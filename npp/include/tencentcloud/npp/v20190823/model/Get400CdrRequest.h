...
#ifndef TENCENTCLOUD_NPP_V20190823_MODEL_GET400CDRREQUEST_H_
#define TENCENTCLOUD_NPP_V20190823_MODEL_GET400CDRREQUEST_H_
    ...
    namespace Npp
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                * Get400Cdr请求参数结构体
                */
                class Get400CdrRequest : public AbstractModel
                {
                public:
                    Get400CdrRequest();
                    ~Get400CdrRequest() = default;
...
#endif // !TENCENTCLOUD_NPP_V20190823_MODEL_GET400CDRREQUEST_H_
