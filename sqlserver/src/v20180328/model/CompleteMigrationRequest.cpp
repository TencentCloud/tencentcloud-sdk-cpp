...
string CompleteMigrationRequest::ToJsonString() const
{
...
int64_t CompleteMigrationRequest::GetMigrateId() const
{
    return m_migrateId;
}

void CompleteMigrationRequest::SetMigrateId(const int64_t& _migrateId)
{
    m_migrateId = _migrateId;
    m_migrateIdHasBeenSet = true;
}

bool CompleteMigrationRequest::MigrateIdHasBeenSet() const
{
