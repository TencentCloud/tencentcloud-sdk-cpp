...
CoreInternalOutcome ModifyDBInstanceNetworkResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceNetworkResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceNetworkResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDBInstanceNetworkResponse::FlowIdHasBeenSet() const
{
