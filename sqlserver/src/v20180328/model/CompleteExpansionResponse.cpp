...
CoreInternalOutcome CompleteExpansionResponse::Deserialize(const string &payload)
{
...
string CompleteExpansionResponse::ToJsonString() const
{
...
uint64_t CompleteExpansionResponse::GetFlowId() const
{
    return m_flowId;
}

bool CompleteExpansionResponse::FlowIdHasBeenSet() const
{
