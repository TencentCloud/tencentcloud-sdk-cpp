...
CoreInternalOutcome RollbackInstanceResponse::Deserialize(const string &payload)
{
...
string RollbackInstanceResponse::ToJsonString() const
{
...
uint64_t RollbackInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool RollbackInstanceResponse::FlowIdHasBeenSet() const
{
