...
CoreInternalOutcome StopMigrationResponse::Deserialize(const string &payload)
{
...
string StopMigrationResponse::ToJsonString() const
{
...
int64_t StopMigrationResponse::GetFlowId() const
{
    return m_flowId;
}

bool StopMigrationResponse::FlowIdHasBeenSet() const
{
