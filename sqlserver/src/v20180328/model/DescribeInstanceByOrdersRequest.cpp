...
string DescribeInstanceByOrdersRequest::ToJsonString() const
{
...
vector<string> DescribeInstanceByOrdersRequest::GetDealNames() const
{
    return m_dealNames;
}

void DescribeInstanceByOrdersRequest::SetDealNames(const vector<string>& _dealNames)
{
    m_dealNames = _dealNames;
    m_dealNamesHasBeenSet = true;
}

bool DescribeInstanceByOrdersRequest::DealNamesHasBeenSet() const
{
