...
CoreInternalOutcome ModifyDReadableResponse::Deserialize(const string &payload)
{
...
string ModifyDReadableResponse::ToJsonString() const
{
...
int64_t ModifyDReadableResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDReadableResponse::FlowIdHasBeenSet() const
{
