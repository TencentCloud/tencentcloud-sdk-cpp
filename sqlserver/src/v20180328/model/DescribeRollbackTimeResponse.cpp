...
CoreInternalOutcome DescribeRollbackTimeResponse::Deserialize(const string &payload)
{
...
string DescribeRollbackTimeResponse::ToJsonString() const
{
...
vector<DbRollbackTimeInfo> DescribeRollbackTimeResponse::GetDetails() const
{
    return m_details;
}

bool DescribeRollbackTimeResponse::DetailsHasBeenSet() const
{
