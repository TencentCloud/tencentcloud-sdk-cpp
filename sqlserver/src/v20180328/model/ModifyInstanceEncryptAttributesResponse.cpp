...
CoreInternalOutcome ModifyInstanceEncryptAttributesResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceEncryptAttributesResponse::ToJsonString() const
{
...
int64_t ModifyInstanceEncryptAttributesResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyInstanceEncryptAttributesResponse::FlowIdHasBeenSet() const
{
