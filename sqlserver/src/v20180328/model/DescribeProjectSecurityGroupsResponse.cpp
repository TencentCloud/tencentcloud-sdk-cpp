...
vector<SecurityGroup> DescribeProjectSecurityGroupsResponse::GetSecurityGroupSet() const
{
    return m_securityGroupSet;
}

bool DescribeProjectSecurityGroupsResponse::SecurityGroupSetHasBeenSet() const
{
