...
CoreInternalOutcome ModifyDatabasePrivilegeResponse::Deserialize(const string &payload)
{
...
string ModifyDatabasePrivilegeResponse::ToJsonString() const
{
...
uint64_t ModifyDatabasePrivilegeResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDatabasePrivilegeResponse::FlowIdHasBeenSet() const
{
