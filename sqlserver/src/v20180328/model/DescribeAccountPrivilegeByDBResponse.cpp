...
CoreInternalOutcome DescribeAccountPrivilegeByDBResponse::Deserialize(const string &payload)
{
...
string DescribeAccountPrivilegeByDBResponse::ToJsonString() const
{
...
int64_t DescribeAccountPrivilegeByDBResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAccountPrivilegeByDBResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AccountPrivilege> DescribeAccountPrivilegeByDBResponse::GetAccounts() const
{
    return m_accounts;
}

bool DescribeAccountPrivilegeByDBResponse::AccountsHasBeenSet() const
{
