...
vector<AccountCreateInfo> CreateAccountRequest::GetAccounts() const
{
    return m_accounts;
}

void CreateAccountRequest::SetAccounts(const vector<AccountCreateInfo>& _accounts)
{
    m_accounts = _accounts;
    m_accountsHasBeenSet = true;
}

bool CreateAccountRequest::AccountsHasBeenSet() const
{
