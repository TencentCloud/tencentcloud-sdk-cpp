...
CoreInternalOutcome DeleteDBResponse::Deserialize(const string &payload)
{
...
string DeleteDBResponse::ToJsonString() const
{
...
int64_t DeleteDBResponse::GetFlowId() const
{
    return m_flowId;
}

bool DeleteDBResponse::FlowIdHasBeenSet() const
{
