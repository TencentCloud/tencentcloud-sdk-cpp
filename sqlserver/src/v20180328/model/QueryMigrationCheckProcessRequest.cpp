...
string QueryMigrationCheckProcessRequest::ToJsonString() const
{
...
int64_t QueryMigrationCheckProcessRequest::GetMigrateId() const
{
    return m_migrateId;
}

void QueryMigrationCheckProcessRequest::SetMigrateId(const int64_t& _migrateId)
{
    m_migrateId = _migrateId;
    m_migrateIdHasBeenSet = true;
}

bool QueryMigrationCheckProcessRequest::MigrateIdHasBeenSet() const
{
