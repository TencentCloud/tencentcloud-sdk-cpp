...
string OpenInterCommunicationRequest::ToJsonString() const
{
...
vector<string> OpenInterCommunicationRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void OpenInterCommunicationRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool OpenInterCommunicationRequest::InstanceIdSetHasBeenSet() const
{
