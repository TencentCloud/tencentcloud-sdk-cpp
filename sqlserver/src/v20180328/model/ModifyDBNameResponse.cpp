...
CoreInternalOutcome ModifyDBNameResponse::Deserialize(const string &payload)
{
...
string ModifyDBNameResponse::ToJsonString() const
{
...
int64_t ModifyDBNameResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDBNameResponse::FlowIdHasBeenSet() const
{
