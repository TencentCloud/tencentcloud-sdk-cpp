...
vector<string> AssociateSecurityGroupsRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void AssociateSecurityGroupsRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool AssociateSecurityGroupsRequest::InstanceIdSetHasBeenSet() const
{
