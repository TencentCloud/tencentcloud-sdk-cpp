...
CoreInternalOutcome StartIncrementalMigrationResponse::Deserialize(const string &payload)
{
...
string StartIncrementalMigrationResponse::ToJsonString() const
{
...
uint64_t StartIncrementalMigrationResponse::GetFlowId() const
{
    return m_flowId;
}

bool StartIncrementalMigrationResponse::FlowIdHasBeenSet() const
{
