...
CoreInternalOutcome ModifyMigrationResponse::Deserialize(const string &payload)
{
...
string ModifyMigrationResponse::ToJsonString() const
{
...
uint64_t ModifyMigrationResponse::GetMigrateId() const
{
    return m_migrateId;
}

bool ModifyMigrationResponse::MigrateIdHasBeenSet() const
{
