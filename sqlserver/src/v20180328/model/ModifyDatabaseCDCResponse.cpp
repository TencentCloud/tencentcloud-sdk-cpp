...
CoreInternalOutcome ModifyDatabaseCDCResponse::Deserialize(const string &payload)
{
...
string ModifyDatabaseCDCResponse::ToJsonString() const
{
...
int64_t ModifyDatabaseCDCResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDatabaseCDCResponse::FlowIdHasBeenSet() const
{
