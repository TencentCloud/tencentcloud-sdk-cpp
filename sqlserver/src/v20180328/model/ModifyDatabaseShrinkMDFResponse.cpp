...
CoreInternalOutcome ModifyDatabaseShrinkMDFResponse::Deserialize(const string &payload)
{
...
string ModifyDatabaseShrinkMDFResponse::ToJsonString() const
{
...
int64_t ModifyDatabaseShrinkMDFResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDatabaseShrinkMDFResponse::FlowIdHasBeenSet() const
{
