...
CoreInternalOutcome ModifyPublishSubscribeResponse::Deserialize(const string &payload)
{
...
string ModifyPublishSubscribeResponse::ToJsonString() const
{
...
int64_t ModifyPublishSubscribeResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyPublishSubscribeResponse::FlowIdHasBeenSet() const
{
