...
CoreInternalOutcome DescribeRestoreTaskResponse::Deserialize(const string &payload)
{
...
string DescribeRestoreTaskResponse::ToJsonString() const
{
...
int64_t DescribeRestoreTaskResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRestoreTaskResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RestoreTask> DescribeRestoreTaskResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeRestoreTaskResponse::TasksHasBeenSet() const
{
