...
CoreInternalOutcome ModifyCloseWanIpResponse::Deserialize(const string &payload)
{
...
string ModifyCloseWanIpResponse::ToJsonString() const
{
...
uint64_t ModifyCloseWanIpResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyCloseWanIpResponse::FlowIdHasBeenSet() const
{
