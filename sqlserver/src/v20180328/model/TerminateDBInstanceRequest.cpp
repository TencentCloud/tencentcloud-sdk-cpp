...
string TerminateDBInstanceRequest::ToJsonString() const
{
...
vector<string> TerminateDBInstanceRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void TerminateDBInstanceRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool TerminateDBInstanceRequest::InstanceIdSetHasBeenSet() const
{
