...
vector<string> ModifyDBInstanceProjectRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void ModifyDBInstanceProjectRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool ModifyDBInstanceProjectRequest::InstanceIdSetHasBeenSet() const
{
    return m_instanceIdSetHasBeenSet;
}

int64_t ModifyDBInstanceProjectRequest::GetProjectId() const
{
    return m_projectId;
}

void ModifyDBInstanceProjectRequest::SetProjectId(const int64_t& _projectId)
{
    m_projectId = _projectId;
    m_projectIdHasBeenSet = true;
}

bool ModifyDBInstanceProjectRequest::ProjectIdHasBeenSet() const
{
