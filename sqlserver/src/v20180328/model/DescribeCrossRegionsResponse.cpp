...
CoreInternalOutcome DescribeCrossRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeCrossRegionsResponse::ToJsonString() const
{
...
vector<string> DescribeCrossRegionsResponse::GetRegions() const
{
    return m_regions;
}

bool DescribeCrossRegionsResponse::RegionsHasBeenSet() const
{
