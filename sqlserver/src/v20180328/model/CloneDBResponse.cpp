...
CoreInternalOutcome CloneDBResponse::Deserialize(const string &payload)
{
...
string CloneDBResponse::ToJsonString() const
{
...
int64_t CloneDBResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloneDBResponse::FlowIdHasBeenSet() const
{
