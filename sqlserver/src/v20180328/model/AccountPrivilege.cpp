...
CoreInternalOutcome AccountPrivilege::Deserialize(const Value &value)
{
    string requestId = "";
...
void AccountPrivilege::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
