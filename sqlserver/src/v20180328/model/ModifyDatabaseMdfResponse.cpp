...
CoreInternalOutcome ModifyDatabaseMdfResponse::Deserialize(const string &payload)
{
...
string ModifyDatabaseMdfResponse::ToJsonString() const
{
...
int64_t ModifyDatabaseMdfResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDatabaseMdfResponse::FlowIdHasBeenSet() const
{
