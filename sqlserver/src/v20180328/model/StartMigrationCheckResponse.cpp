...
CoreInternalOutcome StartMigrationCheckResponse::Deserialize(const string &payload)
{
...
string StartMigrationCheckResponse::ToJsonString() const
{
...
int64_t StartMigrationCheckResponse::GetFlowId() const
{
    return m_flowId;
}

bool StartMigrationCheckResponse::FlowIdHasBeenSet() const
{
