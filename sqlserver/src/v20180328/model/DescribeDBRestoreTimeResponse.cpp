...
CoreInternalOutcome DescribeDBRestoreTimeResponse::Deserialize(const string &payload)
{
...
string DescribeDBRestoreTimeResponse::ToJsonString() const
{
...
int64_t DescribeDBRestoreTimeResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDBRestoreTimeResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DBRenameRes> DescribeDBRestoreTimeResponse::GetDetails() const
{
    return m_details;
}

bool DescribeDBRestoreTimeResponse::DetailsHasBeenSet() const
{
