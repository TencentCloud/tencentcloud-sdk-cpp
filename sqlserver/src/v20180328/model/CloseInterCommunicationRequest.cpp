...
string CloseInterCommunicationRequest::ToJsonString() const
{
...
vector<string> CloseInterCommunicationRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void CloseInterCommunicationRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool CloseInterCommunicationRequest::InstanceIdSetHasBeenSet() const
{
