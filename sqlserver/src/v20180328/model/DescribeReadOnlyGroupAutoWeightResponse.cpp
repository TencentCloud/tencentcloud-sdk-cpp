...
CoreInternalOutcome DescribeReadOnlyGroupAutoWeightResponse::Deserialize(const string &payload)
{
...
string DescribeReadOnlyGroupAutoWeightResponse::ToJsonString() const
{
...
string DescribeReadOnlyGroupAutoWeightResponse::GetReadOnlyGroupId() const
{
    return m_readOnlyGroupId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::ReadOnlyGroupIdHasBeenSet() const
{
    return m_readOnlyGroupIdHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetReadOnlyGroupName() const
{
    return m_readOnlyGroupName;
}

bool DescribeReadOnlyGroupAutoWeightResponse::ReadOnlyGroupNameHasBeenSet() const
{
    return m_readOnlyGroupNameHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetRegionId() const
{
    return m_regionId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::RegionIdHasBeenSet() const
{
    return m_regionIdHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetZoneId() const
{
    return m_zoneId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

int64_t DescribeReadOnlyGroupAutoWeightResponse::GetIsOfflineDelay() const
{
    return m_isOfflineDelay;
}

bool DescribeReadOnlyGroupAutoWeightResponse::IsOfflineDelayHasBeenSet() const
{
    return m_isOfflineDelayHasBeenSet;
}

int64_t DescribeReadOnlyGroupAutoWeightResponse::GetReadOnlyMaxDelayTime() const
{
    return m_readOnlyMaxDelayTime;
}

bool DescribeReadOnlyGroupAutoWeightResponse::ReadOnlyMaxDelayTimeHasBeenSet() const
{
    return m_readOnlyMaxDelayTimeHasBeenSet;
}

int64_t DescribeReadOnlyGroupAutoWeightResponse::GetMinReadOnlyInGroup() const
{
    return m_minReadOnlyInGroup;
}

bool DescribeReadOnlyGroupAutoWeightResponse::MinReadOnlyInGroupHasBeenSet() const
{
    return m_minReadOnlyInGroupHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetVip() const
{
    return m_vip;
}

bool DescribeReadOnlyGroupAutoWeightResponse::VipHasBeenSet() const
{
    return m_vipHasBeenSet;
}

int64_t DescribeReadOnlyGroupAutoWeightResponse::GetVport() const
{
    return m_vport;
}

bool DescribeReadOnlyGroupAutoWeightResponse::VportHasBeenSet() const
{
    return m_vportHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetVpcId() const
{
    return m_vpcId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::VpcIdHasBeenSet() const
{
    return m_vpcIdHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetSubnetId() const
{
    return m_subnetId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::SubnetIdHasBeenSet() const
{
    return m_subnetIdHasBeenSet;
}

vector<ReadOnlyInstance> DescribeReadOnlyGroupAutoWeightResponse::GetReadOnlyInstanceSet() const
{
    return m_readOnlyInstanceSet;
}

bool DescribeReadOnlyGroupAutoWeightResponse::ReadOnlyInstanceSetHasBeenSet() const
{
    return m_readOnlyInstanceSetHasBeenSet;
}

int64_t DescribeReadOnlyGroupAutoWeightResponse::GetStatus() const
{
    return m_status;
}

bool DescribeReadOnlyGroupAutoWeightResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeReadOnlyGroupAutoWeightResponse::GetMasterInstanceId() const
{
    return m_masterInstanceId;
}

bool DescribeReadOnlyGroupAutoWeightResponse::MasterInstanceIdHasBeenSet() const
{
