...
CoreInternalOutcome SwitchCloudInstanceHAResponse::Deserialize(const string &payload)
{
...
string SwitchCloudInstanceHAResponse::ToJsonString() const
{
...
int64_t SwitchCloudInstanceHAResponse::GetFlowId() const
{
    return m_flowId;
}

bool SwitchCloudInstanceHAResponse::FlowIdHasBeenSet() const
{
