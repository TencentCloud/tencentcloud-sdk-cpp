...
CoreInternalOutcome CompleteMigrationResponse::Deserialize(const string &payload)
{
...
string CompleteMigrationResponse::ToJsonString() const
{
...
int64_t CompleteMigrationResponse::GetFlowId() const
{
    return m_flowId;
}

bool CompleteMigrationResponse::FlowIdHasBeenSet() const
{
