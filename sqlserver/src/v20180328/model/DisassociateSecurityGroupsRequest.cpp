...
vector<string> DisassociateSecurityGroupsRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void DisassociateSecurityGroupsRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool DisassociateSecurityGroupsRequest::InstanceIdSetHasBeenSet() const
{
