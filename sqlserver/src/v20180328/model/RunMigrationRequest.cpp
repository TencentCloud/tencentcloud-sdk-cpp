...
string RunMigrationRequest::ToJsonString() const
{
...
uint64_t RunMigrationRequest::GetMigrateId() const
{
    return m_migrateId;
}

void RunMigrationRequest::SetMigrateId(const uint64_t& _migrateId)
{
    m_migrateId = _migrateId;
    m_migrateIdHasBeenSet = true;
}

bool RunMigrationRequest::MigrateIdHasBeenSet() const
{
