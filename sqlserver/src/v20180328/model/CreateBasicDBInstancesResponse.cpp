...
CoreInternalOutcome CreateBasicDBInstancesResponse::Deserialize(const string &payload)
{
...
string CreateBasicDBInstancesResponse::ToJsonString() const
{
...
string CreateBasicDBInstancesResponse::GetDealName() const
{
    return m_dealName;
}

bool CreateBasicDBInstancesResponse::DealNameHasBeenSet() const
{
