...
string StopMigrationRequest::ToJsonString() const
{
...
int64_t StopMigrationRequest::GetMigrateId() const
{
    return m_migrateId;
}

void StopMigrationRequest::SetMigrateId(const int64_t& _migrateId)
{
    m_migrateId = _migrateId;
    m_migrateIdHasBeenSet = true;
}

bool StopMigrationRequest::MigrateIdHasBeenSet() const
{
