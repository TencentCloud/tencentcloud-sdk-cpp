...
CoreInternalOutcome CreatePublishSubscribeResponse::Deserialize(const string &payload)
{
...
string CreatePublishSubscribeResponse::ToJsonString() const
{
...
uint64_t CreatePublishSubscribeResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreatePublishSubscribeResponse::FlowIdHasBeenSet() const
{
