...
CoreInternalOutcome DescribeXEventsResponse::Deserialize(const string &payload)
{
...
string DescribeXEventsResponse::ToJsonString() const
{
...
vector<Events> DescribeXEventsResponse::GetEvents() const
{
    return m_events;
}

bool DescribeXEventsResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

int64_t DescribeXEventsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeXEventsResponse::TotalCountHasBeenSet() const
{
