...
CoreInternalOutcome ModifyDatabaseCTResponse::Deserialize(const string &payload)
{
...
string ModifyDatabaseCTResponse::ToJsonString() const
{
...
int64_t ModifyDatabaseCTResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDatabaseCTResponse::FlowIdHasBeenSet() const
{
