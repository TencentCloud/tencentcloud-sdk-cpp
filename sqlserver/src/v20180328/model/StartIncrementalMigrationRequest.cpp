...
string StartIncrementalMigrationRequest::ToJsonString() const
{
...
string StartIncrementalMigrationRequest::GetInstanceId() const
{
    return m_instanceId;
}

void StartIncrementalMigrationRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool StartIncrementalMigrationRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string StartIncrementalMigrationRequest::GetBackupMigrationId() const
{
    return m_backupMigrationId;
}

void StartIncrementalMigrationRequest::SetBackupMigrationId(const string& _backupMigrationId)
{
    m_backupMigrationId = _backupMigrationId;
    m_backupMigrationIdHasBeenSet = true;
}

bool StartIncrementalMigrationRequest::BackupMigrationIdHasBeenSet() const
{
    return m_backupMigrationIdHasBeenSet;
}

string StartIncrementalMigrationRequest::GetIncrementalMigrationId() const
{
    return m_incrementalMigrationId;
}

void StartIncrementalMigrationRequest::SetIncrementalMigrationId(const string& _incrementalMigrationId)
{
    m_incrementalMigrationId = _incrementalMigrationId;
    m_incrementalMigrationIdHasBeenSet = true;
}

bool StartIncrementalMigrationRequest::IncrementalMigrationIdHasBeenSet() const
{
