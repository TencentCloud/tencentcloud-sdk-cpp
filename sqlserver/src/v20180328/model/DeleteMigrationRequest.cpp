...
string DeleteMigrationRequest::ToJsonString() const
{
...
uint64_t DeleteMigrationRequest::GetMigrateId() const
{
    return m_migrateId;
}

void DeleteMigrationRequest::SetMigrateId(const uint64_t& _migrateId)
{
    m_migrateId = _migrateId;
    m_migrateIdHasBeenSet = true;
}

bool DeleteMigrationRequest::MigrateIdHasBeenSet() const
{
