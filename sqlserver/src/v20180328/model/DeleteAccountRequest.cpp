...
vector<string> DeleteAccountRequest::GetUserNames() const
{
    return m_userNames;
}

void DeleteAccountRequest::SetUserNames(const vector<string>& _userNames)
{
    m_userNames = _userNames;
    m_userNamesHasBeenSet = true;
}

bool DeleteAccountRequest::UserNamesHasBeenSet() const
{
