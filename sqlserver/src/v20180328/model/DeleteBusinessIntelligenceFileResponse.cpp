...
CoreInternalOutcome DeleteBusinessIntelligenceFileResponse::Deserialize(const string &payload)
{
...
string DeleteBusinessIntelligenceFileResponse::ToJsonString() const
{
