...
CoreInternalOutcome ModifyOpenWanIpResponse::Deserialize(const string &payload)
{
...
string ModifyOpenWanIpResponse::ToJsonString() const
{
...
uint64_t ModifyOpenWanIpResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyOpenWanIpResponse::FlowIdHasBeenSet() const
{
