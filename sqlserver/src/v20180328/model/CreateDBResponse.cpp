...
CoreInternalOutcome CreateDBResponse::Deserialize(const string &payload)
{
...
string CreateDBResponse::ToJsonString() const
{
...
int64_t CreateDBResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateDBResponse::FlowIdHasBeenSet() const
{
