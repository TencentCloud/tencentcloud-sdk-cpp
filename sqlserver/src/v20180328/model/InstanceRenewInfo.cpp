...
CoreInternalOutcome InstanceRenewInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceRenewInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
