...
CoreInternalOutcome DescribeCrossRegionZoneResponse::Deserialize(const string &payload)
{
...
string DescribeCrossRegionZoneResponse::ToJsonString() const
{
...
string DescribeCrossRegionZoneResponse::GetRegion() const
{
    return m_region;
}

bool DescribeCrossRegionZoneResponse::RegionHasBeenSet() const
{
    return m_regionHasBeenSet;
}

string DescribeCrossRegionZoneResponse::GetZone() const
{
    return m_zone;
}

bool DescribeCrossRegionZoneResponse::ZoneHasBeenSet() const
{
