...
CoreInternalOutcome RunMigrationResponse::Deserialize(const string &payload)
{
...
string RunMigrationResponse::ToJsonString() const
{
...
int64_t RunMigrationResponse::GetFlowId() const
{
    return m_flowId;
}

bool RunMigrationResponse::FlowIdHasBeenSet() const
{
