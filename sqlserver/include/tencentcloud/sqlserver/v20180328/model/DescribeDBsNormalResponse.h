...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEDBSNORMALRESPONSE_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEDBSNORMALRESPONSE_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                */
                class DescribeDBsNormalResponse : public AbstractModel
                {
                public:
                    DescribeDBsNormalResponse();
                    ~DescribeDBsNormalResponse() = default;
...
#endif // !TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEDBSNORMALRESPONSE_H_
