...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEREADONLYGROUPDETAILSRESPONSE_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEREADONLYGROUPDETAILSRESPONSE_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                */
                class DescribeReadOnlyGroupDetailsResponse : public AbstractModel
                {
                public:
                    DescribeReadOnlyGroupDetailsResponse();
                    ~DescribeReadOnlyGroupDetailsResponse() = default;
...
#endif // !TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEREADONLYGROUPDETAILSRESPONSE_H_
