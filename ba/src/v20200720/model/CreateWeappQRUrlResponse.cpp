...
CoreInternalOutcome CreateWeappQRUrlResponse::Deserialize(const string &payload)
{
...
string CreateWeappQRUrlResponse::ToJsonString() const
{
...
string CreateWeappQRUrlResponse::GetUrl() const
{
    return m_url;
}

bool CreateWeappQRUrlResponse::UrlHasBeenSet() const
{
