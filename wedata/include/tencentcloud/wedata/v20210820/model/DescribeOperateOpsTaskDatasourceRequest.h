...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEOPERATEOPSTASKDATASOURCEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEOPERATEOPSTASKDATASOURCEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeOperateOpsTaskDatasourceRequest : public AbstractModel
                {
                public:
                    DescribeOperateOpsTaskDatasourceRequest();
                    ~DescribeOperateOpsTaskDatasourceRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEOPERATEOPSTASKDATASOURCEREQUEST_H_
