...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::string GetBizStandCode() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetBizStandCode(const std::string& _bizStandCode);

                    /**
                     * 判断参数 BizStandCode 是否已赋值
                     * @return BizStandCode 是否已赋值
                     * 
                     */
                    bool BizStandCodeHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_bizStandCode;
                    bool m_bizStandCodeHasBeenSet;
