...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV2_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV2_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 依赖配置无循环递归属性
                */
                class DependencyConfigDsDTONoRecurV2 : public AbstractModel
                {
                public:
                    DependencyConfigDsDTONoRecurV2();
                    ~DependencyConfigDsDTONoRecurV2() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecurV2 GetParentTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetParentTask(const TaskDsDTONoRecurV2& _parentTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecurV2 GetSonTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetSonTask(const TaskDsDTONoRecurV2& _sonTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    TaskDsDTONoRecurV2 m_parentTask;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV2_H_
