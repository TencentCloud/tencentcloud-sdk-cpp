...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_REGISTERDSEVENTPUBLISHERREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_REGISTERDSEVENTPUBLISHERREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class RegisterDsEventPublisherRequest : public AbstractModel
                {
                public:
                    RegisterDsEventPublisherRequest();
                    ~RegisterDsEventPublisherRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_REGISTERDSEVENTPUBLISHERREQUEST_H_
