...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSINSTANCETRENDREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSINSTANCETRENDREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeIntegrationStatisticsInstanceTrendRequest : public AbstractModel
                {
                public:
                    DescribeIntegrationStatisticsInstanceTrendRequest();
                    ~DescribeIntegrationStatisticsInstanceTrendRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSINSTANCETRENDREQUEST_H_
