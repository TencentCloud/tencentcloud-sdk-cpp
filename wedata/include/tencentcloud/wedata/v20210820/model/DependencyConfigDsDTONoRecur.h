...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECUR_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECUR_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 依赖配置无循环递归属性
                */
                class DependencyConfigDsDTONoRecur : public AbstractModel
                {
                public:
                    DependencyConfigDsDTONoRecur();
                    ~DependencyConfigDsDTONoRecur() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecur GetParentTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetParentTask(const TaskDsDTONoRecur& _parentTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecur GetSonTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetSonTask(const TaskDsDTONoRecur& _sonTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    DependencyStrategy GetDependencyStrategy() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDependencyStrategy(const DependencyStrategy& _dependencyStrategy);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    DependencyStrategy m_dependencyStrategy;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECUR_H_
