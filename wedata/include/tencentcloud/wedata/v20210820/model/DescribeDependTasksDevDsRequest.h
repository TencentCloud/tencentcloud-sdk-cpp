...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSDEVDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSDEVDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeDependTasksDevDsRequest : public AbstractModel
                {
                public:
                    DescribeDependTasksDevDsRequest();
                    ~DescribeDependTasksDevDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSDEVDSREQUEST_H_
