...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMTASKDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMTASKDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 设置任务引用参数-入参
                */
                class ParamTaskDsRequest : public AbstractModel
                {
                public:
                    ParamTaskDsRequest();
                    ~ParamTaskDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMTASKDSREQUEST_H_
