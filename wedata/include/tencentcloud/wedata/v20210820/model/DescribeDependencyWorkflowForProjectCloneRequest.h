...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDENCYWORKFLOWFORPROJECTCLONEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDENCYWORKFLOWFORPROJECTCLONEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeDependencyWorkflowForProjectCloneRequest : public AbstractModel
                {
                public:
                    DescribeDependencyWorkflowForProjectCloneRequest();
                    ~DescribeDependencyWorkflowForProjectCloneRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDENCYWORKFLOWFORPROJECTCLONEREQUEST_H_
