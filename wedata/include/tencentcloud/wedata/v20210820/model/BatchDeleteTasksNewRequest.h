...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSNEWREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSNEWREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchDeleteTasksNewRequest : public AbstractModel
                {
                public:
                    BatchDeleteTasksNewRequest();
                    ~BatchDeleteTasksNewRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSNEWREQUEST_H_
