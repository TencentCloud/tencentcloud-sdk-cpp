...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWCANVASOPLOGRESULT_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWCANVASOPLOGRESULT_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 分页数据集
                */
                class WorkflowCanvasOpLogResult : public AbstractModel
                {
                public:
                    WorkflowCanvasOpLogResult();
                    ~WorkflowCanvasOpLogResult() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<WorkflowCanvasOplog> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<WorkflowCanvasOplog>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<WorkflowCanvasOplog> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWCANVASOPLOGRESULT_H_
