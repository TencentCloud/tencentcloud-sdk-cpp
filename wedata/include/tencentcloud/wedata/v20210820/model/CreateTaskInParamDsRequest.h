...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKINPARAMDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKINPARAMDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class CreateTaskInParamDsRequest : public AbstractModel
                {
                public:
                    CreateTaskInParamDsRequest();
                    ~CreateTaskInParamDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKINPARAMDSREQUEST_H_
