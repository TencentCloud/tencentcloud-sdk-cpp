...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKPARAMDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKPARAMDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class CreateTaskParamDsRequest : public AbstractModel
                {
                public:
                    CreateTaskParamDsRequest();
                    ~CreateTaskParamDsRequest() = default;
                     ...
                     * 
                     */
                    std::vector<ParamTaskDsRequest> GetRequest() const;
                     ...
                     * 
                     */
                    void SetRequest(const std::vector<ParamTaskDsRequest>& _request);
                ...
                private:
                     ...
                     * 入参
                     */
                    std::vector<ParamTaskDsRequest> m_request;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKPARAMDSREQUEST_H_
