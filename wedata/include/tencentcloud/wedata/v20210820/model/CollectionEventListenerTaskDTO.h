...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONEVENTLISTENERTASKDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONEVENTLISTENERTASKDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 事件关联任务分页实体类
                */
                class CollectionEventListenerTaskDTO : public AbstractModel
                {
                public:
                    CollectionEventListenerTaskDTO();
                    ~CollectionEventListenerTaskDTO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<EventListenerTaskInfo> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<EventListenerTaskInfo>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<EventListenerTaskInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONEVENTLISTENERTASKDTO_H_
