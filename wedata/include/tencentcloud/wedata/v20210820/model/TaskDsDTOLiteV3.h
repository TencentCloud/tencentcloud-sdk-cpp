...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV3_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV3_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * TaskDsDTO 减少嵌套层数
                */
                class TaskDsDTOLiteV3 : public AbstractModel
                {
                public:
                    TaskDsDTOLiteV3();
                    ~TaskDsDTOLiteV3() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<DependencyConfigDsDTONoRecurV3> GetDependencyConfigList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDependencyConfigList(const std::vector<DependencyConfigDsDTONoRecurV3>& _dependencyConfigList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<DependencyConfigDsDTONoRecurV3> m_dependencyConfigList;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV3_H_
