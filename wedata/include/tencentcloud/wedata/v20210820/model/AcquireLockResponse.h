...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_ACQUIRELOCKRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_ACQUIRELOCKRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * AcquireLock返回参数结构体
                */
                class AcquireLockResponse : public AbstractModel
                {
                public:
                    AcquireLockResponse();
                    ~AcquireLockResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_ACQUIRELOCKRESPONSE_H_
