...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DIAGNOSEPLUSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DIAGNOSEPLUSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * DiagnosePlus请求参数结构体
                */
                class DiagnosePlusRequest : public AbstractModel
                {
                public:
                    DiagnosePlusRequest();
                    ~DiagnosePlusRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DIAGNOSEPLUSREQUEST_H_
