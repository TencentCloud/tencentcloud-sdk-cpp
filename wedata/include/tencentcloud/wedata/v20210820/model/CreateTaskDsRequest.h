...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * CreateTaskDs请求参数结构体
                */
                class CreateTaskDsRequest : public AbstractModel
                {
                public:
                    CreateTaskDsRequest();
                    ~CreateTaskDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKDSREQUEST_H_
