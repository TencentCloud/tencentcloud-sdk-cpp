...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEEVENTLISTENERREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEEVENTLISTENERREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class UpdateEventListenerRequest : public AbstractModel
                {
                public:
                    UpdateEventListenerRequest();
                    ~UpdateEventListenerRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEEVENTLISTENERREQUEST_H_
