...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * TaskDsDTO 减少嵌套层数
                */
                class TaskDsDTOLite : public AbstractModel
                {
                public:
                    TaskDsDTOLite();
                    ~TaskDsDTOLite() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TaskDsDTONoRecur> GetTasks() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetTasks(const std::vector<TaskDsDTONoRecur>& _tasks);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<DependencyConfigDsDTONoRecur> GetDependencyConfigList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDependencyConfigList(const std::vector<DependencyConfigDsDTONoRecur>& _dependencyConfigList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetParams(const std::vector<Params>& _params);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TaskDsDTONoRecur> m_tasks;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<DependencyConfigDsDTONoRecur> m_dependencyConfigList;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITE_H_
