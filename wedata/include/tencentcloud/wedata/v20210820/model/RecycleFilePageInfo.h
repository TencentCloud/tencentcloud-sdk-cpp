...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLEFILEPAGEINFO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLEFILEPAGEINFO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 回收站任务列表
                */
                class RecycleFilePageInfo : public AbstractModel
                {
                public:
                    RecycleFilePageInfo();
                    ~RecycleFilePageInfo() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<DeleteUserFileDTO> GetRows() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRows(const std::vector<DeleteUserFileDTO>& _rows);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<DeleteUserFileDTO> m_rows;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLEFILEPAGEINFO_H_
