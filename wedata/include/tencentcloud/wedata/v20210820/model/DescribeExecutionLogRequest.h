...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEEXECUTIONLOGREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEEXECUTIONLOGREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeExecutionLogRequest : public AbstractModel
                {
                public:
                    DescribeExecutionLogRequest();
                    ~DescribeExecutionLogRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEEXECUTIONLOGREQUEST_H_
