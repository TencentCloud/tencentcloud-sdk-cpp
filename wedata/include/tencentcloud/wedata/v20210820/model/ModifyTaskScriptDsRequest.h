...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_MODIFYTASKSCRIPTDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_MODIFYTASKSCRIPTDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ModifyTaskScriptDsRequest : public AbstractModel
                {
                public:
                    ModifyTaskScriptDsRequest();
                    ~ModifyTaskScriptDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_MODIFYTASKSCRIPTDSREQUEST_H_
