...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETESTRUNREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETESTRUNREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeTestRunRequest : public AbstractModel
                {
                public:
                    DescribeTestRunRequest();
                    ~DescribeTestRunRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETESTRUNREQUEST_H_
