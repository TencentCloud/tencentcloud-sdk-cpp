...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEFATHERSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEFATHERSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeFathersRequest : public AbstractModel
                {
                public:
                    DescribeFathersRequest();
                    ~DescribeFathersRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEFATHERSREQUEST_H_
