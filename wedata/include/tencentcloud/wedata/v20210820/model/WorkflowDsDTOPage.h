...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWDSDTOPAGE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWDSDTOPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 工作流信息，分页
                */
                class WorkflowDsDTOPage : public AbstractModel
                {
                public:
                    WorkflowDsDTOPage();
                    ~WorkflowDsDTOPage() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<WorkflowDsDTO> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<WorkflowDsDTO>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<WorkflowDsDTO> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_WORKFLOWDSDTOPAGE_H_
