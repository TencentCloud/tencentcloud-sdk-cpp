...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKINCHARGERESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKINCHARGERESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class UpdateBatchTaskInChargeResponse : public AbstractModel
                {
                public:
                    UpdateBatchTaskInChargeResponse();
                    ~UpdateBatchTaskInChargeResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKINCHARGERESPONSE_H_
