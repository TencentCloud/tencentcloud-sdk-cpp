...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKINPARAMDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKINPARAMDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DeleteTaskInParamDsRequest : public AbstractModel
                {
                public:
                    DeleteTaskInParamDsRequest();
                    ~DeleteTaskInParamDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKINPARAMDSREQUEST_H_
