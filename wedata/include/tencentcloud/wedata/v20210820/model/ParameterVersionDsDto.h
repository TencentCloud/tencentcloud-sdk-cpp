...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMETERVERSIONDSDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMETERVERSIONDSDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 项目参数版本信息
                */
                class ParameterVersionDsDto : public AbstractModel
                {
                public:
                    ParameterVersionDsDto();
                    ~ParameterVersionDsDto() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_PARAMETERVERSIONDSDTO_H_
