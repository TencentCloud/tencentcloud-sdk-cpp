...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEBATCHWORKFLOWDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEBATCHWORKFLOWDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DeleteBatchWorkflowDsRequest : public AbstractModel
                {
                public:
                    DeleteBatchWorkflowDsRequest();
                    ~DeleteBatchWorkflowDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEBATCHWORKFLOWDSREQUEST_H_
