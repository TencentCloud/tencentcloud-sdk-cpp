...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMODIFYOWNERSNEWREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMODIFYOWNERSNEWREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchModifyOwnersNewRequest : public AbstractModel
                {
                public:
                    BatchModifyOwnersNewRequest();
                    ~BatchModifyOwnersNewRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMODIFYOWNERSNEWREQUEST_H_
