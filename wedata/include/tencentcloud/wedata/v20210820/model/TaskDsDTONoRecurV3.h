...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECURV3_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECURV3_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务信息无循环递归属性
                */
                class TaskDsDTONoRecurV3 : public AbstractModel
                {
                public:
                    TaskDsDTONoRecurV3();
                    ~TaskDsDTONoRecurV3() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECURV3_H_
