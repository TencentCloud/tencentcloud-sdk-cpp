...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMQUIETINTERVAL_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMQUIETINTERVAL_H_
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<int64_t> GetDaysOfWeek() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDaysOfWeek(const std::vector<int64_t>& _daysOfWeek);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<int64_t> m_daysOfWeek;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMQUIETINTERVAL_H_
