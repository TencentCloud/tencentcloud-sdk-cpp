...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RERUNSCHEDULEINSTANCESREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RERUNSCHEDULEINSTANCESREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class RerunScheduleInstancesRequest : public AbstractModel
                {
                public:
                    RerunScheduleInstancesRequest();
                    ~RerunScheduleInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RERUNSCHEDULEINSTANCESREQUEST_H_
