...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBECODESEARCHINFOV2REQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBECODESEARCHINFOV2REQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeCodeSearchInfoV2Request : public AbstractModel
                {
                public:
                    DescribeCodeSearchInfoV2Request();
                    ~DescribeCodeSearchInfoV2Request() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBECODESEARCHINFOV2REQUEST_H_
