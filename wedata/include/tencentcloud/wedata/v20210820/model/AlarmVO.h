...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 告警信息
                */
                class AlarmVO : public AbstractModel
                {
                public:
                    AlarmVO();
                    ~AlarmVO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<AlarmExtVO> GetAlarmExt() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetAlarmExt(const std::vector<AlarmExtVO>& _alarmExt);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<AlarmExtVO> m_alarmExt;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMVO_H_
