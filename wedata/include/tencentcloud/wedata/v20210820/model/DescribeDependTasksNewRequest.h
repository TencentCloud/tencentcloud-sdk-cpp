...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSNEWREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSNEWREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeDependTasksNewRequest : public AbstractModel
                {
                public:
                    DescribeDependTasksNewRequest();
                    ~DescribeDependTasksNewRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEDEPENDTASKSNEWREQUEST_H_
