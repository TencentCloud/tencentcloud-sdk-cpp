...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULETABLESBYPAGEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULETABLESBYPAGEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeRuleTablesByPageRequest : public AbstractModel
                {
                public:
                    DescribeRuleTablesByPageRequest();
                    ~DescribeRuleTablesByPageRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULETABLESBYPAGEREQUEST_H_
