...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETABLEBASICINFOREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETABLEBASICINFOREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeTableBasicInfoRequest : public AbstractModel
                {
                public:
                    DescribeTableBasicInfoRequest();
                    ~DescribeTableBasicInfoRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETABLEBASICINFOREQUEST_H_
