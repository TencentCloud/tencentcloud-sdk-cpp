...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTTASKLINEAGERESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTTASKLINEAGERESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ReportTaskLineageResponse : public AbstractModel
                {
                public:
                    ReportTaskLineageResponse();
                    ~ReportTaskLineageResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTTASKLINEAGERESPONSE_H_
