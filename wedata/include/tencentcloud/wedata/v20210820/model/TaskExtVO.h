...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKEXTVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKEXTVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 属性配置
                */
                class TaskExtVO : public AbstractModel
                {
                public:
                    TaskExtVO();
                    ~TaskExtVO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<AttributeItemVO> GetDryRunExtAttributes() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDryRunExtAttributes(const std::vector<AttributeItemVO>& _dryRunExtAttributes);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<AttributeItemVO> GetDryRunParameter() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDryRunParameter(const std::vector<AttributeItemVO>& _dryRunParameter);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<AttributeItemVO> m_dryRunExtAttributes;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<AttributeItemVO> m_dryRunParameter;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKEXTVO_H_
