...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWFORPROJECTCLONEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWFORPROJECTCLONEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkflowForProjectCloneRequest : public AbstractModel
                {
                public:
                    DescribeWorkflowForProjectCloneRequest();
                    ~DescribeWorkflowForProjectCloneRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWFORPROJECTCLONEREQUEST_H_
