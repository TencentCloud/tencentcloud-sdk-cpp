...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETRENDSTATREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETRENDSTATREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeTrendStatRequest : public AbstractModel
                {
                public:
                    DescribeTrendStatRequest();
                    ~DescribeTrendStatRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETRENDSTATREQUEST_H_
