...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COPYTASKDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COPYTASKDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * CopyTaskDs请求参数结构体
                */
                class CopyTaskDsRequest : public AbstractModel
                {
                public:
                    CopyTaskDsRequest();
                    ~CopyTaskDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COPYTASKDSREQUEST_H_
