...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYSTRATEGY_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYSTRATEGY_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 依赖配置策略
                */
                class DependencyStrategy : public AbstractModel
                {
                public:
                    DependencyStrategy();
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYSTRATEGY_H_
