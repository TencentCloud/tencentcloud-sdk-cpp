...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RESUMEINTEGRATIONTASKREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RESUMEINTEGRATIONTASKREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ResumeIntegrationTaskRequest : public AbstractModel
                {
                public:
                    ResumeIntegrationTaskRequest();
                    ~ResumeIntegrationTaskRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RESUMEINTEGRATIONTASKREQUEST_H_
