...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTDATABASEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTDATABASEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ReportDatabaseRequest : public AbstractModel
                {
                public:
                    ReportDatabaseRequest();
                    ~ReportDatabaseRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_REPORTDATABASEREQUEST_H_
