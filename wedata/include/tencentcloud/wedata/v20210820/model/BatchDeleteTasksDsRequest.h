...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchDeleteTasksDsRequest : public AbstractModel
                {
                public:
                    BatchDeleteTasksDsRequest();
                    ~BatchDeleteTasksDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHDELETETASKSDSREQUEST_H_
