...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEDSEVENTPUBLISHERREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEDSEVENTPUBLISHERREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DeleteDsEventPublisherRequest : public AbstractModel
                {
                public:
                    DeleteDsEventPublisherRequest();
                    ~DeleteDsEventPublisherRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETEDSEVENTPUBLISHERREQUEST_H_
