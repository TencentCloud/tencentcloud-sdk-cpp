...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMEXTVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMEXTVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * AlarmExtVO信息
                */
                class AlarmExtVO : public AbstractModel
                {
                public:
                    AlarmExtVO();
                    ~AlarmExtVO() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_ALARMEXTVO_H_
