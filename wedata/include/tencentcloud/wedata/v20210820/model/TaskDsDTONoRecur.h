...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECUR_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECUR_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务信息无循环递归属性
                */
                class TaskDsDTONoRecur : public AbstractModel
                {
                public:
                    TaskDsDTONoRecur();
                    ~TaskDsDTONoRecur() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetTaskType(const TaskTypeVO& _taskType);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetTaskExt(const TaskExtVO& _taskExt);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<AlarmVO> GetAlarms() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetAlarms(const std::vector<AlarmVO>& _alarms);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<std::string> GetDependencyConfigList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDependencyConfigList(const std::vector<std::string>& _dependencyConfigList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<std::string> m_dependencyConfigList;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTONORECUR_H_
