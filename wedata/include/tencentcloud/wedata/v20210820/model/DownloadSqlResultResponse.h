...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DownloadSqlResultResponse : public AbstractModel
                {
                public:
                    DownloadSqlResultResponse();
                    ~DownloadSqlResultResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTRESPONSE_H_
