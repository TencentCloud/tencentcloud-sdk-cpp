...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEEXTVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEEXTVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 属性类型扩展
                */
                class TaskTypeExtVO : public AbstractModel
                {
                public:
                    TaskTypeExtVO();
                    ~TaskTypeExtVO() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEEXTVO_H_
