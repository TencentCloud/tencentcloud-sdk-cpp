...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RULEGROUPCONFIG_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RULEGROUPCONFIG_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务配置
                */
                class RuleGroupConfig : public AbstractModel
                {
                public:
                    RuleGroupConfig();
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RULEGROUPCONFIG_H_
