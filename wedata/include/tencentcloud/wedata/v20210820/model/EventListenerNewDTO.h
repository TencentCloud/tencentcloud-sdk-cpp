...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_EVENTLISTENERNEWDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_EVENTLISTENERNEWDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 监听事件
                */
                class EventListenerNewDTO : public AbstractModel
                {
                public:
                    EventListenerNewDTO();
                    ~EventListenerNewDTO() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_EVENTLISTENERNEWDTO_H_
