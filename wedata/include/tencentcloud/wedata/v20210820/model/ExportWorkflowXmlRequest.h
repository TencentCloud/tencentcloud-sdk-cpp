...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_EXPORTWORKFLOWXMLREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_EXPORTWORKFLOWXMLREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ExportWorkflowXmlRequest : public AbstractModel
                {
                public:
                    ExportWorkflowXmlRequest();
                    ~ExportWorkflowXmlRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_EXPORTWORKFLOWXMLREQUEST_H_
