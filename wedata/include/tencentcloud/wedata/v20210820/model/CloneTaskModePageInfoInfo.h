...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_CLONETASKMODEPAGEINFOINFO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_CLONETASKMODEPAGEINFOINFO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 【项目克隆任务模式】任务分页返回数据
                */
                class CloneTaskModePageInfoInfo : public AbstractModel
                {
                public:
                    CloneTaskModePageInfoInfo();
                    ~CloneTaskModePageInfoInfo() = default;
                     ...
                     * 
                     */
                    std::vector<CloneTaskModeInfo> GetItems() const;
                     ...
                     * 
                     */
                    void SetItems(const std::vector<CloneTaskModeInfo>& _items);
                ...
                private:
                     ...
                     * 任务列表信息-项目克隆
                     */
                    std::vector<CloneTaskModeInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_CLONETASKMODEPAGEINFOINFO_H_
