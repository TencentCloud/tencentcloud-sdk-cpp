...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSAGENTSTATUSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSAGENTSTATUSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeIntegrationStatisticsAgentStatusRequest : public AbstractModel
                {
                public:
                    DescribeIntegrationStatisticsAgentStatusRequest();
                    ~DescribeIntegrationStatisticsAgentStatusRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSAGENTSTATUSREQUEST_H_
