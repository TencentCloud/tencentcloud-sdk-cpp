...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONTASKOPSDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONTASKOPSDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务实例集合
                */
                class CollectionTaskOpsDto : public AbstractModel
                {
                public:
                    CollectionTaskOpsDto();
                    ~CollectionTaskOpsDto() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONTASKOPSDTO_H_
