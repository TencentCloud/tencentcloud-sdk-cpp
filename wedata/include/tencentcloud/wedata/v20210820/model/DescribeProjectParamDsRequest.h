...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEPROJECTPARAMDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEPROJECTPARAMDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeProjectParamDsRequest : public AbstractModel
                {
                public:
                    DescribeProjectParamDsRequest();
                    ~DescribeProjectParamDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEPROJECTPARAMDSREQUEST_H_
