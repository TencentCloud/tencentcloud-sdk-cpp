...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONPARAMDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONPARAMDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 分页数据集
                */
                class CollectionParamDTO : public AbstractModel
                {
                public:
                    CollectionParamDTO();
                    ~CollectionParamDTO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ParameterInfoDsDto> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<ParameterInfoDsDto>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ParameterInfoDsDto> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONPARAMDTO_H_
