...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV3_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV3_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 依赖配置无循环递归属性
                */
                class DependencyConfigDsDTONoRecurV3 : public AbstractModel
                {
                public:
                    DependencyConfigDsDTONoRecurV3();
                    ~DependencyConfigDsDTONoRecurV3() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecurV3 GetParentTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetParentTask(const TaskDsDTONoRecurV3& _parentTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    TaskDsDTONoRecurV3 GetSonTask() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetSonTask(const TaskDsDTONoRecurV3& _sonTask);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    TaskDsDTONoRecurV3 m_parentTask;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DEPENDENCYCONFIGDSDTONORECURV3_H_
