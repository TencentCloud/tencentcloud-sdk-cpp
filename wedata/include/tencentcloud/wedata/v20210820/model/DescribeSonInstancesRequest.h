...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBESONINSTANCESREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBESONINSTANCESREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeSonInstancesRequest : public AbstractModel
                {
                public:
                    DescribeSonInstancesRequest();
                    ~DescribeSonInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBESONINSTANCESREQUEST_H_
