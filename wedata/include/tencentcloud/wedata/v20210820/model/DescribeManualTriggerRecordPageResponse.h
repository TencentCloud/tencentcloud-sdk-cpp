...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEMANUALTRIGGERRECORDPAGERESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEMANUALTRIGGERRECORDPAGERESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeManualTriggerRecordPageResponse : public AbstractModel
                {
                public:
                    DescribeManualTriggerRecordPageResponse();
                    ~DescribeManualTriggerRecordPageResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    ManualTriggerRecordOpsDtoPage GetData() const;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEMANUALTRIGGERRECORDPAGERESPONSE_H_
