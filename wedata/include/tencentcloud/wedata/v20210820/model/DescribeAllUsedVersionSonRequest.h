...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEALLUSEDVERSIONSONREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEALLUSEDVERSIONSONREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeAllUsedVersionSonRequest : public AbstractModel
                {
                public:
                    DescribeAllUsedVersionSonRequest();
                    ~DescribeAllUsedVersionSonRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEALLUSEDVERSIONSONREQUEST_H_
