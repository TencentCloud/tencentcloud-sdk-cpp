...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKOUTPUTREGISTRY_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKOUTPUTREGISTRY_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 创建产出登记项
                */
                class CreateTaskOutputRegistry : public AbstractModel
                {
                public:
                    CreateTaskOutputRegistry();
                    ~CreateTaskOutputRegistry() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_CREATETASKOUTPUTREGISTRY_H_
