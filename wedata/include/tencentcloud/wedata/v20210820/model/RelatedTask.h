...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RELATEDTASK_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RELATEDTASK_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务直接关联的其他任务
                */
                class RelatedTask : public AbstractModel
                {
                public:
                    RelatedTask();
                    ~RelatedTask() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 设置查询直接依赖方向，如UP、DOWN
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _dependencyDirection 查询直接依赖方向，如UP、DOWN
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RELATEDTASK_H_
