...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_LATESTTESTRUNINFOTASK_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_LATESTTESTRUNINFOTASK_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 最近一次测试运行记录信息任务
                */
                class LatestTestRunInfoTask : public AbstractModel
                {
                public:
                    LatestTestRunInfoTask();
                    ~LatestTestRunInfoTask() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::string GetRequestTaskId() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRequestTaskId(const std::string& _requestTaskId);

                    /**
                     * 判断参数 RequestTaskId 是否已赋值
                     * @return RequestTaskId 是否已赋值
                     * 
                     */
                    bool RequestTaskIdHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_requestTaskId;
                    bool m_requestTaskIdHasBeenSet;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_LATESTTESTRUNINFOTASK_H_
