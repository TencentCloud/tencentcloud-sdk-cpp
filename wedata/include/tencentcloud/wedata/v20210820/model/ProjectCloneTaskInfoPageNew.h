...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTCLONETASKINFOPAGENEW_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTCLONETASKINFOPAGENEW_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 【项目克隆】任务分页返回数据（新版）
                */
                class ProjectCloneTaskInfoPageNew : public AbstractModel
                {
                public:
                    ProjectCloneTaskInfoPageNew();
                    ~ProjectCloneTaskInfoPageNew() = default;
                     ...
                     * 
                     */
                    std::vector<ProjectCloneTaskInfo> GetItems() const;
                     ...
                     * 
                     */
                    void SetItems(const std::vector<ProjectCloneTaskInfo>& _items);
                ...
                private:
                     ...
                     * 任务列表信息-项目克隆
                     */
                    std::vector<ProjectCloneTaskInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTCLONETASKINFOPAGENEW_H_
