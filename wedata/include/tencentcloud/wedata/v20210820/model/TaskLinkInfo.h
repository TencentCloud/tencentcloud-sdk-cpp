...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKLINKINFO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKLINKINFO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务依赖的边信息
                */
                class TaskLinkInfo : public AbstractModel
                {
                public:
                    TaskLinkInfo();
                    ~TaskLinkInfo() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKLINKINFO_H_
