...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSTOPTASKSNEWREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSTOPTASKSNEWREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchStopTasksNewRequest : public AbstractModel
                {
                public:
                    BatchStopTasksNewRequest();
                    ~BatchStopTasksNewRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSTOPTASKSNEWREQUEST_H_
