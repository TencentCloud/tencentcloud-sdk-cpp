...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DownloadSqlResultRequest : public AbstractModel
                {
                public:
                    DownloadSqlResultRequest();
                    ~DownloadSqlResultRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DOWNLOADSQLRESULTREQUEST_H_
