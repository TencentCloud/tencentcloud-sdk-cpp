...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBENEWSQLTASKRESULTRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBENEWSQLTASKRESULTRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeNewSqlTaskResultResponse : public AbstractModel
                {
                public:
                    DescribeNewSqlTaskResultResponse();
                    ~DescribeNewSqlTaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBENEWSQLTASKRESULTRESPONSE_H_
