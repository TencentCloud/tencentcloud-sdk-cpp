...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_KILLSCHEDULEINSTANCESREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_KILLSCHEDULEINSTANCESREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class KillScheduleInstancesRequest : public AbstractModel
                {
                public:
                    KillScheduleInstancesRequest();
                    ~KillScheduleInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_KILLSCHEDULEINSTANCESREQUEST_H_
