...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINSTANCESINFOWITHTASKINFOREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINSTANCESINFOWITHTASKINFOREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeInstancesInfoWithTaskInfoRequest : public AbstractModel
                {
                public:
                    DescribeInstancesInfoWithTaskInfoRequest();
                    ~DescribeInstancesInfoWithTaskInfoRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINSTANCESINFOWITHTASKINFOREQUEST_H_
