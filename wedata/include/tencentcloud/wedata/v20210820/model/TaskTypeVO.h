...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 任务类型
                */
                class TaskTypeVO : public AbstractModel
                {
                public:
                    TaskTypeVO();
                    ~TaskTypeVO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TaskTypeExtParamVO> GetTaskTypeExtension() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetTaskTypeExtension(const std::vector<TaskTypeExtParamVO>& _taskTypeExtension);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TaskTypeExtParamVO> m_taskTypeExtension;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKTYPEVO_H_
