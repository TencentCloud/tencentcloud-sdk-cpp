...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_MAKEUPOPSTASKSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_MAKEUPOPSTASKSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class MakeUpOpsTasksRequest : public AbstractModel
                {
                public:
                    MakeUpOpsTasksRequest();
                    ~MakeUpOpsTasksRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_MAKEUPOPSTASKSREQUEST_H_
