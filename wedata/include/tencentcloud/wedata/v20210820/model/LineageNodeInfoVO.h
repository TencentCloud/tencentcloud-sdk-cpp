...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_LINEAGENODEINFOVO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_LINEAGENODEINFOVO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * LineageNodeInfoVo
                */
                class LineageNodeInfoVO : public AbstractModel
                {
                public:
                    LineageNodeInfoVO();
                    ~LineageNodeInfoVO() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    LineageRelationVO GetRelation() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRelation(const LineageRelationVO& _relation);
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_LINEAGENODEINFOVO_H_
