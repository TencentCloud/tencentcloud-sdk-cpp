...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKPARAMETERRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKPARAMETERRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class UpdateBatchTaskParameterResponse : public AbstractModel
                {
                public:
                    UpdateBatchTaskParameterResponse();
                    ~UpdateBatchTaskParameterResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_UPDATEBATCHTASKPARAMETERRESPONSE_H_
