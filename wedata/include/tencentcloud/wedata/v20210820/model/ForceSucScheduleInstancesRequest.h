...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_FORCESUCSCHEDULEINSTANCESREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_FORCESUCSCHEDULEINSTANCESREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class ForceSucScheduleInstancesRequest : public AbstractModel
                {
                public:
                    ForceSucScheduleInstancesRequest();
                    ~ForceSucScheduleInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_FORCESUCSCHEDULEINSTANCESREQUEST_H_
