...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_FREEZETASKSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_FREEZETASKSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * FreezeTasks请求参数结构体
                */
                class FreezeTasksRequest : public AbstractModel
                {
                public:
                    FreezeTasksRequest();
                    ~FreezeTasksRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_FREEZETASKSREQUEST_H_
