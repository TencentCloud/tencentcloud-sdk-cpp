...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DRYRUNDIOFFLINETASKREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DRYRUNDIOFFLINETASKREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DryRunDIOfflineTaskRequest : public AbstractModel
                {
                public:
                    DryRunDIOfflineTaskRequest();
                    ~DryRunDIOfflineTaskRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DRYRUNDIOFFLINETASKREQUEST_H_
