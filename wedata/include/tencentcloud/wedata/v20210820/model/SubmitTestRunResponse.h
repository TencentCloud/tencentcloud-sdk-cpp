...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITTESTRUNRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITTESTRUNRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class SubmitTestRunResponse : public AbstractModel
                {
                public:
                    SubmitTestRunResponse();
                    ~SubmitTestRunResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITTESTRUNRESPONSE_H_
