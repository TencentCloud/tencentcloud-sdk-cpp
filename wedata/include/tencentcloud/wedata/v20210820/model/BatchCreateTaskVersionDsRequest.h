...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHCREATETASKVERSIONDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHCREATETASKVERSIONDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchCreateTaskVersionDsRequest : public AbstractModel
                {
                public:
                    BatchCreateTaskVersionDsRequest();
                    ~BatchCreateTaskVersionDsRequest() = default;
                     ...
                     * 
                     */
                    std::vector<BatchCreateTaskVersionDsDTOLite> GetTaskVersionDTOs() const;
                     ...
                     * 
                     */
                    void SetTaskVersionDTOs(const std::vector<BatchCreateTaskVersionDsDTOLite>& _taskVersionDTOs);

                    /**
                     * 判断参数 TaskVersionDTOs 是否已赋值
                     * @return TaskVersionDTOs 是否已赋值
                     * 
                     */
                    bool TaskVersionDTOsHasBeenSet() const;
                ...
                private:
                     ...
                     * 任务版本信息
                     */
                    std::vector<BatchCreateTaskVersionDsDTOLite> m_taskVersionDTOs;
                    bool m_taskVersionDTOsHasBeenSet;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHCREATETASKVERSIONDSREQUEST_H_
