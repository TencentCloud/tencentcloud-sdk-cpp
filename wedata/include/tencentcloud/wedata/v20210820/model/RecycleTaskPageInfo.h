...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLETASKPAGEINFO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLETASKPAGEINFO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 回收站任务列表
                */
                class RecycleTaskPageInfo : public AbstractModel
                {
                public:
                    RecycleTaskPageInfo();
                    ~RecycleTaskPageInfo() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<RecycleTaskInfo> GetRows() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRows(const std::vector<RecycleTaskInfo>& _rows);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<RecycleTaskInfo> m_rows;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_RECYCLETASKPAGEINFO_H_
