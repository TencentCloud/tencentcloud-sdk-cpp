...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKOUTPARAMDSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKOUTPARAMDSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DeleteTaskOutParamDsRequest : public AbstractModel
                {
                public:
                    DeleteTaskOutParamDsRequest();
                    ~DeleteTaskOutParamDsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DELETETASKOUTPARAMDSREQUEST_H_
