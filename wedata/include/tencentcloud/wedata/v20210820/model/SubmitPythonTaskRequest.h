...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITPYTHONTASKREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITPYTHONTASKREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class SubmitPythonTaskRequest : public AbstractModel
                {
                public:
                    SubmitPythonTaskRequest();
                    ~SubmitPythonTaskRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_SUBMITPYTHONTASKREQUEST_H_
