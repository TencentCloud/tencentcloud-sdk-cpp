...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV2_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV2_H_
...
#include <tencentcloud/wedata/v20210820/model/DependencyConfigDsDTONoRecurV2.h>
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * TaskDsDTO 减少嵌套层数
                */
                class TaskDsDTOLiteV2 : public AbstractModel
                {
                public:
                    TaskDsDTOLiteV2();
                    ~TaskDsDTOLiteV2() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TaskDsDTONoRecurV2> GetTasks() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetTasks(const std::vector<TaskDsDTONoRecurV2>& _tasks);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<DependencyConfigDsDTONoRecurV2> GetDependencyConfigList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDependencyConfigList(const std::vector<DependencyConfigDsDTONoRecurV2>& _dependencyConfigList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取去向数据源ID（离线同步）
注意：此字段可能返回 null，表示取不到有效值。
                     * @return TargetServiceId 去向数据源ID（离线同步）
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取去向数据源类型（离线同步）
注意：此字段可能返回 null，表示取不到有效值。
                     * @return TargetServiceType 去向数据源类型（离线同步）
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ParamInList TaskInputParam输入参数
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ParamOutList TaskOutputParam输出参数
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TaskDsDTONoRecurV2> m_tasks;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<DependencyConfigDsDTONoRecurV2> m_dependencyConfigList;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_TASKDSDTOLITEV2_H_
