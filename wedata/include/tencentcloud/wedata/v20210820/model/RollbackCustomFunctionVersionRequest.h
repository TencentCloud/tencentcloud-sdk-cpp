...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_ROLLBACKCUSTOMFUNCTIONVERSIONREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_ROLLBACKCUSTOMFUNCTIONVERSIONREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class RollbackCustomFunctionVersionRequest : public AbstractModel
                {
                public:
                    RollbackCustomFunctionVersionRequest();
                    ~RollbackCustomFunctionVersionRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_ROLLBACKCUSTOMFUNCTIONVERSIONREQUEST_H_
