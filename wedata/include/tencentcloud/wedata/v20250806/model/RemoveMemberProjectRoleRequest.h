...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_REMOVEMEMBERPROJECTROLEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_REMOVEMEMBERPROJECTROLEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class RemoveMemberProjectRoleRequest : public AbstractModel
                {
                public:
                    RemoveMemberProjectRoleRequest();
                    ~RemoveMemberProjectRoleRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_REMOVEMEMBERPROJECTROLEREQUEST_H_
