...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYPRODSCHEDULERTASK_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYPRODSCHEDULERTASK_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 数据质量生产调度任务业务实体
                */
                class QualityProdSchedulerTask : public AbstractModel
                {
                public:
                    QualityProdSchedulerTask();
                    ~QualityProdSchedulerTask() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYPRODSCHEDULERTASK_H_
