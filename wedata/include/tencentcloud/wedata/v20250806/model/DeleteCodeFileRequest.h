...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETECODEFILEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETECODEFILEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class DeleteCodeFileRequest : public AbstractModel
                {
                public:
                    DeleteCodeFileRequest();
                    ~DeleteCodeFileRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETECODEFILEREQUEST_H_
