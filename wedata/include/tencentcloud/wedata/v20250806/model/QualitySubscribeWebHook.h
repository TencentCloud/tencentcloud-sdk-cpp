...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBEWEBHOOK_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBEWEBHOOK_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 群机器人订阅配置
                */
                class QualitySubscribeWebHook : public AbstractModel
                {
                public:
                    QualitySubscribeWebHook();
                    ~QualitySubscribeWebHook() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBEWEBHOOK_H_
