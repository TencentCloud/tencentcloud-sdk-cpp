...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_OUTTASKPARAMETER_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_OUTTASKPARAMETER_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 参数传递-输出参数
                */
                class OutTaskParameter : public AbstractModel
                {
                public:
                    OutTaskParameter();
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_OUTTASKPARAMETER_H_
