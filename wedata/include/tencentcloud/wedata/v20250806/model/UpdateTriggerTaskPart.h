...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKPART_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKPART_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 更新任务对象入参
                */
                class UpdateTriggerTaskPart : public AbstractModel
                {
                public:
                    UpdateTriggerTaskPart();
                    ~UpdateTriggerTaskPart() = default;
                     ...
                     * 
                     */
                    UpdateTriggerTaskBaseAttributePart GetTriggerTaskBaseAttribute() const;
                     ...
                     * 
                     */
                    void SetTriggerTaskBaseAttribute(const UpdateTriggerTaskBaseAttributePart& _triggerTaskBaseAttribute);
                ...
                private:
                     ...
                     * 任务基本属性
                     */
                    UpdateTriggerTaskBaseAttributePart m_triggerTaskBaseAttribute;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKPART_H_
