...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_MODIFYQUALITYRULEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_MODIFYQUALITYRULEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class ModifyQualityRuleRequest : public AbstractModel
                {
                public:
                    ModifyQualityRuleRequest();
                    ~ModifyQualityRuleRequest() = default;
                    ...
                    /**
                     * 设置规则模板ID，当Type≠3（自定义SQL）时必填
                     * @param _ruleTemplateId 规则模板ID，当Type≠3（自定义SQL）时必填
                     * 
                     */
                    ...
                    /**
                     * 获取检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
                    ...
                    /**
                     * 设置检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
                     * @param _conditionType 检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
                     * 
                     */
                    ...
                    /**
                     * 获取条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
                    ...
                    /**
                     * 设置条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
                     * @param _conditionExpression 条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
                     * 
                     */
                    ...
                    /**
                     * 设置自定义SQL，Type=3（自定义SQL）时必填
                     * @param _customSql 自定义SQL，Type=3（自定义SQL）时必填
                     * 
                     */
                    ...
                    /**
                     * 设置自定义模版sql表达式字段替换参数，Type=2时必填
                     * @param _fieldConfig 自定义模版sql表达式字段替换参数，Type=2时必填
                     * 
                     */
                    ...
                    /**
                     * 获取该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
                    ...
                    /**
                     * 设置该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
                     * @param _sourceEngineTypes 该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
                     * 
                     */
                    ...
                    /**
                     * 设置目标数据目录名称，主要用于dlc数据源
                     * @param _targetCatalogName 目标数据目录名称，主要用于dlc数据源
                     * 
                     */
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_MODIFYQUALITYRULEREQUEST_H_
