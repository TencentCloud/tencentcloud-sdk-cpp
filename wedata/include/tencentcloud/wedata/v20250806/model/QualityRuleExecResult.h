...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEEXECRESULT_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEEXECRESULT_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 规则执行结果
                */
                class QualityRuleExecResult : public AbstractModel
                {
                public:
                    QualityRuleExecResult();
                    ~QualityRuleExecResult() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    CompareQualityResult GetCompareResult() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetCompareResult(const CompareQualityResult& _compareResult);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    CompareQualityResult m_compareResult;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEEXECRESULT_H_
