            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取要删除的授权目标类型（用户：user，角色：role，组：group）
                    ...
                    /**
                     * 设置要删除的授权目标类型（用户：user，角色：role，组：group）
                     * @param _permissionTargetType 要删除的授权目标类型（用户：user，角色：role，组：group）
                     * 
                     */
                    ...
                    /**
                     * 设置要删除的授权目标id(userId/roleId)
                     * @param _permissionTargetId 要删除的授权目标id(userId/roleId)
                     * 
                     */
                    ...
                    /**
                     * 获取要删除的授权权限类型数组(CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE，当前仅支持CAN_MANAGE)
                    ...
                    /**
                     * 设置要删除的授权权限类型数组(CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE，当前仅支持CAN_MANAGE)
                     * @param _permissionTypeList 要删除的授权权限类型数组(CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE，当前仅支持CAN_MANAGE)
                     * 
                     */
