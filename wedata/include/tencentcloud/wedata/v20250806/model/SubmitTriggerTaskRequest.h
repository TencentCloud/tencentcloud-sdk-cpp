...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_SUBMITTRIGGERTASKREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_SUBMITTRIGGERTASKREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class SubmitTriggerTaskRequest : public AbstractModel
                {
                public:
                    SubmitTriggerTaskRequest();
                    ~SubmitTriggerTaskRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_SUBMITTRIGGERTASKREQUEST_H_
