...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOMPARERULEITEM_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOMPARERULEITEM_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 比较条件
                */
                class QualityCompareRuleItem : public AbstractModel
                {
                public:
                    QualityCompareRuleItem();
                    ~QualityCompareRuleItem() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetValueList(const std::vector<QualityThresholdValue>& _valueList);
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOMPARERULEITEM_H_
