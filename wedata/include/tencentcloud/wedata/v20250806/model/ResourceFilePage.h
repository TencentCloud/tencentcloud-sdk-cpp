...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_RESOURCEFILEPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_RESOURCEFILEPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 资源文件分页
                */
                class ResourceFilePage : public AbstractModel
                {
                public:
                    ResourceFilePage();
                    ~ResourceFilePage() = default;
                     ...
                     * 
                     */
                    std::vector<ResourceFileItem> GetItems() const;
                     ...
                     * 
                     */
                    void SetItems(const std::vector<ResourceFileItem>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                ...
                private:
                     ...
                     * 任务集合信息
                     */
                    std::vector<ResourceFileItem> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_RESOURCEFILEPAGE_H_
