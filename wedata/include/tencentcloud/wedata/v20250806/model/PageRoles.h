...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_PAGEROLES_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_PAGEROLES_H_
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<SystemRole> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<SystemRole>& _items);
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_PAGEROLES_H_
