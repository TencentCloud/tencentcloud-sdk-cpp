...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_EXPLOREFILEPERMISSIONSPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_EXPLOREFILEPERMISSIONSPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 数据探索文件权限列表分页
                */
                class ExploreFilePermissionsPage : public AbstractModel
                {
                public:
                    ExploreFilePermissionsPage();
                    ~ExploreFilePermissionsPage() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ExploreFilePrivilegeItem> GetRows() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRows(const std::vector<ExploreFilePrivilegeItem>& _rows);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ExploreFilePrivilegeItem> m_rows;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_EXPLOREFILEPERMISSIONSPAGE_H_
