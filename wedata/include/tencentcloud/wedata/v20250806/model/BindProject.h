...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_BINDPROJECT_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_BINDPROJECT_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 关联绑定的project
                */
                class BindProject : public AbstractModel
                {
                public:
                    BindProject();
                    ~BindProject() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_BINDPROJECT_H_
