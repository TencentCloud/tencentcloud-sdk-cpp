...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOLUMNVALUECONFIG_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOLUMNVALUECONFIG_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 字段值变量
                */
                class QualityColumnValueConfig : public AbstractModel
                {
                public:
                    QualityColumnValueConfig();
                    ~QualityColumnValueConfig() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYCOLUMNVALUECONFIG_H_
