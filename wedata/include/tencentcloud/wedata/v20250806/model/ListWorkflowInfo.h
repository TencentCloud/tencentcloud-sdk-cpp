...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTWORKFLOWINFO_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTWORKFLOWINFO_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 查询工作流分页列表
                */
                class ListWorkflowInfo : public AbstractModel
                {
                public:
                    ListWorkflowInfo();
                    ~ListWorkflowInfo() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<WorkflowInfo> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<WorkflowInfo>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<WorkflowInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTWORKFLOWINFO_H_
