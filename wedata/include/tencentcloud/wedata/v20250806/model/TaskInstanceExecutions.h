...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKINSTANCEEXECUTIONS_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKINSTANCEEXECUTIONS_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 任务实例执行列表
                */
                class TaskInstanceExecutions : public AbstractModel
                {
                public:
                    TaskInstanceExecutions();
                    ~TaskInstanceExecutions() = default;
                     ...
                     * 
                     */
                    std::vector<InstanceExecution> GetItems() const;
                     ...
                     * 
                     */
                    void SetItems(const std::vector<InstanceExecution>& _items);
                ...
                private:
                     ...
                     * 记录列表
                     */
                    std::vector<InstanceExecution> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKINSTANCEEXECUTIONS_H_
