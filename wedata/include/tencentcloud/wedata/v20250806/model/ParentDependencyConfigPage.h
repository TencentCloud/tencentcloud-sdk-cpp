...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_PARENTDEPENDENCYCONFIGPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_PARENTDEPENDENCYCONFIGPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 查询任务上游依赖详情分页
                */
                class ParentDependencyConfigPage : public AbstractModel
                {
                public:
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<OpsTaskDepend> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<OpsTaskDepend>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<OpsTaskDepend> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_PARENTDEPENDENCYCONFIGPAGE_H_
