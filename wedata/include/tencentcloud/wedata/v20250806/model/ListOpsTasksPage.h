...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTOPSTASKSPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTOPSTASKSPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 任务列表分页
                */
                class ListOpsTasksPage : public AbstractModel
                {
                public:
                    ListOpsTasksPage();
                    ~ListOpsTasksPage() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TaskOpsInfo> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<TaskOpsInfo>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TaskOpsInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTOPSTASKSPAGE_H_
