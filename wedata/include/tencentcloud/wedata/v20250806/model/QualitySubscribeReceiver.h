...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBERECEIVER_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBERECEIVER_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 订阅接收人
                */
                class QualitySubscribeReceiver : public AbstractModel
                {
                public:
                    QualitySubscribeReceiver();
                    ~QualitySubscribeReceiver() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYSUBSCRIBERECEIVER_H_
