...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULTITEM_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULTITEM_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 对比结果项
                */
                class CompareQualityResultItem : public AbstractModel
                {
                public:
                    CompareQualityResultItem();
                    ~CompareQualityResultItem() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<QualityThresholdValue> GetValues() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetValues(const std::vector<QualityThresholdValue>& _values);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<QualityThresholdValue> m_values;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULTITEM_H_
