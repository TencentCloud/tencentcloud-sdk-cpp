...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTEPART_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTEPART_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 更新任务基本属性信息
                */
                class UpdateTriggerTaskBaseAttributePart : public AbstractModel
                {
                public:
                    UpdateTriggerTaskBaseAttributePart();
                    ~UpdateTriggerTaskBaseAttributePart() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTEPART_H_
