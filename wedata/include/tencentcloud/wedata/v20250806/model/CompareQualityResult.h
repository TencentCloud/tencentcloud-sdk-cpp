...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULT_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULT_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 质量检查对比结果
                */
                class CompareQualityResult : public AbstractModel
                {
                public:
                    CompareQualityResult();
                    ~CompareQualityResult() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<CompareQualityResultItem> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<CompareQualityResultItem>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<CompareQualityResultItem> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_COMPAREQUALITYRESULT_H_
