...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTABLECONFIG_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTABLECONFIG_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 规则表变量替换
                */
                class QualityTableConfig : public AbstractModel
                {
                public:
                    QualityTableConfig();
                    ~QualityTableConfig() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<QualityFieldConfig> GetFieldConfig() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetFieldConfig(const std::vector<QualityFieldConfig>& _fieldConfig);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<QualityFieldConfig> m_fieldConfig;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTABLECONFIG_H_
