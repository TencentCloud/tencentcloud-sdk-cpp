...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEGROUPSUBSCRIBE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEGROUPSUBSCRIBE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 数据质量规则组订阅信息
                */
                class QualityRuleGroupSubscribe : public AbstractModel
                {
                public:
                    QualityRuleGroupSubscribe();
                    ~QualityRuleGroupSubscribe() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<QualitySubscribeReceiver> GetReceivers() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetReceivers(const std::vector<QualitySubscribeReceiver>& _receivers);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<QualitySubscribeWebHook> GetWebHooks() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetWebHooks(const std::vector<QualitySubscribeWebHook>& _webHooks);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<QualitySubscribeReceiver> m_receivers;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<QualitySubscribeWebHook> m_webHooks;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULEGROUPSUBSCRIBE_H_
