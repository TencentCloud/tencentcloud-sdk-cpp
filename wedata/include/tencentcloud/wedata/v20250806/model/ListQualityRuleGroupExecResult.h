...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTQUALITYRULEGROUPEXECRESULT_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTQUALITYRULEGROUPEXECRESULT_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 规则组执行结果
                */
                class ListQualityRuleGroupExecResult : public AbstractModel
                {
                public:
                    ListQualityRuleGroupExecResult();
                    ~ListQualityRuleGroupExecResult() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<QualityRuleExecResult> GetRuleExecResultVOList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRuleExecResultVOList(const std::vector<QualityRuleExecResult>& _ruleExecResultVOList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::string GetBizCatalogName() const;

                    /**
                     * 设置类目名
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _bizCatalogName 类目名
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetBizCatalogName(const std::string& _bizCatalogName);

                    /**
                     * 判断参数 BizCatalogName 是否已赋值
                     * @return BizCatalogName 是否已赋值
                     * 
                     */
                    bool BizCatalogNameHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::string GetBizCatalogId() const;

                    /**
                     * 设置类目id
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _bizCatalogId 类目id
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetBizCatalogId(const std::string& _bizCatalogId);

                    /**
                     * 判断参数 BizCatalogId 是否已赋值
                     * @return BizCatalogId 是否已赋值
                     * 
                     */
                    bool BizCatalogIdHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<QualityRuleExecResult> m_ruleExecResultVOList;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_bizCatalogName;
                    bool m_bizCatalogNameHasBeenSet;

                    /**
                     * 类目id
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_bizCatalogId;
                    bool m_bizCatalogIdHasBeenSet;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTQUALITYRULEGROUPEXECRESULT_H_
