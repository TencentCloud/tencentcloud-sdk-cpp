...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKSCHEDULINGPARAMETER_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKSCHEDULINGPARAMETER_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 任务调度变量参数
                */
                class TaskSchedulingParameter : public AbstractModel
                {
                public:
                    TaskSchedulingParameter();
                    ~TaskSchedulingParameter() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKSCHEDULINGPARAMETER_H_
