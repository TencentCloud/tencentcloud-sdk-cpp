...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTHRESHOLDVALUE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTHRESHOLDVALUE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 数据质量阈值
                */
                class QualityThresholdValue : public AbstractModel
                {
                public:
                    QualityThresholdValue();
                    ~QualityThresholdValue() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYTHRESHOLDVALUE_H_
