...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKEXTPARAMETER_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKEXTPARAMETER_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 任务扩展信息参数
                */
                class TaskExtParameter : public AbstractModel
                {
                public:
                    TaskExtParameter();
                    ~TaskExtParameter() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_TASKEXTPARAMETER_H_
