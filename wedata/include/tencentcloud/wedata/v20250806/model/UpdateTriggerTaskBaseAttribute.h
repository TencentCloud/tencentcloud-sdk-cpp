...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 更新任务基本属性信息
                */
                class UpdateTriggerTaskBaseAttribute : public AbstractModel
                {
                public:
                    UpdateTriggerTaskBaseAttribute();
                    ~UpdateTriggerTaskBaseAttribute() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETRIGGERTASKBASEATTRIBUTE_H_
