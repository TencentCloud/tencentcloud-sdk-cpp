...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_GETPROJECTREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_GETPROJECTREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * GetProject请求参数结构体
                */
                class GetProjectRequest : public AbstractModel
                {
                public:
                    GetProjectRequest();
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_GETPROJECTREQUEST_H_
