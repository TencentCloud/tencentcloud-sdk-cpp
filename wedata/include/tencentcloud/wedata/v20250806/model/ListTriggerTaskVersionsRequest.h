...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKVERSIONSREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKVERSIONSREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class ListTriggerTaskVersionsRequest : public AbstractModel
                {
                public:
                    ListTriggerTaskVersionsRequest();
                    ~ListTriggerTaskVersionsRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKVERSIONSREQUEST_H_
