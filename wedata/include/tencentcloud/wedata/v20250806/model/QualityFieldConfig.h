...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYFIELDCONFIG_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYFIELDCONFIG_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 字段变量
                */
                class QualityFieldConfig : public AbstractModel
                {
                public:
                    QualityFieldConfig();
                    ~QualityFieldConfig() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    QualityColumnValueConfig GetValueConfig() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetValueConfig(const QualityColumnValueConfig& _valueConfig);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    QualityColumnValueConfig m_valueConfig;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYFIELDCONFIG_H_
