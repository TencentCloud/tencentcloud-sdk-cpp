...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 数据质量规则
                */
                class QualityRule : public AbstractModel
                {
                public:
                    QualityRule();
                    ~QualityRule() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 设置目标表的数据目录
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _targetCatalogName 目标表的数据目录
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_QUALITYRULE_H_
