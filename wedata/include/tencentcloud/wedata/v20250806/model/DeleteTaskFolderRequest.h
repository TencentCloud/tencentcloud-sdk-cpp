...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETETASKFOLDERREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETETASKFOLDERREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class DeleteTaskFolderRequest : public AbstractModel
                {
                public:
                    DeleteTaskFolderRequest();
                    ~DeleteTaskFolderRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETETASKFOLDERREQUEST_H_
