...
CoreInternalOutcome DescribeApproveListResponse::Deserialize(const string &payload)
{
...
string DescribeApproveListResponse::ToJsonString() const
{
...
DescribeApply DescribeApproveListResponse::GetData() const
{
    return m_data;
}

bool DescribeApproveListResponse::DataHasBeenSet() const
{
