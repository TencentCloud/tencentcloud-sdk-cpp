...
ParamInfoDs::ParamInfoDs() :
    m_paramKeyHasBeenSet(false),
    m_paramValueHasBeenSet(false)
{
}

CoreInternalOutcome ParamInfoDs::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ParamKey") && !value["ParamKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ParamInfoDs.ParamKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParamValue") && !value["ParamValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ParamInfoDs.ParamValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ParamInfoDs::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string ParamInfoDs::GetParamKey() const
{
    return m_paramKey;
}

void ParamInfoDs::SetParamKey(const string& _paramKey)
{
    m_paramKey = _paramKey;
    m_paramKeyHasBeenSet = true;
}

bool ParamInfoDs::ParamKeyHasBeenSet() const
{
    return m_paramKeyHasBeenSet;
}

string ParamInfoDs::GetParamValue() const
{
    return m_paramValue;
}

void ParamInfoDs::SetParamValue(const string& _paramValue)
{
    m_paramValue = _paramValue;
    m_paramValueHasBeenSet = true;
}

bool ParamInfoDs::ParamValueHasBeenSet() const
{
