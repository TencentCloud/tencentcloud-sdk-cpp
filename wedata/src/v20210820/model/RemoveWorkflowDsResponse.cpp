...
CoreInternalOutcome RemoveWorkflowDsResponse::Deserialize(const string &payload)
{
...
string RemoveWorkflowDsResponse::ToJsonString() const
{
...
bool RemoveWorkflowDsResponse::GetData() const
{
    return m_data;
}

bool RemoveWorkflowDsResponse::DataHasBeenSet() const
{
