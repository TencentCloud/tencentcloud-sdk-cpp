...
CoreInternalOutcome DescribeRuleExecExportResultResponse::Deserialize(const string &payload)
{
...
string DescribeRuleExecExportResultResponse::ToJsonString() const
{
...
RuleExecExportResult DescribeRuleExecExportResultResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleExecExportResultResponse::DataHasBeenSet() const
{
