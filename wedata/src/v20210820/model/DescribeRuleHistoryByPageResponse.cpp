...
CoreInternalOutcome DescribeRuleHistoryByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleHistoryByPageResponse::ToJsonString() const
{
...
RuleHistoryPage DescribeRuleHistoryByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleHistoryByPageResponse::DataHasBeenSet() const
{
