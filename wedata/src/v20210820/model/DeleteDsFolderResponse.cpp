...
CoreInternalOutcome DeleteDsFolderResponse::Deserialize(const string &payload)
{
...
string DeleteDsFolderResponse::ToJsonString() const
{
...
bool DeleteDsFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteDsFolderResponse::DataHasBeenSet() const
{
