...
CoreInternalOutcome DescribeReportTaskListResponse::Deserialize(const string &payload)
{
...
string DescribeReportTaskListResponse::ToJsonString() const
{
...
ReportTaskListInfo DescribeReportTaskListResponse::GetData() const
{
    return m_data;
}

bool DescribeReportTaskListResponse::DataHasBeenSet() const
{
