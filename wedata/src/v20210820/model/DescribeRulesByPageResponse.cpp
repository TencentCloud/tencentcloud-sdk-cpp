...
CoreInternalOutcome DescribeRulesByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRulesByPageResponse::ToJsonString() const
{
...
RulePage DescribeRulesByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRulesByPageResponse::DataHasBeenSet() const
{
