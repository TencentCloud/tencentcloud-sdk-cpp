...
CoreInternalOutcome RunForceSucScheduleInstancesResponse::Deserialize(const string &payload)
{
...
string RunForceSucScheduleInstancesResponse::ToJsonString() const
{
...
BatchOperateResultOpsDto RunForceSucScheduleInstancesResponse::GetData() const
{
    return m_data;
}

bool RunForceSucScheduleInstancesResponse::DataHasBeenSet() const
{
