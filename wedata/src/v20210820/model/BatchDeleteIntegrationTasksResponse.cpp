...
CoreInternalOutcome BatchDeleteIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchDeleteIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchDeleteIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchDeleteIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchDeleteIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchDeleteIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchDeleteIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchDeleteIntegrationTasksResponse::TotalCountHasBeenSet() const
{
