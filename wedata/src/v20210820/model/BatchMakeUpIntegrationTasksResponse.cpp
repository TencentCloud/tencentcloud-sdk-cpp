...
CoreInternalOutcome BatchMakeUpIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchMakeUpIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchMakeUpIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchMakeUpIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchMakeUpIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchMakeUpIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchMakeUpIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchMakeUpIntegrationTasksResponse::TotalCountHasBeenSet() const
{
