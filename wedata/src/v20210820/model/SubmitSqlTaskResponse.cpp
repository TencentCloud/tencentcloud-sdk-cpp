...
CoreInternalOutcome SubmitSqlTaskResponse::Deserialize(const string &payload)
{
...
string SubmitSqlTaskResponse::ToJsonString() const
{
...
AdhocRecord SubmitSqlTaskResponse::GetRecord() const
{
    return m_record;
}

bool SubmitSqlTaskResponse::RecordHasBeenSet() const
{
    return m_recordHasBeenSet;
}

vector<AdhocDetail> SubmitSqlTaskResponse::GetDetails() const
{
    return m_details;
}

bool SubmitSqlTaskResponse::DetailsHasBeenSet() const
{
