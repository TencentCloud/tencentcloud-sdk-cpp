...
CoreInternalOutcome CreateInLongAgentResponse::Deserialize(const string &payload)
{
...
string CreateInLongAgentResponse::ToJsonString() const
{
...
string CreateInLongAgentResponse::GetAgentId() const
{
    return m_agentId;
}

bool CreateInLongAgentResponse::AgentIdHasBeenSet() const
{
