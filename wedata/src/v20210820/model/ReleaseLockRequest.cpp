...
string ReleaseLockRequest::ToJsonString() const
{
...
string ReleaseLockRequest::GetResourcePath() const
{
    return m_resourcePath;
}

void ReleaseLockRequest::SetResourcePath(const string& _resourcePath)
{
    m_resourcePath = _resourcePath;
    m_resourcePathHasBeenSet = true;
}

bool ReleaseLockRequest::ResourcePathHasBeenSet() const
{
