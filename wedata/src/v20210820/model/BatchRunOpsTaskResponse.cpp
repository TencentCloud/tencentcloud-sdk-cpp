...
CoreInternalOutcome BatchRunOpsTaskResponse::Deserialize(const string &payload)
{
...
string BatchRunOpsTaskResponse::ToJsonString() const
{
...
bool BatchRunOpsTaskResponse::GetData() const
{
    return m_data;
}

bool BatchRunOpsTaskResponse::DataHasBeenSet() const
{
