...
CoreInternalOutcome MakeUpTasksNewResponse::Deserialize(const string &payload)
{
...
string MakeUpTasksNewResponse::ToJsonString() const
{
...
BatchOperateResult MakeUpTasksNewResponse::GetData() const
{
    return m_data;
}

bool MakeUpTasksNewResponse::DataHasBeenSet() const
{
