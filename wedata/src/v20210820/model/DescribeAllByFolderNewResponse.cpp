...
CoreInternalOutcome DescribeAllByFolderNewResponse::Deserialize(const string &payload)
{
...
string DescribeAllByFolderNewResponse::ToJsonString() const
{
...
CollectionFolderOpsDto DescribeAllByFolderNewResponse::GetData() const
{
    return m_data;
}

bool DescribeAllByFolderNewResponse::DataHasBeenSet() const
{
