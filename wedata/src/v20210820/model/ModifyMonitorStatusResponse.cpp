...
CoreInternalOutcome ModifyMonitorStatusResponse::Deserialize(const string &payload)
{
...
string ModifyMonitorStatusResponse::ToJsonString() const
{
...
bool ModifyMonitorStatusResponse::GetData() const
{
    return m_data;
}

bool ModifyMonitorStatusResponse::DataHasBeenSet() const
{
