...
CoreInternalOutcome DescribeRuleGroupsByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupsByPageResponse::ToJsonString() const
{
...
RuleGroupPage DescribeRuleGroupsByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupsByPageResponse::DataHasBeenSet() const
{
