...
CoreInternalOutcome DescribeTableScoreTrendResponse::Deserialize(const string &payload)
{
...
string DescribeTableScoreTrendResponse::ToJsonString() const
{
...
QualityScoreTrend DescribeTableScoreTrendResponse::GetData() const
{
    return m_data;
}

bool DescribeTableScoreTrendResponse::DataHasBeenSet() const
{
