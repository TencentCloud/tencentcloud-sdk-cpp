...
CoreInternalOutcome MoveFileResponse::Deserialize(const string &payload)
{
...
string MoveFileResponse::ToJsonString() const
{
...
bool MoveFileResponse::GetResult() const
{
    return m_result;
}

bool MoveFileResponse::ResultHasBeenSet() const
{
