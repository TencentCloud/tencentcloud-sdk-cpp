...
CoreInternalOutcome DescribeWorkflowTaskCountResponse::Deserialize(const string &payload)
{
...
string DescribeWorkflowTaskCountResponse::ToJsonString() const
{
...
WorkflowTaskCountOpsDto DescribeWorkflowTaskCountResponse::GetData() const
{
    return m_data;
}

bool DescribeWorkflowTaskCountResponse::DataHasBeenSet() const
{
