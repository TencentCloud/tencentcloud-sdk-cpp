...
CoreInternalOutcome CountOpsInstanceStateResponse::Deserialize(const string &payload)
{
...
string CountOpsInstanceStateResponse::ToJsonString() const
{
...
TaskInstanceCountDto CountOpsInstanceStateResponse::GetData() const
{
    return m_data;
}

bool CountOpsInstanceStateResponse::DataHasBeenSet() const
{
