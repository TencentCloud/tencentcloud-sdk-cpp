...
CoreInternalOutcome ModifyWorkflowScheduleResponse::Deserialize(const string &payload)
{
...
string ModifyWorkflowScheduleResponse::ToJsonString() const
{
...
BatchResult ModifyWorkflowScheduleResponse::GetData() const
{
    return m_data;
}

bool ModifyWorkflowScheduleResponse::DataHasBeenSet() const
{
