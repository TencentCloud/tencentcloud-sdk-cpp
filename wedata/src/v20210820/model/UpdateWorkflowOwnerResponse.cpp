...
CoreInternalOutcome UpdateWorkflowOwnerResponse::Deserialize(const string &payload)
{
...
string UpdateWorkflowOwnerResponse::ToJsonString() const
{
...
BatchOperationOpsDto UpdateWorkflowOwnerResponse::GetData() const
{
    return m_data;
}

bool UpdateWorkflowOwnerResponse::DataHasBeenSet() const
{
