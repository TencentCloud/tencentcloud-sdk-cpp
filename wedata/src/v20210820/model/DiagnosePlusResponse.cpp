...
DiagnosePlusResponse::DiagnosePlusResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DiagnosePlusResponse::Deserialize(const string &payload)
{
...
string DiagnosePlusResponse::ToJsonString() const
{
...
string DiagnosePlusResponse::GetData() const
{
    return m_data;
}

bool DiagnosePlusResponse::DataHasBeenSet() const
{
