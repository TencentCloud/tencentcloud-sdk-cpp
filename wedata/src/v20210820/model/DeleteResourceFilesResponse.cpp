...
CoreInternalOutcome DeleteResourceFilesResponse::Deserialize(const string &payload)
{
...
string DeleteResourceFilesResponse::ToJsonString() const
{
...
bool DeleteResourceFilesResponse::GetData() const
{
    return m_data;
}

bool DeleteResourceFilesResponse::DataHasBeenSet() const
{
