...
CoreInternalOutcome LockIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string LockIntegrationTaskResponse::ToJsonString() const
{
...
bool LockIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool LockIntegrationTaskResponse::DataHasBeenSet() const
{
