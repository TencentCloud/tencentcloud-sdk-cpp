...
CoreInternalOutcome DescribeInLongAgentTaskListResponse::Deserialize(const string &payload)
{
...
string DescribeInLongAgentTaskListResponse::ToJsonString() const
{
...
vector<InLongAgentTask> DescribeInLongAgentTaskListResponse::GetItems() const
{
    return m_items;
}

bool DescribeInLongAgentTaskListResponse::ItemsHasBeenSet() const
{
