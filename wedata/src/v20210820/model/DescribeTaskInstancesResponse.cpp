...
CoreInternalOutcome DescribeTaskInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeTaskInstancesResponse::ToJsonString() const
{
...
DescribeTaskInstancesData DescribeTaskInstancesResponse::GetData() const
{
    return m_data;
}

bool DescribeTaskInstancesResponse::DataHasBeenSet() const
{
