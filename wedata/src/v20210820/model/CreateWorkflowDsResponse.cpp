...
CoreInternalOutcome CreateWorkflowDsResponse::Deserialize(const string &payload)
{
...
string CreateWorkflowDsResponse::ToJsonString() const
{
...
string CreateWorkflowDsResponse::GetData() const
{
    return m_data;
}

bool CreateWorkflowDsResponse::DataHasBeenSet() const
{
