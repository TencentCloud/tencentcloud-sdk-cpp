...
CoreInternalOutcome DescribeMonitorsByPageResponse::Deserialize(const string &payload)
{
...
string DescribeMonitorsByPageResponse::ToJsonString() const
{
...
RuleGroupMonitorPage DescribeMonitorsByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeMonitorsByPageResponse::DataHasBeenSet() const
{
