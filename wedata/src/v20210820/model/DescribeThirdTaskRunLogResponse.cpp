...
CoreInternalOutcome DescribeThirdTaskRunLogResponse::Deserialize(const string &payload)
{
...
string DescribeThirdTaskRunLogResponse::ToJsonString() const
{
...
string DescribeThirdTaskRunLogResponse::GetData() const
{
    return m_data;
}

bool DescribeThirdTaskRunLogResponse::DataHasBeenSet() const
{
