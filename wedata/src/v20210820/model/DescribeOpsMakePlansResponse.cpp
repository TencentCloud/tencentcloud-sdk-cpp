...
CoreInternalOutcome DescribeOpsMakePlansResponse::Deserialize(const string &payload)
{
...
string DescribeOpsMakePlansResponse::ToJsonString() const
{
...
MakePlanOpsDtoCollection DescribeOpsMakePlansResponse::GetData() const
{
    return m_data;
}

bool DescribeOpsMakePlansResponse::DataHasBeenSet() const
{
