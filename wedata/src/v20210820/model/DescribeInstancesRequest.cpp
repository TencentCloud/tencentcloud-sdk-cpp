...
string DescribeInstancesRequest::GetProjectId() const
{
    return m_projectId;
}

void DescribeInstancesRequest::SetProjectId(const string& _projectId)
{
...
uint64_t DescribeInstancesRequest::GetPageNumber() const
{
    return m_pageNumber;
}

void DescribeInstancesRequest::SetPageNumber(const uint64_t& _pageNumber)
{
...
uint64_t DescribeInstancesRequest::GetPageSize() const
{
    return m_pageSize;
}

void DescribeInstancesRequest::SetPageSize(const uint64_t& _pageSize)
{
