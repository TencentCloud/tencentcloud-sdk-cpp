...
CoreInternalOutcome DescribeRuleTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeRuleTemplateResponse::ToJsonString() const
{
...
RuleTemplate DescribeRuleTemplateResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleTemplateResponse::DataHasBeenSet() const
{
