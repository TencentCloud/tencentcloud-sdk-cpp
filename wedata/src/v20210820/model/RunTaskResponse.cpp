...
CoreInternalOutcome RunTaskResponse::Deserialize(const string &payload)
{
...
string RunTaskResponse::ToJsonString() const
{
...
bool RunTaskResponse::GetData() const
{
    return m_data;
}

bool RunTaskResponse::DataHasBeenSet() const
{
