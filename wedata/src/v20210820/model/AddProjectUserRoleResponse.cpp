...
CoreInternalOutcome AddProjectUserRoleResponse::Deserialize(const string &payload)
{
...
string AddProjectUserRoleResponse::ToJsonString() const
{
...
bool AddProjectUserRoleResponse::GetData() const
{
    return m_data;
}

bool AddProjectUserRoleResponse::DataHasBeenSet() const
{
