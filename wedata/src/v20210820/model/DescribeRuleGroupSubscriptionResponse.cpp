...
CoreInternalOutcome DescribeRuleGroupSubscriptionResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupSubscriptionResponse::ToJsonString() const
{
...
RuleGroupSubscribe DescribeRuleGroupSubscriptionResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupSubscriptionResponse::DataHasBeenSet() const
{
