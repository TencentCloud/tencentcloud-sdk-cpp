...
CoreInternalOutcome RunRerunScheduleInstancesResponse::Deserialize(const string &payload)
{
...
string RunRerunScheduleInstancesResponse::ToJsonString() const
{
...
BatchOperateResultOpsDto RunRerunScheduleInstancesResponse::GetData() const
{
    return m_data;
}

bool RunRerunScheduleInstancesResponse::DataHasBeenSet() const
{
