...
CoreInternalOutcome CreatePathResponse::Deserialize(const string &payload)
{
...
string CreatePathResponse::ToJsonString() const
{
...
bool CreatePathResponse::GetResult() const
{
    return m_result;
}

bool CreatePathResponse::ResultHasBeenSet() const
{
