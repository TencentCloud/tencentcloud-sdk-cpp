...
CoreInternalOutcome DescribeFolderWorkflowListResponse::Deserialize(const string &payload)
{
...
string DescribeFolderWorkflowListResponse::ToJsonString() const
{
...
DescribeFolderWorkflowListData DescribeFolderWorkflowListResponse::GetData() const
{
    return m_data;
}

bool DescribeFolderWorkflowListResponse::DataHasBeenSet() const
{
