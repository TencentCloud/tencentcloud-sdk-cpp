...
CoreInternalOutcome DescribeRuleTablesByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleTablesByPageResponse::ToJsonString() const
{
...
RuleGroupPage DescribeRuleTablesByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleTablesByPageResponse::DataHasBeenSet() const
{
