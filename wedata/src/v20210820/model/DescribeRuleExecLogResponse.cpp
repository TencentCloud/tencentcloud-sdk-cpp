...
CoreInternalOutcome DescribeRuleExecLogResponse::Deserialize(const string &payload)
{
...
string DescribeRuleExecLogResponse::ToJsonString() const
{
...
RuleExecLog DescribeRuleExecLogResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleExecLogResponse::DataHasBeenSet() const
{
