...
CoreInternalOutcome SubmitWorkflowResponse::Deserialize(const string &payload)
{
...
string SubmitWorkflowResponse::ToJsonString() const
{
...
SubmitWorkflow SubmitWorkflowResponse::GetData() const
{
    return m_data;
}

bool SubmitWorkflowResponse::DataHasBeenSet() const
{
