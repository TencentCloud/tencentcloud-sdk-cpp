...
CoreInternalOutcome DescribeOpsMakePlanInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeOpsMakePlanInstancesResponse::ToJsonString() const
{
...
MakePlanInstanceOpsDtoCollection DescribeOpsMakePlanInstancesResponse::GetData() const
{
    return m_data;
}

bool DescribeOpsMakePlanInstancesResponse::DataHasBeenSet() const
{
