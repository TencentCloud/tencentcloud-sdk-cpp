...
RollbackCustomFunctionVersionResponse::RollbackCustomFunctionVersionResponse() :
    m_functionIdHasBeenSet(false),
    m_errorMessageHasBeenSet(false)
{
}

CoreInternalOutcome RollbackCustomFunctionVersionResponse::Deserialize(const string &payload)
{
...
string RollbackCustomFunctionVersionResponse::ToJsonString() const
{
...
string RollbackCustomFunctionVersionResponse::GetFunctionId() const
{
    return m_functionId;
}

bool RollbackCustomFunctionVersionResponse::FunctionIdHasBeenSet() const
{
    return m_functionIdHasBeenSet;
}

string RollbackCustomFunctionVersionResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool RollbackCustomFunctionVersionResponse::ErrorMessageHasBeenSet() const
{
