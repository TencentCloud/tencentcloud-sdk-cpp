...
CoreInternalOutcome FreezeTasksByWorkflowIdsResponse::Deserialize(const string &payload)
{
...
string FreezeTasksByWorkflowIdsResponse::ToJsonString() const
{
...
OperationOpsDto FreezeTasksByWorkflowIdsResponse::GetData() const
{
    return m_data;
}

bool FreezeTasksByWorkflowIdsResponse::DataHasBeenSet() const
{
