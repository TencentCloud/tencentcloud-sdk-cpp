...
CoreInternalOutcome FreezeOpsTasksResponse::Deserialize(const string &payload)
{
...
string FreezeOpsTasksResponse::ToJsonString() const
{
...
bool FreezeOpsTasksResponse::GetData() const
{
    return m_data;
}

bool FreezeOpsTasksResponse::DataHasBeenSet() const
{
