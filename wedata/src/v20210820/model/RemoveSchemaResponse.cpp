...
RemoveSchemaResponse::RemoveSchemaResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome RemoveSchemaResponse::Deserialize(const string &payload)
{
...
string RemoveSchemaResponse::ToJsonString() const
{
...
string RemoveSchemaResponse::GetJobId() const
{
    return m_jobId;
}

bool RemoveSchemaResponse::JobIdHasBeenSet() const
{
