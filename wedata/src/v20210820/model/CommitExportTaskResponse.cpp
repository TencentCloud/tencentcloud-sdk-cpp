...
CoreInternalOutcome CommitExportTaskResponse::Deserialize(const string &payload)
{
...
string CommitExportTaskResponse::ToJsonString() const
{
...
bool CommitExportTaskResponse::GetData() const
{
    return m_data;
}

bool CommitExportTaskResponse::DataHasBeenSet() const
{
