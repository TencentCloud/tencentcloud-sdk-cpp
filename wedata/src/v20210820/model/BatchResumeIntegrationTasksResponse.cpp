...
CoreInternalOutcome BatchResumeIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchResumeIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchResumeIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchResumeIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchResumeIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchResumeIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchResumeIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchResumeIntegrationTasksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<string> BatchResumeIntegrationTasksResponse::GetTaskNames() const
{
    return m_taskNames;
}

bool BatchResumeIntegrationTasksResponse::TaskNamesHasBeenSet() const
{
