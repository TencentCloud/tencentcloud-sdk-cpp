...
CoreInternalOutcome UnlockIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string UnlockIntegrationTaskResponse::ToJsonString() const
{
...
bool UnlockIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool UnlockIntegrationTaskResponse::DataHasBeenSet() const
{
