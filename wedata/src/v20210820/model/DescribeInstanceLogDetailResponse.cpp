...
CoreInternalOutcome DescribeInstanceLogDetailResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceLogDetailResponse::ToJsonString() const
{
...
InstanceLogInfoOpsDto DescribeInstanceLogDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeInstanceLogDetailResponse::DataHasBeenSet() const
{
