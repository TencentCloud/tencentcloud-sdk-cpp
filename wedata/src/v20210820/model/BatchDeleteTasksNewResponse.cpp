...
CoreInternalOutcome BatchDeleteTasksNewResponse::Deserialize(const string &payload)
{
...
string BatchDeleteTasksNewResponse::ToJsonString() const
{
...
BatchOperateResult BatchDeleteTasksNewResponse::GetData() const
{
    return m_data;
}

bool BatchDeleteTasksNewResponse::DataHasBeenSet() const
{
