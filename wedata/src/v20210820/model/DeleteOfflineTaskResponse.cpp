...
CoreInternalOutcome DeleteOfflineTaskResponse::Deserialize(const string &payload)
{
...
string DeleteOfflineTaskResponse::ToJsonString() const
{
...
bool DeleteOfflineTaskResponse::GetData() const
{
    return m_data;
}

bool DeleteOfflineTaskResponse::DataHasBeenSet() const
{
