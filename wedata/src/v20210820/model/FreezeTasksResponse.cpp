...
CoreInternalOutcome FreezeTasksResponse::Deserialize(const string &payload)
{
...
string FreezeTasksResponse::ToJsonString() const
{
...
OperateResult FreezeTasksResponse::GetData() const
{
    return m_data;
}

bool FreezeTasksResponse::DataHasBeenSet() const
{
