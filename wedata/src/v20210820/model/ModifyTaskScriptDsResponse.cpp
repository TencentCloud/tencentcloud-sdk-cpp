...
ModifyTaskScriptDsResponse::ModifyTaskScriptDsResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome ModifyTaskScriptDsResponse::Deserialize(const string &payload)
{
...
string ModifyTaskScriptDsResponse::ToJsonString() const
{
...
string ModifyTaskScriptDsResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskScriptDsResponse::DataHasBeenSet() const
{
