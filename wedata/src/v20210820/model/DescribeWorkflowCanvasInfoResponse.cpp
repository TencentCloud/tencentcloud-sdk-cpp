...
CoreInternalOutcome DescribeWorkflowCanvasInfoResponse::Deserialize(const string &payload)
{
...
string DescribeWorkflowCanvasInfoResponse::ToJsonString() const
{
...
WorkflowCanvasOpsDto DescribeWorkflowCanvasInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeWorkflowCanvasInfoResponse::DataHasBeenSet() const
{
