...
CoreInternalOutcome DescribeOperateOpsTasksResponse::Deserialize(const string &payload)
{
...
string DescribeOperateOpsTasksResponse::ToJsonString() const
{
...
OpsTaskInfoPage DescribeOperateOpsTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeOperateOpsTasksResponse::DataHasBeenSet() const
{
