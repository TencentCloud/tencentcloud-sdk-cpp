...
CoreInternalOutcome BatchSuspendIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchSuspendIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchSuspendIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchSuspendIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchSuspendIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchSuspendIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchSuspendIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchSuspendIntegrationTasksResponse::TotalCountHasBeenSet() const
{
