...
CoreInternalOutcome SuspendIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string SuspendIntegrationTaskResponse::ToJsonString() const
{
...
bool SuspendIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool SuspendIntegrationTaskResponse::DataHasBeenSet() const
{
