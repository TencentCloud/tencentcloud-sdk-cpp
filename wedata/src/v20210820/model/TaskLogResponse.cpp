...
CoreInternalOutcome TaskLogResponse::Deserialize(const string &payload)
{
...
string TaskLogResponse::ToJsonString() const
{
...
vector<LogContent> TaskLogResponse::GetLogContentList() const
{
    return m_logContentList;
}

bool TaskLogResponse::LogContentListHasBeenSet() const
{
