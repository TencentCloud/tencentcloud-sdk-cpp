...
CoreInternalOutcome ModifyDimensionWeightResponse::Deserialize(const string &payload)
{
...
string ModifyDimensionWeightResponse::ToJsonString() const
{
...
bool ModifyDimensionWeightResponse::GetData() const
{
    return m_data;
}

bool ModifyDimensionWeightResponse::DataHasBeenSet() const
{
