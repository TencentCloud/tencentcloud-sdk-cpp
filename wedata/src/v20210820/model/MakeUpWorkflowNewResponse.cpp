...
CoreInternalOutcome MakeUpWorkflowNewResponse::Deserialize(const string &payload)
{
...
string MakeUpWorkflowNewResponse::ToJsonString() const
{
...
BatchOperateResult MakeUpWorkflowNewResponse::GetData() const
{
    return m_data;
}

bool MakeUpWorkflowNewResponse::DataHasBeenSet() const
{
