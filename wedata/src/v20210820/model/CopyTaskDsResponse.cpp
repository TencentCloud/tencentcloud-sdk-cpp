...
CopyTaskDsResponse::CopyTaskDsResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CopyTaskDsResponse::Deserialize(const string &payload)
{
...
string CopyTaskDsResponse::ToJsonString() const
{
...
string CopyTaskDsResponse::GetData() const
{
    return m_data;
}

bool CopyTaskDsResponse::DataHasBeenSet() const
{
