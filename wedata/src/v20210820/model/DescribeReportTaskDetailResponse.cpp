...
CoreInternalOutcome DescribeReportTaskDetailResponse::Deserialize(const string &payload)
{
...
string DescribeReportTaskDetailResponse::ToJsonString() const
{
...
ReportTaskDetail DescribeReportTaskDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeReportTaskDetailResponse::DataHasBeenSet() const
{
