...
CoreInternalOutcome DeleteTaskAlarmRegularResponse::Deserialize(const string &payload)
{
...
string DeleteTaskAlarmRegularResponse::ToJsonString() const
{
...
bool DeleteTaskAlarmRegularResponse::GetData() const
{
    return m_data;
}

bool DeleteTaskAlarmRegularResponse::DataHasBeenSet() const
{
