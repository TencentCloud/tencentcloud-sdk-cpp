...
LineageNodeInfoVO::LineageNodeInfoVO() :
...
CoreInternalOutcome LineageNodeInfoVO::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CurrentResource") && !value["CurrentResource"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.CurrentResource` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Relation") && !value["Relation"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.Relation` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DownStreamCount") && !value["DownStreamCount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.DownStreamCount` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UpStreamCount") && !value["UpStreamCount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.UpStreamCount` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParentSet") && !value["ParentSet"].IsNull())
    {
        if (!value["ParentSet"].IsArray())
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.ParentSet` is not array type"));
    ...
    if (value.HasMember("ChildSet") && !value["ChildSet"].IsNull())
    {
        if (!value["ChildSet"].IsArray())
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.ChildSet` is not array type"));
    ...
    if (value.HasMember("StreamCountFlag") && !value["StreamCountFlag"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LineageNodeInfoVO.StreamCountFlag` IsBool=false incorrectly").SetRequestId(requestId));
        }
...
void LineageNodeInfoVO::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
LineageResouce LineageNodeInfoVO::GetCurrentResource() const
{
    return m_currentResource;
}

void LineageNodeInfoVO::SetCurrentResource(const LineageResouce& _currentResource)
{
    m_currentResource = _currentResource;
    m_currentResourceHasBeenSet = true;
}

bool LineageNodeInfoVO::CurrentResourceHasBeenSet() const
{
    return m_currentResourceHasBeenSet;
}

LineageRelationVO LineageNodeInfoVO::GetRelation() const
{
    return m_relation;
}

void LineageNodeInfoVO::SetRelation(const LineageRelationVO& _relation)
{
    m_relation = _relation;
    m_relationHasBeenSet = true;
}

bool LineageNodeInfoVO::RelationHasBeenSet() const
{
    return m_relationHasBeenSet;
}

int64_t LineageNodeInfoVO::GetDownStreamCount() const
{
    return m_downStreamCount;
}

void LineageNodeInfoVO::SetDownStreamCount(const int64_t& _downStreamCount)
{
    m_downStreamCount = _downStreamCount;
    m_downStreamCountHasBeenSet = true;
}

bool LineageNodeInfoVO::DownStreamCountHasBeenSet() const
{
    return m_downStreamCountHasBeenSet;
}

int64_t LineageNodeInfoVO::GetUpStreamCount() const
{
    return m_upStreamCount;
}

void LineageNodeInfoVO::SetUpStreamCount(const int64_t& _upStreamCount)
{
    m_upStreamCount = _upStreamCount;
    m_upStreamCountHasBeenSet = true;
}

bool LineageNodeInfoVO::UpStreamCountHasBeenSet() const
{
    return m_upStreamCountHasBeenSet;
}

vector<LineageNodeInfoVO> LineageNodeInfoVO::GetParentSet() const
{
    return m_parentSet;
}

void LineageNodeInfoVO::SetParentSet(const vector<LineageNodeInfoVO>& _parentSet)
{
    m_parentSet = _parentSet;
    m_parentSetHasBeenSet = true;
}

bool LineageNodeInfoVO::ParentSetHasBeenSet() const
{
    return m_parentSetHasBeenSet;
}

vector<LineageNodeInfoVO> LineageNodeInfoVO::GetChildSet() const
{
    return m_childSet;
}

void LineageNodeInfoVO::SetChildSet(const vector<LineageNodeInfoVO>& _childSet)
{
    m_childSet = _childSet;
    m_childSetHasBeenSet = true;
}

bool LineageNodeInfoVO::ChildSetHasBeenSet() const
{
    return m_childSetHasBeenSet;
}

bool LineageNodeInfoVO::GetStreamCountFlag() const
{
    return m_streamCountFlag;
}

void LineageNodeInfoVO::SetStreamCountFlag(const bool& _streamCountFlag)
{
    m_streamCountFlag = _streamCountFlag;
    m_streamCountFlagHasBeenSet = true;
}

bool LineageNodeInfoVO::StreamCountFlagHasBeenSet() const
{
