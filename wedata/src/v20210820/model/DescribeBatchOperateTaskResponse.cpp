...
CoreInternalOutcome DescribeBatchOperateTaskResponse::Deserialize(const string &payload)
{
...
string DescribeBatchOperateTaskResponse::ToJsonString() const
{
...
DescribeBatchOperateTaskPage DescribeBatchOperateTaskResponse::GetData() const
{
    return m_data;
}

bool DescribeBatchOperateTaskResponse::DataHasBeenSet() const
{
