...
CoreInternalOutcome TriggerEventResponse::Deserialize(const string &payload)
{
...
string TriggerEventResponse::ToJsonString() const
{
...
BatchReturn TriggerEventResponse::GetData() const
{
    return m_data;
}

bool TriggerEventResponse::DataHasBeenSet() const
{
