...
CoreInternalOutcome RerunInstancesResponse::Deserialize(const string &payload)
{
...
string RerunInstancesResponse::ToJsonString() const
{
...
OperateResult RerunInstancesResponse::GetData() const
{
    return m_data;
}

bool RerunInstancesResponse::DataHasBeenSet() const
{
