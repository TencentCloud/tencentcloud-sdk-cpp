...
CoreInternalOutcome BatchModifyOpsOwnersResponse::Deserialize(const string &payload)
{
...
string BatchModifyOpsOwnersResponse::ToJsonString() const
{
...
BatchOperationOpsDto BatchModifyOpsOwnersResponse::GetData() const
{
    return m_data;
}

bool BatchModifyOpsOwnersResponse::DataHasBeenSet() const
{
