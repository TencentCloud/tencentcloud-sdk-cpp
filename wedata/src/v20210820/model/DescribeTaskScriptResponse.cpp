...
CoreInternalOutcome DescribeTaskScriptResponse::Deserialize(const string &payload)
{
...
string DescribeTaskScriptResponse::ToJsonString() const
{
...
TaskScriptContent DescribeTaskScriptResponse::GetData() const
{
    return m_data;
}

bool DescribeTaskScriptResponse::DataHasBeenSet() const
{
