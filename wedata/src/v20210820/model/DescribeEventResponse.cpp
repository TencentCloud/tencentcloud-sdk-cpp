...
CoreInternalOutcome DescribeEventResponse::Deserialize(const string &payload)
{
...
string DescribeEventResponse::ToJsonString() const
{
...
EventOpsDto DescribeEventResponse::GetData() const
{
    return m_data;
}

bool DescribeEventResponse::DataHasBeenSet() const
{
