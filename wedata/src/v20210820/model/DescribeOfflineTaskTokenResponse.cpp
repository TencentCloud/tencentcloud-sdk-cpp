...
CoreInternalOutcome DescribeOfflineTaskTokenResponse::Deserialize(const string &payload)
{
...
string DescribeOfflineTaskTokenResponse::ToJsonString() const
{
...
string DescribeOfflineTaskTokenResponse::GetToken() const
{
    return m_token;
}
