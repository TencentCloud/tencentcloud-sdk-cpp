...
CoreInternalOutcome RegisterEventResponse::Deserialize(const string &payload)
{
...
string RegisterEventResponse::ToJsonString() const
{
...
BatchReturn RegisterEventResponse::GetData() const
{
    return m_data;
}

bool RegisterEventResponse::DataHasBeenSet() const
{
