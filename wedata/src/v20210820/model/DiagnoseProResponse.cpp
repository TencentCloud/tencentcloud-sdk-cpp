...
CoreInternalOutcome DiagnoseProResponse::Deserialize(const string &payload)
{
...
string DiagnoseProResponse::ToJsonString() const
{
...
DiagnoseRep DiagnoseProResponse::GetData() const
{
    return m_data;
}

bool DiagnoseProResponse::DataHasBeenSet() const
{
