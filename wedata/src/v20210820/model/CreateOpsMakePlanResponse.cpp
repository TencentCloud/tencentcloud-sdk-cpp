...
CoreInternalOutcome CreateOpsMakePlanResponse::Deserialize(const string &payload)
{
...
string CreateOpsMakePlanResponse::ToJsonString() const
{
...
CommonIdOpsDto CreateOpsMakePlanResponse::GetData() const
{
    return m_data;
}

bool CreateOpsMakePlanResponse::DataHasBeenSet() const
{
