...
SubmitShellTaskResponse::SubmitShellTaskResponse() :
    m_recordHasBeenSet(false),
    m_detailsHasBeenSet(false)
{
}

CoreInternalOutcome SubmitShellTaskResponse::Deserialize(const string &payload)
{
...
string SubmitShellTaskResponse::ToJsonString() const
{
...
AdhocRecord SubmitShellTaskResponse::GetRecord() const
{
    return m_record;
}

bool SubmitShellTaskResponse::RecordHasBeenSet() const
{
    return m_recordHasBeenSet;
}

vector<AdhocDetail> SubmitShellTaskResponse::GetDetails() const
{
    return m_details;
}

bool SubmitShellTaskResponse::DetailsHasBeenSet() const
{
