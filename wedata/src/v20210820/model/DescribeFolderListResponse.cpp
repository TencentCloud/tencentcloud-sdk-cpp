...
CoreInternalOutcome DescribeFolderListResponse::Deserialize(const string &payload)
{
...
string DescribeFolderListResponse::ToJsonString() const
{
...
DescribeFolderListData DescribeFolderListResponse::GetData() const
{
    return m_data;
}

bool DescribeFolderListResponse::DataHasBeenSet() const
{
