...
CoreInternalOutcome RegisterEventListenerResponse::Deserialize(const string &payload)
{
...
string RegisterEventListenerResponse::ToJsonString() const
{
...
BatchReturn RegisterEventListenerResponse::GetData() const
{
    return m_data;
}

bool RegisterEventListenerResponse::DataHasBeenSet() const
{
