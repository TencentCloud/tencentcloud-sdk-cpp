...
CoreInternalOutcome CreateTaskVersionDsResponse::Deserialize(const string &payload)
{
...
string CreateTaskVersionDsResponse::ToJsonString() const
{
...
string CreateTaskVersionDsResponse::GetData() const
{
    return m_data;
}

bool CreateTaskVersionDsResponse::DataHasBeenSet() const
{
