...
SubmitPySparkTaskResponse::SubmitPySparkTaskResponse() :
    m_recordHasBeenSet(false),
    m_detailsHasBeenSet(false)
{
}

CoreInternalOutcome SubmitPySparkTaskResponse::Deserialize(const string &payload)
{
...
string SubmitPySparkTaskResponse::ToJsonString() const
{
...
AdhocRecord SubmitPySparkTaskResponse::GetRecord() const
{
    return m_record;
}

bool SubmitPySparkTaskResponse::RecordHasBeenSet() const
{
    return m_recordHasBeenSet;
}

vector<AdhocDetail> SubmitPySparkTaskResponse::GetDetails() const
{
    return m_details;
}

bool SubmitPySparkTaskResponse::DetailsHasBeenSet() const
{
