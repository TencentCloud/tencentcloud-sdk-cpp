...
CoreInternalOutcome CheckDuplicateRuleNameResponse::Deserialize(const string &payload)
{
...
string CheckDuplicateRuleNameResponse::ToJsonString() const
{
...
bool CheckDuplicateRuleNameResponse::GetData() const
{
    return m_data;
}

bool CheckDuplicateRuleNameResponse::DataHasBeenSet() const
{
