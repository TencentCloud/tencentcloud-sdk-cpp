...
CoreInternalOutcome CreateHiveTableResponse::Deserialize(const string &payload)
{
...
string CreateHiveTableResponse::ToJsonString() const
{
...
bool CreateHiveTableResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool CreateHiveTableResponse::IsSuccessHasBeenSet() const
{
