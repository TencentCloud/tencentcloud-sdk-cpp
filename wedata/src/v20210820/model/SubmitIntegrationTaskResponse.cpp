...
SubmitIntegrationTaskResponse::SubmitIntegrationTaskResponse() :
    m_recordHasBeenSet(false),
    m_detailsHasBeenSet(false)
{
}

CoreInternalOutcome SubmitIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string SubmitIntegrationTaskResponse::ToJsonString() const
{
...
AdhocRecord SubmitIntegrationTaskResponse::GetRecord() const
{
    return m_record;
}

bool SubmitIntegrationTaskResponse::RecordHasBeenSet() const
{
    return m_recordHasBeenSet;
}

vector<AdhocDetail> SubmitIntegrationTaskResponse::GetDetails() const
{
    return m_details;
}

bool SubmitIntegrationTaskResponse::DetailsHasBeenSet() const
{
