...
CoreInternalOutcome InstanceInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TaskId") && !value["TaskId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceInfo.TaskId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CurRunDate") && !value["CurRunDate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceInfo.CurRunDate` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string InstanceInfo::GetTaskId() const
{
    return m_taskId;
}

void InstanceInfo::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
    m_taskIdHasBeenSet = true;
}

bool InstanceInfo::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string InstanceInfo::GetCurRunDate() const
{
    return m_curRunDate;
}

void InstanceInfo::SetCurRunDate(const string& _curRunDate)
{
    m_curRunDate = _curRunDate;
    m_curRunDateHasBeenSet = true;
}

bool InstanceInfo::CurRunDateHasBeenSet() const
{
