...
CoreInternalOutcome ModifyTaskNameResponse::Deserialize(const string &payload)
{
...
string ModifyTaskNameResponse::ToJsonString() const
{
...
bool ModifyTaskNameResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskNameResponse::DataHasBeenSet() const
{
