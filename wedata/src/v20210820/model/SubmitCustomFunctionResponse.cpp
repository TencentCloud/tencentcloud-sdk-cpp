...
CoreInternalOutcome SubmitCustomFunctionResponse::Deserialize(const string &payload)
{
...
string SubmitCustomFunctionResponse::ToJsonString() const
{
...
string SubmitCustomFunctionResponse::GetFunctionId() const
{
    return m_functionId;
}

bool SubmitCustomFunctionResponse::FunctionIdHasBeenSet() const
{
    return m_functionIdHasBeenSet;
}

string SubmitCustomFunctionResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool SubmitCustomFunctionResponse::ErrorMessageHasBeenSet() const
{
