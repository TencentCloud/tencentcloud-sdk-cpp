...
CoreInternalOutcome ListInstancesResponse::Deserialize(const string &payload)
{
...
string ListInstancesResponse::ToJsonString() const
{
...
InstancePageVO ListInstancesResponse::GetData() const
{
    return m_data;
}

bool ListInstancesResponse::DataHasBeenSet() const
{
