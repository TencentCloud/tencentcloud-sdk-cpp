...
CoreInternalOutcome DeleteIntegrationNodeResponse::Deserialize(const string &payload)
{
...
string DeleteIntegrationNodeResponse::ToJsonString() const
{
...
bool DeleteIntegrationNodeResponse::GetData() const
{
    return m_data;
}

bool DeleteIntegrationNodeResponse::DataHasBeenSet() const
{
