...
CoreInternalOutcome DescribeInLongTkeClusterListResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["PageIndex"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `PageIndex` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_pageIndex = rsp["PageIndex"].GetUint64();
...
string DescribeInLongTkeClusterListResponse::ToJsonString() const
{
...
vector<InLongTkeDetail> DescribeInLongTkeClusterListResponse::GetItems() const
{
    return m_items;
}

bool DescribeInLongTkeClusterListResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t DescribeInLongTkeClusterListResponse::GetPageIndex() const
{
    return m_pageIndex;
}

bool DescribeInLongTkeClusterListResponse::PageIndexHasBeenSet() const
{
    return m_pageIndexHasBeenSet;
}

uint64_t DescribeInLongTkeClusterListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeInLongTkeClusterListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeInLongTkeClusterListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInLongTkeClusterListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeInLongTkeClusterListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeInLongTkeClusterListResponse::TotalPageHasBeenSet() const
{
