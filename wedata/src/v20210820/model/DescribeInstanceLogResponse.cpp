...
CoreInternalOutcome DescribeInstanceLogResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceLogResponse::ToJsonString() const
{
...
string DescribeInstanceLogResponse::GetData() const
{
    return m_data;
}
