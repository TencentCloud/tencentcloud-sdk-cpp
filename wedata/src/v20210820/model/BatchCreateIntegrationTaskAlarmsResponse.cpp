...
CoreInternalOutcome BatchCreateIntegrationTaskAlarmsResponse::Deserialize(const string &payload)
{
...
string BatchCreateIntegrationTaskAlarmsResponse::ToJsonString() const
{
...
int64_t BatchCreateIntegrationTaskAlarmsResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchCreateIntegrationTaskAlarmsResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchCreateIntegrationTaskAlarmsResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchCreateIntegrationTaskAlarmsResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchCreateIntegrationTaskAlarmsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchCreateIntegrationTaskAlarmsResponse::TotalCountHasBeenSet() const
{
