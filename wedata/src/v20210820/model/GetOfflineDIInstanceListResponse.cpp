...
CoreInternalOutcome GetOfflineDIInstanceListResponse::Deserialize(const string &payload)
{
...
string GetOfflineDIInstanceListResponse::ToJsonString() const
{
...
uint64_t GetOfflineDIInstanceListResponse::GetTotal() const
{
    return m_total;
}

bool GetOfflineDIInstanceListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<OfflineInstance> GetOfflineDIInstanceListResponse::GetList() const
{
    return m_list;
}

bool GetOfflineDIInstanceListResponse::ListHasBeenSet() const
{
