...
CoreInternalOutcome CommitRuleGroupTaskResponse::Deserialize(const string &payload)
{
...
string CommitRuleGroupTaskResponse::ToJsonString() const
{
...
RuleGroupExecResult CommitRuleGroupTaskResponse::GetData() const
{
    return m_data;
}

bool CommitRuleGroupTaskResponse::DataHasBeenSet() const
{
