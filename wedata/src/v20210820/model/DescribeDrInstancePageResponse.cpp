...
CoreInternalOutcome DescribeDrInstancePageResponse::Deserialize(const string &payload)
{
...
string DescribeDrInstancePageResponse::ToJsonString() const
{
...
DrInstanceOpsDtoPage DescribeDrInstancePageResponse::GetData() const
{
    return m_data;
}

bool DescribeDrInstancePageResponse::DataHasBeenSet() const
{
