...
CoreInternalOutcome DeleteProjectParamDsResponse::Deserialize(const string &payload)
{
...
string DeleteProjectParamDsResponse::ToJsonString() const
{
...
bool DeleteProjectParamDsResponse::GetData() const
{
    return m_data;
}

bool DeleteProjectParamDsResponse::DataHasBeenSet() const
{
