...
CoreInternalOutcome BatchStopTasksNewResponse::Deserialize(const string &payload)
{
...
string BatchStopTasksNewResponse::ToJsonString() const
{
...
BatchOperateResult BatchStopTasksNewResponse::GetData() const
{
    return m_data;
}

bool BatchStopTasksNewResponse::DataHasBeenSet() const
{
