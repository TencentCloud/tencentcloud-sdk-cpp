...
CoreInternalOutcome ReleaseLockResponse::Deserialize(const string &payload)
{
...
string ReleaseLockResponse::ToJsonString() const
{
...
bool ReleaseLockResponse::GetSuccess() const
{
    return m_success;
}

bool ReleaseLockResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

string ReleaseLockResponse::GetResourcePath() const
{
    return m_resourcePath;
}

bool ReleaseLockResponse::ResourcePathHasBeenSet() const
{
