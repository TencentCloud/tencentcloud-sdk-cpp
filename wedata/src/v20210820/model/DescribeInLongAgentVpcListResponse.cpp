...
CoreInternalOutcome DescribeInLongAgentVpcListResponse::Deserialize(const string &payload)
{
...
string DescribeInLongAgentVpcListResponse::ToJsonString() const
{
...
vector<string> DescribeInLongAgentVpcListResponse::GetVpcList() const
{
    return m_vpcList;
}

bool DescribeInLongAgentVpcListResponse::VpcListHasBeenSet() const
{
