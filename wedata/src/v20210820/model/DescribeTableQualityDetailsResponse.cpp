...
CoreInternalOutcome DescribeTableQualityDetailsResponse::Deserialize(const string &payload)
{
...
string DescribeTableQualityDetailsResponse::ToJsonString() const
{
...
TableQualityDetailPage DescribeTableQualityDetailsResponse::GetData() const
{
    return m_data;
}

bool DescribeTableQualityDetailsResponse::DataHasBeenSet() const
{
