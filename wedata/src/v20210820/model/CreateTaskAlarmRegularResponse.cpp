...
CoreInternalOutcome CreateTaskAlarmRegularResponse::Deserialize(const string &payload)
{
...
string CreateTaskAlarmRegularResponse::ToJsonString() const
{
...
int64_t CreateTaskAlarmRegularResponse::GetAlarmId() const
{
    return m_alarmId;
}

bool CreateTaskAlarmRegularResponse::AlarmIdHasBeenSet() const
{
