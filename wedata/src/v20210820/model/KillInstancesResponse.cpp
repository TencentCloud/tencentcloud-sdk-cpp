...
CoreInternalOutcome KillInstancesResponse::Deserialize(const string &payload)
{
...
string KillInstancesResponse::ToJsonString() const
{
...
OperateResult KillInstancesResponse::GetData() const
{
    return m_data;
}

bool KillInstancesResponse::DataHasBeenSet() const
{
