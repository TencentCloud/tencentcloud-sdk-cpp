...
CoreInternalOutcome DescribeDependTasksNewResponse::Deserialize(const string &payload)
{
...
string DescribeDependTasksNewResponse::ToJsonString() const
{
...
CanvasInfo DescribeDependTasksNewResponse::GetData() const
{
    return m_data;
}

bool DescribeDependTasksNewResponse::DataHasBeenSet() const
{
