...
CoreInternalOutcome DescribeOpsWorkflowsResponse::Deserialize(const string &payload)
{
...
string DescribeOpsWorkflowsResponse::ToJsonString() const
{
...
WorkflowExtOpsDtoPage DescribeOpsWorkflowsResponse::GetData() const
{
    return m_data;
}

bool DescribeOpsWorkflowsResponse::DataHasBeenSet() const
{
