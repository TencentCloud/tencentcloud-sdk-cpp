...
CoreInternalOutcome DeleteRuleResponse::Deserialize(const string &payload)
{
...
string DeleteRuleResponse::ToJsonString() const
{
...
bool DeleteRuleResponse::GetData() const
{
    return m_data;
}

bool DeleteRuleResponse::DataHasBeenSet() const
{
