...
CoreInternalOutcome DescribeTopTableStatResponse::Deserialize(const string &payload)
{
...
string DescribeTopTableStatResponse::ToJsonString() const
{
...
TopTableStat DescribeTopTableStatResponse::GetData() const
{
    return m_data;
}

bool DescribeTopTableStatResponse::DataHasBeenSet() const
{
