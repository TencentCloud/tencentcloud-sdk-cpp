...
CoreInternalOutcome DescribeRuleGroupExecResultsByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupExecResultsByPageResponse::ToJsonString() const
{
...
RuleGroupExecResultPage DescribeRuleGroupExecResultsByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupExecResultsByPageResponse::DataHasBeenSet() const
{
