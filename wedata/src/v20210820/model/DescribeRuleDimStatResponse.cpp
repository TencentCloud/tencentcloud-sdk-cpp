...
CoreInternalOutcome DescribeRuleDimStatResponse::Deserialize(const string &payload)
{
...
string DescribeRuleDimStatResponse::ToJsonString() const
{
...
RuleDimStat DescribeRuleDimStatResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleDimStatResponse::DataHasBeenSet() const
{
