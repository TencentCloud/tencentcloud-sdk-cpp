...
CoreInternalOutcome DescribeTasksByPageResponse::Deserialize(const string &payload)
{
...
string DescribeTasksByPageResponse::ToJsonString() const
{
...
TaskInfoDataPage DescribeTasksByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeTasksByPageResponse::DataHasBeenSet() const
{
