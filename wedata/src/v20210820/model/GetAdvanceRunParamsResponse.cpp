...
GetAdvanceRunParamsResponse::GetAdvanceRunParamsResponse() :
    m_resultHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome GetAdvanceRunParamsResponse::Deserialize(const string &payload)
{
...
string GetAdvanceRunParamsResponse::ToJsonString() const
{
...
bool GetAdvanceRunParamsResponse::GetResult() const
{
    return m_result;
}

bool GetAdvanceRunParamsResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string GetAdvanceRunParamsResponse::GetData() const
{
    return m_data;
}

bool GetAdvanceRunParamsResponse::DataHasBeenSet() const
{
