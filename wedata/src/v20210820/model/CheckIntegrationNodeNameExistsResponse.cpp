...
CoreInternalOutcome CheckIntegrationNodeNameExistsResponse::Deserialize(const string &payload)
{
...
string CheckIntegrationNodeNameExistsResponse::ToJsonString() const
{
...
bool CheckIntegrationNodeNameExistsResponse::GetData() const
{
    return m_data;
}

bool CheckIntegrationNodeNameExistsResponse::DataHasBeenSet() const
{
