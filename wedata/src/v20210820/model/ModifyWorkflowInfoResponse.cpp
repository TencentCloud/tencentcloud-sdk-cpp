...
CoreInternalOutcome ModifyWorkflowInfoResponse::Deserialize(const string &payload)
{
...
string ModifyWorkflowInfoResponse::ToJsonString() const
{
...
bool ModifyWorkflowInfoResponse::GetData() const
{
    return m_data;
}

bool ModifyWorkflowInfoResponse::DataHasBeenSet() const
{
