...
CoreInternalOutcome BatchStartIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchStartIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchStartIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchStartIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchStartIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchStartIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchStartIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}
