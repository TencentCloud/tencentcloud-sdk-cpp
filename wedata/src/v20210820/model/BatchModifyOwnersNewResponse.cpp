...
CoreInternalOutcome BatchModifyOwnersNewResponse::Deserialize(const string &payload)
{
...
string BatchModifyOwnersNewResponse::ToJsonString() const
{
...
BatchOperateResult BatchModifyOwnersNewResponse::GetData() const
{
    return m_data;
}

bool BatchModifyOwnersNewResponse::DataHasBeenSet() const
{
