...
TriggerManualTasksResponse::TriggerManualTasksResponse() :
    m_requestFromSourceHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome TriggerManualTasksResponse::Deserialize(const string &payload)
{
...
string TriggerManualTasksResponse::ToJsonString() const
{
...
string TriggerManualTasksResponse::GetRequestFromSource() const
{
    return m_requestFromSource;
}

bool TriggerManualTasksResponse::RequestFromSourceHasBeenSet() const
{
    return m_requestFromSourceHasBeenSet;
}

ManualTriggerRecordOpsDto TriggerManualTasksResponse::GetData() const
{
    return m_data;
}

bool TriggerManualTasksResponse::DataHasBeenSet() const
{
