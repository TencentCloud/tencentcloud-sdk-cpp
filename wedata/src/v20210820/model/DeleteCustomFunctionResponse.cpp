...
CoreInternalOutcome DeleteCustomFunctionResponse::Deserialize(const string &payload)
{
...
string DeleteCustomFunctionResponse::ToJsonString() const
{
...
string DeleteCustomFunctionResponse::GetFunctionId() const
{
    return m_functionId;
}

bool DeleteCustomFunctionResponse::FunctionIdHasBeenSet() const
{
    return m_functionIdHasBeenSet;
}

string DeleteCustomFunctionResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DeleteCustomFunctionResponse::ErrorMessageHasBeenSet() const
{
