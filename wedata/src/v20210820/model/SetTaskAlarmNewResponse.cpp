...
CoreInternalOutcome SetTaskAlarmNewResponse::Deserialize(const string &payload)
{
...
string SetTaskAlarmNewResponse::ToJsonString() const
{
...
BatchOperateResult SetTaskAlarmNewResponse::GetData() const
{
    return m_data;
}

bool SetTaskAlarmNewResponse::DataHasBeenSet() const
{
