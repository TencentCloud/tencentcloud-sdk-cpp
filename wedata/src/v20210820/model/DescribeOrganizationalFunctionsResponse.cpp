...
CoreInternalOutcome DescribeOrganizationalFunctionsResponse::Deserialize(const string &payload)
{
...
string DescribeOrganizationalFunctionsResponse::ToJsonString() const
{
...
vector<OrganizationalFunction> DescribeOrganizationalFunctionsResponse::GetContent() const
{
    return m_content;
}

bool DescribeOrganizationalFunctionsResponse::ContentHasBeenSet() const
{
    return m_contentHasBeenSet;
}

string DescribeOrganizationalFunctionsResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeOrganizationalFunctionsResponse::ErrorMessageHasBeenSet() const
{
