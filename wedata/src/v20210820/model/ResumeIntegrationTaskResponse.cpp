...
CoreInternalOutcome ResumeIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string ResumeIntegrationTaskResponse::ToJsonString() const
{
...
bool ResumeIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool ResumeIntegrationTaskResponse::DataHasBeenSet() const
{
