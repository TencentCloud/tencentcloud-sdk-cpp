...
CoreInternalOutcome BatchStopIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchStopIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchStopIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchStopIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchStopIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchStopIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchStopIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchStopIntegrationTasksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<string> BatchStopIntegrationTasksResponse::GetTaskNames() const
{
    return m_taskNames;
}

bool BatchStopIntegrationTasksResponse::TaskNamesHasBeenSet() const
{
