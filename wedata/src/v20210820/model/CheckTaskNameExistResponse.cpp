...
CoreInternalOutcome CheckTaskNameExistResponse::Deserialize(const string &payload)
{
...
string CheckTaskNameExistResponse::ToJsonString() const
{
...
bool CheckTaskNameExistResponse::GetData() const
{
    return m_data;
}

bool CheckTaskNameExistResponse::DataHasBeenSet() const
{
