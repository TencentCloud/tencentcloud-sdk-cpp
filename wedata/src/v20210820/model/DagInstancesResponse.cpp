...
CoreInternalOutcome DagInstancesResponse::Deserialize(const string &payload)
{
...
string DagInstancesResponse::ToJsonString() const
{
...
CollectionInstanceOpsDto DagInstancesResponse::GetData() const
{
    return m_data;
}

bool DagInstancesResponse::DataHasBeenSet() const
{
