...
SubmitPythonTaskResponse::SubmitPythonTaskResponse() :
    m_recordHasBeenSet(false),
    m_detailsHasBeenSet(false)
{
}

CoreInternalOutcome SubmitPythonTaskResponse::Deserialize(const string &payload)
{
...
string SubmitPythonTaskResponse::ToJsonString() const
{
...
AdhocRecord SubmitPythonTaskResponse::GetRecord() const
{
    return m_record;
}

bool SubmitPythonTaskResponse::RecordHasBeenSet() const
{
    return m_recordHasBeenSet;
}

vector<AdhocDetail> SubmitPythonTaskResponse::GetDetails() const
{
    return m_details;
}

bool SubmitPythonTaskResponse::DetailsHasBeenSet() const
{
