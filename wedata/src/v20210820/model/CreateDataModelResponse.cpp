...
CreateDataModelResponse::CreateDataModelResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateDataModelResponse::Deserialize(const string &payload)
{
...
string CreateDataModelResponse::ToJsonString() const
{
...
string CreateDataModelResponse::GetData() const
{
    return m_data;
}

bool CreateDataModelResponse::DataHasBeenSet() const
{
