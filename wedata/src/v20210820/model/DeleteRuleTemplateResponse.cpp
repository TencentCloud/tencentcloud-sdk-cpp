...
CoreInternalOutcome DeleteRuleTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteRuleTemplateResponse::ToJsonString() const
{
...
bool DeleteRuleTemplateResponse::GetData() const
{
    return m_data;
}

bool DeleteRuleTemplateResponse::DataHasBeenSet() const
{
