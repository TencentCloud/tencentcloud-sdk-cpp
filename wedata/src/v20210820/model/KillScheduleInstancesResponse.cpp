...
CoreInternalOutcome KillScheduleInstancesResponse::Deserialize(const string &payload)
{
...
string KillScheduleInstancesResponse::ToJsonString() const
{
...
BatchOperateResultOpsDto KillScheduleInstancesResponse::GetData() const
{
    return m_data;
}

bool KillScheduleInstancesResponse::DataHasBeenSet() const
{
