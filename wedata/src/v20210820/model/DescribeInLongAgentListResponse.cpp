...
CoreInternalOutcome DescribeInLongAgentListResponse::Deserialize(const string &payload)
{
...
string DescribeInLongAgentListResponse::ToJsonString() const
{
...
vector<InLongAgentDetail> DescribeInLongAgentListResponse::GetItems() const
{
    return m_items;
}

bool DescribeInLongAgentListResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t DescribeInLongAgentListResponse::GetPageIndex() const
{
    return m_pageIndex;
}

bool DescribeInLongAgentListResponse::PageIndexHasBeenSet() const
{
    return m_pageIndexHasBeenSet;
}

uint64_t DescribeInLongAgentListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeInLongAgentListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeInLongAgentListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInLongAgentListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeInLongAgentListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeInLongAgentListResponse::TotalPageHasBeenSet() const
{
