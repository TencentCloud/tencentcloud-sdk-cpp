...
CoreInternalOutcome DeleteTaskDsResponse::Deserialize(const string &payload)
{
...
string DeleteTaskDsResponse::ToJsonString() const
{
...
bool DeleteTaskDsResponse::GetData() const
{
    return m_data;
}

bool DeleteTaskDsResponse::DataHasBeenSet() const
{
