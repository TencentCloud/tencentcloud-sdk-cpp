...
CoreInternalOutcome DeleteResourceResponse::Deserialize(const string &payload)
{
...
string DeleteResourceResponse::ToJsonString() const
{
...
bool DeleteResourceResponse::GetData() const
{
    return m_data;
}

bool DeleteResourceResponse::DataHasBeenSet() const
{
