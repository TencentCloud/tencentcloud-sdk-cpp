...
string CreateFolderRequest::GetProjectId() const
{
    return m_projectId;
}

void CreateFolderRequest::SetProjectId(const string& _projectId)
{
    m_projectId = _projectId;
    m_projectIdHasBeenSet = true;
}

bool CreateFolderRequest::ProjectIdHasBeenSet() const
{
...
string CreateFolderRequest::GetParentsFolderId() const
{
    return m_parentsFolderId;
}

void CreateFolderRequest::SetParentsFolderId(const string& _parentsFolderId)
{
    m_parentsFolderId = _parentsFolderId;
    m_parentsFolderIdHasBeenSet = true;
}

bool CreateFolderRequest::ParentsFolderIdHasBeenSet() const
{
