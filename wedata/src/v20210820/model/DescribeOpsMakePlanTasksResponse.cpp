...
CoreInternalOutcome DescribeOpsMakePlanTasksResponse::Deserialize(const string &payload)
{
...
string DescribeOpsMakePlanTasksResponse::ToJsonString() const
{
...
MakePlanTaskOpsDtoCollection DescribeOpsMakePlanTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeOpsMakePlanTasksResponse::DataHasBeenSet() const
{
