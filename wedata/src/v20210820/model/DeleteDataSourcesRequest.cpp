...
string DeleteDataSourcesRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteDataSourcesRequest::GetIds() const
{
    return m_ids;
}

void DeleteDataSourcesRequest::SetIds(const vector<uint64_t>& _ids)
{
    m_ids = _ids;
