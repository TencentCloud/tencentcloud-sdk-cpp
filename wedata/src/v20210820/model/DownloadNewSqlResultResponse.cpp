...
DownloadNewSqlResultResponse::DownloadNewSqlResultResponse() :
    m_cosPathHasBeenSet(false),
    m_cosBucketNameHasBeenSet(false)
{
}

CoreInternalOutcome DownloadNewSqlResultResponse::Deserialize(const string &payload)
{
...
string DownloadNewSqlResultResponse::ToJsonString() const
{
...
string DownloadNewSqlResultResponse::GetCosPath() const
{
    return m_cosPath;
}

bool DownloadNewSqlResultResponse::CosPathHasBeenSet() const
{
    return m_cosPathHasBeenSet;
}

string DownloadNewSqlResultResponse::GetCosBucketName() const
{
    return m_cosBucketName;
}

bool DownloadNewSqlResultResponse::CosBucketNameHasBeenSet() const
{
