...
CoreInternalOutcome BatchDeleteOpsTasksResponse::Deserialize(const string &payload)
{
...
string BatchDeleteOpsTasksResponse::ToJsonString() const
{
...
BatchOperationOpsDto BatchDeleteOpsTasksResponse::GetData() const
{
    return m_data;
}

bool BatchDeleteOpsTasksResponse::DataHasBeenSet() const
{
