...
CoreInternalOutcome DescribeTaskReportDetailListResponse::Deserialize(const string &payload)
{
...
string DescribeTaskReportDetailListResponse::ToJsonString() const
{
...
uint64_t DescribeTaskReportDetailListResponse::GetPageIndex() const
{
    return m_pageIndex;
}

bool DescribeTaskReportDetailListResponse::PageIndexHasBeenSet() const
{
    return m_pageIndexHasBeenSet;
}

uint64_t DescribeTaskReportDetailListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeTaskReportDetailListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeTaskReportDetailListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTaskReportDetailListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeTaskReportDetailListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeTaskReportDetailListResponse::TotalPageHasBeenSet() const
{
    return m_totalPageHasBeenSet;
}

vector<TaskReportDetail> DescribeTaskReportDetailListResponse::GetItems() const
{
    return m_items;
}

bool DescribeTaskReportDetailListResponse::ItemsHasBeenSet() const
{
