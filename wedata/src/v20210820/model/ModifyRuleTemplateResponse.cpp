...
CoreInternalOutcome ModifyRuleTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyRuleTemplateResponse::ToJsonString() const
{
...
bool ModifyRuleTemplateResponse::GetData() const
{
    return m_data;
}

bool ModifyRuleTemplateResponse::DataHasBeenSet() const
{
