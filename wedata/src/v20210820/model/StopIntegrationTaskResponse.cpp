...
CoreInternalOutcome StopIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string StopIntegrationTaskResponse::ToJsonString() const
{
...
bool StopIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool StopIntegrationTaskResponse::DataHasBeenSet() const
{
