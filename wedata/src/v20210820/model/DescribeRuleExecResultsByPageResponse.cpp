...
CoreInternalOutcome DescribeRuleExecResultsByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleExecResultsByPageResponse::ToJsonString() const
{
...
RuleExecResultPage DescribeRuleExecResultsByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleExecResultsByPageResponse::DataHasBeenSet() const
{
