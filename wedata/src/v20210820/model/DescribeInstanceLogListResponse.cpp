...
CoreInternalOutcome DescribeInstanceLogListResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceLogListResponse::ToJsonString() const
{
...
string DescribeInstanceLogListResponse::GetData() const
{
    return m_data;
}
