...
CoreInternalOutcome CreateCustomFunctionResponse::Deserialize(const string &payload)
{
...
string CreateCustomFunctionResponse::ToJsonString() const
{
...
string CreateCustomFunctionResponse::GetFunctionId() const
{
    return m_functionId;
}

bool CreateCustomFunctionResponse::FunctionIdHasBeenSet() const
{
    return m_functionIdHasBeenSet;
}

string CreateCustomFunctionResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool CreateCustomFunctionResponse::ErrorMessageHasBeenSet() const
{
