...
UploadAdvanceRunParamsResponse::UploadAdvanceRunParamsResponse() :
    m_resultHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome UploadAdvanceRunParamsResponse::Deserialize(const string &payload)
{
...
string UploadAdvanceRunParamsResponse::ToJsonString() const
{
...
bool UploadAdvanceRunParamsResponse::GetResult() const
{
    return m_result;
}

bool UploadAdvanceRunParamsResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string UploadAdvanceRunParamsResponse::GetData() const
{
    return m_data;
}

bool UploadAdvanceRunParamsResponse::DataHasBeenSet() const
{
