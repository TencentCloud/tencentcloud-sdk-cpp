...
CoreInternalOutcome DescribeDimensionScoreResponse::Deserialize(const string &payload)
{
...
string DescribeDimensionScoreResponse::ToJsonString() const
{
...
DimensionScore DescribeDimensionScoreResponse::GetData() const
{
    return m_data;
}

bool DescribeDimensionScoreResponse::DataHasBeenSet() const
{
