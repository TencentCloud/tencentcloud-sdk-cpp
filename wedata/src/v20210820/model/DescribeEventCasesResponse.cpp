...
CoreInternalOutcome DescribeEventCasesResponse::Deserialize(const string &payload)
{
...
string DescribeEventCasesResponse::ToJsonString() const
{
...
EventCaseAuditLogVOCollection DescribeEventCasesResponse::GetData() const
{
    return m_data;
}

bool DescribeEventCasesResponse::DataHasBeenSet() const
{
