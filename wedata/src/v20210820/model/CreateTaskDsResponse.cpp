...
CreateTaskDsResponse::CreateTaskDsResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateTaskDsResponse::Deserialize(const string &payload)
{
...
string CreateTaskDsResponse::ToJsonString() const
{
...
string CreateTaskDsResponse::GetData() const
{
    return m_data;
}

bool CreateTaskDsResponse::DataHasBeenSet() const
{
