...
CoreInternalOutcome DescribeEventDetailResponse::Deserialize(const string &payload)
{
...
string DescribeEventDetailResponse::ToJsonString() const
{
...
EventDto DescribeEventDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeEventDetailResponse::DataHasBeenSet() const
{
