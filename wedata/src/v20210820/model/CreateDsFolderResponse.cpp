...
CoreInternalOutcome CreateDsFolderResponse::Deserialize(const string &payload)
{
...
string CreateDsFolderResponse::ToJsonString() const
{
...
string CreateDsFolderResponse::GetData() const
{
    return m_data;
}

bool CreateDsFolderResponse::DataHasBeenSet() const
{
