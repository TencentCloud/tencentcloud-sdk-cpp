...
CoreInternalOutcome CreateLinkResponse::Deserialize(const string &payload)
{
...
string CreateLinkResponse::ToJsonString() const
{
...
string CreateLinkResponse::GetData() const
{
    return m_data;
}

bool CreateLinkResponse::DataHasBeenSet() const
{
