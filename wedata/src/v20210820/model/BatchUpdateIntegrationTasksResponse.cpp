...
CoreInternalOutcome BatchUpdateIntegrationTasksResponse::Deserialize(const string &payload)
{
...
string BatchUpdateIntegrationTasksResponse::ToJsonString() const
{
...
int64_t BatchUpdateIntegrationTasksResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchUpdateIntegrationTasksResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchUpdateIntegrationTasksResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchUpdateIntegrationTasksResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchUpdateIntegrationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchUpdateIntegrationTasksResponse::TotalCountHasBeenSet() const
{
