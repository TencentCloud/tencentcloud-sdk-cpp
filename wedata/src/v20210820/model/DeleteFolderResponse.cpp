...
CoreInternalOutcome DeleteFolderResponse::Deserialize(const string &payload)
{
...
string DeleteFolderResponse::ToJsonString() const
{
...
bool DeleteFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteFolderResponse::DataHasBeenSet() const
{
