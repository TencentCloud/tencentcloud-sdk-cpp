...
CoreInternalOutcome ModifyTaskLinksResponse::Deserialize(const string &payload)
{
...
string ModifyTaskLinksResponse::ToJsonString() const
{
...
bool ModifyTaskLinksResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskLinksResponse::DataHasBeenSet() const
{
