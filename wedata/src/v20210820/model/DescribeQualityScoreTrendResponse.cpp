...
CoreInternalOutcome DescribeQualityScoreTrendResponse::Deserialize(const string &payload)
{
...
string DescribeQualityScoreTrendResponse::ToJsonString() const
{
...
QualityScoreTrend DescribeQualityScoreTrendResponse::GetData() const
{
    return m_data;
}

bool DescribeQualityScoreTrendResponse::DataHasBeenSet() const
{
