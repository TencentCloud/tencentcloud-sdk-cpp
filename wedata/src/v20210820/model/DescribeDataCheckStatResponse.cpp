...
CoreInternalOutcome DescribeDataCheckStatResponse::Deserialize(const string &payload)
{
...
string DescribeDataCheckStatResponse::ToJsonString() const
{
...
DataCheckStat DescribeDataCheckStatResponse::GetData() const
{
    return m_data;
}

bool DescribeDataCheckStatResponse::DataHasBeenSet() const
{
