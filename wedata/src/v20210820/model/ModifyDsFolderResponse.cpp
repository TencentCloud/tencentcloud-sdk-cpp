...
CoreInternalOutcome ModifyDsFolderResponse::Deserialize(const string &payload)
{
...
string ModifyDsFolderResponse::ToJsonString() const
{
...
bool ModifyDsFolderResponse::GetData() const
{
    return m_data;
}

bool ModifyDsFolderResponse::DataHasBeenSet() const
{
