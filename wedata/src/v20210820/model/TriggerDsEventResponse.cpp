...
CoreInternalOutcome TriggerDsEventResponse::Deserialize(const string &payload)
{
...
string TriggerDsEventResponse::ToJsonString() const
{
...
BatchOpsDTO TriggerDsEventResponse::GetData() const
{
    return m_data;
}

bool TriggerDsEventResponse::DataHasBeenSet() const
{
