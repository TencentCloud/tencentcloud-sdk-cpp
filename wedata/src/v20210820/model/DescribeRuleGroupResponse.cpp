...
CoreInternalOutcome DescribeRuleGroupResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupResponse::ToJsonString() const
{
...
RuleGroup DescribeRuleGroupResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupResponse::DataHasBeenSet() const
{
