...
CoreInternalOutcome CheckDuplicateTemplateNameResponse::Deserialize(const string &payload)
{
...
string CheckDuplicateTemplateNameResponse::ToJsonString() const
{
...
bool CheckDuplicateTemplateNameResponse::GetData() const
{
    return m_data;
}

bool CheckDuplicateTemplateNameResponse::DataHasBeenSet() const
{
