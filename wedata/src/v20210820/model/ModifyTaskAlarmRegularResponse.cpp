...
CoreInternalOutcome ModifyTaskAlarmRegularResponse::Deserialize(const string &payload)
{
...
string ModifyTaskAlarmRegularResponse::ToJsonString() const
{
...
bool ModifyTaskAlarmRegularResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskAlarmRegularResponse::DataHasBeenSet() const
{
