...
CoreInternalOutcome DeleteWorkflowNewResponse::Deserialize(const string &payload)
{
...
string DeleteWorkflowNewResponse::ToJsonString() const
{
...
OperateResult DeleteWorkflowNewResponse::GetData() const
{
    return m_data;
}

bool DeleteWorkflowNewResponse::DataHasBeenSet() const
{
