...
CoreInternalOutcome BatchStopWorkflowsByIdsResponse::Deserialize(const string &payload)
{
...
string BatchStopWorkflowsByIdsResponse::ToJsonString() const
{
...
OperationOpsDto BatchStopWorkflowsByIdsResponse::GetData() const
{
    return m_data;
}

bool BatchStopWorkflowsByIdsResponse::DataHasBeenSet() const
{
