...
ReportTaskLineageResponse::ReportTaskLineageResponse() :
    m_requestFromSourceHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome ReportTaskLineageResponse::Deserialize(const string &payload)
{
...
string ReportTaskLineageResponse::ToJsonString() const
{
...
string ReportTaskLineageResponse::GetRequestFromSource() const
{
    return m_requestFromSource;
}

bool ReportTaskLineageResponse::RequestFromSourceHasBeenSet() const
{
    return m_requestFromSourceHasBeenSet;
}

bool ReportTaskLineageResponse::GetData() const
{
    return m_data;
}

bool ReportTaskLineageResponse::DataHasBeenSet() const
{
