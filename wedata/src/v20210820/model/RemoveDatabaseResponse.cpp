...
RemoveDatabaseResponse::RemoveDatabaseResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome RemoveDatabaseResponse::Deserialize(const string &payload)
{
...
string RemoveDatabaseResponse::ToJsonString() const
{
...
string RemoveDatabaseResponse::GetJobId() const
{
    return m_jobId;
}

bool RemoveDatabaseResponse::JobIdHasBeenSet() const
{
