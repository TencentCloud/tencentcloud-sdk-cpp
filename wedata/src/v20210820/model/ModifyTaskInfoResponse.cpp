...
CoreInternalOutcome ModifyTaskInfoResponse::Deserialize(const string &payload)
{
...
string ModifyTaskInfoResponse::ToJsonString() const
{
...
bool ModifyTaskInfoResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskInfoResponse::DataHasBeenSet() const
{
