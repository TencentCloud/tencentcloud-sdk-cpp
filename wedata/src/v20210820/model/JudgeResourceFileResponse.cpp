...
JudgeResourceFileResponse::JudgeResourceFileResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome JudgeResourceFileResponse::Deserialize(const string &payload)
{
...
string JudgeResourceFileResponse::ToJsonString() const
{
...
string JudgeResourceFileResponse::GetData() const
{
    return m_data;
}

bool JudgeResourceFileResponse::DataHasBeenSet() const
{
