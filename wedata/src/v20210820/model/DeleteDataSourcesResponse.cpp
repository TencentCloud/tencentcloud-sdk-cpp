...
CoreInternalOutcome DeleteDataSourcesResponse::Deserialize(const string &payload)
{
...
string DeleteDataSourcesResponse::ToJsonString() const
{
...
bool DeleteDataSourcesResponse::GetData() const
{
    return m_data;
}

bool DeleteDataSourcesResponse::DataHasBeenSet() const
{
