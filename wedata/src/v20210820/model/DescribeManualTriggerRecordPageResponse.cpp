...
DescribeManualTriggerRecordPageResponse::DescribeManualTriggerRecordPageResponse() :
    m_requestFromSourceHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeManualTriggerRecordPageResponse::Deserialize(const string &payload)
{
...
string DescribeManualTriggerRecordPageResponse::ToJsonString() const
{
...
string DescribeManualTriggerRecordPageResponse::GetRequestFromSource() const
{
    return m_requestFromSource;
}

bool DescribeManualTriggerRecordPageResponse::RequestFromSourceHasBeenSet() const
{
    return m_requestFromSourceHasBeenSet;
}

ManualTriggerRecordOpsDtoPage DescribeManualTriggerRecordPageResponse::GetData() const
{
    return m_data;
}

bool DescribeManualTriggerRecordPageResponse::DataHasBeenSet() const
{
