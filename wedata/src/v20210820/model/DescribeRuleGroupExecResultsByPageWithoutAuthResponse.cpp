...
CoreInternalOutcome DescribeRuleGroupExecResultsByPageWithoutAuthResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupExecResultsByPageWithoutAuthResponse::ToJsonString() const
{
...
RuleGroupExecResultPage DescribeRuleGroupExecResultsByPageWithoutAuthResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupExecResultsByPageWithoutAuthResponse::DataHasBeenSet() const
{
