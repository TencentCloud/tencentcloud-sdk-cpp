...
CoreInternalOutcome BatchStopOpsTasksResponse::Deserialize(const string &payload)
{
...
string BatchStopOpsTasksResponse::ToJsonString() const
{
...
BatchOperationOpsDto BatchStopOpsTasksResponse::GetData() const
{
    return m_data;
}

bool BatchStopOpsTasksResponse::DataHasBeenSet() const
{
