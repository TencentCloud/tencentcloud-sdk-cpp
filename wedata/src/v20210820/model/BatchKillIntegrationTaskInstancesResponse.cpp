...
CoreInternalOutcome BatchKillIntegrationTaskInstancesResponse::Deserialize(const string &payload)
{
...
string BatchKillIntegrationTaskInstancesResponse::ToJsonString() const
{
...
int64_t BatchKillIntegrationTaskInstancesResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool BatchKillIntegrationTaskInstancesResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

int64_t BatchKillIntegrationTaskInstancesResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool BatchKillIntegrationTaskInstancesResponse::FailedCountHasBeenSet() const
{
    return m_failedCountHasBeenSet;
}

int64_t BatchKillIntegrationTaskInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool BatchKillIntegrationTaskInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<string> BatchKillIntegrationTaskInstancesResponse::GetTaskNames() const
{
    return m_taskNames;
}

bool BatchKillIntegrationTaskInstancesResponse::TaskNamesHasBeenSet() const
{
