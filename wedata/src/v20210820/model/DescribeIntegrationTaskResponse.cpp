...
CoreInternalOutcome DescribeIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string DescribeIntegrationTaskResponse::ToJsonString() const
{
...
IntegrationTaskInfo DescribeIntegrationTaskResponse::GetTaskInfo() const
{
    return m_taskInfo;
}
