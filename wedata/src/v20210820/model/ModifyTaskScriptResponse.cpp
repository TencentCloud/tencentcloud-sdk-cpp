...
CoreInternalOutcome ModifyTaskScriptResponse::Deserialize(const string &payload)
{
...
string ModifyTaskScriptResponse::ToJsonString() const
{
...
CommonContent ModifyTaskScriptResponse::GetData() const
{
    return m_data;
}

bool ModifyTaskScriptResponse::DataHasBeenSet() const
{
