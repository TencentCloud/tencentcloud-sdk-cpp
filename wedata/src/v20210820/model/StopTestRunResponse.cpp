...
StopTestRunResponse::StopTestRunResponse() :
    m_currentStatusHasBeenSet(false)
{
}

CoreInternalOutcome StopTestRunResponse::Deserialize(const string &payload)
{
...
string StopTestRunResponse::ToJsonString() const
{
...
string StopTestRunResponse::GetCurrentStatus() const
{
    return m_currentStatus;
}

bool StopTestRunResponse::CurrentStatusHasBeenSet() const
{
