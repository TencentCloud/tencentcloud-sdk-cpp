...
CoreInternalOutcome DescribeWorkflowInfoByIdResponse::Deserialize(const string &payload)
{
...
string DescribeWorkflowInfoByIdResponse::ToJsonString() const
{
...
WorkflowSchedulerOpsDto DescribeWorkflowInfoByIdResponse::GetData() const
{
    return m_data;
}

bool DescribeWorkflowInfoByIdResponse::DataHasBeenSet() const
{
