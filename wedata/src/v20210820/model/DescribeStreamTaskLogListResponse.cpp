...
CoreInternalOutcome DescribeStreamTaskLogListResponse::Deserialize(const string &payload)
{
...
string DescribeStreamTaskLogListResponse::ToJsonString() const
{
...
bool DescribeStreamTaskLogListResponse::GetListOver() const
{
    return m_listOver;
}

bool DescribeStreamTaskLogListResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

vector<LogContentInfo> DescribeStreamTaskLogListResponse::GetLogContentList() const
{
