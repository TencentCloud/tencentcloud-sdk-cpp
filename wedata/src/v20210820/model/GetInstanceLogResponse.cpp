...
CoreInternalOutcome GetInstanceLogResponse::Deserialize(const string &payload)
{
...
string GetInstanceLogResponse::ToJsonString() const
{
...
InstanceLogVO GetInstanceLogResponse::GetData() const
{
    return m_data;
}

bool GetInstanceLogResponse::DataHasBeenSet() const
{
