...
CoreInternalOutcome DescribeTaskTemplatesResponse::Deserialize(const string &payload)
{
...
string DescribeTaskTemplatesResponse::ToJsonString() const
{
...
PageTaskTemplateInfo DescribeTaskTemplatesResponse::GetData() const
{
    return m_data;
}

bool DescribeTaskTemplatesResponse::DataHasBeenSet() const
{
