...
CoreInternalOutcome DescribeInstanceLastLogResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceLastLogResponse::ToJsonString() const
{
...
string DescribeInstanceLastLogResponse::GetData() const
{
    return m_data;
}

bool DescribeInstanceLastLogResponse::DataHasBeenSet() const
{
