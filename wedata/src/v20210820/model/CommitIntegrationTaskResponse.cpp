...
CoreInternalOutcome CommitIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string CommitIntegrationTaskResponse::ToJsonString() const
{
...
bool CommitIntegrationTaskResponse::GetData() const
{
    return m_data;
}
