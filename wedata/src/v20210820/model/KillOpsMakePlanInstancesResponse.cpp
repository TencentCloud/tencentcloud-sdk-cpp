...
CoreInternalOutcome KillOpsMakePlanInstancesResponse::Deserialize(const string &payload)
{
...
string KillOpsMakePlanInstancesResponse::ToJsonString() const
{
...
BatchOperateResultOpsDto KillOpsMakePlanInstancesResponse::GetData() const
{
    return m_data;
}

bool KillOpsMakePlanInstancesResponse::DataHasBeenSet() const
{
