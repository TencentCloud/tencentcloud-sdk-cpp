...
CoreInternalOutcome CreateHiveTableByDDLResponse::Deserialize(const string &payload)
{
...
string CreateHiveTableByDDLResponse::ToJsonString() const
{
...
string CreateHiveTableByDDLResponse::GetData() const
{
    return m_data;
}
