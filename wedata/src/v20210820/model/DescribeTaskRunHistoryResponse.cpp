...
CoreInternalOutcome DescribeTaskRunHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeTaskRunHistoryResponse::ToJsonString() const
{
...
InstanceOpsInfoPage DescribeTaskRunHistoryResponse::GetData() const
{
    return m_data;
}

bool DescribeTaskRunHistoryResponse::DataHasBeenSet() const
{
