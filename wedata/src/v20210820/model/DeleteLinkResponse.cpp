...
CoreInternalOutcome DeleteLinkResponse::Deserialize(const string &payload)
{
...
string DeleteLinkResponse::ToJsonString() const
{
...
bool DeleteLinkResponse::GetData() const
{
    return m_data;
}

bool DeleteLinkResponse::DataHasBeenSet() const
{
