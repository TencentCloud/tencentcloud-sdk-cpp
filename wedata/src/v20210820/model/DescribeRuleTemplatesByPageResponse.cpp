...
CoreInternalOutcome DescribeRuleTemplatesByPageResponse::Deserialize(const string &payload)
{
...
string DescribeRuleTemplatesByPageResponse::ToJsonString() const
{
...
RuleTemplatePage DescribeRuleTemplatesByPageResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleTemplatesByPageResponse::DataHasBeenSet() const
{
