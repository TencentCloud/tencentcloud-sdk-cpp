...
CoreInternalOutcome DescribeTemplateHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeTemplateHistoryResponse::ToJsonString() const
{
...
RuleTemplateHistoryPage DescribeTemplateHistoryResponse::GetData() const
{
    return m_data;
}

bool DescribeTemplateHistoryResponse::DataHasBeenSet() const
{
