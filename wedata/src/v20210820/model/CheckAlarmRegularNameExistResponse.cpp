...
CoreInternalOutcome CheckAlarmRegularNameExistResponse::Deserialize(const string &payload)
{
...
string CheckAlarmRegularNameExistResponse::ToJsonString() const
{
...
bool CheckAlarmRegularNameExistResponse::GetData() const
{
    return m_data;
}

bool CheckAlarmRegularNameExistResponse::DataHasBeenSet() const
{
