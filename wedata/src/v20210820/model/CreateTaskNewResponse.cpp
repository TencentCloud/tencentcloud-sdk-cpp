...
CreateTaskNewResponse::CreateTaskNewResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateTaskNewResponse::Deserialize(const string &payload)
{
...
string CreateTaskNewResponse::ToJsonString() const
{
...
string CreateTaskNewResponse::GetData() const
{
    return m_data;
}

bool CreateTaskNewResponse::DataHasBeenSet() const
{
