...
string CreateWorkflowRequest::GetFolderId() const
{
    return m_folderId;
}

void CreateWorkflowRequest::SetFolderId(const string& _folderId)
{
    m_folderId = _folderId;
    m_folderIdHasBeenSet = true;
}

bool CreateWorkflowRequest::FolderIdHasBeenSet() const
{
