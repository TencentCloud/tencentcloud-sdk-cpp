...
CoreInternalOutcome RenameFileResponse::Deserialize(const string &payload)
{
...
string RenameFileResponse::ToJsonString() const
{
...
bool RenameFileResponse::GetResult() const
{
    return m_result;
}

bool RenameFileResponse::ResultHasBeenSet() const
{
