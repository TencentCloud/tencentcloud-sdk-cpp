...
CoreInternalOutcome DescribeEventConsumeTasksResponse::Deserialize(const string &payload)
{
...
string DescribeEventConsumeTasksResponse::ToJsonString() const
{
...
EventCaseConsumeLogOptDtoCollection DescribeEventConsumeTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeEventConsumeTasksResponse::DataHasBeenSet() const
{
