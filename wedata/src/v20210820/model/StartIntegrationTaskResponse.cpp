...
CoreInternalOutcome StartIntegrationTaskResponse::Deserialize(const string &payload)
{
...
string StartIntegrationTaskResponse::ToJsonString() const
{
...
bool StartIntegrationTaskResponse::GetData() const
{
    return m_data;
}

bool StartIntegrationTaskResponse::DataHasBeenSet() const
{
