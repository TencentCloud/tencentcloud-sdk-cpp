...
DownloadSqlResultResponse::DownloadSqlResultResponse() :
    m_cosPathHasBeenSet(false),
    m_cosBucketNameHasBeenSet(false)
{
}

CoreInternalOutcome DownloadSqlResultResponse::Deserialize(const string &payload)
{
...
string DownloadSqlResultResponse::ToJsonString() const
{
...
string DownloadSqlResultResponse::GetCosPath() const
{
    return m_cosPath;
}

bool DownloadSqlResultResponse::CosPathHasBeenSet() const
{
    return m_cosPathHasBeenSet;
}

string DownloadSqlResultResponse::GetCosBucketName() const
{
    return m_cosBucketName;
}

bool DownloadSqlResultResponse::CosBucketNameHasBeenSet() const
{
