...
CoreInternalOutcome DescribeDependOpsTasksResponse::Deserialize(const string &payload)
{
...
string DescribeDependOpsTasksResponse::ToJsonString() const
{
...
OpsTaskCanvasInfoList DescribeDependOpsTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeDependOpsTasksResponse::DataHasBeenSet() const
{
