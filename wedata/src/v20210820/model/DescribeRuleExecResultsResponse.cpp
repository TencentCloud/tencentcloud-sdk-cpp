...
CoreInternalOutcome DescribeRuleExecResultsResponse::Deserialize(const string &payload)
{
...
string DescribeRuleExecResultsResponse::ToJsonString() const
{
...
RuleExecResultPage DescribeRuleExecResultsResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleExecResultsResponse::DataHasBeenSet() const
{
