...
CreateCodeTemplateResponse::CreateCodeTemplateResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateCodeTemplateResponse::Deserialize(const string &payload)
{
...
string CreateCodeTemplateResponse::ToJsonString() const
{
...
string CreateCodeTemplateResponse::GetData() const
{
    return m_data;
}

bool CreateCodeTemplateResponse::DataHasBeenSet() const
{
