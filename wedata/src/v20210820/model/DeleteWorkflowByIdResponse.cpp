...
CoreInternalOutcome DeleteWorkflowByIdResponse::Deserialize(const string &payload)
{
...
string DeleteWorkflowByIdResponse::ToJsonString() const
{
...
OperationOpsDto DeleteWorkflowByIdResponse::GetData() const
{
    return m_data;
}

bool DeleteWorkflowByIdResponse::DataHasBeenSet() const
{
