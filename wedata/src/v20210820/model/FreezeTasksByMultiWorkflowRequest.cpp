...
string FreezeTasksByMultiWorkflowRequest::ToJsonString() const
{
...
vector<string> FreezeTasksByMultiWorkflowRequest::GetWorkFlowIds() const
{
    return m_workFlowIds;
}

void FreezeTasksByMultiWorkflowRequest::SetWorkFlowIds(const vector<string>& _workFlowIds)
{
    m_workFlowIds = _workFlowIds;
    m_workFlowIdsHasBeenSet = true;
}

bool FreezeTasksByMultiWorkflowRequest::WorkFlowIdsHasBeenSet() const
{
