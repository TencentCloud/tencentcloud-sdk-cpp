...
CoreInternalOutcome DeleteResourceFileResponse::Deserialize(const string &payload)
{
...
string DeleteResourceFileResponse::ToJsonString() const
{
...
bool DeleteResourceFileResponse::GetData() const
{
    return m_data;
}

bool DeleteResourceFileResponse::DataHasBeenSet() const
{
