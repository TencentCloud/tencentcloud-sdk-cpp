...
CoreInternalOutcome GetOfflineInstanceListResponse::Deserialize(const string &payload)
{
...
string GetOfflineInstanceListResponse::ToJsonString() const
{
...
uint64_t GetOfflineInstanceListResponse::GetTotal() const
{
    return m_total;
}

bool GetOfflineInstanceListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<OfflineInstance> GetOfflineInstanceListResponse::GetList() const
{
    return m_list;
}

bool GetOfflineInstanceListResponse::ListHasBeenSet() const
{
