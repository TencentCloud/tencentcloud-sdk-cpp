...
CoreInternalOutcome RunTasksByMultiWorkflowResponse::Deserialize(const string &payload)
{
...
string RunTasksByMultiWorkflowResponse::ToJsonString() const
{
...
OperationOpsDto RunTasksByMultiWorkflowResponse::GetData() const
{
    return m_data;
}

bool RunTasksByMultiWorkflowResponse::DataHasBeenSet() const
{
