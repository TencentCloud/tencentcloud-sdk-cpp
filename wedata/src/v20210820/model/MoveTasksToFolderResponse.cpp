...
CoreInternalOutcome MoveTasksToFolderResponse::Deserialize(const string &payload)
{
...
string MoveTasksToFolderResponse::ToJsonString() const
{
...
bool MoveTasksToFolderResponse::GetData() const
{
    return m_data;
}

bool MoveTasksToFolderResponse::DataHasBeenSet() const
{
