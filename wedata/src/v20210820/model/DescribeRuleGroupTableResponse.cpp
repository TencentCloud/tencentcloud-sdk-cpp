...
CoreInternalOutcome DescribeRuleGroupTableResponse::Deserialize(const string &payload)
{
...
string DescribeRuleGroupTableResponse::ToJsonString() const
{
...
RuleGroupTable DescribeRuleGroupTableResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleGroupTableResponse::DataHasBeenSet() const
{
