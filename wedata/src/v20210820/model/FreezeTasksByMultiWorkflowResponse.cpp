...
CoreInternalOutcome FreezeTasksByMultiWorkflowResponse::Deserialize(const string &payload)
{
...
string FreezeTasksByMultiWorkflowResponse::ToJsonString() const
{
...
OperateResult FreezeTasksByMultiWorkflowResponse::GetData() const
{
    return m_data;
}

bool FreezeTasksByMultiWorkflowResponse::DataHasBeenSet() const
{
