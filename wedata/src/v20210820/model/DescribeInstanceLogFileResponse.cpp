...
CoreInternalOutcome DescribeInstanceLogFileResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceLogFileResponse::ToJsonString() const
{
...
InstanceDownloadLogInfo DescribeInstanceLogFileResponse::GetData() const
{
    return m_data;
}

bool DescribeInstanceLogFileResponse::DataHasBeenSet() const
{
