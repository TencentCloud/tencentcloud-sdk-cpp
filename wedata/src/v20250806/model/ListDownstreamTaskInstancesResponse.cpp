...
CoreInternalOutcome ListDownstreamTaskInstancesResponse::Deserialize(const string &payload)
{
...
string ListDownstreamTaskInstancesResponse::ToJsonString() const
{
...
TaskInstancePage ListDownstreamTaskInstancesResponse::GetData() const
{
    return m_data;
}

bool ListDownstreamTaskInstancesResponse::DataHasBeenSet() const
{
