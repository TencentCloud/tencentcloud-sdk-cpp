...
CoreInternalOutcome TriggerTaskSchedulerConfiguration::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("UpstreamDependencyConfigList") && !value["UpstreamDependencyConfigList"].IsNull())
    {
        if (!value["UpstreamDependencyConfigList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.UpstreamDependencyConfigList` is not array type"));
    ...
    if (value.HasMember("RunPriorityType") && !value["RunPriorityType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.RunPriorityType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RetryWaitMinute") && !value["RetryWaitMinute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.RetryWaitMinute` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MaxRetryNumber") && !value["MaxRetryNumber"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.MaxRetryNumber` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ExecutionTTLMinute") && !value["ExecutionTTLMinute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.ExecutionTTLMinute` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("WaitExecutionTotalTTLMinute") && !value["WaitExecutionTotalTTLMinute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.WaitExecutionTotalTTLMinute` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AllowRedoType") && !value["AllowRedoType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.AllowRedoType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParamTaskOutList") && !value["ParamTaskOutList"].IsNull())
    {
        if (!value["ParamTaskOutList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.ParamTaskOutList` is not array type"));
    ...
    if (value.HasMember("ParamTaskInList") && !value["ParamTaskInList"].IsNull())
    {
        if (!value["ParamTaskInList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.ParamTaskInList` is not array type"));
    ...
    if (value.HasMember("TaskOutputRegistryList") && !value["TaskOutputRegistryList"].IsNull())
    {
        if (!value["TaskOutputRegistryList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TriggerTaskSchedulerConfiguration.TaskOutputRegistryList` is not array type"));
...
void TriggerTaskSchedulerConfiguration::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<DependencyTriggerTaskBrief> TriggerTaskSchedulerConfiguration::GetUpstreamDependencyConfigList() const
{
    return m_upstreamDependencyConfigList;
}

void TriggerTaskSchedulerConfiguration::SetUpstreamDependencyConfigList(const vector<DependencyTriggerTaskBrief>& _upstreamDependencyConfigList)
{
    m_upstreamDependencyConfigList = _upstreamDependencyConfigList;
    m_upstreamDependencyConfigListHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::UpstreamDependencyConfigListHasBeenSet() const
{
    return m_upstreamDependencyConfigListHasBeenSet;
}

int64_t TriggerTaskSchedulerConfiguration::GetRunPriorityType() const
{
    return m_runPriorityType;
}

void TriggerTaskSchedulerConfiguration::SetRunPriorityType(const int64_t& _runPriorityType)
{
    m_runPriorityType = _runPriorityType;
    m_runPriorityTypeHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::RunPriorityTypeHasBeenSet() const
{
    return m_runPriorityTypeHasBeenSet;
}

int64_t TriggerTaskSchedulerConfiguration::GetRetryWaitMinute() const
{
    return m_retryWaitMinute;
}

void TriggerTaskSchedulerConfiguration::SetRetryWaitMinute(const int64_t& _retryWaitMinute)
{
    m_retryWaitMinute = _retryWaitMinute;
    m_retryWaitMinuteHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::RetryWaitMinuteHasBeenSet() const
{
    return m_retryWaitMinuteHasBeenSet;
}

int64_t TriggerTaskSchedulerConfiguration::GetMaxRetryNumber() const
{
    return m_maxRetryNumber;
}

void TriggerTaskSchedulerConfiguration::SetMaxRetryNumber(const int64_t& _maxRetryNumber)
{
    m_maxRetryNumber = _maxRetryNumber;
    m_maxRetryNumberHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::MaxRetryNumberHasBeenSet() const
{
    return m_maxRetryNumberHasBeenSet;
}

int64_t TriggerTaskSchedulerConfiguration::GetExecutionTTLMinute() const
{
    return m_executionTTLMinute;
}

void TriggerTaskSchedulerConfiguration::SetExecutionTTLMinute(const int64_t& _executionTTLMinute)
{
    m_executionTTLMinute = _executionTTLMinute;
    m_executionTTLMinuteHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::ExecutionTTLMinuteHasBeenSet() const
{
    return m_executionTTLMinuteHasBeenSet;
}

int64_t TriggerTaskSchedulerConfiguration::GetWaitExecutionTotalTTLMinute() const
{
    return m_waitExecutionTotalTTLMinute;
}

void TriggerTaskSchedulerConfiguration::SetWaitExecutionTotalTTLMinute(const int64_t& _waitExecutionTotalTTLMinute)
{
    m_waitExecutionTotalTTLMinute = _waitExecutionTotalTTLMinute;
    m_waitExecutionTotalTTLMinuteHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::WaitExecutionTotalTTLMinuteHasBeenSet() const
{
    return m_waitExecutionTotalTTLMinuteHasBeenSet;
}

string TriggerTaskSchedulerConfiguration::GetAllowRedoType() const
{
    return m_allowRedoType;
}

void TriggerTaskSchedulerConfiguration::SetAllowRedoType(const string& _allowRedoType)
{
    m_allowRedoType = _allowRedoType;
    m_allowRedoTypeHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::AllowRedoTypeHasBeenSet() const
{
    return m_allowRedoTypeHasBeenSet;
}

vector<OutTaskParameter> TriggerTaskSchedulerConfiguration::GetParamTaskOutList() const
{
    return m_paramTaskOutList;
}

void TriggerTaskSchedulerConfiguration::SetParamTaskOutList(const vector<OutTaskParameter>& _paramTaskOutList)
{
    m_paramTaskOutList = _paramTaskOutList;
    m_paramTaskOutListHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::ParamTaskOutListHasBeenSet() const
{
    return m_paramTaskOutListHasBeenSet;
}

vector<InTaskParameter> TriggerTaskSchedulerConfiguration::GetParamTaskInList() const
{
    return m_paramTaskInList;
}

void TriggerTaskSchedulerConfiguration::SetParamTaskInList(const vector<InTaskParameter>& _paramTaskInList)
{
    m_paramTaskInList = _paramTaskInList;
    m_paramTaskInListHasBeenSet = true;
}

bool TriggerTaskSchedulerConfiguration::ParamTaskInListHasBeenSet() const
{
    return m_paramTaskInListHasBeenSet;
}

vector<TaskDataRegistry> TriggerTaskSchedulerConfiguration::GetTaskOutputRegistryList() const
{
    return m_taskOutputRegistryList;
}

void TriggerTaskSchedulerConfiguration::SetTaskOutputRegistryList(const vector<TaskDataRegistry>& _taskOutputRegistryList)
{
