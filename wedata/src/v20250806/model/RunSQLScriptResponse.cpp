...
CoreInternalOutcome RunSQLScriptResponse::Deserialize(const string &payload)
{
...
string RunSQLScriptResponse::ToJsonString() const
{
...
JobDto RunSQLScriptResponse::GetData() const
{
    return m_data;
}

bool RunSQLScriptResponse::DataHasBeenSet() const
{
