...
CoreInternalOutcome DeleteSQLScriptResponse::Deserialize(const string &payload)
{
...
string DeleteSQLScriptResponse::ToJsonString() const
{
...
SQLContentActionResult DeleteSQLScriptResponse::GetData() const
{
    return m_data;
}

bool DeleteSQLScriptResponse::DataHasBeenSet() const
{
