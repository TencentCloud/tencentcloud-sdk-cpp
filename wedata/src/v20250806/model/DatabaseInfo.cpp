...
CoreInternalOutcome DatabaseInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Guid") && !value["Guid"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DatabaseInfo.Guid` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DatabaseInfo.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CatalogName") && !value["CatalogName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DatabaseInfo.CatalogName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Description") && !value["Description"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DatabaseInfo.Description` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("StorageSize") && !value["StorageSize"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DatabaseInfo.StorageSize` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string DatabaseInfo::GetGuid() const
{
    return m_guid;
}

void DatabaseInfo::SetGuid(const string& _guid)
{
    m_guid = _guid;
    m_guidHasBeenSet = true;
}

bool DatabaseInfo::GuidHasBeenSet() const
{
    return m_guidHasBeenSet;
}

string DatabaseInfo::GetName() const
{
    return m_name;
}

void DatabaseInfo::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool DatabaseInfo::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string DatabaseInfo::GetCatalogName() const
{
    return m_catalogName;
}

void DatabaseInfo::SetCatalogName(const string& _catalogName)
{
    m_catalogName = _catalogName;
    m_catalogNameHasBeenSet = true;
}

bool DatabaseInfo::CatalogNameHasBeenSet() const
{
    return m_catalogNameHasBeenSet;
}

string DatabaseInfo::GetDescription() const
{
    return m_description;
}

void DatabaseInfo::SetDescription(const string& _description)
{
    m_description = _description;
    m_descriptionHasBeenSet = true;
}

bool DatabaseInfo::DescriptionHasBeenSet() const
{
...
int64_t DatabaseInfo::GetStorageSize() const
{
    return m_storageSize;
}

void DatabaseInfo::SetStorageSize(const int64_t& _storageSize)
{
