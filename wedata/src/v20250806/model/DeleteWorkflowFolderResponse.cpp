...
CoreInternalOutcome DeleteWorkflowFolderResponse::Deserialize(const string &payload)
{
...
string DeleteWorkflowFolderResponse::ToJsonString() const
{
...
DeleteFolderResult DeleteWorkflowFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteWorkflowFolderResponse::DataHasBeenSet() const
{
