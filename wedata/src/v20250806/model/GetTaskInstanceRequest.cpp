...
string GetTaskInstanceRequest::GetTimeZone() const
{
    return m_timeZone;
}

void GetTaskInstanceRequest::SetTimeZone(const string& _timeZone)
{
    m_timeZone = _timeZone;
    m_timeZoneHasBeenSet = true;
}

bool GetTaskInstanceRequest::TimeZoneHasBeenSet() const
{
