...
CoreInternalOutcome DeleteWorkflowPermissionsResponse::Deserialize(const string &payload)
{
...
string DeleteWorkflowPermissionsResponse::ToJsonString() const
{
...
DeleteWorkflowPermissionsResult DeleteWorkflowPermissionsResponse::GetData() const
{
    return m_data;
}

bool DeleteWorkflowPermissionsResponse::DataHasBeenSet() const
{
