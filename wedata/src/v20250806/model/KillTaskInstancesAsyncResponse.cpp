...
CoreInternalOutcome KillTaskInstancesAsyncResponse::Deserialize(const string &payload)
{
...
string KillTaskInstancesAsyncResponse::ToJsonString() const
{
...
OpsAsyncResponse KillTaskInstancesAsyncResponse::GetData() const
{
    return m_data;
}

bool KillTaskInstancesAsyncResponse::DataHasBeenSet() const
{
