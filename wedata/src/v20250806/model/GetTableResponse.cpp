...
CoreInternalOutcome GetTableResponse::Deserialize(const string &payload)
{
...
string GetTableResponse::ToJsonString() const
{
...
TableInfo GetTableResponse::GetData() const
{
    return m_data;
}

bool GetTableResponse::DataHasBeenSet() const
{
