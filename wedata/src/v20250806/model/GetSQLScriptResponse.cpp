...
CoreInternalOutcome GetSQLScriptResponse::Deserialize(const string &payload)
{
...
string GetSQLScriptResponse::ToJsonString() const
{
...
SQLScript GetSQLScriptResponse::GetData() const
{
    return m_data;
}

bool GetSQLScriptResponse::DataHasBeenSet() const
{
