...
CoreInternalOutcome CreateOpsAlarmRuleResponse::Deserialize(const string &payload)
{
...
string CreateOpsAlarmRuleResponse::ToJsonString() const
{
...
CreateAlarmRuleData CreateOpsAlarmRuleResponse::GetData() const
{
    return m_data;
}

bool CreateOpsAlarmRuleResponse::DataHasBeenSet() const
{
