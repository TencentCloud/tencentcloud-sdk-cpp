...
CoreInternalOutcome ListDatabaseResponse::Deserialize(const string &payload)
{
...
string ListDatabaseResponse::ToJsonString() const
{
...
ListDatabasePage ListDatabaseResponse::GetData() const
{
    return m_data;
}

bool ListDatabaseResponse::DataHasBeenSet() const
{
