...
CoreInternalOutcome ListProjectMembersResponse::Deserialize(const string &payload)
{
...
string ListProjectMembersResponse::ToJsonString() const
{
...
ProjectUsersBrief ListProjectMembersResponse::GetData() const
{
    return m_data;
}

bool ListProjectMembersResponse::DataHasBeenSet() const
{
