...
CoreInternalOutcome CreateSQLFolderResponse::Deserialize(const string &payload)
{
...
string CreateSQLFolderResponse::ToJsonString() const
{
...
SqlCreateResult CreateSQLFolderResponse::GetData() const
{
    return m_data;
}

bool CreateSQLFolderResponse::DataHasBeenSet() const
{
