...
CoreInternalOutcome ListDownstreamTasksResponse::Deserialize(const string &payload)
{
...
string ListDownstreamTasksResponse::ToJsonString() const
{
...
DependencyConfigPage ListDownstreamTasksResponse::GetData() const
{
    return m_data;
}

bool ListDownstreamTasksResponse::DataHasBeenSet() const
{
