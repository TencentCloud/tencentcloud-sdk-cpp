...
CoreInternalOutcome GetTaskInstanceResponse::Deserialize(const string &payload)
{
...
string GetTaskInstanceResponse::ToJsonString() const
{
...
TaskInstanceDetail GetTaskInstanceResponse::GetData() const
{
    return m_data;
}

bool GetTaskInstanceResponse::DataHasBeenSet() const
{
