...
CoreInternalOutcome GetOpsTaskResponse::Deserialize(const string &payload)
{
...
string GetOpsTaskResponse::ToJsonString() const
{
...
Task GetOpsTaskResponse::GetData() const
{
    return m_data;
}

bool GetOpsTaskResponse::DataHasBeenSet() const
{
