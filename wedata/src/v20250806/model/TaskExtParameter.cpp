...
CoreInternalOutcome TaskExtParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ParamKey") && !value["ParamKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TaskExtParameter.ParamKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParamValue") && !value["ParamValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TaskExtParameter.ParamValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void TaskExtParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string TaskExtParameter::GetParamKey() const
{
    return m_paramKey;
}

void TaskExtParameter::SetParamKey(const string& _paramKey)
{
    m_paramKey = _paramKey;
    m_paramKeyHasBeenSet = true;
}

bool TaskExtParameter::ParamKeyHasBeenSet() const
{
    return m_paramKeyHasBeenSet;
}

string TaskExtParameter::GetParamValue() const
{
    return m_paramValue;
}

void TaskExtParameter::SetParamValue(const string& _paramValue)
{
    m_paramValue = _paramValue;
    m_paramValueHasBeenSet = true;
}

bool TaskExtParameter::ParamValueHasBeenSet() const
{
