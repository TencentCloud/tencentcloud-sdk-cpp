...
CoreInternalOutcome ListCatalogResponse::Deserialize(const string &payload)
{
...
string ListCatalogResponse::ToJsonString() const
{
...
ListCatalogPage ListCatalogResponse::GetData() const
{
    return m_data;
}

bool ListCatalogResponse::DataHasBeenSet() const
{
