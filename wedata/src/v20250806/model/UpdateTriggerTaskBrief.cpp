...
CoreInternalOutcome UpdateTriggerTaskBrief::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TriggerTaskBaseAttribute") && !value["TriggerTaskBaseAttribute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTriggerTaskBrief.TriggerTaskBaseAttribute` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TriggerTaskConfiguration") && !value["TriggerTaskConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTriggerTaskBrief.TriggerTaskConfiguration` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TriggerTaskSchedulerConfiguration") && !value["TriggerTaskSchedulerConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTriggerTaskBrief.TriggerTaskSchedulerConfiguration` is not object type").SetRequestId(requestId));
        }
...
void UpdateTriggerTaskBrief::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
UpdateTriggerTaskBaseAttribute UpdateTriggerTaskBrief::GetTriggerTaskBaseAttribute() const
{
    return m_triggerTaskBaseAttribute;
}

void UpdateTriggerTaskBrief::SetTriggerTaskBaseAttribute(const UpdateTriggerTaskBaseAttribute& _triggerTaskBaseAttribute)
{
    m_triggerTaskBaseAttribute = _triggerTaskBaseAttribute;
    m_triggerTaskBaseAttributeHasBeenSet = true;
}

bool UpdateTriggerTaskBrief::TriggerTaskBaseAttributeHasBeenSet() const
{
    return m_triggerTaskBaseAttributeHasBeenSet;
}

TriggerTaskConfiguration UpdateTriggerTaskBrief::GetTriggerTaskConfiguration() const
{
    return m_triggerTaskConfiguration;
}

void UpdateTriggerTaskBrief::SetTriggerTaskConfiguration(const TriggerTaskConfiguration& _triggerTaskConfiguration)
{
    m_triggerTaskConfiguration = _triggerTaskConfiguration;
    m_triggerTaskConfigurationHasBeenSet = true;
}

bool UpdateTriggerTaskBrief::TriggerTaskConfigurationHasBeenSet() const
{
    return m_triggerTaskConfigurationHasBeenSet;
}

TriggerTaskSchedulerConfiguration UpdateTriggerTaskBrief::GetTriggerTaskSchedulerConfiguration() const
{
    return m_triggerTaskSchedulerConfiguration;
}

void UpdateTriggerTaskBrief::SetTriggerTaskSchedulerConfiguration(const TriggerTaskSchedulerConfiguration& _triggerTaskSchedulerConfiguration)
{
    m_triggerTaskSchedulerConfiguration = _triggerTaskSchedulerConfiguration;
    m_triggerTaskSchedulerConfigurationHasBeenSet = true;
}

bool UpdateTriggerTaskBrief::TriggerTaskSchedulerConfigurationHasBeenSet() const
{
