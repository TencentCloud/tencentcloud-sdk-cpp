...
CoreInternalOutcome UpdateResourceFolderResponse::Deserialize(const string &payload)
{
...
string UpdateResourceFolderResponse::ToJsonString() const
{
...
UpdateFolderResult UpdateResourceFolderResponse::GetData() const
{
    return m_data;
}

bool UpdateResourceFolderResponse::DataHasBeenSet() const
{
