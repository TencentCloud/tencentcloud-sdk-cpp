...
CoreInternalOutcome UpdateCodeFolderResponse::Deserialize(const string &payload)
{
...
string UpdateCodeFolderResponse::ToJsonString() const
{
...
CodeStudioFolderActionResult UpdateCodeFolderResponse::GetData() const
{
    return m_data;
}

bool UpdateCodeFolderResponse::DataHasBeenSet() const
{
