...
CoreInternalOutcome PauseOpsTasksAsyncResponse::Deserialize(const string &payload)
{
...
string PauseOpsTasksAsyncResponse::ToJsonString() const
{
...
OpsAsyncResponse PauseOpsTasksAsyncResponse::GetData() const
{
    return m_data;
}

bool PauseOpsTasksAsyncResponse::DataHasBeenSet() const
{
