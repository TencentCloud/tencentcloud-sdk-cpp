...
CoreInternalOutcome UpdateOpsAlarmRuleResponse::Deserialize(const string &payload)
{
...
string UpdateOpsAlarmRuleResponse::ToJsonString() const
{
...
ModifyAlarmRuleResult UpdateOpsAlarmRuleResponse::GetData() const
{
    return m_data;
}

bool UpdateOpsAlarmRuleResponse::DataHasBeenSet() const
{
