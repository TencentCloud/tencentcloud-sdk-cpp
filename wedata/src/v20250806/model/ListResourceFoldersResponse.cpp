...
CoreInternalOutcome ListResourceFoldersResponse::Deserialize(const string &payload)
{
...
string ListResourceFoldersResponse::ToJsonString() const
{
...
ResourceFolderPage ListResourceFoldersResponse::GetData() const
{
    return m_data;
}

bool ListResourceFoldersResponse::DataHasBeenSet() const
{
