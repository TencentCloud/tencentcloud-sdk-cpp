...
CoreInternalOutcome ListUpstreamOpsTasksResponse::Deserialize(const string &payload)
{
...
string ListUpstreamOpsTasksResponse::ToJsonString() const
{
...
ParentDependencyConfigPage ListUpstreamOpsTasksResponse::GetData() const
{
    return m_data;
}

bool ListUpstreamOpsTasksResponse::DataHasBeenSet() const
{
