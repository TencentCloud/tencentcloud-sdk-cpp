...
CoreInternalOutcome GetProjectResponse::Deserialize(const string &payload)
{
...
string GetProjectResponse::ToJsonString() const
{
...
Project GetProjectResponse::GetData() const
{
    return m_data;
}

bool GetProjectResponse::DataHasBeenSet() const
{
