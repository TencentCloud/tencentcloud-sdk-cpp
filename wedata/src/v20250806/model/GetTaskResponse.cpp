...
CoreInternalOutcome GetTaskResponse::Deserialize(const string &payload)
{
...
string GetTaskResponse::ToJsonString() const
{
...
Task GetTaskResponse::GetData() const
{
    return m_data;
}

bool GetTaskResponse::DataHasBeenSet() const
{
