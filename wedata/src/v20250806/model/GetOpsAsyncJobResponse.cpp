...
CoreInternalOutcome GetOpsAsyncJobResponse::Deserialize(const string &payload)
{
...
string GetOpsAsyncJobResponse::ToJsonString() const
{
...
OpsAsyncJobDetail GetOpsAsyncJobResponse::GetData() const
{
    return m_data;
}

bool GetOpsAsyncJobResponse::DataHasBeenSet() const
{
