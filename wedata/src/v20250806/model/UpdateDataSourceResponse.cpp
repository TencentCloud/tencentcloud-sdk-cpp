...
CoreInternalOutcome UpdateDataSourceResponse::Deserialize(const string &payload)
{
...
string UpdateDataSourceResponse::ToJsonString() const
{
...
DataSourceStatus UpdateDataSourceResponse::GetData() const
{
    return m_data;
}

bool UpdateDataSourceResponse::DataHasBeenSet() const
{
