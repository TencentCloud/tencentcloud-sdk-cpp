...
CoreInternalOutcome ListSchemaResponse::Deserialize(const string &payload)
{
...
string ListSchemaResponse::ToJsonString() const
{
...
ListSchemaPage ListSchemaResponse::GetData() const
{
    return m_data;
}

bool ListSchemaResponse::DataHasBeenSet() const
{
