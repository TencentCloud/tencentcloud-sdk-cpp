...
CoreInternalOutcome ListWorkflowFoldersResponse::Deserialize(const string &payload)
{
...
string ListWorkflowFoldersResponse::ToJsonString() const
{
...
WorkflowFolderPage ListWorkflowFoldersResponse::GetData() const
{
    return m_data;
}

bool ListWorkflowFoldersResponse::DataHasBeenSet() const
{
