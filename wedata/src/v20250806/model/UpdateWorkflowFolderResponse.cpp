...
CoreInternalOutcome UpdateWorkflowFolderResponse::Deserialize(const string &payload)
{
...
string UpdateWorkflowFolderResponse::ToJsonString() const
{
...
UpdateFolderResult UpdateWorkflowFolderResponse::GetData() const
{
    return m_data;
}

bool UpdateWorkflowFolderResponse::DataHasBeenSet() const
{
