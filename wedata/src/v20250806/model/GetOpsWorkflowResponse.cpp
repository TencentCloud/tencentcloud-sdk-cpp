...
CoreInternalOutcome GetOpsWorkflowResponse::Deserialize(const string &payload)
{
...
string GetOpsWorkflowResponse::ToJsonString() const
{
...
OpsWorkflowDetail GetOpsWorkflowResponse::GetData() const
{
    return m_data;
}

bool GetOpsWorkflowResponse::DataHasBeenSet() const
{
