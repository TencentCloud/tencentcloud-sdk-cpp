...
string ListTenantRolesRequest::ToJsonString() const
{
...
string ListTenantRolesRequest::GetRoleDisplayName() const
{
    return m_roleDisplayName;
}

void ListTenantRolesRequest::SetRoleDisplayName(const string& _roleDisplayName)
{
    m_roleDisplayName = _roleDisplayName;
    m_roleDisplayNameHasBeenSet = true;
}

bool ListTenantRolesRequest::RoleDisplayNameHasBeenSet() const
{
