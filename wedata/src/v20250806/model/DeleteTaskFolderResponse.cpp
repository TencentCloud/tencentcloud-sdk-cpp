...
CoreInternalOutcome DeleteTaskFolderResponse::Deserialize(const string &payload)
{
...
string DeleteTaskFolderResponse::ToJsonString() const
{
...
DeleteTaskFolderResult DeleteTaskFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteTaskFolderResponse::DataHasBeenSet() const
{
