...
CoreInternalOutcome ListTriggerTaskRunsResponse::Deserialize(const string &payload)
{
...
string ListTriggerTaskRunsResponse::ToJsonString() const
{
...
ListTriggerTaskRunResult ListTriggerTaskRunsResponse::GetData() const
{
    return m_data;
}

bool ListTriggerTaskRunsResponse::DataHasBeenSet() const
{
