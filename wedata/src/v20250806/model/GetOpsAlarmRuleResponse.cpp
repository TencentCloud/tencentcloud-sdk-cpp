...
CoreInternalOutcome GetOpsAlarmRuleResponse::Deserialize(const string &payload)
{
...
string GetOpsAlarmRuleResponse::ToJsonString() const
{
...
AlarmRuleData GetOpsAlarmRuleResponse::GetData() const
{
    return m_data;
}

bool GetOpsAlarmRuleResponse::DataHasBeenSet() const
{
