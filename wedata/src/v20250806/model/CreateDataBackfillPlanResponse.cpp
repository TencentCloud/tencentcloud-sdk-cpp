...
CoreInternalOutcome CreateDataBackfillPlanResponse::Deserialize(const string &payload)
{
...
string CreateDataBackfillPlanResponse::ToJsonString() const
{
...
CreateDataReplenishmentPlan CreateDataBackfillPlanResponse::GetData() const
{
    return m_data;
}

bool CreateDataBackfillPlanResponse::DataHasBeenSet() const
{
