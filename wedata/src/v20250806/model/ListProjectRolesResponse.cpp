...
CoreInternalOutcome ListProjectRolesResponse::Deserialize(const string &payload)
{
...
string ListProjectRolesResponse::ToJsonString() const
{
...
PageRoles ListProjectRolesResponse::GetData() const
{
    return m_data;
}

bool ListProjectRolesResponse::DataHasBeenSet() const
{
