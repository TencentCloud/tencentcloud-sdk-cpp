...
CoreInternalOutcome ListOpsTasksResponse::Deserialize(const string &payload)
{
...
string ListOpsTasksResponse::ToJsonString() const
{
...
ListOpsTasksPage ListOpsTasksResponse::GetData() const
{
    return m_data;
}

bool ListOpsTasksResponse::DataHasBeenSet() const
{
