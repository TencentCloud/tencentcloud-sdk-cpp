...
CoreInternalOutcome Task::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TaskBaseAttribute") && !value["TaskBaseAttribute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Task.TaskBaseAttribute` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskConfiguration") && !value["TaskConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Task.TaskConfiguration` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskSchedulerConfiguration") && !value["TaskSchedulerConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Task.TaskSchedulerConfiguration` is not object type").SetRequestId(requestId));
        }
...
TaskBaseAttribute Task::GetTaskBaseAttribute() const
{
    return m_taskBaseAttribute;
}

void Task::SetTaskBaseAttribute(const TaskBaseAttribute& _taskBaseAttribute)
{
    m_taskBaseAttribute = _taskBaseAttribute;
    m_taskBaseAttributeHasBeenSet = true;
}

bool Task::TaskBaseAttributeHasBeenSet() const
{
    return m_taskBaseAttributeHasBeenSet;
}

TaskConfiguration Task::GetTaskConfiguration() const
{
    return m_taskConfiguration;
}

void Task::SetTaskConfiguration(const TaskConfiguration& _taskConfiguration)
{
    m_taskConfiguration = _taskConfiguration;
    m_taskConfigurationHasBeenSet = true;
}

bool Task::TaskConfigurationHasBeenSet() const
{
    return m_taskConfigurationHasBeenSet;
}

TaskSchedulerConfiguration Task::GetTaskSchedulerConfiguration() const
{
    return m_taskSchedulerConfiguration;
}

void Task::SetTaskSchedulerConfiguration(const TaskSchedulerConfiguration& _taskSchedulerConfiguration)
{
    m_taskSchedulerConfiguration = _taskSchedulerConfiguration;
    m_taskSchedulerConfigurationHasBeenSet = true;
}

bool Task::TaskSchedulerConfigurationHasBeenSet() const
{
