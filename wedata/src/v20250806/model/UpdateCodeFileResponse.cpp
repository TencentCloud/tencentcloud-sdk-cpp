...
CoreInternalOutcome UpdateCodeFileResponse::Deserialize(const string &payload)
{
...
string UpdateCodeFileResponse::ToJsonString() const
{
...
CodeFile UpdateCodeFileResponse::GetData() const
{
    return m_data;
}

bool UpdateCodeFileResponse::DataHasBeenSet() const
{
