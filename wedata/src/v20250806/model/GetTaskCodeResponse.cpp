...
CoreInternalOutcome GetTaskCodeResponse::Deserialize(const string &payload)
{
...
string GetTaskCodeResponse::ToJsonString() const
{
...
TaskCodeResult GetTaskCodeResponse::GetData() const
{
    return m_data;
}

bool GetTaskCodeResponse::DataHasBeenSet() const
{
