...
CoreInternalOutcome GetSQLFolderResponse::Deserialize(const string &payload)
{
...
string GetSQLFolderResponse::ToJsonString() const
{
...
SQLFolderNode GetSQLFolderResponse::GetData() const
{
    return m_data;
}

bool GetSQLFolderResponse::DataHasBeenSet() const
{
