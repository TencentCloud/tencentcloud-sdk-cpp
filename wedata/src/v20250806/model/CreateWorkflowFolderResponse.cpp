...
CoreInternalOutcome CreateWorkflowFolderResponse::Deserialize(const string &payload)
{
...
string CreateWorkflowFolderResponse::ToJsonString() const
{
...
CreateFolderResult CreateWorkflowFolderResponse::GetData() const
{
    return m_data;
}

bool CreateWorkflowFolderResponse::DataHasBeenSet() const
{
