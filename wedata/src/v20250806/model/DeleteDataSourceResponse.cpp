...
CoreInternalOutcome DeleteDataSourceResponse::Deserialize(const string &payload)
{
...
string DeleteDataSourceResponse::ToJsonString() const
{
...
DataSourceStatus DeleteDataSourceResponse::GetData() const
{
    return m_data;
}

bool DeleteDataSourceResponse::DataHasBeenSet() const
{
