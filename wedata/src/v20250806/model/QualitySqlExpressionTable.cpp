...
CoreInternalOutcome QualitySqlExpressionTable::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TableExpression") && !value["TableExpression"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QualitySqlExpressionTable.TableExpression` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ColumnExpression") && !value["ColumnExpression"].IsNull())
    {
        if (!value["ColumnExpression"].IsArray())
            return CoreInternalOutcome(Core::Error("response `QualitySqlExpressionTable.ColumnExpression` is not array type"));
...
void QualitySqlExpressionTable::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string QualitySqlExpressionTable::GetTableExpression() const
{
    return m_tableExpression;
}

void QualitySqlExpressionTable::SetTableExpression(const string& _tableExpression)
{
    m_tableExpression = _tableExpression;
    m_tableExpressionHasBeenSet = true;
}

bool QualitySqlExpressionTable::TableExpressionHasBeenSet() const
{
    return m_tableExpressionHasBeenSet;
}

vector<string> QualitySqlExpressionTable::GetColumnExpression() const
{
    return m_columnExpression;
}

void QualitySqlExpressionTable::SetColumnExpression(const vector<string>& _columnExpression)
{
    m_columnExpression = _columnExpression;
    m_columnExpressionHasBeenSet = true;
}

bool QualitySqlExpressionTable::ColumnExpressionHasBeenSet() const
{
