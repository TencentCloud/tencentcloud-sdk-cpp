...
CoreInternalOutcome GetTaskInstanceLogResponse::Deserialize(const string &payload)
{
...
string GetTaskInstanceLogResponse::ToJsonString() const
{
...
InstanceLog GetTaskInstanceLogResponse::GetData() const
{
    return m_data;
}

bool GetTaskInstanceLogResponse::DataHasBeenSet() const
{
