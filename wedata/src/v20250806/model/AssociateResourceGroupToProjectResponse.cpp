...
CoreInternalOutcome AssociateResourceGroupToProjectResponse::Deserialize(const string &payload)
{
...
string AssociateResourceGroupToProjectResponse::ToJsonString() const
{
...
ResourceStatus AssociateResourceGroupToProjectResponse::GetData() const
{
    return m_data;
}

bool AssociateResourceGroupToProjectResponse::DataHasBeenSet() const
{
