...
CoreInternalOutcome ListUpstreamTaskInstancesResponse::Deserialize(const string &payload)
{
...
string ListUpstreamTaskInstancesResponse::ToJsonString() const
{
...
TaskInstancePage ListUpstreamTaskInstancesResponse::GetData() const
{
    return m_data;
}

bool ListUpstreamTaskInstancesResponse::DataHasBeenSet() const
{
