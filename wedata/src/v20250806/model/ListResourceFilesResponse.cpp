...
CoreInternalOutcome ListResourceFilesResponse::Deserialize(const string &payload)
{
...
string ListResourceFilesResponse::ToJsonString() const
{
...
ResourceFilePage ListResourceFilesResponse::GetData() const
{
    return m_data;
}

bool ListResourceFilesResponse::DataHasBeenSet() const
{
