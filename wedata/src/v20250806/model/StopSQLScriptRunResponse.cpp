...
CoreInternalOutcome StopSQLScriptRunResponse::Deserialize(const string &payload)
{
...
string StopSQLScriptRunResponse::ToJsonString() const
{
...
SQLStopResult StopSQLScriptRunResponse::GetData() const
{
    return m_data;
}

bool StopSQLScriptRunResponse::DataHasBeenSet() const
{
