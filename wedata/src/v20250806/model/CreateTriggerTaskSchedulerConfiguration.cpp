...
CoreInternalOutcome CreateTriggerTaskSchedulerConfiguration::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("DependencyTriggerPolicy") && !value["DependencyTriggerPolicy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CreateTriggerTaskSchedulerConfiguration.DependencyTriggerPolicy` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AllowDownstreamDependency") && !value["AllowDownstreamDependency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CreateTriggerTaskSchedulerConfiguration.AllowDownstreamDependency` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ScheduleType") && !value["ScheduleType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CreateTriggerTaskSchedulerConfiguration.ScheduleType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string CreateTriggerTaskSchedulerConfiguration::GetDependencyTriggerPolicy() const
{
    return m_dependencyTriggerPolicy;
}

void CreateTriggerTaskSchedulerConfiguration::SetDependencyTriggerPolicy(const string& _dependencyTriggerPolicy)
{
    m_dependencyTriggerPolicy = _dependencyTriggerPolicy;
    m_dependencyTriggerPolicyHasBeenSet = true;
}

bool CreateTriggerTaskSchedulerConfiguration::DependencyTriggerPolicyHasBeenSet() const
{
    return m_dependencyTriggerPolicyHasBeenSet;
}

int64_t CreateTriggerTaskSchedulerConfiguration::GetAllowDownstreamDependency() const
{
    return m_allowDownstreamDependency;
}

void CreateTriggerTaskSchedulerConfiguration::SetAllowDownstreamDependency(const int64_t& _allowDownstreamDependency)
{
    m_allowDownstreamDependency = _allowDownstreamDependency;
    m_allowDownstreamDependencyHasBeenSet = true;
}

bool CreateTriggerTaskSchedulerConfiguration::AllowDownstreamDependencyHasBeenSet() const
{
    return m_allowDownstreamDependencyHasBeenSet;
}

int64_t CreateTriggerTaskSchedulerConfiguration::GetScheduleType() const
{
    return m_scheduleType;
}

void CreateTriggerTaskSchedulerConfiguration::SetScheduleType(const int64_t& _scheduleType)
{
    m_scheduleType = _scheduleType;
    m_scheduleTypeHasBeenSet = true;
}

bool CreateTriggerTaskSchedulerConfiguration::ScheduleTypeHasBeenSet() const
{
