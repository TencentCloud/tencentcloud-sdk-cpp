...
string GetTableColumnsRequest::ToJsonString() const
{
...
string GetTableColumnsRequest::GetTableGuid() const
{
    return m_tableGuid;
}

void GetTableColumnsRequest::SetTableGuid(const string& _tableGuid)
{
    m_tableGuid = _tableGuid;
    m_tableGuidHasBeenSet = true;
}

bool GetTableColumnsRequest::TableGuidHasBeenSet() const
{
