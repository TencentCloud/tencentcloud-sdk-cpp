...
CoreInternalOutcome ListTaskVersionsResponse::Deserialize(const string &payload)
{
...
string ListTaskVersionsResponse::ToJsonString() const
{
...
ListTaskVersions ListTaskVersionsResponse::GetData() const
{
    return m_data;
}

bool ListTaskVersionsResponse::DataHasBeenSet() const
{
