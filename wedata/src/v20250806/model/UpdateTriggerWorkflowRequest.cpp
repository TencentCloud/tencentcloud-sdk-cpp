...
WorkflowRunConfig UpdateTriggerWorkflowRequest::GetTriggerWorkflowRunConfiguration() const
{
    return m_triggerWorkflowRunConfiguration;
}

void UpdateTriggerWorkflowRequest::SetTriggerWorkflowRunConfiguration(const WorkflowRunConfig& _triggerWorkflowRunConfiguration)
{
    m_triggerWorkflowRunConfiguration = _triggerWorkflowRunConfiguration;
    m_triggerWorkflowRunConfigurationHasBeenSet = true;
}

bool UpdateTriggerWorkflowRequest::TriggerWorkflowRunConfigurationHasBeenSet() const
{
    return m_triggerWorkflowRunConfigurationHasBeenSet;
}

string UpdateTriggerWorkflowRequest::GetSchedulerStatus() const
{
    return m_schedulerStatus;
}

void UpdateTriggerWorkflowRequest::SetSchedulerStatus(const string& _schedulerStatus)
{
    m_schedulerStatus = _schedulerStatus;
    m_schedulerStatusHasBeenSet = true;
}

bool UpdateTriggerWorkflowRequest::SchedulerStatusHasBeenSet() const
{
    return m_schedulerStatusHasBeenSet;
}

string UpdateTriggerWorkflowRequest::GetTriggerMode() const
{
    return m_triggerMode;
}

void UpdateTriggerWorkflowRequest::SetTriggerMode(const string& _triggerMode)
{
    m_triggerMode = _triggerMode;
    m_triggerModeHasBeenSet = true;
}

bool UpdateTriggerWorkflowRequest::TriggerModeHasBeenSet() const
{
    return m_triggerModeHasBeenSet;
}

string UpdateTriggerWorkflowRequest::GetExecuteUserUin() const
{
    return m_executeUserUin;
}

void UpdateTriggerWorkflowRequest::SetExecuteUserUin(const string& _executeUserUin)
{
    m_executeUserUin = _executeUserUin;
    m_executeUserUinHasBeenSet = true;
}

bool UpdateTriggerWorkflowRequest::ExecuteUserUinHasBeenSet() const
{
