...
CoreInternalOutcome DeleteOpsAlarmRuleResponse::Deserialize(const string &payload)
{
...
string DeleteOpsAlarmRuleResponse::ToJsonString() const
{
...
DeleteAlarmRuleResult DeleteOpsAlarmRuleResponse::GetData() const
{
    return m_data;
}

bool DeleteOpsAlarmRuleResponse::DataHasBeenSet() const
{
