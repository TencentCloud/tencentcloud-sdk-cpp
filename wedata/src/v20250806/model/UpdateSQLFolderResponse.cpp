...
CoreInternalOutcome UpdateSQLFolderResponse::Deserialize(const string &payload)
{
...
string UpdateSQLFolderResponse::ToJsonString() const
{
...
SQLContentActionResult UpdateSQLFolderResponse::GetData() const
{
    return m_data;
}

bool UpdateSQLFolderResponse::DataHasBeenSet() const
{
