...
CoreInternalOutcome CreateResourceFolderResponse::Deserialize(const string &payload)
{
...
string CreateResourceFolderResponse::ToJsonString() const
{
...
CreateFolderResult CreateResourceFolderResponse::GetData() const
{
    return m_data;
}

bool CreateResourceFolderResponse::DataHasBeenSet() const
{
