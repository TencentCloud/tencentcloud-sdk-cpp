...
CoreInternalOutcome OutTaskParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ParamKey") && !value["ParamKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OutTaskParameter.ParamKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParamValue") && !value["ParamValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OutTaskParameter.ParamValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void OutTaskParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string OutTaskParameter::GetParamKey() const
{
    return m_paramKey;
}

void OutTaskParameter::SetParamKey(const string& _paramKey)
{
    m_paramKey = _paramKey;
    m_paramKeyHasBeenSet = true;
}

bool OutTaskParameter::ParamKeyHasBeenSet() const
{
    return m_paramKeyHasBeenSet;
}

string OutTaskParameter::GetParamValue() const
{
    return m_paramValue;
}

void OutTaskParameter::SetParamValue(const string& _paramValue)
{
    m_paramValue = _paramValue;
    m_paramValueHasBeenSet = true;
}

bool OutTaskParameter::ParamValueHasBeenSet() const
{
