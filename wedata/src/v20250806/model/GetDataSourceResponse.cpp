...
CoreInternalOutcome GetDataSourceResponse::Deserialize(const string &payload)
{
...
string GetDataSourceResponse::ToJsonString() const
{
...
DataSource GetDataSourceResponse::GetData() const
{
    return m_data;
}

bool GetDataSourceResponse::DataHasBeenSet() const
{
