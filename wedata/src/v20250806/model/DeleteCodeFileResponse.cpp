...
CoreInternalOutcome DeleteCodeFileResponse::Deserialize(const string &payload)
{
...
string DeleteCodeFileResponse::ToJsonString() const
{
...
CodeStudioFileActionResult DeleteCodeFileResponse::GetData() const
{
    return m_data;
}

bool DeleteCodeFileResponse::DataHasBeenSet() const
{
