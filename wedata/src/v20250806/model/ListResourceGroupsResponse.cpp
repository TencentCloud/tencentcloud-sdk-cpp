...
CoreInternalOutcome ListResourceGroupsResponse::Deserialize(const string &payload)
{
...
string ListResourceGroupsResponse::ToJsonString() const
{
...
ExecutorResourceGroupData ListResourceGroupsResponse::GetData() const
{
    return m_data;
}

bool ListResourceGroupsResponse::DataHasBeenSet() const
{
