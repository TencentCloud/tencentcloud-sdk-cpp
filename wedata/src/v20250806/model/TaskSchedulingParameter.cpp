...
CoreInternalOutcome TaskSchedulingParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ParamKey") && !value["ParamKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TaskSchedulingParameter.ParamKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParamValue") && !value["ParamValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TaskSchedulingParameter.ParamValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void TaskSchedulingParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string TaskSchedulingParameter::GetParamKey() const
{
    return m_paramKey;
}

void TaskSchedulingParameter::SetParamKey(const string& _paramKey)
{
    m_paramKey = _paramKey;
    m_paramKeyHasBeenSet = true;
}

bool TaskSchedulingParameter::ParamKeyHasBeenSet() const
{
    return m_paramKeyHasBeenSet;
}

string TaskSchedulingParameter::GetParamValue() const
{
    return m_paramValue;
}

void TaskSchedulingParameter::SetParamValue(const string& _paramValue)
{
    m_paramValue = _paramValue;
    m_paramValueHasBeenSet = true;
}

bool TaskSchedulingParameter::ParamValueHasBeenSet() const
{
