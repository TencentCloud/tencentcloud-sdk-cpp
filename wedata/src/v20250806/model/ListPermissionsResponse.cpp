...
CoreInternalOutcome ListPermissionsResponse::Deserialize(const string &payload)
{
...
string ListPermissionsResponse::ToJsonString() const
{
...
GetResourcePrivilegeDetailRsp ListPermissionsResponse::GetData() const
{
    return m_data;
}

bool ListPermissionsResponse::DataHasBeenSet() const
{
