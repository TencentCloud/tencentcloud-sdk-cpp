...
CoreInternalOutcome UpdateOpsTasksOwnerResponse::Deserialize(const string &payload)
{
...
string UpdateOpsTasksOwnerResponse::ToJsonString() const
{
...
UpdateTasksOwner UpdateOpsTasksOwnerResponse::GetData() const
{
    return m_data;
}

bool UpdateOpsTasksOwnerResponse::DataHasBeenSet() const
{
