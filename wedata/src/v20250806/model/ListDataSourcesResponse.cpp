...
CoreInternalOutcome ListDataSourcesResponse::Deserialize(const string &payload)
{
...
string ListDataSourcesResponse::ToJsonString() const
{
...
DataSourceInfo ListDataSourcesResponse::GetData() const
{
    return m_data;
}

bool ListDataSourcesResponse::DataHasBeenSet() const
{
