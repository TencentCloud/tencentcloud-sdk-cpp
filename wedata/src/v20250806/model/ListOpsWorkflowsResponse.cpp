...
CoreInternalOutcome ListOpsWorkflowsResponse::Deserialize(const string &payload)
{
...
string ListOpsWorkflowsResponse::ToJsonString() const
{
...
OpsWorkflows ListOpsWorkflowsResponse::GetData() const
{
    return m_data;
}

bool ListOpsWorkflowsResponse::DataHasBeenSet() const
{
