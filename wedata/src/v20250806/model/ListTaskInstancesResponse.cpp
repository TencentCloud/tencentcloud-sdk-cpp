...
CoreInternalOutcome ListTaskInstancesResponse::Deserialize(const string &payload)
{
...
string ListTaskInstancesResponse::ToJsonString() const
{
...
TaskInstancePage ListTaskInstancesResponse::GetData() const
{
    return m_data;
}

bool ListTaskInstancesResponse::DataHasBeenSet() const
{
