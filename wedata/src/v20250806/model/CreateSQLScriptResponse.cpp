...
CoreInternalOutcome CreateSQLScriptResponse::Deserialize(const string &payload)
{
...
string CreateSQLScriptResponse::ToJsonString() const
{
...
SQLScript CreateSQLScriptResponse::GetData() const
{
    return m_data;
}

bool CreateSQLScriptResponse::DataHasBeenSet() const
{
