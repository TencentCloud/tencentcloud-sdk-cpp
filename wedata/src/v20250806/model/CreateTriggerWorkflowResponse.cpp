...
CoreInternalOutcome CreateTriggerWorkflowResponse::Deserialize(const string &payload)
{
...
string CreateTriggerWorkflowResponse::ToJsonString() const
{
...
CreateTriggerWorkflowResult CreateTriggerWorkflowResponse::GetData() const
{
    return m_data;
}

bool CreateTriggerWorkflowResponse::DataHasBeenSet() const
{
