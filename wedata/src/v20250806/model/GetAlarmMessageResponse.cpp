...
CoreInternalOutcome GetAlarmMessageResponse::Deserialize(const string &payload)
{
...
string GetAlarmMessageResponse::ToJsonString() const
{
...
AlarmMessage GetAlarmMessageResponse::GetData() const
{
    return m_data;
}

bool GetAlarmMessageResponse::DataHasBeenSet() const
{
