...
CoreInternalOutcome CreateResourceGroupResponse::Deserialize(const string &payload)
{
...
string CreateResourceGroupResponse::ToJsonString() const
{
...
ResourceResult CreateResourceGroupResponse::GetData() const
{
    return m_data;
}

bool CreateResourceGroupResponse::DataHasBeenSet() const
{
