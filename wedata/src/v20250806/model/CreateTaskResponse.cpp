...
CoreInternalOutcome CreateTaskResponse::Deserialize(const string &payload)
{
...
string CreateTaskResponse::ToJsonString() const
{
...
CreateTaskResult CreateTaskResponse::GetData() const
{
    return m_data;
}

bool CreateTaskResponse::DataHasBeenSet() const
{
