...
CoreInternalOutcome GetResourceFileResponse::Deserialize(const string &payload)
{
...
string GetResourceFileResponse::ToJsonString() const
{
...
ResourceFile GetResourceFileResponse::GetData() const
{
    return m_data;
}

bool GetResourceFileResponse::DataHasBeenSet() const
{
