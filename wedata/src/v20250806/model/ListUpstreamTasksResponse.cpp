...
CoreInternalOutcome ListUpstreamTasksResponse::Deserialize(const string &payload)
{
...
string ListUpstreamTasksResponse::ToJsonString() const
{
...
DependencyConfigPage ListUpstreamTasksResponse::GetData() const
{
    return m_data;
}

bool ListUpstreamTasksResponse::DataHasBeenSet() const
{
