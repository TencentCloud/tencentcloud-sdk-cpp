...
string GrantMemberProjectRoleRequest::GetRoleId() const
{
    return m_roleId;
}

void GrantMemberProjectRoleRequest::SetRoleId(const string& _roleId)
{
    m_roleId = _roleId;
    m_roleIdHasBeenSet = true;
}

bool GrantMemberProjectRoleRequest::RoleIdHasBeenSet() const
{
