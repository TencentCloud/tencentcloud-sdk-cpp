...
string UpdateProjectRequest::ToJsonString() const
{
    ...
    if (m_projectOwnerUinHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_projectOwnerUin.c_str(), allocator).Move(), allocator);
    }
...
string UpdateProjectRequest::GetDisplayName() const
{
    return m_displayName;
}

void UpdateProjectRequest::SetDisplayName(const string& _displayName)
{
    m_displayName = _displayName;
    m_displayNameHasBeenSet = true;
}

bool UpdateProjectRequest::DisplayNameHasBeenSet() const
{
...
string UpdateProjectRequest::GetProjectOwnerUin() const
{
    return m_projectOwnerUin;
}

void UpdateProjectRequest::SetProjectOwnerUin(const string& _projectOwnerUin)
{
    m_projectOwnerUin = _projectOwnerUin;
    m_projectOwnerUinHasBeenSet = true;
}

bool UpdateProjectRequest::ProjectOwnerUinHasBeenSet() const
{
