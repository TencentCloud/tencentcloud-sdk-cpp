...
CoreInternalOutcome UpdateTaskPart::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TaskBaseAttribute") && !value["TaskBaseAttribute"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTaskPart.TaskBaseAttribute` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskConfiguration") && !value["TaskConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTaskPart.TaskConfiguration` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskSchedulerConfiguration") && !value["TaskSchedulerConfiguration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpdateTaskPart.TaskSchedulerConfiguration` is not object type").SetRequestId(requestId));
        }
...
void UpdateTaskPart::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
UpdateTaskBaseAttributePart UpdateTaskPart::GetTaskBaseAttribute() const
{
    return m_taskBaseAttribute;
}

void UpdateTaskPart::SetTaskBaseAttribute(const UpdateTaskBaseAttributePart& _taskBaseAttribute)
{
    m_taskBaseAttribute = _taskBaseAttribute;
    m_taskBaseAttributeHasBeenSet = true;
}

bool UpdateTaskPart::TaskBaseAttributeHasBeenSet() const
{
    return m_taskBaseAttributeHasBeenSet;
}

TaskConfiguration UpdateTaskPart::GetTaskConfiguration() const
{
    return m_taskConfiguration;
}

void UpdateTaskPart::SetTaskConfiguration(const TaskConfiguration& _taskConfiguration)
{
    m_taskConfiguration = _taskConfiguration;
    m_taskConfigurationHasBeenSet = true;
}

bool UpdateTaskPart::TaskConfigurationHasBeenSet() const
{
    return m_taskConfigurationHasBeenSet;
}

TaskSchedulerConfiguration UpdateTaskPart::GetTaskSchedulerConfiguration() const
{
    return m_taskSchedulerConfiguration;
}

void UpdateTaskPart::SetTaskSchedulerConfiguration(const TaskSchedulerConfiguration& _taskSchedulerConfiguration)
{
    m_taskSchedulerConfiguration = _taskSchedulerConfiguration;
    m_taskSchedulerConfigurationHasBeenSet = true;
}

bool UpdateTaskPart::TaskSchedulerConfigurationHasBeenSet() const
{
