...
CoreInternalOutcome ListTaskInstanceExecutionsResponse::Deserialize(const string &payload)
{
...
string ListTaskInstanceExecutionsResponse::ToJsonString() const
{
...
TaskInstanceExecutions ListTaskInstanceExecutionsResponse::GetData() const
{
    return m_data;
}

bool ListTaskInstanceExecutionsResponse::DataHasBeenSet() const
{
