...
CoreInternalOutcome GetTriggerWorkflowResponse::Deserialize(const string &payload)
{
...
string GetTriggerWorkflowResponse::ToJsonString() const
{
...
TriggerWorkflowDetail GetTriggerWorkflowResponse::GetData() const
{
    return m_data;
}

bool GetTriggerWorkflowResponse::DataHasBeenSet() const
{
