...
CoreInternalOutcome DeleteResourceFolderResponse::Deserialize(const string &payload)
{
...
string DeleteResourceFolderResponse::ToJsonString() const
{
...
DeleteFolderResult DeleteResourceFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteResourceFolderResponse::DataHasBeenSet() const
{
