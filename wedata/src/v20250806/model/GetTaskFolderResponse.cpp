...
CoreInternalOutcome GetTaskFolderResponse::Deserialize(const string &payload)
{
...
string GetTaskFolderResponse::ToJsonString() const
{
...
TaskFolderDetail GetTaskFolderResponse::GetData() const
{
    return m_data;
}

bool GetTaskFolderResponse::DataHasBeenSet() const
{
