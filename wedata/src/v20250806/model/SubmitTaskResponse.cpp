...
CoreInternalOutcome SubmitTaskResponse::Deserialize(const string &payload)
{
...
string SubmitTaskResponse::ToJsonString() const
{
...
SubmitTaskResult SubmitTaskResponse::GetData() const
{
    return m_data;
}

bool SubmitTaskResponse::DataHasBeenSet() const
{
