...
CoreInternalOutcome GetTaskVersionResponse::Deserialize(const string &payload)
{
...
string GetTaskVersionResponse::ToJsonString() const
{
...
TaskVersionDetail GetTaskVersionResponse::GetData() const
{
    return m_data;
}

bool GetTaskVersionResponse::DataHasBeenSet() const
{
