...
CoreInternalOutcome GetResourceFolderResponse::Deserialize(const string &payload)
{
...
string GetResourceFolderResponse::ToJsonString() const
{
...
ResourceFolderDetail GetResourceFolderResponse::GetData() const
{
    return m_data;
}

bool GetResourceFolderResponse::DataHasBeenSet() const
{
