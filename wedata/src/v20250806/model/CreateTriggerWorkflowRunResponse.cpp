...
CoreInternalOutcome CreateTriggerWorkflowRunResponse::Deserialize(const string &payload)
{
...
string CreateTriggerWorkflowRunResponse::ToJsonString() const
{
...
CreateTriggerWorkflowRunResult CreateTriggerWorkflowRunResponse::GetData() const
{
    return m_data;
}

bool CreateTriggerWorkflowRunResponse::DataHasBeenSet() const
{
