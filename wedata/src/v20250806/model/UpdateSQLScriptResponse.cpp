...
CoreInternalOutcome UpdateSQLScriptResponse::Deserialize(const string &payload)
{
...
string UpdateSQLScriptResponse::ToJsonString() const
{
...
SQLScript UpdateSQLScriptResponse::GetData() const
{
    return m_data;
}

bool UpdateSQLScriptResponse::DataHasBeenSet() const
{
