...
CoreInternalOutcome ListDownstreamOpsTasksResponse::Deserialize(const string &payload)
{
...
string ListDownstreamOpsTasksResponse::ToJsonString() const
{
...
ChildDependencyConfigPage ListDownstreamOpsTasksResponse::GetData() const
{
    return m_data;
}

bool ListDownstreamOpsTasksResponse::DataHasBeenSet() const
{
