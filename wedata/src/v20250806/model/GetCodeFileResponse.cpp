...
CoreInternalOutcome GetCodeFileResponse::Deserialize(const string &payload)
{
...
string GetCodeFileResponse::ToJsonString() const
{
...
CodeFile GetCodeFileResponse::GetData() const
{
    return m_data;
}

bool GetCodeFileResponse::DataHasBeenSet() const
{
