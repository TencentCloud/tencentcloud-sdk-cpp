...
CoreInternalOutcome CreateCodeFileResponse::Deserialize(const string &payload)
{
...
string CreateCodeFileResponse::ToJsonString() const
{
...
CodeFile CreateCodeFileResponse::GetData() const
{
    return m_data;
}

bool CreateCodeFileResponse::DataHasBeenSet() const
{
