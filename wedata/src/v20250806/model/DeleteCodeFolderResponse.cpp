...
CoreInternalOutcome DeleteCodeFolderResponse::Deserialize(const string &payload)
{
...
string DeleteCodeFolderResponse::ToJsonString() const
{
...
CodeStudioFolderActionResult DeleteCodeFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteCodeFolderResponse::DataHasBeenSet() const
{
