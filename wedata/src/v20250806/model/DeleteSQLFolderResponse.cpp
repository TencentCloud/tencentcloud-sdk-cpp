...
CoreInternalOutcome DeleteSQLFolderResponse::Deserialize(const string &payload)
{
...
string DeleteSQLFolderResponse::ToJsonString() const
{
...
SQLContentActionResult DeleteSQLFolderResponse::GetData() const
{
    return m_data;
}

bool DeleteSQLFolderResponse::DataHasBeenSet() const
{
