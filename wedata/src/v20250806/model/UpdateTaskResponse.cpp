...
CoreInternalOutcome UpdateTaskResponse::Deserialize(const string &payload)
{
...
string UpdateTaskResponse::ToJsonString() const
{
...
UpdateTaskResult UpdateTaskResponse::GetData() const
{
    return m_data;
}

bool UpdateTaskResponse::DataHasBeenSet() const
{
