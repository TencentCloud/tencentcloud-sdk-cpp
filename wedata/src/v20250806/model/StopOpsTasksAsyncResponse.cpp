...
CoreInternalOutcome StopOpsTasksAsyncResponse::Deserialize(const string &payload)
{
...
string StopOpsTasksAsyncResponse::ToJsonString() const
{
...
OpsAsyncResponse StopOpsTasksAsyncResponse::GetData() const
{
    return m_data;
}

bool StopOpsTasksAsyncResponse::DataHasBeenSet() const
{
