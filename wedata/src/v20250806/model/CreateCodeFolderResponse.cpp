...
CoreInternalOutcome CreateCodeFolderResponse::Deserialize(const string &payload)
{
...
string CreateCodeFolderResponse::ToJsonString() const
{
...
CodeStudioFolderResult CreateCodeFolderResponse::GetData() const
{
    return m_data;
}

bool CreateCodeFolderResponse::DataHasBeenSet() const
{
