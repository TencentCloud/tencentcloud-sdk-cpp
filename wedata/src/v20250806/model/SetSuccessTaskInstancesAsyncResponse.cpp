...
CoreInternalOutcome SetSuccessTaskInstancesAsyncResponse::Deserialize(const string &payload)
{
...
string SetSuccessTaskInstancesAsyncResponse::ToJsonString() const
{
...
OpsAsyncResponse SetSuccessTaskInstancesAsyncResponse::GetData() const
{
    return m_data;
}

bool SetSuccessTaskInstancesAsyncResponse::DataHasBeenSet() const
{
