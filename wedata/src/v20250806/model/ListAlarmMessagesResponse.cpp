...
CoreInternalOutcome ListAlarmMessagesResponse::Deserialize(const string &payload)
{
...
string ListAlarmMessagesResponse::ToJsonString() const
{
...
ListAlarmMessages ListAlarmMessagesResponse::GetData() const
{
    return m_data;
}

bool ListAlarmMessagesResponse::DataHasBeenSet() const
{
