...
CoreInternalOutcome CreateResourceFileResponse::Deserialize(const string &payload)
{
...
string CreateResourceFileResponse::ToJsonString() const
{
...
CreateResourceFileResult CreateResourceFileResponse::GetData() const
{
    return m_data;
}

bool CreateResourceFileResponse::DataHasBeenSet() const
{
