...
CoreInternalOutcome CreateTaskFolderResponse::Deserialize(const string &payload)
{
...
string CreateTaskFolderResponse::ToJsonString() const
{
...
CreateTaskFolderResult CreateTaskFolderResponse::GetData() const
{
    return m_data;
}

bool CreateTaskFolderResponse::DataHasBeenSet() const
{
