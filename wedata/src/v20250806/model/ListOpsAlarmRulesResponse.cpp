...
CoreInternalOutcome ListOpsAlarmRulesResponse::Deserialize(const string &payload)
{
...
string ListOpsAlarmRulesResponse::ToJsonString() const
{
...
ListAlarmRulesResult ListOpsAlarmRulesResponse::GetData() const
{
    return m_data;
}

bool ListOpsAlarmRulesResponse::DataHasBeenSet() const
{
