...
CoreInternalOutcome GetOpsTaskCodeResponse::Deserialize(const string &payload)
{
...
string GetOpsTaskCodeResponse::ToJsonString() const
{
...
TaskCode GetOpsTaskCodeResponse::GetData() const
{
    return m_data;
}

bool GetOpsTaskCodeResponse::DataHasBeenSet() const
{
