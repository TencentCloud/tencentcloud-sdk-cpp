...
CoreInternalOutcome UpdateResourceFileResponse::Deserialize(const string &payload)
{
...
string UpdateResourceFileResponse::ToJsonString() const
{
...
UpdateResourceFileResult UpdateResourceFileResponse::GetData() const
{
    return m_data;
}

bool UpdateResourceFileResponse::DataHasBeenSet() const
{
