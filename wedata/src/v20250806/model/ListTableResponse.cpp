...
CoreInternalOutcome ListTableResponse::Deserialize(const string &payload)
{
...
string ListTableResponse::ToJsonString() const
{
...
ListTablePage ListTableResponse::GetData() const
{
    return m_data;
}

bool ListTableResponse::DataHasBeenSet() const
{
