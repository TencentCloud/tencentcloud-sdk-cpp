...
CoreInternalOutcome ListProjectsResponse::Deserialize(const string &payload)
{
...
string ListProjectsResponse::ToJsonString() const
{
...
ProjectBrief ListProjectsResponse::GetData() const
{
    return m_data;
}

bool ListProjectsResponse::DataHasBeenSet() const
{
