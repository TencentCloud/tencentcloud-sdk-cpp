...
CoreInternalOutcome RerunTaskInstancesAsyncResponse::Deserialize(const string &payload)
{
...
string RerunTaskInstancesAsyncResponse::ToJsonString() const
{
...
OpsAsyncResponse RerunTaskInstancesAsyncResponse::GetData() const
{
    return m_data;
}

bool RerunTaskInstancesAsyncResponse::DataHasBeenSet() const
{
