...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKERECHARGEBYTHIRDPAYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKERECHARGEBYTHIRDPAYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RevokeRechargeByThirdPayResponse : public AbstractModel
                {
                public:
                    RevokeRechargeByThirdPayResponse();
                    ~RevokeRechargeByThirdPayResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKERECHARGEBYTHIRDPAYRESPONSE_H_
