...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTCLASSIFICATIONREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTCLASSIFICATIONREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryMerchantClassificationRequest : public AbstractModel
                {
                public:
                    QueryMerchantClassificationRequest();
                    ~QueryMerchantClassificationRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTCLASSIFICATIONREQUEST_H_
