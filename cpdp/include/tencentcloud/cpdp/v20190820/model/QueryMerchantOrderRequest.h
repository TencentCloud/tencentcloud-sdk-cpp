...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTORDERREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTORDERREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryMerchantOrderRequest : public AbstractModel
                {
                public:
                    QueryMerchantOrderRequest();
                    ~QueryMerchantOrderRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMERCHANTORDERREQUEST_H_
