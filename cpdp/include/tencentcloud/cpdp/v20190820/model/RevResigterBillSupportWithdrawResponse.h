...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RevResigterBillSupportWithdrawResponse : public AbstractModel
                {
                public:
                    RevResigterBillSupportWithdrawResponse();
                    ~RevResigterBillSupportWithdrawResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWRESPONSE_H_
