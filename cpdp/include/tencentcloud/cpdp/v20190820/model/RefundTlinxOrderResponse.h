...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDTLINXORDERRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDTLINXORDERRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RefundTlinxOrderResponse : public AbstractModel
                {
                public:
                    RefundTlinxOrderResponse();
                    ~RefundTlinxOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDTLINXORDERRESPONSE_H_
