...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryBankWithdrawCashDetailsRequest : public AbstractModel
                {
                public:
                    QueryBankWithdrawCashDetailsRequest();
                    ~QueryBankWithdrawCashDetailsRequest() = default;
                    ...
                    /**
                     * 获取STRING(8)，结束日期（若是历史查询，则必输，当日查询时，不起作用。格式：20190101）
                    ...
                    /**
                     * 设置STRING(8)，结束日期（若是历史查询，则必输，当日查询时，不起作用。格式：20190101）
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSREQUEST_H_
