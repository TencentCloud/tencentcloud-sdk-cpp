...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RevResigterBillSupportWithdrawRequest : public AbstractModel
                {
                public:
                    RevResigterBillSupportWithdrawRequest();
                    ~RevResigterBillSupportWithdrawRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVRESIGTERBILLSUPPORTWITHDRAWREQUEST_H_
