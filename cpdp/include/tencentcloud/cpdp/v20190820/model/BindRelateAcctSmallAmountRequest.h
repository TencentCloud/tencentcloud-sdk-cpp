...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTSMALLAMOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTSMALLAMOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class BindRelateAcctSmallAmountRequest : public AbstractModel
                {
                public:
                    BindRelateAcctSmallAmountRequest();
                    ~BindRelateAcctSmallAmountRequest() = default;
                    ...
                    /**
                     * 获取STRING(150)，会员的待绑定账户的开户行名称
                     * @return AcctOpenBranchName STRING(150)，会员的待绑定账户的开户行名称
                     * 
                     */
                    std::string GetAcctOpenBranchName() const;

                    /**
                     * 设置STRING(150)，会员的待绑定账户的开户行名称
                    ...
                    /**
                     * 获取STRING(1027)，转账方式（1: 往账鉴权(默认值); 2: 来账鉴权）
                     * @return ReservedMsg STRING(1027)，转账方式（1: 往账鉴权(默认值); 2: 来账鉴权）
                     * 
                     */
                    std::string GetReservedMsg() const;

                    /**
                     * 设置STRING(1027)，转账方式（1: 往账鉴权(默认值); 2: 来账鉴权）
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTSMALLAMOUNTREQUEST_H_
