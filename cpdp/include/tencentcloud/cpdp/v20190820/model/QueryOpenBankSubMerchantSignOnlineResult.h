...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINERESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINERESULT_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 子商户查询签约返回结果
                */
                class QueryOpenBankSubMerchantSignOnlineResult : public AbstractModel
                {
                public:
                    QueryOpenBankSubMerchantSignOnlineResult();
                    ~QueryOpenBankSubMerchantSignOnlineResult() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINERESULT_H_
