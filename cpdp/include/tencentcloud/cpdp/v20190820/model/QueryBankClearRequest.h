...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryBankClearRequest : public AbstractModel
                {
                public:
                    QueryBankClearRequest();
                    ~QueryBankClearRequest() = default;
                    ...
                    /**
                     * 获取STRING(2)，功能标志（1: 全部; 2: 指定时间段）
                     * @return FunctionFlag STRING(2)，功能标志（1: 全部; 2: 指定时间段）
                     * 
                     */
                    std::string GetFunctionFlag() const;

                    /**
                     * 设置STRING(2)，功能标志（1: 全部; 2: 指定时间段）
                    ...
                    /**
                     * 获取STRING(8)，开始日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式: 20190101）
                     * @return StartDate STRING(8)，开始日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式: 20190101）
                     * 
                     */
                    std::string GetStartDate() const;

                    /**
                     * 设置STRING(8)，开始日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式: 20190101）
                    ...
                    /**
                     * 获取STRING(8)，终止日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式：20190101）
                     * @return EndDate STRING(8)，终止日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式：20190101）
                     * 
                     */
                    std::string GetEndDate() const;

                    /**
                     * 设置STRING(8)，终止日期（若是指定时间段查询，则必输，当查询全部时，不起作用。格式：20190101）
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARREQUEST_H_
