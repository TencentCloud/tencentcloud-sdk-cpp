...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEACCREDITQUERYREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEACCREDITQUERYREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class DistributeAccreditQueryRequest : public AbstractModel
                {
                public:
                    DistributeAccreditQueryRequest();
                    ~DistributeAccreditQueryRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEACCREDITQUERYREQUEST_H_
