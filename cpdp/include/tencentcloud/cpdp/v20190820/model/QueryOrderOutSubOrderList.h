...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYORDEROUTSUBORDERLIST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYORDEROUTSUBORDERLIST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 子订单列表
                */
                class QueryOrderOutSubOrderList : public AbstractModel
                {
                public:
                    QueryOrderOutSubOrderList();
                    ~QueryOrderOutSubOrderList() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYORDEROUTSUBORDERLIST_H_
