...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVREGISTERBILLSUPPORTWITHDRAWRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVREGISTERBILLSUPPORTWITHDRAWRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RevRegisterBillSupportWithdrawResponse : public AbstractModel
                {
                public:
                    RevRegisterBillSupportWithdrawResponse();
                    ~RevRegisterBillSupportWithdrawResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVREGISTERBILLSUPPORTWITHDRAWRESPONSE_H_
