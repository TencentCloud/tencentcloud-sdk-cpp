...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankExternalSubMerchantBankAccountRequest : public AbstractModel
                {
                public:
                    QueryOpenBankExternalSubMerchantBankAccountRequest();
                    ~QueryOpenBankExternalSubMerchantBankAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
