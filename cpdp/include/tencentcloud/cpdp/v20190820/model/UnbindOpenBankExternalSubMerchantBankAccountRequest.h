...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class UnbindOpenBankExternalSubMerchantBankAccountRequest : public AbstractModel
                {
                public:
                    UnbindOpenBankExternalSubMerchantBankAccountRequest();
                    ~UnbindOpenBankExternalSubMerchantBankAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
