...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_WITHDRAWCASHMEMBERSHIPRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_WITHDRAWCASHMEMBERSHIPRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class WithdrawCashMembershipResponse : public AbstractModel
                {
                public:
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取STRING(20)，转账手续费（固定返回0.00）
注意：此字段可能返回 null，表示取不到有效值。
                     * @return TransferFee STRING(20)，转账手续费（固定返回0.00）
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::string GetTransferFee() const;

                    /**
                     * 判断参数 TransferFee 是否已赋值
                     * @return TransferFee 是否已赋值
                     * 
                     */
                    bool TransferFeeHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_transferFee;
                    bool m_transferFeeHasBeenSet;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_WITHDRAWCASHMEMBERSHIPRESPONSE_H_
