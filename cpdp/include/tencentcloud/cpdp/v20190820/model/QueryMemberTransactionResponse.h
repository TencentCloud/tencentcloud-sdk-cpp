...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERTRANSACTIONRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERTRANSACTIONRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryMemberTransactionResponse : public AbstractModel
                {
                public:
                    QueryMemberTransactionResponse();
                    ~QueryMemberTransactionResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERTRANSACTIONRESPONSE_H_
