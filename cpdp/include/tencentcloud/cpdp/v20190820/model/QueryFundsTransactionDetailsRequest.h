...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFUNDSTRANSACTIONDETAILSREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFUNDSTRANSACTIONDETAILSREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryFundsTransactionDetailsRequest : public AbstractModel
                {
                public:
                    QueryFundsTransactionDetailsRequest();
                    ~QueryFundsTransactionDetailsRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFUNDSTRANSACTIONDETAILSREQUEST_H_
