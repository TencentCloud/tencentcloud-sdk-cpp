...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDOUTSUBORDERREFUNDLIST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDOUTSUBORDERREFUNDLIST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 退款子订单列表
                */
                class RefundOutSubOrderRefundList : public AbstractModel
                {
                public:
                    RefundOutSubOrderRefundList();
                    ~RefundOutSubOrderRefundList() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDOUTSUBORDERREFUNDLIST_H_
