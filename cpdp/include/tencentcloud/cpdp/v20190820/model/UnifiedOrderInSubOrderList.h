...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERINSUBORDERLIST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERINSUBORDERLIST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 子订单列表
                */
                class UnifiedOrderInSubOrderList : public AbstractModel
                {
                public:
                    UnifiedOrderInSubOrderList();
                    ~UnifiedOrderInSubOrderList() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERINSUBORDERLIST_H_
