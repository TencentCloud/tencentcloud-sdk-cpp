...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKDOWNLOADURLRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKDOWNLOADURLRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankDownLoadUrlResponse : public AbstractModel
                {
                public:
                    QueryOpenBankDownLoadUrlResponse();
                    ~QueryOpenBankDownLoadUrlResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKDOWNLOADURLRESPONSE_H_
