...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYSHOPOPENIDREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYSHOPOPENIDREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryShopOpenIdRequest : public AbstractModel
                {
                public:
                    QueryShopOpenIdRequest();
                    ~QueryShopOpenIdRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYSHOPOPENIDREQUEST_H_
