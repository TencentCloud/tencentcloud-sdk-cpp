...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBINDEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBINDEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 子商户银行卡绑定结果查询返回结果
                */
                class QueryOpenBankBindExternalSubMerchantBankAccountResult : public AbstractModel
                {
                public:
                    QueryOpenBankBindExternalSubMerchantBankAccountResult();
                    ~QueryOpenBankBindExternalSubMerchantBankAccountResult() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取渠道子商户收款方银行卡信息, 为JSON格式字符串（绑定成功状态下返回）。详情见附录-复杂类型。
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置渠道子商户收款方银行卡信息, 为JSON格式字符串（绑定成功状态下返回）。详情见附录-复杂类型。
注意：此字段可能返回 null，表示取不到有效值。
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBINDEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
