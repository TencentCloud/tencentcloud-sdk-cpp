...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDMEMBERTRANSACTIONRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDMEMBERTRANSACTIONRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RefundMemberTransactionResponse : public AbstractModel
                {
                public:
                    RefundMemberTransactionResponse();
                    ~RefundMemberTransactionResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REFUNDMEMBERTRANSACTIONRESPONSE_H_
