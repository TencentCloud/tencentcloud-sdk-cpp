...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankSubMerchantSignOnlineRequest : public AbstractModel
                {
                public:
                    QueryOpenBankSubMerchantSignOnlineRequest();
                    ~QueryOpenBankSubMerchantSignOnlineRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKSUBMERCHANTSIGNONLINEREQUEST_H_
