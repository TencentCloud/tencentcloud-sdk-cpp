...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryContractRequest : public AbstractModel
                {
                public:
                    QueryContractRequest();
                    ~QueryContractRequest() = default;
...
CONTRACT_QUERY_MODE_BY_CHANNEL_CONTRACT_CODE：按ChannelContractCode查询
                     */
                    std::string m_contractQueryMode;
                    bool m_contractQueryModeHasBeenSet;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTREQUEST_H_
