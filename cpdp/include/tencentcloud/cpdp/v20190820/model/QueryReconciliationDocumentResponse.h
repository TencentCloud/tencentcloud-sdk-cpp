...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYRECONCILIATIONDOCUMENTRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYRECONCILIATIONDOCUMENTRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryReconciliationDocumentResponse : public AbstractModel
                {
                public:
                    QueryReconciliationDocumentResponse();
                    ~QueryReconciliationDocumentResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<FileItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<FileItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYRECONCILIATIONDOCUMENTRESPONSE_H_
