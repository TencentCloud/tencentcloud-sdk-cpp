...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * UnifiedOrder返回参数结构体
                */
                class UnifiedOrderResponse : public AbstractModel
                {
                public:
                    UnifiedOrderResponse();
                    ~UnifiedOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_UNIFIEDORDERRESPONSE_H_
