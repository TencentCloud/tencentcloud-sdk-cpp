...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKTRANSACTIONDETAILSRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKTRANSACTIONDETAILSRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryBankTransactionDetailsResponse : public AbstractModel
                {
                public:
                    QueryBankTransactionDetailsResponse();
                    ~QueryBankTransactionDetailsResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TransactionItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TransactionItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKTRANSACTIONDETAILSRESPONSE_H_
