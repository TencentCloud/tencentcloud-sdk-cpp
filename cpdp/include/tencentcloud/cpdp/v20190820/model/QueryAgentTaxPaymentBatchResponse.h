...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYAGENTTAXPAYMENTBATCHRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYAGENTTAXPAYMENTBATCHRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryAgentTaxPaymentBatchResponse : public AbstractModel
                {
                public:
                    QueryAgentTaxPaymentBatchResponse();
                    ~QueryAgentTaxPaymentBatchResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYAGENTTAXPAYMENTBATCHRESPONSE_H_
