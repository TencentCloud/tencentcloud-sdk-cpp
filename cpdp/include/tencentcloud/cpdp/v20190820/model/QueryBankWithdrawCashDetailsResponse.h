...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryBankWithdrawCashDetailsResponse : public AbstractModel
                {
                public:
                    QueryBankWithdrawCashDetailsResponse();
                    ~QueryBankWithdrawCashDetailsResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<WithdrawItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<WithdrawItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKWITHDRAWCASHDETAILSRESPONSE_H_
