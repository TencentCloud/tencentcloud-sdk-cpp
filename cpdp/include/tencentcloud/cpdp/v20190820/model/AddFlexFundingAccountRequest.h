...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_ADDFLEXFUNDINGACCOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_ADDFLEXFUNDINGACCOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class AddFlexFundingAccountRequest : public AbstractModel
                {
                public:
                    AddFlexFundingAccountRequest();
                    ~AddFlexFundingAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_ADDFLEXFUNDINGACCOUNTREQUEST_H_
