...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBANKACCOUNTBALANCEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBANKACCOUNTBALANCEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankBankAccountBalanceRequest : public AbstractModel
                {
                public:
                    QueryOpenBankBankAccountBalanceRequest();
                    ~QueryOpenBankBankAccountBalanceRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKBANKACCOUNTBALANCEREQUEST_H_
