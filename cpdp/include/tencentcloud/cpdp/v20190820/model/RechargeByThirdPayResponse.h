...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_RECHARGEBYTHIRDPAYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_RECHARGEBYTHIRDPAYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RechargeByThirdPayResponse : public AbstractModel
                {
                public:
                    RechargeByThirdPayResponse();
                    ~RechargeByThirdPayResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_RECHARGEBYTHIRDPAYRESPONSE_H_
