...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYWAYLISTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYWAYLISTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryContractPayWayListRequest : public AbstractModel
                {
                public:
                    QueryContractPayWayListRequest();
                    ~QueryContractPayWayListRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYWAYLISTREQUEST_H_
