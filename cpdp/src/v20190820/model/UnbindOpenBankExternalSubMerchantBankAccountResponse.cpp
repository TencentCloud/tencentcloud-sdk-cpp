...
CoreInternalOutcome UnbindOpenBankExternalSubMerchantBankAccountResponse::Deserialize(const string &payload)
{
...
string UnbindOpenBankExternalSubMerchantBankAccountResponse::ToJsonString() const
{
...
string UnbindOpenBankExternalSubMerchantBankAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool UnbindOpenBankExternalSubMerchantBankAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string UnbindOpenBankExternalSubMerchantBankAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool UnbindOpenBankExternalSubMerchantBankAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

UnbindOpenBankExternalSubMerchantBankAccountResult UnbindOpenBankExternalSubMerchantBankAccountResponse::GetResult() const
{
    return m_result;
}

bool UnbindOpenBankExternalSubMerchantBankAccountResponse::ResultHasBeenSet() const
{
