...
ModifyFlexPayeeAccountRightStatusResponse::ModifyFlexPayeeAccountRightStatusResponse() :
...
CoreInternalOutcome ModifyFlexPayeeAccountRightStatusResponse::Deserialize(const string &payload)
{
...
string ModifyFlexPayeeAccountRightStatusResponse::ToJsonString() const
{
...
string ModifyFlexPayeeAccountRightStatusResponse::GetErrCode() const
{
    return m_errCode;
}

bool ModifyFlexPayeeAccountRightStatusResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ModifyFlexPayeeAccountRightStatusResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ModifyFlexPayeeAccountRightStatusResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string ModifyFlexPayeeAccountRightStatusResponse::GetResult() const
{
    return m_result;
}

bool ModifyFlexPayeeAccountRightStatusResponse::ResultHasBeenSet() const
{
