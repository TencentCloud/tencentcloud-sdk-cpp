...
CoreInternalOutcome UnifiedCloudOrderResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ChannelInfo") && !rsp["ChannelInfo"].IsNull())
    {
        if (!rsp["ChannelInfo"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `ChannelInfo` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_channelInfo = string(rsp["ChannelInfo"].GetString());
...
string UnifiedCloudOrderResponse::ToJsonString() const
{
...
string UnifiedCloudOrderResponse::GetTransactionId() const
{
    return m_transactionId;
}

bool UnifiedCloudOrderResponse::TransactionIdHasBeenSet() const
{
    return m_transactionIdHasBeenSet;
}

string UnifiedCloudOrderResponse::GetOutTradeNo() const
{
    return m_outTradeNo;
}

bool UnifiedCloudOrderResponse::OutTradeNoHasBeenSet() const
{
    return m_outTradeNoHasBeenSet;
}

string UnifiedCloudOrderResponse::GetPayInfo() const
{
    return m_payInfo;
}

bool UnifiedCloudOrderResponse::PayInfoHasBeenSet() const
{
    return m_payInfoHasBeenSet;
}

int64_t UnifiedCloudOrderResponse::GetTotalAmt() const
{
    return m_totalAmt;
}

bool UnifiedCloudOrderResponse::TotalAmtHasBeenSet() const
{
    return m_totalAmtHasBeenSet;
}

string UnifiedCloudOrderResponse::GetChannelInfo() const
{
    return m_channelInfo;
}

bool UnifiedCloudOrderResponse::ChannelInfoHasBeenSet() const
{
