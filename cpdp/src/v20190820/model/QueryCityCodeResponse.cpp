...
CoreInternalOutcome QueryCityCodeResponse::Deserialize(const string &payload)
{
...
string QueryCityCodeResponse::ToJsonString() const
{
...
string QueryCityCodeResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryCityCodeResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string QueryCityCodeResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryCityCodeResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

vector<CityCodeResult> QueryCityCodeResponse::GetResult() const
{
    return m_result;
}

bool QueryCityCodeResponse::ResultHasBeenSet() const
{
