...
CoreInternalOutcome DistributeAccreditTlinxResponse::Deserialize(const string &payload)
{
...
string DistributeAccreditTlinxResponse::ToJsonString() const
{
...
string DistributeAccreditTlinxResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeAccreditTlinxResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeAccreditTlinxResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeAccreditTlinxResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeAccreditResult DistributeAccreditTlinxResponse::GetResult() const
{
    return m_result;
}

bool DistributeAccreditTlinxResponse::ResultHasBeenSet() const
{
