...
ApplyOpenBankSubMerchantSignOnlineResponse::ApplyOpenBankSubMerchantSignOnlineResponse() :
...
CoreInternalOutcome ApplyOpenBankSubMerchantSignOnlineResponse::Deserialize(const string &payload)
{
...
string ApplyOpenBankSubMerchantSignOnlineResponse::ToJsonString() const
{
...
string ApplyOpenBankSubMerchantSignOnlineResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyOpenBankSubMerchantSignOnlineResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyOpenBankSubMerchantSignOnlineResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyOpenBankSubMerchantSignOnlineResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyOpenBankSubMerchantSignOnlineResult ApplyOpenBankSubMerchantSignOnlineResponse::GetResult() const
{
    return m_result;
}

bool ApplyOpenBankSubMerchantSignOnlineResponse::ResultHasBeenSet() const
{
