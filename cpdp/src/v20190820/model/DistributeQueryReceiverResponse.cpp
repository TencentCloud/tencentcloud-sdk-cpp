...
CoreInternalOutcome DistributeQueryReceiverResponse::Deserialize(const string &payload)
{
...
string DistributeQueryReceiverResponse::ToJsonString() const
{
...
string DistributeQueryReceiverResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeQueryReceiverResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeQueryReceiverResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeQueryReceiverResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeReceiverResult DistributeQueryReceiverResponse::GetResult() const
{
    return m_result;
}

bool DistributeQueryReceiverResponse::ResultHasBeenSet() const
{
