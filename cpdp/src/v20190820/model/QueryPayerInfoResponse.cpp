...
CoreInternalOutcome QueryPayerInfoResponse::Deserialize(const string &payload)
{
...
string QueryPayerInfoResponse::ToJsonString() const
{
...
QueryPayerinfoResult QueryPayerInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryPayerInfoResponse::ResultHasBeenSet() const
{
