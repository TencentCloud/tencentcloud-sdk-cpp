...
QueryOpenBankVerificationOrderResponse::QueryOpenBankVerificationOrderResponse() :
...
CoreInternalOutcome QueryOpenBankVerificationOrderResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankVerificationOrderResponse::ToJsonString() const
{
...
string QueryOpenBankVerificationOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankVerificationOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankVerificationOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankVerificationOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankVerificationResult QueryOpenBankVerificationOrderResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankVerificationOrderResponse::ResultHasBeenSet() const
{
