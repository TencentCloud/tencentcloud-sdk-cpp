...
CoreInternalOutcome CreateInvoiceV2Response::Deserialize(const string &payload)
{
...
string CreateInvoiceV2Response::ToJsonString() const
{
...
CreateInvoiceResultV2 CreateInvoiceV2Response::GetResult() const
{
    return m_result;
}

bool CreateInvoiceV2Response::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string CreateInvoiceV2Response::GetErrCode() const
{
    return m_errCode;
}

bool CreateInvoiceV2Response::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateInvoiceV2Response::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateInvoiceV2Response::ErrMessageHasBeenSet() const
{
