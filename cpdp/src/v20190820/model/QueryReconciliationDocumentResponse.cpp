...
string QueryReconciliationDocumentResponse::ToJsonString() const
{
...
string QueryReconciliationDocumentResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool QueryReconciliationDocumentResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string QueryReconciliationDocumentResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool QueryReconciliationDocumentResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string QueryReconciliationDocumentResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool QueryReconciliationDocumentResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string QueryReconciliationDocumentResponse::GetResultNum() const
{
    return m_resultNum;
}

bool QueryReconciliationDocumentResponse::ResultNumHasBeenSet() const
{
    return m_resultNumHasBeenSet;
}

vector<FileItem> QueryReconciliationDocumentResponse::GetTranItemArray() const
{
    return m_tranItemArray;
}

bool QueryReconciliationDocumentResponse::TranItemArrayHasBeenSet() const
{
    return m_tranItemArrayHasBeenSet;
}

string QueryReconciliationDocumentResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool QueryReconciliationDocumentResponse::ReservedMsgHasBeenSet() const
{
