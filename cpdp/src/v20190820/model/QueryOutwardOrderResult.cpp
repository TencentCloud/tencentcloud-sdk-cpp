...
CoreInternalOutcome QueryOutwardOrderResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void QueryOutwardOrderResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
