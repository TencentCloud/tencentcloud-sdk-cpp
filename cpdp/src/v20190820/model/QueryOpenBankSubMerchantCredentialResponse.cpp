...
QueryOpenBankSubMerchantCredentialResponse::QueryOpenBankSubMerchantCredentialResponse() :
...
CoreInternalOutcome QueryOpenBankSubMerchantCredentialResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankSubMerchantCredentialResponse::ToJsonString() const
{
...
string QueryOpenBankSubMerchantCredentialResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankSubMerchantCredentialResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankSubMerchantCredentialResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankSubMerchantCredentialResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankSubMerchantCredentialResult QueryOpenBankSubMerchantCredentialResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankSubMerchantCredentialResponse::ResultHasBeenSet() const
{
