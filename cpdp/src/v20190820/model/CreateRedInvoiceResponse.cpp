...
CoreInternalOutcome CreateRedInvoiceResponse::Deserialize(const string &payload)
{
...
string CreateRedInvoiceResponse::ToJsonString() const
{
...
CreateRedInvoiceResult CreateRedInvoiceResponse::GetResult() const
{
    return m_result;
}

bool CreateRedInvoiceResponse::ResultHasBeenSet() const
{
