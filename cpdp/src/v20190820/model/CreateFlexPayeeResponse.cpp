...
CreateFlexPayeeResponse::CreateFlexPayeeResponse() :
...
CoreInternalOutcome CreateFlexPayeeResponse::Deserialize(const string &payload)
{
...
string CreateFlexPayeeResponse::ToJsonString() const
{
...
string CreateFlexPayeeResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateFlexPayeeResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateFlexPayeeResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateFlexPayeeResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateFlexPayeeResult CreateFlexPayeeResponse::GetResult() const
{
    return m_result;
}

bool CreateFlexPayeeResponse::ResultHasBeenSet() const
{
