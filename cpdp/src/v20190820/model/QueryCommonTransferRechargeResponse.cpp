...
CoreInternalOutcome QueryCommonTransferRechargeResponse::Deserialize(const string &payload)
{
...
string QueryCommonTransferRechargeResponse::ToJsonString() const
{
...
string QueryCommonTransferRechargeResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool QueryCommonTransferRechargeResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool QueryCommonTransferRechargeResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool QueryCommonTransferRechargeResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetResultNum() const
{
    return m_resultNum;
}

bool QueryCommonTransferRechargeResponse::ResultNumHasBeenSet() const
{
    return m_resultNumHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetStartRecordNo() const
{
    return m_startRecordNo;
}

bool QueryCommonTransferRechargeResponse::StartRecordNoHasBeenSet() const
{
    return m_startRecordNoHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetEndFlag() const
{
    return m_endFlag;
}

bool QueryCommonTransferRechargeResponse::EndFlagHasBeenSet() const
{
    return m_endFlagHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool QueryCommonTransferRechargeResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<TransferItem> QueryCommonTransferRechargeResponse::GetTranItemArray() const
{
    return m_tranItemArray;
}

bool QueryCommonTransferRechargeResponse::TranItemArrayHasBeenSet() const
{
    return m_tranItemArrayHasBeenSet;
}

string QueryCommonTransferRechargeResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool QueryCommonTransferRechargeResponse::ReservedMsgHasBeenSet() const
{
