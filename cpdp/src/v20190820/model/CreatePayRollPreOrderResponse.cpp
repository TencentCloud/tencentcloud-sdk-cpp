...
CoreInternalOutcome CreatePayRollPreOrderResponse::Deserialize(const string &payload)
{
...
string CreatePayRollPreOrderResponse::ToJsonString() const
{
...
string CreatePayRollPreOrderResponse::GetAuthNumber() const
{
    return m_authNumber;
}

bool CreatePayRollPreOrderResponse::AuthNumberHasBeenSet() const
{
    return m_authNumberHasBeenSet;
}

int64_t CreatePayRollPreOrderResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool CreatePayRollPreOrderResponse::ExpireTimeHasBeenSet() const
{
    return m_expireTimeHasBeenSet;
}

string CreatePayRollPreOrderResponse::GetMerchantId() const
{
    return m_merchantId;
}

bool CreatePayRollPreOrderResponse::MerchantIdHasBeenSet() const
{
    return m_merchantIdHasBeenSet;
}

string CreatePayRollPreOrderResponse::GetOpenId() const
{
    return m_openId;
}

bool CreatePayRollPreOrderResponse::OpenIdHasBeenSet() const
{
    return m_openIdHasBeenSet;
}

string CreatePayRollPreOrderResponse::GetSubMerchantId() const
{
    return m_subMerchantId;
}

bool CreatePayRollPreOrderResponse::SubMerchantIdHasBeenSet() const
{
    return m_subMerchantIdHasBeenSet;
}

string CreatePayRollPreOrderResponse::GetToken() const
{
    return m_token;
}

bool CreatePayRollPreOrderResponse::TokenHasBeenSet() const
{
