...
CoreInternalOutcome DeduceQuotaResponse::Deserialize(const string &payload)
{
...
string DeduceQuotaResponse::ToJsonString() const
{
...
string DeduceQuotaResponse::GetErrCode() const
{
    return m_errCode;
}

bool DeduceQuotaResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string DeduceQuotaResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool DeduceQuotaResponse::ErrMsgHasBeenSet() const
{
    return m_errMsgHasBeenSet;
}

AssignmentData DeduceQuotaResponse::GetResult() const
{
    return m_result;
}

bool DeduceQuotaResponse::ResultHasBeenSet() const
{
