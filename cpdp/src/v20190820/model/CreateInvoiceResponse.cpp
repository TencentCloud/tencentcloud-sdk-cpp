...
CoreInternalOutcome CreateInvoiceResponse::Deserialize(const string &payload)
{
...
string CreateInvoiceResponse::ToJsonString() const
{
...
CreateInvoiceResult CreateInvoiceResponse::GetResult() const
{
    return m_result;
}

bool CreateInvoiceResponse::ResultHasBeenSet() const
{
