...
CoreInternalOutcome CreateOpenBankPaymentOrderResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankPaymentOrderResponse::ToJsonString() const
{
...
string CreateOpenBankPaymentOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankPaymentOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankPaymentOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankPaymentOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankOrderPaymentResult CreateOpenBankPaymentOrderResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankPaymentOrderResponse::ResultHasBeenSet() const
{
