...
AddFlexFundingAccountResponse::AddFlexFundingAccountResponse() :
...
CoreInternalOutcome AddFlexFundingAccountResponse::Deserialize(const string &payload)
{
...
string AddFlexFundingAccountResponse::ToJsonString() const
{
...
string AddFlexFundingAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddFlexFundingAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string AddFlexFundingAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddFlexFundingAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PayeeFundingAccountResult AddFlexFundingAccountResponse::GetResult() const
{
    return m_result;
}

bool AddFlexFundingAccountResponse::ResultHasBeenSet() const
{
