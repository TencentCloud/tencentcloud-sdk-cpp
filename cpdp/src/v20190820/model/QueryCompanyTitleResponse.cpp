...
QueryCompanyTitleResponse::QueryCompanyTitleResponse() :
...
CoreInternalOutcome QueryCompanyTitleResponse::Deserialize(const string &payload)
{
...
string QueryCompanyTitleResponse::ToJsonString() const
{
...
string QueryCompanyTitleResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryCompanyTitleResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryCompanyTitleResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryCompanyTitleResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

vector<CompanyTitleResult> QueryCompanyTitleResponse::GetResult() const
{
    return m_result;
}

bool QueryCompanyTitleResponse::ResultHasBeenSet() const
{
