...
CreateOpenBankGlobalPaymentOrderResponse::CreateOpenBankGlobalPaymentOrderResponse() :
...
CoreInternalOutcome CreateOpenBankGlobalPaymentOrderResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankGlobalPaymentOrderResponse::ToJsonString() const
{
...
string CreateOpenBankGlobalPaymentOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankGlobalPaymentOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankGlobalPaymentOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankGlobalPaymentOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankUnifiedOrderPaymentResult CreateOpenBankGlobalPaymentOrderResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankGlobalPaymentOrderResponse::ResultHasBeenSet() const
{
