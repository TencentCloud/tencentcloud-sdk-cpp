...
CoreInternalOutcome QueryMemberTransactionDetailsResponse::Deserialize(const string &payload)
{
...
string QueryMemberTransactionDetailsResponse::ToJsonString() const
{
...
string QueryMemberTransactionDetailsResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryMemberTransactionDetailsResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryMemberTransactionDetailsResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryMemberTransactionDetailsResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryMemberTransactionDetailsResult QueryMemberTransactionDetailsResponse::GetResult() const
{
    return m_result;
}

bool QueryMemberTransactionDetailsResponse::ResultHasBeenSet() const
{
