...
CoreInternalOutcome RevRegisterBillSupportWithdrawResponse::Deserialize(const string &payload)
{
    Document d;
...
string RevRegisterBillSupportWithdrawResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool RevRegisterBillSupportWithdrawResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string RevRegisterBillSupportWithdrawResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool RevRegisterBillSupportWithdrawResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string RevRegisterBillSupportWithdrawResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool RevRegisterBillSupportWithdrawResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string RevRegisterBillSupportWithdrawResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool RevRegisterBillSupportWithdrawResponse::FrontSeqNoHasBeenSet() const
{
    return m_frontSeqNoHasBeenSet;
}

string RevRegisterBillSupportWithdrawResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool RevRegisterBillSupportWithdrawResponse::ReservedMsgHasBeenSet() const
{
