...
CoreInternalOutcome ApplyReconciliationFileResponse::Deserialize(const string &payload)
{
...
string ApplyReconciliationFileResponse::ToJsonString() const
{
...
string ApplyReconciliationFileResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyReconciliationFileResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyReconciliationFileResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyReconciliationFileResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyReconciliationFileResult ApplyReconciliationFileResponse::GetResult() const
{
    return m_result;
}

bool ApplyReconciliationFileResponse::ResultHasBeenSet() const
{
