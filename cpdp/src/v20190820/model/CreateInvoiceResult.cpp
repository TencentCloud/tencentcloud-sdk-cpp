...
CoreInternalOutcome CreateInvoiceResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateInvoiceResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
