...
CoreInternalOutcome TransferSinglePayResponse::Deserialize(const string &payload)
{
...
string TransferSinglePayResponse::ToJsonString() const
{
...
string TransferSinglePayResponse::GetErrCode() const
{
    return m_errCode;
}

bool TransferSinglePayResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string TransferSinglePayResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool TransferSinglePayResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

TransferSinglePayData TransferSinglePayResponse::GetResult() const
{
    return m_result;
}

bool TransferSinglePayResponse::ResultHasBeenSet() const
{
