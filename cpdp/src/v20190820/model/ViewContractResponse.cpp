...
CoreInternalOutcome ViewContractResponse::Deserialize(const string &payload)
{
...
string ViewContractResponse::ToJsonString() const
{
...
string ViewContractResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ViewContractResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string ViewContractResponse::GetErrCode() const
{
    return m_errCode;
}

bool ViewContractResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

ViewContractResult ViewContractResponse::GetResult() const
{
    return m_result;
}

bool ViewContractResponse::ResultHasBeenSet() const
{
