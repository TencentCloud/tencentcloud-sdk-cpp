...
CoreInternalOutcome BindOpenBankExternalSubMerchantBankAccountResponse::Deserialize(const string &payload)
{
...
string BindOpenBankExternalSubMerchantBankAccountResponse::ToJsonString() const
{
...
string BindOpenBankExternalSubMerchantBankAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool BindOpenBankExternalSubMerchantBankAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string BindOpenBankExternalSubMerchantBankAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool BindOpenBankExternalSubMerchantBankAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

BindOpenBankExternalSubMerchantBankAccountResult BindOpenBankExternalSubMerchantBankAccountResponse::GetResult() const
{
    return m_result;
}

bool BindOpenBankExternalSubMerchantBankAccountResponse::ResultHasBeenSet() const
{
