...
QueryFlexPayeeAccountListResponse::QueryFlexPayeeAccountListResponse() :
...
CoreInternalOutcome QueryFlexPayeeAccountListResponse::Deserialize(const string &payload)
{
...
string QueryFlexPayeeAccountListResponse::ToJsonString() const
{
...
string QueryFlexPayeeAccountListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPayeeAccountListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPayeeAccountListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPayeeAccountListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PayeeAccountInfos QueryFlexPayeeAccountListResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPayeeAccountListResponse::ResultHasBeenSet() const
{
