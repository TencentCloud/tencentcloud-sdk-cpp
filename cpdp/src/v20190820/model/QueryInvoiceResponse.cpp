...
CoreInternalOutcome QueryInvoiceResponse::Deserialize(const string &payload)
{
...
string QueryInvoiceResponse::ToJsonString() const
{
...
QueryInvoiceResult QueryInvoiceResponse::GetResult() const
{
    return m_result;
}

bool QueryInvoiceResponse::ResultHasBeenSet() const
{
