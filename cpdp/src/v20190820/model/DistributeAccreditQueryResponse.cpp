...
CoreInternalOutcome DistributeAccreditQueryResponse::Deserialize(const string &payload)
{
...
string DistributeAccreditQueryResponse::ToJsonString() const
{
...
string DistributeAccreditQueryResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeAccreditQueryResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeAccreditQueryResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeAccreditQueryResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeAccreditQueryResult DistributeAccreditQueryResponse::GetResult() const
{
    return m_result;
}

bool DistributeAccreditQueryResponse::ResultHasBeenSet() const
{
