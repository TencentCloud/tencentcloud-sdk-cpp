...
CoreInternalOutcome DistributeApplyResponse::Deserialize(const string &payload)
{
...
string DistributeApplyResponse::ToJsonString() const
{
...
string DistributeApplyResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeApplyResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeApplyResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeApplyResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeMultiApplyResult DistributeApplyResponse::GetResult() const
{
    return m_result;
}

bool DistributeApplyResponse::ResultHasBeenSet() const
{
