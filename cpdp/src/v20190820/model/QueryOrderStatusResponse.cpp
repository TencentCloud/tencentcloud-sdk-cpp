...
CoreInternalOutcome QueryOrderStatusResponse::Deserialize(const string &payload)
{
...
string QueryOrderStatusResponse::ToJsonString() const
{
...
string QueryOrderStatusResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOrderStatusResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOrderStatusResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOrderStatusResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOrderStatusResult QueryOrderStatusResponse::GetResult() const
{
    return m_result;
}

bool QueryOrderStatusResponse::ResultHasBeenSet() const
{
