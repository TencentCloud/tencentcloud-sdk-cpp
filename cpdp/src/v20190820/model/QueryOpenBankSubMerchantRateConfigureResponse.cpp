...
QueryOpenBankSubMerchantRateConfigureResponse::QueryOpenBankSubMerchantRateConfigureResponse() :
...
CoreInternalOutcome QueryOpenBankSubMerchantRateConfigureResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankSubMerchantRateConfigureResponse::ToJsonString() const
{
...
string QueryOpenBankSubMerchantRateConfigureResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankSubMerchantRateConfigureResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankSubMerchantRateConfigureResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankSubMerchantRateConfigureResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankSubMerchantRateConfigureResult QueryOpenBankSubMerchantRateConfigureResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankSubMerchantRateConfigureResponse::ResultHasBeenSet() const
{
