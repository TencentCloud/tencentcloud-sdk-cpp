...
CoreInternalOutcome QueryExchangerateResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void QueryExchangerateResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
