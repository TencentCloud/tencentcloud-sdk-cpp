...
CoreInternalOutcome QueryBankWithdrawCashDetailsResponse::Deserialize(const string &payload)
{
...
string QueryBankWithdrawCashDetailsResponse::ToJsonString() const
{
...
string QueryBankWithdrawCashDetailsResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool QueryBankWithdrawCashDetailsResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool QueryBankWithdrawCashDetailsResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool QueryBankWithdrawCashDetailsResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetResultNum() const
{
    return m_resultNum;
}

bool QueryBankWithdrawCashDetailsResponse::ResultNumHasBeenSet() const
{
    return m_resultNumHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetStartRecordNo() const
{
    return m_startRecordNo;
}

bool QueryBankWithdrawCashDetailsResponse::StartRecordNoHasBeenSet() const
{
    return m_startRecordNoHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetEndFlag() const
{
    return m_endFlag;
}

bool QueryBankWithdrawCashDetailsResponse::EndFlagHasBeenSet() const
{
    return m_endFlagHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool QueryBankWithdrawCashDetailsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<WithdrawItem> QueryBankWithdrawCashDetailsResponse::GetTranItemArray() const
{
    return m_tranItemArray;
}

bool QueryBankWithdrawCashDetailsResponse::TranItemArrayHasBeenSet() const
{
    return m_tranItemArrayHasBeenSet;
}

string QueryBankWithdrawCashDetailsResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool QueryBankWithdrawCashDetailsResponse::ReservedMsgHasBeenSet() const
{
