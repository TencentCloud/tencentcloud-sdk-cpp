...
string DeleteAgentTaxPaymentInfosRequest::ToJsonString() const
{
...
int64_t DeleteAgentTaxPaymentInfosRequest::GetBatchNum() const
{
    return m_batchNum;
}

void DeleteAgentTaxPaymentInfosRequest::SetBatchNum(const int64_t& _batchNum)
{
    m_batchNum = _batchNum;
    m_batchNumHasBeenSet = true;
}

bool DeleteAgentTaxPaymentInfosRequest::BatchNumHasBeenSet() const
{
