...
CoreInternalOutcome QueryInvoiceV2Response::Deserialize(const string &payload)
{
...
string QueryInvoiceV2Response::ToJsonString() const
{
...
QueryInvoiceResultData QueryInvoiceV2Response::GetResult() const
{
    return m_result;
}

bool QueryInvoiceV2Response::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string QueryInvoiceV2Response::GetErrCode() const
{
    return m_errCode;
}

bool QueryInvoiceV2Response::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryInvoiceV2Response::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryInvoiceV2Response::ErrMessageHasBeenSet() const
{
