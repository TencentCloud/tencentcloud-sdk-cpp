...
AddFlexPhoneNoResponse::AddFlexPhoneNoResponse() :
...
CoreInternalOutcome AddFlexPhoneNoResponse::Deserialize(const string &payload)
{
...
string AddFlexPhoneNoResponse::ToJsonString() const
{
...
string AddFlexPhoneNoResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddFlexPhoneNoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string AddFlexPhoneNoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddFlexPhoneNoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string AddFlexPhoneNoResponse::GetResult() const
{
    return m_result;
}

bool AddFlexPhoneNoResponse::ResultHasBeenSet() const
{
