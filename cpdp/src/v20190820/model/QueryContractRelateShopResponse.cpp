...
CoreInternalOutcome QueryContractRelateShopResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Result") && !rsp["Result"].IsNull())
    {
        ...
        {
            QueryContractRelateShopResult item;
...
string QueryContractRelateShopResponse::ToJsonString() const
{
...
string QueryContractRelateShopResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryContractRelateShopResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string QueryContractRelateShopResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryContractRelateShopResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

vector<QueryContractRelateShopResult> QueryContractRelateShopResponse::GetResult() const
{
    return m_result;
}

bool QueryContractRelateShopResponse::ResultHasBeenSet() const
{
