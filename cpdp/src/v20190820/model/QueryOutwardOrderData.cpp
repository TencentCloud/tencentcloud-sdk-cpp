...
CoreInternalOutcome QueryOutwardOrderData::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("MerchantId") && !value["MerchantId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.MerchantId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TransactionId") && !value["TransactionId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.TransactionId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AcctDate") && !value["AcctDate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.AcctDate` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PricingCurrency") && !value["PricingCurrency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.PricingCurrency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SourceCurrency") && !value["SourceCurrency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.SourceCurrency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SourceAmount") && !value["SourceAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.SourceAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TargetCurrency") && !value["TargetCurrency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.TargetCurrency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TargetAmount") && !value["TargetAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.TargetAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FxRate") && !value["FxRate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.FxRate` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Status") && !value["Status"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.Status` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FailReason") && !value["FailReason"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.FailReason` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RefundAmount") && !value["RefundAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.RefundAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RefundCurrency") && !value["RefundCurrency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryOutwardOrderData.RefundCurrency` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void QueryOutwardOrderData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_acctDateHasBeenSet)
    {
        ...
        string key = "AcctDate";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_acctDate.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_pricingCurrencyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_pricingCurrency.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_sourceCurrencyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_sourceCurrency.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_sourceAmountHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_sourceAmount.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_targetCurrencyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_targetCurrency.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_targetAmountHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_targetAmount.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_fxRateHasBeenSet)
    {
        ...
        string key = "FxRate";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_fxRate.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_refundAmountHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_refundAmount.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_refundCurrencyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_refundCurrency.c_str(), allocator).Move(), allocator);
    }
