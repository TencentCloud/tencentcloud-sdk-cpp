...
CoreInternalOutcome CreateRedInvoiceResultData::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateRedInvoiceResultData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
