...
CoreInternalOutcome CreatePayRollPreOrderWithAuthResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AuthNumber") && !rsp["AuthNumber"].IsNull())
    {
        if (!rsp["AuthNumber"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `AuthNumber` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_authNumber = string(rsp["AuthNumber"].GetString());
...
string CreatePayRollPreOrderWithAuthResponse::ToJsonString() const
{
...
string CreatePayRollPreOrderWithAuthResponse::GetAuthNumber() const
{
    return m_authNumber;
}

bool CreatePayRollPreOrderWithAuthResponse::AuthNumberHasBeenSet() const
{
    return m_authNumberHasBeenSet;
}

int64_t CreatePayRollPreOrderWithAuthResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool CreatePayRollPreOrderWithAuthResponse::ExpireTimeHasBeenSet() const
{
    return m_expireTimeHasBeenSet;
}

string CreatePayRollPreOrderWithAuthResponse::GetMerchantId() const
{
    return m_merchantId;
}

bool CreatePayRollPreOrderWithAuthResponse::MerchantIdHasBeenSet() const
{
    return m_merchantIdHasBeenSet;
}

string CreatePayRollPreOrderWithAuthResponse::GetOpenId() const
{
    return m_openId;
}

bool CreatePayRollPreOrderWithAuthResponse::OpenIdHasBeenSet() const
{
    return m_openIdHasBeenSet;
}

string CreatePayRollPreOrderWithAuthResponse::GetSubMerchantId() const
{
    return m_subMerchantId;
}

bool CreatePayRollPreOrderWithAuthResponse::SubMerchantIdHasBeenSet() const
{
    return m_subMerchantIdHasBeenSet;
}

string CreatePayRollPreOrderWithAuthResponse::GetToken() const
{
    return m_token;
}

bool CreatePayRollPreOrderWithAuthResponse::TokenHasBeenSet() const
{
