...
CoreInternalOutcome ApplyTradeResponse::Deserialize(const string &payload)
{
...
string ApplyTradeResponse::ToJsonString() const
{
...
ApplyTradeResult ApplyTradeResponse::GetResult() const
{
    return m_result;
}

bool ApplyTradeResponse::ResultHasBeenSet() const
{
