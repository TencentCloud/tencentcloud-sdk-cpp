...
QueryFlexPaymentOrderListResponse::QueryFlexPaymentOrderListResponse() :
...
CoreInternalOutcome QueryFlexPaymentOrderListResponse::Deserialize(const string &payload)
{
...
string QueryFlexPaymentOrderListResponse::ToJsonString() const
{
...
string QueryFlexPaymentOrderListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPaymentOrderListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPaymentOrderListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPaymentOrderListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PaymentOrders QueryFlexPaymentOrderListResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPaymentOrderListResponse::ResultHasBeenSet() const
{
