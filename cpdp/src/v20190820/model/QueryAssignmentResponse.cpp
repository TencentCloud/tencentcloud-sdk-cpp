...
CoreInternalOutcome QueryAssignmentResponse::Deserialize(const string &payload)
{
...
string QueryAssignmentResponse::ToJsonString() const
{
...
string QueryAssignmentResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryAssignmentResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryAssignmentResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool QueryAssignmentResponse::ErrMsgHasBeenSet() const
{
    return m_errMsgHasBeenSet;
}

AssignmentData QueryAssignmentResponse::GetResult() const
{
    return m_result;
}

bool QueryAssignmentResponse::ResultHasBeenSet() const
{
