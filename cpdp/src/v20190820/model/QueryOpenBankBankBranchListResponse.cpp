...
CoreInternalOutcome QueryOpenBankBankBranchListResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankBankBranchListResponse::ToJsonString() const
{
...
string QueryOpenBankBankBranchListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankBankBranchListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankBankBranchListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankBankBranchListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankBankBranchListResult QueryOpenBankBankBranchListResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankBankBranchListResponse::ResultHasBeenSet() const
{
