...
CoreInternalOutcome QueryTradeResponse::Deserialize(const string &payload)
{
...
string QueryTradeResponse::ToJsonString() const
{
...
QueryTradeResult QueryTradeResponse::GetResult() const
{
    return m_result;
}

bool QueryTradeResponse::ResultHasBeenSet() const
{
