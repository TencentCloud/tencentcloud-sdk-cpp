...
QueryOpenBankRefundOrderResponse::QueryOpenBankRefundOrderResponse() :
...
CoreInternalOutcome QueryOpenBankRefundOrderResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankRefundOrderResponse::ToJsonString() const
{
...
string QueryOpenBankRefundOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankRefundOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankRefundOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankRefundOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

OpenBankQueryRefundOrderResult QueryOpenBankRefundOrderResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankRefundOrderResponse::ResultHasBeenSet() const
{
