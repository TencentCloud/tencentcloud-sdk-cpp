...
CoreInternalOutcome QueryOpenBankSupportBankListResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankSupportBankListResponse::ToJsonString() const
{
...
string QueryOpenBankSupportBankListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankSupportBankListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankSupportBankListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankSupportBankListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankSupportBankListResult QueryOpenBankSupportBankListResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankSupportBankListResponse::ResultHasBeenSet() const
{
