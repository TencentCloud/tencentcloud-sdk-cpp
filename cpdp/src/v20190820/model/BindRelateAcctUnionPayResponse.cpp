...
CoreInternalOutcome BindRelateAcctUnionPayResponse::Deserialize(const string &payload)
{
...
string BindRelateAcctUnionPayResponse::ToJsonString() const
{
...
string BindRelateAcctUnionPayResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool BindRelateAcctUnionPayResponse::ReservedMsgHasBeenSet() const
{
    return m_reservedMsgHasBeenSet;
}

string BindRelateAcctUnionPayResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool BindRelateAcctUnionPayResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string BindRelateAcctUnionPayResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool BindRelateAcctUnionPayResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string BindRelateAcctUnionPayResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool BindRelateAcctUnionPayResponse::CnsmrSeqNoHasBeenSet() const
{
