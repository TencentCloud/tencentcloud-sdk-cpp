...
CoreInternalOutcome QueryApplicationMaterialResponse::Deserialize(const string &payload)
{
...
string QueryApplicationMaterialResponse::ToJsonString() const
{
...
QueryDeclareResult QueryApplicationMaterialResponse::GetResult() const
{
    return m_result;
}

bool QueryApplicationMaterialResponse::ResultHasBeenSet() const
{
