...
CoreInternalOutcome BindRelateAccReUnionPayResponse::Deserialize(const string &payload)
{
...
string BindRelateAccReUnionPayResponse::ToJsonString() const
{
...
string BindRelateAccReUnionPayResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool BindRelateAccReUnionPayResponse::FrontSeqNoHasBeenSet() const
{
    return m_frontSeqNoHasBeenSet;
}

string BindRelateAccReUnionPayResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool BindRelateAccReUnionPayResponse::ReservedMsgHasBeenSet() const
{
    return m_reservedMsgHasBeenSet;
}

string BindRelateAccReUnionPayResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool BindRelateAccReUnionPayResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string BindRelateAccReUnionPayResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool BindRelateAccReUnionPayResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string BindRelateAccReUnionPayResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool BindRelateAccReUnionPayResponse::CnsmrSeqNoHasBeenSet() const
{
