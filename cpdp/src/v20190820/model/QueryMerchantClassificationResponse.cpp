...
CoreInternalOutcome QueryMerchantClassificationResponse::Deserialize(const string &payload)
{
...
string QueryMerchantClassificationResponse::ToJsonString() const
{
...
string QueryMerchantClassificationResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryMerchantClassificationResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string QueryMerchantClassificationResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryMerchantClassificationResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

vector<MerchantClassificationId> QueryMerchantClassificationResponse::GetResult() const
{
    return m_result;
}

bool QueryMerchantClassificationResponse::ResultHasBeenSet() const
{
