...
CoreInternalOutcome ViewMerchantResponse::Deserialize(const string &payload)
{
...
string ViewMerchantResponse::ToJsonString() const
{
...
string ViewMerchantResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ViewMerchantResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string ViewMerchantResponse::GetErrCode() const
{
    return m_errCode;
}

bool ViewMerchantResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

ViewMerchantResult ViewMerchantResponse::GetResult() const
{
    return m_result;
}

bool ViewMerchantResponse::ResultHasBeenSet() const
{
