...
CoreInternalOutcome ApplyPayerinfoData::Deserialize(const Value &value)
{
    string requestId = "";
...
void ApplyPayerinfoData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
