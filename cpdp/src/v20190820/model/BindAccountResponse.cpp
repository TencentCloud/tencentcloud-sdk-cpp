...
CoreInternalOutcome BindAccountResponse::Deserialize(const string &payload)
{
...
string BindAccountResponse::ToJsonString() const
{
...
string BindAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool BindAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string BindAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool BindAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string BindAccountResponse::GetResult() const
{
    return m_result;
}

bool BindAccountResponse::ResultHasBeenSet() const
{
