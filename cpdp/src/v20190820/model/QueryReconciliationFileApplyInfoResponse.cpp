...
CoreInternalOutcome QueryReconciliationFileApplyInfoResponse::Deserialize(const string &payload)
{
...
string QueryReconciliationFileApplyInfoResponse::ToJsonString() const
{
...
string QueryReconciliationFileApplyInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryReconciliationFileApplyInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryReconciliationFileApplyInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryReconciliationFileApplyInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryReconciliationFileApplyInfoResult QueryReconciliationFileApplyInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryReconciliationFileApplyInfoResponse::ResultHasBeenSet() const
{
