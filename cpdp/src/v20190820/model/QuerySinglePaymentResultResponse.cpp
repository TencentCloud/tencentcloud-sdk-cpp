...
CoreInternalOutcome QuerySinglePaymentResultResponse::Deserialize(const string &payload)
{
...
string QuerySinglePaymentResultResponse::ToJsonString() const
{
...
string QuerySinglePaymentResultResponse::GetErrCode() const
{
    return m_errCode;
}

bool QuerySinglePaymentResultResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QuerySinglePaymentResultResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QuerySinglePaymentResultResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QuerySinglePaymentResultData QuerySinglePaymentResultResponse::GetResult() const
{
    return m_result;
}

bool QuerySinglePaymentResultResponse::ResultHasBeenSet() const
{
