...
RefundOpenBankOrderResponse::RefundOpenBankOrderResponse() :
...
CoreInternalOutcome RefundOpenBankOrderResponse::Deserialize(const string &payload)
{
...
string RefundOpenBankOrderResponse::ToJsonString() const
{
...
string RefundOpenBankOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool RefundOpenBankOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string RefundOpenBankOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool RefundOpenBankOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

OpenBankRefundOrderApplyResult RefundOpenBankOrderResponse::GetResult() const
{
    return m_result;
}

bool RefundOpenBankOrderResponse::ResultHasBeenSet() const
{
