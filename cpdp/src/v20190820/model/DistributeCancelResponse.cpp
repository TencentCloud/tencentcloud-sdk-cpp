...
CoreInternalOutcome DistributeCancelResponse::Deserialize(const string &payload)
{
...
string DistributeCancelResponse::ToJsonString() const
{
...
string DistributeCancelResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeCancelResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeCancelResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeCancelResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeCancelResult DistributeCancelResponse::GetResult() const
{
    return m_result;
}

bool DistributeCancelResponse::ResultHasBeenSet() const
{
