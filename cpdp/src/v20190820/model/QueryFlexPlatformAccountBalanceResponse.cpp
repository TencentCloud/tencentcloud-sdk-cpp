...
QueryFlexPlatformAccountBalanceResponse::QueryFlexPlatformAccountBalanceResponse() :
...
CoreInternalOutcome QueryFlexPlatformAccountBalanceResponse::Deserialize(const string &payload)
{
...
string QueryFlexPlatformAccountBalanceResponse::ToJsonString() const
{
...
string QueryFlexPlatformAccountBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPlatformAccountBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPlatformAccountBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPlatformAccountBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PlatformAccountBalanceResult QueryFlexPlatformAccountBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPlatformAccountBalanceResponse::ResultHasBeenSet() const
{
