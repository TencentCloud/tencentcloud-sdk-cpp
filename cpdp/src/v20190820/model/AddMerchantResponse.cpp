...
CoreInternalOutcome AddMerchantResponse::Deserialize(const string &payload)
{
...
string AddMerchantResponse::ToJsonString() const
{
...
string AddMerchantResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddMerchantResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string AddMerchantResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddMerchantResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

AddMerchantResult AddMerchantResponse::GetResult() const
{
    return m_result;
}

bool AddMerchantResponse::ResultHasBeenSet() const
{
