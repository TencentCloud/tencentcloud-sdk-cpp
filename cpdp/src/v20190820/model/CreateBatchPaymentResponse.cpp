...
CoreInternalOutcome CreateBatchPaymentResponse::Deserialize(const string &payload)
{
...
string CreateBatchPaymentResponse::ToJsonString() const
{
...
string CreateBatchPaymentResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateBatchPaymentResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateBatchPaymentResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateBatchPaymentResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateBatchPaymentData CreateBatchPaymentResponse::GetResult() const
{
    return m_result;
}

bool CreateBatchPaymentResponse::ResultHasBeenSet() const
{
