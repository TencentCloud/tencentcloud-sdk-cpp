...
CoreInternalOutcome QueryContractPayFeeResponse::Deserialize(const string &payload)
{
...
string QueryContractPayFeeResponse::ToJsonString() const
{
...
string QueryContractPayFeeResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryContractPayFeeResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string QueryContractPayFeeResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryContractPayFeeResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

QueryContractPayFeeResult QueryContractPayFeeResponse::GetResult() const
{
    return m_result;
}

bool QueryContractPayFeeResponse::ResultHasBeenSet() const
{
