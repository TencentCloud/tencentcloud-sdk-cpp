...
string QueryMerchantOrderRequest::ToJsonString() const
{
...
string QueryMerchantOrderRequest::GetMerchantAppId() const
{
    return m_merchantAppId;
}

void QueryMerchantOrderRequest::SetMerchantAppId(const string& _merchantAppId)
{
    m_merchantAppId = _merchantAppId;
    m_merchantAppIdHasBeenSet = true;
}

bool QueryMerchantOrderRequest::MerchantAppIdHasBeenSet() const
{
    return m_merchantAppIdHasBeenSet;
}

string QueryMerchantOrderRequest::GetOrderNo() const
{
    return m_orderNo;
}

void QueryMerchantOrderRequest::SetOrderNo(const string& _orderNo)
{
    m_orderNo = _orderNo;
    m_orderNoHasBeenSet = true;
}

bool QueryMerchantOrderRequest::OrderNoHasBeenSet() const
{
