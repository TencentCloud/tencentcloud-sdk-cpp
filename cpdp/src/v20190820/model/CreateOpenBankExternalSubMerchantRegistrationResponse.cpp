...
CoreInternalOutcome CreateOpenBankExternalSubMerchantRegistrationResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankExternalSubMerchantRegistrationResponse::ToJsonString() const
{
...
string CreateOpenBankExternalSubMerchantRegistrationResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankExternalSubMerchantRegistrationResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankExternalSubMerchantRegistrationResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankExternalSubMerchantRegistrationResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankExternalSubMerchantRegistrationResult CreateOpenBankExternalSubMerchantRegistrationResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankExternalSubMerchantRegistrationResponse::ResultHasBeenSet() const
{
