...
CoreInternalOutcome CreateAnchorResponse::Deserialize(const string &payload)
{
...
string CreateAnchorResponse::ToJsonString() const
{
...
string CreateAnchorResponse::GetAnchorId() const
{
    return m_anchorId;
}

bool CreateAnchorResponse::AnchorIdHasBeenSet() const
{
