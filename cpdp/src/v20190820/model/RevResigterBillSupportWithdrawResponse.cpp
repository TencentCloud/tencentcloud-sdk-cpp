...
CoreInternalOutcome RevResigterBillSupportWithdrawResponse::Deserialize(const string &payload)
{
...
string RevResigterBillSupportWithdrawResponse::ToJsonString() const
{
...
string RevResigterBillSupportWithdrawResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool RevResigterBillSupportWithdrawResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string RevResigterBillSupportWithdrawResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool RevResigterBillSupportWithdrawResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string RevResigterBillSupportWithdrawResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool RevResigterBillSupportWithdrawResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string RevResigterBillSupportWithdrawResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool RevResigterBillSupportWithdrawResponse::FrontSeqNoHasBeenSet() const
{
    return m_frontSeqNoHasBeenSet;
}

string RevResigterBillSupportWithdrawResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool RevResigterBillSupportWithdrawResponse::ReservedMsgHasBeenSet() const
{
