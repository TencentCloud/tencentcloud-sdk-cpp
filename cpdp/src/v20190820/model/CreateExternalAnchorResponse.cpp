...
CoreInternalOutcome CreateExternalAnchorResponse::Deserialize(const string &payload)
{
...
string CreateExternalAnchorResponse::ToJsonString() const
{
...
string CreateExternalAnchorResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateExternalAnchorResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateExternalAnchorResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateExternalAnchorResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateExternalAnchorData CreateExternalAnchorResponse::GetResult() const
{
    return m_result;
}

bool CreateExternalAnchorResponse::ResultHasBeenSet() const
{
