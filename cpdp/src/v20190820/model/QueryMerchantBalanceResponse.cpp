...
CoreInternalOutcome QueryMerchantBalanceResponse::Deserialize(const string &payload)
{
...
string QueryMerchantBalanceResponse::ToJsonString() const
{
...
QueryMerchantBalanceResult QueryMerchantBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryMerchantBalanceResponse::ResultHasBeenSet() const
{
