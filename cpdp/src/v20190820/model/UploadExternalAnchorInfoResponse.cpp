...
CoreInternalOutcome UploadExternalAnchorInfoResponse::Deserialize(const string &payload)
{
...
string UploadExternalAnchorInfoResponse::ToJsonString() const
{
...
string UploadExternalAnchorInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool UploadExternalAnchorInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string UploadExternalAnchorInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool UploadExternalAnchorInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string UploadExternalAnchorInfoResponse::GetResult() const
{
    return m_result;
}

bool UploadExternalAnchorInfoResponse::ResultHasBeenSet() const
{
