...
CoreInternalOutcome GetPayRollAuthResultResponse::Deserialize(const string &payload)
{
...
string GetPayRollAuthResultResponse::ToJsonString() const
{
...
PayRollAuthResult GetPayRollAuthResultResponse::GetResult() const
{
    return m_result;
}

bool GetPayRollAuthResultResponse::ResultHasBeenSet() const
{
