...
CoreInternalOutcome QueryOpenBankDailyReceiptDownloadUrlResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankDailyReceiptDownloadUrlResponse::ToJsonString() const
{
...
string QueryOpenBankDailyReceiptDownloadUrlResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankDailyReceiptDownloadUrlResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankDailyReceiptDownloadUrlResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankDailyReceiptDownloadUrlResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankDailyReceiptDownloadUrlResult QueryOpenBankDailyReceiptDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankDailyReceiptDownloadUrlResponse::ResultHasBeenSet() const
{
