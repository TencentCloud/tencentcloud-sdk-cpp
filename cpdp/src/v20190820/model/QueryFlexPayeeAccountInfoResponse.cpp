...
QueryFlexPayeeAccountInfoResponse::QueryFlexPayeeAccountInfoResponse() :
...
CoreInternalOutcome QueryFlexPayeeAccountInfoResponse::Deserialize(const string &payload)
{
...
string QueryFlexPayeeAccountInfoResponse::ToJsonString() const
{
...
string QueryFlexPayeeAccountInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPayeeAccountInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPayeeAccountInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPayeeAccountInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PayeeAccountInfoResult QueryFlexPayeeAccountInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPayeeAccountInfoResponse::ResultHasBeenSet() const
{
