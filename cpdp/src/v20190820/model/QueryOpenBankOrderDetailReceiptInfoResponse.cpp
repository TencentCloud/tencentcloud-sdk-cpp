...
CoreInternalOutcome QueryOpenBankOrderDetailReceiptInfoResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankOrderDetailReceiptInfoResponse::ToJsonString() const
{
...
string QueryOpenBankOrderDetailReceiptInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankOrderDetailReceiptInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankOrderDetailReceiptInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankOrderDetailReceiptInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankOrderDetailReceiptInfoResult QueryOpenBankOrderDetailReceiptInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankOrderDetailReceiptInfoResponse::ResultHasBeenSet() const
{
