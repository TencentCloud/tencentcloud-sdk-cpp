...
CoreInternalOutcome ConfirmOrderResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("OrderNo") && !rsp["OrderNo"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `OrderNo` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string ConfirmOrderResponse::ToJsonString() const
{
...
string ConfirmOrderResponse::GetMerchantAppId() const
{
    return m_merchantAppId;
}

bool ConfirmOrderResponse::MerchantAppIdHasBeenSet() const
{
    return m_merchantAppIdHasBeenSet;
}

string ConfirmOrderResponse::GetOrderNo() const
{
    return m_orderNo;
}

bool ConfirmOrderResponse::OrderNoHasBeenSet() const
{
    return m_orderNoHasBeenSet;
}

string ConfirmOrderResponse::GetStatus() const
{
    return m_status;
}

bool ConfirmOrderResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ConfirmOrderResponse::GetDescription() const
{
    return m_description;
}

bool ConfirmOrderResponse::DescriptionHasBeenSet() const
{
