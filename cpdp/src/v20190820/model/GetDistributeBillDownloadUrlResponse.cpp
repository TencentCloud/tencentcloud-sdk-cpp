...
CoreInternalOutcome GetDistributeBillDownloadUrlResponse::Deserialize(const string &payload)
{
...
string GetDistributeBillDownloadUrlResponse::ToJsonString() const
{
...
string GetDistributeBillDownloadUrlResponse::GetErrCode() const
{
    return m_errCode;
}

bool GetDistributeBillDownloadUrlResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string GetDistributeBillDownloadUrlResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool GetDistributeBillDownloadUrlResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

BillDownloadUrlResult GetDistributeBillDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool GetDistributeBillDownloadUrlResponse::ResultHasBeenSet() const
{
