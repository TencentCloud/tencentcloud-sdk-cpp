...
CoreInternalOutcome QueryOpenBankDownLoadUrlResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankDownLoadUrlResponse::ToJsonString() const
{
...
string QueryOpenBankDownLoadUrlResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankDownLoadUrlResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankDownLoadUrlResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankDownLoadUrlResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankDownLoadUrlResult QueryOpenBankDownLoadUrlResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankDownLoadUrlResponse::ResultHasBeenSet() const
{
