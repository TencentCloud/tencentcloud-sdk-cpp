...
VerifyOpenBankAccountResponse::VerifyOpenBankAccountResponse() :
...
CoreInternalOutcome VerifyOpenBankAccountResponse::Deserialize(const string &payload)
{
...
string VerifyOpenBankAccountResponse::ToJsonString() const
{
...
string VerifyOpenBankAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool VerifyOpenBankAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string VerifyOpenBankAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool VerifyOpenBankAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

VerifyOpenBankAccountResult VerifyOpenBankAccountResponse::GetResult() const
{
    return m_result;
}

bool VerifyOpenBankAccountResponse::ResultHasBeenSet() const
{
