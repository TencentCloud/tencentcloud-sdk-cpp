...
QueryOpenBankSubMerchantSignOnlineResponse::QueryOpenBankSubMerchantSignOnlineResponse() :
...
CoreInternalOutcome QueryOpenBankSubMerchantSignOnlineResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankSubMerchantSignOnlineResponse::ToJsonString() const
{
...
string QueryOpenBankSubMerchantSignOnlineResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankSubMerchantSignOnlineResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankSubMerchantSignOnlineResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankSubMerchantSignOnlineResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankSubMerchantSignOnlineResult QueryOpenBankSubMerchantSignOnlineResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankSubMerchantSignOnlineResponse::ResultHasBeenSet() const
{
