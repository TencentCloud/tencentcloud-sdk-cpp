...
CoreInternalOutcome CloseOpenBankPaymentOrderResponse::Deserialize(const string &payload)
{
...
string CloseOpenBankPaymentOrderResponse::ToJsonString() const
{
...
string CloseOpenBankPaymentOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CloseOpenBankPaymentOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CloseOpenBankPaymentOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CloseOpenBankPaymentOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CloseOpenBankPaymentOrderResult CloseOpenBankPaymentOrderResponse::GetResult() const
{
    return m_result;
}

bool CloseOpenBankPaymentOrderResponse::ResultHasBeenSet() const
{
