...
QueryFlexAmountBeforeTaxResponse::QueryFlexAmountBeforeTaxResponse() :
...
CoreInternalOutcome QueryFlexAmountBeforeTaxResponse::Deserialize(const string &payload)
{
...
string QueryFlexAmountBeforeTaxResponse::ToJsonString() const
{
...
string QueryFlexAmountBeforeTaxResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexAmountBeforeTaxResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexAmountBeforeTaxResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexAmountBeforeTaxResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

AmountBeforeTaxResult QueryFlexAmountBeforeTaxResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexAmountBeforeTaxResponse::ResultHasBeenSet() const
{
