...
CoreInternalOutcome ContractOrderInSubOrder::Deserialize(const Value &value)
{
    string requestId = "";
...
void ContractOrderInSubOrder::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
