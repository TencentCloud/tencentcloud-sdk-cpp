...
CoreInternalOutcome ApplyPayerInfoResponse::Deserialize(const string &payload)
{
...
string ApplyPayerInfoResponse::ToJsonString() const
{
...
ApplyPayerinfoResult ApplyPayerInfoResponse::GetResult() const
{
    return m_result;
}

bool ApplyPayerInfoResponse::ResultHasBeenSet() const
{
