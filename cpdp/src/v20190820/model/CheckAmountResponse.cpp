...
CoreInternalOutcome CheckAmountResponse::Deserialize(const string &payload)
{
...
string CheckAmountResponse::ToJsonString() const
{
...
string CheckAmountResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool CheckAmountResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string CheckAmountResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool CheckAmountResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string CheckAmountResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool CheckAmountResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string CheckAmountResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool CheckAmountResponse::FrontSeqNoHasBeenSet() const
{
    return m_frontSeqNoHasBeenSet;
}

string CheckAmountResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool CheckAmountResponse::ReservedMsgHasBeenSet() const
{
