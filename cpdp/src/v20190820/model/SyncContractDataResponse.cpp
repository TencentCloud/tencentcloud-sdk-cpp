...
CoreInternalOutcome SyncContractDataResponse::Deserialize(const string &payload)
{
...
string SyncContractDataResponse::ToJsonString() const
{
...
string SyncContractDataResponse::GetMsg() const
{
    return m_msg;
}

bool SyncContractDataResponse::MsgHasBeenSet() const
{
