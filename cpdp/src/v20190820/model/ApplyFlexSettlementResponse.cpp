...
ApplyFlexSettlementResponse::ApplyFlexSettlementResponse() :
...
CoreInternalOutcome ApplyFlexSettlementResponse::Deserialize(const string &payload)
{
...
string ApplyFlexSettlementResponse::ToJsonString() const
{
...
string ApplyFlexSettlementResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyFlexSettlementResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyFlexSettlementResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyFlexSettlementResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyFlexSettlementResult ApplyFlexSettlementResponse::GetResult() const
{
    return m_result;
}

bool ApplyFlexSettlementResponse::ResultHasBeenSet() const
{
