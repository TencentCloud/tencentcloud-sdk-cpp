...
CoreInternalOutcome RegisterBillSupportWithdrawResponse::Deserialize(const string &payload)
{
...
string RegisterBillSupportWithdrawResponse::ToJsonString() const
{
...
string RegisterBillSupportWithdrawResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool RegisterBillSupportWithdrawResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string RegisterBillSupportWithdrawResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool RegisterBillSupportWithdrawResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string RegisterBillSupportWithdrawResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool RegisterBillSupportWithdrawResponse::FrontSeqNoHasBeenSet() const
{
    return m_frontSeqNoHasBeenSet;
}

string RegisterBillSupportWithdrawResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool RegisterBillSupportWithdrawResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string RegisterBillSupportWithdrawResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool RegisterBillSupportWithdrawResponse::ReservedMsgHasBeenSet() const
{
