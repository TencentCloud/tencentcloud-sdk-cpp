...
CoreInternalOutcome ReviseMbrPropertyResponse::Deserialize(const string &payload)
{
...
string ReviseMbrPropertyResponse::ToJsonString() const
{
...
string ReviseMbrPropertyResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool ReviseMbrPropertyResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string ReviseMbrPropertyResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool ReviseMbrPropertyResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string ReviseMbrPropertyResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool ReviseMbrPropertyResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string ReviseMbrPropertyResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool ReviseMbrPropertyResponse::ReservedMsgHasBeenSet() const
{
