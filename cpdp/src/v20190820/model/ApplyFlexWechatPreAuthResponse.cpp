...
ApplyFlexWechatPreAuthResponse::ApplyFlexWechatPreAuthResponse() :
...
CoreInternalOutcome ApplyFlexWechatPreAuthResponse::Deserialize(const string &payload)
{
...
string ApplyFlexWechatPreAuthResponse::ToJsonString() const
{
...
string ApplyFlexWechatPreAuthResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyFlexWechatPreAuthResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyFlexWechatPreAuthResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyFlexWechatPreAuthResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

WechatPreAuthResult ApplyFlexWechatPreAuthResponse::GetResult() const
{
    return m_result;
}

bool ApplyFlexWechatPreAuthResponse::ResultHasBeenSet() const
{
