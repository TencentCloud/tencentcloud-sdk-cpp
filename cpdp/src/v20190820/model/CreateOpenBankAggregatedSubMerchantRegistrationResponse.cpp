...
CreateOpenBankAggregatedSubMerchantRegistrationResponse::CreateOpenBankAggregatedSubMerchantRegistrationResponse() :
...
CoreInternalOutcome CreateOpenBankAggregatedSubMerchantRegistrationResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankAggregatedSubMerchantRegistrationResponse::ToJsonString() const
{
...
string CreateOpenBankAggregatedSubMerchantRegistrationResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankAggregatedSubMerchantRegistrationResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankAggregatedSubMerchantRegistrationResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankAggregatedSubMerchantRegistrationResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankExternalAggregatedSubMerchantRegistrationResult CreateOpenBankAggregatedSubMerchantRegistrationResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankAggregatedSubMerchantRegistrationResponse::ResultHasBeenSet() const
{
