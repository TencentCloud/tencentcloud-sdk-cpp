...
CoreInternalOutcome CheckAcctResponse::Deserialize(const string &payload)
{
...
string CheckAcctResponse::ToJsonString() const
{
...
string CheckAcctResponse::GetFrontSeqNo() const
{
    return m_frontSeqNo;
}

bool CheckAcctResponse::FrontSeqNoHasBeenSet() const
{
