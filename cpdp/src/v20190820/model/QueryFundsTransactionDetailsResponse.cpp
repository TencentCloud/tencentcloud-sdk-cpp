...
CoreInternalOutcome QueryFundsTransactionDetailsResponse::Deserialize(const string &payload)
{
...
string QueryFundsTransactionDetailsResponse::ToJsonString() const
{
...
string QueryFundsTransactionDetailsResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFundsTransactionDetailsResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFundsTransactionDetailsResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFundsTransactionDetailsResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryFundsTransactionDetailsResult QueryFundsTransactionDetailsResponse::GetResult() const
{
    return m_result;
}

bool QueryFundsTransactionDetailsResponse::ResultHasBeenSet() const
{
