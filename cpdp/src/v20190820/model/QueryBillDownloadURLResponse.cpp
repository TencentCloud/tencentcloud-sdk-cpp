...
CoreInternalOutcome QueryBillDownloadURLResponse::Deserialize(const string &payload)
{
...
string QueryBillDownloadURLResponse::ToJsonString() const
{
...
string QueryBillDownloadURLResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryBillDownloadURLResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryBillDownloadURLResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryBillDownloadURLResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryBillDownloadURLData QueryBillDownloadURLResponse::GetResult() const
{
    return m_result;
}

bool QueryBillDownloadURLResponse::ResultHasBeenSet() const
{
