...
QueryOpenBankProfitSharePayeeResponse::QueryOpenBankProfitSharePayeeResponse() :
...
CoreInternalOutcome QueryOpenBankProfitSharePayeeResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankProfitSharePayeeResponse::ToJsonString() const
{
...
string QueryOpenBankProfitSharePayeeResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankProfitSharePayeeResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankProfitSharePayeeResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankProfitSharePayeeResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankProfitSharePayeeResult QueryOpenBankProfitSharePayeeResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankProfitSharePayeeResponse::ResultHasBeenSet() const
{
