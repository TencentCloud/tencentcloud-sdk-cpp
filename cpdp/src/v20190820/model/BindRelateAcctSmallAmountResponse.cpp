...
CoreInternalOutcome BindRelateAcctSmallAmountResponse::Deserialize(const string &payload)
{
...
string BindRelateAcctSmallAmountResponse::ToJsonString() const
{
...
string BindRelateAcctSmallAmountResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool BindRelateAcctSmallAmountResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string BindRelateAcctSmallAmountResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool BindRelateAcctSmallAmountResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string BindRelateAcctSmallAmountResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool BindRelateAcctSmallAmountResponse::CnsmrSeqNoHasBeenSet() const
{
    return m_cnsmrSeqNoHasBeenSet;
}

string BindRelateAcctSmallAmountResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool BindRelateAcctSmallAmountResponse::ReservedMsgHasBeenSet() const
{
