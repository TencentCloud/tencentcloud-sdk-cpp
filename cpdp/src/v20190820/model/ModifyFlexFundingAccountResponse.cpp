...
ModifyFlexFundingAccountResponse::ModifyFlexFundingAccountResponse() :
...
CoreInternalOutcome ModifyFlexFundingAccountResponse::Deserialize(const string &payload)
{
...
string ModifyFlexFundingAccountResponse::ToJsonString() const
{
...
string ModifyFlexFundingAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool ModifyFlexFundingAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ModifyFlexFundingAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ModifyFlexFundingAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string ModifyFlexFundingAccountResponse::GetResult() const
{
    return m_result;
}

bool ModifyFlexFundingAccountResponse::ResultHasBeenSet() const
{
