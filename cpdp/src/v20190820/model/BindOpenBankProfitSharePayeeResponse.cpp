...
BindOpenBankProfitSharePayeeResponse::BindOpenBankProfitSharePayeeResponse() :
...
CoreInternalOutcome BindOpenBankProfitSharePayeeResponse::Deserialize(const string &payload)
{
...
string BindOpenBankProfitSharePayeeResponse::ToJsonString() const
{
...
string BindOpenBankProfitSharePayeeResponse::GetErrCode() const
{
    return m_errCode;
}

bool BindOpenBankProfitSharePayeeResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string BindOpenBankProfitSharePayeeResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool BindOpenBankProfitSharePayeeResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

BindOpenBankProfitSharePayeeResult BindOpenBankProfitSharePayeeResponse::GetResult() const
{
    return m_result;
}

bool BindOpenBankProfitSharePayeeResponse::ResultHasBeenSet() const
{
