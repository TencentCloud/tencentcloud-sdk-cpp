...
CoreInternalOutcome ApplyOpenBankOrderDetailReceiptResponse::Deserialize(const string &payload)
{
...
string ApplyOpenBankOrderDetailReceiptResponse::ToJsonString() const
{
...
string ApplyOpenBankOrderDetailReceiptResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyOpenBankOrderDetailReceiptResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyOpenBankOrderDetailReceiptResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyOpenBankOrderDetailReceiptResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyOpenBankOrderDetailReceiptResult ApplyOpenBankOrderDetailReceiptResponse::GetResult() const
{
    return m_result;
}

bool ApplyOpenBankOrderDetailReceiptResponse::ResultHasBeenSet() const
{
