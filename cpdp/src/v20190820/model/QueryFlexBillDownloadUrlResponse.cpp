...
QueryFlexBillDownloadUrlResponse::QueryFlexBillDownloadUrlResponse() :
...
CoreInternalOutcome QueryFlexBillDownloadUrlResponse::Deserialize(const string &payload)
{
...
string QueryFlexBillDownloadUrlResponse::ToJsonString() const
{
...
string QueryFlexBillDownloadUrlResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexBillDownloadUrlResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexBillDownloadUrlResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexBillDownloadUrlResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

FlexBillDownloadUrlResult QueryFlexBillDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexBillDownloadUrlResponse::ResultHasBeenSet() const
{
