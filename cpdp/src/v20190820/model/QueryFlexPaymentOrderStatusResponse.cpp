...
QueryFlexPaymentOrderStatusResponse::QueryFlexPaymentOrderStatusResponse() :
...
CoreInternalOutcome QueryFlexPaymentOrderStatusResponse::Deserialize(const string &payload)
{
...
string QueryFlexPaymentOrderStatusResponse::ToJsonString() const
{
...
string QueryFlexPaymentOrderStatusResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPaymentOrderStatusResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPaymentOrderStatusResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPaymentOrderStatusResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PaymentOrderStatusResult QueryFlexPaymentOrderStatusResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPaymentOrderStatusResponse::ResultHasBeenSet() const
{
