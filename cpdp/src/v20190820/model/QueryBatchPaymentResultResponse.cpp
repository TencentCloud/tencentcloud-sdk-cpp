...
CoreInternalOutcome QueryBatchPaymentResultResponse::Deserialize(const string &payload)
{
...
string QueryBatchPaymentResultResponse::ToJsonString() const
{
...
string QueryBatchPaymentResultResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryBatchPaymentResultResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryBatchPaymentResultResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryBatchPaymentResultResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryBatchPaymentResultData QueryBatchPaymentResultResponse::GetResult() const
{
    return m_result;
}

bool QueryBatchPaymentResultResponse::ResultHasBeenSet() const
{
