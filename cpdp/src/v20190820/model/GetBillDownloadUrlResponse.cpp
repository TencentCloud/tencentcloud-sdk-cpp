...
CoreInternalOutcome GetBillDownloadUrlResponse::Deserialize(const string &payload)
{
...
string GetBillDownloadUrlResponse::ToJsonString() const
{
...
string GetBillDownloadUrlResponse::GetErrCode() const
{
    return m_errCode;
}

bool GetBillDownloadUrlResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string GetBillDownloadUrlResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool GetBillDownloadUrlResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

BillDownloadUrlResult GetBillDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool GetBillDownloadUrlResponse::ResultHasBeenSet() const
{
