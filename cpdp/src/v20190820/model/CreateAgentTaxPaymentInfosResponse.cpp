...
CoreInternalOutcome CreateAgentTaxPaymentInfosResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AgentTaxPaymentBatch") && !rsp["AgentTaxPaymentBatch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AgentTaxPaymentBatch` is not object type").SetRequestId(requestId));
        }
...
string CreateAgentTaxPaymentInfosResponse::ToJsonString() const
{
...
AgentTaxPaymentBatch CreateAgentTaxPaymentInfosResponse::GetAgentTaxPaymentBatch() const
{
    return m_agentTaxPaymentBatch;
}

bool CreateAgentTaxPaymentInfosResponse::AgentTaxPaymentBatchHasBeenSet() const
{
