...
FreezeFlexBalanceResponse::FreezeFlexBalanceResponse() :
...
CoreInternalOutcome FreezeFlexBalanceResponse::Deserialize(const string &payload)
{
...
string FreezeFlexBalanceResponse::ToJsonString() const
{
...
string FreezeFlexBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool FreezeFlexBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string FreezeFlexBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool FreezeFlexBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

FreezeFlexBalanceResult FreezeFlexBalanceResponse::GetResult() const
{
    return m_result;
}

bool FreezeFlexBalanceResponse::ResultHasBeenSet() const
{
