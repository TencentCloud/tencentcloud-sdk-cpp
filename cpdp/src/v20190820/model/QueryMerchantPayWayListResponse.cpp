...
CoreInternalOutcome QueryMerchantPayWayListResponse::Deserialize(const string &payload)
{
...
string QueryMerchantPayWayListResponse::ToJsonString() const
{
...
string QueryMerchantPayWayListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryMerchantPayWayListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryMerchantPayWayListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryMerchantPayWayListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

vector<MerchantPayWayData> QueryMerchantPayWayListResponse::GetResult() const
{
    return m_result;
}

bool QueryMerchantPayWayListResponse::ResultHasBeenSet() const
{
