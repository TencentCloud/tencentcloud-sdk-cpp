...
CoreInternalOutcome AddContractResponse::Deserialize(const string &payload)
{
...
string AddContractResponse::ToJsonString() const
{
...
string AddContractResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddContractResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string AddContractResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddContractResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

AddContractResult AddContractResponse::GetResult() const
{
    return m_result;
}

bool AddContractResponse::ResultHasBeenSet() const
{
