...
CoreInternalOutcome QueryOpenBankBindExternalSubMerchantBankAccountResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankBindExternalSubMerchantBankAccountResponse::ToJsonString() const
{
...
string QueryOpenBankBindExternalSubMerchantBankAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankBindExternalSubMerchantBankAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankBindExternalSubMerchantBankAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankBindExternalSubMerchantBankAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankBindExternalSubMerchantBankAccountResult QueryOpenBankBindExternalSubMerchantBankAccountResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankBindExternalSubMerchantBankAccountResponse::ResultHasBeenSet() const
{
