...
CreateOpenBankVerificationOrderResponse::CreateOpenBankVerificationOrderResponse() :
...
CoreInternalOutcome CreateOpenBankVerificationOrderResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankVerificationOrderResponse::ToJsonString() const
{
...
string CreateOpenBankVerificationOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankVerificationOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankVerificationOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankVerificationOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankVerificationResult CreateOpenBankVerificationOrderResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankVerificationOrderResponse::ResultHasBeenSet() const
{
