...
CoreInternalOutcome QueryOpenBankExternalSubMerchantBankAccountResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankExternalSubMerchantBankAccountResponse::ToJsonString() const
{
...
string QueryOpenBankExternalSubMerchantBankAccountResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankExternalSubMerchantBankAccountResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankExternalSubMerchantBankAccountResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankExternalSubMerchantBankAccountResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankExternalSubMerchantBankAccountResult QueryOpenBankExternalSubMerchantBankAccountResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankExternalSubMerchantBankAccountResponse::ResultHasBeenSet() const
{
