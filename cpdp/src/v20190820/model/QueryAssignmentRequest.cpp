...
string QueryAssignmentRequest::ToJsonString() const
{
...
string QueryAssignmentRequest::GetAnchorId() const
{
    return m_anchorId;
}

void QueryAssignmentRequest::SetAnchorId(const string& _anchorId)
{
    m_anchorId = _anchorId;
    m_anchorIdHasBeenSet = true;
}

bool QueryAssignmentRequest::AnchorIdHasBeenSet() const
{
