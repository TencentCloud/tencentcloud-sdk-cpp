...
CreateOpenBankUnifiedOrderResponse::CreateOpenBankUnifiedOrderResponse() :
...
CoreInternalOutcome CreateOpenBankUnifiedOrderResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankUnifiedOrderResponse::ToJsonString() const
{
...
string CreateOpenBankUnifiedOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankUnifiedOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankUnifiedOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankUnifiedOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankOrderPaymentResult CreateOpenBankUnifiedOrderResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankUnifiedOrderResponse::ResultHasBeenSet() const
{
