...
CoreInternalOutcome QueryItem::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SubAcctNo") && !value["SubAcctNo"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.SubAcctNo` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubAcctProperty") && !value["SubAcctProperty"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.SubAcctProperty` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubMchId") && !value["SubMchId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.SubMchId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubAcctName") && !value["SubAcctName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.SubAcctName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AcctAvailBal") && !value["AcctAvailBal"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.AcctAvailBal` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CashAmt") && !value["CashAmt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.CashAmt` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MaintenanceDate") && !value["MaintenanceDate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `QueryItem.MaintenanceDate` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void QueryItem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_subAcctNoHasBeenSet)
    {
        ...
        value.AddMember(iKey, Value(m_subAcctNo.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_subAcctPropertyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_subAcctProperty.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_subMchIdHasBeenSet)
    {
        ...
        string key = "SubMchId";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_subMchId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_subAcctNameHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_subAcctName.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_acctAvailBalHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_acctAvailBal.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_cashAmtHasBeenSet)
    {
        ...
        string key = "CashAmt";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_cashAmt.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_maintenanceDateHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_maintenanceDate.c_str(), allocator).Move(), allocator);
    }
