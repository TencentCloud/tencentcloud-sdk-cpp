...
CoreInternalOutcome UploadOrgFileResponse::Deserialize(const string &payload)
{
...
string UploadOrgFileResponse::ToJsonString() const
{
...
string UploadOrgFileResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool UploadOrgFileResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string UploadOrgFileResponse::GetErrCode() const
{
    return m_errCode;
}

bool UploadOrgFileResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

UploadFileResult UploadOrgFileResponse::GetResult() const
{
    return m_result;
}

bool UploadOrgFileResponse::ResultHasBeenSet() const
{
