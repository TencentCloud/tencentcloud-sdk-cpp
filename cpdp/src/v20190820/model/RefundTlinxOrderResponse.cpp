...
CoreInternalOutcome RefundTlinxOrderResponse::Deserialize(const string &payload)
{
...
string RefundTlinxOrderResponse::ToJsonString() const
{
...
string RefundTlinxOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool RefundTlinxOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string RefundTlinxOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool RefundTlinxOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

RefundOrderResult RefundTlinxOrderResponse::GetResult() const
{
    return m_result;
}

bool RefundTlinxOrderResponse::ResultHasBeenSet() const
{
