...
CoreInternalOutcome QueryMerchantInfoForManagementResponse::Deserialize(const string &payload)
{
...
string QueryMerchantInfoForManagementResponse::ToJsonString() const
{
...
MerchantManagementResult QueryMerchantInfoForManagementResponse::GetResult() const
{
    return m_result;
}

bool QueryMerchantInfoForManagementResponse::ResultHasBeenSet() const
{
