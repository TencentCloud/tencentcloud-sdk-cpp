...
CreateOpenBankSubMerchantRateConfigureResponse::CreateOpenBankSubMerchantRateConfigureResponse() :
...
CoreInternalOutcome CreateOpenBankSubMerchantRateConfigureResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankSubMerchantRateConfigureResponse::ToJsonString() const
{
...
string CreateOpenBankSubMerchantRateConfigureResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankSubMerchantRateConfigureResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankSubMerchantRateConfigureResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankSubMerchantRateConfigureResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankSubMerchantRateConfigureResult CreateOpenBankSubMerchantRateConfigureResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankSubMerchantRateConfigureResponse::ResultHasBeenSet() const
{
