...
QueryFlexFreezeOrderListResponse::QueryFlexFreezeOrderListResponse() :
...
CoreInternalOutcome QueryFlexFreezeOrderListResponse::Deserialize(const string &payload)
{
...
string QueryFlexFreezeOrderListResponse::ToJsonString() const
{
...
string QueryFlexFreezeOrderListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexFreezeOrderListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexFreezeOrderListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexFreezeOrderListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

FreezeOrders QueryFlexFreezeOrderListResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexFreezeOrderListResponse::ResultHasBeenSet() const
{
