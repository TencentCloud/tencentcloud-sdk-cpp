...
ApplyOpenBankSettleOrderResponse::ApplyOpenBankSettleOrderResponse() :
...
CoreInternalOutcome ApplyOpenBankSettleOrderResponse::Deserialize(const string &payload)
{
...
string ApplyOpenBankSettleOrderResponse::ToJsonString() const
{
...
string ApplyOpenBankSettleOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyOpenBankSettleOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyOpenBankSettleOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyOpenBankSettleOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyOpenBankSettleOrderResult ApplyOpenBankSettleOrderResponse::GetResult() const
{
    return m_result;
}

bool ApplyOpenBankSettleOrderResponse::ResultHasBeenSet() const
{
