...
QueryOpenBankSettleOrderResponse::QueryOpenBankSettleOrderResponse() :
...
CoreInternalOutcome QueryOpenBankSettleOrderResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankSettleOrderResponse::ToJsonString() const
{
...
string QueryOpenBankSettleOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankSettleOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankSettleOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankSettleOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankSettleOrderResult QueryOpenBankSettleOrderResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankSettleOrderResponse::ResultHasBeenSet() const
{
