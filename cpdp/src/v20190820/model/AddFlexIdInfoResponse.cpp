...
AddFlexIdInfoResponse::AddFlexIdInfoResponse() :
...
CoreInternalOutcome AddFlexIdInfoResponse::Deserialize(const string &payload)
{
...
string AddFlexIdInfoResponse::ToJsonString() const
{
...
string AddFlexIdInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddFlexIdInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string AddFlexIdInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddFlexIdInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string AddFlexIdInfoResponse::GetResult() const
{
    return m_result;
}

bool AddFlexIdInfoResponse::ResultHasBeenSet() const
{
