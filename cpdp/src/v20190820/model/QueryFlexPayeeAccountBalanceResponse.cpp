...
QueryFlexPayeeAccountBalanceResponse::QueryFlexPayeeAccountBalanceResponse() :
...
CoreInternalOutcome QueryFlexPayeeAccountBalanceResponse::Deserialize(const string &payload)
{
...
string QueryFlexPayeeAccountBalanceResponse::ToJsonString() const
{
...
string QueryFlexPayeeAccountBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPayeeAccountBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPayeeAccountBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPayeeAccountBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PayeeAccountBalanceResult QueryFlexPayeeAccountBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPayeeAccountBalanceResponse::ResultHasBeenSet() const
{
