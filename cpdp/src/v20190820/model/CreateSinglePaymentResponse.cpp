...
CoreInternalOutcome CreateSinglePaymentResponse::Deserialize(const string &payload)
{
...
string CreateSinglePaymentResponse::ToJsonString() const
{
...
string CreateSinglePaymentResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateSinglePaymentResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateSinglePaymentResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateSinglePaymentResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateSinglePaymentData CreateSinglePaymentResponse::GetResult() const
{
    return m_result;
}

bool CreateSinglePaymentResponse::ResultHasBeenSet() const
{
