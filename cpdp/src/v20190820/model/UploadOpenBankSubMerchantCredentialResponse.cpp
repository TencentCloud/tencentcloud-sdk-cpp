...
UploadOpenBankSubMerchantCredentialResponse::UploadOpenBankSubMerchantCredentialResponse() :
...
CoreInternalOutcome UploadOpenBankSubMerchantCredentialResponse::Deserialize(const string &payload)
{
...
string UploadOpenBankSubMerchantCredentialResponse::ToJsonString() const
{
...
string UploadOpenBankSubMerchantCredentialResponse::GetErrCode() const
{
    return m_errCode;
}

bool UploadOpenBankSubMerchantCredentialResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string UploadOpenBankSubMerchantCredentialResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool UploadOpenBankSubMerchantCredentialResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

UploadOpenBankSubMerchantCredentialResult UploadOpenBankSubMerchantCredentialResponse::GetResult() const
{
    return m_result;
}

bool UploadOpenBankSubMerchantCredentialResponse::ResultHasBeenSet() const
{
