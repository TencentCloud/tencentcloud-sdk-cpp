...
CoreInternalOutcome CreateInvoiceResultV2::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateInvoiceResultV2::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
