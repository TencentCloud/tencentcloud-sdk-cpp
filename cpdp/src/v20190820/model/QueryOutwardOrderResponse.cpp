...
CoreInternalOutcome QueryOutwardOrderResponse::Deserialize(const string &payload)
{
...
string QueryOutwardOrderResponse::ToJsonString() const
{
...
QueryOutwardOrderResult QueryOutwardOrderResponse::GetResult() const
{
    return m_result;
}

bool QueryOutwardOrderResponse::ResultHasBeenSet() const
{
