...
CoreInternalOutcome QueryMerchantOrderResponse::Deserialize(const string &payload)
{
...
string QueryMerchantOrderResponse::ToJsonString() const
{
...
string QueryMerchantOrderResponse::GetMerchantAppId() const
{
    return m_merchantAppId;
}

bool QueryMerchantOrderResponse::MerchantAppIdHasBeenSet() const
{
    return m_merchantAppIdHasBeenSet;
}

string QueryMerchantOrderResponse::GetOrderNo() const
{
    return m_orderNo;
}

bool QueryMerchantOrderResponse::OrderNoHasBeenSet() const
{
    return m_orderNoHasBeenSet;
}

string QueryMerchantOrderResponse::GetStatus() const
{
    return m_status;
}

bool QueryMerchantOrderResponse::StatusHasBeenSet() const
{
