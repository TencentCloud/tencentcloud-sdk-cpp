...
CoreInternalOutcome ContractUserInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ContractUserInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
