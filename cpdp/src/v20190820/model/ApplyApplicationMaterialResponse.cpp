...
CoreInternalOutcome ApplyApplicationMaterialResponse::Deserialize(const string &payload)
{
...
string ApplyApplicationMaterialResponse::ToJsonString() const
{
...
ApplyDeclareResult ApplyApplicationMaterialResponse::GetResult() const
{
    return m_result;
}

bool ApplyApplicationMaterialResponse::ResultHasBeenSet() const
{
