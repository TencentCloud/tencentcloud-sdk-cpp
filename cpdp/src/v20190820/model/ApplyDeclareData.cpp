...
CoreInternalOutcome ApplyDeclareData::Deserialize(const Value &value)
{
    string requestId = "";
...
void ApplyDeclareData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
