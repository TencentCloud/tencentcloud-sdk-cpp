...
CoreInternalOutcome CreateMerchantResponse::Deserialize(const string &payload)
{
...
string CreateMerchantResponse::ToJsonString() const
{
...
CreateMerchantResult CreateMerchantResponse::GetResult() const
{
    return m_result;
}

bool CreateMerchantResponse::ResultHasBeenSet() const
{
