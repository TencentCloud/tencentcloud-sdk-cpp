...
CoreInternalOutcome MigrateOrderRefundResponse::Deserialize(const string &payload)
{
...
string MigrateOrderRefundResponse::ToJsonString() const
{
...
bool MigrateOrderRefundResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool MigrateOrderRefundResponse::IsSuccessHasBeenSet() const
{
    return m_isSuccessHasBeenSet;
}

string MigrateOrderRefundResponse::GetTradeSerialNo() const
{
    return m_tradeSerialNo;
}

bool MigrateOrderRefundResponse::TradeSerialNoHasBeenSet() const
{
    return m_tradeSerialNoHasBeenSet;
}

string MigrateOrderRefundResponse::GetTradeMsg() const
{
    return m_tradeMsg;
}

bool MigrateOrderRefundResponse::TradeMsgHasBeenSet() const
{
