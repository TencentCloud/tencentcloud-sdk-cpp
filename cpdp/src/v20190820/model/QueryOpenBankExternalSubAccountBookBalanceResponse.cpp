...
CoreInternalOutcome QueryOpenBankExternalSubAccountBookBalanceResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankExternalSubAccountBookBalanceResponse::ToJsonString() const
{
...
string QueryOpenBankExternalSubAccountBookBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankExternalSubAccountBookBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankExternalSubAccountBookBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankExternalSubAccountBookBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryExternalAccountBookResult QueryOpenBankExternalSubAccountBookBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankExternalSubAccountBookBalanceResponse::ResultHasBeenSet() const
{
