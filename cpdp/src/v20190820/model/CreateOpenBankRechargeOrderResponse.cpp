...
CoreInternalOutcome CreateOpenBankRechargeOrderResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankRechargeOrderResponse::ToJsonString() const
{
...
string CreateOpenBankRechargeOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankRechargeOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankRechargeOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankRechargeOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankOrderRechargeResult CreateOpenBankRechargeOrderResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankRechargeOrderResponse::ResultHasBeenSet() const
{
