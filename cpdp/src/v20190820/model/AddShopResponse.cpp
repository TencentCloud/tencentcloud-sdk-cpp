...
CoreInternalOutcome AddShopResponse::Deserialize(const string &payload)
{
...
string AddShopResponse::ToJsonString() const
{
...
string AddShopResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool AddShopResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string AddShopResponse::GetErrCode() const
{
    return m_errCode;
}

bool AddShopResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

AddShopResult AddShopResponse::GetResult() const
{
    return m_result;
}

bool AddShopResponse::ResultHasBeenSet() const
{
