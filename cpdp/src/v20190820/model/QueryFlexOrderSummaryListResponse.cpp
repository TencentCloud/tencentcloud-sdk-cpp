...
QueryFlexOrderSummaryListResponse::QueryFlexOrderSummaryListResponse() :
...
CoreInternalOutcome QueryFlexOrderSummaryListResponse::Deserialize(const string &payload)
{
...
string QueryFlexOrderSummaryListResponse::ToJsonString() const
{
...
string QueryFlexOrderSummaryListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexOrderSummaryListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexOrderSummaryListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexOrderSummaryListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

OrderSummaries QueryFlexOrderSummaryListResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexOrderSummaryListResponse::ResultHasBeenSet() const
{
