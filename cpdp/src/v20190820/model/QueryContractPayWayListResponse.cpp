...
CoreInternalOutcome QueryContractPayWayListResponse::Deserialize(const string &payload)
{
...
string QueryContractPayWayListResponse::ToJsonString() const
{
...
string QueryContractPayWayListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryContractPayWayListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string QueryContractPayWayListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryContractPayWayListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

vector<ContractPayListResult> QueryContractPayWayListResponse::GetResult() const
{
    return m_result;
}

bool QueryContractPayWayListResponse::ResultHasBeenSet() const
{
