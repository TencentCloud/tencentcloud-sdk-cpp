...
QueryOpenBankBillDataPageResponse::QueryOpenBankBillDataPageResponse() :
...
CoreInternalOutcome QueryOpenBankBillDataPageResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankBillDataPageResponse::ToJsonString() const
{
...
string QueryOpenBankBillDataPageResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankBillDataPageResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankBillDataPageResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankBillDataPageResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankBillDataPageResult QueryOpenBankBillDataPageResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankBillDataPageResponse::ResultHasBeenSet() const
{
