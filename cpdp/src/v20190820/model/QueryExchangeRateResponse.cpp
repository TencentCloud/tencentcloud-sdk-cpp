...
CoreInternalOutcome QueryExchangeRateResponse::Deserialize(const string &payload)
{
...
string QueryExchangeRateResponse::ToJsonString() const
{
...
QueryExchangerateResult QueryExchangeRateResponse::GetResult() const
{
    return m_result;
}

bool QueryExchangeRateResponse::ResultHasBeenSet() const
{
