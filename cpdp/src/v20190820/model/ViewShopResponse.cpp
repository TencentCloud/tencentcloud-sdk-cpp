...
CoreInternalOutcome ViewShopResponse::Deserialize(const string &payload)
{
...
string ViewShopResponse::ToJsonString() const
{
...
string ViewShopResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ViewShopResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string ViewShopResponse::GetErrCode() const
{
    return m_errCode;
}

bool ViewShopResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

ViewShopResult ViewShopResponse::GetResult() const
{
    return m_result;
}

bool ViewShopResponse::ResultHasBeenSet() const
{
