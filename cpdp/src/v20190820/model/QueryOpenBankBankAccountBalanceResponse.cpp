...
CoreInternalOutcome QueryOpenBankBankAccountBalanceResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankBankAccountBalanceResponse::ToJsonString() const
{
...
string QueryOpenBankBankAccountBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankBankAccountBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankBankAccountBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankBankAccountBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankBankAccountBalanceResult QueryOpenBankBankAccountBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankBankAccountBalanceResponse::ResultHasBeenSet() const
{
