...
CoreInternalOutcome CreateExternalAnchorData::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void CreateExternalAnchorData::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string CreateExternalAnchorData::GetAnchorId() const
{
    return m_anchorId;
}

void CreateExternalAnchorData::SetAnchorId(const string& _anchorId)
{
    m_anchorId = _anchorId;
    m_anchorIdHasBeenSet = true;
}

bool CreateExternalAnchorData::AnchorIdHasBeenSet() const
{
