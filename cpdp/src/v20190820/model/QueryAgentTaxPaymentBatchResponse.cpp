...
CoreInternalOutcome QueryAgentTaxPaymentBatchResponse::Deserialize(const string &payload)
{
...
string QueryAgentTaxPaymentBatchResponse::ToJsonString() const
{
...
AgentTaxPaymentBatch QueryAgentTaxPaymentBatchResponse::GetAgentTaxPaymentBatch() const
{
    return m_agentTaxPaymentBatch;
}

bool QueryAgentTaxPaymentBatchResponse::AgentTaxPaymentBatchHasBeenSet() const
{
