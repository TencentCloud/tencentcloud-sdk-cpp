...
CoreInternalOutcome ApplyOutwardOrderResponse::Deserialize(const string &payload)
{
...
string ApplyOutwardOrderResponse::ToJsonString() const
{
...
ApplyOutwardOrderResult ApplyOutwardOrderResponse::GetResult() const
{
    return m_result;
}

bool ApplyOutwardOrderResponse::ResultHasBeenSet() const
{
