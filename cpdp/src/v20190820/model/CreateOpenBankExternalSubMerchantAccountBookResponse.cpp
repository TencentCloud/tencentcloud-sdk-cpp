...
CoreInternalOutcome CreateOpenBankExternalSubMerchantAccountBookResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankExternalSubMerchantAccountBookResponse::ToJsonString() const
{
...
string CreateOpenBankExternalSubMerchantAccountBookResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankExternalSubMerchantAccountBookResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankExternalSubMerchantAccountBookResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankExternalSubMerchantAccountBookResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateExternalAccountBookResult CreateOpenBankExternalSubMerchantAccountBookResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankExternalSubMerchantAccountBookResponse::ResultHasBeenSet() const
{
