...
QueryFlexWechatAuthResultResponse::QueryFlexWechatAuthResultResponse() :
...
CoreInternalOutcome QueryFlexWechatAuthResultResponse::Deserialize(const string &payload)
{
...
string QueryFlexWechatAuthResultResponse::ToJsonString() const
{
...
string QueryFlexWechatAuthResultResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexWechatAuthResultResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexWechatAuthResultResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexWechatAuthResultResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryWechatAuthResult QueryFlexWechatAuthResultResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexWechatAuthResultResponse::ResultHasBeenSet() const
{
