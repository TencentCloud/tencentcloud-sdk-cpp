...
QueryFlexServiceProviderAccountBalanceResponse::QueryFlexServiceProviderAccountBalanceResponse() :
...
CoreInternalOutcome QueryFlexServiceProviderAccountBalanceResponse::Deserialize(const string &payload)
{
...
string QueryFlexServiceProviderAccountBalanceResponse::ToJsonString() const
{
...
string QueryFlexServiceProviderAccountBalanceResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexServiceProviderAccountBalanceResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexServiceProviderAccountBalanceResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexServiceProviderAccountBalanceResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ServiceProviderAccountBalanceResult QueryFlexServiceProviderAccountBalanceResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexServiceProviderAccountBalanceResponse::ResultHasBeenSet() const
{
