...
CoreInternalOutcome DownloadOrgFileResponse::Deserialize(const string &payload)
{
...
string DownloadOrgFileResponse::ToJsonString() const
{
...
string DownloadOrgFileResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DownloadOrgFileResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DownloadOrgFileResponse::GetErrCode() const
{
    return m_errCode;
}

bool DownloadOrgFileResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DownloadFileResult DownloadOrgFileResponse::GetResult() const
{
    return m_result;
}

bool DownloadOrgFileResponse::ResultHasBeenSet() const
{
