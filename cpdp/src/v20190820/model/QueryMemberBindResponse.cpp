...
CoreInternalOutcome QueryMemberBindResponse::Deserialize(const string &payload)
{
...
string QueryMemberBindResponse::ToJsonString() const
{
...
string QueryMemberBindResponse::GetResultNum() const
{
    return m_resultNum;
}

bool QueryMemberBindResponse::ResultNumHasBeenSet() const
{
    return m_resultNumHasBeenSet;
}

string QueryMemberBindResponse::GetStartRecordNo() const
{
    return m_startRecordNo;
}

bool QueryMemberBindResponse::StartRecordNoHasBeenSet() const
{
    return m_startRecordNoHasBeenSet;
}

string QueryMemberBindResponse::GetEndFlag() const
{
    return m_endFlag;
}

bool QueryMemberBindResponse::EndFlagHasBeenSet() const
{
    return m_endFlagHasBeenSet;
}

string QueryMemberBindResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool QueryMemberBindResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<TranItem> QueryMemberBindResponse::GetTranItemArray() const
{
    return m_tranItemArray;
}

bool QueryMemberBindResponse::TranItemArrayHasBeenSet() const
{
    return m_tranItemArrayHasBeenSet;
}

string QueryMemberBindResponse::GetReservedMsg() const
{
    return m_reservedMsg;
}

bool QueryMemberBindResponse::ReservedMsgHasBeenSet() const
{
    return m_reservedMsgHasBeenSet;
}

string QueryMemberBindResponse::GetTxnReturnCode() const
{
    return m_txnReturnCode;
}

bool QueryMemberBindResponse::TxnReturnCodeHasBeenSet() const
{
    return m_txnReturnCodeHasBeenSet;
}

string QueryMemberBindResponse::GetTxnReturnMsg() const
{
    return m_txnReturnMsg;
}

bool QueryMemberBindResponse::TxnReturnMsgHasBeenSet() const
{
    return m_txnReturnMsgHasBeenSet;
}

string QueryMemberBindResponse::GetCnsmrSeqNo() const
{
    return m_cnsmrSeqNo;
}

bool QueryMemberBindResponse::CnsmrSeqNoHasBeenSet() const
{
