...
CoreInternalOutcome CreateOpenBankMerchantResponse::Deserialize(const string &payload)
{
...
string CreateOpenBankMerchantResponse::ToJsonString() const
{
...
string CreateOpenBankMerchantResponse::GetErrCode() const
{
    return m_errCode;
}

bool CreateOpenBankMerchantResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateOpenBankMerchantResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateOpenBankMerchantResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

CreateOpenBankMerchantResult CreateOpenBankMerchantResponse::GetResult() const
{
    return m_result;
}

bool CreateOpenBankMerchantResponse::ResultHasBeenSet() const
{
