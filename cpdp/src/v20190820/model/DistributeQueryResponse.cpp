...
CoreInternalOutcome DistributeQueryResponse::Deserialize(const string &payload)
{
...
string DistributeQueryResponse::ToJsonString() const
{
...
string DistributeQueryResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeQueryResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeQueryResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeQueryResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeQueryResult DistributeQueryResponse::GetResult() const
{
    return m_result;
}

bool DistributeQueryResponse::ResultHasBeenSet() const
{
