...
CoreInternalOutcome CreatePayMerchantResponse::Deserialize(const string &payload)
{
...
string CreatePayMerchantResponse::ToJsonString() const
{
...
string CreatePayMerchantResponse::GetMerchantAppId() const
{
    return m_merchantAppId;
}

bool CreatePayMerchantResponse::MerchantAppIdHasBeenSet() const
{
