...
CoreInternalOutcome QueryOpenBankExternalSubMerchantRegistrationResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankExternalSubMerchantRegistrationResponse::ToJsonString() const
{
...
string QueryOpenBankExternalSubMerchantRegistrationResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankExternalSubMerchantRegistrationResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankExternalSubMerchantRegistrationResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankExternalSubMerchantRegistrationResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankExternalSubMerchantRegistrationResult QueryOpenBankExternalSubMerchantRegistrationResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankExternalSubMerchantRegistrationResponse::ResultHasBeenSet() const
{
