...
CoreInternalOutcome CreateRedInvoiceV2Response::Deserialize(const string &payload)
{
...
string CreateRedInvoiceV2Response::ToJsonString() const
{
...
CreateRedInvoiceResultV2 CreateRedInvoiceV2Response::GetResult() const
{
    return m_result;
}

bool CreateRedInvoiceV2Response::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string CreateRedInvoiceV2Response::GetErrCode() const
{
    return m_errCode;
}

bool CreateRedInvoiceV2Response::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CreateRedInvoiceV2Response::GetErrMessage() const
{
    return m_errMessage;
}

bool CreateRedInvoiceV2Response::ErrMessageHasBeenSet() const
{
