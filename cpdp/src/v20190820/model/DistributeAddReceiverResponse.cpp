...
CoreInternalOutcome DistributeAddReceiverResponse::Deserialize(const string &payload)
{
...
string DistributeAddReceiverResponse::ToJsonString() const
{
...
string DistributeAddReceiverResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeAddReceiverResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeAddReceiverResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeAddReceiverResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeReceiverResult DistributeAddReceiverResponse::GetResult() const
{
    return m_result;
}

bool DistributeAddReceiverResponse::ResultHasBeenSet() const
{
