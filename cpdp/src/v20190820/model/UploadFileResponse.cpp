...
CoreInternalOutcome UploadFileResponse::Deserialize(const string &payload)
{
...
string UploadFileResponse::ToJsonString() const
{
...
string UploadFileResponse::GetFileId() const
{
    return m_fileId;
}

bool UploadFileResponse::FileIdHasBeenSet() const
{
