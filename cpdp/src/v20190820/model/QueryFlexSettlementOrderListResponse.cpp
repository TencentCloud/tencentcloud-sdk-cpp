...
QueryFlexSettlementOrderListResponse::QueryFlexSettlementOrderListResponse() :
...
CoreInternalOutcome QueryFlexSettlementOrderListResponse::Deserialize(const string &payload)
{
...
string QueryFlexSettlementOrderListResponse::ToJsonString() const
{
...
string QueryFlexSettlementOrderListResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexSettlementOrderListResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexSettlementOrderListResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexSettlementOrderListResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

SettlementOrders QueryFlexSettlementOrderListResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexSettlementOrderListResponse::ResultHasBeenSet() const
{
