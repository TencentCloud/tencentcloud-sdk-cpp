...
QueryFlexPayeeInfoResponse::QueryFlexPayeeInfoResponse() :
...
CoreInternalOutcome QueryFlexPayeeInfoResponse::Deserialize(const string &payload)
{
...
string QueryFlexPayeeInfoResponse::ToJsonString() const
{
...
string QueryFlexPayeeInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryFlexPayeeInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryFlexPayeeInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryFlexPayeeInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

PayeeInfoResult QueryFlexPayeeInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryFlexPayeeInfoResponse::ResultHasBeenSet() const
{
