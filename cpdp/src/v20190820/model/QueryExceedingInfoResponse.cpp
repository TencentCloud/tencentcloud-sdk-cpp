...
CoreInternalOutcome QueryExceedingInfoResponse::Deserialize(const string &payload)
{
...
string QueryExceedingInfoResponse::ToJsonString() const
{
...
string QueryExceedingInfoResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryExceedingInfoResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryExceedingInfoResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryExceedingInfoResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryExceedingInfoResult QueryExceedingInfoResponse::GetResult() const
{
    return m_result;
}

bool QueryExceedingInfoResponse::ResultHasBeenSet() const
{
