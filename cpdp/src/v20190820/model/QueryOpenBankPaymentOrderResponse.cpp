...
CoreInternalOutcome QueryOpenBankPaymentOrderResponse::Deserialize(const string &payload)
{
...
string QueryOpenBankPaymentOrderResponse::ToJsonString() const
{
...
string QueryOpenBankPaymentOrderResponse::GetErrCode() const
{
    return m_errCode;
}

bool QueryOpenBankPaymentOrderResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string QueryOpenBankPaymentOrderResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool QueryOpenBankPaymentOrderResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

QueryOpenBankPaymentOrderResult QueryOpenBankPaymentOrderResponse::GetResult() const
{
    return m_result;
}

bool QueryOpenBankPaymentOrderResponse::ResultHasBeenSet() const
{
