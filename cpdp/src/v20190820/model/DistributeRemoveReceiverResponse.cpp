...
CoreInternalOutcome DistributeRemoveReceiverResponse::Deserialize(const string &payload)
{
...
string DistributeRemoveReceiverResponse::ToJsonString() const
{
...
string DistributeRemoveReceiverResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool DistributeRemoveReceiverResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

string DistributeRemoveReceiverResponse::GetErrCode() const
{
    return m_errCode;
}

bool DistributeRemoveReceiverResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

DistributeReceiverResult DistributeRemoveReceiverResponse::GetResult() const
{
    return m_result;
}

bool DistributeRemoveReceiverResponse::ResultHasBeenSet() const
{
