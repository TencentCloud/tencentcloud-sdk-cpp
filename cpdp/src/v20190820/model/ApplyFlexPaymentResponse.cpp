...
ApplyFlexPaymentResponse::ApplyFlexPaymentResponse() :
...
CoreInternalOutcome ApplyFlexPaymentResponse::Deserialize(const string &payload)
{
...
string ApplyFlexPaymentResponse::ToJsonString() const
{
...
string ApplyFlexPaymentResponse::GetErrCode() const
{
    return m_errCode;
}

bool ApplyFlexPaymentResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string ApplyFlexPaymentResponse::GetErrMessage() const
{
    return m_errMessage;
}

bool ApplyFlexPaymentResponse::ErrMessageHasBeenSet() const
{
    return m_errMessageHasBeenSet;
}

ApplyFlexPaymentResult ApplyFlexPaymentResponse::GetResult() const
{
    return m_result;
}

bool ApplyFlexPaymentResponse::ResultHasBeenSet() const
{
