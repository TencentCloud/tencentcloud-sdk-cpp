...
CreateApplicationAndVideoResponse::CreateApplicationAndVideoResponse() :
    m_licenseIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateApplicationAndVideoResponse::Deserialize(const string &payload)
{
...
string CreateApplicationAndVideoResponse::ToJsonString() const
{
...
uint64_t CreateApplicationAndVideoResponse::GetLicenseId() const
{
    return m_licenseId;
}

bool CreateApplicationAndVideoResponse::LicenseIdHasBeenSet() const
{
