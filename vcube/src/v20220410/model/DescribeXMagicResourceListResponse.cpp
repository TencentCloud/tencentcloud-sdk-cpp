...
DescribeXMagicResourceListResponse::DescribeXMagicResourceListResponse() :
    m_resourcesHasBeenSet(false),
    m_countHasBeenSet(false)
{
}

CoreInternalOutcome DescribeXMagicResourceListResponse::Deserialize(const string &payload)
{
...
string DescribeXMagicResourceListResponse::ToJsonString() const
{
...
vector<XMagicResourceSimpleInfo> DescribeXMagicResourceListResponse::GetResources() const
{
    return m_resources;
}

bool DescribeXMagicResourceListResponse::ResourcesHasBeenSet() const
{
    return m_resourcesHasBeenSet;
}

uint64_t DescribeXMagicResourceListResponse::GetCount() const
{
    return m_count;
}

bool DescribeXMagicResourceListResponse::CountHasBeenSet() const
{
