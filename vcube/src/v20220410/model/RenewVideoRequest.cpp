...
RenewVideoRequest::RenewVideoRequest() :
    m_licenseIdHasBeenSet(false)
{
}

string RenewVideoRequest::ToJsonString() const
{
...
uint64_t RenewVideoRequest::GetLicenseId() const
{
    return m_licenseId;
}

void RenewVideoRequest::SetLicenseId(const uint64_t& _licenseId)
{
    m_licenseId = _licenseId;
    m_licenseIdHasBeenSet = true;
}

bool RenewVideoRequest::LicenseIdHasBeenSet() const
{
