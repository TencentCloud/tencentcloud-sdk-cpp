...
RenewTestXMagicRequest::RenewTestXMagicRequest() :
    m_xMagicIdHasBeenSet(false)
{
}

string RenewTestXMagicRequest::ToJsonString() const
{
...
uint64_t RenewTestXMagicRequest::GetXMagicId() const
{
    return m_xMagicId;
}

void RenewTestXMagicRequest::SetXMagicId(const uint64_t& _xMagicId)
{
    m_xMagicId = _xMagicId;
    m_xMagicIdHasBeenSet = true;
}

bool RenewTestXMagicRequest::XMagicIdHasBeenSet() const
{
