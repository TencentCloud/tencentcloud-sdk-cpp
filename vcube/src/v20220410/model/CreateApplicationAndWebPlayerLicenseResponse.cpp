...
CoreInternalOutcome CreateApplicationAndWebPlayerLicenseResponse::Deserialize(const string &payload)
{
...
string CreateApplicationAndWebPlayerLicenseResponse::ToJsonString() const
{
