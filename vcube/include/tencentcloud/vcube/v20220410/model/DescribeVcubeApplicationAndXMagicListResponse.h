...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDXMAGICLISTRESPONSE_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDXMAGICLISTRESPONSE_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                */
                class DescribeVcubeApplicationAndXMagicListResponse : public AbstractModel
                {
                public:
                    DescribeVcubeApplicationAndXMagicListResponse();
                    ~DescribeVcubeApplicationAndXMagicListResponse() = default;
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDXMAGICLISTRESPONSE_H_
