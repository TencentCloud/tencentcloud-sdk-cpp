...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_RENEWLICENSEREQUEST_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_RENEWLICENSEREQUEST_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                * RenewLicense请求参数结构体
                */
                class RenewLicenseRequest : public AbstractModel
                {
                public:
                    RenewLicenseRequest();
                    ~RenewLicenseRequest() = default;
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_RENEWLICENSEREQUEST_H_
