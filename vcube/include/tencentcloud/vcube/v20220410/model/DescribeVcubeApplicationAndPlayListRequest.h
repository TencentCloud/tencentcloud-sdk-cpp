...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDPLAYLISTREQUEST_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDPLAYLISTREQUEST_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                */
                class DescribeVcubeApplicationAndPlayListRequest : public AbstractModel
                {
                public:
                    DescribeVcubeApplicationAndPlayListRequest();
                    ~DescribeVcubeApplicationAndPlayListRequest() = default;
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDPLAYLISTREQUEST_H_
