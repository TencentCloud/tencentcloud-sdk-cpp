    ...
    namespace Mariadb
    {
        namespace V20170312
        {
            ...
            public:
                ...
                typedef Outcome<Error, Model::DescribeDBInstanceSpecsResponse> DescribeDBInstanceSpecsOutcome;
                ...
                typedef Outcome<Error, Model::DescribeSaleInfoResponse> DescribeSaleInfoOutcome;
