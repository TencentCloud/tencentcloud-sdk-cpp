...
#ifndef TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBPERFORMANCEREQUEST_H_
#define TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBPERFORMANCEREQUEST_H_
    ...
    namespace Mariadb
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeDBPerformanceRequest : public AbstractModel
                {
                public:
                    DescribeDBPerformanceRequest();
                    ~DescribeDBPerformanceRequest() = default;
...
#endif // !TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBPERFORMANCEREQUEST_H_
