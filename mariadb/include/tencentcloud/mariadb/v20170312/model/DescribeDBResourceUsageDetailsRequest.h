...
#ifndef TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBRESOURCEUSAGEDETAILSREQUEST_H_
#define TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBRESOURCEUSAGEDETAILSREQUEST_H_
    ...
    namespace Mariadb
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeDBResourceUsageDetailsRequest : public AbstractModel
                {
                public:
                    DescribeDBResourceUsageDetailsRequest();
                    ~DescribeDBResourceUsageDetailsRequest() = default;
...
#endif // !TENCENTCLOUD_MARIADB_V20170312_MODEL_DESCRIBEDBRESOURCEUSAGEDETAILSREQUEST_H_
