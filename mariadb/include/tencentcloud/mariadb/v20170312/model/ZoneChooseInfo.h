...
#ifndef TENCENTCLOUD_MARIADB_V20170312_MODEL_ZONECHOOSEINFO_H_
#define TENCENTCLOUD_MARIADB_V20170312_MODEL_ZONECHOOSEINFO_H_
    ...
    namespace Mariadb
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * 分片节点可用区选择
                */
                class ZoneChooseInfo : public AbstractModel
                {
                public:
                    ZoneChooseInfo();
                    ~ZoneChooseInfo() = default;
...
#endif // !TENCENTCLOUD_MARIADB_V20170312_MODEL_ZONECHOOSEINFO_H_
