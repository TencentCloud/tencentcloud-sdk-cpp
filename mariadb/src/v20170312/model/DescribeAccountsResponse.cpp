...
string DescribeAccountsResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DescribeAccountsResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<DBAccount> DescribeAccountsResponse::GetUsers() const
{
    return m_users;
}

bool DescribeAccountsResponse::UsersHasBeenSet() const
{
