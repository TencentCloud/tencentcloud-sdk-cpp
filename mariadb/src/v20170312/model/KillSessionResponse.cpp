...
CoreInternalOutcome KillSessionResponse::Deserialize(const string &payload)
{
...
string KillSessionResponse::ToJsonString() const
{
...
int64_t KillSessionResponse::GetTaskId() const
{
    return m_taskId;
}

bool KillSessionResponse::TaskIdHasBeenSet() const
{
