...
CoreInternalOutcome CancelDcnJobResponse::Deserialize(const string &payload)
{
...
string CancelDcnJobResponse::ToJsonString() const
{
...
int64_t CancelDcnJobResponse::GetFlowId() const
{
    return m_flowId;
}

bool CancelDcnJobResponse::FlowIdHasBeenSet() const
{
