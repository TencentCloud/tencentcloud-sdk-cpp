...
CoreInternalOutcome DescribeSaleInfoResponse::Deserialize(const string &payload)
{
...
string DescribeSaleInfoResponse::ToJsonString() const
{
...
vector<RegionInfo> DescribeSaleInfoResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeSaleInfoResponse::RegionListHasBeenSet() const
{
