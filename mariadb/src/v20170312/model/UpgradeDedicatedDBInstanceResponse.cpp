...
CoreInternalOutcome UpgradeDedicatedDBInstanceResponse::Deserialize(const string &payload)
{
...
string UpgradeDedicatedDBInstanceResponse::ToJsonString() const
{
...
int64_t UpgradeDedicatedDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeDedicatedDBInstanceResponse::FlowIdHasBeenSet() const
{
