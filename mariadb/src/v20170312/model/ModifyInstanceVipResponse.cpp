...
CoreInternalOutcome ModifyInstanceVipResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceVipResponse::ToJsonString() const
{
...
int64_t ModifyInstanceVipResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyInstanceVipResponse::FlowIdHasBeenSet() const
{
