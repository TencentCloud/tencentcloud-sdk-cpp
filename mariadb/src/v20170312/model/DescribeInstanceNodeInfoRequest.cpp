...
uint64_t DescribeInstanceNodeInfoRequest::GetLimit() const
{
    return m_limit;
}

void DescribeInstanceNodeInfoRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
uint64_t DescribeInstanceNodeInfoRequest::GetOffset() const
{
    return m_offset;
}

void DescribeInstanceNodeInfoRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
