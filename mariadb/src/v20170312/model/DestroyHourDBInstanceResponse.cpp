...
CoreInternalOutcome DestroyHourDBInstanceResponse::Deserialize(const string &payload)
{
...
string DestroyHourDBInstanceResponse::ToJsonString() const
{
...
int64_t DestroyHourDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool DestroyHourDBInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string DestroyHourDBInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DestroyHourDBInstanceResponse::InstanceIdHasBeenSet() const
{
