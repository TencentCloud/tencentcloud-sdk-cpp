...
CoreInternalOutcome DescribeRenewalPriceResponse::Deserialize(const string &payload)
{
...
string DescribeRenewalPriceResponse::ToJsonString() const
{
...
int64_t DescribeRenewalPriceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool DescribeRenewalPriceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

int64_t DescribeRenewalPriceResponse::GetPrice() const
{
    return m_price;
}

bool DescribeRenewalPriceResponse::PriceHasBeenSet() const
{
