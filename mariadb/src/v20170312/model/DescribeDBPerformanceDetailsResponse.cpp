...
PerformanceMonitorSet DescribeDBPerformanceDetailsResponse::GetMaster() const
{
    return m_master;
}

bool DescribeDBPerformanceDetailsResponse::MasterHasBeenSet() const
{
    return m_masterHasBeenSet;
}

PerformanceMonitorSet DescribeDBPerformanceDetailsResponse::GetSlave1() const
{
    return m_slave1;
}

bool DescribeDBPerformanceDetailsResponse::Slave1HasBeenSet() const
{
    return m_slave1HasBeenSet;
}

PerformanceMonitorSet DescribeDBPerformanceDetailsResponse::GetSlave2() const
{
    return m_slave2;
}

bool DescribeDBPerformanceDetailsResponse::Slave2HasBeenSet() const
{
