...
CoreInternalOutcome ActivateHourDBInstanceResponse::Deserialize(const string &payload)
{
...
string ActivateHourDBInstanceResponse::ToJsonString() const
{
...
vector<string> ActivateHourDBInstanceResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool ActivateHourDBInstanceResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> ActivateHourDBInstanceResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool ActivateHourDBInstanceResponse::FailedInstanceIdsHasBeenSet() const
{
