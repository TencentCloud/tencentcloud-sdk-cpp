...
CoreInternalOutcome ModifyInstanceNetworkResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceNetworkResponse::ToJsonString() const
{
...
int64_t ModifyInstanceNetworkResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyInstanceNetworkResponse::FlowIdHasBeenSet() const
{
