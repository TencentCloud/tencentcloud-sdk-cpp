...
CoreInternalOutcome CreateDedicatedClusterDBInstanceResponse::Deserialize(const string &payload)
{
...
string CreateDedicatedClusterDBInstanceResponse::ToJsonString() const
{
...
vector<string> CreateDedicatedClusterDBInstanceResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CreateDedicatedClusterDBInstanceResponse::InstanceIdsHasBeenSet() const
{
    return m_instanceIdsHasBeenSet;
}

int64_t CreateDedicatedClusterDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateDedicatedClusterDBInstanceResponse::FlowIdHasBeenSet() const
{
