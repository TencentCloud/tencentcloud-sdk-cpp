...
uint64_t DescribeInstanceNodeInfoResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstanceNodeInfoResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<NodeInfo> DescribeInstanceNodeInfoResponse::GetNodesInfo() const
{
    return m_nodesInfo;
}

bool DescribeInstanceNodeInfoResponse::NodesInfoHasBeenSet() const
{
