...
CoreInternalOutcome IsolateDBInstanceResponse::Deserialize(const string &payload)
{
...
string IsolateDBInstanceResponse::ToJsonString() const
{
...
vector<string> IsolateDBInstanceResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool IsolateDBInstanceResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> IsolateDBInstanceResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool IsolateDBInstanceResponse::FailedInstanceIdsHasBeenSet() const
{
