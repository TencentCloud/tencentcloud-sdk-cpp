...
CoreInternalOutcome RenewDBInstanceResponse::Deserialize(const string &payload)
{
...
string RenewDBInstanceResponse::ToJsonString() const
{
...
string RenewDBInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool RenewDBInstanceResponse::DealNameHasBeenSet() const
{
