...
CoreInternalOutcome DescribePriceResponse::Deserialize(const string &payload)
{
...
string DescribePriceResponse::ToJsonString() const
{
...
int64_t DescribePriceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool DescribePriceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

int64_t DescribePriceResponse::GetPrice() const
{
    return m_price;
}

bool DescribePriceResponse::PriceHasBeenSet() const
{
