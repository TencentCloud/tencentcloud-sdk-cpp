...
string RestartDBInstancesRequest::ToJsonString() const
{
    ...
    if (m_restartTimeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_restartTime.c_str(), allocator).Move(), allocator);
    }
...
vector<string> RestartDBInstancesRequest::GetInstanceIds() const
{
    return m_instanceIds;
}

void RestartDBInstancesRequest::SetInstanceIds(const vector<string>& _instanceIds)
{
