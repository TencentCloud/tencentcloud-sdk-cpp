...
CoreInternalOutcome BatchRegisterResponse::Deserialize(const string &payload)
{
...
string BatchRegisterResponse::ToJsonString() const
{
...
vector<BatchUserInfo> BatchRegisterResponse::GetUsers() const
{
    return m_users;
}

bool BatchRegisterResponse::UsersHasBeenSet() const
{
