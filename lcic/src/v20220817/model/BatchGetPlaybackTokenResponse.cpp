...
CoreInternalOutcome BatchGetPlaybackTokenResponse::Deserialize(const string &payload)
{
...
string BatchGetPlaybackTokenResponse::ToJsonString() const
{
...
vector<TokenResult> BatchGetPlaybackTokenResponse::GetResults() const
{
    return m_results;
}

bool BatchGetPlaybackTokenResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

uint64_t BatchGetPlaybackTokenResponse::GetTotal() const
{
    return m_total;
}
