...
LoginOriginIdWithRoomResponse::LoginOriginIdWithRoomResponse() :
    m_userIdHasBeenSet(false),
    m_tokenHasBeenSet(false)
{
}

CoreInternalOutcome LoginOriginIdWithRoomResponse::Deserialize(const string &payload)
{
...
string LoginOriginIdWithRoomResponse::ToJsonString() const
{
...
string LoginOriginIdWithRoomResponse::GetUserId() const
{
    return m_userId;
}

bool LoginOriginIdWithRoomResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string LoginOriginIdWithRoomResponse::GetToken() const
{
    return m_token;
}

bool LoginOriginIdWithRoomResponse::TokenHasBeenSet() const
{
