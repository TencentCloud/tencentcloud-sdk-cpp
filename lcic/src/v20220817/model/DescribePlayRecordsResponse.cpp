...
DescribePlayRecordsResponse::DescribePlayRecordsResponse() :
    m_totalHasBeenSet(false),
    m_recordsHasBeenSet(false)
{
}

CoreInternalOutcome DescribePlayRecordsResponse::Deserialize(const string &payload)
{
...
string DescribePlayRecordsResponse::ToJsonString() const
{
...
uint64_t DescribePlayRecordsResponse::GetTotal() const
{
    return m_total;
}

bool DescribePlayRecordsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<PlayRecord> DescribePlayRecordsResponse::GetRecords() const
{
    return m_records;
}

bool DescribePlayRecordsResponse::RecordsHasBeenSet() const
{
