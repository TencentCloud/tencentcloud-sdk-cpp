...
CoreInternalOutcome DescribeGroupListResponse::Deserialize(const string &payload)
{
...
string DescribeGroupListResponse::ToJsonString() const
{
...
uint64_t DescribeGroupListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeGroupListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<GroupInfo> DescribeGroupListResponse::GetGroupInfos() const
{
    return m_groupInfos;
}

bool DescribeGroupListResponse::GroupInfosHasBeenSet() const
{
