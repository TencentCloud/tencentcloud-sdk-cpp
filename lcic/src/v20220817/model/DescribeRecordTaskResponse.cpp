...
string DescribeRecordTaskResponse::ToJsonString() const
{
...
string DescribeRecordTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeRecordTaskResponse::TaskIdHasBeenSet() const
{
