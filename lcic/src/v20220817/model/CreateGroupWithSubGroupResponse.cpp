...
CoreInternalOutcome CreateGroupWithSubGroupResponse::Deserialize(const string &payload)
{
...
string CreateGroupWithSubGroupResponse::ToJsonString() const
{
...
string CreateGroupWithSubGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateGroupWithSubGroupResponse::GroupIdHasBeenSet() const
{
