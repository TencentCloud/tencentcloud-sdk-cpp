...
CoreInternalOutcome DescribeSdkAppIdUsersResponse::Deserialize(const string &payload)
{
...
string DescribeSdkAppIdUsersResponse::ToJsonString() const
{
...
uint64_t DescribeSdkAppIdUsersResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSdkAppIdUsersResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<UserInfo> DescribeSdkAppIdUsersResponse::GetUsers() const
{
    return m_users;
}

bool DescribeSdkAppIdUsersResponse::UsersHasBeenSet() const
{
