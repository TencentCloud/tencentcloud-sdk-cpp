...
CoreInternalOutcome CreateGroupWithMembersResponse::Deserialize(const string &payload)
{
...
string CreateGroupWithMembersResponse::ToJsonString() const
{
...
string CreateGroupWithMembersResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateGroupWithMembersResponse::GroupIdHasBeenSet() const
{
