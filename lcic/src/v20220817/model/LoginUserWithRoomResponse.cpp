...
LoginUserWithRoomResponse::LoginUserWithRoomResponse() :
    m_userIdHasBeenSet(false),
    m_tokenHasBeenSet(false)
{
}

CoreInternalOutcome LoginUserWithRoomResponse::Deserialize(const string &payload)
{
...
string LoginUserWithRoomResponse::ToJsonString() const
{
...
string LoginUserWithRoomResponse::GetUserId() const
{
    return m_userId;
}

bool LoginUserWithRoomResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string LoginUserWithRoomResponse::GetToken() const
{
    return m_token;
}

bool LoginUserWithRoomResponse::TokenHasBeenSet() const
{
