...
CoreInternalOutcome GetRoomMessageResponse::Deserialize(const string &payload)
{
...
string GetRoomMessageResponse::ToJsonString() const
{
...
vector<MessageList> GetRoomMessageResponse::GetMessages() const
{
    return m_messages;
}

bool GetRoomMessageResponse::MessagesHasBeenSet() const
{
