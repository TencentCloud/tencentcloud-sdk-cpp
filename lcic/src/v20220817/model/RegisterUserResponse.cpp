...
CoreInternalOutcome RegisterUserResponse::Deserialize(const string &payload)
{
...
string RegisterUserResponse::ToJsonString() const
{
...
string RegisterUserResponse::GetUserId() const
{
    return m_userId;
}

bool RegisterUserResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string RegisterUserResponse::GetToken() const
{
    return m_token;
}

bool RegisterUserResponse::TokenHasBeenSet() const
{
