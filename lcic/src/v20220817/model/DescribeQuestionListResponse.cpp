...
CoreInternalOutcome DescribeQuestionListResponse::Deserialize(const string &payload)
{
...
string DescribeQuestionListResponse::ToJsonString() const
{
...
uint64_t DescribeQuestionListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeQuestionListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<QuestionInfo> DescribeQuestionListResponse::GetQuestionInfo() const
{
    return m_questionInfo;
}

bool DescribeQuestionListResponse::QuestionInfoHasBeenSet() const
{
