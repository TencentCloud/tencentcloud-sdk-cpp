...
CoreInternalOutcome LoginUserResponse::Deserialize(const string &payload)
{
...
string LoginUserResponse::ToJsonString() const
{
...
string LoginUserResponse::GetUserId() const
{
    return m_userId;
}

bool LoginUserResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string LoginUserResponse::GetToken() const
{
    return m_token;
}

bool LoginUserResponse::TokenHasBeenSet() const
{
