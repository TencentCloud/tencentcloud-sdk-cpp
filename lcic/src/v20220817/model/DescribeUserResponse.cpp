...
uint64_t DescribeUserResponse::GetSdkAppId() const
{
    return m_sdkAppId;
}

bool DescribeUserResponse::SdkAppIdHasBeenSet() const
{
    return m_sdkAppIdHasBeenSet;
}

string DescribeUserResponse::GetUserId() const
{
    return m_userId;
}

bool DescribeUserResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string DescribeUserResponse::GetName() const
{
    return m_name;
}

bool DescribeUserResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string DescribeUserResponse::GetAvatar() const
{
    return m_avatar;
}
