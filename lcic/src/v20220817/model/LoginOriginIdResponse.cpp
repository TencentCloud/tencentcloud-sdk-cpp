...
CoreInternalOutcome LoginOriginIdResponse::Deserialize(const string &payload)
{
...
string LoginOriginIdResponse::ToJsonString() const
{
...
string LoginOriginIdResponse::GetUserId() const
{
    return m_userId;
}

bool LoginOriginIdResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string LoginOriginIdResponse::GetToken() const
{
    return m_token;
}

bool LoginOriginIdResponse::TokenHasBeenSet() const
{
