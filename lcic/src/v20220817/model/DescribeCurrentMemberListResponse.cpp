...
CoreInternalOutcome DescribeCurrentMemberListResponse::Deserialize(const string &payload)
{
...
string DescribeCurrentMemberListResponse::ToJsonString() const
{
...
uint64_t DescribeCurrentMemberListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCurrentMemberListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<MemberRecord> DescribeCurrentMemberListResponse::GetMemberRecords() const
{
    return m_memberRecords;
}

bool DescribeCurrentMemberListResponse::MemberRecordsHasBeenSet() const
{
