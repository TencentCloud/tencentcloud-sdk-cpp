...
#ifndef TENCENTCLOUD_LCIC_V20220817_MODEL_GETEDITVERSIONTOKENREQUEST_H_
#define TENCENTCLOUD_LCIC_V20220817_MODEL_GETEDITVERSIONTOKENREQUEST_H_
    ...
    namespace Lcic
    {
        namespace V20220817
        {
            namespace Model
            {
                ...
                */
                class GetEditVersionTokenRequest : public AbstractModel
                {
                public:
                    GetEditVersionTokenRequest();
                    ~GetEditVersionTokenRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>实时互动-教育版的SdkAppId。</p>
                    ...
                    /**
                     * 获取<p>token过期时间，0代表无过期时间，单位毫秒。</p>
                    ...
                    /**
                     * 设置<p>token过期时间，0代表无过期时间，单位毫秒。</p>
...
#endif // !TENCENTCLOUD_LCIC_V20220817_MODEL_GETEDITVERSIONTOKENREQUEST_H_
