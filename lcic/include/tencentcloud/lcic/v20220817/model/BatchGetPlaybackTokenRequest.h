...
#ifndef TENCENTCLOUD_LCIC_V20220817_MODEL_BATCHGETPLAYBACKTOKENREQUEST_H_
#define TENCENTCLOUD_LCIC_V20220817_MODEL_BATCHGETPLAYBACKTOKENREQUEST_H_
    ...
    namespace Lcic
    {
        namespace V20220817
        {
            namespace Model
            {
                ...
                */
                class BatchGetPlaybackTokenRequest : public AbstractModel
                {
                public:
                    BatchGetPlaybackTokenRequest();
                    ~BatchGetPlaybackTokenRequest() = default;
...
#endif // !TENCENTCLOUD_LCIC_V20220817_MODEL_BATCHGETPLAYBACKTOKENREQUEST_H_
