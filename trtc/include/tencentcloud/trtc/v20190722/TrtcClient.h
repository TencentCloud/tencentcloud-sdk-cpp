    ...
    namespace Trtc
    {
        namespace V20190722
        {
            ...
            public:
                ...
                typedef Outcome<Error, Model::StartMCUMixTranscodeByStrRoomIdResponse> StartMCUMixTranscodeByStrRoomIdOutcome;
                ...
                typedef Outcome<Error, Model::StopMCUMixTranscodeByStrRoomIdResponse> StopMCUMixTranscodeByStrRoomIdOutcome;
