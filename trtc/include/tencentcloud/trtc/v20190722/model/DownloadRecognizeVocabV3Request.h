...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DOWNLOADRECOGNIZEVOCABV3REQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DOWNLOADRECOGNIZEVOCABV3REQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DownloadRecognizeVocabV3Request : public AbstractModel
                {
                public:
                    DownloadRecognizeVocabV3Request();
                    ~DownloadRecognizeVocabV3Request() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DOWNLOADRECOGNIZEVOCABV3REQUEST_H_
