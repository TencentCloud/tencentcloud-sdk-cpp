...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMEQUALITYDATAREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMEQUALITYDATAREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCRealTimeQualityDataRequest : public AbstractModel
                {
                public:
                    DescribeTRTCRealTimeQualityDataRequest();
                    ~DescribeTRTCRealTimeQualityDataRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMEQUALITYDATAREQUEST_H_
