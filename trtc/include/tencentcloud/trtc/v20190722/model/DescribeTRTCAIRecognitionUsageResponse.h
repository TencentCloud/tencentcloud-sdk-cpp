...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGERESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGERESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCAIRecognitionUsageResponse : public AbstractModel
                {
                public:
                    DescribeTRTCAIRecognitionUsageResponse();
                    ~DescribeTRTCAIRecognitionUsageResponse() = default;
                     ...
                     * 
                     */
                    std::vector<double> GetTotalUsage() const;
                ...
                private:
                     ...
                     * 总用量列表
                     */
                    std::vector<double> m_totalUsage;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGERESPONSE_H_
