...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_STARTMCUMIXTRANSCODEREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_STARTMCUMIXTRANSCODEREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class StartMCUMixTranscodeRequest : public AbstractModel
                {
                public:
                    StartMCUMixTranscodeRequest();
                    ~StartMCUMixTranscodeRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_STARTMCUMIXTRANSCODEREQUEST_H_
