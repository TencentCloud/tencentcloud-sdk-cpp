...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCMARKETQUALITYMETRICDATAREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCMARKETQUALITYMETRICDATAREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCMarketQualityMetricDataRequest : public AbstractModel
                {
                public:
                    DescribeTRTCMarketQualityMetricDataRequest();
                    ~DescribeTRTCMarketQualityMetricDataRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCMARKETQUALITYMETRICDATAREQUEST_H_
