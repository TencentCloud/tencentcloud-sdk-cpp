...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_MEASURETRTCMCUEXTERNALREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_MEASURETRTCMCUEXTERNALREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class MeasureTrtcMcuExternalRequest : public AbstractModel
                {
                public:
                    MeasureTrtcMcuExternalRequest();
                    ~MeasureTrtcMcuExternalRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_MEASURETRTCMCUEXTERNALREQUEST_H_
