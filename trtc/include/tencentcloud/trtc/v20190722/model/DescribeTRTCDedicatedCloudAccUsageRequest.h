...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGEREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGEREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCDedicatedCloudAccUsageRequest : public AbstractModel
                {
                public:
                    DescribeTRTCDedicatedCloudAccUsageRequest();
                    ~DescribeTRTCDedicatedCloudAccUsageRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGEREQUEST_H_
