...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEREALTIMENETWORKREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEREALTIMENETWORKREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeRealtimeNetworkRequest : public AbstractModel
                {
                public:
                    DescribeRealtimeNetworkRequest();
                    ~DescribeRealtimeNetworkRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEREALTIMENETWORKREQUEST_H_
