...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_REGISTERVOICEPRINTREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_REGISTERVOICEPRINTREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取整个wav音频文件的base64字符串,其中wav文件限定为16k或8k采样率, 16bit位深, 单声道, 8到18秒有效音频时长,编码数据大小不超过2M
                    ...
                    /**
                     * 设置整个wav音频文件的base64字符串,其中wav文件限定为16k或8k采样率, 16bit位深, 单声道, 8到18秒有效音频时长,编码数据大小不超过2M
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_REGISTERVOICEPRINTREQUEST_H_
