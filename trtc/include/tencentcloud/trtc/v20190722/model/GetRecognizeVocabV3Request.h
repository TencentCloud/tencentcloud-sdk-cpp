...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_GETRECOGNIZEVOCABV3REQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_GETRECOGNIZEVOCABV3REQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class GetRecognizeVocabV3Request : public AbstractModel
                {
                public:
                    GetRecognizeVocabV3Request();
                    ~GetRecognizeVocabV3Request() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_GETRECOGNIZEVOCABV3REQUEST_H_
