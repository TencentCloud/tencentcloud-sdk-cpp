...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_SETVOCABSTATEV3REQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_SETVOCABSTATEV3REQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class SetVocabStateV3Request : public AbstractModel
                {
                public:
                    SetVocabStateV3Request();
                    ~SetVocabStateV3Request() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_SETVOCABSTATEV3REQUEST_H_
