...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEABNORMALEVENTRESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEABNORMALEVENTRESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeAbnormalEventResponse : public AbstractModel
                {
                public:
                    DescribeAbnormalEventResponse();
                    ~DescribeAbnormalEventResponse() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEABNORMALEVENTRESPONSE_H_
