...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGEREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGEREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCAIRecognitionUsageRequest : public AbstractModel
                {
                public:
                    DescribeTRTCAIRecognitionUsageRequest();
                    ~DescribeTRTCAIRecognitionUsageRequest() = default;
...
- tts 实时语音合成
                     * 
                     */
                    std::vector<std::string> GetAuType() const;
...
- tts 实时语音合成
                     * 
                     */
                    void SetAuType(const std::vector<std::string>& _auType);
...
- tts 实时语音合成
                     */
                    std::vector<std::string> m_auType;
                    bool m_auTypeHasBeenSet;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCAIRECOGNITIONUSAGEREQUEST_H_
