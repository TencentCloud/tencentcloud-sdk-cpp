...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_MODERATIONSTORAGEPARAMS_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_MODERATIONSTORAGEPARAMS_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                * 审核存储参数
                */
                class ModerationStorageParams : public AbstractModel
                {
                public:
                    ModerationStorageParams();
                    ~ModerationStorageParams() = default;
                     ...
                     * @return CloudModerationStorage 腾讯云对象存储COS以及第三方云存储的账号信息
                     * 
                     */
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_MODERATIONSTORAGEPARAMS_H_
