...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBESTREAMINGESTREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBESTREAMINGESTREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamIngestRequest : public AbstractModel
                {
                public:
                    DescribeStreamIngestRequest();
                    ~DescribeStreamIngestRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBESTREAMINGESTREQUEST_H_
