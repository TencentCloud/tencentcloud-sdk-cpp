...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDSLICETASKREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDSLICETASKREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudSliceTaskRequest : public AbstractModel
                {
                public:
                    DeleteCloudSliceTaskRequest();
                    ~DeleteCloudSliceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDSLICETASKREQUEST_H_
