...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DELETELIVESTREAMMODERATIONREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DELETELIVESTREAMMODERATIONREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DeleteLiveStreamModerationRequest : public AbstractModel
                {
                public:
                    DeleteLiveStreamModerationRequest();
                    ~DeleteLiveStreamModerationRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DELETELIVESTREAMMODERATIONREQUEST_H_
