...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDMODERATIONSTORAGE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDMODERATIONSTORAGE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class CloudModerationStorage : public AbstractModel
                {
                public:
                    CloudModerationStorage();
                    ~CloudModerationStorage() = default;
...
示例值：test-secretkey
                    ...
                    /**
                     * 获取云存储bucket 的指定位置，由字符串数组组成。合法的字符串范围az,AZ,0~9,'_'和'-'，举个例子，切片文件xxx.mp3在 ["prefix1", "prefix2"]作用下，音频切片文件会变成prefix1/prefix2/{taskId}/{userId}/audios/{sdkappid}_{roomId}_{userid}_{UTC时间}.ogg，视频截帧会变成prefix1/prefix2/{taskId}/{userId}/images/{sdkappid}_{roomId}_{userid}_{UTC时间}.png 
                    ...
                    /**
                     * 设置云存储bucket 的指定位置，由字符串数组组成。合法的字符串范围az,AZ,0~9,'_'和'-'，举个例子，切片文件xxx.mp3在 ["prefix1", "prefix2"]作用下，音频切片文件会变成prefix1/prefix2/{taskId}/{userId}/audios/{sdkappid}_{roomId}_{userid}_{UTC时间}.ogg，视频截帧会变成prefix1/prefix2/{taskId}/{userId}/images/{sdkappid}_{roomId}_{userid}_{UTC时间}.png 
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDMODERATIONSTORAGE_H_
