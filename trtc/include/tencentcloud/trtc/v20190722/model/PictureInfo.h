...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_PICTUREINFO_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_PICTUREINFO_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                * 图片列表信息
                */
                class PictureInfo : public AbstractModel
                {
                public:
                    PictureInfo();
                    ~PictureInfo() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_PICTUREINFO_H_
