...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DELETERECOGNIZEVOCABV3REQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DELETERECOGNIZEVOCABV3REQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DeleteRecognizeVocabV3Request : public AbstractModel
                {
                public:
                    DeleteRecognizeVocabV3Request();
                    ~DeleteRecognizeVocabV3Request() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DELETERECOGNIZEVOCABV3REQUEST_H_
