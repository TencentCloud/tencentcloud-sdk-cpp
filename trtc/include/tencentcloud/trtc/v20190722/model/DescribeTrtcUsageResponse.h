...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGERESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGERESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTrtcUsageResponse : public AbstractModel
                {
                public:
                    DescribeTrtcUsageResponse();
                    ~DescribeTrtcUsageResponse() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGERESPONSE_H_
