...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGERESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGERESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCDedicatedCloudAccUsageResponse : public AbstractModel
                {
                public:
                    DescribeTRTCDedicatedCloudAccUsageResponse();
                    ~DescribeTRTCDedicatedCloudAccUsageResponse() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCDEDICATEDCLOUDACCUSAGERESPONSE_H_
