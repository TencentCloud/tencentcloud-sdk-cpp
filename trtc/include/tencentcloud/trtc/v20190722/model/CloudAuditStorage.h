...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDAUDITSTORAGE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDAUDITSTORAGE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class CloudAuditStorage : public AbstractModel
                {
                public:
                    CloudAuditStorage();
                    ~CloudAuditStorage() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_CLOUDAUDITSTORAGE_H_
