...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBELIVESTREAMMODERATIONRESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBELIVESTREAMMODERATIONRESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeLiveStreamModerationResponse : public AbstractModel
                {
                public:
                    DescribeLiveStreamModerationResponse();
                    ~DescribeLiveStreamModerationResponse() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBELIVESTREAMMODERATIONRESPONSE_H_
