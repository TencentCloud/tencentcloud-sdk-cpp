...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_ONESDKAPPIDTRANSCODETIMEUSAGESNEWINFO_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_ONESDKAPPIDTRANSCODETIMEUSAGESNEWINFO_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                * 旁路转码时长的查询结果
                */
                class OneSdkAppIdTranscodeTimeUsagesNewInfo : public AbstractModel
                {
                public:
                    OneSdkAppIdTranscodeTimeUsagesNewInfo();
                    ~OneSdkAppIdTranscodeTimeUsagesNewInfo() = default;
                     ...
                     */
                    std::vector<SdkAppIdTrtcMcuTranscodeTimeNewUsage> GetSdkAppIdTranscodeTimeUsages() const;

                    /**
                     * 设置旁路转码时长查询结果数组
                     * @param SdkAppIdTranscodeTimeUsages 旁路转码时长查询结果数组
                     */
                    void SetSdkAppIdTranscodeTimeUsages(const std::vector<SdkAppIdTrtcMcuTranscodeTimeNewUsage>& _sdkAppIdTranscodeTimeUsages);
                ...
                private:
                     ...
                     * 旁路转码时长查询结果数组
                     */
                    std::vector<SdkAppIdTrtcMcuTranscodeTimeNewUsage> m_sdkAppIdTranscodeTimeUsages;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_ONESDKAPPIDTRANSCODETIMEUSAGESNEWINFO_H_
