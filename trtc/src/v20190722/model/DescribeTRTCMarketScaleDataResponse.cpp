...
CoreInternalOutcome DescribeTRTCMarketScaleDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCMarketScaleDataResponse::ToJsonString() const
{
...
TRTCDataResult DescribeTRTCMarketScaleDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCMarketScaleDataResponse::DataHasBeenSet() const
{
