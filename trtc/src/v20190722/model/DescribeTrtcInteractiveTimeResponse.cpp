...
CoreInternalOutcome DescribeTrtcInteractiveTimeResponse::Deserialize(const string &payload)
{
...
string DescribeTrtcInteractiveTimeResponse::ToJsonString() const
{
...
vector<OneSdkAppIdUsagesInfo> DescribeTrtcInteractiveTimeResponse::GetUsages() const
{
    return m_usages;
}

bool DescribeTrtcInteractiveTimeResponse::UsagesHasBeenSet() const
{
