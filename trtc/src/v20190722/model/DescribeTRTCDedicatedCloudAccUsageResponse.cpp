...
DescribeTRTCDedicatedCloudAccUsageResponse::DescribeTRTCDedicatedCloudAccUsageResponse() :
...
CoreInternalOutcome DescribeTRTCDedicatedCloudAccUsageResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCDedicatedCloudAccUsageResponse::ToJsonString() const
{
...
vector<string> DescribeTRTCDedicatedCloudAccUsageResponse::GetUsageKey() const
{
    return m_usageKey;
}

bool DescribeTRTCDedicatedCloudAccUsageResponse::UsageKeyHasBeenSet() const
{
    return m_usageKeyHasBeenSet;
}

vector<UsageList> DescribeTRTCDedicatedCloudAccUsageResponse::GetUsageList() const
{
    return m_usageList;
}

bool DescribeTRTCDedicatedCloudAccUsageResponse::UsageListHasBeenSet() const
{
    return m_usageListHasBeenSet;
}

vector<uint64_t> DescribeTRTCDedicatedCloudAccUsageResponse::GetTotalUsage() const
{
    return m_totalUsage;
}

bool DescribeTRTCDedicatedCloudAccUsageResponse::TotalUsageHasBeenSet() const
{
