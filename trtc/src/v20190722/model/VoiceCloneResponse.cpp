...
CoreInternalOutcome VoiceCloneResponse::Deserialize(const string &payload)
{
...
string VoiceCloneResponse::ToJsonString() const
{
...
string VoiceCloneResponse::GetVoiceId() const
{
    return m_voiceId;
}

bool VoiceCloneResponse::VoiceIdHasBeenSet() const
{
