...
CoreInternalOutcome DescribeRecordingUsageResponse::Deserialize(const string &payload)
{
...
string DescribeRecordingUsageResponse::ToJsonString() const
{
...
vector<string> DescribeRecordingUsageResponse::GetUsageKey() const
{
    return m_usageKey;
}

bool DescribeRecordingUsageResponse::UsageKeyHasBeenSet() const
{
    return m_usageKeyHasBeenSet;
}

vector<TrtcUsage> DescribeRecordingUsageResponse::GetUsageList() const
{
    return m_usageList;
}

bool DescribeRecordingUsageResponse::UsageListHasBeenSet() const
{
