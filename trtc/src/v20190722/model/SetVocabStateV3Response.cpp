...
SetVocabStateV3Response::SetVocabStateV3Response() :
    m_vocabIdHasBeenSet(false)
{
}

CoreInternalOutcome SetVocabStateV3Response::Deserialize(const string &payload)
{
...
string SetVocabStateV3Response::ToJsonString() const
{
...
string SetVocabStateV3Response::GetVocabId() const
{
    return m_vocabId;
}

bool SetVocabStateV3Response::VocabIdHasBeenSet() const
{
