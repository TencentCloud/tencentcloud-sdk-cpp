...
CoreInternalOutcome DescribeAITranscriptionResponse::Deserialize(const string &payload)
{
...
string DescribeAITranscriptionResponse::ToJsonString() const
{
...
string DescribeAITranscriptionResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeAITranscriptionResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeAITranscriptionResponse::GetStatus() const
{
    return m_status;
}
