...
CoreInternalOutcome DescribeRelayUsageResponse::Deserialize(const string &payload)
{
...
string DescribeRelayUsageResponse::ToJsonString() const
{
...
vector<string> DescribeRelayUsageResponse::GetUsageKey() const
{
    return m_usageKey;
}

bool DescribeRelayUsageResponse::UsageKeyHasBeenSet() const
{
    return m_usageKeyHasBeenSet;
}

vector<TrtcUsage> DescribeRelayUsageResponse::GetUsageList() const
{
    return m_usageList;
}

bool DescribeRelayUsageResponse::UsageListHasBeenSet() const
{
