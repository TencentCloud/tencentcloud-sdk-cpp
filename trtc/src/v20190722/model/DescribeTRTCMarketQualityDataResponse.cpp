...
CoreInternalOutcome DescribeTRTCMarketQualityDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCMarketQualityDataResponse::ToJsonString() const
{
...
TRTCDataResult DescribeTRTCMarketQualityDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCMarketQualityDataResponse::DataHasBeenSet() const
{
