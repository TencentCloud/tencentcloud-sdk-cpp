...
UpdateRecognizeVocabV3Response::UpdateRecognizeVocabV3Response() :
    m_vocabIdHasBeenSet(false)
{
}

CoreInternalOutcome UpdateRecognizeVocabV3Response::Deserialize(const string &payload)
{
...
string UpdateRecognizeVocabV3Response::ToJsonString() const
{
...
string UpdateRecognizeVocabV3Response::GetVocabId() const
{
    return m_vocabId;
}

bool UpdateRecognizeVocabV3Response::VocabIdHasBeenSet() const
{
