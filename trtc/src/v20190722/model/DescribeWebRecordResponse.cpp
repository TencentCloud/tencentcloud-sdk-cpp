...
CoreInternalOutcome DescribeWebRecordResponse::Deserialize(const string &payload)
{
...
string DescribeWebRecordResponse::ToJsonString() const
{
...
int64_t DescribeWebRecordResponse::GetStatus() const
{
    return m_status;
}
