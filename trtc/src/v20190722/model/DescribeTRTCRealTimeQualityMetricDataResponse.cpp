...
CoreInternalOutcome DescribeTRTCRealTimeQualityMetricDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCRealTimeQualityMetricDataResponse::ToJsonString() const
{
...
TRTCDataResp DescribeTRTCRealTimeQualityMetricDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCRealTimeQualityMetricDataResponse::DataHasBeenSet() const
{
