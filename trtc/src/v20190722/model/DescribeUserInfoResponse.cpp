...
uint64_t DescribeUserInfoResponse::GetTotal() const
{
    return m_total;
}

bool DescribeUserInfoResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<UserInformation> DescribeUserInfoResponse::GetUserList() const
{
    return m_userList;
}

bool DescribeUserInfoResponse::UserListHasBeenSet() const
{
