...
CoreInternalOutcome DescribeTRTCRealTimeQualityDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCRealTimeQualityDataResponse::ToJsonString() const
{
...
TRTCDataResult DescribeTRTCRealTimeQualityDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCRealTimeQualityDataResponse::DataHasBeenSet() const
{
