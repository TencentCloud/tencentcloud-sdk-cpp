...
CoreInternalOutcome UsageList::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TimeKey") && !value["TimeKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UsageList.TimeKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UsageValue") && !value["UsageValue"].IsNull())
    {
        if (!value["UsageValue"].IsArray())
            return CoreInternalOutcome(Core::Error("response `UsageList.UsageValue` is not array type"));
...
void UsageList::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string UsageList::GetTimeKey() const
{
    return m_timeKey;
}

void UsageList::SetTimeKey(const string& _timeKey)
{
    m_timeKey = _timeKey;
    m_timeKeyHasBeenSet = true;
}

bool UsageList::TimeKeyHasBeenSet() const
{
    return m_timeKeyHasBeenSet;
}

vector<double> UsageList::GetUsageValue() const
{
    return m_usageValue;
}

void UsageList::SetUsageValue(const vector<double>& _usageValue)
{
    m_usageValue = _usageValue;
    m_usageValueHasBeenSet = true;
}

bool UsageList::UsageValueHasBeenSet() const
{
