...
string TextToSpeechSSERequest::GetModel() const
{
    return m_model;
}

void TextToSpeechSSERequest::SetModel(const string& _model)
{
    m_model = _model;
    m_modelHasBeenSet = true;
}

bool TextToSpeechSSERequest::ModelHasBeenSet() const
{
    return m_modelHasBeenSet;
}

string TextToSpeechSSERequest::GetLanguage() const
{
    return m_language;
}

void TextToSpeechSSERequest::SetLanguage(const string& _language)
{
    m_language = _language;
    m_languageHasBeenSet = true;
}

bool TextToSpeechSSERequest::LanguageHasBeenSet() const
{
    return m_languageHasBeenSet;
}

vector<PronunciationDict> TextToSpeechSSERequest::GetPronunciationDict() const
{
    return m_pronunciationDict;
}

void TextToSpeechSSERequest::SetPronunciationDict(const vector<PronunciationDict>& _pronunciationDict)
{
    m_pronunciationDict = _pronunciationDict;
    m_pronunciationDictHasBeenSet = true;
}

bool TextToSpeechSSERequest::PronunciationDictHasBeenSet() const
{
    return m_pronunciationDictHasBeenSet;
}

uint64_t TextToSpeechSSERequest::GetAlignmentMode() const
{
    return m_alignmentMode;
}

void TextToSpeechSSERequest::SetAlignmentMode(const uint64_t& _alignmentMode)
{
