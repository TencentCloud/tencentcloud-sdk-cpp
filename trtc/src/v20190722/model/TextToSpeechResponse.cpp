...
CoreInternalOutcome TextToSpeechResponse::Deserialize(const string &payload)
{
...
string TextToSpeechResponse::ToJsonString() const
{
...
string TextToSpeechResponse::GetAudio() const
{
    return m_audio;
}
