...
CoreInternalOutcome StopMCUMixTranscodeByStrRoomIdResponse::Deserialize(const string &payload)
{
...
string StopMCUMixTranscodeByStrRoomIdResponse::ToJsonString() const
{
