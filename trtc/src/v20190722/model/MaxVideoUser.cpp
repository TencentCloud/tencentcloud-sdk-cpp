...
CoreInternalOutcome MaxVideoUser::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("UserMediaStream") && !value["UserMediaStream"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MaxVideoUser.UserMediaStream` is not object type").SetRequestId(requestId));
        }
...
void MaxVideoUser::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
UserMediaStream MaxVideoUser::GetUserMediaStream() const
{
    return m_userMediaStream;
}

void MaxVideoUser::SetUserMediaStream(const UserMediaStream& _userMediaStream)
{
    m_userMediaStream = _userMediaStream;
    m_userMediaStreamHasBeenSet = true;
}

bool MaxVideoUser::UserMediaStreamHasBeenSet() const
{
