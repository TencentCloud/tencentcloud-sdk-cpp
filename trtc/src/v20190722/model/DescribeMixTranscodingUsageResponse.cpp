...
CoreInternalOutcome DescribeMixTranscodingUsageResponse::Deserialize(const string &payload)
{
...
string DescribeMixTranscodingUsageResponse::ToJsonString() const
{
...
vector<string> DescribeMixTranscodingUsageResponse::GetUsageKey() const
{
    return m_usageKey;
}

bool DescribeMixTranscodingUsageResponse::UsageKeyHasBeenSet() const
{
    return m_usageKeyHasBeenSet;
}

vector<TrtcUsage> DescribeMixTranscodingUsageResponse::GetUsageList() const
{
    return m_usageList;
}

bool DescribeMixTranscodingUsageResponse::UsageListHasBeenSet() const
{
