...
CoreInternalOutcome StartMCUMixTranscodeByStrRoomIdResponse::Deserialize(const string &payload)
{
...
string StartMCUMixTranscodeByStrRoomIdResponse::ToJsonString() const
{
