...
DescribeTRTCSegmentModerationUsageResponse::DescribeTRTCSegmentModerationUsageResponse() :
...
CoreInternalOutcome DescribeTRTCSegmentModerationUsageResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["TotalUsage"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TotalUsage` is not array type"));

        const rapidjson::Value &tmpValue = rsp["TotalUsage"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            m_totalUsage.push_back((*itr).GetUint64());
        }
...
string DescribeTRTCSegmentModerationUsageResponse::ToJsonString() const
{
    ...
    if (m_totalUsageHasBeenSet)
    {
        ...
        for (auto itr = m_totalUsage.begin(); itr != m_totalUsage.end(); ++itr)
        {
...
vector<string> DescribeTRTCSegmentModerationUsageResponse::GetUsageKey() const
{
    return m_usageKey;
}

bool DescribeTRTCSegmentModerationUsageResponse::UsageKeyHasBeenSet() const
{
    return m_usageKeyHasBeenSet;
}

vector<UsageList> DescribeTRTCSegmentModerationUsageResponse::GetUsageList() const
{
    return m_usageList;
}

bool DescribeTRTCSegmentModerationUsageResponse::UsageListHasBeenSet() const
{
    return m_usageListHasBeenSet;
}

vector<uint64_t> DescribeTRTCSegmentModerationUsageResponse::GetTotalUsage() const
{
    return m_totalUsage;
}

bool DescribeTRTCSegmentModerationUsageResponse::TotalUsageHasBeenSet() const
{
