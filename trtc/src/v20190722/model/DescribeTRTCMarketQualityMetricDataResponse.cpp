...
CoreInternalOutcome DescribeTRTCMarketQualityMetricDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCMarketQualityMetricDataResponse::ToJsonString() const
{
...
TRTCDataResp DescribeTRTCMarketQualityMetricDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCMarketQualityMetricDataResponse::DataHasBeenSet() const
{
