...
CoreInternalOutcome DescribeTRTCRealTimeScaleDataResponse::Deserialize(const string &payload)
{
...
string DescribeTRTCRealTimeScaleDataResponse::ToJsonString() const
{
...
TRTCDataResult DescribeTRTCRealTimeScaleDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTRTCRealTimeScaleDataResponse::DataHasBeenSet() const
{
