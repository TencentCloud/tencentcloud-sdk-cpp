...
CoreInternalOutcome TextToObjectResponse::Deserialize(const string &payload)
{
...
string TextToObjectResponse::ToJsonString() const
{
...
Template TextToObjectResponse::GetTemplate() const
{
    return m_template;
}

bool TextToObjectResponse::TemplateHasBeenSet() const
{
