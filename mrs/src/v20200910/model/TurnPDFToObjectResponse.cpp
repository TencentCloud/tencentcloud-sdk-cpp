...
TurnPDFToObjectResponse::TurnPDFToObjectResponse() :
...
CoreInternalOutcome TurnPDFToObjectResponse::Deserialize(const string &payload)
{
...
string TurnPDFToObjectResponse::ToJsonString() const
{
...
Template TurnPDFToObjectResponse::GetTemplate() const
{
    return m_template;
}

bool TurnPDFToObjectResponse::TemplateHasBeenSet() const
{
    return m_templateHasBeenSet;
}

vector<TextType> TurnPDFToObjectResponse::GetTextTypeList() const
{
    return m_textTypeList;
}

bool TurnPDFToObjectResponse::TextTypeListHasBeenSet() const
{
    return m_textTypeListHasBeenSet;
}

Block TurnPDFToObjectResponse::GetBlock() const
{
    return m_block;
}

bool TurnPDFToObjectResponse::BlockHasBeenSet() const
{
    return m_blockHasBeenSet;
}

bool TurnPDFToObjectResponse::GetIsBlock() const
{
    return m_isBlock;
}

bool TurnPDFToObjectResponse::IsBlockHasBeenSet() const
{
