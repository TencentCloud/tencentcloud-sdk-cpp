...
CoreInternalOutcome ImageToClassResponse::Deserialize(const string &payload)
{
...
string ImageToClassResponse::ToJsonString() const
{
...
vector<TextType> ImageToClassResponse::GetTextTypeList() const
{
    return m_textTypeList;
}

bool ImageToClassResponse::TextTypeListHasBeenSet() const
{
