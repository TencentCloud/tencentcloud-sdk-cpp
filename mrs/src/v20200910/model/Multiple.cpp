...
CoreInternalOutcome Multiple::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void Multiple::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<int64_t> Multiple::GetIndex() const
{
    return m_index;
}

void Multiple::SetIndex(const vector<int64_t>& _index)
{
    m_index = _index;
    m_indexHasBeenSet = true;
}

bool Multiple::IndexHasBeenSet() const
{
    return m_indexHasBeenSet;
}

string Multiple::GetSrc() const
{
    return m_src;
}

void Multiple::SetSrc(const string& _src)
{
    m_src = _src;
    m_srcHasBeenSet = true;
}

bool Multiple::SrcHasBeenSet() const
{
    return m_srcHasBeenSet;
}

string Multiple::GetValue() const
{
    return m_value;
}

void Multiple::SetValue(const string& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool Multiple::ValueHasBeenSet() const
{
    return m_valueHasBeenSet;
}

int64_t Multiple::GetCount() const
{
    return m_count;
}

void Multiple::SetCount(const int64_t& _count)
{
    m_count = _count;
    m_countHasBeenSet = true;
}

bool Multiple::CountHasBeenSet() const
{
    return m_countHasBeenSet;
}

string Multiple::GetName() const
{
    return m_name;
}

void Multiple::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool Multiple::NameHasBeenSet() const
{
