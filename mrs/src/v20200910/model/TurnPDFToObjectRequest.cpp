...
string TurnPDFToObjectRequest::ToJsonString() const
{
...
PdfInfo TurnPDFToObjectRequest::GetPdfInfo() const
{
    return m_pdfInfo;
}

void TurnPDFToObjectRequest::SetPdfInfo(const PdfInfo& _pdfInfo)
{
    m_pdfInfo = _pdfInfo;
