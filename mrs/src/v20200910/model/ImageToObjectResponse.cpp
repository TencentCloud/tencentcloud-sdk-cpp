...
CoreInternalOutcome ImageToObjectResponse::Deserialize(const string &payload)
{
...
string ImageToObjectResponse::ToJsonString() const
{
...
Template ImageToObjectResponse::GetTemplate() const
{
    return m_template;
}
