...
CoreInternalOutcome Elastic::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Index") && !value["Index"].IsNull())
    {
        if (!value["Index"].IsArray())
            return CoreInternalOutcome(Error("response `Elastic.Index` is not array type"));
    ...
    if (value.HasMember("Score") && !value["Score"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Elastic.Score` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Src") && !value["Src"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Elastic.Src` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Elastic.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Elastic.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void Elastic::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_scoreHasBeenSet)
    {
        ...
        string key = "Score";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_score.c_str(), allocator).Move(), allocator);
    }
