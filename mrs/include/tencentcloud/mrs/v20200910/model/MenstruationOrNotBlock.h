...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_MENSTRUATIONORNOTBLOCK_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_MENSTRUATIONORNOTBLOCK_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 是否绝经
                */
                class MenstruationOrNotBlock : public AbstractModel
                {
                public:
                    MenstruationOrNotBlock();
                    ~MenstruationOrNotBlock() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_MENSTRUATIONORNOTBLOCK_H_
