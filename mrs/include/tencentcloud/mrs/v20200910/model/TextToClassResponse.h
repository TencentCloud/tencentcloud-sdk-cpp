...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_TEXTTOCLASSRESPONSE_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_TEXTTOCLASSRESPONSE_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * TextToClass返回参数结构体
                */
                class TextToClassResponse : public AbstractModel
                {
                public:
                    TextToClassResponse();
                    ~TextToClassResponse() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_TEXTTOCLASSRESPONSE_H_
