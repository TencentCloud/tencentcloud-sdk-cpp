...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_CHESTCIRCUMFERENCEITEM_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_CHESTCIRCUMFERENCEITEM_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 体检报告-胸围信息
                */
                class ChestCircumferenceItem : public AbstractModel
                {
                public:
                    ChestCircumferenceItem();
                    ~ChestCircumferenceItem() = default;
                     ...
                     * 
                     */
                    PhysicalBaseItem GetState() const;
                     ...
                     * 
                     */
                    void SetState(const PhysicalBaseItem& _state);
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_CHESTCIRCUMFERENCEITEM_H_
