...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_TEXTREPORT_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_TEXTREPORT_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 文本类型报告返回结果
                */
                class TextReport : public AbstractModel
                {
                public:
                    TextReport();
                    ~TextReport() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_TEXTREPORT_H_
