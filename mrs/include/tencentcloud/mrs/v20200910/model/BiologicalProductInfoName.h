...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_BIOLOGICALPRODUCTINFONAME_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_BIOLOGICALPRODUCTINFONAME_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 药品名称，包括通用名和商品名
                */
                class BiologicalProductInfoName : public AbstractModel
                {
                public:
                    BiologicalProductInfoName();
                    ~BiologicalProductInfoName() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_BIOLOGICALPRODUCTINFONAME_H_
