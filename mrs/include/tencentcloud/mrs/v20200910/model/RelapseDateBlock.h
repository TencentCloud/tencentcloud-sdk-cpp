...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_RELAPSEDATEBLOCK_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_RELAPSEDATEBLOCK_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 复发时间
                */
                class RelapseDateBlock : public AbstractModel
                {
                public:
                    RelapseDateBlock();
                    ~RelapseDateBlock() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_RELAPSEDATEBLOCK_H_
