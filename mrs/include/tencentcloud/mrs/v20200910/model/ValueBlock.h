...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_VALUEBLOCK_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_VALUEBLOCK_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 值块
                */
                class ValueBlock : public AbstractModel
                {
                public:
                    ValueBlock();
                    ~ValueBlock() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_VALUEBLOCK_H_
