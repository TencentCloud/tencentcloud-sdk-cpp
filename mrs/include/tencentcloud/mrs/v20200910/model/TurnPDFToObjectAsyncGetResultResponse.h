...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTASYNCGETRESULTRESPONSE_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTASYNCGETRESULTRESPONSE_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                */
                class TurnPDFToObjectAsyncGetResultResponse : public AbstractModel
                {
                public:
                    TurnPDFToObjectAsyncGetResultResponse();
                    ~TurnPDFToObjectAsyncGetResultResponse() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTASYNCGETRESULTRESPONSE_H_
