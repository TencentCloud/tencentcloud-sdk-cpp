...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_REPORT_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_REPORT_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 报告类型
                */
                class Report : public AbstractModel
                {
                public:
                    Report();
                    ~Report() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_REPORT_H_
