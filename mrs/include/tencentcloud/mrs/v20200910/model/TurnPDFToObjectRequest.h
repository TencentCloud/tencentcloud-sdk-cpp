...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTREQUEST_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTREQUEST_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                */
                class TurnPDFToObjectRequest : public AbstractModel
                {
                public:
                    TurnPDFToObjectRequest();
                    ~TurnPDFToObjectRequest() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_TURNPDFTOOBJECTREQUEST_H_
