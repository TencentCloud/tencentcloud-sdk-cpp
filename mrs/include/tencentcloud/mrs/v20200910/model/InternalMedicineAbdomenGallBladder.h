...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_INTERNALMEDICINEABDOMENGALLBLADDER_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_INTERNALMEDICINEABDOMENGALLBLADDER_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 体检报告-内科-腹部-胆囊
                */
                class InternalMedicineAbdomenGallBladder : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_INTERNALMEDICINEABDOMENGALLBLADDER_H_
