...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_BASEITEM3_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_BASEITEM3_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 基础类型
                */
                class BaseItem3 : public AbstractModel
                {
                public:
                    BaseItem3();
                    ~BaseItem3() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_BASEITEM3_H_
