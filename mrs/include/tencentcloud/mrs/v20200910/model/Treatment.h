...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_TREATMENT_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_TREATMENT_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 诊治信息
                */
                class Treatment : public AbstractModel
                {
                public:
                    Treatment();
                    ~Treatment() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_TREATMENT_H_
