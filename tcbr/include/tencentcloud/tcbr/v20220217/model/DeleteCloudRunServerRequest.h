...
#ifndef TENCENTCLOUD_TCBR_V20220217_MODEL_DELETECLOUDRUNSERVERREQUEST_H_
#define TENCENTCLOUD_TCBR_V20220217_MODEL_DELETECLOUDRUNSERVERREQUEST_H_
    ...
    namespace Tcbr
    {
        namespace V20220217
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudRunServerRequest : public AbstractModel
                {
                public:
                    DeleteCloudRunServerRequest();
                    ~DeleteCloudRunServerRequest() = default;
...
#endif // !TENCENTCLOUD_TCBR_V20220217_MODEL_DELETECLOUDRUNSERVERREQUEST_H_
