...
CoreInternalOutcome DescribeServerManageTaskResponse::Deserialize(const string &payload)
{
...
string DescribeServerManageTaskResponse::ToJsonString() const
{
...
bool DescribeServerManageTaskResponse::GetIsExist() const
{
    return m_isExist;
}

bool DescribeServerManageTaskResponse::IsExistHasBeenSet() const
{
    return m_isExistHasBeenSet;
}

ServerManageTaskInfo DescribeServerManageTaskResponse::GetTask() const
{
    return m_task;
}

bool DescribeServerManageTaskResponse::TaskHasBeenSet() const
{
