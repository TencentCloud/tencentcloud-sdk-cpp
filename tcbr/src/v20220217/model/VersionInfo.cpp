...
CoreInternalOutcome VersionInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("FlowRatio") && !value["FlowRatio"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.FlowRatio` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CreatedTime") && !value["CreatedTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.CreatedTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UpdatedTime") && !value["UpdatedTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.UpdatedTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BuildId") && !value["BuildId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.BuildId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UploadType") && !value["UploadType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.UploadType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Remark") && !value["Remark"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.Remark` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UrlParam") && !value["UrlParam"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.UrlParam` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Priority") && !value["Priority"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.Priority` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("IsDefaultPriority") && !value["IsDefaultPriority"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.IsDefaultPriority` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FlowParams") && !value["FlowParams"].IsNull())
    {
        if (!value["FlowParams"].IsArray())
            return CoreInternalOutcome(Core::Error("response `VersionInfo.FlowParams` is not array type"));

        const rapidjson::Value &tmpValue = value["FlowParams"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ObjectKVPriority item;
    ...
    if (value.HasMember("MinReplicas") && !value["MinReplicas"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.MinReplicas` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MaxReplicas") && !value["MaxReplicas"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.MaxReplicas` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RunId") && !value["RunId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.RunId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Percent") && !value["Percent"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.Percent` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CurrentReplicas") && !value["CurrentReplicas"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.CurrentReplicas` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Architecture") && !value["Architecture"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VersionInfo.Architecture` IsString=false incorrectly").SetRequestId(requestId));
        }
...
int64_t VersionInfo::GetFlowRatio() const
{
    return m_flowRatio;
}

void VersionInfo::SetFlowRatio(const int64_t& _flowRatio)
{
    m_flowRatio = _flowRatio;
    m_flowRatioHasBeenSet = true;
}

bool VersionInfo::FlowRatioHasBeenSet() const
{
...
string VersionInfo::GetCreatedTime() const
{
    return m_createdTime;
}

void VersionInfo::SetCreatedTime(const string& _createdTime)
{
    m_createdTime = _createdTime;
    m_createdTimeHasBeenSet = true;
}

bool VersionInfo::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string VersionInfo::GetUpdatedTime() const
{
    return m_updatedTime;
}

void VersionInfo::SetUpdatedTime(const string& _updatedTime)
{
    m_updatedTime = _updatedTime;
    m_updatedTimeHasBeenSet = true;
}

bool VersionInfo::UpdatedTimeHasBeenSet() const
{
    return m_updatedTimeHasBeenSet;
}

int64_t VersionInfo::GetBuildId() const
{
    return m_buildId;
}

void VersionInfo::SetBuildId(const int64_t& _buildId)
{
    m_buildId = _buildId;
    m_buildIdHasBeenSet = true;
}

bool VersionInfo::BuildIdHasBeenSet() const
{
    return m_buildIdHasBeenSet;
}

string VersionInfo::GetUploadType() const
{
    return m_uploadType;
}

void VersionInfo::SetUploadType(const string& _uploadType)
{
    m_uploadType = _uploadType;
    m_uploadTypeHasBeenSet = true;
}

bool VersionInfo::UploadTypeHasBeenSet() const
{
    return m_uploadTypeHasBeenSet;
}

string VersionInfo::GetRemark() const
{
    return m_remark;
}

void VersionInfo::SetRemark(const string& _remark)
{
    m_remark = _remark;
    m_remarkHasBeenSet = true;
}

bool VersionInfo::RemarkHasBeenSet() const
{
    return m_remarkHasBeenSet;
}

ObjectKV VersionInfo::GetUrlParam() const
{
    return m_urlParam;
}

void VersionInfo::SetUrlParam(const ObjectKV& _urlParam)
{
    m_urlParam = _urlParam;
    m_urlParamHasBeenSet = true;
}

bool VersionInfo::UrlParamHasBeenSet() const
{
    return m_urlParamHasBeenSet;
}

int64_t VersionInfo::GetPriority() const
{
    return m_priority;
}

void VersionInfo::SetPriority(const int64_t& _priority)
{
    m_priority = _priority;
    m_priorityHasBeenSet = true;
}

bool VersionInfo::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

bool VersionInfo::GetIsDefaultPriority() const
{
    return m_isDefaultPriority;
}

void VersionInfo::SetIsDefaultPriority(const bool& _isDefaultPriority)
{
    m_isDefaultPriority = _isDefaultPriority;
    m_isDefaultPriorityHasBeenSet = true;
}

bool VersionInfo::IsDefaultPriorityHasBeenSet() const
{
    return m_isDefaultPriorityHasBeenSet;
}

vector<ObjectKVPriority> VersionInfo::GetFlowParams() const
{
    return m_flowParams;
}

void VersionInfo::SetFlowParams(const vector<ObjectKVPriority>& _flowParams)
{
    m_flowParams = _flowParams;
    m_flowParamsHasBeenSet = true;
}

bool VersionInfo::FlowParamsHasBeenSet() const
{
    return m_flowParamsHasBeenSet;
}

int64_t VersionInfo::GetMinReplicas() const
{
    return m_minReplicas;
}

void VersionInfo::SetMinReplicas(const int64_t& _minReplicas)
{
    m_minReplicas = _minReplicas;
    m_minReplicasHasBeenSet = true;
}

bool VersionInfo::MinReplicasHasBeenSet() const
{
    return m_minReplicasHasBeenSet;
}

int64_t VersionInfo::GetMaxReplicas() const
{
    return m_maxReplicas;
}

void VersionInfo::SetMaxReplicas(const int64_t& _maxReplicas)
{
    m_maxReplicas = _maxReplicas;
    m_maxReplicasHasBeenSet = true;
}

bool VersionInfo::MaxReplicasHasBeenSet() const
{
    return m_maxReplicasHasBeenSet;
}

string VersionInfo::GetRunId() const
{
    return m_runId;
}

void VersionInfo::SetRunId(const string& _runId)
{
    m_runId = _runId;
    m_runIdHasBeenSet = true;
}

bool VersionInfo::RunIdHasBeenSet() const
{
    return m_runIdHasBeenSet;
}

int64_t VersionInfo::GetPercent() const
{
    return m_percent;
}

void VersionInfo::SetPercent(const int64_t& _percent)
{
    m_percent = _percent;
    m_percentHasBeenSet = true;
}

bool VersionInfo::PercentHasBeenSet() const
{
    return m_percentHasBeenSet;
}

int64_t VersionInfo::GetCurrentReplicas() const
{
    return m_currentReplicas;
}

void VersionInfo::SetCurrentReplicas(const int64_t& _currentReplicas)
{
    m_currentReplicas = _currentReplicas;
    m_currentReplicasHasBeenSet = true;
}

bool VersionInfo::CurrentReplicasHasBeenSet() const
{
    return m_currentReplicasHasBeenSet;
}

string VersionInfo::GetArchitecture() const
{
    return m_architecture;
}

void VersionInfo::SetArchitecture(const string& _architecture)
{
    m_architecture = _architecture;
    m_architectureHasBeenSet = true;
}

bool VersionInfo::ArchitectureHasBeenSet() const
{
