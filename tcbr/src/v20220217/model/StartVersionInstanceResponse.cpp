...
StartVersionInstanceResponse::StartVersionInstanceResponse() :
    m_instanceNameHasBeenSet(false)
{
}

CoreInternalOutcome StartVersionInstanceResponse::Deserialize(const string &payload)
{
...
string StartVersionInstanceResponse::ToJsonString() const
{
...
string StartVersionInstanceResponse::GetInstanceName() const
{
    return m_instanceName;
}

bool StartVersionInstanceResponse::InstanceNameHasBeenSet() const
{
