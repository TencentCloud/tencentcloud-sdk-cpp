...
int64_t SearchClsLogRequest::GetLogType() const
{
    return m_logType;
}

void SearchClsLogRequest::SetLogType(const int64_t& _logType)
{
    m_logType = _logType;
    m_logTypeHasBeenSet = true;
}

bool SearchClsLogRequest::LogTypeHasBeenSet() const
{
