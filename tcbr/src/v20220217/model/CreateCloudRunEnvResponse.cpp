...
CoreInternalOutcome CreateCloudRunEnvResponse::Deserialize(const string &payload)
{
...
string CreateCloudRunEnvResponse::ToJsonString() const
{
...
string CreateCloudRunEnvResponse::GetEnvId() const
{
    return m_envId;
}

bool CreateCloudRunEnvResponse::EnvIdHasBeenSet() const
{
    return m_envIdHasBeenSet;
}

string CreateCloudRunEnvResponse::GetTranId() const
{
    return m_tranId;
}

bool CreateCloudRunEnvResponse::TranIdHasBeenSet() const
{
