...
DescribeCloudRunProcessLogResponse::DescribeCloudRunProcessLogResponse() :
    m_logsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCloudRunProcessLogResponse::Deserialize(const string &payload)
{
...
string DescribeCloudRunProcessLogResponse::ToJsonString() const
{
...
vector<string> DescribeCloudRunProcessLogResponse::GetLogs() const
{
    return m_logs;
}

bool DescribeCloudRunProcessLogResponse::LogsHasBeenSet() const
{
