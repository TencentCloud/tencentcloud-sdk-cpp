...
ChannelCreateOrganizationBatchSignUrlResponse::ChannelCreateOrganizationBatchSignUrlResponse() :
    m_signUrlHasBeenSet(false),
    m_expiredTimeHasBeenSet(false)
{
}

CoreInternalOutcome ChannelCreateOrganizationBatchSignUrlResponse::Deserialize(const string &payload)
{
...
string ChannelCreateOrganizationBatchSignUrlResponse::ToJsonString() const
{
...
string ChannelCreateOrganizationBatchSignUrlResponse::GetSignUrl() const
{
    return m_signUrl;
}

bool ChannelCreateOrganizationBatchSignUrlResponse::SignUrlHasBeenSet() const
{
    return m_signUrlHasBeenSet;
}

int64_t ChannelCreateOrganizationBatchSignUrlResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool ChannelCreateOrganizationBatchSignUrlResponse::ExpiredTimeHasBeenSet() const
{
