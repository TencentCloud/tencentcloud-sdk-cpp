...
bool ChannelCreateBatchQuickSignUrlRequest::GetCanSkipReadFlow() const
{
    return m_canSkipReadFlow;
}

void ChannelCreateBatchQuickSignUrlRequest::SetCanSkipReadFlow(const bool& _canSkipReadFlow)
{
