...
ChannelCreatePreparedPersonalEsignResponse::ChannelCreatePreparedPersonalEsignResponse() :
    m_sealIdHasBeenSet(false)
{
}

CoreInternalOutcome ChannelCreatePreparedPersonalEsignResponse::Deserialize(const string &payload)
{
...
string ChannelCreatePreparedPersonalEsignResponse::ToJsonString() const
{
...
string ChannelCreatePreparedPersonalEsignResponse::GetSealId() const
{
    return m_sealId;
}

bool ChannelCreatePreparedPersonalEsignResponse::SealIdHasBeenSet() const
{
