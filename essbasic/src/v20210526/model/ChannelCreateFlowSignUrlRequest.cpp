...
int64_t ChannelCreateFlowSignUrlRequest::GetExpiredOn() const
{
    return m_expiredOn;
}

void ChannelCreateFlowSignUrlRequest::SetExpiredOn(const int64_t& _expiredOn)
{
    m_expiredOn = _expiredOn;
    m_expiredOnHasBeenSet = true;
}

bool ChannelCreateFlowSignUrlRequest::ExpiredOnHasBeenSet() const
{
