...
CoreInternalOutcome ChannelBatchCancelFlowsResponse::Deserialize(const string &payload)
{
...
string ChannelBatchCancelFlowsResponse::ToJsonString() const
{
...
vector<string> ChannelBatchCancelFlowsResponse::GetFailMessages() const
{
