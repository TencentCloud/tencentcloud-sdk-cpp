...
CoreInternalOutcome ChannelCreateFlowGroupByFilesResponse::Deserialize(const string &payload)
{
...
string ChannelCreateFlowGroupByFilesResponse::ToJsonString() const
{
...
string ChannelCreateFlowGroupByFilesResponse::GetFlowGroupId() const
{
    return m_flowGroupId;
}

bool ChannelCreateFlowGroupByFilesResponse::FlowGroupIdHasBeenSet() const
{
    return m_flowGroupIdHasBeenSet;
}

vector<string> ChannelCreateFlowGroupByFilesResponse::GetFlowIds() const
{
    return m_flowIds;
}

bool ChannelCreateFlowGroupByFilesResponse::FlowIdsHasBeenSet() const
{
    return m_flowIdsHasBeenSet;
}

vector<FlowGroupApprovers> ChannelCreateFlowGroupByFilesResponse::GetApprovers() const
{
    return m_approvers;
}

bool ChannelCreateFlowGroupByFilesResponse::ApproversHasBeenSet() const
{
