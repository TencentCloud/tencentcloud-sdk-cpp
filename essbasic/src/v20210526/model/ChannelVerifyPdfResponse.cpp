...
CoreInternalOutcome ChannelVerifyPdfResponse::Deserialize(const string &payload)
{
...
string ChannelVerifyPdfResponse::ToJsonString() const
{
...
int64_t ChannelVerifyPdfResponse::GetVerifyResult() const
{
    return m_verifyResult;
}

bool ChannelVerifyPdfResponse::VerifyResultHasBeenSet() const
{
    return m_verifyResultHasBeenSet;
}

vector<PdfVerifyResult> ChannelVerifyPdfResponse::GetPdfVerifyResults() const
{
