...
ArchiveDynamicFlowResponse::ArchiveDynamicFlowResponse() :
    m_flowIdHasBeenSet(false),
    m_approversHasBeenSet(false)
{
}

CoreInternalOutcome ArchiveDynamicFlowResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Approvers") && !rsp["Approvers"].IsNull())
    {
        ...
        {
            ChannelArchiveDynamicApproverData item;
...
string ArchiveDynamicFlowResponse::ToJsonString() const
{
...
string ArchiveDynamicFlowResponse::GetFlowId() const
{
    return m_flowId;
}

bool ArchiveDynamicFlowResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

vector<ChannelArchiveDynamicApproverData> ArchiveDynamicFlowResponse::GetApprovers() const
{
    return m_approvers;
}

bool ArchiveDynamicFlowResponse::ApproversHasBeenSet() const
{
