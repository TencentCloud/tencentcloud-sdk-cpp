...
CoreInternalOutcome ChannelCreateMultiFlowSignQRCodeResponse::Deserialize(const string &payload)
{
...
string ChannelCreateMultiFlowSignQRCodeResponse::ToJsonString() const
{
...
SignQrCode ChannelCreateMultiFlowSignQRCodeResponse::GetQrCode() const
{
    return m_qrCode;
}
