...
CoreInternalOutcome GetDownloadFlowUrlResponse::Deserialize(const string &payload)
{
...
string GetDownloadFlowUrlResponse::ToJsonString() const
{
...
string GetDownloadFlowUrlResponse::GetDownLoadUrl() const
{
    return m_downLoadUrl;
}

bool GetDownloadFlowUrlResponse::DownLoadUrlHasBeenSet() const
{
