...
string ChannelCreateSealPolicyResponse::GetSealOperatorVerifyPath() const
{
    return m_sealOperatorVerifyPath;
}

bool ChannelCreateSealPolicyResponse::SealOperatorVerifyPathHasBeenSet() const
{
    return m_sealOperatorVerifyPathHasBeenSet;
}

string ChannelCreateSealPolicyResponse::GetSealOperatorVerifyQrcodeUrl() const
{
    return m_sealOperatorVerifyQrcodeUrl;
}

bool ChannelCreateSealPolicyResponse::SealOperatorVerifyQrcodeUrlHasBeenSet() const
{
