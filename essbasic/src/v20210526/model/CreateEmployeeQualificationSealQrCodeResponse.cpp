...
CreateEmployeeQualificationSealQrCodeResponse::CreateEmployeeQualificationSealQrCodeResponse() :
    m_qrcodeBase64HasBeenSet(false)
{
}

CoreInternalOutcome CreateEmployeeQualificationSealQrCodeResponse::Deserialize(const string &payload)
{
...
string CreateEmployeeQualificationSealQrCodeResponse::ToJsonString() const
{
...
string CreateEmployeeQualificationSealQrCodeResponse::GetQrcodeBase64() const
{
    return m_qrcodeBase64;
}

bool CreateEmployeeQualificationSealQrCodeResponse::QrcodeBase64HasBeenSet() const
{
