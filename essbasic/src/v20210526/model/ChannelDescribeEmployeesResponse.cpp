...
CoreInternalOutcome ChannelDescribeEmployeesResponse::Deserialize(const string &payload)
{
...
string ChannelDescribeEmployeesResponse::ToJsonString() const
{
...
vector<Staff> ChannelDescribeEmployeesResponse::GetEmployees() const
{
    return m_employees;
}

bool ChannelDescribeEmployeesResponse::EmployeesHasBeenSet() const
{
    return m_employeesHasBeenSet;
}

int64_t ChannelDescribeEmployeesResponse::GetOffset() const
{
    return m_offset;
}

bool ChannelDescribeEmployeesResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t ChannelDescribeEmployeesResponse::GetLimit() const
{
    return m_limit;
}

bool ChannelDescribeEmployeesResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

int64_t ChannelDescribeEmployeesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ChannelDescribeEmployeesResponse::TotalCountHasBeenSet() const
{
