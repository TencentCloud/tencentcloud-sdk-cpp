...
ChannelCreateOrganizationModifyQrCodeResponse::ChannelCreateOrganizationModifyQrCodeResponse() :
    m_qrCodeUrlHasBeenSet(false),
    m_expiredTimeHasBeenSet(false)
{
}

CoreInternalOutcome ChannelCreateOrganizationModifyQrCodeResponse::Deserialize(const string &payload)
{
...
string ChannelCreateOrganizationModifyQrCodeResponse::ToJsonString() const
{
...
string ChannelCreateOrganizationModifyQrCodeResponse::GetQrCodeUrl() const
{
    return m_qrCodeUrl;
}

bool ChannelCreateOrganizationModifyQrCodeResponse::QrCodeUrlHasBeenSet() const
{
    return m_qrCodeUrlHasBeenSet;
}

int64_t ChannelCreateOrganizationModifyQrCodeResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool ChannelCreateOrganizationModifyQrCodeResponse::ExpiredTimeHasBeenSet() const
{
