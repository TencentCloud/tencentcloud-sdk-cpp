...
DescribeFileConvertTaskResponse::DescribeFileConvertTaskResponse() :
...
CoreInternalOutcome DescribeFileConvertTaskResponse::Deserialize(const string &payload)
{
...
string DescribeFileConvertTaskResponse::ToJsonString() const
{
...
string DescribeFileConvertTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeFileConvertTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

int64_t DescribeFileConvertTaskResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeFileConvertTaskResponse::TaskStatusHasBeenSet() const
{
    return m_taskStatusHasBeenSet;
}

string DescribeFileConvertTaskResponse::GetTaskMessage() const
{
    return m_taskMessage;
}

bool DescribeFileConvertTaskResponse::TaskMessageHasBeenSet() const
{
    return m_taskMessageHasBeenSet;
}

string DescribeFileConvertTaskResponse::GetResourceId() const
{
    return m_resourceId;
}

bool DescribeFileConvertTaskResponse::ResourceIdHasBeenSet() const
{
