...
ChannelDescribeUserAutoSignStatusResponse::ChannelDescribeUserAutoSignStatusResponse() :
...
CoreInternalOutcome ChannelDescribeUserAutoSignStatusResponse::Deserialize(const string &payload)
{
...
string ChannelDescribeUserAutoSignStatusResponse::ToJsonString() const
{
...
bool ChannelDescribeUserAutoSignStatusResponse::GetIsOpen() const
{
    return m_isOpen;
}

bool ChannelDescribeUserAutoSignStatusResponse::IsOpenHasBeenSet() const
{
    return m_isOpenHasBeenSet;
}

int64_t ChannelDescribeUserAutoSignStatusResponse::GetLicenseFrom() const
{
    return m_licenseFrom;
}

bool ChannelDescribeUserAutoSignStatusResponse::LicenseFromHasBeenSet() const
{
    return m_licenseFromHasBeenSet;
}

int64_t ChannelDescribeUserAutoSignStatusResponse::GetLicenseTo() const
{
    return m_licenseTo;
}

bool ChannelDescribeUserAutoSignStatusResponse::LicenseToHasBeenSet() const
{
    return m_licenseToHasBeenSet;
}

int64_t ChannelDescribeUserAutoSignStatusResponse::GetLicenseType() const
{
    return m_licenseType;
}

bool ChannelDescribeUserAutoSignStatusResponse::LicenseTypeHasBeenSet() const
{
    return m_licenseTypeHasBeenSet;
}

string ChannelDescribeUserAutoSignStatusResponse::GetSealId() const
{
    return m_sealId;
}

bool ChannelDescribeUserAutoSignStatusResponse::SealIdHasBeenSet() const
{
