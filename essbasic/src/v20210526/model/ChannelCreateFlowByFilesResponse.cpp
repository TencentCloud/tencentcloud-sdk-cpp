...
CoreInternalOutcome ChannelCreateFlowByFilesResponse::Deserialize(const string &payload)
{
...
string ChannelCreateFlowByFilesResponse::ToJsonString() const
{
...
string ChannelCreateFlowByFilesResponse::GetFlowId() const
{
    return m_flowId;
}
...
string ChannelCreateFlowByFilesResponse::GetPreviewUrl() const
{
    return m_previewUrl;
}

bool ChannelCreateFlowByFilesResponse::PreviewUrlHasBeenSet() const
{
