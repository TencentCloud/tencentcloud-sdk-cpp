...
CoreInternalOutcome ChannelCancelMultiFlowSignQRCodeResponse::Deserialize(const string &payload)
{
...
string ChannelCancelMultiFlowSignQRCodeResponse::ToJsonString() const
{
