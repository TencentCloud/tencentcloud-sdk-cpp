...
CoreInternalOutcome CreateSealByImageResponse::Deserialize(const string &payload)
{
...
string CreateSealByImageResponse::ToJsonString() const
{
...
string CreateSealByImageResponse::GetSealId() const
{
    return m_sealId;
}
