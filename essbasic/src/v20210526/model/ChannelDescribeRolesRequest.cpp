...
string ChannelDescribeRolesRequest::ToJsonString() const
{
...
void ChannelDescribeRolesRequest::SetAgent(const Agent& _agent)
{
    m_agent = _agent;
    m_agentHasBeenSet = true;
}

bool ChannelDescribeRolesRequest::AgentHasBeenSet() const
{
...
void ChannelDescribeRolesRequest::SetLimit(const string& _limit)
{
    m_limit = _limit;
...
void ChannelDescribeRolesRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
