...
CoreInternalOutcome DescribeTemplatesResponse::Deserialize(const string &payload)
{
...
string DescribeTemplatesResponse::ToJsonString() const
{
...
vector<TemplateInfo> DescribeTemplatesResponse::GetTemplates() const
{
    return m_templates;
}
