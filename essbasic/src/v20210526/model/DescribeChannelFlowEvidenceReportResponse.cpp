...
CoreInternalOutcome DescribeChannelFlowEvidenceReportResponse::Deserialize(const string &payload)
{
...
string DescribeChannelFlowEvidenceReportResponse::ToJsonString() const
{
...
string DescribeChannelFlowEvidenceReportResponse::GetReportUrl() const
{
    return m_reportUrl;
}

bool DescribeChannelFlowEvidenceReportResponse::ReportUrlHasBeenSet() const
{
    return m_reportUrlHasBeenSet;
}

string DescribeChannelFlowEvidenceReportResponse::GetStatus() const
{
    return m_status;
}

bool DescribeChannelFlowEvidenceReportResponse::StatusHasBeenSet() const
{
