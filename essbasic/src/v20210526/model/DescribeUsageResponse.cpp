...
CoreInternalOutcome DescribeUsageResponse::Deserialize(const string &payload)
{
...
string DescribeUsageResponse::ToJsonString() const
{
...
uint64_t DescribeUsageResponse::GetTotal() const
{
    return m_total;
}

bool DescribeUsageResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<UsageDetail> DescribeUsageResponse::GetDetails() const
{
    return m_details;
}

bool DescribeUsageResponse::DetailsHasBeenSet() const
{
