...
ChannelCreatePrepareFlowGroupResponse::ChannelCreatePrepareFlowGroupResponse() :
    m_flowGroupIdHasBeenSet(false),
    m_prepareUrlHasBeenSet(false)
{
}

CoreInternalOutcome ChannelCreatePrepareFlowGroupResponse::Deserialize(const string &payload)
{
...
string ChannelCreatePrepareFlowGroupResponse::ToJsonString() const
{
...
string ChannelCreatePrepareFlowGroupResponse::GetFlowGroupId() const
{
    return m_flowGroupId;
}

bool ChannelCreatePrepareFlowGroupResponse::FlowGroupIdHasBeenSet() const
{
    return m_flowGroupIdHasBeenSet;
}

string ChannelCreatePrepareFlowGroupResponse::GetPrepareUrl() const
{
    return m_prepareUrl;
}

bool ChannelCreatePrepareFlowGroupResponse::PrepareUrlHasBeenSet() const
{
