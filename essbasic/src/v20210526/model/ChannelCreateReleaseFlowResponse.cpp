...
CoreInternalOutcome ChannelCreateReleaseFlowResponse::Deserialize(const string &payload)
{
...
string ChannelCreateReleaseFlowResponse::ToJsonString() const
{
...
string ChannelCreateReleaseFlowResponse::GetFlowId() const
{
    return m_flowId;
}

bool ChannelCreateReleaseFlowResponse::FlowIdHasBeenSet() const
{
