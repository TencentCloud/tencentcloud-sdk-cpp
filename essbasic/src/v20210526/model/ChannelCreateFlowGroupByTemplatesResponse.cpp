...
CoreInternalOutcome ChannelCreateFlowGroupByTemplatesResponse::Deserialize(const string &payload)
{
...
string ChannelCreateFlowGroupByTemplatesResponse::ToJsonString() const
{
...
string ChannelCreateFlowGroupByTemplatesResponse::GetFlowGroupId() const
{
    return m_flowGroupId;
}

bool ChannelCreateFlowGroupByTemplatesResponse::FlowGroupIdHasBeenSet() const
{
    return m_flowGroupIdHasBeenSet;
}

vector<string> ChannelCreateFlowGroupByTemplatesResponse::GetFlowIds() const
{
    return m_flowIds;
}

bool ChannelCreateFlowGroupByTemplatesResponse::FlowIdsHasBeenSet() const
{
    return m_flowIdsHasBeenSet;
}

vector<TaskInfo> ChannelCreateFlowGroupByTemplatesResponse::GetTaskInfos() const
{
    return m_taskInfos;
}
