...
#include <tencentcloud/essbasic/v20210526/model/AdminChangeInvitationInfo.h>
...
AdminChangeInvitationInfo::AdminChangeInvitationInfo() :
    ...
    m_changeAdminOrganizationOpenIdHasBeenSet(false),
    m_newAdminOpenIdHasBeenSet(false),
...
CoreInternalOutcome AdminChangeInvitationInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ChangeAdminOrganizationOpenId") && !value["ChangeAdminOrganizationOpenId"].IsNull())
    {
        if (!value["ChangeAdminOrganizationOpenId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `AdminChangeInvitationInfo.ChangeAdminOrganizationOpenId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_changeAdminOrganizationOpenId = string(value["ChangeAdminOrganizationOpenId"].GetString());
        m_changeAdminOrganizationOpenIdHasBeenSet = true;
    }

    if (value.HasMember("NewAdminOpenId") && !value["NewAdminOpenId"].IsNull())
    {
        if (!value["NewAdminOpenId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `AdminChangeInvitationInfo.NewAdminOpenId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_newAdminOpenId = string(value["NewAdminOpenId"].GetString());
        m_newAdminOpenIdHasBeenSet = true;
    }
...
void AdminChangeInvitationInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_changeAdminOrganizationOpenIdHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "ChangeAdminOrganizationOpenId";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_changeAdminOrganizationOpenId.c_str(), allocator).Move(), allocator);
    }

    if (m_newAdminOpenIdHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "NewAdminOpenId";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_newAdminOpenId.c_str(), allocator).Move(), allocator);
    }
...
string AdminChangeInvitationInfo::GetChangeAdminOrganizationOpenId() const
{
    return m_changeAdminOrganizationOpenId;
}

void AdminChangeInvitationInfo::SetChangeAdminOrganizationOpenId(const string& _changeAdminOrganizationOpenId)
{
    m_changeAdminOrganizationOpenId = _changeAdminOrganizationOpenId;
    m_changeAdminOrganizationOpenIdHasBeenSet = true;
}

bool AdminChangeInvitationInfo::ChangeAdminOrganizationOpenIdHasBeenSet() const
{
    return m_changeAdminOrganizationOpenIdHasBeenSet;
}

string AdminChangeInvitationInfo::GetNewAdminOpenId() const
{
    return m_newAdminOpenId;
}

void AdminChangeInvitationInfo::SetNewAdminOpenId(const string& _newAdminOpenId)
{
    m_newAdminOpenId = _newAdminOpenId;
    m_newAdminOpenIdHasBeenSet = true;
}

bool AdminChangeInvitationInfo::NewAdminOpenIdHasBeenSet() const
{
    return m_newAdminOpenIdHasBeenSet;
}
