...
CoreInternalOutcome ChannelCreateFlowSignUrlResponse::Deserialize(const string &payload)
{
...
string ChannelCreateFlowSignUrlResponse::ToJsonString() const
{
...
vector<FlowApproverUrlInfo> ChannelCreateFlowSignUrlResponse::GetFlowApproverUrlInfos() const
{
    return m_flowApproverUrlInfos;
}

bool ChannelCreateFlowSignUrlResponse::FlowApproverUrlInfosHasBeenSet() const
{
