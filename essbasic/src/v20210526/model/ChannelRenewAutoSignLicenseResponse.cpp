...
ChannelRenewAutoSignLicenseResponse::ChannelRenewAutoSignLicenseResponse() :
    m_licenseToHasBeenSet(false)
{
}

CoreInternalOutcome ChannelRenewAutoSignLicenseResponse::Deserialize(const string &payload)
{
...
string ChannelRenewAutoSignLicenseResponse::ToJsonString() const
{
...
int64_t ChannelRenewAutoSignLicenseResponse::GetLicenseTo() const
{
    return m_licenseTo;
}

bool ChannelRenewAutoSignLicenseResponse::LicenseToHasBeenSet() const
{
