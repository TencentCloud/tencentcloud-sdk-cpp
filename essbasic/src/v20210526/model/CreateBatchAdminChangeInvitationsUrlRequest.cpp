...
Agent CreateBatchAdminChangeInvitationsUrlRequest::GetAgent() const
{
    return m_agent;
}

void CreateBatchAdminChangeInvitationsUrlRequest::SetAgent(const Agent& _agent)
{
    m_agent = _agent;
    m_agentHasBeenSet = true;
}

bool CreateBatchAdminChangeInvitationsUrlRequest::AgentHasBeenSet() const
{
