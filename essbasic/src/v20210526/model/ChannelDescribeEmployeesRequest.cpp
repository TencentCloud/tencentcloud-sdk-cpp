...
string ChannelDescribeEmployeesRequest::ToJsonString() const
{
...
void ChannelDescribeEmployeesRequest::SetAgent(const Agent& _agent)
{
    m_agent = _agent;
...
void ChannelDescribeEmployeesRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool ChannelDescribeEmployeesRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

int64_t ChannelDescribeEmployeesRequest::GetOffset() const
{
    return m_offset;
}

void ChannelDescribeEmployeesRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
