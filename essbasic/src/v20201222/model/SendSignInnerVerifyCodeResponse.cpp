...
CoreInternalOutcome SendSignInnerVerifyCodeResponse::Deserialize(const string &payload)
{
...
string SendSignInnerVerifyCodeResponse::ToJsonString() const
{
...
bool SendSignInnerVerifyCodeResponse::GetResult() const
{
    return m_result;
}

bool SendSignInnerVerifyCodeResponse::ResultHasBeenSet() const
{
