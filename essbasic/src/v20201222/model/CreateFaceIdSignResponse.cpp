...
CoreInternalOutcome CreateFaceIdSignResponse::Deserialize(const string &payload)
{
...
string CreateFaceIdSignResponse::ToJsonString() const
{
...
string CreateFaceIdSignResponse::GetSign() const
{
    return m_sign;
}

bool CreateFaceIdSignResponse::SignHasBeenSet() const
{
