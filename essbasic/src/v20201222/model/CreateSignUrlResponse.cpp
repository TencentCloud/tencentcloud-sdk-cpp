...
CoreInternalOutcome CreateSignUrlResponse::Deserialize(const string &payload)
{
...
string CreateSignUrlResponse::ToJsonString() const
{
...
string CreateSignUrlResponse::GetSignUrl() const
{
    return m_signUrl;
}

bool CreateSignUrlResponse::SignUrlHasBeenSet() const
{
