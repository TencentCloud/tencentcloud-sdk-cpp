...
CoreInternalOutcome GenerateUserSealResponse::Deserialize(const string &payload)
{
...
string GenerateUserSealResponse::ToJsonString() const
{
...
string GenerateUserSealResponse::GetSealId() const
{
    return m_sealId;
}

bool GenerateUserSealResponse::SealIdHasBeenSet() const
{
