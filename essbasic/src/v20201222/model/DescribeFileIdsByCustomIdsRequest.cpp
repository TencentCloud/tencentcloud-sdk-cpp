...
string DescribeFileIdsByCustomIdsRequest::ToJsonString() const
{
...
Caller DescribeFileIdsByCustomIdsRequest::GetCaller() const
{
    return m_caller;
}

void DescribeFileIdsByCustomIdsRequest::SetCaller(const Caller& _caller)
{
    m_caller = _caller;
    m_callerHasBeenSet = true;
}

bool DescribeFileIdsByCustomIdsRequest::CallerHasBeenSet() const
{
    return m_callerHasBeenSet;
}

vector<string> DescribeFileIdsByCustomIdsRequest::GetCustomIds() const
{
    return m_customIds;
}

void DescribeFileIdsByCustomIdsRequest::SetCustomIds(const vector<string>& _customIds)
{
    m_customIds = _customIds;
    m_customIdsHasBeenSet = true;
}

bool DescribeFileIdsByCustomIdsRequest::CustomIdsHasBeenSet() const
{
