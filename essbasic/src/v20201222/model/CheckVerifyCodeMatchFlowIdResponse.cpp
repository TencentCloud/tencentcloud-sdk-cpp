...
CoreInternalOutcome CheckVerifyCodeMatchFlowIdResponse::Deserialize(const string &payload)
{
...
string CheckVerifyCodeMatchFlowIdResponse::ToJsonString() const
{
...
bool CheckVerifyCodeMatchFlowIdResponse::GetSuccess() const
{
    return m_success;
}

bool CheckVerifyCodeMatchFlowIdResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

int64_t CheckVerifyCodeMatchFlowIdResponse::GetResult() const
{
    return m_result;
}

bool CheckVerifyCodeMatchFlowIdResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string CheckVerifyCodeMatchFlowIdResponse::GetDescription() const
{
    return m_description;
}

bool CheckVerifyCodeMatchFlowIdResponse::DescriptionHasBeenSet() const
{
