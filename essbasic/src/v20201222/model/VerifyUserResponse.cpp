...
CoreInternalOutcome VerifyUserResponse::Deserialize(const string &payload)
{
...
string VerifyUserResponse::ToJsonString() const
{
...
string VerifyUserResponse::GetUserId() const
{
    return m_userId;
}

bool VerifyUserResponse::UserIdHasBeenSet() const
{
