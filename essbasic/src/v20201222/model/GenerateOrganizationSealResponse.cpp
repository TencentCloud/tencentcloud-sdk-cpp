...
CoreInternalOutcome GenerateOrganizationSealResponse::Deserialize(const string &payload)
{
...
string GenerateOrganizationSealResponse::ToJsonString() const
{
...
string GenerateOrganizationSealResponse::GetSealId() const
{
    return m_sealId;
}

bool GenerateOrganizationSealResponse::SealIdHasBeenSet() const
{
