...
CoreInternalOutcome DescribeCatalogApproversResponse::Deserialize(const string &payload)
{
...
string DescribeCatalogApproversResponse::ToJsonString() const
{
...
vector<CatalogApprovers> DescribeCatalogApproversResponse::GetApprovers() const
{
    return m_approvers;
}

bool DescribeCatalogApproversResponse::ApproversHasBeenSet() const
{
