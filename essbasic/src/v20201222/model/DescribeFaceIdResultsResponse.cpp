...
CoreInternalOutcome DescribeFaceIdResultsResponse::Deserialize(const string &payload)
{
...
string DescribeFaceIdResultsResponse::ToJsonString() const
{
...
vector<FaceIdResult> DescribeFaceIdResultsResponse::GetResults() const
{
    return m_results;
}

bool DescribeFaceIdResultsResponse::ResultsHasBeenSet() const
{
