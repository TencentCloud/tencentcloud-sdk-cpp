...
CoreInternalOutcome DescribeFlowApproversResponse::Deserialize(const string &payload)
{
...
string DescribeFlowApproversResponse::ToJsonString() const
{
...
string DescribeFlowApproversResponse::GetFlowId() const
{
    return m_flowId;
}

bool DescribeFlowApproversResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

vector<FlowApproverInfo> DescribeFlowApproversResponse::GetApprovers() const
{
    return m_approvers;
}

bool DescribeFlowApproversResponse::ApproversHasBeenSet() const
{
