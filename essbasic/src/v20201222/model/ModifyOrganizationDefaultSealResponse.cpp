...
CoreInternalOutcome ModifyOrganizationDefaultSealResponse::Deserialize(const string &payload)
{
...
string ModifyOrganizationDefaultSealResponse::ToJsonString() const
{
