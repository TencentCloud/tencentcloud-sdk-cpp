...
CoreInternalOutcome CreateSubOrganizationAndSealResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SubOrganizationId") && !rsp["SubOrganizationId"].IsNull())
    {
        if (!rsp["SubOrganizationId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `SubOrganizationId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_subOrganizationId = string(rsp["SubOrganizationId"].GetString());
...
string CreateSubOrganizationAndSealResponse::ToJsonString() const
{
...
string CreateSubOrganizationAndSealResponse::GetSubOrganizationId() const
{
    return m_subOrganizationId;
}

bool CreateSubOrganizationAndSealResponse::SubOrganizationIdHasBeenSet() const
{
    return m_subOrganizationIdHasBeenSet;
}

string CreateSubOrganizationAndSealResponse::GetSealId() const
{
    return m_sealId;
}

bool CreateSubOrganizationAndSealResponse::SealIdHasBeenSet() const
{
