...
CoreInternalOutcome SendFlowResponse::Deserialize(const string &payload)
{
...
string SendFlowResponse::ToJsonString() const
{
...
string SendFlowResponse::GetSignId() const
{
    return m_signId;
}

bool SendFlowResponse::SignIdHasBeenSet() const
{
