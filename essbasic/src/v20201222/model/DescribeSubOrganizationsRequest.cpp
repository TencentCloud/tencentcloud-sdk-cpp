...
string DescribeSubOrganizationsRequest::ToJsonString() const
{
...
Caller DescribeSubOrganizationsRequest::GetCaller() const
{
    return m_caller;
}

void DescribeSubOrganizationsRequest::SetCaller(const Caller& _caller)
{
    m_caller = _caller;
    m_callerHasBeenSet = true;
}

bool DescribeSubOrganizationsRequest::CallerHasBeenSet() const
{
    return m_callerHasBeenSet;
}

vector<string> DescribeSubOrganizationsRequest::GetSubOrganizationIds() const
{
    return m_subOrganizationIds;
}

void DescribeSubOrganizationsRequest::SetSubOrganizationIds(const vector<string>& _subOrganizationIds)
{
    m_subOrganizationIds = _subOrganizationIds;
    m_subOrganizationIdsHasBeenSet = true;
}

bool DescribeSubOrganizationsRequest::SubOrganizationIdsHasBeenSet() const
{
