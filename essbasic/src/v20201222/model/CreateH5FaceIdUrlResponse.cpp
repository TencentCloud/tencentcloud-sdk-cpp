...
CoreInternalOutcome CreateH5FaceIdUrlResponse::Deserialize(const string &payload)
{
...
string CreateH5FaceIdUrlResponse::ToJsonString() const
{
...
string CreateH5FaceIdUrlResponse::GetUrl() const
{
    return m_url;
}

bool CreateH5FaceIdUrlResponse::UrlHasBeenSet() const
{
