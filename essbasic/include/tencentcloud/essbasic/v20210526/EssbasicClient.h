...
#include <tencentcloud/essbasic/v20210526/model/CancelOrganizationFlowsResponse.h>
...
#include <tencentcloud/essbasic/v20210526/model/CreateBatchAdminChangeInvitationsRequest.h>
#include <tencentcloud/essbasic/v20210526/model/CreateBatchAdminChangeInvitationsResponse.h>
#include <tencentcloud/essbasic/v20210526/model/CreateBatchAdminChangeInvitationsUrlRequest.h>
#include <tencentcloud/essbasic/v20210526/model/CreateBatchAdminChangeInvitationsUrlResponse.h>
...
#include <tencentcloud/essbasic/v20210526/model/CreateFileConvertTaskRequest.h>
#include <tencentcloud/essbasic/v20210526/model/CreateFileConvertTaskResponse.h>
...
#include <tencentcloud/essbasic/v20210526/model/DescribeFileConvertTaskRequest.h>
#include <tencentcloud/essbasic/v20210526/model/DescribeFileConvertTaskResponse.h>
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            ...
            public:
                ...
                typedef Outcome<Core::Error, Model::CancelOrganizationFlowsResponse> CancelOrganizationFlowsOutcome;
                typedef std::future<CancelOrganizationFlowsOutcome> CancelOrganizationFlowsOutcomeCallable;
                typedef std::function<void(const EssbasicClient*, const Model::CancelOrganizationFlowsRequest&, CancelOrganizationFlowsOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CancelOrganizationFlowsAsyncHandler;
                ...
                typedef std::function<void(const EssbasicClient*, const Model::CreateBatchAdminChangeInvitationsRequest&, CreateBatchAdminChangeInvitationsOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateBatchAdminChangeInvitationsAsyncHandler;
                ...
                typedef std::function<void(const EssbasicClient*, const Model::CreateBatchAdminChangeInvitationsUrlRequest&, CreateBatchAdminChangeInvitationsUrlOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateBatchAdminChangeInvitationsUrlAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::CreateFileConvertTaskResponse> CreateFileConvertTaskOutcome;
                typedef std::future<CreateFileConvertTaskOutcome> CreateFileConvertTaskOutcomeCallable;
                typedef std::function<void(const EssbasicClient*, const Model::CreateFileConvertTaskRequest&, CreateFileConvertTaskOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateFileConvertTaskAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::CreateRequestWithEncryptionResponse> CreateRequestWithEncryptionOutcome;
                typedef std::future<CreateRequestWithEncryptionOutcome> CreateRequestWithEncryptionOutcomeCallable;
                typedef std::function<void(const EssbasicClient*, const Model::CreateRequestWithEncryptionRequest&, CreateRequestWithEncryptionOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateRequestWithEncryptionAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::DescribeFileConvertTaskResponse> DescribeFileConvertTaskOutcome;
                typedef std::future<DescribeFileConvertTaskOutcome> DescribeFileConvertTaskOutcomeCallable;
                typedef std::function<void(const EssbasicClient*, const Model::DescribeFileConvertTaskRequest&, DescribeFileConvertTaskOutcome, const std::shared_ptr<const AsyncCallerContext>&)> DescribeFileConvertTaskAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::ModifyOrganizationBusinessInfoResponse> ModifyOrganizationBusinessInfoOutcome;
                typedef std::future<ModifyOrganizationBusinessInfoOutcome> ModifyOrganizationBusinessInfoOutcomeCallable;
                typedef std::function<void(const EssbasicClient*, const Model::ModifyOrganizationBusinessInfoRequest&, ModifyOrganizationBusinessInfoOutcome, const std::shared_ptr<const AsyncCallerContext>&)> ModifyOrganizationBusinessInfoAsyncHandler;
...
- 撤销后可以看合同PDF内容的人员： 发起方的超管， 发起方自己，发起方撤销合同的操作人员，已经签署合同、已经填写合同、邀请填写已经补充信息的参与人员， 其他参与人员看不到合同的内容。
                 * @param req CancelOrganizationFlowsRequest
                 * @return CancelOrganizationFlowsOutcome
                 */
                CancelOrganizationFlowsOutcome CancelOrganizationFlows(const Model::CancelOrganizationFlowsRequest &request);
                void CancelOrganizationFlowsAsync(const Model::CancelOrganizationFlowsRequest& request, const CancelOrganizationFlowsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                CancelOrganizationFlowsOutcomeCallable CancelOrganizationFlowsCallable(const Model::CancelOrganizationFlowsRequest& request);
...
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
                 * @param req CreateFileConvertTaskRequest
                 * @return CreateFileConvertTaskOutcome
                 */
                CreateFileConvertTaskOutcome CreateFileConvertTask(const Model::CreateFileConvertTaskRequest &request);
                void CreateFileConvertTaskAsync(const Model::CreateFileConvertTaskRequest& request, const CreateFileConvertTaskAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                CreateFileConvertTaskOutcomeCallable CreateFileConvertTaskCallable(const Model::CreateFileConvertTaskRequest& request);
...
```
                 * @param req CreateRequestWithEncryptionRequest
                 * @return CreateRequestWithEncryptionOutcome
                 */
                CreateRequestWithEncryptionOutcome CreateRequestWithEncryption(const Model::CreateRequestWithEncryptionRequest &request);
                void CreateRequestWithEncryptionAsync(const Model::CreateRequestWithEncryptionRequest& request, const CreateRequestWithEncryptionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                CreateRequestWithEncryptionOutcomeCallable CreateRequestWithEncryptionCallable(const Model::CreateRequestWithEncryptionRequest& request);
...
整体流程如下图
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
                 * @param req DescribeFileConvertTaskRequest
                 * @return DescribeFileConvertTaskOutcome
                 */
                DescribeFileConvertTaskOutcome DescribeFileConvertTask(const Model::DescribeFileConvertTaskRequest &request);
                void DescribeFileConvertTaskAsync(const Model::DescribeFileConvertTaskRequest& request, const DescribeFileConvertTaskAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DescribeFileConvertTaskOutcomeCallable DescribeFileConvertTaskCallable(const Model::DescribeFileConvertTaskRequest& request);
...
* **人工收录审核产生结果后**：触发 [企业收录申请审核结果回调](https://qian.tencent.com/developers/partner/callback_types_staffs#%E5%8D%81%E5%85%AD-%E4%BC%81%E4%B8%9A%E6%94%B6%E5%BD%95%E7%94%B3%E8%AF%B7%E5%AE%A1%E6%A0%B8%E7%BB%93%E6%9E%9C%E5%9B%9E%E8%B0%83)
                 * @param req ModifyOrganizationBusinessInfoRequest
                 * @return ModifyOrganizationBusinessInfoOutcome
                 */
                ModifyOrganizationBusinessInfoOutcome ModifyOrganizationBusinessInfo(const Model::ModifyOrganizationBusinessInfoRequest &request);
                void ModifyOrganizationBusinessInfoAsync(const Model::ModifyOrganizationBusinessInfoRequest& request, const ModifyOrganizationBusinessInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                ModifyOrganizationBusinessInfoOutcomeCallable ModifyOrganizationBusinessInfoCallable(const Model::ModifyOrganizationBusinessInfoRequest& request);
