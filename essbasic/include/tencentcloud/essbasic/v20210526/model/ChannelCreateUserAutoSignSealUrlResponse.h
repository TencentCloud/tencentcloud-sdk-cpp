...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLRESPONSE_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelCreateUserAutoSignSealUrlResponse : public AbstractModel
                {
                public:
                    ChannelCreateUserAutoSignSealUrlResponse();
                    ~ChannelCreateUserAutoSignSealUrlResponse() = default;
                    ...
                    /**
                     * 获取<p>个人用户“授权签”的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLRESPONSE_H_
