...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELRENEWAUTOSIGNLICENSEREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELRENEWAUTOSIGNLICENSEREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelRenewAutoSignLicenseRequest : public AbstractModel
                {
                public:
                    ChannelRenewAutoSignLicenseRequest();
                    ~ChannelRenewAutoSignLicenseRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELRENEWAUTOSIGNLICENSEREQUEST_H_
