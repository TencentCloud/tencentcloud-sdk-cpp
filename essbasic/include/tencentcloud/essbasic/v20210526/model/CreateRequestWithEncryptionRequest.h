...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CREATEREQUESTWITHENCRYPTIONREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CREATEREQUESTWITHENCRYPTIONREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>第三方应用的唯一标识，对应通用参数 Agent.AppId。</p>
                    ...
                    /**
                     * 设置<p>第三方应用的唯一标识，对应通用参数 Agent.AppId。</p>
                     * @param _applicationId <p>第三方应用的唯一标识，对应通用参数 Agent.AppId。</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CREATEREQUESTWITHENCRYPTIONREQUEST_H_
