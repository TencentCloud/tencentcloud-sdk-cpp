...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEUSERAUTOSIGNSTATUSREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEUSERAUTOSIGNSTATUSREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelDescribeUserAutoSignStatusRequest : public AbstractModel
                {
                public:
                    ChannelDescribeUserAutoSignStatusRequest();
                    ~ChannelDescribeUserAutoSignStatusRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEUSERAUTOSIGNSTATUSREQUEST_H_
