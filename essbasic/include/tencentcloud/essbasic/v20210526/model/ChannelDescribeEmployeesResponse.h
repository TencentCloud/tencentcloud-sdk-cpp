...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEEMPLOYEESRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEEMPLOYEESRESPONSE_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelDescribeEmployeesResponse : public AbstractModel
                {
                public:
                    ChannelDescribeEmployeesResponse();
                    ~ChannelDescribeEmployeesResponse() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEEMPLOYEESRESPONSE_H_
