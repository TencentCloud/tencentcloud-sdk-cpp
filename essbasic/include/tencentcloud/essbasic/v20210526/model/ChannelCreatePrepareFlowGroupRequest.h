...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEPREPAREFLOWGROUPREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEPREPAREFLOWGROUPREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelCreatePrepareFlowGroupRequest : public AbstractModel
                {
                public:
                    ChannelCreatePrepareFlowGroupRequest();
                    ~ChannelCreatePrepareFlowGroupRequest() = default;
                    ...
                    /**
                     * 判断参数 BaseFlowInfos 是否已赋值
                     * @return BaseFlowInfos 是否已赋值
                     * 
                     */
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEPREPAREFLOWGROUPREQUEST_H_
