...
3. 关键字(KEYWORD)定位方式，使用关键字定位时，请确保PDF原始文件内是关键字以文字形式保存在PDF文件中，不支持对图片内文字进行关键字查找
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p><font color="red">【暂未使用】</font>控件归属的文档的ID， <strong>发起合同时候不要填写此字段留空即可</strong></p>
                    ...
                    /**
                     * 设置<p><font color="red">【暂未使用】</font>控件归属的文档的ID， <strong>发起合同时候不要填写此字段留空即可</strong></p>
                     * @param _documentId <p><font color="red">【暂未使用】</font>控件归属的文档的ID， <strong>发起合同时候不要填写此字段留空即可</strong></p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p><font color="red">【暂未使用】</font>控件描述，用户自定义，不影响合同发起流程</p>
                    ...
                    /**
                     * 设置<p><font color="red">【暂未使用】</font>控件描述，用户自定义，不影响合同发起流程</p>
                     * @param _componentDescription <p><font color="red">【暂未使用】</font>控件描述，用户自定义，不影响合同发起流程</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>填写控件在腾讯电子签小程序填写界面展示的提示信息，例如，在身份证号码填写控件中，提示信息可以设置成“请输入18位身份证号码”。<br>注：<code>签署控件设置此字段无效</code></p>
                    ...
                    /**
                     * 设置<p>填写控件在腾讯电子签小程序填写界面展示的提示信息，例如，在身份证号码填写控件中，提示信息可以设置成“请输入18位身份证号码”。<br>注：<code>签署控件设置此字段无效</code></p>
                     * @param _placeholder <p>填写控件在腾讯电子签小程序填写界面展示的提示信息，例如，在身份证号码填写控件中，提示信息可以设置成“请输入18位身份证号码”。<br>注：<code>签署控件设置此字段无效</code></p>
                     * 
                     */
