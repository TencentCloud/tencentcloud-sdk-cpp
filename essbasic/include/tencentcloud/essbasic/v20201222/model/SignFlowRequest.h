...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SIGNFLOWREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SIGNFLOWREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                * SignFlow请求参数结构体
                */
                class SignFlowRequest : public AbstractModel
                {
                public:
                    SignFlowRequest();
                    ~SignFlowRequest() = default;
...
（注：普通情况下，VerifyChannel不能为None，如您不希望腾讯电子签对用户签署意愿做校验，请提前与客户经理或邮件至e-contract@tencent.com与我们联系）
                     ...
                     * 签署内容
                     */
                    std::vector<SignSeal> m_signSeals;
                    bool m_signSealsHasBeenSet;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SIGNFLOWREQUEST_H_
