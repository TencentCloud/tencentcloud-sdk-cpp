...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CREATESUBORGANIZATIONREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CREATESUBORGANIZATIONREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                */
                class CreateSubOrganizationRequest : public AbstractModel
                {
                public:
                    CreateSubOrganizationRequest();
                    ~CreateSubOrganizationRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CREATESUBORGANIZATIONREQUEST_H_
