...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATECACERTIFICATEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATECACERTIFICATEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DeactivateCaCertificateRequest : public AbstractModel
                {
                public:
                    DeactivateCaCertificateRequest();
                    ~DeactivateCaCertificateRequest() = default;
                    ...
                    /**
                     * 获取证书序列号，可以从 [DescribeCaCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、证书文件中获得。
                    ...
                    /**
                     * 设置证书序列号，可以从 [DescribeCaCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、证书文件中获得。
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATECACERTIFICATEREQUEST_H_
