...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_MODIFYHTTPAUTHENTICATORREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_MODIFYHTTPAUTHENTICATORREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class ModifyHttpAuthenticatorRequest : public AbstractModel
                {
                public:
                    ModifyHttpAuthenticatorRequest();
                    ~ModifyHttpAuthenticatorRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_MODIFYHTTPAUTHENTICATORREQUEST_H_
