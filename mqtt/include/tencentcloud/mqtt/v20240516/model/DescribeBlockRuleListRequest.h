...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEBLOCKRULELISTREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEBLOCKRULELISTREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeBlockRuleListRequest : public AbstractModel
                {
                public:
                    DescribeBlockRuleListRequest();
                    ~DescribeBlockRuleListRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEBLOCKRULELISTREQUEST_H_
