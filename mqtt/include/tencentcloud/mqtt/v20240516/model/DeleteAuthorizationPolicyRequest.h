...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHORIZATIONPOLICYREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHORIZATIONPOLICYREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DeleteAuthorizationPolicyRequest : public AbstractModel
                {
                public:
                    DeleteAuthorizationPolicyRequest();
                    ~DeleteAuthorizationPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHORIZATIONPOLICYREQUEST_H_
