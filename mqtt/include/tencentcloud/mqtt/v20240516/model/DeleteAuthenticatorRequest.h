...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHENTICATORREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHENTICATORREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DeleteAuthenticatorRequest : public AbstractModel
                {
                public:
                    DeleteAuthenticatorRequest();
                    ~DeleteAuthenticatorRequest() = default;
                    ...
                    /**
                     * 获取<p>认证器类型:<br>JWT：JWT认证器<br>JWKS：JWKS认证器<br>HTTP：HTTP认证器</p>
                    ...
                    /**
                     * 设置<p>认证器类型:<br>JWT：JWT认证器<br>JWKS：JWKS认证器<br>HTTP：HTTP认证器</p>
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEAUTHENTICATORREQUEST_H_
