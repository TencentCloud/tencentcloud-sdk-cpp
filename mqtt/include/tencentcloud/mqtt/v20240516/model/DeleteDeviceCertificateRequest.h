...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEDEVICECERTIFICATEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEDEVICECERTIFICATEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DeleteDeviceCertificateRequest : public AbstractModel
                {
                public:
                    DeleteDeviceCertificateRequest();
                    ~DeleteDeviceCertificateRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DELETEDEVICECERTIFICATEREQUEST_H_
