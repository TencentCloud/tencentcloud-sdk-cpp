...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_ACTIVATEDEVICECERTIFICATEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_ACTIVATEDEVICECERTIFICATEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class ActivateDeviceCertificateRequest : public AbstractModel
                {
                public:
                    ActivateDeviceCertificateRequest();
                    ~ActivateDeviceCertificateRequest() = default;
                    ...
                    /**
                     * 获取设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、证书文件中获得。
                    ...
                    /**
                     * 设置设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、证书文件中获得。
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_ACTIVATEDEVICECERTIFICATEREQUEST_H_
