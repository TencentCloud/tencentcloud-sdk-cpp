...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEDEVICECERTIFICATEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEDEVICECERTIFICATEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeDeviceCertificateRequest : public AbstractModel
                {
                public:
                    DescribeDeviceCertificateRequest();
                    ~DescribeDeviceCertificateRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEDEVICECERTIFICATEREQUEST_H_
