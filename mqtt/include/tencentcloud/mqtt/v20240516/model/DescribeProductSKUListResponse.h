...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEPRODUCTSKULISTRESPONSE_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEPRODUCTSKULISTRESPONSE_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeProductSKUListResponse : public AbstractModel
                {
                public:
                    DescribeProductSKUListResponse();
                    ~DescribeProductSKUListResponse() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEPRODUCTSKULISTRESPONSE_H_
