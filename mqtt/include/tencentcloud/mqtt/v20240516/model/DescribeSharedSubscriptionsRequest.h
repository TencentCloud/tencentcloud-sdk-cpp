...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONSREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONSREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeSharedSubscriptionsRequest : public AbstractModel
                {
                public:
                    DescribeSharedSubscriptionsRequest();
                    ~DescribeSharedSubscriptionsRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONSREQUEST_H_
