...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEBLOCKRULEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEBLOCKRULEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class CreateBlockRuleRequest : public AbstractModel
                {
                public:
                    CreateBlockRuleRequest();
                    ~CreateBlockRuleRequest() = default;
                    ...
                    /**
                     * 获取封禁规则名，不可重复，只支持数字字母中划线
                     * @return Name 封禁规则名，不可重复，只支持数字字母中划线
                     * 
                     */
                    std::string GetName() const;

                    /**
                     * 设置封禁规则名，不可重复，只支持数字字母中划线
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEBLOCKRULEREQUEST_H_
