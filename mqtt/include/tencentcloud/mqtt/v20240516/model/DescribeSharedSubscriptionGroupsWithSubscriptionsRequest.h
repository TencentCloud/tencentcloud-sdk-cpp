...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONGROUPSWITHSUBSCRIPTIONSREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONGROUPSWITHSUBSCRIPTIONSREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeSharedSubscriptionGroupsWithSubscriptionsRequest : public AbstractModel
                {
                public:
                    DescribeSharedSubscriptionGroupsWithSubscriptionsRequest();
                    ~DescribeSharedSubscriptionGroupsWithSubscriptionsRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBESHAREDSUBSCRIPTIONGROUPSWITHSUBSCRIPTIONSREQUEST_H_
