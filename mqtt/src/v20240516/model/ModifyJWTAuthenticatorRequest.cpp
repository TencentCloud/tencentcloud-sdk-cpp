...
ModifyJWTAuthenticatorRequest::ModifyJWTAuthenticatorRequest() :
...
string ModifyJWTAuthenticatorRequest::ToJsonString() const
{
...
string ModifyJWTAuthenticatorRequest::GetInstanceId() const
{
    return m_instanceId;
}

void ModifyJWTAuthenticatorRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ModifyJWTAuthenticatorRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ModifyJWTAuthenticatorRequest::GetAlgorithm() const
{
    return m_algorithm;
}

void ModifyJWTAuthenticatorRequest::SetAlgorithm(const string& _algorithm)
{
    m_algorithm = _algorithm;
    m_algorithmHasBeenSet = true;
}

bool ModifyJWTAuthenticatorRequest::AlgorithmHasBeenSet() const
{
    return m_algorithmHasBeenSet;
}

string ModifyJWTAuthenticatorRequest::GetFrom() const
{
    return m_from;
}

void ModifyJWTAuthenticatorRequest::SetFrom(const string& _from)
{
    m_from = _from;
    m_fromHasBeenSet = true;
}

bool ModifyJWTAuthenticatorRequest::FromHasBeenSet() const
{
    return m_fromHasBeenSet;
}

string ModifyJWTAuthenticatorRequest::GetSecret() const
{
    return m_secret;
}

void ModifyJWTAuthenticatorRequest::SetSecret(const string& _secret)
{
    m_secret = _secret;
    m_secretHasBeenSet = true;
}

bool ModifyJWTAuthenticatorRequest::SecretHasBeenSet() const
{
    return m_secretHasBeenSet;
}

string ModifyJWTAuthenticatorRequest::GetPublicKey() const
{
    return m_publicKey;
}

void ModifyJWTAuthenticatorRequest::SetPublicKey(const string& _publicKey)
{
    m_publicKey = _publicKey;
    m_publicKeyHasBeenSet = true;
}

bool ModifyJWTAuthenticatorRequest::PublicKeyHasBeenSet() const
{
...
void ModifyJWTAuthenticatorRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
