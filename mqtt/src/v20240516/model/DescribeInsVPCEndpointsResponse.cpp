...
DescribeInsVPCEndpointsResponse::DescribeInsVPCEndpointsResponse() :
    m_endpointsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeInsVPCEndpointsResponse::Deserialize(const string &payload)
{
...
string DescribeInsVPCEndpointsResponse::ToJsonString() const
{
...
vector<MQTTEndpointItem> DescribeInsVPCEndpointsResponse::GetEndpoints() const
{
    return m_endpoints;
}

bool DescribeInsVPCEndpointsResponse::EndpointsHasBeenSet() const
{
