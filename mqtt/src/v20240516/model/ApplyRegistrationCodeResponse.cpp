...
ApplyRegistrationCodeResponse::ApplyRegistrationCodeResponse() :
    m_instanceIdHasBeenSet(false),
    m_registrationCodeHasBeenSet(false)
{
}

CoreInternalOutcome ApplyRegistrationCodeResponse::Deserialize(const string &payload)
{
...
string ApplyRegistrationCodeResponse::ToJsonString() const
{
...
string ApplyRegistrationCodeResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool ApplyRegistrationCodeResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ApplyRegistrationCodeResponse::GetRegistrationCode() const
{
    return m_registrationCode;
}

bool ApplyRegistrationCodeResponse::RegistrationCodeHasBeenSet() const
{
