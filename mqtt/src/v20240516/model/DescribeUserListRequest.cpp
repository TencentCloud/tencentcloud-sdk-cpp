...
string DescribeUserListRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeUserListRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DescribeUserListRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<Filter> DescribeUserListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeUserListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeUserListRequest::FiltersHasBeenSet() const
{
