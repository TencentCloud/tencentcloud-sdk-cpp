...
string CreateTopicResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateTopicResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateTopicResponse::GetTopic() const
{
    return m_topic;
}

bool CreateTopicResponse::TopicHasBeenSet() const
{
