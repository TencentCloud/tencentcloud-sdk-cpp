...
CoreInternalOutcome CreateStorageCredentialsResponse::Deserialize(const string &payload)
{
...
string CreateStorageCredentialsResponse::ToJsonString() const
{
...
Credentials CreateStorageCredentialsResponse::GetCredentials() const
{
    return m_credentials;
}

bool CreateStorageCredentialsResponse::CredentialsHasBeenSet() const
{
