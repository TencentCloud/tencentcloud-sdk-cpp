...
CoreInternalOutcome DeleteIncrementalMigrationStrategyResponse::Deserialize(const string &payload)
{
...
string DeleteIncrementalMigrationStrategyResponse::ToJsonString() const
{
