...
CoreInternalOutcome ModifyIncrementalMigrationStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyIncrementalMigrationStrategyResponse::ToJsonString() const
{
