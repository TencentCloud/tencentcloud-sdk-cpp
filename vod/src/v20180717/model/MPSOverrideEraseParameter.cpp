...
CoreInternalOutcome MPSOverrideEraseParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EraseType") && !value["EraseType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSOverrideEraseParameter.EraseType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseSubtitleConfig") && !value["EraseSubtitleConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSOverrideEraseParameter.EraseSubtitleConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseWatermarkConfig") && !value["EraseWatermarkConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSOverrideEraseParameter.EraseWatermarkConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErasePrivacyConfig") && !value["ErasePrivacyConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSOverrideEraseParameter.ErasePrivacyConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubtitleEmbedId") && !value["SubtitleEmbedId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSOverrideEraseParameter.SubtitleEmbedId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void MPSOverrideEraseParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MPSOverrideEraseParameter::GetEraseType() const
{
    return m_eraseType;
}

void MPSOverrideEraseParameter::SetEraseType(const string& _eraseType)
{
    m_eraseType = _eraseType;
    m_eraseTypeHasBeenSet = true;
}

bool MPSOverrideEraseParameter::EraseTypeHasBeenSet() const
{
    return m_eraseTypeHasBeenSet;
}

MPSUpdateSmartEraseSubtitleConfig MPSOverrideEraseParameter::GetEraseSubtitleConfig() const
{
    return m_eraseSubtitleConfig;
}

void MPSOverrideEraseParameter::SetEraseSubtitleConfig(const MPSUpdateSmartEraseSubtitleConfig& _eraseSubtitleConfig)
{
    m_eraseSubtitleConfig = _eraseSubtitleConfig;
    m_eraseSubtitleConfigHasBeenSet = true;
}

bool MPSOverrideEraseParameter::EraseSubtitleConfigHasBeenSet() const
{
    return m_eraseSubtitleConfigHasBeenSet;
}

MPSUpdateSmartEraseWatermarkConfig MPSOverrideEraseParameter::GetEraseWatermarkConfig() const
{
    return m_eraseWatermarkConfig;
}

void MPSOverrideEraseParameter::SetEraseWatermarkConfig(const MPSUpdateSmartEraseWatermarkConfig& _eraseWatermarkConfig)
{
    m_eraseWatermarkConfig = _eraseWatermarkConfig;
    m_eraseWatermarkConfigHasBeenSet = true;
}

bool MPSOverrideEraseParameter::EraseWatermarkConfigHasBeenSet() const
{
    return m_eraseWatermarkConfigHasBeenSet;
}

MPSSmartErasePrivacyConfig MPSOverrideEraseParameter::GetErasePrivacyConfig() const
{
    return m_erasePrivacyConfig;
}

void MPSOverrideEraseParameter::SetErasePrivacyConfig(const MPSSmartErasePrivacyConfig& _erasePrivacyConfig)
{
    m_erasePrivacyConfig = _erasePrivacyConfig;
    m_erasePrivacyConfigHasBeenSet = true;
}

bool MPSOverrideEraseParameter::ErasePrivacyConfigHasBeenSet() const
{
    return m_erasePrivacyConfigHasBeenSet;
}

int64_t MPSOverrideEraseParameter::GetSubtitleEmbedId() const
{
    return m_subtitleEmbedId;
}

void MPSOverrideEraseParameter::SetSubtitleEmbedId(const int64_t& _subtitleEmbedId)
{
    m_subtitleEmbedId = _subtitleEmbedId;
    m_subtitleEmbedIdHasBeenSet = true;
}

bool MPSOverrideEraseParameter::SubtitleEmbedIdHasBeenSet() const
{
