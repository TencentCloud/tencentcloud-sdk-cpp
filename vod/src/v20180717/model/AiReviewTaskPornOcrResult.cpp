...
CoreInternalOutcome AiReviewTaskPornOcrResult::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Status") && !value["Status"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.Status` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErrCodeExt") && !value["ErrCodeExt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.ErrCodeExt` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErrCode") && !value["ErrCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.ErrCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Message") && !value["Message"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.Message` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Input") && !value["Input"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.Input` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Output") && !value["Output"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTaskPornOcrResult.Output` is not object type").SetRequestId(requestId));
        }
...
void AiReviewTaskPornOcrResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
