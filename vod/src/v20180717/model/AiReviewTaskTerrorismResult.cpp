...
CoreInternalOutcome AiReviewTaskTerrorismResult::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Progress") && !value["Progress"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiReviewTaskTerrorismResult.Progress` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
int64_t AiReviewTaskTerrorismResult::GetProgress() const
{
    return m_progress;
}

void AiReviewTaskTerrorismResult::SetProgress(const int64_t& _progress)
{
    m_progress = _progress;
    m_progressHasBeenSet = true;
}

bool AiReviewTaskTerrorismResult::ProgressHasBeenSet() const
{
