...
CoreInternalOutcome AiReviewProhibitedAsrTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Definition") && !value["Definition"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewProhibitedAsrTaskInput.Definition` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void AiReviewProhibitedAsrTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
