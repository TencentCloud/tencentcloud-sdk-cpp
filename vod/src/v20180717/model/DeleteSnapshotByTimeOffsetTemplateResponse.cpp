...
CoreInternalOutcome DeleteSnapshotByTimeOffsetTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteSnapshotByTimeOffsetTemplateResponse::ToJsonString() const
{
