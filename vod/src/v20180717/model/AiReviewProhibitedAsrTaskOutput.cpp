...
CoreInternalOutcome AiReviewProhibitedAsrTaskOutput::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("SegmentSetFileUrl") && !value["SegmentSetFileUrl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiReviewProhibitedAsrTaskOutput.SegmentSetFileUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SegmentSetFileUrlExpireTime") && !value["SegmentSetFileUrlExpireTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiReviewProhibitedAsrTaskOutput.SegmentSetFileUrlExpireTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AiReviewProhibitedAsrTaskOutput::GetSegmentSetFileUrl() const
{
    return m_segmentSetFileUrl;
}

void AiReviewProhibitedAsrTaskOutput::SetSegmentSetFileUrl(const string& _segmentSetFileUrl)
{
    m_segmentSetFileUrl = _segmentSetFileUrl;
    m_segmentSetFileUrlHasBeenSet = true;
}

bool AiReviewProhibitedAsrTaskOutput::SegmentSetFileUrlHasBeenSet() const
{
    return m_segmentSetFileUrlHasBeenSet;
}

string AiReviewProhibitedAsrTaskOutput::GetSegmentSetFileUrlExpireTime() const
{
    return m_segmentSetFileUrlExpireTime;
}

void AiReviewProhibitedAsrTaskOutput::SetSegmentSetFileUrlExpireTime(const string& _segmentSetFileUrlExpireTime)
{
    m_segmentSetFileUrlExpireTime = _segmentSetFileUrlExpireTime;
    m_segmentSetFileUrlExpireTimeHasBeenSet = true;
}

bool AiReviewProhibitedAsrTaskOutput::SegmentSetFileUrlExpireTimeHasBeenSet() const
{
