...
CoreInternalOutcome AiReviewTerrorismTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Definition") && !value["Definition"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewTerrorismTaskInput.Definition` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void AiReviewTerrorismTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
