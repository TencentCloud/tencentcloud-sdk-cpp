...
CreateAigcCustomElementResponse::CreateAigcCustomElementResponse() :
    m_elementIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateAigcCustomElementResponse::Deserialize(const string &payload)
{
...
string CreateAigcCustomElementResponse::ToJsonString() const
{
...
string CreateAigcCustomElementResponse::GetElementId() const
{
    return m_elementId;
}

bool CreateAigcCustomElementResponse::ElementIdHasBeenSet() const
{
