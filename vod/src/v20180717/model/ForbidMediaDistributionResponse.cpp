...
CoreInternalOutcome ForbidMediaDistributionResponse::Deserialize(const string &payload)
{
...
string ForbidMediaDistributionResponse::ToJsonString() const
{
...
vector<string> ForbidMediaDistributionResponse::GetNotExistFileIdSet() const
{
    return m_notExistFileIdSet;
}

bool ForbidMediaDistributionResponse::NotExistFileIdSetHasBeenSet() const
{
