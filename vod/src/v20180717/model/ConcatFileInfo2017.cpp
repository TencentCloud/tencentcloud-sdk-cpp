...
CoreInternalOutcome ConcatFileInfo2017::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ErrCode") && !value["ErrCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConcatFileInfo2017.ErrCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Message") && !value["Message"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConcatFileInfo2017.Message` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FileId") && !value["FileId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConcatFileInfo2017.FileId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FileUrl") && !value["FileUrl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConcatFileInfo2017.FileUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FileType") && !value["FileType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConcatFileInfo2017.FileType` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ConcatFileInfo2017::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
