...
CoreInternalOutcome ProcessMediaByProcedureResponse::Deserialize(const string &payload)
{
...
string ProcessMediaByProcedureResponse::ToJsonString() const
{
...
string ProcessMediaByProcedureResponse::GetTaskId() const
{
    return m_taskId;
}
