...
CoreInternalOutcome MediaSnapshotByTimeOffsetInfo::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SnapshotByTimeOffsetSet") && !value["SnapshotByTimeOffsetSet"].IsNull())
    {
        ...
        const Value &tmpValue = value["SnapshotByTimeOffsetSet"];
...
void MediaSnapshotByTimeOffsetInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
