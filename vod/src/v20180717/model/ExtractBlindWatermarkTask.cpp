...
CoreInternalOutcome ExtractBlindWatermarkTask::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ResultUV") && !value["ResultUV"].IsNull())
    {
        if (!value["ResultUV"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `ExtractBlindWatermarkTask.ResultUV` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_resultUV = string(value["ResultUV"].GetString());
        m_resultUVHasBeenSet = true;
    }
    ...
    if (value.HasMember("SessionContext") && !value["SessionContext"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ExtractBlindWatermarkTask.SessionContext` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SessionId") && !value["SessionId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ExtractBlindWatermarkTask.SessionId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ExtractBlindWatermarkTask::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_resultUVHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "ResultUV";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_resultUV.c_str(), allocator).Move(), allocator);
    }
...
ExtractBlindWatermarkInputInfo ExtractBlindWatermarkTask::GetInputInfo() const
{
    return m_inputInfo;
}

void ExtractBlindWatermarkTask::SetInputInfo(const ExtractBlindWatermarkInputInfo& _inputInfo)
{
...
string ExtractBlindWatermarkTask::GetResultUV() const
{
    return m_resultUV;
}

void ExtractBlindWatermarkTask::SetResultUV(const string& _resultUV)
{
    m_resultUV = _resultUV;
    m_resultUVHasBeenSet = true;
}

bool ExtractBlindWatermarkTask::ResultUVHasBeenSet() const
{
    return m_resultUVHasBeenSet;
}
...
string ExtractBlindWatermarkTask::GetSessionContext() const
{
    return m_sessionContext;
}

void ExtractBlindWatermarkTask::SetSessionContext(const string& _sessionContext)
{
    m_sessionContext = _sessionContext;
    m_sessionContextHasBeenSet = true;
}

bool ExtractBlindWatermarkTask::SessionContextHasBeenSet() const
{
    return m_sessionContextHasBeenSet;
}

string ExtractBlindWatermarkTask::GetSessionId() const
{
    return m_sessionId;
}

void ExtractBlindWatermarkTask::SetSessionId(const string& _sessionId)
{
    m_sessionId = _sessionId;
    m_sessionIdHasBeenSet = true;
}

bool ExtractBlindWatermarkTask::SessionIdHasBeenSet() const
{
