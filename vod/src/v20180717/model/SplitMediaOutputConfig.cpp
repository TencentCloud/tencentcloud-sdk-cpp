...
CoreInternalOutcome SplitMediaOutputConfig::Deserialize(const Value &value)
{
    string requestId = "";
...
void SplitMediaOutputConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
