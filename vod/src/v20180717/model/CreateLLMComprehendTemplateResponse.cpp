...
CoreInternalOutcome CreateLLMComprehendTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLLMComprehendTemplateResponse::ToJsonString() const
{
...
int64_t CreateLLMComprehendTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateLLMComprehendTemplateResponse::DefinitionHasBeenSet() const
{
