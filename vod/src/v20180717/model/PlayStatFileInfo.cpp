...
CoreInternalOutcome PlayStatFileInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void PlayStatFileInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
