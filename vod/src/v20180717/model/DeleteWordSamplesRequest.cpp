...
uint64_t DeleteWordSamplesRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DeleteWordSamplesRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DeleteWordSamplesRequest::SubAppIdHasBeenSet() const
{
