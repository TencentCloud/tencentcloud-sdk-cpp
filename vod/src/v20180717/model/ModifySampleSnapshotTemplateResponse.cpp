...
CoreInternalOutcome ModifySampleSnapshotTemplateResponse::Deserialize(const string &payload)
{
...
string ModifySampleSnapshotTemplateResponse::ToJsonString() const
{
