...
uint64_t DescribeAIAnalysisTemplatesRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DescribeAIAnalysisTemplatesRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DescribeAIAnalysisTemplatesRequest::SubAppIdHasBeenSet() const
{
