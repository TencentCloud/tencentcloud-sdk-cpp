...
CoreInternalOutcome AiReviewPornOcrTaskOutput::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("SegmentSetFileUrl") && !value["SegmentSetFileUrl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiReviewPornOcrTaskOutput.SegmentSetFileUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SegmentSetFileUrlExpireTime") && !value["SegmentSetFileUrlExpireTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiReviewPornOcrTaskOutput.SegmentSetFileUrlExpireTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AiReviewPornOcrTaskOutput::GetSegmentSetFileUrl() const
{
    return m_segmentSetFileUrl;
}

void AiReviewPornOcrTaskOutput::SetSegmentSetFileUrl(const string& _segmentSetFileUrl)
{
    m_segmentSetFileUrl = _segmentSetFileUrl;
    m_segmentSetFileUrlHasBeenSet = true;
}

bool AiReviewPornOcrTaskOutput::SegmentSetFileUrlHasBeenSet() const
{
    return m_segmentSetFileUrlHasBeenSet;
}

string AiReviewPornOcrTaskOutput::GetSegmentSetFileUrlExpireTime() const
{
    return m_segmentSetFileUrlExpireTime;
}

void AiReviewPornOcrTaskOutput::SetSegmentSetFileUrlExpireTime(const string& _segmentSetFileUrlExpireTime)
{
    m_segmentSetFileUrlExpireTime = _segmentSetFileUrlExpireTime;
    m_segmentSetFileUrlExpireTimeHasBeenSet = true;
}

bool AiReviewPornOcrTaskOutput::SegmentSetFileUrlExpireTimeHasBeenSet() const
{
