...
int64_t MediaContentReviewPoliticalSegmentItem::GetPicUrlExpireTimeStamp() const
{
    return m_picUrlExpireTimeStamp;
}

void MediaContentReviewPoliticalSegmentItem::SetPicUrlExpireTimeStamp(const int64_t& _picUrlExpireTimeStamp)
{
    m_picUrlExpireTimeStamp = _picUrlExpireTimeStamp;
    m_picUrlExpireTimeStampHasBeenSet = true;
}

bool MediaContentReviewPoliticalSegmentItem::PicUrlExpireTimeStampHasBeenSet() const
{
