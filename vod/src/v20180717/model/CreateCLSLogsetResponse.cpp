...
CoreInternalOutcome CreateCLSLogsetResponse::Deserialize(const string &payload)
{
...
string CreateCLSLogsetResponse::ToJsonString() const
{
...
string CreateCLSLogsetResponse::GetLogsetId() const
{
    return m_logsetId;
}

bool CreateCLSLogsetResponse::LogsetIdHasBeenSet() const
{
