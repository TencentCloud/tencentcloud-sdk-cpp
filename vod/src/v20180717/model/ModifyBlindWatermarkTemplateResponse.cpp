...
CoreInternalOutcome ModifyBlindWatermarkTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyBlindWatermarkTemplateResponse::ToJsonString() const
{
