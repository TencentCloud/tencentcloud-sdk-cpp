...
CoreInternalOutcome EnhanceConfigForUpdate::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("VideoEnhance") && !value["VideoEnhance"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `EnhanceConfigForUpdate.VideoEnhance` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AudioEnhance") && !value["AudioEnhance"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `EnhanceConfigForUpdate.AudioEnhance` is not object type").SetRequestId(requestId));
        }
...
void EnhanceConfigForUpdate::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
VideoEnhanceConfig EnhanceConfigForUpdate::GetVideoEnhance() const
{
    return m_videoEnhance;
}

void EnhanceConfigForUpdate::SetVideoEnhance(const VideoEnhanceConfig& _videoEnhance)
{
    m_videoEnhance = _videoEnhance;
    m_videoEnhanceHasBeenSet = true;
}

bool EnhanceConfigForUpdate::VideoEnhanceHasBeenSet() const
{
    return m_videoEnhanceHasBeenSet;
}

AudioEnhanceConfig EnhanceConfigForUpdate::GetAudioEnhance() const
{
    return m_audioEnhance;
}

void EnhanceConfigForUpdate::SetAudioEnhance(const AudioEnhanceConfig& _audioEnhance)
{
    m_audioEnhance = _audioEnhance;
    m_audioEnhanceHasBeenSet = true;
}

bool EnhanceConfigForUpdate::AudioEnhanceHasBeenSet() const
{
