...
CoreInternalOutcome MediaProcessTaskAnimatedGraphicResult::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Progress") && !value["Progress"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MediaProcessTaskAnimatedGraphicResult.Progress` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BeginProcessTime") && !value["BeginProcessTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MediaProcessTaskAnimatedGraphicResult.BeginProcessTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FinishTime") && !value["FinishTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MediaProcessTaskAnimatedGraphicResult.FinishTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
int64_t MediaProcessTaskAnimatedGraphicResult::GetProgress() const
{
    return m_progress;
}

void MediaProcessTaskAnimatedGraphicResult::SetProgress(const int64_t& _progress)
{
    m_progress = _progress;
    m_progressHasBeenSet = true;
}

bool MediaProcessTaskAnimatedGraphicResult::ProgressHasBeenSet() const
{
    return m_progressHasBeenSet;
}

string MediaProcessTaskAnimatedGraphicResult::GetBeginProcessTime() const
{
    return m_beginProcessTime;
}

void MediaProcessTaskAnimatedGraphicResult::SetBeginProcessTime(const string& _beginProcessTime)
{
    m_beginProcessTime = _beginProcessTime;
    m_beginProcessTimeHasBeenSet = true;
}

bool MediaProcessTaskAnimatedGraphicResult::BeginProcessTimeHasBeenSet() const
{
    return m_beginProcessTimeHasBeenSet;
}

string MediaProcessTaskAnimatedGraphicResult::GetFinishTime() const
{
    return m_finishTime;
}

void MediaProcessTaskAnimatedGraphicResult::SetFinishTime(const string& _finishTime)
{
    m_finishTime = _finishTime;
    m_finishTimeHasBeenSet = true;
}

bool MediaProcessTaskAnimatedGraphicResult::FinishTimeHasBeenSet() const
{
