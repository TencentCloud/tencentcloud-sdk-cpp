...
uint64_t ModifyBlindWatermarkTemplateRequest::GetSubAppId() const
{
    return m_subAppId;
}

void ModifyBlindWatermarkTemplateRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool ModifyBlindWatermarkTemplateRequest::SubAppIdHasBeenSet() const
{
