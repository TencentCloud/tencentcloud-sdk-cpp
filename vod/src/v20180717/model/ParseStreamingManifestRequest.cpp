...
string ParseStreamingManifestRequest::ToJsonString() const
{
    ...
    if (m_mediaManifestContentHasBeenSet)
    {
        ...
        d.AddMember(iKey, rapidjson::Value(m_mediaManifestContent.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_manifestTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_manifestType.c_str(), allocator).Move(), allocator);
    }
