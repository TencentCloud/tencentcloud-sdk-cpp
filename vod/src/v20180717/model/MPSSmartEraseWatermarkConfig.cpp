...
CoreInternalOutcome MPSSmartEraseWatermarkConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("WatermarkEraseMethod") && !value["WatermarkEraseMethod"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartEraseWatermarkConfig.WatermarkEraseMethod` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("WatermarkModel") && !value["WatermarkModel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartEraseWatermarkConfig.WatermarkModel` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AutoAreas") && !value["AutoAreas"].IsNull())
    {
        if (!value["AutoAreas"].IsArray())
            return CoreInternalOutcome(Core::Error("response `MPSSmartEraseWatermarkConfig.AutoAreas` is not array type"));
    ...
    if (value.HasMember("CustomAreas") && !value["CustomAreas"].IsNull())
    {
        if (!value["CustomAreas"].IsArray())
            return CoreInternalOutcome(Core::Error("response `MPSSmartEraseWatermarkConfig.CustomAreas` is not array type"));
...
void MPSSmartEraseWatermarkConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MPSSmartEraseWatermarkConfig::GetWatermarkEraseMethod() const
{
    return m_watermarkEraseMethod;
}

void MPSSmartEraseWatermarkConfig::SetWatermarkEraseMethod(const string& _watermarkEraseMethod)
{
    m_watermarkEraseMethod = _watermarkEraseMethod;
    m_watermarkEraseMethodHasBeenSet = true;
}

bool MPSSmartEraseWatermarkConfig::WatermarkEraseMethodHasBeenSet() const
{
    return m_watermarkEraseMethodHasBeenSet;
}

string MPSSmartEraseWatermarkConfig::GetWatermarkModel() const
{
    return m_watermarkModel;
}

void MPSSmartEraseWatermarkConfig::SetWatermarkModel(const string& _watermarkModel)
{
    m_watermarkModel = _watermarkModel;
    m_watermarkModelHasBeenSet = true;
}

bool MPSSmartEraseWatermarkConfig::WatermarkModelHasBeenSet() const
{
    return m_watermarkModelHasBeenSet;
}

vector<MPSEraseArea> MPSSmartEraseWatermarkConfig::GetAutoAreas() const
{
    return m_autoAreas;
}

void MPSSmartEraseWatermarkConfig::SetAutoAreas(const vector<MPSEraseArea>& _autoAreas)
{
    m_autoAreas = _autoAreas;
    m_autoAreasHasBeenSet = true;
}

bool MPSSmartEraseWatermarkConfig::AutoAreasHasBeenSet() const
{
    return m_autoAreasHasBeenSet;
}

vector<MPSEraseTimeArea> MPSSmartEraseWatermarkConfig::GetCustomAreas() const
{
    return m_customAreas;
}

void MPSSmartEraseWatermarkConfig::SetCustomAreas(const vector<MPSEraseTimeArea>& _customAreas)
{
    m_customAreas = _customAreas;
    m_customAreasHasBeenSet = true;
}

bool MPSSmartEraseWatermarkConfig::CustomAreasHasBeenSet() const
{
