...
CoreInternalOutcome PornAsrReviewTemplateInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Switch") && !value["Switch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PornAsrReviewTemplateInfo.Switch` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BlockConfidence") && !value["BlockConfidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PornAsrReviewTemplateInfo.BlockConfidence` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ReviewConfidence") && !value["ReviewConfidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PornAsrReviewTemplateInfo.ReviewConfidence` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string PornAsrReviewTemplateInfo::GetSwitch() const
{
    return m_switch;
}

void PornAsrReviewTemplateInfo::SetSwitch(const string& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool PornAsrReviewTemplateInfo::SwitchHasBeenSet() const
{
    return m_switchHasBeenSet;
}

int64_t PornAsrReviewTemplateInfo::GetBlockConfidence() const
{
    return m_blockConfidence;
}

void PornAsrReviewTemplateInfo::SetBlockConfidence(const int64_t& _blockConfidence)
{
    m_blockConfidence = _blockConfidence;
    m_blockConfidenceHasBeenSet = true;
}

bool PornAsrReviewTemplateInfo::BlockConfidenceHasBeenSet() const
{
    return m_blockConfidenceHasBeenSet;
}

int64_t PornAsrReviewTemplateInfo::GetReviewConfidence() const
{
    return m_reviewConfidence;
}

void PornAsrReviewTemplateInfo::SetReviewConfidence(const int64_t& _reviewConfidence)
{
    m_reviewConfidence = _reviewConfidence;
    m_reviewConfidenceHasBeenSet = true;
}

bool PornAsrReviewTemplateInfo::ReviewConfidenceHasBeenSet() const
{
