...
CoreInternalOutcome ModifyJustInTimeTranscodeTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyJustInTimeTranscodeTemplateResponse::ToJsonString() const
{
