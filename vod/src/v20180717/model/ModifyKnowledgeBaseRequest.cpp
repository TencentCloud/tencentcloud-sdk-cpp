...
uint64_t ModifyKnowledgeBaseRequest::GetSubAppId() const
{
    return m_subAppId;
}

void ModifyKnowledgeBaseRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool ModifyKnowledgeBaseRequest::SubAppIdHasBeenSet() const
{
...
string ModifyKnowledgeBaseRequest::GetName() const
{
    return m_name;
}

void ModifyKnowledgeBaseRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool ModifyKnowledgeBaseRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string ModifyKnowledgeBaseRequest::GetDescription() const
{
    return m_description;
}

void ModifyKnowledgeBaseRequest::SetDescription(const string& _description)
{
    m_description = _description;
    m_descriptionHasBeenSet = true;
}

bool ModifyKnowledgeBaseRequest::DescriptionHasBeenSet() const
{
