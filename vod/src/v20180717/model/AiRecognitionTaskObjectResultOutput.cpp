...
CoreInternalOutcome AiRecognitionTaskObjectResultOutput::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiRecognitionTaskObjectResultOutput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
