...
CoreInternalOutcome ModifyProcessImageAsyncTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyProcessImageAsyncTemplateResponse::ToJsonString() const
{
