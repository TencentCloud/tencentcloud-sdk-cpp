...
CoreInternalOutcome AiRecognitionTaskAsrWordsResultOutput::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiRecognitionTaskAsrWordsResultOutput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
