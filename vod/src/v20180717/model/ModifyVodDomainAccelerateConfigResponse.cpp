...
CoreInternalOutcome ModifyVodDomainAccelerateConfigResponse::Deserialize(const string &payload)
{
...
string ModifyVodDomainAccelerateConfigResponse::ToJsonString() const
{
