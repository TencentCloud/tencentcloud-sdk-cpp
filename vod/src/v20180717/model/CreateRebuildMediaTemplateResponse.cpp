...
CoreInternalOutcome CreateRebuildMediaTemplateResponse::Deserialize(const string &payload)
{
...
string CreateRebuildMediaTemplateResponse::ToJsonString() const
{
...
int64_t CreateRebuildMediaTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateRebuildMediaTemplateResponse::DefinitionHasBeenSet() const
{
