...
MPSSmartSubtitleTemplate::MPSSmartSubtitleTemplate() :
...
CoreInternalOutcome MPSSmartSubtitleTemplate::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Comment") && !value["Comment"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.Comment` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubtitleType") && !value["SubtitleType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.SubtitleType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VideoSrcLanguage") && !value["VideoSrcLanguage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.VideoSrcLanguage` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubtitleFormat") && !value["SubtitleFormat"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.SubtitleFormat` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TranslateSwitch") && !value["TranslateSwitch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.TranslateSwitch` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TranslateDstLanguage") && !value["TranslateDstLanguage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.TranslateDstLanguage` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ProcessType") && !value["ProcessType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.ProcessType` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SelectingSubtitleAreasConfig") && !value["SelectingSubtitleAreasConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.SelectingSubtitleAreasConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SpeakerMode") && !value["SpeakerMode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.SpeakerMode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SpeakerLabel") && !value["SpeakerLabel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartSubtitleTemplate.SpeakerLabel` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void MPSSmartSubtitleTemplate::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MPSSmartSubtitleTemplate::GetName() const
{
    return m_name;
}

void MPSSmartSubtitleTemplate::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string MPSSmartSubtitleTemplate::GetComment() const
{
    return m_comment;
}

void MPSSmartSubtitleTemplate::SetComment(const string& _comment)
{
    m_comment = _comment;
    m_commentHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::CommentHasBeenSet() const
{
    return m_commentHasBeenSet;
}

int64_t MPSSmartSubtitleTemplate::GetSubtitleType() const
{
    return m_subtitleType;
}

void MPSSmartSubtitleTemplate::SetSubtitleType(const int64_t& _subtitleType)
{
    m_subtitleType = _subtitleType;
    m_subtitleTypeHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::SubtitleTypeHasBeenSet() const
{
    return m_subtitleTypeHasBeenSet;
}

string MPSSmartSubtitleTemplate::GetVideoSrcLanguage() const
{
    return m_videoSrcLanguage;
}

void MPSSmartSubtitleTemplate::SetVideoSrcLanguage(const string& _videoSrcLanguage)
{
    m_videoSrcLanguage = _videoSrcLanguage;
    m_videoSrcLanguageHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::VideoSrcLanguageHasBeenSet() const
{
    return m_videoSrcLanguageHasBeenSet;
}

string MPSSmartSubtitleTemplate::GetSubtitleFormat() const
{
    return m_subtitleFormat;
}

void MPSSmartSubtitleTemplate::SetSubtitleFormat(const string& _subtitleFormat)
{
    m_subtitleFormat = _subtitleFormat;
    m_subtitleFormatHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::SubtitleFormatHasBeenSet() const
{
    return m_subtitleFormatHasBeenSet;
}

string MPSSmartSubtitleTemplate::GetTranslateSwitch() const
{
    return m_translateSwitch;
}

void MPSSmartSubtitleTemplate::SetTranslateSwitch(const string& _translateSwitch)
{
    m_translateSwitch = _translateSwitch;
    m_translateSwitchHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::TranslateSwitchHasBeenSet() const
{
    return m_translateSwitchHasBeenSet;
}

string MPSSmartSubtitleTemplate::GetTranslateDstLanguage() const
{
    return m_translateDstLanguage;
}

void MPSSmartSubtitleTemplate::SetTranslateDstLanguage(const string& _translateDstLanguage)
{
    m_translateDstLanguage = _translateDstLanguage;
    m_translateDstLanguageHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::TranslateDstLanguageHasBeenSet() const
{
    return m_translateDstLanguageHasBeenSet;
}

uint64_t MPSSmartSubtitleTemplate::GetProcessType() const
{
    return m_processType;
}

void MPSSmartSubtitleTemplate::SetProcessType(const uint64_t& _processType)
{
    m_processType = _processType;
    m_processTypeHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::ProcessTypeHasBeenSet() const
{
    return m_processTypeHasBeenSet;
}

MPSSelectingSubtitleAreasConfig MPSSmartSubtitleTemplate::GetSelectingSubtitleAreasConfig() const
{
    return m_selectingSubtitleAreasConfig;
}

void MPSSmartSubtitleTemplate::SetSelectingSubtitleAreasConfig(const MPSSelectingSubtitleAreasConfig& _selectingSubtitleAreasConfig)
{
...
void MPSSmartSubtitleTemplate::SetSpeakerMode(const int64_t& _speakerMode)
{
    m_speakerMode = _speakerMode;
    m_speakerModeHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::SpeakerModeHasBeenSet() const
{
    return m_speakerModeHasBeenSet;
}

int64_t MPSSmartSubtitleTemplate::GetSpeakerLabel() const
{
    return m_speakerLabel;
}

void MPSSmartSubtitleTemplate::SetSpeakerLabel(const int64_t& _speakerLabel)
{
    m_speakerLabel = _speakerLabel;
    m_speakerLabelHasBeenSet = true;
}

bool MPSSmartSubtitleTemplate::SpeakerLabelHasBeenSet() const
{
