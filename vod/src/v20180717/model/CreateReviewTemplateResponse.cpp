...
CoreInternalOutcome CreateReviewTemplateResponse::Deserialize(const string &payload)
{
...
string CreateReviewTemplateResponse::ToJsonString() const
{
...
int64_t CreateReviewTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateReviewTemplateResponse::DefinitionHasBeenSet() const
{
