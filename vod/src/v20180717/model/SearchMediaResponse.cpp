...
CoreInternalOutcome SearchMediaResponse::Deserialize(const string &payload)
{
...
string SearchMediaResponse::ToJsonString() const
{
...
uint64_t SearchMediaResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SearchMediaResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MediaInfo> SearchMediaResponse::GetMediaInfoSet() const
{
    return m_mediaInfoSet;
}

bool SearchMediaResponse::MediaInfoSetHasBeenSet() const
{
