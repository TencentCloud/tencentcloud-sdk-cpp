...
CoreInternalOutcome CreateHeadTailTemplateResponse::Deserialize(const string &payload)
{
...
string CreateHeadTailTemplateResponse::ToJsonString() const
{
...
int64_t CreateHeadTailTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateHeadTailTemplateResponse::DefinitionHasBeenSet() const
{
