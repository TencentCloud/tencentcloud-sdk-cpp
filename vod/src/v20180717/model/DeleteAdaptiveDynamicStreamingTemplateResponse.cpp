...
CoreInternalOutcome DeleteAdaptiveDynamicStreamingTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteAdaptiveDynamicStreamingTemplateResponse::ToJsonString() const
{
