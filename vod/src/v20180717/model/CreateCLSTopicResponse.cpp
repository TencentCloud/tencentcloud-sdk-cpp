...
CoreInternalOutcome CreateCLSTopicResponse::Deserialize(const string &payload)
{
...
string CreateCLSTopicResponse::ToJsonString() const
{
...
string CreateCLSTopicResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateCLSTopicResponse::TopicIdHasBeenSet() const
{
