...
CoreInternalOutcome AiSampleTagOperation::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiSampleTagOperation::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
