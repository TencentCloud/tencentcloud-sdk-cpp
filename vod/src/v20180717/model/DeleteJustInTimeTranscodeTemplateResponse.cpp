...
CoreInternalOutcome DeleteJustInTimeTranscodeTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteJustInTimeTranscodeTemplateResponse::ToJsonString() const
{
