...
uint64_t DeleteKnowledgeBaseRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DeleteKnowledgeBaseRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DeleteKnowledgeBaseRequest::SubAppIdHasBeenSet() const
{
