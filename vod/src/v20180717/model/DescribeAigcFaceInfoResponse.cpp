...
DescribeAigcFaceInfoResponse::DescribeAigcFaceInfoResponse() :
    m_faceInfoSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAigcFaceInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("FaceInfoSet") && !rsp["FaceInfoSet"].IsNull())
    {
        if (!rsp["FaceInfoSet"].IsArray())
            return CoreInternalOutcome(Core::Error("response `FaceInfoSet` is not array type"));
...
string DescribeAigcFaceInfoResponse::ToJsonString() const
{
...
vector<AigcFaceInfo> DescribeAigcFaceInfoResponse::GetFaceInfoSet() const
{
    return m_faceInfoSet;
}

bool DescribeAigcFaceInfoResponse::FaceInfoSetHasBeenSet() const
{
