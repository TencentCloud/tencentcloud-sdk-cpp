...
CoreInternalOutcome ModifySnapshotByTimeOffsetTemplateResponse::Deserialize(const string &payload)
{
...
string ModifySnapshotByTimeOffsetTemplateResponse::ToJsonString() const
{
