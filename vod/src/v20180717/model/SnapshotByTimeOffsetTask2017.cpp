...
CoreInternalOutcome SnapshotByTimeOffsetTask2017::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SnapshotInfoSet") && !value["SnapshotInfoSet"].IsNull())
    {
        ...
        const Value &tmpValue = value["SnapshotInfoSet"];
...
void SnapshotByTimeOffsetTask2017::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
