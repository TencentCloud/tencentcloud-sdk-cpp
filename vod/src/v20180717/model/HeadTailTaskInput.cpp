...
CoreInternalOutcome HeadTailTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void HeadTailTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
