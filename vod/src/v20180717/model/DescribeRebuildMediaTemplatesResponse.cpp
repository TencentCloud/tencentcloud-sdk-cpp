...
CoreInternalOutcome DescribeRebuildMediaTemplatesResponse::Deserialize(const string &payload)
{
...
string DescribeRebuildMediaTemplatesResponse::ToJsonString() const
{
...
int64_t DescribeRebuildMediaTemplatesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRebuildMediaTemplatesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RebuildMediaTemplate> DescribeRebuildMediaTemplatesResponse::GetRebuildMediaTemplateSet() const
{
    return m_rebuildMediaTemplateSet;
}

bool DescribeRebuildMediaTemplatesResponse::RebuildMediaTemplateSetHasBeenSet() const
{
