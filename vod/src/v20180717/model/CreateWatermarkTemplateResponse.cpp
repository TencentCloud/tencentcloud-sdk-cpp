...
CoreInternalOutcome CreateWatermarkTemplateResponse::Deserialize(const string &payload)
{
...
string CreateWatermarkTemplateResponse::ToJsonString() const
{
...
int64_t CreateWatermarkTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateWatermarkTemplateResponse::DefinitionHasBeenSet() const
{
    return m_definitionHasBeenSet;
}

string CreateWatermarkTemplateResponse::GetImageUrl() const
{
    return m_imageUrl;
}

bool CreateWatermarkTemplateResponse::ImageUrlHasBeenSet() const
{
