...
CoreInternalOutcome SceneAigcImageOutputConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("StorageMode") && !value["StorageMode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneAigcImageOutputConfig.StorageMode` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediaName") && !value["MediaName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneAigcImageOutputConfig.MediaName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ClassId") && !value["ClassId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneAigcImageOutputConfig.ClassId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ExpireTime") && !value["ExpireTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneAigcImageOutputConfig.ExpireTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void SceneAigcImageOutputConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string SceneAigcImageOutputConfig::GetStorageMode() const
{
    return m_storageMode;
}

void SceneAigcImageOutputConfig::SetStorageMode(const string& _storageMode)
{
    m_storageMode = _storageMode;
    m_storageModeHasBeenSet = true;
}

bool SceneAigcImageOutputConfig::StorageModeHasBeenSet() const
{
    return m_storageModeHasBeenSet;
}

string SceneAigcImageOutputConfig::GetMediaName() const
{
    return m_mediaName;
}

void SceneAigcImageOutputConfig::SetMediaName(const string& _mediaName)
{
    m_mediaName = _mediaName;
    m_mediaNameHasBeenSet = true;
}

bool SceneAigcImageOutputConfig::MediaNameHasBeenSet() const
{
    return m_mediaNameHasBeenSet;
}

int64_t SceneAigcImageOutputConfig::GetClassId() const
{
    return m_classId;
}

void SceneAigcImageOutputConfig::SetClassId(const int64_t& _classId)
{
    m_classId = _classId;
    m_classIdHasBeenSet = true;
}

bool SceneAigcImageOutputConfig::ClassIdHasBeenSet() const
{
    return m_classIdHasBeenSet;
}

string SceneAigcImageOutputConfig::GetExpireTime() const
{
    return m_expireTime;
}

void SceneAigcImageOutputConfig::SetExpireTime(const string& _expireTime)
{
