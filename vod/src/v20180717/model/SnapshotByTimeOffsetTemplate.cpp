...
CoreInternalOutcome SnapshotByTimeOffsetTemplate::Deserialize(const Value &value)
{
    string requestId = "";
...
void SnapshotByTimeOffsetTemplate::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
