...
CoreInternalOutcome PornConfigureInfoForUpdate::Deserialize(const Value &value)
{
    string requestId = "";
...
void PornConfigureInfoForUpdate::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
