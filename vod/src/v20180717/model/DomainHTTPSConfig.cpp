...
CoreInternalOutcome DomainHTTPSConfig::Deserialize(const Value &value)
{
    string requestId = "";
...
void DomainHTTPSConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
