...
CoreInternalOutcome CreateQualityInspectTemplateResponse::Deserialize(const string &payload)
{
...
string CreateQualityInspectTemplateResponse::ToJsonString() const
{
...
int64_t CreateQualityInspectTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateQualityInspectTemplateResponse::DefinitionHasBeenSet() const
{
