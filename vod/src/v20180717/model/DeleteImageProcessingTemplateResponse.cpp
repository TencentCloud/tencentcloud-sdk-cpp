...
CoreInternalOutcome DeleteImageProcessingTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteImageProcessingTemplateResponse::ToJsonString() const
{
