...
CoreInternalOutcome MPSRawSmartEraseParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EraseType") && !value["EraseType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.EraseType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseSubtitleConfig") && !value["EraseSubtitleConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.EraseSubtitleConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseWatermarkConfig") && !value["EraseWatermarkConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.EraseWatermarkConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErasePrivacyConfig") && !value["ErasePrivacyConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.ErasePrivacyConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubtitleEmbedId") && !value["SubtitleEmbedId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.SubtitleEmbedId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UseOriginalPos") && !value["UseOriginalPos"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.UseOriginalPos` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UseOriginalSize") && !value["UseOriginalSize"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSRawSmartEraseParameter.UseOriginalSize` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void MPSRawSmartEraseParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MPSRawSmartEraseParameter::GetEraseType() const
{
    return m_eraseType;
}

void MPSRawSmartEraseParameter::SetEraseType(const string& _eraseType)
{
    m_eraseType = _eraseType;
    m_eraseTypeHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::EraseTypeHasBeenSet() const
{
    return m_eraseTypeHasBeenSet;
}

MPSSmartEraseSubtitleConfig MPSRawSmartEraseParameter::GetEraseSubtitleConfig() const
{
    return m_eraseSubtitleConfig;
}

void MPSRawSmartEraseParameter::SetEraseSubtitleConfig(const MPSSmartEraseSubtitleConfig& _eraseSubtitleConfig)
{
    m_eraseSubtitleConfig = _eraseSubtitleConfig;
    m_eraseSubtitleConfigHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::EraseSubtitleConfigHasBeenSet() const
{
    return m_eraseSubtitleConfigHasBeenSet;
}

MPSSmartEraseWatermarkConfig MPSRawSmartEraseParameter::GetEraseWatermarkConfig() const
{
    return m_eraseWatermarkConfig;
}

void MPSRawSmartEraseParameter::SetEraseWatermarkConfig(const MPSSmartEraseWatermarkConfig& _eraseWatermarkConfig)
{
    m_eraseWatermarkConfig = _eraseWatermarkConfig;
    m_eraseWatermarkConfigHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::EraseWatermarkConfigHasBeenSet() const
{
    return m_eraseWatermarkConfigHasBeenSet;
}

MPSSmartErasePrivacyConfig MPSRawSmartEraseParameter::GetErasePrivacyConfig() const
{
    return m_erasePrivacyConfig;
}

void MPSRawSmartEraseParameter::SetErasePrivacyConfig(const MPSSmartErasePrivacyConfig& _erasePrivacyConfig)
{
    m_erasePrivacyConfig = _erasePrivacyConfig;
    m_erasePrivacyConfigHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::ErasePrivacyConfigHasBeenSet() const
{
    return m_erasePrivacyConfigHasBeenSet;
}

int64_t MPSRawSmartEraseParameter::GetSubtitleEmbedId() const
{
    return m_subtitleEmbedId;
}

void MPSRawSmartEraseParameter::SetSubtitleEmbedId(const int64_t& _subtitleEmbedId)
{
    m_subtitleEmbedId = _subtitleEmbedId;
    m_subtitleEmbedIdHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::SubtitleEmbedIdHasBeenSet() const
{
    return m_subtitleEmbedIdHasBeenSet;
}

int64_t MPSRawSmartEraseParameter::GetUseOriginalPos() const
{
    return m_useOriginalPos;
}

void MPSRawSmartEraseParameter::SetUseOriginalPos(const int64_t& _useOriginalPos)
{
    m_useOriginalPos = _useOriginalPos;
    m_useOriginalPosHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::UseOriginalPosHasBeenSet() const
{
    return m_useOriginalPosHasBeenSet;
}

int64_t MPSRawSmartEraseParameter::GetUseOriginalSize() const
{
    return m_useOriginalSize;
}

void MPSRawSmartEraseParameter::SetUseOriginalSize(const int64_t& _useOriginalSize)
{
    m_useOriginalSize = _useOriginalSize;
    m_useOriginalSizeHasBeenSet = true;
}

bool MPSRawSmartEraseParameter::UseOriginalSizeHasBeenSet() const
{
