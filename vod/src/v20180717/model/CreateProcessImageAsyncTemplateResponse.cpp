...
CoreInternalOutcome CreateProcessImageAsyncTemplateResponse::Deserialize(const string &payload)
{
...
string CreateProcessImageAsyncTemplateResponse::ToJsonString() const
{
...
int64_t CreateProcessImageAsyncTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateProcessImageAsyncTemplateResponse::DefinitionHasBeenSet() const
{
