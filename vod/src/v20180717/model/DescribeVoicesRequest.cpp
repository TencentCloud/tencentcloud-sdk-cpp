...
string DescribeVoicesRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DescribeVoicesRequest::SetSubAppId(const string& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DescribeVoicesRequest::SubAppIdHasBeenSet() const
{
