...
CoreInternalOutcome ModifyWatermarkTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyWatermarkTemplateResponse::ToJsonString() const
{
...
string ModifyWatermarkTemplateResponse::GetImageUrl() const
{
    return m_imageUrl;
}

bool ModifyWatermarkTemplateResponse::ImageUrlHasBeenSet() const
{
