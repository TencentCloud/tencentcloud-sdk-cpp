...
CoreInternalOutcome DeleteSampleSnapshotTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteSampleSnapshotTemplateResponse::ToJsonString() const
{
