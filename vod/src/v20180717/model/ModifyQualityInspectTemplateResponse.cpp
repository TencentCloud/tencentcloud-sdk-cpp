...
CoreInternalOutcome ModifyQualityInspectTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyQualityInspectTemplateResponse::ToJsonString() const
{
