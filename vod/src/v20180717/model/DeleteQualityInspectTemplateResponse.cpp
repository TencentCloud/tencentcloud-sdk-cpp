...
CoreInternalOutcome DeleteQualityInspectTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteQualityInspectTemplateResponse::ToJsonString() const
{
