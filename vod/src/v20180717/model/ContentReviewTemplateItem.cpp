...
CoreInternalOutcome ContentReviewTemplateItem::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ReviewWallSwitch") && !value["ReviewWallSwitch"].IsNull())
    {
...
string ContentReviewTemplateItem::GetReviewWallSwitch() const
{
    return m_reviewWallSwitch;
}

void ContentReviewTemplateItem::SetReviewWallSwitch(const string& _reviewWallSwitch)
{
    m_reviewWallSwitch = _reviewWallSwitch;
    m_reviewWallSwitchHasBeenSet = true;
}

bool ContentReviewTemplateItem::ReviewWallSwitchHasBeenSet() const
{
    return m_reviewWallSwitchHasBeenSet;
}

double ContentReviewTemplateItem::GetScreenshotInterval() const
{
    return m_screenshotInterval;
}

void ContentReviewTemplateItem::SetScreenshotInterval(const double& _screenshotInterval)
{
    m_screenshotInterval = _screenshotInterval;
    m_screenshotIntervalHasBeenSet = true;
}

bool ContentReviewTemplateItem::ScreenshotIntervalHasBeenSet() const
{
