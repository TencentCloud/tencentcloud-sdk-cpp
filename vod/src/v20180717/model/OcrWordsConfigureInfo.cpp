...
CoreInternalOutcome OcrWordsConfigureInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void OcrWordsConfigureInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
