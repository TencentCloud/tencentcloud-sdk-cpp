...
CoreInternalOutcome MediaTranscodeInfo::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TranscodeSet") && !value["TranscodeSet"].IsNull())
    {
        ...
        const Value &tmpValue = value["TranscodeSet"];
...
void MediaTranscodeInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
