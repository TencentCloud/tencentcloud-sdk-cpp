...
CoreInternalOutcome PornImgReviewTemplateInfoForUpdate::Deserialize(const Value &value)
{
    string requestId = "";
...
void PornImgReviewTemplateInfoForUpdate::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
