...
string CreateCLSLogsetRequest::GetCLSRegion() const
{
    return m_cLSRegion;
}

void CreateCLSLogsetRequest::SetCLSRegion(const string& _cLSRegion)
{
    m_cLSRegion = _cLSRegion;
    m_cLSRegionHasBeenSet = true;
}

bool CreateCLSLogsetRequest::CLSRegionHasBeenSet() const
{
