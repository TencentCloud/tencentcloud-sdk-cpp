...
CoreInternalOutcome MediaProcessTaskAdaptiveDynamicStreamingResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void MediaProcessTaskAdaptiveDynamicStreamingResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
