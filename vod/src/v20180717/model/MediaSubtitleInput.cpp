...
CoreInternalOutcome MediaSubtitleInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void MediaSubtitleInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
