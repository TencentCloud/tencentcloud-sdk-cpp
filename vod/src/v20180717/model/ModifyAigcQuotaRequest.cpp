...
string ModifyAigcQuotaRequest::ToJsonString() const
{
...
uint64_t ModifyAigcQuotaRequest::GetSubAppId() const
{
    return m_subAppId;
}

void ModifyAigcQuotaRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool ModifyAigcQuotaRequest::SubAppIdHasBeenSet() const
{
    return m_subAppIdHasBeenSet;
}

string ModifyAigcQuotaRequest::GetQuotaType() const
{
    return m_quotaType;
}

void ModifyAigcQuotaRequest::SetQuotaType(const string& _quotaType)
{
    m_quotaType = _quotaType;
    m_quotaTypeHasBeenSet = true;
}

bool ModifyAigcQuotaRequest::QuotaTypeHasBeenSet() const
{
    return m_quotaTypeHasBeenSet;
}

uint64_t ModifyAigcQuotaRequest::GetQuotaLimit() const
{
    return m_quotaLimit;
}

void ModifyAigcQuotaRequest::SetQuotaLimit(const uint64_t& _quotaLimit)
{
    m_quotaLimit = _quotaLimit;
    m_quotaLimitHasBeenSet = true;
}

bool ModifyAigcQuotaRequest::QuotaLimitHasBeenSet() const
{
    return m_quotaLimitHasBeenSet;
}

string ModifyAigcQuotaRequest::GetApiToken() const
{
    return m_apiToken;
}

void ModifyAigcQuotaRequest::SetApiToken(const string& _apiToken)
{
    m_apiToken = _apiToken;
    m_apiTokenHasBeenSet = true;
}

bool ModifyAigcQuotaRequest::ApiTokenHasBeenSet() const
{
