...
CoreInternalOutcome CreateEnhanceMediaTemplateResponse::Deserialize(const string &payload)
{
...
string CreateEnhanceMediaTemplateResponse::ToJsonString() const
{
...
int64_t CreateEnhanceMediaTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateEnhanceMediaTemplateResponse::DefinitionHasBeenSet() const
{
