...
CoreInternalOutcome DescribeAigcQuotasResponse::Deserialize(const string &payload)
{
...
string DescribeAigcQuotasResponse::ToJsonString() const
{
...
vector<AigcQuotaItem> DescribeAigcQuotasResponse::GetQuotaSet() const
{
    return m_quotaSet;
}

bool DescribeAigcQuotasResponse::QuotaSetHasBeenSet() const
{
    return m_quotaSetHasBeenSet;
}

uint64_t DescribeAigcQuotasResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAigcQuotasResponse::TotalCountHasBeenSet() const
{
