...
CoreInternalOutcome CreateAIRecognitionTemplateResponse::Deserialize(const string &payload)
{
...
string CreateAIRecognitionTemplateResponse::ToJsonString() const
{
...
int64_t CreateAIRecognitionTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateAIRecognitionTemplateResponse::DefinitionHasBeenSet() const
{
