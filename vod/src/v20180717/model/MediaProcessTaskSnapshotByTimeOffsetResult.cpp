...
CoreInternalOutcome MediaProcessTaskSnapshotByTimeOffsetResult::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Progress") && !value["Progress"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MediaProcessTaskSnapshotByTimeOffsetResult.Progress` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
int64_t MediaProcessTaskSnapshotByTimeOffsetResult::GetProgress() const
{
    return m_progress;
}

void MediaProcessTaskSnapshotByTimeOffsetResult::SetProgress(const int64_t& _progress)
{
    m_progress = _progress;
    m_progressHasBeenSet = true;
}

bool MediaProcessTaskSnapshotByTimeOffsetResult::ProgressHasBeenSet() const
{
