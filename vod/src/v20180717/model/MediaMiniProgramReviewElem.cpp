...
CoreInternalOutcome MediaMiniProgramReviewElem::Deserialize(const Value &value)
{
    string requestId = "";
...
void MediaMiniProgramReviewElem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
