...
CoreInternalOutcome MPSSmartErasePrivacyConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("PrivacyModel") && !value["PrivacyModel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MPSSmartErasePrivacyConfig.PrivacyModel` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PrivacyTargets") && !value["PrivacyTargets"].IsNull())
    {
        if (!value["PrivacyTargets"].IsArray())
            return CoreInternalOutcome(Core::Error("response `MPSSmartErasePrivacyConfig.PrivacyTargets` is not array type"));
...
void MPSSmartErasePrivacyConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MPSSmartErasePrivacyConfig::GetPrivacyModel() const
{
    return m_privacyModel;
}

void MPSSmartErasePrivacyConfig::SetPrivacyModel(const string& _privacyModel)
{
    m_privacyModel = _privacyModel;
    m_privacyModelHasBeenSet = true;
}

bool MPSSmartErasePrivacyConfig::PrivacyModelHasBeenSet() const
{
    return m_privacyModelHasBeenSet;
}

vector<string> MPSSmartErasePrivacyConfig::GetPrivacyTargets() const
{
    return m_privacyTargets;
}

void MPSSmartErasePrivacyConfig::SetPrivacyTargets(const vector<string>& _privacyTargets)
{
    m_privacyTargets = _privacyTargets;
    m_privacyTargetsHasBeenSet = true;
}

bool MPSSmartErasePrivacyConfig::PrivacyTargetsHasBeenSet() const
{
