...
uint64_t DescribeTaskDetailRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DescribeTaskDetailRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DescribeTaskDetailRequest::SubAppIdHasBeenSet() const
{
