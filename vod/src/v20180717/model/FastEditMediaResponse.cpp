...
CoreInternalOutcome FastEditMediaResponse::Deserialize(const string &payload)
{
...
string FastEditMediaResponse::ToJsonString() const
{
...
string FastEditMediaResponse::GetFileId() const
{
    return m_fileId;
}

bool FastEditMediaResponse::FileIdHasBeenSet() const
{
    return m_fileIdHasBeenSet;
}

string FastEditMediaResponse::GetUrl() const
{
    return m_url;
}

bool FastEditMediaResponse::UrlHasBeenSet() const
{
