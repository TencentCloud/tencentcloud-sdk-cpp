...
string DescribeCLSLogsetsRequest::ToJsonString() const
{
...
string DescribeCLSLogsetsRequest::GetCLSRegion() const
{
    return m_cLSRegion;
}

void DescribeCLSLogsetsRequest::SetCLSRegion(const string& _cLSRegion)
{
    m_cLSRegion = _cLSRegion;
    m_cLSRegionHasBeenSet = true;
}

bool DescribeCLSLogsetsRequest::CLSRegionHasBeenSet() const
{
