...
uint64_t DescribeAdaptiveDynamicStreamingTemplatesRequest::GetSubAppId() const
{
    return m_subAppId;
}

void DescribeAdaptiveDynamicStreamingTemplatesRequest::SetSubAppId(const uint64_t& _subAppId)
{
    m_subAppId = _subAppId;
    m_subAppIdHasBeenSet = true;
}

bool DescribeAdaptiveDynamicStreamingTemplatesRequest::SubAppIdHasBeenSet() const
{
