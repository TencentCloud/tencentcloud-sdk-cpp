...
CoreInternalOutcome ModifyAnimatedGraphicsTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyAnimatedGraphicsTemplateResponse::ToJsonString() const
{
