...
CoreInternalOutcome ImageWatermarkInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void ImageWatermarkInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
