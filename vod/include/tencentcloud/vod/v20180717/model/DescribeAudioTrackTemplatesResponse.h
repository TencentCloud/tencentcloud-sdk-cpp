...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEAUDIOTRACKTEMPLATESRESPONSE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEAUDIOTRACKTEMPLATESRESPONSE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeAudioTrackTemplatesResponse : public AbstractModel
                {
                public:
                    DescribeAudioTrackTemplatesResponse();
                    ~DescribeAudioTrackTemplatesResponse() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEAUDIOTRACKTEMPLATESRESPONSE_H_
