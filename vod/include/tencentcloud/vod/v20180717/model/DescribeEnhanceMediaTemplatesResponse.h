...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEENHANCEMEDIATEMPLATESRESPONSE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEENHANCEMEDIATEMPLATESRESPONSE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeEnhanceMediaTemplatesResponse : public AbstractModel
                {
                public:
                    DescribeEnhanceMediaTemplatesResponse();
                    ~DescribeEnhanceMediaTemplatesResponse() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEENHANCEMEDIATEMPLATESRESPONSE_H_
