...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_TEXTTOSPEECHASYNCTASK_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_TEXTTOSPEECHASYNCTASK_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * 语音合成任务。
                */
                class TextToSpeechAsyncTask : public AbstractModel
                {
                public:
                    TextToSpeechAsyncTask();
                    ~TextToSpeechAsyncTask() = default;
                    ...
                    /**
                     * 获取<p>语音合成任务输入信息。</p>
                     * @return Input <p>语音合成任务输入信息。</p>
                     * 
                     */
                    TextToSpeechAsyncInput GetInput() const;
                     ...
                     * 
                     */
                    void SetInput(const TextToSpeechAsyncInput& _input);
                    ...
                    /**
                     * 获取<p>语音合成任务输出信息。</p>
                     * @return Output <p>语音合成任务输出信息。</p>
                     * 
                     */
                    TextToSpeechAsyncOutput GetOutput() const;
                     ...
                     * 
                     */
                    void SetOutput(const TextToSpeechAsyncOutput& _output);
                ...
                private:
                     ...
                     * <p>语音合成任务输入信息。</p>
                     */
                    TextToSpeechAsyncInput m_input;
                    bool m_inputHasBeenSet;

                    /**
                     * <p>语音合成任务输出信息。</p>
                     */
                    TextToSpeechAsyncOutput m_output;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_TEXTTOSPEECHASYNCTASK_H_
