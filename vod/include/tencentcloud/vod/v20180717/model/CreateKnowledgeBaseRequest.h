...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_CREATEKNOWLEDGEBASEREQUEST_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_CREATEKNOWLEDGEBASEREQUEST_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class CreateKnowledgeBaseRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>知识库名称。长度限制：1-64个字符。</p>
                     * @return Name <p>知识库名称。长度限制：1-64个字符。</p>
                     * 
                     */
                    std::string GetName() const;

                    /**
                     * 设置<p>知识库名称。长度限制：1-64个字符。</p>
                    ...
                    /**
                     * 获取<p>知识库描述。长度限制：最多256个字符。</p>
                     * @return Description <p>知识库描述。长度限制：最多256个字符。</p>
                     * 
                     */
                    std::string GetDescription() const;

                    /**
                     * 设置<p>知识库描述。长度限制：最多256个字符。</p>
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_CREATEKNOWLEDGEBASEREQUEST_H_
