...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEDAILYMEDIAPLAYSTATRESPONSE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEDAILYMEDIAPLAYSTATRESPONSE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeDailyMediaPlayStatResponse : public AbstractModel
                {
                public:
                    DescribeDailyMediaPlayStatResponse();
                    ~DescribeDailyMediaPlayStatResponse() = default;
                    ...
                    /**
                     * 获取播放统计数据。
                     * @return DailyPlayStatInfoSet 播放统计数据。
                     * 
                     */
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEDAILYMEDIAPLAYSTATRESPONSE_H_
