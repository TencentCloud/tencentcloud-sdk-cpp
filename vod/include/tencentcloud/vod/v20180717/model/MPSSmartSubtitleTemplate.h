...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTSUBTITLETEMPLATE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTSUBTITLETEMPLATE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * MPS智能字幕模板输入
                */
                class MPSSmartSubtitleTemplate : public AbstractModel
                {
                public:
                    MPSSmartSubtitleTemplate();
                    ~MPSSmartSubtitleTemplate() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTSUBTITLETEMPLATE_H_
