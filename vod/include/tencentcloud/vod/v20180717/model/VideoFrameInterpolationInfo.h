...
<li>OFF：关闭智能插帧。</li>
                    ...
                    /**
                     * 获取智能插帧帧率，帧率范围为 (0, 60]，仅当智能插帧控制开关为 ON 时有效。默认跟源文件帧率一致。
                     * @return Fps 智能插帧帧率，帧率范围为 (0, 60]，仅当智能插帧控制开关为 ON 时有效。默认跟源文件帧率一致。
                     */
                    int64_t GetFps() const;

                    /**
                     * 设置智能插帧帧率，帧率范围为 (0, 60]，仅当智能插帧控制开关为 ON 时有效。默认跟源文件帧率一致。
