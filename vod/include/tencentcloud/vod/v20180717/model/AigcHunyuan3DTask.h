...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_AIGCHUNYUAN3DTASK_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_AIGCHUNYUAN3DTASK_H_
...
#include <tencentcloud/vod/v20180717/model/AigcHunyuan3DTaskOutput.h>
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * AIGC 混元 3D 任务信息。
                */
                class AigcHunyuan3DTask : public AbstractModel
                {
                public:
                    AigcHunyuan3DTask();
                    ~AigcHunyuan3DTask() = default;
                    ...
                    /**
                     * 获取<p>AIGC 混元 3D 任务的输入信息。</p>
                     * @return Input <p>AIGC 混元 3D 任务的输入信息。</p>
                     * 
                     */
                    AigcHunyuan3DTaskInput GetInput() const;

                    /**
                     * 设置<p>AIGC 混元 3D 任务的输入信息。</p>
                     * @param _input <p>AIGC 混元 3D 任务的输入信息。</p>
                     * 
                     */
                    void SetInput(const AigcHunyuan3DTaskInput& _input);
                    ...
                    /**
                     * 获取<p>AIGC 混元 3D 任务的输出信息。</p>
                     * @return Output <p>AIGC 混元 3D 任务的输出信息。</p>
                     * 
                     */
                    AigcHunyuan3DTaskOutput GetOutput() const;

                    /**
                     * 设置<p>AIGC 混元 3D 任务的输出信息。</p>
                     * @param _output <p>AIGC 混元 3D 任务的输出信息。</p>
                     * 
                     */
                    void SetOutput(const AigcHunyuan3DTaskOutput& _output);
                ...
                private:
                     ...
                     */
                    AigcHunyuan3DTaskInput m_input;
                    bool m_inputHasBeenSet;

                    /**
                     * <p>AIGC 混元 3D 任务的输出信息。</p>
                     */
                    AigcHunyuan3DTaskOutput m_output;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_AIGCHUNYUAN3DTASK_H_
