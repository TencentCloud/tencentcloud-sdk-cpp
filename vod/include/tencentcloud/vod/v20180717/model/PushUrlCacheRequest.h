...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_PUSHURLCACHEREQUEST_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_PUSHURLCACHEREQUEST_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * PushUrlCache请求参数结构体
                */
                class PushUrlCacheRequest : public AbstractModel
                {
                public:
                    PushUrlCacheRequest();
                    ~PushUrlCacheRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>预热的 URL 列表，单次最多指定20个 URL。</p>
                    ...
                    /**
                     * 设置<p>预热的 URL 列表，单次最多指定20个 URL。</p>
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_PUSHURLCACHEREQUEST_H_
