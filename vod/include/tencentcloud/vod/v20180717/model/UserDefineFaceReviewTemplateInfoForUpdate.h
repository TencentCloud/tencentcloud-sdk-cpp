...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_USERDEFINEFACEREVIEWTEMPLATEINFOFORUPDATE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_USERDEFINEFACEREVIEWTEMPLATEINFOFORUPDATE_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取用户自定义人物音视频审核任务开关，可选值：
<li>ON：开启自定义人物音视频审核任务；</li>
<li>OFF：关闭自定义人物音视频审核任务。</li>
                     * @return Switch 用户自定义人物音视频审核任务开关，可选值：
<li>ON：开启自定义人物音视频审核任务；</li>
<li>OFF：关闭自定义人物音视频审核任务。</li>
                     * 
                     */
...
<li>OFF：关闭自定义人物音视频审核任务。</li>
                    ...
                    /**
                     * 获取用户自定义人物过滤标签，音视频审核结果包含选择的标签则返回结果，如果过滤标签为空，则音视频审核结果全部返回。如果要使用标签过滤功能，添加自定义人物库的时，需要添加对应人物标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
                     * @return LabelSet 用户自定义人物过滤标签，音视频审核结果包含选择的标签则返回结果，如果过滤标签为空，则音视频审核结果全部返回。如果要使用标签过滤功能，添加自定义人物库的时，需要添加对应人物标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
                     * 
                     */
                    ...
                    /**
                     * 设置用户自定义人物过滤标签，音视频审核结果包含选择的标签则返回结果，如果过滤标签为空，则音视频审核结果全部返回。如果要使用标签过滤功能，添加自定义人物库的时，需要添加对应人物标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
...
标签个数最多 10 个，每个标签长度最多 16 个字符。
                    ...
                    /**
                     * 获取判定涉嫌违规的分数阈值，当音视频审核达到该分数以上，认为涉嫌违规。取值范围：0~100。
                     * @return BlockConfidence 判定涉嫌违规的分数阈值，当音视频审核达到该分数以上，认为涉嫌违规。取值范围：0~100。
                     * 
                     */
                    int64_t GetBlockConfidence() const;

                    /**
                     * 设置判定涉嫌违规的分数阈值，当音视频审核达到该分数以上，认为涉嫌违规。取值范围：0~100。
                    ...
                    /**
                     * 获取判定需人工复核是否违规的分数阈值，当音视频审核达到该分数以上，认为需人工复核。取值范围：0~100。
                     * @return ReviewConfidence 判定需人工复核是否违规的分数阈值，当音视频审核达到该分数以上，认为需人工复核。取值范围：0~100。
                     * 
                     */
                    int64_t GetReviewConfidence() const;

                    /**
                     * 设置判定需人工复核是否违规的分数阈值，当音视频审核达到该分数以上，认为需人工复核。取值范围：0~100。
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_USERDEFINEFACEREVIEWTEMPLATEINFOFORUPDATE_H_
