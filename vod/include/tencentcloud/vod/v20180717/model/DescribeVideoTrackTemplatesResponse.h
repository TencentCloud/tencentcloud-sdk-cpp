...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEVIDEOTRACKTEMPLATESRESPONSE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEVIDEOTRACKTEMPLATESRESPONSE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoTrackTemplatesResponse : public AbstractModel
                {
                public:
                    DescribeVideoTrackTemplatesResponse();
                    ~DescribeVideoTrackTemplatesResponse() = default;
                    ...
                    /**
                     * 获取视频轨模板详情列表。
                     * @return VideoTrackTemplateSet 视频轨模板详情列表。
                     */
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEVIDEOTRACKTEMPLATESRESPONSE_H_
