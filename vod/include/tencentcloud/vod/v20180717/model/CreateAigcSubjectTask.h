            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>创建 AIGC 主体输入信息。</p>
                     * @return Input <p>创建 AIGC 主体输入信息。</p>
                     * 
                     */
                    CreateAigcSubjectInput GetInput() const;

                    /**
                     * 设置<p>创建 AIGC 主体输入信息。</p>
                     * @param _input <p>创建 AIGC 主体输入信息。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>创建 AIGC 主体输出信息。</p>
                     * @return Output <p>创建 AIGC 主体输出信息。</p>
                     * 
                     */
                    CreateAigcSubjectOutput GetOutput() const;

                    /**
                     * 设置<p>创建 AIGC 主体输出信息。</p>
                     * @param _output <p>创建 AIGC 主体输出信息。</p>
                     * 
                     */
