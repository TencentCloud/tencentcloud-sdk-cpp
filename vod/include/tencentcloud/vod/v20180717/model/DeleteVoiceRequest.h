...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DELETEVOICEREQUEST_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DELETEVOICEREQUEST_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * DeleteVoice请求参数结构体
                */
                class DeleteVoiceRequest : public AbstractModel
                {
                public:
                    DeleteVoiceRequest();
                    ~DeleteVoiceRequest() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DELETEVOICEREQUEST_H_
