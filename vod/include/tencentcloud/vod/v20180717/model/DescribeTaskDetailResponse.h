...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>AIGC 视频转绘信息，仅当 TaskType 为 AigcVideoRedrawTask，该字段有值。</p>
                    ...
                    /**
                     * 获取<p>AIGC音效信息，仅当 TaskType 为 AigcAudioTask，该字段有值。</p>
                    ...
                    /**
                     * 获取<p>AIGC 声音复刻信息，仅当 TaskType 为 CreateAigcAudioClone，该字段有值。</p>
                    ...
                    /**
                     * 获取<p>异步获取 AIGC 人脸信息，仅当 TaskType 为 DescribeAigcFaceInfoAsync，该字段有值。</p>
