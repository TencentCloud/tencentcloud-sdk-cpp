...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_GENERALFASTOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_GENERALFASTOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class GeneralFastOCRRequest : public AbstractModel
                {
                public:
                    GeneralFastOCRRequest();
                    ~GeneralFastOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_GENERALFASTOCRREQUEST_H_
