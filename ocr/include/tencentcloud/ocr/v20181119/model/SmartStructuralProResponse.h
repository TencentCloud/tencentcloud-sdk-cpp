...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_SMARTSTRUCTURALPRORESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_SMARTSTRUCTURALPRORESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class SmartStructuralProResponse : public AbstractModel
                {
                public:
                    SmartStructuralProResponse();
                    ~SmartStructuralProResponse() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_SMARTSTRUCTURALPRORESPONSE_H_
