...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_VERIFYBIZLICENSEENTERPRISE3REQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_VERIFYBIZLICENSEENTERPRISE3REQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class VerifyBizLicenseEnterprise3Request : public AbstractModel
                {
                public:
                    VerifyBizLicenseEnterprise3Request();
                    ~VerifyBizLicenseEnterprise3Request() = default;
                    ...
                    /**
                     * 获取<p>核验类型 </p><p>枚举值：</p><ul><li>ENT_2META： 企业名称 、统一社会信用代码</li><li>ENT_3META： 企业名称 、统一社会信用代码 、法人代表名称</li></ul>
                    ...
                    /**
                     * 设置<p>核验类型 </p><p>枚举值：</p><ul><li>ENT_2META： 企业名称 、统一社会信用代码</li><li>ENT_3META： 企业名称 、统一社会信用代码 、法人代表名称</li></ul>
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_VERIFYBIZLICENSEENTERPRISE3REQUEST_H_
