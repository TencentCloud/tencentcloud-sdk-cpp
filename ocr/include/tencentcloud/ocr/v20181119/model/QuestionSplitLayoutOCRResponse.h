...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRRESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRRESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class QuestionSplitLayoutOCRResponse : public AbstractModel
                {
                public:
                    QuestionSplitLayoutOCRResponse();
                    ~QuestionSplitLayoutOCRResponse() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRRESPONSE_H_
