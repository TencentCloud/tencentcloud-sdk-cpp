...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEPERMITINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEPERMITINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 港澳台居住证信息返回
                */
                class ResidencePermitInfo : public AbstractModel
                {
                public:
                    ResidencePermitInfo();
                    ~ResidencePermitInfo() = default;
                    ...
                    /**
                     * 获取通行证号码，港澳台居住证国徽面 返回该字段
                     * @return PassNum 通行证号码，港澳台居住证国徽面 返回该字段
                     * 
                     */
                    ContentInfo GetPassNum() const;

                    /**
                     * 设置通行证号码，港澳台居住证国徽面 返回该字段
                     * @param _passNum 通行证号码，港澳台居住证国徽面 返回该字段
                     * 
                     */
                    void SetPassNum(const ContentInfo& _passNum);

                    /**
                     * 判断参数 PassNum 是否已赋值
                     * @return PassNum 是否已赋值
                     * 
                     */
                    bool PassNumHasBeenSet() const;

                    /**
                     * 获取签发次数，港澳台居住证国徽面 返回该字段
                     * @return IssueNum 签发次数，港澳台居住证国徽面 返回该字段
                     * 
                     */
                    ContentInfo GetIssueNum() const;

                    /**
                     * 设置签发次数，港澳台居住证国徽面 返回该字段
                     * @param _issueNum 签发次数，港澳台居住证国徽面 返回该字段
                     * 
                     */
                    void SetIssueNum(const ContentInfo& _issueNum);

                    /**
                     * 判断参数 IssueNum 是否已赋值
                     * @return IssueNum 是否已赋值
                     * 
                     */
                    bool IssueNumHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    ContentInfo m_passNum;
                    bool m_passNumHasBeenSet;

                    /**
                     * 签发次数，港澳台居住证国徽面 返回该字段
                     */
                    ContentInfo m_issueNum;
                    bool m_issueNumHasBeenSet;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEPERMITINFO_H_
