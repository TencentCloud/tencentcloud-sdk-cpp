...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_ESTATECERTOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_ESTATECERTOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class EstateCertOCRRequest : public AbstractModel
                {
                public:
                    EstateCertOCRRequest();
                    ~EstateCertOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_ESTATECERTOCRREQUEST_H_
