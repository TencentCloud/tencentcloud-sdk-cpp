...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_INSURANCEBILLOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_INSURANCEBILLOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class InsuranceBillOCRRequest : public AbstractModel
                {
                public:
                    InsuranceBillOCRRequest();
                    ~InsuranceBillOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_INSURANCEBILLOCRREQUEST_H_
