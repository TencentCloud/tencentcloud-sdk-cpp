...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGDRIVERLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGDRIVERLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RideHailingDriverLicenseOCRRequest : public AbstractModel
                {
                public:
                    RideHailingDriverLicenseOCRRequest();
                    ~RideHailingDriverLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGDRIVERLICENSEOCRREQUEST_H_
