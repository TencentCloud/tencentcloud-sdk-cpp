...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * FinanBillOCR请求参数结构体
                */
                class FinanBillOCRRequest : public AbstractModel
                {
                public:
                    FinanBillOCRRequest();
                    ~FinanBillOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLOCRREQUEST_H_
