...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_EDUPAPEROCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_EDUPAPEROCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * EduPaperOCR请求参数结构体
                */
                class EduPaperOCRRequest : public AbstractModel
                {
                public:
                    EduPaperOCRRequest();
                    ~EduPaperOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_EDUPAPEROCRREQUEST_H_
