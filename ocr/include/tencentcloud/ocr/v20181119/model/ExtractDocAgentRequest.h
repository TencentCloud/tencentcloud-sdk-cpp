...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCAGENTREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCAGENTREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class ExtractDocAgentRequest : public AbstractModel
                {
                public:
                    ExtractDocAgentRequest();
                    ~ExtractDocAgentRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCAGENTREQUEST_H_
