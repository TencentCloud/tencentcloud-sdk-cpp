...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_STOREINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_STOREINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 门头照识别结果
                */
                class StoreInfo : public AbstractModel
                {
                public:
                    StoreInfo();
                    ~StoreInfo() = default;
                    ...
                    /**
                     * 获取识别出的字段名称(关键字)，如商店名称
                     * @return Name 识别出的字段名称(关键字)，如商店名称
                     * 
                     */
                    std::string GetName() const;

                    /**
                     * 设置识别出的字段名称(关键字)，如商店名称
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_STOREINFO_H_
