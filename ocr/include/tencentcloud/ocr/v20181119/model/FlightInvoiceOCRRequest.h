...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_FLIGHTINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_FLIGHTINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class FlightInvoiceOCRRequest : public AbstractModel
                {
                public:
                    FlightInvoiceOCRRequest();
                    ~FlightInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_FLIGHTINVOICEOCRREQUEST_H_
