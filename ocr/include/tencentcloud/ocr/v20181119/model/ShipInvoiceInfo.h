...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 轮船票字段信息
                */
                class ShipInvoiceInfo : public AbstractModel
                {
                public:
                    ShipInvoiceInfo();
                    ~ShipInvoiceInfo() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEINFO_H_
