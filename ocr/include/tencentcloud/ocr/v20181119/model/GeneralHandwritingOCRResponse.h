...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_GENERALHANDWRITINGOCRRESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_GENERALHANDWRITINGOCRRESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class GeneralHandwritingOCRResponse : public AbstractModel
                {
                public:
                    GeneralHandwritingOCRResponse();
                    ~GeneralHandwritingOCRResponse() = default;
                     ...
                     * 
                     */
                    std::vector<TextGeneralHandwriting> GetTextDetections() const;
                ...
                private:
                     ...
                     */
                    std::vector<TextGeneralHandwriting> m_textDetections;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_GENERALHANDWRITINGOCRRESPONSE_H_
