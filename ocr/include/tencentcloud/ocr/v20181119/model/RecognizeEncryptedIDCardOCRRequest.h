            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
                    ...
                    /**
                     * 设置<p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
                    ...
                    /**
                     * 获取<p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>
                    ...
                    /**
                     * 设置<p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>
