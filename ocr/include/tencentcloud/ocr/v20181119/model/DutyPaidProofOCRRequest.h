...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_DUTYPAIDPROOFOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_DUTYPAIDPROOFOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class DutyPaidProofOCRRequest : public AbstractModel
                {
                public:
                    DutyPaidProofOCRRequest();
                    ~DutyPaidProofOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_DUTYPAIDPROOFOCRREQUEST_H_
