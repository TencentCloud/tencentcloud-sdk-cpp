...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_FORMULAOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_FORMULAOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * FormulaOCR请求参数结构体
                */
                class FormulaOCRRequest : public AbstractModel
                {
                public:
                    FormulaOCRRequest();
                    ~FormulaOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_FORMULAOCRREQUEST_H_
