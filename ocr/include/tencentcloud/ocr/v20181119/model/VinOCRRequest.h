...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_VINOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_VINOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * VinOCR请求参数结构体
                */
                class VinOCRRequest : public AbstractModel
                {
                public:
                    VinOCRRequest();
                    ~VinOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_VINOCRREQUEST_H_
