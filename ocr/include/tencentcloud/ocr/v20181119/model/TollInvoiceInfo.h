...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 过路过桥费字段信息
                */
                class TollInvoiceInfo : public AbstractModel
                {
                public:
                    TollInvoiceInfo();
                    ~TollInvoiceInfo() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取识别出的字段名称（关键字）。支持以下字段的识别：
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEINFO_H_
