...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_QUOTAINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_QUOTAINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class QuotaInvoiceOCRRequest : public AbstractModel
                {
                public:
                    QuotaInvoiceOCRRequest();
                    ~QuotaInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_QUOTAINVOICEOCRREQUEST_H_
