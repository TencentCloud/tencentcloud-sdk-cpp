...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_WORDPOLYGON_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_WORDPOLYGON_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 单词坐标信息
                */
                class WordPolygon : public AbstractModel
                {
                public:
                    WordPolygon();
                    ~WordPolygon() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_WORDPOLYGON_H_
