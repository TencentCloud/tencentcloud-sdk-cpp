...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLSLICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLSLICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class FinanBillSliceOCRRequest : public AbstractModel
                {
                public:
                    FinanBillSliceOCRRequest();
                    ~FinanBillSliceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_FINANBILLSLICEOCRREQUEST_H_
