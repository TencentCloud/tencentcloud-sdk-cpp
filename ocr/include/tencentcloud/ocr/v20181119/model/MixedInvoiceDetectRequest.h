...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_MIXEDINVOICEDETECTREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_MIXEDINVOICEDETECTREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class MixedInvoiceDetectRequest : public AbstractModel
                {
                public:
                    MixedInvoiceDetectRequest();
                    ~MixedInvoiceDetectRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_MIXEDINVOICEDETECTREQUEST_H_
