            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>图片的 Base64 值。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经Base64编码后不超过 10M。图片下载时间不超过 3 秒。支持的图片像素：需介于20-10000px之间。图片的 ImageUrl、ImageBase64 必须提供一个，如果都提供，只使用 ImageUrl。</p>
                    ...
                    /**
                     * 设置<p>图片的 Base64 值。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经Base64编码后不超过 10M。图片下载时间不超过 3 秒。支持的图片像素：需介于20-10000px之间。图片的 ImageUrl、ImageBase64 必须提供一个，如果都提供，只使用 ImageUrl。</p>
                    ...
                    /**
                     * 获取<p>图片的 Url 地址。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经 Base64 编码后不超过 10M。图片下载时间不超过 3 秒。支持的图片像素：需介于20-10000px之间。图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。非腾讯云存储的 Url 速度和稳定性可能受一定影响。</p>
                    ...
                    /**
                     * 设置<p>图片的 Url 地址。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经 Base64 编码后不超过 10M。图片下载时间不超过 3 秒。支持的图片像素：需介于20-10000px之间。图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。非腾讯云存储的 Url 速度和稳定性可能受一定影响。</p>
                    ...
                    /**
                     * 获取<p>是否输出具体场景标签。注：开启后耗时会增加。</p>
                     * @return SceneType <p>是否输出具体场景标签。注：开启后耗时会增加。</p>
                     * 
                     */
                    bool GetSceneType() const;

                    /**
                     * 设置<p>是否输出具体场景标签。注：开启后耗时会增加。</p>
                     * @param _sceneType <p>是否输出具体场景标签。注：开启后耗时会增加。</p>
                     * 
                     */
                    void SetSceneType(const bool& _sceneType);
                    ...
                    /**
                     * 获取<p>输入商户名称，辅助判断具体场景标签。注：仅SceneType配置为true时支持。</p>
                    ...
                    /**
                     * 设置<p>输入商户名称，辅助判断具体场景标签。注：仅SceneType配置为true时支持。</p>
                     * @param _storeInfo <p>输入商户名称，辅助判断具体场景标签。注：仅SceneType配置为true时支持。</p>
                     * 
                     */
                    void SetStoreInfo(const std::string& _storeInfo);
