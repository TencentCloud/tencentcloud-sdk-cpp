...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TAXPAYMENT_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TAXPAYMENT_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 完税凭证
                */
                class TaxPayment : public AbstractModel
                {
                public:
                    TaxPayment();
                    ~TaxPayment() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TAXPAYMENT_H_
