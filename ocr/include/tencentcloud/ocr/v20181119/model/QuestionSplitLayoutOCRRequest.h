...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class QuestionSplitLayoutOCRRequest : public AbstractModel
                {
                public:
                    QuestionSplitLayoutOCRRequest();
                    ~QuestionSplitLayoutOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITLAYOUTOCRREQUEST_H_
