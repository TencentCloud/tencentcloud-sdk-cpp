...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_BUSINESSCARDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_BUSINESSCARDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class BusinessCardOCRRequest : public AbstractModel
                {
                public:
                    BusinessCardOCRRequest();
                    ~BusinessCardOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_BUSINESSCARDOCRREQUEST_H_
