...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_IDCARDINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_IDCARDINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 身份证信息返回
                */
                class IDCardInfo : public AbstractModel
                {
                public:
                    IDCardInfo();
                    ~IDCardInfo() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_IDCARDINFO_H_
