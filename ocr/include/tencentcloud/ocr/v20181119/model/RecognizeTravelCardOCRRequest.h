...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZETRAVELCARDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZETRAVELCARDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeTravelCardOCRRequest : public AbstractModel
                {
                public:
                    RecognizeTravelCardOCRRequest();
                    ~RecognizeTravelCardOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZETRAVELCARDOCRREQUEST_H_
