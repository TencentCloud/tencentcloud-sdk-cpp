...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_BIZLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_BIZLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class BizLicenseOCRRequest : public AbstractModel
                {
                public:
                    BizLicenseOCRRequest();
                    ~BizLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_BIZLICENSEOCRREQUEST_H_
