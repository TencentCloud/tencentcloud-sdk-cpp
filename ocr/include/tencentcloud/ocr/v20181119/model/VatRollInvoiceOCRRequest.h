...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_VATROLLINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_VATROLLINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class VatRollInvoiceOCRRequest : public AbstractModel
                {
                public:
                    VatRollInvoiceOCRRequest();
                    ~VatRollInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_VATROLLINVOICEOCRREQUEST_H_
