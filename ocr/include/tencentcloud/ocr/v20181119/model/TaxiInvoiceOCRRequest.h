...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TAXIINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TAXIINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class TaxiInvoiceOCRRequest : public AbstractModel
                {
                public:
                    TaxiInvoiceOCRRequest();
                    ~TaxiInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TAXIINVOICEOCRREQUEST_H_
