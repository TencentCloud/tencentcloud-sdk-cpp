...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_ORGCODECERTOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_ORGCODECERTOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class OrgCodeCertOCRRequest : public AbstractModel
                {
                public:
                    OrgCodeCertOCRRequest();
                    ~OrgCodeCertOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_ORGCODECERTOCRREQUEST_H_
