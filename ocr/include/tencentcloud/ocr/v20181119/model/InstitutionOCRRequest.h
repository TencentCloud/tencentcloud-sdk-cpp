...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_INSTITUTIONOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_INSTITUTIONOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class InstitutionOCRRequest : public AbstractModel
                {
                public:
                    InstitutionOCRRequest();
                    ~InstitutionOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_INSTITUTIONOCRREQUEST_H_
