...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCMULTIPROREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCMULTIPROREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class ExtractDocMultiProRequest : public AbstractModel
                {
                public:
                    ExtractDocMultiProRequest();
                    ~ExtractDocMultiProRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_EXTRACTDOCMULTIPROREQUEST_H_
