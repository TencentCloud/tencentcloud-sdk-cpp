...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TEXTDETECTREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TEXTDETECTREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * TextDetect请求参数结构体
                */
                class TextDetectRequest : public AbstractModel
                {
                public:
                    TextDetectRequest();
                    ~TextDetectRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TEXTDETECTREQUEST_H_
