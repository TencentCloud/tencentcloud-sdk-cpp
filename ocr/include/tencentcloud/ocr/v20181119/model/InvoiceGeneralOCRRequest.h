...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_INVOICEGENERALOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_INVOICEGENERALOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class InvoiceGeneralOCRRequest : public AbstractModel
                {
                public:
                    InvoiceGeneralOCRRequest();
                    ~InvoiceGeneralOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_INVOICEGENERALOCRREQUEST_H_
