...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANDRIVINGLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANDRIVINGLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeKoreanDrivingLicenseOCRRequest : public AbstractModel
                {
                public:
                    RecognizeKoreanDrivingLicenseOCRRequest();
                    ~RecognizeKoreanDrivingLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANDRIVINGLICENSEOCRREQUEST_H_
