...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESDRIVINGLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESDRIVINGLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizePhilippinesDrivingLicenseOCRRequest : public AbstractModel
                {
                public:
                    RecognizePhilippinesDrivingLicenseOCRRequest();
                    ~RecognizePhilippinesDrivingLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESDRIVINGLICENSEOCRREQUEST_H_
