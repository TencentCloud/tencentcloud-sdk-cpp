...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_HANDWRITINGESSAYOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_HANDWRITINGESSAYOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class HandwritingEssayOCRRequest : public AbstractModel
                {
                public:
                    HandwritingEssayOCRRequest();
                    ~HandwritingEssayOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_HANDWRITINGESSAYOCRREQUEST_H_
