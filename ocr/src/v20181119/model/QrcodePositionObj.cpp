...
CoreInternalOutcome QrcodePositionObj::Deserialize(const Value &value)
{
    string requestId = "";
...
void QrcodePositionObj::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
