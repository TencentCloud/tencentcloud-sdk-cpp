...
CoreInternalOutcome VatRollInvoiceInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void VatRollInvoiceInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string VatRollInvoiceInfo::GetName() const
{
    return m_name;
}

void VatRollInvoiceInfo::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool VatRollInvoiceInfo::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string VatRollInvoiceInfo::GetValue() const
{
    return m_value;
}

void VatRollInvoiceInfo::SetValue(const string& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool VatRollInvoiceInfo::ValueHasBeenSet() const
{
    return m_valueHasBeenSet;
}

Rect VatRollInvoiceInfo::GetRect() const
{
    return m_rect;
}

void VatRollInvoiceInfo::SetRect(const Rect& _rect)
{
    m_rect = _rect;
    m_rectHasBeenSet = true;
}

bool VatRollInvoiceInfo::RectHasBeenSet() const
{
