...
CoreInternalOutcome TableOCRResponse::Deserialize(const string &payload)
{
...
string TableOCRResponse::ToJsonString() const
{
...
vector<TextTable> TableOCRResponse::GetTextDetections() const
{
    return m_textDetections;
}

bool TableOCRResponse::TextDetectionsHasBeenSet() const
{
    return m_textDetectionsHasBeenSet;
}

string TableOCRResponse::GetData() const
{
    return m_data;
}

bool TableOCRResponse::DataHasBeenSet() const
{
