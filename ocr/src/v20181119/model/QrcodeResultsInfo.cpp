...
CoreInternalOutcome QrcodeResultsInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void QrcodeResultsInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
