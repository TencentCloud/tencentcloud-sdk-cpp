...
CoreInternalOutcome ExtractDocMultiResponse::Deserialize(const string &payload)
{
...
string ExtractDocMultiResponse::ToJsonString() const
{
...
double ExtractDocMultiResponse::GetAngle() const
{
    return m_angle;
}

bool ExtractDocMultiResponse::AngleHasBeenSet() const
{
    return m_angleHasBeenSet;
}

vector<GroupInfo> ExtractDocMultiResponse::GetStructuralList() const
{
    return m_structuralList;
}

bool ExtractDocMultiResponse::StructuralListHasBeenSet() const
{
    return m_structuralListHasBeenSet;
}

vector<WordItem> ExtractDocMultiResponse::GetWordList() const
{
    return m_wordList;
}

bool ExtractDocMultiResponse::WordListHasBeenSet() const
{
    return m_wordListHasBeenSet;
}

int64_t ExtractDocMultiResponse::GetTokenNum() const
{
    return m_tokenNum;
}

bool ExtractDocMultiResponse::TokenNumHasBeenSet() const
{
