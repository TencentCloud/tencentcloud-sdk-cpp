...
CreateAIFormTaskResponse::CreateAIFormTaskResponse() :
    m_taskIdHasBeenSet(false),
    m_operateUrlHasBeenSet(false)
{
}

CoreInternalOutcome CreateAIFormTaskResponse::Deserialize(const string &payload)
{
...
string CreateAIFormTaskResponse::ToJsonString() const
{
...
string CreateAIFormTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateAIFormTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateAIFormTaskResponse::GetOperateUrl() const
{
    return m_operateUrl;
}

bool CreateAIFormTaskResponse::OperateUrlHasBeenSet() const
{
