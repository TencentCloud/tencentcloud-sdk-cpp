...
QuestionOCRResponse::QuestionOCRResponse() :
    m_questionInfoHasBeenSet(false)
{
}

CoreInternalOutcome QuestionOCRResponse::Deserialize(const string &payload)
{
...
string QuestionOCRResponse::ToJsonString() const
{
...
vector<QuestionInfo> QuestionOCRResponse::GetQuestionInfo() const
{
    return m_questionInfo;
}

bool QuestionOCRResponse::QuestionInfoHasBeenSet() const
{
