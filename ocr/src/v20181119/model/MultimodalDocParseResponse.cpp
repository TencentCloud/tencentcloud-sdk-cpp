...
MultimodalDocParseResponse::MultimodalDocParseResponse() :
    m_resultUrlHasBeenSet(false)
{
}

CoreInternalOutcome MultimodalDocParseResponse::Deserialize(const string &payload)
{
...
string MultimodalDocParseResponse::ToJsonString() const
{
...
string MultimodalDocParseResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool MultimodalDocParseResponse::ResultUrlHasBeenSet() const
{
