...
string EduPaperOCRRequest::ToJsonString() const
{
...
string EduPaperOCRRequest::GetImageBase64() const
{
    return m_imageBase64;
}

void EduPaperOCRRequest::SetImageBase64(const string& _imageBase64)
{
    m_imageBase64 = _imageBase64;
    m_imageBase64HasBeenSet = true;
}

bool EduPaperOCRRequest::ImageBase64HasBeenSet() const
{
    return m_imageBase64HasBeenSet;
}

string EduPaperOCRRequest::GetImageUrl() const
{
    return m_imageUrl;
}

void EduPaperOCRRequest::SetImageUrl(const string& _imageUrl)
{
