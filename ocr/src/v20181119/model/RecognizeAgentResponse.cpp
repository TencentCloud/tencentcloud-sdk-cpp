...
RecognizeAgentResponse::RecognizeAgentResponse() :
    m_responseHasBeenSet(false),
    m_angleHasBeenSet(false)
{
}

CoreInternalOutcome RecognizeAgentResponse::Deserialize(const string &payload)
{
...
string RecognizeAgentResponse::ToJsonString() const
{
...
vector<ListInfo> RecognizeAgentResponse::GetResponse() const
{
    return m_response;
}

bool RecognizeAgentResponse::ResponseHasBeenSet() const
{
    return m_responseHasBeenSet;
}

double RecognizeAgentResponse::GetAngle() const
{
    return m_angle;
}

bool RecognizeAgentResponse::AngleHasBeenSet() const
{
