...
CoreInternalOutcome SingleInvoiceInfo::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `SingleInvoiceInfo.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `SingleInvoiceInfo.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void SingleInvoiceInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
