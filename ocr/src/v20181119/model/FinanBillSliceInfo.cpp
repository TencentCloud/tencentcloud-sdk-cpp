...
CoreInternalOutcome FinanBillSliceInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void FinanBillSliceInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
