...
CoreInternalOutcome BizLicenseVerifyResult::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void BizLicenseVerifyResult::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
