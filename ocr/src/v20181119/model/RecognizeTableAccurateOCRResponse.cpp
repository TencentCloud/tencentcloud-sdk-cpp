...
CoreInternalOutcome RecognizeTableAccurateOCRResponse::Deserialize(const string &payload)
{
...
string RecognizeTableAccurateOCRResponse::ToJsonString() const
{
...
vector<TableInfo> RecognizeTableAccurateOCRResponse::GetTableDetections() const
{
    return m_tableDetections;
}

bool RecognizeTableAccurateOCRResponse::TableDetectionsHasBeenSet() const
{
    return m_tableDetectionsHasBeenSet;
}

string RecognizeTableAccurateOCRResponse::GetData() const
{
    return m_data;
}

bool RecognizeTableAccurateOCRResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t RecognizeTableAccurateOCRResponse::GetPdfPageSize() const
{
    return m_pdfPageSize;
}

bool RecognizeTableAccurateOCRResponse::PdfPageSizeHasBeenSet() const
{
    return m_pdfPageSizeHasBeenSet;
}

double RecognizeTableAccurateOCRResponse::GetAngle() const
{
    return m_angle;
}

bool RecognizeTableAccurateOCRResponse::AngleHasBeenSet() const
{
