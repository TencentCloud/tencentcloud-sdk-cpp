...
CoreInternalOutcome TollInvoiceInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TollInvoiceInfo.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TollInvoiceInfo.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Rect") && !value["Rect"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TollInvoiceInfo.Rect` is not object type").SetRequestId(requestId));
        }
...
void TollInvoiceInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
