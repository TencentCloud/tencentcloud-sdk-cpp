...
CoreInternalOutcome BankSlipOCRResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("BankSlipInfos") && !rsp["BankSlipInfos"].IsNull())
    {
        if (!rsp["BankSlipInfos"].IsArray())
            return CoreInternalOutcome(Core::Error("response `BankSlipInfos` is not array type"));

        const rapidjson::Value &tmpValue = rsp["BankSlipInfos"];
...
string BankSlipOCRResponse::ToJsonString() const
{
...
vector<BankSlipInfo> BankSlipOCRResponse::GetBankSlipInfos() const
{
    return m_bankSlipInfos;
}

bool BankSlipOCRResponse::BankSlipInfosHasBeenSet() const
{
    return m_bankSlipInfosHasBeenSet;
}

double BankSlipOCRResponse::GetAngle() const
{
    return m_angle;
}

bool BankSlipOCRResponse::AngleHasBeenSet() const
{
