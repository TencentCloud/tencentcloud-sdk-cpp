...
CoreInternalOutcome ArithmeticOCRResponse::Deserialize(const string &payload)
{
...
string ArithmeticOCRResponse::ToJsonString() const
{
...
vector<TextArithmetic> ArithmeticOCRResponse::GetTextDetections() const
{
