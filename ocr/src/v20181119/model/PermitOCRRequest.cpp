...
string PermitOCRRequest::ToJsonString() const
{
...
string PermitOCRRequest::GetImageBase64() const
{
    return m_imageBase64;
}

void PermitOCRRequest::SetImageBase64(const string& _imageBase64)
{
    m_imageBase64 = _imageBase64;
    m_imageBase64HasBeenSet = true;
}

bool PermitOCRRequest::ImageBase64HasBeenSet() const
{
    return m_imageBase64HasBeenSet;
}

string PermitOCRRequest::GetImageUrl() const
{
    return m_imageUrl;
}

void PermitOCRRequest::SetImageUrl(const string& _imageUrl)
{
