...
CoreInternalOutcome GeneralFastOCRResponse::Deserialize(const string &payload)
{
...
string GeneralFastOCRResponse::ToJsonString() const
{
...
vector<TextDetection> GeneralFastOCRResponse::GetTextDetections() const
{
    return m_textDetections;
}

bool GeneralFastOCRResponse::TextDetectionsHasBeenSet() const
{
    return m_textDetectionsHasBeenSet;
}

string GeneralFastOCRResponse::GetLanguage() const
{
    return m_language;
}

bool GeneralFastOCRResponse::LanguageHasBeenSet() const
{
    return m_languageHasBeenSet;
}

double GeneralFastOCRResponse::GetAngel() const
{
    return m_angel;
}
