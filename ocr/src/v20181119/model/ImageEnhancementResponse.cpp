...
ImageEnhancementResponse::ImageEnhancementResponse() :
    m_imageTagHasBeenSet(false),
    m_imageHasBeenSet(false)
{
}

CoreInternalOutcome ImageEnhancementResponse::Deserialize(const string &payload)
{
...
string ImageEnhancementResponse::ToJsonString() const
{
...
string ImageEnhancementResponse::GetImageTag() const
{
    return m_imageTag;
}

bool ImageEnhancementResponse::ImageTagHasBeenSet() const
{
    return m_imageTagHasBeenSet;
}

string ImageEnhancementResponse::GetImage() const
{
    return m_image;
}

bool ImageEnhancementResponse::ImageHasBeenSet() const
{
