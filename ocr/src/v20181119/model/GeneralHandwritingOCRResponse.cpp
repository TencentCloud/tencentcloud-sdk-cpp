...
CoreInternalOutcome GeneralHandwritingOCRResponse::Deserialize(const string &payload)
{
...
string GeneralHandwritingOCRResponse::ToJsonString() const
{
...
vector<TextGeneralHandwriting> GeneralHandwritingOCRResponse::GetTextDetections() const
{
