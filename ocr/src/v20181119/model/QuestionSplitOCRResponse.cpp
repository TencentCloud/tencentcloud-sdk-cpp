...
QuestionSplitOCRResponse::QuestionSplitOCRResponse() :
    m_questionInfoHasBeenSet(false)
{
}

CoreInternalOutcome QuestionSplitOCRResponse::Deserialize(const string &payload)
{
...
string QuestionSplitOCRResponse::ToJsonString() const
{
...
vector<QuestionInfo> QuestionSplitOCRResponse::GetQuestionInfo() const
{
    return m_questionInfo;
}

bool QuestionSplitOCRResponse::QuestionInfoHasBeenSet() const
{
