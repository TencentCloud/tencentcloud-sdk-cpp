...
CoreInternalOutcome BusInvoiceInfo::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BusInvoiceInfo.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BusInvoiceInfo.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Rect") && !value["Rect"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BusInvoiceInfo.Rect` is not object type").SetRequestId(requestId));
        }
...
void BusInvoiceInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
