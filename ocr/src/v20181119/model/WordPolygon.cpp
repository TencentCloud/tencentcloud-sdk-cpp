...
CoreInternalOutcome WordPolygon::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("DetectedText") && !value["DetectedText"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `WordPolygon.DetectedText` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Coord") && !value["Coord"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `WordPolygon.Coord` is not object type").SetRequestId(requestId));
        }
...
void WordPolygon::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string WordPolygon::GetDetectedText() const
{
    return m_detectedText;
}

void WordPolygon::SetDetectedText(const string& _detectedText)
{
    m_detectedText = _detectedText;
    m_detectedTextHasBeenSet = true;
}

bool WordPolygon::DetectedTextHasBeenSet() const
{
    return m_detectedTextHasBeenSet;
}

Polygon WordPolygon::GetCoord() const
{
    return m_coord;
}

void WordPolygon::SetCoord(const Polygon& _coord)
{
    m_coord = _coord;
    m_coordHasBeenSet = true;
}

bool WordPolygon::CoordHasBeenSet() const
{
