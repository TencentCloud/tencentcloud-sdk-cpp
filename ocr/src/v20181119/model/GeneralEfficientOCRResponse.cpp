...
CoreInternalOutcome GeneralEfficientOCRResponse::Deserialize(const string &payload)
{
...
string GeneralEfficientOCRResponse::ToJsonString() const
{
...
vector<TextDetection> GeneralEfficientOCRResponse::GetTextDetections() const
{
