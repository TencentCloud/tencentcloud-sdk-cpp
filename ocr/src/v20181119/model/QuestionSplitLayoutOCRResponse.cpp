...
QuestionSplitLayoutOCRResponse::QuestionSplitLayoutOCRResponse() :
    m_questionInfoHasBeenSet(false)
{
}

CoreInternalOutcome QuestionSplitLayoutOCRResponse::Deserialize(const string &payload)
{
...
string QuestionSplitLayoutOCRResponse::ToJsonString() const
{
...
vector<QuestionInfo> QuestionSplitLayoutOCRResponse::GetQuestionInfo() const
{
    return m_questionInfo;
}

bool QuestionSplitLayoutOCRResponse::QuestionInfoHasBeenSet() const
{
