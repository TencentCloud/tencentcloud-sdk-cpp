...
CoreInternalOutcome SubmitQuestionMarkAgentJobResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("QuestionCount") && !rsp["QuestionCount"].IsNull())
    {
        if (!rsp["QuestionCount"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `QuestionCount` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_questionCount = string(rsp["QuestionCount"].GetString());
...
string SubmitQuestionMarkAgentJobResponse::ToJsonString() const
{
...
string SubmitQuestionMarkAgentJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitQuestionMarkAgentJobResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<QuestionInfo> SubmitQuestionMarkAgentJobResponse::GetQuestionInfo() const
{
    return m_questionInfo;
}

bool SubmitQuestionMarkAgentJobResponse::QuestionInfoHasBeenSet() const
{
    return m_questionInfoHasBeenSet;
}

string SubmitQuestionMarkAgentJobResponse::GetQuestionCount() const
{
