...
ExtractDocBasicResponse::ExtractDocBasicResponse() :
...
CoreInternalOutcome ExtractDocBasicResponse::Deserialize(const string &payload)
{
...
string ExtractDocBasicResponse::ToJsonString() const
{
...
double ExtractDocBasicResponse::GetAngle() const
{
    return m_angle;
}

bool ExtractDocBasicResponse::AngleHasBeenSet() const
{
    return m_angleHasBeenSet;
}

vector<GroupInfo> ExtractDocBasicResponse::GetStructuralList() const
{
    return m_structuralList;
}

bool ExtractDocBasicResponse::StructuralListHasBeenSet() const
{
    return m_structuralListHasBeenSet;
}

vector<WordItem> ExtractDocBasicResponse::GetWordList() const
{
    return m_wordList;
}

bool ExtractDocBasicResponse::WordListHasBeenSet() const
{
    return m_wordListHasBeenSet;
}

vector<SealInfo> ExtractDocBasicResponse::GetSealInfos() const
{
    return m_sealInfos;
}

bool ExtractDocBasicResponse::SealInfosHasBeenSet() const
{
