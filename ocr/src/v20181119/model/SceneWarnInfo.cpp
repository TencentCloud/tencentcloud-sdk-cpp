...
CoreInternalOutcome SceneWarnInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("IsWarn") && !value["IsWarn"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneWarnInfo.IsWarn` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RiskConfidence") && !value["RiskConfidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SceneWarnInfo.RiskConfidence` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Polygon") && !value["Polygon"].IsNull())
    {
        if (!value["Polygon"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SceneWarnInfo.Polygon` is not array type"));
...
void SceneWarnInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
bool SceneWarnInfo::GetIsWarn() const
{
    return m_isWarn;
}

void SceneWarnInfo::SetIsWarn(const bool& _isWarn)
{
    m_isWarn = _isWarn;
    m_isWarnHasBeenSet = true;
}

bool SceneWarnInfo::IsWarnHasBeenSet() const
{
    return m_isWarnHasBeenSet;
}

double SceneWarnInfo::GetRiskConfidence() const
{
    return m_riskConfidence;
}

void SceneWarnInfo::SetRiskConfidence(const double& _riskConfidence)
{
    m_riskConfidence = _riskConfidence;
    m_riskConfidenceHasBeenSet = true;
}

bool SceneWarnInfo::RiskConfidenceHasBeenSet() const
{
    return m_riskConfidenceHasBeenSet;
}

vector<Polygon> SceneWarnInfo::GetPolygon() const
{
    return m_polygon;
}

void SceneWarnInfo::SetPolygon(const vector<Polygon>& _polygon)
{
    m_polygon = _polygon;
    m_polygonHasBeenSet = true;
}

bool SceneWarnInfo::PolygonHasBeenSet() const
{
