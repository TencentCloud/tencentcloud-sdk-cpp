...
CoreInternalOutcome GetOCRResultResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["OCRResult"].IsObject())
        {
            return CoreInternalOutcome(Core::Error("response `OCRResult` is not object type").SetRequestId(requestId));
        }

        CoreInternalOutcome outcome = m_oCRResult.Deserialize(rsp["OCRResult"]);
...
string GetOCRResultResponse::ToJsonString() const
{
...
string GetOCRResultResponse::GetType() const
{
    return m_type;
}

bool GetOCRResultResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

OCRResult GetOCRResultResponse::GetOCRResult() const
{
    return m_oCRResult;
}
