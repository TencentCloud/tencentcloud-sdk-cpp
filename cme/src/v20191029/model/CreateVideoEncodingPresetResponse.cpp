...
CoreInternalOutcome CreateVideoEncodingPresetResponse::Deserialize(const string &payload)
{
...
string CreateVideoEncodingPresetResponse::ToJsonString() const
{
...
uint64_t CreateVideoEncodingPresetResponse::GetId() const
{
    return m_id;
}

bool CreateVideoEncodingPresetResponse::IdHasBeenSet() const
{
