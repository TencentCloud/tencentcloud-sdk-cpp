...
CoreInternalOutcome CopyProjectResponse::Deserialize(const string &payload)
{
...
string CopyProjectResponse::ToJsonString() const
{
...
string CopyProjectResponse::GetProjectId() const
{
    return m_projectId;
}

bool CopyProjectResponse::ProjectIdHasBeenSet() const
{
