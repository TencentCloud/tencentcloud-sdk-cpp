...
CoreInternalOutcome ImportMediaToProjectResponse::Deserialize(const string &payload)
{
...
string ImportMediaToProjectResponse::ToJsonString() const
{
...
string ImportMediaToProjectResponse::GetMaterialId() const
{
    return m_materialId;
}

bool ImportMediaToProjectResponse::MaterialIdHasBeenSet() const
{
    return m_materialIdHasBeenSet;
}

string ImportMediaToProjectResponse::GetTaskId() const
{
    return m_taskId;
}

bool ImportMediaToProjectResponse::TaskIdHasBeenSet() const
{
