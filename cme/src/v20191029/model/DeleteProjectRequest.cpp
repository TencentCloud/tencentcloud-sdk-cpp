...
string DeleteProjectRequest::GetPlatform() const
{
    return m_platform;
}

void DeleteProjectRequest::SetPlatform(const string& _platform)
{
    m_platform = _platform;
    m_platformHasBeenSet = true;
}

bool DeleteProjectRequest::PlatformHasBeenSet() const
{
