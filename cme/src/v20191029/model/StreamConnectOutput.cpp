...
CoreInternalOutcome StreamConnectOutput::Deserialize(const Value &value)
{
    string requestId = "";
...
void StreamConnectOutput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
