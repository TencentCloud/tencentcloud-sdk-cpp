...
CoreInternalOutcome ClassInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ClassInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
...
Entity ClassInfo::GetOwner() const
{
    return m_owner;
}

void ClassInfo::SetOwner(const Entity& _owner)
{
    m_owner = _owner;
    m_ownerHasBeenSet = true;
}

bool ClassInfo::OwnerHasBeenSet() const
{
    return m_ownerHasBeenSet;
}

string ClassInfo::GetClassPath() const
{
    return m_classPath;
}

void ClassInfo::SetClassPath(const string& _classPath)
{
    m_classPath = _classPath;
    m_classPathHasBeenSet = true;
}

bool ClassInfo::ClassPathHasBeenSet() const
{
