...
CoreInternalOutcome LiveStreamClipProjectInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void LiveStreamClipProjectInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
