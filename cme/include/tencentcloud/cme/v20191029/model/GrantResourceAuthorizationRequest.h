...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_GRANTRESOURCEAUTHORIZATIONREQUEST_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_GRANTRESOURCEAUTHORIZATIONREQUEST_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                */
                class GrantResourceAuthorizationRequest : public AbstractModel
                {
                public:
                    GrantResourceAuthorizationRequest();
                    ~GrantResourceAuthorizationRequest() = default;
...
<li>W：可修改、删除媒资。</li>
                    ...
                    /**
                     * 获取操作者。如不填，默认为 `cmeid_system`，表示平台管理员操作，可以授权任意归属者的资源。如果指定操作者，则操作者必须对资源拥有写权限。
                    ...
                    /**
                     * 设置操作者。如不填，默认为 `cmeid_system`，表示平台管理员操作，可以授权任意归属者的资源。如果指定操作者，则操作者必须对资源拥有写权限。
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_GRANTRESOURCEAUTHORIZATIONREQUEST_H_
