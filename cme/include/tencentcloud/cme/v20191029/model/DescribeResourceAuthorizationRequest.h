...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBERESOURCEAUTHORIZATIONREQUEST_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBERESOURCEAUTHORIZATIONREQUEST_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                */
                class DescribeResourceAuthorizationRequest : public AbstractModel
                {
                public:
                    DescribeResourceAuthorizationRequest();
                    ~DescribeResourceAuthorizationRequest() = default;
                    ...
                    /**
                     * 获取操作者。如不填，默认为 `cmeid_system`，表示平台管理员操作，可以查询任意资源的被授权情况。如果指定操作者，则操作者必须对被授权资源有读权限。
                    ...
                    /**
                     * 设置操作者。如不填，默认为 `cmeid_system`，表示平台管理员操作，可以查询任意资源的被授权情况。如果指定操作者，则操作者必须对被授权资源有读权限。
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBERESOURCEAUTHORIZATIONREQUEST_H_
