...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_MATERIALSTATUS_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_MATERIALSTATUS_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                * 素材的状态，目前仅包含素材编辑可用状态。
                */
                class MaterialStatus : public AbstractModel
                {
                public:
                    MaterialStatus();
...
<li>PROCESSING：处理中，暂不可用于编辑。</li>
                     * @return EditorUsableStatus 素材编辑可用状态，取值有：
<li>NORMAL：正常，可直接用于编辑；</li>
<li>ABNORMAL : 异常，不可用于编辑；</li>
<li>PROCESSING：处理中，暂不可用于编辑。</li>
                     * 
...
<li>PROCESSING：处理中，暂不可用于编辑。</li>
                     */
                    std::string m_editorUsableStatus;
                    bool m_editorUsableStatusHasBeenSet;
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_MATERIALSTATUS_H_
