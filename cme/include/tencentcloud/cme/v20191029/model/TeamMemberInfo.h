...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_TEAMMEMBERINFO_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_TEAMMEMBERINFO_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                * 团队成员信息
                */
                class TeamMemberInfo : public AbstractModel
                {
                public:
                    TeamMemberInfo();
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_TEAMMEMBERINFO_H_
