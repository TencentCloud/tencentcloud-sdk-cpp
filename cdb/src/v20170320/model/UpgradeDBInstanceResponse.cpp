...
vector<string> UpgradeDBInstanceResponse::GetDealIds() const
{
    return m_dealIds;
}

bool UpgradeDBInstanceResponse::DealIdsHasBeenSet() const
{
    return m_dealIdsHasBeenSet;
}

string UpgradeDBInstanceResponse::GetAsyncRequestId() const
{
