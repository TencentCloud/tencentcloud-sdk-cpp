...
string CreateDBInstanceHourRequest::GetCdcId() const
{
    return m_cdcId;
}

void CreateDBInstanceHourRequest::SetCdcId(const string& _cdcId)
{
    m_cdcId = _cdcId;
    m_cdcIdHasBeenSet = true;
}

bool CreateDBInstanceHourRequest::CdcIdHasBeenSet() const
{
...
AutoStrategy CreateDBInstanceHourRequest::GetAutoStrategy() const
{
    return m_autoStrategy;
}

void CreateDBInstanceHourRequest::SetAutoStrategy(const AutoStrategy& _autoStrategy)
{
    m_autoStrategy = _autoStrategy;
    m_autoStrategyHasBeenSet = true;
}

bool CreateDBInstanceHourRequest::AutoStrategyHasBeenSet() const
{
