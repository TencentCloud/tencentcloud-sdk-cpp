...
CoreInternalOutcome CreateDBImportJobResponse::Deserialize(const string &payload)
{
...
string CreateDBImportJobResponse::ToJsonString() const
{
...
string CreateDBImportJobResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool CreateDBImportJobResponse::AsyncRequestIdHasBeenSet() const
{
