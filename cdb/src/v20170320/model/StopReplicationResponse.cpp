...
CoreInternalOutcome StopReplicationResponse::Deserialize(const string &payload)
{
...
string StopReplicationResponse::ToJsonString() const
{
...
string StopReplicationResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool StopReplicationResponse::AsyncRequestIdHasBeenSet() const
{
