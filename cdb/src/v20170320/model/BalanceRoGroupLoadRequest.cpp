...
string BalanceRoGroupLoadRequest::ToJsonString() const
{
...
string BalanceRoGroupLoadRequest::GetRoGroupId() const
{
    return m_roGroupId;
}

void BalanceRoGroupLoadRequest::SetRoGroupId(const string& _roGroupId)
{
    m_roGroupId = _roGroupId;
    m_roGroupIdHasBeenSet = true;
}

bool BalanceRoGroupLoadRequest::RoGroupIdHasBeenSet() const
{
