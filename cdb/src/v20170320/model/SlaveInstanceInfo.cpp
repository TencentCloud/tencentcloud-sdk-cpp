...
CoreInternalOutcome SlaveInstanceInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void SlaveInstanceInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
