...
string DeleteDeployGroupsRequest::ToJsonString() const
{
...
vector<string> DeleteDeployGroupsRequest::GetDeployGroupIds() const
{
    return m_deployGroupIds;
}

void DeleteDeployGroupsRequest::SetDeployGroupIds(const vector<string>& _deployGroupIds)
{
    m_deployGroupIds = _deployGroupIds;
    m_deployGroupIdsHasBeenSet = true;
}

bool DeleteDeployGroupsRequest::DeployGroupIdsHasBeenSet() const
{
