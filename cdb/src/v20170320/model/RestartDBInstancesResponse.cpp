...
CoreInternalOutcome RestartDBInstancesResponse::Deserialize(const string &payload)
{
...
string RestartDBInstancesResponse::ToJsonString() const
{
...
string RestartDBInstancesResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool RestartDBInstancesResponse::AsyncRequestIdHasBeenSet() const
{
