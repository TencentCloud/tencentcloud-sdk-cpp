...
CoreInternalOutcome UpgradeCDBProxyVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeCDBProxyVersionResponse::ToJsonString() const
{
...
string UpgradeCDBProxyVersionResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool UpgradeCDBProxyVersionResponse::AsyncRequestIdHasBeenSet() const
{
