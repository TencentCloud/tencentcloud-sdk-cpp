...
CoreInternalOutcome DescribeDBInstanceCharsetResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Charset") && !rsp["Charset"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Charset` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string DescribeDBInstanceCharsetResponse::ToJsonString() const
{
...
string DescribeDBInstanceCharsetResponse::GetCharset() const
{
    return m_charset;
}

bool DescribeDBInstanceCharsetResponse::CharsetHasBeenSet() const
{
