...
CoreInternalOutcome OpenSSLResponse::Deserialize(const string &payload)
{
...
string OpenSSLResponse::ToJsonString() const
{
...
string OpenSSLResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool OpenSSLResponse::AsyncRequestIdHasBeenSet() const
{
