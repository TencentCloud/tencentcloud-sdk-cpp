...
string DescribeAsyncRequestInfoRequest::ToJsonString() const
{
    ...
    if (m_asyncRequestIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_asyncRequestId.c_str(), allocator).Move(), allocator);
    }
...
string DescribeAsyncRequestInfoRequest::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

void DescribeAsyncRequestInfoRequest::SetAsyncRequestId(const string& _asyncRequestId)
{
    m_asyncRequestId = _asyncRequestId;
    m_asyncRequestIdHasBeenSet = true;
}

bool DescribeAsyncRequestInfoRequest::AsyncRequestIdHasBeenSet() const
{
