...
string DescribeSSLStatusRequest::GetRoGroupId() const
{
    return m_roGroupId;
}

void DescribeSSLStatusRequest::SetRoGroupId(const string& _roGroupId)
{
    m_roGroupId = _roGroupId;
    m_roGroupIdHasBeenSet = true;
}

bool DescribeSSLStatusRequest::RoGroupIdHasBeenSet() const
{
