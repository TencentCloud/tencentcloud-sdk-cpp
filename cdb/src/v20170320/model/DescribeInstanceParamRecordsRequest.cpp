...
int64_t DescribeInstanceParamRecordsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeInstanceParamRecordsRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
int64_t DescribeInstanceParamRecordsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeInstanceParamRecordsRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
