...
CoreInternalOutcome ParamTemplateInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ParamTemplateInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
