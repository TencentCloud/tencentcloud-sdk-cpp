...
CoreInternalOutcome StartReplicationResponse::Deserialize(const string &payload)
{
...
string StartReplicationResponse::ToJsonString() const
{
...
string StartReplicationResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool StartReplicationResponse::AsyncRequestIdHasBeenSet() const
{
