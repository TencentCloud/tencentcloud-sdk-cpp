...
string SwitchForUpgradeRequest::ToJsonString() const
{
...
string SwitchForUpgradeRequest::GetInstanceId() const
{
    return m_instanceId;
}

void SwitchForUpgradeRequest::SetInstanceId(const string& _instanceId)
{
