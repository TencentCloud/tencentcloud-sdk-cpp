...
string DeleteAccountsRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DeleteAccountsRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DeleteAccountsRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<Account> DeleteAccountsRequest::GetAccounts() const
{
    return m_accounts;
}

void DeleteAccountsRequest::SetAccounts(const vector<Account>& _accounts)
{
