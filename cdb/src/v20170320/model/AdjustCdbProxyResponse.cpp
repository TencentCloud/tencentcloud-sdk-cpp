...
CoreInternalOutcome AdjustCdbProxyResponse::Deserialize(const string &payload)
{
...
string AdjustCdbProxyResponse::ToJsonString() const
{
...
string AdjustCdbProxyResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool AdjustCdbProxyResponse::AsyncRequestIdHasBeenSet() const
{
