...
CoreInternalOutcome ModifyAccountMaxUserConnectionsResponse::Deserialize(const string &payload)
{
...
string ModifyAccountMaxUserConnectionsResponse::ToJsonString() const
{
...
string ModifyAccountMaxUserConnectionsResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool ModifyAccountMaxUserConnectionsResponse::AsyncRequestIdHasBeenSet() const
{
