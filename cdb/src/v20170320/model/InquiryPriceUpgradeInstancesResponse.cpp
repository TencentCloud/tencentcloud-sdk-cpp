...
CoreInternalOutcome InquiryPriceUpgradeInstancesResponse::Deserialize(const string &payload)
{
...
string InquiryPriceUpgradeInstancesResponse::ToJsonString() const
{
...
int64_t InquiryPriceUpgradeInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceUpgradeInstancesResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

int64_t InquiryPriceUpgradeInstancesResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquiryPriceUpgradeInstancesResponse::OriginalPriceHasBeenSet() const
{
