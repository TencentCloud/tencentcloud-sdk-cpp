...
CoreInternalOutcome SwitchDrInstanceToMasterResponse::Deserialize(const string &payload)
{
...
string SwitchDrInstanceToMasterResponse::ToJsonString() const
{
...
string SwitchDrInstanceToMasterResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool SwitchDrInstanceToMasterResponse::AsyncRequestIdHasBeenSet() const
{
