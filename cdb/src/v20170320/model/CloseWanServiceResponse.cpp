...
CoreInternalOutcome CloseWanServiceResponse::Deserialize(const string &payload)
{
...
string CloseWanServiceResponse::ToJsonString() const
{
...
string CloseWanServiceResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool CloseWanServiceResponse::AsyncRequestIdHasBeenSet() const
{
