...
string DescribeDBInstanceLogToCLSRequest::ToJsonString() const
{
...
string DescribeDBInstanceLogToCLSRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeDBInstanceLogToCLSRequest::SetInstanceId(const string& _instanceId)
{
