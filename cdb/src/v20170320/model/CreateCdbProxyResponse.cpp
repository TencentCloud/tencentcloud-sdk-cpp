...
CoreInternalOutcome CreateCdbProxyResponse::Deserialize(const string &payload)
{
...
string CreateCdbProxyResponse::ToJsonString() const
{
...
string CreateCdbProxyResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool CreateCdbProxyResponse::AsyncRequestIdHasBeenSet() const
{
