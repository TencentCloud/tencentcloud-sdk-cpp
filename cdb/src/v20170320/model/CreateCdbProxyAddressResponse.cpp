...
CoreInternalOutcome CreateCdbProxyAddressResponse::Deserialize(const string &payload)
{
...
string CreateCdbProxyAddressResponse::ToJsonString() const
{
...
string CreateCdbProxyAddressResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool CreateCdbProxyAddressResponse::AsyncRequestIdHasBeenSet() const
{
