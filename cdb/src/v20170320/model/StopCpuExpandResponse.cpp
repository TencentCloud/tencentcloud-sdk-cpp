...
CoreInternalOutcome StopCpuExpandResponse::Deserialize(const string &payload)
{
...
string StopCpuExpandResponse::ToJsonString() const
{
...
string StopCpuExpandResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool StopCpuExpandResponse::AsyncRequestIdHasBeenSet() const
{
