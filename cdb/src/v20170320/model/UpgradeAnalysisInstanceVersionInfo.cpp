...
CoreInternalOutcome UpgradeAnalysisInstanceVersionInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ExpireTime") && !value["ExpireTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UpgradeAnalysisInstanceVersionInfo.ExpireTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
int64_t UpgradeAnalysisInstanceVersionInfo::GetExpireTime() const
{
    return m_expireTime;
}

void UpgradeAnalysisInstanceVersionInfo::SetExpireTime(const int64_t& _expireTime)
{
    m_expireTime = _expireTime;
    m_expireTimeHasBeenSet = true;
}

bool UpgradeAnalysisInstanceVersionInfo::ExpireTimeHasBeenSet() const
{
