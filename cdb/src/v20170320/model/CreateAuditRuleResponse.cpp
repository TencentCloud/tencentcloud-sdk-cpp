...
CoreInternalOutcome CreateAuditRuleResponse::Deserialize(const string &payload)
{
...
string CreateAuditRuleResponse::ToJsonString() const
{
...
string CreateAuditRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateAuditRuleResponse::RuleIdHasBeenSet() const
{
