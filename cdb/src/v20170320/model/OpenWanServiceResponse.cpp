...
CoreInternalOutcome OpenWanServiceResponse::Deserialize(const string &payload)
{
...
string OpenWanServiceResponse::ToJsonString() const
{
...
string OpenWanServiceResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool OpenWanServiceResponse::AsyncRequestIdHasBeenSet() const
{
