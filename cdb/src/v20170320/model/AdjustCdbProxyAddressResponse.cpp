...
CoreInternalOutcome AdjustCdbProxyAddressResponse::Deserialize(const string &payload)
{
...
string AdjustCdbProxyAddressResponse::ToJsonString() const
{
...
string AdjustCdbProxyAddressResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool AdjustCdbProxyAddressResponse::AsyncRequestIdHasBeenSet() const
{
