...
CoreInternalOutcome OpenDBInstanceGTIDResponse::Deserialize(const string &payload)
{
...
string OpenDBInstanceGTIDResponse::ToJsonString() const
{
...
string OpenDBInstanceGTIDResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool OpenDBInstanceGTIDResponse::AsyncRequestIdHasBeenSet() const
{
