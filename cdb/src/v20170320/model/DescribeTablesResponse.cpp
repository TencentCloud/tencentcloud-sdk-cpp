...
int64_t DescribeTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<string> DescribeTablesResponse::GetItems() const
{
    return m_items;
}

bool DescribeTablesResponse::ItemsHasBeenSet() const
{
