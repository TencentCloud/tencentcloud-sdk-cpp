...
CoreInternalOutcome QueryCDBProxyResponse::Deserialize(const string &payload)
{
...
string QueryCDBProxyResponse::ToJsonString() const
{
...
uint64_t QueryCDBProxyResponse::GetCount() const
{
    return m_count;
}

bool QueryCDBProxyResponse::CountHasBeenSet() const
{
    return m_countHasBeenSet;
}

vector<ProxyGroups> QueryCDBProxyResponse::GetProxyGroup() const
{
    return m_proxyGroup;
}

bool QueryCDBProxyResponse::ProxyGroupHasBeenSet() const
{
