...
CoreInternalOutcome StartBatchRollbackResponse::Deserialize(const string &payload)
{
...
string StartBatchRollbackResponse::ToJsonString() const
{
...
string StartBatchRollbackResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool StartBatchRollbackResponse::AsyncRequestIdHasBeenSet() const
{
