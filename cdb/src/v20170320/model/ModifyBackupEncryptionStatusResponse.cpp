...
CoreInternalOutcome ModifyBackupEncryptionStatusResponse::Deserialize(const string &payload)
{
...
string ModifyBackupEncryptionStatusResponse::ToJsonString() const
{
