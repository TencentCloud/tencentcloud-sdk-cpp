...
CoreInternalOutcome ReleaseIsolatedDBInstancesResponse::Deserialize(const string &payload)
{
...
string ReleaseIsolatedDBInstancesResponse::ToJsonString() const
{
...
vector<ReleaseResult> ReleaseIsolatedDBInstancesResponse::GetItems() const
{
    return m_items;
}

bool ReleaseIsolatedDBInstancesResponse::ItemsHasBeenSet() const
{
