...
CoreInternalOutcome CreateAuditPolicyResponse::Deserialize(const string &payload)
{
...
string CreateAuditPolicyResponse::ToJsonString() const
{
...
string CreateAuditPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateAuditPolicyResponse::PolicyIdHasBeenSet() const
{
