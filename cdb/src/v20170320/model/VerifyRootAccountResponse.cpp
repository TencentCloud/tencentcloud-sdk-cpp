...
CoreInternalOutcome VerifyRootAccountResponse::Deserialize(const string &payload)
{
...
string VerifyRootAccountResponse::ToJsonString() const
{
...
string VerifyRootAccountResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool VerifyRootAccountResponse::AsyncRequestIdHasBeenSet() const
{
