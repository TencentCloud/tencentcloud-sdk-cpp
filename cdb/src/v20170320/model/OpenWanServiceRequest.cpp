...
string OpenWanServiceRequest::ToJsonString() const
{
...
string OpenWanServiceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void OpenWanServiceRequest::SetInstanceId(const string& _instanceId)
{
