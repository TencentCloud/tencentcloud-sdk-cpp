...
CoreInternalOutcome ModifyAccountHostResponse::Deserialize(const string &payload)
{
...
string ModifyAccountHostResponse::ToJsonString() const
{
...
string ModifyAccountHostResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool ModifyAccountHostResponse::AsyncRequestIdHasBeenSet() const
{
