...
string ModifyBackupEncryptionStatusRequest::ToJsonString() const
{
...
string ModifyBackupEncryptionStatusRequest::GetInstanceId() const
{
    return m_instanceId;
}

void ModifyBackupEncryptionStatusRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ModifyBackupEncryptionStatusRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ModifyBackupEncryptionStatusRequest::GetEncryptionStatus() const
{
    return m_encryptionStatus;
}

void ModifyBackupEncryptionStatusRequest::SetEncryptionStatus(const string& _encryptionStatus)
{
