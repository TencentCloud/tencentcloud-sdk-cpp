...
string StopDBImportJobRequest::ToJsonString() const
{
...
string StopDBImportJobRequest::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

void StopDBImportJobRequest::SetAsyncRequestId(const string& _asyncRequestId)
{
    m_asyncRequestId = _asyncRequestId;
    m_asyncRequestIdHasBeenSet = true;
}

bool StopDBImportJobRequest::AsyncRequestIdHasBeenSet() const
{
