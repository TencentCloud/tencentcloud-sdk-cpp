...
string CloseSSLRequest::ToJsonString() const
{
...
string CloseSSLRequest::GetInstanceId() const
{
    return m_instanceId;
}

void CloseSSLRequest::SetInstanceId(const string& _instanceId)
{
...
string CloseSSLRequest::GetRoGroupId() const
{
    return m_roGroupId;
}

void CloseSSLRequest::SetRoGroupId(const string& _roGroupId)
{
    m_roGroupId = _roGroupId;
    m_roGroupIdHasBeenSet = true;
}

bool CloseSSLRequest::RoGroupIdHasBeenSet() const
{
