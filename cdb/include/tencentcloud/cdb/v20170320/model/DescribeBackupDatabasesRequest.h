...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEBACKUPDATABASESREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEBACKUPDATABASESREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeBackupDatabasesRequest : public AbstractModel
                {
                public:
                    DescribeBackupDatabasesRequest();
                    ~DescribeBackupDatabasesRequest() = default;
                ...
                private:
                     ...
                     * 要查询的数据库名前缀。
                     */
                    std::string m_searchDatabase;
                    bool m_searchDatabaseHasBeenSet;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEBACKUPDATABASESREQUEST_H_
