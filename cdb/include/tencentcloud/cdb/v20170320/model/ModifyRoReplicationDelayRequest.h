...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_MODIFYROREPLICATIONDELAYREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_MODIFYROREPLICATIONDELAYREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class ModifyRoReplicationDelayRequest : public AbstractModel
                {
                public:
                    ModifyRoReplicationDelayRequest();
                    ~ModifyRoReplicationDelayRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_MODIFYROREPLICATIONDELAYREQUEST_H_
