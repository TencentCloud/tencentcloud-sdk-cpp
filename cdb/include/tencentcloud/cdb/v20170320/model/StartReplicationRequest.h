...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_STARTREPLICATIONREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_STARTREPLICATIONREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class StartReplicationRequest : public AbstractModel
                {
                public:
                    StartReplicationRequest();
                    ~StartReplicationRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_STARTREPLICATIONREQUEST_H_
