...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_RWINFOS_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_RWINFOS_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                * proxy读写分离信息
                */
                class RWInfos : public AbstractModel
                {
                public:
                    RWInfos();
                    ~RWInfos() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<RWInstanceInfo> m_rWInstInfo;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_RWINFOS_H_
