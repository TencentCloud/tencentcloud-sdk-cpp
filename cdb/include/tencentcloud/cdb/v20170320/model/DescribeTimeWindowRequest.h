...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBETIMEWINDOWREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBETIMEWINDOWREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeTimeWindowRequest : public AbstractModel
                {
                public:
                    DescribeTimeWindowRequest();
                    ~DescribeTimeWindowRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBETIMEWINDOWREQUEST_H_
