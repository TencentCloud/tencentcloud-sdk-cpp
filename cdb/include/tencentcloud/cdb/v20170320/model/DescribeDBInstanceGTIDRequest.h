...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEGTIDREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEGTIDREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceGTIDRequest : public AbstractModel
                {
                public:
                    DescribeDBInstanceGTIDRequest();
                    ~DescribeDBInstanceGTIDRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEGTIDREQUEST_H_
