...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETECUSTOMDNSHOSTREQUEST_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETECUSTOMDNSHOSTREQUEST_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class DeleteCustomDnsHostRequest : public AbstractModel
                {
                public:
                    DeleteCustomDnsHostRequest();
                    ~DeleteCustomDnsHostRequest() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETECUSTOMDNSHOSTREQUEST_H_
