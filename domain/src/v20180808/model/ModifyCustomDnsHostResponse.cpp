...
ModifyCustomDnsHostResponse::ModifyCustomDnsHostResponse() :
    m_logIdHasBeenSet(false)
{
}

CoreInternalOutcome ModifyCustomDnsHostResponse::Deserialize(const string &payload)
{
...
string ModifyCustomDnsHostResponse::ToJsonString() const
{
...
uint64_t ModifyCustomDnsHostResponse::GetLogId() const
{
    return m_logId;
}

bool ModifyCustomDnsHostResponse::LogIdHasBeenSet() const
{
