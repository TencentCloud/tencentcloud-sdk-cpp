...
CoreInternalOutcome RenewDomainBatchResponse::Deserialize(const string &payload)
{
...
string RenewDomainBatchResponse::ToJsonString() const
{
...
int64_t RenewDomainBatchResponse::GetLogId() const
{
    return m_logId;
}

bool RenewDomainBatchResponse::LogIdHasBeenSet() const
{
