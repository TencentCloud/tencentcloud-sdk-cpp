...
CoreInternalOutcome TransferInDomainBatchResponse::Deserialize(const string &payload)
{
...
string TransferInDomainBatchResponse::ToJsonString() const
{
...
uint64_t TransferInDomainBatchResponse::GetLogId() const
{
    return m_logId;
}

bool TransferInDomainBatchResponse::LogIdHasBeenSet() const
{
