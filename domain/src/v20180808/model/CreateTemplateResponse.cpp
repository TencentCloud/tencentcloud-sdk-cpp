...
CoreInternalOutcome CreateTemplateResponse::Deserialize(const string &payload)
{
...
string CreateTemplateResponse::ToJsonString() const
{
...
TemplateInfo CreateTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool CreateTemplateResponse::TemplateHasBeenSet() const
{
