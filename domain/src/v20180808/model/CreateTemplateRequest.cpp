...
string CreateTemplateRequest::ToJsonString() const
{
...
ContactInfo CreateTemplateRequest::GetContactInfo() const
{
    return m_contactInfo;
}

void CreateTemplateRequest::SetContactInfo(const ContactInfo& _contactInfo)
{
    m_contactInfo = _contactInfo;
    m_contactInfoHasBeenSet = true;
}

bool CreateTemplateRequest::ContactInfoHasBeenSet() const
{
    return m_contactInfoHasBeenSet;
}

CertificateInfo CreateTemplateRequest::GetCertificateInfo() const
{
    return m_certificateInfo;
}

void CreateTemplateRequest::SetCertificateInfo(const CertificateInfo& _certificateInfo)
{
    m_certificateInfo = _certificateInfo;
    m_certificateInfoHasBeenSet = true;
}

bool CreateTemplateRequest::CertificateInfoHasBeenSet() const
{
