...
CoreInternalOutcome ModifyDomainDNSBatchResponse::Deserialize(const string &payload)
{
...
string ModifyDomainDNSBatchResponse::ToJsonString() const
{
...
uint64_t ModifyDomainDNSBatchResponse::GetLogId() const
{
    return m_logId;
}

bool ModifyDomainDNSBatchResponse::LogIdHasBeenSet() const
{
