...
SyncCustomDnsHostResponse::SyncCustomDnsHostResponse() :
    m_logIdHasBeenSet(false)
{
}

CoreInternalOutcome SyncCustomDnsHostResponse::Deserialize(const string &payload)
{
...
string SyncCustomDnsHostResponse::ToJsonString() const
{
...
uint64_t SyncCustomDnsHostResponse::GetLogId() const
{
    return m_logId;
}

bool SyncCustomDnsHostResponse::LogIdHasBeenSet() const
{
