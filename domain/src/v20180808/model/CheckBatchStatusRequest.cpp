...
string CheckBatchStatusRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
vector<uint64_t> CheckBatchStatusRequest::GetLogIds() const
{
    return m_logIds;
}

void CheckBatchStatusRequest::SetLogIds(const vector<uint64_t>& _logIds)
{
    m_logIds = _logIds;
    m_logIdsHasBeenSet = true;
}

bool CheckBatchStatusRequest::LogIdsHasBeenSet() const
{
