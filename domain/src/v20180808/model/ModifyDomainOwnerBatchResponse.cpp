...
CoreInternalOutcome ModifyDomainOwnerBatchResponse::Deserialize(const string &payload)
{
...
string ModifyDomainOwnerBatchResponse::ToJsonString() const
{
...
uint64_t ModifyDomainOwnerBatchResponse::GetLogId() const
{
    return m_logId;
}

bool ModifyDomainOwnerBatchResponse::LogIdHasBeenSet() const
{
