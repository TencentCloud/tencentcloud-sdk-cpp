...
CoreInternalOutcome ModifyTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyTemplateResponse::ToJsonString() const
{
...
TemplateInfo ModifyTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool ModifyTemplateResponse::TemplateHasBeenSet() const
{
