...
CoreInternalOutcome ContactInfo::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("OrganizationNameCN") && !value["OrganizationNameCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.OrganizationNameCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrganizationName") && !value["OrganizationName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.OrganizationName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegistrantNameCN") && !value["RegistrantNameCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.RegistrantNameCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegistrantName") && !value["RegistrantName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.RegistrantName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ProvinceCN") && !value["ProvinceCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.ProvinceCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CityCN") && !value["CityCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.CityCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("StreetCN") && !value["StreetCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.StreetCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Street") && !value["Street"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.Street` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CountryCN") && !value["CountryCN"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.CountryCN` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Telephone") && !value["Telephone"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.Telephone` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Email") && !value["Email"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.Email` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ZipCode") && !value["ZipCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.ZipCode` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegistrantType") && !value["RegistrantType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.RegistrantType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Province") && !value["Province"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.Province` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("City") && !value["City"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.City` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Country") && !value["Country"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ContactInfo.Country` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ContactInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_organizationNameCNHasBeenSet)
    {
        ...
        value.AddMember(iKey, Value(m_organizationNameCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_registrantNameCNHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_registrantNameCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_registrantNameHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_registrantName.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_provinceCNHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_provinceCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_cityCNHasBeenSet)
    {
        ...
        string key = "CityCN";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_cityCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_streetCNHasBeenSet)
    {
        ...
        string key = "StreetCN";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_streetCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_streetHasBeenSet)
    {
        ...
        string key = "Street";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_street.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_countryCNHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_countryCN.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_zipCodeHasBeenSet)
    {
        ...
        string key = "ZipCode";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_zipCode.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_registrantTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_registrantType.c_str(), allocator).Move(), allocator);
    }
