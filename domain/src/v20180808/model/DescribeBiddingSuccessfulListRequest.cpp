...
string DescribeBiddingSuccessfulListRequest::ToJsonString() const
{
...
void DescribeBiddingSuccessfulListRequest::SetPageSize(const uint64_t& _pageSize)
{
...
void DescribeBiddingSuccessfulListRequest::SetStatus(const vector<uint64_t>& _status)
{
    m_status = _status;
    m_statusHasBeenSet = true;
}

bool DescribeBiddingSuccessfulListRequest::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeBiddingSuccessfulListRequest::GetSortField() const
{
    return m_sortField;
}

void DescribeBiddingSuccessfulListRequest::SetSortField(const string& _sortField)
{
    m_sortField = _sortField;
    m_sortFieldHasBeenSet = true;
}

bool DescribeBiddingSuccessfulListRequest::SortFieldHasBeenSet() const
{
    return m_sortFieldHasBeenSet;
}

string DescribeBiddingSuccessfulListRequest::GetSortOrder() const
{
    return m_sortOrder;
}

void DescribeBiddingSuccessfulListRequest::SetSortOrder(const string& _sortOrder)
{
    m_sortOrder = _sortOrder;
    m_sortOrderHasBeenSet = true;
}

bool DescribeBiddingSuccessfulListRequest::SortOrderHasBeenSet() const
{
