...
CreateCustomDnsHostResponse::CreateCustomDnsHostResponse() :
    m_logIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateCustomDnsHostResponse::Deserialize(const string &payload)
{
...
string CreateCustomDnsHostResponse::ToJsonString() const
{
...
uint64_t CreateCustomDnsHostResponse::GetLogId() const
{
    return m_logId;
}

bool CreateCustomDnsHostResponse::LogIdHasBeenSet() const
{
