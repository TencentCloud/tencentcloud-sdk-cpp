...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_GOODNEWS_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_GOODNEWS_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * 计费下单接口出入参Goods
                */
                class GoodNews : public AbstractModel
                {
                public:
                    GoodNews();
                    ~GoodNews() = default;
                     ...
                     * 
                     */
                    GoodsDetailNew GetGoodsDetail() const;
                     ...
                     * 
                     */
                    void SetGoodsDetail(const GoodsDetailNew& _goodsDetail);
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_GOODNEWS_H_
