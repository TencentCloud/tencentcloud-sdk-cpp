...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEUSERSIGNATURERULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEUSERSIGNATURERULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DescribeUserSignatureRuleRequest : public AbstractModel
                {
                public:
                    DescribeUserSignatureRuleRequest();
                    ~DescribeUserSignatureRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEUSERSIGNATURERULEREQUEST_H_
