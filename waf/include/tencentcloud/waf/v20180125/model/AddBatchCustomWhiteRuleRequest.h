...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_ADDBATCHCUSTOMWHITERULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_ADDBATCHCUSTOMWHITERULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class AddBatchCustomWhiteRuleRequest : public AbstractModel
                {
                public:
                    AddBatchCustomWhiteRuleRequest();
                    ~AddBatchCustomWhiteRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_ADDBATCHCUSTOMWHITERULEREQUEST_H_
