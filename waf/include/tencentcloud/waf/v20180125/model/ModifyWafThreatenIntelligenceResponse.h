...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFTHREATENINTELLIGENCERESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFTHREATENINTELLIGENCERESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyWafThreatenIntelligenceResponse : public AbstractModel
                {
                public:
                    ModifyWafThreatenIntelligenceResponse();
                    ~ModifyWafThreatenIntelligenceResponse() = default;
                    ...
                    /**
                     * 获取当前WAF威胁情报封禁模块详情
                     * @return WafThreatenIntelligenceDetails 当前WAF威胁情报封禁模块详情
                     * 
                     */
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFTHREATENINTELLIGENCERESPONSE_H_
