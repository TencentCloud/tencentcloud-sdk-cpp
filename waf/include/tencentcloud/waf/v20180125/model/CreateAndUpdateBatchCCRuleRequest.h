...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_CREATEANDUPDATEBATCHCCRULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_CREATEANDUPDATEBATCHCCRULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class CreateAndUpdateBatchCCRuleRequest : public AbstractModel
                {
                public:
                    CreateAndUpdateBatchCCRuleRequest();
                    ~CreateAndUpdateBatchCCRuleRequest() = default;
                     ...
                     * 
                     */
                    void SetActionRatio(const int64_t& _actionRatio);
                    ...
                    /**
                     * 获取定时生效类型：month or week
                     * @return CronType 定时生效类型：month or week
                     * 
                     */
                    std::string GetCronType() const;

                    /**
                     * 设置定时生效类型：month or week
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_CREATEANDUPDATEBATCHCCRULEREQUEST_H_
