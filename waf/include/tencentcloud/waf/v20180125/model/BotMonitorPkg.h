...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_BOTMONITORPKG_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_BOTMONITORPKG_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * BOT安全监测资源信息
                */
                class BotMonitorPkg : public AbstractModel
                {
                public:
                    BotMonitorPkg();
                    ~BotMonitorPkg() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_BOTMONITORPKG_H_
