...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DEDICATEDIPPKG_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DEDICATEDIPPKG_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * 独享IP套餐资源信息
                */
                class DedicatedIPPkg : public AbstractModel
                {
                public:
                    DedicatedIPPkg();
                    ~DedicatedIPPkg() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DEDICATEDIPPKG_H_
