...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYBATCHCUSTOMRULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYBATCHCUSTOMRULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyBatchCustomRuleRequest : public AbstractModel
                {
                public:
                    ModifyBatchCustomRuleRequest();
                    ~ModifyBatchCustomRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYBATCHCUSTOMRULEREQUEST_H_
