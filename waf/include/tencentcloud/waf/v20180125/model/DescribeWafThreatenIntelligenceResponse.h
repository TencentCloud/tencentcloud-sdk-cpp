...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEWAFTHREATENINTELLIGENCERESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEWAFTHREATENINTELLIGENCERESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DescribeWafThreatenIntelligenceResponse : public AbstractModel
                {
                public:
                    DescribeWafThreatenIntelligenceResponse();
                    ~DescribeWafThreatenIntelligenceResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEWAFTHREATENINTELLIGENCERESPONSE_H_
