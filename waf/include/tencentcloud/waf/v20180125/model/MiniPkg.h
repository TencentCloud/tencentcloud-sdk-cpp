...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MINIPKG_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MINIPKG_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * 小程序安全资源信息
                */
                class MiniPkg : public AbstractModel
                {
                public:
                    MiniPkg();
                    ~MiniPkg() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MINIPKG_H_
