...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWEBSHELLSTATUSRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWEBSHELLSTATUSRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyWebshellStatusResponse : public AbstractModel
                {
                public:
                    ModifyWebshellStatusResponse();
                    ~ModifyWebshellStatusResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWEBSHELLSTATUSRESPONSE_H_
