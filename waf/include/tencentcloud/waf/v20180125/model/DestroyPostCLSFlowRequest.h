...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESTROYPOSTCLSFLOWREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESTROYPOSTCLSFLOWREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DestroyPostCLSFlowRequest : public AbstractModel
                {
                public:
                    DestroyPostCLSFlowRequest();
                    ~DestroyPostCLSFlowRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESTROYPOSTCLSFLOWREQUEST_H_
