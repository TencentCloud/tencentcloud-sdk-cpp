...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_BOTSECURITYPKG_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_BOTSECURITYPKG_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * BOT安全护航资源信息
                */
                class BotSecurityPkg : public AbstractModel
                {
                public:
                    BotSecurityPkg();
                    ~BotSecurityPkg() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_BOTSECURITYPKG_H_
