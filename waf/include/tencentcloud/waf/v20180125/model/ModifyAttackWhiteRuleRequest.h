...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYATTACKWHITERULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYATTACKWHITERULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyAttackWhiteRuleRequest : public AbstractModel
                {
                public:
                    ModifyAttackWhiteRuleRequest();
                    ~ModifyAttackWhiteRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYATTACKWHITERULEREQUEST_H_
