...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBECUSTOMRULELISTRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBECUSTOMRULELISTRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DescribeCustomRuleListResponse : public AbstractModel
                {
                public:
                    DescribeCustomRuleListResponse();
                    ~DescribeCustomRuleListResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBECUSTOMRULELISTRESPONSE_H_
