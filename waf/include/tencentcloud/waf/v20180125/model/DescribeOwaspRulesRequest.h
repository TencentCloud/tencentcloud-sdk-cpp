...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEOWASPRULESREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEOWASPRULESREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DescribeOwaspRulesRequest : public AbstractModel
                {
                public:
                    DescribeOwaspRulesRequest();
                    ~DescribeOwaspRulesRequest() = default;
                    ...
                    /**
                     * 获取筛选条件，支持 RuleId：规则ID、TypeId：规则类型、Desc：规则描述 、CveID：CVE编号、Status：规则状态、VulLevel：威胁等级
                    ...
                    /**
                     * 设置筛选条件，支持 RuleId：规则ID、TypeId：规则类型、Desc：规则描述 、CveID：CVE编号、Status：规则状态、VulLevel：威胁等级
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEOWASPRULESREQUEST_H_
