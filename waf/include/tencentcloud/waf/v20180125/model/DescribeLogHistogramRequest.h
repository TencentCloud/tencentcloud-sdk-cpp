...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBELOGHISTOGRAMREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBELOGHISTOGRAMREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取日志主题ID，可以通过DescribeTopics接口获取,访问日志主题ID和攻击日志主题ID方式不同，注意DescribeTopics接口使用方法
                    ...
                    /**
                     * 设置日志主题ID，可以通过DescribeTopics接口获取,访问日志主题ID和攻击日志主题ID方式不同，注意DescribeTopics接口使用方法
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBELOGHISTOGRAMREQUEST_H_
