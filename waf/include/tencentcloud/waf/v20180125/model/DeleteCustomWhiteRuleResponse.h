...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DELETECUSTOMWHITERULERESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DELETECUSTOMWHITERULERESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DeleteCustomWhiteRuleResponse : public AbstractModel
                {
                public:
                    DeleteCustomWhiteRuleResponse();
                    ~DeleteCustomWhiteRuleResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DELETECUSTOMWHITERULERESPONSE_H_
