...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULERESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULERESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomWhiteRuleResponse : public AbstractModel
                {
                public:
                    ModifyCustomWhiteRuleResponse();
                    ~ModifyCustomWhiteRuleResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULERESPONSE_H_
