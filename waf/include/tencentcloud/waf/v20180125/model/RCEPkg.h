...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_RCEPKG_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_RCEPKG_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * 有效REC设备安全包信息
                */
                class RCEPkg : public AbstractModel
                {
                public:
                    RCEPkg();
                    ~RCEPkg() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_RCEPKG_H_
