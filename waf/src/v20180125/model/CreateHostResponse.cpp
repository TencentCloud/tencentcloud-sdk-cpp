...
CoreInternalOutcome CreateHostResponse::Deserialize(const string &payload)
{
...
string CreateHostResponse::ToJsonString() const
{
...
string CreateHostResponse::GetDomainId() const
{
    return m_domainId;
}

bool CreateHostResponse::DomainIdHasBeenSet() const
{
