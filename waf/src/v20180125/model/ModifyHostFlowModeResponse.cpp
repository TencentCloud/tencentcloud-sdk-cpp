...
CoreInternalOutcome ModifyHostFlowModeResponse::Deserialize(const string &payload)
{
...
string ModifyHostFlowModeResponse::ToJsonString() const
{
...
ResponseCode ModifyHostFlowModeResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyHostFlowModeResponse::SuccessHasBeenSet() const
{
