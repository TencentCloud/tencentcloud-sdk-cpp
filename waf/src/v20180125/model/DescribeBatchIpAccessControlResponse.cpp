...
CoreInternalOutcome DescribeBatchIpAccessControlResponse::Deserialize(const string &payload)
{
...
string DescribeBatchIpAccessControlResponse::ToJsonString() const
{
...
BatchIpAccessControlData DescribeBatchIpAccessControlResponse::GetData() const
{
    return m_data;
}

bool DescribeBatchIpAccessControlResponse::DataHasBeenSet() const
{
