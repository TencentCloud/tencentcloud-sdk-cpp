...
CoreInternalOutcome FreshAntiFakeUrlResponse::Deserialize(const string &payload)
{
...
string FreshAntiFakeUrlResponse::ToJsonString() const
{
...
string FreshAntiFakeUrlResponse::GetResult() const
{
    return m_result;
}

bool FreshAntiFakeUrlResponse::ResultHasBeenSet() const
{
