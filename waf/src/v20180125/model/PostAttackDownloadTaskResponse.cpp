...
CoreInternalOutcome PostAttackDownloadTaskResponse::Deserialize(const string &payload)
{
...
string PostAttackDownloadTaskResponse::ToJsonString() const
{
...
string PostAttackDownloadTaskResponse::GetFlow() const
{
    return m_flow;
}

bool PostAttackDownloadTaskResponse::FlowHasBeenSet() const
{
