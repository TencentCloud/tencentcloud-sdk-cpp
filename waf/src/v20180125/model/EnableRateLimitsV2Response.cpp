...
EnableRateLimitsV2Response::EnableRateLimitsV2Response() :
    m_baseInfoHasBeenSet(false)
{
}

CoreInternalOutcome EnableRateLimitsV2Response::Deserialize(const string &payload)
{
...
string EnableRateLimitsV2Response::ToJsonString() const
{
...
RateLimitCommonRsp EnableRateLimitsV2Response::GetBaseInfo() const
{
    return m_baseInfo;
}

bool EnableRateLimitsV2Response::BaseInfoHasBeenSet() const
{
