...
CoreInternalOutcome AccessRuleKeyValueInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CaseSensitive") && !value["CaseSensitive"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AccessRuleKeyValueInfo.CaseSensitive` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("KeyValues") && !value["KeyValues"].IsNull())
    {
        if (!value["KeyValues"].IsArray())
            return CoreInternalOutcome(Core::Error("response `AccessRuleKeyValueInfo.KeyValues` is not array type"));
...
void AccessRuleKeyValueInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
bool AccessRuleKeyValueInfo::GetCaseSensitive() const
{
    return m_caseSensitive;
}

void AccessRuleKeyValueInfo::SetCaseSensitive(const bool& _caseSensitive)
{
    m_caseSensitive = _caseSensitive;
    m_caseSensitiveHasBeenSet = true;
}

bool AccessRuleKeyValueInfo::CaseSensitiveHasBeenSet() const
{
    return m_caseSensitiveHasBeenSet;
}

vector<AccessKeyValueInfo> AccessRuleKeyValueInfo::GetKeyValues() const
{
    return m_keyValues;
}

void AccessRuleKeyValueInfo::SetKeyValues(const vector<AccessKeyValueInfo>& _keyValues)
{
    m_keyValues = _keyValues;
    m_keyValuesHasBeenSet = true;
}

bool AccessRuleKeyValueInfo::KeyValuesHasBeenSet() const
{
