...
CoreInternalOutcome ModifyAntiFakeUrlResponse::Deserialize(const string &payload)
{
...
string ModifyAntiFakeUrlResponse::ToJsonString() const
{
...
string ModifyAntiFakeUrlResponse::GetResult() const
{
    return m_result;
}

bool ModifyAntiFakeUrlResponse::ResultHasBeenSet() const
{
