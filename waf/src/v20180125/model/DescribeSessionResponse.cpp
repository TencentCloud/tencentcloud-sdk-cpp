...
CoreInternalOutcome DescribeSessionResponse::Deserialize(const string &payload)
{
...
string DescribeSessionResponse::ToJsonString() const
{
...
SessionData DescribeSessionResponse::GetData() const
{
    return m_data;
}

bool DescribeSessionResponse::DataHasBeenSet() const
{
