...
CoreInternalOutcome ModifyCustomWhiteRuleResponse::Deserialize(const string &payload)
{
...
string ModifyCustomWhiteRuleResponse::ToJsonString() const
{
...
ResponseCode ModifyCustomWhiteRuleResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCustomWhiteRuleResponse::SuccessHasBeenSet() const
{
