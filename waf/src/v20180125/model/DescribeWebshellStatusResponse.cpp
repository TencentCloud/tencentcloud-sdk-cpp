...
CoreInternalOutcome DescribeWebshellStatusResponse::Deserialize(const string &payload)
{
...
string DescribeWebshellStatusResponse::ToJsonString() const
{
...
string DescribeWebshellStatusResponse::GetDomain() const
{
    return m_domain;
}

bool DescribeWebshellStatusResponse::DomainHasBeenSet() const
{
    return m_domainHasBeenSet;
}

uint64_t DescribeWebshellStatusResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebshellStatusResponse::StatusHasBeenSet() const
{
