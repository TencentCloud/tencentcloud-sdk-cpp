...
CreateProtectGroupResponse::CreateProtectGroupResponse() :
    m_groupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateProtectGroupResponse::Deserialize(const string &payload)
{
...
string CreateProtectGroupResponse::ToJsonString() const
{
...
uint64_t CreateProtectGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateProtectGroupResponse::GroupIdHasBeenSet() const
{
