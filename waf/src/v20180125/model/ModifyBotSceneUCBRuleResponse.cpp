...
CoreInternalOutcome ModifyBotSceneUCBRuleResponse::Deserialize(const string &payload)
{
...
string ModifyBotSceneUCBRuleResponse::ToJsonString() const
{
...
string ModifyBotSceneUCBRuleResponse::GetData() const
{
    return m_data;
}
