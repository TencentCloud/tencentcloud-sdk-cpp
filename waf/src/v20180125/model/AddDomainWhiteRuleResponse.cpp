...
CoreInternalOutcome AddDomainWhiteRuleResponse::Deserialize(const string &payload)
{
...
string AddDomainWhiteRuleResponse::ToJsonString() const
{
...
uint64_t AddDomainWhiteRuleResponse::GetId() const
{
    return m_id;
}

bool AddDomainWhiteRuleResponse::IdHasBeenSet() const
{
