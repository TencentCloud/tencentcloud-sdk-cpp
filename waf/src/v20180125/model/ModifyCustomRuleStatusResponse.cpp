...
CoreInternalOutcome ModifyCustomRuleStatusResponse::Deserialize(const string &payload)
{
...
string ModifyCustomRuleStatusResponse::ToJsonString() const
{
...
ResponseCode ModifyCustomRuleStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCustomRuleStatusResponse::SuccessHasBeenSet() const
{
