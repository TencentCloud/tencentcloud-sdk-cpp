...
CoreInternalOutcome DescribeAccessIndexResponse::Deserialize(const string &payload)
{
...
string DescribeAccessIndexResponse::ToJsonString() const
{
...
bool DescribeAccessIndexResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAccessIndexResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

AccessRuleInfo DescribeAccessIndexResponse::GetRule() const
{
    return m_rule;
}

bool DescribeAccessIndexResponse::RuleHasBeenSet() const
{
    return m_ruleHasBeenSet;
}

string DescribeAccessIndexResponse::GetModifyTime() const
{
    return m_modifyTime;
}

bool DescribeAccessIndexResponse::ModifyTimeHasBeenSet() const
{
