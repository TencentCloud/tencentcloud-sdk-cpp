...
CoreInternalOutcome DeleteIpAccessControlV2Response::Deserialize(const string &payload)
{
...
string DeleteIpAccessControlV2Response::ToJsonString() const
{
...
int64_t DeleteIpAccessControlV2Response::GetFailedCount() const
{
    return m_failedCount;
}

bool DeleteIpAccessControlV2Response::FailedCountHasBeenSet() const
{
