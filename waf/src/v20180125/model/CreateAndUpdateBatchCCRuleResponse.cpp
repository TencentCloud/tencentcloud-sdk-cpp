...
CreateAndUpdateBatchCCRuleResponse::CreateAndUpdateBatchCCRuleResponse() :
    m_ruleIdHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateAndUpdateBatchCCRuleResponse::Deserialize(const string &payload)
{
...
string CreateAndUpdateBatchCCRuleResponse::ToJsonString() const
{
...
int64_t CreateAndUpdateBatchCCRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateAndUpdateBatchCCRuleResponse::RuleIdHasBeenSet() const
{
    return m_ruleIdHasBeenSet;
}

string CreateAndUpdateBatchCCRuleResponse::GetData() const
{
    return m_data;
}

bool CreateAndUpdateBatchCCRuleResponse::DataHasBeenSet() const
{
