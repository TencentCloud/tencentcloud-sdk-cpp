...
DescribeWafInfoResponse::DescribeWafInfoResponse() :
    m_totalHasBeenSet(false),
    m_hostListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeWafInfoResponse::Deserialize(const string &payload)
{
...
string DescribeWafInfoResponse::ToJsonString() const
{
...
uint64_t DescribeWafInfoResponse::GetTotal() const
{
    return m_total;
}

bool DescribeWafInfoResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ClbHostResult> DescribeWafInfoResponse::GetHostList() const
{
    return m_hostList;
}

bool DescribeWafInfoResponse::HostListHasBeenSet() const
{
