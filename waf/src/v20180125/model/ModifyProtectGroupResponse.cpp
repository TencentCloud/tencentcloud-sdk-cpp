...
ModifyProtectGroupResponse::ModifyProtectGroupResponse() :
    m_groupIdHasBeenSet(false)
{
}

CoreInternalOutcome ModifyProtectGroupResponse::Deserialize(const string &payload)
{
...
string ModifyProtectGroupResponse::ToJsonString() const
{
...
uint64_t ModifyProtectGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool ModifyProtectGroupResponse::GroupIdHasBeenSet() const
{
