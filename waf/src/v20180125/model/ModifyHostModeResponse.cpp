...
CoreInternalOutcome ModifyHostModeResponse::Deserialize(const string &payload)
{
...
string ModifyHostModeResponse::ToJsonString() const
{
...
ResponseCode ModifyHostModeResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyHostModeResponse::SuccessHasBeenSet() const
{
