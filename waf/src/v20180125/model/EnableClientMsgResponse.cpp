...
EnableClientMsgResponse::EnableClientMsgResponse() :
    m_retCodeHasBeenSet(false)
{
}

CoreInternalOutcome EnableClientMsgResponse::Deserialize(const string &payload)
{
...
string EnableClientMsgResponse::ToJsonString() const
{
...
int64_t EnableClientMsgResponse::GetRetCode() const
{
    return m_retCode;
}

bool EnableClientMsgResponse::RetCodeHasBeenSet() const
{
