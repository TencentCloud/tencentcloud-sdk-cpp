...
CoreInternalOutcome UpsertCCRuleResponse::Deserialize(const string &payload)
{
...
string UpsertCCRuleResponse::ToJsonString() const
{
...
string UpsertCCRuleResponse::GetData() const
{
    return m_data;
}
