...
CoreInternalOutcome DescribeCustomRuleListResponse::Deserialize(const string &payload)
{
...
string DescribeCustomRuleListResponse::ToJsonString() const
{
...
vector<DescribeCustomRulesRspRuleListItem> DescribeCustomRuleListResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeCustomRuleListResponse::RuleListHasBeenSet() const
{
    return m_ruleListHasBeenSet;
}

string DescribeCustomRuleListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCustomRuleListResponse::TotalCountHasBeenSet() const
{
