...
CoreInternalOutcome DescribeCCRuleResponse::Deserialize(const string &payload)
{
...
string DescribeCCRuleResponse::ToJsonString() const
{
...
CCRuleData DescribeCCRuleResponse::GetData() const
{
    return m_data;
}

bool DescribeCCRuleResponse::DataHasBeenSet() const
{
