...
CoreInternalOutcome DescribeAntiInfoLeakRulesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("RuleList") && !rsp["RuleList"].IsNull())
    {
        ...
        {
            DescribeAntiInfoLeakRulesRuleItem item;
...
string DescribeAntiInfoLeakRulesResponse::ToJsonString() const
{
...
string DescribeAntiInfoLeakRulesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAntiInfoLeakRulesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DescribeAntiInfoLeakRulesRuleItem> DescribeAntiInfoLeakRulesResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeAntiInfoLeakRulesResponse::RuleListHasBeenSet() const
{
