...
CoreInternalOutcome DescribeAntiInfoLeakageRulesResponse::Deserialize(const string &payload)
{
...
string DescribeAntiInfoLeakageRulesResponse::ToJsonString() const
{
...
uint64_t DescribeAntiInfoLeakageRulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAntiInfoLeakageRulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DescribeAntiLeakageItem> DescribeAntiInfoLeakageRulesResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeAntiInfoLeakageRulesResponse::RuleListHasBeenSet() const
{
