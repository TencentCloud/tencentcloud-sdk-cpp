...
CoreInternalOutcome CreateIpAccessControlResponse::Deserialize(const string &payload)
{
...
string CreateIpAccessControlResponse::ToJsonString() const
{
...
uint64_t CreateIpAccessControlResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateIpAccessControlResponse::RuleIdHasBeenSet() const
{
