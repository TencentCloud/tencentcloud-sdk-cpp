...
DeleteRateLimitsV2Response::DeleteRateLimitsV2Response() :
    m_baseInfoHasBeenSet(false)
{
}

CoreInternalOutcome DeleteRateLimitsV2Response::Deserialize(const string &payload)
{
...
string DeleteRateLimitsV2Response::ToJsonString() const
{
...
RateLimitCommonRsp DeleteRateLimitsV2Response::GetBaseInfo() const
{
    return m_baseInfo;
}

bool DeleteRateLimitsV2Response::BaseInfoHasBeenSet() const
{
