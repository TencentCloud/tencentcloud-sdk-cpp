...
CoreInternalOutcome DescribeUserLevelResponse::Deserialize(const string &payload)
{
...
string DescribeUserLevelResponse::ToJsonString() const
{
...
uint64_t DescribeUserLevelResponse::GetLevel() const
{
    return m_level;
}

bool DescribeUserLevelResponse::LevelHasBeenSet() const
{
