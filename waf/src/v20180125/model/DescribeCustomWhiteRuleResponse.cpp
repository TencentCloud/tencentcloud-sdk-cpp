...
CoreInternalOutcome DescribeCustomWhiteRuleResponse::Deserialize(const string &payload)
{
...
string DescribeCustomWhiteRuleResponse::ToJsonString() const
{
...
vector<DescribeCustomRulesRspRuleListItem> DescribeCustomWhiteRuleResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeCustomWhiteRuleResponse::RuleListHasBeenSet() const
{
    return m_ruleListHasBeenSet;
}

string DescribeCustomWhiteRuleResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCustomWhiteRuleResponse::TotalCountHasBeenSet() const
{
