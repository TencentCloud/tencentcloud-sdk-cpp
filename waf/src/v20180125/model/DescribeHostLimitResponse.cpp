...
CoreInternalOutcome DescribeHostLimitResponse::Deserialize(const string &payload)
{
...
string DescribeHostLimitResponse::ToJsonString() const
{
...
ResponseCode DescribeHostLimitResponse::GetSuccess() const
{
    return m_success;
}

bool DescribeHostLimitResponse::SuccessHasBeenSet() const
{
