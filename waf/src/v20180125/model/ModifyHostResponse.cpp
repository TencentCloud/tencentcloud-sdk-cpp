...
CoreInternalOutcome ModifyHostResponse::Deserialize(const string &payload)
{
...
string ModifyHostResponse::ToJsonString() const
{
...
string ModifyHostResponse::GetDomainId() const
{
    return m_domainId;
}

bool ModifyHostResponse::DomainIdHasBeenSet() const
{
