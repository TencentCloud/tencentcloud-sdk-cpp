...
CoreInternalOutcome ModifyHostStatusResponse::Deserialize(const string &payload)
{
...
string ModifyHostStatusResponse::ToJsonString() const
{
...
ResponseCode ModifyHostStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyHostStatusResponse::SuccessHasBeenSet() const
{
