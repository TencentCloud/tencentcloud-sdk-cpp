...
CoreInternalOutcome AddCustomWhiteRuleResponse::Deserialize(const string &payload)
{
...
string AddCustomWhiteRuleResponse::ToJsonString() const
{
...
ResponseCode AddCustomWhiteRuleResponse::GetSuccess() const
{
    return m_success;
}

bool AddCustomWhiteRuleResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

uint64_t AddCustomWhiteRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool AddCustomWhiteRuleResponse::RuleIdHasBeenSet() const
{
