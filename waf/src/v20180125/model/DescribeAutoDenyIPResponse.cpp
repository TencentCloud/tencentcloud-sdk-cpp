...
CoreInternalOutcome DescribeAutoDenyIPResponse::Deserialize(const string &payload)
{
...
string DescribeAutoDenyIPResponse::ToJsonString() const
{
...
IpHitItemsData DescribeAutoDenyIPResponse::GetData() const
{
    return m_data;
}

bool DescribeAutoDenyIPResponse::DataHasBeenSet() const
{
