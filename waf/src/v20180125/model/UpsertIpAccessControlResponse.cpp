...
CoreInternalOutcome UpsertIpAccessControlResponse::Deserialize(const string &payload)
{
...
string UpsertIpAccessControlResponse::ToJsonString() const
{
...
string UpsertIpAccessControlResponse::GetFailedItems() const
{
    return m_failedItems;
}

bool UpsertIpAccessControlResponse::FailedItemsHasBeenSet() const
{
    return m_failedItemsHasBeenSet;
}

int64_t UpsertIpAccessControlResponse::GetFailedCount() const
{
