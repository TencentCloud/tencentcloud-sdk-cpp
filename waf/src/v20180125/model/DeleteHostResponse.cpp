...
CoreInternalOutcome DeleteHostResponse::Deserialize(const string &payload)
{
...
string DeleteHostResponse::ToJsonString() const
{
...
ResponseCode DeleteHostResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteHostResponse::SuccessHasBeenSet() const
{
