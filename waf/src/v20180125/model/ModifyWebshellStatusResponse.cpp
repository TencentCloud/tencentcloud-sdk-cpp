...
CoreInternalOutcome ModifyWebshellStatusResponse::Deserialize(const string &payload)
{
...
string ModifyWebshellStatusResponse::ToJsonString() const
{
...
ResponseCode ModifyWebshellStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyWebshellStatusResponse::SuccessHasBeenSet() const
{
