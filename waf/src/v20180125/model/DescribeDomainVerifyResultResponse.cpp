...
CoreInternalOutcome DescribeDomainVerifyResultResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["VerifyCode"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `VerifyCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_verifyCode = rsp["VerifyCode"].GetInt64();
...
string DescribeDomainVerifyResultResponse::ToJsonString() const
{
...
string DescribeDomainVerifyResultResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDomainVerifyResultResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

int64_t DescribeDomainVerifyResultResponse::GetVerifyCode() const
{
    return m_verifyCode;
}

bool DescribeDomainVerifyResultResponse::VerifyCodeHasBeenSet() const
{
