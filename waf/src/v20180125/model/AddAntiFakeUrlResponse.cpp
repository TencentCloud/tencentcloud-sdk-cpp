...
CoreInternalOutcome AddAntiFakeUrlResponse::Deserialize(const string &payload)
{
...
string AddAntiFakeUrlResponse::ToJsonString() const
{
...
string AddAntiFakeUrlResponse::GetResult() const
{
    return m_result;
}
