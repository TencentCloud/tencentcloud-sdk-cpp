...
CoreInternalOutcome DeleteDomainWhiteRulesResponse::Deserialize(const string &payload)
{
...
string DeleteDomainWhiteRulesResponse::ToJsonString() const
{
...
string DeleteDomainWhiteRulesResponse::GetData() const
{
    return m_data;
}

bool DeleteDomainWhiteRulesResponse::DataHasBeenSet() const
{
