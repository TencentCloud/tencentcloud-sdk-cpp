...
CoreInternalOutcome CreateRateLimitV2Response::Deserialize(const string &payload)
{
...
string CreateRateLimitV2Response::ToJsonString() const
{
...
RateLimitCommonRsp CreateRateLimitV2Response::GetBaseInfo() const
{
    return m_baseInfo;
}
