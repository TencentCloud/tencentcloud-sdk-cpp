...
DescribeAccessHistogramResponse::DescribeAccessHistogramResponse() :
...
CoreInternalOutcome DescribeAccessHistogramResponse::Deserialize(const string &payload)
{
...
string DescribeAccessHistogramResponse::ToJsonString() const
{
...
int64_t DescribeAccessHistogramResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeAccessHistogramResponse::IntervalHasBeenSet() const
{
    return m_intervalHasBeenSet;
}

int64_t DescribeAccessHistogramResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAccessHistogramResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AccessHistogramItem> DescribeAccessHistogramResponse::GetHistogramInfos() const
{
    return m_histogramInfos;
}

bool DescribeAccessHistogramResponse::HistogramInfosHasBeenSet() const
{
