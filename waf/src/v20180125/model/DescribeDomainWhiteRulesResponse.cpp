...
CoreInternalOutcome DescribeDomainWhiteRulesResponse::Deserialize(const string &payload)
{
...
string DescribeDomainWhiteRulesResponse::ToJsonString() const
{
...
vector<RuleList> DescribeDomainWhiteRulesResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeDomainWhiteRulesResponse::RuleListHasBeenSet() const
{
    return m_ruleListHasBeenSet;
}

uint64_t DescribeDomainWhiteRulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeDomainWhiteRulesResponse::TotalHasBeenSet() const
{
