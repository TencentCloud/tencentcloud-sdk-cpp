...
CoreInternalOutcome DescribeFindDomainListResponse::Deserialize(const string &payload)
{
...
string DescribeFindDomainListResponse::ToJsonString() const
{
...
uint64_t DescribeFindDomainListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeFindDomainListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<FindAllDomainDetail> DescribeFindDomainListResponse::GetList() const
{
    return m_list;
}

bool DescribeFindDomainListResponse::ListHasBeenSet() const
{
