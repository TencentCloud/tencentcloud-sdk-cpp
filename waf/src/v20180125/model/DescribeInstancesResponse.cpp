...
uint64_t DescribeInstancesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeInstancesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<InstanceInfo> DescribeInstancesResponse::GetInstances() const
{
    return m_instances;
}
