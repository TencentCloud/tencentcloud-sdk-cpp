...
CoreInternalOutcome DescribeIpHitItemsResponse::Deserialize(const string &payload)
{
...
string DescribeIpHitItemsResponse::ToJsonString() const
{
...
IpHitItemsData DescribeIpHitItemsResponse::GetData() const
{
    return m_data;
}

bool DescribeIpHitItemsResponse::DataHasBeenSet() const
{
