...
CoreInternalOutcome ModifyCustomWhiteRuleStatusResponse::Deserialize(const string &payload)
{
...
string ModifyCustomWhiteRuleStatusResponse::ToJsonString() const
{
...
ResponseCode ModifyCustomWhiteRuleStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCustomWhiteRuleStatusResponse::SuccessHasBeenSet() const
{
