...
CoreInternalOutcome DeleteCustomWhiteRuleResponse::Deserialize(const string &payload)
{
...
string DeleteCustomWhiteRuleResponse::ToJsonString() const
{
...
ResponseCode DeleteCustomWhiteRuleResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteCustomWhiteRuleResponse::SuccessHasBeenSet() const
{
