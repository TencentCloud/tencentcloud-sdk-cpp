...
CoreInternalOutcome ModifyWafAutoDenyRulesResponse::Deserialize(const string &payload)
{
...
string ModifyWafAutoDenyRulesResponse::ToJsonString() const
{
...
ResponseCode ModifyWafAutoDenyRulesResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyWafAutoDenyRulesResponse::SuccessHasBeenSet() const
{
