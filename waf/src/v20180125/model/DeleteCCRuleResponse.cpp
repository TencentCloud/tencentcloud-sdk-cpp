...
CoreInternalOutcome DeleteCCRuleResponse::Deserialize(const string &payload)
{
...
string DeleteCCRuleResponse::ToJsonString() const
{
...
string DeleteCCRuleResponse::GetData() const
{
    return m_data;
}

bool DeleteCCRuleResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DeleteCCRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool DeleteCCRuleResponse::RuleIdHasBeenSet() const
{
