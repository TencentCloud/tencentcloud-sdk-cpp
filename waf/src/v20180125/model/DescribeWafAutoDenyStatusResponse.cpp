...
CoreInternalOutcome DescribeWafAutoDenyStatusResponse::Deserialize(const string &payload)
{
...
string DescribeWafAutoDenyStatusResponse::ToJsonString() const
{
...
AutoDenyDetail DescribeWafAutoDenyStatusResponse::GetWafAutoDenyDetails() const
{
    return m_wafAutoDenyDetails;
}

bool DescribeWafAutoDenyStatusResponse::WafAutoDenyDetailsHasBeenSet() const
{
