...
CoreInternalOutcome CreateDealsResponse::Deserialize(const string &payload)
{
...
string CreateDealsResponse::ToJsonString() const
{
...
DealData CreateDealsResponse::GetData() const
{
    return m_data;
}

bool CreateDealsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t CreateDealsResponse::GetStatus() const
{
    return m_status;
}

bool CreateDealsResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateDealsResponse::GetReturnMessage() const
{
    return m_returnMessage;
}

bool CreateDealsResponse::ReturnMessageHasBeenSet() const
{
