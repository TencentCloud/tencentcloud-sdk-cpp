...
#ifndef TENCENTCLOUD_IG_V20210518_MODEL_DRUGINSTRUCTIONINFO_H_
#define TENCENTCLOUD_IG_V20210518_MODEL_DRUGINSTRUCTIONINFO_H_
    ...
    namespace Ig
    {
        namespace V20210518
        {
            namespace Model
            {
                ...
                * 药品说明书信息
                */
                class DrugInstructionInfo : public AbstractModel
                {
                public:
                    DrugInstructionInfo();
                    ~DrugInstructionInfo() = default;
                     ...
                     * 
                     */
                    void SetDrugUsage(const std::string& _drugUsage);

                    /**
                     * 判断参数 DrugUsage 是否已赋值
                     * @return DrugUsage 是否已赋值
                     * 
                     */
                    bool DrugUsageHasBeenSet() const;
                     ...
                     * 
                     */
                    void SetIndication(const std::string& _indication);

                    /**
                     * 判断参数 Indication 是否已赋值
                     * @return Indication 是否已赋值
                     * 
                     */
                    bool IndicationHasBeenSet() const;
                ...
                private:
                     ...
                     * 用法用量
                     */
                    std::string m_drugUsage;
                    bool m_drugUsageHasBeenSet;

                    /**
                     * 适应症
                     */
                    std::string m_indication;
                    bool m_indicationHasBeenSet;
...
#endif // !TENCENTCLOUD_IG_V20210518_MODEL_DRUGINSTRUCTIONINFO_H_
