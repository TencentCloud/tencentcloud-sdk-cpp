...
#ifndef TENCENTCLOUD_IG_V20210518_MODEL_LLMDIAGNOSISDRUGDATA_H_
#define TENCENTCLOUD_IG_V20210518_MODEL_LLMDIAGNOSISDRUGDATA_H_
    ...
    namespace Ig
    {
        namespace V20210518
        {
            namespace Model
            {
                ...
                * 大模型问药返回数据
                */
                class LLMDiagnosisDrugData : public AbstractModel
                {
                public:
                    LLMDiagnosisDrugData();
                    ~LLMDiagnosisDrugData() = default;
...
#endif // !TENCENTCLOUD_IG_V20210518_MODEL_LLMDIAGNOSISDRUGDATA_H_
