...
#ifndef TENCENTCLOUD_IG_V20210518_MODEL_GETLLMDIAGNOSISDRUGCHATREQUEST_H_
#define TENCENTCLOUD_IG_V20210518_MODEL_GETLLMDIAGNOSISDRUGCHATREQUEST_H_
    ...
    namespace Ig
    {
        namespace V20210518
        {
            namespace Model
            {
                ...
                */
                class GetLLMDiagnosisDrugChatRequest : public AbstractModel
                {
                public:
                    GetLLMDiagnosisDrugChatRequest();
                    ~GetLLMDiagnosisDrugChatRequest() = default;
...
#endif // !TENCENTCLOUD_IG_V20210518_MODEL_GETLLMDIAGNOSISDRUGCHATREQUEST_H_
