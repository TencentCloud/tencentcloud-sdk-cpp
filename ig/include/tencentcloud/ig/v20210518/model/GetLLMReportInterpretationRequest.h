...
#ifndef TENCENTCLOUD_IG_V20210518_MODEL_GETLLMREPORTINTERPRETATIONREQUEST_H_
#define TENCENTCLOUD_IG_V20210518_MODEL_GETLLMREPORTINTERPRETATIONREQUEST_H_
    ...
    namespace Ig
    {
        namespace V20210518
        {
            namespace Model
            {
                ...
                */
                class GetLLMReportInterpretationRequest : public AbstractModel
                {
                public:
                    GetLLMReportInterpretationRequest();
                    ~GetLLMReportInterpretationRequest() = default;
                     ...
                     * 
                     */
                    std::vector<ReportFileInfoReq> GetReportFileInfos() const;
                     ...
                     * 
                     */
                    void SetReportFileInfos(const std::vector<ReportFileInfoReq>& _reportFileInfos);

                    /**
                     * 判断参数 ReportFileInfos 是否已赋值
                     * @return ReportFileInfos 是否已赋值
                     * 
                     */
                    bool ReportFileInfosHasBeenSet() const;
                     ...
                     * 
                     */
                    void SetQaPrompt(const std::string& _qaPrompt);

                    /**
                     * 判断参数 QaPrompt 是否已赋值
                     * @return QaPrompt 是否已赋值
                     * 
                     */
                    bool QaPromptHasBeenSet() const;
                ...
                private:
                     ...
                     * <p>报告文件信息</p>
                     */
                    std::vector<ReportFileInfoReq> m_reportFileInfos;
                    bool m_reportFileInfosHasBeenSet;
                     ...
                     * <p>无报告问答提示词</p>
                     */
                    std::string m_qaPrompt;
                    bool m_qaPromptHasBeenSet;
...
#endif // !TENCENTCLOUD_IG_V20210518_MODEL_GETLLMREPORTINTERPRETATIONREQUEST_H_
