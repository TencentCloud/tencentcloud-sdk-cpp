...
#ifndef TENCENTCLOUD_IG_V20210518_MODEL_STANDARDDRUGCARDINFO_H_
#define TENCENTCLOUD_IG_V20210518_MODEL_STANDARDDRUGCARDINFO_H_
    ...
    namespace Ig
    {
        namespace V20210518
        {
            namespace Model
            {
                ...
                * 标准药品卡片信息
                */
                class StandardDrugCardInfo : public AbstractModel
                {
                public:
                    StandardDrugCardInfo();
                    ~StandardDrugCardInfo() = default;
                     ...
                     * 
                     */
                    std::vector<DrugCardInfo> GetDrugInfos() const;
                     ...
                     * 
                     */
                    void SetDrugInfos(const std::vector<DrugCardInfo>& _drugInfos);
                ...
                private:
                     ...
                     * 药品列表
                     */
                    std::vector<DrugCardInfo> m_drugInfos;
...
#endif // !TENCENTCLOUD_IG_V20210518_MODEL_STANDARDDRUGCARDINFO_H_
