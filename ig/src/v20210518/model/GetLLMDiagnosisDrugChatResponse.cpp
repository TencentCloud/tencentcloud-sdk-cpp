...
GetLLMDiagnosisDrugChatResponse::GetLLMDiagnosisDrugChatResponse() :
...
CoreInternalOutcome GetLLMDiagnosisDrugChatResponse::Deserialize(const string &payload)
{
...
string GetLLMDiagnosisDrugChatResponse::ToJsonString() const
{
...
int64_t GetLLMDiagnosisDrugChatResponse::GetCode() const
{
    return m_code;
}

bool GetLLMDiagnosisDrugChatResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string GetLLMDiagnosisDrugChatResponse::GetMessage() const
{
    return m_message;
}

bool GetLLMDiagnosisDrugChatResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LLMDiagnosisDrugData GetLLMDiagnosisDrugChatResponse::GetData() const
{
    return m_data;
}

bool GetLLMDiagnosisDrugChatResponse::DataHasBeenSet() const
{
