...
GetLLMReportInterpretationResponse::GetLLMReportInterpretationResponse() :
...
CoreInternalOutcome GetLLMReportInterpretationResponse::Deserialize(const string &payload)
{
...
string GetLLMReportInterpretationResponse::ToJsonString() const
{
...
int64_t GetLLMReportInterpretationResponse::GetCode() const
{
    return m_code;
}

bool GetLLMReportInterpretationResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string GetLLMReportInterpretationResponse::GetMessage() const
{
    return m_message;
}

bool GetLLMReportInterpretationResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LLMReportInterpretationData GetLLMReportInterpretationResponse::GetData() const
{
    return m_data;
}

bool GetLLMReportInterpretationResponse::DataHasBeenSet() const
{
