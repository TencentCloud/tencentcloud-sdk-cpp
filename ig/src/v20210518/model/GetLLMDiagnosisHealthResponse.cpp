...
GetLLMDiagnosisHealthResponse::GetLLMDiagnosisHealthResponse() :
...
CoreInternalOutcome GetLLMDiagnosisHealthResponse::Deserialize(const string &payload)
{
...
string GetLLMDiagnosisHealthResponse::ToJsonString() const
{
...
int64_t GetLLMDiagnosisHealthResponse::GetCode() const
{
    return m_code;
}

bool GetLLMDiagnosisHealthResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string GetLLMDiagnosisHealthResponse::GetMessage() const
{
    return m_message;
}

bool GetLLMDiagnosisHealthResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LLMDiagnosisHealthData GetLLMDiagnosisHealthResponse::GetData() const
{
    return m_data;
}

bool GetLLMDiagnosisHealthResponse::DataHasBeenSet() const
{
