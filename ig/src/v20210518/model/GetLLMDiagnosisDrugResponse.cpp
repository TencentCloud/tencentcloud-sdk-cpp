...
GetLLMDiagnosisDrugResponse::GetLLMDiagnosisDrugResponse() :
...
CoreInternalOutcome GetLLMDiagnosisDrugResponse::Deserialize(const string &payload)
{
...
string GetLLMDiagnosisDrugResponse::ToJsonString() const
{
...
int64_t GetLLMDiagnosisDrugResponse::GetCode() const
{
    return m_code;
}

bool GetLLMDiagnosisDrugResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string GetLLMDiagnosisDrugResponse::GetMessage() const
{
    return m_message;
}

bool GetLLMDiagnosisDrugResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LLMDiagnosisDrugData GetLLMDiagnosisDrugResponse::GetData() const
{
    return m_data;
}

bool GetLLMDiagnosisDrugResponse::DataHasBeenSet() const
{
