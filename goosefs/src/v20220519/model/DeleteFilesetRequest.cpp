...
string DeleteFilesetRequest::ToJsonString() const
{
...
string DeleteFilesetRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DeleteFilesetRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool DeleteFilesetRequest::FileSystemIdHasBeenSet() const
{
    return m_fileSystemIdHasBeenSet;
}

string DeleteFilesetRequest::GetFsetId() const
{
    return m_fsetId;
}

void DeleteFilesetRequest::SetFsetId(const string& _fsetId)
{
    m_fsetId = _fsetId;
    m_fsetIdHasBeenSet = true;
}

bool DeleteFilesetRequest::FsetIdHasBeenSet() const
{
