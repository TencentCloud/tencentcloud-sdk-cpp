...
DescribeCustomerClusterResponse::DescribeCustomerClusterResponse() :
    m_clusterSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCustomerClusterResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerClusterResponse::ToJsonString() const
{
...
vector<CustomerClusterAttr> DescribeCustomerClusterResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeCustomerClusterResponse::ClusterSetHasBeenSet() const
{
