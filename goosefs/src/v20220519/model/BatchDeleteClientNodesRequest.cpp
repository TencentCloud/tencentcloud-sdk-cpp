...
string BatchDeleteClientNodesRequest::ToJsonString() const
{
...
string BatchDeleteClientNodesRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void BatchDeleteClientNodesRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool BatchDeleteClientNodesRequest::FileSystemIdHasBeenSet() const
{
    return m_fileSystemIdHasBeenSet;
}

vector<LinuxNodeAttribute> BatchDeleteClientNodesRequest::GetClientNodes() const
{
    return m_clientNodes;
}

void BatchDeleteClientNodesRequest::SetClientNodes(const vector<LinuxNodeAttribute>& _clientNodes)
{
    m_clientNodes = _clientNodes;
    m_clientNodesHasBeenSet = true;
}

bool BatchDeleteClientNodesRequest::ClientNodesHasBeenSet() const
{
    return m_clientNodesHasBeenSet;
}

bool BatchDeleteClientNodesRequest::GetSingleClusterFlag() const
{
    return m_singleClusterFlag;
}

void BatchDeleteClientNodesRequest::SetSingleClusterFlag(const bool& _singleClusterFlag)
{
