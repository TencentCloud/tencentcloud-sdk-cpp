...
BuildCustomerClusterResponse::BuildCustomerClusterResponse() :
    m_clusterIdHasBeenSet(false)
{
}

CoreInternalOutcome BuildCustomerClusterResponse::Deserialize(const string &payload)
{
...
string BuildCustomerClusterResponse::ToJsonString() const
{
...
string BuildCustomerClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool BuildCustomerClusterResponse::ClusterIdHasBeenSet() const
{
