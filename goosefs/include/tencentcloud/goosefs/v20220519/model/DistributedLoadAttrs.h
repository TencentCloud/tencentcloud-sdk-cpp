...
#ifndef TENCENTCLOUD_GOOSEFS_V20220519_MODEL_DISTRIBUTEDLOADATTRS_H_
#define TENCENTCLOUD_GOOSEFS_V20220519_MODEL_DISTRIBUTEDLOADATTRS_H_
    ...
    namespace Goosefs
    {
        namespace V20220519
        {
            namespace Model
            {
                ...
                * 数据预热任务参数
                */
                class DistributedLoadAttrs : public AbstractModel
                {
                public:
                    DistributedLoadAttrs();
                    ~DistributedLoadAttrs() = default;
                    ...
                    /**
                     * 获取预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
                    ...
                    /**
                     * 设置预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
                    ...
                    /**
                     * 获取副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
                    ...
                    /**
                     * 设置副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
                    ...
                    /**
                     * 获取同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
                     * @return MetadataSync 同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
                     * 
                     */
                    bool GetMetadataSync() const;

                    /**
                     * 设置同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
                     * @param _metadataSync 同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
                     * 
                     */
                    void SetMetadataSync(const bool& _metadataSync);

                    /**
                     * 判断参数 MetadataSync 是否已赋值
                     * @return MetadataSync 是否已赋值
                     * 
                     */
                    bool MetadataSyncHasBeenSet() const;
...
#endif // !TENCENTCLOUD_GOOSEFS_V20220519_MODEL_DISTRIBUTEDLOADATTRS_H_
