...
CoreInternalOutcome CreateContractByUploadResponse::Deserialize(const string &payload)
{
...
string CreateContractByUploadResponse::ToJsonString() const
{
...
int64_t CreateContractByUploadResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateContractByUploadResponse::TaskIdHasBeenSet() const
{
