...
string CreateEnterpriseAccountRequest::ToJsonString() const
{
    ...
    if (m_identNoHasBeenSet)
    {
        ...
        string key = "IdentNo";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_identNo.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_mobilePhoneHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_mobilePhone.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_transactorNameHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_transactorName.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_transactorIdentNoHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_transactorIdentNo.c_str(), allocator).Move(), allocator);
    }
