...
CoreInternalOutcome DownloadContractResponse::Deserialize(const string &payload)
{
...
string DownloadContractResponse::ToJsonString() const
{
...
int64_t DownloadContractResponse::GetTaskId() const
{
    return m_taskId;
}

bool DownloadContractResponse::TaskIdHasBeenSet() const
{
