...
CoreInternalOutcome EvaluationResponse::Deserialize(const string &payload)
{
...
string EvaluationResponse::ToJsonString() const
{
...
string EvaluationResponse::GetSessionId() const
{
    return m_sessionId;
}

bool EvaluationResponse::SessionIdHasBeenSet() const
{
    return m_sessionIdHasBeenSet;
}

vector<Item> EvaluationResponse::GetItems() const
{
    return m_items;
}
