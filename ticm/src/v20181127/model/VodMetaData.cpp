...
CoreInternalOutcome VodMetaData::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("Duration") && !value["Duration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Duration` IsDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VideoDuration") && !value["VideoDuration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.VideoDuration` IsDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AudioDuration") && !value["AudioDuration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.AudioDuration` IsDouble=false incorrectly").SetRequestId(requestId));
        }
