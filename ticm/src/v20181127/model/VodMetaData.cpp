...
CoreInternalOutcome VodMetaData::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Size") && !value["Size"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Size` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Container") && !value["Container"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Container` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Bitrate") && !value["Bitrate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Bitrate` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Height") && !value["Height"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Height` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Width") && !value["Width"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Width` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Duration") && !value["Duration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Duration` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Rotate") && !value["Rotate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.Rotate` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VideoStreamSet") && !value["VideoStreamSet"].IsNull())
    {
        if (!value["VideoStreamSet"].IsArray())
            return CoreInternalOutcome(Error("response `VodMetaData.VideoStreamSet` is not array type"));
    ...
    if (value.HasMember("AudioStreamSet") && !value["AudioStreamSet"].IsNull())
    {
        if (!value["AudioStreamSet"].IsArray())
            return CoreInternalOutcome(Error("response `VodMetaData.AudioStreamSet` is not array type"));
    ...
    if (value.HasMember("VideoDuration") && !value["VideoDuration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.VideoDuration` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AudioDuration") && !value["AudioDuration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodMetaData.AudioDuration` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
...
void VodMetaData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
