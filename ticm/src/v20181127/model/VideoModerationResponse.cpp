...
string VideoModerationResponse::ToJsonString() const
{
...
string VideoModerationResponse::GetVodTaskId() const
{
    return m_vodTaskId;
}

bool VideoModerationResponse::VodTaskIdHasBeenSet() const
{
