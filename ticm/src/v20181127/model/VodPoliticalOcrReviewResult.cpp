...
CoreInternalOutcome VodPoliticalOcrReviewResult::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Confidence") && !value["Confidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VodPoliticalOcrReviewResult.Confidence` IsDouble=false incorrectly").SetRequestId(requestId));
        }
...
void VodPoliticalOcrReviewResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
