...
CoreInternalOutcome VodAsrTextSegmentItem::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void VodAsrTextSegmentItem::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
