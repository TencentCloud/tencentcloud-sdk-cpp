...
#ifndef TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNOCRRESULT_H_
#define TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNOCRRESULT_H_
    ...
    namespace Ticm
    {
        namespace V20181127
        {
            namespace Model
            {
                ...
                * 内容审核 Ocr 文字鉴黄任务结果类型
                */
                class VodPornOcrResult : public AbstractModel
                {
                public:
                    VodPornOcrResult();
                    ~VodPornOcrResult() = default;
...
#endif // !TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNOCRRESULT_H_
