...
#ifndef TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNREVIEWRESULT_H_
#define TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNREVIEWRESULT_H_
    ...
    namespace Ticm
    {
        namespace V20181127
        {
            namespace Model
            {
                ...
                * 内容审核鉴黄任务结果类型
                */
                class VodPornReviewResult : public AbstractModel
                {
                public:
                    VodPornReviewResult();
                    ~VodPornReviewResult() = default;
...
#endif // !TENCENTCLOUD_TICM_V20181127_MODEL_VODPORNREVIEWRESULT_H_
