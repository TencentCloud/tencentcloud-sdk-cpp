...
#ifndef TENCENTCLOUD_TICM_V20181127_MODEL_VODOCRTEXTSEGMENTITEM_H_
#define TENCENTCLOUD_TICM_V20181127_MODEL_VODOCRTEXTSEGMENTITEM_H_
    ...
    namespace Ticm
    {
        namespace V20181127
        {
            namespace Model
            {
                ...
                * 内容审核 Ocr 文字审核嫌疑片段
                */
                class VodOcrTextSegmentItem : public AbstractModel
                {
                public:
                    VodOcrTextSegmentItem();
                    ~VodOcrTextSegmentItem() = default;
...
#endif // !TENCENTCLOUD_TICM_V20181127_MODEL_VODOCRTEXTSEGMENTITEM_H_
