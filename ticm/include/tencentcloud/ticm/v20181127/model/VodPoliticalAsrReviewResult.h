...
#ifndef TENCENTCLOUD_TICM_V20181127_MODEL_VODPOLITICALASRREVIEWRESULT_H_
#define TENCENTCLOUD_TICM_V20181127_MODEL_VODPOLITICALASRREVIEWRESULT_H_
    ...
    namespace Ticm
    {
        namespace V20181127
        {
            namespace Model
            {
                ...
                */
                class VodPoliticalAsrReviewResult : public AbstractModel
                {
                public:
                    VodPoliticalAsrReviewResult();
                    ~VodPoliticalAsrReviewResult() = default;
...
#endif // !TENCENTCLOUD_TICM_V20181127_MODEL_VODPOLITICALASRREVIEWRESULT_H_
