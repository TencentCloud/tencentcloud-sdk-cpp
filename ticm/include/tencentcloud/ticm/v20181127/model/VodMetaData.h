...
#ifndef TENCENTCLOUD_TICM_V20181127_MODEL_VODMETADATA_H_
#define TENCENTCLOUD_TICM_V20181127_MODEL_VODMETADATA_H_
    ...
    namespace Ticm
    {
        namespace V20181127
        {
            namespace Model
            {
                ...
                * 媒体文件元信息。
                */
                class VodMetaData : public AbstractModel
                {
                public:
                    VodMetaData();
                    ~VodMetaData() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<VodVideoStreamItem> GetVideoStreamSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetVideoStreamSet(const std::vector<VodVideoStreamItem>& _videoStreamSet);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<VodAudioStreamItem> GetAudioStreamSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetAudioStreamSet(const std::vector<VodAudioStreamItem>& _audioStreamSet);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<VodVideoStreamItem> m_videoStreamSet;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<VodAudioStreamItem> m_audioStreamSet;
...
#endif // !TENCENTCLOUD_TICM_V20181127_MODEL_VODMETADATA_H_
