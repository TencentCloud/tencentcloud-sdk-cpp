...
CoreInternalOutcome DescribeContainerInstanceEventsResponse::Deserialize(const string &payload)
{
...
string DescribeContainerInstanceEventsResponse::ToJsonString() const
{
...
vector<Event> DescribeContainerInstanceEventsResponse::GetEventList() const
{
    return m_eventList;
}

bool DescribeContainerInstanceEventsResponse::EventListHasBeenSet() const
{
