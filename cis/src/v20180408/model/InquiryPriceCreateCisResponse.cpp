...
CoreInternalOutcome InquiryPriceCreateCisResponse::Deserialize(const string &payload)
{
...
string InquiryPriceCreateCisResponse::ToJsonString() const
{
...
Price InquiryPriceCreateCisResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceCreateCisResponse::PriceHasBeenSet() const
{
