...
CoreInternalOutcome DeleteContainerInstanceResponse::Deserialize(const string &payload)
{
...
string DeleteContainerInstanceResponse::ToJsonString() const
{
...
string DeleteContainerInstanceResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteContainerInstanceResponse::MsgHasBeenSet() const
{
