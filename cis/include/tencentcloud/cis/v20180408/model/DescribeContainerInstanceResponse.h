...
#ifndef TENCENTCLOUD_CIS_V20180408_MODEL_DESCRIBECONTAINERINSTANCERESPONSE_H_
#define TENCENTCLOUD_CIS_V20180408_MODEL_DESCRIBECONTAINERINSTANCERESPONSE_H_
    ...
    namespace Cis
    {
        namespace V20180408
        {
            namespace Model
            {
                ...
                */
                class DescribeContainerInstanceResponse : public AbstractModel
                {
                public:
                    DescribeContainerInstanceResponse();
                    ~DescribeContainerInstanceResponse() = default;
...
#endif // !TENCENTCLOUD_CIS_V20180408_MODEL_DESCRIBECONTAINERINSTANCERESPONSE_H_
