...
DescribePriceCreateInstanceResponse::DescribePriceCreateInstanceResponse() :
...
CoreInternalOutcome DescribePriceCreateInstanceResponse::Deserialize(const string &payload)
{
...
string DescribePriceCreateInstanceResponse::ToJsonString() const
{
...
double DescribePriceCreateInstanceResponse::GetPrice() const
{
    return m_price;
}

bool DescribePriceCreateInstanceResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

double DescribePriceCreateInstanceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool DescribePriceCreateInstanceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string DescribePriceCreateInstanceResponse::GetCurrency() const
{
    return m_currency;
}

bool DescribePriceCreateInstanceResponse::CurrencyHasBeenSet() const
{
