...
DescribePriceRenewInstanceResponse::DescribePriceRenewInstanceResponse() :
...
CoreInternalOutcome DescribePriceRenewInstanceResponse::Deserialize(const string &payload)
{
...
string DescribePriceRenewInstanceResponse::ToJsonString() const
{
...
double DescribePriceRenewInstanceResponse::GetPrice() const
{
    return m_price;
}

bool DescribePriceRenewInstanceResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

double DescribePriceRenewInstanceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool DescribePriceRenewInstanceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string DescribePriceRenewInstanceResponse::GetCurrency() const
{
    return m_currency;
}

bool DescribePriceRenewInstanceResponse::CurrencyHasBeenSet() const
{
