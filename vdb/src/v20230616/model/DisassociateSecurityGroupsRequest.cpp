...
string DisassociateSecurityGroupsRequest::GetSecurityGroupIds() const
{
    return m_securityGroupIds;
}

void DisassociateSecurityGroupsRequest::SetSecurityGroupIds(const string& _securityGroupIds)
{
