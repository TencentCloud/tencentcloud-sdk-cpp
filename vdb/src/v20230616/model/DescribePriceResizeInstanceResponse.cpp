...
DescribePriceResizeInstanceResponse::DescribePriceResizeInstanceResponse() :
...
CoreInternalOutcome DescribePriceResizeInstanceResponse::Deserialize(const string &payload)
{
...
string DescribePriceResizeInstanceResponse::ToJsonString() const
{
...
double DescribePriceResizeInstanceResponse::GetPrice() const
{
    return m_price;
}

bool DescribePriceResizeInstanceResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

double DescribePriceResizeInstanceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool DescribePriceResizeInstanceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string DescribePriceResizeInstanceResponse::GetCurrency() const
{
    return m_currency;
}

bool DescribePriceResizeInstanceResponse::CurrencyHasBeenSet() const
{
