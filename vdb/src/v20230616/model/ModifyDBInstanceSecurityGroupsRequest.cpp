...
vector<string> ModifyDBInstanceSecurityGroupsRequest::GetInstanceIds() const
{
    return m_instanceIds;
}

void ModifyDBInstanceSecurityGroupsRequest::SetInstanceIds(const vector<string>& _instanceIds)
{
    m_instanceIds = _instanceIds;
    m_instanceIdsHasBeenSet = true;
}

bool ModifyDBInstanceSecurityGroupsRequest::InstanceIdsHasBeenSet() const
{
