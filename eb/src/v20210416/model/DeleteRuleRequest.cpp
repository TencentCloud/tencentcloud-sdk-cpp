...
string DeleteRuleRequest::GetEventBusId() const
{
    return m_eventBusId;
}

void DeleteRuleRequest::SetEventBusId(const string& _eventBusId)
{
    m_eventBusId = _eventBusId;
    m_eventBusIdHasBeenSet = true;
}

bool DeleteRuleRequest::EventBusIdHasBeenSet() const
{
