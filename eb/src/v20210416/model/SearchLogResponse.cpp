...
int64_t SearchLogResponse::GetTotal() const
{
    return m_total;
}

bool SearchLogResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t SearchLogResponse::GetLimit() const
{
    return m_limit;
}

bool SearchLogResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

int64_t SearchLogResponse::GetPage() const
{
    return m_page;
}

bool SearchLogResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

vector<SearchLogResult> SearchLogResponse::GetResults() const
{
    return m_results;
}
