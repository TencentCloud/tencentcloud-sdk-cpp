...
CoreInternalOutcome CreateEventBusResponse::Deserialize(const string &payload)
{
...
string CreateEventBusResponse::ToJsonString() const
{
...
string CreateEventBusResponse::GetEventBusId() const
{
    return m_eventBusId;
}

bool CreateEventBusResponse::EventBusIdHasBeenSet() const
{
