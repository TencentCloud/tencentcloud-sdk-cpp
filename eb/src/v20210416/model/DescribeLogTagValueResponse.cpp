...
CoreInternalOutcome DescribeLogTagValueResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Results") && !rsp["Results"].IsNull())
    {
        ...
        {
            m_results.push_back((*itr).GetString());
        }
...
string DescribeLogTagValueResponse::ToJsonString() const
{
...
vector<string> DescribeLogTagValueResponse::GetResults() const
{
    return m_results;
}

bool DescribeLogTagValueResponse::ResultsHasBeenSet() const
{
