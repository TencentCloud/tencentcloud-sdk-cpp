...
CoreInternalOutcome CheckTransformationResponse::Deserialize(const string &payload)
{
...
string CheckTransformationResponse::ToJsonString() const
{
...
string CheckTransformationResponse::GetOutput() const
{
    return m_output;
}

bool CheckTransformationResponse::OutputHasBeenSet() const
{
