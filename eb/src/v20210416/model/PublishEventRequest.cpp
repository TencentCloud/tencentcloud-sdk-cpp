...
string PublishEventRequest::ToJsonString() const
{
...
vector<Event> PublishEventRequest::GetEventList() const
{
    return m_eventList;
}

void PublishEventRequest::SetEventList(const vector<Event>& _eventList)
{
    m_eventList = _eventList;
    m_eventListHasBeenSet = true;
}

bool PublishEventRequest::EventListHasBeenSet() const
{
    return m_eventListHasBeenSet;
}

string PublishEventRequest::GetEventBusId() const
{
    return m_eventBusId;
}

void PublishEventRequest::SetEventBusId(const string& _eventBusId)
{
    m_eventBusId = _eventBusId;
    m_eventBusIdHasBeenSet = true;
}

bool PublishEventRequest::EventBusIdHasBeenSet() const
{
