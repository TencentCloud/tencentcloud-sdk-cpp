...
string GetEventBusRequest::ToJsonString() const
{
...
string GetEventBusRequest::GetEventBusId() const
{
    return m_eventBusId;
}

void GetEventBusRequest::SetEventBusId(const string& _eventBusId)
{
    m_eventBusId = _eventBusId;
    m_eventBusIdHasBeenSet = true;
}

bool GetEventBusRequest::EventBusIdHasBeenSet() const
{
