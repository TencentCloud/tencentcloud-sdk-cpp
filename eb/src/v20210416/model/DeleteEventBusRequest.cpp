...
string DeleteEventBusRequest::ToJsonString() const
{
...
string DeleteEventBusRequest::GetEventBusId() const
{
    return m_eventBusId;
}

void DeleteEventBusRequest::SetEventBusId(const string& _eventBusId)
{
    m_eventBusId = _eventBusId;
    m_eventBusIdHasBeenSet = true;
}

bool DeleteEventBusRequest::EventBusIdHasBeenSet() const
{
