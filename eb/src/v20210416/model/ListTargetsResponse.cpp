...
CoreInternalOutcome ListTargetsResponse::Deserialize(const string &payload)
{
...
string ListTargetsResponse::ToJsonString() const
{
...
int64_t ListTargetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListTargetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Target> ListTargetsResponse::GetTargets() const
{
    return m_targets;
}

bool ListTargetsResponse::TargetsHasBeenSet() const
{
