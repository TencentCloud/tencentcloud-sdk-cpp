...
CoreInternalOutcome QueryChainMakerContractResponse::Deserialize(const string &payload)
{
...
string QueryChainMakerContractResponse::ToJsonString() const
{
...
ChainMakerContractResult QueryChainMakerContractResponse::GetResult() const
{
    return m_result;
}

bool QueryChainMakerContractResponse::ResultHasBeenSet() const
{
