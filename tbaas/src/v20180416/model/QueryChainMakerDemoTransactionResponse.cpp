...
CoreInternalOutcome QueryChainMakerDemoTransactionResponse::Deserialize(const string &payload)
{
...
string QueryChainMakerDemoTransactionResponse::ToJsonString() const
{
...
ChainMakerTransactionResult QueryChainMakerDemoTransactionResponse::GetResult() const
{
    return m_result;
}

bool QueryChainMakerDemoTransactionResponse::ResultHasBeenSet() const
{
