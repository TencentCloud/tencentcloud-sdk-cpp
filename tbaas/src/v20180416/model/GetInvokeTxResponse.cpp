...
CoreInternalOutcome GetInvokeTxResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TxValidationCode") && !rsp["TxValidationCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TxValidationCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("TxValidationMsg") && !rsp["TxValidationMsg"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TxValidationMsg` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("BlockId") && !rsp["BlockId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `BlockId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
