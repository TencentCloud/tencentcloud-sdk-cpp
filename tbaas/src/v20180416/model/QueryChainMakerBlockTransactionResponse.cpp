...
CoreInternalOutcome QueryChainMakerBlockTransactionResponse::Deserialize(const string &payload)
{
...
string QueryChainMakerBlockTransactionResponse::ToJsonString() const
{
...
vector<ChainMakerTransactionResult> QueryChainMakerBlockTransactionResponse::GetResult() const
{
    return m_result;
}

bool QueryChainMakerBlockTransactionResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

int64_t QueryChainMakerBlockTransactionResponse::GetBlockHeight() const
{
    return m_blockHeight;
}

bool QueryChainMakerBlockTransactionResponse::BlockHeightHasBeenSet() const
{
    return m_blockHeightHasBeenSet;
}

int64_t QueryChainMakerBlockTransactionResponse::GetTxCount() const
{
    return m_txCount;
}

bool QueryChainMakerBlockTransactionResponse::TxCountHasBeenSet() const
{
    return m_txCountHasBeenSet;
}

int64_t QueryChainMakerBlockTransactionResponse::GetBlockTimestamp() const
{
    return m_blockTimestamp;
}

bool QueryChainMakerBlockTransactionResponse::BlockTimestampHasBeenSet() const
{
