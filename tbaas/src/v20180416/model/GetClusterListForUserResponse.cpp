...
CoreInternalOutcome GetClusterListForUserResponse::Deserialize(const string &payload)
{
...
string GetClusterListForUserResponse::ToJsonString() const
{
...
uint64_t GetClusterListForUserResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool GetClusterListForUserResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ClusterDetailForUser> GetClusterListForUserResponse::GetClusterList() const
{
    return m_clusterList;
}

bool GetClusterListForUserResponse::ClusterListHasBeenSet() const
{
