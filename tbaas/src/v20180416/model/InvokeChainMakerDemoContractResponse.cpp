...
CoreInternalOutcome InvokeChainMakerDemoContractResponse::Deserialize(const string &payload)
{
...
string InvokeChainMakerDemoContractResponse::ToJsonString() const
{
...
ChainMakerContractResult InvokeChainMakerDemoContractResponse::GetResult() const
{
    return m_result;
}

bool InvokeChainMakerDemoContractResponse::ResultHasBeenSet() const
{
