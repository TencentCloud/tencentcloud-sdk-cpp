...
CoreInternalOutcome InvokeChainMakerContractResponse::Deserialize(const string &payload)
{
...
string InvokeChainMakerContractResponse::ToJsonString() const
{
...
ChainMakerContractResult InvokeChainMakerContractResponse::GetResult() const
{
    return m_result;
}

bool InvokeChainMakerContractResponse::ResultHasBeenSet() const
{
