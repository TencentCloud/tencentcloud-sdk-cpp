...
CoreInternalOutcome ClusterDetailForUser::Deserialize(const Value &value)
{
    string requestId = "";
...
void ClusterDetailForUser::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
