...
CoreInternalOutcome CreateChaincodeAndInstallForUserResponse::Deserialize(const string &payload)
{
...
string CreateChaincodeAndInstallForUserResponse::ToJsonString() const
{
