...
CoreInternalOutcome InvokeFabricChaincodeResponse::Deserialize(const string &payload)
{
...
string InvokeFabricChaincodeResponse::ToJsonString() const
{
...
string InvokeFabricChaincodeResponse::GetTxId() const
{
    return m_txId;
}

bool InvokeFabricChaincodeResponse::TxIdHasBeenSet() const
{
    return m_txIdHasBeenSet;
}

string InvokeFabricChaincodeResponse::GetTxStatus() const
{
    return m_txStatus;
}

bool InvokeFabricChaincodeResponse::TxStatusHasBeenSet() const
{
    return m_txStatusHasBeenSet;
}

string InvokeFabricChaincodeResponse::GetTxResult() const
{
    return m_txResult;
}

bool InvokeFabricChaincodeResponse::TxResultHasBeenSet() const
{
