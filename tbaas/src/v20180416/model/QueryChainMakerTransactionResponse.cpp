...
CoreInternalOutcome QueryChainMakerTransactionResponse::Deserialize(const string &payload)
{
...
string QueryChainMakerTransactionResponse::ToJsonString() const
{
...
ChainMakerTransactionResult QueryChainMakerTransactionResponse::GetResult() const
{
    return m_result;
}

bool QueryChainMakerTransactionResponse::ResultHasBeenSet() const
{
