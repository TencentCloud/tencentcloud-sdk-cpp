...
CoreInternalOutcome InitializeChaincodeForUserResponse::Deserialize(const string &payload)
{
...
string InitializeChaincodeForUserResponse::ToJsonString() const
{
...
uint64_t InitializeChaincodeForUserResponse::GetTaskId() const
{
    return m_taskId;
}

bool InitializeChaincodeForUserResponse::TaskIdHasBeenSet() const
{
