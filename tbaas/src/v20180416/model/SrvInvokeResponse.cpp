...
CoreInternalOutcome SrvInvokeResponse::Deserialize(const string &payload)
{
...
string SrvInvokeResponse::ToJsonString() const
{
...
int64_t SrvInvokeResponse::GetRetCode() const
{
    return m_retCode;
}

bool SrvInvokeResponse::RetCodeHasBeenSet() const
{
    return m_retCodeHasBeenSet;
}

string SrvInvokeResponse::GetRetMsg() const
{
    return m_retMsg;
}

bool SrvInvokeResponse::RetMsgHasBeenSet() const
{
    return m_retMsgHasBeenSet;
}

string SrvInvokeResponse::GetData() const
{
    return m_data;
}

bool SrvInvokeResponse::DataHasBeenSet() const
{
