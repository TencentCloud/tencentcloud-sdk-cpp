...
CoreInternalOutcome InvokeResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Txid") && !rsp["Txid"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Txid` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("Events") && !rsp["Events"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Events` IsString=false incorrectly").SetRequestId(requestId));
        }
