...
CoreInternalOutcome QueryChainMakerDemoContractResponse::Deserialize(const string &payload)
{
...
string QueryChainMakerDemoContractResponse::ToJsonString() const
{
...
ChainMakerContractResult QueryChainMakerDemoContractResponse::GetResult() const
{
    return m_result;
}

bool QueryChainMakerDemoContractResponse::ResultHasBeenSet() const
{
