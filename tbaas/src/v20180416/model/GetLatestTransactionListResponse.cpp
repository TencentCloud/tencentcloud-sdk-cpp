...
GetLatestTransactionListResponse::GetLatestTransactionListResponse() :
    m_totalCountHasBeenSet(false),
    m_transactionListHasBeenSet(false)
{
}

CoreInternalOutcome GetLatestTransactionListResponse::Deserialize(const string &payload)
{
...
string GetLatestTransactionListResponse::ToJsonString() const
{
...
uint64_t GetLatestTransactionListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool GetLatestTransactionListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TransactionItem> GetLatestTransactionListResponse::GetTransactionList() const
{
    return m_transactionList;
}

bool GetLatestTransactionListResponse::TransactionListHasBeenSet() const
{
