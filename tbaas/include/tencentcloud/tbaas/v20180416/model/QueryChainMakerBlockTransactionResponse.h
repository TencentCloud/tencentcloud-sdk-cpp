...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERBLOCKTRANSACTIONRESPONSE_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERBLOCKTRANSACTIONRESPONSE_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class QueryChainMakerBlockTransactionResponse : public AbstractModel
                {
                public:
                    QueryChainMakerBlockTransactionResponse();
                    ~QueryChainMakerBlockTransactionResponse() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERBLOCKTRANSACTIONRESPONSE_H_
