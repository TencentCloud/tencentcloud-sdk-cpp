...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERDEMOCONTRACTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERDEMOCONTRACTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class QueryChainMakerDemoContractRequest : public AbstractModel
                {
                public:
                    QueryChainMakerDemoContractRequest();
                    ~QueryChainMakerDemoContractRequest() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERDEMOCONTRACTREQUEST_H_
