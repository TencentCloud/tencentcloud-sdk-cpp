            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                     ...
                     * @param _abiInfo 合约编译后的ABI，可在合约详情获取
                     * 
                     */
                     ...
                     * @param _byteCodeBin 合约编译得到的字节码，hex编码，可在合约详情获取
                     * 
                     */
                     ...
                     * @param _constructorParams 构造函数入参，Json数组，多个参数以逗号分隔（参数为数组时同理），如：["str1",["arr1","arr2"]]
                     * 
                     */
