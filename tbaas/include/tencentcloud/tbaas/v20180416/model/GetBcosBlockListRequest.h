...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBCOSBLOCKLISTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBCOSBLOCKLISTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetBcosBlockListRequest : public AbstractModel
                {
                public:
                    GetBcosBlockListRequest();
                    ~GetBcosBlockListRequest() = default;
                    ...
                    /**
                     * 获取区块哈希，可以从InvokeBcosTrans接口的返回值中解析获取
                    ...
                    /**
                     * 设置区块哈希，可以从InvokeBcosTrans接口的返回值中解析获取
                     * @param _blockHash 区块哈希，可以从InvokeBcosTrans接口的返回值中解析获取
                     * 
                     */
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBCOSBLOCKLISTREQUEST_H_
