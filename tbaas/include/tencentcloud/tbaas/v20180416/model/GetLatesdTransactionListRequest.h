...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESDTRANSACTIONLISTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESDTRANSACTIONLISTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetLatesdTransactionListRequest : public AbstractModel
                {
                public:
                    GetLatesdTransactionListRequest();
                    ~GetLatesdTransactionListRequest() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESDTRANSACTIONLISTREQUEST_H_
