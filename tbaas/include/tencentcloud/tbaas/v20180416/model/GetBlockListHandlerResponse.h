...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKLISTHANDLERRESPONSE_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKLISTHANDLERRESPONSE_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetBlockListHandlerResponse : public AbstractModel
                {
                public:
                    GetBlockListHandlerResponse();
                    ~GetBlockListHandlerResponse() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKLISTHANDLERRESPONSE_H_
