...
#ifndef TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_CREATELIVECHANNELRESPONSE_H_
#define TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_CREATELIVECHANNELRESPONSE_H_
    ...
    namespace Iotvideoindustry
    {
        namespace V20201201
        {
            namespace Model
            {
                ...
                */
                class CreateLiveChannelResponse : public AbstractModel
                {
                public:
                    CreateLiveChannelResponse();
                    ~CreateLiveChannelResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_CREATELIVECHANNELRESPONSE_H_
