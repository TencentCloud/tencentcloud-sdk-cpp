...
#ifndef TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_MODIFYLIVECHANNELREQUEST_H_
#define TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_MODIFYLIVECHANNELREQUEST_H_
    ...
    namespace Iotvideoindustry
    {
        namespace V20201201
        {
            namespace Model
            {
                ...
                */
                class ModifyLiveChannelRequest : public AbstractModel
                {
                public:
                    ModifyLiveChannelRequest();
                    ~ModifyLiveChannelRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_MODIFYLIVECHANNELREQUEST_H_
