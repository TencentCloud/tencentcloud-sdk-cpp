...
#ifndef TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBELIVESTREAMREQUEST_H_
#define TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBELIVESTREAMREQUEST_H_
    ...
    namespace Iotvideoindustry
    {
        namespace V20201201
        {
            namespace Model
            {
                ...
                */
                class DescribeLiveStreamRequest : public AbstractModel
                {
                public:
                    DescribeLiveStreamRequest();
                    ~DescribeLiveStreamRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBELIVESTREAMREQUEST_H_
