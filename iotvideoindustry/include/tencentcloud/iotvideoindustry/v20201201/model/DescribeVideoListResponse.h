...
#ifndef TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBEVIDEOLISTRESPONSE_H_
#define TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBEVIDEOLISTRESPONSE_H_
    ...
    namespace Iotvideoindustry
    {
        namespace V20201201
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoListResponse : public AbstractModel
                {
                public:
                    DescribeVideoListResponse();
                    ~DescribeVideoListResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_DESCRIBEVIDEOLISTRESPONSE_H_
