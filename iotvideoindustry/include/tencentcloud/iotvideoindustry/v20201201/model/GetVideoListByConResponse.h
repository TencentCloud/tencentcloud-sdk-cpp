...
#ifndef TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_GETVIDEOLISTBYCONRESPONSE_H_
#define TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_GETVIDEOLISTBYCONRESPONSE_H_
    ...
    namespace Iotvideoindustry
    {
        namespace V20201201
        {
            namespace Model
            {
                ...
                */
                class GetVideoListByConResponse : public AbstractModel
                {
                public:
                    GetVideoListByConResponse();
                    ~GetVideoListByConResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEOINDUSTRY_V20201201_MODEL_GETVIDEOLISTBYCONRESPONSE_H_
