...
CoreInternalOutcome DescribeChannelLocalRecordURLResponse::Deserialize(const string &payload)
{
...
string DescribeChannelLocalRecordURLResponse::ToJsonString() const
{
...
DescribeRecordStreamData DescribeChannelLocalRecordURLResponse::GetData() const
{
    return m_data;
}

bool DescribeChannelLocalRecordURLResponse::DataHasBeenSet() const
{
