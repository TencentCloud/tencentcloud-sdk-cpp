...
vector<string> DescribeGroupsRequest::GetGroupIds() const
{
    return m_groupIds;
}

void DescribeGroupsRequest::SetGroupIds(const vector<string>& _groupIds)
{
    m_groupIds = _groupIds;
    m_groupIdsHasBeenSet = true;
}

bool DescribeGroupsRequest::GroupIdsHasBeenSet() const
{
