...
CoreInternalOutcome CreateTimeTemplateResponse::Deserialize(const string &payload)
{
...
string CreateTimeTemplateResponse::ToJsonString() const
{
...
string CreateTimeTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateTimeTemplateResponse::TemplateIdHasBeenSet() const
{
