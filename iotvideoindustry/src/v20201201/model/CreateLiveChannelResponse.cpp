...
CoreInternalOutcome CreateLiveChannelResponse::Deserialize(const string &payload)
{
...
string CreateLiveChannelResponse::ToJsonString() const
{
...
string CreateLiveChannelResponse::GetLiveChannelId() const
{
    return m_liveChannelId;
}

bool CreateLiveChannelResponse::LiveChannelIdHasBeenSet() const
{
    return m_liveChannelIdHasBeenSet;
}

string CreateLiveChannelResponse::GetPushStreamAddress() const
{
    return m_pushStreamAddress;
}

bool CreateLiveChannelResponse::PushStreamAddressHasBeenSet() const
{
