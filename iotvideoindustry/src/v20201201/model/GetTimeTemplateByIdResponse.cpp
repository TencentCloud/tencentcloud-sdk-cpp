...
CoreInternalOutcome GetTimeTemplateByIdResponse::Deserialize(const string &payload)
{
...
string GetTimeTemplateByIdResponse::ToJsonString() const
{
...
TimeTemplateItem GetTimeTemplateByIdResponse::GetTemplate() const
{
    return m_template;
}

bool GetTimeTemplateByIdResponse::TemplateHasBeenSet() const
{
