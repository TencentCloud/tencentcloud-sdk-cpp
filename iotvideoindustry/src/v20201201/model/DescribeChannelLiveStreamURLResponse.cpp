...
CoreInternalOutcome DescribeChannelLiveStreamURLResponse::Deserialize(const string &payload)
{
...
string DescribeChannelLiveStreamURLResponse::ToJsonString() const
{
...
DescribeDeviceStreamsData DescribeChannelLiveStreamURLResponse::GetData() const
{
    return m_data;
}

bool DescribeChannelLiveStreamURLResponse::DataHasBeenSet() const
{
