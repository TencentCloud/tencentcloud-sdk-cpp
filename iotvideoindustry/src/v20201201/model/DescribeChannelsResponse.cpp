...
CoreInternalOutcome DescribeChannelsResponse::Deserialize(const string &payload)
{
...
string DescribeChannelsResponse::ToJsonString() const
{
...
uint64_t DescribeChannelsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeChannelsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ChannelDetail> DescribeChannelsResponse::GetChannels() const
{
    return m_channels;
}

bool DescribeChannelsResponse::ChannelsHasBeenSet() const
{
