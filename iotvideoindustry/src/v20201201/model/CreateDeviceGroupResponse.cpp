...
string CreateDeviceGroupResponse::GetStatus() const
{
    return m_status;
}

bool CreateDeviceGroupResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateDeviceGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateDeviceGroupResponse::GroupIdHasBeenSet() const
{
