...
CoreInternalOutcome CreateMessageForwardResponse::Deserialize(const string &payload)
{
...
string CreateMessageForwardResponse::ToJsonString() const
{
...
int64_t CreateMessageForwardResponse::GetIntId() const
{
    return m_intId;
}

bool CreateMessageForwardResponse::IntIdHasBeenSet() const
{
