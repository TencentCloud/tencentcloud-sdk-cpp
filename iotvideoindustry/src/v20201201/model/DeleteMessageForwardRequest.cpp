...
string DeleteMessageForwardRequest::ToJsonString() const
{
...
int64_t DeleteMessageForwardRequest::GetIntId() const
{
    return m_intId;
}

void DeleteMessageForwardRequest::SetIntId(const int64_t& _intId)
{
    m_intId = _intId;
    m_intIdHasBeenSet = true;
}

bool DeleteMessageForwardRequest::IntIdHasBeenSet() const
{
