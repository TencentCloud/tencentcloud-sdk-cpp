...
CoreInternalOutcome DescribeVideoListByChannelResponse::Deserialize(const string &payload)
{
...
string DescribeVideoListByChannelResponse::ToJsonString() const
{
...
vector<RecordTaskItem> DescribeVideoListByChannelResponse::GetVideoList() const
{
    return m_videoList;
}

bool DescribeVideoListByChannelResponse::VideoListHasBeenSet() const
{
    return m_videoListHasBeenSet;
}

int64_t DescribeVideoListByChannelResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVideoListByChannelResponse::TotalCountHasBeenSet() const
{
