...
CoreInternalOutcome DescribeWarnModResponse::Deserialize(const string &payload)
{
...
string DescribeWarnModResponse::ToJsonString() const
{
...
string DescribeWarnModResponse::GetData() const
{
    return m_data;
}

bool DescribeWarnModResponse::DataHasBeenSet() const
{
