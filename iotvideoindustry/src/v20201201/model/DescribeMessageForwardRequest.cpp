...
string DescribeMessageForwardRequest::ToJsonString() const
{
...
int64_t DescribeMessageForwardRequest::GetIntId() const
{
    return m_intId;
}

void DescribeMessageForwardRequest::SetIntId(const int64_t& _intId)
{
    m_intId = _intId;
    m_intIdHasBeenSet = true;
}

bool DescribeMessageForwardRequest::IntIdHasBeenSet() const
{
