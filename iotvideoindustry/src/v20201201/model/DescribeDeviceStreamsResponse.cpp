...
CoreInternalOutcome DescribeDeviceStreamsResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceStreamsResponse::ToJsonString() const
{
...
DescribeDeviceStreamsData DescribeDeviceStreamsResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceStreamsResponse::DataHasBeenSet() const
{
