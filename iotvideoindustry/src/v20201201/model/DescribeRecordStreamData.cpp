...
CoreInternalOutcome DescribeRecordStreamData::Deserialize(const Value &value)
{
    string requestId = "";
...
void DescribeRecordStreamData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
