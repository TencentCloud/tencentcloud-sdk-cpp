...
CoreInternalOutcome DescribeSIPServerResponse::Deserialize(const string &payload)
{
...
string DescribeSIPServerResponse::ToJsonString() const
{
...
ServerConfiguration DescribeSIPServerResponse::GetData() const
{
    return m_data;
}

bool DescribeSIPServerResponse::DataHasBeenSet() const
{
