...
string DeleteLiveChannelRequest::ToJsonString() const
{
...
string DeleteLiveChannelRequest::GetLiveChannelId() const
{
    return m_liveChannelId;
}

void DeleteLiveChannelRequest::SetLiveChannelId(const string& _liveChannelId)
{
    m_liveChannelId = _liveChannelId;
    m_liveChannelIdHasBeenSet = true;
}

bool DeleteLiveChannelRequest::LiveChannelIdHasBeenSet() const
{
