...
CoreInternalOutcome DescribeDeviceEventResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceEventResponse::ToJsonString() const
{
...
int64_t DescribeDeviceEventResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeviceEventResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Events> DescribeDeviceEventResponse::GetEvents() const
{
    return m_events;
}

bool DescribeDeviceEventResponse::EventsHasBeenSet() const
{
