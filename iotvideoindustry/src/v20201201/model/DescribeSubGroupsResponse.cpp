...
CoreInternalOutcome DescribeSubGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeSubGroupsResponse::ToJsonString() const
{
...
vector<GroupItem> DescribeSubGroupsResponse::GetGroupList() const
{
    return m_groupList;
}

bool DescribeSubGroupsResponse::GroupListHasBeenSet() const
{
    return m_groupListHasBeenSet;
}

uint64_t DescribeSubGroupsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSubGroupsResponse::TotalCountHasBeenSet() const
{
