...
string ModifyLiveChannelRequest::ToJsonString() const
{
...
string ModifyLiveChannelRequest::GetLiveChannelId() const
{
    return m_liveChannelId;
}

void ModifyLiveChannelRequest::SetLiveChannelId(const string& _liveChannelId)
{
    m_liveChannelId = _liveChannelId;
    m_liveChannelIdHasBeenSet = true;
}

bool ModifyLiveChannelRequest::LiveChannelIdHasBeenSet() const
{
    return m_liveChannelIdHasBeenSet;
}

string ModifyLiveChannelRequest::GetLiveChannelName() const
{
    return m_liveChannelName;
}

void ModifyLiveChannelRequest::SetLiveChannelName(const string& _liveChannelName)
{
    m_liveChannelName = _liveChannelName;
    m_liveChannelNameHasBeenSet = true;
}

bool ModifyLiveChannelRequest::LiveChannelNameHasBeenSet() const
{
