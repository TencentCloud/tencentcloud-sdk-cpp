...
int64_t DescribeDeviceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeviceListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AllDeviceInfo> DescribeDeviceListResponse::GetDevices() const
{
    return m_devices;
}
