...
string DeleteVideoListRequest::ToJsonString() const
{
...
vector<int64_t> DeleteVideoListRequest::GetInitIDs() const
{
    return m_initIDs;
}

void DeleteVideoListRequest::SetInitIDs(const vector<int64_t>& _initIDs)
{
    m_initIDs = _initIDs;
    m_initIDsHasBeenSet = true;
}

bool DeleteVideoListRequest::InitIDsHasBeenSet() const
{
