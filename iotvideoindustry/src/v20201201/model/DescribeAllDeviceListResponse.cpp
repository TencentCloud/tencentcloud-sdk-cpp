...
CoreInternalOutcome DescribeAllDeviceListResponse::Deserialize(const string &payload)
{
...
string DescribeAllDeviceListResponse::ToJsonString() const
{
...
int64_t DescribeAllDeviceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAllDeviceListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AllDeviceInfo> DescribeAllDeviceListResponse::GetDevices() const
{
    return m_devices;
}

bool DescribeAllDeviceListResponse::DevicesHasBeenSet() const
{
