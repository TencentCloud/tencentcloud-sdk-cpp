...
CoreInternalOutcome CreateSceneResponse::Deserialize(const string &payload)
{
...
string CreateSceneResponse::ToJsonString() const
{
...
int64_t CreateSceneResponse::GetIntId() const
{
    return m_intId;
}

bool CreateSceneResponse::IntIdHasBeenSet() const
{
