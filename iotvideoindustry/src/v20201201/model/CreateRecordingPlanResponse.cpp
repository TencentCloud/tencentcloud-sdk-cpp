...
CoreInternalOutcome CreateRecordingPlanResponse::Deserialize(const string &payload)
{
...
string CreateRecordingPlanResponse::ToJsonString() const
{
...
string CreateRecordingPlanResponse::GetPlanId() const
{
    return m_planId;
}

bool CreateRecordingPlanResponse::PlanIdHasBeenSet() const
{
