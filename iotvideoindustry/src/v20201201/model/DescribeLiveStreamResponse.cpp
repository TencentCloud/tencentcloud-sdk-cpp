...
CoreInternalOutcome DescribeLiveStreamResponse::Deserialize(const string &payload)
{
...
string DescribeLiveStreamResponse::ToJsonString() const
{
...
StreamAddress DescribeLiveStreamResponse::GetData() const
{
    return m_data;
}

bool DescribeLiveStreamResponse::DataHasBeenSet() const
{
