...
CoreInternalOutcome DescribeXP2PDataResponse::Deserialize(const string &payload)
{
...
string DescribeXP2PDataResponse::ToJsonString() const
{
...
string DescribeXP2PDataResponse::GetData() const
{
    return m_data;
}

bool DescribeXP2PDataResponse::DataHasBeenSet() const
{
