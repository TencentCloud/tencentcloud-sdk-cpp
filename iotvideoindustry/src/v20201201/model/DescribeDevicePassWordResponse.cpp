...
CoreInternalOutcome DescribeDevicePassWordResponse::Deserialize(const string &payload)
{
...
string DescribeDevicePassWordResponse::ToJsonString() const
{
...
string DescribeDevicePassWordResponse::GetPassWord() const
{
    return m_passWord;
}

bool DescribeDevicePassWordResponse::PassWordHasBeenSet() const
{
