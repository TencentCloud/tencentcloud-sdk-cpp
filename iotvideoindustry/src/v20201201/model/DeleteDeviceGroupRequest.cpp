...
string DeleteDeviceGroupRequest::GetGroupId() const
{
    return m_groupId;
}

void DeleteDeviceGroupRequest::SetGroupId(const string& _groupId)
{
    m_groupId = _groupId;
    m_groupIdHasBeenSet = true;
}

bool DeleteDeviceGroupRequest::GroupIdHasBeenSet() const
{
