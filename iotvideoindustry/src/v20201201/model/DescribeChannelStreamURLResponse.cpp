...
CoreInternalOutcome DescribeChannelStreamURLResponse::Deserialize(const string &payload)
{
...
string DescribeChannelStreamURLResponse::ToJsonString() const
{
...
DescribeDeviceStreamsData DescribeChannelStreamURLResponse::GetData() const
{
    return m_data;
}

bool DescribeChannelStreamURLResponse::DataHasBeenSet() const
{
