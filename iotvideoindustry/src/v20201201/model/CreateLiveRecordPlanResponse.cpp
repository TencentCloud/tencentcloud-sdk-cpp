...
CoreInternalOutcome CreateLiveRecordPlanResponse::Deserialize(const string &payload)
{
...
string CreateLiveRecordPlanResponse::ToJsonString() const
{
...
string CreateLiveRecordPlanResponse::GetPlanId() const
{
    return m_planId;
}

bool CreateLiveRecordPlanResponse::PlanIdHasBeenSet() const
{
