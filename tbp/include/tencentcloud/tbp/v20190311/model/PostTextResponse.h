...
#ifndef TENCENTCLOUD_TBP_V20190311_MODEL_POSTTEXTRESPONSE_H_
#define TENCENTCLOUD_TBP_V20190311_MODEL_POSTTEXTRESPONSE_H_
    ...
    namespace Tbp
    {
        namespace V20190311
        {
            namespace Model
            {
                ...
                * PostText返回参数结构体
                */
                class PostTextResponse : public AbstractModel
                {
                public:
                    PostTextResponse();
                    ~PostTextResponse() = default;
...
#endif // !TENCENTCLOUD_TBP_V20190311_MODEL_POSTTEXTRESPONSE_H_
