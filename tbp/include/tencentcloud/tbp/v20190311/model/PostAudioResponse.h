...
#ifndef TENCENTCLOUD_TBP_V20190311_MODEL_POSTAUDIORESPONSE_H_
#define TENCENTCLOUD_TBP_V20190311_MODEL_POSTAUDIORESPONSE_H_
    ...
    namespace Tbp
    {
        namespace V20190311
        {
            namespace Model
            {
                ...
                * PostAudio返回参数结构体
                */
                class PostAudioResponse : public AbstractModel
                {
                public:
                    PostAudioResponse();
                    ~PostAudioResponse() = default;
...
#endif // !TENCENTCLOUD_TBP_V20190311_MODEL_POSTAUDIORESPONSE_H_
