...
#ifndef TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBELISTENERSTATISTICSRESPONSE_H_
#define TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBELISTENERSTATISTICSRESPONSE_H_
    ...
    namespace Gaap
    {
        namespace V20180529
        {
            namespace Model
            {
                ...
                */
                class DescribeListenerStatisticsResponse : public AbstractModel
                {
                public:
                    DescribeListenerStatisticsResponse();
                    ~DescribeListenerStatisticsResponse() = default;
...
#endif // !TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBELISTENERSTATISTICSRESPONSE_H_
