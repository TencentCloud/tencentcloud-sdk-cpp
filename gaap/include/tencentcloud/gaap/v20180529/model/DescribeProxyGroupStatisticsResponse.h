...
#ifndef TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBEPROXYGROUPSTATISTICSRESPONSE_H_
#define TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBEPROXYGROUPSTATISTICSRESPONSE_H_
    ...
    namespace Gaap
    {
        namespace V20180529
        {
            namespace Model
            {
                ...
                */
                class DescribeProxyGroupStatisticsResponse : public AbstractModel
                {
                public:
                    DescribeProxyGroupStatisticsResponse();
                    ~DescribeProxyGroupStatisticsResponse() = default;
...
#endif // !TENCENTCLOUD_GAAP_V20180529_MODEL_DESCRIBEPROXYGROUPSTATISTICSRESPONSE_H_
