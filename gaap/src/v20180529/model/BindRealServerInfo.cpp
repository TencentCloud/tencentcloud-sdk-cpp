...
CoreInternalOutcome BindRealServerInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void BindRealServerInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
