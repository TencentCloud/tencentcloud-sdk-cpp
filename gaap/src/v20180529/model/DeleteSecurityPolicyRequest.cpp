...
string DeleteSecurityPolicyRequest::GetPolicyId() const
{
    return m_policyId;
}

void DeleteSecurityPolicyRequest::SetPolicyId(const string& _policyId)
{
    m_policyId = _policyId;
    m_policyIdHasBeenSet = true;
}

bool DeleteSecurityPolicyRequest::PolicyIdHasBeenSet() const
{
