...
CoreInternalOutcome CreateSecurityPolicyResponse::Deserialize(const string &payload)
{
...
string CreateSecurityPolicyResponse::ToJsonString() const
{
...
string CreateSecurityPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateSecurityPolicyResponse::PolicyIdHasBeenSet() const
{
