...
CoreInternalOutcome DescribeProxyAndStatisticsListenersResponse::Deserialize(const string &payload)
{
...
string DescribeProxyAndStatisticsListenersResponse::ToJsonString() const
{
...
vector<ProxySimpleInfo> DescribeProxyAndStatisticsListenersResponse::GetProxySet() const
{
    return m_proxySet;
}

bool DescribeProxyAndStatisticsListenersResponse::ProxySetHasBeenSet() const
{
    return m_proxySetHasBeenSet;
}

uint64_t DescribeProxyAndStatisticsListenersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeProxyAndStatisticsListenersResponse::TotalCountHasBeenSet() const
{
