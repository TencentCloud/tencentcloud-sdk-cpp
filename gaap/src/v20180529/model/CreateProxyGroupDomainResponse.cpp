...
CoreInternalOutcome CreateProxyGroupDomainResponse::Deserialize(const string &payload)
{
...
string CreateProxyGroupDomainResponse::ToJsonString() const
{
...
string CreateProxyGroupDomainResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateProxyGroupDomainResponse::GroupIdHasBeenSet() const
{
