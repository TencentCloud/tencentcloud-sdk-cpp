...
CoreInternalOutcome CreateHTTPListenerResponse::Deserialize(const string &payload)
{
...
string CreateHTTPListenerResponse::ToJsonString() const
{
...
string CreateHTTPListenerResponse::GetListenerId() const
{
    return m_listenerId;
}

bool CreateHTTPListenerResponse::ListenerIdHasBeenSet() const
{
