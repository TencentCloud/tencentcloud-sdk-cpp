...
CoreInternalOutcome AddRealServersResponse::Deserialize(const string &payload)
{
...
string AddRealServersResponse::ToJsonString() const
{
...
vector<NewRealServer> AddRealServersResponse::GetRealServerSet() const
{
    return m_realServerSet;
}

bool AddRealServersResponse::RealServerSetHasBeenSet() const
{
