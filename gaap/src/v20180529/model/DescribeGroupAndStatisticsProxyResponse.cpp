...
CoreInternalOutcome DescribeGroupAndStatisticsProxyResponse::Deserialize(const string &payload)
{
...
string DescribeGroupAndStatisticsProxyResponse::ToJsonString() const
{
...
vector<GroupStatisticsInfo> DescribeGroupAndStatisticsProxyResponse::GetGroupSet() const
{
    return m_groupSet;
}

bool DescribeGroupAndStatisticsProxyResponse::GroupSetHasBeenSet() const
{
    return m_groupSetHasBeenSet;
}

uint64_t DescribeGroupAndStatisticsProxyResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeGroupAndStatisticsProxyResponse::TotalCountHasBeenSet() const
{
