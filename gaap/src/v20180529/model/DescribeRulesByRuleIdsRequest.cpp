...
string DescribeRulesByRuleIdsRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
vector<string> DescribeRulesByRuleIdsRequest::GetRuleIds() const
{
    return m_ruleIds;
}

void DescribeRulesByRuleIdsRequest::SetRuleIds(const vector<string>& _ruleIds)
{
    m_ruleIds = _ruleIds;
    m_ruleIdsHasBeenSet = true;
}

bool DescribeRulesByRuleIdsRequest::RuleIdsHasBeenSet() const
{
