...
CoreInternalOutcome OpenProxyGroupResponse::Deserialize(const string &payload)
{
...
string OpenProxyGroupResponse::ToJsonString() const
{
...
vector<string> OpenProxyGroupResponse::GetInvalidStatusInstanceSet() const
{
    return m_invalidStatusInstanceSet;
}

bool OpenProxyGroupResponse::InvalidStatusInstanceSetHasBeenSet() const
{
    return m_invalidStatusInstanceSetHasBeenSet;
}

vector<string> OpenProxyGroupResponse::GetOperationFailedInstanceSet() const
{
    return m_operationFailedInstanceSet;
}

bool OpenProxyGroupResponse::OperationFailedInstanceSetHasBeenSet() const
{
