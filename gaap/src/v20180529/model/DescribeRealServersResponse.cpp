...
CoreInternalOutcome DescribeRealServersResponse::Deserialize(const string &payload)
{
...
string DescribeRealServersResponse::ToJsonString() const
{
...
vector<BindRealServerInfo> DescribeRealServersResponse::GetRealServerSet() const
{
    return m_realServerSet;
}

bool DescribeRealServersResponse::RealServerSetHasBeenSet() const
{
    return m_realServerSetHasBeenSet;
}

uint64_t DescribeRealServersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRealServersResponse::TotalCountHasBeenSet() const
{
