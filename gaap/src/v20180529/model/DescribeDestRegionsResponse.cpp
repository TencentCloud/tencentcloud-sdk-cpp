...
CoreInternalOutcome DescribeDestRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeDestRegionsResponse::ToJsonString() const
{
...
uint64_t DescribeDestRegionsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDestRegionsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RegionDetail> DescribeDestRegionsResponse::GetDestRegionSet() const
{
    return m_destRegionSet;
}

bool DescribeDestRegionsResponse::DestRegionSetHasBeenSet() const
{
