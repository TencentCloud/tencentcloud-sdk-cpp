...
vector<string> CloseProxyGroupResponse::GetInvalidStatusInstanceSet() const
{
    return m_invalidStatusInstanceSet;
}

bool CloseProxyGroupResponse::InvalidStatusInstanceSetHasBeenSet() const
{
    return m_invalidStatusInstanceSetHasBeenSet;
}

vector<string> CloseProxyGroupResponse::GetOperationFailedInstanceSet() const
{
    return m_operationFailedInstanceSet;
}

bool CloseProxyGroupResponse::OperationFailedInstanceSetHasBeenSet() const
{
