...
CoreInternalOutcome OpenProxiesResponse::Deserialize(const string &payload)
{
...
string OpenProxiesResponse::ToJsonString() const
{
...
vector<string> OpenProxiesResponse::GetInvalidStatusInstanceSet() const
{
    return m_invalidStatusInstanceSet;
}

bool OpenProxiesResponse::InvalidStatusInstanceSetHasBeenSet() const
{
    return m_invalidStatusInstanceSetHasBeenSet;
}

vector<string> OpenProxiesResponse::GetOperationFailedInstanceSet() const
{
    return m_operationFailedInstanceSet;
}

bool OpenProxiesResponse::OperationFailedInstanceSetHasBeenSet() const
{
