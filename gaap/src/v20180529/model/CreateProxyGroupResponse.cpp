...
CoreInternalOutcome CreateProxyGroupResponse::Deserialize(const string &payload)
{
...
string CreateProxyGroupResponse::ToJsonString() const
{
...
string CreateProxyGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateProxyGroupResponse::GroupIdHasBeenSet() const
{
