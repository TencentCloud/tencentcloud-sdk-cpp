...
CoreInternalOutcome GetTextEmbeddingResponse::Deserialize(const string &payload)
{
...
string GetTextEmbeddingResponse::ToJsonString() const
{
...
vector<EmbeddingData> GetTextEmbeddingResponse::GetData() const
{
    return m_data;
}

bool GetTextEmbeddingResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

Usage GetTextEmbeddingResponse::GetUsage() const
{
    return m_usage;
}

bool GetTextEmbeddingResponse::UsageHasBeenSet() const
{
