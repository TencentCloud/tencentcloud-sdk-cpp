...
CoreInternalOutcome GetMultiModalEmbeddingResponse::Deserialize(const string &payload)
{
...
string GetMultiModalEmbeddingResponse::ToJsonString() const
{
...
MultiModalEmbeddingData GetMultiModalEmbeddingResponse::GetData() const
{
    return m_data;
}

bool GetMultiModalEmbeddingResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

MultiModalUsage GetMultiModalEmbeddingResponse::GetUsage() const
{
    return m_usage;
}

bool GetMultiModalEmbeddingResponse::UsageHasBeenSet() const
{
