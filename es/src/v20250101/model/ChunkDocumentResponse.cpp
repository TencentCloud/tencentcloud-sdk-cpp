...
CoreInternalOutcome ChunkDocumentResponse::Deserialize(const string &payload)
{
...
string ChunkDocumentResponse::ToJsonString() const
{
...
vector<Chunk> ChunkDocumentResponse::GetChunks() const
{
    return m_chunks;
}
