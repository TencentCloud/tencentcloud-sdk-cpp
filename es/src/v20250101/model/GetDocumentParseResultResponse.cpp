...
CoreInternalOutcome GetDocumentParseResultResponse::Deserialize(const string &payload)
{
...
string GetDocumentParseResultResponse::ToJsonString() const
{
...
int64_t GetDocumentParseResultResponse::GetStatus() const
{
    return m_status;
}

bool GetDocumentParseResultResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string GetDocumentParseResultResponse::GetDocumentParseResultUrl() const
{
    return m_documentParseResultUrl;
}

bool GetDocumentParseResultResponse::DocumentParseResultUrlHasBeenSet() const
{
    return m_documentParseResultUrlHasBeenSet;
}

vector<int64_t> GetDocumentParseResultResponse::GetFailedPages() const
{
