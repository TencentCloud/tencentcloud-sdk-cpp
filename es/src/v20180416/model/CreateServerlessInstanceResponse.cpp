...
CreateServerlessInstanceResponse::CreateServerlessInstanceResponse() :
    m_instanceIdHasBeenSet(false),
    m_dealNameHasBeenSet(false)
{
}

CoreInternalOutcome CreateServerlessInstanceResponse::Deserialize(const string &payload)
{
...
string CreateServerlessInstanceResponse::ToJsonString() const
{
...
string CreateServerlessInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateServerlessInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateServerlessInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool CreateServerlessInstanceResponse::DealNameHasBeenSet() const
{
