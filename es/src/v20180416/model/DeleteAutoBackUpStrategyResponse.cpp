...
CoreInternalOutcome DeleteAutoBackUpStrategyResponse::Deserialize(const string &payload)
{
...
string DeleteAutoBackUpStrategyResponse::ToJsonString() const
{
...
bool DeleteAutoBackUpStrategyResponse::GetStatus() const
{
    return m_status;
}

bool DeleteAutoBackUpStrategyResponse::StatusHasBeenSet() const
{
