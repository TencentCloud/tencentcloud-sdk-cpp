...
CoreInternalOutcome DescribeInstanceLogsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("InstanceLogList") && !rsp["InstanceLogList"].IsNull())
    {
        if (!rsp["InstanceLogList"].IsArray())
            return CoreInternalOutcome(Error("response `InstanceLogList` is not array type"));
...
string DescribeInstanceLogsResponse::ToJsonString() const
{
...
uint64_t DescribeInstanceLogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstanceLogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstanceLog> DescribeInstanceLogsResponse::GetInstanceLogList() const
{
    return m_instanceLogList;
}

bool DescribeInstanceLogsResponse::InstanceLogListHasBeenSet() const
{
