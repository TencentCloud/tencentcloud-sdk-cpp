...
CoreInternalOutcome SaveAndDeployLogstashPipelineResponse::Deserialize(const string &payload)
{
...
string SaveAndDeployLogstashPipelineResponse::ToJsonString() const
{
