...
CoreInternalOutcome UpdateInstanceResponse::Deserialize(const string &payload)
{
...
string UpdateInstanceResponse::ToJsonString() const
{
...
string UpdateInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool UpdateInstanceResponse::DealNameHasBeenSet() const
{
