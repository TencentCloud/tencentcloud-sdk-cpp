...
CoreInternalOutcome ModifyAutoBackUpStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyAutoBackUpStrategyResponse::ToJsonString() const
{
...
bool ModifyAutoBackUpStrategyResponse::GetStatus() const
{
    return m_status;
}

bool ModifyAutoBackUpStrategyResponse::StatusHasBeenSet() const
{
