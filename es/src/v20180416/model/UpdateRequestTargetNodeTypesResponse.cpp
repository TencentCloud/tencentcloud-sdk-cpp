...
CoreInternalOutcome UpdateRequestTargetNodeTypesResponse::Deserialize(const string &payload)
{
...
string UpdateRequestTargetNodeTypesResponse::ToJsonString() const
{
