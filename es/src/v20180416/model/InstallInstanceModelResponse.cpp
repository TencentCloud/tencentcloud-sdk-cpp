...
InstallInstanceModelResponse::InstallInstanceModelResponse() :
    m_flowIdHasBeenSet(false),
    m_errMsgHasBeenSet(false)
{
}

CoreInternalOutcome InstallInstanceModelResponse::Deserialize(const string &payload)
{
...
string InstallInstanceModelResponse::ToJsonString() const
{
...
string InstallInstanceModelResponse::GetFlowId() const
{
    return m_flowId;
}

bool InstallInstanceModelResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string InstallInstanceModelResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool InstallInstanceModelResponse::ErrMsgHasBeenSet() const
{
