...
UpdateInstancePublicAccessResponse::UpdateInstancePublicAccessResponse() :
    m_dealNameHasBeenSet(false)
{
}

CoreInternalOutcome UpdateInstancePublicAccessResponse::Deserialize(const string &payload)
{
...
string UpdateInstancePublicAccessResponse::ToJsonString() const
{
...
string UpdateInstancePublicAccessResponse::GetDealName() const
{
    return m_dealName;
}

bool UpdateInstancePublicAccessResponse::DealNameHasBeenSet() const
{
