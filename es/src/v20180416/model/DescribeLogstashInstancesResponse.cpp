...
CoreInternalOutcome DescribeLogstashInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeLogstashInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeLogstashInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLogstashInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<LogstashInstanceInfo> DescribeLogstashInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeLogstashInstancesResponse::InstanceListHasBeenSet() const
{
