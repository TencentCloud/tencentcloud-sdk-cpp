...
CoreInternalOutcome CreateAutoBackUpStrategyResponse::Deserialize(const string &payload)
{
...
string CreateAutoBackUpStrategyResponse::ToJsonString() const
{
...
bool CreateAutoBackUpStrategyResponse::GetStatus() const
{
    return m_status;
}

bool CreateAutoBackUpStrategyResponse::StatusHasBeenSet() const
{
