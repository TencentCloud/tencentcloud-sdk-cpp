...
CreateServerlessSpaceV2Response::CreateServerlessSpaceV2Response() :
    m_spaceIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateServerlessSpaceV2Response::Deserialize(const string &payload)
{
...
string CreateServerlessSpaceV2Response::ToJsonString() const
{
...
string CreateServerlessSpaceV2Response::GetSpaceId() const
{
    return m_spaceId;
}

bool CreateServerlessSpaceV2Response::SpaceIdHasBeenSet() const
{
