...
DescribeLogstashViewsResponse::DescribeLogstashViewsResponse() :
    m_nodesViewHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLogstashViewsResponse::Deserialize(const string &payload)
{
...
string DescribeLogstashViewsResponse::ToJsonString() const
{
...
vector<LogstashNodeView> DescribeLogstashViewsResponse::GetNodesView() const
{
    return m_nodesView;
}

bool DescribeLogstashViewsResponse::NodesViewHasBeenSet() const
{
