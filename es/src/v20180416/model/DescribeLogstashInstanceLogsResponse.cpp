...
CoreInternalOutcome DescribeLogstashInstanceLogsResponse::Deserialize(const string &payload)
{
...
string DescribeLogstashInstanceLogsResponse::ToJsonString() const
{
...
uint64_t DescribeLogstashInstanceLogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLogstashInstanceLogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstanceLog> DescribeLogstashInstanceLogsResponse::GetInstanceLogList() const
{
    return m_instanceLogList;
}

bool DescribeLogstashInstanceLogsResponse::InstanceLogListHasBeenSet() const
{
