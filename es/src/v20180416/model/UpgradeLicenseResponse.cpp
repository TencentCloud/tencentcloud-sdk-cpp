...
CoreInternalOutcome UpgradeLicenseResponse::Deserialize(const string &payload)
{
...
string UpgradeLicenseResponse::ToJsonString() const
{
...
string UpgradeLicenseResponse::GetDealName() const
{
    return m_dealName;
}

bool UpgradeLicenseResponse::DealNameHasBeenSet() const
{
