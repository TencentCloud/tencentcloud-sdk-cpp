...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_UPDATEINSTANCEPUBLICACCESSREQUEST_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_UPDATEINSTANCEPUBLICACCESSREQUEST_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class UpdateInstancePublicAccessRequest : public AbstractModel
                {
                public:
                    UpdateInstancePublicAccessRequest();
                    ~UpdateInstancePublicAccessRequest() = default;
...
专用主节点磁盘大小（单位GB系统默认配置为50GB,暂不支持自定义）
                     ...
                     * 
                     */
                    std::vector<std::string> GetKibanaAlteringPublicAccess() const;
                     ...
                     * 
                     */
                    void SetKibanaAlteringPublicAccess(const std::vector<std::string>& _kibanaAlteringPublicAccess);
...
专用主节点磁盘大小（单位GB系统默认配置为50GB,暂不支持自定义）
                     ...
                     * 是否开启Altering 外网告警输出
                     */
                    std::vector<std::string> m_kibanaAlteringPublicAccess;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_UPDATEINSTANCEPUBLICACCESSREQUEST_H_
