...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_STARTLOGSTASHPIPELINESREQUEST_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_STARTLOGSTASHPIPELINESREQUEST_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class StartLogstashPipelinesRequest : public AbstractModel
                {
                public:
                    StartLogstashPipelinesRequest();
                    ~StartLogstashPipelinesRequest() = default;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_STARTLOGSTASHPIPELINESREQUEST_H_
