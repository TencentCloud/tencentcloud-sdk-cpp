...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_LOGSTASHZONERESOURCE_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_LOGSTASHZONERESOURCE_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                * Logstash可用区资源描述
                */
                class LogstashZoneResource : public AbstractModel
                {
                public:
                    LogstashZoneResource();
                    ~LogstashZoneResource() = default;
                     ...
                     * 
                     */
                    std::vector<LogstashNodeTypeResource> GetNodeTypeList() const;
                     ...
                     * 
                     */
                    void SetNodeTypeList(const std::vector<LogstashNodeTypeResource>& _nodeTypeList);
                ...
                private:
                     ...
                     * 节点规格资源列表
                     */
                    std::vector<LogstashNodeTypeResource> m_nodeTypeList;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_LOGSTASHZONERESOURCE_H_
