...
#ifndef TENCENTCLOUD_ES_V20250101_MODEL_CHUNKCONFIGASYNC_H_
#define TENCENTCLOUD_ES_V20250101_MODEL_CHUNKCONFIGASYNC_H_
    ...
    namespace Es
    {
        namespace V20250101
        {
            namespace Model
            {
                ...
                * 文档切片异步任务
                */
                class ChunkConfigAsync : public AbstractModel
                {
                public:
                    ChunkConfigAsync();
...
#endif // !TENCENTCLOUD_ES_V20250101_MODEL_CHUNKCONFIGASYNC_H_
