...
CoreInternalOutcome InitOralProcessResponse::Deserialize(const string &payload)
{
...
string InitOralProcessResponse::ToJsonString() const
{
...
string InitOralProcessResponse::GetSessionId() const
{
    return m_sessionId;
}

bool InitOralProcessResponse::SessionIdHasBeenSet() const
{
