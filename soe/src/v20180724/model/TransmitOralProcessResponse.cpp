...
int64_t TransmitOralProcessResponse::GetRefTextId() const
{
    return m_refTextId;
}

bool TransmitOralProcessResponse::RefTextIdHasBeenSet() const
{
    return m_refTextIdHasBeenSet;
}

vector<double> TransmitOralProcessResponse::GetKeyWordHits() const
{
    return m_keyWordHits;
}

bool TransmitOralProcessResponse::KeyWordHitsHasBeenSet() const
{
    return m_keyWordHitsHasBeenSet;
}

vector<double> TransmitOralProcessResponse::GetUnKeyWordHits() const
{
    return m_unKeyWordHits;
}

bool TransmitOralProcessResponse::UnKeyWordHitsHasBeenSet() const
{
