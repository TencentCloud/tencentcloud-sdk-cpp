...
#ifndef TENCENTCLOUD_TKE_V20220501_MODEL_CREATEHEALTHCHECKPOLICYRESPONSE_H_
#define TENCENTCLOUD_TKE_V20220501_MODEL_CREATEHEALTHCHECKPOLICYRESPONSE_H_
    ...
    namespace Tke
    {
        namespace V20220501
        {
            namespace Model
            {
                ...
                */
                class CreateHealthCheckPolicyResponse : public AbstractModel
                {
                public:
                    CreateHealthCheckPolicyResponse();
                    ~CreateHealthCheckPolicyResponse() = default;
...
#endif // !TENCENTCLOUD_TKE_V20220501_MODEL_CREATEHEALTHCHECKPOLICYRESPONSE_H_
