...
#ifndef TENCENTCLOUD_TKE_V20220501_MODEL_DESCRIBEHEALTHCHECKPOLICIESREQUEST_H_
#define TENCENTCLOUD_TKE_V20220501_MODEL_DESCRIBEHEALTHCHECKPOLICIESREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20220501
        {
            namespace Model
            {
                ...
                */
                class DescribeHealthCheckPoliciesRequest : public AbstractModel
                {
                public:
                    DescribeHealthCheckPoliciesRequest();
                    ~DescribeHealthCheckPoliciesRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20220501_MODEL_DESCRIBEHEALTHCHECKPOLICIESREQUEST_H_
