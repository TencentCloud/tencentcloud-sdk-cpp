...
#ifndef TENCENTCLOUD_TKE_V20220501_MODEL_MODIFYHEALTHCHECKPOLICYREQUEST_H_
#define TENCENTCLOUD_TKE_V20220501_MODEL_MODIFYHEALTHCHECKPOLICYREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20220501
        {
            namespace Model
            {
                ...
                */
                class ModifyHealthCheckPolicyRequest : public AbstractModel
                {
                public:
                    ModifyHealthCheckPolicyRequest();
                    ~ModifyHealthCheckPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20220501_MODEL_MODIFYHEALTHCHECKPOLICYREQUEST_H_
