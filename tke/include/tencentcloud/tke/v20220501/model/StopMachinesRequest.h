...
#ifndef TENCENTCLOUD_TKE_V20220501_MODEL_STOPMACHINESREQUEST_H_
#define TENCENTCLOUD_TKE_V20220501_MODEL_STOPMACHINESREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20220501
        {
            namespace Model
            {
                ...
                * StopMachines请求参数结构体
                */
                class StopMachinesRequest : public AbstractModel
                {
                public:
                    StopMachinesRequest();
                    ~StopMachinesRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20220501_MODEL_STOPMACHINESREQUEST_H_
