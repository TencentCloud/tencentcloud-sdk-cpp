...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_FLAG_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_FLAG_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                * 参数描述
                */
                class Flag : public AbstractModel
                {
                public:
                    Flag();
                    ~Flag() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_FLAG_H_
