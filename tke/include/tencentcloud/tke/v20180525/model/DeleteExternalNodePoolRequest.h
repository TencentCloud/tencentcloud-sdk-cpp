...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DELETEEXTERNALNODEPOOLREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DELETEEXTERNALNODEPOOLREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DeleteExternalNodePoolRequest : public AbstractModel
                {
                public:
                    DeleteExternalNodePoolRequest();
                    ~DeleteExternalNodePoolRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DELETEEXTERNALNODEPOOLREQUEST_H_
