...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_CREATEGLOBALMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_CREATEGLOBALMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class CreateGlobalMaintenanceWindowAndExclusionsRequest : public AbstractModel
                {
                public:
                    CreateGlobalMaintenanceWindowAndExclusionsRequest();
                    ~CreateGlobalMaintenanceWindowAndExclusionsRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_CREATEGLOBALMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
