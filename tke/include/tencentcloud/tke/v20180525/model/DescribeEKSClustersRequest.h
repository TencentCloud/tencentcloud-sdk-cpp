...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEEKSCLUSTERSREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEEKSCLUSTERSREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DescribeEKSClustersRequest : public AbstractModel
                {
                public:
                    DescribeEKSClustersRequest();
                    ~DescribeEKSClustersRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEEKSCLUSTERSREQUEST_H_
