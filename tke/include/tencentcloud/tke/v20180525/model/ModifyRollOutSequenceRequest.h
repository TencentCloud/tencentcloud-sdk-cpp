...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYROLLOUTSEQUENCEREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYROLLOUTSEQUENCEREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class ModifyRollOutSequenceRequest : public AbstractModel
                {
                public:
                    ModifyRollOutSequenceRequest();
                    ~ModifyRollOutSequenceRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYROLLOUTSEQUENCEREQUEST_H_
