...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYPROMETHEUSALERTRULEREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYPROMETHEUSALERTRULEREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class ModifyPrometheusAlertRuleRequest : public AbstractModel
                {
                public:
                    ModifyPrometheusAlertRuleRequest();
                    ~ModifyPrometheusAlertRuleRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYPROMETHEUSALERTRULEREQUEST_H_
