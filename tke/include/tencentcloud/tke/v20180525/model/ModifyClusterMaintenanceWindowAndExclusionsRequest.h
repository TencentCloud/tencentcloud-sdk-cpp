...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYCLUSTERMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYCLUSTERMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class ModifyClusterMaintenanceWindowAndExclusionsRequest : public AbstractModel
                {
                public:
                    ModifyClusterMaintenanceWindowAndExclusionsRequest();
                    ~ModifyClusterMaintenanceWindowAndExclusionsRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_MODIFYCLUSTERMAINTENANCEWINDOWANDEXCLUSIONSREQUEST_H_
