...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_IMAGEREGISTRYCREDENTIAL_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_IMAGEREGISTRYCREDENTIAL_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                * 从镜像仓库拉取镜像的凭据
                */
                class ImageRegistryCredential : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_IMAGEREGISTRYCREDENTIAL_H_
