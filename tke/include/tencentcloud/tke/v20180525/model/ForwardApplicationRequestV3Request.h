...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_FORWARDAPPLICATIONREQUESTV3REQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_FORWARDAPPLICATIONREQUESTV3REQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class ForwardApplicationRequestV3Request : public AbstractModel
                {
                public:
                    ForwardApplicationRequestV3Request();
                    ~ForwardApplicationRequestV3Request() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_FORWARDAPPLICATIONREQUESTV3REQUEST_H_
