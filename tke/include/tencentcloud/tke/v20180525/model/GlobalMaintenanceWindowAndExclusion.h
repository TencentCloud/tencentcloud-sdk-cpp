...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_GLOBALMAINTENANCEWINDOWANDEXCLUSION_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_GLOBALMAINTENANCEWINDOWANDEXCLUSION_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                * 全局维护时间窗口和排除项
                */
                class GlobalMaintenanceWindowAndExclusion : public AbstractModel
                {
                public:
                    GlobalMaintenanceWindowAndExclusion();
                    ~GlobalMaintenanceWindowAndExclusion() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_GLOBALMAINTENANCEWINDOWANDEXCLUSION_H_
