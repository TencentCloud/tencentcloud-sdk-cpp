...
CoreInternalOutcome DescribeClusterInstancesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Errors") && !rsp["Errors"].IsNull())
    {
        ...
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            m_errors.push_back((*itr).GetString());
        }
...
string DescribeClusterInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeClusterInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Instance> DescribeClusterInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeClusterInstancesResponse::InstanceSetHasBeenSet() const
{
    return m_instanceSetHasBeenSet;
}

vector<string> DescribeClusterInstancesResponse::GetErrors() const
{
    return m_errors;
}

bool DescribeClusterInstancesResponse::ErrorsHasBeenSet() const
{
