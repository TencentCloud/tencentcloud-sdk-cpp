...
CoreInternalOutcome CreateNodePoolResponse::Deserialize(const string &payload)
{
...
string CreateNodePoolResponse::ToJsonString() const
{
...
string CreateNodePoolResponse::GetNodePoolId() const
{
    return m_nodePoolId;
}

bool CreateNodePoolResponse::NodePoolIdHasBeenSet() const
{
