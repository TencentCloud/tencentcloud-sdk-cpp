...
DescribeClusterMachinesResponse::DescribeClusterMachinesResponse() :
    m_machinesHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeClusterMachinesResponse::Deserialize(const string &payload)
{
...
string DescribeClusterMachinesResponse::ToJsonString() const
{
...
vector<Machine> DescribeClusterMachinesResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeClusterMachinesResponse::MachinesHasBeenSet() const
{
    return m_machinesHasBeenSet;
}

int64_t DescribeClusterMachinesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterMachinesResponse::TotalCountHasBeenSet() const
{
