...
CoreInternalOutcome DescribePrometheusAlertRuleResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AlertRules") && !rsp["AlertRules"].IsNull())
    {
        if (!rsp["AlertRules"].IsArray())
            return CoreInternalOutcome(Error("response `AlertRules` is not array type"));
...
string DescribePrometheusAlertRuleResponse::ToJsonString() const
{
...
vector<PrometheusAlertRuleDetail> DescribePrometheusAlertRuleResponse::GetAlertRules() const
{
    return m_alertRules;
}

bool DescribePrometheusAlertRuleResponse::AlertRulesHasBeenSet() const
{
    return m_alertRulesHasBeenSet;
}

uint64_t DescribePrometheusAlertRuleResponse::GetTotal() const
{
    return m_total;
}

bool DescribePrometheusAlertRuleResponse::TotalHasBeenSet() const
{
