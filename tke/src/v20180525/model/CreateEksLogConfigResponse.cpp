...
CoreInternalOutcome CreateEksLogConfigResponse::Deserialize(const string &payload)
{
...
string CreateEksLogConfigResponse::ToJsonString() const
{
...
string CreateEksLogConfigResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateEksLogConfigResponse::TopicIdHasBeenSet() const
{
