...
uint64_t DescribeReservedInstancesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeReservedInstancesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeReservedInstancesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeReservedInstancesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
string DescribeReservedInstancesRequest::GetOrderField() const
{
    return m_orderField;
}

void DescribeReservedInstancesRequest::SetOrderField(const string& _orderField)
{
    m_orderField = _orderField;
    m_orderFieldHasBeenSet = true;
}

bool DescribeReservedInstancesRequest::OrderFieldHasBeenSet() const
{
    return m_orderFieldHasBeenSet;
}

string DescribeReservedInstancesRequest::GetOrderDirection() const
{
    return m_orderDirection;
}

void DescribeReservedInstancesRequest::SetOrderDirection(const string& _orderDirection)
{
    m_orderDirection = _orderDirection;
    m_orderDirectionHasBeenSet = true;
}

bool DescribeReservedInstancesRequest::OrderDirectionHasBeenSet() const
{
