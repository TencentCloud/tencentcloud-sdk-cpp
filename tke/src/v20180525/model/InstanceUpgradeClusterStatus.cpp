...
CoreInternalOutcome InstanceUpgradeClusterStatus::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceUpgradeClusterStatus::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
