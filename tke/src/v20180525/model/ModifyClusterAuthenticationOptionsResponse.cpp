...
CoreInternalOutcome ModifyClusterAuthenticationOptionsResponse::Deserialize(const string &payload)
{
...
string ModifyClusterAuthenticationOptionsResponse::ToJsonString() const
{
