...
string DescribeClusterKubeconfigRequest::ToJsonString() const
{
...
string DescribeClusterKubeconfigRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeClusterKubeconfigRequest::SetClusterId(const string& _clusterId)
{
