...
string UninstallLogAgentRequest::ToJsonString() const
{
...
string UninstallLogAgentRequest::GetClusterId() const
{
    return m_clusterId;
}

void UninstallLogAgentRequest::SetClusterId(const string& _clusterId)
{
