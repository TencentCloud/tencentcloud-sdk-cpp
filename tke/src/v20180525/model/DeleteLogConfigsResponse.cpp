...
CoreInternalOutcome DeleteLogConfigsResponse::Deserialize(const string &payload)
{
...
string DeleteLogConfigsResponse::ToJsonString() const
{
...
string DeleteLogConfigsResponse::GetMessage() const
{
    return m_message;
}

bool DeleteLogConfigsResponse::MessageHasBeenSet() const
{
