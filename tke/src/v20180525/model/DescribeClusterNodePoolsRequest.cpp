...
string DescribeClusterNodePoolsRequest::ToJsonString() const
{
...
string DescribeClusterNodePoolsRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeClusterNodePoolsRequest::SetClusterId(const string& _clusterId)
{
