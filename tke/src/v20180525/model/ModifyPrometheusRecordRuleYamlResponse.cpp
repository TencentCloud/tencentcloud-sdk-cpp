...
CoreInternalOutcome ModifyPrometheusRecordRuleYamlResponse::Deserialize(const string &payload)
{
...
string ModifyPrometheusRecordRuleYamlResponse::ToJsonString() const
{
