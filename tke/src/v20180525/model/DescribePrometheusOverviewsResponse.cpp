...
CoreInternalOutcome DescribePrometheusOverviewsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Instances") && !rsp["Instances"].IsNull())
    {
        ...
        {
            PrometheusInstanceOverview item;
...
string DescribePrometheusOverviewsResponse::ToJsonString() const
{
...
vector<PrometheusInstanceOverview> DescribePrometheusOverviewsResponse::GetInstances() const
{
    return m_instances;
}

bool DescribePrometheusOverviewsResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

uint64_t DescribePrometheusOverviewsResponse::GetTotal() const
{
    return m_total;
}

bool DescribePrometheusOverviewsResponse::TotalHasBeenSet() const
{
