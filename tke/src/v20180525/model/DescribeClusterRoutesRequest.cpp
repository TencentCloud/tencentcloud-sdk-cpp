...
string DescribeClusterRoutesRequest::ToJsonString() const
{
...
string DescribeClusterRoutesRequest::GetRouteTableName() const
{
    return m_routeTableName;
}

void DescribeClusterRoutesRequest::SetRouteTableName(const string& _routeTableName)
{
