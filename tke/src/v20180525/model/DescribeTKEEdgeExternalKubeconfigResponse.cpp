...
CoreInternalOutcome DescribeTKEEdgeExternalKubeconfigResponse::Deserialize(const string &payload)
{
...
string DescribeTKEEdgeExternalKubeconfigResponse::ToJsonString() const
{
...
string DescribeTKEEdgeExternalKubeconfigResponse::GetKubeconfig() const
{
    return m_kubeconfig;
}

bool DescribeTKEEdgeExternalKubeconfigResponse::KubeconfigHasBeenSet() const
{
