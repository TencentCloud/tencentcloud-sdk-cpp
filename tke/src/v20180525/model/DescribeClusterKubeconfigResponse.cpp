...
CoreInternalOutcome DescribeClusterKubeconfigResponse::Deserialize(const string &payload)
{
...
string DescribeClusterKubeconfigResponse::ToJsonString() const
{
...
string DescribeClusterKubeconfigResponse::GetKubeconfig() const
{
    return m_kubeconfig;
}

bool DescribeClusterKubeconfigResponse::KubeconfigHasBeenSet() const
{
