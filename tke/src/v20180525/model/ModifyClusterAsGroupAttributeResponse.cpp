...
CoreInternalOutcome ModifyClusterAsGroupAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyClusterAsGroupAttributeResponse::ToJsonString() const
{
