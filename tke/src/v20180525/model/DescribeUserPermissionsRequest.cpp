...
string DescribeUserPermissionsRequest::ToJsonString() const
{
...
string DescribeUserPermissionsRequest::GetTargetUin() const
{
    return m_targetUin;
}

void DescribeUserPermissionsRequest::SetTargetUin(const string& _targetUin)
{
    m_targetUin = _targetUin;
    m_targetUinHasBeenSet = true;
}

bool DescribeUserPermissionsRequest::TargetUinHasBeenSet() const
{
