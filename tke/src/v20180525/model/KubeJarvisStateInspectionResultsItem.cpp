...
CoreInternalOutcome KubeJarvisStateInspectionResultsItem::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("StartTime") && !value["StartTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `KubeJarvisStateInspectionResultsItem.StartTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EndTime") && !value["EndTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `KubeJarvisStateInspectionResultsItem.EndTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string KubeJarvisStateInspectionResultsItem::GetStartTime() const
{
    return m_startTime;
}

void KubeJarvisStateInspectionResultsItem::SetStartTime(const string& _startTime)
{
    m_startTime = _startTime;
    m_startTimeHasBeenSet = true;
}

bool KubeJarvisStateInspectionResultsItem::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string KubeJarvisStateInspectionResultsItem::GetEndTime() const
{
    return m_endTime;
}

void KubeJarvisStateInspectionResultsItem::SetEndTime(const string& _endTime)
{
    m_endTime = _endTime;
    m_endTimeHasBeenSet = true;
}

bool KubeJarvisStateInspectionResultsItem::EndTimeHasBeenSet() const
{
