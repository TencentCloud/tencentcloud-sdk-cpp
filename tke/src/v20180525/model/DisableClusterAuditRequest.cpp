...
string DisableClusterAuditRequest::ToJsonString() const
{
...
string DisableClusterAuditRequest::GetClusterId() const
{
    return m_clusterId;
}

void DisableClusterAuditRequest::SetClusterId(const string& _clusterId)
{
