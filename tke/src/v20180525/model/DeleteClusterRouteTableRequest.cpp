...
string DeleteClusterRouteTableRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string DeleteClusterRouteTableRequest::GetRouteTableName() const
{
    return m_routeTableName;
}

void DeleteClusterRouteTableRequest::SetRouteTableName(const string& _routeTableName)
{
    m_routeTableName = _routeTableName;
    m_routeTableNameHasBeenSet = true;
}

bool DeleteClusterRouteTableRequest::RouteTableNameHasBeenSet() const
{
