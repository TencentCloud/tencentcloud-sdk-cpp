...
CoreInternalOutcome PrometheusAlertRuleDetail::Deserialize(const Value &value)
{
    string requestId = "";
...
void PrometheusAlertRuleDetail::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
