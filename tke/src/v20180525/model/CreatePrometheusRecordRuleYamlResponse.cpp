...
CoreInternalOutcome CreatePrometheusRecordRuleYamlResponse::Deserialize(const string &payload)
{
...
string CreatePrometheusRecordRuleYamlResponse::ToJsonString() const
{
