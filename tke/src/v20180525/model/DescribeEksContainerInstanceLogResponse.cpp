...
CoreInternalOutcome DescribeEksContainerInstanceLogResponse::Deserialize(const string &payload)
{
...
string DescribeEksContainerInstanceLogResponse::ToJsonString() const
{
...
string DescribeEksContainerInstanceLogResponse::GetContainerName() const
{
    return m_containerName;
}

bool DescribeEksContainerInstanceLogResponse::ContainerNameHasBeenSet() const
{
    return m_containerNameHasBeenSet;
}

string DescribeEksContainerInstanceLogResponse::GetLogContent() const
{
    return m_logContent;
}

bool DescribeEksContainerInstanceLogResponse::LogContentHasBeenSet() const
{
