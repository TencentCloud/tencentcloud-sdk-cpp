...
vector<PrometheusConfigItem> CreatePrometheusConfigRequest::GetProbes() const
{
    return m_probes;
}

void CreatePrometheusConfigRequest::SetProbes(const vector<PrometheusConfigItem>& _probes)
{
    m_probes = _probes;
    m_probesHasBeenSet = true;
}

bool CreatePrometheusConfigRequest::ProbesHasBeenSet() const
{
