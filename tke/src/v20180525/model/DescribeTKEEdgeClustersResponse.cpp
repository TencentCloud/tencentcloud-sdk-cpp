...
CoreInternalOutcome DescribeTKEEdgeClustersResponse::Deserialize(const string &payload)
{
...
string DescribeTKEEdgeClustersResponse::ToJsonString() const
{
...
uint64_t DescribeTKEEdgeClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTKEEdgeClustersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EdgeCluster> DescribeTKEEdgeClustersResponse::GetClusters() const
{
    return m_clusters;
}

bool DescribeTKEEdgeClustersResponse::ClustersHasBeenSet() const
{
