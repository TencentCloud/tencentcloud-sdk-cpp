...
CoreInternalOutcome DisableClusterDeletionProtectionResponse::Deserialize(const string &payload)
{
...
string DisableClusterDeletionProtectionResponse::ToJsonString() const
{
