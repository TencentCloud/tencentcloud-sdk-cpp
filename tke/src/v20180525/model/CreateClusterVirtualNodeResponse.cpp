...
CoreInternalOutcome CreateClusterVirtualNodeResponse::Deserialize(const string &payload)
{
...
string CreateClusterVirtualNodeResponse::ToJsonString() const
{
...
string CreateClusterVirtualNodeResponse::GetNodeName() const
{
    return m_nodeName;
}

bool CreateClusterVirtualNodeResponse::NodeNameHasBeenSet() const
{
