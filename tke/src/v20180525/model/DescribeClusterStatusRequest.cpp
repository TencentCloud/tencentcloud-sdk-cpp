...
string DescribeClusterStatusRequest::ToJsonString() const
{
...
vector<string> DescribeClusterStatusRequest::GetClusterIds() const
{
    return m_clusterIds;
}

void DescribeClusterStatusRequest::SetClusterIds(const vector<string>& _clusterIds)
{
    m_clusterIds = _clusterIds;
    m_clusterIdsHasBeenSet = true;
}

bool DescribeClusterStatusRequest::ClusterIdsHasBeenSet() const
{
