...
CreateExternalNodePoolResponse::CreateExternalNodePoolResponse() :
    m_nodePoolIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateExternalNodePoolResponse::Deserialize(const string &payload)
{
...
string CreateExternalNodePoolResponse::ToJsonString() const
{
...
string CreateExternalNodePoolResponse::GetNodePoolId() const
{
    return m_nodePoolId;
}

bool CreateExternalNodePoolResponse::NodePoolIdHasBeenSet() const
{
