...
CoreInternalOutcome DeleteClusterVirtualNodePoolResponse::Deserialize(const string &payload)
{
...
string DeleteClusterVirtualNodePoolResponse::ToJsonString() const
{
