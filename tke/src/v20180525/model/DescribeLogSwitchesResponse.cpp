...
CoreInternalOutcome DescribeLogSwitchesResponse::Deserialize(const string &payload)
{
...
string DescribeLogSwitchesResponse::ToJsonString() const
{
    ...
    if (m_switchSetHasBeenSet)
    {
        ...
        int i=0;
        for (auto itr = m_switchSet.begin(); itr != m_switchSet.end(); ++itr, ++i)
        {
...
vector<Switch> DescribeLogSwitchesResponse::GetSwitchSet() const
{
    return m_switchSet;
}

bool DescribeLogSwitchesResponse::SwitchSetHasBeenSet() const
{
