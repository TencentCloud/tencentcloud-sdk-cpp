...
CoreInternalOutcome DeletePrometheusTemplateSyncResponse::Deserialize(const string &payload)
{
...
string DeletePrometheusTemplateSyncResponse::ToJsonString() const
{
