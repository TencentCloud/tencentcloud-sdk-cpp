...
CoreInternalOutcome ModifyClusterVirtualNodePoolResponse::Deserialize(const string &payload)
{
...
string ModifyClusterVirtualNodePoolResponse::ToJsonString() const
{
