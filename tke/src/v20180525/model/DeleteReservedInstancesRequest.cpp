...
DeleteReservedInstancesRequest::DeleteReservedInstancesRequest() :
    m_reservedInstanceIdsHasBeenSet(false)
{
}

string DeleteReservedInstancesRequest::ToJsonString() const
{
...
vector<string> DeleteReservedInstancesRequest::GetReservedInstanceIds() const
{
    return m_reservedInstanceIds;
}

void DeleteReservedInstancesRequest::SetReservedInstanceIds(const vector<string>& _reservedInstanceIds)
{
    m_reservedInstanceIds = _reservedInstanceIds;
    m_reservedInstanceIdsHasBeenSet = true;
}

bool DeleteReservedInstancesRequest::ReservedInstanceIdsHasBeenSet() const
{
