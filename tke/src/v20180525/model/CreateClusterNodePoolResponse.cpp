...
CoreInternalOutcome CreateClusterNodePoolResponse::Deserialize(const string &payload)
{
...
string CreateClusterNodePoolResponse::ToJsonString() const
{
...
string CreateClusterNodePoolResponse::GetNodePoolId() const
{
    return m_nodePoolId;
}

bool CreateClusterNodePoolResponse::NodePoolIdHasBeenSet() const
{
