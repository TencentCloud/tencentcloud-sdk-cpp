...
CoreInternalOutcome TagSpecification::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void TagSpecification::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
