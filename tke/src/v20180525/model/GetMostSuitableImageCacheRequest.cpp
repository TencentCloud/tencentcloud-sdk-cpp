...
string GetMostSuitableImageCacheRequest::ToJsonString() const
{
...
vector<string> GetMostSuitableImageCacheRequest::GetImages() const
{
    return m_images;
}

void GetMostSuitableImageCacheRequest::SetImages(const vector<string>& _images)
{
    m_images = _images;
