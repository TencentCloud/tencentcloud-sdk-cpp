...
CoreInternalOutcome InstanceDataDiskMountSetting::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void InstanceDataDiskMountSetting::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string InstanceDataDiskMountSetting::GetInstanceType() const
{
    return m_instanceType;
}

void InstanceDataDiskMountSetting::SetInstanceType(const string& _instanceType)
{
    m_instanceType = _instanceType;
    m_instanceTypeHasBeenSet = true;
}

bool InstanceDataDiskMountSetting::InstanceTypeHasBeenSet() const
{
    return m_instanceTypeHasBeenSet;
}

vector<DataDisk> InstanceDataDiskMountSetting::GetDataDisks() const
{
    return m_dataDisks;
}

void InstanceDataDiskMountSetting::SetDataDisks(const vector<DataDisk>& _dataDisks)
{
    m_dataDisks = _dataDisks;
    m_dataDisksHasBeenSet = true;
}

bool InstanceDataDiskMountSetting::DataDisksHasBeenSet() const
{
    return m_dataDisksHasBeenSet;
}

string InstanceDataDiskMountSetting::GetZone() const
{
    return m_zone;
}

void InstanceDataDiskMountSetting::SetZone(const string& _zone)
{
    m_zone = _zone;
    m_zoneHasBeenSet = true;
}

bool InstanceDataDiskMountSetting::ZoneHasBeenSet() const
{
