...
CoreInternalOutcome DescribeClusterVirtualNodeResponse::Deserialize(const string &payload)
{
...
string DescribeClusterVirtualNodeResponse::ToJsonString() const
{
...
vector<VirtualNode> DescribeClusterVirtualNodeResponse::GetNodes() const
{
    return m_nodes;
}

bool DescribeClusterVirtualNodeResponse::NodesHasBeenSet() const
{
    return m_nodesHasBeenSet;
}

uint64_t DescribeClusterVirtualNodeResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterVirtualNodeResponse::TotalCountHasBeenSet() const
{
