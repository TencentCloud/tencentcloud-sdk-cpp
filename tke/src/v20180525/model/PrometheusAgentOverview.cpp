...
CoreInternalOutcome PrometheusAgentOverview::Deserialize(const Value &value)
{
    string requestId = "";
...
void PrometheusAgentOverview::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
