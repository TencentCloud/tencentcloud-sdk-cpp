...
CoreInternalOutcome NodeCountSummary::Deserialize(const Value &value)
{
    string requestId = "";
...
void NodeCountSummary::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
