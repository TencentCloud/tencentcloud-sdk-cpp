...
CoreInternalOutcome CreatePrometheusTemplateResponse::Deserialize(const string &payload)
{
...
string CreatePrometheusTemplateResponse::ToJsonString() const
{
...
string CreatePrometheusTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreatePrometheusTemplateResponse::TemplateIdHasBeenSet() const
{
