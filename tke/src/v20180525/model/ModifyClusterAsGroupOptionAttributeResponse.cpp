...
CoreInternalOutcome ModifyClusterAsGroupOptionAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyClusterAsGroupOptionAttributeResponse::ToJsonString() const
{
