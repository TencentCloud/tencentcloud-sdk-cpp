...
CoreInternalOutcome EnableClusterDeletionProtectionResponse::Deserialize(const string &payload)
{
...
string EnableClusterDeletionProtectionResponse::ToJsonString() const
{
