...
string DescribeEdgeLogSwitchesRequest::ToJsonString() const
{
...
vector<string> DescribeEdgeLogSwitchesRequest::GetClusterIds() const
{
    return m_clusterIds;
}

void DescribeEdgeLogSwitchesRequest::SetClusterIds(const vector<string>& _clusterIds)
{
    m_clusterIds = _clusterIds;
    m_clusterIdsHasBeenSet = true;
}

bool DescribeEdgeLogSwitchesRequest::ClusterIdsHasBeenSet() const
{
