...
DescribeExternalNodeScriptResponse::DescribeExternalNodeScriptResponse() :
...
CoreInternalOutcome DescribeExternalNodeScriptResponse::Deserialize(const string &payload)
{
...
string DescribeExternalNodeScriptResponse::ToJsonString() const
{
...
string DescribeExternalNodeScriptResponse::GetLink() const
{
    return m_link;
}

bool DescribeExternalNodeScriptResponse::LinkHasBeenSet() const
{
    return m_linkHasBeenSet;
}

string DescribeExternalNodeScriptResponse::GetToken() const
{
    return m_token;
}

bool DescribeExternalNodeScriptResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string DescribeExternalNodeScriptResponse::GetCommand() const
{
    return m_command;
}

bool DescribeExternalNodeScriptResponse::CommandHasBeenSet() const
{
