...
string DescribeEdgeAvailableExtraArgsRequest::ToJsonString() const
{
...
string DescribeEdgeAvailableExtraArgsRequest::GetClusterVersion() const
{
    return m_clusterVersion;
}

void DescribeEdgeAvailableExtraArgsRequest::SetClusterVersion(const string& _clusterVersion)
{
    m_clusterVersion = _clusterVersion;
    m_clusterVersionHasBeenSet = true;
}

bool DescribeEdgeAvailableExtraArgsRequest::ClusterVersionHasBeenSet() const
{
