...
CoreInternalOutcome RestartEKSContainerInstancesResponse::Deserialize(const string &payload)
{
...
string RestartEKSContainerInstancesResponse::ToJsonString() const
{
