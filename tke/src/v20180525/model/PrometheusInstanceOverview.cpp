...
CoreInternalOutcome PrometheusInstanceOverview::Deserialize(const Value &value)
{
    string requestId = "";
...
void PrometheusInstanceOverview::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
