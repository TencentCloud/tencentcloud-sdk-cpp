...
CoreInternalOutcome ModifyPrometheusAgentExternalLabelsResponse::Deserialize(const string &payload)
{
...
string ModifyPrometheusAgentExternalLabelsResponse::ToJsonString() const
{
