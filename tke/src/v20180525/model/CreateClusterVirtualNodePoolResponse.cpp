...
CoreInternalOutcome CreateClusterVirtualNodePoolResponse::Deserialize(const string &payload)
{
...
string CreateClusterVirtualNodePoolResponse::ToJsonString() const
{
...
string CreateClusterVirtualNodePoolResponse::GetNodePoolId() const
{
    return m_nodePoolId;
}

bool CreateClusterVirtualNodePoolResponse::NodePoolIdHasBeenSet() const
{
