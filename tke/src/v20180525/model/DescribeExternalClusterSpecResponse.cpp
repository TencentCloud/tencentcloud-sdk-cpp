...
CoreInternalOutcome DescribeExternalClusterSpecResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Spec"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `Spec` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_spec = string(rsp["Spec"].GetString());
...
string DescribeExternalClusterSpecResponse::ToJsonString() const
{
...
string DescribeExternalClusterSpecResponse::GetSpec() const
{
    return m_spec;
}

bool DescribeExternalClusterSpecResponse::SpecHasBeenSet() const
{
    return m_specHasBeenSet;
}

string DescribeExternalClusterSpecResponse::GetExpiration() const
{
    return m_expiration;
}

bool DescribeExternalClusterSpecResponse::ExpirationHasBeenSet() const
{
