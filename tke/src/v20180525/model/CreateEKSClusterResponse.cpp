...
CoreInternalOutcome CreateEKSClusterResponse::Deserialize(const string &payload)
{
...
string CreateEKSClusterResponse::ToJsonString() const
{
...
string CreateEKSClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateEKSClusterResponse::ClusterIdHasBeenSet() const
{
