...
CoreInternalOutcome CreateTKEEdgeClusterResponse::Deserialize(const string &payload)
{
...
string CreateTKEEdgeClusterResponse::ToJsonString() const
{
...
string CreateTKEEdgeClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateTKEEdgeClusterResponse::ClusterIdHasBeenSet() const
{
