...
uint64_t DescribePrometheusAgentsRequest::GetOffset() const
{
    return m_offset;
}

void DescribePrometheusAgentsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribePrometheusAgentsRequest::GetLimit() const
{
    return m_limit;
}

void DescribePrometheusAgentsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
