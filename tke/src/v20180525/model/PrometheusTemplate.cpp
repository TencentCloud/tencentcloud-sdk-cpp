...
CoreInternalOutcome PrometheusTemplate::Deserialize(const Value &value)
{
    string requestId = "";
...
void PrometheusTemplate::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
