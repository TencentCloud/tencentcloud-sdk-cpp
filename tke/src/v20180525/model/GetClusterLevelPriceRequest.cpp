...
string GetClusterLevelPriceRequest::ToJsonString() const
{
...
string GetClusterLevelPriceRequest::GetClusterLevel() const
{
    return m_clusterLevel;
}

void GetClusterLevelPriceRequest::SetClusterLevel(const string& _clusterLevel)
{
    m_clusterLevel = _clusterLevel;
    m_clusterLevelHasBeenSet = true;
}

bool GetClusterLevelPriceRequest::ClusterLevelHasBeenSet() const
{
