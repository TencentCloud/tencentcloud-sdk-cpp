...
CoreInternalOutcome DescribeEKSClustersResponse::Deserialize(const string &payload)
{
...
string DescribeEKSClustersResponse::ToJsonString() const
{
...
uint64_t DescribeEKSClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeEKSClustersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EksCluster> DescribeEKSClustersResponse::GetClusters() const
{
    return m_clusters;
}

bool DescribeEKSClustersResponse::ClustersHasBeenSet() const
{
