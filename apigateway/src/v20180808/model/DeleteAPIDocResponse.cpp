...
CoreInternalOutcome DeleteAPIDocResponse::Deserialize(const string &payload)
{
...
string DeleteAPIDocResponse::ToJsonString() const
{
...
bool DeleteAPIDocResponse::GetResult() const
{
    return m_result;
}

bool DeleteAPIDocResponse::ResultHasBeenSet() const
{
