...
CoreInternalOutcome DescribeServiceSubDomainMappingsResponse::Deserialize(const string &payload)
{
...
string DescribeServiceSubDomainMappingsResponse::ToJsonString() const
{
...
ServiceSubDomainMappings DescribeServiceSubDomainMappingsResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceSubDomainMappingsResponse::ResultHasBeenSet() const
{
