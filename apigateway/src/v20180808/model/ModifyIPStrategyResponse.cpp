...
CoreInternalOutcome ModifyIPStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyIPStrategyResponse::ToJsonString() const
{
...
bool ModifyIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool ModifyIPStrategyResponse::ResultHasBeenSet() const
{
