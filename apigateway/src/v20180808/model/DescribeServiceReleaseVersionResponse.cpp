...
CoreInternalOutcome DescribeServiceReleaseVersionResponse::Deserialize(const string &payload)
{
...
string DescribeServiceReleaseVersionResponse::ToJsonString() const
{
...
ServiceReleaseVersion DescribeServiceReleaseVersionResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceReleaseVersionResponse::ResultHasBeenSet() const
{
