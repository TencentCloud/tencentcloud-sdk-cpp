...
CoreInternalOutcome ModifyApiAppResponse::Deserialize(const string &payload)
{
...
string ModifyApiAppResponse::ToJsonString() const
{
...
bool ModifyApiAppResponse::GetResult() const
{
    return m_result;
}

bool ModifyApiAppResponse::ResultHasBeenSet() const
{
