...
CoreInternalOutcome DescribeUpstreamBindApisResponse::Deserialize(const string &payload)
{
...
string DescribeUpstreamBindApisResponse::ToJsonString() const
{
...
DescribeUpstreamBindApis DescribeUpstreamBindApisResponse::GetResult() const
{
    return m_result;
}

bool DescribeUpstreamBindApisResponse::ResultHasBeenSet() const
{
