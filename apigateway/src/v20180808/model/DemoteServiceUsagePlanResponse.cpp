...
CoreInternalOutcome DemoteServiceUsagePlanResponse::Deserialize(const string &payload)
{
...
string DemoteServiceUsagePlanResponse::ToJsonString() const
{
...
bool DemoteServiceUsagePlanResponse::GetResult() const
{
    return m_result;
}

bool DemoteServiceUsagePlanResponse::ResultHasBeenSet() const
{
