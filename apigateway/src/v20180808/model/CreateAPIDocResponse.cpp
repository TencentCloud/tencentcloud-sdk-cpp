...
CoreInternalOutcome CreateAPIDocResponse::Deserialize(const string &payload)
{
...
string CreateAPIDocResponse::ToJsonString() const
{
...
APIDoc CreateAPIDocResponse::GetResult() const
{
    return m_result;
}

bool CreateAPIDocResponse::ResultHasBeenSet() const
{
