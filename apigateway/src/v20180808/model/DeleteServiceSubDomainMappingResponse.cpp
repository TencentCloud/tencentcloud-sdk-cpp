...
CoreInternalOutcome DeleteServiceSubDomainMappingResponse::Deserialize(const string &payload)
{
...
string DeleteServiceSubDomainMappingResponse::ToJsonString() const
{
...
bool DeleteServiceSubDomainMappingResponse::GetResult() const
{
    return m_result;
}

bool DeleteServiceSubDomainMappingResponse::ResultHasBeenSet() const
{
