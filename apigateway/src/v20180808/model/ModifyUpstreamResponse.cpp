...
CoreInternalOutcome ModifyUpstreamResponse::Deserialize(const string &payload)
{
...
string ModifyUpstreamResponse::ToJsonString() const
{
...
bool ModifyUpstreamResponse::ResultHasBeenSet() const
{
