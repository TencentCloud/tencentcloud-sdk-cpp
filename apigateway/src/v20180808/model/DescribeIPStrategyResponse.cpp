...
CoreInternalOutcome DescribeIPStrategyResponse::Deserialize(const string &payload)
{
...
string DescribeIPStrategyResponse::ToJsonString() const
{
...
IPStrategy DescribeIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool DescribeIPStrategyResponse::ResultHasBeenSet() const
{
