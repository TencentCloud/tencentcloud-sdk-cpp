...
string DeleteUsagePlanRequest::ToJsonString() const
{
...
string DeleteUsagePlanRequest::GetUsagePlanId() const
{
    return m_usagePlanId;
}

void DeleteUsagePlanRequest::SetUsagePlanId(const string& _usagePlanId)
{
    m_usagePlanId = _usagePlanId;
    m_usagePlanIdHasBeenSet = true;
}

bool DeleteUsagePlanRequest::UsagePlanIdHasBeenSet() const
{
