...
CoreInternalOutcome UnBindIPStrategyResponse::Deserialize(const string &payload)
{
...
string UnBindIPStrategyResponse::ToJsonString() const
{
...
bool UnBindIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool UnBindIPStrategyResponse::ResultHasBeenSet() const
{
