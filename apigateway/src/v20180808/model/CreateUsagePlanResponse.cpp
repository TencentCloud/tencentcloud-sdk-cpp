...
CoreInternalOutcome CreateUsagePlanResponse::Deserialize(const string &payload)
{
...
string CreateUsagePlanResponse::ToJsonString() const
{
...
UsagePlanInfo CreateUsagePlanResponse::GetResult() const
{
    return m_result;
}

bool CreateUsagePlanResponse::ResultHasBeenSet() const
{
