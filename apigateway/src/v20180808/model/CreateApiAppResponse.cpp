...
CoreInternalOutcome CreateApiAppResponse::Deserialize(const string &payload)
{
...
string CreateApiAppResponse::ToJsonString() const
{
...
ApiAppInfo CreateApiAppResponse::GetResult() const
{
    return m_result;
}

bool CreateApiAppResponse::ResultHasBeenSet() const
{
