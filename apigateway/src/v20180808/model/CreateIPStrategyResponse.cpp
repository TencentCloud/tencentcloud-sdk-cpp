...
CoreInternalOutcome CreateIPStrategyResponse::Deserialize(const string &payload)
{
...
string CreateIPStrategyResponse::ToJsonString() const
{
...
IPStrategy CreateIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool CreateIPStrategyResponse::ResultHasBeenSet() const
{
