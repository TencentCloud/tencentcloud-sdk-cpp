...
CoreInternalOutcome DescribeAPIDocsResponse::Deserialize(const string &payload)
{
...
string DescribeAPIDocsResponse::ToJsonString() const
{
...
APIDocs DescribeAPIDocsResponse::GetResult() const
{
    return m_result;
}

bool DescribeAPIDocsResponse::ResultHasBeenSet() const
{
