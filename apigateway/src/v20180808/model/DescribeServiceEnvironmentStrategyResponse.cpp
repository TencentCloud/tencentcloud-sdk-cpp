...
CoreInternalOutcome DescribeServiceEnvironmentStrategyResponse::Deserialize(const string &payload)
{
...
string DescribeServiceEnvironmentStrategyResponse::ToJsonString() const
{
...
ServiceEnvironmentStrategyStatus DescribeServiceEnvironmentStrategyResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceEnvironmentStrategyResponse::ResultHasBeenSet() const
{
