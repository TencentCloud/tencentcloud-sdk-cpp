...
CoreInternalOutcome DescribeServicesStatusResponse::Deserialize(const string &payload)
{
...
string DescribeServicesStatusResponse::ToJsonString() const
{
...
ServicesStatus DescribeServicesStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeServicesStatusResponse::ResultHasBeenSet() const
{
