...
CoreInternalOutcome ModifyPluginResponse::Deserialize(const string &payload)
{
...
string ModifyPluginResponse::ToJsonString() const
{
...
bool ModifyPluginResponse::GetResult() const
{
    return m_result;
}

bool ModifyPluginResponse::ResultHasBeenSet() const
{
