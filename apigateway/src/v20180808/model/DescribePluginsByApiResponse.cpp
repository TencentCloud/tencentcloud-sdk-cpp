...
CoreInternalOutcome DescribePluginsByApiResponse::Deserialize(const string &payload)
{
...
string DescribePluginsByApiResponse::ToJsonString() const
{
...
AttachedPluginSummary DescribePluginsByApiResponse::GetResult() const
{
    return m_result;
}

bool DescribePluginsByApiResponse::ResultHasBeenSet() const
{
