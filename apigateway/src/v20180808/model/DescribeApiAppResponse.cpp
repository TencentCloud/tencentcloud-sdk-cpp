...
CoreInternalOutcome DescribeApiAppResponse::Deserialize(const string &payload)
{
...
string DescribeApiAppResponse::ToJsonString() const
{
...
ApiAppInfos DescribeApiAppResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiAppResponse::ResultHasBeenSet() const
{
