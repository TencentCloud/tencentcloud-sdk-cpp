...
CoreInternalOutcome UnBindSubDomainResponse::Deserialize(const string &payload)
{
...
string UnBindSubDomainResponse::ToJsonString() const
{
...
bool UnBindSubDomainResponse::GetResult() const
{
    return m_result;
}

bool UnBindSubDomainResponse::ResultHasBeenSet() const
{
