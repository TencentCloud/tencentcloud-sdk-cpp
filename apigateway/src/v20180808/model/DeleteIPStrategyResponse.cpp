...
CoreInternalOutcome DeleteIPStrategyResponse::Deserialize(const string &payload)
{
...
string DeleteIPStrategyResponse::ToJsonString() const
{
...
bool DeleteIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool DeleteIPStrategyResponse::ResultHasBeenSet() const
{
