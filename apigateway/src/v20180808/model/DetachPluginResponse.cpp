...
CoreInternalOutcome DetachPluginResponse::Deserialize(const string &payload)
{
...
string DetachPluginResponse::ToJsonString() const
{
...
bool DetachPluginResponse::GetResult() const
{
    return m_result;
}

bool DetachPluginResponse::ResultHasBeenSet() const
{
