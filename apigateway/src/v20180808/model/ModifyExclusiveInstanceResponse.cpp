...
CoreInternalOutcome ModifyExclusiveInstanceResponse::Deserialize(const string &payload)
{
...
string ModifyExclusiveInstanceResponse::ToJsonString() const
{
...
InstanceDetail ModifyExclusiveInstanceResponse::GetResult() const
{
    return m_result;
}

bool ModifyExclusiveInstanceResponse::ResultHasBeenSet() const
{
