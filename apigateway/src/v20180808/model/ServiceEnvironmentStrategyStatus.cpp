...
CoreInternalOutcome ServiceEnvironmentStrategyStatus::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EnvironmentList") && !value["EnvironmentList"].IsNull())
    {
        ...
        {
            ServiceEnvironmentStrategy item;
...
void ServiceEnvironmentStrategyStatus::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
int64_t ServiceEnvironmentStrategyStatus::GetTotalCount() const
{
    return m_totalCount;
}

void ServiceEnvironmentStrategyStatus::SetTotalCount(const int64_t& _totalCount)
{
    m_totalCount = _totalCount;
    m_totalCountHasBeenSet = true;
}

bool ServiceEnvironmentStrategyStatus::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ServiceEnvironmentStrategy> ServiceEnvironmentStrategyStatus::GetEnvironmentList() const
{
    return m_environmentList;
}

void ServiceEnvironmentStrategyStatus::SetEnvironmentList(const vector<ServiceEnvironmentStrategy>& _environmentList)
{
    m_environmentList = _environmentList;
    m_environmentListHasBeenSet = true;
}

bool ServiceEnvironmentStrategyStatus::EnvironmentListHasBeenSet() const
{
