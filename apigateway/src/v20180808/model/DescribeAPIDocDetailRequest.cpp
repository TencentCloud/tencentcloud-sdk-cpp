...
string DescribeAPIDocDetailRequest::ToJsonString() const
{
...
string DescribeAPIDocDetailRequest::GetApiDocId() const
{
    return m_apiDocId;
}

void DescribeAPIDocDetailRequest::SetApiDocId(const string& _apiDocId)
{
    m_apiDocId = _apiDocId;
    m_apiDocIdHasBeenSet = true;
}

bool DescribeAPIDocDetailRequest::ApiDocIdHasBeenSet() const
{
