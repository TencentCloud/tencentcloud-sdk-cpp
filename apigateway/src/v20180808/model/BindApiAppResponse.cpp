...
CoreInternalOutcome BindApiAppResponse::Deserialize(const string &payload)
{
...
string BindApiAppResponse::ToJsonString() const
{
...
bool BindApiAppResponse::GetResult() const
{
    return m_result;
}

bool BindApiAppResponse::ResultHasBeenSet() const
{
