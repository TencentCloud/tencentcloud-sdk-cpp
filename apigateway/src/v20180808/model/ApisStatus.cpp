...
CoreInternalOutcome ApisStatus::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ApisStatus::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
