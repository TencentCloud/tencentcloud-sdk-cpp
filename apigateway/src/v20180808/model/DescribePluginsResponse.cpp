...
CoreInternalOutcome DescribePluginsResponse::Deserialize(const string &payload)
{
...
string DescribePluginsResponse::ToJsonString() const
{
...
PluginSummary DescribePluginsResponse::GetResult() const
{
    return m_result;
}

bool DescribePluginsResponse::ResultHasBeenSet() const
{
