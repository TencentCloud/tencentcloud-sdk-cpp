...
CoreInternalOutcome DescribeApiResponse::Deserialize(const string &payload)
{
...
string DescribeApiResponse::ToJsonString() const
{
...
ApiInfo DescribeApiResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiResponse::ResultHasBeenSet() const
{
