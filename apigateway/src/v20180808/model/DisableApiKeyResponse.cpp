...
CoreInternalOutcome DisableApiKeyResponse::Deserialize(const string &payload)
{
...
string DisableApiKeyResponse::ToJsonString() const
{
...
bool DisableApiKeyResponse::GetResult() const
{
    return m_result;
}

bool DisableApiKeyResponse::ResultHasBeenSet() const
{
