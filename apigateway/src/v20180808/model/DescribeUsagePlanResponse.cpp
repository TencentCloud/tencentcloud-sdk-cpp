...
CoreInternalOutcome DescribeUsagePlanResponse::Deserialize(const string &payload)
{
...
string DescribeUsagePlanResponse::ToJsonString() const
{
...
UsagePlanInfo DescribeUsagePlanResponse::GetResult() const
{
    return m_result;
}

bool DescribeUsagePlanResponse::ResultHasBeenSet() const
{
