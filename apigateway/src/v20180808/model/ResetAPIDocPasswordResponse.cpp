...
CoreInternalOutcome ResetAPIDocPasswordResponse::Deserialize(const string &payload)
{
...
string ResetAPIDocPasswordResponse::ToJsonString() const
{
...
APIDoc ResetAPIDocPasswordResponse::GetResult() const
{
    return m_result;
}

bool ResetAPIDocPasswordResponse::ResultHasBeenSet() const
{
