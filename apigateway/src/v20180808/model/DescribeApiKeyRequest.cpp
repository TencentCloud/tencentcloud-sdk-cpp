...
string DescribeApiKeyRequest::GetAccessKeyId() const
{
    return m_accessKeyId;
}

void DescribeApiKeyRequest::SetAccessKeyId(const string& _accessKeyId)
{
    m_accessKeyId = _accessKeyId;
    m_accessKeyIdHasBeenSet = true;
}

bool DescribeApiKeyRequest::AccessKeyIdHasBeenSet() const
{
