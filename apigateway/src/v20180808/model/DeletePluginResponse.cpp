...
CoreInternalOutcome DeletePluginResponse::Deserialize(const string &payload)
{
...
string DeletePluginResponse::ToJsonString() const
{
...
bool DeletePluginResponse::GetResult() const
{
    return m_result;
}

bool DeletePluginResponse::ResultHasBeenSet() const
{
