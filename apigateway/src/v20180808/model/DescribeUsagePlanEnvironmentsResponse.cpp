...
CoreInternalOutcome DescribeUsagePlanEnvironmentsResponse::Deserialize(const string &payload)
{
...
string DescribeUsagePlanEnvironmentsResponse::ToJsonString() const
{
...
UsagePlanEnvironmentStatus DescribeUsagePlanEnvironmentsResponse::GetResult() const
{
    return m_result;
}

bool DescribeUsagePlanEnvironmentsResponse::ResultHasBeenSet() const
{
