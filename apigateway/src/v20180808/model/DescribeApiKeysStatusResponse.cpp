...
CoreInternalOutcome DescribeApiKeysStatusResponse::Deserialize(const string &payload)
{
...
string DescribeApiKeysStatusResponse::ToJsonString() const
{
...
ApiKeysStatus DescribeApiKeysStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiKeysStatusResponse::ResultHasBeenSet() const
{
