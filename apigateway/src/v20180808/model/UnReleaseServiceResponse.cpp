...
CoreInternalOutcome UnReleaseServiceResponse::Deserialize(const string &payload)
{
...
string UnReleaseServiceResponse::ToJsonString() const
{
...
bool UnReleaseServiceResponse::GetResult() const
{
    return m_result;
}

bool UnReleaseServiceResponse::ResultHasBeenSet() const
{
