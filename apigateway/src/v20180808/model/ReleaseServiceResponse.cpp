...
CoreInternalOutcome ReleaseServiceResponse::Deserialize(const string &payload)
{
...
string ReleaseServiceResponse::ToJsonString() const
{
...
ReleaseService ReleaseServiceResponse::GetResult() const
{
    return m_result;
}

bool ReleaseServiceResponse::ResultHasBeenSet() const
{
