...
CoreInternalOutcome ModifySubDomainResponse::Deserialize(const string &payload)
{
...
string ModifySubDomainResponse::ToJsonString() const
{
...
bool ModifySubDomainResponse::GetResult() const
{
    return m_result;
}

bool ModifySubDomainResponse::ResultHasBeenSet() const
{
