...
CoreInternalOutcome DescribeUsagePlansStatusResponse::Deserialize(const string &payload)
{
...
string DescribeUsagePlansStatusResponse::ToJsonString() const
{
...
UsagePlansStatus DescribeUsagePlansStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeUsagePlansStatusResponse::ResultHasBeenSet() const
{
