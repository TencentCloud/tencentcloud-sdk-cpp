...
CoreInternalOutcome BuildAPIDocResponse::Deserialize(const string &payload)
{
...
string BuildAPIDocResponse::ToJsonString() const
{
...
bool BuildAPIDocResponse::GetResult() const
{
    return m_result;
}

bool BuildAPIDocResponse::ResultHasBeenSet() const
{
