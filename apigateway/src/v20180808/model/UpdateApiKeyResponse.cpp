...
CoreInternalOutcome UpdateApiKeyResponse::Deserialize(const string &payload)
{
...
string UpdateApiKeyResponse::ToJsonString() const
{
...
ApiKey UpdateApiKeyResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiKeyResponse::ResultHasBeenSet() const
{
