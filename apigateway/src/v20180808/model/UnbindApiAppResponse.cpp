...
CoreInternalOutcome UnbindApiAppResponse::Deserialize(const string &payload)
{
...
string UnbindApiAppResponse::ToJsonString() const
{
...
bool UnbindApiAppResponse::GetResult() const
{
    return m_result;
}

bool UnbindApiAppResponse::ResultHasBeenSet() const
{
