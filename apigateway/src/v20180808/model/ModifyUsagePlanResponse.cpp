...
CoreInternalOutcome ModifyUsagePlanResponse::Deserialize(const string &payload)
{
...
string ModifyUsagePlanResponse::ToJsonString() const
{
...
UsagePlanInfo ModifyUsagePlanResponse::GetResult() const
{
    return m_result;
}

bool ModifyUsagePlanResponse::ResultHasBeenSet() const
{
