...
CoreInternalOutcome DescribeAllPluginApisResponse::Deserialize(const string &payload)
{
...
string DescribeAllPluginApisResponse::ToJsonString() const
{
...
ApiInfoSummary DescribeAllPluginApisResponse::GetResult() const
{
    return m_result;
}

bool DescribeAllPluginApisResponse::ResultHasBeenSet() const
{
