...
CoreInternalOutcome EnableApiKeyResponse::Deserialize(const string &payload)
{
...
string EnableApiKeyResponse::ToJsonString() const
{
...
bool EnableApiKeyResponse::GetResult() const
{
    return m_result;
}

bool EnableApiKeyResponse::ResultHasBeenSet() const
{
