...
CoreInternalOutcome DescribeServiceEnvironmentListResponse::Deserialize(const string &payload)
{
...
string DescribeServiceEnvironmentListResponse::ToJsonString() const
{
...
ServiceEnvironmentSet DescribeServiceEnvironmentListResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceEnvironmentListResponse::ResultHasBeenSet() const
{
