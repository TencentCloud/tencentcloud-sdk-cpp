...
CoreInternalOutcome CreateApiResponse::Deserialize(const string &payload)
{
...
string CreateApiResponse::ToJsonString() const
{
...
bool CreateApiResponse::ResultHasBeenSet() const
{
