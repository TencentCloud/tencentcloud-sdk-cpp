...
CoreInternalOutcome DeleteApiKeyResponse::Deserialize(const string &payload)
{
...
string DeleteApiKeyResponse::ToJsonString() const
{
...
bool DeleteApiKeyResponse::GetResult() const
{
    return m_result;
}

bool DeleteApiKeyResponse::ResultHasBeenSet() const
{
