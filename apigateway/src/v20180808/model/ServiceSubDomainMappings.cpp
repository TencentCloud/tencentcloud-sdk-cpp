...
CoreInternalOutcome ServiceSubDomainMappings::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("PathMappingSet") && !value["PathMappingSet"].IsNull())
    {
        ...
        const Value &tmpValue = value["PathMappingSet"];
...
void ServiceSubDomainMappings::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
