...
CoreInternalOutcome DescribeServiceSubDomainsResponse::Deserialize(const string &payload)
{
...
string DescribeServiceSubDomainsResponse::ToJsonString() const
{
...
DomainSets DescribeServiceSubDomainsResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceSubDomainsResponse::ResultHasBeenSet() const
{
