...
CoreInternalOutcome ModifyAPIDocResponse::Deserialize(const string &payload)
{
...
string ModifyAPIDocResponse::ToJsonString() const
{
...
APIDoc ModifyAPIDocResponse::GetResult() const
{
    return m_result;
}

bool ModifyAPIDocResponse::ResultHasBeenSet() const
{
