...
CoreInternalOutcome AttachPluginResponse::Deserialize(const string &payload)
{
...
string AttachPluginResponse::ToJsonString() const
{
...
bool AttachPluginResponse::GetResult() const
{
    return m_result;
}

bool AttachPluginResponse::ResultHasBeenSet() const
{
