...
CoreInternalOutcome DeleteApiAppResponse::Deserialize(const string &payload)
{
...
string DeleteApiAppResponse::ToJsonString() const
{
...
bool DeleteApiAppResponse::GetResult() const
{
    return m_result;
}

bool DeleteApiAppResponse::ResultHasBeenSet() const
{
