...
CoreInternalOutcome DescribeExclusiveInstancesStatusResponse::Deserialize(const string &payload)
{
...
string DescribeExclusiveInstancesStatusResponse::ToJsonString() const
{
...
InstanceSummary DescribeExclusiveInstancesStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeExclusiveInstancesStatusResponse::ResultHasBeenSet() const
{
