...
string DeleteApiAppRequest::ToJsonString() const
{
...
string DeleteApiAppRequest::GetApiAppId() const
{
    return m_apiAppId;
}

void DeleteApiAppRequest::SetApiAppId(const string& _apiAppId)
{
    m_apiAppId = _apiAppId;
    m_apiAppIdHasBeenSet = true;
}

bool DeleteApiAppRequest::ApiAppIdHasBeenSet() const
{
