...
CoreInternalOutcome UnBindEnvironmentResponse::Deserialize(const string &payload)
{
...
string UnBindEnvironmentResponse::ToJsonString() const
{
...
bool UnBindEnvironmentResponse::GetResult() const
{
    return m_result;
}

bool UnBindEnvironmentResponse::ResultHasBeenSet() const
{
