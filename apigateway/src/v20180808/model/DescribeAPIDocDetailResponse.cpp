...
CoreInternalOutcome DescribeAPIDocDetailResponse::Deserialize(const string &payload)
{
...
string DescribeAPIDocDetailResponse::ToJsonString() const
{
...
APIDocInfo DescribeAPIDocDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeAPIDocDetailResponse::ResultHasBeenSet() const
{
