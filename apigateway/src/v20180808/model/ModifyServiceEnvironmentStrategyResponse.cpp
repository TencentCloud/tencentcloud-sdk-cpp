...
CoreInternalOutcome ModifyServiceEnvironmentStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyServiceEnvironmentStrategyResponse::ToJsonString() const
{
...
bool ModifyServiceEnvironmentStrategyResponse::GetResult() const
{
    return m_result;
}

bool ModifyServiceEnvironmentStrategyResponse::ResultHasBeenSet() const
{
