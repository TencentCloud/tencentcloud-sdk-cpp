...
CoreInternalOutcome BindSecretIdsResponse::Deserialize(const string &payload)
{
...
string BindSecretIdsResponse::ToJsonString() const
{
...
bool BindSecretIdsResponse::GetResult() const
{
    return m_result;
}

bool BindSecretIdsResponse::ResultHasBeenSet() const
{
