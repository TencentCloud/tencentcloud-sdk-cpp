...
CoreInternalOutcome DescribeUpstreamsResponse::Deserialize(const string &payload)
{
...
string DescribeUpstreamsResponse::ToJsonString() const
{
...
DescribeUpstreamInfo DescribeUpstreamsResponse::GetResult() const
{
    return m_result;
}

bool DescribeUpstreamsResponse::ResultHasBeenSet() const
{
