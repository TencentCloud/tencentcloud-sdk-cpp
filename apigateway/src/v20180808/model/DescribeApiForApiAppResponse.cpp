...
CoreInternalOutcome DescribeApiForApiAppResponse::Deserialize(const string &payload)
{
...
string DescribeApiForApiAppResponse::ToJsonString() const
{
...
ApiInfo DescribeApiForApiAppResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiForApiAppResponse::ResultHasBeenSet() const
{
