...
CoreInternalOutcome DescribePluginApisResponse::Deserialize(const string &payload)
{
...
string DescribePluginApisResponse::ToJsonString() const
{
...
AttachedApiSummary DescribePluginApisResponse::GetResult() const
{
    return m_result;
}

bool DescribePluginApisResponse::ResultHasBeenSet() const
{
