...
CoreInternalOutcome DescribeApiBindApiAppsStatusResponse::Deserialize(const string &payload)
{
...
string DescribeApiBindApiAppsStatusResponse::ToJsonString() const
{
...
ApiAppApiInfos DescribeApiBindApiAppsStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiBindApiAppsStatusResponse::ResultHasBeenSet() const
{
