...
CoreInternalOutcome UpdateApiAppKeyResponse::Deserialize(const string &payload)
{
...
string UpdateApiAppKeyResponse::ToJsonString() const
{
...
bool UpdateApiAppKeyResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiAppKeyResponse::ResultHasBeenSet() const
{
