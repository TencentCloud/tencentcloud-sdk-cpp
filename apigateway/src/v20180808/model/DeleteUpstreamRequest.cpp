...
string DeleteUpstreamRequest::ToJsonString() const
{
...
string DeleteUpstreamRequest::GetUpstreamId() const
{
    return m_upstreamId;
}

void DeleteUpstreamRequest::SetUpstreamId(const string& _upstreamId)
{
    m_upstreamId = _upstreamId;
    m_upstreamIdHasBeenSet = true;
}

bool DeleteUpstreamRequest::UpstreamIdHasBeenSet() const
{
