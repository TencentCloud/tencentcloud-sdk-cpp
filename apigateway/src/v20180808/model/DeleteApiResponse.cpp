...
CoreInternalOutcome DeleteApiResponse::Deserialize(const string &payload)
{
...
string DeleteApiResponse::ToJsonString() const
{
...
bool DeleteApiResponse::GetResult() const
{
    return m_result;
}

bool DeleteApiResponse::ResultHasBeenSet() const
{
