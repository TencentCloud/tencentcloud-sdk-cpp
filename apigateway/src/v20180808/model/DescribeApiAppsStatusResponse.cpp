...
CoreInternalOutcome DescribeApiAppsStatusResponse::Deserialize(const string &payload)
{
...
string DescribeApiAppsStatusResponse::ToJsonString() const
{
...
ApiAppInfos DescribeApiAppsStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiAppsStatusResponse::ResultHasBeenSet() const
{
