...
CoreInternalOutcome ModifyApiEnvironmentStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyApiEnvironmentStrategyResponse::ToJsonString() const
{
...
bool ModifyApiEnvironmentStrategyResponse::GetResult() const
{
    return m_result;
}

bool ModifyApiEnvironmentStrategyResponse::ResultHasBeenSet() const
{
