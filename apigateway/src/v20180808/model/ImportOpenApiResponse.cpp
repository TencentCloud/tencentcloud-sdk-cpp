...
CoreInternalOutcome ImportOpenApiResponse::Deserialize(const string &payload)
{
...
string ImportOpenApiResponse::ToJsonString() const
{
...
CreateApiRspSet ImportOpenApiResponse::GetResult() const
{
    return m_result;
}

bool ImportOpenApiResponse::ResultHasBeenSet() const
{
