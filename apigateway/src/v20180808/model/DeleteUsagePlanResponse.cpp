...
CoreInternalOutcome DeleteUsagePlanResponse::Deserialize(const string &payload)
{
...
string DeleteUsagePlanResponse::ToJsonString() const
{
...
bool DeleteUsagePlanResponse::GetResult() const
{
    return m_result;
}

bool DeleteUsagePlanResponse::ResultHasBeenSet() const
{
