...
CoreInternalOutcome DescribeServiceEnvironmentReleaseHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeServiceEnvironmentReleaseHistoryResponse::ToJsonString() const
{
...
ServiceReleaseHistory DescribeServiceEnvironmentReleaseHistoryResponse::GetResult() const
{
    return m_result;
}

bool DescribeServiceEnvironmentReleaseHistoryResponse::ResultHasBeenSet() const
{
