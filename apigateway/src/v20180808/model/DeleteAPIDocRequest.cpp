...
string DeleteAPIDocRequest::ToJsonString() const
{
...
string DeleteAPIDocRequest::GetApiDocId() const
{
    return m_apiDocId;
}

void DeleteAPIDocRequest::SetApiDocId(const string& _apiDocId)
{
    m_apiDocId = _apiDocId;
    m_apiDocIdHasBeenSet = true;
}

bool DeleteAPIDocRequest::ApiDocIdHasBeenSet() const
{
