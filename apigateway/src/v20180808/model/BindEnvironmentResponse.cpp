...
CoreInternalOutcome BindEnvironmentResponse::Deserialize(const string &payload)
{
...
string BindEnvironmentResponse::ToJsonString() const
{
...
bool BindEnvironmentResponse::GetResult() const
{
    return m_result;
}

bool BindEnvironmentResponse::ResultHasBeenSet() const
{
