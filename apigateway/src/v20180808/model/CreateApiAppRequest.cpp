...
string CreateApiAppRequest::ToJsonString() const
{
...
string CreateApiAppRequest::GetApiAppName() const
{
    return m_apiAppName;
}

void CreateApiAppRequest::SetApiAppName(const string& _apiAppName)
{
    m_apiAppName = _apiAppName;
    m_apiAppNameHasBeenSet = true;
}

bool CreateApiAppRequest::ApiAppNameHasBeenSet() const
{
    return m_apiAppNameHasBeenSet;
}

string CreateApiAppRequest::GetApiAppDesc() const
{
    return m_apiAppDesc;
}

void CreateApiAppRequest::SetApiAppDesc(const string& _apiAppDesc)
{
    m_apiAppDesc = _apiAppDesc;
    m_apiAppDescHasBeenSet = true;
}

bool CreateApiAppRequest::ApiAppDescHasBeenSet() const
{
