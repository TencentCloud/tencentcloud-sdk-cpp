...
CoreInternalOutcome BindIPStrategyResponse::Deserialize(const string &payload)
{
...
string BindIPStrategyResponse::ToJsonString() const
{
...
bool BindIPStrategyResponse::GetResult() const
{
    return m_result;
}

bool BindIPStrategyResponse::ResultHasBeenSet() const
{
