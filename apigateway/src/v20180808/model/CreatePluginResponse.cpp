...
CoreInternalOutcome CreatePluginResponse::Deserialize(const string &payload)
{
...
string CreatePluginResponse::ToJsonString() const
{
...
Plugin CreatePluginResponse::GetResult() const
{
    return m_result;
}

bool CreatePluginResponse::ResultHasBeenSet() const
{
