...
CoreInternalOutcome DescribeIPStrategyApisStatusResponse::Deserialize(const string &payload)
{
...
string DescribeIPStrategyApisStatusResponse::ToJsonString() const
{
...
IPStrategyApiStatus DescribeIPStrategyApisStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeIPStrategyApisStatusResponse::ResultHasBeenSet() const
{
