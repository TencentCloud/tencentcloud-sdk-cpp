...
DescribeTimerTaskResponse::DescribeTimerTaskResponse() :
    m_taskHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTimerTaskResponse::Deserialize(const string &payload)
{
...
string DescribeTimerTaskResponse::ToJsonString() const
{
...
TimerTask DescribeTimerTaskResponse::GetTask() const
{
    return m_task;
}

bool DescribeTimerTaskResponse::TaskHasBeenSet() const
{
