...
DeleteDocListRequest::DeleteDocListRequest() :
    m_docIdListHasBeenSet(false),
    m_kbIdHasBeenSet(false)
{
}

string DeleteDocListRequest::ToJsonString() const
{
...
vector<string> DeleteDocListRequest::GetDocIdList() const
{
    return m_docIdList;
}

void DeleteDocListRequest::SetDocIdList(const vector<string>& _docIdList)
{
    m_docIdList = _docIdList;
    m_docIdListHasBeenSet = true;
}

bool DeleteDocListRequest::DocIdListHasBeenSet() const
{
    return m_docIdListHasBeenSet;
}

string DeleteDocListRequest::GetKbId() const
{
    return m_kbId;
}

void DeleteDocListRequest::SetKbId(const string& _kbId)
{
    m_kbId = _kbId;
    m_kbIdHasBeenSet = true;
}

bool DeleteDocListRequest::KbIdHasBeenSet() const
{
