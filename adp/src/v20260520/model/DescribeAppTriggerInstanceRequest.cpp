...
string DescribeAppTriggerInstanceRequest::ToJsonString() const
{
...
string DescribeAppTriggerInstanceRequest::GetAppId() const
{
    return m_appId;
}

void DescribeAppTriggerInstanceRequest::SetAppId(const string& _appId)
{
    m_appId = _appId;
    m_appIdHasBeenSet = true;
}

bool DescribeAppTriggerInstanceRequest::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string DescribeAppTriggerInstanceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeAppTriggerInstanceRequest::SetInstanceId(const string& _instanceId)
{
