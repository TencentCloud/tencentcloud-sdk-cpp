...
DescribeSkillCategoryListResponse::DescribeSkillCategoryListResponse() :
    m_categoryListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSkillCategoryListResponse::Deserialize(const string &payload)
{
...
string DescribeSkillCategoryListResponse::ToJsonString() const
{
...
vector<SkillCategory> DescribeSkillCategoryListResponse::GetCategoryList() const
{
    return m_categoryList;
}

bool DescribeSkillCategoryListResponse::CategoryListHasBeenSet() const
{
