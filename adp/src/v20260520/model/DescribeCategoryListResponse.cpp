...
DescribeCategoryListResponse::DescribeCategoryListResponse() :
    m_categoryListHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCategoryListResponse::Deserialize(const string &payload)
{
...
string DescribeCategoryListResponse::ToJsonString() const
{
...
vector<KBCategory> DescribeCategoryListResponse::GetCategoryList() const
{
    return m_categoryList;
}

bool DescribeCategoryListResponse::CategoryListHasBeenSet() const
{
    return m_categoryListHasBeenSet;
}

uint64_t DescribeCategoryListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCategoryListResponse::TotalCountHasBeenSet() const
{
