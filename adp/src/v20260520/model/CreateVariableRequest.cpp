...
string CreateVariableRequest::GetAppId() const
{
    return m_appId;
}

void CreateVariableRequest::SetAppId(const string& _appId)
{
    m_appId = _appId;
    m_appIdHasBeenSet = true;
}

bool CreateVariableRequest::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

Variable CreateVariableRequest::GetVariable() const
{
    return m_variable;
}

void CreateVariableRequest::SetVariable(const Variable& _variable)
{
    m_variable = _variable;
    m_variableHasBeenSet = true;
}

bool CreateVariableRequest::VariableHasBeenSet() const
{
