...
CoreInternalOutcome DescribeLabelResponse::Deserialize(const string &payload)
{
...
string DescribeLabelResponse::ToJsonString() const
{
...
LabelSummary DescribeLabelResponse::GetSummary() const
{
    return m_summary;
}

bool DescribeLabelResponse::SummaryHasBeenSet() const
{
