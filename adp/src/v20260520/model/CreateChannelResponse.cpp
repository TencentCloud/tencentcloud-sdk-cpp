...
CoreInternalOutcome CreateChannelResponse::Deserialize(const string &payload)
{
...
string CreateChannelResponse::ToJsonString() const
{
...
string CreateChannelResponse::GetChannelId() const
{
    return m_channelId;
}

bool CreateChannelResponse::ChannelIdHasBeenSet() const
{
    return m_channelIdHasBeenSet;
}

string CreateChannelResponse::GetQrcodeUrl() const
{
    return m_qrcodeUrl;
}

bool CreateChannelResponse::QrcodeUrlHasBeenSet() const
{
