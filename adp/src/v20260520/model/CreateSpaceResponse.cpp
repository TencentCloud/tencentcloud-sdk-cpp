...
CoreInternalOutcome CreateSpaceResponse::Deserialize(const string &payload)
{
...
string CreateSpaceResponse::ToJsonString() const
{
...
string CreateSpaceResponse::GetSpaceId() const
{
    return m_spaceId;
}

bool CreateSpaceResponse::SpaceIdHasBeenSet() const
{
