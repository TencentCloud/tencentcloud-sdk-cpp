...
CoreInternalOutcome CreateSkillResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SkillId") && !rsp["SkillId"].IsNull())
    {
        if (!rsp["SkillId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `SkillId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_skillId = string(rsp["SkillId"].GetString());
...
string CreateSkillResponse::ToJsonString() const
{
...
string CreateSkillResponse::GetSkillId() const
{
    return m_skillId;
}

bool CreateSkillResponse::SkillIdHasBeenSet() const
{
    return m_skillIdHasBeenSet;
}

string CreateSkillResponse::GetVersionId() const
{
    return m_versionId;
}

bool CreateSkillResponse::VersionIdHasBeenSet() const
{
