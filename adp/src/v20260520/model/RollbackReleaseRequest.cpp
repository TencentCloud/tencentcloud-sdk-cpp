...
string RollbackReleaseRequest::ToJsonString() const
{
...
string RollbackReleaseRequest::GetAppId() const
{
    return m_appId;
}

void RollbackReleaseRequest::SetAppId(const string& _appId)
{
    m_appId = _appId;
    m_appIdHasBeenSet = true;
}

bool RollbackReleaseRequest::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string RollbackReleaseRequest::GetReleaseId() const
{
    return m_releaseId;
}

void RollbackReleaseRequest::SetReleaseId(const string& _releaseId)
{
    m_releaseId = _releaseId;
    m_releaseIdHasBeenSet = true;
}

bool RollbackReleaseRequest::ReleaseIdHasBeenSet() const
{
