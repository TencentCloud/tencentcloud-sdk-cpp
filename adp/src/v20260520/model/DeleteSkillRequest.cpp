...
string DeleteSkillRequest::GetSkillId() const
{
    return m_skillId;
}

void DeleteSkillRequest::SetSkillId(const string& _skillId)
{
    m_skillId = _skillId;
    m_skillIdHasBeenSet = true;
}

bool DeleteSkillRequest::SkillIdHasBeenSet() const
{
    return m_skillIdHasBeenSet;
}

string DeleteSkillRequest::GetSpaceId() const
{
    return m_spaceId;
}

void DeleteSkillRequest::SetSpaceId(const string& _spaceId)
{
    m_spaceId = _spaceId;
    m_spaceIdHasBeenSet = true;
}

bool DeleteSkillRequest::SpaceIdHasBeenSet() const
{
