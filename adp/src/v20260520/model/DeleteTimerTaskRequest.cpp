...
DeleteTimerTaskRequest::DeleteTimerTaskRequest() :
...
string DeleteTimerTaskRequest::ToJsonString() const
{
...
string DeleteTimerTaskRequest::GetSpaceId() const
{
    return m_spaceId;
}

void DeleteTimerTaskRequest::SetSpaceId(const string& _spaceId)
{
    m_spaceId = _spaceId;
    m_spaceIdHasBeenSet = true;
}

bool DeleteTimerTaskRequest::SpaceIdHasBeenSet() const
{
    return m_spaceIdHasBeenSet;
}

string DeleteTimerTaskRequest::GetTimerId() const
{
    return m_timerId;
}

void DeleteTimerTaskRequest::SetTimerId(const string& _timerId)
{
    m_timerId = _timerId;
    m_timerIdHasBeenSet = true;
}

bool DeleteTimerTaskRequest::TimerIdHasBeenSet() const
{
    return m_timerIdHasBeenSet;
}

string DeleteTimerTaskRequest::GetLoginUin() const
{
    return m_loginUin;
}

void DeleteTimerTaskRequest::SetLoginUin(const string& _loginUin)
{
    m_loginUin = _loginUin;
    m_loginUinHasBeenSet = true;
}

bool DeleteTimerTaskRequest::LoginUinHasBeenSet() const
{
    return m_loginUinHasBeenSet;
}

string DeleteTimerTaskRequest::GetLoginSubAccountUin() const
{
    return m_loginSubAccountUin;
}

void DeleteTimerTaskRequest::SetLoginSubAccountUin(const string& _loginSubAccountUin)
{
    m_loginSubAccountUin = _loginSubAccountUin;
    m_loginSubAccountUinHasBeenSet = true;
}

bool DeleteTimerTaskRequest::LoginSubAccountUinHasBeenSet() const
{
