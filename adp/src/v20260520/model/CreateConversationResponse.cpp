...
CoreInternalOutcome CreateConversationResponse::Deserialize(const string &payload)
{
...
string CreateConversationResponse::ToJsonString() const
{
...
string CreateConversationResponse::GetConversationId() const
{
    return m_conversationId;
}

bool CreateConversationResponse::ConversationIdHasBeenSet() const
{
