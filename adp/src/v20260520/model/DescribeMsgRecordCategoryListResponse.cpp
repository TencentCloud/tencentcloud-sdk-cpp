...
DescribeMsgRecordCategoryListResponse::DescribeMsgRecordCategoryListResponse() :
    m_categoryListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeMsgRecordCategoryListResponse::Deserialize(const string &payload)
{
...
string DescribeMsgRecordCategoryListResponse::ToJsonString() const
{
...
vector<MsgRecordCategory> DescribeMsgRecordCategoryListResponse::GetCategoryList() const
{
    return m_categoryList;
}

bool DescribeMsgRecordCategoryListResponse::CategoryListHasBeenSet() const
{
