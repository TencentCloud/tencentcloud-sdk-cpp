...
string DeleteChannelRequest::GetAppId() const
{
    return m_appId;
}

void DeleteChannelRequest::SetAppId(const string& _appId)
{
    m_appId = _appId;
    m_appIdHasBeenSet = true;
}

bool DeleteChannelRequest::AppIdHasBeenSet() const
{
...
int64_t DeleteChannelRequest::GetScene() const
{
    return m_scene;
}

void DeleteChannelRequest::SetScene(const int64_t& _scene)
{
    m_scene = _scene;
    m_sceneHasBeenSet = true;
}

bool DeleteChannelRequest::SceneHasBeenSet() const
{
