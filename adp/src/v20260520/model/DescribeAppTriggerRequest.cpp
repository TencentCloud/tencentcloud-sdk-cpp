...
string DescribeAppTriggerRequest::ToJsonString() const
{
...
string DescribeAppTriggerRequest::GetAppId() const
{
    return m_appId;
}

void DescribeAppTriggerRequest::SetAppId(const string& _appId)
{
    m_appId = _appId;
    m_appIdHasBeenSet = true;
}

bool DescribeAppTriggerRequest::AppIdHasBeenSet() const
{
...
void DescribeAppTriggerRequest::SetTriggerId(const string& _triggerId)
{
