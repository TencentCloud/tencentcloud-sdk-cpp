...
DescribeTimerTaskSummaryListResponse::DescribeTimerTaskSummaryListResponse() :
    m_taskListHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTimerTaskSummaryListResponse::Deserialize(const string &payload)
{
...
string DescribeTimerTaskSummaryListResponse::ToJsonString() const
{
...
vector<TimerTaskSummary> DescribeTimerTaskSummaryListResponse::GetTaskList() const
{
    return m_taskList;
}

bool DescribeTimerTaskSummaryListResponse::TaskListHasBeenSet() const
{
    return m_taskListHasBeenSet;
}

string DescribeTimerTaskSummaryListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTimerTaskSummaryListResponse::TotalCountHasBeenSet() const
{
