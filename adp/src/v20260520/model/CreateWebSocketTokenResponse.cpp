...
CoreInternalOutcome CreateWebSocketTokenResponse::Deserialize(const string &payload)
{
...
string CreateWebSocketTokenResponse::ToJsonString() const
{
...
string CreateWebSocketTokenResponse::GetAppId() const
{
    return m_appId;
}

bool CreateWebSocketTokenResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateWebSocketTokenResponse::GetToken() const
{
    return m_token;
}
