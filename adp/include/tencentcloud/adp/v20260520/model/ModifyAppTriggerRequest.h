...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_MODIFYAPPTRIGGERREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_MODIFYAPPTRIGGERREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class ModifyAppTriggerRequest : public AbstractModel
                {
                public:
                    ModifyAppTriggerRequest();
                    ~ModifyAppTriggerRequest() = default;
                     ...
                     * 
                     */
                    void SetTrigger(const AppTrigger& _trigger);
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_MODIFYAPPTRIGGERREQUEST_H_
