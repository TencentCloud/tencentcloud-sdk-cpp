...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_APIPLUGINCONFIG_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_APIPLUGINCONFIG_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                * API插件配置
                */
                class ApiPluginConfig : public AbstractModel
                {
                public:
                    ApiPluginConfig();
                    ~ApiPluginConfig() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_APIPLUGINCONFIG_H_
