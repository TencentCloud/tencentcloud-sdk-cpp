...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_RUNTIMERTASKNOWREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_RUNTIMERTASKNOWREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class RunTimerTaskNowRequest : public AbstractModel
                {
                public:
                    RunTimerTaskNowRequest();
                    ~RunTimerTaskNowRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_RUNTIMERTASKNOWREQUEST_H_
