...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_RESETCONVERSATIONREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_RESETCONVERSATIONREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class ResetConversationRequest : public AbstractModel
                {
                public:
                    ResetConversationRequest();
                    ~ResetConversationRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_RESETCONVERSATIONREQUEST_H_
