...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBETIMERTASKREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBETIMERTASKREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeTimerTaskRequest : public AbstractModel
                {
                public:
                    DescribeTimerTaskRequest();
                    ~DescribeTimerTaskRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBETIMERTASKREQUEST_H_
