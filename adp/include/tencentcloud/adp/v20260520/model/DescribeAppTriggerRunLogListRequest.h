...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERRUNLOGLISTREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERRUNLOGLISTREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeAppTriggerRunLogListRequest : public AbstractModel
                {
                public:
                    DescribeAppTriggerRunLogListRequest();
                    ~DescribeAppTriggerRunLogListRequest() = default;
                    ...
                    /**
                     * 获取<p>每页数据量</p><p>取值范围：[1, 100]</p>
                     * @return PageSize <p>每页数据量</p><p>取值范围：[1, 100]</p>
                     * 
                     */
                    uint64_t GetPageSize() const;

                    /**
                     * 设置<p>每页数据量</p><p>取值范围：[1, 100]</p>
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERRUNLOGLISTREQUEST_H_
