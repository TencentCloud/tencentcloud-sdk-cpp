...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWORKSPACECREDENTIALREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWORKSPACECREDENTIALREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class CreateWorkspaceCredentialRequest : public AbstractModel
                {
                public:
                    CreateWorkspaceCredentialRequest();
                    ~CreateWorkspaceCredentialRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWORKSPACECREDENTIALREQUEST_H_
