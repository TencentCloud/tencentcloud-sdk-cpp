...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeAppTriggerRequest : public AbstractModel
                {
                public:
                    DescribeAppTriggerRequest();
                    ~DescribeAppTriggerRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBEAPPTRIGGERREQUEST_H_
