...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_FAVORITESKILLREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_FAVORITESKILLREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class FavoriteSkillRequest : public AbstractModel
                {
                public:
                    FavoriteSkillRequest();
                    ~FavoriteSkillRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_FAVORITESKILLREQUEST_H_
