...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBELABELSUMMARYLISTREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBELABELSUMMARYLISTREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeLabelSummaryListRequest : public AbstractModel
                {
                public:
                    DescribeLabelSummaryListRequest();
                    ~DescribeLabelSummaryListRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBELABELSUMMARYLISTREQUEST_H_
