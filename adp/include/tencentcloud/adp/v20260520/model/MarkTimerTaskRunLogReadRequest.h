...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_MARKTIMERTASKRUNLOGREADREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_MARKTIMERTASKRUNLOGREADREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class MarkTimerTaskRunLogReadRequest : public AbstractModel
                {
                public:
                    MarkTimerTaskRunLogReadRequest();
                    ~MarkTimerTaskRunLogReadRequest() = default;
                     ...
                     * 
                     */
                    std::vector<std::string> GetFireInstanceIdList() const;
                     ...
                     * 
                     */
                    void SetFireInstanceIdList(const std::vector<std::string>& _fireInstanceIdList);

                    /**
                     * 判断参数 FireInstanceIdList 是否已赋值
                     * @return FireInstanceIdList 是否已赋值
                     * 
                     */
                    bool FireInstanceIdListHasBeenSet() const;
                ...
                private:
                     ...
                     * 实例列表
                     */
                    std::vector<std::string> m_fireInstanceIdList;
                    bool m_fireInstanceIdListHasBeenSet;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_MARKTIMERTASKRUNLOGREADREQUEST_H_
