...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DELETEDOCLISTREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DELETEDOCLISTREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DeleteDocListRequest : public AbstractModel
                {
                public:
                    DeleteDocListRequest();
                    ~DeleteDocListRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>待删除的文档 ID 列表（数量：1~20）</p>
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DELETEDOCLISTREQUEST_H_
