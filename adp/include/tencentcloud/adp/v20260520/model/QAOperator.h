...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_QAOPERATOR_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_QAOPERATOR_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                * QA 操作者信息
                */
                class QAOperator : public AbstractModel
                {
                public:
                    QAOperator();
                    ~QAOperator() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    QAPermission GetPermission() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetPermission(const QAPermission& _permission);
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_QAOPERATOR_H_
