...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_PAUSETIMERTASKREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_PAUSETIMERTASKREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class PauseTimerTaskRequest : public AbstractModel
                {
                public:
                    PauseTimerTaskRequest();
                    ~PauseTimerTaskRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_PAUSETIMERTASKREQUEST_H_
