...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWEBSOCKETTOKENREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWEBSOCKETTOKENREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class CreateWebSocketTokenRequest : public AbstractModel
                {
                public:
                    CreateWebSocketTokenRequest();
                    ~CreateWebSocketTokenRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_CREATEWEBSOCKETTOKENREQUEST_H_
