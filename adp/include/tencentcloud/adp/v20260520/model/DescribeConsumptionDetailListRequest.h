...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBECONSUMPTIONDETAILLISTREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBECONSUMPTIONDETAILLISTREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeConsumptionDetailListRequest : public AbstractModel
                {
                public:
                    DescribeConsumptionDetailListRequest();
                    ~DescribeConsumptionDetailListRequest() = default;
                    ...
                    /**
                     * 获取<p>扩展过滤。Filter 组合规则：多项 AND，同项 value_list OR。支持 Name：metric_source_type（METRIC_SOURCE_TYPE_* 或整数）、source_ids（多选来源ID）、resource_id/source_id（单选来源ID，source_ids 未传时生效）、space_id、user_id</p>
                    ...
                    /**
                     * 设置<p>扩展过滤。Filter 组合规则：多项 AND，同项 value_list OR。支持 Name：metric_source_type（METRIC_SOURCE_TYPE_* 或整数）、source_ids（多选来源ID）、resource_id/source_id（单选来源ID，source_ids 未传时生效）、space_id、user_id</p>
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBECONSUMPTIONDETAILLISTREQUEST_H_
