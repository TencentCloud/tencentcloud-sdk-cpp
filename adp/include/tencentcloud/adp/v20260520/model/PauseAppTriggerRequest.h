...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_PAUSEAPPTRIGGERREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_PAUSEAPPTRIGGERREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class PauseAppTriggerRequest : public AbstractModel
                {
                public:
                    PauseAppTriggerRequest();
                    ~PauseAppTriggerRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_PAUSEAPPTRIGGERREQUEST_H_
