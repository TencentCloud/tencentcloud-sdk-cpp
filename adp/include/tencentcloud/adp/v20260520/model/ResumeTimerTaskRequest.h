...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_RESUMETIMERTASKREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_RESUMETIMERTASKREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class ResumeTimerTaskRequest : public AbstractModel
                {
                public:
                    ResumeTimerTaskRequest();
                    ~ResumeTimerTaskRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_RESUMETIMERTASKREQUEST_H_
