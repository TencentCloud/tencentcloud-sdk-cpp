...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DELETESKILLREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DELETESKILLREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                * DeleteSkill请求参数结构体
                */
                class DeleteSkillRequest : public AbstractModel
                {
                public:
                    DeleteSkillRequest();
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DELETESKILLREQUEST_H_
