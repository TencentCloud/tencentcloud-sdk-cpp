...
#ifndef TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBESKILLREFERENCELISTREQUEST_H_
#define TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBESKILLREFERENCELISTREQUEST_H_
    ...
    namespace Adp
    {
        namespace V20260520
        {
            namespace Model
            {
                ...
                */
                class DescribeSkillReferenceListRequest : public AbstractModel
                {
                public:
                    DescribeSkillReferenceListRequest();
                    ~DescribeSkillReferenceListRequest() = default;
...
#endif // !TENCENTCLOUD_ADP_V20260520_MODEL_DESCRIBESKILLREFERENCELISTREQUEST_H_
