...
#ifndef TENCENTCLOUD_CMQ_V20190304_MODEL_DELETESUBSCRIBEREQUEST_H_
#define TENCENTCLOUD_CMQ_V20190304_MODEL_DELETESUBSCRIBEREQUEST_H_
    ...
    namespace Cmq
    {
        namespace V20190304
        {
            namespace Model
            {
                ...
                */
                class DeleteSubscribeRequest : public AbstractModel
                {
                public:
                    DeleteSubscribeRequest();
                    ~DeleteSubscribeRequest() = default;
...
#endif // !TENCENTCLOUD_CMQ_V20190304_MODEL_DELETESUBSCRIBEREQUEST_H_
