...
CoreInternalOutcome DescribeQueueDetailResponse::Deserialize(const string &payload)
{
...
string DescribeQueueDetailResponse::ToJsonString() const
{
...
uint64_t DescribeQueueDetailResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeQueueDetailResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<QueueSet> DescribeQueueDetailResponse::GetQueueSet() const
{
    return m_queueSet;
}

bool DescribeQueueDetailResponse::QueueSetHasBeenSet() const
{
