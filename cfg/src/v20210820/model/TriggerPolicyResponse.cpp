...
CoreInternalOutcome TriggerPolicyResponse::Deserialize(const string &payload)
{
...
string TriggerPolicyResponse::ToJsonString() const
{
...
int64_t TriggerPolicyResponse::GetTaskId() const
{
    return m_taskId;
}

bool TriggerPolicyResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

bool TriggerPolicyResponse::GetSuccess() const
{
    return m_success;
}

bool TriggerPolicyResponse::SuccessHasBeenSet() const
{
