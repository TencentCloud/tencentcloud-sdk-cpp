...
vector<TaskListItem> DescribeTaskListResponse::GetTaskList() const
{
    return m_taskList;
}

bool DescribeTaskListResponse::TaskListHasBeenSet() const
{
    return m_taskListHasBeenSet;
}

int64_t DescribeTaskListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeTaskListResponse::TotalHasBeenSet() const
{
