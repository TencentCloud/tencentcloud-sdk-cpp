...
CoreInternalOutcome CreateTaskFromTemplateResponse::Deserialize(const string &payload)
{
...
string CreateTaskFromTemplateResponse::ToJsonString() const
{
...
uint64_t CreateTaskFromTemplateResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateTaskFromTemplateResponse::TaskIdHasBeenSet() const
{
