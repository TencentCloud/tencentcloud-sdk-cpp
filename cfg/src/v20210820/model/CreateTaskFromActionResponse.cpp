...
CoreInternalOutcome CreateTaskFromActionResponse::Deserialize(const string &payload)
{
...
string CreateTaskFromActionResponse::ToJsonString() const
{
...
uint64_t CreateTaskFromActionResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateTaskFromActionResponse::TaskIdHasBeenSet() const
{
