...
CoreInternalOutcome DescribeTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeTemplateResponse::ToJsonString() const
{
...
Template DescribeTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool DescribeTemplateResponse::TemplateHasBeenSet() const
{
