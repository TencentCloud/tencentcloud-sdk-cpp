...
CoreInternalOutcome DescribeActionLibraryListResponse::Deserialize(const string &payload)
{
...
string DescribeActionLibraryListResponse::ToJsonString() const
{
...
vector<ActionLibraryListResult> DescribeActionLibraryListResponse::GetResults() const
{
    return m_results;
}

bool DescribeActionLibraryListResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

uint64_t DescribeActionLibraryListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeActionLibraryListResponse::TotalHasBeenSet() const
{
