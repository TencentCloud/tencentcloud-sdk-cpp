...
string DescribeSubProjectRequest::ToJsonString() const
{
...
string DescribeSubProjectRequest::GetSubProjectId() const
{
    return m_subProjectId;
}

void DescribeSubProjectRequest::SetSubProjectId(const string& _subProjectId)
{
    m_subProjectId = _subProjectId;
    m_subProjectIdHasBeenSet = true;
}

bool DescribeSubProjectRequest::SubProjectIdHasBeenSet() const
{
