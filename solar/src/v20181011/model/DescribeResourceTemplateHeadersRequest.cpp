...
string DescribeResourceTemplateHeadersRequest::ToJsonString() const
{
...
string DescribeResourceTemplateHeadersRequest::GetWxAppId() const
{
    return m_wxAppId;
}

void DescribeResourceTemplateHeadersRequest::SetWxAppId(const string& _wxAppId)
{
    m_wxAppId = _wxAppId;
    m_wxAppIdHasBeenSet = true;
}

bool DescribeResourceTemplateHeadersRequest::WxAppIdHasBeenSet() const
{
