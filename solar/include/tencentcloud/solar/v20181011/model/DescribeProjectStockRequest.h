...
#ifndef TENCENTCLOUD_SOLAR_V20181011_MODEL_DESCRIBEPROJECTSTOCKREQUEST_H_
#define TENCENTCLOUD_SOLAR_V20181011_MODEL_DESCRIBEPROJECTSTOCKREQUEST_H_
    ...
    namespace Solar
    {
        namespace V20181011
        {
            namespace Model
            {
                ...
                */
                class DescribeProjectStockRequest : public AbstractModel
                {
                public:
                    DescribeProjectStockRequest();
                    ~DescribeProjectStockRequest() = default;
...
#endif // !TENCENTCLOUD_SOLAR_V20181011_MODEL_DESCRIBEPROJECTSTOCKREQUEST_H_
