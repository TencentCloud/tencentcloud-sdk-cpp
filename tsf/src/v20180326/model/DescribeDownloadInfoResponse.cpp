...
CoreInternalOutcome DescribeDownloadInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDownloadInfoResponse::ToJsonString() const
{
...
CosDownloadInfo DescribeDownloadInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeDownloadInfoResponse::ResultHasBeenSet() const
{
