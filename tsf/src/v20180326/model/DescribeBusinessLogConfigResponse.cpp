...
CoreInternalOutcome DescribeBusinessLogConfigResponse::Deserialize(const string &payload)
{
...
string DescribeBusinessLogConfigResponse::ToJsonString() const
{
...
BusinessLogConfig DescribeBusinessLogConfigResponse::GetResult() const
{
    return m_result;
}

bool DescribeBusinessLogConfigResponse::ResultHasBeenSet() const
{
