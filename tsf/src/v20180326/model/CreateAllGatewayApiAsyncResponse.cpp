...
CoreInternalOutcome CreateAllGatewayApiAsyncResponse::Deserialize(const string &payload)
{
...
string CreateAllGatewayApiAsyncResponse::ToJsonString() const
{
...
bool CreateAllGatewayApiAsyncResponse::GetResult() const
{
    return m_result;
}

bool CreateAllGatewayApiAsyncResponse::ResultHasBeenSet() const
{
