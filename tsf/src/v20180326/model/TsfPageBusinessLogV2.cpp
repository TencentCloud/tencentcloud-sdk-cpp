...
CoreInternalOutcome TsfPageBusinessLogV2::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TotalCount") && !value["TotalCount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TsfPageBusinessLogV2.TotalCount` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Content") && !value["Content"].IsNull())
    {
        if (!value["Content"].IsArray())
            return CoreInternalOutcome(Error("response `TsfPageBusinessLogV2.Content` is not array type"));
    ...
    if (value.HasMember("ScrollId") && !value["ScrollId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TsfPageBusinessLogV2.ScrollId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Status") && !value["Status"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TsfPageBusinessLogV2.Status` IsString=false incorrectly").SetRequestId(requestId));
        }
