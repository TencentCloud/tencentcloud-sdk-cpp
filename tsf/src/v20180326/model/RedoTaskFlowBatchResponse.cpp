...
CoreInternalOutcome RedoTaskFlowBatchResponse::Deserialize(const string &payload)
{
...
string RedoTaskFlowBatchResponse::ToJsonString() const
{
...
string RedoTaskFlowBatchResponse::GetResult() const
{
    return m_result;
}

bool RedoTaskFlowBatchResponse::ResultHasBeenSet() const
{
