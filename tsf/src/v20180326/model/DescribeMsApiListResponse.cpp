...
CoreInternalOutcome DescribeMsApiListResponse::Deserialize(const string &payload)
{
...
string DescribeMsApiListResponse::ToJsonString() const
{
...
TsfApiListResponse DescribeMsApiListResponse::GetResult() const
{
    return m_result;
}

bool DescribeMsApiListResponse::ResultHasBeenSet() const
{
