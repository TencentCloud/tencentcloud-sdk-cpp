...
CoreInternalOutcome CreateProgramResponse::Deserialize(const string &payload)
{
...
string CreateProgramResponse::ToJsonString() const
{
...
bool CreateProgramResponse::GetResult() const
{
    return m_result;
}

bool CreateProgramResponse::ResultHasBeenSet() const
{
