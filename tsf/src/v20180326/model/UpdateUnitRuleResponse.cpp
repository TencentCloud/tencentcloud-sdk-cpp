...
CoreInternalOutcome UpdateUnitRuleResponse::Deserialize(const string &payload)
{
...
string UpdateUnitRuleResponse::ToJsonString() const
{
...
bool UpdateUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool UpdateUnitRuleResponse::ResultHasBeenSet() const
{
