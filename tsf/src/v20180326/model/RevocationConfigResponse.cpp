...
CoreInternalOutcome RevocationConfigResponse::Deserialize(const string &payload)
{
...
string RevocationConfigResponse::ToJsonString() const
{
...
bool RevocationConfigResponse::GetResult() const
{
    return m_result;
}

bool RevocationConfigResponse::ResultHasBeenSet() const
{
