...
CoreInternalOutcome DescribePluginInstancesResponse::Deserialize(const string &payload)
{
...
string DescribePluginInstancesResponse::ToJsonString() const
{
...
TsfPageGatewayPlugin DescribePluginInstancesResponse::GetResult() const
{
    return m_result;
}

bool DescribePluginInstancesResponse::ResultHasBeenSet() const
{
