...
CoreInternalOutcome DescribePkgsResponse::Deserialize(const string &payload)
{
...
string DescribePkgsResponse::ToJsonString() const
{
...
PkgList DescribePkgsResponse::GetResult() const
{
    return m_result;
}

bool DescribePkgsResponse::ResultHasBeenSet() const
{
