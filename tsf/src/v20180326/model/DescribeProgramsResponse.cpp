...
CoreInternalOutcome DescribeProgramsResponse::Deserialize(const string &payload)
{
...
string DescribeProgramsResponse::ToJsonString() const
{
...
PagedProgram DescribeProgramsResponse::GetResult() const
{
    return m_result;
}

bool DescribeProgramsResponse::ResultHasBeenSet() const
{
