...
CoreInternalOutcome DescribeEnabledUnitRuleResponse::Deserialize(const string &payload)
{
...
string DescribeEnabledUnitRuleResponse::ToJsonString() const
{
...
UnitRule DescribeEnabledUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool DescribeEnabledUnitRuleResponse::ResultHasBeenSet() const
{
