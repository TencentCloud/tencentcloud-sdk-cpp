...
CoreInternalOutcome DescribeTaskLastStatusResponse::Deserialize(const string &payload)
{
...
string DescribeTaskLastStatusResponse::ToJsonString() const
{
...
TaskLastExecuteStatus DescribeTaskLastStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeTaskLastStatusResponse::ResultHasBeenSet() const
{
