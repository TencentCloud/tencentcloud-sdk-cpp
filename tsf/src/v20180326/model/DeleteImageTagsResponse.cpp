...
CoreInternalOutcome DeleteImageTagsResponse::Deserialize(const string &payload)
{
...
string DeleteImageTagsResponse::ToJsonString() const
{
...
bool DeleteImageTagsResponse::GetResult() const
{
    return m_result;
}

bool DeleteImageTagsResponse::ResultHasBeenSet() const
{
