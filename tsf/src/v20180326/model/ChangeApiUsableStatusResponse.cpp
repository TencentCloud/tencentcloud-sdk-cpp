...
CoreInternalOutcome ChangeApiUsableStatusResponse::Deserialize(const string &payload)
{
...
string ChangeApiUsableStatusResponse::ToJsonString() const
{
...
ApiDetailInfo ChangeApiUsableStatusResponse::GetResult() const
{
    return m_result;
}

bool ChangeApiUsableStatusResponse::ResultHasBeenSet() const
{
