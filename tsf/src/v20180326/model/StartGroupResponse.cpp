...
CoreInternalOutcome StartGroupResponse::Deserialize(const string &payload)
{
...
string StartGroupResponse::ToJsonString() const
{
...
TaskId StartGroupResponse::GetResult() const
{
    return m_result;
}

bool StartGroupResponse::ResultHasBeenSet() const
{
