...
CoreInternalOutcome FieldRef::Deserialize(const Value &value)
{
    string requestId = "";
...
void FieldRef::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_fieldPathHasBeenSet)
    {
        ...
        value.AddMember(iKey, Value(m_fieldPath.c_str(), allocator).Move(), allocator);
    }
