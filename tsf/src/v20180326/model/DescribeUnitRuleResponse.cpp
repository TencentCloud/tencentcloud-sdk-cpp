...
CoreInternalOutcome DescribeUnitRuleResponse::Deserialize(const string &payload)
{
...
string DescribeUnitRuleResponse::ToJsonString() const
{
...
UnitRule DescribeUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool DescribeUnitRuleResponse::ResultHasBeenSet() const
{
