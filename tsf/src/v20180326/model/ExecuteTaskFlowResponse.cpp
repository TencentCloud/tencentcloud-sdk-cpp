...
CoreInternalOutcome ExecuteTaskFlowResponse::Deserialize(const string &payload)
{
...
string ExecuteTaskFlowResponse::ToJsonString() const
{
...
string ExecuteTaskFlowResponse::GetResult() const
{
    return m_result;
}

bool ExecuteTaskFlowResponse::ResultHasBeenSet() const
{
