...
CoreInternalOutcome DescribeServerlessGroupResponse::Deserialize(const string &payload)
{
...
string DescribeServerlessGroupResponse::ToJsonString() const
{
...
ServerlessGroup DescribeServerlessGroupResponse::GetResult() const
{
    return m_result;
}

bool DescribeServerlessGroupResponse::ResultHasBeenSet() const
{
