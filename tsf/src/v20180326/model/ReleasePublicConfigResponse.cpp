...
CoreInternalOutcome ReleasePublicConfigResponse::Deserialize(const string &payload)
{
...
string ReleasePublicConfigResponse::ToJsonString() const
{
...
bool ReleasePublicConfigResponse::GetResult() const
{
    return m_result;
}

bool ReleasePublicConfigResponse::ResultHasBeenSet() const
{
