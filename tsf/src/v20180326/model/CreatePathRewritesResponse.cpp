...
CoreInternalOutcome CreatePathRewritesResponse::Deserialize(const string &payload)
{
...
string CreatePathRewritesResponse::ToJsonString() const
{
...
bool CreatePathRewritesResponse::GetResult() const
{
    return m_result;
}

bool CreatePathRewritesResponse::ResultHasBeenSet() const
{
