...
CoreInternalOutcome DescribePublicConfigSummaryResponse::Deserialize(const string &payload)
{
...
string DescribePublicConfigSummaryResponse::ToJsonString() const
{
...
TsfPageConfig DescribePublicConfigSummaryResponse::GetResult() const
{
    return m_result;
}

bool DescribePublicConfigSummaryResponse::ResultHasBeenSet() const
{
