...
CoreInternalOutcome EnableUnitRouteResponse::Deserialize(const string &payload)
{
...
string EnableUnitRouteResponse::ToJsonString() const
{
...
bool EnableUnitRouteResponse::GetResult() const
{
    return m_result;
}

bool EnableUnitRouteResponse::ResultHasBeenSet() const
{
