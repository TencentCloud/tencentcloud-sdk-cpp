...
CoreInternalOutcome ModifyMicroserviceResponse::Deserialize(const string &payload)
{
...
string ModifyMicroserviceResponse::ToJsonString() const
{
...
bool ModifyMicroserviceResponse::GetResult() const
{
    return m_result;
}

bool ModifyMicroserviceResponse::ResultHasBeenSet() const
{
