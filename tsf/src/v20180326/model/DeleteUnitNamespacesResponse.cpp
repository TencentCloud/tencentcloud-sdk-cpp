...
CoreInternalOutcome DeleteUnitNamespacesResponse::Deserialize(const string &payload)
{
...
string DeleteUnitNamespacesResponse::ToJsonString() const
{
...
bool DeleteUnitNamespacesResponse::GetResult() const
{
    return m_result;
}

bool DeleteUnitNamespacesResponse::ResultHasBeenSet() const
{
