...
CoreInternalOutcome DescribeSimpleNamespacesResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleNamespacesResponse::ToJsonString() const
{
...
TsfPageNamespace DescribeSimpleNamespacesResponse::GetResult() const
{
    return m_result;
}

bool DescribeSimpleNamespacesResponse::ResultHasBeenSet() const
{
