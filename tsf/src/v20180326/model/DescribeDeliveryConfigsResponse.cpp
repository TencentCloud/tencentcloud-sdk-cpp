...
CoreInternalOutcome DescribeDeliveryConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeDeliveryConfigsResponse::ToJsonString() const
{
...
DeliveryConfigBindGroups DescribeDeliveryConfigsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDeliveryConfigsResponse::ResultHasBeenSet() const
{
