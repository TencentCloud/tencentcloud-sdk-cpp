...
CoreInternalOutcome DeleteApiGroupResponse::Deserialize(const string &payload)
{
...
string DeleteApiGroupResponse::ToJsonString() const
{
...
bool DeleteApiGroupResponse::GetResult() const
{
    return m_result;
}

bool DeleteApiGroupResponse::ResultHasBeenSet() const
{
