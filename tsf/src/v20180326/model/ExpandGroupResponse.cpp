...
CoreInternalOutcome ExpandGroupResponse::Deserialize(const string &payload)
{
...
string ExpandGroupResponse::ToJsonString() const
{
...
TaskId ExpandGroupResponse::GetResult() const
{
    return m_result;
}

bool ExpandGroupResponse::ResultHasBeenSet() const
{
