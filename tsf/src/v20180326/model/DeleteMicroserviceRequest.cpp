...
string DeleteMicroserviceRequest::ToJsonString() const
{
...
string DeleteMicroserviceRequest::GetMicroserviceId() const
{
    return m_microserviceId;
}

void DeleteMicroserviceRequest::SetMicroserviceId(const string& _microserviceId)
{
    m_microserviceId = _microserviceId;
    m_microserviceIdHasBeenSet = true;
}

bool DeleteMicroserviceRequest::MicroserviceIdHasBeenSet() const
{
