...
string RevokeFileConfigRequest::ToJsonString() const
{
...
string RevokeFileConfigRequest::GetConfigReleaseId() const
{
    return m_configReleaseId;
}

void RevokeFileConfigRequest::SetConfigReleaseId(const string& _configReleaseId)
{
    m_configReleaseId = _configReleaseId;
    m_configReleaseIdHasBeenSet = true;
}

bool RevokeFileConfigRequest::ConfigReleaseIdHasBeenSet() const
{
