...
string DescribePathRewriteRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_pathRewriteIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_pathRewriteId.c_str(), allocator).Move(), allocator);
    }
...
string DescribePathRewriteRequest::GetPathRewriteId() const
{
    return m_pathRewriteId;
}

void DescribePathRewriteRequest::SetPathRewriteId(const string& _pathRewriteId)
{
    m_pathRewriteId = _pathRewriteId;
    m_pathRewriteIdHasBeenSet = true;
}

bool DescribePathRewriteRequest::PathRewriteIdHasBeenSet() const
{
