...
CoreInternalOutcome DescribeGroupReleaseResponse::Deserialize(const string &payload)
{
...
string DescribeGroupReleaseResponse::ToJsonString() const
{
...
GroupRelease DescribeGroupReleaseResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupReleaseResponse::ResultHasBeenSet() const
{
