...
CoreInternalOutcome DescribeUnitRulesResponse::Deserialize(const string &payload)
{
...
string DescribeUnitRulesResponse::ToJsonString() const
{
...
vector<TsfPageUnitRule> DescribeUnitRulesResponse::GetResult() const
{
    return m_result;
}

bool DescribeUnitRulesResponse::ResultHasBeenSet() const
{
