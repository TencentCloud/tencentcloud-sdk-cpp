...
CoreInternalOutcome ReleaseApiGroupResponse::Deserialize(const string &payload)
{
...
string ReleaseApiGroupResponse::ToJsonString() const
{
...
bool ReleaseApiGroupResponse::GetResult() const
{
    return m_result;
}

bool ReleaseApiGroupResponse::ResultHasBeenSet() const
{
