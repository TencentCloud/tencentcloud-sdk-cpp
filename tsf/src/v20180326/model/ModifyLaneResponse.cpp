...
CoreInternalOutcome ModifyLaneResponse::Deserialize(const string &payload)
{
...
string ModifyLaneResponse::ToJsonString() const
{
...
bool ModifyLaneResponse::GetResult() const
{
    return m_result;
}

bool ModifyLaneResponse::ResultHasBeenSet() const
{
