...
CoreInternalOutcome ResourceFieldRef::Deserialize(const Value &value)
{
    string requestId = "";
...
void ResourceFieldRef::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
