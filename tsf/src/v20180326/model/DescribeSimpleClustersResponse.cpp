...
CoreInternalOutcome DescribeSimpleClustersResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleClustersResponse::ToJsonString() const
{
...
TsfPageCluster DescribeSimpleClustersResponse::GetResult() const
{
    return m_result;
}

bool DescribeSimpleClustersResponse::ResultHasBeenSet() const
{
