...
CoreInternalOutcome CreateContainGroupResponse::Deserialize(const string &payload)
{
...
string CreateContainGroupResponse::ToJsonString() const
{
...
string CreateContainGroupResponse::GetResult() const
{
    return m_result;
}

bool CreateContainGroupResponse::ResultHasBeenSet() const
{
