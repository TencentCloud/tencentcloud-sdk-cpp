...
CoreInternalOutcome DescribeContainerGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeContainerGroupsResponse::ToJsonString() const
{
...
ContainGroupResult DescribeContainerGroupsResponse::GetResult() const
{
    return m_result;
}

bool DescribeContainerGroupsResponse::ResultHasBeenSet() const
{
