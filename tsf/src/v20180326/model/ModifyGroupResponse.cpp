...
CoreInternalOutcome ModifyGroupResponse::Deserialize(const string &payload)
{
...
string ModifyGroupResponse::ToJsonString() const
{
...
bool ModifyGroupResponse::GetResult() const
{
    return m_result;
}

bool ModifyGroupResponse::ResultHasBeenSet() const
{
