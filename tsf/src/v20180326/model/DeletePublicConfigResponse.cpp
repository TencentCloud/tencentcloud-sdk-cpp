...
CoreInternalOutcome DeletePublicConfigResponse::Deserialize(const string &payload)
{
...
string DeletePublicConfigResponse::ToJsonString() const
{
...
bool DeletePublicConfigResponse::GetResult() const
{
    return m_result;
}

bool DeletePublicConfigResponse::ResultHasBeenSet() const
{
