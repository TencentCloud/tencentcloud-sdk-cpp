...
CoreInternalOutcome DeleteContainerGroupResponse::Deserialize(const string &payload)
{
...
string DeleteContainerGroupResponse::ToJsonString() const
{
...
bool DeleteContainerGroupResponse::GetResult() const
{
    return m_result;
}

bool DeleteContainerGroupResponse::ResultHasBeenSet() const
{
