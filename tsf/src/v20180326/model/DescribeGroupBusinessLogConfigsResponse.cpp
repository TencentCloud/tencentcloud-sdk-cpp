...
CoreInternalOutcome DescribeGroupBusinessLogConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeGroupBusinessLogConfigsResponse::ToJsonString() const
{
...
TsfPageBusinessLogConfig DescribeGroupBusinessLogConfigsResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupBusinessLogConfigsResponse::ResultHasBeenSet() const
{
