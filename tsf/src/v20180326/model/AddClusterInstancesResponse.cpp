...
CoreInternalOutcome AddClusterInstancesResponse::Deserialize(const string &payload)
{
...
string AddClusterInstancesResponse::ToJsonString() const
{
...
AddInstanceResult AddClusterInstancesResponse::GetResult() const
{
    return m_result;
}

bool AddClusterInstancesResponse::ResultHasBeenSet() const
{
