...
CoreInternalOutcome DescribeBasicResourceUsageResponse::Deserialize(const string &payload)
{
...
string DescribeBasicResourceUsageResponse::ToJsonString() const
{
...
OverviewBasicResourceUsage DescribeBasicResourceUsageResponse::GetResult() const
{
    return m_result;
}

bool DescribeBasicResourceUsageResponse::ResultHasBeenSet() const
{
