...
CoreInternalOutcome DescribePodInstancesResponse::Deserialize(const string &payload)
{
...
string DescribePodInstancesResponse::ToJsonString() const
{
...
GroupPodResult DescribePodInstancesResponse::GetResult() const
{
    return m_result;
}

bool DescribePodInstancesResponse::ResultHasBeenSet() const
{
