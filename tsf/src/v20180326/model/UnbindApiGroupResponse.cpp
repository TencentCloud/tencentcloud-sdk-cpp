...
CoreInternalOutcome UnbindApiGroupResponse::Deserialize(const string &payload)
{
...
string UnbindApiGroupResponse::ToJsonString() const
{
...
bool UnbindApiGroupResponse::GetResult() const
{
    return m_result;
}

bool UnbindApiGroupResponse::ResultHasBeenSet() const
{
