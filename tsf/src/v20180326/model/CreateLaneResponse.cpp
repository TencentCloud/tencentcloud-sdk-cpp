...
CoreInternalOutcome CreateLaneResponse::Deserialize(const string &payload)
{
...
string CreateLaneResponse::ToJsonString() const
{
...
string CreateLaneResponse::GetResult() const
{
    return m_result;
}

bool CreateLaneResponse::ResultHasBeenSet() const
{
