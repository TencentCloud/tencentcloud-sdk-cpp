...
CoreInternalOutcome DescribeApiRateLimitRulesResponse::Deserialize(const string &payload)
{
...
string DescribeApiRateLimitRulesResponse::ToJsonString() const
{
...
vector<ApiRateLimitRule> DescribeApiRateLimitRulesResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiRateLimitRulesResponse::ResultHasBeenSet() const
{
