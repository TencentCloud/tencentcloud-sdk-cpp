...
CoreInternalOutcome SearchBusinessLogResponse::Deserialize(const string &payload)
{
...
string SearchBusinessLogResponse::ToJsonString() const
{
...
TsfPageBusinessLogV2 SearchBusinessLogResponse::GetResult() const
{
    return m_result;
}

bool SearchBusinessLogResponse::ResultHasBeenSet() const
{
