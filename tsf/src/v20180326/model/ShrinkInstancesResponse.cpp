...
CoreInternalOutcome ShrinkInstancesResponse::Deserialize(const string &payload)
{
...
string ShrinkInstancesResponse::ToJsonString() const
{
...
TaskId ShrinkInstancesResponse::GetResult() const
{
    return m_result;
}

bool ShrinkInstancesResponse::ResultHasBeenSet() const
{
