...
CoreInternalOutcome DeleteLaneResponse::Deserialize(const string &payload)
{
...
string DeleteLaneResponse::ToJsonString() const
{
...
bool DeleteLaneResponse::GetResult() const
{
    return m_result;
}

bool DeleteLaneResponse::ResultHasBeenSet() const
{
