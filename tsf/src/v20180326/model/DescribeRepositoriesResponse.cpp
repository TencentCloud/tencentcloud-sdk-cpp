...
string DescribeRepositoriesResponse::ToJsonString() const
{
...
RepositoryList DescribeRepositoriesResponse::GetResult() const
{
    return m_result;
}

bool DescribeRepositoriesResponse::ResultHasBeenSet() const
{
