...
CoreInternalOutcome UpdateApiRateLimitRuleResponse::Deserialize(const string &payload)
{
...
string UpdateApiRateLimitRuleResponse::ToJsonString() const
{
...
bool UpdateApiRateLimitRuleResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiRateLimitRuleResponse::ResultHasBeenSet() const
{
