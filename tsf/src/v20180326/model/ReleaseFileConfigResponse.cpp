...
CoreInternalOutcome ReleaseFileConfigResponse::Deserialize(const string &payload)
{
...
string ReleaseFileConfigResponse::ToJsonString() const
{
...
bool ReleaseFileConfigResponse::GetResult() const
{
    return m_result;
}

bool ReleaseFileConfigResponse::ResultHasBeenSet() const
{
