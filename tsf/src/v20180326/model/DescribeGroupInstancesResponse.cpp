...
CoreInternalOutcome DescribeGroupInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeGroupInstancesResponse::ToJsonString() const
{
...
TsfPageInstance DescribeGroupInstancesResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupInstancesResponse::ResultHasBeenSet() const
{
