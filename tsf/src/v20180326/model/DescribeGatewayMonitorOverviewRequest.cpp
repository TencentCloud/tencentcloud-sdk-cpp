...
string DescribeGatewayMonitorOverviewRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string DescribeGatewayMonitorOverviewRequest::GetGatewayDeployGroupId() const
{
    return m_gatewayDeployGroupId;
}

void DescribeGatewayMonitorOverviewRequest::SetGatewayDeployGroupId(const string& _gatewayDeployGroupId)
{
    m_gatewayDeployGroupId = _gatewayDeployGroupId;
    m_gatewayDeployGroupIdHasBeenSet = true;
}

bool DescribeGatewayMonitorOverviewRequest::GatewayDeployGroupIdHasBeenSet() const
{
