...
CoreInternalOutcome DescribeConfigSummaryResponse::Deserialize(const string &payload)
{
...
string DescribeConfigSummaryResponse::ToJsonString() const
{
...
TsfPageConfig DescribeConfigSummaryResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigSummaryResponse::ResultHasBeenSet() const
{
