...
CoreInternalOutcome DescribeCreateGatewayApiStatusResponse::Deserialize(const string &payload)
{
...
string DescribeCreateGatewayApiStatusResponse::ToJsonString() const
{
...
bool DescribeCreateGatewayApiStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeCreateGatewayApiStatusResponse::ResultHasBeenSet() const
{
