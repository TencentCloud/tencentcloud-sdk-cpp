...
CoreInternalOutcome DescribeGatewayApisResponse::Deserialize(const string &payload)
{
...
string DescribeGatewayApisResponse::ToJsonString() const
{
...
TsfPageApiDetailInfo DescribeGatewayApisResponse::GetResult() const
{
    return m_result;
}

bool DescribeGatewayApisResponse::ResultHasBeenSet() const
{
