...
CoreInternalOutcome CreatePublicConfigResponse::Deserialize(const string &payload)
{
...
string CreatePublicConfigResponse::ToJsonString() const
{
...
bool CreatePublicConfigResponse::GetResult() const
{
    return m_result;
}

bool CreatePublicConfigResponse::ResultHasBeenSet() const
{
