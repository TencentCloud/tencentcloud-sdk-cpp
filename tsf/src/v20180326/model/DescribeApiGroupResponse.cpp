...
CoreInternalOutcome DescribeApiGroupResponse::Deserialize(const string &payload)
{
...
string DescribeApiGroupResponse::ToJsonString() const
{
...
ApiGroupInfo DescribeApiGroupResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiGroupResponse::ResultHasBeenSet() const
{
