...
CoreInternalOutcome DescribePublicConfigsResponse::Deserialize(const string &payload)
{
...
string DescribePublicConfigsResponse::ToJsonString() const
{
...
TsfPageConfig DescribePublicConfigsResponse::GetResult() const
{
    return m_result;
}

bool DescribePublicConfigsResponse::ResultHasBeenSet() const
{
