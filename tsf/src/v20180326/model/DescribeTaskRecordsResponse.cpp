...
CoreInternalOutcome DescribeTaskRecordsResponse::Deserialize(const string &payload)
{
...
string DescribeTaskRecordsResponse::ToJsonString() const
{
...
TaskRecordPage DescribeTaskRecordsResponse::GetResult() const
{
    return m_result;
}

bool DescribeTaskRecordsResponse::ResultHasBeenSet() const
{
