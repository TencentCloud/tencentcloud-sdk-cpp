...
CoreInternalOutcome DescribeConfigReleaseLogsResponse::Deserialize(const string &payload)
{
...
string DescribeConfigReleaseLogsResponse::ToJsonString() const
{
...
TsfPageConfigReleaseLog DescribeConfigReleaseLogsResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigReleaseLogsResponse::ResultHasBeenSet() const
{
