...
CoreInternalOutcome DescribeGroupUseDetailResponse::Deserialize(const string &payload)
{
...
string DescribeGroupUseDetailResponse::ToJsonString() const
{
...
GroupDailyUseStatistics DescribeGroupUseDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupUseDetailResponse::ResultHasBeenSet() const
{
