...
CoreInternalOutcome UpdateApiGroupResponse::Deserialize(const string &payload)
{
...
string UpdateApiGroupResponse::ToJsonString() const
{
...
bool UpdateApiGroupResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiGroupResponse::ResultHasBeenSet() const
{
