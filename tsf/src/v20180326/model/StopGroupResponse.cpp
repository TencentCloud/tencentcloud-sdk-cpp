...
CoreInternalOutcome StopGroupResponse::Deserialize(const string &payload)
{
...
string StopGroupResponse::ToJsonString() const
{
...
TaskId StopGroupResponse::GetResult() const
{
    return m_result;
}

bool StopGroupResponse::ResultHasBeenSet() const
{
