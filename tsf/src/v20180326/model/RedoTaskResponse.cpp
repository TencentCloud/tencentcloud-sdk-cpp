...
CoreInternalOutcome RedoTaskResponse::Deserialize(const string &payload)
{
...
string RedoTaskResponse::ToJsonString() const
{
...
string RedoTaskResponse::GetResult() const
{
    return m_result;
}

bool RedoTaskResponse::ResultHasBeenSet() const
{
