...
CoreInternalOutcome DescribeInvocationMetricDataPointResponse::Deserialize(const string &payload)
{
...
string DescribeInvocationMetricDataPointResponse::ToJsonString() const
{
...
vector<MetricDataSingleValue> DescribeInvocationMetricDataPointResponse::GetResult() const
{
    return m_result;
}

bool DescribeInvocationMetricDataPointResponse::ResultHasBeenSet() const
{
