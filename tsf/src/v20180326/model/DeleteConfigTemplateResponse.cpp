...
CoreInternalOutcome DeleteConfigTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteConfigTemplateResponse::ToJsonString() const
{
...
bool DeleteConfigTemplateResponse::GetResult() const
{
    return m_result;
}

bool DeleteConfigTemplateResponse::ResultHasBeenSet() const
{
