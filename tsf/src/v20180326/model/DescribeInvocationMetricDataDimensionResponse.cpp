...
CoreInternalOutcome DescribeInvocationMetricDataDimensionResponse::Deserialize(const string &payload)
{
...
string DescribeInvocationMetricDataDimensionResponse::ToJsonString() const
{
...
TsfPageDimension DescribeInvocationMetricDataDimensionResponse::GetResult() const
{
    return m_result;
}

bool DescribeInvocationMetricDataDimensionResponse::ResultHasBeenSet() const
{
