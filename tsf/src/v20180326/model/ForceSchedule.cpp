...
CoreInternalOutcome ForceSchedule::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("AffinityList") && !value["AffinityList"].IsNull())
    {
        if (!value["AffinityList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ForceSchedule.AffinityList` is not array type"));
    ...
    if (value.HasMember("AntiAffinityList") && !value["AntiAffinityList"].IsNull())
    {
        if (!value["AntiAffinityList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ForceSchedule.AntiAffinityList` is not array type"));
...
void ForceSchedule::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<Affinity> ForceSchedule::GetAffinityList() const
{
    return m_affinityList;
}

void ForceSchedule::SetAffinityList(const vector<Affinity>& _affinityList)
{
    m_affinityList = _affinityList;
    m_affinityListHasBeenSet = true;
}

bool ForceSchedule::AffinityListHasBeenSet() const
{
    return m_affinityListHasBeenSet;
}

vector<Affinity> ForceSchedule::GetAntiAffinityList() const
{
    return m_antiAffinityList;
}

void ForceSchedule::SetAntiAffinityList(const vector<Affinity>& _antiAffinityList)
{
    m_antiAffinityList = _antiAffinityList;
    m_antiAffinityListHasBeenSet = true;
}

bool ForceSchedule::AntiAffinityListHasBeenSet() const
{
