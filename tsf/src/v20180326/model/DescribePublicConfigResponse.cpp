...
CoreInternalOutcome DescribePublicConfigResponse::Deserialize(const string &payload)
{
...
string DescribePublicConfigResponse::ToJsonString() const
{
...
Config DescribePublicConfigResponse::GetResult() const
{
    return m_result;
}

bool DescribePublicConfigResponse::ResultHasBeenSet() const
{
