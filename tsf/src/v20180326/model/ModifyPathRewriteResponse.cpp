...
CoreInternalOutcome ModifyPathRewriteResponse::Deserialize(const string &payload)
{
...
string ModifyPathRewriteResponse::ToJsonString() const
{
...
bool ModifyPathRewriteResponse::GetResult() const
{
    return m_result;
}

bool ModifyPathRewriteResponse::ResultHasBeenSet() const
{
