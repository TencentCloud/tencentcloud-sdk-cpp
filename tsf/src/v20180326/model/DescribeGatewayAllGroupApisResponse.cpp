...
CoreInternalOutcome DescribeGatewayAllGroupApisResponse::Deserialize(const string &payload)
{
...
string DescribeGatewayAllGroupApisResponse::ToJsonString() const
{
...
GatewayVo DescribeGatewayAllGroupApisResponse::GetResult() const
{
    return m_result;
}

bool DescribeGatewayAllGroupApisResponse::ResultHasBeenSet() const
{
