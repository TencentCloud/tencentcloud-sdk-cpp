...
CoreInternalOutcome UpdateConfigTemplateResponse::Deserialize(const string &payload)
{
...
string UpdateConfigTemplateResponse::ToJsonString() const
{
...
bool UpdateConfigTemplateResponse::GetResult() const
{
    return m_result;
}

bool UpdateConfigTemplateResponse::ResultHasBeenSet() const
{
