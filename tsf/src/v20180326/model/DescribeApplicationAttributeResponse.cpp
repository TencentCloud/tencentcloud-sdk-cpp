...
CoreInternalOutcome DescribeApplicationAttributeResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationAttributeResponse::ToJsonString() const
{
...
ApplicationAttribute DescribeApplicationAttributeResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationAttributeResponse::ResultHasBeenSet() const
{
