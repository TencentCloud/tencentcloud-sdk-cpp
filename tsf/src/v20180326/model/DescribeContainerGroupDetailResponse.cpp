...
CoreInternalOutcome DescribeContainerGroupDetailResponse::Deserialize(const string &payload)
{
...
string DescribeContainerGroupDetailResponse::ToJsonString() const
{
...
ContainerGroupDetail DescribeContainerGroupDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeContainerGroupDetailResponse::ResultHasBeenSet() const
{
