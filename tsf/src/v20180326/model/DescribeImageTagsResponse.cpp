...
CoreInternalOutcome DescribeImageTagsResponse::Deserialize(const string &payload)
{
...
string DescribeImageTagsResponse::ToJsonString() const
{
...
ImageTagsResult DescribeImageTagsResponse::GetResult() const
{
    return m_result;
}

bool DescribeImageTagsResponse::ResultHasBeenSet() const
{
