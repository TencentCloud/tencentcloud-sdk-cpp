...
CoreInternalOutcome UpdateApiRateLimitRulesResponse::Deserialize(const string &payload)
{
...
string UpdateApiRateLimitRulesResponse::ToJsonString() const
{
...
bool UpdateApiRateLimitRulesResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiRateLimitRulesResponse::ResultHasBeenSet() const
{
