...
CoreInternalOutcome DescribeApiGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeApiGroupsResponse::ToJsonString() const
{
...
TsfPageApiGroupInfo DescribeApiGroupsResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiGroupsResponse::ResultHasBeenSet() const
{
