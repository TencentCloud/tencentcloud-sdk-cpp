...
CoreInternalOutcome HealthCheckConfig::Deserialize(const Value &value)
{
    string requestId = "";
...
void HealthCheckConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
