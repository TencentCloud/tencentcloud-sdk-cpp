...
CoreInternalOutcome DescribeStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStatisticsResponse::ToJsonString() const
{
...
ServiceStatisticsResults DescribeStatisticsResponse::GetResult() const
{
    return m_result;
}

bool DescribeStatisticsResponse::ResultHasBeenSet() const
{
