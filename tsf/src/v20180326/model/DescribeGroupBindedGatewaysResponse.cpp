...
CoreInternalOutcome DescribeGroupBindedGatewaysResponse::Deserialize(const string &payload)
{
...
string DescribeGroupBindedGatewaysResponse::ToJsonString() const
{
...
TsfPageGatewayDeployGroup DescribeGroupBindedGatewaysResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupBindedGatewaysResponse::ResultHasBeenSet() const
{
