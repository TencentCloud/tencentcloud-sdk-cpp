...
CoreInternalOutcome DeleteServerlessGroupResponse::Deserialize(const string &payload)
{
...
string DeleteServerlessGroupResponse::ToJsonString() const
{
...
bool DeleteServerlessGroupResponse::GetResult() const
{
    return m_result;
}

bool DeleteServerlessGroupResponse::ResultHasBeenSet() const
{
