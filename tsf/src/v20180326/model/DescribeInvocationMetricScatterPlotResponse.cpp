...
CoreInternalOutcome DescribeInvocationMetricScatterPlotResponse::Deserialize(const string &payload)
{
...
string DescribeInvocationMetricScatterPlotResponse::ToJsonString() const
{
...
InvocationMetricScatterPlot DescribeInvocationMetricScatterPlotResponse::GetResult() const
{
    return m_result;
}

bool DescribeInvocationMetricScatterPlotResponse::ResultHasBeenSet() const
{
