...
string BindApiGroupRequest::ToJsonString() const
{
...
vector<GatewayGroupIds> BindApiGroupRequest::GetGroupGatewayList() const
{
    return m_groupGatewayList;
}

void BindApiGroupRequest::SetGroupGatewayList(const vector<GatewayGroupIds>& _groupGatewayList)
{
    m_groupGatewayList = _groupGatewayList;
    m_groupGatewayListHasBeenSet = true;
}

bool BindApiGroupRequest::GroupGatewayListHasBeenSet() const
{
