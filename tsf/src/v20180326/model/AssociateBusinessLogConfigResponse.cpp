...
CoreInternalOutcome AssociateBusinessLogConfigResponse::Deserialize(const string &payload)
{
...
string AssociateBusinessLogConfigResponse::ToJsonString() const
{
...
bool AssociateBusinessLogConfigResponse::GetResult() const
{
    return m_result;
}

bool AssociateBusinessLogConfigResponse::ResultHasBeenSet() const
{
