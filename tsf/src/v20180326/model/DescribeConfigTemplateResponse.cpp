...
CoreInternalOutcome DescribeConfigTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeConfigTemplateResponse::ToJsonString() const
{
...
ConfigTemplate DescribeConfigTemplateResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigTemplateResponse::ResultHasBeenSet() const
{
