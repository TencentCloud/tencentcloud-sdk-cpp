...
CoreInternalOutcome UpdateApiTimeoutsResponse::Deserialize(const string &payload)
{
...
string UpdateApiTimeoutsResponse::ToJsonString() const
{
...
bool UpdateApiTimeoutsResponse::GetResult() const
{
    return m_result;
}

bool UpdateApiTimeoutsResponse::ResultHasBeenSet() const
{
