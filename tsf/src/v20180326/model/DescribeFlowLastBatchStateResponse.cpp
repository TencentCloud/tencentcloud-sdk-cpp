...
CoreInternalOutcome DescribeFlowLastBatchStateResponse::Deserialize(const string &payload)
{
...
string DescribeFlowLastBatchStateResponse::ToJsonString() const
{
...
TaskFlowLastBatchState DescribeFlowLastBatchStateResponse::GetResult() const
{
    return m_result;
}

bool DescribeFlowLastBatchStateResponse::ResultHasBeenSet() const
{
