...
CoreInternalOutcome ModifyLaneRuleResponse::Deserialize(const string &payload)
{
...
string ModifyLaneRuleResponse::ToJsonString() const
{
...
bool ModifyLaneRuleResponse::GetResult() const
{
    return m_result;
}

bool ModifyLaneRuleResponse::ResultHasBeenSet() const
{
