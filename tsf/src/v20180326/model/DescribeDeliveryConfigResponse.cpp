...
CoreInternalOutcome DescribeDeliveryConfigResponse::Deserialize(const string &payload)
{
...
string DescribeDeliveryConfigResponse::ToJsonString() const
{
...
KafkaDeliveryConfig DescribeDeliveryConfigResponse::GetResult() const
{
    return m_result;
}

bool DescribeDeliveryConfigResponse::ResultHasBeenSet() const
{
