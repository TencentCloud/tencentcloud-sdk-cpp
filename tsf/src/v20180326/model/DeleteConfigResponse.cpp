...
CoreInternalOutcome DeleteConfigResponse::Deserialize(const string &payload)
{
...
string DeleteConfigResponse::ToJsonString() const
{
...
bool DeleteConfigResponse::GetResult() const
{
    return m_result;
}

bool DeleteConfigResponse::ResultHasBeenSet() const
{
