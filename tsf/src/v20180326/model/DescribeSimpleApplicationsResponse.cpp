...
CoreInternalOutcome DescribeSimpleApplicationsResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleApplicationsResponse::ToJsonString() const
{
...
TsfPageSimpleApplication DescribeSimpleApplicationsResponse::GetResult() const
{
    return m_result;
}

bool DescribeSimpleApplicationsResponse::ResultHasBeenSet() const
{
