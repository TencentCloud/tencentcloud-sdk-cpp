...
CoreInternalOutcome DescribeGatewayMonitorOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeGatewayMonitorOverviewResponse::ToJsonString() const
{
...
MonitorOverview DescribeGatewayMonitorOverviewResponse::GetResult() const
{
    return m_result;
}

bool DescribeGatewayMonitorOverviewResponse::ResultHasBeenSet() const
{
