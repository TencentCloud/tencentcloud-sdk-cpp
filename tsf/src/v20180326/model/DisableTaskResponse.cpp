...
CoreInternalOutcome DisableTaskResponse::Deserialize(const string &payload)
{
...
string DisableTaskResponse::ToJsonString() const
{
...
bool DisableTaskResponse::GetResult() const
{
    return m_result;
}

bool DisableTaskResponse::ResultHasBeenSet() const
{
