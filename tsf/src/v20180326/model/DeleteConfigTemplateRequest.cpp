...
string DeleteConfigTemplateRequest::ToJsonString() const
{
...
string DeleteConfigTemplateRequest::GetConfigTemplateId() const
{
    return m_configTemplateId;
}

void DeleteConfigTemplateRequest::SetConfigTemplateId(const string& _configTemplateId)
{
    m_configTemplateId = _configTemplateId;
    m_configTemplateIdHasBeenSet = true;
}

bool DeleteConfigTemplateRequest::ConfigTemplateIdHasBeenSet() const
{
