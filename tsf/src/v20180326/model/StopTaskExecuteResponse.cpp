...
CoreInternalOutcome StopTaskExecuteResponse::Deserialize(const string &payload)
{
...
string StopTaskExecuteResponse::ToJsonString() const
{
...
bool StopTaskExecuteResponse::GetResult() const
{
    return m_result;
}

bool StopTaskExecuteResponse::ResultHasBeenSet() const
{
