...
CoreInternalOutcome DescribeUsableUnitNamespacesResponse::Deserialize(const string &payload)
{
...
string DescribeUsableUnitNamespacesResponse::ToJsonString() const
{
...
TsfPageUnitNamespace DescribeUsableUnitNamespacesResponse::GetResult() const
{
    return m_result;
}

bool DescribeUsableUnitNamespacesResponse::ResultHasBeenSet() const
{
