...
CoreInternalOutcome DeleteUnitRuleResponse::Deserialize(const string &payload)
{
...
string DeleteUnitRuleResponse::ToJsonString() const
{
...
bool DeleteUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool DeleteUnitRuleResponse::ResultHasBeenSet() const
{
