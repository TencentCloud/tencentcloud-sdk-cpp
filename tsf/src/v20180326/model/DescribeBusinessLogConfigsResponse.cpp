...
CoreInternalOutcome DescribeBusinessLogConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeBusinessLogConfigsResponse::ToJsonString() const
{
...
TsfPageBusinessLogConfig DescribeBusinessLogConfigsResponse::GetResult() const
{
    return m_result;
}

bool DescribeBusinessLogConfigsResponse::ResultHasBeenSet() const
{
