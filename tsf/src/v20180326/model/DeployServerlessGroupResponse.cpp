...
CoreInternalOutcome DeployServerlessGroupResponse::Deserialize(const string &payload)
{
...
string DeployServerlessGroupResponse::ToJsonString() const
{
...
bool DeployServerlessGroupResponse::GetResult() const
{
    return m_result;
}

bool DeployServerlessGroupResponse::ResultHasBeenSet() const
{
