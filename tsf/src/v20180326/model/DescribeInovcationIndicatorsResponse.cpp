...
CoreInternalOutcome DescribeInovcationIndicatorsResponse::Deserialize(const string &payload)
{
...
string DescribeInovcationIndicatorsResponse::ToJsonString() const
{
...
InvocationIndicator DescribeInovcationIndicatorsResponse::GetResult() const
{
    return m_result;
}

bool DescribeInovcationIndicatorsResponse::ResultHasBeenSet() const
{
