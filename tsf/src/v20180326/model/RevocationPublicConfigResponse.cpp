...
CoreInternalOutcome RevocationPublicConfigResponse::Deserialize(const string &payload)
{
...
string RevocationPublicConfigResponse::ToJsonString() const
{
...
bool RevocationPublicConfigResponse::GetResult() const
{
    return m_result;
}

bool RevocationPublicConfigResponse::ResultHasBeenSet() const
{
