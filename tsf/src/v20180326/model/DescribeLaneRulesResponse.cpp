...
CoreInternalOutcome DescribeLaneRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLaneRulesResponse::ToJsonString() const
{
...
LaneRules DescribeLaneRulesResponse::GetResult() const
{
    return m_result;
}

bool DescribeLaneRulesResponse::ResultHasBeenSet() const
{
