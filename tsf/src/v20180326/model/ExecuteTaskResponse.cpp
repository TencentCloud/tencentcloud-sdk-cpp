...
CoreInternalOutcome ExecuteTaskResponse::Deserialize(const string &payload)
{
...
string ExecuteTaskResponse::ToJsonString() const
{
...
string ExecuteTaskResponse::GetResult() const
{
    return m_result;
}

bool ExecuteTaskResponse::ResultHasBeenSet() const
{
