...
CoreInternalOutcome CreateMicroserviceResponse::Deserialize(const string &payload)
{
...
string CreateMicroserviceResponse::ToJsonString() const
{
...
bool CreateMicroserviceResponse::GetResult() const
{
    return m_result;
}

bool CreateMicroserviceResponse::ResultHasBeenSet() const
{
