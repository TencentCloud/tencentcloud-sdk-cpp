...
CoreInternalOutcome ModifyApplicationResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationResponse::ToJsonString() const
{
...
bool ModifyApplicationResponse::GetResult() const
{
    return m_result;
}

bool ModifyApplicationResponse::ResultHasBeenSet() const
{
