...
CoreInternalOutcome ReleaseConfigResponse::Deserialize(const string &payload)
{
...
string ReleaseConfigResponse::ToJsonString() const
{
...
bool ReleaseConfigResponse::GetResult() const
{
    return m_result;
}

bool ReleaseConfigResponse::ResultHasBeenSet() const
{
