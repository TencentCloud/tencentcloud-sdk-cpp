...
CoreInternalOutcome CreateServerlessGroupResponse::Deserialize(const string &payload)
{
...
string CreateServerlessGroupResponse::ToJsonString() const
{
...
string CreateServerlessGroupResponse::GetResult() const
{
    return m_result;
}

bool CreateServerlessGroupResponse::ResultHasBeenSet() const
{
