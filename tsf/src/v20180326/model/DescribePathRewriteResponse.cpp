...
CoreInternalOutcome DescribePathRewriteResponse::Deserialize(const string &payload)
{
...
string DescribePathRewriteResponse::ToJsonString() const
{
...
PathRewrite DescribePathRewriteResponse::GetResult() const
{
    return m_result;
}

bool DescribePathRewriteResponse::ResultHasBeenSet() const
{
