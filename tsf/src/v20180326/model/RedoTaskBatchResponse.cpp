...
CoreInternalOutcome RedoTaskBatchResponse::Deserialize(const string &payload)
{
...
string RedoTaskBatchResponse::ToJsonString() const
{
...
string RedoTaskBatchResponse::GetResult() const
{
    return m_result;
}

bool RedoTaskBatchResponse::ResultHasBeenSet() const
{
