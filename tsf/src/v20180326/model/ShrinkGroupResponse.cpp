...
CoreInternalOutcome ShrinkGroupResponse::Deserialize(const string &payload)
{
...
string ShrinkGroupResponse::ToJsonString() const
{
...
TaskId ShrinkGroupResponse::GetResult() const
{
    return m_result;
}

bool ShrinkGroupResponse::ResultHasBeenSet() const
{
