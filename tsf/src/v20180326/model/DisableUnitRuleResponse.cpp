...
CoreInternalOutcome DisableUnitRuleResponse::Deserialize(const string &payload)
{
...
string DisableUnitRuleResponse::ToJsonString() const
{
...
bool DisableUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool DisableUnitRuleResponse::ResultHasBeenSet() const
{
