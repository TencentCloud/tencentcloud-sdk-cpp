...
CoreInternalOutcome DeletePathRewritesResponse::Deserialize(const string &payload)
{
...
string DeletePathRewritesResponse::ToJsonString() const
{
...
bool DeletePathRewritesResponse::GetResult() const
{
    return m_result;
}

bool DeletePathRewritesResponse::ResultHasBeenSet() const
{
