...
CoreInternalOutcome RevokeFileConfigResponse::Deserialize(const string &payload)
{
...
string RevokeFileConfigResponse::ToJsonString() const
{
...
bool RevokeFileConfigResponse::GetResult() const
{
    return m_result;
}

bool RevokeFileConfigResponse::ResultHasBeenSet() const
{
