...
CoreInternalOutcome CreateFileConfigResponse::Deserialize(const string &payload)
{
...
string CreateFileConfigResponse::ToJsonString() const
{
...
bool CreateFileConfigResponse::GetResult() const
{
    return m_result;
}

bool CreateFileConfigResponse::ResultHasBeenSet() const
{
