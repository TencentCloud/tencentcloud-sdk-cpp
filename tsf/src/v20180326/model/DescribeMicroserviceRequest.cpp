...
string DescribeMicroserviceRequest::ToJsonString() const
{
...
string DescribeMicroserviceRequest::GetMicroserviceId() const
{
    return m_microserviceId;
}

void DescribeMicroserviceRequest::SetMicroserviceId(const string& _microserviceId)
{
    m_microserviceId = _microserviceId;
    m_microserviceIdHasBeenSet = true;
}

bool DescribeMicroserviceRequest::MicroserviceIdHasBeenSet() const
{
    return m_microserviceIdHasBeenSet;
}

int64_t DescribeMicroserviceRequest::GetOffset() const
{
    return m_offset;
}

void DescribeMicroserviceRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeMicroserviceRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeMicroserviceRequest::GetLimit() const
{
    return m_limit;
}

void DescribeMicroserviceRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
