...
CoreInternalOutcome DescribeSimpleGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleGroupsResponse::ToJsonString() const
{
...
TsfPageSimpleGroup DescribeSimpleGroupsResponse::GetResult() const
{
    return m_result;
}

bool DescribeSimpleGroupsResponse::ResultHasBeenSet() const
{
