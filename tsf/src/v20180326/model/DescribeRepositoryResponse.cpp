...
CoreInternalOutcome DescribeRepositoryResponse::Deserialize(const string &payload)
{
...
string DescribeRepositoryResponse::ToJsonString() const
{
...
RepositoryInfo DescribeRepositoryResponse::GetResult() const
{
    return m_result;
}

bool DescribeRepositoryResponse::ResultHasBeenSet() const
{
