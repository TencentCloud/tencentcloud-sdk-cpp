...
string DescribeConfigRequest::GetConfigId() const
{
    return m_configId;
}

void DescribeConfigRequest::SetConfigId(const string& _configId)
{
    m_configId = _configId;
    m_configIdHasBeenSet = true;
}

bool DescribeConfigRequest::ConfigIdHasBeenSet() const
{
