...
CoreInternalOutcome DescribeGroupGatewaysResponse::Deserialize(const string &payload)
{
...
string DescribeGroupGatewaysResponse::ToJsonString() const
{
...
TsfPageApiGroupInfo DescribeGroupGatewaysResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupGatewaysResponse::ResultHasBeenSet() const
{
