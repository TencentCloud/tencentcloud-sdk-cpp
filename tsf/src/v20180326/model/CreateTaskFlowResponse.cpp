...
CoreInternalOutcome CreateTaskFlowResponse::Deserialize(const string &payload)
{
...
string CreateTaskFlowResponse::ToJsonString() const
{
...
string CreateTaskFlowResponse::GetResult() const
{
    return m_result;
}

bool CreateTaskFlowResponse::ResultHasBeenSet() const
{
