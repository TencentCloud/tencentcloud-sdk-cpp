...
CoreInternalOutcome DeployContainerGroupResponse::Deserialize(const string &payload)
{
...
string DeployContainerGroupResponse::ToJsonString() const
{
...
bool DeployContainerGroupResponse::GetResult() const
{
    return m_result;
}

bool DeployContainerGroupResponse::ResultHasBeenSet() const
{
