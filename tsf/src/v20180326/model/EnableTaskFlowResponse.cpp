...
CoreInternalOutcome EnableTaskFlowResponse::Deserialize(const string &payload)
{
...
string EnableTaskFlowResponse::ToJsonString() const
{
...
bool EnableTaskFlowResponse::GetResult() const
{
    return m_result;
}

bool EnableTaskFlowResponse::ResultHasBeenSet() const
{
