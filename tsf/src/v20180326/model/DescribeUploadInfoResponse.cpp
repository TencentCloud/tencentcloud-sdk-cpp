...
CoreInternalOutcome DescribeUploadInfoResponse::Deserialize(const string &payload)
{
...
string DescribeUploadInfoResponse::ToJsonString() const
{
...
CosUploadInfo DescribeUploadInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeUploadInfoResponse::ResultHasBeenSet() const
{
