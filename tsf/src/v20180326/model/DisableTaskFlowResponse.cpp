...
CoreInternalOutcome DisableTaskFlowResponse::Deserialize(const string &payload)
{
...
string DisableTaskFlowResponse::ToJsonString() const
{
...
bool DisableTaskFlowResponse::GetResult() const
{
    return m_result;
}

bool DisableTaskFlowResponse::ResultHasBeenSet() const
{
