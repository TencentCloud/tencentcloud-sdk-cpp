...
CoreInternalOutcome DescribeInvocationMetricDataCurveResponse::Deserialize(const string &payload)
{
...
string DescribeInvocationMetricDataCurveResponse::ToJsonString() const
{
...
vector<MetricDataCurve> DescribeInvocationMetricDataCurveResponse::GetResult() const
{
    return m_result;
}

bool DescribeInvocationMetricDataCurveResponse::ResultHasBeenSet() const
{
