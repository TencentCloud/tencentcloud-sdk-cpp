...
CoreInternalOutcome ModifyClusterResponse::Deserialize(const string &payload)
{
...
string ModifyClusterResponse::ToJsonString() const
{
...
bool ModifyClusterResponse::GetResult() const
{
    return m_result;
}

bool ModifyClusterResponse::ResultHasBeenSet() const
{
