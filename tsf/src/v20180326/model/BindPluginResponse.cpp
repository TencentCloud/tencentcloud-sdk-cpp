...
CoreInternalOutcome BindPluginResponse::Deserialize(const string &payload)
{
...
string BindPluginResponse::ToJsonString() const
{
...
bool BindPluginResponse::GetResult() const
{
    return m_result;
}

bool BindPluginResponse::ResultHasBeenSet() const
{
