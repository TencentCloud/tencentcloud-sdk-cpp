...
string DeleteRepositoryRequest::GetRepositoryId() const
{
    return m_repositoryId;
}

void DeleteRepositoryRequest::SetRepositoryId(const string& _repositoryId)
{
    m_repositoryId = _repositoryId;
    m_repositoryIdHasBeenSet = true;
}

bool DeleteRepositoryRequest::RepositoryIdHasBeenSet() const
{
