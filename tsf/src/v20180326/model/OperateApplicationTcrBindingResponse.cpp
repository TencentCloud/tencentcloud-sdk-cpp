...
CoreInternalOutcome OperateApplicationTcrBindingResponse::Deserialize(const string &payload)
{
...
string OperateApplicationTcrBindingResponse::ToJsonString() const
{
...
bool OperateApplicationTcrBindingResponse::GetResult() const
{
    return m_result;
}

bool OperateApplicationTcrBindingResponse::ResultHasBeenSet() const
{
