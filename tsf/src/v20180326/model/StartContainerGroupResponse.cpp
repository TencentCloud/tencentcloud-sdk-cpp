...
CoreInternalOutcome StartContainerGroupResponse::Deserialize(const string &payload)
{
...
string StartContainerGroupResponse::ToJsonString() const
{
...
bool StartContainerGroupResponse::GetResult() const
{
    return m_result;
}

bool StartContainerGroupResponse::ResultHasBeenSet() const
{
