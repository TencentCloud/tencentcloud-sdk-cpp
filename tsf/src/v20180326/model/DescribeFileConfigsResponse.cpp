...
CoreInternalOutcome DescribeFileConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeFileConfigsResponse::ToJsonString() const
{
...
TsfPageFileConfig DescribeFileConfigsResponse::GetResult() const
{
    return m_result;
}

bool DescribeFileConfigsResponse::ResultHasBeenSet() const
{
