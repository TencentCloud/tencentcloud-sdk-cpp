...
CoreInternalOutcome DescribeReleasedConfigResponse::Deserialize(const string &payload)
{
...
string DescribeReleasedConfigResponse::ToJsonString() const
{
...
string DescribeReleasedConfigResponse::GetResult() const
{
    return m_result;
}

bool DescribeReleasedConfigResponse::ResultHasBeenSet() const
{
