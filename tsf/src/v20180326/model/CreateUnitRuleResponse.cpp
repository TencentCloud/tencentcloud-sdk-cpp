...
CoreInternalOutcome CreateUnitRuleResponse::Deserialize(const string &payload)
{
...
string CreateUnitRuleResponse::ToJsonString() const
{
...
bool CreateUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool CreateUnitRuleResponse::ResultHasBeenSet() const
{
