...
CoreInternalOutcome DescribeApiVersionsResponse::Deserialize(const string &payload)
{
...
string DescribeApiVersionsResponse::ToJsonString() const
{
...
vector<ApiVersionArray> DescribeApiVersionsResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiVersionsResponse::ResultHasBeenSet() const
{
