...
CoreInternalOutcome DescribeOverviewInvocationResponse::Deserialize(const string &payload)
{
...
string DescribeOverviewInvocationResponse::ToJsonString() const
{
...
vector<MetricDataPoint> DescribeOverviewInvocationResponse::GetResult() const
{
    return m_result;
}

bool DescribeOverviewInvocationResponse::ResultHasBeenSet() const
{
