...
CoreInternalOutcome DescribeContainerEventsResponse::Deserialize(const string &payload)
{
...
string DescribeContainerEventsResponse::ToJsonString() const
{
...
TsfPageContainerEvent DescribeContainerEventsResponse::GetResult() const
{
    return m_result;
}

bool DescribeContainerEventsResponse::ResultHasBeenSet() const
{
