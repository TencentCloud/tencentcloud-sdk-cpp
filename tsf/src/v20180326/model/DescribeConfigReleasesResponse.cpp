...
CoreInternalOutcome DescribeConfigReleasesResponse::Deserialize(const string &payload)
{
...
string DescribeConfigReleasesResponse::ToJsonString() const
{
...
TsfPageConfigRelease DescribeConfigReleasesResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigReleasesResponse::ResultHasBeenSet() const
{
