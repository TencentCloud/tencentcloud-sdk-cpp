...
CoreInternalOutcome DeployGroupResponse::Deserialize(const string &payload)
{
...
string DeployGroupResponse::ToJsonString() const
{
...
TaskId DeployGroupResponse::GetResult() const
{
    return m_result;
}

bool DeployGroupResponse::ResultHasBeenSet() const
{
