...
CoreInternalOutcome DisableUnitRouteResponse::Deserialize(const string &payload)
{
...
string DisableUnitRouteResponse::ToJsonString() const
{
...
bool DisableUnitRouteResponse::GetResult() const
{
    return m_result;
}

bool DisableUnitRouteResponse::ResultHasBeenSet() const
{
