...
CoreInternalOutcome GatewayGroupApiVo::Deserialize(const Value &value)
{
    string requestId = "";
...
void GatewayGroupApiVo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
