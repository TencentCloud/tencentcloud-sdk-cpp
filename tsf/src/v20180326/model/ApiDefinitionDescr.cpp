...
CoreInternalOutcome ApiDefinitionDescr::Deserialize(const Value &value)
{
    string requestId = "";
...
void ApiDefinitionDescr::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
