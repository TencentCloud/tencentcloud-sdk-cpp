...
CoreInternalOutcome CreateGatewayApiResponse::Deserialize(const string &payload)
{
...
string CreateGatewayApiResponse::ToJsonString() const
{
...
bool CreateGatewayApiResponse::GetResult() const
{
    return m_result;
}

bool CreateGatewayApiResponse::ResultHasBeenSet() const
{
