...
CoreInternalOutcome RedoTaskExecuteResponse::Deserialize(const string &payload)
{
...
string RedoTaskExecuteResponse::ToJsonString() const
{
...
string RedoTaskExecuteResponse::GetResult() const
{
    return m_result;
}

bool RedoTaskExecuteResponse::ResultHasBeenSet() const
{
