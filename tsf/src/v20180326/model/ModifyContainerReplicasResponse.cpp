...
CoreInternalOutcome ModifyContainerReplicasResponse::Deserialize(const string &payload)
{
...
string ModifyContainerReplicasResponse::ToJsonString() const
{
...
bool ModifyContainerReplicasResponse::GetResult() const
{
    return m_result;
}

bool ModifyContainerReplicasResponse::ResultHasBeenSet() const
{
