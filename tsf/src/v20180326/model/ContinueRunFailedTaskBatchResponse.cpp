...
CoreInternalOutcome ContinueRunFailedTaskBatchResponse::Deserialize(const string &payload)
{
...
string ContinueRunFailedTaskBatchResponse::ToJsonString() const
{
...
bool ContinueRunFailedTaskBatchResponse::GetResult() const
{
    return m_result;
}

bool ContinueRunFailedTaskBatchResponse::ResultHasBeenSet() const
{
