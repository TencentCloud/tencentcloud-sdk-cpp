...
CoreInternalOutcome TerminateTaskFlowBatchResponse::Deserialize(const string &payload)
{
...
string TerminateTaskFlowBatchResponse::ToJsonString() const
{
...
bool TerminateTaskFlowBatchResponse::GetResult() const
{
    return m_result;
}

bool TerminateTaskFlowBatchResponse::ResultHasBeenSet() const
{
