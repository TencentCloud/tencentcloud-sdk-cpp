...
CoreInternalOutcome EnableUnitRuleResponse::Deserialize(const string &payload)
{
...
string EnableUnitRuleResponse::ToJsonString() const
{
...
bool EnableUnitRuleResponse::GetResult() const
{
    return m_result;
}

bool EnableUnitRuleResponse::ResultHasBeenSet() const
{
