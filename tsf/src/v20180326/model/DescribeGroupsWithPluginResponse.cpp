...
CoreInternalOutcome DescribeGroupsWithPluginResponse::Deserialize(const string &payload)
{
...
string DescribeGroupsWithPluginResponse::ToJsonString() const
{
...
TsfPageApiGroupInfo DescribeGroupsWithPluginResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupsWithPluginResponse::ResultHasBeenSet() const
{
