...
CoreInternalOutcome DisassociateKafkaConfigResponse::Deserialize(const string &payload)
{
...
string DisassociateKafkaConfigResponse::ToJsonString() const
{
...
bool DisassociateKafkaConfigResponse::GetResult() const
{
    return m_result;
}

bool DisassociateKafkaConfigResponse::ResultHasBeenSet() const
{
