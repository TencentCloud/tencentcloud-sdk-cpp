...
CoreInternalOutcome DescribeJvmMonitorResponse::Deserialize(const string &payload)
{
...
string DescribeJvmMonitorResponse::ToJsonString() const
{
...
JvmMonitorData DescribeJvmMonitorResponse::GetResult() const
{
    return m_result;
}

bool DescribeJvmMonitorResponse::ResultHasBeenSet() const
{
