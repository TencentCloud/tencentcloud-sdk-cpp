...
CoreInternalOutcome BindApiGroupResponse::Deserialize(const string &payload)
{
...
string BindApiGroupResponse::ToJsonString() const
{
...
bool BindApiGroupResponse::GetResult() const
{
    return m_result;
}

bool BindApiGroupResponse::ResultHasBeenSet() const
{
