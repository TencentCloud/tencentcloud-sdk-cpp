...
CoreInternalOutcome AssociateConfigWithGroupResponse::Deserialize(const string &payload)
{
...
string AssociateConfigWithGroupResponse::ToJsonString() const
{
...
bool AssociateConfigWithGroupResponse::GetResult() const
{
    return m_result;
}

bool AssociateConfigWithGroupResponse::ResultHasBeenSet() const
{
