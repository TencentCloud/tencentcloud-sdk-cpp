...
CoreInternalOutcome DescribeServerlessGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeServerlessGroupsResponse::ToJsonString() const
{
...
ServerlessGroupPage DescribeServerlessGroupsResponse::GetResult() const
{
    return m_result;
}

bool DescribeServerlessGroupsResponse::ResultHasBeenSet() const
{
