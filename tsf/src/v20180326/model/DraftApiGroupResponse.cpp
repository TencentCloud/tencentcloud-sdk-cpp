...
CoreInternalOutcome DraftApiGroupResponse::Deserialize(const string &payload)
{
...
string DraftApiGroupResponse::ToJsonString() const
{
...
bool DraftApiGroupResponse::GetResult() const
{
    return m_result;
}

bool DraftApiGroupResponse::ResultHasBeenSet() const
{
