...
CoreInternalOutcome DescribePathRewritesResponse::Deserialize(const string &payload)
{
...
string DescribePathRewritesResponse::ToJsonString() const
{
...
PathRewritePage DescribePathRewritesResponse::GetResult() const
{
    return m_result;
}

bool DescribePathRewritesResponse::ResultHasBeenSet() const
{
