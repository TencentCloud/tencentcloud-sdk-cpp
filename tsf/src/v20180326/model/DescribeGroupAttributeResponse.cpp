...
CoreInternalOutcome DescribeGroupAttributeResponse::Deserialize(const string &payload)
{
...
string DescribeGroupAttributeResponse::ToJsonString() const
{
...
VmGroupOther DescribeGroupAttributeResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupAttributeResponse::ResultHasBeenSet() const
{
