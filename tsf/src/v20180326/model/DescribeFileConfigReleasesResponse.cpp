...
CoreInternalOutcome DescribeFileConfigReleasesResponse::Deserialize(const string &payload)
{
...
string DescribeFileConfigReleasesResponse::ToJsonString() const
{
...
TsfPageFileConfigRelease DescribeFileConfigReleasesResponse::GetResult() const
{
    return m_result;
}

bool DescribeFileConfigReleasesResponse::ResultHasBeenSet() const
{
