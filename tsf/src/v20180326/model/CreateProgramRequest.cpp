...
string CreateProgramRequest::ToJsonString() const
{
...
string CreateProgramRequest::GetProgramName() const
{
    return m_programName;
}

void CreateProgramRequest::SetProgramName(const string& _programName)
{
    m_programName = _programName;
    m_programNameHasBeenSet = true;
}

bool CreateProgramRequest::ProgramNameHasBeenSet() const
{
    return m_programNameHasBeenSet;
}

string CreateProgramRequest::GetProgramDesc() const
{
    return m_programDesc;
}

void CreateProgramRequest::SetProgramDesc(const string& _programDesc)
{
    m_programDesc = _programDesc;
    m_programDescHasBeenSet = true;
}

bool CreateProgramRequest::ProgramDescHasBeenSet() const
{
    return m_programDescHasBeenSet;
}

vector<ProgramItem> CreateProgramRequest::GetProgramItemList() const
{
    return m_programItemList;
}

void CreateProgramRequest::SetProgramItemList(const vector<ProgramItem>& _programItemList)
{
    m_programItemList = _programItemList;
    m_programItemListHasBeenSet = true;
}

bool CreateProgramRequest::ProgramItemListHasBeenSet() const
{
