...
CoreInternalOutcome StopTaskBatchResponse::Deserialize(const string &payload)
{
...
string StopTaskBatchResponse::ToJsonString() const
{
...
bool StopTaskBatchResponse::GetResult() const
{
    return m_result;
}

bool StopTaskBatchResponse::ResultHasBeenSet() const
{
