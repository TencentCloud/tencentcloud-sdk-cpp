...
CoreInternalOutcome CreateLaneRuleResponse::Deserialize(const string &payload)
{
...
string CreateLaneRuleResponse::ToJsonString() const
{
...
string CreateLaneRuleResponse::GetResult() const
{
    return m_result;
}

bool CreateLaneRuleResponse::ResultHasBeenSet() const
{
