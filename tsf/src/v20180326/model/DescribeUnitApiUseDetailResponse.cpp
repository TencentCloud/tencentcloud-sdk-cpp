...
CoreInternalOutcome DescribeUnitApiUseDetailResponse::Deserialize(const string &payload)
{
...
string DescribeUnitApiUseDetailResponse::ToJsonString() const
{
...
GroupUnitApiUseStatistics DescribeUnitApiUseDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeUnitApiUseDetailResponse::ResultHasBeenSet() const
{
