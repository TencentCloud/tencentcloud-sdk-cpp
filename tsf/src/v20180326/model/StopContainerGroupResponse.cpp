...
CoreInternalOutcome StopContainerGroupResponse::Deserialize(const string &payload)
{
...
string StopContainerGroupResponse::ToJsonString() const
{
...
bool StopContainerGroupResponse::GetResult() const
{
    return m_result;
}

bool StopContainerGroupResponse::ResultHasBeenSet() const
{
