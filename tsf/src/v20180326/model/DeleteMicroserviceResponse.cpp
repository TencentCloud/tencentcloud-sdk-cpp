...
CoreInternalOutcome DeleteMicroserviceResponse::Deserialize(const string &payload)
{
...
string DeleteMicroserviceResponse::ToJsonString() const
{
...
bool DeleteMicroserviceResponse::GetResult() const
{
    return m_result;
}

bool DeleteMicroserviceResponse::ResultHasBeenSet() const
{
