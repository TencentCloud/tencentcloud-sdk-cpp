...
CoreInternalOutcome DescribePublicConfigReleaseLogsResponse::Deserialize(const string &payload)
{
...
string DescribePublicConfigReleaseLogsResponse::ToJsonString() const
{
...
TsfPageConfigReleaseLog DescribePublicConfigReleaseLogsResponse::GetResult() const
{
    return m_result;
}

bool DescribePublicConfigReleaseLogsResponse::ResultHasBeenSet() const
{
