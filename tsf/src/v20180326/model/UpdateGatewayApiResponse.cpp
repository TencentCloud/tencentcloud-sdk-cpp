...
CoreInternalOutcome UpdateGatewayApiResponse::Deserialize(const string &payload)
{
...
string UpdateGatewayApiResponse::ToJsonString() const
{
...
bool UpdateGatewayApiResponse::GetResult() const
{
    return m_result;
}

bool UpdateGatewayApiResponse::ResultHasBeenSet() const
{
