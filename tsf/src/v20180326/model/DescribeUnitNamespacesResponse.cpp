...
CoreInternalOutcome DescribeUnitNamespacesResponse::Deserialize(const string &payload)
{
...
string DescribeUnitNamespacesResponse::ToJsonString() const
{
...
TsfPageUnitNamespace DescribeUnitNamespacesResponse::GetResult() const
{
    return m_result;
}

bool DescribeUnitNamespacesResponse::ResultHasBeenSet() const
{
