...
CoreInternalOutcome EnableTaskResponse::Deserialize(const string &payload)
{
...
string EnableTaskResponse::ToJsonString() const
{
...
bool EnableTaskResponse::GetResult() const
{
    return m_result;
}

bool EnableTaskResponse::ResultHasBeenSet() const
{
