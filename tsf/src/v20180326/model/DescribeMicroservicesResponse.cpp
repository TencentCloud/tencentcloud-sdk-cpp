...
CoreInternalOutcome DescribeMicroservicesResponse::Deserialize(const string &payload)
{
...
string DescribeMicroservicesResponse::ToJsonString() const
{
...
TsfPageMicroservice DescribeMicroservicesResponse::GetResult() const
{
    return m_result;
}

bool DescribeMicroservicesResponse::ResultHasBeenSet() const
{
