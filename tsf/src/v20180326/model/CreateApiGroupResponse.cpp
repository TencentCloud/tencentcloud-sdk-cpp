...
CoreInternalOutcome CreateApiGroupResponse::Deserialize(const string &payload)
{
...
string CreateApiGroupResponse::ToJsonString() const
{
...
string CreateApiGroupResponse::GetResult() const
{
    return m_result;
}

bool CreateApiGroupResponse::ResultHasBeenSet() const
{
