...
string DescribeTaskDetailRequest::ToJsonString() const
{
    ...
    if (m_taskLogIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_taskLogId.c_str(), allocator).Move(), allocator);
    }
...
string DescribeTaskDetailRequest::GetTaskLogId() const
{
    return m_taskLogId;
}

void DescribeTaskDetailRequest::SetTaskLogId(const string& _taskLogId)
{
    m_taskLogId = _taskLogId;
    m_taskLogIdHasBeenSet = true;
}

bool DescribeTaskDetailRequest::TaskLogIdHasBeenSet() const
{
