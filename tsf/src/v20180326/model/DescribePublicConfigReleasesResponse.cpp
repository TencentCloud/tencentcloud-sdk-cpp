...
CoreInternalOutcome DescribePublicConfigReleasesResponse::Deserialize(const string &payload)
{
...
string DescribePublicConfigReleasesResponse::ToJsonString() const
{
...
TsfPageConfigRelease DescribePublicConfigReleasesResponse::GetResult() const
{
    return m_result;
}

bool DescribePublicConfigReleasesResponse::ResultHasBeenSet() const
{
