...
CoreInternalOutcome DescribeDeliveryConfigByGroupIdResponse::Deserialize(const string &payload)
{
...
string DescribeDeliveryConfigByGroupIdResponse::ToJsonString() const
{
...
SimpleKafkaDeliveryConfig DescribeDeliveryConfigByGroupIdResponse::GetResult() const
{
    return m_result;
}

bool DescribeDeliveryConfigByGroupIdResponse::ResultHasBeenSet() const
{
