...
CoreInternalOutcome ModifyTaskResponse::Deserialize(const string &payload)
{
...
string ModifyTaskResponse::ToJsonString() const
{
...
bool ModifyTaskResponse::GetResult() const
{
    return m_result;
}

bool ModifyTaskResponse::ResultHasBeenSet() const
{
