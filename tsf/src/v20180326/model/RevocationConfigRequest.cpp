...
string RevocationConfigRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_configReleaseIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_configReleaseId.c_str(), allocator).Move(), allocator);
    }
...
string RevocationConfigRequest::GetConfigReleaseId() const
{
    return m_configReleaseId;
}

void RevocationConfigRequest::SetConfigReleaseId(const string& _configReleaseId)
{
    m_configReleaseId = _configReleaseId;
    m_configReleaseIdHasBeenSet = true;
}

bool RevocationConfigRequest::ConfigReleaseIdHasBeenSet() const
{
