...
CoreInternalOutcome DisassociateBusinessLogConfigResponse::Deserialize(const string &payload)
{
...
string DisassociateBusinessLogConfigResponse::ToJsonString() const
{
...
bool DisassociateBusinessLogConfigResponse::GetResult() const
{
    return m_result;
}

bool DisassociateBusinessLogConfigResponse::ResultHasBeenSet() const
{
