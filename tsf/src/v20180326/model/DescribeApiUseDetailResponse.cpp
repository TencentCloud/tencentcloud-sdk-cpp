...
CoreInternalOutcome DescribeApiUseDetailResponse::Deserialize(const string &payload)
{
...
string DescribeApiUseDetailResponse::ToJsonString() const
{
...
GroupApiUseStatistics DescribeApiUseDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeApiUseDetailResponse::ResultHasBeenSet() const
{
