...
CoreInternalOutcome RollbackConfigResponse::Deserialize(const string &payload)
{
...
string RollbackConfigResponse::ToJsonString() const
{
...
bool RollbackConfigResponse::GetResult() const
{
    return m_result;
}

bool RollbackConfigResponse::ResultHasBeenSet() const
{
