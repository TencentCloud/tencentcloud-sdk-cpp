...
CoreInternalOutcome DescribeApplicationBusinessLogConfigResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationBusinessLogConfigResponse::ToJsonString() const
{
