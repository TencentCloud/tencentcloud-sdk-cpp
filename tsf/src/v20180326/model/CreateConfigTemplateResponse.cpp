...
CoreInternalOutcome CreateConfigTemplateResponse::Deserialize(const string &payload)
{
...
string CreateConfigTemplateResponse::ToJsonString() const
{
...
bool CreateConfigTemplateResponse::GetResult() const
{
    return m_result;
}

bool CreateConfigTemplateResponse::ResultHasBeenSet() const
{
