...
CoreInternalOutcome UpdateRepositoryResponse::Deserialize(const string &payload)
{
...
string UpdateRepositoryResponse::ToJsonString() const
{
...
bool UpdateRepositoryResponse::GetResult() const
{
    return m_result;
}

bool UpdateRepositoryResponse::ResultHasBeenSet() const
{
