...
CoreInternalOutcome CreateApiRateLimitRuleResponse::Deserialize(const string &payload)
{
...
string CreateApiRateLimitRuleResponse::ToJsonString() const
{
...
bool CreateApiRateLimitRuleResponse::GetResult() const
{
    return m_result;
}

bool CreateApiRateLimitRuleResponse::ResultHasBeenSet() const
{
