...
CoreInternalOutcome ModifyContainerGroupResponse::Deserialize(const string &payload)
{
...
string ModifyContainerGroupResponse::ToJsonString() const
{
...
bool ModifyContainerGroupResponse::GetResult() const
{
    return m_result;
}

bool ModifyContainerGroupResponse::ResultHasBeenSet() const
{
