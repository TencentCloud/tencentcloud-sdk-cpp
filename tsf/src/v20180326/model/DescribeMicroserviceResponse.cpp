...
CoreInternalOutcome DescribeMicroserviceResponse::Deserialize(const string &payload)
{
...
string DescribeMicroserviceResponse::ToJsonString() const
{
...
TsfPageMsInstance DescribeMicroserviceResponse::GetResult() const
{
    return m_result;
}

bool DescribeMicroserviceResponse::ResultHasBeenSet() const
{
