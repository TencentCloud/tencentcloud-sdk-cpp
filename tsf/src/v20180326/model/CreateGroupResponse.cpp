...
CoreInternalOutcome CreateGroupResponse::Deserialize(const string &payload)
{
...
string CreateGroupResponse::ToJsonString() const
{
...
string CreateGroupResponse::GetResult() const
{
    return m_result;
}

bool CreateGroupResponse::ResultHasBeenSet() const
{
