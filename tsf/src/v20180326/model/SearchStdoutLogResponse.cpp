...
CoreInternalOutcome SearchStdoutLogResponse::Deserialize(const string &payload)
{
...
string SearchStdoutLogResponse::ToJsonString() const
{
...
TsfPageStdoutLogV2 SearchStdoutLogResponse::GetResult() const
{
    return m_result;
}

bool SearchStdoutLogResponse::ResultHasBeenSet() const
{
