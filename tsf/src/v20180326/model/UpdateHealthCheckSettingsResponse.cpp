...
CoreInternalOutcome UpdateHealthCheckSettingsResponse::Deserialize(const string &payload)
{
...
string UpdateHealthCheckSettingsResponse::ToJsonString() const
{
...
bool UpdateHealthCheckSettingsResponse::GetResult() const
{
    return m_result;
}

bool UpdateHealthCheckSettingsResponse::ResultHasBeenSet() const
{
