...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKBATCHREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKBATCHREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class StopTaskBatchRequest : public AbstractModel
                {
                public:
                    StopTaskBatchRequest();
                    ~StopTaskBatchRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKBATCHREQUEST_H_
