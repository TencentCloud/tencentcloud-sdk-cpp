...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_REVOCATIONPUBLICCONFIGREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_REVOCATIONPUBLICCONFIGREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class RevocationPublicConfigRequest : public AbstractModel
                {
                public:
                    RevocationPublicConfigRequest();
                    ~RevocationPublicConfigRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_REVOCATIONPUBLICCONFIGREQUEST_H_
