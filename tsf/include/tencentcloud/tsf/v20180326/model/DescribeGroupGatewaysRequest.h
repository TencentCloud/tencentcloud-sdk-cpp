...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPGATEWAYSREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPGATEWAYSREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeGroupGatewaysRequest : public AbstractModel
                {
                public:
                    DescribeGroupGatewaysRequest();
                    ~DescribeGroupGatewaysRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPGATEWAYSREQUEST_H_
