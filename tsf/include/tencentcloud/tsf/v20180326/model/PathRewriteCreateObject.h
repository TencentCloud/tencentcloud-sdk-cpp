...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_PATHREWRITECREATEOBJECT_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_PATHREWRITECREATEOBJECT_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * 路径重写创建对象
                */
                class PathRewriteCreateObject : public AbstractModel
                {
                public:
                    PathRewriteCreateObject();
                    ~PathRewriteCreateObject() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_PATHREWRITECREATEOBJECT_H_
