...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_CREATEAPIRATELIMITRULEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_CREATEAPIRATELIMITRULEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class CreateApiRateLimitRuleRequest : public AbstractModel
                {
                public:
                    CreateApiRateLimitRuleRequest();
                    ~CreateApiRateLimitRuleRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_CREATEAPIRATELIMITRULEREQUEST_H_
