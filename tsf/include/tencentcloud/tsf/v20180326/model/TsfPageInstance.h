...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEINSTANCE_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEINSTANCE_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * TSF机器实例分页对象
                */
                class TsfPageInstance : public AbstractModel
                {
                public:
                    TsfPageInstance();
                    ~TsfPageInstance() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEINSTANCE_H_
