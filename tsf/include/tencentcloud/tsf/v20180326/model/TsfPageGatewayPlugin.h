...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEGATEWAYPLUGIN_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEGATEWAYPLUGIN_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * GatewayPlugin 翻页对象
                */
                class TsfPageGatewayPlugin : public AbstractModel
                {
                public:
                    TsfPageGatewayPlugin();
                    ~TsfPageGatewayPlugin() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_TSFPAGEGATEWAYPLUGIN_H_
