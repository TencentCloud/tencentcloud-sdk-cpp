...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITNAMESPACESREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITNAMESPACESREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeUnitNamespacesRequest : public AbstractModel
                {
                public:
                    DescribeUnitNamespacesRequest();
                    ~DescribeUnitNamespacesRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITNAMESPACESREQUEST_H_
