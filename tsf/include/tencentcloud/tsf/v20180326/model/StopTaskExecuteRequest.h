...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKEXECUTEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKEXECUTEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class StopTaskExecuteRequest : public AbstractModel
                {
                public:
                    StopTaskExecuteRequest();
                    ~StopTaskExecuteRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取任务执行ID。在[任务管理](https://console.cloud.tencent.com/tsf/tct?rid=1)页面点击任务ID进入任务详情，进入执行记录页，点击批次ID进入执行详情列表页，第一列即为任务执行ID。
                     * @return ExecuteId 任务执行ID。在[任务管理](https://console.cloud.tencent.com/tsf/tct?rid=1)页面点击任务ID进入任务详情，进入执行记录页，点击批次ID进入执行详情列表页，第一列即为任务执行ID。
                     * 
                     */
                    std::string GetExecuteId() const;

                    /**
                     * 设置任务执行ID。在[任务管理](https://console.cloud.tencent.com/tsf/tct?rid=1)页面点击任务ID进入任务详情，进入执行记录页，点击批次ID进入执行详情列表页，第一列即为任务执行ID。
                    ...
                    /**
                     * 获取任务ID。在[任务管理](https://console.cloud.tencent.com/tsf/tct?rid=1)列表页面可以查看任务ID。
                    ...
                    /**
                     * 设置任务ID。在[任务管理](https://console.cloud.tencent.com/tsf/tct?rid=1)列表页面可以查看任务ID。
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_STOPTASKEXECUTEREQUEST_H_
