...
CoreInternalOutcome AccountTipoffAccessResponse::Deserialize(const string &payload)
{
...
string AccountTipoffAccessResponse::ToJsonString() const
{
...
TipoffResponse AccountTipoffAccessResponse::GetData() const
{
    return m_data;
}

bool AccountTipoffAccessResponse::DataHasBeenSet() const
{
