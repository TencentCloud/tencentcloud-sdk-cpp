            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 设置<p>号码拉入黑名单统计。</p><p>单位：个</p>
                     * @param _blackListCount <p>号码拉入黑名单统计。</p><p>单位：个</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>运营商频率限制数</p><p>单位：个</p>
                     * @param _frequencyLimitCount <p>运营商频率限制数</p><p>单位：个</p>
                     * 
                     */
