...
#ifndef TENCENTCLOUD_SMS_V20190711_MODEL_DELETESIGNSTATUS_H_
#define TENCENTCLOUD_SMS_V20190711_MODEL_DELETESIGNSTATUS_H_
    ...
    namespace Sms
    {
        namespace V20190711
        {
            namespace Model
            {
                ...
                * 删除签名响应
                */
                class DeleteSignStatus : public AbstractModel
                {
                public:
                    DeleteSignStatus();
                    ~DeleteSignStatus() = default;
...
#endif // !TENCENTCLOUD_SMS_V20190711_MODEL_DELETESIGNSTATUS_H_
