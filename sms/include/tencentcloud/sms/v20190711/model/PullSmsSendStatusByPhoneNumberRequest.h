...
#ifndef TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSBYPHONENUMBERREQUEST_H_
#define TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSBYPHONENUMBERREQUEST_H_
...
注：目前固定设置为0。
                    ...
                    /**
                     * 获取短信SdkAppid在 [短信控制台](https://console.cloud.tencent.com/sms/smslist) 添加应用后生成的实际SdkAppid，例如1400006666。
                    ...
                    /**
                     * 设置短信SdkAppid在 [短信控制台](https://console.cloud.tencent.com/sms/smslist) 添加应用后生成的实际SdkAppid，例如1400006666。
...
#endif // !TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSBYPHONENUMBERREQUEST_H_
