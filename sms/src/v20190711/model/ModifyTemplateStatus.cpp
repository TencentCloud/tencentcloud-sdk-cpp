...
CoreInternalOutcome ModifyTemplateStatus::Deserialize(const Value &value)
{
    string requestId = "";
...
void ModifyTemplateStatus::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
