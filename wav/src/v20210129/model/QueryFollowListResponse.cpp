...
QueryFollowListResponse::QueryFollowListResponse() :
...
CoreInternalOutcome QueryFollowListResponse::Deserialize(const string &payload)
{
...
string QueryFollowListResponse::ToJsonString() const
{
...
string QueryFollowListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryFollowListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<FollowInfo> QueryFollowListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryFollowListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

uint64_t QueryFollowListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool QueryFollowListResponse::HasMoreHasBeenSet() const
{
