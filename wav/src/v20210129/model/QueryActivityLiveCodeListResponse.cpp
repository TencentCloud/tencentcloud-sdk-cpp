...
CoreInternalOutcome QueryActivityLiveCodeListResponse::Deserialize(const string &payload)
{
...
string QueryActivityLiveCodeListResponse::ToJsonString() const
{
...
string QueryActivityLiveCodeListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryActivityLiveCodeListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<LiveCodeDetail> QueryActivityLiveCodeListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryActivityLiveCodeListResponse::PageDataHasBeenSet() const
{
