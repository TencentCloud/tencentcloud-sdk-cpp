...
CoreInternalOutcome QueryExternalContactListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("PageData") && !rsp["PageData"].IsNull())
    {
        ...
        {
            ExternalContactSimpleInfo item;
...
string QueryExternalContactListResponse::ToJsonString() const
{
...
vector<ExternalContactSimpleInfo> QueryExternalContactListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryExternalContactListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

string QueryExternalContactListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryExternalContactListResponse::NextCursorHasBeenSet() const
{
