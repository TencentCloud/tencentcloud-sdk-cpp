...
CoreInternalOutcome QueryExternalUserEventListResponse::Deserialize(const string &payload)
{
...
string QueryExternalUserEventListResponse::ToJsonString() const
{
...
string QueryExternalUserEventListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryExternalUserEventListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ExternalUserEventInfo> QueryExternalUserEventListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryExternalUserEventListResponse::PageDataHasBeenSet() const
{
