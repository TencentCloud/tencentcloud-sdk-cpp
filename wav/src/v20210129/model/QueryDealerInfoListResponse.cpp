...
CoreInternalOutcome QueryDealerInfoListResponse::Deserialize(const string &payload)
{
...
string QueryDealerInfoListResponse::ToJsonString() const
{
...
vector<DealerInfo> QueryDealerInfoListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryDealerInfoListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

string QueryDealerInfoListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryDealerInfoListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

uint64_t QueryDealerInfoListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool QueryDealerInfoListResponse::HasMoreHasBeenSet() const
{
