...
CoreInternalOutcome QueryChatArchivingListResponse::Deserialize(const string &payload)
{
...
string QueryChatArchivingListResponse::ToJsonString() const
{
...
string QueryChatArchivingListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryChatArchivingListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ChatArchivingDetail> QueryChatArchivingListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryChatArchivingListResponse::PageDataHasBeenSet() const
{
