...
CoreInternalOutcome QueryChannelCodeListResponse::Deserialize(const string &payload)
{
...
string QueryChannelCodeListResponse::ToJsonString() const
{
...
string QueryChannelCodeListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryChannelCodeListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ChannelCodeInnerDetail> QueryChannelCodeListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryChannelCodeListResponse::PageDataHasBeenSet() const
{
