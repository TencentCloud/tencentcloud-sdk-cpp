...
CoreInternalOutcome QueryClueInfoListResponse::Deserialize(const string &payload)
{
...
string QueryClueInfoListResponse::ToJsonString() const
{
...
vector<ClueInfoDetail> QueryClueInfoListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryClueInfoListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

string QueryClueInfoListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryClueInfoListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

uint64_t QueryClueInfoListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool QueryClueInfoListResponse::HasMoreHasBeenSet() const
{
