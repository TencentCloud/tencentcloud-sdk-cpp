...
QueryArrivalListResponse::QueryArrivalListResponse() :
...
CoreInternalOutcome QueryArrivalListResponse::Deserialize(const string &payload)
{
...
string QueryArrivalListResponse::ToJsonString() const
{
...
string QueryArrivalListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryArrivalListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ArrivalInfo> QueryArrivalListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryArrivalListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

uint64_t QueryArrivalListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool QueryArrivalListResponse::HasMoreHasBeenSet() const
{
