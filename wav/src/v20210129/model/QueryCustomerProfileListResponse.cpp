...
QueryCustomerProfileListResponse::QueryCustomerProfileListResponse() :
    m_nextCursorHasBeenSet(false),
    m_pageDataHasBeenSet(false)
{
}

CoreInternalOutcome QueryCustomerProfileListResponse::Deserialize(const string &payload)
{
...
string QueryCustomerProfileListResponse::ToJsonString() const
{
...
string QueryCustomerProfileListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryCustomerProfileListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<CustomerProfile> QueryCustomerProfileListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryCustomerProfileListResponse::PageDataHasBeenSet() const
{
