...
CoreInternalOutcome QueryCustomerEventDetailStatisticsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("PageData") && !rsp["PageData"].IsNull())
    {
        ...
        {
            CustomerActionEventDetail item;
...
string QueryCustomerEventDetailStatisticsResponse::ToJsonString() const
{
...
string QueryCustomerEventDetailStatisticsResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryCustomerEventDetailStatisticsResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<CustomerActionEventDetail> QueryCustomerEventDetailStatisticsResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryCustomerEventDetailStatisticsResponse::PageDataHasBeenSet() const
{
