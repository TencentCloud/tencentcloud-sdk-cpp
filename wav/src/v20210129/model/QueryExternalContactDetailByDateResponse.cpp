...
QueryExternalContactDetailByDateResponse::QueryExternalContactDetailByDateResponse() :
    m_nextCursorHasBeenSet(false),
    m_pageDataHasBeenSet(false)
{
}

CoreInternalOutcome QueryExternalContactDetailByDateResponse::Deserialize(const string &payload)
{
...
string QueryExternalContactDetailByDateResponse::ToJsonString() const
{
...
string QueryExternalContactDetailByDateResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryExternalContactDetailByDateResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ExternalContactDetailPro> QueryExternalContactDetailByDateResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryExternalContactDetailByDateResponse::PageDataHasBeenSet() const
{
