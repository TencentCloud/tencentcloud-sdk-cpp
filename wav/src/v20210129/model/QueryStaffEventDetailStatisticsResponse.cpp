...
CoreInternalOutcome QueryStaffEventDetailStatisticsResponse::Deserialize(const string &payload)
{
...
string QueryStaffEventDetailStatisticsResponse::ToJsonString() const
{
...
string QueryStaffEventDetailStatisticsResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryStaffEventDetailStatisticsResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<SalesActionEventDetail> QueryStaffEventDetailStatisticsResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryStaffEventDetailStatisticsResponse::PageDataHasBeenSet() const
{
