...
CoreInternalOutcome QueryUserInfoListResponse::Deserialize(const string &payload)
{
...
string QueryUserInfoListResponse::ToJsonString() const
{
...
string QueryUserInfoListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryUserInfoListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<CorpUserInfo> QueryUserInfoListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryUserInfoListResponse::PageDataHasBeenSet() const
{
