...
CoreInternalOutcome QueryMiniAppCodeListResponse::Deserialize(const string &payload)
{
...
string QueryMiniAppCodeListResponse::ToJsonString() const
{
...
string QueryMiniAppCodeListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryMiniAppCodeListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<MiniAppCodeInfo> QueryMiniAppCodeListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryMiniAppCodeListResponse::PageDataHasBeenSet() const
{
