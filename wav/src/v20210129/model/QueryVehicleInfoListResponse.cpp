...
CoreInternalOutcome QueryVehicleInfoListResponse::Deserialize(const string &payload)
{
...
string QueryVehicleInfoListResponse::ToJsonString() const
{
...
vector<VehicleInfo> QueryVehicleInfoListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryVehicleInfoListResponse::PageDataHasBeenSet() const
{
    return m_pageDataHasBeenSet;
}

string QueryVehicleInfoListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryVehicleInfoListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

uint64_t QueryVehicleInfoListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool QueryVehicleInfoListResponse::HasMoreHasBeenSet() const
{
