...
CoreInternalOutcome QueryMaterialListResponse::Deserialize(const string &payload)
{
...
string QueryMaterialListResponse::ToJsonString() const
{
...
string QueryMaterialListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryMaterialListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<MaterialInfo> QueryMaterialListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryMaterialListResponse::PageDataHasBeenSet() const
{
