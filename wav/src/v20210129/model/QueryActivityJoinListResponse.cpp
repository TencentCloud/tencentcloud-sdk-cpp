...
CoreInternalOutcome QueryActivityJoinListResponse::Deserialize(const string &payload)
{
...
string QueryActivityJoinListResponse::ToJsonString() const
{
...
string QueryActivityJoinListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool QueryActivityJoinListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

vector<ActivityJoinDetail> QueryActivityJoinListResponse::GetPageData() const
{
    return m_pageData;
}

bool QueryActivityJoinListResponse::PageDataHasBeenSet() const
{
