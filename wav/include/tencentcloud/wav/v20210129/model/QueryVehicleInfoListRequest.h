...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryVehicleInfoListRequest : public AbstractModel
                {
                public:
                    QueryVehicleInfoListRequest();
                    ~QueryVehicleInfoListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTREQUEST_H_
