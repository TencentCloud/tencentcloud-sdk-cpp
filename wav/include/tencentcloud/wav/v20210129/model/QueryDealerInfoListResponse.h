...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYDEALERINFOLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYDEALERINFOLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryDealerInfoListResponse : public AbstractModel
                {
                public:
                    QueryDealerInfoListResponse();
                    ~QueryDealerInfoListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<DealerInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYDEALERINFOLISTRESPONSE_H_
