...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryActivityLiveCodeListResponse : public AbstractModel
                {
                public:
                    QueryActivityLiveCodeListResponse();
                    ~QueryActivityLiveCodeListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<LiveCodeDetail> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<LiveCodeDetail> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTRESPONSE_H_
