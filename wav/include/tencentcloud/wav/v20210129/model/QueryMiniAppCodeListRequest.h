...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryMiniAppCodeListRequest : public AbstractModel
                {
                public:
                    QueryMiniAppCodeListRequest();
                    ~QueryMiniAppCodeListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTREQUEST_H_
