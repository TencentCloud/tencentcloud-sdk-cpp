...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMERPROFILELISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMERPROFILELISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryCustomerProfileListRequest : public AbstractModel
                {
                public:
                    QueryCustomerProfileListRequest();
                    ~QueryCustomerProfileListRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取分页，预期请求的数据量，取值范围 1 ~ 1000
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMERPROFILELISTREQUEST_H_
