...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTDETAILBYDATEREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTDETAILBYDATEREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryExternalContactDetailByDateRequest : public AbstractModel
                {
                public:
                    QueryExternalContactDetailByDateRequest();
                    ~QueryExternalContactDetailByDateRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取查询结束时间， 单位秒
                     * @return BeginTime 查询结束时间， 单位秒
                     * 
                     */
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTDETAILBYDATEREQUEST_H_
