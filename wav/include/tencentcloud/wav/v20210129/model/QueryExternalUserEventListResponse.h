...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALUSEREVENTLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALUSEREVENTLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryExternalUserEventListResponse : public AbstractModel
                {
                public:
                    QueryExternalUserEventListResponse();
                    ~QueryExternalUserEventListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取外部联系人事件信息响应数据
注意：此字段可能返回 null，表示取不到有效值。
                     * @return PageData 外部联系人事件信息响应数据
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ExternalUserEventInfo> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ExternalUserEventInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALUSEREVENTLISTRESPONSE_H_
