...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryExternalContactListResponse : public AbstractModel
                {
                public:
                    QueryExternalContactListResponse();
                    ~QueryExternalContactListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * @return PageData 外部联系人信息列表
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ExternalContactSimpleInfo> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ExternalContactSimpleInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTRESPONSE_H_
