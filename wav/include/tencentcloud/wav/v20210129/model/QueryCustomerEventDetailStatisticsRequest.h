...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMEREVENTDETAILSTATISTICSREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMEREVENTDETAILSTATISTICSREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryCustomerEventDetailStatisticsRequest : public AbstractModel
                {
                public:
                    QueryCustomerEventDetailStatisticsRequest();
                    ~QueryCustomerEventDetailStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCUSTOMEREVENTDETAILSTATISTICSREQUEST_H_
