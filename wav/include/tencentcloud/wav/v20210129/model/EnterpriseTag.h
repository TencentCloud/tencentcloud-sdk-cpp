...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_ENTERPRISETAG_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_ENTERPRISETAG_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                * 客户企业标签
                */
                class EnterpriseTag : public AbstractModel
                {
                public:
                    EnterpriseTag();
                    ~EnterpriseTag() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取该客户档案当前已成功关联的企业标签分组名称
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_ENTERPRISETAG_H_
