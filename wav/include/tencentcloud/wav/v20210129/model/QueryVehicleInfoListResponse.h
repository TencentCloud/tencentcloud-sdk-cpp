...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryVehicleInfoListResponse : public AbstractModel
                {
                public:
                    QueryVehicleInfoListResponse();
                    ~QueryVehicleInfoListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<VehicleInfo> GetPageData() const;
                    ...
                    /**
                     * 获取分页游标，下次调用带上该值，则从当前的位置继续往后拉取新增的数据，以实现增量拉取。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<VehicleInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYVEHICLEINFOLISTRESPONSE_H_
