...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYSTAFFEVENTDETAILSTATISTICSREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYSTAFFEVENTDETAILSTATISTICSREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryStaffEventDetailStatisticsRequest : public AbstractModel
                {
                public:
                    QueryStaffEventDetailStatisticsRequest();
                    ~QueryStaffEventDetailStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYSTAFFEVENTDETAILSTATISTICSREQUEST_H_
