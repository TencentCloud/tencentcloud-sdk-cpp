...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCRMSTATISTICSRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCRMSTATISTICSRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryCrmStatisticsResponse : public AbstractModel
                {
                public:
                    QueryCrmStatisticsResponse();
                    ~QueryCrmStatisticsResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取CRM统计响应数据
注意：此字段可能返回 null，表示取不到有效值。
                     * @return PageData CRM统计响应数据
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<CrmStatisticsData> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<CrmStatisticsData> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCRMSTATISTICSRESPONSE_H_
