...
ModifyPGInstanceSpecResponse::ModifyPGInstanceSpecResponse() :
    m_dealNameHasBeenSet(false),
    m_billIdHasBeenSet(false)
{
}

CoreInternalOutcome ModifyPGInstanceSpecResponse::Deserialize(const string &payload)
{
...
string ModifyPGInstanceSpecResponse::ToJsonString() const
{
...
string ModifyPGInstanceSpecResponse::GetDealName() const
{
    return m_dealName;
}

bool ModifyPGInstanceSpecResponse::DealNameHasBeenSet() const
{
    return m_dealNameHasBeenSet;
}

string ModifyPGInstanceSpecResponse::GetBillId() const
{
    return m_billId;
}

bool ModifyPGInstanceSpecResponse::BillIdHasBeenSet() const
{
