...
CoreInternalOutcome EstablishCloudBaseRunServerResponse::Deserialize(const string &payload)
{
...
string EstablishCloudBaseRunServerResponse::ToJsonString() const
{
...
string EstablishCloudBaseRunServerResponse::GetResult() const
{
    return m_result;
}

bool EstablishCloudBaseRunServerResponse::ResultHasBeenSet() const
{
