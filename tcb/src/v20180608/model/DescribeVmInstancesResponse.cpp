...
DescribeVmInstancesResponse::DescribeVmInstancesResponse() :
    m_instanceListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeVmInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeVmInstancesResponse::ToJsonString() const
{
...
vector<VmInstance> DescribeVmInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeVmInstancesResponse::InstanceListHasBeenSet() const
{
