...
vector<TableInfo> DescribeTablesResponse::GetTables() const
{
    return m_tables;
}

bool DescribeTablesResponse::TablesHasBeenSet() const
{
    return m_tablesHasBeenSet;
}

Pager DescribeTablesResponse::GetPager() const
{
    return m_pager;
}

bool DescribeTablesResponse::PagerHasBeenSet() const
{
