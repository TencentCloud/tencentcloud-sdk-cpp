...
CoreInternalOutcome PlatformStatistic::Deserialize(const Value &value)
{
    string requestId = "";
...
void PlatformStatistic::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
