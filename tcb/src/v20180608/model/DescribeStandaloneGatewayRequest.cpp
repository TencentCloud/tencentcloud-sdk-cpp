...
string DescribeStandaloneGatewayRequest::ToJsonString() const
{
...
string DescribeStandaloneGatewayRequest::GetEnvId() const
{
    return m_envId;
}

void DescribeStandaloneGatewayRequest::SetEnvId(const string& _envId)
{
    m_envId = _envId;
    m_envIdHasBeenSet = true;
}

bool DescribeStandaloneGatewayRequest::EnvIdHasBeenSet() const
{
    return m_envIdHasBeenSet;
}

string DescribeStandaloneGatewayRequest::GetGatewayName() const
{
    return m_gatewayName;
}

void DescribeStandaloneGatewayRequest::SetGatewayName(const string& _gatewayName)
{
    m_gatewayName = _gatewayName;
    m_gatewayNameHasBeenSet = true;
}

bool DescribeStandaloneGatewayRequest::GatewayNameHasBeenSet() const
{
    return m_gatewayNameHasBeenSet;
}

string DescribeStandaloneGatewayRequest::GetGatewayAlias() const
{
    return m_gatewayAlias;
}

void DescribeStandaloneGatewayRequest::SetGatewayAlias(const string& _gatewayAlias)
{
    m_gatewayAlias = _gatewayAlias;
    m_gatewayAliasHasBeenSet = true;
}

bool DescribeStandaloneGatewayRequest::GatewayAliasHasBeenSet() const
{
