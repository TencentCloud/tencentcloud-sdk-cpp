...
string TurnOffStandaloneGatewayRequest::ToJsonString() const
{
...
string TurnOffStandaloneGatewayRequest::GetEnvId() const
{
    return m_envId;
}

void TurnOffStandaloneGatewayRequest::SetEnvId(const string& _envId)
{
    m_envId = _envId;
    m_envIdHasBeenSet = true;
}

bool TurnOffStandaloneGatewayRequest::EnvIdHasBeenSet() const
{
    return m_envIdHasBeenSet;
}

string TurnOffStandaloneGatewayRequest::GetGatewayName() const
{
    return m_gatewayName;
}

void TurnOffStandaloneGatewayRequest::SetGatewayName(const string& _gatewayName)
{
    m_gatewayName = _gatewayName;
    m_gatewayNameHasBeenSet = true;
}

bool TurnOffStandaloneGatewayRequest::GatewayNameHasBeenSet() const
{
    return m_gatewayNameHasBeenSet;
}

vector<string> TurnOffStandaloneGatewayRequest::GetServiceNameList() const
{
    return m_serviceNameList;
}

void TurnOffStandaloneGatewayRequest::SetServiceNameList(const vector<string>& _serviceNameList)
{
    m_serviceNameList = _serviceNameList;
    m_serviceNameListHasBeenSet = true;
}

bool TurnOffStandaloneGatewayRequest::ServiceNameListHasBeenSet() const
{
