...
CoreInternalOutcome DescribeCloudBaseRunResourceResponse::Deserialize(const string &payload)
{
...
string DescribeCloudBaseRunResourceResponse::ToJsonString() const
{
...
string DescribeCloudBaseRunResourceResponse::GetClusterStatus() const
{
    return m_clusterStatus;
}

bool DescribeCloudBaseRunResourceResponse::ClusterStatusHasBeenSet() const
{
    return m_clusterStatusHasBeenSet;
}

string DescribeCloudBaseRunResourceResponse::GetVirtualClusterId() const
{
    return m_virtualClusterId;
}

bool DescribeCloudBaseRunResourceResponse::VirtualClusterIdHasBeenSet() const
{
    return m_virtualClusterIdHasBeenSet;
}

string DescribeCloudBaseRunResourceResponse::GetVpcId() const
{
    return m_vpcId;
}

bool DescribeCloudBaseRunResourceResponse::VpcIdHasBeenSet() const
{
    return m_vpcIdHasBeenSet;
}

string DescribeCloudBaseRunResourceResponse::GetRegion() const
{
    return m_region;
}

bool DescribeCloudBaseRunResourceResponse::RegionHasBeenSet() const
{
    return m_regionHasBeenSet;
}

vector<CloudBaseRunVpcSubnet> DescribeCloudBaseRunResourceResponse::GetSubnetIds() const
{
    return m_subnetIds;
}

bool DescribeCloudBaseRunResourceResponse::SubnetIdsHasBeenSet() const
{
