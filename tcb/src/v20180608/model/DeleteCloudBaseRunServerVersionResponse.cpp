...
CoreInternalOutcome DeleteCloudBaseRunServerVersionResponse::Deserialize(const string &payload)
{
...
string DeleteCloudBaseRunServerVersionResponse::ToJsonString() const
{
...
string DeleteCloudBaseRunServerVersionResponse::GetResult() const
{
    return m_result;
}

bool DeleteCloudBaseRunServerVersionResponse::ResultHasBeenSet() const
{
