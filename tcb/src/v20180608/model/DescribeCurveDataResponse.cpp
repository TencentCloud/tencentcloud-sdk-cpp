...
CoreInternalOutcome DescribeCurveDataResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Statistics"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `Statistics` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_statistics = string(rsp["Statistics"].GetString());
...
string DescribeCurveDataResponse::ToJsonString() const
{
    ...
    if (m_statisticsHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_statistics.c_str(), allocator).Move(), allocator);
    }
...
string DescribeCurveDataResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeCurveDataResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeCurveDataResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeCurveDataResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

string DescribeCurveDataResponse::GetMetricName() const
{
    return m_metricName;
}

bool DescribeCurveDataResponse::MetricNameHasBeenSet() const
{
    return m_metricNameHasBeenSet;
}

uint64_t DescribeCurveDataResponse::GetPeriod() const
{
    return m_period;
}

bool DescribeCurveDataResponse::PeriodHasBeenSet() const
{
    return m_periodHasBeenSet;
}

vector<int64_t> DescribeCurveDataResponse::GetValues() const
{
    return m_values;
}

bool DescribeCurveDataResponse::ValuesHasBeenSet() const
{
    return m_valuesHasBeenSet;
}

vector<int64_t> DescribeCurveDataResponse::GetTime() const
{
    return m_time;
}
...
string DescribeCurveDataResponse::GetStatistics() const
{
    return m_statistics;
}

bool DescribeCurveDataResponse::StatisticsHasBeenSet() const
{
