...
CoreInternalOutcome DescribeDownloadFileResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("FilePath") && !rsp["FilePath"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FilePath` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_filePath = string(rsp["FilePath"].GetString());
        m_filePathHasBeenSet = true;
    }

    if (rsp.HasMember("CustomKey") && !rsp["CustomKey"].IsNull())
    {
        if (!rsp["CustomKey"].IsString())
        {
            return CoreInternalOutcome(Error("response `CustomKey` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_customKey = string(rsp["CustomKey"].GetString());
...
string DescribeDownloadFileResponse::ToJsonString() const
{
...
string DescribeDownloadFileResponse::GetFilePath() const
{
    return m_filePath;
}

bool DescribeDownloadFileResponse::FilePathHasBeenSet() const
{
    return m_filePathHasBeenSet;
}

string DescribeDownloadFileResponse::GetCustomKey() const
{
    return m_customKey;
}

bool DescribeDownloadFileResponse::CustomKeyHasBeenSet() const
{
    return m_customKeyHasBeenSet;
}

string DescribeDownloadFileResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeDownloadFileResponse::DownloadUrlHasBeenSet() const
{
