...
DescribeCreditsUsageDetailResponse::DescribeCreditsUsageDetailResponse() :
    m_usagesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCreditsUsageDetailResponse::Deserialize(const string &payload)
{
...
string DescribeCreditsUsageDetailResponse::ToJsonString() const
{
...
vector<EnvPkgCreditsUsage> DescribeCreditsUsageDetailResponse::GetUsages() const
{
    return m_usages;
}

bool DescribeCreditsUsageDetailResponse::UsagesHasBeenSet() const
{
