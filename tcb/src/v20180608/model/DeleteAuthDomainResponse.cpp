...
CoreInternalOutcome DeleteAuthDomainResponse::Deserialize(const string &payload)
{
...
string DeleteAuthDomainResponse::ToJsonString() const
{
...
int64_t DeleteAuthDomainResponse::GetDeleted() const
{
    return m_deleted;
}

bool DeleteAuthDomainResponse::DeletedHasBeenSet() const
{
