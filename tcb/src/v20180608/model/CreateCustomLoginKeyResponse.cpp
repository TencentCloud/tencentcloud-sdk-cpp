...
CreateCustomLoginKeyResponse::CreateCustomLoginKeyResponse() :
    m_privateKeyHasBeenSet(false),
    m_keyIDHasBeenSet(false)
{
}

CoreInternalOutcome CreateCustomLoginKeyResponse::Deserialize(const string &payload)
{
...
string CreateCustomLoginKeyResponse::ToJsonString() const
{
...
string CreateCustomLoginKeyResponse::GetPrivateKey() const
{
    return m_privateKey;
}

bool CreateCustomLoginKeyResponse::PrivateKeyHasBeenSet() const
{
    return m_privateKeyHasBeenSet;
}

string CreateCustomLoginKeyResponse::GetKeyID() const
{
    return m_keyID;
}

bool CreateCustomLoginKeyResponse::KeyIDHasBeenSet() const
{
