...
CoreInternalOutcome CreateEnvResponse::Deserialize(const string &payload)
{
...
string CreateEnvResponse::ToJsonString() const
{
...
string CreateEnvResponse::GetEnvId() const
{
    return m_envId;
}

bool CreateEnvResponse::EnvIdHasBeenSet() const
{
