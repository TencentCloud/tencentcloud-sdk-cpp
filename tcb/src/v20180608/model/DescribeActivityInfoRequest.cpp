...
string DescribeActivityInfoRequest::ToJsonString() const
{
...
vector<int64_t> DescribeActivityInfoRequest::GetActivityIdList() const
{
    return m_activityIdList;
}

void DescribeActivityInfoRequest::SetActivityIdList(const vector<int64_t>& _activityIdList)
{
    m_activityIdList = _activityIdList;
    m_activityIdListHasBeenSet = true;
}

bool DescribeActivityInfoRequest::ActivityIdListHasBeenSet() const
{
