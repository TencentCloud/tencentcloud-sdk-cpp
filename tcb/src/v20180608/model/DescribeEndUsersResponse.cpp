...
CoreInternalOutcome DescribeEndUsersResponse::Deserialize(const string &payload)
{
...
string DescribeEndUsersResponse::ToJsonString() const
{
...
uint64_t DescribeEndUsersResponse::GetTotal() const
{
    return m_total;
}

bool DescribeEndUsersResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<EndUserInfo> DescribeEndUsersResponse::GetUsers() const
{
    return m_users;
}

bool DescribeEndUsersResponse::UsersHasBeenSet() const
{
