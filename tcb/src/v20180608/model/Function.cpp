...
#include <tencentcloud/tcb/v20180608/model/Function.h>
...
CoreInternalOutcome Function::Deserialize(const rapidjson::Value &value)
{
    ...
    {
        if (!value["TotalProvisionedConcurrencyMem"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `Function.TotalProvisionedConcurrencyMem` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_totalProvisionedConcurrencyMem = value["TotalProvisionedConcurrencyMem"].GetInt64();
    ...
    {
        if (!value["ReservedConcurrencyMem"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `Function.ReservedConcurrencyMem` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_reservedConcurrencyMem = value["ReservedConcurrencyMem"].GetInt64();
...
int64_t Function::GetTotalProvisionedConcurrencyMem() const
{
    return m_totalProvisionedConcurrencyMem;
}

void Function::SetTotalProvisionedConcurrencyMem(const int64_t& _totalProvisionedConcurrencyMem)
{
...
int64_t Function::GetReservedConcurrencyMem() const
{
    return m_reservedConcurrencyMem;
}

void Function::SetReservedConcurrencyMem(const int64_t& _reservedConcurrencyMem)
{
