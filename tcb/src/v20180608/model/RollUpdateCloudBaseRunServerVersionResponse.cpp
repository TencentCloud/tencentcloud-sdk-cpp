...
CoreInternalOutcome RollUpdateCloudBaseRunServerVersionResponse::Deserialize(const string &payload)
{
...
string RollUpdateCloudBaseRunServerVersionResponse::ToJsonString() const
{
...
string RollUpdateCloudBaseRunServerVersionResponse::GetResult() const
{
    return m_result;
}

bool RollUpdateCloudBaseRunServerVersionResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string RollUpdateCloudBaseRunServerVersionResponse::GetVersionName() const
{
    return m_versionName;
}

bool RollUpdateCloudBaseRunServerVersionResponse::VersionNameHasBeenSet() const
{
    return m_versionNameHasBeenSet;
}

string RollUpdateCloudBaseRunServerVersionResponse::GetRunId() const
{
    return m_runId;
}

bool RollUpdateCloudBaseRunServerVersionResponse::RunIdHasBeenSet() const
{
