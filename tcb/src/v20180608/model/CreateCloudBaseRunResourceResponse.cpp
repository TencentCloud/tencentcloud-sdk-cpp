...
CoreInternalOutcome CreateCloudBaseRunResourceResponse::Deserialize(const string &payload)
{
...
string CreateCloudBaseRunResourceResponse::ToJsonString() const
{
...
string CreateCloudBaseRunResourceResponse::GetResult() const
{
    return m_result;
}

bool CreateCloudBaseRunResourceResponse::ResultHasBeenSet() const
{
