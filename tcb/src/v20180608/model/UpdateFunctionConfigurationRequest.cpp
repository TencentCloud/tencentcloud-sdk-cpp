...
string UpdateFunctionConfigurationRequest::ToJsonString() const
{
    ...
    if (m_ignoreSysLogHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_ignoreSysLog.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_eipConfigHasBeenSet)
    {
        ...
        int i=0;
        for (auto itr = m_eipConfig.begin(); itr != m_eipConfig.end(); ++itr, ++i)
        {
            d[key.c_str()].PushBack(rapidjson::Value(rapidjson::kObjectType).Move(), allocator);
            (*itr).ToJsonObject(d[key.c_str()][i], allocator);
        }
...
string UpdateFunctionConfigurationRequest::GetEnvId() const
{
    return m_envId;
}

void UpdateFunctionConfigurationRequest::SetEnvId(const string& _envId)
{
    m_envId = _envId;
    m_envIdHasBeenSet = true;
}

bool UpdateFunctionConfigurationRequest::EnvIdHasBeenSet() const
{
...
FunctionEnvironment UpdateFunctionConfigurationRequest::GetEnvironment() const
{
    return m_environment;
}

void UpdateFunctionConfigurationRequest::SetEnvironment(const FunctionEnvironment& _environment)
{
...
FunctionVpcConfig UpdateFunctionConfigurationRequest::GetVpcConfig() const
{
    return m_vpcConfig;
}

void UpdateFunctionConfigurationRequest::SetVpcConfig(const FunctionVpcConfig& _vpcConfig)
{
...
FunctionPublicNetConfig UpdateFunctionConfigurationRequest::GetPublicNetConfig() const
{
    return m_publicNetConfig;
}

void UpdateFunctionConfigurationRequest::SetPublicNetConfig(const FunctionPublicNetConfig& _publicNetConfig)
{
...
vector<FunctionLayer> UpdateFunctionConfigurationRequest::GetLayers() const
{
    return m_layers;
}

void UpdateFunctionConfigurationRequest::SetLayers(const vector<FunctionLayer>& _layers)
{
    m_layers = _layers;
...
string UpdateFunctionConfigurationRequest::GetIgnoreSysLog() const
{
    return m_ignoreSysLog;
}

void UpdateFunctionConfigurationRequest::SetIgnoreSysLog(const string& _ignoreSysLog)
{
...
vector<FunctionEipConfigFixed> UpdateFunctionConfigurationRequest::GetEipConfig() const
{
    return m_eipConfig;
}

void UpdateFunctionConfigurationRequest::SetEipConfig(const vector<FunctionEipConfigFixed>& _eipConfig)
{
    m_eipConfig = _eipConfig;
    m_eipConfigHasBeenSet = true;
}

bool UpdateFunctionConfigurationRequest::EipConfigHasBeenSet() const
{
