...
DescribeCloudBaseRunBuildLogResponse::DescribeCloudBaseRunBuildLogResponse() :
    m_logHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCloudBaseRunBuildLogResponse::Deserialize(const string &payload)
{
...
string DescribeCloudBaseRunBuildLogResponse::ToJsonString() const
{
...
CloudBaseRunBuildLog DescribeCloudBaseRunBuildLogResponse::GetLog() const
{
    return m_log;
}

bool DescribeCloudBaseRunBuildLogResponse::LogHasBeenSet() const
{
