...
CreatePlatformEnvResponse::CreatePlatformEnvResponse() :
    m_envIdHasBeenSet(false)
{
}

CoreInternalOutcome CreatePlatformEnvResponse::Deserialize(const string &payload)
{
...
string CreatePlatformEnvResponse::ToJsonString() const
{
...
string CreatePlatformEnvResponse::GetEnvId() const
{
    return m_envId;
}

bool CreatePlatformEnvResponse::EnvIdHasBeenSet() const
{
