...
CoreInternalOutcome DeleteCloudBaseProjectLatestVersionResponse::Deserialize(const string &payload)
{
...
string DeleteCloudBaseProjectLatestVersionResponse::ToJsonString() const
{
