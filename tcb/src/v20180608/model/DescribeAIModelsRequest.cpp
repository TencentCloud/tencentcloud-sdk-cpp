...
string DescribeAIModelsRequest::GetEnvId() const
{
    return m_envId;
}

void DescribeAIModelsRequest::SetEnvId(const string& _envId)
{
    m_envId = _envId;
    m_envIdHasBeenSet = true;
}

bool DescribeAIModelsRequest::EnvIdHasBeenSet() const
{
