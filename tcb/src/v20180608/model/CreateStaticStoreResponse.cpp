...
CoreInternalOutcome CreateStaticStoreResponse::Deserialize(const string &payload)
{
...
string CreateStaticStoreResponse::ToJsonString() const
{
...
string CreateStaticStoreResponse::GetResult() const
{
    return m_result;
}

bool CreateStaticStoreResponse::ResultHasBeenSet() const
{
