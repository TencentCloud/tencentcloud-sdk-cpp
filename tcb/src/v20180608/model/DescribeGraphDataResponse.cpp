...
DescribeGraphDataResponse::DescribeGraphDataResponse() :
...
CoreInternalOutcome DescribeGraphDataResponse::Deserialize(const string &payload)
{
...
string DescribeGraphDataResponse::ToJsonString() const
{
...
string DescribeGraphDataResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeGraphDataResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeGraphDataResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeGraphDataResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

string DescribeGraphDataResponse::GetMetricName() const
{
    return m_metricName;
}

bool DescribeGraphDataResponse::MetricNameHasBeenSet() const
{
    return m_metricNameHasBeenSet;
}

uint64_t DescribeGraphDataResponse::GetPeriod() const
{
    return m_period;
}

bool DescribeGraphDataResponse::PeriodHasBeenSet() const
{
    return m_periodHasBeenSet;
}

vector<double> DescribeGraphDataResponse::GetValues() const
{
    return m_values;
}

bool DescribeGraphDataResponse::ValuesHasBeenSet() const
{
    return m_valuesHasBeenSet;
}

vector<int64_t> DescribeGraphDataResponse::GetTime() const
{
    return m_time;
}

bool DescribeGraphDataResponse::TimeHasBeenSet() const
{
