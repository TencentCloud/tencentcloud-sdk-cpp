...
InquireVmPriceResponse::InquireVmPriceResponse() :
...
CoreInternalOutcome InquireVmPriceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("OriginalCredits") && !rsp["OriginalCredits"].IsNull())
    {
        if (!rsp["OriginalCredits"].IsLosslessDouble())
        {
            return CoreInternalOutcome(Core::Error("response `OriginalCredits` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
        m_originalCredits = rsp["OriginalCredits"].GetDouble();
        m_originalCreditsHasBeenSet = true;
    }

    if (rsp.HasMember("DiscountCredits") && !rsp["DiscountCredits"].IsNull())
    {
        if (!rsp["DiscountCredits"].IsLosslessDouble())
        {
            return CoreInternalOutcome(Core::Error("response `DiscountCredits` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
        m_discountCredits = rsp["DiscountCredits"].GetDouble();
...
string InquireVmPriceResponse::ToJsonString() const
{
...
string InquireVmPriceResponse::GetCurrency() const
{
    return m_currency;
}

bool InquireVmPriceResponse::CurrencyHasBeenSet() const
{
    return m_currencyHasBeenSet;
}

double InquireVmPriceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquireVmPriceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

double InquireVmPriceResponse::GetDiscount() const
{
    return m_discount;
}

bool InquireVmPriceResponse::DiscountHasBeenSet() const
{
    return m_discountHasBeenSet;
}

double InquireVmPriceResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool InquireVmPriceResponse::DiscountPriceHasBeenSet() const
{
    return m_discountPriceHasBeenSet;
}

double InquireVmPriceResponse::GetOriginalCredits() const
{
    return m_originalCredits;
}

bool InquireVmPriceResponse::OriginalCreditsHasBeenSet() const
{
    return m_originalCreditsHasBeenSet;
}

double InquireVmPriceResponse::GetDiscountCredits() const
{
    return m_discountCredits;
}

bool InquireVmPriceResponse::DiscountCreditsHasBeenSet() const
{
