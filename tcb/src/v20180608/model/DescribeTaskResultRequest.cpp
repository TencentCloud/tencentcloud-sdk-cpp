...
string DescribeTaskResultRequest::GetEnvId() const
{
    return m_envId;
}

void DescribeTaskResultRequest::SetEnvId(const string& _envId)
{
    m_envId = _envId;
    m_envIdHasBeenSet = true;
}

bool DescribeTaskResultRequest::EnvIdHasBeenSet() const
{
