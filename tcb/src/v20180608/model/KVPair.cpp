...
CoreInternalOutcome KVPair::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Key") && !value["Key"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `KVPair.Key` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `KVPair.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void KVPair::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
