...
CoreInternalOutcome DestroyStaticStoreResponse::Deserialize(const string &payload)
{
...
string DestroyStaticStoreResponse::ToJsonString() const
{
...
string DestroyStaticStoreResponse::GetResult() const
{
    return m_result;
}

bool DestroyStaticStoreResponse::ResultHasBeenSet() const
{
