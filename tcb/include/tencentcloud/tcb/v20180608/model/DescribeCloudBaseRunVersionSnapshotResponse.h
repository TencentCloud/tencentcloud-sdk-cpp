...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDBASERUNVERSIONSNAPSHOTRESPONSE_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDBASERUNVERSIONSNAPSHOTRESPONSE_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudBaseRunVersionSnapshotResponse : public AbstractModel
                {
                public:
                    DescribeCloudBaseRunVersionSnapshotResponse();
                    ~DescribeCloudBaseRunVersionSnapshotResponse() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDBASERUNVERSIONSNAPSHOTRESPONSE_H_
