...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_CREATEAIMODELREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_CREATEAIMODELREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class CreateAIModelRequest : public AbstractModel
                {
                public:
                    CreateAIModelRequest();
                    ~CreateAIModelRequest() = default;
                    ...
                    /**
                     * 获取<p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
                    ...
                    /**
                     * 设置<p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_CREATEAIMODELREQUEST_H_
