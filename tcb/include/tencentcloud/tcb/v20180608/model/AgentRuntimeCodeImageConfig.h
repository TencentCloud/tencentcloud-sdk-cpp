...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_AGENTRUNTIMECODEIMAGECONFIG_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_AGENTRUNTIMECODEIMAGECONFIG_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                * Agent 创建云函数镜像配置
                */
                class AgentRuntimeCodeImageConfig : public AbstractModel
                {
                public:
                    AgentRuntimeCodeImageConfig();
                    ~AgentRuntimeCodeImageConfig() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_AGENTRUNTIMECODEIMAGECONFIG_H_
