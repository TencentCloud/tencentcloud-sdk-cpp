...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_FREEZECLOUDBASERUNSERVERSREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_FREEZECLOUDBASERUNSERVERSREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class FreezeCloudBaseRunServersRequest : public AbstractModel
                {
                public:
                    FreezeCloudBaseRunServersRequest();
                    ~FreezeCloudBaseRunServersRequest() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_FREEZECLOUDBASERUNSERVERSREQUEST_H_
