...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_PACKAGEFREEQUOTAINFO_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_PACKAGEFREEQUOTAINFO_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                * 后付费免费额度
                */
                class PackageFreeQuotaInfo : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_PACKAGEFREEQUOTAINFO_H_
