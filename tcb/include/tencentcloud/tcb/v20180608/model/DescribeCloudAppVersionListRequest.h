...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDAPPVERSIONLISTREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDAPPVERSIONLISTREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudAppVersionListRequest : public AbstractModel
                {
                public:
                    DescribeCloudAppVersionListRequest();
                    ~DescribeCloudAppVersionListRequest() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBECLOUDAPPVERSIONLISTREQUEST_H_
