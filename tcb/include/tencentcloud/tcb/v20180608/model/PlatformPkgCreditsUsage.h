...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_PLATFORMPKGCREDITSUSAGE_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_PLATFORMPKGCREDITSUSAGE_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class PlatformPkgCreditsUsage : public AbstractModel
                {
                public:
                    PlatformPkgCreditsUsage();
                    ~PlatformPkgCreditsUsage() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_PLATFORMPKGCREDITSUSAGE_H_
