...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_CREATEUSERREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_CREATEUSERREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取用户名，用户名规则：1. 长度1-64字符 2. 只能包含大小写英文字母、数字和符号 . _ - 3. 只能以字母或数字开头 4. 不能重复
                    ...
                    /**
                     * 设置用户名，用户名规则：1. 长度1-64字符 2. 只能包含大小写英文字母、数字和符号 . _ - 3. 只能以字母或数字开头 4. 不能重复
                    ...
                    /**
                     * 获取用户类型：internalUser-内部用户、externalUser-外部用户，默认internalUser（内部用户）
                    ...
                    /**
                     * 设置用户类型：internalUser-内部用户、externalUser-外部用户，默认internalUser（内部用户）
                    ...
                    /**
                     * 获取密码，传入Uid时密码可不传。密码规则：1. 长度8-32字符（推荐12位以上） 2. 不能以特殊字符开头 3. 至少包含以下四项中的三项：小写字母a-z、大写字母A-Z、数字0-9、特殊字符()!@#$%^&*\|?><_-
                    ...
                    /**
                     * 设置密码，传入Uid时密码可不传。密码规则：1. 长度8-32字符（推荐12位以上） 2. 不能以特殊字符开头 3. 至少包含以下四项中的三项：小写字母a-z、大写字母A-Z、数字0-9、特殊字符()!@#$%^&*\|?><_-
                    ...
                    /**
                     * 获取用户状态：ACTIVE（激活）、BLOCKED（冻结），默认激活
                    ...
                    /**
                     * 设置用户状态：ACTIVE（激活）、BLOCKED（冻结），默认激活
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_CREATEUSERREQUEST_H_
