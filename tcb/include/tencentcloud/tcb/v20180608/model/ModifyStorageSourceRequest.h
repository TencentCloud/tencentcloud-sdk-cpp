...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_MODIFYSTORAGESOURCEREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_MODIFYSTORAGESOURCEREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class ModifyStorageSourceRequest : public AbstractModel
                {
                public:
                    ModifyStorageSourceRequest();
                    ~ModifyStorageSourceRequest() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_MODIFYSTORAGESOURCEREQUEST_H_
