...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEPLATFORMCREDITSUSAGEDETAILREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEPLATFORMCREDITSUSAGEDETAILREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class DescribePlatformCreditsUsageDetailRequest : public AbstractModel
                {
                public:
                    DescribePlatformCreditsUsageDetailRequest();
                    ~DescribePlatformCreditsUsageDetailRequest() = default;
                    ...
                    /**
                     * 获取<p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
                     * @return StartDate <p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
                     * 
                     */
                    std::string GetStartDate() const;

                    /**
                     * 设置<p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
                     * @param _startDate <p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
                     * @return EndDate <p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
                     * 
                     */
                    std::string GetEndDate() const;

                    /**
                     * 设置<p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
                     * @param _endDate <p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEPLATFORMCREDITSUSAGEDETAILREQUEST_H_
