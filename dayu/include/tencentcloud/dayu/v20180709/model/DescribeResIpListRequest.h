...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBERESIPLISTREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBERESIPLISTREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeResIpListRequest : public AbstractModel
                {
                public:
                    DescribeResIpListRequest();
                    ~DescribeResIpListRequest() = default;
                    ...
                    /**
                     * 获取资源ID, 如果不填，则获取用户所有资源的IP
                     * @return IdList 资源ID, 如果不填，则获取用户所有资源的IP
                     * 
                     */
                    std::vector<std::string> GetIdList() const;

                    /**
                     * 设置资源ID, 如果不填，则获取用户所有资源的IP
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBERESIPLISTREQUEST_H_
