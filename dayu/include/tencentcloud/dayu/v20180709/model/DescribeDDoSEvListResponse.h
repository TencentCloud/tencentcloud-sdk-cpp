...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVLISTRESPONSE_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVLISTRESPONSE_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeDDoSEvListResponse : public AbstractModel
                {
                public:
                    DescribeDDoSEvListResponse();
                    ~DescribeDDoSEvListResponse() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVLISTRESPONSE_H_
