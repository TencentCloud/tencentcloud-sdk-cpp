...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_CREATEL4RULESREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_CREATEL4RULESREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class CreateL4RulesRequest : public AbstractModel
                {
                public:
                    CreateL4RulesRequest();
                    ~CreateL4RulesRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_CREATEL4RULESREQUEST_H_
