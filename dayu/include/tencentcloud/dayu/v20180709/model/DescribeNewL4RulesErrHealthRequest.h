...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeNewL4RulesErrHealthRequest : public AbstractModel
                {
                public:
                    DescribeNewL4RulesErrHealthRequest();
                    ~DescribeNewL4RulesErrHealthRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHREQUEST_H_
