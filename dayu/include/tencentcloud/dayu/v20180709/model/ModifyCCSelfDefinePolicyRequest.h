...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYCCSELFDEFINEPOLICYREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYCCSELFDEFINEPOLICYREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class ModifyCCSelfDefinePolicyRequest : public AbstractModel
                {
                public:
                    ModifyCCSelfDefinePolicyRequest();
                    ~ModifyCCSelfDefinePolicyRequest() = default;
                    ...
                    /**
                     * 获取CC策略描述
                     * @return Policy CC策略描述
                     * 
                     */
                    CCPolicy GetPolicy() const;
                     ...
                     * 
                     */
                    void SetPolicy(const CCPolicy& _policy);
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYCCSELFDEFINEPOLICYREQUEST_H_
