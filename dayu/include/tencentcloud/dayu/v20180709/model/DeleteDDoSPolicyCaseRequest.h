...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DELETEDDOSPOLICYCASEREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DELETEDDOSPOLICYCASEREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DeleteDDoSPolicyCaseRequest : public AbstractModel
                {
                public:
                    DeleteDDoSPolicyCaseRequest();
                    ~DeleteDDoSPolicyCaseRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DELETEDDOSPOLICYCASEREQUEST_H_
