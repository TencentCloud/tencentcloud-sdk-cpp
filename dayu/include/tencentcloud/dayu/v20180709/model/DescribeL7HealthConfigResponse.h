...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGRESPONSE_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGRESPONSE_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeL7HealthConfigResponse : public AbstractModel
                {
                public:
                    DescribeL7HealthConfigResponse();
                    ~DescribeL7HealthConfigResponse() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGRESPONSE_H_
