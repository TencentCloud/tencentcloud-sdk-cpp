...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYRESBINDDDOSPOLICYREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYRESBINDDDOSPOLICYREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class ModifyResBindDDoSPolicyRequest : public AbstractModel
                {
                public:
                    ModifyResBindDDoSPolicyRequest();
                    ~ModifyResBindDDoSPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYRESBINDDDOSPOLICYREQUEST_H_
