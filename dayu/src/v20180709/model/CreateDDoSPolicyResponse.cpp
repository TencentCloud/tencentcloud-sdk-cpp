...
CoreInternalOutcome CreateDDoSPolicyResponse::Deserialize(const string &payload)
{
...
string CreateDDoSPolicyResponse::ToJsonString() const
{
...
string CreateDDoSPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateDDoSPolicyResponse::PolicyIdHasBeenSet() const
{
