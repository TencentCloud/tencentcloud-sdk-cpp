...
CoreInternalOutcome CCAlarmThreshold::Deserialize(const Value &value)
{
    string requestId = "";
...
void CCAlarmThreshold::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
