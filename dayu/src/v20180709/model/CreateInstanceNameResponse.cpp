...
CoreInternalOutcome CreateInstanceNameResponse::Deserialize(const string &payload)
{
...
string CreateInstanceNameResponse::ToJsonString() const
{
...
SuccessCode CreateInstanceNameResponse::GetSuccess() const
{
    return m_success;
}

bool CreateInstanceNameResponse::SuccessHasBeenSet() const
{
