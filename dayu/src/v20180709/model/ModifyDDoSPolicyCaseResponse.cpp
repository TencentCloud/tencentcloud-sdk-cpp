...
CoreInternalOutcome ModifyDDoSPolicyCaseResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSPolicyCaseResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSPolicyCaseResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSPolicyCaseResponse::SuccessHasBeenSet() const
{
