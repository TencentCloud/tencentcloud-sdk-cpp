...
CoreInternalOutcome DeleteL4RulesResponse::Deserialize(const string &payload)
{
...
string DeleteL4RulesResponse::ToJsonString() const
{
...
SuccessCode DeleteL4RulesResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteL4RulesResponse::SuccessHasBeenSet() const
{
