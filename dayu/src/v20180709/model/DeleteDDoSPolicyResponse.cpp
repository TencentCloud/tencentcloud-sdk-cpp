...
CoreInternalOutcome DeleteDDoSPolicyResponse::Deserialize(const string &payload)
{
...
string DeleteDDoSPolicyResponse::ToJsonString() const
{
...
SuccessCode DeleteDDoSPolicyResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteDDoSPolicyResponse::SuccessHasBeenSet() const
{
