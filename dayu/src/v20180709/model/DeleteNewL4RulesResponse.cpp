...
CoreInternalOutcome DeleteNewL4RulesResponse::Deserialize(const string &payload)
{
...
string DeleteNewL4RulesResponse::ToJsonString() const
{
...
SuccessCode DeleteNewL4RulesResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteNewL4RulesResponse::SuccessHasBeenSet() const
{
