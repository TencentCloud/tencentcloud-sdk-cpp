...
CoreInternalOutcome ModifyDDoSSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSSwitchResponse::ToJsonString() const
{
...
uint64_t ModifyDDoSSwitchResponse::GetStatus() const
{
    return m_status;
}

bool ModifyDDoSSwitchResponse::StatusHasBeenSet() const
{
