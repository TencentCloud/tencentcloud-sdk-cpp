...
CoreInternalOutcome ModifyNewL4RuleResponse::Deserialize(const string &payload)
{
...
string ModifyNewL4RuleResponse::ToJsonString() const
{
...
SuccessCode ModifyNewL4RuleResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyNewL4RuleResponse::SuccessHasBeenSet() const
{
