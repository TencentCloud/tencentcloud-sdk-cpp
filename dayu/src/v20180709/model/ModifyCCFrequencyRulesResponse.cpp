...
CoreInternalOutcome ModifyCCFrequencyRulesResponse::Deserialize(const string &payload)
{
...
string ModifyCCFrequencyRulesResponse::ToJsonString() const
{
...
SuccessCode ModifyCCFrequencyRulesResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCFrequencyRulesResponse::SuccessHasBeenSet() const
{
