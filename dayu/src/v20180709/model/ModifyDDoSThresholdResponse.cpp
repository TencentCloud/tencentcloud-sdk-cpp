...
CoreInternalOutcome ModifyDDoSThresholdResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSThresholdResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSThresholdResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSThresholdResponse::SuccessHasBeenSet() const
{
