...
CoreInternalOutcome CreateCCSelfDefinePolicyResponse::Deserialize(const string &payload)
{
...
string CreateCCSelfDefinePolicyResponse::ToJsonString() const
{
...
SuccessCode CreateCCSelfDefinePolicyResponse::GetSuccess() const
{
    return m_success;
}

bool CreateCCSelfDefinePolicyResponse::SuccessHasBeenSet() const
{
