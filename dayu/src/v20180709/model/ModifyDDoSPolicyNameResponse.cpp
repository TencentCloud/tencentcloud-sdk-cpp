...
CoreInternalOutcome ModifyDDoSPolicyNameResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSPolicyNameResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSPolicyNameResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSPolicyNameResponse::SuccessHasBeenSet() const
{
