...
CoreInternalOutcome DescribeDDoSNetEvInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDDoSNetEvInfoResponse::ToJsonString() const
{
...
string DescribeDDoSNetEvInfoResponse::GetBusiness() const
{
    return m_business;
}

bool DescribeDDoSNetEvInfoResponse::BusinessHasBeenSet() const
{
    return m_businessHasBeenSet;
}

string DescribeDDoSNetEvInfoResponse::GetId() const
{
    return m_id;
}

bool DescribeDDoSNetEvInfoResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string DescribeDDoSNetEvInfoResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeDDoSNetEvInfoResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeDDoSNetEvInfoResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeDDoSNetEvInfoResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetTcpPacketSum() const
{
    return m_tcpPacketSum;
}

bool DescribeDDoSNetEvInfoResponse::TcpPacketSumHasBeenSet() const
{
    return m_tcpPacketSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetTcpKBSum() const
{
    return m_tcpKBSum;
}

bool DescribeDDoSNetEvInfoResponse::TcpKBSumHasBeenSet() const
{
    return m_tcpKBSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetUdpPacketSum() const
{
    return m_udpPacketSum;
}

bool DescribeDDoSNetEvInfoResponse::UdpPacketSumHasBeenSet() const
{
    return m_udpPacketSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetUdpKBSum() const
{
    return m_udpKBSum;
}

bool DescribeDDoSNetEvInfoResponse::UdpKBSumHasBeenSet() const
{
    return m_udpKBSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetIcmpPacketSum() const
{
    return m_icmpPacketSum;
}

bool DescribeDDoSNetEvInfoResponse::IcmpPacketSumHasBeenSet() const
{
    return m_icmpPacketSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetIcmpKBSum() const
{
    return m_icmpKBSum;
}

bool DescribeDDoSNetEvInfoResponse::IcmpKBSumHasBeenSet() const
{
    return m_icmpKBSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetOtherPacketSum() const
{
    return m_otherPacketSum;
}

bool DescribeDDoSNetEvInfoResponse::OtherPacketSumHasBeenSet() const
{
    return m_otherPacketSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetOtherKBSum() const
{
    return m_otherKBSum;
}

bool DescribeDDoSNetEvInfoResponse::OtherKBSumHasBeenSet() const
{
    return m_otherKBSumHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetTotalTraffic() const
{
    return m_totalTraffic;
}

bool DescribeDDoSNetEvInfoResponse::TotalTrafficHasBeenSet() const
{
    return m_totalTrafficHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetMbps() const
{
    return m_mbps;
}

bool DescribeDDoSNetEvInfoResponse::MbpsHasBeenSet() const
{
    return m_mbpsHasBeenSet;
}

uint64_t DescribeDDoSNetEvInfoResponse::GetPps() const
{
    return m_pps;
}

bool DescribeDDoSNetEvInfoResponse::PpsHasBeenSet() const
{
    return m_ppsHasBeenSet;
}

vector<string> DescribeDDoSNetEvInfoResponse::GetPcapUrl() const
{
    return m_pcapUrl;
}

bool DescribeDDoSNetEvInfoResponse::PcapUrlHasBeenSet() const
{
