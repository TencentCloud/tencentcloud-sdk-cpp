...
CoreInternalOutcome ResourceIp::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ResourceIp::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string ResourceIp::GetId() const
{
    return m_id;
}

void ResourceIp::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool ResourceIp::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

vector<string> ResourceIp::GetIpList() const
{
    return m_ipList;
}

void ResourceIp::SetIpList(const vector<string>& _ipList)
{
    m_ipList = _ipList;
    m_ipListHasBeenSet = true;
}

bool ResourceIp::IpListHasBeenSet() const
{
