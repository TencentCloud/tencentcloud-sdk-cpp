...
CoreInternalOutcome ModifyCCIpAllowDenyResponse::Deserialize(const string &payload)
{
...
string ModifyCCIpAllowDenyResponse::ToJsonString() const
{
...
SuccessCode ModifyCCIpAllowDenyResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCIpAllowDenyResponse::SuccessHasBeenSet() const
{
