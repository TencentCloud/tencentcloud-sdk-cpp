...
CoreInternalOutcome ModifyResourceRenewFlagResponse::Deserialize(const string &payload)
{
...
string ModifyResourceRenewFlagResponse::ToJsonString() const
{
...
SuccessCode ModifyResourceRenewFlagResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyResourceRenewFlagResponse::SuccessHasBeenSet() const
{
