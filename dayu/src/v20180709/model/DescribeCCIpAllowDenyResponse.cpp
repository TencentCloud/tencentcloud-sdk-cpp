...
CoreInternalOutcome DescribeCCIpAllowDenyResponse::Deserialize(const string &payload)
{
...
string DescribeCCIpAllowDenyResponse::ToJsonString() const
{
...
vector<KeyValue> DescribeCCIpAllowDenyResponse::GetData() const
{
    return m_data;
}

bool DescribeCCIpAllowDenyResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeCCIpAllowDenyResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCCIpAllowDenyResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<KeyValueRecord> DescribeCCIpAllowDenyResponse::GetRecordList() const
{
    return m_recordList;
}

bool DescribeCCIpAllowDenyResponse::RecordListHasBeenSet() const
{
