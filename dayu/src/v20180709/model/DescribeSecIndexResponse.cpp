...
CoreInternalOutcome DescribeSecIndexResponse::Deserialize(const string &payload)
{
...
string DescribeSecIndexResponse::ToJsonString() const
{
...
vector<KeyValue> DescribeSecIndexResponse::GetData() const
{
    return m_data;
}

bool DescribeSecIndexResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeSecIndexResponse::GetBeginDate() const
{
    return m_beginDate;
}

bool DescribeSecIndexResponse::BeginDateHasBeenSet() const
{
    return m_beginDateHasBeenSet;
}

string DescribeSecIndexResponse::GetEndDate() const
{
    return m_endDate;
}

bool DescribeSecIndexResponse::EndDateHasBeenSet() const
{
