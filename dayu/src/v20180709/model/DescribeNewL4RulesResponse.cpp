...
CoreInternalOutcome DescribeNewL4RulesResponse::Deserialize(const string &payload)
{
...
string DescribeNewL4RulesResponse::ToJsonString() const
{
...
vector<NewL4RuleEntry> DescribeNewL4RulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeNewL4RulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

uint64_t DescribeNewL4RulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeNewL4RulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<L4RuleHealth> DescribeNewL4RulesResponse::GetHealths() const
{
    return m_healths;
}

bool DescribeNewL4RulesResponse::HealthsHasBeenSet() const
{
