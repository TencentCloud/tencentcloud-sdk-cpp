...
CoreInternalOutcome DescribeDDoSNetIpLogResponse::Deserialize(const string &payload)
{
...
string DescribeDDoSNetIpLogResponse::ToJsonString() const
{
...
string DescribeDDoSNetIpLogResponse::GetBusiness() const
{
    return m_business;
}

bool DescribeDDoSNetIpLogResponse::BusinessHasBeenSet() const
{
    return m_businessHasBeenSet;
}

string DescribeDDoSNetIpLogResponse::GetId() const
{
    return m_id;
}

bool DescribeDDoSNetIpLogResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string DescribeDDoSNetIpLogResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeDDoSNetIpLogResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeDDoSNetIpLogResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeDDoSNetIpLogResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

vector<KeyValueRecord> DescribeDDoSNetIpLogResponse::GetData() const
{
    return m_data;
}

bool DescribeDDoSNetIpLogResponse::DataHasBeenSet() const
{
