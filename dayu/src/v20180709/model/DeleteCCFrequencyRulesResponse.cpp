...
CoreInternalOutcome DeleteCCFrequencyRulesResponse::Deserialize(const string &payload)
{
...
string DeleteCCFrequencyRulesResponse::ToJsonString() const
{
...
SuccessCode DeleteCCFrequencyRulesResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteCCFrequencyRulesResponse::SuccessHasBeenSet() const
{
