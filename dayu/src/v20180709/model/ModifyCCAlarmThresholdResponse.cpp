...
CoreInternalOutcome ModifyCCAlarmThresholdResponse::Deserialize(const string &payload)
{
...
string ModifyCCAlarmThresholdResponse::ToJsonString() const
{
...
SuccessCode ModifyCCAlarmThresholdResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCAlarmThresholdResponse::SuccessHasBeenSet() const
{
