...
CoreInternalOutcome ModifyCCFrequencyRulesStatusResponse::Deserialize(const string &payload)
{
...
string ModifyCCFrequencyRulesStatusResponse::ToJsonString() const
{
...
SuccessCode ModifyCCFrequencyRulesStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCFrequencyRulesStatusResponse::SuccessHasBeenSet() const
{
