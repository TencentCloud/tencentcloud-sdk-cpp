...
CoreInternalOutcome CreateNewL7RulesResponse::Deserialize(const string &payload)
{
...
string CreateNewL7RulesResponse::ToJsonString() const
{
...
SuccessCode CreateNewL7RulesResponse::GetSuccess() const
{
    return m_success;
}

bool CreateNewL7RulesResponse::SuccessHasBeenSet() const
{
