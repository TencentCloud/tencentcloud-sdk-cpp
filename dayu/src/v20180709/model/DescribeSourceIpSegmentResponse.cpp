...
CoreInternalOutcome DescribeSourceIpSegmentResponse::Deserialize(const string &payload)
{
...
string DescribeSourceIpSegmentResponse::ToJsonString() const
{
...
string DescribeSourceIpSegmentResponse::GetData() const
{
    return m_data;
}

bool DescribeSourceIpSegmentResponse::DataHasBeenSet() const
{
