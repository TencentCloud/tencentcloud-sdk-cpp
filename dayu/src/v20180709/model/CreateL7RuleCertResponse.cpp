...
CoreInternalOutcome CreateL7RuleCertResponse::Deserialize(const string &payload)
{
...
string CreateL7RuleCertResponse::ToJsonString() const
{
...
SuccessCode CreateL7RuleCertResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL7RuleCertResponse::SuccessHasBeenSet() const
{
