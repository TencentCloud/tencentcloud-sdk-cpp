...
CoreInternalOutcome DescribeBGPIPL7RuleMaxCntResponse::Deserialize(const string &payload)
{
...
string DescribeBGPIPL7RuleMaxCntResponse::ToJsonString() const
{
...
uint64_t DescribeBGPIPL7RuleMaxCntResponse::GetCount() const
{
    return m_count;
}

bool DescribeBGPIPL7RuleMaxCntResponse::CountHasBeenSet() const
{
