...
CoreInternalOutcome DeleteDDoSPolicyCaseResponse::Deserialize(const string &payload)
{
...
string DeleteDDoSPolicyCaseResponse::ToJsonString() const
{
...
SuccessCode DeleteDDoSPolicyCaseResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteDDoSPolicyCaseResponse::SuccessHasBeenSet() const
{
