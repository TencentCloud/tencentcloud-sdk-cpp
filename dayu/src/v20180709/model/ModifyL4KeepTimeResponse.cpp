...
CoreInternalOutcome ModifyL4KeepTimeResponse::Deserialize(const string &payload)
{
...
string ModifyL4KeepTimeResponse::ToJsonString() const
{
...
SuccessCode ModifyL4KeepTimeResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyL4KeepTimeResponse::SuccessHasBeenSet() const
{
