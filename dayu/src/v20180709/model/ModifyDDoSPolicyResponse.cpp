...
CoreInternalOutcome ModifyDDoSPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSPolicyResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSPolicyResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSPolicyResponse::SuccessHasBeenSet() const
{
