...
CoreInternalOutcome CreateNewL7RulesUploadResponse::Deserialize(const string &payload)
{
...
string CreateNewL7RulesUploadResponse::ToJsonString() const
{
...
SuccessCode CreateNewL7RulesUploadResponse::GetSuccess() const
{
    return m_success;
}

bool CreateNewL7RulesUploadResponse::SuccessHasBeenSet() const
{
