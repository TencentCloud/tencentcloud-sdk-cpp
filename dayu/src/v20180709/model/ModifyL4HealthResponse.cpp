...
CoreInternalOutcome ModifyL4HealthResponse::Deserialize(const string &payload)
{
...
string ModifyL4HealthResponse::ToJsonString() const
{
...
SuccessCode ModifyL4HealthResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyL4HealthResponse::SuccessHasBeenSet() const
{
