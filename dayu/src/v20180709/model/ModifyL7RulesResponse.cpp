...
CoreInternalOutcome ModifyL7RulesResponse::Deserialize(const string &payload)
{
...
string ModifyL7RulesResponse::ToJsonString() const
{
...
SuccessCode ModifyL7RulesResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyL7RulesResponse::SuccessHasBeenSet() const
{
