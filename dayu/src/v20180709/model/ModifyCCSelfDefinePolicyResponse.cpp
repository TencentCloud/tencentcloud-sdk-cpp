...
CoreInternalOutcome ModifyCCSelfDefinePolicyResponse::Deserialize(const string &payload)
{
...
string ModifyCCSelfDefinePolicyResponse::ToJsonString() const
{
...
SuccessCode ModifyCCSelfDefinePolicyResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCSelfDefinePolicyResponse::SuccessHasBeenSet() const
{
