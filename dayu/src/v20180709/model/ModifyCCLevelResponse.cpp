...
CoreInternalOutcome ModifyCCLevelResponse::Deserialize(const string &payload)
{
...
string ModifyCCLevelResponse::ToJsonString() const
{
...
SuccessCode ModifyCCLevelResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCLevelResponse::SuccessHasBeenSet() const
{
