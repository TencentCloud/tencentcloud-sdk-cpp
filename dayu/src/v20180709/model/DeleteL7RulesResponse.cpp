...
CoreInternalOutcome DeleteL7RulesResponse::Deserialize(const string &payload)
{
...
string DeleteL7RulesResponse::ToJsonString() const
{
...
SuccessCode DeleteL7RulesResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteL7RulesResponse::SuccessHasBeenSet() const
{
