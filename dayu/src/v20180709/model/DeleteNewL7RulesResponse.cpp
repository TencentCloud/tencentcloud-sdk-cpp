...
CoreInternalOutcome DeleteNewL7RulesResponse::Deserialize(const string &payload)
{
...
string DeleteNewL7RulesResponse::ToJsonString() const
{
...
SuccessCode DeleteNewL7RulesResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteNewL7RulesResponse::SuccessHasBeenSet() const
{
