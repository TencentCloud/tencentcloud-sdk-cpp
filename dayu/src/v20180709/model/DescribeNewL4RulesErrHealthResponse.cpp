...
CoreInternalOutcome DescribeNewL4RulesErrHealthResponse::Deserialize(const string &payload)
{
...
string DescribeNewL4RulesErrHealthResponse::ToJsonString() const
{
...
uint64_t DescribeNewL4RulesErrHealthResponse::GetTotal() const
{
    return m_total;
}

bool DescribeNewL4RulesErrHealthResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<KeyValue> DescribeNewL4RulesErrHealthResponse::GetErrHealths() const
{
    return m_errHealths;
}

bool DescribeNewL4RulesErrHealthResponse::ErrHealthsHasBeenSet() const
{
