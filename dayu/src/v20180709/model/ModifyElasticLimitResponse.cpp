...
CoreInternalOutcome ModifyElasticLimitResponse::Deserialize(const string &payload)
{
...
string ModifyElasticLimitResponse::ToJsonString() const
{
...
SuccessCode ModifyElasticLimitResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyElasticLimitResponse::SuccessHasBeenSet() const
{
