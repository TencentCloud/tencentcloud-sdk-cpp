...
CoreInternalOutcome ModifyCCPolicySwitchResponse::Deserialize(const string &payload)
{
...
string ModifyCCPolicySwitchResponse::ToJsonString() const
{
...
SuccessCode ModifyCCPolicySwitchResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCPolicySwitchResponse::SuccessHasBeenSet() const
{
