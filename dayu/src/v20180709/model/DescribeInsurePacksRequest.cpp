...
string DescribeInsurePacksRequest::ToJsonString() const
{
...
vector<string> DescribeInsurePacksRequest::GetIdList() const
{
    return m_idList;
}

void DescribeInsurePacksRequest::SetIdList(const vector<string>& _idList)
{
    m_idList = _idList;
    m_idListHasBeenSet = true;
}

bool DescribeInsurePacksRequest::IdListHasBeenSet() const
{
