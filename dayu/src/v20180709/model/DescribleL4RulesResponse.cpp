...
string DescribleL4RulesResponse::ToJsonString() const
{
...
vector<L4RuleEntry> DescribleL4RulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribleL4RulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

uint64_t DescribleL4RulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribleL4RulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<L4RuleHealth> DescribleL4RulesResponse::GetHealths() const
{
    return m_healths;
}

bool DescribleL4RulesResponse::HealthsHasBeenSet() const
{
