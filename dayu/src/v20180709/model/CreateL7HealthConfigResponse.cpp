...
CoreInternalOutcome CreateL7HealthConfigResponse::Deserialize(const string &payload)
{
...
string CreateL7HealthConfigResponse::ToJsonString() const
{
...
SuccessCode CreateL7HealthConfigResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL7HealthConfigResponse::SuccessHasBeenSet() const
{
