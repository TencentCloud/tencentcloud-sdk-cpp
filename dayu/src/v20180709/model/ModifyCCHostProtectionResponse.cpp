...
CoreInternalOutcome ModifyCCHostProtectionResponse::Deserialize(const string &payload)
{
...
string ModifyCCHostProtectionResponse::ToJsonString() const
{
...
SuccessCode ModifyCCHostProtectionResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCHostProtectionResponse::SuccessHasBeenSet() const
{
