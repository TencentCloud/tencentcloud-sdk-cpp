...
CoreInternalOutcome ModifyCCThresholdResponse::Deserialize(const string &payload)
{
...
string ModifyCCThresholdResponse::ToJsonString() const
{
...
SuccessCode ModifyCCThresholdResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCThresholdResponse::SuccessHasBeenSet() const
{
