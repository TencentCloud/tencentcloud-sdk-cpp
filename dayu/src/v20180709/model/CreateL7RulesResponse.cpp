...
CoreInternalOutcome CreateL7RulesResponse::Deserialize(const string &payload)
{
...
string CreateL7RulesResponse::ToJsonString() const
{
...
SuccessCode CreateL7RulesResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL7RulesResponse::SuccessHasBeenSet() const
{
