...
CoreInternalOutcome ModifyDDoSDefendStatusResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSDefendStatusResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSDefendStatusResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSDefendStatusResponse::SuccessHasBeenSet() const
{
