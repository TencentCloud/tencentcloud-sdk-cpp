...
CoreInternalOutcome DescribeDDoSIpLogResponse::Deserialize(const string &payload)
{
...
string DescribeDDoSIpLogResponse::ToJsonString() const
{
...
string DescribeDDoSIpLogResponse::GetBusiness() const
{
    return m_business;
}

bool DescribeDDoSIpLogResponse::BusinessHasBeenSet() const
{
    return m_businessHasBeenSet;
}

string DescribeDDoSIpLogResponse::GetId() const
{
    return m_id;
}

bool DescribeDDoSIpLogResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string DescribeDDoSIpLogResponse::GetIp() const
{
    return m_ip;
}

bool DescribeDDoSIpLogResponse::IpHasBeenSet() const
{
    return m_ipHasBeenSet;
}

string DescribeDDoSIpLogResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeDDoSIpLogResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeDDoSIpLogResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeDDoSIpLogResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

vector<KeyValueRecord> DescribeDDoSIpLogResponse::GetData() const
{
    return m_data;
}

bool DescribeDDoSIpLogResponse::DataHasBeenSet() const
{
