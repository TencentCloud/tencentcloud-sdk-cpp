...
CoreInternalOutcome DescribeSchedulingDomainListResponse::Deserialize(const string &payload)
{
...
string DescribeSchedulingDomainListResponse::ToJsonString() const
{
...
uint64_t DescribeSchedulingDomainListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSchedulingDomainListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<SchedulingDomain> DescribeSchedulingDomainListResponse::GetDomainList() const
{
    return m_domainList;
}

bool DescribeSchedulingDomainListResponse::DomainListHasBeenSet() const
{
