...
CoreInternalOutcome CreateL4HealthConfigResponse::Deserialize(const string &payload)
{
...
string CreateL4HealthConfigResponse::ToJsonString() const
{
...
SuccessCode CreateL4HealthConfigResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL4HealthConfigResponse::SuccessHasBeenSet() const
{
