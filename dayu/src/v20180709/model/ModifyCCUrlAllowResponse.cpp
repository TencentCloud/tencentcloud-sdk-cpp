...
CoreInternalOutcome ModifyCCUrlAllowResponse::Deserialize(const string &payload)
{
...
string ModifyCCUrlAllowResponse::ToJsonString() const
{
...
SuccessCode ModifyCCUrlAllowResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyCCUrlAllowResponse::SuccessHasBeenSet() const
{
