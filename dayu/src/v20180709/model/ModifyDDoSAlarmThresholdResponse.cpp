...
CoreInternalOutcome ModifyDDoSAlarmThresholdResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSAlarmThresholdResponse::ToJsonString() const
{
...
SuccessCode ModifyDDoSAlarmThresholdResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDDoSAlarmThresholdResponse::SuccessHasBeenSet() const
{
