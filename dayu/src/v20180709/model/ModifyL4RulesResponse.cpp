...
CoreInternalOutcome ModifyL4RulesResponse::Deserialize(const string &payload)
{
...
string ModifyL4RulesResponse::ToJsonString() const
{
...
SuccessCode ModifyL4RulesResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyL4RulesResponse::SuccessHasBeenSet() const
{
