...
CoreInternalOutcome DescribleNewL7RulesResponse::Deserialize(const string &payload)
{
...
string DescribleNewL7RulesResponse::ToJsonString() const
{
...
vector<NewL7RuleEntry> DescribleNewL7RulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribleNewL7RulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

uint64_t DescribleNewL7RulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribleNewL7RulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<L7RuleHealth> DescribleNewL7RulesResponse::GetHealths() const
{
    return m_healths;
}

bool DescribleNewL7RulesResponse::HealthsHasBeenSet() const
{
