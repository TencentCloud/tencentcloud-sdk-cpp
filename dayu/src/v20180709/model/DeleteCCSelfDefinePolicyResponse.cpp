...
CoreInternalOutcome DeleteCCSelfDefinePolicyResponse::Deserialize(const string &payload)
{
...
string DeleteCCSelfDefinePolicyResponse::ToJsonString() const
{
...
SuccessCode DeleteCCSelfDefinePolicyResponse::GetSuccess() const
{
    return m_success;
}

bool DeleteCCSelfDefinePolicyResponse::SuccessHasBeenSet() const
{
