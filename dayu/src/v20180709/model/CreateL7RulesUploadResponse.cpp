...
CoreInternalOutcome CreateL7RulesUploadResponse::Deserialize(const string &payload)
{
...
string CreateL7RulesUploadResponse::ToJsonString() const
{
...
SuccessCode CreateL7RulesUploadResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL7RulesUploadResponse::SuccessHasBeenSet() const
{
