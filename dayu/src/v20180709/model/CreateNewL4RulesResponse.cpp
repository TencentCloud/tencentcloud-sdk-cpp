...
CoreInternalOutcome CreateNewL4RulesResponse::Deserialize(const string &payload)
{
...
string CreateNewL4RulesResponse::ToJsonString() const
{
...
SuccessCode CreateNewL4RulesResponse::GetSuccess() const
{
    return m_success;
}

bool CreateNewL4RulesResponse::SuccessHasBeenSet() const
{
