...
CoreInternalOutcome DescribeBaradDataResponse::Deserialize(const string &payload)
{
...
string DescribeBaradDataResponse::ToJsonString() const
{
...
vector<BaradData> DescribeBaradDataResponse::GetDataList() const
{
    return m_dataList;
}

bool DescribeBaradDataResponse::DataListHasBeenSet() const
{
