...
string ModifyCCFrequencyRulesRequest::ToJsonString() const
{
    ...
    if (m_cCFrequencyRuleIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_cCFrequencyRuleId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_actHasBeenSet)
    {
        ...
        string key = "Act";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_act.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_uriHasBeenSet)
    {
        ...
        string key = "Uri";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_uri.c_str(), allocator).Move(), allocator);
    }
