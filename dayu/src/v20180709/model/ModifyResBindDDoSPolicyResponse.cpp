...
CoreInternalOutcome ModifyResBindDDoSPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyResBindDDoSPolicyResponse::ToJsonString() const
{
...
SuccessCode ModifyResBindDDoSPolicyResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyResBindDDoSPolicyResponse::SuccessHasBeenSet() const
{
