...
CoreInternalOutcome CreateL4RulesResponse::Deserialize(const string &payload)
{
...
string CreateL4RulesResponse::ToJsonString() const
{
...
SuccessCode CreateL4RulesResponse::GetSuccess() const
{
    return m_success;
}

bool CreateL4RulesResponse::SuccessHasBeenSet() const
{
