...
CoreInternalOutcome ListMigrationTaskResponse::Deserialize(const string &payload)
{
...
string ListMigrationTaskResponse::ToJsonString() const
{
...
uint64_t ListMigrationTaskResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListMigrationTaskResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Task> ListMigrationTaskResponse::GetTasks() const
{
    return m_tasks;
}

bool ListMigrationTaskResponse::TasksHasBeenSet() const
{
