...
CoreInternalOutcome SearchSessionResponse::Deserialize(const string &payload)
{
...
string SearchSessionResponse::ToJsonString() const
{
...
uint64_t SearchSessionResponse::GetTotalCount() const
{
    return m_totalCount;
}
