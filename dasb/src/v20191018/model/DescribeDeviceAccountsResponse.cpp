...
CoreInternalOutcome DescribeDeviceAccountsResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceAccountsResponse::ToJsonString() const
{
...
uint64_t DescribeDeviceAccountsResponse::GetTotalCount() const
{
    return m_totalCount;
}
