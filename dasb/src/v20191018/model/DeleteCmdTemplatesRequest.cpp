...
string DeleteCmdTemplatesRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteCmdTemplatesRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteCmdTemplatesRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteCmdTemplatesRequest::IdSetHasBeenSet() const
{
