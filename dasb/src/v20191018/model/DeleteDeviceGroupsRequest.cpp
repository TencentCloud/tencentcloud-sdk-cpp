...
string DeleteDeviceGroupsRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteDeviceGroupsRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteDeviceGroupsRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteDeviceGroupsRequest::IdSetHasBeenSet() const
{
