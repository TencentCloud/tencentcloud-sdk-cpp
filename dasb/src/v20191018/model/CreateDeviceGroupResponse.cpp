...
CoreInternalOutcome CreateDeviceGroupResponse::Deserialize(const string &payload)
{
...
string CreateDeviceGroupResponse::ToJsonString() const
{
...
uint64_t CreateDeviceGroupResponse::GetId() const
{
    return m_id;
}

bool CreateDeviceGroupResponse::IdHasBeenSet() const
{
