...
string ResetDeviceAccountPrivateKeyRequest::ToJsonString() const
{
...
vector<uint64_t> ResetDeviceAccountPrivateKeyRequest::GetIdSet() const
{
    return m_idSet;
}

void ResetDeviceAccountPrivateKeyRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool ResetDeviceAccountPrivateKeyRequest::IdSetHasBeenSet() const
{
