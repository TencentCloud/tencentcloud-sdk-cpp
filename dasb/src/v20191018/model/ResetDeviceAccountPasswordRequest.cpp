...
string ResetDeviceAccountPasswordRequest::ToJsonString() const
{
...
vector<uint64_t> ResetDeviceAccountPasswordRequest::GetIdSet() const
{
    return m_idSet;
}

void ResetDeviceAccountPasswordRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool ResetDeviceAccountPasswordRequest::IdSetHasBeenSet() const
{
