...
CoreInternalOutcome DescribeDeviceGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceGroupsResponse::ToJsonString() const
{
...
uint64_t DescribeDeviceGroupsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeviceGroupsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Group> DescribeDeviceGroupsResponse::GetGroupSet() const
{
    return m_groupSet;
}

bool DescribeDeviceGroupsResponse::GroupSetHasBeenSet() const
{
