...
CoreInternalOutcome DescribeUserGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeUserGroupsResponse::ToJsonString() const
{
...
uint64_t DescribeUserGroupsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeUserGroupsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Group> DescribeUserGroupsResponse::GetGroupSet() const
{
    return m_groupSet;
}

bool DescribeUserGroupsResponse::GroupSetHasBeenSet() const
{
