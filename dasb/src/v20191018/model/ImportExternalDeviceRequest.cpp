...
string ImportExternalDeviceRequest::ToJsonString() const
{
...
vector<ExternalDevice> ImportExternalDeviceRequest::GetDeviceSet() const
{
    return m_deviceSet;
}

void ImportExternalDeviceRequest::SetDeviceSet(const vector<ExternalDevice>& _deviceSet)
{
