...
CoreInternalOutcome SearchFileResponse::Deserialize(const string &payload)
{
...
string SearchFileResponse::ToJsonString() const
{
...
uint64_t SearchFileResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SearchFileResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SearchFileResult> SearchFileResponse::GetFiles() const
{
    return m_files;
}

bool SearchFileResponse::FilesHasBeenSet() const
{
