...
CoreInternalOutcome DescribeResourcesResponse::Deserialize(const string &payload)
{
...
string DescribeResourcesResponse::ToJsonString() const
{
...
vector<Resource> DescribeResourcesResponse::GetResourceSet() const
{
