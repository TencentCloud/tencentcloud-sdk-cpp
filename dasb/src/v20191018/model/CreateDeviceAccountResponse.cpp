...
CoreInternalOutcome CreateDeviceAccountResponse::Deserialize(const string &payload)
{
...
string CreateDeviceAccountResponse::ToJsonString() const
{
...
uint64_t CreateDeviceAccountResponse::GetId() const
{
    return m_id;
}

bool CreateDeviceAccountResponse::IdHasBeenSet() const
{
