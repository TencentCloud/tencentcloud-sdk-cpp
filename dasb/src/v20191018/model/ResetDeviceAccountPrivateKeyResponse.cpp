...
CoreInternalOutcome ResetDeviceAccountPrivateKeyResponse::Deserialize(const string &payload)
{
...
string ResetDeviceAccountPrivateKeyResponse::ToJsonString() const
{
