...
CoreInternalOutcome CreateCmdTemplateResponse::Deserialize(const string &payload)
{
...
string CreateCmdTemplateResponse::ToJsonString() const
{
...
uint64_t CreateCmdTemplateResponse::GetId() const
{
    return m_id;
}

bool CreateCmdTemplateResponse::IdHasBeenSet() const
{
