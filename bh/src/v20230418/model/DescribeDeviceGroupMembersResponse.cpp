...
CoreInternalOutcome DescribeDeviceGroupMembersResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceGroupMembersResponse::ToJsonString() const
{
...
uint64_t DescribeDeviceGroupMembersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeviceGroupMembersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Device> DescribeDeviceGroupMembersResponse::GetDeviceSet() const
{
    return m_deviceSet;
}

bool DescribeDeviceGroupMembersResponse::DeviceSetHasBeenSet() const
{
