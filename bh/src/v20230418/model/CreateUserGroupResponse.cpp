...
CoreInternalOutcome CreateUserGroupResponse::Deserialize(const string &payload)
{
...
string CreateUserGroupResponse::ToJsonString() const
{
...
uint64_t CreateUserGroupResponse::GetId() const
{
    return m_id;
}

bool CreateUserGroupResponse::IdHasBeenSet() const
{
