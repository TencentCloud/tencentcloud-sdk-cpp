...
string DeleteDeviceAccountsRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteDeviceAccountsRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteDeviceAccountsRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteDeviceAccountsRequest::IdSetHasBeenSet() const
{
