...
vector<uint64_t> DeleteUserGroupsRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteUserGroupsRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteUserGroupsRequest::IdSetHasBeenSet() const
{
