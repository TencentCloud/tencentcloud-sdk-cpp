...
vector<uint64_t> DeleteUsersRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteUsersRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteUsersRequest::IdSetHasBeenSet() const
{
