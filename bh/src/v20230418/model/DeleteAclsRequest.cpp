...
string DeleteAclsRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteAclsRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteAclsRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteAclsRequest::IdSetHasBeenSet() const
{
