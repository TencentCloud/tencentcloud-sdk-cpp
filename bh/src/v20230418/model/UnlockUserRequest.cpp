...
string UnlockUserRequest::ToJsonString() const
{
...
vector<uint64_t> UnlockUserRequest::GetIdSet() const
{
    return m_idSet;
}

void UnlockUserRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool UnlockUserRequest::IdSetHasBeenSet() const
{
