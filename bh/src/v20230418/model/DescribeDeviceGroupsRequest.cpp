...
string DescribeDeviceGroupsRequest::ToJsonString() const
{
...
vector<uint64_t> DescribeDeviceGroupsRequest::GetIdSet() const
{
    return m_idSet;
}

void DescribeDeviceGroupsRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DescribeDeviceGroupsRequest::IdSetHasBeenSet() const
{
    return m_idSetHasBeenSet;
}

string DescribeDeviceGroupsRequest::GetName() const
{
    return m_name;
}

void DescribeDeviceGroupsRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool DescribeDeviceGroupsRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

uint64_t DescribeDeviceGroupsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeDeviceGroupsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeDeviceGroupsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeDeviceGroupsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeDeviceGroupsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
