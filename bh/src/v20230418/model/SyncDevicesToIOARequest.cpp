...
SyncDevicesToIOARequest::SyncDevicesToIOARequest() :
    m_deviceIdSetHasBeenSet(false)
{
}

string SyncDevicesToIOARequest::ToJsonString() const
{
...
vector<uint64_t> SyncDevicesToIOARequest::GetDeviceIdSet() const
{
    return m_deviceIdSet;
}

void SyncDevicesToIOARequest::SetDeviceIdSet(const vector<uint64_t>& _deviceIdSet)
{
    m_deviceIdSet = _deviceIdSet;
    m_deviceIdSetHasBeenSet = true;
}

bool SyncDevicesToIOARequest::DeviceIdSetHasBeenSet() const
{
