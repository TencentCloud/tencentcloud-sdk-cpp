...
vector<uint64_t> DeleteDevicesRequest::GetIdSet() const
{
    return m_idSet;
}

void DeleteDevicesRequest::SetIdSet(const vector<uint64_t>& _idSet)
{
    m_idSet = _idSet;
    m_idSetHasBeenSet = true;
}

bool DeleteDevicesRequest::IdSetHasBeenSet() const
{
