...
AccessDevicesResponse::AccessDevicesResponse() :
    m_accessInfoHasBeenSet(false)
{
}

CoreInternalOutcome AccessDevicesResponse::Deserialize(const string &payload)
{
...
string AccessDevicesResponse::ToJsonString() const
{
...
AccessInfo AccessDevicesResponse::GetAccessInfo() const
{
    return m_accessInfo;
}

bool AccessDevicesResponse::AccessInfoHasBeenSet() const
{
