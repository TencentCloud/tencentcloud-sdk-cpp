...
#ifndef TENCENTCLOUD_BH_V20230418_MODEL_SESSIONRESULT_H_
#define TENCENTCLOUD_BH_V20230418_MODEL_SESSIONRESULT_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取应用资产类型：1-web
                     * @return AppAssetKind 应用资产类型：1-web
                     * 
                     */
                    uint64_t GetAppAssetKind() const;
                     ...
                     * 
                     */
                    void SetAppAssetKind(const uint64_t& _appAssetKind);

                    /**
                     * 判断参数 AppAssetKind 是否已赋值
                     * @return AppAssetKind 是否已赋值
                     * 
                     */
                    bool AppAssetKindHasBeenSet() const;
                ...
                private:
                     ...
                     * 应用资产类型：1-web
                     */
                    uint64_t m_appAssetKind;
                    bool m_appAssetKindHasBeenSet;
...
#endif // !TENCENTCLOUD_BH_V20230418_MODEL_SESSIONRESULT_H_
