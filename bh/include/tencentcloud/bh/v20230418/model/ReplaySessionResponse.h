...
#ifndef TENCENTCLOUD_BH_V20230418_MODEL_REPLAYSESSIONRESPONSE_H_
#define TENCENTCLOUD_BH_V20230418_MODEL_REPLAYSESSIONRESPONSE_H_
    ...
    namespace Bh
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class ReplaySessionResponse : public AbstractModel
                {
                public:
                    ReplaySessionResponse();
                    ~ReplaySessionResponse() = default;
...
#endif // !TENCENTCLOUD_BH_V20230418_MODEL_REPLAYSESSIONRESPONSE_H_
