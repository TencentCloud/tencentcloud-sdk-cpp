...
#ifndef TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERSREQUEST_H_
#define TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERSREQUEST_H_
    ...
    namespace Dbdc
    {
        namespace V20201029
        {
            namespace Model
            {
                ...
                */
                class DescribeDBCustomClustersRequest : public AbstractModel
                {
                public:
                    DescribeDBCustomClustersRequest();
                    ~DescribeDBCustomClustersRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>按照一个或者多个 ClusterId 查询。</p><p>入参限制：每次请求的数量上限为100</p>
                    ...
                    /**
                     * 设置<p>按照一个或者多个 ClusterId 查询。</p><p>入参限制：每次请求的数量上限为100</p>
                    ...
                    /**
                     * 获取<p>查询筛选条件。支持的筛选条件包括：</p><ul><li>cluster-name：DB Custom 集群名称，精确匹配。</li><li>cluster-status：DB Custom 集群状态（Creating，Running，Destroying）。</li></ul>
                    ...
                    /**
                     * 设置<p>查询筛选条件。支持的筛选条件包括：</p><ul><li>cluster-name：DB Custom 集群名称，精确匹配。</li><li>cluster-status：DB Custom 集群状态（Creating，Running，Destroying）。</li></ul>
                    ...
                    /**
                     * 获取<p>根据标签的 Key 和 Value 筛选 DB Custom 集群</p>
                    ...
                    /**
                     * 设置<p>根据标签的 Key 和 Value 筛选 DB Custom 集群</p>
...
#endif // !TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERSREQUEST_H_
