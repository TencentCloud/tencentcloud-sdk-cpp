...
#ifndef TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERNODECONFIGREQUEST_H_
#define TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERNODECONFIGREQUEST_H_
    ...
    namespace Dbdc
    {
        namespace V20201029
        {
            namespace Model
            {
                ...
                */
                class DescribeDBCustomClusterNodeConfigRequest : public AbstractModel
                {
                public:
                    DescribeDBCustomClusterNodeConfigRequest();
                    ~DescribeDBCustomClusterNodeConfigRequest() = default;
...
#endif // !TENCENTCLOUD_DBDC_V20201029_MODEL_DESCRIBEDBCUSTOMCLUSTERNODECONFIGREQUEST_H_
