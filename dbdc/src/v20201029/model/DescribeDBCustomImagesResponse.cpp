...
DescribeDBCustomImagesResponse::DescribeDBCustomImagesResponse() :
    m_totalCountHasBeenSet(false),
    m_imageSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDBCustomImagesResponse::Deserialize(const string &payload)
{
...
string DescribeDBCustomImagesResponse::ToJsonString() const
{
...
int64_t DescribeDBCustomImagesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDBCustomImagesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DBCustomImage> DescribeDBCustomImagesResponse::GetImageSet() const
{
    return m_imageSet;
}

bool DescribeDBCustomImagesResponse::ImageSetHasBeenSet() const
{
