...
CoreInternalOutcome DescribeInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceListResponse::ToJsonString() const
{
...
vector<DescribeInstanceDetail> DescribeInstanceListResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeInstanceListResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

int64_t DescribeInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstanceListResponse::TotalCountHasBeenSet() const
{
