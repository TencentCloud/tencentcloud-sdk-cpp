...
DescribeDBCustomNodeSecurityGroupsResponse::DescribeDBCustomNodeSecurityGroupsResponse() :
    m_groupsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDBCustomNodeSecurityGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeDBCustomNodeSecurityGroupsResponse::ToJsonString() const
{
...
vector<SecurityGroup> DescribeDBCustomNodeSecurityGroupsResponse::GetGroups() const
{
    return m_groups;
}

bool DescribeDBCustomNodeSecurityGroupsResponse::GroupsHasBeenSet() const
{
