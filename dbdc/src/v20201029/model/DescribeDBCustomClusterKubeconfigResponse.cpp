...
DescribeDBCustomClusterKubeconfigResponse::DescribeDBCustomClusterKubeconfigResponse() :
    m_kubeconfigHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDBCustomClusterKubeconfigResponse::Deserialize(const string &payload)
{
...
string DescribeDBCustomClusterKubeconfigResponse::ToJsonString() const
{
...
string DescribeDBCustomClusterKubeconfigResponse::GetKubeconfig() const
{
    return m_kubeconfig;
}

bool DescribeDBCustomClusterKubeconfigResponse::KubeconfigHasBeenSet() const
{
