...
DescribeDBCustomClustersResponse::DescribeDBCustomClustersResponse() :
    m_totalCountHasBeenSet(false),
    m_clusterSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDBCustomClustersResponse::Deserialize(const string &payload)
{
...
string DescribeDBCustomClustersResponse::ToJsonString() const
{
...
int64_t DescribeDBCustomClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDBCustomClustersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DBCustomCluster> DescribeDBCustomClustersResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeDBCustomClustersResponse::ClusterSetHasBeenSet() const
{
