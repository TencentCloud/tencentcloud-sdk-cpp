...
CreateDBCustomClusterResponse::CreateDBCustomClusterResponse() :
    m_clusterIdHasBeenSet(false),
    m_taskIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateDBCustomClusterResponse::Deserialize(const string &payload)
{
...
string CreateDBCustomClusterResponse::ToJsonString() const
{
...
string CreateDBCustomClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateDBCustomClusterResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

uint64_t CreateDBCustomClusterResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateDBCustomClusterResponse::TaskIdHasBeenSet() const
{
