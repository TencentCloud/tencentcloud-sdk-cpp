...
CoreInternalOutcome DescribeRelationResponse::Deserialize(const string &payload)
{
...
string DescribeRelationResponse::ToJsonString() const
{
...
vector<EntityRelationContent> DescribeRelationResponse::GetContent() const
{
    return m_content;
}

bool DescribeRelationResponse::ContentHasBeenSet() const
{
