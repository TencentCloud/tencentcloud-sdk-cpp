...
CoreInternalOutcome DescribeEntityResponse::Deserialize(const string &payload)
{
...
string DescribeEntityResponse::ToJsonString() const
{
...
string DescribeEntityResponse::GetContent() const
{
    return m_content;
}

bool DescribeEntityResponse::ContentHasBeenSet() const
{
