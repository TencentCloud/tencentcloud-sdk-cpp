...
#ifndef TENCENTCLOUD_TKGDQ_V20190411_MODEL_ENTITYRELATIONOBJECT_H_
#define TENCENTCLOUD_TKGDQ_V20190411_MODEL_ENTITYRELATIONOBJECT_H_
    ...
    namespace Tkgdq
    {
        namespace V20190411
        {
            namespace Model
            {
                ...
                * 实体关系查询返回的Object类型
                */
                class EntityRelationObject : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_TKGDQ_V20190411_MODEL_ENTITYRELATIONOBJECT_H_
