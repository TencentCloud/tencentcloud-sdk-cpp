...
CoreInternalOutcome DescribeImageFilterPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeImageFilterPersonalResponse::ToJsonString() const
{
...
SameImagesResp DescribeImageFilterPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeImageFilterPersonalResponse::DataHasBeenSet() const
{
