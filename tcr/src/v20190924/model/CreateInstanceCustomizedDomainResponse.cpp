...
CoreInternalOutcome CreateInstanceCustomizedDomainResponse::Deserialize(const string &payload)
{
...
string CreateInstanceCustomizedDomainResponse::ToJsonString() const
{
