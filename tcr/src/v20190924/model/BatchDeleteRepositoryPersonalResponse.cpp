...
CoreInternalOutcome BatchDeleteRepositoryPersonalResponse::Deserialize(const string &payload)
{
...
string BatchDeleteRepositoryPersonalResponse::ToJsonString() const
{
