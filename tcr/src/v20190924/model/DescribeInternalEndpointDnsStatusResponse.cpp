...
CoreInternalOutcome DescribeInternalEndpointDnsStatusResponse::Deserialize(const string &payload)
{
...
string DescribeInternalEndpointDnsStatusResponse::ToJsonString() const
{
...
vector<VpcPrivateDomainStatus> DescribeInternalEndpointDnsStatusResponse::GetVpcSet() const
{
    return m_vpcSet;
}

bool DescribeInternalEndpointDnsStatusResponse::VpcSetHasBeenSet() const
{
