...
CoreInternalOutcome ValidateRepositoryExistPersonalResponse::Deserialize(const string &payload)
{
...
string ValidateRepositoryExistPersonalResponse::ToJsonString() const
{
...
RepoIsExistResp ValidateRepositoryExistPersonalResponse::GetData() const
{
    return m_data;
}

bool ValidateRepositoryExistPersonalResponse::DataHasBeenSet() const
{
