...
CoreInternalOutcome DescribeApplicationTriggerLogPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationTriggerLogPersonalResponse::ToJsonString() const
{
...
DescribeApplicationTriggerLogPersonalResp DescribeApplicationTriggerLogPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationTriggerLogPersonalResponse::DataHasBeenSet() const
{
