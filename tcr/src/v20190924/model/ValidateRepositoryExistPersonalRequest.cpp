...
string ValidateRepositoryExistPersonalRequest::ToJsonString() const
{
...
string ValidateRepositoryExistPersonalRequest::GetRepoName() const
{
    return m_repoName;
}

void ValidateRepositoryExistPersonalRequest::SetRepoName(const string& _repoName)
{
    m_repoName = _repoName;
    m_repoNameHasBeenSet = true;
}

bool ValidateRepositoryExistPersonalRequest::RepoNameHasBeenSet() const
{
