...
CoreInternalOutcome DescribeFavorRepositoryPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeFavorRepositoryPersonalResponse::ToJsonString() const
{
...
FavorResp DescribeFavorRepositoryPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeFavorRepositoryPersonalResponse::DataHasBeenSet() const
{
