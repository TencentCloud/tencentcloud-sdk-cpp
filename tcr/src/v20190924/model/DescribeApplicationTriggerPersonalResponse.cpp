...
CoreInternalOutcome DescribeApplicationTriggerPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationTriggerPersonalResponse::ToJsonString() const
{
...
DescribeApplicationTriggerPersonalResp DescribeApplicationTriggerPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationTriggerPersonalResponse::DataHasBeenSet() const
{
