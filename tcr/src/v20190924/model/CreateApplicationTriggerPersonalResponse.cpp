...
CoreInternalOutcome CreateApplicationTriggerPersonalResponse::Deserialize(const string &payload)
{
...
string CreateApplicationTriggerPersonalResponse::ToJsonString() const
{
