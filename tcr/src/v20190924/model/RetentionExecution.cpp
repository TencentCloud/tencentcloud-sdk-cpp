...
CoreInternalOutcome RetentionExecution::Deserialize(const Value &value)
{
    string requestId = "";
...
void RetentionExecution::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
