...
CoreInternalOutcome DeleteInstanceCustomizedDomainResponse::Deserialize(const string &payload)
{
...
string DeleteInstanceCustomizedDomainResponse::ToJsonString() const
{
