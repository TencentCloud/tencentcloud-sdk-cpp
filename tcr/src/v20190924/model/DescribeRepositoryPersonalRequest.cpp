...
string DescribeRepositoryPersonalRequest::ToJsonString() const
{
...
string DescribeRepositoryPersonalRequest::GetRepoName() const
{
    return m_repoName;
}

void DescribeRepositoryPersonalRequest::SetRepoName(const string& _repoName)
{
    m_repoName = _repoName;
    m_repoNameHasBeenSet = true;
}

bool DescribeRepositoryPersonalRequest::RepoNameHasBeenSet() const
{
