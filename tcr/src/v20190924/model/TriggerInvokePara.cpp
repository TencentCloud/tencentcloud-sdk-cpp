...
CoreInternalOutcome TriggerInvokePara::Deserialize(const Value &value)
{
    string requestId = "";
...
void TriggerInvokePara::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
