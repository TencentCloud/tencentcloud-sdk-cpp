...
CoreInternalOutcome CreateImageAccelerationServiceResponse::Deserialize(const string &payload)
{
...
string CreateImageAccelerationServiceResponse::ToJsonString() const
{
...
string CreateImageAccelerationServiceResponse::GetRegistryId() const
{
    return m_registryId;
}

bool CreateImageAccelerationServiceResponse::RegistryIdHasBeenSet() const
{
