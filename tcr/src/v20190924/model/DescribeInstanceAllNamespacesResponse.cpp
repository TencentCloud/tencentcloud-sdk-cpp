...
CoreInternalOutcome DescribeInstanceAllNamespacesResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceAllNamespacesResponse::ToJsonString() const
{
