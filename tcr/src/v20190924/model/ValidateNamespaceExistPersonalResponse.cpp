...
CoreInternalOutcome ValidateNamespaceExistPersonalResponse::Deserialize(const string &payload)
{
...
string ValidateNamespaceExistPersonalResponse::ToJsonString() const
{
...
NamespaceIsExistsResp ValidateNamespaceExistPersonalResponse::GetData() const
{
    return m_data;
}

bool ValidateNamespaceExistPersonalResponse::DataHasBeenSet() const
{
