...
CoreInternalOutcome DescribeRepositoryFilterPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeRepositoryFilterPersonalResponse::ToJsonString() const
{
...
SearchUserRepositoryResp DescribeRepositoryFilterPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeRepositoryFilterPersonalResponse::DataHasBeenSet() const
{
