...
CoreInternalOutcome DescribeGCJobsResponse::Deserialize(const string &payload)
{
...
string DescribeGCJobsResponse::ToJsonString() const
{
...
vector<GCJobInfo> DescribeGCJobsResponse::GetJobs() const
{
    return m_jobs;
}

bool DescribeGCJobsResponse::JobsHasBeenSet() const
{
