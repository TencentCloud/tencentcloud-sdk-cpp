...
CoreInternalOutcome DescribeImagePersonalResponse::Deserialize(const string &payload)
{
...
string DescribeImagePersonalResponse::ToJsonString() const
{
...
TagInfoResp DescribeImagePersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeImagePersonalResponse::DataHasBeenSet() const
{
