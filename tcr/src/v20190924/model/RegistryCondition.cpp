...
CoreInternalOutcome RegistryCondition::Deserialize(const Value &value)
{
    string requestId = "";
...
void RegistryCondition::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
