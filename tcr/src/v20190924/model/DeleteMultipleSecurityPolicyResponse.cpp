...
CoreInternalOutcome DeleteMultipleSecurityPolicyResponse::Deserialize(const string &payload)
{
...
string DeleteMultipleSecurityPolicyResponse::ToJsonString() const
{
...
string DeleteMultipleSecurityPolicyResponse::GetRegistryId() const
{
    return m_registryId;
}

bool DeleteMultipleSecurityPolicyResponse::RegistryIdHasBeenSet() const
{
