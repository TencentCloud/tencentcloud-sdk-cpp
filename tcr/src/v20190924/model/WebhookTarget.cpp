...
CoreInternalOutcome WebhookTarget::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Headers") && !value["Headers"].IsNull())
    {
        ...
        const Value &tmpValue = value["Headers"];
...
void WebhookTarget::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
