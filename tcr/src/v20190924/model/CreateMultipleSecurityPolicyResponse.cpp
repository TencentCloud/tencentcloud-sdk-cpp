...
CoreInternalOutcome CreateMultipleSecurityPolicyResponse::Deserialize(const string &payload)
{
...
string CreateMultipleSecurityPolicyResponse::ToJsonString() const
{
...
string CreateMultipleSecurityPolicyResponse::GetRegistryId() const
{
    return m_registryId;
}

bool CreateMultipleSecurityPolicyResponse::RegistryIdHasBeenSet() const
{
