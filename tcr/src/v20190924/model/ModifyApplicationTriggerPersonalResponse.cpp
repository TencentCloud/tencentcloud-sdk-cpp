...
CoreInternalOutcome ModifyApplicationTriggerPersonalResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationTriggerPersonalResponse::ToJsonString() const
{
