...
CoreInternalOutcome DescribeRepositoryOwnerPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeRepositoryOwnerPersonalResponse::ToJsonString() const
{
...
RepoInfoResp DescribeRepositoryOwnerPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeRepositoryOwnerPersonalResponse::DataHasBeenSet() const
{
