...
CoreInternalOutcome TaskDetail::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("TaskName") && !value["TaskName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskDetail.TaskName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskUUID") && !value["TaskUUID"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskDetail.TaskUUID` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaskMessage") && !value["TaskMessage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskDetail.TaskMessage` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CreatedTime") && !value["CreatedTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskDetail.CreatedTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FinishedTime") && !value["FinishedTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskDetail.FinishedTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void TaskDetail::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_taskUUIDHasBeenSet)
    {
        ...
        string key = "TaskUUID";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_taskUUID.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_taskMessageHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_taskMessage.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_finishedTimeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_finishedTime.c_str(), allocator).Move(), allocator);
    }
