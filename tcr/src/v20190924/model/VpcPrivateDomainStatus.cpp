...
CoreInternalOutcome VpcPrivateDomainStatus::Deserialize(const Value &value)
{
    string requestId = "";
...
void VpcPrivateDomainStatus::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
