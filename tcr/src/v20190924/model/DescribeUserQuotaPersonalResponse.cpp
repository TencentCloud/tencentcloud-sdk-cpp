...
CoreInternalOutcome DescribeUserQuotaPersonalResponse::Deserialize(const string &payload)
{
...
string DescribeUserQuotaPersonalResponse::ToJsonString() const
{
...
RespLimit DescribeUserQuotaPersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeUserQuotaPersonalResponse::DataHasBeenSet() const
{
