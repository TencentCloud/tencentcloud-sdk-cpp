...
CoreInternalOutcome DescribeNamespacePersonalResponse::Deserialize(const string &payload)
{
...
string DescribeNamespacePersonalResponse::ToJsonString() const
{
...
NamespaceInfoResp DescribeNamespacePersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeNamespacePersonalResponse::DataHasBeenSet() const
{
