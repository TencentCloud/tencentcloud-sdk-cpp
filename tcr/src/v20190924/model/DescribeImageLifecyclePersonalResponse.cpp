...
CoreInternalOutcome DescribeImageLifecyclePersonalResponse::Deserialize(const string &payload)
{
...
string DescribeImageLifecyclePersonalResponse::ToJsonString() const
{
...
AutoDelStrategyInfoResp DescribeImageLifecyclePersonalResponse::GetData() const
{
    return m_data;
}

bool DescribeImageLifecyclePersonalResponse::DataHasBeenSet() const
{
