...
string DeleteRepositoryPersonalRequest::ToJsonString() const
{
...
string DeleteRepositoryPersonalRequest::GetRepoName() const
{
    return m_repoName;
}

void DeleteRepositoryPersonalRequest::SetRepoName(const string& _repoName)
{
    m_repoName = _repoName;
    m_repoNameHasBeenSet = true;
}

bool DeleteRepositoryPersonalRequest::RepoNameHasBeenSet() const
{
