...
CoreInternalOutcome DeleteApplicationTriggerPersonalResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationTriggerPersonalResponse::ToJsonString() const
{
