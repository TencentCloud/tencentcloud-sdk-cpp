...
CoreInternalOutcome DescribeInstanceCustomizedDomainResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceCustomizedDomainResponse::ToJsonString() const
{
...
vector<CustomizedDomainInfo> DescribeInstanceCustomizedDomainResponse::GetDomainInfoList() const
{
    return m_domainInfoList;
}

bool DescribeInstanceCustomizedDomainResponse::DomainInfoListHasBeenSet() const
{
    return m_domainInfoListHasBeenSet;
}

int64_t DescribeInstanceCustomizedDomainResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstanceCustomizedDomainResponse::TotalCountHasBeenSet() const
{
