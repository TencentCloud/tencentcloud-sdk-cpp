...
CoreInternalOutcome DuplicateImagePersonalResponse::Deserialize(const string &payload)
{
...
string DuplicateImagePersonalResponse::ToJsonString() const
{
...
DupImageTagResp DuplicateImagePersonalResponse::GetData() const
{
    return m_data;
}

bool DuplicateImagePersonalResponse::DataHasBeenSet() const
{
