...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_SKILLTYPE_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_SKILLTYPE_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                * skill 数据结构
                */
                class SkillType : public AbstractModel
                {
                public:
                    SkillType();
                    ~SkillType() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_SKILLTYPE_H_
