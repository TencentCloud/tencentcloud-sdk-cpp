...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_VERSIONLIST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_VERSIONLIST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                * 模型版本详情
                */
                class VersionList : public AbstractModel
                {
                public:
                    VersionList();
                    ~VersionList() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_VERSIONLIST_H_
