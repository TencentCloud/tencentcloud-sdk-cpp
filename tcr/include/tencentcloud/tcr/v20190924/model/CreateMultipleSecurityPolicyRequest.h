...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_CREATEMULTIPLESECURITYPOLICYREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_CREATEMULTIPLESECURITYPOLICYREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class CreateMultipleSecurityPolicyRequest : public AbstractModel
                {
                public:
                    CreateMultipleSecurityPolicyRequest();
                    ~CreateMultipleSecurityPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_CREATEMULTIPLESECURITYPOLICYREQUEST_H_
