...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_CREATEINTERNALENDPOINTDNSREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_CREATEINTERNALENDPOINTDNSREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class CreateInternalEndpointDnsRequest : public AbstractModel
                {
                public:
                    CreateInternalEndpointDnsRequest();
                    ~CreateInternalEndpointDnsRequest() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_CREATEINTERNALENDPOINTDNSREQUEST_H_
