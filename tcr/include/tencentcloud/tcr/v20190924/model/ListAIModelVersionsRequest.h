...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_LISTAIMODELVERSIONSREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_LISTAIMODELVERSIONSREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class ListAIModelVersionsRequest : public AbstractModel
                {
                public:
                    ListAIModelVersionsRequest();
                    ~ListAIModelVersionsRequest() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_LISTAIMODELVERSIONSREQUEST_H_
