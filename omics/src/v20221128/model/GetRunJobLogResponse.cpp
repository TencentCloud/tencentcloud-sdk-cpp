...
GetRunJobLogResponse::GetRunJobLogResponse() :
    m_contentHasBeenSet(false)
{
}

CoreInternalOutcome GetRunJobLogResponse::Deserialize(const string &payload)
{
...
string GetRunJobLogResponse::ToJsonString() const
{
...
string GetRunJobLogResponse::GetContent() const
{
    return m_content;
}

bool GetRunJobLogResponse::ContentHasBeenSet() const
{
