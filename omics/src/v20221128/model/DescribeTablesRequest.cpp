...
string DescribeTablesRequest::GetProjectId() const
{
    return m_projectId;
}

void DescribeTablesRequest::SetProjectId(const string& _projectId)
{
    m_projectId = _projectId;
    m_projectIdHasBeenSet = true;
}

bool DescribeTablesRequest::ProjectIdHasBeenSet() const
{
    return m_projectIdHasBeenSet;
}

uint64_t DescribeTablesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeTablesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
