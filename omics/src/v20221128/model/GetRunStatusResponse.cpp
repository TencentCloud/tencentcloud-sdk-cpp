...
CoreInternalOutcome GetRunStatusResponse::Deserialize(const string &payload)
{
...
string GetRunStatusResponse::ToJsonString() const
{
...
RunMetadata GetRunStatusResponse::GetMetadata() const
{
    return m_metadata;
}

bool GetRunStatusResponse::MetadataHasBeenSet() const
{
