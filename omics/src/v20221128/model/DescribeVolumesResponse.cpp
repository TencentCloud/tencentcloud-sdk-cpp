...
CoreInternalOutcome DescribeVolumesResponse::Deserialize(const string &payload)
{
...
string DescribeVolumesResponse::ToJsonString() const
{
...
vector<Volume> DescribeVolumesResponse::GetVolumes() const
{
    return m_volumes;
}

bool DescribeVolumesResponse::VolumesHasBeenSet() const
{
    return m_volumesHasBeenSet;
}

uint64_t DescribeVolumesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVolumesResponse::TotalCountHasBeenSet() const
{
