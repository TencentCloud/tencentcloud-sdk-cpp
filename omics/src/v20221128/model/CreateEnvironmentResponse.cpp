...
string CreateEnvironmentResponse::ToJsonString() const
{
...
string CreateEnvironmentResponse::GetWorkflowUuid() const
{
    return m_workflowUuid;
}

bool CreateEnvironmentResponse::WorkflowUuidHasBeenSet() const
{
