...
DescribeHPCNodesResponse::DescribeHPCNodesResponse() :
    m_nodesHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeHPCNodesResponse::Deserialize(const string &payload)
{
...
string DescribeHPCNodesResponse::ToJsonString() const
{
...
vector<HPCNode> DescribeHPCNodesResponse::GetNodes() const
{
    return m_nodes;
}

bool DescribeHPCNodesResponse::NodesHasBeenSet() const
{
    return m_nodesHasBeenSet;
}

uint64_t DescribeHPCNodesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHPCNodesResponse::TotalCountHasBeenSet() const
{
