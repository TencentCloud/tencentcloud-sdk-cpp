...
GetInputTemplateFileResponse::GetInputTemplateFileResponse() :
    m_cosSignedUrlHasBeenSet(false),
    m_contentHasBeenSet(false)
{
}

CoreInternalOutcome GetInputTemplateFileResponse::Deserialize(const string &payload)
{
...
string GetInputTemplateFileResponse::ToJsonString() const
{
...
string GetInputTemplateFileResponse::GetCosSignedUrl() const
{
    return m_cosSignedUrl;
}

bool GetInputTemplateFileResponse::CosSignedUrlHasBeenSet() const
{
    return m_cosSignedUrlHasBeenSet;
}

string GetInputTemplateFileResponse::GetContent() const
{
    return m_content;
}

bool GetInputTemplateFileResponse::ContentHasBeenSet() const
{
