...
string DescribeApplicationsRequest::GetProjectId() const
{
    return m_projectId;
}

void DescribeApplicationsRequest::SetProjectId(const string& _projectId)
{
    m_projectId = _projectId;
    m_projectIdHasBeenSet = true;
}

bool DescribeApplicationsRequest::ProjectIdHasBeenSet() const
{
