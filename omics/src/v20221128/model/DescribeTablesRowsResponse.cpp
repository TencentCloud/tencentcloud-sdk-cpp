...
CoreInternalOutcome DescribeTablesRowsResponse::Deserialize(const string &payload)
{
...
string DescribeTablesRowsResponse::ToJsonString() const
{
...
uint64_t DescribeTablesRowsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTablesRowsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableRow> DescribeTablesRowsResponse::GetRows() const
{
    return m_rows;
}

bool DescribeTablesRowsResponse::RowsHasBeenSet() const
{
