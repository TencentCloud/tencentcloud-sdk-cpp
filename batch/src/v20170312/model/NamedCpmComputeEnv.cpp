...
CoreInternalOutcome NamedCpmComputeEnv::Deserialize(const Value &value)
{
    string requestId = "";
...
void NamedCpmComputeEnv::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
