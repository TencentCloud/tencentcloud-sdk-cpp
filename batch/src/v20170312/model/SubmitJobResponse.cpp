...
CoreInternalOutcome SubmitJobResponse::Deserialize(const string &payload)
{
...
string SubmitJobResponse::ToJsonString() const
{
...
string SubmitJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitJobResponse::JobIdHasBeenSet() const
{
