...
#ifndef TENCENTCLOUD_BATCH_V20170312_MODEL_CREATECPMCOMPUTEENVREQUEST_H_
#define TENCENTCLOUD_BATCH_V20170312_MODEL_CREATECPMCOMPUTEENVREQUEST_H_
    ...
    namespace Batch
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateCpmComputeEnvRequest : public AbstractModel
                {
                public:
                    CreateCpmComputeEnvRequest();
                    ~CreateCpmComputeEnvRequest() = default;
                     ...
                     */
                    NamedCpmComputeEnv GetComputeEnv() const;

                    /**
                     * 设置计算环境信息
                     * @param ComputeEnv 计算环境信息
                     */
                    void SetComputeEnv(const NamedCpmComputeEnv& _computeEnv);
                ...
                private:
                     ...
                     * 计算环境信息
                     */
                    NamedCpmComputeEnv m_computeEnv;
...
#endif // !TENCENTCLOUD_BATCH_V20170312_MODEL_CREATECPMCOMPUTEENVREQUEST_H_
