...
#ifndef TENCENTCLOUD_BATCH_V20170312_MODEL_DESCRIBEJOBREQUEST_H_
#define TENCENTCLOUD_BATCH_V20170312_MODEL_DESCRIBEJOBREQUEST_H_
    ...
    namespace Batch
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * DescribeJob请求参数结构体
                */
                class DescribeJobRequest : public AbstractModel
                {
                public:
                    DescribeJobRequest();
...
#endif // !TENCENTCLOUD_BATCH_V20170312_MODEL_DESCRIBEJOBREQUEST_H_
