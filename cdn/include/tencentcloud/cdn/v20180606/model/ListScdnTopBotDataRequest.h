...
#ifndef TENCENTCLOUD_CDN_V20180606_MODEL_LISTSCDNTOPBOTDATAREQUEST_H_
#define TENCENTCLOUD_CDN_V20180606_MODEL_LISTSCDNTOPBOTDATAREQUEST_H_
    ...
    namespace Cdn
    {
        namespace V20180606
        {
            namespace Model
            {
                ...
                */
                class ListScdnTopBotDataRequest : public AbstractModel
                {
                public:
                    ListScdnTopBotDataRequest();
                    ~ListScdnTopBotDataRequest() = default;
...
#endif // !TENCENTCLOUD_CDN_V20180606_MODEL_LISTSCDNTOPBOTDATAREQUEST_H_
