...
#ifndef TENCENTCLOUD_CDN_V20180606_MODEL_SCDNIPSTRATEGYFILTER_H_
#define TENCENTCLOUD_CDN_V20180606_MODEL_SCDNIPSTRATEGYFILTER_H_
    ...
    namespace Cdn
    {
        namespace V20180606
        {
            namespace Model
            {
                ...
                * IP策略查询过滤参数
                */
                class ScdnIpStrategyFilter : public AbstractModel
                {
                public:
                    ScdnIpStrategyFilter();
                    ~ScdnIpStrategyFilter() = default;
...
#endif // !TENCENTCLOUD_CDN_V20180606_MODEL_SCDNIPSTRATEGYFILTER_H_
