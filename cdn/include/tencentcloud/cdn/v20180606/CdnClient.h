    ...
    namespace Cdn
    {
        namespace V20180606
        {
            ...
            public:
                ...
                typedef Outcome<Error, Model::CreateScdnDomainResponse> CreateScdnDomainOutcome;
                ...
                typedef Outcome<Error, Model::DescribeDiagnoseReportResponse> DescribeDiagnoseReportOutcome;
