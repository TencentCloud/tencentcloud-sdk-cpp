...
CoreInternalOutcome HeaderKey::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Switch") && !value["Switch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `HeaderKey.Switch` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `HeaderKey.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void HeaderKey::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
