...
CoreInternalOutcome ListScdnLogTasksResponse::Deserialize(const string &payload)
{
...
string ListScdnLogTasksResponse::ToJsonString() const
{
...
vector<ScdnLogTaskDetail> ListScdnLogTasksResponse::GetTaskList() const
{
    return m_taskList;
}

bool ListScdnLogTasksResponse::TaskListHasBeenSet() const
{
    return m_taskListHasBeenSet;
}

int64_t ListScdnLogTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListScdnLogTasksResponse::TotalCountHasBeenSet() const
{
