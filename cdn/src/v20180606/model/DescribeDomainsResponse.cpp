...
vector<BriefDomain> DescribeDomainsResponse::GetDomains() const
{
    return m_domains;
}

bool DescribeDomainsResponse::DomainsHasBeenSet() const
{
    return m_domainsHasBeenSet;
}

int64_t DescribeDomainsResponse::GetTotalNumber() const
{
    return m_totalNumber;
}

bool DescribeDomainsResponse::TotalNumberHasBeenSet() const
{
