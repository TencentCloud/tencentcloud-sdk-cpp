...
CoreInternalOutcome DescribeIpVisitResponse::Deserialize(const string &payload)
{
...
string DescribeIpVisitResponse::ToJsonString() const
{
...
string DescribeIpVisitResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeIpVisitResponse::IntervalHasBeenSet() const
{
    return m_intervalHasBeenSet;
}

vector<ResourceData> DescribeIpVisitResponse::GetData() const
{
    return m_data;
}

bool DescribeIpVisitResponse::DataHasBeenSet() const
{
