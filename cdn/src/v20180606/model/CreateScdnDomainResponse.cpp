...
CoreInternalOutcome CreateScdnDomainResponse::Deserialize(const string &payload)
{
...
string CreateScdnDomainResponse::ToJsonString() const
{
...
string CreateScdnDomainResponse::GetResult() const
{
    return m_result;
}

bool CreateScdnDomainResponse::ResultHasBeenSet() const
{
