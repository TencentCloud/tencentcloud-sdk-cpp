...
CoreInternalOutcome IpFilterPathRule::Deserialize(const Value &value)
{
    string requestId = "";
...
void IpFilterPathRule::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
