...
CoreInternalOutcome CacheConfigFollowOrigin::Deserialize(const Value &value)
{
    string requestId = "";
...
void CacheConfigFollowOrigin::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
