...
CoreInternalOutcome AdvancedAuthenticationTypeD::Deserialize(const Value &value)
{
    string requestId = "";
...
void AdvancedAuthenticationTypeD::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
