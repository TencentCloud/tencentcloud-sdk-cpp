...
CoreInternalOutcome DescribeEventLogDataResponse::Deserialize(const string &payload)
{
...
string DescribeEventLogDataResponse::ToJsonString() const
{
...
vector<EventLogStatsData> DescribeEventLogDataResponse::GetResults() const
{
    return m_results;
}

bool DescribeEventLogDataResponse::ResultsHasBeenSet() const
{
