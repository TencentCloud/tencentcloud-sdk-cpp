...
CoreInternalOutcome GetDisableRecordsResponse::Deserialize(const string &payload)
{
...
string GetDisableRecordsResponse::ToJsonString() const
{
...
vector<UrlRecord> GetDisableRecordsResponse::GetUrlRecordList() const
{
