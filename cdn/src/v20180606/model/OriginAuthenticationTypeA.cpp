...
CoreInternalOutcome OriginAuthenticationTypeA::Deserialize(const Value &value)
{
    string requestId = "";
...
void OriginAuthenticationTypeA::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
