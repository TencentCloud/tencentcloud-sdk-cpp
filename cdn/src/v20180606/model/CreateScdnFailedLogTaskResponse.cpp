...
CoreInternalOutcome CreateScdnFailedLogTaskResponse::Deserialize(const string &payload)
{
...
string CreateScdnFailedLogTaskResponse::ToJsonString() const
{
...
string CreateScdnFailedLogTaskResponse::GetResult() const
{
    return m_result;
}

bool CreateScdnFailedLogTaskResponse::ResultHasBeenSet() const
{
