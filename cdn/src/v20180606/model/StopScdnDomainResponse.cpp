...
CoreInternalOutcome StopScdnDomainResponse::Deserialize(const string &payload)
{
...
string StopScdnDomainResponse::ToJsonString() const
{
...
string StopScdnDomainResponse::GetResult() const
{
    return m_result;
}

bool StopScdnDomainResponse::ResultHasBeenSet() const
{
