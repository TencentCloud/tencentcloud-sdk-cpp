...
CoreInternalOutcome DomainAreaConfig::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Area") && !value["Area"].IsNull())
    {
        ...
        const Value &tmpValue = value["Area"];
...
void DomainAreaConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
