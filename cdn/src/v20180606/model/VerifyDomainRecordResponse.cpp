...
CoreInternalOutcome VerifyDomainRecordResponse::Deserialize(const string &payload)
{
...
string VerifyDomainRecordResponse::ToJsonString() const
{
...
bool VerifyDomainRecordResponse::GetResult() const
{
    return m_result;
}

bool VerifyDomainRecordResponse::ResultHasBeenSet() const
{
