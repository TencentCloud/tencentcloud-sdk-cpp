...
CoreInternalOutcome ScdnEventLogConditions::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ScdnEventLogConditions::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
