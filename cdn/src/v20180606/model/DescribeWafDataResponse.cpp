...
CoreInternalOutcome DescribeWafDataResponse::Deserialize(const string &payload)
{
...
string DescribeWafDataResponse::ToJsonString() const
{
...
vector<TimestampData> DescribeWafDataResponse::GetData() const
{
    return m_data;
}

bool DescribeWafDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeWafDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeWafDataResponse::IntervalHasBeenSet() const
{
