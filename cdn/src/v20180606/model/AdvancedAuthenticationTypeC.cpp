...
CoreInternalOutcome AdvancedAuthenticationTypeC::Deserialize(const Value &value)
{
    string requestId = "";
...
void AdvancedAuthenticationTypeC::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
