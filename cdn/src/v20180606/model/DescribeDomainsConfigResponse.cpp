...
CoreInternalOutcome DescribeDomainsConfigResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TotalNumber") && !rsp["TotalNumber"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TotalNumber` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string DescribeDomainsConfigResponse::ToJsonString() const
{
...
vector<DetailDomain> DescribeDomainsConfigResponse::GetDomains() const
{
    return m_domains;
}

bool DescribeDomainsConfigResponse::DomainsHasBeenSet() const
{
    return m_domainsHasBeenSet;
}

int64_t DescribeDomainsConfigResponse::GetTotalNumber() const
{
    return m_totalNumber;
}

bool DescribeDomainsConfigResponse::TotalNumberHasBeenSet() const
{
