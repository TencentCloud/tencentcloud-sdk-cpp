...
CoreInternalOutcome UpdateScdnDomainResponse::Deserialize(const string &payload)
{
...
string UpdateScdnDomainResponse::ToJsonString() const
{
...
string UpdateScdnDomainResponse::GetResult() const
{
    return m_result;
}

bool UpdateScdnDomainResponse::ResultHasBeenSet() const
{
