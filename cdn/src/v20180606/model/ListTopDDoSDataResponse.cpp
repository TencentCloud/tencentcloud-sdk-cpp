...
CoreInternalOutcome ListTopDDoSDataResponse::Deserialize(const string &payload)
{
...
string ListTopDDoSDataResponse::ToJsonString() const
{
...
vector<DDoSTopData> ListTopDDoSDataResponse::GetData() const
{
    return m_data;
}
