...
CoreInternalOutcome CreateScdnLogTaskResponse::Deserialize(const string &payload)
{
...
string CreateScdnLogTaskResponse::ToJsonString() const
{
...
string CreateScdnLogTaskResponse::GetResult() const
{
    return m_result;
}

bool CreateScdnLogTaskResponse::ResultHasBeenSet() const
{
