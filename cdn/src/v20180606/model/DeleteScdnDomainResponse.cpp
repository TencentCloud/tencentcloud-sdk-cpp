...
CoreInternalOutcome DeleteScdnDomainResponse::Deserialize(const string &payload)
{
...
string DeleteScdnDomainResponse::ToJsonString() const
{
...
string DeleteScdnDomainResponse::GetResult() const
{
    return m_result;
}

bool DeleteScdnDomainResponse::ResultHasBeenSet() const
{
