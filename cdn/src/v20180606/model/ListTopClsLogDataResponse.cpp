...
CoreInternalOutcome ListTopClsLogDataResponse::Deserialize(const string &payload)
{
...
string ListTopClsLogDataResponse::ToJsonString() const
{
...
vector<ClsLogIpData> ListTopClsLogDataResponse::GetData() const
{
    return m_data;
}

bool ListTopClsLogDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t ListTopClsLogDataResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListTopClsLogDataResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t ListTopClsLogDataResponse::GetIpCount() const
{
    return m_ipCount;
}

bool ListTopClsLogDataResponse::IpCountHasBeenSet() const
{
