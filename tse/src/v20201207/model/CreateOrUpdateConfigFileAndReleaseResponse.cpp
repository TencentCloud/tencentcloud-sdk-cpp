...
CoreInternalOutcome CreateOrUpdateConfigFileAndReleaseResponse::Deserialize(const string &payload)
{
...
string CreateOrUpdateConfigFileAndReleaseResponse::ToJsonString() const
{
...
bool CreateOrUpdateConfigFileAndReleaseResponse::GetResult() const
{
    return m_result;
}
