...
CoreInternalOutcome DescribeGovernanceInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeGovernanceInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeGovernanceInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeGovernanceInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<GovernanceInstance> DescribeGovernanceInstancesResponse::GetContent() const
{
    return m_content;
}
