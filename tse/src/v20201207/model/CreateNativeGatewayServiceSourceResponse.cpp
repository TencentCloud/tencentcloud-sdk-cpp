...
CoreInternalOutcome CreateNativeGatewayServiceSourceResponse::Deserialize(const string &payload)
{
...
string CreateNativeGatewayServiceSourceResponse::ToJsonString() const
{
...
bool CreateNativeGatewayServiceSourceResponse::GetResult() const
{
    return m_result;
}
