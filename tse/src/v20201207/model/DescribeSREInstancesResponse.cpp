...
CoreInternalOutcome DescribeSREInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeSREInstancesResponse::ToJsonString() const
{
...
int64_t DescribeSREInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSREInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SREInstance> DescribeSREInstancesResponse::GetContent() const
{
    return m_content;
}

bool DescribeSREInstancesResponse::ContentHasBeenSet() const
{
