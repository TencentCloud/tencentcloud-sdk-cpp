...
CoreInternalOutcome DescribeCloudNativeAPIGatewayNodesResponse::Deserialize(const string &payload)
{
...
string DescribeCloudNativeAPIGatewayNodesResponse::ToJsonString() const
{
...
DescribeCloudNativeAPIGatewayNodesResult DescribeCloudNativeAPIGatewayNodesResponse::GetResult() const
{
    return m_result;
}

bool DescribeCloudNativeAPIGatewayNodesResponse::ResultHasBeenSet() const
{
