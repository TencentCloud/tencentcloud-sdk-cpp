...
string DescribeGovernanceNamespacesRequest::ToJsonString() const
{
...
string DescribeGovernanceNamespacesRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeGovernanceNamespacesRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DescribeGovernanceNamespacesRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string DescribeGovernanceNamespacesRequest::GetName() const
{
    return m_name;
}

void DescribeGovernanceNamespacesRequest::SetName(const string& _name)
{
    m_name = _name;
...
void DescribeGovernanceNamespacesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeGovernanceNamespacesRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeGovernanceNamespacesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeGovernanceNamespacesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeGovernanceNamespacesRequest::LimitHasBeenSet() const
{
