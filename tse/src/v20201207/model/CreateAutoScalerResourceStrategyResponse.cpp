...
CoreInternalOutcome CreateAutoScalerResourceStrategyResponse::Deserialize(const string &payload)
{
...
string CreateAutoScalerResourceStrategyResponse::ToJsonString() const
{
...
bool CreateAutoScalerResourceStrategyResponse::GetResult() const
{
    return m_result;
}

bool CreateAutoScalerResourceStrategyResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string CreateAutoScalerResourceStrategyResponse::GetStrategyId() const
{
    return m_strategyId;
}

bool CreateAutoScalerResourceStrategyResponse::StrategyIdHasBeenSet() const
{
