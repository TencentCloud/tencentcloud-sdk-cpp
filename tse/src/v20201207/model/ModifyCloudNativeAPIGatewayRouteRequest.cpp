...
vector<KVMapping> ModifyCloudNativeAPIGatewayRouteRequest::GetQueryStringParameters() const
{
    return m_queryStringParameters;
}

void ModifyCloudNativeAPIGatewayRouteRequest::SetQueryStringParameters(const vector<KVMapping>& _queryStringParameters)
{
    m_queryStringParameters = _queryStringParameters;
    m_queryStringParametersHasBeenSet = true;
}

bool ModifyCloudNativeAPIGatewayRouteRequest::QueryStringParametersHasBeenSet() const
{
