...
CoreInternalOutcome CreateConfigFileResponse::Deserialize(const string &payload)
{
...
string CreateConfigFileResponse::ToJsonString() const
{
...
bool CreateConfigFileResponse::GetResult() const
{
    return m_result;
}
