...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYROUTEREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYROUTEREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class CreateCloudNativeAPIGatewayRouteRequest : public AbstractModel
                {
                public:
                    CreateCloudNativeAPIGatewayRouteRequest();
                    ~CreateCloudNativeAPIGatewayRouteRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYROUTEREQUEST_H_
