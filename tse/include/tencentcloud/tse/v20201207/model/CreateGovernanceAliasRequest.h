...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCEALIASREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCEALIASREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class CreateGovernanceAliasRequest : public AbstractModel
                {
                public:
                    CreateGovernanceAliasRequest();
                    ~CreateGovernanceAliasRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCEALIASREQUEST_H_
