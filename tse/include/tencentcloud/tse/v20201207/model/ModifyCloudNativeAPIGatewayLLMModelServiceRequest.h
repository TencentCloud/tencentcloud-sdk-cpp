...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudNativeAPIGatewayLLMModelServiceRequest : public AbstractModel
                {
                public:
                    ModifyCloudNativeAPIGatewayLLMModelServiceRequest();
                    ~ModifyCloudNativeAPIGatewayLLMModelServiceRequest() = default;
                    ...
                    /**
                     * 获取<p>修改服务名称，长度2-50字符，支持中英文、数字、下划线。</p>
                    ...
                    /**
                     * 设置<p>修改服务名称，长度2-50字符，支持中英文、数字、下划线。</p>
                    ...
                    /**
                     * 获取<p>修改默认模型，模型选择方式为 Specify 时必填。</p>
                    ...
                    /**
                     * 设置<p>修改默认模型，模型选择方式为 Specify 时必填。</p>
                    ...
                    /**
                     * 获取<p>修改模型选择方式，选项：Specify（指定模型）、PassThrough（透传请求模型）。</p>
                    ...
                    /**
                     * 设置<p>修改模型选择方式，选项：Specify（指定模型）、PassThrough（透传请求模型）。</p>
                    ...
                    /**
                     * 获取<p>修改开启模型降级，模型选择方式为 Specify 时必填。</p>
                    ...
                    /**
                     * 设置<p>修改开启模型降级，模型选择方式为 Specify 时必填。</p>
                    ...
                    /**
                     * 获取<p>修改可以配置备用模型规则，EnableSpecifyModelFallback 为 true 时必填。</p>
                    ...
                    /**
                     * 设置<p>修改可以配置备用模型规则，EnableSpecifyModelFallback 为 true 时必填。</p>
                    ...
                    /**
                     * 获取<p>修改开启模型参数校验，是否校验客户端传递的 model 参数, 模型选择方式为 PassThrough 时必填</p>
                    ...
                    /**
                     * 设置<p>修改开启模型参数校验，是否校验客户端传递的 model 参数, 模型选择方式为 PassThrough 时必填</p>
                    ...
                    /**
                     * 获取<p>修改模型检验信息，EnableModelParamCheck 为 true 时必填。</p>
                    ...
                    /**
                     * 设置<p>修改模型检验信息，EnableModelParamCheck 为 true 时必填。</p>
                    ...
                    /**
                     * 获取<p>自定义供应商名称</p><p>仅当Provider值为&quot;custom&quot;时允许填写</p>
                    ...
                    /**
                     * 设置<p>自定义供应商名称</p><p>仅当Provider值为&quot;custom&quot;时允许填写</p>
                     * @param _customProviderName <p>自定义供应商名称</p><p>仅当Provider值为&quot;custom&quot;时允许填写</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
