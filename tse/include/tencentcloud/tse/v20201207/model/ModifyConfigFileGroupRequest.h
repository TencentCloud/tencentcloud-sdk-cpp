...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCONFIGFILEGROUPREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCONFIGFILEGROUPREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class ModifyConfigFileGroupRequest : public AbstractModel
                {
                public:
                    ModifyConfigFileGroupRequest();
                    ~ModifyConfigFileGroupRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYCONFIGFILEGROUPREQUEST_H_
