...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_AIGWFALLBACKSERVICEITEM_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_AIGWFALLBACKSERVICEITEM_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                * 降级服务元素
                */
                class AIGWFallbackServiceItem : public AbstractModel
                {
                public:
                    AIGWFallbackServiceItem();
                    ~AIGWFallbackServiceItem() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_AIGWFALLBACKSERVICEITEM_H_
