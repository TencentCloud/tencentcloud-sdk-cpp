...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEGOVERNANCEALIASESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEGOVERNANCEALIASESREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DescribeGovernanceAliasesRequest : public AbstractModel
                {
                public:
                    DescribeGovernanceAliasesRequest();
                    ~DescribeGovernanceAliasesRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEGOVERNANCEALIASESREQUEST_H_
