...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCENAMESPACESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCENAMESPACESREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class ModifyGovernanceNamespacesRequest : public AbstractModel
                {
                public:
                    ModifyGovernanceNamespacesRequest();
                    ~ModifyGovernanceNamespacesRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCENAMESPACESREQUEST_H_
