...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCEINSTANCESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCEINSTANCESREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class ModifyGovernanceInstancesRequest : public AbstractModel
                {
                public:
                    ModifyGovernanceInstancesRequest();
                    ~ModifyGovernanceInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_MODIFYGOVERNANCEINSTANCESREQUEST_H_
