...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_GOVERNANCELANEGROUP_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_GOVERNANCELANEGROUP_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                * 泳道组
                */
                class GovernanceLaneGroup : public AbstractModel
                {
                public:
                    GovernanceLaneGroup();
                    ~GovernanceLaneGroup() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_GOVERNANCELANEGROUP_H_
