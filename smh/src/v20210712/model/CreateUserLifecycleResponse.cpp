...
CreateUserLifecycleResponse::CreateUserLifecycleResponse() :
...
CoreInternalOutcome CreateUserLifecycleResponse::Deserialize(const string &payload)
{
...
string CreateUserLifecycleResponse::ToJsonString() const
{
...
string CreateUserLifecycleResponse::GetUserId() const
{
    return m_userId;
}

bool CreateUserLifecycleResponse::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string CreateUserLifecycleResponse::GetIsolateTime() const
{
    return m_isolateTime;
}

bool CreateUserLifecycleResponse::IsolateTimeHasBeenSet() const
{
    return m_isolateTimeHasBeenSet;
}

string CreateUserLifecycleResponse::GetDestroyTime() const
{
    return m_destroyTime;
}

bool CreateUserLifecycleResponse::DestroyTimeHasBeenSet() const
{
