...
string DescribeLibrarySecretRequest::ToJsonString() const
{
...
string DescribeLibrarySecretRequest::GetLibraryId() const
{
    return m_libraryId;
}

void DescribeLibrarySecretRequest::SetLibraryId(const string& _libraryId)
{
    m_libraryId = _libraryId;
    m_libraryIdHasBeenSet = true;
}

bool DescribeLibrarySecretRequest::LibraryIdHasBeenSet() const
{
