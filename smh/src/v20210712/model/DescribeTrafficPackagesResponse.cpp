...
vector<TrafficPackage> DescribeTrafficPackagesResponse::GetList() const
{
    return m_list;
}

bool DescribeTrafficPackagesResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeTrafficPackagesResponse::GetTotalCount() const
{
    return m_totalCount;
}
