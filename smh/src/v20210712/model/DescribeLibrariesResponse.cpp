...
CoreInternalOutcome DescribeLibrariesResponse::Deserialize(const string &payload)
{
...
string DescribeLibrariesResponse::ToJsonString() const
{
...
vector<Library> DescribeLibrariesResponse::GetList() const
{
    return m_list;
}

bool DescribeLibrariesResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeLibrariesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLibrariesResponse::TotalCountHasBeenSet() const
{
