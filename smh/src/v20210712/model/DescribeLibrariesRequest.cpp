...
vector<TagFilter> DescribeLibrariesRequest::GetTagFilters() const
{
    return m_tagFilters;
}

void DescribeLibrariesRequest::SetTagFilters(const vector<TagFilter>& _tagFilters)
{
    m_tagFilters = _tagFilters;
    m_tagFiltersHasBeenSet = true;
}

bool DescribeLibrariesRequest::TagFiltersHasBeenSet() const
{
