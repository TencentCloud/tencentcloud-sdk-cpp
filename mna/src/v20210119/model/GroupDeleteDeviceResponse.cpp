...
CoreInternalOutcome GroupDeleteDeviceResponse::Deserialize(const string &payload)
{
...
string GroupDeleteDeviceResponse::ToJsonString() const
{
...
int64_t GroupDeleteDeviceResponse::GetDeviceNum() const
{
    return m_deviceNum;
}

bool GroupDeleteDeviceResponse::DeviceNumHasBeenSet() const
{
