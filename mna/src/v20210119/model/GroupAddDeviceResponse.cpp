...
CoreInternalOutcome GroupAddDeviceResponse::Deserialize(const string &payload)
{
...
string GroupAddDeviceResponse::ToJsonString() const
{
...
int64_t GroupAddDeviceResponse::GetDeviceNum() const
{
    return m_deviceNum;
}

bool GroupAddDeviceResponse::DeviceNumHasBeenSet() const
{
