...
CoreInternalOutcome RegionInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("RegionId") && !value["RegionId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RegionInfo.RegionId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string RegionInfo::GetRegionId() const
{
    return m_regionId;
}

void RegionInfo::SetRegionId(const string& _regionId)
{
