...
string GetApplicationRequest::ToJsonString() const
{
...
string GetApplicationRequest::GetMpApplicationId() const
{
    return m_mpApplicationId;
}

void GetApplicationRequest::SetMpApplicationId(const string& _mpApplicationId)
{
    m_mpApplicationId = _mpApplicationId;
    m_mpApplicationIdHasBeenSet = true;
}

bool GetApplicationRequest::MpApplicationIdHasBeenSet() const
{
