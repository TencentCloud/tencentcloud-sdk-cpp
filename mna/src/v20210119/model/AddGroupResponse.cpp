...
CoreInternalOutcome AddGroupResponse::Deserialize(const string &payload)
{
...
string AddGroupResponse::ToJsonString() const
{
...
string AddGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool AddGroupResponse::GroupIdHasBeenSet() const
{
