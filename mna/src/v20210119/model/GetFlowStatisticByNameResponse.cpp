...
CoreInternalOutcome GetFlowStatisticByNameResponse::Deserialize(const string &payload)
{
...
string GetFlowStatisticByNameResponse::ToJsonString() const
{
...
vector<NetDetails> GetFlowStatisticByNameResponse::GetNetDetails() const
{
    return m_netDetails;
}

bool GetFlowStatisticByNameResponse::NetDetailsHasBeenSet() const
{
    return m_netDetailsHasBeenSet;
}

double GetFlowStatisticByNameResponse::GetMaxValue() const
{
    return m_maxValue;
}

bool GetFlowStatisticByNameResponse::MaxValueHasBeenSet() const
{
    return m_maxValueHasBeenSet;
}

double GetFlowStatisticByNameResponse::GetAvgValue() const
{
    return m_avgValue;
}

bool GetFlowStatisticByNameResponse::AvgValueHasBeenSet() const
{
    return m_avgValueHasBeenSet;
}

double GetFlowStatisticByNameResponse::GetTotalValue() const
{
    return m_totalValue;
}

bool GetFlowStatisticByNameResponse::TotalValueHasBeenSet() const
{
