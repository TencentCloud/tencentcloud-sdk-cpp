...
CoreInternalOutcome GetNetMonitorByNameResponse::Deserialize(const string &payload)
{
...
string GetNetMonitorByNameResponse::ToJsonString() const
{
...
vector<MonitorData> GetNetMonitorByNameResponse::GetMonitorData() const
{
    return m_monitorData;
}

bool GetNetMonitorByNameResponse::MonitorDataHasBeenSet() const
{
    return m_monitorDataHasBeenSet;
}

string GetNetMonitorByNameResponse::GetAccessRegion() const
{
    return m_accessRegion;
}

bool GetNetMonitorByNameResponse::AccessRegionHasBeenSet() const
{
