...
CoreInternalOutcome GetMonitorDataByNameResponse::Deserialize(const string &payload)
{
...
string GetMonitorDataByNameResponse::ToJsonString() const
{
...
string GetMonitorDataByNameResponse::GetFilePath() const
{
    return m_filePath;
}

bool GetMonitorDataByNameResponse::FilePathHasBeenSet() const
{
