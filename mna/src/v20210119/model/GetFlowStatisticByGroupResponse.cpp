...
CoreInternalOutcome GetFlowStatisticByGroupResponse::Deserialize(const string &payload)
{
...
string GetFlowStatisticByGroupResponse::ToJsonString() const
{
...
vector<NetDetails> GetFlowStatisticByGroupResponse::GetNetDetails() const
{
    return m_netDetails;
}

bool GetFlowStatisticByGroupResponse::NetDetailsHasBeenSet() const
{
    return m_netDetailsHasBeenSet;
}

double GetFlowStatisticByGroupResponse::GetMaxValue() const
{
    return m_maxValue;
}

bool GetFlowStatisticByGroupResponse::MaxValueHasBeenSet() const
{
    return m_maxValueHasBeenSet;
}

double GetFlowStatisticByGroupResponse::GetAvgValue() const
{
    return m_avgValue;
}

bool GetFlowStatisticByGroupResponse::AvgValueHasBeenSet() const
{
    return m_avgValueHasBeenSet;
}

double GetFlowStatisticByGroupResponse::GetTotalValue() const
{
    return m_totalValue;
}

bool GetFlowStatisticByGroupResponse::TotalValueHasBeenSet() const
{
