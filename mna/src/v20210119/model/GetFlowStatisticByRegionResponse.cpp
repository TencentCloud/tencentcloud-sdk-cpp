...
CoreInternalOutcome GetFlowStatisticByRegionResponse::Deserialize(const string &payload)
{
...
string GetFlowStatisticByRegionResponse::ToJsonString() const
{
...
vector<NetDetails> GetFlowStatisticByRegionResponse::GetNetDetails() const
{
    return m_netDetails;
}

bool GetFlowStatisticByRegionResponse::NetDetailsHasBeenSet() const
{
    return m_netDetailsHasBeenSet;
}

double GetFlowStatisticByRegionResponse::GetMaxValue() const
{
    return m_maxValue;
}

bool GetFlowStatisticByRegionResponse::MaxValueHasBeenSet() const
{
    return m_maxValueHasBeenSet;
}

double GetFlowStatisticByRegionResponse::GetAvgValue() const
{
    return m_avgValue;
}

bool GetFlowStatisticByRegionResponse::AvgValueHasBeenSet() const
{
    return m_avgValueHasBeenSet;
}

double GetFlowStatisticByRegionResponse::GetTotalValue() const
{
    return m_totalValue;
}

bool GetFlowStatisticByRegionResponse::TotalValueHasBeenSet() const
{
