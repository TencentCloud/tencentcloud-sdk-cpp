...
CoreInternalOutcome GetStatisticDataByNameResponse::Deserialize(const string &payload)
{
...
string GetStatisticDataByNameResponse::ToJsonString() const
{
...
string GetStatisticDataByNameResponse::GetFilePath() const
{
    return m_filePath;
}

bool GetStatisticDataByNameResponse::FilePathHasBeenSet() const
{
