...
CoreInternalOutcome DownloadActiveDeviceCountResponse::Deserialize(const string &payload)
{
...
string DownloadActiveDeviceCountResponse::ToJsonString() const
{
...
string DownloadActiveDeviceCountResponse::GetFilePath() const
{
    return m_filePath;
}

bool DownloadActiveDeviceCountResponse::FilePathHasBeenSet() const
{
