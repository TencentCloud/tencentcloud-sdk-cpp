...
CoreInternalOutcome GetStatisticDataResponse::Deserialize(const string &payload)
{
...
string GetStatisticDataResponse::ToJsonString() const
{
...
string GetStatisticDataResponse::GetFilePath() const
{
    return m_filePath;
}

bool GetStatisticDataResponse::FilePathHasBeenSet() const
{
