...
CoreInternalOutcome OrderPerLicenseResponse::Deserialize(const string &payload)
{
...
string OrderPerLicenseResponse::ToJsonString() const
{
...
string OrderPerLicenseResponse::GetResourceId() const
{
    return m_resourceId;
}

bool OrderPerLicenseResponse::ResourceIdHasBeenSet() const
{
