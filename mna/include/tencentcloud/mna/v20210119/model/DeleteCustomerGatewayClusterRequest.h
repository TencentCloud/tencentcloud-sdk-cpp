...
#ifndef TENCENTCLOUD_MNA_V20210119_MODEL_DELETECUSTOMERGATEWAYCLUSTERREQUEST_H_
#define TENCENTCLOUD_MNA_V20210119_MODEL_DELETECUSTOMERGATEWAYCLUSTERREQUEST_H_
    ...
    namespace Mna
    {
        namespace V20210119
        {
            namespace Model
            {
                ...
                */
                class DeleteCustomerGatewayClusterRequest : public AbstractModel
                {
                public:
                    DeleteCustomerGatewayClusterRequest();
                    ~DeleteCustomerGatewayClusterRequest() = default;
...
#endif // !TENCENTCLOUD_MNA_V20210119_MODEL_DELETECUSTOMERGATEWAYCLUSTERREQUEST_H_
