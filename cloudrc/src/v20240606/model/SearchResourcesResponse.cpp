...
CoreInternalOutcome SearchResourcesResponse::Deserialize(const string &payload)
{
...
string SearchResourcesResponse::ToJsonString() const
{
...
string SearchResourcesResponse::GetNextToken() const
{
    return m_nextToken;
}

bool SearchResourcesResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

vector<ResourceSummary> SearchResourcesResponse::GetResources() const
{
    return m_resources;
}

bool SearchResourcesResponse::ResourcesHasBeenSet() const
{
