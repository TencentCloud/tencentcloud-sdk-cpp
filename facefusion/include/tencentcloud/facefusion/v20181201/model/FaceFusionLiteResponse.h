...
#ifndef TENCENTCLOUD_FACEFUSION_V20181201_MODEL_FACEFUSIONLITERESPONSE_H_
#define TENCENTCLOUD_FACEFUSION_V20181201_MODEL_FACEFUSIONLITERESPONSE_H_
    ...
    namespace Facefusion
    {
        namespace V20181201
        {
            namespace Model
            {
                ...
                */
                class FaceFusionLiteResponse : public AbstractModel
                {
                public:
                    FaceFusionLiteResponse();
                    ~FaceFusionLiteResponse() = default;
...
#endif // !TENCENTCLOUD_FACEFUSION_V20181201_MODEL_FACEFUSIONLITERESPONSE_H_
