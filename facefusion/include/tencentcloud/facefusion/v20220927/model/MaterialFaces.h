...
#ifndef TENCENTCLOUD_FACEFUSION_V20220927_MODEL_MATERIALFACES_H_
#define TENCENTCLOUD_FACEFUSION_V20220927_MODEL_MATERIALFACES_H_
    ...
    namespace Facefusion
    {
        namespace V20220927
        {
            namespace Model
            {
                ...
                * 人脸信息
                */
                class MaterialFaces : public AbstractModel
                {
                public:
                    MaterialFaces();
                    ~MaterialFaces() = default;
...
#endif // !TENCENTCLOUD_FACEFUSION_V20220927_MODEL_MATERIALFACES_H_
