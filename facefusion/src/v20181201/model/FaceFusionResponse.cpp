...
CoreInternalOutcome FaceFusionResponse::Deserialize(const string &payload)
{
...
string FaceFusionResponse::ToJsonString() const
{
...
string FaceFusionResponse::GetImage() const
{
    return m_image;
}

bool FaceFusionResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

vector<FuseFaceReviewResult> FaceFusionResponse::GetReviewResultSet() const
{
    return m_reviewResultSet;
}

bool FaceFusionResponse::ReviewResultSetHasBeenSet() const
{
