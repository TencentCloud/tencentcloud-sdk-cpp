...
CoreInternalOutcome MaterialFaceList::Deserialize(const Value &value)
{
    string requestId = "";
...
void MaterialFaceList::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
