...
CoreInternalOutcome FaceFusionLiteResponse::Deserialize(const string &payload)
{
...
string FaceFusionLiteResponse::ToJsonString() const
{
...
string FaceFusionLiteResponse::GetImage() const
{
    return m_image;
}

bool FaceFusionLiteResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

vector<FuseFaceReviewResult> FaceFusionLiteResponse::GetReviewResultSet() const
{
    return m_reviewResultSet;
}

bool FaceFusionLiteResponse::ReviewResultSetHasBeenSet() const
{
