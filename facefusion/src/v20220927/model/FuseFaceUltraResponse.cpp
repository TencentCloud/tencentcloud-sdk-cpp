...
FuseFaceUltraResponse::FuseFaceUltraResponse() :
    m_fusedImageHasBeenSet(false)
{
}

CoreInternalOutcome FuseFaceUltraResponse::Deserialize(const string &payload)
{
...
string FuseFaceUltraResponse::ToJsonString() const
{
...
string FuseFaceUltraResponse::GetFusedImage() const
{
    return m_fusedImage;
}

bool FuseFaceUltraResponse::FusedImageHasBeenSet() const
{
