...
#ifndef TENCENTCLOUD_SMPN_V20190822_MODEL_CREATESMPNEPAREQUEST_H_
#define TENCENTCLOUD_SMPN_V20190822_MODEL_CREATESMPNEPAREQUEST_H_
    ...
    namespace Smpn
    {
        namespace V20190822
        {
            namespace Model
            {
                ...
                */
                class CreateSmpnEpaRequest : public AbstractModel
                {
                public:
                    CreateSmpnEpaRequest();
                    ~CreateSmpnEpaRequest() = default;
...
#endif // !TENCENTCLOUD_SMPN_V20190822_MODEL_CREATESMPNEPAREQUEST_H_
