...
#ifndef TENCENTCLOUD_SMPN_V20190822_MODEL_MHMRESPONSE_H_
#define TENCENTCLOUD_SMPN_V20190822_MODEL_MHMRESPONSE_H_
    ...
    namespace Smpn
    {
        namespace V20190822
        {
            namespace Model
            {
                ...
                * 号码营销监控回应
                */
                class MHMResponse : public AbstractModel
                {
                public:
                    MHMResponse();
                    ~MHMResponse() = default;
...
#endif // !TENCENTCLOUD_SMPN_V20190822_MODEL_MHMRESPONSE_H_
