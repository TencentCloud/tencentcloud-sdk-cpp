...
CoreInternalOutcome EPARequest::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void EPARequest::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
