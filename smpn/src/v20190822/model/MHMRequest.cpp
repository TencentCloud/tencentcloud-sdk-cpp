...
CoreInternalOutcome MHMRequest::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void MHMRequest::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string MHMRequest::GetPhoneNumber() const
{
    return m_phoneNumber;
}

void MHMRequest::SetPhoneNumber(const string& _phoneNumber)
{
    m_phoneNumber = _phoneNumber;
    m_phoneNumberHasBeenSet = true;
}

bool MHMRequest::PhoneNumberHasBeenSet() const
{
