...
CoreInternalOutcome UpdateAuditResponse::Deserialize(const string &payload)
{
...
string UpdateAuditResponse::ToJsonString() const
{
...
int64_t UpdateAuditResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool UpdateAuditResponse::IsSuccessHasBeenSet() const
{
