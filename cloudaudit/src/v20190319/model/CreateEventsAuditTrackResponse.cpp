...
CreateEventsAuditTrackResponse::CreateEventsAuditTrackResponse() :
    m_trackIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateEventsAuditTrackResponse::Deserialize(const string &payload)
{
...
string CreateEventsAuditTrackResponse::ToJsonString() const
{
...
uint64_t CreateEventsAuditTrackResponse::GetTrackId() const
{
    return m_trackId;
}

bool CreateEventsAuditTrackResponse::TrackIdHasBeenSet() const
{
