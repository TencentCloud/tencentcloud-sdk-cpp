...
string ListCmqEnableRegionRequest::ToJsonString() const
{
...
string ListCmqEnableRegionRequest::GetWebsiteType() const
{
    return m_websiteType;
}

void ListCmqEnableRegionRequest::SetWebsiteType(const string& _websiteType)
{
    m_websiteType = _websiteType;
    m_websiteTypeHasBeenSet = true;
}

bool ListCmqEnableRegionRequest::WebsiteTypeHasBeenSet() const
{
