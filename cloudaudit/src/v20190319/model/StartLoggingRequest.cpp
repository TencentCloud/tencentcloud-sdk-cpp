...
string StartLoggingRequest::ToJsonString() const
{
...
string StartLoggingRequest::GetAuditName() const
{
    return m_auditName;
}

void StartLoggingRequest::SetAuditName(const string& _auditName)
{
    m_auditName = _auditName;
    m_auditNameHasBeenSet = true;
}

bool StartLoggingRequest::AuditNameHasBeenSet() const
{
