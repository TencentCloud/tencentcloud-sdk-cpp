...
string DeleteAuditRequest::ToJsonString() const
{
...
string DeleteAuditRequest::GetAuditName() const
{
    return m_auditName;
}

void DeleteAuditRequest::SetAuditName(const string& _auditName)
{
    m_auditName = _auditName;
    m_auditNameHasBeenSet = true;
}

bool DeleteAuditRequest::AuditNameHasBeenSet() const
{
