...
string DescribeAuditTrackRequest::ToJsonString() const
{
...
uint64_t DescribeAuditTrackRequest::GetTrackId() const
{
    return m_trackId;
}

void DescribeAuditTrackRequest::SetTrackId(const uint64_t& _trackId)
{
    m_trackId = _trackId;
    m_trackIdHasBeenSet = true;
}

bool DescribeAuditTrackRequest::TrackIdHasBeenSet() const
{
