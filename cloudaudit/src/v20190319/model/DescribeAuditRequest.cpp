...
string DescribeAuditRequest::ToJsonString() const
{
...
string DescribeAuditRequest::GetAuditName() const
{
    return m_auditName;
}

void DescribeAuditRequest::SetAuditName(const string& _auditName)
{
    m_auditName = _auditName;
    m_auditNameHasBeenSet = true;
}

bool DescribeAuditRequest::AuditNameHasBeenSet() const
{
