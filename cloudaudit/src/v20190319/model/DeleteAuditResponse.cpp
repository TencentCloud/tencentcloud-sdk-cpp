...
CoreInternalOutcome DeleteAuditResponse::Deserialize(const string &payload)
{
...
string DeleteAuditResponse::ToJsonString() const
{
...
int64_t DeleteAuditResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool DeleteAuditResponse::IsSuccessHasBeenSet() const
{
