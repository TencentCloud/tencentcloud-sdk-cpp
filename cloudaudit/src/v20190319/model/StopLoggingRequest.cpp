...
string StopLoggingRequest::ToJsonString() const
{
...
string StopLoggingRequest::GetAuditName() const
{
    return m_auditName;
}

void StopLoggingRequest::SetAuditName(const string& _auditName)
{
    m_auditName = _auditName;
    m_auditNameHasBeenSet = true;
}

bool StopLoggingRequest::AuditNameHasBeenSet() const
{
