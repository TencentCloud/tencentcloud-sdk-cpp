...
string GetAttributeKeyRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_websiteTypeHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_websiteType.c_str(), allocator).Move(), allocator);
    }
...
string GetAttributeKeyRequest::GetWebsiteType() const
{
    return m_websiteType;
}

void GetAttributeKeyRequest::SetWebsiteType(const string& _websiteType)
{
    m_websiteType = _websiteType;
    m_websiteTypeHasBeenSet = true;
}

bool GetAttributeKeyRequest::WebsiteTypeHasBeenSet() const
{
