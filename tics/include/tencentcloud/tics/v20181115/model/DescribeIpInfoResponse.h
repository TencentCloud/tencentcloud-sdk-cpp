...
#ifndef TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFORESPONSE_H_
#define TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFORESPONSE_H_
    ...
    namespace Tics
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class DescribeIpInfoResponse : public AbstractModel
                {
                public:
                    DescribeIpInfoResponse();
                    ~DescribeIpInfoResponse() = default;
...
#endif // !TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFORESPONSE_H_
