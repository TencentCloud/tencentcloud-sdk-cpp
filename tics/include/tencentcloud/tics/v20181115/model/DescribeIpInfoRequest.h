...
#ifndef TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFOREQUEST_H_
#define TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFOREQUEST_H_
    ...
    namespace Tics
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class DescribeIpInfoRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_TICS_V20181115_MODEL_DESCRIBEIPINFOREQUEST_H_
