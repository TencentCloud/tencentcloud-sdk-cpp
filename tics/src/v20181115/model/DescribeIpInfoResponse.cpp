...
string DescribeIpInfoResponse::ToJsonString() const
{
...
uint64_t DescribeIpInfoResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeIpInfoResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeIpInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeIpInfoResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

uint64_t DescribeIpInfoResponse::GetConfidence() const
{
    return m_confidence;
}

bool DescribeIpInfoResponse::ConfidenceHasBeenSet() const
{
    return m_confidenceHasBeenSet;
}

vector<string> DescribeIpInfoResponse::GetThreatTypes() const
{
    return m_threatTypes;
}

bool DescribeIpInfoResponse::ThreatTypesHasBeenSet() const
{
    return m_threatTypesHasBeenSet;
}

vector<TagType> DescribeIpInfoResponse::GetTags() const
{
    return m_tags;
}

bool DescribeIpInfoResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

vector<IntelligenceType> DescribeIpInfoResponse::GetIntelligences() const
{
    return m_intelligences;
}

bool DescribeIpInfoResponse::IntelligencesHasBeenSet() const
{
    return m_intelligencesHasBeenSet;
}

string DescribeIpInfoResponse::GetContext() const
{
    return m_context;
}

bool DescribeIpInfoResponse::ContextHasBeenSet() const
{
