...
string DescribeIpInfoRequest::ToJsonString() const
{
...
string DescribeIpInfoRequest::GetKey() const
{
    return m_key;
}

void DescribeIpInfoRequest::SetKey(const string& _key)
{
    m_key = _key;
    m_keyHasBeenSet = true;
}

bool DescribeIpInfoRequest::KeyHasBeenSet() const
{
    return m_keyHasBeenSet;
}

uint64_t DescribeIpInfoRequest::GetOption() const
{
    return m_option;
}

void DescribeIpInfoRequest::SetOption(const uint64_t& _option)
{
    m_option = _option;
    m_optionHasBeenSet = true;
}

bool DescribeIpInfoRequest::OptionHasBeenSet() const
{
