...
CoreInternalOutcome CreateFlySecMiniAppScanTaskRepeatResponse::Deserialize(const string &payload)
{
...
string CreateFlySecMiniAppScanTaskRepeatResponse::ToJsonString() const
{
...
int64_t CreateFlySecMiniAppScanTaskRepeatResponse::GetRet() const
{
    return m_ret;
}

bool CreateFlySecMiniAppScanTaskRepeatResponse::RetHasBeenSet() const
{
    return m_retHasBeenSet;
}

string CreateFlySecMiniAppScanTaskRepeatResponse::GetTaskID() const
{
    return m_taskID;
}

bool CreateFlySecMiniAppScanTaskRepeatResponse::TaskIDHasBeenSet() const
{
