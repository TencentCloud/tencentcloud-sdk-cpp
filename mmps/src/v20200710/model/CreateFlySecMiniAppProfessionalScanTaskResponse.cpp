...
CoreInternalOutcome CreateFlySecMiniAppProfessionalScanTaskResponse::Deserialize(const string &payload)
{
...
string CreateFlySecMiniAppProfessionalScanTaskResponse::ToJsonString() const
{
...
int64_t CreateFlySecMiniAppProfessionalScanTaskResponse::GetRet() const
{
    return m_ret;
}

bool CreateFlySecMiniAppProfessionalScanTaskResponse::RetHasBeenSet() const
{
