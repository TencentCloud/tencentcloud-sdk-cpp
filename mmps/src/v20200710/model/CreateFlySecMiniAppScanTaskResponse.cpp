...
CoreInternalOutcome CreateFlySecMiniAppScanTaskResponse::Deserialize(const string &payload)
{
...
string CreateFlySecMiniAppScanTaskResponse::ToJsonString() const
{
...
int64_t CreateFlySecMiniAppScanTaskResponse::GetRet() const
{
    return m_ret;
}

bool CreateFlySecMiniAppScanTaskResponse::RetHasBeenSet() const
{
    return m_retHasBeenSet;
}

string CreateFlySecMiniAppScanTaskResponse::GetTaskID() const
{
    return m_taskID;
}

bool CreateFlySecMiniAppScanTaskResponse::TaskIDHasBeenSet() const
{
