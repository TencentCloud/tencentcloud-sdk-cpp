...
CoreInternalOutcome DescribeFlySecMiniAppReportUrlResponse::Deserialize(const string &payload)
{
...
string DescribeFlySecMiniAppReportUrlResponse::ToJsonString() const
{
...
int64_t DescribeFlySecMiniAppReportUrlResponse::GetRet() const
{
    return m_ret;
}

bool DescribeFlySecMiniAppReportUrlResponse::RetHasBeenSet() const
{
    return m_retHasBeenSet;
}

string DescribeFlySecMiniAppReportUrlResponse::GetUrl() const
{
    return m_url;
}

bool DescribeFlySecMiniAppReportUrlResponse::UrlHasBeenSet() const
{
