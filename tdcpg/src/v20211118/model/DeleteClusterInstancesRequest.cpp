...
vector<string> DeleteClusterInstancesRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void DeleteClusterInstancesRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool DeleteClusterInstancesRequest::InstanceIdSetHasBeenSet() const
{
