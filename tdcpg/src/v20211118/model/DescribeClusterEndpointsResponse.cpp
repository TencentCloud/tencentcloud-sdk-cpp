...
int64_t DescribeClusterEndpointsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterEndpointsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Endpoint> DescribeClusterEndpointsResponse::GetEndpointSet() const
{
    return m_endpointSet;
}

bool DescribeClusterEndpointsResponse::EndpointSetHasBeenSet() const
{
