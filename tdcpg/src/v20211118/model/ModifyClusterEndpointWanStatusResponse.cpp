...
CoreInternalOutcome ModifyClusterEndpointWanStatusResponse::Deserialize(const string &payload)
{
...
string ModifyClusterEndpointWanStatusResponse::ToJsonString() const
{
