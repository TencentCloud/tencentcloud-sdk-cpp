...
vector<FileInfo> UploadFileRequest::GetFileInfos() const
{
    return m_fileInfos;
}

void UploadFileRequest::SetFileInfos(const vector<FileInfo>& _fileInfos)
{
    m_fileInfos = _fileInfos;
    m_fileInfosHasBeenSet = true;
}

bool UploadFileRequest::FileInfosHasBeenSet() const
{
