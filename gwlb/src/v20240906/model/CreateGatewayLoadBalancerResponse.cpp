...
CoreInternalOutcome CreateGatewayLoadBalancerResponse::Deserialize(const string &payload)
{
...
string CreateGatewayLoadBalancerResponse::ToJsonString() const
{
...
vector<string> CreateGatewayLoadBalancerResponse::GetLoadBalancerIds() const
{
    return m_loadBalancerIds;
}

bool CreateGatewayLoadBalancerResponse::LoadBalancerIdsHasBeenSet() const
{
    return m_loadBalancerIdsHasBeenSet;
}

string CreateGatewayLoadBalancerResponse::GetDealName() const
{
    return m_dealName;
}

bool CreateGatewayLoadBalancerResponse::DealNameHasBeenSet() const
{
