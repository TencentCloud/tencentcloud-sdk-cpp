...
CoreInternalOutcome InquirePriceCreateGatewayLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquirePriceCreateGatewayLoadBalancerResponse::ToJsonString() const
{
...
Price InquirePriceCreateGatewayLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceCreateGatewayLoadBalancerResponse::PriceHasBeenSet() const
{
