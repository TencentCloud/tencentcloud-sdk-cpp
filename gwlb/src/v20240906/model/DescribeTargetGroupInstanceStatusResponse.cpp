...
CoreInternalOutcome DescribeTargetGroupInstanceStatusResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TargetGroupInstanceSet") && !rsp["TargetGroupInstanceSet"].IsNull())
    {
        ...
        {
            TargetGroupInstanceStatus item;
...
string DescribeTargetGroupInstanceStatusResponse::ToJsonString() const
{
...
vector<TargetGroupInstanceStatus> DescribeTargetGroupInstanceStatusResponse::GetTargetGroupInstanceSet() const
{
    return m_targetGroupInstanceSet;
}

bool DescribeTargetGroupInstanceStatusResponse::TargetGroupInstanceSetHasBeenSet() const
{
