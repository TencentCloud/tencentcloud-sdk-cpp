            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>健康检查使用的协议。支持PING和TCP两种方式，默认为PING。</p><ul><li>icmp: 使用PING的方式进行健康检查</li><li>tcp: 使用TCP连接的方式进行健康检查</li></ul>
                    ...
                    /**
                     * 设置<p>健康检查使用的协议。支持PING和TCP两种方式，默认为PING。</p><ul><li>icmp: 使用PING的方式进行健康检查</li><li>tcp: 使用TCP连接的方式进行健康检查</li></ul>
                    ...
                    /**
                     * 获取<p>健康检查超时时间。 默认为2秒。 可配置范围：2 - 30秒。</p>
                    ...
                    /**
                     * 设置<p>健康检查超时时间。 默认为2秒。 可配置范围：2 - 30秒。</p>
                    ...
                    /**
                     * 获取<p>检测间隔时间。 默认为5秒。 可配置范围：2 - 300秒。</p>
                    ...
                    /**
                     * 设置<p>检测间隔时间。 默认为5秒。 可配置范围：2 - 300秒。</p>
                    ...
                    /**
                     * 获取<p>检测健康阈值。 默认为3次。 可配置范围：2 - 10次。</p>
                    ...
                    /**
                     * 设置<p>检测健康阈值。 默认为3次。 可配置范围：2 - 10次。</p>
                    ...
                    /**
                     * 获取<p>检测不健康阈值。 默认为3次。 可配置范围：2 - 10次。</p>
                    ...
                    /**
                     * 设置<p>检测不健康阈值。 默认为3次。 可配置范围：2 - 10次。</p>
