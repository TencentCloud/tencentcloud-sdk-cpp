...
#ifndef TENCENTCLOUD_GWLB_V20240906_MODEL_DESCRIBEGATEWAYLOADBALANCERSRESPONSE_H_
#define TENCENTCLOUD_GWLB_V20240906_MODEL_DESCRIBEGATEWAYLOADBALANCERSRESPONSE_H_
    ...
    namespace Gwlb
    {
        namespace V20240906
        {
            namespace Model
            {
                ...
                */
                class DescribeGatewayLoadBalancersResponse : public AbstractModel
                {
                public:
                    DescribeGatewayLoadBalancersResponse();
                    ~DescribeGatewayLoadBalancersResponse() = default;
...
#endif // !TENCENTCLOUD_GWLB_V20240906_MODEL_DESCRIBEGATEWAYLOADBALANCERSRESPONSE_H_
