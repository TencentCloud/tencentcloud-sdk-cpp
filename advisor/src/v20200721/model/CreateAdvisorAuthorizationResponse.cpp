...
CoreInternalOutcome CreateAdvisorAuthorizationResponse::Deserialize(const string &payload)
{
...
string CreateAdvisorAuthorizationResponse::ToJsonString() const
{
...
string CreateAdvisorAuthorizationResponse::GetMessage() const
{
    return m_message;
}

bool CreateAdvisorAuthorizationResponse::MessageHasBeenSet() const
{
