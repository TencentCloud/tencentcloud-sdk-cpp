...
CoreInternalOutcome CorrectMultiImageResponse::Deserialize(const string &payload)
{
...
string CorrectMultiImageResponse::ToJsonString() const
{
...
CompostionContext CorrectMultiImageResponse::GetData() const
{
    return m_data;
}

bool CorrectMultiImageResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

CompositionContext CorrectMultiImageResponse::GetResultData() const
{
    return m_resultData;
}

bool CorrectMultiImageResponse::ResultDataHasBeenSet() const
{
