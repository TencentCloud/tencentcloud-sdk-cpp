...
CoreInternalOutcome EHOCRResponse::Deserialize(const string &payload)
{
...
string EHOCRResponse::ToJsonString() const
{
...
CompostionContext EHOCRResponse::GetData() const
{
    return m_data;
}
