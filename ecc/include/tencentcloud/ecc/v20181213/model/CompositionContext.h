...
#ifndef TENCENTCLOUD_ECC_V20181213_MODEL_COMPOSITIONCONTEXT_H_
#define TENCENTCLOUD_ECC_V20181213_MODEL_COMPOSITIONCONTEXT_H_
    ...
    namespace Ecc
    {
        namespace V20181213
        {
            namespace Model
            {
                ...
                */
                class CompositionContext : public AbstractModel
                {
                public:
                    CompositionContext();
...
#endif // !TENCENTCLOUD_ECC_V20181213_MODEL_COMPOSITIONCONTEXT_H_
