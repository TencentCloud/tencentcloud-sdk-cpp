...
#ifndef TENCENTCLOUD_ECC_V20181213_MODEL_CORRECTMULTIIMAGEREQUEST_H_
#define TENCENTCLOUD_ECC_V20181213_MODEL_CORRECTMULTIIMAGEREQUEST_H_
    ...
    namespace Ecc
    {
        namespace V20181213
        {
            namespace Model
            {
                ...
                */
                class CorrectMultiImageRequest : public AbstractModel
                {
                public:
                    CorrectMultiImageRequest();
                    ~CorrectMultiImageRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取图片的url链接或base64数据。每张图片数据作为数组的一个元素，数组个数与图片个数保持一致。存放类别依据InputType而定，url与base64编码不能混合使用。
                     * @return Image 图片的url链接或base64数据。每张图片数据作为数组的一个元素，数组个数与图片个数保持一致。存放类别依据InputType而定，url与base64编码不能混合使用。
                     * 
                     */
                    std::vector<std::string> GetImage() const;

                    /**
                     * 设置图片的url链接或base64数据。每张图片数据作为数组的一个元素，数组个数与图片个数保持一致。存放类别依据InputType而定，url与base64编码不能混合使用。
                     * @param _image 图片的url链接或base64数据。每张图片数据作为数组的一个元素，数组个数与图片个数保持一致。存放类别依据InputType而定，url与base64编码不能混合使用。
                     * 
                     */
                    void SetImage(const std::vector<std::string>& _image);
                    ...
                    /**
                     * 获取业务应用ID，与账号应用APPID无关，是用来方便客户管理服务的参数。
                    ...
                    /**
                     * 设置业务应用ID，与账号应用APPID无关，是用来方便客户管理服务的参数。
                    ...
                    /**
                     * 获取服务类型，0：“多图像识别”，只返回识别结果；1：“多图像批改”，同时返回识别结果与批改结果。默认为 0。
                    ...
                    /**
                     * 设置服务类型，0：“多图像识别”，只返回识别结果；1：“多图像批改”，同时返回识别结果与批改结果。默认为 0。
...
#endif // !TENCENTCLOUD_ECC_V20181213_MODEL_CORRECTMULTIIMAGEREQUEST_H_
