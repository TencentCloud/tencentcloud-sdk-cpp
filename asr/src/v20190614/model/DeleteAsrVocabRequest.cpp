...
string DeleteAsrVocabRequest::ToJsonString() const
{
...
string DeleteAsrVocabRequest::GetVocabId() const
{
    return m_vocabId;
}

void DeleteAsrVocabRequest::SetVocabId(const string& _vocabId)
{
    m_vocabId = _vocabId;
    m_vocabIdHasBeenSet = true;
}

bool DeleteAsrVocabRequest::VocabIdHasBeenSet() const
{
