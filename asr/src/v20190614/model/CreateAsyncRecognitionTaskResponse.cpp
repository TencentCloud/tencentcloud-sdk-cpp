...
CoreInternalOutcome CreateAsyncRecognitionTaskResponse::Deserialize(const string &payload)
{
...
string CreateAsyncRecognitionTaskResponse::ToJsonString() const
{
...
Task CreateAsyncRecognitionTaskResponse::GetData() const
{
    return m_data;
}

bool CreateAsyncRecognitionTaskResponse::DataHasBeenSet() const
{
