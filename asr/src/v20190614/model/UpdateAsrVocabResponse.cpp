...
CoreInternalOutcome UpdateAsrVocabResponse::Deserialize(const string &payload)
{
...
string UpdateAsrVocabResponse::ToJsonString() const
{
...
string UpdateAsrVocabResponse::GetVocabId() const
{
    return m_vocabId;
}

bool UpdateAsrVocabResponse::VocabIdHasBeenSet() const
{
