...
CoreInternalOutcome SetVocabStateResponse::Deserialize(const string &payload)
{
...
string SetVocabStateResponse::ToJsonString() const
{
...
string SetVocabStateResponse::GetVocabId() const
{
    return m_vocabId;
}

bool SetVocabStateResponse::VocabIdHasBeenSet() const
{
