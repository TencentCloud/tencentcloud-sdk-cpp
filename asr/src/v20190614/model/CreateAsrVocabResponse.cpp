...
CoreInternalOutcome CreateAsrVocabResponse::Deserialize(const string &payload)
{
...
string CreateAsrVocabResponse::ToJsonString() const
{
...
string CreateAsrVocabResponse::GetVocabId() const
{
    return m_vocabId;
}

bool CreateAsrVocabResponse::VocabIdHasBeenSet() const
{
