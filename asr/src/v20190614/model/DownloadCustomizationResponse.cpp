...
CoreInternalOutcome DownloadCustomizationResponse::Deserialize(const string &payload)
{
...
string DownloadCustomizationResponse::ToJsonString() const
{
...
string DownloadCustomizationResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DownloadCustomizationResponse::DownloadUrlHasBeenSet() const
{
