...
CoreInternalOutcome DescribeAsyncRecognitionTasksResponse::Deserialize(const string &payload)
{
...
string DescribeAsyncRecognitionTasksResponse::ToJsonString() const
{
...
AsyncRecognitionTasks DescribeAsyncRecognitionTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeAsyncRecognitionTasksResponse::DataHasBeenSet() const
{
