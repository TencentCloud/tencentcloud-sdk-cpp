...
string GetAsrVocabRequest::ToJsonString() const
{
...
string GetAsrVocabRequest::GetVocabId() const
{
    return m_vocabId;
}

void GetAsrVocabRequest::SetVocabId(const string& _vocabId)
{
    m_vocabId = _vocabId;
    m_vocabIdHasBeenSet = true;
}

bool GetAsrVocabRequest::VocabIdHasBeenSet() const
{
