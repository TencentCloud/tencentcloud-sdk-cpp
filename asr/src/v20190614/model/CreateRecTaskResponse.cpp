...
CoreInternalOutcome CreateRecTaskResponse::Deserialize(const string &payload)
{
...
string CreateRecTaskResponse::ToJsonString() const
{
...
Task CreateRecTaskResponse::GetData() const
{
    return m_data;
}

bool CreateRecTaskResponse::DataHasBeenSet() const
{
