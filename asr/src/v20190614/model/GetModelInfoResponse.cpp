...
CoreInternalOutcome GetModelInfoResponse::Deserialize(const string &payload)
{
...
string GetModelInfoResponse::ToJsonString() const
{
...
Model GetModelInfoResponse::GetData() const
{
    return m_data;
}

bool GetModelInfoResponse::DataHasBeenSet() const
{
