...
#ifndef TENCENTCLOUD_ASR_V20190614_MODEL_VOICEPRINTUPDATEREQUEST_H_
#define TENCENTCLOUD_ASR_V20190614_MODEL_VOICEPRINTUPDATEREQUEST_H_
    ...
    namespace Asr
    {
        namespace V20190614
        {
            namespace Model
            {
                ...
                */
                class VoicePrintUpdateRequest : public AbstractModel
                {
                public:
                    VoicePrintUpdateRequest();
                    ~VoicePrintUpdateRequest() = default;
...
#endif // !TENCENTCLOUD_ASR_V20190614_MODEL_VOICEPRINTUPDATEREQUEST_H_
