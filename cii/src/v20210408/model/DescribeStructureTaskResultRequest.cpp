...
string DescribeStructureTaskResultRequest::ToJsonString() const
{
...
string DescribeStructureTaskResultRequest::GetMainTaskId() const
{
    return m_mainTaskId;
}

void DescribeStructureTaskResultRequest::SetMainTaskId(const string& _mainTaskId)
{
    m_mainTaskId = _mainTaskId;
    m_mainTaskIdHasBeenSet = true;
}

bool DescribeStructureTaskResultRequest::MainTaskIdHasBeenSet() const
{
