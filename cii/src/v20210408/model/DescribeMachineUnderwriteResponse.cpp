...
CoreInternalOutcome DescribeMachineUnderwriteResponse::Deserialize(const string &payload)
{
...
string DescribeMachineUnderwriteResponse::ToJsonString() const
{
...
string DescribeMachineUnderwriteResponse::GetUin() const
{
    return m_uin;
}

bool DescribeMachineUnderwriteResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string DescribeMachineUnderwriteResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool DescribeMachineUnderwriteResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string DescribeMachineUnderwriteResponse::GetPolicyId() const
{
    return m_policyId;
}

bool DescribeMachineUnderwriteResponse::PolicyIdHasBeenSet() const
{
    return m_policyIdHasBeenSet;
}

string DescribeMachineUnderwriteResponse::GetMainTaskId() const
{
    return m_mainTaskId;
}

bool DescribeMachineUnderwriteResponse::MainTaskIdHasBeenSet() const
{
    return m_mainTaskIdHasBeenSet;
}

string DescribeMachineUnderwriteResponse::GetUnderwriteTaskId() const
{
    return m_underwriteTaskId;
}

bool DescribeMachineUnderwriteResponse::UnderwriteTaskIdHasBeenSet() const
{
    return m_underwriteTaskIdHasBeenSet;
}

uint64_t DescribeMachineUnderwriteResponse::GetStatus() const
{
    return m_status;
}

bool DescribeMachineUnderwriteResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<MachineUnderwriteOutput> DescribeMachineUnderwriteResponse::GetUnderwriteResults() const
{
    return m_underwriteResults;
}

bool DescribeMachineUnderwriteResponse::UnderwriteResultsHasBeenSet() const
{
