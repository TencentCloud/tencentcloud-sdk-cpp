...
CoreInternalOutcome DescribeStructureDifferenceResponse::Deserialize(const string &payload)
{
...
string DescribeStructureDifferenceResponse::ToJsonString() const
{
...
string DescribeStructureDifferenceResponse::GetMainTaskId() const
{
    return m_mainTaskId;
}

bool DescribeStructureDifferenceResponse::MainTaskIdHasBeenSet() const
{
    return m_mainTaskIdHasBeenSet;
}

int64_t DescribeStructureDifferenceResponse::GetStatus() const
{
    return m_status;
}

bool DescribeStructureDifferenceResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<PerStructDifference> DescribeStructureDifferenceResponse::GetResults() const
{
    return m_results;
}

bool DescribeStructureDifferenceResponse::ResultsHasBeenSet() const
{
