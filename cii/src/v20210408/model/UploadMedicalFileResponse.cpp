...
CoreInternalOutcome UploadMedicalFileResponse::Deserialize(const string &payload)
{
...
string UploadMedicalFileResponse::ToJsonString() const
{
...
string UploadMedicalFileResponse::GetFileKey() const
{
    return m_fileKey;
}

bool UploadMedicalFileResponse::FileKeyHasBeenSet() const
{
