...
CoreInternalOutcome CreateAutoClassifyStructureTaskResponse::Deserialize(const string &payload)
{
...
string CreateAutoClassifyStructureTaskResponse::ToJsonString() const
{
...
string CreateAutoClassifyStructureTaskResponse::GetMainTaskId() const
{
    return m_mainTaskId;
}

bool CreateAutoClassifyStructureTaskResponse::MainTaskIdHasBeenSet() const
{
