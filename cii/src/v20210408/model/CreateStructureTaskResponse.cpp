...
CoreInternalOutcome CreateStructureTaskResponse::Deserialize(const string &payload)
{
...
string CreateStructureTaskResponse::ToJsonString() const
{
...
string CreateStructureTaskResponse::GetMainTaskId() const
{
    return m_mainTaskId;
}

bool CreateStructureTaskResponse::MainTaskIdHasBeenSet() const
{
