...
CoreInternalOutcome DescribeStructureTaskResultResponse::Deserialize(const string &payload)
{
...
string DescribeStructureTaskResultResponse::ToJsonString() const
{
...
uint64_t DescribeStructureTaskResultResponse::GetStatus() const
{
    return m_status;
}

bool DescribeStructureTaskResultResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<ResultObject> DescribeStructureTaskResultResponse::GetResults() const
{
    return m_results;
}

bool DescribeStructureTaskResultResponse::ResultsHasBeenSet() const
{
