...
#ifndef TENCENTCLOUD_CII_V20210408_MODEL_CREATEAUTOCLASSIFYSTRUCTURETASKREQUEST_H_
#define TENCENTCLOUD_CII_V20210408_MODEL_CREATEAUTOCLASSIFYSTRUCTURETASKREQUEST_H_
    ...
    namespace Cii
    {
        namespace V20210408
        {
            namespace Model
            {
                ...
                */
                class CreateAutoClassifyStructureTaskRequest : public AbstractModel
                {
                public:
                    CreateAutoClassifyStructureTaskRequest();
                    ~CreateAutoClassifyStructureTaskRequest() = default;
...
Underwrite 结构化+核保
                     ...
                     * 
                     */
                    std::vector<CreateAutoClassifyStructureTaskInfo> GetTaskInfos() const;
                     ...
                     * 
                     */
                    void SetTaskInfos(const std::vector<CreateAutoClassifyStructureTaskInfo>& _taskInfos);
...
Underwrite 结构化+核保
                     ...
                     */
                    std::vector<CreateAutoClassifyStructureTaskInfo> m_taskInfos;
...
#endif // !TENCENTCLOUD_CII_V20210408_MODEL_CREATEAUTOCLASSIFYSTRUCTURETASKREQUEST_H_
