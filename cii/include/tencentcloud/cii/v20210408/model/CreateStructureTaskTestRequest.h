...
#ifndef TENCENTCLOUD_CII_V20210408_MODEL_CREATESTRUCTURETASKTESTREQUEST_H_
#define TENCENTCLOUD_CII_V20210408_MODEL_CREATESTRUCTURETASKTESTREQUEST_H_
    ...
    namespace Cii
    {
        namespace V20210408
        {
            namespace Model
            {
                ...
                */
                class CreateStructureTaskTestRequest : public AbstractModel
                {
                public:
                    CreateStructureTaskTestRequest();
                    ~CreateStructureTaskTestRequest() = default;
...
#endif // !TENCENTCLOUD_CII_V20210408_MODEL_CREATESTRUCTURETASKTESTREQUEST_H_
