...
#ifndef TENCENTCLOUD_CII_V20210408_MODEL_DESCRIBEMACHINEUNDERWRITERESPONSE_H_
#define TENCENTCLOUD_CII_V20210408_MODEL_DESCRIBEMACHINEUNDERWRITERESPONSE_H_
    ...
    namespace Cii
    {
        namespace V20210408
        {
            namespace Model
            {
                ...
                */
                class DescribeMachineUnderwriteResponse : public AbstractModel
                {
                public:
                    DescribeMachineUnderwriteResponse();
                    ~DescribeMachineUnderwriteResponse() = default;
...
2：结果生成失败
                     ...
                     * 机器核保结果
                     */
                    std::vector<MachineUnderwriteOutput> m_underwriteResults;
...
#endif // !TENCENTCLOUD_CII_V20210408_MODEL_DESCRIBEMACHINEUNDERWRITERESPONSE_H_
