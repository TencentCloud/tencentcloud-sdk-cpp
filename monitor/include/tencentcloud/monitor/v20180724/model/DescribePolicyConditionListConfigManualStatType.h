...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>数据聚合方式，周期10分钟</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _p600 <p>数据聚合方式，周期10分钟</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>数据聚合方式，周期30分钟</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _p1800 <p>数据聚合方式，周期30分钟</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
