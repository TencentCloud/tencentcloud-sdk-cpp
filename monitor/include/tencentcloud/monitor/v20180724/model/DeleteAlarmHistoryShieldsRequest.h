...
#ifndef TENCENTCLOUD_MONITOR_V20180724_MODEL_DELETEALARMHISTORYSHIELDSREQUEST_H_
#define TENCENTCLOUD_MONITOR_V20180724_MODEL_DELETEALARMHISTORYSHIELDSREQUEST_H_
    ...
    namespace Monitor
    {
        namespace V20180724
        {
            namespace Model
            {
                ...
                */
                class DeleteAlarmHistoryShieldsRequest : public AbstractModel
                {
                public:
                    DeleteAlarmHistoryShieldsRequest();
                    ~DeleteAlarmHistoryShieldsRequest() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20180724_MODEL_DELETEALARMHISTORYSHIELDSREQUEST_H_
