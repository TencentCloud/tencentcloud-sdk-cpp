...
#ifndef TENCENTCLOUD_MONITOR_V20180724_MODEL_CREATEALARMHISTORYSHIELDREQUEST_H_
#define TENCENTCLOUD_MONITOR_V20180724_MODEL_CREATEALARMHISTORYSHIELDREQUEST_H_
    ...
    namespace Monitor
    {
        namespace V20180724
        {
            namespace Model
            {
                ...
                */
                class CreateAlarmHistoryShieldRequest : public AbstractModel
                {
                public:
                    CreateAlarmHistoryShieldRequest();
                    ~CreateAlarmHistoryShieldRequest() = default;
                    ...
                    /**
                     * 获取被屏蔽的告警会话ID(历史的alarmId)
                     * @return SessionId 被屏蔽的告警会话ID(历史的alarmId)
                     * 
                     */
                    std::string GetSessionId() const;

                    /**
                     * 设置被屏蔽的告警会话ID(历史的alarmId)
                     * @param _sessionId 被屏蔽的告警会话ID(历史的alarmId)
                     * 
                     */
...
#endif // !TENCENTCLOUD_MONITOR_V20180724_MODEL_CREATEALARMHISTORYSHIELDREQUEST_H_
