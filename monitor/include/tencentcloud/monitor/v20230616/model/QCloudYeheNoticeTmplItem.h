...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLITEM_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLITEM_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                * 官网通知内容模板元素
                */
                class QCloudYeheNoticeTmplItem : public AbstractModel
                {
                public:
                    QCloudYeheNoticeTmplItem();
                    ~QCloudYeheNoticeTmplItem() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLITEM_H_
