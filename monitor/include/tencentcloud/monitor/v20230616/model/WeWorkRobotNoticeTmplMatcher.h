...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_WEWORKROBOTNOTICETMPLMATCHER_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_WEWORKROBOTNOTICETMPLMATCHER_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                * 企业微信机器人通知模板的匹配器
                */
                class WeWorkRobotNoticeTmplMatcher : public AbstractModel
                {
                public:
                    WeWorkRobotNoticeTmplMatcher();
                    ~WeWorkRobotNoticeTmplMatcher() = default;
...
Trigger 告警触发; Recovery 告警恢复
                     ...
                     * 
                     */
                    WeWorkRobotNoticeTmpl GetTemplate() const;
                     ...
                     * 
                     */
                    void SetTemplate(const WeWorkRobotNoticeTmpl& _template);
...
Trigger 告警触发; Recovery 告警恢复
                     ...
                     * 模板配置
                     */
                    WeWorkRobotNoticeTmpl m_template;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_WEWORKROBOTNOTICETMPLMATCHER_H_
