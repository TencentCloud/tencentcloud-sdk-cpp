...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_MODIFYDISPENSEEXTERNALRULEREQUEST_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_MODIFYDISPENSEEXTERNALRULEREQUEST_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                */
                class ModifyDispenseExternalRuleRequest : public AbstractModel
                {
                public:
                    ModifyDispenseExternalRuleRequest();
                    ~ModifyDispenseExternalRuleRequest() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_MODIFYDISPENSEEXTERNALRULEREQUEST_H_
