...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_SLACKROBOTNOTICETMPL_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_SLACKROBOTNOTICETMPL_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                * 企业微信机器人内容模板配置
                */
                class SlackRobotNoticeTmpl : public AbstractModel
                {
                public:
                    SlackRobotNoticeTmpl();
                    ~SlackRobotNoticeTmpl() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_SLACKROBOTNOTICETMPL_H_
