...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLMATCHER_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLMATCHER_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                * 官网内容通知模板的匹配器
                */
                class QCloudYeheNoticeTmplMatcher : public AbstractModel
                {
                public:
                    QCloudYeheNoticeTmplMatcher();
                    ~QCloudYeheNoticeTmplMatcher() = default;
...
Trigger 告警触发; Recovery 告警恢复
                     ...
                     * 
                     */
                    QCloudYeheNoticeTmpl GetTemplate() const;
                     ...
                     * 
                     */
                    void SetTemplate(const QCloudYeheNoticeTmpl& _template);
...
Trigger 告警触发; Recovery 告警恢复
                     ...
                     * 模板配置
                     */
                    QCloudYeheNoticeTmpl m_template;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_QCLOUDYEHENOTICETMPLMATCHER_H_
