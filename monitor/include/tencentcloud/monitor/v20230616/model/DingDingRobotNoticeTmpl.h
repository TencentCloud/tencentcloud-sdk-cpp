...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_DINGDINGROBOTNOTICETMPL_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_DINGDINGROBOTNOTICETMPL_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                * 钉钉机器人内容模板配置
                */
                class DingDingRobotNoticeTmpl : public AbstractModel
                {
                public:
                    DingDingRobotNoticeTmpl();
                    ~DingDingRobotNoticeTmpl() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_DINGDINGROBOTNOTICETMPL_H_
