...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_GOOGLECHATROBOTNOTICETMPL_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_GOOGLECHATROBOTNOTICETMPL_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                */
                class GoogleChatRobotNoticeTmpl : public AbstractModel
                {
                public:
                    GoogleChatRobotNoticeTmpl();
                    ~GoogleChatRobotNoticeTmpl() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_GOOGLECHATROBOTNOTICETMPL_H_
