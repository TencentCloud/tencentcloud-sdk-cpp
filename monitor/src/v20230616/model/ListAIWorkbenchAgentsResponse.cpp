...
CoreInternalOutcome ListAIWorkbenchAgentsResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchAgentsResponse::ToJsonString() const
{
...
vector<AgentInfo> ListAIWorkbenchAgentsResponse::GetAgents() const
{
    return m_agents;
}

bool ListAIWorkbenchAgentsResponse::AgentsHasBeenSet() const
{
    return m_agentsHasBeenSet;
}

PageByNumResult ListAIWorkbenchAgentsResponse::GetPageResult() const
{
    return m_pageResult;
}

bool ListAIWorkbenchAgentsResponse::PageResultHasBeenSet() const
{
