...
CoreInternalOutcome ListAIWorkbenchSessionsResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchSessionsResponse::ToJsonString() const
{
...
vector<SessionInfo> ListAIWorkbenchSessionsResponse::GetSessions() const
{
    return m_sessions;
}

bool ListAIWorkbenchSessionsResponse::SessionsHasBeenSet() const
{
    return m_sessionsHasBeenSet;
}

PageByNumResult ListAIWorkbenchSessionsResponse::GetPageResult() const
{
    return m_pageResult;
}

bool ListAIWorkbenchSessionsResponse::PageResultHasBeenSet() const
{
