...
CoreInternalOutcome FeiShuRobotNoticeTmpl::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ContentTmpl") && !value["ContentTmpl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `FeiShuRobotNoticeTmpl.ContentTmpl` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TitleTmpl") && !value["TitleTmpl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `FeiShuRobotNoticeTmpl.TitleTmpl` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void FeiShuRobotNoticeTmpl::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string FeiShuRobotNoticeTmpl::GetContentTmpl() const
{
    return m_contentTmpl;
}

void FeiShuRobotNoticeTmpl::SetContentTmpl(const string& _contentTmpl)
{
    m_contentTmpl = _contentTmpl;
    m_contentTmplHasBeenSet = true;
}

bool FeiShuRobotNoticeTmpl::ContentTmplHasBeenSet() const
{
    return m_contentTmplHasBeenSet;
}

string FeiShuRobotNoticeTmpl::GetTitleTmpl() const
{
    return m_titleTmpl;
}

void FeiShuRobotNoticeTmpl::SetTitleTmpl(const string& _titleTmpl)
{
