...
DescribeDispenseRegionResponse::DescribeDispenseRegionResponse() :
    m_regionListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDispenseRegionResponse::Deserialize(const string &payload)
{
...
string DescribeDispenseRegionResponse::ToJsonString() const
{
...
vector<DispenseRegion> DescribeDispenseRegionResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeDispenseRegionResponse::RegionListHasBeenSet() const
{
