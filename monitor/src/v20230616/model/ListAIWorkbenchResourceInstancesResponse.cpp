...
CoreInternalOutcome ListAIWorkbenchResourceInstancesResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchResourceInstancesResponse::ToJsonString() const
{
...
vector<ResourceInstance> ListAIWorkbenchResourceInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool ListAIWorkbenchResourceInstancesResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

PageByNumResult ListAIWorkbenchResourceInstancesResponse::GetPageResult() const
{
    return m_pageResult;
}

bool ListAIWorkbenchResourceInstancesResponse::PageResultHasBeenSet() const
{
