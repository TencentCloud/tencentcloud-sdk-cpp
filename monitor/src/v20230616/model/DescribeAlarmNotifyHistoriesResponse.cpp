...
CoreInternalOutcome DescribeAlarmNotifyHistoriesResponse::Deserialize(const string &payload)
{
...
string DescribeAlarmNotifyHistoriesResponse::ToJsonString() const
{
