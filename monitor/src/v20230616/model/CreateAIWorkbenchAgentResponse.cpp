...
CoreInternalOutcome CreateAIWorkbenchAgentResponse::Deserialize(const string &payload)
{
...
string CreateAIWorkbenchAgentResponse::ToJsonString() const
{
...
string CreateAIWorkbenchAgentResponse::GetAgentId() const
{
    return m_agentId;
}

bool CreateAIWorkbenchAgentResponse::AgentIdHasBeenSet() const
{
