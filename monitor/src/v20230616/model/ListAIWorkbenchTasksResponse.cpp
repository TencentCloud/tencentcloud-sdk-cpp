...
CoreInternalOutcome ListAIWorkbenchTasksResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchTasksResponse::ToJsonString() const
{
...
vector<TaskInfo> ListAIWorkbenchTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool ListAIWorkbenchTasksResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

PageByNumResult ListAIWorkbenchTasksResponse::GetPageResult() const
{
    return m_pageResult;
}

bool ListAIWorkbenchTasksResponse::PageResultHasBeenSet() const
{
