...
CoreInternalOutcome ListAIWorkbenchMessagesResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchMessagesResponse::ToJsonString() const
{
...
vector<MessageInfo> ListAIWorkbenchMessagesResponse::GetMessages() const
{
    return m_messages;
}

bool ListAIWorkbenchMessagesResponse::MessagesHasBeenSet() const
{
    return m_messagesHasBeenSet;
}

string ListAIWorkbenchMessagesResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool ListAIWorkbenchMessagesResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

bool ListAIWorkbenchMessagesResponse::GetHasMore() const
{
    return m_hasMore;
}

bool ListAIWorkbenchMessagesResponse::HasMoreHasBeenSet() const
{
