...
string DescribeAIWorkbenchSkillRequest::ToJsonString() const
{
...
string DescribeAIWorkbenchSkillRequest::GetSkillId() const
{
    return m_skillId;
}

void DescribeAIWorkbenchSkillRequest::SetSkillId(const string& _skillId)
{
    m_skillId = _skillId;
    m_skillIdHasBeenSet = true;
}

bool DescribeAIWorkbenchSkillRequest::SkillIdHasBeenSet() const
{
