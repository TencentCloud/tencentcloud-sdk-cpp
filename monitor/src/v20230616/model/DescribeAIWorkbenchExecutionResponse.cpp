...
CoreInternalOutcome DescribeAIWorkbenchExecutionResponse::Deserialize(const string &payload)
{
...
string DescribeAIWorkbenchExecutionResponse::ToJsonString() const
{
...
ExecutionInfo DescribeAIWorkbenchExecutionResponse::GetExecution() const
{
    return m_execution;
}

bool DescribeAIWorkbenchExecutionResponse::ExecutionHasBeenSet() const
{
