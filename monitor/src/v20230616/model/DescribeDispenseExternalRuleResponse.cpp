...
DescribeDispenseExternalRuleResponse::DescribeDispenseExternalRuleResponse() :
    m_ruleHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDispenseExternalRuleResponse::Deserialize(const string &payload)
{
...
string DescribeDispenseExternalRuleResponse::ToJsonString() const
{
...
Rule DescribeDispenseExternalRuleResponse::GetRule() const
{
    return m_rule;
}

bool DescribeDispenseExternalRuleResponse::RuleHasBeenSet() const
{
