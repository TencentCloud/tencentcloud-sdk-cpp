...
string GetMonitorDataRequest::ToJsonString() const
{
    ...
    if (m_exprHasBeenSet)
    {
        ...
        m_expr.ToJsonObject(d[key.c_str()], allocator);
    }
...
Expr GetMonitorDataRequest::GetExpr() const
{
    return m_expr;
}

void GetMonitorDataRequest::SetExpr(const Expr& _expr)
{
    m_expr = _expr;
    m_exprHasBeenSet = true;
}

bool GetMonitorDataRequest::ExprHasBeenSet() const
{
