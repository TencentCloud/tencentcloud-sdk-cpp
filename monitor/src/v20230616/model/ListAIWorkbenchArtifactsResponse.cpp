...
CoreInternalOutcome ListAIWorkbenchArtifactsResponse::Deserialize(const string &payload)
{
...
string ListAIWorkbenchArtifactsResponse::ToJsonString() const
{
...
vector<ArtifactInfo> ListAIWorkbenchArtifactsResponse::GetArtifacts() const
{
    return m_artifacts;
}

bool ListAIWorkbenchArtifactsResponse::ArtifactsHasBeenSet() const
{
    return m_artifactsHasBeenSet;
}

PageByNumResult ListAIWorkbenchArtifactsResponse::GetPageResult() const
{
    return m_pageResult;
}

bool ListAIWorkbenchArtifactsResponse::PageResultHasBeenSet() const
{
