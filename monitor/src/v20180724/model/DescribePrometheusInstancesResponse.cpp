...
CoreInternalOutcome DescribePrometheusInstancesResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusInstancesResponse::ToJsonString() const
{
...
vector<PrometheusInstancesItem> DescribePrometheusInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribePrometheusInstancesResponse::InstanceSetHasBeenSet() const
{
    return m_instanceSetHasBeenSet;
}

int64_t DescribePrometheusInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePrometheusInstancesResponse::TotalCountHasBeenSet() const
{
