...
CoreInternalOutcome AlarmPolicyCondition::Deserialize(const Value &value)
{
    string requestId = "";
...
void AlarmPolicyCondition::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
