...
CoreInternalOutcome MidQueryCondition::Deserialize(const Value &value)
{
    string requestId = "";
...
void MidQueryCondition::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
