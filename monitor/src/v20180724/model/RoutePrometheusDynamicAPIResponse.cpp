...
CoreInternalOutcome RoutePrometheusDynamicAPIResponse::Deserialize(const string &payload)
{
...
string RoutePrometheusDynamicAPIResponse::ToJsonString() const
{
...
PrometheusDynamicAPIResponseHTTP RoutePrometheusDynamicAPIResponse::GetHTTP() const
{
    return m_hTTP;
}

bool RoutePrometheusDynamicAPIResponse::HTTPHasBeenSet() const
{
