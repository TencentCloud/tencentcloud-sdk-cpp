...
CoreInternalOutcome DescribePrometheusAgentInstancesResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusAgentInstancesResponse::ToJsonString() const
{
...
vector<string> DescribePrometheusAgentInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribePrometheusAgentInstancesResponse::InstancesHasBeenSet() const
{
