...
CoreInternalOutcome CreatePrometheusClusterAgentResponse::Deserialize(const string &payload)
{
...
string CreatePrometheusClusterAgentResponse::ToJsonString() const
{
