...
CoreInternalOutcome UpdateAlertRuleResponse::Deserialize(const string &payload)
{
...
string UpdateAlertRuleResponse::ToJsonString() const
{
...
string UpdateAlertRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool UpdateAlertRuleResponse::RuleIdHasBeenSet() const
{
