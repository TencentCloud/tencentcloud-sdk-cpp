...
CoreInternalOutcome DescribePrometheusTargetsTMPResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusTargetsTMPResponse::ToJsonString() const
{
...
vector<PrometheusJobTargets> DescribePrometheusTargetsTMPResponse::GetJobs() const
{
    return m_jobs;
}

bool DescribePrometheusTargetsTMPResponse::JobsHasBeenSet() const
{
