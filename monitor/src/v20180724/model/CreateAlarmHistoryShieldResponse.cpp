...
CreateAlarmHistoryShieldResponse::CreateAlarmHistoryShieldResponse() :
    m_shieldIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateAlarmHistoryShieldResponse::Deserialize(const string &payload)
{
...
string CreateAlarmHistoryShieldResponse::ToJsonString() const
{
...
string CreateAlarmHistoryShieldResponse::GetShieldId() const
{
    return m_shieldId;
}

bool CreateAlarmHistoryShieldResponse::ShieldIdHasBeenSet() const
{
