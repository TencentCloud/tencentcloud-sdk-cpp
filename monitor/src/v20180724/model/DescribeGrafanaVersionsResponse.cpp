...
DescribeGrafanaVersionsResponse::DescribeGrafanaVersionsResponse() :
    m_versionsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeGrafanaVersionsResponse::Deserialize(const string &payload)
{
...
string DescribeGrafanaVersionsResponse::ToJsonString() const
{
...
vector<GrafanaVersion> DescribeGrafanaVersionsResponse::GetVersions() const
{
    return m_versions;
}

bool DescribeGrafanaVersionsResponse::VersionsHasBeenSet() const
{
