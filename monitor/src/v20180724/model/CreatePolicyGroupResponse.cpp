...
CoreInternalOutcome CreatePolicyGroupResponse::Deserialize(const string &payload)
{
...
string CreatePolicyGroupResponse::ToJsonString() const
{
...
int64_t CreatePolicyGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreatePolicyGroupResponse::GroupIdHasBeenSet() const
{
