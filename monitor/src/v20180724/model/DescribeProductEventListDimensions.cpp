...
string DescribeProductEventListDimensions::GetName() const
{
    return m_name;
}

void DescribeProductEventListDimensions::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool DescribeProductEventListDimensions::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string DescribeProductEventListDimensions::GetValue() const
{
    return m_value;
}

void DescribeProductEventListDimensions::SetValue(const string& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool DescribeProductEventListDimensions::ValueHasBeenSet() const
{
