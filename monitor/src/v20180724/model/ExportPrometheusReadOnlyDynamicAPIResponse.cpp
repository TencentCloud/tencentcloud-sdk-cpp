...
CoreInternalOutcome ExportPrometheusReadOnlyDynamicAPIResponse::Deserialize(const string &payload)
{
...
string ExportPrometheusReadOnlyDynamicAPIResponse::ToJsonString() const
{
