...
CoreInternalOutcome DeletePrometheusRecordRuleYamlResponse::Deserialize(const string &payload)
{
...
string DeletePrometheusRecordRuleYamlResponse::ToJsonString() const
{
