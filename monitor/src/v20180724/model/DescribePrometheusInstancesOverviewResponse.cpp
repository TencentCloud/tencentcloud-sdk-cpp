...
CoreInternalOutcome DescribePrometheusInstancesOverviewResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusInstancesOverviewResponse::ToJsonString() const
{
