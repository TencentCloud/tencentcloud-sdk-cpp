...
CoreInternalOutcome TerminatePrometheusInstancesResponse::Deserialize(const string &payload)
{
...
string TerminatePrometheusInstancesResponse::ToJsonString() const
{
