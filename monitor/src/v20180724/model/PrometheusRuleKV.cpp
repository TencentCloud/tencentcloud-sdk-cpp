...
CoreInternalOutcome PrometheusRuleKV::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Key") && !value["Key"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PrometheusRuleKV.Key` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PrometheusRuleKV.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void PrometheusRuleKV::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
