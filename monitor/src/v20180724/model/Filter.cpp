...
CoreInternalOutcome Filter::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Type") && !value["Type"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Filter.Type` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string Filter::GetType() const
{
    return m_type;
}

void Filter::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool Filter::TypeHasBeenSet() const
{
