...
CoreInternalOutcome UpdatePrometheusAlertGroupStateResponse::Deserialize(const string &payload)
{
...
string UpdatePrometheusAlertGroupStateResponse::ToJsonString() const
{
