...
string DescribeInstalledPluginsRequest::ToJsonString() const
{
...
string DescribeInstalledPluginsRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeInstalledPluginsRequest::SetInstanceId(const string& _instanceId)
{
