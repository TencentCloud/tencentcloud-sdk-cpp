...
CoreInternalOutcome DescribeGrafanaInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeGrafanaInstancesResponse::ToJsonString() const
{
...
vector<GrafanaInstanceInfo> DescribeGrafanaInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeGrafanaInstancesResponse::InstanceSetHasBeenSet() const
{
    return m_instanceSetHasBeenSet;
}

int64_t DescribeGrafanaInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeGrafanaInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<GrafanaInstanceInfo> DescribeGrafanaInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeGrafanaInstancesResponse::InstancesHasBeenSet() const
{
