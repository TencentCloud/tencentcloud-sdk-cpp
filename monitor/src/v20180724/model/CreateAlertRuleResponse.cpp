...
CoreInternalOutcome CreateAlertRuleResponse::Deserialize(const string &payload)
{
...
string CreateAlertRuleResponse::ToJsonString() const
{
...
string CreateAlertRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateAlertRuleResponse::RuleIdHasBeenSet() const
{
