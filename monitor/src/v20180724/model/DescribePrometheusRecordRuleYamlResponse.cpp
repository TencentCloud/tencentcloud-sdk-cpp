...
CoreInternalOutcome DescribePrometheusRecordRuleYamlResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusRecordRuleYamlResponse::ToJsonString() const
{
