...
string DescribeSSOAccountRequest::ToJsonString() const
{
...
string DescribeSSOAccountRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeSSOAccountRequest::SetInstanceId(const string& _instanceId)
{
