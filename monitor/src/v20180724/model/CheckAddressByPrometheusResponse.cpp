...
CheckAddressByPrometheusResponse::CheckAddressByPrometheusResponse() :
...
CoreInternalOutcome CheckAddressByPrometheusResponse::Deserialize(const string &payload)
{
...
string CheckAddressByPrometheusResponse::ToJsonString() const
{
...
string CheckAddressByPrometheusResponse::GetTarget() const
{
    return m_target;
}

bool CheckAddressByPrometheusResponse::TargetHasBeenSet() const
{
    return m_targetHasBeenSet;
}

bool CheckAddressByPrometheusResponse::GetSuccess() const
{
    return m_success;
}

bool CheckAddressByPrometheusResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

string CheckAddressByPrometheusResponse::GetMessage() const
{
    return m_message;
}

bool CheckAddressByPrometheusResponse::MessageHasBeenSet() const
{
