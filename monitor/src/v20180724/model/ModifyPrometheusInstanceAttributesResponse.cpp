...
CoreInternalOutcome ModifyPrometheusInstanceAttributesResponse::Deserialize(const string &payload)
{
...
string ModifyPrometheusInstanceAttributesResponse::ToJsonString() const
{
