...
CoreInternalOutcome UpdatePrometheusAlertGroupResponse::Deserialize(const string &payload)
{
...
string UpdatePrometheusAlertGroupResponse::ToJsonString() const
{
...
string UpdatePrometheusAlertGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool UpdatePrometheusAlertGroupResponse::GroupIdHasBeenSet() const
{
