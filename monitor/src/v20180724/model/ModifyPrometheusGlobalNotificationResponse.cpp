...
CoreInternalOutcome ModifyPrometheusGlobalNotificationResponse::Deserialize(const string &payload)
{
...
string ModifyPrometheusGlobalNotificationResponse::ToJsonString() const
{
