...
CoreInternalOutcome DeletePrometheusClusterAgentResponse::Deserialize(const string &payload)
{
...
string DeletePrometheusClusterAgentResponse::ToJsonString() const
{
