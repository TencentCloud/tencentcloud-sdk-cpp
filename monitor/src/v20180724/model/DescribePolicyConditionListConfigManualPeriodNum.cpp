...
CoreInternalOutcome DescribePolicyConditionListConfigManualPeriodNum::Deserialize(const Value &value)
{
    string requestId = "";
...
void DescribePolicyConditionListConfigManualPeriodNum::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
