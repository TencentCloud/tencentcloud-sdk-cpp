...
CoreInternalOutcome CreateSSOAccountResponse::Deserialize(const string &payload)
{
...
string CreateSSOAccountResponse::ToJsonString() const
{
...
string CreateSSOAccountResponse::GetUserId() const
{
    return m_userId;
}

bool CreateSSOAccountResponse::UserIdHasBeenSet() const
{
