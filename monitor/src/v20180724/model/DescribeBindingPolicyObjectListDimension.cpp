...
CoreInternalOutcome DescribeBindingPolicyObjectListDimension::Deserialize(const Value &value)
{
    string requestId = "";
...
void DescribeBindingPolicyObjectListDimension::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
