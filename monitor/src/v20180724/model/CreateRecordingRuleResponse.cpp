...
CoreInternalOutcome CreateRecordingRuleResponse::Deserialize(const string &payload)
{
...
string CreateRecordingRuleResponse::ToJsonString() const
{
...
string CreateRecordingRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateRecordingRuleResponse::RuleIdHasBeenSet() const
{
