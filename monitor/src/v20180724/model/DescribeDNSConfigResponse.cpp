...
CoreInternalOutcome DescribeDNSConfigResponse::Deserialize(const string &payload)
{
...
string DescribeDNSConfigResponse::ToJsonString() const
{
...
vector<string> DescribeDNSConfigResponse::GetNameServers() const
{
    return m_nameServers;
}

bool DescribeDNSConfigResponse::NameServersHasBeenSet() const
{
