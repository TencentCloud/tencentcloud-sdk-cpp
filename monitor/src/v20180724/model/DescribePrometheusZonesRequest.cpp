...
string DescribePrometheusZonesRequest::ToJsonString() const
{
...
int64_t DescribePrometheusZonesRequest::GetRegionId() const
{
    return m_regionId;
}

void DescribePrometheusZonesRequest::SetRegionId(const int64_t& _regionId)
{
