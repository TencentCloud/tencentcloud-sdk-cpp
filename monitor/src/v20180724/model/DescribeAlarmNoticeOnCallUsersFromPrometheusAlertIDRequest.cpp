...
string DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest::ToJsonString() const
{
...
string DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest::GetAlertId() const
{
    return m_alertId;
}

void DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest::SetAlertId(const string& _alertId)
{
    m_alertId = _alertId;
    m_alertIdHasBeenSet = true;
}

bool DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest::AlertIdHasBeenSet() const
{
