...
CoreInternalOutcome UpdateRecordingRuleResponse::Deserialize(const string &payload)
{
...
string UpdateRecordingRuleResponse::ToJsonString() const
{
...
string UpdateRecordingRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool UpdateRecordingRuleResponse::RuleIdHasBeenSet() const
{
