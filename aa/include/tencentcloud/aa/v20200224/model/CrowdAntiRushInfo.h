...
#ifndef TENCENTCLOUD_AA_V20200224_MODEL_CROWDANTIRUSHINFO_H_
#define TENCENTCLOUD_AA_V20200224_MODEL_CROWDANTIRUSHINFO_H_
    ...
    namespace Aa
    {
        namespace V20200224
        {
            namespace Model
            {
                ...
                * 网赚防刷相关参数
                */
                class CrowdAntiRushInfo : public AbstractModel
                {
                public:
                    CrowdAntiRushInfo();
                    ~CrowdAntiRushInfo() = default;
...
#endif // !TENCENTCLOUD_AA_V20200224_MODEL_CROWDANTIRUSHINFO_H_
