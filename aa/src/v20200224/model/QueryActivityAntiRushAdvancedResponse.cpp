...
CoreInternalOutcome QueryActivityAntiRushAdvancedResponse::Deserialize(const string &payload)
{
...
string QueryActivityAntiRushAdvancedResponse::ToJsonString() const
{
...
OutputActivityAntiRushAdvanced QueryActivityAntiRushAdvancedResponse::GetData() const
{
    return m_data;
}

bool QueryActivityAntiRushAdvancedResponse::DataHasBeenSet() const
{
