...
CoreInternalOutcome CrowdAntiRushInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void CrowdAntiRushInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
