...
CoreInternalOutcome CrowdAntiRushInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void CrowdAntiRushInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string CrowdAntiRushInfo::GetSponsorOpenId() const
{
    return m_sponsorOpenId;
}

void CrowdAntiRushInfo::SetSponsorOpenId(const string& _sponsorOpenId)
{
    m_sponsorOpenId = _sponsorOpenId;
    m_sponsorOpenIdHasBeenSet = true;
}

bool CrowdAntiRushInfo::SponsorOpenIdHasBeenSet() const
{
    return m_sponsorOpenIdHasBeenSet;
}

string CrowdAntiRushInfo::GetSponsorDeviceNumber() const
{
    return m_sponsorDeviceNumber;
}

void CrowdAntiRushInfo::SetSponsorDeviceNumber(const string& _sponsorDeviceNumber)
{
    m_sponsorDeviceNumber = _sponsorDeviceNumber;
    m_sponsorDeviceNumberHasBeenSet = true;
}

bool CrowdAntiRushInfo::SponsorDeviceNumberHasBeenSet() const
{
    return m_sponsorDeviceNumberHasBeenSet;
}

string CrowdAntiRushInfo::GetSponsorPhone() const
{
    return m_sponsorPhone;
}

void CrowdAntiRushInfo::SetSponsorPhone(const string& _sponsorPhone)
{
    m_sponsorPhone = _sponsorPhone;
    m_sponsorPhoneHasBeenSet = true;
}

bool CrowdAntiRushInfo::SponsorPhoneHasBeenSet() const
{
    return m_sponsorPhoneHasBeenSet;
}

string CrowdAntiRushInfo::GetSponsorIp() const
{
    return m_sponsorIp;
}

void CrowdAntiRushInfo::SetSponsorIp(const string& _sponsorIp)
{
    m_sponsorIp = _sponsorIp;
    m_sponsorIpHasBeenSet = true;
}

bool CrowdAntiRushInfo::SponsorIpHasBeenSet() const
{
    return m_sponsorIpHasBeenSet;
}

string CrowdAntiRushInfo::GetCampaignUrl() const
{
    return m_campaignUrl;
}

void CrowdAntiRushInfo::SetCampaignUrl(const string& _campaignUrl)
{
    m_campaignUrl = _campaignUrl;
    m_campaignUrlHasBeenSet = true;
}

bool CrowdAntiRushInfo::CampaignUrlHasBeenSet() const
{
