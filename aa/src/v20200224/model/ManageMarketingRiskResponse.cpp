...
CoreInternalOutcome ManageMarketingRiskResponse::Deserialize(const string &payload)
{
...
string ManageMarketingRiskResponse::ToJsonString() const
{
...
OutputManageMarketingRisk ManageMarketingRiskResponse::GetData() const
{
    return m_data;
}

bool ManageMarketingRiskResponse::DataHasBeenSet() const
{
