...
string QueryActivityAntiRushAdvancedRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
InputActivityAntiRushAdvanced QueryActivityAntiRushAdvancedRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void QueryActivityAntiRushAdvancedRequest::SetBusinessSecurityData(const InputActivityAntiRushAdvanced& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool QueryActivityAntiRushAdvancedRequest::BusinessSecurityDataHasBeenSet() const
{
