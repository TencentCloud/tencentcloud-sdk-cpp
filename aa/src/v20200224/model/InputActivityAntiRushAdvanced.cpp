...
CoreInternalOutcome InputActivityAntiRushAdvanced::Deserialize(const Value &value)
{
    string requestId = "";
...
void InputActivityAntiRushAdvanced::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
