...
CoreInternalOutcome OutputActivityAntiRushAdvancedValue::Deserialize(const Value &value)
{
    string requestId = "";
...
void OutputActivityAntiRushAdvancedValue::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
