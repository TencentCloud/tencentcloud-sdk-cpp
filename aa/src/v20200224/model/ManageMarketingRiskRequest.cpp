...
string ManageMarketingRiskRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
InputManageMarketingRisk ManageMarketingRiskRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void ManageMarketingRiskRequest::SetBusinessSecurityData(const InputManageMarketingRisk& _businessSecurityData)
{
