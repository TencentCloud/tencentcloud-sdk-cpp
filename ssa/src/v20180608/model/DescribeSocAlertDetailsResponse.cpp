...
CoreInternalOutcome DescribeSocAlertDetailsResponse::Deserialize(const string &payload)
{
...
string DescribeSocAlertDetailsResponse::ToJsonString() const
{
...
AlertDetail DescribeSocAlertDetailsResponse::GetData() const
{
    return m_data;
}

bool DescribeSocAlertDetailsResponse::DataHasBeenSet() const
{
