...
string DescribeAssetListRequest::ToJsonString() const
{
...
string DescribeAssetListRequest::GetParams() const
{
    return m_params;
}

void DescribeAssetListRequest::SetParams(const string& _params)
{
    m_params = _params;
    m_paramsHasBeenSet = true;
}

bool DescribeAssetListRequest::ParamsHasBeenSet() const
{
