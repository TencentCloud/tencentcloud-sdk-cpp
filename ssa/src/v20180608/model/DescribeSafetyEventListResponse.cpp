...
CoreInternalOutcome DescribeSafetyEventListResponse::Deserialize(const string &payload)
{
...
string DescribeSafetyEventListResponse::ToJsonString() const
{
...
vector<DataEvent> DescribeSafetyEventListResponse::GetList() const
{
    return m_list;
}

bool DescribeSafetyEventListResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeSafetyEventListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSafetyEventListResponse::TotalHasBeenSet() const
{
