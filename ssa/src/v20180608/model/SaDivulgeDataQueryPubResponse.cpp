...
CoreInternalOutcome SaDivulgeDataQueryPubResponse::Deserialize(const string &payload)
{
...
string SaDivulgeDataQueryPubResponse::ToJsonString() const
{
...
SaDivulgeDataQueryPubList SaDivulgeDataQueryPubResponse::GetData() const
{
    return m_data;
}

bool SaDivulgeDataQueryPubResponse::DataHasBeenSet() const
{
