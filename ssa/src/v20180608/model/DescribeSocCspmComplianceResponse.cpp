...
CoreInternalOutcome DescribeSocCspmComplianceResponse::Deserialize(const string &payload)
{
...
string DescribeSocCspmComplianceResponse::ToJsonString() const
{
...
SocComplianceInfoResp DescribeSocCspmComplianceResponse::GetData() const
{
    return m_data;
}

bool DescribeSocCspmComplianceResponse::DataHasBeenSet() const
{
