...
string DescribeVulListRequest::GetParams() const
{
    return m_params;
}

void DescribeVulListRequest::SetParams(const string& _params)
{
    m_params = _params;
    m_paramsHasBeenSet = true;
}

bool DescribeVulListRequest::ParamsHasBeenSet() const
{
