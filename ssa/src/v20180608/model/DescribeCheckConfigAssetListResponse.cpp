...
CoreInternalOutcome DescribeCheckConfigAssetListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CheckAssetsList") && !rsp["CheckAssetsList"].IsNull())
    {
        if (!rsp["CheckAssetsList"].IsArray())
            return CoreInternalOutcome(Error("response `CheckAssetsList` is not array type"));
...
string DescribeCheckConfigAssetListResponse::ToJsonString() const
{
...
int64_t DescribeCheckConfigAssetListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCheckConfigAssetListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<CheckAssetItem> DescribeCheckConfigAssetListResponse::GetCheckAssetsList() const
{
    return m_checkAssetsList;
}

bool DescribeCheckConfigAssetListResponse::CheckAssetsListHasBeenSet() const
{
