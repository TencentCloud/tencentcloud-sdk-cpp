...
CoreInternalOutcome DescribeSocCheckItemListResponse::Deserialize(const string &payload)
{
...
string DescribeSocCheckItemListResponse::ToJsonString() const
{
...
DescribeSocCheckItemListRspRsp DescribeSocCheckItemListResponse::GetData() const
{
    return m_data;
}

bool DescribeSocCheckItemListResponse::DataHasBeenSet() const
{
