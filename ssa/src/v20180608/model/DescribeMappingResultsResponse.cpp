...
CoreInternalOutcome DescribeMappingResultsResponse::Deserialize(const string &payload)
{
...
string DescribeMappingResultsResponse::ToJsonString() const
{
...
uint64_t DescribeMappingResultsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeMappingResultsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

Results DescribeMappingResultsResponse::GetData() const
{
    return m_data;
}

bool DescribeMappingResultsResponse::DataHasBeenSet() const
{
