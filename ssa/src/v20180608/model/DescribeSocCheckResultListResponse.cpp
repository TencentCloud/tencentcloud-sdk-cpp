...
CoreInternalOutcome DescribeSocCheckResultListResponse::Deserialize(const string &payload)
{
...
string DescribeSocCheckResultListResponse::ToJsonString() const
{
...
DescribeSocCheckResultListRspRsp DescribeSocCheckResultListResponse::GetData() const
{
    return m_data;
}

bool DescribeSocCheckResultListResponse::DataHasBeenSet() const
{
