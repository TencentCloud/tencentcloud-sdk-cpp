...
CoreInternalOutcome DescribeSocAlertListResponse::Deserialize(const string &payload)
{
...
string DescribeSocAlertListResponse::ToJsonString() const
{
...
AlertListData DescribeSocAlertListResponse::GetData() const
{
    return m_data;
}

bool DescribeSocAlertListResponse::DataHasBeenSet() const
{
