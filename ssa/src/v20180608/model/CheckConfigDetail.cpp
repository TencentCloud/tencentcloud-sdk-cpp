...
CoreInternalOutcome CheckConfigDetail::Deserialize(const Value &value)
{
    string requestId = "";
...
void CheckConfigDetail::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
