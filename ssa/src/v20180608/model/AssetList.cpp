...
CoreInternalOutcome AssetList::Deserialize(const Value &value)
{
    string requestId = "";
...
void AssetList::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
...
int64_t AssetList::GetTotal() const
{
    return m_total;
}

void AssetList::SetTotal(const int64_t& _total)
{
    m_total = _total;
    m_totalHasBeenSet = true;
}

bool AssetList::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<Asset> AssetList::GetList() const
{
    return m_list;
}

void AssetList::SetList(const vector<Asset>& _list)
{
    m_list = _list;
    m_listHasBeenSet = true;
}

bool AssetList::ListHasBeenSet() const
{
