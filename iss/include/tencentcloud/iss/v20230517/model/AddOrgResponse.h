...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_ADDORGRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_ADDORGRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 增加组织接口返回数据
                */
                class AddOrgResponse : public AbstractModel
                {
                public:
                    AddOrgResponse();
                    ~AddOrgResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_ADDORGRESPONSE_H_
