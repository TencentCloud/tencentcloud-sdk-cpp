...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 实时上云计划添加和修改的返回数据
                */
                class RecordPlanOptResponse : public AbstractModel
                {
                public:
                    RecordPlanOptResponse();
                    ~RecordPlanOptResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTRESPONSE_H_
