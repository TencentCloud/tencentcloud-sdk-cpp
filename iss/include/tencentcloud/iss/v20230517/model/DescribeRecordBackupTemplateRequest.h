...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDBACKUPTEMPLATEREQUEST_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDBACKUPTEMPLATEREQUEST_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                */
                class DescribeRecordBackupTemplateRequest : public AbstractModel
                {
                public:
                    DescribeRecordBackupTemplateRequest();
                    ~DescribeRecordBackupTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDBACKUPTEMPLATEREQUEST_H_
