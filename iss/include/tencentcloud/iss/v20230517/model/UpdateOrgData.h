...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 修改组织接口返回数据
                */
                class UpdateOrgData : public AbstractModel
                {
                public:
                    UpdateOrgData();
                    ~UpdateOrgData() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGDATA_H_
