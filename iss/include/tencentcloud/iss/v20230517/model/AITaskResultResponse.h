...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_AITASKRESULTRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_AITASKRESULTRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * AI识别结果
                */
                class AITaskResultResponse : public AbstractModel
                {
                public:
                    AITaskResultResponse();
                    ~AITaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_AITASKRESULTRESPONSE_H_
