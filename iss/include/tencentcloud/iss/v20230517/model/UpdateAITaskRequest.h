...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEAITASKREQUEST_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEAITASKREQUEST_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * UpdateAITask请求参数结构体
                */
                class UpdateAITaskRequest : public AbstractModel
                {
                public:
                    UpdateAITaskRequest();
                    ~UpdateAITaskRequest() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEAITASKREQUEST_H_
