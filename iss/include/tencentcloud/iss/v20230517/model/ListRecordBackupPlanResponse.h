...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 查询录像上云计划列表返回数据
                */
                class ListRecordBackupPlanResponse : public AbstractModel
                {
                public:
                    ListRecordBackupPlanResponse();
                    ~ListRecordBackupPlanResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANRESPONSE_H_
