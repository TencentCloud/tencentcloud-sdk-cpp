...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDPLANDEVICESDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDPLANDEVICESDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 云计划下的设备通道列表返回数据
                */
                class ListRecordPlanDevicesData : public AbstractModel
                {
                public:
                    ListRecordPlanDevicesData();
                    ~ListRecordPlanDevicesData() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDPLANDEVICESDATA_H_
