...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDEVICESDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDEVICESDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 查询录像上云计划关联通道的返回数据
                */
                class ListRecordBackupPlanDevicesData : public AbstractModel
                {
                public:
                    ListRecordBackupPlanDevicesData();
                    ~ListRecordBackupPlanDevicesData() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDEVICESDATA_H_
