...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 修改组织接口返回数据
                */
                class UpdateOrgResponse : public AbstractModel
                {
                public:
                    UpdateOrgResponse();
                    ~UpdateOrgResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_UPDATEORGRESPONSE_H_
