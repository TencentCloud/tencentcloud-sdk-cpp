...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDRETRIEVETASKRESPONSE_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDRETRIEVETASKRESPONSE_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 查询云录像取回任务详情返回数据
                */
                class DescribeRecordRetrieveTaskResponse : public AbstractModel
                {
                public:
                    DescribeRecordRetrieveTaskResponse();
                    ~DescribeRecordRetrieveTaskResponse() = default;
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBERECORDRETRIEVETASKRESPONSE_H_
