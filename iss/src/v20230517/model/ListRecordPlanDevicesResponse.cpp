...
ListRecordPlanDevicesResponse::ListRecordPlanDevicesResponse() :
...
CoreInternalOutcome ListRecordPlanDevicesResponse::Deserialize(const string &payload)
{
...
string ListRecordPlanDevicesResponse::ToJsonString() const
{
...
int64_t ListRecordPlanDevicesResponse::GetPageNumber() const
{
    return m_pageNumber;
}

bool ListRecordPlanDevicesResponse::PageNumberHasBeenSet() const
{
    return m_pageNumberHasBeenSet;
}

int64_t ListRecordPlanDevicesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListRecordPlanDevicesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListRecordPlanDevicesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListRecordPlanDevicesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RecordPlanChannelInfo> ListRecordPlanDevicesResponse::GetList() const
{
    return m_list;
}

bool ListRecordPlanDevicesResponse::ListHasBeenSet() const
{
