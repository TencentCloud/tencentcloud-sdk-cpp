...
AddStreamAuthResponse::AddStreamAuthResponse() :
...
CoreInternalOutcome AddStreamAuthResponse::Deserialize(const string &payload)
{
...
string AddStreamAuthResponse::ToJsonString() const
{
...
string AddStreamAuthResponse::GetId() const
{
    return m_id;
}

bool AddStreamAuthResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

int64_t AddStreamAuthResponse::GetPullState() const
{
    return m_pullState;
}

bool AddStreamAuthResponse::PullStateHasBeenSet() const
{
    return m_pullStateHasBeenSet;
}

string AddStreamAuthResponse::GetPullSecret() const
{
    return m_pullSecret;
}

bool AddStreamAuthResponse::PullSecretHasBeenSet() const
{
    return m_pullSecretHasBeenSet;
}

int64_t AddStreamAuthResponse::GetPullExpired() const
{
    return m_pullExpired;
}

bool AddStreamAuthResponse::PullExpiredHasBeenSet() const
{
    return m_pullExpiredHasBeenSet;
}

int64_t AddStreamAuthResponse::GetPushState() const
{
    return m_pushState;
}

bool AddStreamAuthResponse::PushStateHasBeenSet() const
{
    return m_pushStateHasBeenSet;
}

string AddStreamAuthResponse::GetPushSecret() const
{
    return m_pushSecret;
}

bool AddStreamAuthResponse::PushSecretHasBeenSet() const
{
    return m_pushSecretHasBeenSet;
}

int64_t AddStreamAuthResponse::GetPushExpired() const
{
    return m_pushExpired;
}

bool AddStreamAuthResponse::PushExpiredHasBeenSet() const
{
    return m_pushExpiredHasBeenSet;
}

int64_t AddStreamAuthResponse::GetAppId() const
{
    return m_appId;
}

bool AddStreamAuthResponse::AppIdHasBeenSet() const
{
