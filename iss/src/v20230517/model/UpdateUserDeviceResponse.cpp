...
UpdateUserDeviceResponse::UpdateUserDeviceResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome UpdateUserDeviceResponse::Deserialize(const string &payload)
{
...
string UpdateUserDeviceResponse::ToJsonString() const
{
...
bool UpdateUserDeviceResponse::DataHasBeenSet() const
{
