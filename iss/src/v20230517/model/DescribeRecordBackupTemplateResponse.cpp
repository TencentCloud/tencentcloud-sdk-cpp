...
DescribeRecordBackupTemplateResponse::DescribeRecordBackupTemplateResponse() :
...
CoreInternalOutcome DescribeRecordBackupTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeRecordBackupTemplateResponse::ToJsonString() const
{
...
string DescribeRecordBackupTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool DescribeRecordBackupTemplateResponse::TemplateIdHasBeenSet() const
{
    return m_templateIdHasBeenSet;
}

string DescribeRecordBackupTemplateResponse::GetTemplateName() const
{
    return m_templateName;
}

bool DescribeRecordBackupTemplateResponse::TemplateNameHasBeenSet() const
{
    return m_templateNameHasBeenSet;
}

vector<RecordTemplateTimeSections> DescribeRecordBackupTemplateResponse::GetTimeSections() const
{
    return m_timeSections;
}

bool DescribeRecordBackupTemplateResponse::TimeSectionsHasBeenSet() const
{
    return m_timeSectionsHasBeenSet;
}

vector<RecordTemplateTimeSections> DescribeRecordBackupTemplateResponse::GetDevTimeSections() const
{
    return m_devTimeSections;
}

bool DescribeRecordBackupTemplateResponse::DevTimeSectionsHasBeenSet() const
{
    return m_devTimeSectionsHasBeenSet;
}

int64_t DescribeRecordBackupTemplateResponse::GetScale() const
{
    return m_scale;
}

bool DescribeRecordBackupTemplateResponse::ScaleHasBeenSet() const
{
    return m_scaleHasBeenSet;
}

string DescribeRecordBackupTemplateResponse::GetCreateAt() const
{
    return m_createAt;
}

bool DescribeRecordBackupTemplateResponse::CreateAtHasBeenSet() const
{
    return m_createAtHasBeenSet;
}

string DescribeRecordBackupTemplateResponse::GetUpdateAt() const
{
    return m_updateAt;
}

bool DescribeRecordBackupTemplateResponse::UpdateAtHasBeenSet() const
{
