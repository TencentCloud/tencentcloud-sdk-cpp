...
CoreInternalOutcome DescribeDeviceChannelResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Data") && !rsp["Data"].IsNull())
    {
        ...
        {
            DescribeDeviceChannelData item;
...
vector<DescribeDeviceChannelData> DescribeDeviceChannelResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceChannelResponse::DataHasBeenSet() const
{
