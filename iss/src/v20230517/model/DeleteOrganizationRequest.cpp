...
string DeleteOrganizationRequest::ToJsonString() const
{
...
string DeleteOrganizationRequest::GetOrganizationId() const
{
    return m_organizationId;
}

void DeleteOrganizationRequest::SetOrganizationId(const string& _organizationId)
{
    m_organizationId = _organizationId;
    m_organizationIdHasBeenSet = true;
}

bool DeleteOrganizationRequest::OrganizationIdHasBeenSet() const
{
