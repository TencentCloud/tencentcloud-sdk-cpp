...
string ListGatewayDevicesRequest::ToJsonString() const
{
...
string ListGatewayDevicesRequest::GetGatewayId() const
{
    return m_gatewayId;
}

void ListGatewayDevicesRequest::SetGatewayId(const string& _gatewayId)
{
