...
DescribeCNAMEResponse::DescribeCNAMEResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCNAMEResponse::Deserialize(const string &payload)
{
...
string DescribeCNAMEResponse::ToJsonString() const
{
...
string DescribeCNAMEResponse::GetData() const
{
    return m_data;
}

bool DescribeCNAMEResponse::DataHasBeenSet() const
{
