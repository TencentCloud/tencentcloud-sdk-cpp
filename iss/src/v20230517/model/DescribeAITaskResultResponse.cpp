...
bool DescribeAITaskResultResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeAITaskResultResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAITaskResultResponse::TotalCountHasBeenSet() const
{
