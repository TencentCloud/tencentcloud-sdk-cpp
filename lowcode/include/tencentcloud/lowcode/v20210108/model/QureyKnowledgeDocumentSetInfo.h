...
#ifndef TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSETINFO_H_
#define TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSETINFO_H_
    ...
    namespace Lowcode
    {
        namespace V20210108
        {
            namespace Model
            {
                ...
                * 查询文件集合信息详情
                */
                class QureyKnowledgeDocumentSetInfo : public AbstractModel
                {
                public:
                    QureyKnowledgeDocumentSetInfo();
                    ~QureyKnowledgeDocumentSetInfo() = default;
...
Ready：文件解析、写入完成。
                     ...
                     * 
                     */
                    std::string GetIndexedErrorMsg() const;
                     ...
                     * 
                     */
                    void SetIndexedErrorMsg(const std::string& _indexedErrorMsg);

                    /**
                     * 判断参数 IndexedErrorMsg 是否已赋值
                     * @return IndexedErrorMsg 是否已赋值
                     * 
                     */
                    bool IndexedErrorMsgHasBeenSet() const;
...
Ready：文件解析、写入完成。
                     ...
                     * 错误信息
                     */
                    std::string m_indexedErrorMsg;
                    bool m_indexedErrorMsgHasBeenSet;
...
#endif // !TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSETINFO_H_
