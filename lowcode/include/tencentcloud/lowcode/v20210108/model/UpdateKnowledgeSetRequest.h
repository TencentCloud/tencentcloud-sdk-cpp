...
#ifndef TENCENTCLOUD_LOWCODE_V20210108_MODEL_UPDATEKNOWLEDGESETREQUEST_H_
#define TENCENTCLOUD_LOWCODE_V20210108_MODEL_UPDATEKNOWLEDGESETREQUEST_H_
    ...
    namespace Lowcode
    {
        namespace V20210108
        {
            namespace Model
            {
                ...
                */
                class UpdateKnowledgeSetRequest : public AbstractModel
                {
                public:
                    UpdateKnowledgeSetRequest();
                    ~UpdateKnowledgeSetRequest() = default;
                     ...
                     * @return Active 状态;ENABLED启用；NOT_ENABLED不启用
                     * 
                     */
...
#endif // !TENCENTCLOUD_LOWCODE_V20210108_MODEL_UPDATEKNOWLEDGESETREQUEST_H_
