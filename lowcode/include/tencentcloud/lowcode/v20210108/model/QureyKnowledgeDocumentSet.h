...
#ifndef TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSET_H_
#define TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSET_H_
    ...
    namespace Lowcode
    {
        namespace V20210108
        {
            namespace Model
            {
                ...
                * 搜索数据的集合
                */
                class QureyKnowledgeDocumentSet : public AbstractModel
                {
                public:
                    QureyKnowledgeDocumentSet();
                    ~QureyKnowledgeDocumentSet() = default;
...
#endif // !TENCENTCLOUD_LOWCODE_V20210108_MODEL_QUREYKNOWLEDGEDOCUMENTSET_H_
