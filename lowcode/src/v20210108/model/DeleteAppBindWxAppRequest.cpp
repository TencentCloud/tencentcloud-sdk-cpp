...
DeleteAppBindWxAppRequest::DeleteAppBindWxAppRequest() :
    m_weappIdHasBeenSet(false)
{
}

string DeleteAppBindWxAppRequest::ToJsonString() const
{
...
string DeleteAppBindWxAppRequest::GetWeappId() const
{
    return m_weappId;
}

void DeleteAppBindWxAppRequest::SetWeappId(const string& _weappId)
{
    m_weappId = _weappId;
    m_weappIdHasBeenSet = true;
}

bool DeleteAppBindWxAppRequest::WeappIdHasBeenSet() const
{
