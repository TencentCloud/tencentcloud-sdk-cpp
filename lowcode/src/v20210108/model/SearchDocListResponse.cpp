...
SearchDocListResponse::SearchDocListResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome SearchDocListResponse::Deserialize(const string &payload)
{
...
string SearchDocListResponse::ToJsonString() const
{
...
SearchDocRsp SearchDocListResponse::GetData() const
{
    return m_data;
}

bool SearchDocListResponse::DataHasBeenSet() const
{
