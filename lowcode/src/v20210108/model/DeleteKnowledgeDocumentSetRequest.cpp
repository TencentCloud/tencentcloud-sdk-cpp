...
string DeleteKnowledgeDocumentSetRequest::ToJsonString() const
{
...
void DeleteKnowledgeDocumentSetRequest::SetCollectionView(const string& _collectionView)
{
    m_collectionView = _collectionView;
    m_collectionViewHasBeenSet = true;
}

bool DeleteKnowledgeDocumentSetRequest::CollectionViewHasBeenSet() const
{
    return m_collectionViewHasBeenSet;
}

DocumentQuery DeleteKnowledgeDocumentSetRequest::GetQuery() const
{
    return m_query;
}

void DeleteKnowledgeDocumentSetRequest::SetQuery(const DocumentQuery& _query)
{
    m_query = _query;
    m_queryHasBeenSet = true;
}

bool DeleteKnowledgeDocumentSetRequest::QueryHasBeenSet() const
{
