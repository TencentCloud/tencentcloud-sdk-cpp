...
CoreInternalOutcome DescribeInvocationResultResponse::Deserialize(const string &payload)
{
...
string DescribeInvocationResultResponse::ToJsonString() const
{
...
vector<AlgorithmResult> DescribeInvocationResultResponse::GetResults() const
{
    return m_results;
}

bool DescribeInvocationResultResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

int64_t DescribeInvocationResultResponse::GetStatus() const
{
    return m_status;
}

bool DescribeInvocationResultResponse::StatusHasBeenSet() const
{
