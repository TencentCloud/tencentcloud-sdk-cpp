...
string CancelBeautifyVideoJobRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string CancelBeautifyVideoJobRequest::GetJobId() const
{
    return m_jobId;
}

void CancelBeautifyVideoJobRequest::SetJobId(const string& _jobId)
{
    m_jobId = _jobId;
    m_jobIdHasBeenSet = true;
}

bool CancelBeautifyVideoJobRequest::JobIdHasBeenSet() const
{
