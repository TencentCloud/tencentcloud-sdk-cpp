...
CoreInternalOutcome BeautifyVideoResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["EstimatedProcessTime"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `EstimatedProcessTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_estimatedProcessTime = rsp["EstimatedProcessTime"].GetInt64();
...
string BeautifyVideoResponse::ToJsonString() const
{
...
string BeautifyVideoResponse::GetJobId() const
{
    return m_jobId;
}

bool BeautifyVideoResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

int64_t BeautifyVideoResponse::GetEstimatedProcessTime() const
{
    return m_estimatedProcessTime;
}

bool BeautifyVideoResponse::EstimatedProcessTimeHasBeenSet() const
{
