...
CoreInternalOutcome StyleImageResponse::Deserialize(const string &payload)
{
...
string StyleImageResponse::ToJsonString() const
{
...
string StyleImageResponse::GetResultImage() const
{
    return m_resultImage;
}

bool StyleImageResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

string StyleImageResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool StyleImageResponse::ResultUrlHasBeenSet() const
{
