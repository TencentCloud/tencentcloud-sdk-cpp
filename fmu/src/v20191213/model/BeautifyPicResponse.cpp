...
CoreInternalOutcome BeautifyPicResponse::Deserialize(const string &payload)
{
...
string BeautifyPicResponse::ToJsonString() const
{
...
string BeautifyPicResponse::GetResultImage() const
{
    return m_resultImage;
}

bool BeautifyPicResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

string BeautifyPicResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool BeautifyPicResponse::ResultUrlHasBeenSet() const
{
