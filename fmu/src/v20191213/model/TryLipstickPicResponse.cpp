...
CoreInternalOutcome TryLipstickPicResponse::Deserialize(const string &payload)
{
...
string TryLipstickPicResponse::ToJsonString() const
{
...
string TryLipstickPicResponse::GetResultImage() const
{
