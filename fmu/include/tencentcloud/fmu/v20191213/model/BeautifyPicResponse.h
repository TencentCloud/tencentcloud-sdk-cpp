...
#ifndef TENCENTCLOUD_FMU_V20191213_MODEL_BEAUTIFYPICRESPONSE_H_
#define TENCENTCLOUD_FMU_V20191213_MODEL_BEAUTIFYPICRESPONSE_H_
    ...
    namespace Fmu
    {
        namespace V20191213
        {
            namespace Model
            {
                ...
                * BeautifyPic返回参数结构体
                */
                class BeautifyPicResponse : public AbstractModel
                {
                public:
                    BeautifyPicResponse();
                    ~BeautifyPicResponse() = default;
...
#endif // !TENCENTCLOUD_FMU_V20191213_MODEL_BEAUTIFYPICRESPONSE_H_
