...
#ifndef TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGEPRORESPONSE_H_
#define TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGEPRORESPONSE_H_
    ...
    namespace Fmu
    {
        namespace V20191213
        {
            namespace Model
            {
                ...
                */
                class StyleImageProResponse : public AbstractModel
                {
                public:
                    StyleImageProResponse();
                    ~StyleImageProResponse() = default;
...
#endif // !TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGEPRORESPONSE_H_
