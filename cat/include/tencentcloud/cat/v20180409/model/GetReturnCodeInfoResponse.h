...
#ifndef TENCENTCLOUD_CAT_V20180409_MODEL_GETRETURNCODEINFORESPONSE_H_
#define TENCENTCLOUD_CAT_V20180409_MODEL_GETRETURNCODEINFORESPONSE_H_
    ...
    namespace Cat
    {
        namespace V20180409
        {
            namespace Model
            {
                ...
                */
                class GetReturnCodeInfoResponse : public AbstractModel
                {
                public:
                    GetReturnCodeInfoResponse();
                    ~GetReturnCodeInfoResponse() = default;
...
#endif // !TENCENTCLOUD_CAT_V20180409_MODEL_GETRETURNCODEINFORESPONSE_H_
