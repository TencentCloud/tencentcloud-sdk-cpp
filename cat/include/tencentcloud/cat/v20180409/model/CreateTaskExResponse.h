...
#ifndef TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXRESPONSE_H_
#define TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXRESPONSE_H_
    ...
    namespace Cat
    {
        namespace V20180409
        {
            namespace Model
            {
                ...
                * CreateTaskEx返回参数结构体
                */
                class CreateTaskExResponse : public AbstractModel
                {
                public:
                    CreateTaskExResponse();
                    ~CreateTaskExResponse() = default;
...
#endif // !TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXRESPONSE_H_
