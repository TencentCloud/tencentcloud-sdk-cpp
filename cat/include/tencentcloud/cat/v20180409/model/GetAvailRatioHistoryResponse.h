...
#ifndef TENCENTCLOUD_CAT_V20180409_MODEL_GETAVAILRATIOHISTORYRESPONSE_H_
#define TENCENTCLOUD_CAT_V20180409_MODEL_GETAVAILRATIOHISTORYRESPONSE_H_
    ...
    namespace Cat
    {
        namespace V20180409
        {
            namespace Model
            {
                ...
                */
                class GetAvailRatioHistoryResponse : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CAT_V20180409_MODEL_GETAVAILRATIOHISTORYRESPONSE_H_
