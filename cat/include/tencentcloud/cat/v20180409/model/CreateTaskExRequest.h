...
#ifndef TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXREQUEST_H_
#define TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXREQUEST_H_
    ...
    namespace Cat
    {
        namespace V20180409
        {
            namespace Model
            {
                ...
                * CreateTaskEx请求参数结构体
                */
                class CreateTaskExRequest : public AbstractModel
                {
                public:
                    CreateTaskExRequest();
                    ~CreateTaskExRequest() = default;
                    ...
                    /**
                     * 获取拨测分组ID，体现本拨测任务要采用哪些运营商作为拨测源。一般可直接填写本用户的默认拨测分组。参见：DescribeAgentGroups 接口，本参数使用返回结果里的GroupId的值。注意： Type为0时，AgentGroupId为必填
                    ...
                    /**
                     * 设置拨测分组ID，体现本拨测任务要采用哪些运营商作为拨测源。一般可直接填写本用户的默认拨测分组。参见：DescribeAgentGroups 接口，本参数使用返回结果里的GroupId的值。注意： Type为0时，AgentGroupId为必填
                    ...
                    /**
                     * 获取任务ID，用于验证且修改任务时传入原任务ID
                     * @return TaskId 任务ID，用于验证且修改任务时传入原任务ID
                     */
                    uint64_t GetTaskId() const;

                    /**
                     * 设置任务ID，用于验证且修改任务时传入原任务ID
                    ...
                    /**
                     * 获取IsVerify=0 非验证任务 IsVerify=1 验证任务，不传则默认为0
                     * @return IsVerify IsVerify=0 非验证任务 IsVerify=1 验证任务，不传则默认为0
                     */
                    uint64_t GetIsVerify() const;

                    /**
                     * 设置IsVerify=0 非验证任务 IsVerify=1 验证任务，不传则默认为0
                     * @param IsVerify IsVerify=0 非验证任务 IsVerify=1 验证任务，不传则默认为0
                     */
                    void SetIsVerify(const uint64_t& _isVerify);

                    /**
                     * 判断参数 IsVerify 是否已赋值
                     * @return IsVerify 是否已赋值
                     */
                    bool IsVerifyHasBeenSet() const;
...
#endif // !TENCENTCLOUD_CAT_V20180409_MODEL_CREATETASKEXREQUEST_H_
