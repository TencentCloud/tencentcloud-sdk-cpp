...
CoreInternalOutcome GetRespTimeTrendExResponse::Deserialize(const string &payload)
{
...
string GetRespTimeTrendExResponse::ToJsonString() const
{
...
vector<DataPointMetric> GetRespTimeTrendExResponse::GetDataPoints() const
{
    return m_dataPoints;
}

bool GetRespTimeTrendExResponse::DataPointsHasBeenSet() const
{
