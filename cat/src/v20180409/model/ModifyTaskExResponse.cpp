...
CoreInternalOutcome ModifyTaskExResponse::Deserialize(const string &payload)
{
...
string ModifyTaskExResponse::ToJsonString() const
{
...
uint64_t ModifyTaskExResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyTaskExResponse::TaskIdHasBeenSet() const
{
