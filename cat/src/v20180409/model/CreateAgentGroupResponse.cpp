...
CoreInternalOutcome CreateAgentGroupResponse::Deserialize(const string &payload)
{
...
string CreateAgentGroupResponse::ToJsonString() const
{
...
uint64_t CreateAgentGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateAgentGroupResponse::GroupIdHasBeenSet() const
{
