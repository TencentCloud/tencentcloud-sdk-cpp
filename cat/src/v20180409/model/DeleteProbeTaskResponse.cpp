...
CoreInternalOutcome DeleteProbeTaskResponse::Deserialize(const string &payload)
{
...
string DeleteProbeTaskResponse::ToJsonString() const
{
...
int64_t DeleteProbeTaskResponse::GetTotal() const
{
    return m_total;
}

bool DeleteProbeTaskResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t DeleteProbeTaskResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool DeleteProbeTaskResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

vector<TaskResult> DeleteProbeTaskResponse::GetResults() const
{
    return m_results;
}

bool DeleteProbeTaskResponse::ResultsHasBeenSet() const
{
