...
string GetResultSummaryRequest::ToJsonString() const
{
...
vector<uint64_t> GetResultSummaryRequest::GetTaskIds() const
{
    return m_taskIds;
}

void GetResultSummaryRequest::SetTaskIds(const vector<uint64_t>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool GetResultSummaryRequest::TaskIdsHasBeenSet() const
{
