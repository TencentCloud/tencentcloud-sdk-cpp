...
CoreInternalOutcome TaskAlarm::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void TaskAlarm::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
