...
CoreInternalOutcome DescribeTasksByTypeResponse::Deserialize(const string &payload)
{
...
string DescribeTasksByTypeResponse::ToJsonString() const
{
...
uint64_t DescribeTasksByTypeResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTasksByTypeResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TaskAlarm> DescribeTasksByTypeResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeTasksByTypeResponse::TasksHasBeenSet() const
{
