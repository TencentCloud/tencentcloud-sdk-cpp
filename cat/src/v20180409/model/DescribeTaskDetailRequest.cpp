...
vector<uint64_t> DescribeTaskDetailRequest::GetTaskIds() const
{
    return m_taskIds;
}

void DescribeTaskDetailRequest::SetTaskIds(const vector<uint64_t>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool DescribeTaskDetailRequest::TaskIdsHasBeenSet() const
{
