...
string ResumeProbeTaskRequest::ToJsonString() const
{
...
vector<string> ResumeProbeTaskRequest::GetTaskIds() const
{
    return m_taskIds;
}

void ResumeProbeTaskRequest::SetTaskIds(const vector<string>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool ResumeProbeTaskRequest::TaskIdsHasBeenSet() const
{
