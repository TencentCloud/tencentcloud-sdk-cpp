...
string DeleteProbeTaskRequest::ToJsonString() const
{
...
vector<string> DeleteProbeTaskRequest::GetTaskIds() const
{
    return m_taskIds;
}

void DeleteProbeTaskRequest::SetTaskIds(const vector<string>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool DeleteProbeTaskRequest::TaskIdsHasBeenSet() const
{
