...
string GetReturnCodeInfoResponse::ToJsonString() const
{
...
vector<CatReturnDetail> GetReturnCodeInfoResponse::GetDetails() const
{
    return m_details;
}

bool GetReturnCodeInfoResponse::DetailsHasBeenSet() const
{
    return m_detailsHasBeenSet;
}

vector<CatReturnSummary> GetReturnCodeInfoResponse::GetSummary() const
{
    return m_summary;
}

bool GetReturnCodeInfoResponse::SummaryHasBeenSet() const
{
    return m_summaryHasBeenSet;
}

string GetReturnCodeInfoResponse::GetBeginTime() const
{
    return m_beginTime;
}

bool GetReturnCodeInfoResponse::BeginTimeHasBeenSet() const
{
    return m_beginTimeHasBeenSet;
}

string GetReturnCodeInfoResponse::GetEndTime() const
{
    return m_endTime;
}

bool GetReturnCodeInfoResponse::EndTimeHasBeenSet() const
{
