...
string SuspendProbeTaskRequest::ToJsonString() const
{
...
vector<string> SuspendProbeTaskRequest::GetTaskIds() const
{
    return m_taskIds;
}

void SuspendProbeTaskRequest::SetTaskIds(const vector<string>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool SuspendProbeTaskRequest::TaskIdsHasBeenSet() const
{
