...
CoreInternalOutcome SuspendProbeTaskResponse::Deserialize(const string &payload)
{
...
string SuspendProbeTaskResponse::ToJsonString() const
{
...
int64_t SuspendProbeTaskResponse::GetTotal() const
{
    return m_total;
}

bool SuspendProbeTaskResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t SuspendProbeTaskResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool SuspendProbeTaskResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

vector<TaskResult> SuspendProbeTaskResponse::GetResults() const
{
    return m_results;
}

bool SuspendProbeTaskResponse::ResultsHasBeenSet() const
{
