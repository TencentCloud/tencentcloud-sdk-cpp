...
CoreInternalOutcome DescribeProbeTasksResponse::Deserialize(const string &payload)
{
...
string DescribeProbeTasksResponse::ToJsonString() const
{
...
vector<ProbeTask> DescribeProbeTasksResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool DescribeProbeTasksResponse::TaskSetHasBeenSet() const
{
    return m_taskSetHasBeenSet;
}

int64_t DescribeProbeTasksResponse::GetTotal() const
{
    return m_total;
}

bool DescribeProbeTasksResponse::TotalHasBeenSet() const
{
