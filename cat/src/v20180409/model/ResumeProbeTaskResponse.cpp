...
CoreInternalOutcome ResumeProbeTaskResponse::Deserialize(const string &payload)
{
...
string ResumeProbeTaskResponse::ToJsonString() const
{
...
int64_t ResumeProbeTaskResponse::GetTotal() const
{
    return m_total;
}

bool ResumeProbeTaskResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ResumeProbeTaskResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool ResumeProbeTaskResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

vector<TaskResult> ResumeProbeTaskResponse::GetResults() const
{
    return m_results;
}

bool ResumeProbeTaskResponse::ResultsHasBeenSet() const
{
