...
CoreInternalOutcome DescribeAlarmTopicResponse::Deserialize(const string &payload)
{
...
string DescribeAlarmTopicResponse::ToJsonString() const
{
...
uint64_t DescribeAlarmTopicResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAlarmTopicResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AlarmTopic> DescribeAlarmTopicResponse::GetTopics() const
{
    return m_topics;
}

bool DescribeAlarmTopicResponse::TopicsHasBeenSet() const
{
