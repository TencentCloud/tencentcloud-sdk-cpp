...
#ifndef TENCENTCLOUD_AFC_V20200226_MODEL_QUERYANTIFRAUDVIPREQUEST_H_
#define TENCENTCLOUD_AFC_V20200226_MODEL_QUERYANTIFRAUDVIPREQUEST_H_
    ...
    namespace Afc
    {
        namespace V20200226
        {
            namespace Model
            {
                ...
                */
                class QueryAntiFraudVipRequest : public AbstractModel
                {
                public:
                    QueryAntiFraudVipRequest();
                    ~QueryAntiFraudVipRequest() = default;
...
#endif // !TENCENTCLOUD_AFC_V20200226_MODEL_QUERYANTIFRAUDVIPREQUEST_H_
