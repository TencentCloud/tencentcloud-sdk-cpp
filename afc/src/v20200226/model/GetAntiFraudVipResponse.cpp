...
CoreInternalOutcome GetAntiFraudVipResponse::Deserialize(const string &payload)
{
...
string GetAntiFraudVipResponse::ToJsonString() const
{
...
AntiFraudVipRecord GetAntiFraudVipResponse::GetData() const
{
    return m_data;
}

bool GetAntiFraudVipResponse::DataHasBeenSet() const
{
