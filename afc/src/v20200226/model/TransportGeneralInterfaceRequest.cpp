...
string TransportGeneralInterfaceRequest::ToJsonString() const
{
...
TransportGeneralInterfaceInput TransportGeneralInterfaceRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void TransportGeneralInterfaceRequest::SetBusinessSecurityData(const TransportGeneralInterfaceInput& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool TransportGeneralInterfaceRequest::BusinessSecurityDataHasBeenSet() const
{
