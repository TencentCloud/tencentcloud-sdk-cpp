...
CoreInternalOutcome TransportGeneralInterfaceResponse::Deserialize(const string &payload)
{
...
string TransportGeneralInterfaceResponse::ToJsonString() const
{
...
TransportGeneralInterfaceOutput TransportGeneralInterfaceResponse::GetData() const
{
    return m_data;
}

bool TransportGeneralInterfaceResponse::DataHasBeenSet() const
{
