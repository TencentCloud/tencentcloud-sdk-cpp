...
#ifndef TENCENTCLOUD_DATAAGENT_V20250513_MODEL_UPLOADJOB_H_
#define TENCENTCLOUD_DATAAGENT_V20250513_MODEL_UPLOADJOB_H_
    ...
    namespace Dataagent
    {
        namespace V20250513
        {
            namespace Model
            {
                ...
                * 上传任务
                */
                class UploadJob : public AbstractModel
                {
                public:
                    UploadJob();
                    ~UploadJob() = default;
...
#endif // !TENCENTCLOUD_DATAAGENT_V20250513_MODEL_UPLOADJOB_H_
