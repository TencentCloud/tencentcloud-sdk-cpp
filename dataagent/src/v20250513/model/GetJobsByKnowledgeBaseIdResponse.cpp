...
GetJobsByKnowledgeBaseIdResponse::GetJobsByKnowledgeBaseIdResponse() :
    m_jobsHasBeenSet(false)
{
}

CoreInternalOutcome GetJobsByKnowledgeBaseIdResponse::Deserialize(const string &payload)
{
...
string GetJobsByKnowledgeBaseIdResponse::ToJsonString() const
{
...
vector<UploadJob> GetJobsByKnowledgeBaseIdResponse::GetJobs() const
{
    return m_jobs;
}

bool GetJobsByKnowledgeBaseIdResponse::JobsHasBeenSet() const
{
