...
UploadAndCommitFileResponse::UploadAndCommitFileResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome UploadAndCommitFileResponse::Deserialize(const string &payload)
{
...
string UploadAndCommitFileResponse::ToJsonString() const
{
...
string UploadAndCommitFileResponse::GetJobId() const
{
    return m_jobId;
}

bool UploadAndCommitFileResponse::JobIdHasBeenSet() const
{
