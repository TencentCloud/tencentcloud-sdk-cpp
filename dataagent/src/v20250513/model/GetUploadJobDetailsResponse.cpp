...
GetUploadJobDetailsResponse::GetUploadJobDetailsResponse() :
    m_jobHasBeenSet(false)
{
}

CoreInternalOutcome GetUploadJobDetailsResponse::Deserialize(const string &payload)
{
...
string GetUploadJobDetailsResponse::ToJsonString() const
{
...
UploadJob GetUploadJobDetailsResponse::GetJob() const
{
    return m_job;
}

bool GetUploadJobDetailsResponse::JobHasBeenSet() const
{
