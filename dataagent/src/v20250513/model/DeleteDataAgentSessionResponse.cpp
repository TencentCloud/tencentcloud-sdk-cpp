...
CoreInternalOutcome DeleteDataAgentSessionResponse::Deserialize(const string &payload)
{
...
string DeleteDataAgentSessionResponse::ToJsonString() const
{
...
string DeleteDataAgentSessionResponse::GetSessionId() const
{
    return m_sessionId;
}
