...
CoreInternalOutcome QuerySceneListResponse::Deserialize(const string &payload)
{
...
string QuerySceneListResponse::ToJsonString() const
{
...
bool QuerySceneListResponse::TotalHasBeenSet() const
{
