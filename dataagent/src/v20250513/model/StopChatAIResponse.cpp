...
StopChatAIResponse::StopChatAIResponse() :
    m_sessionIdHasBeenSet(false)
{
}

CoreInternalOutcome StopChatAIResponse::Deserialize(const string &payload)
{
...
string StopChatAIResponse::ToJsonString() const
{
...
string StopChatAIResponse::GetSessionId() const
{
    return m_sessionId;
}

bool StopChatAIResponse::SessionIdHasBeenSet() const
{
