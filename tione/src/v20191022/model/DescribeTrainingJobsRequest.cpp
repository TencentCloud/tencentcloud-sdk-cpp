...
string DescribeTrainingJobsRequest::ToJsonString() const
{
    ...
    if (m_creationTimeAfterHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_creationTimeAfter.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_creationTimeBeforeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_creationTimeBefore.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_nameContainsHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_nameContains.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_statusEqualsHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_statusEquals.c_str(), allocator).Move(), allocator);
    }
