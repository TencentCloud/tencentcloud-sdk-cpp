...
CoreInternalOutcome CreateCodeRepositoryResponse::Deserialize(const string &payload)
{
...
string CreateCodeRepositoryResponse::ToJsonString() const
{
...
string CreateCodeRepositoryResponse::GetCodeRepositoryName() const
{
    return m_codeRepositoryName;
}

bool CreateCodeRepositoryResponse::CodeRepositoryNameHasBeenSet() const
{
