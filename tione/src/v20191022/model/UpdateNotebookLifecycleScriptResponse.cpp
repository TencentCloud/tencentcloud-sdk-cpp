...
CoreInternalOutcome UpdateNotebookLifecycleScriptResponse::Deserialize(const string &payload)
{
...
string UpdateNotebookLifecycleScriptResponse::ToJsonString() const
{
