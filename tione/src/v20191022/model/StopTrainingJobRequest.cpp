...
string StopTrainingJobRequest::ToJsonString() const
{
...
string StopTrainingJobRequest::GetTrainingJobName() const
{
    return m_trainingJobName;
}

void StopTrainingJobRequest::SetTrainingJobName(const string& _trainingJobName)
{
    m_trainingJobName = _trainingJobName;
    m_trainingJobNameHasBeenSet = true;
}

bool StopTrainingJobRequest::TrainingJobNameHasBeenSet() const
{
