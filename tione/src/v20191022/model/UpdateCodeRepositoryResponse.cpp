...
CoreInternalOutcome UpdateCodeRepositoryResponse::Deserialize(const string &payload)
{
...
string UpdateCodeRepositoryResponse::ToJsonString() const
{
...
string UpdateCodeRepositoryResponse::GetCodeRepositoryName() const
{
    return m_codeRepositoryName;
}

bool UpdateCodeRepositoryResponse::CodeRepositoryNameHasBeenSet() const
{
