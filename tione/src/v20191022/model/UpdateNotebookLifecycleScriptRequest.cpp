...
string UpdateNotebookLifecycleScriptRequest::ToJsonString() const
{
...
string UpdateNotebookLifecycleScriptRequest::GetNotebookLifecycleScriptsName() const
{
    return m_notebookLifecycleScriptsName;
}

void UpdateNotebookLifecycleScriptRequest::SetNotebookLifecycleScriptsName(const string& _notebookLifecycleScriptsName)
{
    m_notebookLifecycleScriptsName = _notebookLifecycleScriptsName;
    m_notebookLifecycleScriptsNameHasBeenSet = true;
}

bool UpdateNotebookLifecycleScriptRequest::NotebookLifecycleScriptsNameHasBeenSet() const
{
    return m_notebookLifecycleScriptsNameHasBeenSet;
}

string UpdateNotebookLifecycleScriptRequest::GetCreateScript() const
{
    return m_createScript;
}

void UpdateNotebookLifecycleScriptRequest::SetCreateScript(const string& _createScript)
{
    m_createScript = _createScript;
    m_createScriptHasBeenSet = true;
}

bool UpdateNotebookLifecycleScriptRequest::CreateScriptHasBeenSet() const
{
    return m_createScriptHasBeenSet;
}

string UpdateNotebookLifecycleScriptRequest::GetStartScript() const
{
    return m_startScript;
}

void UpdateNotebookLifecycleScriptRequest::SetStartScript(const string& _startScript)
{
    m_startScript = _startScript;
    m_startScriptHasBeenSet = true;
}

bool UpdateNotebookLifecycleScriptRequest::StartScriptHasBeenSet() const
{
