...
CoreInternalOutcome CreateTrainingJobResponse::Deserialize(const string &payload)
{
...
string CreateTrainingJobResponse::ToJsonString() const
{
...
string CreateTrainingJobResponse::GetTrainingJobName() const
{
    return m_trainingJobName;
}

bool CreateTrainingJobResponse::TrainingJobNameHasBeenSet() const
{
