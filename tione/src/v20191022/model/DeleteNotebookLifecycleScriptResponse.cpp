...
CoreInternalOutcome DeleteNotebookLifecycleScriptResponse::Deserialize(const string &payload)
{
...
string DeleteNotebookLifecycleScriptResponse::ToJsonString() const
{
