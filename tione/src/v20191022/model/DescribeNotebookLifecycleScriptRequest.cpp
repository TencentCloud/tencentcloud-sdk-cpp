...
string DescribeNotebookLifecycleScriptRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_notebookLifecycleScriptsNameHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_notebookLifecycleScriptsName.c_str(), allocator).Move(), allocator);
    }
...
string DescribeNotebookLifecycleScriptRequest::GetNotebookLifecycleScriptsName() const
{
    return m_notebookLifecycleScriptsName;
}

void DescribeNotebookLifecycleScriptRequest::SetNotebookLifecycleScriptsName(const string& _notebookLifecycleScriptsName)
{
    m_notebookLifecycleScriptsName = _notebookLifecycleScriptsName;
    m_notebookLifecycleScriptsNameHasBeenSet = true;
}

bool DescribeNotebookLifecycleScriptRequest::NotebookLifecycleScriptsNameHasBeenSet() const
{
