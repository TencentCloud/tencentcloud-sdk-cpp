...
CoreInternalOutcome DeleteCodeRepositoryResponse::Deserialize(const string &payload)
{
...
string DeleteCodeRepositoryResponse::ToJsonString() const
{
...
string DeleteCodeRepositoryResponse::GetCodeRepositoryName() const
{
    return m_codeRepositoryName;
}

bool DeleteCodeRepositoryResponse::CodeRepositoryNameHasBeenSet() const
{
