...
string DescribeCodeRepositoryRequest::ToJsonString() const
{
...
string DescribeCodeRepositoryRequest::GetCodeRepositoryName() const
{
    return m_codeRepositoryName;
}

void DescribeCodeRepositoryRequest::SetCodeRepositoryName(const string& _codeRepositoryName)
{
    m_codeRepositoryName = _codeRepositoryName;
    m_codeRepositoryNameHasBeenSet = true;
}

bool DescribeCodeRepositoryRequest::CodeRepositoryNameHasBeenSet() const
{
