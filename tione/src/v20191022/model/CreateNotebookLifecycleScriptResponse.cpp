...
CoreInternalOutcome CreateNotebookLifecycleScriptResponse::Deserialize(const string &payload)
{
...
string CreateNotebookLifecycleScriptResponse::ToJsonString() const
{
...
string CreateNotebookLifecycleScriptResponse::GetNotebookLifecycleScriptsName() const
{
    return m_notebookLifecycleScriptsName;
}

bool CreateNotebookLifecycleScriptResponse::NotebookLifecycleScriptsNameHasBeenSet() const
{
