...
CoreInternalOutcome CreateNotebookInstanceResponse::Deserialize(const string &payload)
{
...
string CreateNotebookInstanceResponse::ToJsonString() const
{
...
string CreateNotebookInstanceResponse::GetNotebookInstanceName() const
{
    return m_notebookInstanceName;
}

bool CreateNotebookInstanceResponse::NotebookInstanceNameHasBeenSet() const
{
