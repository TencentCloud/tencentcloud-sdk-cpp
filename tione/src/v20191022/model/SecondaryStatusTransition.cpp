...
CoreInternalOutcome SecondaryStatusTransition::Deserialize(const Value &value)
{
    string requestId = "";
...
void SecondaryStatusTransition::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
