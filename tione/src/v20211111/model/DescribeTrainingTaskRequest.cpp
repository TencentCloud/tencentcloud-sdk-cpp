...
string DescribeTrainingTaskRequest::ToJsonString() const
{
...
string DescribeTrainingTaskRequest::GetId() const
{
    return m_id;
}

void DescribeTrainingTaskRequest::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}
