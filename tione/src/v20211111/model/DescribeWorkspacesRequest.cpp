...
string DescribeWorkspacesRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void DescribeWorkspacesRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool DescribeWorkspacesRequest::TiProjectIdHasBeenSet() const
{
...
string DescribeWorkspacesRequest::GetOrderField() const
{
    return m_orderField;
}

void DescribeWorkspacesRequest::SetOrderField(const string& _orderField)
{
    m_orderField = _orderField;
    m_orderFieldHasBeenSet = true;
}

bool DescribeWorkspacesRequest::OrderFieldHasBeenSet() const
{
    return m_orderFieldHasBeenSet;
}

string DescribeWorkspacesRequest::GetOrder() const
{
    return m_order;
}

void DescribeWorkspacesRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeWorkspacesRequest::OrderHasBeenSet() const
{
