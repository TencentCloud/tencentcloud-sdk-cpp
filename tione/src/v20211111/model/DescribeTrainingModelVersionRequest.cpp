...
string DescribeTrainingModelVersionRequest::ToJsonString() const
{
...
string DescribeTrainingModelVersionRequest::GetTrainingModelVersionId() const
{
    return m_trainingModelVersionId;
}

void DescribeTrainingModelVersionRequest::SetTrainingModelVersionId(const string& _trainingModelVersionId)
{
    m_trainingModelVersionId = _trainingModelVersionId;
    m_trainingModelVersionIdHasBeenSet = true;
}

bool DescribeTrainingModelVersionRequest::TrainingModelVersionIdHasBeenSet() const
{
