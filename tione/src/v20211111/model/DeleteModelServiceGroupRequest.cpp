...
string DeleteModelServiceGroupRequest::ToJsonString() const
{
...
string DeleteModelServiceGroupRequest::GetServiceGroupId() const
{
    return m_serviceGroupId;
}

void DeleteModelServiceGroupRequest::SetServiceGroupId(const string& _serviceGroupId)
{
