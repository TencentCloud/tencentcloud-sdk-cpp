...
string DeleteExportRequest::ToJsonString() const
{
...
string DeleteExportRequest::GetExportId() const
{
    return m_exportId;
}

void DeleteExportRequest::SetExportId(const string& _exportId)
{
    m_exportId = _exportId;
    m_exportIdHasBeenSet = true;
}

bool DeleteExportRequest::ExportIdHasBeenSet() const
{
