...
string DeleteModelServiceAuthTokenRequest::ToJsonString() const
{
    ...
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "AuthTokenValue";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_authTokenValue.c_str(), allocator).Move(), allocator);
    }
...
string DeleteModelServiceAuthTokenRequest::GetServiceGroupId() const
{
    return m_serviceGroupId;
}

void DeleteModelServiceAuthTokenRequest::SetServiceGroupId(const string& _serviceGroupId)
{
...
{
    return m_authTokenValue;
}

void DeleteModelServiceAuthTokenRequest::SetAuthTokenValue(const string& _authTokenValue)
{
    m_authTokenValue = _authTokenValue;
    m_authTokenValueHasBeenSet = true;
}

bool DeleteModelServiceAuthTokenRequest::AuthTokenValueHasBeenSet() const
{
    return m_authTokenValueHasBeenSet;
}
