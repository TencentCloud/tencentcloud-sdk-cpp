...
string DescribeDatasetsRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void DescribeDatasetsRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool DescribeDatasetsRequest::TiProjectIdHasBeenSet() const
{
