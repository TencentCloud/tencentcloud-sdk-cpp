...
string UpdateMountLimitRequest::ToJsonString() const
{
...
string UpdateMountLimitRequest::GetType() const
{
    return m_type;
}

void UpdateMountLimitRequest::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool UpdateMountLimitRequest::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string UpdateMountLimitRequest::GetStorageId() const
{
    return m_storageId;
}

void UpdateMountLimitRequest::SetStorageId(const string& _storageId)
{
    m_storageId = _storageId;
    m_storageIdHasBeenSet = true;
}

bool UpdateMountLimitRequest::StorageIdHasBeenSet() const
{
    return m_storageIdHasBeenSet;
}

bool UpdateMountLimitRequest::GetLimitMount() const
{
    return m_limitMount;
}

void UpdateMountLimitRequest::SetLimitMount(const bool& _limitMount)
{
