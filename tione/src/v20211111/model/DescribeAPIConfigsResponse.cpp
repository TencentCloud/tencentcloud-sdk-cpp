...
CoreInternalOutcome DescribeAPIConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeAPIConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeAPIConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAPIConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<APIConfigDetail> DescribeAPIConfigsResponse::GetDetails() const
{
    return m_details;
}

bool DescribeAPIConfigsResponse::DetailsHasBeenSet() const
{
