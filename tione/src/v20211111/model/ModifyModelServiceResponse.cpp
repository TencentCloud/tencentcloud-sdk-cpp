...
CoreInternalOutcome ModifyModelServiceResponse::Deserialize(const string &payload)
{
...
string ModifyModelServiceResponse::ToJsonString() const
{
...
Service ModifyModelServiceResponse::GetService() const
{
    return m_service;
}

bool ModifyModelServiceResponse::ServiceHasBeenSet() const
{
