...
string StartTrainingTaskRequest::ToJsonString() const
{
...
string StartTrainingTaskRequest::GetId() const
{
    return m_id;
}

void StartTrainingTaskRequest::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool StartTrainingTaskRequest::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string StartTrainingTaskRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void StartTrainingTaskRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool StartTrainingTaskRequest::TiProjectIdHasBeenSet() const
{
