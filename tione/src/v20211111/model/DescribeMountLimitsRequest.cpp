...
string DescribeMountLimitsRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void DescribeMountLimitsRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool DescribeMountLimitsRequest::TiProjectIdHasBeenSet() const
{
