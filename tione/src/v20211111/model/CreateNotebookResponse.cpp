...
CoreInternalOutcome CreateNotebookResponse::Deserialize(const string &payload)
{
...
string CreateNotebookResponse::ToJsonString() const
{
...
string CreateNotebookResponse::GetId() const
{
    return m_id;
}

bool CreateNotebookResponse::IdHasBeenSet() const
{
