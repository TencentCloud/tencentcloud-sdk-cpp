...
string DescribeLogsResponse::GetContext() const
{
    return m_context;
}

bool DescribeLogsResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

vector<LogIdentity> DescribeLogsResponse::GetContent() const
{
    return m_content;
}

bool DescribeLogsResponse::ContentHasBeenSet() const
{
