...
CoreInternalOutcome CreateModelServiceResponse::Deserialize(const string &payload)
{
...
string CreateModelServiceResponse::ToJsonString() const
{
...
Service CreateModelServiceResponse::GetService() const
{
    return m_service;
}

bool CreateModelServiceResponse::ServiceHasBeenSet() const
{
