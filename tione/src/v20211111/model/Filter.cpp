...
CoreInternalOutcome Filter::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Negative") && !value["Negative"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Filter.Negative` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Fuzzy") && !value["Fuzzy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Filter.Fuzzy` IsBool=false incorrectly").SetRequestId(requestId));
        }
...
bool Filter::GetNegative() const
{
    return m_negative;
}

void Filter::SetNegative(const bool& _negative)
{
    m_negative = _negative;
    m_negativeHasBeenSet = true;
}

bool Filter::NegativeHasBeenSet() const
{
    return m_negativeHasBeenSet;
}

bool Filter::GetFuzzy() const
{
    return m_fuzzy;
}

void Filter::SetFuzzy(const bool& _fuzzy)
{
    m_fuzzy = _fuzzy;
    m_fuzzyHasBeenSet = true;
}

bool Filter::FuzzyHasBeenSet() const
{
