...
string DeleteModelAccelerateTaskRequest::ToJsonString() const
{
...
string DeleteModelAccelerateTaskRequest::GetModelAccTaskId() const
{
    return m_modelAccTaskId;
}

void DeleteModelAccelerateTaskRequest::SetModelAccTaskId(const string& _modelAccTaskId)
{
    m_modelAccTaskId = _modelAccTaskId;
    m_modelAccTaskIdHasBeenSet = true;
}

bool DeleteModelAccelerateTaskRequest::ModelAccTaskIdHasBeenSet() const
{
