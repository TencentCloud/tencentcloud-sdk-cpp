...
CoreInternalOutcome ModifyModelServicePartialConfigResponse::Deserialize(const string &payload)
{
...
string ModifyModelServicePartialConfigResponse::ToJsonString() const
{
...
Service ModifyModelServicePartialConfigResponse::GetService() const
{
    return m_service;
}

bool ModifyModelServicePartialConfigResponse::ServiceHasBeenSet() const
{
