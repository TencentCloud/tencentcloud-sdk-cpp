...
string DescribeNotebookRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void DescribeNotebookRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool DescribeNotebookRequest::TiProjectIdHasBeenSet() const
{
