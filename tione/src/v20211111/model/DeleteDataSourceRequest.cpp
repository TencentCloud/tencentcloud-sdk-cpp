...
string DeleteDataSourceRequest::GetTiProjectId() const
{
    return m_tiProjectId;
}

void DeleteDataSourceRequest::SetTiProjectId(const string& _tiProjectId)
{
    m_tiProjectId = _tiProjectId;
    m_tiProjectIdHasBeenSet = true;
}

bool DeleteDataSourceRequest::TiProjectIdHasBeenSet() const
{
    return m_tiProjectIdHasBeenSet;
}

string DeleteDataSourceRequest::GetId() const
{
    return m_id;
}

void DeleteDataSourceRequest::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}
