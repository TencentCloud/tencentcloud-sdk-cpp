...
string StopModelAccelerateTaskRequest::ToJsonString() const
{
...
string StopModelAccelerateTaskRequest::GetModelAccTaskId() const
{
    return m_modelAccTaskId;
}

void StopModelAccelerateTaskRequest::SetModelAccTaskId(const string& _modelAccTaskId)
{
    m_modelAccTaskId = _modelAccTaskId;
    m_modelAccTaskIdHasBeenSet = true;
}

bool StopModelAccelerateTaskRequest::ModelAccTaskIdHasBeenSet() const
{
