...
CoreInternalOutcome CreateOptimizedModelResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ModelVersionId") && !rsp["ModelVersionId"].IsNull())
    {
        if (!rsp["ModelVersionId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `ModelVersionId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_modelVersionId = string(rsp["ModelVersionId"].GetString());
...
string CreateOptimizedModelResponse::ToJsonString() const
{
...
string CreateOptimizedModelResponse::GetModelId() const
{
    return m_modelId;
}

bool CreateOptimizedModelResponse::ModelIdHasBeenSet() const
{
    return m_modelIdHasBeenSet;
}

string CreateOptimizedModelResponse::GetModelVersionId() const
{
    return m_modelVersionId;
}

bool CreateOptimizedModelResponse::ModelVersionIdHasBeenSet() const
{
