...
CoreInternalOutcome DescribeModelServicesResponse::Deserialize(const string &payload)
{
...
string DescribeModelServicesResponse::ToJsonString() const
{
...
int64_t DescribeModelServicesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeModelServicesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Service> DescribeModelServicesResponse::GetServices() const
{
    return m_services;
}

bool DescribeModelServicesResponse::ServicesHasBeenSet() const
{
