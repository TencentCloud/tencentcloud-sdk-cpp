...
string DescribeBatchTaskRequest::GetBatchTaskId() const
{
    return m_batchTaskId;
}

void DescribeBatchTaskRequest::SetBatchTaskId(const string& _batchTaskId)
{
    m_batchTaskId = _batchTaskId;
    m_batchTaskIdHasBeenSet = true;
}

bool DescribeBatchTaskRequest::BatchTaskIdHasBeenSet() const
{
