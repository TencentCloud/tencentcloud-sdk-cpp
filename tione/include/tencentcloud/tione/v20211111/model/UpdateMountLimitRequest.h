...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_UPDATEMOUNTLIMITREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_UPDATEMOUNTLIMITREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class UpdateMountLimitRequest : public AbstractModel
                {
                public:
                    UpdateMountLimitRequest();
                    ~UpdateMountLimitRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_UPDATEMOUNTLIMITREQUEST_H_
