...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_CREATEMOUNTLIMITREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_CREATEMOUNTLIMITREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class CreateMountLimitRequest : public AbstractModel
                {
                public:
                    CreateMountLimitRequest();
                    ~CreateMountLimitRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_CREATEMOUNTLIMITREQUEST_H_
