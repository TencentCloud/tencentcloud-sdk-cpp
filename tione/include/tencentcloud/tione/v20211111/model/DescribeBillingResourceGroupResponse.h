...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEBILLINGRESOURCEGROUPRESPONSE_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEBILLINGRESOURCEGROUPRESPONSE_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeBillingResourceGroupResponse : public AbstractModel
                {
                public:
                    DescribeBillingResourceGroupResponse();
                    ~DescribeBillingResourceGroupResponse() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEBILLINGRESOURCEGROUPRESPONSE_H_
