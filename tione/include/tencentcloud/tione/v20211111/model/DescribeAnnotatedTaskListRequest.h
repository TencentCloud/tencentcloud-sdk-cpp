...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEANNOTATEDTASKLISTREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEANNOTATEDTASKLISTREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeAnnotatedTaskListRequest : public AbstractModel
                {
                public:
                    DescribeAnnotatedTaskListRequest();
                    ~DescribeAnnotatedTaskListRequest() = default;
                    ...
                    /**
                     * 获取过滤条件数组，支持数据集ID，标注场景、任务状态、数据集名称、人物名称的过滤，后面两个支持模糊查询
                    ...
                    /**
                     * 设置过滤条件数组，支持数据集ID，标注场景、任务状态、数据集名称、人物名称的过滤，后面两个支持模糊查询
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEANNOTATEDTASKLISTREQUEST_H_
