...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFIRSTCLASS_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFIRSTCLASS_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                * 一级标签
                */
                class TextLabelDistributionDetailInfoFirstClass : public AbstractModel
                {
                public:
                    TextLabelDistributionDetailInfoFirstClass();
                    ~TextLabelDistributionDetailInfoFirstClass() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TextLabelDistributionDetailInfoSecondClass> GetChildLabelList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetChildLabelList(const std::vector<TextLabelDistributionDetailInfoSecondClass>& _childLabelList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TextLabelDistributionDetailInfoSecondClass> m_childLabelList;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFIRSTCLASS_H_
