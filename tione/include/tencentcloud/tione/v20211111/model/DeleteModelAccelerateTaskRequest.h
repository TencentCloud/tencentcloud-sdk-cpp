...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DELETEMODELACCELERATETASKREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DELETEMODELACCELERATETASKREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DeleteModelAccelerateTaskRequest : public AbstractModel
                {
                public:
                    DeleteModelAccelerateTaskRequest();
                    ~DeleteModelAccelerateTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DELETEMODELACCELERATETASKREQUEST_H_
