...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFOURTHCLASS_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFOURTHCLASS_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                * 四级标签
                */
                class TextLabelDistributionDetailInfoFourthClass : public AbstractModel
                {
                public:
                    TextLabelDistributionDetailInfoFourthClass();
                    ~TextLabelDistributionDetailInfoFourthClass() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TextLabelDistributionDetailInfoFifthClass> GetChildLabelList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetChildLabelList(const std::vector<TextLabelDistributionDetailInfoFifthClass>& _childLabelList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TextLabelDistributionDetailInfoFifthClass> m_childLabelList;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOFOURTHCLASS_H_
