...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_MODELACCENGINEVERSION_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_MODELACCENGINEVERSION_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                * 模型加速引擎版本
                */
                class ModelAccEngineVersion : public AbstractModel
                {
                public:
                    ModelAccEngineVersion();
                    ~ModelAccEngineVersion() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_MODELACCENGINEVERSION_H_
