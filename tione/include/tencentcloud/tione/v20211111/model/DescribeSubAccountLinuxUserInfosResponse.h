...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBESUBACCOUNTLINUXUSERINFOSRESPONSE_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBESUBACCOUNTLINUXUSERINFOSRESPONSE_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeSubAccountLinuxUserInfosResponse : public AbstractModel
                {
                public:
                    DescribeSubAccountLinuxUserInfosResponse();
                    ~DescribeSubAccountLinuxUserInfosResponse() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBESUBACCOUNTLINUXUSERINFOSRESPONSE_H_
