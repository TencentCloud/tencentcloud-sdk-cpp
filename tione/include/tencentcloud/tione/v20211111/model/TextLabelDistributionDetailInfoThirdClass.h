...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOTHIRDCLASS_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOTHIRDCLASS_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                * 三级标签
                */
                class TextLabelDistributionDetailInfoThirdClass : public AbstractModel
                {
                public:
                    TextLabelDistributionDetailInfoThirdClass();
                    ~TextLabelDistributionDetailInfoThirdClass() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TextLabelDistributionDetailInfoFourthClass> GetChildLabelList() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetChildLabelList(const std::vector<TextLabelDistributionDetailInfoFourthClass>& _childLabelList);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TextLabelDistributionDetailInfoFourthClass> m_childLabelList;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_TEXTLABELDISTRIBUTIONDETAILINFOTHIRDCLASS_H_
