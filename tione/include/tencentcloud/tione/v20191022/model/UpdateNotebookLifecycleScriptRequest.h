...
#ifndef TENCENTCLOUD_TIONE_V20191022_MODEL_UPDATENOTEBOOKLIFECYCLESCRIPTREQUEST_H_
#define TENCENTCLOUD_TIONE_V20191022_MODEL_UPDATENOTEBOOKLIFECYCLESCRIPTREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20191022
        {
            namespace Model
            {
                ...
                */
                class UpdateNotebookLifecycleScriptRequest : public AbstractModel
                {
                public:
                    UpdateNotebookLifecycleScriptRequest();
                    ~UpdateNotebookLifecycleScriptRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20191022_MODEL_UPDATENOTEBOOKLIFECYCLESCRIPTREQUEST_H_
