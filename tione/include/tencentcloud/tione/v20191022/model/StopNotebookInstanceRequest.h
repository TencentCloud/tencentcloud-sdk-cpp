...
#ifndef TENCENTCLOUD_TIONE_V20191022_MODEL_STOPNOTEBOOKINSTANCEREQUEST_H_
#define TENCENTCLOUD_TIONE_V20191022_MODEL_STOPNOTEBOOKINSTANCEREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20191022
        {
            namespace Model
            {
                ...
                */
                class StopNotebookInstanceRequest : public AbstractModel
                {
                public:
                    StopNotebookInstanceRequest();
                    ~StopNotebookInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20191022_MODEL_STOPNOTEBOOKINSTANCEREQUEST_H_
