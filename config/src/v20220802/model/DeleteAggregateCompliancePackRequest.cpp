...
DeleteAggregateCompliancePackRequest::DeleteAggregateCompliancePackRequest() :
    m_compliancePackIdHasBeenSet(false),
    m_accountGroupIdHasBeenSet(false)
{
}

string DeleteAggregateCompliancePackRequest::ToJsonString() const
{
...
string DeleteAggregateCompliancePackRequest::GetCompliancePackId() const
{
    return m_compliancePackId;
}

void DeleteAggregateCompliancePackRequest::SetCompliancePackId(const string& _compliancePackId)
{
    m_compliancePackId = _compliancePackId;
    m_compliancePackIdHasBeenSet = true;
}

bool DeleteAggregateCompliancePackRequest::CompliancePackIdHasBeenSet() const
{
    return m_compliancePackIdHasBeenSet;
}

string DeleteAggregateCompliancePackRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void DeleteAggregateCompliancePackRequest::SetAccountGroupId(const string& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool DeleteAggregateCompliancePackRequest::AccountGroupIdHasBeenSet() const
{
