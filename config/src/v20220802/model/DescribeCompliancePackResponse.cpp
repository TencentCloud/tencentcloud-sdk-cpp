...
DescribeCompliancePackResponse::DescribeCompliancePackResponse() :
...
CoreInternalOutcome DescribeCompliancePackResponse::Deserialize(const string &payload)
{
...
string DescribeCompliancePackResponse::ToJsonString() const
{
...
string DescribeCompliancePackResponse::GetCompliancePackName() const
{
    return m_compliancePackName;
}

bool DescribeCompliancePackResponse::CompliancePackNameHasBeenSet() const
{
    return m_compliancePackNameHasBeenSet;
}

string DescribeCompliancePackResponse::GetDescription() const
{
    return m_description;
}

bool DescribeCompliancePackResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string DescribeCompliancePackResponse::GetCreateTime() const
{
    return m_createTime;
}

bool DescribeCompliancePackResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t DescribeCompliancePackResponse::GetRiskLevel() const
{
    return m_riskLevel;
}

bool DescribeCompliancePackResponse::RiskLevelHasBeenSet() const
{
    return m_riskLevelHasBeenSet;
}

vector<ComplianceConfigRule> DescribeCompliancePackResponse::GetConfigRules() const
{
    return m_configRules;
}

bool DescribeCompliancePackResponse::ConfigRulesHasBeenSet() const
{
    return m_configRulesHasBeenSet;
}

string DescribeCompliancePackResponse::GetCompliancePackId() const
{
    return m_compliancePackId;
}

bool DescribeCompliancePackResponse::CompliancePackIdHasBeenSet() const
{
    return m_compliancePackIdHasBeenSet;
}

string DescribeCompliancePackResponse::GetStatus() const
{
    return m_status;
}

bool DescribeCompliancePackResponse::StatusHasBeenSet() const
{
