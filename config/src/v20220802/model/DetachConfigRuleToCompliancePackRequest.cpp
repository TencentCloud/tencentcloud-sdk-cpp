...
string DetachConfigRuleToCompliancePackRequest::ToJsonString() const
{
...
string DetachConfigRuleToCompliancePackRequest::GetCompliancePackId() const
{
    return m_compliancePackId;
}

void DetachConfigRuleToCompliancePackRequest::SetCompliancePackId(const string& _compliancePackId)
{
    m_compliancePackId = _compliancePackId;
    m_compliancePackIdHasBeenSet = true;
}

bool DetachConfigRuleToCompliancePackRequest::CompliancePackIdHasBeenSet() const
{
    return m_compliancePackIdHasBeenSet;
}

string DetachConfigRuleToCompliancePackRequest::GetConfigRuleId() const
{
    return m_configRuleId;
}

void DetachConfigRuleToCompliancePackRequest::SetConfigRuleId(const string& _configRuleId)
{
    m_configRuleId = _configRuleId;
    m_configRuleIdHasBeenSet = true;
}

bool DetachConfigRuleToCompliancePackRequest::ConfigRuleIdHasBeenSet() const
{
