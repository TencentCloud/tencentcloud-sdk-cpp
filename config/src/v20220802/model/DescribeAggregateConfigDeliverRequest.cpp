...
DescribeAggregateConfigDeliverRequest::DescribeAggregateConfigDeliverRequest() :
    m_accountGroupIdHasBeenSet(false)
{
}

string DescribeAggregateConfigDeliverRequest::ToJsonString() const
{
...
string DescribeAggregateConfigDeliverRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void DescribeAggregateConfigDeliverRequest::SetAccountGroupId(const string& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool DescribeAggregateConfigDeliverRequest::AccountGroupIdHasBeenSet() const
{
