...
CoreInternalOutcome ListResourceTypesResponse::Deserialize(const string &payload)
{
...
string ListResourceTypesResponse::ToJsonString() const
{
...
vector<ConfigResource> ListResourceTypesResponse::GetItems() const
{
    return m_items;
}

bool ListResourceTypesResponse::ItemsHasBeenSet() const
{
