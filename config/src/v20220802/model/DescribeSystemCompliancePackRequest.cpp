...
DescribeSystemCompliancePackRequest::DescribeSystemCompliancePackRequest() :
    m_compliancePackIdHasBeenSet(false)
{
}

string DescribeSystemCompliancePackRequest::ToJsonString() const
{
...
string DescribeSystemCompliancePackRequest::GetCompliancePackId() const
{
    return m_compliancePackId;
}

void DescribeSystemCompliancePackRequest::SetCompliancePackId(const string& _compliancePackId)
{
    m_compliancePackId = _compliancePackId;
    m_compliancePackIdHasBeenSet = true;
}

bool DescribeSystemCompliancePackRequest::CompliancePackIdHasBeenSet() const
{
