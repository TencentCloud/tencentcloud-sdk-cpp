...
DescribeCompliancePackRequest::DescribeCompliancePackRequest() :
    m_compliancePackIdHasBeenSet(false)
{
}

string DescribeCompliancePackRequest::ToJsonString() const
{
...
string DescribeCompliancePackRequest::GetCompliancePackId() const
{
    return m_compliancePackId;
}

void DescribeCompliancePackRequest::SetCompliancePackId(const string& _compliancePackId)
{
    m_compliancePackId = _compliancePackId;
    m_compliancePackIdHasBeenSet = true;
}

bool DescribeCompliancePackRequest::CompliancePackIdHasBeenSet() const
{
