...
CoreInternalOutcome ListAggregateDiscoveredResourcesResponse::Deserialize(const string &payload)
{
...
string ListAggregateDiscoveredResourcesResponse::ToJsonString() const
{
...
vector<AggregateResourceInfo> ListAggregateDiscoveredResourcesResponse::GetItems() const
{
    return m_items;
}

bool ListAggregateDiscoveredResourcesResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

string ListAggregateDiscoveredResourcesResponse::GetNextToken() const
{
    return m_nextToken;
}

bool ListAggregateDiscoveredResourcesResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

int64_t ListAggregateDiscoveredResourcesResponse::GetCount() const
{
    return m_count;
}

bool ListAggregateDiscoveredResourcesResponse::CountHasBeenSet() const
{
