...
CoreInternalOutcome ListAggregateConfigRulesResponse::Deserialize(const string &payload)
{
...
string ListAggregateConfigRulesResponse::ToJsonString() const
{
...
uint64_t ListAggregateConfigRulesResponse::GetTotal() const
{
    return m_total;
}

bool ListAggregateConfigRulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ConfigRule> ListAggregateConfigRulesResponse::GetItems() const
{
    return m_items;
}

bool ListAggregateConfigRulesResponse::ItemsHasBeenSet() const
{
