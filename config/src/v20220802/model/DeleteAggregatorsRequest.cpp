...
string DeleteAggregatorsRequest::ToJsonString() const
{
...
string DeleteAggregatorsRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void DeleteAggregatorsRequest::SetAccountGroupId(const string& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool DeleteAggregatorsRequest::AccountGroupIdHasBeenSet() const
{
    return m_accountGroupIdHasBeenSet;
}

uint64_t DeleteAggregatorsRequest::GetOwnerUin() const
{
    return m_ownerUin;
}

void DeleteAggregatorsRequest::SetOwnerUin(const uint64_t& _ownerUin)
{
    m_ownerUin = _ownerUin;
    m_ownerUinHasBeenSet = true;
}

bool DeleteAggregatorsRequest::OwnerUinHasBeenSet() const
{
