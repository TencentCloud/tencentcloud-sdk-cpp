...
AddCompliancePackResponse::AddCompliancePackResponse() :
    m_compliancePackIdHasBeenSet(false)
{
}

CoreInternalOutcome AddCompliancePackResponse::Deserialize(const string &payload)
{
...
string AddCompliancePackResponse::ToJsonString() const
{
...
string AddCompliancePackResponse::GetCompliancePackId() const
{
    return m_compliancePackId;
}

bool AddCompliancePackResponse::CompliancePackIdHasBeenSet() const
{
