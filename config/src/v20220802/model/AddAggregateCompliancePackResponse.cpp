...
AddAggregateCompliancePackResponse::AddAggregateCompliancePackResponse() :
    m_compliancePackIdHasBeenSet(false)
{
}

CoreInternalOutcome AddAggregateCompliancePackResponse::Deserialize(const string &payload)
{
...
string AddAggregateCompliancePackResponse::ToJsonString() const
{
...
string AddAggregateCompliancePackResponse::GetCompliancePackId() const
{
    return m_compliancePackId;
}

bool AddAggregateCompliancePackResponse::CompliancePackIdHasBeenSet() const
{
