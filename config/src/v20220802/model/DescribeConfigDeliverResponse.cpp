...
DescribeConfigDeliverResponse::DescribeConfigDeliverResponse() :
...
CoreInternalOutcome DescribeConfigDeliverResponse::Deserialize(const string &payload)
{
...
string DescribeConfigDeliverResponse::ToJsonString() const
{
...
string DescribeConfigDeliverResponse::GetDeliverName() const
{
    return m_deliverName;
}

bool DescribeConfigDeliverResponse::DeliverNameHasBeenSet() const
{
    return m_deliverNameHasBeenSet;
}

string DescribeConfigDeliverResponse::GetTargetArn() const
{
    return m_targetArn;
}

bool DescribeConfigDeliverResponse::TargetArnHasBeenSet() const
{
    return m_targetArnHasBeenSet;
}

uint64_t DescribeConfigDeliverResponse::GetStatus() const
{
    return m_status;
}

bool DescribeConfigDeliverResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeConfigDeliverResponse::GetCreateTime() const
{
    return m_createTime;
}

bool DescribeConfigDeliverResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

string DescribeConfigDeliverResponse::GetDeliverPrefix() const
{
    return m_deliverPrefix;
}

bool DescribeConfigDeliverResponse::DeliverPrefixHasBeenSet() const
{
    return m_deliverPrefixHasBeenSet;
}

string DescribeConfigDeliverResponse::GetDeliverType() const
{
    return m_deliverType;
}

bool DescribeConfigDeliverResponse::DeliverTypeHasBeenSet() const
{
    return m_deliverTypeHasBeenSet;
}

uint64_t DescribeConfigDeliverResponse::GetDeliverContentType() const
{
    return m_deliverContentType;
}

bool DescribeConfigDeliverResponse::DeliverContentTypeHasBeenSet() const
{
