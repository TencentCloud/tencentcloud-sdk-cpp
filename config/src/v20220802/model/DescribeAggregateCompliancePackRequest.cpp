...
DescribeAggregateCompliancePackRequest::DescribeAggregateCompliancePackRequest() :
    m_accountGroupIdHasBeenSet(false),
    m_compliancePackIdHasBeenSet(false)
{
}

string DescribeAggregateCompliancePackRequest::ToJsonString() const
{
...
string DescribeAggregateCompliancePackRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void DescribeAggregateCompliancePackRequest::SetAccountGroupId(const string& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool DescribeAggregateCompliancePackRequest::AccountGroupIdHasBeenSet() const
{
    return m_accountGroupIdHasBeenSet;
}

string DescribeAggregateCompliancePackRequest::GetCompliancePackId() const
{
    return m_compliancePackId;
}

void DescribeAggregateCompliancePackRequest::SetCompliancePackId(const string& _compliancePackId)
{
    m_compliancePackId = _compliancePackId;
    m_compliancePackIdHasBeenSet = true;
}

bool DescribeAggregateCompliancePackRequest::CompliancePackIdHasBeenSet() const
{
