...
CoreInternalOutcome ListDiscoveredResourcesResponse::Deserialize(const string &payload)
{
...
string ListDiscoveredResourcesResponse::ToJsonString() const
{
...
vector<ResourceListInfo> ListDiscoveredResourcesResponse::GetItems() const
{
    return m_items;
}

bool ListDiscoveredResourcesResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

string ListDiscoveredResourcesResponse::GetNextToken() const
{
    return m_nextToken;
}
