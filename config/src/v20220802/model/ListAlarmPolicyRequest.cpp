...
string ListAlarmPolicyRequest::ToJsonString() const
{
...
uint64_t ListAlarmPolicyRequest::GetOffset() const
{
    return m_offset;
}

void ListAlarmPolicyRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
