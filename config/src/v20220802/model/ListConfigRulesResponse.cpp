...
CoreInternalOutcome ListConfigRulesResponse::Deserialize(const string &payload)
{
...
string ListConfigRulesResponse::ToJsonString() const
{
...
uint64_t ListConfigRulesResponse::GetTotal() const
{
    return m_total;
}

bool ListConfigRulesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ConfigRule> ListConfigRulesResponse::GetItems() const
{
    return m_items;
}

bool ListConfigRulesResponse::ItemsHasBeenSet() const
{
