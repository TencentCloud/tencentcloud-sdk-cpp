...
#ifndef TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETEAGGREGATECOMPLIANCEPACKREQUEST_H_
#define TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETEAGGREGATECOMPLIANCEPACKREQUEST_H_
    ...
    namespace Config
    {
        namespace V20220802
        {
            namespace Model
            {
                ...
                */
                class DeleteAggregateCompliancePackRequest : public AbstractModel
                {
                public:
                    DeleteAggregateCompliancePackRequest();
                    ~DeleteAggregateCompliancePackRequest() = default;
...
#endif // !TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETEAGGREGATECOMPLIANCEPACKREQUEST_H_
