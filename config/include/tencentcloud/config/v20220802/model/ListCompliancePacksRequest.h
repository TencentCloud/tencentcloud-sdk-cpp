...
#ifndef TENCENTCLOUD_CONFIG_V20220802_MODEL_LISTCOMPLIANCEPACKSREQUEST_H_
#define TENCENTCLOUD_CONFIG_V20220802_MODEL_LISTCOMPLIANCEPACKSREQUEST_H_
    ...
    namespace Config
    {
        namespace V20220802
        {
            namespace Model
            {
                ...
                */
                class ListCompliancePacksRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
                    ...
                    /**
                     * 设置<p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
...
#endif // !TENCENTCLOUD_CONFIG_V20220802_MODEL_LISTCOMPLIANCEPACKSREQUEST_H_
