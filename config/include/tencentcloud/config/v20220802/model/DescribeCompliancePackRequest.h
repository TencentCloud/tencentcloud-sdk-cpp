...
#ifndef TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBECOMPLIANCEPACKREQUEST_H_
#define TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBECOMPLIANCEPACKREQUEST_H_
    ...
    namespace Config
    {
        namespace V20220802
        {
            namespace Model
            {
                ...
                */
                class DescribeCompliancePackRequest : public AbstractModel
                {
                public:
                    DescribeCompliancePackRequest();
                    ~DescribeCompliancePackRequest() = default;
...
#endif // !TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBECOMPLIANCEPACKREQUEST_H_
