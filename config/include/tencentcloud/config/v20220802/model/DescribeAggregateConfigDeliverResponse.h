...
#ifndef TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBEAGGREGATECONFIGDELIVERRESPONSE_H_
#define TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBEAGGREGATECONFIGDELIVERRESPONSE_H_
    ...
    namespace Config
    {
        namespace V20220802
        {
            namespace Model
            {
                ...
                */
                class DescribeAggregateConfigDeliverResponse : public AbstractModel
                {
                public:
                    DescribeAggregateConfigDeliverResponse();
                    ~DescribeAggregateConfigDeliverResponse() = default;
...
#endif // !TENCENTCLOUD_CONFIG_V20220802_MODEL_DESCRIBEAGGREGATECONFIGDELIVERRESPONSE_H_
