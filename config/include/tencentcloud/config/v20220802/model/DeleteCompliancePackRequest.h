...
#ifndef TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETECOMPLIANCEPACKREQUEST_H_
#define TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETECOMPLIANCEPACKREQUEST_H_
    ...
    namespace Config
    {
        namespace V20220802
        {
            namespace Model
            {
                ...
                */
                class DeleteCompliancePackRequest : public AbstractModel
                {
                public:
                    DeleteCompliancePackRequest();
                    ~DeleteCompliancePackRequest() = default;
...
#endif // !TENCENTCLOUD_CONFIG_V20220802_MODEL_DELETECOMPLIANCEPACKREQUEST_H_
