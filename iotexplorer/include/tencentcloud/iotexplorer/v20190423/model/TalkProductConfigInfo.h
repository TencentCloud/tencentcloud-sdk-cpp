...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_TALKPRODUCTCONFIGINFO_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_TALKPRODUCTCONFIGINFO_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * Talk配置信息描述。
                */
                class TalkProductConfigInfo : public AbstractModel
                {
                public:
                    TalkProductConfigInfo();
                    ~TalkProductConfigInfo() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_TALKPRODUCTCONFIGINFO_H_
