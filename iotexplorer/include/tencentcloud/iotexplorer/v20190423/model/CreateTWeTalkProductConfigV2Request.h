...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKPRODUCTCONFIGV2REQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKPRODUCTCONFIGV2REQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CreateTWeTalkProductConfigV2Request : public AbstractModel
                {
                public:
                    CreateTWeTalkProductConfigV2Request();
                    ~CreateTWeTalkProductConfigV2Request() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKPRODUCTCONFIGV2REQUEST_H_
