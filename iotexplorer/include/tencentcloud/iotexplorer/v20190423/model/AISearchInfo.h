...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_AISEARCHINFO_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_AISEARCHINFO_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * AI视频搜索结果结构体。
                */
                class AISearchInfo : public AbstractModel
                {
                public:
                    AISearchInfo();
                    ~AISearchInfo() = default;
                     ...
                     * 
                     */
                    void SetTargets(const std::vector<TargetInfo>& _targets);
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_AISEARCHINFO_H_
