...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_RESUMEWECALLDEVICEREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_RESUMEWECALLDEVICEREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class ResumeWeCallDeviceRequest : public AbstractModel
                {
                public:
                    ResumeWeCallDeviceRequest();
                    ~ResumeWeCallDeviceRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_RESUMEWECALLDEVICEREQUEST_H_
