...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBECLOUDSTORAGEEVENTSWITHAITASKSREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBECLOUDSTORAGEEVENTSWITHAITASKSREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudStorageEventsWithAITasksRequest : public AbstractModel
                {
                public:
                    DescribeCloudStorageEventsWithAITasksRequest();
                    ~DescribeCloudStorageEventsWithAITasksRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBECLOUDSTORAGEEVENTSWITHAITASKSREQUEST_H_
