...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETGATEWAYSUBDEVICELISTREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETGATEWAYSUBDEVICELISTREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class GetGatewaySubDeviceListRequest : public AbstractModel
                {
                public:
                    GetGatewaySubDeviceListRequest();
                    ~GetGatewaySubDeviceListRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETGATEWAYSUBDEVICELISTREQUEST_H_
