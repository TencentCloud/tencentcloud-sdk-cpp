...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_LISTOTAMODULESREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_LISTOTAMODULESREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class ListOtaModulesRequest : public AbstractModel
                {
                public:
                    ListOtaModulesRequest();
                    ~ListOtaModulesRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_LISTOTAMODULESREQUEST_H_
