...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEERENEWSUBSCRIPTIONENTRY_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEERENEWSUBSCRIPTIONENTRY_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * 待续费的 TWeSee 预付费订阅信息
                */
                class SeeRenewSubscriptionEntry : public AbstractModel
                {
                public:
                    SeeRenewSubscriptionEntry();
                    ~SeeRenewSubscriptionEntry() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEERENEWSUBSCRIPTIONENTRY_H_
