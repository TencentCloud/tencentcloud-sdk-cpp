...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKRESPONSE_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKRESPONSE_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeExternalSourceAIServiceTaskResponse : public AbstractModel
                {
                public:
                    InvokeExternalSourceAIServiceTaskResponse();
                    ~InvokeExternalSourceAIServiceTaskResponse() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKRESPONSE_H_
