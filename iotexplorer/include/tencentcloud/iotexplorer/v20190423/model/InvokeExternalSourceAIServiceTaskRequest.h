...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeExternalSourceAIServiceTaskRequest : public AbstractModel
                {
                public:
                    InvokeExternalSourceAIServiceTaskRequest();
                    ~InvokeExternalSourceAIServiceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKEEXTERNALSOURCEAISERVICETASKREQUEST_H_
