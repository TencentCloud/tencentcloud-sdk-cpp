...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_VISIONRECOGNITIONTASK_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_VISIONRECOGNITIONTASK_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * TWeSee 语义理解任务信息
                */
                class VisionRecognitionTask : public AbstractModel
                {
                public:
                    VisionRecognitionTask();
                    ~VisionRecognitionTask() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_VISIONRECOGNITIONTASK_H_
