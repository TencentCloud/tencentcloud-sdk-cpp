...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CreateTWeSeeRecognitionTaskWithFileRequest : public AbstractModel
                {
                public:
                    CreateTWeSeeRecognitionTaskWithFileRequest();
                    ~CreateTWeSeeRecognitionTaskWithFileRequest() = default;
                    ...
                    /**
                     * 设置视频 / 图片文件的 Base64 编码字符串
                     * @param _inputBase64 视频 / 图片文件的 Base64 编码字符串
                     * 
                     */
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
