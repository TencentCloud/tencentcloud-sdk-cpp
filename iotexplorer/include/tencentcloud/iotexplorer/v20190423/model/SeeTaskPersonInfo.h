...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEETASKPERSONINFO_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEETASKPERSONINFO_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * TWeSee 任务人员信息
                */
                class SeeTaskPersonInfo : public AbstractModel
                {
                public:
                    SeeTaskPersonInfo();
                    ~SeeTaskPersonInfo() = default;
                     ...
                     * 
                     */
                    std::vector<SeeTaskFaceInfo> GetFaces() const;
                     ...
                     * 
                     */
                    void SetFaces(const std::vector<SeeTaskFaceInfo>& _faces);
                ...
                private:
                     ...
                     * 该人员在任务中的人脸列表
                     */
                    std::vector<SeeTaskFaceInfo> m_faces;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEETASKPERSONINFO_H_
