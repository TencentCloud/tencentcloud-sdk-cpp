...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_REVOKESHAREDEVICEFROMUSERREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_REVOKESHAREDEVICEFROMUSERREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class RevokeShareDeviceFromUserRequest : public AbstractModel
                {
                public:
                    RevokeShareDeviceFromUserRequest();
                    ~RevokeShareDeviceFromUserRequest() = default;
                    ...
                    /**
                     * 获取<p>被取消分享用户 OpenID（不存在视为已取消，幂等成功）</p>
                    ...
                    /**
                     * 设置<p>被取消分享用户 OpenID（不存在视为已取消，幂等成功）</p>
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_REVOKESHAREDEVICEFROMUSERREQUEST_H_
