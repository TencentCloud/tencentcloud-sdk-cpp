...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEECREATESUBSCRIPTIONENTRY_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEECREATESUBSCRIPTIONENTRY_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * 待开通的 TWeSee 预付费订阅信息
                */
                class SeeCreateSubscriptionEntry : public AbstractModel
                {
                public:
                    SeeCreateSubscriptionEntry();
                    ~SeeCreateSubscriptionEntry() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEECREATESUBSCRIPTIONENTRY_H_
