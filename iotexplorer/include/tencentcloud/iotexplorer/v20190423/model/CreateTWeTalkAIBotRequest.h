...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKAIBOTREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKAIBOTREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CreateTWeTalkAIBotRequest : public AbstractModel
                {
                public:
                    CreateTWeTalkAIBotRequest();
                    ~CreateTWeTalkAIBotRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATETWETALKAIBOTREQUEST_H_
