...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKAGENTBINDINGREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKAGENTBINDINGREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DescribeTWeTalkAgentBindingRequest : public AbstractModel
                {
                public:
                    DescribeTWeTalkAgentBindingRequest();
                    ~DescribeTWeTalkAgentBindingRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKAGENTBINDINGREQUEST_H_
