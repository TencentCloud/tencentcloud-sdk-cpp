...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKECLOUDSTORAGEAISERVICETASKREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKECLOUDSTORAGEAISERVICETASKREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeCloudStorageAIServiceTaskRequest : public AbstractModel
                {
                public:
                    InvokeCloudStorageAIServiceTaskRequest();
                    ~InvokeCloudStorageAIServiceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKECLOUDSTORAGEAISERVICETASKREQUEST_H_
