...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYLORAFREQUENCYREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYLORAFREQUENCYREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class ModifyLoRaFrequencyRequest : public AbstractModel
                {
                public:
                    ModifyLoRaFrequencyRequest();
                    ~ModifyLoRaFrequencyRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYLORAFREQUENCYREQUEST_H_
