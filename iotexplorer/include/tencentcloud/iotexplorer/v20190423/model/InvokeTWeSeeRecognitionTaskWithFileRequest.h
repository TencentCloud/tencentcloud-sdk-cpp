...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeTWeSeeRecognitionTaskWithFileRequest : public AbstractModel
                {
                public:
                    InvokeTWeSeeRecognitionTaskWithFileRequest();
                    ~InvokeTWeSeeRecognitionTaskWithFileRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILEREQUEST_H_
