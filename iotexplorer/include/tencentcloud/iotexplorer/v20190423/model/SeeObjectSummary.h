...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEEOBJECTSUMMARY_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEEOBJECTSUMMARY_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * TWeSee 直传对象概要信息
                */
                class SeeObjectSummary : public AbstractModel
                {
                public:
                    SeeObjectSummary();
                    ~SeeObjectSummary() = default;
                    ...
                    /**
                     * 获取<p>TWeSee 直传对象或目录的 COS URI</p>
                     * @return COSURI <p>TWeSee 直传对象或目录的 COS URI</p>
                     * 
                     */
                    std::string GetCOSURI() const;

                    /**
                     * 设置<p>TWeSee 直传对象或目录的 COS URI</p>
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_SEEOBJECTSUMMARY_H_
