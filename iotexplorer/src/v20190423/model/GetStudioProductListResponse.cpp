...
CoreInternalOutcome GetStudioProductListResponse::Deserialize(const string &payload)
{
...
string GetStudioProductListResponse::ToJsonString() const
{
...
vector<ProductEntry> GetStudioProductListResponse::GetProducts() const
{
    return m_products;
}

bool GetStudioProductListResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

int64_t GetStudioProductListResponse::GetTotal() const
{
    return m_total;
}

bool GetStudioProductListResponse::TotalHasBeenSet() const
{
