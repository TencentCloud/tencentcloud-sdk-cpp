...
TalkEventCallbackConfig ModifyTWeTalkAgentRequest::GetEventCallbackConfig() const
{
    return m_eventCallbackConfig;
}

void ModifyTWeTalkAgentRequest::SetEventCallbackConfig(const TalkEventCallbackConfig& _eventCallbackConfig)
{
    m_eventCallbackConfig = _eventCallbackConfig;
    m_eventCallbackConfigHasBeenSet = true;
}

bool ModifyTWeTalkAgentRequest::EventCallbackConfigHasBeenSet() const
{
