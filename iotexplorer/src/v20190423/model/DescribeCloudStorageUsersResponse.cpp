...
CoreInternalOutcome DescribeCloudStorageUsersResponse::Deserialize(const string &payload)
{
...
string DescribeCloudStorageUsersResponse::ToJsonString() const
{
...
uint64_t DescribeCloudStorageUsersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCloudStorageUsersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CloudStorageUserInfo> DescribeCloudStorageUsersResponse::GetUsers() const
{
    return m_users;
}

bool DescribeCloudStorageUsersResponse::UsersHasBeenSet() const
{
