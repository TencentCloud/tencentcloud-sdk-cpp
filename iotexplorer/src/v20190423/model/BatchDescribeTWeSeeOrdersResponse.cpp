...
BatchDescribeTWeSeeOrdersResponse::BatchDescribeTWeSeeOrdersResponse() :
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome BatchDescribeTWeSeeOrdersResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Results") && !rsp["Results"].IsNull())
    {
        ...
        {
            BatchDescribeTWeSeeOrdersResult item;
...
string BatchDescribeTWeSeeOrdersResponse::ToJsonString() const
{
...
vector<BatchDescribeTWeSeeOrdersResult> BatchDescribeTWeSeeOrdersResponse::GetResults() const
{
    return m_results;
}

bool BatchDescribeTWeSeeOrdersResponse::ResultsHasBeenSet() const
{
