...
CoreInternalOutcome DeviceUpdateStatus::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("FwType") && !value["FwType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DeviceUpdateStatus.FwType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RetryNum") && !value["RetryNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DeviceUpdateStatus.RetryNum` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
string DeviceUpdateStatus::GetFwType() const
{
    return m_fwType;
}

void DeviceUpdateStatus::SetFwType(const string& _fwType)
{
    m_fwType = _fwType;
    m_fwTypeHasBeenSet = true;
}

bool DeviceUpdateStatus::FwTypeHasBeenSet() const
{
    return m_fwTypeHasBeenSet;
}

uint64_t DeviceUpdateStatus::GetRetryNum() const
{
    return m_retryNum;
}

void DeviceUpdateStatus::SetRetryNum(const uint64_t& _retryNum)
{
    m_retryNum = _retryNum;
    m_retryNumHasBeenSet = true;
}

bool DeviceUpdateStatus::RetryNumHasBeenSet() const
{
