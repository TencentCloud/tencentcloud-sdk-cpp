...
GetTWeCallActiveStatusRequest::GetTWeCallActiveStatusRequest() :
    m_miniProgramAppIdHasBeenSet(false),
    m_deviceListHasBeenSet(false)
{
}

string GetTWeCallActiveStatusRequest::ToJsonString() const
{
...
string GetTWeCallActiveStatusRequest::GetMiniProgramAppId() const
{
    return m_miniProgramAppId;
}

void GetTWeCallActiveStatusRequest::SetMiniProgramAppId(const string& _miniProgramAppId)
{
    m_miniProgramAppId = _miniProgramAppId;
    m_miniProgramAppIdHasBeenSet = true;
}

bool GetTWeCallActiveStatusRequest::MiniProgramAppIdHasBeenSet() const
{
    return m_miniProgramAppIdHasBeenSet;
}

vector<TWeCallInfo> GetTWeCallActiveStatusRequest::GetDeviceList() const
{
    return m_deviceList;
}

void GetTWeCallActiveStatusRequest::SetDeviceList(const vector<TWeCallInfo>& _deviceList)
{
    m_deviceList = _deviceList;
    m_deviceListHasBeenSet = true;
}

bool GetTWeCallActiveStatusRequest::DeviceListHasBeenSet() const
{
