...
BatchRenewTWeSeeSubscriptionResponse::BatchRenewTWeSeeSubscriptionResponse() :
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome BatchRenewTWeSeeSubscriptionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Results") && !rsp["Results"].IsNull())
    {
        ...
        {
            SeeRenewSubscriptionResult item;
...
string BatchRenewTWeSeeSubscriptionResponse::ToJsonString() const
{
...
vector<SeeRenewSubscriptionResult> BatchRenewTWeSeeSubscriptionResponse::GetResults() const
{
    return m_results;
}

bool BatchRenewTWeSeeSubscriptionResponse::ResultsHasBeenSet() const
{
