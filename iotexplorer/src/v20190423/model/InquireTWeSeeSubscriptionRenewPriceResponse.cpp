...
InquireTWeSeeSubscriptionRenewPriceResponse::InquireTWeSeeSubscriptionRenewPriceResponse() :
...
CoreInternalOutcome InquireTWeSeeSubscriptionRenewPriceResponse::Deserialize(const string &payload)
{
...
string InquireTWeSeeSubscriptionRenewPriceResponse::ToJsonString() const
{
...
string InquireTWeSeeSubscriptionRenewPriceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquireTWeSeeSubscriptionRenewPriceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string InquireTWeSeeSubscriptionRenewPriceResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool InquireTWeSeeSubscriptionRenewPriceResponse::DiscountPriceHasBeenSet() const
{
    return m_discountPriceHasBeenSet;
}

string InquireTWeSeeSubscriptionRenewPriceResponse::GetCurrency() const
{
    return m_currency;
}

bool InquireTWeSeeSubscriptionRenewPriceResponse::CurrencyHasBeenSet() const
{
