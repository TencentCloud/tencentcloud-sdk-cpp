...
DescribeSubscribedTopicPolicyResponse::DescribeSubscribedTopicPolicyResponse() :
    m_topicsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSubscribedTopicPolicyResponse::Deserialize(const string &payload)
{
...
string DescribeSubscribedTopicPolicyResponse::ToJsonString() const
{
...
vector<SubscribedTopicItem> DescribeSubscribedTopicPolicyResponse::GetTopics() const
{
    return m_topics;
}

bool DescribeSubscribedTopicPolicyResponse::TopicsHasBeenSet() const
{
