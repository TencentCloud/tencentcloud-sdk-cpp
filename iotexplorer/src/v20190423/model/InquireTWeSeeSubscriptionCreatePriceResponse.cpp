...
InquireTWeSeeSubscriptionCreatePriceResponse::InquireTWeSeeSubscriptionCreatePriceResponse() :
...
CoreInternalOutcome InquireTWeSeeSubscriptionCreatePriceResponse::Deserialize(const string &payload)
{
...
string InquireTWeSeeSubscriptionCreatePriceResponse::ToJsonString() const
{
...
string InquireTWeSeeSubscriptionCreatePriceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquireTWeSeeSubscriptionCreatePriceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string InquireTWeSeeSubscriptionCreatePriceResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool InquireTWeSeeSubscriptionCreatePriceResponse::DiscountPriceHasBeenSet() const
{
    return m_discountPriceHasBeenSet;
}

string InquireTWeSeeSubscriptionCreatePriceResponse::GetCurrency() const
{
    return m_currency;
}

bool InquireTWeSeeSubscriptionCreatePriceResponse::CurrencyHasBeenSet() const
{
