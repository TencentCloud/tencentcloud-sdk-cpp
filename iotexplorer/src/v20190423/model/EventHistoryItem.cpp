...
CoreInternalOutcome EventHistoryItem::Deserialize(const Value &value)
{
    string requestId = "";
...
void EventHistoryItem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
