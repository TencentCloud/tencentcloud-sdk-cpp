...
CoreInternalOutcome ModifyLoRaFrequencyResponse::Deserialize(const string &payload)
{
...
string ModifyLoRaFrequencyResponse::ToJsonString() const
{
...
LoRaFrequencyEntry ModifyLoRaFrequencyResponse::GetData() const
{
    return m_data;
}

bool ModifyLoRaFrequencyResponse::DataHasBeenSet() const
{
