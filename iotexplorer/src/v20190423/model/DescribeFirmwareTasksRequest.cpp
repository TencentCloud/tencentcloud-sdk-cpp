...
string DescribeFirmwareTasksRequest::GetFwType() const
{
    return m_fwType;
}

void DescribeFirmwareTasksRequest::SetFwType(const string& _fwType)
{
    m_fwType = _fwType;
    m_fwTypeHasBeenSet = true;
}

bool DescribeFirmwareTasksRequest::FwTypeHasBeenSet() const
{
