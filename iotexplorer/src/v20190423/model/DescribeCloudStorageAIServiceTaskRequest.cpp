...
string DescribeCloudStorageAIServiceTaskRequest::ToJsonString() const
{
...
string DescribeCloudStorageAIServiceTaskRequest::GetTaskId() const
{
    return m_taskId;
}

void DescribeCloudStorageAIServiceTaskRequest::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
