...
CoreInternalOutcome DescribeCloudStorageEventsByTWeSeePersonResponse::Deserialize(const string &payload)
{
...
string DescribeCloudStorageEventsByTWeSeePersonResponse::ToJsonString() const
{
...
vector<CloudStorageEventWithAITasks> DescribeCloudStorageEventsByTWeSeePersonResponse::GetEvents() const
{
    return m_events;
}

bool DescribeCloudStorageEventsByTWeSeePersonResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

uint64_t DescribeCloudStorageEventsByTWeSeePersonResponse::GetTotal() const
{
    return m_total;
}
