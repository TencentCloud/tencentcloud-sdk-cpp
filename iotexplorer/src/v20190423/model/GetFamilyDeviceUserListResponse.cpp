...
CoreInternalOutcome GetFamilyDeviceUserListResponse::Deserialize(const string &payload)
{
...
string GetFamilyDeviceUserListResponse::ToJsonString() const
{
...
vector<DeviceUser> GetFamilyDeviceUserListResponse::GetUserList() const
{
    return m_userList;
}

bool GetFamilyDeviceUserListResponse::UserListHasBeenSet() const
{
