...
CoreInternalOutcome DescribeGatewaySubProductsResponse::Deserialize(const string &payload)
{
...
string DescribeGatewaySubProductsResponse::ToJsonString() const
{
...
vector<BindProductInfo> DescribeGatewaySubProductsResponse::GetProducts() const
{
    return m_products;
}

bool DescribeGatewaySubProductsResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

uint64_t DescribeGatewaySubProductsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeGatewaySubProductsResponse::TotalHasBeenSet() const
{
