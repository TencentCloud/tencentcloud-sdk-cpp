...
CoreInternalOutcome CreateLoRaFrequencyResponse::Deserialize(const string &payload)
{
...
string CreateLoRaFrequencyResponse::ToJsonString() const
{
...
LoRaFrequencyEntry CreateLoRaFrequencyResponse::GetData() const
{
    return m_data;
}

bool CreateLoRaFrequencyResponse::DataHasBeenSet() const
{
