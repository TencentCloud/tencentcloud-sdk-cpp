...
string DescribeFirmwareTaskDevicesRequest::GetFwType() const
{
    return m_fwType;
}

void DescribeFirmwareTaskDevicesRequest::SetFwType(const string& _fwType)
{
    m_fwType = _fwType;
    m_fwTypeHasBeenSet = true;
}

bool DescribeFirmwareTaskDevicesRequest::FwTypeHasBeenSet() const
{
