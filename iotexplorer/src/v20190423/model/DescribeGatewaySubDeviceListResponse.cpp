...
CoreInternalOutcome DescribeGatewaySubDeviceListResponse::Deserialize(const string &payload)
{
...
string DescribeGatewaySubDeviceListResponse::ToJsonString() const
{
...
int64_t DescribeGatewaySubDeviceListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeGatewaySubDeviceListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<FamilySubDevice> DescribeGatewaySubDeviceListResponse::GetDeviceList() const
{
    return m_deviceList;
}

bool DescribeGatewaySubDeviceListResponse::DeviceListHasBeenSet() const
{
