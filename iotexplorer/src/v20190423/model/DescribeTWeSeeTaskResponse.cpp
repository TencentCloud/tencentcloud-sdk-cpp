...
DescribeTWeSeeTaskResponse::DescribeTWeSeeTaskResponse() :
    m_taskInfoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTWeSeeTaskResponse::Deserialize(const string &payload)
{
...
string DescribeTWeSeeTaskResponse::ToJsonString() const
{
...
SeeTaskInfo DescribeTWeSeeTaskResponse::GetTaskInfo() const
{
    return m_taskInfo;
}

bool DescribeTWeSeeTaskResponse::TaskInfoHasBeenSet() const
{
