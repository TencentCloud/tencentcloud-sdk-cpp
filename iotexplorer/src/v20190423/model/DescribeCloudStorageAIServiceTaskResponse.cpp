...
DescribeCloudStorageAIServiceTaskResponse::DescribeCloudStorageAIServiceTaskResponse() :
    m_taskInfoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCloudStorageAIServiceTaskResponse::Deserialize(const string &payload)
{
...
string DescribeCloudStorageAIServiceTaskResponse::ToJsonString() const
{
...
CloudStorageAIServiceTask DescribeCloudStorageAIServiceTaskResponse::GetTaskInfo() const
{
    return m_taskInfo;
}

bool DescribeCloudStorageAIServiceTaskResponse::TaskInfoHasBeenSet() const
{
