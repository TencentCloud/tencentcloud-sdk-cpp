...
ListTWeSeeTasksResponse::ListTWeSeeTasksResponse() :
    m_tasksHasBeenSet(false),
    m_totalHasBeenSet(false)
{
}

CoreInternalOutcome ListTWeSeeTasksResponse::Deserialize(const string &payload)
{
...
string ListTWeSeeTasksResponse::ToJsonString() const
{
...
vector<SeeTaskInfo> ListTWeSeeTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool ListTWeSeeTasksResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

uint64_t ListTWeSeeTasksResponse::GetTotal() const
{
    return m_total;
}

bool ListTWeSeeTasksResponse::TotalHasBeenSet() const
{
