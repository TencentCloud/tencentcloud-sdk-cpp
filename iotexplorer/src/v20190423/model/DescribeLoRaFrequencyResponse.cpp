...
CoreInternalOutcome DescribeLoRaFrequencyResponse::Deserialize(const string &payload)
{
...
string DescribeLoRaFrequencyResponse::ToJsonString() const
{
...
LoRaFrequencyEntry DescribeLoRaFrequencyResponse::GetData() const
{
    return m_data;
}

bool DescribeLoRaFrequencyResponse::DataHasBeenSet() const
{
