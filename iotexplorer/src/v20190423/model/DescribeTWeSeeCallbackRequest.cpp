...
DescribeTWeSeeCallbackRequest::DescribeTWeSeeCallbackRequest() :
    m_callbackIdHasBeenSet(false)
{
}

string DescribeTWeSeeCallbackRequest::ToJsonString() const
{
...
string DescribeTWeSeeCallbackRequest::GetCallbackId() const
{
    return m_callbackId;
}

void DescribeTWeSeeCallbackRequest::SetCallbackId(const string& _callbackId)
{
    m_callbackId = _callbackId;
    m_callbackIdHasBeenSet = true;
}

bool DescribeTWeSeeCallbackRequest::CallbackIdHasBeenSet() const
{
