...
string DeleteDevicesRequest::ToJsonString() const
{
...
vector<DevicesItem> DeleteDevicesRequest::GetDevicesItems() const
{
    return m_devicesItems;
}

void DeleteDevicesRequest::SetDevicesItems(const vector<DevicesItem>& _devicesItems)
{
    m_devicesItems = _devicesItems;
    m_devicesItemsHasBeenSet = true;
}

bool DeleteDevicesRequest::DevicesItemsHasBeenSet() const
{
