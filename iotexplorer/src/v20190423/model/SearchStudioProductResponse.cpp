...
CoreInternalOutcome SearchStudioProductResponse::Deserialize(const string &payload)
{
...
string SearchStudioProductResponse::ToJsonString() const
{
...
vector<ProductEntry> SearchStudioProductResponse::GetProducts() const
{
    return m_products;
}

bool SearchStudioProductResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

int64_t SearchStudioProductResponse::GetTotal() const
{
    return m_total;
}

bool SearchStudioProductResponse::TotalHasBeenSet() const
{
