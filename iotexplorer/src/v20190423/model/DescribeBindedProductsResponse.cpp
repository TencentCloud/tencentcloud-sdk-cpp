...
CoreInternalOutcome DescribeBindedProductsResponse::Deserialize(const string &payload)
{
...
string DescribeBindedProductsResponse::ToJsonString() const
{
...
vector<BindProductInfo> DescribeBindedProductsResponse::GetProducts() const
{
    return m_products;
}

bool DescribeBindedProductsResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

int64_t DescribeBindedProductsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeBindedProductsResponse::TotalHasBeenSet() const
{
