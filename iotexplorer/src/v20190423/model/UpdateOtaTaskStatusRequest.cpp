...
int64_t UpdateOtaTaskStatusRequest::GetTaskId() const
{
    return m_taskId;
}

void UpdateOtaTaskStatusRequest::SetTaskId(const int64_t& _taskId)
{
    m_taskId = _taskId;
...
int64_t UpdateOtaTaskStatusRequest::GetStatus() const
{
    return m_status;
}

void UpdateOtaTaskStatusRequest::SetStatus(const int64_t& _status)
{
    m_status = _status;
