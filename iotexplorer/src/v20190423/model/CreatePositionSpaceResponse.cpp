...
CoreInternalOutcome CreatePositionSpaceResponse::Deserialize(const string &payload)
{
...
string CreatePositionSpaceResponse::ToJsonString() const
{
...
string CreatePositionSpaceResponse::GetSpaceId() const
{
    return m_spaceId;
}

bool CreatePositionSpaceResponse::SpaceIdHasBeenSet() const
{
