...
CoreInternalOutcome SearchTopicRuleResponse::Deserialize(const string &payload)
{
...
string SearchTopicRuleResponse::ToJsonString() const
{
...
int64_t SearchTopicRuleResponse::GetTotalCnt() const
{
    return m_totalCnt;
}

bool SearchTopicRuleResponse::TotalCntHasBeenSet() const
{
    return m_totalCntHasBeenSet;
}

vector<TopicRuleInfo> SearchTopicRuleResponse::GetRules() const
{
    return m_rules;
}

bool SearchTopicRuleResponse::RulesHasBeenSet() const
{
