...
RenewTWeSeeSubscriptionResponse::RenewTWeSeeSubscriptionResponse() :
...
CoreInternalOutcome RenewTWeSeeSubscriptionResponse::Deserialize(const string &payload)
{
...
string RenewTWeSeeSubscriptionResponse::ToJsonString() const
{
...
string RenewTWeSeeSubscriptionResponse::GetOrderId() const
{
    return m_orderId;
}

bool RenewTWeSeeSubscriptionResponse::OrderIdHasBeenSet() const
{
    return m_orderIdHasBeenSet;
}

string RenewTWeSeeSubscriptionResponse::GetStatus() const
{
    return m_status;
}

bool RenewTWeSeeSubscriptionResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string RenewTWeSeeSubscriptionResponse::GetResourceId() const
{
    return m_resourceId;
}

bool RenewTWeSeeSubscriptionResponse::ResourceIdHasBeenSet() const
{
    return m_resourceIdHasBeenSet;
}

string RenewTWeSeeSubscriptionResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool RenewTWeSeeSubscriptionResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string RenewTWeSeeSubscriptionResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool RenewTWeSeeSubscriptionResponse::DiscountPriceHasBeenSet() const
{
    return m_discountPriceHasBeenSet;
}

string RenewTWeSeeSubscriptionResponse::GetCurrency() const
{
    return m_currency;
}

bool RenewTWeSeeSubscriptionResponse::CurrencyHasBeenSet() const
{
