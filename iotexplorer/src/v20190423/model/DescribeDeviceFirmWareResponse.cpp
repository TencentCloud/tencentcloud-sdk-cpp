...
DescribeDeviceFirmWareResponse::DescribeDeviceFirmWareResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDeviceFirmWareResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceFirmWareResponse::ToJsonString() const
{
...
string DescribeDeviceFirmWareResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceFirmWareResponse::DataHasBeenSet() const
{
