...
string DescribeDeviceRequest::GetDeviceId() const
{
    return m_deviceId;
}

void DescribeDeviceRequest::SetDeviceId(const string& _deviceId)
{
    m_deviceId = _deviceId;
    m_deviceIdHasBeenSet = true;
}

bool DescribeDeviceRequest::DeviceIdHasBeenSet() const
{
