...
DeleteTWeSeeCallbackRequest::DeleteTWeSeeCallbackRequest() :
    m_callbackIdHasBeenSet(false)
{
}

string DeleteTWeSeeCallbackRequest::ToJsonString() const
{
...
string DeleteTWeSeeCallbackRequest::GetCallbackId() const
{
    return m_callbackId;
}

void DeleteTWeSeeCallbackRequest::SetCallbackId(const string& _callbackId)
{
    m_callbackId = _callbackId;
    m_callbackIdHasBeenSet = true;
}

bool DeleteTWeSeeCallbackRequest::CallbackIdHasBeenSet() const
{
