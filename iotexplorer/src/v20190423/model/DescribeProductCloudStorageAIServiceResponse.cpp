...
DescribeProductCloudStorageAIServiceResponse::DescribeProductCloudStorageAIServiceResponse() :
    m_enabledHasBeenSet(false),
    m_availableHasBeenSet(false)
{
}

CoreInternalOutcome DescribeProductCloudStorageAIServiceResponse::Deserialize(const string &payload)
{
...
string DescribeProductCloudStorageAIServiceResponse::ToJsonString() const
{
...
bool DescribeProductCloudStorageAIServiceResponse::GetEnabled() const
{
    return m_enabled;
}

bool DescribeProductCloudStorageAIServiceResponse::EnabledHasBeenSet() const
{
    return m_enabledHasBeenSet;
}

bool DescribeProductCloudStorageAIServiceResponse::GetAvailable() const
{
    return m_available;
}

bool DescribeProductCloudStorageAIServiceResponse::AvailableHasBeenSet() const
{
