...
CoreInternalOutcome GetDeviceListResponse::Deserialize(const string &payload)
{
...
string GetDeviceListResponse::ToJsonString() const
{
...
vector<DeviceInfo> GetDeviceListResponse::GetDevices() const
{
    return m_devices;
}

bool GetDeviceListResponse::DevicesHasBeenSet() const
{
    return m_devicesHasBeenSet;
}

int64_t GetDeviceListResponse::GetTotal() const
{
    return m_total;
}

bool GetDeviceListResponse::TotalHasBeenSet() const
{
