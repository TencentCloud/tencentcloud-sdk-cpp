...
string UpdateDevicesEnableStateResponse::GetResultCode() const
{
    return m_resultCode;
}

bool UpdateDevicesEnableStateResponse::ResultCodeHasBeenSet() const
{
    return m_resultCodeHasBeenSet;
}

string UpdateDevicesEnableStateResponse::GetResultMessage() const
{
    return m_resultMessage;
}

bool UpdateDevicesEnableStateResponse::ResultMessageHasBeenSet() const
{
