...
CoreInternalOutcome ListTopicPolicyResponse::Deserialize(const string &payload)
{
...
string ListTopicPolicyResponse::ToJsonString() const
{
...
vector<TopicItem> ListTopicPolicyResponse::GetTopics() const
{
    return m_topics;
}

bool ListTopicPolicyResponse::TopicsHasBeenSet() const
{
