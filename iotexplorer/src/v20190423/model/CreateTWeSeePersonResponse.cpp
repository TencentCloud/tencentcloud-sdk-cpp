...
CreateTWeSeePersonResponse::CreateTWeSeePersonResponse() :
    m_personHasBeenSet(false)
{
}

CoreInternalOutcome CreateTWeSeePersonResponse::Deserialize(const string &payload)
{
...
string CreateTWeSeePersonResponse::ToJsonString() const
{
...
SeePersonInfo CreateTWeSeePersonResponse::GetPerson() const
{
    return m_person;
}

bool CreateTWeSeePersonResponse::PersonHasBeenSet() const
{
