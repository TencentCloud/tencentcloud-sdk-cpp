...
CreateTWeTalkAIBotResponse::CreateTWeTalkAIBotResponse() :
    m_botIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateTWeTalkAIBotResponse::Deserialize(const string &payload)
{
...
string CreateTWeTalkAIBotResponse::ToJsonString() const
{
...
string CreateTWeTalkAIBotResponse::GetBotId() const
{
    return m_botId;
}

bool CreateTWeTalkAIBotResponse::BotIdHasBeenSet() const
{
