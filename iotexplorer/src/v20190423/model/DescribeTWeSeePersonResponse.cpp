...
DescribeTWeSeePersonResponse::DescribeTWeSeePersonResponse() :
    m_personHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTWeSeePersonResponse::Deserialize(const string &payload)
{
...
string DescribeTWeSeePersonResponse::ToJsonString() const
{
...
SeePersonInfo DescribeTWeSeePersonResponse::GetPerson() const
{
    return m_person;
}

bool DescribeTWeSeePersonResponse::PersonHasBeenSet() const
{
