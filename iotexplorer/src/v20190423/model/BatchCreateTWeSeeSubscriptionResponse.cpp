...
BatchCreateTWeSeeSubscriptionResponse::BatchCreateTWeSeeSubscriptionResponse() :
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome BatchCreateTWeSeeSubscriptionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Results") && !rsp["Results"].IsNull())
    {
        ...
        {
            SeeCreateSubscriptionResult item;
...
string BatchCreateTWeSeeSubscriptionResponse::ToJsonString() const
{
...
vector<SeeCreateSubscriptionResult> BatchCreateTWeSeeSubscriptionResponse::GetResults() const
{
    return m_results;
}

bool BatchCreateTWeSeeSubscriptionResponse::ResultsHasBeenSet() const
{
