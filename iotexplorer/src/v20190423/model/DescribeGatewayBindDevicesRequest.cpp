...
int64_t DescribeGatewayBindDevicesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeGatewayBindDevicesRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
int64_t DescribeGatewayBindDevicesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeGatewayBindDevicesRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
