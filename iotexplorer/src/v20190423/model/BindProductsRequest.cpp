...
string BindProductsRequest::ToJsonString() const
{
...
string BindProductsRequest::GetGatewayProductId() const
{
    return m_gatewayProductId;
}

void BindProductsRequest::SetGatewayProductId(const string& _gatewayProductId)
{
    m_gatewayProductId = _gatewayProductId;
    m_gatewayProductIdHasBeenSet = true;
}

bool BindProductsRequest::GatewayProductIdHasBeenSet() const
{
    return m_gatewayProductIdHasBeenSet;
}

vector<string> BindProductsRequest::GetProductIds() const
{
    return m_productIds;
}

void BindProductsRequest::SetProductIds(const vector<string>& _productIds)
{
    m_productIds = _productIds;
    m_productIdsHasBeenSet = true;
}

bool BindProductsRequest::ProductIdsHasBeenSet() const
{
