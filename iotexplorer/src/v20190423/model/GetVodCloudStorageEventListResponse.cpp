...
GetVodCloudStorageEventListResponse::GetVodCloudStorageEventListResponse() :
...
CoreInternalOutcome GetVodCloudStorageEventListResponse::Deserialize(const string &payload)
{
...
string GetVodCloudStorageEventListResponse::ToJsonString() const
{
...
vector<VodCloudStorageEvent> GetVodCloudStorageEventListResponse::GetEvents() const
{
    return m_events;
}

bool GetVodCloudStorageEventListResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

bool GetVodCloudStorageEventListResponse::GetListover() const
{
    return m_listover;
}

bool GetVodCloudStorageEventListResponse::ListoverHasBeenSet() const
{
    return m_listoverHasBeenSet;
}

string GetVodCloudStorageEventListResponse::GetContext() const
{
    return m_context;
}

bool GetVodCloudStorageEventListResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

uint64_t GetVodCloudStorageEventListResponse::GetTotal() const
{
    return m_total;
}

bool GetVodCloudStorageEventListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

string GetVodCloudStorageEventListResponse::GetVodAppId() const
{
    return m_vodAppId;
}

bool GetVodCloudStorageEventListResponse::VodAppIdHasBeenSet() const
{
