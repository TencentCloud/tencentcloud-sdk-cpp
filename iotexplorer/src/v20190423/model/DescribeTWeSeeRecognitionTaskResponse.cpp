...
DescribeTWeSeeRecognitionTaskResponse::DescribeTWeSeeRecognitionTaskResponse() :
    m_taskInfoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTWeSeeRecognitionTaskResponse::Deserialize(const string &payload)
{
...
string DescribeTWeSeeRecognitionTaskResponse::ToJsonString() const
{
...
VisionRecognitionTask DescribeTWeSeeRecognitionTaskResponse::GetTaskInfo() const
{
    return m_taskInfo;
}

bool DescribeTWeSeeRecognitionTaskResponse::TaskInfoHasBeenSet() const
{
