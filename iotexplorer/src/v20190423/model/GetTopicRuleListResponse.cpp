...
CoreInternalOutcome GetTopicRuleListResponse::Deserialize(const string &payload)
{
...
string GetTopicRuleListResponse::ToJsonString() const
{
...
int64_t GetTopicRuleListResponse::GetTotalCnt() const
{
    return m_totalCnt;
}

bool GetTopicRuleListResponse::TotalCntHasBeenSet() const
{
    return m_totalCntHasBeenSet;
}

vector<TopicRuleInfo> GetTopicRuleListResponse::GetRules() const
{
    return m_rules;
}

bool GetTopicRuleListResponse::RulesHasBeenSet() const
{
