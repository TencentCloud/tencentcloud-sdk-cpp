...
TerminateTWeSeeSubscriptionResponse::TerminateTWeSeeSubscriptionResponse() :
...
CoreInternalOutcome TerminateTWeSeeSubscriptionResponse::Deserialize(const string &payload)
{
...
string TerminateTWeSeeSubscriptionResponse::ToJsonString() const
{
...
string TerminateTWeSeeSubscriptionResponse::GetOrderId() const
{
    return m_orderId;
}

bool TerminateTWeSeeSubscriptionResponse::OrderIdHasBeenSet() const
{
    return m_orderIdHasBeenSet;
}

string TerminateTWeSeeSubscriptionResponse::GetStatus() const
{
    return m_status;
}

bool TerminateTWeSeeSubscriptionResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string TerminateTWeSeeSubscriptionResponse::GetPrice() const
{
    return m_price;
}

bool TerminateTWeSeeSubscriptionResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

string TerminateTWeSeeSubscriptionResponse::GetCurrency() const
{
    return m_currency;
}

bool TerminateTWeSeeSubscriptionResponse::CurrencyHasBeenSet() const
{
