...
CreateTWeSeeSubscriptionResponse::CreateTWeSeeSubscriptionResponse() :
...
CoreInternalOutcome CreateTWeSeeSubscriptionResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["DiscountPrice"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `DiscountPrice` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_discountPrice = string(rsp["DiscountPrice"].GetString());
...
string CreateTWeSeeSubscriptionResponse::ToJsonString() const
{
    ...
    if (m_discountPriceHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_discountPrice.c_str(), allocator).Move(), allocator);
    }
...
string CreateTWeSeeSubscriptionResponse::GetOrderId() const
{
    return m_orderId;
}

bool CreateTWeSeeSubscriptionResponse::OrderIdHasBeenSet() const
{
    return m_orderIdHasBeenSet;
}

string CreateTWeSeeSubscriptionResponse::GetStatus() const
{
    return m_status;
}

bool CreateTWeSeeSubscriptionResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateTWeSeeSubscriptionResponse::GetResourceId() const
{
    return m_resourceId;
}

bool CreateTWeSeeSubscriptionResponse::ResourceIdHasBeenSet() const
{
    return m_resourceIdHasBeenSet;
}

string CreateTWeSeeSubscriptionResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool CreateTWeSeeSubscriptionResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

string CreateTWeSeeSubscriptionResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool CreateTWeSeeSubscriptionResponse::DiscountPriceHasBeenSet() const
{
    return m_discountPriceHasBeenSet;
}

string CreateTWeSeeSubscriptionResponse::GetCurrency() const
{
    return m_currency;
}

bool CreateTWeSeeSubscriptionResponse::CurrencyHasBeenSet() const
{
