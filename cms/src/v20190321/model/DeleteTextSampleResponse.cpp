...
CoreInternalOutcome DeleteTextSampleResponse::Deserialize(const string &payload)
{
...
string DeleteTextSampleResponse::ToJsonString() const
{
...
uint64_t DeleteTextSampleResponse::GetProgress() const
{
    return m_progress;
}

bool DeleteTextSampleResponse::ProgressHasBeenSet() const
{
