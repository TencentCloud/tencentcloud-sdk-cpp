...
CoreInternalOutcome AudioModerationResponse::Deserialize(const string &payload)
{
    Document d;
...
int64_t AudioModerationResponse::GetBusinessCode() const
{
    return m_businessCode;
}

bool AudioModerationResponse::BusinessCodeHasBeenSet() const
{
    return m_businessCodeHasBeenSet;
}

vector<string> AudioModerationResponse::GetData() const
{
    return m_data;
}

bool AudioModerationResponse::DataHasBeenSet() const
{
