...
CoreInternalOutcome DescribeModerationOverviewResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<OverviewRecord> DescribeModerationOverviewResponse::GetResults() const
{
    return m_results;
}

bool DescribeModerationOverviewResponse::ResultsHasBeenSet() const
{
