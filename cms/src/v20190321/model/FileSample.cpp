...
CoreInternalOutcome FileSample::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void FileSample::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
