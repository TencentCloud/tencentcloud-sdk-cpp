...
CoreInternalOutcome ImagePornDetect::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EvilType") && !value["EvilType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ImagePornDetect.EvilType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HitFlag") && !value["HitFlag"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ImagePornDetect.HitFlag` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Keywords") && !value["Keywords"].IsNull())
    {
        if (!value["Keywords"].IsArray())
            return CoreInternalOutcome(Error("response `ImagePornDetect.Keywords` is not array type"));
    ...
    if (value.HasMember("Labels") && !value["Labels"].IsNull())
    {
        if (!value["Labels"].IsArray())
            return CoreInternalOutcome(Error("response `ImagePornDetect.Labels` is not array type"));
    ...
    if (value.HasMember("Score") && !value["Score"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ImagePornDetect.Score` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void ImagePornDetect::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
