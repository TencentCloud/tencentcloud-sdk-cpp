...
CoreInternalOutcome CreateTextSampleResponse::Deserialize(const string &payload)
{
...
string CreateTextSampleResponse::ToJsonString() const
{
...
bool CreateTextSampleResponse::ProgressHasBeenSet() const
{
