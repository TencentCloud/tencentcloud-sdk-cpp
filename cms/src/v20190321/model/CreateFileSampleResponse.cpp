...
CoreInternalOutcome CreateFileSampleResponse::Deserialize(const string &payload)
{
...
string CreateFileSampleResponse::ToJsonString() const
{
...
uint64_t CreateFileSampleResponse::GetProgress() const
{
    return m_progress;
}

bool CreateFileSampleResponse::ProgressHasBeenSet() const
{
