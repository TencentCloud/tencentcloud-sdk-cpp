...
CoreInternalOutcome ManualReviewResponse::Deserialize(const string &payload)
{
...
string ManualReviewResponse::ToJsonString() const
{
...
ManualReviewData ManualReviewResponse::GetData() const
{
    return m_data;
}

bool ManualReviewResponse::DataHasBeenSet() const
{
