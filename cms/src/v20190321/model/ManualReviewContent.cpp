...
CoreInternalOutcome ManualReviewContent::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ManualReviewContent::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
