...
DescribeLibSamplesResponse::DescribeLibSamplesResponse() :
    m_totalCountHasBeenSet(false),
    m_infosHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLibSamplesResponse::Deserialize(const string &payload)
{
...
string DescribeLibSamplesResponse::ToJsonString() const
{
...
int64_t DescribeLibSamplesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLibSamplesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<UserKeywordInfo> DescribeLibSamplesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeLibSamplesResponse::InfosHasBeenSet() const
{
