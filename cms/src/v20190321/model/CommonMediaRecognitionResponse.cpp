...
CoreInternalOutcome CommonMediaRecognitionResponse::Deserialize(const string &payload)
{
    Document d;
...
CallBackData CommonMediaRecognitionResponse::GetData() const
{
    return m_data;
}

bool CommonMediaRecognitionResponse::DataHasBeenSet() const
{
