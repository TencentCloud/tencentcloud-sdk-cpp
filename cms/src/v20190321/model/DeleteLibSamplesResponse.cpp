...
DeleteLibSamplesResponse::DeleteLibSamplesResponse() :
    m_countHasBeenSet(false),
    m_detailsHasBeenSet(false)
{
}

CoreInternalOutcome DeleteLibSamplesResponse::Deserialize(const string &payload)
{
...
string DeleteLibSamplesResponse::ToJsonString() const
{
...
int64_t DeleteLibSamplesResponse::GetCount() const
{
    return m_count;
}

bool DeleteLibSamplesResponse::CountHasBeenSet() const
{
    return m_countHasBeenSet;
}

vector<DeleteSampleDetails> DeleteLibSamplesResponse::GetDetails() const
{
    return m_details;
}

bool DeleteLibSamplesResponse::DetailsHasBeenSet() const
{
