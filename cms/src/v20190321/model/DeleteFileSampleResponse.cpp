...
CoreInternalOutcome DeleteFileSampleResponse::Deserialize(const string &payload)
{
...
string DeleteFileSampleResponse::ToJsonString() const
{
...
uint64_t DeleteFileSampleResponse::GetProgress() const
{
    return m_progress;
}

bool DeleteFileSampleResponse::ProgressHasBeenSet() const
{
