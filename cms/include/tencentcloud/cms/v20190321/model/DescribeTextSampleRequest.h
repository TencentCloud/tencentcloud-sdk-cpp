...
#ifndef TENCENTCLOUD_CMS_V20190321_MODEL_DESCRIBETEXTSAMPLEREQUEST_H_
#define TENCENTCLOUD_CMS_V20190321_MODEL_DESCRIBETEXTSAMPLEREQUEST_H_
    ...
    namespace Cms
    {
        namespace V20190321
        {
            namespace Model
            {
                ...
                */
                class DescribeTextSampleRequest : public AbstractModel
                {
                public:
                    DescribeTextSampleRequest();
                    ~DescribeTextSampleRequest() = default;
...
#endif // !TENCENTCLOUD_CMS_V20190321_MODEL_DESCRIBETEXTSAMPLEREQUEST_H_
