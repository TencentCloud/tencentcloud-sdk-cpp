    ...
    namespace Cms
    {
        namespace V20190321
        {
            ...
            public:
                ...
                typedef Outcome<Core::Error, Model::CreateFileSampleResponse> CreateFileSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::CreateTextSampleResponse> CreateTextSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::DeleteFileSampleResponse> DeleteFileSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::DeleteTextSampleResponse> DeleteTextSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::DescribeFileSampleResponse> DescribeFileSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::DescribeTextSampleResponse> DescribeTextSampleOutcome;
                ...
                typedef Outcome<Core::Error, Model::ManualReviewResponse> ManualReviewOutcome;
