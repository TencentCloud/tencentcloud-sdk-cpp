...
CreateReportPdfResponse::CreateReportPdfResponse() :
    m_urlHasBeenSet(false)
{
}

CoreInternalOutcome CreateReportPdfResponse::Deserialize(const string &payload)
{
...
string CreateReportPdfResponse::ToJsonString() const
{
...
string CreateReportPdfResponse::GetUrl() const
{
    return m_url;
}

bool CreateReportPdfResponse::UrlHasBeenSet() const
{
