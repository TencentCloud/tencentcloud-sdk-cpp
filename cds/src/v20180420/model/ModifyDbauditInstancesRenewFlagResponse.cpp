...
CoreInternalOutcome ModifyDbauditInstancesRenewFlagResponse::Deserialize(const string &payload)
{
...
string ModifyDbauditInstancesRenewFlagResponse::ToJsonString() const
{
