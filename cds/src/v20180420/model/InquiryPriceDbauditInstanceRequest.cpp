...
string InquiryPriceDbauditInstanceRequest::ToJsonString() const
{
    ...
    if (m_instanceVersionHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_instanceVersion.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_inquiryTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_inquiryType.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_serviceRegionHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_serviceRegion.c_str(), allocator).Move(), allocator);
    }
