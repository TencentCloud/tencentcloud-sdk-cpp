...
string RotateProductSecretRequest::ToJsonString() const
{
...
string RotateProductSecretRequest::GetSecretName() const
{
    return m_secretName;
}

void RotateProductSecretRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool RotateProductSecretRequest::SecretNameHasBeenSet() const
{
