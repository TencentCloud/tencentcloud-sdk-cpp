...
CoreInternalOutcome RestoreSecretResponse::Deserialize(const string &payload)
{
...
string RestoreSecretResponse::ToJsonString() const
{
...
string RestoreSecretResponse::GetSecretName() const
{
    return m_secretName;
}

bool RestoreSecretResponse::SecretNameHasBeenSet() const
{
