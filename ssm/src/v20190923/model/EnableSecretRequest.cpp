...
string EnableSecretRequest::ToJsonString() const
{
...
string EnableSecretRequest::GetSecretName() const
{
    return m_secretName;
}

void EnableSecretRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool EnableSecretRequest::SecretNameHasBeenSet() const
{
