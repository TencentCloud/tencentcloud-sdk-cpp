...
CoreInternalOutcome UpdateSecretResponse::Deserialize(const string &payload)
{
...
string UpdateSecretResponse::ToJsonString() const
{
...
string UpdateSecretResponse::GetSecretName() const
{
    return m_secretName;
}

bool UpdateSecretResponse::SecretNameHasBeenSet() const
{
    return m_secretNameHasBeenSet;
}

string UpdateSecretResponse::GetVersionId() const
{
    return m_versionId;
}

bool UpdateSecretResponse::VersionIdHasBeenSet() const
{
