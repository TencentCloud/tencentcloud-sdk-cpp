...
CoreInternalOutcome EnableSecretResponse::Deserialize(const string &payload)
{
...
string EnableSecretResponse::ToJsonString() const
{
...
string EnableSecretResponse::GetSecretName() const
{
    return m_secretName;
}

bool EnableSecretResponse::SecretNameHasBeenSet() const
{
