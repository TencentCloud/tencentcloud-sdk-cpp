...
string ListSecretVersionIdsResponse::ToJsonString() const
{
...
string ListSecretVersionIdsResponse::GetSecretName() const
{
    return m_secretName;
}

bool ListSecretVersionIdsResponse::SecretNameHasBeenSet() const
{
    return m_secretNameHasBeenSet;
}

vector<VersionInfo> ListSecretVersionIdsResponse::GetVersions() const
{
    return m_versions;
}

bool ListSecretVersionIdsResponse::VersionsHasBeenSet() const
{
