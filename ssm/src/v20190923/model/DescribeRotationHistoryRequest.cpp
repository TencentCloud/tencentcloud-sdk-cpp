...
string DescribeRotationHistoryRequest::ToJsonString() const
{
...
string DescribeRotationHistoryRequest::GetSecretName() const
{
    return m_secretName;
}

void DescribeRotationHistoryRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool DescribeRotationHistoryRequest::SecretNameHasBeenSet() const
{
