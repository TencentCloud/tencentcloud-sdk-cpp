...
CoreInternalOutcome DescribeAsyncRequestInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TaskStatus") && !rsp["TaskStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TaskStatus` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
int64_t DescribeAsyncRequestInfoResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeAsyncRequestInfoResponse::TaskStatusHasBeenSet() const
{
    return m_taskStatusHasBeenSet;
}

string DescribeAsyncRequestInfoResponse::GetDescription() const
{
    return m_description;
}

bool DescribeAsyncRequestInfoResponse::DescriptionHasBeenSet() const
{
