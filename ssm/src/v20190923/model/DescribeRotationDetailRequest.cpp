...
string DescribeRotationDetailRequest::ToJsonString() const
{
...
string DescribeRotationDetailRequest::GetSecretName() const
{
    return m_secretName;
}

void DescribeRotationDetailRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool DescribeRotationDetailRequest::SecretNameHasBeenSet() const
{
