...
CoreInternalOutcome RotateProductSecretResponse::Deserialize(const string &payload)
{
...
string RotateProductSecretResponse::ToJsonString() const
{
...
int64_t RotateProductSecretResponse::GetFlowID() const
{
    return m_flowID;
}

bool RotateProductSecretResponse::FlowIDHasBeenSet() const
{
