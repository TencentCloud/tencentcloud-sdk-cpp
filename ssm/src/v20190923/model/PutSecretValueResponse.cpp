...
CoreInternalOutcome PutSecretValueResponse::Deserialize(const string &payload)
{
...
string PutSecretValueResponse::ToJsonString() const
{
...
string PutSecretValueResponse::GetSecretName() const
{
    return m_secretName;
}

bool PutSecretValueResponse::SecretNameHasBeenSet() const
{
    return m_secretNameHasBeenSet;
}

string PutSecretValueResponse::GetVersionId() const
{
    return m_versionId;
}

bool PutSecretValueResponse::VersionIdHasBeenSet() const
{
