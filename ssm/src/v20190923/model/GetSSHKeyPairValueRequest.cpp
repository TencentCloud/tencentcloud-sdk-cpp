...
string GetSSHKeyPairValueRequest::ToJsonString() const
{
...
string GetSSHKeyPairValueRequest::GetSecretName() const
{
    return m_secretName;
}

void GetSSHKeyPairValueRequest::SetSecretName(const string& _secretName)
{
