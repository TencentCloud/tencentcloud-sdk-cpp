...
string RestoreSecretRequest::ToJsonString() const
{
...
string RestoreSecretRequest::GetSecretName() const
{
    return m_secretName;
}

void RestoreSecretRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool RestoreSecretRequest::SecretNameHasBeenSet() const
{
