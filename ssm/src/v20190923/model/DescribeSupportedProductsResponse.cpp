...
CoreInternalOutcome DescribeSupportedProductsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Products") && !rsp["Products"].IsNull())
    {
        if (!rsp["Products"].IsArray())
            return CoreInternalOutcome(Error("response `Products` is not array type"));
...
string DescribeSupportedProductsResponse::ToJsonString() const
{
...
vector<string> DescribeSupportedProductsResponse::GetProducts() const
{
    return m_products;
}

bool DescribeSupportedProductsResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

int64_t DescribeSupportedProductsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSupportedProductsResponse::TotalCountHasBeenSet() const
{
