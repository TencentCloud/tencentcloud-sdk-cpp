...
string ListSecretVersionIdsRequest::ToJsonString() const
{
...
string ListSecretVersionIdsRequest::GetSecretName() const
{
    return m_secretName;
}

void ListSecretVersionIdsRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool ListSecretVersionIdsRequest::SecretNameHasBeenSet() const
{
