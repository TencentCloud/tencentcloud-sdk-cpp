...
string DisableSecretRequest::ToJsonString() const
{
...
string DisableSecretRequest::GetSecretName() const
{
    return m_secretName;
}

void DisableSecretRequest::SetSecretName(const string& _secretName)
{
    m_secretName = _secretName;
    m_secretNameHasBeenSet = true;
}

bool DisableSecretRequest::SecretNameHasBeenSet() const
{
