...
CoreInternalOutcome UpdateDescriptionResponse::Deserialize(const string &payload)
{
...
string UpdateDescriptionResponse::ToJsonString() const
{
...
string UpdateDescriptionResponse::GetSecretName() const
{
    return m_secretName;
}

bool UpdateDescriptionResponse::SecretNameHasBeenSet() const
{
