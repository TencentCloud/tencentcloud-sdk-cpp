...
CoreInternalOutcome CreateCodeBatchResponse::Deserialize(const string &payload)
{
...
string CreateCodeBatchResponse::ToJsonString() const
{
...
string CreateCodeBatchResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateCodeBatchResponse::BatchIdHasBeenSet() const
{
