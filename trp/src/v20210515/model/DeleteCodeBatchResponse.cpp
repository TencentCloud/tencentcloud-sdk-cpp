...
CoreInternalOutcome DeleteCodeBatchResponse::Deserialize(const string &payload)
{
...
string DeleteCodeBatchResponse::ToJsonString() const
{
...
string DeleteCodeBatchResponse::GetBatchId() const
{
    return m_batchId;
}

bool DeleteCodeBatchResponse::BatchIdHasBeenSet() const
{
