...
CoreInternalOutcome DescribeTmpTokenResponse::Deserialize(const string &payload)
{
...
string DescribeTmpTokenResponse::ToJsonString() const
{
...
string DescribeTmpTokenResponse::GetToken() const
{
    return m_token;
}

bool DescribeTmpTokenResponse::TokenHasBeenSet() const
{
