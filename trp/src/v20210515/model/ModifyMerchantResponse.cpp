...
CoreInternalOutcome ModifyMerchantResponse::Deserialize(const string &payload)
{
...
string ModifyMerchantResponse::ToJsonString() const
{
...
string ModifyMerchantResponse::GetMerchantId() const
{
    return m_merchantId;
}

bool ModifyMerchantResponse::MerchantIdHasBeenSet() const
{
