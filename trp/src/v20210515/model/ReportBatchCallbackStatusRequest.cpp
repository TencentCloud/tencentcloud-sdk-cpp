...
ReportBatchCallbackStatusRequest::ReportBatchCallbackStatusRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string ReportBatchCallbackStatusRequest::ToJsonString() const
{
...
InputEncryptData ReportBatchCallbackStatusRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void ReportBatchCallbackStatusRequest::SetBusinessSecurityData(const InputEncryptData& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool ReportBatchCallbackStatusRequest::BusinessSecurityDataHasBeenSet() const
{
