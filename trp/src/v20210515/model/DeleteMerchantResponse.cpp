...
CoreInternalOutcome DeleteMerchantResponse::Deserialize(const string &payload)
{
...
string DeleteMerchantResponse::ToJsonString() const
{
...
string DeleteMerchantResponse::GetMerchantId() const
{
    return m_merchantId;
}

bool DeleteMerchantResponse::MerchantIdHasBeenSet() const
{
