...
DescribeRawScanLogsResponse::DescribeRawScanLogsResponse() :
    m_scanLogsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeRawScanLogsResponse::Deserialize(const string &payload)
{
...
string DescribeRawScanLogsResponse::ToJsonString() const
{
...
vector<RawScanLog> DescribeRawScanLogsResponse::GetScanLogs() const
{
    return m_scanLogs;
}

bool DescribeRawScanLogsResponse::ScanLogsHasBeenSet() const
{
