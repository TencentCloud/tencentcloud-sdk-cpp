...
CoreInternalOutcome DeleteProductResponse::Deserialize(const string &payload)
{
...
string DeleteProductResponse::ToJsonString() const
{
...
string DeleteProductResponse::GetProductId() const
{
    return m_productId;
}

bool DeleteProductResponse::ProductIdHasBeenSet() const
{
