...
uint64_t DeleteProductRequest::GetCorpId() const
{
    return m_corpId;
}

void DeleteProductRequest::SetCorpId(const uint64_t& _corpId)
{
    m_corpId = _corpId;
    m_corpIdHasBeenSet = true;
}

bool DeleteProductRequest::CorpIdHasBeenSet() const
{
