...
CoreInternalOutcome ModifyTraceDataRanksResponse::Deserialize(const string &payload)
{
...
string ModifyTraceDataRanksResponse::ToJsonString() const
{
...
string ModifyTraceDataRanksResponse::GetBatchId() const
{
    return m_batchId;
}

bool ModifyTraceDataRanksResponse::BatchIdHasBeenSet() const
{
