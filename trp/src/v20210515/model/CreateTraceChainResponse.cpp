...
CoreInternalOutcome CreateTraceChainResponse::Deserialize(const string &payload)
{
...
string CreateTraceChainResponse::ToJsonString() const
{
...
string CreateTraceChainResponse::GetTraceId() const
{
    return m_traceId;
}

bool CreateTraceChainResponse::TraceIdHasBeenSet() const
{
