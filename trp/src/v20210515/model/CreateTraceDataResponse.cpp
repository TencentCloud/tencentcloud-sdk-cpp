...
CoreInternalOutcome CreateTraceDataResponse::Deserialize(const string &payload)
{
...
string CreateTraceDataResponse::ToJsonString() const
{
...
string CreateTraceDataResponse::GetTraceId() const
{
    return m_traceId;
}

bool CreateTraceDataResponse::TraceIdHasBeenSet() const
{
