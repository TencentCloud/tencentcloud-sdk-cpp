...
CoreInternalOutcome ModifyTraceDataResponse::Deserialize(const string &payload)
{
...
string ModifyTraceDataResponse::ToJsonString() const
{
...
string ModifyTraceDataResponse::GetTraceId() const
{
    return m_traceId;
}

bool ModifyTraceDataResponse::TraceIdHasBeenSet() const
{
