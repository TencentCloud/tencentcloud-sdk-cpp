...
CoreInternalOutcome ModifyCodeBatchResponse::Deserialize(const string &payload)
{
...
string ModifyCodeBatchResponse::ToJsonString() const
{
...
string ModifyCodeBatchResponse::GetBatchId() const
{
    return m_batchId;
}

bool ModifyCodeBatchResponse::BatchIdHasBeenSet() const
{
