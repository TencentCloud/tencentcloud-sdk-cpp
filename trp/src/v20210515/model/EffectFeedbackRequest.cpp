...
EffectFeedbackRequest::EffectFeedbackRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string EffectFeedbackRequest::ToJsonString() const
{
...
InputEncryptData EffectFeedbackRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void EffectFeedbackRequest::SetBusinessSecurityData(const InputEncryptData& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool EffectFeedbackRequest::BusinessSecurityDataHasBeenSet() const
{
