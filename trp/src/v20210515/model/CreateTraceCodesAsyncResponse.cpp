...
CoreInternalOutcome CreateTraceCodesAsyncResponse::Deserialize(const string &payload)
{
...
string CreateTraceCodesAsyncResponse::ToJsonString() const
{
...
string CreateTraceCodesAsyncResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateTraceCodesAsyncResponse::BatchIdHasBeenSet() const
{
