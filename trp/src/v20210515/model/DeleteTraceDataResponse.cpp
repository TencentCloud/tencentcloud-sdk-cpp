...
CoreInternalOutcome DeleteTraceDataResponse::Deserialize(const string &payload)
{
...
string DeleteTraceDataResponse::ToJsonString() const
{
...
string DeleteTraceDataResponse::GetTraceId() const
{
    return m_traceId;
}

bool DeleteTraceDataResponse::TraceIdHasBeenSet() const
{
