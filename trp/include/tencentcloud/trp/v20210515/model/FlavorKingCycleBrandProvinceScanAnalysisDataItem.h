...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDPROVINCESCANANALYSISDATAITEM_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDPROVINCESCANANALYSISDATAITEM_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                * 品牌扫码数据
                */
                class FlavorKingCycleBrandProvinceScanAnalysisDataItem : public AbstractModel
                {
                public:
                    FlavorKingCycleBrandProvinceScanAnalysisDataItem();
                    ~FlavorKingCycleBrandProvinceScanAnalysisDataItem() = default;
                     ...
                     * 
                     */
                    double GetOtherLastCycleMarketShare() const;
                     ...
                     * 
                     */
                    void SetOtherLastCycleMarketShare(const double& _otherLastCycleMarketShare);

                    /**
                     * 判断参数 OtherLastCycleMarketShare 是否已赋值
                     * @return OtherLastCycleMarketShare 是否已赋值
                     * 
                     */
                    bool OtherLastCycleMarketShareHasBeenSet() const;
                ...
                private:
                     ...
                     * <p>上周期其他品牌市场份额</p>
                     */
                    double m_otherLastCycleMarketShare;
                    bool m_otherLastCycleMarketShareHasBeenSet;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDPROVINCESCANANALYSISDATAITEM_H_
