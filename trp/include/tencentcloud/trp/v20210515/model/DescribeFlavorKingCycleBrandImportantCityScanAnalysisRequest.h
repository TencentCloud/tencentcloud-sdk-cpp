...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREQUEST_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREQUEST_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                */
                class DescribeFlavorKingCycleBrandImportantCityScanAnalysisRequest : public AbstractModel
                {
                public:
                    DescribeFlavorKingCycleBrandImportantCityScanAnalysisRequest();
                    ~DescribeFlavorKingCycleBrandImportantCityScanAnalysisRequest() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREQUEST_H_
