...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBECODEBATCHESREQUEST_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBECODEBATCHESREQUEST_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                */
                class DescribeCodeBatchesRequest : public AbstractModel
                {
                public:
                    DescribeCodeBatchesRequest();
                    ~DescribeCodeBatchesRequest() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBECODEBATCHESREQUEST_H_
