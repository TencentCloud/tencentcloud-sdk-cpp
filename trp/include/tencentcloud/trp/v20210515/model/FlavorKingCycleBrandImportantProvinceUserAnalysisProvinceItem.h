...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCEUSERANALYSISPROVINCEITEM_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCEUSERANALYSISPROVINCEITEM_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                * 品牌扫码数据
                */
                class FlavorKingCycleBrandImportantProvinceUserAnalysisProvinceItem : public AbstractModel
                {
                public:
                    FlavorKingCycleBrandImportantProvinceUserAnalysisProvinceItem();
                    ~FlavorKingCycleBrandImportantProvinceUserAnalysisProvinceItem() = default;
                     ...
                     * 
                     */
                    std::vector<FlavorKingCycleBrandImportantProvinceUserAnalysisCityItem> GetCities() const;
                     ...
                     * 
                     */
                    void SetCities(const std::vector<FlavorKingCycleBrandImportantProvinceUserAnalysisCityItem>& _cities);
                ...
                private:
                     ...
                     * <p>下属城市明细</p>
                     */
                    std::vector<FlavorKingCycleBrandImportantProvinceUserAnalysisCityItem> m_cities;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCEUSERANALYSISPROVINCEITEM_H_
