...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCESCANANALYSISCITYITEM_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCESCANANALYSISCITYITEM_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                * 品牌扫码数据
                */
                class FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem : public AbstractModel
                {
                public:
                    FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem();
                    ~FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTPROVINCESCANANALYSISCITYITEM_H_
