...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_EFFECTFEEDBACKREQUEST_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_EFFECTFEEDBACKREQUEST_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                */
                class EffectFeedbackRequest : public AbstractModel
                {
                public:
                    EffectFeedbackRequest();
                    ~EffectFeedbackRequest() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_EFFECTFEEDBACKREQUEST_H_
