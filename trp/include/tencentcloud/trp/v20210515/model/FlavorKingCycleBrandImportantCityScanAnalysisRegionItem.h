...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREGIONITEM_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREGIONITEM_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                * 品牌扫码数据
                */
                class FlavorKingCycleBrandImportantCityScanAnalysisRegionItem : public AbstractModel
                {
                public:
                    FlavorKingCycleBrandImportantCityScanAnalysisRegionItem();
                    ~FlavorKingCycleBrandImportantCityScanAnalysisRegionItem() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_FLAVORKINGCYCLEBRANDIMPORTANTCITYSCANANALYSISREGIONITEM_H_
