...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDSCANANALYSISREQUEST_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDSCANANALYSISREQUEST_H_
    ...
    namespace Trp
    {
        namespace V20210515
        {
            namespace Model
            {
                ...
                */
                class DescribeFlavorKingCycleBrandScanAnalysisRequest : public AbstractModel
                {
                public:
                    DescribeFlavorKingCycleBrandScanAnalysisRequest();
                    ~DescribeFlavorKingCycleBrandScanAnalysisRequest() = default;
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_DESCRIBEFLAVORKINGCYCLEBRANDSCANANALYSISREQUEST_H_
