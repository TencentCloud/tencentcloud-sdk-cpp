...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERROUTECONFIGREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERROUTECONFIGREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DeleteConsumerRouteConfigRequest : public AbstractModel
                {
                public:
                    DeleteConsumerRouteConfigRequest();
                    ~DeleteConsumerRouteConfigRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERROUTECONFIGREQUEST_H_
