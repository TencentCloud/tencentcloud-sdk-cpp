...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DeleteConsumerLabelRequest : public AbstractModel
                {
                public:
                    DeleteConsumerLabelRequest();
                    ~DeleteConsumerLabelRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELREQUEST_H_
