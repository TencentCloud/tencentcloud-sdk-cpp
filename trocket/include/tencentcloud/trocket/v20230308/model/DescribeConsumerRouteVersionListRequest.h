...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTEVERSIONLISTREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTEVERSIONLISTREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeConsumerRouteVersionListRequest : public AbstractModel
                {
                public:
                    DescribeConsumerRouteVersionListRequest();
                    ~DescribeConsumerRouteVersionListRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTEVERSIONLISTREQUEST_H_
