...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class CreateConsumerLabelRequest : public AbstractModel
                {
                public:
                    CreateConsumerLabelRequest();
                    ~CreateConsumerLabelRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELREQUEST_H_
