...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_VERIFYMESSAGECONSUMPTIONREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_VERIFYMESSAGECONSUMPTIONREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class VerifyMessageConsumptionRequest : public AbstractModel
                {
                public:
                    VerifyMessageConsumptionRequest();
                    ~VerifyMessageConsumptionRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_VERIFYMESSAGECONSUMPTIONREQUEST_H_
