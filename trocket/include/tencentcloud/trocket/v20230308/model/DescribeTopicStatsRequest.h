...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBETOPICSTATSREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBETOPICSTATSREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeTopicStatsRequest : public AbstractModel
                {
                public:
                    DescribeTopicStatsRequest();
                    ~DescribeTopicStatsRequest() = default;
                    ...
                    /**
                     * 获取<p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
                     * @return GroupId <p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
                     * 
                     */
                    std::string GetGroupId() const;

                    /**
                     * 设置<p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBETOPICSTATSREQUEST_H_
