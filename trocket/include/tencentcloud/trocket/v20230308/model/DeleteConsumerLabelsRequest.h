...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELSREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELSREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DeleteConsumerLabelsRequest : public AbstractModel
                {
                public:
                    DeleteConsumerLabelsRequest();
                    ~DeleteConsumerLabelsRequest() = default;
                    ...
                    /**
                     * 获取<p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
                     * @return Labels <p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
                     * 
                     */
                    std::vector<ConsumerLabelKey> GetLabels() const;

                    /**
                     * 设置<p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
                ...
                private:
                    ...
                    /**
                     * <p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
                     */
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DELETECONSUMERLABELSREQUEST_H_
