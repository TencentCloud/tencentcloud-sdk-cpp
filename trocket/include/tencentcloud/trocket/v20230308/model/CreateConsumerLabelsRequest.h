...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELSREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELSREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class CreateConsumerLabelsRequest : public AbstractModel
                {
                public:
                    CreateConsumerLabelsRequest();
                    ~CreateConsumerLabelsRequest() = default;
                    ...
                    /**
                     * 获取<p>消费组标签列表</p><p>入参限制：批量上限为 32 条</p>
                     * @return Labels <p>消费组标签列表</p><p>入参限制：批量上限为 32 条</p>
                     * 
                     */
                    std::vector<ConsumerLabelKey> GetLabels() const;

                    /**
                     * 设置<p>消费组标签列表</p><p>入参限制：批量上限为 32 条</p>
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_CREATECONSUMERLABELSREQUEST_H_
