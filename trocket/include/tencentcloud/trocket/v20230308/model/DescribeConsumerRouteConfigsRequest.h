...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGSREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGSREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeConsumerRouteConfigsRequest : public AbstractModel
                {
                public:
                    DescribeConsumerRouteConfigsRequest();
                    ~DescribeConsumerRouteConfigsRequest() = default;
                    ...
                    /**
                     * 获取<p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
                     * @return Configs <p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
                     * 
                     */
                    std::vector<ConsumerRouteKey> GetConfigs() const;

                    /**
                     * 设置<p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
                     * @param _configs <p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
                     * 
                     */
                    void SetConfigs(const std::vector<ConsumerRouteKey>& _configs);
                ...
                private:
                     ...
                     */
                    std::vector<ConsumerRouteKey> m_configs;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGSREQUEST_H_
