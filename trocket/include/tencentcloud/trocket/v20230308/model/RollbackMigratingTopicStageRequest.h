...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_ROLLBACKMIGRATINGTOPICSTAGEREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_ROLLBACKMIGRATINGTOPICSTAGEREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class RollbackMigratingTopicStageRequest : public AbstractModel
                {
                public:
                    RollbackMigratingTopicStageRequest();
                    ~RollbackMigratingTopicStageRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_ROLLBACKMIGRATINGTOPICSTAGEREQUEST_H_
