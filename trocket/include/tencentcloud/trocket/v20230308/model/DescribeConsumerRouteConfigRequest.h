...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeConsumerRouteConfigRequest : public AbstractModel
                {
                public:
                    DescribeConsumerRouteConfigRequest();
                    ~DescribeConsumerRouteConfigRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERROUTECONFIGREQUEST_H_
