...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEPRODUCERLISTREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEPRODUCERLISTREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeProducerListRequest : public AbstractModel
                {
                public:
                    DescribeProducerListRequest();
                    ~DescribeProducerListRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEPRODUCERLISTREQUEST_H_
