...
DescribeConsumerLabelResponse::DescribeConsumerLabelResponse() :
    m_labelHasBeenSet(false)
{
}

CoreInternalOutcome DescribeConsumerLabelResponse::Deserialize(const string &payload)
{
...
string DescribeConsumerLabelResponse::ToJsonString() const
{
...
ConsumerLabel DescribeConsumerLabelResponse::GetLabel() const
{
    return m_label;
}

bool DescribeConsumerLabelResponse::LabelHasBeenSet() const
{
