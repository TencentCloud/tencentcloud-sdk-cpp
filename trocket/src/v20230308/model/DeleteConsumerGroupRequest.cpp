...
string DeleteConsumerGroupRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DeleteConsumerGroupRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DeleteConsumerGroupRequest::InstanceIdHasBeenSet() const
{
