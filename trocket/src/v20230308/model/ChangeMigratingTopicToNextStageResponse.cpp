...
CoreInternalOutcome ChangeMigratingTopicToNextStageResponse::Deserialize(const string &payload)
{
...
string ChangeMigratingTopicToNextStageResponse::ToJsonString() const
{
...
vector<TopicStageChangeResult> ChangeMigratingTopicToNextStageResponse::GetResults() const
{
    return m_results;
}

bool ChangeMigratingTopicToNextStageResponse::ResultsHasBeenSet() const
{
