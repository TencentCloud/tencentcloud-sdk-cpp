...
DescribeMQTTProductSKUListResponse::DescribeMQTTProductSKUListResponse() :
    m_totalCountHasBeenSet(false),
    m_mQTTProductSkuListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeMQTTProductSKUListResponse::Deserialize(const string &payload)
{
...
string DescribeMQTTProductSKUListResponse::ToJsonString() const
{
...
int64_t DescribeMQTTProductSKUListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMQTTProductSKUListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MQTTProductSkuItem> DescribeMQTTProductSKUListResponse::GetMQTTProductSkuList() const
{
    return m_mQTTProductSkuList;
}

bool DescribeMQTTProductSKUListResponse::MQTTProductSkuListHasBeenSet() const
{
