...
CoreInternalOutcome CreateRoleResponse::Deserialize(const string &payload)
{
...
string CreateRoleResponse::ToJsonString() const
{
...
string CreateRoleResponse::GetRole() const
{
    return m_role;
}

bool CreateRoleResponse::RoleHasBeenSet() const
{
