...
CoreInternalOutcome CreateConsumerGroupResponse::Deserialize(const string &payload)
{
...
string CreateConsumerGroupResponse::ToJsonString() const
{
...
string CreateConsumerGroupResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateConsumerGroupResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateConsumerGroupResponse::GetConsumerGroup() const
{
    return m_consumerGroup;
}

bool CreateConsumerGroupResponse::ConsumerGroupHasBeenSet() const
{
