...
string DescribeMigratingTopicListRequest::ToJsonString() const
{
...
void DescribeMigratingTopicListRequest::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
    m_taskIdHasBeenSet = true;
}

bool DescribeMigratingTopicListRequest::TaskIdHasBeenSet() const
{
