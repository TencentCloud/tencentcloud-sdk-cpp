...
string DescribeSourceClusterGroupListRequest::ToJsonString() const
{
...
void DescribeSourceClusterGroupListRequest::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
    m_taskIdHasBeenSet = true;
}

bool DescribeSourceClusterGroupListRequest::TaskIdHasBeenSet() const
{
