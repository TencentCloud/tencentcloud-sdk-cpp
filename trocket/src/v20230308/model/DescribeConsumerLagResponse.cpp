...
CoreInternalOutcome DescribeConsumerLagResponse::Deserialize(const string &payload)
{
...
string DescribeConsumerLagResponse::ToJsonString() const
{
...
int64_t DescribeConsumerLagResponse::GetConsumerLag() const
{
    return m_consumerLag;
}

bool DescribeConsumerLagResponse::ConsumerLagHasBeenSet() const
{
