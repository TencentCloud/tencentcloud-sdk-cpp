...
string DescribeConsumerGroupRequest::GetConsumerGroup() const
{
    return m_consumerGroup;
}

void DescribeConsumerGroupRequest::SetConsumerGroup(const string& _consumerGroup)
{
    m_consumerGroup = _consumerGroup;
    m_consumerGroupHasBeenSet = true;
}

bool DescribeConsumerGroupRequest::ConsumerGroupHasBeenSet() const
{
