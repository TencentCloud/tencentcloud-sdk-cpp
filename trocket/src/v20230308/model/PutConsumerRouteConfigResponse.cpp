...
PutConsumerRouteConfigResponse::PutConsumerRouteConfigResponse() :
...
CoreInternalOutcome PutConsumerRouteConfigResponse::Deserialize(const string &payload)
{
...
string PutConsumerRouteConfigResponse::ToJsonString() const
{
...
string PutConsumerRouteConfigResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool PutConsumerRouteConfigResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string PutConsumerRouteConfigResponse::GetTopic() const
{
    return m_topic;
}

bool PutConsumerRouteConfigResponse::TopicHasBeenSet() const
{
    return m_topicHasBeenSet;
}

string PutConsumerRouteConfigResponse::GetGroup() const
{
    return m_group;
}

bool PutConsumerRouteConfigResponse::GroupHasBeenSet() const
{
    return m_groupHasBeenSet;
}

int64_t PutConsumerRouteConfigResponse::GetVersion() const
{
    return m_version;
}

bool PutConsumerRouteConfigResponse::VersionHasBeenSet() const
{
