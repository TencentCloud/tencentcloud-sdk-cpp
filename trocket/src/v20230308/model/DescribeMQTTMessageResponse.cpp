...
DescribeMQTTMessageResponse::DescribeMQTTMessageResponse() :
...
CoreInternalOutcome DescribeMQTTMessageResponse::Deserialize(const string &payload)
{
...
string DescribeMQTTMessageResponse::ToJsonString() const
{
...
string DescribeMQTTMessageResponse::GetBody() const
{
    return m_body;
}

bool DescribeMQTTMessageResponse::BodyHasBeenSet() const
{
    return m_bodyHasBeenSet;
}

vector<CustomMapEntry> DescribeMQTTMessageResponse::GetProperties() const
{
    return m_properties;
}

bool DescribeMQTTMessageResponse::PropertiesHasBeenSet() const
{
    return m_propertiesHasBeenSet;
}

string DescribeMQTTMessageResponse::GetProduceTime() const
{
    return m_produceTime;
}

bool DescribeMQTTMessageResponse::ProduceTimeHasBeenSet() const
{
    return m_produceTimeHasBeenSet;
}

string DescribeMQTTMessageResponse::GetMessageId() const
{
    return m_messageId;
}

bool DescribeMQTTMessageResponse::MessageIdHasBeenSet() const
{
    return m_messageIdHasBeenSet;
}

string DescribeMQTTMessageResponse::GetProducerAddr() const
{
    return m_producerAddr;
}

bool DescribeMQTTMessageResponse::ProducerAddrHasBeenSet() const
{
    return m_producerAddrHasBeenSet;
}

string DescribeMQTTMessageResponse::GetShowTopicName() const
{
    return m_showTopicName;
}

bool DescribeMQTTMessageResponse::ShowTopicNameHasBeenSet() const
{
