...
string DescribeRoleListRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeRoleListRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DescribeRoleListRequest::InstanceIdHasBeenSet() const
{
