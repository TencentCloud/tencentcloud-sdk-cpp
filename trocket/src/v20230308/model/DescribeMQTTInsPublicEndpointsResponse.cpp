...
DescribeMQTTInsPublicEndpointsResponse::DescribeMQTTInsPublicEndpointsResponse() :
...
CoreInternalOutcome DescribeMQTTInsPublicEndpointsResponse::Deserialize(const string &payload)
{
...
string DescribeMQTTInsPublicEndpointsResponse::ToJsonString() const
{
...
vector<MQTTEndpointItem> DescribeMQTTInsPublicEndpointsResponse::GetEndpoints() const
{
    return m_endpoints;
}

bool DescribeMQTTInsPublicEndpointsResponse::EndpointsHasBeenSet() const
{
    return m_endpointsHasBeenSet;
}

string DescribeMQTTInsPublicEndpointsResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DescribeMQTTInsPublicEndpointsResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

int64_t DescribeMQTTInsPublicEndpointsResponse::GetBandwidth() const
{
    return m_bandwidth;
}

bool DescribeMQTTInsPublicEndpointsResponse::BandwidthHasBeenSet() const
{
    return m_bandwidthHasBeenSet;
}

vector<PublicAccessRule> DescribeMQTTInsPublicEndpointsResponse::GetRules() const
{
    return m_rules;
}
