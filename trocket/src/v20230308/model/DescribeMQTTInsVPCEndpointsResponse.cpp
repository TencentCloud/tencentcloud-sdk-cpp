...
DescribeMQTTInsVPCEndpointsResponse::DescribeMQTTInsVPCEndpointsResponse() :
    m_endpointsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeMQTTInsVPCEndpointsResponse::Deserialize(const string &payload)
{
...
string DescribeMQTTInsVPCEndpointsResponse::ToJsonString() const
{
...
vector<MQTTEndpointItem> DescribeMQTTInsVPCEndpointsResponse::GetEndpoints() const
{
    return m_endpoints;
}

bool DescribeMQTTInsVPCEndpointsResponse::EndpointsHasBeenSet() const
{
