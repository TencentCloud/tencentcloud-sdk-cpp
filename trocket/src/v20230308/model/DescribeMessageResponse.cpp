...
CoreInternalOutcome DescribeMessageResponse::Deserialize(const string &payload)
{
...
string DescribeMessageResponse::ToJsonString() const
{
...
string DescribeMessageResponse::GetBody() const
{
    return m_body;
}

bool DescribeMessageResponse::BodyHasBeenSet() const
{
    return m_bodyHasBeenSet;
}

string DescribeMessageResponse::GetProperties() const
{
    return m_properties;
}

bool DescribeMessageResponse::PropertiesHasBeenSet() const
{
    return m_propertiesHasBeenSet;
}

string DescribeMessageResponse::GetProduceTime() const
{
    return m_produceTime;
}

bool DescribeMessageResponse::ProduceTimeHasBeenSet() const
{
    return m_produceTimeHasBeenSet;
}

string DescribeMessageResponse::GetMessageId() const
{
    return m_messageId;
}

bool DescribeMessageResponse::MessageIdHasBeenSet() const
{
    return m_messageIdHasBeenSet;
}

string DescribeMessageResponse::GetProducerAddr() const
{
    return m_producerAddr;
}

bool DescribeMessageResponse::ProducerAddrHasBeenSet() const
{
    return m_producerAddrHasBeenSet;
}

vector<MessageTrackItem> DescribeMessageResponse::GetMessageTracks() const
{
    return m_messageTracks;
}

bool DescribeMessageResponse::MessageTracksHasBeenSet() const
{
    return m_messageTracksHasBeenSet;
}

string DescribeMessageResponse::GetShowTopicName() const
{
