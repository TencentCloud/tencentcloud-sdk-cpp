...
string DescribeSmoothMigrationTaskListRequest::ToJsonString() const
{
...
void DescribeSmoothMigrationTaskListRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
...
void DescribeSmoothMigrationTaskListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeSmoothMigrationTaskListRequest::FiltersHasBeenSet() const
{
