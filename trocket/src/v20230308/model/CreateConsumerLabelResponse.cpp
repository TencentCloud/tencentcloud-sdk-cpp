...
CreateConsumerLabelResponse::CreateConsumerLabelResponse() :
...
CoreInternalOutcome CreateConsumerLabelResponse::Deserialize(const string &payload)
{
...
string CreateConsumerLabelResponse::ToJsonString() const
{
...
string CreateConsumerLabelResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateConsumerLabelResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateConsumerLabelResponse::GetGroup() const
{
    return m_group;
}

bool CreateConsumerLabelResponse::GroupHasBeenSet() const
{
    return m_groupHasBeenSet;
}

string CreateConsumerLabelResponse::GetLabel() const
{
    return m_label;
}

bool CreateConsumerLabelResponse::LabelHasBeenSet() const
{
