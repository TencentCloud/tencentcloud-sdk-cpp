...
string AuthTestTidRequest::ToJsonString() const
{
...
string AuthTestTidRequest::GetData() const
{
    return m_data;
}

void AuthTestTidRequest::SetData(const string& _data)
{
    m_data = _data;
    m_dataHasBeenSet = true;
}

bool AuthTestTidRequest::DataHasBeenSet() const
{
