...
CoreInternalOutcome BurnTidNotifyResponse::Deserialize(const string &payload)
{
...
string BurnTidNotifyResponse::ToJsonString() const
{
...
string BurnTidNotifyResponse::GetTid() const
{
    return m_tid;
}

bool BurnTidNotifyResponse::TidHasBeenSet() const
{
