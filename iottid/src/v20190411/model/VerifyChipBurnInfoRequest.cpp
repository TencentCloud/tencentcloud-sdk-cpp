...
string VerifyChipBurnInfoRequest::ToJsonString() const
{
...
string VerifyChipBurnInfoRequest::GetData() const
{
    return m_data;
}

void VerifyChipBurnInfoRequest::SetData(const string& _data)
{
    m_data = _data;
    m_dataHasBeenSet = true;
}

bool VerifyChipBurnInfoRequest::DataHasBeenSet() const
{
