...
CoreInternalOutcome AuthTestTidResponse::Deserialize(const string &payload)
{
...
string AuthTestTidResponse::ToJsonString() const
{
...
bool AuthTestTidResponse::GetPass() const
{
    return m_pass;
}

bool AuthTestTidResponse::PassHasBeenSet() const
{
