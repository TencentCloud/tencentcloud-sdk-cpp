...
string DescribeAvailableLibCountRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string DescribeAvailableLibCountRequest::GetOrderId() const
{
    return m_orderId;
}

void DescribeAvailableLibCountRequest::SetOrderId(const string& _orderId)
{
    m_orderId = _orderId;
    m_orderIdHasBeenSet = true;
}

bool DescribeAvailableLibCountRequest::OrderIdHasBeenSet() const
{
