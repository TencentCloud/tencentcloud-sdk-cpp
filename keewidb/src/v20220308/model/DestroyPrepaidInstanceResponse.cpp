...
CoreInternalOutcome DestroyPrepaidInstanceResponse::Deserialize(const string &payload)
{
...
string DestroyPrepaidInstanceResponse::ToJsonString() const
{
...
string DestroyPrepaidInstanceResponse::GetDealId() const
{
    return m_dealId;
}
