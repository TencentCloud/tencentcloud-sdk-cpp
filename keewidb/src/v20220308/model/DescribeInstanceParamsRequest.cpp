...
string DescribeInstanceParamsRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeInstanceParamsRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DescribeInstanceParamsRequest::InstanceIdHasBeenSet() const
{
