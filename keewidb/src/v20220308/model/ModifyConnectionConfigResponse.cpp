...
CoreInternalOutcome ModifyConnectionConfigResponse::Deserialize(const string &payload)
{
...
string ModifyConnectionConfigResponse::ToJsonString() const
{
...
int64_t ModifyConnectionConfigResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyConnectionConfigResponse::TaskIdHasBeenSet() const
{
