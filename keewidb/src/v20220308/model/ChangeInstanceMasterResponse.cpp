...
CoreInternalOutcome ChangeInstanceMasterResponse::Deserialize(const string &payload)
{
...
string ChangeInstanceMasterResponse::ToJsonString() const
{
...
int64_t ChangeInstanceMasterResponse::GetTaskId() const
{
    return m_taskId;
}

bool ChangeInstanceMasterResponse::TaskIdHasBeenSet() const
{
