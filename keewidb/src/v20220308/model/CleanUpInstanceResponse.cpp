...
CoreInternalOutcome CleanUpInstanceResponse::Deserialize(const string &payload)
{
...
string CleanUpInstanceResponse::ToJsonString() const
{
...
int64_t CleanUpInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool CleanUpInstanceResponse::TaskIdHasBeenSet() const
{
