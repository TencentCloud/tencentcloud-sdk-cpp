...
CoreInternalOutcome CreateBackupManuallyResponse::Deserialize(const string &payload)
{
...
string CreateBackupManuallyResponse::ToJsonString() const
{
...
int64_t CreateBackupManuallyResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateBackupManuallyResponse::TaskIdHasBeenSet() const
{
