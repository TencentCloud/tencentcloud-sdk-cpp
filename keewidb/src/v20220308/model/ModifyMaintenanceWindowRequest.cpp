...
string ModifyMaintenanceWindowRequest::GetEndTime() const
{
    return m_endTime;
}

void ModifyMaintenanceWindowRequest::SetEndTime(const string& _endTime)
{
    m_endTime = _endTime;
    m_endTimeHasBeenSet = true;
}

bool ModifyMaintenanceWindowRequest::EndTimeHasBeenSet() const
{
