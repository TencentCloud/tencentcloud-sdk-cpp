...
#ifndef TENCENTCLOUD_KEEWIDB_V20220308_MODEL_DESCRIBEINSTANCEBINLOGSREQUEST_H_
#define TENCENTCLOUD_KEEWIDB_V20220308_MODEL_DESCRIBEINSTANCEBINLOGSREQUEST_H_
    ...
    namespace Keewidb
    {
        namespace V20220308
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceBinlogsRequest : public AbstractModel
                {
                public:
                    DescribeInstanceBinlogsRequest();
                    ~DescribeInstanceBinlogsRequest() = default;
...
#endif // !TENCENTCLOUD_KEEWIDB_V20220308_MODEL_DESCRIBEINSTANCEBINLOGSREQUEST_H_
