...
CoreInternalOutcome DescribeMediaResponse::Deserialize(const string &payload)
{
...
string DescribeMediaResponse::ToJsonString() const
{
...
MediaInfo DescribeMediaResponse::GetMediaInfo() const
{
    return m_mediaInfo;
}

bool DescribeMediaResponse::MediaInfoHasBeenSet() const
{
