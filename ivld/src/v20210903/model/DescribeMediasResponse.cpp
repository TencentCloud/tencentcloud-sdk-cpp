...
CoreInternalOutcome DescribeMediasResponse::Deserialize(const string &payload)
{
...
string DescribeMediasResponse::ToJsonString() const
{
...
int64_t DescribeMediasResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMediasResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MediaInfo> DescribeMediasResponse::GetMediaInfoSet() const
{
    return m_mediaInfoSet;
}

bool DescribeMediasResponse::MediaInfoSetHasBeenSet() const
{
