...
CoreInternalOutcome DeleteCustomPersonImageResponse::Deserialize(const string &payload)
{
...
string DeleteCustomPersonImageResponse::ToJsonString() const
{
...
string DeleteCustomPersonImageResponse::GetPersonId() const
{
    return m_personId;
}

bool DeleteCustomPersonImageResponse::PersonIdHasBeenSet() const
{
    return m_personIdHasBeenSet;
}

string DeleteCustomPersonImageResponse::GetImageId() const
{
    return m_imageId;
}

bool DeleteCustomPersonImageResponse::ImageIdHasBeenSet() const
{
