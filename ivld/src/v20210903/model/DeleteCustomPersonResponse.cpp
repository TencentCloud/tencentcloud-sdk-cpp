...
CoreInternalOutcome DeleteCustomPersonResponse::Deserialize(const string &payload)
{
...
string DeleteCustomPersonResponse::ToJsonString() const
{
...
string DeleteCustomPersonResponse::GetPersonId() const
{
    return m_personId;
}

bool DeleteCustomPersonResponse::PersonIdHasBeenSet() const
{
