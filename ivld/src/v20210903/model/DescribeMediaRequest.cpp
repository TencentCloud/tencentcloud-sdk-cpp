...
string DescribeMediaRequest::ToJsonString() const
{
...
string DescribeMediaRequest::GetMediaId() const
{
    return m_mediaId;
}

void DescribeMediaRequest::SetMediaId(const string& _mediaId)
{
    m_mediaId = _mediaId;
    m_mediaIdHasBeenSet = true;
}

bool DescribeMediaRequest::MediaIdHasBeenSet() const
{
