...
vector<InstanceListInfo> DescribeInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeInstancesResponse::InstanceListHasBeenSet() const
{
    return m_instanceListHasBeenSet;
}

int64_t DescribeInstancesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeInstancesResponse::TotalNumHasBeenSet() const
{
