...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPACOSDISCOVERYTASKRESULTREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPACOSDISCOVERYTASKRESULTREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DeleteDSPACOSDiscoveryTaskResultRequest : public AbstractModel
                {
                public:
                    DeleteDSPACOSDiscoveryTaskResultRequest();
                    ~DeleteDSPACOSDiscoveryTaskResultRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPACOSDISCOVERYTASKRESULTREQUEST_H_
