...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDATASOURCEINFO_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDATASOURCEINFO_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                * 扫描任务元数据信息
                */
                class DspaCOSDiscoveryTaskDataSourceInfo : public AbstractModel
                {
                public:
                    DspaCOSDiscoveryTaskDataSourceInfo();
                    ~DspaCOSDiscoveryTaskDataSourceInfo() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDATASOURCEINFO_H_
