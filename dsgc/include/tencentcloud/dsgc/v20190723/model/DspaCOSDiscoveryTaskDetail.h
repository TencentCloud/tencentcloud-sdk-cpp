...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDETAIL_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDETAIL_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                * COS敏感数据扫描任务相关信息
                */
                class DspaCOSDiscoveryTaskDetail : public AbstractModel
                {
                public:
                    DspaCOSDiscoveryTaskDetail();
                    ~DspaCOSDiscoveryTaskDetail() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DSPACOSDISCOVERYTASKDETAIL_H_
