...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_COSDATARULE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_COSDATARULE_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                * COS敏感数据识别规则
                */
                class COSDataRule : public AbstractModel
                {
                public:
                    COSDataRule();
                    ~COSDataRule() = default;
...
默认值为or
                     ...
                     * 
                     */
                    std::vector<DataContent> GetContents() const;
                     ...
                     * 
                     */
                    void SetContents(const std::vector<DataContent>& _contents);
...
默认值为or
                     ...
                     * 规则内容
                     */
                    std::vector<DataContent> m_contents;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_COSDATARULE_H_
