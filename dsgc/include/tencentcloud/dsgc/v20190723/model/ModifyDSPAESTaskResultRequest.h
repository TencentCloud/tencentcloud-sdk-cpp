...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_MODIFYDSPAESTASKRESULTREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_MODIFYDSPAESTASKRESULTREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class ModifyDSPAESTaskResultRequest : public AbstractModel
                {
                public:
                    ModifyDSPAESTaskResultRequest();
                    ~ModifyDSPAESTaskResultRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_MODIFYDSPAESTASKRESULTREQUEST_H_
