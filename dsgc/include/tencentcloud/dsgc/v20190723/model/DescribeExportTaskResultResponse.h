...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTRESPONSE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTRESPONSE_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeExportTaskResultResponse : public AbstractModel
                {
                public:
                    DescribeExportTaskResultResponse();
                    ~DescribeExportTaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTRESPONSE_H_
