...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEWITHRULESREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEWITHRULESREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPACategoryTreeWithRulesRequest : public AbstractModel
                {
                public:
                    DescribeDSPACategoryTreeWithRulesRequest();
                    ~DescribeDSPACategoryTreeWithRulesRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEWITHRULESREQUEST_H_
