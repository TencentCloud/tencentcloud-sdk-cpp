...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACATEGORYREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACATEGORYREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class CreateDSPACategoryRequest : public AbstractModel
                {
                public:
                    CreateDSPACategoryRequest();
                    ~CreateDSPACategoryRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACATEGORYREQUEST_H_
