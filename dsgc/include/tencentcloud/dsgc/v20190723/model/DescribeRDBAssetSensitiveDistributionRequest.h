...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBERDBASSETSENSITIVEDISTRIBUTIONREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBERDBASSETSENSITIVEDISTRIBUTIONREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeRDBAssetSensitiveDistributionRequest : public AbstractModel
                {
                public:
                    DescribeRDBAssetSensitiveDistributionRequest();
                    ~DescribeRDBAssetSensitiveDistributionRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBERDBASSETSENSITIVEDISTRIBUTIONREQUEST_H_
