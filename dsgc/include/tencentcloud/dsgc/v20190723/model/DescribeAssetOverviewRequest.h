...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEASSETOVERVIEWREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEASSETOVERVIEWREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetOverviewRequest : public AbstractModel
                {
                public:
                    DescribeAssetOverviewRequest();
                    ~DescribeAssetOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEASSETOVERVIEWREQUEST_H_
