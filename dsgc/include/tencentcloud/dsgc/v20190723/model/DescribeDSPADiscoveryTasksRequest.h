...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKSREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKSREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPADiscoveryTasksRequest : public AbstractModel
                {
                public:
                    DescribeDSPADiscoveryTasksRequest();
                    ~DescribeDSPADiscoveryTasksRequest() = default;
...
selfbuilt-db 表示自建数据库
                    ...
                    /**
                     * 获取任务扫描结果状态，可供选择的状态值有：-1待触发 0待扫描 1扫描中 2扫描终止 3扫描成功 4扫描失败
                    ...
                    /**
                     * 设置任务扫描结果状态，可供选择的状态值有：-1待触发 0待扫描 1扫描中 2扫描终止 3扫描成功 4扫描失败
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKSREQUEST_H_
