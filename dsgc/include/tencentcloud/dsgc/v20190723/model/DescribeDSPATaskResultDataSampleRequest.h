...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPATASKRESULTDATASAMPLEREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPATASKRESULTDATASAMPLEREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPATaskResultDataSampleRequest : public AbstractModel
                {
                public:
                    DescribeDSPATaskResultDataSampleRequest();
                    ~DescribeDSPATaskResultDataSampleRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPATASKRESULTDATASAMPLEREQUEST_H_
