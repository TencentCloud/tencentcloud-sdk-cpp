...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_VERIFYDSPACOSRULERESPONSE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_VERIFYDSPACOSRULERESPONSE_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class VerifyDSPACOSRuleResponse : public AbstractModel
                {
                public:
                    VerifyDSPACOSRuleResponse();
                    ~VerifyDSPACOSRuleResponse() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_VERIFYDSPACOSRULERESPONSE_H_
