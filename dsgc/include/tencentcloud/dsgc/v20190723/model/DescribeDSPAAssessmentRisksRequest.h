...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPAASSESSMENTRISKSREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPAASSESSMENTRISKSREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPAAssessmentRisksRequest : public AbstractModel
                {
                public:
                    DescribeDSPAAssessmentRisksRequest();
                    ~DescribeDSPAAssessmentRisksRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPAASSESSMENTRISKSREQUEST_H_
