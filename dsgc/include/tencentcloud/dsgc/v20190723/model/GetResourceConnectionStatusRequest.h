...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_GETRESOURCECONNECTIONSTATUSREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_GETRESOURCECONNECTIONSTATUSREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class GetResourceConnectionStatusRequest : public AbstractModel
                {
                public:
                    GetResourceConnectionStatusRequest();
                    ~GetResourceConnectionStatusRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_GETRESOURCECONNECTIONSTATUSREQUEST_H_
