...
DsgcClient::CreateClassificationRuleOutcome DsgcClient::CreateClassificationRule(const CreateClassificationRuleRequest &request)
{
    auto outcome = MakeRequest(request, "CreateClassificationRule");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateClassificationRuleResponse rsp = CreateClassificationRuleResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateClassificationRuleOutcome(rsp);
        else
            return CreateClassificationRuleOutcome(o.GetError());
    }
    else
    {
        return CreateClassificationRuleOutcome(outcome.GetError());
    }
}

void DsgcClient::CreateClassificationRuleAsync(const CreateClassificationRuleRequest& request, const CreateClassificationRuleAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->CreateClassificationRule(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::CreateClassificationRuleOutcomeCallable DsgcClient::CreateClassificationRuleCallable(const CreateClassificationRuleRequest &request)
{
    auto task = std::make_shared<std::packaged_task<CreateClassificationRuleOutcome()>>(
        [this, request]()
        {
            return this->CreateClassificationRule(request);
        }
    );
...
DsgcClient::CreateNewClassificationOutcome DsgcClient::CreateNewClassification(const CreateNewClassificationRequest &request)
{
    auto outcome = MakeRequest(request, "CreateNewClassification");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateNewClassificationResponse rsp = CreateNewClassificationResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateNewClassificationOutcome(rsp);
        else
            return CreateNewClassificationOutcome(o.GetError());
    }
    else
    {
        return CreateNewClassificationOutcome(outcome.GetError());
    }
}

void DsgcClient::CreateNewClassificationAsync(const CreateNewClassificationRequest& request, const CreateNewClassificationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->CreateNewClassification(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::CreateNewClassificationOutcomeCallable DsgcClient::CreateNewClassificationCallable(const CreateNewClassificationRequest &request)
{
    auto task = std::make_shared<std::packaged_task<CreateNewClassificationOutcome()>>(
        [this, request]()
        {
            return this->CreateNewClassification(request);
        }
    );
...
DsgcClient::CreateOrCopyStandardOutcome DsgcClient::CreateOrCopyStandard(const CreateOrCopyStandardRequest &request)
{
    auto outcome = MakeRequest(request, "CreateOrCopyStandard");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateOrCopyStandardResponse rsp = CreateOrCopyStandardResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateOrCopyStandardOutcome(rsp);
        else
            return CreateOrCopyStandardOutcome(o.GetError());
    }
    else
    {
        return CreateOrCopyStandardOutcome(outcome.GetError());
    }
}

void DsgcClient::CreateOrCopyStandardAsync(const CreateOrCopyStandardRequest& request, const CreateOrCopyStandardAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->CreateOrCopyStandard(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::CreateOrCopyStandardOutcomeCallable DsgcClient::CreateOrCopyStandardCallable(const CreateOrCopyStandardRequest &request)
{
    auto task = std::make_shared<std::packaged_task<CreateOrCopyStandardOutcome()>>(
        [this, request]()
        {
            return this->CreateOrCopyStandard(request);
        }
    );
...
DsgcClient::DescribeClassificationInfoOutcome DsgcClient::DescribeClassificationInfo(const DescribeClassificationInfoRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeClassificationInfo");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeClassificationInfoResponse rsp = DescribeClassificationInfoResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeClassificationInfoOutcome(rsp);
        else
            return DescribeClassificationInfoOutcome(o.GetError());
    }
    else
    {
        return DescribeClassificationInfoOutcome(outcome.GetError());
    }
}

void DsgcClient::DescribeClassificationInfoAsync(const DescribeClassificationInfoRequest& request, const DescribeClassificationInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DescribeClassificationInfo(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::DescribeClassificationInfoOutcomeCallable DsgcClient::DescribeClassificationInfoCallable(const DescribeClassificationInfoRequest &request)
{
    auto task = std::make_shared<std::packaged_task<DescribeClassificationInfoOutcome()>>(
        [this, request]()
        {
            return this->DescribeClassificationInfo(request);
        }
    );
...
DsgcClient::DescribeClassificationRuleCountOutcome DsgcClient::DescribeClassificationRuleCount(const DescribeClassificationRuleCountRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeClassificationRuleCount");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeClassificationRuleCountResponse rsp = DescribeClassificationRuleCountResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeClassificationRuleCountOutcome(rsp);
        else
            return DescribeClassificationRuleCountOutcome(o.GetError());
    }
    else
    {
        return DescribeClassificationRuleCountOutcome(outcome.GetError());
    }
}

void DsgcClient::DescribeClassificationRuleCountAsync(const DescribeClassificationRuleCountRequest& request, const DescribeClassificationRuleCountAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DescribeClassificationRuleCount(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::DescribeClassificationRuleCountOutcomeCallable DsgcClient::DescribeClassificationRuleCountCallable(const DescribeClassificationRuleCountRequest &request)
{
    auto task = std::make_shared<std::packaged_task<DescribeClassificationRuleCountOutcome()>>(
        [this, request]()
        {
            return this->DescribeClassificationRuleCount(request);
        }
    );
...
DsgcClient::DescribeLeafClassificationOutcome DsgcClient::DescribeLeafClassification(const DescribeLeafClassificationRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeLeafClassification");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeLeafClassificationResponse rsp = DescribeLeafClassificationResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeLeafClassificationOutcome(rsp);
        else
            return DescribeLeafClassificationOutcome(o.GetError());
    }
    else
    {
        return DescribeLeafClassificationOutcome(outcome.GetError());
    }
}

void DsgcClient::DescribeLeafClassificationAsync(const DescribeLeafClassificationRequest& request, const DescribeLeafClassificationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DescribeLeafClassification(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::DescribeLeafClassificationOutcomeCallable DsgcClient::DescribeLeafClassificationCallable(const DescribeLeafClassificationRequest &request)
{
    auto task = std::make_shared<std::packaged_task<DescribeLeafClassificationOutcome()>>(
        [this, request]()
        {
            return this->DescribeLeafClassification(request);
        }
    );
...
DsgcClient::DescribeRuleListOutcome DsgcClient::DescribeRuleList(const DescribeRuleListRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeRuleListResponse rsp = DescribeRuleListResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeRuleListOutcome(rsp);
        else
            return DescribeRuleListOutcome(o.GetError());
    }
    else
    {
        return DescribeRuleListOutcome(outcome.GetError());
    }
}

void DsgcClient::DescribeRuleListAsync(const DescribeRuleListRequest& request, const DescribeRuleListAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DescribeRuleList(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::DescribeRuleListOutcomeCallable DsgcClient::DescribeRuleListCallable(const DescribeRuleListRequest &request)
{
...
DsgcClient::ModifyClassificationRuleOutcome DsgcClient::ModifyClassificationRule(const ModifyClassificationRuleRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyClassificationRule");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyClassificationRuleResponse rsp = ModifyClassificationRuleResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyClassificationRuleOutcome(rsp);
        else
            return ModifyClassificationRuleOutcome(o.GetError());
    }
    else
    {
        return ModifyClassificationRuleOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyClassificationRuleAsync(const ModifyClassificationRuleRequest& request, const ModifyClassificationRuleAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyClassificationRule(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyClassificationRuleOutcomeCallable DsgcClient::ModifyClassificationRuleCallable(const ModifyClassificationRuleRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyClassificationRuleOutcome()>>(
        [this, request]()
        {
            return this->ModifyClassificationRule(request);
        }
    );
...
DsgcClient::ModifyClassificationRuleStateOutcome DsgcClient::ModifyClassificationRuleState(const ModifyClassificationRuleStateRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyClassificationRuleState");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyClassificationRuleStateResponse rsp = ModifyClassificationRuleStateResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyClassificationRuleStateOutcome(rsp);
        else
            return ModifyClassificationRuleStateOutcome(o.GetError());
    }
    else
    {
        return ModifyClassificationRuleStateOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyClassificationRuleStateAsync(const ModifyClassificationRuleStateRequest& request, const ModifyClassificationRuleStateAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyClassificationRuleState(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyClassificationRuleStateOutcomeCallable DsgcClient::ModifyClassificationRuleStateCallable(const ModifyClassificationRuleStateRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyClassificationRuleStateOutcome()>>(
        [this, request]()
        {
            return this->ModifyClassificationRuleState(request);
        }
    );
...
DsgcClient::ModifyLevelInfoOutcome DsgcClient::ModifyLevelInfo(const ModifyLevelInfoRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyLevelInfo");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyLevelInfoResponse rsp = ModifyLevelInfoResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyLevelInfoOutcome(rsp);
        else
            return ModifyLevelInfoOutcome(o.GetError());
    }
    else
    {
        return ModifyLevelInfoOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyLevelInfoAsync(const ModifyLevelInfoRequest& request, const ModifyLevelInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyLevelInfo(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyLevelInfoOutcomeCallable DsgcClient::ModifyLevelInfoCallable(const ModifyLevelInfoRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyLevelInfoOutcome()>>(
        [this, request]()
        {
            return this->ModifyLevelInfo(request);
        }
    );
...
DsgcClient::ModifyLevelNameOutcome DsgcClient::ModifyLevelName(const ModifyLevelNameRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyLevelName");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyLevelNameResponse rsp = ModifyLevelNameResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyLevelNameOutcome(rsp);
        else
            return ModifyLevelNameOutcome(o.GetError());
    }
    else
    {
        return ModifyLevelNameOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyLevelNameAsync(const ModifyLevelNameRequest& request, const ModifyLevelNameAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyLevelName(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyLevelNameOutcomeCallable DsgcClient::ModifyLevelNameCallable(const ModifyLevelNameRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyLevelNameOutcome()>>(
        [this, request]()
        {
            return this->ModifyLevelName(request);
        }
    );
...
DsgcClient::ModifyLevelStateOutcome DsgcClient::ModifyLevelState(const ModifyLevelStateRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyLevelState");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyLevelStateResponse rsp = ModifyLevelStateResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyLevelStateOutcome(rsp);
        else
            return ModifyLevelStateOutcome(o.GetError());
    }
    else
    {
        return ModifyLevelStateOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyLevelStateAsync(const ModifyLevelStateRequest& request, const ModifyLevelStateAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyLevelState(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyLevelStateOutcomeCallable DsgcClient::ModifyLevelStateCallable(const ModifyLevelStateRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyLevelStateOutcome()>>(
        [this, request]()
        {
            return this->ModifyLevelState(request);
        }
    );
...
DsgcClient::ModifyMergeClassificationOutcome DsgcClient::ModifyMergeClassification(const ModifyMergeClassificationRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyMergeClassification");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyMergeClassificationResponse rsp = ModifyMergeClassificationResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyMergeClassificationOutcome(rsp);
        else
            return ModifyMergeClassificationOutcome(o.GetError());
    }
    else
    {
        return ModifyMergeClassificationOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyMergeClassificationAsync(const ModifyMergeClassificationRequest& request, const ModifyMergeClassificationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyMergeClassification(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyMergeClassificationOutcomeCallable DsgcClient::ModifyMergeClassificationCallable(const ModifyMergeClassificationRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyMergeClassificationOutcome()>>(
        [this, request]()
        {
            return this->ModifyMergeClassification(request);
        }
    );
...
DsgcClient::ModifyNewClassificationOutcome DsgcClient::ModifyNewClassification(const ModifyNewClassificationRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyNewClassification");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyNewClassificationResponse rsp = ModifyNewClassificationResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyNewClassificationOutcome(rsp);
        else
            return ModifyNewClassificationOutcome(o.GetError());
    }
    else
    {
        return ModifyNewClassificationOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyNewClassificationAsync(const ModifyNewClassificationRequest& request, const ModifyNewClassificationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyNewClassification(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyNewClassificationOutcomeCallable DsgcClient::ModifyNewClassificationCallable(const ModifyNewClassificationRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyNewClassificationOutcome()>>(
        [this, request]()
        {
            return this->ModifyNewClassification(request);
        }
    );
...
DsgcClient::ModifyStandardInfoOutcome DsgcClient::ModifyStandardInfo(const ModifyStandardInfoRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyStandardInfo");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyStandardInfoResponse rsp = ModifyStandardInfoResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyStandardInfoOutcome(rsp);
        else
            return ModifyStandardInfoOutcome(o.GetError());
    }
    else
    {
        return ModifyStandardInfoOutcome(outcome.GetError());
    }
}

void DsgcClient::ModifyStandardInfoAsync(const ModifyStandardInfoRequest& request, const ModifyStandardInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyStandardInfo(request), context);
    };

    Executor::GetInstance()->Submit(new Runnable(fn));
}

DsgcClient::ModifyStandardInfoOutcomeCallable DsgcClient::ModifyStandardInfoCallable(const ModifyStandardInfoRequest &request)
{
    auto task = std::make_shared<std::packaged_task<ModifyStandardInfoOutcome()>>(
        [this, request]()
        {
            return this->ModifyStandardInfo(request);
        }
    );
