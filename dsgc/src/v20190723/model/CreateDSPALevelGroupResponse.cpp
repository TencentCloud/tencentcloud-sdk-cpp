...
CreateDSPALevelGroupResponse::CreateDSPALevelGroupResponse() :
    m_levelGroupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateDSPALevelGroupResponse::Deserialize(const string &payload)
{
...
string CreateDSPALevelGroupResponse::ToJsonString() const
{
...
uint64_t CreateDSPALevelGroupResponse::GetLevelGroupId() const
{
    return m_levelGroupId;
}

bool CreateDSPALevelGroupResponse::LevelGroupIdHasBeenSet() const
{
