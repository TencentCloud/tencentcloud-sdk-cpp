...
DescribeDSPACOSDataAssetBucketsResponse::DescribeDSPACOSDataAssetBucketsResponse() :
    m_bucketsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDSPACOSDataAssetBucketsResponse::Deserialize(const string &payload)
{
...
string DescribeDSPACOSDataAssetBucketsResponse::ToJsonString() const
{
...
vector<string> DescribeDSPACOSDataAssetBucketsResponse::GetBuckets() const
{
    return m_buckets;
}

bool DescribeDSPACOSDataAssetBucketsResponse::BucketsHasBeenSet() const
{
