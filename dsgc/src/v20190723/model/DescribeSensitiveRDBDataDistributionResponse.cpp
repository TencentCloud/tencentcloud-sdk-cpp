...
DescribeSensitiveRDBDataDistributionResponse::DescribeSensitiveRDBDataDistributionResponse() :
...
CoreInternalOutcome DescribeSensitiveRDBDataDistributionResponse::Deserialize(const string &payload)
{
...
string DescribeSensitiveRDBDataDistributionResponse::ToJsonString() const
{
...
vector<Note> DescribeSensitiveRDBDataDistributionResponse::GetLevelDistribution() const
{
    return m_levelDistribution;
}

bool DescribeSensitiveRDBDataDistributionResponse::LevelDistributionHasBeenSet() const
{
    return m_levelDistributionHasBeenSet;
}

vector<Note> DescribeSensitiveRDBDataDistributionResponse::GetCategoryDistribution() const
{
    return m_categoryDistribution;
}

bool DescribeSensitiveRDBDataDistributionResponse::CategoryDistributionHasBeenSet() const
{
    return m_categoryDistributionHasBeenSet;
}

vector<RuleDistribution> DescribeSensitiveRDBDataDistributionResponse::GetRuleDistribution() const
{
    return m_ruleDistribution;
}

bool DescribeSensitiveRDBDataDistributionResponse::RuleDistributionHasBeenSet() const
{
    return m_ruleDistributionHasBeenSet;
}

int64_t DescribeSensitiveRDBDataDistributionResponse::GetSensitiveDataNum() const
{
    return m_sensitiveDataNum;
}

bool DescribeSensitiveRDBDataDistributionResponse::SensitiveDataNumHasBeenSet() const
{
