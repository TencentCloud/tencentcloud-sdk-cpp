...
DeleteCosMetaResourceResponse::DeleteCosMetaResourceResponse() :
    m_resultsHasBeenSet(false),
    m_dspaIdHasBeenSet(false)
{
}

CoreInternalOutcome DeleteCosMetaResourceResponse::Deserialize(const string &payload)
{
...
string DeleteCosMetaResourceResponse::ToJsonString() const
{
...
vector<DspaTaskResult> DeleteCosMetaResourceResponse::GetResults() const
{
    return m_results;
}

bool DeleteCosMetaResourceResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

string DeleteCosMetaResourceResponse::GetDspaId() const
{
    return m_dspaId;
}

bool DeleteCosMetaResourceResponse::DspaIdHasBeenSet() const
{
