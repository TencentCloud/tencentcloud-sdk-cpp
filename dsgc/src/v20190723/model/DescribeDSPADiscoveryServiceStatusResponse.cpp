...
DescribeDSPADiscoveryServiceStatusResponse::DescribeDSPADiscoveryServiceStatusResponse() :
    m_serviceEnabledHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDSPADiscoveryServiceStatusResponse::Deserialize(const string &payload)
{
...
string DescribeDSPADiscoveryServiceStatusResponse::ToJsonString() const
{
...
bool DescribeDSPADiscoveryServiceStatusResponse::GetServiceEnabled() const
{
    return m_serviceEnabled;
}

bool DescribeDSPADiscoveryServiceStatusResponse::ServiceEnabledHasBeenSet() const
{
