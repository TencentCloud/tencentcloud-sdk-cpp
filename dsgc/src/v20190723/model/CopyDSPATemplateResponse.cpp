...
CopyDSPATemplateResponse::CopyDSPATemplateResponse() :
    m_templateIdHasBeenSet(false)
{
}

CoreInternalOutcome CopyDSPATemplateResponse::Deserialize(const string &payload)
{
...
string CopyDSPATemplateResponse::ToJsonString() const
{
...
int64_t CopyDSPATemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CopyDSPATemplateResponse::TemplateIdHasBeenSet() const
{
