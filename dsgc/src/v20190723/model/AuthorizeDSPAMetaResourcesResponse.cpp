...
AuthorizeDSPAMetaResourcesResponse::AuthorizeDSPAMetaResourcesResponse() :
    m_dspaIdHasBeenSet(false),
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome AuthorizeDSPAMetaResourcesResponse::Deserialize(const string &payload)
{
...
string AuthorizeDSPAMetaResourcesResponse::ToJsonString() const
{
...
string AuthorizeDSPAMetaResourcesResponse::GetDspaId() const
{
    return m_dspaId;
}

bool AuthorizeDSPAMetaResourcesResponse::DspaIdHasBeenSet() const
{
    return m_dspaIdHasBeenSet;
}

vector<DspaTaskResult> AuthorizeDSPAMetaResourcesResponse::GetResults() const
{
    return m_results;
}

bool AuthorizeDSPAMetaResourcesResponse::ResultsHasBeenSet() const
{
