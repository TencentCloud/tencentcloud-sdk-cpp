...
CreateDSPADbMetaResourcesResponse::CreateDSPADbMetaResourcesResponse() :
...
CoreInternalOutcome CreateDSPADbMetaResourcesResponse::Deserialize(const string &payload)
{
...
string CreateDSPADbMetaResourcesResponse::ToJsonString() const
{
...
string CreateDSPADbMetaResourcesResponse::GetUpdateId() const
{
    return m_updateId;
}

bool CreateDSPADbMetaResourcesResponse::UpdateIdHasBeenSet() const
{
    return m_updateIdHasBeenSet;
}

string CreateDSPADbMetaResourcesResponse::GetMetaType() const
{
    return m_metaType;
}

bool CreateDSPADbMetaResourcesResponse::MetaTypeHasBeenSet() const
{
    return m_metaTypeHasBeenSet;
}

string CreateDSPADbMetaResourcesResponse::GetDspaId() const
{
    return m_dspaId;
}

bool CreateDSPADbMetaResourcesResponse::DspaIdHasBeenSet() const
{
    return m_dspaIdHasBeenSet;
}

string CreateDSPADbMetaResourcesResponse::GetResourceRegion() const
{
    return m_resourceRegion;
}

bool CreateDSPADbMetaResourcesResponse::ResourceRegionHasBeenSet() const
{
