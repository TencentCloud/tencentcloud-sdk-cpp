...
DeleteDSPAMetaResourceResponse::DeleteDSPAMetaResourceResponse() :
    m_dspaIdHasBeenSet(false),
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome DeleteDSPAMetaResourceResponse::Deserialize(const string &payload)
{
...
string DeleteDSPAMetaResourceResponse::ToJsonString() const
{
...
string DeleteDSPAMetaResourceResponse::GetDspaId() const
{
    return m_dspaId;
}

bool DeleteDSPAMetaResourceResponse::DspaIdHasBeenSet() const
{
    return m_dspaIdHasBeenSet;
}

vector<DspaTaskResult> DeleteDSPAMetaResourceResponse::GetResults() const
{
    return m_results;
}

bool DeleteDSPAMetaResourceResponse::ResultsHasBeenSet() const
{
