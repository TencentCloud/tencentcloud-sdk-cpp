...
DescribeDSPACOSDiscoveryTaskFilesResponse::DescribeDSPACOSDiscoveryTaskFilesResponse() :
    m_filesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDSPACOSDiscoveryTaskFilesResponse::Deserialize(const string &payload)
{
...
string DescribeDSPACOSDiscoveryTaskFilesResponse::ToJsonString() const
{
...
vector<string> DescribeDSPACOSDiscoveryTaskFilesResponse::GetFiles() const
{
    return m_files;
}

bool DescribeDSPACOSDiscoveryTaskFilesResponse::FilesHasBeenSet() const
{
