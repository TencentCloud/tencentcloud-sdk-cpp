...
DisableDSPAMetaResourceAuthResponse::DisableDSPAMetaResourceAuthResponse() :
    m_dspaIdHasBeenSet(false),
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome DisableDSPAMetaResourceAuthResponse::Deserialize(const string &payload)
{
...
string DisableDSPAMetaResourceAuthResponse::ToJsonString() const
{
...
string DisableDSPAMetaResourceAuthResponse::GetDspaId() const
{
    return m_dspaId;
}

bool DisableDSPAMetaResourceAuthResponse::DspaIdHasBeenSet() const
{
    return m_dspaIdHasBeenSet;
}

vector<DspaTaskResult> DisableDSPAMetaResourceAuthResponse::GetResults() const
{
    return m_results;
}

bool DisableDSPAMetaResourceAuthResponse::ResultsHasBeenSet() const
{
