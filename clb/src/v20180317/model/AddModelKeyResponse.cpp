...
AddModelKeyResponse::AddModelKeyResponse() :
    m_keyIdsHasBeenSet(false)
{
}

CoreInternalOutcome AddModelKeyResponse::Deserialize(const string &payload)
{
...
string AddModelKeyResponse::ToJsonString() const
{
...
vector<string> AddModelKeyResponse::GetKeyIds() const
{
    return m_keyIds;
}

bool AddModelKeyResponse::KeyIdsHasBeenSet() const
{
