...
CoreInternalOutcome InquiryPriceModifyLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquiryPriceModifyLoadBalancerResponse::ToJsonString() const
{
...
Price InquiryPriceModifyLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceModifyLoadBalancerResponse::PriceHasBeenSet() const
{
