...
CoreInternalOutcome InquiryPriceRefundLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRefundLoadBalancerResponse::ToJsonString() const
{
...
Price InquiryPriceRefundLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRefundLoadBalancerResponse::PriceHasBeenSet() const
{
