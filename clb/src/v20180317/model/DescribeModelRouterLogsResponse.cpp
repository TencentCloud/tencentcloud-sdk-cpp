...
DescribeModelRouterLogsResponse::DescribeModelRouterLogsResponse() :
...
CoreInternalOutcome DescribeModelRouterLogsResponse::Deserialize(const string &payload)
{
...
string DescribeModelRouterLogsResponse::ToJsonString() const
{
...
vector<ModelRouterLog> DescribeModelRouterLogsResponse::GetLogs() const
{
    return m_logs;
}

bool DescribeModelRouterLogsResponse::LogsHasBeenSet() const
{
    return m_logsHasBeenSet;
}

uint64_t DescribeModelRouterLogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeModelRouterLogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

string DescribeModelRouterLogsResponse::GetNextToken() const
{
    return m_nextToken;
}

bool DescribeModelRouterLogsResponse::NextTokenHasBeenSet() const
{
