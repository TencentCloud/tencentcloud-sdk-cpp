...
string AssociateCustomizedConfigRequest::ToJsonString() const
{
...
string AssociateCustomizedConfigRequest::GetUconfigId() const
{
    return m_uconfigId;
}

void AssociateCustomizedConfigRequest::SetUconfigId(const string& _uconfigId)
{
    m_uconfigId = _uconfigId;
    m_uconfigIdHasBeenSet = true;
}

bool AssociateCustomizedConfigRequest::UconfigIdHasBeenSet() const
{
    return m_uconfigIdHasBeenSet;
}

vector<BindItem> AssociateCustomizedConfigRequest::GetBindList() const
{
    return m_bindList;
}

void AssociateCustomizedConfigRequest::SetBindList(const vector<BindItem>& _bindList)
{
    m_bindList = _bindList;
    m_bindListHasBeenSet = true;
}

bool AssociateCustomizedConfigRequest::BindListHasBeenSet() const
{
