...
TestServiceProviderConnectionResponse::TestServiceProviderConnectionResponse() :
    m_resultsHasBeenSet(false)
{
}

CoreInternalOutcome TestServiceProviderConnectionResponse::Deserialize(const string &payload)
{
...
string TestServiceProviderConnectionResponse::ToJsonString() const
{
...
vector<ModelTestResult> TestServiceProviderConnectionResponse::GetResults() const
{
    return m_results;
}

bool TestServiceProviderConnectionResponse::ResultsHasBeenSet() const
{
