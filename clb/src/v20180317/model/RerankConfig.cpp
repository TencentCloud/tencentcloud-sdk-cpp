...
CoreInternalOutcome RerankConfig::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("RoutingStrategy") && !value["RoutingStrategy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RerankConfig.RoutingStrategy` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RoutingStrategyArgs") && !value["RoutingStrategyArgs"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RerankConfig.RoutingStrategyArgs` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("NumRetries") && !value["NumRetries"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RerankConfig.NumRetries` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
string RerankConfig::GetRoutingStrategy() const
{
    return m_routingStrategy;
}

void RerankConfig::SetRoutingStrategy(const string& _routingStrategy)
{
    m_routingStrategy = _routingStrategy;
    m_routingStrategyHasBeenSet = true;
}

bool RerankConfig::RoutingStrategyHasBeenSet() const
{
    return m_routingStrategyHasBeenSet;
}

RoutingStrategyArgs RerankConfig::GetRoutingStrategyArgs() const
{
    return m_routingStrategyArgs;
}

void RerankConfig::SetRoutingStrategyArgs(const RoutingStrategyArgs& _routingStrategyArgs)
{
    m_routingStrategyArgs = _routingStrategyArgs;
    m_routingStrategyArgsHasBeenSet = true;
}

bool RerankConfig::RoutingStrategyArgsHasBeenSet() const
{
    return m_routingStrategyArgsHasBeenSet;
}

uint64_t RerankConfig::GetNumRetries() const
{
    return m_numRetries;
}

void RerankConfig::SetNumRetries(const uint64_t& _numRetries)
{
    m_numRetries = _numRetries;
    m_numRetriesHasBeenSet = true;
}

bool RerankConfig::NumRetriesHasBeenSet() const
{
