...
string DescribeLBOperateProtectRequest::ToJsonString() const
{
...
vector<string> DescribeLBOperateProtectRequest::GetLoadBalancerIds() const
{
    return m_loadBalancerIds;
}

void DescribeLBOperateProtectRequest::SetLoadBalancerIds(const vector<string>& _loadBalancerIds)
{
    m_loadBalancerIds = _loadBalancerIds;
    m_loadBalancerIdsHasBeenSet = true;
}

bool DescribeLBOperateProtectRequest::LoadBalancerIdsHasBeenSet() const
{
