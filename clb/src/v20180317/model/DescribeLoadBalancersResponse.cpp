...
uint64_t DescribeLoadBalancersResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<LoadBalancer> DescribeLoadBalancersResponse::GetLoadBalancerSet() const
{
    return m_loadBalancerSet;
}

bool DescribeLoadBalancersResponse::LoadBalancerSetHasBeenSet() const
{
