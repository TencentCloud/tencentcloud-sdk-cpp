...
CoreInternalOutcome EmbeddingConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("RoutingStrategy") && !value["RoutingStrategy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `EmbeddingConfig.RoutingStrategy` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RoutingStrategyArgs") && !value["RoutingStrategyArgs"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `EmbeddingConfig.RoutingStrategyArgs` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("NumRetries") && !value["NumRetries"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `EmbeddingConfig.NumRetries` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void EmbeddingConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string EmbeddingConfig::GetRoutingStrategy() const
{
    return m_routingStrategy;
}

void EmbeddingConfig::SetRoutingStrategy(const string& _routingStrategy)
{
    m_routingStrategy = _routingStrategy;
    m_routingStrategyHasBeenSet = true;
}

bool EmbeddingConfig::RoutingStrategyHasBeenSet() const
{
    return m_routingStrategyHasBeenSet;
}

RoutingStrategyArgs EmbeddingConfig::GetRoutingStrategyArgs() const
{
    return m_routingStrategyArgs;
}

void EmbeddingConfig::SetRoutingStrategyArgs(const RoutingStrategyArgs& _routingStrategyArgs)
{
    m_routingStrategyArgs = _routingStrategyArgs;
    m_routingStrategyArgsHasBeenSet = true;
}

bool EmbeddingConfig::RoutingStrategyArgsHasBeenSet() const
{
    return m_routingStrategyArgsHasBeenSet;
}

uint64_t EmbeddingConfig::GetNumRetries() const
{
    return m_numRetries;
}

void EmbeddingConfig::SetNumRetries(const uint64_t& _numRetries)
{
    m_numRetries = _numRetries;
    m_numRetriesHasBeenSet = true;
}

bool EmbeddingConfig::NumRetriesHasBeenSet() const
{
