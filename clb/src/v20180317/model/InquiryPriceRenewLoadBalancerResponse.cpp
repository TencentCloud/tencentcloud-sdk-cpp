...
CoreInternalOutcome InquiryPriceRenewLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRenewLoadBalancerResponse::ToJsonString() const
{
...
Price InquiryPriceRenewLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRenewLoadBalancerResponse::PriceHasBeenSet() const
{
