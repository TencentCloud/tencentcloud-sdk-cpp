...
string DeleteKeysRequest::ToJsonString() const
{
...
string DeleteKeysRequest::GetModelRouterId() const
{
    return m_modelRouterId;
}

void DeleteKeysRequest::SetModelRouterId(const string& _modelRouterId)
{
    m_modelRouterId = _modelRouterId;
    m_modelRouterIdHasBeenSet = true;
}

bool DeleteKeysRequest::ModelRouterIdHasBeenSet() const
{
    return m_modelRouterIdHasBeenSet;
}

vector<string> DeleteKeysRequest::GetKeyIds() const
{
    return m_keyIds;
}

void DeleteKeysRequest::SetKeyIds(const vector<string>& _keyIds)
{
    m_keyIds = _keyIds;
    m_keyIdsHasBeenSet = true;
}

bool DeleteKeysRequest::KeyIdsHasBeenSet() const
{
