...
RefundModelRouterResourcePackageResponse::RefundModelRouterResourcePackageResponse() :
    m_dealNamesHasBeenSet(false)
{
}

CoreInternalOutcome RefundModelRouterResourcePackageResponse::Deserialize(const string &payload)
{
...
string RefundModelRouterResourcePackageResponse::ToJsonString() const
{
...
vector<string> RefundModelRouterResourcePackageResponse::GetDealNames() const
{
    return m_dealNames;
}

bool RefundModelRouterResourcePackageResponse::DealNamesHasBeenSet() const
{
