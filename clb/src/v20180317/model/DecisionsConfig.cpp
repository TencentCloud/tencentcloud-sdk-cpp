...
CoreInternalOutcome DecisionsConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("RoutingStrategy") && !value["RoutingStrategy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DecisionsConfig.RoutingStrategy` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RoutingStrategyArgs") && !value["RoutingStrategyArgs"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DecisionsConfig.RoutingStrategyArgs` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("NumRetries") && !value["NumRetries"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DecisionsConfig.NumRetries` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void DecisionsConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string DecisionsConfig::GetRoutingStrategy() const
{
    return m_routingStrategy;
}

void DecisionsConfig::SetRoutingStrategy(const string& _routingStrategy)
{
    m_routingStrategy = _routingStrategy;
    m_routingStrategyHasBeenSet = true;
}

bool DecisionsConfig::RoutingStrategyHasBeenSet() const
{
    return m_routingStrategyHasBeenSet;
}

RoutingStrategyArgs DecisionsConfig::GetRoutingStrategyArgs() const
{
    return m_routingStrategyArgs;
}

void DecisionsConfig::SetRoutingStrategyArgs(const RoutingStrategyArgs& _routingStrategyArgs)
{
    m_routingStrategyArgs = _routingStrategyArgs;
    m_routingStrategyArgsHasBeenSet = true;
}

bool DecisionsConfig::RoutingStrategyArgsHasBeenSet() const
{
    return m_routingStrategyArgsHasBeenSet;
}

uint64_t DecisionsConfig::GetNumRetries() const
{
    return m_numRetries;
}

void DecisionsConfig::SetNumRetries(const uint64_t& _numRetries)
{
    m_numRetries = _numRetries;
    m_numRetriesHasBeenSet = true;
}

bool DecisionsConfig::NumRetriesHasBeenSet() const
{
