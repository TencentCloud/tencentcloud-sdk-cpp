...
string CreateRuleRequest::GetLoadBalancerId() const
{
    return m_loadBalancerId;
}

void CreateRuleRequest::SetLoadBalancerId(const string& _loadBalancerId)
{
    m_loadBalancerId = _loadBalancerId;
    m_loadBalancerIdHasBeenSet = true;
}

bool CreateRuleRequest::LoadBalancerIdHasBeenSet() const
{
...
vector<RuleInput> CreateRuleRequest::GetRules() const
{
    return m_rules;
}

void CreateRuleRequest::SetRules(const vector<RuleInput>& _rules)
{
    m_rules = _rules;
