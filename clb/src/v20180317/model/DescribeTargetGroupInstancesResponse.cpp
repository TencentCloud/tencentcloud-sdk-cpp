...
DescribeTargetGroupInstancesResponse::DescribeTargetGroupInstancesResponse() :
    ...
    m_targetGroupInstanceSetHasBeenSet(false),
    m_realCountHasBeenSet(false)
{
}
...
CoreInternalOutcome DescribeTargetGroupInstancesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TargetGroupInstanceSet") && !rsp["TargetGroupInstanceSet"].IsNull())
    {
        ...
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ...
            m_targetGroupInstanceSet.push_back(item);
        }
        m_targetGroupInstanceSetHasBeenSet = true;
    }

    if (rsp.HasMember("RealCount") && !rsp["RealCount"].IsNull())
    {
...
uint64_t DescribeTargetGroupInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTargetGroupInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TargetGroupBackend> DescribeTargetGroupInstancesResponse::GetTargetGroupInstanceSet() const
{
    return m_targetGroupInstanceSet;
}

bool DescribeTargetGroupInstancesResponse::TargetGroupInstanceSetHasBeenSet() const
{
    return m_targetGroupInstanceSetHasBeenSet;
}

uint64_t DescribeTargetGroupInstancesResponse::GetRealCount() const
{
    return m_realCount;
}

bool DescribeTargetGroupInstancesResponse::RealCountHasBeenSet() const
{
    return m_realCountHasBeenSet;
}
