...
CoreInternalOutcome InquiryPriceCreateLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquiryPriceCreateLoadBalancerResponse::ToJsonString() const
{
...
Price InquiryPriceCreateLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceCreateLoadBalancerResponse::PriceHasBeenSet() const
{
