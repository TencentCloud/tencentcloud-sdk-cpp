...
vector<string> DeleteModelRequest::GetServiceProviderIds() const
{
    return m_serviceProviderIds;
}

void DeleteModelRequest::SetServiceProviderIds(const vector<string>& _serviceProviderIds)
{
    m_serviceProviderIds = _serviceProviderIds;
    m_serviceProviderIdsHasBeenSet = true;
}

bool DeleteModelRequest::ServiceProviderIdsHasBeenSet() const
{
