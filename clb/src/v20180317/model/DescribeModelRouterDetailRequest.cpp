...
DescribeModelRouterDetailRequest::DescribeModelRouterDetailRequest() :
    m_modelRouterIdHasBeenSet(false)
{
}

string DescribeModelRouterDetailRequest::ToJsonString() const
{
...
string DescribeModelRouterDetailRequest::GetModelRouterId() const
{
    return m_modelRouterId;
}

void DescribeModelRouterDetailRequest::SetModelRouterId(const string& _modelRouterId)
{
    m_modelRouterId = _modelRouterId;
    m_modelRouterIdHasBeenSet = true;
}

bool DescribeModelRouterDetailRequest::ModelRouterIdHasBeenSet() const
{
