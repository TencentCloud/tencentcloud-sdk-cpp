...
DeleteBudgetsRequest::DeleteBudgetsRequest() :
    m_budgetIdsHasBeenSet(false)
{
}

string DeleteBudgetsRequest::ToJsonString() const
{
...
vector<string> DeleteBudgetsRequest::GetBudgetIds() const
{
    return m_budgetIds;
}

void DeleteBudgetsRequest::SetBudgetIds(const vector<string>& _budgetIds)
{
    m_budgetIds = _budgetIds;
    m_budgetIdsHasBeenSet = true;
}

bool DeleteBudgetsRequest::BudgetIdsHasBeenSet() const
{
