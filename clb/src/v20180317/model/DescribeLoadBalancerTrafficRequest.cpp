...
string DescribeLoadBalancerTrafficRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_loadBalancerRegionHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_loadBalancerRegion.c_str(), allocator).Move(), allocator);
    }
...
string DescribeLoadBalancerTrafficRequest::GetLoadBalancerRegion() const
{
    return m_loadBalancerRegion;
}

void DescribeLoadBalancerTrafficRequest::SetLoadBalancerRegion(const string& _loadBalancerRegion)
{
    m_loadBalancerRegion = _loadBalancerRegion;
    m_loadBalancerRegionHasBeenSet = true;
}

bool DescribeLoadBalancerTrafficRequest::LoadBalancerRegionHasBeenSet() const
{
