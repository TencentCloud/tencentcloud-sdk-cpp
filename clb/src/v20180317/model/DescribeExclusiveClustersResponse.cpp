...
CoreInternalOutcome DescribeExclusiveClustersResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ClusterSet") && !rsp["ClusterSet"].IsNull())
    {
        if (!rsp["ClusterSet"].IsArray())
            return CoreInternalOutcome(Error("response `ClusterSet` is not array type"));
...
string DescribeExclusiveClustersResponse::ToJsonString() const
{
...
vector<Cluster> DescribeExclusiveClustersResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeExclusiveClustersResponse::ClusterSetHasBeenSet() const
{
    return m_clusterSetHasBeenSet;
}

uint64_t DescribeExclusiveClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeExclusiveClustersResponse::TotalCountHasBeenSet() const
{
