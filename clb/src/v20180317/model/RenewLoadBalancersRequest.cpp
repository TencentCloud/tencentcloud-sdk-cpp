...
string RenewLoadBalancersRequest::ToJsonString() const
{
...
vector<string> RenewLoadBalancersRequest::GetLoadBalancerIds() const
{
    return m_loadBalancerIds;
}

void RenewLoadBalancersRequest::SetLoadBalancerIds(const vector<string>& _loadBalancerIds)
{
    m_loadBalancerIds = _loadBalancerIds;
    m_loadBalancerIdsHasBeenSet = true;
}

bool RenewLoadBalancersRequest::LoadBalancerIdsHasBeenSet() const
{
    return m_loadBalancerIdsHasBeenSet;
}

LBChargePrepaid RenewLoadBalancersRequest::GetLBChargePrepaid() const
{
    return m_lBChargePrepaid;
}

void RenewLoadBalancersRequest::SetLBChargePrepaid(const LBChargePrepaid& _lBChargePrepaid)
{
    m_lBChargePrepaid = _lBChargePrepaid;
    m_lBChargePrepaidHasBeenSet = true;
}

bool RenewLoadBalancersRequest::LBChargePrepaidHasBeenSet() const
{
