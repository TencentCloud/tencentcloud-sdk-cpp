...
CoreInternalOutcome TargetRegionInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void TargetRegionInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
