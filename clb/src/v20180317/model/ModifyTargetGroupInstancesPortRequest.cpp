...
string ModifyTargetGroupInstancesPortRequest::ToJsonString() const
{
...
string ModifyTargetGroupInstancesPortRequest::GetTargetGroupId() const
{
    return m_targetGroupId;
}

void ModifyTargetGroupInstancesPortRequest::SetTargetGroupId(const string& _targetGroupId)
{
    m_targetGroupId = _targetGroupId;
    m_targetGroupIdHasBeenSet = true;
}

bool ModifyTargetGroupInstancesPortRequest::TargetGroupIdHasBeenSet() const
{
    return m_targetGroupIdHasBeenSet;
}

vector<TargetGroupInstance> ModifyTargetGroupInstancesPortRequest::GetTargetGroupInstances() const
{
    return m_targetGroupInstances;
}

void ModifyTargetGroupInstancesPortRequest::SetTargetGroupInstances(const vector<TargetGroupInstance>& _targetGroupInstances)
{
    m_targetGroupInstances = _targetGroupInstances;
    m_targetGroupInstancesHasBeenSet = true;
}

bool ModifyTargetGroupInstancesPortRequest::TargetGroupInstancesHasBeenSet() const
{
