...
CoreInternalOutcome CertificateOutput::Deserialize(const Value &value)
{
    string requestId = "";
...
void CertificateOutput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
