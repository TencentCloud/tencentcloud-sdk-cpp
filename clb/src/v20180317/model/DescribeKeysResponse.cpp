...
vector<KeyInfo> DescribeKeysResponse::GetKeys() const
{
    return m_keys;
}
...
uint64_t DescribeKeysResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeKeysResponse::TotalCountHasBeenSet() const
{
