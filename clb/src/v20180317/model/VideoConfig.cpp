...
CoreInternalOutcome VideoConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("RoutingStrategy") && !value["RoutingStrategy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VideoConfig.RoutingStrategy` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RoutingStrategyArgs") && !value["RoutingStrategyArgs"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VideoConfig.RoutingStrategyArgs` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("NumRetries") && !value["NumRetries"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VideoConfig.NumRetries` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void VideoConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string VideoConfig::GetRoutingStrategy() const
{
    return m_routingStrategy;
}

void VideoConfig::SetRoutingStrategy(const string& _routingStrategy)
{
    m_routingStrategy = _routingStrategy;
    m_routingStrategyHasBeenSet = true;
}

bool VideoConfig::RoutingStrategyHasBeenSet() const
{
    return m_routingStrategyHasBeenSet;
}

RoutingStrategyArgs VideoConfig::GetRoutingStrategyArgs() const
{
    return m_routingStrategyArgs;
}

void VideoConfig::SetRoutingStrategyArgs(const RoutingStrategyArgs& _routingStrategyArgs)
{
    m_routingStrategyArgs = _routingStrategyArgs;
    m_routingStrategyArgsHasBeenSet = true;
}

bool VideoConfig::RoutingStrategyArgsHasBeenSet() const
{
    return m_routingStrategyArgsHasBeenSet;
}

uint64_t VideoConfig::GetNumRetries() const
{
    return m_numRetries;
}

void VideoConfig::SetNumRetries(const uint64_t& _numRetries)
{
    m_numRetries = _numRetries;
    m_numRetriesHasBeenSet = true;
}

bool VideoConfig::NumRetriesHasBeenSet() const
{
