...
CoreInternalOutcome ModifyLoadBalancerSlaResponse::Deserialize(const string &payload)
{
...
string ModifyLoadBalancerSlaResponse::ToJsonString() const
{
...
string ModifyLoadBalancerSlaResponse::GetDealName() const
{
    return m_dealName;
}

bool ModifyLoadBalancerSlaResponse::DealNameHasBeenSet() const
{
