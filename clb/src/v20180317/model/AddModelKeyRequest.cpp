...
AddModelKeyRequest::AddModelKeyRequest() :
    m_serviceProviderIdHasBeenSet(false),
    m_keysHasBeenSet(false)
{
}

string AddModelKeyRequest::ToJsonString() const
{
...
string AddModelKeyRequest::GetServiceProviderId() const
{
    return m_serviceProviderId;
}

void AddModelKeyRequest::SetServiceProviderId(const string& _serviceProviderId)
{
    m_serviceProviderId = _serviceProviderId;
    m_serviceProviderIdHasBeenSet = true;
}

bool AddModelKeyRequest::ServiceProviderIdHasBeenSet() const
{
    return m_serviceProviderIdHasBeenSet;
}

vector<KeyItem> AddModelKeyRequest::GetKeys() const
{
    return m_keys;
}

void AddModelKeyRequest::SetKeys(const vector<KeyItem>& _keys)
{
    m_keys = _keys;
    m_keysHasBeenSet = true;
}

bool AddModelKeyRequest::KeysHasBeenSet() const
{
