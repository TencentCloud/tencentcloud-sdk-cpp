...
DescribeModelRewriteRequest::DescribeModelRewriteRequest() :
    m_modelRouterIdHasBeenSet(false),
    m_sourceModelHasBeenSet(false)
{
}

string DescribeModelRewriteRequest::ToJsonString() const
{
...
string DescribeModelRewriteRequest::GetModelRouterId() const
{
    return m_modelRouterId;
}

void DescribeModelRewriteRequest::SetModelRouterId(const string& _modelRouterId)
{
    m_modelRouterId = _modelRouterId;
    m_modelRouterIdHasBeenSet = true;
}

bool DescribeModelRewriteRequest::ModelRouterIdHasBeenSet() const
{
    return m_modelRouterIdHasBeenSet;
}

string DescribeModelRewriteRequest::GetSourceModel() const
{
    return m_sourceModel;
}

void DescribeModelRewriteRequest::SetSourceModel(const string& _sourceModel)
{
    m_sourceModel = _sourceModel;
    m_sourceModelHasBeenSet = true;
}

bool DescribeModelRewriteRequest::SourceModelHasBeenSet() const
{
