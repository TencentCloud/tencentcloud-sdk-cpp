...
CoreInternalOutcome DescribeLBOperateProtectResponse::Deserialize(const string &payload)
{
...
string DescribeLBOperateProtectResponse::ToJsonString() const
{
...
vector<LBOperateProtectInfo> DescribeLBOperateProtectResponse::GetLoadBalancerSet() const
{
    return m_loadBalancerSet;
}

bool DescribeLBOperateProtectResponse::LoadBalancerSetHasBeenSet() const
{
