...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_RATELIMITCONFIGFORBUDGET_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_RATELIMITCONFIGFORBUDGET_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * Budget限速配置
                */
                class RateLimitConfigForBudget : public AbstractModel
                {
                public:
                    RateLimitConfigForBudget();
                    ~RateLimitConfigForBudget() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_RATELIMITCONFIGFORBUDGET_H_
