...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_ASSOCIATEMODELSTOMODELROUTERREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_ASSOCIATEMODELSTOMODELROUTERREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class AssociateModelsToModelRouterRequest : public AbstractModel
                {
                public:
                    AssociateModelsToModelRouterRequest();
                    ~AssociateModelsToModelRouterRequest() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_ASSOCIATEMODELSTOMODELROUTERREQUEST_H_
