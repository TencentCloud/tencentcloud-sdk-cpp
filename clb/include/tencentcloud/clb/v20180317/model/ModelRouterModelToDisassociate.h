...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERMODELTODISASSOCIATE_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERMODELTODISASSOCIATE_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * CMR实例待解绑的模型信息
                */
                class ModelRouterModelToDisassociate : public AbstractModel
                {
                public:
                    ModelRouterModelToDisassociate();
                    ~ModelRouterModelToDisassociate() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERMODELTODISASSOCIATE_H_
