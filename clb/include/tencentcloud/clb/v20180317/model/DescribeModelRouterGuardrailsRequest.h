...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_DESCRIBEMODELROUTERGUARDRAILSREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_DESCRIBEMODELROUTERGUARDRAILSREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class DescribeModelRouterGuardrailsRequest : public AbstractModel
                {
                public:
                    DescribeModelRouterGuardrailsRequest();
                    ~DescribeModelRouterGuardrailsRequest() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_DESCRIBEMODELROUTERGUARDRAILSREQUEST_H_
