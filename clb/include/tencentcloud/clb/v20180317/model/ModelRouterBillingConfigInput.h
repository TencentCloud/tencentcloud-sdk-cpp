...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERBILLINGCONFIGINPUT_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERBILLINGCONFIGINPUT_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * 模型路由计费信息
                */
                class ModelRouterBillingConfigInput : public AbstractModel
                {
                public:
                    ModelRouterBillingConfigInput();
                    ~ModelRouterBillingConfigInput() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERBILLINGCONFIGINPUT_H_
