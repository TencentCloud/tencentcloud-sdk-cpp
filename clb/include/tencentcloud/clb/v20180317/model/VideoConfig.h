...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_VIDEOCONFIG_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_VIDEOCONFIG_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * video配置。
                */
                class VideoConfig : public AbstractModel
                {
                public:
                    VideoConfig();
                    ~VideoConfig() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_VIDEOCONFIG_H_
