...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGITEMOUTPUT_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGITEMOUTPUT_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * 健康检查配置
                */
                class ServiceProviderHealthCheckConfigItemOutput : public AbstractModel
                {
                public:
                    ServiceProviderHealthCheckConfigItemOutput();
                    ~ServiceProviderHealthCheckConfigItemOutput() = default;
                    ...
                    /**
                     * 获取<p>健康检查间隔。支持以300s为步长配置。</p><p>单位：s</p><p>默认值：300</p>
                    ...
                    /**
                     * 设置<p>健康检查间隔。支持以300s为步长配置。</p><p>单位：s</p><p>默认值：300</p>
                    ...
                    /**
                     * 获取<p>不健康阈值。表示当模型连续多少次不健康时认为该模型不健康。</p><p>取值范围：[1, 10]</p><p>默认值：1</p>
                    ...
                    /**
                     * 设置<p>不健康阈值。表示当模型连续多少次不健康时认为该模型不健康。</p><p>取值范围：[1, 10]</p><p>默认值：1</p>
                    ...
                    /**
                     * 获取<p>健康检查使用的最大Token数量。部分模型如gpt系列可能仅支持大于等于16。</p><p>默认值：1</p>
                    ...
                    /**
                     * 设置<p>健康检查使用的最大Token数量。部分模型如gpt系列可能仅支持大于等于16。</p><p>默认值：1</p>
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGITEMOUTPUT_H_
