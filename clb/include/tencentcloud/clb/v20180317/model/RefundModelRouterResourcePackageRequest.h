...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_REFUNDMODELROUTERRESOURCEPACKAGEREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_REFUNDMODELROUTERRESOURCEPACKAGEREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class RefundModelRouterResourcePackageRequest : public AbstractModel
                {
                public:
                    RefundModelRouterResourcePackageRequest();
                    ~RefundModelRouterResourcePackageRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>待退还的模型路由资源包Id</p><p>非有效状态或者设置了自动续订且自动续订已生效的资源包不允许退款。</p>
                     * @return ModelRouterResourcePackageIds <p>待退还的模型路由资源包Id</p><p>非有效状态或者设置了自动续订且自动续订已生效的资源包不允许退款。</p>
                     * 
                     */
                    std::vector<std::string> GetModelRouterResourcePackageIds() const;

                    /**
                     * 设置<p>待退还的模型路由资源包Id</p><p>非有效状态或者设置了自动续订且自动续订已生效的资源包不允许退款。</p>
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_REFUNDMODELROUTERRESOURCEPACKAGEREQUEST_H_
