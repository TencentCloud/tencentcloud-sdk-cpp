...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_MODIFYMODELROUTERSECURITYGROUPSREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_MODIFYMODELROUTERSECURITYGROUPSREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class ModifyModelRouterSecurityGroupsRequest : public AbstractModel
                {
                public:
                    ModifyModelRouterSecurityGroupsRequest();
                    ~ModifyModelRouterSecurityGroupsRequest() = default;
                    ...
                    /**
                     * 获取<p>需要绑定的安全组ID列表</p>
                     * @return SecurityGroups <p>需要绑定的安全组ID列表</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_MODIFYMODELROUTERSECURITYGROUPSREQUEST_H_
