...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_INTENTROUTERTIERITEM_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_INTENTROUTERTIERITEM_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class IntentRouterTierItem : public AbstractModel
                {
                public:
                    IntentRouterTierItem();
                    ~IntentRouterTierItem() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>该分层下的模型显示名称列表。</p>
                     * @return Models <p>该分层下的模型显示名称列表。</p>
                     * 
                     */
                    std::vector<std::string> GetModels() const;

                    /**
                     * 设置<p>该分层下的模型显示名称列表。</p>
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_INTENTROUTERTIERITEM_H_
