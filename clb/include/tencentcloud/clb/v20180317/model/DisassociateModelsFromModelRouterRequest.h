...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_DISASSOCIATEMODELSFROMMODELROUTERREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_DISASSOCIATEMODELSFROMMODELROUTERREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class DisassociateModelsFromModelRouterRequest : public AbstractModel
                {
                public:
                    DisassociateModelsFromModelRouterRequest();
                    ~DisassociateModelsFromModelRouterRequest() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_DISASSOCIATEMODELSFROMMODELROUTERREQUEST_H_
