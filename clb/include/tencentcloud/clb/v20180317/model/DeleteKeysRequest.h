...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_DELETEKEYSREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_DELETEKEYSREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * DeleteKeys请求参数结构体
                */
                class DeleteKeysRequest : public AbstractModel
                {
                public:
                    DeleteKeysRequest();
                    ~DeleteKeysRequest() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_DELETEKEYSREQUEST_H_
