...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGINPUT_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGINPUT_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * 健康检查配置
                */
                class ServiceProviderHealthCheckConfigInput : public AbstractModel
                {
                public:
                    ServiceProviderHealthCheckConfigInput();
                    ~ServiceProviderHealthCheckConfigInput() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_SERVICEPROVIDERHEALTHCHECKCONFIGINPUT_H_
