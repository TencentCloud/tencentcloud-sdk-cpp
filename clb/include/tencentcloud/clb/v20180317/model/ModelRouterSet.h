...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERSET_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERSET_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                * 模型路由列表
                */
                class ModelRouterSet : public AbstractModel
                {
                public:
                    ModelRouterSet();
                    ~ModelRouterSet() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_MODELROUTERSET_H_
