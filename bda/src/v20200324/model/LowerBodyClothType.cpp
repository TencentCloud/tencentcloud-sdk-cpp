...
CoreInternalOutcome LowerBodyClothType::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void LowerBodyClothType::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string LowerBodyClothType::GetType() const
{
    return m_type;
}

void LowerBodyClothType::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool LowerBodyClothType::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

double LowerBodyClothType::GetProbability() const
{
    return m_probability;
}

void LowerBodyClothType::SetProbability(const double& _probability)
{
    m_probability = _probability;
    m_probabilityHasBeenSet = true;
}

bool LowerBodyClothType::ProbabilityHasBeenSet() const
{
