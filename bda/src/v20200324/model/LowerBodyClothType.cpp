...
CoreInternalOutcome LowerBodyClothType::Deserialize(const Value &value)
{
    string requestId = "";
...
void LowerBodyClothType::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
