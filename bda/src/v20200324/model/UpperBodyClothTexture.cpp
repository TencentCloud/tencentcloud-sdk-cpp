...
CoreInternalOutcome UpperBodyClothTexture::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Type") && !value["Type"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `UpperBodyClothTexture.Type` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Probability") && !value["Probability"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `UpperBodyClothTexture.Probability` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
...
void UpperBodyClothTexture::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
