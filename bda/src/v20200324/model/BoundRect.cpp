...
CoreInternalOutcome BoundRect::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("X") && !value["X"].IsNull())
    {
        if (!value["X"].IsInt64())
        {
            return CoreInternalOutcome(Error("response `BoundRect.X` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Y") && !value["Y"].IsNull())
    {
        if (!value["Y"].IsInt64())
        {
            return CoreInternalOutcome(Error("response `BoundRect.Y` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Width") && !value["Width"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BoundRect.Width` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Height") && !value["Height"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BoundRect.Height` IsInt64=false incorrectly").SetRequestId(requestId));
        }
