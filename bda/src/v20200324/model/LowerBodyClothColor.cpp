...
CoreInternalOutcome LowerBodyClothColor::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Type") && !value["Type"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LowerBodyClothColor.Type` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Probability") && !value["Probability"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LowerBodyClothColor.Probability` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
...
void LowerBodyClothColor::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
