...
CoreInternalOutcome LowerBodyClothLength::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Type") && !value["Type"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `LowerBodyClothLength.Type` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Probability") && !value["Probability"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `LowerBodyClothLength.Probability` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
...
void LowerBodyClothLength::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
