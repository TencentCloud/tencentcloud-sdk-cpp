...
CoreInternalOutcome Bag::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void Bag::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
