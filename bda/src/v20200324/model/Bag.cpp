...
CoreInternalOutcome Bag::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Probability") && !value["Probability"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Bag.Probability` IsDouble=false incorrectly").SetRequestId(requestId));
        }
...
void Bag::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
...
void Bag::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool Bag::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

double Bag::GetProbability() const
{
    return m_probability;
}

void Bag::SetProbability(const double& _probability)
{
    m_probability = _probability;
    m_probabilityHasBeenSet = true;
}

bool Bag::ProbabilityHasBeenSet() const
{
