...
CoreInternalOutcome Age::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Probability") && !value["Probability"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Age.Probability` IsDouble=false incorrectly").SetRequestId(requestId));
        }
...
void Age::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
...
string Age::GetType() const
{
    return m_type;
}

void Age::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool Age::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

double Age::GetProbability() const
{
    return m_probability;
}

void Age::SetProbability(const double& _probability)
{
    m_probability = _probability;
    m_probabilityHasBeenSet = true;
}

bool Age::ProbabilityHasBeenSet() const
{
