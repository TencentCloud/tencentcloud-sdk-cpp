...
#ifndef TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHSLEEVE_H_
#define TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHSLEEVE_H_
    ...
    namespace Bda
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                * 上衣衣袖信息。
                */
                class UpperBodyClothSleeve : public AbstractModel
                {
                public:
                    UpperBodyClothSleeve();
                    ~UpperBodyClothSleeve() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取上衣衣袖信息, 返回值为以下集合中的一个 {长袖, 短袖}。
...
#endif // !TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHSLEEVE_H_
