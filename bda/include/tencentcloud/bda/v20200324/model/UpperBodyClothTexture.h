...
#ifndef TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHTEXTURE_H_
#define TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHTEXTURE_H_
    ...
    namespace Bda
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                * 上衣纹理信息。
                */
                class UpperBodyClothTexture : public AbstractModel
                {
                public:
                    UpperBodyClothTexture();
                    ~UpperBodyClothTexture() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取上衣纹理信息，返回值为以下集合中的一个, {纯色, 格子, 大色块}。
                    ...
                    /**
                     * 设置上衣纹理信息，返回值为以下集合中的一个, {纯色, 格子, 大色块}。
...
#endif // !TENCENTCLOUD_BDA_V20200324_MODEL_UPPERBODYCLOTHTEXTURE_H_
