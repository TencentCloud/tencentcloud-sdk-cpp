...
#ifndef TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHTYPE_H_
#define TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHTYPE_H_
    ...
    namespace Bda
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                * 下衣类型信息
                */
                class LowerBodyClothType : public AbstractModel
                {
                public:
                    LowerBodyClothType();
                    ~LowerBodyClothType() = default;
...
#endif // !TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHTYPE_H_
