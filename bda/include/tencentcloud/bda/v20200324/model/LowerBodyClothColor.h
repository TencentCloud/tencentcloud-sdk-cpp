...
#ifndef TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHCOLOR_H_
#define TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHCOLOR_H_
    ...
    namespace Bda
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                * 下衣颜色信息
                */
                class LowerBodyClothColor : public AbstractModel
                {
                public:
                    LowerBodyClothColor();
                    ~LowerBodyClothColor() = default;
...
#endif // !TENCENTCLOUD_BDA_V20200324_MODEL_LOWERBODYCLOTHCOLOR_H_
