...
#ifndef TENCENTCLOUD_BDA_V20200324_MODEL_AGE_H_
#define TENCENTCLOUD_BDA_V20200324_MODEL_AGE_H_
...
AttributesType 不含 Age 或检测超过 5 个人体时，此参数仍返回，但不具备参考意义。
                */
                class Age : public AbstractModel
                {
                public:
                    Age();
                    ~Age() = default;
                    ...
                    /**
                     * 获取人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
                    ...
                    /**
                     * 设置人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
...
#endif // !TENCENTCLOUD_BDA_V20200324_MODEL_AGE_H_
