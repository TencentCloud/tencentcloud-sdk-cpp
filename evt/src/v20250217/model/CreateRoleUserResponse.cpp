...
CreateRoleUserResponse::CreateRoleUserResponse() :
    m_userIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateRoleUserResponse::Deserialize(const string &payload)
{
...
string CreateRoleUserResponse::ToJsonString() const
{
...
string CreateRoleUserResponse::GetUserId() const
{
    return m_userId;
}

bool CreateRoleUserResponse::UserIdHasBeenSet() const
{
