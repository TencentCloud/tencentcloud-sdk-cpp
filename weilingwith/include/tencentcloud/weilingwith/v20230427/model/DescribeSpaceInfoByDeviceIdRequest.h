...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEINFOBYDEVICEIDREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEINFOBYDEVICEIDREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeSpaceInfoByDeviceIdRequest : public AbstractModel
                {
                public:
                    DescribeSpaceInfoByDeviceIdRequest();
                    ~DescribeSpaceInfoByDeviceIdRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEINFOBYDEVICEIDREQUEST_H_
