...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACETYPELISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACETYPELISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeSpaceTypeListRequest : public AbstractModel
                {
                public:
                    DescribeSpaceTypeListRequest();
                    ~DescribeSpaceTypeListRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACETYPELISTREQUEST_H_
