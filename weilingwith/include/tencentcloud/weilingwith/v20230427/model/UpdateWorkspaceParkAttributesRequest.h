...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_UPDATEWORKSPACEPARKATTRIBUTESREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_UPDATEWORKSPACEPARKATTRIBUTESREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class UpdateWorkspaceParkAttributesRequest : public AbstractModel
                {
                public:
                    UpdateWorkspaceParkAttributesRequest();
                    ~UpdateWorkspaceParkAttributesRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_UPDATEWORKSPACEPARKATTRIBUTESREQUEST_H_
