...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeLinkRuleListRequest : public AbstractModel
                {
                public:
                    DescribeLinkRuleListRequest();
                    ~DescribeLinkRuleListRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTREQUEST_H_
