...
CoreInternalOutcome StopVideoStreamingResponse::Deserialize(const string &payload)
{
...
string StopVideoStreamingResponse::ToJsonString() const
{
...
EmptyRes StopVideoStreamingResponse::GetResult() const
{
    return m_result;
}

bool StopVideoStreamingResponse::ResultHasBeenSet() const
{
