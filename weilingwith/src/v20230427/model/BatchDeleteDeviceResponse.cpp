...
BatchDeleteDeviceResponse::BatchDeleteDeviceResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome BatchDeleteDeviceResponse::Deserialize(const string &payload)
{
...
string BatchDeleteDeviceResponse::ToJsonString() const
{
...
EmptyRes BatchDeleteDeviceResponse::GetResult() const
{
    return m_result;
}

bool BatchDeleteDeviceResponse::ResultHasBeenSet() const
{
