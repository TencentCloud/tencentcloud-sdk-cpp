...
BatchCreateDeviceResponse::BatchCreateDeviceResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome BatchCreateDeviceResponse::Deserialize(const string &payload)
{
...
string BatchCreateDeviceResponse::ToJsonString() const
{
...
BatchCreateDeviceRes BatchCreateDeviceResponse::GetResult() const
{
    return m_result;
}

bool BatchCreateDeviceResponse::ResultHasBeenSet() const
{
