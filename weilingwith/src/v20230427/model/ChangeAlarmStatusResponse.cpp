...
ChangeAlarmStatusResponse::ChangeAlarmStatusResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ChangeAlarmStatusResponse::Deserialize(const string &payload)
{
...
string ChangeAlarmStatusResponse::ToJsonString() const
{
...
EmptyRes ChangeAlarmStatusResponse::GetResult() const
{
    return m_result;
}

bool ChangeAlarmStatusResponse::ResultHasBeenSet() const
{
