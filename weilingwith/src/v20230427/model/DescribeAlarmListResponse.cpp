...
DescribeAlarmListResponse::DescribeAlarmListResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAlarmListResponse::Deserialize(const string &payload)
{
...
string DescribeAlarmListResponse::ToJsonString() const
{
...
DescribeAlarmListRes DescribeAlarmListResponse::GetResult() const
{
    return m_result;
}

bool DescribeAlarmListResponse::ResultHasBeenSet() const
{
