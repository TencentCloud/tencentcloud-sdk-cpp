...
CoreInternalOutcome DescribeTenantBuildingCountAndAreaResponse::Deserialize(const string &payload)
{
...
string DescribeTenantBuildingCountAndAreaResponse::ToJsonString() const
{
