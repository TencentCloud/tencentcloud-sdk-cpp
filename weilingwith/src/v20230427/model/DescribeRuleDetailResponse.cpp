...
DescribeRuleDetailResponse::DescribeRuleDetailResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome DescribeRuleDetailResponse::Deserialize(const string &payload)
{
...
string DescribeRuleDetailResponse::ToJsonString() const
{
...
RuleDetailRes DescribeRuleDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeRuleDetailResponse::ResultHasBeenSet() const
{
