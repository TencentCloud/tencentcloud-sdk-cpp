...
DescribeSceneListResponse::DescribeSceneListResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSceneListResponse::Deserialize(const string &payload)
{
...
string DescribeSceneListResponse::ToJsonString() const
{
...
SceneListRes DescribeSceneListResponse::GetResult() const
{
    return m_result;
}

bool DescribeSceneListResponse::ResultHasBeenSet() const
{
