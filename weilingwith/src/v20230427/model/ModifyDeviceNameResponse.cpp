...
ModifyDeviceNameResponse::ModifyDeviceNameResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ModifyDeviceNameResponse::Deserialize(const string &payload)
{
...
string ModifyDeviceNameResponse::ToJsonString() const
{
...
EmptyRes ModifyDeviceNameResponse::GetResult() const
{
    return m_result;
}

bool ModifyDeviceNameResponse::ResultHasBeenSet() const
{
