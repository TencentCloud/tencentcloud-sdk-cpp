...
ControlDeviceResponse::ControlDeviceResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ControlDeviceResponse::Deserialize(const string &payload)
{
...
string ControlDeviceResponse::ToJsonString() const
{
...
ControlDeviceSet ControlDeviceResponse::GetResult() const
{
    return m_result;
}

bool ControlDeviceResponse::ResultHasBeenSet() const
{
