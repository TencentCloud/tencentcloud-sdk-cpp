...
ModifyDeviceTagResponse::ModifyDeviceTagResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ModifyDeviceTagResponse::Deserialize(const string &payload)
{
...
string ModifyDeviceTagResponse::ToJsonString() const
{
...
EmptyRes ModifyDeviceTagResponse::GetResult() const
{
    return m_result;
}

bool ModifyDeviceTagResponse::ResultHasBeenSet() const
{
