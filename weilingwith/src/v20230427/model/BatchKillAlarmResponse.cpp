...
BatchKillAlarmResponse::BatchKillAlarmResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome BatchKillAlarmResponse::Deserialize(const string &payload)
{
...
string BatchKillAlarmResponse::ToJsonString() const
{
...
EmptyRes BatchKillAlarmResponse::GetResult() const
{
    return m_result;
}

bool BatchKillAlarmResponse::ResultHasBeenSet() const
{
