...
CoreInternalOutcome DeleteDeviceGroupResponse::Deserialize(const string &payload)
{
...
string DeleteDeviceGroupResponse::ToJsonString() const
{
...
EmptyRes DeleteDeviceGroupResponse::GetResult() const
{
    return m_result;
}

bool DeleteDeviceGroupResponse::ResultHasBeenSet() const
{
