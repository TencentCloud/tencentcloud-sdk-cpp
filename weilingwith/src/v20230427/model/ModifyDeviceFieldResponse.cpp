...
ModifyDeviceFieldResponse::ModifyDeviceFieldResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ModifyDeviceFieldResponse::Deserialize(const string &payload)
{
...
string ModifyDeviceFieldResponse::ToJsonString() const
{
...
EmptyRes ModifyDeviceFieldResponse::GetResult() const
{
    return m_result;
}

bool ModifyDeviceFieldResponse::ResultHasBeenSet() const
{
