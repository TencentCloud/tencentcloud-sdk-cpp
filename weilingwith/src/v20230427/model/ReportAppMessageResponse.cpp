...
ReportAppMessageResponse::ReportAppMessageResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ReportAppMessageResponse::Deserialize(const string &payload)
{
...
string ReportAppMessageResponse::ToJsonString() const
{
...
EmptyRes ReportAppMessageResponse::GetResult() const
{
    return m_result;
}

bool ReportAppMessageResponse::ResultHasBeenSet() const
{
