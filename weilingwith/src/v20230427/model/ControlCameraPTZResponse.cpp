...
ControlCameraPTZResponse::ControlCameraPTZResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ControlCameraPTZResponse::Deserialize(const string &payload)
{
...
string ControlCameraPTZResponse::ToJsonString() const
{
...
EmptyRes ControlCameraPTZResponse::GetResult() const
{
    return m_result;
}

bool ControlCameraPTZResponse::ResultHasBeenSet() const
{
