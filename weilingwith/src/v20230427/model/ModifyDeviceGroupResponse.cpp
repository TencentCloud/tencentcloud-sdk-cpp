...
CoreInternalOutcome ModifyDeviceGroupResponse::Deserialize(const string &payload)
{
...
string ModifyDeviceGroupResponse::ToJsonString() const
{
...
EmptyRes ModifyDeviceGroupResponse::GetResult() const
{
    return m_result;
}

bool ModifyDeviceGroupResponse::ResultHasBeenSet() const
{
