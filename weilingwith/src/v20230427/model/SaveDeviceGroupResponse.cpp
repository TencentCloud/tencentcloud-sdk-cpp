...
SaveDeviceGroupResponse::SaveDeviceGroupResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome SaveDeviceGroupResponse::Deserialize(const string &payload)
{
...
string SaveDeviceGroupResponse::ToJsonString() const
{
...
SaveDeviceGroupRes SaveDeviceGroupResponse::GetResult() const
{
    return m_result;
}

bool SaveDeviceGroupResponse::ResultHasBeenSet() const
{
