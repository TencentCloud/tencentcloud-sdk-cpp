...
string DescribeInstancesRequest::GetOrder() const
{
    return m_order;
}

void DescribeInstancesRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeInstancesRequest::OrderHasBeenSet() const
{
...
string DescribeInstancesRequest::GetResourceGroupId() const
{
    return m_resourceGroupId;
}

void DescribeInstancesRequest::SetResourceGroupId(const string& _resourceGroupId)
{
    m_resourceGroupId = _resourceGroupId;
    m_resourceGroupIdHasBeenSet = true;
}

bool DescribeInstancesRequest::ResourceGroupIdHasBeenSet() const
{
