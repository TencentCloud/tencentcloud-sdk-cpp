...
string DeleteRuntimeRequest::ToJsonString() const
{
...
string DeleteRuntimeRequest::GetRuntime() const
{
    return m_runtime;
}

void DeleteRuntimeRequest::SetRuntime(const string& _runtime)
{
    m_runtime = _runtime;
    m_runtimeHasBeenSet = true;
}

bool DeleteRuntimeRequest::RuntimeHasBeenSet() const
{
