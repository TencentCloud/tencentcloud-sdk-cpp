...
CoreInternalOutcome UpdateJobResponse::Deserialize(const string &payload)
{
...
string UpdateJobResponse::ToJsonString() const
{
...
Job UpdateJobResponse::GetJob() const
{
    return m_job;
}

bool UpdateJobResponse::JobHasBeenSet() const
{
