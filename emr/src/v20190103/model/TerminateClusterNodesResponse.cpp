...
CoreInternalOutcome TerminateClusterNodesResponse::Deserialize(const string &payload)
{
...
string TerminateClusterNodesResponse::ToJsonString() const
{
...
int64_t TerminateClusterNodesResponse::GetFlowId() const
{
    return m_flowId;
}

bool TerminateClusterNodesResponse::FlowIdHasBeenSet() const
{
