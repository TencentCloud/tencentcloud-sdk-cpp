...
CoreInternalOutcome DescribeSLInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeSLInstanceListResponse::ToJsonString() const
{
...
int64_t DescribeSLInstanceListResponse::GetTotalCnt() const
{
    return m_totalCnt;
}

bool DescribeSLInstanceListResponse::TotalCntHasBeenSet() const
{
    return m_totalCntHasBeenSet;
}

vector<SLInstanceInfo> DescribeSLInstanceListResponse::GetInstancesList() const
{
    return m_instancesList;
}

bool DescribeSLInstanceListResponse::InstancesListHasBeenSet() const
{
