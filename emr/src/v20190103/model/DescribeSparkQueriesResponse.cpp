...
CoreInternalOutcome DescribeSparkQueriesResponse::Deserialize(const string &payload)
{
...
string DescribeSparkQueriesResponse::ToJsonString() const
{
...
int64_t DescribeSparkQueriesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSparkQueriesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<SparkQuery> DescribeSparkQueriesResponse::GetResults() const
{
    return m_results;
}

bool DescribeSparkQueriesResponse::ResultsHasBeenSet() const
{
