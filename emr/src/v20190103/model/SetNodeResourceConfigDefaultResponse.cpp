...
CoreInternalOutcome SetNodeResourceConfigDefaultResponse::Deserialize(const string &payload)
{
...
string SetNodeResourceConfigDefaultResponse::ToJsonString() const
{
