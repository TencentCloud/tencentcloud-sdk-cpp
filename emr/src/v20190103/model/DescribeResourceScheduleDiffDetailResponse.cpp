...
CoreInternalOutcome DescribeResourceScheduleDiffDetailResponse::Deserialize(const string &payload)
{
...
string DescribeResourceScheduleDiffDetailResponse::ToJsonString() const
{
...
vector<DiffDetail> DescribeResourceScheduleDiffDetailResponse::GetDetails() const
{
    return m_details;
}

bool DescribeResourceScheduleDiffDetailResponse::DetailsHasBeenSet() const
{
