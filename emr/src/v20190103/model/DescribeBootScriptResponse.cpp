...
DescribeBootScriptResponse::DescribeBootScriptResponse() :
    m_detailHasBeenSet(false)
{
}

CoreInternalOutcome DescribeBootScriptResponse::Deserialize(const string &payload)
{
...
string DescribeBootScriptResponse::ToJsonString() const
{
...
DescribeBootScriptRsp DescribeBootScriptResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeBootScriptResponse::DetailHasBeenSet() const
{
