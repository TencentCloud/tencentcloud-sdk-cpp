...
CoreInternalOutcome RenewInstancesInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void RenewInstancesInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
