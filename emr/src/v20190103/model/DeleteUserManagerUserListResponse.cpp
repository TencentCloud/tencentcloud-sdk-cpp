...
CoreInternalOutcome DeleteUserManagerUserListResponse::Deserialize(const string &payload)
{
...
string DeleteUserManagerUserListResponse::ToJsonString() const
{
...
int64_t DeleteUserManagerUserListResponse::GetFlowId() const
{
    return m_flowId;
}

bool DeleteUserManagerUserListResponse::FlowIdHasBeenSet() const
{
