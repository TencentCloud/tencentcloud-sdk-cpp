...
DescribeEMREventListResponse::DescribeEMREventListResponse() :
    m_eventListHasBeenSet(false),
    m_totalNumHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEMREventListResponse::Deserialize(const string &payload)
{
...
string DescribeEMREventListResponse::ToJsonString() const
{
...
vector<EMREventListItem> DescribeEMREventListResponse::GetEventList() const
{
    return m_eventList;
}

bool DescribeEMREventListResponse::EventListHasBeenSet() const
{
    return m_eventListHasBeenSet;
}

int64_t DescribeEMREventListResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeEMREventListResponse::TotalNumHasBeenSet() const
{
