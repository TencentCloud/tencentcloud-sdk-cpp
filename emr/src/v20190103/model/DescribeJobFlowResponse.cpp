...
CoreInternalOutcome DescribeJobFlowResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("State") && !rsp["State"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `State` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string DescribeJobFlowResponse::ToJsonString() const
{
...
string DescribeJobFlowResponse::GetState() const
{
    return m_state;
}

bool DescribeJobFlowResponse::StateHasBeenSet() const
{
    return m_stateHasBeenSet;
}

vector<JobResult> DescribeJobFlowResponse::GetDetails() const
{
    return m_details;
}

bool DescribeJobFlowResponse::DetailsHasBeenSet() const
{
