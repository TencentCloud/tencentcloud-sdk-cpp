...
CoreInternalOutcome ModifyYarnDeployResponse::Deserialize(const string &payload)
{
...
string ModifyYarnDeployResponse::ToJsonString() const
{
...
bool ModifyYarnDeployResponse::GetIsDraft() const
{
    return m_isDraft;
}

bool ModifyYarnDeployResponse::IsDraftHasBeenSet() const
{
    return m_isDraftHasBeenSet;
}

string ModifyYarnDeployResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyYarnDeployResponse::ErrorMsgHasBeenSet() const
{
