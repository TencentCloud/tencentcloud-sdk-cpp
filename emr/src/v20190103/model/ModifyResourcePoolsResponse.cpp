...
CoreInternalOutcome ModifyResourcePoolsResponse::Deserialize(const string &payload)
{
...
string ModifyResourcePoolsResponse::ToJsonString() const
{
...
bool ModifyResourcePoolsResponse::GetIsDraft() const
{
    return m_isDraft;
}

bool ModifyResourcePoolsResponse::IsDraftHasBeenSet() const
{
    return m_isDraftHasBeenSet;
}

string ModifyResourcePoolsResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyResourcePoolsResponse::ErrorMsgHasBeenSet() const
{
