...
CoreInternalOutcome ResizeDataDisksResponse::Deserialize(const string &payload)
{
...
string ResizeDataDisksResponse::ToJsonString() const
{
...
int64_t ResizeDataDisksResponse::GetFlowId() const
{
    return m_flowId;
}

bool ResizeDataDisksResponse::FlowIdHasBeenSet() const
{
