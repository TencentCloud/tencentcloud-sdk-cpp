...
CoreInternalOutcome DescribeEmrOverviewMetricsResponse::Deserialize(const string &payload)
{
...
string DescribeEmrOverviewMetricsResponse::ToJsonString() const
{
...
vector<OverviewMetricData> DescribeEmrOverviewMetricsResponse::GetResult() const
{
    return m_result;
}

bool DescribeEmrOverviewMetricsResponse::ResultHasBeenSet() const
{
