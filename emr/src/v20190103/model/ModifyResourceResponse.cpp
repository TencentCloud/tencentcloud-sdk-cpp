...
CoreInternalOutcome ModifyResourceResponse::Deserialize(const string &payload)
{
...
string ModifyResourceResponse::ToJsonString() const
{
...
string ModifyResourceResponse::GetTraceId() const
{
    return m_traceId;
}

bool ModifyResourceResponse::TraceIdHasBeenSet() const
{
