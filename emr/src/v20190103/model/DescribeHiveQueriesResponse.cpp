...
CoreInternalOutcome DescribeHiveQueriesResponse::Deserialize(const string &payload)
{
...
string DescribeHiveQueriesResponse::ToJsonString() const
{
...
int64_t DescribeHiveQueriesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeHiveQueriesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<HiveQuery> DescribeHiveQueriesResponse::GetResults() const
{
    return m_results;
}

bool DescribeHiveQueriesResponse::ResultsHasBeenSet() const
{
