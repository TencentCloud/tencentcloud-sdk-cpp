...
CoreInternalOutcome DescribeAutoScaleRecordsResponse::Deserialize(const string &payload)
{
...
string DescribeAutoScaleRecordsResponse::ToJsonString() const
{
...
int64_t DescribeAutoScaleRecordsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAutoScaleRecordsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AutoScaleRecord> DescribeAutoScaleRecordsResponse::GetRecordList() const
{
    return m_recordList;
}

bool DescribeAutoScaleRecordsResponse::RecordListHasBeenSet() const
{
