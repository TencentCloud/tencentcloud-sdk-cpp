...
CoreInternalOutcome ModifyUsersOfGroupSTDResponse::Deserialize(const string &payload)
{
...
string ModifyUsersOfGroupSTDResponse::ToJsonString() const
{
...
bool ModifyUsersOfGroupSTDResponse::GetData() const
{
    return m_data;
}

bool ModifyUsersOfGroupSTDResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t ModifyUsersOfGroupSTDResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyUsersOfGroupSTDResponse::FlowIdHasBeenSet() const
{
