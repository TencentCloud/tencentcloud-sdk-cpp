...
CoreInternalOutcome ModifyInspectionSettingsResponse::Deserialize(const string &payload)
{
...
string ModifyInspectionSettingsResponse::ToJsonString() const
{
...
string ModifyInspectionSettingsResponse::GetInfo() const
{
    return m_info;
}

bool ModifyInspectionSettingsResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string ModifyInspectionSettingsResponse::GetJobId() const
{
    return m_jobId;
}

bool ModifyInspectionSettingsResponse::JobIdHasBeenSet() const
{
