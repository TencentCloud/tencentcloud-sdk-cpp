...
InstallSoftwareResponse::InstallSoftwareResponse() :
    m_errorMessagesHasBeenSet(false),
    m_flowIdHasBeenSet(false)
{
}

CoreInternalOutcome InstallSoftwareResponse::Deserialize(const string &payload)
{
...
string InstallSoftwareResponse::ToJsonString() const
{
...
vector<string> InstallSoftwareResponse::GetErrorMessages() const
{
    return m_errorMessages;
}

bool InstallSoftwareResponse::ErrorMessagesHasBeenSet() const
{
    return m_errorMessagesHasBeenSet;
}

int64_t InstallSoftwareResponse::GetFlowId() const
{
    return m_flowId;
}

bool InstallSoftwareResponse::FlowIdHasBeenSet() const
{
