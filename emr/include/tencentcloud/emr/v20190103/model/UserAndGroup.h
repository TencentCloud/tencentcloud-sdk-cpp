...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_USERANDGROUP_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_USERANDGROUP_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                * 容器集群用户组信息
                */
                class UserAndGroup : public AbstractModel
                {
                public:
                    UserAndGroup();
                    ~UserAndGroup() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_USERANDGROUP_H_
