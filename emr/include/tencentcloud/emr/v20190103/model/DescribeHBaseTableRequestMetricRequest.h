...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICREQUEST_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICREQUEST_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                */
                class DescribeHBaseTableRequestMetricRequest : public AbstractModel
                {
                public:
                    DescribeHBaseTableRequestMetricRequest();
                    ~DescribeHBaseTableRequestMetricRequest() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICREQUEST_H_
