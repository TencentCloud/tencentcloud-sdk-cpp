...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICRESPONSE_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICRESPONSE_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                */
                class DescribeHBaseTableRequestMetricResponse : public AbstractModel
                {
                public:
                    DescribeHBaseTableRequestMetricResponse();
                    ~DescribeHBaseTableRequestMetricResponse() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEHBASETABLEREQUESTMETRICRESPONSE_H_
