...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEIMPALAQUERIESREQUEST_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEIMPALAQUERIESREQUEST_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                */
                class DescribeImpalaQueriesRequest : public AbstractModel
                {
                public:
                    DescribeImpalaQueriesRequest();
                    ~DescribeImpalaQueriesRequest() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEIMPALAQUERIESREQUEST_H_
