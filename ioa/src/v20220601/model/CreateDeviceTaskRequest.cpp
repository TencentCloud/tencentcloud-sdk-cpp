...
string CreateDeviceTaskRequest::ToJsonString() const
{
...
void CreateDeviceTaskRequest::SetMid(const string& _mid)
{
    m_mid = _mid;
    m_midHasBeenSet = true;
}

bool CreateDeviceTaskRequest::MidHasBeenSet() const
{
