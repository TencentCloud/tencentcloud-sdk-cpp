...
string DeleteAccountGroupRequest::GetDomainInstanceId() const
{
    return m_domainInstanceId;
}

void DeleteAccountGroupRequest::SetDomainInstanceId(const string& _domainInstanceId)
{
    m_domainInstanceId = _domainInstanceId;
    m_domainInstanceIdHasBeenSet = true;
}

bool DeleteAccountGroupRequest::DomainInstanceIdHasBeenSet() const
{
    return m_domainInstanceIdHasBeenSet;
}

uint64_t DeleteAccountGroupRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void DeleteAccountGroupRequest::SetAccountGroupId(const uint64_t& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool DeleteAccountGroupRequest::AccountGroupIdHasBeenSet() const
{
