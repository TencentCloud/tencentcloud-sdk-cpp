...
UnbindVirtualAccountsRequest::UnbindVirtualAccountsRequest() :
...
string UnbindVirtualAccountsRequest::ToJsonString() const
{
...
int64_t UnbindVirtualAccountsRequest::GetVirtualGroupId() const
{
    return m_virtualGroupId;
}

void UnbindVirtualAccountsRequest::SetVirtualGroupId(const int64_t& _virtualGroupId)
{
    m_virtualGroupId = _virtualGroupId;
    m_virtualGroupIdHasBeenSet = true;
}

bool UnbindVirtualAccountsRequest::VirtualGroupIdHasBeenSet() const
{
    return m_virtualGroupIdHasBeenSet;
}

vector<int64_t> UnbindVirtualAccountsRequest::GetAccountIdList() const
{
    return m_accountIdList;
}

void UnbindVirtualAccountsRequest::SetAccountIdList(const vector<int64_t>& _accountIdList)
{
    m_accountIdList = _accountIdList;
    m_accountIdListHasBeenSet = true;
}

bool UnbindVirtualAccountsRequest::AccountIdListHasBeenSet() const
{
    return m_accountIdListHasBeenSet;
}

vector<AccountUserIdItem> UnbindVirtualAccountsRequest::GetAccountUserList() const
{
    return m_accountUserList;
}

void UnbindVirtualAccountsRequest::SetAccountUserList(const vector<AccountUserIdItem>& _accountUserList)
{
    m_accountUserList = _accountUserList;
    m_accountUserListHasBeenSet = true;
}

bool UnbindVirtualAccountsRequest::AccountUserListHasBeenSet() const
{
    return m_accountUserListHasBeenSet;
}

string UnbindVirtualAccountsRequest::GetDomainInstanceId() const
{
    return m_domainInstanceId;
}

void UnbindVirtualAccountsRequest::SetDomainInstanceId(const string& _domainInstanceId)
{
    m_domainInstanceId = _domainInstanceId;
    m_domainInstanceIdHasBeenSet = true;
}

bool UnbindVirtualAccountsRequest::DomainInstanceIdHasBeenSet() const
{
