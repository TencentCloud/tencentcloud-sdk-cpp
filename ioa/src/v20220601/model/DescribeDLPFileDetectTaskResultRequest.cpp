...
DescribeDLPFileDetectTaskResultRequest::DescribeDLPFileDetectTaskResultRequest() :
    m_domainInstanceIdHasBeenSet(false),
    m_taskRequestIdHasBeenSet(false)
{
}

string DescribeDLPFileDetectTaskResultRequest::ToJsonString() const
{
...
string DescribeDLPFileDetectTaskResultRequest::GetDomainInstanceId() const
{
    return m_domainInstanceId;
}

void DescribeDLPFileDetectTaskResultRequest::SetDomainInstanceId(const string& _domainInstanceId)
{
    m_domainInstanceId = _domainInstanceId;
    m_domainInstanceIdHasBeenSet = true;
}

bool DescribeDLPFileDetectTaskResultRequest::DomainInstanceIdHasBeenSet() const
{
    return m_domainInstanceIdHasBeenSet;
}

string DescribeDLPFileDetectTaskResultRequest::GetTaskRequestId() const
{
    return m_taskRequestId;
}

void DescribeDLPFileDetectTaskResultRequest::SetTaskRequestId(const string& _taskRequestId)
{
    m_taskRequestId = _taskRequestId;
    m_taskRequestIdHasBeenSet = true;
}

bool DescribeDLPFileDetectTaskResultRequest::TaskRequestIdHasBeenSet() const
{
