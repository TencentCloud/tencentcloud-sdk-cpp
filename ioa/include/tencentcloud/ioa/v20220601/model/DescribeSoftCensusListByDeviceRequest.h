...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBESOFTCENSUSLISTBYDEVICEREQUEST_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBESOFTCENSUSLISTBYDEVICEREQUEST_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                */
                class DescribeSoftCensusListByDeviceRequest : public AbstractModel
                {
                public:
                    DescribeSoftCensusListByDeviceRequest();
                    ~DescribeSoftCensusListByDeviceRequest() = default;
                    ...
                    /**
                     * 设置过滤条件、分页参数   <li>Name - String - 是否必填：否 - 操作符: eq,like,ilike  - 排序支持：否 - 备注：字段含义，终端名。</li> 	<li>UserName - String - 是否必填：否 - 操作符: eq,like,ilike  - 排序支持：否 - 备注：字段含义，终端用户名。</li> 	<li>IoaUserName - String - 是否必填：否 - 操作符: eq,like,ilike  - 排序支持：否 - 备注：字段含义，最近登录账号。</li> 	<li>Ip - String - 是否必填：否 - 操作符: eq,like,ilike  - 排序支持：否 - 备注：字段含义，IP地址。</li> 	<li>MacAddr - String - 是否必填：否 - 操作符: eq,like,ilike  - 排序支持：否 - 备注：字段含义，MAC地址。</li>
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBESOFTCENSUSLISTBYDEVICEREQUEST_H_
