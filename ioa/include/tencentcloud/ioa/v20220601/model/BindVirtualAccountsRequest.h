...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTSREQUEST_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTSREQUEST_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                */
                class BindVirtualAccountsRequest : public AbstractModel
                {
                public:
                    BindVirtualAccountsRequest();
                    ~BindVirtualAccountsRequest() = default;
                    ...
                    /**
                     * 获取<p>Comment: 要绑定的账户Id集合，这里的Id指的是DescribeLocalAccountsData结构体里返回的Id;Required:true</p>
                    ...
                    /**
                     * 设置<p>Comment: 要绑定的账户Id集合，这里的Id指的是DescribeLocalAccountsData结构体里返回的Id;Required:true</p>
                    ...
                    /**
                     * 获取<p>Comment: 要绑定的账户(目录MenuId+登录账号UserId)集合，与AccountIdList二选一或并用，查不到的账号会被跳过;Required:false</p>
                    ...
                    /**
                     * 设置<p>Comment: 要绑定的账户(目录MenuId+登录账号UserId)集合，与AccountIdList二选一或并用，查不到的账号会被跳过;Required:false</p>
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTSREQUEST_H_
