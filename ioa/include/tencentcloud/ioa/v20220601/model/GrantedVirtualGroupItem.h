...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_GRANTEDVIRTUALGROUPITEM_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_GRANTEDVIRTUALGROUPITEM_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                * GrantedAccountItem
                */
                class GrantedVirtualGroupItem : public AbstractModel
                {
                public:
                    GrantedVirtualGroupItem();
                    ~GrantedVirtualGroupItem() = default;
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_GRANTEDVIRTUALGROUPITEM_H_
