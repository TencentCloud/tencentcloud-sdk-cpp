...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTDATA_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTDATA_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                * 绑定账户虚拟组响应数据
                */
                class BindVirtualAccountData : public AbstractModel
                {
                public:
                    BindVirtualAccountData();
                    ~BindVirtualAccountData() = default;
                    ...
                    /**
                     * 获取<p>绑定成功明细（含幂等场景：已存在绑定的账号也归入成功）</p>
                    ...
                    /**
                     * 设置<p>绑定成功明细（含幂等场景：已存在绑定的账号也归入成功）</p>
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_BINDVIRTUALACCOUNTDATA_H_
