...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEDLPEDGENODEGROUPSREQUEST_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEDLPEDGENODEGROUPSREQUEST_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                */
                class DescribeDLPEdgeNodeGroupsRequest : public AbstractModel
                {
                public:
                    DescribeDLPEdgeNodeGroupsRequest();
                    ~DescribeDLPEdgeNodeGroupsRequest() = default;
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEDLPEDGENODEGROUPSREQUEST_H_
