...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEPROFILEFIELDSMENUREQUEST_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEPROFILEFIELDSMENUREQUEST_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                */
                class DescribeProfileFieldsMenuRequest : public AbstractModel
                {
                public:
                    DescribeProfileFieldsMenuRequest();
                    ~DescribeProfileFieldsMenuRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>查找自动填写字段</p>
                     * @return OnlyRule <p>查找自动填写字段</p>
                     * 
                     */
                    bool GetOnlyRule() const;
                     ...
                     * 
                     */
                    void SetOnlyRule(const bool& _onlyRule);

                    /**
                     * 判断参数 OnlyRule 是否已赋值
                     * @return OnlyRule 是否已赋值
                     * 
                     */
                    bool OnlyRuleHasBeenSet() const;
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_DESCRIBEPROFILEFIELDSMENUREQUEST_H_
