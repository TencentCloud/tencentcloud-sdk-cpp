...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_DEVICESERVICEINFO_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_DEVICESERVICEINFO_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                * 分页的具体数据对象
                */
                class DeviceServiceInfo : public AbstractModel
                {
                public:
                    DeviceServiceInfo();
                    ~DeviceServiceInfo() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetStartType(const int64_t& _startType);
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_DEVICESERVICEINFO_H_
