...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYACCOUNTGROUPS_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYACCOUNTGROUPS_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                * 授权操作
                */
                class GrantResourceOperationByAccountGroups : public AbstractModel
                {
                public:
                    GrantResourceOperationByAccountGroups();
                    ~GrantResourceOperationByAccountGroups() = default;
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYACCOUNTGROUPS_H_
