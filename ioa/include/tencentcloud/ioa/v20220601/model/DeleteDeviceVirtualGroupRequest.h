...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_DELETEDEVICEVIRTUALGROUPREQUEST_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_DELETEDEVICEVIRTUALGROUPREQUEST_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                */
                class DeleteDeviceVirtualGroupRequest : public AbstractModel
                {
                public:
                    DeleteDeviceVirtualGroupRequest();
                    ~DeleteDeviceVirtualGroupRequest() = default;
                    ...
                    /**
                     * 获取必填，系统类型（0: win，1：linux，2: mac，4：android，5：ios，-1：全系统（SaaS一体化版本） ； 不传默认为0）(只支持32位)
                    ...
                    /**
                     * 设置必填，系统类型（0: win，1：linux，2: mac，4：android，5：ios，-1：全系统（SaaS一体化版本） ； 不传默认为0）(只支持32位)
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_DELETEDEVICEVIRTUALGROUPREQUEST_H_
