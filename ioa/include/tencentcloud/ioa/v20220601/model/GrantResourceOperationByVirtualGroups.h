...
#ifndef TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYVIRTUALGROUPS_H_
#define TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYVIRTUALGROUPS_H_
    ...
    namespace Ioa
    {
        namespace V20220601
        {
            namespace Model
            {
                ...
                * 授权操作
                */
                class GrantResourceOperationByVirtualGroups : public AbstractModel
                {
                public:
                    GrantResourceOperationByVirtualGroups();
                    ~GrantResourceOperationByVirtualGroups() = default;
                     ...
                     * 
                     */
                    uint64_t GetVirtualAccountGroupId() const;
                     ...
                     * 
                     */
                    void SetVirtualAccountGroupId(const uint64_t& _virtualAccountGroupId);

                    /**
                     * 判断参数 VirtualAccountGroupId 是否已赋值
                     * @return VirtualAccountGroupId 是否已赋值
                     * 
                     */
                    bool VirtualAccountGroupIdHasBeenSet() const;
                ...
                private:
                     ...
                     * 分组id
                     */
                    uint64_t m_virtualAccountGroupId;
                    bool m_virtualAccountGroupIdHasBeenSet;
...
#endif // !TENCENTCLOUD_IOA_V20220601_MODEL_GRANTRESOURCEOPERATIONBYVIRTUALGROUPS_H_
