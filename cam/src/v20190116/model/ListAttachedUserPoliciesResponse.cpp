...
CoreInternalOutcome ListAttachedUserPoliciesResponse::Deserialize(const string &payload)
{
...
string ListAttachedUserPoliciesResponse::ToJsonString() const
{
...
uint64_t ListAttachedUserPoliciesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListAttachedUserPoliciesResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<AttachPolicyInfo> ListAttachedUserPoliciesResponse::GetList() const
{
    return m_list;
}

bool ListAttachedUserPoliciesResponse::ListHasBeenSet() const
{
