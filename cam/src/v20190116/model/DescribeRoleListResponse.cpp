...
vector<RoleInfo> DescribeRoleListResponse::GetList() const
{
    return m_list;
}

bool DescribeRoleListResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeRoleListResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeRoleListResponse::TotalNumHasBeenSet() const
{
