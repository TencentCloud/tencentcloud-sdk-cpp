...
CoreInternalOutcome ListAccountsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Marker") && !rsp["Marker"].IsNull())
    {
        if (!rsp["Marker"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `Marker` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_marker = string(rsp["Marker"].GetString());
...
string ListAccountsResponse::ToJsonString() const
{
...
vector<ListAllUser> ListAccountsResponse::GetUsers() const
{
    return m_users;
}

bool ListAccountsResponse::UsersHasBeenSet() const
{
    return m_usersHasBeenSet;
}

string ListAccountsResponse::GetMarker() const
{
    return m_marker;
}

bool ListAccountsResponse::MarkerHasBeenSet() const
{
    return m_markerHasBeenSet;
}

bool ListAccountsResponse::GetIsTruncated() const
{
    return m_isTruncated;
}

bool ListAccountsResponse::IsTruncatedHasBeenSet() const
{
