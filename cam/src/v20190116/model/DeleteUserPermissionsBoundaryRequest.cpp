...
string DeleteUserPermissionsBoundaryRequest::ToJsonString() const
{
...
int64_t DeleteUserPermissionsBoundaryRequest::GetTargetUin() const
{
    return m_targetUin;
}

void DeleteUserPermissionsBoundaryRequest::SetTargetUin(const int64_t& _targetUin)
{
    m_targetUin = _targetUin;
    m_targetUinHasBeenSet = true;
}

bool DeleteUserPermissionsBoundaryRequest::TargetUinHasBeenSet() const
{
