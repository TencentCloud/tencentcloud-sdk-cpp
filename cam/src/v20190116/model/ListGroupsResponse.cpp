...
uint64_t ListGroupsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListGroupsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<GroupInfo> ListGroupsResponse::GetGroupInfo() const
{
    return m_groupInfo;
}

bool ListGroupsResponse::GroupInfoHasBeenSet() const
{
