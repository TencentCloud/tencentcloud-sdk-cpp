...
CoreInternalOutcome ListPolicyVersionsResponse::Deserialize(const string &payload)
{
...
string ListPolicyVersionsResponse::ToJsonString() const
{
...
vector<PolicyVersionItem> ListPolicyVersionsResponse::GetVersions() const
{
    return m_versions;
}

bool ListPolicyVersionsResponse::VersionsHasBeenSet() const
{
