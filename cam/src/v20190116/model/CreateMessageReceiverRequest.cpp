...
string CreateMessageReceiverRequest::ToJsonString() const
{
...
string CreateMessageReceiverRequest::GetName() const
{
    return m_name;
}

void CreateMessageReceiverRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool CreateMessageReceiverRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateMessageReceiverRequest::GetCountryCode() const
{
    return m_countryCode;
}

void CreateMessageReceiverRequest::SetCountryCode(const string& _countryCode)
{
    m_countryCode = _countryCode;
    m_countryCodeHasBeenSet = true;
}

bool CreateMessageReceiverRequest::CountryCodeHasBeenSet() const
{
...
void CreateMessageReceiverRequest::SetEmail(const string& _email)
{
    m_email = _email;
...
void CreateMessageReceiverRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
    m_remarkHasBeenSet = true;
}

bool CreateMessageReceiverRequest::RemarkHasBeenSet() const
{
