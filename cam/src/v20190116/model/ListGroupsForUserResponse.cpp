...
CoreInternalOutcome ListGroupsForUserResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["GroupInfo"].IsArray())
            return CoreInternalOutcome(Core::Error("response `GroupInfo` is not array type"));

        const rapidjson::Value &tmpValue = rsp["GroupInfo"];
...
string ListGroupsForUserResponse::ToJsonString() const
{
...
uint64_t ListGroupsForUserResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListGroupsForUserResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<GroupInfo> ListGroupsForUserResponse::GetGroupInfo() const
{
    return m_groupInfo;
}

bool ListGroupsForUserResponse::GroupInfoHasBeenSet() const
{
