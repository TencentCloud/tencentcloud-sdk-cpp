...
CoreInternalOutcome ListPoliciesGrantingServiceAccessResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("List") && !rsp["List"].IsNull())
    {
        ...
        {
            ListGrantServiceAccessNode item;
...
string ListPoliciesGrantingServiceAccessResponse::ToJsonString() const
{
...
vector<ListGrantServiceAccessNode> ListPoliciesGrantingServiceAccessResponse::GetList() const
{
    return m_list;
}

bool ListPoliciesGrantingServiceAccessResponse::ListHasBeenSet() const
{
