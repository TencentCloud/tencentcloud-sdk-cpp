...
CoreInternalOutcome GetUserAppIdResponse::Deserialize(const string &payload)
{
...
string GetUserAppIdResponse::ToJsonString() const
{
...
string GetUserAppIdResponse::GetUin() const
{
    return m_uin;
}

bool GetUserAppIdResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string GetUserAppIdResponse::GetOwnerUin() const
{
    return m_ownerUin;
}

bool GetUserAppIdResponse::OwnerUinHasBeenSet() const
{
    return m_ownerUinHasBeenSet;
}

uint64_t GetUserAppIdResponse::GetAppId() const
{
    return m_appId;
}

bool GetUserAppIdResponse::AppIdHasBeenSet() const
{
