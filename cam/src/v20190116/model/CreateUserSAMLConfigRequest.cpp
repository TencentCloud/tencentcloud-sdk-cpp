...
string CreateUserSAMLConfigRequest::ToJsonString() const
{
...
string CreateUserSAMLConfigRequest::GetSAMLMetadataDocument() const
{
    return m_sAMLMetadataDocument;
}

void CreateUserSAMLConfigRequest::SetSAMLMetadataDocument(const string& _sAMLMetadataDocument)
{
