...
string GetUserPermissionBoundaryRequest::ToJsonString() const
{
...
int64_t GetUserPermissionBoundaryRequest::GetTargetUin() const
{
    return m_targetUin;
}

void GetUserPermissionBoundaryRequest::SetTargetUin(const int64_t& _targetUin)
{
    m_targetUin = _targetUin;
    m_targetUinHasBeenSet = true;
}

bool GetUserPermissionBoundaryRequest::TargetUinHasBeenSet() const
{
