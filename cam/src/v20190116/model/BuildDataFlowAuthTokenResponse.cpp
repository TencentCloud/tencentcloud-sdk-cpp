...
BuildDataFlowAuthTokenResponse::BuildDataFlowAuthTokenResponse() :
    m_credentialsHasBeenSet(false)
{
}

CoreInternalOutcome BuildDataFlowAuthTokenResponse::Deserialize(const string &payload)
{
...
string BuildDataFlowAuthTokenResponse::ToJsonString() const
{
...
AuthToken BuildDataFlowAuthTokenResponse::GetCredentials() const
{
    return m_credentials;
}

bool BuildDataFlowAuthTokenResponse::CredentialsHasBeenSet() const
{
