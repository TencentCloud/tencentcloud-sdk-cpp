...
CoreInternalOutcome ListCollaboratorsResponse::Deserialize(const string &payload)
{
...
string ListCollaboratorsResponse::ToJsonString() const
{
...
uint64_t ListCollaboratorsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListCollaboratorsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<SubAccountInfo> ListCollaboratorsResponse::GetData() const
{
    return m_data;
}

bool ListCollaboratorsResponse::DataHasBeenSet() const
{
