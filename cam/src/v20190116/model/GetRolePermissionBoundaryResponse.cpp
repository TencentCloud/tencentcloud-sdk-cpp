...
CoreInternalOutcome GetRolePermissionBoundaryResponse::Deserialize(const string &payload)
{
...
string GetRolePermissionBoundaryResponse::ToJsonString() const
{
...
int64_t GetRolePermissionBoundaryResponse::GetPolicyId() const
{
    return m_policyId;
}

bool GetRolePermissionBoundaryResponse::PolicyIdHasBeenSet() const
{
    return m_policyIdHasBeenSet;
}

string GetRolePermissionBoundaryResponse::GetPolicyName() const
{
    return m_policyName;
}

bool GetRolePermissionBoundaryResponse::PolicyNameHasBeenSet() const
{
    return m_policyNameHasBeenSet;
}

string GetRolePermissionBoundaryResponse::GetPolicyDocument() const
{
    return m_policyDocument;
}

bool GetRolePermissionBoundaryResponse::PolicyDocumentHasBeenSet() const
{
    return m_policyDocumentHasBeenSet;
}

int64_t GetRolePermissionBoundaryResponse::GetPolicyType() const
{
    return m_policyType;
}

bool GetRolePermissionBoundaryResponse::PolicyTypeHasBeenSet() const
{
    return m_policyTypeHasBeenSet;
}

int64_t GetRolePermissionBoundaryResponse::GetCreateMode() const
{
    return m_createMode;
}

bool GetRolePermissionBoundaryResponse::CreateModeHasBeenSet() const
{
