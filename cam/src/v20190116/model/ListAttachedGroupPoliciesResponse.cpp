...
CoreInternalOutcome ListAttachedGroupPoliciesResponse::Deserialize(const string &payload)
{
...
string ListAttachedGroupPoliciesResponse::ToJsonString() const
{
...
uint64_t ListAttachedGroupPoliciesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListAttachedGroupPoliciesResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<AttachPolicyInfo> ListAttachedGroupPoliciesResponse::GetList() const
{
    return m_list;
}

bool ListAttachedGroupPoliciesResponse::ListHasBeenSet() const
{
