...
CoreInternalOutcome GetCustomMFATokenInfoResponse::Deserialize(const string &payload)
{
...
string GetCustomMFATokenInfoResponse::ToJsonString() const
{
...
uint64_t GetCustomMFATokenInfoResponse::GetUin() const
{
    return m_uin;
}

bool GetCustomMFATokenInfoResponse::UinHasBeenSet() const
{
