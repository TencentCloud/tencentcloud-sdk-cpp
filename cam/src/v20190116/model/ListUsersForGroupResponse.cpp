...
CoreInternalOutcome ListUsersForGroupResponse::Deserialize(const string &payload)
{
...
string ListUsersForGroupResponse::ToJsonString() const
{
...
uint64_t ListUsersForGroupResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListUsersForGroupResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<GroupMemberInfo> ListUsersForGroupResponse::GetUserInfo() const
{
    return m_userInfo;
}

bool ListUsersForGroupResponse::UserInfoHasBeenSet() const
{
