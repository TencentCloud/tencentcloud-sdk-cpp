...
CoreInternalOutcome ListAttachedRolePoliciesResponse::Deserialize(const string &payload)
{
...
string ListAttachedRolePoliciesResponse::ToJsonString() const
{
...
vector<AttachedPolicyOfRole> ListAttachedRolePoliciesResponse::GetList() const
{
    return m_list;
}

bool ListAttachedRolePoliciesResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t ListAttachedRolePoliciesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListAttachedRolePoliciesResponse::TotalNumHasBeenSet() const
{
