...
#ifndef TENCENTCLOUD_CAM_V20190116_MODEL_CREATEUSEROIDCCONFIGREQUEST_H_
#define TENCENTCLOUD_CAM_V20190116_MODEL_CREATEUSEROIDCCONFIGREQUEST_H_
    ...
    namespace Cam
    {
        namespace V20190116
        {
            namespace Model
            {
                ...
                */
                class CreateUserOIDCConfigRequest : public AbstractModel
                {
                public:
                    CreateUserOIDCConfigRequest();
                    ~CreateUserOIDCConfigRequest() = default;
...
对应企业IdP提供的Openid-configuration中"issuer"字段的值。
                    ...
                    /**
                     * 获取OIDC公钥自动轮转开关（默认为0代表关闭，1代表开启）如果不传的话会默认置0
                     * @return AutoRotateKey OIDC公钥自动轮转开关（默认为0代表关闭，1代表开启）如果不传的话会默认置0
                     * 
                     */
                    uint64_t GetAutoRotateKey() const;

                    /**
                     * 设置OIDC公钥自动轮转开关（默认为0代表关闭，1代表开启）如果不传的话会默认置0
...
#endif // !TENCENTCLOUD_CAM_V20190116_MODEL_CREATEUSEROIDCCONFIGREQUEST_H_
