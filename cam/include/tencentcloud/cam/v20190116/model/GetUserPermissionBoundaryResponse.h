...
#ifndef TENCENTCLOUD_CAM_V20190116_MODEL_GETUSERPERMISSIONBOUNDARYRESPONSE_H_
#define TENCENTCLOUD_CAM_V20190116_MODEL_GETUSERPERMISSIONBOUNDARYRESPONSE_H_
    ...
    namespace Cam
    {
        namespace V20190116
        {
            namespace Model
            {
                ...
                */
                class GetUserPermissionBoundaryResponse : public AbstractModel
                {
                public:
                    GetUserPermissionBoundaryResponse();
                    ~GetUserPermissionBoundaryResponse() = default;
...
#endif // !TENCENTCLOUD_CAM_V20190116_MODEL_GETUSERPERMISSIONBOUNDARYRESPONSE_H_
