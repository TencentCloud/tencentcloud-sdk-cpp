...
CoreInternalOutcome CreatePrefetchTaskResponse::Deserialize(const string &payload)
{
...
string CreatePrefetchTaskResponse::ToJsonString() const
{
...
string CreatePrefetchTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool CreatePrefetchTaskResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<FailReason> CreatePrefetchTaskResponse::GetFailedList() const
{
    return m_failedList;
}

bool CreatePrefetchTaskResponse::FailedListHasBeenSet() const
{
