...
CoreInternalOutcome DeleteOriginGroupResponse::Deserialize(const string &payload)
{
...
string DeleteOriginGroupResponse::ToJsonString() const
{
...
string DeleteOriginGroupResponse::GetOriginId() const
{
    return m_originId;
}

bool DeleteOriginGroupResponse::OriginIdHasBeenSet() const
{
