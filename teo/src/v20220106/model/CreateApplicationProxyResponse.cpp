...
CoreInternalOutcome CreateApplicationProxyResponse::Deserialize(const string &payload)
{
...
string CreateApplicationProxyResponse::ToJsonString() const
{
...
string CreateApplicationProxyResponse::GetProxyId() const
{
    return m_proxyId;
}

bool CreateApplicationProxyResponse::ProxyIdHasBeenSet() const
{
