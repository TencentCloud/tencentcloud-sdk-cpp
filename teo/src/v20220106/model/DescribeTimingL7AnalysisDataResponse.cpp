...
CoreInternalOutcome DescribeTimingL7AnalysisDataResponse::Deserialize(const string &payload)
{
...
string DescribeTimingL7AnalysisDataResponse::ToJsonString() const
{
...
vector<TimingDataRecord> DescribeTimingL7AnalysisDataResponse::GetData() const
{
    return m_data;
}

bool DescribeTimingL7AnalysisDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeTimingL7AnalysisDataResponse::GetType() const
{
    return m_type;
}

bool DescribeTimingL7AnalysisDataResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string DescribeTimingL7AnalysisDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeTimingL7AnalysisDataResponse::IntervalHasBeenSet() const
{
