...
CoreInternalOutcome DescribeDDosAttackEventDetailResponse::Deserialize(const string &payload)
{
...
string DescribeDDosAttackEventDetailResponse::ToJsonString() const
{
...
DDosAttackEventDetailData DescribeDDosAttackEventDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeDDosAttackEventDetailResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeDDosAttackEventDetailResponse::GetStatus() const
{
    return m_status;
}

bool DescribeDDosAttackEventDetailResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeDDosAttackEventDetailResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDDosAttackEventDetailResponse::MsgHasBeenSet() const
{
