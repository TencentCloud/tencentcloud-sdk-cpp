...
CoreInternalOutcome DeleteApplicationProxyResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationProxyResponse::ToJsonString() const
{
...
string DeleteApplicationProxyResponse::GetProxyId() const
{
    return m_proxyId;
}

bool DeleteApplicationProxyResponse::ProxyIdHasBeenSet() const
{
