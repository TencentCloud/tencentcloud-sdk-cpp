...
CoreInternalOutcome DescribeHostsSettingResponse::Deserialize(const string &payload)
{
...
string DescribeHostsSettingResponse::ToJsonString() const
{
...
vector<DetailHost> DescribeHostsSettingResponse::GetHosts() const
{
    return m_hosts;
}

bool DescribeHostsSettingResponse::HostsHasBeenSet() const
{
    return m_hostsHasBeenSet;
}

int64_t DescribeHostsSettingResponse::GetTotalNumber() const
{
    return m_totalNumber;
}

bool DescribeHostsSettingResponse::TotalNumberHasBeenSet() const
{
