...
CoreInternalOutcome CreatePurgeTaskResponse::Deserialize(const string &payload)
{
...
string CreatePurgeTaskResponse::ToJsonString() const
{
...
string CreatePurgeTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool CreatePurgeTaskResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<FailReason> CreatePurgeTaskResponse::GetFailedList() const
{
    return m_failedList;
}

bool CreatePurgeTaskResponse::FailedListHasBeenSet() const
{
