...
CoreInternalOutcome DescribeSecurityPolicyManagedRulesIdResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityPolicyManagedRulesIdResponse::ToJsonString() const
{
...
int64_t DescribeSecurityPolicyManagedRulesIdResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSecurityPolicyManagedRulesIdResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ManagedRule> DescribeSecurityPolicyManagedRulesIdResponse::GetRules() const
{
    return m_rules;
}
