...
CoreInternalOutcome CreateDnsRecordResponse::Deserialize(const string &payload)
{
...
string CreateDnsRecordResponse::ToJsonString() const
{
...
string CreateDnsRecordResponse::GetId() const
{
    return m_id;
}

bool CreateDnsRecordResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateDnsRecordResponse::GetType() const
{
    return m_type;
}

bool CreateDnsRecordResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string CreateDnsRecordResponse::GetName() const
{
    return m_name;
}

bool CreateDnsRecordResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateDnsRecordResponse::GetContent() const
{
    return m_content;
}

bool CreateDnsRecordResponse::ContentHasBeenSet() const
{
    return m_contentHasBeenSet;
}

int64_t CreateDnsRecordResponse::GetTtl() const
{
    return m_ttl;
}

bool CreateDnsRecordResponse::TtlHasBeenSet() const
{
    return m_ttlHasBeenSet;
}

int64_t CreateDnsRecordResponse::GetPriority() const
{
    return m_priority;
}

bool CreateDnsRecordResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

string CreateDnsRecordResponse::GetMode() const
{
    return m_mode;
}

bool CreateDnsRecordResponse::ModeHasBeenSet() const
{
    return m_modeHasBeenSet;
}

string CreateDnsRecordResponse::GetStatus() const
{
    return m_status;
}

bool CreateDnsRecordResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

bool CreateDnsRecordResponse::GetLocked() const
{
    return m_locked;
}

bool CreateDnsRecordResponse::LockedHasBeenSet() const
{
    return m_lockedHasBeenSet;
}

string CreateDnsRecordResponse::GetCreatedOn() const
{
    return m_createdOn;
}

bool CreateDnsRecordResponse::CreatedOnHasBeenSet() const
{
    return m_createdOnHasBeenSet;
}

string CreateDnsRecordResponse::GetModifiedOn() const
{
    return m_modifiedOn;
}

bool CreateDnsRecordResponse::ModifiedOnHasBeenSet() const
{
    return m_modifiedOnHasBeenSet;
}

string CreateDnsRecordResponse::GetZoneId() const
{
    return m_zoneId;
}

bool CreateDnsRecordResponse::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string CreateDnsRecordResponse::GetZoneName() const
{
    return m_zoneName;
}

bool CreateDnsRecordResponse::ZoneNameHasBeenSet() const
{
    return m_zoneNameHasBeenSet;
}

string CreateDnsRecordResponse::GetCname() const
{
    return m_cname;
}

bool CreateDnsRecordResponse::CnameHasBeenSet() const
{
