...
CoreInternalOutcome DescribeWebManagedRulesDataResponse::Deserialize(const string &payload)
{
...
string DescribeWebManagedRulesDataResponse::ToJsonString() const
{
...
vector<SecEntry> DescribeWebManagedRulesDataResponse::GetData() const
{
    return m_data;
}

bool DescribeWebManagedRulesDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeWebManagedRulesDataResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebManagedRulesDataResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebManagedRulesDataResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebManagedRulesDataResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribeWebManagedRulesDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeWebManagedRulesDataResponse::IntervalHasBeenSet() const
{
