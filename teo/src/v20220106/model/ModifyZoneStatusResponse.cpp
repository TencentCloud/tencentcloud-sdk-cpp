...
CoreInternalOutcome ModifyZoneStatusResponse::Deserialize(const string &payload)
{
...
string ModifyZoneStatusResponse::ToJsonString() const
{
...
string ModifyZoneStatusResponse::GetId() const
{
    return m_id;
}

bool ModifyZoneStatusResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string ModifyZoneStatusResponse::GetName() const
{
    return m_name;
}

bool ModifyZoneStatusResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

bool ModifyZoneStatusResponse::GetPaused() const
{
    return m_paused;
}

bool ModifyZoneStatusResponse::PausedHasBeenSet() const
{
    return m_pausedHasBeenSet;
}

string ModifyZoneStatusResponse::GetModifiedOn() const
{
    return m_modifiedOn;
}

bool ModifyZoneStatusResponse::ModifiedOnHasBeenSet() const
{
