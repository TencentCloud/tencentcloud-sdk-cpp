...
CoreInternalOutcome ModifyOriginGroupResponse::Deserialize(const string &payload)
{
...
string ModifyOriginGroupResponse::ToJsonString() const
{
...
string ModifyOriginGroupResponse::GetOriginId() const
{
    return m_originId;
}

bool ModifyOriginGroupResponse::OriginIdHasBeenSet() const
{
