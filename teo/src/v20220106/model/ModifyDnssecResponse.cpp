...
CoreInternalOutcome ModifyDnssecResponse::Deserialize(const string &payload)
{
...
string ModifyDnssecResponse::ToJsonString() const
{
...
string ModifyDnssecResponse::GetId() const
{
    return m_id;
}

bool ModifyDnssecResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string ModifyDnssecResponse::GetName() const
{
    return m_name;
}

bool ModifyDnssecResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string ModifyDnssecResponse::GetStatus() const
{
    return m_status;
}

bool ModifyDnssecResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

DnssecInfo ModifyDnssecResponse::GetDnssec() const
{
    return m_dnssec;
}

bool ModifyDnssecResponse::DnssecHasBeenSet() const
{
    return m_dnssecHasBeenSet;
}

string ModifyDnssecResponse::GetModifiedOn() const
{
    return m_modifiedOn;
}

bool ModifyDnssecResponse::ModifiedOnHasBeenSet() const
{
