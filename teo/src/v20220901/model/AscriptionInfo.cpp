...
CoreInternalOutcome AscriptionInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Subdomain") && !value["Subdomain"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AscriptionInfo.Subdomain` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RecordType") && !value["RecordType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AscriptionInfo.RecordType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RecordValue") && !value["RecordValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AscriptionInfo.RecordValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void AscriptionInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string AscriptionInfo::GetSubdomain() const
{
    return m_subdomain;
}

void AscriptionInfo::SetSubdomain(const string& _subdomain)
{
    m_subdomain = _subdomain;
    m_subdomainHasBeenSet = true;
}

bool AscriptionInfo::SubdomainHasBeenSet() const
{
    return m_subdomainHasBeenSet;
}

string AscriptionInfo::GetRecordType() const
{
    return m_recordType;
}

void AscriptionInfo::SetRecordType(const string& _recordType)
{
    m_recordType = _recordType;
    m_recordTypeHasBeenSet = true;
}

bool AscriptionInfo::RecordTypeHasBeenSet() const
{
    return m_recordTypeHasBeenSet;
}

string AscriptionInfo::GetRecordValue() const
{
    return m_recordValue;
}

void AscriptionInfo::SetRecordValue(const string& _recordValue)
{
    m_recordValue = _recordValue;
    m_recordValueHasBeenSet = true;
}

bool AscriptionInfo::RecordValueHasBeenSet() const
{
