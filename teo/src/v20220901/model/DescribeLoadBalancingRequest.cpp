...
vector<AdvancedFilter> DescribeLoadBalancingRequest::GetFilters() const
{
    return m_filters;
}

void DescribeLoadBalancingRequest::SetFilters(const vector<AdvancedFilter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeLoadBalancingRequest::FiltersHasBeenSet() const
{
