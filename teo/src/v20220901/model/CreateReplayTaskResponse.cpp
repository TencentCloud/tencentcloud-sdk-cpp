...
CoreInternalOutcome CreateReplayTaskResponse::Deserialize(const string &payload)
{
...
string CreateReplayTaskResponse::ToJsonString() const
{
...
string CreateReplayTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateReplayTaskResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<FailReason> CreateReplayTaskResponse::GetFailedList() const
{
    return m_failedList;
}

bool CreateReplayTaskResponse::FailedListHasBeenSet() const
{
