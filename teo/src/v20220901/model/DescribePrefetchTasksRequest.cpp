...
vector<AdvancedFilter> DescribePrefetchTasksRequest::GetFilters() const
{
    return m_filters;
}

void DescribePrefetchTasksRequest::SetFilters(const vector<AdvancedFilter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribePrefetchTasksRequest::FiltersHasBeenSet() const
{
