...
vector<TopEntry> DescribeDDoSAttackTopDataResponse::GetData() const
{
    return m_data;
}
...
uint64_t DescribeDDoSAttackTopDataResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDDoSAttackTopDataResponse::TotalCountHasBeenSet() const
{
