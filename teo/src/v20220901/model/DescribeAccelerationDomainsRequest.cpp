...
string DescribeAccelerationDomainsRequest::ToJsonString() const
{
...
string DescribeAccelerationDomainsRequest::GetZoneId() const
{
    return m_zoneId;
}

void DescribeAccelerationDomainsRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool DescribeAccelerationDomainsRequest::ZoneIdHasBeenSet() const
{
...
void DescribeAccelerationDomainsRequest::SetFilters(const vector<AdvancedFilter>& _filters)
{
    m_filters = _filters;
...
void DescribeAccelerationDomainsRequest::SetDirection(const string& _direction)
{
    m_direction = _direction;
    m_directionHasBeenSet = true;
}

bool DescribeAccelerationDomainsRequest::DirectionHasBeenSet() const
{
    return m_directionHasBeenSet;
}

string DescribeAccelerationDomainsRequest::GetMatch() const
{
    return m_match;
}

void DescribeAccelerationDomainsRequest::SetMatch(const string& _match)
{
    m_match = _match;
