...
CoreInternalOutcome SourceIDC::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BaseAction") && !value["BaseAction"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SourceIDC.BaseAction` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BotManagementActionOverrides") && !value["BotManagementActionOverrides"].IsNull())
    {
        if (!value["BotManagementActionOverrides"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SourceIDC.BotManagementActionOverrides` is not array type"));
...
void SourceIDC::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
SecurityAction SourceIDC::GetBaseAction() const
{
    return m_baseAction;
}

void SourceIDC::SetBaseAction(const SecurityAction& _baseAction)
{
    m_baseAction = _baseAction;
    m_baseActionHasBeenSet = true;
}

bool SourceIDC::BaseActionHasBeenSet() const
{
    return m_baseActionHasBeenSet;
}

vector<BotManagementActionOverrides> SourceIDC::GetBotManagementActionOverrides() const
{
    return m_botManagementActionOverrides;
}

void SourceIDC::SetBotManagementActionOverrides(const vector<BotManagementActionOverrides>& _botManagementActionOverrides)
{
    m_botManagementActionOverrides = _botManagementActionOverrides;
    m_botManagementActionOverridesHasBeenSet = true;
}

bool SourceIDC::BotManagementActionOverridesHasBeenSet() const
{
