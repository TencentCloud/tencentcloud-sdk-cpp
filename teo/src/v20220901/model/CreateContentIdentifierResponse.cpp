...
CoreInternalOutcome CreateContentIdentifierResponse::Deserialize(const string &payload)
{
...
string CreateContentIdentifierResponse::ToJsonString() const
{
...
string CreateContentIdentifierResponse::GetContentId() const
{
    return m_contentId;
}

bool CreateContentIdentifierResponse::ContentIdHasBeenSet() const
{
