...
CoreInternalOutcome DescribeMultiPathGatewaySecretKeyResponse::Deserialize(const string &payload)
{
...
string DescribeMultiPathGatewaySecretKeyResponse::ToJsonString() const
{
...
string DescribeMultiPathGatewaySecretKeyResponse::GetSecretKey() const
{
    return m_secretKey;
}

bool DescribeMultiPathGatewaySecretKeyResponse::SecretKeyHasBeenSet() const
{
