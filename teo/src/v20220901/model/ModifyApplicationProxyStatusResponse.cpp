...
CoreInternalOutcome ModifyApplicationProxyStatusResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationProxyStatusResponse::ToJsonString() const
{
