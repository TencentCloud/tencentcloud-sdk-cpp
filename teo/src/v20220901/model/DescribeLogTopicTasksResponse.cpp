...
CoreInternalOutcome DescribeLogTopicTasksResponse::Deserialize(const string &payload)
{
...
string DescribeLogTopicTasksResponse::ToJsonString() const
{
...
vector<ClsLogTopicInfo> DescribeLogTopicTasksResponse::GetTopicList() const
{
    return m_topicList;
}

bool DescribeLogTopicTasksResponse::TopicListHasBeenSet() const
{
    return m_topicListHasBeenSet;
}

uint64_t DescribeLogTopicTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLogTopicTasksResponse::TotalCountHasBeenSet() const
{
