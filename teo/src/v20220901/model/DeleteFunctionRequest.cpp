...
string DeleteFunctionRequest::GetZoneId() const
{
    return m_zoneId;
}

void DeleteFunctionRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool DeleteFunctionRequest::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string DeleteFunctionRequest::GetFunctionId() const
{
    return m_functionId;
}

void DeleteFunctionRequest::SetFunctionId(const string& _functionId)
{
    m_functionId = _functionId;
    m_functionIdHasBeenSet = true;
}

bool DeleteFunctionRequest::FunctionIdHasBeenSet() const
{
