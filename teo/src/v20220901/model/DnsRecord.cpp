...
CoreInternalOutcome DnsRecord::Deserialize(const rapidjson::Value &value)
{
    ...
    {
        if (!value["DnsRecordId"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `DnsRecord.DnsRecordId` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_dnsRecordId = string(value["DnsRecordId"].GetString());
        m_dnsRecordIdHasBeenSet = true;
    }

    if (value.HasMember("DnsRecordType") && !value["DnsRecordType"].IsNull())
    {
        if (!value["DnsRecordType"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `DnsRecord.DnsRecordType` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_dnsRecordType = string(value["DnsRecordType"].GetString());
        m_dnsRecordTypeHasBeenSet = true;
    }

    if (value.HasMember("DnsRecordName") && !value["DnsRecordName"].IsNull())
    {
        if (!value["DnsRecordName"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `DnsRecord.DnsRecordName` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_dnsRecordName = string(value["DnsRecordName"].GetString());
...
void DnsRecord::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_dnsRecordIdHasBeenSet)
    {
        ...
        value.AddMember(iKey, rapidjson::Value(m_dnsRecordId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_dnsRecordTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_dnsRecordType.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_dnsRecordNameHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_dnsRecordName.c_str(), allocator).Move(), allocator);
    }
...
string DnsRecord::GetDnsRecordId() const
{
    return m_dnsRecordId;
}

void DnsRecord::SetDnsRecordId(const string& _dnsRecordId)
{
    m_dnsRecordId = _dnsRecordId;
    m_dnsRecordIdHasBeenSet = true;
}

bool DnsRecord::DnsRecordIdHasBeenSet() const
{
    return m_dnsRecordIdHasBeenSet;
}

string DnsRecord::GetDnsRecordType() const
{
    return m_dnsRecordType;
}

void DnsRecord::SetDnsRecordType(const string& _dnsRecordType)
{
    m_dnsRecordType = _dnsRecordType;
    m_dnsRecordTypeHasBeenSet = true;
}

bool DnsRecord::DnsRecordTypeHasBeenSet() const
{
    return m_dnsRecordTypeHasBeenSet;
}

string DnsRecord::GetDnsRecordName() const
{
    return m_dnsRecordName;
}

void DnsRecord::SetDnsRecordName(const string& _dnsRecordName)
{
    m_dnsRecordName = _dnsRecordName;
    m_dnsRecordNameHasBeenSet = true;
}

bool DnsRecord::DnsRecordNameHasBeenSet() const
{
