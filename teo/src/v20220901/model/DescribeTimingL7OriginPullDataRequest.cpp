...
string DescribeTimingL7OriginPullDataRequest::ToJsonString() const
{
...
void DescribeTimingL7OriginPullDataRequest::SetStartTime(const string& _startTime)
{
    m_startTime = _startTime;
    m_startTimeHasBeenSet = true;
}

bool DescribeTimingL7OriginPullDataRequest::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeTimingL7OriginPullDataRequest::GetEndTime() const
{
    return m_endTime;
}

void DescribeTimingL7OriginPullDataRequest::SetEndTime(const string& _endTime)
{
    m_endTime = _endTime;
    m_endTimeHasBeenSet = true;
}

bool DescribeTimingL7OriginPullDataRequest::EndTimeHasBeenSet() const
{
...
void DescribeTimingL7OriginPullDataRequest::SetInterval(const string& _interval)
{
    m_interval = _interval;
    m_intervalHasBeenSet = true;
}

bool DescribeTimingL7OriginPullDataRequest::IntervalHasBeenSet() const
{
    return m_intervalHasBeenSet;
}

vector<QueryCondition> DescribeTimingL7OriginPullDataRequest::GetFilters() const
{
    return m_filters;
}

void DescribeTimingL7OriginPullDataRequest::SetFilters(const vector<QueryCondition>& _filters)
{
    m_filters = _filters;
