...
CoreInternalOutcome DeleteSecurityClientAttesterResponse::Deserialize(const string &payload)
{
...
string DeleteSecurityClientAttesterResponse::ToJsonString() const
{
