...
vector<QueryCondition> DescribeWebProtectionDataRequest::GetQueryCondition() const
{
    return m_queryCondition;
}

void DescribeWebProtectionDataRequest::SetQueryCondition(const vector<QueryCondition>& _queryCondition)
{
