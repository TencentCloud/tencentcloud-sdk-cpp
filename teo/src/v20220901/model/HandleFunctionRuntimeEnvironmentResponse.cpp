...
CoreInternalOutcome HandleFunctionRuntimeEnvironmentResponse::Deserialize(const string &payload)
{
...
string HandleFunctionRuntimeEnvironmentResponse::ToJsonString() const
{
