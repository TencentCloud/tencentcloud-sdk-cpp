...
CoreInternalOutcome ClientFiltering::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Id") && !value["Id"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ClientFiltering.Id` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string ClientFiltering::GetId() const
{
    return m_id;
}

void ClientFiltering::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool ClientFiltering::IdHasBeenSet() const
{
