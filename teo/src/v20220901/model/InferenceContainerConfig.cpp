...
CoreInternalOutcome InferenceContainerConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ImageType") && !value["ImageType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InferenceContainerConfig.ImageType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TcrRepositoryConfig") && !value["TcrRepositoryConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InferenceContainerConfig.TcrRepositoryConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("StartupCommand") && !value["StartupCommand"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InferenceContainerConfig.StartupCommand` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EnvironmentVariables") && !value["EnvironmentVariables"].IsNull())
    {
        if (!value["EnvironmentVariables"].IsArray())
            return CoreInternalOutcome(Core::Error("response `InferenceContainerConfig.EnvironmentVariables` is not array type"));
...
void InferenceContainerConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string InferenceContainerConfig::GetImageType() const
{
    return m_imageType;
}

void InferenceContainerConfig::SetImageType(const string& _imageType)
{
    m_imageType = _imageType;
    m_imageTypeHasBeenSet = true;
}

bool InferenceContainerConfig::ImageTypeHasBeenSet() const
{
    return m_imageTypeHasBeenSet;
}

InferenceTCRRepositoryConfig InferenceContainerConfig::GetTcrRepositoryConfig() const
{
    return m_tcrRepositoryConfig;
}

void InferenceContainerConfig::SetTcrRepositoryConfig(const InferenceTCRRepositoryConfig& _tcrRepositoryConfig)
{
    m_tcrRepositoryConfig = _tcrRepositoryConfig;
    m_tcrRepositoryConfigHasBeenSet = true;
}

bool InferenceContainerConfig::TcrRepositoryConfigHasBeenSet() const
{
    return m_tcrRepositoryConfigHasBeenSet;
}

string InferenceContainerConfig::GetStartupCommand() const
{
    return m_startupCommand;
}

void InferenceContainerConfig::SetStartupCommand(const string& _startupCommand)
{
    m_startupCommand = _startupCommand;
    m_startupCommandHasBeenSet = true;
}

bool InferenceContainerConfig::StartupCommandHasBeenSet() const
{
    return m_startupCommandHasBeenSet;
}

vector<InferenceEnvironmentVariable> InferenceContainerConfig::GetEnvironmentVariables() const
{
    return m_environmentVariables;
}

void InferenceContainerConfig::SetEnvironmentVariables(const vector<InferenceEnvironmentVariable>& _environmentVariables)
{
    m_environmentVariables = _environmentVariables;
    m_environmentVariablesHasBeenSet = true;
}

bool InferenceContainerConfig::EnvironmentVariablesHasBeenSet() const
{
