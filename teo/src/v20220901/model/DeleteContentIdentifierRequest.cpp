...
string DeleteContentIdentifierRequest::ToJsonString() const
{
...
string DeleteContentIdentifierRequest::GetContentId() const
{
    return m_contentId;
}

void DeleteContentIdentifierRequest::SetContentId(const string& _contentId)
{
    m_contentId = _contentId;
    m_contentIdHasBeenSet = true;
}

bool DeleteContentIdentifierRequest::ContentIdHasBeenSet() const
{
