...
CoreInternalOutcome CreateL4ProxyResponse::Deserialize(const string &payload)
{
...
string CreateL4ProxyResponse::ToJsonString() const
{
...
string CreateL4ProxyResponse::GetProxyId() const
{
    return m_proxyId;
}

bool CreateL4ProxyResponse::ProxyIdHasBeenSet() const
{
