...
string DescribeIPRegionRequest::ToJsonString() const
{
...
vector<string> DescribeIPRegionRequest::GetIPs() const
{
    return m_iPs;
}

void DescribeIPRegionRequest::SetIPs(const vector<string>& _iPs)
{
    m_iPs = _iPs;
    m_iPsHasBeenSet = true;
}

bool DescribeIPRegionRequest::IPsHasBeenSet() const
{
