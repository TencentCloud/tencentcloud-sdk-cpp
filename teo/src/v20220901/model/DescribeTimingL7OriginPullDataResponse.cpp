...
CoreInternalOutcome DescribeTimingL7OriginPullDataResponse::Deserialize(const string &payload)
{
...
string DescribeTimingL7OriginPullDataResponse::ToJsonString() const
{
...
uint64_t DescribeTimingL7OriginPullDataResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTimingL7OriginPullDataResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TimingDataRecord> DescribeTimingL7OriginPullDataResponse::GetTimingDataRecords() const
{
    return m_timingDataRecords;
}

bool DescribeTimingL7OriginPullDataResponse::TimingDataRecordsHasBeenSet() const
{
