...
CoreInternalOutcome ModifySecurityWafGroupPolicyResponse::Deserialize(const string &payload)
{
...
string ModifySecurityWafGroupPolicyResponse::ToJsonString() const
{
