...
CoreInternalOutcome CreateConfigGroupVersionResponse::Deserialize(const string &payload)
{
...
string CreateConfigGroupVersionResponse::ToJsonString() const
{
...
string CreateConfigGroupVersionResponse::GetVersionId() const
{
    return m_versionId;
}

bool CreateConfigGroupVersionResponse::VersionIdHasBeenSet() const
{
