...
vector<LogSetInfo> DescribeLogSetsResponse::GetLogSetList() const
{
    return m_logSetList;
}

bool DescribeLogSetsResponse::LogSetListHasBeenSet() const
{
    return m_logSetListHasBeenSet;
}

uint64_t DescribeLogSetsResponse::GetTotalCount() const
{
    return m_totalCount;
}
