...
CoreInternalOutcome ModifyRealtimeLogDeliveryTaskResponse::Deserialize(const string &payload)
{
...
string ModifyRealtimeLogDeliveryTaskResponse::ToJsonString() const
{
