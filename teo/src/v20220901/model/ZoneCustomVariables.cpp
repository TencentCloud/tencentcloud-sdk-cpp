...
CoreInternalOutcome ZoneCustomVariables::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CustomVariables") && !value["CustomVariables"].IsNull())
    {
        if (!value["CustomVariables"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ZoneCustomVariables.CustomVariables` is not array type"));
    ...
    if (value.HasMember("CustomVariableOperations") && !value["CustomVariableOperations"].IsNull())
    {
        if (!value["CustomVariableOperations"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ZoneCustomVariables.CustomVariableOperations` is not array type"));
...
void ZoneCustomVariables::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<CustomVariable> ZoneCustomVariables::GetCustomVariables() const
{
    return m_customVariables;
}

void ZoneCustomVariables::SetCustomVariables(const vector<CustomVariable>& _customVariables)
{
    m_customVariables = _customVariables;
    m_customVariablesHasBeenSet = true;
}

bool ZoneCustomVariables::CustomVariablesHasBeenSet() const
{
    return m_customVariablesHasBeenSet;
}

vector<CustomVariableOperation> ZoneCustomVariables::GetCustomVariableOperations() const
{
    return m_customVariableOperations;
}

void ZoneCustomVariables::SetCustomVariableOperations(const vector<CustomVariableOperation>& _customVariableOperations)
{
    m_customVariableOperations = _customVariableOperations;
    m_customVariableOperationsHasBeenSet = true;
}

bool ZoneCustomVariables::CustomVariableOperationsHasBeenSet() const
{
