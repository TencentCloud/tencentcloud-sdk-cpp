...
CoreInternalOutcome CreateSecurityIPGroupResponse::Deserialize(const string &payload)
{
...
string CreateSecurityIPGroupResponse::ToJsonString() const
{
...
int64_t CreateSecurityIPGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateSecurityIPGroupResponse::GroupIdHasBeenSet() const
{
