...
CreateMultiPathGatewayResponse::CreateMultiPathGatewayResponse() :
    m_gatewayIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateMultiPathGatewayResponse::Deserialize(const string &payload)
{
...
string CreateMultiPathGatewayResponse::ToJsonString() const
{
...
string CreateMultiPathGatewayResponse::GetGatewayId() const
{
    return m_gatewayId;
}

bool CreateMultiPathGatewayResponse::GatewayIdHasBeenSet() const
{
