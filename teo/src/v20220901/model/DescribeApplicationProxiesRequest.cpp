...
string DescribeApplicationProxiesRequest::ToJsonString() const
{
...
void DescribeApplicationProxiesRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeApplicationProxiesRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeApplicationProxiesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeApplicationProxiesRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
