...
CoreInternalOutcome CreatePlanResponse::Deserialize(const string &payload)
{
...
string CreatePlanResponse::ToJsonString() const
{
...
string CreatePlanResponse::GetPlanId() const
{
    return m_planId;
}

bool CreatePlanResponse::PlanIdHasBeenSet() const
{
    return m_planIdHasBeenSet;
}

string CreatePlanResponse::GetDealName() const
{
    return m_dealName;
}

bool CreatePlanResponse::DealNameHasBeenSet() const
{
