...
CreateInferenceAPITokenResponse::CreateInferenceAPITokenResponse() :
    m_tokenIdHasBeenSet(false),
    m_contentHasBeenSet(false)
{
}

CoreInternalOutcome CreateInferenceAPITokenResponse::Deserialize(const string &payload)
{
...
string CreateInferenceAPITokenResponse::ToJsonString() const
{
...
string CreateInferenceAPITokenResponse::GetTokenId() const
{
    return m_tokenId;
}

bool CreateInferenceAPITokenResponse::TokenIdHasBeenSet() const
{
    return m_tokenIdHasBeenSet;
}

string CreateInferenceAPITokenResponse::GetContent() const
{
    return m_content;
}

bool CreateInferenceAPITokenResponse::ContentHasBeenSet() const
{
