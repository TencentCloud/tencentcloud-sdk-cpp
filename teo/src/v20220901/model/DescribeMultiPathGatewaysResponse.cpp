...
CoreInternalOutcome DescribeMultiPathGatewaysResponse::Deserialize(const string &payload)
{
...
string DescribeMultiPathGatewaysResponse::ToJsonString() const
{
...
vector<MultiPathGateway> DescribeMultiPathGatewaysResponse::GetGateways() const
{
    return m_gateways;
}

bool DescribeMultiPathGatewaysResponse::GatewaysHasBeenSet() const
{
    return m_gatewaysHasBeenSet;
}

int64_t DescribeMultiPathGatewaysResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMultiPathGatewaysResponse::TotalCountHasBeenSet() const
{
