...
CoreInternalOutcome UserRiskProfile::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("HighRiskMinScore") && !value["HighRiskMinScore"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UserRiskProfile.HighRiskMinScore` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HighRiskRequestAction") && !value["HighRiskRequestAction"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UserRiskProfile.HighRiskRequestAction` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediumRiskMinScore") && !value["MediumRiskMinScore"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UserRiskProfile.MediumRiskMinScore` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediumRiskRequestAction") && !value["MediumRiskRequestAction"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `UserRiskProfile.MediumRiskRequestAction` is not object type").SetRequestId(requestId));
        }
...
void UserRiskProfile::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
uint64_t UserRiskProfile::GetHighRiskMinScore() const
{
    return m_highRiskMinScore;
}

void UserRiskProfile::SetHighRiskMinScore(const uint64_t& _highRiskMinScore)
{
    m_highRiskMinScore = _highRiskMinScore;
    m_highRiskMinScoreHasBeenSet = true;
}

bool UserRiskProfile::HighRiskMinScoreHasBeenSet() const
{
    return m_highRiskMinScoreHasBeenSet;
}

SecurityAction UserRiskProfile::GetHighRiskRequestAction() const
{
    return m_highRiskRequestAction;
}

void UserRiskProfile::SetHighRiskRequestAction(const SecurityAction& _highRiskRequestAction)
{
    m_highRiskRequestAction = _highRiskRequestAction;
    m_highRiskRequestActionHasBeenSet = true;
}

bool UserRiskProfile::HighRiskRequestActionHasBeenSet() const
{
    return m_highRiskRequestActionHasBeenSet;
}

uint64_t UserRiskProfile::GetMediumRiskMinScore() const
{
    return m_mediumRiskMinScore;
}

void UserRiskProfile::SetMediumRiskMinScore(const uint64_t& _mediumRiskMinScore)
{
    m_mediumRiskMinScore = _mediumRiskMinScore;
    m_mediumRiskMinScoreHasBeenSet = true;
}

bool UserRiskProfile::MediumRiskMinScoreHasBeenSet() const
{
    return m_mediumRiskMinScoreHasBeenSet;
}

SecurityAction UserRiskProfile::GetMediumRiskRequestAction() const
{
    return m_mediumRiskRequestAction;
}

void UserRiskProfile::SetMediumRiskRequestAction(const SecurityAction& _mediumRiskRequestAction)
{
    m_mediumRiskRequestAction = _mediumRiskRequestAction;
    m_mediumRiskRequestActionHasBeenSet = true;
}

bool UserRiskProfile::MediumRiskRequestActionHasBeenSet() const
{
