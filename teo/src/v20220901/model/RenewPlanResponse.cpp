...
CoreInternalOutcome RenewPlanResponse::Deserialize(const string &payload)
{
...
string RenewPlanResponse::ToJsonString() const
{
...
string RenewPlanResponse::GetDealName() const
{
    return m_dealName;
}

bool RenewPlanResponse::DealNameHasBeenSet() const
{
