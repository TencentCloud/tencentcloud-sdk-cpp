...
string ModifyZoneCnameSpeedUpRequest::GetZoneId() const
{
    return m_zoneId;
}

void ModifyZoneCnameSpeedUpRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool ModifyZoneCnameSpeedUpRequest::ZoneIdHasBeenSet() const
{
