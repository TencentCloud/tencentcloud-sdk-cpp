...
CoreInternalOutcome SearchEngineBots::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BaseAction") && !value["BaseAction"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SearchEngineBots.BaseAction` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BotManagementActionOverrides") && !value["BotManagementActionOverrides"].IsNull())
    {
        if (!value["BotManagementActionOverrides"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SearchEngineBots.BotManagementActionOverrides` is not array type"));
...
void SearchEngineBots::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
SecurityAction SearchEngineBots::GetBaseAction() const
{
    return m_baseAction;
}

void SearchEngineBots::SetBaseAction(const SecurityAction& _baseAction)
{
    m_baseAction = _baseAction;
    m_baseActionHasBeenSet = true;
}

bool SearchEngineBots::BaseActionHasBeenSet() const
{
    return m_baseActionHasBeenSet;
}

vector<BotManagementActionOverrides> SearchEngineBots::GetBotManagementActionOverrides() const
{
    return m_botManagementActionOverrides;
}

void SearchEngineBots::SetBotManagementActionOverrides(const vector<BotManagementActionOverrides>& _botManagementActionOverrides)
{
    m_botManagementActionOverrides = _botManagementActionOverrides;
    m_botManagementActionOverridesHasBeenSet = true;
}

bool SearchEngineBots::BotManagementActionOverridesHasBeenSet() const
{
