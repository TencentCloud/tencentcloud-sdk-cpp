...
CoreInternalOutcome BindSecurityTemplateToEntityResponse::Deserialize(const string &payload)
{
...
string BindSecurityTemplateToEntityResponse::ToJsonString() const
{
