...
CoreInternalOutcome CreateJustInTimeTranscodeTemplateResponse::Deserialize(const string &payload)
{
...
string CreateJustInTimeTranscodeTemplateResponse::ToJsonString() const
{
...
string CreateJustInTimeTranscodeTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateJustInTimeTranscodeTemplateResponse::TemplateIdHasBeenSet() const
{
