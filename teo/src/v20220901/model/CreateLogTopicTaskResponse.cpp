...
CoreInternalOutcome CreateLogTopicTaskResponse::Deserialize(const string &payload)
{
...
string CreateLogTopicTaskResponse::ToJsonString() const
{
...
string CreateLogTopicTaskResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateLogTopicTaskResponse::TopicIdHasBeenSet() const
{
