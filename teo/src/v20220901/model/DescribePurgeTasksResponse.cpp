...
CoreInternalOutcome DescribePurgeTasksResponse::Deserialize(const string &payload)
{
...
string DescribePurgeTasksResponse::ToJsonString() const
{
...
uint64_t DescribePurgeTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePurgeTasksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Task> DescribePurgeTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribePurgeTasksResponse::TasksHasBeenSet() const
{
