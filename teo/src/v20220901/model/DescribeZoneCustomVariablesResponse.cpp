...
DescribeZoneCustomVariablesResponse::DescribeZoneCustomVariablesResponse() :
    m_customVariablesHasBeenSet(false),
    m_customVariableOperationsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeZoneCustomVariablesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CustomVariableOperations") && !rsp["CustomVariableOperations"].IsNull())
    {
        if (!rsp["CustomVariableOperations"].IsArray())
            return CoreInternalOutcome(Core::Error("response `CustomVariableOperations` is not array type"));

        const rapidjson::Value &tmpValue = rsp["CustomVariableOperations"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
...
string DescribeZoneCustomVariablesResponse::ToJsonString() const
{
...
vector<CustomVariable> DescribeZoneCustomVariablesResponse::GetCustomVariables() const
{
    return m_customVariables;
}

bool DescribeZoneCustomVariablesResponse::CustomVariablesHasBeenSet() const
{
    return m_customVariablesHasBeenSet;
}

vector<CustomVariableOperation> DescribeZoneCustomVariablesResponse::GetCustomVariableOperations() const
{
    return m_customVariableOperations;
}

bool DescribeZoneCustomVariablesResponse::CustomVariableOperationsHasBeenSet() const
{
