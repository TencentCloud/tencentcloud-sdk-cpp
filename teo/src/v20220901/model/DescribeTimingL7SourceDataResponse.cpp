...
CoreInternalOutcome DescribeTimingL7SourceDataResponse::Deserialize(const string &payload)
{
...
string DescribeTimingL7SourceDataResponse::ToJsonString() const
{
...
uint64_t DescribeTimingL7SourceDataResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTimingL7SourceDataResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TimingDataRecord> DescribeTimingL7SourceDataResponse::GetTimingDataRecords() const
{
    return m_timingDataRecords;
}

bool DescribeTimingL7SourceDataResponse::TimingDataRecordsHasBeenSet() const
{
