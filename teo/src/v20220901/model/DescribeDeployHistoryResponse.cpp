...
CoreInternalOutcome DescribeDeployHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeDeployHistoryResponse::ToJsonString() const
{
...
uint64_t DescribeDeployHistoryResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeployHistoryResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DeployRecord> DescribeDeployHistoryResponse::GetRecords() const
{
    return m_records;
}

bool DescribeDeployHistoryResponse::RecordsHasBeenSet() const
{
