...
CoreInternalOutcome CreateWebSecurityTemplateResponse::Deserialize(const string &payload)
{
...
string CreateWebSecurityTemplateResponse::ToJsonString() const
{
...
string CreateWebSecurityTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateWebSecurityTemplateResponse::TemplateIdHasBeenSet() const
{
