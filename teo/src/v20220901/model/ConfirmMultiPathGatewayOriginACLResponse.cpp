...
CoreInternalOutcome ConfirmMultiPathGatewayOriginACLResponse::Deserialize(const string &payload)
{
...
string ConfirmMultiPathGatewayOriginACLResponse::ToJsonString() const
{
