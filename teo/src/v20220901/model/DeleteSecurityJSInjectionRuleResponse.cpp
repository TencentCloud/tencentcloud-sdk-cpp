...
CoreInternalOutcome DeleteSecurityJSInjectionRuleResponse::Deserialize(const string &payload)
{
...
string DeleteSecurityJSInjectionRuleResponse::ToJsonString() const
{
