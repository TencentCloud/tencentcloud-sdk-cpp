...
string ModifyAliasDomainRequest::GetAliasId() const
{
    return m_aliasId;
}

void ModifyAliasDomainRequest::SetAliasId(const string& _aliasId)
{
    m_aliasId = _aliasId;
    m_aliasIdHasBeenSet = true;
}

bool ModifyAliasDomainRequest::AliasIdHasBeenSet() const
{
