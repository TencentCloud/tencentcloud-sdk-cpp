...
EdgeKVListResponse::EdgeKVListResponse() :
    m_keysHasBeenSet(false),
    m_cursorHasBeenSet(false)
{
}

CoreInternalOutcome EdgeKVListResponse::Deserialize(const string &payload)
{
...
string EdgeKVListResponse::ToJsonString() const
{
...
vector<string> EdgeKVListResponse::GetKeys() const
{
    return m_keys;
}

bool EdgeKVListResponse::KeysHasBeenSet() const
{
    return m_keysHasBeenSet;
}

string EdgeKVListResponse::GetCursor() const
{
    return m_cursor;
}

bool EdgeKVListResponse::CursorHasBeenSet() const
{
