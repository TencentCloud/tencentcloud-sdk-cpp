...
CoreInternalOutcome ModifySecurityClientAttesterResponse::Deserialize(const string &payload)
{
...
string ModifySecurityClientAttesterResponse::ToJsonString() const
{
