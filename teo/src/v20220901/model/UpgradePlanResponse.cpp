...
CoreInternalOutcome UpgradePlanResponse::Deserialize(const string &payload)
{
...
string UpgradePlanResponse::ToJsonString() const
{
...
string UpgradePlanResponse::GetDealName() const
{
    return m_dealName;
}

bool UpgradePlanResponse::DealNameHasBeenSet() const
{
