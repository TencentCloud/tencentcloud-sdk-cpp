...
CoreInternalOutcome ModifyMultiPathGatewayStatusResponse::Deserialize(const string &payload)
{
...
string ModifyMultiPathGatewayStatusResponse::ToJsonString() const
{
