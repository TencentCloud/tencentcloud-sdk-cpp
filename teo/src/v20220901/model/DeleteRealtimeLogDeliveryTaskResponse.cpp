...
CoreInternalOutcome DeleteRealtimeLogDeliveryTaskResponse::Deserialize(const string &payload)
{
...
string DeleteRealtimeLogDeliveryTaskResponse::ToJsonString() const
{
