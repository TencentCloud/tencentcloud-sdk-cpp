...
CoreInternalOutcome CreateApplicationProxyRuleResponse::Deserialize(const string &payload)
{
...
string CreateApplicationProxyRuleResponse::ToJsonString() const
{
...
string CreateApplicationProxyRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateApplicationProxyRuleResponse::RuleIdHasBeenSet() const
{
