...
uint64_t CreateApplicationProxyRuleRequest::GetSessionPersistTime() const
{
    return m_sessionPersistTime;
}

void CreateApplicationProxyRuleRequest::SetSessionPersistTime(const uint64_t& _sessionPersistTime)
{
    m_sessionPersistTime = _sessionPersistTime;
    m_sessionPersistTimeHasBeenSet = true;
}

bool CreateApplicationProxyRuleRequest::SessionPersistTimeHasBeenSet() const
{
    return m_sessionPersistTimeHasBeenSet;
}

string CreateApplicationProxyRuleRequest::GetOriginPort() const
{
    return m_originPort;
}

void CreateApplicationProxyRuleRequest::SetOriginPort(const string& _originPort)
{
    m_originPort = _originPort;
    m_originPortHasBeenSet = true;
}

bool CreateApplicationProxyRuleRequest::OriginPortHasBeenSet() const
{
    return m_originPortHasBeenSet;
}

string CreateApplicationProxyRuleRequest::GetRuleTag() const
{
    return m_ruleTag;
}

void CreateApplicationProxyRuleRequest::SetRuleTag(const string& _ruleTag)
{
    m_ruleTag = _ruleTag;
    m_ruleTagHasBeenSet = true;
}

bool CreateApplicationProxyRuleRequest::RuleTagHasBeenSet() const
{
