...
CoreInternalOutcome ModifyRuleResponse::Deserialize(const string &payload)
{
...
string ModifyRuleResponse::ToJsonString() const
{
...
string ModifyRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool ModifyRuleResponse::RuleIdHasBeenSet() const
{
