...
CoreInternalOutcome IPReputationGroup::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BaseAction") && !value["BaseAction"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `IPReputationGroup.BaseAction` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BotManagementActionOverrides") && !value["BotManagementActionOverrides"].IsNull())
    {
        if (!value["BotManagementActionOverrides"].IsArray())
            return CoreInternalOutcome(Core::Error("response `IPReputationGroup.BotManagementActionOverrides` is not array type"));
...
void IPReputationGroup::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
SecurityAction IPReputationGroup::GetBaseAction() const
{
    return m_baseAction;
}

void IPReputationGroup::SetBaseAction(const SecurityAction& _baseAction)
{
    m_baseAction = _baseAction;
    m_baseActionHasBeenSet = true;
}

bool IPReputationGroup::BaseActionHasBeenSet() const
{
    return m_baseActionHasBeenSet;
}

vector<BotManagementActionOverrides> IPReputationGroup::GetBotManagementActionOverrides() const
{
    return m_botManagementActionOverrides;
}

void IPReputationGroup::SetBotManagementActionOverrides(const vector<BotManagementActionOverrides>& _botManagementActionOverrides)
{
    m_botManagementActionOverrides = _botManagementActionOverrides;
    m_botManagementActionOverridesHasBeenSet = true;
}

bool IPReputationGroup::BotManagementActionOverridesHasBeenSet() const
{
