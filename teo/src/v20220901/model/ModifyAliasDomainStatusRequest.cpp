...
vector<Filter> ModifyAliasDomainStatusRequest::GetFilters() const
{
    return m_filters;
}

void ModifyAliasDomainStatusRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool ModifyAliasDomainStatusRequest::FiltersHasBeenSet() const
{
