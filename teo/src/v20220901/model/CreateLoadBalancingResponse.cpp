...
CoreInternalOutcome CreateLoadBalancingResponse::Deserialize(const string &payload)
{
...
string CreateLoadBalancingResponse::ToJsonString() const
{
...
string CreateLoadBalancingResponse::GetLoadBalancingId() const
{
    return m_loadBalancingId;
}

bool CreateLoadBalancingResponse::LoadBalancingIdHasBeenSet() const
{
