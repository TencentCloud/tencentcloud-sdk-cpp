            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>文件格式，可选值：<ul><li>csv</li></ul>默认为 csv。</p>
                    ...
                    /**
                     * 设置<p>文件格式，可选值：<ul><li>csv</li></ul>默认为 csv。</p>
                    ...
                    /**
                     * 获取<p>原始日志的时间排序，可选值：  <ul><li>asc：升序；</li>  <li>desc：降序。</li></ul>  默认为 desc。</p>
                    ...
                    /**
                     * 设置<p>原始日志的时间排序，可选值：  <ul><li>asc：升序；</li>  <li>desc：降序。</li></ul>  默认为 desc。</p>
