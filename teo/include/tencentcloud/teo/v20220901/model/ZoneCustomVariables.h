...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_ZONECUSTOMVARIABLES_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_ZONECUSTOMVARIABLES_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class ZoneCustomVariables : public AbstractModel
                {
                public:
                    ZoneCustomVariables();
                    ~ZoneCustomVariables() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_ZONECUSTOMVARIABLES_H_
