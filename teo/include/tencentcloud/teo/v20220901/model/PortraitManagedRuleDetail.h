...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_PORTRAITMANAGEDRULEDETAIL_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_PORTRAITMANAGEDRULEDETAIL_H_
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ClassificationId 规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
                     */
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_PORTRAITMANAGEDRULEDETAIL_H_
