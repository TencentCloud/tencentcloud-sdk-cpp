            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取回源请求参数 Cookie 配置开关，取值有：
<li>on：开启；</li>
<li>off：关闭。</li>
                     * @return Switch 回源请求参数 Cookie 配置开关，取值有：
<li>on：开启；</li>
<li>off：关闭。</li>
                     * 
                     */
...
<li>off：关闭。</li>
                    ...
                    /**
                     * 获取回源请求参数 Cookie 模式。当 Switch 为 on 时，该参数必填。取值有：
<li>full：表示全部保留；</li>
<li>ignore：表示全部忽略；</li>
<li>includeCustom：表示保留部分参数；</li>
<li>excludeCustom：表示忽略部分参数。</li>
                     * @return Action 回源请求参数 Cookie 模式。当 Switch 为 on 时，该参数必填。取值有：
<li>full：表示全部保留；</li>
<li>ignore：表示全部忽略；</li>
<li>includeCustom：表示保留部分参数；</li>
<li>excludeCustom：表示忽略部分参数。</li>
                    ...
                    /**
                     * 设置回源请求参数 Cookie 模式。当 Switch 为 on 时，该参数必填。取值有：
<li>full：表示全部保留；</li>
<li>ignore：表示全部忽略；</li>
<li>includeCustom：表示保留部分参数；</li>
<li>excludeCustom：表示忽略部分参数。</li>
...
<li>excludeCustom：表示忽略部分参数。</li>
                    ...
                    /**
                     * 获取指定参数值。仅当查询字符串模式 Action 为 includeCustom 或者 excludeCustom 时该参数生效，用于指定需要保留或者忽略的参数。最大支持 10 个参数。
                    ...
                    /**
                     * 设置指定参数值。仅当查询字符串模式 Action 为 includeCustom 或者 excludeCustom 时该参数生效，用于指定需要保留或者忽略的参数。最大支持 10 个参数。
