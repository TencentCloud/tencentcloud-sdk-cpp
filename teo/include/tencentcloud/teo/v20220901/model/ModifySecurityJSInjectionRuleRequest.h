...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYJSINJECTIONRULEREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYJSINJECTIONRULEREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class ModifySecurityJSInjectionRuleRequest : public AbstractModel
                {
                public:
                    ModifySecurityJSInjectionRuleRequest();
                    ~ModifySecurityJSInjectionRuleRequest() = default;
                     ...
                     * 
                     */
                    void SetJSInjectionRules(const std::vector<JSInjectionRule>& _jSInjectionRules);
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYJSINJECTIONRULEREQUEST_H_
