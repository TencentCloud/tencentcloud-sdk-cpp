...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7SOURCEDATARESPONSE_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7SOURCEDATARESPONSE_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeTimingL7SourceDataResponse : public AbstractModel
                {
                public:
                    DescribeTimingL7SourceDataResponse();
                    ~DescribeTimingL7SourceDataResponse() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7SOURCEDATARESPONSE_H_
