...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYCLIENTATTESTERREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYCLIENTATTESTERREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class ModifySecurityClientAttesterRequest : public AbstractModel
                {
                public:
                    ModifySecurityClientAttesterRequest();
                    ~ModifySecurityClientAttesterRequest() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_MODIFYSECURITYCLIENTATTESTERREQUEST_H_
