...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEINFERENCEDOMAINSREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEINFERENCEDOMAINSREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeInferenceDomainsRequest : public AbstractModel
                {
                public:
                    DescribeInferenceDomainsRequest();
                    ~DescribeInferenceDomainsRequest() = default;
                    ...
                    /**
                     * 获取<p>排序字段。</p><p>枚举值：</p><ul><li>CreateTime： 域名创建时间；</li><li>UpdateTime： 域名修改时间。</li></ul><p>默认值：CreateTime。</p>
                    ...
                    /**
                     * 设置<p>排序字段。</p><p>枚举值：</p><ul><li>CreateTime： 域名创建时间；</li><li>UpdateTime： 域名修改时间。</li></ul><p>默认值：CreateTime。</p>
                    ...
                    /**
                     * 获取<p>排序方式。</p><p>枚举值：</p><ul><li>Asc： 升序方式；</li><li>Desc： 降序方式。</li></ul><p>默认值：Desc。</p>
                    ...
                    /**
                     * 设置<p>排序方式。</p><p>枚举值：</p><ul><li>Asc： 升序方式；</li><li>Desc： 降序方式。</li></ul><p>默认值：Desc。</p>
                    ...
                    /**
                     * 获取<p>分页查询限制数目。</p><p>默认值：20。</p><p>最大值：200。</p>
                    ...
                    /**
                     * 设置<p>分页查询限制数目。</p><p>默认值：20。</p><p>最大值：200。</p>
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEINFERENCEDOMAINSREQUEST_H_
