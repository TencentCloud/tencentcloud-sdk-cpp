...
必填参数。
                    ...
                    /**
                     * 设置查询起始时间，时间与job-id必填一个。
                     * @param _startTime 查询起始时间，时间与job-id必填一个。
                     * 
                     */
                    ...
                    /**
                     * 设置查询结束时间，时间与job-id必填一个。
                     * @param _endTime 查询结束时间，时间与job-id必填一个。
                     * 
                     */
