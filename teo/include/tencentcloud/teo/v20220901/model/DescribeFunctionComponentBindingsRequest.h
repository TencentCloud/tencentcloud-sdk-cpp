...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEFUNCTIONCOMPONENTBINDINGSREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEFUNCTIONCOMPONENTBINDINGSREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeFunctionComponentBindingsRequest : public AbstractModel
                {
                public:
                    DescribeFunctionComponentBindingsRequest();
                    ~DescribeFunctionComponentBindingsRequest() = default;
                    ...
                    /**
                     * 获取过滤条件，Filters.Values 的上限为 20。详细的过滤条件如下：
...
<li>type：按照绑定类型进行过滤，不支持模糊查询。</li>
                    ...
                    /**
                     * 设置过滤条件，Filters.Values 的上限为 20。详细的过滤条件如下：
<li>name：按照绑定的变量名进行过滤，支持模糊查询；</li>
<li>type：按照绑定类型进行过滤，不支持模糊查询。</li>
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEFUNCTIONCOMPONENTBINDINGSREQUEST_H_
