...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_RULECODEACTION_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_RULECODEACTION_H_
...
#include <tencentcloud/teo/v20220106/model/RuleCodeActionParams.h>
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                * 规则引擎带有状态码的动作
                */
                class RuleCodeAction : public AbstractModel
                {
                public:
                    RuleCodeAction();
                    ~RuleCodeAction() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_RULECODEACTION_H_
