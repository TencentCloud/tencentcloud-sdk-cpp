...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_RULENORMALACTION_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_RULENORMALACTION_H_
...
#include <tencentcloud/teo/v20220106/model/RuleNormalActionParams.h>
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                * 规则引擎常规类型的动作
                */
                class RuleNormalAction : public AbstractModel
                {
                public:
                    RuleNormalAction();
                    ~RuleNormalAction() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_RULENORMALACTION_H_
