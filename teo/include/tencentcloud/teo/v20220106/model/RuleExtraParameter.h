...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_RULEEXTRAPARAMETER_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_RULEEXTRAPARAMETER_H_
...
注意：当 Id 的值为 StatusCode 时数组中的值为整型，填写参数值时请填写字符串的整型数值。
                     */
                    void SetChoices(const std::string& _choices);
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_RULEEXTRAPARAMETER_H_
