...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_RULESETTINGDETAIL_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_RULESETTINGDETAIL_H_
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                * 规则引擎规则详情
                */
                class RuleSettingDetail : public AbstractModel
                {
                public:
                    RuleSettingDetail();
                    ~RuleSettingDetail() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_RULESETTINGDETAIL_H_
