...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_DROPPAGEDETAIL_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_DROPPAGEDETAIL_H_
...
该Id可通过创建拦截页面接口进行上传获取。如传入0，代表使用系统默认拦截页面
                    ...
                    /**
                     * 获取拦截页面的HTTP状态码。状态码范围是 100 - 600。
                     * @return StatusCode 拦截页面的HTTP状态码。状态码范围是 100 - 600。
                     */
                    int64_t GetStatusCode() const;

                    /**
                     * 设置拦截页面的HTTP状态码。状态码范围是 100 - 600。
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_DROPPAGEDETAIL_H_
