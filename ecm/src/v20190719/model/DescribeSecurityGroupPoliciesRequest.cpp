...
string DescribeSecurityGroupPoliciesRequest::GetSecurityGroupId() const
{
    return m_securityGroupId;
}

void DescribeSecurityGroupPoliciesRequest::SetSecurityGroupId(const string& _securityGroupId)
{
