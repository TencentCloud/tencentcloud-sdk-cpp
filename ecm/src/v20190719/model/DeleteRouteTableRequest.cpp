...
string DeleteRouteTableRequest::ToJsonString() const
{
...
string DeleteRouteTableRequest::GetRouteTableId() const
{
    return m_routeTableId;
}

void DeleteRouteTableRequest::SetRouteTableId(const string& _routeTableId)
{
    m_routeTableId = _routeTableId;
    m_routeTableIdHasBeenSet = true;
}

bool DeleteRouteTableRequest::RouteTableIdHasBeenSet() const
{
