...
CoreInternalOutcome DescribePriceRunInstanceResponse::Deserialize(const string &payload)
{
...
string DescribePriceRunInstanceResponse::ToJsonString() const
{
...
InstancesPrice DescribePriceRunInstanceResponse::GetInstancePrice() const
{
    return m_instancePrice;
}

bool DescribePriceRunInstanceResponse::InstancePriceHasBeenSet() const
{
