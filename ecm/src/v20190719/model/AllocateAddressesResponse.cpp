...
CoreInternalOutcome AllocateAddressesResponse::Deserialize(const string &payload)
{
...
string AllocateAddressesResponse::ToJsonString() const
{
...
vector<string> AllocateAddressesResponse::GetAddressSet() const
{
    return m_addressSet;
}
