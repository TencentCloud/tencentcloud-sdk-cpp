...
CoreInternalOutcome ReleaseIpv6AddressesResponse::Deserialize(const string &payload)
{
...
string ReleaseIpv6AddressesResponse::ToJsonString() const
{
...
int64_t ReleaseIpv6AddressesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ReleaseIpv6AddressesResponse::TaskIdHasBeenSet() const
{
