...
string DescribeListenersRequest::GetProtocol() const
{
    return m_protocol;
}

void DescribeListenersRequest::SetProtocol(const string& _protocol)
{
    m_protocol = _protocol;
    m_protocolHasBeenSet = true;
}

bool DescribeListenersRequest::ProtocolHasBeenSet() const
{
    return m_protocolHasBeenSet;
}

int64_t DescribeListenersRequest::GetPort() const
{
    return m_port;
}

void DescribeListenersRequest::SetPort(const int64_t& _port)
{
    m_port = _port;
    m_portHasBeenSet = true;
}

bool DescribeListenersRequest::PortHasBeenSet() const
{
