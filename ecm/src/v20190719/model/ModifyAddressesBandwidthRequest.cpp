...
string ModifyAddressesBandwidthRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void ModifyAddressesBandwidthRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool ModifyAddressesBandwidthRequest::EcmRegionHasBeenSet() const
{
...
uint64_t ModifyAddressesBandwidthRequest::GetInternetMaxBandwidthOut() const
{
    return m_internetMaxBandwidthOut;
}

void ModifyAddressesBandwidthRequest::SetInternetMaxBandwidthOut(const uint64_t& _internetMaxBandwidthOut)
{
