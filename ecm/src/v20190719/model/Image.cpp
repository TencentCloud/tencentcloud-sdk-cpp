...
CoreInternalOutcome Image::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("ImageOsName") && !value["ImageOsName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.ImageOsName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageCreateTime") && !value["ImageCreateTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.ImageCreateTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OsType") && !value["OsType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.OsType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OsVersion") && !value["OsVersion"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.OsVersion` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageOwner") && !value["ImageOwner"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.ImageOwner` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SrcImage") && !value["SrcImage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Image.SrcImage` is not object type").SetRequestId(requestId));
        }
...
void Image::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_imageCreateTimeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_imageCreateTime.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_osVersionHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_osVersion.c_str(), allocator).Move(), allocator);
    }
