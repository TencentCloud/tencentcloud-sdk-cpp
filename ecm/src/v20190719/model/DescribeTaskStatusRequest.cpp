...
vector<TaskInput> DescribeTaskStatusRequest::GetTaskSet() const
{
    return m_taskSet;
}

void DescribeTaskStatusRequest::SetTaskSet(const vector<TaskInput>& _taskSet)
{
    m_taskSet = _taskSet;
    m_taskSetHasBeenSet = true;
}

bool DescribeTaskStatusRequest::TaskSetHasBeenSet() const
{
