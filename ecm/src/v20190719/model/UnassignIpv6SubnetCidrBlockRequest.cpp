...
string UnassignIpv6SubnetCidrBlockRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void UnassignIpv6SubnetCidrBlockRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool UnassignIpv6SubnetCidrBlockRequest::EcmRegionHasBeenSet() const
{
