...
string MigratePrivateIpAddressRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void MigratePrivateIpAddressRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool MigratePrivateIpAddressRequest::EcmRegionHasBeenSet() const
{
