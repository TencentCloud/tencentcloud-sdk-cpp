...
CoreInternalOutcome OperatorAction::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Action") && !value["Action"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `OperatorAction.Action` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Code") && !value["Code"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `OperatorAction.Code` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Message") && !value["Message"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `OperatorAction.Message` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void OperatorAction::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
