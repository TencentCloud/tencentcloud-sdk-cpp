...
string AssignIpv6CidrBlockRequest::GetISPType() const
{
    return m_iSPType;
}

void AssignIpv6CidrBlockRequest::SetISPType(const string& _iSPType)
{
    m_iSPType = _iSPType;
    m_iSPTypeHasBeenSet = true;
}

bool AssignIpv6CidrBlockRequest::ISPTypeHasBeenSet() const
{
    return m_iSPTypeHasBeenSet;
}

string AssignIpv6CidrBlockRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void AssignIpv6CidrBlockRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool AssignIpv6CidrBlockRequest::EcmRegionHasBeenSet() const
{
