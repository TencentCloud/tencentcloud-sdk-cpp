...
int64_t DescribeImageResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeImageResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Image> DescribeImageResponse::GetImageSet() const
{
    return m_imageSet;
}

bool DescribeImageResponse::ImageSetHasBeenSet() const
{
