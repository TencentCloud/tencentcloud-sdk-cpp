...
vector<TargetsWeightRule> BatchModifyTargetWeightRequest::GetModifyList() const
{
    return m_modifyList;
}

void BatchModifyTargetWeightRequest::SetModifyList(const vector<TargetsWeightRule>& _modifyList)
{
