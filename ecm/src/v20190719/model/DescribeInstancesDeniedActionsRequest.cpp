...
string DescribeInstancesDeniedActionsRequest::ToJsonString() const
{
...
vector<string> DescribeInstancesDeniedActionsRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void DescribeInstancesDeniedActionsRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool DescribeInstancesDeniedActionsRequest::InstanceIdSetHasBeenSet() const
{
