...
string DeleteRoutesRequest::ToJsonString() const
{
...
string DeleteRoutesRequest::GetRouteTableId() const
{
    return m_routeTableId;
}

void DeleteRoutesRequest::SetRouteTableId(const string& _routeTableId)
{
    m_routeTableId = _routeTableId;
    m_routeTableIdHasBeenSet = true;
}

bool DeleteRoutesRequest::RouteTableIdHasBeenSet() const
{
    return m_routeTableIdHasBeenSet;
}

vector<Route> DeleteRoutesRequest::GetRoutes() const
{
    return m_routes;
}

void DeleteRoutesRequest::SetRoutes(const vector<Route>& _routes)
{
    m_routes = _routes;
    m_routesHasBeenSet = true;
}

bool DeleteRoutesRequest::RoutesHasBeenSet() const
{
