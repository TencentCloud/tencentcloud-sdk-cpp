...
CoreInternalOutcome ImportCustomImageResponse::Deserialize(const string &payload)
{
...
string ImportCustomImageResponse::ToJsonString() const
{
...
string ImportCustomImageResponse::GetImageId() const
{
    return m_imageId;
}

bool ImportCustomImageResponse::ImageIdHasBeenSet() const
{
    return m_imageIdHasBeenSet;
}

uint64_t ImportCustomImageResponse::GetTaskId() const
{
    return m_taskId;
}

bool ImportCustomImageResponse::TaskIdHasBeenSet() const
{
