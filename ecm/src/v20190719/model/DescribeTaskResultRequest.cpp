...
string DescribeTaskResultRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void DescribeTaskResultRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool DescribeTaskResultRequest::EcmRegionHasBeenSet() const
{
