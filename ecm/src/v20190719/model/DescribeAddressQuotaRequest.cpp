...
string DescribeAddressQuotaRequest::ToJsonString() const
{
...
string DescribeAddressQuotaRequest::GetEcmRegion() const
{
    return m_ecmRegion;
}

void DescribeAddressQuotaRequest::SetEcmRegion(const string& _ecmRegion)
{
    m_ecmRegion = _ecmRegion;
    m_ecmRegionHasBeenSet = true;
}

bool DescribeAddressQuotaRequest::EcmRegionHasBeenSet() const
{
