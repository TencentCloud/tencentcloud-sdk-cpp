...
string DeleteModuleRequest::ToJsonString() const
{
...
string DeleteModuleRequest::GetModuleId() const
{
    return m_moduleId;
}

void DeleteModuleRequest::SetModuleId(const string& _moduleId)
{
    m_moduleId = _moduleId;
    m_moduleIdHasBeenSet = true;
}

bool DeleteModuleRequest::ModuleIdHasBeenSet() const
{
