...
CoreInternalOutcome DescribeAddressQuotaResponse::Deserialize(const string &payload)
{
...
string DescribeAddressQuotaResponse::ToJsonString() const
{
...
vector<EipQuota> DescribeAddressQuotaResponse::GetQuotaSet() const
{
    return m_quotaSet;
}

bool DescribeAddressQuotaResponse::QuotaSetHasBeenSet() const
{
