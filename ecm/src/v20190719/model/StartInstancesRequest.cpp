...
string StartInstancesRequest::ToJsonString() const
{
...
vector<string> StartInstancesRequest::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

void StartInstancesRequest::SetInstanceIdSet(const vector<string>& _instanceIdSet)
{
    m_instanceIdSet = _instanceIdSet;
    m_instanceIdSetHasBeenSet = true;
}

bool StartInstancesRequest::InstanceIdSetHasBeenSet() const
{
