...
string CreateSecurityGroupPoliciesRequest::ToJsonString() const
{
...
string CreateSecurityGroupPoliciesRequest::GetSecurityGroupId() const
{
    return m_securityGroupId;
}

void CreateSecurityGroupPoliciesRequest::SetSecurityGroupId(const string& _securityGroupId)
{
    m_securityGroupId = _securityGroupId;
    m_securityGroupIdHasBeenSet = true;
}

bool CreateSecurityGroupPoliciesRequest::SecurityGroupIdHasBeenSet() const
{
    return m_securityGroupIdHasBeenSet;
}

SecurityGroupPolicySet CreateSecurityGroupPoliciesRequest::GetSecurityGroupPolicySet() const
{
    return m_securityGroupPolicySet;
}

void CreateSecurityGroupPoliciesRequest::SetSecurityGroupPolicySet(const SecurityGroupPolicySet& _securityGroupPolicySet)
{
    m_securityGroupPolicySet = _securityGroupPolicySet;
    m_securityGroupPolicySetHasBeenSet = true;
}

bool CreateSecurityGroupPoliciesRequest::SecurityGroupPolicySetHasBeenSet() const
{
