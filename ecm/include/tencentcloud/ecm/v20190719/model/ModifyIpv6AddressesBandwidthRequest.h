...
#ifndef TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYIPV6ADDRESSESBANDWIDTHREQUEST_H_
#define TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYIPV6ADDRESSESBANDWIDTHREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取IPV6地址。Ipv6Addresses和Ipv6AddressId必须且只能传一个
                    ...
                    /**
                     * 设置IPV6地址。Ipv6Addresses和Ipv6AddressId必须且只能传一个
                    ...
                    /**
                     * 获取IPV6地址对应的唯一ID，形如eip-xxxxxxxx。Ipv6Addresses和Ipv6AddressId必须且只能传一个
                    ...
                    /**
                     * 设置IPV6地址对应的唯一ID，形如eip-xxxxxxxx。Ipv6Addresses和Ipv6AddressId必须且只能传一个
...
#endif // !TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYIPV6ADDRESSESBANDWIDTHREQUEST_H_
