...
#ifndef TENCENTCLOUD_ECM_V20190719_MODEL_DETACHDISKSREQUEST_H_
#define TENCENTCLOUD_ECM_V20190719_MODEL_DETACHDISKSREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取对于非共享型云盘，会忽略该参数；对于共享型云盘，该参数表示要从哪个CVM实例上卸载云盘。
                    ...
                    /**
                     * 设置对于非共享型云盘，会忽略该参数；对于共享型云盘，该参数表示要从哪个CVM实例上卸载云盘。
...
#endif // !TENCENTCLOUD_ECM_V20190719_MODEL_DETACHDISKSREQUEST_H_
