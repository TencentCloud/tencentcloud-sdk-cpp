...
#ifndef TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYMODULENAMEREQUEST_H_
#define TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYMODULENAMEREQUEST_H_
    ...
    namespace Ecm
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                */
                class ModifyModuleNameRequest : public AbstractModel
                {
                public:
                    ModifyModuleNameRequest();
                    ~ModifyModuleNameRequest() = default;
...
#endif // !TENCENTCLOUD_ECM_V20190719_MODEL_MODIFYMODULENAMEREQUEST_H_
