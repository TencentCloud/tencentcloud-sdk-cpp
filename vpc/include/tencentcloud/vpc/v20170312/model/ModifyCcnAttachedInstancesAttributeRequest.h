...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNATTACHEDINSTANCESATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNATTACHEDINSTANCESATTRIBUTEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyCcnAttachedInstancesAttributeRequest : public AbstractModel
                {
                public:
                    ModifyCcnAttachedInstancesAttributeRequest();
                    ~ModifyCcnAttachedInstancesAttributeRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNATTACHEDINSTANCESATTRIBUTEREQUEST_H_
