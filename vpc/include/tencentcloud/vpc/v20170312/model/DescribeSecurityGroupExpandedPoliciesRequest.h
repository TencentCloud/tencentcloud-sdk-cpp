...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeSecurityGroupExpandedPoliciesRequest : public AbstractModel
                {
                public:
                    DescribeSecurityGroupExpandedPoliciesRequest();
                    ~DescribeSecurityGroupExpandedPoliciesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESREQUEST_H_
