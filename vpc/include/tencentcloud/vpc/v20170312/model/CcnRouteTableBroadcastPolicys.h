...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CCNROUTETABLEBROADCASTPOLICYS_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CCNROUTETABLEBROADCASTPOLICYS_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * 云联网路由传播策略列表
                */
                class CcnRouteTableBroadcastPolicys : public AbstractModel
                {
                public:
                    CcnRouteTableBroadcastPolicys();
                    ~CcnRouteTableBroadcastPolicys() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CCNROUTETABLEBROADCASTPOLICYS_H_
