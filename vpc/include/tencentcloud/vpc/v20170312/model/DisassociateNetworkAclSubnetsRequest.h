...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DISASSOCIATENETWORKACLSUBNETSREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DISASSOCIATENETWORKACLSUBNETSREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DisassociateNetworkAclSubnetsRequest : public AbstractModel
                {
                public:
                    DisassociateNetworkAclSubnetsRequest();
                    ~DisassociateNetworkAclSubnetsRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DISASSOCIATENETWORKACLSUBNETSREQUEST_H_
