...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSBANDWIDTHRANGEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSBANDWIDTHRANGEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeAddressBandwidthRangeRequest : public AbstractModel
                {
                public:
                    DescribeAddressBandwidthRangeRequest();
                    ~DescribeAddressBandwidthRangeRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSBANDWIDTHRANGEREQUEST_H_
