...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_ENABLEVPNGATEWAYSSLCLIENTCERTREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_ENABLEVPNGATEWAYSSLCLIENTCERTREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class EnableVpnGatewaySslClientCertRequest : public AbstractModel
                {
                public:
                    EnableVpnGatewaySslClientCertRequest();
                    ~EnableVpnGatewaySslClientCertRequest() = default;
                    ...
                    /**
                     * 获取SSL-VPN-CLIENT 实例ID列表。批量启用时使用。不可和SslVpnClientId同时使用。
                    ...
                    /**
                     * 设置SSL-VPN-CLIENT 实例ID列表。批量启用时使用。不可和SslVpnClientId同时使用。
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_ENABLEVPNGATEWAYSSLCLIENTCERTREQUEST_H_
