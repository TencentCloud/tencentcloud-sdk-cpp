...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNPOLICYBASEDROUTINGNEXTHOPATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNPOLICYBASEDROUTINGNEXTHOPATTRIBUTEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyCcnPolicyBasedRoutingNextHopAttributeRequest : public AbstractModel
                {
                public:
                    ModifyCcnPolicyBasedRoutingNextHopAttributeRequest();
                    ~ModifyCcnPolicyBasedRoutingNextHopAttributeRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYCCNPOLICYBASEDROUTINGNEXTHOPATTRIBUTEREQUEST_H_
