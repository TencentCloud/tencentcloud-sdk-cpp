            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取转换规则类型，可选值"NETWORK_LAYER","TRANSPORT_LAYER"。分别对应三层和四层。
                     * @return TranslationType 转换规则类型，可选值"NETWORK_LAYER","TRANSPORT_LAYER"。分别对应三层和四层。
                     * 
                     */
                    std::string GetTranslationType() const;

                    /**
                     * 设置转换规则类型，可选值"NETWORK_LAYER","TRANSPORT_LAYER"。分别对应三层和四层。
                    ...
                    /**
                     * 获取映射后IP,当转换规则类型为四层时为`IP`池。
                     * @return TranslationIp 映射后IP,当转换规则类型为四层时为`IP`池。
                     * 
                     */
                    std::string GetTranslationIp() const;

                    /**
                     * 设置映射后IP,当转换规则类型为四层时为`IP`池。
                    ...
                    /**
                     * 获取映射前IP,当转换规则类型为三层时有效。
                     * @return OriginalIp 映射前IP,当转换规则类型为三层时有效。
                     * 
                     */
                    std::string GetOriginalIp() const;

                    /**
                     * 设置映射前IP,当转换规则类型为三层时有效。
