...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATENETWORKACLENTRIESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATENETWORKACLENTRIESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateNetworkAclEntriesRequest : public AbstractModel
                {
                public:
                    CreateNetworkAclEntriesRequest();
                    ~CreateNetworkAclEntriesRequest() = default;
                    ...
                    /**
                     * 获取网络三元组ACL规则集。
                     * @return NetworkAclEntrySet 网络三元组ACL规则集。
                     * 
                     */
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATENETWORKACLENTRIESREQUEST_H_
