...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_REJECTATTACHCCNINSTANCESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_REJECTATTACHCCNINSTANCESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class RejectAttachCcnInstancesRequest : public AbstractModel
                {
                public:
                    RejectAttachCcnInstancesRequest();
                    ~RejectAttachCcnInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_REJECTATTACHCCNINSTANCESREQUEST_H_
