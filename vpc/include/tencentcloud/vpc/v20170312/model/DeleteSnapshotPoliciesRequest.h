...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETESNAPSHOTPOLICIESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETESNAPSHOTPOLICIESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteSnapshotPoliciesRequest : public AbstractModel
                {
                public:
                    DeleteSnapshotPoliciesRequest();
                    ~DeleteSnapshotPoliciesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETESNAPSHOTPOLICIESREQUEST_H_
