...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATESERVICETEMPLATERESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATESERVICETEMPLATERESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateServiceTemplateResponse : public AbstractModel
                {
                public:
                    CreateServiceTemplateResponse();
                    ~CreateServiceTemplateResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATESERVICETEMPLATERESPONSE_H_
