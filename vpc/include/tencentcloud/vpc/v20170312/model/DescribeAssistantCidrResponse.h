...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEASSISTANTCIDRRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEASSISTANTCIDRRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeAssistantCidrResponse : public AbstractModel
                {
                public:
                    DescribeAssistantCidrResponse();
                    ~DescribeAssistantCidrResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEASSISTANTCIDRRESPONSE_H_
