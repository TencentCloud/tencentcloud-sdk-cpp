...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEIP6ADDRESSESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEIP6ADDRESSESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeIp6AddressesResponse : public AbstractModel
                {
                public:
                    DescribeIp6AddressesResponse();
                    ~DescribeIp6AddressesResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEIP6ADDRESSESRESPONSE_H_
