...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATEROUTEPOLICYASSOCIATIONSREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATEROUTEPOLICYASSOCIATIONSREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateRoutePolicyAssociationsRequest : public AbstractModel
                {
                public:
                    CreateRoutePolicyAssociationsRequest();
                    ~CreateRoutePolicyAssociationsRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATEROUTEPOLICYASSOCIATIONSREQUEST_H_
