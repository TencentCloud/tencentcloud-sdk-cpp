...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_RESETHIGHPRIORITYROUTESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_RESETHIGHPRIORITYROUTESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ResetHighPriorityRoutesRequest : public AbstractModel
                {
                public:
                    ResetHighPriorityRoutesRequest();
                    ~ResetHighPriorityRoutesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_RESETHIGHPRIORITYROUTESREQUEST_H_
