...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEDHCPIPREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEDHCPIPREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * DeleteDhcpIp请求参数结构体
                */
                class DeleteDhcpIpRequest : public AbstractModel
                {
                public:
                    DeleteDhcpIpRequest();
                    ~DeleteDhcpIpRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEDHCPIPREQUEST_H_
