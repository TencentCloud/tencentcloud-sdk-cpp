...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBECCNROUTETABLEBROADCASTPOLICYSREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBECCNROUTETABLEBROADCASTPOLICYSREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeCcnRouteTableBroadcastPolicysRequest : public AbstractModel
                {
                public:
                    DescribeCcnRouteTableBroadcastPolicysRequest();
                    ~DescribeCcnRouteTableBroadcastPolicysRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBECCNROUTETABLEBROADCASTPOLICYSREQUEST_H_
