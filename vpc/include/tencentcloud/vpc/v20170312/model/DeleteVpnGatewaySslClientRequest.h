...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPNGATEWAYSSLCLIENTREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPNGATEWAYSSLCLIENTREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteVpnGatewaySslClientRequest : public AbstractModel
                {
                public:
                    DeleteVpnGatewaySslClientRequest();
                    ~DeleteVpnGatewaySslClientRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPNGATEWAYSSLCLIENTREQUEST_H_
