...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATEPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATEPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreatePrivateNatGatewayTranslationNatRuleRequest : public AbstractModel
                {
                public:
                    CreatePrivateNatGatewayTranslationNatRuleRequest();
                    ~CreatePrivateNatGatewayTranslationNatRuleRequest() = default;
                     ...
                     * 
                     */
                    std::vector<TranslationNatRuleInput> GetTranslationNatRules() const;
                     ...
                     * 
                     */
                    void SetTranslationNatRules(const std::vector<TranslationNatRuleInput>& _translationNatRules);
                ...
                private:
                     ...
                     * 转换规则对象数组。
                     */
                    std::vector<TranslationNatRuleInput> m_translationNatRules;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATEPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
