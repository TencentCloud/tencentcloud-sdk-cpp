...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSTEMPLATEGROUPSREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSTEMPLATEGROUPSREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeAddressTemplateGroupsRequest : public AbstractModel
                {
                public:
                    DescribeAddressTemplateGroupsRequest();
                    ~DescribeAddressTemplateGroupsRequest() = default;
...
<li>address-template-group-id - String - （过滤条件）IP地址模板实集合例ID，例如：ipmg-mdunqeb6。</li>
                    ...
                    /**
                     * 获取排序字段。支持：`AddressTemplateGroupId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置排序字段。支持：`AddressTemplateGroupId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 获取IP地址成员排序字段。支持：`AddressTemplateId` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置IP地址成员排序字段。支持：`AddressTemplateId` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 获取IP地址成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置IP地址成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEADDRESSTEMPLATEGROUPSREQUEST_H_
