...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribePrivateNatGatewayDestinationIpPortTranslationNatRulesRequest : public AbstractModel
                {
                public:
                    DescribePrivateNatGatewayDestinationIpPortTranslationNatRulesRequest();
                    ~DescribePrivateNatGatewayDestinationIpPortTranslationNatRulesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULESREQUEST_H_
