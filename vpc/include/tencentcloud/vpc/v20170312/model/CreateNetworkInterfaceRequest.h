            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 设置<p>弹性网卡名称，最大长度不能超过60个字节。</p>
                     * @param _networkInterfaceName <p>弹性网卡名称，最大长度不能超过60个字节。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
                    ...
                    /**
                     * 设置<p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
                     * @param _secondaryPrivateIpAddressCount <p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
                    ...
                    /**
                     * 设置<p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
                     * @param _trunkingFlag <p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
                     * 
                     */
