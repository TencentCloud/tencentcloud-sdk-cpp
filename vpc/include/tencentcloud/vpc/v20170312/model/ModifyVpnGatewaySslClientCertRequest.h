...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYVPNGATEWAYSSLCLIENTCERTREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYVPNGATEWAYSSLCLIENTCERTREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyVpnGatewaySslClientCertRequest : public AbstractModel
                {
                public:
                    ModifyVpnGatewaySslClientCertRequest();
                    ~ModifyVpnGatewaySslClientCertRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取SSL-VPN-CLIENT 实例ID列表。
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYVPNGATEWAYSSLCLIENTCERTREQUEST_H_
