...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATEDEFAULTSECURITYGROUPREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATEDEFAULTSECURITYGROUPREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateDefaultSecurityGroupRequest : public AbstractModel
                {
                public:
                    CreateDefaultSecurityGroupRequest();
                    ~CreateDefaultSecurityGroupRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATEDEFAULTSECURITYGROUPREQUEST_H_
