...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIPV6ADDRESSESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIPV6ADDRESSESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class AllocateIPv6AddressesResponse : public AbstractModel
                {
                public:
                    AllocateIPv6AddressesResponse();
                    ~AllocateIPv6AddressesResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);
                    std::string ToJsonString() const;


                    /**
                     * 获取申请到的弹性公网 IPv6 地址的唯一 ID 列表。
                     * @return AddressSet 申请到的弹性公网 IPv6 地址的唯一 ID 列表。
                     * 
                     */
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIPV6ADDRESSESRESPONSE_H_
