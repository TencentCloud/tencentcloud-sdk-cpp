...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyPrivateNatGatewayTranslationNatRuleRequest : public AbstractModel
                {
                public:
                    ModifyPrivateNatGatewayTranslationNatRuleRequest();
                    ~ModifyPrivateNatGatewayTranslationNatRuleRequest() = default;
                    ...
                    /**
                     * 获取转换规则对象数组。仅支持修改单个转换规则
                     * @return TranslationNatRules 转换规则对象数组。仅支持修改单个转换规则
                     * 
                     */
                    std::vector<TranslationNatRuleDiff> GetTranslationNatRules() const;

                    /**
                     * 设置转换规则对象数组。仅支持修改单个转换规则
                     * @param _translationNatRules 转换规则对象数组。仅支持修改单个转换规则
                     * 
                     */
                    void SetTranslationNatRules(const std::vector<TranslationNatRuleDiff>& _translationNatRules);
                ...
                private:
                     ...
                     */
                    std::vector<TranslationNatRuleDiff> m_translationNatRules;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONNATRULEREQUEST_H_
