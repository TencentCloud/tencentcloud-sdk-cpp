...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYTRAFFICMIRRORFILTERRULESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYTRAFFICMIRRORFILTERRULESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyTrafficMirrorFilterRulesRequest : public AbstractModel
                {
                public:
                    ModifyTrafficMirrorFilterRulesRequest();
                    ~ModifyTrafficMirrorFilterRulesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYTRAFFICMIRRORFILTERRULESREQUEST_H_
