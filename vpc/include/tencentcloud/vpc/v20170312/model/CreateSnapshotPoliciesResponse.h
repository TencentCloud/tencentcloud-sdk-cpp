...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATESNAPSHOTPOLICIESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATESNAPSHOTPOLICIESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateSnapshotPoliciesResponse : public AbstractModel
                {
                public:
                    CreateSnapshotPoliciesResponse();
                    ~CreateSnapshotPoliciesResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATESNAPSHOTPOLICIESRESPONSE_H_
