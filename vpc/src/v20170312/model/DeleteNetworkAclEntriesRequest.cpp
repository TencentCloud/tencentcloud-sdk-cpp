...
string DeleteNetworkAclEntriesRequest::ToJsonString() const
{
...
string DeleteNetworkAclEntriesRequest::GetNetworkAclId() const
{
    return m_networkAclId;
}

void DeleteNetworkAclEntriesRequest::SetNetworkAclId(const string& _networkAclId)
{
    m_networkAclId = _networkAclId;
    m_networkAclIdHasBeenSet = true;
}

bool DeleteNetworkAclEntriesRequest::NetworkAclIdHasBeenSet() const
{
    return m_networkAclIdHasBeenSet;
}

NetworkAclEntrySet DeleteNetworkAclEntriesRequest::GetNetworkAclEntrySet() const
{
    return m_networkAclEntrySet;
}

void DeleteNetworkAclEntriesRequest::SetNetworkAclEntrySet(const NetworkAclEntrySet& _networkAclEntrySet)
{
    m_networkAclEntrySet = _networkAclEntrySet;
    m_networkAclEntrySetHasBeenSet = true;
}

bool DeleteNetworkAclEntriesRequest::NetworkAclEntrySetHasBeenSet() const
{
