...
vector<Ipv6Address> CreateAndAttachNetworkInterfaceRequest::GetIpv6Addresses() const
{
    return m_ipv6Addresses;
}

void CreateAndAttachNetworkInterfaceRequest::SetIpv6Addresses(const vector<Ipv6Address>& _ipv6Addresses)
{
    m_ipv6Addresses = _ipv6Addresses;
    m_ipv6AddressesHasBeenSet = true;
}

bool CreateAndAttachNetworkInterfaceRequest::Ipv6AddressesHasBeenSet() const
{
    return m_ipv6AddressesHasBeenSet;
}

uint64_t CreateAndAttachNetworkInterfaceRequest::GetIpv6AddressCount() const
{
    return m_ipv6AddressCount;
}

void CreateAndAttachNetworkInterfaceRequest::SetIpv6AddressCount(const uint64_t& _ipv6AddressCount)
{
    m_ipv6AddressCount = _ipv6AddressCount;
    m_ipv6AddressCountHasBeenSet = true;
}

bool CreateAndAttachNetworkInterfaceRequest::Ipv6AddressCountHasBeenSet() const
{
...
bool CreateAndAttachNetworkInterfaceRequest::GetTerminationProtection() const
{
    return m_terminationProtection;
}

void CreateAndAttachNetworkInterfaceRequest::SetTerminationProtection(const bool& _terminationProtection)
{
    m_terminationProtection = _terminationProtection;
    m_terminationProtectionHasBeenSet = true;
}

bool CreateAndAttachNetworkInterfaceRequest::TerminationProtectionHasBeenSet() const
{
    return m_terminationProtectionHasBeenSet;
}

bool CreateAndAttachNetworkInterfaceRequest::GetTrafficProtection() const
{
    return m_trafficProtection;
}

void CreateAndAttachNetworkInterfaceRequest::SetTrafficProtection(const bool& _trafficProtection)
{
    m_trafficProtection = _trafficProtection;
    m_trafficProtectionHasBeenSet = true;
}

bool CreateAndAttachNetworkInterfaceRequest::TrafficProtectionHasBeenSet() const
{
