...
CoreInternalOutcome ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse::Deserialize(const string &payload)
{
...
string ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse::ToJsonString() const
{
