...
string DeleteRoutePolicyAssociationsRequest::ToJsonString() const
{
...
vector<RoutePolicyAssociation> DeleteRoutePolicyAssociationsRequest::GetRoutePolicyAssociationSet() const
{
    return m_routePolicyAssociationSet;
}

void DeleteRoutePolicyAssociationsRequest::SetRoutePolicyAssociationSet(const vector<RoutePolicyAssociation>& _routePolicyAssociationSet)
{
    m_routePolicyAssociationSet = _routePolicyAssociationSet;
    m_routePolicyAssociationSetHasBeenSet = true;
}

bool DeleteRoutePolicyAssociationsRequest::RoutePolicyAssociationSetHasBeenSet() const
{
