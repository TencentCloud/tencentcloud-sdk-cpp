...
CoreInternalOutcome InquiryPriceModifyAddressesBandwidthResponse::Deserialize(const string &payload)
{
...
string InquiryPriceModifyAddressesBandwidthResponse::ToJsonString() const
{
...
InternetPrice InquiryPriceModifyAddressesBandwidthResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceModifyAddressesBandwidthResponse::PriceHasBeenSet() const
{
