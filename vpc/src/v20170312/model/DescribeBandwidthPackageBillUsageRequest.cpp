...
string DescribeBandwidthPackageBillUsageRequest::ToJsonString() const
{
...
string DescribeBandwidthPackageBillUsageRequest::GetBandwidthPackageId() const
{
    return m_bandwidthPackageId;
}

void DescribeBandwidthPackageBillUsageRequest::SetBandwidthPackageId(const string& _bandwidthPackageId)
{
    m_bandwidthPackageId = _bandwidthPackageId;
    m_bandwidthPackageIdHasBeenSet = true;
}

bool DescribeBandwidthPackageBillUsageRequest::BandwidthPackageIdHasBeenSet() const
{
