...
string DeleteDirectConnectGatewayRequest::ToJsonString() const
{
...
string DeleteDirectConnectGatewayRequest::GetDirectConnectGatewayId() const
{
    return m_directConnectGatewayId;
}

void DeleteDirectConnectGatewayRequest::SetDirectConnectGatewayId(const string& _directConnectGatewayId)
{
    m_directConnectGatewayId = _directConnectGatewayId;
    m_directConnectGatewayIdHasBeenSet = true;
}

bool DeleteDirectConnectGatewayRequest::DirectConnectGatewayIdHasBeenSet() const
{
