...
CoreInternalOutcome DescribeAssistantCidrResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AssistantCidrSet") && !rsp["AssistantCidrSet"].IsNull())
    {
        if (!rsp["AssistantCidrSet"].IsArray())
            return CoreInternalOutcome(Error("response `AssistantCidrSet` is not array type"));
...
string DescribeAssistantCidrResponse::ToJsonString() const
{
...
vector<AssistantCidr> DescribeAssistantCidrResponse::GetAssistantCidrSet() const
{
    return m_assistantCidrSet;
}

bool DescribeAssistantCidrResponse::AssistantCidrSetHasBeenSet() const
{
    return m_assistantCidrSetHasBeenSet;
}

uint64_t DescribeAssistantCidrResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAssistantCidrResponse::TotalCountHasBeenSet() const
{
