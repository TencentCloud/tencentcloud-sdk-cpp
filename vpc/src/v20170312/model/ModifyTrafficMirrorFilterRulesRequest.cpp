...
ModifyTrafficMirrorFilterRulesRequest::ModifyTrafficMirrorFilterRulesRequest() :
...
string ModifyTrafficMirrorFilterRulesRequest::ToJsonString() const
{
...
string ModifyTrafficMirrorFilterRulesRequest::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

void ModifyTrafficMirrorFilterRulesRequest::SetTrafficMirrorId(const string& _trafficMirrorId)
{
    m_trafficMirrorId = _trafficMirrorId;
    m_trafficMirrorIdHasBeenSet = true;
}

bool ModifyTrafficMirrorFilterRulesRequest::TrafficMirrorIdHasBeenSet() const
{
    return m_trafficMirrorIdHasBeenSet;
}

vector<TrafficMirrorFilter> ModifyTrafficMirrorFilterRulesRequest::GetIngressFilterRules() const
{
    return m_ingressFilterRules;
}

void ModifyTrafficMirrorFilterRulesRequest::SetIngressFilterRules(const vector<TrafficMirrorFilter>& _ingressFilterRules)
{
    m_ingressFilterRules = _ingressFilterRules;
    m_ingressFilterRulesHasBeenSet = true;
}

bool ModifyTrafficMirrorFilterRulesRequest::IngressFilterRulesHasBeenSet() const
{
    return m_ingressFilterRulesHasBeenSet;
}

vector<TrafficMirrorFilter> ModifyTrafficMirrorFilterRulesRequest::GetEgressFilterRules() const
{
    return m_egressFilterRules;
}

void ModifyTrafficMirrorFilterRulesRequest::SetEgressFilterRules(const vector<TrafficMirrorFilter>& _egressFilterRules)
{
    m_egressFilterRules = _egressFilterRules;
    m_egressFilterRulesHasBeenSet = true;
}

bool ModifyTrafficMirrorFilterRulesRequest::EgressFilterRulesHasBeenSet() const
{
