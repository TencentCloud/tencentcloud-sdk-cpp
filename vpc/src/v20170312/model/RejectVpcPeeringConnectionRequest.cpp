...
string RejectVpcPeeringConnectionRequest::ToJsonString() const
{
...
string RejectVpcPeeringConnectionRequest::GetPeeringConnectionId() const
{
    return m_peeringConnectionId;
}

void RejectVpcPeeringConnectionRequest::SetPeeringConnectionId(const string& _peeringConnectionId)
{
    m_peeringConnectionId = _peeringConnectionId;
    m_peeringConnectionIdHasBeenSet = true;
}

bool RejectVpcPeeringConnectionRequest::PeeringConnectionIdHasBeenSet() const
{
