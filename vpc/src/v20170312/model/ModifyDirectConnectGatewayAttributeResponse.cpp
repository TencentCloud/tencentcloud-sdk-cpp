...
CoreInternalOutcome ModifyDirectConnectGatewayAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyDirectConnectGatewayAttributeResponse::ToJsonString() const
{
