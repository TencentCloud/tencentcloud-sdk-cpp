...
DisassociateHaVipInstanceRequest::DisassociateHaVipInstanceRequest() :
    m_haVipAssociationSetHasBeenSet(false)
{
}

string DisassociateHaVipInstanceRequest::ToJsonString() const
{
...
vector<HaVipAssociation> DisassociateHaVipInstanceRequest::GetHaVipAssociationSet() const
{
    return m_haVipAssociationSet;
}

void DisassociateHaVipInstanceRequest::SetHaVipAssociationSet(const vector<HaVipAssociation>& _haVipAssociationSet)
{
    m_haVipAssociationSet = _haVipAssociationSet;
    m_haVipAssociationSetHasBeenSet = true;
}

bool DisassociateHaVipInstanceRequest::HaVipAssociationSetHasBeenSet() const
{
