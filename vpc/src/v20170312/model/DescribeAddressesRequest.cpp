...
int64_t DescribeAddressesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAddressesRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
int64_t DescribeAddressesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeAddressesRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
