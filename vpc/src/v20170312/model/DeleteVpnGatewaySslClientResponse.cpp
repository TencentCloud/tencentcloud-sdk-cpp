...
CoreInternalOutcome DeleteVpnGatewaySslClientResponse::Deserialize(const string &payload)
{
...
string DeleteVpnGatewaySslClientResponse::ToJsonString() const
{
...
uint64_t DeleteVpnGatewaySslClientResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpnGatewaySslClientResponse::TaskIdHasBeenSet() const
{
