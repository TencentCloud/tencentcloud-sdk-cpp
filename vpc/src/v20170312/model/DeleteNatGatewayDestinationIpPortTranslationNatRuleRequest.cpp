...
string DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::ToJsonString() const
{
...
string DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::GetNatGatewayId() const
{
    return m_natGatewayId;
}

void DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::SetNatGatewayId(const string& _natGatewayId)
{
    m_natGatewayId = _natGatewayId;
    m_natGatewayIdHasBeenSet = true;
}

bool DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::NatGatewayIdHasBeenSet() const
{
    return m_natGatewayIdHasBeenSet;
}

vector<DestinationIpPortTranslationNatRule> DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::GetDestinationIpPortTranslationNatRules() const
{
    return m_destinationIpPortTranslationNatRules;
}

void DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::SetDestinationIpPortTranslationNatRules(const vector<DestinationIpPortTranslationNatRule>& _destinationIpPortTranslationNatRules)
{
...
bool DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest::DestinationIpPortTranslationNatRulesHasBeenSet() const
{
