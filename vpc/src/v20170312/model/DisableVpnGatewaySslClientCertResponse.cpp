...
CoreInternalOutcome DisableVpnGatewaySslClientCertResponse::Deserialize(const string &payload)
{
...
string DisableVpnGatewaySslClientCertResponse::ToJsonString() const
{
...
uint64_t DisableVpnGatewaySslClientCertResponse::GetTaskId() const
{
    return m_taskId;
}

bool DisableVpnGatewaySslClientCertResponse::TaskIdHasBeenSet() const
{
