...
CoreInternalOutcome ModifyServiceTemplateAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyServiceTemplateAttributeResponse::ToJsonString() const
{
