...
CoreInternalOutcome InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse::Deserialize(const string &payload)
{
...
string InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse::ToJsonString() const
{
...
Price InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse::PriceHasBeenSet() const
{
