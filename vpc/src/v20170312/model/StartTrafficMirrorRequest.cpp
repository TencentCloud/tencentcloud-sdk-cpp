...
StartTrafficMirrorRequest::StartTrafficMirrorRequest() :
    m_trafficMirrorIdHasBeenSet(false)
{
}

string StartTrafficMirrorRequest::ToJsonString() const
{
...
string StartTrafficMirrorRequest::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

void StartTrafficMirrorRequest::SetTrafficMirrorId(const string& _trafficMirrorId)
{
    m_trafficMirrorId = _trafficMirrorId;
    m_trafficMirrorIdHasBeenSet = true;
}

bool StartTrafficMirrorRequest::TrafficMirrorIdHasBeenSet() const
{
