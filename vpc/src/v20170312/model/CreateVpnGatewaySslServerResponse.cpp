...
CoreInternalOutcome CreateVpnGatewaySslServerResponse::Deserialize(const string &payload)
{
...
string CreateVpnGatewaySslServerResponse::ToJsonString() const
{
...
int64_t CreateVpnGatewaySslServerResponse::GetTaskId() const
{
    return m_taskId;
}
