...
vector<string> DescribeNatGatewaysRequest::GetNatGatewayIds() const
{
    return m_natGatewayIds;
}

void DescribeNatGatewaysRequest::SetNatGatewayIds(const vector<string>& _natGatewayIds)
{
    m_natGatewayIds = _natGatewayIds;
    m_natGatewayIdsHasBeenSet = true;
}

bool DescribeNatGatewaysRequest::NatGatewayIdsHasBeenSet() const
{
    return m_natGatewayIdsHasBeenSet;
}

vector<Filter> DescribeNatGatewaysRequest::GetFilters() const
{
    return m_filters;
}

void DescribeNatGatewaysRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeNatGatewaysRequest::FiltersHasBeenSet() const
{
