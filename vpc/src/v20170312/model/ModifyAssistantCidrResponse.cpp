...
CoreInternalOutcome ModifyAssistantCidrResponse::Deserialize(const string &payload)
{
...
string ModifyAssistantCidrResponse::ToJsonString() const
{
...
vector<AssistantCidr> ModifyAssistantCidrResponse::GetAssistantCidrSet() const
{
    return m_assistantCidrSet;
}

bool ModifyAssistantCidrResponse::AssistantCidrSetHasBeenSet() const
{
