...
CoreInternalOutcome InquiryPriceAllocateAddressesResponse::Deserialize(const string &payload)
{
...
string InquiryPriceAllocateAddressesResponse::ToJsonString() const
{
...
InternetPrice InquiryPriceAllocateAddressesResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceAllocateAddressesResponse::PriceHasBeenSet() const
{
