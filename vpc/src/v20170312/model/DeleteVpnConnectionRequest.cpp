...
string DeleteVpnConnectionRequest::ToJsonString() const
{
...
string DeleteVpnConnectionRequest::GetVpnGatewayId() const
{
    return m_vpnGatewayId;
}

void DeleteVpnConnectionRequest::SetVpnGatewayId(const string& _vpnGatewayId)
{
    m_vpnGatewayId = _vpnGatewayId;
    m_vpnGatewayIdHasBeenSet = true;
}

bool DeleteVpnConnectionRequest::VpnGatewayIdHasBeenSet() const
{
    return m_vpnGatewayIdHasBeenSet;
}

string DeleteVpnConnectionRequest::GetVpnConnectionId() const
{
    return m_vpnConnectionId;
}

void DeleteVpnConnectionRequest::SetVpnConnectionId(const string& _vpnConnectionId)
{
    m_vpnConnectionId = _vpnConnectionId;
    m_vpnConnectionIdHasBeenSet = true;
}

bool DeleteVpnConnectionRequest::VpnConnectionIdHasBeenSet() const
{
