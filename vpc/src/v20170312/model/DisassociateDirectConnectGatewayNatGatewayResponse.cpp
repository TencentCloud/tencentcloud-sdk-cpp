...
CoreInternalOutcome DisassociateDirectConnectGatewayNatGatewayResponse::Deserialize(const string &payload)
{
...
string DisassociateDirectConnectGatewayNatGatewayResponse::ToJsonString() const
{
