...
string NotifyRoutesRequest::ToJsonString() const
{
...
string NotifyRoutesRequest::GetRouteTableId() const
{
    return m_routeTableId;
}

void NotifyRoutesRequest::SetRouteTableId(const string& _routeTableId)
{
    m_routeTableId = _routeTableId;
    m_routeTableIdHasBeenSet = true;
}

bool NotifyRoutesRequest::RouteTableIdHasBeenSet() const
{
    return m_routeTableIdHasBeenSet;
}

vector<string> NotifyRoutesRequest::GetRouteItemIds() const
{
    return m_routeItemIds;
}

void NotifyRoutesRequest::SetRouteItemIds(const vector<string>& _routeItemIds)
{
    m_routeItemIds = _routeItemIds;
    m_routeItemIdsHasBeenSet = true;
}

bool NotifyRoutesRequest::RouteItemIdsHasBeenSet() const
{
