...
vector<TrafficPackage> DescribeTrafficPackagesResponse::GetTrafficPackageSet() const
{
    return m_trafficPackageSet;
}

bool DescribeTrafficPackagesResponse::TrafficPackageSetHasBeenSet() const
{
