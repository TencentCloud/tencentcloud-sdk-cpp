...
string ResetNatGatewayConnectionRequest::ToJsonString() const
{
...
string ResetNatGatewayConnectionRequest::GetNatGatewayId() const
{
    return m_natGatewayId;
}

void ResetNatGatewayConnectionRequest::SetNatGatewayId(const string& _natGatewayId)
{
    m_natGatewayId = _natGatewayId;
    m_natGatewayIdHasBeenSet = true;
}

bool ResetNatGatewayConnectionRequest::NatGatewayIdHasBeenSet() const
{
    return m_natGatewayIdHasBeenSet;
}

uint64_t ResetNatGatewayConnectionRequest::GetMaxConcurrentConnection() const
{
    return m_maxConcurrentConnection;
}

void ResetNatGatewayConnectionRequest::SetMaxConcurrentConnection(const uint64_t& _maxConcurrentConnection)
{
