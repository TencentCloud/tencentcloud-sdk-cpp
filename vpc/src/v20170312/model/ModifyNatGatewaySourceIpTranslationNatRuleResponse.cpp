...
CoreInternalOutcome ModifyNatGatewaySourceIpTranslationNatRuleResponse::Deserialize(const string &payload)
{
...
string ModifyNatGatewaySourceIpTranslationNatRuleResponse::ToJsonString() const
{
