...
CoreInternalOutcome DescribeVpcPeeringConnectionsResponse::Deserialize(const string &payload)
{
...
string DescribeVpcPeeringConnectionsResponse::ToJsonString() const
{
