...
Filter DescribeTrafficMirrorsRequest::GetFilters() const
{
    return m_filters;
}

void DescribeTrafficMirrorsRequest::SetFilters(const Filter& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeTrafficMirrorsRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

uint64_t DescribeTrafficMirrorsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeTrafficMirrorsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeTrafficMirrorsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeTrafficMirrorsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
