...
string DescribeVpcResourceDashboardRequest::ToJsonString() const
{
...
vector<string> DescribeVpcResourceDashboardRequest::GetVpcIds() const
{
    return m_vpcIds;
}

void DescribeVpcResourceDashboardRequest::SetVpcIds(const vector<string>& _vpcIds)
{
    m_vpcIds = _vpcIds;
    m_vpcIdsHasBeenSet = true;
}

bool DescribeVpcResourceDashboardRequest::VpcIdsHasBeenSet() const
{
