...
string EnableVpnGatewaySslClientCertRequest::ToJsonString() const
{
...
string EnableVpnGatewaySslClientCertRequest::GetSslVpnClientId() const
{
    return m_sslVpnClientId;
}

void EnableVpnGatewaySslClientCertRequest::SetSslVpnClientId(const string& _sslVpnClientId)
{
