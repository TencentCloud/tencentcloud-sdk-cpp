...
vector<TrafficMirrorFilter> UpdateTrafficMirrorAllFilterRequest::GetIngressFilterRules() const
{
    return m_ingressFilterRules;
}

void UpdateTrafficMirrorAllFilterRequest::SetIngressFilterRules(const vector<TrafficMirrorFilter>& _ingressFilterRules)
{
    m_ingressFilterRules = _ingressFilterRules;
    m_ingressFilterRulesHasBeenSet = true;
}

bool UpdateTrafficMirrorAllFilterRequest::IngressFilterRulesHasBeenSet() const
{
    return m_ingressFilterRulesHasBeenSet;
}

vector<TrafficMirrorFilter> UpdateTrafficMirrorAllFilterRequest::GetEgressFilterRules() const
{
    return m_egressFilterRules;
}

void UpdateTrafficMirrorAllFilterRequest::SetEgressFilterRules(const vector<TrafficMirrorFilter>& _egressFilterRules)
{
    m_egressFilterRules = _egressFilterRules;
    m_egressFilterRulesHasBeenSet = true;
}

bool UpdateTrafficMirrorAllFilterRequest::EgressFilterRulesHasBeenSet() const
{
