...
CoreInternalOutcome ModifyServiceTemplateGroupAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyServiceTemplateGroupAttributeResponse::ToJsonString() const
{
