...
string GenerateVpnConnectionDefaultHealthCheckIpRequest::ToJsonString() const
{
...
string GenerateVpnConnectionDefaultHealthCheckIpRequest::GetVpnGatewayId() const
{
    return m_vpnGatewayId;
}

void GenerateVpnConnectionDefaultHealthCheckIpRequest::SetVpnGatewayId(const string& _vpnGatewayId)
{
    m_vpnGatewayId = _vpnGatewayId;
    m_vpnGatewayIdHasBeenSet = true;
}

bool GenerateVpnConnectionDefaultHealthCheckIpRequest::VpnGatewayIdHasBeenSet() const
{
