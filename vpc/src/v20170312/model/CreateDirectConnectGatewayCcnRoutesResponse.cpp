...
CoreInternalOutcome CreateDirectConnectGatewayCcnRoutesResponse::Deserialize(const string &payload)
{
...
string CreateDirectConnectGatewayCcnRoutesResponse::ToJsonString() const
{
