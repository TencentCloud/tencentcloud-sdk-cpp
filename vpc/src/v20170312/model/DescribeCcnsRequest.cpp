...
string DescribeCcnsRequest::ToJsonString() const
{
    ...
    if (m_ccnIdsHasBeenSet)
    {
        ...
        for (auto itr = m_ccnIds.begin(); itr != m_ccnIds.end(); ++itr)
        {
...
vector<string> DescribeCcnsRequest::GetCcnIds() const
{
    return m_ccnIds;
}

void DescribeCcnsRequest::SetCcnIds(const vector<string>& _ccnIds)
{
    m_ccnIds = _ccnIds;
    m_ccnIdsHasBeenSet = true;
}

bool DescribeCcnsRequest::CcnIdsHasBeenSet() const
{
    return m_ccnIdsHasBeenSet;
}

vector<Filter> DescribeCcnsRequest::GetFilters() const
{
    return m_filters;
}

void DescribeCcnsRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeCcnsRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

uint64_t DescribeCcnsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeCcnsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeCcnsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeCcnsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeCcnsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
