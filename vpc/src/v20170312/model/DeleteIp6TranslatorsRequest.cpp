...
string DeleteIp6TranslatorsRequest::ToJsonString() const
{
...
vector<string> DeleteIp6TranslatorsRequest::GetIp6TranslatorIds() const
{
    return m_ip6TranslatorIds;
}

void DeleteIp6TranslatorsRequest::SetIp6TranslatorIds(const vector<string>& _ip6TranslatorIds)
{
    m_ip6TranslatorIds = _ip6TranslatorIds;
    m_ip6TranslatorIdsHasBeenSet = true;
}

bool DeleteIp6TranslatorsRequest::Ip6TranslatorIdsHasBeenSet() const
{
