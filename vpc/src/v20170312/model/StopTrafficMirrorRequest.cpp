...
StopTrafficMirrorRequest::StopTrafficMirrorRequest() :
    m_trafficMirrorIdHasBeenSet(false)
{
}

string StopTrafficMirrorRequest::ToJsonString() const
{
...
string StopTrafficMirrorRequest::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

void StopTrafficMirrorRequest::SetTrafficMirrorId(const string& _trafficMirrorId)
{
    m_trafficMirrorId = _trafficMirrorId;
    m_trafficMirrorIdHasBeenSet = true;
}

bool StopTrafficMirrorRequest::TrafficMirrorIdHasBeenSet() const
{
