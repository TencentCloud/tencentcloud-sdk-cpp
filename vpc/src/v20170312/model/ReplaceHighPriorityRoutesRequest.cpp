...
ReplaceHighPriorityRoutesRequest::ReplaceHighPriorityRoutesRequest() :
    m_highPriorityRouteTableIdHasBeenSet(false),
    m_highPriorityRoutesHasBeenSet(false)
{
}

string ReplaceHighPriorityRoutesRequest::ToJsonString() const
{
...
string ReplaceHighPriorityRoutesRequest::GetHighPriorityRouteTableId() const
{
    return m_highPriorityRouteTableId;
}

void ReplaceHighPriorityRoutesRequest::SetHighPriorityRouteTableId(const string& _highPriorityRouteTableId)
{
    m_highPriorityRouteTableId = _highPriorityRouteTableId;
    m_highPriorityRouteTableIdHasBeenSet = true;
}

bool ReplaceHighPriorityRoutesRequest::HighPriorityRouteTableIdHasBeenSet() const
{
    return m_highPriorityRouteTableIdHasBeenSet;
}

vector<HighPriorityRoute> ReplaceHighPriorityRoutesRequest::GetHighPriorityRoutes() const
{
    return m_highPriorityRoutes;
}

void ReplaceHighPriorityRoutesRequest::SetHighPriorityRoutes(const vector<HighPriorityRoute>& _highPriorityRoutes)
{
    m_highPriorityRoutes = _highPriorityRoutes;
    m_highPriorityRoutesHasBeenSet = true;
}

bool ReplaceHighPriorityRoutesRequest::HighPriorityRoutesHasBeenSet() const
{
