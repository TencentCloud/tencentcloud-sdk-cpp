...
CoreInternalOutcome InquiryPriceRenewVpnGatewayResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRenewVpnGatewayResponse::ToJsonString() const
{
...
Price InquiryPriceRenewVpnGatewayResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRenewVpnGatewayResponse::PriceHasBeenSet() const
{
