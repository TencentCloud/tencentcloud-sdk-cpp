...
CoreInternalOutcome AssignIpv6AddressesResponse::Deserialize(const string &payload)
{
...
string AssignIpv6AddressesResponse::ToJsonString() const
{
...
vector<Ipv6Address> AssignIpv6AddressesResponse::GetIpv6AddressSet() const
{
    return m_ipv6AddressSet;
}

bool AssignIpv6AddressesResponse::Ipv6AddressSetHasBeenSet() const
{
