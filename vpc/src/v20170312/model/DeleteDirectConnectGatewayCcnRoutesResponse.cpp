...
CoreInternalOutcome DeleteDirectConnectGatewayCcnRoutesResponse::Deserialize(const string &payload)
{
...
string DeleteDirectConnectGatewayCcnRoutesResponse::ToJsonString() const
{
