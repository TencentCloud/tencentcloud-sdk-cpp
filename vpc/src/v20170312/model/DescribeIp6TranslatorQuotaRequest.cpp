...
string DescribeIp6TranslatorQuotaRequest::ToJsonString() const
{
...
vector<string> DescribeIp6TranslatorQuotaRequest::GetIp6TranslatorIds() const
{
    return m_ip6TranslatorIds;
}

void DescribeIp6TranslatorQuotaRequest::SetIp6TranslatorIds(const vector<string>& _ip6TranslatorIds)
{
    m_ip6TranslatorIds = _ip6TranslatorIds;
    m_ip6TranslatorIdsHasBeenSet = true;
}

bool DescribeIp6TranslatorQuotaRequest::Ip6TranslatorIdsHasBeenSet() const
{
