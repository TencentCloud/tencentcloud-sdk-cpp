...
CoreInternalOutcome DescribeVpcIpv6AddressesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Ipv6AddressSet") && !rsp["Ipv6AddressSet"].IsNull())
    {
        if (!rsp["Ipv6AddressSet"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Ipv6AddressSet` is not array type"));
...
string DescribeVpcIpv6AddressesResponse::ToJsonString() const
{
...
vector<VpcIpv6Address> DescribeVpcIpv6AddressesResponse::GetIpv6AddressSet() const
{
    return m_ipv6AddressSet;
}

bool DescribeVpcIpv6AddressesResponse::Ipv6AddressSetHasBeenSet() const
{
    return m_ipv6AddressSetHasBeenSet;
}

uint64_t DescribeVpcIpv6AddressesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVpcIpv6AddressesResponse::TotalCountHasBeenSet() const
{
