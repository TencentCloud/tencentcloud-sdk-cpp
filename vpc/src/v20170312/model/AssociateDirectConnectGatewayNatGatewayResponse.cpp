...
CoreInternalOutcome AssociateDirectConnectGatewayNatGatewayResponse::Deserialize(const string &payload)
{
...
string AssociateDirectConnectGatewayNatGatewayResponse::ToJsonString() const
{
