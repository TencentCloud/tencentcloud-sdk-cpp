...
CoreInternalOutcome ClassicLinkInstance::Deserialize(const Value &value)
{
    string requestId = "";
...
void ClassicLinkInstance::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
