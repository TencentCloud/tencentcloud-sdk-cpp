...
string CreateNetworkAclQuintupleEntriesRequest::ToJsonString() const
{
...
string CreateNetworkAclQuintupleEntriesRequest::GetNetworkAclId() const
{
    return m_networkAclId;
}

void CreateNetworkAclQuintupleEntriesRequest::SetNetworkAclId(const string& _networkAclId)
{
    m_networkAclId = _networkAclId;
    m_networkAclIdHasBeenSet = true;
}

bool CreateNetworkAclQuintupleEntriesRequest::NetworkAclIdHasBeenSet() const
{
    return m_networkAclIdHasBeenSet;
}

NetworkAclQuintupleEntries CreateNetworkAclQuintupleEntriesRequest::GetNetworkAclQuintupleSet() const
{
    return m_networkAclQuintupleSet;
}

void CreateNetworkAclQuintupleEntriesRequest::SetNetworkAclQuintupleSet(const NetworkAclQuintupleEntries& _networkAclQuintupleSet)
{
    m_networkAclQuintupleSet = _networkAclQuintupleSet;
    m_networkAclQuintupleSetHasBeenSet = true;
}

bool CreateNetworkAclQuintupleEntriesRequest::NetworkAclQuintupleSetHasBeenSet() const
{
