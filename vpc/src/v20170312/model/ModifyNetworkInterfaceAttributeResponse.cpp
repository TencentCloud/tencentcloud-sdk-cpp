...
CoreInternalOutcome ModifyNetworkInterfaceAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyNetworkInterfaceAttributeResponse::ToJsonString() const
{
