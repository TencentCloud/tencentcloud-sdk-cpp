...
CoreInternalOutcome DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse::Deserialize(const string &payload)
{
...
string DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse::ToJsonString() const
{
