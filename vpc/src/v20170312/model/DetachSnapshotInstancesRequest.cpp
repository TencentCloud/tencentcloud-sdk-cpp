...
string DetachSnapshotInstancesRequest::ToJsonString() const
{
...
string DetachSnapshotInstancesRequest::GetSnapshotPolicyId() const
{
    return m_snapshotPolicyId;
}

void DetachSnapshotInstancesRequest::SetSnapshotPolicyId(const string& _snapshotPolicyId)
{
    m_snapshotPolicyId = _snapshotPolicyId;
    m_snapshotPolicyIdHasBeenSet = true;
}

bool DetachSnapshotInstancesRequest::SnapshotPolicyIdHasBeenSet() const
{
    return m_snapshotPolicyIdHasBeenSet;
}

vector<SnapshotInstance> DetachSnapshotInstancesRequest::GetInstances() const
{
    return m_instances;
}

void DetachSnapshotInstancesRequest::SetInstances(const vector<SnapshotInstance>& _instances)
{
    m_instances = _instances;
    m_instancesHasBeenSet = true;
}

bool DetachSnapshotInstancesRequest::InstancesHasBeenSet() const
{
