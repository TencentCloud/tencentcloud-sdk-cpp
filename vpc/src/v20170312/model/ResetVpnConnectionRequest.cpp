...
string ResetVpnConnectionRequest::GetVpnGatewayId() const
{
    return m_vpnGatewayId;
}

void ResetVpnConnectionRequest::SetVpnGatewayId(const string& _vpnGatewayId)
{
    m_vpnGatewayId = _vpnGatewayId;
    m_vpnGatewayIdHasBeenSet = true;
}

bool ResetVpnConnectionRequest::VpnGatewayIdHasBeenSet() const
{
