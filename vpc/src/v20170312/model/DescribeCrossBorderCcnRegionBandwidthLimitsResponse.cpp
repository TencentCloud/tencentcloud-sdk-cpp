...
CoreInternalOutcome DescribeCrossBorderCcnRegionBandwidthLimitsResponse::Deserialize(const string &payload)
{
...
string DescribeCrossBorderCcnRegionBandwidthLimitsResponse::ToJsonString() const
{
