...
string DeleteServiceTemplateRequest::ToJsonString() const
{
...
string DeleteServiceTemplateRequest::GetServiceTemplateId() const
{
    return m_serviceTemplateId;
}

void DeleteServiceTemplateRequest::SetServiceTemplateId(const string& _serviceTemplateId)
{
    m_serviceTemplateId = _serviceTemplateId;
    m_serviceTemplateIdHasBeenSet = true;
}

bool DeleteServiceTemplateRequest::ServiceTemplateIdHasBeenSet() const
{
