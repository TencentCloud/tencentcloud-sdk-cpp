...
CoreInternalOutcome ModifyVpnGatewayRoutesResponse::Deserialize(const string &payload)
{
...
string ModifyVpnGatewayRoutesResponse::ToJsonString() const
{
...
vector<VpnGatewayRoute> ModifyVpnGatewayRoutesResponse::GetRoutes() const
{
    return m_routes;
}

bool ModifyVpnGatewayRoutesResponse::RoutesHasBeenSet() const
{
