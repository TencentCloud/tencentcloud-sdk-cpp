...
CoreInternalOutcome DescribeVpcInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeVpcInstancesResponse::ToJsonString() const
{
...
vector<CvmInstance> DescribeVpcInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeVpcInstancesResponse::InstanceSetHasBeenSet() const
{
    return m_instanceSetHasBeenSet;
}

uint64_t DescribeVpcInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVpcInstancesResponse::TotalCountHasBeenSet() const
{
