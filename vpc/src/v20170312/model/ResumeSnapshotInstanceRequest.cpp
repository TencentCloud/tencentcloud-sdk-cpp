...
string ResumeSnapshotInstanceRequest::ToJsonString() const
{
...
string ResumeSnapshotInstanceRequest::GetSnapshotPolicyId() const
{
    return m_snapshotPolicyId;
}

void ResumeSnapshotInstanceRequest::SetSnapshotPolicyId(const string& _snapshotPolicyId)
{
    m_snapshotPolicyId = _snapshotPolicyId;
    m_snapshotPolicyIdHasBeenSet = true;
}

bool ResumeSnapshotInstanceRequest::SnapshotPolicyIdHasBeenSet() const
{
    return m_snapshotPolicyIdHasBeenSet;
}

string ResumeSnapshotInstanceRequest::GetSnapshotFileId() const
{
    return m_snapshotFileId;
}

void ResumeSnapshotInstanceRequest::SetSnapshotFileId(const string& _snapshotFileId)
{
    m_snapshotFileId = _snapshotFileId;
    m_snapshotFileIdHasBeenSet = true;
}

bool ResumeSnapshotInstanceRequest::SnapshotFileIdHasBeenSet() const
{
    return m_snapshotFileIdHasBeenSet;
}

string ResumeSnapshotInstanceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void ResumeSnapshotInstanceRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ResumeSnapshotInstanceRequest::InstanceIdHasBeenSet() const
{
