...
CoreInternalOutcome CreateNatGatewayDestinationIpPortTranslationNatRuleResponse::Deserialize(const string &payload)
{
...
string CreateNatGatewayDestinationIpPortTranslationNatRuleResponse::ToJsonString() const
{
