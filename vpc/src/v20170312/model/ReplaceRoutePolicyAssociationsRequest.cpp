...
string ReplaceRoutePolicyAssociationsRequest::ToJsonString() const
{
...
vector<RoutePolicyAssociation> ReplaceRoutePolicyAssociationsRequest::GetRoutePolicyAssociationSet() const
{
    return m_routePolicyAssociationSet;
}

void ReplaceRoutePolicyAssociationsRequest::SetRoutePolicyAssociationSet(const vector<RoutePolicyAssociation>& _routePolicyAssociationSet)
{
    m_routePolicyAssociationSet = _routePolicyAssociationSet;
    m_routePolicyAssociationSetHasBeenSet = true;
}

bool ReplaceRoutePolicyAssociationsRequest::RoutePolicyAssociationSetHasBeenSet() const
{
