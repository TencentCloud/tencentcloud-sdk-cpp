...
CoreInternalOutcome DescribeAddressTemplateInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeAddressTemplateInstancesResponse::ToJsonString() const
{
