...
string CreateRoutePolicyEntriesRequest::ToJsonString() const
{
...
string CreateRoutePolicyEntriesRequest::GetRoutePolicyId() const
{
    return m_routePolicyId;
}

void CreateRoutePolicyEntriesRequest::SetRoutePolicyId(const string& _routePolicyId)
{
    m_routePolicyId = _routePolicyId;
    m_routePolicyIdHasBeenSet = true;
}

bool CreateRoutePolicyEntriesRequest::RoutePolicyIdHasBeenSet() const
{
    return m_routePolicyIdHasBeenSet;
}

vector<RoutePolicyEntry> CreateRoutePolicyEntriesRequest::GetRoutePolicyEntrySet() const
{
    return m_routePolicyEntrySet;
}

void CreateRoutePolicyEntriesRequest::SetRoutePolicyEntrySet(const vector<RoutePolicyEntry>& _routePolicyEntrySet)
{
    m_routePolicyEntrySet = _routePolicyEntrySet;
    m_routePolicyEntrySetHasBeenSet = true;
}

bool CreateRoutePolicyEntriesRequest::RoutePolicyEntrySetHasBeenSet() const
{
