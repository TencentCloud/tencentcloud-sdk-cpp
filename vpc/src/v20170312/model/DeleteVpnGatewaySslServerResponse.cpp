...
CoreInternalOutcome DeleteVpnGatewaySslServerResponse::Deserialize(const string &payload)
{
...
string DeleteVpnGatewaySslServerResponse::ToJsonString() const
{
...
uint64_t DeleteVpnGatewaySslServerResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpnGatewaySslServerResponse::TaskIdHasBeenSet() const
{
