...
CoreInternalOutcome InquiryPriceCreateVpnGatewayResponse::Deserialize(const string &payload)
{
...
string InquiryPriceCreateVpnGatewayResponse::ToJsonString() const
{
...
Price InquiryPriceCreateVpnGatewayResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceCreateVpnGatewayResponse::PriceHasBeenSet() const
{
