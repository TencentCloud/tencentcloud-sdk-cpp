...
CoreInternalOutcome CcnRouteTableInputPolicy::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("RouteConditions") && !value["RouteConditions"].IsNull())
    {
        if (!value["RouteConditions"].IsArray())
            return CoreInternalOutcome(Core::Error("response `CcnRouteTableInputPolicy.RouteConditions` is not array type"));
    ...
    if (value.HasMember("Action") && !value["Action"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CcnRouteTableInputPolicy.Action` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Description") && !value["Description"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CcnRouteTableInputPolicy.Description` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void CcnRouteTableInputPolicy::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<CcnRouteBroadcastPolicyRouteCondition> CcnRouteTableInputPolicy::GetRouteConditions() const
{
    return m_routeConditions;
}

void CcnRouteTableInputPolicy::SetRouteConditions(const vector<CcnRouteBroadcastPolicyRouteCondition>& _routeConditions)
{
    m_routeConditions = _routeConditions;
    m_routeConditionsHasBeenSet = true;
}

bool CcnRouteTableInputPolicy::RouteConditionsHasBeenSet() const
{
    return m_routeConditionsHasBeenSet;
}

string CcnRouteTableInputPolicy::GetAction() const
{
    return m_action;
}

void CcnRouteTableInputPolicy::SetAction(const string& _action)
{
    m_action = _action;
    m_actionHasBeenSet = true;
}

bool CcnRouteTableInputPolicy::ActionHasBeenSet() const
{
    return m_actionHasBeenSet;
}

string CcnRouteTableInputPolicy::GetDescription() const
{
    return m_description;
}

void CcnRouteTableInputPolicy::SetDescription(const string& _description)
{
