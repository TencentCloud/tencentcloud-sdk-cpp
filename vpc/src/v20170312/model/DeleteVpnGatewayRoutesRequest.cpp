...
string DeleteVpnGatewayRoutesRequest::ToJsonString() const
{
...
string DeleteVpnGatewayRoutesRequest::GetVpnGatewayId() const
{
    return m_vpnGatewayId;
}

void DeleteVpnGatewayRoutesRequest::SetVpnGatewayId(const string& _vpnGatewayId)
{
    m_vpnGatewayId = _vpnGatewayId;
    m_vpnGatewayIdHasBeenSet = true;
}

bool DeleteVpnGatewayRoutesRequest::VpnGatewayIdHasBeenSet() const
{
    return m_vpnGatewayIdHasBeenSet;
}

vector<string> DeleteVpnGatewayRoutesRequest::GetRouteIds() const
{
    return m_routeIds;
}

void DeleteVpnGatewayRoutesRequest::SetRouteIds(const vector<string>& _routeIds)
{
    m_routeIds = _routeIds;
    m_routeIdsHasBeenSet = true;
}

bool DeleteVpnGatewayRoutesRequest::RouteIdsHasBeenSet() const
{
