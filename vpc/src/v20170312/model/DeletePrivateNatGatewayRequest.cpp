...
string DeletePrivateNatGatewayRequest::ToJsonString() const
{
...
string DeletePrivateNatGatewayRequest::GetNatGatewayId() const
{
    return m_natGatewayId;
}

void DeletePrivateNatGatewayRequest::SetNatGatewayId(const string& _natGatewayId)
{
