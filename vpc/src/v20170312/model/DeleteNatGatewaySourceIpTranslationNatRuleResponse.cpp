...
CoreInternalOutcome DeleteNatGatewaySourceIpTranslationNatRuleResponse::Deserialize(const string &payload)
{
...
string DeleteNatGatewaySourceIpTranslationNatRuleResponse::ToJsonString() const
{
