...
string DeleteNetDetectRequest::ToJsonString() const
{
...
string DeleteNetDetectRequest::GetNetDetectId() const
{
    return m_netDetectId;
}

void DeleteNetDetectRequest::SetNetDetectId(const string& _netDetectId)
{
    m_netDetectId = _netDetectId;
    m_netDetectIdHasBeenSet = true;
}

bool DeleteNetDetectRequest::NetDetectIdHasBeenSet() const
{
