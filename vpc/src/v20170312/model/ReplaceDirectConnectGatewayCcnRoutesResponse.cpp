...
CoreInternalOutcome ReplaceDirectConnectGatewayCcnRoutesResponse::Deserialize(const string &payload)
{
...
string ReplaceDirectConnectGatewayCcnRoutesResponse::ToJsonString() const
{
