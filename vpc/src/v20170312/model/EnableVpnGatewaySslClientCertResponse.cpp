...
CoreInternalOutcome EnableVpnGatewaySslClientCertResponse::Deserialize(const string &payload)
{
...
string EnableVpnGatewaySslClientCertResponse::ToJsonString() const
{
...
uint64_t EnableVpnGatewaySslClientCertResponse::GetTaskId() const
{
    return m_taskId;
}

bool EnableVpnGatewaySslClientCertResponse::TaskIdHasBeenSet() const
{
