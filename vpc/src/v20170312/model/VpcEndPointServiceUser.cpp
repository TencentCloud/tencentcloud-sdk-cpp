...
CoreInternalOutcome VpcEndPointServiceUser::Deserialize(const Value &value)
{
    string requestId = "";
...
void VpcEndPointServiceUser::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
