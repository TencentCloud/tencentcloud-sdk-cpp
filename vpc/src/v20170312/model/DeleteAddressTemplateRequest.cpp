...
string DeleteAddressTemplateRequest::ToJsonString() const
{
...
string DeleteAddressTemplateRequest::GetAddressTemplateId() const
{
    return m_addressTemplateId;
}

void DeleteAddressTemplateRequest::SetAddressTemplateId(const string& _addressTemplateId)
{
    m_addressTemplateId = _addressTemplateId;
    m_addressTemplateIdHasBeenSet = true;
}

bool DeleteAddressTemplateRequest::AddressTemplateIdHasBeenSet() const
{
