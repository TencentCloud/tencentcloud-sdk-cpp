...
CoreInternalOutcome ModifyBandwidthPackageAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyBandwidthPackageAttributeResponse::ToJsonString() const
{
