...
string ReplaceDirectConnectGatewayCcnRoutesRequest::ToJsonString() const
{
...
string ReplaceDirectConnectGatewayCcnRoutesRequest::GetDirectConnectGatewayId() const
{
    return m_directConnectGatewayId;
}

void ReplaceDirectConnectGatewayCcnRoutesRequest::SetDirectConnectGatewayId(const string& _directConnectGatewayId)
{
    m_directConnectGatewayId = _directConnectGatewayId;
    m_directConnectGatewayIdHasBeenSet = true;
}

bool ReplaceDirectConnectGatewayCcnRoutesRequest::DirectConnectGatewayIdHasBeenSet() const
{
    return m_directConnectGatewayIdHasBeenSet;
}

vector<DirectConnectGatewayCcnRoute> ReplaceDirectConnectGatewayCcnRoutesRequest::GetRoutes() const
{
    return m_routes;
}

void ReplaceDirectConnectGatewayCcnRoutesRequest::SetRoutes(const vector<DirectConnectGatewayCcnRoute>& _routes)
{
    m_routes = _routes;
