...
uint64_t DescribeCcnAttachedInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCcnAttachedInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CcnAttachedInstance> DescribeCcnAttachedInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeCcnAttachedInstancesResponse::InstanceSetHasBeenSet() const
{
