...
CoreInternalOutcome AdjustPublicAddressResponse::Deserialize(const string &payload)
{
...
string AdjustPublicAddressResponse::ToJsonString() const
{
...
uint64_t AdjustPublicAddressResponse::GetTaskId() const
{
    return m_taskId;
}

bool AdjustPublicAddressResponse::TaskIdHasBeenSet() const
{
