...
CreateNetworkAclEntriesRequest::CreateNetworkAclEntriesRequest() :
    m_networkAclIdHasBeenSet(false),
    m_networkAclEntrySetHasBeenSet(false)
{
}

string CreateNetworkAclEntriesRequest::ToJsonString() const
{
...
string CreateNetworkAclEntriesRequest::GetNetworkAclId() const
{
    return m_networkAclId;
}

void CreateNetworkAclEntriesRequest::SetNetworkAclId(const string& _networkAclId)
{
    m_networkAclId = _networkAclId;
    m_networkAclIdHasBeenSet = true;
}

bool CreateNetworkAclEntriesRequest::NetworkAclIdHasBeenSet() const
{
    return m_networkAclIdHasBeenSet;
}

NetworkAclEntrySet CreateNetworkAclEntriesRequest::GetNetworkAclEntrySet() const
{
    return m_networkAclEntrySet;
}

void CreateNetworkAclEntriesRequest::SetNetworkAclEntrySet(const NetworkAclEntrySet& _networkAclEntrySet)
{
    m_networkAclEntrySet = _networkAclEntrySet;
    m_networkAclEntrySetHasBeenSet = true;
}

bool CreateNetworkAclEntriesRequest::NetworkAclEntrySetHasBeenSet() const
{
