...
string DeleteVpnGatewaySslServerRequest::ToJsonString() const
{
...
string DeleteVpnGatewaySslServerRequest::GetSslVpnServerId() const
{
    return m_sslVpnServerId;
}

void DeleteVpnGatewaySslServerRequest::SetSslVpnServerId(const string& _sslVpnServerId)
{
    m_sslVpnServerId = _sslVpnServerId;
    m_sslVpnServerIdHasBeenSet = true;
}

bool DeleteVpnGatewaySslServerRequest::SslVpnServerIdHasBeenSet() const
{
