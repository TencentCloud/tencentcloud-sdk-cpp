...
string ModifyPrivateNatGatewayAttributeRequest::ToJsonString() const
{
...
string ModifyPrivateNatGatewayAttributeRequest::GetNatGatewayId() const
{
    return m_natGatewayId;
}

void ModifyPrivateNatGatewayAttributeRequest::SetNatGatewayId(const string& _natGatewayId)
{
    m_natGatewayId = _natGatewayId;
    m_natGatewayIdHasBeenSet = true;
}

bool ModifyPrivateNatGatewayAttributeRequest::NatGatewayIdHasBeenSet() const
{
    return m_natGatewayIdHasBeenSet;
}

string ModifyPrivateNatGatewayAttributeRequest::GetNatGatewayName() const
{
    return m_natGatewayName;
}

void ModifyPrivateNatGatewayAttributeRequest::SetNatGatewayName(const string& _natGatewayName)
{
