...
CoreInternalOutcome InquiryPriceRenewAddressesResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRenewAddressesResponse::ToJsonString() const
{
...
InternetPrice InquiryPriceRenewAddressesResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRenewAddressesResponse::PriceHasBeenSet() const
{
