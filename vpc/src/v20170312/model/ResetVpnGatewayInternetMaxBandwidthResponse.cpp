...
CoreInternalOutcome ResetVpnGatewayInternetMaxBandwidthResponse::Deserialize(const string &payload)
{
...
string ResetVpnGatewayInternetMaxBandwidthResponse::ToJsonString() const
{
