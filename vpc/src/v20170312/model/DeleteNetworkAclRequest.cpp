...
string DeleteNetworkAclRequest::ToJsonString() const
{
...
string DeleteNetworkAclRequest::GetNetworkAclId() const
{
    return m_networkAclId;
}

void DeleteNetworkAclRequest::SetNetworkAclId(const string& _networkAclId)
{
    m_networkAclId = _networkAclId;
    m_networkAclIdHasBeenSet = true;
}

bool DeleteNetworkAclRequest::NetworkAclIdHasBeenSet() const
{
