...
CoreInternalOutcome ModifySecurityGroupAttributeResponse::Deserialize(const string &payload)
{
...
string ModifySecurityGroupAttributeResponse::ToJsonString() const
{
