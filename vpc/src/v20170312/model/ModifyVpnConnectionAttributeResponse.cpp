...
CoreInternalOutcome ModifyVpnConnectionAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyVpnConnectionAttributeResponse::ToJsonString() const
{
