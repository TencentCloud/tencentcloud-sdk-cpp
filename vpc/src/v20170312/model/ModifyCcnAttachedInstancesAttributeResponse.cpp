...
CoreInternalOutcome ModifyCcnAttachedInstancesAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyCcnAttachedInstancesAttributeResponse::ToJsonString() const
{
