...
string DeleteNetworkAclQuintupleEntriesRequest::ToJsonString() const
{
...
string DeleteNetworkAclQuintupleEntriesRequest::GetNetworkAclId() const
{
    return m_networkAclId;
}

void DeleteNetworkAclQuintupleEntriesRequest::SetNetworkAclId(const string& _networkAclId)
{
    m_networkAclId = _networkAclId;
    m_networkAclIdHasBeenSet = true;
}

bool DeleteNetworkAclQuintupleEntriesRequest::NetworkAclIdHasBeenSet() const
{
    return m_networkAclIdHasBeenSet;
}

NetworkAclQuintupleEntries DeleteNetworkAclQuintupleEntriesRequest::GetNetworkAclQuintupleSet() const
{
    return m_networkAclQuintupleSet;
}

void DeleteNetworkAclQuintupleEntriesRequest::SetNetworkAclQuintupleSet(const NetworkAclQuintupleEntries& _networkAclQuintupleSet)
{
    m_networkAclQuintupleSet = _networkAclQuintupleSet;
    m_networkAclQuintupleSetHasBeenSet = true;
}

bool DeleteNetworkAclQuintupleEntriesRequest::NetworkAclQuintupleSetHasBeenSet() const
{
