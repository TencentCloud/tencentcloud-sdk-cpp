...
CoreInternalOutcome ModifyCustomerGatewayAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyCustomerGatewayAttributeResponse::ToJsonString() const
{
