...
string CreateRoutePolicyAssociationsRequest::ToJsonString() const
{
...
vector<RoutePolicyAssociation> CreateRoutePolicyAssociationsRequest::GetRoutePolicyAssociationSet() const
{
    return m_routePolicyAssociationSet;
}

void CreateRoutePolicyAssociationsRequest::SetRoutePolicyAssociationSet(const vector<RoutePolicyAssociation>& _routePolicyAssociationSet)
{
    m_routePolicyAssociationSet = _routePolicyAssociationSet;
    m_routePolicyAssociationSetHasBeenSet = true;
}

bool CreateRoutePolicyAssociationsRequest::RoutePolicyAssociationSetHasBeenSet() const
{
