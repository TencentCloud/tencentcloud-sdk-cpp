...
CoreInternalOutcome CheckDefaultSubnetResponse::Deserialize(const string &payload)
{
...
string CheckDefaultSubnetResponse::ToJsonString() const
{
...
bool CheckDefaultSubnetResponse::GetResult() const
{
    return m_result;
}

bool CheckDefaultSubnetResponse::ResultHasBeenSet() const
{
