...
CoreInternalOutcome DescribeIp6TranslatorQuotaResponse::Deserialize(const string &payload)
{
...
string DescribeIp6TranslatorQuotaResponse::ToJsonString() const
{
...
vector<Quota> DescribeIp6TranslatorQuotaResponse::GetQuotaSet() const
{
    return m_quotaSet;
}

bool DescribeIp6TranslatorQuotaResponse::QuotaSetHasBeenSet() const
{
