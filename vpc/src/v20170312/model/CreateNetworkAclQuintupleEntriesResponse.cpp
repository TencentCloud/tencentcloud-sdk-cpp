...
CoreInternalOutcome CreateNetworkAclQuintupleEntriesResponse::Deserialize(const string &payload)
{
...
string CreateNetworkAclQuintupleEntriesResponse::ToJsonString() const
{
