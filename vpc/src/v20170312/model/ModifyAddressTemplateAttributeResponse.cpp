...
CoreInternalOutcome ModifyAddressTemplateAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyAddressTemplateAttributeResponse::ToJsonString() const
{
