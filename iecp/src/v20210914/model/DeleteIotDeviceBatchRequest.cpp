...
string DeleteIotDeviceBatchRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteIotDeviceBatchRequest::GetDeviceIDList() const
{
    return m_deviceIDList;
}

void DeleteIotDeviceBatchRequest::SetDeviceIDList(const vector<uint64_t>& _deviceIDList)
{
    m_deviceIDList = _deviceIDList;
    m_deviceIDListHasBeenSet = true;
}

bool DeleteIotDeviceBatchRequest::DeviceIDListHasBeenSet() const
{
