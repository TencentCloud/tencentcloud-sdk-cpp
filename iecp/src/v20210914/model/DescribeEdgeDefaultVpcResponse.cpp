...
CoreInternalOutcome DescribeEdgeDefaultVpcResponse::Deserialize(const string &payload)
{
...
string DescribeEdgeDefaultVpcResponse::ToJsonString() const
{
...
string DescribeEdgeDefaultVpcResponse::GetVpcId() const
{
    return m_vpcId;
}

bool DescribeEdgeDefaultVpcResponse::VpcIdHasBeenSet() const
{
    return m_vpcIdHasBeenSet;
}

string DescribeEdgeDefaultVpcResponse::GetVpcCidrBlock() const
{
    return m_vpcCidrBlock;
}

bool DescribeEdgeDefaultVpcResponse::VpcCidrBlockHasBeenSet() const
{
    return m_vpcCidrBlockHasBeenSet;
}

string DescribeEdgeDefaultVpcResponse::GetSubnetId() const
{
    return m_subnetId;
}

bool DescribeEdgeDefaultVpcResponse::SubnetIdHasBeenSet() const
{
    return m_subnetIdHasBeenSet;
}

string DescribeEdgeDefaultVpcResponse::GetSubnetCidrBlock() const
{
    return m_subnetCidrBlock;
}

bool DescribeEdgeDefaultVpcResponse::SubnetCidrBlockHasBeenSet() const
{
