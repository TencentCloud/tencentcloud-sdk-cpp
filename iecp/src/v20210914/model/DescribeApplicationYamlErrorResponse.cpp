...
CoreInternalOutcome DescribeApplicationYamlErrorResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationYamlErrorResponse::ToJsonString() const
{
...
bool DescribeApplicationYamlErrorResponse::GetCheckPass() const
{
    return m_checkPass;
}

bool DescribeApplicationYamlErrorResponse::CheckPassHasBeenSet() const
{
    return m_checkPassHasBeenSet;
}

int64_t DescribeApplicationYamlErrorResponse::GetErrType() const
{
    return m_errType;
}

bool DescribeApplicationYamlErrorResponse::ErrTypeHasBeenSet() const
{
    return m_errTypeHasBeenSet;
}

string DescribeApplicationYamlErrorResponse::GetErrInfo() const
{
    return m_errInfo;
}

bool DescribeApplicationYamlErrorResponse::ErrInfoHasBeenSet() const
{
