...
CoreInternalOutcome DescribeApplicationVisualizationResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationVisualizationResponse::ToJsonString() const
{
...
ApplicationBasicInfo DescribeApplicationVisualizationResponse::GetBasicInfo() const
{
    return m_basicInfo;
}

bool DescribeApplicationVisualizationResponse::BasicInfoHasBeenSet() const
{
    return m_basicInfoHasBeenSet;
}

ApplicationBasicConfig DescribeApplicationVisualizationResponse::GetBasicConfig() const
{
    return m_basicConfig;
}

bool DescribeApplicationVisualizationResponse::BasicConfigHasBeenSet() const
{
    return m_basicConfigHasBeenSet;
}

vector<Volume> DescribeApplicationVisualizationResponse::GetVolumes() const
{
    return m_volumes;
}

bool DescribeApplicationVisualizationResponse::VolumesHasBeenSet() const
{
    return m_volumesHasBeenSet;
}

vector<Container> DescribeApplicationVisualizationResponse::GetInitContainers() const
{
    return m_initContainers;
}

bool DescribeApplicationVisualizationResponse::InitContainersHasBeenSet() const
{
    return m_initContainersHasBeenSet;
}

vector<Container> DescribeApplicationVisualizationResponse::GetContainers() const
{
    return m_containers;
}

bool DescribeApplicationVisualizationResponse::ContainersHasBeenSet() const
{
    return m_containersHasBeenSet;
}

Service DescribeApplicationVisualizationResponse::GetService() const
{
    return m_service;
}

bool DescribeApplicationVisualizationResponse::ServiceHasBeenSet() const
{
    return m_serviceHasBeenSet;
}

Job DescribeApplicationVisualizationResponse::GetJob() const
{
    return m_job;
}

bool DescribeApplicationVisualizationResponse::JobHasBeenSet() const
{
    return m_jobHasBeenSet;
}

CronJob DescribeApplicationVisualizationResponse::GetCronJob() const
{
    return m_cronJob;
}

bool DescribeApplicationVisualizationResponse::CronJobHasBeenSet() const
{
    return m_cronJobHasBeenSet;
}

string DescribeApplicationVisualizationResponse::GetRestartPolicy() const
{
    return m_restartPolicy;
}

bool DescribeApplicationVisualizationResponse::RestartPolicyHasBeenSet() const
{
    return m_restartPolicyHasBeenSet;
}

HorizontalPodAutoscaler DescribeApplicationVisualizationResponse::GetHorizontalPodAutoscaler() const
{
    return m_horizontalPodAutoscaler;
}

bool DescribeApplicationVisualizationResponse::HorizontalPodAutoscalerHasBeenSet() const
{
    return m_horizontalPodAutoscalerHasBeenSet;
}

vector<string> DescribeApplicationVisualizationResponse::GetImagePullSecrets() const
{
    return m_imagePullSecrets;
}

bool DescribeApplicationVisualizationResponse::ImagePullSecretsHasBeenSet() const
{
