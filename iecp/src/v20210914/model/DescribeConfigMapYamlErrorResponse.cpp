...
CoreInternalOutcome DescribeConfigMapYamlErrorResponse::Deserialize(const string &payload)
{
...
string DescribeConfigMapYamlErrorResponse::ToJsonString() const
{
...
bool DescribeConfigMapYamlErrorResponse::GetCheckPass() const
{
    return m_checkPass;
}

bool DescribeConfigMapYamlErrorResponse::CheckPassHasBeenSet() const
{
    return m_checkPassHasBeenSet;
}

uint64_t DescribeConfigMapYamlErrorResponse::GetErrType() const
{
    return m_errType;
}

bool DescribeConfigMapYamlErrorResponse::ErrTypeHasBeenSet() const
{
    return m_errTypeHasBeenSet;
}

string DescribeConfigMapYamlErrorResponse::GetErrInfo() const
{
    return m_errInfo;
}

bool DescribeConfigMapYamlErrorResponse::ErrInfoHasBeenSet() const
{
