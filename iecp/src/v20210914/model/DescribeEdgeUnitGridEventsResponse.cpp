...
CoreInternalOutcome DescribeEdgeUnitGridEventsResponse::Deserialize(const string &payload)
{
...
string DescribeEdgeUnitGridEventsResponse::ToJsonString() const
{
...
vector<GridEventInfo> DescribeEdgeUnitGridEventsResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeEdgeUnitGridEventsResponse::EventSetHasBeenSet() const
{
