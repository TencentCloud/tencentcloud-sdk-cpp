...
CoreInternalOutcome DescribeEdgeUnitApplicationLogsResponse::Deserialize(const string &payload)
{
...
string DescribeEdgeUnitApplicationLogsResponse::ToJsonString() const
{
...
vector<string> DescribeEdgeUnitApplicationLogsResponse::GetLogSet() const
{
    return m_logSet;
}

bool DescribeEdgeUnitApplicationLogsResponse::LogSetHasBeenSet() const
{
