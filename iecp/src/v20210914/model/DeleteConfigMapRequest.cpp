...
string DeleteConfigMapRequest::ToJsonString() const
{
...
uint64_t DeleteConfigMapRequest::GetEdgeUnitID() const
{
    return m_edgeUnitID;
}

void DeleteConfigMapRequest::SetEdgeUnitID(const uint64_t& _edgeUnitID)
{
    m_edgeUnitID = _edgeUnitID;
    m_edgeUnitIDHasBeenSet = true;
}

bool DeleteConfigMapRequest::EdgeUnitIDHasBeenSet() const
{
    return m_edgeUnitIDHasBeenSet;
}

string DeleteConfigMapRequest::GetConfigMapName() const
{
    return m_configMapName;
}

void DeleteConfigMapRequest::SetConfigMapName(const string& _configMapName)
{
    m_configMapName = _configMapName;
    m_configMapNameHasBeenSet = true;
}

bool DeleteConfigMapRequest::ConfigMapNameHasBeenSet() const
{
    return m_configMapNameHasBeenSet;
}

string DeleteConfigMapRequest::GetConfigMapNamespace() const
{
    return m_configMapNamespace;
}

void DeleteConfigMapRequest::SetConfigMapNamespace(const string& _configMapNamespace)
{
    m_configMapNamespace = _configMapNamespace;
    m_configMapNamespaceHasBeenSet = true;
}

bool DeleteConfigMapRequest::ConfigMapNamespaceHasBeenSet() const
{
