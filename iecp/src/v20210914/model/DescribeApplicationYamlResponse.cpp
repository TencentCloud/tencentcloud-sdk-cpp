...
CoreInternalOutcome DescribeApplicationYamlResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationYamlResponse::ToJsonString() const
{
...
string DescribeApplicationYamlResponse::GetYaml() const
{
    return m_yaml;
}

bool DescribeApplicationYamlResponse::YamlHasBeenSet() const
{
