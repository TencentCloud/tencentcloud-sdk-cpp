...
CoreInternalOutcome DescribeEdgeUnitApplicationYamlResponse::Deserialize(const string &payload)
{
...
string DescribeEdgeUnitApplicationYamlResponse::ToJsonString() const
{
...
string DescribeEdgeUnitApplicationYamlResponse::GetYaml() const
{
    return m_yaml;
}

bool DescribeEdgeUnitApplicationYamlResponse::YamlHasBeenSet() const
{
