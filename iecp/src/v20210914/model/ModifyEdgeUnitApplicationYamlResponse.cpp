...
CoreInternalOutcome ModifyEdgeUnitApplicationYamlResponse::Deserialize(const string &payload)
{
...
string ModifyEdgeUnitApplicationYamlResponse::ToJsonString() const
{
