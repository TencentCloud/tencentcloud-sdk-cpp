...
CoreInternalOutcome ModifyEdgeUnitApplicationBasicInfoResponse::Deserialize(const string &payload)
{
...
string ModifyEdgeUnitApplicationBasicInfoResponse::ToJsonString() const
{
