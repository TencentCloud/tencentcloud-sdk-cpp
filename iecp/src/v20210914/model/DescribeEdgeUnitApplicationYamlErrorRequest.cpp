...
string DescribeEdgeUnitApplicationYamlErrorRequest::ToJsonString() const
{
...
string DescribeEdgeUnitApplicationYamlErrorRequest::GetYaml() const
{
    return m_yaml;
}

void DescribeEdgeUnitApplicationYamlErrorRequest::SetYaml(const string& _yaml)
{
    m_yaml = _yaml;
    m_yamlHasBeenSet = true;
}

bool DescribeEdgeUnitApplicationYamlErrorRequest::YamlHasBeenSet() const
{
