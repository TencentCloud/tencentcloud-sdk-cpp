...
string DeleteEdgeUnitCloudRequest::ToJsonString() const
{
...
uint64_t DeleteEdgeUnitCloudRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DeleteEdgeUnitCloudRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DeleteEdgeUnitCloudRequest::EdgeUnitIdHasBeenSet() const
{
