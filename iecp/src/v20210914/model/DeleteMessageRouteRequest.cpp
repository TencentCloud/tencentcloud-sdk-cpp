...
string DeleteMessageRouteRequest::ToJsonString() const
{
...
int64_t DeleteMessageRouteRequest::GetRouteID() const
{
    return m_routeID;
}

void DeleteMessageRouteRequest::SetRouteID(const int64_t& _routeID)
{
    m_routeID = _routeID;
    m_routeIDHasBeenSet = true;
}

bool DeleteMessageRouteRequest::RouteIDHasBeenSet() const
{
