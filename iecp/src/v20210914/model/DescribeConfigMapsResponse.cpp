...
CoreInternalOutcome DescribeConfigMapsResponse::Deserialize(const string &payload)
{
...
string DescribeConfigMapsResponse::ToJsonString() const
{
...
vector<ConfigMapBasicInfo> DescribeConfigMapsResponse::GetItems() const
{
    return m_items;
}

bool DescribeConfigMapsResponse::ItemsHasBeenSet() const
{
