...
uint64_t CreateNamespaceRequest::GetEdgeUnitID() const
{
    return m_edgeUnitID;
}

void CreateNamespaceRequest::SetEdgeUnitID(const uint64_t& _edgeUnitID)
{
    m_edgeUnitID = _edgeUnitID;
    m_edgeUnitIDHasBeenSet = true;
}

bool CreateNamespaceRequest::EdgeUnitIDHasBeenSet() const
{
