...
string DeleteNodeUnitRequest::ToJsonString() const
{
...
uint64_t DeleteNodeUnitRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DeleteNodeUnitRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DeleteNodeUnitRequest::EdgeUnitIdHasBeenSet() const
{
    return m_edgeUnitIdHasBeenSet;
}

string DeleteNodeUnitRequest::GetNodeGroupName() const
{
    return m_nodeGroupName;
}

void DeleteNodeUnitRequest::SetNodeGroupName(const string& _nodeGroupName)
{
    m_nodeGroupName = _nodeGroupName;
    m_nodeGroupNameHasBeenSet = true;
}

bool DeleteNodeUnitRequest::NodeGroupNameHasBeenSet() const
{
    return m_nodeGroupNameHasBeenSet;
}

string DeleteNodeUnitRequest::GetNodeUnitName() const
{
    return m_nodeUnitName;
}

void DeleteNodeUnitRequest::SetNodeUnitName(const string& _nodeUnitName)
{
    m_nodeUnitName = _nodeUnitName;
    m_nodeUnitNameHasBeenSet = true;
}

bool DeleteNodeUnitRequest::NodeUnitNameHasBeenSet() const
{
    return m_nodeUnitNameHasBeenSet;
}

string DeleteNodeUnitRequest::GetNamespace() const
{
    return m_namespace;
}

void DeleteNodeUnitRequest::SetNamespace(const string& _namespace)
{
    m_namespace = _namespace;
    m_namespaceHasBeenSet = true;
}

bool DeleteNodeUnitRequest::NamespaceHasBeenSet() const
{
    return m_namespaceHasBeenSet;
}

vector<string> DeleteNodeUnitRequest::GetNodes() const
{
    return m_nodes;
}

void DeleteNodeUnitRequest::SetNodes(const vector<string>& _nodes)
{
    m_nodes = _nodes;
    m_nodesHasBeenSet = true;
}

bool DeleteNodeUnitRequest::NodesHasBeenSet() const
{
