...
CoreInternalOutcome DescribeIotDevicesResponse::Deserialize(const string &payload)
{
...
string DescribeIotDevicesResponse::ToJsonString() const
{
...
int64_t DescribeIotDevicesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeIotDevicesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<IotDevicesInfo> DescribeIotDevicesResponse::GetDeviceSet() const
{
    return m_deviceSet;
}

bool DescribeIotDevicesResponse::DeviceSetHasBeenSet() const
{
