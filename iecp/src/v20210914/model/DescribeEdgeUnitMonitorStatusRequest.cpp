...
string DescribeEdgeUnitMonitorStatusRequest::ToJsonString() const
{
...
uint64_t DescribeEdgeUnitMonitorStatusRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DescribeEdgeUnitMonitorStatusRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DescribeEdgeUnitMonitorStatusRequest::EdgeUnitIdHasBeenSet() const
{
