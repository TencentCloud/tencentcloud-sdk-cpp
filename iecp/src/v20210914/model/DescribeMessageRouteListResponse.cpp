...
CoreInternalOutcome DescribeMessageRouteListResponse::Deserialize(const string &payload)
{
...
string DescribeMessageRouteListResponse::ToJsonString() const
{
...
vector<RouteInfo> DescribeMessageRouteListResponse::GetRouteList() const
{
    return m_routeList;
}

bool DescribeMessageRouteListResponse::RouteListHasBeenSet() const
{
    return m_routeListHasBeenSet;
}

int64_t DescribeMessageRouteListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMessageRouteListResponse::TotalCountHasBeenSet() const
{
