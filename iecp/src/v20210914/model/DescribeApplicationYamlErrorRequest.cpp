...
string DescribeApplicationYamlErrorRequest::ToJsonString() const
{
...
string DescribeApplicationYamlErrorRequest::GetYaml() const
{
    return m_yaml;
}

void DescribeApplicationYamlErrorRequest::SetYaml(const string& _yaml)
{
    m_yaml = _yaml;
    m_yamlHasBeenSet = true;
}

bool DescribeApplicationYamlErrorRequest::YamlHasBeenSet() const
{
