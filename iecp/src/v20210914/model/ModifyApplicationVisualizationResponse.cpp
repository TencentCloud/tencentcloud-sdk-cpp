...
CoreInternalOutcome ModifyApplicationVisualizationResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationVisualizationResponse::ToJsonString() const
{
