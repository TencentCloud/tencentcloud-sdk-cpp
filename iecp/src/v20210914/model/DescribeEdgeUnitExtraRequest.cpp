...
string DescribeEdgeUnitExtraRequest::ToJsonString() const
{
...
uint64_t DescribeEdgeUnitExtraRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DescribeEdgeUnitExtraRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DescribeEdgeUnitExtraRequest::EdgeUnitIdHasBeenSet() const
{
