...
string DescribeEdgeUnitCloudRequest::ToJsonString() const
{
...
uint64_t DescribeEdgeUnitCloudRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DescribeEdgeUnitCloudRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DescribeEdgeUnitCloudRequest::EdgeUnitIdHasBeenSet() const
{
