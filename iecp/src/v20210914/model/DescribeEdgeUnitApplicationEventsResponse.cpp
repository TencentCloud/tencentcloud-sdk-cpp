...
CoreInternalOutcome DescribeEdgeUnitApplicationEventsResponse::Deserialize(const string &payload)
{
...
string DescribeEdgeUnitApplicationEventsResponse::ToJsonString() const
{
...
vector<Event> DescribeEdgeUnitApplicationEventsResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeEdgeUnitApplicationEventsResponse::EventSetHasBeenSet() const
{
