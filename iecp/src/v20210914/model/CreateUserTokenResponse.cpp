...
CoreInternalOutcome CreateUserTokenResponse::Deserialize(const string &payload)
{
...
string CreateUserTokenResponse::ToJsonString() const
{
...
string CreateUserTokenResponse::GetToken() const
{
    return m_token;
}

bool CreateUserTokenResponse::TokenHasBeenSet() const
{
