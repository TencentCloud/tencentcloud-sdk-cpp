...
string DescribeConfigMapYamlErrorRequest::ToJsonString() const
{
...
string DescribeConfigMapYamlErrorRequest::GetYaml() const
{
    return m_yaml;
}

void DescribeConfigMapYamlErrorRequest::SetYaml(const string& _yaml)
{
    m_yaml = _yaml;
    m_yamlHasBeenSet = true;
}

bool DescribeConfigMapYamlErrorRequest::YamlHasBeenSet() const
{
