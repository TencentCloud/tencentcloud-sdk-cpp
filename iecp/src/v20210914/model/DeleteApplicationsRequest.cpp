...
string DeleteApplicationsRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteApplicationsRequest::GetApplicationIds() const
{
    return m_applicationIds;
}

void DeleteApplicationsRequest::SetApplicationIds(const vector<uint64_t>& _applicationIds)
{
    m_applicationIds = _applicationIds;
    m_applicationIdsHasBeenSet = true;
}

bool DeleteApplicationsRequest::ApplicationIdsHasBeenSet() const
{
