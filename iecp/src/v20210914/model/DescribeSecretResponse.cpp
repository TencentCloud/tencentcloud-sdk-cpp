...
string DescribeSecretResponse::GetName() const
{
    return m_name;
}

bool DescribeSecretResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string DescribeSecretResponse::GetNamespace() const
{
    return m_namespace;
}

bool DescribeSecretResponse::NamespaceHasBeenSet() const
{
    return m_namespaceHasBeenSet;
}

string DescribeSecretResponse::GetCreateTime() const
{
    return m_createTime;
}
...
string DescribeSecretResponse::GetYaml() const
{
    return m_yaml;
}

bool DescribeSecretResponse::YamlHasBeenSet() const
{
    return m_yamlHasBeenSet;
}

string DescribeSecretResponse::GetJson() const
{
    return m_json;
}

bool DescribeSecretResponse::JsonHasBeenSet() const
{
