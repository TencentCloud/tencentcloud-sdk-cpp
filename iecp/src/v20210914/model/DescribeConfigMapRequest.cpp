...
string DescribeConfigMapRequest::ToJsonString() const
{
...
uint64_t DescribeConfigMapRequest::GetEdgeUnitID() const
{
    return m_edgeUnitID;
}

void DescribeConfigMapRequest::SetEdgeUnitID(const uint64_t& _edgeUnitID)
{
    m_edgeUnitID = _edgeUnitID;
    m_edgeUnitIDHasBeenSet = true;
}

bool DescribeConfigMapRequest::EdgeUnitIDHasBeenSet() const
{
    return m_edgeUnitIDHasBeenSet;
}

string DescribeConfigMapRequest::GetConfigMapName() const
{
    return m_configMapName;
}

void DescribeConfigMapRequest::SetConfigMapName(const string& _configMapName)
{
    m_configMapName = _configMapName;
    m_configMapNameHasBeenSet = true;
}

bool DescribeConfigMapRequest::ConfigMapNameHasBeenSet() const
{
    return m_configMapNameHasBeenSet;
}

string DescribeConfigMapRequest::GetConfigMapNamespace() const
{
    return m_configMapNamespace;
}

void DescribeConfigMapRequest::SetConfigMapNamespace(const string& _configMapNamespace)
{
    m_configMapNamespace = _configMapNamespace;
    m_configMapNamespaceHasBeenSet = true;
}

bool DescribeConfigMapRequest::ConfigMapNamespaceHasBeenSet() const
{
