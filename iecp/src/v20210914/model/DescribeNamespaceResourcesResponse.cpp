...
CoreInternalOutcome DescribeNamespaceResourcesResponse::Deserialize(const string &payload)
{
...
string DescribeNamespaceResourcesResponse::ToJsonString() const
{
...
vector<NamespaceResource> DescribeNamespaceResourcesResponse::GetResources() const
{
    return m_resources;
}

bool DescribeNamespaceResourcesResponse::ResourcesHasBeenSet() const
{
