...
CoreInternalOutcome DescribeEdgeUnitApplicationYamlErrorResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["ErrType"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `ErrType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_errType = rsp["ErrType"].GetInt64();
...
string DescribeEdgeUnitApplicationYamlErrorResponse::ToJsonString() const
{
...
bool DescribeEdgeUnitApplicationYamlErrorResponse::GetCheckPass() const
{
    return m_checkPass;
}

bool DescribeEdgeUnitApplicationYamlErrorResponse::CheckPassHasBeenSet() const
{
    return m_checkPassHasBeenSet;
}

int64_t DescribeEdgeUnitApplicationYamlErrorResponse::GetErrType() const
{
    return m_errType;
}

bool DescribeEdgeUnitApplicationYamlErrorResponse::ErrTypeHasBeenSet() const
{
    return m_errTypeHasBeenSet;
}

string DescribeEdgeUnitApplicationYamlErrorResponse::GetErrInfo() const
{
    return m_errInfo;
}

bool DescribeEdgeUnitApplicationYamlErrorResponse::ErrInfoHasBeenSet() const
{
