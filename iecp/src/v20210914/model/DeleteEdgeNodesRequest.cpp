...
string DeleteEdgeNodesRequest::ToJsonString() const
{
...
uint64_t DeleteEdgeNodesRequest::GetEdgeUnitId() const
{
    return m_edgeUnitId;
}

void DeleteEdgeNodesRequest::SetEdgeUnitId(const uint64_t& _edgeUnitId)
{
    m_edgeUnitId = _edgeUnitId;
    m_edgeUnitIdHasBeenSet = true;
}

bool DeleteEdgeNodesRequest::EdgeUnitIdHasBeenSet() const
{
    return m_edgeUnitIdHasBeenSet;
}

vector<uint64_t> DeleteEdgeNodesRequest::GetNodeIds() const
{
    return m_nodeIds;
}

void DeleteEdgeNodesRequest::SetNodeIds(const vector<uint64_t>& _nodeIds)
{
    m_nodeIds = _nodeIds;
    m_nodeIdsHasBeenSet = true;
}

bool DeleteEdgeNodesRequest::NodeIdsHasBeenSet() const
{
