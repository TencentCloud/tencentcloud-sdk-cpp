...
string DeleteEdgeUnitApplicationsRequest::ToJsonString() const
{
...
uint64_t DeleteEdgeUnitApplicationsRequest::GetEdgeUnitID() const
{
    return m_edgeUnitID;
}

void DeleteEdgeUnitApplicationsRequest::SetEdgeUnitID(const uint64_t& _edgeUnitID)
{
    m_edgeUnitID = _edgeUnitID;
    m_edgeUnitIDHasBeenSet = true;
}

bool DeleteEdgeUnitApplicationsRequest::EdgeUnitIDHasBeenSet() const
{
    return m_edgeUnitIDHasBeenSet;
}

vector<uint64_t> DeleteEdgeUnitApplicationsRequest::GetApplicationIDs() const
{
    return m_applicationIDs;
}

void DeleteEdgeUnitApplicationsRequest::SetApplicationIDs(const vector<uint64_t>& _applicationIDs)
{
    m_applicationIDs = _applicationIDs;
    m_applicationIDsHasBeenSet = true;
}

bool DeleteEdgeUnitApplicationsRequest::ApplicationIDsHasBeenSet() const
{
