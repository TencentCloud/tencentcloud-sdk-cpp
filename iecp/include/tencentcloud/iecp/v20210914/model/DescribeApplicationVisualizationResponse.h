...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONVISUALIZATIONRESPONSE_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONVISUALIZATIONRESPONSE_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DescribeApplicationVisualizationResponse : public AbstractModel
                {
                public:
                    DescribeApplicationVisualizationResponse();
                    ~DescribeApplicationVisualizationResponse() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONVISUALIZATIONRESPONSE_H_
