...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBECONFIGMAPYAMLERRORRESPONSE_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBECONFIGMAPYAMLERRORRESPONSE_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DescribeConfigMapYamlErrorResponse : public AbstractModel
                {
                public:
                    DescribeConfigMapYamlErrorResponse();
                    ~DescribeConfigMapYamlErrorResponse() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBECONFIGMAPYAMLERRORRESPONSE_H_
