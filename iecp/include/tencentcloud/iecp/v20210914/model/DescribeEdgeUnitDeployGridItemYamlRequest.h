...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITDEPLOYGRIDITEMYAMLREQUEST_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITDEPLOYGRIDITEMYAMLREQUEST_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DescribeEdgeUnitDeployGridItemYamlRequest : public AbstractModel
                {
                public:
                    DescribeEdgeUnitDeployGridItemYamlRequest();
                    ~DescribeEdgeUnitDeployGridItemYamlRequest() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITDEPLOYGRIDITEMYAMLREQUEST_H_
