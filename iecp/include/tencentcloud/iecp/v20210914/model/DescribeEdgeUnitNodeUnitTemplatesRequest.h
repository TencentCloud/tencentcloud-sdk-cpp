...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITNODEUNITTEMPLATESREQUEST_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITNODEUNITTEMPLATESREQUEST_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DescribeEdgeUnitNodeUnitTemplatesRequest : public AbstractModel
                {
                public:
                    DescribeEdgeUnitNodeUnitTemplatesRequest();
                    ~DescribeEdgeUnitNodeUnitTemplatesRequest() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEEDGEUNITNODEUNITTEMPLATESREQUEST_H_
