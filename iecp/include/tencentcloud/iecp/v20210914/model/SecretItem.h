...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_SECRETITEM_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_SECRETITEM_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                * Secret信息
                */
                class SecretItem : public AbstractModel
                {
                public:
                    SecretItem();
                    ~SecretItem() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_SECRETITEM_H_
