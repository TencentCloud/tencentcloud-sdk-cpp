...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_NODEGROUPNODEUNITTEMPLATEINFO_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_NODEGROUPNODEUNITTEMPLATEINFO_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class NodeGroupNodeUnitTemplateInfo : public AbstractModel
                {
                public:
                    NodeGroupNodeUnitTemplateInfo();
                    ~NodeGroupNodeUnitTemplateInfo() = default;
                     ...
                     * 
                     */
                    void SetRelation(const bool& _relation);
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_NODEGROUPNODEUNITTEMPLATEINFO_H_
