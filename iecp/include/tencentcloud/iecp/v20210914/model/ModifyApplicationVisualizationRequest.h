...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_MODIFYAPPLICATIONVISUALIZATIONREQUEST_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_MODIFYAPPLICATIONVISUALIZATIONREQUEST_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class ModifyApplicationVisualizationRequest : public AbstractModel
                {
                public:
                    ModifyApplicationVisualizationRequest();
                    ~ModifyApplicationVisualizationRequest() = default;
                ...
                private:
                     ...
                     * 单个初始化容器
                     */
                    Container m_initContainer;
                    bool m_initContainerHasBeenSet;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_MODIFYAPPLICATIONVISUALIZATIONREQUEST_H_
