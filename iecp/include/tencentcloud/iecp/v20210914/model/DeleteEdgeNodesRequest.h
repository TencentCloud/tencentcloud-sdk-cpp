...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DELETEEDGENODESREQUEST_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DELETEEDGENODESREQUEST_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DeleteEdgeNodesRequest : public AbstractModel
                {
                public:
                    DeleteEdgeNodesRequest();
                    ~DeleteEdgeNodesRequest() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DELETEEDGENODESREQUEST_H_
