...
#ifndef TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONYAMLERRORRESPONSE_H_
#define TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONYAMLERRORRESPONSE_H_
    ...
    namespace Iecp
    {
        namespace V20210914
        {
            namespace Model
            {
                ...
                */
                class DescribeApplicationYamlErrorResponse : public AbstractModel
                {
                public:
                    DescribeApplicationYamlErrorResponse();
                    ~DescribeApplicationYamlErrorResponse() = default;
...
#endif // !TENCENTCLOUD_IECP_V20210914_MODEL_DESCRIBEAPPLICATIONYAMLERRORRESPONSE_H_
