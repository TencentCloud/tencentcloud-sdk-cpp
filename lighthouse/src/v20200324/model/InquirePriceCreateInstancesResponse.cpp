...
CoreInternalOutcome InquirePriceCreateInstancesResponse::Deserialize(const string &payload)
{
...
string InquirePriceCreateInstancesResponse::ToJsonString() const
{
...
Price InquirePriceCreateInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceCreateInstancesResponse::PriceHasBeenSet() const
{
