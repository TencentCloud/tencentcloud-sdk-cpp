...
string DeleteKeyPairsRequest::ToJsonString() const
{
...
vector<string> DeleteKeyPairsRequest::GetKeyIds() const
{
    return m_keyIds;
}

void DeleteKeyPairsRequest::SetKeyIds(const vector<string>& _keyIds)
{
    m_keyIds = _keyIds;
    m_keyIdsHasBeenSet = true;
}

bool DeleteKeyPairsRequest::KeyIdsHasBeenSet() const
{
