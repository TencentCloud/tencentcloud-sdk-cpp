...
CoreInternalOutcome DescribeBundlesResponse::Deserialize(const string &payload)
{
...
string DescribeBundlesResponse::ToJsonString() const
{
...
vector<Bundle> DescribeBundlesResponse::GetBundleSet() const
{
    return m_bundleSet;
}

bool DescribeBundlesResponse::BundleSetHasBeenSet() const
{
    return m_bundleSetHasBeenSet;
}

int64_t DescribeBundlesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBundlesResponse::TotalCountHasBeenSet() const
{
