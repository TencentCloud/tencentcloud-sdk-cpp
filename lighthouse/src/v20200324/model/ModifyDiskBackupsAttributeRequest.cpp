...
string ModifyDiskBackupsAttributeRequest::ToJsonString() const
{
...
vector<string> ModifyDiskBackupsAttributeRequest::GetDiskBackupIds() const
{
    return m_diskBackupIds;
}

void ModifyDiskBackupsAttributeRequest::SetDiskBackupIds(const vector<string>& _diskBackupIds)
{
    m_diskBackupIds = _diskBackupIds;
    m_diskBackupIdsHasBeenSet = true;
}

bool ModifyDiskBackupsAttributeRequest::DiskBackupIdsHasBeenSet() const
{
    return m_diskBackupIdsHasBeenSet;
}

string ModifyDiskBackupsAttributeRequest::GetDiskBackupName() const
{
    return m_diskBackupName;
}

void ModifyDiskBackupsAttributeRequest::SetDiskBackupName(const string& _diskBackupName)
{
    m_diskBackupName = _diskBackupName;
    m_diskBackupNameHasBeenSet = true;
}

bool ModifyDiskBackupsAttributeRequest::DiskBackupNameHasBeenSet() const
{
