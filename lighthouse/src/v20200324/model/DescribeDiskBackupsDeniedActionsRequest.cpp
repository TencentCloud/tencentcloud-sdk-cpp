...
string DescribeDiskBackupsDeniedActionsRequest::ToJsonString() const
{
...
vector<string> DescribeDiskBackupsDeniedActionsRequest::GetDiskBackupIds() const
{
    return m_diskBackupIds;
}

void DescribeDiskBackupsDeniedActionsRequest::SetDiskBackupIds(const vector<string>& _diskBackupIds)
{
    m_diskBackupIds = _diskBackupIds;
    m_diskBackupIdsHasBeenSet = true;
}

bool DescribeDiskBackupsDeniedActionsRequest::DiskBackupIdsHasBeenSet() const
{
