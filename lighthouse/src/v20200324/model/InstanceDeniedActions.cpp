...
CoreInternalOutcome InstanceDeniedActions::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceDeniedActions::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
