...
string DeleteBlueprintsRequest::ToJsonString() const
{
...
vector<string> DeleteBlueprintsRequest::GetBlueprintIds() const
{
    return m_blueprintIds;
}

void DeleteBlueprintsRequest::SetBlueprintIds(const vector<string>& _blueprintIds)
{
    m_blueprintIds = _blueprintIds;
    m_blueprintIdsHasBeenSet = true;
}

bool DeleteBlueprintsRequest::BlueprintIdsHasBeenSet() const
{
