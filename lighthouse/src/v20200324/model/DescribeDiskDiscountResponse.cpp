...
CoreInternalOutcome DescribeDiskDiscountResponse::Deserialize(const string &payload)
{
...
string DescribeDiskDiscountResponse::ToJsonString() const
{
...
string DescribeDiskDiscountResponse::GetCurrency() const
{
    return m_currency;
}

bool DescribeDiskDiscountResponse::CurrencyHasBeenSet() const
{
    return m_currencyHasBeenSet;
}

vector<DiscountDetail> DescribeDiskDiscountResponse::GetDiscountDetail() const
{
    return m_discountDetail;
}

bool DescribeDiskDiscountResponse::DiscountDetailHasBeenSet() const
{
