...
vector<string> DescribeMcpServersRequest::GetMcpServerIds() const
{
    return m_mcpServerIds;
}

void DescribeMcpServersRequest::SetMcpServerIds(const vector<string>& _mcpServerIds)
{
    m_mcpServerIds = _mcpServerIds;
    m_mcpServerIdsHasBeenSet = true;
}

bool DescribeMcpServersRequest::McpServerIdsHasBeenSet() const
{
