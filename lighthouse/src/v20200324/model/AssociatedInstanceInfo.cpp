...
CoreInternalOutcome AssociatedInstanceInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Username") && !value["Username"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AssociatedInstanceInfo.Username` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AssociatedInstanceInfo::GetUsername() const
{
    return m_username;
}

void AssociatedInstanceInfo::SetUsername(const string& _username)
{
    m_username = _username;
    m_usernameHasBeenSet = true;
}

bool AssociatedInstanceInfo::UsernameHasBeenSet() const
{
