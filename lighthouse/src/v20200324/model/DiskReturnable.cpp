...
CoreInternalOutcome DiskReturnable::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("DiskId") && !value["DiskId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DiskReturnable.DiskId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("IsReturnable") && !value["IsReturnable"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DiskReturnable.IsReturnable` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ReturnFailCode") && !value["ReturnFailCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DiskReturnable.ReturnFailCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ReturnFailMessage") && !value["ReturnFailMessage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DiskReturnable.ReturnFailMessage` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void DiskReturnable::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string DiskReturnable::GetDiskId() const
{
    return m_diskId;
}

void DiskReturnable::SetDiskId(const string& _diskId)
{
    m_diskId = _diskId;
    m_diskIdHasBeenSet = true;
}

bool DiskReturnable::DiskIdHasBeenSet() const
{
    return m_diskIdHasBeenSet;
}

bool DiskReturnable::GetIsReturnable() const
{
    return m_isReturnable;
}

void DiskReturnable::SetIsReturnable(const bool& _isReturnable)
{
    m_isReturnable = _isReturnable;
    m_isReturnableHasBeenSet = true;
}

bool DiskReturnable::IsReturnableHasBeenSet() const
{
    return m_isReturnableHasBeenSet;
}

int64_t DiskReturnable::GetReturnFailCode() const
{
    return m_returnFailCode;
}

void DiskReturnable::SetReturnFailCode(const int64_t& _returnFailCode)
{
    m_returnFailCode = _returnFailCode;
    m_returnFailCodeHasBeenSet = true;
}

bool DiskReturnable::ReturnFailCodeHasBeenSet() const
{
    return m_returnFailCodeHasBeenSet;
}

string DiskReturnable::GetReturnFailMessage() const
{
    return m_returnFailMessage;
}

void DiskReturnable::SetReturnFailMessage(const string& _returnFailMessage)
{
    m_returnFailMessage = _returnFailMessage;
    m_returnFailMessageHasBeenSet = true;
}

bool DiskReturnable::ReturnFailMessageHasBeenSet() const
{
