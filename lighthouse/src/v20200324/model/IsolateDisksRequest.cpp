...
string IsolateDisksRequest::ToJsonString() const
{
...
vector<string> IsolateDisksRequest::GetDiskIds() const
{
    return m_diskIds;
}

void IsolateDisksRequest::SetDiskIds(const vector<string>& _diskIds)
{
    m_diskIds = _diskIds;
    m_diskIdsHasBeenSet = true;
}

bool IsolateDisksRequest::DiskIdsHasBeenSet() const
{
