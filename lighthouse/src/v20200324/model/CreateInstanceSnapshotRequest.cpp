...
string CreateInstanceSnapshotRequest::ToJsonString() const
{
...
string CreateInstanceSnapshotRequest::GetInstanceId() const
{
    return m_instanceId;
}

void CreateInstanceSnapshotRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool CreateInstanceSnapshotRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateInstanceSnapshotRequest::GetSnapshotName() const
{
    return m_snapshotName;
}

void CreateInstanceSnapshotRequest::SetSnapshotName(const string& _snapshotName)
{
