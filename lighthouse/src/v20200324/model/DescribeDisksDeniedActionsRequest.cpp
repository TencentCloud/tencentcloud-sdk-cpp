...
string DescribeDisksDeniedActionsRequest::ToJsonString() const
{
...
vector<string> DescribeDisksDeniedActionsRequest::GetDiskIds() const
{
    return m_diskIds;
}

void DescribeDisksDeniedActionsRequest::SetDiskIds(const vector<string>& _diskIds)
{
    m_diskIds = _diskIds;
    m_diskIdsHasBeenSet = true;
}

bool DescribeDisksDeniedActionsRequest::DiskIdsHasBeenSet() const
{
