...
CoreInternalOutcome ModifyFirewallRuleDescriptionResponse::Deserialize(const string &payload)
{
...
string ModifyFirewallRuleDescriptionResponse::ToJsonString() const
{
