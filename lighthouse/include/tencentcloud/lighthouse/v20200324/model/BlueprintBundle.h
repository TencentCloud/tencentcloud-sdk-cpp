...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_BLUEPRINTBUNDLE_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_BLUEPRINTBUNDLE_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                * 镜像套餐详细信息。
                */
                class BlueprintBundle : public AbstractModel
                {
                public:
                    BlueprintBundle();
                    ~BlueprintBundle() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取套餐ID。可以通过[DescribeBundles](https://cloud.tencent.com/document/product/1207/47575)接口返回的BundleId获取。
                    ...
                    /**
                     * 设置套餐ID。可以通过[DescribeBundles](https://cloud.tencent.com/document/product/1207/47575)接口返回的BundleId获取。
                     ...
                     * 
                     */
                    int64_t GetBundleTypePriority() const;
                     ...
                     * 
                     */
                    void SetBundleTypePriority(const int64_t& _bundleTypePriority);

                    /**
                     * 判断参数 BundleTypePriority 是否已赋值
                     * @return BundleTypePriority 是否已赋值
                     * 
                     */
                    bool BundleTypePriorityHasBeenSet() const;
                     ...
                     * 
                     */
                    void SetSupportSlot(const int64_t& _supportSlot);

                    /**
                     * 判断参数 SupportSlot 是否已赋值
                     * @return SupportSlot 是否已赋值
                     * 
                     */
                    bool SupportSlotHasBeenSet() const;
...
<li> CLOUD_SSD：SSD 云硬盘</li><li> CLOUD_PREMIUM：高性能云硬盘</li>
                ...
                private:
                     ...
                     * 套餐类型权重。取值越小排序越靠前。
                     */
                    int64_t m_bundleTypePriority;
                    bool m_bundleTypePriorityHasBeenSet;
                     ...
                     * 支持人数。
                     */
                    int64_t m_supportSlot;
                    bool m_supportSlotHasBeenSet;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_BLUEPRINTBUNDLE_H_
