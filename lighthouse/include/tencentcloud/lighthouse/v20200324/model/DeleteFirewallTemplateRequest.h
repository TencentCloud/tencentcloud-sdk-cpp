...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DELETEFIREWALLTEMPLATEREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DELETEFIREWALLTEMPLATEREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DeleteFirewallTemplateRequest : public AbstractModel
                {
                public:
                    DeleteFirewallTemplateRequest();
                    ~DeleteFirewallTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DELETEFIREWALLTEMPLATEREQUEST_H_
