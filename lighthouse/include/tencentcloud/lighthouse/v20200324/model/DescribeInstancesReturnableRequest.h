...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEINSTANCESRETURNABLEREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEINSTANCESRETURNABLEREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DescribeInstancesReturnableRequest : public AbstractModel
                {
                public:
                    DescribeInstancesReturnableRequest();
                    ~DescribeInstancesReturnableRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEINSTANCESRETURNABLEREQUEST_H_
