...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEDOCKERCONTAINERSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEDOCKERCONTAINERSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class RemoveDockerContainersRequest : public AbstractModel
                {
                public:
                    RemoveDockerContainersRequest();
                    ~RemoveDockerContainersRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEDOCKERCONTAINERSREQUEST_H_
