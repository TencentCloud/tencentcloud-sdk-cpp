...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTDOCKERCONTAINERSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTDOCKERCONTAINERSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class RestartDockerContainersRequest : public AbstractModel
                {
                public:
                    RestartDockerContainersRequest();
                    ~RestartDockerContainersRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTDOCKERCONTAINERSREQUEST_H_
