...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEMCPSERVERSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEMCPSERVERSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class RemoveMcpServersRequest : public AbstractModel
                {
                public:
                    RemoveMcpServersRequest();
                    ~RemoveMcpServersRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_REMOVEMCPSERVERSREQUEST_H_
