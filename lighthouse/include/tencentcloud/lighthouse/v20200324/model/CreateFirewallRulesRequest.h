...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLRULESREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLRULESREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class CreateFirewallRulesRequest : public AbstractModel
                {
                public:
                    CreateFirewallRulesRequest();
                    ~CreateFirewallRulesRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLRULESREQUEST_H_
