...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_APPLYFIREWALLTEMPLATEREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_APPLYFIREWALLTEMPLATEREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class ApplyFirewallTemplateRequest : public AbstractModel
                {
                public:
                    ApplyFirewallTemplateRequest();
                    ~ApplyFirewallTemplateRequest() = default;
                    ...
                    /**
                     * 判断参数 ApplyInstances 是否已赋值
                     * @return ApplyInstances 是否已赋值
                     * 
                     */
                    bool ApplyInstancesHasBeenSet() const;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_APPLYFIREWALLTEMPLATEREQUEST_H_
