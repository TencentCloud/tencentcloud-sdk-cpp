...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEBLUEPRINTSSHAREACROSSACCOUNTINFOSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEBLUEPRINTSSHAREACROSSACCOUNTINFOSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DescribeBlueprintsShareAcrossAccountInfosRequest : public AbstractModel
                {
                public:
                    DescribeBlueprintsShareAcrossAccountInfosRequest();
                    ~DescribeBlueprintsShareAcrossAccountInfosRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取镜像 ID 列表。可以通过[DescribeBlueprints](https://cloud.tencent.com/document/product/1207/47689)接口返回的BlueprintId获取。
                    ...
                    /**
                     * 设置镜像 ID 列表。可以通过[DescribeBlueprints](https://cloud.tencent.com/document/product/1207/47689)接口返回的BlueprintId获取。
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEBLUEPRINTSSHAREACROSSACCOUNTINFOSREQUEST_H_
