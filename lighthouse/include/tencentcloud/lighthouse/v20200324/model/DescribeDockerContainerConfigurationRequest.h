...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEDOCKERCONTAINERCONFIGURATIONREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEDOCKERCONTAINERCONFIGURATIONREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DescribeDockerContainerConfigurationRequest : public AbstractModel
                {
                public:
                    DescribeDockerContainerConfigurationRequest();
                    ~DescribeDockerContainerConfigurationRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEDOCKERCONTAINERCONFIGURATIONREQUEST_H_
