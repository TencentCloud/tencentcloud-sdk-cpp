...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLTEMPLATERULESREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLTEMPLATERULESREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class CreateFirewallTemplateRulesRequest : public AbstractModel
                {
                public:
                    CreateFirewallTemplateRulesRequest();
                    ~CreateFirewallTemplateRulesRequest() = default;
                    ...
                    /**
                     * 获取防火墙模板规则列表。
                     * @return TemplateRules 防火墙模板规则列表。
                     * 
                     */
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CREATEFIREWALLTEMPLATERULESREQUEST_H_
