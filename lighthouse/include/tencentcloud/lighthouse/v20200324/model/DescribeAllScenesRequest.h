...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEALLSCENESREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEALLSCENESREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DescribeAllScenesRequest : public AbstractModel
                {
                public:
                    DescribeAllScenesRequest();
                    ~DescribeAllScenesRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取使用场景ID列表。可通过[DescribeAllScenes](https://cloud.tencent.com/document/product/1207/83513)接口返回值中的SceneId获取。
                    ...
                    /**
                     * 设置使用场景ID列表。可通过[DescribeAllScenes](https://cloud.tencent.com/document/product/1207/83513)接口返回值中的SceneId获取。
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEALLSCENESREQUEST_H_
