            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
                     * @return BizType 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
                     */
                    std::string GetBizType() const;

                    /**
                     * 设置业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
                    ...
                    /**
                     * 获取（可选）回调签名key，具体可以查看回调签名示例
                     * @return Seed （可选）回调签名key，具体可以查看回调签名示例
                     */
                    std::string GetSeed() const;

                    /**
                     * 设置（可选）回调签名key，具体可以查看回调签名示例
