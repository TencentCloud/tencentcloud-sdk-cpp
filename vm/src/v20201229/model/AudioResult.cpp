...
vector<AudioLabelResult> AudioResult::GetLabelResults() const
{
    return m_labelResults;
}

void AudioResult::SetLabelResults(const vector<AudioLabelResult>& _labelResults)
{
