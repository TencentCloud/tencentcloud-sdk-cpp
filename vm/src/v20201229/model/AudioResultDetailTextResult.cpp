...
CoreInternalOutcome AudioResultDetailTextResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void AudioResultDetailTextResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
