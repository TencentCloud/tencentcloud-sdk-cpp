...
string DescribeTasksResponse::GetTotal() const
{
    return m_total;
}

bool DescribeTasksResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<TaskData> DescribeTasksResponse::GetData() const
{
    return m_data;
}

bool DescribeTasksResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeTasksResponse::GetPageToken() const
{
    return m_pageToken;
}

bool DescribeTasksResponse::PageTokenHasBeenSet() const
{
