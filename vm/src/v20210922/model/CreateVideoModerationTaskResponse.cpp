...
CoreInternalOutcome CreateVideoModerationTaskResponse::Deserialize(const string &payload)
{
...
string CreateVideoModerationTaskResponse::ToJsonString() const
{
...
vector<TaskResult> CreateVideoModerationTaskResponse::GetResults() const
{
    return m_results;
}

bool CreateVideoModerationTaskResponse::ResultsHasBeenSet() const
{
