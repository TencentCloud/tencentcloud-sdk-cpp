...
CoreInternalOutcome DescribeVideoStatResponse::Deserialize(const string &payload)
{
...
string DescribeVideoStatResponse::ToJsonString() const
{
...
Overview DescribeVideoStatResponse::GetOverview() const
{
    return m_overview;
}

bool DescribeVideoStatResponse::OverviewHasBeenSet() const
{
    return m_overviewHasBeenSet;
}

vector<TrendCount> DescribeVideoStatResponse::GetTrendCount() const
{
    return m_trendCount;
}

bool DescribeVideoStatResponse::TrendCountHasBeenSet() const
{
    return m_trendCountHasBeenSet;
}

vector<EvilCount> DescribeVideoStatResponse::GetEvilCount() const
{
    return m_evilCount;
}

bool DescribeVideoStatResponse::EvilCountHasBeenSet() const
{
