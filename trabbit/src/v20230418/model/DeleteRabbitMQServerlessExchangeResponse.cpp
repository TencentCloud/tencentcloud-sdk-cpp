...
CoreInternalOutcome DeleteRabbitMQServerlessExchangeResponse::Deserialize(const string &payload)
{
...
string DeleteRabbitMQServerlessExchangeResponse::ToJsonString() const
{
...
string DeleteRabbitMQServerlessExchangeResponse::GetExchangeName() const
{
    return m_exchangeName;
}

bool DeleteRabbitMQServerlessExchangeResponse::ExchangeNameHasBeenSet() const
{
