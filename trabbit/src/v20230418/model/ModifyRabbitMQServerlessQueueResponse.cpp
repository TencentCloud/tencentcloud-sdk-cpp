...
CoreInternalOutcome ModifyRabbitMQServerlessQueueResponse::Deserialize(const string &payload)
{
...
string ModifyRabbitMQServerlessQueueResponse::ToJsonString() const
{
...
string ModifyRabbitMQServerlessQueueResponse::GetQueueName() const
{
    return m_queueName;
}

bool ModifyRabbitMQServerlessQueueResponse::QueueNameHasBeenSet() const
{
