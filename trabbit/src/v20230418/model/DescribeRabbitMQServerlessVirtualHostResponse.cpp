...
CoreInternalOutcome DescribeRabbitMQServerlessVirtualHostResponse::Deserialize(const string &payload)
{
...
string DescribeRabbitMQServerlessVirtualHostResponse::ToJsonString() const
{
...
int64_t DescribeRabbitMQServerlessVirtualHostResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRabbitMQServerlessVirtualHostResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RabbitMQVirtualHostInfo> DescribeRabbitMQServerlessVirtualHostResponse::GetVirtualHostList() const
{
    return m_virtualHostList;
}

bool DescribeRabbitMQServerlessVirtualHostResponse::VirtualHostListHasBeenSet() const
{
