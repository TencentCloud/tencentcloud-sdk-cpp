...
CoreInternalOutcome ListRabbitMQServerlessInstancesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Instances") && !rsp["Instances"].IsNull())
    {
        ...
        {
            RabbitMQServerlessInstance item;
...
string ListRabbitMQServerlessInstancesResponse::ToJsonString() const
{
...
vector<RabbitMQServerlessInstance> ListRabbitMQServerlessInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool ListRabbitMQServerlessInstancesResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

uint64_t ListRabbitMQServerlessInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListRabbitMQServerlessInstancesResponse::TotalCountHasBeenSet() const
{
