...
CoreInternalOutcome CreateRabbitMQServerlessQueueResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQServerlessQueueResponse::ToJsonString() const
{
...
string CreateRabbitMQServerlessQueueResponse::GetQueueName() const
{
    return m_queueName;
}

bool CreateRabbitMQServerlessQueueResponse::QueueNameHasBeenSet() const
{
