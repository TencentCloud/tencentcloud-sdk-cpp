...
string DeleteRabbitMQServerlessExchangeRequest::ToJsonString() const
{
...
string DeleteRabbitMQServerlessExchangeRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DeleteRabbitMQServerlessExchangeRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DeleteRabbitMQServerlessExchangeRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string DeleteRabbitMQServerlessExchangeRequest::GetVirtualHost() const
{
    return m_virtualHost;
}

void DeleteRabbitMQServerlessExchangeRequest::SetVirtualHost(const string& _virtualHost)
{
    m_virtualHost = _virtualHost;
    m_virtualHostHasBeenSet = true;
}

bool DeleteRabbitMQServerlessExchangeRequest::VirtualHostHasBeenSet() const
{
    return m_virtualHostHasBeenSet;
}

string DeleteRabbitMQServerlessExchangeRequest::GetExchangeName() const
{
    return m_exchangeName;
}

void DeleteRabbitMQServerlessExchangeRequest::SetExchangeName(const string& _exchangeName)
{
    m_exchangeName = _exchangeName;
    m_exchangeNameHasBeenSet = true;
}

bool DeleteRabbitMQServerlessExchangeRequest::ExchangeNameHasBeenSet() const
{
