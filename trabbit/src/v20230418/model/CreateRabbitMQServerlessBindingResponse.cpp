...
CoreInternalOutcome CreateRabbitMQServerlessBindingResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQServerlessBindingResponse::ToJsonString() const
{
...
string CreateRabbitMQServerlessBindingResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateRabbitMQServerlessBindingResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateRabbitMQServerlessBindingResponse::GetVirtualHost() const
{
    return m_virtualHost;
}

bool CreateRabbitMQServerlessBindingResponse::VirtualHostHasBeenSet() const
{
    return m_virtualHostHasBeenSet;
}

int64_t CreateRabbitMQServerlessBindingResponse::GetBindingId() const
{
    return m_bindingId;
}

bool CreateRabbitMQServerlessBindingResponse::BindingIdHasBeenSet() const
{
