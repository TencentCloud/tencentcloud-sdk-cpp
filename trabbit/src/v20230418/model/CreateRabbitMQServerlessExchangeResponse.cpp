...
CoreInternalOutcome CreateRabbitMQServerlessExchangeResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQServerlessExchangeResponse::ToJsonString() const
{
...
string CreateRabbitMQServerlessExchangeResponse::GetExchangeName() const
{
    return m_exchangeName;
}

bool CreateRabbitMQServerlessExchangeResponse::ExchangeNameHasBeenSet() const
{
