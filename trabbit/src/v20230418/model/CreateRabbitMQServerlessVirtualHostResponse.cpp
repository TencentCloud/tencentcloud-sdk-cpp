...
CoreInternalOutcome CreateRabbitMQServerlessVirtualHostResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQServerlessVirtualHostResponse::ToJsonString() const
{
...
string CreateRabbitMQServerlessVirtualHostResponse::GetVirtualHost() const
{
    return m_virtualHost;
}

bool CreateRabbitMQServerlessVirtualHostResponse::VirtualHostHasBeenSet() const
{
