...
CoreInternalOutcome ModifyRabbitMQServerlessExchangeResponse::Deserialize(const string &payload)
{
...
string ModifyRabbitMQServerlessExchangeResponse::ToJsonString() const
{
...
string ModifyRabbitMQServerlessExchangeResponse::GetExchangeName() const
{
    return m_exchangeName;
}

bool ModifyRabbitMQServerlessExchangeResponse::ExchangeNameHasBeenSet() const
{
