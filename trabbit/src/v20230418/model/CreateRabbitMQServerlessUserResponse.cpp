...
CoreInternalOutcome CreateRabbitMQServerlessUserResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQServerlessUserResponse::ToJsonString() const
{
...
string CreateRabbitMQServerlessUserResponse::GetUser() const
{
    return m_user;
}

bool CreateRabbitMQServerlessUserResponse::UserHasBeenSet() const
{
