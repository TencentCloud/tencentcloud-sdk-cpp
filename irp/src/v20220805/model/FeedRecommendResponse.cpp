...
CoreInternalOutcome FeedRecommendResponse::Deserialize(const string &payload)
{
...
string FeedRecommendResponse::ToJsonString() const
{
...
vector<RecItemData> FeedRecommendResponse::GetDataList() const
{
    return m_dataList;
}

bool FeedRecommendResponse::DataListHasBeenSet() const
{
