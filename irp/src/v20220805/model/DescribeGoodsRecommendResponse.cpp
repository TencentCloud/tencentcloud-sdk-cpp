...
DescribeGoodsRecommendResponse::DescribeGoodsRecommendResponse() :
    m_dataListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeGoodsRecommendResponse::Deserialize(const string &payload)
{
...
string DescribeGoodsRecommendResponse::ToJsonString() const
{
...
vector<RecGoodsData> DescribeGoodsRecommendResponse::GetDataList() const
{
    return m_dataList;
}

bool DescribeGoodsRecommendResponse::DataListHasBeenSet() const
{
