...
CoreInternalOutcome DestroyInstanceByApiResponse::Deserialize(const string &payload)
{
...
string DestroyInstanceByApiResponse::ToJsonString() const
{
...
string DestroyInstanceByApiResponse::GetFlowId() const
{
    return m_flowId;
}

bool DestroyInstanceByApiResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string DestroyInstanceByApiResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DestroyInstanceByApiResponse::ErrorMsgHasBeenSet() const
{
