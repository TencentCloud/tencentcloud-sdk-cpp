...
CoreInternalOutcome DescribeSimpleInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleInstancesResponse::ToJsonString() const
{
...
int64_t DescribeSimpleInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSimpleInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstanceSimpleInfoNew> DescribeSimpleInstancesResponse::GetInstancesList() const
{
    return m_instancesList;
}

bool DescribeSimpleInstancesResponse::InstancesListHasBeenSet() const
{
    return m_instancesListHasBeenSet;
}

string DescribeSimpleInstancesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeSimpleInstancesResponse::ErrorMsgHasBeenSet() const
{
