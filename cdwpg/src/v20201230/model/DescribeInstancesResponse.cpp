...
int64_t DescribeInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstanceInfo> DescribeInstancesResponse::GetInstancesList() const
{
    return m_instancesList;
}

bool DescribeInstancesResponse::InstancesListHasBeenSet() const
{
    return m_instancesListHasBeenSet;
}

string DescribeInstancesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeInstancesResponse::ErrorMsgHasBeenSet() const
{
