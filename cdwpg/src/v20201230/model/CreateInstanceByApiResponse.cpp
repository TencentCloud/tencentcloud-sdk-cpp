...
CoreInternalOutcome CreateInstanceByApiResponse::Deserialize(const string &payload)
{
...
string CreateInstanceByApiResponse::ToJsonString() const
{
...
string CreateInstanceByApiResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateInstanceByApiResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string CreateInstanceByApiResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateInstanceByApiResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateInstanceByApiResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CreateInstanceByApiResponse::ErrorMsgHasBeenSet() const
{
