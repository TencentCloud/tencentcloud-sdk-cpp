...
string DescribeInstanceStateRequest::ToJsonString() const
{
...
string DescribeInstanceStateRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeInstanceStateRequest::SetInstanceId(const string& _instanceId)
{
