...
string UpgradeInstanceRequest::GetPackageVersion() const
{
    return m_packageVersion;
}

void UpgradeInstanceRequest::SetPackageVersion(const string& _packageVersion)
{
    m_packageVersion = _packageVersion;
    m_packageVersionHasBeenSet = true;
}

bool UpgradeInstanceRequest::PackageVersionHasBeenSet() const
{
