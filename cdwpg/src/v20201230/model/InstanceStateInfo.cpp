...
CoreInternalOutcome InstanceStateInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("BackupStatus") && !value["BackupStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceStateInfo.BackupStatus` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BackupOpenStatus") && !value["BackupOpenStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceStateInfo.BackupOpenStatus` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
int64_t InstanceStateInfo::GetBackupStatus() const
{
    return m_backupStatus;
}

void InstanceStateInfo::SetBackupStatus(const int64_t& _backupStatus)
{
    m_backupStatus = _backupStatus;
    m_backupStatusHasBeenSet = true;
}

bool InstanceStateInfo::BackupStatusHasBeenSet() const
{
...
int64_t InstanceStateInfo::GetBackupOpenStatus() const
{
    return m_backupOpenStatus;
}

void InstanceStateInfo::SetBackupOpenStatus(const int64_t& _backupOpenStatus)
{
    m_backupOpenStatus = _backupOpenStatus;
    m_backupOpenStatusHasBeenSet = true;
}

bool InstanceStateInfo::BackupOpenStatusHasBeenSet() const
{
