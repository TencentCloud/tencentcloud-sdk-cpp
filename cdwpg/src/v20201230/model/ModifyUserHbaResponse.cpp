...
CoreInternalOutcome ModifyUserHbaResponse::Deserialize(const string &payload)
{
...
string ModifyUserHbaResponse::ToJsonString() const
{
...
int64_t ModifyUserHbaResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyUserHbaResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string ModifyUserHbaResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyUserHbaResponse::ErrorMsgHasBeenSet() const
{
