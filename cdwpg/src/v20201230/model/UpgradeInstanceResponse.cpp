...
string UpgradeInstanceResponse::ToJsonString() const
{
...
int64_t UpgradeInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string UpgradeInstanceResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool UpgradeInstanceResponse::ErrorMsgHasBeenSet() const
{
