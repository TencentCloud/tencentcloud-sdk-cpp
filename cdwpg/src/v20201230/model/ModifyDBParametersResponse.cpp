...
CoreInternalOutcome ModifyDBParametersResponse::Deserialize(const string &payload)
{
...
string ModifyDBParametersResponse::ToJsonString() const
{
...
int64_t ModifyDBParametersResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDBParametersResponse::TaskIdHasBeenSet() const
{
