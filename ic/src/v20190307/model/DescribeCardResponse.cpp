...
CoreInternalOutcome DescribeCardResponse::Deserialize(const string &payload)
{
...
string DescribeCardResponse::ToJsonString() const
{
...
CardInfo DescribeCardResponse::GetData() const
{
    return m_data;
}

bool DescribeCardResponse::DataHasBeenSet() const
{
