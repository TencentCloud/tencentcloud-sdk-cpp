...
CoreInternalOutcome DescribeSmsResponse::Deserialize(const string &payload)
{
...
string DescribeSmsResponse::ToJsonString() const
{
...
int64_t DescribeSmsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSmsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ResSms> DescribeSmsResponse::GetList() const
{
    return m_list;
}

bool DescribeSmsResponse::ListHasBeenSet() const
{
