...
CoreInternalOutcome RenewCardsResponse::Deserialize(const string &payload)
{
...
string RenewCardsResponse::ToJsonString() const
{
...
ResRenew RenewCardsResponse::GetData() const
{
    return m_data;
}

bool RenewCardsResponse::DataHasBeenSet() const
{
