...
CoreInternalOutcome DescribeCardsResponse::Deserialize(const string &payload)
{
...
string DescribeCardsResponse::ToJsonString() const
{
...
CardList DescribeCardsResponse::GetData() const
{
    return m_data;
}

bool DescribeCardsResponse::DataHasBeenSet() const
{
