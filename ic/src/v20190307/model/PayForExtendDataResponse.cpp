...
CoreInternalOutcome PayForExtendDataResponse::Deserialize(const string &payload)
{
...
string PayForExtendDataResponse::ToJsonString() const
{
...
ResOrderIds PayForExtendDataResponse::GetData() const
{
    return m_data;
}

bool PayForExtendDataResponse::DataHasBeenSet() const
{
