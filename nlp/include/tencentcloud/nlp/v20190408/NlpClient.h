    ...
    namespace Nlp
    {
        namespace V20190408
        {
            ...
            public:
                ...
                typedef Outcome<Error, Model::SensitiveWordsRecognitionResponse> SensitiveWordsRecognitionOutcome;
                typedef std::future<SensitiveWordsRecognitionOutcome> SensitiveWordsRecognitionOutcomeCallable;
                typedef std::function<void(const NlpClient*, const Model::SensitiveWordsRecognitionRequest&, SensitiveWordsRecognitionOutcome, const std::shared_ptr<const AsyncCallerContext>&)> SensitiveWordsRecognitionAsyncHandler;
...
3、恶意关键词：文本中所有涉嫌恶意的关键词。
                 ...
                 * @return ContentApprovalOutcome
                 */
                ContentApprovalOutcome ContentApproval(const Model::ContentApprovalRequest &request);
                void ContentApprovalAsync(const Model::ContentApprovalRequest& request, const ContentApprovalAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                ContentApprovalOutcomeCallable ContentApprovalCallable(const Model::ContentApprovalRequest& request);
...
目前能够支持对政治、色情、辱骂/低俗、暴恐/毒品、广告/灌水、迷信/邪教、其他违法、综合等8大类敏感信息的识别。
                 ...
                 * @return SensitiveWordsRecognitionOutcome
                 */
                SensitiveWordsRecognitionOutcome SensitiveWordsRecognition(const Model::SensitiveWordsRecognitionRequest &request);
                void SensitiveWordsRecognitionAsync(const Model::SensitiveWordsRecognitionRequest& request, const SensitiveWordsRecognitionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                SensitiveWordsRecognitionOutcomeCallable SensitiveWordsRecognitionCallable(const Model::SensitiveWordsRecognitionRequest& request);
