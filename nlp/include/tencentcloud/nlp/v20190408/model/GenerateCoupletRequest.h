...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETREQUEST_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETREQUEST_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class GenerateCoupletRequest : public AbstractModel
                {
                public:
                    GenerateCoupletRequest();
                    ~GenerateCoupletRequest() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETREQUEST_H_
