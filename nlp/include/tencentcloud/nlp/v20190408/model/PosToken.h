...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_POSTOKEN_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_POSTOKEN_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                * 分词&词性标注结果
                */
                class PosToken : public AbstractModel
                {
                public:
                    PosToken();
                    ~PosToken() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_POSTOKEN_H_
