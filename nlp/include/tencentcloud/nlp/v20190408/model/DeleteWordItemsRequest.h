...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_DELETEWORDITEMSREQUEST_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_DELETEWORDITEMSREQUEST_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class DeleteWordItemsRequest : public AbstractModel
                {
                public:
                    DeleteWordItemsRequest();
                    ~DeleteWordItemsRequest() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_DELETEWORDITEMSREQUEST_H_
