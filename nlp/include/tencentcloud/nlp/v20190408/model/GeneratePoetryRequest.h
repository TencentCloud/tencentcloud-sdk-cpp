...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_GENERATEPOETRYREQUEST_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_GENERATEPOETRYREQUEST_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class GeneratePoetryRequest : public AbstractModel
                {
                public:
                    GeneratePoetryRequest();
                    ~GeneratePoetryRequest() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_GENERATEPOETRYREQUEST_H_
