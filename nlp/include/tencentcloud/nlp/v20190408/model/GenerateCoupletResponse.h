...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETRESPONSE_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETRESPONSE_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class GenerateCoupletResponse : public AbstractModel
                {
                public:
                    GenerateCoupletResponse();
                    ~GenerateCoupletResponse() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_GENERATECOUPLETRESPONSE_H_
