...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_SEARCHWORDITEMSREQUEST_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_SEARCHWORDITEMSREQUEST_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class SearchWordItemsRequest : public AbstractModel
                {
                public:
                    SearchWordItemsRequest();
                    ~SearchWordItemsRequest() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_SEARCHWORDITEMSREQUEST_H_
