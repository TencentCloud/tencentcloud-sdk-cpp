...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_TEXTSIMILARITYRESPONSE_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_TEXTSIMILARITYRESPONSE_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class TextSimilarityResponse : public AbstractModel
                {
                public:
                    TextSimilarityResponse();
                    ~TextSimilarityResponse() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_TEXTSIMILARITYRESPONSE_H_
