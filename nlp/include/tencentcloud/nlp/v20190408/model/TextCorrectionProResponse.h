...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_TEXTCORRECTIONPRORESPONSE_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_TEXTCORRECTIONPRORESPONSE_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                */
                class TextCorrectionProResponse : public AbstractModel
                {
                public:
                    TextCorrectionProResponse();
                    ~TextCorrectionProResponse() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_TEXTCORRECTIONPRORESPONSE_H_
