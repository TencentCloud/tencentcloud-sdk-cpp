...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_BASICPARTICIPLE_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_BASICPARTICIPLE_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                * 基础粒度分词和词性标注的结果
                */
                class BasicParticiple : public AbstractModel
                {
                public:
                    BasicParticiple();
                    ~BasicParticiple() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_BASICPARTICIPLE_H_
