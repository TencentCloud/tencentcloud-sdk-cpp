...
#ifndef TENCENTCLOUD_NLP_V20190408_MODEL_TEXTAPPROVALREQUEST_H_
#define TENCENTCLOUD_NLP_V20190408_MODEL_TEXTAPPROVALREQUEST_H_
    ...
    namespace Nlp
    {
        namespace V20190408
        {
            namespace Model
            {
                ...
                * TextApproval请求参数结构体
                */
                class TextApprovalRequest : public AbstractModel
                {
                public:
                    TextApprovalRequest();
                    ~TextApprovalRequest() = default;
...
#endif // !TENCENTCLOUD_NLP_V20190408_MODEL_TEXTAPPROVALREQUEST_H_
