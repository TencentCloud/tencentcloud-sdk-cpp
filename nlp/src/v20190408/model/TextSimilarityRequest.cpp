...
string TextSimilarityRequest::ToJsonString() const
{
...
string TextSimilarityRequest::GetSrcText() const
{
    return m_srcText;
}

void TextSimilarityRequest::SetSrcText(const string& _srcText)
{
    m_srcText = _srcText;
    m_srcTextHasBeenSet = true;
}

bool TextSimilarityRequest::SrcTextHasBeenSet() const
{
    return m_srcTextHasBeenSet;
}

vector<string> TextSimilarityRequest::GetTargetText() const
{
    return m_targetText;
}

void TextSimilarityRequest::SetTargetText(const vector<string>& _targetText)
{
    m_targetText = _targetText;
    m_targetTextHasBeenSet = true;
}

bool TextSimilarityRequest::TargetTextHasBeenSet() const
{
