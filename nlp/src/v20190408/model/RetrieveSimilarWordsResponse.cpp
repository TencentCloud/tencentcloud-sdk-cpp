...
RetrieveSimilarWordsResponse::RetrieveSimilarWordsResponse() :
    m_wordListHasBeenSet(false)
{
}

CoreInternalOutcome RetrieveSimilarWordsResponse::Deserialize(const string &payload)
{
...
string RetrieveSimilarWordsResponse::ToJsonString() const
{
...
vector<string> RetrieveSimilarWordsResponse::GetWordList() const
{
    return m_wordList;
}

bool RetrieveSimilarWordsResponse::WordListHasBeenSet() const
{
