...
CoreInternalOutcome GeneratePoetryResponse::Deserialize(const string &payload)
{
...
string GeneratePoetryResponse::ToJsonString() const
{
...
string GeneratePoetryResponse::GetTitle() const
{
    return m_title;
}

bool GeneratePoetryResponse::TitleHasBeenSet() const
{
    return m_titleHasBeenSet;
}

vector<string> GeneratePoetryResponse::GetContent() const
{
    return m_content;
}

bool GeneratePoetryResponse::ContentHasBeenSet() const
{
