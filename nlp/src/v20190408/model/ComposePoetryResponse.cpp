...
ComposePoetryResponse::ComposePoetryResponse() :
    m_titleHasBeenSet(false),
    m_contentHasBeenSet(false)
{
}

CoreInternalOutcome ComposePoetryResponse::Deserialize(const string &payload)
{
...
string ComposePoetryResponse::ToJsonString() const
{
...
string ComposePoetryResponse::GetTitle() const
{
    return m_title;
}

bool ComposePoetryResponse::TitleHasBeenSet() const
{
    return m_titleHasBeenSet;
}

vector<string> ComposePoetryResponse::GetContent() const
{
    return m_content;
}

bool ComposePoetryResponse::ContentHasBeenSet() const
{
