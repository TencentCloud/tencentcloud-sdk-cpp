...
CoreInternalOutcome TextCorrectionProResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CCITokens") && !rsp["CCITokens"].IsNull())
    {
        if (!rsp["CCITokens"].IsArray())
            return CoreInternalOutcome(Core::Error("response `CCITokens` is not array type"));
    ...
    if (rsp.HasMember("ResultText") && !rsp["ResultText"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ResultText` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string TextCorrectionProResponse::ToJsonString() const
{
...
vector<CCIToken> TextCorrectionProResponse::GetCCITokens() const
{
    return m_cCITokens;
}

bool TextCorrectionProResponse::CCITokensHasBeenSet() const
{
    return m_cCITokensHasBeenSet;
}

string TextCorrectionProResponse::GetResultText() const
{
    return m_resultText;
}

bool TextCorrectionProResponse::ResultTextHasBeenSet() const
{
