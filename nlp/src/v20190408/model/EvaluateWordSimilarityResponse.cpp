...
EvaluateWordSimilarityResponse::EvaluateWordSimilarityResponse() :
    m_similarityHasBeenSet(false)
{
}

CoreInternalOutcome EvaluateWordSimilarityResponse::Deserialize(const string &payload)
{
...
string EvaluateWordSimilarityResponse::ToJsonString() const
{
...
double EvaluateWordSimilarityResponse::GetSimilarity() const
{
    return m_similarity;
}

bool EvaluateWordSimilarityResponse::SimilarityHasBeenSet() const
{
