...
CoreInternalOutcome TextGenerationUsage::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("PromptTokens") && !value["PromptTokens"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TextGenerationUsage.PromptTokens` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CompletionTokens") && !value["CompletionTokens"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TextGenerationUsage.CompletionTokens` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TotalTokens") && !value["TotalTokens"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TextGenerationUsage.TotalTokens` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void TextGenerationUsage::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
int64_t TextGenerationUsage::GetPromptTokens() const
{
    return m_promptTokens;
}

void TextGenerationUsage::SetPromptTokens(const int64_t& _promptTokens)
{
    m_promptTokens = _promptTokens;
    m_promptTokensHasBeenSet = true;
}

bool TextGenerationUsage::PromptTokensHasBeenSet() const
{
    return m_promptTokensHasBeenSet;
}

int64_t TextGenerationUsage::GetCompletionTokens() const
{
    return m_completionTokens;
}

void TextGenerationUsage::SetCompletionTokens(const int64_t& _completionTokens)
{
    m_completionTokens = _completionTokens;
    m_completionTokensHasBeenSet = true;
}

bool TextGenerationUsage::CompletionTokensHasBeenSet() const
{
    return m_completionTokensHasBeenSet;
}

int64_t TextGenerationUsage::GetTotalTokens() const
{
    return m_totalTokens;
}

void TextGenerationUsage::SetTotalTokens(const int64_t& _totalTokens)
{
    m_totalTokens = _totalTokens;
    m_totalTokensHasBeenSet = true;
}

bool TextGenerationUsage::TotalTokensHasBeenSet() const
{
