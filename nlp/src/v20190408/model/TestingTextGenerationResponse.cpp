...
TestingTextGenerationResponse::TestingTextGenerationResponse() :
...
CoreInternalOutcome TestingTextGenerationResponse::Deserialize(const string &payload)
{
...
string TestingTextGenerationResponse::ToJsonString() const
{
...
vector<TextGenerationChoices> TestingTextGenerationResponse::GetChoices() const
{
    return m_choices;
}

bool TestingTextGenerationResponse::ChoicesHasBeenSet() const
{
    return m_choicesHasBeenSet;
}

int64_t TestingTextGenerationResponse::GetCreated() const
{
    return m_created;
}

bool TestingTextGenerationResponse::CreatedHasBeenSet() const
{
    return m_createdHasBeenSet;
}

string TestingTextGenerationResponse::GetId() const
{
    return m_id;
}

bool TestingTextGenerationResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string TestingTextGenerationResponse::GetModel() const
{
    return m_model;
}

bool TestingTextGenerationResponse::ModelHasBeenSet() const
{
    return m_modelHasBeenSet;
}

TextGenerationUsage TestingTextGenerationResponse::GetUsage() const
{
    return m_usage;
}

bool TestingTextGenerationResponse::UsageHasBeenSet() const
{
