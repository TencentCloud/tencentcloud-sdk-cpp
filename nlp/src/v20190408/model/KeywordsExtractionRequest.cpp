...
string KeywordsExtractionRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string KeywordsExtractionRequest::GetText() const
{
    return m_text;
}

void KeywordsExtractionRequest::SetText(const string& _text)
{
    m_text = _text;
