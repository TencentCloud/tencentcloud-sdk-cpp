...
CoreInternalOutcome KeywordsExtractionResponse::Deserialize(const string &payload)
{
...
string KeywordsExtractionResponse::ToJsonString() const
{
...
vector<Keyword> KeywordsExtractionResponse::GetKeywords() const
{
    return m_keywords;
}

bool KeywordsExtractionResponse::KeywordsHasBeenSet() const
{
