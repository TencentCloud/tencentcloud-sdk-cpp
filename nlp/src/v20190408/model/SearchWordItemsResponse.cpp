...
CoreInternalOutcome SearchWordItemsResponse::Deserialize(const string &payload)
{
...
string SearchWordItemsResponse::ToJsonString() const
{
...
vector<SearchResult> SearchWordItemsResponse::GetResults() const
{
    return m_results;
}

bool SearchWordItemsResponse::ResultsHasBeenSet() const
{
