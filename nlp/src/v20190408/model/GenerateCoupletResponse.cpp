...
CoreInternalOutcome GenerateCoupletResponse::Deserialize(const string &payload)
{
...
string GenerateCoupletResponse::ToJsonString() const
{
...
string GenerateCoupletResponse::GetTopScroll() const
{
    return m_topScroll;
}

bool GenerateCoupletResponse::TopScrollHasBeenSet() const
{
    return m_topScrollHasBeenSet;
}

vector<string> GenerateCoupletResponse::GetContent() const
{
    return m_content;
}

bool GenerateCoupletResponse::ContentHasBeenSet() const
{
    return m_contentHasBeenSet;
}

string GenerateCoupletResponse::GetRandomCause() const
{
    return m_randomCause;
}

bool GenerateCoupletResponse::RandomCauseHasBeenSet() const
{
