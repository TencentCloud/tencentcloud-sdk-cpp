...
#ifndef TENCENTCLOUD_HAI_V20230812_MODEL_SERVICEMETADATA_H_
#define TENCENTCLOUD_HAI_V20230812_MODEL_SERVICEMETADATA_H_
    ...
    namespace Hai
    {
        namespace V20230812
        {
            namespace Model
            {
                ...
                * 服务元数据信息，如服务名
                */
                class ServiceMetaData : public AbstractModel
                {
                public:
                    ServiceMetaData();
...
#endif // !TENCENTCLOUD_HAI_V20230812_MODEL_SERVICEMETADATA_H_
