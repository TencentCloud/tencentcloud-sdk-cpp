...
#ifndef TENCENTCLOUD_HAI_V20230812_MODEL_DESCRIBESERVICESCALLINFOREQUEST_H_
#define TENCENTCLOUD_HAI_V20230812_MODEL_DESCRIBESERVICESCALLINFOREQUEST_H_
    ...
    namespace Hai
    {
        namespace V20230812
        {
            namespace Model
            {
                ...
                */
                class DescribeServicesCallInfoRequest : public AbstractModel
                {
                public:
                    DescribeServicesCallInfoRequest();
                    ~DescribeServicesCallInfoRequest() = default;
...
#endif // !TENCENTCLOUD_HAI_V20230812_MODEL_DESCRIBESERVICESCALLINFOREQUEST_H_
