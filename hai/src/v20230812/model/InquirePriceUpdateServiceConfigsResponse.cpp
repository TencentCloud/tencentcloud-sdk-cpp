...
InquirePriceUpdateServiceConfigsResponse::InquirePriceUpdateServiceConfigsResponse() :
    m_priceHasBeenSet(false)
{
}

CoreInternalOutcome InquirePriceUpdateServiceConfigsResponse::Deserialize(const string &payload)
{
...
string InquirePriceUpdateServiceConfigsResponse::ToJsonString() const
{
...
ServicePriceDetail InquirePriceUpdateServiceConfigsResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceUpdateServiceConfigsResponse::PriceHasBeenSet() const
{
