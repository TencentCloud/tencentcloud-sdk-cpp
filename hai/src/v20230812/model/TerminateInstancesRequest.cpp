...
bool TerminateInstancesRequest::GetDryRun() const
{
    return m_dryRun;
}

void TerminateInstancesRequest::SetDryRun(const bool& _dryRun)
{
    m_dryRun = _dryRun;
    m_dryRunHasBeenSet = true;
}

bool TerminateInstancesRequest::DryRunHasBeenSet() const
{
