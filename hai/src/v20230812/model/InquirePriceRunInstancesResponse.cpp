...
InquirePriceRunInstancesResponse::InquirePriceRunInstancesResponse() :
    m_priceHasBeenSet(false)
{
}

CoreInternalOutcome InquirePriceRunInstancesResponse::Deserialize(const string &payload)
{
...
string InquirePriceRunInstancesResponse::ToJsonString() const
{
...
Price InquirePriceRunInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceRunInstancesResponse::PriceHasBeenSet() const
{
