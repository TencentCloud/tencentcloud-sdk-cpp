...
DescribeModelsResponse::DescribeModelsResponse() :
    m_totalCountHasBeenSet(false),
    m_modelSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeModelsResponse::Deserialize(const string &payload)
{
...
string DescribeModelsResponse::ToJsonString() const
{
...
int64_t DescribeModelsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeModelsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ModelDetail> DescribeModelsResponse::GetModelSet() const
{
    return m_modelSet;
}

bool DescribeModelsResponse::ModelSetHasBeenSet() const
{
