...
CoreInternalOutcome StartInstanceResponse::Deserialize(const string &payload)
{
...
string StartInstanceResponse::ToJsonString() const
{
...
uint64_t StartInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartInstanceResponse::TaskIdHasBeenSet() const
{
