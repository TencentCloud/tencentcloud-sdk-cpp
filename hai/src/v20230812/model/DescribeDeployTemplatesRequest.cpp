...
string DescribeDeployTemplatesRequest::ToJsonString() const
{
...
string DescribeDeployTemplatesRequest::GetModelId() const
{
    return m_modelId;
}

void DescribeDeployTemplatesRequest::SetModelId(const string& _modelId)
{
    m_modelId = _modelId;
