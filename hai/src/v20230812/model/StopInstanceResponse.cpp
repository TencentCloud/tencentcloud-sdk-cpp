...
CoreInternalOutcome StopInstanceResponse::Deserialize(const string &payload)
{
...
string StopInstanceResponse::ToJsonString() const
{
...
uint64_t StopInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool StopInstanceResponse::TaskIdHasBeenSet() const
{
