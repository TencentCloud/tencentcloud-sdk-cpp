...
DeployInferServiceResponse::DeployInferServiceResponse() :
    m_serviceIdHasBeenSet(false)
{
}

CoreInternalOutcome DeployInferServiceResponse::Deserialize(const string &payload)
{
...
string DeployInferServiceResponse::ToJsonString() const
{
...
string DeployInferServiceResponse::GetServiceId() const
{
    return m_serviceId;
}

bool DeployInferServiceResponse::ServiceIdHasBeenSet() const
{
