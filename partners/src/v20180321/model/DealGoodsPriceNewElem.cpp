...
CoreInternalOutcome DealGoodsPriceNewElem::Deserialize(const Value &value)
{
    string requestId = "";
...
void DealGoodsPriceNewElem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
