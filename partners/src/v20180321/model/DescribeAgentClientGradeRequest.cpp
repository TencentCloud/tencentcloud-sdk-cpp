...
string DescribeAgentClientGradeRequest::ToJsonString() const
{
...
string DescribeAgentClientGradeRequest::GetClientUin() const
{
    return m_clientUin;
}

void DescribeAgentClientGradeRequest::SetClientUin(const string& _clientUin)
{
    m_clientUin = _clientUin;
    m_clientUinHasBeenSet = true;
}

bool DescribeAgentClientGradeRequest::ClientUinHasBeenSet() const
{
