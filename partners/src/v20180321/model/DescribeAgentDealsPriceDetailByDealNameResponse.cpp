...
DescribeAgentDealsPriceDetailByDealNameResponse::DescribeAgentDealsPriceDetailByDealNameResponse() :
    m_dealListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAgentDealsPriceDetailByDealNameResponse::Deserialize(const string &payload)
{
...
string DescribeAgentDealsPriceDetailByDealNameResponse::ToJsonString() const
{
...
vector<DealPriceDetail> DescribeAgentDealsPriceDetailByDealNameResponse::GetDealList() const
{
    return m_dealList;
}

bool DescribeAgentDealsPriceDetailByDealNameResponse::DealListHasBeenSet() const
{
