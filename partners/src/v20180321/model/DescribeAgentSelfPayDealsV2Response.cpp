...
CoreInternalOutcome DescribeAgentSelfPayDealsV2Response::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AgentPayDealSet") && !rsp["AgentPayDealSet"].IsNull())
    {
        if (!rsp["AgentPayDealSet"].IsArray())
            return CoreInternalOutcome(Error("response `AgentPayDealSet` is not array type"));
...
string DescribeAgentSelfPayDealsV2Response::ToJsonString() const
{
...
vector<AgentDealNewElem> DescribeAgentSelfPayDealsV2Response::GetAgentPayDealSet() const
{
    return m_agentPayDealSet;
}

bool DescribeAgentSelfPayDealsV2Response::AgentPayDealSetHasBeenSet() const
{
    return m_agentPayDealSetHasBeenSet;
}

uint64_t DescribeAgentSelfPayDealsV2Response::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentSelfPayDealsV2Response::TotalCountHasBeenSet() const
{
