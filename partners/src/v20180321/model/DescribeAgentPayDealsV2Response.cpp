...
CoreInternalOutcome DescribeAgentPayDealsV2Response::Deserialize(const string &payload)
{
...
string DescribeAgentPayDealsV2Response::ToJsonString() const
{
...
vector<AgentDealNewElem> DescribeAgentPayDealsV2Response::GetAgentPayDealSet() const
{
    return m_agentPayDealSet;
}

bool DescribeAgentPayDealsV2Response::AgentPayDealSetHasBeenSet() const
{
    return m_agentPayDealSetHasBeenSet;
}

uint64_t DescribeAgentPayDealsV2Response::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentPayDealsV2Response::TotalCountHasBeenSet() const
{
