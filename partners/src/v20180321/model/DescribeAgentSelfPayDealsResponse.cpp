...
CoreInternalOutcome DescribeAgentSelfPayDealsResponse::Deserialize(const string &payload)
{
...
string DescribeAgentSelfPayDealsResponse::ToJsonString() const
{
...
vector<AgentDealElem> DescribeAgentSelfPayDealsResponse::GetAgentPayDealSet() const
{
    return m_agentPayDealSet;
}

bool DescribeAgentSelfPayDealsResponse::AgentPayDealSetHasBeenSet() const
{
    return m_agentPayDealSetHasBeenSet;
}

uint64_t DescribeAgentSelfPayDealsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentSelfPayDealsResponse::TotalCountHasBeenSet() const
{
