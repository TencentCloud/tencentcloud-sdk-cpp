...
DescribeAgentRelateBigDealIdsResponse::DescribeAgentRelateBigDealIdsResponse() :
    m_bigDealIdListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAgentRelateBigDealIdsResponse::Deserialize(const string &payload)
{
...
string DescribeAgentRelateBigDealIdsResponse::ToJsonString() const
{
...
vector<string> DescribeAgentRelateBigDealIdsResponse::GetBigDealIdList() const
{
    return m_bigDealIdList;
}

bool DescribeAgentRelateBigDealIdsResponse::BigDealIdListHasBeenSet() const
{
