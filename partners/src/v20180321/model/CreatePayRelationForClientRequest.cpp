...
string CreatePayRelationForClientRequest::ToJsonString() const
{
...
string CreatePayRelationForClientRequest::GetClientUin() const
{
    return m_clientUin;
}

void CreatePayRelationForClientRequest::SetClientUin(const string& _clientUin)
{
    m_clientUin = _clientUin;
    m_clientUinHasBeenSet = true;
}

bool CreatePayRelationForClientRequest::ClientUinHasBeenSet() const
{
