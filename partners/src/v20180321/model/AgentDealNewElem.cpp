...
CoreInternalOutcome AgentDealNewElem::Deserialize(const Value &value)
{
    string requestId = "";
...
void AgentDealNewElem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
