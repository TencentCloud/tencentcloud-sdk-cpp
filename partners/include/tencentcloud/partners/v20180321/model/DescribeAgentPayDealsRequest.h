...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSREQUEST_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSREQUEST_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentPayDealsRequest : public AbstractModel
                {
                public:
                    DescribeAgentPayDealsRequest();
                    ~DescribeAgentPayDealsRequest() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSREQUEST_H_
