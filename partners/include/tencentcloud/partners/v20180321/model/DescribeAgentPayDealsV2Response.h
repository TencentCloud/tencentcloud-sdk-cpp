...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSV2RESPONSE_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSV2RESPONSE_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentPayDealsV2Response : public AbstractModel
                {
                public:
                    DescribeAgentPayDealsV2Response();
                    ~DescribeAgentPayDealsV2Response() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTPAYDEALSV2RESPONSE_H_
