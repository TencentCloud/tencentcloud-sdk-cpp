...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_REBATEINFOELEM_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_REBATEINFOELEM_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                * 返佣信息定义
                */
                class RebateInfoElem : public AbstractModel
                {
                public:
                    RebateInfoElem();
                    ~RebateInfoElem() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_REBATEINFOELEM_H_
