...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTSELFPAYDEALSREQUEST_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTSELFPAYDEALSREQUEST_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentSelfPayDealsRequest : public AbstractModel
                {
                public:
                    DescribeAgentSelfPayDealsRequest();
                    ~DescribeAgentSelfPayDealsRequest() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTSELFPAYDEALSREQUEST_H_
