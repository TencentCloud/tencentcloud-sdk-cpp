...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTDEALSCACHEREQUEST_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTDEALSCACHEREQUEST_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentDealsCacheRequest : public AbstractModel
                {
                public:
                    DescribeAgentDealsCacheRequest();
                    ~DescribeAgentDealsCacheRequest() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEAGENTDEALSCACHEREQUEST_H_
