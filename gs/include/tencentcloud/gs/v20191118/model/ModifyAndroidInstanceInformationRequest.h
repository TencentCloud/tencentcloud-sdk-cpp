...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCEINFORMATIONREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCEINFORMATIONREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class ModifyAndroidInstanceInformationRequest : public AbstractModel
                {
                public:
                    ModifyAndroidInstanceInformationRequest();
                    ~ModifyAndroidInstanceInformationRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCEINFORMATIONREQUEST_H_
