...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class EnableAndroidInstancesAppRequest : public AbstractModel
                {
                public:
                    EnableAndroidInstancesAppRequest();
                    ~EnableAndroidInstancesAppRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPREQUEST_H_
