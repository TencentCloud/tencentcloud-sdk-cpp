...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPRESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPRESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DisableAndroidInstancesAppResponse : public AbstractModel
                {
                public:
                    DisableAndroidInstancesAppResponse();
                    ~DisableAndroidInstancesAppResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPRESPONSE_H_
