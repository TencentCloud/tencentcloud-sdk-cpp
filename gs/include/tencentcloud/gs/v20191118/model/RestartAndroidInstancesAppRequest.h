...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_RESTARTANDROIDINSTANCESAPPREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_RESTARTANDROIDINSTANCESAPPREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class RestartAndroidInstancesAppRequest : public AbstractModel
                {
                public:
                    RestartAndroidInstancesAppRequest();
                    ~RestartAndroidInstancesAppRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_RESTARTANDROIDINSTANCESAPPREQUEST_H_
