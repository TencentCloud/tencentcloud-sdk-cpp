...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCETASK_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCETASK_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                * 安卓实例任务信息
                */
                class AndroidInstanceTask : public AbstractModel
                {
                public:
                    AndroidInstanceTask();
                    ~AndroidInstanceTask() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCETASK_H_
