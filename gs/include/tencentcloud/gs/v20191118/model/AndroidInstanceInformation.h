...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCEINFORMATION_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCEINFORMATION_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                * 安卓实例信息
                */
                class AndroidInstanceInformation : public AbstractModel
                {
                public:
                    AndroidInstanceInformation();
                    ~AndroidInstanceInformation() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_ANDROIDINSTANCEINFORMATION_H_
