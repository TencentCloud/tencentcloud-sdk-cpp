...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DESTROYANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DESTROYANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DestroyAndroidInstancesRequest : public AbstractModel
                {
                public:
                    DestroyAndroidInstancesRequest();
                    ~DestroyAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DESTROYANDROIDINSTANCESREQUEST_H_
