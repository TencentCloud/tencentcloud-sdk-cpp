...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESAPPREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESAPPREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class StopAndroidInstancesAppRequest : public AbstractModel
                {
                public:
                    StopAndroidInstancesAppRequest();
                    ~StopAndroidInstancesAppRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESAPPREQUEST_H_
