...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_IMPORTANDROIDINSTANCEIMAGERESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_IMPORTANDROIDINSTANCEIMAGERESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class ImportAndroidInstanceImageResponse : public AbstractModel
                {
                public:
                    ImportAndroidInstanceImageResponse();
                    ~ImportAndroidInstanceImageResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_IMPORTANDROIDINSTANCEIMAGERESPONSE_H_
