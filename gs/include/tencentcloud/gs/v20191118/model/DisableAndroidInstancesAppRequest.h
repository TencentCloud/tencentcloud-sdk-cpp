...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DisableAndroidInstancesAppRequest : public AbstractModel
                {
                public:
                    DisableAndroidInstancesAppRequest();
                    ~DisableAndroidInstancesAppRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DISABLEANDROIDINSTANCESAPPREQUEST_H_
