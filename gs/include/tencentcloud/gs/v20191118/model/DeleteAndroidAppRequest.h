...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DELETEANDROIDAPPREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DELETEANDROIDAPPREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DeleteAndroidAppRequest : public AbstractModel
                {
                public:
                    DeleteAndroidAppRequest();
                    ~DeleteAndroidAppRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DELETEANDROIDAPPREQUEST_H_
