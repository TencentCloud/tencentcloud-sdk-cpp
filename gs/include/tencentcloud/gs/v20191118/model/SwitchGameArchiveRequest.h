...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_SWITCHGAMEARCHIVEREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_SWITCHGAMEARCHIVEREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class SwitchGameArchiveRequest : public AbstractModel
                {
                public:
                    SwitchGameArchiveRequest();
                    ~SwitchGameArchiveRequest() = default;
                ...
                private:
                     ...
                     * 游戏存档Url
                     */
                    std::string m_gameArchiveUrl;
                    bool m_gameArchiveUrlHasBeenSet;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_SWITCHGAMEARCHIVEREQUEST_H_
