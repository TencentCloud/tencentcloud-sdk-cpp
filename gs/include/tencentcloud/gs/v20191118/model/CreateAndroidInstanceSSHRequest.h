...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSHREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSHREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CreateAndroidInstanceSSHRequest : public AbstractModel
                {
                public:
                    CreateAndroidInstanceSSHRequest();
                    ~CreateAndroidInstanceSSHRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSHREQUEST_H_
