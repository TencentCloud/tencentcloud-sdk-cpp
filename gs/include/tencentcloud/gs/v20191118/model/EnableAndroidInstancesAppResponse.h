...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPRESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPRESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class EnableAndroidInstancesAppResponse : public AbstractModel
                {
                public:
                    EnableAndroidInstancesAppResponse();
                    ~EnableAndroidInstancesAppResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_ENABLEANDROIDINSTANCESAPPRESPONSE_H_
