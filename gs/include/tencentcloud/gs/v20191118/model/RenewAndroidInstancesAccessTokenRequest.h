...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_RENEWANDROIDINSTANCESACCESSTOKENREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_RENEWANDROIDINSTANCESACCESSTOKENREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class RenewAndroidInstancesAccessTokenRequest : public AbstractModel
                {
                public:
                    RenewAndroidInstancesAccessTokenRequest();
                    ~RenewAndroidInstancesAccessTokenRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_RENEWANDROIDINSTANCESACCESSTOKENREQUEST_H_
