...
StartAndroidInstancesRequest::StartAndroidInstancesRequest() :
    m_androidInstanceIdsHasBeenSet(false)
{
}

string StartAndroidInstancesRequest::ToJsonString() const
{
...
vector<string> StartAndroidInstancesRequest::GetAndroidInstanceIds() const
{
    return m_androidInstanceIds;
}

void StartAndroidInstancesRequest::SetAndroidInstanceIds(const vector<string>& _androidInstanceIds)
{
    m_androidInstanceIds = _androidInstanceIds;
    m_androidInstanceIdsHasBeenSet = true;
}

bool StartAndroidInstancesRequest::AndroidInstanceIdsHasBeenSet() const
{
