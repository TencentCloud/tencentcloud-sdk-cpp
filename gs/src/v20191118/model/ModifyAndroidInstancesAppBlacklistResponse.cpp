...
ModifyAndroidInstancesAppBlacklistResponse::ModifyAndroidInstancesAppBlacklistResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAndroidInstancesAppBlacklistResponse::Deserialize(const string &payload)
{
...
string ModifyAndroidInstancesAppBlacklistResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> ModifyAndroidInstancesAppBlacklistResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool ModifyAndroidInstancesAppBlacklistResponse::TaskSetHasBeenSet() const
{
