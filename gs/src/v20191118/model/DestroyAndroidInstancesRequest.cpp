...
DestroyAndroidInstancesRequest::DestroyAndroidInstancesRequest() :
    m_androidInstanceIdsHasBeenSet(false)
{
}

string DestroyAndroidInstancesRequest::ToJsonString() const
{
...
vector<string> DestroyAndroidInstancesRequest::GetAndroidInstanceIds() const
{
    return m_androidInstanceIds;
}

void DestroyAndroidInstancesRequest::SetAndroidInstanceIds(const vector<string>& _androidInstanceIds)
{
    m_androidInstanceIds = _androidInstanceIds;
    m_androidInstanceIdsHasBeenSet = true;
}

bool DestroyAndroidInstancesRequest::AndroidInstanceIdsHasBeenSet() const
{
