...
BackUpAndroidInstanceResponse::BackUpAndroidInstanceResponse() :
    m_backupIdHasBeenSet(false)
{
}

CoreInternalOutcome BackUpAndroidInstanceResponse::Deserialize(const string &payload)
{
...
string BackUpAndroidInstanceResponse::ToJsonString() const
{
...
string BackUpAndroidInstanceResponse::GetBackupId() const
{
    return m_backupId;
}

bool BackUpAndroidInstanceResponse::BackupIdHasBeenSet() const
{
