...
RebootAndroidInstancesResponse::RebootAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome RebootAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string RebootAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> RebootAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool RebootAndroidInstancesResponse::TaskSetHasBeenSet() const
{
