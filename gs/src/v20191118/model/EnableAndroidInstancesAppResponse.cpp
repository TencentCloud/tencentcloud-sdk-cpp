...
EnableAndroidInstancesAppResponse::EnableAndroidInstancesAppResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome EnableAndroidInstancesAppResponse::Deserialize(const string &payload)
{
...
string EnableAndroidInstancesAppResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> EnableAndroidInstancesAppResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool EnableAndroidInstancesAppResponse::AndroidInstanceErrorsHasBeenSet() const
{
