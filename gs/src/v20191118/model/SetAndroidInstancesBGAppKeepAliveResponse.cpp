...
SetAndroidInstancesBGAppKeepAliveResponse::SetAndroidInstancesBGAppKeepAliveResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome SetAndroidInstancesBGAppKeepAliveResponse::Deserialize(const string &payload)
{
...
string SetAndroidInstancesBGAppKeepAliveResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> SetAndroidInstancesBGAppKeepAliveResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool SetAndroidInstancesBGAppKeepAliveResponse::AndroidInstanceErrorsHasBeenSet() const
{
