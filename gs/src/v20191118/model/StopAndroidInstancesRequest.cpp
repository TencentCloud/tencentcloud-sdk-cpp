...
StopAndroidInstancesRequest::StopAndroidInstancesRequest() :
    m_androidInstanceIdsHasBeenSet(false)
{
}

string StopAndroidInstancesRequest::ToJsonString() const
{
...
vector<string> StopAndroidInstancesRequest::GetAndroidInstanceIds() const
{
    return m_androidInstanceIds;
}

void StopAndroidInstancesRequest::SetAndroidInstanceIds(const vector<string>& _androidInstanceIds)
{
    m_androidInstanceIds = _androidInstanceIds;
    m_androidInstanceIdsHasBeenSet = true;
}

bool StopAndroidInstancesRequest::AndroidInstanceIdsHasBeenSet() const
{
