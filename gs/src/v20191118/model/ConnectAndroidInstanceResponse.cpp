...
ConnectAndroidInstanceResponse::ConnectAndroidInstanceResponse() :
    m_serverSessionHasBeenSet(false)
{
}

CoreInternalOutcome ConnectAndroidInstanceResponse::Deserialize(const string &payload)
{
...
string ConnectAndroidInstanceResponse::ToJsonString() const
{
...
string ConnectAndroidInstanceResponse::GetServerSession() const
{
    return m_serverSession;
}

bool ConnectAndroidInstanceResponse::ServerSessionHasBeenSet() const
{
