...
DistributePhotoToAndroidInstancesResponse::DistributePhotoToAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome DistributePhotoToAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string DistributePhotoToAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> DistributePhotoToAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool DistributePhotoToAndroidInstancesResponse::TaskSetHasBeenSet() const
{
