...
DistributeFileToAndroidInstancesResponse::DistributeFileToAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome DistributeFileToAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string DistributeFileToAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> DistributeFileToAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool DistributeFileToAndroidInstancesResponse::TaskSetHasBeenSet() const
{
