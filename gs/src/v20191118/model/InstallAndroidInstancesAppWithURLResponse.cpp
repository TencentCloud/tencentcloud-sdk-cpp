...
InstallAndroidInstancesAppWithURLResponse::InstallAndroidInstancesAppWithURLResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome InstallAndroidInstancesAppWithURLResponse::Deserialize(const string &payload)
{
...
string InstallAndroidInstancesAppWithURLResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> InstallAndroidInstancesAppWithURLResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool InstallAndroidInstancesAppWithURLResponse::TaskSetHasBeenSet() const
{
