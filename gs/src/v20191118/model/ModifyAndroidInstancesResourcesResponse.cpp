...
ModifyAndroidInstancesResourcesResponse::ModifyAndroidInstancesResourcesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAndroidInstancesResourcesResponse::Deserialize(const string &payload)
{
...
string ModifyAndroidInstancesResourcesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> ModifyAndroidInstancesResourcesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool ModifyAndroidInstancesResourcesResponse::TaskSetHasBeenSet() const
{
