...
CoreInternalOutcome CreateAndroidInstanceAcceleratorTokenResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["AcceleratorInfo"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `AcceleratorInfo` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_acceleratorInfo = string(rsp["AcceleratorInfo"].GetString());
        m_acceleratorInfoHasBeenSet = true;
    }
...
string CreateAndroidInstanceAcceleratorTokenResponse::ToJsonString() const
{
    ...
    if (m_acceleratorInfoHasBeenSet)
    {
        ...
        string key = "AcceleratorInfo";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_acceleratorInfo.c_str(), allocator).Move(), allocator);
    }
...
{
    return m_acceleratorInfo;
}

bool CreateAndroidInstanceAcceleratorTokenResponse::AcceleratorInfoHasBeenSet() const
{
    return m_acceleratorInfoHasBeenSet;
}

vector<AndroidInstanceError> CreateAndroidInstanceAcceleratorTokenResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool CreateAndroidInstanceAcceleratorTokenResponse::AndroidInstanceErrorsHasBeenSet() const
{
