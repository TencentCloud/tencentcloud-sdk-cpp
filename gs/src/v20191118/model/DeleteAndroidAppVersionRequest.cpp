...
DeleteAndroidAppVersionRequest::DeleteAndroidAppVersionRequest() :
    m_androidAppIdHasBeenSet(false),
    m_androidAppVersionHasBeenSet(false)
{
}

string DeleteAndroidAppVersionRequest::ToJsonString() const
{
...
string DeleteAndroidAppVersionRequest::GetAndroidAppId() const
{
    return m_androidAppId;
}

void DeleteAndroidAppVersionRequest::SetAndroidAppId(const string& _androidAppId)
{
    m_androidAppId = _androidAppId;
    m_androidAppIdHasBeenSet = true;
}

bool DeleteAndroidAppVersionRequest::AndroidAppIdHasBeenSet() const
{
    return m_androidAppIdHasBeenSet;
}

string DeleteAndroidAppVersionRequest::GetAndroidAppVersion() const
{
    return m_androidAppVersion;
}

void DeleteAndroidAppVersionRequest::SetAndroidAppVersion(const string& _androidAppVersion)
{
    m_androidAppVersion = _androidAppVersion;
    m_androidAppVersionHasBeenSet = true;
}

bool DeleteAndroidAppVersionRequest::AndroidAppVersionHasBeenSet() const
{
