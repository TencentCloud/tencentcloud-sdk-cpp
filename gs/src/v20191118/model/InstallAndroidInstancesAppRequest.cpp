...
string InstallAndroidInstancesAppRequest::ToJsonString() const
{
...
vector<string> InstallAndroidInstancesAppRequest::GetAndroidInstanceIds() const
{
    return m_androidInstanceIds;
}

void InstallAndroidInstancesAppRequest::SetAndroidInstanceIds(const vector<string>& _androidInstanceIds)
{
    m_androidInstanceIds = _androidInstanceIds;
    m_androidInstanceIdsHasBeenSet = true;
}

bool InstallAndroidInstancesAppRequest::AndroidInstanceIdsHasBeenSet() const
{
    return m_androidInstanceIdsHasBeenSet;
}

string InstallAndroidInstancesAppRequest::GetAndroidAppId() const
{
    return m_androidAppId;
}

void InstallAndroidInstancesAppRequest::SetAndroidAppId(const string& _androidAppId)
{
    m_androidAppId = _androidAppId;
    m_androidAppIdHasBeenSet = true;
}

bool InstallAndroidInstancesAppRequest::AndroidAppIdHasBeenSet() const
{
    return m_androidAppIdHasBeenSet;
}

string InstallAndroidInstancesAppRequest::GetAndroidAppVersion() const
{
    return m_androidAppVersion;
}

void InstallAndroidInstancesAppRequest::SetAndroidAppVersion(const string& _androidAppVersion)
{
