...
StopAndroidInstancesResponse::StopAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome StopAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string StopAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> StopAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool StopAndroidInstancesResponse::TaskSetHasBeenSet() const
{
