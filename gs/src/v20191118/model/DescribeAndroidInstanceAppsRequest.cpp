...
DescribeAndroidInstanceAppsRequest::DescribeAndroidInstanceAppsRequest() :
    m_androidInstanceIdHasBeenSet(false)
{
}

string DescribeAndroidInstanceAppsRequest::ToJsonString() const
{
...
string DescribeAndroidInstanceAppsRequest::GetAndroidInstanceId() const
{
    return m_androidInstanceId;
}

void DescribeAndroidInstanceAppsRequest::SetAndroidInstanceId(const string& _androidInstanceId)
{
    m_androidInstanceId = _androidInstanceId;
    m_androidInstanceIdHasBeenSet = true;
}

bool DescribeAndroidInstanceAppsRequest::AndroidInstanceIdHasBeenSet() const
{
