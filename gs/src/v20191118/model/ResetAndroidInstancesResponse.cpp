...
ResetAndroidInstancesResponse::ResetAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome ResetAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string ResetAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> ResetAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool ResetAndroidInstancesResponse::TaskSetHasBeenSet() const
{
