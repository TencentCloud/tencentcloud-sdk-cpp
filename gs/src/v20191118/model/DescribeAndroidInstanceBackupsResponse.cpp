...
CoreInternalOutcome DescribeAndroidInstanceBackupsResponse::Deserialize(const string &payload)
{
...
string DescribeAndroidInstanceBackupsResponse::ToJsonString() const
{
