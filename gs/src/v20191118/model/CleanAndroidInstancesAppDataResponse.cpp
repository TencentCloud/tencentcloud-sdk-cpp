...
CleanAndroidInstancesAppDataResponse::CleanAndroidInstancesAppDataResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome CleanAndroidInstancesAppDataResponse::Deserialize(const string &payload)
{
...
string CleanAndroidInstancesAppDataResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> CleanAndroidInstancesAppDataResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool CleanAndroidInstancesAppDataResponse::AndroidInstanceErrorsHasBeenSet() const
{
