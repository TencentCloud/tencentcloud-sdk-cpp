...
UninstallAndroidInstancesAppResponse::UninstallAndroidInstancesAppResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome UninstallAndroidInstancesAppResponse::Deserialize(const string &payload)
{
...
string UninstallAndroidInstancesAppResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> UninstallAndroidInstancesAppResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool UninstallAndroidInstancesAppResponse::TaskSetHasBeenSet() const
{
