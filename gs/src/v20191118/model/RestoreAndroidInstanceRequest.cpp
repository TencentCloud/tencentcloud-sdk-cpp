...
RestoreAndroidInstanceRequest::RestoreAndroidInstanceRequest() :
    m_androidInstanceIdHasBeenSet(false),
    m_backupIdHasBeenSet(false)
{
}

string RestoreAndroidInstanceRequest::ToJsonString() const
{
...
string RestoreAndroidInstanceRequest::GetAndroidInstanceId() const
{
    return m_androidInstanceId;
}

void RestoreAndroidInstanceRequest::SetAndroidInstanceId(const string& _androidInstanceId)
{
    m_androidInstanceId = _androidInstanceId;
    m_androidInstanceIdHasBeenSet = true;
}

bool RestoreAndroidInstanceRequest::AndroidInstanceIdHasBeenSet() const
{
    return m_androidInstanceIdHasBeenSet;
}

string RestoreAndroidInstanceRequest::GetBackupId() const
{
    return m_backupId;
}

void RestoreAndroidInstanceRequest::SetBackupId(const string& _backupId)
{
    m_backupId = _backupId;
    m_backupIdHasBeenSet = true;
}

bool RestoreAndroidInstanceRequest::BackupIdHasBeenSet() const
{
