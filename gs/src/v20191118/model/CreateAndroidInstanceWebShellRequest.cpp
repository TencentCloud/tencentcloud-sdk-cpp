...
CreateAndroidInstanceWebShellRequest::CreateAndroidInstanceWebShellRequest() :
    m_androidInstanceIdHasBeenSet(false)
{
}

string CreateAndroidInstanceWebShellRequest::ToJsonString() const
{
...
string CreateAndroidInstanceWebShellRequest::GetAndroidInstanceId() const
{
    return m_androidInstanceId;
}

void CreateAndroidInstanceWebShellRequest::SetAndroidInstanceId(const string& _androidInstanceId)
{
    m_androidInstanceId = _androidInstanceId;
    m_androidInstanceIdHasBeenSet = true;
}

bool CreateAndroidInstanceWebShellRequest::AndroidInstanceIdHasBeenSet() const
{
