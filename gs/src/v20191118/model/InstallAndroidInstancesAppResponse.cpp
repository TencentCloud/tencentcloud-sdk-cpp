...
InstallAndroidInstancesAppResponse::InstallAndroidInstancesAppResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome InstallAndroidInstancesAppResponse::Deserialize(const string &payload)
{
...
string InstallAndroidInstancesAppResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> InstallAndroidInstancesAppResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool InstallAndroidInstancesAppResponse::TaskSetHasBeenSet() const
{
