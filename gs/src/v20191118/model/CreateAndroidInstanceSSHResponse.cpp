...
CreateAndroidInstanceSSHResponse::CreateAndroidInstanceSSHResponse() :
...
CoreInternalOutcome CreateAndroidInstanceSSHResponse::Deserialize(const string &payload)
{
...
string CreateAndroidInstanceSSHResponse::ToJsonString() const
{
...
string CreateAndroidInstanceSSHResponse::GetPrivateKey() const
{
    return m_privateKey;
}

bool CreateAndroidInstanceSSHResponse::PrivateKeyHasBeenSet() const
{
    return m_privateKeyHasBeenSet;
}

string CreateAndroidInstanceSSHResponse::GetUserName() const
{
    return m_userName;
}

bool CreateAndroidInstanceSSHResponse::UserNameHasBeenSet() const
{
    return m_userNameHasBeenSet;
}

string CreateAndroidInstanceSSHResponse::GetHostName() const
{
    return m_hostName;
}

bool CreateAndroidInstanceSSHResponse::HostNameHasBeenSet() const
{
    return m_hostNameHasBeenSet;
}

int64_t CreateAndroidInstanceSSHResponse::GetPort() const
{
    return m_port;
}

bool CreateAndroidInstanceSSHResponse::PortHasBeenSet() const
{
    return m_portHasBeenSet;
}

string CreateAndroidInstanceSSHResponse::GetConnectCommand() const
{
    return m_connectCommand;
}

bool CreateAndroidInstanceSSHResponse::ConnectCommandHasBeenSet() const
{
