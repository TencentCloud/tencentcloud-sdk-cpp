...
UploadFileToAndroidInstancesResponse::UploadFileToAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome UploadFileToAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string UploadFileToAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> UploadFileToAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool UploadFileToAndroidInstancesResponse::TaskSetHasBeenSet() const
{
