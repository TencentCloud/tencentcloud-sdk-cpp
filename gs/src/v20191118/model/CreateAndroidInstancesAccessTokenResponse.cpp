...
CreateAndroidInstancesAccessTokenResponse::CreateAndroidInstancesAccessTokenResponse() :
...
CoreInternalOutcome CreateAndroidInstancesAccessTokenResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["AccessInfo"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `AccessInfo` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_accessInfo = string(rsp["AccessInfo"].GetString());
...
string CreateAndroidInstancesAccessTokenResponse::ToJsonString() const
{
...
string CreateAndroidInstancesAccessTokenResponse::GetToken() const
{
    return m_token;
}

bool CreateAndroidInstancesAccessTokenResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string CreateAndroidInstancesAccessTokenResponse::GetAccessInfo() const
{
    return m_accessInfo;
}

bool CreateAndroidInstancesAccessTokenResponse::AccessInfoHasBeenSet() const
{
    return m_accessInfoHasBeenSet;
}

vector<AndroidInstanceError> CreateAndroidInstancesAccessTokenResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool CreateAndroidInstancesAccessTokenResponse::AndroidInstanceErrorsHasBeenSet() const
{
