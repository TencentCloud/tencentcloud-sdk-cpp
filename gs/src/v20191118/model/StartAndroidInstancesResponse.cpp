...
StartAndroidInstancesResponse::StartAndroidInstancesResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome StartAndroidInstancesResponse::Deserialize(const string &payload)
{
...
string StartAndroidInstancesResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> StartAndroidInstancesResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool StartAndroidInstancesResponse::TaskSetHasBeenSet() const
{
