...
DisconnectAndroidInstanceRequest::DisconnectAndroidInstanceRequest() :
    m_androidInstanceIdHasBeenSet(false)
{
}

string DisconnectAndroidInstanceRequest::ToJsonString() const
{
...
string DisconnectAndroidInstanceRequest::GetAndroidInstanceId() const
{
    return m_androidInstanceId;
}

void DisconnectAndroidInstanceRequest::SetAndroidInstanceId(const string& _androidInstanceId)
{
    m_androidInstanceId = _androidInstanceId;
    m_androidInstanceIdHasBeenSet = true;
}

bool DisconnectAndroidInstanceRequest::AndroidInstanceIdHasBeenSet() const
{
