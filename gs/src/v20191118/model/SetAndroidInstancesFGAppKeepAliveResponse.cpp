...
SetAndroidInstancesFGAppKeepAliveResponse::SetAndroidInstancesFGAppKeepAliveResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome SetAndroidInstancesFGAppKeepAliveResponse::Deserialize(const string &payload)
{
...
string SetAndroidInstancesFGAppKeepAliveResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> SetAndroidInstancesFGAppKeepAliveResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool SetAndroidInstancesFGAppKeepAliveResponse::AndroidInstanceErrorsHasBeenSet() const
{
