...
CreateAndroidInstancesScreenshotResponse::CreateAndroidInstancesScreenshotResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome CreateAndroidInstancesScreenshotResponse::Deserialize(const string &payload)
{
...
string CreateAndroidInstancesScreenshotResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> CreateAndroidInstancesScreenshotResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool CreateAndroidInstancesScreenshotResponse::TaskSetHasBeenSet() const
{
