...
RebootAndroidInstanceHostsResponse::RebootAndroidInstanceHostsResponse() :
    m_taskSetHasBeenSet(false)
{
}

CoreInternalOutcome RebootAndroidInstanceHostsResponse::Deserialize(const string &payload)
{
...
string RebootAndroidInstanceHostsResponse::ToJsonString() const
{
...
vector<AndroidInstanceTask> RebootAndroidInstanceHostsResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool RebootAndroidInstanceHostsResponse::TaskSetHasBeenSet() const
{
