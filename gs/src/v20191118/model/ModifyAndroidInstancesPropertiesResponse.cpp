...
ModifyAndroidInstancesPropertiesResponse::ModifyAndroidInstancesPropertiesResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAndroidInstancesPropertiesResponse::Deserialize(const string &payload)
{
...
string ModifyAndroidInstancesPropertiesResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> ModifyAndroidInstancesPropertiesResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool ModifyAndroidInstancesPropertiesResponse::AndroidInstanceErrorsHasBeenSet() const
{
