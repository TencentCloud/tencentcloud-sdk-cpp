...
DisableAndroidInstancesAppResponse::DisableAndroidInstancesAppResponse() :
    m_androidInstanceErrorsHasBeenSet(false)
{
}

CoreInternalOutcome DisableAndroidInstancesAppResponse::Deserialize(const string &payload)
{
...
string DisableAndroidInstancesAppResponse::ToJsonString() const
{
...
vector<AndroidInstanceError> DisableAndroidInstancesAppResponse::GetAndroidInstanceErrors() const
{
    return m_androidInstanceErrors;
}

bool DisableAndroidInstancesAppResponse::AndroidInstanceErrorsHasBeenSet() const
{
