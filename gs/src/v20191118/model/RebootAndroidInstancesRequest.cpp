...
RebootAndroidInstancesRequest::RebootAndroidInstancesRequest() :
    m_androidInstanceIdsHasBeenSet(false)
{
}

string RebootAndroidInstancesRequest::ToJsonString() const
{
...
vector<string> RebootAndroidInstancesRequest::GetAndroidInstanceIds() const
{
    return m_androidInstanceIds;
}

void RebootAndroidInstancesRequest::SetAndroidInstanceIds(const vector<string>& _androidInstanceIds)
{
    m_androidInstanceIds = _androidInstanceIds;
    m_androidInstanceIdsHasBeenSet = true;
}

bool RebootAndroidInstancesRequest::AndroidInstanceIdsHasBeenSet() const
{
