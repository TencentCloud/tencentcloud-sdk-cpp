...
string DescribeExecutionRequest::ToJsonString() const
{
...
string DescribeExecutionRequest::GetExecutionResourceName() const
{
    return m_executionResourceName;
}

void DescribeExecutionRequest::SetExecutionResourceName(const string& _executionResourceName)
{
    m_executionResourceName = _executionResourceName;
    m_executionResourceNameHasBeenSet = true;
}

bool DescribeExecutionRequest::ExecutionResourceNameHasBeenSet() const
{
