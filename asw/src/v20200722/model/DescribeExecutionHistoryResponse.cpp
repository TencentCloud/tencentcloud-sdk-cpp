...
CoreInternalOutcome DescribeExecutionHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeExecutionHistoryResponse::ToJsonString() const
{
...
vector<ExecutionEvent> DescribeExecutionHistoryResponse::GetEvents() const
{
    return m_events;
}

bool DescribeExecutionHistoryResponse::EventsHasBeenSet() const
{
