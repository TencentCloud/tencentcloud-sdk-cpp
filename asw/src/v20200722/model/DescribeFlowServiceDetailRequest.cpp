...
string DescribeFlowServiceDetailRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_flowServiceResourceHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_flowServiceResource.c_str(), allocator).Move(), allocator);
    }
...
string DescribeFlowServiceDetailRequest::GetFlowServiceResource() const
{
    return m_flowServiceResource;
}

void DescribeFlowServiceDetailRequest::SetFlowServiceResource(const string& _flowServiceResource)
{
    m_flowServiceResource = _flowServiceResource;
    m_flowServiceResourceHasBeenSet = true;
}

bool DescribeFlowServiceDetailRequest::FlowServiceResourceHasBeenSet() const
{
