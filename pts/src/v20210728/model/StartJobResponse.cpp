...
CoreInternalOutcome StartJobResponse::Deserialize(const string &payload)
{
...
string StartJobResponse::ToJsonString() const
{
...
string StartJobResponse::GetJobId() const
{
    return m_jobId;
}

bool StartJobResponse::JobIdHasBeenSet() const
{
