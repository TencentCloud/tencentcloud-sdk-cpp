...
CoreInternalOutcome GenerateTmpKeyResponse::Deserialize(const string &payload)
{
...
string GenerateTmpKeyResponse::ToJsonString() const
{
...
int64_t GenerateTmpKeyResponse::GetStartTime() const
{
    return m_startTime;
}

bool GenerateTmpKeyResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

int64_t GenerateTmpKeyResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool GenerateTmpKeyResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

Credentials GenerateTmpKeyResponse::GetCredentials() const
{
    return m_credentials;
}

bool GenerateTmpKeyResponse::CredentialsHasBeenSet() const
{
