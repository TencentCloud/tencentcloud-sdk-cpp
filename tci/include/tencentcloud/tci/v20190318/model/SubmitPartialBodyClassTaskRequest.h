...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitPartialBodyClassTaskRequest : public AbstractModel
                {
                public:
                    SubmitPartialBodyClassTaskRequest();
                    ~SubmitPartialBodyClassTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKREQUEST_H_
