...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_DELETEVOCABLIBREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_DELETEVOCABLIBREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class DeleteVocabLibRequest : public AbstractModel
                {
                public:
                    DeleteVocabLibRequest();
                    ~DeleteVocabLibRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_DELETEVOCABLIBREQUEST_H_
