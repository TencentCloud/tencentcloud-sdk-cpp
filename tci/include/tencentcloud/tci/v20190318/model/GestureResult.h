...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_GESTURERESULT_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_GESTURERESULT_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                * GestureResult
                */
                class GestureResult : public AbstractModel
                {
                public:
                    GestureResult();
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_GESTURERESULT_H_
