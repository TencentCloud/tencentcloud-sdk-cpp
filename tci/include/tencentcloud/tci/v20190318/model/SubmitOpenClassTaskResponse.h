...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITOPENCLASSTASKRESPONSE_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITOPENCLASSTASKRESPONSE_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitOpenClassTaskResponse : public AbstractModel
                {
                public:
                    SubmitOpenClassTaskResponse();
                    ~SubmitOpenClassTaskResponse() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITOPENCLASSTASKRESPONSE_H_
