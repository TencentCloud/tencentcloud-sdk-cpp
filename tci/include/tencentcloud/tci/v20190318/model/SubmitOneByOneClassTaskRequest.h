...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITONEBYONECLASSTASKREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITONEBYONECLASSTASKREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitOneByOneClassTaskRequest : public AbstractModel
                {
                public:
                    SubmitOneByOneClassTaskRequest();
                    ~SubmitOneByOneClassTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITONEBYONECLASSTASKREQUEST_H_
