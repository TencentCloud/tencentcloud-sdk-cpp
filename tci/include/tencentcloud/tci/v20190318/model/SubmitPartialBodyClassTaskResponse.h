...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKRESPONSE_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKRESPONSE_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitPartialBodyClassTaskResponse : public AbstractModel
                {
                public:
                    SubmitPartialBodyClassTaskResponse();
                    ~SubmitPartialBodyClassTaskResponse() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITPARTIALBODYCLASSTASKRESPONSE_H_
