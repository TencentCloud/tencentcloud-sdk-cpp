...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitImageTaskRequest : public AbstractModel
                {
                public:
                    SubmitImageTaskRequest();
                    ~SubmitImageTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKREQUEST_H_
