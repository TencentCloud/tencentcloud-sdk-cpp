...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEVOCABREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEVOCABREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class DescribeVocabRequest : public AbstractModel
                {
                public:
                    DescribeVocabRequest();
                    ~DescribeVocabRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEVOCABREQUEST_H_
