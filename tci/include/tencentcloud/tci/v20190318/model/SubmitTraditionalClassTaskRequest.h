...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITTRADITIONALCLASSTASKREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITTRADITIONALCLASSTASKREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitTraditionalClassTaskRequest : public AbstractModel
                {
                public:
                    SubmitTraditionalClassTaskRequest();
                    ~SubmitTraditionalClassTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITTRADITIONALCLASSTASKREQUEST_H_
