...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKRESPONSE_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKRESPONSE_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class SubmitImageTaskResponse : public AbstractModel
                {
                public:
                    SubmitImageTaskResponse();
                    ~SubmitImageTaskResponse() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_SUBMITIMAGETASKRESPONSE_H_
