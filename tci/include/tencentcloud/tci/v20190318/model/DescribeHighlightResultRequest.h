...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEHIGHLIGHTRESULTREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEHIGHLIGHTRESULTREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class DescribeHighlightResultRequest : public AbstractModel
                {
                public:
                    DescribeHighlightResultRequest();
                    ~DescribeHighlightResultRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBEHIGHLIGHTRESULTREQUEST_H_
