...
#ifndef TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBECONVERSATIONTASKREQUEST_H_
#define TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBECONVERSATIONTASKREQUEST_H_
    ...
    namespace Tci
    {
        namespace V20190318
        {
            namespace Model
            {
                ...
                */
                class DescribeConversationTaskRequest : public AbstractModel
                {
                public:
                    DescribeConversationTaskRequest();
                    ~DescribeConversationTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TCI_V20190318_MODEL_DESCRIBECONVERSATIONTASKREQUEST_H_
