...
CoreInternalOutcome SubmitConversationTaskResponse::Deserialize(const string &payload)
{
...
string SubmitConversationTaskResponse::ToJsonString() const
{
...
int64_t SubmitConversationTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitConversationTaskResponse::JobIdHasBeenSet() const
{
