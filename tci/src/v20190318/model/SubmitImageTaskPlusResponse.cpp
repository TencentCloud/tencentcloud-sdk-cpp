...
CoreInternalOutcome SubmitImageTaskPlusResponse::Deserialize(const string &payload)
{
...
string SubmitImageTaskPlusResponse::ToJsonString() const
{
...
vector<ImageTaskResult> SubmitImageTaskPlusResponse::GetResultSet() const
{
    return m_resultSet;
}

bool SubmitImageTaskPlusResponse::ResultSetHasBeenSet() const
{
    return m_resultSetHasBeenSet;
}

int64_t SubmitImageTaskPlusResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitImageTaskPlusResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

int64_t SubmitImageTaskPlusResponse::GetProgress() const
{
    return m_progress;
}

bool SubmitImageTaskPlusResponse::ProgressHasBeenSet() const
{
    return m_progressHasBeenSet;
}

int64_t SubmitImageTaskPlusResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SubmitImageTaskPlusResponse::TotalCountHasBeenSet() const
{
