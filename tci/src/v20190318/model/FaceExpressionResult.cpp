...
CoreInternalOutcome FaceExpressionResult::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Confidence") && !value["Confidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FaceExpressionResult.Confidence` IsDouble=false incorrectly").SetRequestId(requestId));
        }
...
void FaceExpressionResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
