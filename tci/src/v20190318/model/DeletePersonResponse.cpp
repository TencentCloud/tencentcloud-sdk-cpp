...
vector<FaceInfo> DeletePersonResponse::GetFaceInfoSet() const
{
    return m_faceInfoSet;
}

bool DeletePersonResponse::FaceInfoSetHasBeenSet() const
{
    return m_faceInfoSetHasBeenSet;
}

string DeletePersonResponse::GetLibraryId() const
{
    return m_libraryId;
}

bool DeletePersonResponse::LibraryIdHasBeenSet() const
{
    return m_libraryIdHasBeenSet;
}

string DeletePersonResponse::GetPersonId() const
{
    return m_personId;
}

bool DeletePersonResponse::PersonIdHasBeenSet() const
{
    return m_personIdHasBeenSet;
}

string DeletePersonResponse::GetPersonName() const
{
    return m_personName;
}

bool DeletePersonResponse::PersonNameHasBeenSet() const
{
