...
CoreInternalOutcome ActionCountStatistic::Deserialize(const Value &value)
{
    string requestId = "";
...
void ActionCountStatistic::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
