...
CoreInternalOutcome StandardImageResult::Deserialize(const Value &value)
{
    string requestId = "";
...
void StandardImageResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
