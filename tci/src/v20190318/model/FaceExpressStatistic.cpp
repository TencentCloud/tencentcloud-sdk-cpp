...
CoreInternalOutcome FaceExpressStatistic::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ExpressRatio") && !value["ExpressRatio"].IsNull())
    {
        ...
        const Value &tmpValue = value["ExpressRatio"];
...
void FaceExpressStatistic::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
