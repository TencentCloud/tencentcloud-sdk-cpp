...
string SubmitFullBodyClassTaskRequest::ToJsonString() const
{
...
string SubmitFullBodyClassTaskRequest::GetFileContent() const
{
    return m_fileContent;
}

void SubmitFullBodyClassTaskRequest::SetFileContent(const string& _fileContent)
{
    m_fileContent = _fileContent;
    m_fileContentHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::FileContentHasBeenSet() const
{
    return m_fileContentHasBeenSet;
}

string SubmitFullBodyClassTaskRequest::GetFileType() const
{
    return m_fileType;
}

void SubmitFullBodyClassTaskRequest::SetFileType(const string& _fileType)
{
    m_fileType = _fileType;
    m_fileTypeHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::FileTypeHasBeenSet() const
{
    return m_fileTypeHasBeenSet;
}

int64_t SubmitFullBodyClassTaskRequest::GetLang() const
{
    return m_lang;
}

void SubmitFullBodyClassTaskRequest::SetLang(const int64_t& _lang)
{
    m_lang = _lang;
    m_langHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::LangHasBeenSet() const
{
    return m_langHasBeenSet;
}

vector<string> SubmitFullBodyClassTaskRequest::GetLibrarySet() const
{
    return m_librarySet;
}

void SubmitFullBodyClassTaskRequest::SetLibrarySet(const vector<string>& _librarySet)
{
    m_librarySet = _librarySet;
    m_librarySetHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::LibrarySetHasBeenSet() const
{
    return m_librarySetHasBeenSet;
}

int64_t SubmitFullBodyClassTaskRequest::GetMaxVideoDuration() const
{
    return m_maxVideoDuration;
}

void SubmitFullBodyClassTaskRequest::SetMaxVideoDuration(const int64_t& _maxVideoDuration)
{
    m_maxVideoDuration = _maxVideoDuration;
    m_maxVideoDurationHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::MaxVideoDurationHasBeenSet() const
{
    return m_maxVideoDurationHasBeenSet;
}

vector<string> SubmitFullBodyClassTaskRequest::GetVocabLibNameList() const
{
    return m_vocabLibNameList;
}

void SubmitFullBodyClassTaskRequest::SetVocabLibNameList(const vector<string>& _vocabLibNameList)
{
    m_vocabLibNameList = _vocabLibNameList;
    m_vocabLibNameListHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::VocabLibNameListHasBeenSet() const
{
    return m_vocabLibNameListHasBeenSet;
}

int64_t SubmitFullBodyClassTaskRequest::GetVoiceEncodeType() const
{
    return m_voiceEncodeType;
}

void SubmitFullBodyClassTaskRequest::SetVoiceEncodeType(const int64_t& _voiceEncodeType)
{
    m_voiceEncodeType = _voiceEncodeType;
    m_voiceEncodeTypeHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::VoiceEncodeTypeHasBeenSet() const
{
    return m_voiceEncodeTypeHasBeenSet;
}

int64_t SubmitFullBodyClassTaskRequest::GetVoiceFileType() const
{
    return m_voiceFileType;
}

void SubmitFullBodyClassTaskRequest::SetVoiceFileType(const int64_t& _voiceFileType)
{
    m_voiceFileType = _voiceFileType;
    m_voiceFileTypeHasBeenSet = true;
}

bool SubmitFullBodyClassTaskRequest::VoiceFileTypeHasBeenSet() const
{
