...
CoreInternalOutcome HandTrackingResult::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Confidence") && !value["Confidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `HandTrackingResult.Confidence` IsDouble=false incorrectly").SetRequestId(requestId));
        }
...
void HandTrackingResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
