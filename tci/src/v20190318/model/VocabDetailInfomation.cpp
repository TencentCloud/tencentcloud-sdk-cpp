...
CoreInternalOutcome VocabDetailInfomation::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("VocabDetailInfo") && !value["VocabDetailInfo"].IsNull())
    {
        if (!value["VocabDetailInfo"].IsArray())
            return CoreInternalOutcome(Core::Error("response `VocabDetailInfomation.VocabDetailInfo` is not array type"));
    ...
    if (value.HasMember("VocabLibName") && !value["VocabLibName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `VocabDetailInfomation.VocabLibName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
vector<DetailInfo> VocabDetailInfomation::GetVocabDetailInfo() const
{
    return m_vocabDetailInfo;
}

void VocabDetailInfomation::SetVocabDetailInfo(const vector<DetailInfo>& _vocabDetailInfo)
{
    m_vocabDetailInfo = _vocabDetailInfo;
    m_vocabDetailInfoHasBeenSet = true;
}

bool VocabDetailInfomation::VocabDetailInfoHasBeenSet() const
{
    return m_vocabDetailInfoHasBeenSet;
}

string VocabDetailInfomation::GetVocabLibName() const
{
    return m_vocabLibName;
}

void VocabDetailInfomation::SetVocabLibName(const string& _vocabLibName)
{
    m_vocabLibName = _vocabLibName;
    m_vocabLibNameHasBeenSet = true;
}

bool VocabDetailInfomation::VocabLibNameHasBeenSet() const
{
