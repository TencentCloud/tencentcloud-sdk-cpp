...
string CreateFaceRequest::GetLibraryId() const
{
    return m_libraryId;
}

void CreateFaceRequest::SetLibraryId(const string& _libraryId)
{
    m_libraryId = _libraryId;
    m_libraryIdHasBeenSet = true;
}

bool CreateFaceRequest::LibraryIdHasBeenSet() const
{
