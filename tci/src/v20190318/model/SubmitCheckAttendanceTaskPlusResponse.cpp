...
CoreInternalOutcome SubmitCheckAttendanceTaskPlusResponse::Deserialize(const string &payload)
{
...
string SubmitCheckAttendanceTaskPlusResponse::ToJsonString() const
{
    ...
    if (m_notRegisteredSetHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_notRegisteredSet.c_str(), allocator).Move(), allocator);
    }
...
int64_t SubmitCheckAttendanceTaskPlusResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitCheckAttendanceTaskPlusResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string SubmitCheckAttendanceTaskPlusResponse::GetNotRegisteredSet() const
{
    return m_notRegisteredSet;
}

bool SubmitCheckAttendanceTaskPlusResponse::NotRegisteredSetHasBeenSet() const
{
