...
CoreInternalOutcome SubmitImageTaskResponse::Deserialize(const string &payload)
{
...
string SubmitImageTaskResponse::ToJsonString() const
{
...
vector<ImageTaskResult> SubmitImageTaskResponse::GetResultSet() const
{
    return m_resultSet;
}

bool SubmitImageTaskResponse::ResultSetHasBeenSet() const
{
    return m_resultSetHasBeenSet;
}

int64_t SubmitImageTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitImageTaskResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

int64_t SubmitImageTaskResponse::GetProgress() const
{
    return m_progress;
}

bool SubmitImageTaskResponse::ProgressHasBeenSet() const
{
    return m_progressHasBeenSet;
}

int64_t SubmitImageTaskResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SubmitImageTaskResponse::TotalCountHasBeenSet() const
{
