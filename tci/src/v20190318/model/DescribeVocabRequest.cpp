...
string DescribeVocabRequest::ToJsonString() const
{
...
string DescribeVocabRequest::GetVocabLibName() const
{
    return m_vocabLibName;
}

void DescribeVocabRequest::SetVocabLibName(const string& _vocabLibName)
{
    m_vocabLibName = _vocabLibName;
    m_vocabLibNameHasBeenSet = true;
}

bool DescribeVocabRequest::VocabLibNameHasBeenSet() const
{
