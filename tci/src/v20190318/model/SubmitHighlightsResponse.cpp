...
CoreInternalOutcome SubmitHighlightsResponse::Deserialize(const string &payload)
{
...
string SubmitHighlightsResponse::ToJsonString() const
{
...
int64_t SubmitHighlightsResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHighlightsResponse::JobIdHasBeenSet() const
{
