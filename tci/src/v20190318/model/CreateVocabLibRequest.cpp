...
string CreateVocabLibRequest::ToJsonString() const
{
...
string CreateVocabLibRequest::GetVocabLibName() const
{
    return m_vocabLibName;
}

void CreateVocabLibRequest::SetVocabLibName(const string& _vocabLibName)
{
    m_vocabLibName = _vocabLibName;
    m_vocabLibNameHasBeenSet = true;
}

bool CreateVocabLibRequest::VocabLibNameHasBeenSet() const
{
