...
CoreInternalOutcome TimeType::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EndTime") && !value["EndTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TimeType.EndTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("StartTime") && !value["StartTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TimeType.StartTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void TimeType::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
