...
string CreateVocabRequest::ToJsonString() const
{
...
string CreateVocabRequest::GetVocabLibName() const
{
    return m_vocabLibName;
}

void CreateVocabRequest::SetVocabLibName(const string& _vocabLibName)
{
    m_vocabLibName = _vocabLibName;
    m_vocabLibNameHasBeenSet = true;
}

bool CreateVocabRequest::VocabLibNameHasBeenSet() const
{
    return m_vocabLibNameHasBeenSet;
}

vector<string> CreateVocabRequest::GetVocabList() const
{
    return m_vocabList;
}

void CreateVocabRequest::SetVocabList(const vector<string>& _vocabList)
{
    m_vocabList = _vocabList;
    m_vocabListHasBeenSet = true;
}

bool CreateVocabRequest::VocabListHasBeenSet() const
{
