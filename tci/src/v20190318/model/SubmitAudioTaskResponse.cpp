...
CoreInternalOutcome SubmitAudioTaskResponse::Deserialize(const string &payload)
{
...
string SubmitAudioTaskResponse::ToJsonString() const
{
...
int64_t SubmitAudioTaskResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitAudioTaskResponse::JobIdHasBeenSet() const
{
