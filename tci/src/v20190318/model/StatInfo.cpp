...
CoreInternalOutcome StatInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void StatInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string StatInfo::GetKeyword() const
{
    return m_keyword;
}

void StatInfo::SetKeyword(const string& _keyword)
{
    m_keyword = _keyword;
    m_keywordHasBeenSet = true;
}

bool StatInfo::KeywordHasBeenSet() const
{
    return m_keywordHasBeenSet;
}

int64_t StatInfo::GetValue() const
{
    return m_value;
}

void StatInfo::SetValue(const int64_t& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool StatInfo::ValueHasBeenSet() const
{
