...
string CreateLibraryRequest::ToJsonString() const
{
    ...
    if (m_libraryNameHasBeenSet)
    {
        ...
        d.AddMember(iKey, rapidjson::Value(m_libraryName.c_str(), allocator).Move(), allocator);
    }
...
string CreateLibraryRequest::GetLibraryName() const
{
    return m_libraryName;
}

void CreateLibraryRequest::SetLibraryName(const string& _libraryName)
{
    m_libraryName = _libraryName;
    m_libraryNameHasBeenSet = true;
}

bool CreateLibraryRequest::LibraryNameHasBeenSet() const
{
    return m_libraryNameHasBeenSet;
}

string CreateLibraryRequest::GetLibraryId() const
{
    return m_libraryId;
}

void CreateLibraryRequest::SetLibraryId(const string& _libraryId)
{
    m_libraryId = _libraryId;
    m_libraryIdHasBeenSet = true;
}

bool CreateLibraryRequest::LibraryIdHasBeenSet() const
{
