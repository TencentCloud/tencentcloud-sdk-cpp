...
CoreInternalOutcome DeleteLibraryResponse::Deserialize(const string &payload)
{
...
string DeleteLibraryResponse::ToJsonString() const
{
...
string DeleteLibraryResponse::GetLibraryId() const
{
    return m_libraryId;
}

bool DeleteLibraryResponse::LibraryIdHasBeenSet() const
{
    return m_libraryIdHasBeenSet;
}

string DeleteLibraryResponse::GetLibraryName() const
{
    return m_libraryName;
}

bool DeleteLibraryResponse::LibraryNameHasBeenSet() const
{
