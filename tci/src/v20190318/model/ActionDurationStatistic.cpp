...
CoreInternalOutcome ActionDurationStatistic::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ActionDurationStatistic::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
