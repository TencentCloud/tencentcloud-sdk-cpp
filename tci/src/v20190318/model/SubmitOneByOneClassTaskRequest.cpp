...
string SubmitOneByOneClassTaskRequest::ToJsonString() const
{
...
string SubmitOneByOneClassTaskRequest::GetFileContent() const
{
    return m_fileContent;
}

void SubmitOneByOneClassTaskRequest::SetFileContent(const string& _fileContent)
{
    m_fileContent = _fileContent;
    m_fileContentHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::FileContentHasBeenSet() const
{
    return m_fileContentHasBeenSet;
}

string SubmitOneByOneClassTaskRequest::GetFileType() const
{
    return m_fileType;
}

void SubmitOneByOneClassTaskRequest::SetFileType(const string& _fileType)
{
    m_fileType = _fileType;
    m_fileTypeHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::FileTypeHasBeenSet() const
{
    return m_fileTypeHasBeenSet;
}

int64_t SubmitOneByOneClassTaskRequest::GetLang() const
{
    return m_lang;
}

void SubmitOneByOneClassTaskRequest::SetLang(const int64_t& _lang)
{
    m_lang = _lang;
    m_langHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::LangHasBeenSet() const
{
    return m_langHasBeenSet;
}

vector<string> SubmitOneByOneClassTaskRequest::GetLibrarySet() const
{
    return m_librarySet;
}

void SubmitOneByOneClassTaskRequest::SetLibrarySet(const vector<string>& _librarySet)
{
    m_librarySet = _librarySet;
    m_librarySetHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::LibrarySetHasBeenSet() const
{
    return m_librarySetHasBeenSet;
}

int64_t SubmitOneByOneClassTaskRequest::GetMaxVideoDuration() const
{
    return m_maxVideoDuration;
}

void SubmitOneByOneClassTaskRequest::SetMaxVideoDuration(const int64_t& _maxVideoDuration)
{
    m_maxVideoDuration = _maxVideoDuration;
    m_maxVideoDurationHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::MaxVideoDurationHasBeenSet() const
{
    return m_maxVideoDurationHasBeenSet;
}

vector<string> SubmitOneByOneClassTaskRequest::GetVocabLibNameList() const
{
    return m_vocabLibNameList;
}

void SubmitOneByOneClassTaskRequest::SetVocabLibNameList(const vector<string>& _vocabLibNameList)
{
    m_vocabLibNameList = _vocabLibNameList;
    m_vocabLibNameListHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::VocabLibNameListHasBeenSet() const
{
    return m_vocabLibNameListHasBeenSet;
}

int64_t SubmitOneByOneClassTaskRequest::GetVoiceEncodeType() const
{
    return m_voiceEncodeType;
}

void SubmitOneByOneClassTaskRequest::SetVoiceEncodeType(const int64_t& _voiceEncodeType)
{
    m_voiceEncodeType = _voiceEncodeType;
    m_voiceEncodeTypeHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::VoiceEncodeTypeHasBeenSet() const
{
    return m_voiceEncodeTypeHasBeenSet;
}

int64_t SubmitOneByOneClassTaskRequest::GetVoiceFileType() const
{
    return m_voiceFileType;
}

void SubmitOneByOneClassTaskRequest::SetVoiceFileType(const int64_t& _voiceFileType)
{
    m_voiceFileType = _voiceFileType;
    m_voiceFileTypeHasBeenSet = true;
}

bool SubmitOneByOneClassTaskRequest::VoiceFileTypeHasBeenSet() const
{
