...
CoreInternalOutcome FlowProductRemindResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Success") && !rsp["Success"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Success` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("FlowId") && !rsp["FlowId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FlowId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string FlowProductRemindResponse::ToJsonString() const
{
...
string FlowProductRemindResponse::GetSuccess() const
{
    return m_success;
}

bool FlowProductRemindResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

string FlowProductRemindResponse::GetFlowId() const
{
    return m_flowId;
}

bool FlowProductRemindResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string FlowProductRemindResponse::GetInfo() const
{
    return m_info;
}

bool FlowProductRemindResponse::InfoHasBeenSet() const
{
