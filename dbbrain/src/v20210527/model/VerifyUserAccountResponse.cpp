...
CoreInternalOutcome VerifyUserAccountResponse::Deserialize(const string &payload)
{
...
string VerifyUserAccountResponse::ToJsonString() const
{
...
string VerifyUserAccountResponse::GetSessionToken() const
{
    return m_sessionToken;
}

bool VerifyUserAccountResponse::SessionTokenHasBeenSet() const
{
