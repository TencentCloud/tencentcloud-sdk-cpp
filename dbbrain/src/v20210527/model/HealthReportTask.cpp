...
CoreInternalOutcome HealthReportTask::Deserialize(const Value &value)
{
    string requestId = "";
...
void HealthReportTask::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
