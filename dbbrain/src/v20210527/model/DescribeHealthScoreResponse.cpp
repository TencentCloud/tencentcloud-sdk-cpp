...
CoreInternalOutcome DescribeHealthScoreResponse::Deserialize(const string &payload)
{
...
string DescribeHealthScoreResponse::ToJsonString() const
{
...
HealthScoreInfo DescribeHealthScoreResponse::GetData() const
{
    return m_data;
}

bool DescribeHealthScoreResponse::DataHasBeenSet() const
{
