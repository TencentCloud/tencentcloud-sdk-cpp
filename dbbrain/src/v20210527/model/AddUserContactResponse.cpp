...
CoreInternalOutcome AddUserContactResponse::Deserialize(const string &payload)
{
...
string AddUserContactResponse::ToJsonString() const
{
...
int64_t AddUserContactResponse::GetId() const
{
    return m_id;
}

bool AddUserContactResponse::IdHasBeenSet() const
{
