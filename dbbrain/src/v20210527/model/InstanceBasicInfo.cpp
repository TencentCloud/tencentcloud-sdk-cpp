...
CoreInternalOutcome InstanceBasicInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceBasicInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
