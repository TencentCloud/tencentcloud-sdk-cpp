...
string OpenAuditServiceRequest::GetNodeRequestType() const
{
    return m_nodeRequestType;
}

void OpenAuditServiceRequest::SetNodeRequestType(const string& _nodeRequestType)
{
    m_nodeRequestType = _nodeRequestType;
    m_nodeRequestTypeHasBeenSet = true;
}

bool OpenAuditServiceRequest::NodeRequestTypeHasBeenSet() const
{
...
int64_t OpenAuditServiceRequest::GetLogExpireDay() const
{
    return m_logExpireDay;
}

void OpenAuditServiceRequest::SetLogExpireDay(const int64_t& _logExpireDay)
{
...
int64_t OpenAuditServiceRequest::GetHotLogExpireDay() const
{
    return m_hotLogExpireDay;
}

void OpenAuditServiceRequest::SetHotLogExpireDay(const int64_t& _hotLogExpireDay)
{
