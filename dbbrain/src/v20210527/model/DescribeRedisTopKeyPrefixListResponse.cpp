...
CoreInternalOutcome DescribeRedisTopKeyPrefixListResponse::Deserialize(const string &payload)
{
...
string DescribeRedisTopKeyPrefixListResponse::ToJsonString() const
{
...
vector<RedisPreKeySpaceData> DescribeRedisTopKeyPrefixListResponse::GetItems() const
{
    return m_items;
}

bool DescribeRedisTopKeyPrefixListResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t DescribeRedisTopKeyPrefixListResponse::GetTimestamp() const
{
    return m_timestamp;
}

bool DescribeRedisTopKeyPrefixListResponse::TimestampHasBeenSet() const
{
