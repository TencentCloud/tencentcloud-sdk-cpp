...
string DescribeAuditLogFilesRequest::GetNodeRequestType() const
{
    return m_nodeRequestType;
}

void DescribeAuditLogFilesRequest::SetNodeRequestType(const string& _nodeRequestType)
{
    m_nodeRequestType = _nodeRequestType;
    m_nodeRequestTypeHasBeenSet = true;
}

bool DescribeAuditLogFilesRequest::NodeRequestTypeHasBeenSet() const
{
