...
string CreateProxySessionKillTaskRequest::ToJsonString() const
{
...
string CreateProxySessionKillTaskRequest::GetInstanceId() const
{
    return m_instanceId;
}

void CreateProxySessionKillTaskRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool CreateProxySessionKillTaskRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateProxySessionKillTaskRequest::GetProduct() const
{
    return m_product;
}

void CreateProxySessionKillTaskRequest::SetProduct(const string& _product)
{
    m_product = _product;
