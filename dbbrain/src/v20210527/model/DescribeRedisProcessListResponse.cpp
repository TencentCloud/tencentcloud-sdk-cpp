...
DescribeRedisProcessListResponse::DescribeRedisProcessListResponse() :
    m_proxyCountHasBeenSet(false),
    m_processesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeRedisProcessListResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Processes"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Processes` is not array type"));

        const rapidjson::Value &tmpValue = rsp["Processes"];
...
string DescribeRedisProcessListResponse::ToJsonString() const
{
...
int64_t DescribeRedisProcessListResponse::GetProxyCount() const
{
    return m_proxyCount;
}

bool DescribeRedisProcessListResponse::ProxyCountHasBeenSet() const
{
    return m_proxyCountHasBeenSet;
}

vector<Process> DescribeRedisProcessListResponse::GetProcesses() const
{
    return m_processes;
}

bool DescribeRedisProcessListResponse::ProcessesHasBeenSet() const
{
