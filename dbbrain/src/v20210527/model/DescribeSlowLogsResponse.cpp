...
string DescribeSlowLogsResponse::ToJsonString() const
{
...
int64_t DescribeSlowLogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSlowLogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SlowLogInfoItem> DescribeSlowLogsResponse::GetRows() const
{
    return m_rows;
}

bool DescribeSlowLogsResponse::RowsHasBeenSet() const
{
