...
CoreInternalOutcome CloseAuditServiceResponse::Deserialize(const string &payload)
{
...
string CloseAuditServiceResponse::ToJsonString() const
{
...
int64_t CloseAuditServiceResponse::GetTaskId() const
{
    return m_taskId;
}

bool CloseAuditServiceResponse::TaskIdHasBeenSet() const
{
