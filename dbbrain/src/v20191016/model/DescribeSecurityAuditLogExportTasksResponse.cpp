...
string DescribeSecurityAuditLogExportTasksResponse::ToJsonString() const
{
...
vector<SecLogExportTaskInfo> DescribeSecurityAuditLogExportTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeSecurityAuditLogExportTasksResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

uint64_t DescribeSecurityAuditLogExportTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSecurityAuditLogExportTasksResponse::TotalCountHasBeenSet() const
{
