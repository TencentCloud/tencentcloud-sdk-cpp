...
CoreInternalOutcome DescribeSlowLogUserHostStatsResponse::Deserialize(const string &payload)
{
...
string DescribeSlowLogUserHostStatsResponse::ToJsonString() const
{
...
int64_t DescribeSlowLogUserHostStatsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSlowLogUserHostStatsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SlowLogHost> DescribeSlowLogUserHostStatsResponse::GetItems() const
{
    return m_items;
}
