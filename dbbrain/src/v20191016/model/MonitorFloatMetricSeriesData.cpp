...
CoreInternalOutcome MonitorFloatMetricSeriesData::Deserialize(const Value &value)
{
    string requestId = "";
...
void MonitorFloatMetricSeriesData::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
