...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELKILLTASKREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELKILLTASKREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class CancelKillTaskRequest : public AbstractModel
                {
                public:
                    CancelKillTaskRequest();
                    ~CancelKillTaskRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELKILLTASKREQUEST_H_
