...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBENOPRIMARYKEYTABLESREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBENOPRIMARYKEYTABLESREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeNoPrimaryKeyTablesRequest : public AbstractModel
                {
                public:
                    DescribeNoPrimaryKeyTablesRequest();
                    ~DescribeNoPrimaryKeyTablesRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBENOPRIMARYKEYTABLESREQUEST_H_
