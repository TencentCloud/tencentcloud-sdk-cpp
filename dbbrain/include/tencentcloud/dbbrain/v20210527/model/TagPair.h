...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_TAGPAIR_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_TAGPAIR_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                * 标签键值对过滤条件。
                */
                class TagPair : public AbstractModel
                {
                public:
                    TagPair();
                    ~TagPair() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_TAGPAIR_H_
