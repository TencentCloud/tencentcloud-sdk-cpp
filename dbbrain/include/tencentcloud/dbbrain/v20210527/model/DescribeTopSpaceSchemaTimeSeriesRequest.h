...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBETOPSPACESCHEMATIMESERIESREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBETOPSPACESCHEMATIMESERIESREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeTopSpaceSchemaTimeSeriesRequest : public AbstractModel
                {
                public:
                    DescribeTopSpaceSchemaTimeSeriesRequest();
                    ~DescribeTopSpaceSchemaTimeSeriesRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBETOPSPACESCHEMATIMESERIESREQUEST_H_
