...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_MODIFYUSERAUTONOMYPROFILEREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_MODIFYUSERAUTONOMYPROFILEREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class ModifyUserAutonomyProfileRequest : public AbstractModel
                {
                public:
                    ModifyUserAutonomyProfileRequest();
                    ~ModifyUserAutonomyProfileRequest() = default;
                     ...
                     * 
                     */
                    std::string GetNewProfileInfo() const;
                     ...
                     * 
                     */
                    void SetNewProfileInfo(const std::string& _newProfileInfo);

                    /**
                     * 判断参数 NewProfileInfo 是否已赋值
                     * @return NewProfileInfo 是否已赋值
                     * 
                     */
                    bool NewProfileInfoHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    std::string m_newProfileInfo;
                    bool m_newProfileInfoHasBeenSet;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_MODIFYUSERAUTONOMYPROFILEREQUEST_H_
