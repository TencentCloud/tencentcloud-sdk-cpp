...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEUSERAUTONOMYPROFILEREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEUSERAUTONOMYPROFILEREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeUserAutonomyProfileRequest : public AbstractModel
                {
                public:
                    DescribeUserAutonomyProfileRequest();
                    ~DescribeUserAutonomyProfileRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEUSERAUTONOMYPROFILEREQUEST_H_
