...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_VERIFYUSERACCOUNTREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_VERIFYUSERACCOUNTREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class VerifyUserAccountRequest : public AbstractModel
                {
                public:
                    VerifyUserAccountRequest();
                    ~VerifyUserAccountRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_VERIFYUSERACCOUNTREQUEST_H_
