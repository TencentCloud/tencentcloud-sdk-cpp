...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_UPDATEDATABASEAUTONOMYSTATUSREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_UPDATEDATABASEAUTONOMYSTATUSREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class UpdateDatabaseAutonomyStatusRequest : public AbstractModel
                {
                public:
                    UpdateDatabaseAutonomyStatusRequest();
                    ~UpdateDatabaseAutonomyStatusRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_UPDATEDATABASEAUTONOMYSTATUSREQUEST_H_
