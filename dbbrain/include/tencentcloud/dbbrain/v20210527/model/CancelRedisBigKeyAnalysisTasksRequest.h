...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELREDISBIGKEYANALYSISTASKSREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELREDISBIGKEYANALYSISTASKSREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class CancelRedisBigKeyAnalysisTasksRequest : public AbstractModel
                {
                public:
                    CancelRedisBigKeyAnalysisTasksRequest();
                    ~CancelRedisBigKeyAnalysisTasksRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取自治任务ID。
                     * @return AsyncRequestIds 自治任务ID。
                     * 
                     */
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELREDISBIGKEYANALYSISTASKSREQUEST_H_
