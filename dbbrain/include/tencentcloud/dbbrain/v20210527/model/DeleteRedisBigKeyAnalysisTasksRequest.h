...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DELETEREDISBIGKEYANALYSISTASKSREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DELETEREDISBIGKEYANALYSISTASKSREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DeleteRedisBigKeyAnalysisTasksRequest : public AbstractModel
                {
                public:
                    DeleteRedisBigKeyAnalysisTasksRequest();
                    ~DeleteRedisBigKeyAnalysisTasksRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DELETEREDISBIGKEYANALYSISTASKSREQUEST_H_
