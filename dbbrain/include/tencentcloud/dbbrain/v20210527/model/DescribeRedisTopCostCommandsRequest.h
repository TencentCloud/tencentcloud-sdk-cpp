...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISTOPCOSTCOMMANDSREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISTOPCOSTCOMMANDSREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeRedisTopCostCommandsRequest : public AbstractModel
                {
                public:
                    DescribeRedisTopCostCommandsRequest();
                    ~DescribeRedisTopCostCommandsRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISTOPCOSTCOMMANDSREQUEST_H_
