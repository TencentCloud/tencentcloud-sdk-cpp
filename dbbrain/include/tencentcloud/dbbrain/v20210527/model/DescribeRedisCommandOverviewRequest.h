...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDOVERVIEWREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDOVERVIEWREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeRedisCommandOverviewRequest : public AbstractModel
                {
                public:
                    DescribeRedisCommandOverviewRequest();
                    ~DescribeRedisCommandOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDOVERVIEWREQUEST_H_
