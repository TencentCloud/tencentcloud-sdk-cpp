...
CoreInternalOutcome DescribeTtsTaskStatusResponse::Deserialize(const string &payload)
{
...
string DescribeTtsTaskStatusResponse::ToJsonString() const
{
...
DescribeTtsTaskStatusRespData DescribeTtsTaskStatusResponse::GetData() const
{
    return m_data;
}

bool DescribeTtsTaskStatusResponse::DataHasBeenSet() const
{
