...
CoreInternalOutcome CreateTtsTaskResponse::Deserialize(const string &payload)
{
...
string CreateTtsTaskResponse::ToJsonString() const
{
...
CreateTtsTaskRespData CreateTtsTaskResponse::GetData() const
{
    return m_data;
}

bool CreateTtsTaskResponse::DataHasBeenSet() const
{
