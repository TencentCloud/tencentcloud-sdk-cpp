...
#ifndef TENCENTCLOUD_CWS_V20180312_MODEL_MODIFYMONITORATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_CWS_V20180312_MODEL_MODIFYMONITORATTRIBUTEREQUEST_H_
    ...
    namespace Cws
    {
        namespace V20180312
        {
            namespace Model
            {
                ...
                */
                class ModifyMonitorAttributeRequest : public AbstractModel
                {
                public:
                    ModifyMonitorAttributeRequest();
                    ~ModifyMonitorAttributeRequest() = default;
...
#endif // !TENCENTCLOUD_CWS_V20180312_MODEL_MODIFYMONITORATTRIBUTEREQUEST_H_
