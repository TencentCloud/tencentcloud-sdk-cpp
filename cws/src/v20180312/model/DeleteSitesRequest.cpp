...
string DeleteSitesRequest::ToJsonString() const
{
...
vector<uint64_t> DeleteSitesRequest::GetSiteIds() const
{
    return m_siteIds;
}

void DeleteSitesRequest::SetSiteIds(const vector<uint64_t>& _siteIds)
{
    m_siteIds = _siteIds;
    m_siteIdsHasBeenSet = true;
}

bool DeleteSitesRequest::SiteIdsHasBeenSet() const
{
