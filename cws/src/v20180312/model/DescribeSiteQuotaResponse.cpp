...
CoreInternalOutcome DescribeSiteQuotaResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Used") && !rsp["Used"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Used` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    {
        if (!rsp["Available"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `Available` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_available = rsp["Available"].GetUint64();
...
bool DescribeSiteQuotaResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t DescribeSiteQuotaResponse::GetUsed() const
{
    return m_used;
}

bool DescribeSiteQuotaResponse::UsedHasBeenSet() const
{
    return m_usedHasBeenSet;
}

uint64_t DescribeSiteQuotaResponse::GetAvailable() const
{
    return m_available;
}

bool DescribeSiteQuotaResponse::AvailableHasBeenSet() const
{
