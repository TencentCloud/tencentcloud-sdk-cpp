...
string DescribeSitesVerificationRequest::ToJsonString() const
{
...
vector<string> DescribeSitesVerificationRequest::GetUrls() const
{
    return m_urls;
}

void DescribeSitesVerificationRequest::SetUrls(const vector<string>& _urls)
{
    m_urls = _urls;
    m_urlsHasBeenSet = true;
}

bool DescribeSitesVerificationRequest::UrlsHasBeenSet() const
{
