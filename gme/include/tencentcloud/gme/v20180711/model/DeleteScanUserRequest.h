...
#ifndef TENCENTCLOUD_GME_V20180711_MODEL_DELETESCANUSERREQUEST_H_
#define TENCENTCLOUD_GME_V20180711_MODEL_DELETESCANUSERREQUEST_H_
    ...
    namespace Gme
    {
        namespace V20180711
        {
            namespace Model
            {
                ...
                */
                class DeleteScanUserRequest : public AbstractModel
                {
                public:
                    DeleteScanUserRequest();
                    ~DeleteScanUserRequest() = default;
...
#endif // !TENCENTCLOUD_GME_V20180711_MODEL_DELETESCANUSERREQUEST_H_
