...
#ifndef TENCENTCLOUD_GME_V20180711_MODEL_REGISTERVOICEPRINTREQUEST_H_
#define TENCENTCLOUD_GME_V20180711_MODEL_REGISTERVOICEPRINTREQUEST_H_
    ...
    namespace Gme
    {
        namespace V20180711
        {
            namespace Model
            {
                ...
                */
                class RegisterVoicePrintRequest : public AbstractModel
                {
                public:
                    RegisterVoicePrintRequest();
                    ~RegisterVoicePrintRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取整个wav音频文件的base64字符串,其中wav文件限定为16k采样率, 16bit位深, 单声道, 4到18秒音频时长,有效音频不小于3秒(不能有太多静音段), 编码数据大小不超过2M, 为了识别准确率，建议音频长度为8秒
                     * @return Audio 整个wav音频文件的base64字符串,其中wav文件限定为16k采样率, 16bit位深, 单声道, 4到18秒音频时长,有效音频不小于3秒(不能有太多静音段), 编码数据大小不超过2M, 为了识别准确率，建议音频长度为8秒
                     * 
                     */
                    std::string GetAudio() const;

                    /**
                     * 设置整个wav音频文件的base64字符串,其中wav文件限定为16k采样率, 16bit位深, 单声道, 4到18秒音频时长,有效音频不小于3秒(不能有太多静音段), 编码数据大小不超过2M, 为了识别准确率，建议音频长度为8秒
...
#endif // !TENCENTCLOUD_GME_V20180711_MODEL_REGISTERVOICEPRINTREQUEST_H_
