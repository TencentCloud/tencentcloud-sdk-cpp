...
#ifndef TENCENTCLOUD_GME_V20180711_MODEL_CREATEAUDIOMODERATIONSYNCREQUEST_H_
#define TENCENTCLOUD_GME_V20180711_MODEL_CREATEAUDIOMODERATIONSYNCREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>数据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
                     * @return DataId <p>数据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
                     * 
                     */
                    std::string GetDataId() const;

                    /**
                     * 设置<p>数据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
...
#endif // !TENCENTCLOUD_GME_V20180711_MODEL_CREATEAUDIOMODERATIONSYNCREQUEST_H_
