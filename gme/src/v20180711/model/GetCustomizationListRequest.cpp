...
int64_t GetCustomizationListRequest::GetBizId() const
{
    return m_bizId;
}

void GetCustomizationListRequest::SetBizId(const int64_t& _bizId)
{
    m_bizId = _bizId;
    m_bizIdHasBeenSet = true;
}

bool GetCustomizationListRequest::BizIdHasBeenSet() const
{
