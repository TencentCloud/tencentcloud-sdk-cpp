...
CoreInternalOutcome ModifyUserMicStatusResponse::Deserialize(const string &payload)
{
...
string ModifyUserMicStatusResponse::ToJsonString() const
{
...
int64_t ModifyUserMicStatusResponse::GetResult() const
{
    return m_result;
}

bool ModifyUserMicStatusResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ModifyUserMicStatusResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool ModifyUserMicStatusResponse::ErrMsgHasBeenSet() const
{
