...
CoreInternalOutcome ModifyCustomizationStateResponse::Deserialize(const string &payload)
{
...
string ModifyCustomizationStateResponse::ToJsonString() const
{
...
string ModifyCustomizationStateResponse::GetModelId() const
{
    return m_modelId;
}

bool ModifyCustomizationStateResponse::ModelIdHasBeenSet() const
{
    return m_modelIdHasBeenSet;
}

int64_t ModifyCustomizationStateResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool ModifyCustomizationStateResponse::ErrorCodeHasBeenSet() const
{
