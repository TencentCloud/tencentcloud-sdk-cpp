...
CoreInternalOutcome DescribeAgeDetectTaskResponse::Deserialize(const string &payload)
{
...
string DescribeAgeDetectTaskResponse::ToJsonString() const
{
...
string DescribeAgeDetectTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeAgeDetectTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

vector<AgeDetectTaskResult> DescribeAgeDetectTaskResponse::GetResults() const
{
    return m_results;
}

bool DescribeAgeDetectTaskResponse::ResultsHasBeenSet() const
{
