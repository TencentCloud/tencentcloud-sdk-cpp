...
CoreInternalOutcome UpdateScanRoomsResponse::Deserialize(const string &payload)
{
...
string UpdateScanRoomsResponse::ToJsonString() const
{
...
int64_t UpdateScanRoomsResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool UpdateScanRoomsResponse::ErrorCodeHasBeenSet() const
{
