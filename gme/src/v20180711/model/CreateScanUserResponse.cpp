...
CoreInternalOutcome CreateScanUserResponse::Deserialize(const string &payload)
{
...
string CreateScanUserResponse::ToJsonString() const
{
...
int64_t CreateScanUserResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool CreateScanUserResponse::ErrorCodeHasBeenSet() const
{
