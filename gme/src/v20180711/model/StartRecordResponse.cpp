...
CoreInternalOutcome StartRecordResponse::Deserialize(const string &payload)
{
...
string StartRecordResponse::ToJsonString() const
{
...
uint64_t StartRecordResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartRecordResponse::TaskIdHasBeenSet() const
{
