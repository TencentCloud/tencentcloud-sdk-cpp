...
CoreInternalOutcome DescribeApplicationDataResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationDataResponse::ToJsonString() const
{
...
ApplicationDataStatistics DescribeApplicationDataResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationDataResponse::DataHasBeenSet() const
{
