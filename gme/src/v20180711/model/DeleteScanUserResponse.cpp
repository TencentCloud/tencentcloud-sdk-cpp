...
CoreInternalOutcome DeleteScanUserResponse::Deserialize(const string &payload)
{
...
string DeleteScanUserResponse::ToJsonString() const
{
...
int64_t DeleteScanUserResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DeleteScanUserResponse::ErrorCodeHasBeenSet() const
{
