...
CoreInternalOutcome DeleteCustomizationResponse::Deserialize(const string &payload)
{
...
string DeleteCustomizationResponse::ToJsonString() const
{
...
int64_t DeleteCustomizationResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DeleteCustomizationResponse::ErrorCodeHasBeenSet() const
{
