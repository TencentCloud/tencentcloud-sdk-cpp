...
int64_t ModifyCustomizationStateRequest::GetBizId() const
{
    return m_bizId;
}

void ModifyCustomizationStateRequest::SetBizId(const int64_t& _bizId)
{
    m_bizId = _bizId;
    m_bizIdHasBeenSet = true;
}

bool ModifyCustomizationStateRequest::BizIdHasBeenSet() const
{
