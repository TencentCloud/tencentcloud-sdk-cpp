...
CoreInternalOutcome UpdateScanUsersResponse::Deserialize(const string &payload)
{
...
string UpdateScanUsersResponse::ToJsonString() const
{
...
int64_t UpdateScanUsersResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool UpdateScanUsersResponse::ErrorCodeHasBeenSet() const
{
