...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_STOPWORKSPACEREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_STOPWORKSPACEREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class StopWorkspaceRequest : public AbstractModel
                {
                public:
                    StopWorkspaceRequest();
                    ~StopWorkspaceRequest() = default;
                    ...
                    /**
                     * 获取是否强制终止，true或者false
                     * @return Force 是否强制终止，true或者false
                     */
                    std::string GetForce() const;

                    /**
                     * 设置是否强制终止，true或者false
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_STOPWORKSPACEREQUEST_H_
