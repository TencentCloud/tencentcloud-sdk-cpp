...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACEENVLISTREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACEENVLISTREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkspaceEnvListRequest : public AbstractModel
                {
                public:
                    DescribeWorkspaceEnvListRequest();
                    ~DescribeWorkspaceEnvListRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACEENVLISTREQUEST_H_
