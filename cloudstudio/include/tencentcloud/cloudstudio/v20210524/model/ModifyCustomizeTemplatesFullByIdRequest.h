...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESFULLBYIDREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESFULLBYIDREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomizeTemplatesFullByIdRequest : public AbstractModel
                {
                public:
                    ModifyCustomizeTemplatesFullByIdRequest();
                    ~ModifyCustomizeTemplatesFullByIdRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESFULLBYIDREQUEST_H_
