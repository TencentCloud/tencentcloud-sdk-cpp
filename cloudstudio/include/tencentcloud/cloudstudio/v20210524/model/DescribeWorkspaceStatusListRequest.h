...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACESTATUSLISTREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACESTATUSLISTREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkspaceStatusListRequest : public AbstractModel
                {
                public:
                    DescribeWorkspaceStatusListRequest();
                    ~DescribeWorkspaceStatusListRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBEWORKSPACESTATUSLISTREQUEST_H_
