...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESPARTBYIDREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESPARTBYIDREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomizeTemplatesPartByIdRequest : public AbstractModel
                {
                public:
                    ModifyCustomizeTemplatesPartByIdRequest();
                    ~ModifyCustomizeTemplatesPartByIdRequest() = default;
                ...
                private:
                     ...
                     * 自定义模板Patched参数
                     */
                    UserDefinedTemplatePatchedParams m_userDefinedTemplatePatchedParams;
                    bool m_userDefinedTemplatePatchedParamsHasBeenSet;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_MODIFYCUSTOMIZETEMPLATESPARTBYIDREQUEST_H_
