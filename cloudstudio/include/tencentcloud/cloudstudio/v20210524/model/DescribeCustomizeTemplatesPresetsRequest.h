...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESPRESETSREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESPRESETSREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class DescribeCustomizeTemplatesPresetsRequest : public AbstractModel
                {
                public:
                    DescribeCustomizeTemplatesPresetsRequest();
                    ~DescribeCustomizeTemplatesPresetsRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESPRESETSREQUEST_H_
