...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESBYIDREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESBYIDREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class DescribeCustomizeTemplatesByIdRequest : public AbstractModel
                {
                public:
                    DescribeCustomizeTemplatesByIdRequest();
                    ~DescribeCustomizeTemplatesByIdRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DESCRIBECUSTOMIZETEMPLATESBYIDREQUEST_H_
