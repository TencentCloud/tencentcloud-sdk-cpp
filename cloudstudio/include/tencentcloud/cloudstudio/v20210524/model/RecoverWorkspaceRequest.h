...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_RECOVERWORKSPACEREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_RECOVERWORKSPACEREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class RecoverWorkspaceRequest : public AbstractModel
                {
                public:
                    RecoverWorkspaceRequest();
                    ~RecoverWorkspaceRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_RECOVERWORKSPACEREQUEST_H_
