...
#ifndef TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DELETECUSTOMIZETEMPLATESBYIDREQUEST_H_
#define TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DELETECUSTOMIZETEMPLATESBYIDREQUEST_H_
    ...
    namespace Cloudstudio
    {
        namespace V20210524
        {
            namespace Model
            {
                ...
                */
                class DeleteCustomizeTemplatesByIdRequest : public AbstractModel
                {
                public:
                    DeleteCustomizeTemplatesByIdRequest();
                    ~DeleteCustomizeTemplatesByIdRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDSTUDIO_V20210524_MODEL_DELETECUSTOMIZETEMPLATESBYIDREQUEST_H_
