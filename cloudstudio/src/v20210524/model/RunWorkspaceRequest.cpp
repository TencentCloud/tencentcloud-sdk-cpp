...
string RunWorkspaceRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void RunWorkspaceRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool RunWorkspaceRequest::CloudStudioSessionTeamHasBeenSet() const
{
