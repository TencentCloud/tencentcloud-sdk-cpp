...
string DescribeWorkspaceStatusListRequest::ToJsonString() const
{
...
string DescribeWorkspaceStatusListRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeWorkspaceStatusListRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeWorkspaceStatusListRequest::CloudStudioSessionTeamHasBeenSet() const
{
