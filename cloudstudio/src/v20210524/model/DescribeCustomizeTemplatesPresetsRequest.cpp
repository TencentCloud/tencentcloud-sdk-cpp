...
string DescribeCustomizeTemplatesPresetsRequest::ToJsonString() const
{
...
string DescribeCustomizeTemplatesPresetsRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeCustomizeTemplatesPresetsRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeCustomizeTemplatesPresetsRequest::CloudStudioSessionTeamHasBeenSet() const
{
    return m_cloudStudioSessionTeamHasBeenSet;
}

string DescribeCustomizeTemplatesPresetsRequest::GetSpaceKey() const
{
    return m_spaceKey;
}

void DescribeCustomizeTemplatesPresetsRequest::SetSpaceKey(const string& _spaceKey)
{
    m_spaceKey = _spaceKey;
    m_spaceKeyHasBeenSet = true;
}

bool DescribeCustomizeTemplatesPresetsRequest::SpaceKeyHasBeenSet() const
{
