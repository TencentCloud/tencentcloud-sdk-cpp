...
CoreInternalOutcome DescribeCustomizeTemplatesByIdResponse::Deserialize(const string &payload)
{
...
string DescribeCustomizeTemplatesByIdResponse::ToJsonString() const
{
...
WorkspaceTemplateInfo DescribeCustomizeTemplatesByIdResponse::GetData() const
{
    return m_data;
}

bool DescribeCustomizeTemplatesByIdResponse::DataHasBeenSet() const
{
