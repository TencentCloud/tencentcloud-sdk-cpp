...
CoreInternalOutcome ModifyCustomizeTemplateVersionControlResponse::Deserialize(const string &payload)
{
...
string ModifyCustomizeTemplateVersionControlResponse::ToJsonString() const
{
...
WorkspaceTemplateInfo ModifyCustomizeTemplateVersionControlResponse::GetData() const
{
    return m_data;
}

bool ModifyCustomizeTemplateVersionControlResponse::DataHasBeenSet() const
{
