...
string ModifyCustomizeTemplatesFullByIdRequest::ToJsonString() const
{
...
string ModifyCustomizeTemplatesFullByIdRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void ModifyCustomizeTemplatesFullByIdRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool ModifyCustomizeTemplatesFullByIdRequest::CloudStudioSessionTeamHasBeenSet() const
{
    return m_cloudStudioSessionTeamHasBeenSet;
}

int64_t ModifyCustomizeTemplatesFullByIdRequest::GetId() const
{
    return m_id;
}

void ModifyCustomizeTemplatesFullByIdRequest::SetId(const int64_t& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool ModifyCustomizeTemplatesFullByIdRequest::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

UserDefinedTemplateParams ModifyCustomizeTemplatesFullByIdRequest::GetUserDefinedTemplateParams() const
{
    return m_userDefinedTemplateParams;
}

void ModifyCustomizeTemplatesFullByIdRequest::SetUserDefinedTemplateParams(const UserDefinedTemplateParams& _userDefinedTemplateParams)
{
    m_userDefinedTemplateParams = _userDefinedTemplateParams;
    m_userDefinedTemplateParamsHasBeenSet = true;
}

bool ModifyCustomizeTemplatesFullByIdRequest::UserDefinedTemplateParamsHasBeenSet() const
{
