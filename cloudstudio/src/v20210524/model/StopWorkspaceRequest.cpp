...
string StopWorkspaceRequest::ToJsonString() const
{
    ...
    if (m_forceHasBeenSet)
    {
        ...
        string key = "Force";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, rapidjson::Value(m_force.c_str(), allocator).Move(), allocator);
    }
...
string StopWorkspaceRequest::GetSpaceKey() const
{
    return m_spaceKey;
}

void StopWorkspaceRequest::SetSpaceKey(const string& _spaceKey)
{
    m_spaceKey = _spaceKey;
    m_spaceKeyHasBeenSet = true;
}

bool StopWorkspaceRequest::SpaceKeyHasBeenSet() const
{
    return m_spaceKeyHasBeenSet;
}

string StopWorkspaceRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void StopWorkspaceRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool StopWorkspaceRequest::CloudStudioSessionTeamHasBeenSet() const
{
    return m_cloudStudioSessionTeamHasBeenSet;
}

string StopWorkspaceRequest::GetForce() const
{
    return m_force;
}

void StopWorkspaceRequest::SetForce(const string& _force)
{
    m_force = _force;
    m_forceHasBeenSet = true;
}

bool StopWorkspaceRequest::ForceHasBeenSet() const
{
