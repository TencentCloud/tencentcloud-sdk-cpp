...
CoreInternalOutcome CreateWorkspaceByTemplateResponse::Deserialize(const string &payload)
{
...
string CreateWorkspaceByTemplateResponse::ToJsonString() const
{
...
WorkspaceInfo CreateWorkspaceByTemplateResponse::GetData() const
{
    return m_data;
}

bool CreateWorkspaceByTemplateResponse::DataHasBeenSet() const
{
