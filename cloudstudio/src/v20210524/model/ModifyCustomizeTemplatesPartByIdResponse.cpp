...
CoreInternalOutcome ModifyCustomizeTemplatesPartByIdResponse::Deserialize(const string &payload)
{
...
string ModifyCustomizeTemplatesPartByIdResponse::ToJsonString() const
{
...
WorkspaceTemplateInfo ModifyCustomizeTemplatesPartByIdResponse::GetData() const
{
    return m_data;
}

bool ModifyCustomizeTemplatesPartByIdResponse::DataHasBeenSet() const
{
