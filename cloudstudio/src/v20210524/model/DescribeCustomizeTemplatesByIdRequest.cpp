...
string DescribeCustomizeTemplatesByIdRequest::ToJsonString() const
{
...
string DescribeCustomizeTemplatesByIdRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeCustomizeTemplatesByIdRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeCustomizeTemplatesByIdRequest::CloudStudioSessionTeamHasBeenSet() const
{
    return m_cloudStudioSessionTeamHasBeenSet;
}

int64_t DescribeCustomizeTemplatesByIdRequest::GetId() const
{
    return m_id;
}

void DescribeCustomizeTemplatesByIdRequest::SetId(const int64_t& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool DescribeCustomizeTemplatesByIdRequest::IdHasBeenSet() const
{
