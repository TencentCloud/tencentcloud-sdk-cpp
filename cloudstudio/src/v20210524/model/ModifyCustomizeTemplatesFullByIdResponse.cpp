...
CoreInternalOutcome ModifyCustomizeTemplatesFullByIdResponse::Deserialize(const string &payload)
{
...
string ModifyCustomizeTemplatesFullByIdResponse::ToJsonString() const
{
...
WorkspaceTemplateInfo ModifyCustomizeTemplatesFullByIdResponse::GetData() const
{
    return m_data;
}

bool ModifyCustomizeTemplatesFullByIdResponse::DataHasBeenSet() const
{
