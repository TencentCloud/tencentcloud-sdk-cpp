...
CoreInternalOutcome CreateWorkspaceByAgentResponse::Deserialize(const string &payload)
{
...
string CreateWorkspaceByAgentResponse::ToJsonString() const
{
...
WorkspaceInfoDTO CreateWorkspaceByAgentResponse::GetData() const
{
    return m_data;
}

bool CreateWorkspaceByAgentResponse::DataHasBeenSet() const
{
