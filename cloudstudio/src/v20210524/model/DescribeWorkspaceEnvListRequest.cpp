...
string DescribeWorkspaceEnvListRequest::ToJsonString() const
{
...
string DescribeWorkspaceEnvListRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeWorkspaceEnvListRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeWorkspaceEnvListRequest::CloudStudioSessionTeamHasBeenSet() const
{
