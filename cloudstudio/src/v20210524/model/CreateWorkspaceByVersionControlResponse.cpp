...
CoreInternalOutcome CreateWorkspaceByVersionControlResponse::Deserialize(const string &payload)
{
...
string CreateWorkspaceByVersionControlResponse::ToJsonString() const
{
...
WorkspaceInfoDTO CreateWorkspaceByVersionControlResponse::GetData() const
{
    return m_data;
}

bool CreateWorkspaceByVersionControlResponse::DataHasBeenSet() const
{
