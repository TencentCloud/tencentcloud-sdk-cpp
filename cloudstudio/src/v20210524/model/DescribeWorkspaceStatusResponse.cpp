...
CoreInternalOutcome DescribeWorkspaceStatusResponse::Deserialize(const string &payload)
{
...
string DescribeWorkspaceStatusResponse::ToJsonString() const
{
...
WorkspaceStatusInfo DescribeWorkspaceStatusResponse::GetData() const
{
    return m_data;
}

bool DescribeWorkspaceStatusResponse::DataHasBeenSet() const
{
