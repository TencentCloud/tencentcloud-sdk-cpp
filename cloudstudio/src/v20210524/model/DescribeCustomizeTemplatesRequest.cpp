...
string DescribeCustomizeTemplatesRequest::ToJsonString() const
{
...
string DescribeCustomizeTemplatesRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeCustomizeTemplatesRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeCustomizeTemplatesRequest::CloudStudioSessionTeamHasBeenSet() const
{
