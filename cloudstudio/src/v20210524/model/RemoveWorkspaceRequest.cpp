...
string RemoveWorkspaceRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void RemoveWorkspaceRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool RemoveWorkspaceRequest::CloudStudioSessionTeamHasBeenSet() const
{
...
bool RemoveWorkspaceRequest::GetForce() const
{
    return m_force;
}

void RemoveWorkspaceRequest::SetForce(const bool& _force)
{
    m_force = _force;
    m_forceHasBeenSet = true;
}

bool RemoveWorkspaceRequest::ForceHasBeenSet() const
{
