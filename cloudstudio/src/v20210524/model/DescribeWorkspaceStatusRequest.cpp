...
string DescribeWorkspaceStatusRequest::ToJsonString() const
{
...
string DescribeWorkspaceStatusRequest::GetCloudStudioSessionTeam() const
{
    return m_cloudStudioSessionTeam;
}

void DescribeWorkspaceStatusRequest::SetCloudStudioSessionTeam(const string& _cloudStudioSessionTeam)
{
    m_cloudStudioSessionTeam = _cloudStudioSessionTeam;
    m_cloudStudioSessionTeamHasBeenSet = true;
}

bool DescribeWorkspaceStatusRequest::CloudStudioSessionTeamHasBeenSet() const
{
    return m_cloudStudioSessionTeamHasBeenSet;
}

string DescribeWorkspaceStatusRequest::GetSpaceKey() const
{
    return m_spaceKey;
}

void DescribeWorkspaceStatusRequest::SetSpaceKey(const string& _spaceKey)
{
    m_spaceKey = _spaceKey;
    m_spaceKeyHasBeenSet = true;
}

bool DescribeWorkspaceStatusRequest::SpaceKeyHasBeenSet() const
{
