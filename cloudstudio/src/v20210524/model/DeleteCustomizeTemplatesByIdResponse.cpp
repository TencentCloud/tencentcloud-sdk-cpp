...
CoreInternalOutcome DeleteCustomizeTemplatesByIdResponse::Deserialize(const string &payload)
{
...
string DeleteCustomizeTemplatesByIdResponse::ToJsonString() const
{
