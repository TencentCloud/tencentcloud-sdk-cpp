...
CoreInternalOutcome CreateCustomizeTemplatesResponse::Deserialize(const string &payload)
{
...
string CreateCustomizeTemplatesResponse::ToJsonString() const
{
...
WorkspaceTemplateInfo CreateCustomizeTemplatesResponse::GetData() const
{
    return m_data;
}

bool CreateCustomizeTemplatesResponse::DataHasBeenSet() const
{
