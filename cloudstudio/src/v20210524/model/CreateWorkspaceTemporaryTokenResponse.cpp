...
CoreInternalOutcome CreateWorkspaceTemporaryTokenResponse::Deserialize(const string &payload)
{
...
string CreateWorkspaceTemporaryTokenResponse::ToJsonString() const
{
...
WorkspaceTokenInfoV0 CreateWorkspaceTemporaryTokenResponse::GetData() const
{
    return m_data;
}

bool CreateWorkspaceTemporaryTokenResponse::DataHasBeenSet() const
{
