...
CoreInternalOutcome DescribeWorkspaceNameExistResponse::Deserialize(const string &payload)
{
...
string DescribeWorkspaceNameExistResponse::ToJsonString() const
{
...
WorkspaceInfoDTO DescribeWorkspaceNameExistResponse::GetData() const
{
    return m_data;
}

bool DescribeWorkspaceNameExistResponse::DataHasBeenSet() const
{
