...
CoreInternalOutcome DescribeCustomizeTemplatesPresetsResponse::Deserialize(const string &payload)
{
...
string DescribeCustomizeTemplatesPresetsResponse::ToJsonString() const
{
...
CustomizeTemplatesPresetsInfo DescribeCustomizeTemplatesPresetsResponse::GetData() const
{
    return m_data;
}

bool DescribeCustomizeTemplatesPresetsResponse::DataHasBeenSet() const
{
