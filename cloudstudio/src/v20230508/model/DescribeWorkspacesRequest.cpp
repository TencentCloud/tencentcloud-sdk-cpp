...
string DescribeWorkspacesRequest::GetName() const
{
    return m_name;
}

void DescribeWorkspacesRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool DescribeWorkspacesRequest::NameHasBeenSet() const
{
