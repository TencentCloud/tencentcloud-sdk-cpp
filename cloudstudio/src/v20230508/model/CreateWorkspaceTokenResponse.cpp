...
CoreInternalOutcome CreateWorkspaceTokenResponse::Deserialize(const string &payload)
{
...
string CreateWorkspaceTokenResponse::ToJsonString() const
{
...
string CreateWorkspaceTokenResponse::GetToken() const
{
    return m_token;
}

bool CreateWorkspaceTokenResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string CreateWorkspaceTokenResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool CreateWorkspaceTokenResponse::ExpiredTimeHasBeenSet() const
{
