...
string RunWorkspaceRequest::ToJsonString() const
{
...
string RunWorkspaceRequest::GetSpaceKey() const
{
    return m_spaceKey;
}

void RunWorkspaceRequest::SetSpaceKey(const string& _spaceKey)
{
    m_spaceKey = _spaceKey;
    m_spaceKeyHasBeenSet = true;
}

bool RunWorkspaceRequest::SpaceKeyHasBeenSet() const
{
