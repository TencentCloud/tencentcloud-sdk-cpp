...
CoreInternalOutcome ListJobsResponse::Deserialize(const string &payload)
{
...
string ListJobsResponse::ToJsonString() const
{
...
vector<Job> ListJobsResponse::GetJobs() const
{
    return m_jobs;
}

bool ListJobsResponse::JobsHasBeenSet() const
{
