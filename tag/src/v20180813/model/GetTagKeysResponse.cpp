...
CoreInternalOutcome GetTagKeysResponse::Deserialize(const string &payload)
{
...
string GetTagKeysResponse::ToJsonString() const
{
...
string GetTagKeysResponse::GetPaginationToken() const
{
    return m_paginationToken;
}

bool GetTagKeysResponse::PaginationTokenHasBeenSet() const
{
    return m_paginationTokenHasBeenSet;
}

vector<string> GetTagKeysResponse::GetTagKeys() const
{
    return m_tagKeys;
}

bool GetTagKeysResponse::TagKeysHasBeenSet() const
{
