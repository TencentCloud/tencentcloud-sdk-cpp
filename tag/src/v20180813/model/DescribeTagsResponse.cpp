...
CoreInternalOutcome DescribeTagsResponse::Deserialize(const string &payload)
{
...
string DescribeTagsResponse::ToJsonString() const
{
...
uint64_t DescribeTagsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTagsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeTagsResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeTagsResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeTagsResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeTagsResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<TagWithDelete> DescribeTagsResponse::GetTags() const
{
    return m_tags;
}

bool DescribeTagsResponse::TagsHasBeenSet() const
{
