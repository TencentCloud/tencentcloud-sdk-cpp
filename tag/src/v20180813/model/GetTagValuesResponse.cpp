...
CoreInternalOutcome GetTagValuesResponse::Deserialize(const string &payload)
{
...
string GetTagValuesResponse::ToJsonString() const
{
...
string GetTagValuesResponse::GetPaginationToken() const
{
    return m_paginationToken;
}

bool GetTagValuesResponse::PaginationTokenHasBeenSet() const
{
    return m_paginationTokenHasBeenSet;
}

vector<Tag> GetTagValuesResponse::GetTags() const
{
    return m_tags;
}

bool GetTagValuesResponse::TagsHasBeenSet() const
{
