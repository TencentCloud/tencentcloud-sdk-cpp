...
CoreInternalOutcome TagResourcesResponse::Deserialize(const string &payload)
{
...
string TagResourcesResponse::ToJsonString() const
{
...
vector<FailedResource> TagResourcesResponse::GetFailedResources() const
{
    return m_failedResources;
}

bool TagResourcesResponse::FailedResourcesHasBeenSet() const
{
