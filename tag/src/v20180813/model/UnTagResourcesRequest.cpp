...
string UnTagResourcesRequest::ToJsonString() const
{
...
vector<string> UnTagResourcesRequest::GetResourceList() const
{
    return m_resourceList;
}

void UnTagResourcesRequest::SetResourceList(const vector<string>& _resourceList)
{
    m_resourceList = _resourceList;
    m_resourceListHasBeenSet = true;
}

bool UnTagResourcesRequest::ResourceListHasBeenSet() const
{
    return m_resourceListHasBeenSet;
}

vector<string> UnTagResourcesRequest::GetTagKeys() const
{
    return m_tagKeys;
}

void UnTagResourcesRequest::SetTagKeys(const vector<string>& _tagKeys)
{
    m_tagKeys = _tagKeys;
    m_tagKeysHasBeenSet = true;
}

bool UnTagResourcesRequest::TagKeysHasBeenSet() const
{
