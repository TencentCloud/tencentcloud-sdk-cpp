...
CoreInternalOutcome UnTagResourcesResponse::Deserialize(const string &payload)
{
...
string UnTagResourcesResponse::ToJsonString() const
{
...
vector<FailedResource> UnTagResourcesResponse::GetFailedResources() const
{
    return m_failedResources;
}

bool UnTagResourcesResponse::FailedResourcesHasBeenSet() const
{
