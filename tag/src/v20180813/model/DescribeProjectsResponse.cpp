...
uint64_t DescribeProjectsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeProjectsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<Project> DescribeProjectsResponse::GetProjects() const
{
    return m_projects;
}

bool DescribeProjectsResponse::ProjectsHasBeenSet() const
{
