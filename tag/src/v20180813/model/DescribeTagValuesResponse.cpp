...
uint64_t DescribeTagValuesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTagValuesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeTagValuesResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeTagValuesResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeTagValuesResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeTagValuesResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<Tag> DescribeTagValuesResponse::GetTags() const
{
    return m_tags;
}

bool DescribeTagValuesResponse::TagsHasBeenSet() const
{
