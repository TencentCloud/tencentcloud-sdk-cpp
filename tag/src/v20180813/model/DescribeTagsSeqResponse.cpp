...
CoreInternalOutcome DescribeTagsSeqResponse::Deserialize(const string &payload)
{
...
string DescribeTagsSeqResponse::ToJsonString() const
{
...
uint64_t DescribeTagsSeqResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTagsSeqResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeTagsSeqResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeTagsSeqResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeTagsSeqResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeTagsSeqResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<TagWithDelete> DescribeTagsSeqResponse::GetTags() const
{
    return m_tags;
}

bool DescribeTagsSeqResponse::TagsHasBeenSet() const
{
