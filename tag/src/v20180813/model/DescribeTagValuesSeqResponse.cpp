...
CoreInternalOutcome DescribeTagValuesSeqResponse::Deserialize(const string &payload)
{
...
string DescribeTagValuesSeqResponse::ToJsonString() const
{
...
uint64_t DescribeTagValuesSeqResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTagValuesSeqResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeTagValuesSeqResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeTagValuesSeqResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeTagValuesSeqResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeTagValuesSeqResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<Tag> DescribeTagValuesSeqResponse::GetTags() const
{
    return m_tags;
}

bool DescribeTagValuesSeqResponse::TagsHasBeenSet() const
{
