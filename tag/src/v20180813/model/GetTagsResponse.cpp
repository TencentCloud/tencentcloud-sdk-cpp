...
CoreInternalOutcome GetTagsResponse::Deserialize(const string &payload)
{
...
string GetTagsResponse::ToJsonString() const
{
...
string GetTagsResponse::GetPaginationToken() const
{
    return m_paginationToken;
}

bool GetTagsResponse::PaginationTokenHasBeenSet() const
{
    return m_paginationTokenHasBeenSet;
}

vector<Tag> GetTagsResponse::GetTags() const
{
    return m_tags;
}

bool GetTagsResponse::TagsHasBeenSet() const
{
