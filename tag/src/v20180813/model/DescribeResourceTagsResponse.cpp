...
CoreInternalOutcome DescribeResourceTagsResponse::Deserialize(const string &payload)
{
...
string DescribeResourceTagsResponse::ToJsonString() const
{
...
uint64_t DescribeResourceTagsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeResourceTagsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

uint64_t DescribeResourceTagsResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeResourceTagsResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeResourceTagsResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeResourceTagsResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<TagResource> DescribeResourceTagsResponse::GetRows() const
{
    return m_rows;
}

bool DescribeResourceTagsResponse::RowsHasBeenSet() const
{
