...
string DeleteTagRequest::GetTagKey() const
{
    return m_tagKey;
}

void DeleteTagRequest::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool DeleteTagRequest::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string DeleteTagRequest::GetTagValue() const
{
    return m_tagValue;
}

void DeleteTagRequest::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool DeleteTagRequest::TagValueHasBeenSet() const
{
