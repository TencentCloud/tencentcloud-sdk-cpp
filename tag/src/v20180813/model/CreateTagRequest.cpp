...
string CreateTagRequest::GetTagKey() const
{
    return m_tagKey;
}

void CreateTagRequest::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool CreateTagRequest::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string CreateTagRequest::GetTagValue() const
{
    return m_tagValue;
}

void CreateTagRequest::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool CreateTagRequest::TagValueHasBeenSet() const
{
