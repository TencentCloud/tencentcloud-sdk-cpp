...
#ifndef TENCENTCLOUD_TAG_V20180813_MODEL_RESOURCESTAG_H_
#define TENCENTCLOUD_TAG_V20180813_MODEL_RESOURCESTAG_H_
    ...
    namespace Tag
    {
        namespace V20180813
        {
            namespace Model
            {
                ...
                * 资源标签
                */
                class ResourcesTag : public AbstractModel
                {
                public:
                    ResourcesTag();
                    ~ResourcesTag() = default;
...
#endif // !TENCENTCLOUD_TAG_V20180813_MODEL_RESOURCESTAG_H_
