...
string ChartNameValue::GetName() const
{
    return m_name;
}

void ChartNameValue::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool ChartNameValue::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

int64_t ChartNameValue::GetValue() const
{
    return m_value;
}

void ChartNameValue::SetValue(const int64_t& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool ChartNameValue::ValueHasBeenSet() const
{
