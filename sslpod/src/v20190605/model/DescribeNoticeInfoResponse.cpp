...
CoreInternalOutcome DescribeNoticeInfoResponse::Deserialize(const string &payload)
{
...
string DescribeNoticeInfoResponse::ToJsonString() const
{
...
NoticeInfoResult DescribeNoticeInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeNoticeInfoResponse::DataHasBeenSet() const
{
