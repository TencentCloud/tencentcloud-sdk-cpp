...
CoreInternalOutcome ChartHistogram::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ChartHistogram::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
