...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYTAGRESPONSE_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYTAGRESPONSE_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeCostSummaryByTagResponse : public AbstractModel
                {
                public:
                    DescribeCostSummaryByTagResponse();
                    ~DescribeCostSummaryByTagResponse() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYTAGRESPONSE_H_
