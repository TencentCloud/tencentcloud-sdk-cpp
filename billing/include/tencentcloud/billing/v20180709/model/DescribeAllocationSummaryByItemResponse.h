...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYITEMRESPONSE_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYITEMRESPONSE_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeAllocationSummaryByItemResponse : public AbstractModel
                {
                public:
                    DescribeAllocationSummaryByItemResponse();
                    ~DescribeAllocationSummaryByItemResponse() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYITEMRESPONSE_H_
