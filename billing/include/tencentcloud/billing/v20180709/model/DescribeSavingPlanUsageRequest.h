...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBESAVINGPLANUSAGEREQUEST_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBESAVINGPLANUSAGEREQUEST_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeSavingPlanUsageRequest : public AbstractModel
                {
                public:
                    DescribeSavingPlanUsageRequest();
                    ~DescribeSavingPlanUsageRequest() = default;
                    ...
                    /**
                     * 获取查询结果数据的时间间隔
                     * @return TimeInterval 查询结果数据的时间间隔
                     * 
                     */
                     ...
                     * 
                     */
                    void SetTimeInterval(const std::string& _timeInterval);
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBESAVINGPLANUSAGEREQUEST_H_
