...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_ALLOCATIONMONTHOVERVIEWDETAIL_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_ALLOCATIONMONTHOVERVIEWDETAIL_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                * 分账账单月概览金额明细
                */
                class AllocationMonthOverviewDetail : public AbstractModel
                {
                public:
                    AllocationMonthOverviewDetail();
                    ~AllocationMonthOverviewDetail() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_ALLOCATIONMONTHOVERVIEWDETAIL_H_
