...
CoreInternalOutcome DescribeBillSummaryByProductResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SummaryTotal") && !rsp["SummaryTotal"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `SummaryTotal` is not object type").SetRequestId(requestId));
        }
...
uint64_t DescribeBillSummaryByProductResponse::GetReady() const
{
    return m_ready;
}

bool DescribeBillSummaryByProductResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

BusinessSummaryTotal DescribeBillSummaryByProductResponse::GetSummaryTotal() const
{
    return m_summaryTotal;
}

bool DescribeBillSummaryByProductResponse::SummaryTotalHasBeenSet() const
{
