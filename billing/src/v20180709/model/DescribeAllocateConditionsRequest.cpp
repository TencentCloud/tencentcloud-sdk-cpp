...
string DescribeAllocateConditionsRequest::ToJsonString() const
{
...
string DescribeAllocateConditionsRequest::GetMonth() const
{
    return m_month;
}

void DescribeAllocateConditionsRequest::SetMonth(const string& _month)
{
    m_month = _month;
    m_monthHasBeenSet = true;
}

bool DescribeAllocateConditionsRequest::MonthHasBeenSet() const
{
