...
CoreInternalOutcome DescribeAllocationRuleSummaryResponse::Deserialize(const string &payload)
{
...
string DescribeAllocationRuleSummaryResponse::ToJsonString() const
{
...
vector<AllocationRuleOverview> DescribeAllocationRuleSummaryResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeAllocationRuleSummaryResponse::RuleListHasBeenSet() const
{
    return m_ruleListHasBeenSet;
}

uint64_t DescribeAllocationRuleSummaryResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationRuleSummaryResponse::TotalHasBeenSet() const
{
