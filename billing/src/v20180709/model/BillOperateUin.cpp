...
CoreInternalOutcome BillOperateUin::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("OperateUin") && !value["OperateUin"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `BillOperateUin.OperateUin` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void BillOperateUin::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string BillOperateUin::GetOperateUin() const
{
    return m_operateUin;
}

void BillOperateUin::SetOperateUin(const string& _operateUin)
{
    m_operateUin = _operateUin;
    m_operateUinHasBeenSet = true;
}

bool BillOperateUin::OperateUinHasBeenSet() const
{
