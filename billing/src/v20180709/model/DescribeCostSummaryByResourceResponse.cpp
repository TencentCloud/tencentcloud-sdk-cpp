...
CoreInternalOutcome DescribeCostSummaryByResourceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ConditionValue") && !rsp["ConditionValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConditionValue` is not object type").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("Data") && !rsp["Data"].IsNull())
    {
        ...
        {
            ConsumptionResourceSummaryDataItem item;
...
string DescribeCostSummaryByResourceResponse::ToJsonString() const
{
...
uint64_t DescribeCostSummaryByResourceResponse::GetReady() const
{
    return m_ready;
}

bool DescribeCostSummaryByResourceResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

ConsumptionSummaryTotal DescribeCostSummaryByResourceResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCostSummaryByResourceResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

ConsumptionResourceSummaryConditionValue DescribeCostSummaryByResourceResponse::GetConditionValue() const
{
    return m_conditionValue;
}

bool DescribeCostSummaryByResourceResponse::ConditionValueHasBeenSet() const
{
    return m_conditionValueHasBeenSet;
}

uint64_t DescribeCostSummaryByResourceResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeCostSummaryByResourceResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

vector<ConsumptionResourceSummaryDataItem> DescribeCostSummaryByResourceResponse::GetData() const
{
    return m_data;
}

bool DescribeCostSummaryByResourceResponse::DataHasBeenSet() const
{
