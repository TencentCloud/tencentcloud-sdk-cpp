...
BudgetInfoApiResponse CreateBudgetResponse::GetData() const
{
    return m_data;
}

bool CreateBudgetResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateBudgetResponse::GetMessage() const
{
    return m_message;
}

bool CreateBudgetResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t CreateBudgetResponse::GetCode() const
{
    return m_code;
}

bool CreateBudgetResponse::CodeHasBeenSet() const
{
