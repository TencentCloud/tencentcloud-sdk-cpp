...
CoreInternalOutcome ConsumptionRegionSummaryDataItem::Deserialize(const Value &value)
{
    string requestId = "";
...
void ConsumptionRegionSummaryDataItem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
