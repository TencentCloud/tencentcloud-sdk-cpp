...
CoreInternalOutcome DescribeBillSummaryByProjectResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SummaryOverview") && !rsp["SummaryOverview"].IsNull())
    {
        ...
        {
            ProjectSummaryOverviewItem item;
...
string DescribeBillSummaryByProjectResponse::ToJsonString() const
{
...
uint64_t DescribeBillSummaryByProjectResponse::GetReady() const
{
    return m_ready;
}

bool DescribeBillSummaryByProjectResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

vector<ProjectSummaryOverviewItem> DescribeBillSummaryByProjectResponse::GetSummaryOverview() const
{
    return m_summaryOverview;
}

bool DescribeBillSummaryByProjectResponse::SummaryOverviewHasBeenSet() const
{
