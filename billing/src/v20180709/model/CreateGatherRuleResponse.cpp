...
CoreInternalOutcome CreateGatherRuleResponse::Deserialize(const string &payload)
{
...
string CreateGatherRuleResponse::ToJsonString() const
{
...
uint64_t CreateGatherRuleResponse::GetId() const
{
    return m_id;
}

bool CreateGatherRuleResponse::IdHasBeenSet() const
{
