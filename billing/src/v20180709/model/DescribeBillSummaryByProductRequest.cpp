...
void DescribeBillSummaryByProductRequest::SetBeginTime(const string& _beginTime)
{
    m_beginTime = _beginTime;
    m_beginTimeHasBeenSet = true;
}

bool DescribeBillSummaryByProductRequest::BeginTimeHasBeenSet() const
{
    return m_beginTimeHasBeenSet;
}

string DescribeBillSummaryByProductRequest::GetEndTime() const
{
    return m_endTime;
}

void DescribeBillSummaryByProductRequest::SetEndTime(const string& _endTime)
{
    m_endTime = _endTime;
