...
CoreInternalOutcome ConditionProject::Deserialize(const Value &value)
{
    string requestId = "";
...
void ConditionProject::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
