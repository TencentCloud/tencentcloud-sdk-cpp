...
DescribeDosageDetailListResponse::DescribeDosageDetailListResponse() :
    m_recordHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDosageDetailListResponse::Deserialize(const string &payload)
{
...
string DescribeDosageDetailListResponse::ToJsonString() const
{
...
vector<DescribeDosageDetail> DescribeDosageDetailListResponse::GetRecord() const
{
    return m_record;
}

bool DescribeDosageDetailListResponse::RecordHasBeenSet() const
{
