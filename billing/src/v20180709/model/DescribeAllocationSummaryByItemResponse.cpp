...
CoreInternalOutcome DescribeAllocationSummaryByItemResponse::Deserialize(const string &payload)
{
...
string DescribeAllocationSummaryByItemResponse::ToJsonString() const
{
...
uint64_t DescribeAllocationSummaryByItemResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeAllocationSummaryByItemResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

AllocationOverviewTotal DescribeAllocationSummaryByItemResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationSummaryByItemResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AllocationSummaryByItem> DescribeAllocationSummaryByItemResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeAllocationSummaryByItemResponse::DetailHasBeenSet() const
{
