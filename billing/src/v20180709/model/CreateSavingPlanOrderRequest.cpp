...
uint64_t CreateSavingPlanOrderRequest::GetTimeSpan() const
{
    return m_timeSpan;
}

void CreateSavingPlanOrderRequest::SetTimeSpan(const uint64_t& _timeSpan)
{
...
uint64_t CreateSavingPlanOrderRequest::GetPromiseUseAmount() const
{
    return m_promiseUseAmount;
}

void CreateSavingPlanOrderRequest::SetPromiseUseAmount(const uint64_t& _promiseUseAmount)
{
