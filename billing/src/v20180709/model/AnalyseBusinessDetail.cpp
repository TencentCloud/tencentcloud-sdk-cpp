...
CoreInternalOutcome AnalyseBusinessDetail::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BusinessCode") && !value["BusinessCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AnalyseBusinessDetail.BusinessCode` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BusinessCodeName") && !value["BusinessCodeName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AnalyseBusinessDetail.BusinessCodeName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void AnalyseBusinessDetail::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string AnalyseBusinessDetail::GetBusinessCode() const
{
    return m_businessCode;
}

void AnalyseBusinessDetail::SetBusinessCode(const string& _businessCode)
{
    m_businessCode = _businessCode;
    m_businessCodeHasBeenSet = true;
}

bool AnalyseBusinessDetail::BusinessCodeHasBeenSet() const
{
    return m_businessCodeHasBeenSet;
}

string AnalyseBusinessDetail::GetBusinessCodeName() const
{
    return m_businessCodeName;
}

void AnalyseBusinessDetail::SetBusinessCodeName(const string& _businessCodeName)
{
    m_businessCodeName = _businessCodeName;
    m_businessCodeNameHasBeenSet = true;
}

bool AnalyseBusinessDetail::BusinessCodeNameHasBeenSet() const
{
