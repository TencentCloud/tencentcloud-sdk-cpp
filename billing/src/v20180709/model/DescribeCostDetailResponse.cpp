...
CoreInternalOutcome DescribeCostDetailResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("DetailSet") && !rsp["DetailSet"].IsNull())
    {
        if (!rsp["DetailSet"].IsArray())
            return CoreInternalOutcome(Error("response `DetailSet` is not array type"));
...
string DescribeCostDetailResponse::ToJsonString() const
{
...
vector<CostDetail> DescribeCostDetailResponse::GetDetailSet() const
{
    return m_detailSet;
}

bool DescribeCostDetailResponse::DetailSetHasBeenSet() const
{
    return m_detailSetHasBeenSet;
}

uint64_t DescribeCostDetailResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCostDetailResponse::TotalHasBeenSet() const
{
