...
CoreInternalOutcome CreateAllocationRuleResponse::Deserialize(const string &payload)
{
...
string CreateAllocationRuleResponse::ToJsonString() const
{
...
uint64_t CreateAllocationRuleResponse::GetId() const
{
    return m_id;
}

bool CreateAllocationRuleResponse::IdHasBeenSet() const
{
