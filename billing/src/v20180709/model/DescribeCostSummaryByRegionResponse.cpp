...
CoreInternalOutcome DescribeCostSummaryByRegionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Data") && !rsp["Data"].IsNull())
    {
        ...
        {
            ConsumptionRegionSummaryDataItem item;
...
string DescribeCostSummaryByRegionResponse::ToJsonString() const
{
...
uint64_t DescribeCostSummaryByRegionResponse::GetReady() const
{
    return m_ready;
}

bool DescribeCostSummaryByRegionResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

ConsumptionSummaryTotal DescribeCostSummaryByRegionResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCostSummaryByRegionResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ConsumptionRegionSummaryDataItem> DescribeCostSummaryByRegionResponse::GetData() const
{
    return m_data;
}

bool DescribeCostSummaryByRegionResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeCostSummaryByRegionResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeCostSummaryByRegionResponse::RecordNumHasBeenSet() const
{
