...
CoreInternalOutcome DescribeBillResourceSummaryForOrganizationResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ResourceSummarySet") && !rsp["ResourceSummarySet"].IsNull())
    {
        ...
        {
            BillDistributionResourceSummary item;
...
string DescribeBillResourceSummaryForOrganizationResponse::ToJsonString() const
{
...
vector<BillDistributionResourceSummary> DescribeBillResourceSummaryForOrganizationResponse::GetResourceSummarySet() const
{
    return m_resourceSummarySet;
}

bool DescribeBillResourceSummaryForOrganizationResponse::ResourceSummarySetHasBeenSet() const
{
    return m_resourceSummarySetHasBeenSet;
}

int64_t DescribeBillResourceSummaryForOrganizationResponse::GetTotal() const
{
    return m_total;
}

bool DescribeBillResourceSummaryForOrganizationResponse::TotalHasBeenSet() const
{
