...
CoreInternalOutcome DescribeAllocationSummaryByBusinessResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Detail") && !rsp["Detail"].IsNull())
    {
        ...
        {
            AllocationSummaryByBusiness item;
...
string DescribeAllocationSummaryByBusinessResponse::ToJsonString() const
{
...
uint64_t DescribeAllocationSummaryByBusinessResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeAllocationSummaryByBusinessResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

AllocationOverviewTotal DescribeAllocationSummaryByBusinessResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationSummaryByBusinessResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AllocationSummaryByBusiness> DescribeAllocationSummaryByBusinessResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeAllocationSummaryByBusinessResponse::DetailHasBeenSet() const
{
