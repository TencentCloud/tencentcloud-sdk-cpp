...
string DescribeAllocationTreeRequest::ToJsonString() const
{
...
string DescribeAllocationTreeRequest::GetMonth() const
{
    return m_month;
}

void DescribeAllocationTreeRequest::SetMonth(const string& _month)
{
    m_month = _month;
    m_monthHasBeenSet = true;
}

bool DescribeAllocationTreeRequest::MonthHasBeenSet() const
{
