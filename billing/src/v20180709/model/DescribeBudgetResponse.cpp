...
#include <tencentcloud/billing/v20180709/model/DescribeBudgetResponse.h>
...
CoreInternalOutcome DescribeBudgetResponse::Deserialize(const string &payload)
{
...
string DescribeBudgetResponse::ToJsonString() const
{
...
DataForBudgetInfoPage DescribeBudgetResponse::GetData() const
{
    return m_data;
}

bool DescribeBudgetResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeBudgetResponse::GetMessage() const
{
    return m_message;
}

bool DescribeBudgetResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeBudgetResponse::GetCode() const
{
    return m_code;
}

bool DescribeBudgetResponse::CodeHasBeenSet() const
{
