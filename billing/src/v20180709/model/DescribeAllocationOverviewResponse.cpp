...
CoreInternalOutcome DescribeAllocationOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeAllocationOverviewResponse::ToJsonString() const
{
...
uint64_t DescribeAllocationOverviewResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeAllocationOverviewResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

AllocationOverviewTotal DescribeAllocationOverviewResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationOverviewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AllocationOverviewDetail> DescribeAllocationOverviewResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeAllocationOverviewResponse::DetailHasBeenSet() const
{
