...
CoreInternalOutcome ModifyBudgetResponse::Deserialize(const string &payload)
{
...
string ModifyBudgetResponse::ToJsonString() const
{
...
BudgetInfoApiResponse ModifyBudgetResponse::GetData() const
{
    return m_data;
}

bool ModifyBudgetResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyBudgetResponse::GetMessage() const
{
    return m_message;
}

bool ModifyBudgetResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t ModifyBudgetResponse::GetCode() const
{
    return m_code;
}

bool ModifyBudgetResponse::CodeHasBeenSet() const
{
