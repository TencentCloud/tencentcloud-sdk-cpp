...
vector<BillDetail> DescribeBillDetailResponse::GetDetailSet() const
{
    return m_detailSet;
}
...
string DescribeBillDetailResponse::GetContext() const
{
    return m_context;
}

bool DescribeBillDetailResponse::ContextHasBeenSet() const
{
