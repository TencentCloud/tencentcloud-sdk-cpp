...
DescribeCostSummaryByTagResponse::DescribeCostSummaryByTagResponse() :
...
CoreInternalOutcome DescribeCostSummaryByTagResponse::Deserialize(const string &payload)
{
...
string DescribeCostSummaryByTagResponse::ToJsonString() const
{
...
uint64_t DescribeCostSummaryByTagResponse::GetReady() const
{
    return m_ready;
}

bool DescribeCostSummaryByTagResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

vector<TagSummaryOverviewItem> DescribeCostSummaryByTagResponse::GetSummaryOverview() const
{
    return m_summaryOverview;
}

bool DescribeCostSummaryByTagResponse::SummaryOverviewHasBeenSet() const
{
    return m_summaryOverviewHasBeenSet;
}

SummaryTotal DescribeCostSummaryByTagResponse::GetSummaryTotal() const
{
    return m_summaryTotal;
}

bool DescribeCostSummaryByTagResponse::SummaryTotalHasBeenSet() const
{
