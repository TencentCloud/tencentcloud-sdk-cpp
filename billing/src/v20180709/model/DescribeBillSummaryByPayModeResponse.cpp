...
CoreInternalOutcome DescribeBillSummaryByPayModeResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SummaryOverview") && !rsp["SummaryOverview"].IsNull())
    {
        ...
        {
            PayModeSummaryOverviewItem item;
...
string DescribeBillSummaryByPayModeResponse::ToJsonString() const
{
...
uint64_t DescribeBillSummaryByPayModeResponse::GetReady() const
{
    return m_ready;
}

bool DescribeBillSummaryByPayModeResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

vector<PayModeSummaryOverviewItem> DescribeBillSummaryByPayModeResponse::GetSummaryOverview() const
{
    return m_summaryOverview;
}

bool DescribeBillSummaryByPayModeResponse::SummaryOverviewHasBeenSet() const
{
