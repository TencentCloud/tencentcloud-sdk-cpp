...
CoreInternalOutcome DescribeTagListResponse::Deserialize(const string &payload)
{
...
string DescribeTagListResponse::ToJsonString() const
{
...
uint64_t DescribeTagListResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeTagListResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

vector<TagDataInfo> DescribeTagListResponse::GetData() const
{
    return m_data;
}

bool DescribeTagListResponse::DataHasBeenSet() const
{
