...
CoreInternalOutcome ConditionRegion::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("RegionId") && !value["RegionId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConditionRegion.RegionId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegionName") && !value["RegionName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ConditionRegion.RegionName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ConditionRegion::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
