...
CoreInternalOutcome DetailSet::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("DetailPoints") && !value["DetailPoints"].IsNull())
    {
        ...
        const Value &tmpValue = value["DetailPoints"];
...
void DetailSet::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
