...
CoreInternalOutcome DescribeDosageCosDetailByDateResponse::Deserialize(const string &payload)
{
...
string DescribeDosageCosDetailByDateResponse::ToJsonString() const
{
...
vector<CosDetailSets> DescribeDosageCosDetailByDateResponse::GetDetailSets() const
{
    return m_detailSets;
}

bool DescribeDosageCosDetailByDateResponse::DetailSetsHasBeenSet() const
{
