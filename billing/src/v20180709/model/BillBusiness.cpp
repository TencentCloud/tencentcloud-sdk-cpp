...
CoreInternalOutcome BillBusiness::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BusinessCode") && !value["BusinessCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `BillBusiness.BusinessCode` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BusinessCodeName") && !value["BusinessCodeName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `BillBusiness.BusinessCodeName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void BillBusiness::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string BillBusiness::GetBusinessCode() const
{
    return m_businessCode;
}

void BillBusiness::SetBusinessCode(const string& _businessCode)
{
    m_businessCode = _businessCode;
    m_businessCodeHasBeenSet = true;
}

bool BillBusiness::BusinessCodeHasBeenSet() const
{
    return m_businessCodeHasBeenSet;
}

string BillBusiness::GetBusinessCodeName() const
{
    return m_businessCodeName;
}

void BillBusiness::SetBusinessCodeName(const string& _businessCodeName)
{
    m_businessCodeName = _businessCodeName;
    m_businessCodeNameHasBeenSet = true;
}

bool BillBusiness::BusinessCodeNameHasBeenSet() const
{
