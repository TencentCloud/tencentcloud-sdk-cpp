...
CoreInternalOutcome DescribeAllocationMonthOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeAllocationMonthOverviewResponse::ToJsonString() const
{
...
vector<AllocationOverviewNode> DescribeAllocationMonthOverviewResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeAllocationMonthOverviewResponse::DetailHasBeenSet() const
{
    return m_detailHasBeenSet;
}

AllocationOverviewTotal DescribeAllocationMonthOverviewResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationMonthOverviewResponse::TotalHasBeenSet() const
{
