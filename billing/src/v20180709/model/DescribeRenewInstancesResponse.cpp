...
CoreInternalOutcome DescribeRenewInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeRenewInstancesResponse::ToJsonString() const
{
...
vector<RenewInstance> DescribeRenewInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeRenewInstancesResponse::InstanceListHasBeenSet() const
{
    return m_instanceListHasBeenSet;
}

string DescribeRenewInstancesResponse::GetNextToken() const
{
    return m_nextToken;
}

bool DescribeRenewInstancesResponse::NextTokenHasBeenSet() const
{
