...
CoreInternalOutcome ConditionBusiness::Deserialize(const Value &value)
{
    string requestId = "";
...
void ConditionBusiness::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
