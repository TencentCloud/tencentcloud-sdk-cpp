...
CoreInternalOutcome DescribeCostSummaryByProjectResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Data") && !rsp["Data"].IsNull())
    {
        ...
        {
            ConsumptionProjectSummaryDataItem item;
...
string DescribeCostSummaryByProjectResponse::ToJsonString() const
{
...
uint64_t DescribeCostSummaryByProjectResponse::GetReady() const
{
    return m_ready;
}

bool DescribeCostSummaryByProjectResponse::ReadyHasBeenSet() const
{
    return m_readyHasBeenSet;
}

ConsumptionSummaryTotal DescribeCostSummaryByProjectResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCostSummaryByProjectResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ConsumptionProjectSummaryDataItem> DescribeCostSummaryByProjectResponse::GetData() const
{
    return m_data;
}

bool DescribeCostSummaryByProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeCostSummaryByProjectResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeCostSummaryByProjectResponse::RecordNumHasBeenSet() const
{
