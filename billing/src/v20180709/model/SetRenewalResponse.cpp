...
CoreInternalOutcome SetRenewalResponse::Deserialize(const string &payload)
{
...
string SetRenewalResponse::ToJsonString() const
{
...
vector<OperateRsp> SetRenewalResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool SetRenewalResponse::InstanceListHasBeenSet() const
{
