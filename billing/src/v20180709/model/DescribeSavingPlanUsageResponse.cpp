...
DescribeSavingPlanUsageResponse::DescribeSavingPlanUsageResponse() :
    m_usagesHasBeenSet(false),
    m_totalHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSavingPlanUsageResponse::Deserialize(const string &payload)
{
...
string DescribeSavingPlanUsageResponse::ToJsonString() const
{
...
vector<SavingPlanUsageDetail> DescribeSavingPlanUsageResponse::GetUsages() const
{
    return m_usages;
}

bool DescribeSavingPlanUsageResponse::UsagesHasBeenSet() const
{
    return m_usagesHasBeenSet;
}

uint64_t DescribeSavingPlanUsageResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSavingPlanUsageResponse::TotalHasBeenSet() const
{
