...
CoreInternalOutcome DescribeBudgetOperationLogResponse::Deserialize(const string &payload)
{
...
string DescribeBudgetOperationLogResponse::ToJsonString() const
{
...
DataForBudgetOperationLogPage DescribeBudgetOperationLogResponse::GetData() const
{
    return m_data;
}

bool DescribeBudgetOperationLogResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeBudgetOperationLogResponse::GetMessage() const
{
    return m_message;
}

bool DescribeBudgetOperationLogResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeBudgetOperationLogResponse::GetCode() const
{
    return m_code;
}

bool DescribeBudgetOperationLogResponse::CodeHasBeenSet() const
{
