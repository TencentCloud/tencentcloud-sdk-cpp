...
CoreInternalOutcome CreateAllocationUnitResponse::Deserialize(const string &payload)
{
...
string CreateAllocationUnitResponse::ToJsonString() const
{
...
uint64_t CreateAllocationUnitResponse::GetId() const
{
    return m_id;
}

bool CreateAllocationUnitResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateAllocationUnitResponse::GetTreeNodeUniqKey() const
{
    return m_treeNodeUniqKey;
}

bool CreateAllocationUnitResponse::TreeNodeUniqKeyHasBeenSet() const
{
