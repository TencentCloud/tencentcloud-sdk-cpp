...
CoreInternalOutcome DescribeBillDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeBillDownloadUrlResponse::ToJsonString() const
{
...
string DescribeBillDownloadUrlResponse::GetDownloadUrl() const
{
