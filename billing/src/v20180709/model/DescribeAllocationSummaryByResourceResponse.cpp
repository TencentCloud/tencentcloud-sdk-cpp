...
CoreInternalOutcome DescribeAllocationSummaryByResourceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Detail") && !rsp["Detail"].IsNull())
    {
        ...
        {
            AllocationSummaryByResource item;
...
string DescribeAllocationSummaryByResourceResponse::ToJsonString() const
{
...
uint64_t DescribeAllocationSummaryByResourceResponse::GetRecordNum() const
{
    return m_recordNum;
}

bool DescribeAllocationSummaryByResourceResponse::RecordNumHasBeenSet() const
{
    return m_recordNumHasBeenSet;
}

AllocationOverviewTotal DescribeAllocationSummaryByResourceResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAllocationSummaryByResourceResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AllocationSummaryByResource> DescribeAllocationSummaryByResourceResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeAllocationSummaryByResourceResponse::DetailHasBeenSet() const
{
