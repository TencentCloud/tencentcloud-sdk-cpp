...
#ifndef TENCENTCLOUD_BI_V20220105_MODEL_MODIFYUSERDETAILINFOREQUEST_H_
#define TENCENTCLOUD_BI_V20220105_MODEL_MODIFYUSERDETAILINFOREQUEST_H_
    ...
    namespace Bi
    {
        namespace V20220105
        {
            namespace Model
            {
                ...
                */
                class ModifyUserDetailInfoRequest : public AbstractModel
                {
                public:
                    ModifyUserDetailInfoRequest();
                    ~ModifyUserDetailInfoRequest() = default;
                    ...
                    /**
                     * 获取用户组id
                     * @return UserGroupIdList 用户组id
                     * 
                     */
                    std::vector<int64_t> GetUserGroupIdList() const;
                     ...
                     * 
                     */
                    void SetUserGroupIdList(const std::vector<int64_t>& _userGroupIdList);

                    /**
                     * 判断参数 UserGroupIdList 是否已赋值
                     * @return UserGroupIdList 是否已赋值
                     * 
                     */
                    bool UserGroupIdListHasBeenSet() const;
                ...
                private:
                     ...
                     * 用户组id
                     */
                    std::vector<int64_t> m_userGroupIdList;
                    bool m_userGroupIdListHasBeenSet;
...
#endif // !TENCENTCLOUD_BI_V20220105_MODEL_MODIFYUSERDETAILINFOREQUEST_H_
