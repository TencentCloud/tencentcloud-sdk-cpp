...
#ifndef TENCENTCLOUD_BI_V20220105_MODEL_CREATEAUTHAPIKEYREQUEST_H_
#define TENCENTCLOUD_BI_V20220105_MODEL_CREATEAUTHAPIKEYREQUEST_H_
    ...
    namespace Bi
    {
        namespace V20220105
        {
            namespace Model
            {
                ...
                */
                class CreateAuthApiKeyRequest : public AbstractModel
                {
                public:
                    CreateAuthApiKeyRequest();
                    ~CreateAuthApiKeyRequest() = default;
...
#endif // !TENCENTCLOUD_BI_V20220105_MODEL_CREATEAUTHAPIKEYREQUEST_H_
