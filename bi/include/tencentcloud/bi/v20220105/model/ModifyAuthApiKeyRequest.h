...
#ifndef TENCENTCLOUD_BI_V20220105_MODEL_MODIFYAUTHAPIKEYREQUEST_H_
#define TENCENTCLOUD_BI_V20220105_MODEL_MODIFYAUTHAPIKEYREQUEST_H_
    ...
    namespace Bi
    {
        namespace V20220105
        {
            namespace Model
            {
                ...
                */
                class ModifyAuthApiKeyRequest : public AbstractModel
                {
                public:
                    ModifyAuthApiKeyRequest();
                    ~ModifyAuthApiKeyRequest() = default;
...
#endif // !TENCENTCLOUD_BI_V20220105_MODEL_MODIFYAUTHAPIKEYREQUEST_H_
