...
ErrorInfo CreateUserGroupResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateUserGroupResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateUserGroupResponse::GetExtra() const
{
    return m_extra;
}

bool CreateUserGroupResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateUserGroupResponse::GetMsg() const
{
    return m_msg;
}

bool CreateUserGroupResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

UserGroupVO CreateUserGroupResponse::GetData() const
{
    return m_data;
}

bool CreateUserGroupResponse::DataHasBeenSet() const
{
