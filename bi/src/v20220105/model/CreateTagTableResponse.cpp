...
CoreInternalOutcome CreateTagTableResponse::Deserialize(const string &payload)
{
...
string CreateTagTableResponse::ToJsonString() const
{
...
ErrorInfo CreateTagTableResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateTagTableResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

CreateTagTableVO CreateTagTableResponse::GetData() const
{
    return m_data;
}

bool CreateTagTableResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateTagTableResponse::GetExtra() const
{
    return m_extra;
}

bool CreateTagTableResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateTagTableResponse::GetMsg() const
{
    return m_msg;
}

bool CreateTagTableResponse::MsgHasBeenSet() const
{
