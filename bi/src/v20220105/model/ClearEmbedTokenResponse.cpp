...
CoreInternalOutcome ClearEmbedTokenResponse::Deserialize(const string &payload)
{
...
string ClearEmbedTokenResponse::ToJsonString() const
{
...
ErrorInfo ClearEmbedTokenResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ClearEmbedTokenResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ClearEmbedTokenResponse::GetExtra() const
{
    return m_extra;
}

bool ClearEmbedTokenResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ClearEmbedTokenResponse::GetMsg() const
{
    return m_msg;
}

bool ClearEmbedTokenResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

bool ClearEmbedTokenResponse::GetData() const
{
    return m_data;
}

bool ClearEmbedTokenResponse::DataHasBeenSet() const
{
