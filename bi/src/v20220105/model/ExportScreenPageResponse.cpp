...
CoreInternalOutcome ExportScreenPageResponse::Deserialize(const string &payload)
{
...
string ExportScreenPageResponse::ToJsonString() const
{
...
ErrorInfo ExportScreenPageResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ExportScreenPageResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ExportScreenPageResponse::GetExtra() const
{
    return m_extra;
}

bool ExportScreenPageResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

PageScreenListVO ExportScreenPageResponse::GetData() const
{
    return m_data;
}

bool ExportScreenPageResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ExportScreenPageResponse::GetMsg() const
{
    return m_msg;
}

bool ExportScreenPageResponse::MsgHasBeenSet() const
{
