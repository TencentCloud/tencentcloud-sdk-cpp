...
CreateUserGroupMemberResponse::CreateUserGroupMemberResponse() :
...
CoreInternalOutcome CreateUserGroupMemberResponse::Deserialize(const string &payload)
{
...
string CreateUserGroupMemberResponse::ToJsonString() const
{
...
ErrorInfo CreateUserGroupMemberResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateUserGroupMemberResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateUserGroupMemberResponse::GetExtra() const
{
    return m_extra;
}

bool CreateUserGroupMemberResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateUserGroupMemberResponse::GetMsg() const
{
    return m_msg;
}

bool CreateUserGroupMemberResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string CreateUserGroupMemberResponse::GetData() const
{
    return m_data;
}

bool CreateUserGroupMemberResponse::DataHasBeenSet() const
{
