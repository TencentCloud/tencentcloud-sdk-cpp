...
CoreInternalOutcome ModifyTagTableResponse::Deserialize(const string &payload)
{
...
string ModifyTagTableResponse::ToJsonString() const
{
...
ErrorInfo ModifyTagTableResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyTagTableResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

ModifyTagTableVO ModifyTagTableResponse::GetData() const
{
    return m_data;
}

bool ModifyTagTableResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyTagTableResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyTagTableResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyTagTableResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyTagTableResponse::MsgHasBeenSet() const
{
