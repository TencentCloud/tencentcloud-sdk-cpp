...
string ModifyProjectResponse::ToJsonString() const
{
...
ErrorInfo ModifyProjectResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyProjectResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyProjectResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyProjectResponse::GetData() const
{
    return m_data;
}

bool ModifyProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyProjectResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyProjectResponse::MsgHasBeenSet() const
{
