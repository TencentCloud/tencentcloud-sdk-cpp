...
DeleteAuthApiKeyResponse::DeleteAuthApiKeyResponse() :
...
CoreInternalOutcome DeleteAuthApiKeyResponse::Deserialize(const string &payload)
{
...
string DeleteAuthApiKeyResponse::ToJsonString() const
{
...
ErrorInfo DeleteAuthApiKeyResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DeleteAuthApiKeyResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DeleteAuthApiKeyResponse::GetExtra() const
{
    return m_extra;
}

bool DeleteAuthApiKeyResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DeleteAuthApiKeyResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteAuthApiKeyResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DeleteAuthApiKeyResponse::GetData() const
{
    return m_data;
}

bool DeleteAuthApiKeyResponse::DataHasBeenSet() const
{
