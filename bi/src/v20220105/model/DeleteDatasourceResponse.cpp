...
ErrorInfo DeleteDatasourceResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DeleteDatasourceResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DeleteDatasourceResponse::GetData() const
{
    return m_data;
}
...
string DeleteDatasourceResponse::GetExtra() const
{
    return m_extra;
}

bool DeleteDatasourceResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DeleteDatasourceResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteDatasourceResponse::MsgHasBeenSet() const
{
