...
DescribeUserGroupMemberListResponse::DescribeUserGroupMemberListResponse() :
...
CoreInternalOutcome DescribeUserGroupMemberListResponse::Deserialize(const string &payload)
{
...
string DescribeUserGroupMemberListResponse::ToJsonString() const
{
...
ErrorInfo DescribeUserGroupMemberListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeUserGroupMemberListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeUserGroupMemberListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeUserGroupMemberListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeUserGroupMemberListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeUserGroupMemberListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

DescribeUserGroupMemberPageListContainer DescribeUserGroupMemberListResponse::GetData() const
{
    return m_data;
}

bool DescribeUserGroupMemberListResponse::DataHasBeenSet() const
{
