...
CoreInternalOutcome ModifyUserRoleResponse::Deserialize(const string &payload)
{
...
string ModifyUserRoleResponse::ToJsonString() const
{
...
ErrorInfo ModifyUserRoleResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyUserRoleResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyUserRoleResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyUserRoleResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyUserRoleResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyUserRoleResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string ModifyUserRoleResponse::GetData() const
{
    return m_data;
}

bool ModifyUserRoleResponse::DataHasBeenSet() const
{
