...
DescribeAuthApiKeyListResponse::DescribeAuthApiKeyListResponse() :
...
CoreInternalOutcome DescribeAuthApiKeyListResponse::Deserialize(const string &payload)
{
...
string DescribeAuthApiKeyListResponse::ToJsonString() const
{
...
ErrorInfo DescribeAuthApiKeyListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeAuthApiKeyListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeAuthApiKeyListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeAuthApiKeyListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeAuthApiKeyListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeAuthApiKeyListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

ApiKeyAuthApplyVOList DescribeAuthApiKeyListResponse::GetData() const
{
    return m_data;
}

bool DescribeAuthApiKeyListResponse::DataHasBeenSet() const
{
