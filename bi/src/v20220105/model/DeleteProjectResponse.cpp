...
CoreInternalOutcome DeleteProjectResponse::Deserialize(const string &payload)
{
...
string DeleteProjectResponse::ToJsonString() const
{
...
ErrorInfo DeleteProjectResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DeleteProjectResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DeleteProjectResponse::GetExtra() const
{
    return m_extra;
}

bool DeleteProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DeleteProjectResponse::GetData() const
{
    return m_data;
}

bool DeleteProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DeleteProjectResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteProjectResponse::MsgHasBeenSet() const
{
