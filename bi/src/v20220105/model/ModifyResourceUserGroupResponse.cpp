...
ModifyResourceUserGroupResponse::ModifyResourceUserGroupResponse() :
...
CoreInternalOutcome ModifyResourceUserGroupResponse::Deserialize(const string &payload)
{
...
string ModifyResourceUserGroupResponse::ToJsonString() const
{
...
ErrorInfo ModifyResourceUserGroupResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyResourceUserGroupResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyResourceUserGroupResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyResourceUserGroupResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyResourceUserGroupResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyResourceUserGroupResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

int64_t ModifyResourceUserGroupResponse::GetData() const
{
    return m_data;
}

bool ModifyResourceUserGroupResponse::DataHasBeenSet() const
{
