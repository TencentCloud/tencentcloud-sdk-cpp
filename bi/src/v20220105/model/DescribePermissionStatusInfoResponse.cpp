...
DescribePermissionStatusInfoResponse::DescribePermissionStatusInfoResponse() :
...
CoreInternalOutcome DescribePermissionStatusInfoResponse::Deserialize(const string &payload)
{
...
string DescribePermissionStatusInfoResponse::ToJsonString() const
{
...
ErrorInfo DescribePermissionStatusInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribePermissionStatusInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribePermissionStatusInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribePermissionStatusInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribePermissionStatusInfoResponse::GetExtra() const
{
    return m_extra;
}

bool DescribePermissionStatusInfoResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

RowColumnStatus DescribePermissionStatusInfoResponse::GetData() const
{
    return m_data;
}

bool DescribePermissionStatusInfoResponse::DataHasBeenSet() const
{
