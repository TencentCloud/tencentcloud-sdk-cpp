...
ErrorInfo DescribeProjectListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeProjectListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeProjectListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeProjectListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeProjectListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeProjectListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

ProjectListData DescribeProjectListResponse::GetData() const
{
    return m_data;
}

bool DescribeProjectListResponse::DataHasBeenSet() const
{
