...
DescribeUserGroupTreeListResponse::DescribeUserGroupTreeListResponse() :
...
CoreInternalOutcome DescribeUserGroupTreeListResponse::Deserialize(const string &payload)
{
...
string DescribeUserGroupTreeListResponse::ToJsonString() const
{
...
ErrorInfo DescribeUserGroupTreeListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeUserGroupTreeListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeUserGroupTreeListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeUserGroupTreeListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeUserGroupTreeListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeUserGroupTreeListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

vector<UserGroupTreeVO> DescribeUserGroupTreeListResponse::GetData() const
{
    return m_data;
}

bool DescribeUserGroupTreeListResponse::DataHasBeenSet() const
{
