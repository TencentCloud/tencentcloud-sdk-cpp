...
CoreInternalOutcome ModifyUserRoleProjectResponse::Deserialize(const string &payload)
{
...
string ModifyUserRoleProjectResponse::ToJsonString() const
{
...
bool ModifyUserRoleProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyUserRoleProjectResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyUserRoleProjectResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string ModifyUserRoleProjectResponse::GetData() const
{
    return m_data;
}

bool ModifyUserRoleProjectResponse::DataHasBeenSet() const
{
