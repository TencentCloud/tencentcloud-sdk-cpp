...
CoreInternalOutcome EditCorpTagResponse::Deserialize(const string &payload)
{
...
string EditCorpTagResponse::ToJsonString() const
{
...
ErrorInfo EditCorpTagResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool EditCorpTagResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string EditCorpTagResponse::GetExtra() const
{
    return m_extra;
}

bool EditCorpTagResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string EditCorpTagResponse::GetMsg() const
{
    return m_msg;
}

bool EditCorpTagResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

EditTagVO EditCorpTagResponse::GetData() const
{
    return m_data;
}

bool EditCorpTagResponse::DataHasBeenSet() const
{
