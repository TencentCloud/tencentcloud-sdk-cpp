...
ErrorInfo DescribeProjectInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeProjectInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeProjectInfoResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeProjectInfoResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeProjectInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeProjectInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

Project DescribeProjectInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeProjectInfoResponse::DataHasBeenSet() const
{
