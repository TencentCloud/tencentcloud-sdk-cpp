...
CoreInternalOutcome CreateUserRoleResponse::Deserialize(const string &payload)
{
...
string CreateUserRoleResponse::ToJsonString() const
{
...
ErrorInfo CreateUserRoleResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateUserRoleResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateUserRoleResponse::GetExtra() const
{
    return m_extra;
}

bool CreateUserRoleResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

DataId CreateUserRoleResponse::GetData() const
{
    return m_data;
}

bool CreateUserRoleResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateUserRoleResponse::GetMsg() const
{
    return m_msg;
}

bool CreateUserRoleResponse::MsgHasBeenSet() const
{
