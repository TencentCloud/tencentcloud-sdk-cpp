...
ModifyAuthApiKeyResponse::ModifyAuthApiKeyResponse() :
...
CoreInternalOutcome ModifyAuthApiKeyResponse::Deserialize(const string &payload)
{
...
string ModifyAuthApiKeyResponse::ToJsonString() const
{
...
ErrorInfo ModifyAuthApiKeyResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyAuthApiKeyResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyAuthApiKeyResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyAuthApiKeyResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyAuthApiKeyResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyAuthApiKeyResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

ApiKeyAuthApplyVO ModifyAuthApiKeyResponse::GetData() const
{
    return m_data;
}

bool ModifyAuthApiKeyResponse::DataHasBeenSet() const
{
