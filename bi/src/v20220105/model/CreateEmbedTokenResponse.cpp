...
CoreInternalOutcome CreateEmbedTokenResponse::Deserialize(const string &payload)
{
...
string CreateEmbedTokenResponse::ToJsonString() const
{
...
bool CreateEmbedTokenResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

EmbedTokenInfo CreateEmbedTokenResponse::GetData() const
{
    return m_data;
}

bool CreateEmbedTokenResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateEmbedTokenResponse::GetMsg() const
{
    return m_msg;
}

bool CreateEmbedTokenResponse::MsgHasBeenSet() const
{
