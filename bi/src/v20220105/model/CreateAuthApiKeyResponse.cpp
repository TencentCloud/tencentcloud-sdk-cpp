...
CreateAuthApiKeyResponse::CreateAuthApiKeyResponse() :
...
CoreInternalOutcome CreateAuthApiKeyResponse::Deserialize(const string &payload)
{
...
string CreateAuthApiKeyResponse::ToJsonString() const
{
...
ErrorInfo CreateAuthApiKeyResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateAuthApiKeyResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateAuthApiKeyResponse::GetExtra() const
{
    return m_extra;
}

bool CreateAuthApiKeyResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateAuthApiKeyResponse::GetMsg() const
{
    return m_msg;
}

bool CreateAuthApiKeyResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

ApiKeyAuthApplyVO CreateAuthApiKeyResponse::GetData() const
{
    return m_data;
}

bool CreateAuthApiKeyResponse::DataHasBeenSet() const
{
