...
CoreInternalOutcome DescribePageWidgetListResponse::Deserialize(const string &payload)
{
...
string DescribePageWidgetListResponse::ToJsonString() const
{
...
ErrorInfo DescribePageWidgetListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribePageWidgetListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribePageWidgetListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribePageWidgetListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

WidgetListVO DescribePageWidgetListResponse::GetData() const
{
    return m_data;
}

bool DescribePageWidgetListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribePageWidgetListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribePageWidgetListResponse::MsgHasBeenSet() const
{
