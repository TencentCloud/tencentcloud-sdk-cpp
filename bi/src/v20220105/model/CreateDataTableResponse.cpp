...
CoreInternalOutcome CreateDataTableResponse::Deserialize(const string &payload)
{
...
string CreateDataTableResponse::ToJsonString() const
{
...
ErrorInfo CreateDataTableResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateDataTableResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

IdDTO CreateDataTableResponse::GetData() const
{
    return m_data;
}

bool CreateDataTableResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateDataTableResponse::GetExtra() const
{
    return m_extra;
}

bool CreateDataTableResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateDataTableResponse::GetMsg() const
{
    return m_msg;
}

bool CreateDataTableResponse::MsgHasBeenSet() const
{
