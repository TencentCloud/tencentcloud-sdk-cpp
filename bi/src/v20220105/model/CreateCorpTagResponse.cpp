...
ErrorInfo CreateCorpTagResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateCorpTagResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateCorpTagResponse::GetExtra() const
{
    return m_extra;
}

bool CreateCorpTagResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateCorpTagResponse::GetMsg() const
{
    return m_msg;
}

bool CreateCorpTagResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

DataId CreateCorpTagResponse::GetData() const
{
    return m_data;
}

bool CreateCorpTagResponse::DataHasBeenSet() const
{
