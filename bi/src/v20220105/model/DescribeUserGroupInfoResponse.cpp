...
DescribeUserGroupInfoResponse::DescribeUserGroupInfoResponse() :
    m_errorInfoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeUserGroupInfoResponse::Deserialize(const string &payload)
{
...
string DescribeUserGroupInfoResponse::ToJsonString() const
{
...
ErrorInfo DescribeUserGroupInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeUserGroupInfoResponse::ErrorInfoHasBeenSet() const
{
