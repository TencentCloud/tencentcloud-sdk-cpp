...
CoreInternalOutcome ModifyDatasourceCloudResponse::Deserialize(const string &payload)
{
...
string ModifyDatasourceCloudResponse::ToJsonString() const
{
...
ErrorInfo ModifyDatasourceCloudResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyDatasourceCloudResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyDatasourceCloudResponse::GetData() const
{
    return m_data;
}

bool ModifyDatasourceCloudResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyDatasourceCloudResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyDatasourceCloudResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyDatasourceCloudResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyDatasourceCloudResponse::MsgHasBeenSet() const
{
