...
CoreInternalOutcome DescribeUserProjectListResponse::Deserialize(const string &payload)
{
...
string DescribeUserProjectListResponse::ToJsonString() const
{
...
ErrorInfo DescribeUserProjectListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeUserProjectListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

CorpUserListData DescribeUserProjectListResponse::GetData() const
{
    return m_data;
}

bool DescribeUserProjectListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeUserProjectListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeUserProjectListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeUserProjectListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeUserProjectListResponse::MsgHasBeenSet() const
{
