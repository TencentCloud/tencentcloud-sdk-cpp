...
CreateAuthApiKeyRequest::CreateAuthApiKeyRequest() :
    m_defaultUserHasBeenSet(false)
{
}

string CreateAuthApiKeyRequest::ToJsonString() const
{
...
string CreateAuthApiKeyRequest::GetDefaultUser() const
{
    return m_defaultUser;
}

void CreateAuthApiKeyRequest::SetDefaultUser(const string& _defaultUser)
{
    m_defaultUser = _defaultUser;
    m_defaultUserHasBeenSet = true;
}

bool CreateAuthApiKeyRequest::DefaultUserHasBeenSet() const
{
