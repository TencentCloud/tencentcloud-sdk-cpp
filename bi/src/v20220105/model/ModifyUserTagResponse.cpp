...
CoreInternalOutcome ModifyUserTagResponse::Deserialize(const string &payload)
{
...
string ModifyUserTagResponse::ToJsonString() const
{
...
ErrorInfo ModifyUserTagResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyUserTagResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyUserTagResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyUserTagResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string ModifyUserTagResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyUserTagResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyUserTagResponse::GetData() const
{
    return m_data;
}

bool ModifyUserTagResponse::DataHasBeenSet() const
{
