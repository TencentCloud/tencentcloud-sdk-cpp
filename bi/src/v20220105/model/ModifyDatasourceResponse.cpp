...
CoreInternalOutcome ModifyDatasourceResponse::Deserialize(const string &payload)
{
...
string ModifyDatasourceResponse::ToJsonString() const
{
...
ErrorInfo ModifyDatasourceResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyDatasourceResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyDatasourceResponse::GetData() const
{
    return m_data;
}

bool ModifyDatasourceResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyDatasourceResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyDatasourceResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyDatasourceResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyDatasourceResponse::MsgHasBeenSet() const
{
