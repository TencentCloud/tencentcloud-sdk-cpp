...
ModifyUserDetailInfoResponse::ModifyUserDetailInfoResponse() :
...
CoreInternalOutcome ModifyUserDetailInfoResponse::Deserialize(const string &payload)
{
...
string ModifyUserDetailInfoResponse::ToJsonString() const
{
...
ErrorInfo ModifyUserDetailInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyUserDetailInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyUserDetailInfoResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyUserDetailInfoResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyUserDetailInfoResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyUserDetailInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string ModifyUserDetailInfoResponse::GetData() const
{
    return m_data;
}

bool ModifyUserDetailInfoResponse::DataHasBeenSet() const
{
