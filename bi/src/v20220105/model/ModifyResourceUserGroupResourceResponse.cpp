...
CoreInternalOutcome ModifyResourceUserGroupResourceResponse::Deserialize(const string &payload)
{
...
string ModifyResourceUserGroupResourceResponse::ToJsonString() const
{
...
ErrorInfo ModifyResourceUserGroupResourceResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyResourceUserGroupResourceResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyResourceUserGroupResourceResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyResourceUserGroupResourceResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyResourceUserGroupResourceResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyResourceUserGroupResourceResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

int64_t ModifyResourceUserGroupResourceResponse::GetData() const
{
    return m_data;
}

bool ModifyResourceUserGroupResourceResponse::DataHasBeenSet() const
{
