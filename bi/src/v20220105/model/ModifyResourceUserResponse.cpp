...
CoreInternalOutcome ModifyResourceUserResponse::Deserialize(const string &payload)
{
...
string ModifyResourceUserResponse::ToJsonString() const
{
...
ErrorInfo ModifyResourceUserResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ModifyResourceUserResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ModifyResourceUserResponse::GetExtra() const
{
    return m_extra;
}

bool ModifyResourceUserResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string ModifyResourceUserResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyResourceUserResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

int64_t ModifyResourceUserResponse::GetData() const
{
    return m_data;
}

bool ModifyResourceUserResponse::DataHasBeenSet() const
{
