...
CoreInternalOutcome DescribeSourceFieldListResponse::Deserialize(const string &payload)
{
...
string DescribeSourceFieldListResponse::ToJsonString() const
{
...
ErrorInfo DescribeSourceFieldListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeSourceFieldListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeSourceFieldListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeSourceFieldListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeSourceFieldListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeSourceFieldListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

TableColumnListData DescribeSourceFieldListResponse::GetData() const
{
    return m_data;
}

bool DescribeSourceFieldListResponse::DataHasBeenSet() const
{
