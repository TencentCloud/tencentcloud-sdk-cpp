...
CoreInternalOutcome DeleteUserRoleProjectResponse::Deserialize(const string &payload)
{
...
string DeleteUserRoleProjectResponse::ToJsonString() const
{
...
ErrorInfo DeleteUserRoleProjectResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DeleteUserRoleProjectResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DeleteUserRoleProjectResponse::GetExtra() const
{
    return m_extra;
}

bool DeleteUserRoleProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DeleteUserRoleProjectResponse::GetData() const
{
    return m_data;
}

bool DeleteUserRoleProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DeleteUserRoleProjectResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteUserRoleProjectResponse::MsgHasBeenSet() const
{
