...
CoreInternalOutcome DescribeUserRoleListResponse::Deserialize(const string &payload)
{
...
string DescribeUserRoleListResponse::ToJsonString() const
{
...
ErrorInfo DescribeUserRoleListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeUserRoleListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeUserRoleListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeUserRoleListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

UserRoleListData DescribeUserRoleListResponse::GetData() const
{
    return m_data;
}

bool DescribeUserRoleListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeUserRoleListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeUserRoleListResponse::MsgHasBeenSet() const
{
