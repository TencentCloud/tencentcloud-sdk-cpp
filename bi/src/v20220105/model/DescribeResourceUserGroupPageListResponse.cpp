...
DescribeResourceUserGroupPageListResponse::DescribeResourceUserGroupPageListResponse() :
...
CoreInternalOutcome DescribeResourceUserGroupPageListResponse::Deserialize(const string &payload)
{
...
string DescribeResourceUserGroupPageListResponse::ToJsonString() const
{
...
ErrorInfo DescribeResourceUserGroupPageListResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeResourceUserGroupPageListResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeResourceUserGroupPageListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeResourceUserGroupPageListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeResourceUserGroupPageListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeResourceUserGroupPageListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

UserGroupPageTreeVO DescribeResourceUserGroupPageListResponse::GetData() const
{
    return m_data;
}

bool DescribeResourceUserGroupPageListResponse::DataHasBeenSet() const
{
