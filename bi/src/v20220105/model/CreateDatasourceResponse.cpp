...
CoreInternalOutcome CreateDatasourceResponse::Deserialize(const string &payload)
{
...
string CreateDatasourceResponse::ToJsonString() const
{
...
ErrorInfo CreateDatasourceResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateDatasourceResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

IdDTO CreateDatasourceResponse::GetData() const
{
    return m_data;
}

bool CreateDatasourceResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateDatasourceResponse::GetExtra() const
{
    return m_extra;
}

bool CreateDatasourceResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateDatasourceResponse::GetMsg() const
{
    return m_msg;
}

bool CreateDatasourceResponse::MsgHasBeenSet() const
{
