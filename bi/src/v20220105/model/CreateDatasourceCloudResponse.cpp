...
CoreInternalOutcome CreateDatasourceCloudResponse::Deserialize(const string &payload)
{
...
string CreateDatasourceCloudResponse::ToJsonString() const
{
...
ErrorInfo CreateDatasourceCloudResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateDatasourceCloudResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

IdDTO CreateDatasourceCloudResponse::GetData() const
{
    return m_data;
}

bool CreateDatasourceCloudResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateDatasourceCloudResponse::GetExtra() const
{
    return m_extra;
}

bool CreateDatasourceCloudResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreateDatasourceCloudResponse::GetMsg() const
{
    return m_msg;
}

bool CreateDatasourceCloudResponse::MsgHasBeenSet() const
{
