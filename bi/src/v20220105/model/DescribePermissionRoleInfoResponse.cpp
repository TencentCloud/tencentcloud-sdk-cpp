...
DescribePermissionRoleInfoResponse::DescribePermissionRoleInfoResponse() :
...
CoreInternalOutcome DescribePermissionRoleInfoResponse::Deserialize(const string &payload)
{
...
string DescribePermissionRoleInfoResponse::ToJsonString() const
{
...
ErrorInfo DescribePermissionRoleInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribePermissionRoleInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

vector<Role> DescribePermissionRoleInfoResponse::GetData() const
{
    return m_data;
}

bool DescribePermissionRoleInfoResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribePermissionRoleInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribePermissionRoleInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribePermissionRoleInfoResponse::GetExtra() const
{
    return m_extra;
}

bool DescribePermissionRoleInfoResponse::ExtraHasBeenSet() const
{
