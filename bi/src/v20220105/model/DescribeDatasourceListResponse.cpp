...
CoreInternalOutcome DescribeDatasourceListResponse::Deserialize(const string &payload)
{
...
string DescribeDatasourceListResponse::ToJsonString() const
{
...
bool DescribeDatasourceListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeDatasourceListResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeDatasourceListResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeDatasourceListResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDatasourceListResponse::MsgHasBeenSet() const
{
