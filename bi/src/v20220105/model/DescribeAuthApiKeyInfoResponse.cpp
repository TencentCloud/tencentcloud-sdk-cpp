...
DescribeAuthApiKeyInfoResponse::DescribeAuthApiKeyInfoResponse() :
...
CoreInternalOutcome DescribeAuthApiKeyInfoResponse::Deserialize(const string &payload)
{
...
string DescribeAuthApiKeyInfoResponse::ToJsonString() const
{
...
ErrorInfo DescribeAuthApiKeyInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribeAuthApiKeyInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribeAuthApiKeyInfoResponse::GetExtra() const
{
    return m_extra;
}

bool DescribeAuthApiKeyInfoResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DescribeAuthApiKeyInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeAuthApiKeyInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

ApiKeyAuthApplyVO DescribeAuthApiKeyInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeAuthApiKeyInfoResponse::DataHasBeenSet() const
{
