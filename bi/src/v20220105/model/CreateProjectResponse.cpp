...
ErrorInfo CreateProjectResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateProjectResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateProjectResponse::GetExtra() const
{
    return m_extra;
}

bool CreateProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

Data CreateProjectResponse::GetData() const
{
    return m_data;
}

bool CreateProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateProjectResponse::GetMsg() const
{
    return m_msg;
}

bool CreateProjectResponse::MsgHasBeenSet() const
{
