...
CoreInternalOutcome ApplyEmbedIntervalResponse::Deserialize(const string &payload)
{
...
string ApplyEmbedIntervalResponse::ToJsonString() const
{
...
ErrorInfo ApplyEmbedIntervalResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool ApplyEmbedIntervalResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string ApplyEmbedIntervalResponse::GetExtra() const
{
    return m_extra;
}

bool ApplyEmbedIntervalResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

ApplyEmbedTokenInfo ApplyEmbedIntervalResponse::GetData() const
{
    return m_data;
}

bool ApplyEmbedIntervalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ApplyEmbedIntervalResponse::GetMsg() const
{
    return m_msg;
}

bool ApplyEmbedIntervalResponse::MsgHasBeenSet() const
{
