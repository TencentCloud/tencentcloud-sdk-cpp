...
CoreInternalOutcome CreateUserRoleProjectResponse::Deserialize(const string &payload)
{
...
string CreateUserRoleProjectResponse::ToJsonString() const
{
...
ErrorInfo CreateUserRoleProjectResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreateUserRoleProjectResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreateUserRoleProjectResponse::GetExtra() const
{
    return m_extra;
}

bool CreateUserRoleProjectResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

DataId CreateUserRoleProjectResponse::GetData() const
{
    return m_data;
}

bool CreateUserRoleProjectResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string CreateUserRoleProjectResponse::GetMsg() const
{
    return m_msg;
}

bool CreateUserRoleProjectResponse::MsgHasBeenSet() const
{
