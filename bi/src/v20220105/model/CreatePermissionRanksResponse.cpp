...
CoreInternalOutcome CreatePermissionRanksResponse::Deserialize(const string &payload)
{
...
string CreatePermissionRanksResponse::ToJsonString() const
{
...
ErrorInfo CreatePermissionRanksResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool CreatePermissionRanksResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string CreatePermissionRanksResponse::GetMsg() const
{
    return m_msg;
}

bool CreatePermissionRanksResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string CreatePermissionRanksResponse::GetExtra() const
{
    return m_extra;
}

bool CreatePermissionRanksResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string CreatePermissionRanksResponse::GetData() const
{
    return m_data;
}

bool CreatePermissionRanksResponse::DataHasBeenSet() const
{
