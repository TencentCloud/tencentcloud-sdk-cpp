...
DescribePermissionRanksInfoResponse::DescribePermissionRanksInfoResponse() :
...
CoreInternalOutcome DescribePermissionRanksInfoResponse::Deserialize(const string &payload)
{
...
string DescribePermissionRanksInfoResponse::ToJsonString() const
{
...
ErrorInfo DescribePermissionRanksInfoResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DescribePermissionRanksInfoResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DescribePermissionRanksInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribePermissionRanksInfoResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribePermissionRanksInfoResponse::GetExtra() const
{
    return m_extra;
}

bool DescribePermissionRanksInfoResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

RankInfo DescribePermissionRanksInfoResponse::GetData() const
{
    return m_data;
}

bool DescribePermissionRanksInfoResponse::DataHasBeenSet() const
{
