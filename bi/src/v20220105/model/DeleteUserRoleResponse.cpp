...
CoreInternalOutcome DeleteUserRoleResponse::Deserialize(const string &payload)
{
...
string DeleteUserRoleResponse::ToJsonString() const
{
...
ErrorInfo DeleteUserRoleResponse::GetErrorInfo() const
{
    return m_errorInfo;
}

bool DeleteUserRoleResponse::ErrorInfoHasBeenSet() const
{
    return m_errorInfoHasBeenSet;
}

string DeleteUserRoleResponse::GetExtra() const
{
    return m_extra;
}

bool DeleteUserRoleResponse::ExtraHasBeenSet() const
{
    return m_extraHasBeenSet;
}

string DeleteUserRoleResponse::GetData() const
{
    return m_data;
}

bool DeleteUserRoleResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DeleteUserRoleResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteUserRoleResponse::MsgHasBeenSet() const
{
