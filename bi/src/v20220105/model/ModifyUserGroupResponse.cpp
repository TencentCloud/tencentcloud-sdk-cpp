...
CoreInternalOutcome ModifyUserGroupResponse::Deserialize(const string &payload)
{
...
string ModifyUserGroupResponse::ToJsonString() const
{
...
ErrorInfo ModifyUserGroupResponse::GetErrorInfo() const
{
    return m_errorInfo;
}
