...
CoreInternalOutcome DetectDisgustResponse::Deserialize(const string &payload)
{
...
string DetectDisgustResponse::ToJsonString() const
{
...
double DetectDisgustResponse::GetConfidence() const
{
    return m_confidence;
}

bool DetectDisgustResponse::ConfidenceHasBeenSet() const
{
    return m_confidenceHasBeenSet;
}

string DetectDisgustResponse::GetType() const
{
    return m_type;
}

bool DetectDisgustResponse::TypeHasBeenSet() const
{
