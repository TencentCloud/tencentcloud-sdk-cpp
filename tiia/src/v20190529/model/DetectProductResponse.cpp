...
CoreInternalOutcome DetectProductResponse::Deserialize(const string &payload)
{
...
string DetectProductResponse::ToJsonString() const
{
...
vector<Product> DetectProductResponse::GetProducts() const
{
    return m_products;
}

bool DetectProductResponse::ProductsHasBeenSet() const
{
