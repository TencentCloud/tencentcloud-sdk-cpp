...
CoreInternalOutcome DetectLabelProResponse::Deserialize(const string &payload)
{
...
string DetectLabelProResponse::ToJsonString() const
{
...
vector<DetectLabelItem> DetectLabelProResponse::GetLabels() const
{
    return m_labels;
}

bool DetectLabelProResponse::LabelsHasBeenSet() const
{
