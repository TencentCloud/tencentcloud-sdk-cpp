...
CoreInternalOutcome DetectMisbehaviorResponse::Deserialize(const string &payload)
{
...
string DetectMisbehaviorResponse::ToJsonString() const
{
...
double DetectMisbehaviorResponse::GetConfidence() const
{
    return m_confidence;
}

bool DetectMisbehaviorResponse::ConfidenceHasBeenSet() const
{
    return m_confidenceHasBeenSet;
}

string DetectMisbehaviorResponse::GetType() const
{
    return m_type;
}

bool DetectMisbehaviorResponse::TypeHasBeenSet() const
{
