...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_ASSESSQUALITYREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_ASSESSQUALITYREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class AssessQualityRequest : public AbstractModel
                {
                public:
                    AssessQualityRequest();
                    ~AssessQualityRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_ASSESSQUALITYREQUEST_H_
