...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPRORESPONSE_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPRORESPONSE_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class RecognizeCarProResponse : public AbstractModel
                {
                public:
                    RecognizeCarProResponse();
                    ~RecognizeCarProResponse() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPRORESPONSE_H_
