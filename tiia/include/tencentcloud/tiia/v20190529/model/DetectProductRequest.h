...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPRODUCTREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPRODUCTREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class DetectProductRequest : public AbstractModel
                {
                public:
                    DetectProductRequest();
                    ~DetectProductRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPRODUCTREQUEST_H_
