...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTSECURITYRESPONSE_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTSECURITYRESPONSE_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class DetectSecurityResponse : public AbstractModel
                {
                public:
                    DetectSecurityResponse();
                    ~DetectSecurityResponse() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTSECURITYRESPONSE_H_
