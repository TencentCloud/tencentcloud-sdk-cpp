...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPETREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPETREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                * DetectPet请求参数结构体
                */
                class DetectPetRequest : public AbstractModel
                {
                public:
                    DetectPetRequest();
                    ~DetectPetRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTPETREQUEST_H_
