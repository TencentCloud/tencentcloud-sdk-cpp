...
CoreInternalOutcome CreateShieldInstanceResponse::Deserialize(const string &payload)
{
...
string CreateShieldInstanceResponse::ToJsonString() const
{
...
uint64_t CreateShieldInstanceResponse::GetProgress() const
{
    return m_progress;
}

bool CreateShieldInstanceResponse::ProgressHasBeenSet() const
{
    return m_progressHasBeenSet;
}

string CreateShieldInstanceResponse::GetItemId() const
{
    return m_itemId;
}

bool CreateShieldInstanceResponse::ItemIdHasBeenSet() const
{
