...
CoreInternalOutcome DescribeApkDetectionResultResponse::Deserialize(const string &payload)
{
...
string DescribeApkDetectionResultResponse::ToJsonString() const
{
...
string DescribeApkDetectionResultResponse::GetResult() const
{
    return m_result;
}

bool DescribeApkDetectionResultResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string DescribeApkDetectionResultResponse::GetReason() const
{
    return m_reason;
}

bool DescribeApkDetectionResultResponse::ReasonHasBeenSet() const
{
    return m_reasonHasBeenSet;
}

vector<ResultListItem> DescribeApkDetectionResultResponse::GetResultList() const
{
    return m_resultList;
}

bool DescribeApkDetectionResultResponse::ResultListHasBeenSet() const
{
