...
CoreInternalOutcome OptPluginListItem::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("PluginType") && !value["PluginType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OptPluginListItem.PluginType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PluginName") && !value["PluginName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OptPluginListItem.PluginName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PluginDesc") && !value["PluginDesc"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OptPluginListItem.PluginDesc` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void OptPluginListItem::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string OptPluginListItem::GetPluginType() const
{
    return m_pluginType;
}

void OptPluginListItem::SetPluginType(const string& _pluginType)
{
    m_pluginType = _pluginType;
    m_pluginTypeHasBeenSet = true;
}

bool OptPluginListItem::PluginTypeHasBeenSet() const
{
    return m_pluginTypeHasBeenSet;
}

string OptPluginListItem::GetPluginName() const
{
    return m_pluginName;
}

void OptPluginListItem::SetPluginName(const string& _pluginName)
{
    m_pluginName = _pluginName;
    m_pluginNameHasBeenSet = true;
}

bool OptPluginListItem::PluginNameHasBeenSet() const
{
    return m_pluginNameHasBeenSet;
}

string OptPluginListItem::GetPluginDesc() const
{
    return m_pluginDesc;
}

void OptPluginListItem::SetPluginDesc(const string& _pluginDesc)
{
    m_pluginDesc = _pluginDesc;
    m_pluginDescHasBeenSet = true;
}

bool OptPluginListItem::PluginDescHasBeenSet() const
{
