...
CoreInternalOutcome ScanSetInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ScanSetInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
