...
CoreInternalOutcome CreateBindInstanceResponse::Deserialize(const string &payload)
{
...
string CreateBindInstanceResponse::ToJsonString() const
{
...
uint64_t CreateBindInstanceResponse::GetProgress() const
{
    return m_progress;
}

bool CreateBindInstanceResponse::ProgressHasBeenSet() const
{
