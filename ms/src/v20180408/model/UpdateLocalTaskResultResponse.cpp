...
UpdateLocalTaskResultResponse::UpdateLocalTaskResultResponse() :
    m_resultCodeHasBeenSet(false)
{
}

CoreInternalOutcome UpdateLocalTaskResultResponse::Deserialize(const string &payload)
{
...
string UpdateLocalTaskResultResponse::ToJsonString() const
{
...
string UpdateLocalTaskResultResponse::GetResultCode() const
{
    return m_resultCode;
}

bool UpdateLocalTaskResultResponse::ResultCodeHasBeenSet() const
{
