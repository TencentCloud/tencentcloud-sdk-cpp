...
UpdateClientStateResponse::UpdateClientStateResponse() :
    m_resultCodeHasBeenSet(false)
{
}

CoreInternalOutcome UpdateClientStateResponse::Deserialize(const string &payload)
{
...
string UpdateClientStateResponse::ToJsonString() const
{
...
string UpdateClientStateResponse::GetResultCode() const
{
    return m_resultCode;
}

bool UpdateClientStateResponse::ResultCodeHasBeenSet() const
{
