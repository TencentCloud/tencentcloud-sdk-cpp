...
CoreInternalOutcome DeleteShieldInstancesResponse::Deserialize(const string &payload)
{
...
string DeleteShieldInstancesResponse::ToJsonString() const
{
...
uint64_t DeleteShieldInstancesResponse::GetProgress() const
{
    return m_progress;
}

bool DeleteShieldInstancesResponse::ProgressHasBeenSet() const
{
