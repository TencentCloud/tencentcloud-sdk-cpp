...
string DescribeResourceInstancesRequest::ToJsonString() const
{
...
void DescribeResourceInstancesRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeResourceInstancesRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

uint64_t DescribeResourceInstancesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeResourceInstancesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeResourceInstancesRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeResourceInstancesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeResourceInstancesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
void DescribeResourceInstancesRequest::SetOrderField(const string& _orderField)
{
    m_orderField = _orderField;
    m_orderFieldHasBeenSet = true;
}

bool DescribeResourceInstancesRequest::OrderFieldHasBeenSet() const
{
    return m_orderFieldHasBeenSet;
}

string DescribeResourceInstancesRequest::GetOrderDirection() const
{
    return m_orderDirection;
}

void DescribeResourceInstancesRequest::SetOrderDirection(const string& _orderDirection)
{
    m_orderDirection = _orderDirection;
    m_orderDirectionHasBeenSet = true;
}

bool DescribeResourceInstancesRequest::OrderDirectionHasBeenSet() const
{
