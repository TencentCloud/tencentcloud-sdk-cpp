...
CoreInternalOutcome DeleteScanInstancesResponse::Deserialize(const string &payload)
{
...
string DeleteScanInstancesResponse::ToJsonString() const
{
...
uint64_t DeleteScanInstancesResponse::GetProgress() const
{
    return m_progress;
}

bool DeleteScanInstancesResponse::ProgressHasBeenSet() const
{
