...
#ifndef TENCENTCLOUD_MS_V20180408_MODEL_DESCRIBESCANINSTANCESREQUEST_H_
#define TENCENTCLOUD_MS_V20180408_MODEL_DESCRIBESCANINSTANCESREQUEST_H_
    ...
    namespace Ms
    {
        namespace V20180408
        {
            namespace Model
            {
                ...
                */
                class DescribeScanInstancesRequest : public AbstractModel
                {
                public:
                    DescribeScanInstancesRequest();
                    ~DescribeScanInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_MS_V20180408_MODEL_DESCRIBESCANINSTANCESREQUEST_H_
