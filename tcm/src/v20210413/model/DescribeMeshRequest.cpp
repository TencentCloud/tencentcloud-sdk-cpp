...
string DescribeMeshRequest::ToJsonString() const
{
...
string DescribeMeshRequest::GetMeshId() const
{
    return m_meshId;
}

void DescribeMeshRequest::SetMeshId(const string& _meshId)
{
    m_meshId = _meshId;
    m_meshIdHasBeenSet = true;
}

bool DescribeMeshRequest::MeshIdHasBeenSet() const
{
