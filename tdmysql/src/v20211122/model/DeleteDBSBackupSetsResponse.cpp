...
CoreInternalOutcome DeleteDBSBackupSetsResponse::Deserialize(const string &payload)
{
...
string DeleteDBSBackupSetsResponse::ToJsonString() const
{
...
int64_t DeleteDBSBackupSetsResponse::GetDeleted() const
{
    return m_deleted;
}

bool DeleteDBSBackupSetsResponse::DeletedHasBeenSet() const
{
    return m_deletedHasBeenSet;
}

bool DeleteDBSBackupSetsResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool DeleteDBSBackupSetsResponse::IsSuccessHasBeenSet() const
{
    return m_isSuccessHasBeenSet;
}

int64_t DeleteDBSBackupSetsResponse::GetTotal() const
{
    return m_total;
}

bool DeleteDBSBackupSetsResponse::TotalHasBeenSet() const
{
