...
CoreInternalOutcome ResetUsersPasswordResponse::Deserialize(const string &payload)
{
...
string ResetUsersPasswordResponse::ToJsonString() const
{
...
int64_t ResetUsersPasswordResponse::GetFlowId() const
{
    return m_flowId;
}

bool ResetUsersPasswordResponse::FlowIdHasBeenSet() const
{
