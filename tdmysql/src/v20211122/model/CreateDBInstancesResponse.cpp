...
CoreInternalOutcome CreateDBInstancesResponse::Deserialize(const string &payload)
{
...
string CreateDBInstancesResponse::ToJsonString() const
{
...
vector<string> CreateDBInstancesResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CreateDBInstancesResponse::InstanceIdsHasBeenSet() const
{
    return m_instanceIdsHasBeenSet;
}

int64_t CreateDBInstancesResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateDBInstancesResponse::FlowIdHasBeenSet() const
{
