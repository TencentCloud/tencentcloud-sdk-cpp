...
CoreInternalOutcome CancelIsolateDBInstancesResponse::Deserialize(const string &payload)
{
...
string CancelIsolateDBInstancesResponse::ToJsonString() const
{
...
vector<string> CancelIsolateDBInstancesResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool CancelIsolateDBInstancesResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> CancelIsolateDBInstancesResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool CancelIsolateDBInstancesResponse::FailedInstanceIdsHasBeenSet() const
{
