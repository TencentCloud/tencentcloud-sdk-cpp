...
string DescribeDBSAvailableRecoveryTimeRequest::ToJsonString() const
{
...
string DescribeDBSAvailableRecoveryTimeRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DescribeDBSAvailableRecoveryTimeRequest::SetInstanceId(const string& _instanceId)
{
