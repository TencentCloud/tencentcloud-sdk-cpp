...
CoreInternalOutcome ExpandInstanceResponse::Deserialize(const string &payload)
{
...
string ExpandInstanceResponse::ToJsonString() const
{
...
int64_t ExpandInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool ExpandInstanceResponse::FlowIdHasBeenSet() const
{
