...
CoreInternalOutcome ModifyInstanceSSLStatusResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceSSLStatusResponse::ToJsonString() const
{
...
int64_t ModifyInstanceSSLStatusResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyInstanceSSLStatusResponse::FlowIdHasBeenSet() const
{
