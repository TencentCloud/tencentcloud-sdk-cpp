...
CoreInternalOutcome CreateUsersResponse::Deserialize(const string &payload)
{
...
string CreateUsersResponse::ToJsonString() const
{
...
int64_t CreateUsersResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateUsersResponse::FlowIdHasBeenSet() const
{
