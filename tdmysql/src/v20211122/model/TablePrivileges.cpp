...
CoreInternalOutcome TablePrivileges::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Database") && !value["Database"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TablePrivileges.Database` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Table") && !value["Table"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TablePrivileges.Table` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string TablePrivileges::GetDatabase() const
{
    return m_database;
}

void TablePrivileges::SetDatabase(const string& _database)
{
    m_database = _database;
    m_databaseHasBeenSet = true;
}

bool TablePrivileges::DatabaseHasBeenSet() const
{
    return m_databaseHasBeenSet;
}

string TablePrivileges::GetTable() const
{
    return m_table;
}

void TablePrivileges::SetTable(const string& _table)
{
    m_table = _table;
    m_tableHasBeenSet = true;
}

bool TablePrivileges::TableHasBeenSet() const
{
