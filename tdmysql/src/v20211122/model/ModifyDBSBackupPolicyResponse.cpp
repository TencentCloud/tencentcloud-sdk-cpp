...
CoreInternalOutcome ModifyDBSBackupPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyDBSBackupPolicyResponse::ToJsonString() const
{
...
bool ModifyDBSBackupPolicyResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool ModifyDBSBackupPolicyResponse::IsSuccessHasBeenSet() const
{
    return m_isSuccessHasBeenSet;
}

string ModifyDBSBackupPolicyResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyDBSBackupPolicyResponse::MsgHasBeenSet() const
{
