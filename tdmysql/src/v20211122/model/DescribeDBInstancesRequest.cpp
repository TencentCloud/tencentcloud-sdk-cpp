...
vector<InstanceFilter> DescribeDBInstancesRequest::GetFilters() const
{
    return m_filters;
}

void DescribeDBInstancesRequest::SetFilters(const vector<InstanceFilter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeDBInstancesRequest::FiltersHasBeenSet() const
{
...
string DescribeDBInstancesRequest::GetEngineType() const
{
    return m_engineType;
}

void DescribeDBInstancesRequest::SetEngineType(const string& _engineType)
{
