...
CoreInternalOutcome CreateCloneInstanceResponse::Deserialize(const string &payload)
{
...
string CreateCloneInstanceResponse::ToJsonString() const
{
...
string CreateCloneInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateCloneInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

int64_t CreateCloneInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateCloneInstanceResponse::FlowIdHasBeenSet() const
{
