...
CoreInternalOutcome ModifyDBSBackupSetCommentResponse::Deserialize(const string &payload)
{
...
string ModifyDBSBackupSetCommentResponse::ToJsonString() const
{
...
bool ModifyDBSBackupSetCommentResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool ModifyDBSBackupSetCommentResponse::IsSuccessHasBeenSet() const
{
    return m_isSuccessHasBeenSet;
}

string ModifyDBSBackupSetCommentResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyDBSBackupSetCommentResponse::MsgHasBeenSet() const
{
