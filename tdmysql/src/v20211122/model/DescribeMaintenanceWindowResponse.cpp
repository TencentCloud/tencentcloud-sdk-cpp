...
CoreInternalOutcome DescribeMaintenanceWindowResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["MaintenanceWindow"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `MaintenanceWindow` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_maintenanceWindow = string(rsp["MaintenanceWindow"].GetString());
...
string DescribeMaintenanceWindowResponse::ToJsonString() const
{
    ...
    if (m_maintenanceWindowHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_maintenanceWindow.c_str(), allocator).Move(), allocator);
    }
...
string DescribeMaintenanceWindowResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DescribeMaintenanceWindowResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string DescribeMaintenanceWindowResponse::GetMaintenanceWindow() const
{
    return m_maintenanceWindow;
}

bool DescribeMaintenanceWindowResponse::MaintenanceWindowHasBeenSet() const
{
    return m_maintenanceWindowHasBeenSet;
}

vector<string> DescribeMaintenanceWindowResponse::GetWeekDays() const
{
    return m_weekDays;
}

bool DescribeMaintenanceWindowResponse::WeekDaysHasBeenSet() const
{
