...
CoreInternalOutcome ModifyDBInstanceVPortResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceVPortResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceVPortResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDBInstanceVPortResponse::FlowIdHasBeenSet() const
{
