...
CoreInternalOutcome DestroyInstancesResponse::Deserialize(const string &payload)
{
...
string DestroyInstancesResponse::ToJsonString() const
{
...
vector<string> DestroyInstancesResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool DestroyInstancesResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> DestroyInstancesResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool DestroyInstancesResponse::FailedInstanceIdsHasBeenSet() const
{
