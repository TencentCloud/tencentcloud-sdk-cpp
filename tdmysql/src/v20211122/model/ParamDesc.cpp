...
CoreInternalOutcome ParamDesc::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Description") && !value["Description"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ParamDesc.Description` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string ParamDesc::GetDescription() const
{
    return m_description;
}

void ParamDesc::SetDescription(const string& _description)
{
    m_description = _description;
    m_descriptionHasBeenSet = true;
}

bool ParamDesc::DescriptionHasBeenSet() const
{
