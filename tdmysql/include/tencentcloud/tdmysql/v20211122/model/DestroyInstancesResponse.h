...
#ifndef TENCENTCLOUD_TDMYSQL_V20211122_MODEL_DESTROYINSTANCESRESPONSE_H_
#define TENCENTCLOUD_TDMYSQL_V20211122_MODEL_DESTROYINSTANCESRESPONSE_H_
    ...
    namespace Tdmysql
    {
        namespace V20211122
        {
            namespace Model
            {
                ...
                */
                class DestroyInstancesResponse : public AbstractModel
                {
                public:
                    DestroyInstancesResponse();
                    ~DestroyInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_TDMYSQL_V20211122_MODEL_DESTROYINSTANCESRESPONSE_H_
