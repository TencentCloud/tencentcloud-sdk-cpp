...
SubmitVideoTranslateJobResponse::SubmitVideoTranslateJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitVideoTranslateJobResponse::Deserialize(const string &payload)
{
...
string SubmitVideoTranslateJobResponse::ToJsonString() const
{
...
string SubmitVideoTranslateJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitVideoTranslateJobResponse::JobIdHasBeenSet() const
{
