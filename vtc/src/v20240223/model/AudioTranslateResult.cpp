...
AudioTranslateResult::AudioTranslateResult() :
    m_sourceTextHasBeenSet(false),
    m_targetTextHasBeenSet(false)
{
}

CoreInternalOutcome AudioTranslateResult::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SourceText") && !value["SourceText"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AudioTranslateResult.SourceText` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TargetText") && !value["TargetText"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AudioTranslateResult.TargetText` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void AudioTranslateResult::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string AudioTranslateResult::GetSourceText() const
{
    return m_sourceText;
}

void AudioTranslateResult::SetSourceText(const string& _sourceText)
{
    m_sourceText = _sourceText;
    m_sourceTextHasBeenSet = true;
}

bool AudioTranslateResult::SourceTextHasBeenSet() const
{
    return m_sourceTextHasBeenSet;
}

string AudioTranslateResult::GetTargetText() const
{
    return m_targetText;
}

void AudioTranslateResult::SetTargetText(const string& _targetText)
{
    m_targetText = _targetText;
    m_targetTextHasBeenSet = true;
}

bool AudioTranslateResult::TargetTextHasBeenSet() const
{
