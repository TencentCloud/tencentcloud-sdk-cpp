...
#ifndef TENCENTCLOUD_PDS_V20210701_MODEL_DESCRIBENEWUSERACQUISITIONREQUEST_H_
#define TENCENTCLOUD_PDS_V20210701_MODEL_DESCRIBENEWUSERACQUISITIONREQUEST_H_
    ...
    namespace Pds
    {
        namespace V20210701
        {
            namespace Model
            {
                ...
                */
                class DescribeNewUserAcquisitionRequest : public AbstractModel
                {
                public:
                    DescribeNewUserAcquisitionRequest();
                    ~DescribeNewUserAcquisitionRequest() = default;
...
#endif // !TENCENTCLOUD_PDS_V20210701_MODEL_DESCRIBENEWUSERACQUISITIONREQUEST_H_
