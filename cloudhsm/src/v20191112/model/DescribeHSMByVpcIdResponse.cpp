...
CoreInternalOutcome DescribeHSMByVpcIdResponse::Deserialize(const string &payload)
{
...
string DescribeHSMByVpcIdResponse::ToJsonString() const
{
...
int64_t DescribeHSMByVpcIdResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHSMByVpcIdResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

string DescribeHSMByVpcIdResponse::GetVpcId() const
{
    return m_vpcId;
}

bool DescribeHSMByVpcIdResponse::VpcIdHasBeenSet() const
{
