...
CoreInternalOutcome DescribeUsgResponse::Deserialize(const string &payload)
{
...
string DescribeUsgResponse::ToJsonString() const
{
...
vector<SgUnit> DescribeUsgResponse::GetSgList() const
{
    return m_sgList;
}

bool DescribeUsgResponse::SgListHasBeenSet() const
{
    return m_sgListHasBeenSet;
}

int64_t DescribeUsgResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeUsgResponse::TotalCountHasBeenSet() const
{
