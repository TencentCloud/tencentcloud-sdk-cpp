...
CoreInternalOutcome DescribeHSMBySubnetIdResponse::Deserialize(const string &payload)
{
...
string DescribeHSMBySubnetIdResponse::ToJsonString() const
{
...
int64_t DescribeHSMBySubnetIdResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHSMBySubnetIdResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

string DescribeHSMBySubnetIdResponse::GetSubnetId() const
{
    return m_subnetId;
}

bool DescribeHSMBySubnetIdResponse::SubnetIdHasBeenSet() const
{
