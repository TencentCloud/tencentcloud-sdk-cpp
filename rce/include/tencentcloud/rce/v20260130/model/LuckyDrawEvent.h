...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_LUCKYDRAWEVENT_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_LUCKYDRAWEVENT_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                * 抽奖事件详情
                */
                class LuckyDrawEvent : public AbstractModel
                {
                public:
                    LuckyDrawEvent();
                    ~LuckyDrawEvent() = default;
                    ...
                    /**
                     * 获取<p>抽奖次数</p><p>单位：次数</p>
                     * @return LuckyDrawCount <p>抽奖次数</p><p>单位：次数</p>
                     * 
                     */
                    int64_t GetLuckyDrawCount() const;

                    /**
                     * 设置<p>抽奖次数</p><p>单位：次数</p>
                     * @param _luckyDrawCount <p>抽奖次数</p><p>单位：次数</p>
                     * 
                     */
                    void SetLuckyDrawCount(const int64_t& _luckyDrawCount);

                    /**
                     * 判断参数 LuckyDrawCount 是否已赋值
                     * @return LuckyDrawCount 是否已赋值
                     * 
                     */
                    bool LuckyDrawCountHasBeenSet() const;
                     ...
                     * 
                     */
                    std::string GetLuckyDrawType() const;
                     ...
                     * 
                     */
                    void SetLuckyDrawType(const std::string& _luckyDrawType);

                    /**
                     * 判断参数 LuckyDrawType 是否已赋值
                     * @return LuckyDrawType 是否已赋值
                     * 
                     */
                    bool LuckyDrawTypeHasBeenSet() const;
                ...
                private:
                     ...
                     * <p>抽奖次数</p><p>单位：次数</p>
                     */
                    int64_t m_luckyDrawCount;
                    bool m_luckyDrawCountHasBeenSet;

                    /**
                     * <p>抽奖类型</p>
                     */
                    std::string m_luckyDrawType;
                    bool m_luckyDrawTypeHasBeenSet;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_LUCKYDRAWEVENT_H_
