...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_ADDFRIENDEVENT_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_ADDFRIENDEVENT_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                * 添加好友事件详情
                */
                class AddFriendEvent : public AbstractModel
                {
                public:
                    AddFriendEvent();
                    ~AddFriendEvent() = default;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_ADDFRIENDEVENT_H_
