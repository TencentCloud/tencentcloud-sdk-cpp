...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_SENDER_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_SENDER_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                * 发送者信息
                */
                class Sender : public AbstractModel
                {
                public:
                    Sender();
                    ~Sender() = default;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_SENDER_H_
