...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDELETENAMELISTDATA_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDELETENAMELISTDATA_H_
    ...
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                ...
                * 删除黑白名单出参
                */
                class OutputDeleteNameListData : public AbstractModel
                {
                public:
                    OutputDeleteNameListData();
                    ~OutputDeleteNameListData() = default;
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDELETENAMELISTDATA_H_
