...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMELISTFRONT_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMELISTFRONT_H_
    ...
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                ...
                * 修改黑白名单数据出参
                */
                class OutputModifyNameListFront : public AbstractModel
                {
                public:
                    OutputModifyNameListFront();
                    ~OutputModifyNameListFront() = default;
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMELISTFRONT_H_
