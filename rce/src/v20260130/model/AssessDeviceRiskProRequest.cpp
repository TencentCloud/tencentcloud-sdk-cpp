...
string AssessDeviceRiskProRequest::ToJsonString() const
{
...
string AssessDeviceRiskProRequest::GetDeviceToken() const
{
    return m_deviceToken;
}

void AssessDeviceRiskProRequest::SetDeviceToken(const string& _deviceToken)
{
    m_deviceToken = _deviceToken;
    m_deviceTokenHasBeenSet = true;
}

bool AssessDeviceRiskProRequest::DeviceTokenHasBeenSet() const
{
    return m_deviceTokenHasBeenSet;
}

string AssessDeviceRiskProRequest::GetUserIp() const
{
    return m_userIp;
}

void AssessDeviceRiskProRequest::SetUserIp(const string& _userIp)
{
    m_userIp = _userIp;
    m_userIpHasBeenSet = true;
}

bool AssessDeviceRiskProRequest::UserIpHasBeenSet() const
{
