...
CoreInternalOutcome AssessEnvironmentRiskResponse::Deserialize(const string &payload)
{
...
string AssessEnvironmentRiskResponse::ToJsonString() const
{
...
AssessEnvironmentRiskRsp AssessEnvironmentRiskResponse::GetData() const
{
    return m_data;
}

bool AssessEnvironmentRiskResponse::DataHasBeenSet() const
{
