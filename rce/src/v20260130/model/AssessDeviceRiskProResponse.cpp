...
CoreInternalOutcome AssessDeviceRiskProResponse::Deserialize(const string &payload)
{
...
string AssessDeviceRiskProResponse::ToJsonString() const
{
...
AssessDeviceRiskRsp AssessDeviceRiskProResponse::GetData() const
{
    return m_data;
}

bool AssessDeviceRiskProResponse::DataHasBeenSet() const
{
