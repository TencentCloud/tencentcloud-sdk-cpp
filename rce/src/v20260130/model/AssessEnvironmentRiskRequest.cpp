...
string AssessEnvironmentRiskRequest::ToJsonString() const
{
...
string AssessEnvironmentRiskRequest::GetUserIp() const
{
    return m_userIp;
}

void AssessEnvironmentRiskRequest::SetUserIp(const string& _userIp)
{
    m_userIp = _userIp;
    m_userIpHasBeenSet = true;
}

bool AssessEnvironmentRiskRequest::UserIpHasBeenSet() const
{
