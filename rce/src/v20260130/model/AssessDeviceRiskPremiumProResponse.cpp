...
CoreInternalOutcome AssessDeviceRiskPremiumProResponse::Deserialize(const string &payload)
{
...
string AssessDeviceRiskPremiumProResponse::ToJsonString() const
{
...
AssessDeviceRiskPremiumRsp AssessDeviceRiskPremiumProResponse::GetData() const
{
    return m_data;
}

bool AssessDeviceRiskPremiumProResponse::DataHasBeenSet() const
{
