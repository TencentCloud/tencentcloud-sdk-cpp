...
ModifyNameListRequest::ModifyNameListRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string ModifyNameListRequest::ToJsonString() const
{
...
InputModifyNameFront ModifyNameListRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void ModifyNameListRequest::SetBusinessSecurityData(const InputModifyNameFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool ModifyNameListRequest::BusinessSecurityDataHasBeenSet() const
{
