...
string DescribeRiskModelRequest::ToJsonString() const
{
...
InputDescribeRiskModelData DescribeRiskModelRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeRiskModelRequest::SetBusinessSecurityData(const InputDescribeRiskModelData& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeRiskModelRequest::BusinessSecurityDataHasBeenSet() const
{
