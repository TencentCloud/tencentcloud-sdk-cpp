...
ModifyNameListResponse::ModifyNameListResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome ModifyNameListResponse::Deserialize(const string &payload)
{
...
string ModifyNameListResponse::ToJsonString() const
{
...
OutputModifyNameFront ModifyNameListResponse::GetData() const
{
    return m_data;
}

bool ModifyNameListResponse::DataHasBeenSet() const
{
