...
CoreInternalOutcome CreateNameListResponse::Deserialize(const string &payload)
{
...
string CreateNameListResponse::ToJsonString() const
{
...
OutputCreateNameListFront CreateNameListResponse::GetData() const
{
    return m_data;
}

bool CreateNameListResponse::DataHasBeenSet() const
{
