...
DescribeNameListDataListRequest::DescribeNameListDataListRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string DescribeNameListDataListRequest::ToJsonString() const
{
...
InputDescribeDataListFront DescribeNameListDataListRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeNameListDataListRequest::SetBusinessSecurityData(const InputDescribeDataListFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeNameListDataListRequest::BusinessSecurityDataHasBeenSet() const
{
