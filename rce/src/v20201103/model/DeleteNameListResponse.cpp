...
DeleteNameListResponse::DeleteNameListResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DeleteNameListResponse::Deserialize(const string &payload)
{
...
string DeleteNameListResponse::ToJsonString() const
{
...
OutputDeleteNameListFront DeleteNameListResponse::GetData() const
{
    return m_data;
}

bool DeleteNameListResponse::DataHasBeenSet() const
{
