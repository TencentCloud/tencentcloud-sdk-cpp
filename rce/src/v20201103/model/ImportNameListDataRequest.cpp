...
ImportNameListDataRequest::ImportNameListDataRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string ImportNameListDataRequest::ToJsonString() const
{
...
InputImportNameListDataFront ImportNameListDataRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void ImportNameListDataRequest::SetBusinessSecurityData(const InputImportNameListDataFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool ImportNameListDataRequest::BusinessSecurityDataHasBeenSet() const
{
