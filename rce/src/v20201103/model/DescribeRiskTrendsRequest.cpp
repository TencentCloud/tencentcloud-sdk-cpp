...
string DescribeRiskTrendsRequest::ToJsonString() const
{
...
InputFrontRisk DescribeRiskTrendsRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeRiskTrendsRequest::SetBusinessSecurityData(const InputFrontRisk& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeRiskTrendsRequest::BusinessSecurityDataHasBeenSet() const
{
