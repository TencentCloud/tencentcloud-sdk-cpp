...
DeleteNameListRequest::DeleteNameListRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string DeleteNameListRequest::ToJsonString() const
{
...
InputDeleteNameListFront DeleteNameListRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DeleteNameListRequest::SetBusinessSecurityData(const InputDeleteNameListFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DeleteNameListRequest::BusinessSecurityDataHasBeenSet() const
{
