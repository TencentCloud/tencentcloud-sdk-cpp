...
CreateNameListRequest::CreateNameListRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string CreateNameListRequest::ToJsonString() const
{
...
InputCreateNameListFront CreateNameListRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void CreateNameListRequest::SetBusinessSecurityData(const InputCreateNameListFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool CreateNameListRequest::BusinessSecurityDataHasBeenSet() const
{
