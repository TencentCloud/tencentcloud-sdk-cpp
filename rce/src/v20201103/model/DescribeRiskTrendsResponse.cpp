...
CoreInternalOutcome DescribeRiskTrendsResponse::Deserialize(const string &payload)
{
...
string DescribeRiskTrendsResponse::ToJsonString() const
{
...
OutputFrontRiskData DescribeRiskTrendsResponse::GetData() const
{
    return m_data;
}

bool DescribeRiskTrendsResponse::DataHasBeenSet() const
{
