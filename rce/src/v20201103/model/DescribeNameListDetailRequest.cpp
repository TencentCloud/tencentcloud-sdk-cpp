...
DescribeNameListDetailRequest::DescribeNameListDetailRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string DescribeNameListDetailRequest::ToJsonString() const
{
...
InputDescribeNameListDetail DescribeNameListDetailRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeNameListDetailRequest::SetBusinessSecurityData(const InputDescribeNameListDetail& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeNameListDetailRequest::BusinessSecurityDataHasBeenSet() const
{
