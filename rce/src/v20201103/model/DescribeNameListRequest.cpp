...
DescribeNameListRequest::DescribeNameListRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string DescribeNameListRequest::ToJsonString() const
{
...
InputDescribeNameListFront DescribeNameListRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeNameListRequest::SetBusinessSecurityData(const InputDescribeNameListFront& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeNameListRequest::BusinessSecurityDataHasBeenSet() const
{
