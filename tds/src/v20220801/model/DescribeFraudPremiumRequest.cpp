...
string DescribeFraudPremiumRequest::ToJsonString() const
{
...
string DescribeFraudPremiumRequest::GetDeviceToken() const
{
    return m_deviceToken;
}

void DescribeFraudPremiumRequest::SetDeviceToken(const string& _deviceToken)
{
    m_deviceToken = _deviceToken;
    m_deviceTokenHasBeenSet = true;
}

bool DescribeFraudPremiumRequest::DeviceTokenHasBeenSet() const
{
