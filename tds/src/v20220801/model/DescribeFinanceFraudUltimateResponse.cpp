...
DescribeFinanceFraudUltimateResponse::DescribeFinanceFraudUltimateResponse() :
...
CoreInternalOutcome DescribeFinanceFraudUltimateResponse::Deserialize(const string &payload)
{
...
string DescribeFinanceFraudUltimateResponse::ToJsonString() const
{
...
string DescribeFinanceFraudUltimateResponse::GetAppVersion() const
{
    return m_appVersion;
}

bool DescribeFinanceFraudUltimateResponse::AppVersionHasBeenSet() const
{
    return m_appVersionHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetBrand() const
{
    return m_brand;
}

bool DescribeFinanceFraudUltimateResponse::BrandHasBeenSet() const
{
    return m_brandHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetClientIp() const
{
    return m_clientIp;
}

bool DescribeFinanceFraudUltimateResponse::ClientIpHasBeenSet() const
{
    return m_clientIpHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetModel() const
{
    return m_model;
}

bool DescribeFinanceFraudUltimateResponse::ModelHasBeenSet() const
{
    return m_modelHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetNetworkType() const
{
    return m_networkType;
}

bool DescribeFinanceFraudUltimateResponse::NetworkTypeHasBeenSet() const
{
    return m_networkTypeHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetPackageName() const
{
    return m_packageName;
}

bool DescribeFinanceFraudUltimateResponse::PackageNameHasBeenSet() const
{
    return m_packageNameHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetPlatform() const
{
    return m_platform;
}

bool DescribeFinanceFraudUltimateResponse::PlatformHasBeenSet() const
{
    return m_platformHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetSystemVersion() const
{
    return m_systemVersion;
}

bool DescribeFinanceFraudUltimateResponse::SystemVersionHasBeenSet() const
{
    return m_systemVersionHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetSdkBuildNo() const
{
    return m_sdkBuildNo;
}

bool DescribeFinanceFraudUltimateResponse::SdkBuildNoHasBeenSet() const
{
    return m_sdkBuildNoHasBeenSet;
}

vector<RiskInfo> DescribeFinanceFraudUltimateResponse::GetRiskInfos() const
{
    return m_riskInfos;
}

bool DescribeFinanceFraudUltimateResponse::RiskInfosHasBeenSet() const
{
    return m_riskInfosHasBeenSet;
}

vector<RiskInfo> DescribeFinanceFraudUltimateResponse::GetHistRiskInfos() const
{
    return m_histRiskInfos;
}

bool DescribeFinanceFraudUltimateResponse::HistRiskInfosHasBeenSet() const
{
    return m_histRiskInfosHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetOpenid() const
{
    return m_openid;
}

bool DescribeFinanceFraudUltimateResponse::OpenidHasBeenSet() const
{
    return m_openidHasBeenSet;
}

vector<RiskInfo> DescribeFinanceFraudUltimateResponse::GetSceneRiskInfos() const
{
    return m_sceneRiskInfos;
}

bool DescribeFinanceFraudUltimateResponse::SceneRiskInfosHasBeenSet() const
{
    return m_sceneRiskInfosHasBeenSet;
}

uint64_t DescribeFinanceFraudUltimateResponse::GetSuggestionLevel() const
{
    return m_suggestionLevel;
}

bool DescribeFinanceFraudUltimateResponse::SuggestionLevelHasBeenSet() const
{
    return m_suggestionLevelHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetUnionid() const
{
    return m_unionid;
}

bool DescribeFinanceFraudUltimateResponse::UnionidHasBeenSet() const
{
    return m_unionidHasBeenSet;
}

string DescribeFinanceFraudUltimateResponse::GetRiskCheckTimestamp() const
{
    return m_riskCheckTimestamp;
}

bool DescribeFinanceFraudUltimateResponse::RiskCheckTimestampHasBeenSet() const
{
    return m_riskCheckTimestampHasBeenSet;
}

vector<ExtraInfo> DescribeFinanceFraudUltimateResponse::GetExtraInfos() const
{
    return m_extraInfos;
}

bool DescribeFinanceFraudUltimateResponse::ExtraInfosHasBeenSet() const
{
