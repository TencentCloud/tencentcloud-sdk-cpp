...
#ifndef TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBETRUSTEDIDREQUEST_H_
#define TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBETRUSTEDIDREQUEST_H_
    ...
    namespace Tds
    {
        namespace V20220801
        {
            namespace Model
            {
                ...
                */
                class DescribeTrustedIDRequest : public AbstractModel
                {
                public:
                    DescribeTrustedIDRequest();
                    ~DescribeTrustedIDRequest() = default;
...
#endif // !TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBETRUSTEDIDREQUEST_H_
