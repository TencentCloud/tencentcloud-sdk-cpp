...
#ifndef TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDULTIMATEREQUEST_H_
#define TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDULTIMATEREQUEST_H_
    ...
    namespace Tds
    {
        namespace V20220801
        {
            namespace Model
            {
                ...
                */
                class DescribeFraudUltimateRequest : public AbstractModel
                {
                public:
                    DescribeFraudUltimateRequest();
                    ~DescribeFraudUltimateRequest() = default;
...
#endif // !TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDULTIMATEREQUEST_H_
