...
DescribeBackupCheckJobRequest::DescribeBackupCheckJobRequest() :
    m_backupPlanIdHasBeenSet(false)
{
}

string DescribeBackupCheckJobRequest::ToJsonString() const
{
...
string DescribeBackupCheckJobRequest::GetBackupPlanId() const
{
    return m_backupPlanId;
}

void DescribeBackupCheckJobRequest::SetBackupPlanId(const string& _backupPlanId)
{
    m_backupPlanId = _backupPlanId;
    m_backupPlanIdHasBeenSet = true;
}

bool DescribeBackupCheckJobRequest::BackupPlanIdHasBeenSet() const
{
