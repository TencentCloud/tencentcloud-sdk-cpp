...
StartBackupCheckJobRequest::StartBackupCheckJobRequest() :
    m_backupPlanIdHasBeenSet(false)
{
}

string StartBackupCheckJobRequest::ToJsonString() const
{
...
string StartBackupCheckJobRequest::GetBackupPlanId() const
{
    return m_backupPlanId;
}

void StartBackupCheckJobRequest::SetBackupPlanId(const string& _backupPlanId)
{
    m_backupPlanId = _backupPlanId;
    m_backupPlanIdHasBeenSet = true;
}

bool StartBackupCheckJobRequest::BackupPlanIdHasBeenSet() const
{
