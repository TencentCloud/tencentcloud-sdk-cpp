...
string EnableWhiteBoxKeysRequest::ToJsonString() const
{
...
vector<string> EnableWhiteBoxKeysRequest::GetKeyIds() const
{
    return m_keyIds;
}

void EnableWhiteBoxKeysRequest::SetKeyIds(const vector<string>& _keyIds)
{
    m_keyIds = _keyIds;
    m_keyIdsHasBeenSet = true;
}

bool EnableWhiteBoxKeysRequest::KeyIdsHasBeenSet() const
{
