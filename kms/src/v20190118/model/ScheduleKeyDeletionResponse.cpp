...
CoreInternalOutcome ScheduleKeyDeletionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("DeletionDate") && !rsp["DeletionDate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `DeletionDate` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
string ScheduleKeyDeletionResponse::ToJsonString() const
{
...
uint64_t ScheduleKeyDeletionResponse::GetDeletionDate() const
{
    return m_deletionDate;
}

bool ScheduleKeyDeletionResponse::DeletionDateHasBeenSet() const
{
    return m_deletionDateHasBeenSet;
}

string ScheduleKeyDeletionResponse::GetKeyId() const
{
    return m_keyId;
}

bool ScheduleKeyDeletionResponse::KeyIdHasBeenSet() const
{
