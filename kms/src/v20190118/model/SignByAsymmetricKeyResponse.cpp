...
CoreInternalOutcome SignByAsymmetricKeyResponse::Deserialize(const string &payload)
{
...
string SignByAsymmetricKeyResponse::ToJsonString() const
{
...
string SignByAsymmetricKeyResponse::GetSignature() const
{
    return m_signature;
}

bool SignByAsymmetricKeyResponse::SignatureHasBeenSet() const
{
