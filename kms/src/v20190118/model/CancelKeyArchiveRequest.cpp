...
string CancelKeyArchiveRequest::ToJsonString() const
{
...
string CancelKeyArchiveRequest::GetKeyId() const
{
    return m_keyId;
}

void CancelKeyArchiveRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
