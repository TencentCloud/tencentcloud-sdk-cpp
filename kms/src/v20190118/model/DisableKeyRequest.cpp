...
string DisableKeyRequest::ToJsonString() const
{
...
string DisableKeyRequest::GetKeyId() const
{
    return m_keyId;
}

void DisableKeyRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
    m_keyIdHasBeenSet = true;
}

bool DisableKeyRequest::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

MemberAccount DisableKeyRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void DisableKeyRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool DisableKeyRequest::MemberAccountHasBeenSet() const
{
