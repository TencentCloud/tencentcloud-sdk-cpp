...
CoreInternalOutcome DescribeWhiteBoxDecryptKeyResponse::Deserialize(const string &payload)
{
...
string DescribeWhiteBoxDecryptKeyResponse::ToJsonString() const
{
...
string DescribeWhiteBoxDecryptKeyResponse::GetDecryptKey() const
{
    return m_decryptKey;
}

bool DescribeWhiteBoxDecryptKeyResponse::DecryptKeyHasBeenSet() const
{
