...
CoreInternalOutcome DescribeWhiteBoxServiceStatusResponse::Deserialize(const string &payload)
{
...
string DescribeWhiteBoxServiceStatusResponse::ToJsonString() const
{
...
bool DescribeWhiteBoxServiceStatusResponse::GetServiceEnabled() const
{
    return m_serviceEnabled;
}

bool DescribeWhiteBoxServiceStatusResponse::ServiceEnabledHasBeenSet() const
{
