...
CoreInternalOutcome PostQuantumCryptoSignResponse::Deserialize(const string &payload)
{
...
string PostQuantumCryptoSignResponse::ToJsonString() const
{
...
string PostQuantumCryptoSignResponse::GetSignature() const
{
    return m_signature;
}

bool PostQuantumCryptoSignResponse::SignatureHasBeenSet() const
{
