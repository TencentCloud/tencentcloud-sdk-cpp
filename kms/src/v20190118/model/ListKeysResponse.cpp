...
CoreInternalOutcome ListKeysResponse::Deserialize(const string &payload)
{
...
string ListKeysResponse::ToJsonString() const
{
...
vector<Key> ListKeysResponse::GetKeys() const
{
    return m_keys;
}

bool ListKeysResponse::KeysHasBeenSet() const
{
    return m_keysHasBeenSet;
}

uint64_t ListKeysResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListKeysResponse::TotalCountHasBeenSet() const
{
