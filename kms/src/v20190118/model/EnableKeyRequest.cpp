...
string EnableKeyRequest::ToJsonString() const
{
...
string EnableKeyRequest::GetKeyId() const
{
    return m_keyId;
}

void EnableKeyRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
    m_keyIdHasBeenSet = true;
}

bool EnableKeyRequest::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

MemberAccount EnableKeyRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void EnableKeyRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool EnableKeyRequest::MemberAccountHasBeenSet() const
{
