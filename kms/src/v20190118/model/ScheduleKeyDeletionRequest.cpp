...
string ScheduleKeyDeletionRequest::ToJsonString() const
{
...
string ScheduleKeyDeletionRequest::GetKeyId() const
{
    return m_keyId;
}

void ScheduleKeyDeletionRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
    m_keyIdHasBeenSet = true;
}

bool ScheduleKeyDeletionRequest::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

uint64_t ScheduleKeyDeletionRequest::GetPendingWindowInDays() const
{
    return m_pendingWindowInDays;
}

void ScheduleKeyDeletionRequest::SetPendingWindowInDays(const uint64_t& _pendingWindowInDays)
{
    m_pendingWindowInDays = _pendingWindowInDays;
    m_pendingWindowInDaysHasBeenSet = true;
}

bool ScheduleKeyDeletionRequest::PendingWindowInDaysHasBeenSet() const
{
    return m_pendingWindowInDaysHasBeenSet;
}

MemberAccount ScheduleKeyDeletionRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void ScheduleKeyDeletionRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool ScheduleKeyDeletionRequest::MemberAccountHasBeenSet() const
{
