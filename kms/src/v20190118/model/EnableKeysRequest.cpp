...
string EnableKeysRequest::ToJsonString() const
{
...
vector<string> EnableKeysRequest::GetKeyIds() const
{
    return m_keyIds;
}

void EnableKeysRequest::SetKeyIds(const vector<string>& _keyIds)
{
    m_keyIds = _keyIds;
