...
string DescribeDataKeyRequest::ToJsonString() const
{
...
string DescribeDataKeyRequest::GetDataKeyId() const
{
    return m_dataKeyId;
}

void DescribeDataKeyRequest::SetDataKeyId(const string& _dataKeyId)
{
    m_dataKeyId = _dataKeyId;
    m_dataKeyIdHasBeenSet = true;
}

bool DescribeDataKeyRequest::DataKeyIdHasBeenSet() const
{
    return m_dataKeyIdHasBeenSet;
}

MemberAccount DescribeDataKeyRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void DescribeDataKeyRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool DescribeDataKeyRequest::MemberAccountHasBeenSet() const
{
