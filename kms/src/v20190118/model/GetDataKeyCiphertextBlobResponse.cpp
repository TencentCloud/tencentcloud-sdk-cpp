...
CoreInternalOutcome GetDataKeyCiphertextBlobResponse::Deserialize(const string &payload)
{
...
string GetDataKeyCiphertextBlobResponse::ToJsonString() const
{
...
string GetDataKeyCiphertextBlobResponse::GetCiphertextBlob() const
{
    return m_ciphertextBlob;
}

bool GetDataKeyCiphertextBlobResponse::CiphertextBlobHasBeenSet() const
{
