...
string DisableKeysRequest::ToJsonString() const
{
...
vector<string> DisableKeysRequest::GetKeyIds() const
{
    return m_keyIds;
}

void DisableKeysRequest::SetKeyIds(const vector<string>& _keyIds)
{
    m_keyIds = _keyIds;
    m_keyIdsHasBeenSet = true;
}

bool DisableKeysRequest::KeyIdsHasBeenSet() const
{
    return m_keyIdsHasBeenSet;
}

MemberAccount DisableKeysRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void DisableKeysRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool DisableKeysRequest::MemberAccountHasBeenSet() const
{
