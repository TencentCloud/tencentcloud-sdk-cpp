...
string DisableKeyRotationRequest::ToJsonString() const
{
...
string DisableKeyRotationRequest::GetKeyId() const
{
    return m_keyId;
}

void DisableKeyRotationRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
    m_keyIdHasBeenSet = true;
}

bool DisableKeyRotationRequest::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

MemberAccount DisableKeyRotationRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void DisableKeyRotationRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool DisableKeyRotationRequest::MemberAccountHasBeenSet() const
{
