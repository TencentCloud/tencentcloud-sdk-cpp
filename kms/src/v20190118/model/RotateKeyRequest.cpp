...
string RotateKeyRequest::ToJsonString() const
{
...
string RotateKeyRequest::GetKeyId() const
{
    return m_keyId;
}

void RotateKeyRequest::SetKeyId(const string& _keyId)
{
    m_keyId = _keyId;
    m_keyIdHasBeenSet = true;
}

bool RotateKeyRequest::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

MemberAccount RotateKeyRequest::GetMemberAccount() const
{
    return m_memberAccount;
}

void RotateKeyRequest::SetMemberAccount(const MemberAccount& _memberAccount)
{
    m_memberAccount = _memberAccount;
    m_memberAccountHasBeenSet = true;
}

bool RotateKeyRequest::MemberAccountHasBeenSet() const
{
