...
CoreInternalOutcome GenerateRandomResponse::Deserialize(const string &payload)
{
...
string GenerateRandomResponse::ToJsonString() const
{
...
string GenerateRandomResponse::GetPlaintext() const
{
    return m_plaintext;
}

bool GenerateRandomResponse::PlaintextHasBeenSet() const
{
