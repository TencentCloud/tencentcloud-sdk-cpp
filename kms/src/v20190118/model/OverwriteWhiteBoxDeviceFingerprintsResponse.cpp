...
CoreInternalOutcome OverwriteWhiteBoxDeviceFingerprintsResponse::Deserialize(const string &payload)
{
...
string OverwriteWhiteBoxDeviceFingerprintsResponse::ToJsonString() const
{
