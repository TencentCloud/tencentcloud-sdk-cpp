...
CoreInternalOutcome AsymmetricSm2DecryptResponse::Deserialize(const string &payload)
{
...
string AsymmetricSm2DecryptResponse::ToJsonString() const
{
...
string AsymmetricSm2DecryptResponse::GetKeyId() const
{
    return m_keyId;
}

bool AsymmetricSm2DecryptResponse::KeyIdHasBeenSet() const
{
    return m_keyIdHasBeenSet;
}

string AsymmetricSm2DecryptResponse::GetPlaintext() const
{
    return m_plaintext;
}

bool AsymmetricSm2DecryptResponse::PlaintextHasBeenSet() const
{
