...
vector<Tag> GenerateDataKeyRequest::GetTags() const
{
    return m_tags;
}

void GenerateDataKeyRequest::SetTags(const vector<Tag>& _tags)
{
    m_tags = _tags;
    m_tagsHasBeenSet = true;
}

bool GenerateDataKeyRequest::TagsHasBeenSet() const
{
