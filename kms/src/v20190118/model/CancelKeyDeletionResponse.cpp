...
CoreInternalOutcome CancelKeyDeletionResponse::Deserialize(const string &payload)
{
...
string CancelKeyDeletionResponse::ToJsonString() const
{
...
string CancelKeyDeletionResponse::GetKeyId() const
{
    return m_keyId;
}

bool CancelKeyDeletionResponse::KeyIdHasBeenSet() const
{
