...
CoreInternalOutcome EncryptResponse::Deserialize(const string &payload)
{
...
string EncryptResponse::ToJsonString() const
{
...
string EncryptResponse::GetCiphertextBlob() const
{
    return m_ciphertextBlob;
}

bool EncryptResponse::CiphertextBlobHasBeenSet() const
{
    return m_ciphertextBlobHasBeenSet;
}

string EncryptResponse::GetKeyId() const
{
    return m_keyId;
}

bool EncryptResponse::KeyIdHasBeenSet() const
{
