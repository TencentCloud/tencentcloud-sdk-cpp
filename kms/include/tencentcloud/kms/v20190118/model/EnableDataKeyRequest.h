...
#ifndef TENCENTCLOUD_KMS_V20190118_MODEL_ENABLEDATAKEYREQUEST_H_
#define TENCENTCLOUD_KMS_V20190118_MODEL_ENABLEDATAKEYREQUEST_H_
    ...
    namespace Kms
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class EnableDataKeyRequest : public AbstractModel
                {
                public:
                    EnableDataKeyRequest();
                    ~EnableDataKeyRequest() = default;
...
#endif // !TENCENTCLOUD_KMS_V20190118_MODEL_ENABLEDATAKEYREQUEST_H_
