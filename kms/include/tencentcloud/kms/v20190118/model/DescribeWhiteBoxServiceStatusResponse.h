...
#ifndef TENCENTCLOUD_KMS_V20190118_MODEL_DESCRIBEWHITEBOXSERVICESTATUSRESPONSE_H_
#define TENCENTCLOUD_KMS_V20190118_MODEL_DESCRIBEWHITEBOXSERVICESTATUSRESPONSE_H_
    ...
    namespace Kms
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class DescribeWhiteBoxServiceStatusResponse : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_KMS_V20190118_MODEL_DESCRIBEWHITEBOXSERVICESTATUSRESPONSE_H_
