...
#ifndef TENCENTCLOUD_KMS_V20190118_MODEL_LISTDATAKEYDETAILRESPONSE_H_
#define TENCENTCLOUD_KMS_V20190118_MODEL_LISTDATAKEYDETAILRESPONSE_H_
    ...
    namespace Kms
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class ListDataKeyDetailResponse : public AbstractModel
                {
                public:
                    ListDataKeyDetailResponse();
                    ~ListDataKeyDetailResponse() = default;
...
#endif // !TENCENTCLOUD_KMS_V20190118_MODEL_LISTDATAKEYDETAILRESPONSE_H_
