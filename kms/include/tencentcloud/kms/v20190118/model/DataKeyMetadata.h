            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>作为密钥更容易辨识，更容易被人看懂的数据密钥名称</p>
                    ...
                    /**
                     * 设置<p>作为密钥更容易辨识，更容易被人看懂的数据密钥名称</p>
                    ...
                    /**
                     * 获取<p>DataKey的状态， 取值为：Enabled | Disabled | PendingDelete</p>
                    ...
                    /**
                     * 设置<p>DataKey的状态， 取值为：Enabled | Disabled | PendingDelete</p>
                    ...
                    /**
                     * 获取<p>数据密钥的创建者，用户创建的为 user，授权各云产品自动创建的为对应的产品名</p>
                    ...
                    /**
                     * 设置<p>数据密钥的创建者，用户创建的为 user，授权各云产品自动创建的为对应的产品名</p>
                    ...
                    /**
                     * 获取<p>DataKey 密钥材料类型，由KMS创建的为： TENCENT_KMS， 由用户导入的类型为：EXTERNAL</p>
                    ...
                    /**
                     * 设置<p>DataKey 密钥材料类型，由KMS创建的为： TENCENT_KMS， 由用户导入的类型为：EXTERNAL</p>
                    ...
                    /**
                     * 获取<p>资源ID，格式：creatorUin/$creatorUin/$dataKeyId</p>
                    ...
                    /**
                     * 设置<p>资源ID，格式：creatorUin/$creatorUin/$dataKeyId</p>
