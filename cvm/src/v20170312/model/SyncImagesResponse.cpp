...
CoreInternalOutcome SyncImagesResponse::Deserialize(const string &payload)
{
...
string SyncImagesResponse::ToJsonString() const
{
...
vector<SyncImage> SyncImagesResponse::GetImageSet() const
{
    return m_imageSet;
}

bool SyncImagesResponse::ImageSetHasBeenSet() const
{
