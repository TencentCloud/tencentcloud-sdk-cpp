...
CoreInternalOutcome InquiryPriceRenewInstancesResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRenewInstancesResponse::ToJsonString() const
{
...
Price InquiryPriceRenewInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRenewInstancesResponse::PriceHasBeenSet() const
{
