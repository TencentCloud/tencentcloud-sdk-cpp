...
CoreInternalOutcome InternetChargeTypeConfig::Deserialize(const Value &value)
{
    string requestId = "";
...
void InternetChargeTypeConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
