...
string DeleteLaunchTemplateRequest::ToJsonString() const
{
...
string DeleteLaunchTemplateRequest::GetLaunchTemplateId() const
{
    return m_launchTemplateId;
}

void DeleteLaunchTemplateRequest::SetLaunchTemplateId(const string& _launchTemplateId)
{
    m_launchTemplateId = _launchTemplateId;
    m_launchTemplateIdHasBeenSet = true;
}

bool DeleteLaunchTemplateRequest::LaunchTemplateIdHasBeenSet() const
{
