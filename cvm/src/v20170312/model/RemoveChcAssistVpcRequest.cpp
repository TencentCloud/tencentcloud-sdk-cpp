...
string RemoveChcAssistVpcRequest::ToJsonString() const
{
...
vector<string> RemoveChcAssistVpcRequest::GetChcIds() const
{
    return m_chcIds;
}

void RemoveChcAssistVpcRequest::SetChcIds(const vector<string>& _chcIds)
{
    m_chcIds = _chcIds;
    m_chcIdsHasBeenSet = true;
}

bool RemoveChcAssistVpcRequest::ChcIdsHasBeenSet() const
{
