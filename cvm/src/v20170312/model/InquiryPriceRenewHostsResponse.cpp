...
CoreInternalOutcome InquiryPriceRenewHostsResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRenewHostsResponse::ToJsonString() const
{
...
HostPriceInfo InquiryPriceRenewHostsResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRenewHostsResponse::PriceHasBeenSet() const
{
