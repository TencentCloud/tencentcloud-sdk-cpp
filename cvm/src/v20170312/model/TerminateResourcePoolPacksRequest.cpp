...
TerminateResourcePoolPacksRequest::TerminateResourcePoolPacksRequest() :
    m_dedicatedResourcePackIdsHasBeenSet(false)
{
}

string TerminateResourcePoolPacksRequest::ToJsonString() const
{
...
vector<string> TerminateResourcePoolPacksRequest::GetDedicatedResourcePackIds() const
{
    return m_dedicatedResourcePackIds;
}

void TerminateResourcePoolPacksRequest::SetDedicatedResourcePackIds(const vector<string>& _dedicatedResourcePackIds)
{
    m_dedicatedResourcePackIds = _dedicatedResourcePackIds;
    m_dedicatedResourcePackIdsHasBeenSet = true;
}

bool TerminateResourcePoolPacksRequest::DedicatedResourcePackIdsHasBeenSet() const
{
