...
DeleteHpcClustersRequest::DeleteHpcClustersRequest() :
    m_hpcClusterIdsHasBeenSet(false)
{
}

string DeleteHpcClustersRequest::ToJsonString() const
{
...
vector<string> DeleteHpcClustersRequest::GetHpcClusterIds() const
{
    return m_hpcClusterIds;
}

void DeleteHpcClustersRequest::SetHpcClusterIds(const vector<string>& _hpcClusterIds)
{
    m_hpcClusterIds = _hpcClusterIds;
    m_hpcClusterIdsHasBeenSet = true;
}

bool DeleteHpcClustersRequest::HpcClusterIdsHasBeenSet() const
{
