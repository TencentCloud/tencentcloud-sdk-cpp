...
CoreInternalOutcome InquiryPriceResetInstanceResponse::Deserialize(const string &payload)
{
...
string InquiryPriceResetInstanceResponse::ToJsonString() const
{
...
Price InquiryPriceResetInstanceResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceResetInstanceResponse::PriceHasBeenSet() const
{
