...
string RemoveChcDeployVpcRequest::ToJsonString() const
{
...
vector<string> RemoveChcDeployVpcRequest::GetChcIds() const
{
    return m_chcIds;
}

void RemoveChcDeployVpcRequest::SetChcIds(const vector<string>& _chcIds)
{
    m_chcIds = _chcIds;
    m_chcIdsHasBeenSet = true;
}

bool RemoveChcDeployVpcRequest::ChcIdsHasBeenSet() const
{
