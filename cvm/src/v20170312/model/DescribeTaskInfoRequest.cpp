...
int64_t DescribeTaskInfoRequest::GetLimit() const
{
    return m_limit;
}

void DescribeTaskInfoRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
...
int64_t DescribeTaskInfoRequest::GetOffset() const
{
    return m_offset;
}

void DescribeTaskInfoRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
string DescribeTaskInfoRequest::GetProduct() const
{
    return m_product;
}

void DescribeTaskInfoRequest::SetProduct(const string& _product)
{
    m_product = _product;
    m_productHasBeenSet = true;
}

bool DescribeTaskInfoRequest::ProductHasBeenSet() const
{
    return m_productHasBeenSet;
}

vector<int64_t> DescribeTaskInfoRequest::GetTaskStatus() const
{
    return m_taskStatus;
}

void DescribeTaskInfoRequest::SetTaskStatus(const vector<int64_t>& _taskStatus)
{
...
vector<int64_t> DescribeTaskInfoRequest::GetTaskTypeIds() const
{
    return m_taskTypeIds;
}

void DescribeTaskInfoRequest::SetTaskTypeIds(const vector<int64_t>& _taskTypeIds)
{
...
int64_t DescribeTaskInfoRequest::GetOrder() const
{
    return m_order;
}

void DescribeTaskInfoRequest::SetOrder(const int64_t& _order)
{
    m_order = _order;
