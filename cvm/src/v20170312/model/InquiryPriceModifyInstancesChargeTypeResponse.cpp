...
CoreInternalOutcome InquiryPriceModifyInstancesChargeTypeResponse::Deserialize(const string &payload)
{
...
string InquiryPriceModifyInstancesChargeTypeResponse::ToJsonString() const
{
...
Price InquiryPriceModifyInstancesChargeTypeResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceModifyInstancesChargeTypeResponse::PriceHasBeenSet() const
{
