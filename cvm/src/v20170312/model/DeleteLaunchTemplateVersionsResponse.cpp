...
CoreInternalOutcome DeleteLaunchTemplateVersionsResponse::Deserialize(const string &payload)
{
...
string DeleteLaunchTemplateVersionsResponse::ToJsonString() const
{
