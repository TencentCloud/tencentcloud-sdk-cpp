...
CoreInternalOutcome InquiryPriceResizeInstanceDisksResponse::Deserialize(const string &payload)
{
...
string InquiryPriceResizeInstanceDisksResponse::ToJsonString() const
{
...
Price InquiryPriceResizeInstanceDisksResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceResizeInstanceDisksResponse::PriceHasBeenSet() const
{
