...
CoreInternalOutcome DescribeInstancesAttributesResponse::Deserialize(const string &payload)
{
...
string DescribeInstancesAttributesResponse::ToJsonString() const
{
...
vector<InstanceAttribute> DescribeInstancesAttributesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeInstancesAttributesResponse::InstanceSetHasBeenSet() const
{
