...
CoreInternalOutcome InquiryPriceRunInstancesResponse::Deserialize(const string &payload)
{
...
string InquiryPriceRunInstancesResponse::ToJsonString() const
{
...
Price InquiryPriceRunInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceRunInstancesResponse::PriceHasBeenSet() const
{
