...
CoreInternalOutcome InquiryPriceResetInstancesInternetMaxBandwidthResponse::Deserialize(const string &payload)
{
...
string InquiryPriceResetInstancesInternetMaxBandwidthResponse::ToJsonString() const
{
...
Price InquiryPriceResetInstancesInternetMaxBandwidthResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceResetInstancesInternetMaxBandwidthResponse::PriceHasBeenSet() const
{
