...
string CreateHpcClusterRequest::ToJsonString() const
{
...
string CreateHpcClusterRequest::GetZone() const
{
    return m_zone;
}

void CreateHpcClusterRequest::SetZone(const string& _zone)
{
    m_zone = _zone;
    m_zoneHasBeenSet = true;
}

bool CreateHpcClusterRequest::ZoneHasBeenSet() const
{
    return m_zoneHasBeenSet;
}

string CreateHpcClusterRequest::GetName() const
{
    return m_name;
}

void CreateHpcClusterRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool CreateHpcClusterRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateHpcClusterRequest::GetRemark() const
{
    return m_remark;
}

void CreateHpcClusterRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
