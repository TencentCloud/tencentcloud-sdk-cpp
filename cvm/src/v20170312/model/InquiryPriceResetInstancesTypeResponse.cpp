...
CoreInternalOutcome InquiryPriceResetInstancesTypeResponse::Deserialize(const string &payload)
{
...
string InquiryPriceResetInstancesTypeResponse::ToJsonString() const
{
...
Price InquiryPriceResetInstancesTypeResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceResetInstancesTypeResponse::PriceHasBeenSet() const
{
