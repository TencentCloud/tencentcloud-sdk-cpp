...
string DescribeChcDeniedActionsRequest::ToJsonString() const
{
...
vector<string> DescribeChcDeniedActionsRequest::GetChcIds() const
{
    return m_chcIds;
}

void DescribeChcDeniedActionsRequest::SetChcIds(const vector<string>& _chcIds)
{
    m_chcIds = _chcIds;
    m_chcIdsHasBeenSet = true;
}

bool DescribeChcDeniedActionsRequest::ChcIdsHasBeenSet() const
{
