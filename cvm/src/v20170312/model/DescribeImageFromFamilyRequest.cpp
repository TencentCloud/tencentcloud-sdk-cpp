...
string DescribeImageFromFamilyRequest::ToJsonString() const
{
...
string DescribeImageFromFamilyRequest::GetImageFamily() const
{
    return m_imageFamily;
}

void DescribeImageFromFamilyRequest::SetImageFamily(const string& _imageFamily)
{
    m_imageFamily = _imageFamily;
    m_imageFamilyHasBeenSet = true;
}

bool DescribeImageFromFamilyRequest::ImageFamilyHasBeenSet() const
{
