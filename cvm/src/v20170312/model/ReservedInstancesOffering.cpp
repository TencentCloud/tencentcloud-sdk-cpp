...
CoreInternalOutcome ReservedInstancesOffering::Deserialize(const Value &value)
{
    string requestId = "";
...
void ReservedInstancesOffering::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
