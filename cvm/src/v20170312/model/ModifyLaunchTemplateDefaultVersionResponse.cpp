...
CoreInternalOutcome ModifyLaunchTemplateDefaultVersionResponse::Deserialize(const string &payload)
{
...
string ModifyLaunchTemplateDefaultVersionResponse::ToJsonString() const
{
