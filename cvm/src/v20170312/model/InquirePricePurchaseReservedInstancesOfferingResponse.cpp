...
CoreInternalOutcome InquirePricePurchaseReservedInstancesOfferingResponse::Deserialize(const string &payload)
{
...
string InquirePricePurchaseReservedInstancesOfferingResponse::ToJsonString() const
{
...
ReservedInstancePrice InquirePricePurchaseReservedInstancesOfferingResponse::GetPrice() const
{
    return m_price;
}

bool InquirePricePurchaseReservedInstancesOfferingResponse::PriceHasBeenSet() const
{
