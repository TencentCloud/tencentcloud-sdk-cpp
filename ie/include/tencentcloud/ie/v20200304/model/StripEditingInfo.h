...
#ifndef TENCENTCLOUD_IE_V20200304_MODEL_STRIPEDITINGINFO_H_
#define TENCENTCLOUD_IE_V20200304_MODEL_STRIPEDITINGINFO_H_
    ...
    namespace Ie
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                * 智能拆条任务参数信息
                */
                class StripEditingInfo : public AbstractModel
                {
                public:
                    StripEditingInfo();
                    ~StripEditingInfo() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取是否开启智能拆条。0为关闭，1为开启。其他非0非1值默认为0。
                     * @return Switch 是否开启智能拆条。0为关闭，1为开启。其他非0非1值默认为0。
                     * 
                     */
                    int64_t GetSwitch() const;

                    /**
                     * 设置是否开启智能拆条。0为关闭，1为开启。其他非0非1值默认为0。
...
#endif // !TENCENTCLOUD_IE_V20200304_MODEL_STRIPEDITINGINFO_H_
