...
#ifndef TENCENTCLOUD_IE_V20200304_MODEL_OPENINGENDINGEDITINGINFO_H_
#define TENCENTCLOUD_IE_V20200304_MODEL_OPENINGENDINGEDITINGINFO_H_
    ...
    namespace Ie
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                * 片头片尾识别任务参数信息
                */
                class OpeningEndingEditingInfo : public AbstractModel
                {
                public:
                    OpeningEndingEditingInfo();
                    ~OpeningEndingEditingInfo() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取是否开启片头片尾识别。0为关闭，1为开启。其他非0非1值默认为0。
                     * @return Switch 是否开启片头片尾识别。0为关闭，1为开启。其他非0非1值默认为0。
                     * 
                     */
                    int64_t GetSwitch() const;

                    /**
                     * 设置是否开启片头片尾识别。0为关闭，1为开启。其他非0非1值默认为0。
...
#endif // !TENCENTCLOUD_IE_V20200304_MODEL_OPENINGENDINGEDITINGINFO_H_
