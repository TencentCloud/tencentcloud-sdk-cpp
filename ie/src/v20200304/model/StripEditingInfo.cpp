...
int64_t StripEditingInfo::GetSwitch() const
{
    return m_switch;
}

void StripEditingInfo::SetSwitch(const int64_t& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool StripEditingInfo::SwitchHasBeenSet() const
{
    return m_switchHasBeenSet;
}

string StripEditingInfo::GetCustomInfo() const
{
    return m_customInfo;
}

void StripEditingInfo::SetCustomInfo(const string& _customInfo)
{
    m_customInfo = _customInfo;
    m_customInfoHasBeenSet = true;
}

bool StripEditingInfo::CustomInfoHasBeenSet() const
{
