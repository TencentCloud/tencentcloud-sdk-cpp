...
CoreInternalOutcome ClassificationEditingInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ClassificationEditingInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
