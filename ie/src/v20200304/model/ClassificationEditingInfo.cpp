...
CoreInternalOutcome ClassificationEditingInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ClassificationEditingInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
int64_t ClassificationEditingInfo::GetSwitch() const
{
    return m_switch;
}

void ClassificationEditingInfo::SetSwitch(const int64_t& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool ClassificationEditingInfo::SwitchHasBeenSet() const
{
    return m_switchHasBeenSet;
}

string ClassificationEditingInfo::GetCustomInfo() const
{
    return m_customInfo;
}

void ClassificationEditingInfo::SetCustomInfo(const string& _customInfo)
{
    m_customInfo = _customInfo;
    m_customInfoHasBeenSet = true;
}

bool ClassificationEditingInfo::CustomInfoHasBeenSet() const
{
