...
CoreInternalOutcome DescribeMediaProcessTaskResultResponse::Deserialize(const string &payload)
{
...
string DescribeMediaProcessTaskResultResponse::ToJsonString() const
{
...
MediaProcessTaskResult DescribeMediaProcessTaskResultResponse::GetTaskResult() const
{
    return m_taskResult;
}

bool DescribeMediaProcessTaskResultResponse::TaskResultHasBeenSet() const
{
