...
CoreInternalOutcome StopMediaQualityRestorationTaskResponse::Deserialize(const string &payload)
{
...
string StopMediaQualityRestorationTaskResponse::ToJsonString() const
{
