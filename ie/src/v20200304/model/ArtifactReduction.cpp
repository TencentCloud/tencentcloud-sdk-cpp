...
CoreInternalOutcome ArtifactReduction::Deserialize(const Value &value)
{
    string requestId = "";
...
void ArtifactReduction::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
