...
CoreInternalOutcome DescribeEditingTaskResultResponse::Deserialize(const string &payload)
{
...
string DescribeEditingTaskResultResponse::ToJsonString() const
{
...
EditingTaskResult DescribeEditingTaskResultResponse::GetTaskResult() const
{
    return m_taskResult;
}

bool DescribeEditingTaskResultResponse::TaskResultHasBeenSet() const
{
