...
CoreInternalOutcome DescribeMediaQualityRestorationTaskRusultResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TaskResult") && !rsp["TaskResult"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TaskResult` is not object type").SetRequestId(requestId));
        }
...
string DescribeMediaQualityRestorationTaskRusultResponse::ToJsonString() const
{
...
MediaQualityRestorationTaskResult DescribeMediaQualityRestorationTaskRusultResponse::GetTaskResult() const
{
    return m_taskResult;
}

bool DescribeMediaQualityRestorationTaskRusultResponse::TaskResultHasBeenSet() const
{
