...
int64_t DescribeResourceUsageInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeResourceUsageInfoResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

ResourceUsageInfoData DescribeResourceUsageInfoResponse::GetData() const
{
    return m_data;
}
