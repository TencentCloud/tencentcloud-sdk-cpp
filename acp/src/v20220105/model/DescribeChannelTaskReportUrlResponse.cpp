...
CoreInternalOutcome DescribeChannelTaskReportUrlResponse::Deserialize(const string &payload)
{
...
string DescribeChannelTaskReportUrlResponse::ToJsonString() const
{
...
int64_t DescribeChannelTaskReportUrlResponse::GetResult() const
{
    return m_result;
}

bool DescribeChannelTaskReportUrlResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string DescribeChannelTaskReportUrlResponse::GetReportUrl() const
{
    return m_reportUrl;
}

bool DescribeChannelTaskReportUrlResponse::ReportUrlHasBeenSet() const
{
    return m_reportUrlHasBeenSet;
}

string DescribeChannelTaskReportUrlResponse::GetReportTitle() const
{
    return m_reportTitle;
}

bool DescribeChannelTaskReportUrlResponse::ReportTitleHasBeenSet() const
{
