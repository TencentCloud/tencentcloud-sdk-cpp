            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取任务来源, -1:所有, 0:默认值(私域), 1:灵犀, 2:灵鲲;
                     * @return Source 任务来源, -1:所有, 0:默认值(私域), 1:灵犀, 2:灵鲲;
                     */
                    int64_t GetSource() const;

                    /**
                     * 设置任务来源, -1:所有, 0:默认值(私域), 1:灵犀, 2:灵鲲;
                    ...
                    /**
                     * 获取任务状态,可多值查询,比如:"1,2,3" 0:默认值(待检测/待咨询), 1.检测中, 2:待评估, 3:评估中, 4:任务完成/咨询完成, 5:任务失败, 6:咨询中;
                    ...
                    /**
                     * 设置任务状态,可多值查询,比如:"1,2,3" 0:默认值(待检测/待咨询), 1.检测中, 2:待评估, 3:评估中, 4:任务完成/咨询完成, 5:任务失败, 6:咨询中;
                    ...
                    /**
                     * 获取任务类型,可多值查询,采用逗号分隔,比如:"0,1" 0:基础版, 1:专家版, 2:本地化
                     * @return TaskTypes 任务类型,可多值查询,采用逗号分隔,比如:"0,1" 0:基础版, 1:专家版, 2:本地化
                     */
                    std::string GetTaskTypes() const;

                    /**
                     * 设置任务类型,可多值查询,采用逗号分隔,比如:"0,1" 0:基础版, 1:专家版, 2:本地化
