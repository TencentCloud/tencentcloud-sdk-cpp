...
string DescribeStrategyRequest::ToJsonString() const
{
...
string DescribeStrategyRequest::GetStrategyId() const
{
    return m_strategyId;
}

void DescribeStrategyRequest::SetStrategyId(const string& _strategyId)
{
    m_strategyId = _strategyId;
    m_strategyIdHasBeenSet = true;
}

bool DescribeStrategyRequest::StrategyIdHasBeenSet() const
{
