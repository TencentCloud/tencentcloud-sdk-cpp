...
CoreInternalOutcome AccountGroupInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("GroupId") && !value["GroupId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AccountGroupInfo.GroupId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AccountGroupInfo::GetGroupId() const
{
    return m_groupId;
}

void AccountGroupInfo::SetGroupId(const string& _groupId)
{
    m_groupId = _groupId;
    m_groupIdHasBeenSet = true;
}

bool AccountGroupInfo::GroupIdHasBeenSet() const
{
