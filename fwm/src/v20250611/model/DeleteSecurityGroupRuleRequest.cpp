...
string DeleteSecurityGroupRuleRequest::GetGroupId() const
{
    return m_groupId;
}

void DeleteSecurityGroupRuleRequest::SetGroupId(const string& _groupId)
{
    m_groupId = _groupId;
    m_groupIdHasBeenSet = true;
}

bool DeleteSecurityGroupRuleRequest::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

vector<string> DeleteSecurityGroupRuleRequest::GetRuleIds() const
{
    return m_ruleIds;
}

void DeleteSecurityGroupRuleRequest::SetRuleIds(const vector<string>& _ruleIds)
{
    m_ruleIds = _ruleIds;
    m_ruleIdsHasBeenSet = true;
}

bool DeleteSecurityGroupRuleRequest::RuleIdsHasBeenSet() const
{
