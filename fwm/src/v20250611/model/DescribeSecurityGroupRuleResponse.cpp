...
DescribeSecurityGroupRuleResponse::DescribeSecurityGroupRuleResponse() :
    m_ruleHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSecurityGroupRuleResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityGroupRuleResponse::ToJsonString() const
{
...
SgRuleResp DescribeSecurityGroupRuleResponse::GetRule() const
{
    return m_rule;
}

bool DescribeSecurityGroupRuleResponse::RuleHasBeenSet() const
{
