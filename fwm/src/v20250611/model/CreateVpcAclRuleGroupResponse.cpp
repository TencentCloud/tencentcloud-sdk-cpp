...
CreateVpcAclRuleGroupResponse::CreateVpcAclRuleGroupResponse() :
    m_groupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateVpcAclRuleGroupResponse::Deserialize(const string &payload)
{
...
string CreateVpcAclRuleGroupResponse::ToJsonString() const
{
...
string CreateVpcAclRuleGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateVpcAclRuleGroupResponse::GroupIdHasBeenSet() const
{
