...
CreateEdgeAclRuleGroupResponse::CreateEdgeAclRuleGroupResponse() :
    m_groupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateEdgeAclRuleGroupResponse::Deserialize(const string &payload)
{
...
string CreateEdgeAclRuleGroupResponse::ToJsonString() const
{
...
string CreateEdgeAclRuleGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateEdgeAclRuleGroupResponse::GroupIdHasBeenSet() const
{
