...
DescribeOrganSummaryResponse::DescribeOrganSummaryResponse() :
    m_summaryHasBeenSet(false)
{
}

CoreInternalOutcome DescribeOrganSummaryResponse::Deserialize(const string &payload)
{
...
string DescribeOrganSummaryResponse::ToJsonString() const
{
...
OrganSummary DescribeOrganSummaryResponse::GetSummary() const
{
    return m_summary;
}

bool DescribeOrganSummaryResponse::SummaryHasBeenSet() const
{
