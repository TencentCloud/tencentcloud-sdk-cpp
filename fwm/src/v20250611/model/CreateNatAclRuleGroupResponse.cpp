...
CreateNatAclRuleGroupResponse::CreateNatAclRuleGroupResponse() :
    m_groupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateNatAclRuleGroupResponse::Deserialize(const string &payload)
{
...
string CreateNatAclRuleGroupResponse::ToJsonString() const
{
...
string CreateNatAclRuleGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateNatAclRuleGroupResponse::GroupIdHasBeenSet() const
{
