...
string DeleteRuleGroupRequest::ToJsonString() const
{
...
vector<string> DeleteRuleGroupRequest::GetGroupIds() const
{
    return m_groupIds;
}

void DeleteRuleGroupRequest::SetGroupIds(const vector<string>& _groupIds)
{
    m_groupIds = _groupIds;
    m_groupIdsHasBeenSet = true;
}

bool DeleteRuleGroupRequest::GroupIdsHasBeenSet() const
{
