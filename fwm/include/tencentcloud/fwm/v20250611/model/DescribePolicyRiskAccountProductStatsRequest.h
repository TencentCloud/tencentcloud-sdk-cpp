...
#ifndef TENCENTCLOUD_FWM_V20250611_MODEL_DESCRIBEPOLICYRISKACCOUNTPRODUCTSTATSREQUEST_H_
#define TENCENTCLOUD_FWM_V20250611_MODEL_DESCRIBEPOLICYRISKACCOUNTPRODUCTSTATSREQUEST_H_
    ...
    namespace Fwm
    {
        namespace V20250611
        {
            namespace Model
            {
                ...
                */
                class DescribePolicyRiskAccountProductStatsRequest : public AbstractModel
                {
                public:
                    DescribePolicyRiskAccountProductStatsRequest();
                    ~DescribePolicyRiskAccountProductStatsRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取分页大小，按账号分页，默认20，最大100
                    ...
                    /**
                     * 获取筛选条件列表。支持的筛选字段：AccountName（账号名称模糊搜索）、AccountId（账号Uin精确搜索）、OnlyUntreated（仅看待整改，值为1时生效）、OnlyOverdue（仅超时未体检，值为1时生效）
                    ...
                    /**
                     * 设置筛选条件列表。支持的筛选字段：AccountName（账号名称模糊搜索）、AccountId（账号Uin精确搜索）、OnlyUntreated（仅看待整改，值为1时生效）、OnlyOverdue（仅超时未体检，值为1时生效）
...
#endif // !TENCENTCLOUD_FWM_V20250611_MODEL_DESCRIBEPOLICYRISKACCOUNTPRODUCTSTATSREQUEST_H_
