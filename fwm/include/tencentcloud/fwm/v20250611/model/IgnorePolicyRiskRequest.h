...
#ifndef TENCENTCLOUD_FWM_V20250611_MODEL_IGNOREPOLICYRISKREQUEST_H_
#define TENCENTCLOUD_FWM_V20250611_MODEL_IGNOREPOLICYRISKREQUEST_H_
    ...
    namespace Fwm
    {
        namespace V20250611
        {
            namespace Model
            {
                ...
                */
                class IgnorePolicyRiskRequest : public AbstractModel
                {
                public:
                    IgnorePolicyRiskRequest();
                    ~IgnorePolicyRiskRequest() = default;
...
#endif // !TENCENTCLOUD_FWM_V20250611_MODEL_IGNOREPOLICYRISKREQUEST_H_
