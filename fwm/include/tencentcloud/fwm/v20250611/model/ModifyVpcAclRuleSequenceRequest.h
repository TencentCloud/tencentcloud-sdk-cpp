...
#ifndef TENCENTCLOUD_FWM_V20250611_MODEL_MODIFYVPCACLRULESEQUENCEREQUEST_H_
#define TENCENTCLOUD_FWM_V20250611_MODEL_MODIFYVPCACLRULESEQUENCEREQUEST_H_
    ...
    namespace Fwm
    {
        namespace V20250611
        {
            namespace Model
            {
                ...
                */
                class ModifyVpcAclRuleSequenceRequest : public AbstractModel
                {
                public:
                    ModifyVpcAclRuleSequenceRequest();
                    ~ModifyVpcAclRuleSequenceRequest() = default;
...
#endif // !TENCENTCLOUD_FWM_V20250611_MODEL_MODIFYVPCACLRULESEQUENCEREQUEST_H_
