...
#ifndef TENCENTCLOUD_FWM_V20250611_MODEL_CREATEEDGEACLRULEGROUPREQUEST_H_
#define TENCENTCLOUD_FWM_V20250611_MODEL_CREATEEDGEACLRULEGROUPREQUEST_H_
    ...
    namespace Fwm
    {
        namespace V20250611
        {
            namespace Model
            {
                ...
                */
                class CreateEdgeAclRuleGroupRequest : public AbstractModel
                {
                public:
                    CreateEdgeAclRuleGroupRequest();
                    ~CreateEdgeAclRuleGroupRequest() = default;
...
#endif // !TENCENTCLOUD_FWM_V20250611_MODEL_CREATEEDGEACLRULEGROUPREQUEST_H_
