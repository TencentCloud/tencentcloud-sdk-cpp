...
CoreInternalOutcome CreateSnapshotResponse::Deserialize(const string &payload)
{
...
string CreateSnapshotResponse::ToJsonString() const
{
...
string CreateSnapshotResponse::GetSnapshotId() const
{
    return m_snapshotId;
}

bool CreateSnapshotResponse::SnapshotIdHasBeenSet() const
{
