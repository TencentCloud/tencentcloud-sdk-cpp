...
string DescribeSnapshotSharePermissionRequest::ToJsonString() const
{
...
string DescribeSnapshotSharePermissionRequest::GetSnapshotId() const
{
    return m_snapshotId;
}

void DescribeSnapshotSharePermissionRequest::SetSnapshotId(const string& _snapshotId)
{
    m_snapshotId = _snapshotId;
    m_snapshotIdHasBeenSet = true;
}

bool DescribeSnapshotSharePermissionRequest::SnapshotIdHasBeenSet() const
{
