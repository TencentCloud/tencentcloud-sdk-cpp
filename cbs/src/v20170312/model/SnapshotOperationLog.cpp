...
CoreInternalOutcome SnapshotOperationLog::Deserialize(const Value &value)
{
    string requestId = "";
...
void SnapshotOperationLog::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
