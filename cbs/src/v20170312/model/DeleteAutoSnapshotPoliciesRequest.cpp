...
string DeleteAutoSnapshotPoliciesRequest::ToJsonString() const
{
...
vector<string> DeleteAutoSnapshotPoliciesRequest::GetAutoSnapshotPolicyIds() const
{
    return m_autoSnapshotPolicyIds;
}

void DeleteAutoSnapshotPoliciesRequest::SetAutoSnapshotPolicyIds(const vector<string>& _autoSnapshotPolicyIds)
{
    m_autoSnapshotPolicyIds = _autoSnapshotPolicyIds;
    m_autoSnapshotPolicyIdsHasBeenSet = true;
}

bool DeleteAutoSnapshotPoliciesRequest::AutoSnapshotPolicyIdsHasBeenSet() const
{
