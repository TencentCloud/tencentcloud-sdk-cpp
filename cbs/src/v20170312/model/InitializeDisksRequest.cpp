...
string InitializeDisksRequest::ToJsonString() const
{
...
vector<string> InitializeDisksRequest::GetDiskIds() const
{
    return m_diskIds;
}

void InitializeDisksRequest::SetDiskIds(const vector<string>& _diskIds)
{
    m_diskIds = _diskIds;
    m_diskIdsHasBeenSet = true;
}

bool InitializeDisksRequest::DiskIdsHasBeenSet() const
{
