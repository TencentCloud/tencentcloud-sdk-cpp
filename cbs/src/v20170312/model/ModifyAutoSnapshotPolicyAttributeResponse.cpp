...
CoreInternalOutcome ModifyAutoSnapshotPolicyAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyAutoSnapshotPolicyAttributeResponse::ToJsonString() const
{
