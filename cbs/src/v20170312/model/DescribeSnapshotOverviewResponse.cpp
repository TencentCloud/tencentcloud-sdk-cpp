...
CoreInternalOutcome DescribeSnapshotOverviewResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["TotalNums"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `TotalNums` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_totalNums = rsp["TotalNums"].GetUint64();
...
string DescribeSnapshotOverviewResponse::ToJsonString() const
{
...
uint64_t DescribeSnapshotOverviewResponse::GetTotalNums() const
{
    return m_totalNums;
}

bool DescribeSnapshotOverviewResponse::TotalNumsHasBeenSet() const
{
    return m_totalNumsHasBeenSet;
}

double DescribeSnapshotOverviewResponse::GetTotalSize() const
{
    return m_totalSize;
}

bool DescribeSnapshotOverviewResponse::TotalSizeHasBeenSet() const
{
    return m_totalSizeHasBeenSet;
}

double DescribeSnapshotOverviewResponse::GetFreeQuota() const
{
    return m_freeQuota;
}

bool DescribeSnapshotOverviewResponse::FreeQuotaHasBeenSet() const
{
    return m_freeQuotaHasBeenSet;
}

double DescribeSnapshotOverviewResponse::GetRealTradeSize() const
{
    return m_realTradeSize;
}

bool DescribeSnapshotOverviewResponse::RealTradeSizeHasBeenSet() const
{
