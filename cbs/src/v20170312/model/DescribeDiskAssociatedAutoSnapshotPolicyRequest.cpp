...
string DescribeDiskAssociatedAutoSnapshotPolicyRequest::ToJsonString() const
{
...
string DescribeDiskAssociatedAutoSnapshotPolicyRequest::GetDiskId() const
{
    return m_diskId;
}

void DescribeDiskAssociatedAutoSnapshotPolicyRequest::SetDiskId(const string& _diskId)
{
    m_diskId = _diskId;
    m_diskIdHasBeenSet = true;
}

bool DescribeDiskAssociatedAutoSnapshotPolicyRequest::DiskIdHasBeenSet() const
{
