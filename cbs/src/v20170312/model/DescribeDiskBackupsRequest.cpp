...
uint64_t DescribeDiskBackupsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeDiskBackupsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeDiskBackupsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeDiskBackupsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
string DescribeDiskBackupsRequest::GetOrder() const
{
    return m_order;
}

void DescribeDiskBackupsRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeDiskBackupsRequest::OrderHasBeenSet() const
{
    return m_orderHasBeenSet;
}

string DescribeDiskBackupsRequest::GetOrderField() const
{
    return m_orderField;
}

void DescribeDiskBackupsRequest::SetOrderField(const string& _orderField)
{
    m_orderField = _orderField;
    m_orderFieldHasBeenSet = true;
}

bool DescribeDiskBackupsRequest::OrderFieldHasBeenSet() const
{
