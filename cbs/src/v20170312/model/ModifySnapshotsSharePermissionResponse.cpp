...
CoreInternalOutcome ModifySnapshotsSharePermissionResponse::Deserialize(const string &payload)
{
...
string ModifySnapshotsSharePermissionResponse::ToJsonString() const
{
