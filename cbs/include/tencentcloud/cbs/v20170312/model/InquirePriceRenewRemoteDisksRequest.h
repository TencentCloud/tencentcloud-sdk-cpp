...
#ifndef TENCENTCLOUD_CBS_V20170312_MODEL_INQUIREPRICERENEWREMOTEDISKSREQUEST_H_
#define TENCENTCLOUD_CBS_V20170312_MODEL_INQUIREPRICERENEWREMOTEDISKSREQUEST_H_
    ...
    namespace Cbs
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class InquirePriceRenewRemoteDisksRequest : public AbstractModel
                {
                public:
                    InquirePriceRenewRemoteDisksRequest();
                    ~InquirePriceRenewRemoteDisksRequest() = default;
...
#endif // !TENCENTCLOUD_CBS_V20170312_MODEL_INQUIREPRICERENEWREMOTEDISKSREQUEST_H_
