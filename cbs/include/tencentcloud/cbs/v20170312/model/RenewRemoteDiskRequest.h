...
#ifndef TENCENTCLOUD_CBS_V20170312_MODEL_RENEWREMOTEDISKREQUEST_H_
#define TENCENTCLOUD_CBS_V20170312_MODEL_RENEWREMOTEDISKREQUEST_H_
    ...
    namespace Cbs
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class RenewRemoteDiskRequest : public AbstractModel
                {
                public:
                    RenewRemoteDiskRequest();
                    ~RenewRemoteDiskRequest() = default;
...
#endif // !TENCENTCLOUD_CBS_V20170312_MODEL_RENEWREMOTEDISKREQUEST_H_
