...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string GetUnitPriceDiscount() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    void SetUnitPriceDiscount(const std::string& _unitPriceDiscount);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::string m_unitPriceDiscount;
