...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_TASKSCHEDULINGPARAMETERBRIEF_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_TASKSCHEDULINGPARAMETERBRIEF_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                */
                class TaskSchedulingParameterBrief : public AbstractModel
                {
                public:
                    TaskSchedulingParameterBrief();
                    ~TaskSchedulingParameterBrief() = default;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_TASKSCHEDULINGPARAMETERBRIEF_H_
