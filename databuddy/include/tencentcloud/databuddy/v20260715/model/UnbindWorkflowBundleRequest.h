...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UNBINDWORKFLOWBUNDLEREQUEST_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UNBINDWORKFLOWBUNDLEREQUEST_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                */
                class UnbindWorkflowBundleRequest : public AbstractModel
                {
                public:
                    UnbindWorkflowBundleRequest();
                    ~UnbindWorkflowBundleRequest() = default;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UNBINDWORKFLOWBUNDLEREQUEST_H_
