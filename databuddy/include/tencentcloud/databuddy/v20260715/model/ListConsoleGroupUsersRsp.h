...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPUSERSRSP_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPUSERSRSP_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                * 查询控制台用户组成员列表响应
                */
                class ListConsoleGroupUsersRsp : public AbstractModel
                {
                public:
                    ListConsoleGroupUsersRsp();
                    ~ListConsoleGroupUsersRsp() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * @return Items 用户组成员列表
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ConsoleGroupUserInfo> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<ConsoleGroupUserInfo>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ConsoleGroupUserInfo> m_items;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPUSERSRSP_H_
