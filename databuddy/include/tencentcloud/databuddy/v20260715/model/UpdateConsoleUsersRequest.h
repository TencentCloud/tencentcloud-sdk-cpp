...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UPDATECONSOLEUSERSREQUEST_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UPDATECONSOLEUSERSREQUEST_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                */
                class UpdateConsoleUsersRequest : public AbstractModel
                {
                public:
                    UpdateConsoleUsersRequest();
                    ~UpdateConsoleUsersRequest() = default;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_UPDATECONSOLEUSERSREQUEST_H_
