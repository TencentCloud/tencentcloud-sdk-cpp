...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTWORKFLOWSRSP_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTWORKFLOWSRSP_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                * ListWorkflowsRsp
                */
                class ListWorkflowsRsp : public AbstractModel
                {
                public:
                    ListWorkflowsRsp();
                    ~ListWorkflowsRsp() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<WorkflowBrief> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<WorkflowBrief>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<WorkflowBrief> m_items;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTWORKFLOWSRSP_H_
