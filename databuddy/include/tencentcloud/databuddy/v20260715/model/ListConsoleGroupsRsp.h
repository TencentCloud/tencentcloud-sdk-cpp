...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPSRSP_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPSRSP_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                * 查询控制台用户组列表响应
                */
                class ListConsoleGroupsRsp : public AbstractModel
                {
                public:
                    ListConsoleGroupsRsp();
                    ~ListConsoleGroupsRsp() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ConsoleGroupInfo> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<ConsoleGroupInfo>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ConsoleGroupInfo> m_items;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_LISTCONSOLEGROUPSRSP_H_
