...
#ifndef TENCENTCLOUD_DATABUDDY_V20260715_MODEL_ADVANCEDPARAMETER_H_
#define TENCENTCLOUD_DATABUDDY_V20260715_MODEL_ADVANCEDPARAMETER_H_
    ...
    namespace Databuddy
    {
        namespace V20260715
        {
            namespace Model
            {
                ...
                */
                class AdvancedParameter : public AbstractModel
                {
                public:
                    AdvancedParameter();
                    ~AdvancedParameter() = default;
...
#endif // !TENCENTCLOUD_DATABUDDY_V20260715_MODEL_ADVANCEDPARAMETER_H_
