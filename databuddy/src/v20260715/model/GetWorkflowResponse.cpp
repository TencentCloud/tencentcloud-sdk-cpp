...
CoreInternalOutcome GetWorkflowResponse::Deserialize(const string &payload)
{
...
string GetWorkflowResponse::ToJsonString() const
{
...
GetWorkflowRsp GetWorkflowResponse::GetData() const
{
    return m_data;
}

bool GetWorkflowResponse::DataHasBeenSet() const
{
