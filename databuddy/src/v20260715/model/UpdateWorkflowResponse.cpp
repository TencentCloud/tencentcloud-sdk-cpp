...
CoreInternalOutcome UpdateWorkflowResponse::Deserialize(const string &payload)
{
...
string UpdateWorkflowResponse::ToJsonString() const
{
...
UpdateWorkflowRsp UpdateWorkflowResponse::GetData() const
{
    return m_data;
}

bool UpdateWorkflowResponse::DataHasBeenSet() const
{
