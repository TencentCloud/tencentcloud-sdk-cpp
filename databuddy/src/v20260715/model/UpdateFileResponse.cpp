...
CoreInternalOutcome UpdateFileResponse::Deserialize(const string &payload)
{
...
string UpdateFileResponse::ToJsonString() const
{
...
FileInfo UpdateFileResponse::GetData() const
{
    return m_data;
}

bool UpdateFileResponse::DataHasBeenSet() const
{
