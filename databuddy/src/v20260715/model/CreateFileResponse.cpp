...
CoreInternalOutcome CreateFileResponse::Deserialize(const string &payload)
{
...
string CreateFileResponse::ToJsonString() const
{
...
FileInfo CreateFileResponse::GetData() const
{
    return m_data;
}

bool CreateFileResponse::DataHasBeenSet() const
{
