...
CoreInternalOutcome GetFileResponse::Deserialize(const string &payload)
{
...
string GetFileResponse::ToJsonString() const
{
...
FileInfo GetFileResponse::GetData() const
{
    return m_data;
}

bool GetFileResponse::DataHasBeenSet() const
{
