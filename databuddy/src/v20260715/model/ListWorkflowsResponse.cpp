...
CoreInternalOutcome ListWorkflowsResponse::Deserialize(const string &payload)
{
...
string ListWorkflowsResponse::ToJsonString() const
{
...
ListWorkflowsRsp ListWorkflowsResponse::GetData() const
{
    return m_data;
}

bool ListWorkflowsResponse::DataHasBeenSet() const
{
