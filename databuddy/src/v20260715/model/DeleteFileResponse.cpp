...
CoreInternalOutcome DeleteFileResponse::Deserialize(const string &payload)
{
...
string DeleteFileResponse::ToJsonString() const
{
...
DeleteFileResult DeleteFileResponse::GetData() const
{
    return m_data;
}

bool DeleteFileResponse::DataHasBeenSet() const
{
