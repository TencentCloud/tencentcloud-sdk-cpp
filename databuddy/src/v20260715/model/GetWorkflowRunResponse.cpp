...
CoreInternalOutcome GetWorkflowRunResponse::Deserialize(const string &payload)
{
...
string GetWorkflowRunResponse::ToJsonString() const
{
...
GetWorkflowRunRsp GetWorkflowRunResponse::GetData() const
{
    return m_data;
}

bool GetWorkflowRunResponse::DataHasBeenSet() const
{
