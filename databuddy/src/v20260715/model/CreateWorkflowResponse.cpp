...
CoreInternalOutcome CreateWorkflowResponse::Deserialize(const string &payload)
{
...
string CreateWorkflowResponse::ToJsonString() const
{
...
CreateWorkflowRsp CreateWorkflowResponse::GetData() const
{
    return m_data;
}

bool CreateWorkflowResponse::DataHasBeenSet() const
{
