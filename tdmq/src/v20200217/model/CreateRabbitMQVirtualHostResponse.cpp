...
CoreInternalOutcome CreateRabbitMQVirtualHostResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQVirtualHostResponse::ToJsonString() const
{
...
string CreateRabbitMQVirtualHostResponse::GetVirtualHost() const
{
    return m_virtualHost;
}

bool CreateRabbitMQVirtualHostResponse::VirtualHostHasBeenSet() const
{
