...
CoreInternalOutcome DescribeRocketMQVipInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQVipInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeRocketMQVipInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRocketMQVipInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RocketMQVipInstance> DescribeRocketMQVipInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeRocketMQVipInstancesResponse::InstancesHasBeenSet() const
{
