...
CoreInternalOutcome DescribeClusterDetailResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["ClusterSet"].IsObject())
        {
            return CoreInternalOutcome(Core::Error("response `ClusterSet` is not object type").SetRequestId(requestId));
        }

        CoreInternalOutcome outcome = m_clusterSet.Deserialize(rsp["ClusterSet"]);
...
string DescribeClusterDetailResponse::ToJsonString() const
{
    ...
    if (m_clusterSetHasBeenSet)
    {
        ...
        m_clusterSet.ToJsonObject(value[key.c_str()], allocator);
    }
...
Cluster DescribeClusterDetailResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeClusterDetailResponse::ClusterSetHasBeenSet() const
{
