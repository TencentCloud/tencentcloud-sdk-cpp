...
CoreInternalOutcome DescribeRocketMQMsgTraceResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQMsgTraceResponse::ToJsonString() const
{
...
vector<TraceResult> DescribeRocketMQMsgTraceResponse::GetResult() const
{
    return m_result;
}

bool DescribeRocketMQMsgTraceResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string DescribeRocketMQMsgTraceResponse::GetShowTopicName() const
{
    return m_showTopicName;
}

bool DescribeRocketMQMsgTraceResponse::ShowTopicNameHasBeenSet() const
{
