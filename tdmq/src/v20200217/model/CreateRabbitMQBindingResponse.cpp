...
CoreInternalOutcome CreateRabbitMQBindingResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQBindingResponse::ToJsonString() const
{
...
string CreateRabbitMQBindingResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateRabbitMQBindingResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateRabbitMQBindingResponse::GetVirtualHost() const
{
    return m_virtualHost;
}

bool CreateRabbitMQBindingResponse::VirtualHostHasBeenSet() const
{
    return m_virtualHostHasBeenSet;
}

int64_t CreateRabbitMQBindingResponse::GetBindingId() const
{
    return m_bindingId;
}

bool CreateRabbitMQBindingResponse::BindingIdHasBeenSet() const
{
