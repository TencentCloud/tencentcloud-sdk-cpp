...
CoreInternalOutcome PublishCmqMsgResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("MsgId") && !rsp["MsgId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MsgId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string PublishCmqMsgResponse::ToJsonString() const
{
...
bool PublishCmqMsgResponse::GetResult() const
{
    return m_result;
}

bool PublishCmqMsgResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string PublishCmqMsgResponse::GetMsgId() const
{
    return m_msgId;
}

bool PublishCmqMsgResponse::MsgIdHasBeenSet() const
{
