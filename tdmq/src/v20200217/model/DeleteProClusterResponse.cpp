...
CoreInternalOutcome DeleteProClusterResponse::Deserialize(const string &payload)
{
...
string DeleteProClusterResponse::ToJsonString() const
{
...
string DeleteProClusterResponse::GetDealName() const
{
    return m_dealName;
}

bool DeleteProClusterResponse::DealNameHasBeenSet() const
{
