...
CoreInternalOutcome AMQPQueueDetail::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TopicName") && !value["TopicName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AMQPQueueDetail.TopicName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AMQPQueueDetail::GetTopicName() const
{
    return m_topicName;
}

void AMQPQueueDetail::SetTopicName(const string& _topicName)
{
    m_topicName = _topicName;
    m_topicNameHasBeenSet = true;
}

bool AMQPQueueDetail::TopicNameHasBeenSet() const
{
