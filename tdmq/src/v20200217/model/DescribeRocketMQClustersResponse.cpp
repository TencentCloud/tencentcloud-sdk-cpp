...
CoreInternalOutcome DescribeRocketMQClustersResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQClustersResponse::ToJsonString() const
{
...
vector<RocketMQClusterDetail> DescribeRocketMQClustersResponse::GetClusterList() const
{
    return m_clusterList;
}

bool DescribeRocketMQClustersResponse::ClusterListHasBeenSet() const
{
    return m_clusterListHasBeenSet;
}

uint64_t DescribeRocketMQClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRocketMQClustersResponse::TotalCountHasBeenSet() const
{
