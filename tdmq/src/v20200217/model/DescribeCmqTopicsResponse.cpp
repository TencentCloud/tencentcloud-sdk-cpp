...
CoreInternalOutcome DescribeCmqTopicsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TopicList") && !rsp["TopicList"].IsNull())
    {
        if (!rsp["TopicList"].IsArray())
            return CoreInternalOutcome(Error("response `TopicList` is not array type"));
...
string DescribeCmqTopicsResponse::ToJsonString() const
{
...
vector<CmqTopic> DescribeCmqTopicsResponse::GetTopicList() const
{
    return m_topicList;
}

bool DescribeCmqTopicsResponse::TopicListHasBeenSet() const
{
    return m_topicListHasBeenSet;
}

uint64_t DescribeCmqTopicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCmqTopicsResponse::TotalCountHasBeenSet() const
{
