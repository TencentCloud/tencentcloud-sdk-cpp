...
CoreInternalOutcome ResetMsgSubOffsetByTimestampResponse::Deserialize(const string &payload)
{
...
string ResetMsgSubOffsetByTimestampResponse::ToJsonString() const
{
...
bool ResetMsgSubOffsetByTimestampResponse::GetResult() const
{
    return m_result;
}

bool ResetMsgSubOffsetByTimestampResponse::ResultHasBeenSet() const
{
