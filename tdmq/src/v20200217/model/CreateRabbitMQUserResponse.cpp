...
CoreInternalOutcome CreateRabbitMQUserResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQUserResponse::ToJsonString() const
{
...
string CreateRabbitMQUserResponse::GetUser() const
{
    return m_user;
}

bool CreateRabbitMQUserResponse::UserHasBeenSet() const
{
