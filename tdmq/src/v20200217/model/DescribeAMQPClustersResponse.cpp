...
CoreInternalOutcome DescribeAMQPClustersResponse::Deserialize(const string &payload)
{
...
string DescribeAMQPClustersResponse::ToJsonString() const
{
...
vector<AMQPClusterDetail> DescribeAMQPClustersResponse::GetClusterList() const
{
    return m_clusterList;
}

bool DescribeAMQPClustersResponse::ClusterListHasBeenSet() const
{
    return m_clusterListHasBeenSet;
}

uint64_t DescribeAMQPClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAMQPClustersResponse::TotalCountHasBeenSet() const
{
