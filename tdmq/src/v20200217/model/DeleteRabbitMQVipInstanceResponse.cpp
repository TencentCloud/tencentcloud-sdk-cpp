...
CoreInternalOutcome DeleteRabbitMQVipInstanceResponse::Deserialize(const string &payload)
{
...
string DeleteRabbitMQVipInstanceResponse::ToJsonString() const
{
...
string DeleteRabbitMQVipInstanceResponse::GetTranId() const
{
    return m_tranId;
}

bool DeleteRabbitMQVipInstanceResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

string DeleteRabbitMQVipInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DeleteRabbitMQVipInstanceResponse::InstanceIdHasBeenSet() const
{
