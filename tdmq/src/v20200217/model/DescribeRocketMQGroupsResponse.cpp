...
CoreInternalOutcome DescribeRocketMQGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQGroupsResponse::ToJsonString() const
{
...
uint64_t DescribeRocketMQGroupsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRocketMQGroupsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RocketMQGroup> DescribeRocketMQGroupsResponse::GetGroups() const
{
    return m_groups;
}

bool DescribeRocketMQGroupsResponse::GroupsHasBeenSet() const
{
