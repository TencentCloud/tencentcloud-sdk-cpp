...
CoreInternalOutcome CreateRocketMQRoleResponse::Deserialize(const string &payload)
{
...
string CreateRocketMQRoleResponse::ToJsonString() const
{
...
string CreateRocketMQRoleResponse::GetRoleName() const
{
    return m_roleName;
}

bool CreateRocketMQRoleResponse::RoleNameHasBeenSet() const
{
    return m_roleNameHasBeenSet;
}

string CreateRocketMQRoleResponse::GetToken() const
{
    return m_token;
}

bool CreateRocketMQRoleResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string CreateRocketMQRoleResponse::GetRemark() const
{
    return m_remark;
}

bool CreateRocketMQRoleResponse::RemarkHasBeenSet() const
{
