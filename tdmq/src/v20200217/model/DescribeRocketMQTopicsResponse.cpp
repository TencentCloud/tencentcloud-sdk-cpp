...
CoreInternalOutcome DescribeRocketMQTopicsResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQTopicsResponse::ToJsonString() const
{
...
uint64_t DescribeRocketMQTopicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRocketMQTopicsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RocketMQTopic> DescribeRocketMQTopicsResponse::GetTopics() const
{
    return m_topics;
}

bool DescribeRocketMQTopicsResponse::TopicsHasBeenSet() const
{
