...
CoreInternalOutcome SendCmqMsgResponse::Deserialize(const string &payload)
{
...
string SendCmqMsgResponse::ToJsonString() const
{
...
bool SendCmqMsgResponse::GetResult() const
{
    return m_result;
}

bool SendCmqMsgResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string SendCmqMsgResponse::GetMsgId() const
{
    return m_msgId;
}

bool SendCmqMsgResponse::MsgIdHasBeenSet() const
{
