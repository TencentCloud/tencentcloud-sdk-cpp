...
CoreInternalOutcome AcknowledgeMessageResponse::Deserialize(const string &payload)
{
...
string AcknowledgeMessageResponse::ToJsonString() const
{
...
string AcknowledgeMessageResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool AcknowledgeMessageResponse::ErrorMsgHasBeenSet() const
{
