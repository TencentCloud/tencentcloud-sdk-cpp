...
CoreInternalOutcome CreateRocketMQClusterResponse::Deserialize(const string &payload)
{
...
string CreateRocketMQClusterResponse::ToJsonString() const
{
...
string CreateRocketMQClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateRocketMQClusterResponse::ClusterIdHasBeenSet() const
{
