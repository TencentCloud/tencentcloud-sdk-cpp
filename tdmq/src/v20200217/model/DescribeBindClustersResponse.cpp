...
CoreInternalOutcome DescribeBindClustersResponse::Deserialize(const string &payload)
{
...
string DescribeBindClustersResponse::ToJsonString() const
{
...
int64_t DescribeBindClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBindClustersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<BindCluster> DescribeBindClustersResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeBindClustersResponse::ClusterSetHasBeenSet() const
{
