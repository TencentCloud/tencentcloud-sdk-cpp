...
CoreInternalOutcome CreateCmqTopicResponse::Deserialize(const string &payload)
{
...
string CreateCmqTopicResponse::ToJsonString() const
{
...
string CreateCmqTopicResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateCmqTopicResponse::TopicIdHasBeenSet() const
{
