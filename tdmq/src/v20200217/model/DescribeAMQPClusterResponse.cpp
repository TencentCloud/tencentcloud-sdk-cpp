...
CoreInternalOutcome DescribeAMQPClusterResponse::Deserialize(const string &payload)
{
...
string DescribeAMQPClusterResponse::ToJsonString() const
{
...
AMQPClusterInfo DescribeAMQPClusterResponse::GetClusterInfo() const
{
    return m_clusterInfo;
}

bool DescribeAMQPClusterResponse::ClusterInfoHasBeenSet() const
{
    return m_clusterInfoHasBeenSet;
}

AMQPClusterConfig DescribeAMQPClusterResponse::GetClusterConfig() const
{
    return m_clusterConfig;
}

bool DescribeAMQPClusterResponse::ClusterConfigHasBeenSet() const
{
    return m_clusterConfigHasBeenSet;
}

AMQPClusterRecentStats DescribeAMQPClusterResponse::GetClusterStats() const
{
    return m_clusterStats;
}

bool DescribeAMQPClusterResponse::ClusterStatsHasBeenSet() const
{
