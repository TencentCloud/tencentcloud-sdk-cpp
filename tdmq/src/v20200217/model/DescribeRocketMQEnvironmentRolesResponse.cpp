...
CoreInternalOutcome DescribeRocketMQEnvironmentRolesResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQEnvironmentRolesResponse::ToJsonString() const
{
...
int64_t DescribeRocketMQEnvironmentRolesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRocketMQEnvironmentRolesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EnvironmentRole> DescribeRocketMQEnvironmentRolesResponse::GetEnvironmentRoleSets() const
{
    return m_environmentRoleSets;
}

bool DescribeRocketMQEnvironmentRolesResponse::EnvironmentRoleSetsHasBeenSet() const
{
