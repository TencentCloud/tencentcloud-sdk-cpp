...
CoreInternalOutcome DescribeRocketMQPublicAccessMonitorDataResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQPublicAccessMonitorDataResponse::ToJsonString() const
{
...
string DescribeRocketMQPublicAccessMonitorDataResponse::GetMetricName() const
{
    return m_metricName;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::MetricNameHasBeenSet() const
{
    return m_metricNameHasBeenSet;
}

int64_t DescribeRocketMQPublicAccessMonitorDataResponse::GetPeriod() const
{
    return m_period;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::PeriodHasBeenSet() const
{
    return m_periodHasBeenSet;
}

string DescribeRocketMQPublicAccessMonitorDataResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeRocketMQPublicAccessMonitorDataResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

vector<RocketMQDataPoint> DescribeRocketMQPublicAccessMonitorDataResponse::GetDataPoints() const
{
    return m_dataPoints;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::DataPointsHasBeenSet() const
{
    return m_dataPointsHasBeenSet;
}

string DescribeRocketMQPublicAccessMonitorDataResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeRocketMQPublicAccessMonitorDataResponse::MsgHasBeenSet() const
{
