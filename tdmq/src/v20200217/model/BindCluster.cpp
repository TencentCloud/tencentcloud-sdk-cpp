...
CoreInternalOutcome BindCluster::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void BindCluster::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
