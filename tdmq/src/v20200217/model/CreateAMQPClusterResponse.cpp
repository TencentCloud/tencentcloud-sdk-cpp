...
CoreInternalOutcome CreateAMQPClusterResponse::Deserialize(const string &payload)
{
...
string CreateAMQPClusterResponse::ToJsonString() const
{
...
string CreateAMQPClusterResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateAMQPClusterResponse::ClusterIdHasBeenSet() const
{
