...
CoreInternalOutcome DescribeRabbitMQVirtualHostResponse::Deserialize(const string &payload)
{
...
string DescribeRabbitMQVirtualHostResponse::ToJsonString() const
{
...
int64_t DescribeRabbitMQVirtualHostResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRabbitMQVirtualHostResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RabbitMQVirtualHostInfo> DescribeRabbitMQVirtualHostResponse::GetVirtualHostList() const
{
    return m_virtualHostList;
}

bool DescribeRabbitMQVirtualHostResponse::VirtualHostListHasBeenSet() const
{
