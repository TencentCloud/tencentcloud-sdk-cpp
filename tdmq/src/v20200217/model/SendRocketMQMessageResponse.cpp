...
CoreInternalOutcome SendRocketMQMessageResponse::Deserialize(const string &payload)
{
...
string SendRocketMQMessageResponse::ToJsonString() const
{
...
bool SendRocketMQMessageResponse::GetResult() const
{
    return m_result;
}

bool SendRocketMQMessageResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string SendRocketMQMessageResponse::GetMsgId() const
{
    return m_msgId;
}

bool SendRocketMQMessageResponse::MsgIdHasBeenSet() const
{
