...
CoreInternalOutcome DescribePulsarProInstancesResponse::Deserialize(const string &payload)
{
...
string DescribePulsarProInstancesResponse::ToJsonString() const
{
...
uint64_t DescribePulsarProInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePulsarProInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<PulsarProInstance> DescribePulsarProInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribePulsarProInstancesResponse::InstancesHasBeenSet() const
{
