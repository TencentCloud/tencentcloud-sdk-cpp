...
CoreInternalOutcome DescribeMqMsgTraceResponse::Deserialize(const string &payload)
{
...
string DescribeMqMsgTraceResponse::ToJsonString() const
{
...
vector<TraceResult> DescribeMqMsgTraceResponse::GetResult() const
{
    return m_result;
}

bool DescribeMqMsgTraceResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string DescribeMqMsgTraceResponse::GetShowTopicName() const
{
    return m_showTopicName;
}

bool DescribeMqMsgTraceResponse::ShowTopicNameHasBeenSet() const
{
