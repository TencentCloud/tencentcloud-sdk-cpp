...
CoreInternalOutcome SendBatchMessagesResponse::Deserialize(const string &payload)
{
...
string SendBatchMessagesResponse::ToJsonString() const
{
...
string SendBatchMessagesResponse::GetMessageId() const
{
    return m_messageId;
}

bool SendBatchMessagesResponse::MessageIdHasBeenSet() const
{
    return m_messageIdHasBeenSet;
}

string SendBatchMessagesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool SendBatchMessagesResponse::ErrorMsgHasBeenSet() const
{
