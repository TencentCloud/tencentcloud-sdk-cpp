...
CoreInternalOutcome ModifyRoleResponse::Deserialize(const string &payload)
{
...
string ModifyRoleResponse::ToJsonString() const
{
...
string ModifyRoleResponse::GetRoleName() const
{
    return m_roleName;
}

bool ModifyRoleResponse::RoleNameHasBeenSet() const
{
    return m_roleNameHasBeenSet;
}

string ModifyRoleResponse::GetRemark() const
{
    return m_remark;
}

bool ModifyRoleResponse::RemarkHasBeenSet() const
{
