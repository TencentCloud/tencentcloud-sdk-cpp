...
CoreInternalOutcome DeleteRabbitMQBindingResponse::Deserialize(const string &payload)
{
...
string DeleteRabbitMQBindingResponse::ToJsonString() const
{
...
string DeleteRabbitMQBindingResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DeleteRabbitMQBindingResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string DeleteRabbitMQBindingResponse::GetVirtualHost() const
{
    return m_virtualHost;
}

bool DeleteRabbitMQBindingResponse::VirtualHostHasBeenSet() const
{
    return m_virtualHostHasBeenSet;
}

int64_t DeleteRabbitMQBindingResponse::GetBindingId() const
{
    return m_bindingId;
}

bool DeleteRabbitMQBindingResponse::BindingIdHasBeenSet() const
{
