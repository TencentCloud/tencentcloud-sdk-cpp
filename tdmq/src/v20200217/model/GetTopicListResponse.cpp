...
GetTopicListResponse::GetTopicListResponse() :
    m_totalCountHasBeenSet(false),
    m_topicListHasBeenSet(false)
{
}

CoreInternalOutcome GetTopicListResponse::Deserialize(const string &payload)
{
...
string GetTopicListResponse::ToJsonString() const
{
...
uint64_t GetTopicListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool GetTopicListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Topic_Simplification> GetTopicListResponse::GetTopicList() const
{
    return m_topicList;
}

bool GetTopicListResponse::TopicListHasBeenSet() const
{
