...
CoreInternalOutcome ModifyRocketMQInstanceSpecResponse::Deserialize(const string &payload)
{
...
string ModifyRocketMQInstanceSpecResponse::ToJsonString() const
{
...
string ModifyRocketMQInstanceSpecResponse::GetOrderId() const
{
    return m_orderId;
}

bool ModifyRocketMQInstanceSpecResponse::OrderIdHasBeenSet() const
{
