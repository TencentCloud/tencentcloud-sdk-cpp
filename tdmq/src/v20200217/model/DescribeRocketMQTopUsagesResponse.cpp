...
CoreInternalOutcome DescribeRocketMQTopUsagesResponse::Deserialize(const string &payload)
{
...
string DescribeRocketMQTopUsagesResponse::ToJsonString() const
{
...
vector<int64_t> DescribeRocketMQTopUsagesResponse::GetValues() const
{
    return m_values;
}

bool DescribeRocketMQTopUsagesResponse::ValuesHasBeenSet() const
{
    return m_valuesHasBeenSet;
}

vector<DimensionInstance> DescribeRocketMQTopUsagesResponse::GetDimensions() const
{
    return m_dimensions;
}

bool DescribeRocketMQTopUsagesResponse::DimensionsHasBeenSet() const
{
