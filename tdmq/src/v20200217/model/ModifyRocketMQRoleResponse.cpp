...
CoreInternalOutcome ModifyRocketMQRoleResponse::Deserialize(const string &payload)
{
...
string ModifyRocketMQRoleResponse::ToJsonString() const
{
...
string ModifyRocketMQRoleResponse::GetRoleName() const
{
    return m_roleName;
}

bool ModifyRocketMQRoleResponse::RoleNameHasBeenSet() const
{
    return m_roleNameHasBeenSet;
}

string ModifyRocketMQRoleResponse::GetRemark() const
{
    return m_remark;
}

bool ModifyRocketMQRoleResponse::RemarkHasBeenSet() const
{
