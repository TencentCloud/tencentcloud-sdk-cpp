...
string DescribeEnvironmentAttributesRequest::ToJsonString() const
{
...
string DescribeEnvironmentAttributesRequest::GetEnvironmentId() const
{
    return m_environmentId;
}

void DescribeEnvironmentAttributesRequest::SetEnvironmentId(const string& _environmentId)
{
