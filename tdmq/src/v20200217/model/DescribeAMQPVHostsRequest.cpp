...
string DescribeAMQPVHostsRequest::ToJsonString() const
{
...
string DescribeAMQPVHostsRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeAMQPVHostsRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool DescribeAMQPVHostsRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

uint64_t DescribeAMQPVHostsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAMQPVHostsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeAMQPVHostsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeAMQPVHostsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeAMQPVHostsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeAMQPVHostsRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

string DescribeAMQPVHostsRequest::GetNameKeyword() const
{
    return m_nameKeyword;
}

void DescribeAMQPVHostsRequest::SetNameKeyword(const string& _nameKeyword)
{
