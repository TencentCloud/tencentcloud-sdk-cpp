...
CoreInternalOutcome SendMessagesResponse::Deserialize(const string &payload)
{
...
string SendMessagesResponse::ToJsonString() const
{
...
string SendMessagesResponse::GetMessageId() const
{
    return m_messageId;
}

bool SendMessagesResponse::MessageIdHasBeenSet() const
{
    return m_messageIdHasBeenSet;
}

string SendMessagesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool SendMessagesResponse::ErrorMsgHasBeenSet() const
{
