...
CoreInternalOutcome CreateRabbitMQVipInstanceResponse::Deserialize(const string &payload)
{
...
string CreateRabbitMQVipInstanceResponse::ToJsonString() const
{
...
string CreateRabbitMQVipInstanceResponse::GetTranId() const
{
    return m_tranId;
}

bool CreateRabbitMQVipInstanceResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

string CreateRabbitMQVipInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateRabbitMQVipInstanceResponse::InstanceIdHasBeenSet() const
{
