...
string CreateRoleResponse::GetRoleName() const
{
    return m_roleName;
}

bool CreateRoleResponse::RoleNameHasBeenSet() const
{
    return m_roleNameHasBeenSet;
}

string CreateRoleResponse::GetToken() const
{
    return m_token;
}

bool CreateRoleResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string CreateRoleResponse::GetRemark() const
{
    return m_remark;
}
