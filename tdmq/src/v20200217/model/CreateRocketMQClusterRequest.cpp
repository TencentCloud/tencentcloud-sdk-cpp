...
string CreateRocketMQClusterRequest::ToJsonString() const
{
...
string CreateRocketMQClusterRequest::GetName() const
{
    return m_name;
}

void CreateRocketMQClusterRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool CreateRocketMQClusterRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateRocketMQClusterRequest::GetRemark() const
{
    return m_remark;
}

void CreateRocketMQClusterRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
