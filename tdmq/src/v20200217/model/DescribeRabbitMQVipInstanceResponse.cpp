...
CoreInternalOutcome DescribeRabbitMQVipInstanceResponse::Deserialize(const string &payload)
{
...
string DescribeRabbitMQVipInstanceResponse::ToJsonString() const
{
...
RabbitMQClusterInfo DescribeRabbitMQVipInstanceResponse::GetClusterInfo() const
{
    return m_clusterInfo;
}

bool DescribeRabbitMQVipInstanceResponse::ClusterInfoHasBeenSet() const
{
    return m_clusterInfoHasBeenSet;
}

RabbitMQClusterSpecInfo DescribeRabbitMQVipInstanceResponse::GetClusterSpecInfo() const
{
    return m_clusterSpecInfo;
}

bool DescribeRabbitMQVipInstanceResponse::ClusterSpecInfoHasBeenSet() const
{
    return m_clusterSpecInfoHasBeenSet;
}

RabbitMQClusterAccessInfo DescribeRabbitMQVipInstanceResponse::GetClusterNetInfo() const
{
    return m_clusterNetInfo;
}

bool DescribeRabbitMQVipInstanceResponse::ClusterNetInfoHasBeenSet() const
{
    return m_clusterNetInfoHasBeenSet;
}

RabbitMQClusterWhiteListInfo DescribeRabbitMQVipInstanceResponse::GetClusterWhiteListInfo() const
{
    return m_clusterWhiteListInfo;
}

bool DescribeRabbitMQVipInstanceResponse::ClusterWhiteListInfoHasBeenSet() const
{
    return m_clusterWhiteListInfoHasBeenSet;
}

VirtualHostQuota DescribeRabbitMQVipInstanceResponse::GetVirtualHostQuota() const
{
    return m_virtualHostQuota;
}

bool DescribeRabbitMQVipInstanceResponse::VirtualHostQuotaHasBeenSet() const
{
    return m_virtualHostQuotaHasBeenSet;
}

ExchangeQuota DescribeRabbitMQVipInstanceResponse::GetExchangeQuota() const
{
    return m_exchangeQuota;
}

bool DescribeRabbitMQVipInstanceResponse::ExchangeQuotaHasBeenSet() const
{
    return m_exchangeQuotaHasBeenSet;
}

QueueQuota DescribeRabbitMQVipInstanceResponse::GetQueueQuota() const
{
    return m_queueQuota;
}
