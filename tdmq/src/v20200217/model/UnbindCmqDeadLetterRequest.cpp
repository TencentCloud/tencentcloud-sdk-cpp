...
string UnbindCmqDeadLetterRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_sourceQueueNameHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_sourceQueueName.c_str(), allocator).Move(), allocator);
    }
...
string UnbindCmqDeadLetterRequest::GetSourceQueueName() const
{
    return m_sourceQueueName;
}

void UnbindCmqDeadLetterRequest::SetSourceQueueName(const string& _sourceQueueName)
{
    m_sourceQueueName = _sourceQueueName;
    m_sourceQueueNameHasBeenSet = true;
}

bool UnbindCmqDeadLetterRequest::SourceQueueNameHasBeenSet() const
{
