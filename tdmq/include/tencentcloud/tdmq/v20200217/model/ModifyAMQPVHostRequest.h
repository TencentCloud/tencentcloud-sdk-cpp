...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_MODIFYAMQPVHOSTREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_MODIFYAMQPVHOSTREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class ModifyAMQPVHostRequest : public AbstractModel
                {
                public:
                    ModifyAMQPVHostRequest();
                    ~ModifyAMQPVHostRequest() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_MODIFYAMQPVHOSTREQUEST_H_
