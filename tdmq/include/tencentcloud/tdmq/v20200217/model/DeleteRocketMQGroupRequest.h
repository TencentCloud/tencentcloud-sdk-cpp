...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEROCKETMQGROUPREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEROCKETMQGROUPREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class DeleteRocketMQGroupRequest : public AbstractModel
                {
                public:
                    DeleteRocketMQGroupRequest();
                    ~DeleteRocketMQGroupRequest() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEROCKETMQGROUPREQUEST_H_
