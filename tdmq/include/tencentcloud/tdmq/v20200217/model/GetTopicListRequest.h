...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_GETTOPICLISTREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_GETTOPICLISTREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                * GetTopicList请求参数结构体
                */
                class GetTopicListRequest : public AbstractModel
                {
                public:
                    GetTopicListRequest();
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_GETTOPICLISTREQUEST_H_
