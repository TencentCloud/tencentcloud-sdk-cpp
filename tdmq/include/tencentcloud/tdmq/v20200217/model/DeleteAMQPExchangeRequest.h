...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEAMQPEXCHANGEREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEAMQPEXCHANGEREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class DeleteAMQPExchangeRequest : public AbstractModel
                {
                public:
                    DeleteAMQPExchangeRequest();
                    ~DeleteAMQPExchangeRequest() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETEAMQPEXCHANGEREQUEST_H_
