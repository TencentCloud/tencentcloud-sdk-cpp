...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBEENVIRONMENTROLESRESPONSE_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBEENVIRONMENTROLESRESPONSE_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class DescribeEnvironmentRolesResponse : public AbstractModel
                {
                public:
                    DescribeEnvironmentRolesResponse();
                    ~DescribeEnvironmentRolesResponse() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBEENVIRONMENTROLESRESPONSE_H_
