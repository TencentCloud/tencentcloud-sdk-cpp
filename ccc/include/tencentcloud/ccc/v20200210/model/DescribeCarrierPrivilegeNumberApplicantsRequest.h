...
#ifndef TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBECARRIERPRIVILEGENUMBERAPPLICANTSREQUEST_H_
#define TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBECARRIERPRIVILEGENUMBERAPPLICANTSREQUEST_H_
    ...
    namespace Ccc
    {
        namespace V20200210
        {
            namespace Model
            {
                ...
                */
                class DescribeCarrierPrivilegeNumberApplicantsRequest : public AbstractModel
                {
                public:
                    DescribeCarrierPrivilegeNumberApplicantsRequest();
                    ~DescribeCarrierPrivilegeNumberApplicantsRequest() = default;
...
#endif // !TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBECARRIERPRIVILEGENUMBERAPPLICANTSREQUEST_H_
