...
CoreInternalOutcome AbortPredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string AbortPredictiveDialingCampaignResponse::ToJsonString() const
{
