...
string DescribeCCCBuyInfoListRequest::ToJsonString() const
{
...
vector<int64_t> DescribeCCCBuyInfoListRequest::GetSdkAppIds() const
{
    return m_sdkAppIds;
}

void DescribeCCCBuyInfoListRequest::SetSdkAppIds(const vector<int64_t>& _sdkAppIds)
{
    m_sdkAppIds = _sdkAppIds;
    m_sdkAppIdsHasBeenSet = true;
}

bool DescribeCCCBuyInfoListRequest::SdkAppIdsHasBeenSet() const
{
