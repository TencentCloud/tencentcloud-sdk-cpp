...
CoreInternalOutcome ResumePredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string ResumePredictiveDialingCampaignResponse::ToJsonString() const
{
