...
CoreInternalOutcome CreateCallOutSessionResponse::Deserialize(const string &payload)
{
...
string CreateCallOutSessionResponse::ToJsonString() const
{
...
string CreateCallOutSessionResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateCallOutSessionResponse::SessionIdHasBeenSet() const
{
