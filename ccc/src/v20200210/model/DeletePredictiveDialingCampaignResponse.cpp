...
CoreInternalOutcome DeletePredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string DeletePredictiveDialingCampaignResponse::ToJsonString() const
{
