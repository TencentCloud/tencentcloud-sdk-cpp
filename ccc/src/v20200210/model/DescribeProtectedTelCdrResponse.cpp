...
CoreInternalOutcome DescribeProtectedTelCdrResponse::Deserialize(const string &payload)
{
...
string DescribeProtectedTelCdrResponse::ToJsonString() const
{
...
uint64_t DescribeProtectedTelCdrResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeProtectedTelCdrResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TelCdrInfo> DescribeProtectedTelCdrResponse::GetTelCdrs() const
{
    return m_telCdrs;
}
