...
CoreInternalOutcome ResetExtensionPasswordResponse::Deserialize(const string &payload)
{
...
string ResetExtensionPasswordResponse::ToJsonString() const
{
...
string ResetExtensionPasswordResponse::GetPassword() const
{
    return m_password;
}

bool ResetExtensionPasswordResponse::PasswordHasBeenSet() const
{
