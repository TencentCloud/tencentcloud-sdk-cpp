...
CoreInternalOutcome CreatePredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string CreatePredictiveDialingCampaignResponse::ToJsonString() const
{
...
int64_t CreatePredictiveDialingCampaignResponse::GetCampaignId() const
{
    return m_campaignId;
}

bool CreatePredictiveDialingCampaignResponse::CampaignIdHasBeenSet() const
{
