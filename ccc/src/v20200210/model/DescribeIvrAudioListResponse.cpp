...
CoreInternalOutcome DescribeIvrAudioListResponse::Deserialize(const string &payload)
{
...
string DescribeIvrAudioListResponse::ToJsonString() const
{
...
int64_t DescribeIvrAudioListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeIvrAudioListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AudioFileInfo> DescribeIvrAudioListResponse::GetFileInfo() const
{
    return m_fileInfo;
}

bool DescribeIvrAudioListResponse::FileInfoHasBeenSet() const
{
