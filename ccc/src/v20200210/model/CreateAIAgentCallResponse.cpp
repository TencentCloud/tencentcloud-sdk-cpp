...
CoreInternalOutcome CreateAIAgentCallResponse::Deserialize(const string &payload)
{
...
string CreateAIAgentCallResponse::ToJsonString() const
{
...
string CreateAIAgentCallResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateAIAgentCallResponse::SessionIdHasBeenSet() const
{
