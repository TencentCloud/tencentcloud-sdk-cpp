...
DescribeIMCdrListResponse::DescribeIMCdrListResponse() :
    m_totalCountHasBeenSet(false),
    m_iMCdrListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeIMCdrListResponse::Deserialize(const string &payload)
{
...
string DescribeIMCdrListResponse::ToJsonString() const
{
...
int64_t DescribeIMCdrListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeIMCdrListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<IMCdrInfo> DescribeIMCdrListResponse::GetIMCdrList() const
{
    return m_iMCdrList;
}

bool DescribeIMCdrListResponse::IMCdrListHasBeenSet() const
{
