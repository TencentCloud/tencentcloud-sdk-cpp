...
CoreInternalOutcome CreateAICallResponse::Deserialize(const string &payload)
{
...
string CreateAICallResponse::ToJsonString() const
{
...
string CreateAICallResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateAICallResponse::SessionIdHasBeenSet() const
{
