...
CoreInternalOutcome AbortAgentCruiseDialingCampaignResponse::Deserialize(const string &payload)
{
...
string AbortAgentCruiseDialingCampaignResponse::ToJsonString() const
{
