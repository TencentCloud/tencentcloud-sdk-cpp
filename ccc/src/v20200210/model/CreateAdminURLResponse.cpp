...
CoreInternalOutcome CreateAdminURLResponse::Deserialize(const string &payload)
{
...
string CreateAdminURLResponse::ToJsonString() const
{
...
string CreateAdminURLResponse::GetURL() const
{
    return m_uRL;
}

bool CreateAdminURLResponse::URLHasBeenSet() const
{
