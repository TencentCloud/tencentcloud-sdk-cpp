...
CoreInternalOutcome CreateAutoCalloutTaskResponse::Deserialize(const string &payload)
{
...
string CreateAutoCalloutTaskResponse::ToJsonString() const
{
...
uint64_t CreateAutoCalloutTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateAutoCalloutTaskResponse::TaskIdHasBeenSet() const
{
