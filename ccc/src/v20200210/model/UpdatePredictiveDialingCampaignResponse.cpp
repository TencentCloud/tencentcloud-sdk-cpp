...
CoreInternalOutcome UpdatePredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string UpdatePredictiveDialingCampaignResponse::ToJsonString() const
{
