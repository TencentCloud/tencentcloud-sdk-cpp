...
CoreInternalOutcome CreateIVRSessionResponse::Deserialize(const string &payload)
{
...
string CreateIVRSessionResponse::ToJsonString() const
{
...
string CreateIVRSessionResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateIVRSessionResponse::SessionIdHasBeenSet() const
{
