...
CoreInternalOutcome CreateAgentCruiseDialingCampaignResponse::Deserialize(const string &payload)
{
...
string CreateAgentCruiseDialingCampaignResponse::ToJsonString() const
{
...
int64_t CreateAgentCruiseDialingCampaignResponse::GetCampaignId() const
{
    return m_campaignId;
}

bool CreateAgentCruiseDialingCampaignResponse::CampaignIdHasBeenSet() const
{
