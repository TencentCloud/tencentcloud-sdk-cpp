...
CoreInternalOutcome CreateCCCSkillGroupResponse::Deserialize(const string &payload)
{
...
string CreateCCCSkillGroupResponse::ToJsonString() const
{
...
int64_t CreateCCCSkillGroupResponse::GetSkillGroupId() const
{
    return m_skillGroupId;
}

bool CreateCCCSkillGroupResponse::SkillGroupIdHasBeenSet() const
{
