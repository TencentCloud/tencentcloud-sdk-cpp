...
CoreInternalOutcome PausePredictiveDialingCampaignResponse::Deserialize(const string &payload)
{
...
string PausePredictiveDialingCampaignResponse::ToJsonString() const
{
