...
string DescribeZonesRequest::GetStorageType() const
{
    return m_storageType;
}

void DescribeZonesRequest::SetStorageType(const string& _storageType)
{
    m_storageType = _storageType;
    m_storageTypeHasBeenSet = true;
}

bool DescribeZonesRequest::StorageTypeHasBeenSet() const
{
