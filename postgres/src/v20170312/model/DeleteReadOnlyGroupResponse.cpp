...
CoreInternalOutcome DeleteReadOnlyGroupResponse::Deserialize(const string &payload)
{
...
string DeleteReadOnlyGroupResponse::ToJsonString() const
{
...
int64_t DeleteReadOnlyGroupResponse::GetFlowId() const
{
    return m_flowId;
}

bool DeleteReadOnlyGroupResponse::FlowIdHasBeenSet() const
{
