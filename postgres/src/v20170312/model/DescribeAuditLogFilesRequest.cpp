...
string DescribeAuditLogFilesRequest::GetProduct() const
{
    return m_product;
}

void DescribeAuditLogFilesRequest::SetProduct(const string& _product)
{
    m_product = _product;
    m_productHasBeenSet = true;
}

bool DescribeAuditLogFilesRequest::ProductHasBeenSet() const
{
...
uint64_t DescribeAuditLogFilesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeAuditLogFilesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
uint64_t DescribeAuditLogFilesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAuditLogFilesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
