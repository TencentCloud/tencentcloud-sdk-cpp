...
CoreInternalOutcome InquiryPriceUpgradeDBInstanceResponse::Deserialize(const string &payload)
{
...
string InquiryPriceUpgradeDBInstanceResponse::ToJsonString() const
{
...
int64_t InquiryPriceUpgradeDBInstanceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquiryPriceUpgradeDBInstanceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

int64_t InquiryPriceUpgradeDBInstanceResponse::GetPrice() const
{
    return m_price;
}

bool InquiryPriceUpgradeDBInstanceResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

string InquiryPriceUpgradeDBInstanceResponse::GetCurrency() const
{
    return m_currency;
}

bool InquiryPriceUpgradeDBInstanceResponse::CurrencyHasBeenSet() const
{
