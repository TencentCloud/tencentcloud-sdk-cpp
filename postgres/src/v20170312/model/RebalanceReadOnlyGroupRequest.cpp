...
string RebalanceReadOnlyGroupRequest::ToJsonString() const
{
...
string RebalanceReadOnlyGroupRequest::GetReadOnlyGroupId() const
{
    return m_readOnlyGroupId;
}

void RebalanceReadOnlyGroupRequest::SetReadOnlyGroupId(const string& _readOnlyGroupId)
{
    m_readOnlyGroupId = _readOnlyGroupId;
    m_readOnlyGroupIdHasBeenSet = true;
}

bool RebalanceReadOnlyGroupRequest::ReadOnlyGroupIdHasBeenSet() const
{
