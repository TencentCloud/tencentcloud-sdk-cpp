...
string RenewInstanceRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void RenewInstanceRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool RenewInstanceRequest::DBInstanceIdHasBeenSet() const
{
...
int64_t RenewInstanceRequest::GetAutoVoucher() const
{
    return m_autoVoucher;
}

void RenewInstanceRequest::SetAutoVoucher(const int64_t& _autoVoucher)
{
    m_autoVoucher = _autoVoucher;
    m_autoVoucherHasBeenSet = true;
}

bool RenewInstanceRequest::AutoVoucherHasBeenSet() const
{
    return m_autoVoucherHasBeenSet;
}

vector<string> RenewInstanceRequest::GetVoucherIds() const
{
    return m_voucherIds;
}

void RenewInstanceRequest::SetVoucherIds(const vector<string>& _voucherIds)
{
    m_voucherIds = _voucherIds;
    m_voucherIdsHasBeenSet = true;
}

bool RenewInstanceRequest::VoucherIdsHasBeenSet() const
{
