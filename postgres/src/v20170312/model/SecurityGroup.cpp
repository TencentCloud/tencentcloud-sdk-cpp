...
SecurityGroup::SecurityGroup() :
    ...
    m_securityGroupDescriptionHasBeenSet(false)
{
}
...
CoreInternalOutcome SecurityGroup::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("SecurityGroupDescription") && !value["SecurityGroupDescription"].IsNull())
    {
        if (!value["SecurityGroupDescription"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `SecurityGroup.SecurityGroupDescription` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_securityGroupDescription = string(value["SecurityGroupDescription"].GetString());
        m_securityGroupDescriptionHasBeenSet = true;
    }
...
void SecurityGroup::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_securityGroupDescriptionHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "SecurityGroupDescription";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_securityGroupDescription.c_str(), allocator).Move(), allocator);
    }
...
vector<PolicyRule> SecurityGroup::GetInbound() const
{
    return m_inbound;
}

void SecurityGroup::SetInbound(const vector<PolicyRule>& _inbound)
{
    m_inbound = _inbound;
    m_inboundHasBeenSet = true;
}
...
vector<PolicyRule> SecurityGroup::GetOutbound() const
{
    return m_outbound;
}

void SecurityGroup::SetOutbound(const vector<PolicyRule>& _outbound)
{
...
string SecurityGroup::GetSecurityGroupDescription() const
{
    return m_securityGroupDescription;
}

void SecurityGroup::SetSecurityGroupDescription(const string& _securityGroupDescription)
{
    m_securityGroupDescription = _securityGroupDescription;
    m_securityGroupDescriptionHasBeenSet = true;
}

bool SecurityGroup::SecurityGroupDescriptionHasBeenSet() const
{
    return m_securityGroupDescriptionHasBeenSet;
}
