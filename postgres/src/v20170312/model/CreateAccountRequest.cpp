...
string CreateAccountRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void CreateAccountRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool CreateAccountRequest::DBInstanceIdHasBeenSet() const
{
...
void CreateAccountRequest::SetType(const string& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool CreateAccountRequest::TypeHasBeenSet() const
{
