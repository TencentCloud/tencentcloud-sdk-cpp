...
CoreInternalOutcome ModifyDBInstanceReadOnlyGroupResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceReadOnlyGroupResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceReadOnlyGroupResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDBInstanceReadOnlyGroupResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t ModifyDBInstanceReadOnlyGroupResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDBInstanceReadOnlyGroupResponse::TaskIdHasBeenSet() const
{
