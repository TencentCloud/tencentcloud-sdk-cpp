...
CoreInternalOutcome DeleteReadOnlyGroupNetworkAccessResponse::Deserialize(const string &payload)
{
...
string DeleteReadOnlyGroupNetworkAccessResponse::ToJsonString() const
{
...
int64_t DeleteReadOnlyGroupNetworkAccessResponse::GetFlowId() const
{
    return m_flowId;
}

bool DeleteReadOnlyGroupNetworkAccessResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t DeleteReadOnlyGroupNetworkAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteReadOnlyGroupNetworkAccessResponse::TaskIdHasBeenSet() const
{
