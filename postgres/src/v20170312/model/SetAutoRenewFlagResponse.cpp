...
CoreInternalOutcome SetAutoRenewFlagResponse::Deserialize(const string &payload)
{
...
string SetAutoRenewFlagResponse::ToJsonString() const
{
...
int64_t SetAutoRenewFlagResponse::GetCount() const
{
    return m_count;
}

bool SetAutoRenewFlagResponse::CountHasBeenSet() const
{
