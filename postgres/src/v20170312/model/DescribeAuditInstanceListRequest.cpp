...
uint64_t DescribeAuditInstanceListRequest::GetAuditSwitch() const
{
    return m_auditSwitch;
}

void DescribeAuditInstanceListRequest::SetAuditSwitch(const uint64_t& _auditSwitch)
{
...
vector<Filter> DescribeAuditInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeAuditInstanceListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
