...
string OpenServerlessDBExtranetAccessRequest::ToJsonString() const
{
...
string OpenServerlessDBExtranetAccessRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void OpenServerlessDBExtranetAccessRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool OpenServerlessDBExtranetAccessRequest::DBInstanceIdHasBeenSet() const
{
    return m_dBInstanceIdHasBeenSet;
}

string OpenServerlessDBExtranetAccessRequest::GetDBInstanceName() const
{
    return m_dBInstanceName;
}

void OpenServerlessDBExtranetAccessRequest::SetDBInstanceName(const string& _dBInstanceName)
{
    m_dBInstanceName = _dBInstanceName;
    m_dBInstanceNameHasBeenSet = true;
}

bool OpenServerlessDBExtranetAccessRequest::DBInstanceNameHasBeenSet() const
{
