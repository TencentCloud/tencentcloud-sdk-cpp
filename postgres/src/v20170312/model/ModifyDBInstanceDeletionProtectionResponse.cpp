...
CoreInternalOutcome ModifyDBInstanceDeletionProtectionResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceDeletionProtectionResponse::ToJsonString() const
{
