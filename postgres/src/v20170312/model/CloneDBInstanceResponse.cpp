...
CoreInternalOutcome CloneDBInstanceResponse::Deserialize(const string &payload)
{
...
string CloneDBInstanceResponse::ToJsonString() const
{
...
string CloneDBInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool CloneDBInstanceResponse::DealNameHasBeenSet() const
{
    return m_dealNameHasBeenSet;
}

string CloneDBInstanceResponse::GetBillId() const
{
    return m_billId;
}
