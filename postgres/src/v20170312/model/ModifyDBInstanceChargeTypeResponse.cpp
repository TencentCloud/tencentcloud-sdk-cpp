...
CoreInternalOutcome ModifyDBInstanceChargeTypeResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceChargeTypeResponse::ToJsonString() const
{
...
string ModifyDBInstanceChargeTypeResponse::GetDealName() const
{
    return m_dealName;
}

bool ModifyDBInstanceChargeTypeResponse::DealNameHasBeenSet() const
{
