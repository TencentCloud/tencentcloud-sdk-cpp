...
CoreInternalOutcome DescribeDBErrlogsResponse::Deserialize(const string &payload)
{
...
string DescribeDBErrlogsResponse::ToJsonString() const
{
...
int64_t DescribeDBErrlogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDBErrlogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ErrLogDetail> DescribeDBErrlogsResponse::GetDetails() const
{
    return m_details;
}

bool DescribeDBErrlogsResponse::DetailsHasBeenSet() const
{
