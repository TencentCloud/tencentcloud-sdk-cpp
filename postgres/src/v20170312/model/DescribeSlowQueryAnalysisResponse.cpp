...
CoreInternalOutcome DescribeSlowQueryAnalysisResponse::Deserialize(const string &payload)
{
...
string DescribeSlowQueryAnalysisResponse::ToJsonString() const
{
...
int64_t DescribeSlowQueryAnalysisResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSlowQueryAnalysisResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

Detail DescribeSlowQueryAnalysisResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeSlowQueryAnalysisResponse::DetailHasBeenSet() const
{
