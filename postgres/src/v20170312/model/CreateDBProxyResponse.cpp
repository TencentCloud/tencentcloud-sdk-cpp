...
CoreInternalOutcome CreateDBProxyResponse::Deserialize(const string &payload)
{
...
string CreateDBProxyResponse::ToJsonString() const
{
...
string CreateDBProxyResponse::GetDealName() const
{
    return m_dealName;
}

bool CreateDBProxyResponse::DealNameHasBeenSet() const
{
    return m_dealNameHasBeenSet;
}

string CreateDBProxyResponse::GetProxyGroupId() const
{
    return m_proxyGroupId;
}

bool CreateDBProxyResponse::ProxyGroupIdHasBeenSet() const
{
