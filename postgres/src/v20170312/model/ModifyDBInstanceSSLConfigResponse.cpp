...
CoreInternalOutcome ModifyDBInstanceSSLConfigResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceSSLConfigResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceSSLConfigResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDBInstanceSSLConfigResponse::TaskIdHasBeenSet() const
{
