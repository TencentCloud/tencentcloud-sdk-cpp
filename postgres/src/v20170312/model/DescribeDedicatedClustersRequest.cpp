...
vector<Filter> DescribeDedicatedClustersRequest::GetFilters() const
{
    return m_filters;
}

void DescribeDedicatedClustersRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeDedicatedClustersRequest::FiltersHasBeenSet() const
{
