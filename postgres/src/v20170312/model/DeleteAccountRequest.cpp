...
string DeleteAccountRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DeleteAccountRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DeleteAccountRequest::DBInstanceIdHasBeenSet() const
{
