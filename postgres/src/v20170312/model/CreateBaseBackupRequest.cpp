...
string CreateBaseBackupRequest::ToJsonString() const
{
...
string CreateBaseBackupRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void CreateBaseBackupRequest::SetDBInstanceId(const string& _dBInstanceId)
{
