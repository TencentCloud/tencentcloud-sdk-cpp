...
CoreInternalOutcome DeleteDBInstanceNetworkAccessResponse::Deserialize(const string &payload)
{
...
string DeleteDBInstanceNetworkAccessResponse::ToJsonString() const
{
...
int64_t DeleteDBInstanceNetworkAccessResponse::GetFlowId() const
{
    return m_flowId;
}

bool DeleteDBInstanceNetworkAccessResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t DeleteDBInstanceNetworkAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteDBInstanceNetworkAccessResponse::TaskIdHasBeenSet() const
{
