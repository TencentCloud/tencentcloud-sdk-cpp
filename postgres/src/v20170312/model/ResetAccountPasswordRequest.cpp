...
string ResetAccountPasswordRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void ResetAccountPasswordRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool ResetAccountPasswordRequest::DBInstanceIdHasBeenSet() const
{
