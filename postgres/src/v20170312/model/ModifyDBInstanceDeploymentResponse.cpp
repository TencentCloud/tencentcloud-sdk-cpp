...
CoreInternalOutcome ModifyDBInstanceDeploymentResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceDeploymentResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceDeploymentResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDBInstanceDeploymentResponse::TaskIdHasBeenSet() const
{
