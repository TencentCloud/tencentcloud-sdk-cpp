...
CoreInternalOutcome CreateDBInstanceNetworkAccessResponse::Deserialize(const string &payload)
{
...
string CreateDBInstanceNetworkAccessResponse::ToJsonString() const
{
...
int64_t CreateDBInstanceNetworkAccessResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateDBInstanceNetworkAccessResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CreateDBInstanceNetworkAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateDBInstanceNetworkAccessResponse::TaskIdHasBeenSet() const
{
