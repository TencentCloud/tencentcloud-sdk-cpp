...
DescribeDBProxySSLConfigResponse::DescribeDBProxySSLConfigResponse() :
...
CoreInternalOutcome DescribeDBProxySSLConfigResponse::Deserialize(const string &payload)
{
...
string DescribeDBProxySSLConfigResponse::ToJsonString() const
{
...
bool DescribeDBProxySSLConfigResponse::GetSSLEnabled() const
{
    return m_sSLEnabled;
}

bool DescribeDBProxySSLConfigResponse::SSLEnabledHasBeenSet() const
{
    return m_sSLEnabledHasBeenSet;
}

string DescribeDBProxySSLConfigResponse::GetConnectAddress() const
{
    return m_connectAddress;
}

bool DescribeDBProxySSLConfigResponse::ConnectAddressHasBeenSet() const
{
    return m_connectAddressHasBeenSet;
}

string DescribeDBProxySSLConfigResponse::GetCAUrl() const
{
    return m_cAUrl;
}

bool DescribeDBProxySSLConfigResponse::CAUrlHasBeenSet() const
{
