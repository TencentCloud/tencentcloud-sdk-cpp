...
string DeleteReadOnlyGroupRequest::ToJsonString() const
{
...
string DeleteReadOnlyGroupRequest::GetReadOnlyGroupId() const
{
    return m_readOnlyGroupId;
}

void DeleteReadOnlyGroupRequest::SetReadOnlyGroupId(const string& _readOnlyGroupId)
{
    m_readOnlyGroupId = _readOnlyGroupId;
    m_readOnlyGroupIdHasBeenSet = true;
}

bool DeleteReadOnlyGroupRequest::ReadOnlyGroupIdHasBeenSet() const
{
