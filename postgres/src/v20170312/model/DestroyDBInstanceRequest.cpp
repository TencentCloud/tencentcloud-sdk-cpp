...
string DestroyDBInstanceRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DestroyDBInstanceRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DestroyDBInstanceRequest::DBInstanceIdHasBeenSet() const
{
