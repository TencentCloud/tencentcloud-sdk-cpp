...
string DescribeAuditLogsRequest::GetProduct() const
{
    return m_product;
}

void DescribeAuditLogsRequest::SetProduct(const string& _product)
{
    m_product = _product;
    m_productHasBeenSet = true;
}

bool DescribeAuditLogsRequest::ProductHasBeenSet() const
{
