...
string DescribeBackupPlansRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DescribeBackupPlansRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DescribeBackupPlansRequest::DBInstanceIdHasBeenSet() const
{
