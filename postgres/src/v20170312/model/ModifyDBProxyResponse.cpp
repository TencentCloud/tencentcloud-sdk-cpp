...
CoreInternalOutcome ModifyDBProxyResponse::Deserialize(const string &payload)
{
...
string ModifyDBProxyResponse::ToJsonString() const
{
...
string ModifyDBProxyResponse::GetDealName() const
{
    return m_dealName;
}

bool ModifyDBProxyResponse::DealNameHasBeenSet() const
{
