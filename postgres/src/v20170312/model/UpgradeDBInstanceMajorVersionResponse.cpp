...
CoreInternalOutcome UpgradeDBInstanceMajorVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeDBInstanceMajorVersionResponse::ToJsonString() const
{
...
int64_t UpgradeDBInstanceMajorVersionResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpgradeDBInstanceMajorVersionResponse::TaskIdHasBeenSet() const
{
