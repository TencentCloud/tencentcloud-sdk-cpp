...
string RemoveDBInstanceFromReadOnlyGroupRequest::ToJsonString() const
{
...
string RemoveDBInstanceFromReadOnlyGroupRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void RemoveDBInstanceFromReadOnlyGroupRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool RemoveDBInstanceFromReadOnlyGroupRequest::DBInstanceIdHasBeenSet() const
{
    return m_dBInstanceIdHasBeenSet;
}

string RemoveDBInstanceFromReadOnlyGroupRequest::GetReadOnlyGroupId() const
{
    return m_readOnlyGroupId;
}

void RemoveDBInstanceFromReadOnlyGroupRequest::SetReadOnlyGroupId(const string& _readOnlyGroupId)
{
    m_readOnlyGroupId = _readOnlyGroupId;
    m_readOnlyGroupIdHasBeenSet = true;
}

bool RemoveDBInstanceFromReadOnlyGroupRequest::ReadOnlyGroupIdHasBeenSet() const
{
