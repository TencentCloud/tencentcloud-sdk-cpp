...
string DescribeDBInstanceSecurityGroupsRequest::ToJsonString() const
{
...
string DescribeDBInstanceSecurityGroupsRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DescribeDBInstanceSecurityGroupsRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DescribeDBInstanceSecurityGroupsRequest::DBInstanceIdHasBeenSet() const
{
    return m_dBInstanceIdHasBeenSet;
}

string DescribeDBInstanceSecurityGroupsRequest::GetReadOnlyGroupId() const
{
    return m_readOnlyGroupId;
}

void DescribeDBInstanceSecurityGroupsRequest::SetReadOnlyGroupId(const string& _readOnlyGroupId)
{
    m_readOnlyGroupId = _readOnlyGroupId;
    m_readOnlyGroupIdHasBeenSet = true;
}

bool DescribeDBInstanceSecurityGroupsRequest::ReadOnlyGroupIdHasBeenSet() const
{
