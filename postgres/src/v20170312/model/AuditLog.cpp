...
CoreInternalOutcome AuditLog::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ErrCode") && !value["ErrCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.ErrCode` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErrorMessage") && !value["ErrorMessage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.ErrorMessage` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceId") && !value["InstanceId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.InstanceId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ObjectName") && !value["ObjectName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.ObjectName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ObjectType") && !value["ObjectType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.ObjectType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ThreadId") && !value["ThreadId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditLog.ThreadId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AuditLog::GetErrCode() const
{
    return m_errCode;
}

void AuditLog::SetErrCode(const string& _errCode)
{
    m_errCode = _errCode;
    m_errCodeHasBeenSet = true;
}
...
string AuditLog::GetErrorMessage() const
{
    return m_errorMessage;
}

void AuditLog::SetErrorMessage(const string& _errorMessage)
{
    m_errorMessage = _errorMessage;
    m_errorMessageHasBeenSet = true;
}

bool AuditLog::ErrorMessageHasBeenSet() const
{
...
string AuditLog::GetInstanceId() const
{
    return m_instanceId;
}

void AuditLog::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool AuditLog::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string AuditLog::GetObjectName() const
{
    return m_objectName;
}

void AuditLog::SetObjectName(const string& _objectName)
{
    m_objectName = _objectName;
    m_objectNameHasBeenSet = true;
}

bool AuditLog::ObjectNameHasBeenSet() const
{
    return m_objectNameHasBeenSet;
}

string AuditLog::GetObjectType() const
{
    return m_objectType;
}

void AuditLog::SetObjectType(const string& _objectType)
{
    m_objectType = _objectType;
    m_objectTypeHasBeenSet = true;
}

bool AuditLog::ObjectTypeHasBeenSet() const
{
...
string AuditLog::GetThreadId() const
{
    return m_threadId;
}

void AuditLog::SetThreadId(const string& _threadId)
{
