...
CoreInternalOutcome CloseDBExtranetAccessResponse::Deserialize(const string &payload)
{
...
string CloseDBExtranetAccessResponse::ToJsonString() const
{
...
int64_t CloseDBExtranetAccessResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloseDBExtranetAccessResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CloseDBExtranetAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool CloseDBExtranetAccessResponse::TaskIdHasBeenSet() const
{
