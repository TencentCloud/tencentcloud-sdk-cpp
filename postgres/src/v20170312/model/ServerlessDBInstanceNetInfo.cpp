...
CoreInternalOutcome ServerlessDBInstanceNetInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ServerlessDBInstanceNetInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
