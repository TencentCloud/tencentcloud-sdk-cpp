...
CoreInternalOutcome ModifyDBInstanceParametersResponse::Deserialize(const string &payload)
{
...
string ModifyDBInstanceParametersResponse::ToJsonString() const
{
...
int64_t ModifyDBInstanceParametersResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDBInstanceParametersResponse::TaskIdHasBeenSet() const
{
