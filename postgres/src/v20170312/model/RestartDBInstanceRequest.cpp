...
string RestartDBInstanceRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void RestartDBInstanceRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool RestartDBInstanceRequest::DBInstanceIdHasBeenSet() const
{
