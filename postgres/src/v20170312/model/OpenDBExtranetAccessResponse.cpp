...
string OpenDBExtranetAccessResponse::ToJsonString() const
{
...
int64_t OpenDBExtranetAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool OpenDBExtranetAccessResponse::TaskIdHasBeenSet() const
{
