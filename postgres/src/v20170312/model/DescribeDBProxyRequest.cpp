...
string DescribeDBProxyRequest::ToJsonString() const
{
...
string DescribeDBProxyRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DescribeDBProxyRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DescribeDBProxyRequest::DBInstanceIdHasBeenSet() const
{
    return m_dBInstanceIdHasBeenSet;
}

string DescribeDBProxyRequest::GetProxyGroupId() const
{
    return m_proxyGroupId;
}

void DescribeDBProxyRequest::SetProxyGroupId(const string& _proxyGroupId)
{
    m_proxyGroupId = _proxyGroupId;
    m_proxyGroupIdHasBeenSet = true;
}

bool DescribeDBProxyRequest::ProxyGroupIdHasBeenSet() const
{
