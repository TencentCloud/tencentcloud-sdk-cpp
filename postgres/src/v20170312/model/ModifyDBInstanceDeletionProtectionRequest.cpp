...
string ModifyDBInstanceDeletionProtectionRequest::ToJsonString() const
{
...
string ModifyDBInstanceDeletionProtectionRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void ModifyDBInstanceDeletionProtectionRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool ModifyDBInstanceDeletionProtectionRequest::DBInstanceIdHasBeenSet() const
{
...
void ModifyDBInstanceDeletionProtectionRequest::SetDeletionProtection(const bool& _deletionProtection)
{
    m_deletionProtection = _deletionProtection;
    m_deletionProtectionHasBeenSet = true;
}

bool ModifyDBInstanceDeletionProtectionRequest::DeletionProtectionHasBeenSet() const
{
