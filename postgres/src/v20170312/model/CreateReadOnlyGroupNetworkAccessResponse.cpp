...
CoreInternalOutcome CreateReadOnlyGroupNetworkAccessResponse::Deserialize(const string &payload)
{
...
string CreateReadOnlyGroupNetworkAccessResponse::ToJsonString() const
{
...
int64_t CreateReadOnlyGroupNetworkAccessResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateReadOnlyGroupNetworkAccessResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CreateReadOnlyGroupNetworkAccessResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateReadOnlyGroupNetworkAccessResponse::TaskIdHasBeenSet() const
{
