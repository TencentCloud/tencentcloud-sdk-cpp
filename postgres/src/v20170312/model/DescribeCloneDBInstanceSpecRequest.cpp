...
string DescribeCloneDBInstanceSpecRequest::ToJsonString() const
{
...
string DescribeCloneDBInstanceSpecRequest::GetDBInstanceId() const
{
    return m_dBInstanceId;
}

void DescribeCloneDBInstanceSpecRequest::SetDBInstanceId(const string& _dBInstanceId)
{
    m_dBInstanceId = _dBInstanceId;
    m_dBInstanceIdHasBeenSet = true;
}

bool DescribeCloneDBInstanceSpecRequest::DBInstanceIdHasBeenSet() const
{
    return m_dBInstanceIdHasBeenSet;
}

string DescribeCloneDBInstanceSpecRequest::GetBackupSetId() const
{
    return m_backupSetId;
}

void DescribeCloneDBInstanceSpecRequest::SetBackupSetId(const string& _backupSetId)
{
    m_backupSetId = _backupSetId;
    m_backupSetIdHasBeenSet = true;
}

bool DescribeCloneDBInstanceSpecRequest::BackupSetIdHasBeenSet() const
{
    return m_backupSetIdHasBeenSet;
}

string DescribeCloneDBInstanceSpecRequest::GetRecoveryTargetTime() const
{
    return m_recoveryTargetTime;
}

void DescribeCloneDBInstanceSpecRequest::SetRecoveryTargetTime(const string& _recoveryTargetTime)
{
    m_recoveryTargetTime = _recoveryTargetTime;
    m_recoveryTargetTimeHasBeenSet = true;
}

bool DescribeCloneDBInstanceSpecRequest::RecoveryTargetTimeHasBeenSet() const
{
