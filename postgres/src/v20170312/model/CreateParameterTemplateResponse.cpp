...
CoreInternalOutcome CreateParameterTemplateResponse::Deserialize(const string &payload)
{
...
string CreateParameterTemplateResponse::ToJsonString() const
{
...
string CreateParameterTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateParameterTemplateResponse::TemplateIdHasBeenSet() const
{
