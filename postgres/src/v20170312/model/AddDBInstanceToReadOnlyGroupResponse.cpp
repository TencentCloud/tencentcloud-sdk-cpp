...
CoreInternalOutcome AddDBInstanceToReadOnlyGroupResponse::Deserialize(const string &payload)
{
...
string AddDBInstanceToReadOnlyGroupResponse::ToJsonString() const
{
...
int64_t AddDBInstanceToReadOnlyGroupResponse::GetFlowId() const
{
    return m_flowId;
}

bool AddDBInstanceToReadOnlyGroupResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t AddDBInstanceToReadOnlyGroupResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddDBInstanceToReadOnlyGroupResponse::TaskIdHasBeenSet() const
{
