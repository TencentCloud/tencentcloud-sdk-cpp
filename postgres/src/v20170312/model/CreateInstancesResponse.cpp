...
vector<string> CreateInstancesResponse::GetDealNames() const
{
    return m_dealNames;
}

bool CreateInstancesResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

string CreateInstancesResponse::GetBillId() const
{
    return m_billId;
}

bool CreateInstancesResponse::BillIdHasBeenSet() const
{
    return m_billIdHasBeenSet;
}

vector<string> CreateInstancesResponse::GetDBInstanceIdSet() const
{
    return m_dBInstanceIdSet;
}

bool CreateInstancesResponse::DBInstanceIdSetHasBeenSet() const
{
