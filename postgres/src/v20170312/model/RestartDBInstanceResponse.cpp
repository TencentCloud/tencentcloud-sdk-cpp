...
int64_t RestartDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}
...
int64_t RestartDBInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool RestartDBInstanceResponse::TaskIdHasBeenSet() const
{
