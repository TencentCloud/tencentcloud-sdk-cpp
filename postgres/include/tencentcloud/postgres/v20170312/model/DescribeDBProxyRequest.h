...
#ifndef TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBPROXYREQUEST_H_
#define TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBPROXYREQUEST_H_
    ...
    namespace Postgres
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeDBProxyRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>Proxy 实例 ID，格式形如：proxy-xxxxxxxx；不传则查询该实例下全部 Proxy</p>
                    ...
                    /**
                     * 设置<p>Proxy 实例 ID，格式形如：proxy-xxxxxxxx；不传则查询该实例下全部 Proxy</p>
...
#endif // !TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBPROXYREQUEST_H_
