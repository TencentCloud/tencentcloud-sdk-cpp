            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
                     * @return BackupMethod 备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
                     * 
                     */
                    std::string GetBackupMethod() const;

                    /**
                     * 设置备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
                    ...
                    /**
                     * 获取备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
                     * @return BackupMode 备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
                     * 
                     */
                    std::string GetBackupMode() const;

                    /**
                     * 设置备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
