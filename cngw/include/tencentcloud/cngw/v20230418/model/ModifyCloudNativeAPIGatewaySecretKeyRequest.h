...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudNativeAPIGatewaySecretKeyRequest : public AbstractModel
                {
                public:
                    ModifyCloudNativeAPIGatewaySecretKeyRequest();
                    ~ModifyCloudNativeAPIGatewaySecretKeyRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
