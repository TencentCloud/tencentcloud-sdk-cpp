...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPTOOLACLREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPTOOLACLREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudNativeAPIGatewayMCPToolACLRequest : public AbstractModel
                {
                public:
                    ModifyCloudNativeAPIGatewayMCPToolACLRequest();
                    ~ModifyCloudNativeAPIGatewayMCPToolACLRequest() = default;
                    ...
                    /**
                     * 获取<p>鉴权类型</p><p>枚举值：</p><ul><li>None： 继承server鉴权类型</li><li>Allow： 白名单</li><li>Deny： 黑名单</li></ul>
                    ...
                    /**
                     * 设置<p>鉴权类型</p><p>枚举值：</p><ul><li>None： 继承server鉴权类型</li><li>Allow： 白名单</li><li>Deny： 黑名单</li></ul>
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPTOOLACLREQUEST_H_
