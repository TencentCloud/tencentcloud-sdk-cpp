...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPSERVERREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPSERVERREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudNativeAPIGatewayMCPServerRequest : public AbstractModel
                {
                public:
                    ModifyCloudNativeAPIGatewayMCPServerRequest();
                    ~ModifyCloudNativeAPIGatewayMCPServerRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_MODIFYCLOUDNATIVEAPIGATEWAYMCPSERVERREQUEST_H_
