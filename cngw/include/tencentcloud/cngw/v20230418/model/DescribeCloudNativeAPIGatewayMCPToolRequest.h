...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudNativeAPIGatewayMCPToolRequest : public AbstractModel
                {
                public:
                    DescribeCloudNativeAPIGatewayMCPToolRequest();
                    ~DescribeCloudNativeAPIGatewayMCPToolRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
