...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_BINDCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_BINDCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class BindCloudNativeAPIGatewaySecretKeyRequest : public AbstractModel
                {
                public:
                    BindCloudNativeAPIGatewaySecretKeyRequest();
                    ~BindCloudNativeAPIGatewaySecretKeyRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_BINDCLOUDNATIVEAPIGATEWAYSECRETKEYREQUEST_H_
