...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudNativeAPIGatewayMCPToolVersionRequest : public AbstractModel
                {
                public:
                    DescribeCloudNativeAPIGatewayMCPToolVersionRequest();
                    ~DescribeCloudNativeAPIGatewayMCPToolVersionRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
