...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudNativeAPIGatewayMCPToolRequest : public AbstractModel
                {
                public:
                    DeleteCloudNativeAPIGatewayMCPToolRequest();
                    ~DeleteCloudNativeAPIGatewayMCPToolRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLREQUEST_H_
