...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_ROLLBACKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_ROLLBACKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class RollbackCloudNativeAPIGatewayMCPToolVersionRequest : public AbstractModel
                {
                public:
                    RollbackCloudNativeAPIGatewayMCPToolVersionRequest();
                    ~RollbackCloudNativeAPIGatewayMCPToolVersionRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_ROLLBACKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
