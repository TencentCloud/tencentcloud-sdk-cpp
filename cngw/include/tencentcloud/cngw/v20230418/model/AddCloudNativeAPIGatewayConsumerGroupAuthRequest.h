...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_ADDCLOUDNATIVEAPIGATEWAYCONSUMERGROUPAUTHREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_ADDCLOUDNATIVEAPIGATEWAYCONSUMERGROUPAUTHREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class AddCloudNativeAPIGatewayConsumerGroupAuthRequest : public AbstractModel
                {
                public:
                    AddCloudNativeAPIGatewayConsumerGroupAuthRequest();
                    ~AddCloudNativeAPIGatewayConsumerGroupAuthRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_ADDCLOUDNATIVEAPIGATEWAYCONSUMERGROUPAUTHREQUEST_H_
