...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudNativeAPIGatewayMCPToolVersionRequest : public AbstractModel
                {
                public:
                    DeleteCloudNativeAPIGatewayMCPToolVersionRequest();
                    ~DeleteCloudNativeAPIGatewayMCPToolVersionRequest() = default;
                    ...
                    /**
                     * 获取<p>mcp tool版本</p>
                     * @return ToolVersion <p>mcp tool版本</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONREQUEST_H_
