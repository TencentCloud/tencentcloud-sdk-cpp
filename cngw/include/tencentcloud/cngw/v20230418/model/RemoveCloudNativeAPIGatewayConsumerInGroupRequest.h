...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_REMOVECLOUDNATIVEAPIGATEWAYCONSUMERINGROUPREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_REMOVECLOUDNATIVEAPIGATEWAYCONSUMERINGROUPREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class RemoveCloudNativeAPIGatewayConsumerInGroupRequest : public AbstractModel
                {
                public:
                    RemoveCloudNativeAPIGatewayConsumerInGroupRequest();
                    ~RemoveCloudNativeAPIGatewayConsumerInGroupRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_REMOVECLOUDNATIVEAPIGATEWAYCONSUMERINGROUPREQUEST_H_
