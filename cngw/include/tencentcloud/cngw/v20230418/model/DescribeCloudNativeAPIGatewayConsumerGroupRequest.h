...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYCONSUMERGROUPREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYCONSUMERGROUPREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudNativeAPIGatewayConsumerGroupRequest : public AbstractModel
                {
                public:
                    DescribeCloudNativeAPIGatewayConsumerGroupRequest();
                    ~DescribeCloudNativeAPIGatewayConsumerGroupRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYCONSUMERGROUPREQUEST_H_
