...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudNativeAPIGatewayLLMModelServiceRequest : public AbstractModel
                {
                public:
                    DescribeCloudNativeAPIGatewayLLMModelServiceRequest();
                    ~DescribeCloudNativeAPIGatewayLLMModelServiceRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DESCRIBECLOUDNATIVEAPIGATEWAYLLMMODELSERVICEREQUEST_H_
