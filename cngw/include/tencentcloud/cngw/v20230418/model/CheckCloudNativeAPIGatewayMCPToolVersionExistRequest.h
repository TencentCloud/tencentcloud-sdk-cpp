...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_CHECKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONEXISTREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_CHECKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONEXISTREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CheckCloudNativeAPIGatewayMCPToolVersionExistRequest : public AbstractModel
                {
                public:
                    CheckCloudNativeAPIGatewayMCPToolVersionExistRequest();
                    ~CheckCloudNativeAPIGatewayMCPToolVersionExistRequest() = default;
                    ...
                    /**
                     * 获取<p>mcp tool版本id</p>
                     * @return ToolVersion <p>mcp tool版本id</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_CHECKCLOUDNATIVEAPIGATEWAYMCPTOOLVERSIONEXISTREQUEST_H_
