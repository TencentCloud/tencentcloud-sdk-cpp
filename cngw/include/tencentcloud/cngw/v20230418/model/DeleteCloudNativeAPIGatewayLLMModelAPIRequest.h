...
#ifndef TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYLLMMODELAPIREQUEST_H_
#define TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYLLMMODELAPIREQUEST_H_
    ...
    namespace Cngw
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudNativeAPIGatewayLLMModelAPIRequest : public AbstractModel
                {
                public:
                    DeleteCloudNativeAPIGatewayLLMModelAPIRequest();
                    ~DeleteCloudNativeAPIGatewayLLMModelAPIRequest() = default;
...
#endif // !TENCENTCLOUD_CNGW_V20230418_MODEL_DELETECLOUDNATIVEAPIGATEWAYLLMMODELAPIREQUEST_H_
