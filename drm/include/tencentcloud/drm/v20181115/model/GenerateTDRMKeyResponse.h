...
#ifndef TENCENTCLOUD_DRM_V20181115_MODEL_GENERATETDRMKEYRESPONSE_H_
#define TENCENTCLOUD_DRM_V20181115_MODEL_GENERATETDRMKEYRESPONSE_H_
    ...
    namespace Drm
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class GenerateTDRMKeyResponse : public AbstractModel
                {
                public:
                    GenerateTDRMKeyResponse();
                    ~GenerateTDRMKeyResponse() = default;
...
#endif // !TENCENTCLOUD_DRM_V20181115_MODEL_GENERATETDRMKEYRESPONSE_H_
