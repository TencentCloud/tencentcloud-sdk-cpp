...
#ifndef TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMREQUEST_H_
#define TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMREQUEST_H_
    ...
    namespace Drm
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class ModifyFairPlayPemRequest : public AbstractModel
                {
                public:
                    ModifyFairPlayPemRequest();
                    ~ModifyFairPlayPemRequest() = default;
...
#endif // !TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMREQUEST_H_
