...
#ifndef TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMRESPONSE_H_
#define TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMRESPONSE_H_
    ...
    namespace Drm
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class ModifyFairPlayPemResponse : public AbstractModel
                {
                public:
                    ModifyFairPlayPemResponse();
                    ~ModifyFairPlayPemResponse() = default;
...
#endif // !TENCENTCLOUD_DRM_V20181115_MODEL_MODIFYFAIRPLAYPEMRESPONSE_H_
