...
GenerateTDRMKeyResponse::GenerateTDRMKeyResponse() :
    m_contentIdHasBeenSet(false),
    m_tXEncryptionTokenHasBeenSet(false)
{
}

CoreInternalOutcome GenerateTDRMKeyResponse::Deserialize(const string &payload)
{
...
string GenerateTDRMKeyResponse::ToJsonString() const
{
...
string GenerateTDRMKeyResponse::GetContentId() const
{
    return m_contentId;
}

bool GenerateTDRMKeyResponse::ContentIdHasBeenSet() const
{
    return m_contentIdHasBeenSet;
}

string GenerateTDRMKeyResponse::GetTXEncryptionToken() const
{
    return m_tXEncryptionToken;
}

bool GenerateTDRMKeyResponse::TXEncryptionTokenHasBeenSet() const
{
