...
string StartEncryptionRequest::ToJsonString() const
{
    ...
    if (m_cosEndPointHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_cosEndPoint.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_cosSecretIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_cosSecretId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_cosSecretKeyHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_cosSecretKey.c_str(), allocator).Move(), allocator);
    }
