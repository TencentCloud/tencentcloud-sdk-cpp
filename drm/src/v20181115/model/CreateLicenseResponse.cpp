...
CoreInternalOutcome CreateLicenseResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["License"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `License` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_license = string(rsp["License"].GetString());
...
string CreateLicenseResponse::ToJsonString() const
{
...
string CreateLicenseResponse::GetLicense() const
{
    return m_license;
}

bool CreateLicenseResponse::LicenseHasBeenSet() const
{
    return m_licenseHasBeenSet;
}

string CreateLicenseResponse::GetContentId() const
{
    return m_contentId;
}

bool CreateLicenseResponse::ContentIdHasBeenSet() const
{
