...
CoreInternalOutcome ReduceInstanceResponse::Deserialize(const string &payload)
{
...
string ReduceInstanceResponse::ToJsonString() const
{
...
string ReduceInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool ReduceInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string ReduceInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool ReduceInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ReduceInstanceResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ReduceInstanceResponse::ErrorMsgHasBeenSet() const
{
