...
CoreInternalOutcome DescribeCoolDownTableDataResponse::Deserialize(const string &payload)
{
...
string DescribeCoolDownTableDataResponse::ToJsonString() const
{
...
string DescribeCoolDownTableDataResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeCoolDownTableDataResponse::ErrorMsgHasBeenSet() const
{
    return m_errorMsgHasBeenSet;
}

vector<CoolDownTableDataInfo> DescribeCoolDownTableDataResponse::GetList() const
{
    return m_list;
}

bool DescribeCoolDownTableDataResponse::ListHasBeenSet() const
{
