...
CoreInternalOutcome DescribeTableListResponse::Deserialize(const string &payload)
{
...
string DescribeTableListResponse::ToJsonString() const
{
...
vector<string> DescribeTableListResponse::GetTableNames() const
{
    return m_tableNames;
}

bool DescribeTableListResponse::TableNamesHasBeenSet() const
{
    return m_tableNamesHasBeenSet;
}

string DescribeTableListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeTableListResponse::MessageHasBeenSet() const
{
