...
CoreInternalOutcome ModifyNodeStatusResponse::Deserialize(const string &payload)
{
...
string ModifyNodeStatusResponse::ToJsonString() const
{
...
int64_t ModifyNodeStatusResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyNodeStatusResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string ModifyNodeStatusResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyNodeStatusResponse::ErrorMsgHasBeenSet() const
{
