...
string OpenBackUpRequest::ToJsonString() const
{
...
string OpenBackUpRequest::GetInstanceId() const
{
    return m_instanceId;
}

void OpenBackUpRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool OpenBackUpRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string OpenBackUpRequest::GetOperationType() const
{
    return m_operationType;
}

void OpenBackUpRequest::SetOperationType(const string& _operationType)
{
    m_operationType = _operationType;
    m_operationTypeHasBeenSet = true;
}

bool OpenBackUpRequest::OperationTypeHasBeenSet() const
{
    return m_operationTypeHasBeenSet;
}

string OpenBackUpRequest::GetCosBucketName() const
{
    return m_cosBucketName;
}

void OpenBackUpRequest::SetCosBucketName(const string& _cosBucketName)
{
    m_cosBucketName = _cosBucketName;
    m_cosBucketNameHasBeenSet = true;
}

bool OpenBackUpRequest::CosBucketNameHasBeenSet() const
{
