...
CoreInternalOutcome CheckCoolDownWorkingVariableConfigCorrectResponse::Deserialize(const string &payload)
{
...
string CheckCoolDownWorkingVariableConfigCorrectResponse::ToJsonString() const
{
...
string CheckCoolDownWorkingVariableConfigCorrectResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CheckCoolDownWorkingVariableConfigCorrectResponse::ErrorMsgHasBeenSet() const
{
