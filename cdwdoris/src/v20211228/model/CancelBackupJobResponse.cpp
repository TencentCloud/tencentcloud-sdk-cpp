...
CoreInternalOutcome CancelBackupJobResponse::Deserialize(const string &payload)
{
...
string CancelBackupJobResponse::ToJsonString() const
{
...
string CancelBackupJobResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CancelBackupJobResponse::ErrorMsgHasBeenSet() const
{
