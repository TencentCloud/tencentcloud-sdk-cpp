...
CoreInternalOutcome ModifyUserBindWorkloadGroupResponse::Deserialize(const string &payload)
{
...
string ModifyUserBindWorkloadGroupResponse::ToJsonString() const
{
...
string ModifyUserBindWorkloadGroupResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyUserBindWorkloadGroupResponse::ErrorMsgHasBeenSet() const
{
