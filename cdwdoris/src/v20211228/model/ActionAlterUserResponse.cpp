...
CoreInternalOutcome ActionAlterUserResponse::Deserialize(const string &payload)
{
...
string ActionAlterUserResponse::ToJsonString() const
{
...
string ActionAlterUserResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ActionAlterUserResponse::ErrorMsgHasBeenSet() const
{
