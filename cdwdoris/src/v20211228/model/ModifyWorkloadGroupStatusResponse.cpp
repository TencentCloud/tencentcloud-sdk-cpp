...
CoreInternalOutcome ModifyWorkloadGroupStatusResponse::Deserialize(const string &payload)
{
...
string ModifyWorkloadGroupStatusResponse::ToJsonString() const
{
...
string ModifyWorkloadGroupStatusResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyWorkloadGroupStatusResponse::ErrorMsgHasBeenSet() const
{
