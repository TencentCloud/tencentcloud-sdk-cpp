...
CoreInternalOutcome ModifySecurityGroupsResponse::Deserialize(const string &payload)
{
...
string ModifySecurityGroupsResponse::ToJsonString() const
{
...
string ModifySecurityGroupsResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifySecurityGroupsResponse::ErrorMsgHasBeenSet() const
{
