...
CoreInternalOutcome DescribeDatabaseAuditDownloadResponse::Deserialize(const string &payload)
{
...
string DescribeDatabaseAuditDownloadResponse::ToJsonString() const
{
...
string DescribeDatabaseAuditDownloadResponse::GetCosUrl() const
{
    return m_cosUrl;
}

bool DescribeDatabaseAuditDownloadResponse::CosUrlHasBeenSet() const
{
