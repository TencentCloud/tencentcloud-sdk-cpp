...
CoreInternalOutcome DescribeCoolDownPoliciesResponse::Deserialize(const string &payload)
{
...
string DescribeCoolDownPoliciesResponse::ToJsonString() const
{
...
string DescribeCoolDownPoliciesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeCoolDownPoliciesResponse::ErrorMsgHasBeenSet() const
{
    return m_errorMsgHasBeenSet;
}

vector<CoolDownPolicyInfo> DescribeCoolDownPoliciesResponse::GetList() const
{
    return m_list;
}

bool DescribeCoolDownPoliciesResponse::ListHasBeenSet() const
{
