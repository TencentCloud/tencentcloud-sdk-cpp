...
CoreInternalOutcome DescribeInstancesHealthStateResponse::Deserialize(const string &payload)
{
...
string DescribeInstancesHealthStateResponse::ToJsonString() const
{
...
string DescribeInstancesHealthStateResponse::GetData() const
{
    return m_data;
}

bool DescribeInstancesHealthStateResponse::DataHasBeenSet() const
{
