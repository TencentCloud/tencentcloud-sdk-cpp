...
CoreInternalOutcome OpenCoolDownResponse::Deserialize(const string &payload)
{
...
string OpenCoolDownResponse::ToJsonString() const
{
...
string OpenCoolDownResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool OpenCoolDownResponse::ErrorMsgHasBeenSet() const
{
