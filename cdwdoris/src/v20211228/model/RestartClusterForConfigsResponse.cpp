...
CoreInternalOutcome RestartClusterForConfigsResponse::Deserialize(const string &payload)
{
...
string RestartClusterForConfigsResponse::ToJsonString() const
{
...
int64_t RestartClusterForConfigsResponse::GetFlowId() const
{
    return m_flowId;
}

bool RestartClusterForConfigsResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string RestartClusterForConfigsResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool RestartClusterForConfigsResponse::ErrorMsgHasBeenSet() const
{
