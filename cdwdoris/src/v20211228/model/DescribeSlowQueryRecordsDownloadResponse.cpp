...
CoreInternalOutcome DescribeSlowQueryRecordsDownloadResponse::Deserialize(const string &payload)
{
...
string DescribeSlowQueryRecordsDownloadResponse::ToJsonString() const
{
...
string DescribeSlowQueryRecordsDownloadResponse::GetCosUrl() const
{
    return m_cosUrl;
}

bool DescribeSlowQueryRecordsDownloadResponse::CosUrlHasBeenSet() const
{
