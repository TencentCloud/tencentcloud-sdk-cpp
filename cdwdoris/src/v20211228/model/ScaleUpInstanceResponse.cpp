...
CoreInternalOutcome ScaleUpInstanceResponse::Deserialize(const string &payload)
{
...
string ScaleUpInstanceResponse::ToJsonString() const
{
...
string ScaleUpInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool ScaleUpInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string ScaleUpInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool ScaleUpInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ScaleUpInstanceResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ScaleUpInstanceResponse::ErrorMsgHasBeenSet() const
{
