...
int64_t DescribeInstanceOperationsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeInstanceOperationsRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
int64_t DescribeInstanceOperationsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeInstanceOperationsRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
