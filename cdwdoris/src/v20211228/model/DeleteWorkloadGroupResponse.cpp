...
CoreInternalOutcome DeleteWorkloadGroupResponse::Deserialize(const string &payload)
{
...
string DeleteWorkloadGroupResponse::ToJsonString() const
{
...
string DeleteWorkloadGroupResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DeleteWorkloadGroupResponse::ErrorMsgHasBeenSet() const
{
