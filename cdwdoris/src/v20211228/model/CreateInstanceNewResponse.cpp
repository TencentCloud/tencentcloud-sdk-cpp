...
CoreInternalOutcome CreateInstanceNewResponse::Deserialize(const string &payload)
{
...
string CreateInstanceNewResponse::ToJsonString() const
{
...
string CreateInstanceNewResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateInstanceNewResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string CreateInstanceNewResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool CreateInstanceNewResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string CreateInstanceNewResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CreateInstanceNewResponse::ErrorMsgHasBeenSet() const
{
