...
CoreInternalOutcome ModifyWorkloadGroupResponse::Deserialize(const string &payload)
{
...
string ModifyWorkloadGroupResponse::ToJsonString() const
{
...
string ModifyWorkloadGroupResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyWorkloadGroupResponse::ErrorMsgHasBeenSet() const
{
