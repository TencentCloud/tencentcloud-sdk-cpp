...
FitClsLogResponse::FitClsLogResponse() :
    m_flowIdHasBeenSet(false),
    m_errorMsgHasBeenSet(false)
{
}

CoreInternalOutcome FitClsLogResponse::Deserialize(const string &payload)
{
...
string FitClsLogResponse::ToJsonString() const
{
...
int64_t FitClsLogResponse::GetFlowId() const
{
    return m_flowId;
}

bool FitClsLogResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string FitClsLogResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool FitClsLogResponse::ErrorMsgHasBeenSet() const
{
