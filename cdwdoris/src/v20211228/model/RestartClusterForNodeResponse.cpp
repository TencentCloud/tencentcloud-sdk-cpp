...
CoreInternalOutcome RestartClusterForNodeResponse::Deserialize(const string &payload)
{
...
string RestartClusterForNodeResponse::ToJsonString() const
{
...
int64_t RestartClusterForNodeResponse::GetFlowId() const
{
    return m_flowId;
}

bool RestartClusterForNodeResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string RestartClusterForNodeResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool RestartClusterForNodeResponse::ErrorMsgHasBeenSet() const
{
