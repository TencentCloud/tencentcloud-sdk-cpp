...
CoreInternalOutcome ResizeDiskResponse::Deserialize(const string &payload)
{
...
string ResizeDiskResponse::ToJsonString() const
{
...
string ResizeDiskResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool ResizeDiskResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ResizeDiskResponse::GetFlowId() const
{
    return m_flowId;
}

bool ResizeDiskResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string ResizeDiskResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ResizeDiskResponse::ErrorMsgHasBeenSet() const
{
