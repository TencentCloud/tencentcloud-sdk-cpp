...
DescribeDorisMetricFilesResponse::DescribeDorisMetricFilesResponse() :
    m_errorMsgHasBeenSet(false),
    m_returnDataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDorisMetricFilesResponse::Deserialize(const string &payload)
{
...
string DescribeDorisMetricFilesResponse::ToJsonString() const
{
...
string DescribeDorisMetricFilesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeDorisMetricFilesResponse::ErrorMsgHasBeenSet() const
{
    return m_errorMsgHasBeenSet;
}

string DescribeDorisMetricFilesResponse::GetReturnData() const
{
    return m_returnData;
}

bool DescribeDorisMetricFilesResponse::ReturnDataHasBeenSet() const
{
