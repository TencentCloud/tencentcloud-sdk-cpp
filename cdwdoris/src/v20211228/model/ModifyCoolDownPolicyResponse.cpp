...
CoreInternalOutcome ModifyCoolDownPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyCoolDownPolicyResponse::ToJsonString() const
{
...
string ModifyCoolDownPolicyResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ModifyCoolDownPolicyResponse::ErrorMsgHasBeenSet() const
{
