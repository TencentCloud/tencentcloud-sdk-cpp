...
CoreInternalOutcome UpdateCoolDownResponse::Deserialize(const string &payload)
{
...
string UpdateCoolDownResponse::ToJsonString() const
{
...
string UpdateCoolDownResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool UpdateCoolDownResponse::ErrorMsgHasBeenSet() const
{
