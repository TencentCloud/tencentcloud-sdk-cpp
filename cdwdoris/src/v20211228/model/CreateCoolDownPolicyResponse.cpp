...
CoreInternalOutcome CreateCoolDownPolicyResponse::Deserialize(const string &payload)
{
...
string CreateCoolDownPolicyResponse::ToJsonString() const
{
...
string CreateCoolDownPolicyResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CreateCoolDownPolicyResponse::ErrorMsgHasBeenSet() const
{
