...
CoreInternalOutcome DescribeCoolDownBackendsResponse::Deserialize(const string &payload)
{
...
string DescribeCoolDownBackendsResponse::ToJsonString() const
{
...
string DescribeCoolDownBackendsResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeCoolDownBackendsResponse::ErrorMsgHasBeenSet() const
{
    return m_errorMsgHasBeenSet;
}

vector<CoolDownBackend> DescribeCoolDownBackendsResponse::GetList() const
{
    return m_list;
}

bool DescribeCoolDownBackendsResponse::ListHasBeenSet() const
{
