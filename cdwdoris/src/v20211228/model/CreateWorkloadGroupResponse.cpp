...
CoreInternalOutcome CreateWorkloadGroupResponse::Deserialize(const string &payload)
{
...
string CreateWorkloadGroupResponse::ToJsonString() const
{
...
string CreateWorkloadGroupResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CreateWorkloadGroupResponse::ErrorMsgHasBeenSet() const
{
