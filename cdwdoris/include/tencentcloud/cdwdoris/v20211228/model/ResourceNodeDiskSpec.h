...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_RESOURCENODEDISKSPEC_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_RESOURCENODEDISKSPEC_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                * 集群内节点的规格磁盘规格描述
                */
                class ResourceNodeDiskSpec : public AbstractModel
                {
                public:
                    ResourceNodeDiskSpec();
                    ~ResourceNodeDiskSpec() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_RESOURCENODEDISKSPEC_H_
