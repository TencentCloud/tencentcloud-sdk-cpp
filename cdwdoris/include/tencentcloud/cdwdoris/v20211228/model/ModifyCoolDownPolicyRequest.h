...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYCOOLDOWNPOLICYREQUEST_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYCOOLDOWNPOLICYREQUEST_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class ModifyCoolDownPolicyRequest : public AbstractModel
                {
                public:
                    ModifyCoolDownPolicyRequest();
                    ~ModifyCoolDownPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYCOOLDOWNPOLICYREQUEST_H_
