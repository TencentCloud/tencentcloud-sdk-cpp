...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEREGIONZONEREQUEST_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEREGIONZONEREQUEST_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class DescribeRegionZoneRequest : public AbstractModel
                {
                public:
                    DescribeRegionZoneRequest();
                    ~DescribeRegionZoneRequest() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEREGIONZONEREQUEST_H_
