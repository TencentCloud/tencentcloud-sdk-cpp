...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYMETRICFILESTRUCTNEW_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYMETRICFILESTRUCTNEW_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class ModifyMetricFileStructNew : public AbstractModel
                {
                public:
                    ModifyMetricFileStructNew();
                    ~ModifyMetricFileStructNew() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_MODIFYMETRICFILESTRUCTNEW_H_
