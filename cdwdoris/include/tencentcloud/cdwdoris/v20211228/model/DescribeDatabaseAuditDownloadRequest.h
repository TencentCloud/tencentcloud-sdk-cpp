...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEDATABASEAUDITDOWNLOADREQUEST_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEDATABASEAUDITDOWNLOADREQUEST_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class DescribeDatabaseAuditDownloadRequest : public AbstractModel
                {
                public:
                    DescribeDatabaseAuditDownloadRequest();
                    ~DescribeDatabaseAuditDownloadRequest() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEDATABASEAUDITDOWNLOADREQUEST_H_
