...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_RETRYRESOURCEGRAPHREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_RETRYRESOURCEGRAPHREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class RetryResourceGraphRequest : public AbstractModel
                {
                public:
                    RetryResourceGraphRequest();
                    ~RetryResourceGraphRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_RETRYRESOURCEGRAPHREQUEST_H_
