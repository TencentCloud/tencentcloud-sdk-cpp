...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYCLOUDPRODUCTLOGTASKREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYCLOUDPRODUCTLOGTASKREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudProductLogTaskRequest : public AbstractModel
                {
                public:
                    ModifyCloudProductLogTaskRequest();
                    ~ModifyCloudProductLogTaskRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYCLOUDPRODUCTLOGTASKREQUEST_H_
