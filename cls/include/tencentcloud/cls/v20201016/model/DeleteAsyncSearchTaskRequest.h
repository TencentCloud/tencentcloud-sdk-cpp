...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DELETEASYNCSEARCHTASKREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DELETEASYNCSEARCHTASKREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DeleteAsyncSearchTaskRequest : public AbstractModel
                {
                public:
                    DeleteAsyncSearchTaskRequest();
                    ~DeleteAsyncSearchTaskRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DELETEASYNCSEARCHTASKREQUEST_H_
