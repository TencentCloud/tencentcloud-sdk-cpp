...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DELETELOGREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DELETELOGREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                * DeleteLog请求参数结构体
                */
                class DeleteLogRequest : public AbstractModel
                {
                public:
                    DeleteLogRequest();
                    ~DeleteLogRequest() = default;
                    ...
                    /**
                     * 获取<p>日志检索条件，仅支持 CQL 语法，不支持 Lucene 语法</p><p>对符合检索条件的日志进行删除</p>
                    ...
                    /**
                     * 设置<p>日志检索条件，仅支持 CQL 语法，不支持 Lucene 语法</p><p>对符合检索条件的日志进行删除</p>
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DELETELOGREQUEST_H_
