...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHENTITYRELATEDTOPIC_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHENTITYRELATEDTOPIC_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                * 资源图谱实体关联的日志主题信息
                */
                class ResourceGraphEntityRelatedTopic : public AbstractModel
                {
                public:
                    ResourceGraphEntityRelatedTopic();
                    ~ResourceGraphEntityRelatedTopic() = default;
                    ...
                    /**
                     * 获取<p>日志类型</p><p>枚举值：</p><ul><li>bussinesslog： 业务日志</li></ul>
                    ...
                    /**
                     * 设置<p>日志类型</p><p>枚举值：</p><ul><li>bussinesslog： 业务日志</li></ul>
                    ...
                    /**
                     * 获取<p>日志类型</p><p>枚举值：</p><ul><li>0： 日志主题</li><li>1： 指标主题</li></ul>
                    ...
                    /**
                     * 设置<p>日志类型</p><p>枚举值：</p><ul><li>0： 日志主题</li><li>1： 指标主题</li></ul>
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHENTITYRELATEDTOPIC_H_
