...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_CREATECLOUDPRODUCTLOGTASKREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_CREATECLOUDPRODUCTLOGTASKREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class CreateCloudProductLogTaskRequest : public AbstractModel
                {
                public:
                    CreateCloudProductLogTaskRequest();
                    ~CreateCloudProductLogTaskRequest() = default;
...
- APIS所有日志类型：gz
                    ...
                    /**
                     * 获取日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
                     * @return LogsetId 日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
                     * 
                     */
                    std::string GetLogsetId() const;

                    /**
                     * 设置日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
                    ...
                    /**
                     * 获取日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
                     * @return TopicId 日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
                     * 
                     */
                    std::string GetTopicId() const;

                    /**
                     * 设置日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_CREATECLOUDPRODUCTLOGTASKREQUEST_H_
