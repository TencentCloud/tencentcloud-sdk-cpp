...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DELETECLOUDPRODUCTLOGTASKREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DELETECLOUDPRODUCTLOGTASKREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudProductLogTaskRequest : public AbstractModel
                {
                public:
                    DeleteCloudProductLogTaskRequest();
                    ~DeleteCloudProductLogTaskRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DELETECLOUDPRODUCTLOGTASKREQUEST_H_
