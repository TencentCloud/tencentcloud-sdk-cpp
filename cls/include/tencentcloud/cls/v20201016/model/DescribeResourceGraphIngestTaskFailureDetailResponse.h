...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBERESOURCEGRAPHINGESTTASKFAILUREDETAILRESPONSE_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBERESOURCEGRAPHINGESTTASKFAILUREDETAILRESPONSE_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeResourceGraphIngestTaskFailureDetailResponse : public AbstractModel
                {
                public:
                    DescribeResourceGraphIngestTaskFailureDetailResponse();
                    ~DescribeResourceGraphIngestTaskFailureDetailResponse() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBERESOURCEGRAPHINGESTTASKFAILUREDETAILRESPONSE_H_
