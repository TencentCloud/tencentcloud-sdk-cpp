...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_SEARCHS3RECHARGEINFOREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_SEARCHS3RECHARGEINFOREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class SearchS3RechargeInfoRequest : public AbstractModel
                {
                public:
                    SearchS3RechargeInfoRequest();
                    ~SearchS3RechargeInfoRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_SEARCHS3RECHARGEINFOREQUEST_H_
