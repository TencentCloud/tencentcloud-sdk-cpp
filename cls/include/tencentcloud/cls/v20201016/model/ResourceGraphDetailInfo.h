...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHDETAILINFO_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHDETAILINFO_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                * 资源图谱基本信息
                */
                class ResourceGraphDetailInfo : public AbstractModel
                {
                public:
                    ResourceGraphDetailInfo();
                    ~ResourceGraphDetailInfo() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_RESOURCEGRAPHDETAILINFO_H_
