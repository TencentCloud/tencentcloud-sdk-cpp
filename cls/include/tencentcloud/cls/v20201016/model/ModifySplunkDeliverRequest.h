            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>投递任务名称name有以下限制：- 不能为空- 长度不大于256- 只能包含aA-zZ、下划线、-、0-9</p>
                     * @return Name <p>投递任务名称name有以下限制：- 不能为空- 长度不大于256- 只能包含aA-zZ、下划线、-、0-9</p>
                     * 
                     */
                    std::string GetName() const;

                    /**
                     * 设置<p>投递任务名称name有以下限制：- 不能为空- 长度不大于256- 只能包含aA-zZ、下划线、-、0-9</p>
                    ...
                    /**
                     * 获取<p>高级配置-是否启用索引器;<br>1-不开启；2-开启；默认为：1</p>
                    ...
                    /**
                     * 设置<p>高级配置-是否启用索引器;<br>1-不开启；2-开启；默认为：1</p>
                    ...
                    /**
                     * 获取<p>高级配置-通道。<br>需满足限制：如果启用索引器，该值不能为空</p>
                    ...
                    /**
                     * 设置<p>高级配置-通道。<br>需满足限制：如果启用索引器，该值不能为空</p>
