            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
                     * @return EndTime <p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
                     * 
                     */
                    uint64_t GetEndTime() const;

                    /**
                     * 设置<p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
                     * @param _endTime <p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>任务状态。</p><p>枚举值：</p><ul><li>1： 运行</li><li>2： 停止</li></ul>
                     * @return Status <p>任务状态。</p><p>枚举值：</p><ul><li>1： 运行</li><li>2： 停止</li></ul>
                     * 
                     */
                    uint64_t GetStatus() const;

                    /**
                     * 设置<p>任务状态。</p><p>枚举值：</p><ul><li>1： 运行</li><li>2： 停止</li></ul>
