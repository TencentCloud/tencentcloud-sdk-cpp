...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBENOTICECONTENTSRESPONSE_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBENOTICECONTENTSRESPONSE_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeNoticeContentsResponse : public AbstractModel
                {
                public:
                    DescribeNoticeContentsResponse();
                    ~DescribeNoticeContentsResponse() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBENOTICECONTENTSRESPONSE_H_
