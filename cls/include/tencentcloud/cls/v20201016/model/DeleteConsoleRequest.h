...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DELETECONSOLEREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DELETECONSOLEREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DeleteConsoleRequest : public AbstractModel
                {
                public:
                    DeleteConsoleRequest();
                    ~DeleteConsoleRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DELETECONSOLEREQUEST_H_
