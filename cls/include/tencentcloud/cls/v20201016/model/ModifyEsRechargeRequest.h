...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYESRECHARGEREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYESRECHARGEREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class ModifyEsRechargeRequest : public AbstractModel
                {
                public:
                    ModifyEsRechargeRequest();
                    ~ModifyEsRechargeRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_MODIFYESRECHARGEREQUEST_H_
