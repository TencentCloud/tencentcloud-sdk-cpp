            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Auth角色信息</p><p>“第三方认证登录”登录方式必传</p>
                    ...
                    /**
                     * 设置<p>Auth角色信息</p><p>“第三方认证登录”登录方式必传</p>
                    ...
                    /**
                     * 获取<p>标签描述列表，通过指定该参数可以同时绑定标签到相应的日志主题。最大支持10个标签键值对，同一个资源只能绑定到同一个标签键下。</p>
                    ...
                    /**
                     * 设置<p>标签描述列表，通过指定该参数可以同时绑定标签到相应的日志主题。最大支持10个标签键值对，同一个资源只能绑定到同一个标签键下。</p>
