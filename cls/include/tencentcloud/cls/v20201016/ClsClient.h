...
#include <tencentcloud/cls/v20201016/model/DeleteAgentApplicationRequest.h>
...
#include <tencentcloud/cls/v20201016/model/DescribeAgentApplicationsRequest.h>
...
#include <tencentcloud/cls/v20201016/model/ModifyAgentApplicationResponse.h>
...
#include <tencentcloud/cls/v20201016/model/SearchS3RechargeInfoResponse.h>
    ...
    namespace Cls
    {
        namespace V20201016
        {
            ...
            public:
                ...
                typedef Outcome<Core::Error, Model::CreateAgentApplicationResponse> CreateAgentApplicationOutcome;
                typedef std::future<CreateAgentApplicationOutcome> CreateAgentApplicationOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::CreateAgentApplicationRequest&, CreateAgentApplicationOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateAgentApplicationAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::DeleteAgentApplicationResponse> DeleteAgentApplicationOutcome;
                typedef std::future<DeleteAgentApplicationOutcome> DeleteAgentApplicationOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::DeleteAgentApplicationRequest&, DeleteAgentApplicationOutcome, const std::shared_ptr<const AsyncCallerContext>&)> DeleteAgentApplicationAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::DescribeAgentApplicationsResponse> DescribeAgentApplicationsOutcome;
                typedef std::future<DescribeAgentApplicationsOutcome> DescribeAgentApplicationsOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::DescribeAgentApplicationsRequest&, DescribeAgentApplicationsOutcome, const std::shared_ptr<const AsyncCallerContext>&)> DescribeAgentApplicationsAsyncHandler;
                typedef Outcome<Core::Error, Model::DescribeAgentConfigsResponse> DescribeAgentConfigsOutcome;
                typedef std::future<DescribeAgentConfigsOutcome> DescribeAgentConfigsOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::DescribeAgentConfigsRequest&, DescribeAgentConfigsOutcome, const std::shared_ptr<const AsyncCallerContext>&)> DescribeAgentConfigsAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::ModifyAgentApplicationResponse> ModifyAgentApplicationOutcome;
                typedef std::future<ModifyAgentApplicationOutcome> ModifyAgentApplicationOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::ModifyAgentApplicationRequest&, ModifyAgentApplicationOutcome, const std::shared_ptr<const AsyncCallerContext>&)> ModifyAgentApplicationAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::SearchS3RechargeInfoResponse> SearchS3RechargeInfoOutcome;
                typedef std::future<SearchS3RechargeInfoOutcome> SearchS3RechargeInfoOutcomeCallable;
                typedef std::function<void(const ClsClient*, const Model::SearchS3RechargeInfoRequest&, SearchS3RechargeInfoOutcome, const std::shared_ptr<const AsyncCallerContext>&)> SearchS3RechargeInfoAsyncHandler;
...
⚠️注意：通过SSE流式调用此接口时，请务必设置请求域名（Endpoint）为 cls.ai.tencentcloudapi.com (VPC内网环境可配置 cls.ai.internal.tencentcloudapi.com）。
                 ...
                 * @return CreateAgentApplicationOutcome
                 */
                CreateAgentApplicationOutcome CreateAgentApplication(const Model::CreateAgentApplicationRequest &request);
                void CreateAgentApplicationAsync(const Model::CreateAgentApplicationRequest& request, const CreateAgentApplicationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                CreateAgentApplicationOutcomeCallable CreateAgentApplicationCallable(const Model::CreateAgentApplicationRequest& request);
...
- 重建索引时间范围以日志时间为准，日志上传时间与重建索引时间范围有超过1小时的偏差时（例如16:00上传了一条02:00的日志到 CLS，重建00:00～12:00的日志索引）不会被重建且后续无法进行检索。新上报一条日志到已经被重建的日志时间范围时，也不会被重建且后续无法进行检索。
                 ...
                 */
                CreateS3RechargeOutcome CreateS3Recharge(const Model::CreateS3RechargeRequest &request);
                void CreateS3RechargeAsync(const Model::CreateS3RechargeRequest& request, const CreateS3RechargeAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                CreateS3RechargeOutcomeCallable CreateS3RechargeCallable(const Model::CreateS3RechargeRequest& request);
                 ...
                 * @return DeleteAgentApplicationOutcome
                 */
                DeleteAgentApplicationOutcome DeleteAgentApplication(const Model::DeleteAgentApplicationRequest &request);
                void DeleteAgentApplicationAsync(const Model::DeleteAgentApplicationRequest& request, const DeleteAgentApplicationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DeleteAgentApplicationOutcomeCallable DeleteAgentApplicationCallable(const Model::DeleteAgentApplicationRequest& request);
                 ...
                 * @return DeleteS3RechargeOutcome
                 */
                DeleteS3RechargeOutcome DeleteS3Recharge(const Model::DeleteS3RechargeRequest &request);
                void DeleteS3RechargeAsync(const Model::DeleteS3RechargeRequest& request, const DeleteS3RechargeAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DeleteS3RechargeOutcomeCallable DeleteS3RechargeCallable(const Model::DeleteS3RechargeRequest& request);
                 ...
                 * @return DescribeAgentApplicationsOutcome
                 */
                DescribeAgentApplicationsOutcome DescribeAgentApplications(const Model::DescribeAgentApplicationsRequest &request);
                void DescribeAgentApplicationsAsync(const Model::DescribeAgentApplicationsRequest& request, const DescribeAgentApplicationsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DescribeAgentApplicationsOutcomeCallable DescribeAgentApplicationsCallable(const Model::DescribeAgentApplicationsRequest& request);

                /**
                 *获取agent对应的采集配置
                 * @param req DescribeAgentConfigsRequest
                 * @return DescribeAgentConfigsOutcome
                 */
                DescribeAgentConfigsOutcome DescribeAgentConfigs(const Model::DescribeAgentConfigsRequest &request);
                void DescribeAgentConfigsAsync(const Model::DescribeAgentConfigsRequest& request, const DescribeAgentConfigsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DescribeAgentConfigsOutcomeCallable DescribeAgentConfigsCallable(const Model::DescribeAgentConfigsRequest& request);
...
API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
                 ...
                 */
                DescribeS3RechargesOutcome DescribeS3Recharges(const Model::DescribeS3RechargesRequest &request);
                void DescribeS3RechargesAsync(const Model::DescribeS3RechargesRequest& request, const DescribeS3RechargesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                DescribeS3RechargesOutcomeCallable DescribeS3RechargesCallable(const Model::DescribeS3RechargesRequest& request);
...
API 中 Region 填写任意一个地域均可，建议使用广州(ap-guangzhou)
                 ...
                 * @return ModifyAgentApplicationOutcome
                 */
                ModifyAgentApplicationOutcome ModifyAgentApplication(const Model::ModifyAgentApplicationRequest &request);
                void ModifyAgentApplicationAsync(const Model::ModifyAgentApplicationRequest& request, const ModifyAgentApplicationAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                ModifyAgentApplicationOutcomeCallable ModifyAgentApplicationCallable(const Model::ModifyAgentApplicationRequest& request);
...
注意：修改接口直接覆盖历史数据，改为本次合法入参数据，请谨慎调用此接口。
                 ...
                 */
                ModifyS3RechargeOutcome ModifyS3Recharge(const Model::ModifyS3RechargeRequest &request);
                void ModifyS3RechargeAsync(const Model::ModifyS3RechargeRequest& request, const ModifyS3RechargeAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                ModifyS3RechargeOutcomeCallable ModifyS3RechargeCallable(const Model::ModifyS3RechargeRequest& request);
...
2. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
                 ...
                 * @return SearchS3RechargeInfoOutcome
                 */
                SearchS3RechargeInfoOutcome SearchS3RechargeInfo(const Model::SearchS3RechargeInfoRequest &request);
                void SearchS3RechargeInfoAsync(const Model::SearchS3RechargeInfoRequest& request, const SearchS3RechargeInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                SearchS3RechargeInfoOutcomeCallable SearchS3RechargeInfoCallable(const Model::SearchS3RechargeInfoRequest& request);
