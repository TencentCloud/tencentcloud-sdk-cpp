...
CoreInternalOutcome DescribeKafkaRechargesResponse::Deserialize(const string &payload)
{
...
string DescribeKafkaRechargesResponse::ToJsonString() const
{
...
vector<KafkaRechargeInfo> DescribeKafkaRechargesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeKafkaRechargesResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeKafkaRechargesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeKafkaRechargesResponse::TotalCountHasBeenSet() const
{
