...
string CloseKafkaConsumerRequest::ToJsonString() const
{
...
string CloseKafkaConsumerRequest::GetFromTopicId() const
{
    return m_fromTopicId;
}

void CloseKafkaConsumerRequest::SetFromTopicId(const string& _fromTopicId)
{
    m_fromTopicId = _fromTopicId;
    m_fromTopicIdHasBeenSet = true;
}

bool CloseKafkaConsumerRequest::FromTopicIdHasBeenSet() const
{
