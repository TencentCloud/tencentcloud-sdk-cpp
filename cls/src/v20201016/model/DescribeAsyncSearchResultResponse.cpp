...
CoreInternalOutcome DescribeAsyncSearchResultResponse::Deserialize(const string &payload)
{
...
string DescribeAsyncSearchResultResponse::ToJsonString() const
{
...
string DescribeAsyncSearchResultResponse::GetContext() const
{
    return m_context;
}

bool DescribeAsyncSearchResultResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool DescribeAsyncSearchResultResponse::GetListOver() const
{
    return m_listOver;
}

bool DescribeAsyncSearchResultResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

vector<LogInfo> DescribeAsyncSearchResultResponse::GetResults() const
{
    return m_results;
}

bool DescribeAsyncSearchResultResponse::ResultsHasBeenSet() const
{
