...
CoreInternalOutcome CreateLogsetResponse::Deserialize(const string &payload)
{
...
string CreateLogsetResponse::ToJsonString() const
{
...
string CreateLogsetResponse::GetLogsetId() const
{
    return m_logsetId;
}

bool CreateLogsetResponse::LogsetIdHasBeenSet() const
{
