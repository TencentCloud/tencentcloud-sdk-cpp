...
CoreInternalOutcome DescribeAlertRecordHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeAlertRecordHistoryResponse::ToJsonString() const
{
...
int64_t DescribeAlertRecordHistoryResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAlertRecordHistoryResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AlertHistoryRecord> DescribeAlertRecordHistoryResponse::GetRecords() const
{
    return m_records;
}

bool DescribeAlertRecordHistoryResponse::RecordsHasBeenSet() const
{
