...
string DeleteNoticeContentRequest::ToJsonString() const
{
...
string DeleteNoticeContentRequest::GetNoticeContentId() const
{
    return m_noticeContentId;
}

void DeleteNoticeContentRequest::SetNoticeContentId(const string& _noticeContentId)
{
    m_noticeContentId = _noticeContentId;
    m_noticeContentIdHasBeenSet = true;
}

bool DeleteNoticeContentRequest::NoticeContentIdHasBeenSet() const
{
