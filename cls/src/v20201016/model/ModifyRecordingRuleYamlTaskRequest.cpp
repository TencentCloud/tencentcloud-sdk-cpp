...
string ModifyRecordingRuleYamlTaskRequest::ToJsonString() const
{
...
string ModifyRecordingRuleYamlTaskRequest::GetYamlID() const
{
    return m_yamlID;
}

void ModifyRecordingRuleYamlTaskRequest::SetYamlID(const string& _yamlID)
{
    m_yamlID = _yamlID;
    m_yamlIDHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::YamlIDHasBeenSet() const
{
    return m_yamlIDHasBeenSet;
}

string ModifyRecordingRuleYamlTaskRequest::GetTopicId() const
{
    return m_topicId;
}

void ModifyRecordingRuleYamlTaskRequest::SetTopicId(const string& _topicId)
{
    m_topicId = _topicId;
    m_topicIdHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::TopicIdHasBeenSet() const
{
    return m_topicIdHasBeenSet;
}

string ModifyRecordingRuleYamlTaskRequest::GetDstTopicId() const
{
    return m_dstTopicId;
}

void ModifyRecordingRuleYamlTaskRequest::SetDstTopicId(const string& _dstTopicId)
{
    m_dstTopicId = _dstTopicId;
    m_dstTopicIdHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::DstTopicIdHasBeenSet() const
{
    return m_dstTopicIdHasBeenSet;
}

uint64_t ModifyRecordingRuleYamlTaskRequest::GetEnableFlag() const
{
    return m_enableFlag;
}

void ModifyRecordingRuleYamlTaskRequest::SetEnableFlag(const uint64_t& _enableFlag)
{
    m_enableFlag = _enableFlag;
    m_enableFlagHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::EnableFlagHasBeenSet() const
{
    return m_enableFlagHasBeenSet;
}

uint64_t ModifyRecordingRuleYamlTaskRequest::GetProcessStartTime() const
{
    return m_processStartTime;
}

void ModifyRecordingRuleYamlTaskRequest::SetProcessStartTime(const uint64_t& _processStartTime)
{
    m_processStartTime = _processStartTime;
    m_processStartTimeHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::ProcessStartTimeHasBeenSet() const
{
    return m_processStartTimeHasBeenSet;
}

int64_t ModifyRecordingRuleYamlTaskRequest::GetProcessPeriod() const
{
    return m_processPeriod;
}

void ModifyRecordingRuleYamlTaskRequest::SetProcessPeriod(const int64_t& _processPeriod)
{
    m_processPeriod = _processPeriod;
    m_processPeriodHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::ProcessPeriodHasBeenSet() const
{
    return m_processPeriodHasBeenSet;
}

int64_t ModifyRecordingRuleYamlTaskRequest::GetProcessDelay() const
{
    return m_processDelay;
}

void ModifyRecordingRuleYamlTaskRequest::SetProcessDelay(const int64_t& _processDelay)
{
    m_processDelay = _processDelay;
    m_processDelayHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::ProcessDelayHasBeenSet() const
{
    return m_processDelayHasBeenSet;
}

string ModifyRecordingRuleYamlTaskRequest::GetYamlConfigName() const
{
    return m_yamlConfigName;
}

void ModifyRecordingRuleYamlTaskRequest::SetYamlConfigName(const string& _yamlConfigName)
{
    m_yamlConfigName = _yamlConfigName;
    m_yamlConfigNameHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::YamlConfigNameHasBeenSet() const
{
    return m_yamlConfigNameHasBeenSet;
}

string ModifyRecordingRuleYamlTaskRequest::GetYamlContent() const
{
    return m_yamlContent;
}

void ModifyRecordingRuleYamlTaskRequest::SetYamlContent(const string& _yamlContent)
{
    m_yamlContent = _yamlContent;
    m_yamlContentHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::YamlContentHasBeenSet() const
{
    return m_yamlContentHasBeenSet;
}

uint64_t ModifyRecordingRuleYamlTaskRequest::GetHasServicesLog() const
{
    return m_hasServicesLog;
}

void ModifyRecordingRuleYamlTaskRequest::SetHasServicesLog(const uint64_t& _hasServicesLog)
{
    m_hasServicesLog = _hasServicesLog;
    m_hasServicesLogHasBeenSet = true;
}

bool ModifyRecordingRuleYamlTaskRequest::HasServicesLogHasBeenSet() const
{
