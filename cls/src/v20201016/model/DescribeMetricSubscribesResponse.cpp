...
CoreInternalOutcome DescribeMetricSubscribesResponse::Deserialize(const string &payload)
{
...
string DescribeMetricSubscribesResponse::ToJsonString() const
{
...
uint64_t DescribeMetricSubscribesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMetricSubscribesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MetricSubscribeInfo> DescribeMetricSubscribesResponse::GetDatas() const
{
    return m_datas;
}

bool DescribeMetricSubscribesResponse::DatasHasBeenSet() const
{
