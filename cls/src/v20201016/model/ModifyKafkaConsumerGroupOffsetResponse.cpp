...
CoreInternalOutcome ModifyKafkaConsumerGroupOffsetResponse::Deserialize(const string &payload)
{
...
string ModifyKafkaConsumerGroupOffsetResponse::ToJsonString() const
{
...
int64_t ModifyKafkaConsumerGroupOffsetResponse::GetCode() const
{
    return m_code;
}

bool ModifyKafkaConsumerGroupOffsetResponse::CodeHasBeenSet() const
{
