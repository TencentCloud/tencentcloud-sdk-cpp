...
CoreInternalOutcome GetMetricLabelValuesResponse::Deserialize(const string &payload)
{
...
string GetMetricLabelValuesResponse::ToJsonString() const
{
...
vector<string> GetMetricLabelValuesResponse::GetValues() const
{
    return m_values;
}

bool GetMetricLabelValuesResponse::ValuesHasBeenSet() const
{
