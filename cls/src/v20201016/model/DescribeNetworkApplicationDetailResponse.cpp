...
CoreInternalOutcome DescribeNetworkApplicationDetailResponse::Deserialize(const string &payload)
{
...
string DescribeNetworkApplicationDetailResponse::ToJsonString() const
{
...
NetworkApplicationDetail DescribeNetworkApplicationDetailResponse::GetInfo() const
{
    return m_info;
}

bool DescribeNetworkApplicationDetailResponse::InfoHasBeenSet() const
{
