...
string DeleteSearchViewRequest::ToJsonString() const
{
...
string DeleteSearchViewRequest::GetViewId() const
{
    return m_viewId;
}

void DeleteSearchViewRequest::SetViewId(const string& _viewId)
{
    m_viewId = _viewId;
    m_viewIdHasBeenSet = true;
}

bool DeleteSearchViewRequest::ViewIdHasBeenSet() const
{
