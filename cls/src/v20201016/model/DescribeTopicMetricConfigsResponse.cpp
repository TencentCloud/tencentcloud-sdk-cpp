...
CoreInternalOutcome DescribeTopicMetricConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeTopicMetricConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeTopicMetricConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTopicMetricConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MetricCollectConfig> DescribeTopicMetricConfigsResponse::GetDatas() const
{
    return m_datas;
}

bool DescribeTopicMetricConfigsResponse::DatasHasBeenSet() const
{
