...
RetryResourceGraphRequest::RetryResourceGraphRequest() :
    m_resourceGraphIdHasBeenSet(false)
{
}

string RetryResourceGraphRequest::ToJsonString() const
{
...
string RetryResourceGraphRequest::GetResourceGraphId() const
{
    return m_resourceGraphId;
}

void RetryResourceGraphRequest::SetResourceGraphId(const string& _resourceGraphId)
{
    m_resourceGraphId = _resourceGraphId;
    m_resourceGraphIdHasBeenSet = true;
}

bool RetryResourceGraphRequest::ResourceGraphIdHasBeenSet() const
{
