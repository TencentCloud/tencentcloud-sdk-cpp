...
DescribeResourceGraphDetailRequest::DescribeResourceGraphDetailRequest() :
    m_resourceGraphIdHasBeenSet(false)
{
}

string DescribeResourceGraphDetailRequest::ToJsonString() const
{
...
string DescribeResourceGraphDetailRequest::GetResourceGraphId() const
{
    return m_resourceGraphId;
}

void DescribeResourceGraphDetailRequest::SetResourceGraphId(const string& _resourceGraphId)
{
    m_resourceGraphId = _resourceGraphId;
    m_resourceGraphIdHasBeenSet = true;
}

bool DescribeResourceGraphDetailRequest::ResourceGraphIdHasBeenSet() const
{
