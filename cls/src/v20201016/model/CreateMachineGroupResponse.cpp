...
CoreInternalOutcome CreateMachineGroupResponse::Deserialize(const string &payload)
{
...
string CreateMachineGroupResponse::ToJsonString() const
{
...
string CreateMachineGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateMachineGroupResponse::GroupIdHasBeenSet() const
{
