...
CoreInternalOutcome OpenKafkaConsumerResponse::Deserialize(const string &payload)
{
...
string OpenKafkaConsumerResponse::ToJsonString() const
{
...
string OpenKafkaConsumerResponse::GetTopicID() const
{
    return m_topicID;
}

bool OpenKafkaConsumerResponse::TopicIDHasBeenSet() const
{
