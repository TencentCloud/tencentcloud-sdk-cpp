...
CoreInternalOutcome CreateCloudProductLogCollectionResponse::Deserialize(const string &payload)
{
...
string CreateCloudProductLogCollectionResponse::ToJsonString() const
{
...
string CreateCloudProductLogCollectionResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateCloudProductLogCollectionResponse::TopicIdHasBeenSet() const
{
    return m_topicIdHasBeenSet;
}

string CreateCloudProductLogCollectionResponse::GetTopicName() const
{
    return m_topicName;
}

bool CreateCloudProductLogCollectionResponse::TopicNameHasBeenSet() const
{
    return m_topicNameHasBeenSet;
}

string CreateCloudProductLogCollectionResponse::GetLogsetId() const
{
    return m_logsetId;
}

bool CreateCloudProductLogCollectionResponse::LogsetIdHasBeenSet() const
{
    return m_logsetIdHasBeenSet;
}

string CreateCloudProductLogCollectionResponse::GetLogsetName() const
{
    return m_logsetName;
}

bool CreateCloudProductLogCollectionResponse::LogsetNameHasBeenSet() const
{
    return m_logsetNameHasBeenSet;
}

int64_t CreateCloudProductLogCollectionResponse::GetStatus() const
{
    return m_status;
}

bool CreateCloudProductLogCollectionResponse::StatusHasBeenSet() const
{
