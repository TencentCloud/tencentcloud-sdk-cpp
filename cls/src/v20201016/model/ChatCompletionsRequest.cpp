...
vector<MetadataItem> ChatCompletionsRequest::GetMetadata() const
{
    return m_metadata;
}

void ChatCompletionsRequest::SetMetadata(const vector<MetadataItem>& _metadata)
{
    m_metadata = _metadata;
    m_metadataHasBeenSet = true;
}

bool ChatCompletionsRequest::MetadataHasBeenSet() const
{
