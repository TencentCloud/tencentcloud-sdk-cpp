...
CoreInternalOutcome DescribeDlcDeliversResponse::Deserialize(const string &payload)
{
...
string DescribeDlcDeliversResponse::ToJsonString() const
{
...
vector<DlcDeliverInfo> DescribeDlcDeliversResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeDlcDeliversResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeDlcDeliversResponse::GetTotal() const
{
    return m_total;
}

bool DescribeDlcDeliversResponse::TotalHasBeenSet() const
{
