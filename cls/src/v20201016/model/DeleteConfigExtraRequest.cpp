...
string DeleteConfigExtraRequest::ToJsonString() const
{
...
string DeleteConfigExtraRequest::GetConfigExtraId() const
{
    return m_configExtraId;
}

void DeleteConfigExtraRequest::SetConfigExtraId(const string& _configExtraId)
{
    m_configExtraId = _configExtraId;
    m_configExtraIdHasBeenSet = true;
}

bool DeleteConfigExtraRequest::ConfigExtraIdHasBeenSet() const
{
