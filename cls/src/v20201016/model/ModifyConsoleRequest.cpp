...
string ModifyConsoleRequest::ToJsonString() const
{
    ...
    if (m_consoleIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, rapidjson::Value(m_consoleId.c_str(), allocator).Move(), allocator);
    }
...
string ModifyConsoleRequest::GetConsoleId() const
{
    return m_consoleId;
}

void ModifyConsoleRequest::SetConsoleId(const string& _consoleId)
{
    m_consoleId = _consoleId;
    m_consoleIdHasBeenSet = true;
}

bool ModifyConsoleRequest::ConsoleIdHasBeenSet() const
{
    return m_consoleIdHasBeenSet;
}

vector<string> ModifyConsoleRequest::GetAccessMode() const
{
    return m_accessMode;
}

void ModifyConsoleRequest::SetAccessMode(const vector<string>& _accessMode)
{
    m_accessMode = _accessMode;
    m_accessModeHasBeenSet = true;
}

bool ModifyConsoleRequest::AccessModeHasBeenSet() const
{
    return m_accessModeHasBeenSet;
}

uint64_t ModifyConsoleRequest::GetLoginMode() const
{
    return m_loginMode;
}

void ModifyConsoleRequest::SetLoginMode(const uint64_t& _loginMode)
{
    m_loginMode = _loginMode;
    m_loginModeHasBeenSet = true;
}

bool ModifyConsoleRequest::LoginModeHasBeenSet() const
{
    return m_loginModeHasBeenSet;
}

string ModifyConsoleRequest::GetDomainPrefix() const
{
    return m_domainPrefix;
}

void ModifyConsoleRequest::SetDomainPrefix(const string& _domainPrefix)
{
    m_domainPrefix = _domainPrefix;
    m_domainPrefixHasBeenSet = true;
}

bool ModifyConsoleRequest::DomainPrefixHasBeenSet() const
{
    return m_domainPrefixHasBeenSet;
}

vector<ConsoleAccount> ModifyConsoleRequest::GetAccounts() const
{
    return m_accounts;
}

void ModifyConsoleRequest::SetAccounts(const vector<ConsoleAccount>& _accounts)
{
    m_accounts = _accounts;
    m_accountsHasBeenSet = true;
}

bool ModifyConsoleRequest::AccountsHasBeenSet() const
{
    return m_accountsHasBeenSet;
}

AnonymousLoginInfo ModifyConsoleRequest::GetAnonymousLogin() const
{
    return m_anonymousLogin;
}

void ModifyConsoleRequest::SetAnonymousLogin(const AnonymousLoginInfo& _anonymousLogin)
{
    m_anonymousLogin = _anonymousLogin;
    m_anonymousLoginHasBeenSet = true;
}

bool ModifyConsoleRequest::AnonymousLoginHasBeenSet() const
{
    return m_anonymousLoginHasBeenSet;
}

uint64_t ModifyConsoleRequest::GetIntranetType() const
{
    return m_intranetType;
}

void ModifyConsoleRequest::SetIntranetType(const uint64_t& _intranetType)
{
    m_intranetType = _intranetType;
    m_intranetTypeHasBeenSet = true;
}

bool ModifyConsoleRequest::IntranetTypeHasBeenSet() const
{
    return m_intranetTypeHasBeenSet;
}

string ModifyConsoleRequest::GetIntranetRegion() const
{
    return m_intranetRegion;
}

void ModifyConsoleRequest::SetIntranetRegion(const string& _intranetRegion)
{
    m_intranetRegion = _intranetRegion;
    m_intranetRegionHasBeenSet = true;
}

bool ModifyConsoleRequest::IntranetRegionHasBeenSet() const
{
    return m_intranetRegionHasBeenSet;
}

string ModifyConsoleRequest::GetVpcId() const
{
    return m_vpcId;
}

void ModifyConsoleRequest::SetVpcId(const string& _vpcId)
{
    m_vpcId = _vpcId;
    m_vpcIdHasBeenSet = true;
}

bool ModifyConsoleRequest::VpcIdHasBeenSet() const
{
    return m_vpcIdHasBeenSet;
}

string ModifyConsoleRequest::GetSubnetId() const
{
    return m_subnetId;
}

void ModifyConsoleRequest::SetSubnetId(const string& _subnetId)
{
    m_subnetId = _subnetId;
    m_subnetIdHasBeenSet = true;
}

bool ModifyConsoleRequest::SubnetIdHasBeenSet() const
{
    return m_subnetIdHasBeenSet;
}

vector<AuthRoleInfo> ModifyConsoleRequest::GetAuthRoles() const
{
    return m_authRoles;
}

void ModifyConsoleRequest::SetAuthRoles(const vector<AuthRoleInfo>& _authRoles)
{
    m_authRoles = _authRoles;
    m_authRolesHasBeenSet = true;
}

bool ModifyConsoleRequest::AuthRolesHasBeenSet() const
{
    return m_authRolesHasBeenSet;
}

vector<string> ModifyConsoleRequest::GetHideParams() const
{
    return m_hideParams;
}

void ModifyConsoleRequest::SetHideParams(const vector<string>& _hideParams)
{
    m_hideParams = _hideParams;
    m_hideParamsHasBeenSet = true;
}

bool ModifyConsoleRequest::HideParamsHasBeenSet() const
{
    return m_hideParamsHasBeenSet;
}

vector<AccessControlRule> ModifyConsoleRequest::GetAccessControlRules() const
{
    return m_accessControlRules;
}

void ModifyConsoleRequest::SetAccessControlRules(const vector<AccessControlRule>& _accessControlRules)
{
    m_accessControlRules = _accessControlRules;
    m_accessControlRulesHasBeenSet = true;
}

bool ModifyConsoleRequest::AccessControlRulesHasBeenSet() const
{
    return m_accessControlRulesHasBeenSet;
}

string ModifyConsoleRequest::GetRemarks() const
{
    return m_remarks;
}

void ModifyConsoleRequest::SetRemarks(const string& _remarks)
{
    m_remarks = _remarks;
    m_remarksHasBeenSet = true;
}

bool ModifyConsoleRequest::RemarksHasBeenSet() const
{
    return m_remarksHasBeenSet;
}

vector<string> ModifyConsoleRequest::GetMenus() const
{
    return m_menus;
}

void ModifyConsoleRequest::SetMenus(const vector<string>& _menus)
{
    m_menus = _menus;
    m_menusHasBeenSet = true;
}

bool ModifyConsoleRequest::MenusHasBeenSet() const
{
