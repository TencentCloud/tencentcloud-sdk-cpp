...
CoreInternalOutcome RuleKeyValueInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void RuleKeyValueInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
