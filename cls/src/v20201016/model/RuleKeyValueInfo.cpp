...
CoreInternalOutcome RuleKeyValueInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CaseSensitive") && !value["CaseSensitive"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RuleKeyValueInfo.CaseSensitive` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("KeyValues") && !value["KeyValues"].IsNull())
    {
        if (!value["KeyValues"].IsArray())
            return CoreInternalOutcome(Core::Error("response `RuleKeyValueInfo.KeyValues` is not array type"));
...
void RuleKeyValueInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
bool RuleKeyValueInfo::GetCaseSensitive() const
{
    return m_caseSensitive;
}

void RuleKeyValueInfo::SetCaseSensitive(const bool& _caseSensitive)
{
    m_caseSensitive = _caseSensitive;
    m_caseSensitiveHasBeenSet = true;
}

bool RuleKeyValueInfo::CaseSensitiveHasBeenSet() const
{
    return m_caseSensitiveHasBeenSet;
}

vector<KeyValueInfo> RuleKeyValueInfo::GetKeyValues() const
{
    return m_keyValues;
}

void RuleKeyValueInfo::SetKeyValues(const vector<KeyValueInfo>& _keyValues)
{
    m_keyValues = _keyValues;
    m_keyValuesHasBeenSet = true;
}

bool RuleKeyValueInfo::KeyValuesHasBeenSet() const
{
