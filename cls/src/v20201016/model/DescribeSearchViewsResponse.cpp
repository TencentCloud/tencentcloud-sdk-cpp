...
CoreInternalOutcome DescribeSearchViewsResponse::Deserialize(const string &payload)
{
...
string DescribeSearchViewsResponse::ToJsonString() const
{
...
vector<SearchViewInfo> DescribeSearchViewsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeSearchViewsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeSearchViewsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSearchViewsResponse::TotalHasBeenSet() const
{
