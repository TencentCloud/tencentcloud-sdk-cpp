...
string DescribeKafkaConsumerRequest::ToJsonString() const
{
...
string DescribeKafkaConsumerRequest::GetFromTopicId() const
{
    return m_fromTopicId;
}

void DescribeKafkaConsumerRequest::SetFromTopicId(const string& _fromTopicId)
{
    m_fromTopicId = _fromTopicId;
    m_fromTopicIdHasBeenSet = true;
}

bool DescribeKafkaConsumerRequest::FromTopicIdHasBeenSet() const
{
