...
CoreInternalOutcome DescribeCloudProductLogTasksResponse::Deserialize(const string &payload)
{
...
string DescribeCloudProductLogTasksResponse::ToJsonString() const
{
...
vector<CloudProductLogTaskInfo> DescribeCloudProductLogTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeCloudProductLogTasksResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

uint64_t DescribeCloudProductLogTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}
