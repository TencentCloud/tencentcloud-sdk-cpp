...
CoreInternalOutcome DescribeConsoleSharingListResponse::Deserialize(const string &payload)
{
...
string DescribeConsoleSharingListResponse::ToJsonString() const
{
...
uint64_t DescribeConsoleSharingListResponse::GetTotalCount() const
{
    return m_totalCount;
}
