...
CoreInternalOutcome DescribeSplunkDeliversResponse::Deserialize(const string &payload)
{
...
string DescribeSplunkDeliversResponse::ToJsonString() const
{
...
vector<SplunkDeliverInfo> DescribeSplunkDeliversResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeSplunkDeliversResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeSplunkDeliversResponse::GetTotal() const
{
    return m_total;
}

bool DescribeSplunkDeliversResponse::TotalHasBeenSet() const
{
