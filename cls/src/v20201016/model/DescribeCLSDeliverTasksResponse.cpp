...
DescribeCLSDeliverTasksResponse::DescribeCLSDeliverTasksResponse() :
    m_infosHasBeenSet(false),
    m_totalHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCLSDeliverTasksResponse::Deserialize(const string &payload)
{
...
string DescribeCLSDeliverTasksResponse::ToJsonString() const
{
...
vector<CLSDeliverTaskInfo> DescribeCLSDeliverTasksResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeCLSDeliverTasksResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeCLSDeliverTasksResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCLSDeliverTasksResponse::TotalHasBeenSet() const
{
