...
CoreInternalOutcome DescribeClusterMetricConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeClusterMetricConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeClusterMetricConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterMetricConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MetricCollectConfig> DescribeClusterMetricConfigsResponse::GetDatas() const
{
    return m_datas;
}

bool DescribeClusterMetricConfigsResponse::DatasHasBeenSet() const
{
