...
CoreInternalOutcome DescribeNetworkApplicationsResponse::Deserialize(const string &payload)
{
...
string DescribeNetworkApplicationsResponse::ToJsonString() const
{
...
vector<NetworkApplicationInfo> DescribeNetworkApplicationsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeNetworkApplicationsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeNetworkApplicationsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeNetworkApplicationsResponse::TotalHasBeenSet() const
{
