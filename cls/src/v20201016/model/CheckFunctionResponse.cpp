...
CoreInternalOutcome CheckFunctionResponse::Deserialize(const string &payload)
{
...
string CheckFunctionResponse::ToJsonString() const
{
...
int64_t CheckFunctionResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool CheckFunctionResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string CheckFunctionResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool CheckFunctionResponse::ErrorMsgHasBeenSet() const
{
