...
CoreInternalOutcome DescribeResourceGraphEntitiesResponse::Deserialize(const string &payload)
{
...
string DescribeResourceGraphEntitiesResponse::ToJsonString() const
{
...
bool DescribeResourceGraphEntitiesResponse::NextCursorHasBeenSet() const
{
