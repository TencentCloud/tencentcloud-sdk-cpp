...
string DescribeNetworkApplicationDetailRequest::ToJsonString() const
{
...
string DescribeNetworkApplicationDetailRequest::GetNetworkAppId() const
{
    return m_networkAppId;
}

void DescribeNetworkApplicationDetailRequest::SetNetworkAppId(const string& _networkAppId)
{
    m_networkAppId = _networkAppId;
    m_networkAppIdHasBeenSet = true;
}

bool DescribeNetworkApplicationDetailRequest::NetworkAppIdHasBeenSet() const
{
