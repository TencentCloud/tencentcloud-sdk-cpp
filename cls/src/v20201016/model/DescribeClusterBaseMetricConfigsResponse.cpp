...
CoreInternalOutcome DescribeClusterBaseMetricConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeClusterBaseMetricConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeClusterBaseMetricConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterBaseMetricConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<BaseMetricCollectConfig> DescribeClusterBaseMetricConfigsResponse::GetDatas() const
{
    return m_datas;
}

bool DescribeClusterBaseMetricConfigsResponse::DatasHasBeenSet() const
{
