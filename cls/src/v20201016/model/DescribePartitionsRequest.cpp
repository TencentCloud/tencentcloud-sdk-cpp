...
string DescribePartitionsRequest::GetTopicId() const
{
    return m_topicId;
}

void DescribePartitionsRequest::SetTopicId(const string& _topicId)
{
    m_topicId = _topicId;
    m_topicIdHasBeenSet = true;
}

bool DescribePartitionsRequest::TopicIdHasBeenSet() const
{
