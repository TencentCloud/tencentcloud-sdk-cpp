...
vector<Filter> DescribeAlarmsRequest::GetFilters() const
{
    return m_filters;
}

void DescribeAlarmsRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeAlarmsRequest::FiltersHasBeenSet() const
{
