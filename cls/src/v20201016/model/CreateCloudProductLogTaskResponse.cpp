...
#include <tencentcloud/cls/v20201016/model/CreateCloudProductLogTaskResponse.h>
...
CreateCloudProductLogTaskResponse::CreateCloudProductLogTaskResponse() :
...
CoreInternalOutcome CreateCloudProductLogTaskResponse::Deserialize(const string &payload)
{
...
string CreateCloudProductLogTaskResponse::ToJsonString() const
{
...
string CreateCloudProductLogTaskResponse::GetTopicId() const
{
    return m_topicId;
}

bool CreateCloudProductLogTaskResponse::TopicIdHasBeenSet() const
{
    return m_topicIdHasBeenSet;
}

string CreateCloudProductLogTaskResponse::GetTopicName() const
{
    return m_topicName;
}

bool CreateCloudProductLogTaskResponse::TopicNameHasBeenSet() const
{
    return m_topicNameHasBeenSet;
}

string CreateCloudProductLogTaskResponse::GetLogsetId() const
{
    return m_logsetId;
}

bool CreateCloudProductLogTaskResponse::LogsetIdHasBeenSet() const
{
    return m_logsetIdHasBeenSet;
}

string CreateCloudProductLogTaskResponse::GetLogsetName() const
{
    return m_logsetName;
}

bool CreateCloudProductLogTaskResponse::LogsetNameHasBeenSet() const
{
