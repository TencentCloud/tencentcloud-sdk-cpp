...
CoreInternalOutcome MergePartitionResponse::Deserialize(const string &payload)
{
...
string MergePartitionResponse::ToJsonString() const
{
...
vector<PartitionInfo> MergePartitionResponse::GetPartitions() const
{
    return m_partitions;
}

bool MergePartitionResponse::PartitionsHasBeenSet() const
{
