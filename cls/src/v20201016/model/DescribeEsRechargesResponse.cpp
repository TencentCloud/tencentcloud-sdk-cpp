...
CoreInternalOutcome DescribeEsRechargesResponse::Deserialize(const string &payload)
{
...
string DescribeEsRechargesResponse::ToJsonString() const
{
...
uint64_t DescribeEsRechargesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeEsRechargesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EsRechargeInfo> DescribeEsRechargesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeEsRechargesResponse::InfosHasBeenSet() const
{
