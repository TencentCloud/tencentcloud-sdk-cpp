...
vector<ConfigInfo> DescribeConfigsResponse::GetConfigs() const
{
    return m_configs;
}

bool DescribeConfigsResponse::ConfigsHasBeenSet() const
{
    return m_configsHasBeenSet;
}

int64_t DescribeConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeConfigsResponse::TotalCountHasBeenSet() const
{
