...
CoreInternalOutcome DescribeKafkaConsumerPreviewResponse::Deserialize(const string &payload)
{
...
string DescribeKafkaConsumerPreviewResponse::ToJsonString() const
{
