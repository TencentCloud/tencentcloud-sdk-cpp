...
DescribeS3RechargesResponse::DescribeS3RechargesResponse() :
    m_infosHasBeenSet(false),
    m_totalHasBeenSet(false)
{
}

CoreInternalOutcome DescribeS3RechargesResponse::Deserialize(const string &payload)
{
...
string DescribeS3RechargesResponse::ToJsonString() const
{
...
vector<S3RechargeInfo> DescribeS3RechargesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeS3RechargesResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeS3RechargesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeS3RechargesResponse::TotalHasBeenSet() const
{
