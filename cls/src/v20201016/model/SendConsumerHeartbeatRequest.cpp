...
string SendConsumerHeartbeatRequest::ToJsonString() const
{
...
string SendConsumerHeartbeatRequest::GetConsumerGroup() const
{
    return m_consumerGroup;
}

void SendConsumerHeartbeatRequest::SetConsumerGroup(const string& _consumerGroup)
{
    m_consumerGroup = _consumerGroup;
    m_consumerGroupHasBeenSet = true;
}

bool SendConsumerHeartbeatRequest::ConsumerGroupHasBeenSet() const
{
    return m_consumerGroupHasBeenSet;
}

string SendConsumerHeartbeatRequest::GetConsumer() const
{
    return m_consumer;
}

void SendConsumerHeartbeatRequest::SetConsumer(const string& _consumer)
{
    m_consumer = _consumer;
    m_consumerHasBeenSet = true;
}

bool SendConsumerHeartbeatRequest::ConsumerHasBeenSet() const
{
    return m_consumerHasBeenSet;
}

string SendConsumerHeartbeatRequest::GetLogsetId() const
{
    return m_logsetId;
}

void SendConsumerHeartbeatRequest::SetLogsetId(const string& _logsetId)
{
    m_logsetId = _logsetId;
    m_logsetIdHasBeenSet = true;
}

bool SendConsumerHeartbeatRequest::LogsetIdHasBeenSet() const
{
    return m_logsetIdHasBeenSet;
}

vector<TopicPartitionInfo> SendConsumerHeartbeatRequest::GetTopicPartitionsInfo() const
{
    return m_topicPartitionsInfo;
}

void SendConsumerHeartbeatRequest::SetTopicPartitionsInfo(const vector<TopicPartitionInfo>& _topicPartitionsInfo)
{
    m_topicPartitionsInfo = _topicPartitionsInfo;
    m_topicPartitionsInfoHasBeenSet = true;
}

bool SendConsumerHeartbeatRequest::TopicPartitionsInfoHasBeenSet() const
{
