...
CoreInternalOutcome DescribeTopicsResponse::Deserialize(const string &payload)
{
...
string DescribeTopicsResponse::ToJsonString() const
{
...
vector<TopicInfo> DescribeTopicsResponse::GetTopics() const
{
    return m_topics;
}

bool DescribeTopicsResponse::TopicsHasBeenSet() const
{
    return m_topicsHasBeenSet;
}

int64_t DescribeTopicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTopicsResponse::TotalCountHasBeenSet() const
{
