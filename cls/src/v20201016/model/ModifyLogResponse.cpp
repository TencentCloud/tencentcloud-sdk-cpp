...
CoreInternalOutcome ModifyLogResponse::Deserialize(const string &payload)
{
...
string ModifyLogResponse::ToJsonString() const
{
...
int64_t ModifyLogResponse::GetAffectedRows() const
{
    return m_affectedRows;
}

bool ModifyLogResponse::AffectedRowsHasBeenSet() const
{
