...
DeleteLogResponse::DeleteLogResponse() :
    m_affectedRowsHasBeenSet(false)
{
}

CoreInternalOutcome DeleteLogResponse::Deserialize(const string &payload)
{
...
string DeleteLogResponse::ToJsonString() const
{
...
int64_t DeleteLogResponse::GetAffectedRows() const
{
    return m_affectedRows;
}

bool DeleteLogResponse::AffectedRowsHasBeenSet() const
{
