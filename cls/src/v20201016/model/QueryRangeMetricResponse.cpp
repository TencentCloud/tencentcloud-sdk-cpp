...
CoreInternalOutcome QueryRangeMetricResponse::Deserialize(const string &payload)
{
...
string QueryRangeMetricResponse::ToJsonString() const
{
...
string QueryRangeMetricResponse::GetResultType() const
{
    return m_resultType;
}

bool QueryRangeMetricResponse::ResultTypeHasBeenSet() const
{
    return m_resultTypeHasBeenSet;
}

string QueryRangeMetricResponse::GetResult() const
{
    return m_result;
}

bool QueryRangeMetricResponse::ResultHasBeenSet() const
{
