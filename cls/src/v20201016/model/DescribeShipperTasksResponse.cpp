...
CoreInternalOutcome DescribeShipperTasksResponse::Deserialize(const string &payload)
{
...
string DescribeShipperTasksResponse::ToJsonString() const
{
...
vector<ShipperTaskInfo> DescribeShipperTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeShipperTasksResponse::TasksHasBeenSet() const
{
