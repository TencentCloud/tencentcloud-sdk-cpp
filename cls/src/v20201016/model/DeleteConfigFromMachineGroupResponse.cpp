...
CoreInternalOutcome DeleteConfigFromMachineGroupResponse::Deserialize(const string &payload)
{
...
string DeleteConfigFromMachineGroupResponse::ToJsonString() const
{
