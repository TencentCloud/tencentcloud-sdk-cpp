...
string CreateAlarmShieldRequest::GetAlarmNoticeId() const
{
    return m_alarmNoticeId;
}

void CreateAlarmShieldRequest::SetAlarmNoticeId(const string& _alarmNoticeId)
{
    m_alarmNoticeId = _alarmNoticeId;
    m_alarmNoticeIdHasBeenSet = true;
}

bool CreateAlarmShieldRequest::AlarmNoticeIdHasBeenSet() const
{
...
uint64_t CreateAlarmShieldRequest::GetType() const
{
    return m_type;
}

void CreateAlarmShieldRequest::SetType(const uint64_t& _type)
{
    m_type = _type;
    m_typeHasBeenSet = true;
}

bool CreateAlarmShieldRequest::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string CreateAlarmShieldRequest::GetReason() const
{
    return m_reason;
}

void CreateAlarmShieldRequest::SetReason(const string& _reason)
{
    m_reason = _reason;
    m_reasonHasBeenSet = true;
}

bool CreateAlarmShieldRequest::ReasonHasBeenSet() const
{
    return m_reasonHasBeenSet;
}

string CreateAlarmShieldRequest::GetRule() const
{
    return m_rule;
}

void CreateAlarmShieldRequest::SetRule(const string& _rule)
{
    m_rule = _rule;
    m_ruleHasBeenSet = true;
}

bool CreateAlarmShieldRequest::RuleHasBeenSet() const
{
