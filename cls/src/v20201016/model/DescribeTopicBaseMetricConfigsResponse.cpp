...
CoreInternalOutcome DescribeTopicBaseMetricConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeTopicBaseMetricConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeTopicBaseMetricConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTopicBaseMetricConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<BaseMetricCollectConfig> DescribeTopicBaseMetricConfigsResponse::GetDatas() const
{
    return m_datas;
}

bool DescribeTopicBaseMetricConfigsResponse::DatasHasBeenSet() const
{
