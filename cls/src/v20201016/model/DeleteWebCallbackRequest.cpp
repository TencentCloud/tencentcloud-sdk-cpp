...
string DeleteWebCallbackRequest::ToJsonString() const
{
...
string DeleteWebCallbackRequest::GetWebCallbackId() const
{
    return m_webCallbackId;
}

void DeleteWebCallbackRequest::SetWebCallbackId(const string& _webCallbackId)
{
    m_webCallbackId = _webCallbackId;
    m_webCallbackIdHasBeenSet = true;
}

bool DeleteWebCallbackRequest::WebCallbackIdHasBeenSet() const
{
