...
DeleteResourceGraphRequest::DeleteResourceGraphRequest() :
    m_resourceGraphIdHasBeenSet(false)
{
}

string DeleteResourceGraphRequest::ToJsonString() const
{
...
string DeleteResourceGraphRequest::GetResourceGraphId() const
{
    return m_resourceGraphId;
}

void DeleteResourceGraphRequest::SetResourceGraphId(const string& _resourceGraphId)
{
    m_resourceGraphId = _resourceGraphId;
    m_resourceGraphIdHasBeenSet = true;
}

bool DeleteResourceGraphRequest::ResourceGraphIdHasBeenSet() const
{
