...
CoreInternalOutcome MachineGroupTypeInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void MachineGroupTypeInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
