...
CoreInternalOutcome DescribeHostMetricConfigsResponse::Deserialize(const string &payload)
{
...
string DescribeHostMetricConfigsResponse::ToJsonString() const
{
...
uint64_t DescribeHostMetricConfigsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHostMetricConfigsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<HostMetricConfig> DescribeHostMetricConfigsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeHostMetricConfigsResponse::InfosHasBeenSet() const
{
