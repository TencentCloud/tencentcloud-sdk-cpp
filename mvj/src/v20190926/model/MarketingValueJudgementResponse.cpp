...
string MarketingValueJudgementResponse::ToJsonString() const
{
...
Data MarketingValueJudgementResponse::GetData() const
{
    return m_data;
}

bool MarketingValueJudgementResponse::DataHasBeenSet() const
{
