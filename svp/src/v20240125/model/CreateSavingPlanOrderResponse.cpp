...
CreateSavingPlanOrderResponse::CreateSavingPlanOrderResponse() :
    m_bigDealIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateSavingPlanOrderResponse::Deserialize(const string &payload)
{
...
string CreateSavingPlanOrderResponse::ToJsonString() const
{
...
string CreateSavingPlanOrderResponse::GetBigDealId() const
{
    return m_bigDealId;
}

bool CreateSavingPlanOrderResponse::BigDealIdHasBeenSet() const
{
