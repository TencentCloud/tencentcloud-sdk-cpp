...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_GLOSSARYENTRYINPUT_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_GLOSSARYENTRYINPUT_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                * 新建术语条目项
                */
                class GlossaryEntryInput : public AbstractModel
                {
                public:
                    GlossaryEntryInput();
                    ~GlossaryEntryInput() = default;
                    ...
                    /**
                     * 获取源语言术语。最大 1000 字符。
                     * @return SourceTerm 源语言术语。最大 1000 字符。
                     * 
                     */
                    ...
                    /**
                     * 获取目标语言术语。最大 1000 字符。
                     * @return TargetTerm 目标语言术语。最大 1000 字符。
                     * 
                     */
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_GLOSSARYENTRYINPUT_H_
