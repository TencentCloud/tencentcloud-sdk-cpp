...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DELETETOKENPLANAPIKEYREQUEST_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DELETETOKENPLANAPIKEYREQUEST_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                */
                class DeleteTokenPlanApiKeyRequest : public AbstractModel
                {
                public:
                    DeleteTokenPlanApiKeyRequest();
                    ~DeleteTokenPlanApiKeyRequest() = default;
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DELETETOKENPLANAPIKEYREQUEST_H_
