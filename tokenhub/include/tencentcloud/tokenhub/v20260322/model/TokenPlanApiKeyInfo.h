...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_TOKENPLANAPIKEYINFO_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_TOKENPLANAPIKEYINFO_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                */
                class TokenPlanApiKeyInfo : public AbstractModel
                {
                public:
                    TokenPlanApiKeyInfo();
                    ~TokenPlanApiKeyInfo() = default;
                    ...
                    /**
                     * 获取TPM 限制（Tokens Per Minute）。
                     * @return TPM TPM 限制（Tokens Per Minute）。
                     * 
                     */
                    int64_t GetTPM() const;

                    /**
                     * 设置TPM 限制（Tokens Per Minute）。
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_TOKENPLANAPIKEYINFO_H_
