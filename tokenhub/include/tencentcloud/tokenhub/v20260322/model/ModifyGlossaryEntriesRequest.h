...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYGLOSSARYENTRIESREQUEST_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYGLOSSARYENTRIESREQUEST_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                */
                class ModifyGlossaryEntriesRequest : public AbstractModel
                {
                public:
                    ModifyGlossaryEntriesRequest();
                    ~ModifyGlossaryEntriesRequest() = default;
                    ...
                    /**
                     * 获取术语条目列表。单次最多 200 个。
                     * @return Entries 术语条目列表。单次最多 200 个。
                     * 
                     */
                    std::vector<ModifyGlossaryEntryInput> GetEntries() const;
                     ...
                     * 
                     */
                    void SetEntries(const std::vector<ModifyGlossaryEntryInput>& _entries);
                ...
                private:
                     ...
                     * 术语条目列表。单次最多 200 个。
                     */
                    std::vector<ModifyGlossaryEntryInput> m_entries;
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYGLOSSARYENTRIESREQUEST_H_
