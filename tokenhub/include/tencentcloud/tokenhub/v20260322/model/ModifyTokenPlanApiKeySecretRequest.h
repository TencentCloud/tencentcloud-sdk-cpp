...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYTOKENPLANAPIKEYSECRETREQUEST_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYTOKENPLANAPIKEYSECRETREQUEST_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                */
                class ModifyTokenPlanApiKeySecretRequest : public AbstractModel
                {
                public:
                    ModifyTokenPlanApiKeySecretRequest();
                    ~ModifyTokenPlanApiKeySecretRequest() = default;
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_MODIFYTOKENPLANAPIKEYSECRETREQUEST_H_
