...
string DescribeEndpointRequest::ToJsonString() const
{
...
string DescribeEndpointRequest::GetEndpointId() const
{
    return m_endpointId;
}

void DescribeEndpointRequest::SetEndpointId(const string& _endpointId)
{
    m_endpointId = _endpointId;
    m_endpointIdHasBeenSet = true;
}

bool DescribeEndpointRequest::EndpointIdHasBeenSet() const
{
