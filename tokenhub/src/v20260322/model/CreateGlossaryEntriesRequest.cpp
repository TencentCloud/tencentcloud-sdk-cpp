...
string CreateGlossaryEntriesRequest::ToJsonString() const
{
...
string CreateGlossaryEntriesRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void CreateGlossaryEntriesRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool CreateGlossaryEntriesRequest::GlossaryIdHasBeenSet() const
{
    return m_glossaryIdHasBeenSet;
}

vector<GlossaryEntryInput> CreateGlossaryEntriesRequest::GetEntries() const
{
    return m_entries;
}

void CreateGlossaryEntriesRequest::SetEntries(const vector<GlossaryEntryInput>& _entries)
{
    m_entries = _entries;
    m_entriesHasBeenSet = true;
}

bool CreateGlossaryEntriesRequest::EntriesHasBeenSet() const
{
