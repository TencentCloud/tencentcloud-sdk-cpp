...
string DeleteGlossaryEntriesRequest::ToJsonString() const
{
...
string DeleteGlossaryEntriesRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void DeleteGlossaryEntriesRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool DeleteGlossaryEntriesRequest::GlossaryIdHasBeenSet() const
{
    return m_glossaryIdHasBeenSet;
}

vector<DeleteGlossaryEntryInput> DeleteGlossaryEntriesRequest::GetEntries() const
{
    return m_entries;
}

void DeleteGlossaryEntriesRequest::SetEntries(const vector<DeleteGlossaryEntryInput>& _entries)
{
    m_entries = _entries;
    m_entriesHasBeenSet = true;
}

bool DeleteGlossaryEntriesRequest::EntriesHasBeenSet() const
{
