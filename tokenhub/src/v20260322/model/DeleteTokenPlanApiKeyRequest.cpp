...
string DeleteTokenPlanApiKeyRequest::ToJsonString() const
{
...
string DeleteTokenPlanApiKeyRequest::GetApiKeyId() const
{
    return m_apiKeyId;
}

void DeleteTokenPlanApiKeyRequest::SetApiKeyId(const string& _apiKeyId)
{
    m_apiKeyId = _apiKeyId;
    m_apiKeyIdHasBeenSet = true;
}

bool DeleteTokenPlanApiKeyRequest::ApiKeyIdHasBeenSet() const
{
