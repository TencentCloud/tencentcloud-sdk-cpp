...
string ModifyGlossaryEntriesRequest::ToJsonString() const
{
...
string ModifyGlossaryEntriesRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void ModifyGlossaryEntriesRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool ModifyGlossaryEntriesRequest::GlossaryIdHasBeenSet() const
{
    return m_glossaryIdHasBeenSet;
}

vector<ModifyGlossaryEntryInput> ModifyGlossaryEntriesRequest::GetEntries() const
{
    return m_entries;
}

void ModifyGlossaryEntriesRequest::SetEntries(const vector<ModifyGlossaryEntryInput>& _entries)
{
    m_entries = _entries;
    m_entriesHasBeenSet = true;
}

bool ModifyGlossaryEntriesRequest::EntriesHasBeenSet() const
{
