...
CoreInternalOutcome ModifyGlossaryEntriesResponse::Deserialize(const string &payload)
{
...
string ModifyGlossaryEntriesResponse::ToJsonString() const
{
...
vector<GlossaryEntryItem> ModifyGlossaryEntriesResponse::GetEntries() const
{
    return m_entries;
}

bool ModifyGlossaryEntriesResponse::EntriesHasBeenSet() const
{
