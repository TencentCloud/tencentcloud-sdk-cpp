...
CoreInternalOutcome CreateGlossaryEntriesResponse::Deserialize(const string &payload)
{
...
string CreateGlossaryEntriesResponse::ToJsonString() const
{
...
vector<GlossaryEntryItem> CreateGlossaryEntriesResponse::GetEntries() const
{
    return m_entries;
}

bool CreateGlossaryEntriesResponse::EntriesHasBeenSet() const
{
