...
CoreInternalOutcome DescribeGlossaryEntriesResponse::Deserialize(const string &payload)
{
...
string DescribeGlossaryEntriesResponse::ToJsonString() const
{
...
vector<GlossaryEntryItem> DescribeGlossaryEntriesResponse::GetEntries() const
{
    return m_entries;
}

bool DescribeGlossaryEntriesResponse::EntriesHasBeenSet() const
{
    return m_entriesHasBeenSet;
}

int64_t DescribeGlossaryEntriesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeGlossaryEntriesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t DescribeGlossaryEntriesResponse::GetPage() const
{
    return m_page;
}

bool DescribeGlossaryEntriesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t DescribeGlossaryEntriesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeGlossaryEntriesResponse::PageSizeHasBeenSet() const
{
