...
CoreInternalOutcome DescribeEndpointResponse::Deserialize(const string &payload)
{
...
string DescribeEndpointResponse::ToJsonString() const
{
...
EndpointDetail DescribeEndpointResponse::GetEndpoint() const
{
    return m_endpoint;
}

bool DescribeEndpointResponse::EndpointHasBeenSet() const
{
