...
string DeleteGlossaryRequest::ToJsonString() const
{
...
string DeleteGlossaryRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void DeleteGlossaryRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool DeleteGlossaryRequest::GlossaryIdHasBeenSet() const
{
