...
vector<Device> GetDevicesResponse::GetDevices() const
{
    return m_devices;
}

bool GetDevicesResponse::DevicesHasBeenSet() const
{
    return m_devicesHasBeenSet;
}

int64_t GetDevicesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool GetDevicesResponse::TotalCountHasBeenSet() const
{
