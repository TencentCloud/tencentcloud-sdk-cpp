...
DescribeAnnotationTasksResponse::DescribeAnnotationTasksResponse() :
...
CoreInternalOutcome DescribeAnnotationTasksResponse::Deserialize(const string &payload)
{
...
string DescribeAnnotationTasksResponse::ToJsonString() const
{
...
string DescribeAnnotationTasksResponse::GetJobId() const
{
    return m_jobId;
}

bool DescribeAnnotationTasksResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

int64_t DescribeAnnotationTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAnnotationTasksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

int64_t DescribeAnnotationTasksResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeAnnotationTasksResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeAnnotationTasksResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeAnnotationTasksResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<Task> DescribeAnnotationTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeAnnotationTasksResponse::TasksHasBeenSet() const
{
