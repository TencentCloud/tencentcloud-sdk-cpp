...
ModifyCallbackUrlResponse::ModifyCallbackUrlResponse() :
    m_codeHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyCallbackUrlResponse::Deserialize(const string &payload)
{
...
string ModifyCallbackUrlResponse::ToJsonString() const
{
...
int64_t ModifyCallbackUrlResponse::GetCode() const
{
    return m_code;
}

bool ModifyCallbackUrlResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string ModifyCallbackUrlResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyCallbackUrlResponse::MsgHasBeenSet() const
{
