...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_CREATEWECHATOFFICIALACCOUNTREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_CREATEWECHATOFFICIALACCOUNTREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class CreateWechatOfficialAccountRequest : public AbstractModel
                {
                public:
                    CreateWechatOfficialAccountRequest();
                    ~CreateWechatOfficialAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_CREATEWECHATOFFICIALACCOUNTREQUEST_H_
