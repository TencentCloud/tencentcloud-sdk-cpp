...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEENTERPRISESREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEENTERPRISESREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeEnterprisesRequest : public AbstractModel
                {
                public:
                    DescribeEnterprisesRequest();
                    ~DescribeEnterprisesRequest() = default;
                    ...
                    /**
                     * 获取是否展示统计数据
                     * @return IsShowStatistics 是否展示统计数据
                     * 
                     */
                    bool GetIsShowStatistics() const;
                     ...
                     * 
                     */
                    void SetIsShowStatistics(const bool& _isShowStatistics);

                    /**
                     * 判断参数 IsShowStatistics 是否已赋值
                     * @return IsShowStatistics 是否已赋值
                     * 
                     */
                    bool IsShowStatisticsHasBeenSet() const;
                ...
                private:
                     ...
                     * 是否展示统计数据
                     */
                    bool m_isShowStatistics;
                    bool m_isShowStatisticsHasBeenSet;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEENTERPRISESREQUEST_H_
