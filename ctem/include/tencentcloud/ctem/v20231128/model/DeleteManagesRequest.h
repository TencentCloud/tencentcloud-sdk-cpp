...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEMANAGESREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEMANAGESREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DeleteManagesRequest : public AbstractModel
                {
                public:
                    DeleteManagesRequest();
                    ~DeleteManagesRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEMANAGESREQUEST_H_
