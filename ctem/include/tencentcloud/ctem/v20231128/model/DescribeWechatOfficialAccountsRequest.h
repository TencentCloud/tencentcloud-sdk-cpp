...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATOFFICIALACCOUNTSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATOFFICIALACCOUNTSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeWechatOfficialAccountsRequest : public AbstractModel
                {
                public:
                    DescribeWechatOfficialAccountsRequest();
                    ~DescribeWechatOfficialAccountsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATOFFICIALACCOUNTSREQUEST_H_
