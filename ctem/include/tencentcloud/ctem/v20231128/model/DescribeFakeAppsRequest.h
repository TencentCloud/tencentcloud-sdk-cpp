...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEAPPSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEAPPSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeFakeAppsRequest : public AbstractModel
                {
                public:
                    DescribeFakeAppsRequest();
                    ~DescribeFakeAppsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEAPPSREQUEST_H_
