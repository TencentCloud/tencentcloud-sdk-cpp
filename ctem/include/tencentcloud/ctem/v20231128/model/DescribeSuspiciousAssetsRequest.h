...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUSPICIOUSASSETSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUSPICIOUSASSETSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeSuspiciousAssetsRequest : public AbstractModel
                {
                public:
                    DescribeSuspiciousAssetsRequest();
                    ~DescribeSuspiciousAssetsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUSPICIOUSASSETSREQUEST_H_
