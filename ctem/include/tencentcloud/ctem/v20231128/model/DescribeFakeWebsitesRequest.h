...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWEBSITESREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWEBSITESREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeFakeWebsitesRequest : public AbstractModel
                {
                public:
                    DescribeFakeWebsitesRequest();
                    ~DescribeFakeWebsitesRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWEBSITESREQUEST_H_
