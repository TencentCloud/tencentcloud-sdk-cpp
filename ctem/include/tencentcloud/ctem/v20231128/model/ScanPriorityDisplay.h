...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_SCANPRIORITYDISPLAY_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_SCANPRIORITYDISPLAY_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                * 优先级出参
                */
                class ScanPriorityDisplay : public AbstractModel
                {
                public:
                    ScanPriorityDisplay();
                    ~ScanPriorityDisplay() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_SCANPRIORITYDISPLAY_H_
