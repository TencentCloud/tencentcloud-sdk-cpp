...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEMANAGESREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEMANAGESREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeManagesRequest : public AbstractModel
                {
                public:
                    DescribeManagesRequest();
                    ~DescribeManagesRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEMANAGESREQUEST_H_
