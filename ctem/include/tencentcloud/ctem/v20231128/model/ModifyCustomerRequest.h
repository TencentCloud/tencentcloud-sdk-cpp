...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_MODIFYCUSTOMERREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_MODIFYCUSTOMERREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomerRequest : public AbstractModel
                {
                public:
                    ModifyCustomerRequest();
                    ~ModifyCustomerRequest() = default;
                    ...
                    /**
                     * 获取<p>是否包含完整的扫描</p>
                     * @return IsIncludeFullScan <p>是否包含完整的扫描</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_MODIFYCUSTOMERREQUEST_H_
