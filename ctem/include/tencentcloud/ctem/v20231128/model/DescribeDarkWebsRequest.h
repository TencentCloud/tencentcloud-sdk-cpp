...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEDARKWEBSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEDARKWEBSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeDarkWebsRequest : public AbstractModel
                {
                public:
                    DescribeDarkWebsRequest();
                    ~DescribeDarkWebsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEDARKWEBSREQUEST_H_
