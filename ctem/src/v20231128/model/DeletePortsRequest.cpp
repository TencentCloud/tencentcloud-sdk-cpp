...
DeletePortsRequest::DeletePortsRequest() :
...
string DeletePortsRequest::ToJsonString() const
{
...
vector<int64_t> DeletePortsRequest::GetIds() const
{
    return m_ids;
}

void DeletePortsRequest::SetIds(const vector<int64_t>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool DeletePortsRequest::IdsHasBeenSet() const
{
    return m_idsHasBeenSet;
}

vector<int64_t> DeletePortsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DeletePortsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DeletePortsRequest::CustomerIdListHasBeenSet() const
{
    return m_customerIdListHasBeenSet;
}

bool DeletePortsRequest::GetIsAggregation() const
{
    return m_isAggregation;
}

void DeletePortsRequest::SetIsAggregation(const bool& _isAggregation)
{
    m_isAggregation = _isAggregation;
    m_isAggregationHasBeenSet = true;
}

bool DeletePortsRequest::IsAggregationHasBeenSet() const
{
