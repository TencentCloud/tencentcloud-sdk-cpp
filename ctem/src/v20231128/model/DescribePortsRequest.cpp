...
vector<int64_t> DescribePortsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribePortsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribePortsRequest::CustomerIdListHasBeenSet() const
{
    return m_customerIdListHasBeenSet;
}

bool DescribePortsRequest::GetIsAggregation() const
{
    return m_isAggregation;
}

void DescribePortsRequest::SetIsAggregation(const bool& _isAggregation)
{
    m_isAggregation = _isAggregation;
    m_isAggregationHasBeenSet = true;
}

bool DescribePortsRequest::IsAggregationHasBeenSet() const
{
    return m_isAggregationHasBeenSet;
}

bool DescribePortsRequest::GetIsNew() const
{
    return m_isNew;
}

void DescribePortsRequest::SetIsNew(const bool& _isNew)
{
    m_isNew = _isNew;
    m_isNewHasBeenSet = true;
}

bool DescribePortsRequest::IsNewHasBeenSet() const
{
    return m_isNewHasBeenSet;
}

int64_t DescribePortsRequest::GetCustomerId() const
{
    return m_customerId;
}

void DescribePortsRequest::SetCustomerId(const int64_t& _customerId)
{
    m_customerId = _customerId;
    m_customerIdHasBeenSet = true;
}

bool DescribePortsRequest::CustomerIdHasBeenSet() const
{
    return m_customerIdHasBeenSet;
}

uint64_t DescribePortsRequest::GetLimit() const
{
    return m_limit;
}

void DescribePortsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribePortsRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

uint64_t DescribePortsRequest::GetOffset() const
{
    return m_offset;
}

void DescribePortsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribePortsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

vector<string> DescribePortsRequest::GetEnterpriseUidList() const
{
    return m_enterpriseUidList;
}

void DescribePortsRequest::SetEnterpriseUidList(const vector<string>& _enterpriseUidList)
{
    m_enterpriseUidList = _enterpriseUidList;
    m_enterpriseUidListHasBeenSet = true;
}

bool DescribePortsRequest::EnterpriseUidListHasBeenSet() const
{
    return m_enterpriseUidListHasBeenSet;
}

string DescribePortsRequest::GetFormat() const
{
    return m_format;
}

void DescribePortsRequest::SetFormat(const string& _format)
{
    m_format = _format;
    m_formatHasBeenSet = true;
}

bool DescribePortsRequest::FormatHasBeenSet() const
{
    return m_formatHasBeenSet;
}

string DescribePortsRequest::GetCreateAtStart() const
{
    return m_createAtStart;
}

void DescribePortsRequest::SetCreateAtStart(const string& _createAtStart)
{
    m_createAtStart = _createAtStart;
    m_createAtStartHasBeenSet = true;
}

bool DescribePortsRequest::CreateAtStartHasBeenSet() const
{
    return m_createAtStartHasBeenSet;
}

string DescribePortsRequest::GetCreateAtEnd() const
{
    return m_createAtEnd;
}

void DescribePortsRequest::SetCreateAtEnd(const string& _createAtEnd)
{
    m_createAtEnd = _createAtEnd;
    m_createAtEndHasBeenSet = true;
}

bool DescribePortsRequest::CreateAtEndHasBeenSet() const
{
    return m_createAtEndHasBeenSet;
}

string DescribePortsRequest::GetUpdateAtStart() const
{
    return m_updateAtStart;
}

void DescribePortsRequest::SetUpdateAtStart(const string& _updateAtStart)
{
    m_updateAtStart = _updateAtStart;
    m_updateAtStartHasBeenSet = true;
}

bool DescribePortsRequest::UpdateAtStartHasBeenSet() const
{
    return m_updateAtStartHasBeenSet;
}

string DescribePortsRequest::GetUpdateAtEnd() const
{
    return m_updateAtEnd;
}

void DescribePortsRequest::SetUpdateAtEnd(const string& _updateAtEnd)
{
    m_updateAtEnd = _updateAtEnd;
    m_updateAtEndHasBeenSet = true;
}

bool DescribePortsRequest::UpdateAtEndHasBeenSet() const
{
    return m_updateAtEndHasBeenSet;
}

vector<Filter> DescribePortsRequest::GetFilters() const
{
    return m_filters;
}

void DescribePortsRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribePortsRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

bool DescribePortsRequest::GetIgnored() const
{
    return m_ignored;
}

void DescribePortsRequest::SetIgnored(const bool& _ignored)
{
    m_ignored = _ignored;
    m_ignoredHasBeenSet = true;
}

bool DescribePortsRequest::IgnoredHasBeenSet() const
{
