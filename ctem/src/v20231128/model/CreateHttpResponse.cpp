...
CoreInternalOutcome CreateHttpResponse::Deserialize(const string &payload)
{
...
string CreateHttpResponse::ToJsonString() const
{
...
int64_t CreateHttpResponse::GetId() const
{
    return m_id;
}

bool CreateHttpResponse::IdHasBeenSet() const
{
