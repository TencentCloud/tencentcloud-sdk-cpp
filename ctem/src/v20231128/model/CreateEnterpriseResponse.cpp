...
CoreInternalOutcome CreateEnterpriseResponse::Deserialize(const string &payload)
{
...
string CreateEnterpriseResponse::ToJsonString() const
{
...
int64_t CreateEnterpriseResponse::GetId() const
{
    return m_id;
}

bool CreateEnterpriseResponse::IdHasBeenSet() const
{
