...
vector<int64_t> DescribeDomainsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeDomainsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeDomainsRequest::CustomerIdListHasBeenSet() const
{
