...
vector<int64_t> DescribeEnterprisesRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeEnterprisesRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeEnterprisesRequest::CustomerIdListHasBeenSet() const
{
