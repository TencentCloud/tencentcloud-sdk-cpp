...
vector<int64_t> DescribeAssetsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeAssetsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeAssetsRequest::CustomerIdListHasBeenSet() const
{
    return m_customerIdListHasBeenSet;
}

bool DescribeAssetsRequest::GetIsNew() const
{
    return m_isNew;
}

void DescribeAssetsRequest::SetIsNew(const bool& _isNew)
{
    m_isNew = _isNew;
    m_isNewHasBeenSet = true;
}

bool DescribeAssetsRequest::IsNewHasBeenSet() const
{
    return m_isNewHasBeenSet;
}

int64_t DescribeAssetsRequest::GetCustomerId() const
{
    return m_customerId;
}

void DescribeAssetsRequest::SetCustomerId(const int64_t& _customerId)
{
    m_customerId = _customerId;
    m_customerIdHasBeenSet = true;
}

bool DescribeAssetsRequest::CustomerIdHasBeenSet() const
{
    return m_customerIdHasBeenSet;
}

uint64_t DescribeAssetsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeAssetsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
uint64_t DescribeAssetsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAssetsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
vector<string> DescribeAssetsRequest::GetEnterpriseUidList() const
{
    return m_enterpriseUidList;
}

void DescribeAssetsRequest::SetEnterpriseUidList(const vector<string>& _enterpriseUidList)
{
    m_enterpriseUidList = _enterpriseUidList;
    m_enterpriseUidListHasBeenSet = true;
}

bool DescribeAssetsRequest::EnterpriseUidListHasBeenSet() const
{
    return m_enterpriseUidListHasBeenSet;
}

string DescribeAssetsRequest::GetFormat() const
{
    return m_format;
}

void DescribeAssetsRequest::SetFormat(const string& _format)
{
    m_format = _format;
    m_formatHasBeenSet = true;
}

bool DescribeAssetsRequest::FormatHasBeenSet() const
{
    return m_formatHasBeenSet;
}

string DescribeAssetsRequest::GetCreateAtStart() const
{
    return m_createAtStart;
}

void DescribeAssetsRequest::SetCreateAtStart(const string& _createAtStart)
{
    m_createAtStart = _createAtStart;
    m_createAtStartHasBeenSet = true;
}

bool DescribeAssetsRequest::CreateAtStartHasBeenSet() const
{
    return m_createAtStartHasBeenSet;
}

string DescribeAssetsRequest::GetCreateAtEnd() const
{
    return m_createAtEnd;
}

void DescribeAssetsRequest::SetCreateAtEnd(const string& _createAtEnd)
{
    m_createAtEnd = _createAtEnd;
    m_createAtEndHasBeenSet = true;
}

bool DescribeAssetsRequest::CreateAtEndHasBeenSet() const
{
    return m_createAtEndHasBeenSet;
}

string DescribeAssetsRequest::GetUpdateAtStart() const
{
    return m_updateAtStart;
}

void DescribeAssetsRequest::SetUpdateAtStart(const string& _updateAtStart)
{
    m_updateAtStart = _updateAtStart;
    m_updateAtStartHasBeenSet = true;
}

bool DescribeAssetsRequest::UpdateAtStartHasBeenSet() const
{
    return m_updateAtStartHasBeenSet;
}

string DescribeAssetsRequest::GetUpdateAtEnd() const
{
    return m_updateAtEnd;
}

void DescribeAssetsRequest::SetUpdateAtEnd(const string& _updateAtEnd)
{
    m_updateAtEnd = _updateAtEnd;
    m_updateAtEndHasBeenSet = true;
}

bool DescribeAssetsRequest::UpdateAtEndHasBeenSet() const
{
...
bool DescribeAssetsRequest::GetIgnored() const
{
    return m_ignored;
}

void DescribeAssetsRequest::SetIgnored(const bool& _ignored)
{
    m_ignored = _ignored;
    m_ignoredHasBeenSet = true;
}

bool DescribeAssetsRequest::IgnoredHasBeenSet() const
{
