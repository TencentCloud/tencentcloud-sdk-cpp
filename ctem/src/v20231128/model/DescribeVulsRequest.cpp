...
void DescribeVulsRequest::SetIsNew(const bool& _isNew)
{
    m_isNew = _isNew;
    m_isNewHasBeenSet = true;
}

bool DescribeVulsRequest::IsNewHasBeenSet() const
{
    return m_isNewHasBeenSet;
}

int64_t DescribeVulsRequest::GetCustomerId() const
{
    return m_customerId;
}

void DescribeVulsRequest::SetCustomerId(const int64_t& _customerId)
{
    m_customerId = _customerId;
    m_customerIdHasBeenSet = true;
}

bool DescribeVulsRequest::CustomerIdHasBeenSet() const
{
...
vector<string> DescribeVulsRequest::GetEnterpriseUidList() const
{
    return m_enterpriseUidList;
}

void DescribeVulsRequest::SetEnterpriseUidList(const vector<string>& _enterpriseUidList)
{
    m_enterpriseUidList = _enterpriseUidList;
    m_enterpriseUidListHasBeenSet = true;
}

bool DescribeVulsRequest::EnterpriseUidListHasBeenSet() const
{
    return m_enterpriseUidListHasBeenSet;
}

string DescribeVulsRequest::GetFormat() const
{
    return m_format;
}

void DescribeVulsRequest::SetFormat(const string& _format)
{
    m_format = _format;
    m_formatHasBeenSet = true;
}

bool DescribeVulsRequest::FormatHasBeenSet() const
{
    return m_formatHasBeenSet;
}

string DescribeVulsRequest::GetCreateAtStart() const
{
    return m_createAtStart;
}

void DescribeVulsRequest::SetCreateAtStart(const string& _createAtStart)
{
    m_createAtStart = _createAtStart;
    m_createAtStartHasBeenSet = true;
}

bool DescribeVulsRequest::CreateAtStartHasBeenSet() const
{
    return m_createAtStartHasBeenSet;
}

string DescribeVulsRequest::GetCreateAtEnd() const
{
    return m_createAtEnd;
}

void DescribeVulsRequest::SetCreateAtEnd(const string& _createAtEnd)
{
    m_createAtEnd = _createAtEnd;
    m_createAtEndHasBeenSet = true;
}

bool DescribeVulsRequest::CreateAtEndHasBeenSet() const
{
    return m_createAtEndHasBeenSet;
}

string DescribeVulsRequest::GetUpdateAtStart() const
{
    return m_updateAtStart;
}

void DescribeVulsRequest::SetUpdateAtStart(const string& _updateAtStart)
{
    m_updateAtStart = _updateAtStart;
    m_updateAtStartHasBeenSet = true;
}

bool DescribeVulsRequest::UpdateAtStartHasBeenSet() const
{
    return m_updateAtStartHasBeenSet;
}

string DescribeVulsRequest::GetUpdateAtEnd() const
{
    return m_updateAtEnd;
}

void DescribeVulsRequest::SetUpdateAtEnd(const string& _updateAtEnd)
{
    m_updateAtEnd = _updateAtEnd;
    m_updateAtEndHasBeenSet = true;
}

bool DescribeVulsRequest::UpdateAtEndHasBeenSet() const
{
...
bool DescribeVulsRequest::GetIgnored() const
{
    return m_ignored;
}

void DescribeVulsRequest::SetIgnored(const bool& _ignored)
{
    m_ignored = _ignored;
    m_ignoredHasBeenSet = true;
}

bool DescribeVulsRequest::IgnoredHasBeenSet() const
{
