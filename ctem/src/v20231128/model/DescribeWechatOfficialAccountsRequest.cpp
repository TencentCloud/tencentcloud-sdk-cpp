...
vector<int64_t> DescribeWechatOfficialAccountsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeWechatOfficialAccountsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeWechatOfficialAccountsRequest::CustomerIdListHasBeenSet() const
{
