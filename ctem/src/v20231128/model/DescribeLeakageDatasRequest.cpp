...
vector<int64_t> DescribeLeakageDatasRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeLeakageDatasRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeLeakageDatasRequest::CustomerIdListHasBeenSet() const
{
