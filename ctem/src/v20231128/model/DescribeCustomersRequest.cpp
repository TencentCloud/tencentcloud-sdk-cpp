...
vector<Filter> DescribeCustomersRequest::GetFilters() const
{
    return m_filters;
}

void DescribeCustomersRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeCustomersRequest::FiltersHasBeenSet() const
{
