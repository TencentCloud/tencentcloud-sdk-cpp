...
vector<int64_t> DescribeFakeAppsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeFakeAppsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeFakeAppsRequest::CustomerIdListHasBeenSet() const
{
