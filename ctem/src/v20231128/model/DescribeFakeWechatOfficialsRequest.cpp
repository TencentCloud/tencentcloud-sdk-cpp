...
vector<int64_t> DescribeFakeWechatOfficialsRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeFakeWechatOfficialsRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeFakeWechatOfficialsRequest::CustomerIdListHasBeenSet() const
{
