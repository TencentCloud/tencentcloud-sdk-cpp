...
int64_t CreateCustomerRequest::GetPortScanQps() const
{
    return m_portScanQps;
}

void CreateCustomerRequest::SetPortScanQps(const int64_t& _portScanQps)
{
    m_portScanQps = _portScanQps;
    m_portScanQpsHasBeenSet = true;
}

bool CreateCustomerRequest::PortScanQpsHasBeenSet() const
{
    return m_portScanQpsHasBeenSet;
}

int64_t CreateCustomerRequest::GetSingleIPTaskLimit() const
{
    return m_singleIPTaskLimit;
}

void CreateCustomerRequest::SetSingleIPTaskLimit(const int64_t& _singleIPTaskLimit)
{
    m_singleIPTaskLimit = _singleIPTaskLimit;
    m_singleIPTaskLimitHasBeenSet = true;
}

bool CreateCustomerRequest::SingleIPTaskLimitHasBeenSet() const
{
    return m_singleIPTaskLimitHasBeenSet;
}

bool CreateCustomerRequest::GetHighRiskAck() const
{
    return m_highRiskAck;
}

void CreateCustomerRequest::SetHighRiskAck(const bool& _highRiskAck)
{
    m_highRiskAck = _highRiskAck;
    m_highRiskAckHasBeenSet = true;
}

bool CreateCustomerRequest::HighRiskAckHasBeenSet() const
{
    return m_highRiskAckHasBeenSet;
}

vector<string> CreateCustomerRequest::GetScanRateAckChecklist() const
{
    return m_scanRateAckChecklist;
}

void CreateCustomerRequest::SetScanRateAckChecklist(const vector<string>& _scanRateAckChecklist)
{
