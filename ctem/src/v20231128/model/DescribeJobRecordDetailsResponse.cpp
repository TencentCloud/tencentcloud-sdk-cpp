...
CoreInternalOutcome DescribeJobRecordDetailsResponse::Deserialize(const string &payload)
{
...
string DescribeJobRecordDetailsResponse::ToJsonString() const
{
...
int64_t DescribeJobRecordDetailsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeJobRecordDetailsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DisplayJobRecordDetail> DescribeJobRecordDetailsResponse::GetList() const
{
    return m_list;
}
