...
CoreInternalOutcome CreateAssetResponse::Deserialize(const string &payload)
{
...
string CreateAssetResponse::ToJsonString() const
{
...
int64_t CreateAssetResponse::GetId() const
{
    return m_id;
}

bool CreateAssetResponse::IdHasBeenSet() const
{
