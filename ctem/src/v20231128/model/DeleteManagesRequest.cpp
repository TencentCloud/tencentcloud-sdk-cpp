...
DeleteManagesRequest::DeleteManagesRequest() :
...
string DeleteManagesRequest::ToJsonString() const
{
...
vector<int64_t> DeleteManagesRequest::GetIds() const
{
    return m_ids;
}

void DeleteManagesRequest::SetIds(const vector<int64_t>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool DeleteManagesRequest::IdsHasBeenSet() const
{
    return m_idsHasBeenSet;
}

vector<int64_t> DeleteManagesRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DeleteManagesRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DeleteManagesRequest::CustomerIdListHasBeenSet() const
{
    return m_customerIdListHasBeenSet;
}

bool DeleteManagesRequest::GetIsAggregation() const
{
    return m_isAggregation;
}

void DeleteManagesRequest::SetIsAggregation(const bool& _isAggregation)
{
    m_isAggregation = _isAggregation;
    m_isAggregationHasBeenSet = true;
}

bool DeleteManagesRequest::IsAggregationHasBeenSet() const
{
