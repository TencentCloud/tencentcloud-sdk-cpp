...
CoreInternalOutcome CreatePortResponse::Deserialize(const string &payload)
{
...
string CreatePortResponse::ToJsonString() const
{
...
int64_t CreatePortResponse::GetId() const
{
    return m_id;
}

bool CreatePortResponse::IdHasBeenSet() const
{
