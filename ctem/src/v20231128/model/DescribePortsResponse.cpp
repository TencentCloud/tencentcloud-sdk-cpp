...
int64_t DescribePortsResponse::GetTotal() const
{
    return m_total;
}

bool DescribePortsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DisplayPort> DescribePortsResponse::GetList() const
{
    return m_list;
}

bool DescribePortsResponse::ListHasBeenSet() const
{
