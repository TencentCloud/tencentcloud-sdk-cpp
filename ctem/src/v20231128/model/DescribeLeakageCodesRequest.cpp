...
vector<int64_t> DescribeLeakageCodesRequest::GetCustomerIdList() const
{
    return m_customerIdList;
}

void DescribeLeakageCodesRequest::SetCustomerIdList(const vector<int64_t>& _customerIdList)
{
    m_customerIdList = _customerIdList;
    m_customerIdListHasBeenSet = true;
}

bool DescribeLeakageCodesRequest::CustomerIdListHasBeenSet() const
{
