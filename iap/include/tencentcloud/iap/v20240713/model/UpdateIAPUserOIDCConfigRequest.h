...
#ifndef TENCENTCLOUD_IAP_V20240713_MODEL_UPDATEIAPUSEROIDCCONFIGREQUEST_H_
#define TENCENTCLOUD_IAP_V20240713_MODEL_UPDATEIAPUSEROIDCCONFIGREQUEST_H_
    ...
    namespace Iap
    {
        namespace V20240713
        {
            namespace Model
            {
                ...
                */
                class UpdateIAPUserOIDCConfigRequest : public AbstractModel
                {
                public:
                    UpdateIAPUserOIDCConfigRequest();
                    ~UpdateIAPUserOIDCConfigRequest() = default;
...
#endif // !TENCENTCLOUD_IAP_V20240713_MODEL_UPDATEIAPUSEROIDCCONFIGREQUEST_H_
