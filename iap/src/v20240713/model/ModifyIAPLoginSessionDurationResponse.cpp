...
CoreInternalOutcome ModifyIAPLoginSessionDurationResponse::Deserialize(const string &payload)
{
...
string ModifyIAPLoginSessionDurationResponse::ToJsonString() const
{
