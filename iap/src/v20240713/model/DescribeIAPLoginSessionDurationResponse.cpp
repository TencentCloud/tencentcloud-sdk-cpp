...
CoreInternalOutcome DescribeIAPLoginSessionDurationResponse::Deserialize(const string &payload)
{
...
string DescribeIAPLoginSessionDurationResponse::ToJsonString() const
{
...
int64_t DescribeIAPLoginSessionDurationResponse::GetDuration() const
{
    return m_duration;
}

bool DescribeIAPLoginSessionDurationResponse::DurationHasBeenSet() const
{
