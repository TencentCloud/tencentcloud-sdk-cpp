...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_UPDATECAPTCHAAPPIDINFORESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_UPDATECAPTCHAAPPIDINFORESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class UpdateCaptchaAppIdInfoResponse : public AbstractModel
                {
                public:
                    UpdateCaptchaAppIdInfoResponse();
                    ~UpdateCaptchaAppIdInfoResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_UPDATECAPTCHAAPPIDINFORESPONSE_H_
