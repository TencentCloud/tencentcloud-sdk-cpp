...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSREQUEST_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSREQUEST_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class GetTicketStatisticsRequest : public AbstractModel
                {
                public:
                    GetTicketStatisticsRequest();
                    ~GetTicketStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSREQUEST_H_
