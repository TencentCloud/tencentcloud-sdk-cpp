...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTOTALREQUESTSTATISTICSRESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTOTALREQUESTSTATISTICSRESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class GetTotalRequestStatisticsResponse : public AbstractModel
                {
                public:
                    GetTotalRequestStatisticsResponse();
                    ~GetTotalRequestStatisticsResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTOTALREQUESTSTATISTICSRESPONSE_H_
