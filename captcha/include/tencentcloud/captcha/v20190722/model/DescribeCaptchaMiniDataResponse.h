...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATARESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATARESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCaptchaMiniDataResponse : public AbstractModel
                {
                public:
                    DescribeCaptchaMiniDataResponse();
                    ~DescribeCaptchaMiniDataResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATARESPONSE_H_
