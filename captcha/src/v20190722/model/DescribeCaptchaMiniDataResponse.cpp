...
CoreInternalOutcome DescribeCaptchaMiniDataResponse::Deserialize(const string &payload)
{
...
string DescribeCaptchaMiniDataResponse::ToJsonString() const
{
...
int64_t DescribeCaptchaMiniDataResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaMiniDataResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

vector<CaptchaQueryData> DescribeCaptchaMiniDataResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaMiniDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeCaptchaMiniDataResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaMiniDataResponse::CaptchaMsgHasBeenSet() const
{
