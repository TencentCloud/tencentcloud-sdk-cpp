...
CoreInternalOutcome DescribeCaptchaOperDataResponse::Deserialize(const string &payload)
{
...
string DescribeCaptchaOperDataResponse::ToJsonString() const
{
...
int64_t DescribeCaptchaOperDataResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaOperDataResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DescribeCaptchaOperDataResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaOperDataResponse::CaptchaMsgHasBeenSet() const
{
    return m_captchaMsgHasBeenSet;
}

CaptchaOperDataRes DescribeCaptchaOperDataResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaOperDataResponse::DataHasBeenSet() const
{
