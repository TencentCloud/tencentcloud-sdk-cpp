...
CoreInternalOutcome RceResult::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("UserId") && !value["UserId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.UserId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PostTime") && !value["PostTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.PostTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AssociateAccount") && !value["AssociateAccount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.AssociateAccount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UserIp") && !value["UserIp"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.UserIp` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RiskLevel") && !value["RiskLevel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.RiskLevel` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RiskType") && !value["RiskType"].IsNull())
    {
        if (!value["RiskType"].IsArray())
            return CoreInternalOutcome(Core::Error("response `RceResult.RiskType` is not array type"));
    ...
    if (value.HasMember("ConstId") && !value["ConstId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.ConstId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RiskInformation") && !value["RiskInformation"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `RceResult.RiskInformation` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void RceResult::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string RceResult::GetUserId() const
{
    return m_userId;
}

void RceResult::SetUserId(const string& _userId)
{
    m_userId = _userId;
    m_userIdHasBeenSet = true;
}

bool RceResult::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

int64_t RceResult::GetPostTime() const
{
    return m_postTime;
}

void RceResult::SetPostTime(const int64_t& _postTime)
{
    m_postTime = _postTime;
    m_postTimeHasBeenSet = true;
}

bool RceResult::PostTimeHasBeenSet() const
{
    return m_postTimeHasBeenSet;
}

string RceResult::GetAssociateAccount() const
{
    return m_associateAccount;
}

void RceResult::SetAssociateAccount(const string& _associateAccount)
{
    m_associateAccount = _associateAccount;
    m_associateAccountHasBeenSet = true;
}

bool RceResult::AssociateAccountHasBeenSet() const
{
    return m_associateAccountHasBeenSet;
}

string RceResult::GetUserIp() const
{
    return m_userIp;
}

void RceResult::SetUserIp(const string& _userIp)
{
    m_userIp = _userIp;
    m_userIpHasBeenSet = true;
}

bool RceResult::UserIpHasBeenSet() const
{
    return m_userIpHasBeenSet;
}

string RceResult::GetRiskLevel() const
{
    return m_riskLevel;
}

void RceResult::SetRiskLevel(const string& _riskLevel)
{
    m_riskLevel = _riskLevel;
    m_riskLevelHasBeenSet = true;
}

bool RceResult::RiskLevelHasBeenSet() const
{
    return m_riskLevelHasBeenSet;
}

vector<int64_t> RceResult::GetRiskType() const
{
    return m_riskType;
}

void RceResult::SetRiskType(const vector<int64_t>& _riskType)
{
    m_riskType = _riskType;
    m_riskTypeHasBeenSet = true;
}

bool RceResult::RiskTypeHasBeenSet() const
{
    return m_riskTypeHasBeenSet;
}

string RceResult::GetConstId() const
{
    return m_constId;
}

void RceResult::SetConstId(const string& _constId)
{
    m_constId = _constId;
    m_constIdHasBeenSet = true;
}

bool RceResult::ConstIdHasBeenSet() const
{
    return m_constIdHasBeenSet;
}

string RceResult::GetRiskInformation() const
{
    return m_riskInformation;
}

void RceResult::SetRiskInformation(const string& _riskInformation)
{
    m_riskInformation = _riskInformation;
    m_riskInformationHasBeenSet = true;
}

bool RceResult::RiskInformationHasBeenSet() const
{
