...
CoreInternalOutcome DescribeCaptchaDataResponse::Deserialize(const string &payload)
{
...
string DescribeCaptchaDataResponse::ToJsonString() const
{
...
int64_t DescribeCaptchaDataResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaDataResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

vector<CaptchaQueryData> DescribeCaptchaDataResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeCaptchaDataResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaDataResponse::CaptchaMsgHasBeenSet() const
{
