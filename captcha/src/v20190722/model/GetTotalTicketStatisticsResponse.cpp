...
CoreInternalOutcome GetTotalTicketStatisticsResponse::Deserialize(const string &payload)
{
...
string GetTotalTicketStatisticsResponse::ToJsonString() const
{
...
CaptchaStatisticObj GetTotalTicketStatisticsResponse::GetData() const
{
    return m_data;
}

bool GetTotalTicketStatisticsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t GetTotalTicketStatisticsResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool GetTotalTicketStatisticsResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string GetTotalTicketStatisticsResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool GetTotalTicketStatisticsResponse::CaptchaMsgHasBeenSet() const
{
