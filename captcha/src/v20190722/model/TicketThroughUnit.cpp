...
CoreInternalOutcome TicketThroughUnit::Deserialize(const Value &value)
{
    string requestId = "";
...
void TicketThroughUnit::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
