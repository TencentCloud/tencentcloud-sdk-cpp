...
CoreInternalOutcome DescribeCaptchaTicketDataResponse::Deserialize(const string &payload)
{
...
string DescribeCaptchaTicketDataResponse::ToJsonString() const
{
...
int64_t DescribeCaptchaTicketDataResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaTicketDataResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DescribeCaptchaTicketDataResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaTicketDataResponse::CaptchaMsgHasBeenSet() const
{
    return m_captchaMsgHasBeenSet;
}

CaptchaTicketDataRes DescribeCaptchaTicketDataResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaTicketDataResponse::DataHasBeenSet() const
{
