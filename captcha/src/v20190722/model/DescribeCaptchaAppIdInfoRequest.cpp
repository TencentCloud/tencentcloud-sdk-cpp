...
string DescribeCaptchaAppIdInfoRequest::ToJsonString() const
{
...
uint64_t DescribeCaptchaAppIdInfoRequest::GetCaptchaAppId() const
{
    return m_captchaAppId;
}

void DescribeCaptchaAppIdInfoRequest::SetCaptchaAppId(const uint64_t& _captchaAppId)
{
    m_captchaAppId = _captchaAppId;
    m_captchaAppIdHasBeenSet = true;
}

bool DescribeCaptchaAppIdInfoRequest::CaptchaAppIdHasBeenSet() const
{
