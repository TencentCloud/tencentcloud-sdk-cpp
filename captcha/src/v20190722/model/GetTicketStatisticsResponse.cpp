...
CoreInternalOutcome GetTicketStatisticsResponse::Deserialize(const string &payload)
{
...
string GetTicketStatisticsResponse::ToJsonString() const
{
...
CaptchaStatisticObj GetTicketStatisticsResponse::GetData() const
{
    return m_data;
}

bool GetTicketStatisticsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t GetTicketStatisticsResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool GetTicketStatisticsResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string GetTicketStatisticsResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool GetTicketStatisticsResponse::CaptchaMsgHasBeenSet() const
{
