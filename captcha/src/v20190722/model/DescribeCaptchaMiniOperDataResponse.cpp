...
string DescribeCaptchaMiniOperDataResponse::ToJsonString() const
{
...
int64_t DescribeCaptchaMiniOperDataResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaMiniOperDataResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DescribeCaptchaMiniOperDataResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaMiniOperDataResponse::CaptchaMsgHasBeenSet() const
{
    return m_captchaMsgHasBeenSet;
}

CaptchaOperDataRes DescribeCaptchaMiniOperDataResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaMiniOperDataResponse::DataHasBeenSet() const
{
