...
CoreInternalOutcome UpdateCaptchaAppIdInfoResponse::Deserialize(const string &payload)
{
...
string UpdateCaptchaAppIdInfoResponse::ToJsonString() const
{
...
int64_t UpdateCaptchaAppIdInfoResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool UpdateCaptchaAppIdInfoResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string UpdateCaptchaAppIdInfoResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool UpdateCaptchaAppIdInfoResponse::CaptchaMsgHasBeenSet() const
{
