...
CoreInternalOutcome TicketInterceptUnit::Deserialize(const Value &value)
{
    string requestId = "";
...
void TicketInterceptUnit::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
