...
string CreateGlobalAcceleratorAclPolicyRequest::ToJsonString() const
{
...
string CreateGlobalAcceleratorAclPolicyRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void CreateGlobalAcceleratorAclPolicyRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool CreateGlobalAcceleratorAclPolicyRequest::GlobalAcceleratorIdHasBeenSet() const
{
    return m_globalAcceleratorIdHasBeenSet;
}

string CreateGlobalAcceleratorAclPolicyRequest::GetDefaultAction() const
{
    return m_defaultAction;
}

void CreateGlobalAcceleratorAclPolicyRequest::SetDefaultAction(const string& _defaultAction)
{
    m_defaultAction = _defaultAction;
    m_defaultActionHasBeenSet = true;
}

bool CreateGlobalAcceleratorAclPolicyRequest::DefaultActionHasBeenSet() const
{
