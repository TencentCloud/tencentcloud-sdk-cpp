...
string DescribeListenersRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void DescribeListenersRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool DescribeListenersRequest::GlobalAcceleratorIdHasBeenSet() const
{
    return m_globalAcceleratorIdHasBeenSet;
}

uint64_t DescribeListenersRequest::GetOffset() const
{
    return m_offset;
}

void DescribeListenersRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeListenersRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeListenersRequest::GetLimit() const
{
    return m_limit;
}

void DescribeListenersRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeListenersRequest::LimitHasBeenSet() const
{
