...
string DeleteGlobalAcceleratorAclPolicyRequest::ToJsonString() const
{
...
string DeleteGlobalAcceleratorAclPolicyRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void DeleteGlobalAcceleratorAclPolicyRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool DeleteGlobalAcceleratorAclPolicyRequest::GlobalAcceleratorIdHasBeenSet() const
{
    return m_globalAcceleratorIdHasBeenSet;
}

string DeleteGlobalAcceleratorAclPolicyRequest::GetGlobalAcceleratorAclPolicyId() const
{
    return m_globalAcceleratorAclPolicyId;
}

void DeleteGlobalAcceleratorAclPolicyRequest::SetGlobalAcceleratorAclPolicyId(const string& _globalAcceleratorAclPolicyId)
{
    m_globalAcceleratorAclPolicyId = _globalAcceleratorAclPolicyId;
    m_globalAcceleratorAclPolicyIdHasBeenSet = true;
}

bool DeleteGlobalAcceleratorAclPolicyRequest::GlobalAcceleratorAclPolicyIdHasBeenSet() const
{
