...
vector<Filter> DescribeForwardingRuleRequest::GetFilters() const
{
    return m_filters;
}

void DescribeForwardingRuleRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeForwardingRuleRequest::FiltersHasBeenSet() const
{
