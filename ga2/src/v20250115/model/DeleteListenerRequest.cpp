...
string DeleteListenerRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void DeleteListenerRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool DeleteListenerRequest::GlobalAcceleratorIdHasBeenSet() const
{
    return m_globalAcceleratorIdHasBeenSet;
}

string DeleteListenerRequest::GetListenerId() const
{
    return m_listenerId;
}

void DeleteListenerRequest::SetListenerId(const string& _listenerId)
{
    m_listenerId = _listenerId;
    m_listenerIdHasBeenSet = true;
}

bool DeleteListenerRequest::ListenerIdHasBeenSet() const
{
