...
string ModifyAccessLogStatusRequest::ToJsonString() const
{
...
string ModifyAccessLogStatusRequest::GetLogPushTaskId() const
{
    return m_logPushTaskId;
}

void ModifyAccessLogStatusRequest::SetLogPushTaskId(const string& _logPushTaskId)
{
    m_logPushTaskId = _logPushTaskId;
    m_logPushTaskIdHasBeenSet = true;
}

bool ModifyAccessLogStatusRequest::LogPushTaskIdHasBeenSet() const
{
    return m_logPushTaskIdHasBeenSet;
}

string ModifyAccessLogStatusRequest::GetStatus() const
{
    return m_status;
}

void ModifyAccessLogStatusRequest::SetStatus(const string& _status)
{
    m_status = _status;
    m_statusHasBeenSet = true;
}

bool ModifyAccessLogStatusRequest::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyAccessLogStatusRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void ModifyAccessLogStatusRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool ModifyAccessLogStatusRequest::GlobalAcceleratorIdHasBeenSet() const
{
