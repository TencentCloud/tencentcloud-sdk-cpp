...
string CreateAccelerateAreasRequest::ToJsonString() const
{
...
string CreateAccelerateAreasRequest::GetGlobalAcceleratorId() const
{
    return m_globalAcceleratorId;
}

void CreateAccelerateAreasRequest::SetGlobalAcceleratorId(const string& _globalAcceleratorId)
{
    m_globalAcceleratorId = _globalAcceleratorId;
    m_globalAcceleratorIdHasBeenSet = true;
}

bool CreateAccelerateAreasRequest::GlobalAcceleratorIdHasBeenSet() const
{
    return m_globalAcceleratorIdHasBeenSet;
}

vector<AcceleratorAreas> CreateAccelerateAreasRequest::GetAcceleratorAreas() const
{
    return m_acceleratorAreas;
}

void CreateAccelerateAreasRequest::SetAcceleratorAreas(const vector<AcceleratorAreas>& _acceleratorAreas)
{
    m_acceleratorAreas = _acceleratorAreas;
    m_acceleratorAreasHasBeenSet = true;
}

bool CreateAccelerateAreasRequest::AcceleratorAreasHasBeenSet() const
{
