...
#ifndef TENCENTCLOUD_GA2_V20250115_MODEL_MODIFYFORWARDINGPOLICYREQUEST_H_
#define TENCENTCLOUD_GA2_V20250115_MODEL_MODIFYFORWARDINGPOLICYREQUEST_H_
    ...
    namespace Ga2
    {
        namespace V20250115
        {
            namespace Model
            {
                ...
                */
                class ModifyForwardingPolicyRequest : public AbstractModel
                {
                public:
                    ModifyForwardingPolicyRequest();
                    ~ModifyForwardingPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_GA2_V20250115_MODEL_MODIFYFORWARDINGPOLICYREQUEST_H_
