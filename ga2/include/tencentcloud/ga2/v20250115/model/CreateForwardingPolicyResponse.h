...
#ifndef TENCENTCLOUD_GA2_V20250115_MODEL_CREATEFORWARDINGPOLICYRESPONSE_H_
#define TENCENTCLOUD_GA2_V20250115_MODEL_CREATEFORWARDINGPOLICYRESPONSE_H_
    ...
    namespace Ga2
    {
        namespace V20250115
        {
            namespace Model
            {
                ...
                */
                class CreateForwardingPolicyResponse : public AbstractModel
                {
                public:
                    CreateForwardingPolicyResponse();
                    ~CreateForwardingPolicyResponse() = default;
...
#endif // !TENCENTCLOUD_GA2_V20250115_MODEL_CREATEFORWARDINGPOLICYRESPONSE_H_
