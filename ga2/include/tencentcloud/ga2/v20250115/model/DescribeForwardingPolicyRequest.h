            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>过滤条件。<li>forwarding-policy-id - String -（过滤条件）策略ID。</li></p>
                     * @return Filters <p>过滤条件。<li>forwarding-policy-id - String -（过滤条件）策略ID。</li></p>
                     * 
                     */
                    std::vector<Filter> GetFilters() const;

                    /**
                     * 设置<p>过滤条件。<li>forwarding-policy-id - String -（过滤条件）策略ID。</li></p>
