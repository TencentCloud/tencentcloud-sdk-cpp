...
string DescribeMatchRequest::ToJsonString() const
{
...
string DescribeMatchRequest::GetMatchCode() const
{
    return m_matchCode;
}

void DescribeMatchRequest::SetMatchCode(const string& _matchCode)
{
    m_matchCode = _matchCode;
    m_matchCodeHasBeenSet = true;
}

bool DescribeMatchRequest::MatchCodeHasBeenSet() const
{
