...
string DescribeRuleRequest::ToJsonString() const
{
...
string DescribeRuleRequest::GetRuleCode() const
{
    return m_ruleCode;
}

void DescribeRuleRequest::SetRuleCode(const string& _ruleCode)
{
    m_ruleCode = _ruleCode;
    m_ruleCodeHasBeenSet = true;
}

bool DescribeRuleRequest::RuleCodeHasBeenSet() const
{
