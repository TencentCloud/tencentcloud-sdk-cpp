...
CoreInternalOutcome DescribeTokenResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("MatchToken") && !rsp["MatchToken"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `MatchToken` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("CompatibleSpan") && !rsp["CompatibleSpan"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `CompatibleSpan` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
string DescribeTokenResponse::ToJsonString() const
{
...
string DescribeTokenResponse::GetMatchToken() const
{
    return m_matchToken;
}

bool DescribeTokenResponse::MatchTokenHasBeenSet() const
{
    return m_matchTokenHasBeenSet;
}

uint64_t DescribeTokenResponse::GetCompatibleSpan() const
{
    return m_compatibleSpan;
}

bool DescribeTokenResponse::CompatibleSpanHasBeenSet() const
{
