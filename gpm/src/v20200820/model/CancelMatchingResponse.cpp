...
CoreInternalOutcome CancelMatchingResponse::Deserialize(const string &payload)
{
...
string CancelMatchingResponse::ToJsonString() const
{
...
uint64_t CancelMatchingResponse::GetErrCode() const
{
    return m_errCode;
}

bool CancelMatchingResponse::ErrCodeHasBeenSet() const
{
