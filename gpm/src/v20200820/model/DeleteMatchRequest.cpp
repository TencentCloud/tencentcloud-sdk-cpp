...
string DeleteMatchRequest::ToJsonString() const
{
...
string DeleteMatchRequest::GetMatchCode() const
{
    return m_matchCode;
}

void DeleteMatchRequest::SetMatchCode(const string& _matchCode)
{
    m_matchCode = _matchCode;
    m_matchCodeHasBeenSet = true;
}

bool DeleteMatchRequest::MatchCodeHasBeenSet() const
{
