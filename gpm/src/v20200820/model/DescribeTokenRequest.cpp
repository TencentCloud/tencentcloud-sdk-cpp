...
string DescribeTokenRequest::GetMatchCode() const
{
    return m_matchCode;
}

void DescribeTokenRequest::SetMatchCode(const string& _matchCode)
{
    m_matchCode = _matchCode;
    m_matchCodeHasBeenSet = true;
}

bool DescribeTokenRequest::MatchCodeHasBeenSet() const
{
