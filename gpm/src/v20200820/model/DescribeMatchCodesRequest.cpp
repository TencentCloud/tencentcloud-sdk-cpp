...
string DescribeMatchCodesRequest::ToJsonString() const
{
...
int64_t DescribeMatchCodesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeMatchCodesRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeMatchCodesRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeMatchCodesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeMatchCodesRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
