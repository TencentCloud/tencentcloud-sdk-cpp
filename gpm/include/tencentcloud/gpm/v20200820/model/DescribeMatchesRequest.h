...
#ifndef TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHESREQUEST_H_
#define TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHESREQUEST_H_
    ...
    namespace Gpm
    {
        namespace V20200820
        {
            namespace Model
            {
                ...
                */
                class DescribeMatchesRequest : public AbstractModel
                {
                public:
                    DescribeMatchesRequest();
                    ~DescribeMatchesRequest() = default;
...
#endif // !TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHESREQUEST_H_
