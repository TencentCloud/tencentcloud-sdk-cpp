...
#ifndef TENCENTCLOUD_GPM_V20200820_MODEL_MODIFYMATCHREQUEST_H_
#define TENCENTCLOUD_GPM_V20200820_MODEL_MODIFYMATCHREQUEST_H_
    ...
    namespace Gpm
    {
        namespace V20200820
        {
            namespace Model
            {
                ...
                * ModifyMatch请求参数结构体
                */
                class ModifyMatchRequest : public AbstractModel
                {
                public:
                    ModifyMatchRequest();
                    ~ModifyMatchRequest() = default;
...
#endif // !TENCENTCLOUD_GPM_V20200820_MODEL_MODIFYMATCHREQUEST_H_
