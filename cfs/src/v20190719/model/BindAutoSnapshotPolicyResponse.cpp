...
CoreInternalOutcome BindAutoSnapshotPolicyResponse::Deserialize(const string &payload)
{
...
string BindAutoSnapshotPolicyResponse::ToJsonString() const
{
...
string BindAutoSnapshotPolicyResponse::GetAutoSnapshotPolicyId() const
{
    return m_autoSnapshotPolicyId;
}

bool BindAutoSnapshotPolicyResponse::AutoSnapshotPolicyIdHasBeenSet() const
{
