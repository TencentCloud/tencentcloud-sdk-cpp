...
string DeleteCfsSnapshotRequest::ToJsonString() const
{
...
string DeleteCfsSnapshotRequest::GetSnapshotId() const
{
    return m_snapshotId;
}

void DeleteCfsSnapshotRequest::SetSnapshotId(const string& _snapshotId)
{
