...
CoreInternalOutcome UpdateAutoSnapshotPolicyResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AutoSnapshotPolicyId") && !rsp["AutoSnapshotPolicyId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AutoSnapshotPolicyId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string UpdateAutoSnapshotPolicyResponse::ToJsonString() const
{
...
string UpdateAutoSnapshotPolicyResponse::GetAutoSnapshotPolicyId() const
{
    return m_autoSnapshotPolicyId;
}

bool UpdateAutoSnapshotPolicyResponse::AutoSnapshotPolicyIdHasBeenSet() const
{
