...
CoreInternalOutcome CreateCfsSnapshotResponse::Deserialize(const string &payload)
{
...
string CreateCfsSnapshotResponse::ToJsonString() const
{
...
string CreateCfsSnapshotResponse::GetSnapshotId() const
{
    return m_snapshotId;
}

bool CreateCfsSnapshotResponse::SnapshotIdHasBeenSet() const
{
