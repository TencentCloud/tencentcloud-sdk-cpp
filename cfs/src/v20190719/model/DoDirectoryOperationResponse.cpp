...
CoreInternalOutcome DoDirectoryOperationResponse::Deserialize(const string &payload)
{
...
string DoDirectoryOperationResponse::ToJsonString() const
{
...
int64_t DoDirectoryOperationResponse::GetResult() const
{
    return m_result;
}

bool DoDirectoryOperationResponse::ResultHasBeenSet() const
{
