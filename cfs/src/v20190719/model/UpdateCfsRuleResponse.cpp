...
CoreInternalOutcome UpdateCfsRuleResponse::Deserialize(const string &payload)
{
...
string UpdateCfsRuleResponse::ToJsonString() const
{
...
string UpdateCfsRuleResponse::GetPGroupId() const
{
    return m_pGroupId;
}

bool UpdateCfsRuleResponse::PGroupIdHasBeenSet() const
{
    return m_pGroupIdHasBeenSet;
}

string UpdateCfsRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool UpdateCfsRuleResponse::RuleIdHasBeenSet() const
{
    return m_ruleIdHasBeenSet;
}

string UpdateCfsRuleResponse::GetAuthClientIp() const
{
    return m_authClientIp;
}

bool UpdateCfsRuleResponse::AuthClientIpHasBeenSet() const
{
    return m_authClientIpHasBeenSet;
}

string UpdateCfsRuleResponse::GetRWPermission() const
{
    return m_rWPermission;
}

bool UpdateCfsRuleResponse::RWPermissionHasBeenSet() const
{
    return m_rWPermissionHasBeenSet;
}

string UpdateCfsRuleResponse::GetUserPermission() const
{
    return m_userPermission;
}

bool UpdateCfsRuleResponse::UserPermissionHasBeenSet() const
{
    return m_userPermissionHasBeenSet;
}

int64_t UpdateCfsRuleResponse::GetPriority() const
{
    return m_priority;
}

bool UpdateCfsRuleResponse::PriorityHasBeenSet() const
{
