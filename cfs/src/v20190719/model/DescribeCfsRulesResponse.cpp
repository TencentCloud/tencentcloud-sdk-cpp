...
string DescribeCfsRulesResponse::ToJsonString() const
{
...
vector<PGroupRuleInfo> DescribeCfsRulesResponse::GetRuleList() const
{
    return m_ruleList;
}

bool DescribeCfsRulesResponse::RuleListHasBeenSet() const
{
