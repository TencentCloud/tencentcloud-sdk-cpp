...
CoreInternalOutcome DescribeCfsSnapshotsResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["TotalSize"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `TotalSize` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_totalSize = rsp["TotalSize"].GetUint64();
...
string DescribeCfsSnapshotsResponse::ToJsonString() const
{
...
uint64_t DescribeCfsSnapshotsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCfsSnapshotsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SnapshotInfo> DescribeCfsSnapshotsResponse::GetSnapshots() const
{
    return m_snapshots;
}

bool DescribeCfsSnapshotsResponse::SnapshotsHasBeenSet() const
{
    return m_snapshotsHasBeenSet;
}

uint64_t DescribeCfsSnapshotsResponse::GetTotalSize() const
{
    return m_totalSize;
}

bool DescribeCfsSnapshotsResponse::TotalSizeHasBeenSet() const
{
