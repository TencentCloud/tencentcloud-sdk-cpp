...
DeleteDataRetrievalRequest::DeleteDataRetrievalRequest() :
    m_dataRetrievalIdHasBeenSet(false)
{
}

string DeleteDataRetrievalRequest::ToJsonString() const
{
...
string DeleteDataRetrievalRequest::GetDataRetrievalId() const
{
    return m_dataRetrievalId;
}

void DeleteDataRetrievalRequest::SetDataRetrievalId(const string& _dataRetrievalId)
{
    m_dataRetrievalId = _dataRetrievalId;
    m_dataRetrievalIdHasBeenSet = true;
}

bool DeleteDataRetrievalRequest::DataRetrievalIdHasBeenSet() const
{
