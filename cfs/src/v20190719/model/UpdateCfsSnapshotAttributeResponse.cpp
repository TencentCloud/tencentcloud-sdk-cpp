...
CoreInternalOutcome UpdateCfsSnapshotAttributeResponse::Deserialize(const string &payload)
{
...
string UpdateCfsSnapshotAttributeResponse::ToJsonString() const
{
...
string UpdateCfsSnapshotAttributeResponse::GetSnapshotId() const
{
    return m_snapshotId;
}

bool UpdateCfsSnapshotAttributeResponse::SnapshotIdHasBeenSet() const
{
