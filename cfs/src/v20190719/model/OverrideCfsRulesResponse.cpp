...
OverrideCfsRulesResponse::OverrideCfsRulesResponse() :
    m_ruleListHasBeenSet(false)
{
}

CoreInternalOutcome OverrideCfsRulesResponse::Deserialize(const string &payload)
{
...
string OverrideCfsRulesResponse::ToJsonString() const
{
...
vector<PGroupRuleInfo> OverrideCfsRulesResponse::GetRuleList() const
{
    return m_ruleList;
}

bool OverrideCfsRulesResponse::RuleListHasBeenSet() const
{
