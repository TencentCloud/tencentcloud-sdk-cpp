...
CoreInternalOutcome DeleteAutoSnapshotPolicyResponse::Deserialize(const string &payload)
{
...
string DeleteAutoSnapshotPolicyResponse::ToJsonString() const
{
...
string DeleteAutoSnapshotPolicyResponse::GetAutoSnapshotPolicyId() const
{
    return m_autoSnapshotPolicyId;
}

bool DeleteAutoSnapshotPolicyResponse::AutoSnapshotPolicyIdHasBeenSet() const
{
