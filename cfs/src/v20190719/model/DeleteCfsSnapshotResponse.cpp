...
CoreInternalOutcome DeleteCfsSnapshotResponse::Deserialize(const string &payload)
{
...
string DeleteCfsSnapshotResponse::ToJsonString() const
{
...
string DeleteCfsSnapshotResponse::GetSnapshotId() const
{
    return m_snapshotId;
}

bool DeleteCfsSnapshotResponse::SnapshotIdHasBeenSet() const
{
