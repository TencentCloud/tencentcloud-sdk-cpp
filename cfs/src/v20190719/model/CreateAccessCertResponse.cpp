...
CreateAccessCertResponse::CreateAccessCertResponse() :
    m_certIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateAccessCertResponse::Deserialize(const string &payload)
{
...
string CreateAccessCertResponse::ToJsonString() const
{
...
string CreateAccessCertResponse::GetCertId() const
{
    return m_certId;
}

bool CreateAccessCertResponse::CertIdHasBeenSet() const
{
