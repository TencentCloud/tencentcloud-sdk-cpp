...
string DeleteDataFlowRequest::ToJsonString() const
{
...
string DeleteDataFlowRequest::GetDataFlowId() const
{
    return m_dataFlowId;
}

void DeleteDataFlowRequest::SetDataFlowId(const string& _dataFlowId)
{
    m_dataFlowId = _dataFlowId;
    m_dataFlowIdHasBeenSet = true;
}

bool DeleteDataFlowRequest::DataFlowIdHasBeenSet() const
{
    return m_dataFlowIdHasBeenSet;
}

string DeleteDataFlowRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DeleteDataFlowRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool DeleteDataFlowRequest::FileSystemIdHasBeenSet() const
{
