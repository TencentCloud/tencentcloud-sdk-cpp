...
string DescribeCfsRulesRequest::ToJsonString() const
{
...
string DescribeCfsRulesRequest::GetPGroupId() const
{
    return m_pGroupId;
}

void DescribeCfsRulesRequest::SetPGroupId(const string& _pGroupId)
{
    m_pGroupId = _pGroupId;
    m_pGroupIdHasBeenSet = true;
}

bool DescribeCfsRulesRequest::PGroupIdHasBeenSet() const
{
