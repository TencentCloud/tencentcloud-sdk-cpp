...
string DeleteCfsPGroupRequest::ToJsonString() const
{
...
string DeleteCfsPGroupRequest::GetPGroupId() const
{
    return m_pGroupId;
}

void DeleteCfsPGroupRequest::SetPGroupId(const string& _pGroupId)
{
    m_pGroupId = _pGroupId;
    m_pGroupIdHasBeenSet = true;
}

bool DeleteCfsPGroupRequest::PGroupIdHasBeenSet() const
{
