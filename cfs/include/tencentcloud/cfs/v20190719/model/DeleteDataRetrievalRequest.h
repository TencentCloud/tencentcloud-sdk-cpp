...
#ifndef TENCENTCLOUD_CFS_V20190719_MODEL_DELETEDATARETRIEVALREQUEST_H_
#define TENCENTCLOUD_CFS_V20190719_MODEL_DELETEDATARETRIEVALREQUEST_H_
    ...
    namespace Cfs
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                */
                class DeleteDataRetrievalRequest : public AbstractModel
                {
                public:
                    DeleteDataRetrievalRequest();
                    ~DeleteDataRetrievalRequest() = default;
...
#endif // !TENCENTCLOUD_CFS_V20190719_MODEL_DELETEDATARETRIEVALREQUEST_H_
