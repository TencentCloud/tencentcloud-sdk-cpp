...
#ifndef TENCENTCLOUD_CFS_V20190719_MODEL_CREATEDATARETRIEVALRESPONSE_H_
#define TENCENTCLOUD_CFS_V20190719_MODEL_CREATEDATARETRIEVALRESPONSE_H_
    ...
    namespace Cfs
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                */
                class CreateDataRetrievalResponse : public AbstractModel
                {
                public:
                    CreateDataRetrievalResponse();
                    ~CreateDataRetrievalResponse() = default;
...
#endif // !TENCENTCLOUD_CFS_V20190719_MODEL_CREATEDATARETRIEVALRESPONSE_H_
