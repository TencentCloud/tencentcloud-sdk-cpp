...
#ifndef TENCENTCLOUD_APIS_V20240801_MODEL_BINDMCPSECURITYRULEVO_H_
#define TENCENTCLOUD_APIS_V20240801_MODEL_BINDMCPSECURITYRULEVO_H_
    ...
    namespace Apis
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class BindMcpSecurityRuleVO : public AbstractModel
                {
                public:
                    BindMcpSecurityRuleVO();
                    ~BindMcpSecurityRuleVO() = default;
...
#endif // !TENCENTCLOUD_APIS_V20240801_MODEL_BINDMCPSECURITYRULEVO_H_
