...
#ifndef TENCENTCLOUD_APIS_V20240801_MODEL_MODIFYAGENTAPPMODELSERVICESREQUEST_H_
#define TENCENTCLOUD_APIS_V20240801_MODEL_MODIFYAGENTAPPMODELSERVICESREQUEST_H_
    ...
    namespace Apis
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class ModifyAgentAppModelServicesRequest : public AbstractModel
                {
                public:
                    ModifyAgentAppModelServicesRequest();
                    ~ModifyAgentAppModelServicesRequest() = default;
...
#endif // !TENCENTCLOUD_APIS_V20240801_MODEL_MODIFYAGENTAPPMODELSERVICESREQUEST_H_
