...
CoreInternalOutcome DeleteMcpServerResponse::Deserialize(const string &payload)
{
...
string DeleteMcpServerResponse::ToJsonString() const
{
...
ResultIDVO DeleteMcpServerResponse::GetData() const
{
    return m_data;
}

bool DeleteMcpServerResponse::DataHasBeenSet() const
{
