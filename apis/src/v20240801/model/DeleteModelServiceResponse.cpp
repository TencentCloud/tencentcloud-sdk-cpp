...
CoreInternalOutcome DeleteModelServiceResponse::Deserialize(const string &payload)
{
...
string DeleteModelServiceResponse::ToJsonString() const
{
...
ResultIDVO DeleteModelServiceResponse::GetData() const
{
    return m_data;
}

bool DeleteModelServiceResponse::DataHasBeenSet() const
{
