...
CoreInternalOutcome DescribeModelServiceResponse::Deserialize(const string &payload)
{
...
string DescribeModelServiceResponse::ToJsonString() const
{
...
DescribeModelServiceResponseVO DescribeModelServiceResponse::GetData() const
{
    return m_data;
}

bool DescribeModelServiceResponse::DataHasBeenSet() const
{
