...
bool ModifyModelServiceRequest::GetPromptModerateStatus() const
{
    return m_promptModerateStatus;
}

void ModifyModelServiceRequest::SetPromptModerateStatus(const bool& _promptModerateStatus)
{
    m_promptModerateStatus = _promptModerateStatus;
    m_promptModerateStatusHasBeenSet = true;
}

bool ModifyModelServiceRequest::PromptModerateStatusHasBeenSet() const
{
    return m_promptModerateStatusHasBeenSet;
}

PromptModerateConfigDTO ModifyModelServiceRequest::GetPromptModerateConfig() const
{
    return m_promptModerateConfig;
}

void ModifyModelServiceRequest::SetPromptModerateConfig(const PromptModerateConfigDTO& _promptModerateConfig)
{
    m_promptModerateConfig = _promptModerateConfig;
    m_promptModerateConfigHasBeenSet = true;
}

bool ModifyModelServiceRequest::PromptModerateConfigHasBeenSet() const
{
    return m_promptModerateConfigHasBeenSet;
}

bool ModifyModelServiceRequest::GetSensitiveDataCheckStatus() const
{
    return m_sensitiveDataCheckStatus;
}

void ModifyModelServiceRequest::SetSensitiveDataCheckStatus(const bool& _sensitiveDataCheckStatus)
{
    m_sensitiveDataCheckStatus = _sensitiveDataCheckStatus;
    m_sensitiveDataCheckStatusHasBeenSet = true;
}

bool ModifyModelServiceRequest::SensitiveDataCheckStatusHasBeenSet() const
{
    return m_sensitiveDataCheckStatusHasBeenSet;
}

SensitiveDataCheckConfigDTO ModifyModelServiceRequest::GetSensitiveDataCheckConfig() const
{
    return m_sensitiveDataCheckConfig;
}

void ModifyModelServiceRequest::SetSensitiveDataCheckConfig(const SensitiveDataCheckConfigDTO& _sensitiveDataCheckConfig)
{
...
string ModifyModelServiceRequest::GetModelProtocol() const
{
    return m_modelProtocol;
}

void ModifyModelServiceRequest::SetModelProtocol(const string& _modelProtocol)
{
    m_modelProtocol = _modelProtocol;
    m_modelProtocolHasBeenSet = true;
}

bool ModifyModelServiceRequest::ModelProtocolHasBeenSet() const
{
    return m_modelProtocolHasBeenSet;
}

string ModifyModelServiceRequest::GetRawCustomModelProtocolConfig() const
{
    return m_rawCustomModelProtocolConfig;
}

void ModifyModelServiceRequest::SetRawCustomModelProtocolConfig(const string& _rawCustomModelProtocolConfig)
{
    m_rawCustomModelProtocolConfig = _rawCustomModelProtocolConfig;
    m_rawCustomModelProtocolConfigHasBeenSet = true;
}

bool ModifyModelServiceRequest::RawCustomModelProtocolConfigHasBeenSet() const
{
    return m_rawCustomModelProtocolConfigHasBeenSet;
}

string ModifyModelServiceRequest::GetRouteStrategy() const
{
    return m_routeStrategy;
}

void ModifyModelServiceRequest::SetRouteStrategy(const string& _routeStrategy)
{
    m_routeStrategy = _routeStrategy;
    m_routeStrategyHasBeenSet = true;
}

bool ModifyModelServiceRequest::RouteStrategyHasBeenSet() const
{
    return m_routeStrategyHasBeenSet;
}

vector<TokenLengthRouteDTO> ModifyModelServiceRequest::GetTokenLengthRoute() const
{
    return m_tokenLengthRoute;
}

void ModifyModelServiceRequest::SetTokenLengthRoute(const vector<TokenLengthRouteDTO>& _tokenLengthRoute)
{
    m_tokenLengthRoute = _tokenLengthRoute;
    m_tokenLengthRouteHasBeenSet = true;
}

bool ModifyModelServiceRequest::TokenLengthRouteHasBeenSet() const
{
    return m_tokenLengthRouteHasBeenSet;
}

TaskComplexityRouteDTO ModifyModelServiceRequest::GetTaskComplexityRoute() const
{
    return m_taskComplexityRoute;
}

void ModifyModelServiceRequest::SetTaskComplexityRoute(const TaskComplexityRouteDTO& _taskComplexityRoute)
{
