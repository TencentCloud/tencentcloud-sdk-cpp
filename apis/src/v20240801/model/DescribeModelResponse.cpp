...
CoreInternalOutcome DescribeModelResponse::Deserialize(const string &payload)
{
...
string DescribeModelResponse::ToJsonString() const
{
...
DescribeModelResponseVO DescribeModelResponse::GetData() const
{
    return m_data;
}

bool DescribeModelResponse::DataHasBeenSet() const
{
