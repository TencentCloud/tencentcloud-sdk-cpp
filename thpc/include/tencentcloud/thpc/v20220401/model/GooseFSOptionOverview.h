...
#ifndef TENCENTCLOUD_THPC_V20220401_MODEL_GOOSEFSOPTIONOVERVIEW_H_
#define TENCENTCLOUD_THPC_V20220401_MODEL_GOOSEFSOPTIONOVERVIEW_H_
    ...
    namespace Thpc
    {
        namespace V20220401
        {
            namespace Model
            {
                ...
                * GooseFS存储选项概览信息。
                */
                class GooseFSOptionOverview : public AbstractModel
                {
                public:
                    GooseFSOptionOverview();
                    ~GooseFSOptionOverview() = default;
...
#endif // !TENCENTCLOUD_THPC_V20220401_MODEL_GOOSEFSOPTIONOVERVIEW_H_
