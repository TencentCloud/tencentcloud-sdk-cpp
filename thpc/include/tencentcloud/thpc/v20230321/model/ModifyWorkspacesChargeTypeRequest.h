...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_MODIFYWORKSPACESCHARGETYPEREQUEST_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_MODIFYWORKSPACESCHARGETYPEREQUEST_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                */
                class ModifyWorkspacesChargeTypeRequest : public AbstractModel
                {
                public:
                    ModifyWorkspacesChargeTypeRequest();
                    ~ModifyWorkspacesChargeTypeRequest() = default;
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_MODIFYWORKSPACESCHARGETYPEREQUEST_H_
