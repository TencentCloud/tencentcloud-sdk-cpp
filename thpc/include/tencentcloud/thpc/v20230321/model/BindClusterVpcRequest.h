...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_BINDCLUSTERVPCREQUEST_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_BINDCLUSTERVPCREQUEST_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                */
                class BindClusterVpcRequest : public AbstractModel
                {
                public:
                    BindClusterVpcRequest();
                    ~BindClusterVpcRequest() = default;
                    ...
                    /**
                     * 获取<p>私有网络ID，形如<code>vpc-xxx</code>。可通过调用<a href="https://cloud.tencent.com/document/api/215/15778">DescribeVpcs</a>获取。</p>
                    ...
                    /**
                     * 设置<p>私有网络ID，形如<code>vpc-xxx</code>。可通过调用<a href="https://cloud.tencent.com/document/api/215/15778">DescribeVpcs</a>获取。</p>
                    ...
                    /**
                     * 获取<p>私有网络子网ID，形如<code>subnet-xxx</code>。可通过调用<a href="https://cloud.tencent.com/document/api/215/15784">DescribeSubnets</a>获取。</p>
                    ...
                    /**
                     * 设置<p>私有网络子网ID，形如<code>subnet-xxx</code>。可通过调用<a href="https://cloud.tencent.com/document/api/215/15784">DescribeSubnets</a>获取。</p>
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_BINDCLUSTERVPCREQUEST_H_
