...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_EXPANSIONNODECONFIG_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_EXPANSIONNODECONFIG_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                * 弹性扩容节点配置信息。
                */
                class ExpansionNodeConfig : public AbstractModel
                {
                public:
                    ExpansionNodeConfig();
                    ~ExpansionNodeConfig() = default;
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_EXPANSIONNODECONFIG_H_
