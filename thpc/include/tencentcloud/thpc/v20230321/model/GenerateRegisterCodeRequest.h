...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_GENERATEREGISTERCODEREQUEST_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_GENERATEREGISTERCODEREQUEST_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                */
                class GenerateRegisterCodeRequest : public AbstractModel
                {
                public:
                    GenerateRegisterCodeRequest();
                    ~GenerateRegisterCodeRequest() = default;
                    ...
                    /**
                     * 获取<p>指定生成的注册码的过期时间, 单位为秒</p><p>取值范围：[1, 604800]</p><p>默认值：604800</p>
                    ...
                    /**
                     * 设置<p>指定生成的注册码的过期时间, 单位为秒</p><p>取值范围：[1, 604800]</p><p>默认值：604800</p>
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_GENERATEREGISTERCODEREQUEST_H_
