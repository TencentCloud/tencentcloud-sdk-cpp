...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_INQUIREPRICECREATEWORKSPACESREQUEST_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_INQUIREPRICECREATEWORKSPACESREQUEST_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                */
                class InquirePriceCreateWorkspacesRequest : public AbstractModel
                {
                public:
                    InquirePriceCreateWorkspacesRequest();
                    ~InquirePriceCreateWorkspacesRequest() = default;
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_INQUIREPRICECREATEWORKSPACESREQUEST_H_
