...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_DESCRIBEQUEUESREQUEST_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_DESCRIBEQUEUESREQUEST_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                */
                class DescribeQueuesRequest : public AbstractModel
                {
                public:
                    DescribeQueuesRequest();
                    ~DescribeQueuesRequest() = default;
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_DESCRIBEQUEUESREQUEST_H_
