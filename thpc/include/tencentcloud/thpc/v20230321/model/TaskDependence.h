...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_TASKDEPENDENCE_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_TASKDEPENDENCE_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                * 任务的依赖关系。
                */
                class TaskDependence : public AbstractModel
                {
                public:
                    TaskDependence();
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_TASKDEPENDENCE_H_
