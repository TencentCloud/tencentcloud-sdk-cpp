...
GenerateRegisterCodeResponse::GenerateRegisterCodeResponse() :
    m_registerCodeHasBeenSet(false),
    m_expireAtHasBeenSet(false)
{
}

CoreInternalOutcome GenerateRegisterCodeResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["ExpireAt"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `ExpireAt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_expireAt = rsp["ExpireAt"].GetUint64();
...
string GenerateRegisterCodeResponse::ToJsonString() const
{
...
string GenerateRegisterCodeResponse::GetRegisterCode() const
{
    return m_registerCode;
}

bool GenerateRegisterCodeResponse::RegisterCodeHasBeenSet() const
{
    return m_registerCodeHasBeenSet;
}

uint64_t GenerateRegisterCodeResponse::GetExpireAt() const
{
    return m_expireAt;
}

bool GenerateRegisterCodeResponse::ExpireAtHasBeenSet() const
{
