...
string DescribeJobSubmitInfoResponse::GetClusterId() const
{
    return m_clusterId;
}

bool DescribeJobSubmitInfoResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

string DescribeJobSubmitInfoResponse::GetQueueName() const
{
    return m_queueName;
}

bool DescribeJobSubmitInfoResponse::QueueNameHasBeenSet() const
{
    return m_queueNameHasBeenSet;
}

Job DescribeJobSubmitInfoResponse::GetJob() const
{
    return m_job;
}

bool DescribeJobSubmitInfoResponse::JobHasBeenSet() const
{
