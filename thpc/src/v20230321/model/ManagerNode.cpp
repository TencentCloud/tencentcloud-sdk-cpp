...
CoreInternalOutcome ManagerNode::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("InstanceChargeType") && !value["InstanceChargeType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.InstanceChargeType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceChargePrepaid") && !value["InstanceChargePrepaid"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.InstanceChargePrepaid` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceType") && !value["InstanceType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.InstanceType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SystemDisk") && !value["SystemDisk"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.SystemDisk` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DataDisks") && !value["DataDisks"].IsNull())
    {
        if (!value["DataDisks"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ManagerNode.DataDisks` is not array type"));
    ...
    if (value.HasMember("InternetAccessible") && !value["InternetAccessible"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.InternetAccessible` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceName") && !value["InstanceName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.InstanceName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ProjectId") && !value["ProjectId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ManagerNode.ProjectId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void ManagerNode::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string ManagerNode::GetInstanceChargeType() const
{
    return m_instanceChargeType;
}

void ManagerNode::SetInstanceChargeType(const string& _instanceChargeType)
{
    m_instanceChargeType = _instanceChargeType;
    m_instanceChargeTypeHasBeenSet = true;
}

bool ManagerNode::InstanceChargeTypeHasBeenSet() const
{
    return m_instanceChargeTypeHasBeenSet;
}

InstanceChargePrepaid ManagerNode::GetInstanceChargePrepaid() const
{
    return m_instanceChargePrepaid;
}

void ManagerNode::SetInstanceChargePrepaid(const InstanceChargePrepaid& _instanceChargePrepaid)
{
    m_instanceChargePrepaid = _instanceChargePrepaid;
    m_instanceChargePrepaidHasBeenSet = true;
}

bool ManagerNode::InstanceChargePrepaidHasBeenSet() const
{
    return m_instanceChargePrepaidHasBeenSet;
}

string ManagerNode::GetInstanceType() const
{
    return m_instanceType;
}

void ManagerNode::SetInstanceType(const string& _instanceType)
{
    m_instanceType = _instanceType;
    m_instanceTypeHasBeenSet = true;
}

bool ManagerNode::InstanceTypeHasBeenSet() const
{
    return m_instanceTypeHasBeenSet;
}

SystemDisk ManagerNode::GetSystemDisk() const
{
    return m_systemDisk;
}

void ManagerNode::SetSystemDisk(const SystemDisk& _systemDisk)
{
    m_systemDisk = _systemDisk;
    m_systemDiskHasBeenSet = true;
}

bool ManagerNode::SystemDiskHasBeenSet() const
{
    return m_systemDiskHasBeenSet;
}

vector<DataDisk> ManagerNode::GetDataDisks() const
{
    return m_dataDisks;
}

void ManagerNode::SetDataDisks(const vector<DataDisk>& _dataDisks)
{
    m_dataDisks = _dataDisks;
    m_dataDisksHasBeenSet = true;
}

bool ManagerNode::DataDisksHasBeenSet() const
{
    return m_dataDisksHasBeenSet;
}

InternetAccessible ManagerNode::GetInternetAccessible() const
{
    return m_internetAccessible;
}

void ManagerNode::SetInternetAccessible(const InternetAccessible& _internetAccessible)
{
    m_internetAccessible = _internetAccessible;
    m_internetAccessibleHasBeenSet = true;
}

bool ManagerNode::InternetAccessibleHasBeenSet() const
{
    return m_internetAccessibleHasBeenSet;
}

string ManagerNode::GetInstanceName() const
{
    return m_instanceName;
}

void ManagerNode::SetInstanceName(const string& _instanceName)
{
    m_instanceName = _instanceName;
    m_instanceNameHasBeenSet = true;
}

bool ManagerNode::InstanceNameHasBeenSet() const
{
    return m_instanceNameHasBeenSet;
}

int64_t ManagerNode::GetProjectId() const
{
    return m_projectId;
}

void ManagerNode::SetProjectId(const int64_t& _projectId)
{
