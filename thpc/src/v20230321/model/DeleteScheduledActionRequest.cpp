...
vector<string> DeleteScheduledActionRequest::GetScheduledActionIds() const
{
    return m_scheduledActionIds;
}

void DeleteScheduledActionRequest::SetScheduledActionIds(const vector<string>& _scheduledActionIds)
{
    m_scheduledActionIds = _scheduledActionIds;
    m_scheduledActionIdsHasBeenSet = true;
}

bool DeleteScheduledActionRequest::ScheduledActionIdsHasBeenSet() const
{
