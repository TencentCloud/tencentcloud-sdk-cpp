...
SystemDisk AddNodesRequest::GetSystemDisk() const
{
    return m_systemDisk;
}

void AddNodesRequest::SetSystemDisk(const SystemDisk& _systemDisk)
{
...
int64_t AddNodesRequest::GetProjectId() const
{
    return m_projectId;
}

void AddNodesRequest::SetProjectId(const int64_t& _projectId)
{
