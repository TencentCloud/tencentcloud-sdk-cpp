...
InquirePriceCreateWorkspacesResponse::InquirePriceCreateWorkspacesResponse() :
    m_priceHasBeenSet(false)
{
}

CoreInternalOutcome InquirePriceCreateWorkspacesResponse::Deserialize(const string &payload)
{
...
string InquirePriceCreateWorkspacesResponse::ToJsonString() const
{
...
Price InquirePriceCreateWorkspacesResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceCreateWorkspacesResponse::PriceHasBeenSet() const
{
