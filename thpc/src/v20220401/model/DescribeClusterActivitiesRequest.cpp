...
vector<Filter> DescribeClusterActivitiesRequest::GetFilters() const
{
    return m_filters;
}

void DescribeClusterActivitiesRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeClusterActivitiesRequest::FiltersHasBeenSet() const
{
