...
string DescribeAutoScalingConfigurationRequest::ToJsonString() const
{
...
string DescribeAutoScalingConfigurationRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeAutoScalingConfigurationRequest::SetClusterId(const string& _clusterId)
{
