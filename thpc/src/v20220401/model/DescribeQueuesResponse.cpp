...
CoreInternalOutcome DescribeQueuesResponse::Deserialize(const string &payload)
{
...
string DescribeQueuesResponse::ToJsonString() const
{
...
vector<QueueOverview> DescribeQueuesResponse::GetQueueSet() const
{
    return m_queueSet;
}

bool DescribeQueuesResponse::QueueSetHasBeenSet() const
{
    return m_queueSetHasBeenSet;
}

int64_t DescribeQueuesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeQueuesResponse::TotalCountHasBeenSet() const
{
