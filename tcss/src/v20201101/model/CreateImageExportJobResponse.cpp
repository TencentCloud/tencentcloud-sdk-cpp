...
CoreInternalOutcome CreateImageExportJobResponse::Deserialize(const string &payload)
{
...
string CreateImageExportJobResponse::ToJsonString() const
{
...
string CreateImageExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateImageExportJobResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string CreateImageExportJobResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool CreateImageExportJobResponse::DownloadUrlHasBeenSet() const
{
