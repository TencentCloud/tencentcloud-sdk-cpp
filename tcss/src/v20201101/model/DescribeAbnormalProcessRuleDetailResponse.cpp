...
CoreInternalOutcome DescribeAbnormalProcessRuleDetailResponse::Deserialize(const string &payload)
{
...
string DescribeAbnormalProcessRuleDetailResponse::ToJsonString() const
{
...
AbnormalProcessRuleInfo DescribeAbnormalProcessRuleDetailResponse::GetRuleDetail() const
{
    return m_ruleDetail;
}

bool DescribeAbnormalProcessRuleDetailResponse::RuleDetailHasBeenSet() const
{
