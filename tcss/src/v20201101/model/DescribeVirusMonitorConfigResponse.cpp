...
DescribeVirusMonitorConfigResponse::DescribeVirusMonitorConfigResponse() :
...
CoreInternalOutcome DescribeVirusMonitorConfigResponse::Deserialize(const string &payload)
{
...
string DescribeVirusMonitorConfigResponse::ToJsonString() const
{
...
bool DescribeVirusMonitorConfigResponse::GetEnableScan() const
{
    return m_enableScan;
}

bool DescribeVirusMonitorConfigResponse::EnableScanHasBeenSet() const
{
    return m_enableScanHasBeenSet;
}

bool DescribeVirusMonitorConfigResponse::GetIsIncludePath() const
{
    return m_isIncludePath;
}

bool DescribeVirusMonitorConfigResponse::IsIncludePathHasBeenSet() const
{
    return m_isIncludePathHasBeenSet;
}

vector<string> DescribeVirusMonitorConfigResponse::GetScanPath() const
{
    return m_scanPath;
}

bool DescribeVirusMonitorConfigResponse::ScanPathHasBeenSet() const
{
    return m_scanPathHasBeenSet;
}

string DescribeVirusMonitorConfigResponse::GetScanPathMode() const
{
    return m_scanPathMode;
}

bool DescribeVirusMonitorConfigResponse::ScanPathModeHasBeenSet() const
{
