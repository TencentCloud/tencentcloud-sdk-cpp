...
string DescribeAbnormalProcessRulesRequest::ToJsonString() const
{
...
void DescribeAbnormalProcessRulesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeAbnormalProcessRulesRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

uint64_t DescribeAbnormalProcessRulesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAbnormalProcessRulesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeAbnormalProcessRulesRequest::OffsetHasBeenSet() const
{
...
void DescribeAbnormalProcessRulesRequest::SetOrder(const string& _order)
{
    m_order = _order;
