...
CoreInternalOutcome DescribeVirusEventTendencyResponse::Deserialize(const string &payload)
{
...
string DescribeVirusEventTendencyResponse::ToJsonString() const
{
...
vector<VirusTendencyInfo> DescribeVirusEventTendencyResponse::GetList() const
{
    return m_list;
}

bool DescribeVirusEventTendencyResponse::ListHasBeenSet() const
{
