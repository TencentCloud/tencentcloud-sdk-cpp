...
string DescribeCompliancePolicyItemAffectedSummaryRequest::ToJsonString() const
{
...
uint64_t DescribeCompliancePolicyItemAffectedSummaryRequest::GetCustomerPolicyItemId() const
{
    return m_customerPolicyItemId;
}

void DescribeCompliancePolicyItemAffectedSummaryRequest::SetCustomerPolicyItemId(const uint64_t& _customerPolicyItemId)
{
    m_customerPolicyItemId = _customerPolicyItemId;
    m_customerPolicyItemIdHasBeenSet = true;
}

bool DescribeCompliancePolicyItemAffectedSummaryRequest::CustomerPolicyItemIdHasBeenSet() const
{
