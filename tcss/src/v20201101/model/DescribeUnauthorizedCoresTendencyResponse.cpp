...
CoreInternalOutcome DescribeUnauthorizedCoresTendencyResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("List") && !rsp["List"].IsNull())
    {
        ...
        {
            UnauthorizedCoresTendency item;
...
string DescribeUnauthorizedCoresTendencyResponse::ToJsonString() const
{
...
vector<UnauthorizedCoresTendency> DescribeUnauthorizedCoresTendencyResponse::GetList() const
{
    return m_list;
}

bool DescribeUnauthorizedCoresTendencyResponse::ListHasBeenSet() const
{
