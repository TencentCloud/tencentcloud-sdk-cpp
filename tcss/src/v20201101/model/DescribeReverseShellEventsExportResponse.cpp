...
CoreInternalOutcome DescribeReverseShellEventsExportResponse::Deserialize(const string &payload)
{
...
string DescribeReverseShellEventsExportResponse::ToJsonString() const
{
...
string DescribeReverseShellEventsExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeReverseShellEventsExportResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string DescribeReverseShellEventsExportResponse::GetJobId() const
{
    return m_jobId;
}

bool DescribeReverseShellEventsExportResponse::JobIdHasBeenSet() const
{
