...
string DeleteAccessControlRulesRequest::ToJsonString() const
{
...
vector<string> DeleteAccessControlRulesRequest::GetRuleIdSet() const
{
    return m_ruleIdSet;
}

void DeleteAccessControlRulesRequest::SetRuleIdSet(const vector<string>& _ruleIdSet)
{
    m_ruleIdSet = _ruleIdSet;
    m_ruleIdSetHasBeenSet = true;
}

bool DeleteAccessControlRulesRequest::RuleIdSetHasBeenSet() const
{
