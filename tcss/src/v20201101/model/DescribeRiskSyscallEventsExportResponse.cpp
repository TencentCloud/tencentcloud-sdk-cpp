...
CoreInternalOutcome DescribeRiskSyscallEventsExportResponse::Deserialize(const string &payload)
{
...
string DescribeRiskSyscallEventsExportResponse::ToJsonString() const
{
...
string DescribeRiskSyscallEventsExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeRiskSyscallEventsExportResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string DescribeRiskSyscallEventsExportResponse::GetJobId() const
{
    return m_jobId;
}

bool DescribeRiskSyscallEventsExportResponse::JobIdHasBeenSet() const
{
