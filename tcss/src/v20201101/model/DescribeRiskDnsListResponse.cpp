...
vector<RiskDnsEventInfo> DescribeRiskDnsListResponse::GetList() const
{
    return m_list;
}

bool DescribeRiskDnsListResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

int64_t DescribeRiskDnsListResponse::GetTotalCount() const
{
    return m_totalCount;
}
