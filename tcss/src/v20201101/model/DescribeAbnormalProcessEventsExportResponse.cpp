...
CoreInternalOutcome DescribeAbnormalProcessEventsExportResponse::Deserialize(const string &payload)
{
...
string DescribeAbnormalProcessEventsExportResponse::ToJsonString() const
{
...
string DescribeAbnormalProcessEventsExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAbnormalProcessEventsExportResponse::DownloadUrlHasBeenSet() const
{
