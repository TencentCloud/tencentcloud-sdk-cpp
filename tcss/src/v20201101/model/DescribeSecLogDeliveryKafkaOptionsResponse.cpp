...
CoreInternalOutcome DescribeSecLogDeliveryKafkaOptionsResponse::Deserialize(const string &payload)
{
...
string DescribeSecLogDeliveryKafkaOptionsResponse::ToJsonString() const
{
...
vector<CKafkaInstanceInfo> DescribeSecLogDeliveryKafkaOptionsResponse::GetInstanceList() const
{
