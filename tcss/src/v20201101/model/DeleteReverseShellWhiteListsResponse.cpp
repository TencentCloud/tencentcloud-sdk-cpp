...
CoreInternalOutcome DeleteReverseShellWhiteListsResponse::Deserialize(const string &payload)
{
...
string DeleteReverseShellWhiteListsResponse::ToJsonString() const
{
