...
CoreInternalOutcome CreateVulContainerExportJobResponse::Deserialize(const string &payload)
{
...
string CreateVulContainerExportJobResponse::ToJsonString() const
{
...
string CreateVulContainerExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateVulContainerExportJobResponse::JobIdHasBeenSet() const
{
