...
CoreInternalOutcome CreateEscapeWhiteListExportJobResponse::Deserialize(const string &payload)
{
...
string CreateEscapeWhiteListExportJobResponse::ToJsonString() const
{
...
string CreateEscapeWhiteListExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateEscapeWhiteListExportJobResponse::JobIdHasBeenSet() const
{
