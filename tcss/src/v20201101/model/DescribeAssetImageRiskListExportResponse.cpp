...
CoreInternalOutcome DescribeAssetImageRiskListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRiskListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageRiskListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageRiskListExportResponse::DownloadUrlHasBeenSet() const
{
