...
CoreInternalOutcome UpdateImageRegistryTimingScanTaskResponse::Deserialize(const string &payload)
{
...
string UpdateImageRegistryTimingScanTaskResponse::ToJsonString() const
{
