...
string ModifyAccessControlRuleStatusRequest::ToJsonString() const
{
...
vector<string> ModifyAccessControlRuleStatusRequest::GetRuleIdSet() const
{
    return m_ruleIdSet;
}

void ModifyAccessControlRuleStatusRequest::SetRuleIdSet(const vector<string>& _ruleIdSet)
{
    m_ruleIdSet = _ruleIdSet;
    m_ruleIdSetHasBeenSet = true;
}

bool ModifyAccessControlRuleStatusRequest::RuleIdSetHasBeenSet() const
{
    return m_ruleIdSetHasBeenSet;
}

bool ModifyAccessControlRuleStatusRequest::GetIsEnable() const
{
    return m_isEnable;
}

void ModifyAccessControlRuleStatusRequest::SetIsEnable(const bool& _isEnable)
{
    m_isEnable = _isEnable;
    m_isEnableHasBeenSet = true;
}

bool ModifyAccessControlRuleStatusRequest::IsEnableHasBeenSet() const
{
