...
vector<RunTimeFilters> DescribeEmergencyVulListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeEmergencyVulListRequest::SetFilters(const vector<RunTimeFilters>& _filters)
{
    m_filters = _filters;
