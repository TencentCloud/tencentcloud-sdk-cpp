...
CoreInternalOutcome DescribeEscapeEventTendencyResponse::Deserialize(const string &payload)
{
...
string DescribeEscapeEventTendencyResponse::ToJsonString() const
{
...
vector<EscapeEventTendencyInfo> DescribeEscapeEventTendencyResponse::GetList() const
{
    return m_list;
}

bool DescribeEscapeEventTendencyResponse::ListHasBeenSet() const
{
