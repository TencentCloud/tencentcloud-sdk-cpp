...
CoreInternalOutcome DescribeNetworkFirewallPodLabelsListResponse::Deserialize(const string &payload)
{
...
string DescribeNetworkFirewallPodLabelsListResponse::ToJsonString() const
{
...
uint64_t DescribeNetworkFirewallPodLabelsListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeNetworkFirewallPodLabelsListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<NetworkClusterPodInfo> DescribeNetworkFirewallPodLabelsListResponse::GetPodList() const
{
    return m_podList;
}

bool DescribeNetworkFirewallPodLabelsListResponse::PodListHasBeenSet() const
{
