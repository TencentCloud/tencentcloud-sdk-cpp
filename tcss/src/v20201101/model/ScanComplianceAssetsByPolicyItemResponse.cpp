...
CoreInternalOutcome ScanComplianceAssetsByPolicyItemResponse::Deserialize(const string &payload)
{
...
string ScanComplianceAssetsByPolicyItemResponse::ToJsonString() const
{
...
uint64_t ScanComplianceAssetsByPolicyItemResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanComplianceAssetsByPolicyItemResponse::TaskIdHasBeenSet() const
{
