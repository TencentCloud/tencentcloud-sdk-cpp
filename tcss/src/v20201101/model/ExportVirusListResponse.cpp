...
CoreInternalOutcome ExportVirusListResponse::Deserialize(const string &payload)
{
...
string ExportVirusListResponse::ToJsonString() const
{
...
string ExportVirusListResponse::GetJobId() const
{
    return m_jobId;
}

bool ExportVirusListResponse::JobIdHasBeenSet() const
{
