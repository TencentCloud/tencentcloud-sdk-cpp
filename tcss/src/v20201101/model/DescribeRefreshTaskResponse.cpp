...
CoreInternalOutcome DescribeRefreshTaskResponse::Deserialize(const string &payload)
{
...
string DescribeRefreshTaskResponse::ToJsonString() const
{
...
string DescribeRefreshTaskResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeRefreshTaskResponse::TaskStatusHasBeenSet() const
{
