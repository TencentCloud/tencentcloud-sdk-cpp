...
string DeleteReverseShellWhiteListsRequest::ToJsonString() const
{
...
vector<string> DeleteReverseShellWhiteListsRequest::GetWhiteListIdSet() const
{
    return m_whiteListIdSet;
}

void DeleteReverseShellWhiteListsRequest::SetWhiteListIdSet(const vector<string>& _whiteListIdSet)
{
    m_whiteListIdSet = _whiteListIdSet;
    m_whiteListIdSetHasBeenSet = true;
}

bool DeleteReverseShellWhiteListsRequest::WhiteListIdSetHasBeenSet() const
{
