...
CoreInternalOutcome CreateComplianceTaskResponse::Deserialize(const string &payload)
{
...
string CreateComplianceTaskResponse::ToJsonString() const
{
...
uint64_t CreateComplianceTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateComplianceTaskResponse::TaskIdHasBeenSet() const
{
