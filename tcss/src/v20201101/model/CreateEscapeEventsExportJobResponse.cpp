...
CoreInternalOutcome CreateEscapeEventsExportJobResponse::Deserialize(const string &payload)
{
...
string CreateEscapeEventsExportJobResponse::ToJsonString() const
{
...
string CreateEscapeEventsExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateEscapeEventsExportJobResponse::JobIdHasBeenSet() const
{
