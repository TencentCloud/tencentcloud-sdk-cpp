...
CoreInternalOutcome AddEditImageAutoAuthorizedRuleResponse::Deserialize(const string &payload)
{
...
string AddEditImageAutoAuthorizedRuleResponse::ToJsonString() const
{
