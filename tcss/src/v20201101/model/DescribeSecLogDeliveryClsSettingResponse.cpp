...
CoreInternalOutcome DescribeSecLogDeliveryClsSettingResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("LogTypeList") && !rsp["LogTypeList"].IsNull())
    {
        ...
        {
            SecLogDeliveryClsSettingInfo item;
...
string DescribeSecLogDeliveryClsSettingResponse::ToJsonString() const
{
...
vector<SecLogDeliveryClsSettingInfo> DescribeSecLogDeliveryClsSettingResponse::GetLogTypeList() const
{
    return m_logTypeList;
}

bool DescribeSecLogDeliveryClsSettingResponse::LogTypeListHasBeenSet() const
{
