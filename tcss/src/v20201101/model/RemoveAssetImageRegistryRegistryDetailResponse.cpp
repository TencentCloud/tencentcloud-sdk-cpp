...
CoreInternalOutcome RemoveAssetImageRegistryRegistryDetailResponse::Deserialize(const string &payload)
{
...
string RemoveAssetImageRegistryRegistryDetailResponse::ToJsonString() const
{
