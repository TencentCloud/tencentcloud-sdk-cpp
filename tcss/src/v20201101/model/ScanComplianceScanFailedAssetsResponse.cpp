...
CoreInternalOutcome ScanComplianceScanFailedAssetsResponse::Deserialize(const string &payload)
{
...
string ScanComplianceScanFailedAssetsResponse::ToJsonString() const
{
...
uint64_t ScanComplianceScanFailedAssetsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanComplianceScanFailedAssetsResponse::TaskIdHasBeenSet() const
{
