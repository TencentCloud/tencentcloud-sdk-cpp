...
CoreInternalOutcome ModifyAssetImageRegistryScanStopOneKeyResponse::Deserialize(const string &payload)
{
...
string ModifyAssetImageRegistryScanStopOneKeyResponse::ToJsonString() const
{
