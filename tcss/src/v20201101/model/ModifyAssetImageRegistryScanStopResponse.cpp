...
CoreInternalOutcome ModifyAssetImageRegistryScanStopResponse::Deserialize(const string &payload)
{
...
string ModifyAssetImageRegistryScanStopResponse::ToJsonString() const
{
