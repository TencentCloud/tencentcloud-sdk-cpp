...
CoreInternalOutcome DescribeAbnormalProcessEventsResponse::Deserialize(const string &payload)
{
...
string DescribeAbnormalProcessEventsResponse::ToJsonString() const
{
...
uint64_t DescribeAbnormalProcessEventsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAbnormalProcessEventsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AbnormalProcessEventInfo> DescribeAbnormalProcessEventsResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeAbnormalProcessEventsResponse::EventSetHasBeenSet() const
{
