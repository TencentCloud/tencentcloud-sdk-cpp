...
string DeleteRiskSyscallWhiteListsRequest::ToJsonString() const
{
...
vector<string> DeleteRiskSyscallWhiteListsRequest::GetWhiteListIdSet() const
{
    return m_whiteListIdSet;
}

void DeleteRiskSyscallWhiteListsRequest::SetWhiteListIdSet(const vector<string>& _whiteListIdSet)
{
    m_whiteListIdSet = _whiteListIdSet;
    m_whiteListIdSetHasBeenSet = true;
}

bool DeleteRiskSyscallWhiteListsRequest::WhiteListIdSetHasBeenSet() const
{
