...
vector<ReverseShellEventInfo> DescribeReverseShellEventsResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeReverseShellEventsResponse::EventSetHasBeenSet() const
{
