...
CoreInternalOutcome DescribeSecLogAlertMsgResponse::Deserialize(const string &payload)
{
...
string DescribeSecLogAlertMsgResponse::ToJsonString() const
{
...
vector<SecLogAlertMsgInfo> DescribeSecLogAlertMsgResponse::GetList() const
{
    return m_list;
}

bool DescribeSecLogAlertMsgResponse::ListHasBeenSet() const
{
