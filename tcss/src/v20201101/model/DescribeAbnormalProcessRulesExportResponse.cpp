...
CoreInternalOutcome DescribeAbnormalProcessRulesExportResponse::Deserialize(const string &payload)
{
...
string DescribeAbnormalProcessRulesExportResponse::ToJsonString() const
{
...
string DescribeAbnormalProcessRulesExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAbnormalProcessRulesExportResponse::DownloadUrlHasBeenSet() const
{
