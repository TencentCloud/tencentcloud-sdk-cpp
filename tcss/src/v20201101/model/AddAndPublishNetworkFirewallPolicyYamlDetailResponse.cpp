...
CoreInternalOutcome AddAndPublishNetworkFirewallPolicyYamlDetailResponse::Deserialize(const string &payload)
{
...
string AddAndPublishNetworkFirewallPolicyYamlDetailResponse::ToJsonString() const
{
...
uint64_t AddAndPublishNetworkFirewallPolicyYamlDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddAndPublishNetworkFirewallPolicyYamlDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string AddAndPublishNetworkFirewallPolicyYamlDetailResponse::GetResult() const
{
    return m_result;
}

bool AddAndPublishNetworkFirewallPolicyYamlDetailResponse::ResultHasBeenSet() const
{
