...
CoreInternalOutcome UpdateAndPublishNetworkFirewallPolicyDetailResponse::Deserialize(const string &payload)
{
...
string UpdateAndPublishNetworkFirewallPolicyDetailResponse::ToJsonString() const
{
...
uint64_t UpdateAndPublishNetworkFirewallPolicyDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpdateAndPublishNetworkFirewallPolicyDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string UpdateAndPublishNetworkFirewallPolicyDetailResponse::GetResult() const
{
    return m_result;
}

bool UpdateAndPublishNetworkFirewallPolicyDetailResponse::ResultHasBeenSet() const
{
