...
CoreInternalOutcome CreateVulExportJobResponse::Deserialize(const string &payload)
{
...
string CreateVulExportJobResponse::ToJsonString() const
{
...
string CreateVulExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateVulExportJobResponse::JobIdHasBeenSet() const
{
