...
CoreInternalOutcome DescribeVirusScanTimeoutSettingResponse::Deserialize(const string &payload)
{
...
string DescribeVirusScanTimeoutSettingResponse::ToJsonString() const
{
...
uint64_t DescribeVirusScanTimeoutSettingResponse::GetTimeout() const
{
    return m_timeout;
}

bool DescribeVirusScanTimeoutSettingResponse::TimeoutHasBeenSet() const
{
