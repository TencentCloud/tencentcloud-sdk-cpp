...
CoreInternalOutcome UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::Deserialize(const string &payload)
{
...
string UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::ToJsonString() const
{
...
uint64_t UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::GetResult() const
{
    return m_result;
}

bool UpdateAndPublishNetworkFirewallPolicyYamlDetailResponse::ResultHasBeenSet() const
{
