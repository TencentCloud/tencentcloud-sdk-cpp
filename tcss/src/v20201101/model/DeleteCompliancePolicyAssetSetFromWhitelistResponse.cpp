...
CoreInternalOutcome DeleteCompliancePolicyAssetSetFromWhitelistResponse::Deserialize(const string &payload)
{
...
string DeleteCompliancePolicyAssetSetFromWhitelistResponse::ToJsonString() const
{
