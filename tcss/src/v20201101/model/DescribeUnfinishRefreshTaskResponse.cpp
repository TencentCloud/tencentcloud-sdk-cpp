...
CoreInternalOutcome DescribeUnfinishRefreshTaskResponse::Deserialize(const string &payload)
{
...
string DescribeUnfinishRefreshTaskResponse::ToJsonString() const
{
...
uint64_t DescribeUnfinishRefreshTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeUnfinishRefreshTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string DescribeUnfinishRefreshTaskResponse::GetTaskStatus() const
{
    return m_taskStatus;
}
