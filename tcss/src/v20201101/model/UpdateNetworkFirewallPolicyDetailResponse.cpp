...
CoreInternalOutcome UpdateNetworkFirewallPolicyDetailResponse::Deserialize(const string &payload)
{
...
string UpdateNetworkFirewallPolicyDetailResponse::ToJsonString() const
{
...
uint64_t UpdateNetworkFirewallPolicyDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpdateNetworkFirewallPolicyDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string UpdateNetworkFirewallPolicyDetailResponse::GetResult() const
{
    return m_result;
}

bool UpdateNetworkFirewallPolicyDetailResponse::ResultHasBeenSet() const
{
