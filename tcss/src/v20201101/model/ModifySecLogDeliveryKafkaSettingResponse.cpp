...
CoreInternalOutcome ModifySecLogDeliveryKafkaSettingResponse::Deserialize(const string &payload)
{
...
string ModifySecLogDeliveryKafkaSettingResponse::ToJsonString() const
{
