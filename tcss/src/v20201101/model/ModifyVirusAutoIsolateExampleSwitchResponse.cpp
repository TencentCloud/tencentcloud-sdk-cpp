...
CoreInternalOutcome ModifyVirusAutoIsolateExampleSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyVirusAutoIsolateExampleSwitchResponse::ToJsonString() const
{
