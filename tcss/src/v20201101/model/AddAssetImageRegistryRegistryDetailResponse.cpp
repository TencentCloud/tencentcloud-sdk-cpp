...
CoreInternalOutcome AddAssetImageRegistryRegistryDetailResponse::Deserialize(const string &payload)
{
...
string AddAssetImageRegistryRegistryDetailResponse::ToJsonString() const
{
...
string AddAssetImageRegistryRegistryDetailResponse::GetHealthCheckErr() const
{
    return m_healthCheckErr;
}

bool AddAssetImageRegistryRegistryDetailResponse::HealthCheckErrHasBeenSet() const
{
    return m_healthCheckErrHasBeenSet;
}

string AddAssetImageRegistryRegistryDetailResponse::GetNameRepeatErr() const
{
    return m_nameRepeatErr;
}

bool AddAssetImageRegistryRegistryDetailResponse::NameRepeatErrHasBeenSet() const
{
    return m_nameRepeatErrHasBeenSet;
}

int64_t AddAssetImageRegistryRegistryDetailResponse::GetRegistryId() const
{
    return m_registryId;
}

bool AddAssetImageRegistryRegistryDetailResponse::RegistryIdHasBeenSet() const
{
