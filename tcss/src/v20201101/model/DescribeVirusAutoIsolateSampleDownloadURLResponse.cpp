...
CoreInternalOutcome DescribeVirusAutoIsolateSampleDownloadURLResponse::Deserialize(const string &payload)
{
...
string DescribeVirusAutoIsolateSampleDownloadURLResponse::ToJsonString() const
{
...
string DescribeVirusAutoIsolateSampleDownloadURLResponse::GetFileUrl() const
{
    return m_fileUrl;
}

bool DescribeVirusAutoIsolateSampleDownloadURLResponse::FileUrlHasBeenSet() const
{
