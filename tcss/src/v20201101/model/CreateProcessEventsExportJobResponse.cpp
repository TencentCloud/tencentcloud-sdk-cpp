...
CoreInternalOutcome CreateProcessEventsExportJobResponse::Deserialize(const string &payload)
{
...
string CreateProcessEventsExportJobResponse::ToJsonString() const
{
...
string CreateProcessEventsExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateProcessEventsExportJobResponse::JobIdHasBeenSet() const
{
