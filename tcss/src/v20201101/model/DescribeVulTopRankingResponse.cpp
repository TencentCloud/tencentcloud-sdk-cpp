...
CoreInternalOutcome DescribeVulTopRankingResponse::Deserialize(const string &payload)
{
...
string DescribeVulTopRankingResponse::ToJsonString() const
{
...
vector<VulTopRankingInfo> DescribeVulTopRankingResponse::GetList() const
{
    return m_list;
}

bool DescribeVulTopRankingResponse::ListHasBeenSet() const
{
