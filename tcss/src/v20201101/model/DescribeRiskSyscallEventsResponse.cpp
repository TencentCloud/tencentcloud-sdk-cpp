...
CoreInternalOutcome DescribeRiskSyscallEventsResponse::Deserialize(const string &payload)
{
...
string DescribeRiskSyscallEventsResponse::ToJsonString() const
{
...
uint64_t DescribeRiskSyscallEventsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRiskSyscallEventsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RiskSyscallEventInfo> DescribeRiskSyscallEventsResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeRiskSyscallEventsResponse::EventSetHasBeenSet() const
{
