...
CoreInternalOutcome DescribeReverseShellDetailResponse::Deserialize(const string &payload)
{
...
string DescribeReverseShellDetailResponse::ToJsonString() const
{
...
RunTimeEventBaseInfo DescribeReverseShellDetailResponse::GetEventBaseInfo() const
{
    return m_eventBaseInfo;
}

bool DescribeReverseShellDetailResponse::EventBaseInfoHasBeenSet() const
{
    return m_eventBaseInfoHasBeenSet;
}

ProcessDetailInfo DescribeReverseShellDetailResponse::GetProcessInfo() const
{
    return m_processInfo;
}

bool DescribeReverseShellDetailResponse::ProcessInfoHasBeenSet() const
{
    return m_processInfoHasBeenSet;
}

ProcessDetailBaseInfo DescribeReverseShellDetailResponse::GetParentProcessInfo() const
{
    return m_parentProcessInfo;
}

bool DescribeReverseShellDetailResponse::ParentProcessInfoHasBeenSet() const
{
    return m_parentProcessInfoHasBeenSet;
}

ReverseShellEventDescription DescribeReverseShellDetailResponse::GetEventDetail() const
{
