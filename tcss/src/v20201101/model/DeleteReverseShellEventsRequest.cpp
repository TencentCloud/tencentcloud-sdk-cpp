...
string DeleteReverseShellEventsRequest::ToJsonString() const
{
...
vector<string> DeleteReverseShellEventsRequest::GetEventIdSet() const
{
    return m_eventIdSet;
}

void DeleteReverseShellEventsRequest::SetEventIdSet(const vector<string>& _eventIdSet)
{
    m_eventIdSet = _eventIdSet;
    m_eventIdSetHasBeenSet = true;
}

bool DeleteReverseShellEventsRequest::EventIdSetHasBeenSet() const
{
