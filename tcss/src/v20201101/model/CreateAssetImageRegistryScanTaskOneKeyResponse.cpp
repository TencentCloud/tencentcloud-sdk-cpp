...
CoreInternalOutcome CreateAssetImageRegistryScanTaskOneKeyResponse::Deserialize(const string &payload)
{
...
string CreateAssetImageRegistryScanTaskOneKeyResponse::ToJsonString() const
{
...
uint64_t CreateAssetImageRegistryScanTaskOneKeyResponse::GetTaskID() const
{
    return m_taskID;
}

bool CreateAssetImageRegistryScanTaskOneKeyResponse::TaskIDHasBeenSet() const
{
