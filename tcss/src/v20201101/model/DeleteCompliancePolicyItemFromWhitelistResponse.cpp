...
CoreInternalOutcome DeleteCompliancePolicyItemFromWhitelistResponse::Deserialize(const string &payload)
{
...
string DeleteCompliancePolicyItemFromWhitelistResponse::ToJsonString() const
{
