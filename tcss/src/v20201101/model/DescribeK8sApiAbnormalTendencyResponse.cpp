...
CoreInternalOutcome DescribeK8sApiAbnormalTendencyResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("List") && !rsp["List"].IsNull())
    {
        ...
        {
            K8sApiAbnormalTendencyItem item;
...
string DescribeK8sApiAbnormalTendencyResponse::ToJsonString() const
{
...
vector<K8sApiAbnormalTendencyItem> DescribeK8sApiAbnormalTendencyResponse::GetList() const
{
    return m_list;
}
