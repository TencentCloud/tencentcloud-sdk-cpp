...
CoreInternalOutcome DescribeESHitsResponse::Deserialize(const string &payload)
{
...
string DescribeESHitsResponse::ToJsonString() const
{
...
string DescribeESHitsResponse::GetData() const
{
    return m_data;
}

bool DescribeESHitsResponse::DataHasBeenSet() const
{
