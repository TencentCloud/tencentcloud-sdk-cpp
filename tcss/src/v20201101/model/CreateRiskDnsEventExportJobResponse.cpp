...
CoreInternalOutcome CreateRiskDnsEventExportJobResponse::Deserialize(const string &payload)
{
...
string CreateRiskDnsEventExportJobResponse::ToJsonString() const
{
...
string CreateRiskDnsEventExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateRiskDnsEventExportJobResponse::JobIdHasBeenSet() const
{
