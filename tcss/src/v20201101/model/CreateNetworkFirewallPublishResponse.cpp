...
CoreInternalOutcome CreateNetworkFirewallPublishResponse::Deserialize(const string &payload)
{
...
string CreateNetworkFirewallPublishResponse::ToJsonString() const
{
...
uint64_t CreateNetworkFirewallPublishResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateNetworkFirewallPublishResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateNetworkFirewallPublishResponse::GetResult() const
{
    return m_result;
}

bool CreateNetworkFirewallPublishResponse::ResultHasBeenSet() const
{
