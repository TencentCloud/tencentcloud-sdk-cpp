...
CoreInternalOutcome AddNetworkFirewallPolicyDetailResponse::Deserialize(const string &payload)
{
...
string AddNetworkFirewallPolicyDetailResponse::ToJsonString() const
{
...
uint64_t AddNetworkFirewallPolicyDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddNetworkFirewallPolicyDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string AddNetworkFirewallPolicyDetailResponse::GetResult() const
{
    return m_result;
}

bool AddNetworkFirewallPolicyDetailResponse::ResultHasBeenSet() const
{
