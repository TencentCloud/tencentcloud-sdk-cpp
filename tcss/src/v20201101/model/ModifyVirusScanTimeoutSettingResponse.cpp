...
CoreInternalOutcome ModifyVirusScanTimeoutSettingResponse::Deserialize(const string &payload)
{
...
string ModifyVirusScanTimeoutSettingResponse::ToJsonString() const
{
