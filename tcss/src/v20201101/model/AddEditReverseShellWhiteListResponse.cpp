...
CoreInternalOutcome AddEditReverseShellWhiteListResponse::Deserialize(const string &payload)
{
...
string AddEditReverseShellWhiteListResponse::ToJsonString() const
{
