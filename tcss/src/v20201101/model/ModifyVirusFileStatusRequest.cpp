...
string ModifyVirusFileStatusRequest::ToJsonString() const
{
...
vector<string> ModifyVirusFileStatusRequest::GetEventIdSet() const
{
    return m_eventIdSet;
}

void ModifyVirusFileStatusRequest::SetEventIdSet(const vector<string>& _eventIdSet)
{
    m_eventIdSet = _eventIdSet;
    m_eventIdSetHasBeenSet = true;
}

bool ModifyVirusFileStatusRequest::EventIdSetHasBeenSet() const
{
    return m_eventIdSetHasBeenSet;
}

string ModifyVirusFileStatusRequest::GetStatus() const
{
    return m_status;
}

void ModifyVirusFileStatusRequest::SetStatus(const string& _status)
{
    m_status = _status;
    m_statusHasBeenSet = true;
}

bool ModifyVirusFileStatusRequest::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyVirusFileStatusRequest::GetRemark() const
{
    return m_remark;
}

void ModifyVirusFileStatusRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
