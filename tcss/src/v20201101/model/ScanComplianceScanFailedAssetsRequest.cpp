...
string ScanComplianceScanFailedAssetsRequest::ToJsonString() const
{
...
vector<uint64_t> ScanComplianceScanFailedAssetsRequest::GetCustomerAssetIdSet() const
{
    return m_customerAssetIdSet;
}

void ScanComplianceScanFailedAssetsRequest::SetCustomerAssetIdSet(const vector<uint64_t>& _customerAssetIdSet)
{
    m_customerAssetIdSet = _customerAssetIdSet;
    m_customerAssetIdSetHasBeenSet = true;
}

bool ScanComplianceScanFailedAssetsRequest::CustomerAssetIdSetHasBeenSet() const
{
    return m_customerAssetIdSetHasBeenSet;
}

string ScanComplianceScanFailedAssetsRequest::GetAssetType() const
{
    return m_assetType;
}

void ScanComplianceScanFailedAssetsRequest::SetAssetType(const string& _assetType)
{
    m_assetType = _assetType;
    m_assetTypeHasBeenSet = true;
}

bool ScanComplianceScanFailedAssetsRequest::AssetTypeHasBeenSet() const
{
