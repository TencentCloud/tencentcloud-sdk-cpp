...
CoreInternalOutcome ConfirmNetworkFirewallPolicyResponse::Deserialize(const string &payload)
{
...
string ConfirmNetworkFirewallPolicyResponse::ToJsonString() const
{
...
uint64_t ConfirmNetworkFirewallPolicyResponse::GetTaskId() const
{
    return m_taskId;
}

bool ConfirmNetworkFirewallPolicyResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string ConfirmNetworkFirewallPolicyResponse::GetResult() const
{
    return m_result;
}

bool ConfirmNetworkFirewallPolicyResponse::ResultHasBeenSet() const
{
