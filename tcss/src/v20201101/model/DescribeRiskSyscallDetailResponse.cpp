...
CoreInternalOutcome DescribeRiskSyscallDetailResponse::Deserialize(const string &payload)
{
...
string DescribeRiskSyscallDetailResponse::ToJsonString() const
{
...
RunTimeEventBaseInfo DescribeRiskSyscallDetailResponse::GetEventBaseInfo() const
{
    return m_eventBaseInfo;
}

bool DescribeRiskSyscallDetailResponse::EventBaseInfoHasBeenSet() const
{
    return m_eventBaseInfoHasBeenSet;
}

ProcessDetailInfo DescribeRiskSyscallDetailResponse::GetProcessInfo() const
{
    return m_processInfo;
}

bool DescribeRiskSyscallDetailResponse::ProcessInfoHasBeenSet() const
{
    return m_processInfoHasBeenSet;
}

ProcessDetailBaseInfo DescribeRiskSyscallDetailResponse::GetParentProcessInfo() const
{
    return m_parentProcessInfo;
}

bool DescribeRiskSyscallDetailResponse::ParentProcessInfoHasBeenSet() const
{
    return m_parentProcessInfoHasBeenSet;
}

RiskSyscallEventDescription DescribeRiskSyscallDetailResponse::GetEventDetail() const
{
    return m_eventDetail;
}

bool DescribeRiskSyscallDetailResponse::EventDetailHasBeenSet() const
{
    return m_eventDetailHasBeenSet;
}

ProcessBaseInfo DescribeRiskSyscallDetailResponse::GetAncestorProcessInfo() const
{
    return m_ancestorProcessInfo;
}

bool DescribeRiskSyscallDetailResponse::AncestorProcessInfoHasBeenSet() const
{
