...
CoreInternalOutcome DescribeExportJobDownloadURLResponse::Deserialize(const string &payload)
{
...
string DescribeExportJobDownloadURLResponse::ToJsonString() const
{
...
string DescribeExportJobDownloadURLResponse::GetDownloadURL() const
{
    return m_downloadURL;
}

bool DescribeExportJobDownloadURLResponse::DownloadURLHasBeenSet() const
{
