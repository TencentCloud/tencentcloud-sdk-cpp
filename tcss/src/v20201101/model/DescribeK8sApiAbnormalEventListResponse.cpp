...
CoreInternalOutcome DescribeK8sApiAbnormalEventListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("List") && !rsp["List"].IsNull())
    {
        ...
        {
            K8sApiAbnormalEventListItem item;
...
string DescribeK8sApiAbnormalEventListResponse::ToJsonString() const
{
...
vector<K8sApiAbnormalEventListItem> DescribeK8sApiAbnormalEventListResponse::GetList() const
{
    return m_list;
}

bool DescribeK8sApiAbnormalEventListResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeK8sApiAbnormalEventListResponse::GetTotalCount() const
{
    return m_totalCount;
}
