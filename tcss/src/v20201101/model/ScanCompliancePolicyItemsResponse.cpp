...
CoreInternalOutcome ScanCompliancePolicyItemsResponse::Deserialize(const string &payload)
{
...
string ScanCompliancePolicyItemsResponse::ToJsonString() const
{
...
uint64_t ScanCompliancePolicyItemsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanCompliancePolicyItemsResponse::TaskIdHasBeenSet() const
{
