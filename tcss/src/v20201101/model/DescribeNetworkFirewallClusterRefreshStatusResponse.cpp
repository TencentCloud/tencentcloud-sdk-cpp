...
CoreInternalOutcome DescribeNetworkFirewallClusterRefreshStatusResponse::Deserialize(const string &payload)
{
...
string DescribeNetworkFirewallClusterRefreshStatusResponse::ToJsonString() const
{
...
string DescribeNetworkFirewallClusterRefreshStatusResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeNetworkFirewallClusterRefreshStatusResponse::TaskStatusHasBeenSet() const
{
