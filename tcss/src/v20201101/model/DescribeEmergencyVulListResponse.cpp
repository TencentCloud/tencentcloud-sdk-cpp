...
int64_t DescribeEmergencyVulListResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<EmergencyVulInfo> DescribeEmergencyVulListResponse::GetList() const
{
    return m_list;
}
