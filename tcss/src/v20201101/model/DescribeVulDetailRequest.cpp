...
string DescribeVulDetailRequest::GetPocID() const
{
    return m_pocID;
}

void DescribeVulDetailRequest::SetPocID(const string& _pocID)
{
    m_pocID = _pocID;
    m_pocIDHasBeenSet = true;
}

bool DescribeVulDetailRequest::PocIDHasBeenSet() const
{
