...
CoreInternalOutcome CreateVulDefenceEventExportJobResponse::Deserialize(const string &payload)
{
...
string CreateVulDefenceEventExportJobResponse::ToJsonString() const
{
...
string CreateVulDefenceEventExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateVulDefenceEventExportJobResponse::JobIdHasBeenSet() const
{
