...
CoreInternalOutcome CreateAssetImageRegistryScanTaskResponse::Deserialize(const string &payload)
{
...
string CreateAssetImageRegistryScanTaskResponse::ToJsonString() const
{
