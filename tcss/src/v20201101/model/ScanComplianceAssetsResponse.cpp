...
CoreInternalOutcome ScanComplianceAssetsResponse::Deserialize(const string &payload)
{
...
string ScanComplianceAssetsResponse::ToJsonString() const
{
...
uint64_t ScanComplianceAssetsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanComplianceAssetsResponse::TaskIdHasBeenSet() const
{
