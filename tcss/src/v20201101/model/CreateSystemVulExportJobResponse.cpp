...
CoreInternalOutcome CreateSystemVulExportJobResponse::Deserialize(const string &payload)
{
...
string CreateSystemVulExportJobResponse::ToJsonString() const
{
...
string CreateSystemVulExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateSystemVulExportJobResponse::JobIdHasBeenSet() const
{
