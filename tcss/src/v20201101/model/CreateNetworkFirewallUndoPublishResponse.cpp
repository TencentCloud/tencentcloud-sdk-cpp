...
CoreInternalOutcome CreateNetworkFirewallUndoPublishResponse::Deserialize(const string &payload)
{
...
string CreateNetworkFirewallUndoPublishResponse::ToJsonString() const
{
...
uint64_t CreateNetworkFirewallUndoPublishResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateNetworkFirewallUndoPublishResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateNetworkFirewallUndoPublishResponse::GetResult() const
{
    return m_result;
}

bool CreateNetworkFirewallUndoPublishResponse::ResultHasBeenSet() const
{
