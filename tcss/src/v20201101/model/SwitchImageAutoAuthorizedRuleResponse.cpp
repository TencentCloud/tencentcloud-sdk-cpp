...
CoreInternalOutcome SwitchImageAutoAuthorizedRuleResponse::Deserialize(const string &payload)
{
...
string SwitchImageAutoAuthorizedRuleResponse::ToJsonString() const
{
