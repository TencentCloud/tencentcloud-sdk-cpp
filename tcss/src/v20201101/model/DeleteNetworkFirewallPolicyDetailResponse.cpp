...
CoreInternalOutcome DeleteNetworkFirewallPolicyDetailResponse::Deserialize(const string &payload)
{
...
string DeleteNetworkFirewallPolicyDetailResponse::ToJsonString() const
{
...
uint64_t DeleteNetworkFirewallPolicyDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteNetworkFirewallPolicyDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string DeleteNetworkFirewallPolicyDetailResponse::GetResult() const
{
    return m_result;
}

bool DeleteNetworkFirewallPolicyDetailResponse::ResultHasBeenSet() const
{
