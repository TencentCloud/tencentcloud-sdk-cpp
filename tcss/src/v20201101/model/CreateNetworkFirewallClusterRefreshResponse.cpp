...
CoreInternalOutcome CreateNetworkFirewallClusterRefreshResponse::Deserialize(const string &payload)
{
...
string CreateNetworkFirewallClusterRefreshResponse::ToJsonString() const
{
...
uint64_t CreateNetworkFirewallClusterRefreshResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateNetworkFirewallClusterRefreshResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateNetworkFirewallClusterRefreshResponse::GetResult() const
{
    return m_result;
}

bool CreateNetworkFirewallClusterRefreshResponse::ResultHasBeenSet() const
{
