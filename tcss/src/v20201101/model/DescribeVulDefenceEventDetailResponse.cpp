...
CoreInternalOutcome DescribeVulDefenceEventDetailResponse::Deserialize(const string &payload)
{
...
string DescribeVulDefenceEventDetailResponse::ToJsonString() const
{
...
VulDefenceEventDetail DescribeVulDefenceEventDetailResponse::GetEventDetail() const
{
    return m_eventDetail;
}

bool DescribeVulDefenceEventDetailResponse::EventDetailHasBeenSet() const
{
