...
CoreInternalOutcome CreateExportComplianceStatusListJobResponse::Deserialize(const string &payload)
{
...
string CreateExportComplianceStatusListJobResponse::ToJsonString() const
{
...
string CreateExportComplianceStatusListJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateExportComplianceStatusListJobResponse::JobIdHasBeenSet() const
{
