...
CoreInternalOutcome DescribeEscapeEventDetailResponse::Deserialize(const string &payload)
{
...
string DescribeEscapeEventDetailResponse::ToJsonString() const
{
...
RunTimeEventBaseInfo DescribeEscapeEventDetailResponse::GetEventBaseInfo() const
{
    return m_eventBaseInfo;
}

bool DescribeEscapeEventDetailResponse::EventBaseInfoHasBeenSet() const
{
    return m_eventBaseInfoHasBeenSet;
}

ProcessDetailInfo DescribeEscapeEventDetailResponse::GetProcessInfo() const
{
    return m_processInfo;
}

bool DescribeEscapeEventDetailResponse::ProcessInfoHasBeenSet() const
{
    return m_processInfoHasBeenSet;
}

EscapeEventDescription DescribeEscapeEventDetailResponse::GetEventDetail() const
{
    return m_eventDetail;
}

bool DescribeEscapeEventDetailResponse::EventDetailHasBeenSet() const
{
    return m_eventDetailHasBeenSet;
}

ProcessBaseInfo DescribeEscapeEventDetailResponse::GetParentProcessInfo() const
{
    return m_parentProcessInfo;
}

bool DescribeEscapeEventDetailResponse::ParentProcessInfoHasBeenSet() const
{
    return m_parentProcessInfoHasBeenSet;
}

ProcessBaseInfo DescribeEscapeEventDetailResponse::GetAncestorProcessInfo() const
{
    return m_ancestorProcessInfo;
}

bool DescribeEscapeEventDetailResponse::AncestorProcessInfoHasBeenSet() const
{
