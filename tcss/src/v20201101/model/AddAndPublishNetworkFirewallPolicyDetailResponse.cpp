...
CoreInternalOutcome AddAndPublishNetworkFirewallPolicyDetailResponse::Deserialize(const string &payload)
{
...
string AddAndPublishNetworkFirewallPolicyDetailResponse::ToJsonString() const
{
...
uint64_t AddAndPublishNetworkFirewallPolicyDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddAndPublishNetworkFirewallPolicyDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string AddAndPublishNetworkFirewallPolicyDetailResponse::GetResult() const
{
    return m_result;
}

bool AddAndPublishNetworkFirewallPolicyDetailResponse::ResultHasBeenSet() const
{
