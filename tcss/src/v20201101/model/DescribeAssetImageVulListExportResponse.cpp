...
CoreInternalOutcome DescribeAssetImageVulListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageVulListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageVulListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageVulListExportResponse::DownloadUrlHasBeenSet() const
{
