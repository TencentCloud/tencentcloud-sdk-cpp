...
CoreInternalOutcome DescribeSecLogJoinTypeListResponse::Deserialize(const string &payload)
{
...
string DescribeSecLogJoinTypeListResponse::ToJsonString() const
{
...
vector<SecLogJoinInfo> DescribeSecLogJoinTypeListResponse::GetList() const
{
    return m_list;
}
