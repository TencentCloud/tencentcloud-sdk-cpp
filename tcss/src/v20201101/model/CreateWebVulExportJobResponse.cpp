...
CoreInternalOutcome CreateWebVulExportJobResponse::Deserialize(const string &payload)
{
...
string CreateWebVulExportJobResponse::ToJsonString() const
{
...
string CreateWebVulExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateWebVulExportJobResponse::JobIdHasBeenSet() const
{
