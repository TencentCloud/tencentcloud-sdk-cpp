...
string DescribeAssetContainerDetailRequest::ToJsonString() const
{
...
string DescribeAssetContainerDetailRequest::GetContainerId() const
{
    return m_containerId;
}

void DescribeAssetContainerDetailRequest::SetContainerId(const string& _containerId)
{
    m_containerId = _containerId;
    m_containerIdHasBeenSet = true;
}

bool DescribeAssetContainerDetailRequest::ContainerIdHasBeenSet() const
{
