...
CoreInternalOutcome DescribePromotionActivityResponse::Deserialize(const string &payload)
{
...
string DescribePromotionActivityResponse::ToJsonString() const
{
...
vector<PromotionActivityContent> DescribePromotionActivityResponse::GetList() const
{
    return m_list;
}

bool DescribePromotionActivityResponse::ListHasBeenSet() const
{
