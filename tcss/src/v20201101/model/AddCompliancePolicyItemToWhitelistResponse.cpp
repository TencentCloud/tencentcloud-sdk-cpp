...
CoreInternalOutcome AddCompliancePolicyItemToWhitelistResponse::Deserialize(const string &payload)
{
...
string AddCompliancePolicyItemToWhitelistResponse::ToJsonString() const
{
