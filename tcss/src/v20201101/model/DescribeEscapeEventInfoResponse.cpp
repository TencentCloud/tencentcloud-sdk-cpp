...
CoreInternalOutcome DescribeEscapeEventInfoResponse::Deserialize(const string &payload)
{
...
string DescribeEscapeEventInfoResponse::ToJsonString() const
{
...
vector<EscapeEventInfo> DescribeEscapeEventInfoResponse::GetEventSet() const
{
    return m_eventSet;
}

bool DescribeEscapeEventInfoResponse::EventSetHasBeenSet() const
{
    return m_eventSetHasBeenSet;
}

uint64_t DescribeEscapeEventInfoResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeEscapeEventInfoResponse::TotalCountHasBeenSet() const
{
