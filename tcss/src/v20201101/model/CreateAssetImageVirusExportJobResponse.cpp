...
CoreInternalOutcome CreateAssetImageVirusExportJobResponse::Deserialize(const string &payload)
{
...
string CreateAssetImageVirusExportJobResponse::ToJsonString() const
{
...
string CreateAssetImageVirusExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateAssetImageVirusExportJobResponse::JobIdHasBeenSet() const
{
