...
CoreInternalOutcome CreateVulDefenceHostExportJobResponse::Deserialize(const string &payload)
{
...
string CreateVulDefenceHostExportJobResponse::ToJsonString() const
{
...
string CreateVulDefenceHostExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateVulDefenceHostExportJobResponse::JobIdHasBeenSet() const
{
