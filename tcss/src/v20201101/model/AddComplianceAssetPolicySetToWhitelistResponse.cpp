...
CoreInternalOutcome AddComplianceAssetPolicySetToWhitelistResponse::Deserialize(const string &payload)
{
...
string AddComplianceAssetPolicySetToWhitelistResponse::ToJsonString() const
{
