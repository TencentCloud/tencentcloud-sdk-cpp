...
CoreInternalOutcome DescribeAssetImageVirusListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageVirusListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageVirusListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageVirusListExportResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string DescribeAssetImageVirusListExportResponse::GetJobId() const
{
    return m_jobId;
}

bool DescribeAssetImageVirusListExportResponse::JobIdHasBeenSet() const
{
