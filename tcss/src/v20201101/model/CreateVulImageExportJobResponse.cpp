...
CoreInternalOutcome CreateVulImageExportJobResponse::Deserialize(const string &payload)
{
...
string CreateVulImageExportJobResponse::ToJsonString() const
{
...
string CreateVulImageExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateVulImageExportJobResponse::JobIdHasBeenSet() const
{
