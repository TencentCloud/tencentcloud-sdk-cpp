...
string ModifyEscapeRuleRequest::ToJsonString() const
{
...
vector<EscapeRuleEnabled> ModifyEscapeRuleRequest::GetRuleSet() const
{
    return m_ruleSet;
}

void ModifyEscapeRuleRequest::SetRuleSet(const vector<EscapeRuleEnabled>& _ruleSet)
{
    m_ruleSet = _ruleSet;
    m_ruleSetHasBeenSet = true;
}

bool ModifyEscapeRuleRequest::RuleSetHasBeenSet() const
{
