...
CoreInternalOutcome DescribeNetworkFirewallPolicyDiscoverResponse::Deserialize(const string &payload)
{
...
string DescribeNetworkFirewallPolicyDiscoverResponse::ToJsonString() const
{
...
string DescribeNetworkFirewallPolicyDiscoverResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeNetworkFirewallPolicyDiscoverResponse::TaskStatusHasBeenSet() const
{
