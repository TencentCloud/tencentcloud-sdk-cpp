...
CoreInternalOutcome CreateHostExportJobResponse::Deserialize(const string &payload)
{
...
string CreateHostExportJobResponse::ToJsonString() const
{
...
string CreateHostExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateHostExportJobResponse::JobIdHasBeenSet() const
{
