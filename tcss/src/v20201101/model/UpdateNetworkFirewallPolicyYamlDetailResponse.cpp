...
CoreInternalOutcome UpdateNetworkFirewallPolicyYamlDetailResponse::Deserialize(const string &payload)
{
...
string UpdateNetworkFirewallPolicyYamlDetailResponse::ToJsonString() const
{
...
uint64_t UpdateNetworkFirewallPolicyYamlDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpdateNetworkFirewallPolicyYamlDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string UpdateNetworkFirewallPolicyYamlDetailResponse::GetResult() const
{
    return m_result;
}

bool UpdateNetworkFirewallPolicyYamlDetailResponse::ResultHasBeenSet() const
{
