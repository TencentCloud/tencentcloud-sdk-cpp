...
CoreInternalOutcome ModifySecLogCleanSettingInfoResponse::Deserialize(const string &payload)
{
...
string ModifySecLogCleanSettingInfoResponse::ToJsonString() const
{
