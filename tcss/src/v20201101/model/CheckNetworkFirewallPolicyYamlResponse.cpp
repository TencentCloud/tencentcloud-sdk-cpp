...
CoreInternalOutcome CheckNetworkFirewallPolicyYamlResponse::Deserialize(const string &payload)
{
...
string CheckNetworkFirewallPolicyYamlResponse::ToJsonString() const
{
...
uint64_t CheckNetworkFirewallPolicyYamlResponse::GetTaskId() const
{
    return m_taskId;
}

bool CheckNetworkFirewallPolicyYamlResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CheckNetworkFirewallPolicyYamlResponse::GetResult() const
{
    return m_result;
}

bool CheckNetworkFirewallPolicyYamlResponse::ResultHasBeenSet() const
{
