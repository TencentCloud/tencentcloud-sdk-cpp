...
CoreInternalOutcome CreateDefenceVulExportJobResponse::Deserialize(const string &payload)
{
...
string CreateDefenceVulExportJobResponse::ToJsonString() const
{
...
string CreateDefenceVulExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateDefenceVulExportJobResponse::JobIdHasBeenSet() const
{
