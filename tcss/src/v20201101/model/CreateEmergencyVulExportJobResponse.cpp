...
CoreInternalOutcome CreateEmergencyVulExportJobResponse::Deserialize(const string &payload)
{
...
string CreateEmergencyVulExportJobResponse::ToJsonString() const
{
...
string CreateEmergencyVulExportJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateEmergencyVulExportJobResponse::JobIdHasBeenSet() const
{
