...
CoreInternalOutcome DeleteComplianceAssetPolicySetFromWhitelistResponse::Deserialize(const string &payload)
{
...
string DeleteComplianceAssetPolicySetFromWhitelistResponse::ToJsonString() const
{
