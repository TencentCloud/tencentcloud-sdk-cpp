...
CoreInternalOutcome ModifyVirusAutoIsolateSettingResponse::Deserialize(const string &payload)
{
...
string ModifyVirusAutoIsolateSettingResponse::ToJsonString() const
{
