...
CoreInternalOutcome CreateNetworkFirewallPolicyDiscoverResponse::Deserialize(const string &payload)
{
...
string CreateNetworkFirewallPolicyDiscoverResponse::ToJsonString() const
{
...
uint64_t CreateNetworkFirewallPolicyDiscoverResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateNetworkFirewallPolicyDiscoverResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateNetworkFirewallPolicyDiscoverResponse::GetResult() const
{
    return m_result;
}

bool CreateNetworkFirewallPolicyDiscoverResponse::ResultHasBeenSet() const
{
