...
CoreInternalOutcome ModifySecLogDeliveryClsSettingResponse::Deserialize(const string &payload)
{
...
string ModifySecLogDeliveryClsSettingResponse::ToJsonString() const
{
