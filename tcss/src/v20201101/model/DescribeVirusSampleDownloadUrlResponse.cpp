...
CoreInternalOutcome DescribeVirusSampleDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeVirusSampleDownloadUrlResponse::ToJsonString() const
{
...
string DescribeVirusSampleDownloadUrlResponse::GetFileUrl() const
{
    return m_fileUrl;
}

bool DescribeVirusSampleDownloadUrlResponse::FileUrlHasBeenSet() const
{
