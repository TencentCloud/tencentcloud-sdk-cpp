...
CoreInternalOutcome DescribeAssetImageRegistryRiskListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRegistryRiskListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageRegistryRiskListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageRegistryRiskListExportResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string DescribeAssetImageRegistryRiskListExportResponse::GetJobId() const
{
    return m_jobId;
}

bool DescribeAssetImageRegistryRiskListExportResponse::JobIdHasBeenSet() const
{
