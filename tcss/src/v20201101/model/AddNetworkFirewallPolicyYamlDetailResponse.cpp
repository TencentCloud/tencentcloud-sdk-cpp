...
CoreInternalOutcome AddNetworkFirewallPolicyYamlDetailResponse::Deserialize(const string &payload)
{
...
string AddNetworkFirewallPolicyYamlDetailResponse::ToJsonString() const
{
...
uint64_t AddNetworkFirewallPolicyYamlDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddNetworkFirewallPolicyYamlDetailResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string AddNetworkFirewallPolicyYamlDetailResponse::GetResult() const
{
    return m_result;
}

bool AddNetworkFirewallPolicyYamlDetailResponse::ResultHasBeenSet() const
{
