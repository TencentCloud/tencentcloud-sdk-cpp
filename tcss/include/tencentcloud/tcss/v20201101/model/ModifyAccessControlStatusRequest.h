...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLSTATUSREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLSTATUSREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class ModifyAccessControlStatusRequest : public AbstractModel
                {
                public:
                    ModifyAccessControlStatusRequest();
                    ~ModifyAccessControlStatusRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLSTATUSREQUEST_H_
