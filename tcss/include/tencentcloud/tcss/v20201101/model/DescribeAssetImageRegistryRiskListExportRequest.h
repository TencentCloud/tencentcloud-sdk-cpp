...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYRISKLISTEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYRISKLISTEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetImageRegistryRiskListExportRequest : public AbstractModel
                {
                public:
                    DescribeAssetImageRegistryRiskListExportRequest();
                    ~DescribeAssetImageRegistryRiskListExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYRISKLISTEXPORTREQUEST_H_
