...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLNAMESPACELABELLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLNAMESPACELABELLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeNetworkFirewallNamespaceLabelListRequest : public AbstractModel
                {
                public:
                    DescribeNetworkFirewallNamespaceLabelListRequest();
                    ~DescribeNetworkFirewallNamespaceLabelListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLNAMESPACELABELLISTREQUEST_H_
