...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLEVENTSEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLEVENTSEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeRiskSyscallEventsExportRequest : public AbstractModel
                {
                public:
                    DescribeRiskSyscallEventsExportRequest();
                    ~DescribeRiskSyscallEventsExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLEVENTSEXPORTREQUEST_H_
