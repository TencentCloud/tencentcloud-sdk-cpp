...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEPROCESSEVENTSEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEPROCESSEVENTSEXPORTJOBREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateProcessEventsExportJobRequest : public AbstractModel
                {
                public:
                    CreateProcessEventsExportJobRequest();
                    ~CreateProcessEventsExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEPROCESSEVENTSEXPORTJOBREQUEST_H_
