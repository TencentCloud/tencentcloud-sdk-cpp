...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_COMPLIANCEFILTERS_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_COMPLIANCEFILTERS_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class ComplianceFilters : public AbstractModel
                {
                public:
                    ComplianceFilters();
                    ~ComplianceFilters() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_COMPLIANCEFILTERS_H_
