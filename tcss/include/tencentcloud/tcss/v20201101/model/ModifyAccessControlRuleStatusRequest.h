...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLRULESTATUSREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLRULESTATUSREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class ModifyAccessControlRuleStatusRequest : public AbstractModel
                {
                public:
                    ModifyAccessControlRuleStatusRequest();
                    ~ModifyAccessControlRuleStatusRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYACCESSCONTROLRULESTATUSREQUEST_H_
