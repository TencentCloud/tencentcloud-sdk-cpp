...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DELETEACCESSCONTROLRULESREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DELETEACCESSCONTROLRULESREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DeleteAccessControlRulesRequest : public AbstractModel
                {
                public:
                    DeleteAccessControlRulesRequest();
                    ~DeleteAccessControlRulesRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DELETEACCESSCONTROLRULESREQUEST_H_
