...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetImageRegistryVulListRequest : public AbstractModel
                {
                public:
                    DescribeAssetImageRegistryVulListRequest();
                    ~DescribeAssetImageRegistryVulListRequest() = default;
...
<li>Name - String - 是否必填：否 - 漏洞名称</li>
                    ...
                    /**
                     * 获取镜像唯一ID，可通过DescribeAssetImageRegistryList接口获取
                    ...
                    /**
                     * 设置镜像唯一ID，可通过DescribeAssetImageRegistryList接口获取
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTREQUEST_H_
