...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAbnormalProcessRulesExportRequest : public AbstractModel
                {
                public:
                    DescribeAbnormalProcessRulesExportRequest();
                    ~DescribeAbnormalProcessRulesExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESEXPORTREQUEST_H_
