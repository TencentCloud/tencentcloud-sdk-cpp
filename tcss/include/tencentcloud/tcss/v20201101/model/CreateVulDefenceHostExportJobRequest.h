...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEVULDEFENCEHOSTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEVULDEFENCEHOSTEXPORTJOBREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateVulDefenceHostExportJobRequest : public AbstractModel
                {
                public:
                    CreateVulDefenceHostExportJobRequest();
                    ~CreateVulDefenceHostExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEVULDEFENCEHOSTEXPORTJOBREQUEST_H_
