...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATESYSTEMVULEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATESYSTEMVULEXPORTJOBREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateSystemVulExportJobRequest : public AbstractModel
                {
                public:
                    CreateSystemVulExportJobRequest();
                    ~CreateSystemVulExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATESYSTEMVULEXPORTJOBREQUEST_H_
