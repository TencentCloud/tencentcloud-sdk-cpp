...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAbnormalProcessRulesRequest : public AbstractModel
                {
                public:
                    DescribeAbnormalProcessRulesRequest();
                    ~DescribeAbnormalProcessRulesRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSRULESREQUEST_H_
