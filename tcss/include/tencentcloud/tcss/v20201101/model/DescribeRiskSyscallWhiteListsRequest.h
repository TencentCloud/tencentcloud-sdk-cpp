...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLWHITELISTSREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLWHITELISTSREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeRiskSyscallWhiteListsRequest : public AbstractModel
                {
                public:
                    DescribeRiskSyscallWhiteListsRequest();
                    ~DescribeRiskSyscallWhiteListsRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBERISKSYSCALLWHITELISTSREQUEST_H_
