...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_UPDATEANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_UPDATEANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class UpdateAndPublishNetworkFirewallPolicyDetailRequest : public AbstractModel
                {
                public:
                    UpdateAndPublishNetworkFirewallPolicyDetailRequest();
                    ~UpdateAndPublishNetworkFirewallPolicyDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_UPDATEANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
