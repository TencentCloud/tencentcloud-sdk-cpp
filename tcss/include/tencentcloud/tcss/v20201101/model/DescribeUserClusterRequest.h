...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEUSERCLUSTERREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEUSERCLUSTERREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeUserClusterRequest : public AbstractModel
                {
                public:
                    DescribeUserClusterRequest();
                    ~DescribeUserClusterRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEUSERCLUSTERREQUEST_H_
