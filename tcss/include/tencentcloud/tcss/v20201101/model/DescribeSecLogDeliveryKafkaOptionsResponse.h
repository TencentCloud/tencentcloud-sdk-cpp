...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESECLOGDELIVERYKAFKAOPTIONSRESPONSE_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESECLOGDELIVERYKAFKAOPTIONSRESPONSE_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeSecLogDeliveryKafkaOptionsResponse : public AbstractModel
                {
                public:
                    DescribeSecLogDeliveryKafkaOptionsResponse();
                    ~DescribeSecLogDeliveryKafkaOptionsResponse() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESECLOGDELIVERYKAFKAOPTIONSRESPONSE_H_
