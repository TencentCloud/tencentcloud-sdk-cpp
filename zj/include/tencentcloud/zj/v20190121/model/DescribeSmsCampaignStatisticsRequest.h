...
#ifndef TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSCAMPAIGNSTATISTICSREQUEST_H_
#define TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSCAMPAIGNSTATISTICSREQUEST_H_
    ...
    namespace Zj
    {
        namespace V20190121
        {
            namespace Model
            {
                ...
                */
                class DescribeSmsCampaignStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeSmsCampaignStatisticsRequest();
                    ~DescribeSmsCampaignStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSCAMPAIGNSTATISTICSREQUEST_H_
