...
#ifndef TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSSIGNLISTDATASTRUCT_H_
#define TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSSIGNLISTDATASTRUCT_H_
    ...
    namespace Zj
    {
        namespace V20190121
        {
            namespace Model
            {
                ...
                * 获取普通短信签名信息返回信息
                */
                class DescribeSmsSignListDataStruct : public AbstractModel
                {
                public:
                    DescribeSmsSignListDataStruct();
                    ~DescribeSmsSignListDataStruct() = default;
...
#endif // !TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSSIGNLISTDATASTRUCT_H_
