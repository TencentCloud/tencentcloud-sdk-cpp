...
#ifndef TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBEMMSINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBEMMSINSTANCELISTREQUEST_H_
    ...
    namespace Zj
    {
        namespace V20190121
        {
            namespace Model
            {
                ...
                */
                class DescribeMmsInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeMmsInstanceListRequest();
                    ~DescribeMmsInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBEMMSINSTANCELISTREQUEST_H_
