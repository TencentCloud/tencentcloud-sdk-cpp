...
#ifndef TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSTEMPLATELISTDATASTRUCT_H_
#define TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSTEMPLATELISTDATASTRUCT_H_
    ...
    namespace Zj
    {
        namespace V20190121
        {
            namespace Model
            {
                ...
                * 获取短信模板状态返回
                */
                class DescribeSmsTemplateListDataStruct : public AbstractModel
                {
                public:
                    DescribeSmsTemplateListDataStruct();
                    ~DescribeSmsTemplateListDataStruct() = default;
...
#endif // !TENCENTCLOUD_ZJ_V20190121_MODEL_DESCRIBESMSTEMPLATELISTDATASTRUCT_H_
