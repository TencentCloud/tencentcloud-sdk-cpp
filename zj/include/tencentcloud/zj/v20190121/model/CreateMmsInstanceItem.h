...
#ifndef TENCENTCLOUD_ZJ_V20190121_MODEL_CREATEMMSINSTANCEITEM_H_
#define TENCENTCLOUD_ZJ_V20190121_MODEL_CREATEMMSINSTANCEITEM_H_
    ...
    namespace Zj
    {
        namespace V20190121
        {
            namespace Model
            {
                ...
                * 创建样例时候content元素
                */
                class CreateMmsInstanceItem : public AbstractModel
                {
                public:
                    CreateMmsInstanceItem();
                    ~CreateMmsInstanceItem() = default;
...
#endif // !TENCENTCLOUD_ZJ_V20190121_MODEL_CREATEMMSINSTANCEITEM_H_
