...
CoreInternalOutcome SmsSuccessResponse::Deserialize(const Value &value)
{
    string requestId = "";
...
void SmsSuccessResponse::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
