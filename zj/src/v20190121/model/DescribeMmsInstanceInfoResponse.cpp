...
CoreInternalOutcome DescribeMmsInstanceInfoResponse::Deserialize(const string &payload)
{
...
string DescribeMmsInstanceInfoResponse::ToJsonString() const
{
...
MmsInstanceInfo DescribeMmsInstanceInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeMmsInstanceInfoResponse::DataHasBeenSet() const
{
