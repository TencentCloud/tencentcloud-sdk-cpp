...
CoreInternalOutcome SmsCreateCampaignResponse::Deserialize(const Value &value)
{
    string requestId = "";
...
void SmsCreateCampaignResponse::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
