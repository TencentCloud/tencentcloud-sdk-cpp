...
CoreInternalOutcome ModifySmsTemplateDataStruct::Deserialize(const Value &value)
{
    string requestId = "";
...
void ModifySmsTemplateDataStruct::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
