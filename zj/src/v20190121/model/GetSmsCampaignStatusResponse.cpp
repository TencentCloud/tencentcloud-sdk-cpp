...
CoreInternalOutcome GetSmsCampaignStatusResponse::Deserialize(const string &payload)
{
...
string GetSmsCampaignStatusResponse::ToJsonString() const
{
...
PaasSmsCampaignStatusResp GetSmsCampaignStatusResponse::GetData() const
{
    return m_data;
}

bool GetSmsCampaignStatusResponse::DataHasBeenSet() const
{
