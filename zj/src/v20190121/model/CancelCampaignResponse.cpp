...
CoreInternalOutcome CancelCampaignResponse::Deserialize(const string &payload)
{
...
string CancelCampaignResponse::ToJsonString() const
{
...
CancelActivityData CancelCampaignResponse::GetData() const
{
    return m_data;
}

bool CancelCampaignResponse::DataHasBeenSet() const
{
