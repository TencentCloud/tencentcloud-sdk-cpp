...
CoreInternalOutcome GetSmsAmountInfoResponse::Deserialize(const string &payload)
{
...
string GetSmsAmountInfoResponse::ToJsonString() const
{
...
SmsAmountDataStruct GetSmsAmountInfoResponse::GetData() const
{
    return m_data;
}

bool GetSmsAmountInfoResponse::DataHasBeenSet() const
{
