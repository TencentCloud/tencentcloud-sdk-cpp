...
CoreInternalOutcome AddCrowdPackInfoResponse::Deserialize(const string &payload)
{
...
string AddCrowdPackInfoResponse::ToJsonString() const
{
...
SmsAddCrowdPackInfoResponse AddCrowdPackInfoResponse::GetData() const
{
    return m_data;
}

bool AddCrowdPackInfoResponse::DataHasBeenSet() const
{
