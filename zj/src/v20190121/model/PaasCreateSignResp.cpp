...
CoreInternalOutcome PaasCreateSignResp::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void PaasCreateSignResp::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
int64_t PaasCreateSignResp::GetSignId() const
{
    return m_signId;
}

void PaasCreateSignResp::SetSignId(const int64_t& _signId)
{
    m_signId = _signId;
    m_signIdHasBeenSet = true;
}

bool PaasCreateSignResp::SignIdHasBeenSet() const
{
