...
CoreInternalOutcome SmsGetCrowdPackList::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void SmsGetCrowdPackList::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
