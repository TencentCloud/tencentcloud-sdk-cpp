...
CoreInternalOutcome UploadFansInfoCosInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void UploadFansInfoCosInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
