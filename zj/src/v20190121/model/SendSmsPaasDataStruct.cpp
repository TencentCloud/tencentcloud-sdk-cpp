...
CoreInternalOutcome SendSmsPaasDataStruct::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void SendSmsPaasDataStruct::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
