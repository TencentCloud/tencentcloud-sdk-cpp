...
CoreInternalOutcome PushMmsContentResponse::Deserialize(const string &payload)
{
...
string PushMmsContentResponse::ToJsonString() const
{
...
PushMmsContentResp PushMmsContentResponse::GetData() const
{
    return m_data;
}

bool PushMmsContentResponse::DataHasBeenSet() const
{
