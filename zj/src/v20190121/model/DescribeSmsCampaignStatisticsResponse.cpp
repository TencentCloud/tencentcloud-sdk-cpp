...
CoreInternalOutcome DescribeSmsCampaignStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeSmsCampaignStatisticsResponse::ToJsonString() const
{
...
SmsCampaignStatisticsData DescribeSmsCampaignStatisticsResponse::GetData() const
{
    return m_data;
}

bool DescribeSmsCampaignStatisticsResponse::DataHasBeenSet() const
{
