...
CoreInternalOutcome DescribeMmsInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeMmsInstanceListResponse::ToJsonString() const
{
...
MmsInstanceInfoList DescribeMmsInstanceListResponse::GetData() const
{
    return m_data;
}

bool DescribeMmsInstanceListResponse::DataHasBeenSet() const
{
