...
CoreInternalOutcome CreateMmsInstanceResp::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateMmsInstanceResp::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
