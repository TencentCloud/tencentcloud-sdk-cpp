...
CoreInternalOutcome CreateCampaignResponse::Deserialize(const string &payload)
{
...
string CreateCampaignResponse::ToJsonString() const
{
...
SmsCreateCampaignResponse CreateCampaignResponse::GetData() const
{
    return m_data;
}

bool CreateCampaignResponse::DataHasBeenSet() const
{
