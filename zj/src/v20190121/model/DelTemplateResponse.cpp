...
CoreInternalOutcome DelTemplateResponse::Deserialize(const string &payload)
{
...
string DelTemplateResponse::ToJsonString() const
{
...
SmsSuccessResponse DelTemplateResponse::GetData() const
{
    return m_data;
}

bool DelTemplateResponse::DataHasBeenSet() const
{
