...
CoreInternalOutcome CreateMmsInstanceResponse::Deserialize(const string &payload)
{
...
string CreateMmsInstanceResponse::ToJsonString() const
{
...
CreateMmsInstanceResp CreateMmsInstanceResponse::GetData() const
{
    return m_data;
}

bool CreateMmsInstanceResponse::DataHasBeenSet() const
{
