...
CoreInternalOutcome DescribeSmsSignListDataStruct::Deserialize(const Value &value)
{
    string requestId = "";
...
void DescribeSmsSignListDataStruct::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
