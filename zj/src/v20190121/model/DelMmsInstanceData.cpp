...
CoreInternalOutcome DelMmsInstanceData::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void DelMmsInstanceData::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
