...
CoreInternalOutcome DescribeSmsSignListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Data") && !rsp["Data"].IsNull())
    {
        ...
        {
            DescribeSmsSignListDataStruct item;
...
vector<DescribeSmsSignListDataStruct> DescribeSmsSignListResponse::GetData() const
{
    return m_data;
}

bool DescribeSmsSignListResponse::DataHasBeenSet() const
{
