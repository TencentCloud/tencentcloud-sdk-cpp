...
CoreInternalOutcome DeleteMmsInstanceResponse::Deserialize(const string &payload)
{
...
string DeleteMmsInstanceResponse::ToJsonString() const
{
...
DelMmsInstanceData DeleteMmsInstanceResponse::GetData() const
{
    return m_data;
}

bool DeleteMmsInstanceResponse::DataHasBeenSet() const
{
