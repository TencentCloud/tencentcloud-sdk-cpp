...
string CancelCampaignRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string CancelCampaignRequest::GetLicense() const
{
    return m_license;
}

void CancelCampaignRequest::SetLicense(const string& _license)
{
    m_license = _license;
    m_licenseHasBeenSet = true;
}

bool CancelCampaignRequest::LicenseHasBeenSet() const
{
    return m_licenseHasBeenSet;
}

int64_t CancelCampaignRequest::GetCampaignId() const
{
    return m_campaignId;
}

void CancelCampaignRequest::SetCampaignId(const int64_t& _campaignId)
{
    m_campaignId = _campaignId;
    m_campaignIdHasBeenSet = true;
}

bool CancelCampaignRequest::CampaignIdHasBeenSet() const
{
