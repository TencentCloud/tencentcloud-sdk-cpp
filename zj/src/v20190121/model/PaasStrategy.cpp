...
CoreInternalOutcome PaasStrategy::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void PaasStrategy::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
