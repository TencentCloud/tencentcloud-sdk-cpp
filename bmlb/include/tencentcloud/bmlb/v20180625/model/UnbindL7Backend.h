...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL7BACKEND_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL7BACKEND_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class UnbindL7Backend : public AbstractModel
                {
                public:
                    UnbindL7Backend();
                    ~UnbindL7Backend() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL7BACKEND_H_
