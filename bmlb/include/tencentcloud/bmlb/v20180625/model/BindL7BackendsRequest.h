...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_BINDL7BACKENDSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_BINDL7BACKENDSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class BindL7BackendsRequest : public AbstractModel
                {
                public:
                    BindL7BackendsRequest();
                    ~BindL7BackendsRequest() = default;
                     ...
                     * 
                     */
                    std::vector<BindL7Backend> GetBackendSet() const;
                     ...
                     * 
                     */
                    void SetBackendSet(const std::vector<BindL7Backend>& _backendSet);
                ...
                private:
                     ...
                     */
                    std::vector<BindL7Backend> m_backendSet;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_BINDL7BACKENDSREQUEST_H_
