...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_DELETEL7DOMAINSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_DELETEL7DOMAINSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DeleteL7DomainsRequest : public AbstractModel
                {
                public:
                    DeleteL7DomainsRequest();
                    ~DeleteL7DomainsRequest() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_DELETEL7DOMAINSREQUEST_H_
