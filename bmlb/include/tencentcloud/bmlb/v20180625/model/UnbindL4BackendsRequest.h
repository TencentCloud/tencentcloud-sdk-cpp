...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL4BACKENDSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL4BACKENDSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class UnbindL4BackendsRequest : public AbstractModel
                {
                public:
                    UnbindL4BackendsRequest();
                    ~UnbindL4BackendsRequest() = default;
                     ...
                     * 
                     */
                    std::vector<UnbindL4Backend> GetBackendSet() const;
                     ...
                     * 
                     */
                    void SetBackendSet(const std::vector<UnbindL4Backend>& _backendSet);
                ...
                private:
                     ...
                     */
                    std::vector<UnbindL4Backend> m_backendSet;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_UNBINDL4BACKENDSREQUEST_H_
