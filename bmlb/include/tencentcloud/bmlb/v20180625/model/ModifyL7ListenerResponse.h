...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL7LISTENERRESPONSE_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL7LISTENERRESPONSE_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class ModifyL7ListenerResponse : public AbstractModel
                {
                public:
                    ModifyL7ListenerResponse();
                    ~ModifyL7ListenerResponse() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL7LISTENERRESPONSE_H_
