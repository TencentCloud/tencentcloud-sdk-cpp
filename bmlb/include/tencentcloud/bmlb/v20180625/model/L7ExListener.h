...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_L7EXLISTENER_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_L7EXLISTENER_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                * 监听器信息。
                */
                class L7ExListener : public AbstractModel
                {
                public:
                    L7ExListener();
                    ~L7ExListener() = default;
                     ...
                     * 
                     */
                    bool GetBindTrafficMirror() const;
                     ...
                     * 
                     */
                    void SetBindTrafficMirror(const bool& _bindTrafficMirror);

                    /**
                     * 判断参数 BindTrafficMirror 是否已赋值
                     * @return BindTrafficMirror 是否已赋值
                     * 
                     */
                    bool BindTrafficMirrorHasBeenSet() const;
                ...
                private:
                     ...
                     * 是否绑定在入参指定的流量镜像中。
                     */
                    bool m_bindTrafficMirror;
                    bool m_bindTrafficMirrorHasBeenSet;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_L7EXLISTENER_H_
