...
string UnbindTrafficMirrorListenersRequest::ToJsonString() const
{
...
string UnbindTrafficMirrorListenersRequest::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

void UnbindTrafficMirrorListenersRequest::SetTrafficMirrorId(const string& _trafficMirrorId)
{
    m_trafficMirrorId = _trafficMirrorId;
    m_trafficMirrorIdHasBeenSet = true;
}

bool UnbindTrafficMirrorListenersRequest::TrafficMirrorIdHasBeenSet() const
{
    return m_trafficMirrorIdHasBeenSet;
}

vector<string> UnbindTrafficMirrorListenersRequest::GetListenerIds() const
{
    return m_listenerIds;
}

void UnbindTrafficMirrorListenersRequest::SetListenerIds(const vector<string>& _listenerIds)
{
    m_listenerIds = _listenerIds;
    m_listenerIdsHasBeenSet = true;
}

bool UnbindTrafficMirrorListenersRequest::ListenerIdsHasBeenSet() const
{
