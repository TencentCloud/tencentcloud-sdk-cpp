...
string BindTrafficMirrorListenersRequest::ToJsonString() const
{
...
string BindTrafficMirrorListenersRequest::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

void BindTrafficMirrorListenersRequest::SetTrafficMirrorId(const string& _trafficMirrorId)
{
    m_trafficMirrorId = _trafficMirrorId;
    m_trafficMirrorIdHasBeenSet = true;
}

bool BindTrafficMirrorListenersRequest::TrafficMirrorIdHasBeenSet() const
{
    return m_trafficMirrorIdHasBeenSet;
}

vector<string> BindTrafficMirrorListenersRequest::GetListenerIds() const
{
    return m_listenerIds;
}

void BindTrafficMirrorListenersRequest::SetListenerIds(const vector<string>& _listenerIds)
{
    m_listenerIds = _listenerIds;
    m_listenerIdsHasBeenSet = true;
}

bool BindTrafficMirrorListenersRequest::ListenerIdsHasBeenSet() const
{
