...
CoreInternalOutcome DevicesBindInfoLocation::Deserialize(const Value &value)
{
    string requestId = "";
...
void DevicesBindInfoLocation::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
