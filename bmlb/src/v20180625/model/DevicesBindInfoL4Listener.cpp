...
CoreInternalOutcome DevicesBindInfoL4Listener::Deserialize(const Value &value)
{
    string requestId = "";
...
void DevicesBindInfoL4Listener::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
