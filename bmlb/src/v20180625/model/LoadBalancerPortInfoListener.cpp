...
CoreInternalOutcome LoadBalancerPortInfoListener::Deserialize(const Value &value)
{
    string requestId = "";
...
void LoadBalancerPortInfoListener::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
