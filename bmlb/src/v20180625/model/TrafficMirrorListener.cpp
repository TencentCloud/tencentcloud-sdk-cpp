...
CoreInternalOutcome TrafficMirrorListener::Deserialize(const Value &value)
{
    string requestId = "";
...
void TrafficMirrorListener::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
