...
CoreInternalOutcome BindTrafficMirrorReceiver::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Port") && !value["Port"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BindTrafficMirrorReceiver.Port` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceId") && !value["InstanceId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BindTrafficMirrorReceiver.InstanceId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Weight") && !value["Weight"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BindTrafficMirrorReceiver.Weight` IsInt64=false incorrectly").SetRequestId(requestId));
        }
