...
string CreateTrafficMirrorRequest::GetAlias() const
{
    return m_alias;
}

void CreateTrafficMirrorRequest::SetAlias(const string& _alias)
{
    m_alias = _alias;
    m_aliasHasBeenSet = true;
}

bool CreateTrafficMirrorRequest::AliasHasBeenSet() const
{
