...
CoreInternalOutcome UploadCertResponse::Deserialize(const string &payload)
{
...
string UploadCertResponse::ToJsonString() const
{
...
string UploadCertResponse::GetCertId() const
{
    return m_certId;
}

bool UploadCertResponse::CertIdHasBeenSet() const
{
