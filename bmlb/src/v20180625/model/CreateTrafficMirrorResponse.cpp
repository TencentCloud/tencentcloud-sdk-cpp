...
CoreInternalOutcome CreateTrafficMirrorResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TrafficMirrorId") && !rsp["TrafficMirrorId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TrafficMirrorId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string CreateTrafficMirrorResponse::ToJsonString() const
{
...
string CreateTrafficMirrorResponse::GetTrafficMirrorId() const
{
    return m_trafficMirrorId;
}

bool CreateTrafficMirrorResponse::TrafficMirrorIdHasBeenSet() const
{
