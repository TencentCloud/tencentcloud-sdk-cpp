...
CoreInternalOutcome CertDetailLoadBalancer::Deserialize(const Value &value)
{
    string requestId = "";
...
void CertDetailLoadBalancer::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
