...
CoreInternalOutcome UnbindTrafficMirrorReceiver::Deserialize(const Value &value)
{
    string requestId = "";
...
void UnbindTrafficMirrorReceiver::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
