...
CoreInternalOutcome ModifyL7LocationRule::Deserialize(const Value &value)
{
    string requestId = "";
...
void ModifyL7LocationRule::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
