...
CoreInternalOutcome CreateL4Listener::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateL4Listener::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
