...
CoreInternalOutcome L7Backend::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BindType") && !value["BindType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.BindType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Port") && !value["Port"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.Port` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Weight") && !value["Weight"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.Weight` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Status") && !value["Status"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.Status` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceId") && !value["InstanceId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.InstanceId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Alias") && !value["Alias"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.Alias` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LanIp") && !value["LanIp"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.LanIp` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MgtIp") && !value["MgtIp"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `L7Backend.MgtIp` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Operates") && !value["Operates"].IsNull())
    {
        if (!value["Operates"].IsArray())
            return CoreInternalOutcome(Error("response `L7Backend.Operates` is not array type"));
...
void L7Backend::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
