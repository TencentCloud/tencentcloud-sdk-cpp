...
string ModifyLoadBalancerRequest::GetLoadBalancerId() const
{
    return m_loadBalancerId;
}

void ModifyLoadBalancerRequest::SetLoadBalancerId(const string& _loadBalancerId)
{
    m_loadBalancerId = _loadBalancerId;
    m_loadBalancerIdHasBeenSet = true;
}

bool ModifyLoadBalancerRequest::LoadBalancerIdHasBeenSet() const
{
    return m_loadBalancerIdHasBeenSet;
}

string ModifyLoadBalancerRequest::GetLoadBalancerName() const
{
    return m_loadBalancerName;
}

void ModifyLoadBalancerRequest::SetLoadBalancerName(const string& _loadBalancerName)
{
    m_loadBalancerName = _loadBalancerName;
    m_loadBalancerNameHasBeenSet = true;
}

bool ModifyLoadBalancerRequest::LoadBalancerNameHasBeenSet() const
{
    return m_loadBalancerNameHasBeenSet;
}

string ModifyLoadBalancerRequest::GetDomainPrefix() const
{
    return m_domainPrefix;
}

void ModifyLoadBalancerRequest::SetDomainPrefix(const string& _domainPrefix)
{
    m_domainPrefix = _domainPrefix;
    m_domainPrefixHasBeenSet = true;
}

bool ModifyLoadBalancerRequest::DomainPrefixHasBeenSet() const
{
