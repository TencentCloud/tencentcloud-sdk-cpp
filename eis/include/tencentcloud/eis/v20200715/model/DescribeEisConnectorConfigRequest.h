...
#ifndef TENCENTCLOUD_EIS_V20200715_MODEL_DESCRIBEEISCONNECTORCONFIGREQUEST_H_
#define TENCENTCLOUD_EIS_V20200715_MODEL_DESCRIBEEISCONNECTORCONFIGREQUEST_H_
    ...
    namespace Eis
    {
        namespace V20200715
        {
            namespace Model
            {
                ...
                */
                class DescribeEisConnectorConfigRequest : public AbstractModel
                {
                public:
                    DescribeEisConnectorConfigRequest();
                    ~DescribeEisConnectorConfigRequest() = default;
...
#endif // !TENCENTCLOUD_EIS_V20200715_MODEL_DESCRIBEEISCONNECTORCONFIGREQUEST_H_
