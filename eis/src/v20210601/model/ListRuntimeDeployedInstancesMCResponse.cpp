...
CoreInternalOutcome ListRuntimeDeployedInstancesMCResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Instances") && !rsp["Instances"].IsNull())
    {
        ...
        {
            RuntimeDeployedInstanceMC item;
...
string ListRuntimeDeployedInstancesMCResponse::ToJsonString() const
{
...
vector<RuntimeDeployedInstanceMC> ListRuntimeDeployedInstancesMCResponse::GetInstances() const
{
    return m_instances;
}

bool ListRuntimeDeployedInstancesMCResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

int64_t ListRuntimeDeployedInstancesMCResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListRuntimeDeployedInstancesMCResponse::TotalCountHasBeenSet() const
{
