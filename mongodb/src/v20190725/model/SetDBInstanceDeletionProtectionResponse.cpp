...
CoreInternalOutcome SetDBInstanceDeletionProtectionResponse::Deserialize(const string &payload)
{
...
string SetDBInstanceDeletionProtectionResponse::ToJsonString() const
{
