...
CoreInternalOutcome ModifySRVConnectionUrlResponse::Deserialize(const string &payload)
{
...
string ModifySRVConnectionUrlResponse::ToJsonString() const
{
...
uint64_t ModifySRVConnectionUrlResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifySRVConnectionUrlResponse::FlowIdHasBeenSet() const
{
