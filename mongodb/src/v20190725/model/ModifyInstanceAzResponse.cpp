...
CoreInternalOutcome ModifyInstanceAzResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceAzResponse::ToJsonString() const
{
...
string ModifyInstanceAzResponse::GetDealId() const
{
    return m_dealId;
}

bool ModifyInstanceAzResponse::DealIdHasBeenSet() const
{
