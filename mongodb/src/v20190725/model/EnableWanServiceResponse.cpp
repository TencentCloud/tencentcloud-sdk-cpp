...
CoreInternalOutcome EnableWanServiceResponse::Deserialize(const string &payload)
{
...
string EnableWanServiceResponse::ToJsonString() const
{
...
uint64_t EnableWanServiceResponse::GetFlowId() const
{
    return m_flowId;
}

bool EnableWanServiceResponse::FlowIdHasBeenSet() const
{
