...
vector<string> RestartNodesRequest::GetNodeIds() const
{
    return m_nodeIds;
}

void RestartNodesRequest::SetNodeIds(const vector<string>& _nodeIds)
{
    m_nodeIds = _nodeIds;
    m_nodeIdsHasBeenSet = true;
}

bool RestartNodesRequest::NodeIdsHasBeenSet() const
{
