...
vector<LogFilter> OpenAuditServiceRequest::GetRuleFilters() const
{
    return m_ruleFilters;
}

void OpenAuditServiceRequest::SetRuleFilters(const vector<LogFilter>& _ruleFilters)
{
    m_ruleFilters = _ruleFilters;
    m_ruleFiltersHasBeenSet = true;
}

bool OpenAuditServiceRequest::RuleFiltersHasBeenSet() const
{
