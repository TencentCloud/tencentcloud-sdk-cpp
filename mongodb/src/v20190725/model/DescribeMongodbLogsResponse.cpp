...
CoreInternalOutcome DescribeMongodbLogsResponse::Deserialize(const string &payload)
{
...
string DescribeMongodbLogsResponse::ToJsonString() const
{
...
int64_t DescribeMongodbLogsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMongodbLogsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<LogInfo> DescribeMongodbLogsResponse::GetLogList() const
{
    return m_logList;
}

bool DescribeMongodbLogsResponse::LogListHasBeenSet() const
{
