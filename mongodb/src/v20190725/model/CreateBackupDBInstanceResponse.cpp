...
CoreInternalOutcome CreateBackupDBInstanceResponse::Deserialize(const string &payload)
{
...
string CreateBackupDBInstanceResponse::ToJsonString() const
{
...
string CreateBackupDBInstanceResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool CreateBackupDBInstanceResponse::AsyncRequestIdHasBeenSet() const
{
