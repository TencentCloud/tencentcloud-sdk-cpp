...
CoreInternalOutcome InquirePriceCreateDBInstancesResponse::Deserialize(const string &payload)
{
...
string InquirePriceCreateDBInstancesResponse::ToJsonString() const
{
...
DBInstancePrice InquirePriceCreateDBInstancesResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceCreateDBInstancesResponse::PriceHasBeenSet() const
{
