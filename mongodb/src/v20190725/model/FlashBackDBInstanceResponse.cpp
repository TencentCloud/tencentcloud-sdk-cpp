...
FlashBackDBInstanceResponse::FlashBackDBInstanceResponse() :
    m_flowIdHasBeenSet(false)
{
}

CoreInternalOutcome FlashBackDBInstanceResponse::Deserialize(const string &payload)
{
...
string FlashBackDBInstanceResponse::ToJsonString() const
{
...
int64_t FlashBackDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool FlashBackDBInstanceResponse::FlowIdHasBeenSet() const
{
