...
CoreInternalOutcome EnableSRVConnectionUrlResponse::Deserialize(const string &payload)
{
...
string EnableSRVConnectionUrlResponse::ToJsonString() const
{
...
uint64_t EnableSRVConnectionUrlResponse::GetFlowId() const
{
    return m_flowId;
}

bool EnableSRVConnectionUrlResponse::FlowIdHasBeenSet() const
{
