...
CoreInternalOutcome InstanceEnableSSLResponse::Deserialize(const string &payload)
{
...
string InstanceEnableSSLResponse::ToJsonString() const
{
...
int64_t InstanceEnableSSLResponse::GetStatus() const
{
    return m_status;
}

bool InstanceEnableSSLResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string InstanceEnableSSLResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool InstanceEnableSSLResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

string InstanceEnableSSLResponse::GetCertUrl() const
{
    return m_certUrl;
}

bool InstanceEnableSSLResponse::CertUrlHasBeenSet() const
{
    return m_certUrlHasBeenSet;
}

int64_t InstanceEnableSSLResponse::GetFlowId() const
{
    return m_flowId;
}

bool InstanceEnableSSLResponse::FlowIdHasBeenSet() const
{
