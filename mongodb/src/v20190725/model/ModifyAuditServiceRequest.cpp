...
vector<LogFilter> ModifyAuditServiceRequest::GetRuleFilters() const
{
    return m_ruleFilters;
}

void ModifyAuditServiceRequest::SetRuleFilters(const vector<LogFilter>& _ruleFilters)
{
    m_ruleFilters = _ruleFilters;
    m_ruleFiltersHasBeenSet = true;
}

bool ModifyAuditServiceRequest::RuleFiltersHasBeenSet() const
{
