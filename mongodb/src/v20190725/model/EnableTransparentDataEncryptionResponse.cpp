...
CoreInternalOutcome EnableTransparentDataEncryptionResponse::Deserialize(const string &payload)
{
...
string EnableTransparentDataEncryptionResponse::ToJsonString() const
{
...
int64_t EnableTransparentDataEncryptionResponse::GetFlowId() const
{
    return m_flowId;
}

bool EnableTransparentDataEncryptionResponse::FlowIdHasBeenSet() const
{
