...
vector<Filters> DescribeAuditInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeAuditInstanceListRequest::SetFilters(const vector<Filters>& _filters)
{
    m_filters = _filters;
...
uint64_t DescribeAuditInstanceListRequest::GetAuditMode() const
{
    return m_auditMode;
}

void DescribeAuditInstanceListRequest::SetAuditMode(const uint64_t& _auditMode)
{
