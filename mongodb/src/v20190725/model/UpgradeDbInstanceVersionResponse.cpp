...
CoreInternalOutcome UpgradeDbInstanceVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeDbInstanceVersionResponse::ToJsonString() const
{
...
uint64_t UpgradeDbInstanceVersionResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeDbInstanceVersionResponse::FlowIdHasBeenSet() const
{
