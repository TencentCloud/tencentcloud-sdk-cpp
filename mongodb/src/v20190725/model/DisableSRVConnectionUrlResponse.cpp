...
CoreInternalOutcome DisableSRVConnectionUrlResponse::Deserialize(const string &payload)
{
...
string DisableSRVConnectionUrlResponse::ToJsonString() const
{
...
uint64_t DisableSRVConnectionUrlResponse::GetFlowId() const
{
    return m_flowId;
}

bool DisableSRVConnectionUrlResponse::FlowIdHasBeenSet() const
{
