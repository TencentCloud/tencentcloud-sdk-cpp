...
CoreInternalOutcome RestoreDBInstanceResponse::Deserialize(const string &payload)
{
...
string RestoreDBInstanceResponse::ToJsonString() const
{
...
int64_t RestoreDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool RestoreDBInstanceResponse::FlowIdHasBeenSet() const
{
