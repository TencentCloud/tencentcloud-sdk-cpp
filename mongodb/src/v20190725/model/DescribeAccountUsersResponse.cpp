...
CoreInternalOutcome DescribeAccountUsersResponse::Deserialize(const string &payload)
{
...
string DescribeAccountUsersResponse::ToJsonString() const
{
...
vector<UserInfo> DescribeAccountUsersResponse::GetUsers() const
{
    return m_users;
}

bool DescribeAccountUsersResponse::UsersHasBeenSet() const
{
