...
CoreInternalOutcome UpgradeDBInstanceKernelVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeDBInstanceKernelVersionResponse::ToJsonString() const
{
...
uint64_t UpgradeDBInstanceKernelVersionResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeDBInstanceKernelVersionResponse::FlowIdHasBeenSet() const
{
