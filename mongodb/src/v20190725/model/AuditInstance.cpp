...
AuditInstance::AuditInstance() :
    ...
    m_performancesAnalyseHasBeenSet(false),
...
CoreInternalOutcome AuditInstance::Deserialize(const rapidjson::Value &value)
{
    ...
    {
        if (!value["AuditTask"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.AuditTask` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_auditTask = value["AuditTask"].GetInt64();
    ...
    if (value.HasMember("HighLogExpireDay") && !value["HighLogExpireDay"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.HighLogExpireDay` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LowLogExpireDay") && !value["LowLogExpireDay"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.LowLogExpireDay` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("BillingAmount") && !value["BillingAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.BillingAmount` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HighRealStorage") && !value["HighRealStorage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.HighRealStorage` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LowRealStorage") && !value["LowRealStorage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.LowRealStorage` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PerformancesAnalyse") && !value["PerformancesAnalyse"].IsNull())
    {
        if (!value["PerformancesAnalyse"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.PerformancesAnalyse` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_performancesAnalyse = value["PerformancesAnalyse"].GetInt64();
        m_performancesAnalyseHasBeenSet = true;
    }
    ...
    if (value.HasMember("AuditAll") && !value["AuditAll"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.AuditAll` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CreateAt") && !value["CreateAt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.CreateAt` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RuleTemplateIds") && !value["RuleTemplateIds"].IsNull())
    {
        if (!value["RuleTemplateIds"].IsArray())
            return CoreInternalOutcome(Core::Error("response `AuditInstance.RuleTemplateIds` is not array type"));
    ...
    if (value.HasMember("Deliver") && !value["Deliver"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.Deliver` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DeliverSummary") && !value["DeliverSummary"].IsNull())
    {
        if (!value["DeliverSummary"].IsArray())
            return CoreInternalOutcome(Core::Error("response `AuditInstance.DeliverSummary` is not array type"));
    ...
    if (value.HasMember("OldRule") && !value["OldRule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.OldRule` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RealStorage") && !value["RealStorage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AuditInstance.RealStorage` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
...
void AuditInstance::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_performancesAnalyseHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "PerformancesAnalyse";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, m_performancesAnalyse, allocator);
    }
...
int64_t AuditInstance::GetAuditTask() const
{
    return m_auditTask;
}

void AuditInstance::SetAuditTask(const int64_t& _auditTask)
{
    m_auditTask = _auditTask;
    m_auditTaskHasBeenSet = true;
}

bool AuditInstance::AuditTaskHasBeenSet() const
{
...
int64_t AuditInstance::GetHighLogExpireDay() const
{
    return m_highLogExpireDay;
}

void AuditInstance::SetHighLogExpireDay(const int64_t& _highLogExpireDay)
{
    m_highLogExpireDay = _highLogExpireDay;
    m_highLogExpireDayHasBeenSet = true;
}

bool AuditInstance::HighLogExpireDayHasBeenSet() const
{
    return m_highLogExpireDayHasBeenSet;
}

int64_t AuditInstance::GetLowLogExpireDay() const
{
    return m_lowLogExpireDay;
}

void AuditInstance::SetLowLogExpireDay(const int64_t& _lowLogExpireDay)
{
    m_lowLogExpireDay = _lowLogExpireDay;
    m_lowLogExpireDayHasBeenSet = true;
}

bool AuditInstance::LowLogExpireDayHasBeenSet() const
{
    return m_lowLogExpireDayHasBeenSet;
}

double AuditInstance::GetBillingAmount() const
{
    return m_billingAmount;
}

void AuditInstance::SetBillingAmount(const double& _billingAmount)
{
...
double AuditInstance::GetHighRealStorage() const
{
    return m_highRealStorage;
}

void AuditInstance::SetHighRealStorage(const double& _highRealStorage)
{
    m_highRealStorage = _highRealStorage;
    m_highRealStorageHasBeenSet = true;
}

bool AuditInstance::HighRealStorageHasBeenSet() const
{
    return m_highRealStorageHasBeenSet;
}

double AuditInstance::GetLowRealStorage() const
{
    return m_lowRealStorage;
}

void AuditInstance::SetLowRealStorage(const double& _lowRealStorage)
{
    m_lowRealStorage = _lowRealStorage;
    m_lowRealStorageHasBeenSet = true;
}

bool AuditInstance::LowRealStorageHasBeenSet() const
{
    return m_lowRealStorageHasBeenSet;
}

InstanceInfo AuditInstance::GetInstanceInfo() const
{
    return m_instanceInfo;
}

void AuditInstance::SetInstanceInfo(const InstanceInfo& _instanceInfo)
{
...
int64_t AuditInstance::GetPerformancesAnalyse() const
{
    return m_performancesAnalyse;
}

void AuditInstance::SetPerformancesAnalyse(const int64_t& _performancesAnalyse)
{
    m_performancesAnalyse = _performancesAnalyse;
    m_performancesAnalyseHasBeenSet = true;
}

bool AuditInstance::PerformancesAnalyseHasBeenSet() const
{
    return m_performancesAnalyseHasBeenSet;
}

bool AuditInstance::GetAuditAll() const
{
    return m_auditAll;
}

void AuditInstance::SetAuditAll(const bool& _auditAll)
{
    m_auditAll = _auditAll;
    m_auditAllHasBeenSet = true;
}

bool AuditInstance::AuditAllHasBeenSet() const
{
    return m_auditAllHasBeenSet;
}

string AuditInstance::GetCreateAt() const
{
    return m_createAt;
}

void AuditInstance::SetCreateAt(const string& _createAt)
{
    m_createAt = _createAt;
    m_createAtHasBeenSet = true;
}

bool AuditInstance::CreateAtHasBeenSet() const
{
    return m_createAtHasBeenSet;
}

vector<string> AuditInstance::GetRuleTemplateIds() const
{
    return m_ruleTemplateIds;
}

void AuditInstance::SetRuleTemplateIds(const vector<string>& _ruleTemplateIds)
{
    m_ruleTemplateIds = _ruleTemplateIds;
    m_ruleTemplateIdsHasBeenSet = true;
}

bool AuditInstance::RuleTemplateIdsHasBeenSet() const
{
    return m_ruleTemplateIdsHasBeenSet;
}

string AuditInstance::GetDeliver() const
{
    return m_deliver;
}

void AuditInstance::SetDeliver(const string& _deliver)
{
    m_deliver = _deliver;
    m_deliverHasBeenSet = true;
}

bool AuditInstance::DeliverHasBeenSet() const
{
    return m_deliverHasBeenSet;
}

vector<DeliverSummary> AuditInstance::GetDeliverSummary() const
{
    return m_deliverSummary;
}

void AuditInstance::SetDeliverSummary(const vector<DeliverSummary>& _deliverSummary)
{
    m_deliverSummary = _deliverSummary;
    m_deliverSummaryHasBeenSet = true;
}

bool AuditInstance::DeliverSummaryHasBeenSet() const
{
    return m_deliverSummaryHasBeenSet;
}

bool AuditInstance::GetOldRule() const
{
    return m_oldRule;
}

void AuditInstance::SetOldRule(const bool& _oldRule)
{
    m_oldRule = _oldRule;
    m_oldRuleHasBeenSet = true;
}

bool AuditInstance::OldRuleHasBeenSet() const
{
    return m_oldRuleHasBeenSet;
}

double AuditInstance::GetRealStorage() const
{
    return m_realStorage;
}

void AuditInstance::SetRealStorage(const double& _realStorage)
{
    m_realStorage = _realStorage;
    m_realStorageHasBeenSet = true;
}

bool AuditInstance::RealStorageHasBeenSet() const
{
