...
ScaleUpDBInstanceCpuResponse::ScaleUpDBInstanceCpuResponse() :
    m_flowIdHasBeenSet(false)
{
}

CoreInternalOutcome ScaleUpDBInstanceCpuResponse::Deserialize(const string &payload)
{
...
string ScaleUpDBInstanceCpuResponse::ToJsonString() const
{
...
int64_t ScaleUpDBInstanceCpuResponse::GetFlowId() const
{
    return m_flowId;
}

bool ScaleUpDBInstanceCpuResponse::FlowIdHasBeenSet() const
{
