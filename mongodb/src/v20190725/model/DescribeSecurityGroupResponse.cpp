...
CoreInternalOutcome DescribeSecurityGroupResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityGroupResponse::ToJsonString() const
{
...
vector<SecurityGroup> DescribeSecurityGroupResponse::GetGroups() const
{
    return m_groups;
}

bool DescribeSecurityGroupResponse::GroupsHasBeenSet() const
{
