...
CoreInternalOutcome RestartNodesResponse::Deserialize(const string &payload)
{
...
string RestartNodesResponse::ToJsonString() const
{
...
int64_t RestartNodesResponse::GetFlowId() const
{
    return m_flowId;
}

bool RestartNodesResponse::FlowIdHasBeenSet() const
{
