...
CoreInternalOutcome DescribeSRVConnectionDomainResponse::Deserialize(const string &payload)
{
...
string DescribeSRVConnectionDomainResponse::ToJsonString() const
{
...
string DescribeSRVConnectionDomainResponse::GetDomain() const
{
    return m_domain;
}

bool DescribeSRVConnectionDomainResponse::DomainHasBeenSet() const
{
