...
CoreInternalOutcome CreateAccountUserResponse::Deserialize(const string &payload)
{
...
string CreateAccountUserResponse::ToJsonString() const
{
...
uint64_t CreateAccountUserResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateAccountUserResponse::FlowIdHasBeenSet() const
{
