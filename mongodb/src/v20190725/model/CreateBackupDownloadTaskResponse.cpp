...
CoreInternalOutcome CreateBackupDownloadTaskResponse::Deserialize(const string &payload)
{
...
string CreateBackupDownloadTaskResponse::ToJsonString() const
{
...
vector<BackupDownloadTaskStatus> CreateBackupDownloadTaskResponse::GetTasks() const
{
    return m_tasks;
}

bool CreateBackupDownloadTaskResponse::TasksHasBeenSet() const
{
