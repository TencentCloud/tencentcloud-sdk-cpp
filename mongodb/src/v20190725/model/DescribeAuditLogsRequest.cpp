...
#include <tencentcloud/mongodb/v20190725/model/DescribeAuditLogsRequest.h>
...
AuditLogFilter DescribeAuditLogsRequest::GetFilter() const
{
    return m_filter;
}

void DescribeAuditLogsRequest::SetFilter(const AuditLogFilter& _filter)
{
    m_filter = _filter;
    m_filterHasBeenSet = true;
}

bool DescribeAuditLogsRequest::FilterHasBeenSet() const
{
    return m_filterHasBeenSet;
}

uint64_t DescribeAuditLogsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeAuditLogsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
uint64_t DescribeAuditLogsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAuditLogsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
