...
string UpgradeDBInstanceKernelVersionRequest::GetInstanceId() const
{
    return m_instanceId;
}

void UpgradeDBInstanceKernelVersionRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool UpgradeDBInstanceKernelVersionRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

int64_t UpgradeDBInstanceKernelVersionRequest::GetInMaintenance() const
{
    return m_inMaintenance;
}

void UpgradeDBInstanceKernelVersionRequest::SetInMaintenance(const int64_t& _inMaintenance)
{
    m_inMaintenance = _inMaintenance;
    m_inMaintenanceHasBeenSet = true;
}

bool UpgradeDBInstanceKernelVersionRequest::InMaintenanceHasBeenSet() const
{
