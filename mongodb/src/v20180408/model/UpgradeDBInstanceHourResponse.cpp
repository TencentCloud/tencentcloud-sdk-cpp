...
CoreInternalOutcome UpgradeDBInstanceHourResponse::Deserialize(const string &payload)
{
...
string UpgradeDBInstanceHourResponse::ToJsonString() const
{
...
string UpgradeDBInstanceHourResponse::GetDealId() const
{
    return m_dealId;
}

bool UpgradeDBInstanceHourResponse::DealIdHasBeenSet() const
{
