...
CoreInternalOutcome TerminateDBInstanceResponse::Deserialize(const string &payload)
{
...
string TerminateDBInstanceResponse::ToJsonString() const
{
...
string TerminateDBInstanceResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool TerminateDBInstanceResponse::AsyncRequestIdHasBeenSet() const
{
