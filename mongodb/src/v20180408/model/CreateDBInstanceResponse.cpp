...
CoreInternalOutcome CreateDBInstanceResponse::Deserialize(const string &payload)
{
...
string CreateDBInstanceResponse::ToJsonString() const
{
...
string CreateDBInstanceResponse::GetDealId() const
{
    return m_dealId;
}

bool CreateDBInstanceResponse::DealIdHasBeenSet() const
{
    return m_dealIdHasBeenSet;
}

vector<string> CreateDBInstanceResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CreateDBInstanceResponse::InstanceIdsHasBeenSet() const
{
