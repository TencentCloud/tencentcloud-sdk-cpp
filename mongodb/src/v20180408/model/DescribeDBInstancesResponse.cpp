...
vector<MongoDBInstanceDetail> DescribeDBInstancesResponse::GetInstanceDetails() const
{
    return m_instanceDetails;
}

bool DescribeDBInstancesResponse::InstanceDetailsHasBeenSet() const
{
