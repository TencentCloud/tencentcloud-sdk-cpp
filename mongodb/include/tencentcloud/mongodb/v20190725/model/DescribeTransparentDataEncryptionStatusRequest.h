...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBETRANSPARENTDATAENCRYPTIONSTATUSREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBETRANSPARENTDATAENCRYPTIONSTATUSREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class DescribeTransparentDataEncryptionStatusRequest : public AbstractModel
                {
                public:
                    DescribeTransparentDataEncryptionStatusRequest();
                    ~DescribeTransparentDataEncryptionStatusRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBETRANSPARENTDATAENCRYPTIONSTATUSREQUEST_H_
