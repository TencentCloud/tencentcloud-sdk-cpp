...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYSRVCONNECTIONURLREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYSRVCONNECTIONURLREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class ModifySRVConnectionUrlRequest : public AbstractModel
                {
                public:
                    ModifySRVConnectionUrlRequest();
                    ~ModifySRVConnectionUrlRequest() = default;
                    ...
                    /**
                     * 获取自定义的实例的访问域名。
                     * @return CustomDomain 自定义的实例的访问域名。
                     * 
                     */
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYSRVCONNECTIONURLREQUEST_H_
