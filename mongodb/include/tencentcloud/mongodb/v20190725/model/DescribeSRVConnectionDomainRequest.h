...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBESRVCONNECTIONDOMAINREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBESRVCONNECTIONDOMAINREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class DescribeSRVConnectionDomainRequest : public AbstractModel
                {
                public:
                    DescribeSRVConnectionDomainRequest();
                    ~DescribeSRVConnectionDomainRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBESRVCONNECTIONDOMAINREQUEST_H_
