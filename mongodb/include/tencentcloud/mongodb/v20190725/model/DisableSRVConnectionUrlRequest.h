...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_DISABLESRVCONNECTIONURLREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_DISABLESRVCONNECTIONURLREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class DisableSRVConnectionUrlRequest : public AbstractModel
                {
                public:
                    DisableSRVConnectionUrlRequest();
                    ~DisableSRVConnectionUrlRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_DISABLESRVCONNECTIONURLREQUEST_H_
