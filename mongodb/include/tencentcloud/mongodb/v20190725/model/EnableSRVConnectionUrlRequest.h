...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_ENABLESRVCONNECTIONURLREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_ENABLESRVCONNECTIONURLREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class EnableSRVConnectionUrlRequest : public AbstractModel
                {
                public:
                    EnableSRVConnectionUrlRequest();
                    ~EnableSRVConnectionUrlRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_ENABLESRVCONNECTIONURLREQUEST_H_
