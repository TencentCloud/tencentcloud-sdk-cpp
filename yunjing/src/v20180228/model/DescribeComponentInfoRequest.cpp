...
string DescribeComponentInfoRequest::ToJsonString() const
{
...
uint64_t DescribeComponentInfoRequest::GetComponentId() const
{
    return m_componentId;
}

void DescribeComponentInfoRequest::SetComponentId(const uint64_t& _componentId)
{
    m_componentId = _componentId;
    m_componentIdHasBeenSet = true;
}

bool DescribeComponentInfoRequest::ComponentIdHasBeenSet() const
{
