...
string DescribeVulInfoRequest::ToJsonString() const
{
...
uint64_t DescribeVulInfoRequest::GetVulId() const
{
    return m_vulId;
}

void DescribeVulInfoRequest::SetVulId(const uint64_t& _vulId)
{
    m_vulId = _vulId;
    m_vulIdHasBeenSet = true;
}

bool DescribeVulInfoRequest::VulIdHasBeenSet() const
{
