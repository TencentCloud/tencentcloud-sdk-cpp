...
string DescribeWeeklyReportInfoRequest::ToJsonString() const
{
...
string DescribeWeeklyReportInfoRequest::GetBeginDate() const
{
    return m_beginDate;
}

void DescribeWeeklyReportInfoRequest::SetBeginDate(const string& _beginDate)
{
    m_beginDate = _beginDate;
    m_beginDateHasBeenSet = true;
}

bool DescribeWeeklyReportInfoRequest::BeginDateHasBeenSet() const
{
