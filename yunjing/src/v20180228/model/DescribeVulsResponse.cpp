...
CoreInternalOutcome DescribeVulsResponse::Deserialize(const string &payload)
{
...
string DescribeVulsResponse::ToJsonString() const
{
...
uint64_t DescribeVulsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVulsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Vul> DescribeVulsResponse::GetVuls() const
{
    return m_vuls;
}

bool DescribeVulsResponse::VulsHasBeenSet() const
{
