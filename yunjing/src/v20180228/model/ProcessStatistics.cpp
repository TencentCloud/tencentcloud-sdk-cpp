...
CoreInternalOutcome ProcessStatistics::Deserialize(const Value &value)
{
    string requestId = "";
...
void ProcessStatistics::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
