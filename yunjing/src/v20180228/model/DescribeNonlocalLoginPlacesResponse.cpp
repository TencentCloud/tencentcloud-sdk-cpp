...
CoreInternalOutcome DescribeNonlocalLoginPlacesResponse::Deserialize(const string &payload)
{
...
string DescribeNonlocalLoginPlacesResponse::ToJsonString() const
{
...
uint64_t DescribeNonlocalLoginPlacesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeNonlocalLoginPlacesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<NonLocalLoginPlace> DescribeNonlocalLoginPlacesResponse::GetNonLocalLoginPlaces() const
{
    return m_nonLocalLoginPlaces;
}

bool DescribeNonlocalLoginPlacesResponse::NonLocalLoginPlacesHasBeenSet() const
{
