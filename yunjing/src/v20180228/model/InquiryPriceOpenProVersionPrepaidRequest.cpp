...
string InquiryPriceOpenProVersionPrepaidRequest::ToJsonString() const
{
...
ChargePrepaid InquiryPriceOpenProVersionPrepaidRequest::GetChargePrepaid() const
{
    return m_chargePrepaid;
}

void InquiryPriceOpenProVersionPrepaidRequest::SetChargePrepaid(const ChargePrepaid& _chargePrepaid)
{
    m_chargePrepaid = _chargePrepaid;
    m_chargePrepaidHasBeenSet = true;
}

bool InquiryPriceOpenProVersionPrepaidRequest::ChargePrepaidHasBeenSet() const
{
    return m_chargePrepaidHasBeenSet;
}

vector<ProVersionMachine> InquiryPriceOpenProVersionPrepaidRequest::GetMachines() const
{
    return m_machines;
}

void InquiryPriceOpenProVersionPrepaidRequest::SetMachines(const vector<ProVersionMachine>& _machines)
{
    m_machines = _machines;
    m_machinesHasBeenSet = true;
}

bool InquiryPriceOpenProVersionPrepaidRequest::MachinesHasBeenSet() const
{
