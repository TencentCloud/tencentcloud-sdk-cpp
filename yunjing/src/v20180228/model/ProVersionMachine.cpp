...
CoreInternalOutcome ProVersionMachine::Deserialize(const Value &value)
{
    string requestId = "";
...
void ProVersionMachine::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
