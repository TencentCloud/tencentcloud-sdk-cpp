...
CoreInternalOutcome DescribeComponentInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ComponentName") && !rsp["ComponentName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ComponentName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("ComponentType") && !rsp["ComponentType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ComponentType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (rsp.HasMember("Homepage") && !rsp["Homepage"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Homepage` IsString=false incorrectly").SetRequestId(requestId));
        }
