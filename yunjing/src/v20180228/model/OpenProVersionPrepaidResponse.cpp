...
CoreInternalOutcome OpenProVersionPrepaidResponse::Deserialize(const string &payload)
{
...
string OpenProVersionPrepaidResponse::ToJsonString() const
{
...
vector<string> OpenProVersionPrepaidResponse::GetDealIds() const
{
    return m_dealIds;
}

bool OpenProVersionPrepaidResponse::DealIdsHasBeenSet() const
{
