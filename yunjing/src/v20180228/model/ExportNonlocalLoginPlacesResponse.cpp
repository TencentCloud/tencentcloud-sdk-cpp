...
CoreInternalOutcome ExportNonlocalLoginPlacesResponse::Deserialize(const string &payload)
{
...
string ExportNonlocalLoginPlacesResponse::ToJsonString() const
{
...
string ExportNonlocalLoginPlacesResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportNonlocalLoginPlacesResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportNonlocalLoginPlacesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportNonlocalLoginPlacesResponse::TaskIdHasBeenSet() const
{
