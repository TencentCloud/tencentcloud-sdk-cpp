...
CoreInternalOutcome CreateWebpageDepositResponse::Deserialize(const string &payload)
{
...
string CreateWebpageDepositResponse::ToJsonString() const
{
...
string CreateWebpageDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateWebpageDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateWebpageDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateWebpageDepositResponse::EvidenceIdHasBeenSet() const
{
