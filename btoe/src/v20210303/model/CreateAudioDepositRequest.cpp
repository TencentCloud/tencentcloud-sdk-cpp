...
string CreateAudioDepositRequest::GetFileUrl() const
{
    return m_fileUrl;
}

void CreateAudioDepositRequest::SetFileUrl(const string& _fileUrl)
{
    m_fileUrl = _fileUrl;
    m_fileUrlHasBeenSet = true;
}

bool CreateAudioDepositRequest::FileUrlHasBeenSet() const
{
