...
CoreInternalOutcome CreateDataDepositResponse::Deserialize(const string &payload)
{
...
string CreateDataDepositResponse::ToJsonString() const
{
...
string CreateDataDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateDataDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateDataDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateDataDepositResponse::EvidenceIdHasBeenSet() const
{
