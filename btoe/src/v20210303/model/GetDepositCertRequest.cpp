...
string GetDepositCertRequest::ToJsonString() const
{
...
string GetDepositCertRequest::GetEvidenceId() const
{
    return m_evidenceId;
}

void GetDepositCertRequest::SetEvidenceId(const string& _evidenceId)
{
    m_evidenceId = _evidenceId;
    m_evidenceIdHasBeenSet = true;
}

bool GetDepositCertRequest::EvidenceIdHasBeenSet() const
{
