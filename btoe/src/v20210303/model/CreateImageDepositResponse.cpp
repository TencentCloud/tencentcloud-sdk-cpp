...
CoreInternalOutcome CreateImageDepositResponse::Deserialize(const string &payload)
{
...
string CreateImageDepositResponse::ToJsonString() const
{
...
string CreateImageDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateImageDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateImageDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateImageDepositResponse::EvidenceIdHasBeenSet() const
{
