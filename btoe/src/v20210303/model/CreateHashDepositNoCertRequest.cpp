...
uint64_t CreateHashDepositNoCertRequest::GetHashType() const
{
    return m_hashType;
}

void CreateHashDepositNoCertRequest::SetHashType(const uint64_t& _hashType)
{
    m_hashType = _hashType;
    m_hashTypeHasBeenSet = true;
}

bool CreateHashDepositNoCertRequest::HashTypeHasBeenSet() const
{
