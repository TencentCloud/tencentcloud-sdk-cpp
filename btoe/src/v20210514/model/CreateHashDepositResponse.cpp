...
CoreInternalOutcome CreateHashDepositResponse::Deserialize(const string &payload)
{
...
string CreateHashDepositResponse::ToJsonString() const
{
...
string CreateHashDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateHashDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateHashDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateHashDepositResponse::EvidenceIdHasBeenSet() const
{
