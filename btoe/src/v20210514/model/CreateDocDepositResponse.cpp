...
CoreInternalOutcome CreateDocDepositResponse::Deserialize(const string &payload)
{
...
string CreateDocDepositResponse::ToJsonString() const
{
...
string CreateDocDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateDocDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateDocDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateDocDepositResponse::EvidenceIdHasBeenSet() const
{
