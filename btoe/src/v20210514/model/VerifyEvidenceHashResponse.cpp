...
CoreInternalOutcome VerifyEvidenceHashResponse::Deserialize(const string &payload)
{
...
string VerifyEvidenceHashResponse::ToJsonString() const
{
...
bool VerifyEvidenceHashResponse::GetResult() const
{
    return m_result;
}

bool VerifyEvidenceHashResponse::ResultHasBeenSet() const
{
