...
CoreInternalOutcome CreateVideoDepositResponse::Deserialize(const string &payload)
{
...
string CreateVideoDepositResponse::ToJsonString() const
{
...
string CreateVideoDepositResponse::GetBusinessId() const
{
    return m_businessId;
}

bool CreateVideoDepositResponse::BusinessIdHasBeenSet() const
{
    return m_businessIdHasBeenSet;
}

string CreateVideoDepositResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateVideoDepositResponse::EvidenceIdHasBeenSet() const
{
