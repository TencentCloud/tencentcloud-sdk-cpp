...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEWEBPAGEDEPOSITRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEWEBPAGEDEPOSITRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateWebpageDepositResponse : public AbstractModel
                {
                public:
                    CreateWebpageDepositResponse();
                    ~CreateWebpageDepositResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEWEBPAGEDEPOSITRESPONSE_H_
