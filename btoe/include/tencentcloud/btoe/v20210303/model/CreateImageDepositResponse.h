...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateImageDepositResponse : public AbstractModel
                {
                public:
                    CreateImageDepositResponse();
                    ~CreateImageDepositResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITRESPONSE_H_
