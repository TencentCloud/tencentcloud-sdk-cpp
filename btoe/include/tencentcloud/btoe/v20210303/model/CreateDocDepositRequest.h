...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDOCDEPOSITREQUEST_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDOCDEPOSITREQUEST_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateDocDepositRequest : public AbstractModel
                {
                public:
                    CreateDocDepositRequest();
                    ~CreateDocDepositRequest() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDOCDEPOSITREQUEST_H_
