...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEAUDIODEPOSITREQUEST_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEAUDIODEPOSITREQUEST_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateAudioDepositRequest : public AbstractModel
                {
                public:
                    CreateAudioDepositRequest();
                    ~CreateAudioDepositRequest() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEAUDIODEPOSITREQUEST_H_
