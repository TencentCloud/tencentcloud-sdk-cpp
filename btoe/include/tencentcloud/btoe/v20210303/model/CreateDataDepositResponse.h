...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDATADEPOSITRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDATADEPOSITRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateDataDepositResponse : public AbstractModel
                {
                public:
                    CreateDataDepositResponse();
                    ~CreateDataDepositResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEDATADEPOSITRESPONSE_H_
