...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_GETDEPOSITFILEREQUEST_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_GETDEPOSITFILEREQUEST_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class GetDepositFileRequest : public AbstractModel
                {
                public:
                    GetDepositFileRequest();
                    ~GetDepositFileRequest() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_GETDEPOSITFILEREQUEST_H_
