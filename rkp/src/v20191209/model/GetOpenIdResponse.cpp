...
CoreInternalOutcome GetOpenIdResponse::Deserialize(const string &payload)
{
...
string GetOpenIdResponse::ToJsonString() const
{
...
string GetOpenIdResponse::GetOpenId() const
{
    return m_openId;
}

bool GetOpenIdResponse::OpenIdHasBeenSet() const
{
    return m_openIdHasBeenSet;
}

vector<RiskInfo> GetOpenIdResponse::GetRiskInfo() const
{
    return m_riskInfo;
}

bool GetOpenIdResponse::RiskInfoHasBeenSet() const
{
