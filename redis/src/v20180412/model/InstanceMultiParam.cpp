...
CoreInternalOutcome InstanceMultiParam::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceMultiParam::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
...
string InstanceMultiParam::GetTips() const
{
    return m_tips;
}

void InstanceMultiParam::SetTips(const string& _tips)
{
    m_tips = _tips;
    m_tipsHasBeenSet = true;
}
...
int64_t InstanceMultiParam::GetStatus() const
{
    return m_status;
}

void InstanceMultiParam::SetStatus(const int64_t& _status)
{
    m_status = _status;
    m_statusHasBeenSet = true;
}
