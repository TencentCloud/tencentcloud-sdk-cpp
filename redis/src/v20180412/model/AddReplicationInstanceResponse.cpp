...
CoreInternalOutcome AddReplicationInstanceResponse::Deserialize(const string &payload)
{
...
string AddReplicationInstanceResponse::ToJsonString() const
{
...
int64_t AddReplicationInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool AddReplicationInstanceResponse::TaskIdHasBeenSet() const
{
