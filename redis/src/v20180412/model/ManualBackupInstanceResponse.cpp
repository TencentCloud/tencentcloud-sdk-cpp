...
CoreInternalOutcome ManualBackupInstanceResponse::Deserialize(const string &payload)
{
...
string ManualBackupInstanceResponse::ToJsonString() const
{
...
int64_t ManualBackupInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool ManualBackupInstanceResponse::TaskIdHasBeenSet() const
{
