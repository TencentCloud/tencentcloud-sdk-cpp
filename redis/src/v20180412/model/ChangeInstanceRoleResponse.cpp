...
CoreInternalOutcome ChangeInstanceRoleResponse::Deserialize(const string &payload)
{
...
string ChangeInstanceRoleResponse::ToJsonString() const
{
...
int64_t ChangeInstanceRoleResponse::GetTaskId() const
{
    return m_taskId;
}

bool ChangeInstanceRoleResponse::TaskIdHasBeenSet() const
{
