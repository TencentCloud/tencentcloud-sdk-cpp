...
string RenewInstanceResponse::GetDealId() const
{
    return m_dealId;
}

bool RenewInstanceResponse::DealIdHasBeenSet() const
{
    return m_dealIdHasBeenSet;
}

string RenewInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool RenewInstanceResponse::DealNameHasBeenSet() const
{
