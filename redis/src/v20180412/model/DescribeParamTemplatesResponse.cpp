...
uint64_t DescribeParamTemplatesResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<ParamTemplateInfo> DescribeParamTemplatesResponse::GetItems() const
{
    return m_items;
}
