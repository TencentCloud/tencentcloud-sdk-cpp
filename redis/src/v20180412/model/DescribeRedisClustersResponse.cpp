...
CoreInternalOutcome DescribeRedisClustersResponse::Deserialize(const string &payload)
{
...
string DescribeRedisClustersResponse::ToJsonString() const
{
...
int64_t DescribeRedisClustersResponse::GetTotal() const
{
    return m_total;
}

bool DescribeRedisClustersResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<CDCResource> DescribeRedisClustersResponse::GetResources() const
{
    return m_resources;
}

bool DescribeRedisClustersResponse::ResourcesHasBeenSet() const
{
