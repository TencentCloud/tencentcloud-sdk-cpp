...
CoreInternalOutcome ClearInstanceResponse::Deserialize(const string &payload)
{
...
string ClearInstanceResponse::ToJsonString() const
{
...
int64_t ClearInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool ClearInstanceResponse::TaskIdHasBeenSet() const
{
