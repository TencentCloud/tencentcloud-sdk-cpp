...
CoreInternalOutcome DescribeReplicationGroupResponse::Deserialize(const string &payload)
{
...
string DescribeReplicationGroupResponse::ToJsonString() const
{
...
int64_t DescribeReplicationGroupResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeReplicationGroupResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Groups> DescribeReplicationGroupResponse::GetGroups() const
{
    return m_groups;
}

bool DescribeReplicationGroupResponse::GroupsHasBeenSet() const
{
