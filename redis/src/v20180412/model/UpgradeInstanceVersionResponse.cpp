...
string UpgradeInstanceVersionResponse::ToJsonString() const
{
...
string UpgradeInstanceVersionResponse::GetDealName() const
{
    return m_dealName;
}

bool UpgradeInstanceVersionResponse::DealNameHasBeenSet() const
{
