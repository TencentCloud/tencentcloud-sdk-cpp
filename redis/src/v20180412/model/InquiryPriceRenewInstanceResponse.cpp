...
double InquiryPriceRenewInstanceResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquiryPriceRenewInstanceResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

double InquiryPriceRenewInstanceResponse::GetHighPrecisionOriginalPrice() const
{
    return m_highPrecisionOriginalPrice;
}

bool InquiryPriceRenewInstanceResponse::HighPrecisionOriginalPriceHasBeenSet() const
{
