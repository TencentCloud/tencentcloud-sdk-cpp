...
string EnableReplicaReadonlyRequest::ToJsonString() const
{
...
string EnableReplicaReadonlyRequest::GetInstanceId() const
{
    return m_instanceId;
}

void EnableReplicaReadonlyRequest::SetInstanceId(const string& _instanceId)
{
