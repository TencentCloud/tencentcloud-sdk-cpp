...
CoreInternalOutcome ModifyInstancePasswordResponse::Deserialize(const string &payload)
{
...
string ModifyInstancePasswordResponse::ToJsonString() const
{
...
int64_t ModifyInstancePasswordResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyInstancePasswordResponse::TaskIdHasBeenSet() const
{
