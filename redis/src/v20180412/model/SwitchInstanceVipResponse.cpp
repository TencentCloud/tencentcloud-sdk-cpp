...
CoreInternalOutcome SwitchInstanceVipResponse::Deserialize(const string &payload)
{
...
string SwitchInstanceVipResponse::ToJsonString() const
{
...
int64_t SwitchInstanceVipResponse::GetTaskId() const
{
    return m_taskId;
}

bool SwitchInstanceVipResponse::TaskIdHasBeenSet() const
{
