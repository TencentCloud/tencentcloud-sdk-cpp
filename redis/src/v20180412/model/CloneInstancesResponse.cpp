...
CoreInternalOutcome CloneInstancesResponse::Deserialize(const string &payload)
{
...
string CloneInstancesResponse::ToJsonString() const
{
...
string CloneInstancesResponse::GetDealId() const
{
    return m_dealId;
}

bool CloneInstancesResponse::DealIdHasBeenSet() const
{
    return m_dealIdHasBeenSet;
}

vector<string> CloneInstancesResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CloneInstancesResponse::InstanceIdsHasBeenSet() const
{
    return m_instanceIdsHasBeenSet;
}

string CloneInstancesResponse::GetDealName() const
{
    return m_dealName;
}

bool CloneInstancesResponse::DealNameHasBeenSet() const
{
