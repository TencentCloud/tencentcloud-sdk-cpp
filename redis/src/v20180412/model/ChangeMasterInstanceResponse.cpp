...
CoreInternalOutcome ChangeMasterInstanceResponse::Deserialize(const string &payload)
{
...
string ChangeMasterInstanceResponse::ToJsonString() const
{
...
int64_t ChangeMasterInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool ChangeMasterInstanceResponse::TaskIdHasBeenSet() const
{
