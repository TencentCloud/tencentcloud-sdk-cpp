...
CoreInternalOutcome RestoreInstanceResponse::Deserialize(const string &payload)
{
...
string RestoreInstanceResponse::ToJsonString() const
{
...
int64_t RestoreInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool RestoreInstanceResponse::TaskIdHasBeenSet() const
{
