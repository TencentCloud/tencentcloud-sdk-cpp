...
CoreInternalOutcome UpgradeSmallVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeSmallVersionResponse::ToJsonString() const
{
...
int64_t UpgradeSmallVersionResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeSmallVersionResponse::FlowIdHasBeenSet() const
{
