...
CoreInternalOutcome CreateParamTemplateResponse::Deserialize(const string &payload)
{
...
string CreateParamTemplateResponse::ToJsonString() const
{
...
string CreateParamTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateParamTemplateResponse::TemplateIdHasBeenSet() const
{
