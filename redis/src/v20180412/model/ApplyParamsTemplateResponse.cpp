...
CoreInternalOutcome ApplyParamsTemplateResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TaskIds") && !rsp["TaskIds"].IsNull())
    {
        ...
        {
            m_taskIds.push_back((*itr).GetInt64());
        }
...
string ApplyParamsTemplateResponse::ToJsonString() const
{
...
vector<int64_t> ApplyParamsTemplateResponse::GetTaskIds() const
{
    return m_taskIds;
}

bool ApplyParamsTemplateResponse::TaskIdsHasBeenSet() const
{
