...
CoreInternalOutcome ModifyInstanceBackupModeResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceBackupModeResponse::ToJsonString() const
{
...
int64_t ModifyInstanceBackupModeResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyInstanceBackupModeResponse::TaskIdHasBeenSet() const
{
