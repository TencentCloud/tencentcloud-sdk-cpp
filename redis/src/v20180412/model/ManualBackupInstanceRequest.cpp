...
string ManualBackupInstanceRequest::ToJsonString() const
{
...
string ManualBackupInstanceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void ManualBackupInstanceRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ManualBackupInstanceRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ManualBackupInstanceRequest::GetRemark() const
{
    return m_remark;
}

void ManualBackupInstanceRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
