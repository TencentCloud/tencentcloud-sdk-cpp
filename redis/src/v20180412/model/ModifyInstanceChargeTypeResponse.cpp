...
CoreInternalOutcome ModifyInstanceChargeTypeResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("FailedInstanceIds") && !rsp["FailedInstanceIds"].IsNull())
    {
        ...
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ...
            m_failedInstanceIds.push_back(item);
        }
...
string ModifyInstanceChargeTypeResponse::ToJsonString() const
{
    ...
    if (m_failedInstanceIdsHasBeenSet)
    {
        ...
        int i=0;
        for (auto itr = m_failedInstanceIds.begin(); itr != m_failedInstanceIds.end(); ++itr, ++i)
        {
...
vector<FailedInstance> ModifyInstanceChargeTypeResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool ModifyInstanceChargeTypeResponse::FailedInstanceIdsHasBeenSet() const
{
