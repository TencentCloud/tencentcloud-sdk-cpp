...
string DescribeRedisClusterOverviewRequest::ToJsonString() const
{
...
string DescribeRedisClusterOverviewRequest::GetDedicatedClusterId() const
{
    return m_dedicatedClusterId;
}

void DescribeRedisClusterOverviewRequest::SetDedicatedClusterId(const string& _dedicatedClusterId)
{
    m_dedicatedClusterId = _dedicatedClusterId;
    m_dedicatedClusterIdHasBeenSet = true;
}

bool DescribeRedisClusterOverviewRequest::DedicatedClusterIdHasBeenSet() const
{
