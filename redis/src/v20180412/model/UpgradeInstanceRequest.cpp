...
uint64_t UpgradeInstanceRequest::GetMemSize() const
{
    return m_memSize;
}

void UpgradeInstanceRequest::SetMemSize(const uint64_t& _memSize)
{
    m_memSize = _memSize;
...
uint64_t UpgradeInstanceRequest::GetRedisShardNum() const
{
    return m_redisShardNum;
}

void UpgradeInstanceRequest::SetRedisShardNum(const uint64_t& _redisShardNum)
{
    m_redisShardNum = _redisShardNum;
    m_redisShardNumHasBeenSet = true;
}

bool UpgradeInstanceRequest::RedisShardNumHasBeenSet() const
{
    return m_redisShardNumHasBeenSet;
}

uint64_t UpgradeInstanceRequest::GetRedisReplicasNum() const
{
    return m_redisReplicasNum;
}

void UpgradeInstanceRequest::SetRedisReplicasNum(const uint64_t& _redisReplicasNum)
{
