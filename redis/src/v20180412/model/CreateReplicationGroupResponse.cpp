...
CoreInternalOutcome CreateReplicationGroupResponse::Deserialize(const string &payload)
{
...
string CreateReplicationGroupResponse::ToJsonString() const
{
...
int64_t CreateReplicationGroupResponse::GetTaskId() const
{
    return m_taskId;
}
