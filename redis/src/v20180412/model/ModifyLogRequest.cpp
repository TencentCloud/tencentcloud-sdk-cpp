...
string ModifyLogRequest::GetInstanceId() const
{
    return m_instanceId;
}

void ModifyLogRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ModifyLogRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ModifyLogRequest::GetLogType() const
{
    return m_logType;
}

void ModifyLogRequest::SetLogType(const string& _logType)
{
    m_logType = _logType;
    m_logTypeHasBeenSet = true;
}

bool ModifyLogRequest::LogTypeHasBeenSet() const
{
    return m_logTypeHasBeenSet;
}

string ModifyLogRequest::GetLogSubType() const
{
    return m_logSubType;
}

void ModifyLogRequest::SetLogSubType(const string& _logSubType)
{
    m_logSubType = _logSubType;
    m_logSubTypeHasBeenSet = true;
}

bool ModifyLogRequest::LogSubTypeHasBeenSet() const
{
    return m_logSubTypeHasBeenSet;
}

int64_t ModifyLogRequest::GetLogExpireDay() const
{
    return m_logExpireDay;
}

void ModifyLogRequest::SetLogExpireDay(const int64_t& _logExpireDay)
{
    m_logExpireDay = _logExpireDay;
    m_logExpireDayHasBeenSet = true;
}

bool ModifyLogRequest::LogExpireDayHasBeenSet() const
{
    return m_logExpireDayHasBeenSet;
}

int64_t ModifyLogRequest::GetHighLogExpireDay() const
{
    return m_highLogExpireDay;
}

void ModifyLogRequest::SetHighLogExpireDay(const int64_t& _highLogExpireDay)
{
    m_highLogExpireDay = _highLogExpireDay;
    m_highLogExpireDayHasBeenSet = true;
}

bool ModifyLogRequest::HighLogExpireDayHasBeenSet() const
{
    return m_highLogExpireDayHasBeenSet;
}

int64_t ModifyLogRequest::GetDegradeStrategy() const
{
    return m_degradeStrategy;
}

void ModifyLogRequest::SetDegradeStrategy(const int64_t& _degradeStrategy)
{
    m_degradeStrategy = _degradeStrategy;
    m_degradeStrategyHasBeenSet = true;
}

bool ModifyLogRequest::DegradeStrategyHasBeenSet() const
{
