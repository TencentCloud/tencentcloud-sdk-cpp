...
CoreInternalOutcome ModifyInstanceEventResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceEventResponse::ToJsonString() const
{
...
int64_t ModifyInstanceEventResponse::GetEventId() const
{
    return m_eventId;
}

bool ModifyInstanceEventResponse::EventIdHasBeenSet() const
{
