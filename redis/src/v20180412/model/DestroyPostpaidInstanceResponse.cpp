...
CoreInternalOutcome DestroyPostpaidInstanceResponse::Deserialize(const string &payload)
{
...
string DestroyPostpaidInstanceResponse::ToJsonString() const
{
...
int64_t DestroyPostpaidInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool DestroyPostpaidInstanceResponse::TaskIdHasBeenSet() const
{
