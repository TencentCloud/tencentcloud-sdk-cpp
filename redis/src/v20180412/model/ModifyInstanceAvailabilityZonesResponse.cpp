...
CoreInternalOutcome ModifyInstanceAvailabilityZonesResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceAvailabilityZonesResponse::ToJsonString() const
{
...
int64_t ModifyInstanceAvailabilityZonesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyInstanceAvailabilityZonesResponse::TaskIdHasBeenSet() const
{
