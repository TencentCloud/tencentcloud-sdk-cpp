...
string ModifyParamTemplateRequest::GetTemplateId() const
{
    return m_templateId;
}

void ModifyParamTemplateRequest::SetTemplateId(const string& _templateId)
{
...
vector<InstanceParam> ModifyParamTemplateRequest::GetParamList() const
{
    return m_paramList;
}

void ModifyParamTemplateRequest::SetParamList(const vector<InstanceParam>& _paramList)
{
