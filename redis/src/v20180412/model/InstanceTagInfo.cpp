...
CoreInternalOutcome InstanceTagInfo::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("TagKey") && !value["TagKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `InstanceTagInfo.TagKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TagValue") && !value["TagValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `InstanceTagInfo.TagValue` IsString=false incorrectly").SetRequestId(requestId));
        }
