...
CoreInternalOutcome InstanceTagInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TagKey") && !value["TagKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceTagInfo.TagKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TagValue") && !value["TagValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InstanceTagInfo.TagValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string InstanceTagInfo::GetTagKey() const
{
    return m_tagKey;
}

void InstanceTagInfo::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool InstanceTagInfo::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string InstanceTagInfo::GetTagValue() const
{
    return m_tagValue;
}

void InstanceTagInfo::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool InstanceTagInfo::TagValueHasBeenSet() const
{
