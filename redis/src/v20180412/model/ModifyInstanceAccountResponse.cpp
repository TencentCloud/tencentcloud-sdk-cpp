...
CoreInternalOutcome ModifyInstanceAccountResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceAccountResponse::ToJsonString() const
{
...
int64_t ModifyInstanceAccountResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyInstanceAccountResponse::TaskIdHasBeenSet() const
{
