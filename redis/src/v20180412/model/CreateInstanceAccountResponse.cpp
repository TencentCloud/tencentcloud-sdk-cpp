...
CoreInternalOutcome CreateInstanceAccountResponse::Deserialize(const string &payload)
{
...
string CreateInstanceAccountResponse::ToJsonString() const
{
...
int64_t CreateInstanceAccountResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateInstanceAccountResponse::TaskIdHasBeenSet() const
{
