...
CoreInternalOutcome EnableReplicaReadonlyResponse::Deserialize(const string &payload)
{
...
string EnableReplicaReadonlyResponse::ToJsonString() const
{
...
string EnableReplicaReadonlyResponse::GetStatus() const
{
    return m_status;
}
