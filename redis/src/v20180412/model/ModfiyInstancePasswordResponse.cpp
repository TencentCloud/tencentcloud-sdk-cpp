...
CoreInternalOutcome ModfiyInstancePasswordResponse::Deserialize(const string &payload)
{
...
string ModfiyInstancePasswordResponse::ToJsonString() const
{
...
int64_t ModfiyInstancePasswordResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModfiyInstancePasswordResponse::TaskIdHasBeenSet() const
{
