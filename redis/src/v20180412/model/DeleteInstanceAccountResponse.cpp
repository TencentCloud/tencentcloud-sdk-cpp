...
CoreInternalOutcome DeleteInstanceAccountResponse::Deserialize(const string &payload)
{
...
string DeleteInstanceAccountResponse::ToJsonString() const
{
...
int64_t DeleteInstanceAccountResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteInstanceAccountResponse::TaskIdHasBeenSet() const
{
