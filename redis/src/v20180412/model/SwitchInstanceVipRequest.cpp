...
string SwitchInstanceVipRequest::ToJsonString() const
{
    ...
    if (m_srcInstanceIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_srcInstanceId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_dstInstanceIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_dstInstanceId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_switchTimeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_switchTime.c_str(), allocator).Move(), allocator);
    }
