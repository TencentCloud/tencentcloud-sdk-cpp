...
CoreInternalOutcome StartupInstanceResponse::Deserialize(const string &payload)
{
...
string StartupInstanceResponse::ToJsonString() const
{
...
int64_t StartupInstanceResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartupInstanceResponse::TaskIdHasBeenSet() const
{
