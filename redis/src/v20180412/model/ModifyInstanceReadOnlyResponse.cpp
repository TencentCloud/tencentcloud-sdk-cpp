...
CoreInternalOutcome ModifyInstanceReadOnlyResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceReadOnlyResponse::ToJsonString() const
{
...
int64_t ModifyInstanceReadOnlyResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyInstanceReadOnlyResponse::TaskIdHasBeenSet() const
{
