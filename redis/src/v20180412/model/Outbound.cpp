...
CoreInternalOutcome Outbound::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("AddressModule") && !value["AddressModule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Outbound.AddressModule` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ServiceModule") && !value["ServiceModule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Outbound.ServiceModule` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Id") && !value["Id"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Outbound.Id` IsString=false incorrectly").SetRequestId(requestId));
        }
