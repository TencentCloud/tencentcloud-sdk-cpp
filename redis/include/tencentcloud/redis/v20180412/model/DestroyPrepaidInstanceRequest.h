...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESTROYPREPAIDINSTANCEREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESTROYPREPAIDINSTANCEREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DestroyPrepaidInstanceRequest : public AbstractModel
                {
                public:
                    DestroyPrepaidInstanceRequest();
                    ~DestroyPrepaidInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESTROYPREPAIDINSTANCEREQUEST_H_
