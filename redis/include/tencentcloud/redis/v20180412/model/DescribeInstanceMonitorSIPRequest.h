...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORSIPREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORSIPREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceMonitorSIPRequest : public AbstractModel
                {
                public:
                    DescribeInstanceMonitorSIPRequest();
                    ~DescribeInstanceMonitorSIPRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORSIPREQUEST_H_
