...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEPASSWORDPOLICYREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEPASSWORDPOLICYREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DescribeInstancePasswordPolicyRequest : public AbstractModel
                {
                public:
                    DescribeInstancePasswordPolicyRequest();
                    ~DescribeInstancePasswordPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEPASSWORDPOLICYREQUEST_H_
