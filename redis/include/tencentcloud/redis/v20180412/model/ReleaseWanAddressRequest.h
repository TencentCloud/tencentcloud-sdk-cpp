...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_RELEASEWANADDRESSREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_RELEASEWANADDRESSREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class ReleaseWanAddressRequest : public AbstractModel
                {
                public:
                    ReleaseWanAddressRequest();
                    ~ReleaseWanAddressRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_RELEASEWANADDRESSREQUEST_H_
