...
CoreInternalOutcome GetTopicsResponse::Deserialize(const string &payload)
{
...
string GetTopicsResponse::ToJsonString() const
{
...
vector<Topic> GetTopicsResponse::GetTopics() const
{
    return m_topics;
}

bool GetTopicsResponse::TopicsHasBeenSet() const
{
    return m_topicsHasBeenSet;
}

uint64_t GetTopicsResponse::GetTotal() const
{
    return m_total;
}

bool GetTopicsResponse::TotalHasBeenSet() const
{
