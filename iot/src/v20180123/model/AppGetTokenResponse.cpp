...
CoreInternalOutcome AppGetTokenResponse::Deserialize(const string &payload)
{
...
string AppGetTokenResponse::ToJsonString() const
{
...
string AppGetTokenResponse::GetAccessToken() const
{
    return m_accessToken;
}

bool AppGetTokenResponse::AccessTokenHasBeenSet() const
{
