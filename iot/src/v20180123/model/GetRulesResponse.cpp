...
CoreInternalOutcome GetRulesResponse::Deserialize(const string &payload)
{
...
string GetRulesResponse::ToJsonString() const
{
...
vector<Rule> GetRulesResponse::GetRules() const
{
    return m_rules;
}

bool GetRulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

uint64_t GetRulesResponse::GetTotal() const
{
    return m_total;
}

bool GetRulesResponse::TotalHasBeenSet() const
{
