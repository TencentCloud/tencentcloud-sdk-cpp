...
CoreInternalOutcome AppGetDevicesResponse::Deserialize(const string &payload)
{
...
string AppGetDevicesResponse::ToJsonString() const
{
...
vector<AppDevice> AppGetDevicesResponse::GetDevices() const
{
    return m_devices;
}

bool AppGetDevicesResponse::DevicesHasBeenSet() const
{
