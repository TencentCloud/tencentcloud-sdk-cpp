...
string AppGetUserRequest::ToJsonString() const
{
...
string AppGetUserRequest::GetAccessToken() const
{
    return m_accessToken;
}

void AppGetUserRequest::SetAccessToken(const string& _accessToken)
{
    m_accessToken = _accessToken;
    m_accessTokenHasBeenSet = true;
}

bool AppGetUserRequest::AccessTokenHasBeenSet() const
{
