...
CoreInternalOutcome GetProductsResponse::Deserialize(const string &payload)
{
...
string GetProductsResponse::ToJsonString() const
{
...
vector<ProductEntry> GetProductsResponse::GetProducts() const
{
    return m_products;
}

bool GetProductsResponse::ProductsHasBeenSet() const
{
    return m_productsHasBeenSet;
}

uint64_t GetProductsResponse::GetTotal() const
{
    return m_total;
}

bool GetProductsResponse::TotalHasBeenSet() const
{
