...
CoreInternalOutcome DataHistoryEntry::Deserialize(const Value &value)
{
    string requestId = "";
...
void DataHistoryEntry::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
