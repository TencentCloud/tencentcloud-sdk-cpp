...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_GETDEBUGLOGREQUEST_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_GETDEBUGLOGREQUEST_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                * GetDebugLog请求参数结构体
                */
                class GetDebugLogRequest : public AbstractModel
                {
                public:
                    GetDebugLogRequest();
                    ~GetDebugLogRequest() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_GETDEBUGLOGREQUEST_H_
