...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_GETDEVICELOGREQUEST_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_GETDEVICELOGREQUEST_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                * GetDeviceLog请求参数结构体
                */
                class GetDeviceLogRequest : public AbstractModel
                {
                public:
                    GetDeviceLogRequest();
                    ~GetDeviceLogRequest() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_GETDEVICELOGREQUEST_H_
