...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_APPGETDEVICESTATUSESRESPONSE_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_APPGETDEVICESTATUSESRESPONSE_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                */
                class AppGetDeviceStatusesResponse : public AbstractModel
                {
                public:
                    AppGetDeviceStatusesResponse();
                    ~AppGetDeviceStatusesResponse() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_APPGETDEVICESTATUSESRESPONSE_H_
