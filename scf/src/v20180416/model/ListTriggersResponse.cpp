...
CoreInternalOutcome ListTriggersResponse::Deserialize(const string &payload)
{
...
string ListTriggersResponse::ToJsonString() const
{
...
uint64_t ListTriggersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListTriggersResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TriggerInfo> ListTriggersResponse::GetTriggers() const
{
    return m_triggers;
}

bool ListTriggersResponse::TriggersHasBeenSet() const
{
