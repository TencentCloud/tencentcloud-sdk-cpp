...
CoreInternalOutcome InvokeFunctionResponse::Deserialize(const string &payload)
{
...
string InvokeFunctionResponse::ToJsonString() const
{
...
Result InvokeFunctionResponse::GetResult() const
{
    return m_result;
}

bool InvokeFunctionResponse::ResultHasBeenSet() const
{
