...
string DeleteLayerVersionRequest::ToJsonString() const
{
...
string DeleteLayerVersionRequest::GetLayerName() const
{
    return m_layerName;
}

void DeleteLayerVersionRequest::SetLayerName(const string& _layerName)
{
    m_layerName = _layerName;
    m_layerNameHasBeenSet = true;
}

bool DeleteLayerVersionRequest::LayerNameHasBeenSet() const
{
    return m_layerNameHasBeenSet;
}

int64_t DeleteLayerVersionRequest::GetLayerVersion() const
{
    return m_layerVersion;
}

void DeleteLayerVersionRequest::SetLayerVersion(const int64_t& _layerVersion)
{
    m_layerVersion = _layerVersion;
    m_layerVersionHasBeenSet = true;
}

bool DeleteLayerVersionRequest::LayerVersionHasBeenSet() const
{
