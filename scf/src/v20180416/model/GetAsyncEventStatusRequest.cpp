...
string GetAsyncEventStatusRequest::ToJsonString() const
{
...
string GetAsyncEventStatusRequest::GetInvokeRequestId() const
{
    return m_invokeRequestId;
}

void GetAsyncEventStatusRequest::SetInvokeRequestId(const string& _invokeRequestId)
{
    m_invokeRequestId = _invokeRequestId;
    m_invokeRequestIdHasBeenSet = true;
}

bool GetAsyncEventStatusRequest::InvokeRequestIdHasBeenSet() const
{
