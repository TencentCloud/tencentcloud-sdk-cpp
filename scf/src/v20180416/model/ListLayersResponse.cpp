...
CoreInternalOutcome ListLayersResponse::Deserialize(const string &payload)
{
...
string ListLayersResponse::ToJsonString() const
{
...
vector<LayerVersionInfo> ListLayersResponse::GetLayers() const
{
    return m_layers;
}

bool ListLayersResponse::LayersHasBeenSet() const
{
    return m_layersHasBeenSet;
}

int64_t ListLayersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListLayersResponse::TotalCountHasBeenSet() const
{
