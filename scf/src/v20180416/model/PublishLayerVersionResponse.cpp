...
CoreInternalOutcome PublishLayerVersionResponse::Deserialize(const string &payload)
{
...
string PublishLayerVersionResponse::ToJsonString() const
{
...
int64_t PublishLayerVersionResponse::GetLayerVersion() const
{
    return m_layerVersion;
}

bool PublishLayerVersionResponse::LayerVersionHasBeenSet() const
{
