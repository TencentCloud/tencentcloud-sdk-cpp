...
CoreInternalOutcome UpdateFunctionEventInvokeConfigResponse::Deserialize(const string &payload)
{
...
string UpdateFunctionEventInvokeConfigResponse::ToJsonString() const
{
