...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_FWGROUPIDNAME_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_FWGROUPIDNAME_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                * 防火墙(组)ID 和 名称
                */
                class FwGroupIdName : public AbstractModel
                {
                public:
                    FwGroupIdName();
                    ~FwGroupIdName() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_FWGROUPIDNAME_H_
