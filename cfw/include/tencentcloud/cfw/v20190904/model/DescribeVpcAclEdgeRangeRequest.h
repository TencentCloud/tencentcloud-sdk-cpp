...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEVPCACLEDGERANGEREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEVPCACLEDGERANGEREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeVpcAclEdgeRangeRequest : public AbstractModel
                {
                public:
                    DescribeVpcAclEdgeRangeRequest();
                    ~DescribeVpcAclEdgeRangeRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
                     * @return FromList 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
                     * 
                     */
                    std::string GetFromList() const;

                    /**
                     * 设置规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
                     * @param _fromList 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
                     * 
                     */
                    void SetFromList(const std::string& _fromList);

                    /**
                     * 判断参数 FromList 是否已赋值
                     * @return FromList 是否已赋值
                     * 
                     */
                    bool FromListHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    std::string m_fromList;
                    bool m_fromListHasBeenSet;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEVPCACLEDGERANGEREQUEST_H_
