...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATCCNFWSWITCHREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATCCNFWSWITCHREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeNatCcnFwSwitchRequest : public AbstractModel
                {
                public:
                    DescribeNatCcnFwSwitchRequest();
                    ~DescribeNatCcnFwSwitchRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATCCNFWSWITCHREQUEST_H_
