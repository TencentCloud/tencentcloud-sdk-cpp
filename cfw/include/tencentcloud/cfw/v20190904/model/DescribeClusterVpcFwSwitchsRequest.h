...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBECLUSTERVPCFWSWITCHSREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBECLUSTERVPCFWSWITCHSREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeClusterVpcFwSwitchsRequest : public AbstractModel
                {
                public:
                    DescribeClusterVpcFwSwitchsRequest();
                    ~DescribeClusterVpcFwSwitchsRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBECLUSTERVPCFWSWITCHSREQUEST_H_
