...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSEQUENCEACLRULESREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSEQUENCEACLRULESREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class ModifySequenceAclRulesRequest : public AbstractModel
                {
                public:
                    ModifySequenceAclRulesRequest();
                    ~ModifySequenceAclRulesRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSEQUENCEACLRULESREQUEST_H_
