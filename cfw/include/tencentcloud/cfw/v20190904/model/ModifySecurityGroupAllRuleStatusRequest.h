...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSECURITYGROUPALLRULESTATUSREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSECURITYGROUPALLRULESTATUSREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class ModifySecurityGroupAllRuleStatusRequest : public AbstractModel
                {
                public:
                    ModifySecurityGroupAllRuleStatusRequest();
                    ~ModifySecurityGroupAllRuleStatusRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_MODIFYSECURITYGROUPALLRULESTATUSREQUEST_H_
