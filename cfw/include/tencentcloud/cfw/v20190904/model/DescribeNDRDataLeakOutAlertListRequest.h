...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENDRDATALEAKOUTALERTLISTREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENDRDATALEAKOUTALERTLISTREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeNDRDataLeakOutAlertListRequest : public AbstractModel
                {
                public:
                    DescribeNDRDataLeakOutAlertListRequest();
                    ~DescribeNDRDataLeakOutAlertListRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENDRDATALEAKOUTALERTLISTREQUEST_H_
