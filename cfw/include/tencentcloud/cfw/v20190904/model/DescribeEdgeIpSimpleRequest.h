...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEEDGEIPSIMPLEREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEEDGEIPSIMPLEREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeEdgeIpSimpleRequest : public AbstractModel
                {
                public:
                    DescribeEdgeIpSimpleRequest();
                    ~DescribeEdgeIpSimpleRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEEDGEIPSIMPLEREQUEST_H_
