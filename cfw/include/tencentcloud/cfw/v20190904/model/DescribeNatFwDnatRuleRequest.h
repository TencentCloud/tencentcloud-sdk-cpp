...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATFWDNATRULEREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATFWDNATRULEREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeNatFwDnatRuleRequest : public AbstractModel
                {
                public:
                    DescribeNatFwDnatRuleRequest();
                    ~DescribeNatFwDnatRuleRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>需要查询的索引，特定场景使用，可不填</p>
                    ...
                    /**
                     * 获取<p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，可不传</p>
                     * @return Order <p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，可不传</p>
                     * 
                     */
                    std::string GetOrder() const;

                    /**
                     * 设置<p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，可不传</p>
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBENATFWDNATRULEREQUEST_H_
