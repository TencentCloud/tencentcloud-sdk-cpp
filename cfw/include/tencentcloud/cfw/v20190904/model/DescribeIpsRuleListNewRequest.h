...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEIPSRULELISTNEWREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEIPSRULELISTNEWREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeIpsRuleListNewRequest : public AbstractModel
                {
                public:
                    DescribeIpsRuleListNewRequest();
                    ~DescribeIpsRuleListNewRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEIPSRULELISTNEWREQUEST_H_
