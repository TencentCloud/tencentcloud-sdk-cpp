...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DELETENATFWDNATRULEREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DELETENATFWDNATRULEREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DeleteNatFwDnatRuleRequest : public AbstractModel
                {
                public:
                    DeleteNatFwDnatRuleRequest();
                    ~DeleteNatFwDnatRuleRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DELETENATFWDNATRULEREQUEST_H_
