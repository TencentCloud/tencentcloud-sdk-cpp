...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_CHECKCLUSTERNATFWPREACCESSRESPONSE_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_CHECKCLUSTERNATFWPREACCESSRESPONSE_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class CheckClusterNatFwPreAccessResponse : public AbstractModel
                {
                public:
                    CheckClusterNatFwPreAccessResponse();
                    ~CheckClusterNatFwPreAccessResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>检查项清单，按执行顺序返回。前端据此渲染检查项骨架，描述文案已按请求的 Language 返回对应语言（中文/英文）。检查通过轮询 DescribeClusterNatCcnFwSwitchList 接口读取 CheckResult 获取每个阶段的通过/失败状态。</p>
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_CHECKCLUSTERNATFWPREACCESSRESPONSE_H_
