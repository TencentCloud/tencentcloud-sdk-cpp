...
CreateAlertCenterIsolateResponse::CreateAlertCenterIsolateResponse() :
...
CoreInternalOutcome CreateAlertCenterIsolateResponse::Deserialize(const string &payload)
{
...
string CreateAlertCenterIsolateResponse::ToJsonString() const
{
...
int64_t CreateAlertCenterIsolateResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool CreateAlertCenterIsolateResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string CreateAlertCenterIsolateResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool CreateAlertCenterIsolateResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t CreateAlertCenterIsolateResponse::GetStatus() const
{
    return m_status;
}

bool CreateAlertCenterIsolateResponse::StatusHasBeenSet() const
{
