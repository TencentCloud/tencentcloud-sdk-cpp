...
CoreInternalOutcome ModifyBlockIgnoreListResponse::Deserialize(const string &payload)
{
...
string ModifyBlockIgnoreListResponse::ToJsonString() const
{
...
string ModifyBlockIgnoreListResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyBlockIgnoreListResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

uint64_t ModifyBlockIgnoreListResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyBlockIgnoreListResponse::ReturnCodeHasBeenSet() const
{
