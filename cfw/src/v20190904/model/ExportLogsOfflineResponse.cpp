...
ExportLogsOfflineResponse::ExportLogsOfflineResponse() :
    m_returnCodeHasBeenSet(false),
    m_returnMsgHasBeenSet(false)
{
}

CoreInternalOutcome ExportLogsOfflineResponse::Deserialize(const string &payload)
{
...
string ExportLogsOfflineResponse::ToJsonString() const
{
...
int64_t ExportLogsOfflineResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ExportLogsOfflineResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string ExportLogsOfflineResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ExportLogsOfflineResponse::ReturnMsgHasBeenSet() const
{
