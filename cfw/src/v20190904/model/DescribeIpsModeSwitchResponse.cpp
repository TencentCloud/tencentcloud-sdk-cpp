...
DescribeIpsModeSwitchResponse::DescribeIpsModeSwitchResponse() :
...
CoreInternalOutcome DescribeIpsModeSwitchResponse::Deserialize(const string &payload)
{
...
string DescribeIpsModeSwitchResponse::ToJsonString() const
{
...
ModeInfo DescribeIpsModeSwitchResponse::GetData() const
{
    return m_data;
}

bool DescribeIpsModeSwitchResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIpsModeSwitchResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeIpsModeSwitchResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeIpsModeSwitchResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DescribeIpsModeSwitchResponse::ReturnMsgHasBeenSet() const
{
