...
CoreInternalOutcome DescribeTLogInfoResponse::Deserialize(const string &payload)
{
...
string DescribeTLogInfoResponse::ToJsonString() const
{
...
TLogInfo DescribeTLogInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeTLogInfoResponse::DataHasBeenSet() const
{
