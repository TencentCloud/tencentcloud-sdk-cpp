...
CoreInternalOutcome ModifySecurityGroupSequenceRulesResponse::Deserialize(const string &payload)
{
...
string ModifySecurityGroupSequenceRulesResponse::ToJsonString() const
{
...
uint64_t ModifySecurityGroupSequenceRulesResponse::GetStatus() const
{
    return m_status;
}

bool ModifySecurityGroupSequenceRulesResponse::StatusHasBeenSet() const
{
