...
CoreInternalOutcome ModifyAllPublicIPSwitchStatusResponse::Deserialize(const string &payload)
{
...
string ModifyAllPublicIPSwitchStatusResponse::ToJsonString() const
{
...
string ModifyAllPublicIPSwitchStatusResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyAllPublicIPSwitchStatusResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t ModifyAllPublicIPSwitchStatusResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyAllPublicIPSwitchStatusResponse::ReturnCodeHasBeenSet() const
{
