...
CoreInternalOutcome DescribeAssetSyncResponse::Deserialize(const string &payload)
{
...
string DescribeAssetSyncResponse::ToJsonString() const
{
...
int64_t DescribeAssetSyncResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAssetSyncResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeAssetSyncResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DescribeAssetSyncResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

uint64_t DescribeAssetSyncResponse::GetReturnCode() const
{
    return m_returnCode;
}
