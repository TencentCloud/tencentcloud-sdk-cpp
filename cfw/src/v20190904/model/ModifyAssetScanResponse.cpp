...
CoreInternalOutcome ModifyAssetScanResponse::Deserialize(const string &payload)
{
...
string ModifyAssetScanResponse::ToJsonString() const
{
...
string ModifyAssetScanResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyAssetScanResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t ModifyAssetScanResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyAssetScanResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

int64_t ModifyAssetScanResponse::GetStatus() const
{
    return m_status;
}

bool ModifyAssetScanResponse::StatusHasBeenSet() const
{
