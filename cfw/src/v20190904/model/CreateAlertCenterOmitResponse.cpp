...
CreateAlertCenterOmitResponse::CreateAlertCenterOmitResponse() :
...
CoreInternalOutcome CreateAlertCenterOmitResponse::Deserialize(const string &payload)
{
...
string CreateAlertCenterOmitResponse::ToJsonString() const
{
...
int64_t CreateAlertCenterOmitResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool CreateAlertCenterOmitResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string CreateAlertCenterOmitResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool CreateAlertCenterOmitResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t CreateAlertCenterOmitResponse::GetStatus() const
{
    return m_status;
}

bool CreateAlertCenterOmitResponse::StatusHasBeenSet() const
{
