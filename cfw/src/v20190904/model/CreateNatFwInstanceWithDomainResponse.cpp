...
CoreInternalOutcome CreateNatFwInstanceWithDomainResponse::Deserialize(const string &payload)
{
...
string CreateNatFwInstanceWithDomainResponse::ToJsonString() const
{
