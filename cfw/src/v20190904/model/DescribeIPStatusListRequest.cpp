...
string DescribeIPStatusListRequest::ToJsonString() const
{
...
vector<string> DescribeIPStatusListRequest::GetIPList() const
{
    return m_iPList;
}

void DescribeIPStatusListRequest::SetIPList(const vector<string>& _iPList)
{
    m_iPList = _iPList;
    m_iPListHasBeenSet = true;
}

bool DescribeIPStatusListRequest::IPListHasBeenSet() const
{
