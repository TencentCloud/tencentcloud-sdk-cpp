...
ModifyIsolateTableResponse::ModifyIsolateTableResponse() :
    m_returnCodeHasBeenSet(false),
    m_returnMsgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyIsolateTableResponse::Deserialize(const string &payload)
{
...
string ModifyIsolateTableResponse::ToJsonString() const
{
...
int64_t ModifyIsolateTableResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyIsolateTableResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string ModifyIsolateTableResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyIsolateTableResponse::ReturnMsgHasBeenSet() const
{
