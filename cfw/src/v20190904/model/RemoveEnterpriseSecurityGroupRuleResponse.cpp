...
CoreInternalOutcome RemoveEnterpriseSecurityGroupRuleResponse::Deserialize(const string &payload)
{
...
string RemoveEnterpriseSecurityGroupRuleResponse::ToJsonString() const
{
...
int64_t RemoveEnterpriseSecurityGroupRuleResponse::GetRuleUuid() const
{
    return m_ruleUuid;
}

bool RemoveEnterpriseSecurityGroupRuleResponse::RuleUuidHasBeenSet() const
{
    return m_ruleUuidHasBeenSet;
}

int64_t RemoveEnterpriseSecurityGroupRuleResponse::GetStatus() const
{
    return m_status;
}

bool RemoveEnterpriseSecurityGroupRuleResponse::StatusHasBeenSet() const
{
