...
DescribeCfwRulesResponse::DescribeCfwRulesResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCfwRulesResponse::Deserialize(const string &payload)
{
...
string DescribeCfwRulesResponse::ToJsonString() const
{
...
string DescribeCfwRulesResponse::GetData() const
{
    return m_data;
}

bool DescribeCfwRulesResponse::DataHasBeenSet() const
{
