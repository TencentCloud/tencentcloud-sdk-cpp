...
DescribeCfwSwitchesResponse::DescribeCfwSwitchesResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCfwSwitchesResponse::Deserialize(const string &payload)
{
...
string DescribeCfwSwitchesResponse::ToJsonString() const
{
...
string DescribeCfwSwitchesResponse::GetData() const
{
    return m_data;
}

bool DescribeCfwSwitchesResponse::DataHasBeenSet() const
{
