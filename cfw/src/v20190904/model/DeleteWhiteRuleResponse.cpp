...
DeleteWhiteRuleResponse::DeleteWhiteRuleResponse() :
    m_returnCodeHasBeenSet(false),
    m_returnMsgHasBeenSet(false)
{
}

CoreInternalOutcome DeleteWhiteRuleResponse::Deserialize(const string &payload)
{
...
string DeleteWhiteRuleResponse::ToJsonString() const
{
...
int64_t DeleteWhiteRuleResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DeleteWhiteRuleResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DeleteWhiteRuleResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DeleteWhiteRuleResponse::ReturnMsgHasBeenSet() const
{
