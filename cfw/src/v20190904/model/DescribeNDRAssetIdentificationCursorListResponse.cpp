...
DescribeNDRAssetIdentificationCursorListResponse::DescribeNDRAssetIdentificationCursorListResponse() :
...
CoreInternalOutcome DescribeNDRAssetIdentificationCursorListResponse::Deserialize(const string &payload)
{
...
string DescribeNDRAssetIdentificationCursorListResponse::ToJsonString() const
{
...
vector<NDRAssetServiceInfo> DescribeNDRAssetIdentificationCursorListResponse::GetData() const
{
    return m_data;
}

bool DescribeNDRAssetIdentificationCursorListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeNDRAssetIdentificationCursorListResponse::GetNextCursor() const
{
    return m_nextCursor;
}

bool DescribeNDRAssetIdentificationCursorListResponse::NextCursorHasBeenSet() const
{
    return m_nextCursorHasBeenSet;
}

bool DescribeNDRAssetIdentificationCursorListResponse::GetHasMore() const
{
    return m_hasMore;
}

bool DescribeNDRAssetIdentificationCursorListResponse::HasMoreHasBeenSet() const
{
