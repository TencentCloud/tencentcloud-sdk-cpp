...
CreateAlertCenterRuleAsyncResponse::CreateAlertCenterRuleAsyncResponse() :
...
CoreInternalOutcome CreateAlertCenterRuleAsyncResponse::Deserialize(const string &payload)
{
...
string CreateAlertCenterRuleAsyncResponse::ToJsonString() const
{
...
int64_t CreateAlertCenterRuleAsyncResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool CreateAlertCenterRuleAsyncResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string CreateAlertCenterRuleAsyncResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool CreateAlertCenterRuleAsyncResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t CreateAlertCenterRuleAsyncResponse::GetStatus() const
{
    return m_status;
}

bool CreateAlertCenterRuleAsyncResponse::StatusHasBeenSet() const
{
