...
string DeleteResourceGroupRequest::GetGroupId() const
{
    return m_groupId;
}

void DeleteResourceGroupRequest::SetGroupId(const string& _groupId)
{
    m_groupId = _groupId;
    m_groupIdHasBeenSet = true;
}

bool DeleteResourceGroupRequest::GroupIdHasBeenSet() const
{
