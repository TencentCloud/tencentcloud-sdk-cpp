...
CoreInternalOutcome DeleteSecurityGroupRuleResponse::Deserialize(const string &payload)
{
...
string DeleteSecurityGroupRuleResponse::ToJsonString() const
{
...
int64_t DeleteSecurityGroupRuleResponse::GetStatus() const
{
    return m_status;
}

bool DeleteSecurityGroupRuleResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DeleteSecurityGroupRuleResponse::GetInfo() const
{
    return m_info;
}

bool DeleteSecurityGroupRuleResponse::InfoHasBeenSet() const
{
