...
CoreInternalOutcome ModifyAllSwitchStatusResponse::Deserialize(const string &payload)
{
...
string ModifyAllSwitchStatusResponse::ToJsonString() const
{
...
uint64_t ModifyAllSwitchStatusResponse::GetStatus() const
{
    return m_status;
}

bool ModifyAllSwitchStatusResponse::StatusHasBeenSet() const
{
