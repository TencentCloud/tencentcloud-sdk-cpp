...
CoreInternalOutcome DescribeGuideScanInfoResponse::Deserialize(const string &payload)
{
...
string DescribeGuideScanInfoResponse::ToJsonString() const
{
...
ScanInfo DescribeGuideScanInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeGuideScanInfoResponse::DataHasBeenSet() const
{
