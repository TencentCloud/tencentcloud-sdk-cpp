...
string DeleteNatFwInstanceRequest::ToJsonString() const
{
...
string DeleteNatFwInstanceRequest::GetCfwInstance() const
{
    return m_cfwInstance;
}

void DeleteNatFwInstanceRequest::SetCfwInstance(const string& _cfwInstance)
{
    m_cfwInstance = _cfwInstance;
    m_cfwInstanceHasBeenSet = true;
}

bool DeleteNatFwInstanceRequest::CfwInstanceHasBeenSet() const
{
