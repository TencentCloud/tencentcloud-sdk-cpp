...
CoreInternalOutcome DescribeResourceGroupResponse::Deserialize(const string &payload)
{
...
string DescribeResourceGroupResponse::ToJsonString() const
{
...
string DescribeResourceGroupResponse::GetData() const
{
    return m_data;
}

bool DescribeResourceGroupResponse::DataHasBeenSet() const
{
