...
CoreInternalOutcome DescribeNatAcRuleResponse::Deserialize(const string &payload)
{
...
string DescribeNatAcRuleResponse::ToJsonString() const
{
...
uint64_t DescribeNatAcRuleResponse::GetTotal() const
{
    return m_total;
}

bool DescribeNatAcRuleResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DescAcItem> DescribeNatAcRuleResponse::GetData() const
{
    return m_data;
}

bool DescribeNatAcRuleResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeNatAcRuleResponse::GetAllTotal() const
{
    return m_allTotal;
}

bool DescribeNatAcRuleResponse::AllTotalHasBeenSet() const
{
