...
string DescribeVpcRuleOverviewRequest::ToJsonString() const
{
...
string DescribeVpcRuleOverviewRequest::GetEdgeId() const
{
    return m_edgeId;
}

void DescribeVpcRuleOverviewRequest::SetEdgeId(const string& _edgeId)
{
    m_edgeId = _edgeId;
    m_edgeIdHasBeenSet = true;
}

bool DescribeVpcRuleOverviewRequest::EdgeIdHasBeenSet() const
{
