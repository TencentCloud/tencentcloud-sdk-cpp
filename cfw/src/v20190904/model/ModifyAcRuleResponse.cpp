...
CoreInternalOutcome ModifyAcRuleResponse::Deserialize(const string &payload)
{
...
string ModifyAcRuleResponse::ToJsonString() const
{
...
int64_t ModifyAcRuleResponse::GetStatus() const
{
    return m_status;
}

bool ModifyAcRuleResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyAcRuleResponse::GetInfo() const
{
    return m_info;
}

bool ModifyAcRuleResponse::InfoHasBeenSet() const
{
