...
CoreInternalOutcome ModifyPublicIPSwitchStatusResponse::Deserialize(const string &payload)
{
...
string ModifyPublicIPSwitchStatusResponse::ToJsonString() const
{
...
string ModifyPublicIPSwitchStatusResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyPublicIPSwitchStatusResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t ModifyPublicIPSwitchStatusResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyPublicIPSwitchStatusResponse::ReturnCodeHasBeenSet() const
{
