...
CoreInternalOutcome DescribeIPStatusListResponse::Deserialize(const string &payload)
{
...
string DescribeIPStatusListResponse::ToJsonString() const
{
...
vector<IPDefendStatus> DescribeIPStatusListResponse::GetStatusList() const
{
    return m_statusList;
}

bool DescribeIPStatusListResponse::StatusListHasBeenSet() const
{
    return m_statusListHasBeenSet;
}

int64_t DescribeIPStatusListResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeIPStatusListResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeIPStatusListResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DescribeIPStatusListResponse::ReturnMsgHasBeenSet() const
{
