...
CoreInternalOutcome CreateSecurityGroupRulesResponse::Deserialize(const string &payload)
{
...
string CreateSecurityGroupRulesResponse::ToJsonString() const
{
...
uint64_t CreateSecurityGroupRulesResponse::GetStatus() const
{
    return m_status;
}

bool CreateSecurityGroupRulesResponse::StatusHasBeenSet() const
{
