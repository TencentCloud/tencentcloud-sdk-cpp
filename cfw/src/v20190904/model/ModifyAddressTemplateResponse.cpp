...
CoreInternalOutcome ModifyAddressTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyAddressTemplateResponse::ToJsonString() const
{
...
int64_t ModifyAddressTemplateResponse::GetStatus() const
{
    return m_status;
}

bool ModifyAddressTemplateResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyAddressTemplateResponse::GetUuid() const
{
    return m_uuid;
}
