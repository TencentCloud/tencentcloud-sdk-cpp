...
CoreInternalOutcome DescribeBlockStaticListResponse::Deserialize(const string &payload)
{
...
string DescribeBlockStaticListResponse::ToJsonString() const
{
...
vector<StaticInfo> DescribeBlockStaticListResponse::GetData() const
{
    return m_data;
}
