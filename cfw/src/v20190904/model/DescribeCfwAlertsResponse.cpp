...
DescribeCfwAlertsResponse::DescribeCfwAlertsResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCfwAlertsResponse::Deserialize(const string &payload)
{
...
string DescribeCfwAlertsResponse::ToJsonString() const
{
...
string DescribeCfwAlertsResponse::GetData() const
{
    return m_data;
}

bool DescribeCfwAlertsResponse::DataHasBeenSet() const
{
