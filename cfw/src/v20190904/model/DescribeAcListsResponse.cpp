...
CoreInternalOutcome DescribeAcListsResponse::Deserialize(const string &payload)
{
...
string DescribeAcListsResponse::ToJsonString() const
{
...
uint64_t DescribeAcListsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAcListsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AcListsData> DescribeAcListsResponse::GetData() const
{
    return m_data;
}

bool DescribeAcListsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeAcListsResponse::GetAllTotal() const
{
    return m_allTotal;
}

bool DescribeAcListsResponse::AllTotalHasBeenSet() const
{
    return m_allTotalHasBeenSet;
}

uint64_t DescribeAcListsResponse::GetEnable() const
{
    return m_enable;
}

bool DescribeAcListsResponse::EnableHasBeenSet() const
{
