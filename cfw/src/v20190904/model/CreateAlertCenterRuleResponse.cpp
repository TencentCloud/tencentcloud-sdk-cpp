...
CreateAlertCenterRuleResponse::CreateAlertCenterRuleResponse() :
...
CoreInternalOutcome CreateAlertCenterRuleResponse::Deserialize(const string &payload)
{
...
string CreateAlertCenterRuleResponse::ToJsonString() const
{
...
int64_t CreateAlertCenterRuleResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool CreateAlertCenterRuleResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string CreateAlertCenterRuleResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool CreateAlertCenterRuleResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t CreateAlertCenterRuleResponse::GetStatus() const
{
    return m_status;
}

bool CreateAlertCenterRuleResponse::StatusHasBeenSet() const
{
