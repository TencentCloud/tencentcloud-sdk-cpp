...
CoreInternalOutcome DescribeAclRuleResponse::Deserialize(const string &payload)
{
...
string DescribeAclRuleResponse::ToJsonString() const
{
...
uint64_t DescribeAclRuleResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAclRuleResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DescAcItem> DescribeAclRuleResponse::GetData() const
{
    return m_data;
}

bool DescribeAclRuleResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

uint64_t DescribeAclRuleResponse::GetAllTotal() const
{
    return m_allTotal;
}

bool DescribeAclRuleResponse::AllTotalHasBeenSet() const
{
