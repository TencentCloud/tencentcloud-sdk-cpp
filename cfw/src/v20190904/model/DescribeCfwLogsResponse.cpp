...
CoreInternalOutcome DescribeCfwLogsResponse::Deserialize(const string &payload)
{
...
string DescribeCfwLogsResponse::ToJsonString() const
{
...
string DescribeCfwLogsResponse::GetData() const
{
    return m_data;
}

bool DescribeCfwLogsResponse::DataHasBeenSet() const
{
