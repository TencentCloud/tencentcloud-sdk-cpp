...
CoreInternalOutcome ModifyVPCSwitchStatusResponse::Deserialize(const string &payload)
{
...
string ModifyVPCSwitchStatusResponse::ToJsonString() const
{
...
string ModifyVPCSwitchStatusResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyVPCSwitchStatusResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

int64_t ModifyVPCSwitchStatusResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyVPCSwitchStatusResponse::ReturnCodeHasBeenSet() const
{
