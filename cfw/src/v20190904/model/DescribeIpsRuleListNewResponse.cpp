...
DescribeIpsRuleListNewResponse::DescribeIpsRuleListNewResponse() :
...
CoreInternalOutcome DescribeIpsRuleListNewResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Category"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Category` is not array type"));

        const rapidjson::Value &tmpValue = rsp["Category"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
...
string DescribeIpsRuleListNewResponse::ToJsonString() const
{
...
uint64_t DescribeIpsRuleListNewResponse::GetTotal() const
{
    return m_total;
}

bool DescribeIpsRuleListNewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<IpsRuleDetailNew> DescribeIpsRuleListNewResponse::GetData() const
{
    return m_data;
}

bool DescribeIpsRuleListNewResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIpsRuleListNewResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeIpsRuleListNewResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeIpsRuleListNewResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DescribeIpsRuleListNewResponse::ReturnMsgHasBeenSet() const
{
    return m_returnMsgHasBeenSet;
}

vector<string> DescribeIpsRuleListNewResponse::GetCategory() const
{
    return m_category;
}

bool DescribeIpsRuleListNewResponse::CategoryHasBeenSet() const
{
