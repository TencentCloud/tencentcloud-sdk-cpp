...
CoreInternalOutcome DescribeOfflineExportTemporaryCredentialsResponse::Deserialize(const string &payload)
{
...
string DescribeOfflineExportTemporaryCredentialsResponse::ToJsonString() const
{
...
int64_t DescribeOfflineExportTemporaryCredentialsResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeOfflineExportTemporaryCredentialsResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeOfflineExportTemporaryCredentialsResponse::GetReturnMsg() const
{
    return m_returnMsg;
}
