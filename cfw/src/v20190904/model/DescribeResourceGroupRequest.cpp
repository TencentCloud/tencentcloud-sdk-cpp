...
string DescribeResourceGroupRequest::ToJsonString() const
{
...
string DescribeResourceGroupRequest::GetQueryType() const
{
    return m_queryType;
}

void DescribeResourceGroupRequest::SetQueryType(const string& _queryType)
{
    m_queryType = _queryType;
    m_queryTypeHasBeenSet = true;
}

bool DescribeResourceGroupRequest::QueryTypeHasBeenSet() const
{
    return m_queryTypeHasBeenSet;
}

string DescribeResourceGroupRequest::GetGroupId() const
{
    return m_groupId;
}

void DescribeResourceGroupRequest::SetGroupId(const string& _groupId)
{
    m_groupId = _groupId;
