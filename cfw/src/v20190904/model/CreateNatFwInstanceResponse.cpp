...
CoreInternalOutcome CreateNatFwInstanceResponse::Deserialize(const string &payload)
{
...
string CreateNatFwInstanceResponse::ToJsonString() const
{
...
string CreateNatFwInstanceResponse::GetCfwInsId() const
{
    return m_cfwInsId;
}

bool CreateNatFwInstanceResponse::CfwInsIdHasBeenSet() const
{
