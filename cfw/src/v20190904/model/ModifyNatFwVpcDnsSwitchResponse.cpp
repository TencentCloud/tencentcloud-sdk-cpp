...
CoreInternalOutcome ModifyNatFwVpcDnsSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyNatFwVpcDnsSwitchResponse::ToJsonString() const
{
...
string ModifyNatFwVpcDnsSwitchResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyNatFwVpcDnsSwitchResponse::ReturnMsgHasBeenSet() const
{
