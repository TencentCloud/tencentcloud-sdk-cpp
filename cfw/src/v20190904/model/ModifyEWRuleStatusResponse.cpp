...
ModifyEWRuleStatusResponse::ModifyEWRuleStatusResponse() :
    m_returnCodeHasBeenSet(false),
    m_returnMsgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyEWRuleStatusResponse::Deserialize(const string &payload)
{
...
string ModifyEWRuleStatusResponse::ToJsonString() const
{
...
int64_t ModifyEWRuleStatusResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool ModifyEWRuleStatusResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string ModifyEWRuleStatusResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool ModifyEWRuleStatusResponse::ReturnMsgHasBeenSet() const
{
