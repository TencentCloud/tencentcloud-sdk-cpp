...
string CreateBlockIgnoreRuleListRequest::ToJsonString() const
{
...
vector<IntrusionDefenseRule> CreateBlockIgnoreRuleListRequest::GetRules() const
{
    return m_rules;
}

void CreateBlockIgnoreRuleListRequest::SetRules(const vector<IntrusionDefenseRule>& _rules)
{
    m_rules = _rules;
    m_rulesHasBeenSet = true;
}

bool CreateBlockIgnoreRuleListRequest::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

int64_t CreateBlockIgnoreRuleListRequest::GetRuleType() const
{
    return m_ruleType;
}

void CreateBlockIgnoreRuleListRequest::SetRuleType(const int64_t& _ruleType)
{
