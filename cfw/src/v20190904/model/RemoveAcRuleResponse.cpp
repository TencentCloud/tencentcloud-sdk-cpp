...
CoreInternalOutcome RemoveAcRuleResponse::Deserialize(const string &payload)
{
...
string RemoveAcRuleResponse::ToJsonString() const
{
...
int64_t RemoveAcRuleResponse::GetRuleUuid() const
{
    return m_ruleUuid;
}

bool RemoveAcRuleResponse::RuleUuidHasBeenSet() const
{
    return m_ruleUuidHasBeenSet;
}

int64_t RemoveAcRuleResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool RemoveAcRuleResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string RemoveAcRuleResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool RemoveAcRuleResponse::ReturnMsgHasBeenSet() const
{
