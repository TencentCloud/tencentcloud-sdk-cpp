...
DescribeCfwAssetsResponse::DescribeCfwAssetsResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCfwAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeCfwAssetsResponse::ToJsonString() const
{
...
string DescribeCfwAssetsResponse::GetData() const
{
    return m_data;
}

bool DescribeCfwAssetsResponse::DataHasBeenSet() const
{
