...
RemoveOfflineExportTaskResponse::RemoveOfflineExportTaskResponse() :
    m_returnCodeHasBeenSet(false),
    m_returnMsgHasBeenSet(false)
{
}

CoreInternalOutcome RemoveOfflineExportTaskResponse::Deserialize(const string &payload)
{
...
string RemoveOfflineExportTaskResponse::ToJsonString() const
{
...
int64_t RemoveOfflineExportTaskResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool RemoveOfflineExportTaskResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string RemoveOfflineExportTaskResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool RemoveOfflineExportTaskResponse::ReturnMsgHasBeenSet() const
{
