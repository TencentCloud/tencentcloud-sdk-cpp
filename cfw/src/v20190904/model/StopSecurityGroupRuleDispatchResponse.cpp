...
CoreInternalOutcome StopSecurityGroupRuleDispatchResponse::Deserialize(const string &payload)
{
...
string StopSecurityGroupRuleDispatchResponse::ToJsonString() const
{
...
bool StopSecurityGroupRuleDispatchResponse::GetStatus() const
{
    return m_status;
}

bool StopSecurityGroupRuleDispatchResponse::StatusHasBeenSet() const
{
