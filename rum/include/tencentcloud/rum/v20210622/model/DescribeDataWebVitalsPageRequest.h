...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataWebVitalsPageRequest : public AbstractModel
                {
                public:
                    DescribeDataWebVitalsPageRequest();
                    ~DescribeDataWebVitalsPageRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEREQUEST_H_
