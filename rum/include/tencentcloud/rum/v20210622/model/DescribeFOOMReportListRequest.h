...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMREPORTLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMREPORTLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeFOOMReportListRequest : public AbstractModel
                {
                public:
                    DescribeFOOMReportListRequest();
                    ~DescribeFOOMReportListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMREPORTLISTREQUEST_H_
