...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataWebVitalsPageV2Request : public AbstractModel
                {
                public:
                    DescribeDataWebVitalsPageV2Request();
                    ~DescribeDataWebVitalsPageV2Request() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAWEBVITALSPAGEV2REQUEST_H_
