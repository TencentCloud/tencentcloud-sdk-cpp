...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMPROBLEMLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMPROBLEMLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeFOOMProblemListRequest : public AbstractModel
                {
                public:
                    DescribeFOOMProblemListRequest();
                    ~DescribeFOOMProblemListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMPROBLEMLISTREQUEST_H_
