...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPSINGLECASEDETAILLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPSINGLECASEDETAILLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeAppSingleCaseDetailListRequest : public AbstractModel
                {
                public:
                    DescribeAppSingleCaseDetailListRequest();
                    ~DescribeAppSingleCaseDetailListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPSINGLECASEDETAILLISTREQUEST_H_
