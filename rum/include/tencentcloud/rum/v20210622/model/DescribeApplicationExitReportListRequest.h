...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPLICATIONEXITREPORTLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPLICATIONEXITREPORTLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeApplicationExitReportListRequest : public AbstractModel
                {
                public:
                    DescribeApplicationExitReportListRequest();
                    ~DescribeApplicationExitReportListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPLICATIONEXITREPORTLISTREQUEST_H_
