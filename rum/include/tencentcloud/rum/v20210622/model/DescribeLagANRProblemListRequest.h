...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeLagANRProblemListRequest : public AbstractModel
                {
                public:
                    DescribeLagANRProblemListRequest();
                    ~DescribeLagANRProblemListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMLISTREQUEST_H_
