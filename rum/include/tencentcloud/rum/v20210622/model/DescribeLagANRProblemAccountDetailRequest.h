...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMACCOUNTDETAILREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMACCOUNTDETAILREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeLagANRProblemAccountDetailRequest : public AbstractModel
                {
                public:
                    DescribeLagANRProblemAccountDetailRequest();
                    ~DescribeLagANRProblemAccountDetailRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBELAGANRPROBLEMACCOUNTDETAILREQUEST_H_
