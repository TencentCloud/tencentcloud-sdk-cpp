...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPMETRICSDATAREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPMETRICSDATAREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeAppMetricsDataRequest : public AbstractModel
                {
                public:
                    DescribeAppMetricsDataRequest();
                    ~DescribeAppMetricsDataRequest() = default;
                    ...
                    /**
                     * 获取group by 参数
                     * @return GroupByModifier group by 参数
                     * 
                     */
                    std::string GetGroupByModifier() const;
                     ...
                     * 
                     */
                    void SetGroupByModifier(const std::string& _groupByModifier);

                    /**
                     * 判断参数 GroupByModifier 是否已赋值
                     * @return GroupByModifier 是否已赋值
                     * 
                     */
                    bool GroupByModifierHasBeenSet() const;
                ...
                private:
                     ...
                     * group by 参数
                     */
                    std::string m_groupByModifier;
                    bool m_groupByModifierHasBeenSet;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPMETRICSDATAREQUEST_H_
