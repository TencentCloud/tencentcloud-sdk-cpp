...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMMALLOCREPORTLISTREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMMALLOCREPORTLISTREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeFOOMMallocReportListRequest : public AbstractModel
                {
                public:
                    DescribeFOOMMallocReportListRequest();
                    ~DescribeFOOMMallocReportListRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEFOOMMALLOCREPORTLISTREQUEST_H_
