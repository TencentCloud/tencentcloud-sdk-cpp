...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPDIMENSIONMETRICSREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPDIMENSIONMETRICSREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeAppDimensionMetricsRequest : public AbstractModel
                {
                public:
                    DescribeAppDimensionMetricsRequest();
                    ~DescribeAppDimensionMetricsRequest() = default;
                     ...
                     * 
                     */
                    std::string GetBusinessContext() const;
                     ...
                     * 
                     */
                    void SetBusinessContext(const std::string& _businessContext);

                    /**
                     * 判断参数 BusinessContext 是否已赋值
                     * @return BusinessContext 是否已赋值
                     * 
                     */
                    bool BusinessContextHasBeenSet() const;
                ...
                private:
                     ...
                     * 业务上下文参数
                     */
                    std::string m_businessContext;
                    bool m_businessContextHasBeenSet;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEAPPDIMENSIONMETRICSREQUEST_H_
