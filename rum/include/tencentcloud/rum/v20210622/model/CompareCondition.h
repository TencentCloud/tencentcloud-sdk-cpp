...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_COMPARECONDITION_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_COMPARECONDITION_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                * BugLY比较结构体
                */
                class CompareCondition : public AbstractModel
                {
                public:
                    CompareCondition();
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_COMPARECONDITION_H_
