...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICURLREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICURLREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataStaticUrlRequest : public AbstractModel
                {
                public:
                    DescribeDataStaticUrlRequest();
                    ~DescribeDataStaticUrlRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICURLREQUEST_H_
