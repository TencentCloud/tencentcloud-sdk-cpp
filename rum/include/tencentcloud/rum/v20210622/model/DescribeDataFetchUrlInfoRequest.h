...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLINFOREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLINFOREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataFetchUrlInfoRequest : public AbstractModel
                {
                public:
                    DescribeDataFetchUrlInfoRequest();
                    ~DescribeDataFetchUrlInfoRequest() = default;
                    ...
                    /**
                     * 获取Type	是	String	无枚举值。此接口不使用 Type 做分支判断，SQL 固定 group by "url"，Type 字段传任何值不影响查询。
                    ...
                    /**
                     * 设置Type	是	String	无枚举值。此接口不使用 Type 做分支判断，SQL 固定 group by "url"，Type 字段传任何值不影响查询。
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLINFOREQUEST_H_
