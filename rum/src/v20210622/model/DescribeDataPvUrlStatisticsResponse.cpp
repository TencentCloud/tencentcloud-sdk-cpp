...
CoreInternalOutcome DescribeDataPvUrlStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeDataPvUrlStatisticsResponse::ToJsonString() const
{
...
string DescribeDataPvUrlStatisticsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataPvUrlStatisticsResponse::ResultHasBeenSet() const
{
