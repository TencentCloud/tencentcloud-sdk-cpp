...
CoreInternalOutcome DescribeDataStaticUrlV2Response::Deserialize(const string &payload)
{
...
string DescribeDataStaticUrlV2Response::ToJsonString() const
{
...
string DescribeDataStaticUrlV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticUrlV2Response::ResultHasBeenSet() const
{
