...
CoreInternalOutcome DescribeDataFetchProjectResponse::Deserialize(const string &payload)
{
...
string DescribeDataFetchProjectResponse::ToJsonString() const
{
...
string DescribeDataFetchProjectResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataFetchProjectResponse::ResultHasBeenSet() const
{
