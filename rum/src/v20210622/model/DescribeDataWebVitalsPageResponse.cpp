...
CoreInternalOutcome DescribeDataWebVitalsPageResponse::Deserialize(const string &payload)
{
...
string DescribeDataWebVitalsPageResponse::ToJsonString() const
{
...
string DescribeDataWebVitalsPageResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataWebVitalsPageResponse::ResultHasBeenSet() const
{
