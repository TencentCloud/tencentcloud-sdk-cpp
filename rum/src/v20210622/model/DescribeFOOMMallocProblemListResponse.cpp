...
DescribeFOOMMallocProblemListResponse::DescribeFOOMMallocProblemListResponse() :
...
CoreInternalOutcome DescribeFOOMMallocProblemListResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMMallocProblemListResponse::ToJsonString() const
{
...
string DescribeFOOMMallocProblemListResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMMallocProblemListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeFOOMMallocProblemListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMMallocProblemListResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeFOOMMallocProblemListResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMMallocProblemListResponse::CodeHasBeenSet() const
{
