...
CoreInternalOutcome DescribeDataLogUrlInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDataLogUrlInfoResponse::ToJsonString() const
{
...
string DescribeDataLogUrlInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataLogUrlInfoResponse::ResultHasBeenSet() const
{
