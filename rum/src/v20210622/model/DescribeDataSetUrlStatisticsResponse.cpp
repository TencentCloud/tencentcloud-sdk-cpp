...
CoreInternalOutcome DescribeDataSetUrlStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeDataSetUrlStatisticsResponse::ToJsonString() const
{
...
string DescribeDataSetUrlStatisticsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataSetUrlStatisticsResponse::ResultHasBeenSet() const
{
