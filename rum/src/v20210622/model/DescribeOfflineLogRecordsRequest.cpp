...
string DescribeOfflineLogRecordsRequest::ToJsonString() const
{
...
string DescribeOfflineLogRecordsRequest::GetProjectKey() const
{
    return m_projectKey;
}

void DescribeOfflineLogRecordsRequest::SetProjectKey(const string& _projectKey)
{
    m_projectKey = _projectKey;
    m_projectKeyHasBeenSet = true;
}

bool DescribeOfflineLogRecordsRequest::ProjectKeyHasBeenSet() const
{
