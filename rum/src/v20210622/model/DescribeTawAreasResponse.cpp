...
CoreInternalOutcome DescribeTawAreasResponse::Deserialize(const string &payload)
{
...
string DescribeTawAreasResponse::ToJsonString() const
{
...
int64_t DescribeTawAreasResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTawAreasResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RumAreaInfo> DescribeTawAreasResponse::GetAreaSet() const
{
    return m_areaSet;
}

bool DescribeTawAreasResponse::AreaSetHasBeenSet() const
{
