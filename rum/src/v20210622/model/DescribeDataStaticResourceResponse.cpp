...
CoreInternalOutcome DescribeDataStaticResourceResponse::Deserialize(const string &payload)
{
...
string DescribeDataStaticResourceResponse::ToJsonString() const
{
...
string DescribeDataStaticResourceResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticResourceResponse::ResultHasBeenSet() const
{
