...
CoreInternalOutcome CreateStarProjectResponse::Deserialize(const string &payload)
{
...
string CreateStarProjectResponse::ToJsonString() const
{
...
string CreateStarProjectResponse::GetMsg() const
{
    return m_msg;
}

bool CreateStarProjectResponse::MsgHasBeenSet() const
{
