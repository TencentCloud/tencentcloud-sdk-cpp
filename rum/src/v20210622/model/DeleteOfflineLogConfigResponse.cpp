...
CoreInternalOutcome DeleteOfflineLogConfigResponse::Deserialize(const string &payload)
{
...
string DeleteOfflineLogConfigResponse::ToJsonString() const
{
...
string DeleteOfflineLogConfigResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteOfflineLogConfigResponse::MsgHasBeenSet() const
{
