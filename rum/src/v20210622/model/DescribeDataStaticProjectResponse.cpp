...
CoreInternalOutcome DescribeDataStaticProjectResponse::Deserialize(const string &payload)
{
...
string DescribeDataStaticProjectResponse::ToJsonString() const
{
...
string DescribeDataStaticProjectResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticProjectResponse::ResultHasBeenSet() const
{
