...
DescribeFOOMProblemListResponse::DescribeFOOMProblemListResponse() :
...
CoreInternalOutcome DescribeFOOMProblemListResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMProblemListResponse::ToJsonString() const
{
...
string DescribeFOOMProblemListResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMProblemListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeFOOMProblemListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMProblemListResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeFOOMProblemListResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMProblemListResponse::CodeHasBeenSet() const
{
