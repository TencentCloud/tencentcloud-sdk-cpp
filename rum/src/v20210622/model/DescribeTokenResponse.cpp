...
string DescribeTokenResponse::GetData() const
{
    return m_data;
}

bool DescribeTokenResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeTokenResponse::GetCode() const
{
    return m_code;
}

bool DescribeTokenResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeTokenResponse::GetMessage() const
{
    return m_message;
}

bool DescribeTokenResponse::MessageHasBeenSet() const
{
