...
CoreInternalOutcome DescribeErrorResponse::Deserialize(const string &payload)
{
...
string DescribeErrorResponse::ToJsonString() const
{
...
string DescribeErrorResponse::GetContent() const
{
    return m_content;
}

bool DescribeErrorResponse::ContentHasBeenSet() const
{
    return m_contentHasBeenSet;
}

int64_t DescribeErrorResponse::GetID() const
{
    return m_iD;
}

bool DescribeErrorResponse::IDHasBeenSet() const
{
    return m_iDHasBeenSet;
}

string DescribeErrorResponse::GetCreateTime() const
{
    return m_createTime;
}

bool DescribeErrorResponse::CreateTimeHasBeenSet() const
{
