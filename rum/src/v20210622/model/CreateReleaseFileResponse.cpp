...
CoreInternalOutcome CreateReleaseFileResponse::Deserialize(const string &payload)
{
...
string CreateReleaseFileResponse::ToJsonString() const
{
...
string CreateReleaseFileResponse::GetMsg() const
{
    return m_msg;
}

bool CreateReleaseFileResponse::MsgHasBeenSet() const
{
