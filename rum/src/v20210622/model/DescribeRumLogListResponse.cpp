...
CoreInternalOutcome DescribeRumLogListResponse::Deserialize(const string &payload)
{
...
string DescribeRumLogListResponse::ToJsonString() const
{
...
string DescribeRumLogListResponse::GetResult() const
{
    return m_result;
}

bool DescribeRumLogListResponse::ResultHasBeenSet() const
{
