...
CoreInternalOutcome DescribeDataPvUrlStatisticsV2Response::Deserialize(const string &payload)
{
...
string DescribeDataPvUrlStatisticsV2Response::ToJsonString() const
{
...
string DescribeDataPvUrlStatisticsV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataPvUrlStatisticsV2Response::ResultHasBeenSet() const
{
