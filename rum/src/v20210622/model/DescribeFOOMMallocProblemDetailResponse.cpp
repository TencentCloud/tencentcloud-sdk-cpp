...
DescribeFOOMMallocProblemDetailResponse::DescribeFOOMMallocProblemDetailResponse() :
...
CoreInternalOutcome DescribeFOOMMallocProblemDetailResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMMallocProblemDetailResponse::ToJsonString() const
{
...
string DescribeFOOMMallocProblemDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMMallocProblemDetailResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeFOOMMallocProblemDetailResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMMallocProblemDetailResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeFOOMMallocProblemDetailResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMMallocProblemDetailResponse::MessageHasBeenSet() const
{
