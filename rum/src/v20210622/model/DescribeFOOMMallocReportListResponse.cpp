...
DescribeFOOMMallocReportListResponse::DescribeFOOMMallocReportListResponse() :
...
CoreInternalOutcome DescribeFOOMMallocReportListResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMMallocReportListResponse::ToJsonString() const
{
...
string DescribeFOOMMallocReportListResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMMallocReportListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeFOOMMallocReportListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMMallocReportListResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeFOOMMallocReportListResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMMallocReportListResponse::CodeHasBeenSet() const
{
