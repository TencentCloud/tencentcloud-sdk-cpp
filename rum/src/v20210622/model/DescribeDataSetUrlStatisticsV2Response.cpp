...
CoreInternalOutcome DescribeDataSetUrlStatisticsV2Response::Deserialize(const string &payload)
{
...
string DescribeDataSetUrlStatisticsV2Response::ToJsonString() const
{
...
string DescribeDataSetUrlStatisticsV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataSetUrlStatisticsV2Response::ResultHasBeenSet() const
{
