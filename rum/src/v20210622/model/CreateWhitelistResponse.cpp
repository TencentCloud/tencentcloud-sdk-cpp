...
CoreInternalOutcome CreateWhitelistResponse::Deserialize(const string &payload)
{
...
string CreateWhitelistResponse::ToJsonString() const
{
...
string CreateWhitelistResponse::GetMsg() const
{
    return m_msg;
}
