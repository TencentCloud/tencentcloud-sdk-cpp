...
DescribeIssuesDistributionResponse::DescribeIssuesDistributionResponse() :
...
CoreInternalOutcome DescribeIssuesDistributionResponse::Deserialize(const string &payload)
{
...
string DescribeIssuesDistributionResponse::ToJsonString() const
{
...
string DescribeIssuesDistributionResponse::GetData() const
{
    return m_data;
}

bool DescribeIssuesDistributionResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIssuesDistributionResponse::GetCode() const
{
    return m_code;
}

bool DescribeIssuesDistributionResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeIssuesDistributionResponse::GetMessage() const
{
    return m_message;
}

bool DescribeIssuesDistributionResponse::MessageHasBeenSet() const
{
