...
CoreInternalOutcome DeleteLogExportResponse::Deserialize(const string &payload)
{
...
string DeleteLogExportResponse::ToJsonString() const
{
...
string DeleteLogExportResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteLogExportResponse::MsgHasBeenSet() const
{
