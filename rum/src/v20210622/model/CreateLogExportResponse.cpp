...
CoreInternalOutcome CreateLogExportResponse::Deserialize(const string &payload)
{
...
string CreateLogExportResponse::ToJsonString() const
{
...
string CreateLogExportResponse::GetExportID() const
{
    return m_exportID;
}

bool CreateLogExportResponse::ExportIDHasBeenSet() const
{
