...
CoreInternalOutcome DescribeOfflineLogsResponse::Deserialize(const string &payload)
{
...
string DescribeOfflineLogsResponse::ToJsonString() const
{
...
string DescribeOfflineLogsResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeOfflineLogsResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

vector<string> DescribeOfflineLogsResponse::GetLogSet() const
{
    return m_logSet;
}

bool DescribeOfflineLogsResponse::LogSetHasBeenSet() const
{
