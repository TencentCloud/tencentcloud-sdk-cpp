...
CoreInternalOutcome DescribeDataReportCountV2Response::Deserialize(const string &payload)
{
...
string DescribeDataReportCountV2Response::ToJsonString() const
{
...
string DescribeDataReportCountV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataReportCountV2Response::ResultHasBeenSet() const
{
