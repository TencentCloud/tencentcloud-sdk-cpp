...
DescribeApplicationExitReportDetailResponse::DescribeApplicationExitReportDetailResponse() :
...
CoreInternalOutcome DescribeApplicationExitReportDetailResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationExitReportDetailResponse::ToJsonString() const
{
...
string DescribeApplicationExitReportDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationExitReportDetailResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeApplicationExitReportDetailResponse::GetCode() const
{
    return m_code;
}

bool DescribeApplicationExitReportDetailResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeApplicationExitReportDetailResponse::GetMessage() const
{
    return m_message;
}

bool DescribeApplicationExitReportDetailResponse::MessageHasBeenSet() const
{
