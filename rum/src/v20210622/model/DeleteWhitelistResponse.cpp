...
CoreInternalOutcome DeleteWhitelistResponse::Deserialize(const string &payload)
{
...
string DeleteWhitelistResponse::ToJsonString() const
{
...
string DeleteWhitelistResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteWhitelistResponse::MsgHasBeenSet() const
{
