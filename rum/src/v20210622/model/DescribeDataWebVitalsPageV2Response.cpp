...
CoreInternalOutcome DescribeDataWebVitalsPageV2Response::Deserialize(const string &payload)
{
...
string DescribeDataWebVitalsPageV2Response::ToJsonString() const
{
...
string DescribeDataWebVitalsPageV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataWebVitalsPageV2Response::ResultHasBeenSet() const
{
