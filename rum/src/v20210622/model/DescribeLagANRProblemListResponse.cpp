...
DescribeLagANRProblemListResponse::DescribeLagANRProblemListResponse() :
...
CoreInternalOutcome DescribeLagANRProblemListResponse::Deserialize(const string &payload)
{
...
string DescribeLagANRProblemListResponse::ToJsonString() const
{
...
string DescribeLagANRProblemListResponse::GetData() const
{
    return m_data;
}

bool DescribeLagANRProblemListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeLagANRProblemListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeLagANRProblemListResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeLagANRProblemListResponse::GetCode() const
{
    return m_code;
}

bool DescribeLagANRProblemListResponse::CodeHasBeenSet() const
{
