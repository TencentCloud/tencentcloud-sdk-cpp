...
CoreInternalOutcome DescribeDataLogUrlStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeDataLogUrlStatisticsResponse::ToJsonString() const
{
...
string DescribeDataLogUrlStatisticsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataLogUrlStatisticsResponse::ResultHasBeenSet() const
{
