...
CoreInternalOutcome DescribeDataCustomUrlResponse::Deserialize(const string &payload)
{
...
string DescribeDataCustomUrlResponse::ToJsonString() const
{
...
string DescribeDataCustomUrlResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataCustomUrlResponse::ResultHasBeenSet() const
{
