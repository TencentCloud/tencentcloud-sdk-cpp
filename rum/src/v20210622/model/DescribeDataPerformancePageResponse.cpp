...
CoreInternalOutcome DescribeDataPerformancePageResponse::Deserialize(const string &payload)
{
...
string DescribeDataPerformancePageResponse::ToJsonString() const
{
...
string DescribeDataPerformancePageResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataPerformancePageResponse::ResultHasBeenSet() const
{
