...
CoreInternalOutcome DescribeReleaseFilesResponse::Deserialize(const string &payload)
{
...
string DescribeReleaseFilesResponse::ToJsonString() const
{
...
vector<ReleaseFile> DescribeReleaseFilesResponse::GetFiles() const
{
    return m_files;
}

bool DescribeReleaseFilesResponse::FilesHasBeenSet() const
{
