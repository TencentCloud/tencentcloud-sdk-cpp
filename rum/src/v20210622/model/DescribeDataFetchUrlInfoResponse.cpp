...
CoreInternalOutcome DescribeDataFetchUrlInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDataFetchUrlInfoResponse::ToJsonString() const
{
...
string DescribeDataFetchUrlInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataFetchUrlInfoResponse::ResultHasBeenSet() const
{
