...
DescribeTopIssuesResponse::DescribeTopIssuesResponse() :
...
CoreInternalOutcome DescribeTopIssuesResponse::Deserialize(const string &payload)
{
...
string DescribeTopIssuesResponse::ToJsonString() const
{
...
string DescribeTopIssuesResponse::GetData() const
{
    return m_data;
}

bool DescribeTopIssuesResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeTopIssuesResponse::GetCode() const
{
    return m_code;
}

bool DescribeTopIssuesResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeTopIssuesResponse::GetMessage() const
{
    return m_message;
}

bool DescribeTopIssuesResponse::MessageHasBeenSet() const
{
