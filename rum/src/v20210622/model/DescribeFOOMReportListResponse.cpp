...
DescribeFOOMReportListResponse::DescribeFOOMReportListResponse() :
...
CoreInternalOutcome DescribeFOOMReportListResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMReportListResponse::ToJsonString() const
{
...
string DescribeFOOMReportListResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMReportListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeFOOMReportListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMReportListResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

int64_t DescribeFOOMReportListResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMReportListResponse::CodeHasBeenSet() const
{
