...
DescribeApplicationExitReportListResponse::DescribeApplicationExitReportListResponse() :
...
CoreInternalOutcome DescribeApplicationExitReportListResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationExitReportListResponse::ToJsonString() const
{
...
string DescribeApplicationExitReportListResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationExitReportListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeApplicationExitReportListResponse::GetCode() const
{
    return m_code;
}

bool DescribeApplicationExitReportListResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeApplicationExitReportListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeApplicationExitReportListResponse::MessageHasBeenSet() const
{
