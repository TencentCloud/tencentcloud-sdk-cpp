...
string ModifyInstanceRequest::GetInstanceDesc() const
{
    return m_instanceDesc;
}

void ModifyInstanceRequest::SetInstanceDesc(const string& _instanceDesc)
{
    m_instanceDesc = _instanceDesc;
    m_instanceDescHasBeenSet = true;
}

bool ModifyInstanceRequest::InstanceDescHasBeenSet() const
{
