...
CoreInternalOutcome DescribeDataLogUrlStatisticsV2Response::Deserialize(const string &payload)
{
...
string DescribeDataLogUrlStatisticsV2Response::ToJsonString() const
{
...
string DescribeDataLogUrlStatisticsV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataLogUrlStatisticsV2Response::ResultHasBeenSet() const
{
