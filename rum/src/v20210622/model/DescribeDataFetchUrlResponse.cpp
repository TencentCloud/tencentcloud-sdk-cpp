...
CoreInternalOutcome DescribeDataFetchUrlResponse::Deserialize(const string &payload)
{
...
string DescribeDataFetchUrlResponse::ToJsonString() const
{
...
string DescribeDataFetchUrlResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataFetchUrlResponse::ResultHasBeenSet() const
{
