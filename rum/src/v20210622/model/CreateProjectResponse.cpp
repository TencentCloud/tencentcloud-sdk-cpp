...
uint64_t CreateProjectResponse::GetID() const
{
    return m_iD;
}

bool CreateProjectResponse::IDHasBeenSet() const
{
    return m_iDHasBeenSet;
}

string CreateProjectResponse::GetKey() const
{
    return m_key;
}

bool CreateProjectResponse::KeyHasBeenSet() const
{
