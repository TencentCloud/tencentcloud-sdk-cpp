...
CoreInternalOutcome DeleteStarProjectResponse::Deserialize(const string &payload)
{
...
string DeleteStarProjectResponse::ToJsonString() const
{
...
string DeleteStarProjectResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteStarProjectResponse::MsgHasBeenSet() const
{
