...
CoreInternalOutcome ModifyProjectLimitResponse::Deserialize(const string &payload)
{
...
string ModifyProjectLimitResponse::ToJsonString() const
{
...
string ModifyProjectLimitResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyProjectLimitResponse::MsgHasBeenSet() const
{
