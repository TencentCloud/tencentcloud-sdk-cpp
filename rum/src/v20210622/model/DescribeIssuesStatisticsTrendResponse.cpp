...
DescribeIssuesStatisticsTrendResponse::DescribeIssuesStatisticsTrendResponse() :
...
CoreInternalOutcome DescribeIssuesStatisticsTrendResponse::Deserialize(const string &payload)
{
...
string DescribeIssuesStatisticsTrendResponse::ToJsonString() const
{
...
string DescribeIssuesStatisticsTrendResponse::GetData() const
{
    return m_data;
}

bool DescribeIssuesStatisticsTrendResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIssuesStatisticsTrendResponse::GetCode() const
{
    return m_code;
}

bool DescribeIssuesStatisticsTrendResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeIssuesStatisticsTrendResponse::GetMessage() const
{
    return m_message;
}

bool DescribeIssuesStatisticsTrendResponse::MessageHasBeenSet() const
{
