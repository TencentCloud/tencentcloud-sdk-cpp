...
CoreInternalOutcome DeleteReleaseFileResponse::Deserialize(const string &payload)
{
...
string DeleteReleaseFileResponse::ToJsonString() const
{
...
string DeleteReleaseFileResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteReleaseFileResponse::MsgHasBeenSet() const
{
