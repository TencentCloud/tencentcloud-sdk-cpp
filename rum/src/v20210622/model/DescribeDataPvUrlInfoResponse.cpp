...
CoreInternalOutcome DescribeDataPvUrlInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDataPvUrlInfoResponse::ToJsonString() const
{
...
string DescribeDataPvUrlInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataPvUrlInfoResponse::ResultHasBeenSet() const
{
