...
CoreInternalOutcome DescribeRumStatsLogListResponse::Deserialize(const string &payload)
{
...
string DescribeRumStatsLogListResponse::ToJsonString() const
{
...
string DescribeRumStatsLogListResponse::GetResult() const
{
    return m_result;
}

bool DescribeRumStatsLogListResponse::ResultHasBeenSet() const
{
