...
CoreInternalOutcome DescribeDataCustomUrlV2Response::Deserialize(const string &payload)
{
...
string DescribeDataCustomUrlV2Response::ToJsonString() const
{
...
string DescribeDataCustomUrlV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataCustomUrlV2Response::ResultHasBeenSet() const
{
