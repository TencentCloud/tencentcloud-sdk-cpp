...
CoreInternalOutcome DescribeDataStaticResourceV2Response::Deserialize(const string &payload)
{
...
string DescribeDataStaticResourceV2Response::ToJsonString() const
{
...
string DescribeDataStaticResourceV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticResourceV2Response::ResultHasBeenSet() const
{
