...
CoreInternalOutcome DescribeDataStaticUrlResponse::Deserialize(const string &payload)
{
...
string DescribeDataStaticUrlResponse::ToJsonString() const
{
...
string DescribeDataStaticUrlResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticUrlResponse::ResultHasBeenSet() const
{
