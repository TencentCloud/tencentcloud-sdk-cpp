...
CoreInternalOutcome DescribeDataEventUrlV2Response::Deserialize(const string &payload)
{
...
string DescribeDataEventUrlV2Response::ToJsonString() const
{
...
string DescribeDataEventUrlV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataEventUrlV2Response::ResultHasBeenSet() const
{
