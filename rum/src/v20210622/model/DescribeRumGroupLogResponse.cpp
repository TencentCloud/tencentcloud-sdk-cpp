...
CoreInternalOutcome DescribeRumGroupLogResponse::Deserialize(const string &payload)
{
...
string DescribeRumGroupLogResponse::ToJsonString() const
{
...
string DescribeRumGroupLogResponse::GetResult() const
{
    return m_result;
}

bool DescribeRumGroupLogResponse::ResultHasBeenSet() const
{
