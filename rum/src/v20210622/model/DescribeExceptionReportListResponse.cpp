...
DescribeExceptionReportListResponse::DescribeExceptionReportListResponse() :
...
CoreInternalOutcome DescribeExceptionReportListResponse::Deserialize(const string &payload)
{
...
string DescribeExceptionReportListResponse::ToJsonString() const
{
...
string DescribeExceptionReportListResponse::GetData() const
{
    return m_data;
}

bool DescribeExceptionReportListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeExceptionReportListResponse::GetCode() const
{
    return m_code;
}

bool DescribeExceptionReportListResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeExceptionReportListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeExceptionReportListResponse::MessageHasBeenSet() const
{
