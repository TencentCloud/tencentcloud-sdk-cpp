...
CoreInternalOutcome DescribeDataBridgeUrlV2Response::Deserialize(const string &payload)
{
...
string DescribeDataBridgeUrlV2Response::ToJsonString() const
{
...
string DescribeDataBridgeUrlV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataBridgeUrlV2Response::ResultHasBeenSet() const
{
