...
CoreInternalOutcome DescribeDataReportCountResponse::Deserialize(const string &payload)
{
...
string DescribeDataReportCountResponse::ToJsonString() const
{
...
string DescribeDataReportCountResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataReportCountResponse::ResultHasBeenSet() const
{
