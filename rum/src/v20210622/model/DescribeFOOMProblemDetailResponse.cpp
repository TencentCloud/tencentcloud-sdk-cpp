...
DescribeFOOMProblemDetailResponse::DescribeFOOMProblemDetailResponse() :
...
CoreInternalOutcome DescribeFOOMProblemDetailResponse::Deserialize(const string &payload)
{
...
string DescribeFOOMProblemDetailResponse::ToJsonString() const
{
...
string DescribeFOOMProblemDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeFOOMProblemDetailResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeFOOMProblemDetailResponse::GetCode() const
{
    return m_code;
}

bool DescribeFOOMProblemDetailResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeFOOMProblemDetailResponse::GetMessage() const
{
    return m_message;
}

bool DescribeFOOMProblemDetailResponse::MessageHasBeenSet() const
{
