...
CoreInternalOutcome DescribeDataEventUrlResponse::Deserialize(const string &payload)
{
...
string DescribeDataEventUrlResponse::ToJsonString() const
{
...
string DescribeDataEventUrlResponse::GetResult() const
{
    return m_result;
}

bool DescribeDataEventUrlResponse::ResultHasBeenSet() const
{
