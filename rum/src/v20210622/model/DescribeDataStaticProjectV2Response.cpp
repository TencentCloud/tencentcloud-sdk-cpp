...
CoreInternalOutcome DescribeDataStaticProjectV2Response::Deserialize(const string &payload)
{
...
string DescribeDataStaticProjectV2Response::ToJsonString() const
{
...
string DescribeDataStaticProjectV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataStaticProjectV2Response::ResultHasBeenSet() const
{
