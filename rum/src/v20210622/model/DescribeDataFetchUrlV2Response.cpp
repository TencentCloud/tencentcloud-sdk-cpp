...
CoreInternalOutcome DescribeDataFetchUrlV2Response::Deserialize(const string &payload)
{
...
string DescribeDataFetchUrlV2Response::ToJsonString() const
{
...
string DescribeDataFetchUrlV2Response::GetResult() const
{
    return m_result;
}

bool DescribeDataFetchUrlV2Response::ResultHasBeenSet() const
{
