...
CoreInternalOutcome DescribeRumLogExportResponse::Deserialize(const string &payload)
{
...
string DescribeRumLogExportResponse::ToJsonString() const
{
...
string DescribeRumLogExportResponse::GetResult() const
{
    return m_result;
}

bool DescribeRumLogExportResponse::ResultHasBeenSet() const
{
