...
DescribeExceptionDetailResponse::DescribeExceptionDetailResponse() :
...
CoreInternalOutcome DescribeExceptionDetailResponse::Deserialize(const string &payload)
{
...
string DescribeExceptionDetailResponse::ToJsonString() const
{
...
string DescribeExceptionDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeExceptionDetailResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeExceptionDetailResponse::GetCode() const
{
    return m_code;
}

bool DescribeExceptionDetailResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeExceptionDetailResponse::GetMessage() const
{
    return m_message;
}

bool DescribeExceptionDetailResponse::MessageHasBeenSet() const
{
