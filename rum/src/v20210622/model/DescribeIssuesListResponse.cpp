...
DescribeIssuesListResponse::DescribeIssuesListResponse() :
...
CoreInternalOutcome DescribeIssuesListResponse::Deserialize(const string &payload)
{
...
string DescribeIssuesListResponse::ToJsonString() const
{
...
string DescribeIssuesListResponse::GetData() const
{
    return m_data;
}

bool DescribeIssuesListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIssuesListResponse::GetCode() const
{
    return m_code;
}

bool DescribeIssuesListResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DescribeIssuesListResponse::GetMessage() const
{
    return m_message;
}

bool DescribeIssuesListResponse::MessageHasBeenSet() const
{
