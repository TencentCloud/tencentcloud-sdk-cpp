...
#ifndef TENCENTCLOUD_OCEANUS_V20190422_MODEL_DESCRIBEJOBEVENTSRESPONSE_H_
#define TENCENTCLOUD_OCEANUS_V20190422_MODEL_DESCRIBEJOBEVENTSRESPONSE_H_
    ...
    namespace Oceanus
    {
        namespace V20190422
        {
            namespace Model
            {
                ...
                */
                class DescribeJobEventsResponse : public AbstractModel
                {
                public:
                    DescribeJobEventsResponse();
                    ~DescribeJobEventsResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<JobEvent> GetEvents() const;
...
#endif // !TENCENTCLOUD_OCEANUS_V20190422_MODEL_DESCRIBEJOBEVENTSRESPONSE_H_
