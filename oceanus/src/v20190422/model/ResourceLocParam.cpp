...
CoreInternalOutcome ResourceLocParam::Deserialize(const Value &value)
{
    string requestId = "";
...
void ResourceLocParam::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
