...
CoreInternalOutcome StopJobDescription::Deserialize(const Value &value)
{
    string requestId = "";
...
void StopJobDescription::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
