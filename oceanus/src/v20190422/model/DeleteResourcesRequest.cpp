...
string DeleteResourcesRequest::ToJsonString() const
{
...
vector<string> DeleteResourcesRequest::GetResourceIds() const
{
    return m_resourceIds;
}

void DeleteResourcesRequest::SetResourceIds(const vector<string>& _resourceIds)
{
