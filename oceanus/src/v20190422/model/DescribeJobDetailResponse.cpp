...
DescribeJobDetailResponse::DescribeJobDetailResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeJobDetailResponse::Deserialize(const string &payload)
{
...
string DescribeJobDetailResponse::ToJsonString() const
{
...
string DescribeJobDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeJobDetailResponse::DataHasBeenSet() const
{
