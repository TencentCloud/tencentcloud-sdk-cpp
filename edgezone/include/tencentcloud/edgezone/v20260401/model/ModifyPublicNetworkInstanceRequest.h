...
#ifndef TENCENTCLOUD_EDGEZONE_V20260401_MODEL_MODIFYPUBLICNETWORKINSTANCEREQUEST_H_
#define TENCENTCLOUD_EDGEZONE_V20260401_MODEL_MODIFYPUBLICNETWORKINSTANCEREQUEST_H_
    ...
    namespace Edgezone
    {
        namespace V20260401
        {
            namespace Model
            {
                ...
                */
                class ModifyPublicNetworkInstanceRequest : public AbstractModel
                {
                public:
                    ModifyPublicNetworkInstanceRequest();
                    ~ModifyPublicNetworkInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_EDGEZONE_V20260401_MODEL_MODIFYPUBLICNETWORKINSTANCEREQUEST_H_
