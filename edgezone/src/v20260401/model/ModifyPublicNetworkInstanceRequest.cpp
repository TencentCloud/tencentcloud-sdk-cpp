...
string ModifyPublicNetworkInstanceRequest::ToJsonString() const
{
...
string ModifyPublicNetworkInstanceRequest::GetNetworkInstanceId() const
{
    return m_networkInstanceId;
}

void ModifyPublicNetworkInstanceRequest::SetNetworkInstanceId(const string& _networkInstanceId)
{
    m_networkInstanceId = _networkInstanceId;
    m_networkInstanceIdHasBeenSet = true;
}

bool ModifyPublicNetworkInstanceRequest::NetworkInstanceIdHasBeenSet() const
{
    return m_networkInstanceIdHasBeenSet;
}

string ModifyPublicNetworkInstanceRequest::GetNetworkInstanceName() const
{
    return m_networkInstanceName;
}

void ModifyPublicNetworkInstanceRequest::SetNetworkInstanceName(const string& _networkInstanceName)
{
    m_networkInstanceName = _networkInstanceName;
    m_networkInstanceNameHasBeenSet = true;
}

bool ModifyPublicNetworkInstanceRequest::NetworkInstanceNameHasBeenSet() const
{
