...
CoreInternalOutcome CreateInstancesResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["FailedCount"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `FailedCount` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_failedCount = rsp["FailedCount"].GetUint64();
...
vector<string> CreateInstancesResponse::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

bool CreateInstancesResponse::InstanceIdSetHasBeenSet() const
{
    return m_instanceIdSetHasBeenSet;
}

uint64_t CreateInstancesResponse::GetFailedCount() const
{
    return m_failedCount;
}

bool CreateInstancesResponse::FailedCountHasBeenSet() const
{
