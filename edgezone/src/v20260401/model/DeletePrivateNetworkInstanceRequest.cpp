...
string DeletePrivateNetworkInstanceRequest::ToJsonString() const
{
...
string DeletePrivateNetworkInstanceRequest::GetNetworkInstanceId() const
{
    return m_networkInstanceId;
}

void DeletePrivateNetworkInstanceRequest::SetNetworkInstanceId(const string& _networkInstanceId)
{
    m_networkInstanceId = _networkInstanceId;
    m_networkInstanceIdHasBeenSet = true;
}

bool DeletePrivateNetworkInstanceRequest::NetworkInstanceIdHasBeenSet() const
{
