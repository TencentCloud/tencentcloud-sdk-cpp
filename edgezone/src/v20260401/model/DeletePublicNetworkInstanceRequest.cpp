...
string DeletePublicNetworkInstanceRequest::ToJsonString() const
{
...
string DeletePublicNetworkInstanceRequest::GetNetworkInstanceId() const
{
    return m_networkInstanceId;
}

void DeletePublicNetworkInstanceRequest::SetNetworkInstanceId(const string& _networkInstanceId)
{
    m_networkInstanceId = _networkInstanceId;
    m_networkInstanceIdHasBeenSet = true;
}

bool DeletePublicNetworkInstanceRequest::NetworkInstanceIdHasBeenSet() const
{
