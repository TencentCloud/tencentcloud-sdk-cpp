...
CoreInternalOutcome ApplyPublicIpsResponse::Deserialize(const string &payload)
{
...
string ApplyPublicIpsResponse::ToJsonString() const
{
...
vector<string> ApplyPublicIpsResponse::GetIpList() const
{
    return m_ipList;
}

bool ApplyPublicIpsResponse::IpListHasBeenSet() const
{
