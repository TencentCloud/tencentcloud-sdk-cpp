...
string ScaleOutInstanceResponse::GetFlowId() const
{
    return m_flowId;
}
...
string ScaleOutInstanceResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ScaleOutInstanceResponse::ErrorMsgHasBeenSet() const
{
