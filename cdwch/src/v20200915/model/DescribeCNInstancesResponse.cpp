...
DescribeCNInstancesResponse::DescribeCNInstancesResponse() :
...
CoreInternalOutcome DescribeCNInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeCNInstancesResponse::ToJsonString() const
{
...
int64_t DescribeCNInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCNInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CnInstanceInfo> DescribeCNInstancesResponse::GetInstancesList() const
{
    return m_instancesList;
}

bool DescribeCNInstancesResponse::InstancesListHasBeenSet() const
{
    return m_instancesListHasBeenSet;
}

string DescribeCNInstancesResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool DescribeCNInstancesResponse::ErrorMsgHasBeenSet() const
{
