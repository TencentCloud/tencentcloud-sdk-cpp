...
ScaleCNOutUpInstanceResponse::ScaleCNOutUpInstanceResponse() :
...
CoreInternalOutcome ScaleCNOutUpInstanceResponse::Deserialize(const string &payload)
{
...
string ScaleCNOutUpInstanceResponse::ToJsonString() const
{
...
string ScaleCNOutUpInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool ScaleCNOutUpInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

string ScaleCNOutUpInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool ScaleCNOutUpInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ScaleCNOutUpInstanceResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ScaleCNOutUpInstanceResponse::ErrorMsgHasBeenSet() const
{
