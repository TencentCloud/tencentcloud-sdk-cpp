...
string DescribeInstanceNodesRequest::ToJsonString() const
{
    ...
    if (m_forceAllHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "ForceAll";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, m_forceAll, allocator);
    }
...
bool DescribeInstanceNodesRequest::GetForceAll() const
{
    return m_forceAll;
}

void DescribeInstanceNodesRequest::SetForceAll(const bool& _forceAll)
{
    m_forceAll = _forceAll;
    m_forceAllHasBeenSet = true;
}

bool DescribeInstanceNodesRequest::ForceAllHasBeenSet() const
{
    return m_forceAllHasBeenSet;
}
