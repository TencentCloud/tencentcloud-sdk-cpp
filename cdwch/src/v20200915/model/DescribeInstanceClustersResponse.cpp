...
DescribeInstanceClustersResponse::DescribeInstanceClustersResponse() :
    m_clustersHasBeenSet(false)
{
}

CoreInternalOutcome DescribeInstanceClustersResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceClustersResponse::ToJsonString() const
{
...
vector<ClusterInfo> DescribeInstanceClustersResponse::GetClusters() const
{
    return m_clusters;
}

bool DescribeInstanceClustersResponse::ClustersHasBeenSet() const
{
