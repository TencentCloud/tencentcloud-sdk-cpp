...
string ModifyInstanceKeyValConfigsRequest::GetRemark() const
{
    return m_remark;
}

void ModifyInstanceKeyValConfigsRequest::SetRemark(const string& _remark)
{
    m_remark = _remark;
    m_remarkHasBeenSet = true;
}

bool ModifyInstanceKeyValConfigsRequest::RemarkHasBeenSet() const
{
