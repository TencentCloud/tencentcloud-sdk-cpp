...
DescribeInstancesNewResponse::DescribeInstancesNewResponse() :
    m_totalCountHasBeenSet(false),
    m_instancesListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeInstancesNewResponse::Deserialize(const string &payload)
{
...
string DescribeInstancesNewResponse::ToJsonString() const
{
...
int64_t DescribeInstancesNewResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstancesNewResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstanceInfo> DescribeInstancesNewResponse::GetInstancesList() const
{
    return m_instancesList;
}

bool DescribeInstancesNewResponse::InstancesListHasBeenSet() const
{
