...
CoreInternalOutcome ActionAlterCkUserResponse::Deserialize(const string &payload)
{
...
string ActionAlterCkUserResponse::ToJsonString() const
{
...
string ActionAlterCkUserResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool ActionAlterCkUserResponse::ErrMsgHasBeenSet() const
{
