...
CoreInternalOutcome ResourceSpec::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("DisplayName") && !value["DisplayName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ResourceSpec.DisplayName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string ResourceSpec::GetDisplayName() const
{
    return m_displayName;
}

void ResourceSpec::SetDisplayName(const string& _displayName)
{
    m_displayName = _displayName;
    m_displayNameHasBeenSet = true;
}

bool ResourceSpec::DisplayNameHasBeenSet() const
{
