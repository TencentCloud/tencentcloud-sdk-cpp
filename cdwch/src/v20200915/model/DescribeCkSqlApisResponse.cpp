...
CoreInternalOutcome DescribeCkSqlApisResponse::Deserialize(const string &payload)
{
...
string DescribeCkSqlApisResponse::ToJsonString() const
{
...
string DescribeCkSqlApisResponse::GetReturnData() const
{
    return m_returnData;
}

bool DescribeCkSqlApisResponse::ReturnDataHasBeenSet() const
{
