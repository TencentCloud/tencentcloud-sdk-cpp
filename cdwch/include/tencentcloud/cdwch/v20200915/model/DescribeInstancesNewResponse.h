...
#ifndef TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCESNEWRESPONSE_H_
#define TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCESNEWRESPONSE_H_
    ...
    namespace Cdwch
    {
        namespace V20200915
        {
            namespace Model
            {
                ...
                */
                class DescribeInstancesNewResponse : public AbstractModel
                {
                public:
                    DescribeInstancesNewResponse();
                    ~DescribeInstancesNewResponse() = default;
...
#endif // !TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCESNEWRESPONSE_H_
