...
#ifndef TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCENODESREQUEST_H_
#define TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCENODESREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取当true的时候返回所有节点，即Limit无限大
                     * @return ForceAll 当true的时候返回所有节点，即Limit无限大
                     * 
                     */
                    bool GetForceAll() const;

                    /**
                     * 设置当true的时候返回所有节点，即Limit无限大
                     * @param _forceAll 当true的时候返回所有节点，即Limit无限大
                     * 
                     */
                    void SetForceAll(const bool& _forceAll);

                    /**
                     * 判断参数 ForceAll 是否已赋值
                     * @return ForceAll 是否已赋值
                     * 
                     */
                    bool ForceAllHasBeenSet() const;
...
#endif // !TENCENTCLOUD_CDWCH_V20200915_MODEL_DESCRIBEINSTANCENODESREQUEST_H_
