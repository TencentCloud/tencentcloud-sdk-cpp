...
string RecoverMemoryPlusSpaceRequest::ToJsonString() const
{
...
vector<string> RecoverMemoryPlusSpaceRequest::GetSpaceIds() const
{
    return m_spaceIds;
}

void RecoverMemoryPlusSpaceRequest::SetSpaceIds(const vector<string>& _spaceIds)
{
