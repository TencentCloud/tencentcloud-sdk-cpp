...
CoreInternalOutcome DescribeAgentInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeAgentInstancesResponse::ToJsonString() const
{
...
int64_t DescribeAgentInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AgentInstance> DescribeAgentInstancesResponse::GetItems() const
{
    return m_items;
}
