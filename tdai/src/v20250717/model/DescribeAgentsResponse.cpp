...
CoreInternalOutcome DescribeAgentsResponse::Deserialize(const string &payload)
{
...
string DescribeAgentsResponse::ToJsonString() const
{
...
int64_t DescribeAgentsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<Agent> DescribeAgentsResponse::GetItems() const
{
    return m_items;
}

bool DescribeAgentsResponse::ItemsHasBeenSet() const
{
