...
DescribeReportUrlResponse::DescribeReportUrlResponse() :
    m_downloadUrlHasBeenSet(false)
{
}

CoreInternalOutcome DescribeReportUrlResponse::Deserialize(const string &payload)
{
...
string DescribeReportUrlResponse::ToJsonString() const
{
...
string DescribeReportUrlResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeReportUrlResponse::DownloadUrlHasBeenSet() const
{
