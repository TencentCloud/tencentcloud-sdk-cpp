...
CoreInternalOutcome DescribeAgentDutyTasksResponse::Deserialize(const string &payload)
{
...
string DescribeAgentDutyTasksResponse::ToJsonString() const
{
...
int64_t DescribeAgentDutyTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}
