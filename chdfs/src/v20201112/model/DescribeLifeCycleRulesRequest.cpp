...
string DescribeLifeCycleRulesRequest::ToJsonString() const
{
...
string DescribeLifeCycleRulesRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DescribeLifeCycleRulesRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool DescribeLifeCycleRulesRequest::FileSystemIdHasBeenSet() const
{
