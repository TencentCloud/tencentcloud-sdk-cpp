...
string DescribeAccessRulesRequest::ToJsonString() const
{
...
string DescribeAccessRulesRequest::GetAccessGroupId() const
{
    return m_accessGroupId;
}

void DescribeAccessRulesRequest::SetAccessGroupId(const string& _accessGroupId)
{
    m_accessGroupId = _accessGroupId;
    m_accessGroupIdHasBeenSet = true;
}

bool DescribeAccessRulesRequest::AccessGroupIdHasBeenSet() const
{
