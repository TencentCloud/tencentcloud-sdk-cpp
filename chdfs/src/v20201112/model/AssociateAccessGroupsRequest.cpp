...
string AssociateAccessGroupsRequest::ToJsonString() const
{
...
string AssociateAccessGroupsRequest::GetMountPointId() const
{
    return m_mountPointId;
}

void AssociateAccessGroupsRequest::SetMountPointId(const string& _mountPointId)
{
    m_mountPointId = _mountPointId;
    m_mountPointIdHasBeenSet = true;
}

bool AssociateAccessGroupsRequest::MountPointIdHasBeenSet() const
{
    return m_mountPointIdHasBeenSet;
}

vector<string> AssociateAccessGroupsRequest::GetAccessGroupIds() const
{
    return m_accessGroupIds;
}

void AssociateAccessGroupsRequest::SetAccessGroupIds(const vector<string>& _accessGroupIds)
{
    m_accessGroupIds = _accessGroupIds;
    m_accessGroupIdsHasBeenSet = true;
}

bool AssociateAccessGroupsRequest::AccessGroupIdsHasBeenSet() const
{
