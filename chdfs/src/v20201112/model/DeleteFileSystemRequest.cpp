...
string DeleteFileSystemRequest::ToJsonString() const
{
...
string DeleteFileSystemRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DeleteFileSystemRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool DeleteFileSystemRequest::FileSystemIdHasBeenSet() const
{
