...
string DeleteAccessGroupRequest::ToJsonString() const
{
...
string DeleteAccessGroupRequest::GetAccessGroupId() const
{
    return m_accessGroupId;
}

void DeleteAccessGroupRequest::SetAccessGroupId(const string& _accessGroupId)
{
    m_accessGroupId = _accessGroupId;
    m_accessGroupIdHasBeenSet = true;
}

bool DeleteAccessGroupRequest::AccessGroupIdHasBeenSet() const
{
