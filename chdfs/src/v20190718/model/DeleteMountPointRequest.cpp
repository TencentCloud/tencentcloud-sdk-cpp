...
string DeleteMountPointRequest::ToJsonString() const
{
...
string DeleteMountPointRequest::GetMountPointId() const
{
    return m_mountPointId;
}

void DeleteMountPointRequest::SetMountPointId(const string& _mountPointId)
{
    m_mountPointId = _mountPointId;
    m_mountPointIdHasBeenSet = true;
}

bool DeleteMountPointRequest::MountPointIdHasBeenSet() const
{
