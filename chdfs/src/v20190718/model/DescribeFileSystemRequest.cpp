...
string DescribeFileSystemRequest::ToJsonString() const
{
...
string DescribeFileSystemRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DescribeFileSystemRequest::SetFileSystemId(const string& _fileSystemId)
{
    m_fileSystemId = _fileSystemId;
    m_fileSystemIdHasBeenSet = true;
}

bool DescribeFileSystemRequest::FileSystemIdHasBeenSet() const
{
