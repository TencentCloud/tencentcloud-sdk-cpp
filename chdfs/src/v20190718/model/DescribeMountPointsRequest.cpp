...
uint64_t DescribeMountPointsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeMountPointsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeMountPointsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeMountPointsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeMountPointsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeMountPointsRequest::LimitHasBeenSet() const
{
