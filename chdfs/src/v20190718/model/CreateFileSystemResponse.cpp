...
CoreInternalOutcome CreateFileSystemResponse::Deserialize(const string &payload)
{
...
string CreateFileSystemResponse::ToJsonString() const
{
...
FileSystem CreateFileSystemResponse::GetFileSystem() const
{
    return m_fileSystem;
}

bool CreateFileSystemResponse::FileSystemHasBeenSet() const
{
