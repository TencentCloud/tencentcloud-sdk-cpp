...
string DescribeRestoreTasksRequest::ToJsonString() const
{
...
string DescribeRestoreTasksRequest::GetFileSystemId() const
{
    return m_fileSystemId;
}

void DescribeRestoreTasksRequest::SetFileSystemId(const string& _fileSystemId)
{
