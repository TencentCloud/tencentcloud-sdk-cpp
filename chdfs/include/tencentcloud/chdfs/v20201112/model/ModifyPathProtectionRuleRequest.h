...
#ifndef TENCENTCLOUD_CHDFS_V20201112_MODEL_MODIFYPATHPROTECTIONRULEREQUEST_H_
#define TENCENTCLOUD_CHDFS_V20201112_MODEL_MODIFYPATHPROTECTIONRULEREQUEST_H_
    ...
    namespace Chdfs
    {
        namespace V20201112
        {
            namespace Model
            {
                ...
                */
                class ModifyPathProtectionRuleRequest : public AbstractModel
                {
                public:
                    ModifyPathProtectionRuleRequest();
                    ~ModifyPathProtectionRuleRequest() = default;
...
#endif // !TENCENTCLOUD_CHDFS_V20201112_MODEL_MODIFYPATHPROTECTIONRULEREQUEST_H_
