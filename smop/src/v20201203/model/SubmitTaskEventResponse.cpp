...
SubmitTaskEventResponse::SubmitTaskEventResponse() :
...
CoreInternalOutcome SubmitTaskEventResponse::Deserialize(const string &payload)
{
...
string SubmitTaskEventResponse::ToJsonString() const
{
...
string SubmitTaskEventResponse::GetOrderId() const
{
    return m_orderId;
}

bool SubmitTaskEventResponse::OrderIdHasBeenSet() const
{
    return m_orderIdHasBeenSet;
}

int64_t SubmitTaskEventResponse::GetCode() const
{
    return m_code;
}

bool SubmitTaskEventResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string SubmitTaskEventResponse::GetMessage() const
{
    return m_message;
}

bool SubmitTaskEventResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

vector<TaskEventData> SubmitTaskEventResponse::GetData() const
{
    return m_data;
}

bool SubmitTaskEventResponse::DataHasBeenSet() const
{
