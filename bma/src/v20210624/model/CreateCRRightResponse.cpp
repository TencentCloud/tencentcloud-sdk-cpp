...
CoreInternalOutcome CreateCRRightResponse::Deserialize(const string &payload)
{
...
string CreateCRRightResponse::ToJsonString() const
{
...
int64_t CreateCRRightResponse::GetTortId() const
{
    return m_tortId;
}

bool CreateCRRightResponse::TortIdHasBeenSet() const
{
    return m_tortIdHasBeenSet;
}

string CreateCRRightResponse::GetTortNum() const
{
    return m_tortNum;
}

bool CreateCRRightResponse::TortNumHasBeenSet() const
{
