...
string CreateBPOfflineTicketRequest::ToJsonString() const
{
    ...
    if (m_fakeURLIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, m_fakeURLId, allocator);
    }
...
int64_t CreateBPOfflineTicketRequest::GetFakeURLId() const
{
    return m_fakeURLId;
}

void CreateBPOfflineTicketRequest::SetFakeURLId(const int64_t& _fakeURLId)
{
    m_fakeURLId = _fakeURLId;
    m_fakeURLIdHasBeenSet = true;
}

bool CreateBPOfflineTicketRequest::FakeURLIdHasBeenSet() const
{
