...
string CreateBPFalseTicketRequest::ToJsonString() const
{
...
string CreateBPFalseTicketRequest::GetFakeURL() const
{
    return m_fakeURL;
}

void CreateBPFalseTicketRequest::SetFakeURL(const string& _fakeURL)
{
    m_fakeURL = _fakeURL;
    m_fakeURLHasBeenSet = true;
}

bool CreateBPFalseTicketRequest::FakeURLHasBeenSet() const
{
