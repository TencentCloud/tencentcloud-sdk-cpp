...
string DescribeCRWorkInfoRequest::ToJsonString() const
{
...
int64_t DescribeCRWorkInfoRequest::GetWorkId() const
{
    return m_workId;
}

void DescribeCRWorkInfoRequest::SetWorkId(const int64_t& _workId)
{
    m_workId = _workId;
    m_workIdHasBeenSet = true;
}

bool DescribeCRWorkInfoRequest::WorkIdHasBeenSet() const
{
