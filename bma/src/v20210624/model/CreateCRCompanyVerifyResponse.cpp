...
CoreInternalOutcome CreateCRCompanyVerifyResponse::Deserialize(const string &payload)
{
...
string CreateCRCompanyVerifyResponse::ToJsonString() const
{
...
int64_t CreateCRCompanyVerifyResponse::GetStatus() const
{
    return m_status;
}

bool CreateCRCompanyVerifyResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateCRCompanyVerifyResponse::GetNote() const
{
    return m_note;
}

bool CreateCRCompanyVerifyResponse::NoteHasBeenSet() const
{
