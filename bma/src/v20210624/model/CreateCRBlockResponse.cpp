...
CoreInternalOutcome CreateCRBlockResponse::Deserialize(const string &payload)
{
...
string CreateCRBlockResponse::ToJsonString() const
{
...
int64_t CreateCRBlockResponse::GetTortId() const
{
    return m_tortId;
}

bool CreateCRBlockResponse::TortIdHasBeenSet() const
{
    return m_tortIdHasBeenSet;
}

string CreateCRBlockResponse::GetTortNum() const
{
    return m_tortNum;
}

bool CreateCRBlockResponse::TortNumHasBeenSet() const
{
