...
CoreInternalOutcome CreateCRWorkResponse::Deserialize(const string &payload)
{
...
string CreateCRWorkResponse::ToJsonString() const
{
...
int64_t CreateCRWorkResponse::GetWorkId() const
{
    return m_workId;
}

bool CreateCRWorkResponse::WorkIdHasBeenSet() const
{
    return m_workIdHasBeenSet;
}

int64_t CreateCRWorkResponse::GetEvidenceId() const
{
    return m_evidenceId;
}

bool CreateCRWorkResponse::EvidenceIdHasBeenSet() const
{
