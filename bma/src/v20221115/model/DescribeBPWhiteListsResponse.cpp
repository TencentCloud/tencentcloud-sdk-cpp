...
CoreInternalOutcome DescribeBPWhiteListsResponse::Deserialize(const string &payload)
{
...
string DescribeBPWhiteListsResponse::ToJsonString() const
{
    ...
    if (m_whiteListsHasBeenSet)
    {
        ...
        int i=0;
        for (auto itr = m_whiteLists.begin(); itr != m_whiteLists.end(); ++itr, ++i)
        {
...
vector<WhiteListData> DescribeBPWhiteListsResponse::GetWhiteLists() const
{
    return m_whiteLists;
}

bool DescribeBPWhiteListsResponse::WhiteListsHasBeenSet() const
{
    return m_whiteListsHasBeenSet;
}

int64_t DescribeBPWhiteListsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBPWhiteListsResponse::TotalCountHasBeenSet() const
{
