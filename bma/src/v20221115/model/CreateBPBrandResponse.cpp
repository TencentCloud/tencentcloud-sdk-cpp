...
CoreInternalOutcome CreateBPBrandResponse::Deserialize(const string &payload)
{
...
string CreateBPBrandResponse::ToJsonString() const
{
...
int64_t CreateBPBrandResponse::GetCompanyId() const
{
    return m_companyId;
}

bool CreateBPBrandResponse::CompanyIdHasBeenSet() const
{
