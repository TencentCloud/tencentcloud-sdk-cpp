...
#ifndef TENCENTCLOUD_BMA_V20210624_MODEL_UPDATECRWORKRESPONSE_H_
#define TENCENTCLOUD_BMA_V20210624_MODEL_UPDATECRWORKRESPONSE_H_
    ...
    namespace Bma
    {
        namespace V20210624
        {
            namespace Model
            {
                ...
                * UpdateCRWork返回参数结构体
                */
                class UpdateCRWorkResponse : public AbstractModel
                {
                public:
                    UpdateCRWorkResponse();
                    ~UpdateCRWorkResponse() = default;
...
#endif // !TENCENTCLOUD_BMA_V20210624_MODEL_UPDATECRWORKRESPONSE_H_
