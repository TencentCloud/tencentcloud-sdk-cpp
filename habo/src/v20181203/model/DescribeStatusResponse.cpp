...
CoreInternalOutcome DescribeStatusResponse::Deserialize(const string &payload)
{
...
string DescribeStatusResponse::ToJsonString() const
{
...
int64_t DescribeStatusResponse::GetStatus() const
{
    return m_status;
}

bool DescribeStatusResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeStatusResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStatusResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string DescribeStatusResponse::GetData() const
{
    return m_data;
}

bool DescribeStatusResponse::DataHasBeenSet() const
{
