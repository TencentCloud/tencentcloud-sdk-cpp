...
CoreInternalOutcome StartAnalyseResponse::Deserialize(const string &payload)
{
...
string StartAnalyseResponse::ToJsonString() const
{
...
int64_t StartAnalyseResponse::GetStatus() const
{
    return m_status;
}

bool StartAnalyseResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string StartAnalyseResponse::GetInfo() const
{
    return m_info;
}

bool StartAnalyseResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string StartAnalyseResponse::GetData() const
{
    return m_data;
}

bool StartAnalyseResponse::DataHasBeenSet() const
{
