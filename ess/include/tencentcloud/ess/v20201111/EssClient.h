...
#include <tencentcloud/ess/v20201111/model/CancelOrganizationFlowsRequest.h>
#include <tencentcloud/ess/v20201111/model/CancelOrganizationFlowsResponse.h>
...
#include <tencentcloud/ess/v20201111/model/CreateFileConvertTaskResponse.h>
...
#include <tencentcloud/ess/v20201111/model/CreateRequestWithEncryptionRequest.h>
#include <tencentcloud/ess/v20201111/model/CreateRequestWithEncryptionResponse.h>
...
#include <tencentcloud/ess/v20201111/model/DescribeFileConvertTaskRequest.h>
#include <tencentcloud/ess/v20201111/model/DescribeFileConvertTaskResponse.h>
...
#include <tencentcloud/ess/v20201111/model/OperateFlowRemarksResponse.h>
    ...
    namespace Ess
    {
        namespace V20201111
        {
            ...
            public:
                ...
                typedef std::function<void(const EssClient*, const Model::CancelOrganizationFlowsRequest&, CancelOrganizationFlowsOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CancelOrganizationFlowsAsyncHandler;
                ...
                typedef std::function<void(const EssClient*, const Model::CreateFileConvertTaskRequest&, CreateFileConvertTaskOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateFileConvertTaskAsyncHandler;
                ...
                typedef std::function<void(const EssClient*, const Model::CreateRequestWithEncryptionRequest&, CreateRequestWithEncryptionOutcome, const std::shared_ptr<const AsyncCallerContext>&)> CreateRequestWithEncryptionAsyncHandler;
                ...
                typedef std::function<void(const EssClient*, const Model::DescribeFileConvertTaskRequest&, DescribeFileConvertTaskOutcome, const std::shared_ptr<const AsyncCallerContext>&)> DescribeFileConvertTaskAsyncHandler;
                ...
                typedef Outcome<Core::Error, Model::OperateFlowRemarksResponse> OperateFlowRemarksOutcome;
                typedef std::future<OperateFlowRemarksOutcome> OperateFlowRemarksOutcomeCallable;
                typedef std::function<void(const EssClient*, const Model::OperateFlowRemarksRequest&, OperateFlowRemarksOutcome, const std::shared_ptr<const AsyncCallerContext>&)> OperateFlowRemarksAsyncHandler;
...
![image](https://qcloudimg.tencent-cloud.cn/raw/e5ef298c41f999b656f6b620c8b3d888.png)
                 * @param req OperateFlowRemarksRequest
                 * @return OperateFlowRemarksOutcome
                 */
                OperateFlowRemarksOutcome OperateFlowRemarks(const Model::OperateFlowRemarksRequest &request);
                void OperateFlowRemarksAsync(const Model::OperateFlowRemarksRequest& request, const OperateFlowRemarksAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr);
                OperateFlowRemarksOutcomeCallable OperateFlowRemarksCallable(const Model::OperateFlowRemarksRequest& request);
