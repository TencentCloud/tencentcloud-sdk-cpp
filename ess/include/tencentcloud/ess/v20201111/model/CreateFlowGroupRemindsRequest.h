...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPREMINDSREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPREMINDSREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateFlowGroupRemindsRequest : public AbstractModel
                {
                public:
                    CreateFlowGroupRemindsRequest();
                    ~CreateFlowGroupRemindsRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPREMINDSREQUEST_H_
