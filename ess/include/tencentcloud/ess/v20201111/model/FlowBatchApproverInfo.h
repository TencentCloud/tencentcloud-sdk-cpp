...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_FLOWBATCHAPPROVERINFO_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_FLOWBATCHAPPROVERINFO_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class FlowBatchApproverInfo : public AbstractModel
                {
                public:
                    FlowBatchApproverInfo();
                    ~FlowBatchApproverInfo() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_FLOWBATCHAPPROVERINFO_H_
