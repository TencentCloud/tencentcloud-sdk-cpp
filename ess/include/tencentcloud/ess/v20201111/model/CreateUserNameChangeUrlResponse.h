...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEUSERNAMECHANGEURLRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEUSERNAMECHANGEURLRESPONSE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateUserNameChangeUrlResponse : public AbstractModel
                {
                public:
                    CreateUserNameChangeUrlResponse();
                    ~CreateUserNameChangeUrlResponse() = default;
...
`注：` <font color="red">生成的链路后面不能再增加参数，防止出错重复参数覆盖原有的参数</font>
                     * @return UserVerifyUrl 腾讯电子签小程序的个人更名链接。
如果没有传递，默认值是 HTTP。 链接的有效期均是 7 天。
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEUSERNAMECHANGEURLRESPONSE_H_
