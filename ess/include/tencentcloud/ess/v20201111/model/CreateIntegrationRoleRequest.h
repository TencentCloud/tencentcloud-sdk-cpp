...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEINTEGRATIONROLEREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEINTEGRATIONROLEREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateIntegrationRoleRequest : public AbstractModel
                {
                public:
                    CreateIntegrationRoleRequest();
                    ~CreateIntegrationRoleRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEINTEGRATIONROLEREQUEST_H_
