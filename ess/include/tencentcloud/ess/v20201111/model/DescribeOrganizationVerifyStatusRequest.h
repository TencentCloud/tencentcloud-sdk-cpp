...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEORGANIZATIONVERIFYSTATUSREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEORGANIZATIONVERIFYSTATUSREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeOrganizationVerifyStatusRequest : public AbstractModel
                {
                public:
                    DescribeOrganizationVerifyStatusRequest();
                    ~DescribeOrganizationVerifyStatusRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEORGANIZATIONVERIFYSTATUSREQUEST_H_
