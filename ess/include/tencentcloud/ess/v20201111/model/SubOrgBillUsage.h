...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_SUBORGBILLUSAGE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_SUBORGBILLUSAGE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                * 集团子企业使用集团主企业的套餐使用情况
                */
                class SubOrgBillUsage : public AbstractModel
                {
                public:
                    SubOrgBillUsage();
                    ~SubOrgBillUsage() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_SUBORGBILLUSAGE_H_
