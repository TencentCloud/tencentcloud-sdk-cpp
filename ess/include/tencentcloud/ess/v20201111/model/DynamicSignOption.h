...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DYNAMICSIGNOPTION_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DYNAMICSIGNOPTION_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取动态签署方时，预设的企业名称，预设企业名称后，只允许对应的企业员工进行领取签署。
                     * @return OrganizationName 动态签署方时，预设的企业名称，预设企业名称后，只允许对应的企业员工进行领取签署。
                     * 
                     */
                    std::string GetOrganizationName() const;

                    /**
                     * 设置动态签署方时，预设的企业名称，预设企业名称后，只允许对应的企业员工进行领取签署。
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DYNAMICSIGNOPTION_H_
