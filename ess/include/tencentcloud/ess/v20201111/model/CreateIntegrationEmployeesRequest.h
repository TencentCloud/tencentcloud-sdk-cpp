            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取待创建员工的信息，Mobile和DisplayName必填,OpenId和Email选填，其他字段暂不支持
                    ...
                    /**
                     * 设置待创建员工的信息，Mobile和DisplayName必填,OpenId和Email选填，其他字段暂不支持
                     * @param _employees 待创建员工的信息，Mobile和DisplayName必填,OpenId和Email选填，其他字段暂不支持
                     * 
                     */
