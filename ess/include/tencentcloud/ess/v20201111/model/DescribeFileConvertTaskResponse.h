...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECONVERTTASKRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECONVERTTASKRESPONSE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeFileConvertTaskResponse : public AbstractModel
                {
                public:
                    DescribeFileConvertTaskResponse();
                    ~DescribeFileConvertTaskResponse() = default;
                    ...
                    /**
                     * 获取<p>任务状态，需要关注的状态</p><p>枚举值：</p><ul><li>0： NeedTranform - 任务已提交</li><li>4： Processing - 文档转换中</li><li>8： TaskEnd - 任务处理完成</li><li>-2： DownloadFailed - 下载失败</li><li>-6： ProcessFailed - 转换失败</li><li>-13： ProcessTimeout - 转换文件超时</li></ul>
                    ...
                    /**
                     * 获取<p>状态描述，需要关注的状态</p><ul><li> **NeedTranform** : 任务已提交</li><li> **Processing** : 文档转换中</li><li> **TaskEnd** : 任务处理完成</li><li> **DownloadFailed** : 下载失败</li><li> **ProcessFailed** : 转换失败</li><li> **ProcessTimeout** : 转换文件超时</li></ul>
                    ...
                    /**
                     * 获取<p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/companyApis/startFlows/CreateFlowByFiles">用PDF文件创建签署流程</a></p>
                     * @return ResourceId <p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/companyApis/startFlows/CreateFlowByFiles">用PDF文件创建签署流程</a></p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECONVERTTASKRESPONSE_H_
