...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEDIGITALDATASIGNREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEDIGITALDATASIGNREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateDigitalDataSignRequest : public AbstractModel
                {
                public:
                    CreateDigitalDataSignRequest();
                    ~CreateDigitalDataSignRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEDIGITALDATASIGNREQUEST_H_
