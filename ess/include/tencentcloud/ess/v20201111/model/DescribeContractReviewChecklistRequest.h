...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBECONTRACTREVIEWCHECKLISTREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBECONTRACTREVIEWCHECKLISTREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeContractReviewChecklistRequest : public AbstractModel
                {
                public:
                    DescribeContractReviewChecklistRequest();
                    ~DescribeContractReviewChecklistRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBECONTRACTREVIEWCHECKLISTREQUEST_H_
