...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEPARTNERAUTOSIGNAUTHURLRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEPARTNERAUTOSIGNAUTHURLRESPONSE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreatePartnerAutoSignAuthUrlResponse : public AbstractModel
                {
                public:
                    CreatePartnerAutoSignAuthUrlResponse();
                    ~CreatePartnerAutoSignAuthUrlResponse() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEPARTNERAUTOSIGNAUTHURLRESPONSE_H_
