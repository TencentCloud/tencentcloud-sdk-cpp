...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_VERIFYDIGITFILEREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_VERIFYDIGITFILEREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class VerifyDigitFileRequest : public AbstractModel
                {
                public:
                    VerifyDigitFileRequest();
                    ~VerifyDigitFileRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_VERIFYDIGITFILEREQUEST_H_
