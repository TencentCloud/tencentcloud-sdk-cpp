...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWSIGNURLRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWSIGNURLRESPONSE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateFlowSignUrlResponse : public AbstractModel
                {
                public:
                    CreateFlowSignUrlResponse();
                    ~CreateFlowSignUrlResponse() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWSIGNURLRESPONSE_H_
