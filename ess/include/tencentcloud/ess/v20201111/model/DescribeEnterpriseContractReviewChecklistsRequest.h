...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEENTERPRISECONTRACTREVIEWCHECKLISTSREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEENTERPRISECONTRACTREVIEWCHECKLISTSREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeEnterpriseContractReviewChecklistsRequest : public AbstractModel
                {
                public:
                    DescribeEnterpriseContractReviewChecklistsRequest();
                    ~DescribeEnterpriseContractReviewChecklistsRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEENTERPRISECONTRACTREVIEWCHECKLISTSREQUEST_H_
