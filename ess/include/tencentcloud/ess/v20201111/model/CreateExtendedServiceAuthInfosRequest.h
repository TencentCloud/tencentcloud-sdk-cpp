...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEEXTENDEDSERVICEAUTHINFOSREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEEXTENDEDSERVICEAUTHINFOSREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateExtendedServiceAuthInfosRequest : public AbstractModel
                {
                public:
                    CreateExtendedServiceAuthInfosRequest();
                    ~CreateExtendedServiceAuthInfosRequest() = default;
                    ...
                    /**
                     * 获取<p>取值<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
                     * @return ExtendServiceType <p>取值<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
                     * 
                     */
                    std::string GetExtendServiceType() const;

                    /**
                     * 设置<p>取值<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
                     * @param _extendServiceType <p>取值<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEEXTENDEDSERVICEAUTHINFOSREQUEST_H_
