...
CreateOrganizationBatchSignUrlResponse::CreateOrganizationBatchSignUrlResponse() :
    m_signUrlHasBeenSet(false),
    m_expiredTimeHasBeenSet(false)
{
}

CoreInternalOutcome CreateOrganizationBatchSignUrlResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationBatchSignUrlResponse::ToJsonString() const
{
...
string CreateOrganizationBatchSignUrlResponse::GetSignUrl() const
{
    return m_signUrl;
}

bool CreateOrganizationBatchSignUrlResponse::SignUrlHasBeenSet() const
{
    return m_signUrlHasBeenSet;
}

int64_t CreateOrganizationBatchSignUrlResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool CreateOrganizationBatchSignUrlResponse::ExpiredTimeHasBeenSet() const
{
