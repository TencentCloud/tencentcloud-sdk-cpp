...
CoreInternalOutcome DescribeInformationExtractionTaskResponse::Deserialize(const string &payload)
{
...
string DescribeInformationExtractionTaskResponse::ToJsonString() const
{
...
vector<ExtractionField> DescribeInformationExtractionTaskResponse::GetFields() const
{
    return m_fields;
}

bool DescribeInformationExtractionTaskResponse::FieldsHasBeenSet() const
{
    return m_fieldsHasBeenSet;
}

int64_t DescribeInformationExtractionTaskResponse::GetStatus() const
{
    return m_status;
}

bool DescribeInformationExtractionTaskResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeInformationExtractionTaskResponse::GetUrl() const
{
    return m_url;
}
