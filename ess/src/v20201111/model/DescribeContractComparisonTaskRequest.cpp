...
string DescribeContractComparisonTaskRequest::ToJsonString() const
{
...
UserInfo DescribeContractComparisonTaskRequest::GetOperator() const
{
    return m_operator;
}

void DescribeContractComparisonTaskRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool DescribeContractComparisonTaskRequest::OperatorHasBeenSet() const
{
    return m_operatorHasBeenSet;
}

string DescribeContractComparisonTaskRequest::GetTaskId() const
{
    return m_taskId;
}

void DescribeContractComparisonTaskRequest::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
...
vector<Filter> DescribeContractComparisonTaskRequest::GetFilters() const
{
    return m_filters;
}

void DescribeContractComparisonTaskRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeContractComparisonTaskRequest::FiltersHasBeenSet() const
{
