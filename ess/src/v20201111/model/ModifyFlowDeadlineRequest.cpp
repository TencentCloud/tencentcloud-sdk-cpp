...
UserInfo ModifyFlowDeadlineRequest::GetOperator() const
{
    return m_operator;
}

void ModifyFlowDeadlineRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool ModifyFlowDeadlineRequest::OperatorHasBeenSet() const
{
