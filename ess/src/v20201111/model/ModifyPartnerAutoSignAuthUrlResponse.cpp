...
ModifyPartnerAutoSignAuthUrlResponse::ModifyPartnerAutoSignAuthUrlResponse() :
...
CoreInternalOutcome ModifyPartnerAutoSignAuthUrlResponse::Deserialize(const string &payload)
{
...
string ModifyPartnerAutoSignAuthUrlResponse::ToJsonString() const
{
...
string ModifyPartnerAutoSignAuthUrlResponse::GetUrl() const
{
    return m_url;
}

bool ModifyPartnerAutoSignAuthUrlResponse::UrlHasBeenSet() const
{
    return m_urlHasBeenSet;
}

string ModifyPartnerAutoSignAuthUrlResponse::GetMiniAppPath() const
{
    return m_miniAppPath;
}

bool ModifyPartnerAutoSignAuthUrlResponse::MiniAppPathHasBeenSet() const
{
    return m_miniAppPathHasBeenSet;
}

int64_t ModifyPartnerAutoSignAuthUrlResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool ModifyPartnerAutoSignAuthUrlResponse::ExpireTimeHasBeenSet() const
{
