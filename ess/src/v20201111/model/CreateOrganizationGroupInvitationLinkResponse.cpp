...
CreateOrganizationGroupInvitationLinkResponse::CreateOrganizationGroupInvitationLinkResponse() :
...
CoreInternalOutcome CreateOrganizationGroupInvitationLinkResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("JumpUrl") && !rsp["JumpUrl"].IsNull())
    {
        if (!rsp["JumpUrl"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `JumpUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_jumpUrl = string(rsp["JumpUrl"].GetString());
...
string CreateOrganizationGroupInvitationLinkResponse::ToJsonString() const
{
...
string CreateOrganizationGroupInvitationLinkResponse::GetLink() const
{
    return m_link;
}

bool CreateOrganizationGroupInvitationLinkResponse::LinkHasBeenSet() const
{
    return m_linkHasBeenSet;
}

int64_t CreateOrganizationGroupInvitationLinkResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool CreateOrganizationGroupInvitationLinkResponse::ExpireTimeHasBeenSet() const
{
    return m_expireTimeHasBeenSet;
}

string CreateOrganizationGroupInvitationLinkResponse::GetJumpUrl() const
{
    return m_jumpUrl;
}

bool CreateOrganizationGroupInvitationLinkResponse::JumpUrlHasBeenSet() const
{
    return m_jumpUrlHasBeenSet;
}

string CreateOrganizationGroupInvitationLinkResponse::GetMiniAppPath() const
{
    return m_miniAppPath;
}

bool CreateOrganizationGroupInvitationLinkResponse::MiniAppPathHasBeenSet() const
{
