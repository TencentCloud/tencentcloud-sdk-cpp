...
CreateUserMobileChangeUrlResponse::CreateUserMobileChangeUrlResponse() :
    m_urlHasBeenSet(false),
    m_expireTimeHasBeenSet(false)
{
}

CoreInternalOutcome CreateUserMobileChangeUrlResponse::Deserialize(const string &payload)
{
...
string CreateUserMobileChangeUrlResponse::ToJsonString() const
{
...
string CreateUserMobileChangeUrlResponse::GetUrl() const
{
    return m_url;
}

bool CreateUserMobileChangeUrlResponse::UrlHasBeenSet() const
{
    return m_urlHasBeenSet;
}

int64_t CreateUserMobileChangeUrlResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool CreateUserMobileChangeUrlResponse::ExpireTimeHasBeenSet() const
{
