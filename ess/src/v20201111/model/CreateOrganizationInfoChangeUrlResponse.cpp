...
CreateOrganizationInfoChangeUrlResponse::CreateOrganizationInfoChangeUrlResponse() :
    m_urlHasBeenSet(false),
    m_expiredTimeHasBeenSet(false)
{
}

CoreInternalOutcome CreateOrganizationInfoChangeUrlResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationInfoChangeUrlResponse::ToJsonString() const
{
...
string CreateOrganizationInfoChangeUrlResponse::GetUrl() const
{
    return m_url;
}

bool CreateOrganizationInfoChangeUrlResponse::UrlHasBeenSet() const
{
    return m_urlHasBeenSet;
}

int64_t CreateOrganizationInfoChangeUrlResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool CreateOrganizationInfoChangeUrlResponse::ExpiredTimeHasBeenSet() const
{
