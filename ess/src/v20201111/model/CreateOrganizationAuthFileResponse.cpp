...
CreateOrganizationAuthFileResponse::CreateOrganizationAuthFileResponse() :
    m_fileUrlHasBeenSet(false)
{
}

CoreInternalOutcome CreateOrganizationAuthFileResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationAuthFileResponse::ToJsonString() const
{
...
string CreateOrganizationAuthFileResponse::GetFileUrl() const
{
    return m_fileUrl;
}

bool CreateOrganizationAuthFileResponse::FileUrlHasBeenSet() const
{
