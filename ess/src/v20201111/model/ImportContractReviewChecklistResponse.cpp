...
ImportContractReviewChecklistResponse::ImportContractReviewChecklistResponse() :
    m_checklistIdHasBeenSet(false)
{
}

CoreInternalOutcome ImportContractReviewChecklistResponse::Deserialize(const string &payload)
{
...
string ImportContractReviewChecklistResponse::ToJsonString() const
{
...
string ImportContractReviewChecklistResponse::GetChecklistId() const
{
    return m_checklistId;
}

bool ImportContractReviewChecklistResponse::ChecklistIdHasBeenSet() const
{
