...
UserInfo CreateFlowBlockchainEvidenceUrlRequest::GetOperator() const
{
    return m_operator;
}

void CreateFlowBlockchainEvidenceUrlRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool CreateFlowBlockchainEvidenceUrlRequest::OperatorHasBeenSet() const
{
