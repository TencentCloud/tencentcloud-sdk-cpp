...
UserInfo CreateBatchOrganizationAuthorizationUrlRequest::GetOperator() const
{
    return m_operator;
}

void CreateBatchOrganizationAuthorizationUrlRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool CreateBatchOrganizationAuthorizationUrlRequest::OperatorHasBeenSet() const
{
