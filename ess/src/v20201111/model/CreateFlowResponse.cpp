...
CoreInternalOutcome CreateFlowResponse::Deserialize(const string &payload)
{
...
string CreateFlowResponse::ToJsonString() const
{
...
string CreateFlowResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateFlowResponse::FlowIdHasBeenSet() const
{
