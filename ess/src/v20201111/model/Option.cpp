...
CoreInternalOutcome Option::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Key") && !value["Key"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `Option.Key` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string Option::GetKey() const
{
    return m_key;
}

void Option::SetKey(const string& _key)
{
    m_key = _key;
    m_keyHasBeenSet = true;
}

bool Option::KeyHasBeenSet() const
{
