...
CoreInternalOutcome CreateDocumentResponse::Deserialize(const string &payload)
{
...
string CreateDocumentResponse::ToJsonString() const
{
...
string CreateDocumentResponse::GetDocumentId() const
{
    return m_documentId;
}

bool CreateDocumentResponse::DocumentIdHasBeenSet() const
{
    return m_documentIdHasBeenSet;
}

string CreateDocumentResponse::GetPreviewFileUrl() const
{
