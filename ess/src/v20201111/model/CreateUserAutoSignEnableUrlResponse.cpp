...
CreateUserAutoSignEnableUrlResponse::CreateUserAutoSignEnableUrlResponse() :
...
CoreInternalOutcome CreateUserAutoSignEnableUrlResponse::Deserialize(const string &payload)
{
...
string CreateUserAutoSignEnableUrlResponse::ToJsonString() const
{
...
string CreateUserAutoSignEnableUrlResponse::GetUrl() const
{
    return m_url;
}

bool CreateUserAutoSignEnableUrlResponse::UrlHasBeenSet() const
{
    return m_urlHasBeenSet;
}

string CreateUserAutoSignEnableUrlResponse::GetAppId() const
{
    return m_appId;
}

bool CreateUserAutoSignEnableUrlResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateUserAutoSignEnableUrlResponse::GetAppOriginalId() const
{
    return m_appOriginalId;
}

bool CreateUserAutoSignEnableUrlResponse::AppOriginalIdHasBeenSet() const
{
    return m_appOriginalIdHasBeenSet;
}

string CreateUserAutoSignEnableUrlResponse::GetPath() const
{
    return m_path;
}

bool CreateUserAutoSignEnableUrlResponse::PathHasBeenSet() const
{
    return m_pathHasBeenSet;
}

string CreateUserAutoSignEnableUrlResponse::GetQrCode() const
{
    return m_qrCode;
}

bool CreateUserAutoSignEnableUrlResponse::QrCodeHasBeenSet() const
{
    return m_qrCodeHasBeenSet;
}

string CreateUserAutoSignEnableUrlResponse::GetUrlType() const
{
    return m_urlType;
}

bool CreateUserAutoSignEnableUrlResponse::UrlTypeHasBeenSet() const
{
