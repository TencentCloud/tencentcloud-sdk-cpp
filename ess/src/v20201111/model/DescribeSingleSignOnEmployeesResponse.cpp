...
DescribeSingleSignOnEmployeesResponse::DescribeSingleSignOnEmployeesResponse() :
    m_employeesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSingleSignOnEmployeesResponse::Deserialize(const string &payload)
{
...
string DescribeSingleSignOnEmployeesResponse::ToJsonString() const
{
...
vector<SingleSignOnEmployees> DescribeSingleSignOnEmployeesResponse::GetEmployees() const
{
    return m_employees;
}

bool DescribeSingleSignOnEmployeesResponse::EmployeesHasBeenSet() const
{
