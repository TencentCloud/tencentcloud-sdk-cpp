...
UserInfo OperateTemplateRequest::GetOperator() const
{
    return m_operator;
}

void OperateTemplateRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool OperateTemplateRequest::OperatorHasBeenSet() const
{
