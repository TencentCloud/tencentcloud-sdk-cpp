...
UserInfo CancelOrganizationFlowsRequest::GetOperator() const
{
    return m_operator;
}

void CancelOrganizationFlowsRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool CancelOrganizationFlowsRequest::OperatorHasBeenSet() const
{
