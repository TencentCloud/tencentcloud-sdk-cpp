...
CreateBatchSignUrlResponse::CreateBatchSignUrlResponse() :
...
CoreInternalOutcome CreateBatchSignUrlResponse::Deserialize(const string &payload)
{
...
string CreateBatchSignUrlResponse::ToJsonString() const
{
...
string CreateBatchSignUrlResponse::GetSignUrl() const
{
    return m_signUrl;
}

bool CreateBatchSignUrlResponse::SignUrlHasBeenSet() const
{
    return m_signUrlHasBeenSet;
}

int64_t CreateBatchSignUrlResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool CreateBatchSignUrlResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

string CreateBatchSignUrlResponse::GetMiniAppPath() const
{
    return m_miniAppPath;
}

bool CreateBatchSignUrlResponse::MiniAppPathHasBeenSet() const
{
