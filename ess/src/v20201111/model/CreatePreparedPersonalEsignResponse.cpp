...
CreatePreparedPersonalEsignResponse::CreatePreparedPersonalEsignResponse() :
    m_sealIdHasBeenSet(false)
{
}

CoreInternalOutcome CreatePreparedPersonalEsignResponse::Deserialize(const string &payload)
{
...
string CreatePreparedPersonalEsignResponse::ToJsonString() const
{
...
string CreatePreparedPersonalEsignResponse::GetSealId() const
{
    return m_sealId;
}

bool CreatePreparedPersonalEsignResponse::SealIdHasBeenSet() const
{
