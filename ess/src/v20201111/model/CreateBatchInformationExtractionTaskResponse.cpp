...
CreateBatchInformationExtractionTaskResponse::CreateBatchInformationExtractionTaskResponse() :
    m_taskIdsHasBeenSet(false)
{
}

CoreInternalOutcome CreateBatchInformationExtractionTaskResponse::Deserialize(const string &payload)
{
...
string CreateBatchInformationExtractionTaskResponse::ToJsonString() const
{
...
vector<string> CreateBatchInformationExtractionTaskResponse::GetTaskIds() const
{
    return m_taskIds;
}

bool CreateBatchInformationExtractionTaskResponse::TaskIdsHasBeenSet() const
{
