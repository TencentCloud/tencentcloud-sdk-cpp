...
CreateReleaseFlowResponse::CreateReleaseFlowResponse() :
    m_flowIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateReleaseFlowResponse::Deserialize(const string &payload)
{
...
string CreateReleaseFlowResponse::ToJsonString() const
{
...
string CreateReleaseFlowResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateReleaseFlowResponse::FlowIdHasBeenSet() const
{
