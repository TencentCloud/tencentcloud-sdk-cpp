...
DescribePersonCertificateResponse::DescribePersonCertificateResponse() :
    m_certHasBeenSet(false)
{
}

CoreInternalOutcome DescribePersonCertificateResponse::Deserialize(const string &payload)
{
...
string DescribePersonCertificateResponse::ToJsonString() const
{
...
string DescribePersonCertificateResponse::GetCert() const
{
    return m_cert;
}

bool DescribePersonCertificateResponse::CertHasBeenSet() const
{
