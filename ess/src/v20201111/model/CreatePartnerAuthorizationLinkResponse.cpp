...
CreatePartnerAuthorizationLinkResponse::CreatePartnerAuthorizationLinkResponse() :
    m_linkHasBeenSet(false),
    m_expireTimeHasBeenSet(false)
{
}

CoreInternalOutcome CreatePartnerAuthorizationLinkResponse::Deserialize(const string &payload)
{
...
string CreatePartnerAuthorizationLinkResponse::ToJsonString() const
{
...
string CreatePartnerAuthorizationLinkResponse::GetLink() const
{
    return m_link;
}

bool CreatePartnerAuthorizationLinkResponse::LinkHasBeenSet() const
{
    return m_linkHasBeenSet;
}

int64_t CreatePartnerAuthorizationLinkResponse::GetExpireTime() const
{
    return m_expireTime;
}

bool CreatePartnerAuthorizationLinkResponse::ExpireTimeHasBeenSet() const
{
