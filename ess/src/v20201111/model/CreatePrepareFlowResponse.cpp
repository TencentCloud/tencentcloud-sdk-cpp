...
CoreInternalOutcome CreatePrepareFlowResponse::Deserialize(const string &payload)
{
...
string CreatePrepareFlowResponse::ToJsonString() const
{
...
string CreatePrepareFlowResponse::GetUrl() const
{
    return m_url;
}
