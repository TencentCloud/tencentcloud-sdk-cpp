...
RenewAutoSignLicenseResponse::RenewAutoSignLicenseResponse() :
    m_licenseToHasBeenSet(false)
{
}

CoreInternalOutcome RenewAutoSignLicenseResponse::Deserialize(const string &payload)
{
...
string RenewAutoSignLicenseResponse::ToJsonString() const
{
...
int64_t RenewAutoSignLicenseResponse::GetLicenseTo() const
{
    return m_licenseTo;
}

bool RenewAutoSignLicenseResponse::LicenseToHasBeenSet() const
{
