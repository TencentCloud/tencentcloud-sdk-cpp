...
UserInfo DescribeUserFlowTypeRequest::GetOperator() const
{
    return m_operator;
}

void DescribeUserFlowTypeRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool DescribeUserFlowTypeRequest::OperatorHasBeenSet() const
{
