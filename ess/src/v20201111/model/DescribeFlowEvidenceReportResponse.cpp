...
CoreInternalOutcome DescribeFlowEvidenceReportResponse::Deserialize(const string &payload)
{
...
string DescribeFlowEvidenceReportResponse::ToJsonString() const
{
...
string DescribeFlowEvidenceReportResponse::GetReportUrl() const
{
    return m_reportUrl;
}

bool DescribeFlowEvidenceReportResponse::ReportUrlHasBeenSet() const
{
    return m_reportUrlHasBeenSet;
}

string DescribeFlowEvidenceReportResponse::GetStatus() const
{
    return m_status;
}

bool DescribeFlowEvidenceReportResponse::StatusHasBeenSet() const
{
