...
CoreInternalOutcome CreateBatchCancelFlowUrlResponse::Deserialize(const string &payload)
{
...
string CreateBatchCancelFlowUrlResponse::ToJsonString() const
{
...
string CreateBatchCancelFlowUrlResponse::GetBatchCancelFlowUrl() const
{
    return m_batchCancelFlowUrl;
}

bool CreateBatchCancelFlowUrlResponse::BatchCancelFlowUrlHasBeenSet() const
{
    return m_batchCancelFlowUrlHasBeenSet;
}

vector<string> CreateBatchCancelFlowUrlResponse::GetFailMessages() const
{
    return m_failMessages;
}

bool CreateBatchCancelFlowUrlResponse::FailMessagesHasBeenSet() const
{
    return m_failMessagesHasBeenSet;
}

string CreateBatchCancelFlowUrlResponse::GetUrlExpireOn() const
{
    return m_urlExpireOn;
}

bool CreateBatchCancelFlowUrlResponse::UrlExpireOnHasBeenSet() const
{
    return m_urlExpireOnHasBeenSet;
}

string CreateBatchCancelFlowUrlResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateBatchCancelFlowUrlResponse::TaskIdHasBeenSet() const
{
