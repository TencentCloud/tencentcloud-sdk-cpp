...
CreateBatchContractReviewTaskResponse::CreateBatchContractReviewTaskResponse() :
    m_taskIdsHasBeenSet(false)
{
}

CoreInternalOutcome CreateBatchContractReviewTaskResponse::Deserialize(const string &payload)
{
...
string CreateBatchContractReviewTaskResponse::ToJsonString() const
{
...
vector<string> CreateBatchContractReviewTaskResponse::GetTaskIds() const
{
    return m_taskIds;
}

bool CreateBatchContractReviewTaskResponse::TaskIdsHasBeenSet() const
{
