...
DescribeSignFaceVideoResponse::DescribeSignFaceVideoResponse() :
...
CoreInternalOutcome DescribeSignFaceVideoResponse::Deserialize(const string &payload)
{
...
string DescribeSignFaceVideoResponse::ToJsonString() const
{
...
DetectInfoVideoData DescribeSignFaceVideoResponse::GetVideoData() const
{
    return m_videoData;
}

bool DescribeSignFaceVideoResponse::VideoDataHasBeenSet() const
{
    return m_videoDataHasBeenSet;
}

IntentionQuestionResult DescribeSignFaceVideoResponse::GetIntentionQuestionResult() const
{
    return m_intentionQuestionResult;
}

bool DescribeSignFaceVideoResponse::IntentionQuestionResultHasBeenSet() const
{
    return m_intentionQuestionResultHasBeenSet;
}

IntentionActionResult DescribeSignFaceVideoResponse::GetIntentionActionResult() const
{
    return m_intentionActionResult;
}

bool DescribeSignFaceVideoResponse::IntentionActionResultHasBeenSet() const
{
