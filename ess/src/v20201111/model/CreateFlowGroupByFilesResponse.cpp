...
CoreInternalOutcome CreateFlowGroupByFilesResponse::Deserialize(const string &payload)
{
...
string CreateFlowGroupByFilesResponse::ToJsonString() const
{
...
string CreateFlowGroupByFilesResponse::GetFlowGroupId() const
{
    return m_flowGroupId;
}

bool CreateFlowGroupByFilesResponse::FlowGroupIdHasBeenSet() const
{
    return m_flowGroupIdHasBeenSet;
}

vector<string> CreateFlowGroupByFilesResponse::GetFlowIds() const
{
    return m_flowIds;
}
