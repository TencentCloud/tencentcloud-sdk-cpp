...
UserInfo CreateFlowGroupSignReviewRequest::GetOperator() const
{
    return m_operator;
}

void CreateFlowGroupSignReviewRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool CreateFlowGroupSignReviewRequest::OperatorHasBeenSet() const
{
