...
CreateSingleSignOnEmployeesResponse::CreateSingleSignOnEmployeesResponse() :
    m_errorMessagesHasBeenSet(false),
    m_statusHasBeenSet(false)
{
}

CoreInternalOutcome CreateSingleSignOnEmployeesResponse::Deserialize(const string &payload)
{
...
string CreateSingleSignOnEmployeesResponse::ToJsonString() const
{
...
vector<string> CreateSingleSignOnEmployeesResponse::GetErrorMessages() const
{
    return m_errorMessages;
}

bool CreateSingleSignOnEmployeesResponse::ErrorMessagesHasBeenSet() const
{
    return m_errorMessagesHasBeenSet;
}

uint64_t CreateSingleSignOnEmployeesResponse::GetStatus() const
{
    return m_status;
}

bool CreateSingleSignOnEmployeesResponse::StatusHasBeenSet() const
{
