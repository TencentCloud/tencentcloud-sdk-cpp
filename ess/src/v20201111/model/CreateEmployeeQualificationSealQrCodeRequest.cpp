...
UserInfo CreateEmployeeQualificationSealQrCodeRequest::GetOperator() const
{
    return m_operator;
}

void CreateEmployeeQualificationSealQrCodeRequest::SetOperator(const UserInfo& _operator)
{
    m_operator = _operator;
    m_operatorHasBeenSet = true;
}

bool CreateEmployeeQualificationSealQrCodeRequest::OperatorHasBeenSet() const
{
