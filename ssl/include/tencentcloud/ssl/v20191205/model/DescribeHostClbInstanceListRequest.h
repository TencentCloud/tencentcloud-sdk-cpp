...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCLBINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCLBINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostClbInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostClbInstanceListRequest();
                    ~DescribeHostClbInstanceListRequest() = default;
                    ...
                    /**
                     * 获取是否异步缓存,0表示否,1表示是
                     * @return AsyncCache 是否异步缓存,0表示否,1表示是
                     * 
                     */
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCLBINSTANCELISTREQUEST_H_
