...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostTkeInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostTkeInstanceListRequest();
                    ~DescribeHostTkeInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTREQUEST_H_
