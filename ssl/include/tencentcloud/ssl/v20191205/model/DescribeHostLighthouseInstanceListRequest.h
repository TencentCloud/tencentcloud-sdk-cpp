...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTLIGHTHOUSEINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTLIGHTHOUSEINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostLighthouseInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostLighthouseInstanceListRequest();
                    ~DescribeHostLighthouseInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTLIGHTHOUSEINSTANCELISTREQUEST_H_
