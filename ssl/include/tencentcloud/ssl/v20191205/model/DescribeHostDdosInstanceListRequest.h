...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTDDOSINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTDDOSINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostDdosInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostDdosInstanceListRequest();
                    ~DescribeHostDdosInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTDDOSINSTANCELISTREQUEST_H_
