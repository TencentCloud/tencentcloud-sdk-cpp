            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 设置<p>证书来源：<br>trustasia：亚洲诚信，<br>upload：用户上传。<br>wosign：沃通<br>sheca：上海CA</p>
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>订阅服务状态</p><p>枚举值：</p><ul><li>initing： 未激活</li><li>running： 生效中</li><li>expired： 已过期</li><li>refunded： 已退款</li><li>nearExpire： 即将到期</li></ul>
                    ...
                    /**
                     * 设置<p>订阅服务状态</p><p>枚举值：</p><ul><li>initing： 未激活</li><li>running： 生效中</li><li>expired： 已过期</li><li>refunded： 已退款</li><li>nearExpire： 即将到期</li></ul>
                     ...
                     * 
                     */
                    bool GetCertServiceShareEnabled() const;
                     ...
                     * 
                     */
                    void SetCertServiceShareEnabled(const bool& _certServiceShareEnabled);

                    /**
                     * 判断参数 CertServiceShareEnabled 是否已赋值
                     * @return CertServiceShareEnabled 是否已赋值
                     * 
                     */
                    bool CertServiceShareEnabledHasBeenSet() const;

                    /**
                     * 获取<p>当前订阅服务下已经签发未过期的证书数量</p>
                     * @return CertServiceValidCertificateCount <p>当前订阅服务下已经签发未过期的证书数量</p>
                     * 
                     */
                    int64_t GetCertServiceValidCertificateCount() const;

                    /**
                     * 设置<p>当前订阅服务下已经签发未过期的证书数量</p>
                     * @param _certServiceValidCertificateCount <p>当前订阅服务下已经签发未过期的证书数量</p>
                     * 
                     */
                    void SetCertServiceValidCertificateCount(const int64_t& _certServiceValidCertificateCount);

                    /**
                     * 判断参数 CertServiceValidCertificateCount 是否已赋值
                     * @return CertServiceValidCertificateCount 是否已赋值
                     * 
                     */
                    bool CertServiceValidCertificateCountHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * <p>是否开启订阅服务共享</p>
                     */
                    bool m_certServiceShareEnabled;
                    bool m_certServiceShareEnabledHasBeenSet;

                    /**
                     * <p>当前订阅服务下已经签发未过期的证书数量</p>
                     */
                    int64_t m_certServiceValidCertificateCount;
                    bool m_certServiceValidCertificateCountHasBeenSet;
