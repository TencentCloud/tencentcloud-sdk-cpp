...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostApiGatewayInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostApiGatewayInstanceListRequest();
                    ~DescribeHostApiGatewayInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTREQUEST_H_
