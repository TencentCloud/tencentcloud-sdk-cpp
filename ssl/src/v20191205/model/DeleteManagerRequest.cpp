...
string DeleteManagerRequest::ToJsonString() const
{
...
int64_t DeleteManagerRequest::GetManagerId() const
{
    return m_managerId;
}

void DeleteManagerRequest::SetManagerId(const int64_t& _managerId)
{
    m_managerId = _managerId;
    m_managerIdHasBeenSet = true;
}

bool DeleteManagerRequest::ManagerIdHasBeenSet() const
{
