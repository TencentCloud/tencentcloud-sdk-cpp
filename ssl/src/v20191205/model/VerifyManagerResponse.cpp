...
CoreInternalOutcome VerifyManagerResponse::Deserialize(const string &payload)
{
...
string VerifyManagerResponse::ToJsonString() const
{
...
int64_t VerifyManagerResponse::GetManagerId() const
{
    return m_managerId;
}

bool VerifyManagerResponse::ManagerIdHasBeenSet() const
{
