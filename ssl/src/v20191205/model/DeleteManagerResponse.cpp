...
CoreInternalOutcome DeleteManagerResponse::Deserialize(const string &payload)
{
...
string DeleteManagerResponse::ToJsonString() const
{
...
int64_t DeleteManagerResponse::GetManagerId() const
{
    return m_managerId;
}

bool DeleteManagerResponse::ManagerIdHasBeenSet() const
{
