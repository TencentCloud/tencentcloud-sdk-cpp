...
CoreInternalOutcome DescribeHostCdnInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostCdnInstanceListResponse::ToJsonString() const
{
...
vector<CdnInstanceDetail> DescribeHostCdnInstanceListResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeHostCdnInstanceListResponse::InstanceListHasBeenSet() const
{
    return m_instanceListHasBeenSet;
}

uint64_t DescribeHostCdnInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}
