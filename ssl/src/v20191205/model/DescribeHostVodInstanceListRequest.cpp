...
string DescribeHostVodInstanceListRequest::ToJsonString() const
{
...
string DescribeHostVodInstanceListRequest::GetCertificateId() const
{
    return m_certificateId;
}

void DescribeHostVodInstanceListRequest::SetCertificateId(const string& _certificateId)
{
    m_certificateId = _certificateId;
    m_certificateIdHasBeenSet = true;
}

bool DescribeHostVodInstanceListRequest::CertificateIdHasBeenSet() const
{
...
void DescribeHostVodInstanceListRequest::SetIsCache(const uint64_t& _isCache)
{
    m_isCache = _isCache;
    m_isCacheHasBeenSet = true;
}

bool DescribeHostVodInstanceListRequest::IsCacheHasBeenSet() const
{
    return m_isCacheHasBeenSet;
}

vector<Filter> DescribeHostVodInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeHostVodInstanceListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
...
void DescribeHostVodInstanceListRequest::SetOldCertificateId(const string& _oldCertificateId)
{
    m_oldCertificateId = _oldCertificateId;
    m_oldCertificateIdHasBeenSet = true;
}

bool DescribeHostVodInstanceListRequest::OldCertificateIdHasBeenSet() const
{
