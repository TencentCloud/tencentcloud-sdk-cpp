...
DescribeHostWafInstanceListResponse::DescribeHostWafInstanceListResponse() :
    m_instanceListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeHostWafInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostWafInstanceListResponse::ToJsonString() const
{
...
bool DescribeHostWafInstanceListResponse::InstanceListHasBeenSet() const
{
