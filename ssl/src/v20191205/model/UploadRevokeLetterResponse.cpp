...
CoreInternalOutcome UploadRevokeLetterResponse::Deserialize(const string &payload)
{
...
string UploadRevokeLetterResponse::ToJsonString() const
{
...
string UploadRevokeLetterResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool UploadRevokeLetterResponse::CertificateIdHasBeenSet() const
{
    return m_certificateIdHasBeenSet;
}

bool UploadRevokeLetterResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool UploadRevokeLetterResponse::IsSuccessHasBeenSet() const
{
