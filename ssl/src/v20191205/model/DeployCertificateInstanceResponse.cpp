...
DeployCertificateInstanceResponse::DeployCertificateInstanceResponse() :
    m_deployRecordIdHasBeenSet(false),
    m_deployStatusHasBeenSet(false)
{
}

CoreInternalOutcome DeployCertificateInstanceResponse::Deserialize(const string &payload)
{
...
string DeployCertificateInstanceResponse::ToJsonString() const
{
...
uint64_t DeployCertificateInstanceResponse::GetDeployRecordId() const
{
    return m_deployRecordId;
}

bool DeployCertificateInstanceResponse::DeployRecordIdHasBeenSet() const
{
    return m_deployRecordIdHasBeenSet;
}

int64_t DeployCertificateInstanceResponse::GetDeployStatus() const
{
    return m_deployStatus;
}

bool DeployCertificateInstanceResponse::DeployStatusHasBeenSet() const
{
