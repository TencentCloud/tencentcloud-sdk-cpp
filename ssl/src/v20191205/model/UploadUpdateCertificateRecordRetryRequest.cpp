...
string UploadUpdateCertificateRecordRetryRequest::ToJsonString() const
{
...
int64_t UploadUpdateCertificateRecordRetryRequest::GetDeployRecordId() const
{
    return m_deployRecordId;
}

void UploadUpdateCertificateRecordRetryRequest::SetDeployRecordId(const int64_t& _deployRecordId)
{
    m_deployRecordId = _deployRecordId;
    m_deployRecordIdHasBeenSet = true;
}

bool UploadUpdateCertificateRecordRetryRequest::DeployRecordIdHasBeenSet() const
{
    return m_deployRecordIdHasBeenSet;
}

int64_t UploadUpdateCertificateRecordRetryRequest::GetDeployRecordDetailId() const
{
    return m_deployRecordDetailId;
}

void UploadUpdateCertificateRecordRetryRequest::SetDeployRecordDetailId(const int64_t& _deployRecordDetailId)
{
    m_deployRecordDetailId = _deployRecordDetailId;
    m_deployRecordDetailIdHasBeenSet = true;
}

bool UploadUpdateCertificateRecordRetryRequest::DeployRecordDetailIdHasBeenSet() const
{
