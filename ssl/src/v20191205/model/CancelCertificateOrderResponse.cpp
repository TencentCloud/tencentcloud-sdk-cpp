...
CoreInternalOutcome CancelCertificateOrderResponse::Deserialize(const string &payload)
{
...
string CancelCertificateOrderResponse::ToJsonString() const
{
...
string CancelCertificateOrderResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool CancelCertificateOrderResponse::CertificateIdHasBeenSet() const
{
