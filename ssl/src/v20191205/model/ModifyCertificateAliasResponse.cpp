...
CoreInternalOutcome ModifyCertificateAliasResponse::Deserialize(const string &payload)
{
...
string ModifyCertificateAliasResponse::ToJsonString() const
{
...
string ModifyCertificateAliasResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool ModifyCertificateAliasResponse::CertificateIdHasBeenSet() const
{
