...
CoreInternalOutcome ModifyCertificateResubmitResponse::Deserialize(const string &payload)
{
...
string ModifyCertificateResubmitResponse::ToJsonString() const
{
...
string ModifyCertificateResubmitResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool ModifyCertificateResubmitResponse::CertificateIdHasBeenSet() const
{
