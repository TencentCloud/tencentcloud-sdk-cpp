...
DescribeHostClbInstanceListResponse::DescribeHostClbInstanceListResponse() :
...
CoreInternalOutcome DescribeHostClbInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostClbInstanceListResponse::ToJsonString() const
{
...
uint64_t DescribeHostClbInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHostClbInstanceListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ClbInstanceDetail> DescribeHostClbInstanceListResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeHostClbInstanceListResponse::InstanceListHasBeenSet() const
{
    return m_instanceListHasBeenSet;
}

int64_t DescribeHostClbInstanceListResponse::GetAsyncTotalNum() const
{
    return m_asyncTotalNum;
}

bool DescribeHostClbInstanceListResponse::AsyncTotalNumHasBeenSet() const
{
    return m_asyncTotalNumHasBeenSet;
}

int64_t DescribeHostClbInstanceListResponse::GetAsyncOffset() const
{
    return m_asyncOffset;
}

bool DescribeHostClbInstanceListResponse::AsyncOffsetHasBeenSet() const
{
    return m_asyncOffsetHasBeenSet;
}

string DescribeHostClbInstanceListResponse::GetAsyncCacheTime() const
{
    return m_asyncCacheTime;
}

bool DescribeHostClbInstanceListResponse::AsyncCacheTimeHasBeenSet() const
{
