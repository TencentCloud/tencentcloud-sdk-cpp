...
string SubmitAuditManagerRequest::ToJsonString() const
{
...
int64_t SubmitAuditManagerRequest::GetManagerId() const
{
    return m_managerId;
}

void SubmitAuditManagerRequest::SetManagerId(const int64_t& _managerId)
{
    m_managerId = _managerId;
    m_managerIdHasBeenSet = true;
}

bool SubmitAuditManagerRequest::ManagerIdHasBeenSet() const
{
