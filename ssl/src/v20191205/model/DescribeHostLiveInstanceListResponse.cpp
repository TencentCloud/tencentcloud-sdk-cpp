...
DescribeHostLiveInstanceListResponse::DescribeHostLiveInstanceListResponse() :
    m_instanceListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeHostLiveInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostLiveInstanceListResponse::ToJsonString() const
{
...
vector<LiveInstanceDetail> DescribeHostLiveInstanceListResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeHostLiveInstanceListResponse::InstanceListHasBeenSet() const
{
