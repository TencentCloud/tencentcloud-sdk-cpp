...
string UpdateCertificateRecordRollbackRequest::ToJsonString() const
{
...
int64_t UpdateCertificateRecordRollbackRequest::GetDeployRecordId() const
{
    return m_deployRecordId;
}

void UpdateCertificateRecordRollbackRequest::SetDeployRecordId(const int64_t& _deployRecordId)
{
    m_deployRecordId = _deployRecordId;
    m_deployRecordIdHasBeenSet = true;
}

bool UpdateCertificateRecordRollbackRequest::DeployRecordIdHasBeenSet() const
{
