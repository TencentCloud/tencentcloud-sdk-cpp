...
CreateCertificateByPackageResponse::CreateCertificateByPackageResponse() :
    m_certificateIdHasBeenSet(false),
    m_certificateIdsHasBeenSet(false)
{
}

CoreInternalOutcome CreateCertificateByPackageResponse::Deserialize(const string &payload)
{
...
string CreateCertificateByPackageResponse::ToJsonString() const
{
...
string CreateCertificateByPackageResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool CreateCertificateByPackageResponse::CertificateIdHasBeenSet() const
{
    return m_certificateIdHasBeenSet;
}

vector<string> CreateCertificateByPackageResponse::GetCertificateIds() const
{
    return m_certificateIds;
}

bool CreateCertificateByPackageResponse::CertificateIdsHasBeenSet() const
{
