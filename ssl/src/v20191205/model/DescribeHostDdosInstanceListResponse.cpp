...
CoreInternalOutcome DescribeHostDdosInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostDdosInstanceListResponse::ToJsonString() const
{
...
vector<DdosInstanceDetail> DescribeHostDdosInstanceListResponse::GetInstanceList() const
{
