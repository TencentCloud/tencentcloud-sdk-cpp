...
CoreInternalOutcome SubmitAuditManagerResponse::Deserialize(const string &payload)
{
...
string SubmitAuditManagerResponse::ToJsonString() const
{
...
int64_t SubmitAuditManagerResponse::GetManagerId() const
{
    return m_managerId;
}

bool SubmitAuditManagerResponse::ManagerIdHasBeenSet() const
{
