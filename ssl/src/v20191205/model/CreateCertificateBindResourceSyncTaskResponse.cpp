...
CoreInternalOutcome CreateCertificateBindResourceSyncTaskResponse::Deserialize(const string &payload)
{
...
string CreateCertificateBindResourceSyncTaskResponse::ToJsonString() const
{
...
vector<CertTaskId> CreateCertificateBindResourceSyncTaskResponse::GetCertTaskIds() const
{
    return m_certTaskIds;
}

bool CreateCertificateBindResourceSyncTaskResponse::CertTaskIdsHasBeenSet() const
{
