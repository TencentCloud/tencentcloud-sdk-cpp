...
CoreInternalOutcome ApplyCertificateResponse::Deserialize(const string &payload)
{
...
string ApplyCertificateResponse::ToJsonString() const
{
...
string ApplyCertificateResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool ApplyCertificateResponse::CertificateIdHasBeenSet() const
{
