...
CoreInternalOutcome ModifyCertificatesExpiringNotificationSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyCertificatesExpiringNotificationSwitchResponse::ToJsonString() const
{
...
vector<string> ModifyCertificatesExpiringNotificationSwitchResponse::GetCertificateIds() const
{
    return m_certificateIds;
}

bool ModifyCertificatesExpiringNotificationSwitchResponse::CertificateIdsHasBeenSet() const
{
