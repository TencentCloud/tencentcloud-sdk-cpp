...
CoreInternalOutcome DescribeHostTeoInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeHostTeoInstanceListResponse::ToJsonString() const
{
...
vector<TeoInstanceDetail> DescribeHostTeoInstanceListResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeHostTeoInstanceListResponse::InstanceListHasBeenSet() const
{
    return m_instanceListHasBeenSet;
}

int64_t DescribeHostTeoInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeHostTeoInstanceListResponse::TotalCountHasBeenSet() const
{
