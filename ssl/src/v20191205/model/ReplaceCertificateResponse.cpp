...
CoreInternalOutcome ReplaceCertificateResponse::Deserialize(const string &payload)
{
...
string ReplaceCertificateResponse::ToJsonString() const
{
...
string ReplaceCertificateResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool ReplaceCertificateResponse::CertificateIdHasBeenSet() const
{
