...
CoreInternalOutcome UpdateCertificateInstanceResponse::Deserialize(const string &payload)
{
...
string UpdateCertificateInstanceResponse::ToJsonString() const
{
...
uint64_t UpdateCertificateInstanceResponse::GetDeployRecordId() const
{
    return m_deployRecordId;
}

bool UpdateCertificateInstanceResponse::DeployRecordIdHasBeenSet() const
{
    return m_deployRecordIdHasBeenSet;
}

int64_t UpdateCertificateInstanceResponse::GetDeployStatus() const
{
