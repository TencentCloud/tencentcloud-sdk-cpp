...
CheckCertificateExistResponse::CheckCertificateExistResponse() :
    m_repeatCertIdHasBeenSet(false)
{
}

CoreInternalOutcome CheckCertificateExistResponse::Deserialize(const string &payload)
{
...
string CheckCertificateExistResponse::ToJsonString() const
{
...
string CheckCertificateExistResponse::GetRepeatCertId() const
{
    return m_repeatCertId;
}

bool CheckCertificateExistResponse::RepeatCertIdHasBeenSet() const
{
