...
CoreInternalOutcome SubmitCertificateInformationResponse::Deserialize(const string &payload)
{
...
string SubmitCertificateInformationResponse::ToJsonString() const
{
...
string SubmitCertificateInformationResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool SubmitCertificateInformationResponse::CertificateIdHasBeenSet() const
{
