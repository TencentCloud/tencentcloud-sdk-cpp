...
string DescribeHostLiveInstanceListRequest::ToJsonString() const
{
...
string DescribeHostLiveInstanceListRequest::GetCertificateId() const
{
    return m_certificateId;
}

void DescribeHostLiveInstanceListRequest::SetCertificateId(const string& _certificateId)
{
    m_certificateId = _certificateId;
    m_certificateIdHasBeenSet = true;
}

bool DescribeHostLiveInstanceListRequest::CertificateIdHasBeenSet() const
{
...
void DescribeHostLiveInstanceListRequest::SetIsCache(const uint64_t& _isCache)
{
    m_isCache = _isCache;
    m_isCacheHasBeenSet = true;
}

bool DescribeHostLiveInstanceListRequest::IsCacheHasBeenSet() const
{
    return m_isCacheHasBeenSet;
}

vector<Filter> DescribeHostLiveInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeHostLiveInstanceListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
...
void DescribeHostLiveInstanceListRequest::SetOldCertificateId(const string& _oldCertificateId)
{
    m_oldCertificateId = _oldCertificateId;
    m_oldCertificateIdHasBeenSet = true;
}

bool DescribeHostLiveInstanceListRequest::OldCertificateIdHasBeenSet() const
{
