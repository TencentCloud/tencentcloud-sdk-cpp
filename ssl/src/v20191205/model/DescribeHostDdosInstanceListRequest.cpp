...
string DescribeHostDdosInstanceListRequest::ToJsonString() const
{
...
string DescribeHostDdosInstanceListRequest::GetCertificateId() const
{
    return m_certificateId;
}

void DescribeHostDdosInstanceListRequest::SetCertificateId(const string& _certificateId)
{
...
void DescribeHostDdosInstanceListRequest::SetIsCache(const uint64_t& _isCache)
{
    m_isCache = _isCache;
    m_isCacheHasBeenSet = true;
}

bool DescribeHostDdosInstanceListRequest::IsCacheHasBeenSet() const
{
    return m_isCacheHasBeenSet;
}

vector<Filter> DescribeHostDdosInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeHostDdosInstanceListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeHostDdosInstanceListRequest::FiltersHasBeenSet() const
{
...
void DescribeHostDdosInstanceListRequest::SetOldCertificateId(const string& _oldCertificateId)
{
