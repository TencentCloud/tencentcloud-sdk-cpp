...
#ifndef TENCENTCLOUD_AME_V20190916_MODEL_PUTMUSICONTHESHELVESRESPONSE_H_
#define TENCENTCLOUD_AME_V20190916_MODEL_PUTMUSICONTHESHELVESRESPONSE_H_
    ...
    namespace Ame
    {
        namespace V20190916
        {
            namespace Model
            {
                ...
                */
                class PutMusicOnTheShelvesResponse : public AbstractModel
                {
                public:
                    PutMusicOnTheShelvesResponse();
                    ~PutMusicOnTheShelvesResponse() = default;
...
#endif // !TENCENTCLOUD_AME_V20190916_MODEL_PUTMUSICONTHESHELVESRESPONSE_H_
