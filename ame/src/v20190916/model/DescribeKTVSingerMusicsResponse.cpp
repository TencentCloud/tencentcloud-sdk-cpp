...
CoreInternalOutcome DescribeKTVSingerMusicsResponse::Deserialize(const string &payload)
{
...
string DescribeKTVSingerMusicsResponse::ToJsonString() const
{
...
int64_t DescribeKTVSingerMusicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeKTVSingerMusicsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<KTVMusicBaseInfo> DescribeKTVSingerMusicsResponse::GetKTVMusicInfoSet() const
{
    return m_kTVMusicInfoSet;
}

bool DescribeKTVSingerMusicsResponse::KTVMusicInfoSetHasBeenSet() const
{
