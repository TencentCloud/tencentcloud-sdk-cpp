...
CoreInternalOutcome SearchKTVMusicsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("KTVMusicInfoSet") && !rsp["KTVMusicInfoSet"].IsNull())
    {
        if (!rsp["KTVMusicInfoSet"].IsArray())
            return CoreInternalOutcome(Error("response `KTVMusicInfoSet` is not array type"));
...
string SearchKTVMusicsResponse::ToJsonString() const
{
...
int64_t SearchKTVMusicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SearchKTVMusicsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<KTVMusicBaseInfo> SearchKTVMusicsResponse::GetKTVMusicInfoSet() const
{
    return m_kTVMusicInfoSet;
}

bool SearchKTVMusicsResponse::KTVMusicInfoSetHasBeenSet() const
{
