...
string DescribeMusicRequest::ToJsonString() const
{
    ...
    if (m_identityIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_identityId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_subItemTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_subItemType.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_sslHasBeenSet)
    {
        ...
        string key = "Ssl";
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_ssl.c_str(), allocator).Move(), allocator);
    }
