...
CoreInternalOutcome DescribeItemByIdResponse::Deserialize(const string &payload)
{
...
string DescribeItemByIdResponse::ToJsonString() const
{
...
vector<Item> DescribeItemByIdResponse::GetItems() const
{
    return m_items;
}

bool DescribeItemByIdResponse::ItemsHasBeenSet() const
{
