...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_LISTREJECTEDQUESTIONPREVIEWREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_LISTREJECTEDQUESTIONPREVIEWREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class ListRejectedQuestionPreviewRequest : public AbstractModel
                {
                public:
                    ListRejectedQuestionPreviewRequest();
                    ~ListRejectedQuestionPreviewRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_LISTREJECTEDQUESTIONPREVIEWREQUEST_H_
