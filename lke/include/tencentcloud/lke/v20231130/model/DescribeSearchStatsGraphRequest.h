...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESEARCHSTATSGRAPHREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESEARCHSTATSGRAPHREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class DescribeSearchStatsGraphRequest : public AbstractModel
                {
                public:
                    DescribeSearchStatsGraphRequest();
                    ~DescribeSearchStatsGraphRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESEARCHSTATSGRAPHREQUEST_H_
