...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_REFERSHAREKNOWLEDGEREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_REFERSHAREKNOWLEDGEREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class ReferShareKnowledgeRequest : public AbstractModel
                {
                public:
                    ReferShareKnowledgeRequest();
                    ~ReferShareKnowledgeRequest() = default;
                     ...
                     * 
                     */
                    std::vector<std::string> GetKnowledgeBizId() const;
                     ...
                     * 
                     */
                    void SetKnowledgeBizId(const std::vector<std::string>& _knowledgeBizId);
                ...
                private:
                     ...
                     * 共享知识库业务id列表
                     */
                    std::vector<std::string> m_knowledgeBizId;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_REFERSHAREKNOWLEDGEREQUEST_H_
