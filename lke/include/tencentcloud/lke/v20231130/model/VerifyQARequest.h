...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_VERIFYQAREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_VERIFYQAREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * VerifyQA请求参数结构体
                */
                class VerifyQARequest : public AbstractModel
                {
                public:
                    VerifyQARequest();
                    ~VerifyQARequest() = default;
                     ...
                     * 
                     */
                    std::vector<QAList> GetList() const;
                     ...
                     * 
                     */
                    void SetList(const std::vector<QAList>& _list);
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_VERIFYQAREQUEST_H_
