...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESHAREDKNOWLEDGEREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESHAREDKNOWLEDGEREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class DescribeSharedKnowledgeRequest : public AbstractModel
                {
                public:
                    DescribeSharedKnowledgeRequest();
                    ~DescribeSharedKnowledgeRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBESHAREDKNOWLEDGEREQUEST_H_
