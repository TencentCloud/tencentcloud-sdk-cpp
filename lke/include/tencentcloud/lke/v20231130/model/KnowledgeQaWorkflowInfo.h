...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_KNOWLEDGEQAWORKFLOWINFO_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_KNOWLEDGEQAWORKFLOWINFO_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * 应用配置关联的工作流信息
                */
                class KnowledgeQaWorkflowInfo : public AbstractModel
                {
                public:
                    KnowledgeQaWorkflowInfo();
                    ~KnowledgeQaWorkflowInfo() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_KNOWLEDGEQAWORKFLOWINFO_H_
