...
CoreInternalOutcome GetEmbeddingResponse::Deserialize(const string &payload)
{
...
string GetEmbeddingResponse::ToJsonString() const
{
...
vector<EmbeddingObject> GetEmbeddingResponse::GetData() const
{
    return m_data;
}
