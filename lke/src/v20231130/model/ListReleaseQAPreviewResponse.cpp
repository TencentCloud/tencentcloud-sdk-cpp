...
CoreInternalOutcome ListReleaseQAPreviewResponse::Deserialize(const string &payload)
{
...
string ListReleaseQAPreviewResponse::ToJsonString() const
{
...
string ListReleaseQAPreviewResponse::GetTotal() const
{
    return m_total;
}

bool ListReleaseQAPreviewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ReleaseQA> ListReleaseQAPreviewResponse::GetList() const
{
    return m_list;
}

bool ListReleaseQAPreviewResponse::ListHasBeenSet() const
{
