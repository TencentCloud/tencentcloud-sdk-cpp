...
string DeleteQARequest::ToJsonString() const
{
...
string DeleteQARequest::GetBotBizId() const
{
    return m_botBizId;
}

void DeleteQARequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool DeleteQARequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

vector<string> DeleteQARequest::GetQaBizIds() const
{
    return m_qaBizIds;
}

void DeleteQARequest::SetQaBizIds(const vector<string>& _qaBizIds)
{
    m_qaBizIds = _qaBizIds;
    m_qaBizIdsHasBeenSet = true;
}

bool DeleteQARequest::QaBizIdsHasBeenSet() const
{
