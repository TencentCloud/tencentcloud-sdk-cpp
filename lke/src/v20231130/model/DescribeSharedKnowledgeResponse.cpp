...
DescribeSharedKnowledgeResponse::DescribeSharedKnowledgeResponse() :
    m_infoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSharedKnowledgeResponse::Deserialize(const string &payload)
{
...
string DescribeSharedKnowledgeResponse::ToJsonString() const
{
...
KnowledgeDetailInfo DescribeSharedKnowledgeResponse::GetInfo() const
{
    return m_info;
}

bool DescribeSharedKnowledgeResponse::InfoHasBeenSet() const
{
