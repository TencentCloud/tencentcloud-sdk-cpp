...
string GenerateQARequest::ToJsonString() const
{
...
string GenerateQARequest::GetBotBizId() const
{
    return m_botBizId;
}

void GenerateQARequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool GenerateQARequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

vector<string> GenerateQARequest::GetDocBizIds() const
{
    return m_docBizIds;
}

void GenerateQARequest::SetDocBizIds(const vector<string>& _docBizIds)
{
    m_docBizIds = _docBizIds;
    m_docBizIdsHasBeenSet = true;
}

bool GenerateQARequest::DocBizIdsHasBeenSet() const
{
