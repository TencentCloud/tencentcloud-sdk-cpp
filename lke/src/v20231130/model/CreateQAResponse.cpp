...
CoreInternalOutcome CreateQAResponse::Deserialize(const string &payload)
{
...
string CreateQAResponse::ToJsonString() const
{
...
string CreateQAResponse::GetQaBizId() const
{
    return m_qaBizId;
}

bool CreateQAResponse::QaBizIdHasBeenSet() const
{
