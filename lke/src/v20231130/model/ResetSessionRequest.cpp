...
string ResetSessionRequest::ToJsonString() const
{
...
string ResetSessionRequest::GetSessionId() const
{
    return m_sessionId;
}

void ResetSessionRequest::SetSessionId(const string& _sessionId)
{
