...
string CreateDocCateRequest::ToJsonString() const
{
...
string CreateDocCateRequest::GetBotBizId() const
{
    return m_botBizId;
}

void CreateDocCateRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool CreateDocCateRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string CreateDocCateRequest::GetParentBizId() const
{
    return m_parentBizId;
}

void CreateDocCateRequest::SetParentBizId(const string& _parentBizId)
{
    m_parentBizId = _parentBizId;
    m_parentBizIdHasBeenSet = true;
}

bool CreateDocCateRequest::ParentBizIdHasBeenSet() const
{
    return m_parentBizIdHasBeenSet;
}

string CreateDocCateRequest::GetName() const
{
    return m_name;
}

void CreateDocCateRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool CreateDocCateRequest::NameHasBeenSet() const
{
