...
string ModifyQACateRequest::ToJsonString() const
{
...
string ModifyQACateRequest::GetBotBizId() const
{
    return m_botBizId;
}

void ModifyQACateRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool ModifyQACateRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string ModifyQACateRequest::GetName() const
{
    return m_name;
}

void ModifyQACateRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool ModifyQACateRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string ModifyQACateRequest::GetCateBizId() const
{
    return m_cateBizId;
}

void ModifyQACateRequest::SetCateBizId(const string& _cateBizId)
{
    m_cateBizId = _cateBizId;
    m_cateBizIdHasBeenSet = true;
}

bool ModifyQACateRequest::CateBizIdHasBeenSet() const
{
