...
CoreInternalOutcome ListUsageCallDetailResponse::Deserialize(const string &payload)
{
...
string ListUsageCallDetailResponse::ToJsonString() const
{
...
uint64_t ListUsageCallDetailResponse::GetTotal() const
{
    return m_total;
}

bool ListUsageCallDetailResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<CallDetail> ListUsageCallDetailResponse::GetList() const
{
    return m_list;
}

bool ListUsageCallDetailResponse::ListHasBeenSet() const
{
