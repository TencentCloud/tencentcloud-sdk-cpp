...
CoreInternalOutcome ListAppKnowledgeDetailResponse::Deserialize(const string &payload)
{
...
string ListAppKnowledgeDetailResponse::ToJsonString() const
{
...
uint64_t ListAppKnowledgeDetailResponse::GetTotal() const
{
    return m_total;
}

bool ListAppKnowledgeDetailResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<KnowledgeDetail> ListAppKnowledgeDetailResponse::GetList() const
{
    return m_list;
}

bool ListAppKnowledgeDetailResponse::ListHasBeenSet() const
{
