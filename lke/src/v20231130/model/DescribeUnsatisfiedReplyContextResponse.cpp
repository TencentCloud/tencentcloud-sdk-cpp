...
CoreInternalOutcome DescribeUnsatisfiedReplyContextResponse::Deserialize(const string &payload)
{
...
string DescribeUnsatisfiedReplyContextResponse::ToJsonString() const
{
...
vector<Context> DescribeUnsatisfiedReplyContextResponse::GetList() const
{
    return m_list;
}

bool DescribeUnsatisfiedReplyContextResponse::ListHasBeenSet() const
{
