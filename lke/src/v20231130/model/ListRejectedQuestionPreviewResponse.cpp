...
CoreInternalOutcome ListRejectedQuestionPreviewResponse::Deserialize(const string &payload)
{
...
string ListRejectedQuestionPreviewResponse::ToJsonString() const
{
...
string ListRejectedQuestionPreviewResponse::GetTotal() const
{
    return m_total;
}

bool ListRejectedQuestionPreviewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ReleaseRejectedQuestion> ListRejectedQuestionPreviewResponse::GetList() const
{
    return m_list;
}

bool ListRejectedQuestionPreviewResponse::ListHasBeenSet() const
{
