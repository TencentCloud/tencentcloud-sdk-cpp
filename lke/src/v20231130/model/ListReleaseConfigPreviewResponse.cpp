...
CoreInternalOutcome ListReleaseConfigPreviewResponse::Deserialize(const string &payload)
{
...
string ListReleaseConfigPreviewResponse::ToJsonString() const
{
...
string ListReleaseConfigPreviewResponse::GetTotal() const
{
    return m_total;
}

bool ListReleaseConfigPreviewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ReleaseConfigs> ListReleaseConfigPreviewResponse::GetList() const
{
    return m_list;
}

bool ListReleaseConfigPreviewResponse::ListHasBeenSet() const
{
