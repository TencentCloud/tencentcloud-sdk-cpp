...
CoreInternalOutcome QueryRewriteResponse::Deserialize(const string &payload)
{
...
string QueryRewriteResponse::ToJsonString() const
{
...
string QueryRewriteResponse::GetContent() const
{
    return m_content;
}
