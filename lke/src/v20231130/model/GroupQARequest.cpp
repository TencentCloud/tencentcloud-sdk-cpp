...
string GroupQARequest::ToJsonString() const
{
...
string GroupQARequest::GetBotBizId() const
{
    return m_botBizId;
}

void GroupQARequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool GroupQARequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

vector<string> GroupQARequest::GetQaBizIds() const
{
    return m_qaBizIds;
}

void GroupQARequest::SetQaBizIds(const vector<string>& _qaBizIds)
{
    m_qaBizIds = _qaBizIds;
    m_qaBizIdsHasBeenSet = true;
}

bool GroupQARequest::QaBizIdsHasBeenSet() const
{
    return m_qaBizIdsHasBeenSet;
}

string GroupQARequest::GetCateBizId() const
{
    return m_cateBizId;
}

void GroupQARequest::SetCateBizId(const string& _cateBizId)
{
    m_cateBizId = _cateBizId;
    m_cateBizIdHasBeenSet = true;
}

bool GroupQARequest::CateBizIdHasBeenSet() const
{
