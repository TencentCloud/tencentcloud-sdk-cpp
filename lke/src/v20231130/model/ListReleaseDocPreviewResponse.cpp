...
CoreInternalOutcome ListReleaseDocPreviewResponse::Deserialize(const string &payload)
{
...
string ListReleaseDocPreviewResponse::ToJsonString() const
{
...
string ListReleaseDocPreviewResponse::GetTotal() const
{
    return m_total;
}

bool ListReleaseDocPreviewResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ReleaseDoc> ListReleaseDocPreviewResponse::GetList() const
{
    return m_list;
}

bool ListReleaseDocPreviewResponse::ListHasBeenSet() const
{
