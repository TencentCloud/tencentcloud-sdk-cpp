...
CoreInternalOutcome ListQACateResponse::Deserialize(const string &payload)
{
...
string ListQACateResponse::ToJsonString() const
{
...
vector<QACate> ListQACateResponse::GetList() const
{
    return m_list;
}

bool ListQACateResponse::ListHasBeenSet() const
{
