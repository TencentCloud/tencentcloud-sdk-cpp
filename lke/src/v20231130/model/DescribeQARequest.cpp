...
string DescribeQARequest::GetQaBizId() const
{
    return m_qaBizId;
}

void DescribeQARequest::SetQaBizId(const string& _qaBizId)
{
    m_qaBizId = _qaBizId;
    m_qaBizIdHasBeenSet = true;
}

bool DescribeQARequest::QaBizIdHasBeenSet() const
{
    return m_qaBizIdHasBeenSet;
}

string DescribeQARequest::GetBotBizId() const
{
    return m_botBizId;
}

void DescribeQARequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool DescribeQARequest::BotBizIdHasBeenSet() const
{
