...
string StopDocParseRequest::ToJsonString() const
{
...
string StopDocParseRequest::GetBotBizId() const
{
    return m_botBizId;
}

void StopDocParseRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool StopDocParseRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string StopDocParseRequest::GetDocBizId() const
{
    return m_docBizId;
}

void StopDocParseRequest::SetDocBizId(const string& _docBizId)
{
    m_docBizId = _docBizId;
    m_docBizIdHasBeenSet = true;
}

bool StopDocParseRequest::DocBizIdHasBeenSet() const
{
