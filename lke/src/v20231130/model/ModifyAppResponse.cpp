...
CoreInternalOutcome ModifyAppResponse::Deserialize(const string &payload)
{
...
string ModifyAppResponse::ToJsonString() const
{
...
string ModifyAppResponse::GetAppBizId() const
{
    return m_appBizId;
}

bool ModifyAppResponse::AppBizIdHasBeenSet() const
{
    return m_appBizIdHasBeenSet;
}

string ModifyAppResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool ModifyAppResponse::UpdateTimeHasBeenSet() const
{
