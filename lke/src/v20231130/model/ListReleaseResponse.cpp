...
CoreInternalOutcome ListReleaseResponse::Deserialize(const string &payload)
{
...
string ListReleaseResponse::ToJsonString() const
{
...
string ListReleaseResponse::GetTotal() const
{
    return m_total;
}

bool ListReleaseResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ListReleaseItem> ListReleaseResponse::GetList() const
{
    return m_list;
}

bool ListReleaseResponse::ListHasBeenSet() const
{
