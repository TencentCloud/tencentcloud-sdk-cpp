...
string CreateAgentRequest::GetAppBizId() const
{
    return m_appBizId;
}

void CreateAgentRequest::SetAppBizId(const string& _appBizId)
{
    m_appBizId = _appBizId;
    m_appBizIdHasBeenSet = true;
}

bool CreateAgentRequest::AppBizIdHasBeenSet() const
{
    return m_appBizIdHasBeenSet;
}

Agent CreateAgentRequest::GetAgent() const
{
    return m_agent;
}

void CreateAgentRequest::SetAgent(const Agent& _agent)
{
    m_agent = _agent;
