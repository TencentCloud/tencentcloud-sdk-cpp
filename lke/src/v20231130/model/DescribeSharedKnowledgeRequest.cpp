...
DescribeSharedKnowledgeRequest::DescribeSharedKnowledgeRequest() :
    m_knowledgeBizIdHasBeenSet(false)
{
}

string DescribeSharedKnowledgeRequest::ToJsonString() const
{
...
string DescribeSharedKnowledgeRequest::GetKnowledgeBizId() const
{
    return m_knowledgeBizId;
}

void DescribeSharedKnowledgeRequest::SetKnowledgeBizId(const string& _knowledgeBizId)
{
    m_knowledgeBizId = _knowledgeBizId;
    m_knowledgeBizIdHasBeenSet = true;
}

bool DescribeSharedKnowledgeRequest::KnowledgeBizIdHasBeenSet() const
{
