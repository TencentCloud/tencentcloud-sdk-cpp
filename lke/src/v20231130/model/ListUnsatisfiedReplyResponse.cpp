...
CoreInternalOutcome ListUnsatisfiedReplyResponse::Deserialize(const string &payload)
{
...
string ListUnsatisfiedReplyResponse::ToJsonString() const
{
...
string ListUnsatisfiedReplyResponse::GetTotal() const
{
    return m_total;
}

bool ListUnsatisfiedReplyResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<UnsatisfiedReply> ListUnsatisfiedReplyResponse::GetList() const
{
    return m_list;
}

bool ListUnsatisfiedReplyResponse::ListHasBeenSet() const
{
