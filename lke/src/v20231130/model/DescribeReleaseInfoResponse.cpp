...
CoreInternalOutcome DescribeReleaseInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("LastTime") && !rsp["LastTime"].IsNull())
    {
        if (!rsp["LastTime"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `LastTime` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_lastTime = string(rsp["LastTime"].GetString());
...
string DescribeReleaseInfoResponse::ToJsonString() const
{
...
string DescribeReleaseInfoResponse::GetLastTime() const
{
    return m_lastTime;
}

bool DescribeReleaseInfoResponse::LastTimeHasBeenSet() const
{
    return m_lastTimeHasBeenSet;
}

int64_t DescribeReleaseInfoResponse::GetStatus() const
{
    return m_status;
}

bool DescribeReleaseInfoResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

bool DescribeReleaseInfoResponse::GetIsUpdated() const
{
    return m_isUpdated;
}

bool DescribeReleaseInfoResponse::IsUpdatedHasBeenSet() const
{
    return m_isUpdatedHasBeenSet;
}

string DescribeReleaseInfoResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeReleaseInfoResponse::MsgHasBeenSet() const
{
