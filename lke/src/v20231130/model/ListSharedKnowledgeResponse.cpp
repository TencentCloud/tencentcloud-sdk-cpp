...
ListSharedKnowledgeResponse::ListSharedKnowledgeResponse() :
    m_totalHasBeenSet(false),
    m_knowledgeListHasBeenSet(false)
{
}

CoreInternalOutcome ListSharedKnowledgeResponse::Deserialize(const string &payload)
{
...
string ListSharedKnowledgeResponse::ToJsonString() const
{
...
uint64_t ListSharedKnowledgeResponse::GetTotal() const
{
    return m_total;
}

bool ListSharedKnowledgeResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<KnowledgeDetailInfo> ListSharedKnowledgeResponse::GetKnowledgeList() const
{
    return m_knowledgeList;
}

bool ListSharedKnowledgeResponse::KnowledgeListHasBeenSet() const
{
