...
string RetryReleaseRequest::GetBotBizId() const
{
    return m_botBizId;
}

void RetryReleaseRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool RetryReleaseRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string RetryReleaseRequest::GetReleaseBizId() const
{
    return m_releaseBizId;
}

void RetryReleaseRequest::SetReleaseBizId(const string& _releaseBizId)
{
    m_releaseBizId = _releaseBizId;
    m_releaseBizIdHasBeenSet = true;
}

bool RetryReleaseRequest::ReleaseBizIdHasBeenSet() const
{
