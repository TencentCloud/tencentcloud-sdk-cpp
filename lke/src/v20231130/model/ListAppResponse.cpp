...
CoreInternalOutcome ListAppResponse::Deserialize(const string &payload)
{
...
string ListAppResponse::ToJsonString() const
{
...
string ListAppResponse::GetTotal() const
{
    return m_total;
}

bool ListAppResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AppInfo> ListAppResponse::GetList() const
{
    return m_list;
}

bool ListAppResponse::ListHasBeenSet() const
{
