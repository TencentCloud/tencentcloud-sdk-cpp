...
CoreInternalOutcome ListModelResponse::Deserialize(const string &payload)
{
...
string ListModelResponse::ToJsonString() const
{
...
vector<ModelInfo> ListModelResponse::GetList() const
{
    return m_list;
}

bool ListModelResponse::ListHasBeenSet() const
{
