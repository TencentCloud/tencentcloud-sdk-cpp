...
CoreInternalOutcome SaveDocResponse::Deserialize(const string &payload)
{
...
string SaveDocResponse::ToJsonString() const
{
...
string SaveDocResponse::GetDocBizId() const
{
    return m_docBizId;
}

bool SaveDocResponse::DocBizIdHasBeenSet() const
{
    return m_docBizIdHasBeenSet;
}

string SaveDocResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool SaveDocResponse::ErrorMsgHasBeenSet() const
{
    return m_errorMsgHasBeenSet;
}

string SaveDocResponse::GetErrorLink() const
{
    return m_errorLink;
}

bool SaveDocResponse::ErrorLinkHasBeenSet() const
{
    return m_errorLinkHasBeenSet;
}

string SaveDocResponse::GetErrorLinkText() const
{
