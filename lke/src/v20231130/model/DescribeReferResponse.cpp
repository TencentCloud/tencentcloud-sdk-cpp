...
CoreInternalOutcome DescribeReferResponse::Deserialize(const string &payload)
{
...
string DescribeReferResponse::ToJsonString() const
{
...
vector<ReferDetail> DescribeReferResponse::GetList() const
{
    return m_list;
}

bool DescribeReferResponse::ListHasBeenSet() const
{
