...
CoreInternalOutcome DescribeSearchStatsGraphResponse::Deserialize(const string &payload)
{
...
string DescribeSearchStatsGraphResponse::ToJsonString() const
{
...
vector<Stat> DescribeSearchStatsGraphResponse::GetList() const
{
    return m_list;
}

bool DescribeSearchStatsGraphResponse::ListHasBeenSet() const
{
