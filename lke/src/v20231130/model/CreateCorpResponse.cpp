...
CoreInternalOutcome CreateCorpResponse::Deserialize(const string &payload)
{
...
string CreateCorpResponse::ToJsonString() const
{
...
string CreateCorpResponse::GetCorpBizId() const
{
    return m_corpBizId;
}

bool CreateCorpResponse::CorpBizIdHasBeenSet() const
{
