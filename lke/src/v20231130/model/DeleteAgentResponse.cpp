...
CoreInternalOutcome DeleteAgentResponse::Deserialize(const string &payload)
{
...
string DeleteAgentResponse::ToJsonString() const
{
...
string DeleteAgentResponse::GetAgentId() const
{
    return m_agentId;
}

bool DeleteAgentResponse::AgentIdHasBeenSet() const
{
