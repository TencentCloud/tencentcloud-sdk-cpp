...
GetVarListResponse::GetVarListResponse() :
    m_totalHasBeenSet(false),
    m_listHasBeenSet(false)
{
}

CoreInternalOutcome GetVarListResponse::Deserialize(const string &payload)
{
...
string GetVarListResponse::ToJsonString() const
{
...
uint64_t GetVarListResponse::GetTotal() const
{
    return m_total;
}

bool GetVarListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<TaskFLowVar> GetVarListResponse::GetList() const
{
    return m_list;
}

bool GetVarListResponse::ListHasBeenSet() const
{
