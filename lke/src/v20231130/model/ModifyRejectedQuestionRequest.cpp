...
string ModifyRejectedQuestionRequest::ToJsonString() const
{
...
string ModifyRejectedQuestionRequest::GetBotBizId() const
{
    return m_botBizId;
}

void ModifyRejectedQuestionRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool ModifyRejectedQuestionRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string ModifyRejectedQuestionRequest::GetQuestion() const
{
    return m_question;
}

void ModifyRejectedQuestionRequest::SetQuestion(const string& _question)
{
    m_question = _question;
    m_questionHasBeenSet = true;
}

bool ModifyRejectedQuestionRequest::QuestionHasBeenSet() const
{
    return m_questionHasBeenSet;
}

string ModifyRejectedQuestionRequest::GetRejectedBizId() const
{
    return m_rejectedBizId;
}

void ModifyRejectedQuestionRequest::SetRejectedBizId(const string& _rejectedBizId)
{
