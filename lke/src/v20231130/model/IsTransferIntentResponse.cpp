...
CoreInternalOutcome IsTransferIntentResponse::Deserialize(const string &payload)
{
...
string IsTransferIntentResponse::ToJsonString() const
{
...
bool IsTransferIntentResponse::GetHit() const
{
    return m_hit;
}

bool IsTransferIntentResponse::HitHasBeenSet() const
{
