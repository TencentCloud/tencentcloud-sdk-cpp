...
int64_t CreateQARequest::GetEnableScope() const
{
    return m_enableScope;
}

void CreateQARequest::SetEnableScope(const int64_t& _enableScope)
{
    m_enableScope = _enableScope;
    m_enableScopeHasBeenSet = true;
}

bool CreateQARequest::EnableScopeHasBeenSet() const
{
