...
CoreInternalOutcome CreateDocCateResponse::Deserialize(const string &payload)
{
...
string CreateDocCateResponse::ToJsonString() const
{
...
bool CreateDocCateResponse::GetCanAdd() const
{
    return m_canAdd;
}

bool CreateDocCateResponse::CanAddHasBeenSet() const
{
    return m_canAddHasBeenSet;
}

bool CreateDocCateResponse::GetCanEdit() const
{
    return m_canEdit;
}

bool CreateDocCateResponse::CanEditHasBeenSet() const
{
    return m_canEditHasBeenSet;
}

bool CreateDocCateResponse::GetCanDelete() const
{
    return m_canDelete;
}

bool CreateDocCateResponse::CanDeleteHasBeenSet() const
{
    return m_canDeleteHasBeenSet;
}

string CreateDocCateResponse::GetCateBizId() const
{
    return m_cateBizId;
}

bool CreateDocCateResponse::CateBizIdHasBeenSet() const
{
