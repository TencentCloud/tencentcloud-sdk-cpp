...
string DeleteAppRequest::ToJsonString() const
{
...
string DeleteAppRequest::GetAppBizId() const
{
    return m_appBizId;
}

void DeleteAppRequest::SetAppBizId(const string& _appBizId)
{
    m_appBizId = _appBizId;
    m_appBizIdHasBeenSet = true;
}

bool DeleteAppRequest::AppBizIdHasBeenSet() const
{
    return m_appBizIdHasBeenSet;
}

string DeleteAppRequest::GetAppType() const
{
    return m_appType;
}

void DeleteAppRequest::SetAppType(const string& _appType)
{
    m_appType = _appType;
    m_appTypeHasBeenSet = true;
}

bool DeleteAppRequest::AppTypeHasBeenSet() const
{
