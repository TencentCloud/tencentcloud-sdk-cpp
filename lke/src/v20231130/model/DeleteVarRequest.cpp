...
string DeleteVarRequest::ToJsonString() const
{
...
string DeleteVarRequest::GetAppBizId() const
{
    return m_appBizId;
}

void DeleteVarRequest::SetAppBizId(const string& _appBizId)
{
    m_appBizId = _appBizId;
    m_appBizIdHasBeenSet = true;
}

bool DeleteVarRequest::AppBizIdHasBeenSet() const
{
    return m_appBizIdHasBeenSet;
}

string DeleteVarRequest::GetVarId() const
{
    return m_varId;
}

void DeleteVarRequest::SetVarId(const string& _varId)
{
    m_varId = _varId;
