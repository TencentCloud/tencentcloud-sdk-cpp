...
CoreInternalOutcome ListSelectDocResponse::Deserialize(const string &payload)
{
...
string ListSelectDocResponse::ToJsonString() const
{
...
vector<Option> ListSelectDocResponse::GetList() const
{
    return m_list;
}

bool ListSelectDocResponse::ListHasBeenSet() const
{
