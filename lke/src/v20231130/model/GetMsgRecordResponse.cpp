...
CoreInternalOutcome GetMsgRecordResponse::Deserialize(const string &payload)
{
...
string GetMsgRecordResponse::ToJsonString() const
{
...
vector<MsgRecord> GetMsgRecordResponse::GetRecords() const
{
    return m_records;
}
