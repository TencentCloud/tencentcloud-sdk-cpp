...
string DescribeNodeRunRequest::ToJsonString() const
{
    ...
    if (m_nodeRunIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, rapidjson::Value(m_nodeRunId.c_str(), allocator).Move(), allocator);
    }
...
void DescribeNodeRunRequest::SetNodeRunId(const string& _nodeRunId)
{
    m_nodeRunId = _nodeRunId;
    m_nodeRunIdHasBeenSet = true;
}

bool DescribeNodeRunRequest::NodeRunIdHasBeenSet() const
{
