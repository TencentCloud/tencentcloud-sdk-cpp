...
CoreInternalOutcome QACate::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CateBizId") && !value["CateBizId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.CateBizId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Name") && !value["Name"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.Name` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Total") && !value["Total"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.Total` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CanAdd") && !value["CanAdd"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.CanAdd` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CanEdit") && !value["CanEdit"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.CanEdit` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CanDelete") && !value["CanDelete"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `QACate.CanDelete` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Children") && !value["Children"].IsNull())
    {
        if (!value["Children"].IsArray())
            return CoreInternalOutcome(Core::Error("response `QACate.Children` is not array type"));
...
void QACate::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string QACate::GetCateBizId() const
{
    return m_cateBizId;
}

void QACate::SetCateBizId(const string& _cateBizId)
{
    m_cateBizId = _cateBizId;
    m_cateBizIdHasBeenSet = true;
}

bool QACate::CateBizIdHasBeenSet() const
{
    return m_cateBizIdHasBeenSet;
}

string QACate::GetName() const
{
    return m_name;
}

void QACate::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool QACate::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

int64_t QACate::GetTotal() const
{
    return m_total;
}

void QACate::SetTotal(const int64_t& _total)
{
    m_total = _total;
    m_totalHasBeenSet = true;
}

bool QACate::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

bool QACate::GetCanAdd() const
{
    return m_canAdd;
}

void QACate::SetCanAdd(const bool& _canAdd)
{
    m_canAdd = _canAdd;
    m_canAddHasBeenSet = true;
}

bool QACate::CanAddHasBeenSet() const
{
    return m_canAddHasBeenSet;
}

bool QACate::GetCanEdit() const
{
    return m_canEdit;
}

void QACate::SetCanEdit(const bool& _canEdit)
{
    m_canEdit = _canEdit;
    m_canEditHasBeenSet = true;
}

bool QACate::CanEditHasBeenSet() const
{
    return m_canEditHasBeenSet;
}

bool QACate::GetCanDelete() const
{
    return m_canDelete;
}

void QACate::SetCanDelete(const bool& _canDelete)
{
    m_canDelete = _canDelete;
    m_canDeleteHasBeenSet = true;
}

bool QACate::CanDeleteHasBeenSet() const
{
