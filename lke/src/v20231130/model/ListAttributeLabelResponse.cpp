...
CoreInternalOutcome ListAttributeLabelResponse::Deserialize(const string &payload)
{
...
string ListAttributeLabelResponse::ToJsonString() const
{
...
string ListAttributeLabelResponse::GetTotal() const
{
    return m_total;
}

bool ListAttributeLabelResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AttrLabelDetail> ListAttributeLabelResponse::GetList() const
{
    return m_list;
}

bool ListAttributeLabelResponse::ListHasBeenSet() const
{
