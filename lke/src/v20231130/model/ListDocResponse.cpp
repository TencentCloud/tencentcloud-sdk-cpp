...
CoreInternalOutcome ListDocResponse::Deserialize(const string &payload)
{
...
string ListDocResponse::ToJsonString() const
{
...
string ListDocResponse::GetTotal() const
{
    return m_total;
}

bool ListDocResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ListDocItem> ListDocResponse::GetList() const
{
    return m_list;
}

bool ListDocResponse::ListHasBeenSet() const
{
