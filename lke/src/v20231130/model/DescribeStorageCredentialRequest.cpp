...
string DescribeStorageCredentialRequest::ToJsonString() const
{
...
string DescribeStorageCredentialRequest::GetBotBizId() const
{
    return m_botBizId;
}

void DescribeStorageCredentialRequest::SetBotBizId(const string& _botBizId)
{
