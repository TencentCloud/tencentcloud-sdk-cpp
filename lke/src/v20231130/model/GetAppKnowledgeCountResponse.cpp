...
CoreInternalOutcome GetAppKnowledgeCountResponse::Deserialize(const string &payload)
{
...
string GetAppKnowledgeCountResponse::ToJsonString() const
{
...
string GetAppKnowledgeCountResponse::GetTotal() const
{
    return m_total;
}

bool GetAppKnowledgeCountResponse::TotalHasBeenSet() const
{
