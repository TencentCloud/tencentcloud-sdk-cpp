...
CoreInternalOutcome WorkflowInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("WorkflowRunId") && !value["WorkflowRunId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `WorkflowInfo.WorkflowRunId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OptionCards") && !value["OptionCards"].IsNull())
    {
        if (!value["OptionCards"].IsArray())
            return CoreInternalOutcome(Core::Error("response `WorkflowInfo.OptionCards` is not array type"));
    ...
    if (value.HasMember("Outputs") && !value["Outputs"].IsNull())
    {
        if (!value["Outputs"].IsArray())
            return CoreInternalOutcome(Core::Error("response `WorkflowInfo.Outputs` is not array type"));
    ...
    if (value.HasMember("WorkflowReleaseTime") && !value["WorkflowReleaseTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `WorkflowInfo.WorkflowReleaseTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string WorkflowInfo::GetWorkflowRunId() const
{
    return m_workflowRunId;
}

void WorkflowInfo::SetWorkflowRunId(const string& _workflowRunId)
{
    m_workflowRunId = _workflowRunId;
    m_workflowRunIdHasBeenSet = true;
}

bool WorkflowInfo::WorkflowRunIdHasBeenSet() const
{
    return m_workflowRunIdHasBeenSet;
}

vector<string> WorkflowInfo::GetOptionCards() const
{
    return m_optionCards;
}

void WorkflowInfo::SetOptionCards(const vector<string>& _optionCards)
{
    m_optionCards = _optionCards;
    m_optionCardsHasBeenSet = true;
}

bool WorkflowInfo::OptionCardsHasBeenSet() const
{
    return m_optionCardsHasBeenSet;
}

vector<string> WorkflowInfo::GetOutputs() const
{
    return m_outputs;
}

void WorkflowInfo::SetOutputs(const vector<string>& _outputs)
{
    m_outputs = _outputs;
    m_outputsHasBeenSet = true;
}

bool WorkflowInfo::OutputsHasBeenSet() const
{
    return m_outputsHasBeenSet;
}

string WorkflowInfo::GetWorkflowReleaseTime() const
{
    return m_workflowReleaseTime;
}

void WorkflowInfo::SetWorkflowReleaseTime(const string& _workflowReleaseTime)
{
