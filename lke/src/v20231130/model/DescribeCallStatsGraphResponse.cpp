...
CoreInternalOutcome DescribeCallStatsGraphResponse::Deserialize(const string &payload)
{
...
string DescribeCallStatsGraphResponse::ToJsonString() const
{
...
vector<Stat> DescribeCallStatsGraphResponse::GetList() const
{
    return m_list;
}

bool DescribeCallStatsGraphResponse::ListHasBeenSet() const
{
