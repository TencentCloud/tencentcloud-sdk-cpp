...
string ModifyDocCateRequest::ToJsonString() const
{
...
string ModifyDocCateRequest::GetBotBizId() const
{
    return m_botBizId;
}

void ModifyDocCateRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool ModifyDocCateRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string ModifyDocCateRequest::GetName() const
{
    return m_name;
}

void ModifyDocCateRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool ModifyDocCateRequest::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string ModifyDocCateRequest::GetCateBizId() const
{
    return m_cateBizId;
}

void ModifyDocCateRequest::SetCateBizId(const string& _cateBizId)
{
    m_cateBizId = _cateBizId;
    m_cateBizIdHasBeenSet = true;
}

bool ModifyDocCateRequest::CateBizIdHasBeenSet() const
{
