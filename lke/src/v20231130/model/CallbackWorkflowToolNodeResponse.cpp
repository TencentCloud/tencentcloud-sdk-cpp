...
CallbackWorkflowToolNodeResponse::CallbackWorkflowToolNodeResponse() :
    m_codeHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome CallbackWorkflowToolNodeResponse::Deserialize(const string &payload)
{
...
string CallbackWorkflowToolNodeResponse::ToJsonString() const
{
...
int64_t CallbackWorkflowToolNodeResponse::GetCode() const
{
    return m_code;
}

bool CallbackWorkflowToolNodeResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string CallbackWorkflowToolNodeResponse::GetMsg() const
{
    return m_msg;
}

bool CallbackWorkflowToolNodeResponse::MsgHasBeenSet() const
{
