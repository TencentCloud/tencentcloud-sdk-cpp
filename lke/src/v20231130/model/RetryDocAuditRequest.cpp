...
string RetryDocAuditRequest::ToJsonString() const
{
...
string RetryDocAuditRequest::GetBotBizId() const
{
    return m_botBizId;
}

void RetryDocAuditRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool RetryDocAuditRequest::BotBizIdHasBeenSet() const
{
    return m_botBizIdHasBeenSet;
}

string RetryDocAuditRequest::GetDocBizId() const
{
    return m_docBizId;
}

void RetryDocAuditRequest::SetDocBizId(const string& _docBizId)
{
    m_docBizId = _docBizId;
    m_docBizIdHasBeenSet = true;
}

bool RetryDocAuditRequest::DocBizIdHasBeenSet() const
{
