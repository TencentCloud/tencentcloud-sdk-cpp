...
CoreInternalOutcome DescribeSegmentsResponse::Deserialize(const string &payload)
{
...
string DescribeSegmentsResponse::ToJsonString() const
{
...
vector<DocSegment> DescribeSegmentsResponse::GetList() const
{
    return m_list;
}

bool DescribeSegmentsResponse::ListHasBeenSet() const
{
