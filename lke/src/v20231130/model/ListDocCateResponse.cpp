...
CoreInternalOutcome ListDocCateResponse::Deserialize(const string &payload)
{
...
string ListDocCateResponse::ToJsonString() const
{
...
vector<CateInfo> ListDocCateResponse::GetList() const
{
    return m_list;
}

bool ListDocCateResponse::ListHasBeenSet() const
{
