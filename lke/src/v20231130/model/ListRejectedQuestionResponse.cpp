...
CoreInternalOutcome ListRejectedQuestionResponse::Deserialize(const string &payload)
{
...
string ListRejectedQuestionResponse::ToJsonString() const
{
...
string ListRejectedQuestionResponse::GetTotal() const
{
    return m_total;
}

bool ListRejectedQuestionResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<RejectedQuestion> ListRejectedQuestionResponse::GetList() const
{
    return m_list;
}

bool ListRejectedQuestionResponse::ListHasBeenSet() const
{
