...
string DescribeReleaseInfoRequest::ToJsonString() const
{
...
string DescribeReleaseInfoRequest::GetBotBizId() const
{
    return m_botBizId;
}

void DescribeReleaseInfoRequest::SetBotBizId(const string& _botBizId)
{
    m_botBizId = _botBizId;
    m_botBizIdHasBeenSet = true;
}

bool DescribeReleaseInfoRequest::BotBizIdHasBeenSet() const
{
