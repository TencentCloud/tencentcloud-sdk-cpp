...
DeleteSharedKnowledgeRequest::DeleteSharedKnowledgeRequest() :
    m_knowledgeBizIdHasBeenSet(false)
{
}

string DeleteSharedKnowledgeRequest::ToJsonString() const
{
...
string DeleteSharedKnowledgeRequest::GetKnowledgeBizId() const
{
    return m_knowledgeBizId;
}

void DeleteSharedKnowledgeRequest::SetKnowledgeBizId(const string& _knowledgeBizId)
{
    m_knowledgeBizId = _knowledgeBizId;
    m_knowledgeBizIdHasBeenSet = true;
}

bool DeleteSharedKnowledgeRequest::KnowledgeBizIdHasBeenSet() const
{
