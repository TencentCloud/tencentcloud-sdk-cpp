...
CoreInternalOutcome ListReferShareKnowledgeResponse::Deserialize(const string &payload)
{
...
string ListReferShareKnowledgeResponse::ToJsonString() const
{
...
vector<KnowledgeBaseInfo> ListReferShareKnowledgeResponse::GetList() const
{
    return m_list;
}
