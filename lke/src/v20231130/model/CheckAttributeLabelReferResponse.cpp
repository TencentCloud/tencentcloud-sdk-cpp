...
CoreInternalOutcome CheckAttributeLabelReferResponse::Deserialize(const string &payload)
{
...
string CheckAttributeLabelReferResponse::ToJsonString() const
{
...
bool CheckAttributeLabelReferResponse::GetIsRefer() const
{
    return m_isRefer;
}
