...
string DescribeTokenUsageRequest::ToJsonString() const
{
...
vector<string> DescribeTokenUsageRequest::GetUinAccount() const
{
    return m_uinAccount;
}

void DescribeTokenUsageRequest::SetUinAccount(const vector<string>& _uinAccount)
{
    m_uinAccount = _uinAccount;
    m_uinAccountHasBeenSet = true;
}

bool DescribeTokenUsageRequest::UinAccountHasBeenSet() const
{
    return m_uinAccountHasBeenSet;
}

string DescribeTokenUsageRequest::GetLoginUin() const
{
    return m_loginUin;
}

void DescribeTokenUsageRequest::SetLoginUin(const string& _loginUin)
{
    m_loginUin = _loginUin;
    m_loginUinHasBeenSet = true;
}

bool DescribeTokenUsageRequest::LoginUinHasBeenSet() const
{
    return m_loginUinHasBeenSet;
}

string DescribeTokenUsageRequest::GetLoginSubAccountUin() const
{
    return m_loginSubAccountUin;
}

void DescribeTokenUsageRequest::SetLoginSubAccountUin(const string& _loginSubAccountUin)
{
    m_loginSubAccountUin = _loginSubAccountUin;
    m_loginSubAccountUinHasBeenSet = true;
}

bool DescribeTokenUsageRequest::LoginSubAccountUinHasBeenSet() const
{
    return m_loginSubAccountUinHasBeenSet;
}

string DescribeTokenUsageRequest::GetSubBizType() const
{
    return m_subBizType;
}

void DescribeTokenUsageRequest::SetSubBizType(const string& _subBizType)
{
    m_subBizType = _subBizType;
    m_subBizTypeHasBeenSet = true;
}

bool DescribeTokenUsageRequest::SubBizTypeHasBeenSet() const
{
    return m_subBizTypeHasBeenSet;
}

string DescribeTokenUsageRequest::GetModelName() const
{
    return m_modelName;
}

void DescribeTokenUsageRequest::SetModelName(const string& _modelName)
{
    m_modelName = _modelName;
    m_modelNameHasBeenSet = true;
}

bool DescribeTokenUsageRequest::ModelNameHasBeenSet() const
{
    return m_modelNameHasBeenSet;
}

string DescribeTokenUsageRequest::GetStartTime() const
{
    return m_startTime;
}

void DescribeTokenUsageRequest::SetStartTime(const string& _startTime)
{
    m_startTime = _startTime;
    m_startTimeHasBeenSet = true;
}

bool DescribeTokenUsageRequest::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

string DescribeTokenUsageRequest::GetEndTime() const
{
    return m_endTime;
}

void DescribeTokenUsageRequest::SetEndTime(const string& _endTime)
{
    m_endTime = _endTime;
    m_endTimeHasBeenSet = true;
}

bool DescribeTokenUsageRequest::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

vector<string> DescribeTokenUsageRequest::GetAppBizIds() const
{
    return m_appBizIds;
}

void DescribeTokenUsageRequest::SetAppBizIds(const vector<string>& _appBizIds)
{
    m_appBizIds = _appBizIds;
    m_appBizIdsHasBeenSet = true;
}

bool DescribeTokenUsageRequest::AppBizIdsHasBeenSet() const
{
    return m_appBizIdsHasBeenSet;
}

vector<string> DescribeTokenUsageRequest::GetSubScenes() const
{
    return m_subScenes;
}

void DescribeTokenUsageRequest::SetSubScenes(const vector<string>& _subScenes)
{
