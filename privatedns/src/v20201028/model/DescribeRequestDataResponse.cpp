...
CoreInternalOutcome DescribeRequestDataResponse::Deserialize(const string &payload)
{
...
string DescribeRequestDataResponse::ToJsonString() const
{
...
vector<MetricData> DescribeRequestDataResponse::GetData() const
{
    return m_data;
}

bool DescribeRequestDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string DescribeRequestDataResponse::GetInterval() const
{
    return m_interval;
}
