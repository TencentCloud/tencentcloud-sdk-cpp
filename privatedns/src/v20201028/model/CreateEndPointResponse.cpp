...
string CreateEndPointResponse::GetEndPointName() const
{
    return m_endPointName;
}

bool CreateEndPointResponse::EndPointNameHasBeenSet() const
{
    return m_endPointNameHasBeenSet;
}

string CreateEndPointResponse::GetEndPointServiceId() const
{
    return m_endPointServiceId;
}

bool CreateEndPointResponse::EndPointServiceIdHasBeenSet() const
{
    return m_endPointServiceIdHasBeenSet;
}

vector<string> CreateEndPointResponse::GetEndPointVipSet() const
{
    return m_endPointVipSet;
}

bool CreateEndPointResponse::EndPointVipSetHasBeenSet() const
{
