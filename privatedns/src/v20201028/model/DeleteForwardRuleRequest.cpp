...
vector<string> DeleteForwardRuleRequest::GetRuleIdSet() const
{
    return m_ruleIdSet;
}

void DeleteForwardRuleRequest::SetRuleIdSet(const vector<string>& _ruleIdSet)
{
    m_ruleIdSet = _ruleIdSet;
    m_ruleIdSetHasBeenSet = true;
}

bool DeleteForwardRuleRequest::RuleIdSetHasBeenSet() const
{
