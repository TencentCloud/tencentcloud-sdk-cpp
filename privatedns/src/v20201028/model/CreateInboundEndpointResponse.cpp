...
CreateInboundEndpointResponse::CreateInboundEndpointResponse() :
    m_endpointIdHasBeenSet(false),
    m_endpointNameHasBeenSet(false)
{
}

CoreInternalOutcome CreateInboundEndpointResponse::Deserialize(const string &payload)
{
...
string CreateInboundEndpointResponse::ToJsonString() const
{
...
string CreateInboundEndpointResponse::GetEndpointId() const
{
    return m_endpointId;
}

bool CreateInboundEndpointResponse::EndpointIdHasBeenSet() const
{
    return m_endpointIdHasBeenSet;
}

string CreateInboundEndpointResponse::GetEndpointName() const
{
    return m_endpointName;
}

bool CreateInboundEndpointResponse::EndpointNameHasBeenSet() const
{
