...
string DeleteSpecifyPrivateZoneVpcRequest::ToJsonString() const
{
...
string DeleteSpecifyPrivateZoneVpcRequest::GetZoneId() const
{
    return m_zoneId;
}

void DeleteSpecifyPrivateZoneVpcRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool DeleteSpecifyPrivateZoneVpcRequest::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

vector<VpcInfo> DeleteSpecifyPrivateZoneVpcRequest::GetVpcSet() const
{
    return m_vpcSet;
}

void DeleteSpecifyPrivateZoneVpcRequest::SetVpcSet(const vector<VpcInfo>& _vpcSet)
{
    m_vpcSet = _vpcSet;
    m_vpcSetHasBeenSet = true;
}

bool DeleteSpecifyPrivateZoneVpcRequest::VpcSetHasBeenSet() const
{
    return m_vpcSetHasBeenSet;
}

vector<AccountVpcInfo> DeleteSpecifyPrivateZoneVpcRequest::GetAccountVpcSet() const
{
    return m_accountVpcSet;
}

void DeleteSpecifyPrivateZoneVpcRequest::SetAccountVpcSet(const vector<AccountVpcInfo>& _accountVpcSet)
{
