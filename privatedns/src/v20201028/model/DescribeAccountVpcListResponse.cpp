...
CoreInternalOutcome DescribeAccountVpcListResponse::Deserialize(const string &payload)
{
...
string DescribeAccountVpcListResponse::ToJsonString() const
{
...
int64_t DescribeAccountVpcListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAccountVpcListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AccountVpcInfoOut> DescribeAccountVpcListResponse::GetVpcSet() const
{
    return m_vpcSet;
}

bool DescribeAccountVpcListResponse::VpcSetHasBeenSet() const
{
