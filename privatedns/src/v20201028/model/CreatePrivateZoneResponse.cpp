...
CoreInternalOutcome CreatePrivateZoneResponse::Deserialize(const string &payload)
{
...
string CreatePrivateZoneResponse::ToJsonString() const
{
...
string CreatePrivateZoneResponse::GetZoneId() const
{
    return m_zoneId;
}

bool CreatePrivateZoneResponse::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string CreatePrivateZoneResponse::GetDomain() const
{
    return m_domain;
}

bool CreatePrivateZoneResponse::DomainHasBeenSet() const
{
