...
CoreInternalOutcome DescribePrivateZoneServiceResponse::Deserialize(const string &payload)
{
...
string DescribePrivateZoneServiceResponse::ToJsonString() const
{
...
string DescribePrivateZoneServiceResponse::GetServiceStatus() const
{
    return m_serviceStatus;
}

bool DescribePrivateZoneServiceResponse::ServiceStatusHasBeenSet() const
{
