...
CoreInternalOutcome SubscribePrivateZoneServiceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ServiceStatus") && !rsp["ServiceStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `ServiceStatus` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string SubscribePrivateZoneServiceResponse::ToJsonString() const
{
...
string SubscribePrivateZoneServiceResponse::GetServiceStatus() const
{
    return m_serviceStatus;
}

bool SubscribePrivateZoneServiceResponse::ServiceStatusHasBeenSet() const
{
