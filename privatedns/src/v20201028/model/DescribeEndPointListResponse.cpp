...
CoreInternalOutcome DescribeEndPointListResponse::Deserialize(const string &payload)
{
...
string DescribeEndPointListResponse::ToJsonString() const
{
...
int64_t DescribeEndPointListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeEndPointListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EndPointInfo> DescribeEndPointListResponse::GetEndPointSet() const
{
    return m_endPointSet;
}

bool DescribeEndPointListResponse::EndPointSetHasBeenSet() const
{
