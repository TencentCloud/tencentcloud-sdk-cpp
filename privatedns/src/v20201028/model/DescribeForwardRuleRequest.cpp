...
string DescribeForwardRuleRequest::GetRuleId() const
{
    return m_ruleId;
}

void DescribeForwardRuleRequest::SetRuleId(const string& _ruleId)
{
    m_ruleId = _ruleId;
    m_ruleIdHasBeenSet = true;
}

bool DescribeForwardRuleRequest::RuleIdHasBeenSet() const
{
