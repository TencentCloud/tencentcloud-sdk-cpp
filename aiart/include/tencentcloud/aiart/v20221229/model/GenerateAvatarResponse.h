...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_GENERATEAVATARRESPONSE_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_GENERATEAVATARRESPONSE_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class GenerateAvatarResponse : public AbstractModel
                {
                public:
                    GenerateAvatarResponse();
                    ~GenerateAvatarResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>根据入参 RspImgType 填入不同，返回不同的内容。<br>如果传入 base64 则返回生成图 Base64 编码。<br>如果传入 url 则返回的生成图 URL , 有效期1小时，请及时保存。</p>
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_GENERATEAVATARRESPONSE_H_
