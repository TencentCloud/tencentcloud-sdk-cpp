...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_CHANGECLOTHESRESPONSE_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_CHANGECLOTHESRESPONSE_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class ChangeClothesResponse : public AbstractModel
                {
                public:
                    ChangeClothesResponse();
                    ~ChangeClothesResponse() = default;
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_CHANGECLOTHESRESPONSE_H_
