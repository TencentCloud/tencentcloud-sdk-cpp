...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_QUERYTEXTTOIMAGEJOBRESPONSE_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_QUERYTEXTTOIMAGEJOBRESPONSE_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class QueryTextToImageJobResponse : public AbstractModel
                {
                public:
                    QueryTextToImageJobResponse();
                    ~QueryTextToImageJobResponse() = default;
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_QUERYTEXTTOIMAGEJOBRESPONSE_H_
