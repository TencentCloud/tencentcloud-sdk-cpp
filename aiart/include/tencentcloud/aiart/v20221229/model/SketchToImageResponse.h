...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_SKETCHTOIMAGERESPONSE_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_SKETCHTOIMAGERESPONSE_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class SketchToImageResponse : public AbstractModel
                {
                public:
                    SketchToImageResponse();
                    ~SketchToImageResponse() = default;
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_SKETCHTOIMAGERESPONSE_H_
