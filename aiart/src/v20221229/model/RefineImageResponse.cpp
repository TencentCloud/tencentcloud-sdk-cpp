...
RefineImageResponse::RefineImageResponse() :
    m_resultImageHasBeenSet(false)
{
}

CoreInternalOutcome RefineImageResponse::Deserialize(const string &payload)
{
...
string RefineImageResponse::ToJsonString() const
{
...
string RefineImageResponse::GetResultImage() const
{
    return m_resultImage;
}

bool RefineImageResponse::ResultImageHasBeenSet() const
{
