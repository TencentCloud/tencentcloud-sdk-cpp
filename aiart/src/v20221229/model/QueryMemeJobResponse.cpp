...
QueryMemeJobResponse::QueryMemeJobResponse() :
...
CoreInternalOutcome QueryMemeJobResponse::Deserialize(const string &payload)
{
...
string QueryMemeJobResponse::ToJsonString() const
{
...
string QueryMemeJobResponse::GetJobStatusCode() const
{
    return m_jobStatusCode;
}

bool QueryMemeJobResponse::JobStatusCodeHasBeenSet() const
{
    return m_jobStatusCodeHasBeenSet;
}

string QueryMemeJobResponse::GetJobStatusMsg() const
{
    return m_jobStatusMsg;
}

bool QueryMemeJobResponse::JobStatusMsgHasBeenSet() const
{
    return m_jobStatusMsgHasBeenSet;
}

string QueryMemeJobResponse::GetJobErrorCode() const
{
    return m_jobErrorCode;
}

bool QueryMemeJobResponse::JobErrorCodeHasBeenSet() const
{
    return m_jobErrorCodeHasBeenSet;
}

string QueryMemeJobResponse::GetJobErrorMsg() const
{
    return m_jobErrorMsg;
}

bool QueryMemeJobResponse::JobErrorMsgHasBeenSet() const
{
    return m_jobErrorMsgHasBeenSet;
}

string QueryMemeJobResponse::GetResultImage() const
{
    return m_resultImage;
}

bool QueryMemeJobResponse::ResultImageHasBeenSet() const
{
