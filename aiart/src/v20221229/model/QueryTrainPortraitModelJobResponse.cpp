...
QueryTrainPortraitModelJobResponse::QueryTrainPortraitModelJobResponse() :
...
CoreInternalOutcome QueryTrainPortraitModelJobResponse::Deserialize(const string &payload)
{
...
string QueryTrainPortraitModelJobResponse::ToJsonString() const
{
...
string QueryTrainPortraitModelJobResponse::GetJobStatusCode() const
{
    return m_jobStatusCode;
}

bool QueryTrainPortraitModelJobResponse::JobStatusCodeHasBeenSet() const
{
    return m_jobStatusCodeHasBeenSet;
}

string QueryTrainPortraitModelJobResponse::GetJobStatusMsg() const
{
    return m_jobStatusMsg;
}

bool QueryTrainPortraitModelJobResponse::JobStatusMsgHasBeenSet() const
{
    return m_jobStatusMsgHasBeenSet;
}

string QueryTrainPortraitModelJobResponse::GetJobErrorCode() const
{
    return m_jobErrorCode;
}

bool QueryTrainPortraitModelJobResponse::JobErrorCodeHasBeenSet() const
{
    return m_jobErrorCodeHasBeenSet;
}

string QueryTrainPortraitModelJobResponse::GetJobErrorMsg() const
{
    return m_jobErrorMsg;
}

bool QueryTrainPortraitModelJobResponse::JobErrorMsgHasBeenSet() const
{
