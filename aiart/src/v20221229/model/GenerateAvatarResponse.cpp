...
GenerateAvatarResponse::GenerateAvatarResponse() :
    m_resultImageHasBeenSet(false)
{
}

CoreInternalOutcome GenerateAvatarResponse::Deserialize(const string &payload)
{
...
string GenerateAvatarResponse::ToJsonString() const
{
...
string GenerateAvatarResponse::GetResultImage() const
{
    return m_resultImage;
}

bool GenerateAvatarResponse::ResultImageHasBeenSet() const
{
