...
CoreInternalOutcome ImageToImageResponse::Deserialize(const string &payload)
{
...
string ImageToImageResponse::ToJsonString() const
{
...
string ImageToImageResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ImageToImageResponse::ResultImageHasBeenSet() const
{
