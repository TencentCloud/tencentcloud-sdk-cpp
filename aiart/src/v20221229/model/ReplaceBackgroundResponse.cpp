...
ReplaceBackgroundResponse::ReplaceBackgroundResponse() :
    m_resultImageHasBeenSet(false),
    m_maskImageHasBeenSet(false)
{
}

CoreInternalOutcome ReplaceBackgroundResponse::Deserialize(const string &payload)
{
...
string ReplaceBackgroundResponse::ToJsonString() const
{
...
string ReplaceBackgroundResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ReplaceBackgroundResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

string ReplaceBackgroundResponse::GetMaskImage() const
{
    return m_maskImage;
}

bool ReplaceBackgroundResponse::MaskImageHasBeenSet() const
{
