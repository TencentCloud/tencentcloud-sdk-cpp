...
TextToImageLiteResponse::TextToImageLiteResponse() :
    m_resultImageHasBeenSet(false),
    m_seedHasBeenSet(false)
{
}

CoreInternalOutcome TextToImageLiteResponse::Deserialize(const string &payload)
{
...
string TextToImageLiteResponse::ToJsonString() const
{
...
string TextToImageLiteResponse::GetResultImage() const
{
    return m_resultImage;
}

bool TextToImageLiteResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

int64_t TextToImageLiteResponse::GetSeed() const
{
    return m_seed;
}

bool TextToImageLiteResponse::SeedHasBeenSet() const
{
