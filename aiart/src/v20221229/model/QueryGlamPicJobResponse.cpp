...
QueryGlamPicJobResponse::QueryGlamPicJobResponse() :
...
CoreInternalOutcome QueryGlamPicJobResponse::Deserialize(const string &payload)
{
...
string QueryGlamPicJobResponse::ToJsonString() const
{
...
string QueryGlamPicJobResponse::GetJobStatusCode() const
{
    return m_jobStatusCode;
}

bool QueryGlamPicJobResponse::JobStatusCodeHasBeenSet() const
{
    return m_jobStatusCodeHasBeenSet;
}

string QueryGlamPicJobResponse::GetJobStatusMsg() const
{
    return m_jobStatusMsg;
}

bool QueryGlamPicJobResponse::JobStatusMsgHasBeenSet() const
{
    return m_jobStatusMsgHasBeenSet;
}

string QueryGlamPicJobResponse::GetJobErrorCode() const
{
    return m_jobErrorCode;
}

bool QueryGlamPicJobResponse::JobErrorCodeHasBeenSet() const
{
    return m_jobErrorCodeHasBeenSet;
}

string QueryGlamPicJobResponse::GetJobErrorMsg() const
{
    return m_jobErrorMsg;
}

bool QueryGlamPicJobResponse::JobErrorMsgHasBeenSet() const
{
    return m_jobErrorMsgHasBeenSet;
}

vector<string> QueryGlamPicJobResponse::GetResultImage() const
{
    return m_resultImage;
}

bool QueryGlamPicJobResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

vector<string> QueryGlamPicJobResponse::GetResultDetails() const
{
    return m_resultDetails;
}

bool QueryGlamPicJobResponse::ResultDetailsHasBeenSet() const
{
