...
SubmitTextToImageProJobResponse::SubmitTextToImageProJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitTextToImageProJobResponse::Deserialize(const string &payload)
{
...
string SubmitTextToImageProJobResponse::ToJsonString() const
{
...
string SubmitTextToImageProJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitTextToImageProJobResponse::JobIdHasBeenSet() const
{
