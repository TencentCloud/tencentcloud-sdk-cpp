...
ImageOutpaintingResponse::ImageOutpaintingResponse() :
    m_resultImageHasBeenSet(false)
{
}

CoreInternalOutcome ImageOutpaintingResponse::Deserialize(const string &payload)
{
...
string ImageOutpaintingResponse::ToJsonString() const
{
...
string ImageOutpaintingResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ImageOutpaintingResponse::ResultImageHasBeenSet() const
{
