...
UploadTrainPortraitImagesResponse::UploadTrainPortraitImagesResponse() :
    m_resultDetailsHasBeenSet(false)
{
}

CoreInternalOutcome UploadTrainPortraitImagesResponse::Deserialize(const string &payload)
{
...
string UploadTrainPortraitImagesResponse::ToJsonString() const
{
...
vector<string> UploadTrainPortraitImagesResponse::GetResultDetails() const
{
    return m_resultDetails;
}

bool UploadTrainPortraitImagesResponse::ResultDetailsHasBeenSet() const
{
