...
SubmitDrawPortraitJobResponse::SubmitDrawPortraitJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitDrawPortraitJobResponse::Deserialize(const string &payload)
{
...
string SubmitDrawPortraitJobResponse::ToJsonString() const
{
...
string SubmitDrawPortraitJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitDrawPortraitJobResponse::JobIdHasBeenSet() const
{
