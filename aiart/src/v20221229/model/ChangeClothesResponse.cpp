...
CoreInternalOutcome ChangeClothesResponse::Deserialize(const string &payload)
{
...
string ChangeClothesResponse::ToJsonString() const
{
...
string ChangeClothesResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ChangeClothesResponse::ResultImageHasBeenSet() const
{
