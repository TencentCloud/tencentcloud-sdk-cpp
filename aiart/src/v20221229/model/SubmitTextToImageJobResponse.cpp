...
SubmitTextToImageJobResponse::SubmitTextToImageJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitTextToImageJobResponse::Deserialize(const string &payload)
{
...
string SubmitTextToImageJobResponse::ToJsonString() const
{
...
string SubmitTextToImageJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitTextToImageJobResponse::JobIdHasBeenSet() const
{
