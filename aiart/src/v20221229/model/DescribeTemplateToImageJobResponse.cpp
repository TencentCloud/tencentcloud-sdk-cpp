...
DescribeTemplateToImageJobResponse::DescribeTemplateToImageJobResponse() :
...
CoreInternalOutcome DescribeTemplateToImageJobResponse::Deserialize(const string &payload)
{
...
string DescribeTemplateToImageJobResponse::ToJsonString() const
{
...
string DescribeTemplateToImageJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeTemplateToImageJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeTemplateToImageJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeTemplateToImageJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeTemplateToImageJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeTemplateToImageJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<string> DescribeTemplateToImageJobResponse::GetResultImage() const
{
    return m_resultImage;
}

bool DescribeTemplateToImageJobResponse::ResultImageHasBeenSet() const
{
