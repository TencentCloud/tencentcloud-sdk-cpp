...
QueryTextToImageJobResponse::QueryTextToImageJobResponse() :
...
CoreInternalOutcome QueryTextToImageJobResponse::Deserialize(const string &payload)
{
...
string QueryTextToImageJobResponse::ToJsonString() const
{
...
string QueryTextToImageJobResponse::GetJobStatusCode() const
{
    return m_jobStatusCode;
}

bool QueryTextToImageJobResponse::JobStatusCodeHasBeenSet() const
{
    return m_jobStatusCodeHasBeenSet;
}

string QueryTextToImageJobResponse::GetJobStatusMsg() const
{
    return m_jobStatusMsg;
}

bool QueryTextToImageJobResponse::JobStatusMsgHasBeenSet() const
{
    return m_jobStatusMsgHasBeenSet;
}

string QueryTextToImageJobResponse::GetJobErrorCode() const
{
    return m_jobErrorCode;
}

bool QueryTextToImageJobResponse::JobErrorCodeHasBeenSet() const
{
    return m_jobErrorCodeHasBeenSet;
}

string QueryTextToImageJobResponse::GetJobErrorMsg() const
{
    return m_jobErrorMsg;
}

bool QueryTextToImageJobResponse::JobErrorMsgHasBeenSet() const
{
    return m_jobErrorMsgHasBeenSet;
}

vector<string> QueryTextToImageJobResponse::GetResultImage() const
{
    return m_resultImage;
}

bool QueryTextToImageJobResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

vector<string> QueryTextToImageJobResponse::GetResultDetails() const
{
    return m_resultDetails;
}

bool QueryTextToImageJobResponse::ResultDetailsHasBeenSet() const
{
    return m_resultDetailsHasBeenSet;
}

vector<string> QueryTextToImageJobResponse::GetRevisedPrompt() const
{
    return m_revisedPrompt;
}

bool QueryTextToImageJobResponse::RevisedPromptHasBeenSet() const
{
