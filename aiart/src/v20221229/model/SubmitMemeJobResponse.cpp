...
SubmitMemeJobResponse::SubmitMemeJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitMemeJobResponse::Deserialize(const string &payload)
{
...
string SubmitMemeJobResponse::ToJsonString() const
{
...
string SubmitMemeJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitMemeJobResponse::JobIdHasBeenSet() const
{
