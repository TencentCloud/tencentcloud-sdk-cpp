...
QueryTextToImageProJobResponse::QueryTextToImageProJobResponse() :
...
CoreInternalOutcome QueryTextToImageProJobResponse::Deserialize(const string &payload)
{
...
string QueryTextToImageProJobResponse::ToJsonString() const
{
...
string QueryTextToImageProJobResponse::GetJobStatusCode() const
{
    return m_jobStatusCode;
}

bool QueryTextToImageProJobResponse::JobStatusCodeHasBeenSet() const
{
    return m_jobStatusCodeHasBeenSet;
}

string QueryTextToImageProJobResponse::GetJobStatusMsg() const
{
    return m_jobStatusMsg;
}

bool QueryTextToImageProJobResponse::JobStatusMsgHasBeenSet() const
{
    return m_jobStatusMsgHasBeenSet;
}

string QueryTextToImageProJobResponse::GetJobErrorCode() const
{
    return m_jobErrorCode;
}

bool QueryTextToImageProJobResponse::JobErrorCodeHasBeenSet() const
{
    return m_jobErrorCodeHasBeenSet;
}

string QueryTextToImageProJobResponse::GetJobErrorMsg() const
{
    return m_jobErrorMsg;
}

bool QueryTextToImageProJobResponse::JobErrorMsgHasBeenSet() const
{
    return m_jobErrorMsgHasBeenSet;
}

vector<string> QueryTextToImageProJobResponse::GetResultImage() const
{
    return m_resultImage;
}

bool QueryTextToImageProJobResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

vector<string> QueryTextToImageProJobResponse::GetResultDetails() const
{
