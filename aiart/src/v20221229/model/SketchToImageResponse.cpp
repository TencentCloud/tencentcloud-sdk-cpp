...
SketchToImageResponse::SketchToImageResponse() :
    m_resultImageHasBeenSet(false)
{
}

CoreInternalOutcome SketchToImageResponse::Deserialize(const string &payload)
{
...
string SketchToImageResponse::ToJsonString() const
{
...
string SketchToImageResponse::GetResultImage() const
{
    return m_resultImage;
}

bool SketchToImageResponse::ResultImageHasBeenSet() const
{
