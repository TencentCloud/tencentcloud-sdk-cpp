...
ImageInpaintingRemovalResponse::ImageInpaintingRemovalResponse() :
    m_resultImageHasBeenSet(false)
{
}

CoreInternalOutcome ImageInpaintingRemovalResponse::Deserialize(const string &payload)
{
...
string ImageInpaintingRemovalResponse::ToJsonString() const
{
...
string ImageInpaintingRemovalResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ImageInpaintingRemovalResponse::ResultImageHasBeenSet() const
{
