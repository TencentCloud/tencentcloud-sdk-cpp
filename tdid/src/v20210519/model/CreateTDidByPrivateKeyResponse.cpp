...
CoreInternalOutcome CreateTDidByPrivateKeyResponse::Deserialize(const string &payload)
{
...
string CreateTDidByPrivateKeyResponse::ToJsonString() const
{
...
string CreateTDidByPrivateKeyResponse::GetDid() const
{
    return m_did;
}

bool CreateTDidByPrivateKeyResponse::DidHasBeenSet() const
{
