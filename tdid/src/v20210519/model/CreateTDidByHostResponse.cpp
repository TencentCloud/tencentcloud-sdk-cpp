...
CreateTDidByHostResponse::CreateTDidByHostResponse() :
    m_didHasBeenSet(false),
    m_transactionHasBeenSet(false)
{
}

CoreInternalOutcome CreateTDidByHostResponse::Deserialize(const string &payload)
{
...
string CreateTDidByHostResponse::ToJsonString() const
{
...
string CreateTDidByHostResponse::GetDid() const
{
    return m_did;
}

bool CreateTDidByHostResponse::DidHasBeenSet() const
{
    return m_didHasBeenSet;
}

ChainTransaction CreateTDidByHostResponse::GetTransaction() const
{
    return m_transaction;
}

bool CreateTDidByHostResponse::TransactionHasBeenSet() const
{
