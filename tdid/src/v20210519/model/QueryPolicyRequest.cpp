...
string QueryPolicyRequest::ToJsonString() const
{
...
int64_t QueryPolicyRequest::GetPolicyIndex() const
{
    return m_policyIndex;
}

void QueryPolicyRequest::SetPolicyIndex(const int64_t& _policyIndex)
{
    m_policyIndex = _policyIndex;
    m_policyIndexHasBeenSet = true;
}

bool QueryPolicyRequest::PolicyIndexHasBeenSet() const
{
