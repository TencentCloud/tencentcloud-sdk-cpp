...
string GetDeployInfoRequest::ToJsonString() const
{
...
string GetDeployInfoRequest::GetHash() const
{
    return m_hash;
}

void GetDeployInfoRequest::SetHash(const string& _hash)
{
    m_hash = _hash;
    m_hashHasBeenSet = true;
}

bool GetDeployInfoRequest::HashHasBeenSet() const
{
