...
CoreInternalOutcome CheckDidDeployResponse::Deserialize(const string &payload)
{
...
string CheckDidDeployResponse::ToJsonString() const
{
...
Task CheckDidDeployResponse::GetTask() const
{
    return m_task;
}

bool CheckDidDeployResponse::TaskHasBeenSet() const
{
