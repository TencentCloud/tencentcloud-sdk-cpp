...
CoreInternalOutcome VerifyCredentialsResponse::Deserialize(const string &payload)
{
...
string VerifyCredentialsResponse::ToJsonString() const
{
...
bool VerifyCredentialsResponse::GetResult() const
{
    return m_result;
}

bool VerifyCredentialsResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

uint64_t VerifyCredentialsResponse::GetVerifyCode() const
{
    return m_verifyCode;
}

bool VerifyCredentialsResponse::VerifyCodeHasBeenSet() const
{
    return m_verifyCodeHasBeenSet;
}

string VerifyCredentialsResponse::GetVerifyMessage() const
{
    return m_verifyMessage;
}

bool VerifyCredentialsResponse::VerifyMessageHasBeenSet() const
{
