...
VerifyPresentationResponse::VerifyPresentationResponse() :
...
CoreInternalOutcome VerifyPresentationResponse::Deserialize(const string &payload)
{
...
string VerifyPresentationResponse::ToJsonString() const
{
...
bool VerifyPresentationResponse::GetResult() const
{
    return m_result;
}

bool VerifyPresentationResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

uint64_t VerifyPresentationResponse::GetVerifyCode() const
{
    return m_verifyCode;
}

bool VerifyPresentationResponse::VerifyCodeHasBeenSet() const
{
    return m_verifyCodeHasBeenSet;
}

string VerifyPresentationResponse::GetVerifyMessage() const
{
    return m_verifyMessage;
}

bool VerifyPresentationResponse::VerifyMessageHasBeenSet() const
{
