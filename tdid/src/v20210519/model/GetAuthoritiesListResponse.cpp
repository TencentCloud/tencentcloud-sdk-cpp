...
CoreInternalOutcome GetAuthoritiesListResponse::Deserialize(const string &payload)
{
...
string GetAuthoritiesListResponse::ToJsonString() const
{
...
vector<Authority> GetAuthoritiesListResponse::GetResultList() const
{
    return m_resultList;
}

bool GetAuthoritiesListResponse::ResultListHasBeenSet() const
{
    return m_resultListHasBeenSet;
}

int64_t GetAuthoritiesListResponse::GetAllCount() const
{
    return m_allCount;
}

bool GetAuthoritiesListResponse::AllCountHasBeenSet() const
{
