...
GetTDidByObjectIdResponse::GetTDidByObjectIdResponse() :
    m_didHasBeenSet(false)
{
}

CoreInternalOutcome GetTDidByObjectIdResponse::Deserialize(const string &payload)
{
...
string GetTDidByObjectIdResponse::ToJsonString() const
{
...
string GetTDidByObjectIdResponse::GetDid() const
{
    return m_did;
}

bool GetTDidByObjectIdResponse::DidHasBeenSet() const
{
