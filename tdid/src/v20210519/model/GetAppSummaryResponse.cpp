...
GetAppSummaryResponse::GetAppSummaryResponse() :
    m_appCounterHasBeenSet(false),
    m_userCounterHasBeenSet(false)
{
}

CoreInternalOutcome GetAppSummaryResponse::Deserialize(const string &payload)
{
...
string GetAppSummaryResponse::ToJsonString() const
{
...
ResourceCounterData GetAppSummaryResponse::GetAppCounter() const
{
    return m_appCounter;
}

bool GetAppSummaryResponse::AppCounterHasBeenSet() const
{
    return m_appCounterHasBeenSet;
}

ResourceCounterData GetAppSummaryResponse::GetUserCounter() const
{
    return m_userCounter;
}

bool GetAppSummaryResponse::UserCounterHasBeenSet() const
{
