...
SetTDidAttributeResponse::SetTDidAttributeResponse() :
    m_transactionHasBeenSet(false)
{
}

CoreInternalOutcome SetTDidAttributeResponse::Deserialize(const string &payload)
{
...
string SetTDidAttributeResponse::ToJsonString() const
{
...
ChainTransaction SetTDidAttributeResponse::GetTransaction() const
{
    return m_transaction;
}

bool SetTDidAttributeResponse::TransactionHasBeenSet() const
{
