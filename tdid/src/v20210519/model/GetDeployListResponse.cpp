...
CoreInternalOutcome GetDeployListResponse::Deserialize(const string &payload)
{
...
string GetDeployListResponse::ToJsonString() const
{
...
uint64_t GetDeployListResponse::GetAllCount() const
{
    return m_allCount;
}

bool GetDeployListResponse::AllCountHasBeenSet() const
{
    return m_allCountHasBeenSet;
}

vector<Contract> GetDeployListResponse::GetResult() const
{
    return m_result;
}

bool GetDeployListResponse::ResultHasBeenSet() const
{
