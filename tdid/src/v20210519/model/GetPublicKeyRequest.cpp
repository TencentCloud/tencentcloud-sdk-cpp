...
string GetPublicKeyRequest::ToJsonString() const
{
...
string GetPublicKeyRequest::GetDid() const
{
    return m_did;
}

void GetPublicKeyRequest::SetDid(const string& _did)
{
    m_did = _did;
    m_didHasBeenSet = true;
}

bool GetPublicKeyRequest::DidHasBeenSet() const
{
