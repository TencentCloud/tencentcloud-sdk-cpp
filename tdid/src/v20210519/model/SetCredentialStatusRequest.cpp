...
string SetCredentialStatusRequest::ToJsonString() const
{
...
CredentialStatus SetCredentialStatusRequest::GetCredentialStatus() const
{
    return m_credentialStatus;
}

void SetCredentialStatusRequest::SetCredentialStatus(const CredentialStatus& _credentialStatus)
{
    m_credentialStatus = _credentialStatus;
    m_credentialStatusHasBeenSet = true;
}

bool SetCredentialStatusRequest::CredentialStatusHasBeenSet() const
{
