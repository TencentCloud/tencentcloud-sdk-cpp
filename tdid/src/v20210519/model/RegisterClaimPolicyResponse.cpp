...
CoreInternalOutcome RegisterClaimPolicyResponse::Deserialize(const string &payload)
{
...
string RegisterClaimPolicyResponse::ToJsonString() const
{
...
uint64_t RegisterClaimPolicyResponse::GetId() const
{
    return m_id;
}

bool RegisterClaimPolicyResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

uint64_t RegisterClaimPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool RegisterClaimPolicyResponse::PolicyIdHasBeenSet() const
{
