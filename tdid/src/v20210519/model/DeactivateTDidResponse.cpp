...
DeactivateTDidResponse::DeactivateTDidResponse() :
    m_transactionHasBeenSet(false)
{
}

CoreInternalOutcome DeactivateTDidResponse::Deserialize(const string &payload)
{
...
string DeactivateTDidResponse::ToJsonString() const
{
...
ChainTransaction DeactivateTDidResponse::GetTransaction() const
{
    return m_transaction;
}

bool DeactivateTDidResponse::TransactionHasBeenSet() const
{
