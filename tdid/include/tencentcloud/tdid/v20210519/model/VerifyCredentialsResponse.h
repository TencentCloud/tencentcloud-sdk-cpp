...
#ifndef TENCENTCLOUD_TDID_V20210519_MODEL_VERIFYCREDENTIALSRESPONSE_H_
#define TENCENTCLOUD_TDID_V20210519_MODEL_VERIFYCREDENTIALSRESPONSE_H_
    ...
    namespace Tdid
    {
        namespace V20210519
        {
            namespace Model
            {
                ...
                */
                class VerifyCredentialsResponse : public AbstractModel
                {
                public:
                    VerifyCredentialsResponse();
                    ~VerifyCredentialsResponse() = default;
...
#endif // !TENCENTCLOUD_TDID_V20210519_MODEL_VERIFYCREDENTIALSRESPONSE_H_
