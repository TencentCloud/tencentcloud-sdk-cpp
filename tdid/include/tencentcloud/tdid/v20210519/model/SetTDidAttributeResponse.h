...
#ifndef TENCENTCLOUD_TDID_V20210519_MODEL_SETTDIDATTRIBUTERESPONSE_H_
#define TENCENTCLOUD_TDID_V20210519_MODEL_SETTDIDATTRIBUTERESPONSE_H_
    ...
    namespace Tdid
    {
        namespace V20210519
        {
            namespace Model
            {
                ...
                */
                class SetTDidAttributeResponse : public AbstractModel
                {
                public:
                    SetTDidAttributeResponse();
                    ~SetTDidAttributeResponse() = default;
...
#endif // !TENCENTCLOUD_TDID_V20210519_MODEL_SETTDIDATTRIBUTERESPONSE_H_
