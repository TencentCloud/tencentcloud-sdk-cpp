...
uint64_t DescribeClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<Cluster> DescribeClustersResponse::GetClusters() const
{
    return m_clusters;
}

bool DescribeClustersResponse::ClustersHasBeenSet() const
{
