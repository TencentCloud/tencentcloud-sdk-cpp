...
CoreInternalOutcome StopAutoScalingInstancesResponse::Deserialize(const string &payload)
{
...
string StopAutoScalingInstancesResponse::ToJsonString() const
{
...
string StopAutoScalingInstancesResponse::GetActivityId() const
{
    return m_activityId;
}

bool StopAutoScalingInstancesResponse::ActivityIdHasBeenSet() const
{
