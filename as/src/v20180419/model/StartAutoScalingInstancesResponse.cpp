...
CoreInternalOutcome StartAutoScalingInstancesResponse::Deserialize(const string &payload)
{
...
string StartAutoScalingInstancesResponse::ToJsonString() const
{
...
string StartAutoScalingInstancesResponse::GetActivityId() const
{
    return m_activityId;
}

bool StartAutoScalingInstancesResponse::ActivityIdHasBeenSet() const
{
