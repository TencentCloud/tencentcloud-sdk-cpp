...
string DeleteAutoScalingGroupRequest::ToJsonString() const
{
...
string DeleteAutoScalingGroupRequest::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

void DeleteAutoScalingGroupRequest::SetAutoScalingGroupId(const string& _autoScalingGroupId)
{
    m_autoScalingGroupId = _autoScalingGroupId;
    m_autoScalingGroupIdHasBeenSet = true;
}

bool DeleteAutoScalingGroupRequest::AutoScalingGroupIdHasBeenSet() const
{
