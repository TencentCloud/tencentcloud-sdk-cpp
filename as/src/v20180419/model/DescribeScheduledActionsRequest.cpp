...
vector<Filter> DescribeScheduledActionsRequest::GetFilters() const
{
    return m_filters;
}

void DescribeScheduledActionsRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeScheduledActionsRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

uint64_t DescribeScheduledActionsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeScheduledActionsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeScheduledActionsRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeScheduledActionsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeScheduledActionsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeScheduledActionsRequest::LimitHasBeenSet() const
{
