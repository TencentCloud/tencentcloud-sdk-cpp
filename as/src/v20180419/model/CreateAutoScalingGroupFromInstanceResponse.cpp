...
CoreInternalOutcome CreateAutoScalingGroupFromInstanceResponse::Deserialize(const string &payload)
{
...
string CreateAutoScalingGroupFromInstanceResponse::ToJsonString() const
{
...
string CreateAutoScalingGroupFromInstanceResponse::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

bool CreateAutoScalingGroupFromInstanceResponse::AutoScalingGroupIdHasBeenSet() const
{
