...
CoreInternalOutcome CreateAutoScalingGroupResponse::Deserialize(const string &payload)
{
...
string CreateAutoScalingGroupResponse::ToJsonString() const
{
...
string CreateAutoScalingGroupResponse::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

bool CreateAutoScalingGroupResponse::AutoScalingGroupIdHasBeenSet() const
{
