...
string StartInstanceRefreshRequest::ToJsonString() const
{
...
string StartInstanceRefreshRequest::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

void StartInstanceRefreshRequest::SetAutoScalingGroupId(const string& _autoScalingGroupId)
{
    m_autoScalingGroupId = _autoScalingGroupId;
    m_autoScalingGroupIdHasBeenSet = true;
}

bool StartInstanceRefreshRequest::AutoScalingGroupIdHasBeenSet() const
{
    return m_autoScalingGroupIdHasBeenSet;
}

RefreshSettings StartInstanceRefreshRequest::GetRefreshSettings() const
{
    return m_refreshSettings;
}

void StartInstanceRefreshRequest::SetRefreshSettings(const RefreshSettings& _refreshSettings)
{
    m_refreshSettings = _refreshSettings;
    m_refreshSettingsHasBeenSet = true;
}

bool StartInstanceRefreshRequest::RefreshSettingsHasBeenSet() const
{
    return m_refreshSettingsHasBeenSet;
}

string StartInstanceRefreshRequest::GetRefreshMode() const
{
    return m_refreshMode;
}

void StartInstanceRefreshRequest::SetRefreshMode(const string& _refreshMode)
{
    m_refreshMode = _refreshMode;
    m_refreshModeHasBeenSet = true;
}

bool StartInstanceRefreshRequest::RefreshModeHasBeenSet() const
{
