...
string InstanceTag::GetKey() const
{
    return m_key;
}

void InstanceTag::SetKey(const string& _key)
{
    m_key = _key;
    m_keyHasBeenSet = true;
}

bool InstanceTag::KeyHasBeenSet() const
{
    return m_keyHasBeenSet;
}

string InstanceTag::GetValue() const
{
    return m_value;
}

void InstanceTag::SetValue(const string& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool InstanceTag::ValueHasBeenSet() const
{
