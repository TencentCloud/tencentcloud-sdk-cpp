...
CoreInternalOutcome ExecuteScalingPolicyResponse::Deserialize(const string &payload)
{
...
string ExecuteScalingPolicyResponse::ToJsonString() const
{
...
string ExecuteScalingPolicyResponse::GetActivityId() const
{
    return m_activityId;
}

bool ExecuteScalingPolicyResponse::ActivityIdHasBeenSet() const
{
