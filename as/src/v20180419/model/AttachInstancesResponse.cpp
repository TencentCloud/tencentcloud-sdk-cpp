...
CoreInternalOutcome AttachInstancesResponse::Deserialize(const string &payload)
{
...
string AttachInstancesResponse::ToJsonString() const
{
...
string AttachInstancesResponse::GetActivityId() const
{
    return m_activityId;
}

bool AttachInstancesResponse::ActivityIdHasBeenSet() const
{
