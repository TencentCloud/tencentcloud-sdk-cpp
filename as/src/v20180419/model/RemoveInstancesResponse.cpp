...
CoreInternalOutcome RemoveInstancesResponse::Deserialize(const string &payload)
{
...
string RemoveInstancesResponse::ToJsonString() const
{
...
string RemoveInstancesResponse::GetActivityId() const
{
    return m_activityId;
}

bool RemoveInstancesResponse::ActivityIdHasBeenSet() const
{
