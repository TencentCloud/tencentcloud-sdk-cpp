...
string DescribeAutoScalingAdvicesRequest::ToJsonString() const
{
...
vector<string> DescribeAutoScalingAdvicesRequest::GetAutoScalingGroupIds() const
{
    return m_autoScalingGroupIds;
}

void DescribeAutoScalingAdvicesRequest::SetAutoScalingGroupIds(const vector<string>& _autoScalingGroupIds)
{
    m_autoScalingGroupIds = _autoScalingGroupIds;
    m_autoScalingGroupIdsHasBeenSet = true;
}

bool DescribeAutoScalingAdvicesRequest::AutoScalingGroupIdsHasBeenSet() const
{
