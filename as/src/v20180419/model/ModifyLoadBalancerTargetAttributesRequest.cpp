...
string ModifyLoadBalancerTargetAttributesRequest::ToJsonString() const
{
...
string ModifyLoadBalancerTargetAttributesRequest::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

void ModifyLoadBalancerTargetAttributesRequest::SetAutoScalingGroupId(const string& _autoScalingGroupId)
{
    m_autoScalingGroupId = _autoScalingGroupId;
    m_autoScalingGroupIdHasBeenSet = true;
}

bool ModifyLoadBalancerTargetAttributesRequest::AutoScalingGroupIdHasBeenSet() const
{
    return m_autoScalingGroupIdHasBeenSet;
}

vector<ForwardLoadBalancer> ModifyLoadBalancerTargetAttributesRequest::GetForwardLoadBalancers() const
{
    return m_forwardLoadBalancers;
}

void ModifyLoadBalancerTargetAttributesRequest::SetForwardLoadBalancers(const vector<ForwardLoadBalancer>& _forwardLoadBalancers)
{
    m_forwardLoadBalancers = _forwardLoadBalancers;
    m_forwardLoadBalancersHasBeenSet = true;
}

bool ModifyLoadBalancerTargetAttributesRequest::ForwardLoadBalancersHasBeenSet() const
{
