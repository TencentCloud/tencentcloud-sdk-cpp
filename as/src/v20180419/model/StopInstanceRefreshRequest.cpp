...
string StopInstanceRefreshRequest::ToJsonString() const
{
...
string StopInstanceRefreshRequest::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

void StopInstanceRefreshRequest::SetAutoScalingGroupId(const string& _autoScalingGroupId)
{
    m_autoScalingGroupId = _autoScalingGroupId;
    m_autoScalingGroupIdHasBeenSet = true;
}

bool StopInstanceRefreshRequest::AutoScalingGroupIdHasBeenSet() const
{
    return m_autoScalingGroupIdHasBeenSet;
}

string StopInstanceRefreshRequest::GetRefreshActivityId() const
{
    return m_refreshActivityId;
}

void StopInstanceRefreshRequest::SetRefreshActivityId(const string& _refreshActivityId)
{
    m_refreshActivityId = _refreshActivityId;
    m_refreshActivityIdHasBeenSet = true;
}

bool StopInstanceRefreshRequest::RefreshActivityIdHasBeenSet() const
{
