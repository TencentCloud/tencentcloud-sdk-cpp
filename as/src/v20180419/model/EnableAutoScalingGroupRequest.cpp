...
string EnableAutoScalingGroupRequest::ToJsonString() const
{
...
string EnableAutoScalingGroupRequest::GetAutoScalingGroupId() const
{
    return m_autoScalingGroupId;
}

void EnableAutoScalingGroupRequest::SetAutoScalingGroupId(const string& _autoScalingGroupId)
{
    m_autoScalingGroupId = _autoScalingGroupId;
    m_autoScalingGroupIdHasBeenSet = true;
}

bool EnableAutoScalingGroupRequest::AutoScalingGroupIdHasBeenSet() const
{
