...
CoreInternalOutcome DeleteNotificationConfigurationResponse::Deserialize(const string &payload)
{
...
string DeleteNotificationConfigurationResponse::ToJsonString() const
{
