...
CoreInternalOutcome ExitStandbyResponse::Deserialize(const string &payload)
{
...
string ExitStandbyResponse::ToJsonString() const
{
...
string ExitStandbyResponse::GetActivityId() const
{
    return m_activityId;
}

bool ExitStandbyResponse::ActivityIdHasBeenSet() const
{
