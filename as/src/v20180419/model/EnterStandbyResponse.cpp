...
CoreInternalOutcome EnterStandbyResponse::Deserialize(const string &payload)
{
...
string EnterStandbyResponse::ToJsonString() const
{
...
string EnterStandbyResponse::GetActivityId() const
{
    return m_activityId;
}

bool EnterStandbyResponse::ActivityIdHasBeenSet() const
{
