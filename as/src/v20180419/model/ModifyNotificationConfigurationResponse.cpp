...
CoreInternalOutcome ModifyNotificationConfigurationResponse::Deserialize(const string &payload)
{
...
string ModifyNotificationConfigurationResponse::ToJsonString() const
{
