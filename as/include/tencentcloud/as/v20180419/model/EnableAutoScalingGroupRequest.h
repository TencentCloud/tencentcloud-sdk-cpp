...
#ifndef TENCENTCLOUD_AS_V20180419_MODEL_ENABLEAUTOSCALINGGROUPREQUEST_H_
#define TENCENTCLOUD_AS_V20180419_MODEL_ENABLEAUTOSCALINGGROUPREQUEST_H_
    ...
    namespace As
    {
        namespace V20180419
        {
            namespace Model
            {
                ...
                */
                class EnableAutoScalingGroupRequest : public AbstractModel
                {
                public:
                    EnableAutoScalingGroupRequest();
                    ~EnableAutoScalingGroupRequest() = default;
...
#endif // !TENCENTCLOUD_AS_V20180419_MODEL_ENABLEAUTOSCALINGGROUPREQUEST_H_
