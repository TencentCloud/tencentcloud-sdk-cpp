...
CoreInternalOutcome CreateOrderAndPayResponse::Deserialize(const string &payload)
{
...
string CreateOrderAndPayResponse::ToJsonString() const
{
...
string CreateOrderAndPayResponse::GetOrderId() const
{
    return m_orderId;
}

bool CreateOrderAndPayResponse::OrderIdHasBeenSet() const
{
