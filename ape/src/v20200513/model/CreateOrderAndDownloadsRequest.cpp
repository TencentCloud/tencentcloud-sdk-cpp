...
string CreateOrderAndDownloadsRequest::ToJsonString() const
{
...
vector<ImageInfo> CreateOrderAndDownloadsRequest::GetImageInfos() const
{
    return m_imageInfos;
}

void CreateOrderAndDownloadsRequest::SetImageInfos(const vector<ImageInfo>& _imageInfos)
{
    m_imageInfos = _imageInfos;
    m_imageInfosHasBeenSet = true;
}

bool CreateOrderAndDownloadsRequest::ImageInfosHasBeenSet() const
{
