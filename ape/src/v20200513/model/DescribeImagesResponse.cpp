...
CoreInternalOutcome DescribeImagesResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["HaveMore"].IsBool())
        {
            return CoreInternalOutcome(Core::Error("response `HaveMore` IsBool=false incorrectly").SetRequestId(requestId));
        }
        m_haveMore = rsp["HaveMore"].GetBool();
...
int64_t DescribeImagesResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeImagesResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeImagesResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeImagesResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

int64_t DescribeImagesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeImagesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

bool DescribeImagesResponse::GetHaveMore() const
{
    return m_haveMore;
}

bool DescribeImagesResponse::HaveMoreHasBeenSet() const
{
    return m_haveMoreHasBeenSet;
}

vector<ImageItem> DescribeImagesResponse::GetItems() const
{
    return m_items;
}

bool DescribeImagesResponse::ItemsHasBeenSet() const
{
