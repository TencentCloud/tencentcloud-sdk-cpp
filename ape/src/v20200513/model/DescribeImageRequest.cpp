...
uint64_t DescribeImageRequest::GetImageId() const
{
    return m_imageId;
}

void DescribeImageRequest::SetImageId(const uint64_t& _imageId)
{
    m_imageId = _imageId;
    m_imageIdHasBeenSet = true;
}

bool DescribeImageRequest::ImageIdHasBeenSet() const
{
