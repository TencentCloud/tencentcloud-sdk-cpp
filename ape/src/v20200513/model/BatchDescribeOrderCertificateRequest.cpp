...
string BatchDescribeOrderCertificateRequest::ToJsonString() const
{
...
vector<string> BatchDescribeOrderCertificateRequest::GetOrderIds() const
{
    return m_orderIds;
}

void BatchDescribeOrderCertificateRequest::SetOrderIds(const vector<string>& _orderIds)
{
    m_orderIds = _orderIds;
    m_orderIdsHasBeenSet = true;
}

bool BatchDescribeOrderCertificateRequest::OrderIdsHasBeenSet() const
{
