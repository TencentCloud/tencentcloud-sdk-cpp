...
CoreInternalOutcome UploadDocResponse::Deserialize(const string &payload)
{
...
string UploadDocResponse::ToJsonString() const
{
...
string UploadDocResponse::GetDocId() const
{
    return m_docId;
}

bool UploadDocResponse::DocIdHasBeenSet() const
{
