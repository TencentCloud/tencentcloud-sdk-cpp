...
RetrieveKnowledgeResponse::RetrieveKnowledgeResponse() :
    m_recordsHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome RetrieveKnowledgeResponse::Deserialize(const string &payload)
{
...
string RetrieveKnowledgeResponse::ToJsonString() const
{
...
vector<RetrievalRecord> RetrieveKnowledgeResponse::GetRecords() const
{
    return m_records;
}

bool RetrieveKnowledgeResponse::RecordsHasBeenSet() const
{
    return m_recordsHasBeenSet;
}

uint64_t RetrieveKnowledgeResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool RetrieveKnowledgeResponse::TotalCountHasBeenSet() const
{
