...
CoreInternalOutcome ListDocsResponse::Deserialize(const string &payload)
{
...
string ListDocsResponse::ToJsonString() const
{
...
bool ListDocsResponse::ListHasBeenSet() const
{
