...
#ifndef TENCENTCLOUD_LKEAP_V20240522_MODEL_RETRIEVEKNOWLEDGEREALTIMEREQUEST_H_
#define TENCENTCLOUD_LKEAP_V20240522_MODEL_RETRIEVEKNOWLEDGEREALTIMEREQUEST_H_
    ...
    namespace Lkeap
    {
        namespace V20240522
        {
            namespace Model
            {
                ...
                */
                class RetrieveKnowledgeRealtimeRequest : public AbstractModel
                {
                public:
                    RetrieveKnowledgeRealtimeRequest();
                    ~RetrieveKnowledgeRealtimeRequest() = default;
...
#endif // !TENCENTCLOUD_LKEAP_V20240522_MODEL_RETRIEVEKNOWLEDGEREALTIMEREQUEST_H_
