            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取用户 ID。 Username 和 UserId 需至少一个不为空；都不为空时优先使用 Username。
                     * @return UserId 用户 ID。 Username 和 UserId 需至少一个不为空；都不为空时优先使用 Username。
                     * 
                     */
                    std::string GetUserId() const;

                    /**
                     * 设置用户 ID。 Username 和 UserId 需至少一个不为空；都不为空时优先使用 Username。
