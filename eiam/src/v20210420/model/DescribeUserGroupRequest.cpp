...
string DescribeUserGroupRequest::ToJsonString() const
{
...
string DescribeUserGroupRequest::GetUserGroupId() const
{
    return m_userGroupId;
}

void DescribeUserGroupRequest::SetUserGroupId(const string& _userGroupId)
{
    m_userGroupId = _userGroupId;
    m_userGroupIdHasBeenSet = true;
}

bool DescribeUserGroupRequest::UserGroupIdHasBeenSet() const
{
