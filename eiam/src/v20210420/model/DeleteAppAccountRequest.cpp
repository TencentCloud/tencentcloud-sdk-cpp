...
string DeleteAppAccountRequest::ToJsonString() const
{
...
vector<string> DeleteAppAccountRequest::GetAccountIdList() const
{
    return m_accountIdList;
}

void DeleteAppAccountRequest::SetAccountIdList(const vector<string>& _accountIdList)
{
    m_accountIdList = _accountIdList;
    m_accountIdListHasBeenSet = true;
}

bool DeleteAppAccountRequest::AccountIdListHasBeenSet() const
{
