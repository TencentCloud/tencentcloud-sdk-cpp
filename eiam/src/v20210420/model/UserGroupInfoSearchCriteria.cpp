...
CoreInternalOutcome UserGroupInfoSearchCriteria::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void UserGroupInfoSearchCriteria::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string UserGroupInfoSearchCriteria::GetKeyword() const
{
    return m_keyword;
}

void UserGroupInfoSearchCriteria::SetKeyword(const string& _keyword)
{
    m_keyword = _keyword;
    m_keywordHasBeenSet = true;
}

bool UserGroupInfoSearchCriteria::KeywordHasBeenSet() const
{
