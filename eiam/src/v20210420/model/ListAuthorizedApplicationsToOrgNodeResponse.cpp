...
CoreInternalOutcome ListAuthorizedApplicationsToOrgNodeResponse::Deserialize(const string &payload)
{
...
string ListAuthorizedApplicationsToOrgNodeResponse::ToJsonString() const
{
...
vector<string> ListAuthorizedApplicationsToOrgNodeResponse::GetApplicationIds() const
{
    return m_applicationIds;
}

bool ListAuthorizedApplicationsToOrgNodeResponse::ApplicationIdsHasBeenSet() const
{
