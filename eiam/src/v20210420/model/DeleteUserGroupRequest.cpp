...
string DeleteUserGroupRequest::ToJsonString() const
{
...
string DeleteUserGroupRequest::GetUserGroupId() const
{
    return m_userGroupId;
}

void DeleteUserGroupRequest::SetUserGroupId(const string& _userGroupId)
{
    m_userGroupId = _userGroupId;
    m_userGroupIdHasBeenSet = true;
}

bool DeleteUserGroupRequest::UserGroupIdHasBeenSet() const
{
