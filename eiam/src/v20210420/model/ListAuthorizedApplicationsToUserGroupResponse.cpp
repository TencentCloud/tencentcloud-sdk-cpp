...
CoreInternalOutcome ListAuthorizedApplicationsToUserGroupResponse::Deserialize(const string &payload)
{
...
string ListAuthorizedApplicationsToUserGroupResponse::ToJsonString() const
{
...
vector<string> ListAuthorizedApplicationsToUserGroupResponse::GetApplicationIds() const
{
    return m_applicationIds;
}

bool ListAuthorizedApplicationsToUserGroupResponse::ApplicationIdsHasBeenSet() const
{
