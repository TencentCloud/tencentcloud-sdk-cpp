...
string DescribeUserInfoRequest::GetUserName() const
{
    return m_userName;
}

void DescribeUserInfoRequest::SetUserName(const string& _userName)
{
    m_userName = _userName;
    m_userNameHasBeenSet = true;
}

bool DescribeUserInfoRequest::UserNameHasBeenSet() const
{
