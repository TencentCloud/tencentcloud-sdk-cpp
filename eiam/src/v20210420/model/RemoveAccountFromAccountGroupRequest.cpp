...
string RemoveAccountFromAccountGroupRequest::ToJsonString() const
{
...
string RemoveAccountFromAccountGroupRequest::GetAccountGroupId() const
{
    return m_accountGroupId;
}

void RemoveAccountFromAccountGroupRequest::SetAccountGroupId(const string& _accountGroupId)
{
    m_accountGroupId = _accountGroupId;
    m_accountGroupIdHasBeenSet = true;
}

bool RemoveAccountFromAccountGroupRequest::AccountGroupIdHasBeenSet() const
{
    return m_accountGroupIdHasBeenSet;
}

vector<string> RemoveAccountFromAccountGroupRequest::GetAccountIds() const
{
    return m_accountIds;
}

void RemoveAccountFromAccountGroupRequest::SetAccountIds(const vector<string>& _accountIds)
{
    m_accountIds = _accountIds;
    m_accountIdsHasBeenSet = true;
}

bool RemoveAccountFromAccountGroupRequest::AccountIdsHasBeenSet() const
{
