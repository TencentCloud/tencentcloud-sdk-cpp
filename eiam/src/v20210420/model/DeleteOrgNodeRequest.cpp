...
string DeleteOrgNodeRequest::ToJsonString() const
{
...
string DeleteOrgNodeRequest::GetOrgNodeId() const
{
    return m_orgNodeId;
}

void DeleteOrgNodeRequest::SetOrgNodeId(const string& _orgNodeId)
{
    m_orgNodeId = _orgNodeId;
    m_orgNodeIdHasBeenSet = true;
}

bool DeleteOrgNodeRequest::OrgNodeIdHasBeenSet() const
{
