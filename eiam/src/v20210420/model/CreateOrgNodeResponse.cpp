...
CoreInternalOutcome CreateOrgNodeResponse::Deserialize(const string &payload)
{
...
string CreateOrgNodeResponse::ToJsonString() const
{
...
string CreateOrgNodeResponse::GetOrgNodeId() const
{
    return m_orgNodeId;
}

bool CreateOrgNodeResponse::OrgNodeIdHasBeenSet() const
{
