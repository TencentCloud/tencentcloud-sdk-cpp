...
CoreInternalOutcome DeleteUsersResponse::Deserialize(const string &payload)
{
...
string DeleteUsersResponse::ToJsonString() const
{
...
vector<string> DeleteUsersResponse::GetFailedItems() const
{
    return m_failedItems;
}

bool DeleteUsersResponse::FailedItemsHasBeenSet() const
{
