...
CoreInternalOutcome SearchByTextResponse::Deserialize(const string &payload)
{
...
string SearchByTextResponse::ToJsonString() const
{
...
string SearchByTextResponse::GetQuery() const
{
    return m_query;
}

bool SearchByTextResponse::QueryHasBeenSet() const
{
    return m_queryHasBeenSet;
}

vector<string> SearchByTextResponse::GetImages() const
{
    return m_images;
}

bool SearchByTextResponse::ImagesHasBeenSet() const
{
