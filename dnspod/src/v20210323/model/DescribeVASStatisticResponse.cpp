...
CoreInternalOutcome DescribeVASStatisticResponse::Deserialize(const string &payload)
{
...
string DescribeVASStatisticResponse::ToJsonString() const
{
...
vector<VASStatisticItem> DescribeVASStatisticResponse::GetVASList() const
{
    return m_vASList;
}

bool DescribeVASStatisticResponse::VASListHasBeenSet() const
{
