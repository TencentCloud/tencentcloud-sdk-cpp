...
CoreInternalOutcome CreateDomainGroupResponse::Deserialize(const string &payload)
{
...
string CreateDomainGroupResponse::ToJsonString() const
{
...
int64_t CreateDomainGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateDomainGroupResponse::GroupIdHasBeenSet() const
{
