...
CoreInternalOutcome CreateDomainBatchRecord::Deserialize(const Value &value)
{
    string requestId = "";
...
void CreateDomainBatchRecord::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
