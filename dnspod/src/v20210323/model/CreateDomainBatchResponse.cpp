...
vector<CreateDomainBatchDetail> CreateDomainBatchResponse::GetDetailList() const
{
    return m_detailList;
}

bool CreateDomainBatchResponse::DetailListHasBeenSet() const
{
    return m_detailListHasBeenSet;
}

uint64_t CreateDomainBatchResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateDomainBatchResponse::JobIdHasBeenSet() const
{
