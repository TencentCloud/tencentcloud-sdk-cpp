...
DescribeDomainLogFilterFileResponse::DescribeDomainLogFilterFileResponse() :
    m_downloadURLHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDomainLogFilterFileResponse::Deserialize(const string &payload)
{
...
string DescribeDomainLogFilterFileResponse::ToJsonString() const
{
...
string DescribeDomainLogFilterFileResponse::GetDownloadURL() const
{
    return m_downloadURL;
}

bool DescribeDomainLogFilterFileResponse::DownloadURLHasBeenSet() const
{
