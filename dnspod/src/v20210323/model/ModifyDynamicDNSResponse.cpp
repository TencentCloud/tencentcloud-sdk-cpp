...
CoreInternalOutcome ModifyDynamicDNSResponse::Deserialize(const string &payload)
{
...
string ModifyDynamicDNSResponse::ToJsonString() const
{
...
uint64_t ModifyDynamicDNSResponse::GetRecordId() const
{
    return m_recordId;
}

bool ModifyDynamicDNSResponse::RecordIdHasBeenSet() const
{
