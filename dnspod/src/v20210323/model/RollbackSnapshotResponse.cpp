...
CoreInternalOutcome RollbackSnapshotResponse::Deserialize(const string &payload)
{
...
string RollbackSnapshotResponse::ToJsonString() const
{
...
uint64_t RollbackSnapshotResponse::GetTaskId() const
{
    return m_taskId;
}

bool RollbackSnapshotResponse::TaskIdHasBeenSet() const
{
