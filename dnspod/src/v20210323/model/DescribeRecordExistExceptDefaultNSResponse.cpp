...
CoreInternalOutcome DescribeRecordExistExceptDefaultNSResponse::Deserialize(const string &payload)
{
...
string DescribeRecordExistExceptDefaultNSResponse::ToJsonString() const
{
...
bool DescribeRecordExistExceptDefaultNSResponse::GetExist() const
{
    return m_exist;
}

bool DescribeRecordExistExceptDefaultNSResponse::ExistHasBeenSet() const
{
