...
CreateAndPayDealResponse::CreateAndPayDealResponse() :
    m_bigDealIdHasBeenSet(false),
    m_dealListHasBeenSet(false)
{
}

CoreInternalOutcome CreateAndPayDealResponse::Deserialize(const string &payload)
{
...
string CreateAndPayDealResponse::ToJsonString() const
{
...
string CreateAndPayDealResponse::GetBigDealId() const
{
    return m_bigDealId;
}

bool CreateAndPayDealResponse::BigDealIdHasBeenSet() const
{
    return m_bigDealIdHasBeenSet;
}

vector<Deals> CreateAndPayDealResponse::GetDealList() const
{
    return m_dealList;
}

bool CreateAndPayDealResponse::DealListHasBeenSet() const
{
