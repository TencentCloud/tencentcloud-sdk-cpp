...
CoreInternalOutcome DescribeSubdomainAnalyticsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AliasData") && !rsp["AliasData"].IsNull())
    {
        ...
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            SubdomainAliasAnalyticsItem item;
            CoreInternalOutcome outcome = item.Deserialize(*itr);
            if (!outcome.IsSuccess())
            {
                outcome.GetError().SetRequestId(requestId);
...
string DescribeSubdomainAnalyticsResponse::ToJsonString() const
{
...
vector<DomainAnalyticsDetail> DescribeSubdomainAnalyticsResponse::GetData() const
{
    return m_data;
}

bool DescribeSubdomainAnalyticsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

SubdomainAnalyticsInfo DescribeSubdomainAnalyticsResponse::GetInfo() const
{
    return m_info;
}

bool DescribeSubdomainAnalyticsResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

vector<SubdomainAliasAnalyticsItem> DescribeSubdomainAnalyticsResponse::GetAliasData() const
{
    return m_aliasData;
}

bool DescribeSubdomainAnalyticsResponse::AliasDataHasBeenSet() const
{
