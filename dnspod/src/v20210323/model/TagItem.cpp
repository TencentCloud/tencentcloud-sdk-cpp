...
CoreInternalOutcome TagItem::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TagKey") && !value["TagKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TagItem.TagKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TagValue") && !value["TagValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TagItem.TagValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string TagItem::GetTagKey() const
{
    return m_tagKey;
}

void TagItem::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool TagItem::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string TagItem::GetTagValue() const
{
    return m_tagValue;
}

void TagItem::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool TagItem::TagValueHasBeenSet() const
{
