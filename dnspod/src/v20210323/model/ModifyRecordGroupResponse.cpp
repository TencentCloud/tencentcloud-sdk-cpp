...
CoreInternalOutcome ModifyRecordGroupResponse::Deserialize(const string &payload)
{
...
string ModifyRecordGroupResponse::ToJsonString() const
{
...
uint64_t ModifyRecordGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool ModifyRecordGroupResponse::GroupIdHasBeenSet() const
{
