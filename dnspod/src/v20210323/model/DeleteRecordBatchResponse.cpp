...
DeleteRecordBatchResponse::DeleteRecordBatchResponse() :
    m_jobIdHasBeenSet(false),
    m_detailListHasBeenSet(false)
{
}

CoreInternalOutcome DeleteRecordBatchResponse::Deserialize(const string &payload)
{
...
string DeleteRecordBatchResponse::ToJsonString() const
{
...
uint64_t DeleteRecordBatchResponse::GetJobId() const
{
    return m_jobId;
}

bool DeleteRecordBatchResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<DeleteRecordBatchDetail> DeleteRecordBatchResponse::GetDetailList() const
{
    return m_detailList;
}

bool DeleteRecordBatchResponse::DetailListHasBeenSet() const
{
