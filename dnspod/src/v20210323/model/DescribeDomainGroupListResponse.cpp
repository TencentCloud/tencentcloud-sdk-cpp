...
CoreInternalOutcome DescribeDomainGroupListResponse::Deserialize(const string &payload)
{
...
string DescribeDomainGroupListResponse::ToJsonString() const
{
...
vector<GroupInfo> DescribeDomainGroupListResponse::GetGroupList() const
{
    return m_groupList;
}

bool DescribeDomainGroupListResponse::GroupListHasBeenSet() const
{
