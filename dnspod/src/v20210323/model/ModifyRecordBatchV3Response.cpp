...
ModifyRecordBatchV3Response::ModifyRecordBatchV3Response() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome ModifyRecordBatchV3Response::Deserialize(const string &payload)
{
...
string ModifyRecordBatchV3Response::ToJsonString() const
{
...
uint64_t ModifyRecordBatchV3Response::GetJobId() const
{
    return m_jobId;
}

bool ModifyRecordBatchV3Response::JobIdHasBeenSet() const
{
