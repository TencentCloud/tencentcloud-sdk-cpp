...
CoreInternalOutcome DeleteDomainBatchResponse::Deserialize(const string &payload)
{
...
string DeleteDomainBatchResponse::ToJsonString() const
{
...
uint64_t DeleteDomainBatchResponse::GetJobId() const
{
    return m_jobId;
}

bool DeleteDomainBatchResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

vector<DeleteDomainBatchDetail> DeleteDomainBatchResponse::GetDetailList() const
{
    return m_detailList;
}

bool DeleteDomainBatchResponse::DetailListHasBeenSet() const
{
