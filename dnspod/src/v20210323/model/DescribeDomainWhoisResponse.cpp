...
CoreInternalOutcome DescribeDomainWhoisResponse::Deserialize(const string &payload)
{
...
string DescribeDomainWhoisResponse::ToJsonString() const
{
...
WhoisInfo DescribeDomainWhoisResponse::GetInfo() const
{
    return m_info;
}

bool DescribeDomainWhoisResponse::InfoHasBeenSet() const
{
