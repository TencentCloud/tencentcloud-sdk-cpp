...
CoreInternalOutcome CheckRecordSnapshotRollbackResponse::Deserialize(const string &payload)
{
...
string CheckRecordSnapshotRollbackResponse::ToJsonString() const
{
...
string CheckRecordSnapshotRollbackResponse::GetReason() const
{
    return m_reason;
}

bool CheckRecordSnapshotRollbackResponse::ReasonHasBeenSet() const
{
