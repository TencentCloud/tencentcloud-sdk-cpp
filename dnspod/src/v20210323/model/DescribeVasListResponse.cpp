...
CoreInternalOutcome DescribeVasListResponse::Deserialize(const string &payload)
{
...
string DescribeVasListResponse::ToJsonString() const
{
...
uint64_t DescribeVasListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVasListResponse::TotalCountHasBeenSet() const
{
