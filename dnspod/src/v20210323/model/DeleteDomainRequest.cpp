...
uint64_t DeleteDomainRequest::GetDomainId() const
{
    return m_domainId;
}

void DeleteDomainRequest::SetDomainId(const uint64_t& _domainId)
{
    m_domainId = _domainId;
    m_domainIdHasBeenSet = true;
}

bool DeleteDomainRequest::DomainIdHasBeenSet() const
{
