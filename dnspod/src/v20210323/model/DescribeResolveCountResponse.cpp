...
DescribeResolveCountResponse::DescribeResolveCountResponse() :
...
CoreInternalOutcome DescribeResolveCountResponse::Deserialize(const string &payload)
{
...
string DescribeResolveCountResponse::ToJsonString() const
{
...
vector<ResolveCountDataItem> DescribeResolveCountResponse::GetData() const
{
    return m_data;
}

bool DescribeResolveCountResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

ResolveCountInfo DescribeResolveCountResponse::GetInfo() const
{
    return m_info;
}

bool DescribeResolveCountResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

vector<ResolveCountAliasItem> DescribeResolveCountResponse::GetAliasData() const
{
    return m_aliasData;
}

bool DescribeResolveCountResponse::AliasDataHasBeenSet() const
{
