...
string DeleteDomainBatchRequest::ToJsonString() const
{
...
vector<string> DeleteDomainBatchRequest::GetDomainList() const
{
    return m_domainList;
}

void DeleteDomainBatchRequest::SetDomainList(const vector<string>& _domainList)
{
    m_domainList = _domainList;
    m_domainListHasBeenSet = true;
}

bool DeleteDomainBatchRequest::DomainListHasBeenSet() const
{
