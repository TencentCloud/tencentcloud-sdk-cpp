...
DescribeDomainAndRecordListResponse::DescribeDomainAndRecordListResponse() :
    m_detailListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDomainAndRecordListResponse::Deserialize(const string &payload)
{
...
string DescribeDomainAndRecordListResponse::ToJsonString() const
{
...
vector<BatchSearchDomainInfo> DescribeDomainAndRecordListResponse::GetDetailList() const
{
    return m_detailList;
}

bool DescribeDomainAndRecordListResponse::DetailListHasBeenSet() const
{
