...
CoreInternalOutcome DownloadSnapshotResponse::Deserialize(const string &payload)
{
...
string DownloadSnapshotResponse::ToJsonString() const
{
...
string DownloadSnapshotResponse::GetCosUrl() const
{
    return m_cosUrl;
}

bool DownloadSnapshotResponse::CosUrlHasBeenSet() const
{
