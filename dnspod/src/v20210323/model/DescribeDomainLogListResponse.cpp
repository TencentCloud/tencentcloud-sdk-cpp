...
CoreInternalOutcome DescribeDomainLogListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("LogList") && !rsp["LogList"].IsNull())
    {
        if (!rsp["LogList"].IsArray())
            return CoreInternalOutcome(Error("response `LogList` is not array type"));
...
string DescribeDomainLogListResponse::ToJsonString() const
{
...
vector<string> DescribeDomainLogListResponse::GetLogList() const
{
    return m_logList;
}

bool DescribeDomainLogListResponse::LogListHasBeenSet() const
{
    return m_logListHasBeenSet;
}

uint64_t DescribeDomainLogListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeDomainLogListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeDomainLogListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDomainLogListResponse::TotalCountHasBeenSet() const
{
