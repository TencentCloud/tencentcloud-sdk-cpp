...
CoreInternalOutcome ModifyRecordFieldsResponse::Deserialize(const string &payload)
{
...
string ModifyRecordFieldsResponse::ToJsonString() const
{
...
uint64_t ModifyRecordFieldsResponse::GetRecordId() const
{
    return m_recordId;
}

bool ModifyRecordFieldsResponse::RecordIdHasBeenSet() const
{
