...
CoreInternalOutcome CreateRecordBatchResponse::Deserialize(const string &payload)
{
...
string CreateRecordBatchResponse::ToJsonString() const
{
...
vector<CreateRecordBatchDetail> CreateRecordBatchResponse::GetDetailList() const
{
    return m_detailList;
}

bool CreateRecordBatchResponse::DetailListHasBeenSet() const
{
    return m_detailListHasBeenSet;
}

uint64_t CreateRecordBatchResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateRecordBatchResponse::JobIdHasBeenSet() const
{
