...
CoreInternalOutcome DescribeRecordLineCategoryListResponse::Deserialize(const string &payload)
{
...
string DescribeRecordLineCategoryListResponse::ToJsonString() const
{
...
vector<LineItem> DescribeRecordLineCategoryListResponse::GetLineList() const
{
    return m_lineList;
}

bool DescribeRecordLineCategoryListResponse::LineListHasBeenSet() const
{
