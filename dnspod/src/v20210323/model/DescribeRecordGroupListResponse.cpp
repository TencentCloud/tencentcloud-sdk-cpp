...
CoreInternalOutcome DescribeRecordGroupListResponse::Deserialize(const string &payload)
{
...
string DescribeRecordGroupListResponse::ToJsonString() const
{
...
vector<RecordGroupInfo> DescribeRecordGroupListResponse::GetGroupList() const
{
    return m_groupList;
}

bool DescribeRecordGroupListResponse::GroupListHasBeenSet() const
{
