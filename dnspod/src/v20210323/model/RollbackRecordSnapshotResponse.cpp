...
CoreInternalOutcome RollbackRecordSnapshotResponse::Deserialize(const string &payload)
{
...
string RollbackRecordSnapshotResponse::ToJsonString() const
{
...
uint64_t RollbackRecordSnapshotResponse::GetJobId() const
{
    return m_jobId;
}

bool RollbackRecordSnapshotResponse::JobIdHasBeenSet() const
{
