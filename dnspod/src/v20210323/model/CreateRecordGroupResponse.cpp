...
CoreInternalOutcome CreateRecordGroupResponse::Deserialize(const string &payload)
{
...
string CreateRecordGroupResponse::ToJsonString() const
{
...
uint64_t CreateRecordGroupResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateRecordGroupResponse::GroupIdHasBeenSet() const
{
