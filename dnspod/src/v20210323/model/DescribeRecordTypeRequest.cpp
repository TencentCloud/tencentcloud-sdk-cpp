...
string DescribeRecordTypeRequest::ToJsonString() const
{
...
string DescribeRecordTypeRequest::GetDomainGrade() const
{
    return m_domainGrade;
}

void DescribeRecordTypeRequest::SetDomainGrade(const string& _domainGrade)
{
    m_domainGrade = _domainGrade;
    m_domainGradeHasBeenSet = true;
}

bool DescribeRecordTypeRequest::DomainGradeHasBeenSet() const
{
