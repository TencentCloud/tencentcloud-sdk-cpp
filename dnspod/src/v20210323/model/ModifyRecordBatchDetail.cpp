...
CoreInternalOutcome ModifyRecordBatchDetail::Deserialize(const Value &value)
{
    string requestId = "";
...
void ModifyRecordBatchDetail::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
