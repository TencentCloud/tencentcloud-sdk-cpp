...
CoreInternalOutcome DescribeSnapshotListResponse::Deserialize(const string &payload)
{
...
string DescribeSnapshotListResponse::ToJsonString() const
{
...
SnapshotPageInfo DescribeSnapshotListResponse::GetInfo() const
{
    return m_info;
}

bool DescribeSnapshotListResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

vector<SnapshotInfo> DescribeSnapshotListResponse::GetSnapshotList() const
{
    return m_snapshotList;
}

bool DescribeSnapshotListResponse::SnapshotListHasBeenSet() const
{
