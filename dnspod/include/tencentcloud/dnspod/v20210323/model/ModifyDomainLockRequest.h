...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINLOCKREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINLOCKREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class ModifyDomainLockRequest : public AbstractModel
                {
                public:
                    ModifyDomainLockRequest();
                    ~ModifyDomainLockRequest() = default;
                    ...
                    /**
                     * 判断参数 LockDays 是否已赋值
                     * @return LockDays 是否已赋值
                     * 
                     */
                    bool LockDaysHasBeenSet() const;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINLOCKREQUEST_H_
