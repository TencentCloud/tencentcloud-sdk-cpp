...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYRECORDGROUPREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYRECORDGROUPREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class ModifyRecordGroupRequest : public AbstractModel
                {
                public:
                    ModifyRecordGroupRequest();
                    ~ModifyRecordGroupRequest() = default;
                    ...
                    /**
                     * 获取要修改的分组 ID，可通过DescribeRecordGroupList接口获取所有记录分组
                    ...
                    /**
                     * 设置要修改的分组 ID，可通过DescribeRecordGroupList接口获取所有记录分组
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYRECORDGROUPREQUEST_H_
