...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATELINEGROUPREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATELINEGROUPREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class CreateLineGroupRequest : public AbstractModel
                {
                public:
                    CreateLineGroupRequest();
                    ~CreateLineGroupRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATELINEGROUPREQUEST_H_
