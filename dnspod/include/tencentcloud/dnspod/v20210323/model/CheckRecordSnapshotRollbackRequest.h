...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKRECORDSNAPSHOTROLLBACKREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKRECORDSNAPSHOTROLLBACKREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class CheckRecordSnapshotRollbackRequest : public AbstractModel
                {
                public:
                    CheckRecordSnapshotRollbackRequest();
                    ~CheckRecordSnapshotRollbackRequest() = default;
                     ...
                     * 
                     */
                    SnapshotRecord GetRecord() const;
                     ...
                     * 
                     */
                    void SetRecord(const SnapshotRecord& _record);
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKRECORDSNAPSHOTROLLBACKREQUEST_H_
