...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINUNLOCKREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINUNLOCKREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class ModifyDomainUnlockRequest : public AbstractModel
                {
                public:
                    ModifyDomainUnlockRequest();
                    ~ModifyDomainUnlockRequest() = default;
                    ...
                    /**
                     * 获取域名解锁码，锁定的时候会返回。
                     * @return LockCode 域名解锁码，锁定的时候会返回。
                     * 
                     */
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_MODIFYDOMAINUNLOCKREQUEST_H_
