...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETESHAREDOMAINREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETESHAREDOMAINREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DeleteShareDomainRequest : public AbstractModel
                {
                public:
                    DeleteShareDomainRequest();
                    ~DeleteShareDomainRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETESHAREDOMAINREQUEST_H_
