...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREINFOREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREINFOREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeDomainShareInfoRequest : public AbstractModel
                {
                public:
                    DescribeDomainShareInfoRequest();
                    ~DescribeDomainShareInfoRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREINFOREQUEST_H_
