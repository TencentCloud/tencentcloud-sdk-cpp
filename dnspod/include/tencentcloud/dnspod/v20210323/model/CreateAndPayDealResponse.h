...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEANDPAYDEALRESPONSE_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEANDPAYDEALRESPONSE_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class CreateAndPayDealResponse : public AbstractModel
                {
                public:
                    CreateAndPayDealResponse();
                    ~CreateAndPayDealResponse() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEANDPAYDEALRESPONSE_H_
