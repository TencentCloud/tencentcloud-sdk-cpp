...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINCUSTOMLINELISTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINCUSTOMLINELISTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeDomainCustomLineListRequest : public AbstractModel
                {
                public:
                    DescribeDomainCustomLineListRequest();
                    ~DescribeDomainCustomLineListRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINCUSTOMLINELISTREQUEST_H_
