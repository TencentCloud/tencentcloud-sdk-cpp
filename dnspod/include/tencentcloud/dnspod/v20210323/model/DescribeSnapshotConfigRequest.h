...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTCONFIGREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTCONFIGREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeSnapshotConfigRequest : public AbstractModel
                {
                public:
                    DescribeSnapshotConfigRequest();
                    ~DescribeSnapshotConfigRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTCONFIGREQUEST_H_
