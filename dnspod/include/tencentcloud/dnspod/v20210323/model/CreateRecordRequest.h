            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>记录线路，可以通过接口DescribeRecordLineList查看当前域名允许的线路信息，中文，比如：默认。</p>
                    ...
                    /**
                     * 设置<p>记录线路，可以通过接口DescribeRecordLineList查看当前域名允许的线路信息，中文，比如：默认。</p>
                    ...
                    /**
                     * 获取<p>线路的 ID，可以通过接口DescribeRecordLineList查看当前域名允许的线路信息，英文字符串，比如：10=1。参数RecordLineId优先级高于RecordLine，如果同时传递二者，优先使用RecordLineId参数。</p>
                    ...
                    /**
                     * 设置<p>线路的 ID，可以通过接口DescribeRecordLineList查看当前域名允许的线路信息，英文字符串，比如：10=1。参数RecordLineId优先级高于RecordLine，如果同时传递二者，优先使用RecordLineId参数。</p>
                    ...
                    /**
                     * 获取<p>TTL，范围1-604800，不同套餐域名最小值不同。</p>
                    ...
                    /**
                     * 设置<p>TTL，范围1-604800，不同套餐域名最小值不同。</p>
                    ...
                    /**
                     * 获取<p>开启DNSSEC时，强制添加CNAME/URL记录</p>
                    ...
                    /**
                     * 设置<p>开启DNSSEC时，强制添加CNAME/URL记录</p>
                    ...
                    /**
                     * 获取<p>记录分组 Id。可以通过接口 DescribeRecordGroupList 接口 GroupId 字段获取。</p><p>取值参考：<a href="https://cloud.tencent.com/document/api/1427/83225">DescribeRecordGroupList</a></p>
                    ...
                    /**
                     * 设置<p>记录分组 Id。可以通过接口 DescribeRecordGroupList 接口 GroupId 字段获取。</p><p>取值参考：<a href="https://cloud.tencent.com/document/api/1427/83225">DescribeRecordGroupList</a></p>
