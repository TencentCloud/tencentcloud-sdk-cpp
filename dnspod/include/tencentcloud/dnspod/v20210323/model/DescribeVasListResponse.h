...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEVASLISTRESPONSE_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEVASLISTRESPONSE_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeVasListResponse : public AbstractModel
                {
                public:
                    DescribeVasListResponse();
                    ~DescribeVasListResponse() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEVASLISTRESPONSE_H_
