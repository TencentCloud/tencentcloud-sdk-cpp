...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREUSERLISTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREUSERLISTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeDomainShareUserListRequest : public AbstractModel
                {
                public:
                    DescribeDomainShareUserListRequest();
                    ~DescribeDomainShareUserListRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBEDOMAINSHAREUSERLISTREQUEST_H_
