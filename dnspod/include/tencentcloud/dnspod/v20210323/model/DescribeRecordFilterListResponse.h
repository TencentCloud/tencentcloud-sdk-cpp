...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDFILTERLISTRESPONSE_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDFILTERLISTRESPONSE_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeRecordFilterListResponse : public AbstractModel
                {
                public:
                    DescribeRecordFilterListResponse();
                    ~DescribeRecordFilterListResponse() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDFILTERLISTRESPONSE_H_
