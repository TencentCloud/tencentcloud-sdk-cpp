...
CoreInternalOutcome DescribeApmAllVulCountResponse::Deserialize(const string &payload)
{
...
string DescribeApmAllVulCountResponse::ToJsonString() const
{
...
vector<ApmMetricRecord> DescribeApmAllVulCountResponse::GetVulnerabilityList() const
{
    return m_vulnerabilityList;
}

bool DescribeApmAllVulCountResponse::VulnerabilityListHasBeenSet() const
{
    return m_vulnerabilityListHasBeenSet;
}

int64_t DescribeApmAllVulCountResponse::GetVulnerabilityCount() const
{
    return m_vulnerabilityCount;
}

bool DescribeApmAllVulCountResponse::VulnerabilityCountHasBeenSet() const
{
    return m_vulnerabilityCountHasBeenSet;
}

int64_t DescribeApmAllVulCountResponse::GetImportantVulnerabilityCount() const
{
    return m_importantVulnerabilityCount;
}

bool DescribeApmAllVulCountResponse::ImportantVulnerabilityCountHasBeenSet() const
{
    return m_importantVulnerabilityCountHasBeenSet;
}

int64_t DescribeApmAllVulCountResponse::GetCriticalVulnerabilityCount() const
{
    return m_criticalVulnerabilityCount;
}

bool DescribeApmAllVulCountResponse::CriticalVulnerabilityCountHasBeenSet() const
{
