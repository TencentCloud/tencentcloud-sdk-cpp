...
CoreInternalOutcome DescribeTagValuesResponse::Deserialize(const string &payload)
{
...
string DescribeTagValuesResponse::ToJsonString() const
{
...
vector<string> DescribeTagValuesResponse::GetValues() const
{
    return m_values;
}

bool DescribeTagValuesResponse::ValuesHasBeenSet() const
{
