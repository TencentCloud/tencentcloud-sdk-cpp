...
CoreInternalOutcome DescribeGeneralMetricDataResponse::Deserialize(const string &payload)
{
...
string DescribeGeneralMetricDataResponse::ToJsonString() const
{
...
vector<Line> DescribeGeneralMetricDataResponse::GetRecords() const
{
    return m_records;
}

bool DescribeGeneralMetricDataResponse::RecordsHasBeenSet() const
{
