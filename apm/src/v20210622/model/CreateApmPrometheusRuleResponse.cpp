...
CoreInternalOutcome CreateApmPrometheusRuleResponse::Deserialize(const string &payload)
{
...
string CreateApmPrometheusRuleResponse::ToJsonString() const
{
...
int64_t CreateApmPrometheusRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool CreateApmPrometheusRuleResponse::RuleIdHasBeenSet() const
{
