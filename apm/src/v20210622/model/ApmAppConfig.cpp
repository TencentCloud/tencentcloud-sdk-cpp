...
ApmAppConfig::ApmAppConfig() :
    ...
    m_analysisAutoEnableHasBeenSet(false),
...
CoreInternalOutcome ApmAppConfig::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("DbStatementParametersEnabled") && !value["DbStatementParametersEnabled"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.DbStatementParametersEnabled` IsBool=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SlowSQLThresholds") && !value["SlowSQLThresholds"].IsNull())
    {
        if (!value["SlowSQLThresholds"].IsArray())
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.SlowSQLThresholds` is not array type"));
    ...
    if (value.HasMember("EnableDesensitizationRule") && !value["EnableDesensitizationRule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.EnableDesensitizationRule` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DesensitizationRule") && !value["DesensitizationRule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.DesensitizationRule` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UseDefaultFuseConfig") && !value["UseDefaultFuseConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.UseDefaultFuseConfig` IsBool=false incorrectly").SetRequestId(requestId));
        }
        m_useDefaultFuseConfig = value["UseDefaultFuseConfig"].GetBool();
        m_useDefaultFuseConfigHasBeenSet = true;
    }

    if (value.HasMember("AnalysisAutoEnable") && !value["AnalysisAutoEnable"].IsNull())
    {
        if (!value["AnalysisAutoEnable"].IsBool())
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.AnalysisAutoEnable` IsBool=false incorrectly").SetRequestId(requestId));
        }
        m_analysisAutoEnable = value["AnalysisAutoEnable"].GetBool();
        m_analysisAutoEnableHasBeenSet = true;
    }

    if (value.HasMember("EnableHeadSampler") && !value["EnableHeadSampler"].IsNull())
    {
        if (!value["EnableHeadSampler"].IsBool())
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.EnableHeadSampler` IsBool=false incorrectly").SetRequestId(requestId));
        }
        m_enableHeadSampler = value["EnableHeadSampler"].GetBool();
        m_enableHeadSamplerHasBeenSet = true;
    }

    if (value.HasMember("HeadSamplerType") && !value["HeadSamplerType"].IsNull())
    {
        if (!value["HeadSamplerType"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.HeadSamplerType` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_headSamplerType = string(value["HeadSamplerType"].GetString());
        m_headSamplerTypeHasBeenSet = true;
    }

    if (value.HasMember("HeadSamplerArg") && !value["HeadSamplerArg"].IsNull())
    {
        if (!value["HeadSamplerArg"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.HeadSamplerArg` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_headSamplerArg = value["HeadSamplerArg"].GetInt64();
    ...
    if (value.HasMember("CrossAccountStatus") && !value["CrossAccountStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.CrossAccountStatus` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CrossAccountPeerId") && !value["CrossAccountPeerId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ApmAppConfig.CrossAccountPeerId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void ApmAppConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_analysisAutoEnableHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "AnalysisAutoEnable";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, m_analysisAutoEnable, allocator);
    }
    ...
    if (m_enableHeadSamplerHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, m_enableHeadSampler, allocator);
    }
    ...
    if (m_headSamplerTypeHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_headSamplerType.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_headSamplerArgHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, m_headSamplerArg, allocator);
    }
...
bool ApmAppConfig::GetDbStatementParametersEnabled() const
{
    return m_dbStatementParametersEnabled;
}

void ApmAppConfig::SetDbStatementParametersEnabled(const bool& _dbStatementParametersEnabled)
{
    m_dbStatementParametersEnabled = _dbStatementParametersEnabled;
    m_dbStatementParametersEnabledHasBeenSet = true;
}

bool ApmAppConfig::DbStatementParametersEnabledHasBeenSet() const
{
    return m_dbStatementParametersEnabledHasBeenSet;
}

vector<ApmTag> ApmAppConfig::GetSlowSQLThresholds() const
{
    return m_slowSQLThresholds;
}

void ApmAppConfig::SetSlowSQLThresholds(const vector<ApmTag>& _slowSQLThresholds)
{
    m_slowSQLThresholds = _slowSQLThresholds;
    m_slowSQLThresholdsHasBeenSet = true;
}

bool ApmAppConfig::SlowSQLThresholdsHasBeenSet() const
{
    return m_slowSQLThresholdsHasBeenSet;
}

int64_t ApmAppConfig::GetEnableDesensitizationRule() const
{
    return m_enableDesensitizationRule;
}

void ApmAppConfig::SetEnableDesensitizationRule(const int64_t& _enableDesensitizationRule)
{
    m_enableDesensitizationRule = _enableDesensitizationRule;
    m_enableDesensitizationRuleHasBeenSet = true;
}

bool ApmAppConfig::EnableDesensitizationRuleHasBeenSet() const
{
    return m_enableDesensitizationRuleHasBeenSet;
}

string ApmAppConfig::GetDesensitizationRule() const
{
    return m_desensitizationRule;
}

void ApmAppConfig::SetDesensitizationRule(const string& _desensitizationRule)
{
...
bool ApmAppConfig::GetUseDefaultFuseConfig() const
{
    return m_useDefaultFuseConfig;
}

void ApmAppConfig::SetUseDefaultFuseConfig(const bool& _useDefaultFuseConfig)
{
    m_useDefaultFuseConfig = _useDefaultFuseConfig;
    m_useDefaultFuseConfigHasBeenSet = true;
}

bool ApmAppConfig::UseDefaultFuseConfigHasBeenSet() const
{
    return m_useDefaultFuseConfigHasBeenSet;
}

bool ApmAppConfig::GetAnalysisAutoEnable() const
{
    return m_analysisAutoEnable;
}

void ApmAppConfig::SetAnalysisAutoEnable(const bool& _analysisAutoEnable)
{
    m_analysisAutoEnable = _analysisAutoEnable;
    m_analysisAutoEnableHasBeenSet = true;
}

bool ApmAppConfig::AnalysisAutoEnableHasBeenSet() const
{
    return m_analysisAutoEnableHasBeenSet;
}

bool ApmAppConfig::GetEnableHeadSampler() const
{
    return m_enableHeadSampler;
}

void ApmAppConfig::SetEnableHeadSampler(const bool& _enableHeadSampler)
{
    m_enableHeadSampler = _enableHeadSampler;
    m_enableHeadSamplerHasBeenSet = true;
}

bool ApmAppConfig::EnableHeadSamplerHasBeenSet() const
{
    return m_enableHeadSamplerHasBeenSet;
}

string ApmAppConfig::GetHeadSamplerType() const
{
    return m_headSamplerType;
}

void ApmAppConfig::SetHeadSamplerType(const string& _headSamplerType)
{
    m_headSamplerType = _headSamplerType;
    m_headSamplerTypeHasBeenSet = true;
}

bool ApmAppConfig::HeadSamplerTypeHasBeenSet() const
{
    return m_headSamplerTypeHasBeenSet;
}

int64_t ApmAppConfig::GetHeadSamplerArg() const
{
    return m_headSamplerArg;
}

void ApmAppConfig::SetHeadSamplerArg(const int64_t& _headSamplerArg)
{
    m_headSamplerArg = _headSamplerArg;
    m_headSamplerArgHasBeenSet = true;
}

bool ApmAppConfig::HeadSamplerArgHasBeenSet() const
{
    return m_headSamplerArgHasBeenSet;
}

int64_t ApmAppConfig::GetCrossAccountStatus() const
{
    return m_crossAccountStatus;
}

void ApmAppConfig::SetCrossAccountStatus(const int64_t& _crossAccountStatus)
{
    m_crossAccountStatus = _crossAccountStatus;
    m_crossAccountStatusHasBeenSet = true;
}

bool ApmAppConfig::CrossAccountStatusHasBeenSet() const
{
    return m_crossAccountStatusHasBeenSet;
}

string ApmAppConfig::GetCrossAccountPeerId() const
{
    return m_crossAccountPeerId;
}

void ApmAppConfig::SetCrossAccountPeerId(const string& _crossAccountPeerId)
{
    m_crossAccountPeerId = _crossAccountPeerId;
    m_crossAccountPeerIdHasBeenSet = true;
}

bool ApmAppConfig::CrossAccountPeerIdHasBeenSet() const
{
