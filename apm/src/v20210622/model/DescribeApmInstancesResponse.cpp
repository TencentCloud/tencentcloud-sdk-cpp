...
CoreInternalOutcome DescribeApmInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeApmInstancesResponse::ToJsonString() const
{
...
vector<ApmInstanceDetail> DescribeApmInstancesResponse::GetInstances() const
{
    return m_instances;
}
