...
CoreInternalOutcome DescribeMetricRecordsResponse::Deserialize(const string &payload)
{
...
string DescribeMetricRecordsResponse::ToJsonString() const
{
...
vector<ApmMetricRecord> DescribeMetricRecordsResponse::GetRecords() const
{
    return m_records;
}
