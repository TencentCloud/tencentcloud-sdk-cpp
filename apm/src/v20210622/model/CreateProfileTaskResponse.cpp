...
CoreInternalOutcome CreateProfileTaskResponse::Deserialize(const string &payload)
{
...
string CreateProfileTaskResponse::ToJsonString() const
{
...
int64_t CreateProfileTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateProfileTaskResponse::TaskIdHasBeenSet() const
{
