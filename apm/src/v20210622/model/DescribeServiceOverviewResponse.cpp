...
CoreInternalOutcome DescribeServiceOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeServiceOverviewResponse::ToJsonString() const
{
...
vector<ApmMetricRecord> DescribeServiceOverviewResponse::GetRecords() const
{
    return m_records;
}

bool DescribeServiceOverviewResponse::RecordsHasBeenSet() const
{
