...
#ifndef TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTRESPONSE_H_
#define TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTRESPONSE_H_
    ...
    namespace Apm
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeOPRAllVulCountResponse : public AbstractModel
                {
                public:
                    DescribeOPRAllVulCountResponse();
                    ~DescribeOPRAllVulCountResponse() = default;
...
#endif // !TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTRESPONSE_H_
