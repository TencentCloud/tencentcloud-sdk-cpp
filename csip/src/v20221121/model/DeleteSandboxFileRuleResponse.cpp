...
DeleteSandboxFileRuleResponse::DeleteSandboxFileRuleResponse() :
    m_iDListHasBeenSet(false)
{
}

CoreInternalOutcome DeleteSandboxFileRuleResponse::Deserialize(const string &payload)
{
...
string DeleteSandboxFileRuleResponse::ToJsonString() const
{
...
vector<int64_t> DeleteSandboxFileRuleResponse::GetIDList() const
{
    return m_iDList;
}

bool DeleteSandboxFileRuleResponse::IDListHasBeenSet() const
{
