...
CoreInternalOutcome DescribeRiskCenterServerRiskListResponse::Deserialize(const string &payload)
{
...
string DescribeRiskCenterServerRiskListResponse::ToJsonString() const
{
...
int64_t DescribeRiskCenterServerRiskListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRiskCenterServerRiskListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ServerRisk> DescribeRiskCenterServerRiskListResponse::GetData() const
{
    return m_data;
}

bool DescribeRiskCenterServerRiskListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterServerRiskListResponse::GetInstanceTypeLists() const
{
    return m_instanceTypeLists;
}

bool DescribeRiskCenterServerRiskListResponse::InstanceTypeListsHasBeenSet() const
{
