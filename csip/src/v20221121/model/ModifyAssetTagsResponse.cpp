...
ModifyAssetTagsResponse::ModifyAssetTagsResponse() :
    m_codeHasBeenSet(false),
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAssetTagsResponse::Deserialize(const string &payload)
{
...
string ModifyAssetTagsResponse::ToJsonString() const
{
...
string ModifyAssetTagsResponse::GetCode() const
{
    return m_code;
}

bool ModifyAssetTagsResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string ModifyAssetTagsResponse::GetMessage() const
{
    return m_message;
}

bool ModifyAssetTagsResponse::MessageHasBeenSet() const
{
