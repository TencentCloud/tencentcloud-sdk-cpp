...
DescribeCWPMachinesResponse::DescribeCWPMachinesResponse() :
    m_machinesHasBeenSet(false),
    m_totalHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCWPMachinesResponse::Deserialize(const string &payload)
{
...
string DescribeCWPMachinesResponse::ToJsonString() const
{
...
vector<Machine> DescribeCWPMachinesResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeCWPMachinesResponse::MachinesHasBeenSet() const
{
    return m_machinesHasBeenSet;
}

int64_t DescribeCWPMachinesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCWPMachinesResponse::TotalHasBeenSet() const
{
