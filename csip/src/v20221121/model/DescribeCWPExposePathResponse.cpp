...
DescribeCWPExposePathResponse::DescribeCWPExposePathResponse() :
    m_contentHasBeenSet(false),
    m_pathCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCWPExposePathResponse::Deserialize(const string &payload)
{
...
string DescribeCWPExposePathResponse::ToJsonString() const
{
...
string DescribeCWPExposePathResponse::GetContent() const
{
    return m_content;
}

bool DescribeCWPExposePathResponse::ContentHasBeenSet() const
{
    return m_contentHasBeenSet;
}

uint64_t DescribeCWPExposePathResponse::GetPathCount() const
{
    return m_pathCount;
}

bool DescribeCWPExposePathResponse::PathCountHasBeenSet() const
{
