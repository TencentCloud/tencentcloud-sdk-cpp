...
CreateDspmResourceResponse::CreateDspmResourceResponse() :
    m_resourceIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateDspmResourceResponse::Deserialize(const string &payload)
{
...
string CreateDspmResourceResponse::ToJsonString() const
{
...
string CreateDspmResourceResponse::GetResourceId() const
{
    return m_resourceId;
}

bool CreateDspmResourceResponse::ResourceIdHasBeenSet() const
{
