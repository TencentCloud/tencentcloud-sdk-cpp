...
DescribeImageAssetDetailResponse::DescribeImageAssetDetailResponse() :
    m_detailHasBeenSet(false)
{
}

CoreInternalOutcome DescribeImageAssetDetailResponse::Deserialize(const string &payload)
{
...
string DescribeImageAssetDetailResponse::ToJsonString() const
{
...
ImageAssetDetail DescribeImageAssetDetailResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeImageAssetDetailResponse::DetailHasBeenSet() const
{
