...
string ModifyOrganizationAccountStatusRequest::ToJsonString() const
{
...
int64_t ModifyOrganizationAccountStatusRequest::GetStatus() const
{
    return m_status;
}

void ModifyOrganizationAccountStatusRequest::SetStatus(const int64_t& _status)
{
    m_status = _status;
