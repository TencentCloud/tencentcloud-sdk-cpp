...
CoreInternalOutcome CreateIaCAccessTokenResponse::Deserialize(const string &payload)
{
...
string CreateIaCAccessTokenResponse::ToJsonString() const
{
...
string CreateIaCAccessTokenResponse::GetToken() const
{
    return m_token;
}

bool CreateIaCAccessTokenResponse::TokenHasBeenSet() const
{
