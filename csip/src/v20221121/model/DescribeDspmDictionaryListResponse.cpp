...
DescribeDspmDictionaryListResponse::DescribeDspmDictionaryListResponse() :
    m_dataSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDspmDictionaryListResponse::Deserialize(const string &payload)
{
...
string DescribeDspmDictionaryListResponse::ToJsonString() const
{
...
vector<DspmDictionary> DescribeDspmDictionaryListResponse::GetDataSet() const
{
    return m_dataSet;
}

bool DescribeDspmDictionaryListResponse::DataSetHasBeenSet() const
{
