...
DescribeCSPMPayInfoResponse::DescribeCSPMPayInfoResponse() :
...
CoreInternalOutcome DescribeCSPMPayInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CSPMNum") && !rsp["CSPMNum"].IsNull())
    {
        if (!rsp["CSPMNum"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `CSPMNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_cSPMNum = rsp["CSPMNum"].GetInt64();
    ...
    if (rsp.HasMember("GrantedCSPMNum") && !rsp["GrantedCSPMNum"].IsNull())
    {
        if (!rsp["GrantedCSPMNum"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `GrantedCSPMNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_grantedCSPMNum = rsp["GrantedCSPMNum"].GetInt64();
...
string DescribeCSPMPayInfoResponse::ToJsonString() const
{
...
int64_t DescribeCSPMPayInfoResponse::GetAppID() const
{
    return m_appID;
}

bool DescribeCSPMPayInfoResponse::AppIDHasBeenSet() const
{
    return m_appIDHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetOrderStatus() const
{
    return m_orderStatus;
}

bool DescribeCSPMPayInfoResponse::OrderStatusHasBeenSet() const
{
    return m_orderStatusHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetCSPMNum() const
{
    return m_cSPMNum;
}

bool DescribeCSPMPayInfoResponse::CSPMNumHasBeenSet() const
{
    return m_cSPMNumHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetUsedCount() const
{
    return m_usedCount;
}

bool DescribeCSPMPayInfoResponse::UsedCountHasBeenSet() const
{
    return m_usedCountHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetGrantedCSPMNum() const
{
    return m_grantedCSPMNum;
}

bool DescribeCSPMPayInfoResponse::GrantedCSPMNumHasBeenSet() const
{
    return m_grantedCSPMNumHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetPayMode() const
{
    return m_payMode;
}

bool DescribeCSPMPayInfoResponse::PayModeHasBeenSet() const
{
    return m_payModeHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetIsSelfBuy() const
{
    return m_isSelfBuy;
}

bool DescribeCSPMPayInfoResponse::IsSelfBuyHasBeenSet() const
{
    return m_isSelfBuyHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetBeginTime() const
{
    return m_beginTime;
}

bool DescribeCSPMPayInfoResponse::BeginTimeHasBeenSet() const
{
    return m_beginTimeHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeCSPMPayInfoResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetAutoRenew() const
{
    return m_autoRenew;
}

bool DescribeCSPMPayInfoResponse::AutoRenewHasBeenSet() const
{
    return m_autoRenewHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetTimeSpan() const
{
    return m_timeSpan;
}

bool DescribeCSPMPayInfoResponse::TimeSpanHasBeenSet() const
{
    return m_timeSpanHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetTimeUnit() const
{
    return m_timeUnit;
}

bool DescribeCSPMPayInfoResponse::TimeUnitHasBeenSet() const
{
    return m_timeUnitHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetResourceId() const
{
    return m_resourceId;
}

bool DescribeCSPMPayInfoResponse::ResourceIdHasBeenSet() const
{
    return m_resourceIdHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetBetaEndTime() const
{
    return m_betaEndTime;
}

bool DescribeCSPMPayInfoResponse::BetaEndTimeHasBeenSet() const
{
    return m_betaEndTimeHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetTimeNow() const
{
    return m_timeNow;
}

bool DescribeCSPMPayInfoResponse::TimeNowHasBeenSet() const
{
    return m_timeNowHasBeenSet;
}

int64_t DescribeCSPMPayInfoResponse::GetIsShareToOther() const
{
    return m_isShareToOther;
}

bool DescribeCSPMPayInfoResponse::IsShareToOtherHasBeenSet() const
{
    return m_isShareToOtherHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetUin() const
{
    return m_uin;
}

bool DescribeCSPMPayInfoResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string DescribeCSPMPayInfoResponse::GetNickName() const
{
    return m_nickName;
}

bool DescribeCSPMPayInfoResponse::NickNameHasBeenSet() const
{
