...
CoreInternalOutcome UpdateAlertStatusListResponse::Deserialize(const string &payload)
{
...
string UpdateAlertStatusListResponse::ToJsonString() const
{
...
string UpdateAlertStatusListResponse::GetMsg() const
{
    return m_msg;
}

bool UpdateAlertStatusListResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string UpdateAlertStatusListResponse::GetCode() const
{
    return m_code;
}

bool UpdateAlertStatusListResponse::CodeHasBeenSet() const
{
