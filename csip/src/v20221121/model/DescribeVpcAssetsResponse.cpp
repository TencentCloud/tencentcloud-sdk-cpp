...
CoreInternalOutcome DescribeVpcAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeVpcAssetsResponse::ToJsonString() const
{
...
vector<Vpc> DescribeVpcAssetsResponse::GetData() const
{
    return m_data;
}

bool DescribeVpcAssetsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeVpcAssetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeVpcAssetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<FilterDataObject> DescribeVpcAssetsResponse::GetVpcList() const
{
    return m_vpcList;
}

bool DescribeVpcAssetsResponse::VpcListHasBeenSet() const
{
    return m_vpcListHasBeenSet;
}

vector<FilterDataObject> DescribeVpcAssetsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeVpcAssetsResponse::RegionListHasBeenSet() const
{
    return m_regionListHasBeenSet;
}

vector<FilterDataObject> DescribeVpcAssetsResponse::GetAppIdList() const
{
    return m_appIdList;
}

bool DescribeVpcAssetsResponse::AppIdListHasBeenSet() const
{
