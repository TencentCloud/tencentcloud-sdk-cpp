...
CoreInternalOutcome DescribeGatewayAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeGatewayAssetsResponse::ToJsonString() const
{
...
vector<GateWayAsset> DescribeGatewayAssetsResponse::GetData() const
{
    return m_data;
}

bool DescribeGatewayAssetsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeGatewayAssetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeGatewayAssetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<FilterDataObject> DescribeGatewayAssetsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeGatewayAssetsResponse::RegionListHasBeenSet() const
{
    return m_regionListHasBeenSet;
}

vector<FilterDataObject> DescribeGatewayAssetsResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribeGatewayAssetsResponse::AssetTypeListHasBeenSet() const
{
    return m_assetTypeListHasBeenSet;
}

vector<FilterDataObject> DescribeGatewayAssetsResponse::GetVpcList() const
{
    return m_vpcList;
}

bool DescribeGatewayAssetsResponse::VpcListHasBeenSet() const
{
    return m_vpcListHasBeenSet;
}

vector<FilterDataObject> DescribeGatewayAssetsResponse::GetAppIdList() const
{
    return m_appIdList;
}

bool DescribeGatewayAssetsResponse::AppIdListHasBeenSet() const
{
