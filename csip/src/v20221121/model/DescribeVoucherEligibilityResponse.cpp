...
DescribeVoucherEligibilityResponse::DescribeVoucherEligibilityResponse() :
    m_availableHasBeenSet(false)
{
}

CoreInternalOutcome DescribeVoucherEligibilityResponse::Deserialize(const string &payload)
{
...
string DescribeVoucherEligibilityResponse::ToJsonString() const
{
...
int64_t DescribeVoucherEligibilityResponse::GetAvailable() const
{
    return m_available;
}

bool DescribeVoucherEligibilityResponse::AvailableHasBeenSet() const
{
