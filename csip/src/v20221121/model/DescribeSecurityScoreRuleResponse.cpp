...
DescribeSecurityScoreRuleResponse::DescribeSecurityScoreRuleResponse() :
    m_isDefaultHasBeenSet(false),
    m_rulesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSecurityScoreRuleResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityScoreRuleResponse::ToJsonString() const
{
...
bool DescribeSecurityScoreRuleResponse::GetIsDefault() const
{
    return m_isDefault;
}

bool DescribeSecurityScoreRuleResponse::IsDefaultHasBeenSet() const
{
    return m_isDefaultHasBeenSet;
}

vector<ScoreRuleItem> DescribeSecurityScoreRuleResponse::GetRules() const
{
    return m_rules;
}

bool DescribeSecurityScoreRuleResponse::RulesHasBeenSet() const
{
