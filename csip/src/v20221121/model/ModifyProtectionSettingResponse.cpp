...
ModifyProtectionSettingResponse::ModifyProtectionSettingResponse() :
    m_failListHasBeenSet(false)
{
}

CoreInternalOutcome ModifyProtectionSettingResponse::Deserialize(const string &payload)
{
...
string ModifyProtectionSettingResponse::ToJsonString() const
{
...
vector<string> ModifyProtectionSettingResponse::GetFailList() const
{
    return m_failList;
}

bool ModifyProtectionSettingResponse::FailListHasBeenSet() const
{
