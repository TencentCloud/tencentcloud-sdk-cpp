...
CoreInternalOutcome ModifyUebaRuleSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyUebaRuleSwitchResponse::ToJsonString() const
{
...
int64_t ModifyUebaRuleSwitchResponse::GetCode() const
{
    return m_code;
}

bool ModifyUebaRuleSwitchResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string ModifyUebaRuleSwitchResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyUebaRuleSwitchResponse::MsgHasBeenSet() const
{
