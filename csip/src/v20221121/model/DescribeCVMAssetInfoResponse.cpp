...
CoreInternalOutcome DescribeCVMAssetInfoResponse::Deserialize(const string &payload)
{
...
string DescribeCVMAssetInfoResponse::ToJsonString() const
{
...
AssetBaseInfoResponse DescribeCVMAssetInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeCVMAssetInfoResponse::DataHasBeenSet() const
{
