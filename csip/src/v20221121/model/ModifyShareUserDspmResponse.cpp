...
ModifyShareUserDspmResponse::ModifyShareUserDspmResponse() :
    m_resultHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyShareUserDspmResponse::Deserialize(const string &payload)
{
...
string ModifyShareUserDspmResponse::ToJsonString() const
{
...
int64_t ModifyShareUserDspmResponse::GetResult() const
{
    return m_result;
}

bool ModifyShareUserDspmResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ModifyShareUserDspmResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyShareUserDspmResponse::MsgHasBeenSet() const
{
