...
CoreInternalOutcome DescribeSearchBugInfoResponse::Deserialize(const string &payload)
{
...
string DescribeSearchBugInfoResponse::ToJsonString() const
{
...
DataSearchBug DescribeSearchBugInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeSearchBugInfoResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeSearchBugInfoResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeSearchBugInfoResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeSearchBugInfoResponse::GetReturnMsg() const
{
    return m_returnMsg;
}

bool DescribeSearchBugInfoResponse::ReturnMsgHasBeenSet() const
{
