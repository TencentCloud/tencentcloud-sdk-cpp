...
vector<string> DescribeOtherCloudAssetsRequest::GetMemberId() const
{
    return m_memberId;
}

void DescribeOtherCloudAssetsRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool DescribeOtherCloudAssetsRequest::MemberIdHasBeenSet() const
{
