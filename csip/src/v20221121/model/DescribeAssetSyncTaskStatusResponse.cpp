...
DescribeAssetSyncTaskStatusResponse::DescribeAssetSyncTaskStatusResponse() :
    m_taskStatusHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAssetSyncTaskStatusResponse::Deserialize(const string &payload)
{
...
string DescribeAssetSyncTaskStatusResponse::ToJsonString() const
{
...
string DescribeAssetSyncTaskStatusResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeAssetSyncTaskStatusResponse::TaskStatusHasBeenSet() const
{
