...
vector<string> ModifyMachineAutoClearConfigRequest::GetMemberId() const
{
    return m_memberId;
}

void ModifyMachineAutoClearConfigRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool ModifyMachineAutoClearConfigRequest::MemberIdHasBeenSet() const
{
