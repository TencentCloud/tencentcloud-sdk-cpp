...
DescribeSkillScanAlertListResponse::DescribeSkillScanAlertListResponse() :
...
CoreInternalOutcome DescribeSkillScanAlertListResponse::Deserialize(const string &payload)
{
...
string DescribeSkillScanAlertListResponse::ToJsonString() const
{
...
int64_t DescribeSkillScanAlertListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSkillScanAlertListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SkillScanAlertItem> DescribeSkillScanAlertListResponse::GetAlertList() const
{
    return m_alertList;
}

bool DescribeSkillScanAlertListResponse::AlertListHasBeenSet() const
{
    return m_alertListHasBeenSet;
}

vector<SkillRuleCatalogItem> DescribeSkillScanAlertListResponse::GetRuleCatalog() const
{
    return m_ruleCatalog;
}

bool DescribeSkillScanAlertListResponse::RuleCatalogHasBeenSet() const
{
