...
DescribeHostVulOverviewResponse::DescribeHostVulOverviewResponse() :
    m_overviewHasBeenSet(false)
{
}

CoreInternalOutcome DescribeHostVulOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeHostVulOverviewResponse::ToJsonString() const
{
...
HostVulOverview DescribeHostVulOverviewResponse::GetOverview() const
{
    return m_overview;
}

bool DescribeHostVulOverviewResponse::OverviewHasBeenSet() const
{
