...
CoreInternalOutcome DescribeTaskLogListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("NotViewNumber") && !rsp["NotViewNumber"].IsNull())
    {
        if (!rsp["NotViewNumber"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `NotViewNumber` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_notViewNumber = rsp["NotViewNumber"].GetInt64();
...
string DescribeTaskLogListResponse::ToJsonString() const
{
...
int64_t DescribeTaskLogListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTaskLogListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TaskLogInfo> DescribeTaskLogListResponse::GetData() const
{
    return m_data;
}

bool DescribeTaskLogListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeTaskLogListResponse::GetNotViewNumber() const
{
    return m_notViewNumber;
}
