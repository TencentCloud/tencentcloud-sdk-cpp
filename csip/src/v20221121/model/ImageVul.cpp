...
#include <tencentcloud/csip/v20221121/model/ImageVul.h>
...
CoreInternalOutcome ImageVul::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("OwnerAccountName") && !value["OwnerAccountName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.OwnerAccountName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OwnerUin") && !value["OwnerUin"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.OwnerUin` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OwnerAppId") && !value["OwnerAppId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.OwnerAppId` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ID") && !value["ID"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.ID` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("FirstFoundTime") && !value["FirstFoundTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.FirstFoundTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LatestFoundTime") && !value["LatestFoundTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.LatestFoundTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VulInfo") && !value["VulInfo"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.VulInfo` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageId") && !value["ImageId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageVul.ImageId` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string ImageVul::GetOwnerAccountName() const
{
    return m_ownerAccountName;
}

void ImageVul::SetOwnerAccountName(const string& _ownerAccountName)
{
    m_ownerAccountName = _ownerAccountName;
    m_ownerAccountNameHasBeenSet = true;
}

bool ImageVul::OwnerAccountNameHasBeenSet() const
{
    return m_ownerAccountNameHasBeenSet;
}

string ImageVul::GetOwnerUin() const
{
    return m_ownerUin;
}

void ImageVul::SetOwnerUin(const string& _ownerUin)
{
    m_ownerUin = _ownerUin;
    m_ownerUinHasBeenSet = true;
}

bool ImageVul::OwnerUinHasBeenSet() const
{
    return m_ownerUinHasBeenSet;
}

uint64_t ImageVul::GetOwnerAppId() const
{
    return m_ownerAppId;
}

void ImageVul::SetOwnerAppId(const uint64_t& _ownerAppId)
{
    m_ownerAppId = _ownerAppId;
    m_ownerAppIdHasBeenSet = true;
}

bool ImageVul::OwnerAppIdHasBeenSet() const
{
    return m_ownerAppIdHasBeenSet;
}

uint64_t ImageVul::GetID() const
{
    return m_iD;
}

void ImageVul::SetID(const uint64_t& _iD)
{
    m_iD = _iD;
    m_iDHasBeenSet = true;
}

bool ImageVul::IDHasBeenSet() const
{
    return m_iDHasBeenSet;
}

string ImageVul::GetFirstFoundTime() const
{
    return m_firstFoundTime;
}

void ImageVul::SetFirstFoundTime(const string& _firstFoundTime)
{
    m_firstFoundTime = _firstFoundTime;
    m_firstFoundTimeHasBeenSet = true;
}

bool ImageVul::FirstFoundTimeHasBeenSet() const
{
    return m_firstFoundTimeHasBeenSet;
}

string ImageVul::GetLatestFoundTime() const
{
    return m_latestFoundTime;
}

void ImageVul::SetLatestFoundTime(const string& _latestFoundTime)
{
    m_latestFoundTime = _latestFoundTime;
    m_latestFoundTimeHasBeenSet = true;
}

bool ImageVul::LatestFoundTimeHasBeenSet() const
{
    return m_latestFoundTimeHasBeenSet;
}

ImageVulBaseInfo ImageVul::GetVulInfo() const
{
    return m_vulInfo;
}

void ImageVul::SetVulInfo(const ImageVulBaseInfo& _vulInfo)
{
    m_vulInfo = _vulInfo;
    m_vulInfoHasBeenSet = true;
}

bool ImageVul::VulInfoHasBeenSet() const
{
    return m_vulInfoHasBeenSet;
}

string ImageVul::GetImageId() const
{
    return m_imageId;
}

void ImageVul::SetImageId(const string& _imageId)
{
    m_imageId = _imageId;
    m_imageIdHasBeenSet = true;
}

bool ImageVul::ImageIdHasBeenSet() const
{
