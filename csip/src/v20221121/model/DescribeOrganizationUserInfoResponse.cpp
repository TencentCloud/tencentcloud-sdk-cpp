...
CoreInternalOutcome DescribeOrganizationUserInfoResponse::Deserialize(const string &payload)
{
...
string DescribeOrganizationUserInfoResponse::ToJsonString() const
{
...
uint64_t DescribeOrganizationUserInfoResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeOrganizationUserInfoResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<OrganizationUserInfo> DescribeOrganizationUserInfoResponse::GetData() const
{
    return m_data;
}
