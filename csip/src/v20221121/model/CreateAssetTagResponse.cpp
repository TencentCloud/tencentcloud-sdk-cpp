...
CreateAssetTagResponse::CreateAssetTagResponse() :
    m_codeHasBeenSet(false),
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome CreateAssetTagResponse::Deserialize(const string &payload)
{
...
string CreateAssetTagResponse::ToJsonString() const
{
...
string CreateAssetTagResponse::GetCode() const
{
    return m_code;
}

bool CreateAssetTagResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string CreateAssetTagResponse::GetMessage() const
{
    return m_message;
}

bool CreateAssetTagResponse::MessageHasBeenSet() const
{
