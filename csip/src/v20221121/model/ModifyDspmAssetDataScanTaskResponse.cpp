...
ModifyDspmAssetDataScanTaskResponse::ModifyDspmAssetDataScanTaskResponse() :
    m_taskIdSetHasBeenSet(false)
{
}

CoreInternalOutcome ModifyDspmAssetDataScanTaskResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TaskIdSet") && !rsp["TaskIdSet"].IsNull())
    {
        ...
        {
            m_taskIdSet.push_back((*itr).GetUint64());
        }
...
string ModifyDspmAssetDataScanTaskResponse::ToJsonString() const
{
...
vector<uint64_t> ModifyDspmAssetDataScanTaskResponse::GetTaskIdSet() const
{
    return m_taskIdSet;
}

bool ModifyDspmAssetDataScanTaskResponse::TaskIdSetHasBeenSet() const
{
