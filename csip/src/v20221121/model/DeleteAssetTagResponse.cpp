...
DeleteAssetTagResponse::DeleteAssetTagResponse() :
    m_codeHasBeenSet(false),
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome DeleteAssetTagResponse::Deserialize(const string &payload)
{
...
string DeleteAssetTagResponse::ToJsonString() const
{
...
string DeleteAssetTagResponse::GetCode() const
{
    return m_code;
}

bool DeleteAssetTagResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string DeleteAssetTagResponse::GetMessage() const
{
    return m_message;
}

bool DeleteAssetTagResponse::MessageHasBeenSet() const
{
