...
string DescribeDspmStatisticsRequest::ToJsonString() const
{
...
vector<string> DescribeDspmStatisticsRequest::GetMemberId() const
{
    return m_memberId;
}

void DescribeDspmStatisticsRequest::SetMemberId(const vector<string>& _memberId)
{
