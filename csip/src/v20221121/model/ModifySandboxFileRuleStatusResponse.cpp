...
ModifySandboxFileRuleStatusResponse::ModifySandboxFileRuleStatusResponse() :
    m_iDListHasBeenSet(false)
{
}

CoreInternalOutcome ModifySandboxFileRuleStatusResponse::Deserialize(const string &payload)
{
...
string ModifySandboxFileRuleStatusResponse::ToJsonString() const
{
...
vector<int64_t> ModifySandboxFileRuleStatusResponse::GetIDList() const
{
    return m_iDList;
}

bool ModifySandboxFileRuleStatusResponse::IDListHasBeenSet() const
{
