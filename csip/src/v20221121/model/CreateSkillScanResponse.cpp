...
CoreInternalOutcome CreateSkillScanResponse::Deserialize(const string &payload)
{
...
string CreateSkillScanResponse::ToJsonString() const
{
...
string CreateSkillScanResponse::GetContentHash() const
{
    return m_contentHash;
}

bool CreateSkillScanResponse::ContentHashHasBeenSet() const
{
    return m_contentHashHasBeenSet;
}

int64_t CreateSkillScanResponse::GetEngineVersion() const
{
    return m_engineVersion;
}

bool CreateSkillScanResponse::EngineVersionHasBeenSet() const
{
    return m_engineVersionHasBeenSet;
}

string CreateSkillScanResponse::GetStatus() const
{
    return m_status;
}

bool CreateSkillScanResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateSkillScanResponse::GetMessage() const
{
    return m_message;
}

bool CreateSkillScanResponse::MessageHasBeenSet() const
{
