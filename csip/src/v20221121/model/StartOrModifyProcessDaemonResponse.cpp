...
StartOrModifyProcessDaemonResponse::StartOrModifyProcessDaemonResponse() :
    m_failedHostCountHasBeenSet(false)
{
}

CoreInternalOutcome StartOrModifyProcessDaemonResponse::Deserialize(const string &payload)
{
...
string StartOrModifyProcessDaemonResponse::ToJsonString() const
{
...
uint64_t StartOrModifyProcessDaemonResponse::GetFailedHostCount() const
{
    return m_failedHostCount;
}

bool StartOrModifyProcessDaemonResponse::FailedHostCountHasBeenSet() const
{
