...
CoreInternalOutcome CreateDomainAndIpResponse::Deserialize(const string &payload)
{
...
string CreateDomainAndIpResponse::ToJsonString() const
{
...
int64_t CreateDomainAndIpResponse::GetData() const
{
    return m_data;
}

bool CreateDomainAndIpResponse::DataHasBeenSet() const
{
