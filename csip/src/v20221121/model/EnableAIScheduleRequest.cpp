...
EnableAIScheduleRequest::EnableAIScheduleRequest() :
    m_scheduleIdHasBeenSet(false)
{
}

string EnableAIScheduleRequest::ToJsonString() const
{
...
string EnableAIScheduleRequest::GetScheduleId() const
{
    return m_scheduleId;
}

void EnableAIScheduleRequest::SetScheduleId(const string& _scheduleId)
{
    m_scheduleId = _scheduleId;
    m_scheduleIdHasBeenSet = true;
}

bool EnableAIScheduleRequest::ScheduleIdHasBeenSet() const
{
