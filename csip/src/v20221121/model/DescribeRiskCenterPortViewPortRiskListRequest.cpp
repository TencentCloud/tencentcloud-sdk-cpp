...
vector<string> DescribeRiskCenterPortViewPortRiskListRequest::GetMemberId() const
{
    return m_memberId;
}

void DescribeRiskCenterPortViewPortRiskListRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool DescribeRiskCenterPortViewPortRiskListRequest::MemberIdHasBeenSet() const
{
