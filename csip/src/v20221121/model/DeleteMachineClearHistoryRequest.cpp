...
vector<string> DeleteMachineClearHistoryRequest::GetMemberId() const
{
    return m_memberId;
}

void DeleteMachineClearHistoryRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool DeleteMachineClearHistoryRequest::MemberIdHasBeenSet() const
{
