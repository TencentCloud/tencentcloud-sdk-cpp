...
CheckRiskResponse::CheckRiskResponse() :
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome CheckRiskResponse::Deserialize(const string &payload)
{
...
string CheckRiskResponse::ToJsonString() const
{
...
string CheckRiskResponse::GetMessage() const
{
    return m_message;
}

bool CheckRiskResponse::MessageHasBeenSet() const
{
