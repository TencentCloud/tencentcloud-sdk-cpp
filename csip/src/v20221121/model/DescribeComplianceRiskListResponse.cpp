...
DescribeComplianceRiskListResponse::DescribeComplianceRiskListResponse() :
...
CoreInternalOutcome DescribeComplianceRiskListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CheckViewRiskList") && !rsp["CheckViewRiskList"].IsNull())
    {
        if (!rsp["CheckViewRiskList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `CheckViewRiskList` is not array type"));

        const rapidjson::Value &tmpValue = rsp["CheckViewRiskList"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            CheckViewRiskItem item;
            ...
            m_checkViewRiskList.push_back(item);
        }
...
string DescribeComplianceRiskListResponse::ToJsonString() const
{
    ...
    if (m_checkViewRiskListHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "CheckViewRiskList";
        iKey.SetString(key.c_str(), allocator);
...
int64_t DescribeComplianceRiskListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeComplianceRiskListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CheckViewRiskItem> DescribeComplianceRiskListResponse::GetCheckViewRiskList() const
{
    return m_checkViewRiskList;
}

bool DescribeComplianceRiskListResponse::CheckViewRiskListHasBeenSet() const
{
    return m_checkViewRiskListHasBeenSet;
}

vector<AttributeOptionSet> DescribeComplianceRiskListResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribeComplianceRiskListResponse::AssetTypeListHasBeenSet() const
{
    return m_assetTypeListHasBeenSet;
}

vector<AttributeOptionSet> DescribeComplianceRiskListResponse::GetProviderList() const
{
    return m_providerList;
}

bool DescribeComplianceRiskListResponse::ProviderListHasBeenSet() const
{
