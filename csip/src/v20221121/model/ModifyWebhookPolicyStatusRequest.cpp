...
string ModifyWebhookPolicyStatusRequest::GetStatus() const
{
    return m_status;
}

void ModifyWebhookPolicyStatusRequest::SetStatus(const string& _status)
{
    m_status = _status;
    m_statusHasBeenSet = true;
}

bool ModifyWebhookPolicyStatusRequest::StatusHasBeenSet() const
{
