...
DescribeEdrExportJobDownloadURLResponse::DescribeEdrExportJobDownloadURLResponse() :
    m_downloadUrlHasBeenSet(false),
    m_fileNameHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEdrExportJobDownloadURLResponse::Deserialize(const string &payload)
{
...
string DescribeEdrExportJobDownloadURLResponse::ToJsonString() const
{
...
string DescribeEdrExportJobDownloadURLResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeEdrExportJobDownloadURLResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string DescribeEdrExportJobDownloadURLResponse::GetFileName() const
{
    return m_fileName;
}

bool DescribeEdrExportJobDownloadURLResponse::FileNameHasBeenSet() const
{
