...
CoreInternalOutcome DescribeExposePathResponse::Deserialize(const string &payload)
{
...
string DescribeExposePathResponse::ToJsonString() const
{
...
string DescribeExposePathResponse::GetContent() const
{
    return m_content;
}
