...
CreateDspmRiskStrategyResponse::CreateDspmRiskStrategyResponse() :
    m_strategyIdHasBeenSet(false),
    m_strategyTypeHasBeenSet(false)
{
}

CoreInternalOutcome CreateDspmRiskStrategyResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["StrategyId"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `StrategyId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_strategyId = rsp["StrategyId"].GetInt64();
...
string CreateDspmRiskStrategyResponse::ToJsonString() const
{
...
int64_t CreateDspmRiskStrategyResponse::GetStrategyId() const
{
    return m_strategyId;
}

bool CreateDspmRiskStrategyResponse::StrategyIdHasBeenSet() const
{
    return m_strategyIdHasBeenSet;
}

string CreateDspmRiskStrategyResponse::GetStrategyType() const
{
    return m_strategyType;
}

bool CreateDspmRiskStrategyResponse::StrategyTypeHasBeenSet() const
{
