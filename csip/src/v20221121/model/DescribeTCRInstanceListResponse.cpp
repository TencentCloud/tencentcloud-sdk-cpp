...
DescribeTCRInstanceListResponse::DescribeTCRInstanceListResponse() :
    m_registriesHasBeenSet(false),
    m_totalCountHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTCRInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeTCRInstanceListResponse::ToJsonString() const
{
...
vector<TcrRegistry> DescribeTCRInstanceListResponse::GetRegistries() const
{
    return m_registries;
}

bool DescribeTCRInstanceListResponse::RegistriesHasBeenSet() const
{
    return m_registriesHasBeenSet;
}

uint64_t DescribeTCRInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTCRInstanceListResponse::TotalCountHasBeenSet() const
{
