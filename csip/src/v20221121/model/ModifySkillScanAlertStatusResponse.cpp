...
ModifySkillScanAlertStatusResponse::ModifySkillScanAlertStatusResponse() :
    m_successCountHasBeenSet(false)
{
}

CoreInternalOutcome ModifySkillScanAlertStatusResponse::Deserialize(const string &payload)
{
...
string ModifySkillScanAlertStatusResponse::ToJsonString() const
{
...
int64_t ModifySkillScanAlertStatusResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool ModifySkillScanAlertStatusResponse::SuccessCountHasBeenSet() const
{
