...
vector<string> AddLoginWhiteListsRequest::GetMemberId() const
{
    return m_memberId;
}

void AddLoginWhiteListsRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool AddLoginWhiteListsRequest::MemberIdHasBeenSet() const
{
