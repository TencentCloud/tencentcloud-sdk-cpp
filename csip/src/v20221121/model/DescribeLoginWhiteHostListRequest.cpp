...
vector<string> DescribeLoginWhiteHostListRequest::GetMemberId() const
{
    return m_memberId;
}

void DescribeLoginWhiteHostListRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool DescribeLoginWhiteHostListRequest::MemberIdHasBeenSet() const
{
