...
DescribeCspmShardConfigResponse::DescribeCspmShardConfigResponse() :
...
CoreInternalOutcome DescribeCspmShardConfigResponse::Deserialize(const string &payload)
{
...
string DescribeCspmShardConfigResponse::ToJsonString() const
{
...
uint64_t DescribeCspmShardConfigResponse::GetShardFromAppID() const
{
    return m_shardFromAppID;
}

bool DescribeCspmShardConfigResponse::ShardFromAppIDHasBeenSet() const
{
    return m_shardFromAppIDHasBeenSet;
}

uint64_t DescribeCspmShardConfigResponse::GetAutoShardStatus() const
{
    return m_autoShardStatus;
}

bool DescribeCspmShardConfigResponse::AutoShardStatusHasBeenSet() const
{
    return m_autoShardStatusHasBeenSet;
}

vector<uint64_t> DescribeCspmShardConfigResponse::GetShardAppIDs() const
{
    return m_shardAppIDs;
}

bool DescribeCspmShardConfigResponse::ShardAppIDsHasBeenSet() const
{
