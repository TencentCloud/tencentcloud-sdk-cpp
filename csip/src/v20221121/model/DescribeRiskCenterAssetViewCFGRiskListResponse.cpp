...
CoreInternalOutcome DescribeRiskCenterAssetViewCFGRiskListResponse::Deserialize(const string &payload)
{
...
string DescribeRiskCenterAssetViewCFGRiskListResponse::ToJsonString() const
{
...
int64_t DescribeRiskCenterAssetViewCFGRiskListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AssetViewCFGRisk> DescribeRiskCenterAssetViewCFGRiskListResponse::GetData() const
{
    return m_data;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetStatusLists() const
{
    return m_statusLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::StatusListsHasBeenSet() const
{
    return m_statusListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetLevelLists() const
{
    return m_levelLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::LevelListsHasBeenSet() const
{
    return m_levelListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetCFGNameLists() const
{
    return m_cFGNameLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::CFGNameListsHasBeenSet() const
{
    return m_cFGNameListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetCheckTypeLists() const
{
    return m_checkTypeLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::CheckTypeListsHasBeenSet() const
{
    return m_checkTypeListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetInstanceTypeLists() const
{
    return m_instanceTypeLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::InstanceTypeListsHasBeenSet() const
{
    return m_instanceTypeListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterAssetViewCFGRiskListResponse::GetFromLists() const
{
    return m_fromLists;
}

bool DescribeRiskCenterAssetViewCFGRiskListResponse::FromListsHasBeenSet() const
{
