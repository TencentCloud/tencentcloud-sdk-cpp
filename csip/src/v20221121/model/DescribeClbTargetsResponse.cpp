...
DescribeClbTargetsResponse::DescribeClbTargetsResponse() :
    m_targetsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeClbTargetsResponse::Deserialize(const string &payload)
{
...
string DescribeClbTargetsResponse::ToJsonString() const
{
...
vector<ClbTargetItem> DescribeClbTargetsResponse::GetTargets() const
{
    return m_targets;
}

bool DescribeClbTargetsResponse::TargetsHasBeenSet() const
{
