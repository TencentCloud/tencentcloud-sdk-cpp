...
DescribePreventUninstallGlobalConfResponse::DescribePreventUninstallGlobalConfResponse() :
...
CoreInternalOutcome DescribePreventUninstallGlobalConfResponse::Deserialize(const string &payload)
{
...
string DescribePreventUninstallGlobalConfResponse::ToJsonString() const
{
...
uint64_t DescribePreventUninstallGlobalConfResponse::GetEnable() const
{
    return m_enable;
}

bool DescribePreventUninstallGlobalConfResponse::EnableHasBeenSet() const
{
    return m_enableHasBeenSet;
}

uint64_t DescribePreventUninstallGlobalConfResponse::GetScope() const
{
    return m_scope;
}

bool DescribePreventUninstallGlobalConfResponse::ScopeHasBeenSet() const
{
    return m_scopeHasBeenSet;
}

uint64_t DescribePreventUninstallGlobalConfResponse::GetIncludeHostCount() const
{
    return m_includeHostCount;
}

bool DescribePreventUninstallGlobalConfResponse::IncludeHostCountHasBeenSet() const
{
    return m_includeHostCountHasBeenSet;
}

uint64_t DescribePreventUninstallGlobalConfResponse::GetExcludeHostCount() const
{
    return m_excludeHostCount;
}

bool DescribePreventUninstallGlobalConfResponse::ExcludeHostCountHasBeenSet() const
{
    return m_excludeHostCountHasBeenSet;
}

vector<string> DescribePreventUninstallGlobalConfResponse::GetIncludeQuuid() const
{
    return m_includeQuuid;
}

bool DescribePreventUninstallGlobalConfResponse::IncludeQuuidHasBeenSet() const
{
    return m_includeQuuidHasBeenSet;
}

vector<string> DescribePreventUninstallGlobalConfResponse::GetExcludeQuuid() const
{
    return m_excludeQuuid;
}

bool DescribePreventUninstallGlobalConfResponse::ExcludeQuuidHasBeenSet() const
{
    return m_excludeQuuidHasBeenSet;
}

uint64_t DescribePreventUninstallGlobalConfResponse::GetEnableCount() const
{
    return m_enableCount;
}

bool DescribePreventUninstallGlobalConfResponse::EnableCountHasBeenSet() const
{
    return m_enableCountHasBeenSet;
}

uint64_t DescribePreventUninstallGlobalConfResponse::GetDisableCount() const
{
    return m_disableCount;
}

bool DescribePreventUninstallGlobalConfResponse::DisableCountHasBeenSet() const
{
