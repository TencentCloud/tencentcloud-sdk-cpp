...
DeleteDspmShareUserDataResponse::DeleteDspmShareUserDataResponse() :
    m_resultHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome DeleteDspmShareUserDataResponse::Deserialize(const string &payload)
{
...
string DeleteDspmShareUserDataResponse::ToJsonString() const
{
...
int64_t DeleteDspmShareUserDataResponse::GetResult() const
{
    return m_result;
}

bool DeleteDspmShareUserDataResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string DeleteDspmShareUserDataResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteDspmShareUserDataResponse::MsgHasBeenSet() const
{
