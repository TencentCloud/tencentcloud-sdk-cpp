...
CoreInternalOutcome NodeInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Key") && !value["Key"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `NodeInfo.Key` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `NodeInfo.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string NodeInfo::GetKey() const
{
    return m_key;
}

void NodeInfo::SetKey(const string& _key)
{
    m_key = _key;
    m_keyHasBeenSet = true;
}

bool NodeInfo::KeyHasBeenSet() const
{
    return m_keyHasBeenSet;
}

string NodeInfo::GetValue() const
{
    return m_value;
}

void NodeInfo::SetValue(const string& _value)
{
    m_value = _value;
    m_valueHasBeenSet = true;
}

bool NodeInfo::ValueHasBeenSet() const
{
