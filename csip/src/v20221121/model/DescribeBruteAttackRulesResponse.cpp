...
CoreInternalOutcome DescribeBruteAttackRulesResponse::Deserialize(const string &payload)
{
...
string DescribeBruteAttackRulesResponse::ToJsonString() const
{
...
vector<BruteAttackRuleList> DescribeBruteAttackRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeBruteAttackRulesResponse::RulesHasBeenSet() const
{
