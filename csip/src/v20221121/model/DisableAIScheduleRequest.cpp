...
DisableAIScheduleRequest::DisableAIScheduleRequest() :
    m_scheduleIdHasBeenSet(false)
{
}

string DisableAIScheduleRequest::ToJsonString() const
{
...
string DisableAIScheduleRequest::GetScheduleId() const
{
    return m_scheduleId;
}

void DisableAIScheduleRequest::SetScheduleId(const string& _scheduleId)
{
    m_scheduleId = _scheduleId;
    m_scheduleIdHasBeenSet = true;
}

bool DisableAIScheduleRequest::ScheduleIdHasBeenSet() const
{
