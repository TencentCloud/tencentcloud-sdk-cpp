...
DescribeProcessDaemonGlobalConfResponse::DescribeProcessDaemonGlobalConfResponse() :
...
CoreInternalOutcome DescribeProcessDaemonGlobalConfResponse::Deserialize(const string &payload)
{
...
string DescribeProcessDaemonGlobalConfResponse::ToJsonString() const
{
...
uint64_t DescribeProcessDaemonGlobalConfResponse::GetEnable() const
{
    return m_enable;
}

bool DescribeProcessDaemonGlobalConfResponse::EnableHasBeenSet() const
{
    return m_enableHasBeenSet;
}

uint64_t DescribeProcessDaemonGlobalConfResponse::GetScope() const
{
    return m_scope;
}

bool DescribeProcessDaemonGlobalConfResponse::ScopeHasBeenSet() const
{
    return m_scopeHasBeenSet;
}

uint64_t DescribeProcessDaemonGlobalConfResponse::GetIncludeHostCount() const
{
    return m_includeHostCount;
}

bool DescribeProcessDaemonGlobalConfResponse::IncludeHostCountHasBeenSet() const
{
    return m_includeHostCountHasBeenSet;
}

uint64_t DescribeProcessDaemonGlobalConfResponse::GetExcludeHostCount() const
{
    return m_excludeHostCount;
}

bool DescribeProcessDaemonGlobalConfResponse::ExcludeHostCountHasBeenSet() const
{
    return m_excludeHostCountHasBeenSet;
}

vector<string> DescribeProcessDaemonGlobalConfResponse::GetIncludeQuuid() const
{
    return m_includeQuuid;
}

bool DescribeProcessDaemonGlobalConfResponse::IncludeQuuidHasBeenSet() const
{
    return m_includeQuuidHasBeenSet;
}

vector<string> DescribeProcessDaemonGlobalConfResponse::GetExcludeQuuid() const
{
    return m_excludeQuuid;
}

bool DescribeProcessDaemonGlobalConfResponse::ExcludeQuuidHasBeenSet() const
{
    return m_excludeQuuidHasBeenSet;
}

uint64_t DescribeProcessDaemonGlobalConfResponse::GetEnableCount() const
{
    return m_enableCount;
}

bool DescribeProcessDaemonGlobalConfResponse::EnableCountHasBeenSet() const
{
    return m_enableCountHasBeenSet;
}

uint64_t DescribeProcessDaemonGlobalConfResponse::GetDisableCount() const
{
    return m_disableCount;
}

bool DescribeProcessDaemonGlobalConfResponse::DisableCountHasBeenSet() const
{
