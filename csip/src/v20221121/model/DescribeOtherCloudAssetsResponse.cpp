...
CoreInternalOutcome DescribeOtherCloudAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeOtherCloudAssetsResponse::ToJsonString() const
{
...
uint64_t DescribeOtherCloudAssetsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeOtherCloudAssetsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DBAssetVO> DescribeOtherCloudAssetsResponse::GetData() const
{
    return m_data;
}

bool DescribeOtherCloudAssetsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

vector<FilterDataObject> DescribeOtherCloudAssetsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeOtherCloudAssetsResponse::RegionListHasBeenSet() const
{
    return m_regionListHasBeenSet;
}

vector<FilterDataObject> DescribeOtherCloudAssetsResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribeOtherCloudAssetsResponse::AssetTypeListHasBeenSet() const
{
    return m_assetTypeListHasBeenSet;
}

vector<FilterDataObject> DescribeOtherCloudAssetsResponse::GetVpcList() const
{
    return m_vpcList;
}

bool DescribeOtherCloudAssetsResponse::VpcListHasBeenSet() const
{
    return m_vpcListHasBeenSet;
}

vector<FilterDataObject> DescribeOtherCloudAssetsResponse::GetAppIdList() const
{
    return m_appIdList;
}

bool DescribeOtherCloudAssetsResponse::AppIdListHasBeenSet() const
{
