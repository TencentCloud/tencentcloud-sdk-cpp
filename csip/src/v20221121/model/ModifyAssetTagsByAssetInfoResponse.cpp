...
ModifyAssetTagsByAssetInfoResponse::ModifyAssetTagsByAssetInfoResponse() :
    m_codeHasBeenSet(false),
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAssetTagsByAssetInfoResponse::Deserialize(const string &payload)
{
...
string ModifyAssetTagsByAssetInfoResponse::ToJsonString() const
{
...
string ModifyAssetTagsByAssetInfoResponse::GetCode() const
{
    return m_code;
}

bool ModifyAssetTagsByAssetInfoResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string ModifyAssetTagsByAssetInfoResponse::GetMessage() const
{
    return m_message;
}

bool ModifyAssetTagsByAssetInfoResponse::MessageHasBeenSet() const
{
