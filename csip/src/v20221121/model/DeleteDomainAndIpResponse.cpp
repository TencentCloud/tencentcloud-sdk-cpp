...
CoreInternalOutcome DeleteDomainAndIpResponse::Deserialize(const string &payload)
{
...
string DeleteDomainAndIpResponse::ToJsonString() const
{
...
int64_t DeleteDomainAndIpResponse::GetData() const
{
    return m_data;
}

bool DeleteDomainAndIpResponse::DataHasBeenSet() const
{
