...
DescribeClusterInstallCommandResponse::DescribeClusterInstallCommandResponse() :
...
CoreInternalOutcome DescribeClusterInstallCommandResponse::Deserialize(const string &payload)
{
...
string DescribeClusterInstallCommandResponse::ToJsonString() const
{
...
string DescribeClusterInstallCommandResponse::GetCommand() const
{
    return m_command;
}

bool DescribeClusterInstallCommandResponse::CommandHasBeenSet() const
{
    return m_commandHasBeenSet;
}

string DescribeClusterInstallCommandResponse::GetURL() const
{
    return m_uRL;
}

bool DescribeClusterInstallCommandResponse::URLHasBeenSet() const
{
    return m_uRLHasBeenSet;
}

string DescribeClusterInstallCommandResponse::GetFileContent() const
{
    return m_fileContent;
}

bool DescribeClusterInstallCommandResponse::FileContentHasBeenSet() const
{
