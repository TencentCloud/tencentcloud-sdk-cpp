...
CoreInternalOutcome DescribeRiskCenterVULViewVULRiskListResponse::Deserialize(const string &payload)
{
...
string DescribeRiskCenterVULViewVULRiskListResponse::ToJsonString() const
{
...
int64_t DescribeRiskCenterVULViewVULRiskListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRiskCenterVULViewVULRiskListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<VULViewVULRisk> DescribeRiskCenterVULViewVULRiskListResponse::GetData() const
{
    return m_data;
}

bool DescribeRiskCenterVULViewVULRiskListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterVULViewVULRiskListResponse::GetLevelLists() const
{
    return m_levelLists;
}

bool DescribeRiskCenterVULViewVULRiskListResponse::LevelListsHasBeenSet() const
{
    return m_levelListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterVULViewVULRiskListResponse::GetFromLists() const
{
    return m_fromLists;
}

bool DescribeRiskCenterVULViewVULRiskListResponse::FromListsHasBeenSet() const
{
    return m_fromListsHasBeenSet;
}

vector<FilterDataObject> DescribeRiskCenterVULViewVULRiskListResponse::GetVULTypeLists() const
{
    return m_vULTypeLists;
}

bool DescribeRiskCenterVULViewVULRiskListResponse::VULTypeListsHasBeenSet() const
{
