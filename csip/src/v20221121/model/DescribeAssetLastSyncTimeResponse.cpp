...
DescribeAssetLastSyncTimeResponse::DescribeAssetLastSyncTimeResponse() :
    m_lastSyncTimeHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAssetLastSyncTimeResponse::Deserialize(const string &payload)
{
...
string DescribeAssetLastSyncTimeResponse::ToJsonString() const
{
...
string DescribeAssetLastSyncTimeResponse::GetLastSyncTime() const
{
    return m_lastSyncTime;
}

bool DescribeAssetLastSyncTimeResponse::LastSyncTimeHasBeenSet() const
{
