...
CoreInternalOutcome DescribeAssetViewVulRiskListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetViewVulRiskListResponse::ToJsonString() const
{
...
int64_t DescribeAssetViewVulRiskListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAssetViewVulRiskListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AssetViewVULRiskData> DescribeAssetViewVulRiskListResponse::GetData() const
{
    return m_data;
}

bool DescribeAssetViewVulRiskListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetStatusLists() const
{
    return m_statusLists;
}

bool DescribeAssetViewVulRiskListResponse::StatusListsHasBeenSet() const
{
    return m_statusListsHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetLevelLists() const
{
    return m_levelLists;
}

bool DescribeAssetViewVulRiskListResponse::LevelListsHasBeenSet() const
{
    return m_levelListsHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetFromLists() const
{
    return m_fromLists;
}

bool DescribeAssetViewVulRiskListResponse::FromListsHasBeenSet() const
{
    return m_fromListsHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetVULTypeLists() const
{
    return m_vULTypeLists;
}

bool DescribeAssetViewVulRiskListResponse::VULTypeListsHasBeenSet() const
{
    return m_vULTypeListsHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetInstanceTypeLists() const
{
    return m_instanceTypeLists;
}

bool DescribeAssetViewVulRiskListResponse::InstanceTypeListsHasBeenSet() const
{
    return m_instanceTypeListsHasBeenSet;
}

vector<FilterDataObject> DescribeAssetViewVulRiskListResponse::GetTags() const
{
    return m_tags;
}

bool DescribeAssetViewVulRiskListResponse::TagsHasBeenSet() const
{
