...
DescribePublicCloudAssetsResponse::DescribePublicCloudAssetsResponse() :
...
CoreInternalOutcome DescribePublicCloudAssetsResponse::Deserialize(const string &payload)
{
...
string DescribePublicCloudAssetsResponse::ToJsonString() const
{
...
int64_t DescribePublicCloudAssetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePublicCloudAssetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<PublicAssetInfo> DescribePublicCloudAssetsResponse::GetAssets() const
{
    return m_assets;
}

bool DescribePublicCloudAssetsResponse::AssetsHasBeenSet() const
{
    return m_assetsHasBeenSet;
}

vector<AttributeOptionSet> DescribePublicCloudAssetsResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribePublicCloudAssetsResponse::AssetTypeListHasBeenSet() const
{
    return m_assetTypeListHasBeenSet;
}

vector<AttributeOptionSet> DescribePublicCloudAssetsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribePublicCloudAssetsResponse::RegionListHasBeenSet() const
{
