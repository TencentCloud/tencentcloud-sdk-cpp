...
CoreInternalOutcome UpdateAccessKeyAlarmStatusResponse::Deserialize(const string &payload)
{
...
string UpdateAccessKeyAlarmStatusResponse::ToJsonString() const
{
...
int64_t UpdateAccessKeyAlarmStatusResponse::GetCode() const
{
    return m_code;
}

bool UpdateAccessKeyAlarmStatusResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string UpdateAccessKeyAlarmStatusResponse::GetMsg() const
{
    return m_msg;
}

bool UpdateAccessKeyAlarmStatusResponse::MsgHasBeenSet() const
{
