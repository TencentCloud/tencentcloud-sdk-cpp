...
DescribeLastScanTaskInfoResponse::DescribeLastScanTaskInfoResponse() :
    m_taskInfoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLastScanTaskInfoResponse::Deserialize(const string &payload)
{
...
string DescribeLastScanTaskInfoResponse::ToJsonString() const
{
...
TaskInfo DescribeLastScanTaskInfoResponse::GetTaskInfo() const
{
    return m_taskInfo;
}

bool DescribeLastScanTaskInfoResponse::TaskInfoHasBeenSet() const
{
