...
DescribeCWPExposuresResponse::DescribeCWPExposuresResponse() :
    m_totalCountHasBeenSet(false),
    m_exposeListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCWPExposuresResponse::Deserialize(const string &payload)
{
...
string DescribeCWPExposuresResponse::ToJsonString() const
{
...
int64_t DescribeCWPExposuresResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCWPExposuresResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ExposesItem> DescribeCWPExposuresResponse::GetExposeList() const
{
    return m_exposeList;
}

bool DescribeCWPExposuresResponse::ExposeListHasBeenSet() const
{
