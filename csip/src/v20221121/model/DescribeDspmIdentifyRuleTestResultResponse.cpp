...
DescribeDspmIdentifyRuleTestResultResponse::DescribeDspmIdentifyRuleTestResultResponse() :
    m_isMatchHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDspmIdentifyRuleTestResultResponse::Deserialize(const string &payload)
{
...
string DescribeDspmIdentifyRuleTestResultResponse::ToJsonString() const
{
...
bool DescribeDspmIdentifyRuleTestResultResponse::GetIsMatch() const
{
    return m_isMatch;
}

bool DescribeDspmIdentifyRuleTestResultResponse::IsMatchHasBeenSet() const
{
