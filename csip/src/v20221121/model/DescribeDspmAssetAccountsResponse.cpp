...
DescribeDspmAssetAccountsResponse::DescribeDspmAssetAccountsResponse() :
    m_totalCountHasBeenSet(false),
    m_accountSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeDspmAssetAccountsResponse::Deserialize(const string &payload)
{
...
string DescribeDspmAssetAccountsResponse::ToJsonString() const
{
...
int64_t DescribeDspmAssetAccountsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDspmAssetAccountsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DspmAssetAccount> DescribeDspmAssetAccountsResponse::GetAccountSet() const
{
    return m_accountSet;
}

bool DescribeDspmAssetAccountsResponse::AccountSetHasBeenSet() const
{
