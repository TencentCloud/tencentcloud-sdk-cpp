...
CoreInternalOutcome DescribeNICAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeNICAssetsResponse::ToJsonString() const
{
...
vector<NICAsset> DescribeNICAssetsResponse::GetData() const
{
    return m_data;
}

bool DescribeNICAssetsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeNICAssetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeNICAssetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<FilterDataObject> DescribeNICAssetsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeNICAssetsResponse::RegionListHasBeenSet() const
{
    return m_regionListHasBeenSet;
}

vector<FilterDataObject> DescribeNICAssetsResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribeNICAssetsResponse::AssetTypeListHasBeenSet() const
{
    return m_assetTypeListHasBeenSet;
}

vector<FilterDataObject> DescribeNICAssetsResponse::GetVpcList() const
{
    return m_vpcList;
}

bool DescribeNICAssetsResponse::VpcListHasBeenSet() const
{
    return m_vpcListHasBeenSet;
}

vector<FilterDataObject> DescribeNICAssetsResponse::GetAppIdList() const
{
    return m_appIdList;
}

bool DescribeNICAssetsResponse::AppIdListHasBeenSet() const
{
