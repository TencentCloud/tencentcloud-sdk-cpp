...
DescribeCloudAssetsResponse::DescribeCloudAssetsResponse() :
...
CoreInternalOutcome DescribeCloudAssetsResponse::Deserialize(const string &payload)
{
...
string DescribeCloudAssetsResponse::ToJsonString() const
{
...
int64_t DescribeCloudAssetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCloudAssetsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<AssetItem> DescribeCloudAssetsResponse::GetAssets() const
{
    return m_assets;
}

bool DescribeCloudAssetsResponse::AssetsHasBeenSet() const
{
    return m_assetsHasBeenSet;
}

vector<AttributeOptionSet> DescribeCloudAssetsResponse::GetAssetTypeList() const
{
    return m_assetTypeList;
}

bool DescribeCloudAssetsResponse::AssetTypeListHasBeenSet() const
{
