...
CreateAssetSyncTaskResponse::CreateAssetSyncTaskResponse() :
    m_taskIDsHasBeenSet(false)
{
}

CoreInternalOutcome CreateAssetSyncTaskResponse::Deserialize(const string &payload)
{
...
string CreateAssetSyncTaskResponse::ToJsonString() const
{
...
vector<string> CreateAssetSyncTaskResponse::GetTaskIDs() const
{
    return m_taskIDs;
}

bool CreateAssetSyncTaskResponse::TaskIDsHasBeenSet() const
{
