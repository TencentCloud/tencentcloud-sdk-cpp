...
DescribeCosAuditDictionaryListResponse::DescribeCosAuditDictionaryListResponse() :
    m_dataSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeCosAuditDictionaryListResponse::Deserialize(const string &payload)
{
...
string DescribeCosAuditDictionaryListResponse::ToJsonString() const
{
...
vector<CosDictionary> DescribeCosAuditDictionaryListResponse::GetDataSet() const
{
    return m_dataSet;
}

bool DescribeCosAuditDictionaryListResponse::DataSetHasBeenSet() const
{
