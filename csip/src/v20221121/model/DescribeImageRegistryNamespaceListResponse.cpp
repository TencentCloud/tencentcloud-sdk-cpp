...
CoreInternalOutcome DescribeImageRegistryNamespaceListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("NamespaceList") && !rsp["NamespaceList"].IsNull())
    {
        ...
        {
            ImageRegistryNamespaceInfo item;
...
string DescribeImageRegistryNamespaceListResponse::ToJsonString() const
{
...
uint64_t DescribeImageRegistryNamespaceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeImageRegistryNamespaceListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ImageRegistryNamespaceInfo> DescribeImageRegistryNamespaceListResponse::GetNamespaceList() const
{
