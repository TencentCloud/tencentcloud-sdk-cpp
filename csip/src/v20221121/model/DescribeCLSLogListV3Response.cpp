...
DescribeCLSLogListV3Response::DescribeCLSLogListV3Response() :
...
CoreInternalOutcome DescribeCLSLogListV3Response::Deserialize(const string &payload)
{
...
string DescribeCLSLogListV3Response::ToJsonString() const
{
...
string DescribeCLSLogListV3Response::GetContext() const
{
    return m_context;
}

bool DescribeCLSLogListV3Response::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool DescribeCLSLogListV3Response::GetListOver() const
{
    return m_listOver;
}

bool DescribeCLSLogListV3Response::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

bool DescribeCLSLogListV3Response::GetAnalysis() const
{
    return m_analysis;
}

bool DescribeCLSLogListV3Response::AnalysisHasBeenSet() const
{
    return m_analysisHasBeenSet;
}

vector<LogSearchResult> DescribeCLSLogListV3Response::GetResults() const
{
    return m_results;
}

bool DescribeCLSLogListV3Response::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

vector<string> DescribeCLSLogListV3Response::GetColNames() const
{
    return m_colNames;
}

bool DescribeCLSLogListV3Response::ColNamesHasBeenSet() const
{
    return m_colNamesHasBeenSet;
}

vector<LogItems> DescribeCLSLogListV3Response::GetAnalysisResults() const
{
    return m_analysisResults;
}

bool DescribeCLSLogListV3Response::AnalysisResultsHasBeenSet() const
{
    return m_analysisResultsHasBeenSet;
}

vector<string> DescribeCLSLogListV3Response::GetAnalysisRecords() const
{
    return m_analysisRecords;
}

bool DescribeCLSLogListV3Response::AnalysisRecordsHasBeenSet() const
{
    return m_analysisRecordsHasBeenSet;
}

vector<LogColumn> DescribeCLSLogListV3Response::GetColumns() const
{
    return m_columns;
}

bool DescribeCLSLogListV3Response::ColumnsHasBeenSet() const
{
    return m_columnsHasBeenSet;
}

double DescribeCLSLogListV3Response::GetSamplingRate() const
{
    return m_samplingRate;
}

bool DescribeCLSLogListV3Response::SamplingRateHasBeenSet() const
{
    return m_samplingRateHasBeenSet;
}

LogSearchTopics DescribeCLSLogListV3Response::GetTopics() const
{
    return m_topics;
}

bool DescribeCLSLogListV3Response::TopicsHasBeenSet() const
{
