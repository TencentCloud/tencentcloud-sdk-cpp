...
CreateDspmPersonalIdentifyResponse::CreateDspmPersonalIdentifyResponse() :
    m_personIdHasBeenSet(false),
    m_identifyIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateDspmPersonalIdentifyResponse::Deserialize(const string &payload)
{
...
string CreateDspmPersonalIdentifyResponse::ToJsonString() const
{
...
string CreateDspmPersonalIdentifyResponse::GetPersonId() const
{
    return m_personId;
}

bool CreateDspmPersonalIdentifyResponse::PersonIdHasBeenSet() const
{
    return m_personIdHasBeenSet;
}

string CreateDspmPersonalIdentifyResponse::GetIdentifyId() const
{
    return m_identifyId;
}

bool CreateDspmPersonalIdentifyResponse::IdentifyIdHasBeenSet() const
{
