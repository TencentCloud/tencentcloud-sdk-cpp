...
ModifyShareUserAKResponse::ModifyShareUserAKResponse() :
    m_resultHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyShareUserAKResponse::Deserialize(const string &payload)
{
...
string ModifyShareUserAKResponse::ToJsonString() const
{
...
int64_t ModifyShareUserAKResponse::GetResult() const
{
    return m_result;
}

bool ModifyShareUserAKResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ModifyShareUserAKResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyShareUserAKResponse::MsgHasBeenSet() const
{
