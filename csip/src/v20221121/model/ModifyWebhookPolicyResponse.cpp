...
CoreInternalOutcome ModifyWebhookPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyWebhookPolicyResponse::ToJsonString() const
{
...
int64_t ModifyWebhookPolicyResponse::GetID() const
{
    return m_iD;
}

bool ModifyWebhookPolicyResponse::IDHasBeenSet() const
{
