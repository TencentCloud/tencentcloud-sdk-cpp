...
CoreInternalOutcome DescribeDbAssetInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDbAssetInfoResponse::ToJsonString() const
{
...
DbAssetInfo DescribeDbAssetInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeDbAssetInfoResponse::DataHasBeenSet() const
{
