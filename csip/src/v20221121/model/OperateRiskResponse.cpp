...
OperateRiskResponse::OperateRiskResponse() :
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome OperateRiskResponse::Deserialize(const string &payload)
{
...
string OperateRiskResponse::ToJsonString() const
{
...
string OperateRiskResponse::GetMessage() const
{
    return m_message;
}

bool OperateRiskResponse::MessageHasBeenSet() const
{
