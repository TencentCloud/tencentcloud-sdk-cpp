...
vector<string> ModifyLoginWhiteRecordRequest::GetMemberId() const
{
    return m_memberId;
}

void ModifyLoginWhiteRecordRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool ModifyLoginWhiteRecordRequest::MemberIdHasBeenSet() const
{
