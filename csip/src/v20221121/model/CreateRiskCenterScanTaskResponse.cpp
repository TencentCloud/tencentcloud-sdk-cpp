...
CoreInternalOutcome CreateRiskCenterScanTaskResponse::Deserialize(const string &payload)
{
...
string CreateRiskCenterScanTaskResponse::ToJsonString() const
{
...
string CreateRiskCenterScanTaskResponse::GetTaskId() const
{
    return m_taskId;
}
