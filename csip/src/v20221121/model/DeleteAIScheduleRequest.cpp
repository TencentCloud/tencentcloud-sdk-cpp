...
DeleteAIScheduleRequest::DeleteAIScheduleRequest() :
    m_scheduleIdHasBeenSet(false)
{
}

string DeleteAIScheduleRequest::ToJsonString() const
{
...
string DeleteAIScheduleRequest::GetScheduleId() const
{
    return m_scheduleId;
}

void DeleteAIScheduleRequest::SetScheduleId(const string& _scheduleId)
{
    m_scheduleId = _scheduleId;
    m_scheduleIdHasBeenSet = true;
}

bool DeleteAIScheduleRequest::ScheduleIdHasBeenSet() const
{
