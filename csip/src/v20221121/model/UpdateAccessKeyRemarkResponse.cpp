...
CoreInternalOutcome UpdateAccessKeyRemarkResponse::Deserialize(const string &payload)
{
...
string UpdateAccessKeyRemarkResponse::ToJsonString() const
{
...
int64_t UpdateAccessKeyRemarkResponse::GetCode() const
{
    return m_code;
}

bool UpdateAccessKeyRemarkResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string UpdateAccessKeyRemarkResponse::GetMsg() const
{
    return m_msg;
}

bool UpdateAccessKeyRemarkResponse::MsgHasBeenSet() const
{
