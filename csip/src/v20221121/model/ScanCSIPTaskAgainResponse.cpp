...
ScanCSIPTaskAgainResponse::ScanCSIPTaskAgainResponse() :
    m_successCountHasBeenSet(false),
    m_taskIdHasBeenSet(false)
{
}

CoreInternalOutcome ScanCSIPTaskAgainResponse::Deserialize(const string &payload)
{
...
string ScanCSIPTaskAgainResponse::ToJsonString() const
{
...
uint64_t ScanCSIPTaskAgainResponse::GetSuccessCount() const
{
    return m_successCount;
}

bool ScanCSIPTaskAgainResponse::SuccessCountHasBeenSet() const
{
    return m_successCountHasBeenSet;
}

uint64_t ScanCSIPTaskAgainResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanCSIPTaskAgainResponse::TaskIdHasBeenSet() const
{
