...
#include <tencentcloud/csip/v20221121/model/ImageAssetDetail.h>
...
CoreInternalOutcome ImageAssetDetail::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ImageDigest") && !value["ImageDigest"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageDigest` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageRepoAddress") && !value["ImageRepoAddress"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageRepoAddress` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegistryType") && !value["RegistryType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.RegistryType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageName") && !value["ImageName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageTag") && !value["ImageTag"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageTag` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LatestScanTime") && !value["LatestScanTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.LatestScanTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ScanStatus") && !value["ScanStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ScanStatus` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VulCnt") && !value["VulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.VulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("VirusCnt") && !value["VirusCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.VirusCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SensitiveCnt") && !value["SensitiveCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.SensitiveCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceId") && !value["InstanceId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.InstanceId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("InstanceName") && !value["InstanceName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.InstanceName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Namespace") && !value["Namespace"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.Namespace` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("IsAuthorized") && !value["IsAuthorized"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.IsAuthorized` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageSize") && !value["ImageSize"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageSize` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageId") && !value["ImageId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RegistryRegion") && !value["RegistryRegion"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.RegistryRegion` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ImageCreateTime") && !value["ImageCreateTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.ImageCreateTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Id") && !value["Id"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.Id` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OwnerAccountName") && !value["OwnerAccountName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.OwnerAccountName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OwnerUin") && !value["OwnerUin"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.OwnerUin` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OwnerAppId") && !value["OwnerAppId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.OwnerAppId` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LowLevelVulCnt") && !value["LowLevelVulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.LowLevelVulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediumLevelVulCnt") && !value["MediumLevelVulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.MediumLevelVulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HighLevelVulCnt") && !value["HighLevelVulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.HighLevelVulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CriticalLevelVulCnt") && !value["CriticalLevelVulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.CriticalLevelVulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LowLevelVirusCnt") && !value["LowLevelVirusCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.LowLevelVirusCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediumLevelVirusCnt") && !value["MediumLevelVirusCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.MediumLevelVirusCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HighLevelVirusCnt") && !value["HighLevelVirusCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.HighLevelVirusCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CriticalLevelVirusCnt") && !value["CriticalLevelVirusCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.CriticalLevelVirusCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EmergencyVulCnt") && !value["EmergencyVulCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.EmergencyVulCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LowLevelSensitiveCnt") && !value["LowLevelSensitiveCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.LowLevelSensitiveCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MediumLevelSensitiveCnt") && !value["MediumLevelSensitiveCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.MediumLevelSensitiveCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("HighLevelSensitiveCnt") && !value["HighLevelSensitiveCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.HighLevelSensitiveCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CriticalLevelSensitiveCnt") && !value["CriticalLevelSensitiveCnt"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `ImageAssetDetail.CriticalLevelSensitiveCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void ImageAssetDetail::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string ImageAssetDetail::GetImageDigest() const
{
    return m_imageDigest;
}

void ImageAssetDetail::SetImageDigest(const string& _imageDigest)
{
    m_imageDigest = _imageDigest;
    m_imageDigestHasBeenSet = true;
}

bool ImageAssetDetail::ImageDigestHasBeenSet() const
{
    return m_imageDigestHasBeenSet;
}

string ImageAssetDetail::GetImageRepoAddress() const
{
    return m_imageRepoAddress;
}

void ImageAssetDetail::SetImageRepoAddress(const string& _imageRepoAddress)
{
    m_imageRepoAddress = _imageRepoAddress;
    m_imageRepoAddressHasBeenSet = true;
}

bool ImageAssetDetail::ImageRepoAddressHasBeenSet() const
{
    return m_imageRepoAddressHasBeenSet;
}

string ImageAssetDetail::GetRegistryType() const
{
    return m_registryType;
}

void ImageAssetDetail::SetRegistryType(const string& _registryType)
{
    m_registryType = _registryType;
    m_registryTypeHasBeenSet = true;
}

bool ImageAssetDetail::RegistryTypeHasBeenSet() const
{
    return m_registryTypeHasBeenSet;
}

string ImageAssetDetail::GetImageName() const
{
    return m_imageName;
}

void ImageAssetDetail::SetImageName(const string& _imageName)
{
    m_imageName = _imageName;
    m_imageNameHasBeenSet = true;
}

bool ImageAssetDetail::ImageNameHasBeenSet() const
{
    return m_imageNameHasBeenSet;
}

string ImageAssetDetail::GetImageTag() const
{
    return m_imageTag;
}

void ImageAssetDetail::SetImageTag(const string& _imageTag)
{
    m_imageTag = _imageTag;
    m_imageTagHasBeenSet = true;
}

bool ImageAssetDetail::ImageTagHasBeenSet() const
{
    return m_imageTagHasBeenSet;
}

string ImageAssetDetail::GetLatestScanTime() const
{
    return m_latestScanTime;
}

void ImageAssetDetail::SetLatestScanTime(const string& _latestScanTime)
{
    m_latestScanTime = _latestScanTime;
    m_latestScanTimeHasBeenSet = true;
}

bool ImageAssetDetail::LatestScanTimeHasBeenSet() const
{
    return m_latestScanTimeHasBeenSet;
}

uint64_t ImageAssetDetail::GetScanStatus() const
{
    return m_scanStatus;
}

void ImageAssetDetail::SetScanStatus(const uint64_t& _scanStatus)
{
    m_scanStatus = _scanStatus;
    m_scanStatusHasBeenSet = true;
}

bool ImageAssetDetail::ScanStatusHasBeenSet() const
{
    return m_scanStatusHasBeenSet;
}

uint64_t ImageAssetDetail::GetVulCnt() const
{
    return m_vulCnt;
}

void ImageAssetDetail::SetVulCnt(const uint64_t& _vulCnt)
{
    m_vulCnt = _vulCnt;
    m_vulCntHasBeenSet = true;
}

bool ImageAssetDetail::VulCntHasBeenSet() const
{
    return m_vulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetVirusCnt() const
{
    return m_virusCnt;
}

void ImageAssetDetail::SetVirusCnt(const uint64_t& _virusCnt)
{
    m_virusCnt = _virusCnt;
    m_virusCntHasBeenSet = true;
}

bool ImageAssetDetail::VirusCntHasBeenSet() const
{
    return m_virusCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetSensitiveCnt() const
{
    return m_sensitiveCnt;
}

void ImageAssetDetail::SetSensitiveCnt(const uint64_t& _sensitiveCnt)
{
    m_sensitiveCnt = _sensitiveCnt;
    m_sensitiveCntHasBeenSet = true;
}

bool ImageAssetDetail::SensitiveCntHasBeenSet() const
{
    return m_sensitiveCntHasBeenSet;
}

string ImageAssetDetail::GetInstanceId() const
{
    return m_instanceId;
}

void ImageAssetDetail::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool ImageAssetDetail::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

string ImageAssetDetail::GetInstanceName() const
{
    return m_instanceName;
}

void ImageAssetDetail::SetInstanceName(const string& _instanceName)
{
    m_instanceName = _instanceName;
    m_instanceNameHasBeenSet = true;
}

bool ImageAssetDetail::InstanceNameHasBeenSet() const
{
    return m_instanceNameHasBeenSet;
}

string ImageAssetDetail::GetNamespace() const
{
    return m_namespace;
}

void ImageAssetDetail::SetNamespace(const string& _namespace)
{
    m_namespace = _namespace;
    m_namespaceHasBeenSet = true;
}

bool ImageAssetDetail::NamespaceHasBeenSet() const
{
    return m_namespaceHasBeenSet;
}

uint64_t ImageAssetDetail::GetIsAuthorized() const
{
    return m_isAuthorized;
}

void ImageAssetDetail::SetIsAuthorized(const uint64_t& _isAuthorized)
{
    m_isAuthorized = _isAuthorized;
    m_isAuthorizedHasBeenSet = true;
}

bool ImageAssetDetail::IsAuthorizedHasBeenSet() const
{
    return m_isAuthorizedHasBeenSet;
}

uint64_t ImageAssetDetail::GetImageSize() const
{
    return m_imageSize;
}

void ImageAssetDetail::SetImageSize(const uint64_t& _imageSize)
{
    m_imageSize = _imageSize;
    m_imageSizeHasBeenSet = true;
}

bool ImageAssetDetail::ImageSizeHasBeenSet() const
{
    return m_imageSizeHasBeenSet;
}

string ImageAssetDetail::GetImageId() const
{
    return m_imageId;
}

void ImageAssetDetail::SetImageId(const string& _imageId)
{
    m_imageId = _imageId;
    m_imageIdHasBeenSet = true;
}

bool ImageAssetDetail::ImageIdHasBeenSet() const
{
    return m_imageIdHasBeenSet;
}

string ImageAssetDetail::GetRegistryRegion() const
{
    return m_registryRegion;
}

void ImageAssetDetail::SetRegistryRegion(const string& _registryRegion)
{
    m_registryRegion = _registryRegion;
    m_registryRegionHasBeenSet = true;
}

bool ImageAssetDetail::RegistryRegionHasBeenSet() const
{
    return m_registryRegionHasBeenSet;
}

string ImageAssetDetail::GetImageCreateTime() const
{
    return m_imageCreateTime;
}

void ImageAssetDetail::SetImageCreateTime(const string& _imageCreateTime)
{
    m_imageCreateTime = _imageCreateTime;
    m_imageCreateTimeHasBeenSet = true;
}

bool ImageAssetDetail::ImageCreateTimeHasBeenSet() const
{
    return m_imageCreateTimeHasBeenSet;
}

string ImageAssetDetail::GetId() const
{
    return m_id;
}

void ImageAssetDetail::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool ImageAssetDetail::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string ImageAssetDetail::GetOwnerAccountName() const
{
    return m_ownerAccountName;
}

void ImageAssetDetail::SetOwnerAccountName(const string& _ownerAccountName)
{
    m_ownerAccountName = _ownerAccountName;
    m_ownerAccountNameHasBeenSet = true;
}

bool ImageAssetDetail::OwnerAccountNameHasBeenSet() const
{
    return m_ownerAccountNameHasBeenSet;
}

string ImageAssetDetail::GetOwnerUin() const
{
    return m_ownerUin;
}

void ImageAssetDetail::SetOwnerUin(const string& _ownerUin)
{
    m_ownerUin = _ownerUin;
    m_ownerUinHasBeenSet = true;
}

bool ImageAssetDetail::OwnerUinHasBeenSet() const
{
    return m_ownerUinHasBeenSet;
}

uint64_t ImageAssetDetail::GetOwnerAppId() const
{
    return m_ownerAppId;
}

void ImageAssetDetail::SetOwnerAppId(const uint64_t& _ownerAppId)
{
    m_ownerAppId = _ownerAppId;
    m_ownerAppIdHasBeenSet = true;
}

bool ImageAssetDetail::OwnerAppIdHasBeenSet() const
{
    return m_ownerAppIdHasBeenSet;
}

uint64_t ImageAssetDetail::GetLowLevelVulCnt() const
{
    return m_lowLevelVulCnt;
}

void ImageAssetDetail::SetLowLevelVulCnt(const uint64_t& _lowLevelVulCnt)
{
    m_lowLevelVulCnt = _lowLevelVulCnt;
    m_lowLevelVulCntHasBeenSet = true;
}

bool ImageAssetDetail::LowLevelVulCntHasBeenSet() const
{
    return m_lowLevelVulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetMediumLevelVulCnt() const
{
    return m_mediumLevelVulCnt;
}

void ImageAssetDetail::SetMediumLevelVulCnt(const uint64_t& _mediumLevelVulCnt)
{
    m_mediumLevelVulCnt = _mediumLevelVulCnt;
    m_mediumLevelVulCntHasBeenSet = true;
}

bool ImageAssetDetail::MediumLevelVulCntHasBeenSet() const
{
    return m_mediumLevelVulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetHighLevelVulCnt() const
{
    return m_highLevelVulCnt;
}

void ImageAssetDetail::SetHighLevelVulCnt(const uint64_t& _highLevelVulCnt)
{
    m_highLevelVulCnt = _highLevelVulCnt;
    m_highLevelVulCntHasBeenSet = true;
}

bool ImageAssetDetail::HighLevelVulCntHasBeenSet() const
{
    return m_highLevelVulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetCriticalLevelVulCnt() const
{
    return m_criticalLevelVulCnt;
}

void ImageAssetDetail::SetCriticalLevelVulCnt(const uint64_t& _criticalLevelVulCnt)
{
    m_criticalLevelVulCnt = _criticalLevelVulCnt;
    m_criticalLevelVulCntHasBeenSet = true;
}

bool ImageAssetDetail::CriticalLevelVulCntHasBeenSet() const
{
    return m_criticalLevelVulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetLowLevelVirusCnt() const
{
    return m_lowLevelVirusCnt;
}

void ImageAssetDetail::SetLowLevelVirusCnt(const uint64_t& _lowLevelVirusCnt)
{
    m_lowLevelVirusCnt = _lowLevelVirusCnt;
    m_lowLevelVirusCntHasBeenSet = true;
}

bool ImageAssetDetail::LowLevelVirusCntHasBeenSet() const
{
    return m_lowLevelVirusCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetMediumLevelVirusCnt() const
{
    return m_mediumLevelVirusCnt;
}

void ImageAssetDetail::SetMediumLevelVirusCnt(const uint64_t& _mediumLevelVirusCnt)
{
    m_mediumLevelVirusCnt = _mediumLevelVirusCnt;
    m_mediumLevelVirusCntHasBeenSet = true;
}

bool ImageAssetDetail::MediumLevelVirusCntHasBeenSet() const
{
    return m_mediumLevelVirusCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetHighLevelVirusCnt() const
{
    return m_highLevelVirusCnt;
}

void ImageAssetDetail::SetHighLevelVirusCnt(const uint64_t& _highLevelVirusCnt)
{
    m_highLevelVirusCnt = _highLevelVirusCnt;
    m_highLevelVirusCntHasBeenSet = true;
}

bool ImageAssetDetail::HighLevelVirusCntHasBeenSet() const
{
    return m_highLevelVirusCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetCriticalLevelVirusCnt() const
{
    return m_criticalLevelVirusCnt;
}

void ImageAssetDetail::SetCriticalLevelVirusCnt(const uint64_t& _criticalLevelVirusCnt)
{
    m_criticalLevelVirusCnt = _criticalLevelVirusCnt;
    m_criticalLevelVirusCntHasBeenSet = true;
}

bool ImageAssetDetail::CriticalLevelVirusCntHasBeenSet() const
{
    return m_criticalLevelVirusCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetEmergencyVulCnt() const
{
    return m_emergencyVulCnt;
}

void ImageAssetDetail::SetEmergencyVulCnt(const uint64_t& _emergencyVulCnt)
{
    m_emergencyVulCnt = _emergencyVulCnt;
    m_emergencyVulCntHasBeenSet = true;
}

bool ImageAssetDetail::EmergencyVulCntHasBeenSet() const
{
    return m_emergencyVulCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetLowLevelSensitiveCnt() const
{
    return m_lowLevelSensitiveCnt;
}

void ImageAssetDetail::SetLowLevelSensitiveCnt(const uint64_t& _lowLevelSensitiveCnt)
{
    m_lowLevelSensitiveCnt = _lowLevelSensitiveCnt;
    m_lowLevelSensitiveCntHasBeenSet = true;
}

bool ImageAssetDetail::LowLevelSensitiveCntHasBeenSet() const
{
    return m_lowLevelSensitiveCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetMediumLevelSensitiveCnt() const
{
    return m_mediumLevelSensitiveCnt;
}

void ImageAssetDetail::SetMediumLevelSensitiveCnt(const uint64_t& _mediumLevelSensitiveCnt)
{
    m_mediumLevelSensitiveCnt = _mediumLevelSensitiveCnt;
    m_mediumLevelSensitiveCntHasBeenSet = true;
}

bool ImageAssetDetail::MediumLevelSensitiveCntHasBeenSet() const
{
    return m_mediumLevelSensitiveCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetHighLevelSensitiveCnt() const
{
    return m_highLevelSensitiveCnt;
}

void ImageAssetDetail::SetHighLevelSensitiveCnt(const uint64_t& _highLevelSensitiveCnt)
{
    m_highLevelSensitiveCnt = _highLevelSensitiveCnt;
    m_highLevelSensitiveCntHasBeenSet = true;
}

bool ImageAssetDetail::HighLevelSensitiveCntHasBeenSet() const
{
    return m_highLevelSensitiveCntHasBeenSet;
}

uint64_t ImageAssetDetail::GetCriticalLevelSensitiveCnt() const
{
    return m_criticalLevelSensitiveCnt;
}

void ImageAssetDetail::SetCriticalLevelSensitiveCnt(const uint64_t& _criticalLevelSensitiveCnt)
{
    m_criticalLevelSensitiveCnt = _criticalLevelSensitiveCnt;
    m_criticalLevelSensitiveCntHasBeenSet = true;
}

bool ImageAssetDetail::CriticalLevelSensitiveCntHasBeenSet() const
{
