...
vector<string> DescribeVULRiskAdvanceCFGListRequest::GetMemberId() const
{
    return m_memberId;
}

void DescribeVULRiskAdvanceCFGListRequest::SetMemberId(const vector<string>& _memberId)
{
    m_memberId = _memberId;
    m_memberIdHasBeenSet = true;
}

bool DescribeVULRiskAdvanceCFGListRequest::MemberIdHasBeenSet() const
{
