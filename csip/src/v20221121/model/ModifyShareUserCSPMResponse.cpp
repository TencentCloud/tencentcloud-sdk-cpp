...
ModifyShareUserCSPMResponse::ModifyShareUserCSPMResponse() :
    m_resultHasBeenSet(false),
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyShareUserCSPMResponse::Deserialize(const string &payload)
{
...
string ModifyShareUserCSPMResponse::ToJsonString() const
{
...
int64_t ModifyShareUserCSPMResponse::GetResult() const
{
    return m_result;
}

bool ModifyShareUserCSPMResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ModifyShareUserCSPMResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyShareUserCSPMResponse::MsgHasBeenSet() const
{
