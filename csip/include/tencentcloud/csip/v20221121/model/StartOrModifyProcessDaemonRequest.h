...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_STARTORMODIFYPROCESSDAEMONREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_STARTORMODIFYPROCESSDAEMONREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class StartOrModifyProcessDaemonRequest : public AbstractModel
                {
                public:
                    StartOrModifyProcessDaemonRequest();
                    ~StartOrModifyProcessDaemonRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_STARTORMODIFYPROCESSDAEMONREQUEST_H_
