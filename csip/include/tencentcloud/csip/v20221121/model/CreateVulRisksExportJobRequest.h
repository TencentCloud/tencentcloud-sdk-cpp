...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEVULRISKSEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEVULRISKSEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateVulRisksExportJobRequest : public AbstractModel
                {
                public:
                    CreateVulRisksExportJobRequest();
                    ~CreateVulRisksExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEVULRISKSEXPORTJOBREQUEST_H_
