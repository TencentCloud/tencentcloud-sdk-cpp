...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEHIGHBASELINERISKLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEHIGHBASELINERISKLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeHighBaseLineRiskListRequest : public AbstractModel
                {
                public:
                    DescribeHighBaseLineRiskListRequest();
                    ~DescribeHighBaseLineRiskListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEHIGHBASELINERISKLISTREQUEST_H_
