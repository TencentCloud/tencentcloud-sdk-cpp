...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSETLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSETLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageAssetListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageAssetListExportJobRequest();
                    ~CreateImageAssetListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSETLISTEXPORTJOBREQUEST_H_
