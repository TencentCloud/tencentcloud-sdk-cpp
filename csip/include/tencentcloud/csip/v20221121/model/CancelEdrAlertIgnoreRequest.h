...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CANCELEDRALERTIGNOREREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CANCELEDRALERTIGNOREREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CancelEdrAlertIgnoreRequest : public AbstractModel
                {
                public:
                    CancelEdrAlertIgnoreRequest();
                    ~CancelEdrAlertIgnoreRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CANCELEDRALERTIGNOREREQUEST_H_
