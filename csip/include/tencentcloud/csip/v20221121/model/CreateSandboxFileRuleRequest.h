...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESANDBOXFILERULEREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESANDBOXFILERULEREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateSandboxFileRuleRequest : public AbstractModel
                {
                public:
                    CreateSandboxFileRuleRequest();
                    ~CreateSandboxFileRuleRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESANDBOXFILERULEREQUEST_H_
