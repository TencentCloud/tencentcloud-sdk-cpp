...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEDETAILITEM_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEDETAILITEM_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * dspm数据识别分类数据项关联详情
                */
                class DspmIdentifyCategoryRuleRelateDetailItem : public AbstractModel
                {
                public:
                    DspmIdentifyCategoryRuleRelateDetailItem();
                    ~DspmIdentifyCategoryRuleRelateDetailItem() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEDETAILITEM_H_
