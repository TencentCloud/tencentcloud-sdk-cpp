...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageVulListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageVulListExportJobRequest();
                    ~CreateImageVulListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULLISTEXPORTJOBREQUEST_H_
