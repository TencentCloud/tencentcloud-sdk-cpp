            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取排序字段(opTime=时间,dangerLvl=风险等级)
                    ...
                    /**
                     * 设置排序字段(opTime=时间,dangerLvl=风险等级)
                    ...
                    /**
                     * 获取风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)
                    ...
                    /**
                     * 设置风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)
                    ...
                    /**
                     * 获取流量来源，取值 Agent/Proxy/空；传Agent会返回Agent的日志，传Proxy会返回Proxy日志，两者都传或不传则返回所有
                    ...
                    /**
                     * 设置流量来源，取值 Agent/Proxy/空；传Agent会返回Agent的日志，传Proxy会返回Proxy日志，两者都传或不传则返回所有
                    ...
                    /**
                     * 获取风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)
                    ...
                    /**
                     * 设置风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)
