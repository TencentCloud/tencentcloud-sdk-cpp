...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYRULEREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYRULEREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateDspmIdentifyRuleRequest : public AbstractModel
                {
                public:
                    CreateDspmIdentifyRuleRequest();
                    ~CreateDspmIdentifyRuleRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYRULEREQUEST_H_
