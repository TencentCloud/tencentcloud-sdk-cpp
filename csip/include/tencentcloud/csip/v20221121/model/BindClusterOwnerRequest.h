...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_BINDCLUSTEROWNERREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_BINDCLUSTEROWNERREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class BindClusterOwnerRequest : public AbstractModel
                {
                public:
                    BindClusterOwnerRequest();
                    ~BindClusterOwnerRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_BINDCLUSTEROWNERREQUEST_H_
