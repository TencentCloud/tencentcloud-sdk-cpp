...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMASSETIDENTIFYINFOLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMASSETIDENTIFYINFOLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeDspmAssetIdentifyInfoListRequest : public AbstractModel
                {
                public:
                    DescribeDspmAssetIdentifyInfoListRequest();
                    ~DescribeDspmAssetIdentifyInfoListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMASSETIDENTIFYINFOLISTREQUEST_H_
