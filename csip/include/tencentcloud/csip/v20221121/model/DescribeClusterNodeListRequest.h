...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERNODELISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERNODELISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeClusterNodeListRequest : public AbstractModel
                {
                public:
                    DescribeClusterNodeListRequest();
                    ~DescribeClusterNodeListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERNODELISTREQUEST_H_
