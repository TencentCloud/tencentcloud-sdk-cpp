            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>进程命令行参数<br>入参限制：最大 4096 字节，超长时可能被截断</p>
                    ...
                    /**
                     * 设置<p>进程命令行参数<br>入参限制：最大 4096 字节，超长时可能被截断</p>
                    ...
                    /**
                     * 获取<p>目标地址，形如 GET http://xxxx 或 ip:port</p>
                    ...
                    /**
                     * 设置<p>目标地址，形如 GET http://xxxx 或 ip:port</p>
                    ...
                    /**
                     * 获取<p>协议类型<br>枚举值：<br>http<br>https</p>
                    ...
                    /**
                     * 设置<p>协议类型<br>枚举值：<br>http<br>https</p>
