...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYCSIPLICENSEUNBINDSRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYCSIPLICENSEUNBINDSRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifyCSIPLicenseUnBindsResponse : public AbstractModel
                {
                public:
                    ModifyCSIPLicenseUnBindsResponse();
                    ~ModifyCSIPLicenseUnBindsResponse() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYCSIPLICENSEUNBINDSRESPONSE_H_
