...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_TIMEDSCANTASKPREVIEWINFO_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_TIMEDSCANTASKPREVIEWINFO_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * 定时任务预览镜像信息
                */
                class TimedScanTaskPreviewInfo : public AbstractModel
                {
                public:
                    TimedScanTaskPreviewInfo();
                    ~TimedScanTaskPreviewInfo() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_TIMEDSCANTASKPREVIEWINFO_H_
