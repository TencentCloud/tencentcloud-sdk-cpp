...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVIRUSLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVIRUSLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageVirusListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageVirusListExportJobRequest();
                    ~CreateImageVirusListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVIRUSLISTEXPORTJOBREQUEST_H_
