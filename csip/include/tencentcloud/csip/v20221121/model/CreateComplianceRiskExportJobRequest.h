...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECOMPLIANCERISKEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECOMPLIANCERISKEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateComplianceRiskExportJobRequest : public AbstractModel
                {
                public:
                    CreateComplianceRiskExportJobRequest();
                    ~CreateComplianceRiskExportJobRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>合规标准ID</p>
                     * @return StandardID <p>合规标准ID</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECOMPLIANCERISKEXPORTJOBREQUEST_H_
