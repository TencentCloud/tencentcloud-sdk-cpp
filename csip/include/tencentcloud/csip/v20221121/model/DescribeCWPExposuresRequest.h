...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECWPEXPOSURESREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECWPEXPOSURESREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeCWPExposuresRequest : public AbstractModel
                {
                public:
                    DescribeCWPExposuresRequest();
                    ~DescribeCWPExposuresRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECWPEXPOSURESREQUEST_H_
