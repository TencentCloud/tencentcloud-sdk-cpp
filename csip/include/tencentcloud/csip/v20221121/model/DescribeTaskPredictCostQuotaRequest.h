...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBETASKPREDICTCOSTQUOTAREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBETASKPREDICTCOSTQUOTAREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeTaskPredictCostQuotaRequest : public AbstractModel
                {
                public:
                    DescribeTaskPredictCostQuotaRequest();
                    ~DescribeTaskPredictCostQuotaRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBETASKPREDICTCOSTQUOTAREQUEST_H_
