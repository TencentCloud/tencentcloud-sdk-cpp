...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMCKAFKASTARTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMCKAFKASTARTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifyDspmCkafkaStartRequest : public AbstractModel
                {
                public:
                    ModifyDspmCkafkaStartRequest();
                    ~ModifyDspmCkafkaStartRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMCKAFKASTARTREQUEST_H_
