            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>待重新扫描的风险记录 RiskID 列表，不可为空且元素不可为空字符串。</p>
                    ...
                    /**
                     * 设置<p>待重新扫描的风险记录 RiskID 列表，不可为空且元素不可为空字符串。</p>
                     * @param _riskIDList <p>待重新扫描的风险记录 RiskID 列表，不可为空且元素不可为空字符串。</p>
                     * 
                     */
