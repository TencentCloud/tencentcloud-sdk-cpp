            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>
                     * @return Enable <p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>正选主机数</p>
                     * @return IncludeHostCount <p>正选主机数</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>反选主机数</p>
                     * @return ExcludeHostCount <p>反选主机数</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>正选quuid列表</p>
                     * @return IncludeQuuid <p>正选quuid列表</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>反选quuid列表</p>
                     * @return ExcludeQuuid <p>反选quuid列表</p>
                     * 
                     */
