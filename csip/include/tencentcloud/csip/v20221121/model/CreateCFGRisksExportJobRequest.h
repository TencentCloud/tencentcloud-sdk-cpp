...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECFGRISKSEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECFGRISKSEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateCFGRisksExportJobRequest : public AbstractModel
                {
                public:
                    CreateCFGRisksExportJobRequest();
                    ~CreateCFGRisksExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATECFGRISKSEXPORTJOBREQUEST_H_
