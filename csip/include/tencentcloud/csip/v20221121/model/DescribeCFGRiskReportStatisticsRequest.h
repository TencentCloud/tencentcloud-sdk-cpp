...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECFGRISKREPORTSTATISTICSREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECFGRISKREPORTSTATISTICSREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeCFGRiskReportStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeCFGRiskReportStatisticsRequest();
                    ~DescribeCFGRiskReportStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECFGRISKREPORTSTATISTICSREQUEST_H_
