...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOMPLIANCERISKLISTRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOMPLIANCERISKLISTRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeComplianceRiskListResponse : public AbstractModel
                {
                public:
                    DescribeComplianceRiskListResponse();
                    ~DescribeComplianceRiskListResponse() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOMPLIANCERISKLISTRESPONSE_H_
