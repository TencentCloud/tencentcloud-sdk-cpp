...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEVULRISKLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEVULRISKLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeVulRiskListRequest : public AbstractModel
                {
                public:
                    DescribeVulRiskListRequest();
                    ~DescribeVulRiskListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEVULRISKLISTREQUEST_H_
