...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_SCANBASELINEASSETITEMLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_SCANBASELINEASSETITEMLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ScanBaselineAssetItemListRequest : public AbstractModel
                {
                public:
                    ScanBaselineAssetItemListRequest();
                    ~ScanBaselineAssetItemListRequest() = default;
                    ...
                    /**
                     * 获取<p>要重新扫描的检测项 ID 列表，仅对该资产生效。</p>
                    ...
                    /**
                     * 设置<p>要重新扫描的检测项 ID 列表，仅对该资产生效。</p>
                     * @param _itemIDList <p>要重新扫描的检测项 ID 列表，仅对该资产生效。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>目标资产 ID（AssetType=HOST 时为 InstanceID，=CLUSTER 时为集群 ID）。</p>
                    ...
                    /**
                     * 设置<p>目标资产 ID（AssetType=HOST 时为 InstanceID，=CLUSTER 时为集群 ID）。</p>
                     * @param _assetID <p>目标资产 ID（AssetType=HOST 时为 InstanceID，=CLUSTER 时为集群 ID）。</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_SCANBASELINEASSETITEMLISTREQUEST_H_
