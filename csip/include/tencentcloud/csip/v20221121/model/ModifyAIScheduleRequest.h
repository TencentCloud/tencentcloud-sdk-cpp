            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>AI 定时任务 ID。可通过 CreateAISchedule 接口获取。</p>
                    ...
                    /**
                     * 设置<p>AI 定时任务 ID。可通过 CreateAISchedule 接口获取。</p>
                     * @param _scheduleId <p>AI 定时任务 ID。可通过 CreateAISchedule 接口获取。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>触发器列表，当 UpdateTriggers 为 true 时全量替换。</p>
                    ...
                    /**
                     * 设置<p>触发器列表，当 UpdateTriggers 为 true 时全量替换。</p>
                     * @param _triggers <p>触发器列表，当 UpdateTriggers 为 true 时全量替换。</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>是否更新触发器列表。取值：true（使用 Triggers 字段全量替换）、false（不更新）。</p>
                    ...
                    /**
                     * 设置<p>是否更新触发器列表。取值：true（使用 Triggers 字段全量替换）、false（不更新）。</p>
                     * @param _updateTriggers <p>是否更新触发器列表。取值：true（使用 Triggers 字段全量替换）、false（不更新）。</p>
                     * 
                     */
