...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEDRRULELISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEDRRULELISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeEDRRuleListRequest : public AbstractModel
                {
                public:
                    DescribeEDRRuleListRequest();
                    ~DescribeEDRRuleListRequest() = default;
                    ...
                    /**
                     * 获取<p>PolicyType - int - 是否必填：否 - 策略类型<br>PolicyName - string - 是否必填：否 - 策略名称<br>Domain - string - 是否必填：否 - 域名(先对域名做urlencode,再base64)<br>PolicyAction- int - 是否必填：否 - 策略动作<br>IsEnabled - int - 是否必填：否 - 是否生效</p>
                     * @return Filters <p>PolicyType - int - 是否必填：否 - 策略类型<br>PolicyName - string - 是否必填：否 - 策略名称<br>Domain - string - 是否必填：否 - 域名(先对域名做urlencode,再base64)<br>PolicyAction- int - 是否必填：否 - 策略动作<br>IsEnabled - int - 是否必填：否 - 是否生效</p>
                     * 
                     */
                    std::vector<EDRFilter> GetFilters() const;

                    /**
                     * 设置<p>PolicyType - int - 是否必填：否 - 策略类型<br>PolicyName - string - 是否必填：否 - 策略名称<br>Domain - string - 是否必填：否 - 域名(先对域名做urlencode,再base64)<br>PolicyAction- int - 是否必填：否 - 策略动作<br>IsEnabled - int - 是否必填：否 - 是否生效</p>
                    ...
                    /**
                     * 获取<p>可选排序列: [ModifyTime]</p>
                     * @return By <p>可选排序列: [ModifyTime]</p>
                     * 
                     */
                    std::string GetBy() const;

                    /**
                     * 设置<p>可选排序列: [ModifyTime]</p>
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEDRRULELISTREQUEST_H_
