...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTRELATEDIMAGELISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTRELATEDIMAGELISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateAssetComponentRelatedImageListExportJobRequest : public AbstractModel
                {
                public:
                    CreateAssetComponentRelatedImageListExportJobRequest();
                    ~CreateAssetComponentRelatedImageListExportJobRequest() = default;
                    ...
                    /**
                     * 获取<p>是否保存到导出任务中</p><p>枚举值：</p><ul><li>0： 不保存</li><li>1： 保存</li></ul>
                    ...
                    /**
                     * 设置<p>是否保存到导出任务中</p><p>枚举值：</p><ul><li>0： 不保存</li><li>1： 保存</li></ul>
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTRELATEDIMAGELISTEXPORTJOBREQUEST_H_
