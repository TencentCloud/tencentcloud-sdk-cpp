...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_IMAGELAYERVUL_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_IMAGELAYERVUL_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * 镜像漏洞信息
                */
                class ImageLayerVul : public AbstractModel
                {
                public:
                    ImageLayerVul();
                    ~ImageLayerVul() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_IMAGELAYERVUL_H_
