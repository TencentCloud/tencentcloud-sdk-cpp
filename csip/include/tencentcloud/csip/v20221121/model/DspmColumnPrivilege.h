...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMCOLUMNPRIVILEGE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMCOLUMNPRIVILEGE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * 列权限信息
                */
                class DspmColumnPrivilege : public AbstractModel
                {
                public:
                    DspmColumnPrivilege();
                    ~DspmColumnPrivilege() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMCOLUMNPRIVILEGE_H_
