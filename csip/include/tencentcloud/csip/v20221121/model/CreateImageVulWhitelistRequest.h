...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULWHITELISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULWHITELISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageVulWhitelistRequest : public AbstractModel
                {
                public:
                    CreateImageVulWhitelistRequest();
                    ~CreateImageVulWhitelistRequest() = default;
                     ...
                     * 
                     */
                    std::vector<std::string> GetPocId() const;
                     ...
                     * 
                     */
                    void SetPocId(const std::vector<std::string>& _pocId);
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEVULWHITELISTREQUEST_H_
