...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERLISTV2REQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERLISTV2REQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeClusterListV2Request : public AbstractModel
                {
                public:
                    DescribeClusterListV2Request();
                    ~DescribeClusterListV2Request() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLUSTERLISTV2REQUEST_H_
