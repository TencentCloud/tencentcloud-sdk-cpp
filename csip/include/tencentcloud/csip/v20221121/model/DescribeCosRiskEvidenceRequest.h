...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKEVIDENCEREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKEVIDENCEREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeCosRiskEvidenceRequest : public AbstractModel
                {
                public:
                    DescribeCosRiskEvidenceRequest();
                    ~DescribeCosRiskEvidenceRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKEVIDENCEREQUEST_H_
