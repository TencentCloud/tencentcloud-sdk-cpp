...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETTAGREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETTAGREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateAssetTagRequest : public AbstractModel
                {
                public:
                    CreateAssetTagRequest();
                    ~CreateAssetTagRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETTAGREQUEST_H_
