...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKACTIONLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKACTIONLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeCosRiskActionListRequest : public AbstractModel
                {
                public:
                    DescribeCosRiskActionListRequest();
                    ~DescribeCosRiskActionListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECOSRISKACTIONLISTREQUEST_H_
