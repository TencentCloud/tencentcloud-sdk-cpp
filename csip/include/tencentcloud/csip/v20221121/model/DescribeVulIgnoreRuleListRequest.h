            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>过滤条件，支持以下 Name：</p><li>Keyword - 漏洞名/备注，模糊匹配</li><li>Switch - 开关状态，过滤值：0（关闭）/ 1（开启）</li>
                     * @return Filters <p>过滤条件，支持以下 Name：</p><li>Keyword - 漏洞名/备注，模糊匹配</li><li>Switch - 开关状态，过滤值：0（关闭）/ 1（开启）</li>
                     * 
                     */
                    std::vector<Filters> GetFilters() const;

                    /**
                     * 设置<p>过滤条件，支持以下 Name：</p><li>Keyword - 漏洞名/备注，模糊匹配</li><li>Switch - 开关状态，过滤值：0（关闭）/ 1（开启）</li>
                    ...
                    /**
                     * 获取<p>排序方向：asc（升序）/ desc（降序），默认 desc</p>
                    ...
                    /**
                     * 设置<p>排序方向：asc（升序）/ desc（降序），默认 desc</p>
                    ...
                    /**
                     * 获取<p>排序字段，默认按更新时间（UpdateTime）排序</p>
                     * @return By <p>排序字段，默认按更新时间（UpdateTime）排序</p>
                     * 
                     */
                    std::string GetBy() const;

                    /**
                     * 设置<p>排序字段，默认按更新时间（UpdateTime）排序</p>
