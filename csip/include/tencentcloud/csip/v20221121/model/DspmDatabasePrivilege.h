...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMDATABASEPRIVILEGE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMDATABASEPRIVILEGE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * 数据库权限
                */
                class DspmDatabasePrivilege : public AbstractModel
                {
                public:
                    DspmDatabasePrivilege();
                    ~DspmDatabasePrivilege() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMDATABASEPRIVILEGE_H_
