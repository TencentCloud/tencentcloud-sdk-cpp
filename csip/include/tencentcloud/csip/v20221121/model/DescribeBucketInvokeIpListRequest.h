...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBUCKETINVOKEIPLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBUCKETINVOKEIPLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeBucketInvokeIpListRequest : public AbstractModel
                {
                public:
                    DescribeBucketInvokeIpListRequest();
                    ~DescribeBucketInvokeIpListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBUCKETINVOKEIPLISTREQUEST_H_
