...
CoreInternalOutcome DescribeWhiteboardBucketConfigResponse::Deserialize(const string &payload)
{
...
string DescribeWhiteboardBucketConfigResponse::ToJsonString() const
{
