...
DescribePPTCheckCallbackResponse::DescribePPTCheckCallbackResponse() :
    m_callbackHasBeenSet(false),
    m_callbackKeyHasBeenSet(false)
{
}

CoreInternalOutcome DescribePPTCheckCallbackResponse::Deserialize(const string &payload)
{
...
string DescribePPTCheckCallbackResponse::ToJsonString() const
{
...
string DescribePPTCheckCallbackResponse::GetCallback() const
{
    return m_callback;
}

bool DescribePPTCheckCallbackResponse::CallbackHasBeenSet() const
{
    return m_callbackHasBeenSet;
}

string DescribePPTCheckCallbackResponse::GetCallbackKey() const
{
    return m_callbackKey;
}

bool DescribePPTCheckCallbackResponse::CallbackKeyHasBeenSet() const
{
