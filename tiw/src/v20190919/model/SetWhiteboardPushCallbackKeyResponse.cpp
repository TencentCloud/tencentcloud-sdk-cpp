...
CoreInternalOutcome SetWhiteboardPushCallbackKeyResponse::Deserialize(const string &payload)
{
...
string SetWhiteboardPushCallbackKeyResponse::ToJsonString() const
{
