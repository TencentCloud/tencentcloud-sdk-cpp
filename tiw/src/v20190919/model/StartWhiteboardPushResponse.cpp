...
CoreInternalOutcome StartWhiteboardPushResponse::Deserialize(const string &payload)
{
...
string StartWhiteboardPushResponse::ToJsonString() const
{
...
string StartWhiteboardPushResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartWhiteboardPushResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string StartWhiteboardPushResponse::GetBackup() const
{
    return m_backup;
}

bool StartWhiteboardPushResponse::BackupHasBeenSet() const
{
