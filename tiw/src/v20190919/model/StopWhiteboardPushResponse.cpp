...
CoreInternalOutcome StopWhiteboardPushResponse::Deserialize(const string &payload)
{
...
string StopWhiteboardPushResponse::ToJsonString() const
{
...
string StopWhiteboardPushResponse::GetBackup() const
{
    return m_backup;
}

bool StopWhiteboardPushResponse::BackupHasBeenSet() const
{
