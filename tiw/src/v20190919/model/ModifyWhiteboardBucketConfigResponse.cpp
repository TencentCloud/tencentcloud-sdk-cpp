...
CoreInternalOutcome ModifyWhiteboardBucketConfigResponse::Deserialize(const string &payload)
{
...
string ModifyWhiteboardBucketConfigResponse::ToJsonString() const
{
