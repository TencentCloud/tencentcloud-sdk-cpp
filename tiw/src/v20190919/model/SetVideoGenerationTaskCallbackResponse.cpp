...
CoreInternalOutcome SetVideoGenerationTaskCallbackResponse::Deserialize(const string &payload)
{
...
string SetVideoGenerationTaskCallbackResponse::ToJsonString() const
{
