...
int64_t ModifyApplicationRequest::GetSdkAppId() const
{
    return m_sdkAppId;
}

void ModifyApplicationRequest::SetSdkAppId(const int64_t& _sdkAppId)
{
    m_sdkAppId = _sdkAppId;
    m_sdkAppIdHasBeenSet = true;
}

bool ModifyApplicationRequest::SdkAppIdHasBeenSet() const
{
