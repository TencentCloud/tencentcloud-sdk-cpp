...
CoreInternalOutcome DescribeWhiteboardPushCallbackResponse::Deserialize(const string &payload)
{
...
string DescribeWhiteboardPushCallbackResponse::ToJsonString() const
{
...
string DescribeWhiteboardPushCallbackResponse::GetCallback() const
{
    return m_callback;
}

bool DescribeWhiteboardPushCallbackResponse::CallbackHasBeenSet() const
{
    return m_callbackHasBeenSet;
}

string DescribeWhiteboardPushCallbackResponse::GetCallbackKey() const
{
    return m_callbackKey;
}

bool DescribeWhiteboardPushCallbackResponse::CallbackKeyHasBeenSet() const
{
