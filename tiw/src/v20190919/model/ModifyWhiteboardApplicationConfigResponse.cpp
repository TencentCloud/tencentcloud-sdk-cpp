...
CoreInternalOutcome ModifyWhiteboardApplicationConfigResponse::Deserialize(const string &payload)
{
...
string ModifyWhiteboardApplicationConfigResponse::ToJsonString() const
{
