...
DescribeWarningCallbackResponse::DescribeWarningCallbackResponse() :
    m_callbackHasBeenSet(false),
    m_callbackKeyHasBeenSet(false)
{
}

CoreInternalOutcome DescribeWarningCallbackResponse::Deserialize(const string &payload)
{
...
string DescribeWarningCallbackResponse::ToJsonString() const
{
...
string DescribeWarningCallbackResponse::GetCallback() const
{
    return m_callback;
}

bool DescribeWarningCallbackResponse::CallbackHasBeenSet() const
{
    return m_callbackHasBeenSet;
}

string DescribeWarningCallbackResponse::GetCallbackKey() const
{
    return m_callbackKey;
}

bool DescribeWarningCallbackResponse::CallbackKeyHasBeenSet() const
{
