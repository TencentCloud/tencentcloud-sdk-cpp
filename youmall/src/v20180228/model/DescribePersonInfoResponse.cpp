...
CoreInternalOutcome DescribePersonInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("PersonInfoSet") && !rsp["PersonInfoSet"].IsNull())
    {
        if (!rsp["PersonInfoSet"].IsArray())
            return CoreInternalOutcome(Error("response `PersonInfoSet` is not array type"));
...
string DescribePersonInfoResponse::ToJsonString() const
{
...
string DescribePersonInfoResponse::GetCompanyId() const
{
    return m_companyId;
}

bool DescribePersonInfoResponse::CompanyIdHasBeenSet() const
{
    return m_companyIdHasBeenSet;
}

uint64_t DescribePersonInfoResponse::GetShopId() const
{
    return m_shopId;
}

bool DescribePersonInfoResponse::ShopIdHasBeenSet() const
{
    return m_shopIdHasBeenSet;
}

uint64_t DescribePersonInfoResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePersonInfoResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<PersonInfo> DescribePersonInfoResponse::GetPersonInfoSet() const
{
    return m_personInfoSet;
}

bool DescribePersonInfoResponse::PersonInfoSetHasBeenSet() const
{
