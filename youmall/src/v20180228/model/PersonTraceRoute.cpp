...
CoreInternalOutcome PersonTraceRoute::Deserialize(const Value &value)
{
    string requestId = "";
...
void PersonTraceRoute::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
