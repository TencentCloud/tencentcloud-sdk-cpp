...
CoreInternalOutcome DescribeZoneFlowHourlyByZoneIdResponse::Deserialize(const string &payload)
{
...
string DescribeZoneFlowHourlyByZoneIdResponse::ToJsonString() const
{
...
string DescribeZoneFlowHourlyByZoneIdResponse::GetCompanyId() const
{
    return m_companyId;
}

bool DescribeZoneFlowHourlyByZoneIdResponse::CompanyIdHasBeenSet() const
{
    return m_companyIdHasBeenSet;
}

int64_t DescribeZoneFlowHourlyByZoneIdResponse::GetShopId() const
{
    return m_shopId;
}

bool DescribeZoneFlowHourlyByZoneIdResponse::ShopIdHasBeenSet() const
{
    return m_shopIdHasBeenSet;
}

int64_t DescribeZoneFlowHourlyByZoneIdResponse::GetZoneId() const
{
    return m_zoneId;
}

bool DescribeZoneFlowHourlyByZoneIdResponse::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string DescribeZoneFlowHourlyByZoneIdResponse::GetZoneName() const
{
    return m_zoneName;
}

bool DescribeZoneFlowHourlyByZoneIdResponse::ZoneNameHasBeenSet() const
{
    return m_zoneNameHasBeenSet;
}

vector<ZoneHourFlow> DescribeZoneFlowHourlyByZoneIdResponse::GetData() const
{
    return m_data;
}

bool DescribeZoneFlowHourlyByZoneIdResponse::DataHasBeenSet() const
{
