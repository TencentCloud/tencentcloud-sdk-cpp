...
CoreInternalOutcome NetworkHistoryInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void NetworkHistoryInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
