...
CoreInternalOutcome CreateFacePictureResponse::Deserialize(const string &payload)
{
...
string CreateFacePictureResponse::ToJsonString() const
{
...
int64_t CreateFacePictureResponse::GetPersonId() const
{
    return m_personId;
}

bool CreateFacePictureResponse::PersonIdHasBeenSet() const
{
    return m_personIdHasBeenSet;
}

int64_t CreateFacePictureResponse::GetStatus() const
{
    return m_status;
}

bool CreateFacePictureResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateFacePictureResponse::GetPictureUrl() const
{
    return m_pictureUrl;
}

bool CreateFacePictureResponse::PictureUrlHasBeenSet() const
{
