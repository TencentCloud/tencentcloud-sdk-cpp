...
CoreInternalOutcome DescribeZoneFlowAgeInfoByZoneIdResponse::Deserialize(const string &payload)
{
...
string DescribeZoneFlowAgeInfoByZoneIdResponse::ToJsonString() const
{
...
string DescribeZoneFlowAgeInfoByZoneIdResponse::GetCompanyId() const
{
    return m_companyId;
}

bool DescribeZoneFlowAgeInfoByZoneIdResponse::CompanyIdHasBeenSet() const
{
    return m_companyIdHasBeenSet;
}

int64_t DescribeZoneFlowAgeInfoByZoneIdResponse::GetShopId() const
{
    return m_shopId;
}

bool DescribeZoneFlowAgeInfoByZoneIdResponse::ShopIdHasBeenSet() const
{
    return m_shopIdHasBeenSet;
}

int64_t DescribeZoneFlowAgeInfoByZoneIdResponse::GetZoneId() const
{
    return m_zoneId;
}

bool DescribeZoneFlowAgeInfoByZoneIdResponse::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string DescribeZoneFlowAgeInfoByZoneIdResponse::GetZoneName() const
{
    return m_zoneName;
}

bool DescribeZoneFlowAgeInfoByZoneIdResponse::ZoneNameHasBeenSet() const
{
    return m_zoneNameHasBeenSet;
}

vector<double> DescribeZoneFlowAgeInfoByZoneIdResponse::GetData() const
{
    return m_data;
}

bool DescribeZoneFlowAgeInfoByZoneIdResponse::DataHasBeenSet() const
{
