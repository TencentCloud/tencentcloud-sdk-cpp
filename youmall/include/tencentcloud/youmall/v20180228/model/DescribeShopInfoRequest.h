...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPINFOREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPINFOREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeShopInfoRequest : public AbstractModel
                {
                public:
                    DescribeShopInfoRequest();
                    ~DescribeShopInfoRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPINFOREQUEST_H_
