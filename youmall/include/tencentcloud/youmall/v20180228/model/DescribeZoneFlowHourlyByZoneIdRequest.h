...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWHOURLYBYZONEIDREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWHOURLYBYZONEIDREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeZoneFlowHourlyByZoneIdRequest : public AbstractModel
                {
                public:
                    DescribeZoneFlowHourlyByZoneIdRequest();
                    ~DescribeZoneFlowHourlyByZoneIdRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWHOURLYBYZONEIDREQUEST_H_
