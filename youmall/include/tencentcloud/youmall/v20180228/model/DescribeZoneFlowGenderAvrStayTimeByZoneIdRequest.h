...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERAVRSTAYTIMEBYZONEIDREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERAVRSTAYTIMEBYZONEIDREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeZoneFlowGenderAvrStayTimeByZoneIdRequest : public AbstractModel
                {
                public:
                    DescribeZoneFlowGenderAvrStayTimeByZoneIdRequest();
                    ~DescribeZoneFlowGenderAvrStayTimeByZoneIdRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERAVRSTAYTIMEBYZONEIDREQUEST_H_
