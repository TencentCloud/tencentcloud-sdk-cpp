...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBENETWORKINFOREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBENETWORKINFOREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeNetworkInfoRequest : public AbstractModel
                {
                public:
                    DescribeNetworkInfoRequest();
                    ~DescribeNetworkInfoRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBENETWORKINFOREQUEST_H_
