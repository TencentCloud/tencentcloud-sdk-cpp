...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERINFOBYZONEIDREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERINFOBYZONEIDREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeZoneFlowGenderInfoByZoneIdRequest : public AbstractModel
                {
                public:
                    DescribeZoneFlowGenderInfoByZoneIdRequest();
                    ~DescribeZoneFlowGenderInfoByZoneIdRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWGENDERINFOBYZONEIDREQUEST_H_
