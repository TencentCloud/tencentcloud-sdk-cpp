...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWAGEINFOBYZONEIDREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWAGEINFOBYZONEIDREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeZoneFlowAgeInfoByZoneIdRequest : public AbstractModel
                {
                public:
                    DescribeZoneFlowAgeInfoByZoneIdRequest();
                    ~DescribeZoneFlowAgeInfoByZoneIdRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWAGEINFOBYZONEIDREQUEST_H_
