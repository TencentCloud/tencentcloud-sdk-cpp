...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPHOURTRAFFICINFOREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPHOURTRAFFICINFOREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeShopHourTrafficInfoRequest : public AbstractModel
                {
                public:
                    DescribeShopHourTrafficInfoRequest();
                    ~DescribeShopHourTrafficInfoRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBESHOPHOURTRAFFICINFOREQUEST_H_
