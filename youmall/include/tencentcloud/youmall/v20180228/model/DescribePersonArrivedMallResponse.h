...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEPERSONARRIVEDMALLRESPONSE_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEPERSONARRIVEDMALLRESPONSE_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribePersonArrivedMallResponse : public AbstractModel
                {
                public:
                    DescribePersonArrivedMallResponse();
                    ~DescribePersonArrivedMallResponse() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEPERSONARRIVEDMALLRESPONSE_H_
