...
#ifndef TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWDAILYBYZONEIDREQUEST_H_
#define TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWDAILYBYZONEIDREQUEST_H_
    ...
    namespace Youmall
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeZoneFlowDailyByZoneIdRequest : public AbstractModel
                {
                public:
                    DescribeZoneFlowDailyByZoneIdRequest();
                    ~DescribeZoneFlowDailyByZoneIdRequest() = default;
...
#endif // !TENCENTCLOUD_YOUMALL_V20180228_MODEL_DESCRIBEZONEFLOWDAILYBYZONEIDREQUEST_H_
