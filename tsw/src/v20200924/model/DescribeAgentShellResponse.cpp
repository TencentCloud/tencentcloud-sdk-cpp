...
CoreInternalOutcome DescribeAgentShellResponse::Deserialize(const string &payload)
{
...
string DescribeAgentShellResponse::ToJsonString() const
{
...
AgentShell DescribeAgentShellResponse::GetResult() const
{
    return m_result;
}

bool DescribeAgentShellResponse::ResultHasBeenSet() const
{
