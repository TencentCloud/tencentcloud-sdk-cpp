...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_BINDORGANIZATIONPOLICYSUBACCOUNTREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_BINDORGANIZATIONPOLICYSUBACCOUNTREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class BindOrganizationPolicySubAccountRequest : public AbstractModel
                {
                public:
                    BindOrganizationPolicySubAccountRequest();
                    ~BindOrganizationPolicySubAccountRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_BINDORGANIZATIONPOLICYSUBACCOUNTREQUEST_H_
