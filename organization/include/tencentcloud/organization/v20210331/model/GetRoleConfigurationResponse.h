...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_GETROLECONFIGURATIONRESPONSE_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_GETROLECONFIGURATIONRESPONSE_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class GetRoleConfigurationResponse : public AbstractModel
                {
                public:
                    GetRoleConfigurationResponse();
                    ~GetRoleConfigurationResponse() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_GETROLECONFIGURATIONRESPONSE_H_
