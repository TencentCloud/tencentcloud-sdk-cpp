...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTTASKSRESPONSE_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTTASKSRESPONSE_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                * ListTasks返回参数结构体
                */
                class ListTasksResponse : public AbstractModel
                {
                public:
                    ListTasksResponse();
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTTASKSRESPONSE_H_
