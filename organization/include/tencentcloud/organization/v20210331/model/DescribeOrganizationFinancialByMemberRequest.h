...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DESCRIBEORGANIZATIONFINANCIALBYMEMBERREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DESCRIBEORGANIZATIONFINANCIALBYMEMBERREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DescribeOrganizationFinancialByMemberRequest : public AbstractModel
                {
                public:
                    DescribeOrganizationFinancialByMemberRequest();
                    ~DescribeOrganizationFinancialByMemberRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DESCRIBEORGANIZATIONFINANCIALBYMEMBERREQUEST_H_
