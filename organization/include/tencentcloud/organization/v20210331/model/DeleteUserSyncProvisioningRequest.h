...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEUSERSYNCPROVISIONINGREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEUSERSYNCPROVISIONINGREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DeleteUserSyncProvisioningRequest : public AbstractModel
                {
                public:
                    DeleteUserSyncProvisioningRequest();
                    ~DeleteUserSyncProvisioningRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEUSERSYNCPROVISIONINGREQUEST_H_
