...
CoreInternalOutcome CancelOrganizationInvitationResponse::Deserialize(const string &payload)
{
...
string CancelOrganizationInvitationResponse::ToJsonString() const
{
