...
CoreInternalOutcome AcceptOrganizationInvitationResponse::Deserialize(const string &payload)
{
...
string AcceptOrganizationInvitationResponse::ToJsonString() const
{
