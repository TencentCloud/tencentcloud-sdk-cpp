...
string GetOrganizationMemberRequest::ToJsonString() const
{
...
uint64_t GetOrganizationMemberRequest::GetMemberUin() const
{
    return m_memberUin;
}

void GetOrganizationMemberRequest::SetMemberUin(const uint64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool GetOrganizationMemberRequest::MemberUinHasBeenSet() const
{
