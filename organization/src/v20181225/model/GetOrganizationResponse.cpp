...
CoreInternalOutcome GetOrganizationResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("IsEmpty") && !rsp["IsEmpty"].IsNull())
    {
...
bool GetOrganizationResponse::OrgIdHasBeenSet() const
{
    return m_orgIdHasBeenSet;
}

uint64_t GetOrganizationResponse::GetHostUin() const
{
    return m_hostUin;
}

bool GetOrganizationResponse::HostUinHasBeenSet() const
{
    return m_hostUinHasBeenSet;
}

string GetOrganizationResponse::GetNickname() const
{
    return m_nickname;
}

bool GetOrganizationResponse::NicknameHasBeenSet() const
{
    return m_nicknameHasBeenSet;
}

string GetOrganizationResponse::GetMail() const
{
    return m_mail;
}

bool GetOrganizationResponse::MailHasBeenSet() const
{
    return m_mailHasBeenSet;
}

uint64_t GetOrganizationResponse::GetOrgType() const
{
    return m_orgType;
}

bool GetOrganizationResponse::OrgTypeHasBeenSet() const
{
    return m_orgTypeHasBeenSet;
}

uint64_t GetOrganizationResponse::GetIsEmpty() const
{
    return m_isEmpty;
}

bool GetOrganizationResponse::IsEmptyHasBeenSet() const
{
    return m_isEmptyHasBeenSet;
}
