...
string ListOrganizationMembersResponse::ToJsonString() const
{
...
vector<OrgMember> ListOrganizationMembersResponse::GetMembers() const
{
    return m_members;
}

bool ListOrganizationMembersResponse::MembersHasBeenSet() const
{
    return m_membersHasBeenSet;
}

uint64_t ListOrganizationMembersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListOrganizationMembersResponse::TotalCountHasBeenSet() const
{
