...
CoreInternalOutcome ListNonCompliantResourceResponse::Deserialize(const string &payload)
{
...
string ListNonCompliantResourceResponse::ToJsonString() const
{
...
vector<ResourceTagMapping> ListNonCompliantResourceResponse::GetItems() const
{
    return m_items;
}

bool ListNonCompliantResourceResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

string ListNonCompliantResourceResponse::GetPaginationToken() const
{
    return m_paginationToken;
}

bool ListNonCompliantResourceResponse::PaginationTokenHasBeenSet() const
{
