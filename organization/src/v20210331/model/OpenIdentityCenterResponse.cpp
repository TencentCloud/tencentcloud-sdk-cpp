...
CoreInternalOutcome OpenIdentityCenterResponse::Deserialize(const string &payload)
{
...
string OpenIdentityCenterResponse::ToJsonString() const
{
...
string OpenIdentityCenterResponse::GetZoneId() const
{
    return m_zoneId;
}

bool OpenIdentityCenterResponse::ZoneIdHasBeenSet() const
{
