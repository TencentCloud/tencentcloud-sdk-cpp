...
CoreInternalOutcome ListPoliciesForTargetResponse::Deserialize(const string &payload)
{
...
string ListPoliciesForTargetResponse::ToJsonString() const
{
...
uint64_t ListPoliciesForTargetResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListPoliciesForTargetResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<ListPoliciesForTarget> ListPoliciesForTargetResponse::GetList() const
{
    return m_list;
}

bool ListPoliciesForTargetResponse::ListHasBeenSet() const
{
