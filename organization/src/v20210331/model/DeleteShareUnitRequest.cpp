...
string DeleteShareUnitRequest::ToJsonString() const
{
...
string DeleteShareUnitRequest::GetUnitId() const
{
    return m_unitId;
}

void DeleteShareUnitRequest::SetUnitId(const string& _unitId)
{
    m_unitId = _unitId;
    m_unitIdHasBeenSet = true;
}

bool DeleteShareUnitRequest::UnitIdHasBeenSet() const
{
