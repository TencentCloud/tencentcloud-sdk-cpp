...
CoreInternalOutcome RemoveExternalSAMLIdPCertificateResponse::Deserialize(const string &payload)
{
...
string RemoveExternalSAMLIdPCertificateResponse::ToJsonString() const
{
