...
vector<int64_t> DeleteOrganizationMembersRequest::GetMemberUin() const
{
    return m_memberUin;
}

void DeleteOrganizationMembersRequest::SetMemberUin(const vector<int64_t>& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool DeleteOrganizationMembersRequest::MemberUinHasBeenSet() const
{
