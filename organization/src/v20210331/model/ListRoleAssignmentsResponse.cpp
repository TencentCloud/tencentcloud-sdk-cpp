...
ListRoleAssignmentsResponse::ListRoleAssignmentsResponse() :
    ...
    m_roleAssignmentsHasBeenSet(false)
{
}

CoreInternalOutcome ListRoleAssignmentsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("RoleAssignments") && !rsp["RoleAssignments"].IsNull())
    {
        if (!rsp["RoleAssignments"].IsArray())
            return CoreInternalOutcome(Core::Error("response `RoleAssignments` is not array type"));

        const rapidjson::Value &tmpValue = rsp["RoleAssignments"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            RoleAssignments item;
            ...
            m_roleAssignments.push_back(item);
        }
        m_roleAssignmentsHasBeenSet = true;
    }
...
string ListRoleAssignmentsResponse::ToJsonString() const
{
    ...
    if (m_roleAssignmentsHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "RoleAssignments";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(rapidjson::kArrayType).Move(), allocator);

        int i=0;
        for (auto itr = m_roleAssignments.begin(); itr != m_roleAssignments.end(); ++itr, ++i)
        {
...
string ListRoleAssignmentsResponse::GetNextToken() const
{
    return m_nextToken;
}

bool ListRoleAssignmentsResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

int64_t ListRoleAssignmentsResponse::GetTotalCounts() const
{
    return m_totalCounts;
}

bool ListRoleAssignmentsResponse::TotalCountsHasBeenSet() const
{
    return m_totalCountsHasBeenSet;
}

int64_t ListRoleAssignmentsResponse::GetMaxResults() const
{
    return m_maxResults;
}

bool ListRoleAssignmentsResponse::MaxResultsHasBeenSet() const
{
    return m_maxResultsHasBeenSet;
}

bool ListRoleAssignmentsResponse::GetIsTruncated() const
{
    return m_isTruncated;
}

bool ListRoleAssignmentsResponse::IsTruncatedHasBeenSet() const
{
    return m_isTruncatedHasBeenSet;
}

vector<RoleAssignments> ListRoleAssignmentsResponse::GetRoleAssignments() const
{
    return m_roleAssignments;
}

bool ListRoleAssignmentsResponse::RoleAssignmentsHasBeenSet() const
{
    return m_roleAssignmentsHasBeenSet;
}
