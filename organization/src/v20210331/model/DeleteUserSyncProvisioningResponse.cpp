...
CoreInternalOutcome DeleteUserSyncProvisioningResponse::Deserialize(const string &payload)
{
...
string DeleteUserSyncProvisioningResponse::ToJsonString() const
{
...
UserProvisioningsTask DeleteUserSyncProvisioningResponse::GetTasks() const
{
    return m_tasks;
}

bool DeleteUserSyncProvisioningResponse::TasksHasBeenSet() const
{
