...
CoreInternalOutcome DismantleRoleConfigurationResponse::Deserialize(const string &payload)
{
...
string DismantleRoleConfigurationResponse::ToJsonString() const
{
...
RoleProvisioningsTask DismantleRoleConfigurationResponse::GetTask() const
{
    return m_task;
}

bool DismantleRoleConfigurationResponse::TaskHasBeenSet() const
{
