...
string CheckAccountDeleteRequest::ToJsonString() const
{
...
int64_t CheckAccountDeleteRequest::GetMemberUin() const
{
    return m_memberUin;
}

void CheckAccountDeleteRequest::SetMemberUin(const int64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool CheckAccountDeleteRequest::MemberUinHasBeenSet() const
{
