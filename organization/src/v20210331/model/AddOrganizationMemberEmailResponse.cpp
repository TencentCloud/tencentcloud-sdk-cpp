...
CoreInternalOutcome AddOrganizationMemberEmailResponse::Deserialize(const string &payload)
{
...
string AddOrganizationMemberEmailResponse::ToJsonString() const
{
...
uint64_t AddOrganizationMemberEmailResponse::GetBindId() const
{
    return m_bindId;
}

bool AddOrganizationMemberEmailResponse::BindIdHasBeenSet() const
{
