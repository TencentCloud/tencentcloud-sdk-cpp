...
string DescribeOrganizationRequest::ToJsonString() const
{
...
string DescribeOrganizationRequest::GetLang() const
{
    return m_lang;
}

void DescribeOrganizationRequest::SetLang(const string& _lang)
{
    m_lang = _lang;
