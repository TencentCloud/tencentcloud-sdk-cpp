...
CoreInternalOutcome CreateOrganizationMembersPolicyResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationMembersPolicyResponse::ToJsonString() const
{
...
int64_t CreateOrganizationMembersPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateOrganizationMembersPolicyResponse::PolicyIdHasBeenSet() const
{
