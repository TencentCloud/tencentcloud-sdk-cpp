...
string CreateSCIMCredentialRequest::ToJsonString() const
{
...
string CreateSCIMCredentialRequest::GetZoneId() const
{
    return m_zoneId;
}

void CreateSCIMCredentialRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
