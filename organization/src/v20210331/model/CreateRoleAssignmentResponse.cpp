...
CoreInternalOutcome CreateRoleAssignmentResponse::Deserialize(const string &payload)
{
...
string CreateRoleAssignmentResponse::ToJsonString() const
{
...
vector<TaskInfo> CreateRoleAssignmentResponse::GetTasks() const
{
    return m_tasks;
}

bool CreateRoleAssignmentResponse::TasksHasBeenSet() const
{
