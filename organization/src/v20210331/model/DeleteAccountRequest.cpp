...
int64_t DeleteAccountRequest::GetMemberUin() const
{
    return m_memberUin;
}

void DeleteAccountRequest::SetMemberUin(const int64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool DeleteAccountRequest::MemberUinHasBeenSet() const
{
