...
CoreInternalOutcome ProvisionRoleConfigurationResponse::Deserialize(const string &payload)
{
...
string ProvisionRoleConfigurationResponse::ToJsonString() const
{
...
RoleProvisioningsTask ProvisionRoleConfigurationResponse::GetTask() const
{
    return m_task;
}

bool ProvisionRoleConfigurationResponse::TaskHasBeenSet() const
{
