...
string GetRoleConfigurationRequest::ToJsonString() const
{
...
string GetRoleConfigurationRequest::GetZoneId() const
{
    return m_zoneId;
}

void GetRoleConfigurationRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool GetRoleConfigurationRequest::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string GetRoleConfigurationRequest::GetRoleConfigurationId() const
{
    return m_roleConfigurationId;
}

void GetRoleConfigurationRequest::SetRoleConfigurationId(const string& _roleConfigurationId)
{
    m_roleConfigurationId = _roleConfigurationId;
    m_roleConfigurationIdHasBeenSet = true;
}

bool GetRoleConfigurationRequest::RoleConfigurationIdHasBeenSet() const
{
