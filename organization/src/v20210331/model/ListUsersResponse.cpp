...
CoreInternalOutcome ListUsersResponse::Deserialize(const string &payload)
{
...
string ListUsersResponse::ToJsonString() const
{
...
int64_t ListUsersResponse::GetTotalCounts() const
{
    return m_totalCounts;
}

bool ListUsersResponse::TotalCountsHasBeenSet() const
{
    return m_totalCountsHasBeenSet;
}

int64_t ListUsersResponse::GetMaxResults() const
{
    return m_maxResults;
}

bool ListUsersResponse::MaxResultsHasBeenSet() const
{
    return m_maxResultsHasBeenSet;
}

vector<UserInfo> ListUsersResponse::GetUsers() const
{
    return m_users;
}

bool ListUsersResponse::UsersHasBeenSet() const
{
    return m_usersHasBeenSet;
}

string ListUsersResponse::GetNextToken() const
{
    return m_nextToken;
}

bool ListUsersResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

bool ListUsersResponse::GetIsTruncated() const
{
    return m_isTruncated;
}

bool ListUsersResponse::IsTruncatedHasBeenSet() const
{
