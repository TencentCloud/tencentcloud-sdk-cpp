...
CoreInternalOutcome ListPermissionPoliciesInRoleConfigurationResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("RolePolicies") && !rsp["RolePolicies"].IsNull())
    {
        if (!rsp["RolePolicies"].IsArray())
            return CoreInternalOutcome(Core::Error("response `RolePolicies` is not array type"));

        const rapidjson::Value &tmpValue = rsp["RolePolicies"];
...
string ListPermissionPoliciesInRoleConfigurationResponse::ToJsonString() const
{
...
int64_t ListPermissionPoliciesInRoleConfigurationResponse::GetTotalCounts() const
{
    return m_totalCounts;
}

bool ListPermissionPoliciesInRoleConfigurationResponse::TotalCountsHasBeenSet() const
{
    return m_totalCountsHasBeenSet;
}

vector<RolePolicie> ListPermissionPoliciesInRoleConfigurationResponse::GetRolePolicies() const
{
    return m_rolePolicies;
}

bool ListPermissionPoliciesInRoleConfigurationResponse::RolePoliciesHasBeenSet() const
{
