...
UpdateIPWhitelistResponse::UpdateIPWhitelistResponse() :
    m_successHasBeenSet(false)
{
}

CoreInternalOutcome UpdateIPWhitelistResponse::Deserialize(const string &payload)
{
...
string UpdateIPWhitelistResponse::ToJsonString() const
{
...
bool UpdateIPWhitelistResponse::GetSuccess() const
{
    return m_success;
}

bool UpdateIPWhitelistResponse::SuccessHasBeenSet() const
{
