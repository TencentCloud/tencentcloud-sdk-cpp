...
CoreInternalOutcome DescribeShareAreasResponse::Deserialize(const string &payload)
{
...
string DescribeShareAreasResponse::ToJsonString() const
{
...
vector<ShareArea> DescribeShareAreasResponse::GetItems() const
{
    return m_items;
}

bool DescribeShareAreasResponse::ItemsHasBeenSet() const
{
