...
CoreInternalOutcome ClearExternalSAMLIdentityProviderResponse::Deserialize(const string &payload)
{
...
string ClearExternalSAMLIdentityProviderResponse::ToJsonString() const
{
