...
CoreInternalOutcome DescribePolicyConfigResponse::Deserialize(const string &payload)
{
...
string DescribePolicyConfigResponse::ToJsonString() const
{
...
uint64_t DescribePolicyConfigResponse::GetStatus() const
{
    return m_status;
}

bool DescribePolicyConfigResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribePolicyConfigResponse::GetType() const
{
    return m_type;
}

bool DescribePolicyConfigResponse::TypeHasBeenSet() const
{
