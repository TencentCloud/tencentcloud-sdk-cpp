...
CoreInternalOutcome RemovePermissionPolicyFromRoleConfigurationResponse::Deserialize(const string &payload)
{
...
string RemovePermissionPolicyFromRoleConfigurationResponse::ToJsonString() const
{
