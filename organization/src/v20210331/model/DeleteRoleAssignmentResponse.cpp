...
CoreInternalOutcome DeleteRoleAssignmentResponse::Deserialize(const string &payload)
{
...
string DeleteRoleAssignmentResponse::ToJsonString() const
{
...
TaskInfo DeleteRoleAssignmentResponse::GetTask() const
{
    return m_task;
}

bool DeleteRoleAssignmentResponse::TaskHasBeenSet() const
{
