...
CoreInternalOutcome RejectJoinShareUnitInvitationResponse::Deserialize(const string &payload)
{
...
string RejectJoinShareUnitInvitationResponse::ToJsonString() const
{
