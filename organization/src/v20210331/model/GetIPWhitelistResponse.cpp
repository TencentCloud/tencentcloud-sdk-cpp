...
GetIPWhitelistResponse::GetIPWhitelistResponse() :
    m_ipWhitelistHasBeenSet(false)
{
}

CoreInternalOutcome GetIPWhitelistResponse::Deserialize(const string &payload)
{
...
string GetIPWhitelistResponse::ToJsonString() const
{
...
vector<string> GetIPWhitelistResponse::GetIpWhitelist() const
{
    return m_ipWhitelist;
}

bool GetIPWhitelistResponse::IpWhitelistHasBeenSet() const
{
