...
CoreInternalOutcome UpdateCustomPolicyForRoleConfigurationResponse::Deserialize(const string &payload)
{
...
string UpdateCustomPolicyForRoleConfigurationResponse::ToJsonString() const
{
