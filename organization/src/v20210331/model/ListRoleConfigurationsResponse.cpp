...
ListRoleConfigurationsResponse::ListRoleConfigurationsResponse() :
    ...
    m_roleConfigurationsHasBeenSet(false)
{
}

CoreInternalOutcome ListRoleConfigurationsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("RoleConfigurations") && !rsp["RoleConfigurations"].IsNull())
    {
        if (!rsp["RoleConfigurations"].IsArray())
            return CoreInternalOutcome(Core::Error("response `RoleConfigurations` is not array type"));

        const rapidjson::Value &tmpValue = rsp["RoleConfigurations"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            RoleConfiguration item;
            ...
            m_roleConfigurations.push_back(item);
        }
        m_roleConfigurationsHasBeenSet = true;
    }
...
string ListRoleConfigurationsResponse::ToJsonString() const
{
    ...
    if (m_roleConfigurationsHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "RoleConfigurations";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(rapidjson::kArrayType).Move(), allocator);

        int i=0;
        for (auto itr = m_roleConfigurations.begin(); itr != m_roleConfigurations.end(); ++itr, ++i)
        {
...
int64_t ListRoleConfigurationsResponse::GetTotalCounts() const
{
    return m_totalCounts;
}

bool ListRoleConfigurationsResponse::TotalCountsHasBeenSet() const
{
    return m_totalCountsHasBeenSet;
}

int64_t ListRoleConfigurationsResponse::GetMaxResults() const
{
    return m_maxResults;
}

bool ListRoleConfigurationsResponse::MaxResultsHasBeenSet() const
{
    return m_maxResultsHasBeenSet;
}

bool ListRoleConfigurationsResponse::GetIsTruncated() const
{
    return m_isTruncated;
}

bool ListRoleConfigurationsResponse::IsTruncatedHasBeenSet() const
{
    return m_isTruncatedHasBeenSet;
}

string ListRoleConfigurationsResponse::GetNextToken() const
{
    return m_nextToken;
}

bool ListRoleConfigurationsResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

vector<RoleConfiguration> ListRoleConfigurationsResponse::GetRoleConfigurations() const
{
    return m_roleConfigurations;
}

bool ListRoleConfigurationsResponse::RoleConfigurationsHasBeenSet() const
{
    return m_roleConfigurationsHasBeenSet;
}
