...
string DeleteRoleConfigurationRequest::ToJsonString() const
{
...
string DeleteRoleConfigurationRequest::GetZoneId() const
{
    return m_zoneId;
}

void DeleteRoleConfigurationRequest::SetZoneId(const string& _zoneId)
{
    m_zoneId = _zoneId;
    m_zoneIdHasBeenSet = true;
}

bool DeleteRoleConfigurationRequest::ZoneIdHasBeenSet() const
{
    return m_zoneIdHasBeenSet;
}

string DeleteRoleConfigurationRequest::GetRoleConfigurationId() const
{
    return m_roleConfigurationId;
}

void DeleteRoleConfigurationRequest::SetRoleConfigurationId(const string& _roleConfigurationId)
{
    m_roleConfigurationId = _roleConfigurationId;
    m_roleConfigurationIdHasBeenSet = true;
}

bool DeleteRoleConfigurationRequest::RoleConfigurationIdHasBeenSet() const
{
