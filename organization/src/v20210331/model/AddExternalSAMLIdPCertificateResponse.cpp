...
CoreInternalOutcome AddExternalSAMLIdPCertificateResponse::Deserialize(const string &payload)
{
...
string AddExternalSAMLIdPCertificateResponse::ToJsonString() const
{
...
string AddExternalSAMLIdPCertificateResponse::GetCertificateId() const
{
    return m_certificateId;
}

bool AddExternalSAMLIdPCertificateResponse::CertificateIdHasBeenSet() const
{
