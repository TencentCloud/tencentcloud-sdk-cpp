...
CoreInternalOutcome CreateOrganizationMemberPolicyResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationMemberPolicyResponse::ToJsonString() const
{
...
int64_t CreateOrganizationMemberPolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateOrganizationMemberPolicyResponse::PolicyIdHasBeenSet() const
{
