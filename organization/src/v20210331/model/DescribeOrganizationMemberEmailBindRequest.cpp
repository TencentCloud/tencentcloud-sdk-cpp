...
string DescribeOrganizationMemberEmailBindRequest::ToJsonString() const
{
...
int64_t DescribeOrganizationMemberEmailBindRequest::GetMemberUin() const
{
    return m_memberUin;
}

void DescribeOrganizationMemberEmailBindRequest::SetMemberUin(const int64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool DescribeOrganizationMemberEmailBindRequest::MemberUinHasBeenSet() const
{
