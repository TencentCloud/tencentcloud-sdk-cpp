...
CoreInternalOutcome ListGroupsResponse::Deserialize(const string &payload)
{
...
string ListGroupsResponse::ToJsonString() const
{
...
string ListGroupsResponse::GetNextToken() const
{
    return m_nextToken;
}

bool ListGroupsResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

vector<GroupInfo> ListGroupsResponse::GetGroups() const
{
    return m_groups;
}

bool ListGroupsResponse::GroupsHasBeenSet() const
{
    return m_groupsHasBeenSet;
}

int64_t ListGroupsResponse::GetMaxResults() const
{
    return m_maxResults;
}

bool ListGroupsResponse::MaxResultsHasBeenSet() const
{
    return m_maxResultsHasBeenSet;
}

int64_t ListGroupsResponse::GetTotalCounts() const
{
    return m_totalCounts;
}

bool ListGroupsResponse::TotalCountsHasBeenSet() const
{
    return m_totalCountsHasBeenSet;
}

bool ListGroupsResponse::GetIsTruncated() const
{
    return m_isTruncated;
}

bool ListGroupsResponse::IsTruncatedHasBeenSet() const
{
