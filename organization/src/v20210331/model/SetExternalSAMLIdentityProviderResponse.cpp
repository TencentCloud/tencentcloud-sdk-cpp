...
CoreInternalOutcome SetExternalSAMLIdentityProviderResponse::Deserialize(const string &payload)
{
...
string SetExternalSAMLIdentityProviderResponse::ToJsonString() const
{
