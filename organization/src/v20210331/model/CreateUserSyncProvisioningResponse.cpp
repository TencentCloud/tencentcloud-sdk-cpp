...
CoreInternalOutcome CreateUserSyncProvisioningResponse::Deserialize(const string &payload)
{
...
string CreateUserSyncProvisioningResponse::ToJsonString() const
{
...
vector<UserProvisioningsTask> CreateUserSyncProvisioningResponse::GetTasks() const
{
    return m_tasks;
}

bool CreateUserSyncProvisioningResponse::TasksHasBeenSet() const
{
