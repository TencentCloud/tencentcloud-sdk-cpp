...
string DescribeOrganizationAuthNodeRequest::ToJsonString() const
{
...
uint64_t DescribeOrganizationAuthNodeRequest::GetOffset() const
{
    return m_offset;
}

void DescribeOrganizationAuthNodeRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeOrganizationAuthNodeRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

uint64_t DescribeOrganizationAuthNodeRequest::GetLimit() const
{
    return m_limit;
}

void DescribeOrganizationAuthNodeRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
