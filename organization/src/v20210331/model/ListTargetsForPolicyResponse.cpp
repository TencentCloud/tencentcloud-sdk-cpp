...
CoreInternalOutcome ListTargetsForPolicyResponse::Deserialize(const string &payload)
{
...
string ListTargetsForPolicyResponse::ToJsonString() const
{
...
uint64_t ListTargetsForPolicyResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool ListTargetsForPolicyResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

vector<ListTargetsForPolicyNode> ListTargetsForPolicyResponse::GetList() const
{
    return m_list;
}

bool ListTargetsForPolicyResponse::ListHasBeenSet() const
{
