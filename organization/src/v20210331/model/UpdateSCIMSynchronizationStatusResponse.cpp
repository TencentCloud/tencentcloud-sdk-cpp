...
CoreInternalOutcome UpdateSCIMSynchronizationStatusResponse::Deserialize(const string &payload)
{
...
string UpdateSCIMSynchronizationStatusResponse::ToJsonString() const
{
