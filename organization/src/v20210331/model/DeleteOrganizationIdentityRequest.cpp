...
string DeleteOrganizationIdentityRequest::ToJsonString() const
{
...
uint64_t DeleteOrganizationIdentityRequest::GetIdentityId() const
{
    return m_identityId;
}

void DeleteOrganizationIdentityRequest::SetIdentityId(const uint64_t& _identityId)
{
    m_identityId = _identityId;
    m_identityIdHasBeenSet = true;
}

bool DeleteOrganizationIdentityRequest::IdentityIdHasBeenSet() const
{
