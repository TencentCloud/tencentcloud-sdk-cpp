...
CoreInternalOutcome AcceptJoinShareUnitInvitationResponse::Deserialize(const string &payload)
{
...
string AcceptJoinShareUnitInvitationResponse::ToJsonString() const
{
