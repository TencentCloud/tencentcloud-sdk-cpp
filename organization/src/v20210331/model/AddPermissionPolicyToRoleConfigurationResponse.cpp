...
CoreInternalOutcome AddPermissionPolicyToRoleConfigurationResponse::Deserialize(const string &payload)
{
...
string AddPermissionPolicyToRoleConfigurationResponse::ToJsonString() const
{
