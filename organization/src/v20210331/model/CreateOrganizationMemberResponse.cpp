...
CoreInternalOutcome CreateOrganizationMemberResponse::Deserialize(const string &payload)
{
...
string CreateOrganizationMemberResponse::ToJsonString() const
{
...
int64_t CreateOrganizationMemberResponse::GetUin() const
{
    return m_uin;
}

bool CreateOrganizationMemberResponse::UinHasBeenSet() const
{
