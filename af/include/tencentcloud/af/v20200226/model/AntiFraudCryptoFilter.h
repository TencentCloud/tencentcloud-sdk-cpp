...
#ifndef TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDCRYPTOFILTER_H_
#define TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDCRYPTOFILTER_H_
    ...
    namespace Af
    {
        namespace V20200226
        {
            namespace Model
            {
                ...
                */
                class AntiFraudCryptoFilter : public AbstractModel
                {
                public:
                    AntiFraudCryptoFilter();
                    ~AntiFraudCryptoFilter() = default;
...
#endif // !TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDCRYPTOFILTER_H_
