...
#ifndef TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDFILTER_H_
#define TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDFILTER_H_
    ...
    namespace Af
    {
        namespace V20200226
        {
            namespace Model
            {
                ...
                */
                class AntiFraudFilter : public AbstractModel
                {
                public:
                    AntiFraudFilter();
                    ~AntiFraudFilter() = default;
...
#endif // !TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDFILTER_H_
