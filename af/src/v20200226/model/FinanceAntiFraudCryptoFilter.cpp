...
CoreInternalOutcome FinanceAntiFraudCryptoFilter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CryptoType") && !value["CryptoType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `FinanceAntiFraudCryptoFilter.CryptoType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CryptoContent") && !value["CryptoContent"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `FinanceAntiFraudCryptoFilter.CryptoContent` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void FinanceAntiFraudCryptoFilter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string FinanceAntiFraudCryptoFilter::GetCryptoType() const
{
    return m_cryptoType;
}

void FinanceAntiFraudCryptoFilter::SetCryptoType(const string& _cryptoType)
{
    m_cryptoType = _cryptoType;
    m_cryptoTypeHasBeenSet = true;
}

bool FinanceAntiFraudCryptoFilter::CryptoTypeHasBeenSet() const
{
    return m_cryptoTypeHasBeenSet;
}

string FinanceAntiFraudCryptoFilter::GetCryptoContent() const
{
    return m_cryptoContent;
}

void FinanceAntiFraudCryptoFilter::SetCryptoContent(const string& _cryptoContent)
{
    m_cryptoContent = _cryptoContent;
    m_cryptoContentHasBeenSet = true;
}

bool FinanceAntiFraudCryptoFilter::CryptoContentHasBeenSet() const
{
