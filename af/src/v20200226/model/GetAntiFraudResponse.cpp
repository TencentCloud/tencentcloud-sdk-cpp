...
CoreInternalOutcome GetAntiFraudResponse::Deserialize(const string &payload)
{
...
string GetAntiFraudResponse::ToJsonString() const
{
...
AntiFraudRecord GetAntiFraudResponse::GetData() const
{
    return m_data;
}

bool GetAntiFraudResponse::DataHasBeenSet() const
{
