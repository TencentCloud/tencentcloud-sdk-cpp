...
CoreInternalOutcome DescribeAntiFraudResponse::Deserialize(const string &payload)
{
...
string DescribeAntiFraudResponse::ToJsonString() const
{
...
FinanceAntiFraudRecord DescribeAntiFraudResponse::GetData() const
{
    return m_data;
}

bool DescribeAntiFraudResponse::DataHasBeenSet() const
{
