...
string DescribeAntiFraudRequest::ToJsonString() const
{
...
FinanceAntiFraudFilter DescribeAntiFraudRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void DescribeAntiFraudRequest::SetBusinessSecurityData(const FinanceAntiFraudFilter& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool DescribeAntiFraudRequest::BusinessSecurityDataHasBeenSet() const
{
    return m_businessSecurityDataHasBeenSet;
}

FinanceAntiFraudCryptoFilter DescribeAntiFraudRequest::GetBusinessCryptoData() const
{
    return m_businessCryptoData;
}

void DescribeAntiFraudRequest::SetBusinessCryptoData(const FinanceAntiFraudCryptoFilter& _businessCryptoData)
{
    m_businessCryptoData = _businessCryptoData;
    m_businessCryptoDataHasBeenSet = true;
}

bool DescribeAntiFraudRequest::BusinessCryptoDataHasBeenSet() const
{
