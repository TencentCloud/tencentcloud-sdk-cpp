...
string DescribeKBLicenseRequest::ToJsonString() const
{
    ...
    if (m_licenseExpressionHasBeenSet)
    {
        ...
        d.AddMember(iKey, rapidjson::Value(m_licenseExpression.c_str(), allocator).Move(), allocator);
    }
...
string DescribeKBLicenseRequest::GetLicenseExpression() const
{
    return m_licenseExpression;
}

void DescribeKBLicenseRequest::SetLicenseExpression(const string& _licenseExpression)
{
    m_licenseExpression = _licenseExpression;
    m_licenseExpressionHasBeenSet = true;
}

bool DescribeKBLicenseRequest::LicenseExpressionHasBeenSet() const
{
