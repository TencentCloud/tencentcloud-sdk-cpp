...
CoreInternalOutcome FileTranslateResponse::Deserialize(const string &payload)
{
...
string FileTranslateResponse::ToJsonString() const
{
...
Task FileTranslateResponse::GetData() const
{
    return m_data;
}

bool FileTranslateResponse::DataHasBeenSet() const
{
