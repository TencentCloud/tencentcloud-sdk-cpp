...
CoreInternalOutcome GetFileTranslateResponse::Deserialize(const string &payload)
{
...
string GetFileTranslateResponse::ToJsonString() const
{
...
GetFileTranslateData GetFileTranslateResponse::GetData() const
{
    return m_data;
}

bool GetFileTranslateResponse::DataHasBeenSet() const
{
