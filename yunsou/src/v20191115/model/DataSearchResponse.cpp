...
CoreInternalOutcome DataSearchResponse::Deserialize(const string &payload)
{
...
string DataSearchResponse::ToJsonString() const
{
...
SearchResult DataSearchResponse::GetData() const
{
    return m_data;
}

bool DataSearchResponse::DataHasBeenSet() const
{
