...
CoreInternalOutcome DataManipulationResponse::Deserialize(const string &payload)
{
...
string DataManipulationResponse::ToJsonString() const
{
...
DataManipulationResult DataManipulationResponse::GetData() const
{
    return m_data;
}

bool DataManipulationResponse::DataHasBeenSet() const
{
