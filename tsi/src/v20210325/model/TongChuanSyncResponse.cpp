...
TongChuanSyncResponse::TongChuanSyncResponse() :
    m_listHasBeenSet(false)
{
}

CoreInternalOutcome TongChuanSyncResponse::Deserialize(const string &payload)
{
...
string TongChuanSyncResponse::ToJsonString() const
{
...
vector<DisplayInfo> TongChuanSyncResponse::GetList() const
{
    return m_list;
}

bool TongChuanSyncResponse::ListHasBeenSet() const
{
