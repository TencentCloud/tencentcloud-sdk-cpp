...
TongChuanDisplayResponse::TongChuanDisplayResponse() :
    m_listHasBeenSet(false)
{
}

CoreInternalOutcome TongChuanDisplayResponse::Deserialize(const string &payload)
{
...
string TongChuanDisplayResponse::ToJsonString() const
{
...
vector<DisplayInfo> TongChuanDisplayResponse::GetList() const
{
    return m_list;
}

bool TongChuanDisplayResponse::ListHasBeenSet() const
{
