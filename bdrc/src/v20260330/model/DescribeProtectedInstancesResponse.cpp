...
DescribeProtectedInstancesResponse::DescribeProtectedInstancesResponse() :
    m_totalCountHasBeenSet(false),
    m_instanceSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeProtectedInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeProtectedInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeProtectedInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeProtectedInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ProtectInstance> DescribeProtectedInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeProtectedInstancesResponse::InstanceSetHasBeenSet() const
{
