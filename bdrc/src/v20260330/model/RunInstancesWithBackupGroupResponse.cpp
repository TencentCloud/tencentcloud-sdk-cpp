...
RunInstancesWithBackupGroupResponse::RunInstancesWithBackupGroupResponse() :
    m_instanceIdSetHasBeenSet(false)
{
}

CoreInternalOutcome RunInstancesWithBackupGroupResponse::Deserialize(const string &payload)
{
...
string RunInstancesWithBackupGroupResponse::ToJsonString() const
{
...
vector<string> RunInstancesWithBackupGroupResponse::GetInstanceIdSet() const
{
    return m_instanceIdSet;
}

bool RunInstancesWithBackupGroupResponse::InstanceIdSetHasBeenSet() const
{
