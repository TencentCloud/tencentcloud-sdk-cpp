...
RunCopyPairTasksRequest::RunCopyPairTasksRequest() :
    m_copyPairIdsHasBeenSet(false),
    m_copyPairTypeHasBeenSet(false)
{
}

string RunCopyPairTasksRequest::ToJsonString() const
{
...
vector<string> RunCopyPairTasksRequest::GetCopyPairIds() const
{
    return m_copyPairIds;
}

void RunCopyPairTasksRequest::SetCopyPairIds(const vector<string>& _copyPairIds)
{
    m_copyPairIds = _copyPairIds;
    m_copyPairIdsHasBeenSet = true;
}

bool RunCopyPairTasksRequest::CopyPairIdsHasBeenSet() const
{
    return m_copyPairIdsHasBeenSet;
}

string RunCopyPairTasksRequest::GetCopyPairType() const
{
    return m_copyPairType;
}

void RunCopyPairTasksRequest::SetCopyPairType(const string& _copyPairType)
{
    m_copyPairType = _copyPairType;
    m_copyPairTypeHasBeenSet = true;
}

bool RunCopyPairTasksRequest::CopyPairTypeHasBeenSet() const
{
