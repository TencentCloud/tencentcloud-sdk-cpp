...
FinishFailoverCopyPairsRequest::FinishFailoverCopyPairsRequest() :
    m_copyPairIdsHasBeenSet(false),
    m_copyPairTypeHasBeenSet(false)
{
}

string FinishFailoverCopyPairsRequest::ToJsonString() const
{
...
vector<string> FinishFailoverCopyPairsRequest::GetCopyPairIds() const
{
    return m_copyPairIds;
}

void FinishFailoverCopyPairsRequest::SetCopyPairIds(const vector<string>& _copyPairIds)
{
    m_copyPairIds = _copyPairIds;
    m_copyPairIdsHasBeenSet = true;
}

bool FinishFailoverCopyPairsRequest::CopyPairIdsHasBeenSet() const
{
    return m_copyPairIdsHasBeenSet;
}

string FinishFailoverCopyPairsRequest::GetCopyPairType() const
{
    return m_copyPairType;
}

void FinishFailoverCopyPairsRequest::SetCopyPairType(const string& _copyPairType)
{
    m_copyPairType = _copyPairType;
    m_copyPairTypeHasBeenSet = true;
}

bool FinishFailoverCopyPairsRequest::CopyPairTypeHasBeenSet() const
{
