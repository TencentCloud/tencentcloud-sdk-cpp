...
BackupGroupDeniedAction::BackupGroupDeniedAction() :
    m_backupGroupIdHasBeenSet(false),
    m_deniedActionsHasBeenSet(false)
{
}

CoreInternalOutcome BackupGroupDeniedAction::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("BackupGroupId") && !value["BackupGroupId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `BackupGroupDeniedAction.BackupGroupId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DeniedActions") && !value["DeniedActions"].IsNull())
    {
        if (!value["DeniedActions"].IsArray())
            return CoreInternalOutcome(Core::Error("response `BackupGroupDeniedAction.DeniedActions` is not array type"));
...
void BackupGroupDeniedAction::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string BackupGroupDeniedAction::GetBackupGroupId() const
{
    return m_backupGroupId;
}

void BackupGroupDeniedAction::SetBackupGroupId(const string& _backupGroupId)
{
    m_backupGroupId = _backupGroupId;
    m_backupGroupIdHasBeenSet = true;
}

bool BackupGroupDeniedAction::BackupGroupIdHasBeenSet() const
{
    return m_backupGroupIdHasBeenSet;
}

vector<DeniedAction> BackupGroupDeniedAction::GetDeniedActions() const
{
    return m_deniedActions;
}

void BackupGroupDeniedAction::SetDeniedActions(const vector<DeniedAction>& _deniedActions)
{
    m_deniedActions = _deniedActions;
    m_deniedActionsHasBeenSet = true;
}

bool BackupGroupDeniedAction::DeniedActionsHasBeenSet() const
{
