...
int64_t DescribeDisksResponse::GetTotalCount() const
{
    return m_totalCount;
}
...
vector<DiskInfo> DescribeDisksResponse::GetDiskInfoSet() const
{
    return m_diskInfoSet;
}

bool DescribeDisksResponse::DiskInfoSetHasBeenSet() const
{
