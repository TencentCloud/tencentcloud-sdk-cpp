...
StopCopyPairTasksRequest::StopCopyPairTasksRequest() :
    m_copyPairIdsHasBeenSet(false),
    m_copyPairTypeHasBeenSet(false)
{
}

string StopCopyPairTasksRequest::ToJsonString() const
{
...
vector<string> StopCopyPairTasksRequest::GetCopyPairIds() const
{
    return m_copyPairIds;
}

void StopCopyPairTasksRequest::SetCopyPairIds(const vector<string>& _copyPairIds)
{
    m_copyPairIds = _copyPairIds;
    m_copyPairIdsHasBeenSet = true;
}

bool StopCopyPairTasksRequest::CopyPairIdsHasBeenSet() const
{
    return m_copyPairIdsHasBeenSet;
}

string StopCopyPairTasksRequest::GetCopyPairType() const
{
    return m_copyPairType;
}

void StopCopyPairTasksRequest::SetCopyPairType(const string& _copyPairType)
{
    m_copyPairType = _copyPairType;
    m_copyPairTypeHasBeenSet = true;
}

bool StopCopyPairTasksRequest::CopyPairTypeHasBeenSet() const
{
