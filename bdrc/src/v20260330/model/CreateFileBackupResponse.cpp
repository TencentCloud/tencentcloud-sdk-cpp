...
CreateFileBackupResponse::CreateFileBackupResponse() :
    m_backupIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateFileBackupResponse::Deserialize(const string &payload)
{
...
string CreateFileBackupResponse::ToJsonString() const
{
...
string CreateFileBackupResponse::GetBackupId() const
{
    return m_backupId;
}

bool CreateFileBackupResponse::BackupIdHasBeenSet() const
{
