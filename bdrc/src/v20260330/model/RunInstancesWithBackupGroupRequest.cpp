...
RunInstancesWithBackupGroupRequest::RunInstancesWithBackupGroupRequest() :
    m_backupGroupIdHasBeenSet(false)
{
}

string RunInstancesWithBackupGroupRequest::ToJsonString() const
{
...
string RunInstancesWithBackupGroupRequest::GetBackupGroupId() const
{
    return m_backupGroupId;
}

void RunInstancesWithBackupGroupRequest::SetBackupGroupId(const string& _backupGroupId)
{
    m_backupGroupId = _backupGroupId;
    m_backupGroupIdHasBeenSet = true;
}

bool RunInstancesWithBackupGroupRequest::BackupGroupIdHasBeenSet() const
{
