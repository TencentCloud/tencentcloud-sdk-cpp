...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_DISKCOPYPAIRFORCVM_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_DISKCOPYPAIRFORCVM_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                * cvm的盘复制对信息
                */
                class DiskCopyPairForCvm : public AbstractModel
                {
                public:
                    DiskCopyPairForCvm();
                    ~DiskCopyPairForCvm() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取容灾端云硬盘ID（延迟创建模式且 CVM 未真实创建时被脱敏为空字符串）
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置容灾端云硬盘ID（延迟创建模式且 CVM 未真实创建时被脱敏为空字符串）
注意：此字段可能返回 null，表示取不到有效值。
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_DISKCOPYPAIRFORCVM_H_
