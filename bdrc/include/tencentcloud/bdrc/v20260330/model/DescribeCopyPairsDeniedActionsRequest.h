...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBECOPYPAIRSDENIEDACTIONSREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBECOPYPAIRSDENIEDACTIONSREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class DescribeCopyPairsDeniedActionsRequest : public AbstractModel
                {
                public:
                    DescribeCopyPairsDeniedActionsRequest();
                    ~DescribeCopyPairsDeniedActionsRequest() = default;
                    ...
                    /**
                     * 获取要查询复制对的类型，枚举值：DISK（云硬盘）、INSTANCE（云服务器）、CFS（文件存储）
                    ...
                    /**
                     * 设置要查询复制对的类型，枚举值：DISK（云硬盘）、INSTANCE（云服务器）、CFS（文件存储）
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBECOPYPAIRSDENIEDACTIONSREQUEST_H_
