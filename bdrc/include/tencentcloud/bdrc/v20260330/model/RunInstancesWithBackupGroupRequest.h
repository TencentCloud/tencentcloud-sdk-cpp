...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_RUNINSTANCESWITHBACKUPGROUPREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_RUNINSTANCESWITHBACKUPGROUPREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class RunInstancesWithBackupGroupRequest : public AbstractModel
                {
                public:
                    RunInstancesWithBackupGroupRequest();
                    ~RunInstancesWithBackupGroupRequest() = default;
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_RUNINSTANCESWITHBACKUPGROUPREQUEST_H_
