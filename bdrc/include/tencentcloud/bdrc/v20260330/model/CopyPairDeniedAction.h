...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_COPYPAIRDENIEDACTION_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_COPYPAIRDENIEDACTION_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                * 复制对操作掩码
                */
                class CopyPairDeniedAction : public AbstractModel
                {
                public:
                    CopyPairDeniedAction();
                    ~CopyPairDeniedAction() = default;
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_COPYPAIRDENIEDACTION_H_
