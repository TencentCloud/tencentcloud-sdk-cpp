...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEFILEBACKUPSREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEFILEBACKUPSREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class DescribeFileBackupsRequest : public AbstractModel
                {
                public:
                    DescribeFileBackupsRequest();
                    ~DescribeFileBackupsRequest() = default;
                    ...
                    /**
                     * 获取过滤条件。支持: backup-id, plan-id, instance-id, status, backup-type, auto-backup-policy-id
                    ...
                    /**
                     * 设置过滤条件。支持: backup-id, plan-id, instance-id, status, backup-type, auto-backup-policy-id
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEFILEBACKUPSREQUEST_H_
