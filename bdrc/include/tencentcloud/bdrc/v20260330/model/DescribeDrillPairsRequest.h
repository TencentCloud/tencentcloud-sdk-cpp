...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEDRILLPAIRSREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEDRILLPAIRSREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class DescribeDrillPairsRequest : public AbstractModel
                {
                public:
                    DescribeDrillPairsRequest();
                    ~DescribeDrillPairsRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
                    ...
                    /**
                     * 设置要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
                    ...
                    /**
                     * 获取输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
                    ...
                    /**
                     * 设置输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBEDRILLPAIRSREQUEST_H_
