...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBESECURITYGROUPMAPPINGSREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBESECURITYGROUPMAPPINGSREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class DescribeSecurityGroupMappingsRequest : public AbstractModel
                {
                public:
                    DescribeSecurityGroupMappingsRequest();
                    ~DescribeSecurityGroupMappingsRequest() = default;
                    ...
                    /**
                     * 获取过滤条件，详见过滤条件表。支持的Name：src-security-group-id、target-security-group-id
                    ...
                    /**
                     * 设置过滤条件，详见过滤条件表。支持的Name：src-security-group-id、target-security-group-id
                    ...
                    /**
                     * 获取返回数量，默认为20，最大值为500。关于Limit的更进一步介绍请参考 API 简介中的相关小节
                    ...
                    /**
                     * 设置返回数量，默认为20，最大值为500。关于Limit的更进一步介绍请参考 API 简介中的相关小节
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_DESCRIBESECURITYGROUPMAPPINGSREQUEST_H_
