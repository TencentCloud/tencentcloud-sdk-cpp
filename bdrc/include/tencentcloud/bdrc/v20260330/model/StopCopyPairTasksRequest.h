...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_STOPCOPYPAIRTASKSREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_STOPCOPYPAIRTASKSREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class StopCopyPairTasksRequest : public AbstractModel
                {
                public:
                    StopCopyPairTasksRequest();
                    ~StopCopyPairTasksRequest() = default;
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_STOPCOPYPAIRTASKSREQUEST_H_
