...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_MODIFYFILEBACKUPATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_MODIFYFILEBACKUPATTRIBUTEREQUEST_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                */
                class ModifyFileBackupAttributeRequest : public AbstractModel
                {
                public:
                    ModifyFileBackupAttributeRequest();
                    ~ModifyFileBackupAttributeRequest() = default;
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_MODIFYFILEBACKUPATTRIBUTEREQUEST_H_
