...
#ifndef TENCENTCLOUD_BDRC_V20260330_MODEL_PROTECTGROUPDENIEDACTION_H_
#define TENCENTCLOUD_BDRC_V20260330_MODEL_PROTECTGROUPDENIEDACTION_H_
    ...
    namespace Bdrc
    {
        namespace V20260330
        {
            namespace Model
            {
                ...
                * 保护组操作掩码
                */
                class ProtectGroupDeniedAction : public AbstractModel
                {
                public:
                    ProtectGroupDeniedAction();
                    ~ProtectGroupDeniedAction() = default;
...
#endif // !TENCENTCLOUD_BDRC_V20260330_MODEL_PROTECTGROUPDENIEDACTION_H_
