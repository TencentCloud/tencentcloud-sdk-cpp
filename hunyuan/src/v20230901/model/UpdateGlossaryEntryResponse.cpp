...
UpdateGlossaryEntryResponse::UpdateGlossaryEntryResponse() :
    m_entriesHasBeenSet(false)
{
}

CoreInternalOutcome UpdateGlossaryEntryResponse::Deserialize(const string &payload)
{
...
string UpdateGlossaryEntryResponse::ToJsonString() const
{
...
vector<GlossaryEntry> UpdateGlossaryEntryResponse::GetEntries() const
{
    return m_entries;
}

bool UpdateGlossaryEntryResponse::EntriesHasBeenSet() const
{
