...
ImageQuestionResponse::ImageQuestionResponse() :
...
CoreInternalOutcome ImageQuestionResponse::Deserialize(const string &payload)
{
...
string ImageQuestionResponse::ToJsonString() const
{
...
int64_t ImageQuestionResponse::GetCreated() const
{
    return m_created;
}

bool ImageQuestionResponse::CreatedHasBeenSet() const
{
    return m_createdHasBeenSet;
}

Usage ImageQuestionResponse::GetUsage() const
{
    return m_usage;
}

bool ImageQuestionResponse::UsageHasBeenSet() const
{
    return m_usageHasBeenSet;
}

string ImageQuestionResponse::GetNote() const
{
    return m_note;
}

bool ImageQuestionResponse::NoteHasBeenSet() const
{
    return m_noteHasBeenSet;
}

string ImageQuestionResponse::GetId() const
{
    return m_id;
}

bool ImageQuestionResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

vector<Choice> ImageQuestionResponse::GetChoices() const
{
    return m_choices;
}

bool ImageQuestionResponse::ChoicesHasBeenSet() const
{
    return m_choicesHasBeenSet;
}

ErrorMsg ImageQuestionResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ImageQuestionResponse::ErrorMsgHasBeenSet() const
{
