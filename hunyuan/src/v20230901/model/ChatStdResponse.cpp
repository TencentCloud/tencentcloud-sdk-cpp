...
ChatStdResponse::ChatStdResponse() :
...
CoreInternalOutcome ChatStdResponse::Deserialize(const string &payload)
{
...
string ChatStdResponse::ToJsonString() const
{
...
int64_t ChatStdResponse::GetCreated() const
{
    return m_created;
}

bool ChatStdResponse::CreatedHasBeenSet() const
{
    return m_createdHasBeenSet;
}

Usage ChatStdResponse::GetUsage() const
{
    return m_usage;
}

bool ChatStdResponse::UsageHasBeenSet() const
{
    return m_usageHasBeenSet;
}

string ChatStdResponse::GetNote() const
{
    return m_note;
}

bool ChatStdResponse::NoteHasBeenSet() const
{
    return m_noteHasBeenSet;
}

string ChatStdResponse::GetId() const
{
    return m_id;
}

bool ChatStdResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

vector<Choice> ChatStdResponse::GetChoices() const
{
    return m_choices;
}

bool ChatStdResponse::ChoicesHasBeenSet() const
{
    return m_choicesHasBeenSet;
}

ErrorMsg ChatStdResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ChatStdResponse::ErrorMsgHasBeenSet() const
{
