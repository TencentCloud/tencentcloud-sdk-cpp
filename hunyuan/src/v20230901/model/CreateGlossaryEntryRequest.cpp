...
string CreateGlossaryEntryRequest::ToJsonString() const
{
...
string CreateGlossaryEntryRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void CreateGlossaryEntryRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool CreateGlossaryEntryRequest::GlossaryIdHasBeenSet() const
{
    return m_glossaryIdHasBeenSet;
}

vector<GlossaryEntryCreateItem> CreateGlossaryEntryRequest::GetEntries() const
{
    return m_entries;
}

void CreateGlossaryEntryRequest::SetEntries(const vector<GlossaryEntryCreateItem>& _entries)
{
    m_entries = _entries;
    m_entriesHasBeenSet = true;
}

bool CreateGlossaryEntryRequest::EntriesHasBeenSet() const
{
