...
ChatProResponse::ChatProResponse() :
...
CoreInternalOutcome ChatProResponse::Deserialize(const string &payload)
{
...
string ChatProResponse::ToJsonString() const
{
...
int64_t ChatProResponse::GetCreated() const
{
    return m_created;
}

bool ChatProResponse::CreatedHasBeenSet() const
{
    return m_createdHasBeenSet;
}

Usage ChatProResponse::GetUsage() const
{
    return m_usage;
}

bool ChatProResponse::UsageHasBeenSet() const
{
    return m_usageHasBeenSet;
}

string ChatProResponse::GetNote() const
{
    return m_note;
}

bool ChatProResponse::NoteHasBeenSet() const
{
    return m_noteHasBeenSet;
}

string ChatProResponse::GetId() const
{
    return m_id;
}

bool ChatProResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

vector<Choice> ChatProResponse::GetChoices() const
{
    return m_choices;
}

bool ChatProResponse::ChoicesHasBeenSet() const
{
    return m_choicesHasBeenSet;
}

ErrorMsg ChatProResponse::GetErrorMsg() const
{
    return m_errorMsg;
}

bool ChatProResponse::ErrorMsgHasBeenSet() const
{
