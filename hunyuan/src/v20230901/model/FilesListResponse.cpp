...
CoreInternalOutcome FilesListResponse::Deserialize(const string &payload)
{
...
string FilesListResponse::ToJsonString() const
{
...
uint64_t FilesListResponse::GetTotal() const
{
    return m_total;
}

bool FilesListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

string FilesListResponse::GetObject() const
{
    return m_object;
}

bool FilesListResponse::ObjectHasBeenSet() const
{
    return m_objectHasBeenSet;
}

vector<FileObject> FilesListResponse::GetData() const
{
    return m_data;
}

bool FilesListResponse::DataHasBeenSet() const
{
