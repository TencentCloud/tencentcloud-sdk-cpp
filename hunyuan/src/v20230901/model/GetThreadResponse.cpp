...
CoreInternalOutcome GetThreadResponse::Deserialize(const string &payload)
{
...
string GetThreadResponse::ToJsonString() const
{
...
string GetThreadResponse::GetID() const
{
    return m_iD;
}

bool GetThreadResponse::IDHasBeenSet() const
{
    return m_iDHasBeenSet;
}

string GetThreadResponse::GetObject() const
{
    return m_object;
}

bool GetThreadResponse::ObjectHasBeenSet() const
{
    return m_objectHasBeenSet;
}

int64_t GetThreadResponse::GetCreatedAt() const
{
    return m_createdAt;
}

bool GetThreadResponse::CreatedAtHasBeenSet() const
{
    return m_createdAtHasBeenSet;
}

ThreadToolResources GetThreadResponse::GetToolResources() const
{
    return m_toolResources;
}

bool GetThreadResponse::ToolResourcesHasBeenSet() const
{
