...
CreateGlossaryEntryResponse::CreateGlossaryEntryResponse() :
    m_entriesHasBeenSet(false)
{
}

CoreInternalOutcome CreateGlossaryEntryResponse::Deserialize(const string &payload)
{
...
string CreateGlossaryEntryResponse::ToJsonString() const
{
...
vector<GlossaryEntry> CreateGlossaryEntryResponse::GetEntries() const
{
    return m_entries;
}

bool CreateGlossaryEntryResponse::EntriesHasBeenSet() const
{
