...
string UpdateGlossaryEntryRequest::ToJsonString() const
{
...
string UpdateGlossaryEntryRequest::GetGlossaryId() const
{
    return m_glossaryId;
}

void UpdateGlossaryEntryRequest::SetGlossaryId(const string& _glossaryId)
{
    m_glossaryId = _glossaryId;
    m_glossaryIdHasBeenSet = true;
}

bool UpdateGlossaryEntryRequest::GlossaryIdHasBeenSet() const
{
    return m_glossaryIdHasBeenSet;
}

vector<GlossaryEntryUpdateItem> UpdateGlossaryEntryRequest::GetEntries() const
{
    return m_entries;
}

void UpdateGlossaryEntryRequest::SetEntries(const vector<GlossaryEntryUpdateItem>& _entries)
{
    m_entries = _entries;
    m_entriesHasBeenSet = true;
}

bool UpdateGlossaryEntryRequest::EntriesHasBeenSet() const
{
