...
CoreInternalOutcome Describe3DSmartTopologyJobResponse::Deserialize(const string &payload)
{
...
string Describe3DSmartTopologyJobResponse::ToJsonString() const
{
...
string Describe3DSmartTopologyJobResponse::GetStatus() const
{
    return m_status;
}

bool Describe3DSmartTopologyJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string Describe3DSmartTopologyJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool Describe3DSmartTopologyJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string Describe3DSmartTopologyJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool Describe3DSmartTopologyJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> Describe3DSmartTopologyJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool Describe3DSmartTopologyJobResponse::ResultFile3DsHasBeenSet() const
{
