...
QueryHunyuanTo3DJobResponse::QueryHunyuanTo3DJobResponse() :
...
CoreInternalOutcome QueryHunyuanTo3DJobResponse::Deserialize(const string &payload)
{
...
string QueryHunyuanTo3DJobResponse::ToJsonString() const
{
...
string QueryHunyuanTo3DJobResponse::GetStatus() const
{
    return m_status;
}

bool QueryHunyuanTo3DJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<File3Ds> QueryHunyuanTo3DJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool QueryHunyuanTo3DJobResponse::ResultFile3DsHasBeenSet() const
{
    return m_resultFile3DsHasBeenSet;
}

string QueryHunyuanTo3DJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool QueryHunyuanTo3DJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string QueryHunyuanTo3DJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool QueryHunyuanTo3DJobResponse::ErrorMessageHasBeenSet() const
{
