...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDRESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * ChatStd返回参数结构体
                */
                class ChatStdResponse : public AbstractModel
                {
                public:
                    ChatStdResponse();
                    ~ChatStdResponse() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDRESPONSE_H_
