...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRYCREATEITEM_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRYCREATEITEM_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * 术语条目
                */
                class GlossaryEntryCreateItem : public AbstractModel
                {
                public:
                    GlossaryEntryCreateItem();
                    ~GlossaryEntryCreateItem() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRYCREATEITEM_H_
