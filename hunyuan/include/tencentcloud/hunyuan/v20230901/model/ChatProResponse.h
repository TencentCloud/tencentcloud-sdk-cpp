...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATPRORESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATPRORESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * ChatPro返回参数结构体
                */
                class ChatProResponse : public AbstractModel
                {
                public:
                    ChatProResponse();
                    ~ChatProResponse() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATPRORESPONSE_H_
