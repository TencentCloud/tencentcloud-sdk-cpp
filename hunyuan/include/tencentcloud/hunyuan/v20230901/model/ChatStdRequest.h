...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDREQUEST_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDREQUEST_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * ChatStd请求参数结构体
                */
                class ChatStdRequest : public AbstractModel
                {
                public:
                    ChatStdRequest();
                    ~ChatStdRequest() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_CHATSTDREQUEST_H_
