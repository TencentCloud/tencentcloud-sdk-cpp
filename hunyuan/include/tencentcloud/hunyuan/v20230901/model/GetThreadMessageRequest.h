...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADMESSAGEREQUEST_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADMESSAGEREQUEST_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class GetThreadMessageRequest : public AbstractModel
                {
                public:
                    GetThreadMessageRequest();
                    ~GetThreadMessageRequest() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADMESSAGEREQUEST_H_
