...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRY_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRY_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * 术语条目
                */
                class GlossaryEntry : public AbstractModel
                {
                public:
                    GlossaryEntry();
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GLOSSARYENTRY_H_
