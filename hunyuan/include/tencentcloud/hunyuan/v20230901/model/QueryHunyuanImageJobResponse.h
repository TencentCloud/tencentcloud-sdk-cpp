...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANIMAGEJOBRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANIMAGEJOBRESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class QueryHunyuanImageJobResponse : public AbstractModel
                {
                public:
                    QueryHunyuanImageJobResponse();
                    ~QueryHunyuanImageJobResponse() = default;
...
1：等待中、2：运行中、4：处理失败、5：处理完成。
                    ...
                    /**
                     * 获取对应 SubmitHunyuanImageJob 接口中 Revise 参数。开启扩写时，返回扩写后的 prompt 文本。 如果关闭扩写，将直接返回原始输入的 prompt。
                     * @return RevisedPrompt 对应 SubmitHunyuanImageJob 接口中 Revise 参数。开启扩写时，返回扩写后的 prompt 文本。 如果关闭扩写，将直接返回原始输入的 prompt。
                     * 
                     */
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANIMAGEJOBRESPONSE_H_
