...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_UPDATEGLOSSARYENTRYREQUEST_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_UPDATEGLOSSARYENTRYREQUEST_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class UpdateGlossaryEntryRequest : public AbstractModel
                {
                public:
                    UpdateGlossaryEntryRequest();
                    ~UpdateGlossaryEntryRequest() = default;
                     ...
                     * 
                     */
                    std::vector<GlossaryEntryUpdateItem> GetEntries() const;
                     ...
                     * 
                     */
                    void SetEntries(const std::vector<GlossaryEntryUpdateItem>& _entries);
                ...
                private:
                     ...
                     */
                    std::vector<GlossaryEntryUpdateItem> m_entries;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_UPDATEGLOSSARYENTRYREQUEST_H_
