...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_IMAGEQUESTIONRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_IMAGEQUESTIONRESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class ImageQuestionResponse : public AbstractModel
                {
                public:
                    ImageQuestionResponse();
                    ~ImageQuestionResponse() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_IMAGEQUESTIONRESPONSE_H_
