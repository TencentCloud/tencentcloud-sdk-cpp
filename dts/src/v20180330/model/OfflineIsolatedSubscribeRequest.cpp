...
string OfflineIsolatedSubscribeRequest::ToJsonString() const
{
...
string OfflineIsolatedSubscribeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void OfflineIsolatedSubscribeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool OfflineIsolatedSubscribeRequest::SubscribeIdHasBeenSet() const
{
