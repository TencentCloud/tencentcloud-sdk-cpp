...
CoreInternalOutcome CreateSyncJobResponse::Deserialize(const string &payload)
{
...
string CreateSyncJobResponse::ToJsonString() const
{
...
string CreateSyncJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateSyncJobResponse::JobIdHasBeenSet() const
{
