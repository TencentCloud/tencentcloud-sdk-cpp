...
CoreInternalOutcome CreateMigrateJobResponse::Deserialize(const string &payload)
{
...
string CreateMigrateJobResponse::ToJsonString() const
{
...
string CreateMigrateJobResponse::GetJobId() const
{
    return m_jobId;
}

bool CreateMigrateJobResponse::JobIdHasBeenSet() const
{
