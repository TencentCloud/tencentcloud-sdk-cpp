...
CoreInternalOutcome SwitchDrToMasterResponse::Deserialize(const string &payload)
{
...
string SwitchDrToMasterResponse::ToJsonString() const
{
...
string SwitchDrToMasterResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool SwitchDrToMasterResponse::AsyncRequestIdHasBeenSet() const
{
