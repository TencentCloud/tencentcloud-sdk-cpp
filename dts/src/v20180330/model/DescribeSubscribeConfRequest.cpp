...
string DescribeSubscribeConfRequest::ToJsonString() const
{
...
string DescribeSubscribeConfRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DescribeSubscribeConfRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DescribeSubscribeConfRequest::SubscribeIdHasBeenSet() const
{
