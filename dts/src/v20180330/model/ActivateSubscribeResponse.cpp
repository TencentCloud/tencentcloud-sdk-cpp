...
CoreInternalOutcome ActivateSubscribeResponse::Deserialize(const string &payload)
{
...
string ActivateSubscribeResponse::ToJsonString() const
{
...
string ActivateSubscribeResponse::GetAsyncRequestId() const
{
    return m_asyncRequestId;
}

bool ActivateSubscribeResponse::AsyncRequestIdHasBeenSet() const
{
