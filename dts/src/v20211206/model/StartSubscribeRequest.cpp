...
string StartSubscribeRequest::ToJsonString() const
{
...
string StartSubscribeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void StartSubscribeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool StartSubscribeRequest::SubscribeIdHasBeenSet() const
{
