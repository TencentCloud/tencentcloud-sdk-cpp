...
CoreInternalOutcome View::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("ViewName") && !value["ViewName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `View.ViewName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("NewViewName") && !value["NewViewName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `View.NewViewName` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void View::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string View::GetViewName() const
{
    return m_viewName;
}

void View::SetViewName(const string& _viewName)
{
    m_viewName = _viewName;
    m_viewNameHasBeenSet = true;
}

bool View::ViewNameHasBeenSet() const
{
    return m_viewNameHasBeenSet;
}

string View::GetNewViewName() const
{
    return m_newViewName;
}

void View::SetNewViewName(const string& _newViewName)
{
    m_newViewName = _newViewName;
    m_newViewNameHasBeenSet = true;
}

bool View::NewViewNameHasBeenSet() const
{
