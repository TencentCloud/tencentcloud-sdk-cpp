...
CoreInternalOutcome DescribeModifyCheckSyncJobResultResponse::Deserialize(const string &payload)
{
...
string DescribeModifyCheckSyncJobResultResponse::ToJsonString() const
{
...
string DescribeModifyCheckSyncJobResultResponse::GetStatus() const
{
    return m_status;
}

bool DescribeModifyCheckSyncJobResultResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

uint64_t DescribeModifyCheckSyncJobResultResponse::GetStepCount() const
{
    return m_stepCount;
}

bool DescribeModifyCheckSyncJobResultResponse::StepCountHasBeenSet() const
{
    return m_stepCountHasBeenSet;
}

uint64_t DescribeModifyCheckSyncJobResultResponse::GetStepCur() const
{
    return m_stepCur;
}

bool DescribeModifyCheckSyncJobResultResponse::StepCurHasBeenSet() const
{
    return m_stepCurHasBeenSet;
}

uint64_t DescribeModifyCheckSyncJobResultResponse::GetProgress() const
{
    return m_progress;
}

bool DescribeModifyCheckSyncJobResultResponse::ProgressHasBeenSet() const
{
    return m_progressHasBeenSet;
}

vector<StepInfo> DescribeModifyCheckSyncJobResultResponse::GetStepInfos() const
{
    return m_stepInfos;
}

bool DescribeModifyCheckSyncJobResultResponse::StepInfosHasBeenSet() const
{
