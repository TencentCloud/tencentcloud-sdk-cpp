...
CoreInternalOutcome ModifyConsumerGroupDescriptionResponse::Deserialize(const string &payload)
{
...
string ModifyConsumerGroupDescriptionResponse::ToJsonString() const
{
