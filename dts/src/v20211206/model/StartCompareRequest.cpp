...
string StartCompareRequest::ToJsonString() const
{
...
string StartCompareRequest::GetJobId() const
{
    return m_jobId;
}

void StartCompareRequest::SetJobId(const string& _jobId)
{
    m_jobId = _jobId;
    m_jobIdHasBeenSet = true;
}

bool StartCompareRequest::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string StartCompareRequest::GetCompareTaskId() const
{
    return m_compareTaskId;
}

void StartCompareRequest::SetCompareTaskId(const string& _compareTaskId)
{
    m_compareTaskId = _compareTaskId;
    m_compareTaskIdHasBeenSet = true;
}

bool StartCompareRequest::CompareTaskIdHasBeenSet() const
{
