...
string DescribeSubscribeCheckJobRequest::ToJsonString() const
{
...
string DescribeSubscribeCheckJobRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DescribeSubscribeCheckJobRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DescribeSubscribeCheckJobRequest::SubscribeIdHasBeenSet() const
{
