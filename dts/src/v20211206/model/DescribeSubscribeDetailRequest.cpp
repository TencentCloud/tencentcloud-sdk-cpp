...
string DescribeSubscribeDetailRequest::ToJsonString() const
{
...
string DescribeSubscribeDetailRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DescribeSubscribeDetailRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DescribeSubscribeDetailRequest::SubscribeIdHasBeenSet() const
{
