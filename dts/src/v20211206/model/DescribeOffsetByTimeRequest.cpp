...
string DescribeOffsetByTimeRequest::ToJsonString() const
{
...
string DescribeOffsetByTimeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DescribeOffsetByTimeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DescribeOffsetByTimeRequest::SubscribeIdHasBeenSet() const
{
    return m_subscribeIdHasBeenSet;
}

string DescribeOffsetByTimeRequest::GetTime() const
{
    return m_time;
}

void DescribeOffsetByTimeRequest::SetTime(const string& _time)
{
    m_time = _time;
    m_timeHasBeenSet = true;
}

bool DescribeOffsetByTimeRequest::TimeHasBeenSet() const
{
