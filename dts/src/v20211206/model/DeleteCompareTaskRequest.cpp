...
string DeleteCompareTaskRequest::ToJsonString() const
{
...
string DeleteCompareTaskRequest::GetJobId() const
{
    return m_jobId;
}

void DeleteCompareTaskRequest::SetJobId(const string& _jobId)
{
    m_jobId = _jobId;
    m_jobIdHasBeenSet = true;
}

bool DeleteCompareTaskRequest::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string DeleteCompareTaskRequest::GetCompareTaskId() const
{
    return m_compareTaskId;
}

void DeleteCompareTaskRequest::SetCompareTaskId(const string& _compareTaskId)
{
    m_compareTaskId = _compareTaskId;
    m_compareTaskIdHasBeenSet = true;
}

bool DeleteCompareTaskRequest::CompareTaskIdHasBeenSet() const
{
