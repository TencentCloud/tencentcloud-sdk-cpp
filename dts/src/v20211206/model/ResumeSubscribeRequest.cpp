...
string ResumeSubscribeRequest::ToJsonString() const
{
...
string ResumeSubscribeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void ResumeSubscribeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool ResumeSubscribeRequest::SubscribeIdHasBeenSet() const
{
