...
string DescribeMigrationDetailRequest::GetJobId() const
{
    return m_jobId;
}

void DescribeMigrationDetailRequest::SetJobId(const string& _jobId)
{
    m_jobId = _jobId;
    m_jobIdHasBeenSet = true;
}

bool DescribeMigrationDetailRequest::JobIdHasBeenSet() const
{
