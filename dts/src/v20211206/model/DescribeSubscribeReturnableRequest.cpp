...
string DescribeSubscribeReturnableRequest::ToJsonString() const
{
...
string DescribeSubscribeReturnableRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DescribeSubscribeReturnableRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DescribeSubscribeReturnableRequest::SubscribeIdHasBeenSet() const
{
