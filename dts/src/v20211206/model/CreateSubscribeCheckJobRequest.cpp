...
string CreateSubscribeCheckJobRequest::ToJsonString() const
{
...
string CreateSubscribeCheckJobRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void CreateSubscribeCheckJobRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool CreateSubscribeCheckJobRequest::SubscribeIdHasBeenSet() const
{
