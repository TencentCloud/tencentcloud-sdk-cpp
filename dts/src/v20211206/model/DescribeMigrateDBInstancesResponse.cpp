...
CoreInternalOutcome DescribeMigrateDBInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeMigrateDBInstancesResponse::ToJsonString() const
{
...
int64_t DescribeMigrateDBInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMigrateDBInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MigrateDBItem> DescribeMigrateDBInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeMigrateDBInstancesResponse::InstancesHasBeenSet() const
{
