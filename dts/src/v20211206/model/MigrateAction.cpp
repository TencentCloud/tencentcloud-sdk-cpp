...
CoreInternalOutcome MigrateAction::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("AllAction") && !value["AllAction"].IsNull())
    {
        if (!value["AllAction"].IsArray())
            return CoreInternalOutcome(Core::Error("response `MigrateAction.AllAction` is not array type"));
    ...
    if (value.HasMember("AllowedAction") && !value["AllowedAction"].IsNull())
    {
        if (!value["AllowedAction"].IsArray())
            return CoreInternalOutcome(Core::Error("response `MigrateAction.AllowedAction` is not array type"));
...
void MigrateAction::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
vector<string> MigrateAction::GetAllAction() const
{
    return m_allAction;
}

void MigrateAction::SetAllAction(const vector<string>& _allAction)
{
    m_allAction = _allAction;
    m_allActionHasBeenSet = true;
}

bool MigrateAction::AllActionHasBeenSet() const
{
    return m_allActionHasBeenSet;
}

vector<string> MigrateAction::GetAllowedAction() const
{
    return m_allowedAction;
}

void MigrateAction::SetAllowedAction(const vector<string>& _allowedAction)
{
    m_allowedAction = _allowedAction;
    m_allowedActionHasBeenSet = true;
}

bool MigrateAction::AllowedActionHasBeenSet() const
{
