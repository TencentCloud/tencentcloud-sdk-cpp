...
CoreInternalOutcome DescribeOffsetByTimeResponse::Deserialize(const string &payload)
{
...
string DescribeOffsetByTimeResponse::ToJsonString() const
{
...
vector<OffsetTimeMap> DescribeOffsetByTimeResponse::GetItems() const
{
    return m_items;
}

bool DescribeOffsetByTimeResponse::ItemsHasBeenSet() const
{
