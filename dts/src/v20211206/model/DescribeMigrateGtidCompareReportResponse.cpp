...
DescribeMigrateGtidCompareReportResponse::DescribeMigrateGtidCompareReportResponse() :
...
CoreInternalOutcome DescribeMigrateGtidCompareReportResponse::Deserialize(const string &payload)
{
...
string DescribeMigrateGtidCompareReportResponse::ToJsonString() const
{
...
string DescribeMigrateGtidCompareReportResponse::GetConclusion() const
{
    return m_conclusion;
}

bool DescribeMigrateGtidCompareReportResponse::ConclusionHasBeenSet() const
{
    return m_conclusionHasBeenSet;
}

string DescribeMigrateGtidCompareReportResponse::GetStatus() const
{
    return m_status;
}

bool DescribeMigrateGtidCompareReportResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeMigrateGtidCompareReportResponse::GetType() const
{
    return m_type;
}

bool DescribeMigrateGtidCompareReportResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

vector<DifferenceDetails> DescribeMigrateGtidCompareReportResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeMigrateGtidCompareReportResponse::DetailHasBeenSet() const
{
