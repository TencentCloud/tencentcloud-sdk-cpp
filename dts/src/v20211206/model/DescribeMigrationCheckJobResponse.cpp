...
CoreInternalOutcome DescribeMigrationCheckJobResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("StepInfo") && !rsp["StepInfo"].IsNull())
    {
        if (!rsp["StepInfo"].IsArray())
            return CoreInternalOutcome(Core::Error("response `StepInfo` is not array type"));
    ...
    {
        if (!rsp["CheckFlag"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `CheckFlag` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_checkFlag = string(rsp["CheckFlag"].GetString());
...
string DescribeMigrationCheckJobResponse::ToJsonString() const
{
    ...
    if (m_checkFlagHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_checkFlag.c_str(), allocator).Move(), allocator);
    }
...
string DescribeMigrationCheckJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeMigrationCheckJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeMigrationCheckJobResponse::GetBriefMsg() const
{
    return m_briefMsg;
}

bool DescribeMigrationCheckJobResponse::BriefMsgHasBeenSet() const
{
    return m_briefMsgHasBeenSet;
}

vector<CheckStep> DescribeMigrationCheckJobResponse::GetStepInfo() const
{
    return m_stepInfo;
}

bool DescribeMigrationCheckJobResponse::StepInfoHasBeenSet() const
{
    return m_stepInfoHasBeenSet;
}

string DescribeMigrationCheckJobResponse::GetCheckFlag() const
{
    return m_checkFlag;
}

bool DescribeMigrationCheckJobResponse::CheckFlagHasBeenSet() const
{
