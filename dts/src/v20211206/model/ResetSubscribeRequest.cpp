...
string ResetSubscribeRequest::ToJsonString() const
{
...
string ResetSubscribeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void ResetSubscribeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool ResetSubscribeRequest::SubscribeIdHasBeenSet() const
{
