...
string DestroyIsolatedSubscribeRequest::ToJsonString() const
{
...
string DestroyIsolatedSubscribeRequest::GetSubscribeId() const
{
    return m_subscribeId;
}

void DestroyIsolatedSubscribeRequest::SetSubscribeId(const string& _subscribeId)
{
    m_subscribeId = _subscribeId;
    m_subscribeIdHasBeenSet = true;
}

bool DestroyIsolatedSubscribeRequest::SubscribeIdHasBeenSet() const
{
