...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_STARTCOMPAREREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_STARTCOMPAREREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                * StartCompare请求参数结构体
                */
                class StartCompareRequest : public AbstractModel
                {
                public:
                    StartCompareRequest();
                    ~StartCompareRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_STARTCOMPAREREQUEST_H_
