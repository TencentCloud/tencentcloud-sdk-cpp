...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class DescribeMigrateGtidCompareReportRequest : public AbstractModel
                {
                public:
                    DescribeMigrateGtidCompareReportRequest();
                    ~DescribeMigrateGtidCompareReportRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTREQUEST_H_
