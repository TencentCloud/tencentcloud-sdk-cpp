...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBESYNCCOMPARETASKSREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBESYNCCOMPARETASKSREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class DescribeSyncCompareTasksRequest : public AbstractModel
                {
                public:
                    DescribeSyncCompareTasksRequest();
                    ~DescribeSyncCompareTasksRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBESYNCCOMPARETASKSREQUEST_H_
