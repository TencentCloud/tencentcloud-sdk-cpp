...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTRESPONSE_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTRESPONSE_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class DescribeMigrateGtidCompareReportResponse : public AbstractModel
                {
                public:
                    DescribeMigrateGtidCompareReportResponse();
                    ~DescribeMigrateGtidCompareReportResponse() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATEGTIDCOMPAREREPORTRESPONSE_H_
