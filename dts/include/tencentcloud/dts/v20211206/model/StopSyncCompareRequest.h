...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCCOMPAREREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCCOMPAREREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class StopSyncCompareRequest : public AbstractModel
                {
                public:
                    StopSyncCompareRequest();
                    ~StopSyncCompareRequest() = default;
                    ...
                    /**
                     * 获取对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
                     * @return CompareTaskId 对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
                     * 
                     */
                    std::string GetCompareTaskId() const;

                    /**
                     * 设置对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
                    ...
                    /**
                     * 获取是否强制停止。如果填true，迁移任务增量阶段会跳过一致性校验产生的binlog，达到快速恢复任务的效果
                     * @return ForceStop 是否强制停止。如果填true，迁移任务增量阶段会跳过一致性校验产生的binlog，达到快速恢复任务的效果
                     * 
                     */
                    bool GetForceStop() const;

                    /**
                     * 设置是否强制停止。如果填true，迁移任务增量阶段会跳过一致性校验产生的binlog，达到快速恢复任务的效果
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCCOMPAREREQUEST_H_
