...
SyncStandardDictResponse::SyncStandardDictResponse() :
    m_codeHasBeenSet(false),
    m_messageHasBeenSet(false)
{
}

CoreInternalOutcome SyncStandardDictResponse::Deserialize(const string &payload)
{
...
string SyncStandardDictResponse::ToJsonString() const
{
...
int64_t SyncStandardDictResponse::GetCode() const
{
    return m_code;
}

bool SyncStandardDictResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string SyncStandardDictResponse::GetMessage() const
{
    return m_message;
}

bool SyncStandardDictResponse::MessageHasBeenSet() const
{
