...
SyncDepartmentResponse::SyncDepartmentResponse() :
...
CoreInternalOutcome SyncDepartmentResponse::Deserialize(const string &payload)
{
...
string SyncDepartmentResponse::ToJsonString() const
{
...
int64_t SyncDepartmentResponse::GetCode() const
{
    return m_code;
}

bool SyncDepartmentResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string SyncDepartmentResponse::GetMessage() const
{
    return m_message;
}

bool SyncDepartmentResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

SyncDepartmentRespData SyncDepartmentResponse::GetData() const
{
    return m_data;
}

bool SyncDepartmentResponse::DataHasBeenSet() const
{
