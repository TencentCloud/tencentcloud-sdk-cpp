...
LoginOutHisToolResponse::LoginOutHisToolResponse() :
...
CoreInternalOutcome LoginOutHisToolResponse::Deserialize(const string &payload)
{
...
string LoginOutHisToolResponse::ToJsonString() const
{
...
int64_t LoginOutHisToolResponse::GetCode() const
{
    return m_code;
}

bool LoginOutHisToolResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string LoginOutHisToolResponse::GetMessage() const
{
    return m_message;
}

bool LoginOutHisToolResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LoginOutResponseData LoginOutHisToolResponse::GetData() const
{
    return m_data;
}

bool LoginOutHisToolResponse::DataHasBeenSet() const
{
