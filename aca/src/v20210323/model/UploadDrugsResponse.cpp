...
UploadDrugsResponse::UploadDrugsResponse() :
...
CoreInternalOutcome UploadDrugsResponse::Deserialize(const string &payload)
{
...
string UploadDrugsResponse::ToJsonString() const
{
...
int64_t UploadDrugsResponse::GetCode() const
{
    return m_code;
}

bool UploadDrugsResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string UploadDrugsResponse::GetMessage() const
{
    return m_message;
}

bool UploadDrugsResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

OperateResp UploadDrugsResponse::GetData() const
{
    return m_data;
}

bool UploadDrugsResponse::DataHasBeenSet() const
{
