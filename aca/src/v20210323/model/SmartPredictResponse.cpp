...
SmartPredictResponse::SmartPredictResponse() :
...
CoreInternalOutcome SmartPredictResponse::Deserialize(const string &payload)
{
...
string SmartPredictResponse::ToJsonString() const
{
...
int64_t SmartPredictResponse::GetCode() const
{
    return m_code;
}

bool SmartPredictResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string SmartPredictResponse::GetMessage() const
{
    return m_message;
}

bool SmartPredictResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

SmartPredictRespData SmartPredictResponse::GetData() const
{
    return m_data;
}

bool SmartPredictResponse::DataHasBeenSet() const
{
