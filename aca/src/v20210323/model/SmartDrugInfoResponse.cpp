...
SmartDrugInfoResponse::SmartDrugInfoResponse() :
...
CoreInternalOutcome SmartDrugInfoResponse::Deserialize(const string &payload)
{
...
string SmartDrugInfoResponse::ToJsonString() const
{
...
int64_t SmartDrugInfoResponse::GetCode() const
{
    return m_code;
}

bool SmartDrugInfoResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string SmartDrugInfoResponse::GetMessage() const
{
    return m_message;
}

bool SmartDrugInfoResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

SmartDrugInfoResp SmartDrugInfoResponse::GetData() const
{
    return m_data;
}

bool SmartDrugInfoResponse::DataHasBeenSet() const
{
