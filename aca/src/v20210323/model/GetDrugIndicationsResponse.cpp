...
GetDrugIndicationsResponse::GetDrugIndicationsResponse() :
...
CoreInternalOutcome GetDrugIndicationsResponse::Deserialize(const string &payload)
{
...
string GetDrugIndicationsResponse::ToJsonString() const
{
...
int64_t GetDrugIndicationsResponse::GetCode() const
{
    return m_code;
}

bool GetDrugIndicationsResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string GetDrugIndicationsResponse::GetMessage() const
{
    return m_message;
}

bool GetDrugIndicationsResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

GetDrugIndicationsResp GetDrugIndicationsResponse::GetData() const
{
    return m_data;
}

bool GetDrugIndicationsResponse::DataHasBeenSet() const
{
