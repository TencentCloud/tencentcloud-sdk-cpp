...
LoginHisToolResponse::LoginHisToolResponse() :
...
CoreInternalOutcome LoginHisToolResponse::Deserialize(const string &payload)
{
...
string LoginHisToolResponse::ToJsonString() const
{
...
int64_t LoginHisToolResponse::GetCode() const
{
    return m_code;
}

bool LoginHisToolResponse::CodeHasBeenSet() const
{
    return m_codeHasBeenSet;
}

string LoginHisToolResponse::GetMessage() const
{
    return m_message;
}

bool LoginHisToolResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

LoginDataResp LoginHisToolResponse::GetData() const
{
    return m_data;
}

bool LoginHisToolResponse::DataHasBeenSet() const
{
