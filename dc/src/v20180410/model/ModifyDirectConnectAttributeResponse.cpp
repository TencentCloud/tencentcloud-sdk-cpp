...
CoreInternalOutcome ModifyDirectConnectAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyDirectConnectAttributeResponse::ToJsonString() const
{
