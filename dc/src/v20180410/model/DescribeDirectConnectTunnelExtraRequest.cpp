...
string DescribeDirectConnectTunnelExtraRequest::ToJsonString() const
{
...
string DescribeDirectConnectTunnelExtraRequest::GetDirectConnectTunnelId() const
{
    return m_directConnectTunnelId;
}

void DescribeDirectConnectTunnelExtraRequest::SetDirectConnectTunnelId(const string& _directConnectTunnelId)
{
    m_directConnectTunnelId = _directConnectTunnelId;
    m_directConnectTunnelIdHasBeenSet = true;
}

bool DescribeDirectConnectTunnelExtraRequest::DirectConnectTunnelIdHasBeenSet() const
{
