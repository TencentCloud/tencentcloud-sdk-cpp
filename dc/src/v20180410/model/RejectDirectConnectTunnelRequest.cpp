...
string RejectDirectConnectTunnelRequest::ToJsonString() const
{
...
string RejectDirectConnectTunnelRequest::GetDirectConnectTunnelId() const
{
    return m_directConnectTunnelId;
}

void RejectDirectConnectTunnelRequest::SetDirectConnectTunnelId(const string& _directConnectTunnelId)
{
    m_directConnectTunnelId = _directConnectTunnelId;
    m_directConnectTunnelIdHasBeenSet = true;
}

bool RejectDirectConnectTunnelRequest::DirectConnectTunnelIdHasBeenSet() const
{
