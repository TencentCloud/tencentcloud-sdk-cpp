...
CoreInternalOutcome DescribeDirectConnectsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("DirectConnectSet") && !rsp["DirectConnectSet"].IsNull())
    {
        ...
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ...
            m_directConnectSet.push_back(item);
        }
        m_directConnectSetHasBeenSet = true;
    }
...
vector<DirectConnect> DescribeDirectConnectsResponse::GetDirectConnectSet() const
{
    return m_directConnectSet;
}

bool DescribeDirectConnectsResponse::DirectConnectSetHasBeenSet() const
{
    return m_directConnectSetHasBeenSet;
}

int64_t DescribeDirectConnectsResponse::GetTotalCount() const
{
    return m_totalCount;
}
