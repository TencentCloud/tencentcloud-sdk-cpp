...
CoreInternalOutcome ModifyDirectConnectTunnelExtraResponse::Deserialize(const string &payload)
{
...
string ModifyDirectConnectTunnelExtraResponse::ToJsonString() const
{
