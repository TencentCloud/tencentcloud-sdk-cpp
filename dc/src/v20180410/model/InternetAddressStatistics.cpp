...
CoreInternalOutcome InternetAddressStatistics::Deserialize(const Value &value)
{
    string requestId = "";
...
void InternetAddressStatistics::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
