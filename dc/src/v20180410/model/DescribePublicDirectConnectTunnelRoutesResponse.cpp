...
CoreInternalOutcome DescribePublicDirectConnectTunnelRoutesResponse::Deserialize(const string &payload)
{
...
string DescribePublicDirectConnectTunnelRoutesResponse::ToJsonString() const
{
...
vector<DirectConnectTunnelRoute> DescribePublicDirectConnectTunnelRoutesResponse::GetRoutes() const
{
    return m_routes;
}

bool DescribePublicDirectConnectTunnelRoutesResponse::RoutesHasBeenSet() const
{
    return m_routesHasBeenSet;
}

int64_t DescribePublicDirectConnectTunnelRoutesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribePublicDirectConnectTunnelRoutesResponse::TotalCountHasBeenSet() const
{
