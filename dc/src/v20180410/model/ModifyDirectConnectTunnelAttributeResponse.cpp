...
CoreInternalOutcome ModifyDirectConnectTunnelAttributeResponse::Deserialize(const string &payload)
{
...
string ModifyDirectConnectTunnelAttributeResponse::ToJsonString() const
{
