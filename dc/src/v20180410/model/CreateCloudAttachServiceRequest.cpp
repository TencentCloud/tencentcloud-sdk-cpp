...
string CreateCloudAttachServiceRequest::ToJsonString() const
{
...
CreateCasInput CreateCloudAttachServiceRequest::GetData() const
{
    return m_data;
}

void CreateCloudAttachServiceRequest::SetData(const CreateCasInput& _data)
{
    m_data = _data;
