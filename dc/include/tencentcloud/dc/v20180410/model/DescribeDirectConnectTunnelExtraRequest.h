...
#ifndef TENCENTCLOUD_DC_V20180410_MODEL_DESCRIBEDIRECTCONNECTTUNNELEXTRAREQUEST_H_
#define TENCENTCLOUD_DC_V20180410_MODEL_DESCRIBEDIRECTCONNECTTUNNELEXTRAREQUEST_H_
    ...
    namespace Dc
    {
        namespace V20180410
        {
            namespace Model
            {
                ...
                */
                class DescribeDirectConnectTunnelExtraRequest : public AbstractModel
                {
                public:
                    DescribeDirectConnectTunnelExtraRequest();
                    ~DescribeDirectConnectTunnelExtraRequest() = default;
...
#endif // !TENCENTCLOUD_DC_V20180410_MODEL_DESCRIBEDIRECTCONNECTTUNNELEXTRAREQUEST_H_
