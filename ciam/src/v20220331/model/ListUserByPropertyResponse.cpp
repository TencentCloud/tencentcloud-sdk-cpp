...
CoreInternalOutcome ListUserByPropertyResponse::Deserialize(const string &payload)
{
...
string ListUserByPropertyResponse::ToJsonString() const
{
...
vector<User> ListUserByPropertyResponse::GetUsers() const
{
    return m_users;
}

bool ListUserByPropertyResponse::UsersHasBeenSet() const
{
