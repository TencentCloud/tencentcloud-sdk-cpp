...
CoreInternalOutcome CreateApiImportUserJobResponse::Deserialize(const string &payload)
{
...
string CreateApiImportUserJobResponse::ToJsonString() const
{
...
Job CreateApiImportUserJobResponse::GetJob() const
{
    return m_job;
}

bool CreateApiImportUserJobResponse::JobHasBeenSet() const
{
