...
CoreInternalOutcome CreateFileExportUserJobResponse::Deserialize(const string &payload)
{
...
string CreateFileExportUserJobResponse::ToJsonString() const
{
...
Job CreateFileExportUserJobResponse::GetJob() const
{
    return m_job;
}

bool CreateFileExportUserJobResponse::JobHasBeenSet() const
{
