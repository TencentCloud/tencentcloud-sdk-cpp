...
string ResetPasswordRequest::GetUserId() const
{
    return m_userId;
}

void ResetPasswordRequest::SetUserId(const string& _userId)
{
    m_userId = _userId;
    m_userIdHasBeenSet = true;
}

bool ResetPasswordRequest::UserIdHasBeenSet() const
{
    return m_userIdHasBeenSet;
}

string ResetPasswordRequest::GetUserStoreId() const
{
    return m_userStoreId;
}

void ResetPasswordRequest::SetUserStoreId(const string& _userStoreId)
{
    m_userStoreId = _userStoreId;
    m_userStoreIdHasBeenSet = true;
}

bool ResetPasswordRequest::UserStoreIdHasBeenSet() const
{
