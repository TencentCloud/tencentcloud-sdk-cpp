...
vector<string> CreateUserRequest::GetUserOrg() const
{
    return m_userOrg;
}

void CreateUserRequest::SetUserOrg(const vector<string>& _userOrg)
{
    m_userOrg = _userOrg;
    m_userOrgHasBeenSet = true;
}

bool CreateUserRequest::UserOrgHasBeenSet() const
{
