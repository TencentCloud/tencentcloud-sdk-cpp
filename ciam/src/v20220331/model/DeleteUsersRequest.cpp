...
string DeleteUsersRequest::GetUserStoreId() const
{
    return m_userStoreId;
}

void DeleteUsersRequest::SetUserStoreId(const string& _userStoreId)
{
    m_userStoreId = _userStoreId;
    m_userStoreIdHasBeenSet = true;
}

bool DeleteUsersRequest::UserStoreIdHasBeenSet() const
{
    return m_userStoreIdHasBeenSet;
}

vector<string> DeleteUsersRequest::GetUserIds() const
{
    return m_userIds;
}

void DeleteUsersRequest::SetUserIds(const vector<string>& _userIds)
{
    m_userIds = _userIds;
    m_userIdsHasBeenSet = true;
}

bool DeleteUsersRequest::UserIdsHasBeenSet() const
{
