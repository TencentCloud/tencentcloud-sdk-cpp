...
CoreInternalOutcome ResetPasswordResponse::Deserialize(const string &payload)
{
...
string ResetPasswordResponse::ToJsonString() const
{
...
string ResetPasswordResponse::GetPassword() const
{
    return m_password;
}

bool ResetPasswordResponse::PasswordHasBeenSet() const
{
