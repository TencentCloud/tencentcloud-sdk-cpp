...
CoreInternalOutcome DescribeRecordsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<SingleRecord> DescribeRecordsResponse::GetRecordList() const
{
    return m_recordList;
}

bool DescribeRecordsResponse::RecordListHasBeenSet() const
{
    return m_recordListHasBeenSet;
}

int64_t DescribeRecordsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeRecordsResponse::TotalCountHasBeenSet() const
{
