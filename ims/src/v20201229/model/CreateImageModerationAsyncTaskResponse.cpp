...
CoreInternalOutcome CreateImageModerationAsyncTaskResponse::Deserialize(const string &payload)
{
...
string CreateImageModerationAsyncTaskResponse::ToJsonString() const
{
...
string CreateImageModerationAsyncTaskResponse::GetDataId() const
{
    return m_dataId;
}

bool CreateImageModerationAsyncTaskResponse::DataIdHasBeenSet() const
{
