...
ImsClient::ImageRecognitionOutcome ImsClient::ImageRecognition(const ImageRecognitionRequest &request)
{
...
void ImsClient::ImageRecognitionAsync(const ImageRecognitionRequest& request, const ImageRecognitionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
...
ImsClient::ImageRecognitionOutcomeCallable ImsClient::ImageRecognitionCallable(const ImageRecognitionRequest &request)
{
