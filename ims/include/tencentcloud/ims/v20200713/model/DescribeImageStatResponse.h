...
#ifndef TENCENTCLOUD_IMS_V20200713_MODEL_DESCRIBEIMAGESTATRESPONSE_H_
#define TENCENTCLOUD_IMS_V20200713_MODEL_DESCRIBEIMAGESTATRESPONSE_H_

#include <string>
#include <vector>
#include <map>
#include <tencentcloud/core/AbstractModel.h>
#include <tencentcloud/ims/v20200713/model/Overview.h>
#include <tencentcloud/ims/v20200713/model/TrendCount.h>
#include <tencentcloud/ims/v20200713/model/EvilCount.h>
    ...
    namespace Ims
    {
        namespace V20200713
        {
            namespace Model
            {
                ...
                */
                class DescribeImageStatResponse : public AbstractModel
                {
                public:
                    DescribeImageStatResponse();
                    ~DescribeImageStatResponse() = default;
...
#endif // !TENCENTCLOUD_IMS_V20200713_MODEL_DESCRIBEIMAGESTATRESPONSE_H_
