...
#ifndef TENCENTCLOUD_IMS_V20201229_MODEL_IMAGERECOGNITIONREQUEST_H_
#define TENCENTCLOUD_IMS_V20201229_MODEL_IMAGERECOGNITIONREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                     ...
                     */
                    std::string GetCustomAppId() const;

                    /**
                     * 设置产品侧腾讯云用户账号AppId
                     * @param CustomAppId 产品侧腾讯云用户账号AppId
                     */
                    void SetCustomAppId(const std::string& _customAppId);

                    /**
                     * 判断参数 CustomAppId 是否已赋值
                     * @return CustomAppId 是否已赋值
                     */
                    bool CustomAppIdHasBeenSet() const;
                    ...
                    /**
                     * 获取图片资源访问链接，__与FileContent参数必须二选一输入__
                     * @return FileUrl 图片资源访问链接，__与FileContent参数必须二选一输入__
                     */
                    std::string GetFileUrl() const;

                    /**
                     * 设置图片资源访问链接，__与FileContent参数必须二选一输入__
                     ...
                     */
                    std::string GetCustomUin() const;

                    /**
                     * 设置产品侧腾讯云用户账号Uin
                     * @param CustomUin 产品侧腾讯云用户账号Uin
                     */
                    void SetCustomUin(const std::string& _customUin);

                    /**
                     * 判断参数 CustomUin 是否已赋值
                     * @return CustomUin 是否已赋值
                     */
                    bool CustomUinHasBeenSet() const;

                    /**
                     * 获取产品侧腾讯云用户子账号Uin
                     * @return CustomSubAccountUin 产品侧腾讯云用户子账号Uin
                     */
                    std::string GetCustomSubAccountUin() const;

                    /**
                     * 设置产品侧腾讯云用户子账号Uin
                     * @param CustomSubAccountUin 产品侧腾讯云用户子账号Uin
                     */
                    void SetCustomSubAccountUin(const std::string& _customSubAccountUin);

                    /**
                     * 判断参数 CustomSubAccountUin 是否已赋值
                     * @return CustomSubAccountUin 是否已赋值
                     */
                    bool CustomSubAccountUinHasBeenSet() const;
                ...
                private:
                     ...
                     * 产品侧腾讯云用户账号AppId
                     */
                    std::string m_customAppId;
                    bool m_customAppIdHasBeenSet;
                     ...
                     * 产品侧腾讯云用户账号Uin
                     */
                    std::string m_customUin;
                    bool m_customUinHasBeenSet;

                    /**
                     * 产品侧腾讯云用户子账号Uin
                     */
                    std::string m_customSubAccountUin;
                    bool m_customSubAccountUinHasBeenSet;
...
#endif // !TENCENTCLOUD_IMS_V20201229_MODEL_IMAGERECOGNITIONREQUEST_H_
