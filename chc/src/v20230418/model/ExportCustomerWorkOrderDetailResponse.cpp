...
ExportCustomerWorkOrderDetailResponse::ExportCustomerWorkOrderDetailResponse() :
    m_downloadUrlHasBeenSet(false)
{
}

CoreInternalOutcome ExportCustomerWorkOrderDetailResponse::Deserialize(const string &payload)
{
...
string ExportCustomerWorkOrderDetailResponse::ToJsonString() const
{
...
string ExportCustomerWorkOrderDetailResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportCustomerWorkOrderDetailResponse::DownloadUrlHasBeenSet() const
{
