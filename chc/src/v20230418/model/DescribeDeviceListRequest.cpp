...
vector<Filter> DescribeDeviceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeDeviceListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeDeviceListRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

uint64_t DescribeDeviceListRequest::GetOffset() const
{
    return m_offset;
}

void DescribeDeviceListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeDeviceListRequest::GetLimit() const
{
    return m_limit;
}

void DescribeDeviceListRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
string DescribeDeviceListRequest::GetDstService() const
{
    return m_dstService;
}

void DescribeDeviceListRequest::SetDstService(const string& _dstService)
{
    m_dstService = _dstService;
    m_dstServiceHasBeenSet = true;
}

bool DescribeDeviceListRequest::DstServiceHasBeenSet() const
{
