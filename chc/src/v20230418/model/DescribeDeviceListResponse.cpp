...
uint64_t DescribeDeviceListResponse::GetTotal() const
{
    return m_total;
}
...
vector<Device> DescribeDeviceListResponse::GetDeviceSet() const
{
    return m_deviceSet;
}

bool DescribeDeviceListResponse::DeviceSetHasBeenSet() const
{
