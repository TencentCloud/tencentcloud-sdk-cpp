...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPERSONNELVISITWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPERSONNELVISITWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreatePersonnelVisitWorkOrderResponse : public AbstractModel
                {
                public:
                    CreatePersonnelVisitWorkOrderResponse();
                    ~CreatePersonnelVisitWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPERSONNELVISITWORKORDERRESPONSE_H_
