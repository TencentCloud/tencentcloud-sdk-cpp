...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATERECEIVINGWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATERECEIVINGWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateReceivingWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateReceivingWorkOrderResponse();
                    ~CreateReceivingWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATERECEIVINGWORKORDERRESPONSE_H_
