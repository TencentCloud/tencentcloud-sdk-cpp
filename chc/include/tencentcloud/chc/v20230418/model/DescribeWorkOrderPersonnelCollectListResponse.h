...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_DESCRIBEWORKORDERPERSONNELCOLLECTLISTRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_DESCRIBEWORKORDERPERSONNELCOLLECTLISTRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkOrderPersonnelCollectListResponse : public AbstractModel
                {
                public:
                    DescribeWorkOrderPersonnelCollectListResponse();
                    ~DescribeWorkOrderPersonnelCollectListResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_DESCRIBEWORKORDERPERSONNELCOLLECTLISTRESPONSE_H_
