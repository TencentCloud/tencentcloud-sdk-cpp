...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMODELEVALUATIONWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMODELEVALUATIONWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateModelEvaluationWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateModelEvaluationWorkOrderResponse();
                    ~CreateModelEvaluationWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMODELEVALUATIONWORKORDERRESPONSE_H_
