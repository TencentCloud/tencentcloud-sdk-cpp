...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERREQUEST_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERREQUEST_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateRackOffWorkOrderRequest : public AbstractModel
                {
                public:
                    CreateRackOffWorkOrderRequest();
                    ~CreateRackOffWorkOrderRequest() = default;
                    ...
                    /**
                     * 获取下架人员 1.自行解决 2.由腾讯IDC负责
                     * @return StuffOption 下架人员 1.自行解决 2.由腾讯IDC负责
                     * 
                     */
                    std::string GetStuffOption() const;

                    /**
                     * 设置下架人员 1.自行解决 2.由腾讯IDC负责
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERREQUEST_H_
