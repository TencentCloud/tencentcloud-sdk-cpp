...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATESPECIALLYQUITWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATESPECIALLYQUITWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateSpeciallyQuitWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateSpeciallyQuitWorkOrderResponse();
                    ~CreateSpeciallyQuitWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATESPECIALLYQUITWORKORDERRESPONSE_H_
