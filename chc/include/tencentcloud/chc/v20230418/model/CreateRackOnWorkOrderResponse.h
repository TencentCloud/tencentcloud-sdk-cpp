...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKONWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKONWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateRackOnWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateRackOnWorkOrderResponse();
                    ~CreateRackOnWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKONWORKORDERRESPONSE_H_
