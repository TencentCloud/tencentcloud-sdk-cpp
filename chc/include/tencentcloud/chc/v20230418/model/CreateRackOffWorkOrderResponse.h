...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateRackOffWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateRackOffWorkOrderResponse();
                    ~CreateRackOffWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATERACKOFFWORKORDERRESPONSE_H_
