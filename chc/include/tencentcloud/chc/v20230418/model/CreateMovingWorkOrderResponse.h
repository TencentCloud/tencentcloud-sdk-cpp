...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMOVINGWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMOVINGWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateMovingWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateMovingWorkOrderResponse();
                    ~CreateMovingWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATEMOVINGWORKORDERRESPONSE_H_
