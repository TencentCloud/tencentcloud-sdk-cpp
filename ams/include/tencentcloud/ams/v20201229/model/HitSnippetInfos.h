...
#ifndef TENCENTCLOUD_AMS_V20201229_MODEL_HITSNIPPETINFOS_H_
#define TENCENTCLOUD_AMS_V20201229_MODEL_HITSNIPPETINFOS_H_
...
#include <tencentcloud/ams/v20201229/model/Duration.h>
    ...
    namespace Ams
    {
        namespace V20201229
        {
            namespace Model
            {
                ...
                * 机审命中信息
                */
                class HitSnippetInfos : public AbstractModel
                {
                public:
                    HitSnippetInfos();
                    ~HitSnippetInfos() = default;
...
#endif // !TENCENTCLOUD_AMS_V20201229_MODEL_HITSNIPPETINFOS_H_
