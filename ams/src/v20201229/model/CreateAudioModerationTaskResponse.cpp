...
CoreInternalOutcome CreateAudioModerationTaskResponse::Deserialize(const string &payload)
{
...
string CreateAudioModerationTaskResponse::ToJsonString() const
{
...
vector<TaskResult> CreateAudioModerationTaskResponse::GetResults() const
{
    return m_results;
}

bool CreateAudioModerationTaskResponse::ResultsHasBeenSet() const
{
