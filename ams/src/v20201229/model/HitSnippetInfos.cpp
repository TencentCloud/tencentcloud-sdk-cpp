...
CoreInternalOutcome HitSnippetInfos::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Target") && !value["Target"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Target` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Snippet") && !value["Snippet"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Snippet` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Scene") && !value["Scene"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Scene` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AtomicCategory") && !value["AtomicCategory"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.AtomicCategory` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AtomicName") && !value["AtomicName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.AtomicName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AtomicId") && !value["AtomicId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.AtomicId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UnitId") && !value["UnitId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.UnitId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UnitName") && !value["UnitName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.UnitName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ParticleId") && !value["ParticleId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.ParticleId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Positions") && !value["Positions"].IsNull())
    {
        if (!value["Positions"].IsArray())
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Positions` is not array type"));
    ...
    if (value.HasMember("Duration") && !value["Duration"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Duration` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Score") && !value["Score"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `HitSnippetInfos.Score` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void HitSnippetInfos::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string HitSnippetInfos::GetTarget() const
{
    return m_target;
}

void HitSnippetInfos::SetTarget(const string& _target)
{
    m_target = _target;
    m_targetHasBeenSet = true;
}

bool HitSnippetInfos::TargetHasBeenSet() const
{
    return m_targetHasBeenSet;
}

string HitSnippetInfos::GetSnippet() const
{
    return m_snippet;
}

void HitSnippetInfos::SetSnippet(const string& _snippet)
{
    m_snippet = _snippet;
    m_snippetHasBeenSet = true;
}

bool HitSnippetInfos::SnippetHasBeenSet() const
{
    return m_snippetHasBeenSet;
}

string HitSnippetInfos::GetScene() const
{
    return m_scene;
}

void HitSnippetInfos::SetScene(const string& _scene)
{
    m_scene = _scene;
    m_sceneHasBeenSet = true;
}

bool HitSnippetInfos::SceneHasBeenSet() const
{
    return m_sceneHasBeenSet;
}

string HitSnippetInfos::GetAtomicCategory() const
{
    return m_atomicCategory;
}

void HitSnippetInfos::SetAtomicCategory(const string& _atomicCategory)
{
    m_atomicCategory = _atomicCategory;
    m_atomicCategoryHasBeenSet = true;
}

bool HitSnippetInfos::AtomicCategoryHasBeenSet() const
{
    return m_atomicCategoryHasBeenSet;
}

string HitSnippetInfos::GetAtomicName() const
{
    return m_atomicName;
}

void HitSnippetInfos::SetAtomicName(const string& _atomicName)
{
    m_atomicName = _atomicName;
    m_atomicNameHasBeenSet = true;
}

bool HitSnippetInfos::AtomicNameHasBeenSet() const
{
    return m_atomicNameHasBeenSet;
}

string HitSnippetInfos::GetAtomicId() const
{
    return m_atomicId;
}

void HitSnippetInfos::SetAtomicId(const string& _atomicId)
{
    m_atomicId = _atomicId;
    m_atomicIdHasBeenSet = true;
}

bool HitSnippetInfos::AtomicIdHasBeenSet() const
{
    return m_atomicIdHasBeenSet;
}

string HitSnippetInfos::GetUnitId() const
{
    return m_unitId;
}

void HitSnippetInfos::SetUnitId(const string& _unitId)
{
    m_unitId = _unitId;
    m_unitIdHasBeenSet = true;
}

bool HitSnippetInfos::UnitIdHasBeenSet() const
{
    return m_unitIdHasBeenSet;
}

string HitSnippetInfos::GetUnitName() const
{
    return m_unitName;
}

void HitSnippetInfos::SetUnitName(const string& _unitName)
{
    m_unitName = _unitName;
    m_unitNameHasBeenSet = true;
}

bool HitSnippetInfos::UnitNameHasBeenSet() const
{
    return m_unitNameHasBeenSet;
}

string HitSnippetInfos::GetParticleId() const
{
    return m_particleId;
}

void HitSnippetInfos::SetParticleId(const string& _particleId)
{
    m_particleId = _particleId;
    m_particleIdHasBeenSet = true;
}

bool HitSnippetInfos::ParticleIdHasBeenSet() const
{
    return m_particleIdHasBeenSet;
}

vector<Position> HitSnippetInfos::GetPositions() const
{
    return m_positions;
}

void HitSnippetInfos::SetPositions(const vector<Position>& _positions)
{
    m_positions = _positions;
    m_positionsHasBeenSet = true;
}

bool HitSnippetInfos::PositionsHasBeenSet() const
{
    return m_positionsHasBeenSet;
}

Duration HitSnippetInfos::GetDuration() const
{
    return m_duration;
}

void HitSnippetInfos::SetDuration(const Duration& _duration)
{
    m_duration = _duration;
    m_durationHasBeenSet = true;
}

bool HitSnippetInfos::DurationHasBeenSet() const
{
    return m_durationHasBeenSet;
}

int64_t HitSnippetInfos::GetScore() const
{
    return m_score;
}

void HitSnippetInfos::SetScore(const int64_t& _score)
{
    m_score = _score;
    m_scoreHasBeenSet = true;
}

bool HitSnippetInfos::ScoreHasBeenSet() const
{
