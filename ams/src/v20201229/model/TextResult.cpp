...
CoreInternalOutcome TextResult::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Label") && !value["Label"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TextResult.Label` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LibId") && !value["LibId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TextResult.LibId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LibName") && !value["LibName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TextResult.LibName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Score") && !value["Score"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TextResult.Score` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LibType") && !value["LibType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `TextResult.LibType` IsInt64=false incorrectly").SetRequestId(requestId));
        }
