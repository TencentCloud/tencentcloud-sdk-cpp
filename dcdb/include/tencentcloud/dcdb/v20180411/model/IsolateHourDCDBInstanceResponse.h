...
#ifndef TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEHOURDCDBINSTANCERESPONSE_H_
#define TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEHOURDCDBINSTANCERESPONSE_H_
    ...
    namespace Dcdb
    {
        namespace V20180411
        {
            namespace Model
            {
                ...
                */
                class IsolateHourDCDBInstanceResponse : public AbstractModel
                {
                public:
                    IsolateHourDCDBInstanceResponse();
                    ~IsolateHourDCDBInstanceResponse() = default;
...
#endif // !TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEHOURDCDBINSTANCERESPONSE_H_
