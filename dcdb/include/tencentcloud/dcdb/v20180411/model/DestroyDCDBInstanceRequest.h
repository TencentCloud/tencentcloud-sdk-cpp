...
#ifndef TENCENTCLOUD_DCDB_V20180411_MODEL_DESTROYDCDBINSTANCEREQUEST_H_
#define TENCENTCLOUD_DCDB_V20180411_MODEL_DESTROYDCDBINSTANCEREQUEST_H_
    ...
    namespace Dcdb
    {
        namespace V20180411
        {
            namespace Model
            {
                ...
                */
                class DestroyDCDBInstanceRequest : public AbstractModel
                {
                public:
                    DestroyDCDBInstanceRequest();
                    ~DestroyDCDBInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_DCDB_V20180411_MODEL_DESTROYDCDBINSTANCEREQUEST_H_
