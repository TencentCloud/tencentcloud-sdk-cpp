...
CoreInternalOutcome CloneAccountResponse::Deserialize(const string &payload)
{
...
string CloneAccountResponse::ToJsonString() const
{
...
int64_t CloneAccountResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloneAccountResponse::FlowIdHasBeenSet() const
{
