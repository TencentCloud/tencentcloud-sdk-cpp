...
CoreInternalOutcome DescribeDCDBInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeDCDBInstancesResponse::ToJsonString() const
{
...
int64_t DescribeDCDBInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDCDBInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DCDBInstanceInfo> DescribeDCDBInstancesResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeDCDBInstancesResponse::InstancesHasBeenSet() const
{
