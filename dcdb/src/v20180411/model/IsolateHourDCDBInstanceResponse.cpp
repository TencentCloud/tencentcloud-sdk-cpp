...
CoreInternalOutcome IsolateHourDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string IsolateHourDCDBInstanceResponse::ToJsonString() const
{
...
vector<string> IsolateHourDCDBInstanceResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool IsolateHourDCDBInstanceResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> IsolateHourDCDBInstanceResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool IsolateHourDCDBInstanceResponse::FailedInstanceIdsHasBeenSet() const
{
