...
CoreInternalOutcome RenewDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string RenewDCDBInstanceResponse::ToJsonString() const
{
...
string RenewDCDBInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool RenewDCDBInstanceResponse::DealNameHasBeenSet() const
{
