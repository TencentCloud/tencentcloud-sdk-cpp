...
CoreInternalOutcome UpgradeDedicatedDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string UpgradeDedicatedDCDBInstanceResponse::ToJsonString() const
{
...
int64_t UpgradeDedicatedDCDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeDedicatedDCDBInstanceResponse::FlowIdHasBeenSet() const
{
