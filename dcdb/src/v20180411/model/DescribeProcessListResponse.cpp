...
DescribeProcessListResponse::DescribeProcessListResponse() :
    m_processListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeProcessListResponse::Deserialize(const string &payload)
{
...
string DescribeProcessListResponse::ToJsonString() const
{
...
vector<Process> DescribeProcessListResponse::GetProcessList() const
{
    return m_processList;
}

bool DescribeProcessListResponse::ProcessListHasBeenSet() const
{
