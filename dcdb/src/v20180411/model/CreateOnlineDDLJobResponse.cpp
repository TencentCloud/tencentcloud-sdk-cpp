...
CoreInternalOutcome CreateOnlineDDLJobResponse::Deserialize(const string &payload)
{
...
string CreateOnlineDDLJobResponse::ToJsonString() const
{
...
int64_t CreateOnlineDDLJobResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateOnlineDDLJobResponse::FlowIdHasBeenSet() const
{
