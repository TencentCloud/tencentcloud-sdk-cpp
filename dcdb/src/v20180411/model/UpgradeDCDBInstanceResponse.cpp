...
CoreInternalOutcome UpgradeDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string UpgradeDCDBInstanceResponse::ToJsonString() const
{
...
string UpgradeDCDBInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool UpgradeDCDBInstanceResponse::DealNameHasBeenSet() const
{
