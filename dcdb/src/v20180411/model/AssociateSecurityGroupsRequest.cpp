...
string AssociateSecurityGroupsRequest::GetProduct() const
{
    return m_product;
}

void AssociateSecurityGroupsRequest::SetProduct(const string& _product)
{
    m_product = _product;
    m_productHasBeenSet = true;
}

bool AssociateSecurityGroupsRequest::ProductHasBeenSet() const
{
