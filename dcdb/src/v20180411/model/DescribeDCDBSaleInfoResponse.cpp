...
CoreInternalOutcome DescribeDCDBSaleInfoResponse::Deserialize(const string &payload)
{
...
string DescribeDCDBSaleInfoResponse::ToJsonString() const
{
...
vector<RegionInfo> DescribeDCDBSaleInfoResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeDCDBSaleInfoResponse::RegionListHasBeenSet() const
{
