...
CoreInternalOutcome ModifyDBSyncModeResponse::Deserialize(const string &payload)
{
...
string ModifyDBSyncModeResponse::ToJsonString() const
{
...
int64_t ModifyDBSyncModeResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyDBSyncModeResponse::FlowIdHasBeenSet() const
{
