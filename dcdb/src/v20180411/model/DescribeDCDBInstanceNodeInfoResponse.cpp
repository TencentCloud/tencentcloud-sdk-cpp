...
CoreInternalOutcome DescribeDCDBInstanceNodeInfoResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("NodesInfo") && !rsp["NodesInfo"].IsNull())
    {
        if (!rsp["NodesInfo"].IsArray())
            return CoreInternalOutcome(Error("response `NodesInfo` is not array type"));
...
string DescribeDCDBInstanceNodeInfoResponse::ToJsonString() const
{
...
uint64_t DescribeDCDBInstanceNodeInfoResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDCDBInstanceNodeInfoResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<BriefNodeInfo> DescribeDCDBInstanceNodeInfoResponse::GetNodesInfo() const
{
    return m_nodesInfo;
}

bool DescribeDCDBInstanceNodeInfoResponse::NodesInfoHasBeenSet() const
{
