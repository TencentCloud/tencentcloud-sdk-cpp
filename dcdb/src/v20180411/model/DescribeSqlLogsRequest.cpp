...
uint64_t DescribeSqlLogsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeSqlLogsRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeSqlLogsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeSqlLogsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
