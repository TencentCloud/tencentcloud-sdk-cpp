...
CoreInternalOutcome DescribeAccountPrivilegesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Privileges") && !rsp["Privileges"].IsNull())
    {
        if (!rsp["Privileges"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Privileges` is not array type"));

        const rapidjson::Value &tmpValue = rsp["Privileges"];
...
string DescribeAccountPrivilegesResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DescribeAccountPrivilegesResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<string> DescribeAccountPrivilegesResponse::GetPrivileges() const
{
    return m_privileges;
}

bool DescribeAccountPrivilegesResponse::PrivilegesHasBeenSet() const
{
    return m_privilegesHasBeenSet;
}

string DescribeAccountPrivilegesResponse::GetUserName() const
{
    return m_userName;
}

bool DescribeAccountPrivilegesResponse::UserNameHasBeenSet() const
{
    return m_userNameHasBeenSet;
}

string DescribeAccountPrivilegesResponse::GetHost() const
{
    return m_host;
}

bool DescribeAccountPrivilegesResponse::HostHasBeenSet() const
{
