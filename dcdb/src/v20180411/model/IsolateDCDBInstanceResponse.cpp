...
CoreInternalOutcome IsolateDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string IsolateDCDBInstanceResponse::ToJsonString() const
{
...
vector<string> IsolateDCDBInstanceResponse::GetSuccessInstanceIds() const
{
    return m_successInstanceIds;
}

bool IsolateDCDBInstanceResponse::SuccessInstanceIdsHasBeenSet() const
{
    return m_successInstanceIdsHasBeenSet;
}

vector<string> IsolateDCDBInstanceResponse::GetFailedInstanceIds() const
{
    return m_failedInstanceIds;
}

bool IsolateDCDBInstanceResponse::FailedInstanceIdsHasBeenSet() const
{
