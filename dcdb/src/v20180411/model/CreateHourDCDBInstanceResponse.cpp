...
CoreInternalOutcome CreateHourDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string CreateHourDCDBInstanceResponse::ToJsonString() const
{
...
vector<string> CreateHourDCDBInstanceResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CreateHourDCDBInstanceResponse::InstanceIdsHasBeenSet() const
{
    return m_instanceIdsHasBeenSet;
}

int64_t CreateHourDCDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}
