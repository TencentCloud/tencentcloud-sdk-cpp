...
CoreInternalOutcome DescribeDBParametersResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Params") && !rsp["Params"].IsNull())
    {
        if (!rsp["Params"].IsArray())
            return CoreInternalOutcome(Error("response `Params` is not array type"));
...
string DescribeDBParametersResponse::ToJsonString() const
{
...
string DescribeDBParametersResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DescribeDBParametersResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<ParamDesc> DescribeDBParametersResponse::GetParams() const
{
    return m_params;
}

bool DescribeDBParametersResponse::ParamsHasBeenSet() const
{
