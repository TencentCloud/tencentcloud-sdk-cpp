...
CoreInternalOutcome TerminateDedicatedDBInstanceResponse::Deserialize(const string &payload)
{
...
string TerminateDedicatedDBInstanceResponse::ToJsonString() const
{
...
int64_t TerminateDedicatedDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool TerminateDedicatedDBInstanceResponse::FlowIdHasBeenSet() const
{
