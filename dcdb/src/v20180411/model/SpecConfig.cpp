...
CoreInternalOutcome SpecConfig::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SpecConfigInfos") && !value["SpecConfigInfos"].IsNull())
    {
        ...
        const Value &tmpValue = value["SpecConfigInfos"];
...
void SpecConfig::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
