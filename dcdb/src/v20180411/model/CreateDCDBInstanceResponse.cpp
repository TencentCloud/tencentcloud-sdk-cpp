...
CoreInternalOutcome CreateDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string CreateDCDBInstanceResponse::ToJsonString() const
{
...
string CreateDCDBInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool CreateDCDBInstanceResponse::DealNameHasBeenSet() const
{
    return m_dealNameHasBeenSet;
}

vector<string> CreateDCDBInstanceResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool CreateDCDBInstanceResponse::InstanceIdsHasBeenSet() const
{
