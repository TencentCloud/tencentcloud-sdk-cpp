...
CoreInternalOutcome DestroyDCDBInstanceResponse::Deserialize(const string &payload)
{
...
string DestroyDCDBInstanceResponse::ToJsonString() const
{
...
string DestroyDCDBInstanceResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool DestroyDCDBInstanceResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

int64_t DestroyDCDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool DestroyDCDBInstanceResponse::FlowIdHasBeenSet() const
{
