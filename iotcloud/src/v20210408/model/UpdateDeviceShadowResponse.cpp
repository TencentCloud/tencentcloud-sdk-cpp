...
CoreInternalOutcome UpdateDeviceShadowResponse::Deserialize(const string &payload)
{
...
string UpdateDeviceShadowResponse::ToJsonString() const
{
...
string UpdateDeviceShadowResponse::GetData() const
{
    return m_data;
}

bool UpdateDeviceShadowResponse::DataHasBeenSet() const
{
