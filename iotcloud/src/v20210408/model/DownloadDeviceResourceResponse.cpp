...
CoreInternalOutcome DownloadDeviceResourceResponse::Deserialize(const string &payload)
{
...
string DownloadDeviceResourceResponse::ToJsonString() const
{
...
string DownloadDeviceResourceResponse::GetUrl() const
{
    return m_url;
}

bool DownloadDeviceResourceResponse::UrlHasBeenSet() const
{
