...
CoreInternalOutcome DescribePrivateCABindedProductsResponse::Deserialize(const string &payload)
{
...
string DescribePrivateCABindedProductsResponse::ToJsonString() const
{
...
vector<BindProductInfo> DescribePrivateCABindedProductsResponse::GetProducts() const
{
    return m_products;
}

bool DescribePrivateCABindedProductsResponse::ProductsHasBeenSet() const
{
