...
CoreInternalOutcome BindProductInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ProductId") && !value["ProductId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BindProductInfo.ProductId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ProductName") && !value["ProductName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `BindProductInfo.ProductName` IsString=false incorrectly").SetRequestId(requestId));
        }
