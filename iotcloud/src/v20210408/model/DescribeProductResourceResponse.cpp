...
CoreInternalOutcome DescribeProductResourceResponse::Deserialize(const string &payload)
{
...
string DescribeProductResourceResponse::ToJsonString() const
{
...
ProductResourceInfo DescribeProductResourceResponse::GetResult() const
{
    return m_result;
}

bool DescribeProductResourceResponse::ResultHasBeenSet() const
{
