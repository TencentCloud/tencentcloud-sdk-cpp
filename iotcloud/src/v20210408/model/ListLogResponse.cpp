...
CoreInternalOutcome ListLogResponse::Deserialize(const string &payload)
{
...
string ListLogResponse::ToJsonString() const
{
...
string ListLogResponse::GetContext() const
{
    return m_context;
}

bool ListLogResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool ListLogResponse::GetListover() const
{
    return m_listover;
}

bool ListLogResponse::ListoverHasBeenSet() const
{
    return m_listoverHasBeenSet;
}

vector<CLSLogItem> ListLogResponse::GetResults() const
{
    return m_results;
}

bool ListLogResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

uint64_t ListLogResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListLogResponse::TotalCountHasBeenSet() const
{
