...
CoreInternalOutcome UpdateProductDynamicRegisterResponse::Deserialize(const string &payload)
{
...
string UpdateProductDynamicRegisterResponse::ToJsonString() const
{
...
uint64_t UpdateProductDynamicRegisterResponse::GetRegisterType() const
{
    return m_registerType;
}

bool UpdateProductDynamicRegisterResponse::RegisterTypeHasBeenSet() const
{
    return m_registerTypeHasBeenSet;
}

string UpdateProductDynamicRegisterResponse::GetProductSecret() const
{
    return m_productSecret;
}

bool UpdateProductDynamicRegisterResponse::ProductSecretHasBeenSet() const
{
    return m_productSecretHasBeenSet;
}

uint64_t UpdateProductDynamicRegisterResponse::GetRegisterLimit() const
{
    return m_registerLimit;
}

bool UpdateProductDynamicRegisterResponse::RegisterLimitHasBeenSet() const
{
