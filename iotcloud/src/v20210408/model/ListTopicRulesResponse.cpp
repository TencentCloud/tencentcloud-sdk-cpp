...
CoreInternalOutcome ListTopicRulesResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["TotalCnt"].IsUint64())
        {
            return CoreInternalOutcome(Core::Error("response `TotalCnt` IsUint64=false incorrectly").SetRequestId(requestId));
        }
        m_totalCnt = rsp["TotalCnt"].GetUint64();
...
string ListTopicRulesResponse::ToJsonString() const
{
...
uint64_t ListTopicRulesResponse::GetTotalCnt() const
{
    return m_totalCnt;
}

bool ListTopicRulesResponse::TotalCntHasBeenSet() const
{
    return m_totalCntHasBeenSet;
}

vector<TopicRuleInfo> ListTopicRulesResponse::GetRules() const
{
    return m_rules;
}

bool ListTopicRulesResponse::RulesHasBeenSet() const
{
