...
CoreInternalOutcome GetAllVersionResponse::Deserialize(const string &payload)
{
...
string GetAllVersionResponse::ToJsonString() const
{
...
vector<string> GetAllVersionResponse::GetVersion() const
{
    return m_version;
}

bool GetAllVersionResponse::VersionHasBeenSet() const
{
