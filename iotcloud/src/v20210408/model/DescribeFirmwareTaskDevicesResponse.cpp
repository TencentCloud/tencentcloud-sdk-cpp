...
CoreInternalOutcome DescribeFirmwareTaskDevicesResponse::Deserialize(const string &payload)
{
...
string DescribeFirmwareTaskDevicesResponse::ToJsonString() const
{
...
uint64_t DescribeFirmwareTaskDevicesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeFirmwareTaskDevicesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DeviceUpdateStatus> DescribeFirmwareTaskDevicesResponse::GetDevices() const
{
    return m_devices;
}

bool DescribeFirmwareTaskDevicesResponse::DevicesHasBeenSet() const
{
