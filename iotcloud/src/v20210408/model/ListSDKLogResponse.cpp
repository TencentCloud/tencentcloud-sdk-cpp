...
CoreInternalOutcome ListSDKLogResponse::Deserialize(const string &payload)
{
...
string ListSDKLogResponse::ToJsonString() const
{
...
string ListSDKLogResponse::GetContext() const
{
    return m_context;
}

bool ListSDKLogResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool ListSDKLogResponse::GetListover() const
{
    return m_listover;
}

bool ListSDKLogResponse::ListoverHasBeenSet() const
{
    return m_listoverHasBeenSet;
}

vector<SDKLogItem> ListSDKLogResponse::GetResults() const
{
    return m_results;
}

bool ListSDKLogResponse::ResultsHasBeenSet() const
{
