...
CoreInternalOutcome DescribePushResourceTaskStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribePushResourceTaskStatisticsResponse::ToJsonString() const
{
...
uint64_t DescribePushResourceTaskStatisticsResponse::GetSuccessTotal() const
{
    return m_successTotal;
}

bool DescribePushResourceTaskStatisticsResponse::SuccessTotalHasBeenSet() const
{
    return m_successTotalHasBeenSet;
}

uint64_t DescribePushResourceTaskStatisticsResponse::GetFailureTotal() const
{
    return m_failureTotal;
}

bool DescribePushResourceTaskStatisticsResponse::FailureTotalHasBeenSet() const
{
    return m_failureTotalHasBeenSet;
}

uint64_t DescribePushResourceTaskStatisticsResponse::GetUpgradingTotal() const
{
    return m_upgradingTotal;
}

bool DescribePushResourceTaskStatisticsResponse::UpgradingTotalHasBeenSet() const
{
