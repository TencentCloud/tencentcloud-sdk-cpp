...
CoreInternalOutcome DescribeDeviceResourceResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceResourceResponse::ToJsonString() const
{
...
DeviceResourceInfo DescribeDeviceResourceResponse::GetResult() const
{
    return m_result;
}

bool DescribeDeviceResourceResponse::ResultHasBeenSet() const
{
