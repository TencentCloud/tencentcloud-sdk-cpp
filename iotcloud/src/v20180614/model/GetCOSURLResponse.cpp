...
CoreInternalOutcome GetCOSURLResponse::Deserialize(const string &payload)
{
...
string GetCOSURLResponse::ToJsonString() const
{
...
string GetCOSURLResponse::GetUrl() const
{
    return m_url;
}

bool GetCOSURLResponse::UrlHasBeenSet() const
{
