...
CoreInternalOutcome DeviceLabel::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Key") && !value["Key"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `DeviceLabel.Key` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Value") && !value["Value"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `DeviceLabel.Value` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void DeviceLabel::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
