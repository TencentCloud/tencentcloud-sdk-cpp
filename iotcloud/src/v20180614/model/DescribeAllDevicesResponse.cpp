...
string DescribeAllDevicesResponse::ToJsonString() const
{
...
int64_t DescribeAllDevicesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAllDevicesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DeviceProperty> DescribeAllDevicesResponse::GetDevices() const
{
    return m_devices;
}

bool DescribeAllDevicesResponse::DevicesHasBeenSet() const
{
