...
CoreInternalOutcome PublishBroadcastMessageResponse::Deserialize(const string &payload)
{
...
string PublishBroadcastMessageResponse::ToJsonString() const
{
...
int64_t PublishBroadcastMessageResponse::GetTaskId() const
{
    return m_taskId;
}

bool PublishBroadcastMessageResponse::TaskIdHasBeenSet() const
{
