...
CoreInternalOutcome DescribeProductsResponse::Deserialize(const string &payload)
{
...
string DescribeProductsResponse::ToJsonString() const
{
...
uint64_t DescribeProductsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeProductsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ProductInfo> DescribeProductsResponse::GetProducts() const
{
    return m_products;
}

bool DescribeProductsResponse::ProductsHasBeenSet() const
{
