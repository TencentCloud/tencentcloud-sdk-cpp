...
CoreInternalOutcome DescribeMultiDevTaskResponse::Deserialize(const string &payload)
{
...
string DescribeMultiDevTaskResponse::ToJsonString() const
{
...
string DescribeMultiDevTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeMultiDevTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

uint64_t DescribeMultiDevTaskResponse::GetTaskStatus() const
{
    return m_taskStatus;
}

bool DescribeMultiDevTaskResponse::TaskStatusHasBeenSet() const
{
