...
CoreInternalOutcome DescribeDeviceShadowResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceShadowResponse::ToJsonString() const
{
...
string DescribeDeviceShadowResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceShadowResponse::DataHasBeenSet() const
{
