...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEDOWNLOADURLREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEDOWNLOADURLREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class GetSkillPackageDownloadURLRequest : public AbstractModel
                {
                public:
                    GetSkillPackageDownloadURLRequest();
                    ~GetSkillPackageDownloadURLRequest() = default;
                    ...
                    /**
                     * 获取<p>Record ID；必须 AGENT_SKILLS 且 ContentStatus=READY。</p>
                    ...
                    /**
                     * 设置<p>Record ID；必须 AGENT_SKILLS 且 ContentStatus=READY。</p>
                    ...
                    /**
                     * 获取<p>可选。指定要下载的 Version；与 Label 互斥；均省略时使用 Stable。</p>
                    ...
                    /**
                     * 设置<p>可选。指定要下载的 Version；与 Label 互斥；均省略时使用 Stable。</p>
                    ...
                    /**
                     * 获取<p>可选。指定要下载的 Label 目标；与 VersionId 互斥；均省略时使用 Stable。</p>
                    ...
                    /**
                     * 设置<p>可选。指定要下载的 Label 目标；与 VersionId 互斥；均省略时使用 Stable。</p>
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEDOWNLOADURLREQUEST_H_
