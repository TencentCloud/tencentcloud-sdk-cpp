...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEREGISTRYLISTREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEREGISTRYLISTREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class DescribeRegistryListRequest : public AbstractModel
                {
                public:
                    DescribeRegistryListRequest();
                    ~DescribeRegistryListRequest() = default;
                    ...
                    /**
                     * 获取<p>过滤条件。Name 支持：<code>name</code>/<code>search</code>（模糊）、<code>archived</code>/<code>status</code>（true/false/all）、<code>tag-key</code> 和 <code>tag:&lt;key&gt;</code>；最多 6 个标签过滤组，每个标签过滤组最多 10 个 Values，同 Key 多值为 OR，不同 Key 为 AND。</p>
                    ...
                    /**
                     * 设置<p>过滤条件。Name 支持：<code>name</code>/<code>search</code>（模糊）、<code>archived</code>/<code>status</code>（true/false/all）、<code>tag-key</code> 和 <code>tag:&lt;key&gt;</code>；最多 6 个标签过滤组，每个标签过滤组最多 10 个 Values，同 Key 多值为 OR，不同 Key 为 AND。</p>
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEREGISTRYLISTREQUEST_H_
