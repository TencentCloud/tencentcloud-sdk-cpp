...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEPRECACHEIMAGETASKREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEPRECACHEIMAGETASKREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class DescribePreCacheImageTaskRequest : public AbstractModel
                {
                public:
                    DescribePreCacheImageTaskRequest();
                    ~DescribePreCacheImageTaskRequest() = default;
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBEPRECACHEIMAGETASKREQUEST_H_
