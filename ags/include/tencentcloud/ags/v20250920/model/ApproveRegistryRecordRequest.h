...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_APPROVEREGISTRYRECORDREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_APPROVEREGISTRYRECORDREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class ApproveRegistryRecordRequest : public AbstractModel
                {
                public:
                    ApproveRegistryRecordRequest();
                    ~ApproveRegistryRecordRequest() = default;
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_APPROVEREGISTRYRECORDREQUEST_H_
