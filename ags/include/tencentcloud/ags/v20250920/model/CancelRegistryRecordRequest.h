...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_CANCELREGISTRYRECORDREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_CANCELREGISTRYRECORDREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class CancelRegistryRecordRequest : public AbstractModel
                {
                public:
                    CancelRegistryRecordRequest();
                    ~CancelRegistryRecordRequest() = default;
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_CANCELREGISTRYRECORDREQUEST_H_
