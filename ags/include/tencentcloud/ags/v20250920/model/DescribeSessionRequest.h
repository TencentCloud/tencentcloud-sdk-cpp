...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBESESSIONREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBESESSIONREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class DescribeSessionRequest : public AbstractModel
                {
                public:
                    DescribeSessionRequest();
                    ~DescribeSessionRequest() = default;
                    ...
                    /**
                     * 获取<p>返回最近事件数量，默认为 0，最大值为 200。</p>
                     * @return NumRecentEvents <p>返回最近事件数量，默认为 0，最大值为 200。</p>
                     * 
                     */
                    int64_t GetNumRecentEvents() const;

                    /**
                     * 设置<p>返回最近事件数量，默认为 0，最大值为 200。</p>
                     * @param _numRecentEvents <p>返回最近事件数量，默认为 0，最大值为 200。</p>
                     * 
                     */
                    void SetNumRecentEvents(const int64_t& _numRecentEvents);

                    /**
                     * 判断参数 NumRecentEvents 是否已赋值
                     * @return NumRecentEvents 是否已赋值
                     * 
                     */
                    bool NumRecentEventsHasBeenSet() const;

                    /**
                     * 获取<p>事件起始时间，RFC3339 格式，最大长度 64 字符。</p>
                    ...
                    /**
                     * 设置<p>事件起始时间，RFC3339 格式，最大长度 64 字符。</p>
                ...
                private:
                     ...
                     */
                    int64_t m_numRecentEvents;
                    bool m_numRecentEventsHasBeenSet;
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_DESCRIBESESSIONREQUEST_H_
