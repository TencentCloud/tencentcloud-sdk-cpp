...
#ifndef TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEUPLOADURLREQUEST_H_
#define TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEUPLOADURLREQUEST_H_
    ...
    namespace Ags
    {
        namespace V20250920
        {
            namespace Model
            {
                ...
                */
                class GetSkillPackageUploadURLRequest : public AbstractModel
                {
                public:
                    GetSkillPackageUploadURLRequest();
                    ~GetSkillPackageUploadURLRequest() = default;
...
#endif // !TENCENTCLOUD_AGS_V20250920_MODEL_GETSKILLPACKAGEUPLOADURLREQUEST_H_
