...
string PauseSandboxInstanceRequest::ToJsonString() const
{
...
string PauseSandboxInstanceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void PauseSandboxInstanceRequest::SetInstanceId(const string& _instanceId)
{
