...
CoreInternalOutcome UpdateRegistryResponse::Deserialize(const string &payload)
{
...
string UpdateRegistryResponse::ToJsonString() const
{
...
CloudRegistry UpdateRegistryResponse::GetRegistry() const
{
    return m_registry;
}

bool UpdateRegistryResponse::RegistryHasBeenSet() const
{
