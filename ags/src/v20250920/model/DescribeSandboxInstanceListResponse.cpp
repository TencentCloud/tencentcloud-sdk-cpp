...
DescribeSandboxInstanceListResponse::DescribeSandboxInstanceListResponse() :
...
CoreInternalOutcome DescribeSandboxInstanceListResponse::Deserialize(const string &payload)
{
...
string DescribeSandboxInstanceListResponse::ToJsonString() const
{
...
vector<SandboxInstance> DescribeSandboxInstanceListResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeSandboxInstanceListResponse::InstanceSetHasBeenSet() const
{
    return m_instanceSetHasBeenSet;
}

int64_t DescribeSandboxInstanceListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSandboxInstanceListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

string DescribeSandboxInstanceListResponse::GetNextToken() const
{
    return m_nextToken;
}

bool DescribeSandboxInstanceListResponse::NextTokenHasBeenSet() const
{
