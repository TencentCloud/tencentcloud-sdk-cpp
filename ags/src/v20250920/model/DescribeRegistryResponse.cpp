...
CoreInternalOutcome DescribeRegistryResponse::Deserialize(const string &payload)
{
...
string DescribeRegistryResponse::ToJsonString() const
{
...
CloudRegistry DescribeRegistryResponse::GetRegistry() const
{
    return m_registry;
}

bool DescribeRegistryResponse::RegistryHasBeenSet() const
{
