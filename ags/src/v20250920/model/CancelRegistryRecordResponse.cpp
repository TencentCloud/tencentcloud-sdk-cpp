...
CancelRegistryRecordResponse::CancelRegistryRecordResponse() :
    m_versionHasBeenSet(false)
{
}

CoreInternalOutcome CancelRegistryRecordResponse::Deserialize(const string &payload)
{
...
string CancelRegistryRecordResponse::ToJsonString() const
{
...
CloudRecordVersion CancelRegistryRecordResponse::GetVersion() const
{
    return m_version;
}

bool CancelRegistryRecordResponse::VersionHasBeenSet() const
{
