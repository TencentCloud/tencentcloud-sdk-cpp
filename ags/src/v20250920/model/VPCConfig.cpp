...
CoreInternalOutcome VPCConfig::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("SubnetIds") && !value["SubnetIds"].IsNull())
    {
        if (!value["SubnetIds"].IsArray())
            return CoreInternalOutcome(Core::Error("response `VPCConfig.SubnetIds` is not array type"));
    ...
    if (value.HasMember("SecurityGroupIds") && !value["SecurityGroupIds"].IsNull())
    {
        if (!value["SecurityGroupIds"].IsArray())
            return CoreInternalOutcome(Core::Error("response `VPCConfig.SecurityGroupIds` is not array type"));
...
vector<string> VPCConfig::GetSubnetIds() const
{
    return m_subnetIds;
}

void VPCConfig::SetSubnetIds(const vector<string>& _subnetIds)
{
    m_subnetIds = _subnetIds;
    m_subnetIdsHasBeenSet = true;
}

bool VPCConfig::SubnetIdsHasBeenSet() const
{
    return m_subnetIdsHasBeenSet;
}

vector<string> VPCConfig::GetSecurityGroupIds() const
{
    return m_securityGroupIds;
}

void VPCConfig::SetSecurityGroupIds(const vector<string>& _securityGroupIds)
{
    m_securityGroupIds = _securityGroupIds;
    m_securityGroupIdsHasBeenSet = true;
}

bool VPCConfig::SecurityGroupIdsHasBeenSet() const
{
