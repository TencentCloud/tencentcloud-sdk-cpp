...
string DescribePreCacheImageTaskRequest::ToJsonString() const
{
...
string DescribePreCacheImageTaskRequest::GetImage() const
{
    return m_image;
}

void DescribePreCacheImageTaskRequest::SetImage(const string& _image)
{
    m_image = _image;
    m_imageHasBeenSet = true;
}

bool DescribePreCacheImageTaskRequest::ImageHasBeenSet() const
{
...
void DescribePreCacheImageTaskRequest::SetImageDigest(const string& _imageDigest)
{
    m_imageDigest = _imageDigest;
    m_imageDigestHasBeenSet = true;
}

bool DescribePreCacheImageTaskRequest::ImageDigestHasBeenSet() const
{
