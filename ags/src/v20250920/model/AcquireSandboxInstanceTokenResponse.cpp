...
CoreInternalOutcome AcquireSandboxInstanceTokenResponse::Deserialize(const string &payload)
{
...
string AcquireSandboxInstanceTokenResponse::ToJsonString() const
{
...
string AcquireSandboxInstanceTokenResponse::GetToken() const
{
    return m_token;
}

bool AcquireSandboxInstanceTokenResponse::TokenHasBeenSet() const
{
    return m_tokenHasBeenSet;
}

string AcquireSandboxInstanceTokenResponse::GetExpiresAt() const
{
    return m_expiresAt;
}
