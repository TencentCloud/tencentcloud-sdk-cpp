...
#ifndef TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZETARGETAUDIENCEREQUEST_H_
#define TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZETARGETAUDIENCEREQUEST_H_
    ...
    namespace Taf
    {
        namespace V20200210
        {
            namespace Model
            {
                ...
                */
                class RecognizeTargetAudienceRequest : public AbstractModel
                {
                public:
                    RecognizeTargetAudienceRequest();
                    ~RecognizeTargetAudienceRequest() = default;
...
#endif // !TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZETARGETAUDIENCEREQUEST_H_
