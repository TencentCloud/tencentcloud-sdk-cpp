...
#ifndef TENCENTCLOUD_TAF_V20200210_MODEL_DETECTFRAUDKOLREQUEST_H_
#define TENCENTCLOUD_TAF_V20200210_MODEL_DETECTFRAUDKOLREQUEST_H_
    ...
    namespace Taf
    {
        namespace V20200210
        {
            namespace Model
            {
                ...
                */
                class DetectFraudKOLRequest : public AbstractModel
                {
                public:
                    DetectFraudKOLRequest();
                    ~DetectFraudKOLRequest() = default;
                     ...
                     * @return BspData 业务数据
                     */
                    InputKolBspData GetBspData() const;

                    /**
                     * 设置业务数据
                     * @param BspData 业务数据
                     */
                    void SetBspData(const InputKolBspData& _bspData);
...
#endif // !TENCENTCLOUD_TAF_V20200210_MODEL_DETECTFRAUDKOLREQUEST_H_
