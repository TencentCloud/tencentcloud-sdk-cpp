...
#ifndef TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZECUSTOMIZEDAUDIENCEREQUEST_H_
#define TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZECUSTOMIZEDAUDIENCEREQUEST_H_
    ...
    namespace Taf
    {
        namespace V20200210
        {
            namespace Model
            {
                ...
                */
                class RecognizeCustomizedAudienceRequest : public AbstractModel
                {
                public:
                    RecognizeCustomizedAudienceRequest();
                    ~RecognizeCustomizedAudienceRequest() = default;
...
#endif // !TENCENTCLOUD_TAF_V20200210_MODEL_RECOGNIZECUSTOMIZEDAUDIENCEREQUEST_H_
