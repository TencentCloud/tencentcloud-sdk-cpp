...
CoreInternalOutcome RecognizeEffectiveFlowResponse::Deserialize(const string &payload)
{
...
string RecognizeEffectiveFlowResponse::ToJsonString() const
{
...
OutputRecognizeEffectiveFlow RecognizeEffectiveFlowResponse::GetData() const
{
    return m_data;
}

bool RecognizeEffectiveFlowResponse::DataHasBeenSet() const
{
