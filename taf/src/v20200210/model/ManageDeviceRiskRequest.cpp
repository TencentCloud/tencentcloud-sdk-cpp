...
ManageDeviceRiskRequest::ManageDeviceRiskRequest() :
    m_businessSecurityDataHasBeenSet(false)
{
}

string ManageDeviceRiskRequest::ToJsonString() const
{
...
ManageDeviceRiskInput ManageDeviceRiskRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void ManageDeviceRiskRequest::SetBusinessSecurityData(const ManageDeviceRiskInput& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool ManageDeviceRiskRequest::BusinessSecurityDataHasBeenSet() const
{
