...
string RecognizeEffectiveFlowRequest::ToJsonString() const
{
...
InputRecognizeEffectiveFlow RecognizeEffectiveFlowRequest::GetBusinessSecurityData() const
{
    return m_businessSecurityData;
}

void RecognizeEffectiveFlowRequest::SetBusinessSecurityData(const InputRecognizeEffectiveFlow& _businessSecurityData)
{
    m_businessSecurityData = _businessSecurityData;
    m_businessSecurityDataHasBeenSet = true;
}

bool RecognizeEffectiveFlowRequest::BusinessSecurityDataHasBeenSet() const
{
