...
CoreInternalOutcome EnhanceTaDegreeResponse::Deserialize(const string &payload)
{
...
string EnhanceTaDegreeResponse::ToJsonString() const
{
...
OutputTaData EnhanceTaDegreeResponse::GetData() const
{
    return m_data;
}

bool EnhanceTaDegreeResponse::DataHasBeenSet() const
{
