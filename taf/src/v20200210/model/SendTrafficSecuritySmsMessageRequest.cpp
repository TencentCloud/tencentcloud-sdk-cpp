...
string SendTrafficSecuritySmsMessageRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
InputSendTrafficSecuritySmsMsg SendTrafficSecuritySmsMessageRequest::GetBspData() const
{
    return m_bspData;
}

void SendTrafficSecuritySmsMessageRequest::SetBspData(const InputSendTrafficSecuritySmsMsg& _bspData)
{
    m_bspData = _bspData;
    m_bspDataHasBeenSet = true;
}

bool SendTrafficSecuritySmsMessageRequest::BspDataHasBeenSet() const
{
