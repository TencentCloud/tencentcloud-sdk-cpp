...
CoreInternalOutcome SendTrafficSecuritySmsMessageResponse::Deserialize(const string &payload)
{
...
string SendTrafficSecuritySmsMessageResponse::ToJsonString() const
{
...
OutputSendTrafficSecuritySmsMsg SendTrafficSecuritySmsMessageResponse::GetData() const
{
    return m_data;
}

bool SendTrafficSecuritySmsMessageResponse::DataHasBeenSet() const
{
