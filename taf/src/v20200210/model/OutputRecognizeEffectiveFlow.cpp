...
CoreInternalOutcome OutputRecognizeEffectiveFlow::Deserialize(const Value &value)
{
    string requestId = "";
...
void OutputRecognizeEffectiveFlow::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
