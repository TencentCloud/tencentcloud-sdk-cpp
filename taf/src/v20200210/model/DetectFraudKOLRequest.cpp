...
string DetectFraudKOLRequest::ToJsonString() const
{
...
InputKolBspData DetectFraudKOLRequest::GetBspData() const
{
    return m_bspData;
}

void DetectFraudKOLRequest::SetBspData(const InputKolBspData& _bspData)
{
    m_bspData = _bspData;
