...
DescribeInstancePackageListResponse::DescribeInstancePackageListResponse() :
    m_totalCountHasBeenSet(false),
    m_instanceSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeInstancePackageListResponse::Deserialize(const string &payload)
{
...
string DescribeInstancePackageListResponse::ToJsonString() const
{
...
uint64_t DescribeInstancePackageListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstancePackageListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<InstancePackage> DescribeInstancePackageListResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeInstancePackageListResponse::InstanceSetHasBeenSet() const
{
