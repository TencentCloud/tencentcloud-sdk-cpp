...
ModifyAddressPoolResponse::ModifyAddressPoolResponse() :
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAddressPoolResponse::Deserialize(const string &payload)
{
...
string ModifyAddressPoolResponse::ToJsonString() const
{
...
string ModifyAddressPoolResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyAddressPoolResponse::MsgHasBeenSet() const
{
