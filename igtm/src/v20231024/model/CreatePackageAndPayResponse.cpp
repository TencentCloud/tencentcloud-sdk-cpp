...
CreatePackageAndPayResponse::CreatePackageAndPayResponse() :
    m_resourceIdsHasBeenSet(false)
{
}

CoreInternalOutcome CreatePackageAndPayResponse::Deserialize(const string &payload)
{
...
string CreatePackageAndPayResponse::ToJsonString() const
{
...
vector<string> CreatePackageAndPayResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreatePackageAndPayResponse::ResourceIdsHasBeenSet() const
{
