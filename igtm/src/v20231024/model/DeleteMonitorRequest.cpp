...
string DeleteMonitorRequest::ToJsonString() const
{
...
uint64_t DeleteMonitorRequest::GetMonitorId() const
{
    return m_monitorId;
}

void DeleteMonitorRequest::SetMonitorId(const uint64_t& _monitorId)
{
    m_monitorId = _monitorId;
    m_monitorIdHasBeenSet = true;
}

bool DeleteMonitorRequest::MonitorIdHasBeenSet() const
{
