...
uint64_t DescribeInstanceListRequest::GetOffset() const
{
    return m_offset;
}

void DescribeInstanceListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeInstanceListRequest::GetLimit() const
{
    return m_limit;
}

void DescribeInstanceListRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
...
vector<ResourceFilter> DescribeInstanceListRequest::GetFilters() const
{
    return m_filters;
}

void DescribeInstanceListRequest::SetFilters(const vector<ResourceFilter>& _filters)
{
    m_filters = _filters;
