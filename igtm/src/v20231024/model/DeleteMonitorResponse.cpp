...
CoreInternalOutcome DeleteMonitorResponse::Deserialize(const string &payload)
{
...
string DeleteMonitorResponse::ToJsonString() const
{
...
string DeleteMonitorResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteMonitorResponse::MsgHasBeenSet() const
{
