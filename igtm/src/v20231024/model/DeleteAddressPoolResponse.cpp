...
DeleteAddressPoolResponse::DeleteAddressPoolResponse() :
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome DeleteAddressPoolResponse::Deserialize(const string &payload)
{
...
string DeleteAddressPoolResponse::ToJsonString() const
{
...
string DeleteAddressPoolResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteAddressPoolResponse::MsgHasBeenSet() const
{
