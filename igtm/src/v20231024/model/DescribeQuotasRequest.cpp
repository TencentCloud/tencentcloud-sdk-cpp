...
string DescribeQuotasRequest::GetAccessDomain() const
{
    return m_accessDomain;
}

void DescribeQuotasRequest::SetAccessDomain(const string& _accessDomain)
{
    m_accessDomain = _accessDomain;
    m_accessDomainHasBeenSet = true;
}

bool DescribeQuotasRequest::AccessDomainHasBeenSet() const
{
