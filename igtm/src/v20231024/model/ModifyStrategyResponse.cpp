...
ModifyStrategyResponse::ModifyStrategyResponse() :
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyStrategyResponse::ToJsonString() const
{
...
string ModifyStrategyResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyStrategyResponse::MsgHasBeenSet() const
{
