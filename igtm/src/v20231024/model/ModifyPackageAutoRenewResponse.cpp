...
CoreInternalOutcome ModifyPackageAutoRenewResponse::Deserialize(const string &payload)
{
...
string ModifyPackageAutoRenewResponse::ToJsonString() const
{
...
vector<string> ModifyPackageAutoRenewResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool ModifyPackageAutoRenewResponse::ResourceIdsHasBeenSet() const
{
