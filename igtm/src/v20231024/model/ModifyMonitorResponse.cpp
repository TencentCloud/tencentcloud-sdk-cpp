...
ModifyMonitorResponse::ModifyMonitorResponse() :
    m_msgHasBeenSet(false)
{
}

CoreInternalOutcome ModifyMonitorResponse::Deserialize(const string &payload)
{
...
string ModifyMonitorResponse::ToJsonString() const
{
...
string ModifyMonitorResponse::GetMsg() const
{
    return m_msg;
}

bool ModifyMonitorResponse::MsgHasBeenSet() const
{
