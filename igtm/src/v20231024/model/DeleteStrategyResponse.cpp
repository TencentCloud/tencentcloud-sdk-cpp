...
CoreInternalOutcome DeleteStrategyResponse::Deserialize(const string &payload)
{
...
string DeleteStrategyResponse::ToJsonString() const
{
...
string DeleteStrategyResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteStrategyResponse::MsgHasBeenSet() const
{
