...
DescribeMonitorDetailRequest::DescribeMonitorDetailRequest() :
    m_monitorIdHasBeenSet(false)
{
}

string DescribeMonitorDetailRequest::ToJsonString() const
{
...
uint64_t DescribeMonitorDetailRequest::GetMonitorId() const
{
    return m_monitorId;
}

void DescribeMonitorDetailRequest::SetMonitorId(const uint64_t& _monitorId)
{
    m_monitorId = _monitorId;
    m_monitorIdHasBeenSet = true;
}

bool DescribeMonitorDetailRequest::MonitorIdHasBeenSet() const
{
