...
#ifndef TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEMONITORREQUEST_H_
#define TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEMONITORREQUEST_H_
    ...
    namespace Igtm
    {
        namespace V20231024
        {
            namespace Model
            {
                ...
                */
                class CreateMonitorRequest : public AbstractModel
                {
                public:
                    CreateMonitorRequest();
                    ~CreateMonitorRequest() = default;
                    ...
                    /**
                     * 获取探测协议，可选值 PING TCP HTTP HTTPS
                     * @return CheckProtocol 探测协议，可选值 PING TCP HTTP HTTPS
                     * 
                     */
                    std::string GetCheckProtocol() const;

                    /**
                     * 设置探测协议，可选值 PING TCP HTTP HTTPS
                    ...
                    /**
                     * 获取检查间隔（秒），可选值有15 60 120 300
                     * @return CheckInterval 检查间隔（秒），可选值有15 60 120 300
                     * 
                     */
                    uint64_t GetCheckInterval() const;

                    /**
                     * 设置检查间隔（秒），可选值有15 60 120 300
                    ...
                    /**
                     * 获取超时时间，单位秒，可选值为2 3 5 10
                     * @return Timeout 超时时间，单位秒，可选值为2 3 5 10
                     * 
                     */
                    uint64_t GetTimeout() const;

                    /**
                     * 设置超时时间，单位秒，可选值为2 3 5 10
                    ...
                    /**
                     * 获取失败比例，取值为 20 30 40 50 60 70 80 100，默认值50
                     * @return FailRate 失败比例，取值为 20 30 40 50 60 70 80 100，默认值50
                     * 
                     */
                    uint64_t GetFailRate() const;

                    /**
                     * 设置失败比例，取值为 20 30 40 50 60 70 80 100，默认值50
                    ...
                    /**
                     * 获取探测器组id列表以,分隔
                     * @return DetectorGroupIds 探测器组id列表以,分隔
                     * 
                     */
                    ...
                    /**
                     * 获取PING 包数目，当CheckProtocol=ping时必填，可选值有20 50 100
                     * @return PingNum PING 包数目，当CheckProtocol=ping时必填，可选值有20 50 100
                     * 
                     */
                    uint64_t GetPingNum() const;

                    /**
                     * 设置PING 包数目，当CheckProtocol=ping时必填，可选值有20 50 100
                    ...
                    /**
                     * 获取检查端口，可选值在1-65535之间
                     * @return TcpPort 检查端口，可选值在1-65535之间
                     * 
                     */
                    uint64_t GetTcpPort() const;

                    /**
                     * 设置检查端口，可选值在1-65535之间
                    ...
                    /**
                     * 获取丢包率告警阈值，当CheckProtocol=ping时必填取值为10 30 50 80 90 100
                     * @return PacketLossRate 丢包率告警阈值，当CheckProtocol=ping时必填取值为10 30 50 80 90 100
                     * 
                     */
                    uint64_t GetPacketLossRate() const;

                    /**
                     * 设置丢包率告警阈值，当CheckProtocol=ping时必填取值为10 30 50 80 90 100
...
#endif // !TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEMONITORREQUEST_H_
