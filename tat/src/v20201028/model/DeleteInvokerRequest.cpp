...
string DeleteInvokerRequest::ToJsonString() const
{
...
string DeleteInvokerRequest::GetInvokerId() const
{
    return m_invokerId;
}

void DeleteInvokerRequest::SetInvokerId(const string& _invokerId)
{
    m_invokerId = _invokerId;
    m_invokerIdHasBeenSet = true;
}

bool DeleteInvokerRequest::InvokerIdHasBeenSet() const
{
