...
string DeleteRegisterCodesRequest::ToJsonString() const
{
...
vector<string> DeleteRegisterCodesRequest::GetRegisterCodeIds() const
{
    return m_registerCodeIds;
}

void DeleteRegisterCodesRequest::SetRegisterCodeIds(const vector<string>& _registerCodeIds)
{
    m_registerCodeIds = _registerCodeIds;
    m_registerCodeIdsHasBeenSet = true;
}

bool DeleteRegisterCodesRequest::RegisterCodeIdsHasBeenSet() const
{
