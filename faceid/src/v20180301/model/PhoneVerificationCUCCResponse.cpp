...
CoreInternalOutcome PhoneVerificationCUCCResponse::Deserialize(const string &payload)
{
...
string PhoneVerificationCUCCResponse::ToJsonString() const
{
...
string PhoneVerificationCUCCResponse::GetResult() const
{
    return m_result;
}

bool PhoneVerificationCUCCResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string PhoneVerificationCUCCResponse::GetIsp() const
{
    return m_isp;
}

bool PhoneVerificationCUCCResponse::IspHasBeenSet() const
{
    return m_ispHasBeenSet;
}

string PhoneVerificationCUCCResponse::GetDescription() const
{
    return m_description;
}

bool PhoneVerificationCUCCResponse::DescriptionHasBeenSet() const
{
