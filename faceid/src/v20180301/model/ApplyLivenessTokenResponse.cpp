...
CoreInternalOutcome ApplyLivenessTokenResponse::Deserialize(const string &payload)
{
...
string ApplyLivenessTokenResponse::ToJsonString() const
{
...
string ApplyLivenessTokenResponse::GetSdkToken() const
{
    return m_sdkToken;
}

bool ApplyLivenessTokenResponse::SdkTokenHasBeenSet() const
{
