...
string DetectAuthResponse::ToJsonString() const
{
...
string DetectAuthResponse::GetUrl() const
{
    return m_url;
}

bool DetectAuthResponse::UrlHasBeenSet() const
{
    return m_urlHasBeenSet;
}

string DetectAuthResponse::GetBizToken() const
{
    return m_bizToken;
}

bool DetectAuthResponse::BizTokenHasBeenSet() const
{
