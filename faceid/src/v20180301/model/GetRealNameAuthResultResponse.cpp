...
CoreInternalOutcome GetRealNameAuthResultResponse::Deserialize(const string &payload)
{
...
string GetRealNameAuthResultResponse::ToJsonString() const
{
...
string GetRealNameAuthResultResponse::GetResultType() const
{
    return m_resultType;
}

bool GetRealNameAuthResultResponse::ResultTypeHasBeenSet() const
{
