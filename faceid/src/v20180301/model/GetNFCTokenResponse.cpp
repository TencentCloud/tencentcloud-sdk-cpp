...
CoreInternalOutcome GetNFCTokenResponse::Deserialize(const string &payload)
{
...
string GetNFCTokenResponse::ToJsonString() const
{
...
string GetNFCTokenResponse::GetToken() const
{
    return m_token;
}

bool GetNFCTokenResponse::TokenHasBeenSet() const
{
