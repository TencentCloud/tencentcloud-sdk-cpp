...
string ImageRecognitionResponse::ToJsonString() const
{
...
double ImageRecognitionResponse::GetSim() const
{
    return m_sim;
}

bool ImageRecognitionResponse::SimHasBeenSet() const
{
    return m_simHasBeenSet;
}

string ImageRecognitionResponse::GetResult() const
{
    return m_result;
}

bool ImageRecognitionResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ImageRecognitionResponse::GetDescription() const
{
    return m_description;
}

bool ImageRecognitionResponse::DescriptionHasBeenSet() const
{
