...
CoreInternalOutcome MobileStatusResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("StatusCode") && !rsp["StatusCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `StatusCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string MobileStatusResponse::ToJsonString() const
{
...
string MobileStatusResponse::GetResult() const
{
    return m_result;
}

bool MobileStatusResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string MobileStatusResponse::GetDescription() const
{
    return m_description;
}

bool MobileStatusResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

int64_t MobileStatusResponse::GetStatusCode() const
{
    return m_statusCode;
}

bool MobileStatusResponse::StatusCodeHasBeenSet() const
{
