...
CoreInternalOutcome LivenessRecognitionResponse::Deserialize(const string &payload)
{
...
string LivenessRecognitionResponse::ToJsonString() const
{
...
string LivenessRecognitionResponse::GetBestFrameBase64() const
{
    return m_bestFrameBase64;
}

bool LivenessRecognitionResponse::BestFrameBase64HasBeenSet() const
{
    return m_bestFrameBase64HasBeenSet;
}

double LivenessRecognitionResponse::GetSim() const
{
    return m_sim;
}

bool LivenessRecognitionResponse::SimHasBeenSet() const
{
    return m_simHasBeenSet;
}

string LivenessRecognitionResponse::GetResult() const
{
    return m_result;
}

bool LivenessRecognitionResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string LivenessRecognitionResponse::GetDescription() const
{
