...
CoreInternalOutcome PhoneVerificationResponse::Deserialize(const string &payload)
{
...
string PhoneVerificationResponse::ToJsonString() const
{
...
string PhoneVerificationResponse::GetResult() const
{
    return m_result;
}

bool PhoneVerificationResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string PhoneVerificationResponse::GetDescription() const
{
    return m_description;
}

bool PhoneVerificationResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string PhoneVerificationResponse::GetIsp() const
{
    return m_isp;
}
