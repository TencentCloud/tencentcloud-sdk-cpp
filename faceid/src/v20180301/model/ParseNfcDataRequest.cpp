...
string ParseNfcDataRequest::ToJsonString() const
{
...
string ParseNfcDataRequest::GetReqId() const
{
    return m_reqId;
}

void ParseNfcDataRequest::SetReqId(const string& _reqId)
{
    m_reqId = _reqId;
    m_reqIdHasBeenSet = true;
}

bool ParseNfcDataRequest::ReqIdHasBeenSet() const
{
