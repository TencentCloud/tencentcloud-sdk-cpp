...
string MobileNetworkTimeVerificationRequest::ToJsonString() const
{
...
string MobileNetworkTimeVerificationRequest::GetMobile() const
{
    return m_mobile;
}

void MobileNetworkTimeVerificationRequest::SetMobile(const string& _mobile)
{
    m_mobile = _mobile;
