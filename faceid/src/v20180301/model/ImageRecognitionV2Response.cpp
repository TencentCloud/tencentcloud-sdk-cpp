...
CoreInternalOutcome ImageRecognitionV2Response::Deserialize(const string &payload)
{
...
string ImageRecognitionV2Response::ToJsonString() const
{
...
double ImageRecognitionV2Response::GetSim() const
{
    return m_sim;
}

bool ImageRecognitionV2Response::SimHasBeenSet() const
{
    return m_simHasBeenSet;
}

string ImageRecognitionV2Response::GetResult() const
{
    return m_result;
}

bool ImageRecognitionV2Response::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string ImageRecognitionV2Response::GetDescription() const
{
