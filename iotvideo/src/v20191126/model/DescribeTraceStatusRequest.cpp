...
string DescribeTraceStatusRequest::ToJsonString() const
{
...
vector<string> DescribeTraceStatusRequest::GetTids() const
{
    return m_tids;
}

void DescribeTraceStatusRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool DescribeTraceStatusRequest::TidsHasBeenSet() const
{
