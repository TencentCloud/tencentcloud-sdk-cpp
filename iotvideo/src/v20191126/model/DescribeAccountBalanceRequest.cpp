...
int64_t DescribeAccountBalanceRequest::GetAccountType() const
{
    return m_accountType;
}

void DescribeAccountBalanceRequest::SetAccountType(const int64_t& _accountType)
{
    m_accountType = _accountType;
    m_accountTypeHasBeenSet = true;
}

bool DescribeAccountBalanceRequest::AccountTypeHasBeenSet() const
{
