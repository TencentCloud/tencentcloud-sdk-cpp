...
CoreInternalOutcome UpgradeDeviceResponse::Deserialize(const string &payload)
{
...
string UpgradeDeviceResponse::ToJsonString() const
{
...
string UpgradeDeviceResponse::GetData() const
{
    return m_data;
}

bool UpgradeDeviceResponse::DataHasBeenSet() const
{
