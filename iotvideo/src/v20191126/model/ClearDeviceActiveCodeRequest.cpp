...
string ClearDeviceActiveCodeRequest::ToJsonString() const
{
...
vector<string> ClearDeviceActiveCodeRequest::GetTids() const
{
    return m_tids;
}

void ClearDeviceActiveCodeRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool ClearDeviceActiveCodeRequest::TidsHasBeenSet() const
{
