...
CoreInternalOutcome DescribeModelDataRetResponse::Deserialize(const string &payload)
{
...
string DescribeModelDataRetResponse::ToJsonString() const
{
...
string DescribeModelDataRetResponse::GetData() const
{
    return m_data;
}

bool DescribeModelDataRetResponse::DataHasBeenSet() const
{
