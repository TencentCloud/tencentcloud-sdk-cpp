...
string DeleteTraceIdsRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
vector<string> DeleteTraceIdsRequest::GetTids() const
{
    return m_tids;
}

void DeleteTraceIdsRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool DeleteTraceIdsRequest::TidsHasBeenSet() const
{
