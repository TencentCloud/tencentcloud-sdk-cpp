...
string RunDeviceRequest::ToJsonString() const
{
...
vector<string> RunDeviceRequest::GetTids() const
{
    return m_tids;
}

void RunDeviceRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool RunDeviceRequest::TidsHasBeenSet() const
{
