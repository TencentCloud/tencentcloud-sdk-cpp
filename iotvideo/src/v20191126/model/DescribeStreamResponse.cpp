...
CoreInternalOutcome DescribeStreamResponse::Deserialize(const string &payload)
{
...
string DescribeStreamResponse::ToJsonString() const
{
...
Data DescribeStreamResponse::GetData() const
{
    return m_data;
}

bool DescribeStreamResponse::DataHasBeenSet() const
{
