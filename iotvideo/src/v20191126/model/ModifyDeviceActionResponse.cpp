...
CoreInternalOutcome ModifyDeviceActionResponse::Deserialize(const string &payload)
{
...
string ModifyDeviceActionResponse::ToJsonString() const
{
...
string ModifyDeviceActionResponse::GetData() const
{
    return m_data;
}

bool ModifyDeviceActionResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

string ModifyDeviceActionResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyDeviceActionResponse::TaskIdHasBeenSet() const
{
