...
string DeleteAppUsrRequest::ToJsonString() const
{
...
string DeleteAppUsrRequest::GetAccessId() const
{
    return m_accessId;
}

void DeleteAppUsrRequest::SetAccessId(const string& _accessId)
{
    m_accessId = _accessId;
    m_accessIdHasBeenSet = true;
}

bool DeleteAppUsrRequest::AccessIdHasBeenSet() const
{
