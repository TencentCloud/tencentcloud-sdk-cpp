...
string DisableDeviceStreamRequest::ToJsonString() const
{
...
vector<string> DisableDeviceStreamRequest::GetTids() const
{
    return m_tids;
}

void DisableDeviceStreamRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool DisableDeviceStreamRequest::TidsHasBeenSet() const
{
