...
CoreInternalOutcome DescribeStorageServiceResponse::Deserialize(const string &payload)
{
...
string DescribeStorageServiceResponse::ToJsonString() const
{
...
string DescribeStorageServiceResponse::GetServiceId() const
{
    return m_serviceId;
}

bool DescribeStorageServiceResponse::ServiceIdHasBeenSet() const
{
    return m_serviceIdHasBeenSet;
}

string DescribeStorageServiceResponse::GetStorageRegion() const
{
    return m_storageRegion;
}

bool DescribeStorageServiceResponse::StorageRegionHasBeenSet() const
{
    return m_storageRegionHasBeenSet;
}

string DescribeStorageServiceResponse::GetTid() const
{
    return m_tid;
}

bool DescribeStorageServiceResponse::TidHasBeenSet() const
{
    return m_tidHasBeenSet;
}

int64_t DescribeStorageServiceResponse::GetChnNum() const
{
    return m_chnNum;
}

bool DescribeStorageServiceResponse::ChnNumHasBeenSet() const
{
    return m_chnNumHasBeenSet;
}

string DescribeStorageServiceResponse::GetAccessId() const
{
    return m_accessId;
}

bool DescribeStorageServiceResponse::AccessIdHasBeenSet() const
{
    return m_accessIdHasBeenSet;
}

int64_t DescribeStorageServiceResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeStorageServiceResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

int64_t DescribeStorageServiceResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeStorageServiceResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

int64_t DescribeStorageServiceResponse::GetStatus() const
{
    return m_status;
}

bool DescribeStorageServiceResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<StorageOrder> DescribeStorageServiceResponse::GetData() const
{
    return m_data;
}

bool DescribeStorageServiceResponse::DataHasBeenSet() const
{
