...
CoreInternalOutcome DescribeRunLogResponse::Deserialize(const string &payload)
{
...
string DescribeRunLogResponse::ToJsonString() const
{
...
string DescribeRunLogResponse::GetData() const
{
    return m_data;
}

bool DescribeRunLogResponse::DataHasBeenSet() const
{
