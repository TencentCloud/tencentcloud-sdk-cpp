...
string DisableDeviceRequest::ToJsonString() const
{
...
vector<string> DisableDeviceRequest::GetTids() const
{
    return m_tids;
}

void DisableDeviceRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool DisableDeviceRequest::TidsHasBeenSet() const
{
