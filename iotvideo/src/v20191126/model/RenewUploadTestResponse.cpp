...
CoreInternalOutcome RenewUploadTestResponse::Deserialize(const string &payload)
{
...
string RenewUploadTestResponse::ToJsonString() const
{
...
RenewCertificate RenewUploadTestResponse::GetData() const
{
    return m_data;
}

bool RenewUploadTestResponse::DataHasBeenSet() const
{
