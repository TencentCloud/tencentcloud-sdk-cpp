...
CoreInternalOutcome DescribeMessageQueueResponse::Deserialize(const string &payload)
{
...
string DescribeMessageQueueResponse::ToJsonString() const
{
...
MsgQueueData DescribeMessageQueueResponse::GetData() const
{
    return m_data;
}

bool DescribeMessageQueueResponse::DataHasBeenSet() const
{
