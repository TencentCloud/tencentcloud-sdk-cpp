...
vector<string> DeleteDeviceRequest::GetTids() const
{
    return m_tids;
}

void DeleteDeviceRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool DeleteDeviceRequest::TidsHasBeenSet() const
{
