...
CoreInternalOutcome CreateBindingResponse::Deserialize(const string &payload)
{
...
string CreateBindingResponse::ToJsonString() const
{
...
string CreateBindingResponse::GetAccessToken() const
{
    return m_accessToken;
}

bool CreateBindingResponse::AccessTokenHasBeenSet() const
{
