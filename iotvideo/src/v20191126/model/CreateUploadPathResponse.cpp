...
CoreInternalOutcome CreateUploadPathResponse::Deserialize(const string &payload)
{
...
string CreateUploadPathResponse::ToJsonString() const
{
...
string CreateUploadPathResponse::GetData() const
{
    return m_data;
}

bool CreateUploadPathResponse::DataHasBeenSet() const
{
