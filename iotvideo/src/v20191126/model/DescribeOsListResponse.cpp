...
CoreInternalOutcome DescribeOsListResponse::Deserialize(const string &payload)
{
...
string DescribeOsListResponse::ToJsonString() const
{
...
SystemType DescribeOsListResponse::GetData() const
{
    return m_data;
}

bool DescribeOsListResponse::DataHasBeenSet() const
{
