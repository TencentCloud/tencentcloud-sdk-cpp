...
CoreInternalOutcome DescribeIotModelResponse::Deserialize(const string &payload)
{
...
string DescribeIotModelResponse::ToJsonString() const
{
...
string DescribeIotModelResponse::GetData() const
{
    return m_data;
}

bool DescribeIotModelResponse::DataHasBeenSet() const
{
