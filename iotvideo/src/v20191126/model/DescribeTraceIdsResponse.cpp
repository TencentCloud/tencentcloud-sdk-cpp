...
CoreInternalOutcome DescribeTraceIdsResponse::Deserialize(const string &payload)
{
...
string DescribeTraceIdsResponse::ToJsonString() const
{
...
string DescribeTraceIdsResponse::GetData() const
{
    return m_data;
}

bool DescribeTraceIdsResponse::DataHasBeenSet() const
{
