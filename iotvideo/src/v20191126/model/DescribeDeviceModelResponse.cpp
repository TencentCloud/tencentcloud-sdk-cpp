...
CoreInternalOutcome DescribeDeviceModelResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceModelResponse::ToJsonString() const
{
...
DeviceModelData DescribeDeviceModelResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceModelResponse::DataHasBeenSet() const
{
