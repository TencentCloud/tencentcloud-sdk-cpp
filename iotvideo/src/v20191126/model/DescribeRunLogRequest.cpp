...
string DescribeRunLogRequest::ToJsonString() const
{
...
string DescribeRunLogRequest::GetTid() const
{
    return m_tid;
}

void DescribeRunLogRequest::SetTid(const string& _tid)
{
    m_tid = _tid;
    m_tidHasBeenSet = true;
}

bool DescribeRunLogRequest::TidHasBeenSet() const
{
