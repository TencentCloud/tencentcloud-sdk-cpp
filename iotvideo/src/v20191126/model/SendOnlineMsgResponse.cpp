...
CoreInternalOutcome SendOnlineMsgResponse::Deserialize(const string &payload)
{
...
string SendOnlineMsgResponse::ToJsonString() const
{
...
string SendOnlineMsgResponse::GetTaskId() const
{
    return m_taskId;
}

bool SendOnlineMsgResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string SendOnlineMsgResponse::GetData() const
{
    return m_data;
}

bool SendOnlineMsgResponse::DataHasBeenSet() const
{
