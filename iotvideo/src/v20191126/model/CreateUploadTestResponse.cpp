...
CoreInternalOutcome CreateUploadTestResponse::Deserialize(const string &payload)
{
...
string CreateUploadTestResponse::ToJsonString() const
{
...
CosCertificate CreateUploadTestResponse::GetData() const
{
    return m_data;
}

bool CreateUploadTestResponse::DataHasBeenSet() const
{
