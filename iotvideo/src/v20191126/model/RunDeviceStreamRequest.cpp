...
string RunDeviceStreamRequest::ToJsonString() const
{
...
vector<string> RunDeviceStreamRequest::GetTids() const
{
    return m_tids;
}

void RunDeviceStreamRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool RunDeviceStreamRequest::TidsHasBeenSet() const
{
