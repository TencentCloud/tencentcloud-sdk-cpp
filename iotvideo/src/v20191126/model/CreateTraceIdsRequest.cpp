...
string CreateTraceIdsRequest::ToJsonString() const
{
...
vector<string> CreateTraceIdsRequest::GetTids() const
{
    return m_tids;
}

void CreateTraceIdsRequest::SetTids(const vector<string>& _tids)
{
    m_tids = _tids;
    m_tidsHasBeenSet = true;
}

bool CreateTraceIdsRequest::TidsHasBeenSet() const
{
