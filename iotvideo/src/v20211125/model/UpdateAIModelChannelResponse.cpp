...
CoreInternalOutcome UpdateAIModelChannelResponse::Deserialize(const string &payload)
{
...
string UpdateAIModelChannelResponse::ToJsonString() const
{
...
string UpdateAIModelChannelResponse::GetForwardKey() const
{
    return m_forwardKey;
}

bool UpdateAIModelChannelResponse::ForwardKeyHasBeenSet() const
{
