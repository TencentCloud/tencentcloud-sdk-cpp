...
CoreInternalOutcome DescribeDeviceStatusLogResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceStatusLogResponse::ToJsonString() const
{
...
bool DescribeDeviceStatusLogResponse::GetListover() const
{
    return m_listover;
}

bool DescribeDeviceStatusLogResponse::ListoverHasBeenSet() const
{
    return m_listoverHasBeenSet;
}

string DescribeDeviceStatusLogResponse::GetContext() const
{
    return m_context;
}

bool DescribeDeviceStatusLogResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

vector<DeviceStatusLogItem> DescribeDeviceStatusLogResponse::GetResults() const
{
    return m_results;
}

bool DescribeDeviceStatusLogResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

int64_t DescribeDeviceStatusLogResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDeviceStatusLogResponse::TotalCountHasBeenSet() const
{
