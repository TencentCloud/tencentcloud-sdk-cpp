...
CreateFreeCloudStorageResponse::CreateFreeCloudStorageResponse() :
    m_priceHasBeenSet(false),
    m_amountHasBeenSet(false)
{
}

CoreInternalOutcome CreateFreeCloudStorageResponse::Deserialize(const string &payload)
{
...
string CreateFreeCloudStorageResponse::ToJsonString() const
{
...
uint64_t CreateFreeCloudStorageResponse::GetPrice() const
{
    return m_price;
}

bool CreateFreeCloudStorageResponse::PriceHasBeenSet() const
{
    return m_priceHasBeenSet;
}

uint64_t CreateFreeCloudStorageResponse::GetAmount() const
{
    return m_amount;
}

bool CreateFreeCloudStorageResponse::AmountHasBeenSet() const
{
