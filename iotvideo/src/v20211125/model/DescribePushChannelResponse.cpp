...
DescribePushChannelResponse::DescribePushChannelResponse() :
...
CoreInternalOutcome DescribePushChannelResponse::Deserialize(const string &payload)
{
...
string DescribePushChannelResponse::ToJsonString() const
{
...
string DescribePushChannelResponse::GetType() const
{
    return m_type;
}

bool DescribePushChannelResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string DescribePushChannelResponse::GetForwardAddress() const
{
    return m_forwardAddress;
}

bool DescribePushChannelResponse::ForwardAddressHasBeenSet() const
{
    return m_forwardAddressHasBeenSet;
}

string DescribePushChannelResponse::GetForwardKey() const
{
    return m_forwardKey;
}

bool DescribePushChannelResponse::ForwardKeyHasBeenSet() const
{
    return m_forwardKeyHasBeenSet;
}

string DescribePushChannelResponse::GetCKafkaRegion() const
{
    return m_cKafkaRegion;
}

bool DescribePushChannelResponse::CKafkaRegionHasBeenSet() const
{
    return m_cKafkaRegionHasBeenSet;
}

string DescribePushChannelResponse::GetCKafkaInstance() const
{
    return m_cKafkaInstance;
}

bool DescribePushChannelResponse::CKafkaInstanceHasBeenSet() const
{
    return m_cKafkaInstanceHasBeenSet;
}

string DescribePushChannelResponse::GetCKafkaTopic() const
{
    return m_cKafkaTopic;
}

bool DescribePushChannelResponse::CKafkaTopicHasBeenSet() const
{
