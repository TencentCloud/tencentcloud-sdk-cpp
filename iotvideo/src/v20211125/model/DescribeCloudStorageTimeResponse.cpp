...
CoreInternalOutcome DescribeCloudStorageTimeResponse::Deserialize(const string &payload)
{
...
string DescribeCloudStorageTimeResponse::ToJsonString() const
{
...
CloudStorageTimeData DescribeCloudStorageTimeResponse::GetData() const
{
    return m_data;
}

bool DescribeCloudStorageTimeResponse::DataHasBeenSet() const
{
