...
CoreInternalOutcome DescribeDeviceDataResponse::Deserialize(const string &payload)
{
...
string DescribeDeviceDataResponse::ToJsonString() const
{
...
string DescribeDeviceDataResponse::GetData() const
{
    return m_data;
}

bool DescribeDeviceDataResponse::DataHasBeenSet() const
{
