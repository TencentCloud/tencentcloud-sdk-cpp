...
CoreInternalOutcome ModifyProductDynamicRegisterResponse::Deserialize(const string &payload)
{
...
string ModifyProductDynamicRegisterResponse::ToJsonString() const
{
...
uint64_t ModifyProductDynamicRegisterResponse::GetRegisterType() const
{
    return m_registerType;
}

bool ModifyProductDynamicRegisterResponse::RegisterTypeHasBeenSet() const
{
    return m_registerTypeHasBeenSet;
}

string ModifyProductDynamicRegisterResponse::GetProductSecret() const
{
    return m_productSecret;
}

bool ModifyProductDynamicRegisterResponse::ProductSecretHasBeenSet() const
{
    return m_productSecretHasBeenSet;
}

uint64_t ModifyProductDynamicRegisterResponse::GetRegisterLimit() const
{
    return m_registerLimit;
}

bool ModifyProductDynamicRegisterResponse::RegisterLimitHasBeenSet() const
{
