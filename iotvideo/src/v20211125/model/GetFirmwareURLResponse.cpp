...
CoreInternalOutcome GetFirmwareURLResponse::Deserialize(const string &payload)
{
...
string GetFirmwareURLResponse::ToJsonString() const
{
...
string GetFirmwareURLResponse::GetUrl() const
{
    return m_url;
}

bool GetFirmwareURLResponse::UrlHasBeenSet() const
{
