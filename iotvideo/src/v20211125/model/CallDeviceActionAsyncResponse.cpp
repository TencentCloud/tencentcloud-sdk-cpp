...
CoreInternalOutcome CallDeviceActionAsyncResponse::Deserialize(const string &payload)
{
...
string CallDeviceActionAsyncResponse::ToJsonString() const
{
...
string CallDeviceActionAsyncResponse::GetClientToken() const
{
    return m_clientToken;
}

bool CallDeviceActionAsyncResponse::ClientTokenHasBeenSet() const
{
    return m_clientTokenHasBeenSet;
}

string CallDeviceActionAsyncResponse::GetStatus() const
{
    return m_status;
}

bool CallDeviceActionAsyncResponse::StatusHasBeenSet() const
{
