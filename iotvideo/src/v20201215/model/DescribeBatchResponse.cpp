...
CoreInternalOutcome DescribeBatchResponse::Deserialize(const string &payload)
{
...
string DescribeBatchResponse::ToJsonString() const
{
...
VideoBatch DescribeBatchResponse::GetData() const
{
    return m_data;
}

bool DescribeBatchResponse::DataHasBeenSet() const
{
