...
CoreInternalOutcome DescribeSDKLogResponse::Deserialize(const string &payload)
{
...
string DescribeSDKLogResponse::ToJsonString() const
{
...
string DescribeSDKLogResponse::GetContext() const
{
    return m_context;
}

bool DescribeSDKLogResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool DescribeSDKLogResponse::GetListover() const
{
    return m_listover;
}

bool DescribeSDKLogResponse::ListoverHasBeenSet() const
{
    return m_listoverHasBeenSet;
}

vector<SDKLogItem> DescribeSDKLogResponse::GetResults() const
{
    return m_results;
}

bool DescribeSDKLogResponse::ResultsHasBeenSet() const
{
