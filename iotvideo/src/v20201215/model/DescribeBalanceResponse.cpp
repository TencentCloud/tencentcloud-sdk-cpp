...
CoreInternalOutcome DescribeBalanceResponse::Deserialize(const string &payload)
{
...
string DescribeBalanceResponse::ToJsonString() const
{
...
uint64_t DescribeBalanceResponse::GetBalance() const
{
    return m_balance;
}

bool DescribeBalanceResponse::BalanceHasBeenSet() const
{
