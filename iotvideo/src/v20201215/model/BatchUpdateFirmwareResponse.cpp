...
CoreInternalOutcome BatchUpdateFirmwareResponse::Deserialize(const string &payload)
{
...
string BatchUpdateFirmwareResponse::ToJsonString() const
{
...
uint64_t BatchUpdateFirmwareResponse::GetTaskId() const
{
    return m_taskId;
}

bool BatchUpdateFirmwareResponse::TaskIdHasBeenSet() const
{
