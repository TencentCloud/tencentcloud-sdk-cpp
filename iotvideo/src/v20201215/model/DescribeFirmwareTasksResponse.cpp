...
CoreInternalOutcome DescribeFirmwareTasksResponse::Deserialize(const string &payload)
{
...
string DescribeFirmwareTasksResponse::ToJsonString() const
{
...
vector<FirmwareTaskInfo> DescribeFirmwareTasksResponse::GetTaskInfos() const
{
    return m_taskInfos;
}

bool DescribeFirmwareTasksResponse::TaskInfosHasBeenSet() const
{
    return m_taskInfosHasBeenSet;
}

uint64_t DescribeFirmwareTasksResponse::GetTotal() const
{
    return m_total;
}

bool DescribeFirmwareTasksResponse::TotalHasBeenSet() const
{
