...
CoreInternalOutcome DescribeCategoryResponse::Deserialize(const string &payload)
{
...
string DescribeCategoryResponse::ToJsonString() const
{
...
ProductTemplate DescribeCategoryResponse::GetData() const
{
    return m_data;
}

bool DescribeCategoryResponse::DataHasBeenSet() const
{
