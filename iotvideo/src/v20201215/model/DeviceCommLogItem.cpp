...
CoreInternalOutcome DeviceCommLogItem::Deserialize(const Value &value)
{
    string requestId = "";
...
void DeviceCommLogItem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
