...
CoreInternalOutcome ControlDeviceDataResponse::Deserialize(const string &payload)
{
...
string ControlDeviceDataResponse::ToJsonString() const
{
...
string ControlDeviceDataResponse::GetData() const
{
    return m_data;
}
