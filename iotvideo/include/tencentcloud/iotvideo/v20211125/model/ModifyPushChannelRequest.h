...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPUSHCHANNELREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPUSHCHANNELREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class ModifyPushChannelRequest : public AbstractModel
                {
                public:
                    ModifyPushChannelRequest();
                    ~ModifyPushChannelRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPUSHCHANNELREQUEST_H_
