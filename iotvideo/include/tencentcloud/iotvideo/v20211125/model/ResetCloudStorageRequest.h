...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_RESETCLOUDSTORAGEREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_RESETCLOUDSTORAGEREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class ResetCloudStorageRequest : public AbstractModel
                {
                public:
                    ResetCloudStorageRequest();
                    ~ResetCloudStorageRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_RESETCLOUDSTORAGEREQUEST_H_
