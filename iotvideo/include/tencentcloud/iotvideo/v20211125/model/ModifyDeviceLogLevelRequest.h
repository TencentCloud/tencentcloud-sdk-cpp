...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYDEVICELOGLEVELREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYDEVICELOGLEVELREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class ModifyDeviceLogLevelRequest : public AbstractModel
                {
                public:
                    ModifyDeviceLogLevelRequest();
                    ~ModifyDeviceLogLevelRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYDEVICELOGLEVELREQUEST_H_
