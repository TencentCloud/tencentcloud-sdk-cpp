...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPRODUCTDYNAMICREGISTERRESPONSE_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPRODUCTDYNAMICREGISTERRESPONSE_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class ModifyProductDynamicRegisterResponse : public AbstractModel
                {
                public:
                    ModifyProductDynamicRegisterResponse();
                    ~ModifyProductDynamicRegisterResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_MODIFYPRODUCTDYNAMICREGISTERRESPONSE_H_
