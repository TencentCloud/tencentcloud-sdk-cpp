...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_DESCRIBEPUSHCHANNELRESPONSE_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_DESCRIBEPUSHCHANNELRESPONSE_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class DescribePushChannelResponse : public AbstractModel
                {
                public:
                    DescribePushChannelResponse();
                    ~DescribePushChannelResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ForwardKey 第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_DESCRIBEPUSHCHANNELRESPONSE_H_
