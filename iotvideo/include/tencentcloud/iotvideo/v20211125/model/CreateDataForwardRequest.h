...
#ifndef TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_CREATEDATAFORWARDREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_CREATEDATAFORWARDREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20211125
        {
            namespace Model
            {
                ...
                */
                class CreateDataForwardRequest : public AbstractModel
                {
                public:
                    CreateDataForwardRequest();
                    ~CreateDataForwardRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20211125_MODEL_CREATEDATAFORWARDREQUEST_H_
