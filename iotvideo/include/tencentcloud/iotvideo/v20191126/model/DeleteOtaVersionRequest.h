...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEOTAVERSIONREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEOTAVERSIONREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                */
                class DeleteOtaVersionRequest : public AbstractModel
                {
                public:
                    DeleteOtaVersionRequest();
                    ~DeleteOtaVersionRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEOTAVERSIONREQUEST_H_
