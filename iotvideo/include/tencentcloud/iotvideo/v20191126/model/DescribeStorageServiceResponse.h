...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DESCRIBESTORAGESERVICERESPONSE_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DESCRIBESTORAGESERVICERESPONSE_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                */
                class DescribeStorageServiceResponse : public AbstractModel
                {
                public:
                    DescribeStorageServiceResponse();
                    ~DescribeStorageServiceResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DESCRIBESTORAGESERVICERESPONSE_H_
