...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_REFUNDSTORAGESERVICERESPONSE_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_REFUNDSTORAGESERVICERESPONSE_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                */
                class RefundStorageServiceResponse : public AbstractModel
                {
                public:
                    RefundStorageServiceResponse();
                    ~RefundStorageServiceResponse() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_REFUNDSTORAGESERVICERESPONSE_H_
