...
#ifndef TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_CANCELDEVICEFIRMWARETASKREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_CANCELDEVICEFIRMWARETASKREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20201215
        {
            namespace Model
            {
                ...
                */
                class CancelDeviceFirmwareTaskRequest : public AbstractModel
                {
                public:
                    CancelDeviceFirmwareTaskRequest();
                    ~CancelDeviceFirmwareTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_CANCELDEVICEFIRMWARETASKREQUEST_H_
