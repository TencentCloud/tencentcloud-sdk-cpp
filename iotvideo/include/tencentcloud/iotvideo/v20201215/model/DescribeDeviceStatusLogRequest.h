...
#ifndef TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_DESCRIBEDEVICESTATUSLOGREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_DESCRIBEDEVICESTATUSLOGREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20201215
        {
            namespace Model
            {
                ...
                */
                class DescribeDeviceStatusLogRequest : public AbstractModel
                {
                public:
                    DescribeDeviceStatusLogRequest();
                    ~DescribeDeviceStatusLogRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20201215_MODEL_DESCRIBEDEVICESTATUSLOGREQUEST_H_
