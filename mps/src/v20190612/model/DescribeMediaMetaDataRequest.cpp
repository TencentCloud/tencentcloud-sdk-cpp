...
string DescribeMediaMetaDataRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
MediaInputInfo DescribeMediaMetaDataRequest::GetInputInfo() const
{
    return m_inputInfo;
}

void DescribeMediaMetaDataRequest::SetInputInfo(const MediaInputInfo& _inputInfo)
{
