...
AdaptiveDynamicStreamingTaskInput::AdaptiveDynamicStreamingTaskInput() :
    ...
    m_subStreamManifestObjectNameHasBeenSet(false),
...
CoreInternalOutcome AdaptiveDynamicStreamingTaskInput::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("SubStreamManifestObjectName") && !value["SubStreamManifestObjectName"].IsNull())
    {
        if (!value["SubStreamManifestObjectName"].IsString())
        {
            return CoreInternalOutcome(Error("response `AdaptiveDynamicStreamingTaskInput.SubStreamManifestObjectName` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_subStreamManifestObjectName = string(value["SubStreamManifestObjectName"].GetString());
        m_subStreamManifestObjectNameHasBeenSet = true;
    }
    ...
    if (value.HasMember("ObjectNumberFormat") && !value["ObjectNumberFormat"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AdaptiveDynamicStreamingTaskInput.ObjectNumberFormat` is not object type").SetRequestId(requestId));
        }
...
void AdaptiveDynamicStreamingTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_subStreamManifestObjectNameHasBeenSet)
    {
        Value iKey(kStringType);
        string key = "SubStreamManifestObjectName";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_subStreamManifestObjectName.c_str(), allocator).Move(), allocator);
    }
...
string AdaptiveDynamicStreamingTaskInput::GetSubStreamManifestObjectName() const
{
    return m_subStreamManifestObjectName;
}

void AdaptiveDynamicStreamingTaskInput::SetSubStreamManifestObjectName(const string& _subStreamManifestObjectName)
{
    m_subStreamManifestObjectName = _subStreamManifestObjectName;
    m_subStreamManifestObjectNameHasBeenSet = true;
}

bool AdaptiveDynamicStreamingTaskInput::SubStreamManifestObjectNameHasBeenSet() const
{
    return m_subStreamManifestObjectNameHasBeenSet;
}
...
NumberFormat AdaptiveDynamicStreamingTaskInput::GetObjectNumberFormat() const
{
    return m_objectNumberFormat;
}

void AdaptiveDynamicStreamingTaskInput::SetObjectNumberFormat(const NumberFormat& _objectNumberFormat)
{
    m_objectNumberFormat = _objectNumberFormat;
    m_objectNumberFormatHasBeenSet = true;
}

bool AdaptiveDynamicStreamingTaskInput::ObjectNumberFormatHasBeenSet() const
{
