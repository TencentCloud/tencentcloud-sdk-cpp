...
CoreInternalOutcome AiRecognitionTaskAsrWordsResultItem::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiRecognitionTaskAsrWordsResultItem::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
