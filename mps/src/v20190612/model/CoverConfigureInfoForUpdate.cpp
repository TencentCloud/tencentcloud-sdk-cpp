...
string CoverConfigureInfoForUpdate::GetSwitch() const
{
    return m_switch;
}

void CoverConfigureInfoForUpdate::SetSwitch(const string& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool CoverConfigureInfoForUpdate::SwitchHasBeenSet() const
{
