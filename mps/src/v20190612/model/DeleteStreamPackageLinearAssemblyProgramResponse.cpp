...
CoreInternalOutcome DeleteStreamPackageLinearAssemblyProgramResponse::Deserialize(const string &payload)
{
...
string DeleteStreamPackageLinearAssemblyProgramResponse::ToJsonString() const
{
