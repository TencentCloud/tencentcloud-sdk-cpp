...
CoreInternalOutcome OverrideEraseParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EraseType") && !value["EraseType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideEraseParameter.EraseType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseSubtitleConfig") && !value["EraseSubtitleConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideEraseParameter.EraseSubtitleConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EraseWatermarkConfig") && !value["EraseWatermarkConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideEraseParameter.EraseWatermarkConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErasePrivacyConfig") && !value["ErasePrivacyConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideEraseParameter.ErasePrivacyConfig` is not object type").SetRequestId(requestId));
        }
...
void OverrideEraseParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string OverrideEraseParameter::GetEraseType() const
{
    return m_eraseType;
}

void OverrideEraseParameter::SetEraseType(const string& _eraseType)
{
    m_eraseType = _eraseType;
    m_eraseTypeHasBeenSet = true;
}

bool OverrideEraseParameter::EraseTypeHasBeenSet() const
{
    return m_eraseTypeHasBeenSet;
}

UpdateSmartEraseSubtitleConfig OverrideEraseParameter::GetEraseSubtitleConfig() const
{
    return m_eraseSubtitleConfig;
}

void OverrideEraseParameter::SetEraseSubtitleConfig(const UpdateSmartEraseSubtitleConfig& _eraseSubtitleConfig)
{
    m_eraseSubtitleConfig = _eraseSubtitleConfig;
    m_eraseSubtitleConfigHasBeenSet = true;
}

bool OverrideEraseParameter::EraseSubtitleConfigHasBeenSet() const
{
    return m_eraseSubtitleConfigHasBeenSet;
}

UpdateSmartEraseWatermarkConfig OverrideEraseParameter::GetEraseWatermarkConfig() const
{
    return m_eraseWatermarkConfig;
}

void OverrideEraseParameter::SetEraseWatermarkConfig(const UpdateSmartEraseWatermarkConfig& _eraseWatermarkConfig)
{
    m_eraseWatermarkConfig = _eraseWatermarkConfig;
    m_eraseWatermarkConfigHasBeenSet = true;
}

bool OverrideEraseParameter::EraseWatermarkConfigHasBeenSet() const
{
    return m_eraseWatermarkConfigHasBeenSet;
}

UpdateSmartErasePrivacyConfig OverrideEraseParameter::GetErasePrivacyConfig() const
{
    return m_erasePrivacyConfig;
}

void OverrideEraseParameter::SetErasePrivacyConfig(const UpdateSmartErasePrivacyConfig& _erasePrivacyConfig)
{
