...
CoreInternalOutcome DeleteQualityControlTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteQualityControlTemplateResponse::ToJsonString() const
{
