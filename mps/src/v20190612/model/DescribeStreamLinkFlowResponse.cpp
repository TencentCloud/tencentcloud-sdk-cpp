...
CoreInternalOutcome DescribeStreamLinkFlowResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkFlowResponse::ToJsonString() const
{
...
DescribeFlow DescribeStreamLinkFlowResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLinkFlowResponse::InfoHasBeenSet() const
{
