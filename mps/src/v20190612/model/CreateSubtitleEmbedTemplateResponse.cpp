...
CoreInternalOutcome CreateSubtitleEmbedTemplateResponse::Deserialize(const string &payload)
{
...
string CreateSubtitleEmbedTemplateResponse::ToJsonString() const
{
...
int64_t CreateSubtitleEmbedTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateSubtitleEmbedTemplateResponse::DefinitionHasBeenSet() const
{
