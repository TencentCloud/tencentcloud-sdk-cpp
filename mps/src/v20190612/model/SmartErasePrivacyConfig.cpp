...
CoreInternalOutcome SmartErasePrivacyConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("PrivacyModel") && !value["PrivacyModel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SmartErasePrivacyConfig.PrivacyModel` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PrivacyTargets") && !value["PrivacyTargets"].IsNull())
    {
        if (!value["PrivacyTargets"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SmartErasePrivacyConfig.PrivacyTargets` is not array type"));
...
void SmartErasePrivacyConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string SmartErasePrivacyConfig::GetPrivacyModel() const
{
    return m_privacyModel;
}

void SmartErasePrivacyConfig::SetPrivacyModel(const string& _privacyModel)
{
    m_privacyModel = _privacyModel;
    m_privacyModelHasBeenSet = true;
}

bool SmartErasePrivacyConfig::PrivacyModelHasBeenSet() const
{
    return m_privacyModelHasBeenSet;
}

vector<string> SmartErasePrivacyConfig::GetPrivacyTargets() const
{
    return m_privacyTargets;
}

void SmartErasePrivacyConfig::SetPrivacyTargets(const vector<string>& _privacyTargets)
{
    m_privacyTargets = _privacyTargets;
    m_privacyTargetsHasBeenSet = true;
}

bool SmartErasePrivacyConfig::PrivacyTargetsHasBeenSet() const
{
