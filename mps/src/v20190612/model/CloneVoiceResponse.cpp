...
CloneVoiceResponse::CloneVoiceResponse() :
...
CoreInternalOutcome CloneVoiceResponse::Deserialize(const string &payload)
{
...
string CloneVoiceResponse::ToJsonString() const
{
...
int64_t CloneVoiceResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool CloneVoiceResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string CloneVoiceResponse::GetMsg() const
{
    return m_msg;
}

bool CloneVoiceResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string CloneVoiceResponse::GetVoiceId() const
{
    return m_voiceId;
}

bool CloneVoiceResponse::VoiceIdHasBeenSet() const
{
    return m_voiceIdHasBeenSet;
}

string CloneVoiceResponse::GetAudioData() const
{
    return m_audioData;
}

bool CloneVoiceResponse::AudioDataHasBeenSet() const
{
    return m_audioDataHasBeenSet;
}

string CloneVoiceResponse::GetAudioUrl() const
{
    return m_audioUrl;
}
