...
CoreInternalOutcome AiReviewPornOcrTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Definition") && !value["Definition"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `AiReviewPornOcrTaskInput.Definition` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
void AiReviewPornOcrTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
