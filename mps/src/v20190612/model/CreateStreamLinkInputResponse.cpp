...
CoreInternalOutcome CreateStreamLinkInputResponse::Deserialize(const string &payload)
{
...
string CreateStreamLinkInputResponse::ToJsonString() const
{
...
DescribeFlow CreateStreamLinkInputResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamLinkInputResponse::InfoHasBeenSet() const
{
