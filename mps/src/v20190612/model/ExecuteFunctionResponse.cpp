...
CoreInternalOutcome ExecuteFunctionResponse::Deserialize(const string &payload)
{
...
string ExecuteFunctionResponse::ToJsonString() const
{
...
string ExecuteFunctionResponse::GetResult() const
{
    return m_result;
}

bool ExecuteFunctionResponse::ResultHasBeenSet() const
{
