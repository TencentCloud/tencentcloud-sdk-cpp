...
CoreInternalOutcome AiAnalysisTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiAnalysisTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
