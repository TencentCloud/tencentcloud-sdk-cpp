...
string DeleteAsrHotwordsRequest::ToJsonString() const
{
...
string DeleteAsrHotwordsRequest::GetHotwordsId() const
{
    return m_hotwordsId;
}

void DeleteAsrHotwordsRequest::SetHotwordsId(const string& _hotwordsId)
{
    m_hotwordsId = _hotwordsId;
    m_hotwordsIdHasBeenSet = true;
}

bool DeleteAsrHotwordsRequest::HotwordsIdHasBeenSet() const
{
