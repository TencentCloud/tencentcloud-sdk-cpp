...
string TextToSpeechRequest::GetVoiceId() const
{
    return m_voiceId;
}

void TextToSpeechRequest::SetVoiceId(const string& _voiceId)
{
    m_voiceId = _voiceId;
    m_voiceIdHasBeenSet = true;
}

bool TextToSpeechRequest::VoiceIdHasBeenSet() const
{
    return m_voiceIdHasBeenSet;
}

string TextToSpeechRequest::GetTextLang() const
{
    return m_textLang;
}

void TextToSpeechRequest::SetTextLang(const string& _textLang)
{
    m_textLang = _textLang;
    m_textLangHasBeenSet = true;
}

bool TextToSpeechRequest::TextLangHasBeenSet() const
{
    return m_textLangHasBeenSet;
}

SyncDubbingOutputOption TextToSpeechRequest::GetOutput() const
{
    return m_output;
}

void TextToSpeechRequest::SetOutput(const SyncDubbingOutputOption& _output)
{
    m_output = _output;
    m_outputHasBeenSet = true;
}

bool TextToSpeechRequest::OutputHasBeenSet() const
{
    return m_outputHasBeenSet;
}

string TextToSpeechRequest::GetExtParam() const
{
    return m_extParam;
}

void TextToSpeechRequest::SetExtParam(const string& _extParam)
{
    m_extParam = _extParam;
    m_extParamHasBeenSet = true;
}

bool TextToSpeechRequest::ExtParamHasBeenSet() const
{
