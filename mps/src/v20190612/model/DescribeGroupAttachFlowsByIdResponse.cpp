...
DescribeGroupAttachFlowsByIdResponse::DescribeGroupAttachFlowsByIdResponse() :
    m_infosHasBeenSet(false)
{
}

CoreInternalOutcome DescribeGroupAttachFlowsByIdResponse::Deserialize(const string &payload)
{
...
string DescribeGroupAttachFlowsByIdResponse::ToJsonString() const
{
...
vector<FlowInOutResp> DescribeGroupAttachFlowsByIdResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeGroupAttachFlowsByIdResponse::InfosHasBeenSet() const
{
