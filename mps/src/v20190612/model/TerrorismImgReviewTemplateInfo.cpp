...
CoreInternalOutcome TerrorismImgReviewTemplateInfo::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Switch") && !value["Switch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TerrorismImgReviewTemplateInfo.Switch` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LabelSet") && !value["LabelSet"].IsNull())
    {
        if (!value["LabelSet"].IsArray())
            return CoreInternalOutcome(Core::Error("response `TerrorismImgReviewTemplateInfo.LabelSet` is not array type"));
    ...
    if (value.HasMember("BlockConfidence") && !value["BlockConfidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TerrorismImgReviewTemplateInfo.BlockConfidence` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ReviewConfidence") && !value["ReviewConfidence"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TerrorismImgReviewTemplateInfo.ReviewConfidence` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
string TerrorismImgReviewTemplateInfo::GetSwitch() const
{
    return m_switch;
}

void TerrorismImgReviewTemplateInfo::SetSwitch(const string& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool TerrorismImgReviewTemplateInfo::SwitchHasBeenSet() const
{
    return m_switchHasBeenSet;
}

vector<string> TerrorismImgReviewTemplateInfo::GetLabelSet() const
{
    return m_labelSet;
}

void TerrorismImgReviewTemplateInfo::SetLabelSet(const vector<string>& _labelSet)
{
    m_labelSet = _labelSet;
    m_labelSetHasBeenSet = true;
}

bool TerrorismImgReviewTemplateInfo::LabelSetHasBeenSet() const
{
    return m_labelSetHasBeenSet;
}

int64_t TerrorismImgReviewTemplateInfo::GetBlockConfidence() const
{
    return m_blockConfidence;
}

void TerrorismImgReviewTemplateInfo::SetBlockConfidence(const int64_t& _blockConfidence)
{
    m_blockConfidence = _blockConfidence;
    m_blockConfidenceHasBeenSet = true;
}

bool TerrorismImgReviewTemplateInfo::BlockConfidenceHasBeenSet() const
{
    return m_blockConfidenceHasBeenSet;
}

int64_t TerrorismImgReviewTemplateInfo::GetReviewConfidence() const
{
    return m_reviewConfidence;
}

void TerrorismImgReviewTemplateInfo::SetReviewConfidence(const int64_t& _reviewConfidence)
{
    m_reviewConfidence = _reviewConfidence;
    m_reviewConfidenceHasBeenSet = true;
}

bool TerrorismImgReviewTemplateInfo::ReviewConfidenceHasBeenSet() const
{
