...
DocToVideoCosInfo::DocToVideoCosInfo() :
...
CoreInternalOutcome DocToVideoCosInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CosBucketRegion") && !value["CosBucketRegion"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DocToVideoCosInfo.CosBucketRegion` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CosBucketName") && !value["CosBucketName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DocToVideoCosInfo.CosBucketName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CosBucketPath") && !value["CosBucketPath"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DocToVideoCosInfo.CosBucketPath` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void DocToVideoCosInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string DocToVideoCosInfo::GetCosBucketRegion() const
{
    return m_cosBucketRegion;
}

void DocToVideoCosInfo::SetCosBucketRegion(const string& _cosBucketRegion)
{
    m_cosBucketRegion = _cosBucketRegion;
    m_cosBucketRegionHasBeenSet = true;
}

bool DocToVideoCosInfo::CosBucketRegionHasBeenSet() const
{
    return m_cosBucketRegionHasBeenSet;
}

string DocToVideoCosInfo::GetCosBucketName() const
{
    return m_cosBucketName;
}

void DocToVideoCosInfo::SetCosBucketName(const string& _cosBucketName)
{
    m_cosBucketName = _cosBucketName;
    m_cosBucketNameHasBeenSet = true;
}

bool DocToVideoCosInfo::CosBucketNameHasBeenSet() const
{
    return m_cosBucketNameHasBeenSet;
}

string DocToVideoCosInfo::GetCosBucketPath() const
{
    return m_cosBucketPath;
}

void DocToVideoCosInfo::SetCosBucketPath(const string& _cosBucketPath)
{
    m_cosBucketPath = _cosBucketPath;
    m_cosBucketPathHasBeenSet = true;
}

bool DocToVideoCosInfo::CosBucketPathHasBeenSet() const
{
