...
string DescribeAIRecognitionTemplatesRequest::GetName() const
{
    return m_name;
}

void DescribeAIRecognitionTemplatesRequest::SetName(const string& _name)
{
    m_name = _name;
    m_nameHasBeenSet = true;
}

bool DescribeAIRecognitionTemplatesRequest::NameHasBeenSet() const
{
