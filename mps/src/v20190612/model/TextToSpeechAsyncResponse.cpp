...
int64_t TextToSpeechAsyncResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool TextToSpeechAsyncResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string TextToSpeechAsyncResponse::GetMsg() const
{
    return m_msg;
}

bool TextToSpeechAsyncResponse::MsgHasBeenSet() const
{
