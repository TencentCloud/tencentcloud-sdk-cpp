...
CoreInternalOutcome UserDefineOcrTextReviewTemplateInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void UserDefineOcrTextReviewTemplateInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
