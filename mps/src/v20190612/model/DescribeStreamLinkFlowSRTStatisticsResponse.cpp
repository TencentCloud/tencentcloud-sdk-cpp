...
CoreInternalOutcome DescribeStreamLinkFlowSRTStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkFlowSRTStatisticsResponse::ToJsonString() const
{
...
vector<FlowSRTInfo> DescribeStreamLinkFlowSRTStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkFlowSRTStatisticsResponse::InfosHasBeenSet() const
{
