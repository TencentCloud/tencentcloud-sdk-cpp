...
DescribeStreamLinkEventsResponse::DescribeStreamLinkEventsResponse() :
...
CoreInternalOutcome DescribeStreamLinkEventsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkEventsResponse::ToJsonString() const
{
...
vector<DescribeEvent> DescribeStreamLinkEventsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkEventsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

int64_t DescribeStreamLinkEventsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamLinkEventsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

int64_t DescribeStreamLinkEventsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamLinkEventsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t DescribeStreamLinkEventsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamLinkEventsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

int64_t DescribeStreamLinkEventsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamLinkEventsResponse::TotalPageHasBeenSet() const
{
