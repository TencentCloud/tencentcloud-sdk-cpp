...
CoreInternalOutcome DeleteVoiceResponse::Deserialize(const string &payload)
{
...
string DeleteVoiceResponse::ToJsonString() const
{
...
int64_t DeleteVoiceResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DeleteVoiceResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DeleteVoiceResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteVoiceResponse::MsgHasBeenSet() const
{
