...
CoreInternalOutcome CreateSmartSubtitleTemplateResponse::Deserialize(const string &payload)
{
...
string CreateSmartSubtitleTemplateResponse::ToJsonString() const
{
...
int64_t CreateSmartSubtitleTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateSmartSubtitleTemplateResponse::DefinitionHasBeenSet() const
{
