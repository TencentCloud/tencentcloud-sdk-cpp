...
CoreInternalOutcome CreateAsrHotwordsResponse::Deserialize(const string &payload)
{
...
string CreateAsrHotwordsResponse::ToJsonString() const
{
...
string CreateAsrHotwordsResponse::GetHotwordsId() const
{
    return m_hotwordsId;
}

bool CreateAsrHotwordsResponse::HotwordsIdHasBeenSet() const
{
