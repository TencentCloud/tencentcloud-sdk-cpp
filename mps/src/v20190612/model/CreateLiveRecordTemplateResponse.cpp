...
CoreInternalOutcome CreateLiveRecordTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLiveRecordTemplateResponse::ToJsonString() const
{
...
int64_t CreateLiveRecordTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateLiveRecordTemplateResponse::DefinitionHasBeenSet() const
{
