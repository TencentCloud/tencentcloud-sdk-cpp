...
CoreInternalOutcome DescribeStreamLinkFlowMediaStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkFlowMediaStatisticsResponse::ToJsonString() const
{
...
vector<FlowMediaInfo> DescribeStreamLinkFlowMediaStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkFlowMediaStatisticsResponse::InfosHasBeenSet() const
{
