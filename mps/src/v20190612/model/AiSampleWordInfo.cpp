...
CoreInternalOutcome AiSampleWordInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiSampleWordInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
