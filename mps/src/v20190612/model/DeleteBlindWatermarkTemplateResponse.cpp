...
CoreInternalOutcome DeleteBlindWatermarkTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteBlindWatermarkTemplateResponse::ToJsonString() const
{
