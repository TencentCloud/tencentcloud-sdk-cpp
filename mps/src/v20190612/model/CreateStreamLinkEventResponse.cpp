...
CreateStreamLinkEventResponse::CreateStreamLinkEventResponse() :
    m_infoHasBeenSet(false)
{
}

CoreInternalOutcome CreateStreamLinkEventResponse::Deserialize(const string &payload)
{
...
string CreateStreamLinkEventResponse::ToJsonString() const
{
...
DescribeEvent CreateStreamLinkEventResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamLinkEventResponse::InfoHasBeenSet() const
{
