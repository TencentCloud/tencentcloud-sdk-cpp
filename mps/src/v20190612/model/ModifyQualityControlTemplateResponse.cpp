...
CoreInternalOutcome ModifyQualityControlTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyQualityControlTemplateResponse::ToJsonString() const
{
