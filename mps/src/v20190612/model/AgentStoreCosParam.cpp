...
AgentStoreCosParam::AgentStoreCosParam() :
...
CoreInternalOutcome AgentStoreCosParam::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("CosBucketName") && !value["CosBucketName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AgentStoreCosParam.CosBucketName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CosBucketRegion") && !value["CosBucketRegion"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AgentStoreCosParam.CosBucketRegion` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CosBucketPath") && !value["CosBucketPath"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AgentStoreCosParam.CosBucketPath` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void AgentStoreCosParam::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string AgentStoreCosParam::GetCosBucketName() const
{
    return m_cosBucketName;
}

void AgentStoreCosParam::SetCosBucketName(const string& _cosBucketName)
{
    m_cosBucketName = _cosBucketName;
    m_cosBucketNameHasBeenSet = true;
}

bool AgentStoreCosParam::CosBucketNameHasBeenSet() const
{
    return m_cosBucketNameHasBeenSet;
}

string AgentStoreCosParam::GetCosBucketRegion() const
{
    return m_cosBucketRegion;
}

void AgentStoreCosParam::SetCosBucketRegion(const string& _cosBucketRegion)
{
    m_cosBucketRegion = _cosBucketRegion;
    m_cosBucketRegionHasBeenSet = true;
}

bool AgentStoreCosParam::CosBucketRegionHasBeenSet() const
{
    return m_cosBucketRegionHasBeenSet;
}

string AgentStoreCosParam::GetCosBucketPath() const
{
    return m_cosBucketPath;
}

void AgentStoreCosParam::SetCosBucketPath(const string& _cosBucketPath)
{
    m_cosBucketPath = _cosBucketPath;
    m_cosBucketPathHasBeenSet = true;
}

bool AgentStoreCosParam::CosBucketPathHasBeenSet() const
{
