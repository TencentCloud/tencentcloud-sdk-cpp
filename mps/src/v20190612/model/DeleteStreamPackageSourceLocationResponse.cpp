...
CoreInternalOutcome DeleteStreamPackageSourceLocationResponse::Deserialize(const string &payload)
{
...
string DeleteStreamPackageSourceLocationResponse::ToJsonString() const
{
