...
CoreInternalOutcome ModifyAdaptiveDynamicStreamingTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyAdaptiveDynamicStreamingTemplateResponse::ToJsonString() const
{
