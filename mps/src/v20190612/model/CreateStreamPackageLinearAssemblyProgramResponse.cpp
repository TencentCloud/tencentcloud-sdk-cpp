...
CoreInternalOutcome CreateStreamPackageLinearAssemblyProgramResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageLinearAssemblyProgramResponse::ToJsonString() const
{
...
LinearAssemblyProgramInfo CreateStreamPackageLinearAssemblyProgramResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageLinearAssemblyProgramResponse::InfoHasBeenSet() const
{
