...
CoreInternalOutcome DescribeMediaMetaDataResponse::Deserialize(const string &payload)
{
...
string DescribeMediaMetaDataResponse::ToJsonString() const
{
...
MediaMetaData DescribeMediaMetaDataResponse::GetMetaData() const
{
    return m_metaData;
}

bool DescribeMediaMetaDataResponse::MetaDataHasBeenSet() const
{
