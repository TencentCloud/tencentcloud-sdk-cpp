...
DescribeStreamLinkSecurityGroupsResponse::DescribeStreamLinkSecurityGroupsResponse() :
    m_infosHasBeenSet(false)
{
}

CoreInternalOutcome DescribeStreamLinkSecurityGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkSecurityGroupsResponse::ToJsonString() const
{
...
vector<SecurityGroupInfo> DescribeStreamLinkSecurityGroupsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkSecurityGroupsResponse::InfosHasBeenSet() const
{
