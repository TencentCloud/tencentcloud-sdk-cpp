...
CoreInternalOutcome CreateBlindWatermarkTemplateResponse::Deserialize(const string &payload)
{
...
string CreateBlindWatermarkTemplateResponse::ToJsonString() const
{
...
int64_t CreateBlindWatermarkTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateBlindWatermarkTemplateResponse::DefinitionHasBeenSet() const
{
