...
string DeleteVoiceRequest::ToJsonString() const
{
...
string DeleteVoiceRequest::GetVoiceId() const
{
    return m_voiceId;
}

void DeleteVoiceRequest::SetVoiceId(const string& _voiceId)
{
    m_voiceId = _voiceId;
    m_voiceIdHasBeenSet = true;
}

bool DeleteVoiceRequest::VoiceIdHasBeenSet() const
{
    return m_voiceIdHasBeenSet;
}

string DeleteVoiceRequest::GetExtParam() const
{
    return m_extParam;
}

void DeleteVoiceRequest::SetExtParam(const string& _extParam)
{
    m_extParam = _extParam;
    m_extParamHasBeenSet = true;
}

bool DeleteVoiceRequest::ExtParamHasBeenSet() const
{
