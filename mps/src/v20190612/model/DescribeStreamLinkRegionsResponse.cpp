...
CoreInternalOutcome DescribeStreamLinkRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkRegionsResponse::ToJsonString() const
{
...
StreamLinkRegionInfo DescribeStreamLinkRegionsResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLinkRegionsResponse::InfoHasBeenSet() const
{
