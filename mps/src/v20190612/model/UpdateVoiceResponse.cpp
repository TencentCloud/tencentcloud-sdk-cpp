...
CoreInternalOutcome UpdateVoiceResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Voice"].IsObject())
        {
            return CoreInternalOutcome(Core::Error("response `Voice` is not object type").SetRequestId(requestId));
        }

        CoreInternalOutcome outcome = m_voice.Deserialize(rsp["Voice"]);
...
string UpdateVoiceResponse::ToJsonString() const
{
...
int64_t UpdateVoiceResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool UpdateVoiceResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string UpdateVoiceResponse::GetMsg() const
{
    return m_msg;
}

bool UpdateVoiceResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

VoiceInfo UpdateVoiceResponse::GetVoice() const
{
    return m_voice;
}

bool UpdateVoiceResponse::VoiceHasBeenSet() const
{
