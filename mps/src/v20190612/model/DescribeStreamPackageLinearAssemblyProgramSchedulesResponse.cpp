...
CoreInternalOutcome DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Infos") && !rsp["Infos"].IsNull())
    {
        ...
        {
            LinearAssemblyProgramInfo item;
...
string DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::ToJsonString() const
{
...
vector<LinearAssemblyProgramInfo> DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageLinearAssemblyProgramSchedulesResponse::TotalPageHasBeenSet() const
{
