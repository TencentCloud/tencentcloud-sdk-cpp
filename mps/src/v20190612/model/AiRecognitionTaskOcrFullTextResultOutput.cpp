...
CoreInternalOutcome AiRecognitionTaskOcrFullTextResultOutput::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiRecognitionTaskOcrFullTextResultOutput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
