...
CoreInternalOutcome ModifyStreamLinkOutputInfoResponse::Deserialize(const string &payload)
{
...
string ModifyStreamLinkOutputInfoResponse::ToJsonString() const
{
...
DescribeOutput ModifyStreamLinkOutputInfoResponse::GetInfo() const
{
    return m_info;
}

bool ModifyStreamLinkOutputInfoResponse::InfoHasBeenSet() const
{
