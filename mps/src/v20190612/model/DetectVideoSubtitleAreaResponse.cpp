...
CoreInternalOutcome DetectVideoSubtitleAreaResponse::Deserialize(const string &payload)
{
...
string DetectVideoSubtitleAreaResponse::ToJsonString() const
{
...
int64_t DetectVideoSubtitleAreaResponse::GetWidth() const
{
    return m_width;
}

bool DetectVideoSubtitleAreaResponse::WidthHasBeenSet() const
{
    return m_widthHasBeenSet;
}

int64_t DetectVideoSubtitleAreaResponse::GetHeight() const
{
    return m_height;
}

bool DetectVideoSubtitleAreaResponse::HeightHasBeenSet() const
{
    return m_heightHasBeenSet;
}

vector<SubtitleArea> DetectVideoSubtitleAreaResponse::GetResult() const
{
    return m_result;
}

bool DetectVideoSubtitleAreaResponse::ResultHasBeenSet() const
{
