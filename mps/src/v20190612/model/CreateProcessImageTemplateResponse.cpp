...
CoreInternalOutcome CreateProcessImageTemplateResponse::Deserialize(const string &payload)
{
...
string CreateProcessImageTemplateResponse::ToJsonString() const
{
...
int64_t CreateProcessImageTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateProcessImageTemplateResponse::DefinitionHasBeenSet() const
{
