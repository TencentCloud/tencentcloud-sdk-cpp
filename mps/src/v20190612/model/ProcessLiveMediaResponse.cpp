...
CoreInternalOutcome ProcessLiveMediaResponse::Deserialize(const string &payload)
{
    Document d;
...
string ProcessLiveMediaResponse::GetTaskId() const
{
    return m_taskId;
}

bool ProcessLiveMediaResponse::TaskIdHasBeenSet() const
{
