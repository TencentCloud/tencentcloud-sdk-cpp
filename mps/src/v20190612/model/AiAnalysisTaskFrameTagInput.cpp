...
CoreInternalOutcome AiAnalysisTaskFrameTagInput::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("ExtendedParameter") && !value["ExtendedParameter"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AiAnalysisTaskFrameTagInput.ExtendedParameter` IsString=false incorrectly").SetRequestId(requestId));
        }
...
uint64_t AiAnalysisTaskFrameTagInput::GetDefinition() const
{
    return m_definition;
}

void AiAnalysisTaskFrameTagInput::SetDefinition(const uint64_t& _definition)
{
    m_definition = _definition;
    m_definitionHasBeenSet = true;
}

bool AiAnalysisTaskFrameTagInput::DefinitionHasBeenSet() const
{
    return m_definitionHasBeenSet;
}

string AiAnalysisTaskFrameTagInput::GetExtendedParameter() const
{
    return m_extendedParameter;
}

void AiAnalysisTaskFrameTagInput::SetExtendedParameter(const string& _extendedParameter)
{
    m_extendedParameter = _extendedParameter;
    m_extendedParameterHasBeenSet = true;
}

bool AiAnalysisTaskFrameTagInput::ExtendedParameterHasBeenSet() const
{
