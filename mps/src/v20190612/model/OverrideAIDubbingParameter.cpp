...
OverrideAIDubbingParameter::OverrideAIDubbingParameter() :
...
CoreInternalOutcome OverrideAIDubbingParameter::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("TranslateConfig") && !value["TranslateConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideAIDubbingParameter.TranslateConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SubtitleConfig") && !value["SubtitleConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideAIDubbingParameter.SubtitleConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DubbingConfig") && !value["DubbingConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideAIDubbingParameter.DubbingConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OutputConfig") && !value["OutputConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `OverrideAIDubbingParameter.OutputConfig` is not object type").SetRequestId(requestId));
        }
...
void OverrideAIDubbingParameter::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
DubbingTranslateConfig OverrideAIDubbingParameter::GetTranslateConfig() const
{
    return m_translateConfig;
}

void OverrideAIDubbingParameter::SetTranslateConfig(const DubbingTranslateConfig& _translateConfig)
{
    m_translateConfig = _translateConfig;
    m_translateConfigHasBeenSet = true;
}

bool OverrideAIDubbingParameter::TranslateConfigHasBeenSet() const
{
    return m_translateConfigHasBeenSet;
}

DubbingSubtitleConfig OverrideAIDubbingParameter::GetSubtitleConfig() const
{
    return m_subtitleConfig;
}

void OverrideAIDubbingParameter::SetSubtitleConfig(const DubbingSubtitleConfig& _subtitleConfig)
{
    m_subtitleConfig = _subtitleConfig;
    m_subtitleConfigHasBeenSet = true;
}

bool OverrideAIDubbingParameter::SubtitleConfigHasBeenSet() const
{
    return m_subtitleConfigHasBeenSet;
}

DubbingConfig OverrideAIDubbingParameter::GetDubbingConfig() const
{
    return m_dubbingConfig;
}

void OverrideAIDubbingParameter::SetDubbingConfig(const DubbingConfig& _dubbingConfig)
{
    m_dubbingConfig = _dubbingConfig;
    m_dubbingConfigHasBeenSet = true;
}

bool OverrideAIDubbingParameter::DubbingConfigHasBeenSet() const
{
    return m_dubbingConfigHasBeenSet;
}

DubbingOutputConfig OverrideAIDubbingParameter::GetOutputConfig() const
{
    return m_outputConfig;
}

void OverrideAIDubbingParameter::SetOutputConfig(const DubbingOutputConfig& _outputConfig)
{
    m_outputConfig = _outputConfig;
    m_outputConfigHasBeenSet = true;
}

bool OverrideAIDubbingParameter::OutputConfigHasBeenSet() const
{
