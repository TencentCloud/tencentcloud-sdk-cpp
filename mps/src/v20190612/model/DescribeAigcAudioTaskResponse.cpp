...
CoreInternalOutcome DescribeAigcAudioTaskResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AudioInfos") && !rsp["AudioInfos"].IsNull())
    {
        if (!rsp["AudioInfos"].IsArray())
            return CoreInternalOutcome(Core::Error("response `AudioInfos` is not array type"));

        const rapidjson::Value &tmpValue = rsp["AudioInfos"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            AigcAudioOutputAudioInfo item;
...
string DescribeAigcAudioTaskResponse::ToJsonString() const
{
...
string DescribeAigcAudioTaskResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAigcAudioTaskResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeAigcAudioTaskResponse::GetMessage() const
{
    return m_message;
}

bool DescribeAigcAudioTaskResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

vector<AigcAudioOutputAudioInfo> DescribeAigcAudioTaskResponse::GetAudioInfos() const
{
    return m_audioInfos;
}

bool DescribeAigcAudioTaskResponse::AudioInfosHasBeenSet() const
{
    return m_audioInfosHasBeenSet;
}

vector<AigcAudioOutputVideoInfo> DescribeAigcAudioTaskResponse::GetVideoInfos() const
{
    return m_videoInfos;
}

bool DescribeAigcAudioTaskResponse::VideoInfosHasBeenSet() const
{
