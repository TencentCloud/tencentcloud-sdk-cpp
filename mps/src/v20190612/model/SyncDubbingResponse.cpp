...
CoreInternalOutcome SyncDubbingResponse::Deserialize(const string &payload)
{
...
string SyncDubbingResponse::ToJsonString() const
{
...
int64_t SyncDubbingResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool SyncDubbingResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string SyncDubbingResponse::GetMsg() const
{
    return m_msg;
}

bool SyncDubbingResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string SyncDubbingResponse::GetAudioData() const
{
    return m_audioData;
}

bool SyncDubbingResponse::AudioDataHasBeenSet() const
{
