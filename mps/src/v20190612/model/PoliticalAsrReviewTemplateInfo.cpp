...
CoreInternalOutcome PoliticalAsrReviewTemplateInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void PoliticalAsrReviewTemplateInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
