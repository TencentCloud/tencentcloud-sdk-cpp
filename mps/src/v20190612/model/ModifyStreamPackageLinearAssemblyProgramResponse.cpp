...
CoreInternalOutcome ModifyStreamPackageLinearAssemblyProgramResponse::Deserialize(const string &payload)
{
...
string ModifyStreamPackageLinearAssemblyProgramResponse::ToJsonString() const
{
