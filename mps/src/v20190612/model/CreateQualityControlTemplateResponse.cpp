...
CoreInternalOutcome CreateQualityControlTemplateResponse::Deserialize(const string &payload)
{
...
string CreateQualityControlTemplateResponse::ToJsonString() const
{
...
int64_t CreateQualityControlTemplateResponse::GetDefinition() const
{
    return m_definition;
}

bool CreateQualityControlTemplateResponse::DefinitionHasBeenSet() const
{
