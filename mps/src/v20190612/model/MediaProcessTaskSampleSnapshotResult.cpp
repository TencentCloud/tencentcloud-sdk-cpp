...
CoreInternalOutcome MediaProcessTaskSampleSnapshotResult::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Status") && !value["Status"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MediaProcessTaskSampleSnapshotResult.Status` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ErrCode") && !value["ErrCode"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MediaProcessTaskSampleSnapshotResult.ErrCode` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Message") && !value["Message"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MediaProcessTaskSampleSnapshotResult.Message` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Input") && !value["Input"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MediaProcessTaskSampleSnapshotResult.Input` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Output") && !value["Output"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `MediaProcessTaskSampleSnapshotResult.Output` is not object type").SetRequestId(requestId));
        }
...
void MediaProcessTaskSampleSnapshotResult::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
