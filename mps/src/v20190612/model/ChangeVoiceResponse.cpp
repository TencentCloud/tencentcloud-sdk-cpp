...
ChangeVoiceResponse::ChangeVoiceResponse() :
...
CoreInternalOutcome ChangeVoiceResponse::Deserialize(const string &payload)
{
...
string ChangeVoiceResponse::ToJsonString() const
{
...
int64_t ChangeVoiceResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool ChangeVoiceResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string ChangeVoiceResponse::GetMsg() const
{
    return m_msg;
}

bool ChangeVoiceResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string ChangeVoiceResponse::GetAudioData() const
{
    return m_audioData;
}

bool ChangeVoiceResponse::AudioDataHasBeenSet() const
{
    return m_audioDataHasBeenSet;
}

string ChangeVoiceResponse::GetAudioUrl() const
{
    return m_audioUrl;
}

bool ChangeVoiceResponse::AudioUrlHasBeenSet() const
{
