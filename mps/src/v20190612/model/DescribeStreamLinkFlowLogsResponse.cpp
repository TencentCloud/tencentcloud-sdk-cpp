...
CoreInternalOutcome DescribeStreamLinkFlowLogsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkFlowLogsResponse::ToJsonString() const
{
...
vector<FlowLogInfo> DescribeStreamLinkFlowLogsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkFlowLogsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

int64_t DescribeStreamLinkFlowLogsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamLinkFlowLogsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

int64_t DescribeStreamLinkFlowLogsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamLinkFlowLogsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t DescribeStreamLinkFlowLogsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamLinkFlowLogsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

int64_t DescribeStreamLinkFlowLogsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamLinkFlowLogsResponse::TotalPageHasBeenSet() const
{
