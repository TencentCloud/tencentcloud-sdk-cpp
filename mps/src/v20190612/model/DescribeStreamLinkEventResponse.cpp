...
DescribeStreamLinkEventResponse::DescribeStreamLinkEventResponse() :
    m_infoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeStreamLinkEventResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkEventResponse::ToJsonString() const
{
...
DescribeEvent DescribeStreamLinkEventResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLinkEventResponse::InfoHasBeenSet() const
{
