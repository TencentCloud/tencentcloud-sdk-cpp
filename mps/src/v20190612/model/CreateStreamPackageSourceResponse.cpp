...
CoreInternalOutcome CreateStreamPackageSourceResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageSourceResponse::ToJsonString() const
{
...
SourceInfo CreateStreamPackageSourceResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageSourceResponse::InfoHasBeenSet() const
{
