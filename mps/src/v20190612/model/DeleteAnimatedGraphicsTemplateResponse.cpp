...
CoreInternalOutcome DeleteAnimatedGraphicsTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteAnimatedGraphicsTemplateResponse::ToJsonString() const
{
