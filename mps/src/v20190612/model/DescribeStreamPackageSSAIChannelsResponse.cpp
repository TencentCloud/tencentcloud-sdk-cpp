...
CoreInternalOutcome DescribeStreamPackageSSAIChannelsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSSAIChannelsResponse::ToJsonString() const
{
...
vector<SSAIChannelInfo> DescribeStreamPackageSSAIChannelsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageSSAIChannelsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageSSAIChannelsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageSSAIChannelsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageSSAIChannelsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageSSAIChannelsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageSSAIChannelsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageSSAIChannelsResponse::TotalNumHasBeenSet() const
{
