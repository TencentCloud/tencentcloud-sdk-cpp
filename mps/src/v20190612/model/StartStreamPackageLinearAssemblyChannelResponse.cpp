...
CoreInternalOutcome StartStreamPackageLinearAssemblyChannelResponse::Deserialize(const string &payload)
{
...
string StartStreamPackageLinearAssemblyChannelResponse::ToJsonString() const
{
