...
CoreInternalOutcome SmartEraseWatermarkConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("WatermarkEraseMethod") && !value["WatermarkEraseMethod"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SmartEraseWatermarkConfig.WatermarkEraseMethod` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("WatermarkModel") && !value["WatermarkModel"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SmartEraseWatermarkConfig.WatermarkModel` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AutoAreas") && !value["AutoAreas"].IsNull())
    {
        if (!value["AutoAreas"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SmartEraseWatermarkConfig.AutoAreas` is not array type"));
    ...
    if (value.HasMember("CustomAreas") && !value["CustomAreas"].IsNull())
    {
        if (!value["CustomAreas"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SmartEraseWatermarkConfig.CustomAreas` is not array type"));
...
void SmartEraseWatermarkConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string SmartEraseWatermarkConfig::GetWatermarkEraseMethod() const
{
    return m_watermarkEraseMethod;
}

void SmartEraseWatermarkConfig::SetWatermarkEraseMethod(const string& _watermarkEraseMethod)
{
    m_watermarkEraseMethod = _watermarkEraseMethod;
    m_watermarkEraseMethodHasBeenSet = true;
}

bool SmartEraseWatermarkConfig::WatermarkEraseMethodHasBeenSet() const
{
    return m_watermarkEraseMethodHasBeenSet;
}

string SmartEraseWatermarkConfig::GetWatermarkModel() const
{
    return m_watermarkModel;
}

void SmartEraseWatermarkConfig::SetWatermarkModel(const string& _watermarkModel)
{
    m_watermarkModel = _watermarkModel;
    m_watermarkModelHasBeenSet = true;
}

bool SmartEraseWatermarkConfig::WatermarkModelHasBeenSet() const
{
    return m_watermarkModelHasBeenSet;
}

vector<EraseArea> SmartEraseWatermarkConfig::GetAutoAreas() const
{
    return m_autoAreas;
}

void SmartEraseWatermarkConfig::SetAutoAreas(const vector<EraseArea>& _autoAreas)
{
    m_autoAreas = _autoAreas;
    m_autoAreasHasBeenSet = true;
}

bool SmartEraseWatermarkConfig::AutoAreasHasBeenSet() const
{
    return m_autoAreasHasBeenSet;
}

vector<EraseTimeArea> SmartEraseWatermarkConfig::GetCustomAreas() const
{
    return m_customAreas;
}

void SmartEraseWatermarkConfig::SetCustomAreas(const vector<EraseTimeArea>& _customAreas)
{
    m_customAreas = _customAreas;
    m_customAreasHasBeenSet = true;
}

bool SmartEraseWatermarkConfig::CustomAreasHasBeenSet() const
{
