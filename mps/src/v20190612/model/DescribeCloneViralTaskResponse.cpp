...
CoreInternalOutcome DescribeCloneViralTaskResponse::Deserialize(const string &payload)
{
...
string DescribeCloneViralTaskResponse::ToJsonString() const
{
...
string DescribeCloneViralTaskResponse::GetStatus() const
{
    return m_status;
}

bool DescribeCloneViralTaskResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeCloneViralTaskResponse::GetMessage() const
{
    return m_message;
}

bool DescribeCloneViralTaskResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

vector<string> DescribeCloneViralTaskResponse::GetVideoUrls() const
{
    return m_videoUrls;
}
