...
int64_t TextToSpeechResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool TextToSpeechResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string TextToSpeechResponse::GetMsg() const
{
    return m_msg;
}

bool TextToSpeechResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string TextToSpeechResponse::GetAudioData() const
{
    return m_audioData;
}

bool TextToSpeechResponse::AudioDataHasBeenSet() const
{
    return m_audioDataHasBeenSet;
}

string TextToSpeechResponse::GetAudioUrl() const
{
    return m_audioUrl;
}

bool TextToSpeechResponse::AudioUrlHasBeenSet() const
{
    return m_audioUrlHasBeenSet;
}

string TextToSpeechResponse::GetExtInfo() const
{
    return m_extInfo;
}

bool TextToSpeechResponse::ExtInfoHasBeenSet() const
{
