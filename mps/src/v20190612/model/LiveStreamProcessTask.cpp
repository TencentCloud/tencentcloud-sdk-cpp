...
CoreInternalOutcome LiveStreamProcessTask::Deserialize(const Value &value)
{
    string requestId = "";
...
void LiveStreamProcessTask::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
