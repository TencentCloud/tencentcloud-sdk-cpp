...
DescribeImageTasksResponse::DescribeImageTasksResponse() :
...
CoreInternalOutcome DescribeImageTasksResponse::Deserialize(const string &payload)
{
...
string DescribeImageTasksResponse::ToJsonString() const
{
...
int64_t DescribeImageTasksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeImageTasksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

string DescribeImageTasksResponse::GetScrollToken() const
{
    return m_scrollToken;
}

bool DescribeImageTasksResponse::ScrollTokenHasBeenSet() const
{
    return m_scrollTokenHasBeenSet;
}

vector<ImageTaskInfo> DescribeImageTasksResponse::GetTaskSet() const
{
    return m_taskSet;
}

bool DescribeImageTasksResponse::TaskSetHasBeenSet() const
{
