...
CoreInternalOutcome DescribeStreamPackageSourcesResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourcesResponse::ToJsonString() const
{
...
vector<SourceInfo> DescribeStreamPackageSourcesResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageSourcesResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageSourcesResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageSourcesResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageSourcesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageSourcesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageSourcesResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageSourcesResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageSourcesResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageSourcesResponse::TotalPageHasBeenSet() const
{
