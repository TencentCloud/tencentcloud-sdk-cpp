...
CoreInternalOutcome DesignVoiceAsyncResponse::Deserialize(const string &payload)
{
...
string DesignVoiceAsyncResponse::ToJsonString() const
{
...
int64_t DesignVoiceAsyncResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DesignVoiceAsyncResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DesignVoiceAsyncResponse::GetMsg() const
{
    return m_msg;
}

bool DesignVoiceAsyncResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DesignVoiceAsyncResponse::GetTaskId() const
{
    return m_taskId;
}

bool DesignVoiceAsyncResponse::TaskIdHasBeenSet() const
{
