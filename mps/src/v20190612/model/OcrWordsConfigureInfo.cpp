...
CoreInternalOutcome OcrWordsConfigureInfo::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void OcrWordsConfigureInfo::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string OcrWordsConfigureInfo::GetSwitch() const
{
    return m_switch;
}

void OcrWordsConfigureInfo::SetSwitch(const string& _switch)
{
    m_switch = _switch;
    m_switchHasBeenSet = true;
}

bool OcrWordsConfigureInfo::SwitchHasBeenSet() const
{
    return m_switchHasBeenSet;
}

vector<string> OcrWordsConfigureInfo::GetLabelSet() const
{
    return m_labelSet;
}

void OcrWordsConfigureInfo::SetLabelSet(const vector<string>& _labelSet)
{
    m_labelSet = _labelSet;
    m_labelSetHasBeenSet = true;
}

bool OcrWordsConfigureInfo::LabelSetHasBeenSet() const
{
