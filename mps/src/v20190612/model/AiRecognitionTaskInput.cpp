...
CoreInternalOutcome AiRecognitionTaskInput::Deserialize(const Value &value)
{
    string requestId = "";
...
void AiRecognitionTaskInput::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
