...
string DeleteScheduleRequest::ToJsonString() const
{
...
int64_t DeleteScheduleRequest::GetScheduleId() const
{
    return m_scheduleId;
}

void DeleteScheduleRequest::SetScheduleId(const int64_t& _scheduleId)
{
    m_scheduleId = _scheduleId;
    m_scheduleIdHasBeenSet = true;
}

bool DeleteScheduleRequest::ScheduleIdHasBeenSet() const
{
