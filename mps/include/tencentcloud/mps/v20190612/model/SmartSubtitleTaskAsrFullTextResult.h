...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKASRFULLTEXTRESULT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKASRFULLTEXTRESULT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 语音全文识别结果。
                */
                class SmartSubtitleTaskAsrFullTextResult : public AbstractModel
                {
                public:
                    SmartSubtitleTaskAsrFullTextResult();
                    ~SmartSubtitleTaskAsrFullTextResult() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    SmartSubtitleTaskAsrFullTextResultOutput GetOutput() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetOutput(const SmartSubtitleTaskAsrFullTextResultOutput& _output);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    SmartSubtitleTaskAsrFullTextResultOutput m_output;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKASRFULLTEXTRESULT_H_
