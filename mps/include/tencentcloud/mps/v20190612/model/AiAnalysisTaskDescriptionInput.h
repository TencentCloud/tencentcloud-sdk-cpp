...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKDESCRIPTIONINPUT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKDESCRIPTIONINPUT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 智能分类任务输入类型
                */
                class AiAnalysisTaskDescriptionInput : public AbstractModel
                {
                public:
                    AiAnalysisTaskDescriptionInput();
                    ~AiAnalysisTaskDescriptionInput() = default;
                    ...
                    /**
                     * 获取<p>视频智能描述模板 ID。</p>
                     * @return Definition <p>视频智能描述模板 ID。</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKDESCRIPTIONINPUT_H_
