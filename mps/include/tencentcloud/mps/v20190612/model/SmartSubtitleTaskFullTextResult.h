...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTRESULT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTRESULT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 智能字幕全文识别结果。
                */
                class SmartSubtitleTaskFullTextResult : public AbstractModel
                {
                public:
                    SmartSubtitleTaskFullTextResult();
                    ~SmartSubtitleTaskFullTextResult() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTRESULT_H_
