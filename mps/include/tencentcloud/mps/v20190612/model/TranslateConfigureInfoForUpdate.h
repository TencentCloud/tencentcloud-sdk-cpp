...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_TRANSLATECONFIGUREINFOFORUPDATE_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_TRANSLATECONFIGUREINFOFORUPDATE_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 语音翻译任务控制参数
                */
                class TranslateConfigureInfoForUpdate : public AbstractModel
                {
                public:
                    TranslateConfigureInfoForUpdate();
                    ~TranslateConfigureInfoForUpdate() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_TRANSLATECONFIGUREINFOFORUPDATE_H_
