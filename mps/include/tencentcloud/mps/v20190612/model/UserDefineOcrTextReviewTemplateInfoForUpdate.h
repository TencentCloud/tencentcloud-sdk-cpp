...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_USERDEFINEOCRTEXTREVIEWTEMPLATEINFOFORUPDATE_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_USERDEFINEOCRTEXTREVIEWTEMPLATEINFOFORUPDATE_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 用户自定义文本审核任务控制参数。
                */
                class UserDefineOcrTextReviewTemplateInfoForUpdate : public AbstractModel
                {
                public:
                    UserDefineOcrTextReviewTemplateInfoForUpdate();
                    ~UserDefineOcrTextReviewTemplateInfoForUpdate() = default;
...
<li>OFF：关闭自定义文本审核任务。</li>
                    ...
                    /**
                     * 获取用户自定义文本过滤标签，审核结果包含选择的标签则返回结果，如果过滤标签为空，则审核结果全部返回。如果要使用标签过滤功能，添加自定义文本关键词素材时需要添加对应标签。
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_USERDEFINEOCRTEXTREVIEWTEMPLATEINFOFORUPDATE_H_
