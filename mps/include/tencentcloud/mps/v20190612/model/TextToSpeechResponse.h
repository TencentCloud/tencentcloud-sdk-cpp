...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_TEXTTOSPEECHRESPONSE_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_TEXTTOSPEECHRESPONSE_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>合成音频的base64编码，默认wav格式</p>
                     * @return AudioData <p>合成音频的base64编码，默认wav格式</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>
                     * @return ExtInfo <p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_TEXTTOSPEECHRESPONSE_H_
