...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKVIDEOCOMPREHENSIONINPUT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKVIDEOCOMPREHENSIONINPUT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 视频（音频）理解任务输入
                */
                class AiAnalysisTaskVideoComprehensionInput : public AbstractModel
                {
                public:
                    AiAnalysisTaskVideoComprehensionInput();
                    ~AiAnalysisTaskVideoComprehensionInput() = default;
                    ...
                    /**
                     * 获取<p>视频（音频）理解模板ID</p>
                     * @return Definition <p>视频（音频）理解模板ID</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKVIDEOCOMPREHENSIONINPUT_H_
