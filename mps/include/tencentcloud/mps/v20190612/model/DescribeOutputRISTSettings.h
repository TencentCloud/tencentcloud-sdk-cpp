...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEOUTPUTRISTSETTINGS_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEOUTPUTRISTSETTINGS_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 查询输出的RIST拉流配置信息。
                */
                class DescribeOutputRISTSettings : public AbstractModel
                {
                public:
                    DescribeOutputRISTSettings();
                    ~DescribeOutputRISTSettings() = default;
                    ...
                    /**
                     * 获取服务器监听地址，RIST模式为LISTENER时使用。
注意：此字段可能返回 null，表示取不到有效值。
                     * @return SourceAddresses 服务器监听地址，RIST模式为LISTENER时使用。
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<OutputRISTSourceAddressResp> GetSourceAddresses() const;

                    /**
                     * 设置服务器监听地址，RIST模式为LISTENER时使用。
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _sourceAddresses 服务器监听地址，RIST模式为LISTENER时使用。
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetSourceAddresses(const std::vector<OutputRISTSourceAddressResp>& _sourceAddresses);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<OutputRISTSourceAddressResp> m_sourceAddresses;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEOUTPUTRISTSETTINGS_H_
