...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_CREATEINPUTRISTSETTINGS_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_CREATEINPUTRISTSETTINGS_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 创建的输入RIST的配置信息。
                */
                class CreateInputRISTSettings : public AbstractModel
                {
                public:
                    CreateInputRISTSettings();
                    ~CreateInputRISTSettings() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取RIST模式，可选[LISTENER]，默认为LISTENER。
                    ...
                    /**
                     * 设置RIST模式，可选[LISTENER]，默认为LISTENER。
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_CREATEINPUTRISTSETTINGS_H_
