...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESMARTERASETEMPLATESREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESMARTERASETEMPLATESREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DescribeSmartEraseTemplatesRequest : public AbstractModel
                {
                public:
                    DescribeSmartEraseTemplatesRequest();
                    ~DescribeSmartEraseTemplatesRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取智能擦除模板唯一标识过滤条件，数组长度限制：100。
                     * @return Definitions 智能擦除模板唯一标识过滤条件，数组长度限制：100。
                     * 
                     */
                    std::vector<int64_t> GetDefinitions() const;

                    /**
                     * 设置智能擦除模板唯一标识过滤条件，数组长度限制：100。
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESMARTERASETEMPLATESREQUEST_H_
