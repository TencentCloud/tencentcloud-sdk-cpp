...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKGENERICINPUT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKGENERICINPUT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 智能分析通用任务输入类型
                */
                class AiAnalysisTaskGenericInput : public AbstractModel
                {
                public:
                    AiAnalysisTaskGenericInput();
                    ~AiAnalysisTaskGenericInput() = default;
                    ...
                    /**
                     * 获取<p>智能分析模板 ID。</p>
                     * @return Definition <p>智能分析模板 ID。</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKGENERICINPUT_H_
