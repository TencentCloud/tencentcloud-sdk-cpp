...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_COMPOSEVIDEOITEM_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_COMPOSEVIDEOITEM_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 视频编辑/合成任务 视频元素信息。
                */
                class ComposeVideoItem : public AbstractModel
                {
                public:
                    ComposeVideoItem();
                    ~ComposeVideoItem() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_COMPOSEVIDEOITEM_H_
