...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSTREAMLINKSECURITYGROUPREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSTREAMLINKSECURITYGROUPREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class ModifyStreamLinkSecurityGroupRequest : public AbstractModel
                {
                public:
                    ModifyStreamLinkSecurityGroupRequest();
                    ~ModifyStreamLinkSecurityGroupRequest() = default;
                    ...
                    /**
                     * 获取安全组名称，限制大小写、数字和下划线，长度[1, 32]，Region下唯一。
                    ...
                    /**
                     * 设置安全组名称，限制大小写、数字和下划线，长度[1, 32]，Region下唯一。
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSTREAMLINKSECURITYGROUPREQUEST_H_
