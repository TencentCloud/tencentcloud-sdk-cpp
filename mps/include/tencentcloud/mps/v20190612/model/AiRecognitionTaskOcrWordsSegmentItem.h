...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_AIRECOGNITIONTASKOCRWORDSSEGMENTITEM_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_AIRECOGNITIONTASKOCRWORDSSEGMENTITEM_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 文本识别片段。
                */
                class AiRecognitionTaskOcrWordsSegmentItem : public AbstractModel
                {
                public:
                    AiRecognitionTaskOcrWordsSegmentItem();
                    ~AiRecognitionTaskOcrWordsSegmentItem() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_AIRECOGNITIONTASKOCRWORDSSEGMENTITEM_H_
