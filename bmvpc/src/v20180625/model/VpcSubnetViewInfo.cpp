...
CoreInternalOutcome VpcSubnetViewInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void VpcSubnetViewInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
