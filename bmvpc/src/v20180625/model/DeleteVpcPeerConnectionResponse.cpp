...
CoreInternalOutcome DeleteVpcPeerConnectionResponse::Deserialize(const string &payload)
{
...
string DeleteVpcPeerConnectionResponse::ToJsonString() const
{
...
uint64_t DeleteVpcPeerConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpcPeerConnectionResponse::TaskIdHasBeenSet() const
{
