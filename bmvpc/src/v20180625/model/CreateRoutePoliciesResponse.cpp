...
CoreInternalOutcome CreateRoutePoliciesResponse::Deserialize(const string &payload)
{
...
string CreateRoutePoliciesResponse::ToJsonString() const
{
...
uint64_t CreateRoutePoliciesResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateRoutePoliciesResponse::TaskIdHasBeenSet() const
{
