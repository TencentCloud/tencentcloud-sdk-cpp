...
CoreInternalOutcome ModifyRoutePolicyResponse::Deserialize(const string &payload)
{
...
string ModifyRoutePolicyResponse::ToJsonString() const
{
...
uint64_t ModifyRoutePolicyResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyRoutePolicyResponse::TaskIdHasBeenSet() const
{
