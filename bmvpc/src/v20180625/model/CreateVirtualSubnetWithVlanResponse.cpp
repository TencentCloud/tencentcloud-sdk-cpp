...
CoreInternalOutcome CreateVirtualSubnetWithVlanResponse::Deserialize(const string &payload)
{
...
string CreateVirtualSubnetWithVlanResponse::ToJsonString() const
{
...
int64_t CreateVirtualSubnetWithVlanResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateVirtualSubnetWithVlanResponse::TaskIdHasBeenSet() const
{
