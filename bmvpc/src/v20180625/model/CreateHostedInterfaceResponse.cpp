...
CoreInternalOutcome CreateHostedInterfaceResponse::Deserialize(const string &payload)
{
...
string CreateHostedInterfaceResponse::ToJsonString() const
{
...
uint64_t CreateHostedInterfaceResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateHostedInterfaceResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

vector<string> CreateHostedInterfaceResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateHostedInterfaceResponse::ResourceIdsHasBeenSet() const
{
