...
CoreInternalOutcome ModifyVpcPeerConnectionResponse::Deserialize(const string &payload)
{
...
string ModifyVpcPeerConnectionResponse::ToJsonString() const
{
...
uint64_t ModifyVpcPeerConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyVpcPeerConnectionResponse::TaskIdHasBeenSet() const
{
