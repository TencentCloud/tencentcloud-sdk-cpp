...
CoreInternalOutcome CreateVpcResponse::Deserialize(const string &payload)
{
...
string CreateVpcResponse::ToJsonString() const
{
...
uint64_t CreateVpcResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateVpcResponse::TaskIdHasBeenSet() const
{
