...
CoreInternalOutcome DeleteVpnConnectionResponse::Deserialize(const string &payload)
{
...
string DeleteVpnConnectionResponse::ToJsonString() const
{
...
uint64_t DeleteVpnConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpnConnectionResponse::TaskIdHasBeenSet() const
{
