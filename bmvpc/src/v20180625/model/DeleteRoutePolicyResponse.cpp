...
CoreInternalOutcome DeleteRoutePolicyResponse::Deserialize(const string &payload)
{
...
string DeleteRoutePolicyResponse::ToJsonString() const
{
...
uint64_t DeleteRoutePolicyResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteRoutePolicyResponse::TaskIdHasBeenSet() const
{
