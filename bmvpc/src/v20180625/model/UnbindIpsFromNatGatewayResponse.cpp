...
CoreInternalOutcome UnbindIpsFromNatGatewayResponse::Deserialize(const string &payload)
{
...
string UnbindIpsFromNatGatewayResponse::ToJsonString() const
{
...
uint64_t UnbindIpsFromNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool UnbindIpsFromNatGatewayResponse::TaskIdHasBeenSet() const
{
