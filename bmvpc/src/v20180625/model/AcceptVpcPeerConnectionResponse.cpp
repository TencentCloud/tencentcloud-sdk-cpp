...
CoreInternalOutcome AcceptVpcPeerConnectionResponse::Deserialize(const string &payload)
{
...
string AcceptVpcPeerConnectionResponse::ToJsonString() const
{
...
uint64_t AcceptVpcPeerConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool AcceptVpcPeerConnectionResponse::TaskIdHasBeenSet() const
{
