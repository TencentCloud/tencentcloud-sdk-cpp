...
CoreInternalOutcome DeleteNatGatewayResponse::Deserialize(const string &payload)
{
...
string DeleteNatGatewayResponse::ToJsonString() const
{
...
uint64_t DeleteNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteNatGatewayResponse::TaskIdHasBeenSet() const
{
