...
string AcceptVpcPeerConnectionRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_vpcPeerConnectionIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_vpcPeerConnectionId.c_str(), allocator).Move(), allocator);
    }
...
string AcceptVpcPeerConnectionRequest::GetVpcPeerConnectionId() const
{
    return m_vpcPeerConnectionId;
}

void AcceptVpcPeerConnectionRequest::SetVpcPeerConnectionId(const string& _vpcPeerConnectionId)
{
    m_vpcPeerConnectionId = _vpcPeerConnectionId;
    m_vpcPeerConnectionIdHasBeenSet = true;
}

bool AcceptVpcPeerConnectionRequest::VpcPeerConnectionIdHasBeenSet() const
{
