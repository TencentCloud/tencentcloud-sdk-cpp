...
CoreInternalOutcome UnbindSubnetsFromNatGatewayResponse::Deserialize(const string &payload)
{
...
string UnbindSubnetsFromNatGatewayResponse::ToJsonString() const
{
...
uint64_t UnbindSubnetsFromNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool UnbindSubnetsFromNatGatewayResponse::TaskIdHasBeenSet() const
{
