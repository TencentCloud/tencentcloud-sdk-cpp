...
CoreInternalOutcome SubnetCreateInputInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void SubnetCreateInputInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
