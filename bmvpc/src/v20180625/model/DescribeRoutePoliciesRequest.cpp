...
string DescribeRoutePoliciesRequest::GetRouteTableId() const
{
    return m_routeTableId;
}

void DescribeRoutePoliciesRequest::SetRouteTableId(const string& _routeTableId)
{
    m_routeTableId = _routeTableId;
    m_routeTableIdHasBeenSet = true;
}

bool DescribeRoutePoliciesRequest::RouteTableIdHasBeenSet() const
{
...
uint64_t DescribeRoutePoliciesRequest::GetOffset() const
{
    return m_offset;
}

void DescribeRoutePoliciesRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
uint64_t DescribeRoutePoliciesRequest::GetLimit() const
{
    return m_limit;
}

void DescribeRoutePoliciesRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
