...
CoreInternalOutcome DeleteVirtualIpResponse::Deserialize(const string &payload)
{
...
string DeleteVirtualIpResponse::ToJsonString() const
{
...
uint64_t DeleteVirtualIpResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVirtualIpResponse::TaskIdHasBeenSet() const
{
