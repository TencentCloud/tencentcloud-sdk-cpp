...
CoreInternalOutcome BindEipsToNatGatewayResponse::Deserialize(const string &payload)
{
...
string BindEipsToNatGatewayResponse::ToJsonString() const
{
...
uint64_t BindEipsToNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindEipsToNatGatewayResponse::TaskIdHasBeenSet() const
{
