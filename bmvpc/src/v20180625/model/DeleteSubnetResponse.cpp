...
CoreInternalOutcome DeleteSubnetResponse::Deserialize(const string &payload)
{
...
string DeleteSubnetResponse::ToJsonString() const
{
...
uint64_t DeleteSubnetResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteSubnetResponse::TaskIdHasBeenSet() const
{
