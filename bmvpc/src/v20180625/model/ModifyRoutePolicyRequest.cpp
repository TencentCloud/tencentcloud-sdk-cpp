...
string ModifyRoutePolicyRequest::ToJsonString() const
{
    ...
    if (m_routePolicyHasBeenSet)
    {
        ...
        m_routePolicy.ToJsonObject(d[key.c_str()], allocator);
    }
...
string ModifyRoutePolicyRequest::GetRouteTableId() const
{
    return m_routeTableId;
}

void ModifyRoutePolicyRequest::SetRouteTableId(const string& _routeTableId)
{
    m_routeTableId = _routeTableId;
    m_routeTableIdHasBeenSet = true;
}

bool ModifyRoutePolicyRequest::RouteTableIdHasBeenSet() const
{
    return m_routeTableIdHasBeenSet;
}

RoutePolicy ModifyRoutePolicyRequest::GetRoutePolicy() const
{
    return m_routePolicy;
}

void ModifyRoutePolicyRequest::SetRoutePolicy(const RoutePolicy& _routePolicy)
{
    m_routePolicy = _routePolicy;
    m_routePolicyHasBeenSet = true;
}

bool ModifyRoutePolicyRequest::RoutePolicyHasBeenSet() const
{
