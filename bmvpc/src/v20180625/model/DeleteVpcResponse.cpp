...
CoreInternalOutcome DeleteVpcResponse::Deserialize(const string &payload)
{
...
string DeleteVpcResponse::ToJsonString() const
{
...
uint64_t DeleteVpcResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpcResponse::TaskIdHasBeenSet() const
{
