...
CoreInternalOutcome BindSubnetsToNatGatewayResponse::Deserialize(const string &payload)
{
...
string BindSubnetsToNatGatewayResponse::ToJsonString() const
{
...
uint64_t BindSubnetsToNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindSubnetsToNatGatewayResponse::TaskIdHasBeenSet() const
{
