...
CoreInternalOutcome BindIpsToNatGatewayResponse::Deserialize(const string &payload)
{
...
string BindIpsToNatGatewayResponse::ToJsonString() const
{
...
uint64_t BindIpsToNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindIpsToNatGatewayResponse::TaskIdHasBeenSet() const
{
