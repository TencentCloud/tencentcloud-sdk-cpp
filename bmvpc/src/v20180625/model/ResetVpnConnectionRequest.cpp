...
string ResetVpnConnectionRequest::ToJsonString() const
{
...
string ResetVpnConnectionRequest::GetVpcId() const
{
    return m_vpcId;
}

void ResetVpnConnectionRequest::SetVpcId(const string& _vpcId)
{
    m_vpcId = _vpcId;
    m_vpcIdHasBeenSet = true;
}

bool ResetVpnConnectionRequest::VpcIdHasBeenSet() const
{
    return m_vpcIdHasBeenSet;
}

string ResetVpnConnectionRequest::GetVpnConnectionId() const
{
    return m_vpnConnectionId;
}

void ResetVpnConnectionRequest::SetVpnConnectionId(const string& _vpnConnectionId)
{
    m_vpnConnectionId = _vpnConnectionId;
    m_vpnConnectionIdHasBeenSet = true;
}

bool ResetVpnConnectionRequest::VpnConnectionIdHasBeenSet() const
{
