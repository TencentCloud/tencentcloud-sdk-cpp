...
CoreInternalOutcome CreateVpcPeerConnectionResponse::Deserialize(const string &payload)
{
...
string CreateVpcPeerConnectionResponse::ToJsonString() const
{
...
uint64_t CreateVpcPeerConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateVpcPeerConnectionResponse::TaskIdHasBeenSet() const
{
