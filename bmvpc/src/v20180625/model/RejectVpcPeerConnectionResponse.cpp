...
CoreInternalOutcome RejectVpcPeerConnectionResponse::Deserialize(const string &payload)
{
...
string RejectVpcPeerConnectionResponse::ToJsonString() const
{
...
uint64_t RejectVpcPeerConnectionResponse::GetTaskId() const
{
    return m_taskId;
}

bool RejectVpcPeerConnectionResponse::TaskIdHasBeenSet() const
{
