...
CoreInternalOutcome DeleteVpnGatewayResponse::Deserialize(const string &payload)
{
...
string DeleteVpnGatewayResponse::ToJsonString() const
{
...
uint64_t DeleteVpnGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteVpnGatewayResponse::TaskIdHasBeenSet() const
{
