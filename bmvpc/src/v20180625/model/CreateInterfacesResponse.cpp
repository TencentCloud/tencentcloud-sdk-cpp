...
CoreInternalOutcome CreateInterfacesResponse::Deserialize(const string &payload)
{
...
string CreateInterfacesResponse::ToJsonString() const
{
...
uint64_t CreateInterfacesResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateInterfacesResponse::TaskIdHasBeenSet() const
{
