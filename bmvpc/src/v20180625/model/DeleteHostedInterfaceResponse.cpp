...
CoreInternalOutcome DeleteHostedInterfaceResponse::Deserialize(const string &payload)
{
...
string DeleteHostedInterfaceResponse::ToJsonString() const
{
...
uint64_t DeleteHostedInterfaceResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteHostedInterfaceResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

vector<string> DeleteHostedInterfaceResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool DeleteHostedInterfaceResponse::ResourceIdsHasBeenSet() const
{
