...
CoreInternalOutcome DeleteInterfacesResponse::Deserialize(const string &payload)
{
...
string DeleteInterfacesResponse::ToJsonString() const
{
...
uint64_t DeleteInterfacesResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteInterfacesResponse::TaskIdHasBeenSet() const
{
