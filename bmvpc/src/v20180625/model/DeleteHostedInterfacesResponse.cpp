...
CoreInternalOutcome DeleteHostedInterfacesResponse::Deserialize(const string &payload)
{
...
string DeleteHostedInterfacesResponse::ToJsonString() const
{
...
uint64_t DeleteHostedInterfacesResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteHostedInterfacesResponse::TaskIdHasBeenSet() const
{
