...
CoreInternalOutcome UnbindEipsFromNatGatewayResponse::Deserialize(const string &payload)
{
...
string UnbindEipsFromNatGatewayResponse::ToJsonString() const
{
...
uint64_t UnbindEipsFromNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool UnbindEipsFromNatGatewayResponse::TaskIdHasBeenSet() const
{
