...
CoreInternalOutcome AsyncRegisterIpsResponse::Deserialize(const string &payload)
{
...
string AsyncRegisterIpsResponse::ToJsonString() const
{
...
int64_t AsyncRegisterIpsResponse::GetTaskId() const
{
    return m_taskId;
}

bool AsyncRegisterIpsResponse::TaskIdHasBeenSet() const
{
