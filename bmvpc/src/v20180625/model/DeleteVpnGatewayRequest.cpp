...
string DeleteVpnGatewayRequest::ToJsonString() const
{
...
string DeleteVpnGatewayRequest::GetVpnGatewayId() const
{
    return m_vpnGatewayId;
}

void DeleteVpnGatewayRequest::SetVpnGatewayId(const string& _vpnGatewayId)
{
    m_vpnGatewayId = _vpnGatewayId;
    m_vpnGatewayIdHasBeenSet = true;
}

bool DeleteVpnGatewayRequest::VpnGatewayIdHasBeenSet() const
{
