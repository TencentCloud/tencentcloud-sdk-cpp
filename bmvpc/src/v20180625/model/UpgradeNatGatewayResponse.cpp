...
CoreInternalOutcome UpgradeNatGatewayResponse::Deserialize(const string &payload)
{
...
string UpgradeNatGatewayResponse::ToJsonString() const
{
...
uint64_t UpgradeNatGatewayResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpgradeNatGatewayResponse::TaskIdHasBeenSet() const
{
