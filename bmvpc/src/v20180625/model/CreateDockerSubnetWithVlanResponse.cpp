...
CoreInternalOutcome CreateDockerSubnetWithVlanResponse::Deserialize(const string &payload)
{
...
string CreateDockerSubnetWithVlanResponse::ToJsonString() const
{
...
uint64_t CreateDockerSubnetWithVlanResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateDockerSubnetWithVlanResponse::TaskIdHasBeenSet() const
{
