...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBESUBNETBYDEVICEREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBESUBNETBYDEVICEREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DescribeSubnetByDeviceRequest : public AbstractModel
                {
                public:
                    DescribeSubnetByDeviceRequest();
                    ~DescribeSubnetByDeviceRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBESUBNETBYDEVICEREQUEST_H_
