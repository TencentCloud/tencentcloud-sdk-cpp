...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_DELETEHOSTEDINTERFACEREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_DELETEHOSTEDINTERFACEREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DeleteHostedInterfaceRequest : public AbstractModel
                {
                public:
                    DeleteHostedInterfaceRequest();
                    ~DeleteHostedInterfaceRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_DELETEHOSTEDINTERFACEREQUEST_H_
