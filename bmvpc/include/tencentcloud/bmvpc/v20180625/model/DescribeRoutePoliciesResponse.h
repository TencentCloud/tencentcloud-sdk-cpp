...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBEROUTEPOLICIESRESPONSE_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBEROUTEPOLICIESRESPONSE_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DescribeRoutePoliciesResponse : public AbstractModel
                {
                public:
                    DescribeRoutePoliciesResponse();
                    ~DescribeRoutePoliciesResponse() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBEROUTEPOLICIESRESPONSE_H_
