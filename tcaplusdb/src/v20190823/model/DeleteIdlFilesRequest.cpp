...
string DeleteIdlFilesRequest::ToJsonString() const
{
...
void DeleteIdlFilesRequest::SetIdlFiles(const vector<IdlFileInfo>& _idlFiles)
{
    m_idlFiles = _idlFiles;
    m_idlFilesHasBeenSet = true;
}

bool DeleteIdlFilesRequest::IdlFilesHasBeenSet() const
{
