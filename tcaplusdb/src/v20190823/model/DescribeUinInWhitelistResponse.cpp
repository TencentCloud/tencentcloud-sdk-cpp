...
CoreInternalOutcome DescribeUinInWhitelistResponse::Deserialize(const string &payload)
{
...
string DescribeUinInWhitelistResponse::ToJsonString() const
{
...
string DescribeUinInWhitelistResponse::GetResult() const
{
    return m_result;
}

bool DescribeUinInWhitelistResponse::ResultHasBeenSet() const
{
