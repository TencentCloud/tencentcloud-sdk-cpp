...
CoreInternalOutcome ImportSnapshotsResponse::Deserialize(const string &payload)
{
...
string ImportSnapshotsResponse::ToJsonString() const
{
...
string ImportSnapshotsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ImportSnapshotsResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string ImportSnapshotsResponse::GetApplicationId() const
{
    return m_applicationId;
}

bool ImportSnapshotsResponse::ApplicationIdHasBeenSet() const
{
