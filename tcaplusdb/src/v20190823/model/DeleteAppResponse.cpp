...
CoreInternalOutcome DeleteAppResponse::Deserialize(const string &payload)
{
    Document d;
...
string DeleteAppResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteAppResponse::TaskIdHasBeenSet() const
{
