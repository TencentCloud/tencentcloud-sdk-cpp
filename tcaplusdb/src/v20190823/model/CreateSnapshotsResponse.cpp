...
CoreInternalOutcome CreateSnapshotsResponse::Deserialize(const string &payload)
{
...
string CreateSnapshotsResponse::ToJsonString() const
{
...
uint64_t CreateSnapshotsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool CreateSnapshotsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SnapshotResult> CreateSnapshotsResponse::GetTableResults() const
{
    return m_tableResults;
}

bool CreateSnapshotsResponse::TableResultsHasBeenSet() const
{
