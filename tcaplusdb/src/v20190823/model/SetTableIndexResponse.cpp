...
CoreInternalOutcome SetTableIndexResponse::Deserialize(const string &payload)
{
...
string SetTableIndexResponse::ToJsonString() const
{
...
uint64_t SetTableIndexResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SetTableIndexResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> SetTableIndexResponse::GetTableResults() const
{
    return m_tableResults;
}

bool SetTableIndexResponse::TableResultsHasBeenSet() const
{
