...
CoreInternalOutcome DeleteSnapshotsResponse::Deserialize(const string &payload)
{
...
string DeleteSnapshotsResponse::ToJsonString() const
{
...
uint64_t DeleteSnapshotsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DeleteSnapshotsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SnapshotResult> DeleteSnapshotsResponse::GetTableResults() const
{
    return m_tableResults;
}

bool DeleteSnapshotsResponse::TableResultsHasBeenSet() const
{
