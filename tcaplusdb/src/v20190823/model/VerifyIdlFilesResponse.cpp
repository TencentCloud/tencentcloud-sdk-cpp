...
CoreInternalOutcome VerifyIdlFilesResponse::Deserialize(const string &payload)
{
...
string VerifyIdlFilesResponse::ToJsonString() const
{
...
vector<IdlFileInfo> VerifyIdlFilesResponse::GetIdlFiles() const
{
    return m_idlFiles;
}

bool VerifyIdlFilesResponse::IdlFilesHasBeenSet() const
{
    return m_idlFilesHasBeenSet;
}

uint64_t VerifyIdlFilesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool VerifyIdlFilesResponse::TotalCountHasBeenSet() const
{
...
bool VerifyIdlFilesResponse::TableInfosHasBeenSet() const
{
