...
CoreInternalOutcome ModifySnapshotsResponse::Deserialize(const string &payload)
{
...
string ModifySnapshotsResponse::ToJsonString() const
{
...
uint64_t ModifySnapshotsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ModifySnapshotsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SnapshotResult> ModifySnapshotsResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ModifySnapshotsResponse::TableResultsHasBeenSet() const
{
