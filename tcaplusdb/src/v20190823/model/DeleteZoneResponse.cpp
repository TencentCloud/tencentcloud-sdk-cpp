...
CoreInternalOutcome DeleteZoneResponse::Deserialize(const string &payload)
{
    Document d;
...
string DeleteZoneResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteZoneResponse::TaskIdHasBeenSet() const
{
