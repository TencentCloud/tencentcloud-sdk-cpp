...
CoreInternalOutcome DescribeTableTagsResponse::Deserialize(const string &payload)
{
...
string DescribeTableTagsResponse::ToJsonString() const
{
...
int64_t DescribeTableTagsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTableTagsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TagsInfoOfTable> DescribeTableTagsResponse::GetRows() const
{
    return m_rows;
}

bool DescribeTableTagsResponse::RowsHasBeenSet() const
{
