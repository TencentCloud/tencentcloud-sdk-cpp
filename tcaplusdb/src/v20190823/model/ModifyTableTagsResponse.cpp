...
CoreInternalOutcome ModifyTableTagsResponse::Deserialize(const string &payload)
{
...
string ModifyTableTagsResponse::ToJsonString() const
{
...
int64_t ModifyTableTagsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ModifyTableTagsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> ModifyTableTagsResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ModifyTableTagsResponse::TableResultsHasBeenSet() const
{
