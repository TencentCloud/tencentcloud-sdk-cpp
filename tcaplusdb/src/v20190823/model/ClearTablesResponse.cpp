...
CoreInternalOutcome ClearTablesResponse::Deserialize(const string &payload)
{
...
string ClearTablesResponse::ToJsonString() const
{
...
uint64_t ClearTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ClearTablesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> ClearTablesResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ClearTablesResponse::TableResultsHasBeenSet() const
{
