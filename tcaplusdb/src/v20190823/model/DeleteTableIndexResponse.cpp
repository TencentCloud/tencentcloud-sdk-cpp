...
CoreInternalOutcome DeleteTableIndexResponse::Deserialize(const string &payload)
{
...
string DeleteTableIndexResponse::ToJsonString() const
{
...
uint64_t DeleteTableIndexResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DeleteTableIndexResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> DeleteTableIndexResponse::GetTableResults() const
{
    return m_tableResults;
}

bool DeleteTableIndexResponse::TableResultsHasBeenSet() const
{
