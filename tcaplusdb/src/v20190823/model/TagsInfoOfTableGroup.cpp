...
CoreInternalOutcome TagsInfoOfTableGroup::Deserialize(const Value &value)
{
    string requestId = "";
...
void TagsInfoOfTableGroup::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
