...
CoreInternalOutcome RollbackTablesResponse::Deserialize(const string &payload)
{
...
string RollbackTablesResponse::ToJsonString() const
{
...
uint64_t RollbackTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool RollbackTablesResponse::TotalCountHasBeenSet() const
{
...
bool RollbackTablesResponse::TableResultsHasBeenSet() const
{
