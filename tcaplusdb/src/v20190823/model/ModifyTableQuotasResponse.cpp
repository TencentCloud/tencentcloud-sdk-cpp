...
CoreInternalOutcome ModifyTableQuotasResponse::Deserialize(const string &payload)
{
...
string ModifyTableQuotasResponse::ToJsonString() const
{
...
uint64_t ModifyTableQuotasResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ModifyTableQuotasResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> ModifyTableQuotasResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ModifyTableQuotasResponse::TableResultsHasBeenSet() const
{
