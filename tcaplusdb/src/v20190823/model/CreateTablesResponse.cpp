...
CoreInternalOutcome CreateTablesResponse::Deserialize(const string &payload)
{
...
string CreateTablesResponse::ToJsonString() const
{
...
uint64_t CreateTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool CreateTablesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> CreateTablesResponse::GetTableResults() const
{
    return m_tableResults;
}

bool CreateTablesResponse::TableResultsHasBeenSet() const
{
