...
CoreInternalOutcome MergeTablesDataResponse::Deserialize(const string &payload)
{
...
string MergeTablesDataResponse::ToJsonString() const
{
...
vector<MergeTableResult> MergeTablesDataResponse::GetResults() const
{
    return m_results;
}

bool MergeTablesDataResponse::ResultsHasBeenSet() const
{
