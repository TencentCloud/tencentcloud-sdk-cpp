...
CoreInternalOutcome ModifyTablesResponse::Deserialize(const string &payload)
{
...
string ModifyTablesResponse::ToJsonString() const
{
...
uint64_t ModifyTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ModifyTablesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> ModifyTablesResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ModifyTablesResponse::TableResultsHasBeenSet() const
{
