...
CoreInternalOutcome DescribeTableGroupTagsResponse::Deserialize(const string &payload)
{
...
string DescribeTableGroupTagsResponse::ToJsonString() const
{
...
vector<TagsInfoOfTableGroup> DescribeTableGroupTagsResponse::GetRows() const
{
    return m_rows;
}

bool DescribeTableGroupTagsResponse::RowsHasBeenSet() const
{
    return m_rowsHasBeenSet;
}

int64_t DescribeTableGroupTagsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTableGroupTagsResponse::TotalCountHasBeenSet() const
{
