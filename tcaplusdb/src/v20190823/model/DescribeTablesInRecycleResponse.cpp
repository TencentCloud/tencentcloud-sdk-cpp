...
CoreInternalOutcome DescribeTablesInRecycleResponse::Deserialize(const string &payload)
{
...
string DescribeTablesInRecycleResponse::ToJsonString() const
{
...
uint64_t DescribeTablesInRecycleResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTablesInRecycleResponse::TotalCountHasBeenSet() const
{
...
bool DescribeTablesInRecycleResponse::TableInfosHasBeenSet() const
{
