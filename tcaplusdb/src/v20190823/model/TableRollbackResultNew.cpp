...
CoreInternalOutcome TableRollbackResultNew::Deserialize(const Value &value)
{
    string requestId = "";
...
void TableRollbackResultNew::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
