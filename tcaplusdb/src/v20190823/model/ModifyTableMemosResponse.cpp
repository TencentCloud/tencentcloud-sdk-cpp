...
CoreInternalOutcome ModifyTableMemosResponse::Deserialize(const string &payload)
{
...
string ModifyTableMemosResponse::ToJsonString() const
{
...
uint64_t ModifyTableMemosResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ModifyTableMemosResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> ModifyTableMemosResponse::GetTableResults() const
{
    return m_tableResults;
}

bool ModifyTableMemosResponse::TableResultsHasBeenSet() const
{
