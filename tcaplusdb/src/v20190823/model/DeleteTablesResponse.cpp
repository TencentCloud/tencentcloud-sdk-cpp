...
CoreInternalOutcome DeleteTablesResponse::Deserialize(const string &payload)
{
...
string DeleteTablesResponse::ToJsonString() const
{
...
uint64_t DeleteTablesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DeleteTablesResponse::TotalCountHasBeenSet() const
{
...
bool DeleteTablesResponse::TableResultsHasBeenSet() const
{
