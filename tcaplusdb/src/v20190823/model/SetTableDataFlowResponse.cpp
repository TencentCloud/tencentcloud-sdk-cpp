...
CoreInternalOutcome SetTableDataFlowResponse::Deserialize(const string &payload)
{
...
string SetTableDataFlowResponse::ToJsonString() const
{
...
uint64_t SetTableDataFlowResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool SetTableDataFlowResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<TableResultNew> SetTableDataFlowResponse::GetTableResults() const
{
    return m_tableResults;
}

bool SetTableDataFlowResponse::TableResultsHasBeenSet() const
{
