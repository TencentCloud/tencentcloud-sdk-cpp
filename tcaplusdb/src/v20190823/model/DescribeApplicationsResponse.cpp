...
vector<Application> DescribeApplicationsResponse::GetApplications() const
{
    return m_applications;
}

bool DescribeApplicationsResponse::ApplicationsHasBeenSet() const
{
    return m_applicationsHasBeenSet;
}

int64_t DescribeApplicationsResponse::GetTotalCount() const
{
    return m_totalCount;
}
