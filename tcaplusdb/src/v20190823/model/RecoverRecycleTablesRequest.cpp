...
string RecoverRecycleTablesRequest::GetClusterId() const
{
    return m_clusterId;
}

void RecoverRecycleTablesRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool RecoverRecycleTablesRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

vector<SelectedTableInfoNew> RecoverRecycleTablesRequest::GetSelectedTables() const
{
    return m_selectedTables;
}

void RecoverRecycleTablesRequest::SetSelectedTables(const vector<SelectedTableInfoNew>& _selectedTables)
{
