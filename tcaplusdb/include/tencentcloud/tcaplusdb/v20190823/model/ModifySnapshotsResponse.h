...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYSNAPSHOTSRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYSNAPSHOTSRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class ModifySnapshotsResponse : public AbstractModel
                {
                public:
                    ModifySnapshotsResponse();
                    ~ModifySnapshotsResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYSNAPSHOTSRESPONSE_H_
