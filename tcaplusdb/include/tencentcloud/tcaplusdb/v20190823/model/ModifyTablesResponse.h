...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYTABLESRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYTABLESRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                * ModifyTables返回参数结构体
                */
                class ModifyTablesResponse : public AbstractModel
                {
                public:
                    ModifyTablesResponse();
                    ~ModifyTablesResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_MODIFYTABLESRESPONSE_H_
