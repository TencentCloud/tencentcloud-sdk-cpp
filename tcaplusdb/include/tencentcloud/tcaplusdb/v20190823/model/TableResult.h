...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_TABLERESULT_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_TABLERESULT_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                * 表处理结果信息
                */
                class TableResult : public AbstractModel
                {
                public:
                    TableResult();
                    ~TableResult() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_TABLERESULT_H_
