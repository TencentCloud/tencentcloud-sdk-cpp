...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_CREATETABLESRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_CREATETABLESRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                * CreateTables返回参数结构体
                */
                class CreateTablesResponse : public AbstractModel
                {
                public:
                    CreateTablesResponse();
                    ~CreateTablesResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_CREATETABLESRESPONSE_H_
