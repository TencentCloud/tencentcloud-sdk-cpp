...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLESRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLESRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                * DeleteTables返回参数结构体
                */
                class DeleteTablesResponse : public AbstractModel
                {
                public:
                    DeleteTablesResponse();
                    ~DeleteTablesResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLESRESPONSE_H_
