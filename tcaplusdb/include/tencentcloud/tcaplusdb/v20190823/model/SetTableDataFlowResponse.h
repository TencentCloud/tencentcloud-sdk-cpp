...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEDATAFLOWRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEDATAFLOWRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class SetTableDataFlowResponse : public AbstractModel
                {
                public:
                    SetTableDataFlowResponse();
                    ~SetTableDataFlowResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEDATAFLOWRESPONSE_H_
