...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEDATAFLOWREQUEST_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEDATAFLOWREQUEST_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class DeleteTableDataFlowRequest : public AbstractModel
                {
                public:
                    DeleteTableDataFlowRequest();
                    ~DeleteTableDataFlowRequest() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEDATAFLOWREQUEST_H_
