...
CoreInternalOutcome DescribeBrandSocialReportResponse::Deserialize(const string &payload)
{
...
string DescribeBrandSocialReportResponse::ToJsonString() const
{
...
uint64_t DescribeBrandSocialReportResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBrandSocialReportResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DateCount> DescribeBrandSocialReportResponse::GetDateCountSet() const
{
    return m_dateCountSet;
}

bool DescribeBrandSocialReportResponse::DateCountSetHasBeenSet() const
{
