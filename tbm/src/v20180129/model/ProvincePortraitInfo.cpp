...
CoreInternalOutcome ProvincePortraitInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ProvincePortraitInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
