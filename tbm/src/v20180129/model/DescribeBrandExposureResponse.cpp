...
CoreInternalOutcome DescribeBrandExposureResponse::Deserialize(const string &payload)
{
...
string DescribeBrandExposureResponse::ToJsonString() const
{
...
uint64_t DescribeBrandExposureResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBrandExposureResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DateCount> DescribeBrandExposureResponse::GetDateCountSet() const
{
    return m_dateCountSet;
}

bool DescribeBrandExposureResponse::DateCountSetHasBeenSet() const
{
