...
CoreInternalOutcome MoviePortraitInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void MoviePortraitInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
