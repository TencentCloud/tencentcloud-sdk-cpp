...
CoreInternalOutcome AgePortrait::Deserialize(const Value &value)
{
    string requestId = "";
...
void AgePortrait::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_ageRangeHasBeenSet)
    {
        ...
        value.AddMember(iKey, Value(m_ageRange.c_str(), allocator).Move(), allocator);
    }
