...
#ifndef TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSURERESPONSE_H_
#define TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSURERESPONSE_H_
    ...
    namespace Tbm
    {
        namespace V20180129
        {
            namespace Model
            {
                ...
                */
                class DescribeBrandExposureResponse : public AbstractModel
                {
                public:
                    DescribeBrandExposureResponse();
                    ~DescribeBrandExposureResponse() = default;
...
#endif // !TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSURERESPONSE_H_
