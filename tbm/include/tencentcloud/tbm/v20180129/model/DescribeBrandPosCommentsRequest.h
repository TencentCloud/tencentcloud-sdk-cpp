...
#ifndef TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDPOSCOMMENTSREQUEST_H_
#define TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDPOSCOMMENTSREQUEST_H_
    ...
    namespace Tbm
    {
        namespace V20180129
        {
            namespace Model
            {
                ...
                */
                class DescribeBrandPosCommentsRequest : public AbstractModel
                {
                public:
                    DescribeBrandPosCommentsRequest();
                    ~DescribeBrandPosCommentsRequest() = default;
...
#endif // !TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDPOSCOMMENTSREQUEST_H_
