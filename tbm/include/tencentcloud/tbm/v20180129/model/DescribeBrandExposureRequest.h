...
#ifndef TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSUREREQUEST_H_
#define TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSUREREQUEST_H_
    ...
    namespace Tbm
    {
        namespace V20180129
        {
            namespace Model
            {
                ...
                */
                class DescribeBrandExposureRequest : public AbstractModel
                {
                public:
                    DescribeBrandExposureRequest();
                    ~DescribeBrandExposureRequest() = default;
...
#endif // !TENCENTCLOUD_TBM_V20180129_MODEL_DESCRIBEBRANDEXPOSUREREQUEST_H_
