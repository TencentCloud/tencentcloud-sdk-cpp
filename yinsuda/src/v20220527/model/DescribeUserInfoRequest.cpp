...
string DescribeUserInfoRequest::GetAppName() const
{
    return m_appName;
}

void DescribeUserInfoRequest::SetAppName(const string& _appName)
{
    m_appName = _appName;
    m_appNameHasBeenSet = true;
}

bool DescribeUserInfoRequest::AppNameHasBeenSet() const
{
