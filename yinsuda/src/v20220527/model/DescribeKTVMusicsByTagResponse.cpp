...
CoreInternalOutcome DescribeKTVMusicsByTagResponse::Deserialize(const string &payload)
{
...
string DescribeKTVMusicsByTagResponse::ToJsonString() const
{
...
vector<KTVMusicBaseInfo> DescribeKTVMusicsByTagResponse::GetKTVMusicInfoSet() const
{
    return m_kTVMusicInfoSet;
}

bool DescribeKTVMusicsByTagResponse::KTVMusicInfoSetHasBeenSet() const
{
    return m_kTVMusicInfoSetHasBeenSet;
}

string DescribeKTVMusicsByTagResponse::GetScrollToken() const
{
    return m_scrollToken;
}

bool DescribeKTVMusicsByTagResponse::ScrollTokenHasBeenSet() const
{
