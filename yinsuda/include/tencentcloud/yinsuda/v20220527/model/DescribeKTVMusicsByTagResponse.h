...
#ifndef TENCENTCLOUD_YINSUDA_V20220527_MODEL_DESCRIBEKTVMUSICSBYTAGRESPONSE_H_
#define TENCENTCLOUD_YINSUDA_V20220527_MODEL_DESCRIBEKTVMUSICSBYTAGRESPONSE_H_
    ...
    namespace Yinsuda
    {
        namespace V20220527
        {
            namespace Model
            {
                ...
                */
                class DescribeKTVMusicsByTagResponse : public AbstractModel
                {
                public:
                    DescribeKTVMusicsByTagResponse();
                    ~DescribeKTVMusicsByTagResponse() = default;
...
#endif // !TENCENTCLOUD_YINSUDA_V20220527_MODEL_DESCRIBEKTVMUSICSBYTAGRESPONSE_H_
