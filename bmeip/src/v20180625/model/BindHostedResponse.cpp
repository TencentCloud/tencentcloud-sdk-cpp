...
CoreInternalOutcome BindHostedResponse::Deserialize(const string &payload)
{
...
string BindHostedResponse::ToJsonString() const
{
...
int64_t BindHostedResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindHostedResponse::TaskIdHasBeenSet() const
{
