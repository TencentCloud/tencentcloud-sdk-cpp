...
CoreInternalOutcome DeleteEipResponse::Deserialize(const string &payload)
{
...
string DeleteEipResponse::ToJsonString() const
{
...
uint64_t DeleteEipResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteEipResponse::TaskIdHasBeenSet() const
{
