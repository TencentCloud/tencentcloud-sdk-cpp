...
string DeleteEipRequest::ToJsonString() const
{
...
vector<string> DeleteEipRequest::GetEipIds() const
{
    return m_eipIds;
}

void DeleteEipRequest::SetEipIds(const vector<string>& _eipIds)
{
    m_eipIds = _eipIds;
    m_eipIdsHasBeenSet = true;
}

bool DeleteEipRequest::EipIdsHasBeenSet() const
{
