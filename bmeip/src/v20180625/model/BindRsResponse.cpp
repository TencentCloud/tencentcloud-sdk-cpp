...
CoreInternalOutcome BindRsResponse::Deserialize(const string &payload)
{
...
string BindRsResponse::ToJsonString() const
{
...
int64_t BindRsResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindRsResponse::TaskIdHasBeenSet() const
{
