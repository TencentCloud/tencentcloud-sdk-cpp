...
CoreInternalOutcome UnbindVpcIpResponse::Deserialize(const string &payload)
{
...
string UnbindVpcIpResponse::ToJsonString() const
{
...
int64_t UnbindVpcIpResponse::GetTaskId() const
{
    return m_taskId;
}

bool UnbindVpcIpResponse::TaskIdHasBeenSet() const
{
