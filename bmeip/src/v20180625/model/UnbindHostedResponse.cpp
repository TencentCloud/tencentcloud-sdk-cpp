...
CoreInternalOutcome UnbindHostedResponse::Deserialize(const string &payload)
{
...
string UnbindHostedResponse::ToJsonString() const
{
...
uint64_t UnbindHostedResponse::GetTaskId() const
{
    return m_taskId;
}

bool UnbindHostedResponse::TaskIdHasBeenSet() const
{
