...
CoreInternalOutcome BindVpcIpResponse::Deserialize(const string &payload)
{
...
string BindVpcIpResponse::ToJsonString() const
{
...
int64_t BindVpcIpResponse::GetTaskId() const
{
    return m_taskId;
}

bool BindVpcIpResponse::TaskIdHasBeenSet() const
{
