...
CoreInternalOutcome ModifyEipChargeResponse::Deserialize(const string &payload)
{
...
string ModifyEipChargeResponse::ToJsonString() const
{
...
int64_t ModifyEipChargeResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyEipChargeResponse::TaskIdHasBeenSet() const
{
