...
#ifndef TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDEIPACLSREQUEST_H_
#define TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDEIPACLSREQUEST_H_
    ...
    namespace Bmeip
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class UnbindEipAclsRequest : public AbstractModel
                {
                public:
                    UnbindEipAclsRequest();
                    ~UnbindEipAclsRequest() = default;
...
#endif // !TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDEIPACLSREQUEST_H_
