...
#ifndef TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDVPCIPREQUEST_H_
#define TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDVPCIPREQUEST_H_
    ...
    namespace Bmeip
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                * UnbindVpcIp请求参数结构体
                */
                class UnbindVpcIpRequest : public AbstractModel
                {
                public:
                    UnbindVpcIpRequest();
                    ~UnbindVpcIpRequest() = default;
...
#endif // !TENCENTCLOUD_BMEIP_V20180625_MODEL_UNBINDVPCIPREQUEST_H_
