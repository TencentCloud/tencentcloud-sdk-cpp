...
string QueryApiKeyRequest::ToJsonString() const
{
...
uint64_t QueryApiKeyRequest::GetTargetUin() const
{
    return m_targetUin;
}

void QueryApiKeyRequest::SetTargetUin(const uint64_t& _targetUin)
{
    m_targetUin = _targetUin;
    m_targetUinHasBeenSet = true;
}

bool QueryApiKeyRequest::TargetUinHasBeenSet() const
{
