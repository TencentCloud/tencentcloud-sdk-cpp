...
CoreInternalOutcome GetSessionTokenResponse::Deserialize(const string &payload)
{
...
string GetSessionTokenResponse::ToJsonString() const
{
...
Credentials GetSessionTokenResponse::GetCredentials() const
{
    return m_credentials;
}

bool GetSessionTokenResponse::CredentialsHasBeenSet() const
{
    return m_credentialsHasBeenSet;
}

uint64_t GetSessionTokenResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool GetSessionTokenResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

string GetSessionTokenResponse::GetExpiration() const
{
    return m_expiration;
}

bool GetSessionTokenResponse::ExpirationHasBeenSet() const
{
