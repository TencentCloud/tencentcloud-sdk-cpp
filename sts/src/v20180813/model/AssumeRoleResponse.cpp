...
Credentials AssumeRoleResponse::GetCredentials() const
{
    return m_credentials;
}

bool AssumeRoleResponse::CredentialsHasBeenSet() const
{
    return m_credentialsHasBeenSet;
}

int64_t AssumeRoleResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool AssumeRoleResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

string AssumeRoleResponse::GetExpiration() const
{
    return m_expiration;
}

bool AssumeRoleResponse::ExpirationHasBeenSet() const
{
