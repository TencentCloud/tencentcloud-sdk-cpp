...
CoreInternalOutcome AssumeRoleWithWebIdentityResponse::Deserialize(const string &payload)
{
...
string AssumeRoleWithWebIdentityResponse::ToJsonString() const
{
...
uint64_t AssumeRoleWithWebIdentityResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool AssumeRoleWithWebIdentityResponse::ExpiredTimeHasBeenSet() const
{
    return m_expiredTimeHasBeenSet;
}

string AssumeRoleWithWebIdentityResponse::GetExpiration() const
{
    return m_expiration;
}

bool AssumeRoleWithWebIdentityResponse::ExpirationHasBeenSet() const
{
    return m_expirationHasBeenSet;
}

Credentials AssumeRoleWithWebIdentityResponse::GetCredentials() const
{
    return m_credentials;
}

bool AssumeRoleWithWebIdentityResponse::CredentialsHasBeenSet() const
{
