...
DeleteAigcElementRequest::DeleteAigcElementRequest() :
    m_elementIdHasBeenSet(false)
{
}

string DeleteAigcElementRequest::ToJsonString() const
{
...
string DeleteAigcElementRequest::GetElementId() const
{
    return m_elementId;
}

void DeleteAigcElementRequest::SetElementId(const string& _elementId)
{
    m_elementId = _elementId;
    m_elementIdHasBeenSet = true;
}

bool DeleteAigcElementRequest::ElementIdHasBeenSet() const
{
