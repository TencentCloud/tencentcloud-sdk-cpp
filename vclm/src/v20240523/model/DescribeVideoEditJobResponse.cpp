...
DescribeVideoEditJobResponse::DescribeVideoEditJobResponse() :
...
CoreInternalOutcome DescribeVideoEditJobResponse::Deserialize(const string &payload)
{
...
string DescribeVideoEditJobResponse::ToJsonString() const
{
...
string DescribeVideoEditJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeVideoEditJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeVideoEditJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeVideoEditJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

string DescribeVideoEditJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeVideoEditJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeVideoEditJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeVideoEditJobResponse::ErrorMessageHasBeenSet() const
{
