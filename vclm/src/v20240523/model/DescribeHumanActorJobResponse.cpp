...
DescribeHumanActorJobResponse::DescribeHumanActorJobResponse() :
...
CoreInternalOutcome DescribeHumanActorJobResponse::Deserialize(const string &payload)
{
...
string DescribeHumanActorJobResponse::ToJsonString() const
{
...
string DescribeHumanActorJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeHumanActorJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeHumanActorJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeHumanActorJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

string DescribeHumanActorJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeHumanActorJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeHumanActorJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeHumanActorJobResponse::ErrorMessageHasBeenSet() const
{
