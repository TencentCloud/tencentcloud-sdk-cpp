...
SubmitHumanActorJobResponse::SubmitHumanActorJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitHumanActorJobResponse::Deserialize(const string &payload)
{
...
string SubmitHumanActorJobResponse::ToJsonString() const
{
...
string SubmitHumanActorJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHumanActorJobResponse::JobIdHasBeenSet() const
{
