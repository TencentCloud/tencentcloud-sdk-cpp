...
DeleteAigcElementResponse::DeleteAigcElementResponse() :
    m_elementIdHasBeenSet(false),
    m_deletedHasBeenSet(false)
{
}

CoreInternalOutcome DeleteAigcElementResponse::Deserialize(const string &payload)
{
...
string DeleteAigcElementResponse::ToJsonString() const
{
...
string DeleteAigcElementResponse::GetElementId() const
{
    return m_elementId;
}

bool DeleteAigcElementResponse::ElementIdHasBeenSet() const
{
    return m_elementIdHasBeenSet;
}

bool DeleteAigcElementResponse::GetDeleted() const
{
    return m_deleted;
}

bool DeleteAigcElementResponse::DeletedHasBeenSet() const
{
