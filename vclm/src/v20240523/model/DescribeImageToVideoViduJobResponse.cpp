...
#include <tencentcloud/vclm/v20240523/model/DescribeImageToVideoViduJobResponse.h>
...
DescribeImageToVideoViduJobResponse::DescribeImageToVideoViduJobResponse() :
...
CoreInternalOutcome DescribeImageToVideoViduJobResponse::Deserialize(const string &payload)
{
...
string DescribeImageToVideoViduJobResponse::ToJsonString() const
{
...
string DescribeImageToVideoViduJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeImageToVideoViduJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeImageToVideoViduJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeImageToVideoViduJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeImageToVideoViduJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeImageToVideoViduJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeImageToVideoViduJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeImageToVideoViduJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

double DescribeImageToVideoViduJobResponse::GetCredits() const
{
    return m_credits;
}

bool DescribeImageToVideoViduJobResponse::CreditsHasBeenSet() const
{
    return m_creditsHasBeenSet;
}

string DescribeImageToVideoViduJobResponse::GetPayload() const
{
    return m_payload;
}

bool DescribeImageToVideoViduJobResponse::PayloadHasBeenSet() const
{
