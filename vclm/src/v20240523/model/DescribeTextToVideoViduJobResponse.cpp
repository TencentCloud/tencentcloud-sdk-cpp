...
#include <tencentcloud/vclm/v20240523/model/DescribeTextToVideoViduJobResponse.h>
...
DescribeTextToVideoViduJobResponse::DescribeTextToVideoViduJobResponse() :
...
CoreInternalOutcome DescribeTextToVideoViduJobResponse::Deserialize(const string &payload)
{
...
string DescribeTextToVideoViduJobResponse::ToJsonString() const
{
...
string DescribeTextToVideoViduJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeTextToVideoViduJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeTextToVideoViduJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeTextToVideoViduJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeTextToVideoViduJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeTextToVideoViduJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeTextToVideoViduJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeTextToVideoViduJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

double DescribeTextToVideoViduJobResponse::GetCredits() const
{
    return m_credits;
}

bool DescribeTextToVideoViduJobResponse::CreditsHasBeenSet() const
{
    return m_creditsHasBeenSet;
}

string DescribeTextToVideoViduJobResponse::GetPayload() const
{
    return m_payload;
}

bool DescribeTextToVideoViduJobResponse::PayloadHasBeenSet() const
{
