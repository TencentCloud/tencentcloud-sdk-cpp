...
DescribeImageToVideoGeneralJobResponse::DescribeImageToVideoGeneralJobResponse() :
...
CoreInternalOutcome DescribeImageToVideoGeneralJobResponse::Deserialize(const string &payload)
{
...
string DescribeImageToVideoGeneralJobResponse::ToJsonString() const
{
...
string DescribeImageToVideoGeneralJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeImageToVideoGeneralJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeImageToVideoGeneralJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeImageToVideoGeneralJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeImageToVideoGeneralJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeImageToVideoGeneralJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeImageToVideoGeneralJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeImageToVideoGeneralJobResponse::ResultVideoUrlHasBeenSet() const
{
