...
SubmitVideoEditJobResponse::SubmitVideoEditJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitVideoEditJobResponse::Deserialize(const string &payload)
{
...
string SubmitVideoEditJobResponse::ToJsonString() const
{
...
string SubmitVideoEditJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitVideoEditJobResponse::JobIdHasBeenSet() const
{
