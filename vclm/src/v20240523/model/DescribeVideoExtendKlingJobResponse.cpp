...
#include <tencentcloud/vclm/v20240523/model/DescribeVideoExtendKlingJobResponse.h>
...
DescribeVideoExtendKlingJobResponse::DescribeVideoExtendKlingJobResponse() :
...
CoreInternalOutcome DescribeVideoExtendKlingJobResponse::Deserialize(const string &payload)
{
...
string DescribeVideoExtendKlingJobResponse::ToJsonString() const
{
...
string DescribeVideoExtendKlingJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeVideoExtendKlingJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeVideoExtendKlingJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeVideoExtendKlingJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeVideoExtendKlingJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetDuration() const
{
    return m_duration;
}

bool DescribeVideoExtendKlingJobResponse::DurationHasBeenSet() const
{
    return m_durationHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetFinalUnitDeduction() const
{
    return m_finalUnitDeduction;
}

bool DescribeVideoExtendKlingJobResponse::FinalUnitDeductionHasBeenSet() const
{
    return m_finalUnitDeductionHasBeenSet;
}

string DescribeVideoExtendKlingJobResponse::GetVideoId() const
{
    return m_videoId;
}

bool DescribeVideoExtendKlingJobResponse::VideoIdHasBeenSet() const
{
