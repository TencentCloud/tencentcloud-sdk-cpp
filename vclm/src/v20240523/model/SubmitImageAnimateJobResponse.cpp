...
CoreInternalOutcome SubmitImageAnimateJobResponse::Deserialize(const string &payload)
{
...
string SubmitImageAnimateJobResponse::ToJsonString() const
{
...
string SubmitImageAnimateJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitImageAnimateJobResponse::JobIdHasBeenSet() const
{
