...
#include <tencentcloud/vclm/v20240523/model/DescribeHunyuanToVideoJobResponse.h>
...
DescribeHunyuanToVideoJobResponse::DescribeHunyuanToVideoJobResponse() :
...
CoreInternalOutcome DescribeHunyuanToVideoJobResponse::Deserialize(const string &payload)
{
...
string DescribeHunyuanToVideoJobResponse::ToJsonString() const
{
...
string DescribeHunyuanToVideoJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeHunyuanToVideoJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeHunyuanToVideoJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeHunyuanToVideoJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeHunyuanToVideoJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeHunyuanToVideoJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeHunyuanToVideoJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeHunyuanToVideoJobResponse::ResultVideoUrlHasBeenSet() const
{
