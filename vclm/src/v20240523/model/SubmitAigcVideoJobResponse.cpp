...
SubmitAigcVideoJobResponse::SubmitAigcVideoJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitAigcVideoJobResponse::Deserialize(const string &payload)
{
...
string SubmitAigcVideoJobResponse::ToJsonString() const
{
...
string SubmitAigcVideoJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitAigcVideoJobResponse::JobIdHasBeenSet() const
{
