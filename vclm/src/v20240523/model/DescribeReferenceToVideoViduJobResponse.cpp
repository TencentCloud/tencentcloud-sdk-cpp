...
#include <tencentcloud/vclm/v20240523/model/DescribeReferenceToVideoViduJobResponse.h>
...
DescribeReferenceToVideoViduJobResponse::DescribeReferenceToVideoViduJobResponse() :
...
CoreInternalOutcome DescribeReferenceToVideoViduJobResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Credits") && !rsp["Credits"].IsNull())
    {
        if (!rsp["Credits"].IsLosslessDouble())
        {
            return CoreInternalOutcome(Core::Error("response `Credits` IsLosslessDouble=false incorrectly").SetRequestId(requestId));
        }
        m_credits = rsp["Credits"].GetDouble();
...
string DescribeReferenceToVideoViduJobResponse::ToJsonString() const
{
...
string DescribeReferenceToVideoViduJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeReferenceToVideoViduJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeReferenceToVideoViduJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeReferenceToVideoViduJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeReferenceToVideoViduJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeReferenceToVideoViduJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeReferenceToVideoViduJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeReferenceToVideoViduJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

double DescribeReferenceToVideoViduJobResponse::GetCredits() const
{
    return m_credits;
}

bool DescribeReferenceToVideoViduJobResponse::CreditsHasBeenSet() const
{
    return m_creditsHasBeenSet;
}

string DescribeReferenceToVideoViduJobResponse::GetPayload() const
{
    return m_payload;
}

bool DescribeReferenceToVideoViduJobResponse::PayloadHasBeenSet() const
{
