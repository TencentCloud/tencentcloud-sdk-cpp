...
#include <tencentcloud/vclm/v20240523/model/SubmitVideoEditKlingJobResponse.h>
...
SubmitVideoEditKlingJobResponse::SubmitVideoEditKlingJobResponse() :
    m_jobIdHasBeenSet(false),
    m_externalTaskIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitVideoEditKlingJobResponse::Deserialize(const string &payload)
{
...
string SubmitVideoEditKlingJobResponse::ToJsonString() const
{
...
string SubmitVideoEditKlingJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitVideoEditKlingJobResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string SubmitVideoEditKlingJobResponse::GetExternalTaskId() const
{
    return m_externalTaskId;
}

bool SubmitVideoEditKlingJobResponse::ExternalTaskIdHasBeenSet() const
{
