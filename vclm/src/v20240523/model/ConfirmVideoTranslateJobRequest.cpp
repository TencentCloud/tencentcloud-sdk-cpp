...
vector<TranslateResult> ConfirmVideoTranslateJobRequest::GetTranslateResults() const
{
    return m_translateResults;
}

void ConfirmVideoTranslateJobRequest::SetTranslateResults(const vector<TranslateResult>& _translateResults)
{
