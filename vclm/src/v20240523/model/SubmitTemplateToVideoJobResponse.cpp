...
SubmitTemplateToVideoJobResponse::SubmitTemplateToVideoJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitTemplateToVideoJobResponse::Deserialize(const string &payload)
{
...
string SubmitTemplateToVideoJobResponse::ToJsonString() const
{
...
string SubmitTemplateToVideoJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitTemplateToVideoJobResponse::JobIdHasBeenSet() const
{
