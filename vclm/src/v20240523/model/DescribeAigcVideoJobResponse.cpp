...
DescribeAigcVideoJobResponse::DescribeAigcVideoJobResponse() :
...
CoreInternalOutcome DescribeAigcVideoJobResponse::Deserialize(const string &payload)
{
...
string DescribeAigcVideoJobResponse::ToJsonString() const
{
...
string DescribeAigcVideoJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAigcVideoJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeAigcVideoJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeAigcVideoJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeAigcVideoJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeAigcVideoJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeAigcVideoJobResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool DescribeAigcVideoJobResponse::ResultUrlHasBeenSet() const
{
