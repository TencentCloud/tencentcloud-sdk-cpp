...
#include <tencentcloud/vclm/v20240523/model/SubmitMotionControlKlingJobResponse.h>
...
SubmitMotionControlKlingJobResponse::SubmitMotionControlKlingJobResponse() :
    m_jobIdHasBeenSet(false),
    m_externalTaskIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitMotionControlKlingJobResponse::Deserialize(const string &payload)
{
...
string SubmitMotionControlKlingJobResponse::ToJsonString() const
{
...
string SubmitMotionControlKlingJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitMotionControlKlingJobResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string SubmitMotionControlKlingJobResponse::GetExternalTaskId() const
{
    return m_externalTaskId;
}

bool SubmitMotionControlKlingJobResponse::ExternalTaskIdHasBeenSet() const
{
