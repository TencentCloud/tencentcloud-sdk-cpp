...
CheckAnimateImageJobResponse::CheckAnimateImageJobResponse() :
    m_checkPassHasBeenSet(false)
{
}

CoreInternalOutcome CheckAnimateImageJobResponse::Deserialize(const string &payload)
{
...
string CheckAnimateImageJobResponse::ToJsonString() const
{
...
bool CheckAnimateImageJobResponse::GetCheckPass() const
{
    return m_checkPass;
}

bool CheckAnimateImageJobResponse::CheckPassHasBeenSet() const
{
