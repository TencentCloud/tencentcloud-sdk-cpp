...
DescribeVideoFaceFusionJobResponse::DescribeVideoFaceFusionJobResponse() :
...
CoreInternalOutcome DescribeVideoFaceFusionJobResponse::Deserialize(const string &payload)
{
...
string DescribeVideoFaceFusionJobResponse::ToJsonString() const
{
...
string DescribeVideoFaceFusionJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeVideoFaceFusionJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeVideoFaceFusionJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeVideoFaceFusionJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeVideoFaceFusionJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeVideoFaceFusionJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeVideoFaceFusionJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeVideoFaceFusionJobResponse::ResultVideoUrlHasBeenSet() const
{
