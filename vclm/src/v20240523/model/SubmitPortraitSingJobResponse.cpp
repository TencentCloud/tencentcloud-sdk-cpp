...
SubmitPortraitSingJobResponse::SubmitPortraitSingJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitPortraitSingJobResponse::Deserialize(const string &payload)
{
...
string SubmitPortraitSingJobResponse::ToJsonString() const
{
...
string SubmitPortraitSingJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitPortraitSingJobResponse::JobIdHasBeenSet() const
{
