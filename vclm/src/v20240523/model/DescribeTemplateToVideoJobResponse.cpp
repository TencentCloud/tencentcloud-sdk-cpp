...
DescribeTemplateToVideoJobResponse::DescribeTemplateToVideoJobResponse() :
...
CoreInternalOutcome DescribeTemplateToVideoJobResponse::Deserialize(const string &payload)
{
...
string DescribeTemplateToVideoJobResponse::ToJsonString() const
{
...
string DescribeTemplateToVideoJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeTemplateToVideoJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeTemplateToVideoJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeTemplateToVideoJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeTemplateToVideoJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeTemplateToVideoJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeTemplateToVideoJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeTemplateToVideoJobResponse::ResultVideoUrlHasBeenSet() const
{
