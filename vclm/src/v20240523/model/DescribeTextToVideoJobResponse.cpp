...
DescribeTextToVideoJobResponse::DescribeTextToVideoJobResponse() :
...
CoreInternalOutcome DescribeTextToVideoJobResponse::Deserialize(const string &payload)
{
...
string DescribeTextToVideoJobResponse::ToJsonString() const
{
...
string DescribeTextToVideoJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeTextToVideoJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeTextToVideoJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeTextToVideoJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeTextToVideoJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetVideoId() const
{
    return m_videoId;
}

bool DescribeTextToVideoJobResponse::VideoIdHasBeenSet() const
{
    return m_videoIdHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetDuration() const
{
    return m_duration;
}

bool DescribeTextToVideoJobResponse::DurationHasBeenSet() const
{
    return m_durationHasBeenSet;
}

string DescribeTextToVideoJobResponse::GetFinalUnitDeduction() const
{
