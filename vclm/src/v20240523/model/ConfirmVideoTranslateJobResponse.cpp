...
CoreInternalOutcome ConfirmVideoTranslateJobResponse::Deserialize(const string &payload)
{
...
string ConfirmVideoTranslateJobResponse::ToJsonString() const
{
...
string ConfirmVideoTranslateJobResponse::GetJobId() const
{
    return m_jobId;
}

bool ConfirmVideoTranslateJobResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

string ConfirmVideoTranslateJobResponse::GetTaskId() const
{
    return m_taskId;
}

bool ConfirmVideoTranslateJobResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string ConfirmVideoTranslateJobResponse::GetSessionId() const
{
    return m_sessionId;
}
