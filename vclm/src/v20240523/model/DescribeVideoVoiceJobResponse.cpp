...
DescribeVideoVoiceJobResponse::DescribeVideoVoiceJobResponse() :
...
CoreInternalOutcome DescribeVideoVoiceJobResponse::Deserialize(const string &payload)
{
...
string DescribeVideoVoiceJobResponse::ToJsonString() const
{
...
string DescribeVideoVoiceJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeVideoVoiceJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeVideoVoiceJobResponse::GetResultVideoUrl() const
{
    return m_resultVideoUrl;
}

bool DescribeVideoVoiceJobResponse::ResultVideoUrlHasBeenSet() const
{
    return m_resultVideoUrlHasBeenSet;
}

string DescribeVideoVoiceJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeVideoVoiceJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeVideoVoiceJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeVideoVoiceJobResponse::ErrorMessageHasBeenSet() const
{
