...
string SubmitVideoEditJobRequest::ToJsonString() const
{
...
string SubmitVideoEditJobRequest::GetVideoUrl() const
{
    return m_videoUrl;
}

void SubmitVideoEditJobRequest::SetVideoUrl(const string& _videoUrl)
{
    m_videoUrl = _videoUrl;
    m_videoUrlHasBeenSet = true;
}

bool SubmitVideoEditJobRequest::VideoUrlHasBeenSet() const
{
    return m_videoUrlHasBeenSet;
}

string SubmitVideoEditJobRequest::GetPrompt() const
{
    return m_prompt;
}

void SubmitVideoEditJobRequest::SetPrompt(const string& _prompt)
{
    m_prompt = _prompt;
...
void SubmitVideoEditJobRequest::SetImage(const Image& _image)
{
    m_image = _image;
...
void SubmitVideoEditJobRequest::SetLogoAdd(const int64_t& _logoAdd)
{
    m_logoAdd = _logoAdd;
    m_logoAddHasBeenSet = true;
}

bool SubmitVideoEditJobRequest::LogoAddHasBeenSet() const
{
    return m_logoAddHasBeenSet;
}

LogoParam SubmitVideoEditJobRequest::GetLogoParam() const
{
    return m_logoParam;
}

void SubmitVideoEditJobRequest::SetLogoParam(const LogoParam& _logoParam)
{
    m_logoParam = _logoParam;
    m_logoParamHasBeenSet = true;
}

bool SubmitVideoEditJobRequest::LogoParamHasBeenSet() const
{
