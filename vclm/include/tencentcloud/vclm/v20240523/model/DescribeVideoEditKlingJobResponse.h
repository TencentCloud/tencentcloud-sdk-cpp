...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITKLINGJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITKLINGJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoEditKlingJobResponse : public AbstractModel
                {
                public:
                    DescribeVideoEditKlingJobResponse();
                    ~DescribeVideoEditKlingJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITKLINGJOBRESPONSE_H_
