...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeMotionControlKlingJobResponse : public AbstractModel
                {
                public:
                    DescribeMotionControlKlingJobResponse();
                    ~DescribeMotionControlKlingJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBRESPONSE_H_
