...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBREQUEST_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBREQUEST_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeImageToVideoJobRequest : public AbstractModel
                {
                public:
                    DescribeImageToVideoJobRequest();
                    ~DescribeImageToVideoJobRequest() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBREQUEST_H_
