...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOVOICEJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOVOICEJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoVoiceJobResponse : public AbstractModel
                {
                public:
                    DescribeVideoVoiceJobResponse();
                    ~DescribeVideoVoiceJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOVOICEJOBRESPONSE_H_
