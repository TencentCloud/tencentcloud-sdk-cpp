...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOFACEFUSIONJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOFACEFUSIONJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoFaceFusionJobResponse : public AbstractModel
                {
                public:
                    DescribeVideoFaceFusionJobResponse();
                    ~DescribeVideoFaceFusionJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOFACEFUSIONJOBRESPONSE_H_
