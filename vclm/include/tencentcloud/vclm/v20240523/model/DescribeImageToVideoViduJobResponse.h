...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOVIDUJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOVIDUJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeImageToVideoViduJobResponse : public AbstractModel
                {
                public:
                    DescribeImageToVideoViduJobResponse();
                    ~DescribeImageToVideoViduJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOVIDUJOBRESPONSE_H_
