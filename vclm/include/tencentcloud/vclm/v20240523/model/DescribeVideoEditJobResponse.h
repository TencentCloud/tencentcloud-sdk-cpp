...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeVideoEditJobResponse : public AbstractModel
                {
                public:
                    DescribeVideoEditJobResponse();
                    ~DescribeVideoEditJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEVIDEOEDITJOBRESPONSE_H_
