...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITVIDEOVOICEJOBREQUEST_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITVIDEOVOICEJOBREQUEST_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class SubmitVideoVoiceJobRequest : public AbstractModel
                {
                public:
                    SubmitVideoVoiceJobRequest();
                    ~SubmitVideoVoiceJobRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取输入视频的Url  上传视频时长限制：1-15s 视频格式：MP4，MOV 视频大小：不超过1 GB URL地址中不能包含中文字符。
                    ...
                    /**
                     * 设置输入视频的Url  上传视频时长限制：1-15s 视频格式：MP4，MOV 视频大小：不超过1 GB URL地址中不能包含中文字符。
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITVIDEOVOICEJOBREQUEST_H_
