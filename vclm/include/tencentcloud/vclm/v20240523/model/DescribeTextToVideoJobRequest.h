...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBREQUEST_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBREQUEST_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeTextToVideoJobRequest : public AbstractModel
                {
                public:
                    DescribeTextToVideoJobRequest();
                    ~DescribeTextToVideoJobRequest() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBREQUEST_H_
