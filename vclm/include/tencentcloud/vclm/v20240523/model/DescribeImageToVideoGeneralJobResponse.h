...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOGENERALJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOGENERALJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeImageToVideoGeneralJobResponse : public AbstractModel
                {
                public:
                    DescribeImageToVideoGeneralJobResponse();
                    ~DescribeImageToVideoGeneralJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOGENERALJOBRESPONSE_H_
