...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUMANACTORJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUMANACTORJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeHumanActorJobResponse : public AbstractModel
                {
                public:
                    DescribeHumanActorJobResponse();
                    ~DescribeHumanActorJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUMANACTORJOBRESPONSE_H_
