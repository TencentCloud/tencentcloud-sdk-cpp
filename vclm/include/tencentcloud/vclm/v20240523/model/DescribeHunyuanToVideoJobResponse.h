...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUNYUANTOVIDEOJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUNYUANTOVIDEOJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeHunyuanToVideoJobResponse : public AbstractModel
                {
                public:
                    DescribeHunyuanToVideoJobResponse();
                    ~DescribeHunyuanToVideoJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEHUNYUANTOVIDEOJOBRESPONSE_H_
