...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBREQUEST_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBREQUEST_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeMotionControlKlingJobRequest : public AbstractModel
                {
                public:
                    DescribeMotionControlKlingJobRequest();
                    ~DescribeMotionControlKlingJobRequest() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEMOTIONCONTROLKLINGJOBREQUEST_H_
