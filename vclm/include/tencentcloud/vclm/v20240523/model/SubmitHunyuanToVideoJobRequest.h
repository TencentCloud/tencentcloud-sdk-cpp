...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITHUNYUANTOVIDEOJOBREQUEST_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITHUNYUANTOVIDEOJOBREQUEST_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class SubmitHunyuanToVideoJobRequest : public AbstractModel
                {
                public:
                    SubmitHunyuanToVideoJobRequest();
                    ~SubmitHunyuanToVideoJobRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取视频内容的描述，中文正向提示词。最多支持200个 utf-8 字符（首尾空格不计入字符数）。 示例值：一只猫在草原上奔跑，写实风格
                     * @return Prompt 视频内容的描述，中文正向提示词。最多支持200个 utf-8 字符（首尾空格不计入字符数）。 示例值：一只猫在草原上奔跑，写实风格
                     * 
                     */
                    std::string GetPrompt() const;

                    /**
                     * 设置视频内容的描述，中文正向提示词。最多支持200个 utf-8 字符（首尾空格不计入字符数）。 示例值：一只猫在草原上奔跑，写实风格
...
单边分辨率不超过5000，不小于50，长宽限制1:4 ~ 4:1
                    ...
                    /**
                     * 获取目前仅支持720p视频分辨率，默认720p。
                     * @return Resolution 目前仅支持720p视频分辨率，默认720p。
                     * 
                     */
                    std::string GetResolution() const;

                    /**
                     * 设置目前仅支持720p视频分辨率，默认720p。
                    ...
                    /**
                     * 获取为生成视频添加标识的开关，默认为1，0 需前往 控制台 申请开启显示标识自主完成方可生效。
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
                     * @return LogoAdd 为生成视频添加标识的开关，默认为1，0 需前往 控制台 申请开启显示标识自主完成方可生效。
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
                     * 
                     */
                    ...
                    /**
                     * 设置为生成视频添加标识的开关，默认为1，0 需前往 控制台 申请开启显示标识自主完成方可生效。
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_SUBMITHUNYUANTOVIDEOJOBREQUEST_H_
