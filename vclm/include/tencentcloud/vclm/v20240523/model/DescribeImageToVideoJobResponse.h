...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeImageToVideoJobResponse : public AbstractModel
                {
                public:
                    DescribeImageToVideoJobResponse();
                    ~DescribeImageToVideoJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBEIMAGETOVIDEOJOBRESPONSE_H_
