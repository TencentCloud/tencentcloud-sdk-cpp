...
#ifndef TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBRESPONSE_H_
#define TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBRESPONSE_H_
    ...
    namespace Vclm
    {
        namespace V20240523
        {
            namespace Model
            {
                ...
                */
                class DescribeTextToVideoJobResponse : public AbstractModel
                {
                public:
                    DescribeTextToVideoJobResponse();
                    ~DescribeTextToVideoJobResponse() = default;
...
#endif // !TENCENTCLOUD_VCLM_V20240523_MODEL_DESCRIBETEXTTOVIDEOJOBRESPONSE_H_
