...
#ifndef TENCENTCLOUD_FT_V20200304_MODEL_SWAPGENDERPICRESPONSE_H_
#define TENCENTCLOUD_FT_V20200304_MODEL_SWAPGENDERPICRESPONSE_H_
    ...
    namespace Ft
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                */
                class SwapGenderPicResponse : public AbstractModel
                {
                public:
                    SwapGenderPicResponse();
                    ~SwapGenderPicResponse() = default;
...
#endif // !TENCENTCLOUD_FT_V20200304_MODEL_SWAPGENDERPICRESPONSE_H_
