...
CoreInternalOutcome MorphFaceResponse::Deserialize(const string &payload)
{
...
string MorphFaceResponse::ToJsonString() const
{
...
string MorphFaceResponse::GetJobId() const
{
    return m_jobId;
}

bool MorphFaceResponse::JobIdHasBeenSet() const
{
    return m_jobIdHasBeenSet;
}

int64_t MorphFaceResponse::GetEstimatedProcessTime() const
{
    return m_estimatedProcessTime;
}

bool MorphFaceResponse::EstimatedProcessTimeHasBeenSet() const
{
