...
CoreInternalOutcome ChangeAgePicResponse::Deserialize(const string &payload)
{
...
string ChangeAgePicResponse::ToJsonString() const
{
...
string ChangeAgePicResponse::GetResultImage() const
{
    return m_resultImage;
}

bool ChangeAgePicResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

string ChangeAgePicResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool ChangeAgePicResponse::ResultUrlHasBeenSet() const
{
