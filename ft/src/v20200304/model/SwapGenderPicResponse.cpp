...
CoreInternalOutcome SwapGenderPicResponse::Deserialize(const string &payload)
{
...
string SwapGenderPicResponse::ToJsonString() const
{
...
string SwapGenderPicResponse::GetResultImage() const
{
