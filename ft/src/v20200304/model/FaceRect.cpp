...
CoreInternalOutcome FaceRect::Deserialize(const Value &value)
{
    ...
    if (value.HasMember("Width") && !value["Width"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FaceRect.Width` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Height") && !value["Height"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FaceRect.Height` IsInt64=false incorrectly").SetRequestId(requestId));
        }
