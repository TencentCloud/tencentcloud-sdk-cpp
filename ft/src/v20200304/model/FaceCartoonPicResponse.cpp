...
CoreInternalOutcome FaceCartoonPicResponse::Deserialize(const string &payload)
{
...
string FaceCartoonPicResponse::ToJsonString() const
{
...
string FaceCartoonPicResponse::GetResultImage() const
{
    return m_resultImage;
}

bool FaceCartoonPicResponse::ResultImageHasBeenSet() const
{
    return m_resultImageHasBeenSet;
}

string FaceCartoonPicResponse::GetResultUrl() const
{
    return m_resultUrl;
}

bool FaceCartoonPicResponse::ResultUrlHasBeenSet() const
{
