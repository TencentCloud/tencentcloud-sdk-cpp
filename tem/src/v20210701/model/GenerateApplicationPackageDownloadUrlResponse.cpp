...
CoreInternalOutcome GenerateApplicationPackageDownloadUrlResponse::Deserialize(const string &payload)
{
...
string GenerateApplicationPackageDownloadUrlResponse::ToJsonString() const
{
...
string GenerateApplicationPackageDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool GenerateApplicationPackageDownloadUrlResponse::ResultHasBeenSet() const
{
