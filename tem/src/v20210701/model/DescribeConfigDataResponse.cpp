...
CoreInternalOutcome DescribeConfigDataResponse::Deserialize(const string &payload)
{
...
string DescribeConfigDataResponse::ToJsonString() const
{
...
ConfigData DescribeConfigDataResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigDataResponse::ResultHasBeenSet() const
{
