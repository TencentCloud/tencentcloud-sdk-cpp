...
CoreInternalOutcome CreateApplicationServiceResponse::Deserialize(const string &payload)
{
...
string CreateApplicationServiceResponse::ToJsonString() const
{
...
bool CreateApplicationServiceResponse::GetResult() const
{
    return m_result;
}

bool CreateApplicationServiceResponse::ResultHasBeenSet() const
{
