...
CoreInternalOutcome ResumeDeployApplicationResponse::Deserialize(const string &payload)
{
...
string ResumeDeployApplicationResponse::ToJsonString() const
{
...
bool ResumeDeployApplicationResponse::GetResult() const
{
    return m_result;
}

bool ResumeDeployApplicationResponse::ResultHasBeenSet() const
{
