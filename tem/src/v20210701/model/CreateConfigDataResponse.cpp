...
CoreInternalOutcome CreateConfigDataResponse::Deserialize(const string &payload)
{
...
string CreateConfigDataResponse::ToJsonString() const
{
...
bool CreateConfigDataResponse::GetResult() const
{
    return m_result;
}

bool CreateConfigDataResponse::ResultHasBeenSet() const
{
