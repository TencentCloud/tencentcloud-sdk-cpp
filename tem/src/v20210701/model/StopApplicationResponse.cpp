...
CoreInternalOutcome StopApplicationResponse::Deserialize(const string &payload)
{
...
string StopApplicationResponse::ToJsonString() const
{
...
bool StopApplicationResponse::GetResult() const
{
    return m_result;
}

bool StopApplicationResponse::ResultHasBeenSet() const
{
