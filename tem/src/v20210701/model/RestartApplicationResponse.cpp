...
CoreInternalOutcome RestartApplicationResponse::Deserialize(const string &payload)
{
...
string RestartApplicationResponse::ToJsonString() const
{
...
bool RestartApplicationResponse::GetResult() const
{
    return m_result;
}

bool RestartApplicationResponse::ResultHasBeenSet() const
{
