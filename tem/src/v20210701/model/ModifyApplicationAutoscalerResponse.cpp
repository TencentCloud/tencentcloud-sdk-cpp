...
CoreInternalOutcome ModifyApplicationAutoscalerResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationAutoscalerResponse::ToJsonString() const
{
...
bool ModifyApplicationAutoscalerResponse::GetResult() const
{
    return m_result;
}

bool ModifyApplicationAutoscalerResponse::ResultHasBeenSet() const
{
