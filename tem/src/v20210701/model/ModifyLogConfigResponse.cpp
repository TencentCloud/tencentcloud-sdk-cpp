...
CoreInternalOutcome ModifyLogConfigResponse::Deserialize(const string &payload)
{
...
string ModifyLogConfigResponse::ToJsonString() const
{
...
bool ModifyLogConfigResponse::GetResult() const
{
    return m_result;
}

bool ModifyLogConfigResponse::ResultHasBeenSet() const
{
