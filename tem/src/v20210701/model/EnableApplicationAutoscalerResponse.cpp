...
CoreInternalOutcome EnableApplicationAutoscalerResponse::Deserialize(const string &payload)
{
...
string EnableApplicationAutoscalerResponse::ToJsonString() const
{
...
bool EnableApplicationAutoscalerResponse::GetResult() const
{
    return m_result;
}

bool EnableApplicationAutoscalerResponse::ResultHasBeenSet() const
{
