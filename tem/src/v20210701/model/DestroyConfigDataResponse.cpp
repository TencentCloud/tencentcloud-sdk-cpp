...
CoreInternalOutcome DestroyConfigDataResponse::Deserialize(const string &payload)
{
...
string DestroyConfigDataResponse::ToJsonString() const
{
...
bool DestroyConfigDataResponse::GetResult() const
{
    return m_result;
}

bool DestroyConfigDataResponse::ResultHasBeenSet() const
{
