...
CoreInternalOutcome DescribePagedLogConfigListResponse::Deserialize(const string &payload)
{
...
string DescribePagedLogConfigListResponse::ToJsonString() const
{
...
LogConfigListPage DescribePagedLogConfigListResponse::GetResult() const
{
    return m_result;
}

bool DescribePagedLogConfigListResponse::ResultHasBeenSet() const
{
