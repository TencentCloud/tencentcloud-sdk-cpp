...
CoreInternalOutcome RevertDeployApplicationResponse::Deserialize(const string &payload)
{
...
string RevertDeployApplicationResponse::ToJsonString() const
{
...
bool RevertDeployApplicationResponse::GetResult() const
{
    return m_result;
}

bool RevertDeployApplicationResponse::ResultHasBeenSet() const
{
