...
CoreInternalOutcome DescribeEnvironmentResponse::Deserialize(const string &payload)
{
...
string DescribeEnvironmentResponse::ToJsonString() const
{
...
NamespaceInfo DescribeEnvironmentResponse::GetResult() const
{
    return m_result;
}

bool DescribeEnvironmentResponse::ResultHasBeenSet() const
{
