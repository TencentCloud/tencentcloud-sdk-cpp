...
CoreInternalOutcome DescribeApplicationInfoResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationInfoResponse::ToJsonString() const
{
...
TemServiceVersionInfo DescribeApplicationInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationInfoResponse::ResultHasBeenSet() const
{
