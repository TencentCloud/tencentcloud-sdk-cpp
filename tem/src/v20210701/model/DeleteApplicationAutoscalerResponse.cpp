...
CoreInternalOutcome DeleteApplicationAutoscalerResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationAutoscalerResponse::ToJsonString() const
{
...
bool DeleteApplicationAutoscalerResponse::GetResult() const
{
    return m_result;
}

bool DeleteApplicationAutoscalerResponse::ResultHasBeenSet() const
{
