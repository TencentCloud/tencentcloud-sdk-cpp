...
CoreInternalOutcome DescribeApplicationServiceListResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationServiceListResponse::ToJsonString() const
{
...
EksService DescribeApplicationServiceListResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationServiceListResponse::ResultHasBeenSet() const
{
