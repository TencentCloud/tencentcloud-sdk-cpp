...
CoreInternalOutcome DescribeApplicationAutoscalerListResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationAutoscalerListResponse::ToJsonString() const
{
...
vector<Autoscaler> DescribeApplicationAutoscalerListResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationAutoscalerListResponse::ResultHasBeenSet() const
{
