...
CoreInternalOutcome ModifyIngressResponse::Deserialize(const string &payload)
{
...
string ModifyIngressResponse::ToJsonString() const
{
...
bool ModifyIngressResponse::GetResult() const
{
    return m_result;
}

bool ModifyIngressResponse::ResultHasBeenSet() const
{
