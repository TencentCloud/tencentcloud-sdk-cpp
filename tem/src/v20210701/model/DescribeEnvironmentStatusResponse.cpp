...
CoreInternalOutcome DescribeEnvironmentStatusResponse::Deserialize(const string &payload)
{
...
string DescribeEnvironmentStatusResponse::ToJsonString() const
{
...
vector<NamespaceStatusInfo> DescribeEnvironmentStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeEnvironmentStatusResponse::ResultHasBeenSet() const
{
