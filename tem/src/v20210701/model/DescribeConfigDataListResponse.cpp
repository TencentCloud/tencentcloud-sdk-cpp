...
CoreInternalOutcome DescribeConfigDataListResponse::Deserialize(const string &payload)
{
...
string DescribeConfigDataListResponse::ToJsonString() const
{
...
DescribeConfigDataListPage DescribeConfigDataListResponse::GetResult() const
{
    return m_result;
}

bool DescribeConfigDataListResponse::ResultHasBeenSet() const
{
