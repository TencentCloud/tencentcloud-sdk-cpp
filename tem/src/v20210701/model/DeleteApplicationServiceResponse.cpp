...
CoreInternalOutcome DeleteApplicationServiceResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationServiceResponse::ToJsonString() const
{
...
bool DeleteApplicationServiceResponse::GetResult() const
{
    return m_result;
}

bool DeleteApplicationServiceResponse::ResultHasBeenSet() const
{
