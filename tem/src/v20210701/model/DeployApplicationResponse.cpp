...
CoreInternalOutcome DeployApplicationResponse::Deserialize(const string &payload)
{
...
string DeployApplicationResponse::ToJsonString() const
{
...
string DeployApplicationResponse::GetResult() const
{
    return m_result;
}

bool DeployApplicationResponse::ResultHasBeenSet() const
{
