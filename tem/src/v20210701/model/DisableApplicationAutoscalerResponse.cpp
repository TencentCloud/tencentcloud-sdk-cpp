...
CoreInternalOutcome DisableApplicationAutoscalerResponse::Deserialize(const string &payload)
{
...
string DisableApplicationAutoscalerResponse::ToJsonString() const
{
...
bool DisableApplicationAutoscalerResponse::GetResult() const
{
    return m_result;
}

bool DisableApplicationAutoscalerResponse::ResultHasBeenSet() const
{
