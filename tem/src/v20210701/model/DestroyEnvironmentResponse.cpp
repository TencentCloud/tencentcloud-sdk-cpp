...
CoreInternalOutcome DestroyEnvironmentResponse::Deserialize(const string &payload)
{
...
string DestroyEnvironmentResponse::ToJsonString() const
{
...
bool DestroyEnvironmentResponse::GetResult() const
{
    return m_result;
}

bool DestroyEnvironmentResponse::ResultHasBeenSet() const
{
