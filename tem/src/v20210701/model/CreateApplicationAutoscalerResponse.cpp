...
CoreInternalOutcome CreateApplicationAutoscalerResponse::Deserialize(const string &payload)
{
...
string CreateApplicationAutoscalerResponse::ToJsonString() const
{
...
string CreateApplicationAutoscalerResponse::GetResult() const
{
    return m_result;
}

bool CreateApplicationAutoscalerResponse::ResultHasBeenSet() const
{
