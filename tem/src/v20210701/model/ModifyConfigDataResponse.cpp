...
CoreInternalOutcome ModifyConfigDataResponse::Deserialize(const string &payload)
{
...
string ModifyConfigDataResponse::ToJsonString() const
{
...
bool ModifyConfigDataResponse::GetResult() const
{
    return m_result;
}

bool ModifyConfigDataResponse::ResultHasBeenSet() const
{
