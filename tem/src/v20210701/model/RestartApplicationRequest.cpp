...
string RestartApplicationRequest::ToJsonString() const
{
...
string RestartApplicationRequest::GetApplicationId() const
{
    return m_applicationId;
}

void RestartApplicationRequest::SetApplicationId(const string& _applicationId)
{
    m_applicationId = _applicationId;
    m_applicationIdHasBeenSet = true;
}

bool RestartApplicationRequest::ApplicationIdHasBeenSet() const
{
...
void RestartApplicationRequest::SetEnvironmentId(const string& _environmentId)
{
