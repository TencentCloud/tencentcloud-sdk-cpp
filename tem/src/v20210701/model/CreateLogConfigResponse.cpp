...
CoreInternalOutcome CreateLogConfigResponse::Deserialize(const string &payload)
{
...
string CreateLogConfigResponse::ToJsonString() const
{
...
bool CreateLogConfigResponse::GetResult() const
{
    return m_result;
}

bool CreateLogConfigResponse::ResultHasBeenSet() const
{
