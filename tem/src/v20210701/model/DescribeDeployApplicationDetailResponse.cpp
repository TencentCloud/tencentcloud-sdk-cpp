...
CoreInternalOutcome DescribeDeployApplicationDetailResponse::Deserialize(const string &payload)
{
...
string DescribeDeployApplicationDetailResponse::ToJsonString() const
{
...
TemDeployApplicationDetailInfo DescribeDeployApplicationDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeDeployApplicationDetailResponse::ResultHasBeenSet() const
{
