...
CoreInternalOutcome ModifyEnvironmentResponse::Deserialize(const string &payload)
{
...
string ModifyEnvironmentResponse::ToJsonString() const
{
...
bool ModifyEnvironmentResponse::GetResult() const
{
    return m_result;
}

bool ModifyEnvironmentResponse::ResultHasBeenSet() const
{
