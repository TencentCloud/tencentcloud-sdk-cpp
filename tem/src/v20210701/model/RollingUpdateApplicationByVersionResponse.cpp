...
CoreInternalOutcome RollingUpdateApplicationByVersionResponse::Deserialize(const string &payload)
{
...
string RollingUpdateApplicationByVersionResponse::ToJsonString() const
{
...
string RollingUpdateApplicationByVersionResponse::GetResult() const
{
    return m_result;
}

bool RollingUpdateApplicationByVersionResponse::ResultHasBeenSet() const
{
