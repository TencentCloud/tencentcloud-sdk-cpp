...
CoreInternalOutcome ModifyApplicationInfoResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationInfoResponse::ToJsonString() const
{
...
bool ModifyApplicationInfoResponse::GetResult() const
{
    return m_result;
}

bool ModifyApplicationInfoResponse::ResultHasBeenSet() const
{
