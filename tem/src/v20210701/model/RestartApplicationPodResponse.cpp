...
CoreInternalOutcome RestartApplicationPodResponse::Deserialize(const string &payload)
{
...
string RestartApplicationPodResponse::ToJsonString() const
{
...
bool RestartApplicationPodResponse::GetResult() const
{
    return m_result;
}

bool RestartApplicationPodResponse::ResultHasBeenSet() const
{
