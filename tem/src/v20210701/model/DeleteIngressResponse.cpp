...
CoreInternalOutcome DeleteIngressResponse::Deserialize(const string &payload)
{
...
string DeleteIngressResponse::ToJsonString() const
{
...
bool DeleteIngressResponse::GetResult() const
{
    return m_result;
}

bool DeleteIngressResponse::ResultHasBeenSet() const
{
