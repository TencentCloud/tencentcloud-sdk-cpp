...
CoreInternalOutcome ModifyApplicationServiceResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationServiceResponse::ToJsonString() const
{
...
bool ModifyApplicationServiceResponse::GetResult() const
{
    return m_result;
}

bool ModifyApplicationServiceResponse::ResultHasBeenSet() const
{
