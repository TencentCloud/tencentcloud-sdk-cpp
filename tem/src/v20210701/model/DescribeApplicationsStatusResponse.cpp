...
CoreInternalOutcome DescribeApplicationsStatusResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationsStatusResponse::ToJsonString() const
{
...
vector<ServiceVersionBrief> DescribeApplicationsStatusResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationsStatusResponse::ResultHasBeenSet() const
{
