...
CoreInternalOutcome DescribeApplicationPodsResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationPodsResponse::ToJsonString() const
{
...
DescribeRunPodPage DescribeApplicationPodsResponse::GetResult() const
{
    return m_result;
}

bool DescribeApplicationPodsResponse::ResultHasBeenSet() const
{
