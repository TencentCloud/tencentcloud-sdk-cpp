...
CoreInternalOutcome CreateServiceV2Response::Deserialize(const string &payload)
{
...
string CreateServiceV2Response::ToJsonString() const
{
...
string CreateServiceV2Response::GetResult() const
{
    return m_result;
}

bool CreateServiceV2Response::ResultHasBeenSet() const
{
