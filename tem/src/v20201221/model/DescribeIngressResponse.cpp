...
CoreInternalOutcome DescribeIngressResponse::Deserialize(const string &payload)
{
...
string DescribeIngressResponse::ToJsonString() const
{
...
IngressInfo DescribeIngressResponse::GetResult() const
{
    return m_result;
}

bool DescribeIngressResponse::ResultHasBeenSet() const
{
