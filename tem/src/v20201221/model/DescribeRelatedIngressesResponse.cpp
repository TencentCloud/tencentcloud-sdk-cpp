...
CoreInternalOutcome DescribeRelatedIngressesResponse::Deserialize(const string &payload)
{
...
string DescribeRelatedIngressesResponse::ToJsonString() const
{
...
vector<IngressInfo> DescribeRelatedIngressesResponse::GetResult() const
{
    return m_result;
}

bool DescribeRelatedIngressesResponse::ResultHasBeenSet() const
{
