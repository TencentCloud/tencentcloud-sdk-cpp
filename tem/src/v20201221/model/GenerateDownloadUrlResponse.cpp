...
CoreInternalOutcome GenerateDownloadUrlResponse::Deserialize(const string &payload)
{
...
string GenerateDownloadUrlResponse::ToJsonString() const
{
...
string GenerateDownloadUrlResponse::GetResult() const
{
    return m_result;
}

bool GenerateDownloadUrlResponse::ResultHasBeenSet() const
{
