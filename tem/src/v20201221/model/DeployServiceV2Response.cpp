...
CoreInternalOutcome DeployServiceV2Response::Deserialize(const string &payload)
{
...
string DeployServiceV2Response::ToJsonString() const
{
...
string DeployServiceV2Response::GetResult() const
{
    return m_result;
}

bool DeployServiceV2Response::ResultHasBeenSet() const
{
