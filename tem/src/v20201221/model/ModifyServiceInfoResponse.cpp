...
CoreInternalOutcome ModifyServiceInfoResponse::Deserialize(const string &payload)
{
...
string ModifyServiceInfoResponse::ToJsonString() const
{
...
bool ModifyServiceInfoResponse::GetResult() const
{
    return m_result;
}

bool ModifyServiceInfoResponse::ResultHasBeenSet() const
{
