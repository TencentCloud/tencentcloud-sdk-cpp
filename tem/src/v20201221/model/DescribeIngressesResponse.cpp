...
CoreInternalOutcome DescribeIngressesResponse::Deserialize(const string &payload)
{
...
string DescribeIngressesResponse::ToJsonString() const
{
...
vector<IngressInfo> DescribeIngressesResponse::GetResult() const
{
    return m_result;
}

bool DescribeIngressesResponse::ResultHasBeenSet() const
{
