...
CoreInternalOutcome RestartServiceRunPodResponse::Deserialize(const string &payload)
{
...
string RestartServiceRunPodResponse::ToJsonString() const
{
...
bool RestartServiceRunPodResponse::GetResult() const
{
    return m_result;
}

bool RestartServiceRunPodResponse::ResultHasBeenSet() const
{
