...
CoreInternalOutcome CreateNamespaceResponse::Deserialize(const string &payload)
{
...
string CreateNamespaceResponse::ToJsonString() const
{
...
string CreateNamespaceResponse::GetResult() const
{
    return m_result;
}

bool CreateNamespaceResponse::ResultHasBeenSet() const
{
