...
CoreInternalOutcome CreateCosTokenV2Response::Deserialize(const string &payload)
{
...
string CreateCosTokenV2Response::ToJsonString() const
{
...
CosToken CreateCosTokenV2Response::GetResult() const
{
    return m_result;
}

bool CreateCosTokenV2Response::ResultHasBeenSet() const
{
