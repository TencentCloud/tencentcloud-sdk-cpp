...
CoreInternalOutcome CreateCosTokenResponse::Deserialize(const string &payload)
{
...
string CreateCosTokenResponse::ToJsonString() const
{
...
CosToken CreateCosTokenResponse::GetResult() const
{
    return m_result;
}

bool CreateCosTokenResponse::ResultHasBeenSet() const
{
