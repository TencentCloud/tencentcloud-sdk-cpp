...
#ifndef TENCENTCLOUD_TEM_V20210701_MODEL_DELETEAPPLICATIONAUTOSCALERREQUEST_H_
#define TENCENTCLOUD_TEM_V20210701_MODEL_DELETEAPPLICATIONAUTOSCALERREQUEST_H_
    ...
    namespace Tem
    {
        namespace V20210701
        {
            namespace Model
            {
                ...
                */
                class DeleteApplicationAutoscalerRequest : public AbstractModel
                {
                public:
                    DeleteApplicationAutoscalerRequest();
                    ~DeleteApplicationAutoscalerRequest() = default;
...
#endif // !TENCENTCLOUD_TEM_V20210701_MODEL_DELETEAPPLICATIONAUTOSCALERREQUEST_H_
