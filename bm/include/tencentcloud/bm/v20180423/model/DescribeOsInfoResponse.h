...
#ifndef TENCENTCLOUD_BM_V20180423_MODEL_DESCRIBEOSINFORESPONSE_H_
#define TENCENTCLOUD_BM_V20180423_MODEL_DESCRIBEOSINFORESPONSE_H_
    ...
    namespace Bm
    {
        namespace V20180423
        {
            namespace Model
            {
                ...
                */
                class DescribeOsInfoResponse : public AbstractModel
                {
                public:
                    DescribeOsInfoResponse();
                    ~DescribeOsInfoResponse() = default;
...
#endif // !TENCENTCLOUD_BM_V20180423_MODEL_DESCRIBEOSINFORESPONSE_H_
