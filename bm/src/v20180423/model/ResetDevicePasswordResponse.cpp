...
CoreInternalOutcome ResetDevicePasswordResponse::Deserialize(const string &payload)
{
...
string ResetDevicePasswordResponse::ToJsonString() const
{
...
uint64_t ResetDevicePasswordResponse::GetTaskId() const
{
    return m_taskId;
}

bool ResetDevicePasswordResponse::TaskIdHasBeenSet() const
{
