...
CoreInternalOutcome RebootDevicesResponse::Deserialize(const string &payload)
{
...
string RebootDevicesResponse::ToJsonString() const
{
...
uint64_t RebootDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool RebootDevicesResponse::TaskIdHasBeenSet() const
{
