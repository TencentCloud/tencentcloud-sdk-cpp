...
CoreInternalOutcome ReturnDevicesResponse::Deserialize(const string &payload)
{
...
string ReturnDevicesResponse::ToJsonString() const
{
...
uint64_t ReturnDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ReturnDevicesResponse::TaskIdHasBeenSet() const
{
