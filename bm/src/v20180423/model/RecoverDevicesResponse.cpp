...
CoreInternalOutcome RecoverDevicesResponse::Deserialize(const string &payload)
{
...
string RecoverDevicesResponse::ToJsonString() const
{
...
uint64_t RecoverDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool RecoverDevicesResponse::TaskIdHasBeenSet() const
{
