...
CoreInternalOutcome CreateSpotDeviceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("FlowId") && !rsp["FlowId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `FlowId` IsUint64=false incorrectly").SetRequestId(requestId));
        }
...
string CreateSpotDeviceResponse::ToJsonString() const
{
...
vector<string> CreateSpotDeviceResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateSpotDeviceResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

uint64_t CreateSpotDeviceResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateSpotDeviceResponse::FlowIdHasBeenSet() const
{
