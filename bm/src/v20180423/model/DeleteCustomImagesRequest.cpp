...
string DeleteCustomImagesRequest::ToJsonString() const
{
...
vector<string> DeleteCustomImagesRequest::GetImageIds() const
{
    return m_imageIds;
}

void DeleteCustomImagesRequest::SetImageIds(const vector<string>& _imageIds)
{
    m_imageIds = _imageIds;
    m_imageIdsHasBeenSet = true;
}

bool DeleteCustomImagesRequest::ImageIdsHasBeenSet() const
{
