...
CoreInternalOutcome ShutdownDevicesResponse::Deserialize(const string &payload)
{
...
string ShutdownDevicesResponse::ToJsonString() const
{
...
uint64_t ShutdownDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ShutdownDevicesResponse::TaskIdHasBeenSet() const
{
