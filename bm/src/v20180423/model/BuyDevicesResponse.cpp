...
CoreInternalOutcome BuyDevicesResponse::Deserialize(const string &payload)
{
...
string BuyDevicesResponse::ToJsonString() const
{
...
vector<string> BuyDevicesResponse::GetInstanceIds() const
{
    return m_instanceIds;
}

bool BuyDevicesResponse::InstanceIdsHasBeenSet() const
{
