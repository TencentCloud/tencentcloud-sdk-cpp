...
string DeletePsaRegulationRequest::ToJsonString() const
{
...
string DeletePsaRegulationRequest::GetPsaId() const
{
    return m_psaId;
}

void DeletePsaRegulationRequest::SetPsaId(const string& _psaId)
{
    m_psaId = _psaId;
    m_psaIdHasBeenSet = true;
}

bool DeletePsaRegulationRequest::PsaIdHasBeenSet() const
{
