...
CoreInternalOutcome ModifyLanIpResponse::Deserialize(const string &payload)
{
...
string ModifyLanIpResponse::ToJsonString() const
{
...
uint64_t ModifyLanIpResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyLanIpResponse::TaskIdHasBeenSet() const
{
