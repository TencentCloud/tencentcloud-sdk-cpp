...
CoreInternalOutcome DeviceHardwareInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void DeviceHardwareInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
