...
CoreInternalOutcome DeleteCustomImagesResponse::Deserialize(const string &payload)
{
...
string DeleteCustomImagesResponse::ToJsonString() const
{
...
uint64_t DeleteCustomImagesResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteCustomImagesResponse::TaskIdHasBeenSet() const
{
