...
CoreInternalOutcome OfflineDevicesResponse::Deserialize(const string &payload)
{
...
string OfflineDevicesResponse::ToJsonString() const
{
...
uint64_t OfflineDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool OfflineDevicesResponse::TaskIdHasBeenSet() const
{
