...
CoreInternalOutcome StartDevicesResponse::Deserialize(const string &payload)
{
...
string StartDevicesResponse::ToJsonString() const
{
...
uint64_t StartDevicesResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartDevicesResponse::TaskIdHasBeenSet() const
{
