...
string BindPsaTagRequest::ToJsonString() const
{
...
string BindPsaTagRequest::GetPsaId() const
{
    return m_psaId;
}

void BindPsaTagRequest::SetPsaId(const string& _psaId)
{
    m_psaId = _psaId;
    m_psaIdHasBeenSet = true;
}

bool BindPsaTagRequest::PsaIdHasBeenSet() const
{
    return m_psaIdHasBeenSet;
}

string BindPsaTagRequest::GetTagKey() const
{
    return m_tagKey;
}

void BindPsaTagRequest::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool BindPsaTagRequest::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string BindPsaTagRequest::GetTagValue() const
{
    return m_tagValue;
}

void BindPsaTagRequest::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool BindPsaTagRequest::TagValueHasBeenSet() const
{
