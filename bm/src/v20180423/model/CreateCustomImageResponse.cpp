...
CoreInternalOutcome CreateCustomImageResponse::Deserialize(const string &payload)
{
...
string CreateCustomImageResponse::ToJsonString() const
{
...
uint64_t CreateCustomImageResponse::GetTaskId() const
{
    return m_taskId;
}
