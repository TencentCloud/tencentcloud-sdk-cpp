...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_CREATEINTEGRATECLUSTERRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_CREATEINTEGRATECLUSTERRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class CreateIntegrateClusterResponse : public AbstractModel
                {
                public:
                    CreateIntegrateClusterResponse();
                    ~CreateIntegrateClusterResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_CREATEINTEGRATECLUSTERRESPONSE_H_
