...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ACTIVATELIBRADBINSTANCEREQUEST_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ACTIVATELIBRADBINSTANCEREQUEST_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class ActivateLibraDBInstanceRequest : public AbstractModel
                {
                public:
                    ActivateLibraDBInstanceRequest();
                    ~ActivateLibraDBInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ACTIVATELIBRADBINSTANCEREQUEST_H_
