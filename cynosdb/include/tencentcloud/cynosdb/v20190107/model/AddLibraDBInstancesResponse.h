...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDLIBRADBINSTANCESRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDLIBRADBINSTANCESRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class AddLibraDBInstancesResponse : public AbstractModel
                {
                public:
                    AddLibraDBInstancesResponse();
                    ~AddLibraDBInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDLIBRADBINSTANCESRESPONSE_H_
