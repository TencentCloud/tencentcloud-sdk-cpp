...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEISOLATEDINSTANCESRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEISOLATEDINSTANCESRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class DescribeIsolatedInstancesResponse : public AbstractModel
                {
                public:
                    DescribeIsolatedInstancesResponse();
                    ~DescribeIsolatedInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEISOLATEDINSTANCESRESPONSE_H_
