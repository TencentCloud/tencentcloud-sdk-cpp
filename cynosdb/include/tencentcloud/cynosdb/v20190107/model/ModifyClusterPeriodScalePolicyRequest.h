...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPERIODSCALEPOLICYREQUEST_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPERIODSCALEPOLICYREQUEST_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class ModifyClusterPeriodScalePolicyRequest : public AbstractModel
                {
                public:
                    ModifyClusterPeriodScalePolicyRequest();
                    ~ModifyClusterPeriodScalePolicyRequest() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPERIODSCALEPOLICYREQUEST_H_
