...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEBINLOGLISTBYVAULTREQUEST_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEBINLOGLISTBYVAULTREQUEST_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class DescribeBinlogListByVaultRequest : public AbstractModel
                {
                public:
                    DescribeBinlogListByVaultRequest();
                    ~DescribeBinlogListByVaultRequest() = default;
                    ...
                    /**
                     * 获取返回数量，范围: (0, 100]，默认100
                     * @return Limit 返回数量，范围: (0, 100]，默认100
                     * 
                     */
                    int64_t GetLimit() const;

                    /**
                     * 设置返回数量，范围: (0, 100]，默认100
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_DESCRIBEBINLOGLISTBYVAULTREQUEST_H_
