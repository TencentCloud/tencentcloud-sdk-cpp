...
CoreInternalOutcome OpenClusterTransparentEncryptResponse::Deserialize(const string &payload)
{
...
string OpenClusterTransparentEncryptResponse::ToJsonString() const
{
...
int64_t OpenClusterTransparentEncryptResponse::GetTaskId() const
{
    return m_taskId;
}

bool OpenClusterTransparentEncryptResponse::TaskIdHasBeenSet() const
{
