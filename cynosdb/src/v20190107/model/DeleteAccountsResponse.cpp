...
CoreInternalOutcome DeleteAccountsResponse::Deserialize(const string &payload)
{
...
string DeleteAccountsResponse::ToJsonString() const
{
...
int64_t DeleteAccountsResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteAccountsResponse::TaskIdHasBeenSet() const
{
