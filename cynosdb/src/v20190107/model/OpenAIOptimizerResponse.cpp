...
CoreInternalOutcome OpenAIOptimizerResponse::Deserialize(const string &payload)
{
...
string OpenAIOptimizerResponse::ToJsonString() const
{
...
int64_t OpenAIOptimizerResponse::GetTaskId() const
{
    return m_taskId;
}

bool OpenAIOptimizerResponse::TaskIdHasBeenSet() const
{
