...
CoreInternalOutcome RenewLibraDBClustersResponse::Deserialize(const string &payload)
{
...
string RenewLibraDBClustersResponse::ToJsonString() const
{
...
vector<string> RenewLibraDBClustersResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool RenewLibraDBClustersResponse::BigDealIdsHasBeenSet() const
{
    return m_bigDealIdsHasBeenSet;
}

string RenewLibraDBClustersResponse::GetTranId() const
{
    return m_tranId;
}

bool RenewLibraDBClustersResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> RenewLibraDBClustersResponse::GetDealNames() const
{
    return m_dealNames;
}

bool RenewLibraDBClustersResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> RenewLibraDBClustersResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool RenewLibraDBClustersResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

vector<string> RenewLibraDBClustersResponse::GetClusterIds() const
{
    return m_clusterIds;
}

bool RenewLibraDBClustersResponse::ClusterIdsHasBeenSet() const
{
