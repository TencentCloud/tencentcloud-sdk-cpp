...
string DeleteAuditLogFileRequest::GetFileName() const
{
    return m_fileName;
}

void DeleteAuditLogFileRequest::SetFileName(const string& _fileName)
{
    m_fileName = _fileName;
    m_fileNameHasBeenSet = true;
}

bool DeleteAuditLogFileRequest::FileNameHasBeenSet() const
{
