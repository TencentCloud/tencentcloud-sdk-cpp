...
CoreInternalOutcome SetRenewFlagResponse::Deserialize(const string &payload)
{
...
string SetRenewFlagResponse::ToJsonString() const
{
...
int64_t SetRenewFlagResponse::GetCount() const
{
    return m_count;
}

bool SetRenewFlagResponse::CountHasBeenSet() const
{
