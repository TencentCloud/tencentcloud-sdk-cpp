...
string ModifyBinlogSaveDaysRequest::ToJsonString() const
{
...
string ModifyBinlogSaveDaysRequest::GetClusterId() const
{
    return m_clusterId;
}

void ModifyBinlogSaveDaysRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool ModifyBinlogSaveDaysRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t ModifyBinlogSaveDaysRequest::GetBinlogSaveDays() const
{
    return m_binlogSaveDays;
}

void ModifyBinlogSaveDaysRequest::SetBinlogSaveDays(const int64_t& _binlogSaveDays)
{
