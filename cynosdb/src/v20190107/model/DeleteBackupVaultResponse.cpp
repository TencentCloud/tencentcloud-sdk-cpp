...
CoreInternalOutcome DeleteBackupVaultResponse::Deserialize(const string &payload)
{
...
string DeleteBackupVaultResponse::ToJsonString() const
{
...
int64_t DeleteBackupVaultResponse::GetTaskId() const
{
    return m_taskId;
}

bool DeleteBackupVaultResponse::TaskIdHasBeenSet() const
{
