...
CoreInternalOutcome CreateIntegrateClusterResponse::Deserialize(const string &payload)
{
...
string CreateIntegrateClusterResponse::ToJsonString() const
{
...
string CreateIntegrateClusterResponse::GetTranId() const
{
    return m_tranId;
}

bool CreateIntegrateClusterResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> CreateIntegrateClusterResponse::GetDealNames() const
{
    return m_dealNames;
}

bool CreateIntegrateClusterResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> CreateIntegrateClusterResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateIntegrateClusterResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

vector<string> CreateIntegrateClusterResponse::GetClusterIds() const
{
    return m_clusterIds;
}

bool CreateIntegrateClusterResponse::ClusterIdsHasBeenSet() const
{
    return m_clusterIdsHasBeenSet;
}

vector<string> CreateIntegrateClusterResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool CreateIntegrateClusterResponse::BigDealIdsHasBeenSet() const
{
