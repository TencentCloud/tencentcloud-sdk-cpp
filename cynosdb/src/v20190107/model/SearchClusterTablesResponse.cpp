...
CoreInternalOutcome SearchClusterTablesResponse::Deserialize(const string &payload)
{
...
string SearchClusterTablesResponse::ToJsonString() const
{
...
vector<DatabaseTables> SearchClusterTablesResponse::GetTables() const
{
    return m_tables;
}

bool SearchClusterTablesResponse::TablesHasBeenSet() const
{
