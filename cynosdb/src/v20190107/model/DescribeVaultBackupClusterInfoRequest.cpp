...
string DescribeVaultBackupClusterInfoRequest::ToJsonString() const
{
...
string DescribeVaultBackupClusterInfoRequest::GetVaultId() const
{
    return m_vaultId;
}

void DescribeVaultBackupClusterInfoRequest::SetVaultId(const string& _vaultId)
{
    m_vaultId = _vaultId;
    m_vaultIdHasBeenSet = true;
}

bool DescribeVaultBackupClusterInfoRequest::VaultIdHasBeenSet() const
{
