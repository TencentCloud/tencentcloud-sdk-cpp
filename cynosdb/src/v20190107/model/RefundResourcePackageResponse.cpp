...
CoreInternalOutcome RefundResourcePackageResponse::Deserialize(const string &payload)
{
...
string RefundResourcePackageResponse::ToJsonString() const
{
...
vector<string> RefundResourcePackageResponse::GetDealNames() const
{
    return m_dealNames;
}

bool RefundResourcePackageResponse::DealNamesHasBeenSet() const
{
