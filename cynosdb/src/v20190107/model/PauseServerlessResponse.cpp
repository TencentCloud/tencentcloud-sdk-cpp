...
CoreInternalOutcome PauseServerlessResponse::Deserialize(const string &payload)
{
...
string PauseServerlessResponse::ToJsonString() const
{
...
int64_t PauseServerlessResponse::GetFlowId() const
{
    return m_flowId;
}

bool PauseServerlessResponse::FlowIdHasBeenSet() const
{
