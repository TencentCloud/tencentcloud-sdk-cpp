...
CoreInternalOutcome IsolateLibraDBInstanceResponse::Deserialize(const string &payload)
{
...
string IsolateLibraDBInstanceResponse::ToJsonString() const
{
...
int64_t IsolateLibraDBInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool IsolateLibraDBInstanceResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

vector<string> IsolateLibraDBInstanceResponse::GetDealNames() const
{
    return m_dealNames;
}

bool IsolateLibraDBInstanceResponse::DealNamesHasBeenSet() const
{
