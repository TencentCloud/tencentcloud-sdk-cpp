...
CoreInternalOutcome DescribeBackupDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeBackupDownloadUrlResponse::ToJsonString() const
{
...
string DescribeBackupDownloadUrlResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeBackupDownloadUrlResponse::DownloadUrlHasBeenSet() const
{
