...
CoreInternalOutcome DescribeIsolatedInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeIsolatedInstancesResponse::ToJsonString() const
{
...
int64_t DescribeIsolatedInstancesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeIsolatedInstancesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CynosdbInstance> DescribeIsolatedInstancesResponse::GetInstanceSet() const
{
    return m_instanceSet;
}

bool DescribeIsolatedInstancesResponse::InstanceSetHasBeenSet() const
{
