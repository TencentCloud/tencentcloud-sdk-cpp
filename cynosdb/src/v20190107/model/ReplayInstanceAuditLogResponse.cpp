...
CoreInternalOutcome ReplayInstanceAuditLogResponse::Deserialize(const string &payload)
{
...
string ReplayInstanceAuditLogResponse::ToJsonString() const
{
...
int64_t ReplayInstanceAuditLogResponse::GetTaskId() const
{
    return m_taskId;
}

bool ReplayInstanceAuditLogResponse::TaskIdHasBeenSet() const
{
