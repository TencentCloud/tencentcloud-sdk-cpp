...
CoreInternalOutcome StartCLSDeliveryResponse::Deserialize(const string &payload)
{
...
string StartCLSDeliveryResponse::ToJsonString() const
{
...
int64_t StartCLSDeliveryResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartCLSDeliveryResponse::TaskIdHasBeenSet() const
{
