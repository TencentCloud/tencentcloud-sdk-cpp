...
string DescribeRollbackTimeRangeRequest::ToJsonString() const
{
...
string DescribeRollbackTimeRangeRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeRollbackTimeRangeRequest::SetClusterId(const string& _clusterId)
{
