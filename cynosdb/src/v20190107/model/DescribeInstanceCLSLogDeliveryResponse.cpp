...
CoreInternalOutcome DescribeInstanceCLSLogDeliveryResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceCLSLogDeliveryResponse::ToJsonString() const
{
