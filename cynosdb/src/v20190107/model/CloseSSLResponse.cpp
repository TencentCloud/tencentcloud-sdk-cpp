...
CoreInternalOutcome CloseSSLResponse::Deserialize(const string &payload)
{
...
string CloseSSLResponse::ToJsonString() const
{
...
int64_t CloseSSLResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloseSSLResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CloseSSLResponse::GetTaskId() const
{
    return m_taskId;
}

bool CloseSSLResponse::TaskIdHasBeenSet() const
{
