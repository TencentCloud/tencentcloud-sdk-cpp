...
int64_t OpenSSLResponse::GetFlowId() const
{
    return m_flowId;
}

bool OpenSSLResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t OpenSSLResponse::GetTaskId() const
{
    return m_taskId;
}

bool OpenSSLResponse::TaskIdHasBeenSet() const
{
