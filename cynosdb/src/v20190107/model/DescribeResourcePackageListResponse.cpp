...
CoreInternalOutcome DescribeResourcePackageListResponse::Deserialize(const string &payload)
{
...
string DescribeResourcePackageListResponse::ToJsonString() const
{
...
int64_t DescribeResourcePackageListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeResourcePackageListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<Package> DescribeResourcePackageListResponse::GetDetail() const
{
    return m_detail;
}

bool DescribeResourcePackageListResponse::DetailHasBeenSet() const
{
