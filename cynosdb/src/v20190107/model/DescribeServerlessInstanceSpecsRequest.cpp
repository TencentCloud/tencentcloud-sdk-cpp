...
string DescribeServerlessInstanceSpecsRequest::ToJsonString() const
{
...
string DescribeServerlessInstanceSpecsRequest::GetZone() const
{
    return m_zone;
}

void DescribeServerlessInstanceSpecsRequest::SetZone(const string& _zone)
{
    m_zone = _zone;
