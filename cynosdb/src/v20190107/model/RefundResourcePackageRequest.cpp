...
string RefundResourcePackageRequest::ToJsonString() const
{
...
string RefundResourcePackageRequest::GetPackageId() const
{
    return m_packageId;
}

void RefundResourcePackageRequest::SetPackageId(const string& _packageId)
{
    m_packageId = _packageId;
    m_packageIdHasBeenSet = true;
}

bool RefundResourcePackageRequest::PackageIdHasBeenSet() const
{
