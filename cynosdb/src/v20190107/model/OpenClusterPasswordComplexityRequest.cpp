...
string OpenClusterPasswordComplexityRequest::ToJsonString() const
{
...
string OpenClusterPasswordComplexityRequest::GetClusterId() const
{
    return m_clusterId;
}

void OpenClusterPasswordComplexityRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t OpenClusterPasswordComplexityRequest::GetValidatePasswordLength() const
{
    return m_validatePasswordLength;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordLength(const int64_t& _validatePasswordLength)
{
    m_validatePasswordLength = _validatePasswordLength;
    m_validatePasswordLengthHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordLengthHasBeenSet() const
{
    return m_validatePasswordLengthHasBeenSet;
}

int64_t OpenClusterPasswordComplexityRequest::GetValidatePasswordMixedCaseCount() const
{
    return m_validatePasswordMixedCaseCount;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordMixedCaseCount(const int64_t& _validatePasswordMixedCaseCount)
{
    m_validatePasswordMixedCaseCount = _validatePasswordMixedCaseCount;
    m_validatePasswordMixedCaseCountHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordMixedCaseCountHasBeenSet() const
{
    return m_validatePasswordMixedCaseCountHasBeenSet;
}

int64_t OpenClusterPasswordComplexityRequest::GetValidatePasswordSpecialCharCount() const
{
    return m_validatePasswordSpecialCharCount;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordSpecialCharCount(const int64_t& _validatePasswordSpecialCharCount)
{
    m_validatePasswordSpecialCharCount = _validatePasswordSpecialCharCount;
    m_validatePasswordSpecialCharCountHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordSpecialCharCountHasBeenSet() const
{
    return m_validatePasswordSpecialCharCountHasBeenSet;
}

int64_t OpenClusterPasswordComplexityRequest::GetValidatePasswordNumberCount() const
{
    return m_validatePasswordNumberCount;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordNumberCount(const int64_t& _validatePasswordNumberCount)
{
    m_validatePasswordNumberCount = _validatePasswordNumberCount;
    m_validatePasswordNumberCountHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordNumberCountHasBeenSet() const
{
    return m_validatePasswordNumberCountHasBeenSet;
}

string OpenClusterPasswordComplexityRequest::GetValidatePasswordPolicy() const
{
    return m_validatePasswordPolicy;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordPolicy(const string& _validatePasswordPolicy)
{
    m_validatePasswordPolicy = _validatePasswordPolicy;
    m_validatePasswordPolicyHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordPolicyHasBeenSet() const
{
    return m_validatePasswordPolicyHasBeenSet;
}

vector<string> OpenClusterPasswordComplexityRequest::GetValidatePasswordDictionary() const
{
    return m_validatePasswordDictionary;
}

void OpenClusterPasswordComplexityRequest::SetValidatePasswordDictionary(const vector<string>& _validatePasswordDictionary)
{
    m_validatePasswordDictionary = _validatePasswordDictionary;
    m_validatePasswordDictionaryHasBeenSet = true;
}

bool OpenClusterPasswordComplexityRequest::ValidatePasswordDictionaryHasBeenSet() const
{
