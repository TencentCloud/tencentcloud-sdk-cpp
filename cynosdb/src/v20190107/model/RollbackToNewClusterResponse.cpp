...
CoreInternalOutcome RollbackToNewClusterResponse::Deserialize(const string &payload)
{
...
string RollbackToNewClusterResponse::ToJsonString() const
{
...
string RollbackToNewClusterResponse::GetTranId() const
{
    return m_tranId;
}

bool RollbackToNewClusterResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> RollbackToNewClusterResponse::GetDealNames() const
{
    return m_dealNames;
}

bool RollbackToNewClusterResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> RollbackToNewClusterResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool RollbackToNewClusterResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

vector<string> RollbackToNewClusterResponse::GetClusterIds() const
{
    return m_clusterIds;
}

bool RollbackToNewClusterResponse::ClusterIdsHasBeenSet() const
{
    return m_clusterIdsHasBeenSet;
}

vector<string> RollbackToNewClusterResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool RollbackToNewClusterResponse::BigDealIdsHasBeenSet() const
{
