...
CoreInternalOutcome ExportResourcePackageDeductDetailsResponse::Deserialize(const string &payload)
{
...
string ExportResourcePackageDeductDetailsResponse::ToJsonString() const
{
...
string ExportResourcePackageDeductDetailsResponse::GetFileContent() const
{
    return m_fileContent;
}

bool ExportResourcePackageDeductDetailsResponse::FileContentHasBeenSet() const
{
