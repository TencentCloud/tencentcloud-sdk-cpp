...
string DescribeBackupDownloadRestrictionRequest::ToJsonString() const
{
...
vector<string> DescribeBackupDownloadRestrictionRequest::GetClusterIds() const
{
    return m_clusterIds;
}

void DescribeBackupDownloadRestrictionRequest::SetClusterIds(const vector<string>& _clusterIds)
{
    m_clusterIds = _clusterIds;
    m_clusterIdsHasBeenSet = true;
}

bool DescribeBackupDownloadRestrictionRequest::ClusterIdsHasBeenSet() const
{
