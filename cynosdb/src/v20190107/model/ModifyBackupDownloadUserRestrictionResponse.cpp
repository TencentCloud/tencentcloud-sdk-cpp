...
CoreInternalOutcome ModifyBackupDownloadUserRestrictionResponse::Deserialize(const string &payload)
{
...
string ModifyBackupDownloadUserRestrictionResponse::ToJsonString() const
{
