...
CoreInternalOutcome DescribeBinlogDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeBinlogDownloadUrlResponse::ToJsonString() const
{
...
string DescribeBinlogDownloadUrlResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeBinlogDownloadUrlResponse::DownloadUrlHasBeenSet() const
{
