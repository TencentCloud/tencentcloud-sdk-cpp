...
CoreInternalOutcome OfflineInstanceResponse::Deserialize(const string &payload)
{
...
string OfflineInstanceResponse::ToJsonString() const
{
...
int64_t OfflineInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool OfflineInstanceResponse::FlowIdHasBeenSet() const
{
