...
string DeleteCLSDeliveryRequest::ToJsonString() const
{
...
string DeleteCLSDeliveryRequest::GetInstanceId() const
{
    return m_instanceId;
}

void DeleteCLSDeliveryRequest::SetInstanceId(const string& _instanceId)
{
    m_instanceId = _instanceId;
    m_instanceIdHasBeenSet = true;
}

bool DeleteCLSDeliveryRequest::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

vector<string> DeleteCLSDeliveryRequest::GetCLSTopicIds() const
{
    return m_cLSTopicIds;
}

void DeleteCLSDeliveryRequest::SetCLSTopicIds(const vector<string>& _cLSTopicIds)
{
