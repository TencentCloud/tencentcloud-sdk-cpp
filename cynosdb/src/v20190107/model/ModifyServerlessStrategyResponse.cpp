...
CoreInternalOutcome ModifyServerlessStrategyResponse::Deserialize(const string &payload)
{
...
string ModifyServerlessStrategyResponse::ToJsonString() const
{
...
int64_t ModifyServerlessStrategyResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyServerlessStrategyResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t ModifyServerlessStrategyResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyServerlessStrategyResponse::TaskIdHasBeenSet() const
{
