...
CoreInternalOutcome CloseProxyResponse::Deserialize(const string &payload)
{
...
string CloseProxyResponse::ToJsonString() const
{
...
int64_t CloseProxyResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloseProxyResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CloseProxyResponse::GetTaskId() const
{
    return m_taskId;
}

bool CloseProxyResponse::TaskIdHasBeenSet() const
{
