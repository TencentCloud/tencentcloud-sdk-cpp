...
string DescribeSSLStatusRequest::GetClusterId() const
{
    return m_clusterId;
}

void DescribeSSLStatusRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool DescribeSSLStatusRequest::ClusterIdHasBeenSet() const
{
