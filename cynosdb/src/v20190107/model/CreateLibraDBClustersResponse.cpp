...
CoreInternalOutcome CreateLibraDBClustersResponse::Deserialize(const string &payload)
{
...
string CreateLibraDBClustersResponse::ToJsonString() const
{
...
vector<string> CreateLibraDBClustersResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool CreateLibraDBClustersResponse::BigDealIdsHasBeenSet() const
{
    return m_bigDealIdsHasBeenSet;
}

vector<string> CreateLibraDBClustersResponse::GetClusterIds() const
{
    return m_clusterIds;
}

bool CreateLibraDBClustersResponse::ClusterIdsHasBeenSet() const
{
    return m_clusterIdsHasBeenSet;
}

vector<string> CreateLibraDBClustersResponse::GetDealNames() const
{
    return m_dealNames;
}

bool CreateLibraDBClustersResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

string CreateLibraDBClustersResponse::GetTranId() const
{
    return m_tranId;
}

bool CreateLibraDBClustersResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> CreateLibraDBClustersResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateLibraDBClustersResponse::ResourceIdsHasBeenSet() const
{
