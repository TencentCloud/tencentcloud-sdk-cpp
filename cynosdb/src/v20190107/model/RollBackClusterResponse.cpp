...
CoreInternalOutcome RollBackClusterResponse::Deserialize(const string &payload)
{
...
string RollBackClusterResponse::ToJsonString() const
{
...
int64_t RollBackClusterResponse::GetFlowId() const
{
    return m_flowId;
}

bool RollBackClusterResponse::FlowIdHasBeenSet() const
{
