...
CoreInternalOutcome ModifyVipVportResponse::Deserialize(const string &payload)
{
...
string ModifyVipVportResponse::ToJsonString() const
{
...
int64_t ModifyVipVportResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyVipVportResponse::FlowIdHasBeenSet() const
{
