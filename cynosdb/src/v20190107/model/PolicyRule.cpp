...
CoreInternalOutcome PolicyRule::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Action") && !value["Action"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.Action` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CidrIp") && !value["CidrIp"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.CidrIp` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PortRange") && !value["PortRange"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.PortRange` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("IpProtocol") && !value["IpProtocol"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.IpProtocol` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ServiceModule") && !value["ServiceModule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.ServiceModule` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AddressModule") && !value["AddressModule"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.AddressModule` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Id") && !value["Id"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.Id` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Desc") && !value["Desc"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `PolicyRule.Desc` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void PolicyRule::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
