...
CoreInternalOutcome ModifyClusterStorageResponse::Deserialize(const string &payload)
{
...
string ModifyClusterStorageResponse::ToJsonString() const
{
...
string ModifyClusterStorageResponse::GetTranId() const
{
    return m_tranId;
}

bool ModifyClusterStorageResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> ModifyClusterStorageResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool ModifyClusterStorageResponse::BigDealIdsHasBeenSet() const
{
    return m_bigDealIdsHasBeenSet;
}

vector<string> ModifyClusterStorageResponse::GetDealNames() const
{
    return m_dealNames;
}

bool ModifyClusterStorageResponse::DealNamesHasBeenSet() const
{
