...
string CloseClusterPasswordComplexityRequest::ToJsonString() const
{
...
vector<string> CloseClusterPasswordComplexityRequest::GetClusterIds() const
{
    return m_clusterIds;
}

void CloseClusterPasswordComplexityRequest::SetClusterIds(const vector<string>& _clusterIds)
{
    m_clusterIds = _clusterIds;
    m_clusterIdsHasBeenSet = true;
}

bool CloseClusterPasswordComplexityRequest::ClusterIdsHasBeenSet() const
{
