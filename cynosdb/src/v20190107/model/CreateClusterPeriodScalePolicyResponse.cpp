...
CreateClusterPeriodScalePolicyResponse::CreateClusterPeriodScalePolicyResponse() :
    m_policyIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateClusterPeriodScalePolicyResponse::Deserialize(const string &payload)
{
...
string CreateClusterPeriodScalePolicyResponse::ToJsonString() const
{
...
string CreateClusterPeriodScalePolicyResponse::GetPolicyId() const
{
    return m_policyId;
}

bool CreateClusterPeriodScalePolicyResponse::PolicyIdHasBeenSet() const
{
