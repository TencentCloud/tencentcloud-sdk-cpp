...
CoreInternalOutcome CreateVaultResponse::Deserialize(const string &payload)
{
...
string CreateVaultResponse::ToJsonString() const
{
...
int64_t CreateVaultResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateVaultResponse::TaskIdHasBeenSet() const
{
