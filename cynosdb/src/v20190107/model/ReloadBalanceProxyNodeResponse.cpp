...
CoreInternalOutcome ReloadBalanceProxyNodeResponse::Deserialize(const string &payload)
{
...
string ReloadBalanceProxyNodeResponse::ToJsonString() const
{
...
int64_t ReloadBalanceProxyNodeResponse::GetFlowId() const
{
    return m_flowId;
}

bool ReloadBalanceProxyNodeResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t ReloadBalanceProxyNodeResponse::GetTaskId() const
{
    return m_taskId;
}

bool ReloadBalanceProxyNodeResponse::TaskIdHasBeenSet() const
{
