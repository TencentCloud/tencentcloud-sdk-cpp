...
CoreInternalOutcome DescribeSlaveZonesResponse::Deserialize(const string &payload)
{
...
string DescribeSlaveZonesResponse::ToJsonString() const
{
...
vector<string> DescribeSlaveZonesResponse::GetSlaveZones() const
{
    return m_slaveZones;
}

bool DescribeSlaveZonesResponse::SlaveZonesHasBeenSet() const
{
