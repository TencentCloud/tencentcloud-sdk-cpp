...
CoreInternalOutcome IsolateLibraDBClusterResponse::Deserialize(const string &payload)
{
...
string IsolateLibraDBClusterResponse::ToJsonString() const
{
...
int64_t IsolateLibraDBClusterResponse::GetFlowId() const
{
    return m_flowId;
}

bool IsolateLibraDBClusterResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

vector<string> IsolateLibraDBClusterResponse::GetDealNames() const
{
    return m_dealNames;
}

bool IsolateLibraDBClusterResponse::DealNamesHasBeenSet() const
{
