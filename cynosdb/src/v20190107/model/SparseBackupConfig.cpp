...
CoreInternalOutcome SparseBackupConfig::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("SparseBackupSwitch") && !value["SparseBackupSwitch"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `SparseBackupConfig.SparseBackupSwitch` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SparseBackupConfigInfos") && !value["SparseBackupConfigInfos"].IsNull())
    {
        if (!value["SparseBackupConfigInfos"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SparseBackupConfig.SparseBackupConfigInfos` is not array type"));
...
void SparseBackupConfig::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string SparseBackupConfig::GetSparseBackupSwitch() const
{
    return m_sparseBackupSwitch;
}

void SparseBackupConfig::SetSparseBackupSwitch(const string& _sparseBackupSwitch)
{
    m_sparseBackupSwitch = _sparseBackupSwitch;
    m_sparseBackupSwitchHasBeenSet = true;
}

bool SparseBackupConfig::SparseBackupSwitchHasBeenSet() const
{
    return m_sparseBackupSwitchHasBeenSet;
}

vector<SparseBackupConfigInfo> SparseBackupConfig::GetSparseBackupConfigInfos() const
{
    return m_sparseBackupConfigInfos;
}

void SparseBackupConfig::SetSparseBackupConfigInfos(const vector<SparseBackupConfigInfo>& _sparseBackupConfigInfos)
{
    m_sparseBackupConfigInfos = _sparseBackupConfigInfos;
    m_sparseBackupConfigInfosHasBeenSet = true;
}

bool SparseBackupConfig::SparseBackupConfigInfosHasBeenSet() const
{
