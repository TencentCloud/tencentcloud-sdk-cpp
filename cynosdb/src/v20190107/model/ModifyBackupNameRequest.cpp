...
string ModifyBackupNameRequest::GetClusterId() const
{
    return m_clusterId;
}

void ModifyBackupNameRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool ModifyBackupNameRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t ModifyBackupNameRequest::GetBackupId() const
{
    return m_backupId;
}

void ModifyBackupNameRequest::SetBackupId(const int64_t& _backupId)
{
