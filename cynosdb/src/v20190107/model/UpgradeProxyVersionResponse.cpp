...
CoreInternalOutcome UpgradeProxyVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeProxyVersionResponse::ToJsonString() const
{
...
int64_t UpgradeProxyVersionResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeProxyVersionResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t UpgradeProxyVersionResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpgradeProxyVersionResponse::TaskIdHasBeenSet() const
{
