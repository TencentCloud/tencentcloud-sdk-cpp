...
CoreInternalOutcome AddLibraDBInstancesResponse::Deserialize(const string &payload)
{
...
string AddLibraDBInstancesResponse::ToJsonString() const
{
...
vector<string> AddLibraDBInstancesResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool AddLibraDBInstancesResponse::BigDealIdsHasBeenSet() const
{
    return m_bigDealIdsHasBeenSet;
}

string AddLibraDBInstancesResponse::GetTranId() const
{
    return m_tranId;
}

bool AddLibraDBInstancesResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> AddLibraDBInstancesResponse::GetDealNames() const
{
    return m_dealNames;
}

bool AddLibraDBInstancesResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> AddLibraDBInstancesResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool AddLibraDBInstancesResponse::ResourceIdsHasBeenSet() const
{
