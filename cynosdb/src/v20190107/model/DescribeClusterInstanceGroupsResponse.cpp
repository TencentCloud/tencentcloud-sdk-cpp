...
CoreInternalOutcome DescribeClusterInstanceGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeClusterInstanceGroupsResponse::ToJsonString() const
{
...
int64_t DescribeClusterInstanceGroupsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterInstanceGroupsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<CynosdbInstanceGroup> DescribeClusterInstanceGroupsResponse::GetInstanceGroupInfoList() const
{
    return m_instanceGroupInfoList;
}

bool DescribeClusterInstanceGroupsResponse::InstanceGroupInfoListHasBeenSet() const
{
