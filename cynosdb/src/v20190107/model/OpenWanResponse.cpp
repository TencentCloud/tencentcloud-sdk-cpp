...
CoreInternalOutcome OpenWanResponse::Deserialize(const string &payload)
{
...
string OpenWanResponse::ToJsonString() const
{
...
int64_t OpenWanResponse::GetFlowId() const
{
    return m_flowId;
}

bool OpenWanResponse::FlowIdHasBeenSet() const
{
