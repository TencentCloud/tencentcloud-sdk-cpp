...
CoreInternalOutcome ExportInstanceSlowQueriesResponse::Deserialize(const string &payload)
{
...
string ExportInstanceSlowQueriesResponse::ToJsonString() const
{
...
string ExportInstanceSlowQueriesResponse::GetFileContent() const
{
    return m_fileContent;
}

bool ExportInstanceSlowQueriesResponse::FileContentHasBeenSet() const
{
