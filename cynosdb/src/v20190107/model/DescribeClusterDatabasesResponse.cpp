...
CoreInternalOutcome DescribeClusterDatabasesResponse::Deserialize(const string &payload)
{
...
string DescribeClusterDatabasesResponse::ToJsonString() const
{
...
int64_t DescribeClusterDatabasesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClusterDatabasesResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

int64_t DescribeClusterDatabasesResponse::GetOffset() const
{
    return m_offset;
}

bool DescribeClusterDatabasesResponse::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

vector<string> DescribeClusterDatabasesResponse::GetDatabases() const
{
    return m_databases;
}

bool DescribeClusterDatabasesResponse::DatabasesHasBeenSet() const
{
    return m_databasesHasBeenSet;
}

int64_t DescribeClusterDatabasesResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeClusterDatabasesResponse::LimitHasBeenSet() const
{
