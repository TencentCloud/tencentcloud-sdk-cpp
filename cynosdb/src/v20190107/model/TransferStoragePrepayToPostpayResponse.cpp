...
CoreInternalOutcome TransferStoragePrepayToPostpayResponse::Deserialize(const string &payload)
{
...
string TransferStoragePrepayToPostpayResponse::ToJsonString() const
{
...
vector<string> TransferStoragePrepayToPostpayResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool TransferStoragePrepayToPostpayResponse::BigDealIdsHasBeenSet() const
{
    return m_bigDealIdsHasBeenSet;
}

vector<string> TransferStoragePrepayToPostpayResponse::GetDealNames() const
{
    return m_dealNames;
}

bool TransferStoragePrepayToPostpayResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> TransferStoragePrepayToPostpayResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool TransferStoragePrepayToPostpayResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

vector<string> TransferStoragePrepayToPostpayResponse::GetClusterIds() const
{
    return m_clusterIds;
}

bool TransferStoragePrepayToPostpayResponse::ClusterIdsHasBeenSet() const
{
