...
CoreInternalOutcome ResumeServerlessResponse::Deserialize(const string &payload)
{
...
string ResumeServerlessResponse::ToJsonString() const
{
...
int64_t ResumeServerlessResponse::GetFlowId() const
{
    return m_flowId;
}

bool ResumeServerlessResponse::FlowIdHasBeenSet() const
{
