...
int64_t IsolateClusterResponse::GetFlowId() const
{
    return m_flowId;
}

bool IsolateClusterResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

vector<string> IsolateClusterResponse::GetDealNames() const
{
    return m_dealNames;
}

bool IsolateClusterResponse::DealNamesHasBeenSet() const
{
