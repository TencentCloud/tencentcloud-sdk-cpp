...
CoreInternalOutcome SwitchClusterVpcResponse::Deserialize(const string &payload)
{
...
string SwitchClusterVpcResponse::ToJsonString() const
{
...
int64_t SwitchClusterVpcResponse::GetFlowId() const
{
    return m_flowId;
}

bool SwitchClusterVpcResponse::FlowIdHasBeenSet() const
{
