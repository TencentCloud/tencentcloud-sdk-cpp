...
CoreInternalOutcome CloseWanResponse::Deserialize(const string &payload)
{
...
string CloseWanResponse::ToJsonString() const
{
...
int64_t CloseWanResponse::GetFlowId() const
{
    return m_flowId;
}

bool CloseWanResponse::FlowIdHasBeenSet() const
{
