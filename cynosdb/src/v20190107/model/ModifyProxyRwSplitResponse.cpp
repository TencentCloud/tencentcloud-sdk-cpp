...
CoreInternalOutcome ModifyProxyRwSplitResponse::Deserialize(const string &payload)
{
...
string ModifyProxyRwSplitResponse::ToJsonString() const
{
...
int64_t ModifyProxyRwSplitResponse::GetFlowId() const
{
    return m_flowId;
}

bool ModifyProxyRwSplitResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t ModifyProxyRwSplitResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyProxyRwSplitResponse::TaskIdHasBeenSet() const
{
