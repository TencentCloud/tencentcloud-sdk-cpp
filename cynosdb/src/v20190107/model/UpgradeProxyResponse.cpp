...
CoreInternalOutcome UpgradeProxyResponse::Deserialize(const string &payload)
{
...
string UpgradeProxyResponse::ToJsonString() const
{
...
int64_t UpgradeProxyResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeProxyResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t UpgradeProxyResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpgradeProxyResponse::TaskIdHasBeenSet() const
{
