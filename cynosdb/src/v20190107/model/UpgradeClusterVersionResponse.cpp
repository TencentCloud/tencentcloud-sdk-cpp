...
CoreInternalOutcome UpgradeClusterVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeClusterVersionResponse::ToJsonString() const
{
...
int64_t UpgradeClusterVersionResponse::GetFlowId() const
{
    return m_flowId;
}

bool UpgradeClusterVersionResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t UpgradeClusterVersionResponse::GetTaskId() const
{
    return m_taskId;
}

bool UpgradeClusterVersionResponse::TaskIdHasBeenSet() const
{
