...
CoreInternalOutcome CreateProxyEndPointResponse::Deserialize(const string &payload)
{
...
string CreateProxyEndPointResponse::ToJsonString() const
{
...
int64_t CreateProxyEndPointResponse::GetFlowId() const
{
    return m_flowId;
}

bool CreateProxyEndPointResponse::FlowIdHasBeenSet() const
{
    return m_flowIdHasBeenSet;
}

int64_t CreateProxyEndPointResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateProxyEndPointResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string CreateProxyEndPointResponse::GetProxyGroupId() const
{
    return m_proxyGroupId;
}

bool CreateProxyEndPointResponse::ProxyGroupIdHasBeenSet() const
{
