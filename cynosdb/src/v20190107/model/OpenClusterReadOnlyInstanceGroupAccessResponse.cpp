...
CoreInternalOutcome OpenClusterReadOnlyInstanceGroupAccessResponse::Deserialize(const string &payload)
{
...
string OpenClusterReadOnlyInstanceGroupAccessResponse::ToJsonString() const
{
