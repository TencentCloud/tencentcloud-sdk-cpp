...
CoreInternalOutcome TransferClusterPrepayToPostpayResponse::Deserialize(const string &payload)
{
...
string TransferClusterPrepayToPostpayResponse::ToJsonString() const
{
