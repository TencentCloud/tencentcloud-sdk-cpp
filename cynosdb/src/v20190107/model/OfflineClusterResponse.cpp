...
CoreInternalOutcome OfflineClusterResponse::Deserialize(const string &payload)
{
...
string OfflineClusterResponse::ToJsonString() const
{
...
int64_t OfflineClusterResponse::GetFlowId() const
{
    return m_flowId;
}

bool OfflineClusterResponse::FlowIdHasBeenSet() const
{
