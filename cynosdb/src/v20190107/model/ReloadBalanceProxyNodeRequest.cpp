...
string ReloadBalanceProxyNodeRequest::ToJsonString() const
{
...
string ReloadBalanceProxyNodeRequest::GetClusterId() const
{
    return m_clusterId;
}

void ReloadBalanceProxyNodeRequest::SetClusterId(const string& _clusterId)
{
    m_clusterId = _clusterId;
    m_clusterIdHasBeenSet = true;
}

bool ReloadBalanceProxyNodeRequest::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

string ReloadBalanceProxyNodeRequest::GetProxyGroupId() const
{
    return m_proxyGroupId;
}

void ReloadBalanceProxyNodeRequest::SetProxyGroupId(const string& _proxyGroupId)
{
