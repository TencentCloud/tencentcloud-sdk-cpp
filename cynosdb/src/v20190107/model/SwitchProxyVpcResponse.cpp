...
CoreInternalOutcome SwitchProxyVpcResponse::Deserialize(const string &payload)
{
...
string SwitchProxyVpcResponse::ToJsonString() const
{
...
int64_t SwitchProxyVpcResponse::GetFlowId() const
{
    return m_flowId;
}

bool SwitchProxyVpcResponse::FlowIdHasBeenSet() const
{
