...
CoreInternalOutcome AddServerlessRoInstancesResponse::Deserialize(const string &payload)
{
...
string AddServerlessRoInstancesResponse::ToJsonString() const
{
...
string AddServerlessRoInstancesResponse::GetTranId() const
{
    return m_tranId;
}

bool AddServerlessRoInstancesResponse::TranIdHasBeenSet() const
{
    return m_tranIdHasBeenSet;
}

vector<string> AddServerlessRoInstancesResponse::GetDealNames() const
{
    return m_dealNames;
}

bool AddServerlessRoInstancesResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> AddServerlessRoInstancesResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool AddServerlessRoInstancesResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

vector<string> AddServerlessRoInstancesResponse::GetBigDealIds() const
{
    return m_bigDealIds;
}

bool AddServerlessRoInstancesResponse::BigDealIdsHasBeenSet() const
{
