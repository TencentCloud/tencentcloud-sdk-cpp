...
CoreInternalOutcome DescribeLibraDBClusterAccountAllPrivilegesResponse::Deserialize(const string &payload)
{
...
string DescribeLibraDBClusterAccountAllPrivilegesResponse::ToJsonString() const
{
...
vector<string> DescribeLibraDBClusterAccountAllPrivilegesResponse::GetPrivilegeStatements() const
{
    return m_privilegeStatements;
}

bool DescribeLibraDBClusterAccountAllPrivilegesResponse::PrivilegeStatementsHasBeenSet() const
{
    return m_privilegeStatementsHasBeenSet;
}

vector<string> DescribeLibraDBClusterAccountAllPrivilegesResponse::GetGlobalPrivileges() const
{
    return m_globalPrivileges;
}

bool DescribeLibraDBClusterAccountAllPrivilegesResponse::GlobalPrivilegesHasBeenSet() const
{
    return m_globalPrivilegesHasBeenSet;
}

vector<DatabasePrivileges> DescribeLibraDBClusterAccountAllPrivilegesResponse::GetDatabasePrivileges() const
{
    return m_databasePrivileges;
}

bool DescribeLibraDBClusterAccountAllPrivilegesResponse::DatabasePrivilegesHasBeenSet() const
{
    return m_databasePrivilegesHasBeenSet;
}

vector<TablePrivileges> DescribeLibraDBClusterAccountAllPrivilegesResponse::GetTablePrivileges() const
{
    return m_tablePrivileges;
}

bool DescribeLibraDBClusterAccountAllPrivilegesResponse::TablePrivilegesHasBeenSet() const
{
