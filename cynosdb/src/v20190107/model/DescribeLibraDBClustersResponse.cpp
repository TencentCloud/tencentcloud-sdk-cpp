...
CoreInternalOutcome DescribeLibraDBClustersResponse::Deserialize(const string &payload)
{
...
string DescribeLibraDBClustersResponse::ToJsonString() const
{
...
vector<LibraDBClusterSet> DescribeLibraDBClustersResponse::GetClusterSet() const
{
    return m_clusterSet;
}

bool DescribeLibraDBClustersResponse::ClusterSetHasBeenSet() const
{
    return m_clusterSetHasBeenSet;
}

int64_t DescribeLibraDBClustersResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLibraDBClustersResponse::TotalCountHasBeenSet() const
{
