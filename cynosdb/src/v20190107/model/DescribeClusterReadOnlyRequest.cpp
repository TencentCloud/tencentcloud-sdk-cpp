...
string DescribeClusterReadOnlyRequest::ToJsonString() const
{
...
vector<string> DescribeClusterReadOnlyRequest::GetClusterIds() const
{
    return m_clusterIds;
}

void DescribeClusterReadOnlyRequest::SetClusterIds(const vector<string>& _clusterIds)
{
    m_clusterIds = _clusterIds;
    m_clusterIdsHasBeenSet = true;
}

bool DescribeClusterReadOnlyRequest::ClusterIdsHasBeenSet() const
{
