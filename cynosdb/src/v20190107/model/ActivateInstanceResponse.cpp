...
CoreInternalOutcome ActivateInstanceResponse::Deserialize(const string &payload)
{
...
string ActivateInstanceResponse::ToJsonString() const
{
...
int64_t ActivateInstanceResponse::GetFlowId() const
{
    return m_flowId;
}

bool ActivateInstanceResponse::FlowIdHasBeenSet() const
{
