...
string GetLocalEngineRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string GetLocalEngineRequest::GetKey() const
{
    return m_key;
}

void GetLocalEngineRequest::SetKey(const string& _key)
{
    m_key = _key;
    m_keyHasBeenSet = true;
}

bool GetLocalEngineRequest::KeyHasBeenSet() const
{
