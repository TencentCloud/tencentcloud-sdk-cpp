...
CoreInternalOutcome GetLocalEngineResponse::Deserialize(const string &payload)
{
...
string GetLocalEngineResponse::ToJsonString() const
{
...
uint64_t GetLocalEngineResponse::GetStatus() const
{
    return m_status;
}

bool GetLocalEngineResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string GetLocalEngineResponse::GetInfo() const
{
    return m_info;
}

bool GetLocalEngineResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string GetLocalEngineResponse::GetData() const
{
    return m_data;
}

bool GetLocalEngineResponse::DataHasBeenSet() const
{
