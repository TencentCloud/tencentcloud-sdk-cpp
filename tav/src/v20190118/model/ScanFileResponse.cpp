...
CoreInternalOutcome ScanFileResponse::Deserialize(const string &payload)
{
...
string ScanFileResponse::ToJsonString() const
{
...
uint64_t ScanFileResponse::GetStatus() const
{
    return m_status;
}

bool ScanFileResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ScanFileResponse::GetInfo() const
{
    return m_info;
}

bool ScanFileResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string ScanFileResponse::GetData() const
{
    return m_data;
}

bool ScanFileResponse::DataHasBeenSet() const
{
