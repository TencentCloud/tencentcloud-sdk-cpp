...
CoreInternalOutcome GetScanResultResponse::Deserialize(const string &payload)
{
...
string GetScanResultResponse::ToJsonString() const
{
...
uint64_t GetScanResultResponse::GetStatus() const
{
    return m_status;
}

bool GetScanResultResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string GetScanResultResponse::GetInfo() const
{
    return m_info;
}

bool GetScanResultResponse::InfoHasBeenSet() const
{
    return m_infoHasBeenSet;
}

string GetScanResultResponse::GetData() const
{
    return m_data;
}

bool GetScanResultResponse::DataHasBeenSet() const
{
