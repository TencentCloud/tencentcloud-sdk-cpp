...
#ifndef TENCENTCLOUD_TAV_V20190118_MODEL_GETLOCALENGINERESPONSE_H_
#define TENCENTCLOUD_TAV_V20190118_MODEL_GETLOCALENGINERESPONSE_H_
    ...
    namespace Tav
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class GetLocalEngineResponse : public AbstractModel
                {
                public:
                    GetLocalEngineResponse();
                    ~GetLocalEngineResponse() = default;
...
#endif // !TENCENTCLOUD_TAV_V20190118_MODEL_GETLOCALENGINERESPONSE_H_
