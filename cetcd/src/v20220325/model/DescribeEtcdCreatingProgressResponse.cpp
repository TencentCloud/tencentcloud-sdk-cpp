...
DescribeEtcdCreatingProgressResponse::DescribeEtcdCreatingProgressResponse() :
    m_stepsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdCreatingProgressResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdCreatingProgressResponse::ToJsonString() const
{
...
vector<TaskStepInfo> DescribeEtcdCreatingProgressResponse::GetSteps() const
{
    return m_steps;
}

bool DescribeEtcdCreatingProgressResponse::StepsHasBeenSet() const
{
