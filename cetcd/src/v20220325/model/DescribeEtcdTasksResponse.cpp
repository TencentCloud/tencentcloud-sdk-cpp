...
DescribeEtcdTasksResponse::DescribeEtcdTasksResponse() :
    m_tasksHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdTasksResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdTasksResponse::ToJsonString() const
{
...
vector<EtcdTaskInfo> DescribeEtcdTasksResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeEtcdTasksResponse::TasksHasBeenSet() const
{
