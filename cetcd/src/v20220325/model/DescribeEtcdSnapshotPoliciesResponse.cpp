...
DescribeEtcdSnapshotPoliciesResponse::DescribeEtcdSnapshotPoliciesResponse() :
    m_snapshotPoliciesHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdSnapshotPoliciesResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdSnapshotPoliciesResponse::ToJsonString() const
{
...
vector<EtcdSnapshotPolicy> DescribeEtcdSnapshotPoliciesResponse::GetSnapshotPolicies() const
{
    return m_snapshotPolicies;
}

bool DescribeEtcdSnapshotPoliciesResponse::SnapshotPoliciesHasBeenSet() const
{
