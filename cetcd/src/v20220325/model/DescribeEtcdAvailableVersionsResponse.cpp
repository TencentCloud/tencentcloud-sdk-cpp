...
DescribeEtcdAvailableVersionsResponse::DescribeEtcdAvailableVersionsResponse() :
    m_versionsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdAvailableVersionsResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdAvailableVersionsResponse::ToJsonString() const
{
...
vector<VersionInstance> DescribeEtcdAvailableVersionsResponse::GetVersions() const
{
    return m_versions;
}

bool DescribeEtcdAvailableVersionsResponse::VersionsHasBeenSet() const
{
