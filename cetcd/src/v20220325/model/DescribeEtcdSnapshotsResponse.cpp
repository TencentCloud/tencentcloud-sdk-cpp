...
DescribeEtcdSnapshotsResponse::DescribeEtcdSnapshotsResponse() :
    m_snapshotsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdSnapshotsResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdSnapshotsResponse::ToJsonString() const
{
...
vector<EtcdSnapshot> DescribeEtcdSnapshotsResponse::GetSnapshots() const
{
    return m_snapshots;
}

bool DescribeEtcdSnapshotsResponse::SnapshotsHasBeenSet() const
{
