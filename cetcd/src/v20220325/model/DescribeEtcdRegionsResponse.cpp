...
DescribeEtcdRegionsResponse::DescribeEtcdRegionsResponse() :
    m_regionsHasBeenSet(false)
{
}

CoreInternalOutcome DescribeEtcdRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeEtcdRegionsResponse::ToJsonString() const
{
...
vector<RegionInstance> DescribeEtcdRegionsResponse::GetRegions() const
{
    return m_regions;
}

bool DescribeEtcdRegionsResponse::RegionsHasBeenSet() const
{
