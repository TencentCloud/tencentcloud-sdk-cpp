...
#ifndef TENCENTCLOUD_CETCD_V20220325_MODEL_CREATEETCDSNAPSHOTPOLICYREQUEST_H_
#define TENCENTCLOUD_CETCD_V20220325_MODEL_CREATEETCDSNAPSHOTPOLICYREQUEST_H_
    ...
    namespace Cetcd
    {
        namespace V20220325
        {
            namespace Model
            {
                ...
                */
                class CreateEtcdSnapshotPolicyRequest : public AbstractModel
                {
                public:
                    CreateEtcdSnapshotPolicyRequest();
                    ~CreateEtcdSnapshotPolicyRequest() = default;
...
#endif // !TENCENTCLOUD_CETCD_V20220325_MODEL_CREATEETCDSNAPSHOTPOLICYREQUEST_H_
