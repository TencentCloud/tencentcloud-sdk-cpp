...
#ifndef TENCENTCLOUD_AI3D_V20250513_MODEL_SUBMITHUNYUANTO3DUVJOBREQUEST_H_
#define TENCENTCLOUD_AI3D_V20250513_MODEL_SUBMITHUNYUANTO3DUVJOBREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取需进行UV展开的3D文件URL，可支持FBX,OBJ,GLB格式。
                     * @return File 需进行UV展开的3D文件URL，可支持FBX,OBJ,GLB格式。
                     * 
                     */
                    InputFile3D GetFile() const;

                    /**
                     * 设置需进行UV展开的3D文件URL，可支持FBX,OBJ,GLB格式。
...
#endif // !TENCENTCLOUD_AI3D_V20250513_MODEL_SUBMITHUNYUANTO3DUVJOBREQUEST_H_
