...
#ifndef TENCENTCLOUD_AI3D_V20250513_MODEL_DESCRIBEREDUCEFACEJOBRESPONSE_H_
#define TENCENTCLOUD_AI3D_V20250513_MODEL_DESCRIBEREDUCEFACEJOBRESPONSE_H_
    ...
    namespace Ai3d
    {
        namespace V20250513
        {
            namespace Model
            {
                ...
                */
                class DescribeReduceFaceJobResponse : public AbstractModel
                {
                public:
                    DescribeReduceFaceJobResponse();
                    ~DescribeReduceFaceJobResponse() = default;
...
#endif // !TENCENTCLOUD_AI3D_V20250513_MODEL_DESCRIBEREDUCEFACEJOBRESPONSE_H_
