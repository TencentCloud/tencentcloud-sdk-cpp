...
SubmitProfileTo3DJobResponse::SubmitProfileTo3DJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitProfileTo3DJobResponse::Deserialize(const string &payload)
{
...
string SubmitProfileTo3DJobResponse::ToJsonString() const
{
...
string SubmitProfileTo3DJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitProfileTo3DJobResponse::JobIdHasBeenSet() const
{
