...
CoreInternalOutcome SubmitHunyuanTo3DRapidJobResponse::Deserialize(const string &payload)
{
...
string SubmitHunyuanTo3DRapidJobResponse::ToJsonString() const
{
...
string SubmitHunyuanTo3DRapidJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHunyuanTo3DRapidJobResponse::JobIdHasBeenSet() const
{
