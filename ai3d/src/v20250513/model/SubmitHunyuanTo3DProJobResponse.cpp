...
CoreInternalOutcome SubmitHunyuanTo3DProJobResponse::Deserialize(const string &payload)
{
...
string SubmitHunyuanTo3DProJobResponse::ToJsonString() const
{
...
string SubmitHunyuanTo3DProJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHunyuanTo3DProJobResponse::JobIdHasBeenSet() const
{
