...
DescribeTextureTo3DJobResponse::DescribeTextureTo3DJobResponse() :
...
CoreInternalOutcome DescribeTextureTo3DJobResponse::Deserialize(const string &payload)
{
...
string DescribeTextureTo3DJobResponse::ToJsonString() const
{
...
string DescribeTextureTo3DJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeTextureTo3DJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeTextureTo3DJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeTextureTo3DJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeTextureTo3DJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeTextureTo3DJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeTextureTo3DJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeTextureTo3DJobResponse::ResultFile3DsHasBeenSet() const
{
