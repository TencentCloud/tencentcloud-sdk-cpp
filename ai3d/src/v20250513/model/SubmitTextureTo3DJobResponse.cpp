...
SubmitTextureTo3DJobResponse::SubmitTextureTo3DJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitTextureTo3DJobResponse::Deserialize(const string &payload)
{
...
string SubmitTextureTo3DJobResponse::ToJsonString() const
{
...
string SubmitTextureTo3DJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitTextureTo3DJobResponse::JobIdHasBeenSet() const
{
