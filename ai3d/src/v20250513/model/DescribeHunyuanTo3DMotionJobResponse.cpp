...
DescribeHunyuanTo3DMotionJobResponse::DescribeHunyuanTo3DMotionJobResponse() :
...
CoreInternalOutcome DescribeHunyuanTo3DMotionJobResponse::Deserialize(const string &payload)
{
...
string DescribeHunyuanTo3DMotionJobResponse::ToJsonString() const
{
...
string DescribeHunyuanTo3DMotionJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeHunyuanTo3DMotionJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeHunyuanTo3DMotionJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeHunyuanTo3DMotionJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeHunyuanTo3DMotionJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeHunyuanTo3DMotionJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeHunyuanTo3DMotionJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeHunyuanTo3DMotionJobResponse::ResultFile3DsHasBeenSet() const
{
