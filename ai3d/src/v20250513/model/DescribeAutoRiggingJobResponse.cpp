...
CoreInternalOutcome DescribeAutoRiggingJobResponse::Deserialize(const string &payload)
{
...
string DescribeAutoRiggingJobResponse::ToJsonString() const
{
...
string DescribeAutoRiggingJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAutoRiggingJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeAutoRiggingJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeAutoRiggingJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeAutoRiggingJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeAutoRiggingJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeAutoRiggingJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeAutoRiggingJobResponse::ResultFile3DsHasBeenSet() const
{
