...
CoreInternalOutcome SubmitAutoRiggingJobResponse::Deserialize(const string &payload)
{
...
string SubmitAutoRiggingJobResponse::ToJsonString() const
{
...
string SubmitAutoRiggingJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitAutoRiggingJobResponse::JobIdHasBeenSet() const
{
