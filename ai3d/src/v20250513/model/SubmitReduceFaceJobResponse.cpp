...
SubmitReduceFaceJobResponse::SubmitReduceFaceJobResponse() :
    m_jobIdHasBeenSet(false)
{
}

CoreInternalOutcome SubmitReduceFaceJobResponse::Deserialize(const string &payload)
{
...
string SubmitReduceFaceJobResponse::ToJsonString() const
{
...
string SubmitReduceFaceJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitReduceFaceJobResponse::JobIdHasBeenSet() const
{
