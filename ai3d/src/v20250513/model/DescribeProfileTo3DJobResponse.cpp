...
DescribeProfileTo3DJobResponse::DescribeProfileTo3DJobResponse() :
...
CoreInternalOutcome DescribeProfileTo3DJobResponse::Deserialize(const string &payload)
{
...
string DescribeProfileTo3DJobResponse::ToJsonString() const
{
...
string DescribeProfileTo3DJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeProfileTo3DJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeProfileTo3DJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeProfileTo3DJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeProfileTo3DJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeProfileTo3DJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeProfileTo3DJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeProfileTo3DJobResponse::ResultFile3DsHasBeenSet() const
{
