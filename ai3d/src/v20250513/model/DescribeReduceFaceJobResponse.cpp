...
DescribeReduceFaceJobResponse::DescribeReduceFaceJobResponse() :
...
CoreInternalOutcome DescribeReduceFaceJobResponse::Deserialize(const string &payload)
{
...
string DescribeReduceFaceJobResponse::ToJsonString() const
{
...
string DescribeReduceFaceJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeReduceFaceJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeReduceFaceJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeReduceFaceJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeReduceFaceJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeReduceFaceJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeReduceFaceJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeReduceFaceJobResponse::ResultFile3DsHasBeenSet() const
{
