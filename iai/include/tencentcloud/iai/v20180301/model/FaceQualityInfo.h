...
#ifndef TENCENTCLOUD_IAI_V20180301_MODEL_FACEQUALITYINFO_H_
#define TENCENTCLOUD_IAI_V20180301_MODEL_FACEQUALITYINFO_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取质量分: [0,100]，综合评价图像质量是否适合人脸识别，分数越高质量越好。 
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置质量分: [0,100]，综合评价图像质量是否适合人脸识别，分数越高质量越好。 
正常情况，只需要使用Score作为质量分总体的判断标准即可。Sharpness、Brightness、Completeness等细项分仅供参考。
参考范围：[0,40]较差，[40,60] 一般，[60,80]较好，[80,100]很好。 
建议：人脸入库选取70以上的图片。
注意：此字段可能返回 null，表示取不到有效值。
...
#endif // !TENCENTCLOUD_IAI_V20180301_MODEL_FACEQUALITYINFO_H_
