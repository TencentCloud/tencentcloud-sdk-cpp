...
#ifndef TENCENTCLOUD_IAI_V20200303_MODEL_COMPAREMASKFACEREQUEST_H_
#define TENCENTCLOUD_IAI_V20200303_MODEL_COMPAREMASKFACEREQUEST_H_
    ...
    namespace Iai
    {
        namespace V20200303
        {
            namespace Model
            {
                ...
                */
                class CompareMaskFaceRequest : public AbstractModel
                {
                public:
                    CompareMaskFaceRequest();
                    ~CompareMaskFaceRequest() = default;
...
#endif // !TENCENTCLOUD_IAI_V20200303_MODEL_COMPAREMASKFACEREQUEST_H_
