...
#ifndef TENCENTCLOUD_IAI_V20200303_MODEL_ANALYZEDENSELANDMARKSREQUEST_H_
#define TENCENTCLOUD_IAI_V20200303_MODEL_ANALYZEDENSELANDMARKSREQUEST_H_
    ...
    namespace Iai
    {
        namespace V20200303
        {
            namespace Model
            {
                ...
                */
                class AnalyzeDenseLandmarksRequest : public AbstractModel
                {
                public:
                    AnalyzeDenseLandmarksRequest();
                    ~AnalyzeDenseLandmarksRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取检测模式。0 为检测所有出现的人脸， 1 为检测面积最大的人脸。 
默认为 0。 
...
#endif // !TENCENTCLOUD_IAI_V20200303_MODEL_ANALYZEDENSELANDMARKSREQUEST_H_
