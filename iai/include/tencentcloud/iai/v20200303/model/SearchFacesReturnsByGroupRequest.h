...
#ifndef TENCENTCLOUD_IAI_V20200303_MODEL_SEARCHFACESRETURNSBYGROUPREQUEST_H_
#define TENCENTCLOUD_IAI_V20200303_MODEL_SEARCHFACESRETURNSBYGROUPREQUEST_H_
    ...
    namespace Iai
    {
        namespace V20200303
        {
            namespace Model
            {
                ...
                */
                class SearchFacesReturnsByGroupRequest : public AbstractModel
                {
                public:
                    SearchFacesReturnsByGroupRequest();
                    ~SearchFacesReturnsByGroupRequest() = default;
...
#endif // !TENCENTCLOUD_IAI_V20200303_MODEL_SEARCHFACESRETURNSBYGROUPREQUEST_H_
