...
#ifndef TENCENTCLOUD_IAI_V20200303_MODEL_VERIFYFACEREQUEST_H_
#define TENCENTCLOUD_IAI_V20200303_MODEL_VERIFYFACEREQUEST_H_
    ...
    namespace Iai
    {
        namespace V20200303
        {
            namespace Model
            {
                ...
                * VerifyFace请求参数结构体
                */
                class VerifyFaceRequest : public AbstractModel
                {
                public:
                    VerifyFaceRequest();
                    ~VerifyFaceRequest() = default;
...
#endif // !TENCENTCLOUD_IAI_V20200303_MODEL_VERIFYFACEREQUEST_H_
