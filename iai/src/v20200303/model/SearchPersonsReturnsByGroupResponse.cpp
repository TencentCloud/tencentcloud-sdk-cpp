...
uint64_t SearchPersonsReturnsByGroupResponse::GetPersonNum() const
{
    return m_personNum;
}

bool SearchPersonsReturnsByGroupResponse::PersonNumHasBeenSet() const
{
    return m_personNumHasBeenSet;
}

vector<ResultsReturnsByGroup> SearchPersonsReturnsByGroupResponse::GetResultsReturnsByGroup() const
{
    return m_resultsReturnsByGroup;
}

bool SearchPersonsReturnsByGroupResponse::ResultsReturnsByGroupHasBeenSet() const
{
    return m_resultsReturnsByGroupHasBeenSet;
}

string SearchPersonsReturnsByGroupResponse::GetFaceModelVersion() const
{
    return m_faceModelVersion;
}

bool SearchPersonsReturnsByGroupResponse::FaceModelVersionHasBeenSet() const
{
