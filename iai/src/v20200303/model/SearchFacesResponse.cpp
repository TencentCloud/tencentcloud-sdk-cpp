...
string SearchFacesResponse::ToJsonString() const
{
...
string SearchFacesResponse::GetFaceModelVersion() const
{
    return m_faceModelVersion;
}

bool SearchFacesResponse::FaceModelVersionHasBeenSet() const
{
