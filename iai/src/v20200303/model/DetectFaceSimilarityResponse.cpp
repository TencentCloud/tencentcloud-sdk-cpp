...
CoreInternalOutcome DetectFaceSimilarityResponse::Deserialize(const string &payload)
{
...
string DetectFaceSimilarityResponse::ToJsonString() const
{
...
double DetectFaceSimilarityResponse::GetScore() const
{
    return m_score;
}

bool DetectFaceSimilarityResponse::ScoreHasBeenSet() const
{
