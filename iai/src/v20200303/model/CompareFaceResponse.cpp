...
CoreInternalOutcome CompareFaceResponse::Deserialize(const string &payload)
{
...
string CompareFaceResponse::ToJsonString() const
{
...
double CompareFaceResponse::GetScore() const
{
    return m_score;
}
