...
CoreInternalOutcome FaceDetailAttributesInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void FaceDetailAttributesInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
