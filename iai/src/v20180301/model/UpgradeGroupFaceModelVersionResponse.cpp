...
CoreInternalOutcome UpgradeGroupFaceModelVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeGroupFaceModelVersionResponse::ToJsonString() const
{
...
string UpgradeGroupFaceModelVersionResponse::GetJobId() const
{
    return m_jobId;
}

bool UpgradeGroupFaceModelVersionResponse::JobIdHasBeenSet() const
{
