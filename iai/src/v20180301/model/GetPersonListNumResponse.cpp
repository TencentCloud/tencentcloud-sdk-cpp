...
CoreInternalOutcome GetPersonListNumResponse::Deserialize(const string &payload)
{
...
string GetPersonListNumResponse::ToJsonString() const
{
...
uint64_t GetPersonListNumResponse::GetPersonNum() const
{
    return m_personNum;
}

bool GetPersonListNumResponse::PersonNumHasBeenSet() const
{
    return m_personNumHasBeenSet;
}

uint64_t GetPersonListNumResponse::GetFaceNum() const
{
    return m_faceNum;
}

bool GetPersonListNumResponse::FaceNumHasBeenSet() const
{
