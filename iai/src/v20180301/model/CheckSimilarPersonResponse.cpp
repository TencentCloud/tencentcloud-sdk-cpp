...
CoreInternalOutcome CheckSimilarPersonResponse::Deserialize(const string &payload)
{
...
string CheckSimilarPersonResponse::ToJsonString() const
{
...
string CheckSimilarPersonResponse::GetJobId() const
{
    return m_jobId;
}

bool CheckSimilarPersonResponse::JobIdHasBeenSet() const
{
