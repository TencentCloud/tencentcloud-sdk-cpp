...
string EstimateCheckSimilarPersonCostTimeRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
vector<string> EstimateCheckSimilarPersonCostTimeRequest::GetGroupIds() const
{
    return m_groupIds;
}

void EstimateCheckSimilarPersonCostTimeRequest::SetGroupIds(const vector<string>& _groupIds)
{
    m_groupIds = _groupIds;
    m_groupIdsHasBeenSet = true;
}

bool EstimateCheckSimilarPersonCostTimeRequest::GroupIdsHasBeenSet() const
{
