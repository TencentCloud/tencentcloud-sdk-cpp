...
string DescribeSecurityPolicyRelationsRequest::ToJsonString() const
{
...
vector<string> DescribeSecurityPolicyRelationsRequest::GetSecurityPolicyIds() const
{
    return m_securityPolicyIds;
}

void DescribeSecurityPolicyRelationsRequest::SetSecurityPolicyIds(const vector<string>& _securityPolicyIds)
{
    m_securityPolicyIds = _securityPolicyIds;
    m_securityPolicyIdsHasBeenSet = true;
}

bool DescribeSecurityPolicyRelationsRequest::SecurityPolicyIdsHasBeenSet() const
{
