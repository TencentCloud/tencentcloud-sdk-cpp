...
string DescribeSecurityPoliciesResponse::GetNextToken() const
{
    return m_nextToken;
}

bool DescribeSecurityPoliciesResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

vector<SecurityPolicyInfo> DescribeSecurityPoliciesResponse::GetSecurityPolicies() const
{
    return m_securityPolicies;
}

bool DescribeSecurityPoliciesResponse::SecurityPoliciesHasBeenSet() const
{
    return m_securityPoliciesHasBeenSet;
}

int64_t DescribeSecurityPoliciesResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSecurityPoliciesResponse::TotalCountHasBeenSet() const
{
