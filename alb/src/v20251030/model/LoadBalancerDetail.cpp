...
CoreInternalOutcome LoadBalancerDetail::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("AccessLogConfig") && !value["AccessLogConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.AccessLogConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AddressType") && !value["AddressType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.AddressType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("DeletionProtection") && !value["DeletionProtection"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.DeletionProtection` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LoadBalancerBillingConfig") && !value["LoadBalancerBillingConfig"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.LoadBalancerBillingConfig` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LoadBalancerOperationLocks") && !value["LoadBalancerOperationLocks"].IsNull())
    {
        if (!value["LoadBalancerOperationLocks"].IsArray())
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.LoadBalancerOperationLocks` is not array type"));
    ...
    if (value.HasMember("LoadBalancerStatus") && !value["LoadBalancerStatus"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.LoadBalancerStatus` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("ModificationProtection") && !value["ModificationProtection"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.ModificationProtection` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("SecurityGroupIds") && !value["SecurityGroupIds"].IsNull())
    {
        if (!value["SecurityGroupIds"].IsArray())
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.SecurityGroupIds` is not array type"));
    ...
    if (value.HasMember("ZoneMappings") && !value["ZoneMappings"].IsNull())
    {
        if (!value["ZoneMappings"].IsArray())
            return CoreInternalOutcome(Core::Error("response `LoadBalancerDetail.ZoneMappings` is not array type"));

        const rapidjson::Value &tmpValue = value["ZoneMappings"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ZoneMappingInfo item;
            CoreInternalOutcome outcome = item.Deserialize(*itr);
            if (!outcome.IsSuccess())
            {
                outcome.GetError().SetRequestId(requestId);
...
AccessLogConfig LoadBalancerDetail::GetAccessLogConfig() const
{
    return m_accessLogConfig;
}

void LoadBalancerDetail::SetAccessLogConfig(const AccessLogConfig& _accessLogConfig)
{
    m_accessLogConfig = _accessLogConfig;
    m_accessLogConfigHasBeenSet = true;
}

bool LoadBalancerDetail::AccessLogConfigHasBeenSet() const
{
...
string LoadBalancerDetail::GetAddressType() const
{
    return m_addressType;
}

void LoadBalancerDetail::SetAddressType(const string& _addressType)
{
    m_addressType = _addressType;
    m_addressTypeHasBeenSet = true;
}

bool LoadBalancerDetail::AddressTypeHasBeenSet() const
{
...
DeletionProtectionConfig LoadBalancerDetail::GetDeletionProtection() const
{
    return m_deletionProtection;
}

void LoadBalancerDetail::SetDeletionProtection(const DeletionProtectionConfig& _deletionProtection)
{
    m_deletionProtection = _deletionProtection;
    m_deletionProtectionHasBeenSet = true;
}

bool LoadBalancerDetail::DeletionProtectionHasBeenSet() const
{
...
LoadBalancerBillingConfig LoadBalancerDetail::GetLoadBalancerBillingConfig() const
{
    return m_loadBalancerBillingConfig;
}

void LoadBalancerDetail::SetLoadBalancerBillingConfig(const LoadBalancerBillingConfig& _loadBalancerBillingConfig)
{
    m_loadBalancerBillingConfig = _loadBalancerBillingConfig;
    m_loadBalancerBillingConfigHasBeenSet = true;
}

bool LoadBalancerDetail::LoadBalancerBillingConfigHasBeenSet() const
{
...
vector<LoadBalancerOperationLocksItem> LoadBalancerDetail::GetLoadBalancerOperationLocks() const
{
    return m_loadBalancerOperationLocks;
}

void LoadBalancerDetail::SetLoadBalancerOperationLocks(const vector<LoadBalancerOperationLocksItem>& _loadBalancerOperationLocks)
{
    m_loadBalancerOperationLocks = _loadBalancerOperationLocks;
    m_loadBalancerOperationLocksHasBeenSet = true;
}

bool LoadBalancerDetail::LoadBalancerOperationLocksHasBeenSet() const
{
    return m_loadBalancerOperationLocksHasBeenSet;
}

string LoadBalancerDetail::GetLoadBalancerStatus() const
{
    return m_loadBalancerStatus;
}

void LoadBalancerDetail::SetLoadBalancerStatus(const string& _loadBalancerStatus)
{
    m_loadBalancerStatus = _loadBalancerStatus;
    m_loadBalancerStatusHasBeenSet = true;
}

bool LoadBalancerDetail::LoadBalancerStatusHasBeenSet() const
{
    return m_loadBalancerStatusHasBeenSet;
}

ModificationProtectionInfo LoadBalancerDetail::GetModificationProtection() const
{
    return m_modificationProtection;
}

void LoadBalancerDetail::SetModificationProtection(const ModificationProtectionInfo& _modificationProtection)
{
    m_modificationProtection = _modificationProtection;
    m_modificationProtectionHasBeenSet = true;
}

bool LoadBalancerDetail::ModificationProtectionHasBeenSet() const
{
    return m_modificationProtectionHasBeenSet;
}

vector<string> LoadBalancerDetail::GetSecurityGroupIds() const
{
    return m_securityGroupIds;
}

void LoadBalancerDetail::SetSecurityGroupIds(const vector<string>& _securityGroupIds)
{
    m_securityGroupIds = _securityGroupIds;
    m_securityGroupIdsHasBeenSet = true;
}

bool LoadBalancerDetail::SecurityGroupIdsHasBeenSet() const
{
...
vector<ZoneMappingInfo> LoadBalancerDetail::GetZoneMappings() const
{
    return m_zoneMappings;
}

void LoadBalancerDetail::SetZoneMappings(const vector<ZoneMappingInfo>& _zoneMappings)
{
    m_zoneMappings = _zoneMappings;
    m_zoneMappingsHasBeenSet = true;
}

bool LoadBalancerDetail::ZoneMappingsHasBeenSet() const
{
