...
#include <tencentcloud/alb/v20251030/model/Price.h>
...
PostPayPriceInfo Price::GetInstancePrice() const
{
    return m_instancePrice;
}

void Price::SetInstancePrice(const PostPayPriceInfo& _instancePrice)
{
...
PostPayPriceInfo Price::GetLcuPrice() const
{
    return m_lcuPrice;
}

void Price::SetLcuPrice(const PostPayPriceInfo& _lcuPrice)
{
