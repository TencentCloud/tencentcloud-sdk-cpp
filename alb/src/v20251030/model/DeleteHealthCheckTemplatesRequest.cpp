...
string DeleteHealthCheckTemplatesRequest::ToJsonString() const
{
...
void DeleteHealthCheckTemplatesRequest::SetHealthCheckTemplateIds(const vector<string>& _healthCheckTemplateIds)
{
