...
vector<string> DescribeQuotaRequest::GetQuotaTypes() const
{
    return m_quotaTypes;
}

void DescribeQuotaRequest::SetQuotaTypes(const vector<string>& _quotaTypes)
{
    m_quotaTypes = _quotaTypes;
    m_quotaTypesHasBeenSet = true;
}

bool DescribeQuotaRequest::QuotaTypesHasBeenSet() const
{
    return m_quotaTypesHasBeenSet;
}

vector<string> DescribeQuotaRequest::GetDisplayFields() const
{
    return m_displayFields;
}

void DescribeQuotaRequest::SetDisplayFields(const vector<string>& _displayFields)
{
    m_displayFields = _displayFields;
    m_displayFieldsHasBeenSet = true;
}

bool DescribeQuotaRequest::DisplayFieldsHasBeenSet() const
{
    return m_displayFieldsHasBeenSet;
}

vector<string> DescribeQuotaRequest::GetResourceIds() const
{
    return m_resourceIds;
}

void DescribeQuotaRequest::SetResourceIds(const vector<string>& _resourceIds)
{
    m_resourceIds = _resourceIds;
    m_resourceIdsHasBeenSet = true;
}

bool DescribeQuotaRequest::ResourceIdsHasBeenSet() const
{
