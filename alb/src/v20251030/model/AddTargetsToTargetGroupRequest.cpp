...
string AddTargetsToTargetGroupRequest::ToJsonString() const
{
...
string AddTargetsToTargetGroupRequest::GetTargetGroupId() const
{
    return m_targetGroupId;
}

void AddTargetsToTargetGroupRequest::SetTargetGroupId(const string& _targetGroupId)
{
    m_targetGroupId = _targetGroupId;
    m_targetGroupIdHasBeenSet = true;
}

bool AddTargetsToTargetGroupRequest::TargetGroupIdHasBeenSet() const
{
...
void AddTargetsToTargetGroupRequest::SetTargets(const vector<TargetToAdd>& _targets)
{
    m_targets = _targets;
