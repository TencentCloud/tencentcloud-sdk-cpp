...
CoreInternalOutcome InquirePriceCreateLoadBalancerResponse::Deserialize(const string &payload)
{
...
string InquirePriceCreateLoadBalancerResponse::ToJsonString() const
{
...
Price InquirePriceCreateLoadBalancerResponse::GetPrice() const
{
    return m_price;
}

bool InquirePriceCreateLoadBalancerResponse::PriceHasBeenSet() const
{
