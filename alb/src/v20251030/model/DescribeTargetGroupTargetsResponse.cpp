...
CoreInternalOutcome DescribeTargetGroupTargetsResponse::Deserialize(const string &payload)
{
...
string DescribeTargetGroupTargetsResponse::ToJsonString() const
{
...
string DescribeTargetGroupTargetsResponse::GetNextToken() const
{
    return m_nextToken;
}

bool DescribeTargetGroupTargetsResponse::NextTokenHasBeenSet() const
{
    return m_nextTokenHasBeenSet;
}

vector<TargetOutput> DescribeTargetGroupTargetsResponse::GetTargets() const
{
    return m_targets;
}

bool DescribeTargetGroupTargetsResponse::TargetsHasBeenSet() const
{
    return m_targetsHasBeenSet;
}

int64_t DescribeTargetGroupTargetsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeTargetGroupTargetsResponse::TotalCountHasBeenSet() const
{
