...
CoreInternalOutcome ModifySecurityPolicyAttributesResponse::Deserialize(const string &payload)
{
...
string ModifySecurityPolicyAttributesResponse::ToJsonString() const
{
