...
#ifndef TENCENTCLOUD_ALB_V20251030_MODEL_SECURITYPOLICYCAPABILITY_H_
#define TENCENTCLOUD_ALB_V20251030_MODEL_SECURITYPOLICYCAPABILITY_H_
    ...
    namespace Alb
    {
        namespace V20251030
        {
            namespace Model
            {
                ...
                * 不同TLS版本支持的加密套件信息。
                */
                class SecurityPolicyCapability : public AbstractModel
                {
                public:
                    SecurityPolicyCapability();
                    ~SecurityPolicyCapability() = default;
                    ...
                    /**
                     * 获取支持的 TLS 协议版本。可选值包括：TLSv1.0、TLSv1.1、TLSv1.2、TLSv1.3。
                    ...
                    /**
                     * 设置支持的 TLS 协议版本。可选值包括：TLSv1.0、TLSv1.1、TLSv1.2、TLSv1.3。
                     * @param _tLSVersion 支持的 TLS 协议版本。可选值包括：TLSv1.0、TLSv1.1、TLSv1.2、TLSv1.3。
                     * 
                     */
                    void SetTLSVersion(const std::string& _tLSVersion);
...
#endif // !TENCENTCLOUD_ALB_V20251030_MODEL_SECURITYPOLICYCAPABILITY_H_
