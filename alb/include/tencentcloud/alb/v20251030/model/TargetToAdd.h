...
#ifndef TENCENTCLOUD_ALB_V20251030_MODEL_TARGETTOADD_H_
#define TENCENTCLOUD_ALB_V20251030_MODEL_TARGETTOADD_H_
    ...
    namespace Alb
    {
        namespace V20251030
        {
            namespace Model
            {
                ...
                * 添加至目标组的后端服务
                */
                class TargetToAdd : public AbstractModel
                {
                public:
                    TargetToAdd();
                    ~TargetToAdd() = default;
...
- 当服务器组为 **Instance** 类型时，该参数为 **Eni** 的主内网 IP 或辅助内网 IP。
                    ...
                    /**
                     * 获取后端服务的权重，取值范围：**0 - 100**。默认值为**10**。如果设置权重为**0**，则不会将请求转发给该后端服务。
                    ...
                    /**
                     * 设置后端服务的权重，取值范围：**0 - 100**。默认值为**10**。如果设置权重为**0**，则不会将请求转发给该后端服务。
...
#endif // !TENCENTCLOUD_ALB_V20251030_MODEL_TARGETTOADD_H_
