...
#ifndef TENCENTCLOUD_ALB_V20251030_MODEL_DESCRIBELISTENERDETAILREQUEST_H_
#define TENCENTCLOUD_ALB_V20251030_MODEL_DESCRIBELISTENERDETAILREQUEST_H_
    ...
    namespace Alb
    {
        namespace V20251030
        {
            namespace Model
            {
                ...
                */
                class DescribeListenerDetailRequest : public AbstractModel
                {
                public:
                    DescribeListenerDetailRequest();
                    ~DescribeListenerDetailRequest() = default;
...
#endif // !TENCENTCLOUD_ALB_V20251030_MODEL_DESCRIBELISTENERDETAILREQUEST_H_
