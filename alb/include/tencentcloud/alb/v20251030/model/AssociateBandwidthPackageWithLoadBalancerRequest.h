...
#ifndef TENCENTCLOUD_ALB_V20251030_MODEL_ASSOCIATEBANDWIDTHPACKAGEWITHLOADBALANCERREQUEST_H_
#define TENCENTCLOUD_ALB_V20251030_MODEL_ASSOCIATEBANDWIDTHPACKAGEWITHLOADBALANCERREQUEST_H_
    ...
    namespace Alb
    {
        namespace V20251030
        {
            namespace Model
            {
                ...
                */
                class AssociateBandwidthPackageWithLoadBalancerRequest : public AbstractModel
                {
                public:
                    AssociateBandwidthPackageWithLoadBalancerRequest();
                    ~AssociateBandwidthPackageWithLoadBalancerRequest() = default;
...
#endif // !TENCENTCLOUD_ALB_V20251030_MODEL_ASSOCIATEBANDWIDTHPACKAGEWITHLOADBALANCERREQUEST_H_
