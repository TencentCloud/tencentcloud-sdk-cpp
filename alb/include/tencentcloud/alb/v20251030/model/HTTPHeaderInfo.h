            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取HTTP Header的键，长度1 ~ 40个字符，支持的字符集为：a-z A-Z 0-9 - _ 。
...
不支持中文，不支持Host，Cookie。
                    ...
                    /**
                     * 设置HTTP Header的键，长度1 ~ 40个字符，支持的字符集为：a-z A-Z 0-9 - _ 。
不支持中文，不支持Host，Cookie。
...
不支持中文，不支持Host，Cookie。
                    ...
                    /**
                     * 获取HTTP Header的值，长度1 ~ 128个字符，支持可打印字符。
...
不支持"，开头和结尾不能是空格，结尾不能是\。
                    ...
                    /**
                     * 设置HTTP Header的值，长度1 ~ 128个字符，支持可打印字符。
不支持"，开头和结尾不能是空格，结尾不能是\。
