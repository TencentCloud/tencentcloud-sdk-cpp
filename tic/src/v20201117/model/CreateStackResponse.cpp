...
CoreInternalOutcome CreateStackResponse::Deserialize(const string &payload)
{
...
string CreateStackResponse::ToJsonString() const
{
...
string CreateStackResponse::GetStackId() const
{
    return m_stackId;
}

bool CreateStackResponse::StackIdHasBeenSet() const
{
    return m_stackIdHasBeenSet;
}

string CreateStackResponse::GetVersionId() const
{
    return m_versionId;
}

bool CreateStackResponse::VersionIdHasBeenSet() const
{
