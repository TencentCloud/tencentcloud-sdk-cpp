...
string DescribeStackEventsResponse::ToJsonString() const
{
...
int64_t DescribeStackEventsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeStackEventsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<EventInfo> DescribeStackEventsResponse::GetEvents() const
{
    return m_events;
}

bool DescribeStackEventsResponse::EventsHasBeenSet() const
{
