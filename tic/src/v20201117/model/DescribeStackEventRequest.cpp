...
string DescribeStackEventRequest::ToJsonString() const
{
...
string DescribeStackEventRequest::GetEventId() const
{
    return m_eventId;
}

void DescribeStackEventRequest::SetEventId(const string& _eventId)
{
    m_eventId = _eventId;
    m_eventIdHasBeenSet = true;
}

bool DescribeStackEventRequest::EventIdHasBeenSet() const
{
