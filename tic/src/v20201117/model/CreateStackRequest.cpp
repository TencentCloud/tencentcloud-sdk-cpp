...
string CreateStackRequest::ToJsonString() const
{
    ...
    if (m_stackNameHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_stackName.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_stackRegionHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_stackRegion.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_templateUrlHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_templateUrl.c_str(), allocator).Move(), allocator);
    }
