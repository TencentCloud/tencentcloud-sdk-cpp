...
CoreInternalOutcome DestroyStackResponse::Deserialize(const string &payload)
{
...
string DestroyStackResponse::ToJsonString() const
{
...
string DestroyStackResponse::GetEventId() const
{
    return m_eventId;
}

bool DestroyStackResponse::EventIdHasBeenSet() const
{
