...
CoreInternalOutcome CreateStackVersionResponse::Deserialize(const string &payload)
{
...
string CreateStackVersionResponse::ToJsonString() const
{
...
string CreateStackVersionResponse::GetVersionId() const
{
    return m_versionId;
}

bool CreateStackVersionResponse::VersionIdHasBeenSet() const
{
