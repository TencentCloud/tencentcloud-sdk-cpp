...
CoreInternalOutcome PlanStackResponse::Deserialize(const string &payload)
{
...
string PlanStackResponse::ToJsonString() const
{
...
string PlanStackResponse::GetEventId() const
{
    return m_eventId;
}

bool PlanStackResponse::EventIdHasBeenSet() const
{
