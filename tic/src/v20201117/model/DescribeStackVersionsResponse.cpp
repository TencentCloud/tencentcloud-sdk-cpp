...
CoreInternalOutcome DescribeStackVersionsResponse::Deserialize(const string &payload)
{
...
string DescribeStackVersionsResponse::ToJsonString() const
{
...
int64_t DescribeStackVersionsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeStackVersionsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<VersionInfo> DescribeStackVersionsResponse::GetVersions() const
{
    return m_versions;
}

bool DescribeStackVersionsResponse::VersionsHasBeenSet() const
{
