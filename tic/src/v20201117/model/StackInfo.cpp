...
CoreInternalOutcome StackInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void StackInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_stackNameHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_stackName.c_str(), allocator).Move(), allocator);
    }
