...
CoreInternalOutcome ApplyStackResponse::Deserialize(const string &payload)
{
...
string ApplyStackResponse::ToJsonString() const
{
...
string ApplyStackResponse::GetEventId() const
{
    return m_eventId;
}

bool ApplyStackResponse::EventIdHasBeenSet() const
{
