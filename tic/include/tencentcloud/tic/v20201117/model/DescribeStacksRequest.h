...
#ifndef TENCENTCLOUD_TIC_V20201117_MODEL_DESCRIBESTACKSREQUEST_H_
#define TENCENTCLOUD_TIC_V20201117_MODEL_DESCRIBESTACKSREQUEST_H_
    ...
    namespace Tic
    {
        namespace V20201117
        {
            namespace Model
            {
                ...
                */
                class DescribeStacksRequest : public AbstractModel
                {
                public:
                    DescribeStacksRequest();
                    ~DescribeStacksRequest() = default;
                     ...
                     */
                    void SetStackIds(const std::vector<std::string>& _stackIds);

                    /**
                     * 判断参数 StackIds 是否已赋值
                     * @return StackIds 是否已赋值
                     */
                    bool StackIdsHasBeenSet() const;
                ...
                private:
                     ...
                     * 按照⼀个或者多个资源栈ID查询
                     */
                    std::vector<std::string> m_stackIds;
...
#endif // !TENCENTCLOUD_TIC_V20201117_MODEL_DESCRIBESTACKSREQUEST_H_
