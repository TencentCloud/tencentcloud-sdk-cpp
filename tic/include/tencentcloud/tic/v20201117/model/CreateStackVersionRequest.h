...
#ifndef TENCENTCLOUD_TIC_V20201117_MODEL_CREATESTACKVERSIONREQUEST_H_
#define TENCENTCLOUD_TIC_V20201117_MODEL_CREATESTACKVERSIONREQUEST_H_
    ...
    namespace Tic
    {
        namespace V20201117
        {
            namespace Model
            {
                ...
                */
                class CreateStackVersionRequest : public AbstractModel
                {
                public:
                    CreateStackVersionRequest();
                    ~CreateStackVersionRequest() = default;
...
#endif // !TENCENTCLOUD_TIC_V20201117_MODEL_CREATESTACKVERSIONREQUEST_H_
