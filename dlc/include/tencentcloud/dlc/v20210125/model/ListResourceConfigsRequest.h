...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTRESOURCECONFIGSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTRESOURCECONFIGSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListResourceConfigsRequest : public AbstractModel
                {
                public:
                    ListResourceConfigsRequest();
                    ~ListResourceConfigsRequest() = default;
                    ...
                    /**
                     * 获取提交时间起始过滤-时间戳（毫秒）
                     * @return StartTime 提交时间起始过滤-时间戳（毫秒）
                     * 
                     */
                    ...
                    /**
                     * 获取提交时间截止过滤-时间戳（毫秒）
                     * @return EndTime 提交时间截止过滤-时间戳（毫秒）
                     * 
                     */
                    ...
                    /**
                     * 获取排序字段列表（列表字段名称）
                     * @return SortFields 排序字段列表（列表字段名称）
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTRESOURCECONFIGSREQUEST_H_
