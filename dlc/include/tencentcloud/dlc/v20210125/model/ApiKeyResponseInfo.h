...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_APIKEYRESPONSEINFO_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_APIKEYRESPONSEINFO_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * API Key 响应类.
                */
                class ApiKeyResponseInfo : public AbstractModel
                {
                public:
                    ApiKeyResponseInfo();
                    ~ApiKeyResponseInfo() = default;
                    ...
                    /**
                     * 获取<p>apikey状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
                    ...
                    /**
                     * 设置<p>apikey状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
                     * @param _status <p>apikey状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_APIKEYRESPONSEINFO_H_
