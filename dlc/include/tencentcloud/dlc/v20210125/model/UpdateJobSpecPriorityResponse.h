...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECPRIORITYRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECPRIORITYRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateJobSpecPriorityResponse : public AbstractModel
                {
                public:
                    UpdateJobSpecPriorityResponse();
                    ~UpdateJobSpecPriorityResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>集群分派策略（本期仅支持 RANDOM；NULL 时退化为依赖 ClusterGroup 配置兜底）</p>
                     * @return DispatchStrategy <p>集群分派策略（本期仅支持 RANDOM；NULL 时退化为依赖 ClusterGroup 配置兜底）</p>
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>该配置下未进入终态的作业实例数量</p>
                     * @return JobInstanceCount <p>该配置下未进入终态的作业实例数量</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>高级参数，JSON 字符串（内容为 Key-Value 对象）</p>
                     * @return AdvancedOptions <p>高级参数，JSON 字符串（内容为 Key-Value 对象）</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECPRIORITYRESPONSE_H_
