...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class LaunchStandardEngineResourceGroupsResponse : public AbstractModel
                {
                public:
                    LaunchStandardEngineResourceGroupsResponse();
                    ~LaunchStandardEngineResourceGroupsResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSRESPONSE_H_
