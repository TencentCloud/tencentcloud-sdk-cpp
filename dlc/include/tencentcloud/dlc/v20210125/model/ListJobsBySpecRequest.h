...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTJOBSBYSPECREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTJOBSBYSPECREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListJobsBySpecRequest : public AbstractModel
                {
                public:
                    ListJobsBySpecRequest();
                    ~ListJobsBySpecRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTJOBSBYSPECREQUEST_H_
