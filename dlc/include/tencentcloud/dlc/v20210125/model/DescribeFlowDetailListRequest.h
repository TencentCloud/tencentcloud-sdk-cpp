...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEFLOWDETAILLISTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEFLOWDETAILLISTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DescribeFlowDetailListRequest : public AbstractModel
                {
                public:
                    DescribeFlowDetailListRequest();
                    ~DescribeFlowDetailListRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEFLOWDETAILLISTREQUEST_H_
