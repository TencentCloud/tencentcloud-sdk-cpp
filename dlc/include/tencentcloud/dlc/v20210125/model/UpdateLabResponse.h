...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * UpdateLab返回参数结构体
                */
                class UpdateLabResponse : public AbstractModel
                {
                public:
                    UpdateLabResponse();
                    ~UpdateLabResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABRESPONSE_H_
