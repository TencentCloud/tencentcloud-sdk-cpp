...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateJobSpecResponse : public AbstractModel
                {
                public:
                    UpdateJobSpecResponse();
                    ~UpdateJobSpecResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEJOBSPECRESPONSE_H_
