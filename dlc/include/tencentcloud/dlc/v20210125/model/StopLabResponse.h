...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_STOPLABRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_STOPLABRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * StopLab返回参数结构体
                */
                class StopLabResponse : public AbstractModel
                {
                public:
                    StopLabResponse();
                    ~StopLabResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_STOPLABRESPONSE_H_
