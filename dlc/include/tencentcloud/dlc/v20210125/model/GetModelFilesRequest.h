...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELFILESREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELFILESREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetModelFilesRequest : public AbstractModel
                {
                public:
                    GetModelFilesRequest();
                    ~GetModelFilesRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELFILESREQUEST_H_
