...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATERAYJOBPRIORITYRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATERAYJOBPRIORITYRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateRayJobPriorityResponse : public AbstractModel
                {
                public:
                    UpdateRayJobPriorityResponse();
                    ~UpdateRayJobPriorityResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATERAYJOBPRIORITYRESPONSE_H_
