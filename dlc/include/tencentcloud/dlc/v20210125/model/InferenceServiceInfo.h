...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_INFERENCESERVICEINFO_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_INFERENCESERVICEINFO_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * 推理服务信息
                */
                class InferenceServiceInfo : public AbstractModel
                {
                public:
                    InferenceServiceInfo();
                    ~InferenceServiceInfo() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>关联模型的类型（LLM / VLM / Embedding / Reranker / TTS / ASR / CV / NLP / ML）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>服务状态（Running/Stopped/Deploying/Failed）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>OpenAI 兼容统一入口 URL（通过 API-Key 路由，适用于 LLM/Embedding/Reranker）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _unifiedEndpointUrl <p>OpenAI 兼容统一入口 URL（通过 API-Key 路由，适用于 LLM/Embedding/Reranker）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetUnifiedEndpointUrl(const std::string& _unifiedEndpointUrl);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>KServe V2 协议统一入口 URL（通过 API-Key + model name 路由，适用于 XGBoost 等传统 ML 模型）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _unifiedV2EndpointUrl <p>KServe V2 协议统一入口 URL（通过 API-Key + model name 路由，适用于 XGBoost 等传统 ML 模型）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetUnifiedV2EndpointUrl(const std::string& _unifiedV2EndpointUrl);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetDeploymentCount(const int64_t& _deploymentCount);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>是否存在至少一个运行中的部署</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _hasRunningDeployment <p>是否存在至少一个运行中的部署</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetHasRunningDeployment(const bool& _hasRunningDeployment);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>是否启用 API-Key 鉴权</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _apiKeyAuthEnabled <p>是否启用 API-Key 鉴权</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetApiKeyAuthEnabled(const bool& _apiKeyAuthEnabled);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>是否强制开启 API-Key 鉴权（生产环境为 true，不允许关闭）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _apiKeyAuthForceEnabled <p>是否强制开启 API-Key 鉴权（生产环境为 true，不允许关闭）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetApiKeyAuthForceEnabled(const bool& _apiKeyAuthForceEnabled);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>是否跳过 TLS 证书验证（自签证书场景，前端 curl 命令需加 -k 参数）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _skipTlsVerify <p>是否跳过 TLS 证书验证（自签证书场景，前端 curl 命令需加 -k 参数）</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetSkipTlsVerify(const bool& _skipTlsVerify);
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 设置<p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * @param _gpuResourceSummary <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetGpuResourceSummary(const std::vector<GpuSummaryItem>& _gpuResourceSummary);
                    ...
                    /**
                     * 设置<p>运行中部署的 CPU 资源汇总</p>
                     * @param _cpuResourceSummary <p>运行中部署的 CPU 资源汇总</p>
                     * 
                     */
                    void SetCpuResourceSummary(const CpuSummaryItem& _cpuResourceSummary);
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_INFERENCESERVICEINFO_H_
