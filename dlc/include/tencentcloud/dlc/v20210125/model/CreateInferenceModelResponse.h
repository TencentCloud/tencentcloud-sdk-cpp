...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATEINFERENCEMODELRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATEINFERENCEMODELRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateInferenceModelResponse : public AbstractModel
                {
                public:
                    CreateInferenceModelResponse();
                    ~CreateInferenceModelResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATEINFERENCEMODELRESPONSE_H_
