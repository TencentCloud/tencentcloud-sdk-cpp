...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCESERVICESREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCESERVICESREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListInferenceServicesRequest : public AbstractModel
                {
                public:
                    ListInferenceServicesRequest();
                    ~ListInferenceServicesRequest() = default;
                    ...
                    /**
                     * 获取<p>创建时间起始过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
                     * @return StartTime <p>创建时间起始过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
                     * 
                     */
                    uint64_t GetStartTime() const;

                    /**
                     * 设置<p>创建时间起始过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
                    ...
                    /**
                     * 获取<p>创建时间截止过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
                     * @return EndTime <p>创建时间截止过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
                     * 
                     */
                    uint64_t GetEndTime() const;

                    /**
                     * 设置<p>创建时间截止过滤-时间戳（毫秒，可选）</p><p>单位：ms</p>
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCESERVICESREQUEST_H_
