...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTAPIKEYSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTAPIKEYSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * ListApiKeys请求参数结构体
                */
                class ListApiKeysRequest : public AbstractModel
                {
                public:
                    ListApiKeysRequest();
                    ...
                    /**
                     * 获取<p>过滤条件。支持的过滤字段：Keyword（Key 名称模糊搜索，取第一个 Value）、Status（状态精确匹配，取第一个 Value，如 Active、Revoked）</p>
                     * @return Filters <p>过滤条件。支持的过滤字段：Keyword（Key 名称模糊搜索，取第一个 Value）、Status（状态精确匹配，取第一个 Value，如 Active、Revoked）</p>
                     * 
                     */
                    std::vector<Filter> GetFilters() const;

                    /**
                     * 设置<p>过滤条件。支持的过滤字段：Keyword（Key 名称模糊搜索，取第一个 Value）、Status（状态精确匹配，取第一个 Value，如 Active、Revoked）</p>
                     * @param _filters <p>过滤条件。支持的过滤字段：Keyword（Key 名称模糊搜索，取第一个 Value）、Status（状态精确匹配，取第一个 Value，如 Active、Revoked）</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTAPIKEYSREQUEST_H_
