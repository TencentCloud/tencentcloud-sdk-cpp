...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATERAYCLUSTERRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATERAYCLUSTERRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateRayClusterResponse : public AbstractModel
                {
                public:
                    CreateRayClusterResponse();
                    ~CreateRayClusterResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATERAYCLUSTERRESPONSE_H_
