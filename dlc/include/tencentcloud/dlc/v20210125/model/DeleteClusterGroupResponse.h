...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DELETECLUSTERGROUPRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DELETECLUSTERGROUPRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DeleteClusterGroupResponse : public AbstractModel
                {
                public:
                    DeleteClusterGroupResponse();
                    ~DeleteClusterGroupResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>是否已软删除（false=活跃, true=已删除）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DELETECLUSTERGROUPRESPONSE_H_
