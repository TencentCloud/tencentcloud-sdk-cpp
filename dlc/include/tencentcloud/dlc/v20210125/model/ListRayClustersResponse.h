...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListRayClustersResponse : public AbstractModel
                {
                public:
                    ListRayClustersResponse();
                    ~ListRayClustersResponse() = default;
                    ...
                    /**
                     * 获取<p>Ray cluster列表</p>
                     * @return Items <p>Ray cluster列表</p>
                     * 
                     */
                    std::vector<RayClusterEntity> GetItems() const;
                ...
                private:
                     ...
                     * <p>Ray cluster列表</p>
                     */
                    std::vector<RayClusterEntity> m_items;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSRESPONSE_H_
