...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATESERVICEAUTHCONFIGRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATESERVICEAUTHCONFIGRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateServiceAuthConfigResponse : public AbstractModel
                {
                public:
                    UpdateServiceAuthConfigResponse();
                    ~UpdateServiceAuthConfigResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATESERVICEAUTHCONFIGRESPONSE_H_
