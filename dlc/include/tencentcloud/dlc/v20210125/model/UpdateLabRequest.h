...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * UpdateLab请求参数结构体
                */
                class UpdateLabRequest : public AbstractModel
                {
                public:
                    UpdateLabRequest();
                    ~UpdateLabRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATELABREQUEST_H_
