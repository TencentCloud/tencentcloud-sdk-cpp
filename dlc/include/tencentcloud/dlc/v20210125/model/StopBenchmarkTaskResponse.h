...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_STOPBENCHMARKTASKRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_STOPBENCHMARKTASKRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class StopBenchmarkTaskResponse : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>与本次评测关联的部署及其资源规格。语义按模式区分： • 网关模式（UseGateway=true）：Service 下所有 Running 部署（长度可能 &gt; 1） • 直连模式（UseGateway=false）：仅绑定的那个部署（长度恒为 1）</p>
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_STOPBENCHMARKTASKRESPONSE_H_
