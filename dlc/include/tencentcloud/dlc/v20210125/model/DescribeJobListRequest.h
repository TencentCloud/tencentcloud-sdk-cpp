...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBLISTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBLISTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DescribeJobListRequest : public AbstractModel
                {
                public:
                    DescribeJobListRequest();
                    ~DescribeJobListRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBLISTREQUEST_H_
