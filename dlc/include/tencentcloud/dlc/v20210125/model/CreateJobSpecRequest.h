...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateJobSpecRequest : public AbstractModel
                {
                public:
                    CreateJobSpecRequest();
                    ~CreateJobSpecRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECREQUEST_H_
