...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_RUNJOBSPECRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_RUNJOBSPECRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * RunJobSpec返回参数结构体
                */
                class RunJobSpecResponse : public AbstractModel
                {
                public:
                    RunJobSpecResponse();
                    ~RunJobSpecResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_RUNJOBSPECRESPONSE_H_
