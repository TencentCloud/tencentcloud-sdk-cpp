...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateUDFPolicyRequest : public AbstractModel
                {
                public:
                    UpdateUDFPolicyRequest();
                    ~UpdateUDFPolicyRequest() = default;
                     ...
                     * 
                     */
                    void SetUDFPolicyInfos(const std::vector<UDFPolicyInfo>& _uDFPolicyInfos);
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYREQUEST_H_
