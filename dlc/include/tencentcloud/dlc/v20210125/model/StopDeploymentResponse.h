...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_STOPDEPLOYMENTRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_STOPDEPLOYMENTRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class StopDeploymentResponse : public AbstractModel
                {
                public:
                    StopDeploymentResponse();
                    ~StopDeploymentResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>镜像拉取方式</p>
                     * @return ImagePullType <p>镜像拉取方式</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_STOPDEPLOYMENTRESPONSE_H_
