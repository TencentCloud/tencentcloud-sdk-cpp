...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTMLFLOWSERVERSRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTMLFLOWSERVERSRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListMlflowServersResponse : public AbstractModel
                {
                public:
                    ListMlflowServersResponse();
                    ~ListMlflowServersResponse() = default;
                    ...
                    /**
                     * 获取<p>MlFlow列表</p>
                     * @return Items <p>MlFlow列表</p>
                     * 
                     */
                    std::vector<MlFlowServerInfo> GetItems() const;
                ...
                private:
                     ...
                     * <p>MlFlow列表</p>
                     */
                    std::vector<MlFlowServerInfo> m_items;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTMLFLOWSERVERSRESPONSE_H_
