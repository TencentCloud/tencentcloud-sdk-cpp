...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKTASKSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKTASKSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListBenchmarkTasksRequest : public AbstractModel
                {
                public:
                    ListBenchmarkTasksRequest();
                    ~ListBenchmarkTasksRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKTASKSREQUEST_H_
