...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELCONFIGREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELCONFIGREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetModelConfigRequest : public AbstractModel
                {
                public:
                    GetModelConfigRequest();
                    ~GetModelConfigRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETMODELCONFIGREQUEST_H_
