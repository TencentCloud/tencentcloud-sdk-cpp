...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBEVENTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBEVENTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetRayJobEventRequest : public AbstractModel
                {
                public:
                    GetRayJobEventRequest();
                    ~GetRayJobEventRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBEVENTREQUEST_H_
