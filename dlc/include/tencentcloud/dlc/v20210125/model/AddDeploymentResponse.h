...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_ADDDEPLOYMENTRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_ADDDEPLOYMENTRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class AddDeploymentResponse : public AbstractModel
                {
                public:
                    AddDeploymentResponse();
                    ~AddDeploymentResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_ADDDEPLOYMENTRESPONSE_H_
