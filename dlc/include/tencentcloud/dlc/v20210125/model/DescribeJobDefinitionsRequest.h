...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBDEFINITIONSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBDEFINITIONSREQUEST_H_
...
namespace TencentCloud
{
    namespace Dlc
    {
        namespace V20210125
        {
            ...
            {
                /**
                * DescribeJobDefinitions请求参数结构体
                */
                class DescribeJobDefinitionsRequest : public AbstractModel
                {
                public:
                    DescribeJobDefinitionsRequest();
                    ~DescribeJobDefinitionsRequest() = default;
                    ...
                    /**
                     * 获取<p>创建时间下限（Unix 毫秒时间戳）。</p>
                     * @return CreateTimeStart <p>创建时间下限（Unix 毫秒时间戳）。</p>
                     * 
                     */
                    int64_t GetCreateTimeStart() const;

                    /**
                     * 设置<p>创建时间下限（Unix 毫秒时间戳）。</p>
                     * @param _createTimeStart <p>创建时间下限（Unix 毫秒时间戳）。</p>
                     * 
                     */
                    void SetCreateTimeStart(const int64_t& _createTimeStart);
                    ...
                    /**
                     * 获取<p>创建时间上限（Unix 毫秒时间戳）。</p>
                     * @return CreateTimeEnd <p>创建时间上限（Unix 毫秒时间戳）。</p>
                     * 
                     */
                    int64_t GetCreateTimeEnd() const;

                    /**
                     * 设置<p>创建时间上限（Unix 毫秒时间戳）。</p>
                     * @param _createTimeEnd <p>创建时间上限（Unix 毫秒时间戳）。</p>
                     * 
                     */
                    void SetCreateTimeEnd(const int64_t& _createTimeEnd);
                    ...
                    /**
                     * 获取<p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
                     * @return InstanceTimeRange <p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
                     * 
                     */
                    int64_t GetInstanceTimeRange() const;

                    /**
                     * 设置<p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
                     * @param _instanceTimeRange <p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
                     * 
                     */
                    void SetInstanceTimeRange(const int64_t& _instanceTimeRange);

                    /**
                     * 判断参数 InstanceTimeRange 是否已赋值
                     * @return InstanceTimeRange 是否已赋值
                     * 
                     */
                    bool InstanceTimeRangeHasBeenSet() const;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBEJOBDEFINITIONSREQUEST_H_
