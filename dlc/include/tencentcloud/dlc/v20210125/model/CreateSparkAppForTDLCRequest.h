...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATESPARKAPPFORTDLCREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATESPARKAPPFORTDLCREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateSparkAppForTDLCRequest : public AbstractModel
                {
                public:
                    CreateSparkAppForTDLCRequest();
                    ~CreateSparkAppForTDLCRequest() = default;
                    ...
                    /**
                     * 获取<p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
                    ...
                    /**
                     * 设置<p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATESPARKAPPFORTDLCREQUEST_H_
