...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYLABPRIORITYRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYLABPRIORITYRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ModifyLabPriorityResponse : public AbstractModel
                {
                public:
                    ModifyLabPriorityResponse();
                    ~ModifyLabPriorityResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYLABPRIORITYRESPONSE_H_
