...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATECLUSTERGROUPRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATECLUSTERGROUPRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateClusterGroupResponse : public AbstractModel
                {
                public:
                    CreateClusterGroupResponse();
                    ~CreateClusterGroupResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATECLUSTERGROUPRESPONSE_H_
