...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATETCICEBERGTABLEREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATETCICEBERGTABLEREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateTcIcebergTableRequest : public AbstractModel
                {
                public:
                    CreateTcIcebergTableRequest();
                    ~CreateTcIcebergTableRequest() = default;
                    ...
                    /**
                     * 获取为true时只获取sql而不执行
                     * @return DryRun 为true时只获取sql而不执行
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATETCICEBERGTABLEREQUEST_H_
