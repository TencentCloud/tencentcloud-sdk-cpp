...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCERESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCERESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListTrainingJobInstanceResponse : public AbstractModel
                {
                public:
                    ListTrainingJobInstanceResponse();
                    ~ListTrainingJobInstanceResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCERESPONSE_H_
