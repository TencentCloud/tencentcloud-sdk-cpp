...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListRayClustersRequest : public AbstractModel
                {
                public:
                    ListRayClustersRequest();
                    ~ListRayClustersRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>起始时间（毫秒时间戳）</p>
                     * @return StartTime <p>起始时间（毫秒时间戳）</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTRAYCLUSTERSREQUEST_H_
