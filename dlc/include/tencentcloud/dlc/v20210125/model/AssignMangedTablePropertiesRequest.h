...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_ASSIGNMANGEDTABLEPROPERTIESREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_ASSIGNMANGEDTABLEPROPERTIESREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class AssignMangedTablePropertiesRequest : public AbstractModel
                {
                public:
                    AssignMangedTablePropertiesRequest();
                    ~AssignMangedTablePropertiesRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_ASSIGNMANGEDTABLEPROPERTIESREQUEST_H_
