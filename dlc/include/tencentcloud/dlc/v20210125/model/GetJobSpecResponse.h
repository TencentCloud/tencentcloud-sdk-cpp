...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETJOBSPECRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETJOBSPECRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * GetJobSpec返回参数结构体
                */
                class GetJobSpecResponse : public AbstractModel
                {
                public:
                    GetJobSpecResponse();
                    ~GetJobSpecResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETJOBSPECRESPONSE_H_
