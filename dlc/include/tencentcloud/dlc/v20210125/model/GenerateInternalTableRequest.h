...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GENERATEINTERNALTABLEREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GENERATEINTERNALTABLEREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GenerateInternalTableRequest : public AbstractModel
                {
                public:
                    GenerateInternalTableRequest();
                    ~GenerateInternalTableRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GENERATEINTERNALTABLEREQUEST_H_
