...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTMODELVERSIONSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTMODELVERSIONSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListModelVersionsRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>页码（默认1）</p><p>取值范围：[1, 2147483647]</p>
                    ...
                    /**
                     * 设置<p>页码（默认1）</p><p>取值范围：[1, 2147483647]</p>
                    ...
                    /**
                     * 获取<p>每页数量（默认200）</p><p>取值范围：[1, 2147483647]</p>
                    ...
                    /**
                     * 设置<p>每页数量（默认200）</p><p>取值范围：[1, 2147483647]</p>
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTMODELVERSIONSREQUEST_H_
