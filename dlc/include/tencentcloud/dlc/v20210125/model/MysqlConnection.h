...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_MYSQLCONNECTION_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_MYSQLCONNECTION_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * tcc mysql连接信息
                */
                class MysqlConnection : public AbstractModel
                {
                public:
                    MysqlConnection();
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_MYSQLCONNECTION_H_
