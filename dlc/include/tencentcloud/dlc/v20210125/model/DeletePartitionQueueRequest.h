...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DELETEPARTITIONQUEUEREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DELETEPARTITIONQUEUEREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DeletePartitionQueueRequest : public AbstractModel
                {
                public:
                    DeletePartitionQueueRequest();
                    ~DeletePartitionQueueRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DELETEPARTITIONQUEUEREQUEST_H_
