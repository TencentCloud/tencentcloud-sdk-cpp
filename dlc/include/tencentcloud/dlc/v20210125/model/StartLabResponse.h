...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_STARTLABRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_STARTLABRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * StartLab返回参数结构体
                */
                class StartLabResponse : public AbstractModel
                {
                public:
                    StartLabResponse();
                    ~StartLabResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_STARTLABRESPONSE_H_
