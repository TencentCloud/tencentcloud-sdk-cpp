...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKSUMMARYREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKSUMMARYREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListBenchmarkSummaryRequest : public AbstractModel
                {
                public:
                    ListBenchmarkSummaryRequest();
                    ~ListBenchmarkSummaryRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTBENCHMARKSUMMARYREQUEST_H_
