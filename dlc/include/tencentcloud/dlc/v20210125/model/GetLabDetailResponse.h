...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETLABDETAILRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETLABDETAILRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * GetLabDetail返回参数结构体
                */
                class GetLabDetailResponse : public AbstractModel
                {
                public:
                    GetLabDetailResponse();
                    ~GetLabDetailResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETLABDETAILRESPONSE_H_
