...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATERESOURCECONFIGRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATERESOURCECONFIGRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateResourceConfigResponse : public AbstractModel
                {
                public:
                    CreateResourceConfigResponse();
                    ~CreateResourceConfigResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATERESOURCECONFIGRESPONSE_H_
