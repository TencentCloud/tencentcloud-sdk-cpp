...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBECLUSTERGROUPRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBECLUSTERGROUPRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DescribeClusterGroupResponse : public AbstractModel
                {
                public:
                    DescribeClusterGroupResponse();
                    ~DescribeClusterGroupResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBECLUSTERGROUPRESPONSE_H_
