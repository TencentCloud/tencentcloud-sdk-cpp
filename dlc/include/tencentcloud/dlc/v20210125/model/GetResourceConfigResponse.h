...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETRESOURCECONFIGRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETRESOURCECONFIGRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetResourceConfigResponse : public AbstractModel
                {
                public:
                    GetResourceConfigResponse();
                    ~GetResourceConfigResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETRESOURCECONFIGRESPONSE_H_
