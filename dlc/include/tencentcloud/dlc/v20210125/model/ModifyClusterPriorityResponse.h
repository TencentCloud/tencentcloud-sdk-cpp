...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYCLUSTERPRIORITYRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYCLUSTERPRIORITYRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ModifyClusterPriorityResponse : public AbstractModel
                {
                public:
                    ModifyClusterPriorityResponse();
                    ~ModifyClusterPriorityResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_MODIFYCLUSTERPRIORITYRESPONSE_H_
