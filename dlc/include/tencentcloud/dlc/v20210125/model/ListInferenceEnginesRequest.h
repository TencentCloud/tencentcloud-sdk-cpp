...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCEENGINESREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCEENGINESREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListInferenceEnginesRequest : public AbstractModel
                {
                public:
                    ListInferenceEnginesRequest();
                    ~ListInferenceEnginesRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTINFERENCEENGINESREQUEST_H_
