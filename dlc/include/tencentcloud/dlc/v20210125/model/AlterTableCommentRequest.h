...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_ALTERTABLECOMMENTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_ALTERTABLECOMMENTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class AlterTableCommentRequest : public AbstractModel
                {
                public:
                    AlterTableCommentRequest();
                    ~AlterTableCommentRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取修改表的基本信息
                     * @return TableBaseInfo 修改表的基本信息
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_ALTERTABLECOMMENTREQUEST_H_
