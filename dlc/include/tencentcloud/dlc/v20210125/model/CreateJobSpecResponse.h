...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateJobSpecResponse : public AbstractModel
                {
                public:
                    CreateJobSpecResponse();
                    ~CreateJobSpecResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取<p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
                     * @return SubmissionTarget <p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATEJOBSPECRESPONSE_H_
