...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_RESTARTINFERENCESERVICERESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_RESTARTINFERENCESERVICERESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class RestartInferenceServiceResponse : public AbstractModel
                {
                public:
                    RestartInferenceServiceResponse();
                    ~RestartInferenceServiceResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_RESTARTINFERENCESERVICERESPONSE_H_
