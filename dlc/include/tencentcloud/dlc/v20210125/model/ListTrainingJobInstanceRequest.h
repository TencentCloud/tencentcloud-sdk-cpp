...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCEREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCEREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListTrainingJobInstanceRequest : public AbstractModel
                {
                public:
                    ListTrainingJobInstanceRequest();
                    ~ListTrainingJobInstanceRequest() = default;
                    ...
                    /**
                     * 设置<p>每页数量（默认 10）</p>
                     * @param _pageSize <p>每页数量（默认 10）</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>过滤条件列表，每项含 Name、Operator、Values</p>
                    ...
                    /**
                     * 设置<p>过滤条件列表，每项含 Name、Operator、Values</p>
                     * @param _filters <p>过滤条件列表，每项含 Name、Operator、Values</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
                    ...
                    /**
                     * 设置<p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
                     * @param _sortFields <p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTTRAININGJOBINSTANCEREQUEST_H_
