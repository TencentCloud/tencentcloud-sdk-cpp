...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_IMPORTTKECLUSTERRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_IMPORTTKECLUSTERRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ImportTkeClusterResponse : public AbstractModel
                {
                public:
                    ImportTkeClusterResponse();
                    ~ImportTkeClusterResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_IMPORTTKECLUSTERRESPONSE_H_
