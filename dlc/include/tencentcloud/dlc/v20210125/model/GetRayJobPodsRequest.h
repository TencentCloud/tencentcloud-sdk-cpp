...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBPODSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBPODSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetRayJobPodsRequest : public AbstractModel
                {
                public:
                    GetRayJobPodsRequest();
                    ~GetRayJobPodsRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYJOBPODSREQUEST_H_
