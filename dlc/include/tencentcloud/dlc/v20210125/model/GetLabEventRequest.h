...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETLABEVENTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETLABEVENTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * GetLabEvent请求参数结构体
                */
                class GetLabEventRequest : public AbstractModel
                {
                public:
                    GetLabEventRequest();
                    ~GetLabEventRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETLABEVENTREQUEST_H_
