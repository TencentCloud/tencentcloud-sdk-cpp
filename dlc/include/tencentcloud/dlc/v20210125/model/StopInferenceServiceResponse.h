...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_STOPINFERENCESERVICERESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_STOPINFERENCESERVICERESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class StopInferenceServiceResponse : public AbstractModel
                {
                public:
                    StopInferenceServiceResponse();
                    ~StopInferenceServiceResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_STOPINFERENCESERVICERESPONSE_H_
