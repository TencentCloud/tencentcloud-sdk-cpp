...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTDEPLOYMENTSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTDEPLOYMENTSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListDeploymentsRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取<p>创建时间起始</p><p>单位：ms</p>
                     * @return StartTime <p>创建时间起始</p><p>单位：ms</p>
                     * 
                     */
                    uint64_t GetStartTime() const;

                    /**
                     * 设置<p>创建时间起始</p><p>单位：ms</p>
                     * @param _startTime <p>创建时间起始</p><p>单位：ms</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>创建时间截止</p><p>单位：ms</p>
                     * @return EndTime <p>创建时间截止</p><p>单位：ms</p>
                     * 
                     */
                    uint64_t GetEndTime() const;

                    /**
                     * 设置<p>创建时间截止</p><p>单位：ms</p>
                     * @param _endTime <p>创建时间截止</p><p>单位：ms</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTDEPLOYMENTSREQUEST_H_
