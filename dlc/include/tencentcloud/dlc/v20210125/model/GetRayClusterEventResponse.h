...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTEREVENTRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTEREVENTRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetRayClusterEventResponse : public AbstractModel
                {
                public:
                    GetRayClusterEventResponse();
                    ~GetRayClusterEventResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTEREVENTRESPONSE_H_
