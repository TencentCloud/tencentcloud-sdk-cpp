...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class LaunchStandardEngineResourceGroupsRequest : public AbstractModel
                {
                public:
                    LaunchStandardEngineResourceGroupsRequest();
                    ~LaunchStandardEngineResourceGroupsRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LAUNCHSTANDARDENGINERESOURCEGROUPSREQUEST_H_
