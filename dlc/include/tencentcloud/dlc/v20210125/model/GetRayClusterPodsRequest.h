...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTERPODSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTERPODSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class GetRayClusterPodsRequest : public AbstractModel
                {
                public:
                    GetRayClusterPodsRequest();
                    ~GetRayClusterPodsRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_GETRAYCLUSTERPODSREQUEST_H_
