...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBENOTEBOOKSESSIONSTATEMENTRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBENOTEBOOKSESSIONSTATEMENTRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DescribeNotebookSessionStatementResponse : public AbstractModel
                {
                public:
                    DescribeNotebookSessionStatementResponse();
                    ~DescribeNotebookSessionStatementResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBENOTEBOOKSESSIONSTATEMENTRESPONSE_H_
