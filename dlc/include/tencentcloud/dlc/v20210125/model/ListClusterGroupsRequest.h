...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTCLUSTERGROUPSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTCLUSTERGROUPSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class ListClusterGroupsRequest : public AbstractModel
                {
                public:
                    ListClusterGroupsRequest();
                    ~ListClusterGroupsRequest() = default;
                    ...
                    /**
                     * 获取<p>提交时间起始过滤-时间戳（毫秒，可选）</p>
                     * @return StartTime <p>提交时间起始过滤-时间戳（毫秒，可选）</p>
                     * 
                     */
                    uint64_t GetStartTime() const;

                    /**
                     * 设置<p>提交时间起始过滤-时间戳（毫秒，可选）</p>
                    ...
                    /**
                     * 获取<p>提交时间截止过滤-时间戳（毫秒，可选）</p>
                     * @return EndTime <p>提交时间截止过滤-时间戳（毫秒，可选）</p>
                     * 
                     */
                    uint64_t GetEndTime() const;

                    /**
                     * 设置<p>提交时间截止过滤-时间戳（毫秒，可选）</p>
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTCLUSTERGROUPSREQUEST_H_
