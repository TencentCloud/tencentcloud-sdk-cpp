...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_LISTLABSREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_LISTLABSREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                * ListLabs请求参数结构体
                */
                class ListLabsRequest : public AbstractModel
                {
                public:
                    ListLabsRequest();
                    ~ListLabsRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_LISTLABSREQUEST_H_
