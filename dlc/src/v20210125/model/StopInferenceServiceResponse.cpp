...
StopInferenceServiceResponse::StopInferenceServiceResponse() :
...
CoreInternalOutcome StopInferenceServiceResponse::Deserialize(const string &payload)
{
...
string StopInferenceServiceResponse::ToJsonString() const
{
...
string StopInferenceServiceResponse::GetServiceId() const
{
    return m_serviceId;
}

bool StopInferenceServiceResponse::ServiceIdHasBeenSet() const
{
    return m_serviceIdHasBeenSet;
}

string StopInferenceServiceResponse::GetName() const
{
    return m_name;
}

bool StopInferenceServiceResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string StopInferenceServiceResponse::GetModelUid() const
{
    return m_modelUid;
}

bool StopInferenceServiceResponse::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string StopInferenceServiceResponse::GetModelName() const
{
    return m_modelName;
}

bool StopInferenceServiceResponse::ModelNameHasBeenSet() const
{
    return m_modelNameHasBeenSet;
}

string StopInferenceServiceResponse::GetModelVersion() const
{
    return m_modelVersion;
}

bool StopInferenceServiceResponse::ModelVersionHasBeenSet() const
{
    return m_modelVersionHasBeenSet;
}

string StopInferenceServiceResponse::GetModelIdentifier() const
{
    return m_modelIdentifier;
}

bool StopInferenceServiceResponse::ModelIdentifierHasBeenSet() const
{
    return m_modelIdentifierHasBeenSet;
}

string StopInferenceServiceResponse::GetModelType() const
{
    return m_modelType;
}

bool StopInferenceServiceResponse::ModelTypeHasBeenSet() const
{
    return m_modelTypeHasBeenSet;
}

string StopInferenceServiceResponse::GetStatus() const
{
    return m_status;
}

bool StopInferenceServiceResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string StopInferenceServiceResponse::GetEndpointUrl() const
{
    return m_endpointUrl;
}

bool StopInferenceServiceResponse::EndpointUrlHasBeenSet() const
{
    return m_endpointUrlHasBeenSet;
}

string StopInferenceServiceResponse::GetUnifiedEndpointUrl() const
{
    return m_unifiedEndpointUrl;
}

bool StopInferenceServiceResponse::UnifiedEndpointUrlHasBeenSet() const
{
    return m_unifiedEndpointUrlHasBeenSet;
}

string StopInferenceServiceResponse::GetUnifiedV2EndpointUrl() const
{
    return m_unifiedV2EndpointUrl;
}

bool StopInferenceServiceResponse::UnifiedV2EndpointUrlHasBeenSet() const
{
    return m_unifiedV2EndpointUrlHasBeenSet;
}

int64_t StopInferenceServiceResponse::GetAppId() const
{
    return m_appId;
}

bool StopInferenceServiceResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string StopInferenceServiceResponse::GetUin() const
{
    return m_uin;
}

bool StopInferenceServiceResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

int64_t StopInferenceServiceResponse::GetCreateTime() const
{
    return m_createTime;
}

bool StopInferenceServiceResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

int64_t StopInferenceServiceResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool StopInferenceServiceResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t StopInferenceServiceResponse::GetDeploymentCount() const
{
    return m_deploymentCount;
}

bool StopInferenceServiceResponse::DeploymentCountHasBeenSet() const
{
    return m_deploymentCountHasBeenSet;
}

bool StopInferenceServiceResponse::GetHasRunningDeployment() const
{
    return m_hasRunningDeployment;
}

bool StopInferenceServiceResponse::HasRunningDeploymentHasBeenSet() const
{
    return m_hasRunningDeploymentHasBeenSet;
}

bool StopInferenceServiceResponse::GetApiKeyAuthEnabled() const
{
    return m_apiKeyAuthEnabled;
}

bool StopInferenceServiceResponse::ApiKeyAuthEnabledHasBeenSet() const
{
    return m_apiKeyAuthEnabledHasBeenSet;
}

bool StopInferenceServiceResponse::GetApiKeyAuthForceEnabled() const
{
    return m_apiKeyAuthForceEnabled;
}

bool StopInferenceServiceResponse::ApiKeyAuthForceEnabledHasBeenSet() const
{
    return m_apiKeyAuthForceEnabledHasBeenSet;
}

bool StopInferenceServiceResponse::GetSkipTlsVerify() const
{
    return m_skipTlsVerify;
}

bool StopInferenceServiceResponse::SkipTlsVerifyHasBeenSet() const
{
    return m_skipTlsVerifyHasBeenSet;
}

string StopInferenceServiceResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool StopInferenceServiceResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

CpuSummaryItem StopInferenceServiceResponse::GetCpuResourceSummary() const
{
    return m_cpuResourceSummary;
}

bool StopInferenceServiceResponse::CpuResourceSummaryHasBeenSet() const
{
    return m_cpuResourceSummaryHasBeenSet;
}

string StopInferenceServiceResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool StopInferenceServiceResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

vector<Tag> StopInferenceServiceResponse::GetResourceTags() const
{
    return m_resourceTags;
}

bool StopInferenceServiceResponse::ResourceTagsHasBeenSet() const
{
    return m_resourceTagsHasBeenSet;
}

string StopInferenceServiceResponse::GetDeploymentMode() const
{
    return m_deploymentMode;
}

bool StopInferenceServiceResponse::DeploymentModeHasBeenSet() const
{
    return m_deploymentModeHasBeenSet;
}

bool StopInferenceServiceResponse::GetIsCustom() const
{
    return m_isCustom;
}

bool StopInferenceServiceResponse::IsCustomHasBeenSet() const
{
