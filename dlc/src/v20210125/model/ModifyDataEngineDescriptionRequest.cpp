...
string ModifyDataEngineDescriptionRequest::ToJsonString() const
{
...
string ModifyDataEngineDescriptionRequest::GetDataEngineName() const
{
    return m_dataEngineName;
}

void ModifyDataEngineDescriptionRequest::SetDataEngineName(const string& _dataEngineName)
{
    m_dataEngineName = _dataEngineName;
    m_dataEngineNameHasBeenSet = true;
}

bool ModifyDataEngineDescriptionRequest::DataEngineNameHasBeenSet() const
{
    return m_dataEngineNameHasBeenSet;
}

string ModifyDataEngineDescriptionRequest::GetMessage() const
{
    return m_message;
}

void ModifyDataEngineDescriptionRequest::SetMessage(const string& _message)
{
    m_message = _message;
    m_messageHasBeenSet = true;
}

bool ModifyDataEngineDescriptionRequest::MessageHasBeenSet() const
{
