...
GetLabPodYamlResponse::GetLabPodYamlResponse() :
    m_yamlHasBeenSet(false)
{
}

CoreInternalOutcome GetLabPodYamlResponse::Deserialize(const string &payload)
{
...
string GetLabPodYamlResponse::ToJsonString() const
{
...
string GetLabPodYamlResponse::GetYaml() const
{
    return m_yaml;
}

bool GetLabPodYamlResponse::YamlHasBeenSet() const
{
