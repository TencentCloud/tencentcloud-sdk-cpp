...
LaunchStandardEngineResourceGroupsRequest::LaunchStandardEngineResourceGroupsRequest() :
    m_engineResourceGroupNamesHasBeenSet(false)
{
}

string LaunchStandardEngineResourceGroupsRequest::ToJsonString() const
{
...
vector<string> LaunchStandardEngineResourceGroupsRequest::GetEngineResourceGroupNames() const
{
    return m_engineResourceGroupNames;
}

void LaunchStandardEngineResourceGroupsRequest::SetEngineResourceGroupNames(const vector<string>& _engineResourceGroupNames)
{
    m_engineResourceGroupNames = _engineResourceGroupNames;
    m_engineResourceGroupNamesHasBeenSet = true;
}

bool LaunchStandardEngineResourceGroupsRequest::EngineResourceGroupNamesHasBeenSet() const
{
