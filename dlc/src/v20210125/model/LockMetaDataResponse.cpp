...
CoreInternalOutcome LockMetaDataResponse::Deserialize(const string &payload)
{
...
string LockMetaDataResponse::ToJsonString() const
{
...
int64_t LockMetaDataResponse::GetLockId() const
{
    return m_lockId;
}

bool LockMetaDataResponse::LockIdHasBeenSet() const
{
    return m_lockIdHasBeenSet;
}

string LockMetaDataResponse::GetLockState() const
{
    return m_lockState;
}

bool LockMetaDataResponse::LockStateHasBeenSet() const
{
