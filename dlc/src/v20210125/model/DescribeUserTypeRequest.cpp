...
string DescribeUserTypeRequest::ToJsonString() const
{
...
string DescribeUserTypeRequest::GetUserId() const
{
    return m_userId;
}

void DescribeUserTypeRequest::SetUserId(const string& _userId)
{
    m_userId = _userId;
