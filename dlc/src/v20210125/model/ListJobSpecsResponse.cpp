...
ListJobSpecsResponse::ListJobSpecsResponse() :
...
CoreInternalOutcome ListJobSpecsResponse::Deserialize(const string &payload)
{
...
string ListJobSpecsResponse::ToJsonString() const
{
...
int64_t ListJobSpecsResponse::GetTotal() const
{
    return m_total;
}

bool ListJobSpecsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListJobSpecsResponse::GetPage() const
{
    return m_page;
}

bool ListJobSpecsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListJobSpecsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListJobSpecsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListJobSpecsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListJobSpecsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<JobSpec> ListJobSpecsResponse::GetItems() const
{
    return m_items;
}

bool ListJobSpecsResponse::ItemsHasBeenSet() const
{
