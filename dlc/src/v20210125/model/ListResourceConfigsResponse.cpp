...
ListResourceConfigsResponse::ListResourceConfigsResponse() :
...
CoreInternalOutcome ListResourceConfigsResponse::Deserialize(const string &payload)
{
...
string ListResourceConfigsResponse::ToJsonString() const
{
...
int64_t ListResourceConfigsResponse::GetTotal() const
{
    return m_total;
}

bool ListResourceConfigsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListResourceConfigsResponse::GetPage() const
{
    return m_page;
}

bool ListResourceConfigsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListResourceConfigsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListResourceConfigsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListResourceConfigsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListResourceConfigsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ResourceConfig> ListResourceConfigsResponse::GetItems() const
{
    return m_items;
}

bool ListResourceConfigsResponse::ItemsHasBeenSet() const
{
