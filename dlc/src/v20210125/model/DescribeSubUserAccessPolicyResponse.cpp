...
CoreInternalOutcome DescribeSubUserAccessPolicyResponse::Deserialize(const string &payload)
{
...
string DescribeSubUserAccessPolicyResponse::ToJsonString() const
{
...
string DescribeSubUserAccessPolicyResponse::GetPolicyDocument() const
{
    return m_policyDocument;
}

bool DescribeSubUserAccessPolicyResponse::PolicyDocumentHasBeenSet() const
{
