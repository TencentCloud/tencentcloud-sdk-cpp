...
string CheckDataEngineImageCanBeUpgradeRequest::ToJsonString() const
{
...
string CheckDataEngineImageCanBeUpgradeRequest::GetDataEngineId() const
{
    return m_dataEngineId;
}

void CheckDataEngineImageCanBeUpgradeRequest::SetDataEngineId(const string& _dataEngineId)
{
    m_dataEngineId = _dataEngineId;
    m_dataEngineIdHasBeenSet = true;
}

bool CheckDataEngineImageCanBeUpgradeRequest::DataEngineIdHasBeenSet() const
{
