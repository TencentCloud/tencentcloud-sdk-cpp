...
ListExampleDifficultiesResponse::ListExampleDifficultiesResponse() :
...
CoreInternalOutcome ListExampleDifficultiesResponse::Deserialize(const string &payload)
{
...
string ListExampleDifficultiesResponse::ToJsonString() const
{
...
int64_t ListExampleDifficultiesResponse::GetTotal() const
{
    return m_total;
}

bool ListExampleDifficultiesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListExampleDifficultiesResponse::GetPage() const
{
    return m_page;
}

bool ListExampleDifficultiesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListExampleDifficultiesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListExampleDifficultiesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListExampleDifficultiesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListExampleDifficultiesResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ExampleDifficulties> ListExampleDifficultiesResponse::GetItems() const
{
    return m_items;
}

bool ListExampleDifficultiesResponse::ItemsHasBeenSet() const
{
