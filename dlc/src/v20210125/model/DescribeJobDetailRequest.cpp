...
string DescribeJobDetailRequest::GetJobId() const
{
    return m_jobId;
}

void DescribeJobDetailRequest::SetJobId(const string& _jobId)
{
    m_jobId = _jobId;
    m_jobIdHasBeenSet = true;
}

bool DescribeJobDetailRequest::JobIdHasBeenSet() const
{
