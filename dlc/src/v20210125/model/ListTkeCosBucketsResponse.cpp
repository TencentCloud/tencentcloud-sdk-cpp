...
#include <tencentcloud/dlc/v20210125/model/ListTkeCosBucketsResponse.h>
...
ListTkeCosBucketsResponse::ListTkeCosBucketsResponse() :
    m_bucketsHasBeenSet(false)
{
}

CoreInternalOutcome ListTkeCosBucketsResponse::Deserialize(const string &payload)
{
...
string ListTkeCosBucketsResponse::ToJsonString() const
{
...
vector<string> ListTkeCosBucketsResponse::GetBuckets() const
{
    return m_buckets;
}

bool ListTkeCosBucketsResponse::BucketsHasBeenSet() const
{
