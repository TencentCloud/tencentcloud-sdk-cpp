...
CreateJobFromDefinitionRequest::CreateJobFromDefinitionRequest() :
    m_jobDefinitionIdHasBeenSet(false)
{
}

string CreateJobFromDefinitionRequest::ToJsonString() const
{
...
string CreateJobFromDefinitionRequest::GetJobDefinitionId() const
{
    return m_jobDefinitionId;
}

void CreateJobFromDefinitionRequest::SetJobDefinitionId(const string& _jobDefinitionId)
{
    m_jobDefinitionId = _jobDefinitionId;
    m_jobDefinitionIdHasBeenSet = true;
}

bool CreateJobFromDefinitionRequest::JobDefinitionIdHasBeenSet() const
{
