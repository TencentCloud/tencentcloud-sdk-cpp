...
GetRayClusterPodsResponse::GetRayClusterPodsResponse() :
...
CoreInternalOutcome GetRayClusterPodsResponse::Deserialize(const string &payload)
{
...
string GetRayClusterPodsResponse::ToJsonString() const
{
...
int64_t GetRayClusterPodsResponse::GetTotal() const
{
    return m_total;
}

bool GetRayClusterPodsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t GetRayClusterPodsResponse::GetPage() const
{
    return m_page;
}

bool GetRayClusterPodsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t GetRayClusterPodsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool GetRayClusterPodsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t GetRayClusterPodsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool GetRayClusterPodsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ClusterPod> GetRayClusterPodsResponse::GetItems() const
{
    return m_items;
}

bool GetRayClusterPodsResponse::ItemsHasBeenSet() const
{
