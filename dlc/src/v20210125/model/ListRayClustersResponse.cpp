...
#include <tencentcloud/dlc/v20210125/model/ListRayClustersResponse.h>
...
ListRayClustersResponse::ListRayClustersResponse() :
...
CoreInternalOutcome ListRayClustersResponse::Deserialize(const string &payload)
{
...
string ListRayClustersResponse::ToJsonString() const
{
...
int64_t ListRayClustersResponse::GetTotal() const
{
    return m_total;
}

bool ListRayClustersResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListRayClustersResponse::GetPage() const
{
    return m_page;
}

bool ListRayClustersResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListRayClustersResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListRayClustersResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListRayClustersResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListRayClustersResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayClusterEntity> ListRayClustersResponse::GetItems() const
{
    return m_items;
}

bool ListRayClustersResponse::ItemsHasBeenSet() const
{
