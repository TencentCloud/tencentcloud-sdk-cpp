...
CoreInternalOutcome CreateTasksResponse::Deserialize(const string &payload)
{
...
string CreateTasksResponse::ToJsonString() const
{
...
string CreateTasksResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateTasksResponse::BatchIdHasBeenSet() const
{
    return m_batchIdHasBeenSet;
}

vector<string> CreateTasksResponse::GetTaskIdSet() const
{
    return m_taskIdSet;
}

bool CreateTasksResponse::TaskIdSetHasBeenSet() const
{
