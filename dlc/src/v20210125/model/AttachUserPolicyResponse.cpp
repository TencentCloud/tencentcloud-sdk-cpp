...
CoreInternalOutcome AttachUserPolicyResponse::Deserialize(const string &payload)
{
...
string AttachUserPolicyResponse::ToJsonString() const
{
...
vector<Policy> AttachUserPolicyResponse::GetPolicySet() const
{
    return m_policySet;
}

bool AttachUserPolicyResponse::PolicySetHasBeenSet() const
{
