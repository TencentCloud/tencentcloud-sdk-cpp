...
UpdateJobSpecResponse::UpdateJobSpecResponse() :
...
CoreInternalOutcome UpdateJobSpecResponse::Deserialize(const string &payload)
{
...
string UpdateJobSpecResponse::ToJsonString() const
{
...
string UpdateJobSpecResponse::GetId() const
{
    return m_id;
}

bool UpdateJobSpecResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string UpdateJobSpecResponse::GetName() const
{
    return m_name;
}

bool UpdateJobSpecResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string UpdateJobSpecResponse::GetDescription() const
{
    return m_description;
}

bool UpdateJobSpecResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string UpdateJobSpecResponse::GetEntrypoint() const
{
    return m_entrypoint;
}

bool UpdateJobSpecResponse::EntrypointHasBeenSet() const
{
    return m_entrypointHasBeenSet;
}

string UpdateJobSpecResponse::GetImage() const
{
    return m_image;
}

bool UpdateJobSpecResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string UpdateJobSpecResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool UpdateJobSpecResponse::ImagePullTypeHasBeenSet() const
{
    return m_imagePullTypeHasBeenSet;
}

string UpdateJobSpecResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool UpdateJobSpecResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string UpdateJobSpecResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool UpdateJobSpecResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string UpdateJobSpecResponse::GetRuntimeEnv() const
{
    return m_runtimeEnv;
}

bool UpdateJobSpecResponse::RuntimeEnvHasBeenSet() const
{
    return m_runtimeEnvHasBeenSet;
}

string UpdateJobSpecResponse::GetCatalog() const
{
    return m_catalog;
}

bool UpdateJobSpecResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string UpdateJobSpecResponse::GetAutoscalerOptions() const
{
    return m_autoscalerOptions;
}

bool UpdateJobSpecResponse::AutoscalerOptionsHasBeenSet() const
{
    return m_autoscalerOptionsHasBeenSet;
}

string UpdateJobSpecResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool UpdateJobSpecResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

bool UpdateJobSpecResponse::GetResourceConfigChanged() const
{
    return m_resourceConfigChanged;
}

bool UpdateJobSpecResponse::ResourceConfigChangedHasBeenSet() const
{
    return m_resourceConfigChangedHasBeenSet;
}

string UpdateJobSpecResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool UpdateJobSpecResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string UpdateJobSpecResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool UpdateJobSpecResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string UpdateJobSpecResponse::GetQueue() const
{
    return m_queue;
}

bool UpdateJobSpecResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

string UpdateJobSpecResponse::GetQueueAlias() const
{
    return m_queueAlias;
}

bool UpdateJobSpecResponse::QueueAliasHasBeenSet() const
{
    return m_queueAliasHasBeenSet;
}

string UpdateJobSpecResponse::GetJobPackage() const
{
    return m_jobPackage;
}

bool UpdateJobSpecResponse::JobPackageHasBeenSet() const
{
    return m_jobPackageHasBeenSet;
}

string UpdateJobSpecResponse::GetJobPackageName() const
{
    return m_jobPackageName;
}

bool UpdateJobSpecResponse::JobPackageNameHasBeenSet() const
{
    return m_jobPackageNameHasBeenSet;
}

string UpdateJobSpecResponse::GetJobPackageSource() const
{
    return m_jobPackageSource;
}

bool UpdateJobSpecResponse::JobPackageSourceHasBeenSet() const
{
    return m_jobPackageSourceHasBeenSet;
}

int64_t UpdateJobSpecResponse::GetAppId() const
{
    return m_appId;
}

bool UpdateJobSpecResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string UpdateJobSpecResponse::GetUin() const
{
    return m_uin;
}

bool UpdateJobSpecResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string UpdateJobSpecResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool UpdateJobSpecResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string UpdateJobSpecResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool UpdateJobSpecResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

uint64_t UpdateJobSpecResponse::GetCreateTime() const
{
    return m_createTime;
}

bool UpdateJobSpecResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t UpdateJobSpecResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool UpdateJobSpecResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t UpdateJobSpecResponse::GetJobInstanceCount() const
{
    return m_jobInstanceCount;
}

bool UpdateJobSpecResponse::JobInstanceCountHasBeenSet() const
{
    return m_jobInstanceCountHasBeenSet;
}

bool UpdateJobSpecResponse::GetHasRunningJobs() const
{
    return m_hasRunningJobs;
}

bool UpdateJobSpecResponse::HasRunningJobsHasBeenSet() const
{
    return m_hasRunningJobsHasBeenSet;
}

string UpdateJobSpecResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool UpdateJobSpecResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

string UpdateJobSpecResponse::GetGroupId() const
{
    return m_groupId;
}

bool UpdateJobSpecResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string UpdateJobSpecResponse::GetClusterId() const
{
    return m_clusterId;
}

bool UpdateJobSpecResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t UpdateJobSpecResponse::GetPriority() const
{
    return m_priority;
}

bool UpdateJobSpecResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

vector<Tag> UpdateJobSpecResponse::GetTags() const
{
    return m_tags;
}

bool UpdateJobSpecResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string UpdateJobSpecResponse::GetDispatchStrategy() const
{
    return m_dispatchStrategy;
}

bool UpdateJobSpecResponse::DispatchStrategyHasBeenSet() const
{
    return m_dispatchStrategyHasBeenSet;
}

string UpdateJobSpecResponse::GetSubmissionTarget() const
{
    return m_submissionTarget;
}

bool UpdateJobSpecResponse::SubmissionTargetHasBeenSet() const
{
    return m_submissionTargetHasBeenSet;
}

string UpdateJobSpecResponse::GetGroupName() const
{
    return m_groupName;
}

bool UpdateJobSpecResponse::GroupNameHasBeenSet() const
{
    return m_groupNameHasBeenSet;
}

string UpdateJobSpecResponse::GetClusterName() const
{
    return m_clusterName;
}

bool UpdateJobSpecResponse::ClusterNameHasBeenSet() const
{
