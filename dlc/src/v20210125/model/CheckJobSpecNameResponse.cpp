...
#include <tencentcloud/dlc/v20210125/model/CheckJobSpecNameResponse.h>
...
CheckJobSpecNameResponse::CheckJobSpecNameResponse() :
    m_availableHasBeenSet(false),
    m_reasonHasBeenSet(false)
{
}

CoreInternalOutcome CheckJobSpecNameResponse::Deserialize(const string &payload)
{
...
string CheckJobSpecNameResponse::ToJsonString() const
{
...
bool CheckJobSpecNameResponse::GetAvailable() const
{
    return m_available;
}

bool CheckJobSpecNameResponse::AvailableHasBeenSet() const
{
    return m_availableHasBeenSet;
}

string CheckJobSpecNameResponse::GetReason() const
{
    return m_reason;
}

bool CheckJobSpecNameResponse::ReasonHasBeenSet() const
{
