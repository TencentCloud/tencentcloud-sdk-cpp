...
CreateJobSpecResponse::CreateJobSpecResponse() :
...
CoreInternalOutcome CreateJobSpecResponse::Deserialize(const string &payload)
{
...
string CreateJobSpecResponse::ToJsonString() const
{
...
string CreateJobSpecResponse::GetId() const
{
    return m_id;
}

bool CreateJobSpecResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateJobSpecResponse::GetName() const
{
    return m_name;
}

bool CreateJobSpecResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateJobSpecResponse::GetDescription() const
{
    return m_description;
}

bool CreateJobSpecResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string CreateJobSpecResponse::GetEntrypoint() const
{
    return m_entrypoint;
}

bool CreateJobSpecResponse::EntrypointHasBeenSet() const
{
    return m_entrypointHasBeenSet;
}

string CreateJobSpecResponse::GetImage() const
{
    return m_image;
}

bool CreateJobSpecResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string CreateJobSpecResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool CreateJobSpecResponse::ImagePullTypeHasBeenSet() const
{
    return m_imagePullTypeHasBeenSet;
}

string CreateJobSpecResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool CreateJobSpecResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string CreateJobSpecResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool CreateJobSpecResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string CreateJobSpecResponse::GetRuntimeEnv() const
{
    return m_runtimeEnv;
}

bool CreateJobSpecResponse::RuntimeEnvHasBeenSet() const
{
    return m_runtimeEnvHasBeenSet;
}

string CreateJobSpecResponse::GetCatalog() const
{
    return m_catalog;
}

bool CreateJobSpecResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string CreateJobSpecResponse::GetAutoscalerOptions() const
{
    return m_autoscalerOptions;
}

bool CreateJobSpecResponse::AutoscalerOptionsHasBeenSet() const
{
    return m_autoscalerOptionsHasBeenSet;
}

string CreateJobSpecResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool CreateJobSpecResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

bool CreateJobSpecResponse::GetResourceConfigChanged() const
{
    return m_resourceConfigChanged;
}

bool CreateJobSpecResponse::ResourceConfigChangedHasBeenSet() const
{
    return m_resourceConfigChangedHasBeenSet;
}

string CreateJobSpecResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool CreateJobSpecResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string CreateJobSpecResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool CreateJobSpecResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string CreateJobSpecResponse::GetQueue() const
{
    return m_queue;
}

bool CreateJobSpecResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

string CreateJobSpecResponse::GetQueueAlias() const
{
    return m_queueAlias;
}

bool CreateJobSpecResponse::QueueAliasHasBeenSet() const
{
    return m_queueAliasHasBeenSet;
}

string CreateJobSpecResponse::GetJobPackage() const
{
    return m_jobPackage;
}

bool CreateJobSpecResponse::JobPackageHasBeenSet() const
{
    return m_jobPackageHasBeenSet;
}

string CreateJobSpecResponse::GetJobPackageName() const
{
    return m_jobPackageName;
}

bool CreateJobSpecResponse::JobPackageNameHasBeenSet() const
{
    return m_jobPackageNameHasBeenSet;
}

string CreateJobSpecResponse::GetJobPackageSource() const
{
    return m_jobPackageSource;
}

bool CreateJobSpecResponse::JobPackageSourceHasBeenSet() const
{
    return m_jobPackageSourceHasBeenSet;
}

int64_t CreateJobSpecResponse::GetAppId() const
{
    return m_appId;
}

bool CreateJobSpecResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateJobSpecResponse::GetUin() const
{
    return m_uin;
}

bool CreateJobSpecResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string CreateJobSpecResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool CreateJobSpecResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string CreateJobSpecResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool CreateJobSpecResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

uint64_t CreateJobSpecResponse::GetCreateTime() const
{
    return m_createTime;
}

bool CreateJobSpecResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t CreateJobSpecResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool CreateJobSpecResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t CreateJobSpecResponse::GetJobInstanceCount() const
{
    return m_jobInstanceCount;
}

bool CreateJobSpecResponse::JobInstanceCountHasBeenSet() const
{
    return m_jobInstanceCountHasBeenSet;
}

bool CreateJobSpecResponse::GetHasRunningJobs() const
{
    return m_hasRunningJobs;
}

bool CreateJobSpecResponse::HasRunningJobsHasBeenSet() const
{
    return m_hasRunningJobsHasBeenSet;
}

string CreateJobSpecResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool CreateJobSpecResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

string CreateJobSpecResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateJobSpecResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string CreateJobSpecResponse::GetClusterId() const
{
    return m_clusterId;
}

bool CreateJobSpecResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t CreateJobSpecResponse::GetPriority() const
{
    return m_priority;
}

bool CreateJobSpecResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

vector<Tag> CreateJobSpecResponse::GetTags() const
{
    return m_tags;
}

bool CreateJobSpecResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string CreateJobSpecResponse::GetDispatchStrategy() const
{
    return m_dispatchStrategy;
}

bool CreateJobSpecResponse::DispatchStrategyHasBeenSet() const
{
    return m_dispatchStrategyHasBeenSet;
}

string CreateJobSpecResponse::GetSubmissionTarget() const
{
    return m_submissionTarget;
}

bool CreateJobSpecResponse::SubmissionTargetHasBeenSet() const
{
    return m_submissionTargetHasBeenSet;
}

string CreateJobSpecResponse::GetGroupName() const
{
    return m_groupName;
}

bool CreateJobSpecResponse::GroupNameHasBeenSet() const
{
    return m_groupNameHasBeenSet;
}

string CreateJobSpecResponse::GetClusterName() const
{
    return m_clusterName;
}

bool CreateJobSpecResponse::ClusterNameHasBeenSet() const
{
