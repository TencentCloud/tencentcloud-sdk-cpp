...
DescribeJobLogResponse::DescribeJobLogResponse() :
...
CoreInternalOutcome DescribeJobLogResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Lines") && !rsp["Lines"].IsNull())
    {
        if (!rsp["Lines"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Lines` is not array type"));

        const rapidjson::Value &tmpValue = rsp["Lines"];
...
string DescribeJobLogResponse::ToJsonString() const
{
...
vector<string> DescribeJobLogResponse::GetLines() const
{
    return m_lines;
}

bool DescribeJobLogResponse::LinesHasBeenSet() const
{
    return m_linesHasBeenSet;
}

string DescribeJobLogResponse::GetCursor() const
{
    return m_cursor;
}

bool DescribeJobLogResponse::CursorHasBeenSet() const
{
    return m_cursorHasBeenSet;
}

bool DescribeJobLogResponse::GetHasMore() const
{
    return m_hasMore;
}

bool DescribeJobLogResponse::HasMoreHasBeenSet() const
{
    return m_hasMoreHasBeenSet;
}

vector<ClsLogEntry> DescribeJobLogResponse::GetResults() const
{
    return m_results;
}

bool DescribeJobLogResponse::ResultsHasBeenSet() const
{
