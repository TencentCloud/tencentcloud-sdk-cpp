...
#include <tencentcloud/dlc/v20210125/model/GetRayClusterHistoryResponse.h>
...
GetRayClusterHistoryResponse::GetRayClusterHistoryResponse() :
...
CoreInternalOutcome GetRayClusterHistoryResponse::Deserialize(const string &payload)
{
...
string GetRayClusterHistoryResponse::ToJsonString() const
{
...
int64_t GetRayClusterHistoryResponse::GetTotal() const
{
    return m_total;
}

bool GetRayClusterHistoryResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t GetRayClusterHistoryResponse::GetPage() const
{
    return m_page;
}

bool GetRayClusterHistoryResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t GetRayClusterHistoryResponse::GetPageSize() const
{
    return m_pageSize;
}

bool GetRayClusterHistoryResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t GetRayClusterHistoryResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool GetRayClusterHistoryResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayClusterHistory> GetRayClusterHistoryResponse::GetItems() const
{
    return m_items;
}

bool GetRayClusterHistoryResponse::ItemsHasBeenSet() const
{
