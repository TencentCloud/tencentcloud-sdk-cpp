...
GetModelFilesRequest::GetModelFilesRequest() :
    m_modelUidHasBeenSet(false),
    m_modelVersionHasBeenSet(false)
{
}

string GetModelFilesRequest::ToJsonString() const
{
...
string GetModelFilesRequest::GetModelUid() const
{
    return m_modelUid;
}

void GetModelFilesRequest::SetModelUid(const string& _modelUid)
{
    m_modelUid = _modelUid;
    m_modelUidHasBeenSet = true;
}

bool GetModelFilesRequest::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string GetModelFilesRequest::GetModelVersion() const
{
    return m_modelVersion;
}

void GetModelFilesRequest::SetModelVersion(const string& _modelVersion)
{
    m_modelVersion = _modelVersion;
    m_modelVersionHasBeenSet = true;
}

bool GetModelFilesRequest::ModelVersionHasBeenSet() const
{
