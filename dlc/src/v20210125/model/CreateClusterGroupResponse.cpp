...
CreateClusterGroupResponse::CreateClusterGroupResponse() :
...
CoreInternalOutcome CreateClusterGroupResponse::Deserialize(const string &payload)
{
...
string CreateClusterGroupResponse::ToJsonString() const
{
...
string CreateClusterGroupResponse::GetId() const
{
    return m_id;
}

bool CreateClusterGroupResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateClusterGroupResponse::GetName() const
{
    return m_name;
}

bool CreateClusterGroupResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateClusterGroupResponse::GetDescription() const
{
    return m_description;
}

bool CreateClusterGroupResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

int64_t CreateClusterGroupResponse::GetAppId() const
{
    return m_appId;
}

bool CreateClusterGroupResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateClusterGroupResponse::GetUin() const
{
    return m_uin;
}

bool CreateClusterGroupResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string CreateClusterGroupResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool CreateClusterGroupResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

uint64_t CreateClusterGroupResponse::GetCreateTime() const
{
    return m_createTime;
}

bool CreateClusterGroupResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t CreateClusterGroupResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool CreateClusterGroupResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

string CreateClusterGroupResponse::GetConfig() const
{
    return m_config;
}

bool CreateClusterGroupResponse::ConfigHasBeenSet() const
{
    return m_configHasBeenSet;
}

bool CreateClusterGroupResponse::GetDeleted() const
{
    return m_deleted;
}

bool CreateClusterGroupResponse::DeletedHasBeenSet() const
{
    return m_deletedHasBeenSet;
}

uint64_t CreateClusterGroupResponse::GetDeleteTime() const
{
    return m_deleteTime;
}

bool CreateClusterGroupResponse::DeleteTimeHasBeenSet() const
{
