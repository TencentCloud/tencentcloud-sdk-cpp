...
#include <tencentcloud/dlc/v20210125/model/RerunBenchmarkTaskResponse.h>
...
RerunBenchmarkTaskResponse::RerunBenchmarkTaskResponse() :
...
CoreInternalOutcome RerunBenchmarkTaskResponse::Deserialize(const string &payload)
{
...
string RerunBenchmarkTaskResponse::ToJsonString() const
{
...
string RerunBenchmarkTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool RerunBenchmarkTaskResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetTaskName() const
{
    return m_taskName;
}

bool RerunBenchmarkTaskResponse::TaskNameHasBeenSet() const
{
    return m_taskNameHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetServiceId() const
{
    return m_serviceId;
}

bool RerunBenchmarkTaskResponse::ServiceIdHasBeenSet() const
{
    return m_serviceIdHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetServiceName() const
{
    return m_serviceName;
}

bool RerunBenchmarkTaskResponse::ServiceNameHasBeenSet() const
{
    return m_serviceNameHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetStatus() const
{
    return m_status;
}

bool RerunBenchmarkTaskResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetInputTokens() const
{
    return m_inputTokens;
}

bool RerunBenchmarkTaskResponse::InputTokensHasBeenSet() const
{
    return m_inputTokensHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetOutputTokens() const
{
    return m_outputTokens;
}

bool RerunBenchmarkTaskResponse::OutputTokensHasBeenSet() const
{
    return m_outputTokensHasBeenSet;
}

double RerunBenchmarkTaskResponse::GetRequestsPerSecond() const
{
    return m_requestsPerSecond;
}

bool RerunBenchmarkTaskResponse::RequestsPerSecondHasBeenSet() const
{
    return m_requestsPerSecondHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetMaxConcurrency() const
{
    return m_maxConcurrency;
}

bool RerunBenchmarkTaskResponse::MaxConcurrencyHasBeenSet() const
{
    return m_maxConcurrencyHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetTotalPrompts() const
{
    return m_totalPrompts;
}

bool RerunBenchmarkTaskResponse::TotalPromptsHasBeenSet() const
{
    return m_totalPromptsHasBeenSet;
}

bool RerunBenchmarkTaskResponse::GetUseGateway() const
{
    return m_useGateway;
}

bool RerunBenchmarkTaskResponse::UseGatewayHasBeenSet() const
{
    return m_useGatewayHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetDeploymentName() const
{
    return m_deploymentName;
}

bool RerunBenchmarkTaskResponse::DeploymentNameHasBeenSet() const
{
    return m_deploymentNameHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetApiKeyId() const
{
    return m_apiKeyId;
}

bool RerunBenchmarkTaskResponse::ApiKeyIdHasBeenSet() const
{
    return m_apiKeyIdHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetApiKeyName() const
{
    return m_apiKeyName;
}

bool RerunBenchmarkTaskResponse::ApiKeyNameHasBeenSet() const
{
    return m_apiKeyNameHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetUin() const
{
    return m_uin;
}

bool RerunBenchmarkTaskResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetCreateTime() const
{
    return m_createTime;
}

bool RerunBenchmarkTaskResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t RerunBenchmarkTaskResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool RerunBenchmarkTaskResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t RerunBenchmarkTaskResponse::GetAppId() const
{
    return m_appId;
}

bool RerunBenchmarkTaskResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string RerunBenchmarkTaskResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool RerunBenchmarkTaskResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

BenchmarkResourceInfo RerunBenchmarkTaskResponse::GetResources() const
{
    return m_resources;
}

bool RerunBenchmarkTaskResponse::ResourcesHasBeenSet() const
{
    return m_resourcesHasBeenSet;
}

vector<DeploymentResourceInfo> RerunBenchmarkTaskResponse::GetDeploymentResources() const
{
    return m_deploymentResources;
}

bool RerunBenchmarkTaskResponse::DeploymentResourcesHasBeenSet() const
{
