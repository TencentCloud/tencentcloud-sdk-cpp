...
CoreInternalOutcome CreateLabResponse::Deserialize(const string &payload)
{
...
string CreateLabResponse::ToJsonString() const
{
...
string CreateLabResponse::GetExampleId() const
{
    return m_exampleId;
}

bool CreateLabResponse::ExampleIdHasBeenSet() const
{
    return m_exampleIdHasBeenSet;
}

string CreateLabResponse::GetCodeArchiveUrl() const
{
    return m_codeArchiveUrl;
}

bool CreateLabResponse::CodeArchiveUrlHasBeenSet() const
{
    return m_codeArchiveUrlHasBeenSet;
}

vector<TypeKVPair> CreateLabResponse::GetServices() const
{
    return m_services;
}

bool CreateLabResponse::ServicesHasBeenSet() const
{
    return m_servicesHasBeenSet;
}

string CreateLabResponse::GetId() const
{
    return m_id;
}

bool CreateLabResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateLabResponse::GetType() const
{
    return m_type;
}

bool CreateLabResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string CreateLabResponse::GetName() const
{
    return m_name;
}

bool CreateLabResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string CreateLabResponse::GetDescription() const
{
    return m_description;
}

bool CreateLabResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string CreateLabResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool CreateLabResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string CreateLabResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool CreateLabResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string CreateLabResponse::GetQueue() const
{
    return m_queue;
}

bool CreateLabResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

int64_t CreateLabResponse::GetAppId() const
{
    return m_appId;
}

bool CreateLabResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateLabResponse::GetUin() const
{
    return m_uin;
}

bool CreateLabResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string CreateLabResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool CreateLabResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string CreateLabResponse::GetStatus() const
{
    return m_status;
}

bool CreateLabResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

uint64_t CreateLabResponse::GetCreateTime() const
{
    return m_createTime;
}

bool CreateLabResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

string CreateLabResponse::GetGroupId() const
{
    return m_groupId;
}

bool CreateLabResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string CreateLabResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool CreateLabResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string CreateLabResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool CreateLabResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

string CreateLabResponse::GetImage() const
{
    return m_image;
}

bool CreateLabResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string CreateLabResponse::GetCatalog() const
{
    return m_catalog;
}

bool CreateLabResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string CreateLabResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool CreateLabResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string CreateLabResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool CreateLabResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

int64_t CreateLabResponse::GetPriority() const
{
    return m_priority;
}

bool CreateLabResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

vector<Tag> CreateLabResponse::GetTags() const
{
    return m_tags;
}

bool CreateLabResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

PersistentWorkDir CreateLabResponse::GetPersistentWorkDir() const
{
    return m_persistentWorkDir;
}

bool CreateLabResponse::PersistentWorkDirHasBeenSet() const
{
    return m_persistentWorkDirHasBeenSet;
}

bool CreateLabResponse::GetEnableToken() const
{
    return m_enableToken;
}

bool CreateLabResponse::EnableTokenHasBeenSet() const
{
    return m_enableTokenHasBeenSet;
}

string CreateLabResponse::GetLabImagePullType() const
{
    return m_labImagePullType;
}

bool CreateLabResponse::LabImagePullTypeHasBeenSet() const
{
    return m_labImagePullTypeHasBeenSet;
}

string CreateLabResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool CreateLabResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

string CreateLabResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool CreateLabResponse::ImagePullTypeHasBeenSet() const
{
