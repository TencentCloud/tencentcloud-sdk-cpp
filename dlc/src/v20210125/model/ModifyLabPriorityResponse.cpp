...
ModifyLabPriorityResponse::ModifyLabPriorityResponse() :
...
CoreInternalOutcome ModifyLabPriorityResponse::Deserialize(const string &payload)
{
...
string ModifyLabPriorityResponse::ToJsonString() const
{
...
string ModifyLabPriorityResponse::GetExampleId() const
{
    return m_exampleId;
}

bool ModifyLabPriorityResponse::ExampleIdHasBeenSet() const
{
    return m_exampleIdHasBeenSet;
}

string ModifyLabPriorityResponse::GetCodeArchiveUrl() const
{
    return m_codeArchiveUrl;
}

bool ModifyLabPriorityResponse::CodeArchiveUrlHasBeenSet() const
{
    return m_codeArchiveUrlHasBeenSet;
}

vector<TypeKVPair> ModifyLabPriorityResponse::GetServices() const
{
    return m_services;
}

bool ModifyLabPriorityResponse::ServicesHasBeenSet() const
{
    return m_servicesHasBeenSet;
}

string ModifyLabPriorityResponse::GetLabImage() const
{
    return m_labImage;
}

bool ModifyLabPriorityResponse::LabImageHasBeenSet() const
{
    return m_labImageHasBeenSet;
}

string ModifyLabPriorityResponse::GetId() const
{
    return m_id;
}

bool ModifyLabPriorityResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string ModifyLabPriorityResponse::GetType() const
{
    return m_type;
}

bool ModifyLabPriorityResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string ModifyLabPriorityResponse::GetName() const
{
    return m_name;
}

bool ModifyLabPriorityResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string ModifyLabPriorityResponse::GetDescription() const
{
    return m_description;
}

bool ModifyLabPriorityResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string ModifyLabPriorityResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool ModifyLabPriorityResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string ModifyLabPriorityResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool ModifyLabPriorityResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string ModifyLabPriorityResponse::GetQueue() const
{
    return m_queue;
}

bool ModifyLabPriorityResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

int64_t ModifyLabPriorityResponse::GetAppId() const
{
    return m_appId;
}

bool ModifyLabPriorityResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string ModifyLabPriorityResponse::GetUin() const
{
    return m_uin;
}

bool ModifyLabPriorityResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string ModifyLabPriorityResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool ModifyLabPriorityResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string ModifyLabPriorityResponse::GetStatus() const
{
    return m_status;
}

bool ModifyLabPriorityResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyLabPriorityResponse::GetStatusMessage() const
{
    return m_statusMessage;
}

bool ModifyLabPriorityResponse::StatusMessageHasBeenSet() const
{
    return m_statusMessageHasBeenSet;
}

uint64_t ModifyLabPriorityResponse::GetCreateTime() const
{
    return m_createTime;
}

bool ModifyLabPriorityResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

string ModifyLabPriorityResponse::GetGroupName() const
{
    return m_groupName;
}

bool ModifyLabPriorityResponse::GroupNameHasBeenSet() const
{
    return m_groupNameHasBeenSet;
}

string ModifyLabPriorityResponse::GetGroupId() const
{
    return m_groupId;
}

bool ModifyLabPriorityResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string ModifyLabPriorityResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool ModifyLabPriorityResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string ModifyLabPriorityResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool ModifyLabPriorityResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

string ModifyLabPriorityResponse::GetImage() const
{
    return m_image;
}

bool ModifyLabPriorityResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string ModifyLabPriorityResponse::GetCatalog() const
{
    return m_catalog;
}

bool ModifyLabPriorityResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string ModifyLabPriorityResponse::GetHistoryUrl() const
{
    return m_historyUrl;
}

bool ModifyLabPriorityResponse::HistoryUrlHasBeenSet() const
{
    return m_historyUrlHasBeenSet;
}

string ModifyLabPriorityResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool ModifyLabPriorityResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string ModifyLabPriorityResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool ModifyLabPriorityResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

int64_t ModifyLabPriorityResponse::GetPriority() const
{
    return m_priority;
}

bool ModifyLabPriorityResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

uint64_t ModifyLabPriorityResponse::GetStartTime() const
{
    return m_startTime;
}

bool ModifyLabPriorityResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

uint64_t ModifyLabPriorityResponse::GetStopTime() const
{
    return m_stopTime;
}

bool ModifyLabPriorityResponse::StopTimeHasBeenSet() const
{
    return m_stopTimeHasBeenSet;
}

vector<Tag> ModifyLabPriorityResponse::GetTags() const
{
    return m_tags;
}

bool ModifyLabPriorityResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

PersistentWorkDir ModifyLabPriorityResponse::GetPersistentWorkDir() const
{
    return m_persistentWorkDir;
}

bool ModifyLabPriorityResponse::PersistentWorkDirHasBeenSet() const
{
    return m_persistentWorkDirHasBeenSet;
}

bool ModifyLabPriorityResponse::GetEnableToken() const
{
    return m_enableToken;
}

bool ModifyLabPriorityResponse::EnableTokenHasBeenSet() const
{
    return m_enableTokenHasBeenSet;
}

string ModifyLabPriorityResponse::GetLabImagePullType() const
{
    return m_labImagePullType;
}

bool ModifyLabPriorityResponse::LabImagePullTypeHasBeenSet() const
{
    return m_labImagePullTypeHasBeenSet;
}

string ModifyLabPriorityResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool ModifyLabPriorityResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

string ModifyLabPriorityResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool ModifyLabPriorityResponse::ImagePullTypeHasBeenSet() const
{
