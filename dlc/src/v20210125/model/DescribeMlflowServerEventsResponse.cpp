...
#include <tencentcloud/dlc/v20210125/model/DescribeMlflowServerEventsResponse.h>
...
DescribeMlflowServerEventsResponse::DescribeMlflowServerEventsResponse() :
...
CoreInternalOutcome DescribeMlflowServerEventsResponse::Deserialize(const string &payload)
{
...
string DescribeMlflowServerEventsResponse::ToJsonString() const
{
...
string DescribeMlflowServerEventsResponse::GetContext() const
{
    return m_context;
}

bool DescribeMlflowServerEventsResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool DescribeMlflowServerEventsResponse::GetListOver() const
{
    return m_listOver;
}

bool DescribeMlflowServerEventsResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

int64_t DescribeMlflowServerEventsResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeMlflowServerEventsResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

int64_t DescribeMlflowServerEventsResponse::GetEndTime() const
{
    return m_endTime;
}

bool DescribeMlflowServerEventsResponse::EndTimeHasBeenSet() const
{
    return m_endTimeHasBeenSet;
}

vector<EventItem> DescribeMlflowServerEventsResponse::GetEvents() const
{
    return m_events;
}

bool DescribeMlflowServerEventsResponse::EventsHasBeenSet() const
{
