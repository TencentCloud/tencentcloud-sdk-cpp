...
AlterTableCommentRequest::AlterTableCommentRequest() :
    m_tableBaseInfoHasBeenSet(false)
{
}

string AlterTableCommentRequest::ToJsonString() const
{
...
TableBaseInfo AlterTableCommentRequest::GetTableBaseInfo() const
{
    return m_tableBaseInfo;
}

void AlterTableCommentRequest::SetTableBaseInfo(const TableBaseInfo& _tableBaseInfo)
{
    m_tableBaseInfo = _tableBaseInfo;
    m_tableBaseInfoHasBeenSet = true;
}

bool AlterTableCommentRequest::TableBaseInfoHasBeenSet() const
{
