...
#include <tencentcloud/dlc/v20210125/model/ListTrainingJobSpecResponse.h>
...
ListTrainingJobSpecResponse::ListTrainingJobSpecResponse() :
...
CoreInternalOutcome ListTrainingJobSpecResponse::Deserialize(const string &payload)
{
...
string ListTrainingJobSpecResponse::ToJsonString() const
{
...
vector<TrainingJobSpec> ListTrainingJobSpecResponse::GetItems() const
{
    return m_items;
}

bool ListTrainingJobSpecResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListTrainingJobSpecResponse::GetTotal() const
{
    return m_total;
}

bool ListTrainingJobSpecResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListTrainingJobSpecResponse::GetPage() const
{
    return m_page;
}

bool ListTrainingJobSpecResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListTrainingJobSpecResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListTrainingJobSpecResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListTrainingJobSpecResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListTrainingJobSpecResponse::TotalPagesHasBeenSet() const
{
