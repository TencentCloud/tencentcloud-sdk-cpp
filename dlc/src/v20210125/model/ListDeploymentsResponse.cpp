...
#include <tencentcloud/dlc/v20210125/model/ListDeploymentsResponse.h>
...
CoreInternalOutcome ListDeploymentsResponse::Deserialize(const string &payload)
{
...
string ListDeploymentsResponse::ToJsonString() const
{
...
vector<DeploymentInfo> ListDeploymentsResponse::GetItems() const
{
    return m_items;
}

bool ListDeploymentsResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t ListDeploymentsResponse::GetTotal() const
{
    return m_total;
}

bool ListDeploymentsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListDeploymentsResponse::GetPage() const
{
    return m_page;
}

bool ListDeploymentsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListDeploymentsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListDeploymentsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListDeploymentsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListDeploymentsResponse::TotalPagesHasBeenSet() const
{
