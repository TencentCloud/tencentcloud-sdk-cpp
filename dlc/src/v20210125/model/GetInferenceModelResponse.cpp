...
GetInferenceModelResponse::GetInferenceModelResponse() :
...
CoreInternalOutcome GetInferenceModelResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SupportedEngines") && !rsp["SupportedEngines"].IsNull())
    {
        if (!rsp["SupportedEngines"].IsArray())
            return CoreInternalOutcome(Core::Error("response `SupportedEngines` is not array type"));

        const rapidjson::Value &tmpValue = rsp["SupportedEngines"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
...
string GetInferenceModelResponse::ToJsonString() const
{
...
string GetInferenceModelResponse::GetModelId() const
{
    return m_modelId;
}

bool GetInferenceModelResponse::ModelIdHasBeenSet() const
{
    return m_modelIdHasBeenSet;
}

string GetInferenceModelResponse::GetModelUid() const
{
    return m_modelUid;
}

bool GetInferenceModelResponse::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string GetInferenceModelResponse::GetName() const
{
    return m_name;
}

bool GetInferenceModelResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string GetInferenceModelResponse::GetProvider() const
{
    return m_provider;
}

bool GetInferenceModelResponse::ProviderHasBeenSet() const
{
    return m_providerHasBeenSet;
}

string GetInferenceModelResponse::GetDescription() const
{
    return m_description;
}

bool GetInferenceModelResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string GetInferenceModelResponse::GetModelType() const
{
    return m_modelType;
}

bool GetInferenceModelResponse::ModelTypeHasBeenSet() const
{
    return m_modelTypeHasBeenSet;
}

string GetInferenceModelResponse::GetParameterSize() const
{
    return m_parameterSize;
}

bool GetInferenceModelResponse::ParameterSizeHasBeenSet() const
{
    return m_parameterSizeHasBeenSet;
}

vector<string> GetInferenceModelResponse::GetTags() const
{
    return m_tags;
}

bool GetInferenceModelResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string GetInferenceModelResponse::GetLatestVersion() const
{
    return m_latestVersion;
}

bool GetInferenceModelResponse::LatestVersionHasBeenSet() const
{
    return m_latestVersionHasBeenSet;
}

int64_t GetInferenceModelResponse::GetVersionCount() const
{
    return m_versionCount;
}

bool GetInferenceModelResponse::VersionCountHasBeenSet() const
{
    return m_versionCountHasBeenSet;
}

int64_t GetInferenceModelResponse::GetServiceCount() const
{
    return m_serviceCount;
}

bool GetInferenceModelResponse::ServiceCountHasBeenSet() const
{
    return m_serviceCountHasBeenSet;
}

bool GetInferenceModelResponse::GetHasStorage() const
{
    return m_hasStorage;
}

bool GetInferenceModelResponse::HasStorageHasBeenSet() const
{
    return m_hasStorageHasBeenSet;
}

string GetInferenceModelResponse::GetStorageRegion() const
{
    return m_storageRegion;
}

bool GetInferenceModelResponse::StorageRegionHasBeenSet() const
{
    return m_storageRegionHasBeenSet;
}

bool GetInferenceModelResponse::GetHasCustomStorage() const
{
    return m_hasCustomStorage;
}

bool GetInferenceModelResponse::HasCustomStorageHasBeenSet() const
{
    return m_hasCustomStorageHasBeenSet;
}

string GetInferenceModelResponse::GetStorageType() const
{
    return m_storageType;
}

bool GetInferenceModelResponse::StorageTypeHasBeenSet() const
{
    return m_storageTypeHasBeenSet;
}

bool GetInferenceModelResponse::GetBuiltIn() const
{
    return m_builtIn;
}

bool GetInferenceModelResponse::BuiltInHasBeenSet() const
{
    return m_builtInHasBeenSet;
}

vector<string> GetInferenceModelResponse::GetTasks() const
{
    return m_tasks;
}

bool GetInferenceModelResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

vector<string> GetInferenceModelResponse::GetSupportedEngines() const
{
    return m_supportedEngines;
}

bool GetInferenceModelResponse::SupportedEnginesHasBeenSet() const
{
    return m_supportedEnginesHasBeenSet;
}

string GetInferenceModelResponse::GetUin() const
{
    return m_uin;
}

bool GetInferenceModelResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

int64_t GetInferenceModelResponse::GetAppId() const
{
    return m_appId;
}

bool GetInferenceModelResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

int64_t GetInferenceModelResponse::GetCreateTime() const
{
    return m_createTime;
}

bool GetInferenceModelResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

int64_t GetInferenceModelResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool GetInferenceModelResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

string GetInferenceModelResponse::GetSubAccountUin() const
{
