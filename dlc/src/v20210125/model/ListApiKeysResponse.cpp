...
#include <tencentcloud/dlc/v20210125/model/ListApiKeysResponse.h>
...
CoreInternalOutcome ListApiKeysResponse::Deserialize(const string &payload)
{
...
string ListApiKeysResponse::ToJsonString() const
{
...
vector<ApiKeyInfo> ListApiKeysResponse::GetItems() const
{
    return m_items;
}

bool ListApiKeysResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t ListApiKeysResponse::GetTotal() const
{
    return m_total;
}

bool ListApiKeysResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListApiKeysResponse::GetPage() const
{
    return m_page;
}

bool ListApiKeysResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListApiKeysResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListApiKeysResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListApiKeysResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListApiKeysResponse::TotalPagesHasBeenSet() const
{
