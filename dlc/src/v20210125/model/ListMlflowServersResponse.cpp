...
ListMlflowServersResponse::ListMlflowServersResponse() :
...
CoreInternalOutcome ListMlflowServersResponse::Deserialize(const string &payload)
{
...
string ListMlflowServersResponse::ToJsonString() const
{
...
vector<MlFlowServerInfo> ListMlflowServersResponse::GetItems() const
{
    return m_items;
}

bool ListMlflowServersResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListMlflowServersResponse::GetTotal() const
{
    return m_total;
}

bool ListMlflowServersResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListMlflowServersResponse::GetPage() const
{
    return m_page;
}

bool ListMlflowServersResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListMlflowServersResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListMlflowServersResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListMlflowServersResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListMlflowServersResponse::TotalPagesHasBeenSet() const
{
