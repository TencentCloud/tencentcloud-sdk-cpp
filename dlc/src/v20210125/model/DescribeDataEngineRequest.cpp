...
string DescribeDataEngineRequest::ToJsonString() const
{
...
string DescribeDataEngineRequest::GetDataEngineName() const
{
    return m_dataEngineName;
}

void DescribeDataEngineRequest::SetDataEngineName(const string& _dataEngineName)
{
    m_dataEngineName = _dataEngineName;
    m_dataEngineNameHasBeenSet = true;
}

bool DescribeDataEngineRequest::DataEngineNameHasBeenSet() const
{
