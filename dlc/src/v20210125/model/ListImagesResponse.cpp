...
CoreInternalOutcome ListImagesResponse::Deserialize(const string &payload)
{
...
string ListImagesResponse::ToJsonString() const
{
...
int64_t ListImagesResponse::GetTotal() const
{
    return m_total;
}

bool ListImagesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListImagesResponse::GetPage() const
{
    return m_page;
}

bool ListImagesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListImagesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListImagesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListImagesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListImagesResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ImageDto> ListImagesResponse::GetItems() const
{
    return m_items;
}

bool ListImagesResponse::ItemsHasBeenSet() const
{
