...
CoreInternalOutcome DescribeDMSPartitionsResponse::Deserialize(const string &payload)
{
...
string DescribeDMSPartitionsResponse::ToJsonString() const
{
...
vector<DMSPartition> DescribeDMSPartitionsResponse::GetPartitions() const
{
    return m_partitions;
}

bool DescribeDMSPartitionsResponse::PartitionsHasBeenSet() const
{
    return m_partitionsHasBeenSet;
}

int64_t DescribeDMSPartitionsResponse::GetTotal() const
{
    return m_total;
}

bool DescribeDMSPartitionsResponse::TotalHasBeenSet() const
{
