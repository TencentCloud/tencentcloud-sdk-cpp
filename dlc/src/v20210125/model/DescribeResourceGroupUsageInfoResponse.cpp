...
DescribeResourceGroupUsageInfoResponse::DescribeResourceGroupUsageInfoResponse() :
...
CoreInternalOutcome DescribeResourceGroupUsageInfoResponse::Deserialize(const string &payload)
{
...
string DescribeResourceGroupUsageInfoResponse::ToJsonString() const
{
...
int64_t DescribeResourceGroupUsageInfoResponse::GetTotal() const
{
    return m_total;
}

bool DescribeResourceGroupUsageInfoResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t DescribeResourceGroupUsageInfoResponse::GetUsed() const
{
    return m_used;
}

bool DescribeResourceGroupUsageInfoResponse::UsedHasBeenSet() const
{
    return m_usedHasBeenSet;
}

int64_t DescribeResourceGroupUsageInfoResponse::GetAvailable() const
{
    return m_available;
}

bool DescribeResourceGroupUsageInfoResponse::AvailableHasBeenSet() const
{
