...
GetInferenceServiceResponse::GetInferenceServiceResponse() :
...
CoreInternalOutcome GetInferenceServiceResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("RayDashboardUrl") && !rsp["RayDashboardUrl"].IsNull())
    {
        if (!rsp["RayDashboardUrl"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `RayDashboardUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_rayDashboardUrl = string(rsp["RayDashboardUrl"].GetString());
    ...
    if (rsp.HasMember("GpuResourceSummary") && !rsp["GpuResourceSummary"].IsNull())
    {
        if (!rsp["GpuResourceSummary"].IsArray())
            return CoreInternalOutcome(Core::Error("response `GpuResourceSummary` is not array type"));

        const rapidjson::Value &tmpValue = rsp["GpuResourceSummary"];
...
string GetInferenceServiceResponse::ToJsonString() const
{
...
string GetInferenceServiceResponse::GetServiceId() const
{
    return m_serviceId;
}

bool GetInferenceServiceResponse::ServiceIdHasBeenSet() const
{
    return m_serviceIdHasBeenSet;
}

string GetInferenceServiceResponse::GetName() const
{
    return m_name;
}

bool GetInferenceServiceResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string GetInferenceServiceResponse::GetModelUid() const
{
    return m_modelUid;
}

bool GetInferenceServiceResponse::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string GetInferenceServiceResponse::GetModelName() const
{
    return m_modelName;
}

bool GetInferenceServiceResponse::ModelNameHasBeenSet() const
{
    return m_modelNameHasBeenSet;
}

string GetInferenceServiceResponse::GetModelVersion() const
{
    return m_modelVersion;
}

bool GetInferenceServiceResponse::ModelVersionHasBeenSet() const
{
    return m_modelVersionHasBeenSet;
}

string GetInferenceServiceResponse::GetModelIdentifier() const
{
    return m_modelIdentifier;
}

bool GetInferenceServiceResponse::ModelIdentifierHasBeenSet() const
{
    return m_modelIdentifierHasBeenSet;
}

string GetInferenceServiceResponse::GetModelType() const
{
    return m_modelType;
}

bool GetInferenceServiceResponse::ModelTypeHasBeenSet() const
{
    return m_modelTypeHasBeenSet;
}

string GetInferenceServiceResponse::GetStatus() const
{
    return m_status;
}

bool GetInferenceServiceResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string GetInferenceServiceResponse::GetEndpointUrl() const
{
    return m_endpointUrl;
}

bool GetInferenceServiceResponse::EndpointUrlHasBeenSet() const
{
    return m_endpointUrlHasBeenSet;
}

string GetInferenceServiceResponse::GetUnifiedEndpointUrl() const
{
    return m_unifiedEndpointUrl;
}

bool GetInferenceServiceResponse::UnifiedEndpointUrlHasBeenSet() const
{
    return m_unifiedEndpointUrlHasBeenSet;
}

string GetInferenceServiceResponse::GetUnifiedV2EndpointUrl() const
{
    return m_unifiedV2EndpointUrl;
}

bool GetInferenceServiceResponse::UnifiedV2EndpointUrlHasBeenSet() const
{
    return m_unifiedV2EndpointUrlHasBeenSet;
}

int64_t GetInferenceServiceResponse::GetAppId() const
{
    return m_appId;
}

bool GetInferenceServiceResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string GetInferenceServiceResponse::GetUin() const
{
    return m_uin;
}

bool GetInferenceServiceResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

int64_t GetInferenceServiceResponse::GetCreateTime() const
{
    return m_createTime;
}

bool GetInferenceServiceResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

int64_t GetInferenceServiceResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool GetInferenceServiceResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t GetInferenceServiceResponse::GetDeploymentCount() const
{
    return m_deploymentCount;
}

bool GetInferenceServiceResponse::DeploymentCountHasBeenSet() const
{
    return m_deploymentCountHasBeenSet;
}

bool GetInferenceServiceResponse::GetHasRunningDeployment() const
{
    return m_hasRunningDeployment;
}

bool GetInferenceServiceResponse::HasRunningDeploymentHasBeenSet() const
{
    return m_hasRunningDeploymentHasBeenSet;
}

string GetInferenceServiceResponse::GetRayDashboardUrl() const
{
    return m_rayDashboardUrl;
}

bool GetInferenceServiceResponse::RayDashboardUrlHasBeenSet() const
{
    return m_rayDashboardUrlHasBeenSet;
}

bool GetInferenceServiceResponse::GetApiKeyAuthEnabled() const
{
    return m_apiKeyAuthEnabled;
}

bool GetInferenceServiceResponse::ApiKeyAuthEnabledHasBeenSet() const
{
    return m_apiKeyAuthEnabledHasBeenSet;
}

bool GetInferenceServiceResponse::GetApiKeyAuthForceEnabled() const
{
    return m_apiKeyAuthForceEnabled;
}

bool GetInferenceServiceResponse::ApiKeyAuthForceEnabledHasBeenSet() const
{
    return m_apiKeyAuthForceEnabledHasBeenSet;
}

bool GetInferenceServiceResponse::GetSkipTlsVerify() const
{
    return m_skipTlsVerify;
}

bool GetInferenceServiceResponse::SkipTlsVerifyHasBeenSet() const
{
    return m_skipTlsVerifyHasBeenSet;
}

vector<GpuSummaryItem> GetInferenceServiceResponse::GetGpuResourceSummary() const
{
    return m_gpuResourceSummary;
}

bool GetInferenceServiceResponse::GpuResourceSummaryHasBeenSet() const
{
    return m_gpuResourceSummaryHasBeenSet;
}

string GetInferenceServiceResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool GetInferenceServiceResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

CpuSummaryItem GetInferenceServiceResponse::GetCpuResourceSummary() const
{
    return m_cpuResourceSummary;
}

bool GetInferenceServiceResponse::CpuResourceSummaryHasBeenSet() const
{
    return m_cpuResourceSummaryHasBeenSet;
}

string GetInferenceServiceResponse::GetResourceConfig() const
{
