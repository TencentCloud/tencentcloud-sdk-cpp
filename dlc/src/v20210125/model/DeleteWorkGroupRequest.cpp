...
string DeleteWorkGroupRequest::ToJsonString() const
{
...
vector<int64_t> DeleteWorkGroupRequest::GetWorkGroupIds() const
{
    return m_workGroupIds;
}

void DeleteWorkGroupRequest::SetWorkGroupIds(const vector<int64_t>& _workGroupIds)
{
    m_workGroupIds = _workGroupIds;
    m_workGroupIdsHasBeenSet = true;
}

bool DeleteWorkGroupRequest::WorkGroupIdsHasBeenSet() const
{
