...
CoreInternalOutcome ListModelVersionsResponse::Deserialize(const string &payload)
{
...
string ListModelVersionsResponse::ToJsonString() const
{
...
vector<ModelVersionInfo> ListModelVersionsResponse::GetItems() const
{
    return m_items;
}

bool ListModelVersionsResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListModelVersionsResponse::GetTotal() const
{
    return m_total;
}

bool ListModelVersionsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListModelVersionsResponse::GetPage() const
{
    return m_page;
}

bool ListModelVersionsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListModelVersionsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListModelVersionsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListModelVersionsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListModelVersionsResponse::TotalPagesHasBeenSet() const
{
