...
ListInferenceServicesResponse::ListInferenceServicesResponse() :
...
CoreInternalOutcome ListInferenceServicesResponse::Deserialize(const string &payload)
{
...
string ListInferenceServicesResponse::ToJsonString() const
{
...
vector<InferenceServiceInfo> ListInferenceServicesResponse::GetItems() const
{
    return m_items;
}

bool ListInferenceServicesResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListInferenceServicesResponse::GetTotal() const
{
    return m_total;
}

bool ListInferenceServicesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListInferenceServicesResponse::GetPage() const
{
    return m_page;
}

bool ListInferenceServicesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListInferenceServicesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListInferenceServicesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListInferenceServicesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListInferenceServicesResponse::TotalPagesHasBeenSet() const
{
