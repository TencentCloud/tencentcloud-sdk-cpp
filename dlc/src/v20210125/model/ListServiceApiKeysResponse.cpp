...
ListServiceApiKeysResponse::ListServiceApiKeysResponse() :
...
CoreInternalOutcome ListServiceApiKeysResponse::Deserialize(const string &payload)
{
...
string ListServiceApiKeysResponse::ToJsonString() const
{
...
vector<ApiKeyInfo> ListServiceApiKeysResponse::GetItems() const
{
    return m_items;
}

bool ListServiceApiKeysResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t ListServiceApiKeysResponse::GetTotal() const
{
    return m_total;
}

bool ListServiceApiKeysResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListServiceApiKeysResponse::GetPage() const
{
    return m_page;
}

bool ListServiceApiKeysResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListServiceApiKeysResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListServiceApiKeysResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListServiceApiKeysResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListServiceApiKeysResponse::TotalPagesHasBeenSet() const
{
