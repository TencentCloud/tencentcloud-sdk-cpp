...
DescribeTasksOverviewResponse::DescribeTasksOverviewResponse() :
    m_tasksOverviewHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTasksOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeTasksOverviewResponse::ToJsonString() const
{
...
TasksOverview DescribeTasksOverviewResponse::GetTasksOverview() const
{
    return m_tasksOverview;
}

bool DescribeTasksOverviewResponse::TasksOverviewHasBeenSet() const
{
