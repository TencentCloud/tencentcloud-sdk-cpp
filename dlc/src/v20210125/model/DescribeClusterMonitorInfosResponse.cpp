...
DescribeClusterMonitorInfosResponse::DescribeClusterMonitorInfosResponse() :
    m_infoHasBeenSet(false)
{
}

CoreInternalOutcome DescribeClusterMonitorInfosResponse::Deserialize(const string &payload)
{
...
string DescribeClusterMonitorInfosResponse::ToJsonString() const
{
...
string DescribeClusterMonitorInfosResponse::GetInfo() const
{
    return m_info;
}

bool DescribeClusterMonitorInfosResponse::InfoHasBeenSet() const
{
