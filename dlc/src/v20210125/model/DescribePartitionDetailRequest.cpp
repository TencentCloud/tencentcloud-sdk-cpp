...
DescribePartitionDetailRequest::DescribePartitionDetailRequest() :
    m_partitionCodeHasBeenSet(false)
{
}

string DescribePartitionDetailRequest::ToJsonString() const
{
...
string DescribePartitionDetailRequest::GetPartitionCode() const
{
    return m_partitionCode;
}

void DescribePartitionDetailRequest::SetPartitionCode(const string& _partitionCode)
{
    m_partitionCode = _partitionCode;
    m_partitionCodeHasBeenSet = true;
}

bool DescribePartitionDetailRequest::PartitionCodeHasBeenSet() const
{
