...
#include <tencentcloud/dlc/v20210125/model/UpdateClusterGroupResponse.h>
...
UpdateClusterGroupResponse::UpdateClusterGroupResponse() :
...
CoreInternalOutcome UpdateClusterGroupResponse::Deserialize(const string &payload)
{
...
string UpdateClusterGroupResponse::ToJsonString() const
{
...
string UpdateClusterGroupResponse::GetId() const
{
    return m_id;
}

bool UpdateClusterGroupResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string UpdateClusterGroupResponse::GetName() const
{
    return m_name;
}

bool UpdateClusterGroupResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string UpdateClusterGroupResponse::GetDescription() const
{
    return m_description;
}

bool UpdateClusterGroupResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string UpdateClusterGroupResponse::GetConfig() const
{
    return m_config;
}

bool UpdateClusterGroupResponse::ConfigHasBeenSet() const
{
    return m_configHasBeenSet;
}

int64_t UpdateClusterGroupResponse::GetAppId() const
{
    return m_appId;
}

bool UpdateClusterGroupResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string UpdateClusterGroupResponse::GetUin() const
{
    return m_uin;
}

bool UpdateClusterGroupResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string UpdateClusterGroupResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool UpdateClusterGroupResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

uint64_t UpdateClusterGroupResponse::GetCreateTime() const
{
    return m_createTime;
}

bool UpdateClusterGroupResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t UpdateClusterGroupResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool UpdateClusterGroupResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

bool UpdateClusterGroupResponse::GetDeleted() const
{
    return m_deleted;
}

bool UpdateClusterGroupResponse::DeletedHasBeenSet() const
{
    return m_deletedHasBeenSet;
}

uint64_t UpdateClusterGroupResponse::GetDeleteTime() const
{
    return m_deleteTime;
}

bool UpdateClusterGroupResponse::DeleteTimeHasBeenSet() const
{
