...
CoreInternalOutcome DescribeUserTypeResponse::Deserialize(const string &payload)
{
...
string DescribeUserTypeResponse::ToJsonString() const
{
...
string DescribeUserTypeResponse::GetUserType() const
{
    return m_userType;
}

bool DescribeUserTypeResponse::UserTypeHasBeenSet() const
{
