...
DescribeJobDefinitionDetailRequest::DescribeJobDefinitionDetailRequest() :
    m_jobDefinitionIdHasBeenSet(false)
{
}

string DescribeJobDefinitionDetailRequest::ToJsonString() const
{
...
string DescribeJobDefinitionDetailRequest::GetJobDefinitionId() const
{
    return m_jobDefinitionId;
}

void DescribeJobDefinitionDetailRequest::SetJobDefinitionId(const string& _jobDefinitionId)
{
    m_jobDefinitionId = _jobDefinitionId;
    m_jobDefinitionIdHasBeenSet = true;
}

bool DescribeJobDefinitionDetailRequest::JobDefinitionIdHasBeenSet() const
{
