...
DescribeTaskLogResponse::DescribeTaskLogResponse() :
...
CoreInternalOutcome DescribeTaskLogResponse::Deserialize(const string &payload)
{
...
string DescribeTaskLogResponse::ToJsonString() const
{
...
string DescribeTaskLogResponse::GetContext() const
{
    return m_context;
}

bool DescribeTaskLogResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool DescribeTaskLogResponse::GetListOver() const
{
    return m_listOver;
}

bool DescribeTaskLogResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

vector<JobLogResult> DescribeTaskLogResponse::GetResults() const
{
    return m_results;
}

bool DescribeTaskLogResponse::ResultsHasBeenSet() const
{
    return m_resultsHasBeenSet;
}

string DescribeTaskLogResponse::GetLogUrl() const
{
    return m_logUrl;
}

bool DescribeTaskLogResponse::LogUrlHasBeenSet() const
{
