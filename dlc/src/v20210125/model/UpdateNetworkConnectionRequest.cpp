...
UpdateNetworkConnectionRequest::UpdateNetworkConnectionRequest() :
    m_networkConnectionDescHasBeenSet(false),
    m_networkConnectionNameHasBeenSet(false)
{
}

string UpdateNetworkConnectionRequest::ToJsonString() const
{
...
string UpdateNetworkConnectionRequest::GetNetworkConnectionDesc() const
{
    return m_networkConnectionDesc;
}

void UpdateNetworkConnectionRequest::SetNetworkConnectionDesc(const string& _networkConnectionDesc)
{
    m_networkConnectionDesc = _networkConnectionDesc;
    m_networkConnectionDescHasBeenSet = true;
}

bool UpdateNetworkConnectionRequest::NetworkConnectionDescHasBeenSet() const
{
    return m_networkConnectionDescHasBeenSet;
}

string UpdateNetworkConnectionRequest::GetNetworkConnectionName() const
{
    return m_networkConnectionName;
}

void UpdateNetworkConnectionRequest::SetNetworkConnectionName(const string& _networkConnectionName)
{
    m_networkConnectionName = _networkConnectionName;
    m_networkConnectionNameHasBeenSet = true;
}

bool UpdateNetworkConnectionRequest::NetworkConnectionNameHasBeenSet() const
{
