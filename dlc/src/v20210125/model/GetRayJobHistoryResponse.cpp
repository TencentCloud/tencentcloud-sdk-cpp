...
GetRayJobHistoryResponse::GetRayJobHistoryResponse() :
...
CoreInternalOutcome GetRayJobHistoryResponse::Deserialize(const string &payload)
{
...
string GetRayJobHistoryResponse::ToJsonString() const
{
...
int64_t GetRayJobHistoryResponse::GetTotal() const
{
    return m_total;
}

bool GetRayJobHistoryResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t GetRayJobHistoryResponse::GetPage() const
{
    return m_page;
}

bool GetRayJobHistoryResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t GetRayJobHistoryResponse::GetPageSize() const
{
    return m_pageSize;
}

bool GetRayJobHistoryResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t GetRayJobHistoryResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool GetRayJobHistoryResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<JobStatusHistory> GetRayJobHistoryResponse::GetItems() const
{
    return m_items;
}

bool GetRayJobHistoryResponse::ItemsHasBeenSet() const
{
