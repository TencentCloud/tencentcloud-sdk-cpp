...
StartLabResponse::StartLabResponse() :
...
CoreInternalOutcome StartLabResponse::Deserialize(const string &payload)
{
...
string StartLabResponse::ToJsonString() const
{
...
string StartLabResponse::GetExampleId() const
{
    return m_exampleId;
}

bool StartLabResponse::ExampleIdHasBeenSet() const
{
    return m_exampleIdHasBeenSet;
}

string StartLabResponse::GetCodeArchiveUrl() const
{
    return m_codeArchiveUrl;
}

bool StartLabResponse::CodeArchiveUrlHasBeenSet() const
{
    return m_codeArchiveUrlHasBeenSet;
}

vector<TypeKVPair> StartLabResponse::GetServices() const
{
    return m_services;
}

bool StartLabResponse::ServicesHasBeenSet() const
{
    return m_servicesHasBeenSet;
}

string StartLabResponse::GetLabImage() const
{
    return m_labImage;
}

bool StartLabResponse::LabImageHasBeenSet() const
{
    return m_labImageHasBeenSet;
}

string StartLabResponse::GetId() const
{
    return m_id;
}

bool StartLabResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string StartLabResponse::GetType() const
{
    return m_type;
}

bool StartLabResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string StartLabResponse::GetName() const
{
    return m_name;
}

bool StartLabResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string StartLabResponse::GetDescription() const
{
    return m_description;
}

bool StartLabResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string StartLabResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool StartLabResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string StartLabResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool StartLabResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string StartLabResponse::GetQueue() const
{
    return m_queue;
}

bool StartLabResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

int64_t StartLabResponse::GetAppId() const
{
    return m_appId;
}

bool StartLabResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string StartLabResponse::GetUin() const
{
    return m_uin;
}

bool StartLabResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string StartLabResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool StartLabResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string StartLabResponse::GetStatus() const
{
    return m_status;
}

bool StartLabResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

uint64_t StartLabResponse::GetCreateTime() const
{
    return m_createTime;
}

bool StartLabResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

string StartLabResponse::GetGroupName() const
{
    return m_groupName;
}

bool StartLabResponse::GroupNameHasBeenSet() const
{
    return m_groupNameHasBeenSet;
}

string StartLabResponse::GetGroupId() const
{
    return m_groupId;
}

bool StartLabResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string StartLabResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool StartLabResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string StartLabResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool StartLabResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

string StartLabResponse::GetImage() const
{
    return m_image;
}

bool StartLabResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string StartLabResponse::GetCatalog() const
{
    return m_catalog;
}

bool StartLabResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string StartLabResponse::GetHistoryUrl() const
{
    return m_historyUrl;
}

bool StartLabResponse::HistoryUrlHasBeenSet() const
{
    return m_historyUrlHasBeenSet;
}

string StartLabResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool StartLabResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string StartLabResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool StartLabResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

int64_t StartLabResponse::GetPriority() const
{
    return m_priority;
}

bool StartLabResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

uint64_t StartLabResponse::GetStartTime() const
{
    return m_startTime;
}

bool StartLabResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

vector<Tag> StartLabResponse::GetTags() const
{
    return m_tags;
}

bool StartLabResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

PersistentWorkDir StartLabResponse::GetPersistentWorkDir() const
{
    return m_persistentWorkDir;
}

bool StartLabResponse::PersistentWorkDirHasBeenSet() const
{
    return m_persistentWorkDirHasBeenSet;
}

bool StartLabResponse::GetEnableToken() const
{
    return m_enableToken;
}

bool StartLabResponse::EnableTokenHasBeenSet() const
{
    return m_enableTokenHasBeenSet;
}

string StartLabResponse::GetLabImagePullType() const
{
    return m_labImagePullType;
}

bool StartLabResponse::LabImagePullTypeHasBeenSet() const
{
    return m_labImagePullTypeHasBeenSet;
}

string StartLabResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool StartLabResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

string StartLabResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool StartLabResponse::ImagePullTypeHasBeenSet() const
{
