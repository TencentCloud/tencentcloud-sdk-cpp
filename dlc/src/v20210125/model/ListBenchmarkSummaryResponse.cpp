...
ListBenchmarkSummaryResponse::ListBenchmarkSummaryResponse() :
...
CoreInternalOutcome ListBenchmarkSummaryResponse::Deserialize(const string &payload)
{
...
string ListBenchmarkSummaryResponse::ToJsonString() const
{
...
vector<BenchmarkSummaryInfo> ListBenchmarkSummaryResponse::GetItems() const
{
    return m_items;
}

bool ListBenchmarkSummaryResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t ListBenchmarkSummaryResponse::GetTotal() const
{
    return m_total;
}

bool ListBenchmarkSummaryResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListBenchmarkSummaryResponse::GetPage() const
{
    return m_page;
}

bool ListBenchmarkSummaryResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListBenchmarkSummaryResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListBenchmarkSummaryResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListBenchmarkSummaryResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListBenchmarkSummaryResponse::TotalPagesHasBeenSet() const
{
