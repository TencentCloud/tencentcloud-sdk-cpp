...
InitializeTCLakeResponse::InitializeTCLakeResponse() :
    m_instanceIdHasBeenSet(false),
    m_isSuccessHasBeenSet(false)
{
}

CoreInternalOutcome InitializeTCLakeResponse::Deserialize(const string &payload)
{
...
string InitializeTCLakeResponse::ToJsonString() const
{
...
string InitializeTCLakeResponse::GetInstanceId() const
{
    return m_instanceId;
}

bool InitializeTCLakeResponse::InstanceIdHasBeenSet() const
{
    return m_instanceIdHasBeenSet;
}

bool InitializeTCLakeResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool InitializeTCLakeResponse::IsSuccessHasBeenSet() const
{
