...
CoreInternalOutcome CreateSparkAppTaskResponse::Deserialize(const string &payload)
{
...
string CreateSparkAppTaskResponse::ToJsonString() const
{
...
string CreateSparkAppTaskResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateSparkAppTaskResponse::BatchIdHasBeenSet() const
{
    return m_batchIdHasBeenSet;
}

string CreateSparkAppTaskResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateSparkAppTaskResponse::TaskIdHasBeenSet() const
{
