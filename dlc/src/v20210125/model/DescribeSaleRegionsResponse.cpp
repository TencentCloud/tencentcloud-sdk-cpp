...
DescribeSaleRegionsResponse::DescribeSaleRegionsResponse() :
    m_regionListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeSaleRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeSaleRegionsResponse::ToJsonString() const
{
...
vector<RegionInfo> DescribeSaleRegionsResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeSaleRegionsResponse::RegionListHasBeenSet() const
{
