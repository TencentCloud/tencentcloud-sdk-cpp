...
GetJobSpecResponse::GetJobSpecResponse() :
...
CoreInternalOutcome GetJobSpecResponse::Deserialize(const string &payload)
{
...
string GetJobSpecResponse::ToJsonString() const
{
...
string GetJobSpecResponse::GetId() const
{
    return m_id;
}

bool GetJobSpecResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string GetJobSpecResponse::GetName() const
{
    return m_name;
}

bool GetJobSpecResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string GetJobSpecResponse::GetDescription() const
{
    return m_description;
}

bool GetJobSpecResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string GetJobSpecResponse::GetEntrypoint() const
{
    return m_entrypoint;
}

bool GetJobSpecResponse::EntrypointHasBeenSet() const
{
    return m_entrypointHasBeenSet;
}

string GetJobSpecResponse::GetImage() const
{
    return m_image;
}

bool GetJobSpecResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string GetJobSpecResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool GetJobSpecResponse::ImagePullTypeHasBeenSet() const
{
    return m_imagePullTypeHasBeenSet;
}

string GetJobSpecResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool GetJobSpecResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string GetJobSpecResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool GetJobSpecResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string GetJobSpecResponse::GetRuntimeEnv() const
{
    return m_runtimeEnv;
}

bool GetJobSpecResponse::RuntimeEnvHasBeenSet() const
{
    return m_runtimeEnvHasBeenSet;
}

string GetJobSpecResponse::GetCatalog() const
{
    return m_catalog;
}

bool GetJobSpecResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string GetJobSpecResponse::GetAutoscalerOptions() const
{
    return m_autoscalerOptions;
}

bool GetJobSpecResponse::AutoscalerOptionsHasBeenSet() const
{
    return m_autoscalerOptionsHasBeenSet;
}

string GetJobSpecResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool GetJobSpecResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

bool GetJobSpecResponse::GetResourceConfigChanged() const
{
    return m_resourceConfigChanged;
}

bool GetJobSpecResponse::ResourceConfigChangedHasBeenSet() const
{
    return m_resourceConfigChangedHasBeenSet;
}

string GetJobSpecResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool GetJobSpecResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string GetJobSpecResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool GetJobSpecResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string GetJobSpecResponse::GetQueue() const
{
    return m_queue;
}

bool GetJobSpecResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

string GetJobSpecResponse::GetQueueAlias() const
{
    return m_queueAlias;
}

bool GetJobSpecResponse::QueueAliasHasBeenSet() const
{
    return m_queueAliasHasBeenSet;
}

string GetJobSpecResponse::GetJobPackage() const
{
    return m_jobPackage;
}

bool GetJobSpecResponse::JobPackageHasBeenSet() const
{
    return m_jobPackageHasBeenSet;
}

string GetJobSpecResponse::GetJobPackageName() const
{
    return m_jobPackageName;
}

bool GetJobSpecResponse::JobPackageNameHasBeenSet() const
{
    return m_jobPackageNameHasBeenSet;
}

string GetJobSpecResponse::GetJobPackageSource() const
{
    return m_jobPackageSource;
}

bool GetJobSpecResponse::JobPackageSourceHasBeenSet() const
{
    return m_jobPackageSourceHasBeenSet;
}

int64_t GetJobSpecResponse::GetAppId() const
{
    return m_appId;
}

bool GetJobSpecResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string GetJobSpecResponse::GetUin() const
{
    return m_uin;
}

bool GetJobSpecResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string GetJobSpecResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool GetJobSpecResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

string GetJobSpecResponse::GetSubAccountName() const
{
    return m_subAccountName;
}

bool GetJobSpecResponse::SubAccountNameHasBeenSet() const
{
    return m_subAccountNameHasBeenSet;
}

uint64_t GetJobSpecResponse::GetCreateTime() const
{
    return m_createTime;
}

bool GetJobSpecResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t GetJobSpecResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool GetJobSpecResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t GetJobSpecResponse::GetJobInstanceCount() const
{
    return m_jobInstanceCount;
}

bool GetJobSpecResponse::JobInstanceCountHasBeenSet() const
{
    return m_jobInstanceCountHasBeenSet;
}

bool GetJobSpecResponse::GetHasRunningJobs() const
{
    return m_hasRunningJobs;
}

bool GetJobSpecResponse::HasRunningJobsHasBeenSet() const
{
    return m_hasRunningJobsHasBeenSet;
}

string GetJobSpecResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool GetJobSpecResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

string GetJobSpecResponse::GetGroupId() const
{
    return m_groupId;
}

bool GetJobSpecResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string GetJobSpecResponse::GetClusterId() const
{
    return m_clusterId;
}

bool GetJobSpecResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

int64_t GetJobSpecResponse::GetPriority() const
{
    return m_priority;
}

bool GetJobSpecResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

vector<Tag> GetJobSpecResponse::GetTags() const
{
    return m_tags;
}

bool GetJobSpecResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string GetJobSpecResponse::GetDispatchStrategy() const
{
    return m_dispatchStrategy;
}

bool GetJobSpecResponse::DispatchStrategyHasBeenSet() const
{
    return m_dispatchStrategyHasBeenSet;
}

string GetJobSpecResponse::GetSubmissionTarget() const
{
    return m_submissionTarget;
}

bool GetJobSpecResponse::SubmissionTargetHasBeenSet() const
{
    return m_submissionTargetHasBeenSet;
}

string GetJobSpecResponse::GetGroupName() const
{
    return m_groupName;
}

bool GetJobSpecResponse::GroupNameHasBeenSet() const
{
    return m_groupNameHasBeenSet;
}

string GetJobSpecResponse::GetClusterName() const
{
    return m_clusterName;
}

bool GetJobSpecResponse::ClusterNameHasBeenSet() const
{
