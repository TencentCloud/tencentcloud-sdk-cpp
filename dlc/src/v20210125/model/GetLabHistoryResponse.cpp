...
GetLabHistoryResponse::GetLabHistoryResponse() :
...
CoreInternalOutcome GetLabHistoryResponse::Deserialize(const string &payload)
{
...
string GetLabHistoryResponse::ToJsonString() const
{
...
int64_t GetLabHistoryResponse::GetTotal() const
{
    return m_total;
}

bool GetLabHistoryResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t GetLabHistoryResponse::GetPage() const
{
    return m_page;
}

bool GetLabHistoryResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t GetLabHistoryResponse::GetPageSize() const
{
    return m_pageSize;
}

bool GetLabHistoryResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t GetLabHistoryResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool GetLabHistoryResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayClusterHistory> GetLabHistoryResponse::GetItems() const
{
    return m_items;
}

bool GetLabHistoryResponse::ItemsHasBeenSet() const
{
