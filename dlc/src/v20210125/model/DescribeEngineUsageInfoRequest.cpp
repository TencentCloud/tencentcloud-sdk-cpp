...
string DescribeEngineUsageInfoRequest::ToJsonString() const
{
...
string DescribeEngineUsageInfoRequest::GetDataEngineId() const
{
    return m_dataEngineId;
}

void DescribeEngineUsageInfoRequest::SetDataEngineId(const string& _dataEngineId)
{
    m_dataEngineId = _dataEngineId;
    m_dataEngineIdHasBeenSet = true;
}

bool DescribeEngineUsageInfoRequest::DataEngineIdHasBeenSet() const
{
