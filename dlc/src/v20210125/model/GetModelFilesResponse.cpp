...
GetModelFilesResponse::GetModelFilesResponse() :
...
CoreInternalOutcome GetModelFilesResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["ModelId"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `ModelId` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_modelId = rsp["ModelId"].GetInt64();
...
string GetModelFilesResponse::ToJsonString() const
{
...
int64_t GetModelFilesResponse::GetModelId() const
{
    return m_modelId;
}

bool GetModelFilesResponse::ModelIdHasBeenSet() const
{
    return m_modelIdHasBeenSet;
}

string GetModelFilesResponse::GetModelName() const
{
    return m_modelName;
}

bool GetModelFilesResponse::ModelNameHasBeenSet() const
{
    return m_modelNameHasBeenSet;
}

vector<FileNode> GetModelFilesResponse::GetFiles() const
{
    return m_files;
}

bool GetModelFilesResponse::FilesHasBeenSet() const
{
