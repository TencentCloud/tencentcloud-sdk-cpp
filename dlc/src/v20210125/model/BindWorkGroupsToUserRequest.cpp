...
string BindWorkGroupsToUserRequest::ToJsonString() const
{
...
WorkGroupIdSetOfUserId BindWorkGroupsToUserRequest::GetAddInfo() const
{
    return m_addInfo;
}

void BindWorkGroupsToUserRequest::SetAddInfo(const WorkGroupIdSetOfUserId& _addInfo)
{
    m_addInfo = _addInfo;
    m_addInfoHasBeenSet = true;
}

bool BindWorkGroupsToUserRequest::AddInfoHasBeenSet() const
{
