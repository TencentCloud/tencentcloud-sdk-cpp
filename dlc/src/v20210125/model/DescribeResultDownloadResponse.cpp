...
CoreInternalOutcome DescribeResultDownloadResponse::Deserialize(const string &payload)
{
...
string DescribeResultDownloadResponse::ToJsonString() const
{
...
string DescribeResultDownloadResponse::GetPath() const
{
    return m_path;
}

bool DescribeResultDownloadResponse::PathHasBeenSet() const
{
    return m_pathHasBeenSet;
}

string DescribeResultDownloadResponse::GetStatus() const
{
    return m_status;
}

bool DescribeResultDownloadResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeResultDownloadResponse::GetReason() const
{
    return m_reason;
}

bool DescribeResultDownloadResponse::ReasonHasBeenSet() const
{
    return m_reasonHasBeenSet;
}

string DescribeResultDownloadResponse::GetSecretId() const
{
    return m_secretId;
}

bool DescribeResultDownloadResponse::SecretIdHasBeenSet() const
{
    return m_secretIdHasBeenSet;
}

string DescribeResultDownloadResponse::GetSecretKey() const
{
    return m_secretKey;
}

bool DescribeResultDownloadResponse::SecretKeyHasBeenSet() const
{
    return m_secretKeyHasBeenSet;
}

string DescribeResultDownloadResponse::GetToken() const
{
    return m_token;
}

bool DescribeResultDownloadResponse::TokenHasBeenSet() const
{
