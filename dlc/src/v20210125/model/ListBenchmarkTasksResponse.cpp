...
ListBenchmarkTasksResponse::ListBenchmarkTasksResponse() :
...
CoreInternalOutcome ListBenchmarkTasksResponse::Deserialize(const string &payload)
{
...
string ListBenchmarkTasksResponse::ToJsonString() const
{
...
vector<BenchmarkTaskInfo> ListBenchmarkTasksResponse::GetItems() const
{
    return m_items;
}

bool ListBenchmarkTasksResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

uint64_t ListBenchmarkTasksResponse::GetTotal() const
{
    return m_total;
}

bool ListBenchmarkTasksResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListBenchmarkTasksResponse::GetPage() const
{
    return m_page;
}

bool ListBenchmarkTasksResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListBenchmarkTasksResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListBenchmarkTasksResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListBenchmarkTasksResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListBenchmarkTasksResponse::TotalPagesHasBeenSet() const
{
