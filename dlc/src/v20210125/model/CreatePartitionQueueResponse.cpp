...
CoreInternalOutcome CreatePartitionQueueResponse::Deserialize(const string &payload)
{
...
string CreatePartitionQueueResponse::ToJsonString() const
{
...
int64_t CreatePartitionQueueResponse::GetId() const
{
    return m_id;
}
