...
ListLabsResponse::ListLabsResponse() :
...
CoreInternalOutcome ListLabsResponse::Deserialize(const string &payload)
{
...
string ListLabsResponse::ToJsonString() const
{
...
int64_t ListLabsResponse::GetTotal() const
{
    return m_total;
}

bool ListLabsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListLabsResponse::GetPage() const
{
    return m_page;
}

bool ListLabsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListLabsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListLabsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListLabsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListLabsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<LabResponse> ListLabsResponse::GetItems() const
{
    return m_items;
}

bool ListLabsResponse::ItemsHasBeenSet() const
{
