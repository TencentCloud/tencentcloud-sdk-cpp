...
QueryDashboardServiceListResponse::QueryDashboardServiceListResponse() :
...
CoreInternalOutcome QueryDashboardServiceListResponse::Deserialize(const string &payload)
{
...
string QueryDashboardServiceListResponse::ToJsonString() const
{
...
uint64_t QueryDashboardServiceListResponse::GetTotal() const
{
    return m_total;
}

bool QueryDashboardServiceListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t QueryDashboardServiceListResponse::GetPage() const
{
    return m_page;
}

bool QueryDashboardServiceListResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t QueryDashboardServiceListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool QueryDashboardServiceListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t QueryDashboardServiceListResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool QueryDashboardServiceListResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ServiceMetricsItem> QueryDashboardServiceListResponse::GetItems() const
{
    return m_items;
}

bool QueryDashboardServiceListResponse::ItemsHasBeenSet() const
{
