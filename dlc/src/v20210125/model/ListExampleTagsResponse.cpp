...
ListExampleTagsResponse::ListExampleTagsResponse() :
...
CoreInternalOutcome ListExampleTagsResponse::Deserialize(const string &payload)
{
...
string ListExampleTagsResponse::ToJsonString() const
{
...
int64_t ListExampleTagsResponse::GetTotal() const
{
    return m_total;
}

bool ListExampleTagsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListExampleTagsResponse::GetPage() const
{
    return m_page;
}

bool ListExampleTagsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListExampleTagsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListExampleTagsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListExampleTagsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListExampleTagsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ExampleTag> ListExampleTagsResponse::GetItems() const
{
    return m_items;
}

bool ListExampleTagsResponse::ItemsHasBeenSet() const
{
