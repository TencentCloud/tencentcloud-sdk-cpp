...
CoreInternalOutcome CancelNotebookSessionStatementResponse::Deserialize(const string &payload)
{
...
string CancelNotebookSessionStatementResponse::ToJsonString() const
{
