...
string CreateStoreLocationRequest::ToJsonString() const
{
...
string CreateStoreLocationRequest::GetStoreLocation() const
{
    return m_storeLocation;
}

void CreateStoreLocationRequest::SetStoreLocation(const string& _storeLocation)
{
    m_storeLocation = _storeLocation;
    m_storeLocationHasBeenSet = true;
}

bool CreateStoreLocationRequest::StoreLocationHasBeenSet() const
{
