...
CoreInternalOutcome ViewResponseInfo::Deserialize(const Value &value)
{
    string requestId = "";
...
void ViewResponseInfo::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
