...
CopyJobSpecRequest::CopyJobSpecRequest() :
    m_specIdHasBeenSet(false),
    m_newNameHasBeenSet(false)
{
}

string CopyJobSpecRequest::ToJsonString() const
{
...
string CopyJobSpecRequest::GetSpecId() const
{
    return m_specId;
}

void CopyJobSpecRequest::SetSpecId(const string& _specId)
{
    m_specId = _specId;
    m_specIdHasBeenSet = true;
}

bool CopyJobSpecRequest::SpecIdHasBeenSet() const
{
    return m_specIdHasBeenSet;
}

string CopyJobSpecRequest::GetNewName() const
{
    return m_newName;
}

void CopyJobSpecRequest::SetNewName(const string& _newName)
{
    m_newName = _newName;
    m_newNameHasBeenSet = true;
}

bool CopyJobSpecRequest::NewNameHasBeenSet() const
{
