...
DescribeEngineNodeSpecRequest::DescribeEngineNodeSpecRequest() :
    m_dataEngineNameHasBeenSet(false)
{
}

string DescribeEngineNodeSpecRequest::ToJsonString() const
{
...
string DescribeEngineNodeSpecRequest::GetDataEngineName() const
{
    return m_dataEngineName;
}

void DescribeEngineNodeSpecRequest::SetDataEngineName(const string& _dataEngineName)
{
    m_dataEngineName = _dataEngineName;
    m_dataEngineNameHasBeenSet = true;
}

bool DescribeEngineNodeSpecRequest::DataEngineNameHasBeenSet() const
{
