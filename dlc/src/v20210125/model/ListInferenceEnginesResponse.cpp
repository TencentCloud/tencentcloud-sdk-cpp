...
ListInferenceEnginesResponse::ListInferenceEnginesResponse() :
...
CoreInternalOutcome ListInferenceEnginesResponse::Deserialize(const string &payload)
{
...
string ListInferenceEnginesResponse::ToJsonString() const
{
...
vector<InferenceEngineInfo> ListInferenceEnginesResponse::GetItems() const
{
    return m_items;
}

bool ListInferenceEnginesResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListInferenceEnginesResponse::GetTotal() const
{
    return m_total;
}

bool ListInferenceEnginesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListInferenceEnginesResponse::GetPage() const
{
    return m_page;
}

bool ListInferenceEnginesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListInferenceEnginesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListInferenceEnginesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListInferenceEnginesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListInferenceEnginesResponse::TotalPagesHasBeenSet() const
{
