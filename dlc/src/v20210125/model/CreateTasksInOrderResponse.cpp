...
CoreInternalOutcome CreateTasksInOrderResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("TaskIdSet") && !rsp["TaskIdSet"].IsNull())
    {
        if (!rsp["TaskIdSet"].IsArray())
            return CoreInternalOutcome(Error("response `TaskIdSet` is not array type"));
...
string CreateTasksInOrderResponse::ToJsonString() const
{
...
string CreateTasksInOrderResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateTasksInOrderResponse::BatchIdHasBeenSet() const
{
    return m_batchIdHasBeenSet;
}

vector<string> CreateTasksInOrderResponse::GetTaskIdSet() const
{
    return m_taskIdSet;
}

bool CreateTasksInOrderResponse::TaskIdSetHasBeenSet() const
{
