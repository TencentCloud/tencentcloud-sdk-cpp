...
#include <tencentcloud/dlc/v20210125/model/ListExampleCategoriesResponse.h>
...
ListExampleCategoriesResponse::ListExampleCategoriesResponse() :
...
CoreInternalOutcome ListExampleCategoriesResponse::Deserialize(const string &payload)
{
...
string ListExampleCategoriesResponse::ToJsonString() const
{
...
int64_t ListExampleCategoriesResponse::GetTotal() const
{
    return m_total;
}

bool ListExampleCategoriesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListExampleCategoriesResponse::GetPage() const
{
    return m_page;
}

bool ListExampleCategoriesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListExampleCategoriesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListExampleCategoriesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListExampleCategoriesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListExampleCategoriesResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ExampleCategories> ListExampleCategoriesResponse::GetItems() const
{
    return m_items;
}

bool ListExampleCategoriesResponse::ItemsHasBeenSet() const
{
