...
string DeleteUsersFromWorkGroupRequest::ToJsonString() const
{
...
UserIdSetOfWorkGroupId DeleteUsersFromWorkGroupRequest::GetAddInfo() const
{
    return m_addInfo;
}

void DeleteUsersFromWorkGroupRequest::SetAddInfo(const UserIdSetOfWorkGroupId& _addInfo)
{
    m_addInfo = _addInfo;
    m_addInfoHasBeenSet = true;
}

bool DeleteUsersFromWorkGroupRequest::AddInfoHasBeenSet() const
{
