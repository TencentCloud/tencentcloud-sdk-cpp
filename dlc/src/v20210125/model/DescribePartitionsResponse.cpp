...
CoreInternalOutcome DescribePartitionsResponse::Deserialize(const string &payload)
{
...
string DescribePartitionsResponse::ToJsonString() const
{
...
vector<PartitionInfo> DescribePartitionsResponse::GetPartitions() const
{
    return m_partitions;
}

bool DescribePartitionsResponse::PartitionsHasBeenSet() const
{
    return m_partitionsHasBeenSet;
}

int64_t DescribePartitionsResponse::GetTotal() const
{
    return m_total;
}

bool DescribePartitionsResponse::TotalHasBeenSet() const
{
