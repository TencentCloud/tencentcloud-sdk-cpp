...
ListDeploymentReplicasResponse::ListDeploymentReplicasResponse() :
...
CoreInternalOutcome ListDeploymentReplicasResponse::Deserialize(const string &payload)
{
...
string ListDeploymentReplicasResponse::ToJsonString() const
{
...
vector<DeploymentReplicaInfo> ListDeploymentReplicasResponse::GetItems() const
{
    return m_items;
}

bool ListDeploymentReplicasResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListDeploymentReplicasResponse::GetTotal() const
{
    return m_total;
}

bool ListDeploymentReplicasResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListDeploymentReplicasResponse::GetPage() const
{
    return m_page;
}

bool ListDeploymentReplicasResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListDeploymentReplicasResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListDeploymentReplicasResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListDeploymentReplicasResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListDeploymentReplicasResponse::TotalPagesHasBeenSet() const
{
