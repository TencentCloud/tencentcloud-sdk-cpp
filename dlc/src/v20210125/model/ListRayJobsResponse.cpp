...
#include <tencentcloud/dlc/v20210125/model/ListRayJobsResponse.h>
...
ListRayJobsResponse::ListRayJobsResponse() :
...
CoreInternalOutcome ListRayJobsResponse::Deserialize(const string &payload)
{
...
string ListRayJobsResponse::ToJsonString() const
{
...
int64_t ListRayJobsResponse::GetPage() const
{
    return m_page;
}

bool ListRayJobsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListRayJobsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListRayJobsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListRayJobsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListRayJobsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayJobSubmitEntity> ListRayJobsResponse::GetItems() const
{
    return m_items;
}

bool ListRayJobsResponse::ItemsHasBeenSet() const
{
