...
CoreInternalOutcome DescribeClsTopicsResponse::Deserialize(const string &payload)
{
...
string DescribeClsTopicsResponse::ToJsonString() const
{
...
int64_t DescribeClsTopicsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClsTopicsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<ClsTopicItem> DescribeClsTopicsResponse::GetTopics() const
{
    return m_topics;
}

bool DescribeClsTopicsResponse::TopicsHasBeenSet() const
{
