...
string DeleteDataEngineRequest::ToJsonString() const
{
...
vector<string> DeleteDataEngineRequest::GetDataEngineNames() const
{
    return m_dataEngineNames;
}

void DeleteDataEngineRequest::SetDataEngineNames(const vector<string>& _dataEngineNames)
{
    m_dataEngineNames = _dataEngineNames;
    m_dataEngineNamesHasBeenSet = true;
}

bool DeleteDataEngineRequest::DataEngineNamesHasBeenSet() const
{
