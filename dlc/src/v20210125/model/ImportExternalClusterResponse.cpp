...
ImportExternalClusterResponse::ImportExternalClusterResponse() :
...
CoreInternalOutcome ImportExternalClusterResponse::Deserialize(const string &payload)
{
...
string ImportExternalClusterResponse::ToJsonString() const
{
...
int64_t ImportExternalClusterResponse::GetResourcePoolId() const
{
    return m_resourcePoolId;
}

bool ImportExternalClusterResponse::ResourcePoolIdHasBeenSet() const
{
    return m_resourcePoolIdHasBeenSet;
}

string ImportExternalClusterResponse::GetResourcePoolCode() const
{
    return m_resourcePoolCode;
}

bool ImportExternalClusterResponse::ResourcePoolCodeHasBeenSet() const
{
    return m_resourcePoolCodeHasBeenSet;
}

int64_t ImportExternalClusterResponse::GetWorkflowId() const
{
    return m_workflowId;
}

bool ImportExternalClusterResponse::WorkflowIdHasBeenSet() const
{
