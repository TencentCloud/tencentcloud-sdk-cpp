...
CoreInternalOutcome CreateNotebookSessionResponse::Deserialize(const string &payload)
{
...
string CreateNotebookSessionResponse::ToJsonString() const
{
...
string CreateNotebookSessionResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateNotebookSessionResponse::SessionIdHasBeenSet() const
{
    return m_sessionIdHasBeenSet;
}

string CreateNotebookSessionResponse::GetSparkAppId() const
{
    return m_sparkAppId;
}

bool CreateNotebookSessionResponse::SparkAppIdHasBeenSet() const
{
    return m_sparkAppIdHasBeenSet;
}

string CreateNotebookSessionResponse::GetState() const
{
    return m_state;
}

bool CreateNotebookSessionResponse::StateHasBeenSet() const
{
