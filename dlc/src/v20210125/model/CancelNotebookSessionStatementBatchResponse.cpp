...
CoreInternalOutcome CancelNotebookSessionStatementBatchResponse::Deserialize(const string &payload)
{
...
string CancelNotebookSessionStatementBatchResponse::ToJsonString() const
{
