...
#include <tencentcloud/dlc/v20210125/model/GetRayJobYamlResponse.h>
...
GetRayJobYamlResponse::GetRayJobYamlResponse() :
    m_yamlHasBeenSet(false)
{
}

CoreInternalOutcome GetRayJobYamlResponse::Deserialize(const string &payload)
{
...
string GetRayJobYamlResponse::ToJsonString() const
{
...
string GetRayJobYamlResponse::GetYaml() const
{
    return m_yaml;
}

bool GetRayJobYamlResponse::YamlHasBeenSet() const
{
