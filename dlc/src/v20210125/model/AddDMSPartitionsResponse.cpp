...
CoreInternalOutcome AddDMSPartitionsResponse::Deserialize(const string &payload)
{
...
string AddDMSPartitionsResponse::ToJsonString() const
{
...
int64_t AddDMSPartitionsResponse::GetTotal() const
{
    return m_total;
}

bool AddDMSPartitionsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DMSPartition> AddDMSPartitionsResponse::GetPartitions() const
{
    return m_partitions;
}

bool AddDMSPartitionsResponse::PartitionsHasBeenSet() const
{
