...
string AddDMSPartitionsRequest::ToJsonString() const
{
...
vector<DMSPartition> AddDMSPartitionsRequest::GetPartitions() const
{
    return m_partitions;
}

void AddDMSPartitionsRequest::SetPartitions(const vector<DMSPartition>& _partitions)
{
    m_partitions = _partitions;
    m_partitionsHasBeenSet = true;
}

bool AddDMSPartitionsRequest::PartitionsHasBeenSet() const
{
