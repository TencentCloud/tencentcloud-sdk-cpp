...
string CreateScriptRequest::ToJsonString() const
{
    ...
    if (m_scriptNameHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_scriptName.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_sQLStatementHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_sQLStatement.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_scriptDescHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_scriptDesc.c_str(), allocator).Move(), allocator);
    }
