...
string DescribeSessionImageVersionRequest::ToJsonString() const
{
...
string DescribeSessionImageVersionRequest::GetDataEngineId() const
{
    return m_dataEngineId;
}

void DescribeSessionImageVersionRequest::SetDataEngineId(const string& _dataEngineId)
{
    m_dataEngineId = _dataEngineId;
    m_dataEngineIdHasBeenSet = true;
}

bool DescribeSessionImageVersionRequest::DataEngineIdHasBeenSet() const
{
    return m_dataEngineIdHasBeenSet;
}

string DescribeSessionImageVersionRequest::GetFrameworkType() const
{
    return m_frameworkType;
}

void DescribeSessionImageVersionRequest::SetFrameworkType(const string& _frameworkType)
{
    m_frameworkType = _frameworkType;
    m_frameworkTypeHasBeenSet = true;
}

bool DescribeSessionImageVersionRequest::FrameworkTypeHasBeenSet() const
{
