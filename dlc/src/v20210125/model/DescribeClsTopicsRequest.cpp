...
string DescribeClsTopicsRequest::GetTopicName() const
{
    return m_topicName;
}

void DescribeClsTopicsRequest::SetTopicName(const string& _topicName)
{
    m_topicName = _topicName;
    m_topicNameHasBeenSet = true;
}

bool DescribeClsTopicsRequest::TopicNameHasBeenSet() const
{
    return m_topicNameHasBeenSet;
}

string DescribeClsTopicsRequest::GetTopicId() const
{
    return m_topicId;
}

void DescribeClsTopicsRequest::SetTopicId(const string& _topicId)
{
    m_topicId = _topicId;
    m_topicIdHasBeenSet = true;
}

bool DescribeClsTopicsRequest::TopicIdHasBeenSet() const
{
