...
ModifySparkAppForTDLCRequest::ModifySparkAppForTDLCRequest() :
...
string ModifySparkAppForTDLCRequest::ToJsonString() const
{
...
string ModifySparkAppForTDLCRequest::GetAppName() const
{
    return m_appName;
}

void ModifySparkAppForTDLCRequest::SetAppName(const string& _appName)
{
    m_appName = _appName;
    m_appNameHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppNameHasBeenSet() const
{
    return m_appNameHasBeenSet;
}

int64_t ModifySparkAppForTDLCRequest::GetAppType() const
{
    return m_appType;
}

void ModifySparkAppForTDLCRequest::SetAppType(const int64_t& _appType)
{
    m_appType = _appType;
    m_appTypeHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppTypeHasBeenSet() const
{
    return m_appTypeHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetDataEngine() const
{
    return m_dataEngine;
}

void ModifySparkAppForTDLCRequest::SetDataEngine(const string& _dataEngine)
{
    m_dataEngine = _dataEngine;
    m_dataEngineHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::DataEngineHasBeenSet() const
{
    return m_dataEngineHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppFile() const
{
    return m_appFile;
}

void ModifySparkAppForTDLCRequest::SetAppFile(const string& _appFile)
{
    m_appFile = _appFile;
    m_appFileHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppFileHasBeenSet() const
{
    return m_appFileHasBeenSet;
}

int64_t ModifySparkAppForTDLCRequest::GetRoleArn() const
{
    return m_roleArn;
}

void ModifySparkAppForTDLCRequest::SetRoleArn(const int64_t& _roleArn)
{
    m_roleArn = _roleArn;
    m_roleArnHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::RoleArnHasBeenSet() const
{
    return m_roleArnHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppDriverSize() const
{
    return m_appDriverSize;
}

void ModifySparkAppForTDLCRequest::SetAppDriverSize(const string& _appDriverSize)
{
    m_appDriverSize = _appDriverSize;
    m_appDriverSizeHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppDriverSizeHasBeenSet() const
{
    return m_appDriverSizeHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppExecutorSize() const
{
    return m_appExecutorSize;
}

void ModifySparkAppForTDLCRequest::SetAppExecutorSize(const string& _appExecutorSize)
{
    m_appExecutorSize = _appExecutorSize;
    m_appExecutorSizeHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppExecutorSizeHasBeenSet() const
{
    return m_appExecutorSizeHasBeenSet;
}

int64_t ModifySparkAppForTDLCRequest::GetAppExecutorNums() const
{
    return m_appExecutorNums;
}

void ModifySparkAppForTDLCRequest::SetAppExecutorNums(const int64_t& _appExecutorNums)
{
    m_appExecutorNums = _appExecutorNums;
    m_appExecutorNumsHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppExecutorNumsHasBeenSet() const
{
    return m_appExecutorNumsHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetSparkAppId() const
{
    return m_sparkAppId;
}

void ModifySparkAppForTDLCRequest::SetSparkAppId(const string& _sparkAppId)
{
    m_sparkAppId = _sparkAppId;
    m_sparkAppIdHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::SparkAppIdHasBeenSet() const
{
    return m_sparkAppIdHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetEni() const
{
    return m_eni;
}

void ModifySparkAppForTDLCRequest::SetEni(const string& _eni)
{
    m_eni = _eni;
    m_eniHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::EniHasBeenSet() const
{
    return m_eniHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetIsLocal() const
{
    return m_isLocal;
}

void ModifySparkAppForTDLCRequest::SetIsLocal(const string& _isLocal)
{
    m_isLocal = _isLocal;
    m_isLocalHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsLocalHasBeenSet() const
{
    return m_isLocalHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetMainClass() const
{
    return m_mainClass;
}

void ModifySparkAppForTDLCRequest::SetMainClass(const string& _mainClass)
{
    m_mainClass = _mainClass;
    m_mainClassHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::MainClassHasBeenSet() const
{
    return m_mainClassHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppConf() const
{
    return m_appConf;
}

void ModifySparkAppForTDLCRequest::SetAppConf(const string& _appConf)
{
    m_appConf = _appConf;
    m_appConfHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppConfHasBeenSet() const
{
    return m_appConfHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetIsLocalJars() const
{
    return m_isLocalJars;
}

void ModifySparkAppForTDLCRequest::SetIsLocalJars(const string& _isLocalJars)
{
    m_isLocalJars = _isLocalJars;
    m_isLocalJarsHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsLocalJarsHasBeenSet() const
{
    return m_isLocalJarsHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppJars() const
{
    return m_appJars;
}

void ModifySparkAppForTDLCRequest::SetAppJars(const string& _appJars)
{
    m_appJars = _appJars;
    m_appJarsHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppJarsHasBeenSet() const
{
    return m_appJarsHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetIsLocalFiles() const
{
    return m_isLocalFiles;
}

void ModifySparkAppForTDLCRequest::SetIsLocalFiles(const string& _isLocalFiles)
{
    m_isLocalFiles = _isLocalFiles;
    m_isLocalFilesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsLocalFilesHasBeenSet() const
{
    return m_isLocalFilesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppFiles() const
{
    return m_appFiles;
}

void ModifySparkAppForTDLCRequest::SetAppFiles(const string& _appFiles)
{
    m_appFiles = _appFiles;
    m_appFilesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppFilesHasBeenSet() const
{
    return m_appFilesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetIsLocalPythonFiles() const
{
    return m_isLocalPythonFiles;
}

void ModifySparkAppForTDLCRequest::SetIsLocalPythonFiles(const string& _isLocalPythonFiles)
{
    m_isLocalPythonFiles = _isLocalPythonFiles;
    m_isLocalPythonFilesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsLocalPythonFilesHasBeenSet() const
{
    return m_isLocalPythonFilesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppPythonFiles() const
{
    return m_appPythonFiles;
}

void ModifySparkAppForTDLCRequest::SetAppPythonFiles(const string& _appPythonFiles)
{
    m_appPythonFiles = _appPythonFiles;
    m_appPythonFilesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppPythonFilesHasBeenSet() const
{
    return m_appPythonFilesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetCmdArgs() const
{
    return m_cmdArgs;
}

void ModifySparkAppForTDLCRequest::SetCmdArgs(const string& _cmdArgs)
{
    m_cmdArgs = _cmdArgs;
    m_cmdArgsHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::CmdArgsHasBeenSet() const
{
    return m_cmdArgsHasBeenSet;
}

int64_t ModifySparkAppForTDLCRequest::GetMaxRetries() const
{
    return m_maxRetries;
}

void ModifySparkAppForTDLCRequest::SetMaxRetries(const int64_t& _maxRetries)
{
    m_maxRetries = _maxRetries;
    m_maxRetriesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::MaxRetriesHasBeenSet() const
{
    return m_maxRetriesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetDataSource() const
{
    return m_dataSource;
}

void ModifySparkAppForTDLCRequest::SetDataSource(const string& _dataSource)
{
    m_dataSource = _dataSource;
    m_dataSourceHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::DataSourceHasBeenSet() const
{
    return m_dataSourceHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetIsLocalArchives() const
{
    return m_isLocalArchives;
}

void ModifySparkAppForTDLCRequest::SetIsLocalArchives(const string& _isLocalArchives)
{
    m_isLocalArchives = _isLocalArchives;
    m_isLocalArchivesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsLocalArchivesHasBeenSet() const
{
    return m_isLocalArchivesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetAppArchives() const
{
    return m_appArchives;
}

void ModifySparkAppForTDLCRequest::SetAppArchives(const string& _appArchives)
{
    m_appArchives = _appArchives;
    m_appArchivesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppArchivesHasBeenSet() const
{
    return m_appArchivesHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetSparkImage() const
{
    return m_sparkImage;
}

void ModifySparkAppForTDLCRequest::SetSparkImage(const string& _sparkImage)
{
    m_sparkImage = _sparkImage;
    m_sparkImageHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::SparkImageHasBeenSet() const
{
    return m_sparkImageHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetSparkImageVersion() const
{
    return m_sparkImageVersion;
}

void ModifySparkAppForTDLCRequest::SetSparkImageVersion(const string& _sparkImageVersion)
{
    m_sparkImageVersion = _sparkImageVersion;
    m_sparkImageVersionHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::SparkImageVersionHasBeenSet() const
{
    return m_sparkImageVersionHasBeenSet;
}

int64_t ModifySparkAppForTDLCRequest::GetAppExecutorMaxNumbers() const
{
    return m_appExecutorMaxNumbers;
}

void ModifySparkAppForTDLCRequest::SetAppExecutorMaxNumbers(const int64_t& _appExecutorMaxNumbers)
{
    m_appExecutorMaxNumbers = _appExecutorMaxNumbers;
    m_appExecutorMaxNumbersHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::AppExecutorMaxNumbersHasBeenSet() const
{
    return m_appExecutorMaxNumbersHasBeenSet;
}

string ModifySparkAppForTDLCRequest::GetSessionId() const
{
    return m_sessionId;
}

void ModifySparkAppForTDLCRequest::SetSessionId(const string& _sessionId)
{
    m_sessionId = _sessionId;
    m_sessionIdHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::SessionIdHasBeenSet() const
{
    return m_sessionIdHasBeenSet;
}

uint64_t ModifySparkAppForTDLCRequest::GetIsInherit() const
{
    return m_isInherit;
}

void ModifySparkAppForTDLCRequest::SetIsInherit(const uint64_t& _isInherit)
{
    m_isInherit = _isInherit;
    m_isInheritHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsInheritHasBeenSet() const
{
    return m_isInheritHasBeenSet;
}

bool ModifySparkAppForTDLCRequest::GetIsSessionStarted() const
{
    return m_isSessionStarted;
}

void ModifySparkAppForTDLCRequest::SetIsSessionStarted(const bool& _isSessionStarted)
{
    m_isSessionStarted = _isSessionStarted;
    m_isSessionStartedHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::IsSessionStartedHasBeenSet() const
{
    return m_isSessionStartedHasBeenSet;
}

vector<DependencyPackage> ModifySparkAppForTDLCRequest::GetDependencyPackages() const
{
    return m_dependencyPackages;
}

void ModifySparkAppForTDLCRequest::SetDependencyPackages(const vector<DependencyPackage>& _dependencyPackages)
{
    m_dependencyPackages = _dependencyPackages;
    m_dependencyPackagesHasBeenSet = true;
}

bool ModifySparkAppForTDLCRequest::DependencyPackagesHasBeenSet() const
{
