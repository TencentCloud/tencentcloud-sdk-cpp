...
ListTaskJobLogNameResponse::ListTaskJobLogNameResponse() :
    m_namesHasBeenSet(false)
{
}

CoreInternalOutcome ListTaskJobLogNameResponse::Deserialize(const string &payload)
{
...
string ListTaskJobLogNameResponse::ToJsonString() const
{
...
vector<string> ListTaskJobLogNameResponse::GetNames() const
{
    return m_names;
}

bool ListTaskJobLogNameResponse::NamesHasBeenSet() const
{
