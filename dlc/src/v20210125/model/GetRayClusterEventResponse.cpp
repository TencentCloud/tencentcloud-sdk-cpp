...
GetRayClusterEventResponse::GetRayClusterEventResponse() :
...
CoreInternalOutcome GetRayClusterEventResponse::Deserialize(const string &payload)
{
...
string GetRayClusterEventResponse::ToJsonString() const
{
...
string GetRayClusterEventResponse::GetContext() const
{
    return m_context;
}

bool GetRayClusterEventResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool GetRayClusterEventResponse::GetListOver() const
{
    return m_listOver;
}

bool GetRayClusterEventResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

vector<EventItem> GetRayClusterEventResponse::GetEvents() const
{
    return m_events;
}

bool GetRayClusterEventResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

uint64_t GetRayClusterEventResponse::GetStartTime() const
{
    return m_startTime;
}

bool GetRayClusterEventResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

uint64_t GetRayClusterEventResponse::GetEndTime() const
{
    return m_endTime;
}

bool GetRayClusterEventResponse::EndTimeHasBeenSet() const
{
