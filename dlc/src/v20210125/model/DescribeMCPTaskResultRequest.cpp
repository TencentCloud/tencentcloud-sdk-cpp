...
string DescribeMCPTaskResultRequest::ToJsonString() const
{
...
string DescribeMCPTaskResultRequest::GetTaskId() const
{
    return m_taskId;
}

void DescribeMCPTaskResultRequest::SetTaskId(const string& _taskId)
{
    m_taskId = _taskId;
