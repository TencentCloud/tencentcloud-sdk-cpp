...
GetLabYamlResponse::GetLabYamlResponse() :
    m_yamlHasBeenSet(false)
{
}

CoreInternalOutcome GetLabYamlResponse::Deserialize(const string &payload)
{
...
string GetLabYamlResponse::ToJsonString() const
{
...
string GetLabYamlResponse::GetYaml() const
{
    return m_yaml;
}

bool GetLabYamlResponse::YamlHasBeenSet() const
{
