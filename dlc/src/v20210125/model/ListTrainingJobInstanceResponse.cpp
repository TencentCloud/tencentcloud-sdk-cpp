...
#include <tencentcloud/dlc/v20210125/model/ListTrainingJobInstanceResponse.h>
...
ListTrainingJobInstanceResponse::ListTrainingJobInstanceResponse() :
...
CoreInternalOutcome ListTrainingJobInstanceResponse::Deserialize(const string &payload)
{
...
string ListTrainingJobInstanceResponse::ToJsonString() const
{
...
vector<TrainingJobInstance> ListTrainingJobInstanceResponse::GetItems() const
{
    return m_items;
}

bool ListTrainingJobInstanceResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListTrainingJobInstanceResponse::GetTotal() const
{
    return m_total;
}

bool ListTrainingJobInstanceResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListTrainingJobInstanceResponse::GetPage() const
{
    return m_page;
}

bool ListTrainingJobInstanceResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListTrainingJobInstanceResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListTrainingJobInstanceResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListTrainingJobInstanceResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListTrainingJobInstanceResponse::TotalPagesHasBeenSet() const
{
