...
GetResourceConfigResponse::GetResourceConfigResponse() :
...
CoreInternalOutcome GetResourceConfigResponse::Deserialize(const string &payload)
{
...
string GetResourceConfigResponse::ToJsonString() const
{
...
string GetResourceConfigResponse::GetId() const
{
    return m_id;
}

bool GetResourceConfigResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string GetResourceConfigResponse::GetName() const
{
    return m_name;
}

bool GetResourceConfigResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string GetResourceConfigResponse::GetDescription() const
{
    return m_description;
}

bool GetResourceConfigResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string GetResourceConfigResponse::GetType() const
{
    return m_type;
}

bool GetResourceConfigResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

HeadSpecDTO GetResourceConfigResponse::GetHead() const
{
    return m_head;
}

bool GetResourceConfigResponse::HeadHasBeenSet() const
{
    return m_headHasBeenSet;
}

vector<WorkerSpecDTO> GetResourceConfigResponse::GetWorker() const
{
    return m_worker;
}

bool GetResourceConfigResponse::WorkerHasBeenSet() const
{
    return m_workerHasBeenSet;
}

uint64_t GetResourceConfigResponse::GetCreateTime() const
{
    return m_createTime;
}

bool GetResourceConfigResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t GetResourceConfigResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool GetResourceConfigResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t GetResourceConfigResponse::GetAppId() const
{
    return m_appId;
}

bool GetResourceConfigResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string GetResourceConfigResponse::GetUin() const
{
    return m_uin;
}

bool GetResourceConfigResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string GetResourceConfigResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool GetResourceConfigResponse::SubAccountUinHasBeenSet() const
{
