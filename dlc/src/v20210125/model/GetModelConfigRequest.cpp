...
string GetModelConfigRequest::ToJsonString() const
{
...
string GetModelConfigRequest::GetModelUid() const
{
    return m_modelUid;
}

void GetModelConfigRequest::SetModelUid(const string& _modelUid)
{
    m_modelUid = _modelUid;
    m_modelUidHasBeenSet = true;
}

bool GetModelConfigRequest::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string GetModelConfigRequest::GetModelVersion() const
{
    return m_modelVersion;
}

void GetModelConfigRequest::SetModelVersion(const string& _modelVersion)
{
    m_modelVersion = _modelVersion;
    m_modelVersionHasBeenSet = true;
}

bool GetModelConfigRequest::ModelVersionHasBeenSet() const
{
