...
ListInferenceModelsResponse::ListInferenceModelsResponse() :
...
CoreInternalOutcome ListInferenceModelsResponse::Deserialize(const string &payload)
{
...
string ListInferenceModelsResponse::ToJsonString() const
{
...
vector<InferenceModelInfo> ListInferenceModelsResponse::GetItems() const
{
    return m_items;
}

bool ListInferenceModelsResponse::ItemsHasBeenSet() const
{
    return m_itemsHasBeenSet;
}

int64_t ListInferenceModelsResponse::GetTotal() const
{
    return m_total;
}

bool ListInferenceModelsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListInferenceModelsResponse::GetPage() const
{
    return m_page;
}

bool ListInferenceModelsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListInferenceModelsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListInferenceModelsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListInferenceModelsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListInferenceModelsResponse::TotalPagesHasBeenSet() const
{
