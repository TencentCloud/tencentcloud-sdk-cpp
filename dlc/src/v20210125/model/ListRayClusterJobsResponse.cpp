...
ListRayClusterJobsResponse::ListRayClusterJobsResponse() :
...
CoreInternalOutcome ListRayClusterJobsResponse::Deserialize(const string &payload)
{
...
string ListRayClusterJobsResponse::ToJsonString() const
{
...
int64_t ListRayClusterJobsResponse::GetPage() const
{
    return m_page;
}

bool ListRayClusterJobsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListRayClusterJobsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListRayClusterJobsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListRayClusterJobsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListRayClusterJobsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayJobSubmitEntity> ListRayClusterJobsResponse::GetItems() const
{
    return m_items;
}

bool ListRayClusterJobsResponse::ItemsHasBeenSet() const
{
