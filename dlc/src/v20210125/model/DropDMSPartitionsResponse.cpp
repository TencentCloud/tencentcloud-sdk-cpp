...
CoreInternalOutcome DropDMSPartitionsResponse::Deserialize(const string &payload)
{
...
string DropDMSPartitionsResponse::ToJsonString() const
{
...
bool DropDMSPartitionsResponse::GetStatus() const
{
    return m_status;
}

bool DropDMSPartitionsResponse::StatusHasBeenSet() const
{
