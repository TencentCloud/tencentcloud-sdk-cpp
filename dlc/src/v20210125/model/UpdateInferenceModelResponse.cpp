...
UpdateInferenceModelResponse::UpdateInferenceModelResponse() :
...
CoreInternalOutcome UpdateInferenceModelResponse::Deserialize(const string &payload)
{
...
string UpdateInferenceModelResponse::ToJsonString() const
{
...
string UpdateInferenceModelResponse::GetModelId() const
{
    return m_modelId;
}

bool UpdateInferenceModelResponse::ModelIdHasBeenSet() const
{
    return m_modelIdHasBeenSet;
}

string UpdateInferenceModelResponse::GetModelUid() const
{
    return m_modelUid;
}

bool UpdateInferenceModelResponse::ModelUidHasBeenSet() const
{
    return m_modelUidHasBeenSet;
}

string UpdateInferenceModelResponse::GetName() const
{
    return m_name;
}

bool UpdateInferenceModelResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string UpdateInferenceModelResponse::GetProvider() const
{
    return m_provider;
}

bool UpdateInferenceModelResponse::ProviderHasBeenSet() const
{
    return m_providerHasBeenSet;
}

string UpdateInferenceModelResponse::GetDescription() const
{
    return m_description;
}

bool UpdateInferenceModelResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string UpdateInferenceModelResponse::GetModelType() const
{
    return m_modelType;
}

bool UpdateInferenceModelResponse::ModelTypeHasBeenSet() const
{
    return m_modelTypeHasBeenSet;
}

string UpdateInferenceModelResponse::GetParameterSize() const
{
    return m_parameterSize;
}

bool UpdateInferenceModelResponse::ParameterSizeHasBeenSet() const
{
    return m_parameterSizeHasBeenSet;
}

vector<string> UpdateInferenceModelResponse::GetTags() const
{
    return m_tags;
}

bool UpdateInferenceModelResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string UpdateInferenceModelResponse::GetLatestVersion() const
{
    return m_latestVersion;
}

bool UpdateInferenceModelResponse::LatestVersionHasBeenSet() const
{
    return m_latestVersionHasBeenSet;
}

int64_t UpdateInferenceModelResponse::GetVersionCount() const
{
    return m_versionCount;
}

bool UpdateInferenceModelResponse::VersionCountHasBeenSet() const
{
    return m_versionCountHasBeenSet;
}

int64_t UpdateInferenceModelResponse::GetServiceCount() const
{
    return m_serviceCount;
}

bool UpdateInferenceModelResponse::ServiceCountHasBeenSet() const
{
    return m_serviceCountHasBeenSet;
}

bool UpdateInferenceModelResponse::GetHasStorage() const
{
    return m_hasStorage;
}

bool UpdateInferenceModelResponse::HasStorageHasBeenSet() const
{
    return m_hasStorageHasBeenSet;
}

bool UpdateInferenceModelResponse::GetHasCustomStorage() const
{
    return m_hasCustomStorage;
}

bool UpdateInferenceModelResponse::HasCustomStorageHasBeenSet() const
{
    return m_hasCustomStorageHasBeenSet;
}

string UpdateInferenceModelResponse::GetStorageType() const
{
    return m_storageType;
}

bool UpdateInferenceModelResponse::StorageTypeHasBeenSet() const
{
    return m_storageTypeHasBeenSet;
}

bool UpdateInferenceModelResponse::GetBuiltIn() const
{
    return m_builtIn;
}

bool UpdateInferenceModelResponse::BuiltInHasBeenSet() const
{
    return m_builtInHasBeenSet;
}

vector<string> UpdateInferenceModelResponse::GetTasks() const
{
    return m_tasks;
}

bool UpdateInferenceModelResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

int64_t UpdateInferenceModelResponse::GetAppId() const
{
    return m_appId;
}

bool UpdateInferenceModelResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

int64_t UpdateInferenceModelResponse::GetCreateTime() const
{
    return m_createTime;
}

bool UpdateInferenceModelResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

int64_t UpdateInferenceModelResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool UpdateInferenceModelResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

string UpdateInferenceModelResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool UpdateInferenceModelResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

vector<Tag> UpdateInferenceModelResponse::GetResourceTags() const
{
    return m_resourceTags;
}

bool UpdateInferenceModelResponse::ResourceTagsHasBeenSet() const
{
