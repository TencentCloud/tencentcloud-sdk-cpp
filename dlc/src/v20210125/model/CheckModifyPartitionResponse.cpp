...
CheckModifyPartitionResponse::CheckModifyPartitionResponse() :
    m_canModifyHasBeenSet(false),
    m_messageListHasBeenSet(false)
{
}

CoreInternalOutcome CheckModifyPartitionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("CanModify") && !rsp["CanModify"].IsNull())
    {
        if (!rsp["CanModify"].IsBool())
        {
            return CoreInternalOutcome(Core::Error("response `CanModify` IsBool=false incorrectly").SetRequestId(requestId));
        }
        m_canModify = rsp["CanModify"].GetBool();
...
string CheckModifyPartitionResponse::ToJsonString() const
{
...
bool CheckModifyPartitionResponse::GetCanModify() const
{
    return m_canModify;
}

bool CheckModifyPartitionResponse::CanModifyHasBeenSet() const
{
    return m_canModifyHasBeenSet;
}

vector<MessageItem> CheckModifyPartitionResponse::GetMessageList() const
{
    return m_messageList;
}

bool CheckModifyPartitionResponse::MessageListHasBeenSet() const
{
