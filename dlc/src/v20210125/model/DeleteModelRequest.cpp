...
#include <tencentcloud/dlc/v20210125/model/DeleteModelRequest.h>
...
string DeleteModelRequest::GetModelUid() const
{
    return m_modelUid;
}

void DeleteModelRequest::SetModelUid(const string& _modelUid)
{
    m_modelUid = _modelUid;
    m_modelUidHasBeenSet = true;
}

bool DeleteModelRequest::ModelUidHasBeenSet() const
{
