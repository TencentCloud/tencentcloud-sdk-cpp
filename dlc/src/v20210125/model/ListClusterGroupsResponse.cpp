...
ListClusterGroupsResponse::ListClusterGroupsResponse() :
...
CoreInternalOutcome ListClusterGroupsResponse::Deserialize(const string &payload)
{
...
string ListClusterGroupsResponse::ToJsonString() const
{
...
int64_t ListClusterGroupsResponse::GetTotal() const
{
    return m_total;
}

bool ListClusterGroupsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListClusterGroupsResponse::GetPage() const
{
    return m_page;
}

bool ListClusterGroupsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListClusterGroupsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListClusterGroupsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListClusterGroupsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListClusterGroupsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ClusterGroup> ListClusterGroupsResponse::GetItems() const
{
    return m_items;
}

bool ListClusterGroupsResponse::ItemsHasBeenSet() const
{
