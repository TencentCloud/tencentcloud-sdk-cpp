...
string CreateMetaDatabaseResponse::GetBatchId() const
{
    return m_batchId;
}

bool CreateMetaDatabaseResponse::BatchIdHasBeenSet() const
{
    return m_batchIdHasBeenSet;
}

vector<string> CreateMetaDatabaseResponse::GetTaskIdSet() const
{
    return m_taskIdSet;
}

bool CreateMetaDatabaseResponse::TaskIdSetHasBeenSet() const
{
