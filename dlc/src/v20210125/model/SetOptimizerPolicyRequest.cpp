...
SetOptimizerPolicyRequest::SetOptimizerPolicyRequest() :
    m_smartPolicyHasBeenSet(false)
{
}

string SetOptimizerPolicyRequest::ToJsonString() const
{
...
SmartPolicy SetOptimizerPolicyRequest::GetSmartPolicy() const
{
    return m_smartPolicy;
}

void SetOptimizerPolicyRequest::SetSmartPolicy(const SmartPolicy& _smartPolicy)
{
    m_smartPolicy = _smartPolicy;
    m_smartPolicyHasBeenSet = true;
}

bool SetOptimizerPolicyRequest::SmartPolicyHasBeenSet() const
{
