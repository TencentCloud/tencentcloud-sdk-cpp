...
CoreInternalOutcome DescribeSparkSessionBatchSqlLogResponse::Deserialize(const string &payload)
{
...
string DescribeSparkSessionBatchSqlLogResponse::ToJsonString() const
{
    ...
    if (m_logSetHasBeenSet)
    {
        ...
        int i=0;
        for (auto itr = m_logSet.begin(); itr != m_logSet.end(); ++itr, ++i)
        {
...
uint64_t DescribeSparkSessionBatchSqlLogResponse::GetState() const
{
    return m_state;
}

bool DescribeSparkSessionBatchSqlLogResponse::StateHasBeenSet() const
{
    return m_stateHasBeenSet;
}

vector<SparkSessionBatchLog> DescribeSparkSessionBatchSqlLogResponse::GetLogSet() const
{
    return m_logSet;
}

bool DescribeSparkSessionBatchSqlLogResponse::LogSetHasBeenSet() const
{
