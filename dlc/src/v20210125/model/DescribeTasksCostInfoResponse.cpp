...
DescribeTasksCostInfoResponse::DescribeTasksCostInfoResponse() :
    m_searchAfterHasBeenSet(false),
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome DescribeTasksCostInfoResponse::Deserialize(const string &payload)
{
...
string DescribeTasksCostInfoResponse::ToJsonString() const
{
...
string DescribeTasksCostInfoResponse::GetSearchAfter() const
{
    return m_searchAfter;
}

bool DescribeTasksCostInfoResponse::SearchAfterHasBeenSet() const
{
    return m_searchAfterHasBeenSet;
}

string DescribeTasksCostInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeTasksCostInfoResponse::DataHasBeenSet() const
{
