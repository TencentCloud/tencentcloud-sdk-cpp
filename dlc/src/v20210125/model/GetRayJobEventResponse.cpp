...
GetRayJobEventResponse::GetRayJobEventResponse() :
...
CoreInternalOutcome GetRayJobEventResponse::Deserialize(const string &payload)
{
...
string GetRayJobEventResponse::ToJsonString() const
{
...
string GetRayJobEventResponse::GetContext() const
{
    return m_context;
}

bool GetRayJobEventResponse::ContextHasBeenSet() const
{
    return m_contextHasBeenSet;
}

bool GetRayJobEventResponse::GetListOver() const
{
    return m_listOver;
}

bool GetRayJobEventResponse::ListOverHasBeenSet() const
{
    return m_listOverHasBeenSet;
}

vector<RayJobEventItem> GetRayJobEventResponse::GetEvents() const
{
    return m_events;
}

bool GetRayJobEventResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

uint64_t GetRayJobEventResponse::GetStartTime() const
{
    return m_startTime;
}

bool GetRayJobEventResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

uint64_t GetRayJobEventResponse::GetEndTime() const
{
    return m_endTime;
}

bool GetRayJobEventResponse::EndTimeHasBeenSet() const
{
