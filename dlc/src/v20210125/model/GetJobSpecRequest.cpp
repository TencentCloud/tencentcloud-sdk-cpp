...
GetJobSpecRequest::GetJobSpecRequest() :
    m_specIdHasBeenSet(false)
{
}

string GetJobSpecRequest::ToJsonString() const
{
...
string GetJobSpecRequest::GetSpecId() const
{
    return m_specId;
}

void GetJobSpecRequest::SetSpecId(const string& _specId)
{
    m_specId = _specId;
    m_specIdHasBeenSet = true;
}

bool GetJobSpecRequest::SpecIdHasBeenSet() const
{
