...
string AttachWorkGroupPolicyRequest::ToJsonString() const
{
...
int64_t AttachWorkGroupPolicyRequest::GetWorkGroupId() const
{
    return m_workGroupId;
}

void AttachWorkGroupPolicyRequest::SetWorkGroupId(const int64_t& _workGroupId)
{
    m_workGroupId = _workGroupId;
    m_workGroupIdHasBeenSet = true;
}

bool AttachWorkGroupPolicyRequest::WorkGroupIdHasBeenSet() const
{
    return m_workGroupIdHasBeenSet;
}

vector<Policy> AttachWorkGroupPolicyRequest::GetPolicySet() const
{
    return m_policySet;
}

void AttachWorkGroupPolicyRequest::SetPolicySet(const vector<Policy>& _policySet)
{
    m_policySet = _policySet;
    m_policySetHasBeenSet = true;
}

bool AttachWorkGroupPolicyRequest::PolicySetHasBeenSet() const
{
