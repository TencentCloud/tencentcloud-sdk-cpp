...
CoreInternalOutcome ListExamplesResponse::Deserialize(const string &payload)
{
...
string ListExamplesResponse::ToJsonString() const
{
...
int64_t ListExamplesResponse::GetTotal() const
{
    return m_total;
}

bool ListExamplesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListExamplesResponse::GetPage() const
{
    return m_page;
}

bool ListExamplesResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListExamplesResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListExamplesResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListExamplesResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListExamplesResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ExampleEntity> ListExamplesResponse::GetItems() const
{
    return m_items;
}

bool ListExamplesResponse::ItemsHasBeenSet() const
{
