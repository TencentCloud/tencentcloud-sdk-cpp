...
string CreateTableRequest::ToJsonString() const
{
    ...
    if (m_tableInfoHasBeenSet)
    {
        ...
        m_tableInfo.ToJsonObject(d[key.c_str()], allocator);
    }
...
TableInfo CreateTableRequest::GetTableInfo() const
{
    return m_tableInfo;
}

void CreateTableRequest::SetTableInfo(const TableInfo& _tableInfo)
{
    m_tableInfo = _tableInfo;
    m_tableInfoHasBeenSet = true;
}

bool CreateTableRequest::TableInfoHasBeenSet() const
{
