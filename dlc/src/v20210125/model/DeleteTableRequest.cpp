...
TableBaseInfo DeleteTableRequest::GetTableBaseInfo() const
{
    return m_tableBaseInfo;
}

void DeleteTableRequest::SetTableBaseInfo(const TableBaseInfo& _tableBaseInfo)
{
    m_tableBaseInfo = _tableBaseInfo;
    m_tableBaseInfoHasBeenSet = true;
}

bool DeleteTableRequest::TableBaseInfoHasBeenSet() const
{
