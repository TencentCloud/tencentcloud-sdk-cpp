...
DescribeBindablePrometheusResponse::DescribeBindablePrometheusResponse() :
...
CoreInternalOutcome DescribeBindablePrometheusResponse::Deserialize(const string &payload)
{
...
string DescribeBindablePrometheusResponse::ToJsonString() const
{
...
bool DescribeBindablePrometheusResponse::GetBound() const
{
    return m_bound;
}

bool DescribeBindablePrometheusResponse::BoundHasBeenSet() const
{
    return m_boundHasBeenSet;
}

int64_t DescribeBindablePrometheusResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBindablePrometheusResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<PrometheusInstanceItem> DescribeBindablePrometheusResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeBindablePrometheusResponse::InstancesHasBeenSet() const
{
