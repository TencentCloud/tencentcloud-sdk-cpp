...
#include <tencentcloud/dlc/v20210125/model/BindApiKeyResponse.h>
...
BindApiKeyResponse::BindApiKeyResponse() :
    m_successListHasBeenSet(false),
    m_failedListHasBeenSet(false)
{
}

CoreInternalOutcome BindApiKeyResponse::Deserialize(const string &payload)
{
...
string BindApiKeyResponse::ToJsonString() const
{
...
vector<ApiKeyResponseInfo> BindApiKeyResponse::GetSuccessList() const
{
    return m_successList;
}

bool BindApiKeyResponse::SuccessListHasBeenSet() const
{
    return m_successListHasBeenSet;
}

vector<FailedItem> BindApiKeyResponse::GetFailedList() const
{
    return m_failedList;
}

bool BindApiKeyResponse::FailedListHasBeenSet() const
{
