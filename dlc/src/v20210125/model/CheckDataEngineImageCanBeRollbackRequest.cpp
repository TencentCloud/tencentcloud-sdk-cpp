...
string CheckDataEngineImageCanBeRollbackRequest::ToJsonString() const
{
...
string CheckDataEngineImageCanBeRollbackRequest::GetDataEngineId() const
{
    return m_dataEngineId;
}

void CheckDataEngineImageCanBeRollbackRequest::SetDataEngineId(const string& _dataEngineId)
{
    m_dataEngineId = _dataEngineId;
    m_dataEngineIdHasBeenSet = true;
}

bool CheckDataEngineImageCanBeRollbackRequest::DataEngineIdHasBeenSet() const
{
