...
CoreInternalOutcome CreatePartitionResponse::Deserialize(const string &payload)
{
...
string CreatePartitionResponse::ToJsonString() const
{
...
string CreatePartitionResponse::GetDealName() const
{
    return m_dealName;
}

bool CreatePartitionResponse::DealNameHasBeenSet() const
{
    return m_dealNameHasBeenSet;
}

string CreatePartitionResponse::GetBigDealId() const
{
    return m_bigDealId;
}
