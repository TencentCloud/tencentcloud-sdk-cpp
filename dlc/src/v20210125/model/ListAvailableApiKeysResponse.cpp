...
ListAvailableApiKeysResponse::ListAvailableApiKeysResponse() :
...
CoreInternalOutcome ListAvailableApiKeysResponse::Deserialize(const string &payload)
{
...
string ListAvailableApiKeysResponse::ToJsonString() const
{
...
uint64_t ListAvailableApiKeysResponse::GetTotal() const
{
    return m_total;
}

bool ListAvailableApiKeysResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

uint64_t ListAvailableApiKeysResponse::GetPage() const
{
    return m_page;
}

bool ListAvailableApiKeysResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

uint64_t ListAvailableApiKeysResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListAvailableApiKeysResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t ListAvailableApiKeysResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListAvailableApiKeysResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ApiKeyInfo> ListAvailableApiKeysResponse::GetItems() const
{
    return m_items;
}

bool ListAvailableApiKeysResponse::ItemsHasBeenSet() const
{
