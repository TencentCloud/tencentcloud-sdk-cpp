...
#include <tencentcloud/dlc/v20210125/model/CreateApiKeyResponse.h>
...
string CreateApiKeyResponse::GetApiKeyId() const
{
    return m_apiKeyId;
}

bool CreateApiKeyResponse::ApiKeyIdHasBeenSet() const
{
...
string CreateApiKeyResponse::GetServiceId() const
{
    return m_serviceId;
}

bool CreateApiKeyResponse::ServiceIdHasBeenSet() const
{
    return m_serviceIdHasBeenSet;
}

string CreateApiKeyResponse::GetServiceName() const
{
    return m_serviceName;
}

bool CreateApiKeyResponse::ServiceNameHasBeenSet() const
{
    return m_serviceNameHasBeenSet;
}

string CreateApiKeyResponse::GetStatus() const
{
    return m_status;
}

bool CreateApiKeyResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

int64_t CreateApiKeyResponse::GetAppId() const
{
    return m_appId;
}

bool CreateApiKeyResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string CreateApiKeyResponse::GetUin() const
{
    return m_uin;
}

bool CreateApiKeyResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

uint64_t CreateApiKeyResponse::GetCreateTime() const
{
    return m_createTime;
}

bool CreateApiKeyResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t CreateApiKeyResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool CreateApiKeyResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

string CreateApiKeyResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool CreateApiKeyResponse::SubAccountUinHasBeenSet() const
{
