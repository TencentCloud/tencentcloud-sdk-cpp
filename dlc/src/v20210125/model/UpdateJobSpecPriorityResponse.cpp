...
#include <tencentcloud/dlc/v20210125/model/UpdateJobSpecPriorityResponse.h>
...
UpdateJobSpecPriorityResponse::UpdateJobSpecPriorityResponse() :
...
CoreInternalOutcome UpdateJobSpecPriorityResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("JobPackageSource") && !rsp["JobPackageSource"].IsNull())
    {
        if (!rsp["JobPackageSource"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `JobPackageSource` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_jobPackageSource = string(rsp["JobPackageSource"].GetString());
...
string UpdateJobSpecPriorityResponse::ToJsonString() const
{
...
string UpdateJobSpecPriorityResponse::GetId() const
{
    return m_id;
}

bool UpdateJobSpecPriorityResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetName() const
{
    return m_name;
}

bool UpdateJobSpecPriorityResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetDescription() const
{
    return m_description;
}

bool UpdateJobSpecPriorityResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetEntrypoint() const
{
    return m_entrypoint;
}

bool UpdateJobSpecPriorityResponse::EntrypointHasBeenSet() const
{
    return m_entrypointHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetImage() const
{
    return m_image;
}

bool UpdateJobSpecPriorityResponse::ImageHasBeenSet() const
{
    return m_imageHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetImagePullType() const
{
    return m_imagePullType;
}

bool UpdateJobSpecPriorityResponse::ImagePullTypeHasBeenSet() const
{
    return m_imagePullTypeHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetImagePullPolicy() const
{
    return m_imagePullPolicy;
}

bool UpdateJobSpecPriorityResponse::ImagePullPolicyHasBeenSet() const
{
    return m_imagePullPolicyHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetResourceConfig() const
{
    return m_resourceConfig;
}

bool UpdateJobSpecPriorityResponse::ResourceConfigHasBeenSet() const
{
    return m_resourceConfigHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetRuntimeEnv() const
{
    return m_runtimeEnv;
}

bool UpdateJobSpecPriorityResponse::RuntimeEnvHasBeenSet() const
{
    return m_runtimeEnvHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetCatalog() const
{
    return m_catalog;
}

bool UpdateJobSpecPriorityResponse::CatalogHasBeenSet() const
{
    return m_catalogHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetAutoscalerOptions() const
{
    return m_autoscalerOptions;
}

bool UpdateJobSpecPriorityResponse::AutoscalerOptionsHasBeenSet() const
{
    return m_autoscalerOptionsHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetResourceConfigId() const
{
    return m_resourceConfigId;
}

bool UpdateJobSpecPriorityResponse::ResourceConfigIdHasBeenSet() const
{
    return m_resourceConfigIdHasBeenSet;
}

bool UpdateJobSpecPriorityResponse::GetResourceConfigChanged() const
{
    return m_resourceConfigChanged;
}

bool UpdateJobSpecPriorityResponse::ResourceConfigChangedHasBeenSet() const
{
    return m_resourceConfigChangedHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetResourcePartitionId() const
{
    return m_resourcePartitionId;
}

bool UpdateJobSpecPriorityResponse::ResourcePartitionIdHasBeenSet() const
{
    return m_resourcePartitionIdHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetResourcePartitionName() const
{
    return m_resourcePartitionName;
}

bool UpdateJobSpecPriorityResponse::ResourcePartitionNameHasBeenSet() const
{
    return m_resourcePartitionNameHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetQueue() const
{
    return m_queue;
}

bool UpdateJobSpecPriorityResponse::QueueHasBeenSet() const
{
    return m_queueHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetGroupId() const
{
    return m_groupId;
}

bool UpdateJobSpecPriorityResponse::GroupIdHasBeenSet() const
{
    return m_groupIdHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetClusterId() const
{
    return m_clusterId;
}

bool UpdateJobSpecPriorityResponse::ClusterIdHasBeenSet() const
{
    return m_clusterIdHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetDispatchStrategy() const
{
    return m_dispatchStrategy;
}

bool UpdateJobSpecPriorityResponse::DispatchStrategyHasBeenSet() const
{
    return m_dispatchStrategyHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetJobPackage() const
{
    return m_jobPackage;
}

bool UpdateJobSpecPriorityResponse::JobPackageHasBeenSet() const
{
    return m_jobPackageHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetJobPackageName() const
{
    return m_jobPackageName;
}

bool UpdateJobSpecPriorityResponse::JobPackageNameHasBeenSet() const
{
    return m_jobPackageNameHasBeenSet;
}

int64_t UpdateJobSpecPriorityResponse::GetPriority() const
{
    return m_priority;
}

bool UpdateJobSpecPriorityResponse::PriorityHasBeenSet() const
{
    return m_priorityHasBeenSet;
}

int64_t UpdateJobSpecPriorityResponse::GetAppId() const
{
    return m_appId;
}

bool UpdateJobSpecPriorityResponse::AppIdHasBeenSet() const
{
    return m_appIdHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetUin() const
{
    return m_uin;
}

bool UpdateJobSpecPriorityResponse::UinHasBeenSet() const
{
    return m_uinHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetSubAccountUin() const
{
    return m_subAccountUin;
}

bool UpdateJobSpecPriorityResponse::SubAccountUinHasBeenSet() const
{
    return m_subAccountUinHasBeenSet;
}

uint64_t UpdateJobSpecPriorityResponse::GetCreateTime() const
{
    return m_createTime;
}

bool UpdateJobSpecPriorityResponse::CreateTimeHasBeenSet() const
{
    return m_createTimeHasBeenSet;
}

uint64_t UpdateJobSpecPriorityResponse::GetUpdateTime() const
{
    return m_updateTime;
}

bool UpdateJobSpecPriorityResponse::UpdateTimeHasBeenSet() const
{
    return m_updateTimeHasBeenSet;
}

int64_t UpdateJobSpecPriorityResponse::GetJobInstanceCount() const
{
    return m_jobInstanceCount;
}

bool UpdateJobSpecPriorityResponse::JobInstanceCountHasBeenSet() const
{
    return m_jobInstanceCountHasBeenSet;
}

bool UpdateJobSpecPriorityResponse::GetHasRunningJobs() const
{
    return m_hasRunningJobs;
}

bool UpdateJobSpecPriorityResponse::HasRunningJobsHasBeenSet() const
{
    return m_hasRunningJobsHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetAdvancedOptions() const
{
    return m_advancedOptions;
}

bool UpdateJobSpecPriorityResponse::AdvancedOptionsHasBeenSet() const
{
    return m_advancedOptionsHasBeenSet;
}

vector<Tag> UpdateJobSpecPriorityResponse::GetTags() const
{
    return m_tags;
}

bool UpdateJobSpecPriorityResponse::TagsHasBeenSet() const
{
    return m_tagsHasBeenSet;
}

string UpdateJobSpecPriorityResponse::GetJobPackageSource() const
{
    return m_jobPackageSource;
}

bool UpdateJobSpecPriorityResponse::JobPackageSourceHasBeenSet() const
{
