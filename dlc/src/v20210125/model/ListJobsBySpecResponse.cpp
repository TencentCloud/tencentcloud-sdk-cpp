...
ListJobsBySpecResponse::ListJobsBySpecResponse() :
...
CoreInternalOutcome ListJobsBySpecResponse::Deserialize(const string &payload)
{
...
string ListJobsBySpecResponse::ToJsonString() const
{
...
int64_t ListJobsBySpecResponse::GetTotal() const
{
    return m_total;
}

bool ListJobsBySpecResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t ListJobsBySpecResponse::GetPage() const
{
    return m_page;
}

bool ListJobsBySpecResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t ListJobsBySpecResponse::GetPageSize() const
{
    return m_pageSize;
}

bool ListJobsBySpecResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t ListJobsBySpecResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool ListJobsBySpecResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<RayJobSubmitEntity> ListJobsBySpecResponse::GetItems() const
{
    return m_items;
}

bool ListJobsBySpecResponse::ItemsHasBeenSet() const
{
