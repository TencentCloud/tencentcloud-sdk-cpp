...
#include <tencentcloud/dlc/v20210125/model/GetLabPodsResponse.h>
...
GetLabPodsResponse::GetLabPodsResponse() :
...
CoreInternalOutcome GetLabPodsResponse::Deserialize(const string &payload)
{
...
string GetLabPodsResponse::ToJsonString() const
{
...
int64_t GetLabPodsResponse::GetTotal() const
{
    return m_total;
}

bool GetLabPodsResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t GetLabPodsResponse::GetPage() const
{
    return m_page;
}

bool GetLabPodsResponse::PageHasBeenSet() const
{
    return m_pageHasBeenSet;
}

int64_t GetLabPodsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool GetLabPodsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t GetLabPodsResponse::GetTotalPages() const
{
    return m_totalPages;
}

bool GetLabPodsResponse::TotalPagesHasBeenSet() const
{
    return m_totalPagesHasBeenSet;
}

vector<ClusterPod> GetLabPodsResponse::GetItems() const
{
    return m_items;
}

bool GetLabPodsResponse::ItemsHasBeenSet() const
{
