...
DeleteMetaDatabaseResponse::DeleteMetaDatabaseResponse() :
    m_batchIdHasBeenSet(false),
    m_taskIdSetHasBeenSet(false)
{
}

CoreInternalOutcome DeleteMetaDatabaseResponse::Deserialize(const string &payload)
{
...
string DeleteMetaDatabaseResponse::ToJsonString() const
{
...
string DeleteMetaDatabaseResponse::GetBatchId() const
{
    return m_batchId;
}

bool DeleteMetaDatabaseResponse::BatchIdHasBeenSet() const
{
    return m_batchIdHasBeenSet;
}

vector<string> DeleteMetaDatabaseResponse::GetTaskIdSet() const
{
    return m_taskIdSet;
}

bool DeleteMetaDatabaseResponse::TaskIdSetHasBeenSet() const
{
