...
string DeleteEmailAddressRequest::ToJsonString() const
{
...
string DeleteEmailAddressRequest::GetEmailAddress() const
{
    return m_emailAddress;
}

void DeleteEmailAddressRequest::SetEmailAddress(const string& _emailAddress)
{
    m_emailAddress = _emailAddress;
    m_emailAddressHasBeenSet = true;
}

bool DeleteEmailAddressRequest::EmailAddressHasBeenSet() const
{
