...
string DeleteCustomBlackListRequest::ToJsonString() const
{
...
vector<string> DeleteCustomBlackListRequest::GetEmails() const
{
    return m_emails;
}

void DeleteCustomBlackListRequest::SetEmails(const vector<string>& _emails)
{
    m_emails = _emails;
    m_emailsHasBeenSet = true;
}

bool DeleteCustomBlackListRequest::EmailsHasBeenSet() const
{
