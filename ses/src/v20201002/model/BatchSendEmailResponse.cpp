...
CoreInternalOutcome BatchSendEmailResponse::Deserialize(const string &payload)
{
...
string BatchSendEmailResponse::ToJsonString() const
{
...
uint64_t BatchSendEmailResponse::GetTaskId() const
{
    return m_taskId;
}

bool BatchSendEmailResponse::TaskIdHasBeenSet() const
{
