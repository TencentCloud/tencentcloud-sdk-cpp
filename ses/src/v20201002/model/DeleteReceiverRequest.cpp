...
string DeleteReceiverRequest::ToJsonString() const
{
...
uint64_t DeleteReceiverRequest::GetReceiverId() const
{
    return m_receiverId;
}

void DeleteReceiverRequest::SetReceiverId(const uint64_t& _receiverId)
{
    m_receiverId = _receiverId;
    m_receiverIdHasBeenSet = true;
}

bool DeleteReceiverRequest::ReceiverIdHasBeenSet() const
{
