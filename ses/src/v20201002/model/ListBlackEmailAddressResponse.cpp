...
CoreInternalOutcome ListBlackEmailAddressResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("BlackList") && !rsp["BlackList"].IsNull())
    {
        if (!rsp["BlackList"].IsArray())
            return CoreInternalOutcome(Core::Error("response `BlackList` is not array type"));
...
string ListBlackEmailAddressResponse::ToJsonString() const
{
...
vector<BlackEmailAddress> ListBlackEmailAddressResponse::GetBlackList() const
{
    return m_blackList;
}

bool ListBlackEmailAddressResponse::BlackListHasBeenSet() const
{
    return m_blackListHasBeenSet;
}

uint64_t ListBlackEmailAddressResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ListBlackEmailAddressResponse::TotalCountHasBeenSet() const
{
