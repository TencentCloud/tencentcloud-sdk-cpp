...
CoreInternalOutcome SendEmailResponse::Deserialize(const string &payload)
{
...
string SendEmailResponse::ToJsonString() const
{
...
string SendEmailResponse::GetMessageId() const
{
    return m_messageId;
}

bool SendEmailResponse::MessageIdHasBeenSet() const
{
