...
string GetEmailIdentityRequest::ToJsonString() const
{
...
string GetEmailIdentityRequest::GetEmailIdentity() const
{
    return m_emailIdentity;
}

void GetEmailIdentityRequest::SetEmailIdentity(const string& _emailIdentity)
{
    m_emailIdentity = _emailIdentity;
    m_emailIdentityHasBeenSet = true;
}

bool GetEmailIdentityRequest::EmailIdentityHasBeenSet() const
{
