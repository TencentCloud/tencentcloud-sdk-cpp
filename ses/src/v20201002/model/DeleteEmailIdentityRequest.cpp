...
string DeleteEmailIdentityRequest::ToJsonString() const
{
...
string DeleteEmailIdentityRequest::GetEmailIdentity() const
{
    return m_emailIdentity;
}

void DeleteEmailIdentityRequest::SetEmailIdentity(const string& _emailIdentity)
{
    m_emailIdentity = _emailIdentity;
    m_emailIdentityHasBeenSet = true;
}

bool DeleteEmailIdentityRequest::EmailIdentityHasBeenSet() const
{
