...
CoreInternalOutcome TagList::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("TagKey") && !value["TagKey"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TagList.TagKey` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TagValue") && !value["TagValue"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `TagList.TagValue` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string TagList::GetTagKey() const
{
    return m_tagKey;
}

void TagList::SetTagKey(const string& _tagKey)
{
    m_tagKey = _tagKey;
    m_tagKeyHasBeenSet = true;
}

bool TagList::TagKeyHasBeenSet() const
{
    return m_tagKeyHasBeenSet;
}

string TagList::GetTagValue() const
{
    return m_tagValue;
}

void TagList::SetTagValue(const string& _tagValue)
{
    m_tagValue = _tagValue;
    m_tagValueHasBeenSet = true;
}

bool TagList::TagValueHasBeenSet() const
{
