...
string CreateReceiverDetailRequest::ToJsonString() const
{
...
uint64_t CreateReceiverDetailRequest::GetReceiverId() const
{
    return m_receiverId;
}

void CreateReceiverDetailRequest::SetReceiverId(const uint64_t& _receiverId)
{
    m_receiverId = _receiverId;
    m_receiverIdHasBeenSet = true;
}

bool CreateReceiverDetailRequest::ReceiverIdHasBeenSet() const
{
    return m_receiverIdHasBeenSet;
}

vector<string> CreateReceiverDetailRequest::GetEmails() const
{
    return m_emails;
}

void CreateReceiverDetailRequest::SetEmails(const vector<string>& _emails)
{
    m_emails = _emails;
    m_emailsHasBeenSet = true;
}

bool CreateReceiverDetailRequest::EmailsHasBeenSet() const
{
