...
CoreInternalOutcome CreateEmailIdentityResponse::Deserialize(const string &payload)
{
...
string CreateEmailIdentityResponse::ToJsonString() const
{
...
string CreateEmailIdentityResponse::GetIdentityType() const
{
    return m_identityType;
}

bool CreateEmailIdentityResponse::IdentityTypeHasBeenSet() const
{
    return m_identityTypeHasBeenSet;
}

bool CreateEmailIdentityResponse::GetVerifiedForSendingStatus() const
{
    return m_verifiedForSendingStatus;
}

bool CreateEmailIdentityResponse::VerifiedForSendingStatusHasBeenSet() const
{
    return m_verifiedForSendingStatusHasBeenSet;
}

vector<DNSAttributes> CreateEmailIdentityResponse::GetAttributes() const
{
    return m_attributes;
}

bool CreateEmailIdentityResponse::AttributesHasBeenSet() const
{
    return m_attributesHasBeenSet;
}

uint64_t CreateEmailIdentityResponse::GetDKIMOption() const
{
    return m_dKIMOption;
}

bool CreateEmailIdentityResponse::DKIMOptionHasBeenSet() const
{
