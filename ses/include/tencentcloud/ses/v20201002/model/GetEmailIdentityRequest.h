...
#ifndef TENCENTCLOUD_SES_V20201002_MODEL_GETEMAILIDENTITYREQUEST_H_
#define TENCENTCLOUD_SES_V20201002_MODEL_GETEMAILIDENTITYREQUEST_H_
    ...
    namespace Ses
    {
        namespace V20201002
        {
            namespace Model
            {
                ...
                */
                class GetEmailIdentityRequest : public AbstractModel
                {
                public:
                    GetEmailIdentityRequest();
                    ~GetEmailIdentityRequest() = default;
...
#endif // !TENCENTCLOUD_SES_V20201002_MODEL_GETEMAILIDENTITYREQUEST_H_
