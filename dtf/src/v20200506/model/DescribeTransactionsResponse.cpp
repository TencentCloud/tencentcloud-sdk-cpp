...
CoreInternalOutcome DescribeTransactionsResponse::Deserialize(const string &payload)
{
...
string DescribeTransactionsResponse::ToJsonString() const
{
...
PagedTransaction DescribeTransactionsResponse::GetResult() const
{
    return m_result;
}

bool DescribeTransactionsResponse::ResultHasBeenSet() const
{
