...
#ifndef TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYLINKTACTICREQUEST_H_
#define TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYLINKTACTICREQUEST_H_
    ...
    namespace Hasim
    {
        namespace V20210716
        {
            namespace Model
            {
                ...
                */
                class ModifyLinkTacticRequest : public AbstractModel
                {
                public:
                    ModifyLinkTacticRequest();
                    ~ModifyLinkTacticRequest() = default;
...
#endif // !TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYLINKTACTICREQUEST_H_
