...
#ifndef TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYTACTICREQUEST_H_
#define TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYTACTICREQUEST_H_
    ...
    namespace Hasim
    {
        namespace V20210716
        {
            namespace Model
            {
                ...
                * ModifyTactic请求参数结构体
                */
                class ModifyTacticRequest : public AbstractModel
                {
                public:
                    ModifyTacticRequest();
                    ~ModifyTacticRequest() = default;
                    ...
                    /**
                     * 获取是否最优先信号选取策略
                     * @return IsBestSignal 是否最优先信号选取策略
                     * 
                     */
...
#endif // !TENCENTCLOUD_HASIM_V20210716_MODEL_MODIFYTACTICREQUEST_H_
