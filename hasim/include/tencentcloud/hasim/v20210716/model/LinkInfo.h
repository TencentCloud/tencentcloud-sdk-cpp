...
#ifndef TENCENTCLOUD_HASIM_V20210716_MODEL_LINKINFO_H_
#define TENCENTCLOUD_HASIM_V20210716_MODEL_LINKINFO_H_
    ...
    namespace Hasim
    {
        namespace V20210716
        {
            namespace Model
            {
                ...
                * 云兔连接基本信息
                */
                class LinkInfo : public AbstractModel
                {
                public:
                    LinkInfo();
                    ~LinkInfo() = default;
...
#endif // !TENCENTCLOUD_HASIM_V20210716_MODEL_LINKINFO_H_
