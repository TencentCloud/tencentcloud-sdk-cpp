...
CoreInternalOutcome DescribeLinksResponse::Deserialize(const string &payload)
{
...
string DescribeLinksResponse::ToJsonString() const
{
...
LinkInfos DescribeLinksResponse::GetData() const
{
    return m_data;
}

bool DescribeLinksResponse::DataHasBeenSet() const
{
