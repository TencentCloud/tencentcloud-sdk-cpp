...
CoreInternalOutcome DescribeLinkResponse::Deserialize(const string &payload)
{
...
string DescribeLinkResponse::ToJsonString() const
{
...
LinkDetailInfo DescribeLinkResponse::GetData() const
{
    return m_data;
}

bool DescribeLinkResponse::DataHasBeenSet() const
{
