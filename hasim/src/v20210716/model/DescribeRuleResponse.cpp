...
CoreInternalOutcome DescribeRuleResponse::Deserialize(const string &payload)
{
...
string DescribeRuleResponse::ToJsonString() const
{
...
RuleDetail DescribeRuleResponse::GetData() const
{
    return m_data;
}

bool DescribeRuleResponse::DataHasBeenSet() const
{
