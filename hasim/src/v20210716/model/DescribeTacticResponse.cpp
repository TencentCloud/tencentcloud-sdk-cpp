...
CoreInternalOutcome DescribeTacticResponse::Deserialize(const string &payload)
{
...
string DescribeTacticResponse::ToJsonString() const
{
...
Tactic DescribeTacticResponse::GetData() const
{
    return m_data;
}

bool DescribeTacticResponse::DataHasBeenSet() const
{
