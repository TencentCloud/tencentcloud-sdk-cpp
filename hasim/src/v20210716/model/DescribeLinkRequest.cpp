...
string DescribeLinkRequest::ToJsonString() const
{
...
int64_t DescribeLinkRequest::GetLinkID() const
{
    return m_linkID;
}

void DescribeLinkRequest::SetLinkID(const int64_t& _linkID)
{
    m_linkID = _linkID;
    m_linkIDHasBeenSet = true;
}

bool DescribeLinkRequest::LinkIDHasBeenSet() const
{
    return m_linkIDHasBeenSet;
}

string DescribeLinkRequest::GetUinAccount() const
{
    return m_uinAccount;
}

void DescribeLinkRequest::SetUinAccount(const string& _uinAccount)
{
    m_uinAccount = _uinAccount;
    m_uinAccountHasBeenSet = true;
}

bool DescribeLinkRequest::UinAccountHasBeenSet() const
{
