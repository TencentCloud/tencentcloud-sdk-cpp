...
string DescribeTacticRequest::ToJsonString() const
{
...
int64_t DescribeTacticRequest::GetTacticID() const
{
    return m_tacticID;
}

void DescribeTacticRequest::SetTacticID(const int64_t& _tacticID)
{
    m_tacticID = _tacticID;
    m_tacticIDHasBeenSet = true;
}

bool DescribeTacticRequest::TacticIDHasBeenSet() const
{
