...
CoreInternalOutcome DescribeTacticsResponse::Deserialize(const string &payload)
{
...
string DescribeTacticsResponse::ToJsonString() const
{
...
TacticInfos DescribeTacticsResponse::GetData() const
{
    return m_data;
}

bool DescribeTacticsResponse::DataHasBeenSet() const
{
