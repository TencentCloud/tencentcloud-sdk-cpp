    ...
    namespace Gse
    {
        namespace V20191112
        {
            ...
            public:
                ...
                typedef Outcome<Error, Model::DescribeAssetSystemsResponse> DescribeAssetSystemsOutcome;
                ...
                typedef Outcome<Error, Model::UpdateFleetNameResponse> UpdateFleetNameOutcome;
