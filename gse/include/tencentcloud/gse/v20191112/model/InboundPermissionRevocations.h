...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_INBOUNDPERMISSIONREVOCATIONS_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_INBOUNDPERMISSIONREVOCATIONS_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                * 需要移除的安全组
                */
                class InboundPermissionRevocations : public AbstractModel
                {
                public:
                    InboundPermissionRevocations();
                    ~InboundPermissionRevocations() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_INBOUNDPERMISSIONREVOCATIONS_H_
