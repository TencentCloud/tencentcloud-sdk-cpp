...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETATTRIBUTESRESPONSE_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETATTRIBUTESRESPONSE_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                */
                class DescribeFleetAttributesResponse : public AbstractModel
                {
                public:
                    DescribeFleetAttributesResponse();
                    ~DescribeFleetAttributesResponse() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETATTRIBUTESRESPONSE_H_
