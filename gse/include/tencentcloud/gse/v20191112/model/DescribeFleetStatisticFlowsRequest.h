...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETSTATISTICFLOWSREQUEST_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETSTATISTICFLOWSREQUEST_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                */
                class DescribeFleetStatisticFlowsRequest : public AbstractModel
                {
                public:
                    DescribeFleetStatisticFlowsRequest();
                    ~DescribeFleetStatisticFlowsRequest() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEFLEETSTATISTICFLOWSREQUEST_H_
