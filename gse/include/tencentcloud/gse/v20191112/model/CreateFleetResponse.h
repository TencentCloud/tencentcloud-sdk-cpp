...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_CREATEFLEETRESPONSE_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_CREATEFLEETRESPONSE_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                * CreateFleet返回参数结构体
                */
                class CreateFleetResponse : public AbstractModel
                {
                public:
                    CreateFleetResponse();
                    ~CreateFleetResponse() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_CREATEFLEETRESPONSE_H_
