...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEINSTANCESEXTENDREQUEST_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEINSTANCESEXTENDREQUEST_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                */
                class DescribeInstancesExtendRequest : public AbstractModel
                {
                public:
                    DescribeInstancesExtendRequest();
                    ~DescribeInstancesExtendRequest() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_DESCRIBEINSTANCESEXTENDREQUEST_H_
