...
#ifndef TENCENTCLOUD_GSE_V20191112_MODEL_STARTMATCHPLACEMENTREQUEST_H_
#define TENCENTCLOUD_GSE_V20191112_MODEL_STARTMATCHPLACEMENTREQUEST_H_
    ...
    namespace Gse
    {
        namespace V20191112
        {
            namespace Model
            {
                ...
                */
                class StartMatchPlacementRequest : public AbstractModel
                {
                public:
                    StartMatchPlacementRequest();
                    ~StartMatchPlacementRequest() = default;
...
#endif // !TENCENTCLOUD_GSE_V20191112_MODEL_STARTMATCHPLACEMENTREQUEST_H_
