...
string DescribeGameServerSessionPlacementRequest::ToJsonString() const
{
...
string DescribeGameServerSessionPlacementRequest::GetPlacementId() const
{
    return m_placementId;
}

void DescribeGameServerSessionPlacementRequest::SetPlacementId(const string& _placementId)
{
    m_placementId = _placementId;
    m_placementIdHasBeenSet = true;
}

bool DescribeGameServerSessionPlacementRequest::PlacementIdHasBeenSet() const
{
