...
string DescribeFleetUtilizationRequest::ToJsonString() const
{
...
vector<string> DescribeFleetUtilizationRequest::GetFleetIds() const
{
    return m_fleetIds;
}

void DescribeFleetUtilizationRequest::SetFleetIds(const vector<string>& _fleetIds)
{
    m_fleetIds = _fleetIds;
    m_fleetIdsHasBeenSet = true;
}

bool DescribeFleetUtilizationRequest::FleetIdsHasBeenSet() const
{
