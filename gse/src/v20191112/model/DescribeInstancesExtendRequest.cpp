...
string DescribeInstancesExtendRequest::ToJsonString() const
{
...
string DescribeInstancesExtendRequest::GetFleetId() const
{
    return m_fleetId;
}

void DescribeInstancesExtendRequest::SetFleetId(const string& _fleetId)
{
    m_fleetId = _fleetId;
    m_fleetIdHasBeenSet = true;
}

bool DescribeInstancesExtendRequest::FleetIdHasBeenSet() const
{
    return m_fleetIdHasBeenSet;
}

int64_t DescribeInstancesExtendRequest::GetOffset() const
{
    return m_offset;
}

void DescribeInstancesExtendRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeInstancesExtendRequest::OffsetHasBeenSet() const
{
    return m_offsetHasBeenSet;
}

int64_t DescribeInstancesExtendRequest::GetLimit() const
{
    return m_limit;
}

void DescribeInstancesExtendRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
