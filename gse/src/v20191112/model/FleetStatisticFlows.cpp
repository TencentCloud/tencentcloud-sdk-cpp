...
CoreInternalOutcome FleetStatisticFlows::Deserialize(const Value &value)
{
    string requestId = "";
...
void FleetStatisticFlows::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
