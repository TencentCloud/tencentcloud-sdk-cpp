...
string StopGameServerSessionPlacementRequest::ToJsonString() const
{
...
string StopGameServerSessionPlacementRequest::GetPlacementId() const
{
    return m_placementId;
}

void StopGameServerSessionPlacementRequest::SetPlacementId(const string& _placementId)
{
    m_placementId = _placementId;
    m_placementIdHasBeenSet = true;
}

bool StopGameServerSessionPlacementRequest::PlacementIdHasBeenSet() const
{
