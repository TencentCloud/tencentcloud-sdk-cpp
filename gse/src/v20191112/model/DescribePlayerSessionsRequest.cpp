...
string DescribePlayerSessionsRequest::ToJsonString() const
{
    ...
    if (m_playerSessionIdHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_playerSessionId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_playerSessionStatusFilterHasBeenSet)
    {
        ...
        iKey.SetString(key.c_str(), allocator);
        d.AddMember(iKey, Value(m_playerSessionStatusFilter.c_str(), allocator).Move(), allocator);
    }
