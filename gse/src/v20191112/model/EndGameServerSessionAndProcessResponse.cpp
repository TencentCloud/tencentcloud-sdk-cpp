...
CoreInternalOutcome EndGameServerSessionAndProcessResponse::Deserialize(const string &payload)
{
...
string EndGameServerSessionAndProcessResponse::ToJsonString() const
{
