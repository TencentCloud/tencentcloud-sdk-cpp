...
string DetachCcnInstancesRequest::ToJsonString() const
{
...
string DetachCcnInstancesRequest::GetFleetId() const
{
    return m_fleetId;
}

void DetachCcnInstancesRequest::SetFleetId(const string& _fleetId)
{
    m_fleetId = _fleetId;
    m_fleetIdHasBeenSet = true;
}

bool DetachCcnInstancesRequest::FleetIdHasBeenSet() const
{
