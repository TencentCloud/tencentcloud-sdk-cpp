...
CoreInternalOutcome FleetStatisticTimes::Deserialize(const Value &value)
{
    string requestId = "";
...
void FleetStatisticTimes::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
