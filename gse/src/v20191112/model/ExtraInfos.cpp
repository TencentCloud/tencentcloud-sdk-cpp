...
CoreInternalOutcome ExtraInfos::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void ExtraInfos::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
