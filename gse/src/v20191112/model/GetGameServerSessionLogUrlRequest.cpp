...
string GetGameServerSessionLogUrlRequest::ToJsonString() const
{
...
string GetGameServerSessionLogUrlRequest::GetGameServerSessionId() const
{
    return m_gameServerSessionId;
}

void GetGameServerSessionLogUrlRequest::SetGameServerSessionId(const string& _gameServerSessionId)
{
    m_gameServerSessionId = _gameServerSessionId;
    m_gameServerSessionIdHasBeenSet = true;
}

bool GetGameServerSessionLogUrlRequest::GameServerSessionIdHasBeenSet() const
{
