...
CoreInternalOutcome Alias::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("AliasId") && !value["AliasId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Alias.AliasId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AliasArn") && !value["AliasArn"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Alias.AliasArn` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RoutingStrategy") && !value["RoutingStrategy"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Alias.RoutingStrategy` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CreationTime") && !value["CreationTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Alias.CreationTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("LastUpdatedTime") && !value["LastUpdatedTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Alias.LastUpdatedTime` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void Alias::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
    ...
    if (m_aliasIdHasBeenSet)
    {
        ...
        value.AddMember(iKey, Value(m_aliasId.c_str(), allocator).Move(), allocator);
    }
    ...
    if (m_aliasArnHasBeenSet)
    {
        ...
        string key = "AliasArn";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, Value(m_aliasArn.c_str(), allocator).Move(), allocator);
    }
