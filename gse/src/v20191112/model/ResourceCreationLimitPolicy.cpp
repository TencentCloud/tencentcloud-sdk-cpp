...
CoreInternalOutcome ResourceCreationLimitPolicy::Deserialize(const Value &value)
{
    string requestId = "";
...
void ResourceCreationLimitPolicy::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
