...
CoreInternalOutcome DescribeInstancesExtendResponse::Deserialize(const string &payload)
{
...
string DescribeInstancesExtendResponse::ToJsonString() const
{
...
vector<InstanceExtend> DescribeInstancesExtendResponse::GetInstances() const
{
    return m_instances;
}

bool DescribeInstancesExtendResponse::InstancesHasBeenSet() const
{
    return m_instancesHasBeenSet;
}

int64_t DescribeInstancesExtendResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeInstancesExtendResponse::TotalCountHasBeenSet() const
{
