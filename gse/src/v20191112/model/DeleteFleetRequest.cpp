...
string DeleteFleetRequest::ToJsonString() const
{
...
string DeleteFleetRequest::GetFleetId() const
{
    return m_fleetId;
}

void DeleteFleetRequest::SetFleetId(const string& _fleetId)
{
    m_fleetId = _fleetId;
    m_fleetIdHasBeenSet = true;
}

bool DeleteFleetRequest::FleetIdHasBeenSet() const
{
