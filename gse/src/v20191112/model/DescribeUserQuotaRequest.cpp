...
uint64_t DescribeUserQuotaRequest::GetResourceType() const
{
    return m_resourceType;
}

void DescribeUserQuotaRequest::SetResourceType(const uint64_t& _resourceType)
{
    m_resourceType = _resourceType;
    m_resourceTypeHasBeenSet = true;
}

bool DescribeUserQuotaRequest::ResourceTypeHasBeenSet() const
{
