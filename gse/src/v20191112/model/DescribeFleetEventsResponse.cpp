...
CoreInternalOutcome DescribeFleetEventsResponse::Deserialize(const string &payload)
{
...
string DescribeFleetEventsResponse::ToJsonString() const
{
...
vector<Event> DescribeFleetEventsResponse::GetEvents() const
{
    return m_events;
}

bool DescribeFleetEventsResponse::EventsHasBeenSet() const
{
    return m_eventsHasBeenSet;
}

uint64_t DescribeFleetEventsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeFleetEventsResponse::TotalCountHasBeenSet() const
{
