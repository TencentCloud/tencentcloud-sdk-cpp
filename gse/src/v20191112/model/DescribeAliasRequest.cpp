...
string DescribeAliasRequest::ToJsonString() const
{
...
string DescribeAliasRequest::GetAliasId() const
{
    return m_aliasId;
}

void DescribeAliasRequest::SetAliasId(const string& _aliasId)
{
    m_aliasId = _aliasId;
    m_aliasIdHasBeenSet = true;
}

bool DescribeAliasRequest::AliasIdHasBeenSet() const
{
