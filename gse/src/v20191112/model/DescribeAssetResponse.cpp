...
CoreInternalOutcome DescribeAssetResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Asset") && !rsp["Asset"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `Asset` is not object type").SetRequestId(requestId));
        }
...
string DescribeAssetResponse::ToJsonString() const
{
...
Asset DescribeAssetResponse::GetAsset() const
{
    return m_asset;
}

bool DescribeAssetResponse::AssetHasBeenSet() const
{
