...
string DescribeInstancesRequest::GetFleetId() const
{
    return m_fleetId;
}

void DescribeInstancesRequest::SetFleetId(const string& _fleetId)
{
    m_fleetId = _fleetId;
    m_fleetIdHasBeenSet = true;
}

bool DescribeInstancesRequest::FleetIdHasBeenSet() const
{
