...
CoreInternalOutcome FleetRelatedResource::Deserialize(const Value &value)
{
    string requestId = "";
...
void FleetRelatedResource::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
