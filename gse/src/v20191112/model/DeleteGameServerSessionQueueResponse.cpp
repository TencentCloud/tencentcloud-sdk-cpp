...
CoreInternalOutcome DeleteGameServerSessionQueueResponse::Deserialize(const string &payload)
{
...
string DeleteGameServerSessionQueueResponse::ToJsonString() const
{
