...
CoreInternalOutcome DescribeInstanceLimitResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ExtraInfos") && !rsp["ExtraInfos"].IsNull())
    {
        if (!rsp["ExtraInfos"].IsArray())
            return CoreInternalOutcome(Error("response `ExtraInfos` is not array type"));
...
string DescribeInstanceLimitResponse::ToJsonString() const
{
...
int64_t DescribeInstanceLimitResponse::GetLimit() const
{
    return m_limit;
}

bool DescribeInstanceLimitResponse::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

vector<ExtraInfos> DescribeInstanceLimitResponse::GetExtraInfos() const
{
    return m_extraInfos;
}

bool DescribeInstanceLimitResponse::ExtraInfosHasBeenSet() const
{
