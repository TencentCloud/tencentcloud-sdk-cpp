...
#ifndef TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBECAMERASREQUEST_H_
#define TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBECAMERASREQUEST_H_
    ...
    namespace Ump
    {
        namespace V20200918
        {
            namespace Model
            {
                ...
                */
                class DescribeCamerasRequest : public AbstractModel
                {
                public:
                    DescribeCamerasRequest();
                    ~DescribeCamerasRequest() = default;
...
#endif // !TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBECAMERASREQUEST_H_
