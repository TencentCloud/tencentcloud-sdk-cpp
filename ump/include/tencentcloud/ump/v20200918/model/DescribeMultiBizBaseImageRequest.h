...
#ifndef TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBEMULTIBIZBASEIMAGEREQUEST_H_
#define TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBEMULTIBIZBASEIMAGEREQUEST_H_
    ...
    namespace Ump
    {
        namespace V20200918
        {
            namespace Model
            {
                ...
                */
                class DescribeMultiBizBaseImageRequest : public AbstractModel
                {
                public:
                    DescribeMultiBizBaseImageRequest();
                    ~DescribeMultiBizBaseImageRequest() = default;
...
#endif // !TENCENTCLOUD_UMP_V20200918_MODEL_DESCRIBEMULTIBIZBASEIMAGEREQUEST_H_
