...
string DescribeZonesRequest::GetGroupCode() const
{
    return m_groupCode;
}

void DescribeZonesRequest::SetGroupCode(const string& _groupCode)
{
    m_groupCode = _groupCode;
    m_groupCodeHasBeenSet = true;
}

bool DescribeZonesRequest::GroupCodeHasBeenSet() const
{
    return m_groupCodeHasBeenSet;
}

uint64_t DescribeZonesRequest::GetMallId() const
{
    return m_mallId;
}

void DescribeZonesRequest::SetMallId(const uint64_t& _mallId)
{
    m_mallId = _mallId;
    m_mallIdHasBeenSet = true;
}

bool DescribeZonesRequest::MallIdHasBeenSet() const
{
