...
string CreateCaptureRequest::ToJsonString() const
{
...
string CreateCaptureRequest::GetData() const
{
    return m_data;
}

void CreateCaptureRequest::SetData(const string& _data)
{
    m_data = _data;
    m_dataHasBeenSet = true;
}

bool CreateCaptureRequest::DataHasBeenSet() const
{
