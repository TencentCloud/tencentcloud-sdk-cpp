...
CoreInternalOutcome DescribeMultiBizBaseImageResponse::Deserialize(const string &payload)
{
...
string DescribeMultiBizBaseImageResponse::ToJsonString() const
{
...
string DescribeMultiBizBaseImageResponse::GetImageUrl() const
{
    return m_imageUrl;
}

bool DescribeMultiBizBaseImageResponse::ImageUrlHasBeenSet() const
{
