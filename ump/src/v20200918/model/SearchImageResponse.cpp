...
string SearchImageResponse::GetFaceId() const
{
    return m_faceId;
}

bool SearchImageResponse::FaceIdHasBeenSet() const
{
    return m_faceIdHasBeenSet;
}

vector<SearchResult> SearchImageResponse::GetResults() const
{
    return m_results;
}

bool SearchImageResponse::ResultsHasBeenSet() const
{
