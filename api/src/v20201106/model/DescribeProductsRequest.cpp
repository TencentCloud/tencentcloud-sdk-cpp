...
int64_t DescribeProductsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeProductsRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
...
int64_t DescribeProductsRequest::GetOffset() const
{
    return m_offset;
}

void DescribeProductsRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
