...
CoreInternalOutcome ExportVulDetectionReportResponse::Deserialize(const string &payload)
{
...
string ExportVulDetectionReportResponse::ToJsonString() const
{
...
string ExportVulDetectionReportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportVulDetectionReportResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportVulDetectionReportResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportVulDetectionReportResponse::TaskIdHasBeenSet() const
{
