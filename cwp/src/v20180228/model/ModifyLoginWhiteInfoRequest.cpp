...
string ModifyLoginWhiteInfoRequest::ToJsonString() const
{
...
UpdateHostLoginWhiteObj ModifyLoginWhiteInfoRequest::GetHostLoginWhiteObj() const
{
    return m_hostLoginWhiteObj;
}

void ModifyLoginWhiteInfoRequest::SetHostLoginWhiteObj(const UpdateHostLoginWhiteObj& _hostLoginWhiteObj)
{
    m_hostLoginWhiteObj = _hostLoginWhiteObj;
    m_hostLoginWhiteObjHasBeenSet = true;
}

bool ModifyLoginWhiteInfoRequest::HostLoginWhiteObjHasBeenSet() const
{
