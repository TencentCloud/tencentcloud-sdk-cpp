...
CoreInternalOutcome DescribeMachinesSimpleResponse::Deserialize(const string &payload)
{
...
string DescribeMachinesSimpleResponse::ToJsonString() const
{
...
vector<MachineSimple> DescribeMachinesSimpleResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeMachinesSimpleResponse::MachinesHasBeenSet() const
{
    return m_machinesHasBeenSet;
}

uint64_t DescribeMachinesSimpleResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMachinesSimpleResponse::TotalCountHasBeenSet() const
{
