...
CoreInternalOutcome DescribeVulDefenceOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeVulDefenceOverviewResponse::ToJsonString() const
{
...
VulDefenceOverview DescribeVulDefenceOverviewResponse::GetOverview() const
{
    return m_overview;
}

bool DescribeVulDefenceOverviewResponse::OverviewHasBeenSet() const
{
