...
string ExportSecurityTrendsRequest::ToJsonString() const
{
...
string ExportSecurityTrendsRequest::GetBeginDate() const
{
    return m_beginDate;
}

void ExportSecurityTrendsRequest::SetBeginDate(const string& _beginDate)
{
    m_beginDate = _beginDate;
    m_beginDateHasBeenSet = true;
}

bool ExportSecurityTrendsRequest::BeginDateHasBeenSet() const
{
    return m_beginDateHasBeenSet;
}

string ExportSecurityTrendsRequest::GetEndDate() const
{
    return m_endDate;
}

void ExportSecurityTrendsRequest::SetEndDate(const string& _endDate)
{
    m_endDate = _endDate;
    m_endDateHasBeenSet = true;
}

bool ExportSecurityTrendsRequest::EndDateHasBeenSet() const
{
