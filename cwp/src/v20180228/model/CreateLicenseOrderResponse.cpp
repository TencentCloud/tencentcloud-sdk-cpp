...
CoreInternalOutcome CreateLicenseOrderResponse::Deserialize(const string &payload)
{
...
string CreateLicenseOrderResponse::ToJsonString() const
{
...
vector<string> CreateLicenseOrderResponse::GetDealNames() const
{
    return m_dealNames;
}

bool CreateLicenseOrderResponse::DealNamesHasBeenSet() const
{
    return m_dealNamesHasBeenSet;
}

vector<string> CreateLicenseOrderResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateLicenseOrderResponse::ResourceIdsHasBeenSet() const
{
    return m_resourceIdsHasBeenSet;
}

string CreateLicenseOrderResponse::GetBigDealId() const
{
    return m_bigDealId;
}

bool CreateLicenseOrderResponse::BigDealIdHasBeenSet() const
{
