...
CoreInternalOutcome ModifyMaliciousRequestWhiteListResponse::Deserialize(const string &payload)
{
...
string ModifyMaliciousRequestWhiteListResponse::ToJsonString() const
{
