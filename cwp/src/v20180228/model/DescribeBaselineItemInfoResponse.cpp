...
CoreInternalOutcome DescribeBaselineItemInfoResponse::Deserialize(const string &payload)
{
...
string DescribeBaselineItemInfoResponse::ToJsonString() const
{
...
vector<BaselineItemInfo> DescribeBaselineItemInfoResponse::GetList() const
{
    return m_list;
}

bool DescribeBaselineItemInfoResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

int64_t DescribeBaselineItemInfoResponse::GetTotal() const
{
    return m_total;
}
