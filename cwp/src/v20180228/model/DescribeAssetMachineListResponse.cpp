...
CoreInternalOutcome DescribeAssetMachineListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetMachineListResponse::ToJsonString() const
{
...
uint64_t DescribeAssetMachineListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetMachineListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AssetMachineBaseInfo> DescribeAssetMachineListResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeAssetMachineListResponse::MachinesHasBeenSet() const
{
