...
CoreInternalOutcome DescribeMaliciousRequestsResponse::Deserialize(const string &payload)
{
    Document d;
...
uint64_t DescribeMaliciousRequestsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMaliciousRequestsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<MaliciousRequest> DescribeMaliciousRequestsResponse::GetMaliciousRequests() const
{
    return m_maliciousRequests;
}

bool DescribeMaliciousRequestsResponse::MaliciousRequestsHasBeenSet() const
{
