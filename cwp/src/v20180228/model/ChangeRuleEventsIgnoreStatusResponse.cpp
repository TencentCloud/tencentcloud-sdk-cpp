...
CoreInternalOutcome ChangeRuleEventsIgnoreStatusResponse::Deserialize(const string &payload)
{
...
string ChangeRuleEventsIgnoreStatusResponse::ToJsonString() const
{
