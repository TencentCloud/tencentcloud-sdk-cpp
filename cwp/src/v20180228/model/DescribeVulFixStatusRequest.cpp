...
uint64_t DescribeVulFixStatusRequest::GetKbId() const
{
    return m_kbId;
}

void DescribeVulFixStatusRequest::SetKbId(const uint64_t& _kbId)
{
    m_kbId = _kbId;
    m_kbIdHasBeenSet = true;
}

bool DescribeVulFixStatusRequest::KbIdHasBeenSet() const
{
