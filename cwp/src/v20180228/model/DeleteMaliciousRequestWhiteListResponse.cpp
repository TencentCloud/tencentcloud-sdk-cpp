...
CoreInternalOutcome DeleteMaliciousRequestWhiteListResponse::Deserialize(const string &payload)
{
...
string DeleteMaliciousRequestWhiteListResponse::ToJsonString() const
{
