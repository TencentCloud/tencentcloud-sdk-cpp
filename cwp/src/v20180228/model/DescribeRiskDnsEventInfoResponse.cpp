...
CoreInternalOutcome DescribeRiskDnsEventInfoResponse::Deserialize(const string &payload)
{
...
string DescribeRiskDnsEventInfoResponse::ToJsonString() const
{
...
RiskDnsEvent DescribeRiskDnsEventInfoResponse::GetInfo() const
{
    return m_info;
}

bool DescribeRiskDnsEventInfoResponse::InfoHasBeenSet() const
{
