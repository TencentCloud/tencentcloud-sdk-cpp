...
CoreInternalOutcome ExportSecurityTrendsResponse::Deserialize(const string &payload)
{
...
string ExportSecurityTrendsResponse::ToJsonString() const
{
...
string ExportSecurityTrendsResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportSecurityTrendsResponse::DownloadUrlHasBeenSet() const
{
