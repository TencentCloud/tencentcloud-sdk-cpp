...
CoreInternalOutcome RaspEventOverviewResponse::Deserialize(const string &payload)
{
...
string RaspEventOverviewResponse::ToJsonString() const
{
...
RaspEventOverview RaspEventOverviewResponse::GetOverview() const
{
    return m_overview;
}

bool RaspEventOverviewResponse::OverviewHasBeenSet() const
{
