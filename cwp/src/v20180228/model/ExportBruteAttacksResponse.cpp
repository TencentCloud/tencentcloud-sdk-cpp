...
CoreInternalOutcome ExportBruteAttacksResponse::Deserialize(const string &payload)
{
...
string ExportBruteAttacksResponse::ToJsonString() const
{
...
string ExportBruteAttacksResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBruteAttacksResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBruteAttacksResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBruteAttacksResponse::TaskIdHasBeenSet() const
{
