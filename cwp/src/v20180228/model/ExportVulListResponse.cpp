...
CoreInternalOutcome ExportVulListResponse::Deserialize(const string &payload)
{
...
string ExportVulListResponse::ToJsonString() const
{
...
string ExportVulListResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportVulListResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportVulListResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportVulListResponse::TaskIdHasBeenSet() const
{
