...
CoreInternalOutcome ModifyAutoOpenProVersionConfigResponse::Deserialize(const string &payload)
{
...
string ModifyAutoOpenProVersionConfigResponse::ToJsonString() const
{
