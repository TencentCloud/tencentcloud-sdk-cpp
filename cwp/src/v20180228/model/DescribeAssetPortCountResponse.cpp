...
CoreInternalOutcome DescribeAssetPortCountResponse::Deserialize(const string &payload)
{
...
string DescribeAssetPortCountResponse::ToJsonString() const
{
...
vector<AssetKeyVal> DescribeAssetPortCountResponse::GetPorts() const
{
    return m_ports;
}

bool DescribeAssetPortCountResponse::PortsHasBeenSet() const
{
