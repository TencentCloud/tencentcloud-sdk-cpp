...
CoreInternalOutcome DescribeAssetPlanTaskListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetPlanTaskListResponse::ToJsonString() const
{
...
vector<AssetPlanTask> DescribeAssetPlanTaskListResponse::GetTasks() const
{
    return m_tasks;
}

bool DescribeAssetPlanTaskListResponse::TasksHasBeenSet() const
{
    return m_tasksHasBeenSet;
}

uint64_t DescribeAssetPlanTaskListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetPlanTaskListResponse::TotalHasBeenSet() const
{
