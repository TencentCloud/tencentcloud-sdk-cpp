...
CoreInternalOutcome ExportBaselineListResponse::Deserialize(const string &payload)
{
...
string ExportBaselineListResponse::ToJsonString() const
{
...
string ExportBaselineListResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBaselineListResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBaselineListResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBaselineListResponse::TaskIdHasBeenSet() const
{
