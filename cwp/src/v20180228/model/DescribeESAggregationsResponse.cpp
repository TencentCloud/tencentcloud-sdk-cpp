...
CoreInternalOutcome DescribeESAggregationsResponse::Deserialize(const string &payload)
{
...
string DescribeESAggregationsResponse::ToJsonString() const
{
...
string DescribeESAggregationsResponse::GetData() const
{
    return m_data;
}

bool DescribeESAggregationsResponse::DataHasBeenSet() const
{
