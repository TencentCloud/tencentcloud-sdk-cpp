...
CoreInternalOutcome DescribeRaspMemShellDetailTCSSResponse::Deserialize(const string &payload)
{
...
string DescribeRaspMemShellDetailTCSSResponse::ToJsonString() const
{
...
RaspMemShellDetail DescribeRaspMemShellDetailTCSSResponse::GetData() const
{
    return m_data;
}

bool DescribeRaspMemShellDetailTCSSResponse::DataHasBeenSet() const
{
