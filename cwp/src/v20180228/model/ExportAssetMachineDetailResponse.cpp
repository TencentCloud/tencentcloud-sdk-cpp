...
CoreInternalOutcome ExportAssetMachineDetailResponse::Deserialize(const string &payload)
{
...
string ExportAssetMachineDetailResponse::ToJsonString() const
{
...
string ExportAssetMachineDetailResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportAssetMachineDetailResponse::DownloadUrlHasBeenSet() const
{
