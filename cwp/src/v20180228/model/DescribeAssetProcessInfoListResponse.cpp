...
CoreInternalOutcome DescribeAssetProcessInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetProcessInfoListResponse::ToJsonString() const
{
...
uint64_t DescribeAssetProcessInfoListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetProcessInfoListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AssetProcessBaseInfo> DescribeAssetProcessInfoListResponse::GetProcess() const
{
    return m_process;
}

bool DescribeAssetProcessInfoListResponse::ProcessHasBeenSet() const
{
