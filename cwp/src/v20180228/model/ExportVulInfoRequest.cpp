...
string ExportVulInfoRequest::ToJsonString() const
{
...
uint64_t ExportVulInfoRequest::GetVulId() const
{
    return m_vulId;
}

void ExportVulInfoRequest::SetVulId(const uint64_t& _vulId)
{
    m_vulId = _vulId;
    m_vulIdHasBeenSet = true;
}

bool ExportVulInfoRequest::VulIdHasBeenSet() const
{
