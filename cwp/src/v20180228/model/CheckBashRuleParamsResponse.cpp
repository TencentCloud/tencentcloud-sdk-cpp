...
CoreInternalOutcome CheckBashRuleParamsResponse::Deserialize(const string &payload)
{
...
string CheckBashRuleParamsResponse::ToJsonString() const
{
...
uint64_t CheckBashRuleParamsResponse::GetErrCode() const
{
    return m_errCode;
}

bool CheckBashRuleParamsResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CheckBashRuleParamsResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool CheckBashRuleParamsResponse::ErrMsgHasBeenSet() const
{
