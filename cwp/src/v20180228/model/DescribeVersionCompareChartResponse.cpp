...
CoreInternalOutcome DescribeVersionCompareChartResponse::Deserialize(const string &payload)
{
...
string DescribeVersionCompareChartResponse::ToJsonString() const
{
...
string DescribeVersionCompareChartResponse::GetData() const
{
    return m_data;
}

bool DescribeVersionCompareChartResponse::DataHasBeenSet() const
{
