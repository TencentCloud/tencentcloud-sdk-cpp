...
string DescribeScanTaskStatusRequest::GetModuleType() const
{
    return m_moduleType;
}

void DescribeScanTaskStatusRequest::SetModuleType(const string& _moduleType)
{
    m_moduleType = _moduleType;
    m_moduleTypeHasBeenSet = true;
}

bool DescribeScanTaskStatusRequest::ModuleTypeHasBeenSet() const
{
