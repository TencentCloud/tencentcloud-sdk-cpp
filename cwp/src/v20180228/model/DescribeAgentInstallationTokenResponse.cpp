...
CoreInternalOutcome DescribeAgentInstallationTokenResponse::Deserialize(const string &payload)
{
...
string DescribeAgentInstallationTokenResponse::ToJsonString() const
{
...
string DescribeAgentInstallationTokenResponse::GetToken() const
{
    return m_token;
}

bool DescribeAgentInstallationTokenResponse::TokenHasBeenSet() const
{
