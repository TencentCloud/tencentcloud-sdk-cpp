...
CoreInternalOutcome DescribeScreenMachineRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeScreenMachineRegionsResponse::ToJsonString() const
{
...
vector<ScreenRegionInfo> DescribeScreenMachineRegionsResponse::GetList() const
{
    return m_list;
}

bool DescribeScreenMachineRegionsResponse::ListHasBeenSet() const
{
