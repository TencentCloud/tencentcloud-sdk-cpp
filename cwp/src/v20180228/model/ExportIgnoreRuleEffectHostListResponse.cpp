...
CoreInternalOutcome ExportIgnoreRuleEffectHostListResponse::Deserialize(const string &payload)
{
...
string ExportIgnoreRuleEffectHostListResponse::ToJsonString() const
{
...
string ExportIgnoreRuleEffectHostListResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportIgnoreRuleEffectHostListResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportIgnoreRuleEffectHostListResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportIgnoreRuleEffectHostListResponse::TaskIdHasBeenSet() const
{
