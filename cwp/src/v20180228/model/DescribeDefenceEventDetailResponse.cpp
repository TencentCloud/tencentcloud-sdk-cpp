...
CoreInternalOutcome DescribeDefenceEventDetailResponse::Deserialize(const string &payload)
{
...
string DescribeDefenceEventDetailResponse::ToJsonString() const
{
...
VulDefenceEventDetail DescribeDefenceEventDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeDefenceEventDetailResponse::DataHasBeenSet() const
{
