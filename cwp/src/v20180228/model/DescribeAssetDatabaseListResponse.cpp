...
CoreInternalOutcome DescribeAssetDatabaseListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetDatabaseListResponse::ToJsonString() const
{
...
vector<AssetDatabaseBaseInfo> DescribeAssetDatabaseListResponse::GetDatabases() const
{
    return m_databases;
}

bool DescribeAssetDatabaseListResponse::DatabasesHasBeenSet() const
{
    return m_databasesHasBeenSet;
}

uint64_t DescribeAssetDatabaseListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetDatabaseListResponse::TotalHasBeenSet() const
{
