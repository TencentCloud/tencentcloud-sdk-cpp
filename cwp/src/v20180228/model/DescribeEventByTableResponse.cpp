...
CoreInternalOutcome DescribeEventByTableResponse::Deserialize(const string &payload)
{
...
string DescribeEventByTableResponse::ToJsonString() const
{
...
string DescribeEventByTableResponse::GetType() const
{
    return m_type;
}

bool DescribeEventByTableResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string DescribeEventByTableResponse::GetValue() const
{
    return m_value;
}

bool DescribeEventByTableResponse::ValueHasBeenSet() const
{
