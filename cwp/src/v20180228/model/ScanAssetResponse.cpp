...
CoreInternalOutcome ScanAssetResponse::Deserialize(const string &payload)
{
...
string ScanAssetResponse::ToJsonString() const
{
...
uint64_t ScanAssetResponse::GetTaskId() const
{
    return m_taskId;
}

bool ScanAssetResponse::TaskIdHasBeenSet() const
{
