...
string DescribeMachineInfoRequest::ToJsonString() const
{
...
string DescribeMachineInfoRequest::GetUuid() const
{
    return m_uuid;
}

void DescribeMachineInfoRequest::SetUuid(const string& _uuid)
{
    m_uuid = _uuid;
