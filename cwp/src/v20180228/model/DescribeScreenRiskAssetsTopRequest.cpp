...
string DescribeScreenRiskAssetsTopRequest::ToJsonString() const
{
...
uint64_t DescribeScreenRiskAssetsTopRequest::GetBusinessType() const
{
    return m_businessType;
}

void DescribeScreenRiskAssetsTopRequest::SetBusinessType(const uint64_t& _businessType)
{
    m_businessType = _businessType;
    m_businessTypeHasBeenSet = true;
}

bool DescribeScreenRiskAssetsTopRequest::BusinessTypeHasBeenSet() const
{
