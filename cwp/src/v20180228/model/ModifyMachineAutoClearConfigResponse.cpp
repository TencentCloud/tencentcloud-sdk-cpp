...
CoreInternalOutcome ModifyMachineAutoClearConfigResponse::Deserialize(const string &payload)
{
...
string ModifyMachineAutoClearConfigResponse::ToJsonString() const
{
