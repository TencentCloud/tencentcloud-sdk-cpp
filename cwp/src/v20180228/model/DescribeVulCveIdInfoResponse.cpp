...
CoreInternalOutcome DescribeVulCveIdInfoResponse::Deserialize(const string &payload)
{
...
string DescribeVulCveIdInfoResponse::ToJsonString() const
{
...
vector<VulInfoByCveId> DescribeVulCveIdInfoResponse::GetList() const
{
    return m_list;
}

bool DescribeVulCveIdInfoResponse::ListHasBeenSet() const
{
