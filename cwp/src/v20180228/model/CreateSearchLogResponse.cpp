...
CoreInternalOutcome CreateSearchLogResponse::Deserialize(const string &payload)
{
...
string CreateSearchLogResponse::ToJsonString() const
{
...
uint64_t CreateSearchLogResponse::GetStatus() const
{
    return m_status;
}

bool CreateSearchLogResponse::StatusHasBeenSet() const
{
