...
KeyValueInfo RuleInfo::GetKeyValue() const
{
    return m_keyValue;
}

void RuleInfo::SetKeyValue(const KeyValueInfo& _keyValue)
{
...
KeyValueInfo RuleInfo::GetTag() const
{
    return m_tag;
}

void RuleInfo::SetTag(const KeyValueInfo& _tag)
{
    m_tag = _tag;
    m_tagHasBeenSet = true;
}
