...
CoreInternalOutcome CheckBashPolicyParamsResponse::Deserialize(const string &payload)
{
...
string CheckBashPolicyParamsResponse::ToJsonString() const
{
...
uint64_t CheckBashPolicyParamsResponse::GetErrCode() const
{
    return m_errCode;
}

bool CheckBashPolicyParamsResponse::ErrCodeHasBeenSet() const
{
    return m_errCodeHasBeenSet;
}

string CheckBashPolicyParamsResponse::GetErrMsg() const
{
    return m_errMsg;
}

bool CheckBashPolicyParamsResponse::ErrMsgHasBeenSet() const
{
