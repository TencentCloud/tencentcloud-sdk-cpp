...
CoreInternalOutcome DescribeJavaMemShellInfoResponse::Deserialize(const string &payload)
{
...
string DescribeJavaMemShellInfoResponse::ToJsonString() const
{
...
JavaMemShellDetail DescribeJavaMemShellInfoResponse::GetInfo() const
{
    return m_info;
}

bool DescribeJavaMemShellInfoResponse::InfoHasBeenSet() const
{
