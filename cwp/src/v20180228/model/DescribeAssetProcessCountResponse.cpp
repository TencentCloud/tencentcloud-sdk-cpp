...
CoreInternalOutcome DescribeAssetProcessCountResponse::Deserialize(const string &payload)
{
...
string DescribeAssetProcessCountResponse::ToJsonString() const
{
...
vector<AssetKeyVal> DescribeAssetProcessCountResponse::GetProcess() const
{
    return m_process;
}

bool DescribeAssetProcessCountResponse::ProcessHasBeenSet() const
{
