...
string DescribeMachineLicenseDetailRequest::ToJsonString() const
{
...
vector<string> DescribeMachineLicenseDetailRequest::GetQuuids() const
{
    return m_quuids;
}

void DescribeMachineLicenseDetailRequest::SetQuuids(const vector<string>& _quuids)
{
    m_quuids = _quuids;
    m_quuidsHasBeenSet = true;
}

bool DescribeMachineLicenseDetailRequest::QuuidsHasBeenSet() const
{
