...
string DescribeStrategyExistRequest::ToJsonString() const
{
...
string DescribeStrategyExistRequest::GetStrategyName() const
{
    return m_strategyName;
}

void DescribeStrategyExistRequest::SetStrategyName(const string& _strategyName)
{
    m_strategyName = _strategyName;
    m_strategyNameHasBeenSet = true;
}

bool DescribeStrategyExistRequest::StrategyNameHasBeenSet() const
{
