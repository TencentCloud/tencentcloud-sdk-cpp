...
CoreInternalOutcome ExportBaselineEffectHostListResponse::Deserialize(const string &payload)
{
...
string ExportBaselineEffectHostListResponse::ToJsonString() const
{
...
string ExportBaselineEffectHostListResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBaselineEffectHostListResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBaselineEffectHostListResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBaselineEffectHostListResponse::TaskIdHasBeenSet() const
{
