...
string DescribeAssetUserListRequest::ToJsonString() const
{
...
void DescribeAssetUserListRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeAssetUserListRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

uint64_t DescribeAssetUserListRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAssetUserListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeAssetUserListRequest::OffsetHasBeenSet() const
{
...
void DescribeAssetUserListRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeAssetUserListRequest::OrderHasBeenSet() const
{
    return m_orderHasBeenSet;
}

string DescribeAssetUserListRequest::GetBy() const
{
    return m_by;
}

void DescribeAssetUserListRequest::SetBy(const string& _by)
{
    m_by = _by;
    m_byHasBeenSet = true;
}
