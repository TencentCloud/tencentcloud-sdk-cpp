...
CoreInternalOutcome ModifyRansomDefenseStrategyStatusResponse::Deserialize(const string &payload)
{
...
string ModifyRansomDefenseStrategyStatusResponse::ToJsonString() const
{
