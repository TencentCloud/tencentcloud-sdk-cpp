...
AddVulIgnoreRuleRequest::AddVulIgnoreRuleRequest() :
    m_ruleDetailListHasBeenSet(false)
{
}

string AddVulIgnoreRuleRequest::ToJsonString() const
{
...
vector<VulIgnoreRule> AddVulIgnoreRuleRequest::GetRuleDetailList() const
{
    return m_ruleDetailList;
}

void AddVulIgnoreRuleRequest::SetRuleDetailList(const vector<VulIgnoreRule>& _ruleDetailList)
{
    m_ruleDetailList = _ruleDetailList;
    m_ruleDetailListHasBeenSet = true;
}

bool AddVulIgnoreRuleRequest::RuleDetailListHasBeenSet() const
{
