...
CoreInternalOutcome DescribeMachineListResponse::Deserialize(const string &payload)
{
...
string DescribeMachineListResponse::ToJsonString() const
{
...
vector<Machine> DescribeMachineListResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeMachineListResponse::MachinesHasBeenSet() const
{
    return m_machinesHasBeenSet;
}

uint64_t DescribeMachineListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeMachineListResponse::TotalCountHasBeenSet() const
{
