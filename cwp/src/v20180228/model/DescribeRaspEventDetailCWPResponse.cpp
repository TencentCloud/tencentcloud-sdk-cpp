...
CoreInternalOutcome DescribeRaspEventDetailCWPResponse::Deserialize(const string &payload)
{
...
string DescribeRaspEventDetailCWPResponse::ToJsonString() const
{
...
RaspEventDetail DescribeRaspEventDetailCWPResponse::GetData() const
{
    return m_data;
}

bool DescribeRaspEventDetailCWPResponse::DataHasBeenSet() const
{
