...
CoreInternalOutcome ExportPrivilegeEventsResponse::Deserialize(const string &payload)
{
...
string ExportPrivilegeEventsResponse::ToJsonString() const
{
...
string ExportPrivilegeEventsResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportPrivilegeEventsResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportPrivilegeEventsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportPrivilegeEventsResponse::TaskIdHasBeenSet() const
{
