...
CoreInternalOutcome DescribeLicenseBindScheduleResponse::Deserialize(const string &payload)
{
...
string DescribeLicenseBindScheduleResponse::ToJsonString() const
{
...
uint64_t DescribeLicenseBindScheduleResponse::GetSchedule() const
{
    return m_schedule;
}

bool DescribeLicenseBindScheduleResponse::ScheduleHasBeenSet() const
{
    return m_scheduleHasBeenSet;
}

vector<LicenseBindTaskDetail> DescribeLicenseBindScheduleResponse::GetList() const
{
    return m_list;
}

bool DescribeLicenseBindScheduleResponse::ListHasBeenSet() const
{
    return m_listHasBeenSet;
}

uint64_t DescribeLicenseBindScheduleResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeLicenseBindScheduleResponse::TotalCountHasBeenSet() const
{
