...
CoreInternalOutcome DescribeLoginTypeHostResponse::Deserialize(const string &payload)
{
...
string DescribeLoginTypeHostResponse::ToJsonString() const
{
...
uint64_t DescribeLoginTypeHostResponse::GetTotal() const
{
    return m_total;
}

bool DescribeLoginTypeHostResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ClientSettingHost> DescribeLoginTypeHostResponse::GetList() const
{
    return m_list;
}

bool DescribeLoginTypeHostResponse::ListHasBeenSet() const
{
