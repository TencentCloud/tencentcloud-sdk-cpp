...
CoreInternalOutcome DescribeScreenEventsCntResponse::Deserialize(const string &payload)
{
...
string DescribeScreenEventsCntResponse::ToJsonString() const
{
...
vector<ScreenEventsCnt> DescribeScreenEventsCntResponse::GetInfo() const
{
    return m_info;
}

bool DescribeScreenEventsCntResponse::InfoHasBeenSet() const
{
