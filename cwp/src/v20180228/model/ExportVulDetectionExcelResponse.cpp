...
CoreInternalOutcome ExportVulDetectionExcelResponse::Deserialize(const string &payload)
{
...
string ExportVulDetectionExcelResponse::ToJsonString() const
{
...
string ExportVulDetectionExcelResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportVulDetectionExcelResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportVulDetectionExcelResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportVulDetectionExcelResponse::TaskIdHasBeenSet() const
{
