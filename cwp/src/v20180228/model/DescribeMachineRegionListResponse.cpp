...
CoreInternalOutcome DescribeMachineRegionListResponse::Deserialize(const string &payload)
{
...
string DescribeMachineRegionListResponse::ToJsonString() const
{
...
vector<RegionListDetail> DescribeMachineRegionListResponse::GetRegionList() const
{
    return m_regionList;
}

bool DescribeMachineRegionListResponse::RegionListHasBeenSet() const
{
