...
vector<uint64_t> ModifyVulDefenceEventStatusRequest::GetIds() const
{
    return m_ids;
}

void ModifyVulDefenceEventStatusRequest::SetIds(const vector<uint64_t>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool ModifyVulDefenceEventStatusRequest::IdsHasBeenSet() const
{
    return m_idsHasBeenSet;
}

uint64_t ModifyVulDefenceEventStatusRequest::GetStatus() const
{
    return m_status;
}

void ModifyVulDefenceEventStatusRequest::SetStatus(const uint64_t& _status)
{
    m_status = _status;
