...
CoreInternalOutcome DescribeCanFixVulMachineResponse::Deserialize(const string &payload)
{
...
string DescribeCanFixVulMachineResponse::ToJsonString() const
{
...
vector<CanFixVulInfo> DescribeCanFixVulMachineResponse::GetVulInfo() const
{
    return m_vulInfo;
}

bool DescribeCanFixVulMachineResponse::VulInfoHasBeenSet() const
{
