...
string DeleteRiskDnsPolicyRequest::ToJsonString() const
{
...
vector<int64_t> DeleteRiskDnsPolicyRequest::GetPolicyIds() const
{
    return m_policyIds;
}

void DeleteRiskDnsPolicyRequest::SetPolicyIds(const vector<int64_t>& _policyIds)
{
    m_policyIds = _policyIds;
    m_policyIdsHasBeenSet = true;
}

bool DeleteRiskDnsPolicyRequest::PolicyIdsHasBeenSet() const
{
