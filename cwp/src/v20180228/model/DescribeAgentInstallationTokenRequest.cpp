...
string DescribeAgentInstallationTokenRequest::ToJsonString() const
{
...
string DescribeAgentInstallationTokenRequest::GetExpireDate() const
{
    return m_expireDate;
}

void DescribeAgentInstallationTokenRequest::SetExpireDate(const string& _expireDate)
{
    m_expireDate = _expireDate;
    m_expireDateHasBeenSet = true;
}

bool DescribeAgentInstallationTokenRequest::ExpireDateHasBeenSet() const
{
