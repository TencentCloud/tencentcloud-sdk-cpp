...
CoreInternalOutcome DescribeBaselineScanScheduleResponse::Deserialize(const string &payload)
{
...
string DescribeBaselineScanScheduleResponse::ToJsonString() const
{
...
uint64_t DescribeBaselineScanScheduleResponse::GetSchedule() const
{
    return m_schedule;
}

bool DescribeBaselineScanScheduleResponse::ScheduleHasBeenSet() const
{
