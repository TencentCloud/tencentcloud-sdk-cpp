...
string DescribeRansomDefenseMachineStrategyInfoRequest::ToJsonString() const
{
...
vector<string> DescribeRansomDefenseMachineStrategyInfoRequest::GetQuuids() const
{
    return m_quuids;
}

void DescribeRansomDefenseMachineStrategyInfoRequest::SetQuuids(const vector<string>& _quuids)
{
    m_quuids = _quuids;
    m_quuidsHasBeenSet = true;
}

bool DescribeRansomDefenseMachineStrategyInfoRequest::QuuidsHasBeenSet() const
{
