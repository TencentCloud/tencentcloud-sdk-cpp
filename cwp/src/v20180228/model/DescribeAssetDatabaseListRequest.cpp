...
string DescribeAssetDatabaseListRequest::ToJsonString() const
{
...
void DescribeAssetDatabaseListRequest::SetFilters(const vector<AssetFilters>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeAssetDatabaseListRequest::FiltersHasBeenSet() const
{
