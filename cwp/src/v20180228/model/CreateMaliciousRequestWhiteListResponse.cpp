...
CoreInternalOutcome CreateMaliciousRequestWhiteListResponse::Deserialize(const string &payload)
{
...
string CreateMaliciousRequestWhiteListResponse::ToJsonString() const
{
