...
string DescribeAssetAppListRequest::ToJsonString() const
{
...
void DescribeAssetAppListRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeAssetAppListRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

uint64_t DescribeAssetAppListRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAssetAppListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeAssetAppListRequest::OffsetHasBeenSet() const
{
...
void DescribeAssetAppListRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeAssetAppListRequest::OrderHasBeenSet() const
{
