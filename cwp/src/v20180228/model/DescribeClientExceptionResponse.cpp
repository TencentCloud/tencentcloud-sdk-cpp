...
CoreInternalOutcome DescribeClientExceptionResponse::Deserialize(const string &payload)
{
...
string DescribeClientExceptionResponse::ToJsonString() const
{
...
uint64_t DescribeClientExceptionResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeClientExceptionResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<RecordInfo> DescribeClientExceptionResponse::GetRecords() const
{
    return m_records;
}

bool DescribeClientExceptionResponse::RecordsHasBeenSet() const
{
