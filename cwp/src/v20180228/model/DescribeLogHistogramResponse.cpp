...
vector<LogHistogram> DescribeLogHistogramResponse::GetData() const
{
    return m_data;
}

bool DescribeLogHistogramResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeLogHistogramResponse::GetPeriod() const
{
    return m_period;
}

bool DescribeLogHistogramResponse::PeriodHasBeenSet() const
{
