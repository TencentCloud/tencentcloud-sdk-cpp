...
string DescribeAssetWebLocationListRequest::ToJsonString() const
{
...
void DescribeAssetWebLocationListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
    m_offsetHasBeenSet = true;
}

bool DescribeAssetWebLocationListRequest::OffsetHasBeenSet() const
{
...
void DescribeAssetWebLocationListRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeAssetWebLocationListRequest::OrderHasBeenSet() const
{
    return m_orderHasBeenSet;
}

string DescribeAssetWebLocationListRequest::GetBy() const
{
    return m_by;
}

void DescribeAssetWebLocationListRequest::SetBy(const string& _by)
{
    m_by = _by;
    m_byHasBeenSet = true;
}
