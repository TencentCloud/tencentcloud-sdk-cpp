...
CoreInternalOutcome CreateVulFixResponse::Deserialize(const string &payload)
{
...
string CreateVulFixResponse::ToJsonString() const
{
...
uint64_t CreateVulFixResponse::GetFixId() const
{
    return m_fixId;
}

bool CreateVulFixResponse::FixIdHasBeenSet() const
{
