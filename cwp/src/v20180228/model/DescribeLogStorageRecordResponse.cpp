...
CoreInternalOutcome DescribeLogStorageRecordResponse::Deserialize(const string &payload)
{
...
string DescribeLogStorageRecordResponse::ToJsonString() const
{
...
vector<LogStorageRecord> DescribeLogStorageRecordResponse::GetRecords() const
{
    return m_records;
}

bool DescribeLogStorageRecordResponse::RecordsHasBeenSet() const
{
