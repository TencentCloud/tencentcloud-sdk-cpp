...
CoreInternalOutcome DescribeScanScheduleResponse::Deserialize(const string &payload)
{
...
string DescribeScanScheduleResponse::ToJsonString() const
{
...
uint64_t DescribeScanScheduleResponse::GetSchedule() const
{
    return m_schedule;
}

bool DescribeScanScheduleResponse::ScheduleHasBeenSet() const
{
