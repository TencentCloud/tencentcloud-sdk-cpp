...
CoreInternalOutcome ExportVulInfoResponse::Deserialize(const string &payload)
{
...
string ExportVulInfoResponse::ToJsonString() const
{
...
uint64_t ExportVulInfoResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportVulInfoResponse::TaskIdHasBeenSet() const
{
