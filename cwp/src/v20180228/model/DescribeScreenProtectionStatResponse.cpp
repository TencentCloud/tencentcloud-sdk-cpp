...
CoreInternalOutcome DescribeScreenProtectionStatResponse::Deserialize(const string &payload)
{
...
string DescribeScreenProtectionStatResponse::ToJsonString() const
{
...
vector<ScreenProtection> DescribeScreenProtectionStatResponse::GetInfo() const
{
    return m_info;
}

bool DescribeScreenProtectionStatResponse::InfoHasBeenSet() const
{
