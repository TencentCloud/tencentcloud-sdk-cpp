...
string DescribeBaselineAnalysisDataRequest::ToJsonString() const
{
...
uint64_t DescribeBaselineAnalysisDataRequest::GetStrategyId() const
{
    return m_strategyId;
}

void DescribeBaselineAnalysisDataRequest::SetStrategyId(const uint64_t& _strategyId)
{
    m_strategyId = _strategyId;
    m_strategyIdHasBeenSet = true;
}

bool DescribeBaselineAnalysisDataRequest::StrategyIdHasBeenSet() const
{
