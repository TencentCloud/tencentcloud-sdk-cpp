...
CoreInternalOutcome DescribeUsersConfigResponse::Deserialize(const string &payload)
{
...
string DescribeUsersConfigResponse::ToJsonString() const
{
...
string DescribeUsersConfigResponse::GetValue() const
{
    return m_value;
}

bool DescribeUsersConfigResponse::ValueHasBeenSet() const
{
