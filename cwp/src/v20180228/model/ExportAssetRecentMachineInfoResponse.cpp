...
CoreInternalOutcome ExportAssetRecentMachineInfoResponse::Deserialize(const string &payload)
{
...
string ExportAssetRecentMachineInfoResponse::ToJsonString() const
{
...
string ExportAssetRecentMachineInfoResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportAssetRecentMachineInfoResponse::DownloadUrlHasBeenSet() const
{
