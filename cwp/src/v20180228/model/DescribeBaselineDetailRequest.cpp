...
string DescribeBaselineDetailRequest::ToJsonString() const
{
...
uint64_t DescribeBaselineDetailRequest::GetBaselineId() const
{
    return m_baselineId;
}

void DescribeBaselineDetailRequest::SetBaselineId(const uint64_t& _baselineId)
{
    m_baselineId = _baselineId;
    m_baselineIdHasBeenSet = true;
}

bool DescribeBaselineDetailRequest::BaselineIdHasBeenSet() const
{
