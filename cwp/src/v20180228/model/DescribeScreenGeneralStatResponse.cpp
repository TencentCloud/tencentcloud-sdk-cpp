...
CoreInternalOutcome DescribeScreenGeneralStatResponse::Deserialize(const string &payload)
{
...
string DescribeScreenGeneralStatResponse::ToJsonString() const
{
...
vector<ScreenNameValue> DescribeScreenGeneralStatResponse::GetMachines() const
{
    return m_machines;
}

bool DescribeScreenGeneralStatResponse::MachinesHasBeenSet() const
{
    return m_machinesHasBeenSet;
}

vector<ScreenNameValue> DescribeScreenGeneralStatResponse::GetProtection() const
{
    return m_protection;
}

bool DescribeScreenGeneralStatResponse::ProtectionHasBeenSet() const
{
