...
string DescribeVulHostTopRequest::ToJsonString() const
{
...
uint64_t DescribeVulHostTopRequest::GetTop() const
{
    return m_top;
}

void DescribeVulHostTopRequest::SetTop(const uint64_t& _top)
{
    m_top = _top;
    m_topHasBeenSet = true;
}

bool DescribeVulHostTopRequest::TopHasBeenSet() const
{
    return m_topHasBeenSet;
}

uint64_t DescribeVulHostTopRequest::GetVulCategory() const
{
    return m_vulCategory;
}

void DescribeVulHostTopRequest::SetVulCategory(const uint64_t& _vulCategory)
{
