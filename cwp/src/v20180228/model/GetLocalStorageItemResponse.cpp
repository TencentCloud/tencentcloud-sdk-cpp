...
CoreInternalOutcome GetLocalStorageItemResponse::Deserialize(const string &payload)
{
...
string GetLocalStorageItemResponse::ToJsonString() const
{
...
string GetLocalStorageItemResponse::GetValue() const
{
    return m_value;
}

bool GetLocalStorageItemResponse::ValueHasBeenSet() const
{
