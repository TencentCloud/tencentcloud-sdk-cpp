...
string DescribeScreenEventsCntRequest::ToJsonString() const
{
...
uint64_t DescribeScreenEventsCntRequest::GetBusinessType() const
{
    return m_businessType;
}

void DescribeScreenEventsCntRequest::SetBusinessType(const uint64_t& _businessType)
{
    m_businessType = _businessType;
    m_businessTypeHasBeenSet = true;
}

bool DescribeScreenEventsCntRequest::BusinessTypeHasBeenSet() const
{
