...
CoreInternalOutcome ModifyRansomDefenseEventsStatusResponse::Deserialize(const string &payload)
{
...
string ModifyRansomDefenseEventsStatusResponse::ToJsonString() const
{
