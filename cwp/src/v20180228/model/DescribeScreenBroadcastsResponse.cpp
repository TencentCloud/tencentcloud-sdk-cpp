...
CoreInternalOutcome DescribeScreenBroadcastsResponse::Deserialize(const string &payload)
{
...
string DescribeScreenBroadcastsResponse::ToJsonString() const
{
...
vector<ScreenBroadcasts> DescribeScreenBroadcastsResponse::GetList() const
{
    return m_list;
}

bool DescribeScreenBroadcastsResponse::ListHasBeenSet() const
{
