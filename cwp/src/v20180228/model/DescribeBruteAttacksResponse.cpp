...
CoreInternalOutcome DescribeBruteAttacksResponse::Deserialize(const string &payload)
{
...
uint64_t DescribeBruteAttacksResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeBruteAttacksResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<BruteAttack> DescribeBruteAttacksResponse::GetBruteAttacks() const
{
    return m_bruteAttacks;
}

bool DescribeBruteAttacksResponse::BruteAttacksHasBeenSet() const
{
