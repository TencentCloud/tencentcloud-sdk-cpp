...
string DescribeAssetProcessInfoListRequest::ToJsonString() const
{
...
void DescribeAssetProcessInfoListRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeAssetProcessInfoListRequest::LimitHasBeenSet() const
{
    return m_limitHasBeenSet;
}

uint64_t DescribeAssetProcessInfoListRequest::GetOffset() const
{
    return m_offset;
}

void DescribeAssetProcessInfoListRequest::SetOffset(const uint64_t& _offset)
{
    m_offset = _offset;
...
void DescribeAssetProcessInfoListRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool DescribeAssetProcessInfoListRequest::OrderHasBeenSet() const
{
    return m_orderHasBeenSet;
}

string DescribeAssetProcessInfoListRequest::GetBy() const
{
    return m_by;
}

void DescribeAssetProcessInfoListRequest::SetBy(const string& _by)
{
    m_by = _by;
    m_byHasBeenSet = true;
}

bool DescribeAssetProcessInfoListRequest::ByHasBeenSet() const
{
