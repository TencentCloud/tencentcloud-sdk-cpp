...
string SyncAssetScanRequest::ToJsonString() const
{
...
bool SyncAssetScanRequest::GetSync() const
{
    return m_sync;
}

void SyncAssetScanRequest::SetSync(const bool& _sync)
{
    m_sync = _sync;
    m_syncHasBeenSet = true;
}

bool SyncAssetScanRequest::SyncHasBeenSet() const
{
