...
CoreInternalOutcome DescribeScreenProtectionCntResponse::Deserialize(const string &payload)
{
...
string DescribeScreenProtectionCntResponse::ToJsonString() const
{
...
vector<ScreenProtectionCnt> DescribeScreenProtectionCntResponse::GetList() const
{
    return m_list;
}

bool DescribeScreenProtectionCntResponse::ListHasBeenSet() const
{
