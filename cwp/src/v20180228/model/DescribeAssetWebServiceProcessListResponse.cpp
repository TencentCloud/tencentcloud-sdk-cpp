...
CoreInternalOutcome DescribeAssetWebServiceProcessListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetWebServiceProcessListResponse::ToJsonString() const
{
...
vector<AssetAppProcessInfo> DescribeAssetWebServiceProcessListResponse::GetProcess() const
{
    return m_process;
}

bool DescribeAssetWebServiceProcessListResponse::ProcessHasBeenSet() const
{
    return m_processHasBeenSet;
}

uint64_t DescribeAssetWebServiceProcessListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetWebServiceProcessListResponse::TotalHasBeenSet() const
{
