...
string StopBaselineDetectRequest::ToJsonString() const
{
...
vector<int64_t> StopBaselineDetectRequest::GetTaskIds() const
{
    return m_taskIds;
}

void StopBaselineDetectRequest::SetTaskIds(const vector<int64_t>& _taskIds)
{
    m_taskIds = _taskIds;
    m_taskIdsHasBeenSet = true;
}

bool StopBaselineDetectRequest::TaskIdsHasBeenSet() const
{
