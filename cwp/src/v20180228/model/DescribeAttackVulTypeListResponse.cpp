...
CoreInternalOutcome DescribeAttackVulTypeListResponse::Deserialize(const string &payload)
{
...
string DescribeAttackVulTypeListResponse::ToJsonString() const
{
...
vector<string> DescribeAttackVulTypeListResponse::GetList() const
{
    return m_list;
}

bool DescribeAttackVulTypeListResponse::ListHasBeenSet() const
{
