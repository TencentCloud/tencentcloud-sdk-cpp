...
CoreInternalOutcome DescribeLogDeliveryKafkaOptionsResponse::Deserialize(const string &payload)
{
...
string DescribeLogDeliveryKafkaOptionsResponse::ToJsonString() const
{
...
vector<CKafkaInstanceInfo> DescribeLogDeliveryKafkaOptionsResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeLogDeliveryKafkaOptionsResponse::InstanceListHasBeenSet() const
{
