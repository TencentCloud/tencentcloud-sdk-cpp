...
string ExportBaselineHostDetectListRequest::ToJsonString() const
{
...
vector<Filter> ExportBaselineHostDetectListRequest::GetFilters() const
{
    return m_filters;
}

void ExportBaselineHostDetectListRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool ExportBaselineHostDetectListRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

int64_t ExportBaselineHostDetectListRequest::GetExportAll() const
{
    return m_exportAll;
}

void ExportBaselineHostDetectListRequest::SetExportAll(const int64_t& _exportAll)
{
