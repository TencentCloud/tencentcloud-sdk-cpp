...
string DescribeVulInfoCvssRequest::ToJsonString() const
{
...
uint64_t DescribeVulInfoCvssRequest::GetVulId() const
{
    return m_vulId;
}

void DescribeVulInfoCvssRequest::SetVulId(const uint64_t& _vulId)
{
    m_vulId = _vulId;
