...
CoreInternalOutcome ModifyLicenseBindsResponse::Deserialize(const string &payload)
{
...
string ModifyLicenseBindsResponse::ToJsonString() const
{
...
uint64_t ModifyLicenseBindsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ModifyLicenseBindsResponse::TaskIdHasBeenSet() const
{
