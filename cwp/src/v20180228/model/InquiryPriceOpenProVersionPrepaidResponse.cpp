...
CoreInternalOutcome InquiryPriceOpenProVersionPrepaidResponse::Deserialize(const string &payload)
{
...
string InquiryPriceOpenProVersionPrepaidResponse::ToJsonString() const
{
...
double InquiryPriceOpenProVersionPrepaidResponse::GetOriginalPrice() const
{
    return m_originalPrice;
}

bool InquiryPriceOpenProVersionPrepaidResponse::OriginalPriceHasBeenSet() const
{
    return m_originalPriceHasBeenSet;
}

double InquiryPriceOpenProVersionPrepaidResponse::GetDiscountPrice() const
{
    return m_discountPrice;
}

bool InquiryPriceOpenProVersionPrepaidResponse::DiscountPriceHasBeenSet() const
{
