...
CoreInternalOutcome DescribeMachineOsListResponse::Deserialize(const string &payload)
{
...
string DescribeMachineOsListResponse::ToJsonString() const
{
...
vector<OsName> DescribeMachineOsListResponse::GetList() const
{
    return m_list;
}

bool DescribeMachineOsListResponse::ListHasBeenSet() const
{
