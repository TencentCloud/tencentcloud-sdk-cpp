...
CoreInternalOutcome ExportIgnoreBaselineRuleResponse::Deserialize(const string &payload)
{
...
string ExportIgnoreBaselineRuleResponse::ToJsonString() const
{
...
string ExportIgnoreBaselineRuleResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportIgnoreBaselineRuleResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportIgnoreBaselineRuleResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportIgnoreBaselineRuleResponse::TaskIdHasBeenSet() const
{
