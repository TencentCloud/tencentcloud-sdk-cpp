...
CoreInternalOutcome StartBaselineDetectResponse::Deserialize(const string &payload)
{
...
string StartBaselineDetectResponse::ToJsonString() const
{
...
int64_t StartBaselineDetectResponse::GetTaskId() const
{
    return m_taskId;
}

bool StartBaselineDetectResponse::TaskIdHasBeenSet() const
{
