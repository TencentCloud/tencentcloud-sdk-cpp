...
CoreInternalOutcome DescribeCanNotSeparateMachineResponse::Deserialize(const string &payload)
{
...
string DescribeCanNotSeparateMachineResponse::ToJsonString() const
{
...
vector<CanNotSeparateInfo> DescribeCanNotSeparateMachineResponse::GetList() const
{
    return m_list;
}

bool DescribeCanNotSeparateMachineResponse::ListHasBeenSet() const
{
