...
string DeleteBaselineStrategyRequest::ToJsonString() const
{
...
uint64_t DeleteBaselineStrategyRequest::GetStrategyId() const
{
    return m_strategyId;
}

void DeleteBaselineStrategyRequest::SetStrategyId(const uint64_t& _strategyId)
{
    m_strategyId = _strategyId;
    m_strategyIdHasBeenSet = true;
}

bool DeleteBaselineStrategyRequest::StrategyIdHasBeenSet() const
{
