...
CoreInternalOutcome ModifyJavaMemShellPluginSwitchResponse::Deserialize(const string &payload)
{
...
string ModifyJavaMemShellPluginSwitchResponse::ToJsonString() const
{
