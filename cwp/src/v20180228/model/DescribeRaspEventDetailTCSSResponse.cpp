...
CoreInternalOutcome DescribeRaspEventDetailTCSSResponse::Deserialize(const string &payload)
{
...
string DescribeRaspEventDetailTCSSResponse::ToJsonString() const
{
...
RaspEventDetail DescribeRaspEventDetailTCSSResponse::GetData() const
{
    return m_data;
}

bool DescribeRaspEventDetailTCSSResponse::DataHasBeenSet() const
{
