...
string DescribeUsersConfigRequest::ToJsonString() const
{
...
string DescribeUsersConfigRequest::GetConfigName() const
{
    return m_configName;
}

void DescribeUsersConfigRequest::SetConfigName(const string& _configName)
{
    m_configName = _configName;
    m_configNameHasBeenSet = true;
}

bool DescribeUsersConfigRequest::ConfigNameHasBeenSet() const
{
