...
CoreInternalOutcome DescribeAssetPortInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetPortInfoListResponse::ToJsonString() const
{
...
uint64_t DescribeAssetPortInfoListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetPortInfoListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AssetPortBaseInfo> DescribeAssetPortInfoListResponse::GetPorts() const
{
    return m_ports;
}

bool DescribeAssetPortInfoListResponse::PortsHasBeenSet() const
{
