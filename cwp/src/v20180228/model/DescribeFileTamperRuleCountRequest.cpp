...
string DescribeFileTamperRuleCountRequest::ToJsonString() const
{
...
vector<string> DescribeFileTamperRuleCountRequest::GetUuids() const
{
    return m_uuids;
}

void DescribeFileTamperRuleCountRequest::SetUuids(const vector<string>& _uuids)
{
    m_uuids = _uuids;
    m_uuidsHasBeenSet = true;
}

bool DescribeFileTamperRuleCountRequest::UuidsHasBeenSet() const
{
