...
CoreInternalOutcome DescribeVulLabelsResponse::Deserialize(const string &payload)
{
...
string DescribeVulLabelsResponse::ToJsonString() const
{
...
vector<string> DescribeVulLabelsResponse::GetList() const
{
    return m_list;
}

bool DescribeVulLabelsResponse::ListHasBeenSet() const
{
