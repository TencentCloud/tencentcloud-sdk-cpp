...
CoreInternalOutcome DescribeFileTamperRuleCountResponse::Deserialize(const string &payload)
{
...
string DescribeFileTamperRuleCountResponse::ToJsonString() const
{
...
vector<FileTamperRuleCount> DescribeFileTamperRuleCountResponse::GetList() const
{
    return m_list;
}

bool DescribeFileTamperRuleCountResponse::ListHasBeenSet() const
{
