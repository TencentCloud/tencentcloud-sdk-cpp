...
CoreInternalOutcome ExportMaliciousRequestsResponse::Deserialize(const string &payload)
{
...
string ExportMaliciousRequestsResponse::ToJsonString() const
{
...
string ExportMaliciousRequestsResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportMaliciousRequestsResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportMaliciousRequestsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportMaliciousRequestsResponse::TaskIdHasBeenSet() const
{
