...
string DescribeBashEventsRequest::ToJsonString() const
{
...
uint64_t DescribeBashEventsRequest::GetLimit() const
{
    return m_limit;
}

void DescribeBashEventsRequest::SetLimit(const uint64_t& _limit)
{
    m_limit = _limit;
    m_limitHasBeenSet = true;
}

bool DescribeBashEventsRequest::LimitHasBeenSet() const
{
