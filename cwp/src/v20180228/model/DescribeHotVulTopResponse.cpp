...
CoreInternalOutcome DescribeHotVulTopResponse::Deserialize(const string &payload)
{
...
string DescribeHotVulTopResponse::ToJsonString() const
{
...
vector<VulStoreListInfo> DescribeHotVulTopResponse::GetList() const
{
    return m_list;
}

bool DescribeHotVulTopResponse::ListHasBeenSet() const
{
