...
CoreInternalOutcome DescribeWebHookRuleResponse::Deserialize(const string &payload)
{
...
string DescribeWebHookRuleResponse::ToJsonString() const
{
...
WebHookRuleDetail DescribeWebHookRuleResponse::GetData() const
{
    return m_data;
}

bool DescribeWebHookRuleResponse::DataHasBeenSet() const
{
