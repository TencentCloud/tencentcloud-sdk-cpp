...
CoreInternalOutcome CreateWhiteListOrderResponse::Deserialize(const string &payload)
{
...
string CreateWhiteListOrderResponse::ToJsonString() const
{
...
OrderResource CreateWhiteListOrderResponse::GetResource() const
{
    return m_resource;
}

bool CreateWhiteListOrderResponse::ResourceHasBeenSet() const
{
