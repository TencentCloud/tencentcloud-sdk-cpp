...
CoreInternalOutcome KeysLocalStorageResponse::Deserialize(const string &payload)
{
...
string KeysLocalStorageResponse::ToJsonString() const
{
...
vector<string> KeysLocalStorageResponse::GetKeys() const
{
    return m_keys;
}

bool KeysLocalStorageResponse::KeysHasBeenSet() const
{
