...
CoreInternalOutcome DescribeAssetDatabaseCountResponse::Deserialize(const string &payload)
{
...
string DescribeAssetDatabaseCountResponse::ToJsonString() const
{
...
vector<AssetKeyVal> DescribeAssetDatabaseCountResponse::GetDatabases() const
{
    return m_databases;
}

bool DescribeAssetDatabaseCountResponse::DatabasesHasBeenSet() const
{
