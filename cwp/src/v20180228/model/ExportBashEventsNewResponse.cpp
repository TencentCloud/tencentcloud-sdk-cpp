...
CoreInternalOutcome ExportBashEventsNewResponse::Deserialize(const string &payload)
{
...
string ExportBashEventsNewResponse::ToJsonString() const
{
...
string ExportBashEventsNewResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBashEventsNewResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBashEventsNewResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBashEventsNewResponse::TaskIdHasBeenSet() const
{
