...
CoreInternalOutcome ExportBashEventsResponse::Deserialize(const string &payload)
{
...
string ExportBashEventsResponse::ToJsonString() const
{
...
string ExportBashEventsResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBashEventsResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBashEventsResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBashEventsResponse::TaskIdHasBeenSet() const
{
