...
CoreInternalOutcome DescribeAssetUserCountResponse::Deserialize(const string &payload)
{
...
string DescribeAssetUserCountResponse::ToJsonString() const
{
...
vector<AssetKeyVal> DescribeAssetUserCountResponse::GetUsers() const
{
    return m_users;
}

bool DescribeAssetUserCountResponse::UsersHasBeenSet() const
{
