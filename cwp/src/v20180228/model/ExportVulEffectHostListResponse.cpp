...
CoreInternalOutcome ExportVulEffectHostListResponse::Deserialize(const string &payload)
{
...
string ExportVulEffectHostListResponse::ToJsonString() const
{
...
string ExportVulEffectHostListResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportVulEffectHostListResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportVulEffectHostListResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportVulEffectHostListResponse::TaskIdHasBeenSet() const
{
