...
CoreInternalOutcome DescribeLogTypeResponse::Deserialize(const string &payload)
{
...
string DescribeLogTypeResponse::ToJsonString() const
{
...
string DescribeLogTypeResponse::GetData() const
{
    return m_data;
}

bool DescribeLogTypeResponse::DataHasBeenSet() const
{
