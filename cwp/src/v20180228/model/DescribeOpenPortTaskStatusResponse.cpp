...
CoreInternalOutcome DescribeOpenPortTaskStatusResponse::Deserialize(const string &payload)
{
...
string DescribeOpenPortTaskStatusResponse::GetStatus() const
{
    return m_status;
}

bool DescribeOpenPortTaskStatusResponse::StatusHasBeenSet() const
{
