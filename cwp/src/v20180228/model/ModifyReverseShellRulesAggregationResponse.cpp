...
CoreInternalOutcome ModifyReverseShellRulesAggregationResponse::Deserialize(const string &payload)
{
...
string ModifyReverseShellRulesAggregationResponse::ToJsonString() const
{
