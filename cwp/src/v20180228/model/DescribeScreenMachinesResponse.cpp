...
CoreInternalOutcome DescribeScreenMachinesResponse::Deserialize(const string &payload)
{
...
string DescribeScreenMachinesResponse::ToJsonString() const
{
...
vector<ScreenRegionMachines> DescribeScreenMachinesResponse::GetList() const
{
    return m_list;
}

bool DescribeScreenMachinesResponse::ListHasBeenSet() const
{
