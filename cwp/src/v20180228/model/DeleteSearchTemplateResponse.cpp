...
CoreInternalOutcome DeleteSearchTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteSearchTemplateResponse::ToJsonString() const
{
...
uint64_t DeleteSearchTemplateResponse::GetStatus() const
{
    return m_status;
}

bool DeleteSearchTemplateResponse::StatusHasBeenSet() const
{
