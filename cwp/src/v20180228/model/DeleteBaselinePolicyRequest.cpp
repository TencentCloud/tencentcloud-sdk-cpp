...
string DeleteBaselinePolicyRequest::ToJsonString() const
{
...
vector<int64_t> DeleteBaselinePolicyRequest::GetPolicyIds() const
{
    return m_policyIds;
}

void DeleteBaselinePolicyRequest::SetPolicyIds(const vector<int64_t>& _policyIds)
{
    m_policyIds = _policyIds;
    m_policyIdsHasBeenSet = true;
}

bool DeleteBaselinePolicyRequest::PolicyIdsHasBeenSet() const
{
