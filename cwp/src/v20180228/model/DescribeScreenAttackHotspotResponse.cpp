...
CoreInternalOutcome DescribeScreenAttackHotspotResponse::Deserialize(const string &payload)
{
...
string DescribeScreenAttackHotspotResponse::ToJsonString() const
{
...
vector<ScreenAttackHotspot> DescribeScreenAttackHotspotResponse::GetList() const
{
    return m_list;
}

bool DescribeScreenAttackHotspotResponse::ListHasBeenSet() const
{
