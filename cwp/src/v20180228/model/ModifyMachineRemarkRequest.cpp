...
string ModifyMachineRemarkRequest::GetQuuid() const
{
    return m_quuid;
}

void ModifyMachineRemarkRequest::SetQuuid(const string& _quuid)
{
    m_quuid = _quuid;
    m_quuidHasBeenSet = true;
}

bool ModifyMachineRemarkRequest::QuuidHasBeenSet() const
{
