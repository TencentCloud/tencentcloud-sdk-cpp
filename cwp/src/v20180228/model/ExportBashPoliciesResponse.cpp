...
CoreInternalOutcome ExportBashPoliciesResponse::Deserialize(const string &payload)
{
...
string ExportBashPoliciesResponse::ToJsonString() const
{
...
string ExportBashPoliciesResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportBashPoliciesResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

string ExportBashPoliciesResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportBashPoliciesResponse::TaskIdHasBeenSet() const
{
