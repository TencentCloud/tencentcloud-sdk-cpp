...
string DescribeBaselineStrategyDetailRequest::ToJsonString() const
{
...
uint64_t DescribeBaselineStrategyDetailRequest::GetStrategyId() const
{
    return m_strategyId;
}

void DescribeBaselineStrategyDetailRequest::SetStrategyId(const uint64_t& _strategyId)
{
    m_strategyId = _strategyId;
    m_strategyIdHasBeenSet = true;
}

bool DescribeBaselineStrategyDetailRequest::StrategyIdHasBeenSet() const
{
