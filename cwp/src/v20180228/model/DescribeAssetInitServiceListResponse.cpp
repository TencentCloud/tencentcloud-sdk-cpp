...
CoreInternalOutcome DescribeAssetInitServiceListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetInitServiceListResponse::ToJsonString() const
{
...
vector<AssetInitServiceBaseInfo> DescribeAssetInitServiceListResponse::GetServices() const
{
    return m_services;
}

bool DescribeAssetInitServiceListResponse::ServicesHasBeenSet() const
{
    return m_servicesHasBeenSet;
}

uint64_t DescribeAssetInitServiceListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetInitServiceListResponse::TotalHasBeenSet() const
{
