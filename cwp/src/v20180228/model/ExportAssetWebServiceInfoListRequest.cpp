...
string ExportAssetWebServiceInfoListRequest::ToJsonString() const
{
...
void ExportAssetWebServiceInfoListRequest::SetFilters(const vector<AssetFilters>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool ExportAssetWebServiceInfoListRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

string ExportAssetWebServiceInfoListRequest::GetOrder() const
{
    return m_order;
}

void ExportAssetWebServiceInfoListRequest::SetOrder(const string& _order)
{
    m_order = _order;
    m_orderHasBeenSet = true;
}

bool ExportAssetWebServiceInfoListRequest::OrderHasBeenSet() const
{
    return m_orderHasBeenSet;
}

string ExportAssetWebServiceInfoListRequest::GetBy() const
{
    return m_by;
}

void ExportAssetWebServiceInfoListRequest::SetBy(const string& _by)
{
    m_by = _by;
    m_byHasBeenSet = true;
}
