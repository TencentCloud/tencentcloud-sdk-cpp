...
string CancelIgnoreVulRequest::ToJsonString() const
{
...
string CancelIgnoreVulRequest::GetEventIds() const
{
    return m_eventIds;
}

void CancelIgnoreVulRequest::SetEventIds(const string& _eventIds)
{
    m_eventIds = _eventIds;
    m_eventIdsHasBeenSet = true;
}

bool CancelIgnoreVulRequest::EventIdsHasBeenSet() const
{
