...
CoreInternalOutcome DescribeAssetSystemPackageListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetSystemPackageListResponse::ToJsonString() const
{
...
uint64_t DescribeAssetSystemPackageListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetSystemPackageListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AssetSystemPackageInfo> DescribeAssetSystemPackageListResponse::GetPackages() const
{
    return m_packages;
}

bool DescribeAssetSystemPackageListResponse::PackagesHasBeenSet() const
{
