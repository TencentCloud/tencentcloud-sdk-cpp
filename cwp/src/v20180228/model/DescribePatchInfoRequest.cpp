...
string DescribePatchInfoRequest::ToJsonString() const
{
...
uint64_t DescribePatchInfoRequest::GetKbId() const
{
    return m_kbId;
}

void DescribePatchInfoRequest::SetKbId(const uint64_t& _kbId)
{
    m_kbId = _kbId;
    m_kbIdHasBeenSet = true;
}

bool DescribePatchInfoRequest::KbIdHasBeenSet() const
{
