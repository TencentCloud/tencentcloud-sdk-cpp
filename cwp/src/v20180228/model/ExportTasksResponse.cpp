...
CoreInternalOutcome ExportTasksResponse::Deserialize(const string &payload)
{
...
string ExportTasksResponse::ToJsonString() const
{
...
string ExportTasksResponse::GetStatus() const
{
    return m_status;
}

bool ExportTasksResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ExportTasksResponse::GetDownloadUrl() const
{
