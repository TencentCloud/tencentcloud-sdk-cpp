...
CoreInternalOutcome ExportLicenseDetailResponse::Deserialize(const string &payload)
{
...
string ExportLicenseDetailResponse::ToJsonString() const
{
...
string ExportLicenseDetailResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool ExportLicenseDetailResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

uint64_t ExportLicenseDetailResponse::GetTaskId() const
{
    return m_taskId;
}

bool ExportLicenseDetailResponse::TaskIdHasBeenSet() const
{
