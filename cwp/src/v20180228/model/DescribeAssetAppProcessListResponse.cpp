...
CoreInternalOutcome DescribeAssetAppProcessListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetAppProcessListResponse::ToJsonString() const
{
...
vector<AssetAppProcessInfo> DescribeAssetAppProcessListResponse::GetProcess() const
{
    return m_process;
}

bool DescribeAssetAppProcessListResponse::ProcessHasBeenSet() const
{
    return m_processHasBeenSet;
}

uint64_t DescribeAssetAppProcessListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetAppProcessListResponse::TotalHasBeenSet() const
{
