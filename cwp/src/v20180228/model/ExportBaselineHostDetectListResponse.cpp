...
CoreInternalOutcome ExportBaselineHostDetectListResponse::Deserialize(const string &payload)
{
...
string ExportBaselineHostDetectListResponse::ToJsonString() const
{
