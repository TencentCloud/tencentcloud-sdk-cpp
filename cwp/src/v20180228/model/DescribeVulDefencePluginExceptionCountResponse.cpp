...
CoreInternalOutcome DescribeVulDefencePluginExceptionCountResponse::Deserialize(const string &payload)
{
...
string DescribeVulDefencePluginExceptionCountResponse::ToJsonString() const
{
...
uint64_t DescribeVulDefencePluginExceptionCountResponse::GetCount() const
{
    return m_count;
}

bool DescribeVulDefencePluginExceptionCountResponse::CountHasBeenSet() const
{
