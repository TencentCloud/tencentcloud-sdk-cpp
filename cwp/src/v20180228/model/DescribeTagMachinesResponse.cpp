...
CoreInternalOutcome DescribeTagMachinesResponse::Deserialize(const string &payload)
{
...
string DescribeTagMachinesResponse::ToJsonString() const
{
...
vector<TagMachine> DescribeTagMachinesResponse::GetList() const
{
    return m_list;
}

bool DescribeTagMachinesResponse::ListHasBeenSet() const
{
