...
CoreInternalOutcome DescribeAssetUserKeyListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetUserKeyListResponse::ToJsonString() const
{
...
vector<AssetUserKeyInfo> DescribeAssetUserKeyListResponse::GetKeys() const
{
    return m_keys;
}

bool DescribeAssetUserKeyListResponse::KeysHasBeenSet() const
{
    return m_keysHasBeenSet;
}

uint64_t DescribeAssetUserKeyListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetUserKeyListResponse::TotalHasBeenSet() const
{
