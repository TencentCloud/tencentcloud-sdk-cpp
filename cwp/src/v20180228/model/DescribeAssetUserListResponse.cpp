...
CoreInternalOutcome DescribeAssetUserListResponse::Deserialize(const string &payload)
{
...
string DescribeAssetUserListResponse::ToJsonString() const
{
...
uint64_t DescribeAssetUserListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeAssetUserListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<AssetUserBaseInfo> DescribeAssetUserListResponse::GetUsers() const
{
    return m_users;
}

bool DescribeAssetUserListResponse::UsersHasBeenSet() const
{
