...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETWEBLOCATIONLISTRESPONSE_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETWEBLOCATIONLISTRESPONSE_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetWebLocationListResponse : public AbstractModel
                {
                public:
                    DescribeAssetWebLocationListResponse();
                    ~DescribeAssetWebLocationListResponse() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETWEBLOCATIONLISTRESPONSE_H_
