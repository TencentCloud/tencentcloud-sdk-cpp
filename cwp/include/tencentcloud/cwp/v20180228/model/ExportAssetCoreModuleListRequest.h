...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETCOREMODULELISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETCOREMODULELISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class ExportAssetCoreModuleListRequest : public AbstractModel
                {
                public:
                    ExportAssetCoreModuleListRequest();
                    ~ExportAssetCoreModuleListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETCOREMODULELISTREQUEST_H_
