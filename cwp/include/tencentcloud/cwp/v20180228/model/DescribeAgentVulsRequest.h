...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEAGENTVULSREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEAGENTVULSREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentVulsRequest : public AbstractModel
                {
                public:
                    DescribeAgentVulsRequest();
                    ~DescribeAgentVulsRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEAGENTVULSREQUEST_H_
