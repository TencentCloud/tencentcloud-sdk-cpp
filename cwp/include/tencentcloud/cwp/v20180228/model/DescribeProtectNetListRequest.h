...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEPROTECTNETLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEPROTECTNETLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeProtectNetListRequest : public AbstractModel
                {
                public:
                    DescribeProtectNetListRequest();
                    ~DescribeProtectNetListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEPROTECTNETLISTREQUEST_H_
