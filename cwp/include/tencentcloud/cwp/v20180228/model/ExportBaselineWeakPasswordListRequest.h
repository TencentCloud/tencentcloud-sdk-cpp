...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTBASELINEWEAKPASSWORDLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTBASELINEWEAKPASSWORDLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class ExportBaselineWeakPasswordListRequest : public AbstractModel
                {
                public:
                    ExportBaselineWeakPasswordListRequest();
                    ~ExportBaselineWeakPasswordListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTBASELINEWEAKPASSWORDLISTREQUEST_H_
