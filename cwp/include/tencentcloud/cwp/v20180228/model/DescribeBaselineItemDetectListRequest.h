            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<li>HostId - string - 是否必填：否 - 主机Id</li>
...
<li>EndTime - string - 是否必填：否 - 结束时间</li>
                    ...
                    /**
                     * 设置<li>HostId - string - 是否必填：否 - 主机Id</li>
<li>RuleId - int64 - 是否必填：否 - 规则Id</li>
<li>PolicyId - int64 - 是否必填：否 - 规则Id</li>
<li>ItemName - string - 是否必填：否 - 项名称</li>
<li>DetectStatus - int - 是否必填：否 - 检测状态</li>
...
<li>EndTime - string - 是否必填：否 - 结束时间</li>
                    ...
                    /**
                     * 获取可选排序列: [HostCount|FirstTime|LastTime]
                     * @return By 可选排序列: [HostCount|FirstTime|LastTime]
                     * 
                     */
                    std::string GetBy() const;

                    /**
                     * 设置可选排序列: [HostCount|FirstTime|LastTime]
