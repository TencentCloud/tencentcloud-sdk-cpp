...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_MODIFYWEBHOOKRULESTATUSREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_MODIFYWEBHOOKRULESTATUSREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class ModifyWebHookRuleStatusRequest : public AbstractModel
                {
                public:
                    ModifyWebHookRuleStatusRequest();
                    ~ModifyWebHookRuleStatusRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_MODIFYWEBHOOKRULESTATUSREQUEST_H_
