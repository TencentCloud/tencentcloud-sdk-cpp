...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBESAVEORUPDATEWARNINGSREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBESAVEORUPDATEWARNINGSREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeSaveOrUpdateWarningsRequest : public AbstractModel
                {
                public:
                    DescribeSaveOrUpdateWarningsRequest();
                    ~DescribeSaveOrUpdateWarningsRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBESAVEORUPDATEWARNINGSREQUEST_H_
