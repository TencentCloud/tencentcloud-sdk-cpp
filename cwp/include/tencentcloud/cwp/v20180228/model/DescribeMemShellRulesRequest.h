...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEMEMSHELLRULESREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEMEMSHELLRULESREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeMemShellRulesRequest : public AbstractModel
                {
                public:
                    DescribeMemShellRulesRequest();
                    ~DescribeMemShellRulesRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEMEMSHELLRULESREQUEST_H_
