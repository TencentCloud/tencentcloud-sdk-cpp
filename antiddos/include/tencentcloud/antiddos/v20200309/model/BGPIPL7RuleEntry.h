...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_BGPIPL7RULEENTRY_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_BGPIPL7RULEENTRY_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                * L7规则
                */
                class BGPIPL7RuleEntry : public AbstractModel
                {
                public:
                    BGPIPL7RuleEntry();
                    ~BGPIPL7RuleEntry() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_BGPIPL7RULEENTRY_H_
