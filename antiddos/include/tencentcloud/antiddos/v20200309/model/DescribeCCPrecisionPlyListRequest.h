...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBECCPRECISIONPLYLISTREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBECCPRECISIONPLYLISTREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeCCPrecisionPlyListRequest : public AbstractModel
                {
                public:
                    DescribeCCPrecisionPlyListRequest();
                    ~DescribeCCPrecisionPlyListRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取DDoS防护子产品代号（bgpip-multip：表示高防包；bgpip：表示高防IP）
                    ...
                    /**
                     * 设置DDoS防护子产品代号（bgpip-multip：表示高防包；bgpip：表示高防IP）
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBECCPRECISIONPLYLISTREQUEST_H_
