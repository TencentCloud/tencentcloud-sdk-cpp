...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPACKETFILTERCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPACKETFILTERCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeListPacketFilterConfigRequest : public AbstractModel
                {
                public:
                    DescribeListPacketFilterConfigRequest();
                    ~DescribeListPacketFilterConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPACKETFILTERCONFIGREQUEST_H_
