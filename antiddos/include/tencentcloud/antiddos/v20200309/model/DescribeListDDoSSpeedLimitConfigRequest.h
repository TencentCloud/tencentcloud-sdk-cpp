...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSSPEEDLIMITCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSSPEEDLIMITCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeListDDoSSpeedLimitConfigRequest : public AbstractModel
                {
                public:
                    DescribeListDDoSSpeedLimitConfigRequest();
                    ~DescribeListDDoSSpeedLimitConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSSPEEDLIMITCONFIGREQUEST_H_
