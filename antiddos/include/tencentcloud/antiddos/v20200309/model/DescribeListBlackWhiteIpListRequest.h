...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTBLACKWHITEIPLISTREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTBLACKWHITEIPLISTREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeListBlackWhiteIpListRequest : public AbstractModel
                {
                public:
                    DescribeListBlackWhiteIpListRequest();
                    ~DescribeListBlackWhiteIpListRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTBLACKWHITEIPLISTREQUEST_H_
