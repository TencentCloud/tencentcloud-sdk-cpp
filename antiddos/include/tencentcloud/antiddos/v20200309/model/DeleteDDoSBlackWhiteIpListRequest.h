...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSBLACKWHITEIPLISTREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSBLACKWHITEIPLISTREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DeleteDDoSBlackWhiteIpListRequest : public AbstractModel
                {
                public:
                    DeleteDDoSBlackWhiteIpListRequest();
                    ~DeleteDDoSBlackWhiteIpListRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSBLACKWHITEIPLISTREQUEST_H_
