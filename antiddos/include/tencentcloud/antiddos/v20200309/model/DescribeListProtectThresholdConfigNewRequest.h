...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPROTECTTHRESHOLDCONFIGNEWREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPROTECTTHRESHOLDCONFIGNEWREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeListProtectThresholdConfigNewRequest : public AbstractModel
                {
                public:
                    DescribeListProtectThresholdConfigNewRequest();
                    ~DescribeListProtectThresholdConfigNewRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTPROTECTTHRESHOLDCONFIGNEWREQUEST_H_
