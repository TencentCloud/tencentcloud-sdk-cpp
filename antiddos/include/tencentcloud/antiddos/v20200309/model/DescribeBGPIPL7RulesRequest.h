...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBEBGPIPL7RULESREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBEBGPIPL7RULESREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeBGPIPL7RulesRequest : public AbstractModel
                {
                public:
                    DescribeBGPIPL7RulesRequest();
                    ~DescribeBGPIPL7RulesRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBEBGPIPL7RULESREQUEST_H_
