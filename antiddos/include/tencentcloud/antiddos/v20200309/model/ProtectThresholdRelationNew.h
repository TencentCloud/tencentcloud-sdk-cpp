...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_PROTECTTHRESHOLDRELATIONNEW_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_PROTECTTHRESHOLDRELATIONNEW_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                * 防护阈值配置相关信息
                */
                class ProtectThresholdRelationNew : public AbstractModel
                {
                public:
                    ProtectThresholdRelationNew();
                    ~ProtectThresholdRelationNew() = default;
...
1(开启)
                     ...
                     * 
                     */
                    std::vector<ListenerCcThresholdConfig> GetListenerCcThresholdList() const;
                     ...
                     * 
                     */
                    void SetListenerCcThresholdList(const std::vector<ListenerCcThresholdConfig>& _listenerCcThresholdList);
...
1(开启)
                     ...
                     * 域名与协议纬度的防护阈值
                     */
                    std::vector<ListenerCcThresholdConfig> m_listenerCcThresholdList;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_PROTECTTHRESHOLDRELATIONNEW_H_
