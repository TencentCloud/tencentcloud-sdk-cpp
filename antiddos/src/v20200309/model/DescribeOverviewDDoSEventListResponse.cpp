...
CoreInternalOutcome DescribeOverviewDDoSEventListResponse::Deserialize(const string &payload)
{
...
string DescribeOverviewDDoSEventListResponse::ToJsonString() const
{
...
uint64_t DescribeOverviewDDoSEventListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeOverviewDDoSEventListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<OverviewDDoSEvent> DescribeOverviewDDoSEventListResponse::GetEventList() const
{
    return m_eventList;
}

bool DescribeOverviewDDoSEventListResponse::EventListHasBeenSet() const
{
