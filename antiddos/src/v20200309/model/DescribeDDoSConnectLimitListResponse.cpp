...
CoreInternalOutcome DescribeDDoSConnectLimitListResponse::Deserialize(const string &payload)
{
...
string DescribeDDoSConnectLimitListResponse::ToJsonString() const
{
...
uint64_t DescribeDDoSConnectLimitListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeDDoSConnectLimitListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ConnectLimitRelation> DescribeDDoSConnectLimitListResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeDDoSConnectLimitListResponse::ConfigListHasBeenSet() const
{
