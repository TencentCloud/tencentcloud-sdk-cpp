...
DescribeBGPIPL7RulesResponse::DescribeBGPIPL7RulesResponse() :
...
CoreInternalOutcome DescribeBGPIPL7RulesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Healths") && !rsp["Healths"].IsNull())
    {
        if (!rsp["Healths"].IsArray())
            return CoreInternalOutcome(Core::Error("response `Healths` is not array type"));
...
string DescribeBGPIPL7RulesResponse::ToJsonString() const
{
...
vector<BGPIPL7RuleEntry> DescribeBGPIPL7RulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeBGPIPL7RulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

vector<L7RuleHealth> DescribeBGPIPL7RulesResponse::GetHealths() const
{
    return m_healths;
}

bool DescribeBGPIPL7RulesResponse::HealthsHasBeenSet() const
{
    return m_healthsHasBeenSet;
}

uint64_t DescribeBGPIPL7RulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeBGPIPL7RulesResponse::TotalHasBeenSet() const
{
