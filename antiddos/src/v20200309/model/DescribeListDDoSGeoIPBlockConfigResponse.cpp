...
CoreInternalOutcome DescribeListDDoSGeoIPBlockConfigResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ConfigList") && !rsp["ConfigList"].IsNull())
    {
        ...
        {
            DDoSGeoIPBlockConfigRelation item;
...
string DescribeListDDoSGeoIPBlockConfigResponse::ToJsonString() const
{
...
uint64_t DescribeListDDoSGeoIPBlockConfigResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListDDoSGeoIPBlockConfigResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DDoSGeoIPBlockConfigRelation> DescribeListDDoSGeoIPBlockConfigResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListDDoSGeoIPBlockConfigResponse::ConfigListHasBeenSet() const
{
