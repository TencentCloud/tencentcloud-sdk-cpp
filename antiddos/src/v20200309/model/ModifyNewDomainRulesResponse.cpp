...
CoreInternalOutcome ModifyNewDomainRulesResponse::Deserialize(const string &payload)
{
...
string ModifyNewDomainRulesResponse::ToJsonString() const
{
...
SuccessCode ModifyNewDomainRulesResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyNewDomainRulesResponse::SuccessHasBeenSet() const
{
