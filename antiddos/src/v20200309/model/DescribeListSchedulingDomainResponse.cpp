...
CoreInternalOutcome DescribeListSchedulingDomainResponse::Deserialize(const string &payload)
{
...
string DescribeListSchedulingDomainResponse::ToJsonString() const
{
...
uint64_t DescribeListSchedulingDomainResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListSchedulingDomainResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<SchedulingDomainInfo> DescribeListSchedulingDomainResponse::GetDomainList() const
{
    return m_domainList;
}

bool DescribeListSchedulingDomainResponse::DomainListHasBeenSet() const
{
