...
CoreInternalOutcome DescribeListBlackWhiteIpListResponse::Deserialize(const string &payload)
{
...
string DescribeListBlackWhiteIpListResponse::ToJsonString() const
{
...
int64_t DescribeListBlackWhiteIpListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListBlackWhiteIpListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<BlackWhiteIpRelation> DescribeListBlackWhiteIpListResponse::GetIpList() const
{
    return m_ipList;
}

bool DescribeListBlackWhiteIpListResponse::IpListHasBeenSet() const
{
