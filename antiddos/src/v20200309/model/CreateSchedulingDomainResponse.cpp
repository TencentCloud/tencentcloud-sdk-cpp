...
CoreInternalOutcome CreateSchedulingDomainResponse::Deserialize(const string &payload)
{
...
string CreateSchedulingDomainResponse::ToJsonString() const
{
...
string CreateSchedulingDomainResponse::GetDomain() const
{
    return m_domain;
}

bool CreateSchedulingDomainResponse::DomainHasBeenSet() const
{
