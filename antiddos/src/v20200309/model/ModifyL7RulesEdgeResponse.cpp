...
CoreInternalOutcome ModifyL7RulesEdgeResponse::Deserialize(const string &payload)
{
...
string ModifyL7RulesEdgeResponse::ToJsonString() const
{
...
SuccessCode ModifyL7RulesEdgeResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyL7RulesEdgeResponse::SuccessHasBeenSet() const
{
