...
CoreInternalOutcome DescribeListDDoSAIResponse::Deserialize(const string &payload)
{
...
string DescribeListDDoSAIResponse::ToJsonString() const
{
...
int64_t DescribeListDDoSAIResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListDDoSAIResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DDoSAIRelation> DescribeListDDoSAIResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListDDoSAIResponse::ConfigListHasBeenSet() const
{
