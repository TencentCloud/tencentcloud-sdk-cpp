...
CreateBgpInstanceResponse::CreateBgpInstanceResponse() :
    m_resourceIdsHasBeenSet(false)
{
}

CoreInternalOutcome CreateBgpInstanceResponse::Deserialize(const string &payload)
{
...
string CreateBgpInstanceResponse::ToJsonString() const
{
...
vector<string> CreateBgpInstanceResponse::GetResourceIds() const
{
    return m_resourceIds;
}

bool CreateBgpInstanceResponse::ResourceIdsHasBeenSet() const
{
