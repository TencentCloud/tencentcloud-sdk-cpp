...
CoreInternalOutcome DescribeCCLevelPolicyResponse::Deserialize(const string &payload)
{
...
string DescribeCCLevelPolicyResponse::ToJsonString() const
{
...
string DescribeCCLevelPolicyResponse::GetLevel() const
{
    return m_level;
}

bool DescribeCCLevelPolicyResponse::LevelHasBeenSet() const
{
