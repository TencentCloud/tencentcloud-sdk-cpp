...
CoreInternalOutcome DescribeListBGPIPInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeListBGPIPInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeListBGPIPInstancesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListBGPIPInstancesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<BGPIPInstance> DescribeListBGPIPInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeListBGPIPInstancesResponse::InstanceListHasBeenSet() const
{
