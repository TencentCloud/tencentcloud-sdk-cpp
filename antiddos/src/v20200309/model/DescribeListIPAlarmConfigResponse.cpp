...
CoreInternalOutcome DescribeListIPAlarmConfigResponse::Deserialize(const string &payload)
{
...
string DescribeListIPAlarmConfigResponse::ToJsonString() const
{
...
int64_t DescribeListIPAlarmConfigResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListIPAlarmConfigResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<IPAlarmThresholdRelation> DescribeListIPAlarmConfigResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListIPAlarmConfigResponse::ConfigListHasBeenSet() const
{
