...
DescribeBizMonitorTrendResponse::DescribeBizMonitorTrendResponse() :
...
CoreInternalOutcome DescribeBizMonitorTrendResponse::Deserialize(const string &payload)
{
...
string DescribeBizMonitorTrendResponse::ToJsonString() const
{
...
vector<double> DescribeBizMonitorTrendResponse::GetDataList() const
{
    return m_dataList;
}

bool DescribeBizMonitorTrendResponse::DataListHasBeenSet() const
{
    return m_dataListHasBeenSet;
}

string DescribeBizMonitorTrendResponse::GetMetricName() const
{
    return m_metricName;
}

bool DescribeBizMonitorTrendResponse::MetricNameHasBeenSet() const
{
    return m_metricNameHasBeenSet;
}

uint64_t DescribeBizMonitorTrendResponse::GetMaxData() const
{
    return m_maxData;
}

bool DescribeBizMonitorTrendResponse::MaxDataHasBeenSet() const
{
