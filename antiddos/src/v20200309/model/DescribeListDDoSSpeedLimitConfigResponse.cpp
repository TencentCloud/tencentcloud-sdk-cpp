...
CoreInternalOutcome DescribeListDDoSSpeedLimitConfigResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("ConfigList") && !rsp["ConfigList"].IsNull())
    {
        ...
        {
            DDoSSpeedLimitConfigRelation item;
...
string DescribeListDDoSSpeedLimitConfigResponse::ToJsonString() const
{
...
uint64_t DescribeListDDoSSpeedLimitConfigResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListDDoSSpeedLimitConfigResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<DDoSSpeedLimitConfigRelation> DescribeListDDoSSpeedLimitConfigResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListDDoSSpeedLimitConfigResponse::ConfigListHasBeenSet() const
{
