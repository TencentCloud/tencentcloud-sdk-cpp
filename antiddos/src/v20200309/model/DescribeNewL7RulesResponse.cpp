...
CoreInternalOutcome DescribeNewL7RulesResponse::Deserialize(const string &payload)
{
...
string DescribeNewL7RulesResponse::ToJsonString() const
{
...
vector<NewL7RuleEntry> DescribeNewL7RulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeNewL7RulesResponse::RulesHasBeenSet() const
{
    return m_rulesHasBeenSet;
}

vector<L7RuleHealth> DescribeNewL7RulesResponse::GetHealths() const
{
    return m_healths;
}

bool DescribeNewL7RulesResponse::HealthsHasBeenSet() const
{
    return m_healthsHasBeenSet;
}

uint64_t DescribeNewL7RulesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeNewL7RulesResponse::TotalHasBeenSet() const
{
