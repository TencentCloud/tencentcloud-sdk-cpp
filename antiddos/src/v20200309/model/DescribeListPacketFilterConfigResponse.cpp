...
CoreInternalOutcome DescribeListPacketFilterConfigResponse::Deserialize(const string &payload)
{
...
string DescribeListPacketFilterConfigResponse::ToJsonString() const
{
...
int64_t DescribeListPacketFilterConfigResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListPacketFilterConfigResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<PacketFilterRelation> DescribeListPacketFilterConfigResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListPacketFilterConfigResponse::ConfigListHasBeenSet() const
{
