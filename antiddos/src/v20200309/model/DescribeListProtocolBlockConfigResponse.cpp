...
CoreInternalOutcome DescribeListProtocolBlockConfigResponse::Deserialize(const string &payload)
{
...
string DescribeListProtocolBlockConfigResponse::ToJsonString() const
{
...
int64_t DescribeListProtocolBlockConfigResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListProtocolBlockConfigResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<ProtocolBlockRelation> DescribeListProtocolBlockConfigResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeListProtocolBlockConfigResponse::ConfigListHasBeenSet() const
{
