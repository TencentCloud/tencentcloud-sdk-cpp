...
CoreInternalOutcome DescribeBasicDeviceStatusResponse::Deserialize(const string &payload)
{
...
string DescribeBasicDeviceStatusResponse::ToJsonString() const
{
...
vector<KeyValue> DescribeBasicDeviceStatusResponse::GetData() const
{
    return m_data;
}
