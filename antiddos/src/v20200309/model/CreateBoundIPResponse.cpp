...
CoreInternalOutcome CreateBoundIPResponse::Deserialize(const string &payload)
{
...
string CreateBoundIPResponse::ToJsonString() const
{
...
SuccessCode CreateBoundIPResponse::GetSuccess() const
{
    return m_success;
}

bool CreateBoundIPResponse::SuccessHasBeenSet() const
{
