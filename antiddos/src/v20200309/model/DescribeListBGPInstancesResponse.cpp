...
CoreInternalOutcome DescribeListBGPInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeListBGPInstancesResponse::ToJsonString() const
{
...
uint64_t DescribeListBGPInstancesResponse::GetTotal() const
{
    return m_total;
}

bool DescribeListBGPInstancesResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<BGPInstance> DescribeListBGPInstancesResponse::GetInstanceList() const
{
    return m_instanceList;
}

bool DescribeListBGPInstancesResponse::InstanceListHasBeenSet() const
{
