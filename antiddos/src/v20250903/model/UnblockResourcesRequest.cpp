...
string UnblockResourcesRequest::ToJsonString() const
{
...
vector<string> UnblockResourcesRequest::GetResources() const
{
    return m_resources;
}

void UnblockResourcesRequest::SetResources(const vector<string>& _resources)
{
    m_resources = _resources;
    m_resourcesHasBeenSet = true;
}

bool UnblockResourcesRequest::ResourcesHasBeenSet() const
{
