...
#ifndef TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBEDEDICATEDCLUSTERHOSTSTATISTICSREQUEST_H_
#define TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBEDEDICATEDCLUSTERHOSTSTATISTICSREQUEST_H_
    ...
    namespace Cdc
    {
        namespace V20201214
        {
            namespace Model
            {
                ...
                */
                class DescribeDedicatedClusterHostStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeDedicatedClusterHostStatisticsRequest();
                    ~DescribeDedicatedClusterHostStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBEDEDICATEDCLUSTERHOSTSTATISTICSREQUEST_H_
