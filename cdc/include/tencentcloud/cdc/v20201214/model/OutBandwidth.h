...
#ifndef TENCENTCLOUD_CDC_V20201214_MODEL_OUTBANDWIDTH_H_
#define TENCENTCLOUD_CDC_V20201214_MODEL_OUTBANDWIDTH_H_
    ...
    namespace Cdc
    {
        namespace V20201214
        {
            namespace Model
            {
                ...
                * 出带宽数据。
                */
                class OutBandwidth : public AbstractModel
                {
                public:
                    OutBandwidth();
...
#endif // !TENCENTCLOUD_CDC_V20201214_MODEL_OUTBANDWIDTH_H_
