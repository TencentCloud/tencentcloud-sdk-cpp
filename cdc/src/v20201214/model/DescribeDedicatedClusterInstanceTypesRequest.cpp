...
string DescribeDedicatedClusterInstanceTypesRequest::ToJsonString() const
{
...
string DescribeDedicatedClusterInstanceTypesRequest::GetDedicatedClusterId() const
{
    return m_dedicatedClusterId;
}

void DescribeDedicatedClusterInstanceTypesRequest::SetDedicatedClusterId(const string& _dedicatedClusterId)
{
    m_dedicatedClusterId = _dedicatedClusterId;
    m_dedicatedClusterIdHasBeenSet = true;
}

bool DescribeDedicatedClusterInstanceTypesRequest::DedicatedClusterIdHasBeenSet() const
{
