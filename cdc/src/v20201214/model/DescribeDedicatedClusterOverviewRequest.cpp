...
string DescribeDedicatedClusterOverviewRequest::ToJsonString() const
{
...
string DescribeDedicatedClusterOverviewRequest::GetDedicatedClusterId() const
{
    return m_dedicatedClusterId;
}

void DescribeDedicatedClusterOverviewRequest::SetDedicatedClusterId(const string& _dedicatedClusterId)
{
    m_dedicatedClusterId = _dedicatedClusterId;
    m_dedicatedClusterIdHasBeenSet = true;
}

bool DescribeDedicatedClusterOverviewRequest::DedicatedClusterIdHasBeenSet() const
{
