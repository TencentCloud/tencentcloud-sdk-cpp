...
string DescribeDedicatedClusterCosCapacityRequest::ToJsonString() const
{
...
string DescribeDedicatedClusterCosCapacityRequest::GetDedicatedClusterId() const
{
    return m_dedicatedClusterId;
}

void DescribeDedicatedClusterCosCapacityRequest::SetDedicatedClusterId(const string& _dedicatedClusterId)
{
    m_dedicatedClusterId = _dedicatedClusterId;
    m_dedicatedClusterIdHasBeenSet = true;
}

bool DescribeDedicatedClusterCosCapacityRequest::DedicatedClusterIdHasBeenSet() const
{
