...
CoreInternalOutcome DescribeDedicatedSupportedZonesResponse::Deserialize(const string &payload)
{
...
string DescribeDedicatedSupportedZonesResponse::ToJsonString() const
{
...
vector<RegionZoneInfo> DescribeDedicatedSupportedZonesResponse::GetZoneSet() const
{
    return m_zoneSet;
}

bool DescribeDedicatedSupportedZonesResponse::ZoneSetHasBeenSet() const
{
