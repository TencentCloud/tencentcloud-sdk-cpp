...
CoreInternalOutcome DescribeHttpStatusInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeHttpStatusInfoListResponse::ToJsonString() const
{
...
vector<HttpStatusData> DescribeHttpStatusInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeHttpStatusInfoListResponse::DataInfoListHasBeenSet() const
{
