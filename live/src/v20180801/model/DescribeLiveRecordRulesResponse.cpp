...
CoreInternalOutcome DescribeLiveRecordRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveRecordRulesResponse::ToJsonString() const
{
...
vector<RuleInfo> DescribeLiveRecordRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveRecordRulesResponse::RulesHasBeenSet() const
{
