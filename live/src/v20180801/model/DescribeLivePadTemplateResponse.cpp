...
DescribeLivePadTemplateResponse::DescribeLivePadTemplateResponse() :
    m_templateHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLivePadTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeLivePadTemplateResponse::ToJsonString() const
{
...
PadTemplate DescribeLivePadTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool DescribeLivePadTemplateResponse::TemplateHasBeenSet() const
{
