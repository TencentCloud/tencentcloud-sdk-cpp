...
ModifyAuditTemplateRequest::ModifyAuditTemplateRequest() :
    m_auditTemplateHasBeenSet(false)
{
}

string ModifyAuditTemplateRequest::ToJsonString() const
{
...
AuditTemplate ModifyAuditTemplateRequest::GetAuditTemplate() const
{
    return m_auditTemplate;
}

void ModifyAuditTemplateRequest::SetAuditTemplate(const AuditTemplate& _auditTemplate)
{
    m_auditTemplate = _auditTemplate;
    m_auditTemplateHasBeenSet = true;
}

bool ModifyAuditTemplateRequest::AuditTemplateHasBeenSet() const
{
