...
DescribeMonitorReportRequest::DescribeMonitorReportRequest() :
    m_monitorIdHasBeenSet(false)
{
}

string DescribeMonitorReportRequest::ToJsonString() const
{
...
string DescribeMonitorReportRequest::GetMonitorId() const
{
    return m_monitorId;
}

void DescribeMonitorReportRequest::SetMonitorId(const string& _monitorId)
{
    m_monitorId = _monitorId;
    m_monitorIdHasBeenSet = true;
}

bool DescribeMonitorReportRequest::MonitorIdHasBeenSet() const
{
