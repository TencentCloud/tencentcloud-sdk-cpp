...
DescribeCallbackRecordsListResponse::DescribeCallbackRecordsListResponse() :
...
CoreInternalOutcome DescribeCallbackRecordsListResponse::Deserialize(const string &payload)
{
...
string DescribeCallbackRecordsListResponse::ToJsonString() const
{
...
vector<CallbackEventInfo> DescribeCallbackRecordsListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeCallbackRecordsListResponse::DataInfoListHasBeenSet() const
{
    return m_dataInfoListHasBeenSet;
}

uint64_t DescribeCallbackRecordsListResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeCallbackRecordsListResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeCallbackRecordsListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeCallbackRecordsListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeCallbackRecordsListResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeCallbackRecordsListResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeCallbackRecordsListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeCallbackRecordsListResponse::TotalPageHasBeenSet() const
{
