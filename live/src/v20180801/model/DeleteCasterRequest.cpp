...
string DeleteCasterRequest::ToJsonString() const
{
...
uint64_t DeleteCasterRequest::GetCasterId() const
{
    return m_casterId;
}

void DeleteCasterRequest::SetCasterId(const uint64_t& _casterId)
{
    m_casterId = _casterId;
    m_casterIdHasBeenSet = true;
}

bool DeleteCasterRequest::CasterIdHasBeenSet() const
{
