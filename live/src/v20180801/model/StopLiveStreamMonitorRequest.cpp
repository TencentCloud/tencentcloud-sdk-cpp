...
string StopLiveStreamMonitorRequest::ToJsonString() const
{
...
string StopLiveStreamMonitorRequest::GetMonitorId() const
{
    return m_monitorId;
}

void StopLiveStreamMonitorRequest::SetMonitorId(const string& _monitorId)
{
    m_monitorId = _monitorId;
    m_monitorIdHasBeenSet = true;
}

bool StopLiveStreamMonitorRequest::MonitorIdHasBeenSet() const
{
