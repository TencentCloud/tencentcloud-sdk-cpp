...
CoreInternalOutcome CreateLiveCallbackTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLiveCallbackTemplateResponse::ToJsonString() const
{
...
int64_t CreateLiveCallbackTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateLiveCallbackTemplateResponse::TemplateIdHasBeenSet() const
{
