...
ModifyAuditTemplateResponse::ModifyAuditTemplateResponse() :
    m_templateIdHasBeenSet(false)
{
}

CoreInternalOutcome ModifyAuditTemplateResponse::Deserialize(const string &payload)
{
...
string ModifyAuditTemplateResponse::ToJsonString() const
{
...
int64_t ModifyAuditTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool ModifyAuditTemplateResponse::TemplateIdHasBeenSet() const
{
