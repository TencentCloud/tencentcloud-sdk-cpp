...
CreateLiveAvatarRoomResponse::CreateLiveAvatarRoomResponse() :
    m_roomIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateLiveAvatarRoomResponse::Deserialize(const string &payload)
{
...
string CreateLiveAvatarRoomResponse::ToJsonString() const
{
...
string CreateLiveAvatarRoomResponse::GetRoomId() const
{
    return m_roomId;
}

bool CreateLiveAvatarRoomResponse::RoomIdHasBeenSet() const
{
