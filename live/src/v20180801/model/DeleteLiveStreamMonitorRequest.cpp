...
string DeleteLiveStreamMonitorRequest::ToJsonString() const
{
...
string DeleteLiveStreamMonitorRequest::GetMonitorId() const
{
    return m_monitorId;
}

void DeleteLiveStreamMonitorRequest::SetMonitorId(const string& _monitorId)
{
    m_monitorId = _monitorId;
    m_monitorIdHasBeenSet = true;
}

bool DeleteLiveStreamMonitorRequest::MonitorIdHasBeenSet() const
{
