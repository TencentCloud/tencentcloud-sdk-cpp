...
CoreInternalOutcome DescribeAreaBillBandwidthAndFluxListResponse::Deserialize(const string &payload)
{
...
string DescribeAreaBillBandwidthAndFluxListResponse::ToJsonString() const
{
...
vector<BillAreaInfo> DescribeAreaBillBandwidthAndFluxListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeAreaBillBandwidthAndFluxListResponse::DataInfoListHasBeenSet() const
{
