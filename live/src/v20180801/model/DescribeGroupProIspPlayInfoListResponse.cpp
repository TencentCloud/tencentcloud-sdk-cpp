...
CoreInternalOutcome DescribeGroupProIspPlayInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeGroupProIspPlayInfoListResponse::ToJsonString() const
{
...
vector<GroupProIspDataInfo> DescribeGroupProIspPlayInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeGroupProIspPlayInfoListResponse::DataInfoListHasBeenSet() const
{
