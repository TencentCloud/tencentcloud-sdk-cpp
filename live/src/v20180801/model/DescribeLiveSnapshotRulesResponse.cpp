...
CoreInternalOutcome DescribeLiveSnapshotRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveSnapshotRulesResponse::ToJsonString() const
{
...
vector<RuleInfo> DescribeLiveSnapshotRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveSnapshotRulesResponse::RulesHasBeenSet() const
{
