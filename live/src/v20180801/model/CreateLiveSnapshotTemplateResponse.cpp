...
CoreInternalOutcome CreateLiveSnapshotTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLiveSnapshotTemplateResponse::ToJsonString() const
{
...
int64_t CreateLiveSnapshotTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateLiveSnapshotTemplateResponse::TemplateIdHasBeenSet() const
{
