...
CoreInternalOutcome DescribeLiveWatermarkRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveWatermarkRulesResponse::ToJsonString() const
{
...
vector<RuleInfo> DescribeLiveWatermarkRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveWatermarkRulesResponse::RulesHasBeenSet() const
{
