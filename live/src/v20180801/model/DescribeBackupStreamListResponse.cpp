...
DescribeBackupStreamListResponse::DescribeBackupStreamListResponse() :
    m_streamInfoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeBackupStreamListResponse::Deserialize(const string &payload)
{
...
string DescribeBackupStreamListResponse::ToJsonString() const
{
...
vector<BackupStreamGroupInfo> DescribeBackupStreamListResponse::GetStreamInfoList() const
{
    return m_streamInfoList;
}

bool DescribeBackupStreamListResponse::StreamInfoListHasBeenSet() const
{
