...
DescribePullTransformPushInfoListResponse::DescribePullTransformPushInfoListResponse() :
    m_dataInfoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribePullTransformPushInfoListResponse::Deserialize(const string &payload)
{
...
string DescribePullTransformPushInfoListResponse::ToJsonString() const
{
...
vector<TurnPushInfo> DescribePullTransformPushInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribePullTransformPushInfoListResponse::DataInfoListHasBeenSet() const
{
