...
CoreInternalOutcome DescribeLiveStreamPublishedListResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("PublishInfo") && !rsp["PublishInfo"].IsNull())
    {
        if (!rsp["PublishInfo"].IsArray())
            return CoreInternalOutcome(Core::Error("response `PublishInfo` is not array type"));

        const rapidjson::Value &tmpValue = rsp["PublishInfo"];
        for (rapidjson::Value::ConstValueIterator itr = tmpValue.Begin(); itr != tmpValue.End(); ++itr)
        {
            ...
            m_publishInfo.push_back(item);
        }
        m_publishInfoHasBeenSet = true;
    }
...
string DescribeLiveStreamPublishedListResponse::ToJsonString() const
{
    rapidjson::Document value;
    value.SetObject();
    rapidjson::Document::AllocatorType& allocator = value.GetAllocator();

    if (m_publishInfoHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "PublishInfo";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(rapidjson::kArrayType).Move(), allocator);

        int i=0;
        for (auto itr = m_publishInfo.begin(); itr != m_publishInfo.end(); ++itr, ++i)
        {
...
vector<StreamName> DescribeLiveStreamPublishedListResponse::GetPublishInfo() const
{
    return m_publishInfo;
}

bool DescribeLiveStreamPublishedListResponse::PublishInfoHasBeenSet() const
{
    return m_publishInfoHasBeenSet;
}

uint64_t DescribeLiveStreamPublishedListResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeLiveStreamPublishedListResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeLiveStreamPublishedListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeLiveStreamPublishedListResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeLiveStreamPublishedListResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeLiveStreamPublishedListResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeLiveStreamPublishedListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeLiveStreamPublishedListResponse::TotalPageHasBeenSet() const
{
