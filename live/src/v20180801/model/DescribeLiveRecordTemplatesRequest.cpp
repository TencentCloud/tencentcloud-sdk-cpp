...
int64_t DescribeLiveRecordTemplatesRequest::GetIsDelayLive() const
{
    return m_isDelayLive;
}

void DescribeLiveRecordTemplatesRequest::SetIsDelayLive(const int64_t& _isDelayLive)
{
    m_isDelayLive = _isDelayLive;
    m_isDelayLiveHasBeenSet = true;
}

bool DescribeLiveRecordTemplatesRequest::IsDelayLiveHasBeenSet() const
{
