...
DescribeLiveXP2PDetailInfoListResponse::DescribeLiveXP2PDetailInfoListResponse() :
    m_dataInfoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLiveXP2PDetailInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveXP2PDetailInfoListResponse::ToJsonString() const
{
...
vector<XP2PDetailInfo> DescribeLiveXP2PDetailInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeLiveXP2PDetailInfoListResponse::DataInfoListHasBeenSet() const
{
