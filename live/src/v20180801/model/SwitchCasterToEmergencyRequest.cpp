...
string SwitchCasterToEmergencyRequest::ToJsonString() const
{
...
uint64_t SwitchCasterToEmergencyRequest::GetCasterId() const
{
    return m_casterId;
}

void SwitchCasterToEmergencyRequest::SetCasterId(const uint64_t& _casterId)
{
