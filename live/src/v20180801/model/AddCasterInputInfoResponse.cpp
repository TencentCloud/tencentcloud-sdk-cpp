...
AddCasterInputInfoResponse::AddCasterInputInfoResponse() :
    m_inputPlayUrlHasBeenSet(false),
    m_inputWebRTCPlayUrlHasBeenSet(false)
{
}

CoreInternalOutcome AddCasterInputInfoResponse::Deserialize(const string &payload)
{
...
string AddCasterInputInfoResponse::ToJsonString() const
{
...
string AddCasterInputInfoResponse::GetInputPlayUrl() const
{
    return m_inputPlayUrl;
}

bool AddCasterInputInfoResponse::InputPlayUrlHasBeenSet() const
{
    return m_inputPlayUrlHasBeenSet;
}

string AddCasterInputInfoResponse::GetInputWebRTCPlayUrl() const
{
    return m_inputWebRTCPlayUrl;
}

bool AddCasterInputInfoResponse::InputWebRTCPlayUrlHasBeenSet() const
{
