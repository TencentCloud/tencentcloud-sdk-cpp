...
CoreInternalOutcome DescribeLiveTimeShiftRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveTimeShiftRulesResponse::ToJsonString() const
{
...
vector<RuleInfo> DescribeLiveTimeShiftRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveTimeShiftRulesResponse::RulesHasBeenSet() const
{
