...
CopyLiveAvatarRoomResponse::CopyLiveAvatarRoomResponse() :
    m_roomIdHasBeenSet(false)
{
}

CoreInternalOutcome CopyLiveAvatarRoomResponse::Deserialize(const string &payload)
{
...
string CopyLiveAvatarRoomResponse::ToJsonString() const
{
...
string CopyLiveAvatarRoomResponse::GetRoomId() const
{
    return m_roomId;
}

bool CopyLiveAvatarRoomResponse::RoomIdHasBeenSet() const
{
