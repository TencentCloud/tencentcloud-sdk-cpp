...
CoreInternalOutcome DescribeLiveTranscodeRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveTranscodeRulesResponse::ToJsonString() const
{
...
vector<RuleInfo> DescribeLiveTranscodeRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveTranscodeRulesResponse::RulesHasBeenSet() const
{
