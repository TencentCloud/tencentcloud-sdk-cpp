...
CoreInternalOutcome DescribeTranscodeTaskNumResponse::Deserialize(const string &payload)
{
...
string DescribeTranscodeTaskNumResponse::ToJsonString() const
{
...
vector<TranscodeTaskNum> DescribeTranscodeTaskNumResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeTranscodeTaskNumResponse::DataInfoListHasBeenSet() const
{
