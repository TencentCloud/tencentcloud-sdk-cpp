...
CoreInternalOutcome DescribeDeliverBandwidthListResponse::Deserialize(const string &payload)
{
...
string DescribeDeliverBandwidthListResponse::ToJsonString() const
{
...
vector<BandwidthInfo> DescribeDeliverBandwidthListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeDeliverBandwidthListResponse::DataInfoListHasBeenSet() const
{
