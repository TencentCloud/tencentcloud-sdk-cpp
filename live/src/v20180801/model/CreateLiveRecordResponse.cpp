...
CoreInternalOutcome CreateLiveRecordResponse::Deserialize(const string &payload)
{
...
string CreateLiveRecordResponse::ToJsonString() const
{
...
uint64_t CreateLiveRecordResponse::GetTaskId() const
{
    return m_taskId;
}

bool CreateLiveRecordResponse::TaskIdHasBeenSet() const
{
