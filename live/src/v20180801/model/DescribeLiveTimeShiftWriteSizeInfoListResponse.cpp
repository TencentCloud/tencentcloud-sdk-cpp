...
DescribeLiveTimeShiftWriteSizeInfoListResponse::DescribeLiveTimeShiftWriteSizeInfoListResponse() :
    m_dataInfoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLiveTimeShiftWriteSizeInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveTimeShiftWriteSizeInfoListResponse::ToJsonString() const
{
...
vector<TimeShiftWriteSizeData> DescribeLiveTimeShiftWriteSizeInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeLiveTimeShiftWriteSizeInfoListResponse::DataInfoListHasBeenSet() const
{
