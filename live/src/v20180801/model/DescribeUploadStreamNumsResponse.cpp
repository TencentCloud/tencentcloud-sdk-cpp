...
CoreInternalOutcome DescribeUploadStreamNumsResponse::Deserialize(const string &payload)
{
...
string DescribeUploadStreamNumsResponse::ToJsonString() const
{
...
vector<ConcurrentRecordStreamNum> DescribeUploadStreamNumsResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeUploadStreamNumsResponse::DataInfoListHasBeenSet() const
{
