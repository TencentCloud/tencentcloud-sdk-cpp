...
CoreInternalOutcome CreateLiveTimeShiftTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLiveTimeShiftTemplateResponse::ToJsonString() const
{
...
int64_t CreateLiveTimeShiftTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateLiveTimeShiftTemplateResponse::TemplateIdHasBeenSet() const
{
