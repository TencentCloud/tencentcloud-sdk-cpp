...
CoreInternalOutcome CreateLiveTranscodeTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLiveTranscodeTemplateResponse::ToJsonString() const
{
...
int64_t CreateLiveTranscodeTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateLiveTranscodeTemplateResponse::TemplateIdHasBeenSet() const
{
