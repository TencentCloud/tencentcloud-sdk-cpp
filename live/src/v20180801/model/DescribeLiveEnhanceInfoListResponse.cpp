...
DescribeLiveEnhanceInfoListResponse::DescribeLiveEnhanceInfoListResponse() :
    m_dataInfoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLiveEnhanceInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveEnhanceInfoListResponse::ToJsonString() const
{
...
vector<LiveEnhanceInfo> DescribeLiveEnhanceInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeLiveEnhanceInfoListResponse::DataInfoListHasBeenSet() const
{
