...
CoreInternalOutcome DescribeStreamPushInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPushInfoListResponse::ToJsonString() const
{
...
vector<PushQualityData> DescribeStreamPushInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeStreamPushInfoListResponse::DataInfoListHasBeenSet() const
{
