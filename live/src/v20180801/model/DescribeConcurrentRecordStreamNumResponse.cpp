...
CoreInternalOutcome DescribeConcurrentRecordStreamNumResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("DataInfoList") && !rsp["DataInfoList"].IsNull())
    {
        ...
        {
            ConcurrentRecordStreamNum item;
...
string DescribeConcurrentRecordStreamNumResponse::ToJsonString() const
{
...
vector<ConcurrentRecordStreamNum> DescribeConcurrentRecordStreamNumResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeConcurrentRecordStreamNumResponse::DataInfoListHasBeenSet() const
{
