...
CoreInternalOutcome DescribePushBandwidthAndFluxListResponse::Deserialize(const string &payload)
{
...
string DescribePushBandwidthAndFluxListResponse::ToJsonString() const
{
...
string DescribePushBandwidthAndFluxListResponse::GetPeakBandwidthTime() const
{
    return m_peakBandwidthTime;
}

bool DescribePushBandwidthAndFluxListResponse::PeakBandwidthTimeHasBeenSet() const
{
    return m_peakBandwidthTimeHasBeenSet;
}

double DescribePushBandwidthAndFluxListResponse::GetPeakBandwidth() const
{
    return m_peakBandwidth;
}

bool DescribePushBandwidthAndFluxListResponse::PeakBandwidthHasBeenSet() const
{
    return m_peakBandwidthHasBeenSet;
}

string DescribePushBandwidthAndFluxListResponse::GetP95PeakBandwidthTime() const
{
    return m_p95PeakBandwidthTime;
}

bool DescribePushBandwidthAndFluxListResponse::P95PeakBandwidthTimeHasBeenSet() const
{
    return m_p95PeakBandwidthTimeHasBeenSet;
}

double DescribePushBandwidthAndFluxListResponse::GetP95PeakBandwidth() const
{
    return m_p95PeakBandwidth;
}

bool DescribePushBandwidthAndFluxListResponse::P95PeakBandwidthHasBeenSet() const
{
    return m_p95PeakBandwidthHasBeenSet;
}

double DescribePushBandwidthAndFluxListResponse::GetSumFlux() const
{
    return m_sumFlux;
}

bool DescribePushBandwidthAndFluxListResponse::SumFluxHasBeenSet() const
{
    return m_sumFluxHasBeenSet;
}

vector<BillDataInfo> DescribePushBandwidthAndFluxListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribePushBandwidthAndFluxListResponse::DataInfoListHasBeenSet() const
{
