...
CoreInternalOutcome DescribeLiveTimeShiftBillInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveTimeShiftBillInfoListResponse::ToJsonString() const
{
...
vector<TimeShiftBillData> DescribeLiveTimeShiftBillInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeLiveTimeShiftBillInfoListResponse::DataInfoListHasBeenSet() const
{
