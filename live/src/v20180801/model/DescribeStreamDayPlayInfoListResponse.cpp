...
CoreInternalOutcome DescribeStreamDayPlayInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeStreamDayPlayInfoListResponse::ToJsonString() const
{
...
vector<PlayDataInfoByStream> DescribeStreamDayPlayInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeStreamDayPlayInfoListResponse::DataInfoListHasBeenSet() const
{
    return m_dataInfoListHasBeenSet;
}

uint64_t DescribeStreamDayPlayInfoListResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamDayPlayInfoListResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamDayPlayInfoListResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamDayPlayInfoListResponse::TotalPageHasBeenSet() const
{
    return m_totalPageHasBeenSet;
}

uint64_t DescribeStreamDayPlayInfoListResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamDayPlayInfoListResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamDayPlayInfoListResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamDayPlayInfoListResponse::PageSizeHasBeenSet() const
{
