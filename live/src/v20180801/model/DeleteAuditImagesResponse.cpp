...
DeleteAuditImagesResponse::DeleteAuditImagesResponse() :
    m_infosHasBeenSet(false)
{
}

CoreInternalOutcome DeleteAuditImagesResponse::Deserialize(const string &payload)
{
...
string DeleteAuditImagesResponse::ToJsonString() const
{
...
vector<AuditImageDeleteDetail> DeleteAuditImagesResponse::GetInfos() const
{
    return m_infos;
}

bool DeleteAuditImagesResponse::InfosHasBeenSet() const
{
