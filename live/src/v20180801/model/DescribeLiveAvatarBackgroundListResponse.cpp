...
DescribeLiveAvatarBackgroundListResponse::DescribeLiveAvatarBackgroundListResponse() :
    m_infoListHasBeenSet(false)
{
}

CoreInternalOutcome DescribeLiveAvatarBackgroundListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveAvatarBackgroundListResponse::ToJsonString() const
{
...
vector<AvatarBackgroundInfo> DescribeLiveAvatarBackgroundListResponse::GetInfoList() const
{
    return m_infoList;
}

bool DescribeLiveAvatarBackgroundListResponse::InfoListHasBeenSet() const
{
