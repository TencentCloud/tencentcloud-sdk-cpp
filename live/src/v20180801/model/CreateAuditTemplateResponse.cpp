...
CreateAuditTemplateResponse::CreateAuditTemplateResponse() :
    m_templateIdHasBeenSet(false)
{
}

CoreInternalOutcome CreateAuditTemplateResponse::Deserialize(const string &payload)
{
...
string CreateAuditTemplateResponse::ToJsonString() const
{
...
int64_t CreateAuditTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateAuditTemplateResponse::TemplateIdHasBeenSet() const
{
