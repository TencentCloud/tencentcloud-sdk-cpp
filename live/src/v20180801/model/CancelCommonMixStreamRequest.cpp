...
string CancelCommonMixStreamRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
    ...
    if (m_mixStreamSessionIdHasBeenSet)
    {
        ...
        d.AddMember(iKey, Value(m_mixStreamSessionId.c_str(), allocator).Move(), allocator);
    }
...
string CancelCommonMixStreamRequest::GetMixStreamSessionId() const
{
    return m_mixStreamSessionId;
}

void CancelCommonMixStreamRequest::SetMixStreamSessionId(const string& _mixStreamSessionId)
{
    m_mixStreamSessionId = _mixStreamSessionId;
    m_mixStreamSessionIdHasBeenSet = true;
}

bool CancelCommonMixStreamRequest::MixStreamSessionIdHasBeenSet() const
{
