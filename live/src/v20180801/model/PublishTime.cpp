...
CoreInternalOutcome PublishTime::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
...
void PublishTime::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
