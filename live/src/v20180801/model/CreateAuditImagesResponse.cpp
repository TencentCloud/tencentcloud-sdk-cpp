...
CreateAuditImagesResponse::CreateAuditImagesResponse() :
    m_infosHasBeenSet(false)
{
}

CoreInternalOutcome CreateAuditImagesResponse::Deserialize(const string &payload)
{
...
string CreateAuditImagesResponse::ToJsonString() const
{
...
vector<AuditImageCreateDetail> CreateAuditImagesResponse::GetInfos() const
{
    return m_infos;
}

bool CreateAuditImagesResponse::InfosHasBeenSet() const
{
