...
DescribeSceneVideoTaskResponse::DescribeSceneVideoTaskResponse() :
...
CoreInternalOutcome DescribeSceneVideoTaskResponse::Deserialize(const string &payload)
{
...
string DescribeSceneVideoTaskResponse::ToJsonString() const
{
...
vector<SceneVideoOutputInfo> DescribeSceneVideoTaskResponse::GetInfoList() const
{
    return m_infoList;
}

bool DescribeSceneVideoTaskResponse::InfoListHasBeenSet() const
{
    return m_infoListHasBeenSet;
}

string DescribeSceneVideoTaskResponse::GetStatus() const
{
    return m_status;
}

bool DescribeSceneVideoTaskResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeSceneVideoTaskResponse::GetResolution() const
{
    return m_resolution;
}

bool DescribeSceneVideoTaskResponse::ResolutionHasBeenSet() const
{
    return m_resolutionHasBeenSet;
}

string DescribeSceneVideoTaskResponse::GetMessage() const
{
    return m_message;
}

bool DescribeSceneVideoTaskResponse::MessageHasBeenSet() const
{
    return m_messageHasBeenSet;
}

vector<string> DescribeSceneVideoTaskResponse::GetVideoUrls() const
{
    return m_videoUrls;
}

bool DescribeSceneVideoTaskResponse::VideoUrlsHasBeenSet() const
{
