...
CoreInternalOutcome CreateLivePadTemplateResponse::Deserialize(const string &payload)
{
...
string CreateLivePadTemplateResponse::ToJsonString() const
{
...
int64_t CreateLivePadTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateLivePadTemplateResponse::TemplateIdHasBeenSet() const
{
