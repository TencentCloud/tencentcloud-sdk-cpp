...
DescribeLiveAvatarRoomsResponse::DescribeLiveAvatarRoomsResponse() :
...
CoreInternalOutcome DescribeLiveAvatarRoomsResponse::Deserialize(const string &payload)
{
...
string DescribeLiveAvatarRoomsResponse::ToJsonString() const
{
...
vector<AvatarRoomInfo> DescribeLiveAvatarRoomsResponse::GetInfoList() const
{
    return m_infoList;
}

bool DescribeLiveAvatarRoomsResponse::InfoListHasBeenSet() const
{
    return m_infoListHasBeenSet;
}

int64_t DescribeLiveAvatarRoomsResponse::GetLimitCreateNum() const
{
    return m_limitCreateNum;
}

bool DescribeLiveAvatarRoomsResponse::LimitCreateNumHasBeenSet() const
{
    return m_limitCreateNumHasBeenSet;
}

int64_t DescribeLiveAvatarRoomsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeLiveAvatarRoomsResponse::TotalNumHasBeenSet() const
{
