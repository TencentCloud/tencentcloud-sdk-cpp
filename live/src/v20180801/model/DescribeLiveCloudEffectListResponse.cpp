...
CoreInternalOutcome DescribeLiveCloudEffectListResponse::Deserialize(const string &payload)
{
...
string DescribeLiveCloudEffectListResponse::ToJsonString() const
{
...
vector<CloudEffectInfo> DescribeLiveCloudEffectListResponse::GetInfoList() const
{
    return m_infoList;
}
