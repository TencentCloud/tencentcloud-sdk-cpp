...
CoreInternalOutcome DescribeLiveTranscodeTotalInfoResponse::Deserialize(const string &payload)
{
...
string DescribeLiveTranscodeTotalInfoResponse::ToJsonString() const
{
...
vector<TranscodeTotalInfo> DescribeLiveTranscodeTotalInfoResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeLiveTranscodeTotalInfoResponse::DataInfoListHasBeenSet() const
{
