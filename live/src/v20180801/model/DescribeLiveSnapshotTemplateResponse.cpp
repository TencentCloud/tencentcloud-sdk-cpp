...
CoreInternalOutcome DescribeLiveSnapshotTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeLiveSnapshotTemplateResponse::ToJsonString() const
{
...
SnapshotTemplateInfo DescribeLiveSnapshotTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool DescribeLiveSnapshotTemplateResponse::TemplateHasBeenSet() const
{
