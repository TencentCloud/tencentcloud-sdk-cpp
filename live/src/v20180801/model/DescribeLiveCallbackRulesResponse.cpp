...
CoreInternalOutcome DescribeLiveCallbackRulesResponse::Deserialize(const string &payload)
{
...
string DescribeLiveCallbackRulesResponse::ToJsonString() const
{
...
vector<CallBackRuleInfo> DescribeLiveCallbackRulesResponse::GetRules() const
{
    return m_rules;
}

bool DescribeLiveCallbackRulesResponse::RulesHasBeenSet() const
{
