...
StopLivePadProcessorResponse::StopLivePadProcessorResponse() :
    m_resultMessageHasBeenSet(false)
{
}

CoreInternalOutcome StopLivePadProcessorResponse::Deserialize(const string &payload)
{
...
string StopLivePadProcessorResponse::ToJsonString() const
{
...
string StopLivePadProcessorResponse::GetResultMessage() const
{
    return m_resultMessage;
}

bool StopLivePadProcessorResponse::ResultMessageHasBeenSet() const
{
