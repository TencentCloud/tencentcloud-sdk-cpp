...
CoreInternalOutcome DescribeStreamPlayInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPlayInfoListResponse::ToJsonString() const
{
...
vector<DayStreamPlayInfo> DescribeStreamPlayInfoListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeStreamPlayInfoListResponse::DataInfoListHasBeenSet() const
{
