...
CoreInternalOutcome DescribeScreenShotSheetNumListResponse::Deserialize(const string &payload)
{
...
string DescribeScreenShotSheetNumListResponse::ToJsonString() const
{
...
vector<TimeValue> DescribeScreenShotSheetNumListResponse::GetDataInfoList() const
{
    return m_dataInfoList;
}

bool DescribeScreenShotSheetNumListResponse::DataInfoListHasBeenSet() const
{
