...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_CREATEAUDITTEMPLATEREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_CREATEAUDITTEMPLATEREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class CreateAuditTemplateRequest : public AbstractModel
                {
                public:
                    CreateAuditTemplateRequest();
                    ~CreateAuditTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_CREATEAUDITTEMPLATEREQUEST_H_
