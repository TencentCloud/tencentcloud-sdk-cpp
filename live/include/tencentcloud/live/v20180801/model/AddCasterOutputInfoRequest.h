...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTEROUTPUTINFOREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTEROUTPUTINFOREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class AddCasterOutputInfoRequest : public AbstractModel
                {
                public:
                    AddCasterOutputInfoRequest();
                    ~AddCasterOutputInfoRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTEROUTPUTINFOREQUEST_H_
