...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPGMRESPONSE_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPGMRESPONSE_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class CreateCasterPgmResponse : public AbstractModel
                {
                public:
                    CreateCasterPgmResponse();
                    ~CreateCasterPgmResponse() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPGMRESPONSE_H_
