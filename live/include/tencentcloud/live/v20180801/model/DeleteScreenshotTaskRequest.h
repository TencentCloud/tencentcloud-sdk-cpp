...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_DELETESCREENSHOTTASKREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_DELETESCREENSHOTTASKREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class DeleteScreenshotTaskRequest : public AbstractModel
                {
                public:
                    DeleteScreenshotTaskRequest();
                    ~DeleteScreenshotTaskRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_DELETESCREENSHOTTASKREQUEST_H_
