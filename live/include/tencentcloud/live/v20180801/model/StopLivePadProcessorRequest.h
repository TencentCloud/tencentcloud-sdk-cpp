...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_STOPLIVEPADPROCESSORREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_STOPLIVEPADPROCESSORREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class StopLivePadProcessorRequest : public AbstractModel
                {
                public:
                    StopLivePadProcessorRequest();
                    ~StopLivePadProcessorRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_STOPLIVEPADPROCESSORREQUEST_H_
