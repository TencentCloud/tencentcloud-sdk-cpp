...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPVWREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPVWREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class CreateCasterPvwRequest : public AbstractModel
                {
                public:
                    CreateCasterPvwRequest();
                    ~CreateCasterPvwRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取导播台预监展示信息参数
                     * @return PvwDisplayInfo 导播台预监展示信息参数
                     * 
                     */
                     ...
                     * 
                     */
                    void SetPvwDisplayInfo(const CasterDisplayInfo& _pvwDisplayInfo);
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_CREATECASTERPVWREQUEST_H_
