...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERLAYOUTINFOREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERLAYOUTINFOREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class AddCasterLayoutInfoRequest : public AbstractModel
                {
                public:
                    AddCasterLayoutInfoRequest();
                    ~AddCasterLayoutInfoRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERLAYOUTINFOREQUEST_H_
