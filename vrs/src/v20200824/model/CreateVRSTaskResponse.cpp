...
CreateVRSTaskResponse::CreateVRSTaskResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome CreateVRSTaskResponse::Deserialize(const string &payload)
{
...
string CreateVRSTaskResponse::ToJsonString() const
{
...
CreateVRSTaskRespData CreateVRSTaskResponse::GetData() const
{
    return m_data;
}

bool CreateVRSTaskResponse::DataHasBeenSet() const
{
