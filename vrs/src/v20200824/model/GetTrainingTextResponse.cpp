...
GetTrainingTextResponse::GetTrainingTextResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome GetTrainingTextResponse::Deserialize(const string &payload)
{
...
string GetTrainingTextResponse::ToJsonString() const
{
...
TrainingTexts GetTrainingTextResponse::GetData() const
{
    return m_data;
}

bool GetTrainingTextResponse::DataHasBeenSet() const
{
