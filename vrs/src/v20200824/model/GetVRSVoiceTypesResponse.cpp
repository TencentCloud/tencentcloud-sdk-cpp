...
GetVRSVoiceTypesResponse::GetVRSVoiceTypesResponse() :
    m_dataHasBeenSet(false)
{
}

CoreInternalOutcome GetVRSVoiceTypesResponse::Deserialize(const string &payload)
{
...
string GetVRSVoiceTypesResponse::ToJsonString() const
{
...
VoiceTypeListData GetVRSVoiceTypesResponse::GetData() const
{
    return m_data;
}

bool GetVRSVoiceTypesResponse::DataHasBeenSet() const
{
