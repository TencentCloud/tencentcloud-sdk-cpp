            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取国内站标准版填写standards2, 专业版填写profession
                    ...
                    /**
                     * 设置国内站标准版填写standards2, 专业版填写profession
                     * @param _instanceType 国内站标准版填写standards2, 专业版填写profession
                     * 
                     */
                    ...
                    /**
                     * 设置实例内网带宽大小, 单位MB/s (购买时必填)
                     * @param _bandwidth 实例内网带宽大小, 单位MB/s (购买时必填)
                     * 
                     */
                    ...
                    /**
                     * 设置实例的硬盘购买类型以及大小 (购买时必填)
                     * @param _inquiryDiskParam 实例的硬盘购买类型以及大小 (购买时必填)
                     * 
                     */
                    ...
                    /**
                     * 设置购买实例分区数, 单位个 (购买时必填)
                     * @param _partition 购买实例分区数, 单位个 (购买时必填)
                     * 
                     */
