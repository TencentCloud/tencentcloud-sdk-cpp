...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_ASSOCIATEROUTESSECURITYGROUPREQUEST_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_ASSOCIATEROUTESSECURITYGROUPREQUEST_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                */
                class AssociateRoutesSecurityGroupRequest : public AbstractModel
                {
                public:
                    AssociateRoutesSecurityGroupRequest();
                    ~AssociateRoutesSecurityGroupRequest() = default;
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_ASSOCIATEROUTESSECURITYGROUPREQUEST_H_
