            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Es连接源的实例vip，当为腾讯云实例时，必填</p>
                    ...
                    /**
                     * 设置<p>Es连接源的实例vip，当为腾讯云实例时，必填</p>
                    ...
                    /**
                     * 获取<p>Es连接源的vpcId，当为腾讯云实例时，必填</p>
                    ...
                    /**
                     * 设置<p>Es连接源的vpcId，当为腾讯云实例时，必填</p>
