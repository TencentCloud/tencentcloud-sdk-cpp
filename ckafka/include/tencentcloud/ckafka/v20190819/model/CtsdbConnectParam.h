...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_CTSDBCONNECTPARAM_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_CTSDBCONNECTPARAM_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                * Ctsdb连接源参数
                */
                class CtsdbConnectParam : public AbstractModel
                {
                public:
                    CtsdbConnectParam();
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_CTSDBCONNECTPARAM_H_
