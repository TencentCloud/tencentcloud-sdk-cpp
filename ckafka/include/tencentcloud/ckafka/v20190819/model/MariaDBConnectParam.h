...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBCONNECTPARAM_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBCONNECTPARAM_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                * MariaDB连接源参数
                */
                class MariaDBConnectParam : public AbstractModel
                {
                public:
                    MariaDBConnectParam();
                    ~MariaDBConnectParam() = default;
                    ...
                    /**
                     * 获取MariaDB连接源的实例资源
                     * @return Resource MariaDB连接源的实例资源
                     * 
                     */
                    ...
                    /**
                     * 获取MariaDB连接源的实例vip，当为腾讯云实例时，必填
                     * @return ServiceVip MariaDB连接源的实例vip，当为腾讯云实例时，必填
                     * 
                     */
                    std::string GetServiceVip() const;

                    /**
                     * 设置MariaDB连接源的实例vip，当为腾讯云实例时，必填
                    ...
                    /**
                     * 获取MariaDB连接源的vpcId，当为腾讯云实例时，必填
                     * @return UniqVpcId MariaDB连接源的vpcId，当为腾讯云实例时，必填
                     * 
                     */
                    std::string GetUniqVpcId() const;

                    /**
                     * 设置MariaDB连接源的vpcId，当为腾讯云实例时，必填
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBCONNECTPARAM_H_
