...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_CREATEMETADATAANDOFFSETSYNCDATAHUBTASKREQUEST_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_CREATEMETADATAANDOFFSETSYNCDATAHUBTASKREQUEST_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                */
                class CreateMetaDataAndOffsetSyncDatahubTaskRequest : public AbstractModel
                {
                public:
                    CreateMetaDataAndOffsetSyncDatahubTaskRequest();
                    ~CreateMetaDataAndOffsetSyncDatahubTaskRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
                     * @return TaskName <p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
                     * 
                     */
                    std::string GetTaskName() const;

                    /**
                     * 设置<p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
                    ...
                    /**
                     * 获取<p>同步目标链接</p><p>参数格式：resource-test</p>
                     * @return TargetResourceId <p>同步目标链接</p><p>参数格式：resource-test</p>
                     * 
                     */
                    std::string GetTargetResourceId() const;

                    /**
                     * 设置<p>同步目标链接</p><p>参数格式：resource-test</p>
                    ...
                    /**
                     * 获取<p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
                     * @return OffsetType <p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
                     * 
                     */
                    std::string GetOffsetType() const;

                    /**
                     * 设置<p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_CREATEMETADATAANDOFFSETSYNCDATAHUBTASKREQUEST_H_
