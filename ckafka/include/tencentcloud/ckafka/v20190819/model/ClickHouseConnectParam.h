...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_CLICKHOUSECONNECTPARAM_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_CLICKHOUSECONNECTPARAM_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                * ClickHouse连接源参数
                */
                class ClickHouseConnectParam : public AbstractModel
                {
                public:
                    ClickHouseConnectParam();
                    ~ClickHouseConnectParam() = default;
                    ...
                    /**
                     * 获取ClickHouse连接源的实例vip，当为腾讯云实例时，必填
                    ...
                    /**
                     * 设置ClickHouse连接源的实例vip，当为腾讯云实例时，必填
                    ...
                    /**
                     * 获取ClickHouse连接源的vpcId，当为腾讯云实例时，必填
                    ...
                    /**
                     * 设置ClickHouse连接源的vpcId，当为腾讯云实例时，必填
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_CLICKHOUSECONNECTPARAM_H_
