...
CoreInternalOutcome CreateTokenResponse::Deserialize(const string &payload)
{
...
string CreateTokenResponse::ToJsonString() const
{
...
string CreateTokenResponse::GetResult() const
{
    return m_result;
}

bool CreateTokenResponse::ResultHasBeenSet() const
{
