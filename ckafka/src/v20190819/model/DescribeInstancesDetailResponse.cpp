...
CoreInternalOutcome DescribeInstancesDetailResponse::Deserialize(const string &payload)
{
...
string DescribeInstancesDetailResponse::ToJsonString() const
{
...
InstanceDetailResponse DescribeInstancesDetailResponse::GetResult() const
{
    return m_result;
}

bool DescribeInstancesDetailResponse::ResultHasBeenSet() const
{
