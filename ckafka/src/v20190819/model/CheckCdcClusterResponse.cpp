...
CoreInternalOutcome CheckCdcClusterResponse::Deserialize(const string &payload)
{
...
string CheckCdcClusterResponse::ToJsonString() const
{
...
string CheckCdcClusterResponse::GetResult() const
{
    return m_result;
}

bool CheckCdcClusterResponse::ResultHasBeenSet() const
{
