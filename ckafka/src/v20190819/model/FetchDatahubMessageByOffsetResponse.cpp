...
CoreInternalOutcome FetchDatahubMessageByOffsetResponse::Deserialize(const string &payload)
{
...
string FetchDatahubMessageByOffsetResponse::ToJsonString() const
{
...
ConsumerRecord FetchDatahubMessageByOffsetResponse::GetResult() const
{
    return m_result;
}

bool FetchDatahubMessageByOffsetResponse::ResultHasBeenSet() const
{
