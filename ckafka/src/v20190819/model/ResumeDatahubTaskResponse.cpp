...
ResumeDatahubTaskResponse::ResumeDatahubTaskResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome ResumeDatahubTaskResponse::Deserialize(const string &payload)
{
...
string ResumeDatahubTaskResponse::ToJsonString() const
{
...
DatahubTaskIdRes ResumeDatahubTaskResponse::GetResult() const
{
    return m_result;
}

bool ResumeDatahubTaskResponse::ResultHasBeenSet() const
{
