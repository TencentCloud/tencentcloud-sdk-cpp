...
CoreInternalOutcome ModifyTopicAttributesResponse::Deserialize(const string &payload)
{
...
string ModifyTopicAttributesResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyTopicAttributesResponse::GetResult() const
{
    return m_result;
}

bool ModifyTopicAttributesResponse::ResultHasBeenSet() const
{
