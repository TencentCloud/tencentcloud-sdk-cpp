...
CoreInternalOutcome InstanceScalingDownResponse::Deserialize(const string &payload)
{
...
string InstanceScalingDownResponse::ToJsonString() const
{
...
ScalingDownResp InstanceScalingDownResponse::GetResult() const
{
    return m_result;
}

bool InstanceScalingDownResponse::ResultHasBeenSet() const
{
