...
CoreInternalOutcome DescribeGroupOffsetsResponse::Deserialize(const string &payload)
{
...
string DescribeGroupOffsetsResponse::ToJsonString() const
{
...
GroupOffsetResponse DescribeGroupOffsetsResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupOffsetsResponse::ResultHasBeenSet() const
{
