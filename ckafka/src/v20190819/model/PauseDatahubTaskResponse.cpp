...
PauseDatahubTaskResponse::PauseDatahubTaskResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome PauseDatahubTaskResponse::Deserialize(const string &payload)
{
...
string PauseDatahubTaskResponse::ToJsonString() const
{
...
DatahubTaskIdRes PauseDatahubTaskResponse::GetResult() const
{
    return m_result;
}

bool PauseDatahubTaskResponse::ResultHasBeenSet() const
{
