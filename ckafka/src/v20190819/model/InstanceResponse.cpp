...
CoreInternalOutcome InstanceResponse::Deserialize(const Value &value)
{
    string requestId = "";
...
void InstanceResponse::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
