...
CoreInternalOutcome IsolatedInstancePreResponse::Deserialize(const string &payload)
{
...
string IsolatedInstancePreResponse::ToJsonString() const
{
...
CreateInstancePreResp IsolatedInstancePreResponse::GetResult() const
{
    return m_result;
}

bool IsolatedInstancePreResponse::ResultHasBeenSet() const
{
