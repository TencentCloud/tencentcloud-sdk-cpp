...
CoreInternalOutcome DescribeTopicSubscribeGroupResponse::Deserialize(const string &payload)
{
...
string DescribeTopicSubscribeGroupResponse::ToJsonString() const
{
...
TopicSubscribeGroup DescribeTopicSubscribeGroupResponse::GetResult() const
{
    return m_result;
}

bool DescribeTopicSubscribeGroupResponse::ResultHasBeenSet() const
{
