...
CoreInternalOutcome DescribeConnectResourcesResponse::Deserialize(const string &payload)
{
...
string DescribeConnectResourcesResponse::ToJsonString() const
{
...
DescribeConnectResourcesResp DescribeConnectResourcesResponse::GetResult() const
{
    return m_result;
}

bool DescribeConnectResourcesResponse::ResultHasBeenSet() const
{
