...
CreatePrometheusResponse::CreatePrometheusResponse() :
    m_resultHasBeenSet(false)
{
}

CoreInternalOutcome CreatePrometheusResponse::Deserialize(const string &payload)
{
...
string CreatePrometheusResponse::ToJsonString() const
{
...
PrometheusResult CreatePrometheusResponse::GetResult() const
{
    return m_result;
}

bool CreatePrometheusResponse::ResultHasBeenSet() const
{
