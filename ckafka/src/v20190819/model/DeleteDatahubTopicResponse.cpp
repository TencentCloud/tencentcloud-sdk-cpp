...
CoreInternalOutcome DeleteDatahubTopicResponse::Deserialize(const string &payload)
{
...
string DeleteDatahubTopicResponse::ToJsonString() const
{
...
JgwOperateResponse DeleteDatahubTopicResponse::GetResult() const
{
    return m_result;
}

bool DeleteDatahubTopicResponse::ResultHasBeenSet() const
{
