...
CoreInternalOutcome DescribeTopicAttributesResponse::Deserialize(const string &payload)
{
...
string DescribeTopicAttributesResponse::ToJsonString() const
{
...
TopicAttributesResponse DescribeTopicAttributesResponse::GetResult() const
{
    return m_result;
}

bool DescribeTopicAttributesResponse::ResultHasBeenSet() const
{
