...
CoreInternalOutcome DescribeConnectResourceResponse::Deserialize(const string &payload)
{
...
string DescribeConnectResourceResponse::ToJsonString() const
{
...
DescribeConnectResourceResp DescribeConnectResourceResponse::GetResult() const
{
    return m_result;
}

bool DescribeConnectResourceResponse::ResultHasBeenSet() const
{
