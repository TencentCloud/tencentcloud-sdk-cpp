...
CoreInternalOutcome DeleteTopicResponse::Deserialize(const string &payload)
{
...
string DeleteTopicResponse::ToJsonString() const
{
...
JgwOperateResponse DeleteTopicResponse::GetResult() const
{
    return m_result;
}

bool DeleteTopicResponse::ResultHasBeenSet() const
{
