...
CoreInternalOutcome ModifyInstancePreResponse::Deserialize(const string &payload)
{
...
string ModifyInstancePreResponse::ToJsonString() const
{
...
CreateInstancePreResp ModifyInstancePreResponse::GetResult() const
{
    return m_result;
}

bool ModifyInstancePreResponse::ResultHasBeenSet() const
{
