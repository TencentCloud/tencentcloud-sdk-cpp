...
CoreInternalOutcome DescribeInstanceAttributesResponse::Deserialize(const string &payload)
{
...
string DescribeInstanceAttributesResponse::ToJsonString() const
{
...
InstanceAttributesResponse DescribeInstanceAttributesResponse::GetResult() const
{
    return m_result;
}

bool DescribeInstanceAttributesResponse::ResultHasBeenSet() const
{
