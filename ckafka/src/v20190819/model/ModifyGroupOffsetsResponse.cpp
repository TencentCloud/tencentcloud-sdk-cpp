...
CoreInternalOutcome ModifyGroupOffsetsResponse::Deserialize(const string &payload)
{
...
string ModifyGroupOffsetsResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyGroupOffsetsResponse::GetResult() const
{
    return m_result;
}

bool ModifyGroupOffsetsResponse::ResultHasBeenSet() const
{
