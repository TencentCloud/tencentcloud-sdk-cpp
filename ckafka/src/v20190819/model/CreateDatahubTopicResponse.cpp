...
CoreInternalOutcome CreateDatahubTopicResponse::Deserialize(const string &payload)
{
...
string CreateDatahubTopicResponse::ToJsonString() const
{
...
DatahubTopicResp CreateDatahubTopicResponse::GetResult() const
{
    return m_result;
}

bool CreateDatahubTopicResponse::ResultHasBeenSet() const
{
