...
CoreInternalOutcome FetchLatestDatahubMessageListResponse::Deserialize(const string &payload)
{
...
string FetchLatestDatahubMessageListResponse::ToJsonString() const
{
...
vector<ConsumerRecord> FetchLatestDatahubMessageListResponse::GetResult() const
{
    return m_result;
}

bool FetchLatestDatahubMessageListResponse::ResultHasBeenSet() const
{
