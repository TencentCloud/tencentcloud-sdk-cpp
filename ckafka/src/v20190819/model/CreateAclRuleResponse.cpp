...
CoreInternalOutcome CreateAclRuleResponse::Deserialize(const string &payload)
{
...
string CreateAclRuleResponse::ToJsonString() const
{
...
int64_t CreateAclRuleResponse::GetResult() const
{
    return m_result;
}

bool CreateAclRuleResponse::ResultHasBeenSet() const
{
