...
RenewCkafkaInstanceResponse::RenewCkafkaInstanceResponse() :
    m_bigDealIdHasBeenSet(false),
    m_dealNameHasBeenSet(false)
{
}

CoreInternalOutcome RenewCkafkaInstanceResponse::Deserialize(const string &payload)
{
...
string RenewCkafkaInstanceResponse::ToJsonString() const
{
...
string RenewCkafkaInstanceResponse::GetBigDealId() const
{
    return m_bigDealId;
}

bool RenewCkafkaInstanceResponse::BigDealIdHasBeenSet() const
{
    return m_bigDealIdHasBeenSet;
}

string RenewCkafkaInstanceResponse::GetDealName() const
{
    return m_dealName;
}

bool RenewCkafkaInstanceResponse::DealNameHasBeenSet() const
{
