...
CoreInternalOutcome BatchModifyTopicAttributesResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Result") && !rsp["Result"].IsNull())
    {
        ...
        {
            BatchModifyTopicResultDTO item;
...
string BatchModifyTopicAttributesResponse::ToJsonString() const
{
...
vector<BatchModifyTopicResultDTO> BatchModifyTopicAttributesResponse::GetResult() const
{
    return m_result;
}

bool BatchModifyTopicAttributesResponse::ResultHasBeenSet() const
{
