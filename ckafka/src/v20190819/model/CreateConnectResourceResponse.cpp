...
CoreInternalOutcome CreateConnectResourceResponse::Deserialize(const string &payload)
{
...
string CreateConnectResourceResponse::ToJsonString() const
{
...
ConnectResourceResourceIdResp CreateConnectResourceResponse::GetResult() const
{
    return m_result;
}

bool CreateConnectResourceResponse::ResultHasBeenSet() const
{
