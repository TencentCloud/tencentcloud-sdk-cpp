...
CoreInternalOutcome DeleteInstancePreResponse::Deserialize(const string &payload)
{
...
string DeleteInstancePreResponse::ToJsonString() const
{
...
CreateInstancePreResp DeleteInstancePreResponse::GetResult() const
{
    return m_result;
}

bool DeleteInstancePreResponse::ResultHasBeenSet() const
{
