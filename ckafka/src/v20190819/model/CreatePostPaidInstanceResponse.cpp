...
CoreInternalOutcome CreatePostPaidInstanceResponse::Deserialize(const string &payload)
{
...
string CreatePostPaidInstanceResponse::ToJsonString() const
{
...
CreateInstancePostResp CreatePostPaidInstanceResponse::GetResult() const
{
    return m_result;
}

bool CreatePostPaidInstanceResponse::ResultHasBeenSet() const
{
