...
CoreInternalOutcome DescribeTopicSyncReplicaResponse::Deserialize(const string &payload)
{
...
string DescribeTopicSyncReplicaResponse::ToJsonString() const
{
...
TopicInSyncReplicaResult DescribeTopicSyncReplicaResponse::GetResult() const
{
    return m_result;
}

bool DescribeTopicSyncReplicaResponse::ResultHasBeenSet() const
{
