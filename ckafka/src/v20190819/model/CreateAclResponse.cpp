...
CoreInternalOutcome CreateAclResponse::Deserialize(const string &payload)
{
...
string CreateAclResponse::ToJsonString() const
{
...
JgwOperateResponse CreateAclResponse::GetResult() const
{
    return m_result;
}

bool CreateAclResponse::ResultHasBeenSet() const
{
