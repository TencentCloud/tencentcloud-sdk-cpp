...
CoreInternalOutcome ModifyAccessPolicyResponse::Deserialize(const string &payload)
{
...
string ModifyAccessPolicyResponse::ToJsonString() const
{
...
string ModifyAccessPolicyResponse::GetResult() const
{
    return m_result;
}

bool ModifyAccessPolicyResponse::ResultHasBeenSet() const
{
