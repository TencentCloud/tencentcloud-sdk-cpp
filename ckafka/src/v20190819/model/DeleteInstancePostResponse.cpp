...
CoreInternalOutcome DeleteInstancePostResponse::Deserialize(const string &payload)
{
...
string DeleteInstancePostResponse::ToJsonString() const
{
...
InstanceDeleteResponse DeleteInstancePostResponse::GetResult() const
{
    return m_result;
}

bool DeleteInstancePostResponse::ResultHasBeenSet() const
{
