...
CoreInternalOutcome DescribeDatahubTaskResponse::Deserialize(const string &payload)
{
...
string DescribeDatahubTaskResponse::ToJsonString() const
{
...
DescribeDatahubTaskRes DescribeDatahubTaskResponse::GetResult() const
{
    return m_result;
}

bool DescribeDatahubTaskResponse::ResultHasBeenSet() const
{
