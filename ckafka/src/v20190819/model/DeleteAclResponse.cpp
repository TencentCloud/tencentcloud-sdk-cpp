...
CoreInternalOutcome DeleteAclResponse::Deserialize(const string &payload)
{
...
string DeleteAclResponse::ToJsonString() const
{
...
JgwOperateResponse DeleteAclResponse::GetResult() const
{
    return m_result;
}

bool DeleteAclResponse::ResultHasBeenSet() const
{
