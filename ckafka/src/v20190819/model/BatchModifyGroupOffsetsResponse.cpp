...
CoreInternalOutcome BatchModifyGroupOffsetsResponse::Deserialize(const string &payload)
{
...
string BatchModifyGroupOffsetsResponse::ToJsonString() const
{
...
JgwOperateResponse BatchModifyGroupOffsetsResponse::GetResult() const
{
    return m_result;
}

bool BatchModifyGroupOffsetsResponse::ResultHasBeenSet() const
{
