...
CoreInternalOutcome DescribeSecurityGroupRoutesResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityGroupRoutesResponse::ToJsonString() const
{
...
SecurityGroupRouteResp DescribeSecurityGroupRoutesResponse::GetResult() const
{
    return m_result;
}

bool DescribeSecurityGroupRoutesResponse::ResultHasBeenSet() const
{
