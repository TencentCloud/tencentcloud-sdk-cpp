...
CoreInternalOutcome DescribeDatahubTopicResponse::Deserialize(const string &payload)
{
...
string DescribeDatahubTopicResponse::ToJsonString() const
{
...
DescribeDatahubTopicResp DescribeDatahubTopicResponse::GetResult() const
{
    return m_result;
}

bool DescribeDatahubTopicResponse::ResultHasBeenSet() const
{
