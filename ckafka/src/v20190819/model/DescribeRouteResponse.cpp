...
CoreInternalOutcome DescribeRouteResponse::Deserialize(const string &payload)
{
...
string DescribeRouteResponse::ToJsonString() const
{
...
RouteResponse DescribeRouteResponse::GetResult() const
{
    return m_result;
}

bool DescribeRouteResponse::ResultHasBeenSet() const
{
