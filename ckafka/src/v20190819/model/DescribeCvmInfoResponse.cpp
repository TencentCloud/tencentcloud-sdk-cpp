...
CoreInternalOutcome DescribeCvmInfoResponse::Deserialize(const string &payload)
{
...
string DescribeCvmInfoResponse::ToJsonString() const
{
...
ListCvmAndIpInfoRsp DescribeCvmInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeCvmInfoResponse::ResultHasBeenSet() const
{
