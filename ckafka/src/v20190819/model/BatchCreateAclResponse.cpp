...
CoreInternalOutcome BatchCreateAclResponse::Deserialize(const string &payload)
{
...
string BatchCreateAclResponse::ToJsonString() const
{
...
int64_t BatchCreateAclResponse::GetResult() const
{
    return m_result;
}

bool BatchCreateAclResponse::ResultHasBeenSet() const
{
