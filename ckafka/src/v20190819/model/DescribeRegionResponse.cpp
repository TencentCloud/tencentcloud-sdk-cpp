...
CoreInternalOutcome DescribeRegionResponse::Deserialize(const string &payload)
{
...
string DescribeRegionResponse::ToJsonString() const
{
...
vector<Region> DescribeRegionResponse::GetResult() const
{
    return m_result;
}

bool DescribeRegionResponse::ResultHasBeenSet() const
{
