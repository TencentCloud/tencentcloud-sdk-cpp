...
CoreInternalOutcome DescribeACLResponse::Deserialize(const string &payload)
{
...
string DescribeACLResponse::ToJsonString() const
{
...
AclResponse DescribeACLResponse::GetResult() const
{
    return m_result;
}

bool DescribeACLResponse::ResultHasBeenSet() const
{
