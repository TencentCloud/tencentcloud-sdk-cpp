...
CoreInternalOutcome CancelAuthorizationTokenResponse::Deserialize(const string &payload)
{
...
string CancelAuthorizationTokenResponse::ToJsonString() const
{
...
int64_t CancelAuthorizationTokenResponse::GetResult() const
{
    return m_result;
}

bool CancelAuthorizationTokenResponse::ResultHasBeenSet() const
{
