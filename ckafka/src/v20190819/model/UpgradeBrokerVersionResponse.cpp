...
CoreInternalOutcome UpgradeBrokerVersionResponse::Deserialize(const string &payload)
{
...
string UpgradeBrokerVersionResponse::ToJsonString() const
{
...
JgwOperateResponse UpgradeBrokerVersionResponse::GetResult() const
{
    return m_result;
}

bool UpgradeBrokerVersionResponse::ResultHasBeenSet() const
{
