...
CoreInternalOutcome ModifyDatahubTopicResponse::Deserialize(const string &payload)
{
...
string ModifyDatahubTopicResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyDatahubTopicResponse::GetResult() const
{
    return m_result;
}

bool ModifyDatahubTopicResponse::ResultHasBeenSet() const
{
