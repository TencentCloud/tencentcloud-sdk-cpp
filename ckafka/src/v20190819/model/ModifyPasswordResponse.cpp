...
CoreInternalOutcome ModifyPasswordResponse::Deserialize(const string &payload)
{
...
string ModifyPasswordResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyPasswordResponse::GetResult() const
{
    return m_result;
}

bool ModifyPasswordResponse::ResultHasBeenSet() const
{
