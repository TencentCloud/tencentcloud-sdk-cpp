...
CoreInternalOutcome InquireCkafkaPriceResponse::Deserialize(const string &payload)
{
...
string InquireCkafkaPriceResponse::ToJsonString() const
{
...
InquireCkafkaPriceResp InquireCkafkaPriceResponse::GetResult() const
{
    return m_result;
}

bool InquireCkafkaPriceResponse::ResultHasBeenSet() const
{
