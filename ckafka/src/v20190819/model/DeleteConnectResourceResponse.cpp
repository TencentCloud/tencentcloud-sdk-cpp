...
CoreInternalOutcome DeleteConnectResourceResponse::Deserialize(const string &payload)
{
...
string DeleteConnectResourceResponse::ToJsonString() const
{
...
ConnectResourceResourceIdResp DeleteConnectResourceResponse::GetResult() const
{
    return m_result;
}

bool DeleteConnectResourceResponse::ResultHasBeenSet() const
{
