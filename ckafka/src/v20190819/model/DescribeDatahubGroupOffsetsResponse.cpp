...
CoreInternalOutcome DescribeDatahubGroupOffsetsResponse::Deserialize(const string &payload)
{
...
string DescribeDatahubGroupOffsetsResponse::ToJsonString() const
{
...
GroupOffsetResponse DescribeDatahubGroupOffsetsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDatahubGroupOffsetsResponse::ResultHasBeenSet() const
{
