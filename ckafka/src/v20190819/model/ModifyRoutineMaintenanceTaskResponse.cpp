...
CoreInternalOutcome ModifyRoutineMaintenanceTaskResponse::Deserialize(const string &payload)
{
...
string ModifyRoutineMaintenanceTaskResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyRoutineMaintenanceTaskResponse::GetResult() const
{
    return m_result;
}

bool ModifyRoutineMaintenanceTaskResponse::ResultHasBeenSet() const
{
