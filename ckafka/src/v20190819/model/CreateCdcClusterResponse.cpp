...
CoreInternalOutcome CreateCdcClusterResponse::Deserialize(const string &payload)
{
...
string CreateCdcClusterResponse::ToJsonString() const
{
...
CdcClusterResponse CreateCdcClusterResponse::GetResult() const
{
    return m_result;
}

bool CreateCdcClusterResponse::ResultHasBeenSet() const
{
