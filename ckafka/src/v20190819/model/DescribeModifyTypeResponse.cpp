...
CoreInternalOutcome DescribeModifyTypeResponse::Deserialize(const string &payload)
{
...
string DescribeModifyTypeResponse::ToJsonString() const
{
...
DescModifyType DescribeModifyTypeResponse::GetResult() const
{
    return m_result;
}

bool DescribeModifyTypeResponse::ResultHasBeenSet() const
{
