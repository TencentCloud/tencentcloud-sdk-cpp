...
CoreInternalOutcome DescribeDatahubTasksResponse::Deserialize(const string &payload)
{
...
string DescribeDatahubTasksResponse::ToJsonString() const
{
...
DescribeDatahubTasksRes DescribeDatahubTasksResponse::GetResult() const
{
    return m_result;
}

bool DescribeDatahubTasksResponse::ResultHasBeenSet() const
{
