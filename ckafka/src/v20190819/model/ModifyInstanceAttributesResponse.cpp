...
CoreInternalOutcome ModifyInstanceAttributesResponse::Deserialize(const string &payload)
{
...
string ModifyInstanceAttributesResponse::ToJsonString() const
{
...
JgwOperateResponse ModifyInstanceAttributesResponse::GetResult() const
{
    return m_result;
}

bool ModifyInstanceAttributesResponse::ResultHasBeenSet() const
{
