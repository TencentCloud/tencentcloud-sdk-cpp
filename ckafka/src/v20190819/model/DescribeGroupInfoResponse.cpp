...
CoreInternalOutcome DescribeGroupInfoResponse::Deserialize(const string &payload)
{
...
string DescribeGroupInfoResponse::ToJsonString() const
{
...
vector<GroupInfoResponse> DescribeGroupInfoResponse::GetResult() const
{
    return m_result;
}

bool DescribeGroupInfoResponse::ResultHasBeenSet() const
{
