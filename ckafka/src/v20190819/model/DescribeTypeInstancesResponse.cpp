...
CoreInternalOutcome DescribeTypeInstancesResponse::Deserialize(const string &payload)
{
...
string DescribeTypeInstancesResponse::ToJsonString() const
{
...
InstanceResponse DescribeTypeInstancesResponse::GetResult() const
{
    return m_result;
}

bool DescribeTypeInstancesResponse::ResultHasBeenSet() const
{
