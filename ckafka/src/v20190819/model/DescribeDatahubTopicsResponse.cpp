...
CoreInternalOutcome DescribeDatahubTopicsResponse::Deserialize(const string &payload)
{
...
string DescribeDatahubTopicsResponse::ToJsonString() const
{
...
DescribeDatahubTopicsResp DescribeDatahubTopicsResponse::GetResult() const
{
    return m_result;
}

bool DescribeDatahubTopicsResponse::ResultHasBeenSet() const
{
