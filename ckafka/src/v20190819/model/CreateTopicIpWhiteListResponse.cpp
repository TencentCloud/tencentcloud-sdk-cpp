...
CoreInternalOutcome CreateTopicIpWhiteListResponse::Deserialize(const string &payload)
{
...
string CreateTopicIpWhiteListResponse::ToJsonString() const
{
...
JgwOperateResponse CreateTopicIpWhiteListResponse::GetResult() const
{
    return m_result;
}

bool CreateTopicIpWhiteListResponse::ResultHasBeenSet() const
{
