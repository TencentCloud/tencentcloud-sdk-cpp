...
CoreInternalOutcome ModifyConnectResourceResponse::Deserialize(const string &payload)
{
...
string ModifyConnectResourceResponse::ToJsonString() const
{
...
ConnectResourceResourceIdResp ModifyConnectResourceResponse::GetResult() const
{
    return m_result;
}

bool ModifyConnectResourceResponse::ResultHasBeenSet() const
{
