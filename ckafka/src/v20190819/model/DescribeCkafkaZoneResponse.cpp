...
CoreInternalOutcome DescribeCkafkaZoneResponse::Deserialize(const string &payload)
{
...
string DescribeCkafkaZoneResponse::ToJsonString() const
{
...
ZoneResponse DescribeCkafkaZoneResponse::GetResult() const
{
    return m_result;
}

bool DescribeCkafkaZoneResponse::ResultHasBeenSet() const
{
