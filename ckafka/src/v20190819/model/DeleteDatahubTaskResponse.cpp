...
CoreInternalOutcome DeleteDatahubTaskResponse::Deserialize(const string &payload)
{
...
string DeleteDatahubTaskResponse::ToJsonString() const
{
...
DatahubTaskIdRes DeleteDatahubTaskResponse::GetResult() const
{
    return m_result;
}

bool DeleteDatahubTaskResponse::ResultHasBeenSet() const
{
