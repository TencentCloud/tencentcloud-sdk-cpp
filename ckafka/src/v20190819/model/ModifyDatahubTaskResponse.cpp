...
CoreInternalOutcome ModifyDatahubTaskResponse::Deserialize(const string &payload)
{
...
string ModifyDatahubTaskResponse::ToJsonString() const
{
...
DatahubTaskIdRes ModifyDatahubTaskResponse::GetResult() const
{
    return m_result;
}

bool ModifyDatahubTaskResponse::ResultHasBeenSet() const
{
