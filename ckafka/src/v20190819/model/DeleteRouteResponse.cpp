...
CoreInternalOutcome DeleteRouteResponse::Deserialize(const string &payload)
{
...
string DeleteRouteResponse::ToJsonString() const
{
...
JgwOperateResponse DeleteRouteResponse::GetResult() const
{
    return m_result;
}

bool DeleteRouteResponse::ResultHasBeenSet() const
{
