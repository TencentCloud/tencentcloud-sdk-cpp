...
CoreInternalOutcome DescribeAccessPolicyResponse::Deserialize(const string &payload)
{
...
string DescribeAccessPolicyResponse::ToJsonString() const
{
...
ExternalAccessInfoWrapper DescribeAccessPolicyResponse::GetResult() const
{
    return m_result;
}

bool DescribeAccessPolicyResponse::ResultHasBeenSet() const
{
