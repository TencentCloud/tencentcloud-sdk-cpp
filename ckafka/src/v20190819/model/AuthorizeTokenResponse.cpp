...
CoreInternalOutcome AuthorizeTokenResponse::Deserialize(const string &payload)
{
...
string AuthorizeTokenResponse::ToJsonString() const
{
...
int64_t AuthorizeTokenResponse::GetResult() const
{
    return m_result;
}

bool AuthorizeTokenResponse::ResultHasBeenSet() const
{
