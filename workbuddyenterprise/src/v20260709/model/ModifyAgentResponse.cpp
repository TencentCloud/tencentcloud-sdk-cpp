...
string ModifyAgentResponse::GetAgentName() const
{
    return m_agentName;
}

bool ModifyAgentResponse::AgentNameHasBeenSet() const
{
    return m_agentNameHasBeenSet;
}

string ModifyAgentResponse::GetDescription() const
{
    return m_description;
}

bool ModifyAgentResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string ModifyAgentResponse::GetAvatarUrl() const
{
    return m_avatarUrl;
}

bool ModifyAgentResponse::AvatarUrlHasBeenSet() const
{
    return m_avatarUrlHasBeenSet;
}

bool ModifyAgentResponse::GetIsDebug() const
{
    return m_isDebug;
}

bool ModifyAgentResponse::IsDebugHasBeenSet() const
{
    return m_isDebugHasBeenSet;
}

string ModifyAgentResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool ModifyAgentResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string ModifyAgentResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool ModifyAgentResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

vector<RoutingItem> ModifyAgentResponse::GetRoutingSet() const
{
    return m_routingSet;
}

bool ModifyAgentResponse::RoutingSetHasBeenSet() const
{
    return m_routingSetHasBeenSet;
}

A2AConfig ModifyAgentResponse::GetA2AConfig() const
{
    return m_a2AConfig;
}

bool ModifyAgentResponse::A2AConfigHasBeenSet() const
{
    return m_a2AConfigHasBeenSet;
}

string ModifyAgentResponse::GetAccountId() const
{
    return m_accountId;
}

bool ModifyAgentResponse::AccountIdHasBeenSet() const
{
