...
ModifyAgentRoutingResponse::ModifyAgentRoutingResponse() :
...
CoreInternalOutcome ModifyAgentRoutingResponse::Deserialize(const string &payload)
{
...
string ModifyAgentRoutingResponse::ToJsonString() const
{
...
string ModifyAgentRoutingResponse::GetAgentId() const
{
    return m_agentId;
}

bool ModifyAgentRoutingResponse::AgentIdHasBeenSet() const
{
    return m_agentIdHasBeenSet;
}

string ModifyAgentRoutingResponse::GetAgentName() const
{
    return m_agentName;
}

bool ModifyAgentRoutingResponse::AgentNameHasBeenSet() const
{
    return m_agentNameHasBeenSet;
}

string ModifyAgentRoutingResponse::GetDescription() const
{
    return m_description;
}

bool ModifyAgentRoutingResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string ModifyAgentRoutingResponse::GetAvatarUrl() const
{
    return m_avatarUrl;
}

bool ModifyAgentRoutingResponse::AvatarUrlHasBeenSet() const
{
    return m_avatarUrlHasBeenSet;
}

bool ModifyAgentRoutingResponse::GetIsDebug() const
{
    return m_isDebug;
}

bool ModifyAgentRoutingResponse::IsDebugHasBeenSet() const
{
    return m_isDebugHasBeenSet;
}

string ModifyAgentRoutingResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool ModifyAgentRoutingResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string ModifyAgentRoutingResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool ModifyAgentRoutingResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

vector<RoutingItem> ModifyAgentRoutingResponse::GetRoutingSet() const
{
    return m_routingSet;
}

bool ModifyAgentRoutingResponse::RoutingSetHasBeenSet() const
{
    return m_routingSetHasBeenSet;
}

A2AConfig ModifyAgentRoutingResponse::GetA2AConfig() const
{
    return m_a2AConfig;
}

bool ModifyAgentRoutingResponse::A2AConfigHasBeenSet() const
{
    return m_a2AConfigHasBeenSet;
}

string ModifyAgentRoutingResponse::GetAccountId() const
{
    return m_accountId;
}

bool ModifyAgentRoutingResponse::AccountIdHasBeenSet() const
{
