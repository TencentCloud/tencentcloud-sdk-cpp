...
BindExternalAgentResponse::BindExternalAgentResponse() :
    m_statusHasBeenSet(false),
    m_bindingIdHasBeenSet(false)
{
}

CoreInternalOutcome BindExternalAgentResponse::Deserialize(const string &payload)
{
...
string BindExternalAgentResponse::ToJsonString() const
{
...
string BindExternalAgentResponse::GetStatus() const
{
    return m_status;
}

bool BindExternalAgentResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string BindExternalAgentResponse::GetBindingId() const
{
    return m_bindingId;
}

bool BindExternalAgentResponse::BindingIdHasBeenSet() const
{
