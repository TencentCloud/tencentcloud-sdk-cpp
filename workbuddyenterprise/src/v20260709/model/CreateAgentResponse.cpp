...
string CreateAgentResponse::GetAgentName() const
{
    return m_agentName;
}

bool CreateAgentResponse::AgentNameHasBeenSet() const
{
    return m_agentNameHasBeenSet;
}

string CreateAgentResponse::GetDescription() const
{
    return m_description;
}

bool CreateAgentResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string CreateAgentResponse::GetAvatarUrl() const
{
    return m_avatarUrl;
}

bool CreateAgentResponse::AvatarUrlHasBeenSet() const
{
    return m_avatarUrlHasBeenSet;
}

bool CreateAgentResponse::GetIsDebug() const
{
    return m_isDebug;
}

bool CreateAgentResponse::IsDebugHasBeenSet() const
{
    return m_isDebugHasBeenSet;
}

string CreateAgentResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool CreateAgentResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string CreateAgentResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool CreateAgentResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

vector<RoutingItem> CreateAgentResponse::GetRoutingSet() const
{
    return m_routingSet;
}

bool CreateAgentResponse::RoutingSetHasBeenSet() const
{
    return m_routingSetHasBeenSet;
}

A2AConfig CreateAgentResponse::GetA2AConfig() const
{
    return m_a2AConfig;
}

bool CreateAgentResponse::A2AConfigHasBeenSet() const
{
    return m_a2AConfigHasBeenSet;
}

string CreateAgentResponse::GetAccountId() const
{
    return m_accountId;
}

bool CreateAgentResponse::AccountIdHasBeenSet() const
{
