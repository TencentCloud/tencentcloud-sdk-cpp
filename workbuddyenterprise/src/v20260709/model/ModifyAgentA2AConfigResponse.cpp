...
ModifyAgentA2AConfigResponse::ModifyAgentA2AConfigResponse() :
...
CoreInternalOutcome ModifyAgentA2AConfigResponse::Deserialize(const string &payload)
{
...
string ModifyAgentA2AConfigResponse::ToJsonString() const
{
...
string ModifyAgentA2AConfigResponse::GetAgentId() const
{
    return m_agentId;
}

bool ModifyAgentA2AConfigResponse::AgentIdHasBeenSet() const
{
    return m_agentIdHasBeenSet;
}

string ModifyAgentA2AConfigResponse::GetAgentName() const
{
    return m_agentName;
}

bool ModifyAgentA2AConfigResponse::AgentNameHasBeenSet() const
{
    return m_agentNameHasBeenSet;
}

string ModifyAgentA2AConfigResponse::GetDescription() const
{
    return m_description;
}

bool ModifyAgentA2AConfigResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string ModifyAgentA2AConfigResponse::GetAvatarUrl() const
{
    return m_avatarUrl;
}

bool ModifyAgentA2AConfigResponse::AvatarUrlHasBeenSet() const
{
    return m_avatarUrlHasBeenSet;
}

bool ModifyAgentA2AConfigResponse::GetIsDebug() const
{
    return m_isDebug;
}

bool ModifyAgentA2AConfigResponse::IsDebugHasBeenSet() const
{
    return m_isDebugHasBeenSet;
}

string ModifyAgentA2AConfigResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool ModifyAgentA2AConfigResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string ModifyAgentA2AConfigResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool ModifyAgentA2AConfigResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

vector<RoutingItem> ModifyAgentA2AConfigResponse::GetRoutingSet() const
{
    return m_routingSet;
}

bool ModifyAgentA2AConfigResponse::RoutingSetHasBeenSet() const
{
    return m_routingSetHasBeenSet;
}

A2AConfig ModifyAgentA2AConfigResponse::GetA2AConfig() const
{
    return m_a2AConfig;
}

bool ModifyAgentA2AConfigResponse::A2AConfigHasBeenSet() const
{
