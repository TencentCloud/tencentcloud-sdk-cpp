...
string DescribeExternalAgentRequest::ToJsonString() const
{
...
string DescribeExternalAgentRequest::GetAgentId() const
{
    return m_agentId;
}

void DescribeExternalAgentRequest::SetAgentId(const string& _agentId)
{
    m_agentId = _agentId;
    m_agentIdHasBeenSet = true;
}

bool DescribeExternalAgentRequest::AgentIdHasBeenSet() const
{
    return m_agentIdHasBeenSet;
}

string DescribeExternalAgentRequest::GetA2AAgentId() const
{
    return m_a2AAgentId;
}

void DescribeExternalAgentRequest::SetA2AAgentId(const string& _a2AAgentId)
{
    m_a2AAgentId = _a2AAgentId;
    m_a2AAgentIdHasBeenSet = true;
}

bool DescribeExternalAgentRequest::A2AAgentIdHasBeenSet() const
{
