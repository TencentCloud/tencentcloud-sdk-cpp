...
string DescribeAgentRequest::ToJsonString() const
{
...
string DescribeAgentRequest::GetAgentId() const
{
    return m_agentId;
}

void DescribeAgentRequest::SetAgentId(const string& _agentId)
{
    m_agentId = _agentId;
    m_agentIdHasBeenSet = true;
}

bool DescribeAgentRequest::AgentIdHasBeenSet() const
{
