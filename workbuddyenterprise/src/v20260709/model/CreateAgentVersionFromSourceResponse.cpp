...
CreateAgentVersionFromSourceResponse::CreateAgentVersionFromSourceResponse() :
...
CoreInternalOutcome CreateAgentVersionFromSourceResponse::Deserialize(const string &payload)
{
...
string CreateAgentVersionFromSourceResponse::ToJsonString() const
{
...
string CreateAgentVersionFromSourceResponse::GetVersionId() const
{
    return m_versionId;
}

bool CreateAgentVersionFromSourceResponse::VersionIdHasBeenSet() const
{
    return m_versionIdHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetAgentId() const
{
    return m_agentId;
}

bool CreateAgentVersionFromSourceResponse::AgentIdHasBeenSet() const
{
    return m_agentIdHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetVersionName() const
{
    return m_versionName;
}

bool CreateAgentVersionFromSourceResponse::VersionNameHasBeenSet() const
{
    return m_versionNameHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetVersionType() const
{
    return m_versionType;
}

bool CreateAgentVersionFromSourceResponse::VersionTypeHasBeenSet() const
{
    return m_versionTypeHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetDescription() const
{
    return m_description;
}

bool CreateAgentVersionFromSourceResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetModel() const
{
    return m_model;
}

bool CreateAgentVersionFromSourceResponse::ModelHasBeenSet() const
{
    return m_modelHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetManifest() const
{
    return m_manifest;
}

bool CreateAgentVersionFromSourceResponse::ManifestHasBeenSet() const
{
    return m_manifestHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetStatus() const
{
    return m_status;
}

bool CreateAgentVersionFromSourceResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool CreateAgentVersionFromSourceResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool CreateAgentVersionFromSourceResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

string CreateAgentVersionFromSourceResponse::GetSandboxTemplateId() const
{
    return m_sandboxTemplateId;
}

bool CreateAgentVersionFromSourceResponse::SandboxTemplateIdHasBeenSet() const
{
