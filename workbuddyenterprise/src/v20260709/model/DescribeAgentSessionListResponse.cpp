...
DescribeAgentSessionListResponse::DescribeAgentSessionListResponse() :
    m_totalCountHasBeenSet(false),
    m_sessionSetHasBeenSet(false)
{
}

CoreInternalOutcome DescribeAgentSessionListResponse::Deserialize(const string &payload)
{
...
string DescribeAgentSessionListResponse::ToJsonString() const
{
...
int64_t DescribeAgentSessionListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeAgentSessionListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SessionItem> DescribeAgentSessionListResponse::GetSessionSet() const
{
    return m_sessionSet;
}

bool DescribeAgentSessionListResponse::SessionSetHasBeenSet() const
{
