...
CreateAgentSessionResponse::CreateAgentSessionResponse() :
    m_sessionIdHasBeenSet(false),
    m_endpointSetHasBeenSet(false)
{
}

CoreInternalOutcome CreateAgentSessionResponse::Deserialize(const string &payload)
{
...
string CreateAgentSessionResponse::ToJsonString() const
{
...
string CreateAgentSessionResponse::GetSessionId() const
{
    return m_sessionId;
}

bool CreateAgentSessionResponse::SessionIdHasBeenSet() const
{
    return m_sessionIdHasBeenSet;
}

vector<ChatEndpoint> CreateAgentSessionResponse::GetEndpointSet() const
{
    return m_endpointSet;
}

bool CreateAgentSessionResponse::EndpointSetHasBeenSet() const
{
