...
DescribeAgentVersionResponse::DescribeAgentVersionResponse() :
...
CoreInternalOutcome DescribeAgentVersionResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("SessionCount") && !rsp["SessionCount"].IsNull())
    {
        if (!rsp["SessionCount"].IsInt64())
        {
            return CoreInternalOutcome(Core::Error("response `SessionCount` IsInt64=false incorrectly").SetRequestId(requestId));
        }
        m_sessionCount = rsp["SessionCount"].GetInt64();
...
string DescribeAgentVersionResponse::ToJsonString() const
{
...
string DescribeAgentVersionResponse::GetVersionId() const
{
    return m_versionId;
}

bool DescribeAgentVersionResponse::VersionIdHasBeenSet() const
{
    return m_versionIdHasBeenSet;
}

string DescribeAgentVersionResponse::GetAgentId() const
{
    return m_agentId;
}

bool DescribeAgentVersionResponse::AgentIdHasBeenSet() const
{
    return m_agentIdHasBeenSet;
}

string DescribeAgentVersionResponse::GetVersionName() const
{
    return m_versionName;
}

bool DescribeAgentVersionResponse::VersionNameHasBeenSet() const
{
    return m_versionNameHasBeenSet;
}

string DescribeAgentVersionResponse::GetVersionType() const
{
    return m_versionType;
}

bool DescribeAgentVersionResponse::VersionTypeHasBeenSet() const
{
    return m_versionTypeHasBeenSet;
}

string DescribeAgentVersionResponse::GetDescription() const
{
    return m_description;
}

bool DescribeAgentVersionResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string DescribeAgentVersionResponse::GetModel() const
{
    return m_model;
}

bool DescribeAgentVersionResponse::ModelHasBeenSet() const
{
    return m_modelHasBeenSet;
}

string DescribeAgentVersionResponse::GetManifest() const
{
    return m_manifest;
}

bool DescribeAgentVersionResponse::ManifestHasBeenSet() const
{
    return m_manifestHasBeenSet;
}

string DescribeAgentVersionResponse::GetStatus() const
{
    return m_status;
}

bool DescribeAgentVersionResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeAgentVersionResponse::GetCreatedTime() const
{
    return m_createdTime;
}

bool DescribeAgentVersionResponse::CreatedTimeHasBeenSet() const
{
    return m_createdTimeHasBeenSet;
}

string DescribeAgentVersionResponse::GetModifiedTime() const
{
    return m_modifiedTime;
}

bool DescribeAgentVersionResponse::ModifiedTimeHasBeenSet() const
{
    return m_modifiedTimeHasBeenSet;
}

string DescribeAgentVersionResponse::GetSandboxTemplateId() const
{
    return m_sandboxTemplateId;
}

bool DescribeAgentVersionResponse::SandboxTemplateIdHasBeenSet() const
{
    return m_sandboxTemplateIdHasBeenSet;
}

int64_t DescribeAgentVersionResponse::GetSessionCount() const
{
    return m_sessionCount;
}

bool DescribeAgentVersionResponse::SessionCountHasBeenSet() const
{
