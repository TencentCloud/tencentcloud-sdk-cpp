...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_BINDEXTERNALAGENTREQUEST_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_BINDEXTERNALAGENTREQUEST_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class BindExternalAgentRequest : public AbstractModel
                {
                public:
                    BindExternalAgentRequest();
                    ~BindExternalAgentRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取TMA managed agent 业务 ID（CloudAgentID）
                    ...
                    /**
                     * 设置TMA managed agent 业务 ID（CloudAgentID）
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_BINDEXTERNALAGENTREQUEST_H_
