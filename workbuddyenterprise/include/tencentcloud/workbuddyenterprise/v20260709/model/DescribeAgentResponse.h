...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTRESPONSE_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTRESPONSE_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentResponse : public AbstractModel
                {
                public:
                    DescribeAgentResponse();
                    ~DescribeAgentResponse() = default;
                    ...
                    /**
                     * 获取当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
                     * @return ActiveSessionCount 当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
                     * 
                     */
                    int64_t GetActiveSessionCount() const;

                    /**
                     * 判断参数 ActiveSessionCount 是否已赋值
                     * @return ActiveSessionCount 是否已赋值
                     * 
                     */
                    bool ActiveSessionCountHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    int64_t m_activeSessionCount;
                    bool m_activeSessionCountHasBeenSet;
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTRESPONSE_H_
