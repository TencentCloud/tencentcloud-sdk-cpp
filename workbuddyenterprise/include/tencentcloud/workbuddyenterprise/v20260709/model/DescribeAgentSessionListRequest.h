...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTSESSIONLISTREQUEST_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTSESSIONLISTREQUEST_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentSessionListRequest : public AbstractModel
                {
                public:
                    DescribeAgentSessionListRequest();
                    ~DescribeAgentSessionListRequest() = default;
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTSESSIONLISTREQUEST_H_
