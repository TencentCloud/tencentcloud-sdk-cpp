...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_SKILLCOUNTS_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_SKILLCOUNTS_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                * 全局技能计数
                */
                class SkillCounts : public AbstractModel
                {
                public:
                    SkillCounts();
                    ~SkillCounts() = default;
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_SKILLCOUNTS_H_
