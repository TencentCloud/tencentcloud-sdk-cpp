...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_MODIFYAGENTROUTINGRESPONSE_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_MODIFYAGENTROUTINGRESPONSE_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class ModifyAgentRoutingResponse : public AbstractModel
                {
                public:
                    ModifyAgentRoutingResponse();
                    ~ModifyAgentRoutingResponse() = default;
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_MODIFYAGENTROUTINGRESPONSE_H_
