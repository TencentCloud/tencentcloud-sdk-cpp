...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTVERSIONRESPONSE_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTVERSIONRESPONSE_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class DescribeAgentVersionResponse : public AbstractModel
                {
                public:
                    DescribeAgentVersionResponse();
                    ~DescribeAgentVersionResponse() = default;
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEAGENTVERSIONRESPONSE_H_
