...
#ifndef TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEBUILTINMODELLISTREQUEST_H_
#define TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEBUILTINMODELLISTREQUEST_H_
    ...
    namespace Workbuddyenterprise
    {
        namespace V20260709
        {
            namespace Model
            {
                ...
                */
                class DescribeBuiltinModelListRequest : public AbstractModel
                {
                public:
                    DescribeBuiltinModelListRequest();
                    ~DescribeBuiltinModelListRequest() = default;
                    ...
                    /**
                     * 获取OneID 企业账号 ID，可选。传入时拉取该账号对应企业的模型（要求当前主账号 UIN 已授权该账号），不传时使用服务配置的企业 ID
                    ...
                    /**
                     * 设置OneID 企业账号 ID，可选。传入时拉取该账号对应企业的模型（要求当前主账号 UIN 已授权该账号），不传时使用服务配置的企业 ID
...
#endif // !TENCENTCLOUD_WORKBUDDYENTERPRISE_V20260709_MODEL_DESCRIBEBUILTINMODELLISTREQUEST_H_
